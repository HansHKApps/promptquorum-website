#!/usr/bin/env node
// One-off generator for the superagi-review article hero images (9 locales).
...
// saving the result to public/images/superagi-review-hero-{lang}.png.
// Usage: node scripts/gen-superagi-review-heroes.mjs (requires the dev
// server running on the port below).

import fs from 'node:fs/promises'

const BASE = 'http://localhost:3418'
const ARTICLE_PATH = 'src/lib/power-local-llm/articles/superagi-review.ts'
...
async function generate(lang, spec) {
  ...
  const outPath = `public/images/superagi-review-hero-${lang}.png`
