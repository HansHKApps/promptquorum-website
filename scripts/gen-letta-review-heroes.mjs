#!/usr/bin/env node
// One-off generator for the letta-review article hero images (9 locales).
...
// saving the result to public/images/letta-review-hero-{lang}.png.
// Usage: node scripts/gen-letta-review-heroes.mjs (requires the dev
// server running on the port below).

import fs from 'node:fs/promises'

const BASE = 'http://localhost:3417'
const ARTICLE_PATH = 'src/lib/power-local-llm/articles/letta-review.ts'
...
async function generate(lang, spec) {
  ...
  const outPath = `public/images/letta-review-hero-${lang}.png`
