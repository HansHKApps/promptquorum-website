#!/usr/bin/env node
// One-off generator for the leon-ai-review article hero images (9 locales).
...
// saving the result to public/images/leon-ai-review-hero-{lang}.png.
// Usage: node scripts/gen-leon-ai-review-heroes.mjs (requires the dev
// server running on the port below).

import fs from 'node:fs/promises'

const BASE = 'http://localhost:3415'
const ARTICLE_PATH = 'src/lib/power-local-llm/articles/leon-ai-review.ts'
...
async function generate(lang, spec) {
  ...
  const outPath = `public/images/leon-ai-review-hero-${lang}.png`
