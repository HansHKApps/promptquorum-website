...
const CATEGORY_COPY: Partial<Record<Lang, Record<string, { badge: string; description: string }>>> = {
  en: {
    'hub-money':      { badge: 'Start Here',        description: 'The basics and the main buying guides: what balcony solar is, the best kits, batteries, and micro-inverters, and running it all without the cloud.' },
    'decision-howto': { badge: 'Decision & How-To',              description: 'Practical guides: balcony vs rooftop, installation, registration, sizing and payback, and mounting.' },
    'legislation':    { badge: 'Rules by Country',                description: 'Per-country legal status: the global tracker plus dedicated pages for the US, Germany, Spain/LatAm, Portugal/Brazil, and the Gulf/MENA region.' },
    'long-tail':      { badge: 'Buying Help & Troubleshooting', description: 'Brand comparisons, whether you need a battery, whether the payback adds up, and fixes when your system stops producing.' },
  ...
  de: {
    'hub-money':      { badge: 'Hier starten',          description: 'Die Grundlagen und die wichtigsten Kaufberatungen: was ein Balkonkraftwerk ist, die besten Sets, Speicher und Mikrowechselrichter, und der Betrieb ohne Cloud.' },
    'decision-howto': { badge: 'Entscheidung & Anleitung',        description: 'Praxis-Ratgeber: Balkon vs. Dach, Installation, Anmeldung, Dimensionierung und Amortisation, Montage.' },
    ...
    'long-tail':      { badge: 'Kaufberatung & Fehlerbehebung',   description: 'Markenvergleiche, ob Sie einen Speicher benötigen, ob sich die Amortisation lohnt, und Lösungen, wenn die Anlage nichts mehr liefert.' },
  ...
  fr: {
    'hub-money':      { badge: 'Commencer ici', description: 'Les bases et les principaux guides d\'achat : qu\'est-ce que le solaire de balcon, les meilleurs kits, batteries et micro-onduleurs, et le pilotage sans cloud.' },
    'decision-howto': { badge: 'Décision et guides pratiques',       description: 'Guides pratiques : balcon vs toiture, installation, enregistrement, dimensionnement et rentabilité, fixation.' },
    ...
    'long-tail':      { badge: 'Aide à l\'achat et dépannage',        description: 'Comparatifs de marques, faut-il une batterie, la rentabilité en vaut-elle la peine, et que faire si le système ne produit plus.' },
  ...
  ja: {
    'hub-money':      { badge: 'まずはここから',              description: '基本と主要な購入ガイド：バルコニーソーラーとは何か、最良のキット・バッテリー・マイクロインバーター、そしてクラウドなしでの運用。' },
    'decision-howto': { badge: '意思決定とハウツー',                   description: '実践ガイド：バルコニーvs屋根、設置、登録、サイジングと投資回収、取り付け。' },
    'legislation':    { badge: '国別法規制',                          description: '国ごとの法的状況：グローバルトラッカーに加え、米国、ドイツ、スペイン/ラテンアメリカ、ポルトガル/ブラジル、湾岸/MENA地域の専用ページ。' },
    'long-tail':      { badge: '購入ガイドとトラブルシューティング',        description: 'ブランド比較、バッテリーは必要か、投資回収は見合うか、発電が止まったときの対処法。' },
  ...
  zh: {
    'hub-money':      { badge: '从这里开始',                    description: '基础知识与主要选购指南：什么是阳台光伏、最佳套件/电池/微型逆变器，以及如何在无云端条件下运行。' },
    'decision-howto': { badge: '决策与操作指南',                       description: '实用指南：阳台vs屋顶、安装、注册、选型与回本周期、安装方式。' },
    'legislation':    { badge: '各国法规',                       description: '各国法律状态：全球追踪页，以及美国、德国、西班牙/拉美、葡萄牙/巴西、海湾/中东北非地区的专属页面。' },
    'long-tail':      { badge: '选购建议与故障排查',                       description: '品牌对比、是否需要电池、回本是否划算，以及系统不发电时的排查方法。' },
    'trends-2027':    { badge: '2027年趋势', description: '2027年将发生的变化：欧盟电池/功率标准、住房协会的B2B采纳、荷兰净计量制度的终结，以及日本、中国、巴西、希腊和海湾/中东北非空白市场的国别状态报告。' },
  },
  es: {
    'hub-money':      { badge: 'Empieza aquí', description: 'Los fundamentos y las principales guías de compra: qué es el solar de balcón, los mejores kits, baterías y microinversores, y su funcionamiento sin nube.' },
    'decision-howto': { badge: 'Decisión y guías prácticas',           description: 'Guías prácticas: balcón vs tejado, instalación, registro, dimensionamiento y amortización, montaje.' },
    ...
    'long-tail':      { badge: 'Guía de compra y solución de problemas',   description: 'Comparativas de marcas, si necesitas batería, si compensa la inversión, y qué hacer cuando el sistema deja de producir.' },
  ...
  pt: {
    'hub-money':      { badge: 'Comece aqui', description: 'Os fundamentos e os principais guias de compra: o que é o solar de varanda, os melhores kits, baterias e microinversores, e o funcionamento sem nuvem.' },
    'decision-howto': { badge: 'Decisão e guias práticos',            description: 'Guias práticos: varanda vs telhado, instalação, registro, dimensionamento e retorno, montagem.' },
    ...
    'long-tail':      { badge: 'Guia de compra e solução de problemas',      description: 'Comparações de marcas, se você precisa de bateria, se o retorno compensa, e o que fazer quando o sistema deixa de produzir.' },
  ...
  ar: {
    'hub-money':      { badge: 'ابدأ من هنا',       description: 'الأساسيات وأهم أدلة الشراء: ما هي الطاقة الشمسية للشرفة، وأفضل الأطقم والبطاريات والمحولات الدقيقة، وتشغيلها دون سحابة.' },
    'decision-howto': { badge: 'القرار والإرشادات العملية',            description: 'أدلة عملية: الشرفة مقابل السطح، التركيب، التسجيل، تحديد الحجم والعائد، التثبيت.' },
    ...
    'long-tail':      { badge: 'دليل الشراء واستكشاف الأخطاء',            description: 'مقارنات العلامات التجارية، وهل تحتاج إلى بطارية، وهل يستحق العائد، وحلول عندما يتوقف النظام عن الإنتاج.' },
  ...
  ko: {
    'hub-money':      { badge: '여기서 시작하기', description: '기본 사항과 주요 구매 가이드: 발코니 태양광이란 무엇인지, 최고의 키트·배터리·마이크로인버터, 그리고 클라우드 없이 운영하는 방법.' },
    'decision-howto': { badge: '결정 및 방법 가이드', description: '실용 가이드: 발코니 vs 지붕, 설치, 등록, 사이징과 투자 회수, 마운팅.' },
    'legislation':    { badge: '국가별 법규', description: '국가별 법적 상태: 글로벌 트래커와 미국·독일·스페인/라틴아메리카·포르투갈/브라질·걸프/MENA 지역 전용 페이지.' },
    'long-tail':      { badge: '구매 가이드 및 문제 해결', description: '브랜드 비교, 배터리가 필요한지, 투자 회수가 타당한지, 시스템이 발전을 멈췄을 때의 해결 방법.' },
