...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    schema: {
      ...
      description: 'Is balcony solar legal in your US state? States have signed legislation as of write-time, with more pending — verified state-by-state status.',
  ...
  es: {
    ...
    schema: {
      ...
      description: '¿Es legal el balcony solar en tu estado de EE. UU.? Estados han firmado legislación hasta la fecha de esta publicación, con más pendientes — estado verificado por estado.',
      datePublished: '2026-07-02',
      dateModified: '2026-07-02',
      author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
  ...
  pt: {
    ...
    schema: {
      ...
      description: 'A energia solar de varanda é legal no seu estado dos EUA? Estados sancionaram legislação até o momento desta publicação, com mais pendentes — status verificado estado a estado.',
      datePublished: '2026-07-02',
      dateModified: '2026-07-02',
      author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
  ...
  ja: {
    ...
    schema: {
      ...
      description: 'あなたの州でバルコニーソーラーは合法? 執筆時点で州が法律に署名済み、さらに審議中の州もある — 州別の最新状況、。',
      datePublished: '2026-07-02',
      dateModified: '2026-07-02',
      author: { '@type': 'Organization', name: 'PromptQuorum' },
  ...
  zh: {
    ...
    schema: {
      ...
      description: '阳台光伏在你所在的美国州合法吗?截至发稿时州已签署立法,更多州正在审议中——各州最新状态。',
      datePublished: '2026-07-02',
      dateModified: '2026-07-02',
      author: { '@type': 'Organization', name: 'PromptQuorum' },
  ...
  fr: {
    ...
    schema: {
      ...
      description: 'Le solaire de balcon est-il légal dans votre État américain ? Des États ont promulgué une législation au moment de la rédaction, avec d\'autres en attente — statut.',
      datePublished: '2026-07-02',
      dateModified: '2026-07-02',
      author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
  ...
  ko: {
    ...
    schema: {
      ...
      description: '내가 사는 미국 주에서 발코니 태양광이 합법인가요? 이 글 작성 시점 기준 주가 법안에 서명했으며, 더 많은 주가 심의 중입니다 — 주별 최신 현황.',
      datePublished: '2026-07-02',
      dateModified: '2026-07-02',
      author: { '@type': 'Organization', name: 'PromptQuorum' },
