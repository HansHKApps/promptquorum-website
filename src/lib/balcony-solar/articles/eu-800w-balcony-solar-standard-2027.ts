...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    intro: 'Germany\'s 800W balcony solar cap, finalized under DIN VDE V 0126-95 in December 2025, brings the country in line with a de facto EU standard already used by France, Austria, Belgium, and the Netherlands — rather than setting a new precedent others are following. This page tracks how that convergence is spreading — though Greece\'s own framework, now in public consultation under Law 5299/2026 through July 20, 2026, takes a stricter "zero feed-in" approach rather than simply adopting the France/Austria/Belgium/Netherlands model, driven by the EU\'s Energy Performance of Buildings Directive. Not every member state is converging: Sweden and Hungary remain clear holdouts.',
    metaDescription: 'France, Austria, Belgium, and the Netherlands already allow 800W balcony solar with simple notification-only registration. Germany joined that standard in December 2025 — Greece is now in public consultation on a stricter zero-feed-in framework (Law 5299/2026, through July 20, 2026), driven by the EPBD\'s extension to facades and balconies.',
