    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local Smart Home Energy Management](/smart-home/local-smart-home-energy-management-2027) — cross-cluster: the load-shifting automation that turns this battery\'s stored energy into dynamic-tariff savings',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[إدارة الطاقة المحلية في المنزل الذكي](/ar/smart-home/local-smart-home-energy-management-2027) — عبر المجموعات: أتمتة تحويل الحمل التي تحوّل الطاقة المخزَّنة في هذه البطارية إلى وفورات في ظل التعرفات الديناميكية',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Lokales Energiemanagement im Smart Home](/de/smart-home/local-smart-home-energy-management-2027) — clusterübergreifend: die Lastverschiebungs-Automatisierung, die den gespeicherten Strom dieser Batterie in Einsparungen bei dynamischen Tarifen verwandelt',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Gestión local de energía en el hogar inteligente](/es/smart-home/local-smart-home-energy-management-2027) — entre clústers: la automatización de desplazamiento de carga que convierte la energía almacenada de esta batería en ahorros con tarifas dinámicas',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Gestion locale de l\'énergie dans la maison connectée](/fr/smart-home/local-smart-home-energy-management-2027) — inter-cluster : l\'automatisation de décalage de charge qui transforme l\'énergie stockée de cette batterie en économies sur les tarifs dynamiques',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[ローカルなスマートホームのエネルギー管理](/ja/smart-home/local-smart-home-energy-management-2027) — クラスター横断：このバッテリーに蓄えたエネルギーをダイナミック料金での節約に変える負荷シフト自動化',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[로컬 스마트홈 에너지 관리](/ko/smart-home/local-smart-home-energy-management-2027) — 클러스터 간: 이 배터리에 저장된 에너지를 동적 요금제 절감으로 바꾸는 부하 이동 자동화',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Gestão local de energia na casa inteligente](/pt/smart-home/local-smart-home-energy-management-2027) — entre clusters: a automação de deslocamento de carga que transforma a energia armazenada nesta bateria em economia com tarifas dinâmicas',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[本地智能家居能源管理](/zh/smart-home/local-smart-home-energy-management-2027) ——跨集群：将这块电池储存的电能转化为动态电价节省的负荷转移自动化',
        ],
      },
    },
  },
