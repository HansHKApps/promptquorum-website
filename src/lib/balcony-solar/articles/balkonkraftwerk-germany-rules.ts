...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ja: {
    ...
    metaDescription: 'ドイツのBalkonkraftwerkルール：800Wインバーター上限、Marktstammdatenregister登録、新しいDIN VDE V 0126-95規格 — 一次法的文書に基づき確認済み、2026年7月。',
    publishDate: '2026-07-02',
    dateModified: '2026-07-02',
    readTime: '約9分',
    educationalLevel: 'Intermediate',
  ...
  zh: {
    ...
    metaDescription: 'Balkonkraftwerk德国规定：800W逆变器上限、Marktstammdatenregister注册以及新的DIN VDE V 0126-95标准——已核对一手法律文本，2026年7月。',
    publishDate: '2026-07-02',
    dateModified: '2026-07-02',
    readTime: '约9分钟',
    educationalLevel: 'Intermediate',
  ...
  fr: {
    ...
    metaDescription: 'Règles du Balkonkraftwerk en Allemagne : plafond de 800 W de l\'onduleur, enregistrement au Marktstammdatenregister, et la nouvelle norme DIN VDE V 0126-95 — vérifié par rapport au texte légal primaire, juillet 2026.',
    publishDate: '2026-07-02',
    dateModified: '2026-07-02',
  ...
  ko: {
    ...
    metaDescription: '독일 Balkonkraftwerk 규정: 800W 인버터 상한, Marktstammdatenregister 등록, 그리고 새로운 DIN VDE V 0126-95 규격 — 1차 법률 문서 대조 확인, 2026년 7월.',
    publishDate: '2026-07-02',
    dateModified: '2026-07-02',
    readTime: '9분 읽기',
    educationalLevel: 'Intermediate',
  ...
  de: {
    ...
    metaDescription: 'Balkonkraftwerk-Regeln in Deutschland: 800-W-Grenze am Wechselrichter-Ausgang, Anmeldung im Marktstammdatenregister und die neue Norm DIN VDE V 0126-95 — geprüft anhand des primären Gesetzestexts, Juli 2026.',
    publishDate: '2026-07-02',
    dateModified: '2026-07-02',
