...
export const blogContent: Record<string, Record<Language, BlogPost>> = {
  hallucinations: {
    en: {
      ...
      publishDate: 'Last updated: March 22, 2026',
      ...
      sections: {
        ...
        commonTypes: {
          ...
          rows: [
            { type: 'Invented sources', example: 'Citation to a peer-reviewed paper that doesn\'t exist; fake author names and publication years', why: 'Model was trained on millions of citations and learned citation-like patterns, then invents new ones', severity: 'Very High' },
            { type: 'Wrong facts (dates, numbers, names)', example: 'Stating a historical event in the wrong year; incorrect biographical details', why: 'Training data is incomplete or conflicting; model picks a plausible-sounding number', severity: 'Very High' },
            { type: 'Fabricated URLs and emails', example: 'Providing a link or email address that doesn\'t resolve or belong to the claimed organization', why: 'Model learned URL and email patterns and generates new ones that sound realistic but are fictional', severity: 'High' },
            { type: 'Lost context', example: 'Answering a question as if the model understood earlier context, when it actually lost track of it', why: 'Context window is finite; long documents cause earlier details to fade from the model\'s attention', severity: 'High' },
            { type: 'Role drift', example: 'Starting in one role (analyst) and gradually shifting to another (storyteller), inventing details to fill gaps', why: 'Model loses track of the initial instruction and defaults to pattern-matching on text alone', severity: 'Medium' },
            { type: 'Overconfident generalization', example: 'Stating "All X do Y" when only the specific training examples show this', why: 'Model generalizes too broadly from limited training data without confidence-checking', severity: 'Medium' },
            { type: 'Internal contradiction', example: 'Stating opposing facts within the same response', why: 'Model doesn\'t have a mechanism to track consistency across multiple sentences', severity: 'Medium' },
          ],
    ...
    de: {
      ...
      title: 'KI-Halluzinationen: Warum KI Dinge erfindet',
      intro: 'Große Sprachmodelle produzieren vertrauensvoll falsche Informationen. Diese Fehler – Halluzinationen genannt – reichen von erfundenen Zitaten bis zu erfundenen Fakten, die mit vollständiger Autorität präsentiert werden.',
      publishDate: 'Zuletzt aktualisiert: 22. März 2026',
      readTime: '12 Min. Lesezeit',
      sections: {},
    },
    fr: {
      category: 'Fiabilité IA',
      title: 'Hallucinations IA: Pourquoi l\'IA Invente des Choses',
      intro: 'Les grands modèles de langage produisent confidentement des informations fausses. Ces erreurs, appelées hallucinations, vont de citations inventées à des faits fabriqués présentés avec une autorité complète.',
      publishDate: 'Dernier mise à jour: 22 mars 2026',
      readTime: '12 min de lecture',
      sections: {},
    },
    ja: {
      category: 'AI信頼性',
      title: 'AIハルシネーション：AIがなぜ物を作り出すのか',
      intro: '大規模言語モデルは誤った情報を自信を持って生成します。これらのエラー（ハルシネーションと呼ばれる）は、架空の引用から完全な権威で提示された捏造された事実までの範囲です。',
      publishDate: '最終更新：2026年3月22日',
      readTime: '12分の読み物',
      sections: {},
    },
    zh: {
      category: 'AI可靠性',
      title: 'AI幻觉：为什么AI会编造东西',
      intro: '大型语言模型自信地产生错误信息。这些错误（称为幻觉）的范围从虚假引文到以完全权威性呈现的捏造事实。',
      publishDate: '最后更新：2026年3月22日',
      readTime: '12分钟阅读',
      sections: {},
    },
  },
