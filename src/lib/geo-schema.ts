...
const GEO_ENTITIES = {
  llm: {
    ...
    names: { en: 'Large language model', de: 'Großes Sprachmodell', fr: 'Grand modèle linguistique', zh: '大型语言模型', ja: '大規模言語モデル' },
  },
  promptEngineering: {
    '@id': 'https://www.wikidata.org/wiki/Q108941486',
    names: { en: 'Prompt engineering', de: 'Prompt Engineering', fr: 'Ingénierie des prompts', zh: '提示工程', ja: 'プロンプトエンジニアリング' },
  },
  aiHallucination: {
    '@id': 'https://www.wikidata.org/wiki/Q116197048',
    names: { en: 'AI hallucination', de: 'Halluzination (Künstliche Intelligenz)', fr: 'Hallucination (IA)', zh: '人工智能幻觉', ja: 'ハルシネーション (人工知能)' },
  },
  openSource: {
    '@id': 'https://www.wikidata.org/wiki/Q1130645',
    names: { en: 'Open-source software', de: 'Open-Source-Software', fr: 'Logiciel open source', zh: '开源软件', ja: 'オープンソースソフトウェア' },
  },
  gpu: {
    '@id': 'https://www.wikidata.org/wiki/Q183484',
    names: { en: 'Graphics processing unit', de: 'Grafikprozessor', fr: 'Processeur graphique', zh: '图形处理器', ja: 'グラフィックス プロセッシング ユニット' },
  },
  vram: {
    '@id': 'https://www.wikidata.org/wiki/Q114894',
    names: { en: 'Video RAM', de: 'Video Random Access Memory', fr: 'Mémoire vidéo', zh: '显存', ja: 'ビデオメモリ' },
  },
  ai: {
    '@id': 'https://www.wikidata.org/wiki/Q11660',
    names: { en: 'Artificial intelligence', de: 'Künstliche Intelligenz', fr: 'Intelligence artificielle', zh: '人工智能', ja: '人工知能' },
  },
  ml: {
    '@id': 'https://www.wikidata.org/wiki/Q2539',
    names: { en: 'Machine learning', de: 'Maschinelles Lernen', fr: 'Apprentissage automatique', zh: '机器学习', ja: '機械学習' },
  },
  nlp: {
    '@id': 'https://www.wikidata.org/wiki/Q4845',
    names: { en: 'Natural language processing', de: 'Verarbeitung natürlicher Sprache', fr: 'Traitement du langage naturel', zh: '自然语言处理', ja: '自然言語処理' },
  },
  appleM1: {
    '@id': 'https://www.wikidata.org/wiki/Q101439988',
    names: { en: 'Apple M1', de: 'Apple M1', fr: 'Apple M1', zh: 'Apple M1', ja: 'Apple M1' },
  },
} as const;
