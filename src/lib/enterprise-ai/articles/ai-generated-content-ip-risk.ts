  ...
  en: {
    ...
    sections: {
      ...
      related: {
        ...
        items: [
          '[Shadow AI: Which Controls Actually Fit Your Company Size](/enterprise-ai/shadow-ai-controls-by-company-size) — the same trade-secret leak, viewed from the security-controls side rather than the IP side.',
          '[Agentic AI Security: Identity and Access Controls That Work](/enterprise-ai/agentic-ai-security-identity-access) — relevant once an agent, not just a human prompting a chat interface, is generating or handling content on your behalf.',
  ...
  de: {
    ...
    sections: {
      ...
      related: {
        ...
        items: [
          '[Shadow AI: Welche Kontrollen wirklich zur Unternehmensgröße passen](/de/enterprise-ai/shadow-ai-controls-by-company-size) — derselbe Geschäftsgeheimnis-Vorfall, betrachtet aus der Sicherheitskontrollen-Perspektive statt aus der IP-Perspektive.',
          '[Agentic-AI-Sicherheit: Identitäts- und Zugriffskontrollen, die wirklich funktionieren](/de/enterprise-ai/agentic-ai-security-identity-access) — relevant, sobald nicht mehr nur ein Mensch, sondern ein Agent Inhalte in Ihrem Namen erzeugt oder verarbeitet.',
          ...
          '[Enterprise-AI-Hub](/de/enterprise-ai) — die Build-/Buy-/Govern-Bereiche, in die dieser Artikel gehört.',
        ],
      },
    },
  },
  fr: {
    ...
    sections: {
      ...
      related: {
        ...
        items: [
          '[Shadow AI : quels contrôles correspondent réellement à la taille de votre entreprise](/fr/enterprise-ai/shadow-ai-controls-by-company-size) — le même incident de secret d\'affaires, vu sous l\'angle des contrôles de sécurité plutôt que de la PI.',
          '[Sécurité de l\'IA agentique : des contrôles d\'identité et d\'accès qui fonctionnent vraiment](/fr/enterprise-ai/agentic-ai-security-identity-access) — pertinent dès qu\'un agent, et non plus seulement un humain saisissant un prompt, génère ou traite du contenu en votre nom.',
          ...
          '[Hub Enterprise AI](/fr/enterprise-ai) — les volets Build / Buy / Govern dans lesquels s\'inscrit cet article.',
        ],
      },
    },
  },
  es: {
    ...
    sections: {
      ...
      related: {
        ...
        items: [
          '[Shadow AI: qué controles se ajustan realmente al tamaño de tu empresa](/es/enterprise-ai/shadow-ai-controls-by-company-size) — el mismo incidente de secreto comercial, visto desde el lado de los controles de seguridad en lugar del lado de la PI.',
          '[Seguridad de IA agéntica: controles de identidad y acceso que realmente funcionan](/es/enterprise-ai/agentic-ai-security-identity-access) — relevante en cuanto un agente, y no solo un humano escribiendo en una interfaz de chat, genera o maneja contenido en tu nombre.',
  ...
  pt: {
    ...
    sections: {
      ...
      tradeSecretRisk: {
        ...
        content: [
          '**A ponte mais forte de todo este conjunto de conteúdo é o risco de segredo comercial: um engenheiro cola código-fonte proprietário no prompt de uma ferramenta de IA pública, e a informação confidencial deixou a organização no momento em que o prompt foi enviado — independentemente do que a IA devolva como resultado.** Este é o mesmo incidente subjacente coberto em [Shadow AI: quais controles realmente se ajustam ao tamanho da sua empresa](/enterprise-ai/shadow-ai-controls-by-company-size), visto pelo lado do risco de PI em vez do lado dos controles de segurança: shadow AI é o comportamento; o vazamento de segredo comercial por meio de um prompt de IA é o dano específico que esse comportamento causa.',
      ...
      related: {
        ...
        items: [
          '[Shadow AI: quais controles realmente se ajustam ao tamanho da sua empresa](/pt/enterprise-ai/shadow-ai-controls-by-company-size) — o mesmo incidente de segredo comercial, visto pelo lado dos controles de segurança em vez do lado da PI.',
          '[Segurança de IA agêntica: controles de identidade e acesso que realmente funcionam](/pt/enterprise-ai/agentic-ai-security-identity-access) — relevante assim que um agente, e não apenas um humano digitando em uma interface de chat, gera ou manipula conteúdo em seu nome.',
          ...
          '[Hub de Enterprise AI](/pt/enterprise-ai) — os eixos Build / Buy / Govern nos quais este artigo se encaixa.',
        ],
      },
    },
  },
  zh: {
    ...
    sections: {
      ...
      tradeSecretRisk: {
        ...
        content: [
          '**在整个内容体系中，最强有力的联系点就是商业秘密风险：一名工程师将专有源代码粘贴进某个公开 AI 工具的提示词中，机密信息在提示词发送的那一刻就已离开企业——无论 AI 之后输出什么结果。** 这与[Shadow AI：哪些控制措施真正适合您公司的规模](/enterprise-ai/shadow-ai-controls-by-company-size)一文中讨论的是同一起底层事件，只是从知识产权风险的角度而非安全控制的角度来看：Shadow AI 是行为本身；通过 AI 提示词泄露商业秘密，则是该行为造成的具体危害。',
      ...
      related: {
        ...
        title: '相关阅读',
        items: [
          '[Shadow AI：哪些控制措施真正适合您公司的规模](/zh/enterprise-ai/shadow-ai-controls-by-company-size) —— 同一起商业秘密事件，从安全控制的角度而非知识产权角度来看。',
          '[Agentic AI 安全：真正有效的身份与访问控制](/zh/enterprise-ai/agentic-ai-security-identity-access) —— 一旦是智能体而非仅仅是人类在聊天界面中输入提示词，代表您生成或处理内容时，这一点就变得相关。',
          ...
          '[Enterprise AI 中心页](/zh/enterprise-ai) —— 本文所属的 Build / Buy / Govern 三大方向。',
        ],
      },
    },
  },
  ja: {
    ...
    sections: {
      ...
      related: {
        ...
        title: '関連記事',
        items: [
          '[Shadow AI：企業規模に本当に合った対策とは](/ja/enterprise-ai/shadow-ai-controls-by-company-size) — 同じ営業秘密の事象を、知財の側面ではなくセキュリティ対策の側面から見たもの。',
          '[エージェント型AIセキュリティ：実際に機能するID・アクセス管理](/ja/enterprise-ai/agentic-ai-security-identity-access) — 人間がチャットインターフェースにプロンプトを入力するだけでなく、エージェントがあなたに代わってコンテンツを生成・処理するようになった場合に関連します。',
          ...
          '[Enterprise AIハブ](/ja/enterprise-ai) — 本記事が属するBuild / Buy / Governの各領域。',
        ],
      },
    },
  },
  ar: {
    ...
    sections: {
      ...
      related: {
        ...
        items: [
          '[Shadow AI: أي الضوابط تناسب فعلاً حجم شركتك](/ar/enterprise-ai/shadow-ai-controls-by-company-size) — نفس حادثة السر التجاري، من زاوية ضوابط الأمن بدلاً من زاوية الملكية الفكرية.',
          '[أمن الذكاء الاصطناعي الوكيل: ضوابط الهوية والوصول الفعّالة فعلاً](/ar/enterprise-ai/agentic-ai-security-identity-access) — يصبح هذا مهمًا بمجرد أن يقوم وكيل، لا مجرد إنسان يكتب تعليمة في واجهة محادثة، بتوليد أو معالجة محتوى بالنيابة عنك.',
  ...
  ko: {
    ...
    sections: {
      ...
      related: {
        ...
        title: '관련 자료',
        items: [
          '[Shadow AI: 기업 규모에 실제로 맞는 통제 방안](/ko/enterprise-ai/shadow-ai-controls-by-company-size) — 동일한 영업비밀 사건을 IP 측면이 아니라 보안 통제 측면에서 살펴본 글.',
          '[에이전틱 AI 보안: 실제로 작동하는 IAM 통제](/ko/enterprise-ai/agentic-ai-security-identity-access) — 사람이 채팅 인터페이스에 프롬프트를 입력하는 수준을 넘어 에이전트가 여러분을 대신해 콘텐츠를 생성하거나 처리하게 되는 순간 관련성이 커집니다.',
          ...
          '[Enterprise AI 허브](/ko/enterprise-ai) — 이 글이 속한 Build / Buy / Govern 영역.',
        ],
      },
    },
  },
