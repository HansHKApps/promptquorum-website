...
const FAQ_DATA: Record<Language, { q: string; a: string }[]> = {
  en: [
    ...
    { q: 'Can local LLMs match cloud models like GPT-5.6?', a: 'On coding and reasoning tasks, Qwen 3.6 27B, DeepSeek V3, and Qwen3 score within 5–10% of frontier cloud models on standard benchmarks (MMLU, HumanEval). Claude Opus 4.8 and GPT-5.6 maintain an edge on complex multi-step tasks.' },
    ...
    { q: 'Is a local LLM better than ChatGPT?', a: 'For privacy and cost, yes. For raw output quality, no. As of 2026, frontier cloud models (GPT-5.6, Claude Opus 4.8, Claude Sonnet 5) outperform all locally-runnable models on complex reasoning. However, local models like Qwen 3.6 27B match or exceed older cloud models on most everyday tasks — at zero per-query cost.' },
  ...
  es: [
    ...
    { q: '¿Pueden los LLMs locales competir con modelos en la nube como GPT-5.6?', a: 'En tareas de codificación y razonamiento, Qwen 3.6 27B, DeepSeek V3 y Qwen3 puntúan entre el 5–10% de los modelos en la nube fronterizos en benchmarks estándar (MMLU, HumanEval). Claude Opus 4.8 y GPT-5.6 mantienen ventaja en tareas complejas de múltiples pasos.' },
    ...
    { q: '¿Es un LLM local mejor que ChatGPT?', a: 'Para privacidad y coste, sí. Para calidad de salida pura, no. A partir de 2026, los modelos en la nube fronterizos (GPT-5.6, Claude Opus 4.8, Claude Sonnet 5) superan todos los modelos ejecutables localmente en razonamiento complejo. Sin embargo, modelos locales como Qwen 3.6 27B igualan o superan a modelos en la nube más antiguos en la mayoría de tareas cotidianas — a coste cero por consulta.' },
