...
const FAQ_DATA: Record<Language, { q: string; a: string }[]> = {
  en: [
    ...
    { q: 'Can local LLMs match cloud models like GPT-4o?', a: 'On coding and reasoning tasks, Llama 4 Scout, DeepSeek V3, and Qwen3 score within 5–10% of GPT-4o mini on standard benchmarks (MMLU, HumanEval). Claude Opus 4.7 and GPT-4o maintain an edge on complex multi-step tasks.' },
