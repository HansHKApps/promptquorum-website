...
schema: {
    ...
    de: {
      ...
      metaDescription: 'Lokale LLMs in VS Code mit Continue.dev und Cursor einrichten. Beste Modelle: Qwen-Coder 7B, Code Llama 13B. Performance-Optimierung, Latenz, VRAM-Leitfaden.',
      publishDate: '2026-04-04',
      ...
      sections: {
        ...
        sources: {
          ...
          title: 'Quellen',
          items: [
            'Continue.dev Team. (2026). "Continue Documentation." [docs.continue.dev/](https://docs.continue.dev/) -- Official setup guide, config.json reference, and local model integration instructions.',
            'Cursor. (2026). "Cursor Documentation." [docs.cursor.com/](https://docs.cursor.com/) -- Local model configuration, Ollama integration, and inference setup guide.',
            'Alibaba Qwen Team. (2025). "Qwen3-Coder Technical Report." arXiv:2409.12186. [arxiv.org/abs/2409.12186](https://arxiv.org/abs/2409.12186) -- HumanEval and code generation benchmarks for Qwen3-Coder variants.',
            'DeepSeek-AI. (2024). "DeepSeek-Coder Technical Paper." arXiv:2401.14196. [arxiv.org/abs/2401.14196](https://arxiv.org/abs/2401.14196) -- Benchmark data and capability analysis for DeepSeek-Coder family.',
          ],
        },
      },
schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': 'Lokale LLMs mit VS Code und Cursor: Einrichtung und Best Practices',
        'description': 'Lokale LLMs in VS Code mit Continue.dev und Cursor einrichten. Beste Modelle: Qwen-Coder 7B, Code Llama 13B. Performance-Optimierung, Latenz, VRAM-Leitfaden.',
...
schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': 'LLM Locaux avec VS Code et Cursor : Configuration et Bonnes Pratiques',
        'description': 'Configurez les LLM locaux dans VS Code avec Continue.dev et Cursor. Meilleurs modèles : Qwen-Coder 7B, Code Llama 13B. Performance, latence, RAM.',
...
schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': 'VS CodeとCursorでローカルLLMを使用する：セットアップとベストプラクティス',
        'description': 'VS CodeおよびCursorエディタでローカル大言語モデルによるコード補完を実現するための完全セットアップガイド。Continue.dev設定、Cursor統合、最適なモデル選択、パフォーマンスチューニング、VRAM要件。',
...
schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': 'VS Code和Cursor中的本地LLM：设置和最佳实践',
        'description': '在VS Code和Cursor代码编辑器中使用本地运行的大语言模型实现私密代码补全的完整教程与最佳实践指南。详细讲解Continue.dev扩展的安装配置、Cursor集成方法、最优编码模型推荐、性能优化技巧、显存需求分析、隐私保护措施和完整的零成本高效AI编程助手解决方案步骤。',
    ...
    es: {
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': 'LLMs Locales con VS Code y Cursor: Configuración y Mejores Prácticas',
        'description': 'Usa Ollama en VS Code con Continue.dev para completados de código locales sin clave API. Mejores modelos, requisitos de VRAM e integración con Cursor 2026.',
    ...
    ar: {
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': 'نماذج ⁨LLM⁩ المحلية مع ⁨VS Code⁩ و⁨Cursor⁩: الإعداد وأفضل الممارسات',
        'description': '⁨Ollama⁩ مع ⁨Continue.dev⁩ في ⁨VS Code⁩ يتيح إكمال الشيفرة محليًا بلا مفتاح ⁨API⁩. أفضل النماذج ⁨2026⁩، متطلبات ⁨VRAM⁩ التفصيلية، وإعداد ⁨Cursor⁩ بخطوات واضحة.',
    ...
    pt: {
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': 'LLMs Locais com VS Code e Cursor: Configuração e Boas Práticas',
        'description': 'Use o Ollama no VS Code com o Continue.dev para completamentos de código locais sem chave de API. Melhores modelos, requisitos de VRAM e integração com o Cursor 2026.',
