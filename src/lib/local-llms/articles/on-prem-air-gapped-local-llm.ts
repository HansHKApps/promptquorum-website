    ...
    ja: {
      ...
      sections: {
        ...
        'relatedReading': {
          ...
          title: '関連記事',
          items: [
            '[ローカルLLMセキュリティガイド](/local-llms/local-llm-security?lang=ja)',
            '[エンタープライズLLMデプロイメント](/local-llms/enterprise-llm-deployment?lang=ja)',
            '[政府・防衛LLMコンプライアンス](/local-llms/govt-compliance-llm?lang=ja)',
          ],
        },
        'sources': {
          id: 'sources',
      ...
      schema: {
        ...
        'url': 'https://www.promptquorum.com/local-llms/on-prem-air-gapped-local-llm?lang=ja',
        'inLanguage': 'ja',
        'datePublished': '2026-04-04',
