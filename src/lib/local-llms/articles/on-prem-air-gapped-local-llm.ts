...
schema: {
  ...
  ko: {
    ...
    heroImage: '/images/on-prem-air-gapped-local-llm-overview-hero-ko.webp',
      ...
      publishDate: '2026-04-04',
      leadAnswerBlock: '에어갭 배포란 LLM 인프라가 인터넷으로부터 완전히 격리된 상태를 의미합니다. 인터넷 연결 없음, 외부 API 호출 없음, 데이터 유출 위험 없음. 2026년 4월 기준으로, 이는 기밀 또는 고도로 민감한 데이터를 다루는 정부, 군사, 금융 기관의 표준 방식입니다.',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '2026년 4월 기준, 에어갭은 정부 및 국방 계약업체의 표준입니다.',
          ],
        },
        whatIsAirGapped: {
          title: '에어갭이란 무엇입니까?',
