...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      seoTitle: 'Run Local LLMs on a Laptop: RAM, Speed & Thermals 2026',
      ...
      metaDescription: 'Run 7B models on an 8 GB laptop: thermal throttling cuts speed 20–40% after 15 min. Apple Silicon vs Windows benchmarks included. Q4_K_M quantization guide.',
...
schema: {
    ...
    // thermals: { ..., image: '/images/laptop-stand-airflow.svg', imageCaption: '...' }
      ...
      seoTitle: 'Local LLMs auf Laptop 2026: Praktischer Guide Thermal Throttling',
      ...
      metaDescription: '7B-Modelle auf Laptops mit 8GB RAM. Thermal Throttling reduziert Geschwindigkeit um 20–40% nach 15 Min. Apple Silicon vs Windows. Q4_K_M Quantisierungs-Leitfaden.',
...
schema: {
    ...
    fr: {
      ...
      seoTitle: 'Local LLMs sur Laptop 2026 : Guide Performances et Throttling',
      ...
      metaDescription: 'Modèles 7B sur ordinateurs portables 8 Go. Étranglement thermique réduit vitesse 20–40% après 15 min. Apple Silicon vs Windows. Guide quantization Q4_K_M.',
...
schema: {
      ...
      seoTitle: 'ノートPC Local LLM 2026：熱節流対策完全ガイド',
      ...
      metaDescription: '7Bモデル 8GB ノートPC 実運用ガイド。熱節流で速度20–40%低下（15分後）。Apple Silicon vs Windows。Q4_K_M 設定完全解説。',
...
schema: {
    ...
    zh: {
      ...
      seoTitle: '笔记本 Local LLM 2026：热节流防护完全指南',
      ...
      metaDescription: '7B 模型 8GB 笔记本实操指南。热节流降速 20–40%（15分钟后）。苹果硅 vs Windows。Q4_K_M 量化完全解析。',
