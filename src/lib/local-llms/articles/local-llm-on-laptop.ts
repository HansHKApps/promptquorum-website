...
schema: {
    ...
    es: {
      ...
      schema: {
        ...
        'url': 'https://www.promptquorum.com/es/es/local-llms/local-llm-on-laptop',
        'datePublished': '2026-04-04',
        'dateModified': '2026-04-18',
        'author': { '@type': 'Person', 'name': 'Hans Kuepper' },
        'publisher': { '@type': 'Organization', 'name': 'PromptQuorum', 'url': 'https://www.promptquorum.com' },
    ...
    ar: {
      ...
      seoTitle: 'Llama وPhi على أجهزة لابتوب بسعة 8–16 GB: السرعة والحرارة',
      ...
      metaDescription: 'شغّل Llama 3.2 7B وPhi-4 Mini وGemma 2B على أجهزة لابتوب بسعة 8–16 GB. خفض الأداء الحراري يقلّص السرعة 20–40%. Apple Silicon مقابل Intel Iris Xe.',
