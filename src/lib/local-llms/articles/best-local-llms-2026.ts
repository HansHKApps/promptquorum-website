...
schema: {
    ...
    es: {
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'url': 'https://www.promptquorum.com/es/es/local-llms/best-local-llms-2026',
    ...
    ar: {
      ...
      seoTitle: 'أفضل نماذج LLM المحلية 2026: Llama، Qwen، Mistral مصنّفة',
      ...
      metaDescription: 'أفضل نماذج LLM المحلية في 2026: Llama 3.3 70B، وQwen3 72B، وMistral Small 3.1، وGemma 3 9B، وPhi-4 Mini. متطلبات VRAM ودرجات القياس.',
      publishDate: '2026-04-04',
