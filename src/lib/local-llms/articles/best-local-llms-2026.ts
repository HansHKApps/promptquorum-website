      ...
      sections: {
        ...
        faqSection: {
          ...
          faqs: [
            ...
            {
              q: 'How do these models compare to GPT-5.5?',
              a: 'Llama 3.3 70B and Qwen2.5 72B match or exceed GPT-4 (2023) on MMLU, HumanEval, and MATH benchmarks, but GPT-5.5 (the 2024 multimodal version) remains ahead on complex reasoning and vision tasks. For text-only work (analysis, coding, writing), Llama 3.3 70B and Qwen2.5 72B are competitive. GPT-5.5 has superior image understanding and longer context. Choose local models for privacy, speed (no API latency), and cost; choose GPT-5.5 for maximum capability and multimodal tasks.',
            },
            {
