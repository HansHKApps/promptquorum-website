...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      current_models_mentioned: ['Llama 3.3 70B', 'Qwen2.5 72B', 'Mistral Small 3.1 24B', 'Gemma 3 9B', 'Phi-4 Mini 3.8B'],
      theme: 'Best Models',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Llama 3.3 70B and Qwen2.5 72B match or exceed GPT-4 (2023) on MMLU, HumanEval, and MATH benchmarks, but current frontier cloud models (GPT-5.5, Claude Opus 4.8, Gemini 3.5, Grok 4) remain ahead on complex reasoning and vision tasks. For text-only work (analysis, coding, writing), Llama 3.3 70B and Qwen2.5 72B are competitive. Frontier cloud models have superior image understanding and longer context. Choose local models for privacy, speed (no API latency), and cost; choose a frontier cloud model for maximum capability and multimodal tasks.',
            },
            {
...
schema: { '@context': 'https://schema.org', '@type': 'TechArticle', 'url': 'https://www.promptquorum.com/de/local-llms/best-local-llms-2026', 'inLanguage': 'de', headline: 'Beste lokale LLMs 2026: Top-Modelle nach Task, Hardware und Qualität', description: 'Beste lokale LLMs 2026: Llama 3.3 70B, Qwen2.5 72B, Mistral Small 3.1, Gemma 3 9B und Phi-4 Mini -- mit VRAM-Anforderungen und Benchmark-Ergebnissen.', datePublished: '2026-04-04', dateModified: '2026-06-01', author: { '@type': 'Person', 'name': 'Hans Kuepper', 'sameAs': 'https://www.promptquorum.com/author/hans-kuepper' }, publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' }, proficiencyLevel: 'Beginner', about: [{ '@type': 'Thing', name: 'Llama 3.3 70B' }, { '@type': 'Thing', name: 'Qwen2.5 72B' }, { '@type': 'Thing', name: 'Mistral Small 3.1' }, { '@type': 'Thing', name: 'Lokaler LLM-Benchmark' }, { '@type': 'Thing', name: 'MMLU-Benchmark' }], speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] } },
