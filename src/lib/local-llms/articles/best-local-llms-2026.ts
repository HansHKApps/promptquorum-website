...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      heroImage: '/images/best-local-llms-2026-ranked-comparison-hero-en.png',
      ...
      sections: {
        ...
        howWeRanked: {
          ...
          image: '/images/best-local-llms-2026-ranked-comparison-hero-en.png',
        ...
        whichModel: {
          ...
          image: '/images/best-local-llms-2026-ram-tier-picker-hero-en.png',
...
schema: {
    ...
    es: {
      ...
      heroImage: '/images/best-local-llms-2026-ranked-comparison-hero-es.png',
      publishDate: '2026-04-04',
      ...
      sections: {
        ...
        howWeRanked: {
          ...
          image: '/images/best-local-llms-2026-ranked-comparison-hero-es.png',
        ...
        whichModel: {
          ...
          image: '/images/best-local-llms-2026-ram-tier-picker-hero-es.png',
    ...
    ar: {
      ...
      heroImage: '/images/best-local-llms-2026-ranked-comparison-hero-ar.png',
      publishDate: '2026-04-04',
      ...
      sections: {
        ...
        howWeRanked: {
          ...
          image: '/images/best-local-llms-2026-ranked-comparison-hero-ar.png',
        ...
        whichModel: {
          ...
          image: '/images/best-local-llms-2026-ram-tier-picker-hero-ar.png',
    ...
    pt: {
      ...
      heroImage: '/images/best-local-llms-2026-ranked-comparison-hero-pt.png',
      publishDate: '2026-04-04',
      ...
      sections: {
        ...
        howWeRanked: {
          ...
          image: '/images/best-local-llms-2026-ranked-comparison-hero-pt.png',
    ...
    de: {
      ...
      heroImage: '/images/best-local-llms-2026-ranked-comparison-hero-de.png',
      publishDate: '2026-04-04',
...
schema: { '@context': 'https://schema.org', '@type': 'TechArticle', 'url': 'https://www.promptquorum.com/de/local-llms/best-local-llms-2026', 'inLanguage': 'de', headline: 'Beste lokale LLMs 2026: Qwen3.6 27B, Gemma 4 und Phi-4-mini im Ranking', description: 'Beste lokale LLMs Juli 2026: Qwen3.6 27B gewinnt insgesamt (84% MMLU, 17 GB RAM). Gemma 4 26B-A4B für Reasoning. Qwen2.5-Coder 7B für Code. Phi-4-mini für CPU-only.', datePublished: '2026-04-04', dateModified: '2026-07-15', author: { '@type': 'Person', 'name': 'Hans Kuepper', 'sameAs': 'https://www.linkedin.com/in/hanskuepper/' }, publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' }, proficiencyLevel: 'Beginner', about: [{ '@type': 'Thing', name: 'Qwen3.6 27B' }, { '@type': 'Thing', name: 'Gemma 4 26B-A4B' }, { '@type': 'Thing', name: 'Qwen2.5-Coder 7B' }, { '@type': 'Thing', name: 'Phi-4-mini' }, { '@type': 'Thing', name: 'MMLU-Benchmark' }], speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] } },
    ...
    fr: {
      ...
      heroImage: '/images/best-local-llms-2026-ranked-comparison-hero-fr.png',
      publishDate: '2026-04-04',
      ...
      sections: {
        ...
        howWeRanked: {
          ...
          image: '/images/best-local-llms-2026-ranked-comparison-hero-fr.png',
        ...
        whichModel: {
          ...
          image: '/images/best-local-llms-2026-ram-tier-picker-hero-fr.png',
...
schema: {
    ...
    ja: {
      ...
      heroImage: '/images/best-local-llms-2026-ranked-comparison-hero-ja.png',
      publishDate: '2026-04-04',
      readTime: '10分で読める',
      educationalLevel: 'Beginner',
      ...
      sections: {
        ...
        howWeRanked: {
          ...
          image: '/images/best-local-llms-2026-ranked-comparison-hero-ja.png',
        ...
        whichModel: {
          ...
          image: '/images/best-local-llms-2026-ram-tier-picker-hero-ja.png',
...
schema: {
    ...
    zh: {
      ...
      heroImage: '/images/best-local-llms-2026-ranked-comparison-hero-zh.png',
      publishDate: '2026-04-04',
      readTime: '阅读约10分钟',
      educationalLevel: 'Beginner',
      ...
      sections: {
        ...
        howWeRanked: {
          ...
          image: '/images/best-local-llms-2026-ranked-comparison-hero-zh.png',
        ...
        whichModel: {
          ...
          image: '/images/best-local-llms-2026-ram-tier-picker-hero-zh.png',
...
schema: {
  ...
  heroImage: '/images/best-local-llms-2026-ranked-comparison-hero-ko.png',
  publishDate: '2026-04-04',
  ...
  sections: {
    ...
    howWeRanked: {
      ...
      image: '/images/best-local-llms-2026-ranked-comparison-hero-ko.png',
    ...
    whichModel: {
      ...
      image: '/images/best-local-llms-2026-ram-tier-picker-hero-ko.png',
