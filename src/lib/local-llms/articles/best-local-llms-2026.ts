      ...
      sections: {
        ...
        notSureLocalIsRight: {
          ...
          content: [
            ...
            'Une fois un modèle choisi, l\'étape suivante pour la plupart des lecteurs est de le connecter à votre machine. Voir [Agents IA locaux avec MCP](/power-local-llm/local-ai-agents-with-mcp-2026?lang=fr) pour le protocole qui transforme n\'importe lequel des modèles ci-dessus en un agent capable de lire des fichiers, d\'interroger des bases de données et de piloter un navigateur.',
          ],
        },
        relatedReading: {
          ...
          items: [
            ...
            '[Meilleurs mini-PC AMD pour Local LLM 2026](/local-llms/best-amd-mini-pc-local-llm-2026?lang=fr) -- AMD Ryzen AI Max+ 395: 64–128 Go de mémoire unifiée, 50 TOPS NPU, €1.200–2.600.',
          ],
        },
        sources: {
          id: 'sources',
      ...
      sections: {
        ...
        notSureLocalIsRight: {
          ...
          content: [
            ...
            'モデルを選んだら、多くの読者にとっての次の一歩はそれを自分のマシンにつなぐことです。上記のいずれのモデルも、ファイルの読み書き、データベース照会、ブラウザ操作ができるエージェントに変えるプロトコルについては、[MCP を使ったローカル AI エージェント](/power-local-llm/local-ai-agents-with-mcp-2026?lang=ja)を参照してください。',
          ],
        },
        relatedReading: {
          title: '関連する読み物',
          items: [
            ...
            '[最佳AMD迷你PC Local LLM 2026](/local-llms/best-amd-mini-pc-local-llm-2026?lang=ja) -- AMD Ryzen AI Max+ 395: 64–128GBユニファイドメモリ、50 TOPS NPU、¥172,000–205,000.',
          ],
        },
        sources: {
          title: 'ソース',
      ...
      sections: {
        ...
        notSureLocalIsRight: {
          ...
          content: [
            ...
            '选好模型之后，大多数读者的下一步是把它接到自己的机器上。要让上面任何一款模型都变成能够读写文件、查询数据库、操作浏览器的代理，请参阅[使用 MCP 的本地 AI 代理](/power-local-llm/local-ai-agents-with-mcp-2026?lang=zh)介绍的协议。',
          ],
        },
        relatedReading: {
          title: '相关阅读',
          items: [
            ...
            '[最佳AMD迷你PC本地LLM 2026](/local-llms/best-amd-mini-pc-local-llm-2026?lang=zh) -- AMD Ryzen AI Max+ 395: 64–128GB统一内存、50 TOPS NPU、¥10500–13700。',
          ],
        },
        sources: {
          title: '信息来源',
