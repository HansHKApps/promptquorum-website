...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'أفضل نماذج LLM المحلية للبرتغالية البرازيلية 2026: Qwen3 وSabiá والمزيد',
    metaDescription: 'أفضل نماذج LLM المحلية للبرتغالية البرازيلية في 2026: Qwen3 8B عبر Ollama، وSabiá-3 من Maritaca AI، وLlama 3.1 8B. دليل VRAM واختبارات الجودة وروابط التنزيل.',
