...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    theme: 'Best Models',
    heroImage: '/images/best-local-llms-portuguese-language-2026-overview-hero-en.webp',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**Qwen3 14B** for higher quality at 16GB+ VRAM (`ollama run qwen3:14b`); **Qwen3.8-27B** for the best available quality at 24GB VRAM (`ollama run qwen3.8:27b`)',
      ...
      'top-models': {
        ...
        rows: [
          ...
          { 'Model': 'Qwen3.8-27B', 'Size': '27B', 'VRAM (Q4)': '~24 GB', 'PT-BR Quality': 'Excellent+', 'On Ollama?': 'Yes (ollama run qwen3.8:27b)', 'Best For': 'Best available quality, native vision-language' },
          ...
          { 'Model': 'Gemma 4 31B', 'Size': '31B', 'VRAM (Q4)': '~19 GB', 'PT-BR Quality': 'Good', 'On Ollama?': 'Yes (ollama run gemma4:31b)', 'Best For': 'Wide language support (35+ languages)' },
      ...
      'vram-setup': {
        ...
        items: [
          ...
          '**24GB VRAM:** Qwen3.8-27B (~24GB), Gemma 4 31B (~19GB)',
  ...
  de: {
    ...
    last_full_refresh: '2026-08-28',
    theme: 'Best Models',
    heroImage: '/images/best-local-llms-portuguese-language-2026-overview-hero-de.webp',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**Qwen3 14B** für höhere Qualität bei 16 GB+ VRAM (`ollama run qwen3:14b`); **Qwen3.8-27B** für die beste verfügbare Qualität bei 24 GB VRAM (`ollama run qwen3.8:27b`)',
      ...
      'top-models': {
        ...
        rows: [
          ...
          { 'Modell': 'Qwen3.8-27B', 'Größe': '27B', 'VRAM (Q4)': '~24 GB', 'PT-BR-Qualität': 'Ausgezeichnet+', 'Auf Ollama?': 'Ja (ollama run qwen3.8:27b)', 'Geeignet für': 'Beste verfügbare Qualität, natives Vision-Language-Modell' },
          ...
          { 'Modell': 'Gemma 4 31B', 'Größe': '31B', 'VRAM (Q4)': '~19 GB', 'PT-BR-Qualität': 'Gut', 'Auf Ollama?': 'Ja (ollama run gemma4:31b)', 'Geeignet für': 'Breite Sprachunterstützung (35+ Sprachen)' },
      ...
      'vram-setup': {
        ...
        items: [
          ...
          '**24 GB VRAM:** Qwen3.8-27B (~24 GB), Gemma 4 31B (~19 GB)',
  ...
  es: {
    ...
    last_full_refresh: '2026-08-28',
    theme: 'Best Models',
    heroImage: '/images/best-local-llms-portuguese-language-2026-overview-hero-es.webp',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**Qwen3 14B** para mayor calidad con 16 GB+ de VRAM (`ollama run qwen3:14b`); **Qwen3.8-27B** para la mejor calidad disponible con 24 GB de VRAM (`ollama run qwen3.8:27b`)',
      ...
      'top-models': {
        ...
        rows: [
          ...
          { 'Modelo': 'Qwen3.8-27B', 'Tamaño': '27B', 'VRAM (Q4)': '~24 GB', 'Calidad PT-BR': 'Excelente+', '¿En Ollama?': 'Sí (ollama run qwen3.8:27b)', 'Ideal para': 'Mejor calidad disponible, visión-lenguaje nativo' },
          ...
          { 'Modelo': 'Gemma 4 31B', 'Tamaño': '31B', 'VRAM (Q4)': '~19 GB', 'Calidad PT-BR': 'Buena', '¿En Ollama?': 'Sí (ollama run gemma4:31b)', 'Ideal para': 'Amplio soporte de idiomas (más de 35)' },
      ...
      'vram-setup': {
        ...
        items: [
          ...
          '**24 GB de VRAM:** Qwen3.8-27B (~24 GB), Gemma 4 31B (~19 GB)',
  ...
  fr: {
    ...
    last_full_refresh: '2026-08-28',
    theme: 'Best Models',
    heroImage: '/images/best-local-llms-portuguese-language-2026-overview-hero-fr.webp',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**Qwen3 14B** pour une qualité supérieure avec 16 Go+ de VRAM (`ollama run qwen3:14b`) ; **Qwen3.8-27B** pour la meilleure qualité disponible avec 24 Go de VRAM (`ollama run qwen3.8:27b`)',
      ...
      'top-models': {
        ...
        rows: [
          ...
          { 'Modèle': 'Qwen3.8-27B', 'Taille': '27B', 'VRAM (Q4)': '~24 Go', 'Qualité PT-BR': 'Excellente+', 'Sur Ollama ?': 'Oui (ollama run qwen3.8:27b)', 'Idéal pour': 'Meilleure qualité disponible, vision-langage natif' },
          ...
          { 'Modèle': 'Gemma 4 31B', 'Taille': '31B', 'VRAM (Q4)': '~19 Go', 'Qualité PT-BR': 'Bonne', 'Sur Ollama ?': 'Oui (ollama run gemma4:31b)', 'Idéal pour': 'Large prise en charge des langues (plus de 35)' },
      ...
      'vram-setup': {
        ...
        items: [
          ...
          '**24 Go de VRAM :** Qwen3.8-27B (~24 Go), Gemma 4 31B (~19 Go)',
  ...
  ja: {
    ...
    last_full_refresh: '2026-08-28',
    theme: 'Best Models',
    heroImage: '/images/best-local-llms-portuguese-language-2026-overview-hero-ja.webp',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '16GB以上のVRAMがあれば**Qwen3 14B**（`ollama run qwen3:14b`）でより高い品質に、24GBのVRAMがあれば現時点で最高品質の**Qwen3.8-27B**（`ollama run qwen3.8:27b`）',
      ...
      'top-models': {
        ...
        rows: [
          ...
          { 'モデル': 'Qwen3.8-27B', 'サイズ': '27B', 'VRAM (Q4)': '~24 GB', 'PT-BR品質': '優秀+', 'Ollama対応？': 'はい (ollama run qwen3.8:27b)', '最適な用途': '現時点で最高品質、ネイティブなビジョン言語対応' },
          { 'モデル': 'Llama 3.1 8B', 'サイズ': '8B', 'VRAM (Q4)': '~7 GB', 'PT-BR品質': '良い', 'Ollama対応？': 'はい (ollama run llama3.1:8b)', '最適な用途': '一般的なPT、競争力あり' },
          { 'モデル': 'Gemma 4 31B', 'サイズ': '31B', 'VRAM (Q4)': '~19 GB', 'PT-BR品質': '良い', 'Ollama対応？': 'はい (ollama run gemma4:31b)', '最適な用途': '幅広い言語サポート（35以上の言語）' },
      ...
      'vram-setup': {
        ...
        items: [
          ...
          '**24GBのVRAM：** Qwen3.8-27B（~24GB）、Gemma 4 31B（~19GB）',
  ...
  zh: {
    ...
    last_full_refresh: '2026-08-28',
    theme: 'Best Models',
    heroImage: '/images/best-local-llms-portuguese-language-2026-overview-hero-zh.webp',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '若显存为 16GB 以上，可选 **Qwen3 14B** 获得更高质量（`ollama run qwen3:14b`）；若显存为 24GB，**Qwen3.8-27B** 是目前质量最佳的选择（`ollama run qwen3.8:27b`）',
      ...
      'top-models': {
        ...
        rows: [
          ...
          { '模型': 'Qwen3.8-27B', '大小': '27B', 'VRAM (Q4)': '~24 GB', 'PT-BR 质量': '优秀+', '是否在 Ollama 上？': '是 (ollama run qwen3.8:27b)', '最适合': '目前最佳质量，原生视觉-语言支持' },
          { '模型': 'Llama 3.1 8B', '大小': '8B', 'VRAM (Q4)': '~7 GB', 'PT-BR 质量': '良好', '是否在 Ollama 上？': '是 (ollama run llama3.1:8b)', '最适合': '通用 PT，有竞争力' },
          { '模型': 'Gemma 4 31B', '大小': '31B', 'VRAM (Q4)': '~19 GB', 'PT-BR 质量': '良好', '是否在 Ollama 上？': '是 (ollama run gemma4:31b)', '最适合': '广泛的语言支持（35 种以上语言）' },
      ...
      'vram-setup': {
        ...
        items: [
          ...
          '**24GB 显存：** Qwen3.8-27B（~24GB）、Gemma 4 31B（~19GB）',
  ...
  pt: {
    ...
    last_full_refresh: '2026-08-28',
    theme: 'Best Models',
    heroImage: '/images/best-local-llms-portuguese-language-2026-overview-hero-pt.webp',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**Qwen3 14B** para maior qualidade com 16 GB+ de VRAM (`ollama run qwen3:14b`); **Qwen3.8-27B** para a melhor qualidade disponível com 24 GB de VRAM (`ollama run qwen3.8:27b`)',
      ...
      'top-models': {
        ...
        rows: [
          ...
          { 'Modelo': 'Qwen3.8-27B', 'Tamanho': '27B', 'VRAM (Q4)': '~24 GB', 'Qualidade PT-BR': 'Excelente+', 'No Ollama?': 'Sim (ollama run qwen3.8:27b)', 'Melhor para': 'Melhor qualidade disponível, visão-linguagem nativa' },
          ...
          { 'Modelo': 'Gemma 4 31B', 'Tamanho': '31B', 'VRAM (Q4)': '~19 GB', 'Qualidade PT-BR': 'Boa', 'No Ollama?': 'Sim (ollama run gemma4:31b)', 'Melhor para': 'Amplo suporte a idiomas (mais de 35)' },
  ...
  ar: {
    ...
    last_full_refresh: '2026-08-28',
    theme: 'Best Models',
    heroImage: '/images/best-local-llms-portuguese-language-2026-overview-hero-ar.webp',
    title: 'أفضل نماذج ⁨LLM⁩ المحلية للبرتغالية البرازيلية (⁨2026⁩)',
    seoTitle: 'أفضل ⁨LLM⁩ محلية للبرتغالية البرازيلية ⁨2026⁩: ⁨Qwen3⁩',
    metaDescription: 'أفضل نماذج ⁨LLM⁩ المحلية للبرتغالية البرازيلية ⁨2026⁩: ⁨Qwen3 8B⁩ عبر ⁨Ollama⁩، و⁨Sabi⁩á-⁨3⁩، و⁨Llama 3.1 8B⁩. دليل ⁨VRAM⁩ واختبارات الجودة وروابط التنزيل.',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**Qwen3 14B** لجودة أعلى مع 16 جيجابايت+ من VRAM (`ollama run qwen3:14b`)؛ **Qwen3.8-27B** لأفضل جودة متاحة مع 24 جيجابايت من VRAM (`ollama run qwen3.8:27b`)',
      ...
      'top-models': {
        ...
        rows: [
          ...
          { 'النموذج': 'Qwen3.8-27B', 'الحجم': '27B', 'VRAM (Q4)': '~24 GB', 'جودة PT-BR': 'ممتازة+', 'على Ollama؟': 'نعم (ollama run qwen3.8:27b)', 'الأفضل لـ': 'أفضل جودة متاحة، دعم أصلي للرؤية واللغة' },
          ...
          { 'النموذج': 'Gemma 4 31B', 'الحجم': '31B', 'VRAM (Q4)': '~19 GB', 'جودة PT-BR': 'جيدة', 'على Ollama؟': 'نعم (ollama run gemma4:31b)', 'الأفضل لـ': 'دعم لغوي واسع (أكثر من 35 لغة)' },
      ...
      'vram-setup': {
        ...
        items: [
          ...
          '**24 جيجابايت VRAM:** Qwen3.8-27B (~24 GB)، وGemma 4 31B (~19 GB)',
  ...
  ko: {
    ...
    last_full_refresh: '2026-08-28',
    theme: 'Best Models',
    heroImage: '/images/best-local-llms-portuguese-language-2026-overview-hero-ko.webp',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '16GB 이상의 VRAM에서는 더 높은 품질을 위해 **Qwen3 14B**(`ollama run qwen3:14b`)를, 24GB VRAM에서는 현재 가장 높은 품질의 **Qwen3.8-27B**(`ollama run qwen3.8:27b`)를 선택하십시오',
      ...
      'top-models': {
        ...
        rows: [
          ...
          { '모델': 'Qwen3.8-27B', '크기': '27B', 'VRAM (Q4)': '~24 GB', 'PT-BR 품질': '뛰어남+', 'Ollama 제공?': '예 (ollama run qwen3.8:27b)', '적합 용도': '현재 가장 높은 품질, 네이티브 비전-언어 지원' },
          { '모델': 'Llama 3.1 8B', '크기': '8B', 'VRAM (Q4)': '~7 GB', 'PT-BR 품질': '좋음', 'Ollama 제공?': '예 (ollama run llama3.1:8b)', '적합 용도': '일반 PT, 경쟁력 있음' },
          { '모델': 'Gemma 4 31B', '크기': '31B', 'VRAM (Q4)': '~19 GB', 'PT-BR 품질': '좋음', 'Ollama 제공?': '예 (ollama run gemma4:31b)', '적합 용도': '폭넓은 언어 지원(35개 이상 언어)' },
