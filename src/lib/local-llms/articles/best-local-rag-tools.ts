      ...
      sections: {
        ...
        top8Tools: {
          ...
          rows: [
            ...
            { 'الأداة': 'LlamaIndex', 'النوع': 'إطار Python', 'مثالية لـ': 'خطوط أنابيب مرنة', 'قاعدة البيانات المتجهية': 'أي منها (Chroma، Qdrant، Pinecone)', 'منحنى التعلّم': 'متوسط' },
            { 'الأداة': 'LangChain', 'النوع': 'إطار Python', 'مثالية لـ': 'أنظمة الإنتاج', 'قاعدة البيانات المتجهية': 'أي منها', 'منحنى التعلّم': 'متوسط' },
            { 'الأداة': 'Chroma', 'النوع': 'قاعدة بيانات متجهية', 'مثالية لـ': 'RAG بسيط', 'قاعدة البيانات المتجهية': 'Chroma (مدمجة)', 'منحنى التعلّم': 'منخفض' },
            { 'الأداة': 'Qdrant', 'النوع': 'قاعدة بيانات متجهية', 'مثالية لـ': 'RAG قابل للتوسع', 'قاعدة البيانات المتجهية': 'Qdrant (موزّعة)', 'منحنى التعلّم': 'متوسط' },
            { 'الأداة': 'Weaviate', 'النوع': 'قاعدة بيانات متجهية', 'مثالية لـ': 'استعلامات GraphQL', 'قاعدة البيانات المتجهية': 'Weaviate', 'منحنى التعلّم': 'متوسط' },
            { 'الأداة': 'Milvus', 'النوع': 'قاعدة بيانات متجهية', 'مثالية لـ': 'النطاق الكبير', 'قاعدة البيانات المتجهية': 'Milvus', 'منحنى التعلّم': 'مرتفع' },
      ...
      sections: {
        ...
        top8Tools: {
          ...
          rows: [
            ...
            { 'Ferramenta': 'LlamaIndex', 'Tipo': 'Framework Python', 'Ideal para': 'Pipelines flexíveis', 'Banco de dados vetorial': 'Qualquer (Chroma, Qdrant, Pinecone)', 'Curva de aprendizado': 'Média' },
            { 'Ferramenta': 'LangChain', 'Tipo': 'Framework Python', 'Ideal para': 'Sistemas de produção', 'Banco de dados vetorial': 'Qualquer', 'Curva de aprendizado': 'Média' },
            { 'Ferramenta': 'Chroma', 'Tipo': 'Banco de dados vetorial', 'Ideal para': 'RAG simples', 'Banco de dados vetorial': 'Chroma (incorporado)', 'Curva de aprendizado': 'Baixa' },
            { 'Ferramenta': 'Qdrant', 'Tipo': 'Banco de dados vetorial', 'Ideal para': 'RAG escalável', 'Banco de dados vetorial': 'Qdrant (distribuído)', 'Curva de aprendizado': 'Média' },
            { 'Ferramenta': 'Weaviate', 'Tipo': 'Banco de dados vetorial', 'Ideal para': 'Consultas GraphQL', 'Banco de dados vetorial': 'Weaviate', 'Curva de aprendizado': 'Média' },
            { 'Ferramenta': 'Milvus', 'Tipo': 'Banco de dados vetorial', 'Ideal para': 'Grande escala', 'Banco de dados vetorial': 'Milvus', 'Curva de aprendizado': 'Alta' },
