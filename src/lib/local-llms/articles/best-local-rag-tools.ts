...
schema: {
    ...
    pt: {
      ...
      intro: 'RAG (Retrieval-Augmented Generation) permite que o seu LLM local responda perguntas sobre os seus próprios documentos. Em abril de 2026, o Open WebUI conta com o RAG integrado mais fácil (carregue documentos e faça perguntas), enquanto LlamaIndex e LangChain são frameworks profissionais para construir pipelines de RAG. Este guia cobre 8 ferramentas em termos de facilidade de uso, funcionalidades e prontidão para produção.',
      ...
      publishDate: '2026-04-04',
      leadAnswerBlock: '**RAG (Retrieval-Augmented Generation) permite que o seu LLM local responda perguntas sobre os seus próprios documentos. Em abril de 2026, o Open WebUI conta com o RAG integrado mais fácil (carregue documentos e faça perguntas), enquanto LlamaIndex e LangChain são frameworks profissionais para construir pipelines de RAG.**',
