...
schema: {
    ...
    es: {
      ...
      schema: {
        ...
        url: 'https://www.promptquorum.com/es/es/local-llms/best-local-rag-tools',
        inLanguage: 'es',
        datePublished: '2026-04-04',
    ...
    ar: {
      ...
      seoTitle: 'مقارنة أفضل أدوات RAG المحلية',
      ...
      metaDescription: 'أفضل أدوات RAG المحلية: Open WebUI وLlamaIndex وLangChain والمزيد. أسئلة وأجوبة المستندات والاسترجاع والتقطيع.',
      publishDate: '2026-04-04',
