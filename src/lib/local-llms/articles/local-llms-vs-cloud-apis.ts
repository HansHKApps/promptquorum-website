...
schema: {
    ...
    ar: {
      ...
      intro: 'تعمل نماذج LLM المحلية على عتادك الخاص دون تكاليف API وبخصوصية بيانات كاملة. تقدّم واجهات API السحابية مثل OpenAI GPT-5.5 وAnthropic Claude 4.6 جودة مخرجات أعلى ولا تتطلب إعداد عتاد. يعتمد الخيار الصحيح على حساسية بياناتك وميزانيتك وجودة النموذج المطلوبة وما إذا كنت تحتاج وصولًا دون اتصال.',
      ...
      leadAnswerBlock: '**تُشغّل نماذج LLM المحلية كل الاستدلال على عتادك الخاص بتكلفة رمز صفرية وبخصوصية بيانات كاملة.** تقدّم واجهات API السحابية (GPT-5.5، Claude Opus 4.8، Gemini 3.1 Pro) جودة أعلى بإعداد ضئيل.',
      dateModified: '2026-04-12',
      publishDate: '2026-04-04',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'تتفوّق واجهات API السحابية (GPT-5.5، Claude Opus 4.8، Gemini 3.1 Pro) على جميع النماذج القابلة للتشغيل محليًا في مهام الاستدلال والشيفرة المعقّدة.',
        ...
        fullComparison: {
          ...
          rows: [
            ...
            { 'Factor': 'جودة المخرجات', 'LLM local': 'جيدة في 13B-70B؛ تنافسية في كثير من المهام', 'API en la nube': 'الأفضل المتاح -- GPT-5.5 وClaude 4.6 Sonnet يتصدّران المعايير' },
        ...
        costComparison: {
          ...
          content: [
            '**تكلّف واجهات API السحابية 0.15$-60$ لكل مليون رمز؛ تكلّف نماذج LLM المحلية 0$ لكل رمز بعد الاستثمار في العتاد.** تتفاوت أسعار واجهات API السحابية حسب فئة النموذج. في 2026، أسعار تمثيلية لكل مليون رمز: GPT-5.5 بـ2.50$ إدخال / 10$ إخراج، Claude Opus 4.8 بـ3.00$ / 15$، Gemini 3.1 Pro بـ1.25$ / 5$، وGPT-5.5 Mini بـ0.15$ / 0.60$.',
            'مطوّر يعالج 10 ملايين رمز إخراج شهريًا بـGPT-5.5 يدفع قرابة 100$/شهر. الحمل نفسه على نموذج محلي 8B يكلّف 0$ لكل رمز -- التكلفة الوحيدة هي الكهرباء (قرابة 0.10$-0.30$/ساعة لاستدلال GPU) والعتاد الأولي.',
        ...
        speed: {
          ...
          rows: [
            ...
            { 'Hardware': 'API سحابية (GPT-5.5 Mini)', 'Modelo': 'GPT-5.5 Mini', 'Velocidad': '80-150 رمز/ث (يتفاوت)' },
          ],
          columns: ['Hardware', 'Modelo', 'Velocidad'],
        },
        quality: {
          ...
          content: [
            '**تتصدّر نماذج الحدود السحابية (GPT-5.5، Claude 4.6 Sonnet، Gemini 3.1 Pro) في الاستدلال المعقّد؛ تضاهي النماذج المحلية 13B في التلخيص والترجمة والأسئلة البسيطة.** في معايير MMLU (اتساع المعرفة) وHumanEval (البرمجة)، تحقّق نماذج الحدود السحابية 85-90% مقابل 65-80% لأفضل النماذج المحلية 70B.',
            'للمهام اليومية -- التلخيص والترجمة والتصنيف والأسئلة البسيطة وكتابة المستندات -- يُنتج نموذج محلي 13B بمطالبة جيدة نتائج يصعب تمييزها عن GPT-5.5 Mini في التقييمات العمياء. فجوة الجودة أكثر وضوحًا في المهام التي تتطلب معرفة عميقة بالعالم أو سلاسل استدلال متعددة الخطوات.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            {
              q: 'هل نموذج محلي 70B أفضل من GPT-5.5 Mini؟',
              a: 'في معظم معايير 2026، نعم -- يحقّق Meta Llama 3.3 70B وQwen3 72B درجات أعلى من GPT-5.5 Mini في مهام الاستدلال والبرمجة القياسية. ومع ذلك، تتطلب نماذج 70B بين 40-48 GB من RAM، خارج نطاق معظم العتاد الاستهلاكي. للاستخدام المحلي العملي، نطاق 7B-13B هو الأكثر شيوعًا.',
            },
            ...
            { q: 'كيف أقلّل تكاليف واجهات API السحابية؟', a: 'استخدم نماذج أرخص للمهام البسيطة (GPT-5.5 Mini: 0.15$ لكل مليون رمز مقابل GPT-5.5: 2.50$). جمّع الطلبات. خزّن المطالبات مؤقتًا حيث يُدعَم ذلك. للاستخدام عالي الحجم، تقدّم واجهات API للمعالجة بالدفعات خصم 50%. أو انتقل إلى النماذج المحلية لأحمال العمل عالية التردد.' },
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'جودة المخرجات', 'description': 'LLM محلي: جيدة في 13B-70B. API سحابية: الأفضل المتاح -- GPT-5.5 وClaude 4.6 Sonnet يتصدّران المعايير.' },
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'هل نموذج محلي 70B أفضل من GPT-5.5 Mini؟', 'acceptedAnswer': { '@type': 'Answer', 'text': 'في معظم معايير 2026، نعم -- يحقّق Meta Llama 3.3 70B وQwen3 72B درجات أعلى من GPT-5.5 Mini في مهام الاستدلال والبرمجة. ومع ذلك، تتطلب نماذج 70B بين 40-48 GB من RAM، خارج نطاق معظم العتاد الاستهلاكي.' } },
    ...
    pt: {
      ...
      leadAnswerBlock: '**Os LLMs locais executam toda a inferência no seu próprio hardware com custo por token zero e privacidade total de dados.** As APIs na nuvem (GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro) oferecem maior qualidade com configuração mínima.',
      dateModified: '2026-04-12',
      publishDate: '2026-04-04',
      ...
      sections: {
        ...
        fullComparison: {
          ...
          rows: [
            ...
            { 'Fator': 'Qualidade de saída', 'LLM local': 'Boa em 13B–70B; competitiva em muitas tarefas', 'API na nuvem': 'A melhor disponível — GPT-5.5, Claude 4.6 Sonnet lideram os benchmarks' },
        ...
        speed: {
          ...
          rows: [
            ...
            { 'Hardware': 'API na nuvem (GPT-5.5 Mini)', 'Modelo': 'GPT-5.5 Mini', 'Velocidade': '80–150 tok/s (varia)' },
          ],
        ...
        faqSection: {
          ...
          faqs: [
            ...
            {
              q: 'Um modelo local 70B é melhor que o GPT-5.5 Mini?',
              a: 'Na maioria dos benchmarks de 2026, sim — Meta Llama 3.3 70B e Qwen3 72B obtêm pontuações superiores ao GPT-5.5 Mini em tarefas padrão de raciocínio e programação. No entanto, os modelos 70B requerem 40–48 GB de RAM, fora do alcance da maioria do hardware de consumo. Para uso local prático, a faixa 7B–13B é a mais comum.',
            },
...
schema: {
  ...
  ko: {
      ...
      intro: '로컬 LLM은 자체 하드웨어에서 실행되어 API 비용이 전혀 들지 않으며 완전한 데이터 프라이버시를 제공합니다. OpenAI GPT-5.5 및 Anthropic Claude 4.6과 같은 클라우드 API는 더 높은 출력 품질을 제공하며 별도의 하드웨어 설정이 필요하지 않습니다. 올바른 선택은 데이터 민감도, 예산, 요구되는 모델 품질, 오프라인 접근 필요 여부에 따라 달라집니다.',
      metaDescription: '로컬 LLM은 하드웨어 투자 후 토큰당 $0입니다. 클라우드 API는 1M 토큰당 $0.15~$60입니다. 2026년 전체 비교: 프라이버시, 비용, 속도, 품질 8가지 요소.',
      leadAnswerBlock: '**로컬 LLM은 모든 추론을 자체 하드웨어에서 실행하며 토큰 비용이 없고 완전한 데이터 프라이버시를 보장합니다.** 클라우드 API(GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro)는 최소한의 설정으로 더 높은 품질을 제공합니다.',
      dateModified: '2026-04-12',
      publishDate: '2026-04-04',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '클라우드 API(GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro)는 복잡한 추론 및 코딩 작업에서 로컬에서 실행 가능한 모든 모델을 능가합니다.',
        ...
        fullComparison: {
          ...
          rows: [
            ...
            { 'Factor': '출력 품질', 'Local LLM': '13B~70B에서 우수함; 다양한 작업에서 경쟁력 있음', 'Cloud API': '최고 수준 — GPT-5.5, Claude 4.6 Sonnet이 벤치마크 선도' },
        ...
        costComparison: {
          ...
          content: [
            '**클라우드 API는 1M 토큰당 $0.15~$60이며, 로컬 LLM은 하드웨어 투자 후 토큰당 $0입니다.** 클라우드 API 가격은 모델 등급에 따라 다릅니다. 2026년 기준 대표적인 1M 토큰당 가격: GPT-5.5는 입력 $2.50 / 출력 $10, Claude Opus 4.8은 $3.00 / $15, Gemini 3.1 Pro는 $1.25 / $5, GPT-5.5 Mini는 $0.15 / $0.60입니다.',
            '월 1,000만 출력 토큰을 GPT-5.5로 처리하는 개발자는 약 $100/월을 지불합니다. 동일한 워크로드를 로컬 8B 모델로 처리하면 토큰당 비용은 $0이며, 유일한 비용은 전기료(GPU 추론 시 약 $0.10~0.30/시간)와 초기 하드웨어 비용입니다.',
        ...
        speed: {
          ...
          rows: [
            ...
            { 'Hardware': 'NVIDIA RTX 4060 (8 GB VRAM)', 'Model': 'Llama 3.3 8B Q4', 'Speed': '70~100 tok/sec' },
            { 'Hardware': 'NVIDIA RTX 4090 (24 GB VRAM)', 'Model': 'Llama 3.3 8B Q4', 'Speed': '130~160 tok/sec' },
            { 'Hardware': '클라우드 API (GPT-5.5 Mini)', 'Model': 'GPT-5.5 Mini', 'Speed': '80~150 tok/sec (가변)' },
          ],
          columns: ['Hardware', 'Model', 'Speed'],
        },
        quality: {
          ...
          content: [
            '**클라우드 최전선 모델(GPT-5.5, Claude 4.6 Sonnet, Gemini 3.1 Pro)은 복잡한 추론에서 선도하며, 로컬 13B 모델은 요약, 번역, 간단한 Q&A에서 대등합니다.** MMLU(지식 폭)와 HumanEval(코딩) 벤치마크에서 최전선 클라우드 모델은 85~90%를 기록하는 반면, 최고의 로컬 70B 모델은 65~80%입니다.',
            '일상적인 작업 — 요약, 번역, 분류, 간단한 Q&A, 문서 초안 작성 — 에서 잘 프롬프팅된 13B 로컬 모델은 맹목 평가에서 GPT-5.5 Mini와 구별하기 어려운 결과를 생성합니다. 품질 격차는 깊은 세계 지식이나 다단계 추론 체인이 필요한 작업에서 가장 두드러집니다.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            {
              q: '로컬 70B 모델이 GPT-5.5 Mini보다 낫습니까?',
              a: '2026년 대부분의 벤치마크에서 그렇습니다 — Meta Llama 3.3 70B와 Qwen3 72B는 표준 추론 및 코딩 작업에서 GPT-5.5 Mini보다 높은 점수를 기록합니다. 하지만 70B 모델은 40~48 GB의 RAM이 필요하여 대부분의 소비자용 하드웨어로는 실행이 어렵습니다. 실용적인 로컬 사용에는 7B~13B 모델이 일반적입니다.',
            },
            ...
            { q: '클라우드 API 비용을 어떻게 줄일 수 있습니까?', a: '간단한 작업에는 더 저렴한 모델을 사용하십시오(GPT-5.5 Mini: 1M 토큰당 $0.15 vs GPT-5.5: $2.50). 요청을 일괄 처리하십시오. 지원되는 경우 프롬프트를 캐시하십시오. 고빈도 워크로드의 경우 로컬 모델로 전환하십시오 — 하드웨어 투자 후 토큰당 비용이 없습니다.' },
