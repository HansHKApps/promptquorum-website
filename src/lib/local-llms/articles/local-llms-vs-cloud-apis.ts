...
schema: {
    ...
    es: {
      ...
      seoTitle: 'LLMs locales vs APIs en la nube 2026: Privacidad, costo y calidad',
      ...
      metaDescription: 'Los LLMs locales cuestan $0/token tras el hardware; las APIs en la nube cuestan $0.15-$60/1M tokens. Comparación completa 2026: privacidad, costo, velocidad y calidad en 8 factores.',
      ...
      sections: {
        ...
        fullComparison: {
          ...
          rows: [
            ...
            { 'Factor': 'Calidad de salida', 'LLM local': 'Buena en 13B-70B; competitiva en muchas tareas', 'API en la nube': 'La mejor disponible -- GPT-4o, Claude 4.6 Sonnet lideran los benchmarks' },
        ...
        speed: {
          ...
          rows: [
            ...
            { 'Hardware': 'API en la nube (GPT-4o Mini)', 'Modelo': 'GPT-4o Mini', 'Velocidad': '80-150 tok/seg (varía)' },
          ],
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'Calidad de salida', 'description': 'LLM local: buena en 13B-70B. API en la nube: la mejor disponible -- GPT-4o, Claude 4.6 Sonnet lideran los benchmarks.' },
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '¿Es un modelo local 70B mejor que GPT-4o Mini?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'En la mayoría de los benchmarks de 2026, sí -- Meta Llama 3.3 70B y Qwen2.5 72B obtienen puntuaciones superiores a GPT-4o Mini en tareas de razonamiento y programación. Sin embargo, los modelos 70B requieren 40-48 GB de RAM, fuera del alcance de la mayoría del hardware de consumo.' } },
          ...
          { '@type': 'Question', 'name': '¿Cómo reduzco los costos de las APIs en la nube?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Usa modelos más baratos para tareas simples (GPT-4o Mini a $0.15/1M tokens vs GPT-4o a $2.50). Agrupa solicitudes. Almacena prompts en caché donde sea compatible. Cambia a modelos locales para cargas de trabajo de alta frecuencia -- costo de token cero tras la inversión en hardware.' } },
