...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      heroImage: '/images/local-llms-vs-cloud-apis-overview-hero-en.webp',
      ...
      leadAnswerBlock: '**Local LLMs run all inference on your own hardware at zero token cost with full data privacy.** Cloud APIs (GPT-5.6, Claude Opus 5, Gemini 3.1 Pro) deliver higher quality with minimal setup.',
      ...
      sections: {
        ...
        costComparison: {
          ...
          content: [
            '**Cloud APIs cost $0.15-$60 per 1M tokens; local LLMs cost $0 per token after the hardware investment.** Cloud API pricing varies by model tier. In 2026, representative prices per 1M tokens: GPT-5.6 at $2.50 input / $10 output, Claude Opus 5 at $5.00 / $25, Gemini 3.1 Pro at $1.25 / $5, and GPT-5.6 Luna at $0.15 / $0.60.',
...
schema: {
    ...
    es: {
      ...
      heroImage: '/images/local-llms-vs-cloud-apis-overview-hero-es.webp',
      ...
      leadAnswerBlock: '**Los LLMs locales ejecutan toda la inferencia en tu propio hardware a costo de token cero con privacidad total de datos.** Las APIs en la nube (GPT-5.6, Claude Opus 5, Gemini 3.1 Pro) ofrecen mayor calidad con configuración mínima.',
      dateModified: '2026-08-28',
      publishDate: '2026-04-04',
      ...
      sections: {
        ...
        costComparison: {
          ...
          content: [
            '**Las APIs en la nube cuestan $0.15-$60 por 1M tokens; los LLMs locales cuestan $0 por token tras la inversión en hardware.** Los precios de las APIs en la nube varían según el nivel del modelo. En 2026, precios representativos por 1M tokens: GPT-5.6 a $2.50 de entrada / $10 de salida, Claude Opus 5 a $5.00 / $25, Gemini 3.1 Pro a $1.25 / $5, y GPT-5.6 Luna a $0.15 / $0.60.',
        ...
        speed: {
          ...
          rows: [
            { 'Hardware': 'Solo CPU (laptop moderno)', 'Modelo': 'Llama 3.1 8B Q4', 'Velocidad': '10-25 tok/seg' },
            { 'Hardware': 'Apple M3 Pro (18 GB unificada)', 'Modelo': 'Llama 3.1 8B Q4', 'Velocidad': '55-75 tok/seg' },
            { 'Hardware': 'NVIDIA RTX 4060 (8 GB VRAM)', 'Modelo': 'Llama 3.1 8B Q4', 'Velocidad': '70-100 tok/seg' },
            { 'Hardware': 'NVIDIA RTX 4090 (24 GB VRAM)', 'Modelo': 'Llama 3.1 8B Q4', 'Velocidad': '130-160 tok/seg' },
    ...
    ar: {
      ...
      heroImage: '/images/local-llms-vs-cloud-apis-overview-hero-ar.webp',
      ...
      leadAnswerBlock: '**تُشغّل نماذج LLM المحلية كل الاستدلال على عتادك الخاص بتكلفة رمز صفرية وبخصوصية بيانات كاملة.** تقدّم واجهات API السحابية (GPT-5.6، Claude Opus 5، Gemini 3.1 Pro) جودة أعلى بإعداد ضئيل.',
      dateModified: '2026-08-28',
      publishDate: '2026-04-04',
      ...
      sections: {
        ...
        costComparison: {
          ...
          content: [
            '**تكلّف واجهات API السحابية 0.15$-60$ لكل مليون رمز؛ تكلّف نماذج LLM المحلية 0$ لكل رمز بعد الاستثمار في العتاد.** تتفاوت أسعار واجهات API السحابية حسب فئة النموذج. في 2026، أسعار تمثيلية لكل مليون رمز: GPT-5.6 بـ2.50$ إدخال / 10$ إخراج، Claude Opus 5 بـ3.00$ / 15$، Gemini 3.1 Pro بـ1.25$ / 5$، وGPT-5.6 Luna بـ0.15$ / 0.60$.',
        ...
        speed: {
          ...
          rows: [
            { 'Hardware': 'CPU فقط (حاسوب محمول حديث)', 'Modelo': 'Llama 3.1 8B Q4', 'Velocidad': '10-25 رمز/ث' },
            { 'Hardware': 'Apple M3 Pro (18 GB موحدة)', 'Modelo': 'Llama 3.1 8B Q4', 'Velocidad': '55-75 رمز/ث' },
            { 'Hardware': 'NVIDIA RTX 4060 (8 GB VRAM)', 'Modelo': 'Llama 3.1 8B Q4', 'Velocidad': '70-100 رمز/ث' },
            { 'Hardware': 'NVIDIA RTX 4090 (24 GB VRAM)', 'Modelo': 'Llama 3.1 8B Q4', 'Velocidad': '130-160 رمز/ث' },
    ...
    pt: {
      ...
      heroImage: '/images/local-llms-vs-cloud-apis-overview-hero-pt.webp',
      ...
      leadAnswerBlock: '**Os LLMs locais executam toda a inferência no seu próprio hardware com custo por token zero e privacidade total de dados.** As APIs na nuvem (GPT-5.6, Claude Opus 5, Gemini 3.1 Pro) oferecem maior qualidade com configuração mínima.',
      dateModified: '2026-08-28',
      publishDate: '2026-04-04',
      ...
      sections: {
        ...
        costComparison: {
          ...
          content: [
            '**As APIs na nuvem custam $0,15–$60 por 1M tokens; os LLMs locais custam $0 por token após o investimento em hardware.** Os preços das APIs na nuvem variam por nível de modelo. Em 2026, preços representativos por 1M tokens: GPT-5.6 a $2,50 entrada / $10 saída, Claude Opus 5 a $5,00 / $25, Gemini 3.1 Pro a $1,25 / $5, GPT-5.6 Luna a $0,15 / $0,60.',
        ...
        speed: {
          ...
          rows: [
            { 'Hardware': 'Apenas CPU (laptop moderno)', 'Modelo': 'Llama 3.1 8B Q4', 'Velocidade': '10–25 tok/s' },
            { 'Hardware': 'Apple M3 Pro (18 GB unificada)', 'Modelo': 'Llama 3.1 8B Q4', 'Velocidade': '55–75 tok/s' },
            { 'Hardware': 'NVIDIA RTX 4060 (8 GB VRAM)', 'Modelo': 'Llama 3.1 8B Q4', 'Velocidade': '70–100 tok/s' },
            { 'Hardware': 'NVIDIA RTX 4090 (24 GB VRAM)', 'Modelo': 'Llama 3.1 8B Q4', 'Velocidade': '130–160 tok/s' },
    ...
    de: {
      ...
      heroImage: '/images/local-llms-vs-cloud-apis-overview-hero-de.webp',
      ...
      leadAnswerBlock: '**Lokale LLMs führen alle Berechnungen auf Ihrer eigenen Hardware durch \u2013 ohne Token-Kosten und mit vollständigem Datenschutz.** Cloud-APIs (GPT-5.6, Claude Opus 5, Gemini 3.1 Pro) liefern höhere Qualität mit minimalem Einrichtungsaufwand.',
      dateModified: '2026-08-28',
      publishDate: '2026-04-04',
...
schema: {
    ...
    fr: {
      ...
      heroImage: '/images/local-llms-vs-cloud-apis-overview-hero-fr.webp',
      ...
      leadAnswerBlock: '**Les LLMs locaux exécutent toutes les inférences sur votre propre matériel -- sans coût par token et avec une confidentialité totale.** Les APIs cloud (GPT-5.6, Claude Opus 5, Gemini 3.1 Pro) offrent une qualité supérieure avec une configuration minimale.',
      dateModified: '2026-08-28',
      publishDate: '2026-04-04',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Les APIs cloud (GPT-5.6, Claude Opus 5, Gemini 3.1 Pro) surpassent tous les modèles exécutables localement sur les tâches complexes de raisonnement et de code.',
...
schema: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Oui. Qwen3 8B et 14B offrent de bonnes performances en français grâce à un entraînement multilingue étendu. Pour un usage professionnel en français, Llama 3.1 8B et Mistral Small sont également de bons choix avec Ollama. Les modèles 13B et supérieurs produisent généralement une qualité de texte français nettement supérieure aux modèles 7B.',
            },
          },
        ],
      },
    ...
    ja: {
      ...
      heroImage: '/images/local-llms-vs-cloud-apis-overview-hero-ja.webp',
      ...
      leadAnswerBlock: '**ローカルLLMはトークンコストゼロ・完全なデータプライバシーで自社ハードウェア上で推論を実行します。** クラウドAPI（GPT-5.6、Claude Opus 5、Gemini 3.1 Pro）は最小限のセットアップで高品質な出力を提供します。',
      dateModified: '2026-08-28',
      publishDate: '2026-04-04',
      readTime: '8分で読める',
      gammaEmbedUrl: '/presentations/local-llms-vs-cloud-apis-static.html',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'クラウドAPI（GPT-5.6、Claude Opus 5、Gemini 3.1 Pro）は複雑な推論・コードタスクでローカル実行可能なすべてのモデルを上回ります。',
        ...
        regionalContext: {
          ...
          items: [
            '**日本（METI）：** 経済産業省（METI）のAIガバナンスガイドラインは、機密に分類された企業データに対してオンプレミス推論を推奨しています。顧客データを取り扱う日本企業にとって、ローカルLLMはMETIの「AIシステムの適切な管理」という原則に沿っています。クラウドAPIを使用する場合は、プロバイダーのデータ処理場所が個人情報保護法（APPI）に準拠していることを確認する必要があります。日本語業務ワークフローには、OllamaでのQwen3 8Bが推奨ローカルモデルです -- ネイティブな日本語トークナイゼーションにより、日本語文書の処理速度がLlamaより30〜40%向上します。',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: '日本語の業務データにはローカルLLMとクラウドAPIのどちらが適していますか？', a: 'METIのAIガバナンスガイドラインの観点から、機密な顧客データや業務データにはローカルLLMが推奨されます。OllamaでのQwen3 8Bは日本語に最適化されており、ネイティブな日本語トークナイゼーションにより高速な処理が可能です。個人情報保護法（APPI）への準拠を確実にするため、クラウドAPIを使用する場合はデータ処理場所を必ず確認してください。' },
            { q: 'Qwen3は日本語に対応していますか？', a: 'はい。Qwen3 8Bと14Bは広範な多言語トレーニングにより日本語で優れたパフォーマンスを発揮します。ネイティブな日本語トークナイゼーションにより、Llama系モデルと比較して日本語文書の処理が30〜40%効率的です。Ollamaで実行できます：ollama run qwen2.5:7b。' },
...
schema: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'METIのAIガバナンスガイドラインの観点から、機密な顧客データや業務データにはローカルLLMが推奨されます。OllamaでのQwen3 8Bは日本語に最適化されており、ネイティブな日本語トークナイゼーションにより高速な処理が可能です。個人情報保護法（APPI）への準拠を確実にするため、クラウドAPIを使用する場合はデータ処理場所を必ず確認してください。',
            },
          },
          {
            '@type': 'Question',
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'はい。Qwen3 8Bと14Bは広範な多言語トレーニングにより日本語で優れたパフォーマンスを発揮します。ネイティブな日本語トークナイゼーションにより、Llama系モデルと比較して日本語文書の処理が30〜40%効率的です。Ollamaで実行できます：ollama run qwen2.5:7b。',
            },
          },
          {
            '@type': 'Question',
    ...
    zh: {
      ...
      heroImage: '/images/local-llms-vs-cloud-apis-overview-hero-zh.webp',
      ...
      leadAnswerBlock: '**本地LLM在您自己的硬件上运行所有推理，token成本为零，数据完全私密。** 云端API（GPT-5.6、Claude Opus 5、Gemini 3.1 Pro）以最少的设置提供更高质量。',
      dateModified: '2026-08-28',
      publishDate: '2026-04-04',
      readTime: '阅读约8分钟',
      gammaEmbedUrl: '/presentations/local-llms-vs-cloud-apis-static.html',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '云端API（GPT-5.6、Claude Opus 5、Gemini 3.1 Pro）在复杂推理和代码任务上优于所有可本地运行的模型。',
...
schema: {
  ...
  ko: {
    ...
    heroImage: '/images/local-llms-vs-cloud-apis-overview-hero-ko.webp',
      ...
      leadAnswerBlock: '**로컬 LLM은 모든 추론을 자체 하드웨어에서 실행하며 토큰 비용이 없고 완전한 데이터 프라이버시를 보장합니다.** 클라우드 API(GPT-5.6, Claude Opus 5, Gemini 3.1 Pro)는 최소한의 설정으로 더 높은 품질을 제공합니다.',
      dateModified: '2026-08-28',
      publishDate: '2026-04-04',
      ...
      sections: {
        ...
        costComparison: {
          ...
          content: [
            '**클라우드 API는 1M 토큰당 $0.15~$60이며, 로컬 LLM은 하드웨어 투자 후 토큰당 $0입니다.** 클라우드 API 가격은 모델 등급에 따라 다릅니다. 2026년 기준 대표적인 1M 토큰당 가격: GPT-5.6는 입력 $2.50 / 출력 $10, Claude Opus 5은 $5.00 / $25, Gemini 3.1 Pro는 $1.25 / $5, GPT-5.6 Luna는 $0.15 / $0.60입니다.',
        ...
        speed: {
          ...
          rows: [
            { 'Hardware': 'CPU만 사용 (최신 노트북)', 'Model': 'Llama 3.1 8B Q4', 'Speed': '10~25 tok/sec' },
            { 'Hardware': 'Apple M3 Pro (18 GB 통합 메모리)', 'Model': 'Llama 3.1 8B Q4', 'Speed': '55~75 tok/sec' },
            { 'Hardware': 'NVIDIA RTX 4060 (8 GB VRAM)', 'Model': 'Llama 3.1 8B Q4', 'Speed': '70~100 tok/sec' },
            { 'Hardware': 'NVIDIA RTX 4090 (24 GB VRAM)', 'Model': 'Llama 3.1 8B Q4', 'Speed': '130~160 tok/sec' },
