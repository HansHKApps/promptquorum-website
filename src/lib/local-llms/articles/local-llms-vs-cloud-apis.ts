...
schema: {
    ...
    ar: {
      ...
      seoTitle: 'نماذج LLM المحلية مقابل API السحابية 2026: الخصوصية والتكلفة والجودة',
      ...
      metaDescription: 'تكلّف نماذج LLM المحلية 0$/رمز بعد العتاد؛ تكلّف واجهات API السحابية 0.15$–60$/مليون رمز. مقارنة 2026 للخصوصية والتكلفة والسرعة والجودة.',
