      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Cloud APIs (GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro) outperform all locally-runnable models on complex reasoning and code tasks.',
        ...
        costComparison: {
          ...
          content: [
            '**Cloud APIs cost $0.15-$60 per 1M tokens; local LLMs cost $0 per token after the hardware investment.** Cloud API pricing varies by model tier. In 2026, representative prices per 1M tokens: GPT-5.5 at $2.50 input / $10 output, Claude Opus 4.7 at $3.00 / $15, Gemini 3.1 Pro at $1.25 / $5, and GPT-5.5 Mini at $0.15 / $0.60.',
...
schema: {
    ...
    de: {
      ...
      leadAnswerBlock: '**Lokale LLMs führen alle Berechnungen auf Ihrer eigenen Hardware durch \u2013 ohne Token-Kosten und mit vollständigem Datenschutz.** Cloud-APIs (GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro) liefern höhere Qualität mit minimalem Einrichtungsaufwand.',
      dateModified: '2026-04-12',
      publishDate: '2026-04-04',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Cloud-APIs (GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro) übertreffen alle lokal ausführbaren Modelle bei komplexen Denkaufgaben und Code-Aufgaben.',
...
schema: {
    ...
    fr: {
      ...
      leadAnswerBlock: '**Les LLMs locaux exécutent toutes les inférences sur votre propre matériel -- sans coût par token et avec une confidentialité totale.** Les APIs cloud (GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro) offrent une qualité supérieure avec une configuration minimale.',
      dateModified: '2026-04-12',
      publishDate: '2026-04-04',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Les APIs cloud (GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro) surpassent tous les modèles exécutables localement sur les tâches complexes de raisonnement et de code.',
...
schema: {
    ...
    ja: {
      ...
      leadAnswerBlock: '**ローカルLLMはトークンコストゼロ・完全なデータプライバシーで自社ハードウェア上で推論を実行します。** クラウドAPI（GPT-5.5、Claude Opus 4.7、Gemini 3.1 Pro）は最小限のセットアップで高品質な出力を提供します。',
      dateModified: '2026-04-12',
      publishDate: '2026-04-04',
      readTime: '8分で読める',
      gammaEmbedUrl: '/presentations/local-llms-vs-cloud-apis-static.html',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'クラウドAPI（GPT-5.5、Claude Opus 4.7、Gemini 3.1 Pro）は複雑な推論・コードタスクでローカル実行可能なすべてのモデルを上回ります。',
        ...
        costComparison: {
          ...
          content: [
            '**クラウドAPIは100万トークンあたり$0.15〜$60；ローカルLLMはハードウェア投資後$0/トークン。** クラウドAPIの価格はモデルティアによって異なります。2026年の代表的な100万トークンあたりの価格：GPT-5.5が入力$2.50/出力$10、Claude Opus 4.7が$3.00/$15、Gemini 3.1 Proが$1.25/$5、GPT-5.5 Miniが$0.15/$0.60。',
...
schema: {
    ...
    zh: {
      ...
      leadAnswerBlock: '**本地LLM在您自己的硬件上运行所有推理，token成本为零，数据完全私密。** 云端API（GPT-5.5、Claude Opus 4.7、Gemini 3.1 Pro）以最少的设置提供更高质量。',
      dateModified: '2026-04-12',
      publishDate: '2026-04-04',
      readTime: '阅读约8分钟',
      gammaEmbedUrl: '/presentations/local-llms-vs-cloud-apis-static.html',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '云端API（GPT-5.5、Claude Opus 4.7、Gemini 3.1 Pro）在复杂推理和代码任务上优于所有可本地运行的模型。',
        ...
        costComparison: {
          ...
          content: [
            '**云端API每百万token费用为$0.15-$60；本地LLM硬件投资后每token费用为$0。** 云端API价格因模型层级而异。2026年代表性价格（每百万token）：GPT-5.5输入$2.50/输出$10，Claude Opus 4.7 $3.00/$15，Gemini 3.1 Pro $1.25/$5，GPT-5.5 Mini $0.15/$0.60。',
