...
schema: {
  ...
  ar: {
    ...
    seoTitle: 'أمان نماذج LLM المحلية 2026: حافظ على خصوصية بياناتك',
    ...
    metaDescription: 'قائمة من 12 خطوة: عطّل القياس عن بُعد، تحقق من checksums، اعزل المنفذ 11434 وشفّر القرص. امتثال GDPR وHIPAA. إعداد معزول عن الشبكة (air-gapped).',
