...
schema: {
  ...
  es: {
    ...
    schema: {
      ...
      'url': 'https://www.promptquorum.com/es/es/local-llms/local-llm-security-privacy-checklist',
      'datePublished': '2026-04-04',
      'dateModified': '2026-04-18',
  ...
  ar: {
    ...
    seoTitle: 'قائمة أمان LLM المحلي: 12 خطوة لحماية بياناتك 2026',
    ...
    metaDescription: '12 خطوة في أقل من 10 دقائق: عطّل القياس عن بُعد في Ollama، تحقق من checksums، اعزل المنفذ 11434، فعّل تشفير القرص. يشمل GDPR وHIPAA والإعداد المعزول.',
  ...
  pt: {
    ...
    seoTitle: 'Segurança de LLMs locais 2026: mantenha seus dados privados',
    ...
    metaDescription: 'Lista de 12 passos: desative telemetria, verifique checksums, isole a porta 11434 e criptografe o disco. Conformidade LGPD e HIPAA. Configuração air-gapped.',
    publishDate: '2026-04-04',
    dateModified: '2026-04-18',
  ...
  de: {
    ...
    seoTitle: 'LLM-Sicherheit & Datenschutz-Checkliste 2026 (DSGVO)',
