...
schema: {
  ...
  ar: {
    ...
    twitterDescription: 'قائمة تحقق أمان لنماذج LLM المحلية في 12 خطوة: عطّل القياس عن بُعد، تحقق من checksums، اعزل المنفذ 11434، فعّل تشفير القرص. GDPR وHIPAA مُدرجان.',
    publishDate: '2026-04-04',
    dateModified: '2026-06-19',
