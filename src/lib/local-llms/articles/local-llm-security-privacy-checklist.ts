...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      metaDescription: '12-step checklist to secure a local LLM: disable telemetry, verify checksums, isolate port 11434, enable disk encryption. GDPR and HIPAA covered. April 2026.',
