...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      heroImage: '/images/how-to-install-lm-studio-overview-hero-en.png',
...
schema: {
    ...
    es: {
      ...
      heroImage: '/images/how-to-install-lm-studio-overview-hero-es.png',
    ...
    ar: {
      ...
      heroImage: '/images/how-to-install-lm-studio-overview-hero-ar.png',
    ...
    pt: {
      ...
      heroImage: '/images/how-to-install-lm-studio-overview-hero-pt.png',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            '[Como instalar Ollama](/pt/local-llms/how-to-install-ollama) -- Alternativa baseada em linha de comando.',
    ...
    de: {
      ...
      heroImage: '/images/how-to-install-lm-studio-overview-hero-de.png',
...
schema: {
    ...
    fr: {
      ...
      heroImage: '/images/how-to-install-lm-studio-overview-hero-fr.png',
...
schema: {
    ...
    ja: {
      ...
      heroImage: '/images/how-to-install-lm-studio-overview-hero-ja.png',
...
schema: {
    ...
    zh: {
      ...
      heroImage: '/images/how-to-install-lm-studio-overview-hero-zh.png',
...
schema: {
  ...
  ko: {
    ...
    heroImage: '/images/how-to-install-lm-studio-overview-hero-ko.png',
