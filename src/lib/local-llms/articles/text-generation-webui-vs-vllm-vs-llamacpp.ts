...
schema: {
    ...
    ar: {
      ...
      seoTitle: 'Text-Generation-WebUI مقابل vLLM مقابل llama.cpp',
      ...
      metaDescription: 'يهيمن vLLM على الإنتاج (أعلى إنتاجية)، ويشغّل llama.cpp تطبيق Ollama (الأخف)، وText-Generation-WebUI مثالي للبحث وLoRA. 2026.',
      publishDate: '2026-04-04',
