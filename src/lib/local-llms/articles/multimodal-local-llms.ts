      ...
      sections: {
        ...
        models: {
          ...
          rows: [
            ...
            { 'Model': 'Gemma 4 E2B', 'Image Support': 'Yes', 'VRAM': '~2 GB', 'Speed': '1-2 sec/image', 'Best For': 'Smallest / edge hardware' },
      ...
      sections: {
        ...
        models: {
          ...
          rows: [
            ...
            { 'Modelo': 'Gemma 4 E2B', 'Soporte de imagen': 'Sí', 'VRAM': '~2 GB', 'Velocidad': '1-2 seg/imagen', 'Mejor para': 'Hardware mínimo / edge' },
      ...
      sections: {
        ...
        models: {
          ...
          rows: [
            ...
            { 'Modelo': 'Gemma 4 E2B', 'Soporte de imagen': 'نعم', 'VRAM': '~2 GB', 'Velocidad': '1-2 ث/صورة', 'Mejor para': 'أصغر عتاد / edge' },
      ...
      sections: {
        ...
        models: {
          ...
          rows: [
            ...
            { 'Modell': 'Gemma 4 E2B', 'Bildunterstützung': 'Ja', 'VRAM': '~2 GB', 'Geschwindigkeit': '1-2 Sek./Bild', 'Am besten für': 'Minimalste Hardware / Edge' },
      ...
      sections: {
        ...
        models: {
          ...
          rows: [
            ...
            { 'Modèle': 'Gemma 4 E2B', 'Support d\'image': 'Oui', 'VRAM': '~2 GB', 'Vitesse': '1-2 sec/image', 'Idéal pour': 'Matériel minimal / edge' },
      ...
      sections: {
        ...
        models: {
          ...
          rows: [
            ...
            { 'モデル': 'Gemma 4 E2B', '画像サポート': 'はい', 'VRAM': '~2 GB', '速度': '1-2秒/画像', '最適用途': '最小構成/エッジ' },
      ...
      sections: {
        ...
        models: {
          ...
          rows: [
            ...
            { '模型': 'Gemma 4 E2B', '图像支持': '是', 'VRAM': '~2 GB', '速度': '1-2秒/图像', '最适用': '最小硬件/边缘设备' },
      ...
      sections: {
        ...
        models: {
          ...
          rows: [
            ...
            { 'Modelo': 'Gemma 4 E2B', 'Suporte a imagem': 'Sim', 'VRAM': '~2 GB', 'Velocidade': '1-2 seg/imagem', 'Melhor para': 'Hardware mínimo / edge' },
      ...
      sections: {
        ...
        models: {
          ...
          rows: [
            ...
            { 'Model': 'Gemma 4 E2B', 'Image Support': '지원', 'VRAM': '~2 GB', 'Speed': '이미지당 1-2초', 'Best For': '최소 하드웨어 / 엣지' },
