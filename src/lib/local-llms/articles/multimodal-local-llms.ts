...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      intro: 'Multimodal models process images, text, and audio. As of April 2026, Llama 3.2 Vision, Gemma 4, and Qwen2-VL are practical multimodal models for local deployment. They enable document OCR, image analysis, and visual question-answering without cloud APIs.',
      ...
      leadAnswerBlock: '**Multimodal models process images, text, and audio. As of April 2026, Llama 3.2 Vision, Gemma 4, and Qwen2-VL are practical multimodal models for local deployment.**',
    ...
    es: {
      ...
      intro: 'Los modelos multimodales procesan imágenes, texto y audio. A partir de abril de 2026, Llama 3.2 Vision, Gemma 4 y Qwen2-VL son modelos multimodales prácticos para implementación local. Permiten OCR de documentos, análisis de imágenes y preguntas y respuestas visuales sin APIs de nube.',
      ...
      publishDate: '2026-04-04',
      leadAnswerBlock: '**Los modelos multimodales procesan imágenes, texto y audio. A partir de abril de 2026, Llama 3.2 Vision, Gemma 4 y Qwen2-VL son modelos multimodales prácticos para implementación local.**',
    ...
    ar: {
      ...
      intro: 'تعالج النماذج متعددة الوسائط الصور والنص والصوت. اعتبارًا من أبريل 2026، Llama 3.2 Vision وGemma 4 وQwen2-VL نماذج متعددة الوسائط عملية للنشر المحلي. تتيح OCR للمستندات وتحليل الصور والأسئلة والأجوبة البصرية دون واجهات API سحابية.',
      ...
      publishDate: '2026-04-04',
      leadAnswerBlock: '**تعالج النماذج متعددة الوسائط الصور والنص والصوت. اعتبارًا من أبريل 2026، Llama 3.2 Vision وGemma 4 وQwen2-VL نماذج متعددة الوسائط عملية للنشر المحلي.**',
    ...
    de: {
      ...
      intro: 'Multimodale Modelle verarbeiten Bilder, Text und Audio. Ab April 2026 sind Llama 3.2 Vision, Gemma 4 und Qwen2-VL praktische multimodale Modelle für lokale Bereitstellung. Sie ermöglichen Dokumenten-OCR, Bildanalyse und visuelle Frage-Antwort-Verarbeitung ohne Cloud-APIs.',
      ...
      publishDate: '2026-04-04',
      leadAnswerBlock: '**Multimodale Modelle verarbeiten Bilder, Text und Audio. Ab April 2026 sind Llama 3.2 Vision, Gemma 4 und Qwen2-VL praktische multimodale Modelle für lokale Bereitstellung.**',
    ...
    fr: {
      ...
      intro: 'Les modèles multimodaux traitent images, texte et audio. Depuis avril 2026, Llama 3.2 Vision, Gemma 4 et Qwen2-VL sont des modèles multimodaux pratiques pour déploiement local. Ils activent OCR de documents, analyse d\'images et question-réponse visuelle sans API cloud.',
      ...
      publishDate: '2026-04-04',
      leadAnswerBlock: '**Les modèles multimodaux traitent images, texte et audio. Depuis avril 2026, Llama 3.2 Vision, Gemma 4 et Qwen2-VL sont des modèles multimodaux pratiques pour déploiement local.**',
    ...
    ja: {
      ...
      intro: 'マルチモーダルモデルは画像、テキスト、オーディオを処理します。2026年4月現在、Llama 3.2 Vision、Gemma 4、Qwen2-VLはローカル展開に実用的なマルチモーダルモデルです。クラウドAPIなしでドキュメントOCR、画像分析、視覚的質問応答が可能です。',
      metaDescription: 'マルチモーダルローカルLLM 2026: ビジョン、画像処理、OCR、オーディオモデル。LLaVA、Qwen-VLガイドと使用例。',
      publishDate: '2026-04-04',
      leadAnswerBlock: '**マルチモーダルモデルは画像、テキスト、オーディオを処理します。2026年4月現在、Llama 3.2 Vision、Gemma 4、Qwen2-VLはローカル展開に実用的なマルチモーダルモデルです。**',
    ...
    zh: {
      ...
      seoTitle: '多模态本地LLM',
      intro: '多模态模型处理图像、文本和音频。截至2026年4月，Llama 3.2 Vision、Gemma 4和Qwen2-VL是实用的本地部署多模态模型。它们支持文档OCR、图像分析和视觉问答，无需云API。',
      metaDescription: '多模态本地LLM 2026: 视觉、图像处理、OCR、音频模型。LLaVA、Qwen-VL指南和用例。',
      publishDate: '2026-04-04',
      leadAnswerBlock: '**多模态模型处理图像、文本和音频。截至2026年4月，Llama 3.2 Vision、Gemma 4和Qwen2-VL是实用的本地部署多模态模型。**',
    ...
    pt: {
      ...
      intro: 'Os modelos multimodais processam imagens, texto e áudio. A partir de abril de 2026, Llama 3.2 Vision, Gemma 4 e Qwen2-VL são modelos multimodais práticos para implantação local. Eles permitem OCR de documentos, análise de imagens e perguntas e respostas visuais sem APIs de nuvem.',
      ...
      publishDate: '2026-04-04',
      leadAnswerBlock: '**Os modelos multimodais processam imagens, texto e áudio. A partir de abril de 2026, Llama 3.2 Vision, Gemma 4 e Qwen2-VL são modelos multimodais práticos para implantação local.**',
  ...
  ko: {
    ...
    heroImage: '/images/multimodal-local-llms-overview-hero-ko.webp',
      ...
      intro: '멀티모달 모델은 이미지, 텍스트, 오디오를 처리합니다. 2026년 4월 기준으로 Llama 3.2 Vision, Gemma 4, Qwen2-VL은 로컬 배포에 실용적인 멀티모달 모델입니다. 이 모델들을 사용하면 클라우드 API 없이도 문서 OCR, 이미지 분석, 시각적 질의응답이 가능합니다.',
      metaDescription: '멀티모달 로컬 LLM 2026: 비전, 이미지 처리, OCR, 오디오 모델. LLaVA, Qwen-VL 가이드 및 활용 사례.',
      publishDate: '2026-04-04',
      leadAnswerBlock: '멀티모달 모델은 이미지, 텍스트, 오디오를 처리합니다. 2026년 4월 기준으로 Llama 3.2 Vision, Gemma 4, Qwen2-VL은 로컬 배포에 실용적인 멀티모달 모델입니다.',
