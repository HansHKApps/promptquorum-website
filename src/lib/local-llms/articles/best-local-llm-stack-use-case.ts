...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      heroImage: '/images/best-local-llm-stack-use-case-hardware-tier-hero-en.png',
      ...
      sections: {
        tldr: {
          ...
          image: '/images/best-local-llm-stack-use-case-use-case-picker-hero-en.png',
        ...
        'hardware': {
          ...
          image: '/images/best-local-llm-stack-use-case-hardware-tier-hero-en.png',
...
schema: {
        ...
        'description': 'Best local LLM stack by use case June 2026: Coding → vLLM + Qwen3-Coder. Writing → Ollama + Llama 3.3. RAG → LlamaIndex + Qdrant. Hardware tiers 8–24 GB VRAM. Complete setup guide.',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 6, 'name': 'Fine-Tuning & Research', 'description': 'HuggingFace Transformers + LoRA + Ollama/vLLM for inference. LoRA reduces VRAM footprint 10×. Train separately on dedicated hardware, serve on inference box. Llama 3.2 and Qwen3 recommended (Llama 3.3 deprecated as of June 2026).' },
    ...
    es: {
      ...
      heroImage: '/images/best-local-llm-stack-use-case-hardware-tier-hero-es.png',
      ...
      sections: {
        tldr: {
          ...
          image: '/images/best-local-llm-stack-use-case-use-case-picker-hero-es.png',
        ...
        'hardware': {
          ...
          image: '/images/best-local-llm-stack-use-case-hardware-tier-hero-es.png',
...
for filename, review in reviews:
    ...
    ar: {
      ...
      heroImage: '/images/best-local-llm-stack-use-case-hardware-tier-hero-ar.png',
      ...
      sections: {
        tldr: {
          ...
          image: '/images/best-local-llm-stack-use-case-use-case-picker-hero-ar.png',
        ...
        'hardware': {
          ...
          image: '/images/best-local-llm-stack-use-case-hardware-tier-hero-ar.png',
...
for filename, review in reviews:
    ...
    pt: {
      ...
      heroImage: '/images/best-local-llm-stack-use-case-hardware-tier-hero-pt.png',
      publishDate: '2026-04-05',
      ...
      sections: {
        tldr: {
          ...
          image: '/images/best-local-llm-stack-use-case-use-case-picker-hero-pt.png',
        ...
        hardware: {
          ...
          image: '/images/best-local-llm-stack-use-case-hardware-tier-hero-pt.png',
    ...
    de: {
      ...
      intro: '**Der beste lokale LLM-Stack hängt von Ihrem Workflow ab: Autoren benötigen Ollama + OpenWebUI + Llama 3.3, Entwickler benötigen vLLM + Qwen3-Coder + IDE-Erweiterung, Forscher benötigen LangGraph + vLLM. Stand June 2026 überzeugt kein einzelnes Tool in allen Bereichen.** Dieser Leitfaden ordnet 7 gängige Anwendungsfälle ihrem optimalen Stack (Backend + UI + Integrationen) und Hardware-Stufen (8–24 GB VRAM) zu.',
      metaDescription: 'Lokaler LLM-Stack nach Anwendungsfall June 2026: Coding → vLLM + Qwen3-Coder. Schreiben → Ollama + Llama 3.3. RAG → LlamaIndex + Qdrant. 8–24 GB VRAM.',
      heroImage: '/images/best-local-llm-stack-use-case-hardware-tier-hero-de.png',
      twitterDescription: 'Lokaler LLM-Stack nach Anwendungsfall: Coding → vLLM + Qwen3-Coder. Schreiben → Ollama + Llama 3.3. RAG → LlamaIndex + Qdrant. Agenten → LangGraph + vLLM. June 2026.',
      publishDate: '2026-04-05',
      dateModified: '2026-06-21',
      leadAnswerBlock: '**Der beste lokale LLM-Stack hängt von Ihrem Workflow ab: Autoren benötigen OpenWebUI + Llama 3, Entwickler benötigen vLLM + Python SDK, Forscher benötigen LangGraph + benutzerdefinierte Skripte. Stand June 2026: Kein einzelnes Tool ist in allem führend.**',
      ...
      sections: {
        tldr: {
          ...
          image: '/images/best-local-llm-stack-use-case-use-case-picker-hero-de.png',
          imageCaption: 'Bester Lokaler LLM-Stack nach Anwendungsfall -- Tools, die für die Aufgabe zusammenarbeiten',
        },
        'hardware': {
          id: 'hardware',
          title: 'Schnellentscheidung: Stack nach Hardware-Stufe (June 2026)',
          ...
          image: '/images/best-local-llm-stack-use-case-hardware-tier-hero-de.png',
        ...
        'coding': {
          ...
          content:  [
            ...
            'Warum dieser Stack: Qwen3-Coder erzielt 82% auf HumanEval (bestes Open-Source-Coding-Modell, June 2026). vLLM ist 3–5-fach schneller als Ollama für Batch-Inferenz. Native OpenAI-API-Kompatibilität passt zu bestehenden IDE-Tools. Streaming für Echtzeit-Vorschläge aktiviert.',
            '',
    ...
    print(f"=== {filename} ===\n{review}\n")`,
        ...
        'finetuning': {
          ...
          content: [
            ...
            '',
            '**Hinweis (June 2026):** Meta hat Llama 3.3 für kommerzielles Fine-Tuning eingestellt. Fine-Tuning auf Llama 3.2 (`meta-llama/Llama-3.2-1B` oder größer) oder Qwen3 (`Qwen/Qwen3-7B`) für Apache 2.0 / Open-Source-Lizenzbedingungen durchführen. Beide unterstützen LoRA und werden in Ollama problemlos geladen.',
          ],
          numberedItems: [
...
schema: {
        ...
        'description': 'Lokaler LLM-Stack nach Anwendungsfall June 2026: Coding → vLLM + Qwen3-Coder. Schreiben → Ollama + Llama 3.3. RAG → LlamaIndex + Qdrant. 8–24 GB VRAM.',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 6, 'name': 'Fine-Tuning & Forschung', 'description': 'HuggingFace Transformers + LoRA + Ollama/vLLM für Inferenz. LoRA reduziert VRAM-Bedarf um das 10-Fache. Separat trainieren, auf Inferenz-Box deployen. Llama 3.2 und Qwen3 empfohlen (Llama 3.3 ab June 2026 eingestellt).' },
    ...
    fr: {
      ...
      heroImage: '/images/best-local-llm-stack-use-case-hardware-tier-hero-fr.png',
      ...
      sections: {
        tldr: {
          ...
          image: '/images/best-local-llm-stack-use-case-use-case-picker-hero-fr.png',
        ...
        'hardware': {
          ...
          image: '/images/best-local-llm-stack-use-case-hardware-tier-hero-fr.png',
...
schema: {
    ...
    ja: {
      ...
      heroImage: '/images/best-local-llm-stack-use-case-hardware-tier-hero-ja.png',
      ...
      sections: {
        tldr: {
          ...
          image: '/images/best-local-llm-stack-use-case-use-case-picker-hero-ja.png',
        ...
        'hardware': {
          ...
          image: '/images/best-local-llm-stack-use-case-hardware-tier-hero-ja.png',
...
schema: {
    ...
    zh: {
      ...
      heroImage: '/images/best-local-llm-stack-use-case-hardware-tier-hero-zh.png',
      ...
      sections: {
        tldr: {
          ...
          image: '/images/best-local-llm-stack-use-case-use-case-picker-hero-zh.png',
        ...
        'hardware': {
          ...
          image: '/images/best-local-llm-stack-use-case-hardware-tier-hero-zh.png',
...
schema: {
  ...
  heroImage: '/images/best-local-llm-stack-use-case-hardware-tier-hero-ko.png',
  ...
  sections: {
    tldr: {
      ...
      image: '/images/best-local-llm-stack-use-case-use-case-picker-hero-ko.png',
    ...
    'hardware': {
      ...
      image: '/images/best-local-llm-stack-use-case-hardware-tier-hero-ko.png',
