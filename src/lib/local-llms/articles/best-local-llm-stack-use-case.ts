...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      intro: '**The best local LLM stack depends on your workflow: writers need Ollama + OpenWebUI + Llama 3.3, developers need vLLM + Qwen3-Coder + IDE extension, researchers need LangGraph + vLLM. No single tool excels at everything.** This guide maps 7 common use cases to their optimal stack (backend + UI + integrations) and hardware tiers (8–24 GB VRAM).',
      metaDescription: 'Coding: vLLM + Qwen3-Coder. Writing: Ollama + Llama 3.3. RAG: LlamaIndex + Qdrant + Qwen3. Agents: CrewAI. VRAM tiers 8–24 GB with setup commands. 2026.',
      ...
      leadAnswerBlock: '**The best local LLM stack depends on your workflow: writers need OpenWebUI + Llama 3.3, developers need vLLM + Python SDK, researchers need LangGraph + custom scripts. No single tool excels at everything.**',
      ...
      sections: {
        tldr: {
          ...
          image: '/images/best-local-llm-stack-use-case-use-case-picker-hero-en.webp',
          imageCaption: 'Best Local LLM Stack by Use Case -- Tools that work together for the job',
        },
        'hardware': {
          id: 'hardware',
          ...
          rows: [
            ...
            { 'Your Hardware': '12 GB VRAM (RTX 3060, RTX 4070)', 'Writing': 'Ollama + Llama 3.1 8B', 'Coding': 'vLLM + Qwen3-Coder-7B', 'RAG': 'LlamaIndex + Llama 3.1 8B', 'Agents': 'LangGraph + Ollama (slower)' },
          ...
          image: '/images/best-local-llm-stack-use-case-hardware-tier-hero-en.webp',
          imageCaption: 'Best Stack by Hardware Tier -- Match GPU/VRAM to the optimal stack',
        },
        'writing': {
          id: 'writing',
          content: [
...
schema: {
        ...
        'description': 'Best local LLM stack by use case Juni 2026: Coding → vLLM + Qwen3-Coder. Writing → Ollama + Llama 3.3. RAG → LlamaIndex + Qdrant. Hardware tiers 8–24 GB VRAM. Complete setup guide.',
      ...
      itemListSchema: {
        ...
        'numberOfItems': 7,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'Writing & Content Creation', 'description': 'Ollama + OpenWebUI + Llama 3.3 (24GB) or Llama 3.1 8B (8GB). Best for long-form writing with adjustable 8K–32K context windows. Simple setup, no coding required. Best chat UX among local LLM frontends.' },
          ...
          { '@type': 'ListItem', 'position': 6, 'name': 'Fine-Tuning & Research', 'description': 'HuggingFace Transformers + LoRA + Ollama/vLLM for inference. LoRA reduces VRAM footprint 10×. Train separately on dedicated hardware, serve on inference box. Llama 3.2 and Qwen3 recommended (Llama 3.3 deprecated as of Juni 2026).' },
    ...
    es: {
      ...
      intro: '**El mejor stack de LLM local depende de tu flujo de trabajo: escritura → Ollama + OpenWebUI + Llama 3.3, desarrollo → vLLM + Qwen3-Coder + extensión IDE, investigación → LangGraph + vLLM. En junio de 2026, ninguna herramienta lo hace todo bien.** Esta guía mapea 7 casos de uso comunes a su stack óptimo (backend + UI + integraciones) y niveles de hardware (8–24 GB VRAM).',
      ...
      heroImage: '/images/best-local-llm-stack-use-case-hardware-tier-hero-es.webp',
      ...
      publishDate: '2026-04-05',
      dateModified: '2026-08-28',
      leadAnswerBlock: '**El mejor stack de LLM local depende de tu flujo de trabajo: escritores necesitan OpenWebUI + Llama 3, desarrolladores necesitan vLLM + Python SDK, investigadores necesitan LangGraph + scripts personalizados. En junio de 2026, ninguna herramienta es líder en todo.**',
      ...
      sections: {
        tldr: {
          ...
          image: '/images/best-local-llm-stack-use-case-use-case-picker-hero-es.webp',
          imageCaption: 'Mejor Stack de LLM Local por Caso de Uso -- Herramientas que trabajan juntas para la tarea',
        },
        'hardware': {
          id: 'hardware',
          ...
          rows: [
            ...
            { 'Tu hardware': '12 GB VRAM (RTX 3060, RTX 4070)', 'Escritura': 'Ollama + Llama 3.1 8B', 'Código': 'vLLM + Qwen3-Coder-7B', 'RAG': 'LlamaIndex + Llama 3.1 8B', 'Agentes': 'LangGraph + Ollama (más lento)' },
          ...
          image: '/images/best-local-llm-stack-use-case-hardware-tier-hero-es.webp',
          imageCaption: 'Mejor Stack por Nivel de Hardware -- Ajusta GPU/VRAM al stack óptimo',
        },
        'writing': {
          id: 'writing',
          content: [
...
for filename, review in reviews:
    ...
    ar: {
      ...
      intro: '**أفضل منظومة LLM محلية تعتمد على سير عملك: الكتابة ← Ollama + OpenWebUI + Llama 3.3، التطوير ← vLLM + Qwen3-Coder + امتداد IDE، البحث ← LangGraph + vLLM. في يونيو 2026، لا توجد أداة واحدة تتقن كل شيء.** يربط هذا الدليل 7 حالات استخدام شائعة بمنظومتها المثلى (الخلفية + الواجهة + التكاملات) وفئات العتاد (8–24 GB VRAM).',
      ...
      heroImage: '/images/best-local-llm-stack-use-case-hardware-tier-hero-ar.webp',
      ...
      publishDate: '2026-04-05',
      dateModified: '2026-08-28',
      leadAnswerBlock: '**أفضل منظومة LLM محلية تعتمد على سير عملك: الكتّاب يحتاجون OpenWebUI + Llama 3، والمطورون يحتاجون vLLM + Python SDK، والباحثون يحتاجون LangGraph + سكربتات مخصصة. في يونيو 2026، لا توجد أداة واحدة رائدة في كل شيء.**',
      ...
      sections: {
        tldr: {
          ...
          image: '/images/best-local-llm-stack-use-case-use-case-picker-hero-ar.webp',
          imageCaption: 'أفضل حزمة LLM محلية حسب حالة الاستخدام -- أدوات تعمل معًا لأداء المهمة',
        },
        'hardware': {
          id: 'hardware',
          ...
          rows: [
            ...
            { 'عتادك': '12 GB VRAM (RTX 3060, RTX 4070)', 'الكتابة': 'Ollama + Llama 3.1 8B', 'البرمجة': 'vLLM + Qwen3-Coder-7B', 'RAG': 'LlamaIndex + Llama 3.1 8B', 'الوكلاء': 'LangGraph + Ollama (أبطأ)' },
          ...
          image: '/images/best-local-llm-stack-use-case-hardware-tier-hero-ar.webp',
          imageCaption: 'أفضل حزمة حسب فئة الجهاز -- طابق GPU/الذاكرة مع الحزمة المثلى',
        },
        'writing': {
          id: 'writing',
          content: [
        ...
        'coding': {
          ...
          content:  [
            ...
            'لماذا هذه المنظومة: يحقق Qwen3-Coder نسبة 82% في HumanEval (أفضل نموذج برمجي مفتوح المصدر، يونيو 2026). vLLM أسرع بمقدار 3–5× من Ollama للاستدلال بالدفعات. التوافق الأصلي مع API من OpenAI يناسب أدوات IDE الحالية. streaming مُفعَّل للاقتراحات في الوقت الفعلي.',
            '',
...
for filename, review in reviews:
    print(f"=== {filename} ===\n{review}\n")`,
      ...
      schema: {
        ...
        'description': 'أفضل منظومة LLM محلية حسب حالة الاستخدام يونيو 2026: البرمجة ← vLLM + Qwen3-Coder. الكتابة ← Ollama + Llama 3.3. RAG ← LlamaIndex + Qdrant. VRAM 8–24 GB. دليل تهيئة شامل.',
      ...
      itemListSchema: {
        ...
        'numberOfItems': 7,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'الكتابة وإنشاء المحتوى', 'description': 'Ollama + OpenWebUI + Llama 3.3 (24 GB) أو Llama 3.1 8B (8 GB). مثالي لكتابة النصوص الطويلة بنوافذ سياق قابلة للضبط 8K–32K. تهيئة بسيطة، دون حاجة إلى كود. أفضل تجربة دردشة بين واجهات LLM المحلية.' },
          ...
          { '@type': 'ListItem', 'position': 6, 'name': 'fine-tuning والبحث', 'description': 'HuggingFace Transformers + LoRA + Ollama/vLLM للاستدلال. يقلّل LoRA استخدام VRAM بمقدار 10×. درّب منفصلاً على عتاد مخصص، وقدّم الخدمة على جهاز الاستدلال. يُوصى بـ Llama 3.2 وQwen3 (Llama 3.3 موقوف منذ يونيو 2026).' },
    ...
    pt: {
      ...
      intro: '**O melhor stack de LLM local depende do seu fluxo de trabalho: escrita → Ollama + OpenWebUI + Llama 3.3, desenvolvimento → vLLM + Qwen3-Coder + extensão IDE, pesquisa → LangGraph + vLLM. Em junho de 2026, nenhuma ferramenta faz tudo bem.** Este guia mapeia 7 casos de uso comuns para o stack ideal (backend + UI + integrações) e níveis de hardware (8-24 GB VRAM).',
      ...
      heroImage: '/images/best-local-llm-stack-use-case-hardware-tier-hero-pt.webp',
      publishDate: '2026-04-05',
      dateModified: '2026-08-28',
      leadAnswerBlock: '**O melhor stack de LLM local depende do seu fluxo de trabalho: escritores precisam de OpenWebUI + Llama 3, desenvolvedores precisam de vLLM + Python SDK, pesquisadores precisam de LangGraph + scripts personalizados. Em junho de 2026, nenhuma ferramenta lidera em tudo.**',
      ...
      sections: {
        tldr: {
          ...
          image: '/images/best-local-llm-stack-use-case-use-case-picker-hero-pt.webp',
          imageCaption: 'Melhor Stack de LLM Local por Caso de Uso -- Ferramentas que trabalham juntas para a tarefa',
        },
        hardware: {
          id: 'hardware',
          ...
          rows: [
            ...
            { 'Seu hardware': '12 GB VRAM (RTX 3060, RTX 4070)', 'Escrita': 'Ollama + Llama 3.1 8B', 'Código': 'vLLM + Qwen3-Coder-7B', 'RAG': 'LlamaIndex + Llama 3.1 8B', 'Agentes': 'LangGraph + Ollama (mais lento)' },
          ...
          image: '/images/best-local-llm-stack-use-case-hardware-tier-hero-pt.webp',
          imageCaption: 'Melhor Stack por Nível de Hardware -- Combine GPU/VRAM com o stack ideal',
        },
        writing: {
          id: 'writing',
          content: [
      ...
      itemListSchema: {
        ...
        numberOfItems: 7,
        itemListElement: [
          { '@type': 'ListItem', position: 1, name: 'Escrita e Criação de Conteúdo', description: 'Ollama + OpenWebUI + Llama 3.3 (24GB) ou Llama 3.1 8B (8GB). Ideal para textos longos com janelas de contexto ajustáveis de 8K–32K. Configuração simples, sem necessidade de código.' },
      ...
      faqSchema: {
        ...
        inLanguage: 'pt-BR',
        mainEntity: [
          { '@type': 'Question', name: 'Qual stack de LLM local é melhor para desenvolvimento em Python?', acceptedAnswer: { '@type': 'Answer', text: 'vLLM + Qwen3-Coder-14B + Continue.dev é o melhor stack para desenvolvimento Python em 2026. Qwen3-Coder obtém 82% no HumanEval, vLLM fornece inferência rápida com API compatível com OpenAI.' } },
          { '@type': 'Question', name: 'Como implementar RAG em português com LLMs locais?', acceptedAnswer: { '@type': 'Answer', text: 'Use LlamaIndex + Ollama + Qdrant. Para documentos em português, use um modelo de embedding multilíngue (ex: multilingual-e5-large) e Llama 3.3 ou Qwen3 como modelo de geração. Ambos têm bom suporte para português.' } },
          { '@type': 'Question', name: 'O stack local precisa de conexão à internet?', acceptedAnswer: { '@type': 'Answer', text: 'Não. Todos os componentes desta lista (Ollama, vLLM, LlamaIndex, Qdrant, Open WebUI) funcionam totalmente offline. Ideal para ambientes com requisitos de conformidade com LGPD.' } },
        ],
      },
    },
    de: {
      ...
      intro: '**Der beste lokale LLM-Stack hängt von Ihrem Workflow ab: Autoren benötigen Ollama + OpenWebUI + Llama 3.3, Entwickler benötigen vLLM + Qwen3-Coder + IDE-Erweiterung, Forscher benötigen LangGraph + vLLM. Stand Juni 2026 überzeugt kein einzelnes Tool in allen Bereichen.** Dieser Leitfaden ordnet 7 gängige Anwendungsfälle ihrem optimalen Stack (Backend + UI + Integrationen) und Hardware-Stufen (8–24 GB VRAM) zu.',
      metaDescription: 'Lokaler LLM-Stack nach Anwendungsfall Juni 2026: Coding → vLLM + Qwen3-Coder. Schreiben → Ollama + Llama 3.3. RAG → LlamaIndex + Qdrant. 8–24 GB VRAM.',
      heroImage: '/images/best-local-llm-stack-use-case-hardware-tier-hero-de.webp',
      twitterDescription: 'Lokaler LLM-Stack nach Anwendungsfall: Coding → vLLM + Qwen3-Coder. Schreiben → Ollama + Llama 3.3. RAG → LlamaIndex + Qdrant. Agenten → LangGraph + vLLM. Juni 2026.',
      publishDate: '2026-04-05',
      dateModified: '2026-08-28',
      leadAnswerBlock: '**Der beste lokale LLM-Stack hängt von Ihrem Workflow ab: Autoren benötigen OpenWebUI + Llama 3, Entwickler benötigen vLLM + Python SDK, Forscher benötigen LangGraph + benutzerdefinierte Skripte. Stand Juni 2026: Kein einzelnes Tool ist in allem führend.**',
      ...
      sections: {
        tldr: {
          ...
          image: '/images/best-local-llm-stack-use-case-use-case-picker-hero-de.webp',
          imageCaption: 'Bester Lokaler LLM-Stack nach Anwendungsfall -- Tools, die für die Aufgabe zusammenarbeiten',
        },
        'hardware': {
          id: 'hardware',
          ...
          rows: [
            ...
            { 'Ihre Hardware': '12 GB VRAM (RTX 3060, RTX 4070)', 'Schreiben': 'Ollama + Llama 3.1 8B', 'Coding': 'vLLM + Qwen3-Coder-7B', 'RAG': 'LlamaIndex + Llama 3.1 8B', 'Agenten': 'LangGraph + Ollama (langsamer)' },
          ...
          image: '/images/best-local-llm-stack-use-case-hardware-tier-hero-de.webp',
          imageCaption: 'Bester Stack nach Hardware-Klasse -- GPU/VRAM zum optimalen Stack passen',
        },
        'writing': {
          id: 'writing',
          content: [
        ...
        'coding': {
          ...
          content:  [
            ...
            'Warum dieser Stack: Qwen3-Coder erzielt 82% auf HumanEval (bestes Open-Source-Coding-Modell, Juni 2026). vLLM ist 3–5-fach schneller als Ollama für Batch-Inferenz. Native OpenAI-API-Kompatibilität passt zu bestehenden IDE-Tools. Streaming für Echtzeit-Vorschläge aktiviert.',
            '',
...
schema: {
        ...
        'description': 'Lokaler LLM-Stack nach Anwendungsfall Juni 2026: Coding → vLLM + Qwen3-Coder. Schreiben → Ollama + Llama 3.3. RAG → LlamaIndex + Qdrant. 8–24 GB VRAM.',
      ...
      itemListSchema: {
        ...
        'numberOfItems': 7,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'Schreiben & Content-Erstellung', 'description': 'Ollama + OpenWebUI + Llama 3.3 (24 GB) oder Llama 3.1 8B (8 GB). Bestens für langes Schreiben mit einstellbaren 8K–32K-Kontextfenstern. Einfache Einrichtung, kein Coding erforderlich. Beste Chat-UX unter lokalen LLM-Frontends.' },
          ...
          { '@type': 'ListItem', 'position': 6, 'name': 'Fine-Tuning & Forschung', 'description': 'HuggingFace Transformers + LoRA + Ollama/vLLM für Inferenz. LoRA reduziert VRAM-Bedarf um das 10-Fache. Separat trainieren, auf Inferenz-Box deployen. Llama 3.2 und Qwen3 empfohlen (Llama 3.3 ab Juni 2026 eingestellt).' },
    ...
    fr: {
      ...
      intro: '**Le meilleur stack LLM local dépend de votre flux de travail : rédaction → Ollama + OpenWebUI + Llama 3.3, développement → vLLM + Qwen3-Coder + extension IDE, recherche → LangGraph + vLLM. En juin 2026, aucun outil ne couvre tous les cas d\'usage.** Ce guide associe 7 cas d\'usage courants à leur stack optimal (backend + interface + intégrations) et aux niveaux matériels requis (8–24 Go VRAM).',
      metaDescription: 'Stack LLM local par cas d\'usage juin 2026 : Coding → vLLM + Qwen3-Coder. Rédaction → Ollama + Llama 3.3. RAG → LlamaIndex + Qdrant. 8–24 Go VRAM. Guide complet.',
      heroImage: '/images/best-local-llm-stack-use-case-hardware-tier-hero-fr.webp',
      ...
      publishDate: '2026-04-05',
      dateModified: '2026-08-28',
      leadAnswerBlock: '**Le meilleur stack LLM local dépend de votre flux de travail : rédacteurs → OpenWebUI + Llama 3, développeurs → vLLM + SDK Python, chercheurs → LangGraph + scripts personnalisés. En juin 2026, aucun outil ne couvre tout.**',
      ...
      sections: {
        tldr: {
          ...
          image: '/images/best-local-llm-stack-use-case-use-case-picker-hero-fr.webp',
          imageCaption: 'Meilleure Stack LLM Locale par Cas d\'Usage -- Outils qui fonctionnent ensemble pour la tâche',
        },
        'hardware': {
          id: 'hardware',
          ...
          rows: [
            ...
            { 'Votre matériel': '12 Go VRAM (RTX 3060, RTX 4070)', 'Rédaction': 'Ollama + Llama 3.1 8B', 'Coding': 'vLLM + Qwen3-Coder-7B', 'RAG': 'LlamaIndex + Llama 3.1 8B', 'Agents': 'LangGraph + Ollama (plus lent)' },
          ...
          image: '/images/best-local-llm-stack-use-case-hardware-tier-hero-fr.webp',
          imageCaption: 'Meilleure Stack par Niveau de Matériel -- Adaptez GPU/VRAM à la stack optimale',
        },
        'writing': {
          id: 'writing',
          content: [
        ...
        'coding': {
          ...
          content:  [
            ...
            'Pourquoi ce stack : Qwen3-Coder obtient 82 % sur HumanEval (meilleur modèle de coding open-source, juin 2026). vLLM est 3–5× plus rapide qu\'Ollama pour l\'inférence par lots. Compatibilité OpenAI API native avec les outils IDE existants. Streaming activé pour les suggestions en temps réel.',
            '',
...
schema: {
        ...
        'description': 'Stack LLM local par cas d\'usage juin 2026 : Coding → vLLM + Qwen3-Coder. Rédaction → Ollama + Llama 3.3. RAG → LlamaIndex + Qdrant. 8–24 Go VRAM. Guide complet.',
      ...
      itemListSchema: {
        ...
        'numberOfItems': 7,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'Rédaction & création de contenu', 'description': 'Ollama + OpenWebUI + Llama 3.3 (24 Go) ou Llama 3.1 8B (8 Go). Idéal pour la rédaction longue avec fenêtres de contexte ajustables 8K–32K. Configuration simple, aucun code requis. Meilleure UX chat parmi les interfaces LLM locales.' },
          ...
          { '@type': 'ListItem', 'position': 6, 'name': 'Fine-tuning & recherche', 'description': 'HuggingFace Transformers + LoRA + Ollama/vLLM pour l\'inférence. LoRA réduit l\'empreinte VRAM par 10×. Entraînez séparément sur du matériel dédié, servez sur la machine d\'inférence. Llama 3.2 et Qwen3 recommandés (Llama 3.3 déprécié depuis juin 2026).' },
    ...
    ja: {
      ...
      intro: '**最適なローカルLLMスタックはワークフロー次第で決まる：ライティング→Ollama + OpenWebUI + Llama 3.3、開発→vLLM + Qwen3-Coder + IDE拡張、研究→LangGraph + vLLM。2026年6月現在、すべてのユースケースをカバーする単一ツールは存在しない。** 本ガイドは7つの主要ユースケースを最適スタック（backend + UI + インテグレーション）とハードウェア層（8–24 GB VRAM）にマッピングします。',
      metaDescription: 'ユースケース別ローカルLLMスタック2026年6月：コーディング→vLLM + Qwen3-Coder。ライティング→Ollama + Llama 3.3。RAG→LlamaIndex + Qdrant。VRAM 8–24 GB対応。完全セットアップガイド。',
      heroImage: '/images/best-local-llm-stack-use-case-hardware-tier-hero-ja.webp',
      twitterDescription: 'ユースケース別ローカルLLMスタック：コーディング→vLLM + Qwen3-Coder。ライティング→Ollama + Llama 3.3。RAG→LlamaIndex + Qdrant。エージェント→LangGraph + vLLM。2026年6月版。',
      publishDate: '2026-04-05',
      dateModified: '2026-08-28',
      leadAnswerBlock: '**最適スタックはワークフロー次第：ライター→OpenWebUI + Llama 3、開発者→vLLM + Python SDK、研究者→LangGraph + カスタムスクリプト。2026年6月現在、すべてをカバーする単一ツールはない。**',
      ...
      sections: {
        tldr: {
          ...
          image: '/images/best-local-llm-stack-use-case-use-case-picker-hero-ja.webp',
          imageCaption: '用途別ベストローカルLLMスタック -- 目的のために連携するツール',
        },
        'hardware': {
          id: 'hardware',
          title: 'ハードウェア別判断テーブル',
          ...
          rows: [
            ...
            { 'お使いのハード': '12 GB VRAM（RTX 3060、RTX 4070）', 'ライティング': 'Ollama + Llama 3.1 8B', 'コーディング': 'vLLM + Qwen3-Coder-7B', 'RAG': 'LlamaIndex + Llama 3.1 8B', 'エージェント': 'LangGraph + Ollama（低速）' },
          ...
          image: '/images/best-local-llm-stack-use-case-hardware-tier-hero-ja.webp',
          imageCaption: 'ハードウェア階層別ベストスタック -- GPU/VRAMを最適なスタックに合わせる',
        },
        'writing': {
          id: 'writing',
          content: [
        ...
        'coding': {
          ...
          content:  [
            ...
            'Qwen3-CoderはHumanEvalで82％（2026年6月現在最高のオープンソースコーディングモデル）。vLLMはバッチ推論でOllamaよ3–5倍高速。既存IDEツールとのネイティブOpenAI API互换性。リアルタイム潔歋候補のストリーミング有効。',
            '',
            '**複数ファイルの並列コードレビュー**',
...
schema: {
        ...
        'description': 'ユースケース別ローカルLLMスタック2026年6月：コーディング→vLLM + Qwen3-Coder。ライティング→Ollama + Llama 3.3。RAG→LlamaIndex + Qdrant。VRAM 8–24 GB対応。',
      ...
      itemListSchema: {
        ...
        'numberOfItems': 7,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'ライティング & コンテンツ作成', 'description': 'Ollama + OpenWebUI + Llama 3.3（24 GB）またはLlama 3.1 8B（8 GB）。調整可能なコンテキストウィンドウ（8K–32K）で長文ライティングに最適。シンプルな設定、コード不要。ローカルLLMフロントエンドの中で最高のUX。' },
          ...
          { '@type': 'ListItem', 'position': 6, 'name': 'ファインチューニング & 研究', 'description': 'HuggingFace Transformers + LoRA + Ollama/vLLM（推論）。LoRAはVRAMフットプリントを１０分の１に削減。専用ハードで別流トレーニング、推論マシンでserving。Llama 3.2とQwen3推奨（2026年6月以降Llama 3.3は非推奨）。' },
    ...
    zh: {
      ...
      intro: '**最佳本地LLM堆栈取决于具体工作流：内容写作→Ollama + OpenWebUI + Llama 3.3，软件开发→vLLM + Qwen3-Coder + IDE插件，程式研究→LangGraph + vLLM。2026年6月更新：无单一工具能涵盖所有场景。** 本指南将的7个常见用途与最佳堆栈（后端 + UI + 集成）及硬件配置（8–24 GB显存）一一对应。',
      metaDescription: '按用途本地LLM堆捨2026年6月：编程→vLLM+Qwen3-Coder，写作→Ollama+Llama 3.3，RAG→LlamaIndex+Qdrant。8-24GB显存。完整配置指南。',
      heroImage: '/images/best-local-llm-stack-use-case-hardware-tier-hero-zh.webp',
      twitterDescription: '本地LLM堆栈：编程→vLLM+Qwen3-Coder，写作→Ollama+Llama 3.3，RAG→LlamaIndex+Qdrant，智能体→LangGraph+vLLM。2026年6月。',
      publishDate: '2026-04-05',
      dateModified: '2026-08-28',
      leadAnswerBlock: '**最佳堆栈取决于工作流：内容创作者→OpenWebUI + Llama 3，开发者→vLLM + Python SDK，研究人员→LangGraph + 自定义脚本。2026年6月：没有万能工具。**',
      ...
      sections: {
        tldr: {
          ...
          image: '/images/best-local-llm-stack-use-case-use-case-picker-hero-zh.webp',
          imageCaption: '按用途划分的最佳本地LLM技术栈 -- 为特定任务协同工作的工具组合',
        },
        'hardware': {
          id: 'hardware',
          title: '硬件分级决策表',
          ...
          rows: [
            ...
            { '您的硬件': '12 GB显存（RTX 3060、RTX 4070）', '写作': 'Ollama + Llama 3.1 8B', '编程': 'vLLM + Qwen3-Coder-7B', 'RAG': 'LlamaIndex + Llama 3.1 8B', '智能体': 'LangGraph + Ollama（较慢）' },
          ...
          image: '/images/best-local-llm-stack-use-case-hardware-tier-hero-zh.webp',
          imageCaption: '按硬件档位划分的最佳技术栈 -- 将GPU/显存匹配到最佳技术栈',
        },
        'writing': {
          id: 'writing',
          content: [
        ...
        'coding': {
          ...
          content:  [
            ...
            'Qwen3-Coder在HumanEval得劆8剸2%（2026年6月最佳开源代码模型）。vLLM批量推理比Ollama快3–5倍。原生OpenAI API兼容，完美适配现有IDE工具。实时补全流式传输已启用。',
            '',
            '**多文件并行代码审查**',
...
schema: {
        ...
        'description': '按用途本地LLM堆捨2026年6月：编程→vLLM+Qwen3-Coder，写作→Ollama+Llama 3.3，RAG→LlamaIndex+Qdrant。8-24 GB显存。完整配置指南。',
      ...
      itemListSchema: {
        ...
        'numberOfItems': 7,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': '写作 & 内容创作', 'description': 'Ollama + OpenWebUI + Llama 3.3（24 GB）或Llama 3.1 8B（8 GB）。可调节的上下文窗口（8K–32K）适合长文写作。配置简单，无需编程。本地LLM前端中最佳聊天体验。' },
          ...
          { '@type': 'ListItem', 'position': 6, 'name': '微调 & 研究', 'description': 'HuggingFace Transformers + LoRA + Ollama/vLLM推理。LoRA将显存占用减小10倍。在层用硬件单独训练，在推理机器serving。推荐Llama 3.2和Qwen3（2026年6月起Llama 3.3已不推荐）。' },
  ...
  intro: '**최적의 로컬 LLM 스택은 워크플로에 따라 다릅니다. 작가에게는 Ollama + OpenWebUI + Llama 3.3, 개발자에게는 vLLM + Qwen3-Coder + IDE 확장, 연구자에게는 LangGraph + vLLM이 적합합니다. 2026년 6월 기준, 모든 영역에서 우수한 단일 도구는 존재하지 않습니다.** 이 가이드는 7가지 일반적인 사용 사례를 최적의 스택(백엔드 + UI + 통합)과 하드웨어 등급(VRAM 8~24 GB)에 매핑합니다.',
  ...
  itemListSchema: {
    ...
    numberOfItems: 7,
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: '글쓰기 및 콘텐츠 제작', description: 'Ollama + OpenWebUI + Llama 3.3 (24GB) 또는 Llama 3.1 8B (8GB). 8K–32K 조절 가능한 컨텍스트 윈도우로 장문 작성에 최적. 코딩 불필요, 간단한 설정.' },
  ...
  faqSchema: {
    ...
    inLanguage: 'ko',
    mainEntity: [
      { '@type': 'Question', name: 'Ollama와 vLLM 중 어떤 것을 사용해야 합니까?', acceptedAnswer: { '@type': 'Answer', text: 'Ollama는 채팅 UI와 간편함에 적합합니다. vLLM은 API 서버, 배치 처리, 성능에 적합합니다. 상호 배타적이지 않으므로 둘 다 실행할 수 있습니다.' } },
      { '@type': 'Question', name: 'Ollama를 프로덕션 API에 사용할 수 있습니까?', acceptedAnswer: { '@type': 'Answer', text: '예, 하지만 vLLM이 더 빠릅니다(처리량 3~5배 높음). Ollama는 초당 10건 미만 요청에 적합합니다. 초당 10건 이상에는 vLLM을 사용하십시오.' } },
      { '@type': 'Question', name: '코드 리뷰에 가장 적합한 로컬 LLM은 무엇입니까?', acceptedAnswer: { '@type': 'Answer', text: 'vLLM + Qwen3-Coder-7B-Instruct입니다. Qwen3-Coder는 HumanEval에서 82%를 기록합니다(최고의 오픈소스). vLLM은 10개 파일을 병렬로 처리합니다. RTX 3060 12GB에서 약 30~50 tok/sec입니다.' } },
      { '@type': 'Question', name: '간단한 RAG에 벡터 DB가 필요합니까?', acceptedAnswer: { '@type': 'Answer', text: '문서 100개 미만의 경우: 인메모리 임베딩(np.ndarray)으로 충분합니다. 100개 이상의 경우: 메모리 과부하를 방지하기 위해 Qdrant 또는 Weaviate를 사용하십시오.' } },
      { '@type': 'Question', name: 'LangGraph는 간단한 챗봇에 과도합니까?', acceptedAnswer: { '@type': 'Answer', text: '예. Ollama 또는 vLLM만 사용하십시오. LangGraph는 다단계 워크플로(에이전트 루프, 계획)를 위한 것입니다.' } },
      { '@type': 'Question', name: 'Ollama와 vLLM 백엔드를 혼합할 수 있습니까?', acceptedAnswer: { '@type': 'Answer', text: '예. 예를 들어, Ollama는 채팅 UI용, vLLM은 배치 API용으로 사용합니다. 같은 머신에서 서로 다른 포트로 실행할 수 있습니다.' } },
    ],
  },
  sections: {
    tldr: {
      ...
      image: '/images/best-local-llm-stack-use-case-use-case-picker-hero-ko.webp',
      imageCaption: '사용 사례별 최고의 로컬 LLM 스택 -- 작업을 위해 함께 작동하는 도구들',
    },
    'hardware': {
      id: 'hardware',
      ...
      rows: [
        ...
        { '하드웨어': '12 GB VRAM (RTX 3060, RTX 4070)', '글쓰기': 'Ollama + Llama 3.1 8B', '코딩': 'vLLM + Qwen3-Coder-7B', 'RAG': 'LlamaIndex + Llama 3.1 8B', '에이전트': 'LangGraph + Ollama (느림)' },
      ...
      image: '/images/best-local-llm-stack-use-case-hardware-tier-hero-ko.webp',
      imageCaption: '하드웨어 등급별 최적 스택 -- GPU/VRAM에 맞는 최적 스택',
    },
    'writing': {
      id: 'writing',
      content: [
    ...
    'coding': {
      ...
      content:  [
        ...
        '이 스택을 선택하는 이유: Qwen3-Coder는 HumanEval에서 82%를 기록합니다(2026년 6월 기준 최고의 오픈소스 코딩 모델). vLLM은 배치 추론에서 Ollama보다 3~5배 빠릅니다. 네이티브 OpenAI API 호환성으로 기존 IDE 도구에 적합합니다. 실시간 제안을 위한 스트리밍이 활성화됩니다.',
        '',
