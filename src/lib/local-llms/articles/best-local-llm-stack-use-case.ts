...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      intro: '**The best local LLM stack depends on your workflow: writers need Ollama + OpenWebUI + Llama 3.3, developers need vLLM + Qwen3-Coder + IDE extension, researchers need LangGraph + vLLM. As of June 2026, no single tool excels at everything.** This guide maps 7 common use cases to their optimal stack (backend + UI + integrations) and hardware tiers (8–24 GB VRAM).',
