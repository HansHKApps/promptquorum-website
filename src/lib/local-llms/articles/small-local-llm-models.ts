      ...
      sections: {
        ...
        phi4mini: {
          ...
          rows: [
            ...
            { 'Especificación': 'HumanEval', 'Valor': '70%' },
            { 'Especificación': 'RAM (Q4_K_M)', 'Valor': '~2.5 GB' },
            { 'Especificación': 'السياق', 'Valor': '128K token' },
            { 'Especificación': 'السرعة على CPU', 'Valor': '30-50 tok/ثانية' },
        ...
        qwen25_3b: {
          ...
          rows: [
            ...
            { 'Especificación': 'RAM (Q4_K_M)', 'Valor': '~2 GB' },
            { 'Especificación': 'السياق', 'Valor': '128K token' },
            { 'Especificación': 'السرعة على CPU', 'Valor': '25-40 tok/ثانية' },
            { 'Especificación': 'أمر Ollama', 'Valor': 'ollama run qwen2.5:3b' },
          ],
          columns: ['المواصفة', 'القيمة'],
        },
        llama32_3b: {
          ...
          rows: [
            ...
            { 'Especificación': 'RAM (Q4_K_M)', 'Valor': '~2.5 GB' },
            { 'Especificación': 'السياق', 'Valor': '128K token' },
            { 'Especificación': 'السرعة على CPU', 'Valor': '25-45 tok/ثانية' },
        ...
        comparisonTable: {
          ...
          rows: [
            ...
            { 'Modelo': 'Qwen3 3B', 'MMLU': '62%', 'HumanEval': '65%', 'RAM': '2 GB', 'Contexto': '128K', 'Mejor para': 'البرمجة، متعدد اللغات' },
            { 'Modelo': 'Llama 3.2 3B', 'MMLU': '58%', 'HumanEval': '60%', 'RAM': '2.5 GB', 'Contexto': '128K', 'Mejor para': 'استخدام عام، أول نموذج' },
            { 'Modelo': 'Gemma 4 E2B', 'MMLU': '—', 'HumanEval': '—', 'RAM': '2 GB', 'Contexto': '128K', 'Mejor para': 'الأجهزة الطرفية (MMLU Pro 60%)' },
            { 'Modelo': 'Llama 3.2 1B', 'MMLU': '32%', 'HumanEval': '28%', 'RAM': '1.3 GB', 'Contexto': '128K', 'Mejor para': 'أدنى RAM مطلق' },
          ],
