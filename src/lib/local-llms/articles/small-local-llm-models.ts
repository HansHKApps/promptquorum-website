...
schema: {
    ...
    ar: {
      ...
      toc: [
        ...
        { label: '#2 Gemma 2 2B -- الأسرع على CPU', anchor: '#gemma-2-2b' },
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Gemma 2 2B', description: 'MMLU 52%. 1.7 GB من RAM. 40-60 tok/ثانية على CPU -- أسرع نموذج صغير. سياق 8K. ollama run gemma2:2b' },
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'هل النماذج الصغيرة جيدة للتلخيص؟', acceptedAnswer: { '@type': 'Answer', text: 'نعم -- التلخيص أحد أقوى حالات استخدام النماذج الصغيرة. ينتج Gemma 2 2B وLlama 3.2 3B ملخصات دقيقة لنصوص تصل إلى ~4000 كلمة بشكل موثوق. للمستندات الأطول، استخدم نموذجًا بنافذة سياق كبيرة مثل Phi-4 Mini أو Llama 3.2 3B (كلاهما بـ 128K token).' } },
          { '@type': 'Question', name: 'كم أسرع نموذج 2B من نموذج 7B على العتاد نفسه؟', acceptedAnswer: { '@type': 'Answer', text: 'أسرع بنحو 2-3 مرات على CPU. يولّد Gemma 2 2B 40-60 tok/ثانية مقابل 10-20 tok/ثانية لـ Mistral Small على CPU الحاسوب المحمول نفسه. فرق السرعة أكثر وضوحًا على الأجهزة التي تعتمد CPU فقط.' } },
          { '@type': 'Question', name: 'هل تدعم النماذج الصغيرة استدعاء الدوال؟', acceptedAnswer: { '@type': 'Answer', text: 'بعضها نعم. يدعم Qwen3 3B استدعاء الدوال ووضع JSON. يملك Llama 3.2 3B دعمًا أساسيًا لاستخدام الأدوات. لا يدعم Gemma 2 2B استدعاء الدوال. راجع وثائق النموذج قبل بناء مسار يعتمد على مخرجات منظّمة.' } },
          { '@type': 'Question', name: 'أي نموذج صغير أفضل للغات غير الإنجليزية؟', acceptedAnswer: { '@type': 'Answer', text: 'يدعم Qwen3 3B 29 لغة بشكل أصلي، بما في ذلك الصينية واليابانية والكورية والعربية. Gemma 2 2B وPhi-4 Mini محسّنان أساسًا للإنجليزية. لمهام اللغات الأخرى على نطاق النموذج الصغير، Qwen3 3B هو الخيار الواضح.' } },
      ...
      sections: {
        ...
        gemma2: {
          title: 'Gemma 2 2B -- أسرع نموذج LLM محلي صغير على CPU',
          content: [
          ...
          rows: [
            { 'Especificación': 'MMLU', 'Valor': '52%' },
            { 'Especificación': 'RAM (Q4_K_M)', 'Valor': '~1.7 GB' },
            { 'Especificación': 'السياق', 'Valor': '8K token' },
            { 'Especificación': 'السرعة على CPU', 'Valor': '40-60 tok/ثانية' },
            { 'Especificación': 'أمر Ollama', 'Valor': 'ollama run gemma2:2b' },
          ],
          columns: ['المواصفة', 'القيمة'],
        },
        qwen25_3b: {
        ...
        comparisonTable: {
          ...
          rows: [
            ...
            { 'Modelo': 'Gemma 2 2B', 'MMLU': '52%', 'HumanEval': '38%', 'RAM': '1.7 GB', 'Contexto': '8K', 'Mejor para': 'السرعة، ذاكرة منخفضة جدًا' },
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'نعم -- التلخيص أحد أقوى حالات استخدام النماذج الصغيرة. ينتج Gemma 2 2B وLlama 3.2 3B ملخصات دقيقة لنصوص تصل إلى ~4000 كلمة (حد سياقها العملي لمخرجات جيدة) بشكل موثوق. للمستندات الأطول، استخدم نموذجًا بنافذة سياق كبيرة مثل Phi-4 Mini أو Llama 3.2 3B (كلاهما بـ 128K token).',
            },
            {
              q: 'كم أسرع نموذج 2B من نموذج 7B على العتاد نفسه؟',
              a: 'أسرع بنحو 2-3 مرات على CPU. يولّد Gemma 2 2B 40-60 tok/ثانية مقابل 10-20 tok/ثانية لـ Mistral Small على CPU الحاسوب المحمول نفسه. على GPU، يتقلّص فارق السرعة لأن أداء GPU أقل تقييدًا بحجم النموذج. فرق السرعة أكثر وضوحًا على الأجهزة التي تعتمد CPU فقط.',
            },
            {
              q: 'هل تدعم النماذج الصغيرة استدعاء الدوال؟',
              a: 'بعضها نعم. يدعم Qwen3 3B استدعاء الدوال ووضع JSON. يملك Llama 3.2 3B دعمًا أساسيًا لاستخدام الأدوات. لا يدعم Gemma 2 2B استدعاء الدوال. راجع وثائق النموذج قبل بناء مسار يعتمد على مخرجات منظّمة.',
            },
            {
              q: 'أي نموذج صغير أفضل للغات غير الإنجليزية؟',
              a: 'يدعم Qwen3 3B 29 لغة بشكل أصلي، بما في ذلك الصينية واليابانية والكورية والعربية. Gemma 2 2B وPhi-4 Mini محسّنان أساسًا للإنجليزية. لمهام اللغات الأخرى على نطاق النموذج الصغير، Qwen3 3B هو الخيار الواضح. راجع [مقارنة Qwen vs Llama vs Mistral متعددة اللغات](/ar/local-llms/qwen-vs-llama-vs-mistral) لمقارنة كاملة للغات.',
            },
            {
...
schema: {
  ...
  ko: {
      ...
      toc: [
        ...
        { label: '#2 Gemma 2 2B -- CPU에서 가장 빠름', anchor: '#gemma-2-2b' },
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Gemma 2 2B', description: 'MMLU 52%. RAM 1.7 GB. CPU 초당 40~60 토큰 -- 가장 빠른 소형 모델. 컨텍스트 8K. ollama run gemma2:2b' },
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: '유용한 출력을 생성하는 가장 작은 로컬 LLM은 무엇입니까?', acceptedAnswer: { '@type': 'Answer', text: '2026년 4월 기준으로, 유용한 출력을 위한 실질적인 최소 사양은 Q4_K_M 양자화의 3B 모델입니다. 2B 미만 파라미터 모델은 다단계 지시 사항과 복잡한 추론에 어려움을 겪습니다. 요약이나 간단한 Q&A와 같은 작업에는 Gemma 2 2B가 사용 가능합니다. 더 복잡한 작업에는 3B 모델부터 시작하십시오.' } },
          ...
          { '@type': 'Question', name: '소형 모델은 요약 작업에 적합합니까?', acceptedAnswer: { '@type': 'Answer', text: '예 -- 요약은 소형 모델의 가장 강력한 사용 사례 중 하나입니다. Gemma 2 2B와 Llama 3.2 3B는 약 4,000단어까지의 텍스트 요약을 안정적으로 생성합니다. 더 긴 문서의 경우 Phi-4 Mini나 Llama 3.2 3B(둘 다 128K 토큰)와 같이 큰 컨텍스트 창을 가진 모델을 사용하십시오.' } },
          { '@type': 'Question', name: '동일한 하드웨어에서 2B 모델은 7B 모델보다 얼마나 빠릅니까?', acceptedAnswer: { '@type': 'Answer', text: 'CPU에서 약 2~3배 빠릅니다. Gemma 2 2B는 동일한 노트북 CPU에서 Mistral Small 대비 초당 40~60 토큰 대 10~20 토큰을 생성합니다. GPU에서는 속도 차이가 줄어듭니다. 속도 차이는 CPU 전용 기기에서 가장 두드러집니다.' } },
          { '@type': 'Question', name: '소형 모델은 함수 호출을 지원합니까?', acceptedAnswer: { '@type': 'Answer', text: '일부 모델은 지원합니다. Qwen3 3B는 함수 호출과 JSON 모드를 지원합니다. Llama 3.2 3B는 기본적인 도구 사용을 지원합니다. Gemma 2 2B는 함수 호출을 지원하지 않습니다. 구조화된 출력에 의존하는 파이프라인을 구축하기 전에 모델 문서를 확인하십시오.' } },
          { '@type': 'Question', name: '영어 외 언어에 가장 적합한 소형 모델은 무엇입니까?', acceptedAnswer: { '@type': 'Answer', text: 'Qwen3 3B는 중국어, 일본어, 한국어, 아랍어를 포함하여 29개 언어를 기본으로 지원합니다. Gemma 2 2B와 Phi-4 Mini는 주로 영어에 최적화되어 있습니다. 소형 모델 규모에서 비영어 작업에는 Qwen3 3B가 명확한 선택입니다.' } },
      ...
      sections: {
        ...
        gemma2: {
          title: 'Gemma 2 2B -- CPU에서 가장 빠른 소형 로컬 LLM',
          content: [
          ...
          rows: [
            { 'Spec': 'MMLU', 'Value': '52%' },
            { 'Spec': 'RAM (Q4_K_M)', 'Value': '~1.7 GB' },
            { 'Spec': '컨텍스트', 'Value': '8K 토큰' },
            { 'Spec': 'CPU 속도', 'Value': '초당 40~60 토큰' },
            { 'Spec': 'Ollama 명령어', 'Value': 'ollama run gemma2:2b' },
          ],
          columns: ['Spec', 'Value'],
        },
        qwen25_3b: {
        ...
        comparisonTable: {
          ...
          rows: [
            ...
            { '모델': 'Gemma 2 2B', 'MMLU': '52%', 'HumanEval': '38%', 'RAM': '1.7 GB', '컨텍스트': '8K', '최적 용도': '속도, 극저용량 RAM' },
          ...
          faqs: [
            {
              ...
              a: '2026년 4월 기준으로, 유용한 출력을 위한 실질적인 최소 사양은 Q4_K_M 양자화의 3B 모델입니다. 2B 미만 파라미터 모델(Llama 3.2 1B, Gemma 2 2B)은 일관성 있는 단일 문장을 생성하지만 다단계 지시, 긴 응답, 복잡한 추론에 어려움을 겪습니다. 요약이나 간단한 Q&A와 같은 작업에는 Gemma 2 2B가 사용 가능합니다. 더 복잡한 작업에는 3B 모델부터 시작하십시오.',
            },
            {
            ...
            },
            {
              ...
              a: '예 -- 요약은 소형 모델의 가장 강력한 사용 사례 중 하나입니다. Gemma 2 2B와 Llama 3.2 3B는 약 4,000단어까지의 텍스트 요약을(품질 출력의 실질적 컨텍스트 한계) 안정적으로 생성합니다. 더 긴 문서의 경우 Phi-4 Mini나 Llama 3.2 3B(둘 다 128K 토큰)와 같이 큰 컨텍스트 창을 가진 모델을 사용하십시오.',
            },
            {
              q: '동일한 하드웨어에서 2B 모델은 7B 모델보다 얼마나 빠릅니까?',
              a: 'CPU에서 약 2~3배 빠릅니다. Gemma 2 2B는 동일한 노트북 CPU에서 Mistral Small 대비 초당 40~60 토큰 대 10~20 토큰을 생성합니다. GPU에서는 GPU 처리량이 모델 크기에 덜 제약받기 때문에 속도 이점이 줄어듭니다. 속도 차이는 CPU 전용 기기에서 가장 두드러집니다.',
            },
            {
              q: '소형 모델은 함수 호출을 지원합니까?',
              a: '일부 모델은 지원합니다. Qwen3 3B는 함수 호출과 JSON 모드를 지원합니다. Llama 3.2 3B는 기본적인 도구 사용을 지원합니다. Gemma 2 2B는 함수 호출을 지원하지 않습니다. 구조화된 출력에 의존하는 파이프라인을 구축하기 전에 모델 문서를 확인하십시오.',
            },
            {
              q: '영어 외 언어에 가장 적합한 소형 모델은 무엇입니까?',
              a: 'Qwen3 3B는 중국어, 일본어, 한국어, 아랍어를 포함하여 29개 언어를 기본으로 지원합니다. Gemma 2 2B와 Phi-4 Mini는 주로 영어에 최적화되어 있습니다. 소형 모델 규모에서 비영어 작업에는 Qwen3 3B가 명확한 선택입니다. 전체 언어 비교는 [Qwen vs Llama vs Mistral 다국어 비교](/local-llms/qwen-vs-llama-vs-mistral)를 참조하십시오.',
            },
            {
