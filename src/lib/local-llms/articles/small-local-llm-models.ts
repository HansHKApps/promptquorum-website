...
schema: {
    ...
    es: {
      ...
      schema: {
        ...
        datePublished: '2026-04-04',
        dateModified: '2026-04-05',
        'url': 'https://www.promptquorum.com/es/es/local-llms/small-local-llm-models',
    ...
    ar: {
      ...
      seoTitle: 'نماذج LLM المحلية الصغيرة 2026: أفضل 5 نماذج أقل من 4B مرتّبة',
      ...
      metaDescription: 'أفضل نماذج LLM المحلية أقل من 4B لذاكرة 4–8 GB: Phi-4 Mini (68% MMLU)، وGemma 2 (الأسرع)، وQwen3 (البرمجة)، وLlama 3.2 (عام). 2026.',
      publishDate: '2026-04-04',
