...
schema: {
    ...
    es: {
      ...
      intro: 'Los LLMs locales pequeños (1B-4B parámetros) funcionan en máquinas con 4-8 GB de RAM y producen 30-70 tokens/seg en CPU -- suficientemente rápido para chat en tiempo real. Los mejores modelos pequeños en 2026 son Microsoft Phi-4 Mini 3.8B (mejor razonamiento), Google Gemma 4 E2B (el más rápido), Qwen3 3B (mejor para código) y Meta Llama 3.2 3B (mejor uso general).',
      metaDescription: 'Mejores modelos LLM locales sub-4B para 4-8 GB de RAM: Phi-4 Mini (68% MMLU), Gemma 4 E2B (60% MMLU Pro, 128K contexto), Qwen3 (código), Llama 3.2 (general).',
    ...
    ar: {
      ...
      intro: 'تعمل نماذج LLM المحلية الصغيرة (1B-4B معاملات) على أجهزة بذاكرة RAM سعة 4-8 GB وتنتج 30-70 token/ثانية على CPU -- سريعة بما يكفي للدردشة الفورية. أفضل النماذج الصغيرة في 2026 هي Microsoft Phi-4 Mini 3.8B (أفضل استدلال)، وGoogle Gemma 4 E2B (الأسرع)، وQwen3 3B (الأفضل للبرمجة)، وMeta Llama 3.2 3B (الأفضل للاستخدام العام).',
      metaDescription: 'أفضل ⁨5⁩ نماذج ⁨LLM⁩ محلية أقل من ⁨4B⁩ في ⁨2026⁩: ⁨Phi-4 Mini⁩ (⁨68% MMLU⁩، ⁨2.5 GB⁩)، ⁨Gemma 4 E2B⁩ (⁨60% MMLU Pro⁩، سياق ⁨128K⁩)، ⁨Qwen3⁩ (البرمجة)، ⁨Llama 3.2⁩ (عام).',
      ...
      toc: [
        ...
        { label: '#3 Qwen3 3B -- الأفضل للبرمجة', anchor: '#qwen2-5-3b' },
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'Qwen3 3B', description: 'MMLU 62%، HumanEval 65%. 2 GB من RAM. 29 لغة بشكل أصلي. يدعم استدعاء الدوال. ollama run qwen2.5:3b' },
      ...
      sections: {
        ...
        comparisonTable: {
          ...
          rows: [
            ...
            { 'النموذج': 'Qwen3 3B', 'MMLU': '62%', 'HumanEval': '65%', 'RAM': '2 GB', 'السياق': '128K', 'الأفضل لـ': 'البرمجة، متعدد اللغات' },
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[أفضل نماذج LLM المحلية للبرمجة](/ar/local-llms/best-local-llms-for-coding) -- نماذج خاصة بالبرمجة على نطاق 7B+ عندما لا يكفي Qwen3 3B للمهام المعقدة',
    ...
    pt: {
      ...
      intro: 'Os LLMs locais pequenos (1B-4B parâmetros) funcionam em máquinas com 4-8 GB de RAM e produzem 30-70 tokens/seg na CPU -- rápido o suficiente para chat em tempo real. Os melhores modelos pequenos em 2026 são Microsoft Phi-4 Mini 3.8B (melhor raciocínio), Google Gemma 4 E2B (o mais rápido), Qwen3 3B (melhor para código) e Meta Llama 3.2 3B (melhor uso geral).',
      metaDescription: 'Melhores modelos LLM locais sub-4B para 4-8 GB de RAM: Phi-4 Mini (68% MMLU), Gemma 4 E2B (60% MMLU Pro, contexto 128K), Qwen3 (código), Llama 3.2 (geral).',
    ...
    de: {
      ...
      metaDescription: 'Best Sub-4B Modelle für 4-8 GB RAM in 2026: Phi-4 Mini (68% MMLU), Gemma 4 E2B (60% MMLU Pro, 128K Kontext), Qwen3 (Codierung), Llama 3.2.',
      heroImage: '/images/small-local-llm-models-performance-tier-hero-de.webp',
      intro: 'Kleine lokale LLMs (1B-4B Parameter) laufen auf Maschinen mit 4-8 GB RAM und erzeugen 30-70 Token/Sek auf CPU -- schnell genug für Echtzeit-Chat. Die besten kleinen Modelle in 2026 sind Microsoft Phi-4 Mini 3.8B (bestes Reasoning), Google Gemma 4 E2B (schnellste), Qwen3 3B (beste Codierung) und Meta Llama 3.2 3B (beste allgemeine Nutzung).',
      publishDate: '2026-04-04',
      freshness_tier: 'semi_annual',
      next_refresh_due: '2027-02-27',
...
schema: {
      ...
      faqSchema: {
        ...
        '@type': 'FAQPage',
        mainEntity: [
          { '@type': 'Question', name: 'Was ist das kleinste lokale LLM mit nützlicher Ausgabe?', acceptedAnswer: { '@type': 'Answer', text: 'Seit April 2026 ist 3B bei Q4_K_M praktisches Minimum. Modelle unter 2B (Llama 3.2 1B, Gemma 4 E2B) erzeugen kohärente einzelne Sätze, kämpfen aber mit mehrstufigen Anweisungen und Reasoning. Für Zusammenfassung und F&A ist Gemma 4 E2B brauchbar. Für komplexere Aufgaben: beginnen Sie mit 3B.' } },
          ...
          { '@type': 'Question', name: 'Unterstützen kleine Modelle Funktionsaufrufe?', acceptedAnswer: { '@type': 'Answer', text: 'Einige tun dies. Qwen3 3B unterstützt Funktionsaufrufe und JSON. Llama 3.2 3B hat grundlegende Werkzeugunterstützung. Gemma 4 E2B unterstützt keine Funktionsaufrufe. Überprüfen Sie Modelldokumentation vor Pipeline-Aufbau.' } },
          { '@type': 'Question', name: 'Welches kleine Modell ist beste für nicht-englische Sprachen?', acceptedAnswer: { '@type': 'Answer', text: 'Qwen3 3B unterstützt nativ 29 Sprachen (Chinesisch, Japanisch, Koreanisch, Arabisch). Gemma 4 E2B und Phi-4 Mini sind hauptsächlich auf Englisch optimiert. Für nicht-englische Aufgaben bei kleinen Modellen ist Qwen3 3B klare Wahl.' } },
 ...
 items: ['**Bestes Reasoning im kleinen Format**: Phi-4 Mini 3.8B -- 68% MMLU, 70% HumanEval, läuft auf 4 GB RAM.', '**Bestes kleines/Edge-Modell**: Gemma 4 E2B -- MMLU Pro 60%, 128K Kontext, ~2 GB RAM, Apache 2.0. Ersetzt das ältere Gemma 2 2B.', '**Bestes kleines Codierungsmodell**: Qwen3 3B -- 65% HumanEval bei ~2 GB RAM.', '**Beste Universal-3B**: Llama 3.2 3B -- beste Community-Unterstützung, 128K Kontext, 2,5 GB RAM.', 'Seit April 2026 produziert kein Sub-2B-Modell Ausgabequalität, die für professionelle Aufgaben geeignet ist. Verwenden Sie 3B+ für echte Arbeit.'] },
    ...
    fr: {
      ...
      metaDescription: 'Top 5 modèles sub-4B pour 4-8 GB RAM en 2026 : Phi-4 Mini (68% MMLU), Gemma 4 E2B (60% MMLU Pro, contexte 128K), Qwen3 (codage), Llama 3.2.',
      heroImage: '/images/small-local-llm-models-performance-tier-hero-fr.webp',
      intro: 'Les petits LLMs locaux (1B-4B paramètres) fonctionnent sur des machines avec 4-8 GB RAM et produisent 30-70 tokens/sec sur CPU -- assez rapide pour le chat en temps réel. Les meilleurs petits modèles en 2026 sont Microsoft Phi-4 Mini 3.8B (meilleur reasoning), Google Gemma 4 E2B (plus rapide), Qwen3 3B (meilleur codage), et Meta Llama 3.2 3B (meilleur usage général).',
      publishDate: '2026-04-04',
      freshness_tier: 'semi_annual',
      next_refresh_due: '2027-02-27',
...
schema: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': "Certains oui. Qwen3 3B supporte l'appel de fonction et le mode JSON. Llama 3.2 3B a un support basique d'utilisation d'outils. Gemma 4 E2B ne supporte pas l'appel de fonction. Vérifiez la documentation du modèle avant de construire un pipeline qui dépend d'une sortie structurée.",
            },
          },
          {
            '@type': 'Question',
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': "Qwen3 3B supporte nativement 29 langues dont le chinois, le japonais, le coréen et l'arabe. Gemma 4 E2B et Phi-4 Mini sont principalement optimisés pour l'anglais. Pour les tâches non-anglaises à l'échelle des petits modèles, Qwen3 3B est le choix évident. Voir [comparaison multilingue Qwen vs Llama vs Mistral](/fr/local-llms/qwen-vs-llama-vs-mistral) pour une comparaison complète des langues.",
            },
          },
          {
            '@type': 'Question',
          ...
          {
            '@type': 'Question',
            'name': 'Quelle est la différence de qualité entre un modèle 3B et 7B ?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Un modèle 3B à 68% MMLU (Phi-4 Mini) performe de façon similaire à un GPT-4o mini d\'ère 2023 sur les tâches générales. L\'écriture longue et le code complexe auront une qualité notablement inférieure.',
            },
          },
          {
            '@type': 'Question',
            'name': 'Comment puis-je exécuter un petit LLM en français ?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Téléchargez le modèle avec Ollama : `ollama pull qwen2.5:3b` ou `ollama pull llama3.2:3b`. Démarrez une conversation en français avec `ollama run qwen2.5:3b`. Aucun paramètre de configuration spécial n\'est nécessaire -- les modèles produisent automatiquement du texte français de bonne qualité.',
            },
          },
          {
            '@type': 'Question',
            'name': 'Quels sont les erreurs courantes avec les petits modèles locaux ?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Les erreurs courantes incluent : utiliser Q8_0 au lieu de Q4_K_M (consomme deux fois plus de RAM), exécuter la variante de base au lieu de la variante d\'instruction, et attendre une qualité de modèle 7B d\'un modèle 3B.',
            },
          },
        ],
      },
 ...
 items: ['**Meilleur raisonnement à petite échelle** : Phi-4 Mini 3.8B -- 68% MMLU, 70% HumanEval, fonctionne sur 4 Go de RAM.', '**Meilleur petit modèle/edge** : Gemma 4 E2B -- MMLU Pro 60 %, contexte 128K, ~2 Go RAM, Apache 2.0. Remplace l\'ancien Gemma 2 2B.', '**Meilleur petit modèle de codage** : Qwen3 3B -- 65% HumanEval avec environ 2 Go de RAM.', '**Meilleur usage général 3B** : Llama 3.2 3B -- meilleur support communautaire, contexte 128K, 2,5 Go de RAM.', "Depuis avril 2026, aucun modèle sub-2B ne produit une qualité de sortie adaptée aux tâches professionnelles. Utilisez 3B ou plus pour un vrai travail."] },
        ...
        quantizationGuide: { title: 'Comprendre la quantification : compromis RAM vs qualité', image: '/images/small-local-llm-models-quantization-tradeoff-hero-fr.webp', imageCaption: 'Compromis de quantification : Q4_K_M (2,5 Go, -0,5% qualité) est le défaut recommandé. Q8_0 utilise 3,8 Go sans gain de qualité. Q3_K_M (1,8 Go, -1,8% perte) pour les contraintes RAM extrêmes.' },
        ...
        faqSection: { id: 'faq', title: 'Questions fréquentes sur les petits modèles LLM locaux', faqs: [
            ...
            { q: 'Les petits modèles supportent-ils l\'appel de fonction ?', a: "Certains oui. Qwen3 3B supporte l'appel de fonction et le mode JSON. Llama 3.2 3B a un support basique d'utilisation d'outils. Gemma 4 E2B ne supporte pas l'appel de fonction. Vérifiez la documentation du modèle avant de construire un pipeline qui dépend d'une sortie structurée." },
            { q: 'Quel petit modèle est le meilleur pour les langues autres que l\'anglais ?', a: "Qwen3 3B supporte nativement 29 langues dont le chinois, le japonais, le coréen et l'arabe. Gemma 4 E2B et Phi-4 Mini sont principalement optimisés pour l'anglais. Pour les tâches non-anglaises à l'échelle des petits modèles, Qwen3 3B est le choix évident. Voir [comparaison multilingue Qwen vs Llama vs Mistral](/fr/local-llms/qwen-vs-llama-vs-mistral) pour une comparaison complète des langues." },
            ...
            { q: 'Quelle est la différence de qualité entre un modèle 3B et 7B ?', a: 'Un modèle 3B à 68% MMLU (Phi-4 Mini) performe de façon similaire à un GPT-4o mini d\'ère 2023 sur les tâches générales. L\'écriture longue et le code complexe auront une qualité notablement inférieure.' },
            { q: 'Comment puis-je exécuter un petit LLM en français ?', a: 'Téléchargez le modèle avec Ollama : `ollama pull qwen2.5:3b` ou `ollama pull llama3.2:3b`. Démarrez une conversation en français avec `ollama run qwen2.5:3b`. Aucun paramètre de configuration spécial n\'est nécessaire -- les modèles produisent automatiquement du texte français de bonne qualité.' },
            { q: 'Quels sont les erreurs courantes avec les petits modèles locaux ?', a: 'Les erreurs courantes incluent : utiliser Q8_0 au lieu de Q4_K_M (consomme deux fois plus de RAM), exécuter la variante de base au lieu de la variante d\'instruction, et attendre une qualité de modèle 7B d\'un modèle 3B.' },
          ] },
    ...
    ja: {
      ...
      metaDescription: '4～8GB RAM向け最高5つの小型ローカルLLMモデル2026年完全比較：Phi-4 Mini（68% MMLU）、Gemma 4 E2B（MMLU Pro 60%、128Kコンテキスト）、Qwen3（コーディング）、Llama 3.2。',
      heroImage: '/images/small-local-llm-models-performance-tier-hero-ja.webp',
      intro: '小規模ローカルLLM（1B～4Bパラメータ）は4～8GB RAMのマシンで動作し、CPU上で30～70トークン/秒を生成します。リアルタイムチャットに十分な速度です。2026年の最高の小規模モデルはMicrosoft Phi-4 Mini 3.8B（最高の推論）、Google Gemma 4 E2B（最速）、Qwen3 3B（最高のコーディング）、Meta Llama 3.2 3B（最高の汎用）です。',
      publishDate: '2026-04-04',
      freshness_tier: 'semi_annual',
      next_refresh_due: '2027-02-27',
...
schema: {
      ...
      faqSchema: {
        ...
        '@type': 'FAQPage',
        mainEntity: [
          { '@type': 'Question', name: '有用な出力を生成する最小のローカルLLMは何ですか？', acceptedAnswer: { '@type': 'Answer', text: '2026年4月現在、有用な出力の実用的な最小値はQ4_K_M量子化での3Bモデルです。2B以下のパラメータを持つモデル（Llama 3.2 1B、Gemma 4 E2B）は一貫した単一文を生成しますが、複数ステップの指示と複雑な推論に苦労しています。要約やシンプルなQ&Aなどのタスクの場合、Gemma 4 E2Bは使用可能です。より複雑な場合は、3Bモデルから始めてください。' } },
          ...
          { '@type': 'Question', name: '小規模モデルは関数呼び出しをサポートしていますか？', acceptedAnswer: { '@type': 'Answer', text: 'いくつかサポートしています。Qwen3 3Bは関数呼び出しとJSONモードをサポートしています。Llama 3.2 3Bは基本的なツール使用をサポートしています。Gemma 4 E2Bは関数呼び出しをサポートしていません。構造化された出力に依存するパイプラインを構築する前に、モデルのドキュメントを確認してください。' } },
          { '@type': 'Question', name: '英語以外の言語に最適な小規模モデルはどれですか？', acceptedAnswer: { '@type': 'Answer', text: 'Qwen3 3Bは、中国語、日本語、韓国語、アラビア語を含む29言語をネイティブにサポートしています。Gemma 4 E2BとPhi-4 Miniは主に英語最適化されています。小規模モデルスケールでの非英語タスクの場合、Qwen3 3Bが明確な選択肢です。[Qwen vs Llama vs Mistral 多言語比較](/local-llms/qwen-vs-llama-vs-mistral)で完全な言語比較を参照してください。' } },
          ...
          { '@type': 'Question', name: 'Phi-4 MiniはコーディングでLlama 3.2 3Bより優れていますか？', acceptedAnswer: { '@type': 'Answer', text: 'はい。Phi-4 Miniはこのスケールで意味のある10ポイントギャップでLlama 3.2 3Bの60%対70% HumanEvalスコアを達成します。4～6 GB RAMマシンでのコーディング支援の場合、Phi-4 Miniが推奨される選択肢です。多言語コーディング（非Python）の場合、65% HumanEvalのQwen3 3Bはphi-4 Miniと競争力があり、関数呼び出しもサポートしています。' } },
        ],
      },
      sections: {
        tldr: {
          ...
          faqs: [
            {
              ...
              a: '2026年4月現在、有用な出力の実用的な最小値はQ4_K_M量子化での3Bモデルです。2B以下のパラメータを持つモデル（Llama 3.2 1B、Gemma 4 E2B）は一貫した単一文を生成しますが、複数ステップの指示と複雑な推論に苦労しています。要約やシンプルなQ&Aなどのタスクの場合、Gemma 4 E2Bは使用可能です。より複雑な場合は、3Bモデルから始めてください。',
            },
            {
              q: '3Bモデルを電話で実行できますか？',
            ...
            },
            {
              ...
              a: 'いくつかサポートしています。Qwen3 3Bは関数呼び出しとJSONモードをサポートしています。Llama 3.2 3Bは基本的なツール使用をサポートしています。Gemma 4 E2Bは関数呼び出しをサポートしていません。構造化された出力に依存するパイプラインを構築する前に、モデルのドキュメントを確認してください。',
            },
            {
              q: '英語以外の言語に最適な小規模モデルはどれですか？',
              a: 'Qwen3 3Bは、中国語、日本語、韓国語、アラビア語を含む29言語をネイティブにサポートしています。Gemma 4 E2BとPhi-4 Miniは主に英語最適化されています。小規模モデルスケールでの非英語タスクの場合、Qwen3 3Bが明確な選択肢です。[Qwen vs Llama vs Mistral 多言語比較](/local-llms/qwen-vs-llama-vs-mistral)で完全な言語比較を参照してください。',
            },
            {
    ...
    zh: {
      ...
      metaDescription: '本地小模型推荐与排行：Phi-4 Mini（68% MMLU）、Gemma 4 E2B（MMLU Pro 60%，128K上下文）、Qwen3（编码最优）、Llama 3.2（通用）。4-8GB 内存即可运行，含性能对比。',
      heroImage: '/images/small-local-llm-models-performance-tier-hero-zh.webp',
      intro: '小型本地LLM（1B-4B参数）在4-8GB RAM的机器上运行，在CPU上生成30-70个令牌/秒----足够用于实时聊天。2026年最好的小型模型是Microsoft Phi-4 Mini 3.8B（最佳推理）、Google Gemma 4 E2B（最快）、Qwen3 3B（最佳编码）和Meta Llama 3.2 3B（最佳通用用途）。',
      publishDate: '2026-04-04',
      freshness_tier: 'semi_annual',
      next_refresh_due: '2027-02-27',
...
schema: {
      ...
      faqSchema: {
        ...
        '@type': 'FAQPage',
        mainEntity: [
          { '@type': 'Question', name: '生成有用输出的最小本地LLM是什么？', acceptedAnswer: { '@type': 'Answer', text: '截至2026年4月，有用输出的实际最小值是Q4_K_M量化下的3B模型。2B以下参数的模型生成连贯的单句但在多步骤指令和复杂推理上苦恼。对于摘要和简单问答等任务，Gemma 4 E2B是可用的。对于更复杂的任务，从3B模型开始。' } },
          ...
          { '@type': 'Question', name: '小型模型支持函数调用吗？', acceptedAnswer: { '@type': 'Answer', text: '有些支持。Qwen3 3B支持函数调用和JSON模式。Llama 3.2 3B有基本的工具使用支持。Gemma 4 E2B不支持函数调用。在构建依赖于结构化输出的管道之前检查模型文档。' } },
          { '@type': 'Question', name: '英文以外的语言最好的小型模型是什么？', acceptedAnswer: { '@type': 'Answer', text: 'Qwen3 3B原生支持29种语言，包括中文、日文、韩文和阿拉伯文。Gemma 4 E2B和Phi-4 Mini主要是英文优化的。对于小型模型规模的非英文任务，Qwen3 3B是明确的选择。有关完整的语言比较，请参阅[Qwen vs Llama vs Mistral 多语言比较](/local-llms/qwen-vs-llama-vs-mistral)。' } },
          ...
          { '@type': 'Question', name: 'Phi-4 Mini在编码上比Llama 3.2 3B更好吗？', acceptedAnswer: { '@type': 'Answer', text: '是的。Phi-4 Mini在此规模达到60%对70% HumanEval得分，与Llama 3.2 3B相比有意义的10点差距。对于4-6 GB RAM机器上的编码协助，Phi-4 Mini是推荐选择。对于多语言编码（非Python），65% HumanEval的Qwen3 3B与Phi-4 Mini竞争，同时也支持函数调用。' } },
        ],
      },
      sections: {
        tldr: {
        ...
        faqSection: {
          ...
          faqs: [
            {
              q: '生成有用输出的最小本地LLM是什么？',
              a: '截至2026年4月，有用输出的实际最小值是Q4_K_M量化下的3B模型。2B以下参数的模型生成连贯的单句但在多步骤指令和复杂推理上苦恼。对于摘要和简单问答等任务，Gemma 4 E2B是可用的。对于更复杂的任务，从3B模型开始。',
            },
            {
              q: '我可以在电话上运行3B模型吗？',
            ...
            {
              q: '小型模型支持函数调用吗？',
              a: '有些支持。Qwen3 3B支持函数调用和JSON模式。Llama 3.2 3B有基本的工具使用支持。Gemma 4 E2B不支持函数调用。在构建依赖于结构化输出的管道之前检查模型文档。',
            },
            {
              q: '英文以外的语言最好的小型模型是什么？',
              a: 'Qwen3 3B原生支持29种语言，包括中文、日文、韩文和阿拉伯文。Gemma 4 E2B和Phi-4 Mini主要是英文优化的。对于小型模型规模的非英文任务，Qwen3 3B是明确的选择。有关完整的语言比较，请参阅[Qwen vs Llama vs Mistral 多语言比较](/local-llms/qwen-vs-llama-vs-mistral)。',
            },
            {
  ...
  ko: {
      ...
      intro: '소형 로컬 LLM(1B~4B 파라미터)은 RAM 4~8GB 기기에서 실행되며 CPU에서 초당 30~70 토큰을 생성합니다 -- 실시간 채팅에 충분한 속도입니다. 2026년 최고의 소형 모델은 Microsoft Phi-4 Mini 3.8B(최고 추론 성능), Google Gemma 4 E2B(가장 빠름), Qwen3 3B(최고 코딩 성능), Meta Llama 3.2 3B(최고 범용 성능)입니다.',
      metaDescription: 'RAM 4~8GB용 4B 미만 최고 로컬 LLM 모델: Phi-4 Mini(MMLU 68%), Gemma 4 E2B(MMLU Pro 60%, 컨텍스트 128K), Qwen3(코딩), Llama 3.2(범용).',
      ...
      toc: [
        ...
        { label: '#3 Qwen3 3B -- 코딩에 최적', anchor: '#qwen2-5-3b' },
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'Qwen3 3B', description: 'MMLU 62%, HumanEval 65%. RAM 2 GB. 29개 언어 기본 지원. 함수 호출 지원. ollama run qwen2.5:3b' },
      ...
      sections: {
        ...
        comparisonTable: {
          ...
          rows: [
            ...
            { '모델': 'Qwen3 3B', 'MMLU': '62%', 'HumanEval': '65%', 'RAM': '2 GB', '컨텍스트': '128K', '최적 용도': '코딩, 다국어' },
