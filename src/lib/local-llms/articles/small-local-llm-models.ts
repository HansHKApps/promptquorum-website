...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      metaDescription: 'Best sub-4B local LLM models for 4-8 GB RAM: Phi-4 Mini (68% MMLU), Gemma 4 E2B (60% MMLU Pro, 128K context), Qwen3 (coding), Llama 3.2 (general). August 2026.',
...
schema: {
    ...
    es: {
      ...
      metaDescription: 'Mejores modelos LLM locales sub-4B para 4-8 GB de RAM: Phi-4 Mini (68% MMLU), Gemma 4 E2B (60% MMLU Pro, 128K contexto), Qwen3 (código), Llama 3.2 (general). Agosto 2026.',
    ...
    pt: {
      ...
      metaDescription: 'Melhores modelos LLM locais sub-4B para 4-8 GB de RAM: Phi-4 Mini (68% MMLU), Gemma 4 E2B (60% MMLU Pro, contexto 128K), Qwen3 (código), Llama 3.2 (geral). Agosto 2026.',
    ...
    de: {
      ...
      metaDescription: 'Best Sub-4B Modelle für 4-8 GB RAM in 2026: Phi-4 Mini (68% MMLU), Gemma 4 E2B (60% MMLU Pro, 128K Kontext), Qwen3 (Codierung), Llama 3.2. August 2026.',
...
schema: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Sind kleine Modelle gut für Zusammenfassung?', acceptedAnswer: { '@type': 'Answer', text: 'Ja -- Zusammenfassung ist einer der besten Anwendungsfälle für kleine Modelle. Gemma 4 E2B und Llama 3.2 3B produzieren zuverlässig genaue Zusammenfassungen von Texten bis zu ~4.000 Wörtern.' } },
          { '@type': 'Question', name: 'Wie viel schneller ist ein 2B-Modell als ein 7B-Modell auf derselben Hardware?', acceptedAnswer: { '@type': 'Answer', text: 'Hängt stark von Hardware und Quantisierung ab -- Google berichtet ~7,6 Token/Sek (Decode) für Gemma 4 E2B auf einem Raspberry Pi 5, während unabhängige x86-CPU-Tests zwischen 8-48 Token/Sek liegen. Der Geschwindigkeitsvorteil ist auf reinen CPU-Maschinen am deutlichsten.' } },
          { '@type': 'Question', name: 'Unterstützen kleine Modelle Funktionsaufrufe?', acceptedAnswer: { '@type': 'Answer', text: 'Einige tun dies. Qwen3 3B unterstützt Funktionsaufrufe und JSON-Modus. Llama 3.2 3B hat grundlegende Werkzeugunterstützung. Gemma 4 E2B unterstützt Funktionsaufrufe nicht.' } },
          { '@type': 'Question', name: 'Welches kleine Modell ist für Sprachen außer Englisch am besten?', acceptedAnswer: { '@type': 'Answer', text: 'Qwen3 3B unterstützt nativ 29 Sprachen, einschließlich Chinesisch, Japanisch, Koreanisch und Arabisch. Gemma 4 E2B und Phi-4 Mini sind hauptsächlich auf Englisch optimiert. Für nicht-englische Aufgaben auf kleiner Modellskala ist Qwen3 3B die klare Wahl.' } },
 ...
 isTldr: true, items: ['**Bestes Reasoning im kleinen Format**: Phi-4 Mini 3.8B -- 68% MMLU, 70% HumanEval, läuft auf 4 GB RAM.', '**Bestes kleines/Edge-Modell**: Gemma 4 E2B -- MMLU Pro 60%, 128K Kontext, ~2 GB RAM, Apache 2.0. Ersetzt das ältere Gemma 2 2B.', '**Bestes kleines Codierungsmodell**: Qwen3 3B -- 65% HumanEval bei ~2 GB RAM.', '**Beste Universal-3B**: Llama 3.2 3B -- beste Community-Unterstützung, 128K Kontext, 2,5 GB RAM.', 'Seit April 2026 produziert kein Sub-2B-Modell Ausgabequalität, die für professionelle Aufgaben geeignet ist. Verwenden Sie 3B+ für echte Arbeit.'] },
    ...
    fr: {
      ...
      metaDescription: 'Top 5 modèles sub-4B pour 4-8 GB RAM en 2026 : Phi-4 Mini (68% MMLU), Gemma 4 E2B (60% MMLU Pro, contexte 128K), Qwen3 (codage), Llama 3.2. Août 2026.',
...
schema: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: '小規模モデルは要約に適していますか？', acceptedAnswer: { '@type': 'Answer', text: 'はい -- 要約は小規模モデルの最適なユースケースの1つです。Gemma 4 E2BとLlama 3.2 3Bは約4,000語までのテキストの正確な要約を一貫して生成します。' } },
          { '@type': 'Question', name: '2Bモデルは同じハードウェアで7Bモデルより何倍速いですか？', acceptedAnswer: { '@type': 'Answer', text: 'ハードウェアと量子化に大きく依存します -- GoogleはRaspberry Pi 5でのGemma 4 E2Bのデコード速度を約7.6トークン/秒と報告しており、独立系のx86 CPUテストでは8～48トークン/秒の幅があります。速度の利点はCPUのみのマシンで最も顕著です。' } },
          { '@type': 'Question', name: '小規模モデルは関数呼び出しをサポートしていますか？', acceptedAnswer: { '@type': 'Answer', text: 'いくつかサポートしています。Qwen3 3Bは関数呼び出しとJSONモードをサポートしています。Llama 3.2 3Bは基本的なツール使用をサポートしています。Gemma 4 E2Bは関数呼び出しをサポートしていません。' } },
          { '@type': 'Question', name: '英語以外の言語に最適な小規模モデルはどれですか？', acceptedAnswer: { '@type': 'Answer', text: 'Qwen3 3Bは中国語、日本語、韓国語、アラビア語を含む29言語をネイティブにサポートしています。Gemma 4 E2BとPhi-4 Miniは主に英語用に最適化されています。小規模モデルスケールの非英語タスクの場合、Qwen3 3Bが明確な選択肢です。' } },
    ...
    zh: {
      ...
      metaDescription: '2026年4-8GB RAM最佳5大小型本地LLM完整对比：Phi-4 Mini（68% MMLU）、Gemma 4 E2B（MMLU Pro 60%，128K上下文）、Qwen3（编码最优）、Llama 3.2（通用推荐）。',
...
schema: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: '小型模型适合摘要总结吗？', acceptedAnswer: { '@type': 'Answer', text: '可以----摘要总结是小型模型最好的用例之一。Gemma 4 E2B和Llama 3.2 3B可靠地生成长达约4,000个单词的文本摘要。' } },
          { '@type': 'Question', name: '2B模型比同一硬件上的7B模型快多少倍？', acceptedAnswer: { '@type': 'Answer', text: '很大程度上取决于硬件和量化方式——Google官方数据显示Gemma 4 E2B在Raspberry Pi 5上的解码速度约为7.6令牌/秒，而独立的x86 CPU测试范围为8-48令牌/秒。速度优势在仅CPU的机器上最为明显。' } },
          { '@type': 'Question', name: '小型模型支持函数调用吗？', acceptedAnswer: { '@type': 'Answer', text: '有些支持。Qwen3 3B支持函数调用和JSON模式。Llama 3.2 3B具有基本的工具使用支持。Gemma 4 E2B不支持函数调用。' } },
          { '@type': 'Question', name: '哪个小型模型对英语以外的语言最佳？', acceptedAnswer: { '@type': 'Answer', text: 'Qwen3 3B原生支持29种语言，包括中文、日语、韩语和阿拉伯语。Gemma 4 E2B和Phi-4 Mini主要针对英语优化。对于小模型规模的非英语任务，Qwen3 3B是明确的选择。' } },
  ...
  ko: {
      ...
      metaDescription: 'RAM 4~8GB용 4B 미만 최고 로컬 LLM 모델: Phi-4 Mini(MMLU 68%), Gemma 4 E2B(MMLU Pro 60%, 컨텍스트 128K), Qwen3(코딩), Llama 3.2(범용). 2026년 8월 기준.',
