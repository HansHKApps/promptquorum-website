    ...
    es: {
      ...
      sections: {
        ...
        comparisonTable: {
          ...
          image: '/images/small-llm-performance-tier-mockup.svg',
          imageCaption: 'Niveles de rendimiento: las puntuaciones de MMLU y HumanEval muestran que Phi-4 Mini lidera en razonamiento y código, Gemma 2 es el más rápido en CPU, Qwen2.5 destaca en código.',
          rows: [
