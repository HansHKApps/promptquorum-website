    ...
    en: {
      ...
      sections: {
        ...
        costSavings: {
          ...
          rows: [
            { 'Annual Token Volume': '100M tokens', 'Cloud API Cost': '$1,000', 'Local AI (amortized)': '$500', 'Annual Savings': '$500' },
            { 'Annual Token Volume': '1B tokens', 'Cloud API Cost': '$10,000', 'Local AI (amortized)': '$5,000', 'Annual Savings': '$5,000' },
            { 'Annual Token Volume': '10B tokens', 'Cloud API Cost': '$100,000', 'Local AI (amortized)': '$50,000', 'Annual Savings': '$50,000' },
            { 'Annual Token Volume': '100B tokens', 'Cloud API Cost': '$1,000,000', 'Local AI (amortized)': '$500,000', 'Annual Savings': '$500,000' },
          ],
        ...
        useCases: {
          ...
          rows: [
            { 'Industry': 'Healthcare', 'Use Case': 'Medical document analysis (HIPAA-compliant)', 'Annual Volume': '500M tokens/year', 'Annual Savings': '$8k/year' },
            { 'Industry': 'Finance', 'Use Case': 'Compliance analysis, regulatory filing', 'Annual Volume': '2B tokens/year', 'Annual Savings': '$35k/year' },
            { 'Industry': 'Legal', 'Use Case': 'Contract review, due diligence', 'Annual Volume': '1B tokens/year', 'Annual Savings': '$18k/year' },
            { 'Industry': 'Manufacturing', 'Use Case': 'Quality control, predictive maintenance', 'Annual Volume': '100M tokens/year', 'Annual Savings': '$1.5k/year' },
            { 'Industry': 'Government', 'Use Case': 'Classified document processing', 'Annual Volume': '500M tokens/year', 'Annual Savings': '$8k/year + compliance' },
          ],
    ...
    es: {
      ...
      sections: {
        ...
        costSavings: {
          ...
          rows: [
            { 'Volumen anual de tokens': '100 M tokens', 'Costo de API en la nube': '$1.000', 'IA local (amortizado)': '$500', 'Ahorro anual': '$500' },
            { 'Volumen anual de tokens': '1.000 M tokens', 'Costo de API en la nube': '$10.000', 'IA local (amortizado)': '$5.000', 'Ahorro anual': '$5.000' },
            { 'Volumen anual de tokens': '10.000 M tokens', 'Costo de API en la nube': '$100.000', 'IA local (amortizado)': '$50.000', 'Ahorro anual': '$50.000' },
            { 'Volumen anual de tokens': '100.000 M tokens', 'Costo de API en la nube': '$1.000.000', 'IA local (amortizado)': '$500.000', 'Ahorro anual': '$500.000' },
          ],
        ...
        useCases: {
          ...
          rows: [
            { 'Industria': 'Sanidad', 'Caso de uso': 'Análisis de documentos médicos (compatible con HIPAA)', 'Volumen anual': '500 M tokens/año', 'Ahorro anual': '$8k/año' },
            { 'Industria': 'Finanzas', 'Caso de uso': 'Análisis de cumplimiento, informes regulatorios', 'Volumen anual': '2.000 M tokens/año', 'Ahorro anual': '$35k/año' },
            { 'Industria': 'Legal', 'Caso de uso': 'Revisión de contratos, due diligence', 'Volumen anual': '1.000 M tokens/año', 'Ahorro anual': '$18k/año' },
            { 'Industria': 'Manufactura', 'Caso de uso': 'Control de calidad, mantenimiento predictivo', 'Volumen anual': '100 M tokens/año', 'Ahorro anual': '$1,5k/año' },
            { 'Industria': 'Gobierno', 'Caso de uso': 'Procesamiento de documentos clasificados', 'Volumen anual': '500 M tokens/año', 'Ahorro anual': '$8k/año + cumplimiento' },
          ],
    ...
    ar: {
      ...
      sections: {
        ...
        costSavings: {
          ...
          rows: [
            { 'الحجم السنوي من token': '100 مليون token', 'تكلفة API السحابية': '$1,000', 'الذكاء الاصطناعي المحلي (مُستهلَك)': '$500', 'التوفير السنوي': '$500' },
            { 'الحجم السنوي من token': '1,000 مليون token', 'تكلفة API السحابية': '$10,000', 'الذكاء الاصطناعي المحلي (مُستهلَك)': '$5,000', 'التوفير السنوي': '$5,000' },
            { 'الحجم السنوي من token': '10,000 مليون token', 'تكلفة API السحابية': '$100,000', 'الذكاء الاصطناعي المحلي (مُستهلَك)': '$50,000', 'التوفير السنوي': '$50,000' },
            { 'الحجم السنوي من token': '100,000 مليون token', 'تكلفة API السحابية': '$1,000,000', 'الذكاء الاصطناعي المحلي (مُستهلَك)': '$500,000', 'التوفير السنوي': '$500,000' },
          ],
        ...
        useCases: {
          ...
          rows: [
            { 'القطاع': 'الرعاية الصحية', 'حالة الاستخدام': 'تحليل المستندات الطبية (متوافق مع HIPAA)', 'الحجم السنوي': '500 مليون token/سنة', 'التوفير السنوي': '$8k/سنة' },
            { 'القطاع': 'المالية', 'حالة الاستخدام': 'تحليل الامتثال، والتقارير التنظيمية', 'الحجم السنوي': '2,000 مليون token/سنة', 'التوفير السنوي': '$35k/سنة' },
            { 'القطاع': 'القانون', 'حالة الاستخدام': 'مراجعة العقود، والعناية الواجبة', 'الحجم السنوي': '1,000 مليون token/سنة', 'التوفير السنوي': '$18k/سنة' },
            { 'القطاع': 'التصنيع', 'حالة الاستخدام': 'مراقبة الجودة، والصيانة التنبؤية', 'الحجم السنوي': '100 مليون token/سنة', 'التوفير السنوي': '$1.5k/سنة' },
            { 'القطاع': 'الحكومة', 'حالة الاستخدام': 'معالجة المستندات المصنّفة', 'الحجم السنوي': '500 مليون token/سنة', 'التوفير السنوي': '$8k/سنة + الامتثال' },
          ],
    ...
    de: {
      ...
      sections: {
        ...
        costSavings: {
          ...
          rows: [
            { 'Jährliches Token-Volumen': '100Mio. Token', 'Cloud-API-Kosten': '€900', 'Lokale KI (amortisiert)': '€450', 'Jährliche Einsparungen': '€450' },
            { 'Jährliches Token-Volumen': '1Mrd. Token', 'Cloud-API-Kosten': '€9.000', 'Lokale KI (amortisiert)': '€4.500', 'Jährliche Einsparungen': '€4.500' },
            { 'Jährliches Token-Volumen': '10Mrd. Token', 'Cloud-API-Kosten': '€90.000', 'Lokale KI (amortisiert)': '€45.000', 'Jährliche Einsparungen': '€45.000' },
            { 'Jährliches Token-Volumen': '100Mrd. Token', 'Cloud-API-Kosten': '€900.000', 'Lokale KI (amortisiert)': '€450.000', 'Jährliche Einsparungen': '€450.000' },
          ],
        ...
        useCases: {
          ...
          rows: [
            { 'Branche': 'Gesundheitswesen', 'Anwendungsfall': 'Medizinische Dokumentenanalyse (DSGVO-konform)', 'Jährliches Volumen': '500Mio. Token/Jahr', 'Jährliche Einsparungen': '€7k/Jahr' },
            { 'Branche': 'Finanzwesen', 'Anwendungsfall': 'Compliance-Analyse, Regulierungsarchivierung', 'Jährliches Volumen': '2Mrd. Token/Jahr', 'Jährliche Einsparungen': '€31k/Jahr' },
            { 'Branche': 'Recht', 'Anwendungsfall': 'Vertragsüberprüfung, Due-Diligence', 'Jährliches Volumen': '1Mrd. Token/Jahr', 'Jährliche Einsparungen': '€16k/Jahr' },
            { 'Branche': 'Fertigung', 'Anwendungsfall': 'Qualitätskontrolle, vorhersagende Wartung', 'Jährliches Volumen': '100Mio. Token/Jahr', 'Jährliche Einsparungen': '€1.4k/Jahr' },
            { 'Branche': 'Regierung', 'Anwendungsfall': 'Verarbeitung geheimer Dokumente', 'Jährliches Volumen': '500Mio. Token/Jahr', 'Jährliche Einsparungen': '€7k/Jahr + Compliance' },
          ],
    ...
    fr: {
      ...
      sections: {
        ...
        costSavings: {
          ...
          rows: [
            { 'Volume de jetons annuel': '100M jetons', 'Coût API cloud': '€900', 'IA local (amorti)': '€425', 'Économies annuelles': '€475' },
            { 'Volume de jetons annuel': '1Md jetons', 'Coût API cloud': '€9.000', 'IA local (amorti)': '€4.250', 'Économies annuelles': '€4.750' },
            { 'Volume de jetons annuel': '10Md jetons', 'Coût API cloud': '€90.000', 'IA local (amorti)': '€42.500', 'Économies annuelles': '€47.500' },
            { 'Volume de jetons annuel': '100Md jetons', 'Coût API cloud': '€900.000', 'IA local (amorti)': '€425.000', 'Économies annuelles': '€475.000' },
          ],
        ...
        useCases: {
          ...
          rows: [
            { 'Industrie': 'Santé', 'Cas d\'usage': 'Analyse de documents médicaux (conforme RGPD)', 'Volume annuel': '500M jetons/an', 'Économies annuelles': '€8k/an' },
            { 'Industrie': 'Finance', 'Cas d\'usage': 'Analyse de conformité, dépôt réglementaire', 'Volume annuel': '2Md jetons/an', 'Économies annuelles': '€32k/an' },
            { 'Industrie': 'Droit', 'Cas d\'usage': 'Examen de contrat, diligence raisonnable', 'Volume annuel': '1Md jetons/an', 'Économies annuelles': '€16k/an' },
            { 'Industrie': 'Fabrication', 'Cas d\'usage': 'Contrôle qualité, maintenance prédictive', 'Volume annuel': '100M jetons/an', 'Économies annuelles': '€1.4k/an' },
            { 'Industrie': 'Gouvernement', 'Cas d\'usage': 'Traitement de documents classifiés', 'Volume annuel': '500M jetons/an', 'Économies annuelles': '€8k/an + conformité' },
          ],
    ...
    ja: {
      ...
      sections: {
        ...
        costSavings: {
          ...
          rows: [
            { '年間トークンボリューム': '100M トークン', 'クラウドAPI費用': '¥11,000', 'ローカルAI（償却）': '¥5,500', '年間節約': '¥5,500' },
            { '年間トークンボリューム': '1Md トークン', 'クラウドAPI費用': '¥110,000', 'ローカルAI（償却）': '¥55,000', '年間節約': '¥55,000' },
            { '年間トークンボリューム': '10Md トークン', 'クラウドAPI費用': '¥1,100,000', 'ローカルAI（償却）': '¥550,000', '年間節約': '¥550,000' },
            { '年間トークンボリューム': '100Md トークン', 'クラウドAPI費用': '¥11,000,000', 'ローカルAI（償却）': '¥5,500,000', '年間節約': '¥5,500,000' },
          ],
        ...
        useCases: {
          ...
          rows: [
            { '業界': '医療', 'ユースケース': '医療文書分析（日本医療規制対応）', '年間ボリューム': '500M トークン/年', '年間節約': '¥8k/年' },
            { '業界': '金融', 'ユースケース': 'コンプライアンス分析、規制ファイリング', '年間ボリューム': '2Md トークン/年', '年間節約': '¥35k/年' },
            { '業界': '法務', 'ユースケース': '契約レビュー、デューデリジェンス', '年間ボリューム': '1Md トークン/年', '年間節約': '¥18k/年' },
            { '業界': '製造', 'ユースケース': '品質管理、予測メンテナンス', '年間ボリューム': '100M トークン/年', '年間節約': '¥1.5k/年' },
            { '業界': '政府', 'ユースケース': '機密文書処理', '年間ボリューム': '500M トークン/年', '年間節約': '¥8k/年 + コンプライアンス' },
          ],
    ...
    zh: {
      ...
      sections: {
        ...
        costSavings: {
          ...
          rows: [
            { '年度令牌量': '100M令牌', '云API成本': '$1,000', '本地AI（摊销）': '$500', '年度节省': '$500' },
            { '年度令牌量': '1Md令牌', '云API成本': '$10,000', '本地AI（摊销）': '$5,000', '年度节省': '$5,000' },
            { '年度令牌量': '10Md令牌', '云API成本': '$100,000', '本地AI（摊销）': '$50,000', '年度节省': '$50,000' },
            { '年度令牌量': '100Md令牌', '云API成本': '$1,000,000', '本地AI（摊销）': '$500,000', '年度节省': '$500,000' },
          ],
        ...
        useCases: {
          ...
          content: '企业如何使用本地LLM：',
          rows: [
            { '行业': '医疗', '用例': '医疗文档分析（数据安全法合规）', '年度量': '500M令牌/年', '年度节省': '$8k/年' },
            { '行业': '金融', '用例': '合规性分析、监管申报', '年度量': '2Md令牌/年', '年度节省': '$35k/年' },
            { '行业': '法律', '用例': '合同审查、尽职调查', '年度量': '1Md令牌/年', '年度节省': '$18k/年' },
            { '行业': '制造', '用例': '质量控制、预测性维护', '年度量': '100M令牌/年', '年度节省': '$1.5k/年' },
            { '行业': '政府', '用例': '机密文件处理', '年度量': '500M令牌/年', '年度节省': '$8k/年+合规' },
          ],
    ...
    heroImage: '/images/why-enterprises-use-local-llms-overview-hero-ko.webp',
      ...
      sections: {
        ...
        costSavings: {
          ...
          rows: [
            { '연간 토큰 사용량': '1억 토큰', '클라우드 API 비용': '$1,000', '로컬 AI (상각)': '$500', '연간 절감액': '$500' },
            { '연간 토큰 사용량': '10억 토큰', '클라우드 API 비용': '$10,000', '로컬 AI (상각)': '$5,000', '연간 절감액': '$5,000' },
            { '연간 토큰 사용량': '100억 토큰', '클라우드 API 비용': '$100,000', '로컬 AI (상각)': '$50,000', '연간 절감액': '$50,000' },
            { '연간 토큰 사용량': '1,000억 토큰', '클라우드 API 비용': '$1,000,000', '로컬 AI (상각)': '$500,000', '연간 절감액': '$500,000' },
          ],
        ...
        useCases: {
          ...
          rows: [
            { '업종': '의료', '활용 사례': '의료 문서 분석 (HIPAA 준수)', '연간 사용량': '연 5억 토큰', '연간 절감액': '연 $8,000' },
            { '업종': '금융', '활용 사례': '컴플라이언스 분석, 규제 신고', '연간 사용량': '연 20억 토큰', '연간 절감액': '연 $35,000' },
            { '업종': '법무', '활용 사례': '계약 검토, 실사', '연간 사용량': '연 10억 토큰', '연간 절감액': '연 $18,000' },
            { '업종': '제조', '활용 사례': '품질 관리, 예측 유지보수', '연간 사용량': '연 1억 토큰', '연간 절감액': '연 $1,500' },
            { '업종': '정부', '활용 사례': '기밀 문서 처리', '연간 사용량': '연 5억 토큰', '연간 절감액': '연 $8,000 + 컴플라이언스' },
          ],
