...
schema: {
    ...
    ar: {
      ...
      seoTitle: 'لماذا تختار المؤسسات نماذج LLM المحلية؟',
      ...
      metaDescription: 'توفّر المؤسسات بين $100k و$500k سنويًا بتجنّب رسوم API لكل token. دليل التكلفة والامتثال لـ GDPR وHIPAA وسيادة البيانات.',
      publishDate: '2026-04-04',
    ...
    pt: {
      ...
      sections: {
        ...
        costAnalysis: {
          ...
          rows: [
            { 'Serviço': 'Claude Sonnet 4.6', 'Custo por 1M tokens (entrada)': '$3,00', 'Custo por 1M tokens (saída)': '$15,00', 'Custo mensal (10B tokens)': '$180.000' },
            { 'Serviço': 'GPT-4o', 'Custo por 1M tokens (entrada)': '$2,50', 'Custo por 1M tokens (saída)': '$10,00', 'Custo mensal (10B tokens)': '$125.000' },
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'Qual é o ROI típico de LLMs locais para empresas?', a: 'Para cargas de trabalho de 1B+ tokens/mês, o hardware de $50K-200K geralmente se paga em 6-18 meses vs. APIs na nuvem como Claude Sonnet 4.6 ($3/1M tokens). A eletricidade adiciona $2.000-5.000/mês para clusters de 4-8 GPUs.' },
