...
schema: {
    ...
    es: {
      ...
      publishDate: '2026-04-05',
      dateModified: '2026-04-19',
      leadAnswerBlock: '**Solo CPU: Phi-4 Mini 3.8B a 5–15 tok/s. 4 GB VRAM: TinyLlama 1.1B Q5 a 20–40 tok/s. 8 GB VRAM: Mistral 7B Q4 o Llama 3.1 8B Q4 a 25–60 tok/s. Los modelos 1B–3B alcanzan 60–120 tok/s para máxima velocidad.**',
      quickAnswer: {
        ...
        bullets: [
          ...
          '**8 GB VRAM (punto óptimo):** Mistral 7B Q4 o Llama 3.1 8B Q4 — 25–60 tok/s, experiencia completa de asistente',
        ],
      ...
      sections: {
        ...
        'hardware-decision': {
          ...
          rows: [
            ...
            { 'Tu hardware': '8 GB VRAM', 'Modelo recomendado': 'Mistral 7B Q4', 'Velocidad esperada': '25–60 tok/s' },
        ...
        'by-hardware': {
          ...
          rows: [
            ...
            { 'Hardware': 'GPU 8 GB', 'Model': 'Mistral 7B', 'Quant': 'Q4', 'Speed': '25–60 t/s', 'Experience': 'fluido' },
        ...
        'faqSection': {
          ...
          faqs: [
            ...
            { q: '¿Puedo ejecutar Mistral 7B en una GPU de 4 GB?', a: 'Con cuantización Q2, sí. Con Q4, no (cuelgue por OOM). Q2 tiene una pérdida de calidad aceptable (~5–10% menor en la puntuación MMLU), pero la velocidad aumenta un 30%. Es una compensación práctica para usuarios con VRAM limitada.' },
      ...
      schema: {
        ...
        'about': [
          ...
          { '@type': 'Thing', 'name': 'TinyLlama 1B' },
          { '@type': 'Thing', 'name': 'Phi-4 Mini 3.8B' },
          { '@type': 'Thing', 'name': 'Velocidad Mistral 7B Q4' },
        ],
        'speakable': {
          '@type': 'SpeakableSpecification',
          'cssSelector': ['.article-intro', '.key-takeaways'],
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Sí, pero lentamente. Mistral 7B Q4 necesita ~4.5 GB para los pesos del modelo más ~2 GB para el SO — cabe en 8 GB de RAM. Espera 3–8 tok/s en CPU. Usable para tareas por lotes, borradores y trabajo offline. No apto para chat interactivo.',
            },
          },
          {
            '@type': 'Question',
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Mistral 7B Q4 en Ollama con 8 GB VRAM da 25–60 tok/s — comparable a ChatGPT para tareas básicas. La calidad es menor que GPT-4o pero suficiente para chat, resúmenes y código simple. Completamente gratuito, funciona offline, sin necesidad de clave API.',
            },
          },
          {
            '@type': 'Question',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 4, 'name': '8 GB VRAM (RTX 3060) — punto óptimo', 'description': 'Mistral 7B Q4. 25–60 tok/s. Experiencia completa de asistente. ollama run mistral' },
