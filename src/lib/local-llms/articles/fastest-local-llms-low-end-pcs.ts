...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      current_models_mentioned: ['Qwen3 1.7B', 'Phi-4-mini 3.8B', 'Qwen3 4B', 'Qwen3 8B', 'Llama 3.2 3B', 'Gemma 4 E2B'],
      ...
      toc: [
        ...
        { label: 'How Fast Are These Models? Real Benchmarks (2026)', anchor: '#benchmarks' },
      ...
      sections: {
        ...
        'model-picker': {
          ...
          items: [
            ...
            '**Also worth testing on 4–8 GB RAM:** Gemma 4 E2B (~1.5–2 GB, released June 2026) — Google\'s smallest current-generation model. `ollama run gemma4:e2b`. Not yet benchmarked on this guide\'s hardware set; see [CPU-only benchmark guide](/local-llms/best-cpu-only-llm) for measured speeds on other CPUs.',
        ...
        'faqSection': {
          ...
          faqs: [
            ...
            { q: 'Is Gemma 4 E2B faster than Qwen3 1.7B on a low-end PC?', a: 'Gemma 4 E2B (Google, released June 2026, ~1.5–2 GB) is a newer CPU-friendly option worth testing alongside Qwen3 1.7B on 4–8 GB RAM systems. It measured 15 tok/s on an Intel i7-12700 in PromptQuorum\'s CPU-only benchmark guide — a faster desktop-class CPU than the mini PCs and ultrabooks benchmarked on this page. Qwen3 1.7B remains this guide\'s tested pick for the lowest-power hardware (25–40 tok/s on Intel N100/i5-1235U-class CPUs); if your system is closer to a desktop-class i7, try `ollama run gemma4:e2b` for comparison.' },
          ],
        },
        'relatedReading': {
          id: 'related',
...
schema: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          {
            '@type': 'Question',
            'name': 'Is Gemma 4 E2B faster than Qwen3 1.7B on a low-end PC?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Gemma 4 E2B (Google, released June 2026, ~1.5–2 GB) is a newer CPU-friendly option worth testing alongside Qwen3 1.7B on 4–8 GB RAM systems. It measured 15 tok/s on an Intel i7-12700 in PromptQuorum\'s CPU-only benchmark guide — a faster desktop-class CPU than the mini PCs and ultrabooks benchmarked on this page. Qwen3 1.7B remains this guide\'s tested pick for the lowest-power hardware (25–40 tok/s on Intel N100/i5-1235U-class CPUs); if your system is closer to a desktop-class i7, try `ollama run gemma4:e2b` for comparison.',
            },
          },
        ],
      },
    ...
    es: {
      ...
      twitterDescription: 'Solo CPU: Qwen3 1.7B 25–40 tok/s. Phi-4-mini 15–25 tok/s. Guía sin GPU con 8 GB RAM. Comandos de Ollama incluidos.',
      publishDate: '2026-04-05',
      dateModified: '2026-09-02',
      ...
      toc: [
        ...
        { label: '¿Qué tan rápidos son estos modelos? Benchmarks reales (2026)', anchor: '#benchmarks' },
      ...
      sections: {
        ...
        'model-picker': {
          ...
          items: [
            ...
            '**También vale la pena probar en 4–8 GB de RAM:** Gemma 4 E2B (~1.5–2 GB, lanzado en junio de 2026) — el modelo más pequeño de la generación actual de Google. `ollama run gemma4:e2b`. Aún no evaluado con el hardware de esta guía; consulta la [guía de modelos solo CPU](/es/local-llms/best-cpu-only-llm) para velocidades medidas en otras CPU.',
        ...
        'faqSection': {
          ...
          faqs: [
            ...
            { q: '¿Un modelo de IA local es lo mismo que un LLM local?', a: 'Para esta guía, sí. "Modelo de IA local" es la forma coloquial de referirse a lo que el sector llama LLM local (modelo de lenguaje grande) — pesos generadores de texto que descargas una vez y ejecutas en tu propia máquina, sin conexión. La distinción solo importa cuando el modelo de IA no se basa en texto: generadores de imágenes como Stable Diffusion y modelos de voz como Whisper también funcionan localmente, pero tienen perfiles de hardware distintos y ninguna de las cifras de tok/s de esta guía se les aplica.' },
            { q: '¿Cuál es el LLM local más ligero que aún escribe texto utilizable?', a: 'Qwen3 1.7B en Q4_K_M es el modelo más ligero de esta guía que vale la pena usar — unos 1.1 GB en disco, funciona con 4 GB de RAM, 25–40 tok/s solo CPU. Existen opciones más pequeñas (TinyLlama 1.1B, Qwen3 0.6B) y son aún más rápidas, pero la calidad de salida baja tanto que es mejor tratarlas como autocompletado que como asistente de escritura. Por debajo de aproximadamente 1B de parámetros, ningún modelo ligero produce texto largo de forma fiablemente coherente.' },
            { q: '¿Gemma 4 E2B es más rápido que Qwen3 1.7B en un PC de gama baja?', a: 'Gemma 4 E2B (Google, lanzado en junio de 2026, ~1.5–2 GB) es una opción más reciente y apta para CPU que vale la pena probar junto a Qwen3 1.7B en sistemas con 4–8 GB de RAM. Alcanzó 15 tok/s en un Intel i7-12700 en la guía de referencia solo CPU de PromptQuorum — una CPU de escritorio más potente que los mini PC y ultrabooks evaluados en esta página. Qwen3 1.7B sigue siendo la opción probada de esta guía para el hardware de menor potencia (25–40 tok/s en CPU de la clase Intel N100/i5-1235U); si tu equipo se acerca más a un i7 de escritorio, prueba `ollama run gemma4:e2b` para comparar.' },
          ],
        },
        'relatedReading': {
          id: 'related',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          {
            '@type': 'Question',
            'name': '¿Un modelo de IA local es lo mismo que un LLM local?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Para esta guía, sí. "Modelo de IA local" es la forma coloquial de referirse a lo que el sector llama LLM local (modelo de lenguaje grande) — pesos generadores de texto que descargas una vez y ejecutas en tu propia máquina, sin conexión. La distinción solo importa cuando el modelo de IA no se basa en texto: generadores de imágenes como Stable Diffusion y modelos de voz como Whisper también funcionan localmente, pero tienen perfiles de hardware distintos y ninguna de las cifras de tok/s de esta guía se les aplica.',
            },
          },
          {
            '@type': 'Question',
            'name': '¿Cuál es el LLM local más ligero que aún escribe texto utilizable?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Qwen3 1.7B en Q4_K_M es el modelo más ligero de esta guía que vale la pena usar — unos 1.1 GB en disco, funciona con 4 GB de RAM, 25–40 tok/s solo CPU. Existen opciones más pequeñas (TinyLlama 1.1B, Qwen3 0.6B) y son aún más rápidas, pero la calidad de salida baja tanto que es mejor tratarlas como autocompletado que como asistente de escritura. Por debajo de aproximadamente 1B de parámetros, ningún modelo ligero produce texto largo de forma fiablemente coherente.',
            },
          },
          {
            '@type': 'Question',
            'name': '¿Gemma 4 E2B es más rápido que Qwen3 1.7B en un PC de gama baja?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Gemma 4 E2B (Google, lanzado en junio de 2026, ~1.5–2 GB) es una opción más reciente y apta para CPU que vale la pena probar junto a Qwen3 1.7B en sistemas con 4–8 GB de RAM. Alcanzó 15 tok/s en un Intel i7-12700 en la guía de referencia solo CPU de PromptQuorum — una CPU de escritorio más potente que los mini PC y ultrabooks evaluados en esta página. Qwen3 1.7B sigue siendo la opción probada de esta guía para el hardware de menor potencia (25–40 tok/s en CPU de la clase Intel N100/i5-1235U); si tu equipo se acerca más a un i7 de escritorio, prueba `ollama run gemma4:e2b` para comparar.',
            },
          },
        ],
      },
    ...
    ar: {
      ...
      twitterDescription: 'CPU فقط: Qwen3 1.7B بسرعة 25–40 tok/s. Phi-4-mini بسرعة 15–25 tok/s. دليل 8 جيجابايت رام دون GPU. أوامر Ollama مضمّنة.',
      publishDate: '2026-04-05',
      dateModified: '2026-09-02',
      ...
      toc: [
        ...
        { label: 'ما مدى سرعة هذه النماذج؟ معايير حقيقية (2026)', anchor: '#benchmarks' },
      ...
      sections: {
        ...
        'model-picker': {
          ...
          items: [
            ...
            '**يستحق التجربة أيضاً على 4–8 جيجابايت رام:** Gemma 4 E2B (~1.5–2 جيجابايت، صدر في يونيو 2026) — أصغر نموذج من الجيل الحالي لجوجل. `ollama run gemma4:e2b`. لم يُختبر بعد على أجهزة هذا الدليل؛ راجع [دليل النماذج بمعالج فقط](/ar/local-llms/best-cpu-only-llm) للسرعات المقاسة على معالجات أخرى.',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          {
            '@type': 'Question',
            'name': 'هل نموذج الذكاء الاصطناعي المحلي هو نفسه LLM المحلي؟',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'بالنسبة لهذا الدليل، نعم. "نموذج الذكاء الاصطناعي المحلي" هو التعبير الشائع لما يسميه المجال LLM محلي (نموذج لغوي كبير) — أوزان مولّدة للنص تُحمّل مرة واحدة وتُشغّل على جهازك الخاص، دون اتصال. لا يهم هذا التمييز إلا عندما يكون نموذج الذكاء الاصطناعي غير نصي: مولدات الصور مثل Stable Diffusion ونماذج الكلام مثل Whisper تعمل محلياً أيضاً، لكن لها ملفات أجهزة مختلفة ولا تنطبق عليها أرقام tok/s في هذا الدليل.',
            },
          },
          {
            '@type': 'Question',
            'name': 'ما هو أخف LLM محلي لا يزال يكتب نصاً قابلاً للاستخدام؟',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Qwen3 1.7B بصيغة Q4_K_M هو أخف نموذج في هذا الدليل يستحق الاستخدام — نحو 1.1 جيجابايت على القرص، يعمل بـ 4 جيجابايت رام، وبسرعة 25–40 tok/s على CPU فقط. توجد خيارات أصغر (TinyLlama 1.1B، Qwen3 0.6B) وهي أسرع، لكن جودة الإخراج تنخفض بشكل حاد يجعل التعامل معها كإكمال تلقائي أفضل من اعتبارها مساعد كتابة. دون نحو 1 مليار معامل، لا ينتج أي نموذج خفيف نصاً طويلاً متماسكاً بشكل موثوق.',
            },
          },
          {
            '@type': 'Question',
            'name': 'هل Gemma 4 E2B أسرع من Qwen3 1.7B على كمبيوتر منخفض الأداء؟',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Gemma 4 E2B (جوجل، صدر في يونيو 2026، ~1.5–2 جيجابايت) خيار أحدث وملائم لـ CPU يستحق التجربة إلى جانب Qwen3 1.7B على أنظمة 4–8 جيجابايت رام. سجّل 15 tok/s على معالج Intel i7-12700 في دليل PromptQuorum المرجعي لمعالج فقط — معالج مكتبي أقوى من أجهزة الميني بي سي وأجهزة الألترابوك المُختبرة في هذه الصفحة. يبقى Qwen3 1.7B الخيار المُختبر في هذا الدليل للأجهزة الأضعف (25–40 tok/s على معالجات من فئة Intel N100/i5-1235U)؛ إذا كان جهازك أقرب إلى i7 مكتبي، جرّب `ollama run gemma4:e2b` للمقارنة.',
            },
          },
        ],
      },
    ...
    pt: {
      ...
      twitterDescription: 'Somente CPU: Qwen3 1.7B 25–40 tok/s. Phi-4-mini 15–25 tok/s. Guia sem GPU com 8 GB de RAM. Comandos do Ollama incluídos.',
      publishDate: '2026-04-05',
      dateModified: '2026-09-02',
      ...
      toc: [
        ...
        { label: 'Qual a velocidade real desses modelos? Benchmarks (2026)', anchor: '#benchmarks' },
      ...
      sections: {
        ...
        'model-picker': {
          ...
          items: [
            ...
            '**Também vale testar em 4–8 GB de RAM:** Gemma 4 E2B (~1.5–2 GB, lançado em junho de 2026) — o menor modelo da geração atual do Google. `ollama run gemma4:e2b`. Ainda não testado no hardware deste guia; veja o [guia de modelos somente CPU](/pt/local-llms/best-cpu-only-llm) para velocidades medidas em outras CPUs.',
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          {
            '@type': 'Question',
            'name': 'Como verifico minha RAM disponível no Windows?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Abra o Gerenciador de Tarefas → Desempenho → Memória. O total mostrado é sua RAM do sistema — compare com a tabela de decisão de hardware acima (níveis de 4 GB, 8 GB ou 16 GB) para escolher o modelo certo.',
            },
          },
          {
            '@type': 'Question',
            'name': 'Quanto mais rápida é uma GPU dedicada em comparação à CPU para LLMs locais?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': '5–10× mais rápida. Uma RTX 4060 8 GB usada (~US$250) supera amplamente qualquer configuração somente CPU coberta neste guia. Uma iGPU Intel Iris fica no meio-termo — por exemplo, o Qwen3 4B atinge 12–20 tok/s com offload de iGPU contra 8–15 tok/s somente CPU no nível comparável mais próximo.',
            },
          },
          {
            '@type': 'Question',
            'name': 'Um modelo de IA local é a mesma coisa que um LLM local?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Para este guia, sim. "Modelo de IA local" é a forma cotidiana de se referir ao que a área chama de LLM local (modelo de linguagem grande) — pesos geradores de texto que você baixa uma vez e roda na sua própria máquina, offline. A distinção só importa quando o modelo de IA não é baseado em texto: geradores de imagem como Stable Diffusion e modelos de fala como Whisper também rodam localmente, mas têm perfis de hardware diferentes e nenhum dos números de tok/s deste guia se aplica a eles.',
            },
          },
          {
            '@type': 'Question',
            'name': 'Qual é o LLM local mais leve que ainda escreve texto utilizável?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'O Qwen3 1.7B em Q4_K_M é o modelo mais leve deste guia que vale a pena usar — cerca de 1,1 GB em disco, roda em 4 GB de RAM, 25–40 tok/s somente CPU. Existem opções menores (TinyLlama 1.1B, Qwen3 0.6B) e são ainda mais rápidas, mas a qualidade da saída cai o suficiente para que sejam melhor tratadas como autocompletar do que como assistente de escrita. Abaixo de aproximadamente 1B de parâmetros, nenhum modelo leve produz texto longo de forma confiavelmente coerente.',
            },
          },
          {
            '@type': 'Question',
            'name': 'O Gemma 4 E2B é mais rápido que o Qwen3 1.7B em um PC de baixo custo?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'O Gemma 4 E2B (Google, lançado em junho de 2026, ~1.5–2 GB) é uma opção mais recente e amigável para CPU que vale a pena testar junto ao Qwen3 1.7B em sistemas com 4–8 GB de RAM. Ele registrou 15 tok/s em um Intel i7-12700 no guia de referência somente CPU da PromptQuorum — uma CPU de desktop mais potente que os mini PCs e ultrabooks testados nesta página. O Qwen3 1.7B continua sendo a escolha testada deste guia para o hardware mais fraco (25–40 tok/s em CPUs da classe Intel N100/i5-1235U); se o seu sistema for mais parecido com um i7 de desktop, experimente `ollama run gemma4:e2b` para comparar.',
            },
          },
        ],
      },
    ...
    de: {
      ...
      twitterDescription: 'Nur CPU: Qwen3 1.7B 25–40 Tok/s. Phi-4-mini 15–25 Tok/s. 8GB-RAM-Guide ohne GPU. Ollama-Befehle inklusive.',
      publishDate: '2026-04-05',
      dateModified: '2026-09-02',
      ...
      toc: [
        ...
        { label: 'Wie schnell sind diese Modelle? Echte Benchmarks (2026)', anchor: '#benchmarks' },
      ...
      sections: {
        ...
        'model-picker': {
          ...
          items: [
            ...
            '**Ebenfalls einen Test wert bei 4–8 GB RAM:** Gemma 4 E2B (~1,5–2 GB, veröffentlicht im Juni 2026) — Googles kleinstes aktuelles Modell. `ollama run gemma4:e2b`. Auf der Hardware dieses Guides noch nicht benchmarkt; siehe den [Leitfaden für reine CPU-Modelle](/de/local-llms/best-cpu-only-llm) für gemessene Geschwindigkeiten auf anderen CPUs.',
        ...
        'faqSection': {
          ...
          faqs: [
            ...
            { q: 'Ist ein lokales KI-Modell dasselbe wie ein lokales LLM?', a: 'Für diesen Leitfaden: ja. "Lokales KI-Modell" ist die umgangssprachliche Bezeichnung für das, was der Fachbereich lokales LLM (Large Language Model) nennt — textgenerierende Gewichte, die Sie einmal herunterladen und offline auf Ihrem eigenen Gerät ausführen. Der Unterschied spielt nur eine Rolle, wenn das KI-Modell nicht textbasiert ist: Bildgeneratoren wie Stable Diffusion und Sprachmodelle wie Whisper laufen ebenfalls lokal, haben aber andere Hardware-Profile, und keine der Tok/s-Angaben in diesem Leitfaden gilt für sie.' },
            { q: 'Was ist das leichteste lokale LLM, das noch brauchbaren Text schreibt?', a: 'Qwen3 1.7B bei Q4_K_M ist das leichteste Modell in diesem Leitfaden, das sich lohnt — etwa 1,1 GB auf der Festplatte, läuft mit 4 GB RAM, 25–40 Tok/s rein auf CPU. Kleinere Optionen existieren (TinyLlama 1.1B, Qwen3 0.6B) und sind noch schneller, aber die Ausgabequalität sinkt so stark, dass sie eher als Autovervollständigung denn als Schreibassistent zu behandeln sind. Unter etwa 1 Mrd. Parametern liefert kein leichtgewichtiges Modell zuverlässig kohärenten Fließtext.' },
            { q: 'Ist Gemma 4 E2B schneller als Qwen3 1.7B auf einem Low-End-PC?', a: 'Gemma 4 E2B (Google, veröffentlicht im Juni 2026, ~1,5–2 GB) ist eine neuere, CPU-freundliche Option, die sich neben Qwen3 1.7B auf Systemen mit 4–8 GB RAM zu testen lohnt. Im CPU-only-Benchmark-Leitfaden von PromptQuorum erreichte es 15 Tok/s auf einem Intel i7-12700 — einer leistungsstärkeren Desktop-CPU als den in diesem Artikel getesteten Mini-PCs und Ultrabooks. Qwen3 1.7B bleibt die getestete Wahl dieses Leitfadens für die schwächste Hardware (25–40 Tok/s auf CPUs der Klasse Intel N100/i5-1235U); wenn Ihr System eher einem Desktop-i7 entspricht, probieren Sie zum Vergleich `ollama run gemma4:e2b`.' },
          ],
        },
        'relatedReading': {
          id: 'related',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          {
            '@type': 'Question',
            'name': 'Ist ein lokales KI-Modell dasselbe wie ein lokales LLM?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Für diesen Leitfaden: ja. "Lokales KI-Modell" ist die umgangssprachliche Bezeichnung für das, was der Fachbereich lokales LLM (Large Language Model) nennt — textgenerierende Gewichte, die Sie einmal herunterladen und offline auf Ihrem eigenen Gerät ausführen. Der Unterschied spielt nur eine Rolle, wenn das KI-Modell nicht textbasiert ist: Bildgeneratoren wie Stable Diffusion und Sprachmodelle wie Whisper laufen ebenfalls lokal, haben aber andere Hardware-Profile, und keine der Tok/s-Angaben in diesem Leitfaden gilt für sie.',
            },
          },
          {
            '@type': 'Question',
            'name': 'Was ist das leichteste lokale LLM, das noch brauchbaren Text schreibt?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Qwen3 1.7B bei Q4_K_M ist das leichteste Modell in diesem Leitfaden, das sich lohnt — etwa 1,1 GB auf der Festplatte, läuft mit 4 GB RAM, 25–40 Tok/s rein auf CPU. Kleinere Optionen existieren (TinyLlama 1.1B, Qwen3 0.6B) und sind noch schneller, aber die Ausgabequalität sinkt so stark, dass sie eher als Autovervollständigung denn als Schreibassistent zu behandeln sind. Unter etwa 1 Mrd. Parametern liefert kein leichtgewichtiges Modell zuverlässig kohärenten Fließtext.',
            },
          },
          {
            '@type': 'Question',
            'name': 'Ist Gemma 4 E2B schneller als Qwen3 1.7B auf einem Low-End-PC?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Gemma 4 E2B (Google, veröffentlicht im Juni 2026, ~1,5–2 GB) ist eine neuere, CPU-freundliche Option, die sich neben Qwen3 1.7B auf Systemen mit 4–8 GB RAM zu testen lohnt. Im CPU-only-Benchmark-Leitfaden von PromptQuorum erreichte es 15 Tok/s auf einem Intel i7-12700 — einer leistungsstärkeren Desktop-CPU als den in diesem Artikel getesteten Mini-PCs und Ultrabooks. Qwen3 1.7B bleibt die getestete Wahl dieses Leitfadens für die schwächste Hardware (25–40 Tok/s auf CPUs der Klasse Intel N100/i5-1235U); wenn Ihr System eher einem Desktop-i7 entspricht, probieren Sie zum Vergleich `ollama run gemma4:e2b`.',
            },
          },
        ],
      },
    ...
    fr: {
      ...
      twitterDescription: 'CPU seul : Qwen3 1.7B 25–40 tok/s. Phi-4-mini 15–25 tok/s. Guide sans GPU, 8 Go de RAM. Commandes Ollama incluses.',
      publishDate: '2026-04-05',
      dateModified: '2026-09-02',
      ...
      toc: [
        ...
        { label: 'À quelle vitesse tournent ces modèles ? Benchmarks réels (2026)', anchor: '#benchmarks' },
      ...
      sections: {
        ...
        'model-picker': {
          ...
          items: [
            ...
            '**À tester aussi sur 4–8 Go de RAM :** Gemma 4 E2B (~1.5–2 Go, sorti en juin 2026) — le plus petit modèle de la génération actuelle de Google. `ollama run gemma4:e2b`. Pas encore benchmarké sur le matériel de ce guide ; voir le [guide des modèles CPU uniquement](/fr/local-llms/best-cpu-only-llm) pour des vitesses mesurées sur d\'autres CPU.',
        ...
        'faqSection': {
          ...
          faqs: [
            ...
            { q: 'Un modèle d\'IA local est-il la même chose qu\'un LLM local ?', a: 'Pour ce guide, oui. « Modèle d\'IA local » est la formulation courante pour ce que le secteur appelle un LLM local (grand modèle de langage) — des poids générateurs de texte que vous téléchargez une fois et exécutez sur votre propre machine, hors ligne. La distinction ne compte que lorsque le modèle d\'IA n\'est pas basé sur le texte : les générateurs d\'images comme Stable Diffusion et les modèles vocaux comme Whisper fonctionnent aussi en local, mais avec des profils matériels différents, et aucun des chiffres de tok/s de ce guide ne s\'applique à eux.' },
            { q: 'Quel est le LLM local le plus léger qui écrit encore un texte utilisable ?', a: 'Qwen3 1.7B en Q4_K_M est le modèle le plus léger de ce guide qui vaut la peine d\'être utilisé — environ 1,1 Go sur disque, tourne avec 4 Go de RAM, 25–40 tok/s en CPU seul. Des options plus petites existent (TinyLlama 1.1B, Qwen3 0.6B) et sont encore plus rapides, mais la qualité de sortie chute suffisamment pour qu\'elles soient plutôt traitées comme de l\'autocomplétion que comme un assistant de rédaction. En dessous d\'environ 1 milliard de paramètres, aucun modèle léger ne produit de texte long de façon fiablement cohérente.' },
            { q: 'Gemma 4 E2B est-il plus rapide que Qwen3 1.7B sur un PC bas de gamme ?', a: 'Gemma 4 E2B (Google, sorti en juin 2026, ~1.5–2 Go) est une option plus récente et adaptée au CPU, à tester à côté de Qwen3 1.7B sur des systèmes avec 4–8 Go de RAM. Il a atteint 15 tok/s sur un Intel i7-12700 dans le guide de référence CPU uniquement de PromptQuorum — un CPU de bureau plus puissant que les mini PC et ultrabooks testés dans cet article. Qwen3 1.7B reste le choix testé de ce guide pour le matériel le plus faible (25–40 tok/s sur des CPU de classe Intel N100/i5-1235U) ; si votre machine se rapproche davantage d\'un i7 de bureau, essayez `ollama run gemma4:e2b` pour comparer.' },
          ],
        },
        'relatedReading': {
          id: 'related',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          {
            '@type': 'Question',
            'name': 'Un modèle d\'IA local est-il la même chose qu\'un LLM local ?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Pour ce guide, oui. « Modèle d\'IA local » est la formulation courante pour ce que le secteur appelle un LLM local (grand modèle de langage) — des poids générateurs de texte que vous téléchargez une fois et exécutez sur votre propre machine, hors ligne. La distinction ne compte que lorsque le modèle d\'IA n\'est pas basé sur le texte : les générateurs d\'images comme Stable Diffusion et les modèles vocaux comme Whisper fonctionnent aussi en local, mais avec des profils matériels différents, et aucun des chiffres de tok/s de ce guide ne s\'applique à eux.',
            },
          },
          {
            '@type': 'Question',
            'name': 'Quel est le LLM local le plus léger qui écrit encore un texte utilisable ?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Qwen3 1.7B en Q4_K_M est le modèle le plus léger de ce guide qui vaut la peine d\'être utilisé — environ 1,1 Go sur disque, tourne avec 4 Go de RAM, 25–40 tok/s en CPU seul. Des options plus petites existent (TinyLlama 1.1B, Qwen3 0.6B) et sont encore plus rapides, mais la qualité de sortie chute suffisamment pour qu\'elles soient plutôt traitées comme de l\'autocomplétion que comme un assistant de rédaction. En dessous d\'environ 1 milliard de paramètres, aucun modèle léger ne produit de texte long de façon fiablement cohérente.',
            },
          },
          {
            '@type': 'Question',
            'name': 'Gemma 4 E2B est-il plus rapide que Qwen3 1.7B sur un PC bas de gamme ?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Gemma 4 E2B (Google, sorti en juin 2026, ~1.5–2 Go) est une option plus récente et adaptée au CPU, à tester à côté de Qwen3 1.7B sur des systèmes avec 4–8 Go de RAM. Il a atteint 15 tok/s sur un Intel i7-12700 dans le guide de référence CPU uniquement de PromptQuorum — un CPU de bureau plus puissant que les mini PC et ultrabooks testés dans cet article. Qwen3 1.7B reste le choix testé de ce guide pour le matériel le plus faible (25–40 tok/s sur des CPU de classe Intel N100/i5-1235U) ; si votre machine se rapproche davantage d\'un i7 de bureau, essayez `ollama run gemma4:e2b` pour comparer.',
            },
          },
        ],
      },
    ...
    ja: {
      ...
      twitterDescription: 'CPU専用：Qwen3 1.7B 25〜40トークン/秒。Phi-4-mini 15〜25トークン/秒。RAM 8GB・GPU不要ガイド。Ollamaコマンド付き。',
      publishDate: '2026-04-05',
      dateModified: '2026-09-02',
      ...
      toc: [
        ...
        { label: '実際のベンチマーク（2026年）', anchor: '#benchmarks' },
      ...
      sections: {
        ...
        'model-picker': {
          ...
          items: [
            ...
            '**4〜8GB RAMで試す価値もあり：** Gemma 4 E2B（約1.5〜2GB、2026年6月リリース）— Googleの現行世代最小モデル。`ollama run gemma4:e2b`。このガイドのハードウェアではまだベンチマーク未実施。他のCPUでの測定速度は[CPU専用モデルガイド](/ja/local-llms/best-cpu-only-llm)を参照。',
        ...
        'faqSection': {
          ...
          faqs: [
            ...
            { q: 'ローカルAIモデルとローカルLLMは同じものですか？', a: '本ガイドでは同じ意味で使っています。「ローカルAIモデル」は、業界がローカルLLM（大規模言語モデル）と呼ぶもの — 一度ダウンロードして自分のマシン上でオフラインで実行するテキスト生成の重み — を指す日常的な言い方です。この区別が重要になるのは、AIモデルがテキストベースでない場合のみです。Stable Diffusionのような画像生成モデルやWhisperのような音声モデルもローカルで動作しますが、ハードウェア要件が異なり、本ガイドのトークン/秒の数値はいずれも当てはまりません。' },
            { q: '実用的な文章を書ける最も軽量なローカルLLMは何ですか？', a: 'Q4_K_MのQwen3 1.7Bが、本ガイドで使う価値のある最軽量モデルです — ディスク上で約1.1GB、4GBのRAMで動作し、CPU専用で25〜40トークン/秒。さらに小さい選択肢（TinyLlama 1.1B、Qwen3 0.6B）も存在し速度はより速いですが、出力品質が大きく落ちるため、文章作成アシスタントというよりオートコンプリートとして扱う方が適切です。おおよそ10億パラメータを下回ると、軽量モデルは長文で安定した一貫性のあるテキストを生成できません。' },
            { q: 'Gemma 4 E2BはローエンドPCでQwen3 1.7Bより速いですか？', a: 'Gemma 4 E2B（Google、2026年6月リリース、約1.5〜2GB）は、4〜8GBのRAMシステムでQwen3 1.7Bと並んで試す価値のある新しいCPU向けの選択肢です。PromptQuorumのCPU専用ベンチマークガイドでは、Intel i7-12700で15トークン/秒を記録しました — 本ページでベンチマークしたミニPCやウルトラブックより高性能なデスクトップ級CPUです。本ガイドの最も非力なハードウェア（Intel N100/i5-1235U級CPUで25〜40トークン/秒）向けの検証済みの選択肢としては、引き続きQwen3 1.7Bが最適です。お使いのシステムがデスクトップ向けi7に近い場合は、比較のために`ollama run gemma4:e2b`を試してください。' },
          ],
        },
        'relatedReading': {
          id: 'related',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          {
            '@type': 'Question',
            'name': 'ローカルAIモデルとローカルLLMは同じものですか？',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': '本ガイドでは同じ意味で使っています。「ローカルAIモデル」は、業界がローカルLLM(大規模言語モデル)と呼ぶもの — 一度ダウンロードして自分のマシン上でオフラインで実行するテキスト生成の重み — を指す日常的な言い方です。この区別が重要になるのは、AIモデルがテキストベースでない場合のみです。Stable Diffusionのような画像生成モデルやWhisperのような音声モデルもローカルで動作しますが、ハードウェア要件が異なり、本ガイドのトークン/秒の数値はいずれも当てはまりません。',
            },
          },
          {
            '@type': 'Question',
            'name': '実用的な文章を書ける最も軽量なローカルLLMは何ですか？',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Q4_K_MのQwen3 1.7Bが、本ガイドで使う価値のある最軽量モデルです — ディスク上で約1.1GB、4GBのRAMで動作し、CPU専用で25〜40トークン/秒。さらに小さい選択肢(TinyLlama 1.1B、Qwen3 0.6B)も存在し速度はより速いですが、出力品質が大きく落ちるため、文章作成アシスタントというよりオートコンプリートとして扱う方が適切です。おおよそ10億パラメータを下回ると、軽量モデルは長文で安定した一貫性のあるテキストを生成できません。',
            },
          },
          {
            '@type': 'Question',
            'name': 'Gemma 4 E2BはローエンドPCでQwen3 1.7Bより速いですか？',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Gemma 4 E2B(Google、2026年6月リリース、約1.5〜2GB)は、4〜8GBのRAMシステムでQwen3 1.7Bと並んで試す価値のある新しいCPU向けの選択肢です。PromptQuorumのCPU専用ベンチマークガイドでは、Intel i7-12700で15トークン/秒を記録しました — 本ページでベンチマークしたミニPCやウルトラブックより高性能なデスクトップ級CPUです。本ガイドの最も非力なハードウェア(Intel N100/i5-1235U級CPUで25〜40トークン/秒)向けの検証済みの選択肢としては、引き続きQwen3 1.7Bが最適です。お使いのシステムがデスクトップ向けi7に近い場合は、比較のために`ollama run gemma4:e2b`を試してください。',
            },
          },
        ],
      },
    ...
    zh: {
      ...
      twitterDescription: '纯CPU：Qwen3 1.7B 25–40 tok/s。Phi-4-mini 15–25 tok/s。8GB内存无GPU指南。附Ollama命令。',
      publishDate: '2026-04-05',
      dateModified: '2026-09-02',
      ...
      toc: [
        ...
        { label: '这些模型有多快？真实基准（2026年）', anchor: '#benchmarks' },
      ...
      sections: {
        ...
        'model-picker': {
          ...
          items: [
            ...
            '**在4–8 GB内存上也值得尝试：** Gemma 4 E2B（约1.5–2 GB，2026年6月发布）——谷歌当前一代最小的模型。`ollama run gemma4:e2b`。尚未在本指南的硬件上测试；其他CPU上的实测速度见[纯CPU模型指南](/zh/local-llms/best-cpu-only-llm)。',
        ...
        'faqSection': {
          ...
          faqs: [
            ...
            { q: '本地AI模型和本地LLM是同一回事吗？', a: '在本指南中，是的。"本地AI模型"是业界所说的本地LLM（大语言模型）的通俗说法——即下载一次、在自己设备上离线运行的文本生成权重。这一区分只在AI模型不基于文本时才有意义：Stable Diffusion等图像生成模型和Whisper等语音模型也能本地运行，但硬件要求不同，本指南中的tok/s数据均不适用于它们。' },
            { q: '仍能写出可用文本的最轻量本地LLM是什么？', a: 'Q4_K_M量化的Qwen3 1.7B是本指南中值得使用的最轻量模型——磁盘占用约1.1 GB，4 GB内存即可运行，纯CPU下25–40 tok/s。更小的选择也存在（TinyLlama 1.1B、Qwen3 0.6B），速度更快，但输出质量下降明显，更适合作为自动补全而非写作助手。参数量低于约10亿时，轻量模型无法可靠生成连贯的长文本。' },
            { q: 'Gemma 4 E2B在低配电脑上比Qwen3 1.7B快吗？', a: 'Gemma 4 E2B（谷歌，2026年6月发布，约1.5–2 GB）是一款更新的CPU友好型选项，值得在4–8 GB内存系统上与Qwen3 1.7B一同测试。在PromptQuorum的纯CPU基准指南中，它在Intel i7-12700上达到15 tok/s——比本页测试的迷你主机和轻薄本更强的桌面级CPU。对于本指南中最低功耗的硬件（Intel N100/i5-1235U级CPU上25–40 tok/s），Qwen3 1.7B仍是经过实测的首选；如果你的设备更接近桌面级i7，可尝试`ollama run gemma4:e2b`进行对比。' },
          ],
        },
        'relatedReading': {
          id: 'related',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          {
            '@type': 'Question',
            'name': '本地AI模型和本地LLM是同一回事吗？',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': '在本指南中，是的。"本地AI模型"是业界所说的本地LLM（大语言模型）的通俗说法——即下载一次、在自己设备上离线运行的文本生成权重。这一区分只在AI模型不基于文本时才有意义：Stable Diffusion等图像生成模型和Whisper等语音模型也能本地运行，但硬件要求不同，本指南中的tok/s数据均不适用于它们。',
            },
          },
          {
            '@type': 'Question',
            'name': '仍能写出可用文本的最轻量本地LLM是什么？',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Q4_K_M量化的Qwen3 1.7B是本指南中值得使用的最轻量模型——磁盘占用约1.1 GB，4 GB内存即可运行，纯CPU下25–40 tok/s。更小的选择也存在（TinyLlama 1.1B、Qwen3 0.6B），速度更快，但输出质量下降明显，更适合作为自动补全而非写作助手。参数量低于约10亿时，轻量模型无法可靠生成连贯的长文本。',
            },
          },
          {
            '@type': 'Question',
            'name': 'Gemma 4 E2B在低配电脑上比Qwen3 1.7B快吗？',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Gemma 4 E2B（谷歌，2026年6月发布，约1.5–2 GB）是一款更新的CPU友好型选项，值得在4–8 GB内存系统上与Qwen3 1.7B一同测试。在PromptQuorum的纯CPU基准指南中，它在Intel i7-12700上达到15 tok/s——比本页测试的迷你主机和轻薄本更强的桌面级CPU。对于本指南中最低功耗的硬件（Intel N100/i5-1235U级CPU上25–40 tok/s），Qwen3 1.7B仍是经过实测的首选；如果你的设备更接近桌面级i7，可尝试`ollama run gemma4:e2b`进行对比。',
            },
          },
        ],
      },
  ...
  ko: {
      ...
      twitterDescription: 'CPU 전용: Qwen3 1.7B 초당 25–40 토큰. Phi-4-mini 초당 15–25 토큰. RAM 8GB GPU 불필요 가이드. Ollama 명령어 포함.',
      publishDate: '2026-04-05',
      dateModified: '2026-09-02',
      ...
      toc: [
        ...
        { label: '이 모델들은 얼마나 빠릅니까? 실제 벤치마크 (2026년)', anchor: '#benchmarks' },
      ...
      sections: {
        ...
        'model-picker': {
          ...
          items: [
            ...
            '**4–8GB RAM에서도 시도해 볼 가치가 있음:** Gemma 4 E2B(약 1.5–2GB, 2026년 6월 출시) — Google의 현세대 최소형 모델입니다. `ollama run gemma4:e2b`. 이 가이드의 하드웨어에서는 아직 벤치마크하지 않았습니다. 다른 CPU에서 측정된 속도는 [CPU 전용 모델 가이드](/ko/local-llms/best-cpu-only-llm)를 참고하십시오.',
        ...
        'faqSection': {
          ...
          faqs: [
            ...
            { q: '로컬 AI 모델과 로컬 LLM은 같은 것입니까?', a: '이 가이드에서는 동일한 의미로 사용합니다. "로컬 AI 모델"은 업계에서 로컬 LLM(대규모 언어 모델)이라고 부르는 것 — 한 번 다운로드하여 자신의 기기에서 오프라인으로 실행하는 텍스트 생성 가중치 — 을 가리키는 일상적 표현입니다. 이 구분이 중요해지는 경우는 AI 모델이 텍스트 기반이 아닐 때뿐입니다. Stable Diffusion과 같은 이미지 생성 모델이나 Whisper와 같은 음성 모델도 로컬에서 실행되지만 하드웨어 요구사항이 다르며, 이 가이드의 tok/s 수치는 이들에 적용되지 않습니다.' },
            { q: '실용적인 텍스트를 작성할 수 있는 가장 가벼운 로컬 LLM은 무엇입니까?', a: 'Q4_K_M 양자화된 Qwen3 1.7B가 이 가이드에서 사용할 가치가 있는 가장 가벼운 모델입니다 — 디스크 용량 약 1.1GB, 4GB RAM에서 실행되며 CPU 전용으로 초당 25–40 토큰입니다. 더 작은 옵션(TinyLlama 1.1B, Qwen3 0.6B)도 존재하며 속도는 더 빠르지만, 출력 품질이 크게 떨어져 글쓰기 보조 도구보다는 자동완성으로 취급하는 것이 낫습니다. 약 10억 파라미터 미만에서는 가벼운 모델이 안정적으로 일관된 장문 텍스트를 생성하지 못합니다.' },
            { q: '저사양 PC에서 Gemma 4 E2B가 Qwen3 1.7B보다 빠릅니까?', a: 'Gemma 4 E2B(Google, 2026년 6월 출시, 약 1.5–2GB)는 4–8GB RAM 시스템에서 Qwen3 1.7B와 함께 시도해 볼 가치가 있는 최신 CPU 친화적 옵션입니다. PromptQuorum의 CPU 전용 벤치마크 가이드에서 Intel i7-12700 기준 초당 15 토큰을 기록했습니다 — 이 페이지에서 벤치마크한 미니 PC나 울트라북보다 강력한 데스크톱급 CPU입니다. 이 가이드에서 가장 저사양인 하드웨어(Intel N100/i5-1235U급 CPU에서 초당 25–40 토큰)에 대해서는 Qwen3 1.7B가 여전히 검증된 선택입니다. 사용 중인 시스템이 데스크톱용 i7에 더 가깝다면 비교를 위해 `ollama run gemma4:e2b`를 시도해 보십시오.' },
          ],
        },
        'relatedReading': {
          id: 'related',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          {
            '@type': 'Question',
            'name': '로컬 AI 모델과 로컬 LLM은 같은 것입니까?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': '이 가이드에서는 동일한 의미로 사용합니다. "로컬 AI 모델"은 업계에서 로컬 LLM(대규모 언어 모델)이라고 부르는 것 — 한 번 다운로드하여 자신의 기기에서 오프라인으로 실행하는 텍스트 생성 가중치 — 을 가리키는 일상적 표현입니다. 이 구분이 중요해지는 경우는 AI 모델이 텍스트 기반이 아닐 때뿐입니다. Stable Diffusion과 같은 이미지 생성 모델이나 Whisper와 같은 음성 모델도 로컬에서 실행되지만 하드웨어 요구사항이 다르며, 이 가이드의 tok/s 수치는 이들에 적용되지 않습니다.',
            },
          },
          {
            '@type': 'Question',
            'name': '실용적인 텍스트를 작성할 수 있는 가장 가벼운 로컬 LLM은 무엇입니까?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Q4_K_M 양자화된 Qwen3 1.7B가 이 가이드에서 사용할 가치가 있는 가장 가벼운 모델입니다 — 디스크 용량 약 1.1GB, 4GB RAM에서 실행되며 CPU 전용으로 초당 25–40 토큰입니다. 더 작은 옵션(TinyLlama 1.1B, Qwen3 0.6B)도 존재하며 속도는 더 빠르지만, 출력 품질이 크게 떨어져 글쓰기 보조 도구보다는 자동완성으로 취급하는 것이 낫습니다. 약 10억 파라미터 미만에서는 가벼운 모델이 안정적으로 일관된 장문 텍스트를 생성하지 못합니다.',
            },
          },
          {
            '@type': 'Question',
            'name': '저사양 PC에서 Gemma 4 E2B가 Qwen3 1.7B보다 빠릅니까?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Gemma 4 E2B(Google, 2026년 6월 출시, 약 1.5–2GB)는 4–8GB RAM 시스템에서 Qwen3 1.7B와 함께 시도해 볼 가치가 있는 최신 CPU 친화적 옵션입니다. PromptQuorum의 CPU 전용 벤치마크 가이드에서 Intel i7-12700 기준 초당 15 토큰을 기록했습니다 — 이 페이지에서 벤치마크한 미니 PC나 울트라북보다 강력한 데스크톱급 CPU입니다. 이 가이드에서 가장 저사양인 하드웨어(Intel N100/i5-1235U급 CPU에서 초당 25–40 토큰)에 대해서는 Qwen3 1.7B가 여전히 검증된 선택입니다. 사용 중인 시스템이 데스크톱용 i7에 더 가깝다면 비교를 위해 `ollama run gemma4:e2b`를 시도해 보십시오.',
            },
          },
        ],
      },
