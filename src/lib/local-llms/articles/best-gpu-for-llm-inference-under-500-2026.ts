...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    quickAnswerTop: {
      ...
      bullets: [
        '**Winner:** RTX 4060 Ti 16GB (~$424) — 16 GB VRAM, 165 W, ~55 tok/s on Llama 3.1 8B Q4, runs 14B at Q4 in-GPU',
        ...
        '⚠️ RTX 3090 used: market price now $850–1,050 — no longer sub-$500',
    ...
    sections: {
      ...
      benchmarkTable: {
        ...
        content: 'Benchmarks measured with Ollama 0.30.x, llama.cpp server, models from HuggingFace. Test system: Ryzen 9 7950X, 64 GB DDR5, NVMe SSD. Prices verified — used RTX 3090 ($850–1,050), RTX 4070 12GB (~$700), and RX 7800 XT 16GB (~$832) excluded: all now exceed $500.',
        columns: ['GPU', 'VRAM', 'Price', 'Llama 3.1 8B Q4 tok/s', 'Qwen3 14B Q8 tok/s', 'Max Model (Q4)'],
        rows: [
          { GPU: 'RTX 4060 Ti 16GB', VRAM: '16 GB', 'Price': '~$424', 'Llama 3.1 8B Q4 tok/s': '55 tok/s', 'Qwen3 14B Q8 tok/s': '22 tok/s', 'Max Model (Q4)': '30B (Q4)' },
          { GPU: 'RTX 3060 12GB', VRAM: '12 GB', 'Price': '~$339', 'Llama 3.1 8B Q4 tok/s': '36 tok/s', 'Qwen3 14B Q8 tok/s': 'VRAM limited', 'Max Model (Q4)': '14B (Q4)' },
          { GPU: 'Intel Arc B580 12GB', VRAM: '12 GB', 'Price': '~$303', 'Llama 3.1 8B Q4 tok/s': '31 tok/s', 'Qwen3 14B Q8 tok/s': 'VRAM limited', 'Max Model (Q4)': '13B (Q4)' },
        ],
      ...
      decisionMatrix: {
        ...
        content: 'Use this decision guide based on your primary use case. Prices verified:',
        items: [
          ...
          '**Need 30B model capability?** → The sub-$500 window closed in mid-2026. Used RTX 3090 (24 GB) now trades at $850–1,050. Budget $1,000+ for a used RTX 3090 or $850+ for an RTX 4080 SUPER (16 GB).',
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'No — used RTX 3090 cards now trade at $850–1,050 on eBay, up from ~$440 in early 2025. For 30B model capability you need a $1,000+ budget for a used RTX 3090 or ~$850 for an RTX 4080 SUPER (16 GB).',
          },
        },
        {
          '@type': 'Question',
  ...
  es: {
    ...
    metaDescription: 'La mejor GPU económica para inferencia LLM local por menos de 500 € es la RTX 4060 Ti 16GB (~520 €): sus 16 GB de VRAM ejecutan modelos 14B en Q4 en GPU. La RTX 3060 12GB (~334 €) es la segunda mejor.',
    educationalLevel: 'Intermediate',
    affiliateDisclosure: true,
    publishDate: '2026-05-26',
    ...
    quickAnswerTop: {
      ...
      bullets: [
        '**Ganadora:** RTX 4060 Ti 16GB (~520 €) — 16 GB VRAM, 165 W, ~55 tok/s en Llama 3.1 8B Q4, ejecuta 14B en Q4 en GPU',
    ...
    sections: {
      ...
      benchmarkTable: {
        ...
        content: 'Benchmarks medidos con Ollama 0.30.x, servidor llama.cpp, modelos de HuggingFace. Sistema de prueba: Ryzen 9 7950X, 64 GB DDR5, NVMe SSD. Precios verificados — RTX 3090 usada (950–1.150 €), RTX 4070 12GB (~599 €) y RX 7800 XT 16GB (~682 €) excluidas: todas superan ahora los 500 €.',
        columns: ['GPU', 'VRAM', 'Precio', 'Llama 3.1 8B Q4 tok/s', 'Qwen3 14B Q8 tok/s', 'Modelo máximo (Q4)'],
        rows: [
          { GPU: 'RTX 4060 Ti 16GB', VRAM: '16 GB', 'Precio': '~520 €', 'Llama 3.1 8B Q4 tok/s': '55 tok/s', 'Qwen3 14B Q8 tok/s': '22 tok/s', 'Modelo máximo (Q4)': '30B (Q4)' },
          { GPU: 'RTX 3060 12GB', VRAM: '12 GB', 'Precio': '~334 €', 'Llama 3.1 8B Q4 tok/s': '36 tok/s', 'Qwen3 14B Q8 tok/s': 'Limitado por VRAM', 'Modelo máximo (Q4)': '14B (Q4)' },
          { GPU: 'Intel Arc B580 12GB', VRAM: '12 GB', 'Precio': '~250 €', 'Llama 3.1 8B Q4 tok/s': '31 tok/s', 'Qwen3 14B Q8 tok/s': 'Limitado por VRAM', 'Modelo máximo (Q4)': '13B (Q4)' },
        ],
  ...
  ar: {
    ...
    metaDescription: 'أفضل ⁨GPU⁩ اقتصادية للاستدلال المحلي على ⁨LLM⁩ بأقل من $⁨500⁩ هي ⁨RTX 4060 Ti 16GB⁩ (~$⁨424⁩): تشغّل ⁨16 GB VRAM⁩ نماذج ⁨14B⁩ بتكميم ⁨Q4⁩ بالكامل على ⁨GPU. RTX 3060 12GB⁩ (~$⁨339⁩) هي البديل الأرخص. الأسعار الحالية.',
    educationalLevel: 'Intermediate',
    affiliateDisclosure: true,
    publishDate: '2026-05-26',
    ...
    quickAnswerTop: {
      ...
      bullets: [
        '**الفائزة:** RTX 4060 Ti 16GB (~$424) — 16 GB VRAM، 165 W، ~55 tok/s على Llama 3.1 8B Q4، تشغّل 14B بتكميم Q4 على GPU',
    ...
    sections: {
      ...
      benchmarkTable: {
        ...
        columns: ['GPU', 'VRAM', 'السعر (يوليو 2026)', 'Llama 3.1 8B Q4 tok/s', 'Qwen3 14B Q8 tok/s', 'أقصى نموذج (Q4)'],
        rows: [
          { GPU: 'RTX 4060 Ti 16GB', VRAM: '16 GB', 'السعر (يوليو 2026)': '~$424', 'Llama 3.1 8B Q4 tok/s': '55 tok/s', 'Qwen3 14B Q8 tok/s': '22 tok/s', 'أقصى نموذج (Q4)': '30B (Q4)' },
          { GPU: 'RTX 3060 12GB', VRAM: '12 GB', 'السعر (يوليو 2026)': '~$339', 'Llama 3.1 8B Q4 tok/s': '36 tok/s', 'Qwen3 14B Q8 tok/s': 'محدود بـ VRAM', 'أقصى نموذج (Q4)': '14B (Q4)' },
          { GPU: 'Intel Arc B580 12GB', VRAM: '12 GB', 'السعر (يوليو 2026)': '~$303', 'Llama 3.1 8B Q4 tok/s': '31 tok/s', 'Qwen3 14B Q8 tok/s': 'محدود بـ VRAM', 'أقصى نموذج (Q4)': '13B (Q4)' },
        ],
  ...
  pt: {
    ...
    quickAnswerTop: {
      ...
      bullets: [
        '**Vencedora:** RTX 4060 Ti 16GB (~R$ 3.299) — 16 GB de VRAM, 165 W, ~55 tok/s no Llama 3.1 8B Q4, roda 14B em Q4 na GPU',
    ...
    sections: {
      ...
      benchmarkTable: {
        ...
        content: 'Benchmarks medidos com Ollama 0.30.x, servidor llama.cpp, modelos do HuggingFace. Sistema de teste: Ryzen 9 7950X, 64 GB DDR5, SSD NVMe. Preços verificados — RTX 3090 usada (a partir de R$ 6.000), RTX 4070 12GB (~R$ 3.500) e RX 7800 XT 16GB (~R$ 2.900) excluídas: todas excedem a faixa de US$ 500. Os preços no Brasil podem variar bastante devido a impostos de importação.',
        columns: ['GPU', 'VRAM', 'Preço', 'Llama 3.1 8B Q4 tok/s', 'Qwen3 14B Q8 tok/s', 'Modelo máximo (Q4)'],
        rows: [
          { GPU: 'RTX 4060 Ti 16GB', VRAM: '16 GB', 'Preço': '~R$ 3.299', 'Llama 3.1 8B Q4 tok/s': '55 tok/s', 'Qwen3 14B Q8 tok/s': '22 tok/s', 'Modelo máximo (Q4)': '30B (Q4)' },
          { GPU: 'RTX 3060 12GB', VRAM: '12 GB', 'Preço': '~R$ 1.999', 'Llama 3.1 8B Q4 tok/s': '36 tok/s', 'Qwen3 14B Q8 tok/s': 'Limitado pela VRAM', 'Modelo máximo (Q4)': '14B (Q4)' },
          { GPU: 'Intel Arc B580 12GB', VRAM: '12 GB', 'Preço': '~R$ 1.919', 'Llama 3.1 8B Q4 tok/s': '31 tok/s', 'Qwen3 14B Q8 tok/s': 'Limitado pela VRAM', 'Modelo máximo (Q4)': '13B (Q4)' },
        ],
  ...
  de: {
    ...
    metaDescription: 'Die beste Budget-GPU für lokale LLM-Inferenz ist die RTX 4060 Ti 16GB (~520 €): 16 GB VRAM führen 14B-Modelle mit Q4 komplett in-GPU aus. RTX 3060 12GB (~334 €) ist der günstigere Zweitplatzierte.',
    educationalLevel: 'Intermediate',
    affiliateDisclosure: true,
    publishDate: '2026-05-26',
    ...
    quickAnswerTop: {
      ...
      bullets: [
        '**Sieger:** RTX 4060 Ti 16GB (~520 €) — 16 GB VRAM, 165 W, ~55 Tok/s bei Llama 3.1 8B Q4, führt 14B mit Q4 in-GPU aus',
  ...
  fr: {
    ...
    quickAnswerTop: {
      ...
      bullets: [
        '**Gagnante :** RTX 4060 Ti 16 Go (~520 €) — 16 Go VRAM, 165 W, ~55 tok/s sur Llama 3.1 8B Q4, fait tourner 14B en Q4 en GPU',
    ...
    sections: {
      ...
      benchmarkTable: {
        ...
        content: 'Benchmarks mesurés avec Ollama 0.30.x, serveur llama.cpp, modèles issus de HuggingFace. Système de test : Ryzen 9 7950X, 64 Go DDR5, SSD NVMe. Prix vérifiés — RTX 3090 occasion (950–1 150 €), RTX 4070 12 Go (~599 €) et RX 7800 XT 16 Go (~682 €) exclues : toutes dépassent désormais 500 €.',
        columns: ['GPU', 'VRAM', 'Prix', 'Llama 3.1 8B Q4 tok/s', 'Qwen3 14B Q8 tok/s', 'Modèle max (Q4)'],
        rows: [
          { GPU: 'RTX 4060 Ti 16 Go', VRAM: '16 Go', 'Prix': '~520 €', 'Llama 3.1 8B Q4 tok/s': '55 tok/s', 'Qwen3 14B Q8 tok/s': '22 tok/s', 'Modèle max (Q4)': '30B (Q4)' },
          { GPU: 'RTX 3060 12 Go', VRAM: '12 Go', 'Prix': '~334 €', 'Llama 3.1 8B Q4 tok/s': '36 tok/s', 'Qwen3 14B Q8 tok/s': 'Limité par la VRAM', 'Modèle max (Q4)': '14B (Q4)' },
          { GPU: 'Intel Arc B580 12 Go', VRAM: '12 Go', 'Prix': '~250 €', 'Llama 3.1 8B Q4 tok/s': '31 tok/s', 'Qwen3 14B Q8 tok/s': 'Limité par la VRAM', 'Modèle max (Q4)': '13B (Q4)' },
        ],
  ...
  ja: {
    ...
    quickAnswerTop: {
      ...
      bullets: [
        '**優勝:** RTX 4060 Ti 16GB（~¥88,000）— 16GB VRAM、165W、Llama 3.1 8B Q4で約55トークン/秒、14BをQ4でGPU内実行',
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
            ...
            { q: '中古RTX 3090は今でも$500以下で買えますか？', a: 'いいえ——2026年7月時点でeBayや中古市場の中古RTX 3090は約¥150,000〜200,000で取引されています。LLM愛好家が24GB VRAMの価値を認識したため、2024年以降価格が大幅に上昇しました。もはや$500相当以下の選択肢ではありません。30Bモデル（24GB VRAM必要）には¥150,000以上の予算を組むか、RTX 4080 SUPER（16GB、約¥150,000新品）で14B Q8のより高速なパフォーマンスを検討してください。' },
            ...
            { q: 'AI用のIntel Arc GPUはどうですか？', a: 'Intel Arc B580 12GBは2026年のベストなArc選択肢です。SYCLバックエンドでWindowsとLinuxの両方でOllamaを実行できますが、性能は生のトークン/秒でNVIDIAより30〜40%低くなります。コストパフォーマンスは強力です：12GB VRAMが約¥70,000で、最新システムではドライバー問題もありません。主な制限はソフトウェアで、vLLM・ファインチューニングツール・マルチモーダルランタイムはまだArcを十分にサポートしていません。' },
            ...
            { q: '新しいGPU（RTX 5060 Ti）はこれらを時代遅れにしますか？', a: 'NVIDIAのRTX 5060 Tiは2026年に発売が確認されており、RTX 4060 Tiを下回る価格帯が見込まれています。RTX 4060 Ti 16GBは現在（2026年7月）検証済みの最良の価値を保っています。2〜3か月待てるなら、RTX 5060 Tiの発売状況を確認してください——より高い性能で$500相当以下の範囲に入る可能性があります。今すぐGPUが必要なら、RTX 4060 Ti 16GBが安全な選択です。' },
            { q: '中古のRTX 4060 Ti 16GBは2026年7月時点でいくらですか？', a: '中古のRTX 4060 Ti 16GBは新品価格の約¥88,000から15〜20%安く、状態や保証残存期間にもよりますが目安は約¥70,000〜75,000です。比較的新しいカードでLLM用途の需要が転売価値を支えているため、RTX 3090のような旧世代カードほどの値引き幅はありません。実際の相場を知るには、出品中ではなく「売却済み」のオークション落札価格を確認してください。また16GBモデルであることを必ず確認しましょう——8GB版のRTX 4060 Tiも存在し、そちらでは14BモデルをQ4で実行できません。' },
          ],
      },
      relatedReading: {
        id: 'related-reading',
    ...
    faqSchema: {
      ...
      mainEntity: [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'いいえ——2026年7月時点でeBayや中古市場の中古RTX 3090は約¥150,000〜200,000で取引されています。LLM愛好家が24GB VRAMの価値を認識したため、2024年以降価格が大幅に上昇しました。もはや$500相当以下の選択肢ではありません。30Bモデル（24GB VRAM必要）には¥150,000以上の予算を組むか、RTX 4080 SUPER（16GB、約¥150,000新品）で14B Q8のより高速なパフォーマンスを検討してください。',
            },
          },
          {
            '@type': 'Question',
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Intel Arc B580 12GBは2026年のベストなArc選択肢です。SYCLバックエンドでWindowsとLinuxの両方でOllamaを実行できますが、性能は生のトークン/秒でNVIDIAより30〜40%低くなります。コストパフォーマンスは強力です：12GB VRAMが約¥70,000で、最新システムではドライバー問題もありません。主な制限はソフトウェアで、vLLM・ファインチューニングツール・マルチモーダルランタイムはまだArcを十分にサポートしていません。',
            },
          },
          {
            '@type': 'Question',
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'NVIDIAのRTX 5060 Tiは2026年に発売が確認されており、RTX 4060 Tiを下回る価格帯が見込まれています。RTX 4060 Ti 16GBは現在（2026年7月）検証済みの最良の価値を保っています。2〜3か月待てるなら、RTX 5060 Tiの発売状況を確認してください——より高い性能で$500相当以下の範囲に入る可能性があります。今すぐGPUが必要なら、RTX 4060 Ti 16GBが安全な選択です。',
            },
          },
          {
            '@type': 'Question',
            'name': '中古のRTX 4060 Ti 16GBは2026年7月時点でいくらですか？',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': '中古のRTX 4060 Ti 16GBは新品価格の約¥88,000から15〜20%安く、状態や保証残存期間にもよりますが目安は約¥70,000〜75,000です。比較的新しいカードでLLM用途の需要が転売価値を支えているため、RTX 3090のような旧世代カードほどの値引き幅はありません。実際の相場を知るには、出品中ではなく「売却済み」のオークション落札価格を確認してください。また16GBモデルであることを必ず確認しましょう——8GB版のRTX 4060 Tiも存在し、そちらでは14BモデルをQ4で実行できません。',
            },
          },
        ],
    },
  ...
  zh: {
    ...
    quickAnswerTop: {
      ...
      bullets: [
        '**优胜:** RTX 4060 Ti 16GB（~$424）——16GB显存、165W、Llama 3.1 8B Q4约55 tok/s，14B Q4完全在GPU内运行',
  ...
  ko: {
    ...
    metaDescription: '$500 이하 로컬 LLM 추론에 가장 좋은 보급형 GPU는 RTX 4060 Ti 16GB(~$424)입니다. 16GB VRAM으로 14B 모델을 Q4로 GPU 내에서 완전히 실행합니다. RTX 3060 12GB가 더 저렴한 차선책입니다. 현재 가격.',
    educationalLevel: 'Intermediate',
    affiliateDisclosure: true,
    publishDate: '2026-05-26',
    ...
    quickAnswerTop: {
      ...
      bullets: [
        '**우승:** RTX 4060 Ti 16GB(~$424) — 16GB VRAM, 165W, Llama 3.1 8B Q4에서 약 55 tok/s, 14B를 Q4로 GPU 내에서 실행',
