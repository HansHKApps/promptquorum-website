  ...
  pt: {
    ...
    sections: {
      ...
      decisionMatrix: {
        ...
        items: [
          '**Melhor opção geral por menos de US$ 500** → RTX 4060 Ti 16GB (~R$ 3.299). Roda 14B em Q4 totalmente na GPU (Q8 com folga), 16 GB de VRAM, cadeia de ferramentas CUDA e amplo suporte no Windows/Linux.',
