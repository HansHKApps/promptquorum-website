...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      metaDescription: 'RTX 4090: 575W, $52/month at $0.12/kWh. RTX 5090: 575W, 32GB VRAM. M5 Max Mac: 30W (10× more efficient). 1200W PSU required. Cooling, EU/Japan costs included.',
...
schema: {
    ...
    de: {
      ...
      seoTitle: 'Stromverbrauch lokaler LLMs 2026: RTX 4090 575W = €150/Monat',
      ...
      metaDescription: 'RTX 4090: 575W, €150/Monat bei €0,35/kWh. RTX 5090: 575W, 32GB VRAM. M5 Max Mac: 30W (10× effizienter). 1200W PSU erforderlich. Kühlung, DSGVO-Konformität, EU-Stromkosten.',
      publishDate: '2026-04-04',
      dateModified: '2026-04-25',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            '[Leitfaden zur Hardware für lokale LLMs 2026](/local-llms/local-llm-hardware-guide-2026?lang=de) — Komplette Hardware-Einrichtung und Komponentenauswahl.',
            '[Beste GPUs für lokale LLMs](/local-llms/best-gpus-for-local-llms?lang=de) — GPU-Auswahlhilfe für alle Preisstufen.',
            '[Laptop vs Desktop für lokale LLM](/local-llms/laptop-vs-desktop-local-llm?lang=de) — Strom- und Thermik-Kompromisse für mobile Inferenz.',
...
schema: {
        ...
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
        inLanguage: 'de',
        url: 'https://www.promptquorum.com/local-llms/local-llm-power-consumption?lang=de',
    ...
    fr: {
      ...
      seoTitle: 'Consommation électrique des LLMs locaux 2026 : RTX 4090 575W = 110 €/mois',
      ...
      metaDescription: 'RTX 4090 : 575W, 110 €/mois à €0.30/kWh. RTX 5090 : 575W, 32GB VRAM. M5 Max : 30W (10× plus efficace). Alimentation 1200W requise. Refroidissement, conformité CNIL, coûts Europe.',
      publishDate: '2026-04-04',
      dateModified: '2026-04-25',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            '[Guide complet du matériel LLM local 2026](/local-llms/local-llm-hardware-guide-2026?lang=fr) — Configuration matérielle complète et sélection de composants.',
            '[Meilleures GPUs pour LLMs locaux](/local-llms/best-gpus-for-local-llms?lang=fr) — Guide de sélection GPU pour tous les niveaux.',
            '[Ordinateur portable vs Bureau pour LLM local](/local-llms/laptop-vs-desktop-local-llm?lang=fr) — Compromis énergétiques et thermiques pour l\'inférence mobile.',
...
schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        url: 'https://www.promptquorum.com/local-llms/local-llm-power-consumption?lang=fr',
        inLanguage: 'fr',
    ...
    zh: {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          title: '相关阅读',
          items: [
            '[本地LLM硬件指南2026](/local-llms/local-llm-hardware-guide-2026?lang=zh) — 完整硬件设置',
            '[本地LLM最佳GPU选择](/local-llms/best-gpus-for-local-llms?lang=zh) — GPU选型指南',
            '[笔记本 vs 台式机 本地LLM](/local-llms/laptop-vs-desktop-local-llm?lang=zh) — 移动功耗考量',
      ...
      schema: {
        ...
        url: 'https://www.promptquorum.com/local-llms/local-llm-power-consumption?lang=zh',
        inLanguage: 'zh',
        datePublished: '2026-04-04',
        dateModified: '2026-04-25',
    ...
    ja: {
      ...
      sections: {
        ...
        'relatedReading': {
          ...
          title: '関連記事',
          items: [
            '[ローカルLLM GPU要件ガイド](/local-llms/gpu-requirements-local-llm?lang=ja)',
            '[2026年 ベストローカルLLM GPU](/local-llms/best-gpus-local-llm?lang=ja)',
            '[ノートパソコン vs デスクトップ: ローカルLLM](/local-llms/laptop-vs-desktop-local-llm?lang=ja)',
          ],
        },
        'sources': {
          id: 'sources',
      ...
      schema: {
        ...
        url: 'https://www.promptquorum.com/local-llms/local-llm-power-consumption?lang=ja',
        inLanguage: 'ja',
        datePublished: '2026-04-04',
        dateModified: '2026-04-25',
        author: { '@type': 'Organization', name: 'PromptQuorum' },
