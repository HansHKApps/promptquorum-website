...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      heroImage: '/images/local-llm-power-consumption-overview-hero-en.png',
...
schema: {
    ...
    es: {
      ...
      next_refresh_due: '2026-10-04',
      theme: 'Hardware & Performance',
      heroImage: '/images/local-llm-power-consumption-overview-hero-es.png',
    ...
    ar: {
      ...
      next_refresh_due: '2026-10-04',
      theme: 'Hardware & Performance',
      heroImage: '/images/local-llm-power-consumption-overview-hero-ar.png',
    ...
    pt: {
      ...
      next_refresh_due: '2026-10-04',
      theme: 'Hardware & Performance',
      heroImage: '/images/local-llm-power-consumption-overview-hero-pt.png',
    ...
    de: {
      theme: 'Hardware & Performance',
      heroImage: '/images/local-llm-power-consumption-overview-hero-de.png',
...
schema: {
    ...
    fr: {
      ...
      heroImage: '/images/local-llm-power-consumption-overview-hero-fr.png',
...
schema: {
    ...
    zh: {
      freshness_tier: 'semi_annual',
      theme: '硬件 & 性能',
      heroImage: '/images/local-llm-power-consumption-overview-hero-zh.png',
    ...
    ja: {
      ...
      next_refresh_due: '2026-10-04',
      theme: 'Hardware & Performance',
      heroImage: '/images/local-llm-power-consumption-overview-hero-ja.png',
  ...
  ko: {
      ...
      next_refresh_due: '2026-10-04',
      theme: '하드웨어 및 성능',
    heroImage: '/images/local-llm-power-consumption-overview-hero-ko.png',
      ...
      toc: [
        ...
        { label: 'LLM 추론 시 GPU별 전력 소비량은?', anchor: '#gpu-power' },
        { label: '로컬 LLM PC의 총 전력 소비량은?', anchor: '#system-power' },
        { label: '로컬 LLM을 24/7 실행하는 비용은?', anchor: '#electricity-cost' },
        { label: '로컬 LLM 추론에 필요한 냉각 장치는?', anchor: '#cooling' },
        { label: '빠른 팩트', anchor: '#quick-facts' },
        { label: '흔한 실수', anchor: '#common-mistakes' },
        { label: '지역별 전기 비용', anchor: '#regional-context' },
        { label: '전력 및 냉각 FAQ', anchor: '#faq' },
      ...
      sections: {
        ...
        gpuPower: {
          ...
          rows: [
            ...
            { 'GPU': 'RTX 4070', 'Power': '200W', 'Idle': '6W', 'PSU': '650W' },
            { 'GPU': 'AMD RX 7900 XTX', 'Power': '355W', 'Idle': '25W', 'PSU': '850W' },
            { 'GPU': 'Apple M5 Max (GPU)', 'Power': '25~35W', 'Idle': '1W', 'PSU': '내장' },
            { 'GPU': 'Apple M5 Pro (GPU)', 'Power': '20~28W', 'Idle': '1W', 'PSU': '내장' },
          ],
          columns: ['GPU', 'Power', 'Idle', 'PSU'],
          callouts: [
            { type: 'warning', text: 'RTX 5090 TDP: NVIDIA는 575W로 규정하지만 전원 제한 설정에 따라 실제 최대 전력은 600W+에 달할 수 있습니다.' },
          ],
        },
        systemPower: {
          id: 'system-power',
          ...
          rows: [
            ...
            { 'Component': '**총 시스템 부하**', 'Power': '**~895~945W**', 'Notes': '**최소 1200W PSU 필요**' },
          ],
          columns: ['Component', 'Power', 'Notes'],
          callouts: [
            { type: 'keypoint', text: 'GPU는 총 시스템 전력의 60~65%를 차지합니다. CPU, 냉각, 오버헤드가 나머지 35~40%입니다.' },
          ],
        },
        electricityCost: {
          id: 'electricity-cost',
          title: '로컬 LLM을 24/7 실행하는 비용은?',
          image: '/images/local-llm-power-consumption-electricity-cost-en.svg',
          imageCaption: '$0.12/kWh 기준 24/7 로컬 LLM 전기 비용: RTX 4090 월 $52 (연 $625), RTX 4080 월 $30, RTX 4070 Ti 월 $26, Apple M5 Max 월 $2.60 (연 $32).',
          content: [
            '**$0.12/kWh (미국 평균) 기준:**',
          ],
          rows: [
            { 'GPU': 'RTX 4090 (평균 600W)', 'Daily Cost': '$1.73', 'Monthly': '$52', 'Annual': '$625' },
            { 'GPU': 'RTX 4080 (평균 350W)', 'Daily Cost': '$1.01', 'Monthly': '$30', 'Annual': '$360' },
            { 'GPU': 'RTX 4070 Ti (평균 300W)', 'Daily Cost': '$0.86', 'Monthly': '$26', 'Annual': '$315' },
            { 'GPU': 'M5 Max Mac (평균 30W)', 'Daily Cost': '$0.09', 'Monthly': '$2.60', 'Annual': '$32' },
          ],
          columns: ['GPU', 'Daily Cost', 'Monthly', 'Annual'],
          callouts: [
            { type: 'tip', text: 'RTX 4090의 전력을 350W로 제한하면 속도 손실은 ~10%에 불과하면서 전기 비용을 40% 절약할 수 있습니다. 효율적인 대규모 추론의 최적 지점입니다.' },
          ],
          snippetBlocks: [
            { type: 'plain-terms', text: '**kWh (킬로와트시):** 1,000와트의 전력을 1시간 동안 사용하는 단위입니다. $0.12/kWh에서 600W RTX 4090을 24시간 실행하면 14.4 kWh, 즉 $1.73/일이 소요됩니다.' },
          ],
        },
        cooling: {
          id: 'cooling',
          title: '로컬 LLM 추론에 필요한 냉각 장치는?',
          content: [
          ...
          callouts: [
            { type: 'warning', text: 'GPU는 83°C 이상에서 스로틀링 발생 — 성능이 10~20% 저하됩니다. 환기 불량 시 고온 실내 (75°C 이상)에서도 지속적인 스로틀링이 발생할 수 있습니다.' },
            { type: 'practice', text: '`nvidia-smi -q -d TEMPERATURE`를 사용하여 GPU 온도를 지속적으로 모니터링하십시오. 스로틀링 방지를 위해 75°C에서 알림을 설정하십시오.' },
          ],
          snippetBlocks: [
            { type: 'one-sentence', text: '**열 스로틀링:** GPU가 안전하지 않은 온도를 감지했을 때 추론 속도를 희생하여 열 손상으로부터 칩을 보호하기 위해 자동으로 클럭 속도를 낮추는 현상입니다.' },
          ],
        },
        quickFacts: {
          id: 'quick-facts',
          ...
          callouts: [
            { type: 'tip', text: 'Apple Silicon vs NVIDIA: 효율성의 승자. M5 Max는 단 25~35W로 65~85 tok/sec를 달성합니다 — M4 세대보다 4배 빠르며 같은 전력을 사용합니다. 반면 RTX 4090은 같은 모델에서 150 tok/sec를 위해 600W가 필요합니다.' },
          ],
        },
        commonMistakes: {
          id: 'common-mistakes',
          ...
          callouts: [
            { type: 'warning', text: '750W PSU + RTX 4090 = 지속 추론 시 랜덤 시스템 종료. 실제 전력 스파이크가 PSU 용량을 초과하여 부품 보호를 위한 자동 종료가 발생합니다.' },
          ],
        },
        regionalContext: {
          id: 'regional-context',
          title: '지역별 전기 비용',
          image: '/images/local-llm-power-consumption-regional-costs-en.svg',
          imageCaption: '지역별 월간 로컬 LLM 추론 비용: 미국 $52 (RTX 4090) vs $2.60 (M5 Max), 독일 €152 vs €7.60, 프랑스 €130 vs €6.50, 일본 ¥12,960 vs ¥648, 중국 ¥504 vs ¥25. 요금은 2026년 추정치입니다.',
          content: [
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: '$0.12/kWh (미국 평균) 기준: RTX 4090 시스템은 월 ~$52가 소요됩니다. RTX 4080 시스템: 월 ~$30. RTX 4070 Ti 시스템: 월 ~$26. Apple M5 Max Mac: 월 ~$2.60. 전기 요금은 국가마다 다릅니다 — 독일 (~$0.40/kWh)에서는 3배를 곱하십시오. 업무 시간에만 추론을 실행하면 (하루 8시간) 비용을 ~67% 절감할 수 있습니다.',
            },
            {
            ...
            },
            {
              ...
              a: '예 — 큰 차이로 그렇습니다. M5 Max (128GB 통합, 2026년 3월)는 7B 모델을 전체 시스템 전력 25~35W에서 65~85 tok/sec로 실행합니다. RTX 4090은 동일한 모델을 600W에서 150 tok/sec로 실행합니다. M5 Max는 RTX 4090 대비 토큰당 ~10배 적은 전력을 사용하며, 70B 모델을 위한 4배 더 큰 메모리 풀 (128GB vs 32GB)도 제공합니다.',
            },
            {
              q: '지속적인 LLM 추론에 안전한 GPU 온도는 얼마입니까?',
              a: '지속 추론을 위해 GPU 온도를 83°C 이하로 유지하십시오. RTX 4090의 열 스로틀링은 83°C에서 시작되어 클럭 속도와 추론 속도가 10~20% 감소합니다. 이상적인 동작 범위: 65~75°C. `nvidia-smi -q -d TEMPERATURE`로 모니터링하십시오. 온도가 80°C를 초과하면 케이스 환기를 개선하거나 서멀 페이스트를 교체하십시오.',
            },
            {
            ...
            },
            {
              ...
              a: '아니요 — 냉각이 적절하다면 지속적인 추론이 정상적인 GPU를 손상시키지 않습니다. GPU는 24/7 100% 사용률로 작동하도록 설계되어 있습니다 (데이터 센터에서 이렇게 합니다). 실제 위험은: (1) 냉각 불량으로 인한 스로틀링 및 수명 단축, (2) 용량이 부족한 PSU로 인한 전력 스파이크가 시스템 종료를 유발, (3) 먼지/환기 불량으로 인한 시간이 지남에 따른 성능 저하입니다. 온도를 모니터링하고 충분한 환기를 유지하면 GPU는 5년 이상 지속됩니다.',
            },
          ],
        },
        relatedReading: {
          ...
          title: '관련 읽을거리',
          items: [
            '[로컬 LLM 하드웨어 가이드 2026](/local-llms/local-llm-hardware-guide-2026) — 완전한 하드웨어 설정 및 부품 선택.',
            '[로컬 LLM을 위한 최고의 GPU](/local-llms/best-gpus-for-local-llms) — 전 등급 GPU 선택 가이드.',
            '[노트북 vs 데스크톱 로컬 LLM](/local-llms/laptop-vs-desktop-local-llm) — 모바일 추론의 전력 및 열 트레이드오프.',
            '[로컬 LLM에 필요한 VRAM 용량은?](/local-llms/how-much-vram-local-llm) — 모델별 메모리 요구 사항.',
            '[LLM 양자화 설명](/local-llms/llm-quantization-explained) — 양자화를 통한 VRAM 및 전력 절감.',
            '[로컬 LLM에서 Mac vs Windows vs Linux](/local-llms/mac-vs-windows-vs-linux-local-llm) — OS 전력 소비 및 효율성 비교.',
            '[로컬 AI 서버로서 Mac Mini M5](/local-llms/mac-mini-m5-local-ai-server) — 연간 $35 전기 요금으로 상시 가동 LLM 스택: 전력 효율성 사례 연구.',
            '[M5 Pro vs M5 Max LLM 벤치마크 2026](/local-llms/m5-pro-max-llm-benchmarks-2026) — 모든 Apple Silicon 칩 등급의 tok/sec와 함께 전력 소비 측정.',
            '[Apple Silicon의 Whisper 2026](/local-llms/apple-silicon-whisper-metal-benchmark) — M5 Pro에서 전체 시스템 전력 ~30W로 실시간의 10배 속도로 음성 변환.',
          ],
        },
        sources: {
          id: 'sources',
          title: '출처',
          items: [
            '[NVIDIA GPU 전력 사양](https://www.nvidia.com/en-us/geforce/)',
            '[미국 전기 요금 — 미국 에너지 정보청](https://www.eia.gov/electricity/)',
            '[nvidia-smi를 이용한 GPU 온도 모니터링](https://developer.nvidia.com/nvidia-system-management-interface)',
            '전력 효율은 속도를 향상시키지만, 속도가 항상 품질 높은 출력을 보장하지는 않습니다. 온도와 샘플링 설정은 더 나은 결과로 에너지 소비를 상쇄할 수 있습니다: [temperature and top-p](https://www.promptquorum.com/prompt-engineering/temperature-and-top-p-control-ai-creativity)에서 이러한 파라미터가 속도와 일관성을 어떻게 절충하는지 설명합니다.',
          ],
        },
      },
schema: {
        ...
        speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
        about: [
          { '@type': 'Thing', name: 'GPU 전력 소비' },
          { '@type': 'Thing', name: '로컬 LLM 추론' },
          { '@type': 'Thing', name: 'PSU 용량 선택' },
          { '@type': 'Thing', name: '전기 비용' },
        ],
        mentions: [
          { '@type': 'SoftwareApplication', name: 'Ollama' },
          { '@type': 'SoftwareApplication', name: 'nvidia-smi' },
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          {
            '@type': 'Question',
            name: '로컬 LLM을 24/7 실행하는 데 비용이 얼마나 듭니까?',
            acceptedAnswer: { '@type': 'Answer', text: '$0.12/kWh (미국 평균) 기준: RTX 4090 시스템은 월 ~$52. RTX 4080 시스템: 월 ~$30. RTX 4070 Ti 시스템: 월 ~$26. Apple M5 Max Mac: 월 ~$2.60. 독일 (~$0.40/kWh)에서는 3배를 곱하십시오.' },
          },
          {
            '@type': 'Question',
          ...
          {
            '@type': 'Question',
            name: 'Apple Silicon이 로컬 LLM에서 NVIDIA보다 더 효율적입니까?',
            acceptedAnswer: { '@type': 'Answer', text: '예 — 큰 차이로 그렇습니다. M5 Max (128GB 통합, 2026년 3월)는 7B 모델을 전체 시스템 전력 25~35W에서 65~85 tok/sec로 실행합니다. RTX 4090은 동일한 모델을 600W에서 150 tok/sec로 실행합니다. M5 Max는 RTX 4090 대비 토큰당 ~10배 적은 전력을 사용하며, 70B 모델을 위한 4배 더 큰 메모리 풀 (128GB vs 32GB)도 제공합니다.' },
          },
          {
            '@type': 'Question',
            name: '지속적인 LLM 추론에 안전한 GPU 온도는 얼마입니까?',
            acceptedAnswer: { '@type': 'Answer', text: '지속 추론을 위해 GPU 온도를 83°C 이하로 유지하십시오. RTX 4090의 열 스로틀링은 83°C에서 시작되어 클럭 속도와 추론 속도가 10~20% 감소합니다. 이상적인 동작 범위: 65~75°C. `nvidia-smi -q -d TEMPERATURE`로 모니터링하십시오.' },
          },
          {
            '@type': 'Question',
          ...
          {
            '@type': 'Question',
            name: '로컬 LLM 실행이 GPU를 손상시킵니까?',
            acceptedAnswer: { '@type': 'Answer', text: '아니요 — 냉각이 적절하다면 지속적인 추론이 GPU를 손상시키지 않습니다. GPU는 24/7 100% 사용률로 작동하도록 설계되어 있습니다. 실제 위험은 냉각 불량, 용량 부족한 PSU, 먼지/환기 불량입니다. 온도를 모니터링하고 충분한 환기를 유지하면 GPU는 5년 이상 지속됩니다.' },
          },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        name: '로컬 LLM GPU 전력 소비 비교 2026',
        numberOfItems: 10,
        itemListElement: [
          { '@type': 'ListItem', position: 1, name: 'Apple M5 Pro (GPU)', description: '20~28W. 가장 효율적. 64GB 통합 메모리. 조용한 동작.' },
          { '@type': 'ListItem', position: 2, name: 'Apple M5 Max (GPU)', description: '25~35W. 128GB 통합. 7B 모델에서 65~85 tok/sec. RTX 4090 대비 토큰당 10배 더 효율적.' },
          { '@type': 'ListItem', position: 3, name: 'RTX 4070', description: '200W TDP. 12GB VRAM. 650W PSU. 진입 수준 효율적 NVIDIA.' },
          { '@type': 'ListItem', position: 4, name: 'RTX 5070', description: '250W TDP. 12GB VRAM. 800W PSU.' },
          { '@type': 'ListItem', position: 5, name: 'RTX 4070 Ti', description: '285W TDP. 12GB VRAM. 750W PSU.' },
      ...
      gammaEmbedUrl: '/presentations/local-llm-power-consumption-static.html',
      gammaDescription: 'GPU 등급별 전력 소비 (RTX 5090 575W ~ M5 Max 25~35W), 전기 비용 표 (월 $52 vs $2.60), 총 시스템 PSU 요구 사항, 83°C 한계를 위한 냉각 설정, 40% 절감을 위한 전력 제한, 지역별 비용 (미국/EU/일본/중국)을 다루는 14슬라이드 인터랙티브 덱입니다. PDF를 로컬 LLM 전력 소비 참조 카드로 다운로드하십시오.',
    },
  };
