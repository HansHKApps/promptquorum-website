...
schema: {
    ...
    ar: {
      ...
      seoTitle: 'خادم LLM محلي للفرق: vLLM وnginx لـ5–20 مستخدمًا',
      ...
      metaDescription: 'خادم مشترك بتكلفة 50$/شهر مقابل 1,000$+ على السحابة. يغطي إعداد vLLM وnginx، والأذونات حسب الأدوار، وقياس الاستخدام، وعزو التكاليف لفرق المؤسسة.',
      publishDate: '2026-04-05',
      dateModified: '2026-04-19',
