...
schema: {
    ...
    zh: {
      ...
      intro: '合规框架（GDPR、HIPAA、SOC2、AI Act）对 AI 系统施加特定要求：数据驻留、审计日志、透明性、模型文档。Local LLMs 通过将数据保持在本地并提供完全控制来满足这些要求。截至 2026 年 8 月，法规合规是企业 Local AI 采用的主要驱动力。',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '从 2026 年 8 月起，本地部署通过将数据和控制保留在内部，大幅简化合规认证流程。',
          ],
        },
        gdpr: {
          id: 'gdpr',
