  ...
  ja: {
    ...
    sections: {
      ...
      benchmarks: {
        ...
        rows: [
          { Benchmark: 'HumanEval（Pythonコーディング）', 'Qwen 3.6 27B': '92.1%', 'Claude Sonnet 5': '89.4%', 'DeepSeek R2': '91.6%' },
          { Benchmark: 'SWE-bench（GitHubイシュー）', 'Qwen 3.6 27B': '77.2%', 'Claude Sonnet 5': '~72%', 'DeepSeek R2': '~75%' },
          { Benchmark: 'MMLU（知識幅）', 'Qwen 3.6 27B': '86.4%', 'Claude Sonnet 5': '88.1%', 'DeepSeek R2': '87.8%' },
          { Benchmark: 'MATH（競技レベル）', 'Qwen 3.6 27B': '88.7%', 'Claude Sonnet 5': '91.2%', 'DeepSeek R2': '93.1%' },
        ],
