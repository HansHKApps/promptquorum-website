...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      intro: 'In June 2026, long context is mainstream. Qwen3, Gemma 4, Llama 3.1, and Mistral Small 3.1 all support 128K context natively. Qwen3 14B at Q4_K_M handles 128K tokens in roughly 12 GB RAM at 15-25 tok/s on Apple M5 Pro -- the clear winner for most setups. On 8 GB machines, Qwen3 4B covers the same 128K window at lower quality. Ollama\'s Modelfile spec defaults num_ctx to 2048, but the current runtime picks a VRAM-tiered default (4K under 24 GiB, 32K from 24–48 GiB, 256K above); this guide covers which models fit your VRAM and how fast they run at full context.',
      metaDescription: 'Qwen3, Gemma 4, and Llama 3.1 all support 128K context locally. Which models fit your VRAM and how fast they run at full context.',
      heroImage: '/images/long-context-local-llms-models-comparison-hero-en.webp',
      publishDate: '2026-04-04',
      leadAnswerBlock: '**The best long-context local LLM in June 2026 is Qwen3 14B at Q4_K_M — handles 128K tokens in ~12 GB RAM at 15-25 tok/s on Apple M5 Pro. For 8 GB machines, Qwen3 4B (128K) runs comfortably. All major 2026 models — Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 — support 128K context natively; long context is now mainstream.**',
      nextStep: {
...
schema: {
        ...
        '@type': 'TechArticle',
        'headline': 'Long Context Local LLMs 2026: Best 128K Models Compared',
        'description': 'Qwen3 14B (128K, ~12 GB RAM, 15-25 tok/s on M5 Pro) leads long-context local LLMs in June 2026. All major models — Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 — support 128K natively. June 2026 guide.',
      ...
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        'name': 'Local LLMs by Context Window Size -- Ollama June 2026',
        'numberOfItems': 10,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1,  'name': 'Qwen3 14B Q4_K_M',          'description': '128K tokens context. ~32K-64K practical. ~12 GB RAM at 128K. 15-25 tok/s on M5 Pro. Best overall for 16 GB machines. ollama run qwen3:14b' },
          { '@type': 'ListItem', 'position': 2,  'name': 'Qwen3 4B Q4_K_M',           'description': '128K tokens context. ~16K-32K practical. ~5 GB RAM. Best for 8 GB machines. ollama run qwen3:4b' },
          { '@type': 'ListItem', 'position': 3,  'name': 'Gemma 4 26B-A4B Q4_K_M',    'description': '128K tokens context. ~32K practical. ~15 GB RAM (MoE, 4B active). Strong multimodal support. ollama run gemma4:26b-a4b' },
          { '@type': 'ListItem', 'position': 4,  'name': 'Gemma 4 31B Q4_K_M',        'description': '128K tokens context. ~32K-64K practical. ~19 GB RAM at 128K (est.). ollama run gemma4:31b' },
          { '@type': 'ListItem', 'position': 5,  'name': 'Llama 3.1 8B Q4_K_M',       'description': '128K tokens context. ~32K practical. ~14 GB RAM at 128K. ollama run llama3.1:8b' },
          ...
          { '@type': 'ListItem', 'position': 8,  'name': 'Qwen3 8B',                  'description': '128K tokens context. ~32K practical. ~9 GB RAM at 128K Q4_K_M. ollama run qwen3:8b' },
          { '@type': 'ListItem', 'position': 9,  'name': 'Qwen3 30B',                 'description': '128K tokens context. ~64K practical. ~22 GB RAM at 128K Q4_K_M. ollama run qwen3:30b' },
          { '@type': 'ListItem', 'position': 10, 'name': 'DeepSeek-R1 14B',           'description': '128K tokens context. ~32K practical. ~10 GB RAM at 128K Q4_K_M. Best for reasoning tasks. ollama run deepseek-r1:14b' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'On 16 GB RAM, Mistral Small 3.1 24B at Q4_K_M with 32K context uses ~17 GB -- exceeds 16 GB. Use Llama 3.1 8B at Q4_K_M with 32K context (~9 GB) or 128K context (~14 GB) for a comfortable fit. Set num_ctx in a Modelfile: PARAMETER num_ctx 32768.',
            },
          },
        ],
      },
      ...
      quickAnswerTop: {
        en: {
          ...
          answer: 'All major 2026 local models — Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 — support 128K tokens natively. The best pick for most users is Qwen3 14B Q4_K_M: handles 128K in ~12 GB RAM at 15–25 tok/s on Apple M5 Pro. On 8 GB, use Qwen3 4B (same 128K context, lower quality). Important: Ollama\'s Modelfile spec defaults num_ctx to 2048, but the current runtime picks a VRAM-tiered default (4K under 24 GiB, 32K from 24–48 GiB, 256K above) — set num_ctx explicitly in a Modelfile.',
          bullets: [
            ...
            'Gemma 4 26B-A4B, Llama 3.1 8B, Mistral Small 3.1 24B: all support 128K',
            'Ollama runtime default (VRAM-scaled) tokens — always set num_ctx in Modelfile for long context',
        ...
        de: {
          ...
          answer: 'Alle großen lokalen Modelle 2026 — Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 — unterstützen nativ 128K Token. Die beste Wahl für die meisten Nutzer ist Qwen3 14B Q4_K_M: verarbeitet 128K in ~12 GB RAM bei 15–25 Tok/s auf Apple M5 Pro. Mit 8 GB: Qwen3 4B (gleicher 128K-Kontext, geringere Qualität). Wichtig: Ollama ist standardmäßig auf 2048 Token eingestellt — num_ctx im Modelfile explizit setzen.',
          bullets: [
            ...
            'Gemma 4 26B-A4B, Llama 3.1 8B, Mistral Small 3.1 24B: alle unterstützen 128K',
        ...
        fr: {
          ...
          answer: 'Tous les grands modèles locaux 2026 — Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 — supportent nativement 128K tokens. Le meilleur choix pour la plupart des utilisateurs est Qwen3 14B Q4_K_M : gère 128K en ~12 Go de RAM à 15–25 tok/s sur Apple M5 Pro. Avec 8 Go : Qwen3 4B (même contexte 128K, qualité moindre). Important : Ollama est limité à 2048 tokens par défaut — définissez num_ctx explicitement dans un Modelfile.',
          bullets: [
            ...
            'Gemma 4 26B-A4B, Llama 3.1 8B, Mistral Small 3.1 24B : tous supportent 128K',
        ...
        ja: {
          ...
          answer: '2026年の主要なローカルモデル（Qwen3、Gemma 4、Llama 3.1、Mistral Small 3.1）はすべて128Kトークンをネイティブでサポートしています。多くのユーザーに最適なのはQwen3 14B Q4_K_M：Apple M5 Proで~12 GB RAMを使い15〜25トークン/秒で128Kを処理。8 GBマシンではQwen3 4B（同じ128K、品質は若干落ちる）。重要：Ollamaのデフォルトは2048トークン — Modelfileでnum_ctxを明示的に設定すること。',
          bullets: [
            'Qwen3 14B Q4_K_M: 128Kコンテキスト、~12 GB RAM、M5 Proで15〜25トークン/秒（最良のオールラウンダー）',
            'Qwen3 4B: 128Kコンテキスト、~4 GB RAM（8 GBマシンに最適）',
            'Gemma 4 26B-A4B、Llama 3.1 8B、Mistral Small 3.1 24B: すべて128Kをサポート',
        ...
        zh: {
          ...
          answer: '2026年所有主要本地模型——Qwen3、Gemma 4、Llama 3.1、Mistral Small 3.1——原生支持128K token。大多数用户的最佳选择是Qwen3 14B Q4_K_M：在Apple M5 Pro上以约12 GB RAM、15–25 tok/s处理128K。8 GB机器：Qwen3 4B（同样128K，质量稍低）。重要：Ollama默认只有2048 token——必须在Modelfile中明确设置num_ctx。',
          bullets: [
            'Qwen3 14B Q4_K_M：128K上下文，约12 GB RAM，M5 Pro上15–25 tok/s（最全面）',
            'Qwen3 4B：128K上下文，约4 GB RAM（最适合8 GB机器）',
            'Gemma 4 26B-A4B、Llama 3.1 8B、Mistral Small 3.1 24B：均支持128K',
        ...
        es: {
          ...
          bullets: [
            ...
            'Gemma 4 26B-A4B, Llama 3.1 8B, Mistral Small 3.1 24B: todos soportan 128K',
        ...
        pt: {
          ...
          answer: 'Todos os principais modelos locais de 2026 — Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 — suportam 128K tokens nativamente. A melhor escolha para a maioria é Qwen3 14B Q4_K_M: processa 128K em ~12 GB de RAM a 15–25 tok/s no Apple M5 Pro. Com 8 GB: Qwen3 4B (mesmo contexto 128K, qualidade menor). Importante: Ollama tem padrão de 2048 tokens — defina num_ctx explicitamente em um Modelfile.',
          bullets: [
            ...
            'Gemma 4 26B-A4B, Llama 3.1 8B, Mistral Small 3.1 24B: todos suportam 128K',
        ...
        ar: {
          ...
          answer: 'جميع النماذج المحلية الكبرى لعام 2026 — Qwen3 وGemma 4 وLlama 3.1 وMistral Small 3.1 — تدعم 128 ألف رمز بشكل أصلي. الخيار الأفضل لمعظم المستخدمين هو Qwen3 14B Q4_K_M: يعالج 128K في ~12 جيجابايت رام بسرعة 15–25 رمزاً/ثانية على Apple M5 Pro. مع 8 جيجابايت: استخدم Qwen3 4B (نفس سياق 128K، جودة أقل). مهم: Ollama يعمل افتراضياً بـ 2048 رمزاً — اضبط num_ctx صراحةً في Modelfile.',
          bullets: [
            ...
            'Gemma 4 26B-A4B وLlama 3.1 8B وMistral Small 3.1 24B: جميعها تدعم 128K',
        ...
        ko: {
          ...
          answer: '2026년 모든 주요 로컬 모델 — Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 — 은 128K 토큰을 기본적으로 지원합니다. 대부분의 사용자에게 최선은 Qwen3 14B Q4_K_M: Apple M5 Pro에서 ~12 GB RAM으로 15–25 tok/s에 128K 처리. 8 GB에서는 Qwen3 4B(동일한 128K, 품질 약간 낮음). 중요: Ollama 기본값은 2048 토큰 — Modelfile에서 num_ctx를 명시적으로 설정해야 합니다.',
          bullets: [
            'Qwen3 14B Q4_K_M: 128K 컨텍스트, ~12 GB RAM, M5 Pro에서 15–25 tok/s (최고 올라운더)',
            'Qwen3 4B: 128K 컨텍스트, ~4 GB RAM (8 GB 기기에 최적)',
            'Gemma 4 26B-A4B, Llama 3.1 8B, Mistral Small 3.1 24B: 모두 128K 지원',
      ...
      sections: {
        tldr: {
          ...
          items: [
            'All major 2026 local models — Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 — support 128K tokens natively. Long context is no longer a differentiator; it is table stakes.',
        ...
        which128k: {
          ...
          rows: [
            { 'Model': 'Qwen3 14B Q4_K_M', 'Context Window': '128K', 'Practical Limit': '~32-64K reliable', 'Ollama Command': 'ollama run qwen3:14b' },
            { 'Model': 'Qwen3 4B Q4_K_M', 'Context Window': '128K', 'Practical Limit': '~16-32K reliable', 'Ollama Command': 'ollama run qwen3:4b' },
            { 'Model': 'Gemma 4 26B-A4B Q4_K_M', 'Context Window': '128K', 'Practical Limit': '~32K reliable', 'Ollama Command': 'ollama run gemma4:26b-a4b' },
            { 'Model': 'Llama 3.1 8B Q4_K_M', 'Context Window': '128K', 'Practical Limit': '~32K reliable', 'Ollama Command': 'ollama run llama3.1:8b' },
            ...
            { 'Model': 'Qwen3 8B Q4_K_M', 'Context Window': '128K', 'Practical Limit': '~32K reliable', 'Ollama Command': 'ollama run qwen3:8b' },
            { 'Model': 'DeepSeek-R1 14B Q4_K_M', 'Context Window': '128K', 'Practical Limit': '~32K reliable', 'Ollama Command': 'ollama run deepseek-r1:14b' },
          ],
          columns: ['Model', 'Context Window', 'Practical Limit', 'Ollama Command'],
          image: '/images/long-context-local-llms-models-comparison-hero-en.webp',
          imageCaption: '8 local LLM models with 128K context support in 2026 -- Qwen3 14B is the top pick for 16 GB machines, Qwen3 4B for 8 GB machines.',
        },
        ramForLongContext: {
          id: 'ram-long-context',
          ...
          image: '/images/long-context-local-llms-ram-scaling-hero-en.webp',
    ...
    es: {
      freshness_tier: 'monthly',
      theme: 'Best Models',
      title: 'LLMs locales con contexto largo 2026: Mejores modelos 128K comparados',
      seoTitle: 'LLM locales contexto largo (2026): modelos 128K que puedes ejecutar ahora',
      intro: 'En junio de 2026, el contexto largo es la norma. Qwen3, Gemma 4, Llama 3.1 y Mistral Small 3.1 soportan 128K tokens nativamente. Qwen3 14B en Q4_K_M gestiona 128K tokens en ~12 GB de RAM a 15-25 tok/s en Apple M5 Pro -- el ganador claro para la mayoría de los setups. En máquinas de 8 GB, Qwen3 4B cubre la misma ventana de 128K con menor calidad. Ollama usa 2048 tokens por defecto; esta guía cubre qué modelos caben en tu VRAM y a qué velocidad funcionan con contexto completo.',
      metaDescription: 'Qwen3, Gemma 4 y Llama 3.1 soportan 128K tokens localmente. Qué modelos caben en tu VRAM y a qué velocidad funcionan con contexto completo.',
      heroImage: '/images/long-context-local-llms-models-comparison-hero-es.webp',
      publishDate: '2026-04-04',
      leadAnswerBlock: '**El mejor LLM local con contexto largo en junio de 2026 es Qwen3 14B en Q4_K_M — gestiona 128K tokens en ~12 GB de RAM a 15-25 tok/s en Apple M5 Pro. Para máquinas de 8 GB, Qwen3 4B (128K) funciona cómodamente. Todos los modelos principales de 2026 — Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 — soportan 128K tokens nativamente; el contexto largo es ahora estándar.**',
      nextStep: {
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': 'LLMs locales con contexto largo 2026: Mejores modelos 128K comparados',
        'description': 'Qwen3 14B (128K, ~12 GB RAM, 15-25 tok/s en M5 Pro) lidera los LLM locales con contexto largo en junio de 2026. Todos los modelos principales — Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 — soportan 128K nativamente. Guía de junio 2026.',
        'datePublished': '2026-04-04',
        'dateModified': '2026-08-28',
      ...
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        'name': 'LLM locales por tamaño de ventana de contexto -- Ollama junio 2026',
        'numberOfItems': 10,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1,  'name': 'Qwen3 14B Q4_K_M',          'description': '128K tokens de contexto. ~32K-64K práctico. ~12 GB de RAM con 128K. 15-25 tok/s en M5 Pro. Mejor opción para máquinas de 16 GB. ollama run qwen3:14b' },
          { '@type': 'ListItem', 'position': 2,  'name': 'Qwen3 4B Q4_K_M',           'description': '128K tokens de contexto. ~16K-32K práctico. ~5 GB de RAM. Mejor para máquinas de 8 GB. ollama run qwen3:4b' },
          { '@type': 'ListItem', 'position': 3,  'name': 'Gemma 4 26B-A4B Q4_K_M',        'description': '128K tokens de contexto. ~32K práctico. ~15 GB de RAM con 128K. ollama run gemma4:26b-a4b' },
          { '@type': 'ListItem', 'position': 4,  'name': 'Gemma 4 31B Q4_K_M',        'description': '128K tokens de contexto. ~32K-64K práctico. ~19 GB de RAM con 128K. ollama run gemma4:31b' },
          { '@type': 'ListItem', 'position': 5,  'name': 'Llama 3.1 8B Q4_K_M',       'description': '128K tokens de contexto. ~32K práctico. ~14 GB de RAM con 128K. ollama run llama3.1:8b' },
          ...
          { '@type': 'ListItem', 'position': 8,  'name': 'Qwen3 8B Q4_K_M',          'description': '128K tokens de contexto. ~32K práctico. ~9 GB de RAM con 128K. ollama run qwen3:8b' },
          { '@type': 'ListItem', 'position': 9,  'name': 'Qwen3 30B Q4_K_M',         'description': '128K tokens de contexto. ~64K práctico. ~22 GB de RAM con 128K. ollama run qwen3:30b' },
          { '@type': 'ListItem', 'position': 10, 'name': 'DeepSeek-R1 14B Q4_K_M',   'description': '128K tokens de contexto. ~32K práctico. ~10 GB de RAM. Mejor para razonamiento. ollama run deepseek-r1:14b' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Con 16 GB de RAM, Mistral Small 3.1 24B en Q4_K_M con 32K de contexto usa ~17 GB -- supera los 16 GB. Usa Llama 3.1 8B en Q4_K_M con 32K de contexto (~9 GB) o 128K de contexto (~14 GB) para un ajuste cómodo. Establece num_ctx en un Modelfile: PARAMETER num_ctx 32768.',
            },
          },
        ],
      },
      ...
      sections: {
        ...
        which128k: {
          ...
          rows: [
            { 'Modelo': 'Qwen3 14B Q4_K_M', 'Ventana de contexto': '128K', 'Límite práctico': '~32-64K fiable', 'Comando Ollama': 'ollama run qwen3:14b' },
            { 'Modelo': 'Qwen3 4B Q4_K_M', 'Ventana de contexto': '128K', 'Límite práctico': '~16-32K fiable', 'Comando Ollama': 'ollama run qwen3:4b' },
            { 'Modelo': 'Gemma 4 26B-A4B Q4_K_M', 'Ventana de contexto': '128K', 'Límite práctico': '~32K fiable', 'Comando Ollama': 'ollama run gemma4:26b-a4b' },
            { 'Modelo': 'Llama 3.1 8B Q4_K_M', 'Ventana de contexto': '128K', 'Límite práctico': '~32K fiable', 'Comando Ollama': 'ollama run llama3.1:8b' },
            ...
            { 'Modelo': 'Qwen3 8B Q4_K_M', 'Ventana de contexto': '128K', 'Límite práctico': '~32K fiable', 'Comando Ollama': 'ollama run qwen3:8b' },
            { 'Modelo': 'DeepSeek-R1 14B Q4_K_M', 'Ventana de contexto': '128K', 'Límite práctico': '~32K fiable', 'Comando Ollama': 'ollama run deepseek-r1:14b' },
          ],
          columns: ['Modelo', 'Ventana de contexto', 'Límite práctico', 'Comando Ollama'],
          image: '/images/long-context-local-llms-models-comparison-hero-es.webp',
          imageCaption: '8 modelos LLM locales con soporte de contexto 128K en 2026 -- Qwen3 14B es la mejor opción para máquinas de 16 GB, Qwen3 4B para máquinas de 8 GB.',
        },
        ramForLongContext: {
          id: 'ram-long-context',
          ...
          rows: [
            { 'Modelo': 'Llama 3.1 8B Q4_K_M', 'Contexto 4K': '~6 GB', 'Contexto 32K': '~9 GB', 'Contexto 128K': '~14 GB' },
          ...
          image: '/images/long-context-local-llms-ram-scaling-hero-es.webp',
    ...
    ar: {
      freshness_tier: 'monthly',
      theme: 'Best Models',
      title: 'أفضل نماذج ⁨LLM⁩ المحلية بسياق ⁨128K 2026⁩: مقارنة شاملة',
      seoTitle: 'نماذج ⁨LLM⁩ محلية بسياق طويل (⁨2026⁩): نماذج ⁨128K⁩ يمكنك تشغيلها الآن',
      intro: 'في يونيو 2026، أصبح السياق الطويل معيارًا أساسيًا. تدعم نماذج Qwen3 وGemma 4 وLlama 3.1 وMistral Small 3.1 جميعها 128K رمز أصليًا. يعالج Qwen3 14B بكمية Q4_K_M سياق 128K رمز في ~12 GB من RAM بسرعة 15-25 رمز/ث على Apple M5 Pro -- الخيار الأمثل لمعظم الإعدادات. على أجهزة 8 GB، يغطي Qwen3 4B نافذة 128K ذاتها بجودة أقل. يستخدم Ollama 2048 رمزًا افتراضيًا؛ يوضح هذا الدليل النماذج التي تناسب VRAM لديك والسرعة التي تعمل بها في السياق الكامل.',
      metaDescription: '⁨Qwen3⁩ و⁨Gemma 4⁩ و⁨Llama 3.1⁩ تدعم جميعها ⁨128K⁩ سياق محليًا. أي النماذج تناسب ⁨VRAM⁩ لديك وكيف تعمل بسرعة في السياق الكامل.',
      heroImage: '/images/long-context-local-llms-models-comparison-hero-ar.webp',
      publishDate: '2026-04-04',
      leadAnswerBlock: '**أفضل نموذج LLM محلي بسياق طويل في يونيو 2026 هو Qwen3 14B بكمية Q4_K_M — يعالج 128K رمز في ~12 GB RAM بسرعة 15-25 رمز/ث على Apple M5 Pro. لأجهزة 8 GB، يعمل Qwen3 4B (128K) بسلاسة. جميع النماذج الرئيسية لعام 2026 — Qwen3 وGemma 4 وLlama 3.1 وMistral Small 3.1 — تدعم 128K رمز أصليًا؛ السياق الطويل أصبح الآن معيارًا أساسيًا.**',
      nextStep: {
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': 'أفضل نماذج LLM المحلية بسياق 128K 2026: مقارنة شاملة',
        'description': 'يتصدّر Qwen3 14B (128K، ~12 GB RAM، 15-25 رمز/ث على M5 Pro) نماذج LLM المحلية بالسياق الطويل في يونيو 2026. جميع النماذج الرئيسية — Qwen3 وGemma 4 وLlama 3.1 وMistral Small 3.1 — تدعم 128K أصليًا. دليل يونيو 2026.',
        'datePublished': '2026-04-04',
        'dateModified': '2026-08-28',
      ...
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        'name': 'نماذج LLM المحلية حسب حجم نافذة السياق -- Ollama يونيو 2026',
        'numberOfItems': 10,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1,  'name': 'Qwen3 14B Q4_K_M',          'description': '128K رمز سياق. ~32K-64K عمليًا. ~12 GB من RAM بسياق 128K. 15-25 رمز/ث على M5 Pro. الأفضل لأجهزة 16 GB. ollama run qwen3:14b' },
          { '@type': 'ListItem', 'position': 2,  'name': 'Qwen3 4B Q4_K_M',           'description': '128K رمز سياق. ~16K-32K عمليًا. ~5 GB من RAM. الأفضل لأجهزة 8 GB. ollama run qwen3:4b' },
          { '@type': 'ListItem', 'position': 3,  'name': 'Gemma 4 26B-A4B Q4_K_M',        'description': '128K رمز سياق. ~32K عمليًا. ~15 GB من RAM بسياق 128K. ollama run gemma4:26b-a4b' },
          { '@type': 'ListItem', 'position': 4,  'name': 'Gemma 4 31B Q4_K_M',        'description': '128K رمز سياق. ~32K-64K عمليًا. ~19 GB من RAM بسياق 128K. ollama run gemma4:31b' },
          { '@type': 'ListItem', 'position': 5,  'name': 'Llama 3.1 8B Q4_K_M',       'description': '128K رمز سياق. ~32K عمليًا. ~14 GB من RAM بسياق 128K. ollama run llama3.1:8b' },
          ...
          { '@type': 'ListItem', 'position': 8,  'name': 'Qwen3 8B Q4_K_M',          'description': '128K رمز سياق. ~32K عمليًا. ~9 GB من RAM بسياق 128K. ollama run qwen3:8b' },
          { '@type': 'ListItem', 'position': 9,  'name': 'Qwen3 30B Q4_K_M',         'description': '128K رمز سياق. ~64K عمليًا. ~22 GB من RAM بسياق 128K. ollama run qwen3:30b' },
          { '@type': 'ListItem', 'position': 10, 'name': 'DeepSeek-R1 14B Q4_K_M',   'description': '128K رمز سياق. ~32K عمليًا. ~10 GB من RAM. الأفضل للمهام الاستنتاجية. ollama run deepseek-r1:14b' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'بـ16 GB من RAM، يستخدم Mistral Small 3.1 24B في Q4_K_M بسياق 32K ~17 GB -- يتجاوز 16 GB. استخدم Llama 3.1 8B في Q4_K_M بسياق 32K (~9 GB) أو سياق 128K (~14 GB) لملاءمة مريحة. اضبط num_ctx في Modelfile: PARAMETER num_ctx 32768.',
            },
          },
        ],
      },
      ...
      sections: {
        tldr: {
          ...
          items: [
            'تدعم جميع نماذج 2026 الرئيسية — Qwen3 وGemma 4 وLlama 3.1 وMistral Small 3.1 — سياق 128K رمز أصليًا. السياق الطويل أصبح معيارًا أساسيًا، لا ميزة تنافسية.',
        ...
        which128k: {
          ...
          rows: [
            { 'النموذج': 'Qwen3 14B Q4_K_M', 'نافذة السياق': '128K', 'الحد العملي': '~32-64K موثوق', 'أمر Ollama': 'ollama run qwen3:14b' },
            { 'النموذج': 'Qwen3 4B Q4_K_M', 'نافذة السياق': '128K', 'الحد العملي': '~16-32K موثوق', 'أمر Ollama': 'ollama run qwen3:4b' },
            { 'النموذج': 'Gemma 4 26B-A4B Q4_K_M', 'نافذة السياق': '128K', 'الحد العملي': '~32K موثوق', 'أمر Ollama': 'ollama run gemma4:26b-a4b' },
            { 'النموذج': 'Llama 3.1 8B Q4_K_M', 'نافذة السياق': '128K', 'الحد العملي': '~32K موثوق', 'أمر Ollama': 'ollama run llama3.1:8b' },
            { 'النموذج': 'Llama 3.2 3B', 'نافذة السياق': '128K', 'الحد العملي': '~16K موثوق', 'أمر Ollama': 'ollama run llama3.2:3b' },
            { 'النموذج': 'Mistral Small 3.1 24B', 'نافذة السياق': '128K', 'الحد العملي': '~32K موثوق', 'أمر Ollama': 'ollama run mistral-small3.1' },
            { 'النموذج': 'Qwen3 8B Q4_K_M', 'نافذة السياق': '128K', 'الحد العملي': '~32K موثوق', 'أمر Ollama': 'ollama run qwen3:8b' },
            { 'النموذج': 'DeepSeek-R1 14B Q4_K_M', 'نافذة السياق': '128K', 'الحد العملي': '~32K موثوق', 'أمر Ollama': 'ollama run deepseek-r1:14b' },
          ],
          columns: ['النموذج', 'نافذة السياق', 'الحد العملي', 'أمر Ollama'],
          image: '/images/long-context-local-llms-models-comparison-hero-ar.webp',
          imageCaption: '8 نماذج LLM محلية بدعم سياق 128K في 2026 -- Qwen3 14B هو الخيار الأمثل لأجهزة 16 GB، وQwen3 4B لأجهزة 8 GB.',
        },
        ramForLongContext: {
          id: 'ram-long-context',
          ...
          columns: ['Modelo', 'Contexto 4K', 'Contexto 32K', 'Contexto 128K'],
          image: '/images/long-context-local-llms-ram-scaling-hero-ar.webp',
    ...
    pt: {
      freshness_tier: 'monthly',
      theme: 'Best Models',
      title: 'LLMs locais com contexto longo 2026: Melhores modelos 128K comparados',
      seoTitle: 'LLMs locais contexto longo (2026): modelos 128K que você pode rodar agora',
      intro: 'Em junho de 2026, o contexto longo é padrão. Qwen3, Gemma 4, Llama 3.1 e Mistral Small 3.1 todos suportam 128K tokens nativamente. O Qwen3 14B em Q4_K_M processa 128K tokens em ~12 GB de RAM a 15-25 tok/s no Apple M5 Pro — o vencedor claro para a maioria dos setups. Em máquinas de 8 GB, o Qwen3 4B cobre a mesma janela de 128K com menor qualidade. O Ollama usa 2048 tokens por padrão; este guia mostra quais modelos cabem na sua VRAM e com que velocidade funcionam com contexto completo.',
      metaDescription: 'Qwen3, Gemma 4 e Llama 3.1 suportam 128K tokens localmente. Quais modelos cabem na sua VRAM e com que velocidade funcionam com contexto completo.',
      heroImage: '/images/long-context-local-llms-models-comparison-hero-pt.webp',
      publishDate: '2026-04-04',
      leadAnswerBlock: '**O melhor LLM local com contexto longo em junho de 2026 é o Qwen3 14B em Q4_K_M — processa 128K tokens em ~12 GB de RAM a 15-25 tok/s no Apple M5 Pro. Para máquinas de 8 GB, o Qwen3 4B (128K) roda confortavelmente. Todos os modelos principais de 2026 — Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 — suportam 128K tokens nativamente; o contexto longo agora é padrão.**',
      nextStep: {
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': 'LLMs locais com contexto longo 2026: Melhores modelos 128K comparados',
        'description': 'Qwen3 14B (128K, ~12 GB RAM, 15-25 tok/s no M5 Pro) lidera os LLMs locais com contexto longo em junho de 2026. Todos os modelos principais — Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 — suportam 128K nativamente. Guia de junho de 2026.',
        'datePublished': '2026-04-04',
        'dateModified': '2026-08-28',
        'url': 'https://www.promptquorum.com/pt/local-llms/long-context-local-llms',
        'proficiencyLevel': 'Intermediate',
        'about': [
      ...
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        'name': 'LLMs locais por tamanho de janela de contexto -- Ollama junho 2026',
        'numberOfItems': 10,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1,  'name': 'Qwen3 14B Q4_K_M',          'description': '128K tokens de contexto. ~32K-64K prático. ~12 GB de RAM com 128K. 15-25 tok/s no M5 Pro. Melhor para máquinas de 16 GB. ollama run qwen3:14b' },
          { '@type': 'ListItem', 'position': 2,  'name': 'Qwen3 4B Q4_K_M',           'description': '128K tokens de contexto. ~16K-32K prático. ~5 GB de RAM. Melhor para máquinas de 8 GB. ollama run qwen3:4b' },
          { '@type': 'ListItem', 'position': 3,  'name': 'Gemma 4 26B-A4B Q4_K_M',        'description': '128K tokens de contexto. ~32K prático. ~15 GB de RAM com 128K. ollama run gemma4:26b-a4b' },
          { '@type': 'ListItem', 'position': 4,  'name': 'Gemma 4 31B Q4_K_M',        'description': '128K tokens de contexto. ~32K-64K prático. ~19 GB de RAM com 128K. ollama run gemma4:31b' },
          { '@type': 'ListItem', 'position': 5,  'name': 'Llama 3.1 8B Q4_K_M',       'description': '128K tokens de contexto. ~32K prático. ~14 GB de RAM com 128K. ollama run llama3.1:8b' },
          ...
          { '@type': 'ListItem', 'position': 8,  'name': 'Qwen3 8B Q4_K_M',          'description': '128K tokens de contexto. ~32K prático. ~9 GB de RAM com 128K. ollama run qwen3:8b' },
          { '@type': 'ListItem', 'position': 9,  'name': 'Qwen3 30B Q4_K_M',         'description': '128K tokens de contexto. ~64K prático. ~22 GB de RAM com 128K. ollama run qwen3:30b' },
          { '@type': 'ListItem', 'position': 10, 'name': 'DeepSeek-R1 14B Q4_K_M',   'description': '128K tokens de contexto. ~32K prático. ~10 GB de RAM. Melhor para raciocínio. ollama run deepseek-r1:14b' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Com 16 GB de RAM, o Mistral Small 3.1 24B em Q4_K_M com 32K de contexto usa ~17 GB -- ultrapassa os 16 GB. Use o Llama 3.1 8B em Q4_K_M com 32K de contexto (~9 GB) ou 128K de contexto (~14 GB) para um encaixe confortável. Defina num_ctx em um Modelfile: PARAMETER num_ctx 32768.',
            },
          },
        ],
      },
      ...
      sections: {
        ...
        which128k: {
          ...
          rows: [
            { 'Modelo': 'Qwen3 14B Q4_K_M', 'Janela de contexto': '128K', 'Limite prático': '~32-64K confiável', 'Comando Ollama': 'ollama run qwen3:14b' },
            { 'Modelo': 'Qwen3 4B Q4_K_M', 'Janela de contexto': '128K', 'Limite prático': '~16-32K confiável', 'Comando Ollama': 'ollama run qwen3:4b' },
            { 'Modelo': 'Gemma 4 26B-A4B Q4_K_M', 'Janela de contexto': '128K', 'Limite prático': '~32K confiável', 'Comando Ollama': 'ollama run gemma4:26b-a4b' },
            { 'Modelo': 'Llama 3.1 8B Q4_K_M', 'Janela de contexto': '128K', 'Limite prático': '~32K confiável', 'Comando Ollama': 'ollama run llama3.1:8b' },
            ...
            { 'Modelo': 'Qwen3 8B Q4_K_M', 'Janela de contexto': '128K', 'Limite prático': '~32K confiável', 'Comando Ollama': 'ollama run qwen3:8b' },
            { 'Modelo': 'DeepSeek-R1 14B Q4_K_M', 'Janela de contexto': '128K', 'Limite prático': '~32K confiável', 'Comando Ollama': 'ollama run deepseek-r1:14b' },
          ],
          columns: ['Modelo', 'Janela de contexto', 'Limite prático', 'Comando Ollama'],
          image: '/images/long-context-local-llms-models-comparison-hero-pt.webp',
          imageCaption: '8 modelos LLM locais com suporte a contexto 128K em 2026 -- Qwen3 14B é a melhor escolha para máquinas de 16 GB, Qwen3 4B para máquinas de 8 GB.',
        },
        ramForLongContext: {
          id: 'ram-long-context',
          ...
          columns: ['Modelo', 'Contexto 4K', 'Contexto 32K', 'Contexto 128K'],
          image: '/images/long-context-local-llms-ram-scaling-hero-pt.webp',
        ...
        regionalContext: {
          ...
          content: [
            ...
            '**Japão (METI):** Os documentos japoneses exigem 1,5-2 vezes mais tokens que os documentos equivalentes em inglês por causa das diferenças do tokenizador. Um relatório japonês de 50 páginas pode consumir 25K-35K tokens -- dentro da faixa confiável do Qwen3 8B (limite prático 32K), mas exigindo configuração explícita do contexto no Ollama: PARAMETER num_ctx 32768. Para documentos jurídicos e financeiros em japonês, o Qwen3 14B em Q4_K_M com 32K de contexto (~12 GB de RAM) oferece a melhor relação qualidade/RAM para processamento de contexto longo em japonês. O tokenizador nativo em japonês do Qwen3 processa texto japonês 30-40% mais eficientemente que o Llama.',
    ...
    zh: {
      theme: '最佳模型',
      title: '长上下文本地LLM 2026：最佳128K模型对比',
      seoTitle: '本地LLM长上下文（2026）：现在可运行的128K模型',
      intro: '2026年6月，长上下文已成为主流标准。Qwen3、Gemma 4、Llama 3.1和Mistral Small 3.1全部原生支持128K令牌上下文。Qwen3系列专为中文优化——原生中文分词器比Llama对中文文档的处理效率高30-40%。Qwen3 14B（Q4_K_M量化）在Apple M5 Pro上以15-25令牌/秒处理128K上下文，仅需约12 GB RAM。8 GB设备推荐使用Qwen3 4B——同样的128K窗口，质量略低但完全可用。',
      metaDescription: 'Qwen3、Gemma 3和Llama 3.1全部支持128K本地上下文。哪些模型适合您的VRAM，以及在完整上下文下的运行速度。',
      heroImage: '/images/long-context-local-llms-models-comparison-hero-zh.webp',
      nextStep: {
      ...
      sections: {
        tldr: {
          ...
          items: [
            '2026年6月所有主流本地LLM——Qwen3、Gemma 4、Llama 3.1、Mistral Small 3.1——均原生支持128K标记上下文窗口。长上下文已成标准，非差异化优势。',
        ...
        which128k: {
          ...
          rows: [
            { '模型': 'Qwen3 14B Q4_K_M', '上下文窗口': '128K', '实际上限': '约32-64K可靠', 'Ollama命令': 'ollama run qwen3:14b' },
            { '模型': 'Qwen3 4B Q4_K_M', '上下文窗口': '128K', '实际上限': '约16-32K可靠', 'Ollama命令': 'ollama run qwen3:4b' },
            { '模型': 'Gemma 4 26B-A4B Q4_K_M', '上下文窗口': '128K', '实际上限': '约32K可靠', 'Ollama命令': 'ollama run gemma4:26b-a4b' },
            { '模型': 'Llama 3.1 8B Q4_K_M', '上下文窗口': '128K', '实际上限': '约32K可靠', 'Ollama命令': 'ollama run llama3.1:8b' },
            ...
            { '模型': 'Qwen3 8B Q4_K_M', '上下文窗口': '128K', '实际上限': '约32K可靠', 'Ollama命令': 'ollama run qwen3:8b' },
            { '模型': 'DeepSeek-R1 14B Q4_K_M', '上下文窗口': '128K', '实际上限': '约32K可靠', 'Ollama命令': 'ollama run deepseek-r1:14b' },
          ],
        ...
        ramForLongContext: {
          ...
          rows: [
            { '模型': 'Llama 3.1 8B Q4_K_M', '4K上下文': '约6 GB', '32K上下文': '约9 GB', '128K上下文': '约14 GB' },
        ...
        regionalContext: {
          ...
          content: [
            ...
            '**日本（METI）：** 由于分词器差异，日文文档比等效英文文档需要1.5-2倍以上的标记。一份50页的日文报告可能消耗25K-35K标记----在Qwen3 8B可靠范围内（32K实际上限），但需要在Ollama中显式配置上下文：PARAMETER num_ctx 32768。',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: '2026年6月的主流本地模型——Qwen3、Gemma 4、Llama 3.1、Mistral Small 3.1——均原生支持128K标记，足以覆盖绝大多数长文档使用场景。Qwen3的中文分词器比Llama对中文文档效率高30-40%。1M标记本地推理需要150+ GB VRAM的专用硬件。对于大多数用户，Qwen3 14B配合128K上下文是实际可行的方案。',
            },
            {
              q: '什么是"中间迷失"问题，如何避免？',
...
schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': '长上下文本地LLM 2026：最佳128K模型对比',
        'description': 'Qwen3 14B（128K，~12 GB RAM，M5 Pro上15-25令牌/秒）领衔2026年6月本地长上下文LLM。Qwen3的原生中文分词器比Llama对中文文档效率高30-40%。所有主流模型——Qwen3、Gemma 4、Llama 3.1、Mistral Small 3.1——均原生支持128K。',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': '2026年6月的主流本地模型均原生支持128K标记，足以覆盖绝大多数长文档使用场景。Qwen3中文分词器比Llama效率高30-40%，是中文文档处理的首选。1M标记本地推理需要专用硬件（150+ GB VRAM）。对于大多数用户，Qwen3 14B配合128K上下文即可。',
            },
          },
          {
            '@type': 'Question',
      ...
      itemListSchema: {
        ...
        'numberOfItems': 10,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1,  'name': 'Qwen3 14B Q4_K_M',          'description': '128K上下文。实际上限32-64K。~12 GB RAM。M5 Pro上15-25令牌/秒。中文优化。ollama run qwen3:14b' },
          { '@type': 'ListItem', 'position': 2,  'name': 'Qwen3 4B Q4_K_M',           'description': '128K上下文。实际上限16-32K。~5 GB RAM。8 GB设备首选。ollama run qwen3:4b' },
          { '@type': 'ListItem', 'position': 3,  'name': 'Gemma 4 26B-A4B Q4_K_M',        'description': '128K上下文。实际上限32K。~15 GB RAM。ollama run gemma4:26b-a4b' },
          { '@type': 'ListItem', 'position': 4,  'name': 'Gemma 4 31B Q4_K_M',        'description': '128K上下文。实际上限32-64K。~19 GB RAM。ollama run gemma4:31b' },
          { '@type': 'ListItem', 'position': 5,  'name': 'Llama 3.1 8B Q4_K_M',       'description': '128K上下文。实际上限32K。~14 GB RAM。ollama run llama3.1:8b' },
          { '@type': 'ListItem', 'position': 6,  'name': 'Llama 3.2 3B',              'description': '128K上下文。实际上限16K。2.5 GB RAM。ollama run llama3.2:3b' },
          { '@type': 'ListItem', 'position': 7,  'name': 'Mistral Small 3.1 24B',     'description': '128K上下文。实际上限32K。24 GB RAM。ollama run mistral-small3.1' },
          { '@type': 'ListItem', 'position': 8,  'name': 'Qwen3 8B Q4_K_M',          'description': '128K上下文。实际上限32K。~9 GB RAM。ollama run qwen3:8b' },
          { '@type': 'ListItem', 'position': 9,  'name': 'Qwen3 30B Q4_K_M',         'description': '128K上下文。实际上限64K。~22 GB RAM。ollama run qwen3:30b' },
          { '@type': 'ListItem', 'position': 10, 'name': 'DeepSeek-R1 14B Q4_K_M',   'description': '128K上下文。实际上限32K。~10 GB RAM。推理任务首选。ollama run deepseek-r1:14b' },
        ],
      },
      gammaEmbedUrl: '/presentations/long-context-local-llms-static.html',
    ...
    de: {
      theme: 'Best Models',
      title: 'Lokale LLMs mit langem Kontext 2026: Beste 128K-Modelle im Vergleich',
      seoTitle: 'Lokale LLMs mit langem Kontext (2026): 128K-Modelle jetzt ausführbar',
      intro: 'Im Juni 2026 ist langer Kontext Standard. Qwen3, Gemma 4, Llama 3.1 und Mistral Small 3.1 unterstützen alle nativ 128K Token. Qwen3 14B bei Q4_K_M verarbeitet 128K Token in ~12 GB RAM mit 15-25 Tok/s auf Apple M5 Pro -- der klare Sieger für die meisten Setups. Auf 8-GB-Geräten deckt Qwen3 4B dasselbe 128K-Fenster bei geringerer Qualität ab. Ollama verwendet standardmäßig 2048 Token; dieser Leitfaden zeigt, welche Modelle in Ihr VRAM passen und wie schnell sie bei vollem Kontext laufen.',
      metaDescription: 'Qwen3, Gemma 4 und Llama 3.1 unterstützen alle 128K Kontext lokal. Welche Modelle in Ihr VRAM passen und wie schnell sie bei vollem Kontext laufen.',
      heroImage: '/images/long-context-local-llms-models-comparison-hero-de.webp',
      nextStep: {
      ...
      howToSchema: {
        '@context': 'https://schema.org',
        '@type': 'HowTo',
        'name': 'Kontextlänge in Ollama einstellen',
        'totalTime': 'PT5M',
        'step': [
          { '@type': 'HowToStep', 'position': 1, 'name': 'Standardkontext mit ollama show prüfen', 'text': 'Ausführen: ollama show llama3.1:8b -- nach num_ctx in der Ausgabe suchen' },
          { '@type': 'HowToStep', 'position': 2, 'name': 'Modelfile mit num_ctx-Parameter erstellen', 'text': 'FROM llama3.1:8b\nPARAMETER num_ctx 32768' },
          { '@type': 'HowToStep', 'position': 3, 'name': 'Das benutzerdefinierte Modell registrieren', 'text': 'ollama create llama3.1-32k -f Modelfile' },
          { '@type': 'HowToStep', 'position': 4, 'name': 'Ausführen und Kontext-Aktivierung überprüfen', 'text': 'ollama run llama3.1-32k' },
          { '@type': 'HowToStep', 'position': 5, 'name': 'Mit ollama ps bestätigen', 'text': 'ollama ps -- CONTEXT-Spalte sollte 32768 anzeigen' },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        'name': 'Lokale LLMs nach Kontextfenstergröße -- Ollama Juni 2026',
        'numberOfItems': 10,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1,  'name': 'Qwen3 14B Q4_K_M',          'description': '128K Token Kontext. ~32K-64K praktisch nutzbar. ~12 GB RAM bei 128K. 15-25 Tok/s auf M5 Pro. Beste Gesamtwahl für 16-GB-Geräte. ollama run qwen3:14b' },
          { '@type': 'ListItem', 'position': 2,  'name': 'Qwen3 4B Q4_K_M',           'description': '128K Token Kontext. ~16K-32K praktisch nutzbar. ~5 GB RAM. Beste Wahl für 8-GB-Geräte. ollama run qwen3:4b' },
          { '@type': 'ListItem', 'position': 3,  'name': 'Gemma 4 26B-A4B Q4_K_M',        'description': '128K Token Kontext. ~32K praktisch nutzbar. ~15 GB RAM bei 128K. Starke Multimodal-Unterstützung. ollama run gemma4:26b-a4b' },
          { '@type': 'ListItem', 'position': 4,  'name': 'Gemma 4 31B Q4_K_M',        'description': '128K Token Kontext. ~32K-64K praktisch nutzbar. ~19 GB RAM bei 128K. ollama run gemma4:31b' },
          { '@type': 'ListItem', 'position': 5,  'name': 'Llama 3.1 8B Q4_K_M',       'description': '128K Token Kontext. ~32K praktisch nutzbar. ~14 GB RAM bei 128K. ollama run llama3.1:8b' },
          { '@type': 'ListItem', 'position': 6,  'name': 'Llama 3.2 3B',              'description': '128K Token Kontext. ~16K praktisch nutzbar. 2,5 GB RAM. ollama run llama3.2:3b' },
          { '@type': 'ListItem', 'position': 7,  'name': 'Mistral Small 3.1 24B',     'description': '128K Token Kontext. ~32K praktisch nutzbar. 24 GB RAM bei 128K Q4_K_M. ollama run mistral-small3.1' },
          { '@type': 'ListItem', 'position': 8,  'name': 'Qwen3 8B',                  'description': '128K Token Kontext. ~32K praktisch nutzbar. ~9 GB RAM bei 128K Q4_K_M. ollama run qwen3:8b' },
          { '@type': 'ListItem', 'position': 9,  'name': 'Qwen3 30B',                 'description': '128K Token Kontext. ~64K praktisch nutzbar. ~22 GB RAM bei 128K Q4_K_M. ollama run qwen3:30b' },
          { '@type': 'ListItem', 'position': 10, 'name': 'DeepSeek-R1 14B',           'description': '128K Token Kontext. ~32K praktisch nutzbar. ~10 GB RAM bei 128K Q4_K_M. Beste Wahl für Reasoning-Aufgaben. ollama run deepseek-r1:14b' },
        ],
      },
      sections: {
        tldr: { id: 'key-takeaways', isTldr: true, snippetBlocks: [{ type: 'one-sentence', text: 'Alle großen lokalen LLMs von 2026 unterstützen nativ 128K Token; Qwen3 14B Q4_K_M verarbeitet 128K in ~12 GB RAM bei 15–25 Tok/s — aber Ollama begrenzt standardmäßig auf 2048 Token, also immer num_ctx im Modelfile setzen.' }, { type: 'plain-terms', text: 'Kontextlänge ist, wie viel Text eine KI auf einmal "sehen" kann. 128K Token ≈ 96.000 Wörter — genug für einen ganzen Roman. Der Haken: Modelle verlieren Genauigkeit bei Informationen, die in der Mitte sehr langer Eingaben vergraben sind ("Lost in the Middle"). Die wichtigsten Fakten an den Anfang des Prompts stellen.' }], items: ['Alle wichtigen lokalen LLMs 2026 — Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 — unterstützen 128K Token nativ. Langer Kontext ist Standard, kein Unterscheidungsmerkmal mehr.', '**Empfehlung für die meisten Nutzer: Qwen3 14B bei Q4_K_M.** Verarbeitet 128K Token in ~12 GB RAM mit 15-25 Tok/s auf Apple M5 Pro. Auf 8-GB-Geräten: Qwen3 4B — gleiche Kontextlänge, geringere Qualität, voll nutzbar.', 'RAM skaliert mit Kontextlänge UND Modellgröße. Ein 7B-Modell Q4_K_M benötigt ~6 GB bei 4K und ~14 GB bei 128K. Qwen3 14B Q4_K_M verbraucht ~12 GB bei 128K auf Apple Silicon (Unified Memory hilft).', '"Lost in the Middle" gilt weiterhin: LLMs verpassen Details aus mittleren Kontextabschnitten. Abhilfe: wichtige Infos an den Anfang, RAG für Suche, oder überlappende Chunks.', 'Langer Kontext eignet sich für holistische Analyse vollständiger Dokumente. RAG eignet sich für suchintensive Aufgaben. Nach Aufgabentyp wählen, nicht nach Kontextgröße.', 'Ollama nutzt standardmäßig 2048 Token -- nicht 128K. num_ctx explizit in einer Modelfile setzen. Apple M5 (16-32 GB, 200 GB/s) und M5 Pro (36-64 GB, 307 GB/s) eignen sich gut für 128K-Inferenz.'] },
        ...
        which128k: { id: 'models-128k', title: 'Welche lokalen LLMs unterstützen 128K-Token-Kontext im Jahr 2026?', rows: [{ 'Modell': 'Qwen3 14B Q4_K_M', 'Kontextfenster': '128K', 'Praktisches Limit': '~32-64K zuverlässig', 'Ollama-Befehl': 'ollama run qwen3:14b' }, { 'Modell': 'Qwen3 4B Q4_K_M', 'Kontextfenster': '128K', 'Praktisches Limit': '~16-32K zuverlässig', 'Ollama-Befehl': 'ollama run qwen3:4b' }, { 'Modell': 'Gemma 4 26B-A4B Q4_K_M', 'Kontextfenster': '128K', 'Praktisches Limit': '~32K zuverlässig', 'Ollama-Befehl': 'ollama run gemma4:26b-a4b' }, { 'Modell': 'Llama 3.1 8B Q4_K_M', 'Kontextfenster': '128K', 'Praktisches Limit': '~32K zuverlässig', 'Ollama-Befehl': 'ollama run llama3.1:8b' }, { 'Modell': 'Llama 3.2 3B', 'Kontextfenster': '128K', 'Praktisches Limit': '~16K zuverlässig', 'Ollama-Befehl': 'ollama run llama3.2:3b' }, { 'Modell': 'Mistral Small 3.1 24B', 'Kontextfenster': '128K', 'Praktisches Limit': '~32K zuverlässig', 'Ollama-Befehl': 'ollama run mistral-small3.1' }, { 'Modell': 'Qwen3 8B Q4_K_M', 'Kontextfenster': '128K', 'Praktisches Limit': '~32K zuverlässig', 'Ollama-Befehl': 'ollama run qwen3:8b' }, { 'Modell': 'DeepSeek-R1 14B Q4_K_M', 'Kontextfenster': '128K', 'Praktisches Limit': '~32K zuverlässig', 'Ollama-Befehl': 'ollama run deepseek-r1:14b' }], columns: ['Modell', 'Kontextfenster', 'Praktisches Limit', 'Ollama-Befehl'], image: '/images/long-context-local-llms-models-comparison-hero-de.webp', imageCaption: '8 lokale LLM-Modelle mit 128K-Kontextunterstützung 2026 -- Qwen3 14B ist die Top-Wahl für 16-GB-Geräte, Qwen3 4B für 8-GB-Geräte.' },
        ramForLongContext: { id: 'ram-long-context', title: 'Wie viel RAM benötigt die Verarbeitung langer Kontexte?', content: ['**Der RAM-Verbrauch skaliert sowohl mit Modellgröße als auch Kontextlänge.** Der KV-Cache speichert Attention-Zustände für alle verarbeiteten Token -- dieser wächst linear mit der Kontextlänge.', 'Ein 7B-Modell bei Q4_K_M mit 4K-Kontext benötigt ~6 GB RAM. Dasselbe Modell mit 32K-Kontext benötigt ~8-9 GB RAM. Bei 128K-Kontext: ~12-16 GB RAM.'], rows: [{ 'Modell': 'Llama 3.1 8B Q4_K_M', '4K-Kontext': '~6 GB', '32K-Kontext': '~9 GB', '128K-Kontext': '~14 GB' }, { 'Modell': 'Qwen3 14B Q4_K_M', '4K-Kontext': '~9 GB', '32K-Kontext': '~12 GB', '128K-Kontext': '~18 GB' }, { 'Modell': 'Mistral Small 3.1 24B Q4_K_M', '4K-Kontext': '~14 GB', '32K-Kontext': '~17 GB', '128K-Kontext': '~24 GB' }, { 'Modell': 'Llama 3.3 70B Q4_K_M', '4K-Kontext': '~40 GB', '32K-Kontext': '~45 GB', '128K-Kontext': '~55 GB' }], columns: ['Modell', '4K-Kontext', '32K-Kontext', '128K-Kontext'], image: '/images/long-context-local-llms-ram-scaling-hero-de.webp', imageCaption: 'KV-Cache-RAM skaliert mit Kontextlänge -- ein 7B-Modell bei Q4_K_M benötigt ~6 GB bei 4K, aber ~14 GB bei 128K-Kontext.' },
    ...
    fr: {
      theme: 'Best Models',
      title: 'LLMs locaux long contexte 2026 : Meilleurs modèles 128K comparés',
      seoTitle: 'LLM locaux long contexte (2026) : modèles 128K exécutables maintenant',
      intro: 'En juin 2026, le long contexte est devenu standard. Qwen3, Gemma 4, Llama 3.1 et Mistral Small 3.1 supportent tous nativement 128K tokens. Qwen3 14B en Q4_K_M traite 128K tokens en ~12 Go de RAM à 15-25 tok/s sur Apple M5 Pro — le choix évident pour la plupart des configurations. Sur les machines 8 Go, Qwen3 4B couvre la même fenêtre 128K avec une qualité moindre. Ollama utilise 2048 tokens par défaut ; ce guide indique quels modèles rentrent dans votre VRAM et à quelle vitesse ils fonctionnent en contexte complet.',
      metaDescription: 'Qwen3, Gemma 4 et Llama 3.1 supportent tous 128K tokens localement. Quels modèles rentrent dans votre VRAM et à quelle vitesse ils fonctionnent en contexte complet.',
      heroImage: '/images/long-context-local-llms-models-comparison-hero-fr.webp',
      nextStep: {
      ...
      howToSchema: {
        '@context': 'https://schema.org',
        '@type': 'HowTo',
        'name': 'Comment définir la longueur de contexte dans Ollama',
        'totalTime': 'PT5M',
        'step': [
          { '@type': 'HowToStep', 'position': 1, 'name': 'Vérifier le contexte par défaut avec ollama show', 'text': 'Exécuter : ollama show llama3.1:8b -- rechercher num_ctx dans la sortie' },
          { '@type': 'HowToStep', 'position': 2, 'name': 'Créer un Modelfile avec le paramètre num_ctx', 'text': 'FROM llama3.1:8b\nPARAMETER num_ctx 32768' },
          { '@type': 'HowToStep', 'position': 3, 'name': 'Enregistrer le modèle personnalisé', 'text': 'ollama create llama3.1-32k -f Modelfile' },
          { '@type': 'HowToStep', 'position': 4, 'name': 'Exécuter et vérifier que le contexte est actif', 'text': 'ollama run llama3.1-32k' },
          { '@type': 'HowToStep', 'position': 5, 'name': 'Confirmer avec ollama ps', 'text': 'ollama ps -- vérifier que la colonne CONTEXT affiche 32768' },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        'name': 'LLMs locaux par taille de fenêtre de contexte -- Ollama juin 2026',
        'numberOfItems': 10,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1,  'name': 'Qwen3 14B Q4_K_M',          'description': '128K tokens de contexte. ~32K-64K fiable en pratique. ~12 Go de RAM à 128K. 15-25 tok/s sur M5 Pro. Meilleur choix global pour les machines 16 Go. ollama run qwen3:14b' },
          { '@type': 'ListItem', 'position': 2,  'name': 'Qwen3 4B Q4_K_M',           'description': '128K tokens de contexte. ~16K-32K fiable en pratique. ~5 Go de RAM. Idéal pour les machines 8 Go. ollama run qwen3:4b' },
          { '@type': 'ListItem', 'position': 3,  'name': 'Gemma 4 26B-A4B Q4_K_M',        'description': '128K tokens de contexte. ~32K fiable en pratique. ~15 Go de RAM à 128K. Bon support multimodal. ollama run gemma4:26b-a4b' },
          { '@type': 'ListItem', 'position': 4,  'name': 'Gemma 4 31B Q4_K_M',        'description': '128K tokens de contexte. ~32K-64K fiable en pratique. ~19 Go de RAM à 128K. ollama run gemma4:31b' },
          { '@type': 'ListItem', 'position': 5,  'name': 'Llama 3.1 8B Q4_K_M',       'description': '128K tokens de contexte. ~32K fiable en pratique. ~14 Go de RAM à 128K. ollama run llama3.1:8b' },
          { '@type': 'ListItem', 'position': 6,  'name': 'Llama 3.2 3B',              'description': '128K tokens de contexte. ~16K fiable en pratique. 2,5 Go de RAM. ollama run llama3.2:3b' },
          { '@type': 'ListItem', 'position': 7,  'name': 'Mistral Small 3.1 24B',     'description': '128K tokens de contexte. ~32K fiable en pratique. 24 Go de RAM à 128K en Q4_K_M. ollama run mistral-small3.1' },
          { '@type': 'ListItem', 'position': 8,  'name': 'Qwen3 8B',                  'description': '128K tokens de contexte. ~32K fiable en pratique. ~9 Go de RAM à 128K en Q4_K_M. ollama run qwen3:8b' },
          { '@type': 'ListItem', 'position': 9,  'name': 'Qwen3 30B',                 'description': '128K tokens de contexte. ~64K fiable en pratique. ~22 Go de RAM à 128K en Q4_K_M. ollama run qwen3:30b' },
          { '@type': 'ListItem', 'position': 10, 'name': 'DeepSeek-R1 14B',           'description': '128K tokens de contexte. ~32K fiable en pratique. ~10 Go de RAM à 128K en Q4_K_M. Idéal pour les tâches de raisonnement. ollama run deepseek-r1:14b' },
        ],
      },
      sections: {
        tldr: { id: 'key-takeaways', isTldr: true, snippetBlocks: [{ type: 'one-sentence', text: 'Tous les grands LLM locaux 2026 supportent 128K tokens nativement ; Qwen3 14B Q4_K_M gère 128K en ~12 Go RAM à 15–25 tok/s — mais Ollama est limité à 2048 tokens par défaut, alors toujours définir num_ctx dans un Modelfile.' }, { type: 'plain-terms', text: 'La longueur de contexte indique combien de texte une IA peut "voir" à la fois. 128K tokens ≈ 96 000 mots — de quoi couvrir un roman entier. Le problème : les modèles perdent en précision sur les informations enfouies au milieu de très longues entrées ("Lost in the Middle"). Placez vos faits les plus importants au début du prompt.' }], items: ['Tous les principaux LLMs locaux 2026 — Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 — supportent 128K tokens nativement. Le long contexte est désormais standard, plus un avantage différenciant.', '**Recommandation pour la plupart des utilisateurs : Qwen3 14B en Q4_K_M.** Traite 128K tokens en ~12 Go de RAM à 15-25 tok/s sur Apple M5 Pro. Sur 8 Go : Qwen3 4B — même longueur de contexte, qualité moindre, pleinement utilisable.', 'La RAM évolue avec la longueur du contexte ET la taille du modèle. Un modèle 7B Q4_K_M nécessite ~6 Go à 4K et ~14 Go à 128K. Qwen3 14B Q4_K_M utilise ~12 Go à 128K sur Apple Silicon.', 'Le problème "Lost in the Middle" persiste : les LLMs manquent des détails des sections centrales. Solutions : informations critiques au début du prompt, RAG pour la recherche, ou blocs chevauchants.', 'Le long contexte excelle pour l\'analyse holistique de documents complets. Le RAG excelle pour les tâches de recherche sur de nombreux documents. Choisir selon le type de tâche.', 'Ollama utilise 2048 tokens par défaut -- pas 128K. Définir num_ctx explicitement dans un Modelfile. Apple M5 (16-32 Go, 200 Go/s) et M5 Pro (36-64 Go, 307 Go/s) gèrent bien l\'inférence 128K.'] },
        ...
        which128k: { id: 'models-128k', title: 'Quels LLMs locaux supportent 128K tokens de contexte en 2026 ?', rows: [{ 'Modèle': 'Qwen3 14B Q4_K_M', 'Fenêtre de contexte': '128K', 'Limite pratique': '~32-64K fiable', 'Commande Ollama': 'ollama run qwen3:14b' }, { 'Modèle': 'Qwen3 4B Q4_K_M', 'Fenêtre de contexte': '128K', 'Limite pratique': '~16-32K fiable', 'Commande Ollama': 'ollama run qwen3:4b' }, { 'Modèle': 'Gemma 4 26B-A4B Q4_K_M', 'Fenêtre de contexte': '128K', 'Limite pratique': '~32K fiable', 'Commande Ollama': 'ollama run gemma4:26b-a4b' }, { 'Modèle': 'Llama 3.1 8B Q4_K_M', 'Fenêtre de contexte': '128K', 'Limite pratique': '~32K fiable', 'Commande Ollama': 'ollama run llama3.1:8b' }, { 'Modèle': 'Llama 3.2 3B', 'Fenêtre de contexte': '128K', 'Limite pratique': '~16K fiable', 'Commande Ollama': 'ollama run llama3.2:3b' }, { 'Modèle': 'Mistral Small 3.1 24B', 'Fenêtre de contexte': '128K', 'Limite pratique': '~32K fiable', 'Commande Ollama': 'ollama run mistral-small3.1' }, { 'Modèle': 'Qwen3 8B Q4_K_M', 'Fenêtre de contexte': '128K', 'Limite pratique': '~32K fiable', 'Commande Ollama': 'ollama run qwen3:8b' }, { 'Modèle': 'DeepSeek-R1 14B Q4_K_M', 'Fenêtre de contexte': '128K', 'Limite pratique': '~32K fiable', 'Commande Ollama': 'ollama run deepseek-r1:14b' }], columns: ['Modèle', 'Fenêtre de contexte', 'Limite pratique', 'Commande Ollama'], image: '/images/long-context-local-llms-models-comparison-hero-fr.webp', imageCaption: '8 modèles LLM locaux avec support de contexte 128K en 2026 -- Qwen3 14B est le meilleur choix pour les machines 16 Go.' },
        ramForLongContext: { id: 'ram-long-context', title: 'Combien de RAM le traitement de long contexte nécessite-t-il ?', content: ['**L\'utilisation RAM évolue avec la taille du modèle et la longueur du contexte.** Le cache KV stocke les états d\'attention pour tous les tokens traités -- il croît linéairement avec la longueur du contexte.', 'Un modèle 7B en Q4_K_M avec contexte 4K utilise ~6 Go de RAM. Le même modèle avec contexte 32K utilise ~8-9 Go. Avec contexte 128K : ~12-16 Go.'], rows: [{ 'Modèle': 'Llama 3.1 8B Q4_K_M', 'Contexte 4K': '~6 Go', 'Contexte 32K': '~9 Go', 'Contexte 128K': '~14 Go' }, { 'Modèle': 'Qwen3 14B Q4_K_M', 'Contexte 4K': '~9 Go', 'Contexte 32K': '~12 Go', 'Contexte 128K': '~18 Go' }, { 'Modèle': 'Mistral Small 3.1 24B Q4_K_M', 'Contexte 4K': '~14 Go', 'Contexte 32K': '~17 Go', 'Contexte 128K': '~24 Go' }, { 'Modèle': 'Llama 3.3 70B Q4_K_M', 'Contexte 4K': '~40 Go', 'Contexte 32K': '~45 Go', 'Contexte 128K': '~55 Go' }], columns: ['Modèle', 'Contexte 4K', 'Contexte 32K', 'Contexte 128K'], image: '/images/long-context-local-llms-ram-scaling-hero-fr.webp', imageCaption: 'La RAM du cache KV évolue avec la longueur du contexte -- un modèle 7B en Q4_K_M nécessite ~6 Go à 4K, mais ~14 Go à 128K.' },
    ...
    ja: {
      theme: 'Best Models',
      title: '長コンテキスト対応ローカルLLM 2026：最良の128Kモデル比較',
      seoTitle: '長コンテキスト・ローカルLLM（2026）：今すぐ動かせる128Kモデル',
      intro: '2026年6月、長コンテキストはスタンダードになった。Qwen3、Gemma 4、Llama 3.1、Mistral Small 3.1はすべて128Kトークンをネイティブサポートする。**Qwen3はネイティブ日本語トークナイザーを搭載しており、Llamaより日本語文書を30-40%効率的に処理する。** Qwen3 14B（Q4_K_M量化）はApple M5 Proで約12 GB RAMを使用し、128Kコンテキストを15-25トークン/秒で処理できる。8 GBマシンにはQwen3 4Bが同じ128Kウィンドウをより低品質で提供する。',
      metaDescription: 'Qwen3、Gemma 4、Llama 3.1はすべて128Kコンテキストをローカルでサポート。どのモデルがあなたのVRAMに収まり、フルコンテキストでどれだけ速いかを比較。',
      heroImage: '/images/long-context-local-llms-models-comparison-hero-ja.webp',
      nextStep: {
      ...
      howToSchema: {
        '@context': 'https://schema.org',
        '@type': 'HowTo',
        'name': 'Ollamaでコンテキスト長を設定する方法',
        'totalTime': 'PT5M',
        'step': [
          { '@type': 'HowToStep', 'position': 1, 'name': 'ollama showでデフォルトのコンテキストを確認する', 'text': '実行：ollama show llama3.1:8b -- 出力のnum_ctxを確認' },
          { '@type': 'HowToStep', 'position': 2, 'name': 'num_ctxパラメータを含むModelfileを作成する', 'text': 'FROM llama3.1:8b\nPARAMETER num_ctx 32768' },
          { '@type': 'HowToStep', 'position': 3, 'name': 'カスタムモデルを登録する', 'text': 'ollama create llama3.1-32k -f Modelfile' },
          { '@type': 'HowToStep', 'position': 4, 'name': '実行してコンテキストが有効か確認する', 'text': 'ollama run llama3.1-32k' },
          { '@type': 'HowToStep', 'position': 5, 'name': 'ollama psで確認する', 'text': 'ollama ps -- CONTEXT列が32768と表示されることを確認' },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        'name': 'コンテキストウィンドウサイズ別ローカルLLM -- Ollama 2026年6月',
        'numberOfItems': 10,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1,  'name': 'Qwen3 14B Q4_K_M',          'description': '128Kトークンコンテキスト。~32K-64K実用的。128Kで~12 GB RAM。M5 Proで15-25トークン/秒。16 GBマシンに最適。ollama run qwen3:14b' },
          { '@type': 'ListItem', 'position': 2,  'name': 'Qwen3 4B Q4_K_M',           'description': '128Kトークンコンテキスト。~16K-32K実用的。~5 GB RAM。8 GBマシンに最適。ollama run qwen3:4b' },
          { '@type': 'ListItem', 'position': 3,  'name': 'Gemma 4 26B-A4B Q4_K_M',        'description': '128Kトークンコンテキスト。~32K実用的。128Kで~15 GB RAM。強力なマルチモーダル対応。ollama run gemma4:26b-a4b' },
          { '@type': 'ListItem', 'position': 4,  'name': 'Gemma 4 31B Q4_K_M',        'description': '128Kトークンコンテキスト。~32K-64K実用的。128Kで~19 GB RAM。ollama run gemma4:31b' },
          { '@type': 'ListItem', 'position': 5,  'name': 'Llama 3.1 8B Q4_K_M',       'description': '128Kトークンコンテキスト。~32K実用的。128Kで~14 GB RAM。ollama run llama3.1:8b' },
          { '@type': 'ListItem', 'position': 6,  'name': 'Llama 3.2 3B',              'description': '128Kトークンコンテキスト。~16K実用的。2.5 GB RAM。ollama run llama3.2:3b' },
          { '@type': 'ListItem', 'position': 7,  'name': 'Mistral Small 3.1 24B',     'description': '128Kトークンコンテキスト。~32K実用的。128K時Q4_K_Mで24 GB RAM。ollama run mistral-small3.1' },
          { '@type': 'ListItem', 'position': 8,  'name': 'Qwen3 8B',                  'description': '128Kトークンコンテキスト。~32K実用的。128K時Q4_K_Mで~9 GB RAM。ollama run qwen3:8b' },
          { '@type': 'ListItem', 'position': 9,  'name': 'Qwen3 30B',                 'description': '128Kトークンコンテキスト。~64K実用的。128K時Q4_K_Mで~22 GB RAM。ollama run qwen3:30b' },
          { '@type': 'ListItem', 'position': 10, 'name': 'DeepSeek-R1 14B',           'description': '128Kトークンコンテキスト。~32K実用的。128K時Q4_K_Mで~10 GB RAM。推論タスクに最適。ollama run deepseek-r1:14b' },
        ],
      },
      sections: {
        tldr: { id: 'key-takeaways', isTldr: true, snippetBlocks: [{ type: 'one-sentence', text: '2026年の主要なローカルLLMはすべて128Kトークンをネイティブでサポート。Qwen3 14B Q4_K_Mは~12 GB RAMで15〜25トークン/秒 — ただしOllamaのデフォルトは2048トークンなので、Modelfileで必ずnum_ctxを明示的に設定すること。' }, { type: 'plain-terms', text: 'コンテキスト長とは、AIが一度に「見ることができる」テキストの量です。128Kトークン ≈ 96,000語 — 小説1冊分に相当します。落とし穴：非常に長い入力の中間に埋め込まれた情報に対してモデルの精度が低下します（「Lost in the Middle」と呼ばれる現象）。最も重要な情報をプロンプトの冒頭に置くようにしましょう。' }], items: ['2026年6月の主要ローカルLLM——Qwen3、Gemma 4、Llama 3.1、Mistral Small 3.1——はすべて128Kトークンをネイティブサポートする。長コンテキストは標準機能になった。', '**ほとんどのユーザーへの推奨：Qwen3 14B（Q4_K_M）。** Apple M5 Proで約12 GB RAM使用、128Kを15-25トークン/秒で処理。**Qwen3はネイティブ日本語トークナイザーでLlamaより30-40%効率的。** 8 GBマシンにはQwen3 4B。', 'RAMはコンテキスト長とモデルサイズ両方に比例して増加。7BモデルQ4_K_Mは4Kで~6 GB、128Kで~14 GB必要。Apple M5 Proの統合メモリ（36-64 GB、307 GB/s）は128K推論に最適。', '"中間迷子"問題は依然として存在：LLMはコンテキスト中間の詳細を見落とす。対策：重要情報をプロンプト冒頭に置き、検索にはRAGを使用する。', '長いコンテキストは完全なドキュメントの総合分析に優れる。RAGは多数のドキュメントの検索タスクに優れる。タスク種別で選択する。', 'Ollamaのデフォルトは2048トークン——128Kではない。ModelfileでPARAMETER num_ctx 32768を明示的に設定すること。'] },
        ...
        faqSection: { id: 'faq', title: 'よくある質問', faqs: [{ q: 'ローカルLLMで本全体を要約できますか？', a: '典型的な300ページの本は90,000-120,000語、約120K-160Kトークンです。これはほとんどの7Bモデルの実用的な信頼性コンテキストを超えています。7Bモデルでは：本を20K語の章に分割し、各章を要約してから章の要約をまとめてください。' }, { q: '32Kトークンに何ページのテキストが入りますか？', a: '標準的な英語テキスト（1ページ250語）で約50-70ページです。32Kトークンには短編小説、付録付きの完全な研究論文、または完全な技術仕様書が入ります。' }, { q: 'コンテキスト長を増やすと推論が遅くなりますか？', a: 'はい。同じハードウェアで32Kコンテキストの処理は4Kより約3-4倍時間がかかります（アテンション計算の二次スケーリングのため）。生成速度は大きく影響しませんが、初回トークンまでの時間は入力長に比例します。' }, { q: 'どのローカルLLMが長いコンテキストよりRAGを上手く処理しますか？', a: 'ドキュメントの検索と取得タスクでは、RAGの方が効果的な場合が多いです。RAGは3-5個の関連チャンク（合計4K-8Kトークン）を取得し、"中間迷子"問題を回避します。' }, { q: 'KVキャッシュとは何か、なぜコンテキスト長とともに増加するのか？', a: 'KVキャッシュはコンテキストウィンドウで処理されたすべてのトークンのAttention状態を格納します。32Kコンテキストは4Kより8倍多くのKVキャッシュメモリが必要です。モデルの重みは変わらず、KVキャッシュのみが増加します。' }, { q: 'ローカルモデルはGemini 3.1 Proのような1Mトークンのコンテキストを処理できますか？', a: '2026年6月の主要ローカルモデル——Qwen3、Gemma 4、Llama 3.1、Mistral Small 3.1——はすべて128Kトークンをネイティブサポートし、大半の長文書使用ケースをカバーする。**Qwen3はネイティブ日本語トークナイザーにより、日本語文書をLlamaより30-40%効率的に処理できる。** 1Mトークンのローカル推論には専用ハードウェア（150+ GB VRAM）が必要。ほとんどのユーザーにはQwen3 14Bと128Kコンテキストが実用的な最適解。' }, { q: '"中間迷子"問題とは何か、どう回避するか？', a: 'LLMはコンテキストの最初と最後の情報を確実に取得しますが、中間の詳細を見落とします。128Kコンテキストでは40K-80Kトークン付近が最も無視されやすいです。重要情報はプロンプトの先頭に配置し、RAGを使うか、重複する16K-32Kセクションで処理してください。' }, { q: 'Ollamaが使用しているコンテキスト長を確認するには？', a: '`ollama show <モデル>` を実行してください -- 出力にnum_ctxが表示されます。2048と表示された場合、Ollamaはデフォルトを使用しています。永続的に変更するには：PARAMETER num_ctx 32768のModelfileを作成し、`ollama create <名前> -f Modelfile` を実行。`ollama ps` でアクティブなセッションを確認してください。' }, { q: 'ドキュメントQ&Aには長いコンテキストとRAGのどちらが優れていますか？', a: 'RAGは通常、ドキュメントQ&AにおいてRAMも効率的で効果的です。RAGは3-5個の関連チャンク（合計4K-8Kトークン）を取得し、"中間迷子"問題を回避します。長いコンテキストはドキュメント全体の構造を理解する必要がある場合や、セクション間の関係が重要な場合に優れています。' }] },
  ...
  ko: {
      ...
      next_refresh_due: '2026-09-28',
      theme: 'Best Models',
      title: '긴 컨텍스트 로컬 LLM 2026: 최고의 128K 모델 비교',
      seoTitle: '로컬 LLM 긴 컨텍스트 (2026): 지금 실행 가능한 128K 모델',
      intro: '2026년 6월, 긴 컨텍스트는 표준이 되었습니다. Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 모두 128K 토큰을 기본 지원합니다. Qwen3 14B (Q4_K_M)는 Apple M5 Pro에서 약 12 GB RAM으로 128K 컨텍스트를 15-25 토큰/초로 처리할 수 있습니다. 8 GB 장치에는 Qwen3 4B가 동일한 128K 창을 낮은 품질로 제공합니다. Ollama의 기본값은 2048 토큰입니다. 이 가이드에서는 VRAM에 맞는 모델과 전체 컨텍스트에서의 속도를 안내합니다.',
      metaDescription: 'Qwen3, Gemma 4, Llama 3.1 모두 128K 컨텍스트를 로컬에서 지원합니다. 어떤 모델이 VRAM에 맞고 전체 컨텍스트에서 얼마나 빠른지 비교.',
      heroImage: '/images/long-context-local-llms-models-comparison-hero-ko.webp',
      publishDate: '2026-04-04',
      leadAnswerBlock: '2026년 6월 최고의 긴 컨텍스트 로컬 LLM은 Qwen3 14B (Q4_K_M)입니다 — Apple M5 Pro에서 약 12 GB RAM으로 128K 토큰을 15-25 토큰/초로 처리합니다. 8 GB 장치에는 Qwen3 4B (128K)가 적합합니다. 2026년 모든 주요 모델 — Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 — 이 128K 컨텍스트를 기본 지원합니다. 긴 컨텍스트는 이제 표준입니다.',
      nextStep: {
        text: '128K 이상 컨텍스트 모델을 실행할 하드웨어가 필요하십니까? 하드웨어 가이드부터 시작하십시오.',
        label: '로컬 LLM 하드웨어 가이드 2026 →',
        href: '/local-llms/local-llm-hardware-guide-2026',
      },
      audience: 'Ollama 또는 LM Studio에 익숙한 개발자로서 로컬 LLM 워크플로우를 최적화하려는 분',
      dateModified: '2026-08-28',
      readTime: '8분 읽기',
      educationalLevel: 'Intermediate',
      primaryTerm: '긴 컨텍스트 로컬 LLM',
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': '긴 컨텍스트 로컬 LLM 2026: 최고의 128K 모델 비교',
        'description': '2026년 6월 최고의 긴 컨텍스트 로컬 LLM은 Qwen3 14B (Q4_K_M) — Apple M5 Pro에서 약 12 GB RAM으로 128K 토큰을 15-25 토큰/초로 처리. 모든 주요 2026 모델 — Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 — 이 128K 컨텍스트를 기본 지원.',
        'datePublished': '2026-04-04',
        'dateModified': '2026-08-28',
        'url': 'https://www.promptquorum.com/local-llms/long-context-local-llms',
        'proficiencyLevel': 'Intermediate',
        'about': [
          { '@type': 'Thing', 'name': '긴 컨텍스트 LLM' },
          { '@type': 'Thing', 'name': '128K 컨텍스트 창 Ollama' },
          { '@type': 'Thing', 'name': 'KV 캐시 RAM' },
      ...
      howToSchema: {
        '@context': 'https://schema.org',
        '@type': 'HowTo',
        'name': 'Ollama에서 컨텍스트 길이 설정하는 방법',
        'totalTime': 'PT5M',
        'step': [
          { '@type': 'HowToStep', 'position': 1, 'name': 'ollama show로 기본 컨텍스트 확인', 'text': '실행: ollama show llama3.1:8b -- 출력에서 num_ctx 확인' },
          { '@type': 'HowToStep', 'position': 2, 'name': 'num_ctx 파라미터로 Modelfile 생성', 'text': 'FROM llama3.1:8b\nPARAMETER num_ctx 32768' },
          { '@type': 'HowToStep', 'position': 3, 'name': '커스텀 모델 등록', 'text': 'ollama create llama3.1-32k -f Modelfile' },
          { '@type': 'HowToStep', 'position': 4, 'name': '실행하여 컨텍스트 활성화 확인', 'text': 'ollama run llama3.1-32k' },
          { '@type': 'HowToStep', 'position': 5, 'name': 'ollama ps로 확인', 'text': 'ollama ps -- CONTEXT 열에 32768이 표시되는지 확인' },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        'name': '128K 컨텍스트 창 지원 로컬 LLM -- 2026년 6월',
        'numberOfItems': 10,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1,  'name': 'Qwen3 14B Q4_K_M',          'description': '128K 토큰 컨텍스트. 32-64K 실용 가능. ~12 GB RAM. M5 Pro에서 15-25 토큰/초. ollama run qwen3:14b' },
          { '@type': 'ListItem', 'position': 2,  'name': 'Qwen3 4B Q4_K_M',           'description': '128K 토큰 컨텍스트. 16-32K 실용 가능. ~5 GB RAM. 8 GB 장치용. ollama run qwen3:4b' },
          { '@type': 'ListItem', 'position': 3,  'name': 'Gemma 4 26B-A4B Q4_K_M',        'description': '128K 토큰 컨텍스트. 32K 실용 가능. ~15 GB RAM. ollama run gemma4:26b-a4b' },
          { '@type': 'ListItem', 'position': 4,  'name': 'Gemma 4 31B Q4_K_M',        'description': '128K 토큰 컨텍스트. 32-64K 실용 가능. ~19 GB RAM. ollama run gemma4:31b' },
          { '@type': 'ListItem', 'position': 5,  'name': 'Llama 3.1 8B Q4_K_M',       'description': '128K 토큰 컨텍스트. 32K 실용 가능. ~14 GB RAM. ollama run llama3.1:8b' },
          { '@type': 'ListItem', 'position': 6,  'name': 'Llama 3.2 3B',              'description': '128K 토큰 컨텍스트. 16K 실용 가능. 2.5 GB RAM. ollama run llama3.2:3b' },
          { '@type': 'ListItem', 'position': 7,  'name': 'Mistral Small 3.1 24B',     'description': '128K 토큰 컨텍스트. 32K 실용 가능. 24 GB RAM. ollama run mistral-small3.1' },
          { '@type': 'ListItem', 'position': 8,  'name': 'Qwen3 8B Q4_K_M',          'description': '128K 토큰 컨텍스트. 32K 실용 가능. ~9 GB RAM. ollama run qwen3:8b' },
          { '@type': 'ListItem', 'position': 9,  'name': 'Qwen3 30B Q4_K_M',         'description': '128K 토큰 컨텍스트. 64K 실용 가능. ~22 GB RAM. ollama run qwen3:30b' },
          { '@type': 'ListItem', 'position': 10, 'name': 'DeepSeek-R1 14B Q4_K_M',   'description': '128K 토큰 컨텍스트. 32K 실용 가능. ~10 GB RAM. 추론 작업 최적. ollama run deepseek-r1:14b' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
        ...
        'mainEntity': [
          ...
          {
            '@type': 'Question',
            'name': '32K 토큰에는 몇 페이지의 텍스트가 들어갑니까?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': '표준 영어 텍스트 기준(페이지당 250단어) 약 50~70페이지입니다. 32K 토큰 컨텍스트에는 단편 소설, 부록이 포함된 완전한 연구 논문, 또는 전체 기술 사양 문서가 들어갑니다.',
            },
          },
          {
            '@type': 'Question',
          ...
          {
            '@type': 'Question',
            'name': '로컬 모델이 Gemini 3.1 Pro처럼 1M 토큰 컨텍스트를 처리할 수 있습니까?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': '2026년 6월 주요 로컬 모델 — Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 — 은 모두 128K 토큰을 기본 지원하며 대부분의 긴 문서 사용 사례를 커버합니다. 1M 토큰 로컬 추론은 전문 하드웨어(150+ GB VRAM)가 필요합니다. 대부분의 사용자에게는 Qwen3 14B와 128K 컨텍스트가 실용적인 최적 솔루션입니다.',
            },
          },
          {
            '@type': 'Question',
          ...
          {
            '@type': 'Question',
            'name': '16GB RAM으로 128K 컨텍스트 로컬 LLM을 실행하려면 어떻게 해야 합니까?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': '16GB RAM에서 Q4_K_M의 Mistral Small 3.1 24B로 32K 컨텍스트를 사용하면 약 17GB가 필요하여 16GB를 초과합니다. Q4_K_M의 Llama 3.1 8B로 32K 컨텍스트(약 9GB) 또는 128K 컨텍스트(약 14GB)를 사용하면 여유 있게 실행됩니다. Modelfile에서 num_ctx를 설정하십시오: PARAMETER num_ctx 32768.',
            },
          },
        ],
      },
      toc: [
        ...
        { label: '컨텍스트 길이란?', anchor: '#what-is-context-length' },
        { label: '128K를 지원하는 모델', anchor: '#models-128k' },
        { label: '긴 컨텍스트에 필요한 RAM', anchor: '#ram-long-context' },
        { label: '실용적 컨텍스트 vs 이론적 컨텍스트', anchor: '#practical-context' },
        { label: 'Ollama에서 컨텍스트 길이 설정하기', anchor: '#set-context-ollama' },
      ...
      sections: {
        tldr: {
          ...
          items: [
            '2026년 6월 주요 로컬 LLM — Qwen3, Gemma 4, Llama 3.1, Mistral Small 3.1 — 모두 128K 토큰을 기본 지원합니다. 긴 컨텍스트는 이제 표준이 되었습니다.',
        ...
        whatIsContext: {
          id: 'what-is-context-length',
          title: '컨텍스트 길이란 무엇이며 로컬 LLM에서 왜 중요합니까?',
          content: [
        ...
        which128k: {
          id: 'models-128k',
          title: '2026년에 128K 토큰 컨텍스트를 지원하는 로컬 LLM은?',
          rows: [
            { '모델': 'Qwen3 14B Q4_K_M', '컨텍스트 창': '128K', '실용적 한계': '~32-64K 안정', 'Ollama 명령': 'ollama run qwen3:14b' },
            { '모델': 'Qwen3 4B Q4_K_M',  '컨텍스트 창': '128K', '실용적 한계': '~16-32K 안정', 'Ollama 명령': 'ollama run qwen3:4b' },
            { '모델': 'Gemma 4 26B-A4B Q4_K_M', '컨텍스트 창': '128K', '실용적 한계': '~32K 안정', 'Ollama 명령': 'ollama run gemma4:26b-a4b' },
            { '모델': 'Llama 3.1 8B Q4_K_M', '컨텍스트 창': '128K', '실용적 한계': '~32K 안정', 'Ollama 명령': 'ollama run llama3.1:8b' },
            { '모델': 'Llama 3.2 3B', '컨텍스트 창': '128K', '실용적 한계': '~16K 안정', 'Ollama 명령': 'ollama run llama3.2:3b' },
            { '모델': 'Mistral Small 3.1 24B', '컨텍스트 창': '128K', '실용적 한계': '~32K 안정', 'Ollama 명령': 'ollama run mistral-small3.1' },
            { '모델': 'Qwen3 8B Q4_K_M', '컨텍스트 창': '128K', '실용적 한계': '~32K 안정', 'Ollama 명령': 'ollama run qwen3:8b' },
            { '모델': 'DeepSeek-R1 14B Q4_K_M', '컨텍스트 창': '128K', '실용적 한계': '~32K 안정', 'Ollama 명령': 'ollama run deepseek-r1:14b' },
          ],
          columns: ['모델', '컨텍스트 창', '실용적 한계', 'Ollama 명령'],
          image: '/images/long-context-local-llms-models-comparison-hero-ko.webp',
          imageCaption: '2026년 128K 컨텍스트를 지원하는 로컬 LLM 8개 -- Qwen3 14B는 16 GB 장치에 최적, Qwen3 4B는 8 GB 장치에 최적.',
        },
        ramForLongContext: {
          id: 'ram-long-context',
          title: '긴 컨텍스트 처리에는 얼마나 많은 RAM이 필요합니까?',
          content: [
          ...
          columns: ['Model', '4K Context', '32K Context', '128K Context'],
          image: '/images/long-context-local-llms-ram-scaling-hero-ko.webp',
          imageCaption: 'KV 캐시 RAM은 컨텍스트 길이에 따라 증가합니다. Q4_K_M의 7B 모델은 4K 컨텍스트에서 약 6GB, 128K 컨텍스트에서 약 14GB가 필요합니다.',
        },
        practicalVsTheoretical: {
          id: 'practical-context',
          title: '실용적 컨텍스트 길이가 광고된 최대값보다 짧은 이유는 무엇입니까?',
          content: [
            ...
            '긴 컨텍스트 창은 더 많은 입력을 가능하게 하지만, 모델이 해당 컨텍스트를 효과적으로 활용하는지는 프롬프트 구조에 달려 있습니다. RAG, 프롬프트 체이닝, 컨텍스트 창 관리 전략 등의 기법은 [프롬프트 엔지니어링 가이드](https://www.promptquorum.com/prompt-engineering)에서 다루고 있습니다.',
          ],
          image: '/images/lost-in-the-middle-effect-en.svg',
          imageCaption: '"중간 소실" 효과: LLM은 컨텍스트 창의 시작과 끝 부분의 내용은 안정적으로 기억하지만 40K~80K 토큰 구간은 놓칩니다.',
        },
        contextSettings: {
          id: 'set-context-ollama',
          title: 'Ollama에서 컨텍스트 길이를 어떻게 설정합니까?',
          content: ['별도 설정이 없으면 Ollama는 기본적으로 2048 토큰의 컨텍스트를 사용합니다. 모델의 전체 컨텍스트 창을 사용하려면:', '컨텍스트 창 크기는 모델이 처리할 수 있는 텍스트 양을 결정하지만, 모델이 해당 컨텍스트를 효과적으로 활용하는지는 프롬프트 구조에 달려 있습니다. 모델이 이전 입력을 잊는 이유와 이를 완화하는 전략에 대한 심층 설명은 [컨텍스트 창 설명: AI가 잊는 이유](https://www.promptquorum.com/prompt-engineering/context-windows-explained-why-ai-forgets)를 참조하십시오.'],
          codeBlock: '# 런타임에서 컨텍스트 길이 설정\nollama run llama3.2 --ctx 32768\n\n# 또는 Modelfile로 커스텀 모델 생성\ncat << EOF > Modelfile\nFROM llama3.1:8b\nPARAMETER num_ctx 32768\nEOF\nollama create llama3.1-32k -f Modelfile\nollama run llama3.1-32k',
          codeLanguage: 'bash',
          image: '/images/ollama-context-modelfile-en.svg',
          imageCaption: 'Modelfile에서 num_ctx 32768을 설정하면 Ollama에서 32K 컨텍스트가 활성화됩니다. `ollama ps`의 CTX 열에서 확인할 수 있습니다.',
        },
        regionalContext: {
          id: 'regional-context',
          title: '긴 컨텍스트 로컬 LLM: 지역별 컨텍스트',
          content: [
            ...
            '민감한 문서를 로컬에서 처리하는 AI 시스템에 대한 독일 BSI 준수를 위한 권장 구성은 32K 컨텍스트의 Q4_K_M 7B 모델입니다(표준 워크스테이션의 9~10GB RAM에 맞음). 이는 최대 50페이지 문서에서 안정적인 품질을 제공하면서 모든 데이터를 온프레미스에 유지합니다. 긴 컨텍스트 문서 처리를 위한 EU 준수 선택으로는 Llama 3.1 8B와 Mistral Small 3.1이 권장됩니다.',
            '개인 데이터에 관한 프랑스 CNIL 가이드라인: 외부 API 호출 없이 Ollama를 통한 로컬 추론은 개인 데이터가 유효한 법적 근거 없이 제3자 AI 제공자에 의해 처리되지 않아야 한다는 요구 사항을 충족합니다.',
            '**일본 (METI):** 일본어 문서는 토크나이저 차이로 인해 동등한 영어 문서보다 1.5~2배 더 많은 토큰이 필요합니다. 50페이지 일본어 보고서는 25K~35K 토큰을 소비할 수 있습니다. 이는 Qwen3 8B의 안정적 범위(32K 실용 한계) 내이지만 Ollama에서 명시적 컨텍스트 설정이 필요합니다: PARAMETER num_ctx 32768. 일본어 법률 및 금융 문서의 경우 32K 컨텍스트의 Q4_K_M Qwen3 14B(약 12GB RAM)가 일본어 긴 컨텍스트 처리에서 최고의 품질 대비 RAM 효율을 제공합니다. Qwen3의 일본어 네이티브 토크나이저는 Llama보다 일본어 텍스트를 30~40% 더 효율적으로 처리합니다.',
        ...
        commonMistakes: {
          id: 'common-mistakes',
          title: '긴 컨텍스트 로컬 LLM 사용 시 흔한 실수',
          items: [
        ...
        sources: {
          ...
          title: '출처',
          items: [
            '[중간 소실: 언어 모델이 긴 컨텍스트를 사용하는 방법](https://arxiv.org/abs/2307.03172) -- Liu et al., 2023',
            '[Ollama 컨텍스트 길이 설정](https://github.com/ollama/ollama/blob/main/docs/modelfile.md) -- Ollama 문서',
            '[Llama 3.3 기술 보고서](https://ai.meta.com/research/publications/the-llama-3-herd-of-models/) -- Meta AI, 2024',
            '[EU AI Act 공식 텍스트](https://artificialintelligenceact.eu) -- 유럽 의회, 2024',
          ],
        },
      },
      gammaEmbedUrl: '/presentations/long-context-local-llms-static.html',
      gammaDescription: '아래 슬라이드 덱은 다음 내용을 다룹니다: 128K 컨텍스트 창 모델 비교(Llama 3.3, Qwen3, Mistral Small 3.1), 4K/32K/128K 컨텍스트 길이에서의 RAM 사용량, "중간 소실" 효과와 실용적 안정 한계(7B 모델에서 약 32K), Ollama에서 num_ctx 설정 방법. 긴 컨텍스트 로컬 LLM 참조 카드로 PDF를 다운로드하십시오.',
    },
  };
