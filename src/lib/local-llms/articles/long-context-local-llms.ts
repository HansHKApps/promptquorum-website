...
schema: {
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 5, 'name': 'Llama 3.1 8B',               'description': '128K tokens context. ~32K practical. 14 GB RAM at 128K Q4_K_M. ollama run llama3.1:8b' },
          ...
          { '@type': 'ListItem', 'position': 12, 'name': 'Mistral 7B v0.3',           'description': '32K tokens context. ~16K practical. 4.5 GB RAM. ollama run mistral' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'As of May 2026: Llama 4 Scout supports 10M tokens (practical: 256K-1M on sufficient hardware). DeepSeek V4-Flash and Qwen 3.6 support 1M and 256K tokens respectively (Qwen 3.6 extendable to 1M via YaRN). Earlier models: Qwen3, Llama 3.1, Qwen2.5, and Mistral Small support 128K tokens. Ollama defaults to 2048 tokens -- set num_ctx explicitly in a Modelfile to access long contexts.',
            },
          },
          {
            '@type': 'Question',
      ...
      sections: {
        ...
        which128k: {
          ...
          rows: [
            { 'Model': 'Llama 3.1 8B', 'Context Window': '128K', 'Practical Limit': '~32K reliable', 'Ollama Command': 'ollama run llama3.2' },
            ...
            { 'Model': 'Mistral 7B v0.3', 'Context Window': '32K', 'Practical Limit': '~16K reliable', 'Ollama Command': 'ollama run llama3.2' },
          ],
        ...
        sources: {
          ...
          items: [
            ...
            '[Llama 3.1 Technical Report](https://ai.meta.com/research/publications/the-llama-3-herd-of-models/) -- Meta AI, 2024',
    ...
    es: {
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 5, 'name': 'Llama 3.1 8B',               'description': '128K tokens de contexto. ~32K práctico. 14 GB de RAM con 128K Q4_K_M. ollama run llama3.1:8b' },
          ...
          { '@type': 'ListItem', 'position': 12, 'name': 'Mistral 7B v0.3',           'description': '32K tokens de contexto. ~16K práctico. 4.5 GB de RAM. ollama run mistral' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
      ...
      sections: {
        ...
        which128k: {
          ...
          rows: [
            { 'Modelo': 'Llama 3.1 8B', 'Ventana de contexto': '128K', 'Límite práctico': '~32K fiable', 'Comando Ollama': 'ollama run llama3.2' },
      ...
      gammaEmbedUrl: '/presentations/long-context-local-llms-static.html',
      gammaDescription: 'El deck de diapositivas cubre: comparación de modelos con ventana de contexto de 128K (Llama 3.1, Qwen2.5, Mistral Small 3.1), uso de RAM en longitudes de contexto 4K/32K/128K, el efecto "lost in the middle" y los límites prácticos fiables (~32K para modelos 7B), y cómo configurar num_ctx en Ollama. Descarga el PDF como tarjeta de referencia de LLM local de contexto largo.',
    },
    zh: {
      theme: '最佳模型',
      ...
      sections: {
        ...
        which128k: {
          ...
          rows: [
            { '模型': 'Llama 3.1 8B', '上下文窗口': '128K', '实际上限': '约32K可靠', 'Ollama命令': 'ollama run llama3.2' },
            ...
            { '模型': 'Mistral 7B v0.3', '上下文窗口': '32K', '实际上限': '约16K可靠', 'Ollama命令': 'ollama run llama3.2' },
          ],
...
schema: {
      ...
      itemListSchema: {
        ...
        'numberOfItems': 8,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'Llama 3.1 8B',          'description': '128K上下文。实际上限32K。ollama run llama3.2' },
    ...
    de: {
      ...
      sections: {
        ...
        which128k: { id: 'models-128k', title: 'Welche lokalen LLMs unterstützen 128K-Token-Kontext im Jahr 2026?', rows: [{ 'Modell': 'Llama 3.1 8B', 'Kontextfenster': '128K', 'Praktisches Limit': '~32K zuverlässig', 'Ollama-Befehl': 'ollama run llama3.2' }, { 'Modell': 'Llama 3.2 3B', 'Kontextfenster': '128K', 'Praktisches Limit': '~16K zuverlässig', 'Ollama-Befehl': 'ollama run llama3.2:3b' }, { 'Modell': 'Llama 3.3 70B', 'Kontextfenster': '128K', 'Praktisches Limit': '~64K zuverlässig', 'Ollama-Befehl': 'ollama run llama3.3:70b' }, { 'Modell': 'Qwen2.5 7B', 'Kontextfenster': '128K', 'Praktisches Limit': '~32K zuverlässig', 'Ollama-Befehl': 'ollama run qwen2.5:7b' }, { 'Modell': 'Qwen2.5 72B', 'Kontextfenster': '128K', 'Praktisches Limit': '~64K zuverlässig', 'Ollama-Befehl': 'ollama run qwen2.5:72b' }, { 'Modell': 'Mistral Small 3.1 24B', 'Kontextfenster': '128K', 'Praktisches Limit': '~32K zuverlässig', 'Ollama-Befehl': 'ollama run mistral-small3.1' }, { 'Modell': 'Gemma 2 2B', 'Kontextfenster': '8K', 'Praktisches Limit': '~6K zuverlässig', 'Ollama-Befehl': 'ollama run gemma2:2b' }, { 'Modell': 'Mistral 7B v0.3', 'Kontextfenster': '32K', 'Praktisches Limit': '~16K zuverlässig', 'Ollama-Befehl': 'ollama run llama3.2' }], columns: ['Modell', 'Kontextfenster', 'Praktisches Limit', 'Ollama-Befehl'], image: '/images/long-context-models-comparison-en.svg', imageCaption: '6 lokale LLM-Modelle mit 128K-Kontextunterstützung -- praktisches Zuverlässigkeitslimit 32K für 7B-Modelle, 64K für 70B-Modelle.' },
        ramForLongContext: { id: 'ram-long-context', title: 'Wie viel RAM benötigt die Verarbeitung langer Kontexte?', content: ['**Der RAM-Verbrauch skaliert sowohl mit Modellgröße als auch Kontextlänge.** Der KV-Cache speichert Attention-Zustände für alle verarbeiteten Token -- dieser wächst linear mit der Kontextlänge.', 'Ein 7B-Modell bei Q4_K_M mit 4K-Kontext benötigt ~6 GB RAM. Dasselbe Modell mit 32K-Kontext benötigt ~8-9 GB RAM. Bei 128K-Kontext: ~12-16 GB RAM.'], rows: [{ 'Modell': 'Llama 3.1 8B Q4_K_M', '4K-Kontext': '~6 GB', '32K-Kontext': '~9 GB', '128K-Kontext': '~14 GB' }, { 'Modell': 'Qwen2.5 14B Q4_K_M', '4K-Kontext': '~9 GB', '32K-Kontext': '~12 GB', '128K-Kontext': '~18 GB' }, { 'Modell': 'Mistral Small 3.1 24B Q4_K_M', '4K-Kontext': '~14 GB', '32K-Kontext': '~17 GB', '128K-Kontext': '~24 GB' }, { 'Modell': 'Llama 3.3 70B Q4_K_M', '4K-Kontext': '~40 GB', '32K-Kontext': '~45 GB', '128K-Kontext': '~55 GB' }], columns: ['Modell', '4K-Kontext', '32K-Kontext', '128K-Kontext'], image: '/images/long-context-ram-scaling-en.svg', imageCaption: 'KV-Cache-RAM skaliert mit Kontextlänge -- ein 7B-Modell bei Q4_K_M benötigt ~6 GB bei 4K, aber ~14 GB bei 128K-Kontext.' },
        ...
        sources: { id: 'sources', title: 'Quellen', items: ['[Lost in the Middle: How Language Models Use Long Contexts](https://arxiv.org/abs/2307.03172) -- Liu et al., 2023', '[Ollama Context Length Configuration](https://github.com/ollama/ollama/blob/main/docs/modelfile.md) -- Ollama-Dokumentation', '[Llama 3.1 Technical Report](https://ai.meta.com/research/publications/the-llama-3-herd-of-models/) -- Meta AI, 2024', '[EU AI Act Official Text](https://artificialintelligenceact.eu) -- Europäisches Parlament, 2024'] },
      },
      gammaEmbedUrl: '/presentations/long-context-local-llms-static.html',
    ...
    fr: {
      ...
      sections: {
        ...
        which128k: { id: 'models-128k', title: 'Quels LLMs locaux supportent 128K tokens de contexte en 2026 ?', rows: [{ 'Modèle': 'Llama 3.1 8B', 'Fenêtre de contexte': '128K', 'Limite pratique': '~32K fiable', 'Commande Ollama': 'ollama run llama3.2' }, { 'Modèle': 'Llama 3.2 3B', 'Fenêtre de contexte': '128K', 'Limite pratique': '~16K fiable', 'Commande Ollama': 'ollama run llama3.2:3b' }, { 'Modèle': 'Llama 3.3 70B', 'Fenêtre de contexte': '128K', 'Limite pratique': '~64K fiable', 'Commande Ollama': 'ollama run llama3.3:70b' }, { 'Modèle': 'Qwen2.5 7B', 'Fenêtre de contexte': '128K', 'Limite pratique': '~32K fiable', 'Commande Ollama': 'ollama run qwen2.5:7b' }, { 'Modèle': 'Qwen2.5 72B', 'Fenêtre de contexte': '128K', 'Limite pratique': '~64K fiable', 'Commande Ollama': 'ollama run qwen2.5:72b' }, { 'Modèle': 'Mistral Small 3.1 24B', 'Fenêtre de contexte': '128K', 'Limite pratique': '~32K fiable', 'Commande Ollama': 'ollama run mistral-small3.1' }, { 'Modèle': 'Gemma 2 2B', 'Fenêtre de contexte': '8K', 'Limite pratique': '~6K fiable', 'Commande Ollama': 'ollama run gemma2:2b' }, { 'Modèle': 'Mistral 7B v0.3', 'Fenêtre de contexte': '32K', 'Limite pratique': '~16K fiable', 'Commande Ollama': 'ollama run llama3.2' }], columns: ['Modèle', 'Fenêtre de contexte', 'Limite pratique', 'Commande Ollama'], image: '/images/long-context-models-comparison-en.svg', imageCaption: '6 modèles LLM locaux avec support de contexte 128K -- limite fiable pratique de 32K pour les 7B, 64K pour les 70B.' },
        ramForLongContext: { id: 'ram-long-context', title: 'Combien de RAM le traitement de long contexte nécessite-t-il ?', content: ['**L\'utilisation RAM évolue avec la taille du modèle et la longueur du contexte.** Le cache KV stocke les états d\'attention pour tous les tokens traités -- il croît linéairement avec la longueur du contexte.', 'Un modèle 7B en Q4_K_M avec contexte 4K utilise ~6 Go de RAM. Le même modèle avec contexte 32K utilise ~8-9 Go. Avec contexte 128K : ~12-16 Go.'], rows: [{ 'Modèle': 'Llama 3.1 8B Q4_K_M', 'Contexte 4K': '~6 Go', 'Contexte 32K': '~9 Go', 'Contexte 128K': '~14 Go' }, { 'Modèle': 'Qwen2.5 14B Q4_K_M', 'Contexte 4K': '~9 Go', 'Contexte 32K': '~12 Go', 'Contexte 128K': '~18 Go' }, { 'Modèle': 'Mistral Small 3.1 24B Q4_K_M', 'Contexte 4K': '~14 Go', 'Contexte 32K': '~17 Go', 'Contexte 128K': '~24 Go' }, { 'Modèle': 'Llama 3.3 70B Q4_K_M', 'Contexte 4K': '~40 Go', 'Contexte 32K': '~45 Go', 'Contexte 128K': '~55 Go' }], columns: ['Modèle', 'Contexte 4K', 'Contexte 32K', 'Contexte 128K'], image: '/images/long-context-ram-scaling-en.svg', imageCaption: 'La RAM du cache KV évolue avec la longueur du contexte -- un modèle 7B en Q4_K_M nécessite ~6 Go à 4K, mais ~14 Go à 128K.' },
        ...
        sources: { id: 'sources', title: 'Sources', items: ['[Lost in the Middle: How Language Models Use Long Contexts](https://arxiv.org/abs/2307.03172) -- Liu et al., 2023', '[Ollama Context Length Configuration](https://github.com/ollama/ollama/blob/main/docs/modelfile.md) -- Documentation Ollama', '[Llama 3.1 Technical Report](https://ai.meta.com/research/publications/the-llama-3-herd-of-models/) -- Meta AI, 2024', '[Texte officiel de la Loi IA UE](https://artificialintelligenceact.eu) -- Parlement européen, 2024'] },
      },
      gammaEmbedUrl: '/presentations/long-context-local-llms-static.html',
    ...
    ja: {
      ...
      sections: {
        ...
        which128k: { id: 'models-128k', title: '2026年に128KトークンのコンテキストをサポートするローカルLLMは？', rows: [{ 'モデル': 'Llama 3.1 8B', 'コンテキストウィンドウ': '128K', '実用的な上限': '~32K 信頼性あり', 'Ollamaコマンド': 'ollama run llama3.2' }, { 'モデル': 'Llama 3.2 3B', 'コンテキストウィンドウ': '128K', '実用的な上限': '~16K 信頼性あり', 'Ollamaコマンド': 'ollama run llama3.2:3b' }, { 'モデル': 'Llama 3.3 70B', 'コンテキストウィンドウ': '128K', '実用的な上限': '~64K 信頼性あり', 'Ollamaコマンド': 'ollama run llama3.3:70b' }, { 'モデル': 'Qwen2.5 7B', 'コンテキストウィンドウ': '128K', '実用的な上限': '~32K 信頼性あり', 'Ollamaコマンド': 'ollama run qwen2.5:7b' }, { 'モデル': 'Qwen2.5 72B', 'コンテキストウィンドウ': '128K', '実用的な上限': '~64K 信頼性あり', 'Ollamaコマンド': 'ollama run qwen2.5:72b' }, { 'モデル': 'Mistral Small 3.1 24B', 'コンテキストウィンドウ': '128K', '実用的な上限': '~32K 信頼性あり', 'Ollamaコマンド': 'ollama run mistral-small3.1' }, { 'モデル': 'Gemma 2 2B', 'コンテキストウィンドウ': '8K', '実用的な上限': '~6K 信頼性あり', 'Ollamaコマンド': 'ollama run gemma2:2b' }, { 'モデル': 'Mistral 7B v0.3', 'コンテキストウィンドウ': '32K', '実用的な上限': '~16K 信頼性あり', 'Ollamaコマンド': 'ollama run llama3.2' }], columns: ['モデル', 'コンテキストウィンドウ', '実用的な上限', 'Ollamaコマンド'], image: '/images/long-context-models-comparison-en.svg', imageCaption: '128Kコンテキストをサポートする6つのローカルLLM。7Bモデルで32K、70Bモデルで64Kが実用的な信頼性の上限。' },
        ramForLongContext: { id: 'ram-long-context', title: '長いコンテキストの処理にはどれくらいのRAMが必要か？', content: ['**RAMの使用量はモデルサイズとコンテキスト長の両方に比例して増加します。** KVキャッシュはすべての処理済みトークンのAttention状態を格納し、コンテキスト長に線形に増加します。', 'Q4_K_Mの7Bモデルで4Kコンテキストは~6 GB RAMを使用。同じモデルで32Kコンテキストは~8-9 GB。128Kコンテキストでは~12-16 GB。'], rows: [{ 'モデル': 'Llama 3.1 8B Q4_K_M', '4Kコンテキスト': '~6 GB', '32Kコンテキスト': '~9 GB', '128Kコンテキスト': '~14 GB' }, { 'モデル': 'Qwen2.5 14B Q4_K_M', '4Kコンテキスト': '~9 GB', '32Kコンテキスト': '~12 GB', '128Kコンテキスト': '~18 GB' }, { 'モデル': 'Mistral Small 3.1 24B Q4_K_M', '4Kコンテキスト': '~14 GB', '32Kコンテキスト': '~17 GB', '128Kコンテキスト': '~24 GB' }, { 'モデル': 'Llama 3.3 70B Q4_K_M', '4Kコンテキスト': '~40 GB', '32Kコンテキスト': '~45 GB', '128Kコンテキスト': '~55 GB' }], columns: ['モデル', '4Kコンテキスト', '32Kコンテキスト', '128Kコンテキスト'], image: '/images/long-context-ram-scaling-en.svg', imageCaption: 'KVキャッシュのRAMはコンテキスト長とともに増加。Q4_K_Mの7Bモデルは4Kで~6 GB、128Kで~14 GB必要。' },
        ...
        sources: { id: 'sources', title: '出典', items: ['[Lost in the Middle: How Language Models Use Long Contexts](https://arxiv.org/abs/2307.03172) -- Liu et al., 2023', '[Ollama Context Length Configuration](https://github.com/ollama/ollama/blob/main/docs/modelfile.md) -- Ollamaドキュメント', '[Llama 3.1 Technical Report](https://ai.meta.com/research/publications/the-llama-3-herd-of-models/) -- Meta AI, 2024', '[EU AI Act Official Text](https://artificialintelligenceact.eu) -- 欧州議会、2024年'] },
      },
      gammaEmbedUrl: '/presentations/long-context-local-llms-static.html',
