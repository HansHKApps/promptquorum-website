      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'As of June 2026: Qwen3 (all sizes 4B–30B), Gemma 3 (4B/12B/27B), Llama 3.1 (8B/70B), and Mistral Small 3.1 (24B) all support 128K tokens natively. Qwen3 14B Q4_K_M is the recommended choice for 16 GB machines. Ollama defaults to 2048 tokens -- set num_ctx explicitly in a Modelfile to access long contexts.',
            },
          },
          {
            '@type': 'Question',
...
schema: {
    ...
    de: {
      ...
      sections: {
        ...
        ramForLongContext: { id: 'ram-long-context', title: 'Wie viel RAM benötigt die Verarbeitung langer Kontexte?', content: ['**Der RAM-Verbrauch skaliert sowohl mit Modellgröße als auch Kontextlänge.** Der KV-Cache speichert Attention-Zustände für alle verarbeiteten Token -- dieser wächst linear mit der Kontextlänge.', 'Ein 7B-Modell bei Q4_K_M mit 4K-Kontext benötigt ~6 GB RAM. Dasselbe Modell mit 32K-Kontext benötigt ~8-9 GB RAM. Bei 128K-Kontext: ~12-16 GB RAM.'], rows: [{ 'Modell': 'Llama 3.3 8B Q4_K_M', '4K-Kontext': '~6 GB', '32K-Kontext': '~9 GB', '128K-Kontext': '~14 GB' }, { 'Modell': 'Qwen3 14B Q4_K_M', '4K-Kontext': '~9 GB', '32K-Kontext': '~12 GB', '128K-Kontext': '~18 GB' }, { 'Modell': 'Mistral Small 3.1 24B Q4_K_M', '4K-Kontext': '~14 GB', '32K-Kontext': '~17 GB', '128K-Kontext': '~24 GB' }, { 'Modell': 'Llama 3.3 70B Q4_K_M', '4K-Kontext': '~40 GB', '32K-Kontext': '~45 GB', '128K-Kontext': '~55 GB' }], columns: ['Modell', '4K-Kontext', '32K-Kontext', '128K-Kontext'], image: '/images/long-context-local-llms-ram-scaling-hero-de.webp', imageCaption: 'KV-Cache-RAM skaliert mit Kontextlänge -- ein 7B-Modell bei Q4_K_M benötigt ~6 GB bei 4K, aber ~14 GB bei 128K-Kontext.' },
    ...
    fr: {
      ...
      sections: {
        ...
        ramForLongContext: { id: 'ram-long-context', title: 'Combien de RAM le traitement de long contexte nécessite-t-il ?', content: ['**L\'utilisation RAM évolue avec la taille du modèle et la longueur du contexte.** Le cache KV stocke les états d\'attention pour tous les tokens traités -- il croît linéairement avec la longueur du contexte.', 'Un modèle 7B en Q4_K_M avec contexte 4K utilise ~6 Go de RAM. Le même modèle avec contexte 32K utilise ~8-9 Go. Avec contexte 128K : ~12-16 Go.'], rows: [{ 'Modèle': 'Llama 3.3 8B Q4_K_M', 'Contexte 4K': '~6 Go', 'Contexte 32K': '~9 Go', 'Contexte 128K': '~14 Go' }, { 'Modèle': 'Qwen3 14B Q4_K_M', 'Contexte 4K': '~9 Go', 'Contexte 32K': '~12 Go', 'Contexte 128K': '~18 Go' }, { 'Modèle': 'Mistral Small 3.1 24B Q4_K_M', 'Contexte 4K': '~14 Go', 'Contexte 32K': '~17 Go', 'Contexte 128K': '~24 Go' }, { 'Modèle': 'Llama 3.3 70B Q4_K_M', 'Contexte 4K': '~40 Go', 'Contexte 32K': '~45 Go', 'Contexte 128K': '~55 Go' }], columns: ['Modèle', 'Contexte 4K', 'Contexte 32K', 'Contexte 128K'], image: '/images/long-context-local-llms-ram-scaling-hero-fr.webp', imageCaption: 'La RAM du cache KV évolue avec la longueur du contexte -- un modèle 7B en Q4_K_M nécessite ~6 Go à 4K, mais ~14 Go à 128K.' },
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': '16GB RAM에서 Q4_K_M의 Mistral Small 3.1 24B로 32K 컨텍스트를 사용하면 약 17GB가 필요하여 16GB를 초과합니다. Q4_K_M의 Llama 3.3 8B로 32K 컨텍스트(약 9GB) 또는 128K 컨텍스트(약 14GB)를 사용하면 여유 있게 실행됩니다. Modelfile에서 num_ctx를 설정하십시오: PARAMETER num_ctx 32768.',
            },
          },
        ],
      },
