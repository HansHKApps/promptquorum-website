...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      seoTitle: 'Long Context Local LLMs 2026: 6 Models, 128K to 1M Tokens',
      ...
      metaDescription: '6 local LLMs ranked by context: Llama 4 Scout (10M), DeepSeek V4-Flash (1M), Qwen 3.6 (256K) and 128K models. RAM per tier (14-55 GB) plus the num_ctx fix.',
...
schema: {
    ...
    es: {
      ...
      seoTitle: 'LLM locales contexto largo 2026: 6 modelos, 128K a 1M',
      ...
      metaDescription: '6 LLM locales por contexto: Llama 4 Scout (10M), DeepSeek V4-Flash (1M), Qwen 3.6 (256K) y modelos de 128K. RAM por nivel (14-55 GB) y el ajuste num_ctx.',
      publishDate: '2026-04-04',
    ...
    ar: {
      ...
      metaDescription: '6 نماذج LLM محلية حسب السياق: Llama 4 Scout (10M) وDeepSeek V4-Flash (1M) وQwen 3.6 (256K) ونماذج 128K. متطلبات RAM لكل مستوى (14-55 GB) وضبط num_ctx.',
      publishDate: '2026-04-04',
