      ...
      sections: {
        ...
        byCategory: {
          ...
          items: [
            ...
            '**Coding (best, 24B)**: `ollama run devstral-small:24b` -- Best agentic coding model (multi-file edits, debugging). 16 GB RAM. By Mistral AI.',
            '**Coding (frontier, MoE)**: `ollama run kimi-k2.6` -- 87/100 real-world coding. MoE (42B active/1T total). MIT license. Needs quantization for consumer hardware.',
            '**Coding (dense, best)**: `ollama run qwen3.6:27b` -- 77.2% SWE-bench. Best dense coding model. 22 GB VRAM.',
...
schema: {
    ...
    de: {
      theme: 'Beste Modelle',
      title: 'Die besten Open-Source-Modelle auf Ollama Mai 2026: Neue Releases, Benchmarks und Pull-Befehle',
      seoTitle: "Beste Ollama-Modelle Mai 2026: Top 10 + Kimi K2.6, Qwen 3.6",
      ...
      metaDescription: "Beste Ollama-Modelle Mai 2026: llama4:scout (Chat, MoE), qwen3.6:27b (Code, 77,2% SWE-bench), kimi-k2.6 (Top Coding), deepseek-r1:7b (Reasoning). Neu im Mai.",
      ...
      sections: {
        ...
        byCategory: {
          ...
          items: [
            ...
            '**Codierung (32B)**: `ollama run qwen2.5-coder:32b` -- 92,7% HumanEval. Bestes Single-GPU Coding-Modell 2026. Benötigt 20 GB RAM bei Q4_K_M.',
            '**Codierung (bestes, 24B)**: `ollama run devstral-small:24b` -- Bestes Agentic Coding-Modell (Multi-Datei-Edits, Debugging). 16 GB RAM. Von Mistral AI.',
            '**Codierung (Frontier, MoE)**: `ollama run kimi-k2.6` -- 87/100 Real-World-Codierung. MoE (42B aktiv/1T gesamt). MIT-Lizenz. Benötigt Quantisierung für Consumer-Hardware.',
            '**Codierung (dicht, bestes)**: `ollama run qwen3.6:27b` -- 77,2% SWE-bench. Bestes dichtes Coding-Modell. 22 GB VRAM.',
...
schema: {
    ...
    fr: {
      ...
      title: 'Les meilleurs modèles open source sur Ollama mai 2026 : Nouvelles sorties, benchmarks et commandes',
      seoTitle: "Meilleurs modèles Ollama mai 2026 : Top 10 + Kimi K2.6, Qwen 3.6",
      ...
      metaDescription: "Meilleurs modèles Ollama mai 2026 : llama4:scout (chat, MoE), qwen3.6:27b (code, 77,2% SWE-bench), kimi-k2.6 (Top Coding), deepseek-r1:7b (raisonnement). Nouveau mai.",
      publishDate: '2026-04-11',
      ...
      sections: {
        ...
        byCategory: {
          ...
          items: [
            ...
            '**Codage (32B)** : `ollama run qwen2.5-coder:32b` -- 92,7% HumanEval. Meilleur modèle de codage single-GPU en 2026. Nécessite 20 Go RAM à Q4_K_M.',
            '**Codage (meilleur, 24B)** : `ollama run devstral-small:24b` -- Meilleur modèle de codage agentique (éditions multi-fichiers, débogage). 16 Go RAM. Par Mistral AI.',
            '**Codage (frontière, MoE)** : `ollama run kimi-k2.6` -- 87/100 codage réel. MoE (42B actif/1T au total). Licence MIT.',
            '**Codage (dense, meilleur)** : `ollama run qwen3.6:27b` -- 77,2% SWE-bench. Meilleur modèle de codage dense. 22 Go VRAM.',
...
schema: {
    ...
    ja: {
      theme: 'ベストモデル',
      title: '2026年5月Ollama最高のオープンソースモデル：Llama 4 Scout、Kimi K2.6、Qwen 3.6',
      seoTitle: "Ollamaおすすめモデル2026年5月：Llama 4 Scout + Kimi K2.6 + Qwen 3.6",
      ...
      metaDescription: "2026年5月Ollamaベストモデル：llama4:scout（チャット、MoE）、qwen3.6:27b（コーディング、77.2% SWE-bench）、kimi-k2.6（Top Coding）、deepseek-r1:7b（推論）。新5月。",
      publishDate: '2026-04-11',
      readTime: '9分で読める',
      ...
      sections: {
        ...
        byCategory: {
          ...
          items: [
            ...
            '**コード（32B）**：`ollama run qwen2.5-coder:32b` -- 92.7% HumanEval。2026年最高Single-GPUコーディングモデル。Q4_K_Mで20GB RAM必要。',
            '**コード（最高、24B）**：`ollama run devstral-small:24b` -- 最高エージェントコーディング（マルチファイル編集、デバッグ）。16GB RAM。Mistral AI製。',
            '**コード（フロンティア、MoE）**：`ollama run kimi-k2.6` -- 87/100実践コーディング。MoE（42B活性/1T合計）。MIT License。',
            '**コード（密集、最高）**：`ollama run qwen3.6:27b` -- 77.2% SWE-bench。最高密集コーディングモデル。22GB VRAM。',
...
schema: {
    ...
    zh: {
      theme: '最佳模型',
      title: '2026年5月Ollama最佳开源模型：Llama 4 Scout、Kimi K2.6、Qwen 3.6',
      seoTitle: "Ollama最佳模型2026年5月：Llama 4 Scout + Kimi K2.6 + Qwen 3.6",
      ...
      metaDescription: "2026年5月Ollama最佳模型：llama4:scout（对话、MoE）、qwen3.6:27b（编程、77.2% SWE-bench）、kimi-k2.6（顶级编程）、deepseek-r1:7b（推理）。新5月。",
      publishDate: '2026-04-11',
      readTime: '阅读约9分钟',
      educationalLevel: 'Beginner',
      ...
      sections: {
        ...
        byCategory: {
          ...
          items: [
            ...
            '**编程（32B）**：`ollama run qwen2.5-coder:32b` -- 92.7% HumanEval。2026年最佳单GPU编码模型。Q4_K_M需20GB显存。',
            '**编程（最优，24B）**：`ollama run devstral-small:24b` -- 最优代理编程（多文件编辑、调试）。16GB RAM。Mistral AI出品。',
            '**编程（前沿、MoE）**：`ollama run kimi-k2.6` -- 87/100实战编程。MoE（42B活跃/1T总数）。MIT许可。',
            '**编程（密集、最优）**：`ollama run qwen3.6:27b` -- 77.2% SWE-bench。最优密集编程模型。22GB显存。',
