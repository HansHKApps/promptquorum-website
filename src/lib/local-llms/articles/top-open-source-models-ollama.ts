...
schema: {
  ...
  ar: {
      ...
      current_benchmarks_used: ['SWE-bench', 'SWE-Bench Pro', 'HumanEval', 'MATH'],
      theme: 'Best Models',
      title: 'تحديث Ollama يونيو 2026: أحدث إصدار + أحدث النماذج (مرتبة)',
      seoTitle: 'أولاما يونيو 2026: أحدث إصدار وأفضل النماذج',
      ...
      metaDescription: 'تحديث يونيو 2026: أحدث إصدار Ollama هو v0.30.8. أحدث النماذج: MiniMax M3 وKimi K2.6 وQwen 3.6 وDeepSeek V4. معايير موثقة وأوامر pull.',
      publishDate: '2026-04-04',
