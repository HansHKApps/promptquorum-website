...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      quickAnswerTop: {
        en: {
          ...
          bullets: [
            ...
            '→Qwen 3.6 27B — best dense coding model, 77.2% SWE-bench, 22 GB VRAM',
            '→Devstral Small 24B — best agentic coding (multi-file edits), 16 GB RAM',
        ...
        de: {
          ...
          answer: 'Die besten Ollama-Modelle Mai 2026: Llama 4 Scout (bestes Gesamtmodell), Kimi K2.6 (best Coding), Qwen 3.6 27B (bestes dichtes Coding), Devstral Small 24B (best agentic coding), Mistral 7B (Geschwindigkeit), Phi-4 Mini (wenig VRAM). Installation: ollama pull <modell-name>',
          bullets: [
            '→Llama 4 Scout 17B — beste Gesamtqualitaet, MoE-Architektur, ca. 10 GB VRAM',
            '→Kimi K2.6 — bestes Coding-Modell (87/100 real-world), MoE (42B aktiv/1T gesamt), MIT-Lizenz',
            '→Qwen 3.6 27B — bestes dichtes Coding-Modell, 77,2% SWE-bench, 22 GB VRAM',
            '→Devstral Small 24B — best agentic coding (Multi-Datei-Edits), 16 GB RAM',
        ...
        fr: {
          ...
          answer: 'Les meilleurs modeles Ollama mai 2026: Llama 4 Scout (meilleur global), Kimi K2.6 (meilleur code), Qwen 3.6 27B (meilleur code dense), Devstral Small 24B (meilleur code agentique), Mistral 7B (rapidite), Phi-4 Mini (faible VRAM). Installation: ollama pull <nom-du-modele>',
          bullets: [
            '→Llama 4 Scout 17B — meilleure qualite, architecture MoE, ~10 Go VRAM',
            '→Kimi K2.6 — meilleur code (87/100 reel), MoE (42B actif/1T total), MIT',
            '→Qwen 3.6 27B — meilleur code dense, 77,2% SWE-bench, 22 Go VRAM',
            '→Devstral Small 24B — meilleur code agentique (multi-fichiers), 16 Go RAM',
        ...
        ja: {
          ...
          answer: '2026年5月トップモデル：Llama 4 Scout（総合最高）、Kimi K2.6（コーディング最強）、Qwen 3.6 27B（最高密度コード）、Devstral Small 24B（エージェント最強）、Mistral 7B（高速）、Phi-4 Mini（低VRAM）。インストール：ollama pull <モデル名>',
          bullets: [
            '→Llama 4 Scout 17B — 総合最高、MoEアーキテクチャ、約10GB VRAM',
            '→Kimi K2.6 — コーディング最強（87/100 実践），MoE（42B活性/1T合計）、MIT',
            '→Qwen 3.6 27B — 最高密度コード、77.2% SWE-bench、22GB VRAM',
            '→Devstral Small 24B — エージェント最強（複数ファイル編集）、16GB RAM',
        ...
        zh: {
          ...
          answer: '2026年5月Ollama最佳模型：Llama 4 Scout（综合最佳）、Kimi K2.6（编程最强）、Qwen 3.6 27B（最佳密集编程）、Devstral Small 24B（智能体最强）、Mistral 7B（速度）、Phi-4 Mini（低显存）。安装：ollama pull <模型名称>',
          bullets: [
            '→Llama 4 Scout 17B — 综合最佳，MoE架构，约10GB显存',
            '→Kimi K2.6 — 编程最强（87/100实战），MoE（42B活跃/1T总）、MIT',
            '→Qwen 3.6 27B — 最佳密集编程，77.2% SWE-bench，22GB显存',
            '→Devstral Small 24B — 智能体最强（多文件编辑），16GB内存',
            '→Mistral 7B — 8GB显存最快',
            '→Phi-4 Mini — 4GB显存可运行',
          ],
          updatedDate: '2026-05-17',
      ...
      toc: [
        ...
        { label: 'New in May 2026', anchor: '#new-may-2026' },
      ...
      sections: {
        ...
        whatsNew: {
          ...
          items: [
            '**Kimi K2.6** (Moonshot AI, May 2026) — First non-Western model to reach Tier A in coding benchmarks (87/100 real-world). MoE architecture (42B active / 1T total). MIT license. Pull: `ollama pull kimi-k2.6`',
            '**Qwen 3.6 27B** (Alibaba, May 2026) — Best dense coding model with 77.2% SWE-bench. 22 GB VRAM required. Pull: `ollama pull qwen3.6:27b`',
            '**GLM-5.1** (Zhipu AI, May 2026) — Structured code generation leader on SWE-Bench Pro. Pull: `ollama pull glm-5.1`',
            '**Gemma 4** (Google, April 2, 2026) — First vision + tool calling combination. Vision support for image understanding. 6 GB VRAM. Pull: `ollama pull gemma4:9b`',
          ],
        ...
        byCategory: {
          ...
          imageCaption: 'Ollama model selection by use case: 3 categories with 10 models. Pick llama4:scout for chat, qwen3.6:27b (77.2% SWE-bench) for coding, deepseek-r1:7b for math.',
        },
        newApril2026: {
          id: 'new-may-2026',
          title: 'New Ollama Models — May 2026 Releases',
          ...
          rows: [
            { 'Model': 'kimi-k2.6', 'Released': 'May 2026', 'Best For': 'Top-tier coding, MoE (42B/1T), MIT license', 'Ollama Command': 'ollama run kimi-k2.6' },
            { 'Model': 'qwen3.6:27b', 'Released': 'May 2026', 'Best For': 'Best dense coding model, 77.2% SWE-bench', 'Ollama Command': 'ollama run qwen3.6:27b' },
            { 'Model': 'glm-5.1', 'Released': 'May 2026', 'Best For': 'Structured code generation, SWE-Bench Pro leader', 'Ollama Command': 'ollama run glm-5.1' },
            ...
            { 'Model': 'qwen3:7b', 'Released': 'May 2026', 'Best For': 'HumanEval 76% at 7B, multilingual', 'Ollama Command': 'ollama run qwen3:7b' },
          ],
        ...
        visionModels: {
          ...
          rows: [
            ...
            { 'Model': 'gemma4:9b', 'RAM': '~6 GB', 'Image Support': 'Yes + Tool Calling ✓', 'Ollama Command': 'ollama run gemma4:9b' },
          ],
          columns: ['Model', 'RAM', 'Image Support', 'Ollama Command'],
          image: '/images/ollama-vision-models-comparison-en.svg',
          imageCaption: '5 Ollama vision models for image input. Gemma 4 9B (6 GB) now includes tool calling. Llama 3.2 Vision 11B (8 GB) for dedicated vision. All run locally.',
        },
        fullTop10: {
          ...
          rows: [
            ...
            { '#': '3', 'Model': 'Qwen3 8B', 'Best For': 'Updated, multilingual + coding', 'RAM': '5.5 GB', 'HumanEval': '76%' },
            { '#': '4', 'Model': 'Devstral Small 24B', 'Best For': 'Agentic coding (multi-file)', 'RAM': '16 GB', 'HumanEval': '80%' },
            ...
            { '#': '9', 'Model': 'gemma4:9b', 'Best For': 'Vision + tool calling', 'RAM': '6 GB', 'Notes': 'Agent-ready' },
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'For a general-purpose local chatbot: `llama4:scout` on 12 GB VRAM (best quality, MoE), or `llama3.2:3b` on 8 GB RAM (easiest entry point). For higher-quality use: `mistral-small3.1` on 16 GB RAM. For a coding assistant chatbot: `qwen3.6:27b` (best coding model, 77.2% SWE-bench) or `devstral-small:24b` (agentic coding). Pair with Open WebUI for a web-based interface that connects to Ollama\'s API at localhost:11434.',
            },
            {
              q: 'Are all Ollama models truly open source?',
              a: 'Not all. The Ollama library includes models with varying licences. Llama 3.x/4.x use the Meta Llama Community Licence (not OSI-approved open source -- restricts commercial use above 700M monthly active users). Mistral 7B, Qwen3, Qwen 3.6, Devstral, and Gemma models are Apache 2.0 (fully open source). Kimi K2.6 is MIT licensed (fully commercial-friendly). Always check the licence before commercial deployment.',
            },
            {
            ...
            },
            {
              ...
              a: 'The Ollama team adds new models within days to weeks of major releases. Kimi K2.6 and Qwen 3.6 appeared within days of their May 2026 releases. Ollama v0.22.1 (May 3, 2026) added Gemma 4 rendering improvements. Follow the Ollama GitHub repository (github.com/ollama/ollama) or the Ollama Twitter/X account for new model announcements.',
            },
            {
        ...
        sources: {
          ...
          items: [
            ...
            '[Moonshot AI. (2026). "Kimi K2.6 Model Card." moonshot.ai](https://moonshot.ai/) -- MIT-licensed MoE coding model (42B active/1T total), 87/100 real-world coding.',
...
schema: {
    ...
    es: {
      ...
      toc: [
        ...
        { label: 'Novedades de mayo de 2026', anchor: '#new-may-2026' },
      ...
      sections: {
        ...
        byCategory: {
          ...
          image: '/images/ollama-model-by-use-case-en.svg',
          imageCaption: 'Selección de modelos Ollama por caso de uso: 3 categorías con 10 modelos. Elige llama4:scout para chat, qwen3.6:27b (77,2% SWE-bench) para programación, deepseek-r1:7b para matemáticas.',
        },
        newApril2026: {
          id: 'new-may-2026',
          title: 'Nuevos modelos Ollama — Lanzamientos de mayo de 2026',
          ...
          rows: [
            { 'Modelo': 'kimi-k2.6', 'Lanzamiento': 'Mayo de 2026', 'Mejor para': 'Programación de primer nivel, MoE (42B/1T), licencia MIT', 'Comando Ollama': 'ollama run kimi-k2.6' },
            { 'Modelo': 'qwen3.6:27b', 'Lanzamiento': 'Mayo de 2026', 'Mejor para': 'Mejor modelo de programación denso, 77,2% SWE-bench', 'Comando Ollama': 'ollama run qwen3.6:27b' },
            { 'Modelo': 'glm-5.1', 'Lanzamiento': 'Mayo de 2026', 'Mejor para': 'Generación de código estructurado, líder SWE-Bench Pro', 'Comando Ollama': 'ollama run glm-5.1' },
            ...
            { 'Modelo': 'gemma4:9b', 'Lanzamiento': '2 de abril de 2026', 'Mejor para': 'Tareas de agentes, tool calling, visión', 'Comando Ollama': 'ollama run gemma4:9b' },
            { 'Modelo': 'qwen3:7b', 'Lanzamiento': 'Mayo de 2026', 'Mejor para': 'HumanEval 76% a 7B, multilingüe', 'Comando Ollama': 'ollama run qwen3:7b' },
          ],
        ...
        visionModels: {
          ...
          content: 'A partir de mayo de 2026, estos modelos en Ollama admiten entrada de imágenes (multimodal): Gemma 4 admite tanto visión COMO tool calling — único entre los modelos de visión en Ollama.',
          rows: [
            { 'Modelo': 'llama3.2-vision:11b', 'RAM': '~8 GB', 'Soporte de imágenes': 'Sí', 'Comando Ollama': 'ollama run llama3.2-vision:11b' },
            { 'Modelo': 'llama3.2-vision:90b', 'RAM': '~55 GB', 'Soporte de imágenes': 'Sí', 'Comando Ollama': 'ollama run llama3.2-vision:90b' },
            { 'Modelo': 'gemma3:9b (vision)', 'RAM': '~6 GB', 'Soporte de imágenes': 'Sí', 'Comando Ollama': 'ollama run gemma3:9b' },
            { 'Modelo': 'minicpm-v:8b', 'RAM': '~5,5 GB', 'Soporte de imágenes': 'Sí', 'Comando Ollama': 'ollama run minicpm-v' },
            { 'Modelo': 'gemma4:9b', 'RAM': '~6 GB', 'Soporte de imágenes': 'Sí + Tool Calling ✓', 'Comando Ollama': 'ollama run gemma4:9b' },
          ],
          columns: ['Modelo', 'RAM', 'Soporte de imágenes', 'Comando Ollama'],
          image: '/images/ollama-vision-models-comparison-en.svg',
          imageCaption: '5 modelos de visión de Ollama para entrada de imágenes. Gemma 4 9B (6 GB) ahora incluye tool calling. Llama 3.2 Vision 11B (8 GB) para visión dedicada. Todos locales.',
        },
        fullTop10: {
          id: 'full-top-10-comparison',
          title: '¿Cuáles son los 10 mejores modelos de código abierto en Ollama?',
          content: 'Los recuentos de descargas siguen favoreciendo a Llama 3.x y Qwen 2.5 por la prevalencia de tutoriales. Para nuevos proyectos en mayo de 2026, prefiere Llama 4 Scout, Qwen3 y Gemma 4.',
          rows: [
            { '#': '1', 'Modelo': 'Llama 3.2 3B', 'Mejor para': 'Primer modelo, chat general', 'RAM': '2,5 GB', 'HumanEval': '60%' },
            { '#': '2', 'Modelo': 'Llama 4 Scout 17B', 'Mejor para': 'Mejor calidad general, MoE', 'RAM': '~10 GB', 'HumanEval': '85%' },
            { '#': '3', 'Modelo': 'Qwen3 8B', 'Mejor para': 'Actualizado, multilingüe + programación', 'RAM': '5,5 GB', 'HumanEval': '76%' },
            { '#': '4', 'Modelo': 'Devstral Small 24B', 'Mejor para': 'Programación agéntica (multichivo)', 'RAM': '16 GB', 'HumanEval': '80%' },
            { '#': '5', 'Modelo': 'deepseek-r1:7b', 'Mejor para': 'Razonamiento, matemáticas', 'RAM': '5 GB', 'MATH': '52%' },
            { '#': '6', 'Modelo': 'Mistral 7B v0.3', 'Mejor para': 'Uso en UE, eficiente', 'RAM': '4,5 GB', 'HumanEval': '39%' },
            { '#': '7', 'Modelo': 'mistral-small3.1', 'Mejor para': 'Calidad en 16 GB', 'RAM': '14 GB', 'HumanEval': '74%' },
            { '#': '8', 'Modelo': 'gemma2:2b', 'Mejor para': 'Rápido, poca RAM', 'RAM': '1,7 GB', 'Speed': '40-60 tok/s' },
            { '#': '9', 'Modelo': 'gemma4:9b', 'Mejor para': 'Visión + tool calling', 'RAM': '6 GB', 'Notes': 'Listo para agentes' },
            { '#': '10', 'Modelo': 'phi4-mini', 'Mejor para': 'Razonamiento, 4 GB de RAM', 'RAM': '2,5 GB', 'HumanEval': '70%' },
          ],
          columns: ['#', 'Modelo', 'Mejor para', 'RAM', 'HumanEval'],
          image: '/images/ollama-top10-models-comparison-en.svg',
          imageCaption: 'Top 10 modelos Ollama: RAM desde 1,7 GB (gemma2:2b) hasta 16 GB (Devstral). Preferidos para nuevos proyectos en mayo de 2026: Llama 4 Scout, Qwen3, Gemma 4.',
        },
        howToBrowse: {
          id: 'how-to-browse-ollama-library',
          ...
          faqs: [
            {
              ...
              a: 'A partir de mayo de 2026, la biblioteca de Ollama contiene aproximadamente más de 4.500 modelos (contribuciones curadas + de la comunidad) con soporte oficial. Hugging Face aloja miles de modelos GGUF adicionales que se pueden cargar mediante Ollama usando Modelfiles personalizados.',
            },
            {
            ...
            },
            {
              ...
              a: 'El equipo de Ollama añade nuevos modelos en días o semanas tras los lanzamientos principales. Kimi K2.6 y Qwen 3.6 aparecieron a los pocos días de sus lanzamientos de mayo de 2026. Ollama v0.22.1 (3 de mayo de 2026) añadió mejoras de renderizado de Gemma 4. Sigue el repositorio GitHub de Ollama (github.com/ollama/ollama) o la cuenta de Twitter/X de Ollama para anuncios de nuevos modelos.',
            },
            {
        ...
        sources: {
          ...
          items: [
            ...
            '[Moonshot AI. (2026). "Kimi K2.6 Model Card." moonshot.ai](https://moonshot.ai/) -- Modelo de programación MoE con licencia MIT (42B activos/1T total), 87/100 en programación del mundo real.',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'Qwen 3.6 27B', 'url': 'https://ollama.com/library/qwen3.6', 'description': 'Mejor modelo de programación denso mayo de 2026. 77,2% SWE-bench. 22 GB de RAM. ollama run qwen3.6:27b' },
          { '@type': 'ListItem', 'position': 4, 'name': 'Kimi K2.6', 'url': 'https://ollama.com/library/kimi-k2.6', 'description': 'Modelo de programación MoE de frontera mayo de 2026. 87/100 en el mundo real. 42B activos/1T total. Licencia MIT. ollama run kimi-k2.6' },
          ...
          { '@type': 'ListItem', 'position': 6, 'name': 'gemma4:9b', 'url': 'https://ollama.com/library/gemma4', 'description': 'Mejor agente + tool calling + visión. 6 GB de RAM. Soporte de visión + salida estructurada. ollama run gemma4:9b' },
          { '@type': 'ListItem', 'position': 7, 'name': 'qwen3:7b', 'url': 'https://ollama.com/library/qwen3', 'description': 'Mejor programación ligera. 76% HumanEval. Multilingüe. 5,5 GB de RAM. ollama run qwen3:7b' },
        ...
        'mainEntity': [
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'A partir de mayo de 2026, la biblioteca de Ollama contiene aproximadamente más de 4.500 modelos (contribuciones curadas + de la comunidad) con soporte oficial. Hugging Face aloja miles de modelos GGUF adicionales que se pueden cargar mediante Ollama usando Modelfiles personalizados.',
            }
          },
          {
            '@type': 'Question',
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Para un chatbot local de propósito general: `llama4:scout` con 12 GB de VRAM (mejor calidad, MoE), o `llama3.2:3b` con 8 GB de RAM (punto de entrada más sencillo). Para uso de mayor calidad: `mistral-small3.1` con 16 GB de RAM. Para un chatbot asistente de programación: `qwen3.6:27b` (mejor modelo de programación, 77,2% SWE-bench) o `devstral-small:24b` (programación agéntica). Combínalo con Open WebUI para una interfaz web que se conecta a la API de Ollama en localhost:11434.',
            }
          },
          {
            '@type': 'Question',
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'El equipo de Ollama añade nuevos modelos en días o semanas tras los lanzamientos principales. Kimi K2.6 y Qwen 3.6 aparecieron a los pocos días de sus lanzamientos de mayo de 2026. Ollama v0.22.1 (3 de mayo de 2026) añadió mejoras de renderizado de Gemma 4. Sigue el repositorio GitHub de Ollama (github.com/ollama/ollama) o la cuenta de Twitter/X de Ollama para anuncios de nuevos modelos.',
            }
          },
          {
            '@type': 'Question',
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Tres lanzamientos principales en abril de 2026: Gemma 4 9B (Google, 2 de abril -- mejor para tareas de agentes y tool calling, 6 GB de RAM), Qwen3 7B (Alibaba -- 76% HumanEval, mejor en la clase 7B, Apache 2.0) y Llama 4 Scout 8B (Meta, marzo de 2026 -- ventana de contexto de 10M en vista previa). Comandos: ollama run gemma4:9b, ollama run qwen3:7b, ollama run llama4:8b.',
            }
          },
        ]
      },
    ...
    de: {
      ...
      metaDescription: "Top Ollama-Modelle Juni 2026: Llama 4 Scout, Qwen 3.6, Kimi K2.6, Gemma 4. Releases Mai-Juni, Version v0.22.1, beste Modelle für Chat und Code.",
      ...
      sections: {
        ...
        byCategory: {
          ...
          imageCaption: 'Ollama-Modellauswahl nach Anwendungsfall: Mai 2026. Chat: llama4:scout, Codierung: qwen3.6:27b, Reasoning: deepseek-r1:7b.',
        },
        deepseekR1: {
          id: 'deepseek-r1',
...
# Antwort: Sie treffen sich ...`,
        ...
        visionModels: {
          ...
          content: 'Mai 2026: Diese Modelle auf Ollama unterstützen Bildeingabe (multimodal). Gemma 4 unterstützt sowohl Vision ALS AUCH Tool Calling – einzigartig unter Vision-Modellen auf Ollama.',
          columns: ['Modell', 'RAM', 'Bildunterstützung', 'Ollama Befehl'],
          image: '/images/ollama-vision-models-comparison-de.svg',
          imageCaption: '5 Ollama-Vision-Modelle für Bildeingabe. Gemma 4 9B (6 GB) mit Tool Calling. Llama 3.2 Vision 11B (8 GB) für dedizierte Vision. Alle lokal.',
          rows: [
            { 'Modell': 'llama3.2-vision:11b', 'RAM': '~8 GB', 'Bildunterstützung': 'Ja', 'Ollama Befehl': 'ollama run llama3.2-vision:11b' },
            { 'Modell': 'llama3.2-vision:90b', 'RAM': '~55 GB', 'Bildunterstützung': 'Ja', 'Ollama Befehl': 'ollama run llama3.2-vision:90b' },
            { 'Modell': 'gemma3:9b (vision)', 'RAM': '~6 GB', 'Bildunterstützung': 'Ja', 'Ollama Befehl': 'ollama run gemma3:9b' },
            { 'Modell': 'minicpm-v:8b', 'RAM': '~5,5 GB', 'Bildunterstützung': 'Ja', 'Ollama Befehl': 'ollama run minicpm-v' },
            { 'Modell': 'gemma4:9b', 'RAM': '~6 GB', 'Bildunterstützung': 'Ja ✓', 'Ollama Befehl': 'ollama run gemma4:9b' },
          ],
        },
        fullTop10: {
          id: 'full-top-10',
          title: 'Vollständiger Top-10-Vergleich',
          content: 'Download-Zählungen bevorzugen immer noch Llama 3.x und Qwen 2.5 aufgrund der Häufigkeit von Tutorials. Für neue Projekte im Mai 2026 sind Llama 4 Scout, Qwen3 und Gemma 4 zu bevorzugen.',
          columns: ['#', 'Modell', 'Beste für', 'RAM', 'HumanEval'],
          image: '/images/ollama-top10-models-comparison-de.svg',
          imageCaption: 'Top 10 Ollama-Modelle: RAM von 1,7 GB (gemma2:2b) bis 16 GB (Devstral). Bevorzugt für neue Projekte Mai 2026: Llama 4 Scout, Qwen3, Gemma 4.',
          rows: [
            { '#': '1', 'Modell': 'Llama 3.2 3B', 'Beste für': 'Einstiegsmodell, allgemeiner Chat', 'RAM': '2,5 GB', 'HumanEval': '60%' },
            { '#': '2', 'Modell': 'Llama 4 Scout 17B', 'Beste für': 'Beste Gesamtqualität, MoE', 'RAM': '~10 GB', 'HumanEval': '85%' },
            { '#': '3', 'Modell': 'Qwen3 8B', 'Beste für': 'Aktualisiert, mehrsprachig + Codierung', 'RAM': '5,5 GB', 'HumanEval': '76%' },
            { '#': '4', 'Modell': 'Devstral Small 24B', 'Beste für': 'Agentic Codierung (Multi-Datei)', 'RAM': '16 GB', 'HumanEval': '80%' },
            { '#': '5', 'Modell': 'deepseek-r1:7b', 'Beste für': 'Reasoning, Mathe', 'RAM': '5 GB', 'MATH': '52%' },
            { '#': '6', 'Modell': 'Mistral 7B v0.3', 'Beste für': 'EU-Einsatz, effizient', 'RAM': '4,5 GB', 'HumanEval': '39%' },
            { '#': '7', 'Modell': 'mistral-small3.1', 'Beste für': 'Qualität bei 16 GB', 'RAM': '14 GB', 'HumanEval': '74%' },
            { '#': '8', 'Modell': 'gemma2:2b', 'Beste für': 'Schnell, niedriger RAM', 'RAM': '1,7 GB', 'Speed': '40-60 tok/s' },
            { '#': '9', 'Modell': 'gemma4:9b', 'Beste für': 'Vision + Tool Calling', 'RAM': '6 GB', 'Notes': 'Agent-ready' },
            { '#': '10', 'Modell': 'phi4-mini', 'Beste für': 'Reasoning, 4 GB RAM', 'RAM': '2,5 GB', 'HumanEval': '70%' },
          ],
        },
        howToBrowse: {
          id: 'how-to-browse',
...
schema: {
    ...
    fr: {
      ...
      intro: 'Les modèles open source les plus populaires sur Ollama en mai 2026 : Llama 4 Scout meilleure qualité, Qwen3 en plus forte croissance, DeepSeek-R1 en tête pour le raisonnement, Gemma 4 révolutionne les agents. Nouveau mai : Kimi K2.6 (Top Coding, MoE, MIT), Qwen 3.6 27B (77.2% SWE-bench), GLM-5.1. Ce guide présente les commandes de téléchargement, les exigences RAM, les benchmarks et les modèles les mieux adaptés à vos besoins.',
      metaDescription: "Top modèles Ollama juin 2026 : Llama 4 Scout, Qwen 3.6, Kimi K2.6, Gemma 4. Mises à jour mai-juin, version v0.22.1, meilleurs modèles pour chat et code.",
      publishDate: '2026-04-11',
      ...
      sections: {
        ...
        whatsNew: {
          ...
          content: [
            '**Version Ollama actuelle :** v0.22.1 (publiée le 3 mai 2026). C\'est la dernière version stable disponible sur ollama.com/download.',
            '**Dernier Lancement (3 mai 2026) :** Ollama v0.22.1 a ajouté la prise en charge complète de Gemma 4 avec les capacités de pensée et d\'appel d\'outils. Cette version incluait des améliorations de la gestion de la quantification et de l\'inférence des modèles.',
            '**Nouveaux Modèles Ajoutés (mai-juin 2026) :**',
          ],
          items: [
            '**Kimi K2.6** (Moonshot AI, mai 2026) — Premier modèle non-occidental à atteindre le Tier A en benchmarks de codage (87/100). Architecture MoE. Licence MIT.',
            '**Qwen 3.6 27B** (Alibaba, mai 2026) — Meilleur modèle de codage dense avec 77,2% SWE-bench.',
            '**GLM-5.1** (Zhipu AI, mai 2026) — Leader en génération de code structuré.',
            '**Gemma 4** (Google, 2 avril 2026) — Première combinaison Vision + Tool-Calling avec 6 GB VRAM.',
          ],
          codeBlock: '# Mettre à jour Ollama vers la dernière version\ncurl https://ollama.ai/install.sh | sh\n\n# Ou sur Mac : brew upgrade ollama\n\n# Vérifier la version actuelle\nollama --version  # Sortie : ollama version 0.22.1',
          codeLanguage: 'bash',
        },
        mostPopular: {
        ...
        byCategory: {
          ...
          imageCaption: 'Sélection Ollama par cas d\'usage : mai 2026. Chat : llama4:scout, codage : qwen3.6:27b, raisonnement : deepseek-r1:7b.',
        },
        deepseekR1: {
...
schema: {
    ...
    ja: {
      ...
      intro: '2026年5月のOllama最人気オープンソースモデル：Llama 4 Scoutが最高品質、Qwen3が最高速成長、DeepSeek-R1が推論トップ、Gemma 4がエージェント革新。新5月：Kimi K2.6（Top Coding、MoE、MIT）、Qwen 3.6 27B（77.2% SWE-bench）、GLM-5.1。このガイドではダウンロードコマンド、RAM要件、ベンチマーク、ニーズに合致したモデルを紹介します。',
      metaDescription: "2026年6月Ollamaトップモデル：Llama 4 Scout、Qwen 3.6、Kimi K2.6、Gemma 4。最新アップデートv0.22.1、5月-6月新リリース、チャットとコーディング最適モデル。",
      publishDate: '2026-04-11',
      readTime: '9分で読める',
      ...
      sections: {
        ...
        whatsNew: {
          ...
          content: [
            '**現在のOllamaバージョン：** v0.22.1（2026年5月3日リリース）。ollama.com/downloadで最新安定版として入手可能。',
            '**最新リリース（2026年5月3日）：** Ollama v0.22.1はGemma 4の完全サポートを追加し、思考機能とツール呼び出し機能を実装。量子化処理の改善とモデル推論最適化を含む。',
            '**新モデル追加（5月-6月2026）：**',
          ],
          items: [
            '**Kimi K2.6**（Moonshot AI、2026年5月）— 初の非西方モデルでコーディングベンチマークTier A到達（87/100）。MoEアーキテクチャ（42B活性/1T合計）。MIT ライセンス。',
            '**Qwen 3.6 27B**（Alibaba、2026年5月）— 77.2% SWE-benchで最高密度コーディング。',
            '**GLM-5.1**（Zhipu AI、2026年5月）— 構造化コード生成リーダー。',
            '**Gemma 4**（Google、2026年4月2日）— ビジョン+ツール呼び出し初組み合わせ。6GB VRAM対応。',
          ],
          codeBlock: '# Ollamaを最新版にアップデート\ncurl https://ollama.ai/install.sh | sh\n\n# またはMac：brew upgrade ollama\n\n# 現在のバージョンを確認\nollama --version  # 出力：ollama version 0.22.1',
          codeLanguage: 'bash',
        },
        mostPopular: {
          title: 'Ollama最人気モデル',
          content: [
            ...
            '**Llama 3.2 3B**は全体で最多ダウンロード。主にチュートリアルとして使用。Llama 4 Scoutは2026年3月リリース後、品質向上で急速に上昇。',
            '**Qwen3・Qwen 3.6**はOllama ライブラリで最速成長のモデルファミリー。Qwen3と新しいQwen 3.6密度バリアントがQwen2.5を急速に置き換え。DeepSeek-R1と新しいDeepSeek-R2はリリース後の大きなスパイク後、推論タスク向けに常に高ダウンロード状態。',
        ...
        byCategory: {
          ...
          imageCaption: '用途別Ollamaモデル選択：2026年5月。チャット：llama4:scout、コーディング：qwen3.6:27b、推論：deepseek-r1:7b。',
        },
        deepseekR1: {
...
schema: {
    ...
    zh: {
      ...
      intro: '2026年5月，Ollama最受欢迎的开源模型包括：Llama 4 Scout（最高品质、MoE）、Qwen3系列（增长最快，中文支持最优）、DeepSeek-R1（推理最强）、Gemma 4（智能体革命）。新5月：Kimi K2.6（顶级编程、MoE、MIT）、Qwen 3.6 27B（77.2% SWE-bench）、GLM-5.1。本文提供完整的Top 10排行、RAM要求、性能基准及快速安装命令。',
      metaDescription: "2026年6月Ollama最佳模型：Llama 4 Scout、Qwen 3.6、Kimi K2.6、Gemma 4。最新版本v0.22.1、5月-6月新发布、对话和编程最优模型。",
      publishDate: '2026-04-11',
      readTime: '阅读约9分钟',
      educationalLevel: 'Beginner',
      ...
      sections: {
        ...
        whatsNew: {
          ...
          content: [
            '**当前Ollama版本：** v0.22.1（2026年5月3日发布）。ollama.com/download 提供最新稳定版本。',
            '**最新版本（2026年5月3日）：** Ollama v0.22.1增加了Gemma 4完整支持，带来思维能力和工具调用功能。发布包含量化处理改进和模型推理优化。',
            '**新模型上线（5月-6月2026）：**',
          ],
          items: [
            '**Kimi K2.6**（Moonshot AI、2026年5月）— 首个达到编码基准Tier A（87/100）的非西方模型。MoE架构（42B活跃/1T总数）。MIT许可。',
            '**Qwen 3.6 27B**（Alibaba、2026年5月）— 以77.2% SWE-bench成为最佳密集编码模型。',
            '**GLM-5.1**（Zhipu AI、2026年5月）— 结构化代码生成领导者。',
            '**Gemma 4**（Google、2026年4月2日）— 首个视觉+工具调用组合。6GB显存支持。',
          ],
          codeBlock: '# 更新Ollama到最新版本\ncurl https://ollama.ai/install.sh | sh\n\n# 或Mac：brew upgrade ollama\n\n# 检查当前版本\nollama --version  # 输出：ollama version 0.22.1',
          codeLanguage: 'bash',
        },
        mostPopular: {
          title: '最受欢迎的模型（2026年5月）',
          content: [
        ...
        byCategory: {
          ...
          imageCaption: '按用途选择Ollama：2026年5月。聊天llama4:scout，编码qwen3.6:27b，推理deepseek-r1:7b。',
        },
        deepseekR1: {
