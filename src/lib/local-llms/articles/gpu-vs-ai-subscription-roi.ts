...
schema: {
    ...
    ar: {
      ...
      seoTitle: 'GPU مقابل ChatGPT Plus 2026: عائد الاستثمار في 18 شهرًا',
      ...
      metaDescription: 'RTX 5060 Ti مستعملة بـ 450$ تعادل ChatGPT Plus (240$/سنة) خلال 18–24 شهرًا بمعدل 5 ساعات أسبوعياً. المستخدمون المكثفون يوفرون 5000$+ خلال 5 سنوات.',
      publishDate: '2026-04-05',
      dateModified: '2026-04-25',
      ...
      sections: {
        'tldr': {
          ...
          items: [
            ...
            '품질: 구독 = GPT-5.2/GPT-5.4 Pro (최상). 로컬 = Llama 3.3 70B (MMLU 기준 GPT-5.2의 82%)',
        ...
        'relatedReading': {
          ...
          items: [
            ...
            '[로컬 LLM과 클라우드 API 사용 시점](/local-llms/local-llm-vs-cloud-api)',
          ],
        },
        'sources': {
          title: '출처',
