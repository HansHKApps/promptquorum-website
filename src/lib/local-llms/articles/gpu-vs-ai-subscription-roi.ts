    ...
    en: {
      ...
      sections: {
        ...
        'hidden-costs': {
          ...
          content: [
            '**Subscription hidden costs: Rate limits (ChatGPT Plus: 160 messages/3 hrs with GPT-5.2 + 3,000 GPT-5.2 Thinking/week), API costs if building applications ($0.015-0.06 per 1K tokens), data ownership (your conversations belong to OpenAI/Anthropic).**',
    ...
    zh: {
      ...
      sections: {
        ...
        'faqSection': {
          ...
          faqs: [
            ...
            {
              q: '苹果2026年8月的Mac mini更新是否会改变GPU vs订阅数学?',
              a: '苹果于2026年8月25日更新了Mac mini产品线: Mac mini M6 ($899，最高32 GB统一内存) 和Mac mini M5 Pro ($1,699，最高64 GB)，均于2026年9月22日发货 — 取代上一代M4 ($599) 和M4 Pro (最高$2,299)。新芯片尚无独立的tok/sec基准测试数据。仅从价格看: M5 Pro ($1,699，64 GB) 内存足以运行Llama 3.3 70B级本地模型，与ChatGPT Plus ($240/年) 的损益分岐点约为7年，与Pro $100 ($1,200/年) 相比约为17个月。M6 ($899，最高32 GB) 适合较小模型，与Plus的损益分岐点约为3.7年，与Pro $100相比约为9个月。',
            },
            {
              q: '中国企业的GPU是否具有成本效益?',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '苹果2026年8月的Mac mini更新是否会改变GPU vs订阅数学?', 'acceptedAnswer': { '@type': 'Answer', 'text': '苹果于2026年8月25日更新Mac mini: M6 ($899，最高32GB) 和M5 Pro ($1,699，最高64GB)，2026年9月22日发货 — 取代M4 ($599)/M4 Pro (最高$2,299)。新芯片尚无公开基准测试。按价格计算: M5 Pro与Plus的损益分岐点约7年，与Pro $100约17个月。M6与Plus约3.7年，与Pro $100约9个月。' } },
