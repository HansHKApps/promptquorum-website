      ...
      sections: {
        ...
        'relatedReading': {
          ...
          items: [
            ...
            '[クラウドGPUレンタル2026:RunPod・Vast.ai・Lambda Labs比較](/local-llms/cloud-gpu-rental-comparison-2026?lang=ja)',
      ...
      sections: {
        ...
        'relatedReading': {
          ...
          items: [
            ...
            '[2026年云GPU租赁对比: RunPod、Vast.ai、Lambda Labs](/local-llms/cloud-gpu-rental-comparison-2026?lang=zh)',
