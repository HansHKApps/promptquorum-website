...
schema: {
    ...
    ja: {
      ...
      sections: {
        ...
        'relatedReading': {
          title: '関連資料',
          items: [
            '[ローカル LLM 対 ChatGPT Plus: コスト比較](/local-llms/local-llms-vs-chatgpt-plus?lang=ja)',
            '[ローカル LLM 対 Claude Pro: プライバシーとコスト](/local-llms/local-llms-vs-claude-pro?lang=ja)',
            '[ローカル LLM 対クラウド GPU: どちらが安いか?](/local-llms/local-llm-vs-cloud-gpu-cost?lang=ja)',
            '[ローカル LLM 向け最高予算 GPU](/local-llms/best-budget-gpus-local-llm?lang=ja)',
            '[ローカル LLM に必要な VRAM はいくら?](/local-llms/how-much-vram-local-llm?lang=ja)',
            '[ローカル LLM ハードウェアガイド 2026: GPU、CPU、RAM](/local-llms/local-llm-hardware-guide-2026?lang=ja)',
            '[ローカル LLM 対クラウド API をいつ使用するか](/local-llms/local-llm-vs-cloud-api?lang=ja)',
          ],
        },
        'sources': {
          title: '参考文献',
          items: [
            ...
            'トークンあたりのコストは重要ですが、クエリあたりの出力品質も同様に重要です。より高い品質の応答は無駄なトークンを削減します。[温度と top-p パラメータをチューニングするとハードウェアなしでの結果が向上する方法を示しています。](https://www.promptquorum.com/prompt-engineering/temperature-and-top-p-control-ai-creativity?lang=ja)',
          ],
        },
      },
      schema: {
        ...
        'url': 'https://www.promptquorum.com/local-llms/gpu-vs-ai-subscription-roi?lang=ja',
        'inLanguage': 'ja',
        'datePublished': '2026-04-05',
        'dateModified': '2026-04-25',
    ...
    zh: {
      ...
      sections: {
        ...
        'relatedReading': {
          ...
          items: [
            ...
            '[本地LLM vs Claude Pro: 隐私和成本](/local-llms/local-llms-vs-claude-pro?lang=zh)',
            '[本地LLM vs云GPU: 哪个更便宜?](/local-llms/local-llm-vs-cloud-gpu-cost?lang=zh)',
            '[本地LLM的最佳预算GPU](/local-llms/best-budget-gpus-local-llm?lang=zh)',
            '[本地LLM需要多少VRAM?](/local-llms/how-much-vram-local-llm?lang=zh)',
            '[本地LLM硬件指南2026: GPU、CPU、RAM](/local-llms/local-llm-hardware-guide-2026?lang=zh)',
            '[何时使用本地LLM vs云API](/local-llms/local-llm-vs-cloud-api?lang=zh)',
          ],
        },
        'sources': {
          title: '参考资料',
      ...
      schema: {
        ...
        'url': 'https://www.promptquorum.com/local-llms/gpu-vs-ai-subscription-roi?lang=zh',
        'inLanguage': 'zh',
        'datePublished': '2026-04-05',
        'dateModified': '2026-04-25',
        'author': { '@type': 'Organization', 'name': 'PromptQuorum' },
