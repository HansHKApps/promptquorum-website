    ...
    en: {
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 4, 'name': 'Mistral 7B Q4 — Better Quality on 16+ GB RAM (4.5 GB, 5 tok/s)' },
          { '@type': 'ListItem', 'position': 5, 'name': 'Llama 3.1 8B Q4 — Best for Coding on CPU (5 GB, 4 tok/s)' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
    ...
    es: {
      ...
      sections: {
        ...
        bestModels: {
          ...
          rows: [
            ...
            { 'Modelo': 'Mistral 7B Q4', 'Parámetros': '7B', 'Tamaño GGUF': '~4,5 GB', 'RAM necesaria': '6 GB', 'Velocidad CPU': '5 tok/seg', 'Mejor para': 'Mejor calidad, 16+ GB RAM' },
            { 'Modelo': 'Llama 3.1 8B Q4', 'Parámetros': '8B', 'Tamaño GGUF': '~5 GB', 'RAM necesaria': '7 GB', 'Velocidad CPU': '4 tok/seg', 'Mejor para': 'Programación, tareas lógicas' },
          ],
        ...
        speedComparison: {
          ...
          rows: [
            ...
            { 'Hardware': 'RTX 4090 (GPU, 24 GB)', 'Modelo': 'Llama 3.1 8B Q4', 'Velocidad': '120 tokens/seg', 'Notas': 'GPU es 30× más rápida que CPU' },
          ],
        ...
        ramRequirements: {
          ...
          rows: [
            ...
            { 'Modelo': 'Mistral 7B Q4', 'Tamaño GGUF': '~4,5 GB', 'RAM mínima': '5 GB', 'Cómodo': '8 GB', 'Longitud de contexto': '32K' },
            { 'Modelo': 'Llama 3.1 8B Q4', 'Tamaño GGUF': '~5 GB', 'RAM mínima': '6 GB', 'Cómodo': '12 GB', 'Longitud de contexto': '128K' },
          ],
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 4, 'name': 'Mistral 7B Q4 — Mejor calidad con 16+ GB RAM (4,5 GB, 5 tok/s)' },
          { '@type': 'ListItem', 'position': 5, 'name': 'Llama 3.1 8B Q4 — Mejor para programación en CPU (5 GB, 4 tok/s)' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Usa la regla: tamaño del archivo GGUF + 500 MB de sobrecarga. Phi-4 Mini (2,3 GB) necesita 3 GB de RAM. Gemma 3 2B (1,5 GB) necesita 2 GB de RAM. Mistral 7B Q4 (4,5 GB) necesita 5 GB de RAM.',
            },
          },
          {
            '@type': 'Question',
    ...
    de: {
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 4, 'name': 'Mistral 7B Q4 — Bessere Qualität auf 16+ GB RAM (4,5 GB, 5 Tok/Sek)' },
          { '@type': 'ListItem', 'position': 5, 'name': 'Llama 3.1 8B Q4 — Bestes für Coding auf CPU (5 GB, 4 Tok/Sek)' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
    ...
    fr: {
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 4, 'name': 'Mistral 7B Q4 — Meilleure qualité sur 16+ GB RAM (4.5 GB, 5 tok/s)' },
          { '@type': 'ListItem', 'position': 5, 'name': 'Llama 3.1 8B Q4 — Meilleur pour le code sur CPU (5 GB, 4 tok/s)' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
    ...
    ja: {
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 4, 'name': 'Mistral 7B Q4 — 16+ GB RAM でより高品質（4.5 GB、5 トークン/秒）' },
          { '@type': 'ListItem', 'position': 5, 'name': 'Llama 3.1 8B Q4 — CPU でコーディングに最適（5 GB、4 トークン/秒）' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
    ...
    zh: {
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 4, 'name': 'Mistral 7B Q4 — 16+ GB RAM下更高质量（4.5 GB，5令牌/秒）' },
          { '@type': 'ListItem', 'position': 5, 'name': 'Llama 3.1 8B Q4 — CPU编码最佳选择（5 GB，4令牌/秒）' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
