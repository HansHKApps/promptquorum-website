      ...
      sections: {
        ...
        bestModels: {
          ...
          rows: [
            ...
            { 'Model': 'Mistral Small Q4', 'Params': '7B', 'GGUF Size': '~4.5 GB', 'RAM Needed': '6 GB', 'CPU Speed': '5 tok/sec', 'Best For': 'Better quality, 16+ GB RAM' },
            { 'Model': 'Llama 3.3 8B Q4', 'Params': '8B', 'GGUF Size': '~5 GB', 'RAM Needed': '7 GB', 'CPU Speed': '4 tok/sec', 'Best For': 'Coding, logic tasks' },
          ],
        ...
        speedComparison: {
          ...
          rows: [
            ...
            { 'Hardware': 'RTX 4090 (GPU, 24 GB)', 'Model': 'Llama 3.3 8B Q4', 'Speed': '120 tokens/sec', 'Notes': 'GPU is 30× faster than CPU' },
          ],
        ...
        ramRequirements: {
          ...
          rows: [
            ...
            { 'Model': 'Mistral Small Q4', 'GGUF Size': '~4.5 GB', 'Min RAM': '5 GB', 'Comfortable': '8 GB', 'Context Length': '32K' },
            { 'Model': 'Llama 3.3 8B Q4', 'GGUF Size': '~5 GB', 'Min RAM': '6 GB', 'Comfortable': '12 GB', 'Context Length': '128K' },
          ],
    ...
    es: {
      ...
      sections: {
        ...
        bestModels: {
          ...
          rows: [
            { 'Modelo': 'Phi-4 Mini', 'Parámetros': '3,8B', 'Tamaño GGUF': '~2,3 GB', 'RAM necesaria': '4 GB', 'Velocidad CPU': '12 tok/seg', 'Mejor para': 'Chat general, asistencia de código' },
            { 'Modelo': 'Gemma 3 2B', 'Parámetros': '2B', 'Tamaño GGUF': '~1,5 GB', 'RAM necesaria': '3 GB', 'Velocidad CPU': '15 tok/seg', 'Mejor para': 'Respuestas rápidas, bajo VRAM' },
            { 'Modelo': 'Llama 3.2 3B', 'Parámetros': '3B', 'Tamaño GGUF': '~2 GB', 'RAM necesaria': '3,5 GB', 'Velocidad CPU': '10 tok/seg', 'Mejor para': 'Equilibrio calidad/velocidad' },
            { 'Modelo': 'Mistral Small Q4', 'Parámetros': '7B', 'Tamaño GGUF': '~4,5 GB', 'RAM necesaria': '6 GB', 'Velocidad CPU': '5 tok/seg', 'Mejor para': 'Mejor calidad, 16+ GB RAM' },
            { 'Modelo': 'Llama 3.3 8B Q4', 'Parámetros': '8B', 'Tamaño GGUF': '~5 GB', 'RAM necesaria': '7 GB', 'Velocidad CPU': '4 tok/seg', 'Mejor para': 'Programación, tareas lógicas' },
          ],
        ...
        speedComparison: {
          ...
          rows: [
            { 'Hardware': 'Intel i7-12700 (CPU)', 'Modelo': 'Phi-4 Mini 3,8B', 'Velocidad': '12 tokens/seg', 'Notas': 'AVX-512 activado' },
            { 'Hardware': 'AMD Ryzen 7 5700X (CPU)', 'Modelo': 'Phi-4 Mini 3,8B', 'Velocidad': '9 tokens/seg', 'Notas': 'Solo AVX2 más antiguo' },
            ...
            { 'Hardware': 'RTX 4090 (GPU, 24 GB)', 'Modelo': 'Llama 3.3 8B Q4', 'Velocidad': '120 tokens/seg', 'Notas': 'GPU es 30× más rápida que CPU' },
          ],
        ...
        ramRequirements: {
          ...
          rows: [
            { 'Modelo': 'Gemma 3 2B', 'Tamaño GGUF': '~1,5 GB', 'RAM mínima': '2–2,5 GB', 'Cómodo': '4 GB', 'Longitud de contexto': '8K' },
            { 'Modelo': 'Phi-4 Mini 3,8B', 'Tamaño GGUF': '~2,3 GB', 'RAM mínima': '3 GB', 'Cómodo': '6 GB', 'Longitud de contexto': '4K' },
            { 'Modelo': 'Llama 3.2 3B', 'Tamaño GGUF': '~2 GB', 'RAM mínima': '2,5–3 GB', 'Cómodo': '6 GB', 'Longitud de contexto': '8K' },
            { 'Modelo': 'Mistral Small Q4', 'Tamaño GGUF': '~4,5 GB', 'RAM mínima': '5 GB', 'Cómodo': '8 GB', 'Longitud de contexto': '32K' },
            { 'Modelo': 'Llama 3.3 8B Q4', 'Tamaño GGUF': '~5 GB', 'RAM mínima': '6 GB', 'Cómodo': '12 GB', 'Longitud de contexto': '128K' },
          ],
      ...
      sections: {
        ...
        bestModels: {
          ...
          rows: [
            ...
            { 'Modell': 'Mistral Small Q4', 'Parameter': '7B', 'GGUF-Größe': '~4,5 GB', 'RAM erforderlich': '6 GB', 'CPU-Geschwindigkeit': '5 Token/Sekunde', 'Beste für': 'Bessere Qualität, 16+ GB RAM' },
            { 'Modell': 'Llama 3.3 8B Q4', 'Parameter': '8B', 'GGUF-Größe': '~5 GB', 'RAM erforderlich': '7 GB', 'CPU-Geschwindigkeit': '4 Token/Sekunde', 'Beste für': 'Kodierung, Logik-Aufgaben' },
          ],
        ...
        speedComparison: {
          ...
          rows: [
            ...
            { 'Hardware': 'RTX 4090 (GPU, 24 GB)', 'Modell': 'Llama 3.3 8B Q4', 'Geschwindigkeit': '120 Token/Sekunde', 'Notizen': 'GPU ist 30× schneller als CPU' },
          ],
        ...
        ramRequirements: {
          ...
          rows: [
            ...
            { 'Modell': 'Mistral Small Q4', 'GGUF-Größe': '~4,5 GB', 'Min RAM': '5 GB', 'Komfortabel': '8 GB', 'Kontextlänge': '32K' },
            { 'Modell': 'Llama 3.3 8B Q4', 'GGUF-Größe': '~5 GB', 'Min RAM': '6 GB', 'Komfortabel': '12 GB', 'Kontextlänge': '128K' },
          ],
      ...
      sections: {
        ...
        bestModels: {
          ...
          rows: [
            ...
            { 'Modèle': 'Mistral Small Q4', 'Paramètres': '7B', 'Taille GGUF': '~4.5 GB', 'RAM Requise': '6 GB', 'Vitesse CPU': '5 tokens/sec', 'Meilleur Pour': 'Meilleure qualité, 16+ GB RAM' },
            { 'Modèle': 'Llama 3.3 8B Q4', 'Paramètres': '8B', 'Taille GGUF': '~5 GB', 'RAM Requise': '7 GB', 'Vitesse CPU': '4 tokens/sec', 'Meilleur Pour': 'Codage, tâches logiques' },
          ],
        ...
        speedComparison: {
          ...
          rows: [
            ...
            { 'Matériel': 'RTX 4090 (GPU, 24 GB)', 'Modèle': 'Llama 3.3 8B Q4', 'Vitesse': '120 tokens/sec', 'Notes': 'GPU 30× plus rapide que CPU' },
          ],
        ...
        ramRequirements: {
          ...
          rows: [
            ...
            { 'Modèle': 'Mistral Small Q4', 'Taille GGUF': '~4.5 GB', 'RAM Min': '5 GB', 'Confortable': '8 GB', 'Longueur Contexte': '32K' },
            { 'Modèle': 'Llama 3.3 8B Q4', 'Taille GGUF': '~5 GB', 'RAM Min': '6 GB', 'Confortable': '12 GB', 'Longueur Contexte': '128K' },
          ],
      ...
      sections: {
        ...
        bestModels: {
          ...
          rows: [
            ...
            { 'モデル': 'Mistral Small Q4', 'パラメータ': '7B', 'GGUF サイズ': '~4.5 GB', 'RAM 要件': '6 GB', 'CPU 速度': '5 トークン/秒', '最適な用途': 'より高い品質、16+ GB RAM' },
            { 'モデル': 'Llama 3.3 8B Q4', 'パラメータ': '8B', 'GGUF サイズ': '~5 GB', 'RAM 要件': '7 GB', 'CPU 速度': '4 トークン/秒', '最適な用途': 'コーディング、ロジックタスク' },
          ],
        ...
        speedComparison: {
          ...
          rows: [
            ...
            { 'ハードウェア': 'RTX 4090 (GPU、24 GB)', 'モデル': 'Llama 3.3 8B Q4', '速度': '120 トークン/秒', '注釈': 'GPU は CPU より 30× 高速' },
          ],
        ...
        ramRequirements: {
          ...
          rows: [
            ...
            { 'モデル': 'Mistral Small Q4', 'GGUF サイズ': '~4.5 GB', '最小 RAM': '5 GB', '快適': '8 GB', 'コンテキスト長': '32K' },
            { 'モデル': 'Llama 3.3 8B Q4', 'GGUF サイズ': '~5 GB', '最小 RAM': '6 GB', '快適': '12 GB', 'コンテキスト長': '128K' },
          ],
      ...
      sections: {
        ...
        bestModels: {
          ...
          rows: [
            ...
            { '模型': 'Mistral Small Q4', '参数': '7B', 'GGUF 大小': '~4.5 GB', 'RAM 需求': '6 GB', 'CPU 速度': '5 令牌/秒', '最适合': '更高质量、16+ GB RAM' },
            { '模型': 'Llama 3.3 8B Q4', '参数': '8B', 'GGUF 大小': '~5 GB', 'RAM 需求': '7 GB', 'CPU 速度': '4 令牌/秒', '最适合': '编码、逻辑任务' },
          ],
        ...
        speedComparison: {
          ...
          rows: [
            ...
            { '硬件': 'RTX 4090 (GPU、24 GB)', '模型': 'Llama 3.3 8B Q4', '速度': '120 令牌/秒', '备注': 'GPU 比 CPU 快 30 倍' },
          ],
          columns: ['硬件', '模型', '速度', '备注'],
        },
        ramRequirements: {
          ...
          rows: [
            ...
            { '模型': 'Mistral Small Q4', 'GGUF 大小': '~4.5 GB', '最小 RAM': '5 GB', '舒适': '8 GB', '上下文长度': '32K' },
            { '模型': 'Llama 3.3 8B Q4', 'GGUF 大小': '~5 GB', '最小 RAM': '6 GB', '舒适': '12 GB', '上下文长度': '128K' },
          ],
