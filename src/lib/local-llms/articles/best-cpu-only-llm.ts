...
export const article: Partial<Record<Language, LLMArticle>> = {
    ...
    de: {
      ...
      itemListSchema: {
        ...
        'url': 'https://www.promptquorum.com/local-llms/best-cpu-only-llm?lang=de',
        'inLanguage': 'de',
        'numberOfItems': 5,
        'itemListElement': [
    ...
    fr: {
      ...
      itemListSchema: {
        ...
        'url': 'https://www.promptquorum.com/local-llms/best-cpu-only-llm?lang=fr',
        'inLanguage': 'fr',
        'numberOfItems': 5,
        'itemListElement': [
    ...
    ja: {
      ...
      itemListSchema: {
        ...
        'url': 'https://www.promptquorum.com/local-llms/best-cpu-only-llm?lang=ja',
        'inLanguage': 'ja',
        'numberOfItems': 5,
        'itemListElement': [
    ...
    zh: {
      ...
      itemListSchema: {
        ...
        'url': 'https://www.promptquorum.com/local-llms/best-cpu-only-llm?lang=zh',
        'inLanguage': 'zh',
        'numberOfItems': 5,
        'itemListElement': [
