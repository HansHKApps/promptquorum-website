...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  es: {
    ...
    metaDescription: 'El proxy de LiteLLM es gratis y autoalojado, OpenRouter cobra ~5.5% sobre el saldo que cargas y Portkey ya forma parte de Prisma AIRS de Palo Alto. Agosto 2026.',
    educationalLevel: 'Advanced',
  ...
  pt: {
    ...
    metaDescription: 'O proxy do LiteLLM é gratuito e auto-hospedado, o OpenRouter cobra ~5,5% sobre o saldo comprado e o Portkey agora faz parte do Prisma AIRS da Palo Alto. Agosto de 2026.',
    educationalLevel: 'Advanced',
  ...
  ja: {
    ...
    metaDescription: 'LiteLLMのプロキシは無料・セルフホスト、OpenRouterはクレジット購入に約5.5%、Portkeyは現在Palo AltoのPrisma AIRSの一部。2026年8月時点。',
    educationalLevel: 'Advanced',
    ...
    schema: {
      ...
      description: 'LLM APIゲートウェイとしてのLiteLLM、OpenRouter、Portkey/Prisma AIRSの比較。実際の価格、セルフホストの選択肢、フェイルオーバー制御、そしてPortkeyのカテゴリーを変えたPalo Altoによる買収。2026年8月検証。',
      datePublished: '2026-08-27',
      dateModified: '2026-08-27',
  ...
  zh: {
    ...
    metaDescription: 'LiteLLM的代理免费且可自托管，OpenRouter对充值收取约5.5%，Portkey现已并入Palo Alto的Prisma AIRS。2026年8月核实。',
    educationalLevel: 'Advanced',
    ...
    schema: {
      ...
      description: '把LiteLLM、OpenRouter与Portkey/Prisma AIRS作为LLM API网关进行对比：真实价格、自托管选项、故障转移控制，以及改变了Portkey品类的Palo Alto收购案。2026年8月核实。',
      datePublished: '2026-08-27',
      dateModified: '2026-08-27',
  ...
  ko: {
    ...
    metaDescription: 'LiteLLM 프록시는 무료이며 셀프 호스팅이 가능하고, OpenRouter는 충전 금액의 약 5.5%를 받으며, Portkey는 이제 Palo Alto의 Prisma AIRS에 속합니다. 2026년 8월 확인.',
    educationalLevel: 'Advanced',
    ...
    schema: {
      ...
      description: 'LLM API 게이트웨이로서 LiteLLM, OpenRouter, Portkey/Prisma AIRS 비교: 실제 가격, 셀프 호스팅 옵션, 장애 대응 통제, 그리고 Portkey의 범주를 바꾼 Palo Alto 인수. 2026년 8월 확인.',
      datePublished: '2026-08-27',
      dateModified: '2026-08-27',
