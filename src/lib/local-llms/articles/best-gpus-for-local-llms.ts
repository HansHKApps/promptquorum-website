      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Apple Silicon vs GPU NVIDIA pour LLMs locaux](/local-llms/apple-silicon-vs-nvidia-gpu-local-llm?lang=fr) -- Mac vs GPU : seuil mémoire unifiée 24GB, TCO 3 ans, et comparaison consommation énergétique.',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Apple Silicon vs NVIDIA GPU ローカルLLM向け](/local-llms/apple-silicon-vs-nvidia-gpu-local-llm?lang=ja) -- Mac vs GPU：24GB統合メモリ、3年TCO、消費電力比較。',
