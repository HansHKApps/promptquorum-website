...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    theme: 'Best Models',
    title: 'Qwen 3.6 Coder vs DeepSeek Coder v3 vs Mistral Devstral: Local Coding Benchmark 2026',
    seoTitle: 'Qwen 3.6 Coder vs DeepSeek Coder v3 vs Mistral Devstral: 2026 Benchmark',
    intro: 'Qwen 3.6 27B scores 92.1% HumanEval and 77.2% SWE-bench, matching DeepSeek Coder v3 (91.6% HumanEval, ~75% SWE-bench) and outperforming Mistral Devstral Small 24B (90.1% HumanEval, ~73% SWE-bench) on agentic coding. All three run locally on consumer hardware. This benchmark covers HumanEval, SWE-bench, MBPP, per-token cost math, latency at different quantizations, hardware profiles, and multi-model dispatch strategy for coding workloads.',
    metaDescription: 'Qwen 3.6 Coder vs DeepSeek Coder v3 vs Mistral Devstral: HumanEval 92.1% vs 91.6% vs 90.1%, SWE-bench, MBPP, cost, and hardware. Local coding LLM benchmark 2026.',
    ...
    quickAnswerTop: {
      ...
      ja: {
        ...
        answer: '2026年5月：Qwen 3.6 27Bは16 GB VRAMでローカル実行して92.1% HumanEvalと77.2% SWE-benchを達成。DeepSeek Coder v3は$0.14/1MトークンのクラウドAPIで91.6% HumanEval。Mistral Devstral Small 24Bは90.1% HumanEvalで、エージェント型マルチステップタスクに最適。GDPR準拠のEU開発には、ローカルQwen 3.6 27Bが明確な勝者。',
        bullets: [
          'Qwen 3.6 27B — 92.1% HumanEval、77.2% SWE-bench、84.3% MBPP、16 GB VRAMローカル',
          'DeepSeek Coder v3 — 91.6% HumanEval、~75% SWE-bench、$0.14/1Mトークン クラウドAPI',
      ...
      zh: {
        ...
        answer: '2026年5月：Qwen 3.6 27B在16 GB显存下本地运行达到92.1% HumanEval和77.2% SWE-bench。DeepSeek Coder v3作为云API以$0.14/1M令牌达到91.6% HumanEval。Mistral Devstral Small 24B达到90.1% HumanEval，在智能体多步骤任务上领先。对于GDPR合规的欧盟开发，本地Qwen 3.6 27B是明确的赢家。',
        bullets: [
          'Qwen 3.6 27B — 92.1% HumanEval，77.2% SWE-bench，84.3% MBPP，16 GB显存本地',
          'DeepSeek Coder v3 — 91.6% HumanEval，~75% SWE-bench，$0.14/1M令牌云API',
    ...
    comparisonTable: {
      ...
      rows: [
        ...
        { Model: 'DeepSeek Coder v3', HumanEval: '91.6%', 'SWE-bench': '~75%', MBPP: '82.7%', Deployment: 'Cloud API', 'Input Cost ($/1M)': '$0.14', 'VRAM (local)': 'N/A (cloud)' },
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**DeepSeek Coder v3 is the cloud cost winner**: $0.14/1M input tokens, 0.5 pp below Qwen on HumanEval. Use it for non-sensitive public code at scale.',
      ...
      benchmarkTable: {
        ...
        rows: [
          { Benchmark: 'HumanEval (Python, pass@1)', 'Qwen 3.6 27B': '92.1%', 'DeepSeek Coder v3': '91.6%', 'Mistral Devstral 24B': '90.1%', 'Codestral 22B': '88.9%' },
          { Benchmark: 'SWE-bench (GitHub issues)', 'Qwen 3.6 27B': '77.2%', 'DeepSeek Coder v3': '~75%', 'Mistral Devstral 24B': '~73%', 'Codestral 22B': 'N/A' },
          { Benchmark: 'MBPP (Python problems)', 'Qwen 3.6 27B': '84.3%', 'DeepSeek Coder v3': '82.7%', 'Mistral Devstral 24B': '81.4%', 'Codestral 22B': '79.2%' },
          { Benchmark: 'Multi-lang (Java, Go, Rust)', 'Qwen 3.6 27B': '88.4%', 'DeepSeek Coder v3': '87.1%', 'Mistral Devstral 24B': '84.6%', 'Codestral 22B': '83.1%' },
        ],
        columns: ['Benchmark', 'Qwen 3.6 27B', 'DeepSeek Coder v3', 'Mistral Devstral 24B', 'Codestral 22B'],
        tableFormat: true,
        callouts: [
          { type: 'note', text: 'SWE-bench scores for DeepSeek Coder v3 and Mistral Devstral are estimated from available leaderboard data. Qwen 3.6 27B and Codestral SWE-bench scores are from official publications.' },
        ],
      },
      costMath: {
        id: 'cost-math',
...
# Break-even vs DeepSeek at 5M tokens/day: hardware_cost / (annual_cost - annual_local) ≈ 2.5 years`,
      ...
      latency: {
        ...
        rows: [
          ...
          { Model: 'DeepSeek Coder v3 (API, EU latency)', 'First Token (ms)': '150–400', 'Sustained (tok/sec)': '80–120', 'Interactive Coding?': '⚠️ Marginal' },
...
ollama run qwen3-coder`,
      ...
      dispatchStrategy: {
        ...
        content: [
          'No single coding model wins every task. Qwen 3.6 27B leads on benchmark accuracy. Devstral leads on agentic multi-file tasks. DeepSeek Coder v3 is the cheapest at scale for non-sensitive code. A dispatch layer that routes tasks by type captures the benefits of all three.',
        ...
        rows: [
          ...
          { 'Task Type': 'Code review (non-sensitive)', 'Recommended Model': 'DeepSeek Coder v3 (API)', 'Why': '$0.14/1M, good quality, high throughput' },
          ...
          { 'Task Type': 'Batch test generation', 'Recommended Model': 'DeepSeek Coder v3 (API)', 'Why': 'Cost-optimised for non-sensitive volume' },
        ],
...
# default → qwen3-coder (local)`,
      ...
      faq: {
        ...
        title: 'FAQ',
        faqs: [
          { q: 'Is Qwen 3.6 27B better than DeepSeek Coder v3 for local coding?', a: 'Yes on benchmarks: Qwen 3.6 27B scores 92.1% HumanEval vs DeepSeek Coder v3\'s 91.6% HumanEval, and 77.2% SWE-bench vs ~75%. Qwen also runs fully locally on 16 GB VRAM, making it GDPR-compliant for EU teams. DeepSeek Coder v3 is a cloud API and costs $0.14/1M input tokens — the better choice for non-sensitive high-volume code generation where local hardware is not available.' },
  ...
  de: {
    ...
    next_refresh_due: '2026-11-16',
    theme: 'Best Models',
    title: 'Qwen 3.6 Coder vs. DeepSeek Coder v3 vs. Mistral Devstral: Lokaler Coding-Benchmark 2026',
    seoTitle: 'Qwen 3.6 Coder vs. DeepSeek Coder v3 vs. Mistral Devstral: Benchmark 2026',
    intro: 'Qwen 3.6 27B erreicht 92,1% HumanEval und 77,2% SWE-bench lokal auf 16 GB VRAM. DeepSeek Coder v3 erreicht 91,6% HumanEval als Cloud-API. Mistral Devstral Small 24B erreicht 90,1% HumanEval und fuehrt bei agentischen Multi-Datei-Aufgaben.',
    metaDescription: 'Qwen 3.6 Coder vs. DeepSeek Coder v3 vs. Mistral Devstral: HumanEval, SWE-bench, MBPP, Kosten und Hardware im Vergleich. Lokaler Coding-LLM-Benchmark 2026.',
    publishDate: '2026-05-16',
    dateModified: '2026-05-16',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'DeepSeek Coder v3 ist der Cloud-Kostensieger: 0,14 $/1M Token, 0,5 Prozentpunkte hinter Qwen bei HumanEval.',
  ...
  fr: {
    ...
    next_refresh_due: '2026-11-16',
    theme: 'Best Models',
    title: 'Qwen 3.6 Coder vs DeepSeek Coder v3 vs Mistral Devstral : Benchmark Code Local 2026',
    seoTitle: 'Qwen 3.6 Coder vs DeepSeek Coder v3 vs Mistral Devstral : Benchmark 2026',
    intro: 'Qwen 3.6 27B obtient 92,1% HumanEval et 77,2% SWE-bench en local sur 16 Go VRAM. DeepSeek Coder v3 obtient 91,6% HumanEval en API cloud. Mistral Devstral Small 24B obtient 90,1% HumanEval et excelle sur les tâches agentiques multi-fichiers.',
    metaDescription: 'Qwen 3.6 Coder vs DeepSeek Coder v3 vs Mistral Devstral : HumanEval, SWE-bench, MBPP, coûts et matériel comparés. Benchmark LLM de code local 2026.',
    publishDate: '2026-05-16',
    dateModified: '2026-05-16',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'DeepSeek Coder v3 est le champion du coût cloud : 0,14 $/1M tokens, 0,5 pp derrière Qwen sur HumanEval.',
  ...
  ja: {
    ...
    next_refresh_due: '2026-11-16',
    theme: 'Best Models',
    title: 'Qwen 3.6 Coder vs DeepSeek Coder v3 vs Mistral Devstral：ローカルコーディングベンチマーク 2026',
    seoTitle: 'Qwen 3.6 Coder vs DeepSeek Coder v3 vs Mistral Devstral：2026ベンチマーク',
    intro: 'Qwen 3.6 27Bは16 GB VRAMでローカル実行して92.1% HumanEvalと77.2% SWE-benchを達成。DeepSeek Coder v3はクラウドAPIで91.6% HumanEval。Mistral Devstral Small 24Bは90.1% HumanEvalで、エージェント型マルチファイルタスクに最適。',
    metaDescription: 'Qwen 3.6 Coder vs DeepSeek Coder v3 vs Mistral Devstral：HumanEval、SWE-bench、MBPP、コスト、ハードウェアを比較。ローカルコーディングLLMベンチマーク2026。',
    publishDate: '2026-05-16',
    dateModified: '2026-05-16',
    readTime: '9分で読めます',
    sections: {
      tldr: {
        ...
        items: [
          ...
          'DeepSeek Coder v3がクラウドコスト最安：$0.14/1Mトークン、HumanEvalでQwenに0.5ポイント差。',
  ...
  zh: {
    ...
    next_refresh_due: '2026-11-16',
    theme: 'Best Models',
    title: 'Qwen 3.6 Coder vs DeepSeek Coder v3 vs Mistral Devstral：本地编程基准测试 2026',
    seoTitle: 'Qwen 3.6 Coder vs DeepSeek Coder v3 vs Mistral Devstral：2026基准测试',
    intro: 'Qwen 3.6 27B在16 GB显存下本地运行达到92.1% HumanEval和77.2% SWE-bench。DeepSeek Coder v3作为云API达到91.6% HumanEval。Mistral Devstral Small 24B达到90.1% HumanEval，在智能体多文件任务上领先。',
    metaDescription: 'Qwen 3.6 Coder vs DeepSeek Coder v3 vs Mistral Devstral：HumanEval、SWE-bench、MBPP、成本和硬件比较。本地编程LLM基准测试2026。',
    publishDate: '2026-05-16',
    dateModified: '2026-05-16',
    readTime: '9分钟阅读',
    sections: {
      tldr: {
        ...
        items: [
          ...
          'DeepSeek Coder v3是云端成本冠军：$0.14/1M令牌，HumanEval比Qwen低0.5个百分点。',
