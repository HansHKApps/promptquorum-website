...
schema: {
    ...
    ar: {
      ...
      seoTitle: 'هندسة الأوامر لنماذج LLM المحلية 2026: CoT وFew-Shot',
      ...
      metaDescription: 'يرفع أمر سلسلة التفكير دقة النماذج بحجم 7B بنسبة 10–20%. يتفوق few-shot (3–5 أمثلة) على zero-shot بنسبة 15–25%. دليل أمر النظام.',
      publishDate: '2026-04-04',
      dateModified: '2026-04-25',
