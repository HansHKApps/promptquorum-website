...
schema: {
    ...
    ar: {
      ...
      seoTitle: 'حزمة LLM محلية للمطورين 2026: من CLI إلى الإنتاج',
      ...
      metaDescription: 'بيئة تطوير محلية بـ LLM من 3 مستويات: Ollama CLI (5 دقائق)، وvLLM + FastAPI (30 دقيقة)، والإنتاج متعدد GPU. تتكامل مع VS Code وCursor.',
