...
schema: {
    ...
    es: {
      ...
      seoTitle: 'Stack Local LLM para Devs: CLI → API → Guía de Producción 2026',
      ...
      metaDescription: 'Entorno de desarrollo local con LLM en 3 niveles: (1) Ollama CLI en 5 min, (2) vLLM + FastAPI en 30 min, (3) producción multi-GPU con nginx y Prometheus. Integración con VS Code y Cursor. Abril 2026.',
