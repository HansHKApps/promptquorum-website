      ...
      sections: {
        ...
        'sources': {
          ...
          items: [
            ...
            '[Qwen3-Coder Model Card](https://huggingface.co/Qwen/Qwen3-Coder-7B-Instruct) -- Alibaba. 82% HumanEval، رخصة Apache 2.0. أفضل نموذج برمجة بأقل من 8 GB من VRAM.',
          ],
        },
      },
      itemListSchema: {
      ...
      sections: {
        ...
        'sources': {
          ...
          items: [
            ...
            '[Qwen3-Coder 모델 카드](https://huggingface.co/Qwen/Qwen3-Coder-7B-Instruct) -- Alibaba. 82% HumanEval, Apache 2.0 라이선스. 8 GB VRAM 미만에서 최고의 코딩 모델.',
          ],
        },
      },
      itemListSchema: {
