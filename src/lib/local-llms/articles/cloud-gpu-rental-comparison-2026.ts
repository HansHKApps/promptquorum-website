  ...
  de: {
    ...
    sections: {
      ...
      gdprChecklist: {
        ...
        callout: 'Für EU-Kunden, die DSGVO-konforme Optionen ausführlich vergleichen möchten, siehe unser dediziertes [EU DSGVO-konformes Cloud-GPU-Vergleich →](/local-llms/eu-cloud-gpu-gdpr-2026?lang=de) mit Hetzner, Scaleway, OVHcloud, Nebius und anderen mit detaillierter Schrems-II-Analyse.',
      },
      contrarian: {
        id: 'when-not-cloud',
  ...
  fr: {
    ...
    sections: {
      ...
      gdprChecklist: {
        ...
        callout: 'Pour les clients UE comparant les options conformes au RGPD en profondeur, voir notre [Comparaison cloud GPU conforme au RGPD UE dédiée →](/local-llms/eu-cloud-gpu-gdpr-2026?lang=fr) couvrant Hetzner, Scaleway, OVHcloud, Nebius, et autres avec analyse détaillée Schrems II.',
      },
      contrarian: {
        id: 'when-not-cloud',
  ...
  ja: {
    ...
    sections: {
      ...
      gdprChecklist: {
        ...
        callout: 'GDPR対応クラウドGPUオプションを深く比較したいEU顧客向けに、Hetzner、Scaleway、OVHcloud、Nebiusなどをカバーする詳細なSchrems II分析を含む専用[EU GDPR対応クラウドGPU比較→](/local-llms/eu-cloud-gpu-gdpr-2026?lang=ja)を参照してください。',
      },
      contrarian: {
        id: 'when-not-cloud',
  ...
  zh: {
    ...
    sections: {
      ...
      gdprChecklist: {
        ...
        callout: '对于想要深入比较GDPR合规云GPU选项的EU客户,请参阅我们的专用[EU GDPR合规云GPU比较→](/local-llms/eu-cloud-gpu-gdpr-2026?lang=zh),涵盖Hetzner、Scaleway、OVHcloud、Nebius等,包含详细的Schrems II分析。',
      },
      contrarian: {
        id: 'when-not-cloud',
