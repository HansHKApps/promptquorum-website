    ...
    en: {
      ...
      sections: {
        ...
        'speed-diff': {
          ...
          image: '/images/rtx-5090-vs-rtx-4090-local-llm-speed-comparison-hero-en.png',
        ...
        'cost-per-token': {
          ...
          image: '/images/rtx-5090-vs-rtx-4090-local-llm-cost-per-token-hero-en.png',
        ...
        'faqSection': {
          ...
          faqs: [
            { q: 'Is RTX 5090 worth it for running Llama 3.3 70B?', a: 'Depends. 4090 gives you ~36 tok/s on 70B Q4 which is usable. 5090 gives ~52 tok/s — 40% faster. The extra speed costs $1,000. Worth it if you\'re running 70B continuously; not worth it for occasional use.' },
            { q: 'Should I buy RTX 5090 or two RTX 4090s?', a: 'Two 4090s (~$2,500 used) beat 5090 ($1,999) on raw 70B speed (~72 tok/s combined). But two-GPU setups have complexity: tensor parallelism, driver overhead, space. 5090 is simpler and adds 32GB unified VRAM for 34B Q8 use cases.' },
            { q: 'Does RTX 5090 have better VRAM than 4090?', a: 'Yes. RTX 5090 has 32GB GDDR7, RTX 4090 has 24GB GDDR6X. The 8GB extra lets 5090 run 34B Q8 models (~28GB needed) without squeezing. Both cards cannot fit 70B Q4 (~38-40GB) without splitting across GPUs.' },
            { q: 'Is the RTX 5090 overkill for a 14B model?', a: 'Yes, for most use cases. A 14B Q4 model needs ~9GB VRAM and runs at ~55-65 tok/s on a 4090 — already fast. The 5090 would give ~65-75 tok/s, a marginal improvement. The 4090 or even a 3090 is more cost-effective for 14B inference.' },
...
schema: {
    ...
    es: {
      ...
      heroImage: '/images/rtx-5090-vs-rtx-4090-local-llm-speed-comparison-hero-es.png',
      publishDate: '2026-04-05',
      dateModified: '2026-06-21',
      leadAnswerBlock: '**Para LLMs locales, la RTX 5090 es un 20-25% más rápida que la RTX 4090, pero cuesta $1.000 más. En junio de 2026, la elección depende de si ejecutas modelos de 70B (la 5090 gana) o modelos de 7B-13B (la 4090 ya es excesiva).**',
      ...
      sections: {
        ...
        'speed-diff': {
          ...
          image: '/images/rtx-5090-vs-rtx-4090-local-llm-speed-comparison-hero-es.png',
        ...
        'cost-per-token': {
          ...
          image: '/images/rtx-5090-vs-rtx-4090-local-llm-cost-per-token-hero-es.png',
    ...
    ar: {
      ...
      intro: '**لنماذج LLM المحلية، RTX 5090 أسرع بـ 20-25% من RTX 4090، لكنها تكلّف $1,000 أكثر.** في يونيو 2026، يعتمد الاختيار على ما إذا كنت تشغّل نماذج 70B (تفوز 5090) أو نماذج 7B-13B (4090 مبالغ فيها بالفعل). إذا كنت تملك 4090، فالترقية ليست مجدية. إذا اشتريت جديدًا، تقدّم RTX 5080 نسبة أداء-سعر أفضل.',
      ...
      heroImage: '/images/rtx-5090-vs-rtx-4090-local-llm-speed-comparison-hero-ar.png',
      publishDate: '2026-04-05',
      dateModified: '2026-06-21',
      leadAnswerBlock: '**لنماذج LLM المحلية، RTX 5090 أسرع بـ 20-25% من RTX 4090، لكنها تكلّف $1,000 أكثر. في يونيو 2026، يعتمد الاختيار على ما إذا كنت تشغّل نماذج 70B (تفوز 5090) أو نماذج 7B-13B (4090 مبالغ فيها بالفعل).**',
      ...
      sections: {
        ...
        'speed-diff': {
          ...
          image: '/images/rtx-5090-vs-rtx-4090-local-llm-speed-comparison-hero-ar.png',
        ...
        'cost-per-token': {
          ...
          image: '/images/rtx-5090-vs-rtx-4090-local-llm-cost-per-token-hero-ar.png',
    ...
    de: {
      ...
      intro: '**Für lokale LLMs ist RTX 5090 20–25% schneller als RTX 4090, kostet aber 1.000€ mehr.** Im Juni 2026 hängt die Wahl davon ab, ob Sie 70B-Modelle (5090 gewinnt) oder 7B-13B-Modelle (4090 ist ohnehin Overkill) ausführen. Falls Sie bereits eine 4090 besitzen, lohnt sich ein Upgrade nicht. Wenn Sie neu kaufen, bietet die RTX 5080 eine bessere Performance-pro-Euro.',
      ...
      heroImage: '/images/rtx-5090-vs-rtx-4090-local-llm-speed-comparison-hero-de.png',
      publishDate: '2026-04-05',
      dateModified: '2026-06-21',
      leadAnswerBlock: '**Für lokale LLMs ist RTX 5090 20–25% schneller als RTX 4090, kostet aber 1.000€ mehr. Im Juni 2026 hängt die Wahl davon ab, ob Sie 70B-Modelle (5090 gewinnt) oder 7B-13B-Modelle (4090 ist ohnehin Overkill) ausführen.**',
      ...
      sections: {
        ...
        'speed-diff': {
          ...
          image: '/images/rtx-5090-vs-rtx-4090-local-llm-speed-comparison-hero-de.png',
        ...
        'vram-diff': {
          ...
          content: [
            '**RTX 5090 hat 32GB GDDR7, RTX 4090 hat 24GB GDDR6X.** Die 8GB Unterschied ist relevant für bestimmte Modellgrößen.',
            '34B Q8 Modelle (~28GB) passen problemlos in 32GB, aber kaum in 24GB. Für 7B–13B Modelle sind 24GB mehr als genug für beide Karten.',
          ],
        },
        'cost-per-token': {
          id: 'cost-per-token',
          ...
          image: '/images/rtx-5090-vs-rtx-4090-local-llm-cost-per-token-hero-de.png',
 ...
 isTldr: true, items: ['RTX 3060 12GB（€150-190二手）是7B-13B型号的最佳预算选择。', 'RTX 4060 Ti 8GB（€220-250新品）提供更新技术，但VRAM有限。', '永远不要为本地LLM购买2GB/4GB卡----最小VRAM是8GB。', '二手企业卡（RTX A2000、A4000）提供12GB-16GB VRAM €100-200。', 'GPU预算€200-300，系统其他部分€300-400避免瓶颈。', '对于预算GPU，避免DDR5 RAM和高端CPU。'] },
    ...
    pt: {
      ...
      intro: '**Para LLMs locais, a RTX 5090 é 20-25% mais rápida que a RTX 4090, mas custa cerca de R$ 9.000 a mais.** Em junho de 2026, a escolha depende de você rodar modelos 70B (a 5090 vence) ou modelos 7B-13B (a 4090 já é exagero). Se você já tem uma 4090, fazer upgrade não compensa. Se for comprar nova, a RTX 5080 oferece melhor relação desempenho-preço.',
      ...
      heroImage: '/images/rtx-5090-vs-rtx-4090-local-llm-speed-comparison-hero-pt.png',
      publishDate: '2026-04-05',
      dateModified: '2026-06-21',
      leadAnswerBlock: '**Para LLMs locais, a RTX 5090 é 20-25% mais rápida que a RTX 4090, mas custa cerca de R$ 9.000 a mais. Em junho de 2026, a escolha depende de você rodar modelos 70B (a 5090 vence) ou modelos 7B-13B (a 4090 já é exagero).**',
      ...
      sections: {
        ...
        'speed-diff': {
          ...
          image: '/images/rtx-5090-vs-rtx-4090-local-llm-speed-comparison-hero-pt.png',
        ...
        'cost-per-token': {
          ...
          image: '/images/rtx-5090-vs-rtx-4090-local-llm-cost-per-token-hero-pt.png',
  ...
  ko: {
      ...
      intro: '**로컬 LLM 기준으로 RTX 5090은 RTX 4090보다 20~25% 빠르지만 가격은 $1,000 더 비쌉니다.** 2026년 6월 현재, 선택 기준은 70B 모델을 실행하느냐(5090 우세) 아니면 7B~13B 모델을 실행하느냐(어차피 4090도 과스펙)에 달려 있습니다. 이미 4090을 보유하고 있다면 업그레이드는 비용 효율적이지 않습니다. 새로 구매한다면 RTX 5080이 가격 대비 성능 면에서 더 유리합니다.',
      metaDescription: 'RTX 5090 vs RTX 4090 로컬 LLM 비교: 속도, VRAM 분석, 토큰당 비용, 업그레이드 시점 가이드.',
      heroImage: '/images/rtx-5090-vs-rtx-4090-local-llm-speed-comparison-hero-ko.png',
      publishDate: '2026-04-05',
      dateModified: '2026-06-21',
      leadAnswerBlock: '**로컬 LLM 기준으로 RTX 5090은 RTX 4090보다 20~25% 빠르지만 가격은 $1,000 더 비쌉니다. 2026년 6월 현재, 선택 기준은 70B 모델을 실행하느냐(5090 우세) 아니면 7B~13B 모델을 실행하느냐(어차피 4090도 과스펙)에 달려 있습니다.**',
      ...
      sections: {
        ...
        'speed-diff': {
          ...
          image: '/images/rtx-5090-vs-rtx-4090-local-llm-speed-comparison-hero-ko.png',
        ...
        'cost-per-token': {
          ...
          image: '/images/rtx-5090-vs-rtx-4090-local-llm-cost-per-token-hero-ko.png',
