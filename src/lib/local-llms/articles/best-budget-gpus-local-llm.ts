...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      seoTitle: 'RTX 3060 12GB: Qwen 3 8B (16-20 tok/sec), Llama 4 Scout (2026)',
...
schema: {
 ...
 isTldr: true, items: ['**RTX 3060 12GB**（中古$200–250）：すべての7Bモデルとほとんどの13BをQ4で実行。プラスLlama 4 Scout（MoE）~10GB — 最良の全体品質。', '**RTX 3060 6GB**：3Bモデルのみ（Phi-4 Mini、Llama 3.2 3B）。7Bには不足。', '**12GBでの最良総合モデル：** Llama 4 Scout 17B（MoE）~10GB VRAM、12–16トークン/秒。稠密30Bモデルに匹敵する品質。', '**12GBでの最良コーディングモデル：** Qwen3 8B、16–20トークン/秒。Qwen3より改善。', '**12GBでの最良推論モデル：** DeepSeek-R1 7B、10–12トークン/秒。', '**対象外：** 70Bモデルや13B Q8が必要な場合は24GB（RTX 4090）が必要。'] },
        ...
        'relatedReading': { title: '関連資料', items: ['[ローカルLLMに必要なVRAMはいくらか](/local-llms/how-much-vram-local-llm?lang=ja)', '[コンシューマーハードウェアの70Bモデル](/local-llms/70b-models-consumer-hardware?lang=ja)', '[RTX 5090 vs RTX 4090](/local-llms/rtx-5090-vs-rtx-4090-local-llm?lang=ja)', '[ローカルLLM用の中古GPU](/local-llms/used-gpus-for-local-llms?lang=ja)', '[ローカルLLM向けの最高のGPU](/local-llms/best-gpus-for-local-llms?lang=ja)', '[VRAM計算機](/local-llms/how-much-vram-local-llm?lang=ja)', '[Mac Mini M5ローカルAIサーバーとして](/local-llms/mac-mini-m5-local-ai-server?lang=ja)', '[ローカルLLM向けApple Silicon対NVIDIA GPU](/local-llms/apple-silicon-vs-nvidia-gpu-local-llm?lang=ja)', '[Apple Silicon向けベストモデル2026](/local-llms/best-models-apple-silicon-2026?lang=ja)'] },
