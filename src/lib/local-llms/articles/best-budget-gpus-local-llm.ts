      ...
      sections: {
        ...
        'relatedReading': {
          ...
          items: [
            ...
            '[Apple Silicon vs NVIDIA GPU for Local LLMs](/local-llms/apple-silicon-vs-nvidia-gpu-local-llm) — Full cost and performance comparison: when a Mac beats a budget GPU.',
      ...
      sections: {
        ...
        'relatedReading': {
          ...
          items: [
            ...
            '[Apple Silicon vs NVIDIA GPU für lokale LLMs](/local-llms/apple-silicon-vs-nvidia-gpu-local-llm?lang=de) — Vollständiger Kosten- und Leistungsvergleich: wann schlägt ein Mac ein Budget-GPU.',
