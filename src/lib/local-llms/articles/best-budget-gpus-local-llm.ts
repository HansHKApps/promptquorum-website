      ...
      sections: {
        ...
        'best-by-use-case': {
          ...
          items: [
            ...
            '**Coding:** `ollama run qwen3:8b` — Improved coding performance over Qwen3. 5 GB VRAM. 16–20 tok/sec.',
...
schema: {
    ...
    de: {
      ...
      sections: {
        ...
        'rtx-3060-12gb': {
          ...
          rows: [
            { 'Modell': 'Llama 4 Scout 17B', 'Größe': '17B aktiv (109B MoE)', 'Quantisierung': 'Q4_K_M', 'VRAM': '~10 GB', 'Geschwindigkeit': '12–16 Tok/Sek', 'Ideal für': 'Beste Gesamtqualität (MoE)' },
            { 'Modell': 'Llama 3.2 7B', 'Größe': '7B', 'Quantisierung': 'Q4_K_M', 'VRAM': '~7 GB', 'Geschwindigkeit': '15–20 Tok/Sek', 'Ideal für': 'Chat, Frage-Antwort (Legacy)' },
            { 'Modell': 'Mistral 7B v0.3', 'Größe': '7B', 'Quantisierung': 'Q4_K_M', 'VRAM': '~7 GB', 'Geschwindigkeit': '18 Tok/Sek', 'Ideal für': 'Instruktionsfolge' },
            { 'Modell': 'Qwen3 8B', 'Größe': '8B', 'Quantisierung': 'Q4_K_M', 'VRAM': '~7 GB', 'Geschwindigkeit': '16–20 Tok/Sek', 'Ideal für': 'Coding (Verbesserung zu Qwen2.5)' },
        ...
        'best-by-use-case': {
          ...
          content: [
            ...
            'Budget-Hardware läuft kleinere Modelle — aber gezieltes Prompting schließt die Qualitätslücke. Der [Prompt-Engineering-Guide](https://www.promptquorum.com/prompt-engineering?lang=de) deckt Techniken wie Chain-of-Thought und strukturierte Ausgaben ab, die kleineren Modellen helfen, über ihrem Gewicht zu boxen. Ein konkreter Workload, der genau auf die RTX 3060 12 GB passt, ist automatisierter Pull-Request-Review — siehe [Lokales LLM-Code-Review in CI/CD](/power-local-llm/local-llm-code-review-ci-cd?lang=de) für das GitHub-Actions-Muster, das Qwen3 8B auf genau dieser Hardware gegen PRs laufen lässt.',
          ],
          items: [
        ...
        'faqSection': {
          ...
          faqs: [
            { q: 'Ist RTX 3060 12GB noch 2026 wert?', a: 'Ja. Sie ist 4+ Jahre alt, aber 12GB VRAM ist zeitlos. Lädt Llama 4 Scout 17B (MoE), Qwen3 8B und Mistral 7B reibungslos. Die MoE-Architektur von Llama 4 Scout bedeutet, 12 GB VRAM ist jetzt genug für Modellqualität, die früher 16+ GB erforderte.' },
            ...
            { q: 'Kann ich Ollama mit einer €100-Budget-GPU ausführen?', a: 'Ja. Ollama ist leichtgewichtig. Eine 4 Jahre alte RTX 3060 mit Ollama lädt Llama 4 Scout bei 12-16 Tok/Sek oder Qwen3 8B bei 16-20 Tok/Sek — völlig nutzbar für interaktiven Chat und Code-Unterstützung.' },
            ...
            { q: 'Kann ich Llama 4 Scout auf einer RTX 3060 12GB ausführen?', a: 'Ja. Llama 4 Scout nutzt MoE-Architektur — 17B Parameter aktiv von 109B insgesamt. Bei Q4_K_M nutzt es ~10 GB VRAM und passt komfortabel in den RTX 3060 12GB-Speicher. Erwarten Sie 12-16 Tok/Sek. Dies ist das einzelne beste Upgrade für RTX 3060-Besitzer 2026: `ollama pull llama4:scout`.' },
          ],
        },
        'recommended-setups': {
        ...
        'relatedReading': {
          ...
          items: [
            ...
            '[Prompt Engineering für lokale Modelle](/prompt-engineering/prompt-engineering-for-local-models?lang=de) — Prompts für Modelle auf Budget-Hardware optimieren.',
            '[Chain-of-Thought Prompting](/prompt-engineering/chain-of-thought-prompting?lang=de) — Verbessert DeepSeek-R1 Output-Qualität erheblich.',
            '[Mac Mini M5 als lokaler KI-Server](/local-llms/mac-mini-m5-local-ai-server?lang=de) — Budget-Alternative zu GPU-Builds: Dauerbetrieb-KI für 599 $ Hardware + 35 $/Jahr Strom.',
            '[Apple Silicon M5 für lokale LLMs](/local-llms/apple-silicon-m5-local-llm?lang=de) — Vollständiger M5 Pro/Max-Leitfaden: Benchmarks, Mac-Konfigurationen, Speicherstufen und welcher Mac zum Kauf für lokale Inferenz.',
            '[Apple Silicon vs NVIDIA GPU für lokale LLMs](/power-local-llm/apple-mlx-vs-nvidia-cuda-local-llm-2026?lang=de) — Vollständiger Kosten- und Leistungsvergleich: wann schlägt ein Mac ein Budget-GPU.',
            '[Beste Modelle für Apple Silicon 2026](/local-llms/best-models-apple-silicon-2026?lang=de) — Modellempfehlungen für 16 GB–128 GB Unified Memory.',
 ...
 isTldr: true, items: ['**RTX 3060 12 Go** (200–250 $ d\'occasion) : Exécute tous les 7B et la plupart des 13B en Q4. Plus Llama 4 Scout (MoE) à ~10 Go — meilleure qualité.', '**RTX 3060 6 Go** : Limité aux modèles 3B (Phi-4 Mini, Llama 3.2 3B). Trop juste pour 7B.', '**Meilleur modèle global sur 12 Go :** Llama 4 Scout 17B (MoE) à ~10 Go VRAM, 12–16 tok/sec. Qualité comparable aux modèles denses 30B.', '**Meilleur modèle code sur 12 Go :** Qwen3 8B à 16–20 tok/sec. Amélioration vs Qwen3.', '**Meilleur modèle raisonnement sur 12 Go :** DeepSeek-R1 7B à 10–12 tok/sec.', '**À éviter si :** vous voulez des modèles 70B ou 13B en Q8 — il faut 24 Go (RTX 4090).'] },
        'rtx-3060-12gb': {
          id: 'rtx-3060-12gb',
          ...
          rows: [
            { 'Modèle': 'Llama 4 Scout 17B', 'Taille': '17B actif (109B MoE)', 'Quantification': 'Q4_K_M', 'VRAM': '~10 Go', 'Vitesse': '12–16 tok/sec', 'Idéal pour': 'Meilleure qualité globale (MoE)' },
            { 'Modèle': 'Llama 3.2 7B', 'Taille': '7B', 'Quantification': 'Q4_K_M', 'VRAM': '~7 Go', 'Vitesse': '15–20 tok/sec', 'Idéal pour': 'Chat, Q&R (Legacy)' },
            { 'Modèle': 'Mistral 7B v0.3', 'Taille': '7B', 'Quantification': 'Q4_K_M', 'VRAM': '~7 Go', 'Vitesse': '18 tok/sec', 'Idéal pour': 'Suivi d\'instructions' },
            { 'Modèle': 'Qwen3 8B', 'Taille': '8B', 'Quantification': 'Q4_K_M', 'VRAM': '~7 Go', 'Vitesse': '16–20 tok/sec', 'Idéal pour': 'Code (Amélioration Qwen2.5)' },
        ...
        'best-by-use-case': {
          ...
          content: [
            ...
            'Le matériel d\'entrée de gamme fait tourner des modèles plus petits — mais un prompting habile comble l\'écart de qualité. Le [guide de prompt engineering](https://www.promptquorum.com/prompt-engineering?lang=fr) couvre des techniques comme la chain-of-thought et les sorties structurées qui aident les modèles plus petits à performer au-delà de leur taille. Un cas d\'usage concret qui rentre dans le palier RTX 3060 12 Go est la revue automatique de pull-requests — voir [Revue de code par LLM local en CI/CD](/power-local-llm/local-llm-code-review-ci-cd?lang=fr) pour le pattern GitHub Actions qui fait tourner Qwen3 8B contre des PR sur exactement ce matériel.',
          ],
          items: [
        ...
        'mistakes': { title: 'Quelles erreurs GPU budget devriez-vous éviter?', items: ['Acheter une RTX 2060 4GB et s\'attendre à une inférence 7B fluide--vous aurez constamment des erreurs de mémoire insuffisante.', 'Associer un GPU à 300 € avec un PSU à 30 € (alimentation)--la chute de tension tue la stabilité. Budgétisez 80+ Gold certifié, 650W minimum.', 'Supposer que la RAM DDR5 et le CPU i9 accélèrent l\'inférence des LLM--ils ne le font pas. La bande passante du VRAM GPU est le seul goulot qui affecte la vitesse d\'inférence.', 'Ne pas essayer Llama 4 Scout sur 12 Go VRAM. De nombreux propriétaires RTX 3060 supposent qu\'ils sont limités à des modèles denses 7B-8B. Llama 4 Scout (MoE, 17B actif / 109B total) tient à ~10 Go et offre une qualité comparable aux modèles denses 30B. Si vous avez 12 Go VRAM et n\'avez pas essayé Scout, vous sous-utilisez considérablement votre matériel.', 'Acheter une carte 16 Go juste pour les modèles 13B. Avec Llama 4 Scout disponible à ~10 Go, la mise à niveau 12→16 Go est moins nécessaire qu\'il y a six mois. Mettez à niveau à 16 Go uniquement si vous avez spécifiquement besoin de Llama 3.1 70B, Mistral Small 3.1 ou d\'autres modèles denses 20B+.'] },
        ...
        'relatedReading': { title: 'Lecture Associée', items: ['[Combien de VRAM pour les LLM locaux](/local-llms/how-much-vram-local-llm?lang=fr)', '[Modèles 70B sur matériel grand public](/local-llms/70b-models-consumer-hardware?lang=fr)', '[RTX 5090 vs RTX 4090](/local-llms/rtx-5090-vs-rtx-4090-local-llm?lang=fr)', '[GPU d\'occasion pour LLM locaux](/local-llms/used-gpus-for-local-llms?lang=fr)', '[Meilleurs GPU pour LLM locaux](/local-llms/best-gpus-for-local-llms?lang=fr)', '[Calculatrice VRAM](/local-llms/how-much-vram-local-llm?lang=fr)', '[Prompt Engineering pour modèles locaux](/prompt-engineering/prompt-engineering-for-local-models?lang=fr) — optimisez les prompts pour les modèles sur matériel budget.', '[Chain-of-Thought Prompting](/prompt-engineering/chain-of-thought-prompting?lang=fr) — améliore considérablement la qualité des résultats DeepSeek-R1.', '[Mac Mini M5 comme serveur IA local](/local-llms/mac-mini-m5-local-ai-server?lang=fr) — Alternative budget aux builds GPU : IA en continu à 599 $ matériel + 35 $/an d\'électricité.', '[Apple Silicon M5 pour les LLM locaux](/local-llms/apple-silicon-m5-local-llm?lang=fr) — Guide complet M5 Pro/Max : benchmarks, configurations Mac, niveaux de mémoire et quel Mac acheter pour l\'inférence locale.', '[Apple Silicon vs NVIDIA GPU pour les LLM locaux](/power-local-llm/apple-mlx-vs-nvidia-cuda-local-llm-2026?lang=fr) — Comparaison complète coût et performance : quand un Mac bat un GPU budget.', '[Meilleurs modèles pour Apple Silicon 2026](/local-llms/best-models-apple-silicon-2026?lang=fr) — Recommandations de modèles pour 16 Go–128 Go de mémoire unifiée.', 'Pour les prix des GPU spécifiques au Japon, les revendeurs d\'Akihabara et les options du marché d\'occasion sur Mercari et Yahoo Auctions, consultez notre <a href="/fr/prompt-bites/best-gpu-local-llm-japan-price" class="text-primary hover:underline">guide du meilleur GPU qualité-prix au Japon</a>.'] },
    ...
    ja: {
      ...
      intro: '**RTX 3060 12GBはLlama 4 Scout 17B（MoE）を12–16トークン/秒、Qwen3 8Bを16–20トークン/秒、Mistral 7Bを18トークン/秒、DeepSeek-R1 7Bを10–12トークン/秒で実行します — すべてQ4量子化。** 6GB版は3Bモデルのみ対応。2026年5月時点、RTX 3060 12GB（中古$200–250）はローカルLLM用の最良バジェットGPUです。12GB VRAMはすべての7BとほとんどのQ413Bモデルに対応し、さらにLlama 4 Scout（MoE）は7B-8B稠密モデルを大きく上回る品質を提供します。',
      metaDescription: 'RTX 3060 12GB（中古約2万5千円）は2026年の7Bモデル向け最高のコスパGPUです。VRAM・価格・推論速度でLlama 4 Scout対応の5つのGPUを比較しました。13B対応のVRAM閾値に注意が必要です。',
      nextStep: {
 ...
 isTldr: true, items: ['**RTX 3060 12GB**（中古$200–250）：すべての7Bモデルとほとんどの13BをQ4で実行。プラスLlama 4 Scout（MoE）~10GB — 最良の全体品質。', '**RTX 3060 6GB**：3Bモデルのみ（Phi-4 Mini、Llama 3.2 3B）。7Bには不足。', '**12GBでの最良総合モデル：** Llama 4 Scout 17B（MoE）~10GB VRAM、12–16トークン/秒。稠密30Bモデルに匹敵する品質。', '**12GBでの最良コーディングモデル：** Qwen3 8B、16–20トークン/秒。Qwen3より改善。', '**12GBでの最良推論モデル：** DeepSeek-R1 7B、10–12トークン/秒。', '**対象外：** 70Bモデルや13B Q8が必要な場合は24GB（RTX 4090）が必要。'] },
        ...
        'best-by-use-case': { id: 'best-by-use-case', title: 'RTX 3060でのユースケース別最適モデル', content: ['**パラメータ数ではなく、実際のニーズに基づいてモデルを選択してください：**', 'バジェットハードウェアは小さなモデルを実行しますが、巧みなプロンプティングが品質差を縮めます。[プロンプトエンジニアリングガイド](https://www.promptquorum.com/prompt-engineering?lang=ja)では、Chain-of-Thoughtや構造化出力など、小さなモデルの実力を引き出すテクニックを解説しています。RTX 3060 12 GB の VRAM に収まる具体的なワークロードのひとつが、プルリクエストの自動レビューです。まさに同じハードウェア上で Qwen3 8B を PR にぶつける GitHub Actions のパターンは、[CI/CD でのローカル LLM コードレビュー](/power-local-llm/local-llm-code-review-ci-cd?lang=ja)で解説しています。'], items: ['**チャット / Q&A：** `ollama run llama3.2:7b` — 最良の万能モデル。15–20トークン/秒。128Kコンテキスト。', '**コーディング：** `ollama run qwen2.5-coder:7b` — 72% HumanEval。16トークン/秒。Python、JavaScript、SQL。', '**推論 / 数学：** `ollama run deepseek-r1:7b` — Chain-of-Thought。10–12トークン/秒。', '**ライティング / クリエイティブ：** `ollama run mistral:7b` — 最良の指示従行。18トークン/秒。', '**ビジョン / 画像：** `ollama run gemma4:9b` — マルチモーダル。12–15トークン/秒。~8GB VRAM。', '**プライバシー / オフライン：** 上記すべて。100%ローカル。データは外部送信されません。'] },
        ...
        'relatedReading': { title: '関連資料', items: ['[ローカルLLMに必要なVRAMはいくらか](/local-llms/how-much-vram-local-llm?lang=ja)', '[コンシューマーハードウェアの70Bモデル](/local-llms/70b-models-consumer-hardware?lang=ja)', '[RTX 5090 vs RTX 4090](/local-llms/rtx-5090-vs-rtx-4090-local-llm?lang=ja)', '[ローカルLLM用の中古GPU](/local-llms/used-gpus-for-local-llms?lang=ja)', '[ローカルLLM向けの最高のGPU](/local-llms/best-gpus-for-local-llms?lang=ja)', '[VRAM計算機](/local-llms/how-much-vram-local-llm?lang=ja)', '[Mac Mini M5ローカルAIサーバーとして](/local-llms/mac-mini-m5-local-ai-server?lang=ja)', '[ローカルLLM向けApple Silicon M5](/local-llms/apple-silicon-m5-local-llm?lang=ja) — M5 Pro/Max完全ガイド：ベンチマーク、Mac構成、メモリ層、ローカル推論用Mac購入ガイド', '[ローカルLLM向けApple Silicon対NVIDIA GPU](/power-local-llm/apple-mlx-vs-nvidia-cuda-local-llm-2026?lang=ja)', '[Apple Silicon向けベストモデル2026](/local-llms/best-models-apple-silicon-2026?lang=ja)', '秋葉原の販売店、メルカリ・Yahoo!オークションの中古市場を含む日本のGPU価格については、<a href="/ja/prompt-bites/best-gpu-local-llm-japan-price" class="text-primary hover:underline">日本でコスパ最強のローカルLLM用GPUガイド</a>をご覧ください。'] },
    ...
    zh: {
      ...
      intro: '**RTX 3060 12GB以12–16令牌/秒运行Llama 4 Scout 17B（MoE），以16–20令牌/秒运行Qwen3 8B，以18令牌/秒运行Mistral 7B，以10–12令牌/秒运行DeepSeek-R1 7B——均为Q4量化。** 6GB版本仅限3B模型。截至2026年5月，RTX 3060 12GB（二手$200–250）仍是本地LLM最佳预算GPU。12GB VRAM适配所有7B和大部分Q4级13B模型，加上Llama 4 Scout（MoE）可实现远超密集7B-8B模型的品质。',
      metaDescription: 'RTX 3060 12GB（二手约1400-1800元）是2026年7B模型本地推理的性价比首选。5款GPU按VRAM、价格和推理速度排名，涵盖Llama 4 Scout和Mistral 7B。',
      nextStep: {
      ...
      sections: {
        ...
        'rtx-3060-12gb': {
          ...
          rows: [
            ...
            { '模型': 'Qwen3 7B', '大小': '7B', '量化': 'Q4_K_M', 'VRAM占用': '~7 GB', '速度': '16令牌/秒', '最适合': '编程（72% HumanEval）' },
        ...
        'best-by-use-case': {
          ...
          content: [
            '**根据实际需求选择模型，而非参数量：**',
            '预算硬件只能运行较小的模型——但熟练的提示词技巧可以弥补质量差距。[Prompt工程指南](https://www.promptquorum.com/prompt-engineering?lang=zh)涵盖了思维链和结构化输出等技术，帮助小模型超越其规模发挥。一个正好落在 RTX 3060 12 GB 档位的具体工作负载是自动化的 PR 评审——把 Qwen3 8B 直接针对 PR 跑起来的 GitHub Actions 方案，请参阅[CI/CD 中的本地 LLM 代码评审](/power-local-llm/local-llm-code-review-ci-cd?lang=zh)。',
          ],
          items: [
        ...
        'relatedReading': {
          ...
          items: [
            ...
            '[本地LLM的Apple Silicon对比NVIDIA GPU](/power-local-llm/apple-mlx-vs-nvidia-cuda-local-llm-2026?lang=zh)',
