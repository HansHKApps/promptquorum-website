...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      title: 'RTX 3060 12GB: Run Qwen3 8B, Qwen3 14B, Gemma 4, Mistral Small (2026 Guide)',
      ...
      metaDescription: 'RTX 3060 12GB: Qwen3 8B (16-20 tok/sec), Qwen3 14B (9-12 tok/sec), Gemma 4 E12B, Mistral Small, DeepSeek-R1. Full model table with VRAM + speed benchmarks.',
...
schema: {
    ...
    es: {
      freshness_tier: 'monthly',
      theme: 'GPU Buying Guides',
      title: 'RTX 3060 12GB: Ejecuta Qwen3 8B, Qwen3 14B, Gemma 4, Mistral Small (Guía 2026)',
      ...
      metaDescription: 'RTX 3060 12GB: Qwen3 8B (16–20 tok/s), Qwen3 14B (9–12 tok/s), Gemma 4 E12B, Mistral Small y DeepSeek-R1. Tabla completa con benchmarks de VRAM y velocidad.',
      publishDate: '2026-04-05',
      ...
      sections: {
        ...
        'relatedReading': {
          ...
          items: [
            ...
            '[هندسة الموجّهات لنماذج LLM المحلية](/ar/prompt-engineering/prompt-engineering-for-local-models) — حسّن الموجّهات للنماذج التي تعمل على عتاد اقتصادي.',
    ...
    pt: {
      ...
      seoTitle: 'RTX 3060 12 GB: melhor GPU econômica para LLMs locais 2026',
      ...
      metaDescription: 'RTX 3060 12 GB: Qwen3 8B (16-20 tok/s), Qwen3 14B (9-12 tok/s), Gemma 4 E12B, Mistral Small e DeepSeek-R1. Tabela completa com benchmarks de VRAM e velocidade.',
      publishDate: '2026-04-05',
    ...
    de: {
      ...
      intro: '**RTX 3060 12GB führt Qwen3 14B mit 9–12 Tok/Sek, Qwen3 8B mit 16–20 Tok/Sek, Gemma 4 E12B mit 11–14 Tok/Sek, Mistral Small mit 18 Tok/Sek und DeepSeek-R1 7B mit 10–12 Tok/Sek aus — alles bei Q4-Quantisierung.** Die 6-GB-Variante ist auf 3B-Modelle beschränkt. Stand Juni 2026 bleibt die RTX 3060 12GB (150–190 € gebraucht) die beste Budget-GPU für lokale LLMs: 12 GB VRAM passt für jedes 7B-8B-Modell bei Q4/Q5 und die meisten dichten 13B-14B-Modelle bei Q4. (Hinweis: Llama 4 Scout ist ein MoE mit 17B aktiv / 109B insgesamt und benötigt ~55 GB bei Q4 — er passt normalerweise nicht in 12 GB.)',
      metaDescription: 'RTX 3060 12GB (150-190 € gebraucht) ist die beste Budget-GPU für 7B-Modelle 2026. 5 GPUs nach VRAM und Preis für Qwen3 14B und Mistral Small verglichen.',
      nextStep: {
      ...
      sections: {
        ...
        'rtx-3060-12gb': {
          ...
          rows: [
            ...
            { 'Modell': 'Mistral Small v0.3', 'Größe': '7B', 'Quantisierung': 'Q4_K_M', 'VRAM': '~7 GB', 'Geschwindigkeit': '18 Tok/Sek', 'Ideal für': 'Instruktionsfolge' },
        ...
        'best-for-each-use': {
          ...
          content: [
            '**Codierung (Qwen 3 7B)**: Qwen 3 7B ist exzellent bei Code-Generierung und Reasoning. Benötigt RTX 3060 12GB oder RTX 4060 Ti 8GB. Ideal auf RTX A6000 Enterprise-Karten, falls verfügbar für 32B+-Modelle.',
            ...
            '**Leichte lokale Nutzung (Mistral Small)**: Mistral Small ist das leichteste hochwertige Modell. Lässt sich bequem auf RTX 3060 12GB oder RTX 4060 Ti 8GB ausführen. Perfekt für Notebook-Inferenz.',
          ],
        },
        'quick-answer': {
          ...
          content: [
            ...
            '✅ **Bestes für Codierung:** Qwen 3 (spezialisiert auf Code-Verständnis)',
            '✅ **Bestes leichtgewichtig:** Mistral Small (minimales VRAM, schnelle Inferenz)',
        ...
        'model-comparison': {
          ...
          rows: [
            { 'Modell': 'Qwen 3 7B', 'Am besten für': 'Codierung', 'Stärke': 'Ausgezeichnete Code-Genauigkeit, mehrsprachiges Reasoning', 'Schwäche': 'Schwächer bei reinem englischen Reasoning vs. Llama', 'Min VRAM (Q4)': '6-8 GB' },
            ...
            { 'Modell': 'Mistral Small', 'Am besten für': 'Effizienz', 'Stärke': 'Schnellste Inferenz, minimales VRAM, leichtgewichtig', 'Schwäche': 'Weniger fähig als Llama/Qwen bei komplexen Aufgaben', 'Min VRAM (Q4)': '6-8 GB' },
          ],
          tableFormat: true,
        },
        'vram-7b': {
        ...
        'best-by-use-case': {
          ...
          items: [
            ...
            '**Hausautomation / Immer-an-KI:** `ollama run phi4-mini` — Phi-4 Mini (3,8B, ~3 GB VRAM) bearbeitet Home-Assistant-Sprachanfragen auf einem Mini-PC ohne dedizierte GPU. Siehe [beste Hardware für lokale Smart-Home-KI →](/smart-home/best-hardware-for-local-smart-home).',
          ],
        },
        'used-vs-new': {
        ...
        'final-verdict': {
          ...
          content: [
            '**Für Codierungsaufgaben:** Wählen Sie RTX 3060 12GB oder RTX A4000 (16GB) + Qwen 3 7B. Sie erhalten starke Code-Generierung ohne Überausgaben.',
            ...
            '**Für leichte lokale Setups:** Wählen Sie RTX 4060 Ti 8GB + Mistral Small. Schnellste Inferenz, niedrigster Stromverbrauch, minimales VRAM-Fußabdruck.',
        ...
        'faqSection': {
          ...
          faqs: [
            { q: 'Ist RTX 3060 12GB noch 2026 wert?', a: 'Ja. Sie ist 4+ Jahre alt, aber 12GB VRAM ist zeitlos. Lädt Qwen3 14B, Qwen3 8B, Gemma 4 E12B und Mistral Small reibungslos bei Q4. Sie passt für jedes 7B-8B-Modell und die meisten dichten 13B-14B-Modelle.' },
        ...
        'recommended-setups': {
          ...
          items: [
            ...
            '**Für Qwen 3 Codierungsmodelle:** Siehe [Beste GPUs für lokale LLMs](/de/local-llms/best-gpus-for-local-llms) für optimierte Qwen-Setups.',
            '**Für Mistral Small auf minimaler Hardware:** Dieser Leitfaden (RTX 3060 oder 4060 Ti) ist Ihr Startpunkt.',
      ...
      faqSchema: {
        ...
        'url': 'https://www.promptquorum.com/de/local-llms/best-budget-gpus-local-llm',
        'mainEntity': [
          { '@type': 'Question', 'name': 'Lohnt sich RTX 3060 12GB 2026 noch?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Ja. 4+ Jahre alt, aber 12GB VRAM ist zeitlos. Läuft Llama 3.3 8B und Mistral Small reibungslos. Ideal wenn gebraucht unter €190 gefunden.' } },
    ...
    fr: {
      ...
      intro: '**La RTX 3060 12 Go exécute Qwen3 14B à 9–12 tok/sec, Qwen3 8B à 16–20 tok/sec, Gemma 4 E12B à 11–14 tok/sec, Mistral Small à 18 tok/sec et DeepSeek-R1 7B à 10–12 tok/sec — le tout en quantification Q4.** La variante 6 Go est limitée aux modèles 3B. En juin 2026, la RTX 3060 12 Go (200–250 $ d\'occasion) reste le meilleur GPU budget pour les LLM locaux : 12 Go VRAM accueille tous les modèles 7B-8B en Q4/Q5 et la plupart des denses 13B-14B en Q4. (Note : Llama 4 Scout est un MoE de 17B actifs/109B au total nécessitant ~55 Go en Q4 — il ne tient pas dans 12 Go normalement.)',
      metaDescription: 'RTX 3060 12GB (200-250 € d\'occasion) domine pour les modèles 7B. 5 GPU budget classés par VRAM et prix pour Qwen3 14B et Mistral Small en 2026.',
      nextStep: {
 ...
 isTldr: true, items: ['**RTX 3060 12 Go** (200–250 $ d\'occasion) : Exécute tous les 7B-8B en Q4/Q5 et la plupart des denses 13B-14B en Q4. Meilleur choix budget.', '**RTX 3060 6 Go** : Limité aux modèles 3B (Phi-4 Mini, Llama 3.2 3B). Trop juste pour 7B.', '**Meilleur modèle global sur 12 Go :** Qwen3 14B à ~9 Go VRAM, 9–12 tok/sec. Meilleure qualité dense qui tient confortablement.', '**Meilleur modèle code sur 12 Go :** Qwen3 8B à 16–20 tok/sec.', '**Meilleur modèle raisonnement sur 12 Go :** DeepSeek-R1 7B à 10–12 tok/sec.', '**À éviter si :** vous voulez des modèles 70B, Llama 4 Scout (nécessite ~55 Go) ou 13B en Q8 — il faut 24 Go+ (RTX 4090).'] },
        'rtx-3060-12gb': {
          ...
          rows: [
            ...
            { 'Modèle': 'Mistral Small v0.3', 'Taille': '7B', 'Quantification': 'Q4_K_M', 'VRAM': '~7 Go', 'Vitesse': '18 tok/sec', 'Idéal pour': 'Suivi d\'instructions' },
        ...
        'best-for-each-use': { title: 'Quel modèle est le meilleur pour chaque cas d\'usage?', content: ['**Codage (Qwen 3 7B)**: Qwen 3 7B excelle à la génération de code et au raisonnement. Nécessite RTX 3060 12GB ou RTX 4060 Ti 8GB. Idéal sur les cartes enterprise RTX A6000 si disponibles pour les modèles 32B+.', '**Raisonnement Anglais (Llama 3.3)**: Llama 3.3 est le meilleur modèle polyvalent pour le raisonnement factuel. Llama 3.3 70B nécessite 48GB VRAM (RTX 6000 ou A100). La version 7B tient sur n\'importe quel GPU 8GB+.', '**Utilisation locale légère (Mistral Small)**: Mistral Small est le modèle haut de gamme le plus léger. S\'exécute confortablement sur RTX 3060 12GB ou RTX 4060 Ti 8GB. Parfait pour l\'inférence portative.'] },
        'quick-answer': { title: 'Quels modèles gagnent par cas d\'usage?', content: ['✅ **Meilleur au global:** Llama 3.3 (ouvert, capable, largement optimisé)', '✅ **Meilleur pour le codage:** Qwen 3 (compréhension de code spécialisée)', '✅ **Meilleur léger:** Mistral Small (VRAM minimal, inférence rapide)', '✅ **Meilleur GPU budget:** RTX 3060 12GB (200-250 € d\'occasion)'] },
        'model-comparison': { title: 'Comparaison des modèles: Quel modèle gagne?', columns: ['Modèle', 'Meilleur pour', 'Force', 'Faiblesse', 'Min VRAM (Q4)'], rows: [{ 'Modèle': 'Qwen 3 7B', 'Meilleur pour': 'Codage', 'Force': 'Excellente précision de code, raisonnement multilingue', 'Faiblesse': 'Plus faible au raisonnement anglais pur vs Llama', 'Min VRAM (Q4)': '6-8 GB' }, { 'Modèle': 'Llama 3.3 8B', 'Meilleur pour': 'Raisonnement', 'Force': 'Polyvalent fort, raisonnement factuel', 'Faiblesse': 'Plus lourd que Mistral, plus de VRAM requis', 'Min VRAM (Q4)': '8-10 GB' }, { 'Modèle': 'Mistral Small', 'Meilleur pour': 'Efficacité', 'Force': 'Inférence la plus rapide, VRAM minimal, léger', 'Faiblesse': 'Moins capable que Llama/Qwen aux tâches complexes', 'Min VRAM (Q4)': '6-8 GB' }], tableFormat: true },
        ...
        'best-by-use-case': {
          ...
          items: [
            ...
            '**Domotique / IA en continu :** `ollama run phi4-mini` — Phi-4 Mini (3,8B, ~3 Go VRAM) gère les requêtes vocales Home Assistant sur un mini PC sans GPU dédié. Voir [meilleur matériel pour IA smart home →](/smart-home/best-hardware-for-local-smart-home).',
          ],
        },
      ...
      faqSchema: {
        ...
        'mainEntity': [
          { '@type': 'Question', 'name': 'RTX 3060 12GB vaut-il toujours le coup en 2026?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Oui. 4+ ans, mais 12GB VRAM ne vieillit pas. Exécute Llama 3.3 8B et Mistral Small en douceur. Idéal si vous trouvez un occasion <€190.' } },
    ...
    ja: {
      ...
      intro: '**RTX 3060 12GBはQwen3 14Bを9–12トークン/秒、Qwen3 8Bを16–20トークン/秒、Gemma 4 E12Bを11–14トークン/秒、Mistral Smallを18トークン/秒、DeepSeek-R1 7Bを10–12トークン/秒で実行します — すべてQ4量子化。** 6GB版は3Bモデルのみ対応。2026年6月時点、RTX 3060 12GB（中古$200–250）はローカルLLM用の最良バジェットGPUです。12GB VRAMはすべての7B-8BモデルをQ4/Q5で、ほとんどの稠密13B-14BモデルをQ4で実行できます。（注：Llama 4 Scoutは17Bアクティブ/109B合計のMoEで、Q4で~55GB必要なため、通常12GBには収まりません。）',
 ...
 isTldr: true, items: ['**RTX 3060 12GB**（中古$200–250）：すべての7B-8BモデルをQ4/Q5で、ほとんどの稠密13B-14BをQ4で実行。最良のバジェット選択。', '**RTX 3060 6GB**：3Bモデルのみ（Phi-4 Mini、Llama 3.2 3B）。7Bには不足。', '**12GBでの最良総合モデル：** Qwen3 14B、~9GB VRAM、9–12トークン/秒。快適に収まる最良の稠密品質。', '**12GBでの最良コーディングモデル：** Qwen3 8B、16–20トークン/秒。', '**12GBでの最良推論モデル：** DeepSeek-R1 7B、10–12トークン/秒。', '**対象外：** 70Bモデル、Llama 4 Scout（~55GB必要）、13B Q8が必要な場合は24GB以上（RTX 4090）が必要。'] },
    ...
    zh: {
      ...
      intro: '**RTX 3060 12GB以9–12令牌/秒运行Qwen3 14B，以16–20令牌/秒运行Qwen3 8B，以11–14令牌/秒运行Gemma 4 E12B，以18令牌/秒运行Mistral Small，以10–12令牌/秒运行DeepSeek-R1 7B——均为Q4量化。** 6GB版本仅限3B模型。截至2026年6月，RTX 3060 12GB（二手$200–250）仍是本地LLM最佳预算GPU。12GB VRAM以Q4/Q5适配所有7B-8B模型，以Q4适配大部分密集13B-14B模型。（注：Llama 4 Scout是17B激活/109B总计的MoE，Q4下需要~55GB，通常无法装入12GB。）',
      metaDescription: 'RTX 3060 12GB（二手约1400-1800元）是2026年7B模型本地推理的性价比首选。5款GPU按VRAM、价格和推理速度排名，涵盖Qwen3 14B和Mistral Small。',
      nextStep: {
