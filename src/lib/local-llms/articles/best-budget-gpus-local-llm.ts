...
schema: {
    ...
    de: {
      ...
      intro: '**Die RTX 3060 12GB betreibt Qwen3 14B mit 9–12 Tok/Sek, Qwen3 8B mit 16–20 Tok/Sek, Gemma 4 E12B mit 11–14 Tok/Sek, Mistral Small mit 18 Tok/Sek und DeepSeek-R1 7B mit 10–12 Tok/Sek — alles bei Q4-Quantisierung.** Die 6-GB-Variante ist auf reine 3B-Modelle beschränkt. Stand Juni 2026 bleibt die RTX 3060 12GB (200–250 € gebraucht) die beste Budget-GPU für lokale LLMs: 12 GB VRAM fassen jedes 7B-8B-Modell bei Q4/Q5 und die meisten dichten 13B-14B-Modelle bei Q4. (Hinweis: Llama 4 Scout ist ein MoE mit 17B aktiven / 109B Gesamt-Parametern, das bei Q4 ca. 55 GB benötigt — es passt normalerweise nicht in 12 GB.) Dieser Leitfaden zeigt genau, welche Modelle auf welcher VRAM-Stufe laufen, mit echten Geschwindigkeiten und praxistauglichen Setups.',
      ...
      sections: {
        ...
        'relatedReading': { title: 'Weiterführende Artikel', items: [
          ...
          '[Prompt Engineering für lokale LLMs](/de/prompt-engineering/prompt-engineering-for-local-models) — Prompts für Modelle auf Budget-Hardware optimieren.',
      ...
      schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', 'headline': 'RTX 3060 Leitfaden für lokale LLMs 2026: Welche Modelle laufen', 'description': 'Welche lokalen LLMs können Sie auf der RTX 3060 12GB oder 6GB betreiben? Sehen Sie die besten Modelle für Coding, Chat und Reasoning 2026 mit echten VRAM-Grenzen und Performance-Tipps.', 'url': 'https://www.promptquorum.com/de/local-llms/best-budget-gpus-local-llm', 'datePublished': '2026-04-05', 'dateModified': '2026-06-19', 'inLanguage': 'de', 'author': { '@type': 'Person', 'name': 'Hans Kuepper' }, 'publisher': { '@type': 'Organization', 'name': 'PromptQuorum', 'url': 'https://www.promptquorum.com' }, 'about': [ { '@type': 'Thing', 'name': 'budget GPU' }, { '@type': 'Thing', 'name': 'RTX 3060' }, { '@type': 'Thing', 'name': 'GPU VRAM' }, { '@type': 'Thing', 'name': 'local LLM inference' } ], 'speakable': { '@type': 'SpeakableSpecification', 'cssSelector': ['.article-intro', '.key-takeaways', 'h2'] }, 'educationalLevel': 'Beginner' },
    ...
    fr: {
      ...
      intro: '**La RTX 3060 12GB fait tourner Qwen3 14B à 9–12 tok/sec, Qwen3 8B à 16–20 tok/sec, Gemma 4 E12B à 11–14 tok/sec, Mistral Small à 18 tok/sec et DeepSeek-R1 7B à 10–12 tok/sec — le tout en quantification Q4.** La variante 6GB se limite aux modèles 3B. En juin 2026, la RTX 3060 12GB (200–250 € d\'occasion) reste le meilleur GPU économique pour les LLM locaux : ses 12GB de VRAM accueillent tous les modèles 7B-8B en Q4/Q5 et la plupart des modèles denses 13B-14B en Q4. (Remarque : Llama 4 Scout est un MoE 17B actifs/109B au total qui réclame ~55 GB en Q4 — il ne tient normalement pas dans 12 GB.) Ce guide détaille précisément quels modèles tournent sur chaque palier de VRAM, avec vitesses réelles et configurations pratiques.',
      ...
      sections: {
        ...
        'relatedReading': { title: 'Lectures complémentaires', items: [
          ...
          '[Ingénierie de prompts pour LLM locaux](/fr/prompt-engineering/prompt-engineering-for-local-models) — optimisez vos prompts pour les modèles sur matériel économique.',
      ...
      schema: { '@context': 'https://schema.org', '@type': 'NewsArticle', 'headline': 'Guide RTX 3060 pour LLM locaux 2026 : quels modèles pouvez-vous exécuter', 'description': 'Quels LLM locaux pouvez-vous faire tourner sur une RTX 3060 12GB ou 6GB ? Découvrez les meilleurs modèles pour le code, le chat et le raisonnement en 2026, avec limites de VRAM réelles et conseils de performance.', 'url': 'https://www.promptquorum.com/fr/local-llms/best-budget-gpus-local-llm', 'datePublished': '2026-04-05', 'dateModified': '2026-06-19', 'inLanguage': 'fr', 'author': { '@type': 'Person', 'name': 'Hans Kuepper' }, 'publisher': { '@type': 'Organization', 'name': 'PromptQuorum', 'url': 'https://www.promptquorum.com' }, 'about': [ { '@type': 'Thing', 'name': 'budget GPU' }, { '@type': 'Thing', 'name': 'RTX 3060' }, { '@type': 'Thing', 'name': 'GPU VRAM' }, { '@type': 'Thing', 'name': 'local LLM inference' } ], 'speakable': { '@type': 'SpeakableSpecification', 'cssSelector': ['.article-intro', '.key-takeaways', 'h2'] }, 'educationalLevel': 'Beginner' },
