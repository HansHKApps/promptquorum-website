...
schema: {
      ...
      sections: {
        ...
        relatedReading: { title: 'Lectures complémentaires', items: ['[Configuration LLM local pour équipes](/local-llms/local-llm-setup-for-teams?lang=fr)', '[Workflow LLM local hors ligne sécurisé](/local-llms/secure-offline-local-llm-workflow?lang=fr)', '[LLM local privé pour données sensibles](/local-llms/private-local-llm-sensitive-data?lang=fr)'] },
...
schema: {
      ...
      sections: {
        ...
        relatedReading: { title: '関連資料', items: ['[チーム向けローカルLLMセットアップ](/local-llms/local-llm-setup-for-teams?lang=ja)', '[セキュアなオフラインローカルLLMワークフロー](/local-llms/secure-offline-local-llm-workflow?lang=ja)', '[機密データのためのプライベートローカルLLM](/local-llms/private-local-llm-sensitive-data?lang=ja)'] },
...
schema: {
      ...
      sections: {
        ...
        relatedReading: { title: '相关阅读', items: ['[团队本地LLM设置](/local-llms/local-llm-setup-for-teams?lang=zh)', '[安全的离线本地LLM工作流](/local-llms/secure-offline-local-llm-workflow?lang=zh)', '[敏感数据的私有本地LLM](/local-llms/private-local-llm-sensitive-data?lang=zh)'] },
