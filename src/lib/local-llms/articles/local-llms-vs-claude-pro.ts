...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      heroImage: '/images/local-llms-vs-claude-pro-overview-hero-en.png',
      ...
      sections: {
        ...
        'pricing': {
          ...
          callouts: [
            ...
            { type: '💡 Pro Tip', text: 'Dual RTX 4070s ($500–600 used) also run Llama 3.3 70B at 60–70% speed for roughly half the GPU cost.' },
          ],
        },
        'privacy': {
          id: 'privacy',
...
schema: {
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'Thing', 'name': 'Local Llama 3.3 70B', 'description': 'Open-source model on RTX 4090 ($1,000 used) with 128K token context, full fine-tuning support, and offline operation.' },
    ...
    es: {
      ...
      heroImage: '/images/local-llms-vs-claude-pro-overview-hero-es.png',
      ...
      sections: {
        ...
        'quickFacts': {
          ...
          items: [
            ...
            '**Hardware para Llama 3.3 70B:** RTX 4090 (~$1,000 usada) o dual RTX 4070s (~$550 usadas)',
        ...
        'pricing': {
          ...
          content: [
            '**Claude Pro cobra $20/mes sin necesidad de hardware; Llama 3.3 70B local cuesta $1,000+ de inicio pero solo $60/año en electricidad después.** El primer año es caro para la opción local, pero el punto de equilibrio llega en el mes 50.',
          ...
          callouts: [
            ...
            { type: '💡 Consejo profesional', text: 'Dos RTX 4070s ($500–600 usadas) también ejecutan Llama 3.3 70B al 60–70% de velocidad por aproximadamente la mitad del costo de GPU.' },
          ],
        },
        'privacy': {
          id: 'privacy',
        ...
        'five-year': {
          ...
          content: [
            ...
            'Llama 3.3 70B local (GPU nueva): RTX 4090 $1,600 + electricidad 5 años $300 = $1,900 en total.',
            'Llama 3.3 70B local (GPU usada): $1,000 + $300 de electricidad = $1,300 en total.',
        ...
        'commonMistakes': {
          ...
          items: [
            ...
            'Asumir que Llama 3.3 70B requiere una GPU de $1,600. Una RTX 4090 usada (~$1,000) o dos RTX 4070s ($500–600 en total) también funcionan.',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'Thing', 'name': 'Llama 3.3 70B local', 'description': 'Modelo de código abierto en RTX 4090 (~$1,000 usada) con contexto de 128K tokens, soporte completo de fine-tuning y operación offline.' },
          { '@type': 'Thing', 'name': 'Análisis TCO a 5 años', 'description': 'Claude Pro $1,200 vs Llama 3.3 local $1,300 (GPU usada) — costo casi idéntico con diferentes compromisos.' },
        ],
      },
    },
    ar: {
      ...
      heroImage: '/images/local-llms-vs-claude-pro-overview-hero-ar.png',
      ...
      metaDescription: '⁨Claude Pro⁩ بـ ⁨20⁩$/شهر؛ ⁨RTX 4090⁩ مستعملة مع ⁨Llama 3.3 70B⁩ تسترد استثمارها خلال ⁨4⁩ سنوات. مقارنة: التكلفة والخصوصية والمعايير ونافذة ⁨200K⁩ رمز.',
      publishDate: '2026-04-05',
      dateModified: '2026-07-13',
      ...
      sections: {
        ...
        'pricing': {
          ...
          content: [
            ...
            '[أفضل بطاقات GPU لنماذج LLM المحلية](/ar/local-llms/best-gpus-for-local-llms) يتضمن خيارات العتاد والأسعار المفصّلة.',
          ],
          callouts: [
            { type: '⚠️ تحذير', text: 'في السنة الأولى، يكلّف المحلي أوليًا 4–7× أكثر. تحدث نقطة التعادل حوالي الشهر 50 بـGPU مستعملة.' },
            { type: '💡 نصيحة احترافية', text: 'بطاقتا RTX 4070 (500–600$ مستعملة) تُشغّلان أيضًا Llama 3.3 70B بسرعة 60–70% بنحو نصف تكلفة GPU.' },
          ],
        },
        'privacy': {
          id: 'privacy',
        ...
        'five-year': {
          ...
          callouts: [
            { type: '💡 نصيحة احترافية', text: 'تحديد RTX 4090 عند 350W يوفّر 40% من الكهرباء بخسارة سرعة لا تتجاوز ~10% — مما يخفض التكلفة المحلية لـ5 سنوات إلى أقل من 1,200$.' },
          ],
          snippetBlocks: [
            {
              type: 'plain-terms',
        ...
        'faqSection': {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'تفقد قدرة الحوسبة حتى الاستبدال (~1,000$). يتدهور Claude Pro بسلاسة (تحديد المعدل). يتطلب المحلي تخطيط تكرار (GPU احتياطية، تجاوز فشل سحابي).',
            },
            {
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'Thing', 'name': 'Llama 3.3 70B محلي', 'description': 'نموذج مفتوح المصدر على RTX 4090 (~1,000$ مستعملة) بسياق 128K رمز ودعم ضبط دقيق كامل وتشغيل دون اتصال.' },
          { '@type': 'Thing', 'name': 'تحليل إجمالي تكلفة الملكية لـ5 سنوات', 'description': 'Claude Pro 1,200$ مقابل Llama 3.3 محلي 1,300$ (GPU مستعملة) — تكلفة شبه متطابقة بمقايضات مختلفة.' },
        ],
      },
    },
    pt: {
      ...
      heroImage: '/images/local-llms-vs-claude-pro-overview-hero-pt.png',
    ...
    de: {
      ...
      heroImage: '/images/local-llms-vs-claude-pro-overview-hero-de.png',
      ...
      sections: {
        ...
        'quickFacts': {
          ...
          items: [
            ...
            '**Llama 3.3 70B Hardware:** RTX 4090 (~1.400€ gebraucht) oder dual RTX 4070s (~750€ gebraucht)',
        ...
        'pricing': {
          ...
          content: [
            '**Claude Pro berechnet 20€/Monat ohne Hardware erforderlich; lokales Llama 3.3 70B kostet 1.400€+ Auffront, aber nur 60€/Jahr Strom danach.** Jahr 1 ist teuer für lokal, aber Amortisationspunkt kommt bei Monat 50.',
          ...
          callouts: [
            ...
            { type: '💡 Pro Tipp', text: 'Dual RTX 4070s (500–600€ gebraucht) führen auch Llama 3.3 70B mit 60–70% Geschwindigkeit für grob die Hälfte der GPU-Kosten aus.' },
          ],
        },
        'privacy': {
          id: 'privacy',
        ...
        'five-year': {
          ...
          content: [
            ...
            'Lokales Llama 3.3 70B (neue GPU): RTX 4090 1.960€ + Strom 5 Jahre 300€ = 2.260€ gesamt.',
            'Lokales Llama 3.3 70B (gebrauchte GPU): 1.400€ + 300€ Strom = 1.700€ gesamt.',
        ...
        'commonMistakes': {
          ...
          items: [
            ...
            'Annehmen Llama 3.3 70B erfordert eine 1.960€ GPU. Gebrauchte RTX 4090 (~1.400€) oder dual RTX 4070s (500–600€ gesamt) funktionieren auch.',
...
schema: {
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'Thing', 'name': 'Lokales Llama 3.3 70B', 'description': 'Open-Source-Modell auf RTX 4090 (~1.400€ gebraucht) mit 128K Token-Kontext, vollständigem Fine-Tuning Support und Offline-Betrieb.' },
    ...
    fr: {
      ...
      heroImage: '/images/local-llms-vs-claude-pro-overview-hero-fr.png',
      ...
      sections: {
        ...
        'quickFacts': {
          ...
          items: [
            ...
            '**Matériel Llama 3.3 70B:** RTX 4090 (~1 200€ d\'occasion) ou dual RTX 4070s (~700€ d\'occasion)',
        ...
        'pricing': {
          ...
          content: [
            '**Claude Pro facture 20€/mois sans matériel requis; Llama 3.3 70B local coûte 1 200€+ d\'avance mais seulement 60€/an en électricité après cela.** L\'année 1 est chère pour le local, mais le seuil de rentabilité arrive au mois 50.',
          ...
          callouts: [
            ...
            { type: '💡 Conseil utile', text: 'Dual RTX 4070s (500–700€ d\'occasion) exécutent aussi Llama 3.3 70B à 60–70 % de vitesse pour approximativement moitié prix GPU.' },
          ],
        },
        'privacy': {
          id: 'privacy',
        ...
        'five-year': {
          ...
          content: [
            ...
            'Llama 3.3 70B local (GPU neuf): RTX 4090 1 900€ + électricité 5 ans 300€ = 2 400€ total.',
            'Llama 3.3 70B local (GPU d\'occasion): 1 200€ + 300€ électricité = 1 500€ total.',
        ...
        'commonMistakes': {
          ...
          items: [
            ...
            'Supposer Llama 3.3 70B requiert GPU 1 900€. GPU RTX 4090 d\'occasion (~1 200€) ou dual RTX 4070s (700€ total) fonctionnent aussi.',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'Thing', 'name': 'Llama 3.3 70B local', 'description': 'Modèle open-source sur RTX 4090 (~1 200€ d\'occasion) avec contexte 128K tokens, support fine-tuning complet, opération hors ligne.' },
          { '@type': 'Thing', 'name': 'Analyse TCO 5 ans', 'description': 'Claude Pro 1 200€ vs Llama 3.3 local 1 500€ (GPU d\'occasion) - coûts pratiquement identiques avec compromis différents.' },
        ],
      },
    },
    ja: {
      ...
      heroImage: '/images/local-llms-vs-claude-pro-overview-hero-ja.png',
      ...
      sections: {
        ...
        'quickFacts': {
          ...
          items: [
            ...
            '**Llama 3.3 70Bハードウェア:** RTX 4090（中古約¥189,000）またはdual RTX 4070s（中古約¥105,000）',
        ...
        'pricing': {
          ...
          content: [
            '**Claude Proは月¥3,200でハードウェア不要; ローカルLlama 3.3 70Bは初期投資¥189,000以上だが、その後年¥9,600電気代のみ。** 初年度はローカルが高いですが、損益分岐点は約50ヶ月です。',
          ...
          callouts: [
            ...
            { type: '💡 プロのコツ', text: 'Dual RTX 4070s（中古¥100,000～120,000）もLlama 3.3 70Bを60～70%速度で実行でき、GPU価格約半分です。' },
          ],
        },
        'privacy': {
          id: 'privacy',
        ...
        'five-year': {
          ...
          content: [
            ...
            'ローカルLlama 3.3 70B（新GPU）: RTX 4090 ¥302,400 + 電気5年 ¥48,000 = ¥350,400合計。',
            'ローカルLlama 3.3 70B（中古GPU）: ¥189,000 + ¥48,000電気代 = ¥237,000合計。',
        ...
        'commonMistakes': {
          ...
          items: [
            ...
            'Llama 3.3 70Bは¥302,400 GPUが必要だと仮定する。中古RTX 4090（約¥189,000）またはdual RTX 4070s（合計¥100,000～120,000）も動作します。',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'Thing', 'name': 'ローカルLlama 3.3 70B', 'description': 'RTX 4090（中古約¥189,000）上のオープンソースモデル、128Kトークンコンテキスト、完全なファインチューニングサポート、オフライン操作。' },
    ...
    zh: {
      ...
      heroImage: '/images/local-llms-vs-claude-pro-overview-hero-zh.png',
      ...
      sections: {
        ...
        'quickFacts': {
          ...
          items: [
            ...
            '**Llama 3.3 70B硬件:** RTX 4090（二手约$1,000）或双RTX 4070s（二手约$550）',
        ...
        'pricing': {
          ...
          content: [
            '**Claude Pro按月$20收费，无需硬件；本地Llama 3.3 70B初期投资$1,000+但之后仅年$60电力。** 初年本地更贵，但损益平衡点约在50个月。',
          ...
          callouts: [
            ...
            { type: '💡 专业建议', text: '双RTX 4070s（二手$500-600）也能以60-70%速度运行Llama 3.3 70B，成本约为GPU价格一半。' },
          ],
        },
        'privacy': {
          id: 'privacy',
        ...
        'five-year': {
          ...
          content: [
            ...
            '本地Llama 3.3 70B（新GPU）: RTX 4090 $1,600 + 5年电力$300 = $1,900总计。',
            '本地Llama 3.3 70B（二手GPU）: $1,000 + $300电力 = $1,300总计。',
        ...
        'commonMistakes': {
          ...
          items: [
            ...
            '假设Llama 3.3 70B需要$1,600 GPU。二手RTX 4090（约$1,000）或双RTX 4070s（总$500-600）也能工作。',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'Thing', 'name': '本地Llama 3.3 70B', 'description': 'RTX 4090（二手约$1,000）上开源模型，128K令牌上下文、完整微调支持、离线运作。' },
  ...
  ko: {
    ...
    heroImage: '/images/local-llms-vs-claude-pro-overview-hero-ko.png',
