...
schema: {
    ...
    ar: {
      ...
      seoTitle: 'LLM المحلي مقابل السحابة 2026: الخصوصية مقابل السرعة مقابل الجودة',
      ...
      metaDescription: 'خاص بنسبة 100% و$0/token، لكنه أبطأ بـ 10× من GPT-5.5 وبلا بيانات في الوقت الفعلي. جدول: أي المهام تذهب محليًا وأيها إلى السحابة. السرعة والتكلفة وVRAM.',
