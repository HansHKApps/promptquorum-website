      ...
      sections: {
        'tldr': {
          ...
          items: [
            ...
            'Pro 100$ أفضل قيمة للمستخدمين المتقدمين — 5× حدود Plus، وصول إلى GPT-5.4 Pro بـ100$/شهر',
          ],
          image: '/images/mac-vs-windows-vs-linux-local-llm-os-summary-es.svg',
        ...
        'quality': {
          ...
          content: [
            ...
            '[Llama 3.3 70B (Meta، ديسمبر 2024): 80% MMLU، 88% HumanEval](/ar/local-llms/top-open-source-models-ollama) — أفضل نموذج مفتوح المصدر للاستدلال المحلي. فجوة 5 نقاط في MMLU مع GPT-5.2 هي الأصغر بين السحابي والمحلي في التاريخ. لـ80% من المهام المؤسسية (البريد الإلكتروني، مراجعة الشيفرة، التلخيص، الأسئلة والأجوبة)، Llama 3.3 70B كافٍ.',
          ...
          rows: [
            ...
            { 'Modelo': 'Llama 3.3 70B', 'Tipo': 'محلي', 'MMLU': '80%', 'HumanEval': '88%', 'Notas': 'أفضل نموذج مفتوح المصدر عام (ديسمبر 2024)' },
            { 'Modelo': 'Llama 4 Scout 8B', 'Tipo': 'محلي', 'MMLU': '78%', 'HumanEval': '79%', 'Notas': 'جديد مارس 2026؛ متصدّر فئة 8B' },
            { 'Modelo': 'Mistral Small 3.1 24B', 'Tipo': 'محلي', 'MMLU': '73%', 'HumanEval': '75%', 'Notas': 'أفضل 24B؛ يتسع في RTX 5060 Ti 16 GB' },
      ...
      sections: {
        ...
        'quality': {
          ...
          rows: [
            ...
            { 'Modelo': 'Llama 3.3 70B', 'Tipo': 'Local', 'MMLU': '80%', 'HumanEval': '88%', 'Notas': 'Melhor modelo open-source geral (dez. 2024)' },
            { 'Modelo': 'Llama 4 Scout 8B', 'Tipo': 'Local', 'MMLU': '78%', 'HumanEval': '79%', 'Notas': 'Novo mar. 2026; top da classe 8B' },
            { 'Modelo': 'Mistral Small 3.1 24B', 'Tipo': 'Local', 'MMLU': '73%', 'HumanEval': '75%', 'Notas': 'Melhor 24B; cabe na RTX 5060 Ti 16 GB' },
      ...
      sections: {
        'tldr': {
          ...
          items: [
            ...
            'Pro $100은 파워 유저에게 최고의 가성비 — Plus 한도의 5배, $100/월에 GPT-5.4 Pro 이용 가능',
          ],
          image: '/images/mac-vs-windows-vs-linux-local-llm-os-summary-en.svg',
        ...
        'quality': {
          ...
          content: [
            ...
            '[Llama 3.3 70B(Meta, 2024년 12월): MMLU 80%, HumanEval 88%](/local-llms/top-open-source-models-ollama) — 로컬 추론에 최적인 오픈 소스 모델. GPT-5.2와의 5포인트 MMLU 격차는 역대 최소 클라우드/로컬 격차입니다. 비즈니스 작업의 80%(이메일, 코드 리뷰, 요약, Q&A)에서 Llama 3.3 70B로 충분합니다.',
          ...
          rows: [
            ...
            { '모델': 'Llama 3.3 70B', '유형': '로컬', 'MMLU': '80%', 'HumanEval': '88%', '비고': '최고의 전반적 오픈 모델 (2024년 12월)' },
            { '모델': 'Llama 4 Scout 8B', '유형': '로컬', 'MMLU': '78%', 'HumanEval': '79%', '비고': '2026년 3월 출시, 8B급 최상위' },
            { '모델': 'Mistral Small 3.1 24B', '유형': '로컬', 'MMLU': '73%', 'HumanEval': '75%', '비고': '최고의 24B, RTX 5060 Ti 16 GB에 적합' },
