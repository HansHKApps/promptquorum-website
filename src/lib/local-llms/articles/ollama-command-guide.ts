      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '`ollama ps` -- Show currently loaded (running) models and their memory usage.',
        ...
        essentialCommands: {
          ...
          items: [
            ...
            '**`ollama ps`** -- Show currently loaded models and their memory usage (useful for debugging VRAM issues).',
            '**`ollama stop <model>`** -- Unload a model from memory immediately (default keep-alive is 5 minutes of inactivity).',
...
schema: {
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', position: 5, name: '`ollama ps` -- Show currently loaded models and their memory usage.' },
    ...
    pt: {
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '`ollama ps` — Mostra os modelos atualmente carregados e seu uso de memória.',
            '`ollama stop <model>` — Descarrega um modelo da memória imediatamente.',
            ...
            'Em agosto de 2026, esses comandos são estáveis e cobrem todos os casos de uso comuns.',
          ],
        },
        essentialCommands: {
          id: 'essential-commands',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', position: 5, name: '`ollama ps` — Mostra os modelos atualmente carregados.' },
          { '@type': 'ListItem', position: 6, name: '`ollama stop <model>` — Descarrega um modelo da memória imediatamente.' },
          { '@type': 'ListItem', position: 7, name: '`ollama serve` — Inicia o servidor API do Ollama (executa automaticamente no Mac/Windows).' },
          { '@type': 'ListItem', position: 6, name: '`ollama create <name> -f <modelfile>` — Cria um modelo personalizado a partir de um Modelfile.' },
          { '@type': 'ListItem', position: 7, name: 'Em agosto de 2026, esses comandos são estáveis e cobrem todos os casos de uso comuns.' },
        ],
      },
    },
    de: {
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '`ollama ps` -- Aktuell geladene Modelle und deren Speichernutzung anzeigen.',
            '`ollama stop <model>` -- Ein Modell sofort aus dem Speicher entladen.',
            ...
            'Ab August 2026 sind diese Befehle stabil und decken alle häufigen Anwendungsfälle ab.',
          ],
        },
        essentialCommands: {
          id: 'essential-commands',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 5, 'name': '`ollama ps` -- Aktuell geladene Modelle anzeigen.' },
          { '@type': 'ListItem', 'position': 6, 'name': '`ollama stop <model>` -- Ein Modell sofort aus dem Speicher entladen.' },
          { '@type': 'ListItem', 'position': 7, 'name': '`ollama serve` -- Ollama API-Server starten (läuft automatisch auf Mac/Windows).' },
          { '@type': 'ListItem', 'position': 6, 'name': '`ollama create <name> -f <modelfile>` -- Benutzerdefiniertes Modell aus Modelfile erstellen.' },
          { '@type': 'ListItem', 'position': 7, 'name': 'Ab August 2026 sind diese Befehle stabil und decken alle häufigen Anwendungsfälle ab.' },
        ],
      },
    },
    fr: {
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '`ollama ps` -- Afficher les modèles actuellement chargés et leur utilisation mémoire.',
            '`ollama stop <model>` -- Décharger immédiatement un modèle de la mémoire.',
            ...
            'À partir d\'août 2026, ces commandes sont stables et couvrent tous les cas d\'usage courants.',
          ],
        },
        essentialCommands: {
          id: 'essential-commands',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 5, 'name': '`ollama ps` -- Afficher les modèles actuellement chargés.' },
          { '@type': 'ListItem', 'position': 6, 'name': '`ollama stop <model>` -- Décharger immédiatement un modèle de la mémoire.' },
          { '@type': 'ListItem', 'position': 7, 'name': '`ollama serve` -- Démarrer le serveur API Ollama (s\'exécute automatiquement sur Mac/Windows).' },
          { '@type': 'ListItem', 'position': 6, 'name': '`ollama create <name> -f <modelfile>` -- Créer un modèle personnalisé à partir d\'un Modelfile.' },
          { '@type': 'ListItem', 'position': 7, 'name': 'À partir d\'août 2026, ces commandes sont stables et couvrent tous les cas d\'usage courants.' },
        ],
      },
    },
    ja: {
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '`ollama ps` -- 現在ロードされているモデルとそのメモリ使用量を表示。',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 5, 'name': '`ollama ps` -- 現在ロードされているモデルを表示。' },
    ...
    es: {
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '`ollama ps` -- Muestra los modelos actualmente cargados y su uso de memoria.',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', position: 5, name: '`ollama ps` -- Muestra los modelos actualmente cargados.' },
    ...
    ar: {
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '`ollama ps` -- يعرض النماذج المحمّلة حاليًا واستخدام الذاكرة.',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', position: 5, name: '`ollama ps` -- يعرض النماذج المحمّلة حاليًا.' },
    ...
    zh: {
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 5, 'name': '`ollama ps` -- 显示当前已加载的模型。' },
    ...
    heroImage: '/images/ollama-command-guide-overview-hero-ko.webp',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '`ollama ps` -- 현재 로드된 모델과 메모리 사용량을 표시합니다.',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', position: 5, name: '`ollama ps` -- 현재 로드된 모델을 표시합니다.' },
