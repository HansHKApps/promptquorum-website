    ...
    ja: {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          title: '関連記事',
          items: [
            '[Ollama インストールガイド: ステップバイステップ](/local-llms/how-to-install-ollama?lang=ja) -- 入門。',
            '[Ollama vs LM Studio vs Jan: 比較](/local-llms/ollama-vs-lm-studio?lang=ja) -- 正しいツールを選択。',
            '[Ollama でローカル LLM をファインチューン](/local-llms/fine-tune-local-llm-ollama?lang=ja) -- ユースケース向け調整。',
            '[Ollama API リファレンス](/local-llms/ollama-api-reference?lang=ja) -- プログラマティック使用。',
          ],
        },
        sources: {
          id: 'sources',
      ...
      schema: {
        ...
        'url': 'https://www.promptquorum.com/local-llms/ollama-command-guide?lang=ja',
        'inLanguage': 'ja',
        'datePublished': '2026-04-04',
        'dateModified': '2026-04-19',
    ...
    zh: {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          title: '相关阅读',
          items: [
            '[本地 LLM 完整指南](/local-llms/local-llm-guide?lang=zh) — 从硬件选择到部署的全面概述',
            '[Ollama vs LM Studio](/local-llms/lm-studio-vs-ollama-local-llm?lang=zh) — 命令行与图形界面对比',
            '[LLM 量化详解](/local-llms/quantization-llms-comprehensive-guide?lang=zh) — GGUF、Q4_K_M 和精度权衡',
          ],
        },
        sources: {
          id: 'sources',
      ...
      schema: {
        ...
        'url': 'https://www.promptquorum.com/local-llms/ollama-command-guide?lang=zh',
        'inLanguage': 'zh',
        'datePublished': '2026-04-04',
        'dateModified': '2026-04-19',
        'author': { '@type': 'Organization', 'name': 'PromptQuorum' },
