...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      heroImage: '/images/local-llm-workstation-build-overview-hero-en.webp',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Apple alternative: Mac Studio M5 Max ($2,499, up to 128GB unified memory) or Mac Studio M5 Ultra ($5,499, up to 512GB) ships Sept 22, 2026 (512GB config late October 2026). Quieter, lower power draw, no PC build required — trades raw multi-user throughput for simplicity.',
          ],
        },
        'who-needs': {
          id: 'who-needs',
        ...
        'parts-list': {
          ...
          rows: [
            { 'Component': 'GPU', 'Model': '2× RTX 4090 24GB (used)', 'Price': '$2,200-2,600', 'Notes': 'NVLink bridges optional. Test both cards before pairing.' },
            { 'Component': 'CPU', 'Model': 'Threadripper 7970X (32-core)', 'Price': '$2,400-2,500', 'Notes': 'Enables 32 parallel cores for fine-tuning while serving inference on both GPUs.' },
            { 'Component': 'Motherboard', 'Model': 'TRX850 or Xeon W90', 'Price': '$400-800', 'Notes': 'Dual GPU support, PCIe 5.0, enterprise-grade power delivery.' },
            { 'Component': 'RAM', 'Model': '128GB DDR5 6000 MHz', 'Price': '$600-800', 'Notes': 'Corsair Dominator Platinum. Enables 8+ concurrent users.' },
            { 'Component': 'Storage', 'Model': '4TB NVMe + 12TB HDD', 'Price': '$800-1,200', 'Notes': 'NVMe for hot models, HDD for backup & datasets.' },
            { 'Component': 'PSU', 'Model': '2000W 80+ Platinum or 2× 1200W', 'Price': '$1,000-1,500', 'Notes': 'Dual 4090s = 900W sustained, need 2000W+ headroom.' },
            { 'Component': 'Cooling', 'Model': 'Custom loop or 2× 360mm AIO', 'Price': '$1,500-2,500', 'Notes': 'CPU + 2 GPUs = 1,200W heat. Air cooling insufficient.' },
            { 'Component': 'Case', 'Model': 'Lian Li O11 Dynamic or Corsair Crystal', 'Price': '$200-300', 'Notes': 'Supports dual GPU + large AIO or loop.' },
            { 'Component': 'Total', 'Model': '--', 'Price': '$4,000-6,000', 'Notes': 'Scales with GPU market prices & cooling choice.' },
          ],
          columns: ['Component', 'Model', 'Price', 'Notes'],
        ...
        'relatedReading': {
          ...
          items: [
            '[Best Local LLM PC Build Under $2,000](/local-llms/local-llm-workstation-build) — Mid-range single-GPU setup for small teams.',
            '[Best Local LLM PC Build Under $1,000](/local-llms/local-llm-workstation-build) — Budget-friendly 7B-13B inference.',
            ...
            '[Apple Silicon for Local LLM 2026](/local-llms/apple-silicon-m5-local-llm) — Mac Studio M5 Max/Ultra alternative: up to 512GB unified memory, no PC build required.',
            ...
            'Liquid Cooling for GPU Workstations — Custom loop vs. AIO best practices.',
          ],
        },
        'sources': {
          id: 'sources',
          title: 'Sources',
          items: [
            '[PCPartPicker](https://pcpartpicker.com) — Live component pricing for Threadripper, RTX 4090/5090, and DDR5 RAM.',
            ...
            '[vLLM Distributed Serving](https://docs.vllm.ai/en/stable/serving/parallelism_scaling/) — Multi-GPU tensor parallelism configuration for 70B models on consumer hardware.',
          ],
        },
      },
schema: {
    ...
    de: {
      ...
      heroImage: '/images/local-llm-workstation-build-overview-hero-de.webp',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Apple-Alternative: Mac Studio M5 Max ($2.499, bis zu 128GB Unified Memory) oder Mac Studio M5 Ultra ($5.499, bis zu 512GB), Auslieferung ab 22. September 2026 (512GB-Konfiguration Ende Oktober 2026). Leiser, geringerer Stromverbrauch, kein PC-Build nötig — dafür geringerer Multi-User-Durchsatz.',
          ],
        },
        'who-needs': {
          id: 'who-needs',
        ...
        'parts-list': {
          ...
          rows: [
            { 'Komponente': 'GPU', 'Modell': '2× RTX 4090 24GB (gebraucht)', 'Preis': '€1.900–2.200', 'Notizen': 'NVLink-Brücken optional. Beide Karten vor dem Pairing testen.' },
            { 'Komponente': 'CPU', 'Modell': 'Threadripper 7970X (32-Kern)', 'Preis': '€2.400–2.500', 'Notizen': 'Ermöglicht 32 parallele Kerne für Fine-Tuning während Inferenz auf beiden GPUs läuft.' },
            { 'Komponente': 'Motherboard', 'Modell': 'TRX850 oder Xeon W90', 'Preis': '€400–800', 'Notizen': 'Dual-GPU-Unterstützung, PCIe 5.0, Enterprise-Grade Power Delivery.' },
            { 'Komponente': 'RAM', 'Modell': '128GB DDR5 6000 MHz', 'Preis': '€600–800', 'Notizen': 'Corsair Dominator Platinum. Ermöglicht 8+ gleichzeitige Nutzer.' },
            { 'Komponente': 'Speicher', 'Modell': '4TB NVMe + 12TB HDD', 'Preis': '€800–1.200', 'Notizen': 'NVMe für Hot-Models, HDD für Backup & Datensätze.' },
            { 'Komponente': 'Netzteil', 'Modell': '2000W 80+ Platinum oder 2× 1200W', 'Preis': '€1.000–1.500', 'Notizen': 'Dual 4090s = 900W kontinuierlich, benötigen 2000W+ Headroom.' },
            { 'Komponente': 'Kühlung', 'Modell': 'Custom Loop oder 2× 360mm AIO', 'Preis': '€1.500–2.500', 'Notizen': 'CPU + 2 GPUs = 1.200W Wärme. Luftkühlung unzureichend.' },
            { 'Komponente': 'Gehäuse', 'Modell': 'Lian Li O11 Dynamic oder Corsair Crystal', 'Preis': '€200–300', 'Notizen': 'Unterstützt Dual-GPU + großer AIO oder Loop.' },
            { 'Komponente': 'Gesamt', 'Modell': '--', 'Preis': '€4.000–6.000', 'Notizen': 'Skaliert mit GPU-Marktpreisen & Kühlungsoptionen.' },
          ],
          columns: ['Komponente', 'Modell', 'Preis', 'Notizen'],
        ...
        'relatedReading': {
          ...
          items: [
            ...
            '[Apple Silicon für lokale LLMs 2026](/de/local-llms/apple-silicon-m5-local-llm) — Mac Studio M5 Max/Ultra Alternative: bis zu 512GB Unified Memory, kein PC-Build nötig.',
            '[Bester lokaler LLM PC Build unter €2.000](/de/local-llms/local-llm-workstation-build) — Mid-Range Single-GPU Setup für kleine Teams.',
            '[Bester lokaler LLM PC Build unter €1.000](/de/local-llms/local-llm-workstation-build) — Budget-Friendly 7B-13B Inferenz.',
            ...
            'Liquid-Kühlung für GPU Workstations — Custom Loop vs AIO Best Practices.',
          ],
        },
        'sources': {
          id: 'sources',
          ...
          items: [
            ...
            '[vLLM Distributed Serving](https://docs.vllm.ai/en/stable/serving/parallelism_scaling/) — Multi-GPU Tensor Parallelism Konfiguration für 70B Modelle auf Consumer Hardware.',
          ],
        },
      },
      gammaEmbedUrl: '/presentations/local-llm-workstation-build-static.html',
...
schema: {
    ...
    fr: {
      ...
      heroImage: '/images/local-llm-workstation-build-overview-hero-fr.webp',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Alternative Apple : Mac Studio M5 Max ($2 499, jusqu\'à 128 Go de mémoire unifiée) ou Mac Studio M5 Ultra ($5 499, jusqu\'à 512 Go), disponible à partir du 22 septembre 2026 (configuration 512 Go fin octobre 2026). Plus silencieux, moins gourmand en énergie, aucun assemblage PC requis — au prix d\'un débit multi-utilisateur inférieur.',
          ],
        },
        'who-needs': {
          id: 'who-needs',
        ...
        'relatedReading': {
          ...
          items: [
            ...
            '[Apple Silicon pour LLM local 2026](/fr/local-llms/apple-silicon-m5-local-llm) — Alternative Mac Studio M5 Max/Ultra : jusqu\'à 512 Go de mémoire unifiée, aucun assemblage PC requis.',
            '[Meilleur Local LLM PC Build Sous €2 000](/fr/local-llms/local-llm-workstation-build) — Setup single-GPU gamme-moyenne petites équipes.',
            '[Meilleur Local LLM PC Build Sous €1 000](/fr/local-llms/local-llm-workstation-build) — Inférence 7B–13B budget.',
            ...
            'Refroidissement Liquide pour Stations GPU — Boucle custom vs AIO meilleures pratiques.',
          ],
        },
        'sources': {
          id: 'sources',
          ...
          items: [
            ...
            '[vLLM Distributed Serving](https://docs.vllm.ai/en/stable/serving/parallelism_scaling/) — Configuration Multi-GPU tensor parallelism modèles 70B hardware consumer.',
          ],
        },
      },
      gammaEmbedUrl: '/presentations/local-llm-workstation-build-static.html',
...
schema: {
    ...
    ja: {
      ...
      heroImage: '/images/local-llm-workstation-build-overview-hero-ja.webp',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Apple代替案：Mac Studio M5 Max（$2,499、最大128GBユニファイドメモリ）またはMac Studio M5 Ultra（$5,499、最大512GB）、2026年9月22日発売（512GB構成は2026年10月下旬発売）。より静音で消費電力も低く、PC組み立て不要——ただしマルチユーザー処理能力は下がる。',
          ],
        },
        'who-needs': {
          id: 'who-needs',
        ...
        'parts-list': {
          ...
          rows: [
            { 'コンポーネント': 'GPU', 'モデル': '2× RTX 4090 24GB（中古）', '価格': '¥330,000–385,000', 'ノート': 'NVLink橋をオプション提供。ペアリング前に両カードテスト。' },
            { 'コンポーネント': 'CPU', 'モデル': 'Threadripper 7970X（32コア）', '価格': '¥358,000–367,000', 'ノート': 'ファインチューニング時に32並列コア、両GPU推論実行。' },
            { 'コンポーネント': 'マザーボード', 'モデル': 'TRX850またはXeon W90', '価格': '¥88,000–176,000', 'ノート': 'デュアルGPUサポート、PCIe 5.0、エンタープライズグレード電源。' },
            { 'コンポーネント': 'メモリ', 'モデル': '128GB DDR5 6000 MHz', '価格': '¥132,000–176,000', 'ノート': 'Corsair Dominator Platinum。8+同時ユーザーをサポート。' },
            { 'コンポーネント': 'ストレージ', 'モデル': '4TB NVMe + 12TB HDD', '価格': '¥176,000–264,000', 'ノート': 'ホットモデルNVMe、バックアップ&データセットHDD。' },
            { 'コンポーネント': '電源', 'モデル': '2000W 80+ Platinum または 2× 1200W', '価格': '¥220,000–330,000', 'ノート': 'デュアル4090s = 900W持続、2000W+ ヘッドルーム必須。' },
            { 'コンポーネント': '冷却', 'モデル': 'カスタムループまたは2× 360mm AIO', '価格': '¥330,000–550,000', 'ノート': 'CPU + 2 GPU = 1,200W熱。空冷では不十分。' },
            { 'コンポーネント': 'ケース', 'モデル': 'Lian Li O11 Dynamic または Corsair Crystal', '価格': '¥44,000–66,000', 'ノート': 'デュアルGPUクリアランス、大型AIOループ対応。' },
            { 'コンポーネント': '合計', 'モデル': '--', '価格': '¥880,000–1,320,000', 'ノート': 'GPU市場価格と冷却選択で変動。' },
          ],
          columns: ['コンポーネント', 'モデル', '価格', 'ノート'],
        ...
        'relatedReading': {
          ...
          items: [
            ...
            '[ローカルLLM向けApple Silicon 2026](/ja/local-llms/apple-silicon-m5-local-llm) — Mac Studio M5 Max/Ultra代替案：最大512GBユニファイドメモリ、PC組み立て不要。',
            '[¥220,000以下最高ローカルLLM PCビルド](/ja/local-llms/local-llm-workstation-build) — 小チーム向けミッドレンジシングルGPUセットアップ。',
            '[¥110,000以下最高ローカルLLM PCビルド](/ja/local-llms/local-llm-workstation-build) — バジェット向け7B–13B推論。',
            ...
            'GPU ワークステーション向け液冷 — カスタムループ vs AIO ベストプラクティス。',
          ],
        },
        'sources': {
          id: 'sources',
          title: 'ソース',
          items: [
            '[PCPartPicker](https://pcpartpicker.com) — Threadripper、RTX 4090/5090、DDR5 RAMのライブコンポーネント価格。',
            ...
            '[vLLM分散サービング](https://docs.vllm.ai/en/stable/serving/parallelism_scaling/) — コンシューマーハードウェア上70Bモデル向けマルチGPUテンソル並列設定。',
          ],
        },
      },
schema: {
    ...
    zh: {
      ...
      heroImage: '/images/local-llm-workstation-build-overview-hero-zh.webp',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '苹果替代方案：Mac Studio M5 Max（$2,499，最高128GB统一内存）或Mac Studio M5 Ultra（$5,499，最高512GB），2026年9月22日发货（512GB配置于2026年10月下旬发货）。更安静、功耗更低、无需组装PC——但多用户吞吐量较低。',
          ],
        },
        'who-needs': {
          id: 'who-needs',
        ...
        'parts-list': {
          ...
          rows: [
            { '组件': 'GPU', '型号': '2× RTX 4090 24GB（二手）', '价格': '$2,200–2,600', '备注': 'NVLink桥可选。配对前测试两张卡。' },
            { '组件': 'CPU', '型号': 'Threadripper 7970X（32核）', '价格': '$2,400–2,500', '备注': '32并行核心用于微调同时在两个GPU上提供推理。' },
            { '组件': '主板', '型号': 'TRX850或Xeon W90', '价格': '$400–800', '备注': '双GPU支持、PCIe 5.0、企业级电源传输。' },
            { '组件': '内存', '型号': '128GB DDR5 6000 MHz', '价格': '$600–800', '备注': 'Corsair Dominator Platinum。支持8+并发用户。' },
            { '组件': '存储', '型号': '4TB NVMe + 12TB HDD', '价格': '$800–1,200', '备注': 'NVMe用于热模型，HDD用于备份&数据集。' },
            { '组件': '电源', '型号': '2000W 80+ Platinum或2× 1200W', '价格': '$1,000–1,500', '备注': '双4090s = 900W持续，需要2000W+余量。' },
            { '组件': '冷却', '型号': '自定义环路或2× 360mm AIO', '价格': '$1,500–2,500', '备注': 'CPU + 2个GPU = 1,200W热。空气冷却不足。' },
            { '组件': '机箱', '型号': 'Lian Li O11 Dynamic或Corsair Crystal', '价格': '$200–300', '备注': '支持双GPU + 大型AIO或环路。' },
            { '组件': '总计', '型号': '--', '价格': '$4,000–6,000', '备注': '随GPU市场价格和冷却选择调整。' },
          ],
          columns: ['组件', '型号', '价格', '备注'],
        ...
        'relatedReading': {
          ...
          items: [
            ...
            '[本地LLM的苹果芯片指南 2026](/zh/local-llms/apple-silicon-m5-local-llm) — Mac Studio M5 Max/Ultra替代方案：最高512GB统一内存，无需组装PC。',
            '[最佳$2,000本地LLM PC构建](/zh/local-llms/local-llm-workstation-build) — 小型团队的中端单GPU设置。',
            '[最佳$1,000本地LLM PC构建](/zh/local-llms/local-llm-workstation-build) — 经济型7B–13B推理。',
        ...
        'sources': {
          ...
          items: [
            ...
            '[vLLM分布式服务](https://docs.vllm.ai/en/stable/serving/parallelism_scaling/) — 消费级硬件上70B模型的多GPU张量并行配置。',
          ],
        },
      },
      gammaEmbedUrl: '/presentations/local-llm-workstation-build-static.html',
...
schema: {
    ...
    es: {
      ...
      heroImage: '/images/local-llm-workstation-build-overview-hero-es.webp',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Alternativa Apple: Mac Studio M5 Max ($2,499, hasta 128GB de memoria unificada) o Mac Studio M5 Ultra ($5,499, hasta 512GB), disponible desde el 22 de septiembre de 2026 (la configuración de 512GB llega a finales de octubre de 2026). Más silencioso, menor consumo eléctrico, sin necesidad de ensamblar un PC — a cambio de menor rendimiento multiusuario.',
          ],
        },
        'who-needs': {
          id: 'who-needs',
        ...
        'relatedReading': {
          ...
          items: [
            '[Mejor PC LLM Local por menos de $2,000](/es/local-llms/local-llm-workstation-build) — Configuración de GPU única de gama media para equipos pequeños.',
            '[Mejor PC LLM Local por menos de $1,000](/es/local-llms/local-llm-workstation-build) — Inferencia 7B–13B con presupuesto ajustado.',
            ...
            '[Apple Silicon para LLM local 2026](/es/local-llms/apple-silicon-m5-local-llm) — Alternativa Mac Studio M5 Max/Ultra: hasta 512GB de memoria unificada, sin necesidad de ensamblar un PC.',
            ...
            'Refrigeración líquida para estaciones de trabajo GPU — Mejores prácticas de circuito personalizado vs. AIO.',
          ],
        },
        'sources': {
          id: 'sources',
          ...
          items: [
            ...
            '[vLLM Distributed Serving](https://docs.vllm.ai/en/stable/serving/parallelism_scaling/) — Configuración de paralelismo tensorial multi-GPU para modelos 70B en hardware de consumo.',
          ],
        },
      },
      gammaEmbedUrl: '/presentations/local-llm-workstation-build-static.html',
    ...
    ar: {
      ...
      heroImage: '/images/local-llm-workstation-build-overview-hero-ar.webp',
      ...
      metaDescription: 'محطة بـ ⁨4⁩,⁨000⁩–⁨6⁩,⁨000⁩$: بطاقتا ⁨RTX 4090⁩ (⁨48 GB VRAM⁩)، ⁨Threadripper 7970X⁩ (⁨32⁩ نواة)، ⁨128 GB DDR5⁩، مزود ⁨2⁩,⁨000W⁩. تخدم ⁨2⁩–⁨3⁩ مستخدمين لنماذج ⁨70B⁩.',
      publishDate: '2026-04-05',
      dateModified: '2026-08-26',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'بديل Apple: Mac Studio M5 Max (2,499$، حتى 128GB ذاكرة موحدة) أو Mac Studio M5 Ultra (5,499$، حتى 512GB)، يُشحن في 22 سبتمبر 2026 (تكوين 512GB أواخر أكتوبر 2026). أهدأ واستهلاك طاقة أقل ولا يتطلب تجميع PC — مقابل معدل نقل أقل للمستخدمين المتزامنين.',
          ],
        },
        'who-needs': {
          id: 'who-needs',
        ...
        'relatedReading': {
          ...
          items: [
            '[أفضل حاسوب LLM محلي بأقل من 2,000$](/ar/local-llms/local-llm-workstation-build) — إعداد GPU واحدة من الفئة المتوسطة للفرق الصغيرة.',
            '[أفضل حاسوب LLM محلي بأقل من 1,000$](/ar/local-llms/local-llm-workstation-build) — استدلال 7B–13B بميزانية محدودة.',
            ...
            '[Apple Silicon لنماذج LLM المحلية 2026](/ar/local-llms/apple-silicon-m5-local-llm) — بديل Mac Studio M5 Max/Ultra: حتى 512GB ذاكرة موحدة، بلا حاجة لتجميع PC.',
            ...
            'التبريد السائل لمحطات عمل GPU — أفضل ممارسات الدائرة المخصصة مقابل AIO.',
          ],
        },
        'sources': {
          id: 'sources',
          ...
          items: [
            ...
            '[vLLM Distributed Serving](https://docs.vllm.ai/en/stable/serving/parallelism_scaling/) — إعداد التوازي التنسوري متعدد GPU لنماذج 70B على عتاد استهلاكي.',
          ],
        },
      },
      gammaEmbedUrl: '/presentations/local-llm-workstation-build-static.html',
    ...
    pt: {
      ...
      heroImage: '/images/local-llm-workstation-build-overview-hero-pt.webp',
      ...
      howToSchema: {
        ...
        '@type': 'HowTo',
        inLanguage: 'pt-BR',
        name: 'Como Configurar Dual GPUs para Máximo Desempenho',
        description: 'Três opções de configuração para duas RTX 4090: operação independente, ponte NVLink ou paralelismo de tensores.',
        step: [
          { '@type': 'HowToStep', position: 1, name: 'Operação independente (sem NVLink)', text: 'Cada GPU roda de forma independente. Modelo A na GPU 0, Modelo B na GPU 1. Ideal para workloads heterogêneas (fine-tuning de 7B + servindo 70B).' },
          { '@type': 'HowToStep', position: 2, name: 'Ponte NVLink', text: 'Funde a VRAM (48 GB aparecem como um único pool de 48 GB). Permite batches maiores ou janelas de contexto enormes. Custo: $200–300 para a ponte + complexidade de configuração.' },
          { '@type': 'HowToStep', position: 3, name: 'Inferência dual-GPU', text: 'Distribui um único modelo 70B entre 2 GPUs para 2x de throughput (28 tok/s em vez de 14). Requer suporte a tensor-parallel do vLLM ou llama.cpp.' },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        inLanguage: 'pt-BR',
        name: 'Componentes da Estação de Trabalho LLM Local 2026',
        numberOfItems: 8,
        itemListElement: [
          { '@type': 'ListItem', position: 1, name: 'GPU: 2× RTX 4090 24 GB (par usado)', description: '$2.200–2.600. 48 GB de VRAM combinada. Paralelismo de tensores para 70B a 100 tok/s.' },
          { '@type': 'ListItem', position: 2, name: 'CPU: AMD Threadripper 7970X (32 núcleos)', description: '$2.499. Permite quantização e fine-tuning paralelos enquanto serve inferência.' },
          { '@type': 'ListItem', position: 3, name: 'Placa-mãe: chipset TRX50 (sTR5)', description: '$400–800. Suporte a dual GPU, PCIe 5.0, DDR5 de 7 canais.' },
          { '@type': 'ListItem', position: 4, name: 'RAM: 128 GB DDR5 6000 MHz', description: '$600–800. Corsair Dominator Platinum ou equivalente. Suporta 8+ usuários simultâneos.' },
          { '@type': 'ListItem', position: 5, name: 'Armazenamento: 4 TB NVMe Gen4 + 12 TB HDD', description: '$800–1.200. NVMe para modelos ativos, HDD para backup e datasets de treinamento.' },
          { '@type': 'ListItem', position: 6, name: 'Fonte: 2.000 W 80+ Platinum', description: '$300–500. Duas 4090 consomem 900 W sustentados. Margem para picos de 1.300 W é essencial.' },
          { '@type': 'ListItem', position: 7, name: 'Refrigeração: circuito personalizado ou 2× AIO 360mm', description: '$1.000–2.500. CPU + 2 GPUs = 1.200 W de calor. Refrigeração a ar causa thermal throttling.' },
          { '@type': 'ListItem', position: 8, name: 'Case: Lian Li O11 Dynamic XL', description: '$200–300. Espaço para dual GPU, suporte a radiador grande, gerenciamento de cabos.' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
        ...
        inLanguage: 'pt-BR',
        mainEntity: [
          { '@type': 'Question', name: 'Um Threadripper é necessário, ou posso usar um Ryzen 9?', acceptedAnswer: { '@type': 'Answer', text: 'Apenas para inferência: o Ryzen 9 funciona bem. Para inferência + fine-tuning paralelo: os núcleos extras do Threadripper (32 vs. 16) são essenciais.' } },
          { '@type': 'Question', name: 'Devo usar NVLink para fundir as duas 4090?', acceptedAnswer: { '@type': 'Answer', text: 'Opcional. Pule se estiver rodando modelos separados em cada GPU (7B + 70B). Use se estiver distribuindo um único 70B entre as duas GPUs para batches maiores.' } },
          { '@type': 'Question', name: 'Quantos usuários simultâneos uma configuração dual-4090 suporta?', acceptedAnswer: { '@type': 'Answer', text: 'Para 70B: 2–3 usuários (14 tok/s cada). Para 7B: 8+ usuários (30+ tok/s cada).' } },
          { '@type': 'Question', name: 'Posso migrar para uma RTX 5090 em vez de dual 4090?', acceptedAnswer: { '@type': 'Answer', text: 'RTX 5090 única: desempenho semelhante ao dual 4090, metade da VRAM (24 GB vs. 48 GB), $1.999. Dual 5090: $4.000 (exagero, pior custo-benefício).' } },
          { '@type': 'Question', name: 'Qual o ROI de uma estação de $5.000 vs. API de LLM na nuvem?', acceptedAnswer: { '@type': 'Answer', text: 'Nuvem: $0,001 por 1K tokens. Estação: $5.000 amortizados em 2 anos = $2.500/ano, ~$0,000001 por token. Ponto de equilíbrio em 2,5 bilhões de tokens/ano (uso leve).' } },
        ],
      },
    },
  ko: {
    ...
    heroImage: '/images/local-llm-workstation-build-overview-hero-ko.webp',
      seoTitle: '로컬 LLM 워크스테이션 제작 2026: 듀얼 RTX 4090, $4~6K, 70B 지원',
      intro: '**프로덕션 로컬 LLM 추론을 위한 전문 워크스테이션은 $4,000~6,000이며, 듀얼 RTX 4090 GPU (VRAM 합계 48 GB), Threadripper 7970X CPU (32코어), 128 GB DDR5 RAM, 맞춤형 냉각 시스템, 2,000 W 전원 공급 장치를 갖추고 있습니다.** 2026년 4월 기준, 이 사양은 70B 사용자 2~3명에게 각각 14 tok/s를 동시에 제공하고, Llama 3.3 70B 파인튜닝과 추론을 동시에 실행하며, 클라우드 API 비용 없이 온프레미스 배포를 지원합니다.',
      metaDescription: '올바른 GPU, VRAM, RAM을 갖춘 강력한 로컬 LLM 워크스테이션을 제작하세요. Ollama와 LM Studio로 7B~70B 모델을 빠르게 실행하는 정확한 PC 구성.',
      publishDate: '2026-04-05',
      dateModified: '2026-08-26',
      leadAnswerBlock: '**프로덕션 로컬 LLM 추론을 위한 전문 워크스테이션은 $4,000~6,000이며, 듀얼 RTX 4090 GPU (VRAM 합계 48 GB), Threadripper 7970X CPU (32코어), 128 GB DDR5 RAM, 맞춤형 냉각 시스템, 2,000 W 전원 공급 장치를 갖추고 있습니다.** 2026년 4월 기준, 이 사양은 70B 사용자 2~3명에게 각각 14 tok/s를 동시에 제공하고, Llama 3.3 70B 파인튜닝과 추론을 동시에 실행하며, 클라우드 API 비용 없이 온프레미스 배포를 지원합니다.',
      ...
      toc: [
        ...
        { label: '듀얼 RTX 5090 vs 듀얼 RTX 4090: 가치 비교', anchor: '#rtx5090-vs-4090' },
        { label: '1,200 W의 열을 어떻게 냉각합니까?', anchor: '#cooling' },
        { label: '올바른 전원 공급 장치 및 전기 설정은?', anchor: '#power' },
        { label: '멀티유저 추론 성능은 어느 정도입니까?', anchor: '#perf' },
        { label: '워크스테이션 제작 시 흔한 실수는?', anchor: '#mistakes' },
      ...
      itemListSchema: {
        ...
        '@type': 'ItemList',
        inLanguage: 'ko',
        name: '2026년 로컬 LLM 워크스테이션 구성 부품',
        numberOfItems: 8,
        itemListElement: [
          { '@type': 'ListItem', position: 1, name: 'GPU: RTX 4090 24GB × 2 (중고)', description: '$2,200–2,600. 통합 48GB VRAM. 70B 모델을 100 tok/s로 텐서 병렬 처리.' },
          { '@type': 'ListItem', position: 2, name: 'CPU: AMD Threadripper 7970X (32코어)', description: '$2,499. 추론과 동시에 병렬 양자화 및 파인튜닝 가능.' },
          { '@type': 'ListItem', position: 3, name: '메인보드: TRX50 칩셋 (sTR5)', description: '$400–800. 듀얼 GPU 지원, PCIe 5.0, 7채널 DDR5.' },
          { '@type': 'ListItem', position: 4, name: 'RAM: 128GB DDR5 6000MHz', description: '$600–800. Corsair Dominator Platinum 또는 동급. 8명 이상 동시 사용자 지원.' },
          { '@type': 'ListItem', position: 5, name: '저장장치: 4TB NVMe Gen4 + 12TB HDD', description: '$800–1,200. NVMe는 자주 쓰는 모델용, HDD는 백업 및 훈련 데이터셋용.' },
          { '@type': 'ListItem', position: 6, name: '파워: 2,000W 80+ Platinum', description: '$300–500. 듀얼 4090은 900W를 지속적으로 소비합니다. 1,300W 스파이크에 대한 여유가 필수적입니다.' },
          { '@type': 'ListItem', position: 7, name: '냉각: 커스텀 루프 또는 360mm AIO × 2', description: '$1,000–2,500. CPU + GPU 2개 = 1,200W 발열. 공랭은 열 스로틀링을 유발합니다.' },
          { '@type': 'ListItem', position: 8, name: '케이스: Lian Li O11 Dynamic XL', description: '$200–300. 듀얼 GPU 공간, 대형 라디에이터 지원, 케이블 관리.' },
        ],
      },
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Apple 대안: Mac Studio M5 Max ($2,499, 최대 128GB 통합 메모리) 또는 Mac Studio M5 Ultra ($5,499, 최대 512GB), 2026년 9월 22일 출시 (512GB 구성은 2026년 10월 말 출시). 더 조용하고 전력 소비가 낮으며 PC 조립이 필요 없지만, 멀티유저 처리량은 낮습니다.',
          ],
        },
        'who-needs': {
          id: 'who-needs',
          title: '$4K~6K 워크스테이션이 필요한 사람은?',
          content: '이 사양이 필요한 경우:',
          items: [
        ...
        'parts-list': {
          id: 'parts-list',
          title: '워크스테이션 부품 목록은?',
          content: '**전문 워크스테이션은 듀얼 RTX 4090($2,200~2,600, 중고 쌍)과 Threadripper CPU($2,800~3,200), 128GB DDR5 RAM과 맞춤형 수냉 시스템으로 시작합니다.** 전체 부품 목록과 비용 내역은 다음과 같습니다:',
          rows: [
            { 'Component': 'GPU', 'Model': '2× RTX 4090 24GB (중고)', 'Price': '$2,200~2,600', 'Notes': 'NVLink 브리지 선택 사항. 쌍으로 구성하기 전에 두 카드 모두 테스트하세요.' },
            { 'Component': 'CPU', 'Model': 'Threadripper 7970X (32코어)', 'Price': '$2,400~2,500', 'Notes': '두 GPU에서 추론을 제공하면서 파인튜닝을 위한 32개의 병렬 코어를 지원합니다.' },
            { 'Component': '메인보드', 'Model': 'TRX850 또는 Xeon W90', 'Price': '$400~800', 'Notes': '듀얼 GPU 지원, PCIe 5.0, 엔터프라이즈급 전원 공급.' },
            { 'Component': 'RAM', 'Model': '128GB DDR5 6000 MHz', 'Price': '$600~800', 'Notes': 'Corsair Dominator Platinum. 8명 이상의 동시 사용자 지원.' },
            { 'Component': '스토리지', 'Model': '4TB NVMe + 12TB HDD', 'Price': '$800~1,200', 'Notes': 'NVMe는 핫 모델용, HDD는 백업 및 데이터셋용.' },
            { 'Component': 'PSU', 'Model': '2000W 80+ Platinum 또는 2× 1200W', 'Price': '$1,000~1,500', 'Notes': '듀얼 4090 = 지속 900W 소비, 2000W+ 여유 용량 필요.' },
            { 'Component': '냉각', 'Model': '맞춤형 루프 또는 2× 360mm AIO', 'Price': '$1,500~2,500', 'Notes': 'CPU + GPU 2개 = 1,200W 발열. 공냉식 불충분.' },
            { 'Component': '케이스', 'Model': 'Lian Li O11 Dynamic 또는 Corsair Crystal', 'Price': '$200~300', 'Notes': '듀얼 GPU + 대형 AIO 또는 루프 지원.' },
            { 'Component': '합계', 'Model': '--', 'Price': '$4,000~6,000', 'Notes': 'GPU 시장 가격 및 냉각 선택에 따라 달라집니다.' },
          ],
          columns: ['Component', 'Model', 'Price', 'Notes'],
          image: '/images/local-llm-workstation-build-components-layout-en.svg',
          imageCaption: '워크스테이션 구성 요소: 듀얼 RTX 4090 GPU (총 VRAM 48GB), Threadripper 7970X CPU (32코어), 128GB DDR5 RAM, 2000W PSU, 1,200W 열 방출을 위한 수냉 시스템.',
        },
        'dual-gpu': {
          id: 'dual-gpu',
          title: '최대 성능을 위한 듀얼 GPU 구성 방법은?',
          content: '**두 개의 RTX 4090은 48GB VRAM과 추론을 위한 약 2배의 처리량을 제공합니다.** 세 가지 구성 옵션이 있습니다: 병렬 독립 작동, 통합 VRAM을 위한 NVLink 융합, 단일 모델 가속을 위한 텐서 병렬 처리.',
          numberedItems: [
            '**병렬 독립 작동 (NVLink 없음):** 각 GPU가 독립적으로 실행됩니다. GPU 0에서 모델 A, GPU 1에서 모델 B. 이기종 워크로드(7B 파인튜닝 + 70B 서빙)에 최적.',
            '**NVLink 브리지:** VRAM을 융합합니다 (48GB가 단일 48GB 풀로 표시됨). 더 큰 배치 크기 또는 방대한 컨텍스트 윈도우 지원. 비용: $200~300 브리지 + 설정 복잡성.',
            '**듀얼 GPU 추론:** 단일 70B 모델을 2개의 GPU에 분산하여 2배 처리량 달성 (14 tok/s 대신 28 tok/s). vLLM 또는 llama.cpp 텐서 병렬 지원 필요.',
          ],
          callouts: [
            { type: '💡 Pro Tip', text: '이기종 워크로드의 경우 NVLink를 건너뛰세요. 독립 작동이 더 간단하고 비용이 낮으며 ($200 절약), 브리지 펌웨어 버그를 방지합니다.' },
            { type: '⚠️ Warning', text: 'NVLink 브리지는 NVIDIA 전용 드라이버 지원이 필요합니다. 오픈소스 ROCm 또는 AMD 동급 제품은 서로 다른 GPU 간의 브리지를 지원하지 않습니다.' },
          ],
          snippetBlocks: [
            { type: 'one-sentence', text: '듀얼 GPU는 카드별로 독립 모델을 실행(가장 간단)하거나 NVLink를 통해 VRAM을 풀링(복잡하지만 대형 모델 지원)합니다.' },
            { type: 'plain-terms', text: '두 대의 별도 컴퓨터(병렬 독립)와 하나의 공유 슈퍼컴퓨터(NVLink)로 생각하세요. 병렬 독립이 설정하기 더 쉽고, 공유 방식은 대형 모델에 더 많은 성능을 제공합니다.' },
          ],
          image: '/images/local-llm-workstation-build-dual-gpu-config-en.svg',
          imageCaption: '듀얼 GPU 구성 세 가지 옵션: 병렬 독립(이기종 워크로드, NVLink 없음), NVLink 브리지(통합 48GB VRAM 풀, 대형 컨텍스트 윈도우), 텐서 병렬 처리(28 tok/s 처리량을 위해 GPU 간에 분산된 단일 70B 모델).',
        },
        'rtx5090-vs-4090': {
          id: 'rtx5090-vs-4090',
          ...
          rows: [
            ...
            { 'Configuration': '단일 RTX 5090 (신품)', 'VRAM': '32 GB', '70B Speed': '40~50 tok/s (Q4)', 'Cost': '$2,000' },
            { 'Configuration': '듀얼 RTX 5090 (신품)', 'VRAM': '64 GB', '70B Speed': '120 tok/s (Q4)', 'Cost': '$4,000' },
          ],
          columns: ['Configuration', 'VRAM', '70B Speed', 'Cost'],
          callouts: [
            { type: '💡 Pro Tip', text: '최대 처리량의 Q4 70B 추론의 경우: 중고 듀얼 4090 ($2,200~2,600)이 2026년 4월 최고의 가치를 제공합니다. 신품 5090은 50% 이상 더 비쌉니다.' },
            { type: '📌 Key Point', text: '듀얼 5090은 Q8 70B (더 높은 품질 출력) 또는 미래 대비용에 적합합니다. 단일 5090은 개인 사용자의 듀얼 GPU 복잡성을 제거합니다.' },
          ],
        },
        'cooling': {
          id: 'cooling',
          title: '1,200 W의 열을 어떻게 냉각합니까?',
          content: 'RTX 4090 (450W) + RTX 4090 (450W) + CPU (200W) = 지속 1,100W, 최대 1,300W.',
          items: [
          ...
          callouts: [
            { type: '🛠️ Best Practice', text: '5+ W/mK 열전도율의 써멀 페이스트를 사용하세요 (Noctua NT-H2, Corsair TM30). 저렴한 페이스트는 온도를 10~15°C 높이고 GPU 보증을 무효화할 수 있습니다.' },
          ],
          image: '/images/local-llm-workstation-build-cooling-setup-en.svg',
          imageCaption: '열 방출: 듀얼 RTX 4090 (각 450W)과 Threadripper CPU (200W)에서 총 1,200W. 냉각 솔루션: 맞춤형 수냉 루프 ($1,500~2,500), 듀얼 360mm AIO ($600~900), 공냉식 (권장하지 않음, 열 스로틀링 유발).',
        },
        'power': {
          id: 'power',
          title: '올바른 전원 공급 장치 및 전기 설정은?',
          content: '**듀얼 4090 (지속 900W, 최대 1,300W)은 최소 2000W PSU가 필요합니다 — 그보다 적으면 부하 시 전압 강하 및 충돌이 발생합니다.** 단일 2000W PSU 또는 이중화를 위한 듀얼 1200W PSU를 선택할 수 있지만, 가정/사무실 회로가 최대 부하 시 2000W를 처리할 수 있는지 확인해야 합니다.',
          items: [
          ...
          callouts: [
            { type: '⚠️ Warning', text: '가정용 콘센트는 보통 120V 15A (최대 1,800W)입니다. 듀얼 4090 장비는 차단기를 트립시킵니다. 전용 240V 20A 회로를 설치하세요 ($200~400 전기 기사 비용).' },
            { type: '📌 Key Point', text: '항상 모듈식 PSU를 사용하세요. 듀얼 GPU에는 수십 개의 전원 핀이 있으며, 비모듈식 케이블은 다중 핀 커넥터의 접촉 저항으로 인한 화재 위험을 초래합니다.' },
          ],
          image: '/images/local-llm-workstation-build-power-electrical-en.svg',
          imageCaption: '전력 요구 사항: 지속 약 1,100W (450W + 450W GPU, 200W CPU), 최대 1,300W. PSU 옵션: 단일 2000W (간단, 깔끔한 케이블) 또는 듀얼 1200W (이중화, 복잡한 설정). 둘 다 전용 20A 240V 회로 필요.',
        },
        'perf': {
          id: 'perf',
          title: '멀티유저 추론 성능은 어느 정도입니까?',
          content: '**128GB RAM과 듀얼 4090을 사용하면 70B 사용자 2~3명에게 각각 14 tok/s를 동시에 제공하거나, 7B 사용자 8명 이상에게 각각 30+ tok/s를 제공할 수 있습니다.** 다음 벤치마크는 Q4 양자화와 멀티유저 스케줄링을 위한 vLLM을 가정합니다:',
          items: [
        ...
        'mistakes': {
          ...
          callouts: [
            { type: '⚠️ Warning', text: '불일치하는 GPU (다른 모델이나 VRAM 크기)는 텐서 병렬 처리를 방해합니다. vLLM은 단일 GPU 추론으로 폴백하여 처리량이 절반으로 줄어듭니다.' },
            { type: '💡 Pro Tip', text: '새 단일 카드 대신 (이전 소유자에 의해 함께 작동이 확인된) 중고 RTX 4090 쌍을 구매하세요. $500~800을 절약하고 하드웨어 복권을 피할 수 있습니다.' },
          ],
        },
        'faqSection': {
          id: 'faq',
          title: '자주 묻는 질문',
          faqs: [
            { q: 'Threadripper CPU가 필요합니까, 아니면 Ryzen 9을 사용할 수 있습니까?', a: '추론만을 위한 경우: Ryzen 9도 잘 작동합니다. 추론 + 병렬 파인튜닝의 경우: Threadripper의 추가 코어 (64개 대 16개)가 필수입니다.' },
            { q: '두 4090을 융합하기 위해 NVLink를 사용해야 합니까?', a: '선택 사항입니다. 각 GPU에서 별도 모델을 실행하는 경우 (7B + 70B) 건너뛰세요. 더 높은 배치 크기를 위해 두 GPU에 걸쳐 단일 70B를 분산하는 경우 사용하세요.' },
            { q: '듀얼 4090 장비는 동시 사용자를 몇 명이나 처리할 수 있습니까?', a: '70B의 경우: 2~3명 (각 14 tok/s). 7B의 경우: 8명 이상 (각 30+ tok/s).' },
            { q: '듀얼 4090 대신 RTX 5090으로 업그레이드할 수 있습니까?', a: '단일 5090: 듀얼 4090과 유사한 성능, VRAM 절반 (24GB 대 48GB), $1,999. 듀얼 5090: $4,000 (과도한 사양, 가치 부족).' },
            { q: '$5,000 워크스테이션 대비 클라우드 LLM API의 ROI는 어떻습니까?', a: '클라우드: 1K 토큰당 $0.001. 워크스테이션: $5,000을 2년에 걸쳐 상각하면 연간 $2,500, 토큰당 약 $0.000001. 연간 25억 토큰에서 손익분기점 달성 (가벼운 사용).' },
            { q: '워크스테이션에 데이터 센터 냉각이 필요합니까?', a: '아닙니다. 소비자용 수냉 (2× 360mm AIO 또는 맞춤형 루프)으로 충분합니다. 데이터 센터 냉각 (인라인, 오버헤드)은 고밀도를 위해 설계되었습니다; 단일 워크스테이션의 1,200W는 사무실 HVAC 범위 내에 있습니다.' },
            { q: '지금 듀얼 4090을 구매하는 대신 RTX 6090을 기다려야 합니까?', a: 'NVIDIA의 RTX 60시리즈는 역사적인 2년 교체 주기를 기반으로 2026년 말부터 2027년으로 예상됩니다. 지금 워크스테이션이 필요하다면: 중고 듀얼 RTX 4090 ($2,200~2,600)이 2026년 4월 기준 최고의 70B 추론 가치를 제공합니다. 12~18개월을 기다릴 수 있다면: RTX 6090은 단일 카드에 48GB VRAM을 탑재할 가능성이 높아 듀얼 GPU의 필요성을 완전히 없애줄 것입니다.' },
            { q: '듀얼 4090 워크스테이션의 소음 수준은 어떻습니까?', a: '지속적인 70B 추론 시: 맞춤형 수냉으로 1미터에서 50~60 dB. 일반 사무실 대화와 비슷합니다. 듀얼 360mm AIO의 경우: 55~65 dB (부하 시 더 큰 소음). 공냉식: 65~75 dB (시끄러워 사무실 사용에 부적합). 데스크 사이드 배치의 경우: 맞춤형 루프 또는 조용한 AIO가 필수입니다. 서버실 배치의 경우: 소음은 관계없습니다.' },
          ],
          callouts: [
            { type: '🔍 Did You Know?', text: '전체 추론 부하에서 듀얼 RTX 4090은 지속적으로 900W를 소비합니다. 24/7 운영 시 미국 평균 요금 ($0.13/kWh) 기준 연간 전기 요금: 약 $2,000.' },
          ],
        },
        'relatedReading': {
          id: 'related-reading',
          title: '관련 읽기',
          items: [
            '[로컬 LLM PC 제작 $2,000 이하](/ko/local-llms/local-llm-workstation-build) — 소규모 팀을 위한 중간급 단일 GPU 설정.',
            '[로컬 LLM PC 제작 $1,000 이하](/ko/local-llms/local-llm-workstation-build) — 예산 친화적인 7B~13B 추론.',
            '[AMD Ryzen AI Max+ 미니 PC (2026)](/ko/local-llms/best-amd-mini-pc-local-llm-2026) — 대안: 30~70B 모델 추론을 위한 64~128GB 통합 메모리 컴팩트 시스템.',
            '[2026년 로컬 LLM용 Apple Silicon](/ko/local-llms/apple-silicon-m5-local-llm) — Mac Studio M5 Max/Ultra 대안: 최대 512GB 통합 메모리, PC 조립 불필요.',
            '[클라우드 GPU 임대 vs 구매: 언제 임대하나요](/ko/local-llms/cloud-gpu-rental-comparison-2026) — RunPod, Vast.ai, Lambda Labs 가격 및 의사결정 매트릭스.',
            '[RTX 5090 vs RTX 4090](/ko/local-llms/rtx-5090-vs-rtx-4090-local-llm) — 워크스테이션 업그레이드를 위한 단일 GPU 비교.',
            '[LoRA로 로컬 LLM 파인튜닝](/ko/local-llms/fine-tuning-local-llms-lora) — 듀얼 GPU에서의 병렬 파인튜닝 기술.',
            '[로컬 LLM에 필요한 VRAM 용량은?](/ko/local-llms/how-much-vram-local-llm) — 8GB부터 128GB까지 VRAM 스케일링.',
            'GPU 워크스테이션 수냉 — 맞춤형 루프 vs AIO 모범 사례.',
          ],
        },
        'sources': {
          id: 'sources',
          title: '출처',
          items: [
            '[PCPartPicker](https://pcpartpicker.com) — 2026년 4월 기준 Threadripper, RTX 4090/5090, DDR5 RAM의 실시간 부품 가격.',
            '[TechPowerUp CPU Database](https://www.techpowerup.com/cpu-specs/?mfgr=AMD&family=Threadripper) — Threadripper 7970X 공식 전력 소비 및 코어 수 사양.',
            '[NVIDIA NVLink Documentation](https://www.nvidia.com/en-us/data-center/nvlink/) — 듀얼 RTX 카드에서의 메모리 풀링 및 텐서 병렬 처리를 위한 NVLink 공식 사양.',
            '[vLLM Distributed Serving](https://docs.vllm.ai/en/stable/serving/parallelism_scaling/) — 소비자 하드웨어에서 70B 모델을 위한 멀티 GPU 텐서 병렬 처리 구성.',
          ],
        },
      },
    },
