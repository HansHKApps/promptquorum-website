  ...
  ko: {
      ...
      sections: {
        ...
        'relatedReading': {
          ...
          title: '관련 읽기',
          items: [
            '[로컬 LLM PC 제작 $2,000 이하](/local-llms/local-llm-pc-build-2000) — 소규모 팀을 위한 중간급 단일 GPU 설정.',
            '[로컬 LLM PC 제작 $1,000 이하](/local-llms/local-llm-pc-build-1000) — 예산 친화적인 7B~13B 추론.',
            ...
            '[GPU 워크스테이션 수냉](/local-llms/gpu-cooling-strategies) — 맞춤형 루프 vs AIO 모범 사례.',
          ],
        },
        'sources': {
          id: 'sources',
