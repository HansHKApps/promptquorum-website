    ...
    heroImage: '/images/local-llm-workstation-build-overview-hero-ko.webp',
      ...
      sections: {
        ...
        'parts-list': {
          ...
          rows: [
            { 'Component': 'GPU', 'Model': '2× RTX 4090 24GB (중고)', 'Price (April 2026)': '$2,200~2,600', 'Notes': 'NVLink 브리지 선택 사항. 쌍으로 구성하기 전에 두 카드 모두 테스트하세요.' },
            { 'Component': 'CPU', 'Model': 'Threadripper 7970X (32코어)', 'Price (April 2026)': '$2,400~2,500', 'Notes': '두 GPU에서 추론을 제공하면서 파인튜닝을 위한 32개의 병렬 코어를 지원합니다.' },
            { 'Component': '메인보드', 'Model': 'TRX850 또는 Xeon W90', 'Price (April 2026)': '$400~800', 'Notes': '듀얼 GPU 지원, PCIe 5.0, 엔터프라이즈급 전원 공급.' },
            { 'Component': 'RAM', 'Model': '128GB DDR5 6000 MHz', 'Price (April 2026)': '$600~800', 'Notes': 'Corsair Dominator Platinum. 8명 이상의 동시 사용자 지원.' },
            { 'Component': '스토리지', 'Model': '4TB NVMe + 12TB HDD', 'Price (April 2026)': '$800~1,200', 'Notes': 'NVMe는 핫 모델용, HDD는 백업 및 데이터셋용.' },
            { 'Component': 'PSU', 'Model': '2000W 80+ Platinum 또는 2× 1200W', 'Price (April 2026)': '$1,000~1,500', 'Notes': '듀얼 4090 = 지속 900W 소비, 2000W+ 여유 용량 필요.' },
            { 'Component': '냉각', 'Model': '맞춤형 루프 또는 2× 360mm AIO', 'Price (April 2026)': '$1,500~2,500', 'Notes': 'CPU + GPU 2개 = 1,200W 발열. 공냉식 불충분.' },
            { 'Component': '케이스', 'Model': 'Lian Li O11 Dynamic 또는 Corsair Crystal', 'Price (April 2026)': '$200~300', 'Notes': '듀얼 GPU + 대형 AIO 또는 루프 지원.' },
            { 'Component': '합계', 'Model': '--', 'Price (April 2026)': '$4,000~6,000', 'Notes': 'GPU 시장 가격 및 냉각 선택에 따라 달라집니다.' },
          ],
          columns: ['Component', 'Model', 'Price (April 2026)', 'Notes'],
          image: '/images/local-llm-workstation-build-components-layout-en.svg',
