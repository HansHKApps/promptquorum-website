    ...
    heroImage: '/images/local-llm-workstation-build-overview-hero-ko.webp',
      ...
      sections: {
        ...
        'relatedReading': {
          ...
          title: '관련 읽기',
          items: [
            '[로컬 LLM PC 제작 $2,000 이하](/local-llms/local-llm-workstation-build) — 소규모 팀을 위한 중간급 단일 GPU 설정.',
            '[로컬 LLM PC 제작 $1,000 이하](/local-llms/local-llm-workstation-build) — 예산 친화적인 7B~13B 추론.',
            '[AMD Ryzen AI Max+ 미니 PC (2026)](/local-llms/best-amd-mini-pc-local-llm-2026) — 대안: 30~70B 모델 추론을 위한 64~128GB 통합 메모리 컴팩트 시스템.',
            '[2026년 로컬 LLM용 Apple Silicon](/local-llms/apple-silicon-m5-local-llm) — Mac Studio M5 Max/Ultra 대안: 최대 512GB 통합 메모리, PC 조립 불필요.',
            '[클라우드 GPU 임대 vs 구매: 언제 임대하나요](/local-llms/cloud-gpu-rental-comparison-2026) — RunPod, Vast.ai, Lambda Labs 가격 및 의사결정 매트릭스.',
            '[RTX 5090 vs RTX 4090](/local-llms/rtx-5090-vs-rtx-4090-local-llm) — 워크스테이션 업그레이드를 위한 단일 GPU 비교.',
            '[LoRA로 로컬 LLM 파인튜닝](/local-llms/fine-tuning-local-llms-lora) — 듀얼 GPU에서의 병렬 파인튜닝 기술.',
            '[로컬 LLM에 필요한 VRAM 용량은?](/local-llms/how-much-vram-local-llm) — 8GB부터 128GB까지 VRAM 스케일링.',
