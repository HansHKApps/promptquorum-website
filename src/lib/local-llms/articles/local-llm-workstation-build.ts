      ...
      sections: {
        ...
        'relatedReading': {
          ...
          items: [
            ...
            '[Fine-Tuning lokaler LLMs mit LoRA](/local-llms/fine-tuning-local-llms-lora?lang=de) — Techniken für Parallel Fine-Tuning auf Dual-GPUs.',
            '[Wie viel VRAM für lokale LLMs?](/local-llms/how-much-vram-local-llm?lang=de) — VRAM Skalierung von 8GB bis 128GB.',
            '[Liquid-Kühlung für GPU Workstations](/local-llms/gpu-cooling-strategies?lang=de) — Custom Loop vs AIO Best Practices.',
          ],
        },
        'sources': {
          id: 'sources',
...
schema: {
        ...
        'url': 'https://www.promptquorum.com/local-llms/local-llm-workstation-build?lang=de',
        'inLanguage': 'de',
        'datePublished': '2026-04-05',
        'dateModified': '2026-04-25',
        'author': {
      ...
      sections: {
        ...
        'relatedReading': {
          ...
          items: [
            ...
            '[Fine-Tuning LLMs Locaux avec LoRA](/local-llms/fine-tuning-local-llms-lora?lang=fr) — Techniques fine-tuning parallèle GPU-dual.',
            '[Combien VRAM pour LLMs Locaux ?](/local-llms/how-much-vram-local-llm?lang=fr) — Skalage VRAM 8 GB à 128 GB.',
            '[Refroidissement Liquide pour Stations GPU](/local-llms/gpu-cooling-strategies?lang=fr) — Boucle custom vs AIO meilleures pratiques.',
          ],
        },
        'sources': {
          id: 'sources',
...
schema: {
        ...
        'url': 'https://www.promptquorum.com/local-llms/local-llm-workstation-build?lang=fr',
        'inLanguage': 'fr',
        'datePublished': '2026-04-05',
        'dateModified': '2026-04-25',
        'author': {
      ...
      sections: {
        ...
        'relatedReading': {
          ...
          items: [
            ...
            '[LoRAでローカルLLMをファインチューニング](/local-llms/fine-tuning-local-llms-lora?lang=ja) — デュアルGPU上並行ファインチューニング技術。',
            '[ローカルLLM向けVRAMはいくつか必要か？](/local-llms/how-much-vram-local-llm?lang=ja) — 8GBから128GBへのVRAMスケーリング。',
            '[GPU ワークステーション向け液冷](/local-llms/gpu-cooling-strategies?lang=ja) — カスタムループ vs AIO ベストプラクティス。',
          ],
        },
        'sources': {
          id: 'sources',
...
schema: {
        ...
        'url': 'https://www.promptquorum.com/local-llms/local-llm-workstation-build?lang=ja',
        'inLanguage': 'ja',
        'datePublished': '2026-04-05',
        'dateModified': '2026-04-25',
        'author': {
      ...
      sections: {
        ...
        'relatedReading': {
          ...
          items: [
            ...
            '[使用LoRA微调本地LLM](/local-llms/fine-tuning-local-llms-lora?lang=zh) — 双GPU上的并行微调技术。',
            '[本地LLM需要多少显存？](/local-llms/how-much-vram-local-llm?lang=zh) — 8GB到128GB的显存扩展。',
            '[GPU工作站的液冷](/local-llms/gpu-cooling-strategies?lang=zh) — 自定义环路vs AIO最佳实践。',
          ],
        },
        'sources': {
          id: 'sources',
...
schema: {
        ...
        'url': 'https://www.promptquorum.com/local-llms/local-llm-workstation-build?lang=zh',
        'inLanguage': 'zh',
        'datePublished': '2026-04-05',
        'dateModified': '2026-04-25',
        'author': {
