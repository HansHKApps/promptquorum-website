...
schema: {
      ...
      faqSchema: {
        ...
        'url': 'https://www.promptquorum.com/local-llms/mac-vs-windows-vs-linux-local-llm',
        'mainEntity': [
          { '@type': 'Question', 'name': 'Can I run Llama 3.3 70B on macOS?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes — MacBook Pro M5 Pro (64 GB) runs 70B Q4 at 15–20 tok/sec. M5 Max (128 GB) runs 70B Q8 at 25–35 tok/sec. Mac mini M4 Pro (64 GB, still current) runs 70B at 10–15 tok/sec. Smaller configs (32 GB or less) cannot fit 70B.' } },
    ...
    es: {
      ...
      faqSchema: {
        ...
        'url': 'https://www.promptquorum.com/es/local-llms/mac-vs-windows-vs-linux-local-llm',
        'mainEntity': [
          { '@type': 'Question', 'name': '¿Puedo ejecutar Llama 3.3 70B en macOS?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Sí — MacBook Pro M5 Pro (64 GB) ejecuta 70B Q4 a 15–20 tok/s. M5 Max (128 GB) ejecuta 70B Q8 a 25–35 tok/s. Mac mini M4 Pro (64 GB, vigente) ejecuta 70B a 10–15 tok/s. Las configuraciones más pequeñas (32 GB o menos) no caben en 70B.' } },
    ...
    ar: {
      ...
      specific_year: 2026,
      theme: 'Cost & Comparisons',
      title: 'Mac مقابل Windows مقابل Linux لنماذج LLM المحلية 2026: مقارنة Apple M5 وRTX 5090 وخادم Linux',
      ...
      metaDescription: 'M5 Max 128GB: 70B بسرعة 25–35 tok/s و614 GB/s. RTX 5090 32GB: 40–50 tok/s بتكلفة 2,000 دولار. Linux أسرع بنسبة 1–5% وتكلفة 810 دولارات على 3 سنوات.',
      publishDate: '2026-04-05',
      dateModified: '2026-04-19',
      ...
      sections: {
        ...
        'tco': {
          ...
          image: '/images/mac-vs-windows-vs-linux-local-llm-tco-es.svg',
          imageCaption: 'التكلفة الإجمالية للملكية على 3 سنوات لنماذج LLM المحلية: Linux + RTX 5060 Ti الأرخص بـ 810 دولارات؛ Mac mini M4 Pro يكلّف 2,319 دولارًا؛ MacBook Pro M5 Max يكلّف 3,529 دولارًا؛ Linux + RTX 5090 يوفّر أفضل قيمة GPU بـ 1,500 دولار.',
          content: [
          ...
          note: '**الخلاصة الرئيسية:** Linux + RTX 5060 Ti يبقى حل الإنتاج الأكثر اقتصادًا بـ 810 دولارات على 3 سنوات. Mac mini M4 Pro هو خيار Apple الأرخص الذي يشغّل 70B (2,319 دولارًا). M5 Max الأغلى في البداية لكنه يوفّر ذاكرة 4× (128 GB مقابل 32 GB في RTX 5090).',
        },
        'faqSection': {
          id: 'faq',
          ...
          faqs: [
            {
              ...
              a: 'نعم — MacBook Pro M5 Pro (64 GB) يشغّل 70B Q4 بسرعة 15–20 tok/s. M5 Max (128 GB) يشغّل 70B Q8 بسرعة 25–35 tok/s. Mac mini M4 Pro (64 GB، متاح حاليًا) يشغّل 70B بسرعة 10–15 tok/s. التهيئات الأصغر (32 GB أو أقل) لا تتسع لـ 70B.',
            },
            {
            ...
            {
              q: 'هل أنتظر Mac mini M5 أم أشتري Mac mini M4 Pro الآن؟',
              a: 'يُتوقع Mac mini M5 Pro في منتصف 2026 (ربما WWDC في يونيو، وربما يتأخر إلى أكتوبر بسبب نقص عالمي في RAM). إذا احتجت جهاز 70B الآن، Mac mini M4 Pro 64 GB (2,299 دولارًا) يشغّل 70B بسرعة 10–15 tok/s. M5 Pro mini سيبلغ على الأرجح 15–20 tok/s — تحسّن بنسبة 50%. إذا أمكنك الانتظار 3–6 أشهر، انتظر.',
            },
          ],
        },
        'commonMistakes': {
      ...
      faqSchema: {
        ...
        'url': 'https://www.promptquorum.com/ar/local-llms/mac-vs-windows-vs-linux-local-llm',
        'mainEntity': [
          { '@type': 'Question', 'name': 'هل يمكنني تشغيل Llama 3.3 70B على macOS؟', 'acceptedAnswer': { '@type': 'Answer', 'text': 'نعم — MacBook Pro M5 Pro (64 GB) يشغّل 70B Q4 بسرعة 15–20 tok/s. M5 Max (128 GB) يشغّل 70B Q8 بسرعة 25–35 tok/s. Mac mini M4 Pro (64 GB، متاح حاليًا) يشغّل 70B بسرعة 10–15 tok/s. التهيئات الأصغر (32 GB أو أقل) لا تتسع لـ 70B.' } },
          ...
          { '@type': 'Question', 'name': 'هل أنتظر Mac mini M5 أم أشتري Mac mini M4 Pro الآن؟', 'acceptedAnswer': { '@type': 'Answer', 'text': 'يُتوقع Mac mini M5 Pro في منتصف 2026 (ربما WWDC في يونيو، وربما يتأخر إلى أكتوبر بسبب نقص عالمي في RAM). إذا احتجت جهاز 70B الآن، Mac mini M4 Pro 64 GB (2,299 دولارًا) يشغّل 70B بسرعة 10–15 tok/s. M5 Pro mini سيبلغ على الأرجح 15–20 tok/s — تحسّن بنسبة 50%. إذا أمكنك الانتظار 3–6 أشهر، انتظر.' } },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
...
schema: {
    ...
    schema: {
          ...
          faqSchema: {
            ...
            'url': 'https://www.promptquorum.com/ja/local-llms/mac-vs-windows-vs-linux-local-llm',
            'mainEntity': [
              { '@type': 'Question', 'name': 'macOS で Llama 3.3 70B を実行できますか？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'はい — MacBook Pro M5 Pro（64GB）は70B Q4を15–20トークン/秒で実行。M5 Max（128GB）は70B Q8を25–35トークン/秒で実行。Mac mini M4 Pro（64GB、現行）は70B を10–15トークン/秒で実行。小さい構成（32GB以下）は70B を収容できません。' } },
    ...
    schema: {
          ...
          faqSchema: {
            ...
            'url': 'https://www.promptquorum.com/zh/local-llms/mac-vs-windows-vs-linux-local-llm',
            'mainEntity': [
              { '@type': 'Question', 'name': '能在macOS上运行Llama 3.3 70B吗？', 'acceptedAnswer': { '@type': 'Answer', 'text': '能——MacBook Pro M5 Pro（64GB）运行70B Q4为15–20标记/秒。M5 Max（128GB）运行70B Q8为25–35标记/秒。Mac mini M4 Pro（64GB、现行）运行70B为10–15标记/秒。更小配置（32GB以下）装不下70B。' } },
  ...
  ko: {
      ...
      sections: {
        ...
        'tco': {
          ...
          image: '/images/mac-vs-windows-vs-linux-local-llm-tco-en.svg',
          imageCaption: '로컬 LLM의 3년 총소유비용: Linux + RTX 5060 Ti가 $810으로 가장 저렴, Mac mini M4 Pro는 $2,319, MacBook Pro M5 Max는 $3,529, Linux + RTX 5090은 $1,500으로 최고의 GPU 가성비 제공.',
          content: [
            '| 설정 | 1년차 | 2~3년차 | 3년 합계 |',
            '|---|---|---|---|',
          ...
          note: '**핵심 인사이트:** Linux + RTX 5060 Ti는 3년간 $810으로 가장 저렴한 프로덕션 솔루션입니다. Mac mini M4 Pro는 70B를 실행할 수 있는 가장 저렴한 Apple 옵션($2,319)입니다. M5 Max는 초기 비용이 가장 비싸지만 메모리가 4배 많습니다(RTX 5090의 32 GB 대비 128 GB).',
        },
        'faqSection': {
          id: 'faq',
          title: '자주 묻는 질문',
          faqs: [
            {
              ...
              a: '네 — MacBook Pro M5 Pro(64 GB)는 70B Q4를 초당 15~20 토큰으로 실행합니다. M5 Max(128 GB)는 70B Q8을 초당 25~35 토큰으로 실행합니다. Mac mini M4 Pro(64 GB, 현재 판매 중)는 70B를 초당 10~15 토큰으로 실행합니다. 32 GB 이하 구성은 70B를 수용할 수 없습니다.',
            },
            {
            ...
            {
              q: 'Mac mini M5를 기다려야 합니까, 아니면 지금 Mac mini M4 Pro를 구매해야 합니까?',
              a: 'Mac mini M5 Pro는 2026년 중반 출시 예정입니다(WWDC 6월 가능성 있음, 글로벌 RAM 부족으로 10월 지연 가능성도 있음). 지금 70B 머신이 필요하다면, Mac mini M4 Pro 64 GB($2,299)가 70B를 초당 10~15 토큰으로 실행합니다. M5 Pro mini는 초당 15~20 토큰에 도달할 것으로 예상됩니다 — 50% 향상. 3~6개월을 기다릴 수 있다면 기다리십시오.',
            },
          ],
        },
        'commonMistakes': {
