...
print(embedding.data[0].embedding[:5])`,
  ...
  ar: {
    ...
    seoTitle: 'Xinference: Llama 3 وQwen وChatGLM وMistral محليًا',
    ...
    metaDescription: 'يدعم Xinference 200+ نموذج منها Llama 3 وQwen 3 وChatGLM4 وMistral — pip install ثم xinference launch، وAPI متوافقة مع OpenAI على localhost:9997.',
    publishDate: '2026-05-23',
    dateModified: '2026-05-23',
