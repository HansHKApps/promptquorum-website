...
print(embedding.data[0].embedding[:5])`,
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      'url': 'https://www.promptquorum.com/local-llms/xinference-llama-qwen-chatglm-mistral?lang=de',
      'inLanguage': 'de',
...
print(embedding.data[0].embedding[:5])`,
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      'url': 'https://www.promptquorum.com/local-llms/xinference-llama-qwen-chatglm-mistral?lang=fr',
      'inLanguage': 'fr',
...
print(embedding.data[0].embedding[:5])`,
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      'url': 'https://www.promptquorum.com/local-llms/xinference-llama-qwen-chatglm-mistral?lang=ja',
      'inLanguage': 'ja',
...
print(embedding.data[0].embedding[:5])`,
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      'url': 'https://www.promptquorum.com/local-llms/xinference-llama-qwen-chatglm-mistral?lang=zh',
      'inLanguage': 'zh',
