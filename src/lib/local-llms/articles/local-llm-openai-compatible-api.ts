    ...
    en: {
      ...
      sections: {
        ...
        lmStudio: {
          ...
          codeLanguage: 'python',
          rows: [
            { 'Platform': '[LM Studio](https://lmstudio.ai)', 'Port': 'localhost:1234', 'Best For': 'GUI users, visual model management', 'GPU Required': 'No (CPU works)' },
            { 'Platform': '[Ollama](https://ollama.com)', 'Port': 'localhost:11434', 'Best For': 'Scripting, automation, production', 'GPU Required': 'No (CPU works)' },
            { 'Platform': '[vLLM](https://github.com/vllm-project/vllm)', 'Port': 'localhost:8000', 'Best For': 'Multi-GPU, high-throughput servers', 'GPU Required': 'Recommended' },
          ],
        ...
        aiCodingTools: {
          ...
          rows: [
            { 'Tool': '[Cline](https://cline.bot)', 'Config Location': 'VS Code extension settings → API Provider → OpenAI Compatible', 'Local Base URL': 'http://localhost:11434/v1 (Ollama) or :1234/v1 (LM Studio)' },
            { 'Tool': '[Roo Code](https://github.com/RooCodeInc/Roo-Code)', 'Config Location': 'VS Code extension settings → API Provider (same pattern as Cline)', 'Local Base URL': 'http://localhost:11434/v1 (Ollama) or :1234/v1 (LM Studio)' },
            { 'Tool': '[Aider](https://aider.chat)', 'Config Location': 'OPENAI_API_BASE / OPENAI_API_KEY environment variables or CLI flags', 'Local Base URL': 'http://localhost:11434/v1 (Ollama) or :1234/v1 (LM Studio)' },
          ],
    ...
    de: {
      ...
      sections: {
        ...
        lmStudio: {
          ...
          codeLanguage: 'python',
          rows: [
            { 'Plattform': '[LM Studio](https://lmstudio.ai)', 'Port': 'localhost:1234', 'Beste für': 'GUI Nutzer, visuelles Modell-Management', 'GPU erforderlich': 'Nein (CPU funktioniert)' },
            { 'Plattform': '[Ollama](https://ollama.com)', 'Port': 'localhost:11434', 'Beste für': 'Scripting, Automatisierung, Produktion', 'GPU erforderlich': 'Nein (CPU funktioniert)' },
            { 'Plattform': '[vLLM](https://github.com/vllm-project/vllm)', 'Port': 'localhost:8000', 'Beste für': 'Multi-GPU, hochdurchsatzige Server', 'GPU erforderlich': 'Empfohlen' },
          ],
        ...
        aiCodingTools: {
          ...
          rows: [
            { 'Tool': '[Cline](https://cline.bot)', 'Konfigurationsort': 'VS Code Erweiterungseinstellungen → API Provider → OpenAI Compatible', 'Lokale Base URL': 'http://localhost:11434/v1 (Ollama) oder :1234/v1 (LM Studio)' },
            { 'Tool': '[Roo Code](https://github.com/RooCodeInc/Roo-Code)', 'Konfigurationsort': 'VS Code Erweiterungseinstellungen → API Provider (gleiches Muster wie Cline)', 'Lokale Base URL': 'http://localhost:11434/v1 (Ollama) oder :1234/v1 (LM Studio)' },
            { 'Tool': '[Aider](https://aider.chat)', 'Konfigurationsort': 'OPENAI_API_BASE / OPENAI_API_KEY Umgebungsvariablen oder CLI-Flags', 'Lokale Base URL': 'http://localhost:11434/v1 (Ollama) oder :1234/v1 (LM Studio)' },
          ],
    ...
    fr: {
      ...
      sections: {
        ...
        lmStudio: {
          ...
          codeLanguage: 'python',
          rows: [
            { 'Plateforme': '[LM Studio](https://lmstudio.ai)', 'Port': 'localhost:1234', 'Idéal pour': 'Utilisateurs GUI, gestion visuelle des modèles', 'GPU requis': 'Non (CPU fonctionne)' },
            { 'Plateforme': '[Ollama](https://ollama.com)', 'Port': 'localhost:11434', 'Idéal pour': 'Scripts, automatisation, production', 'GPU requis': 'Non (CPU fonctionne)' },
            { 'Plateforme': '[vLLM](https://github.com/vllm-project/vllm)', 'Port': 'localhost:8000', 'Idéal pour': 'Multi-GPU, serveurs haute performance', 'GPU requis': 'Recommandé' },
          ],
        ...
        aiCodingTools: {
          ...
          rows: [
            { 'Outil': '[Cline](https://cline.bot)', 'Emplacement de configuration': 'Paramètres de l\'extension VS Code → API Provider → OpenAI Compatible', 'Base URL locale': 'http://localhost:11434/v1 (Ollama) ou :1234/v1 (LM Studio)' },
            { 'Outil': '[Roo Code](https://github.com/RooCodeInc/Roo-Code)', 'Emplacement de configuration': 'Paramètres de l\'extension VS Code → API Provider (même schéma que Cline)', 'Base URL locale': 'http://localhost:11434/v1 (Ollama) ou :1234/v1 (LM Studio)' },
            { 'Outil': '[Aider](https://aider.chat)', 'Emplacement de configuration': 'Variables d\'environnement OPENAI_API_BASE / OPENAI_API_KEY ou options CLI', 'Base URL locale': 'http://localhost:11434/v1 (Ollama) ou :1234/v1 (LM Studio)' },
          ],
    ...
    ja: {
      ...
      sections: {
        ...
        lmStudio: {
          ...
          codeLanguage: 'python',
          rows: [
            { 'プラットフォーム': '[LM Studio](https://lmstudio.ai)', 'ポート': 'localhost:1234', '最適用途': 'GUIユーザー、ビジュアルモデル管理', 'GPU必要': '不要（CPUで動作）' },
            { 'プラットフォーム': '[Ollama](https://ollama.com)', 'ポート': 'localhost:11434', '最適用途': 'スクリプト、自動化、本番環境', 'GPU必要': '不要（CPUで動作）' },
            { 'プラットフォーム': '[vLLM](https://github.com/vllm-project/vllm)', 'ポート': 'localhost:8000', '最適用途': 'マルチGPU、高スループットサーバー', 'GPU必要': '推奨' },
          ],
        ...
        aiCodingTools: {
          ...
          rows: [
            { 'ツール': '[Cline](https://cline.bot)', '設定場所': 'VS Code拡張機能設定 → API Provider → OpenAI Compatible', 'ローカルBase URL': 'http://localhost:11434/v1（Ollama）または:1234/v1（LM Studio）' },
            { 'ツール': '[Roo Code](https://github.com/RooCodeInc/Roo-Code)', '設定場所': 'VS Code拡張機能設定 → API Provider（Clineと同じパターン）', 'ローカルBase URL': 'http://localhost:11434/v1（Ollama）または:1234/v1（LM Studio）' },
            { 'ツール': '[Aider](https://aider.chat)', '設定場所': 'OPENAI_API_BASE / OPENAI_API_KEY 環境変数またはCLIフラグ', 'ローカルBase URL': 'http://localhost:11434/v1（Ollama）または:1234/v1（LM Studio）' },
          ],
    ...
    zh: {
      ...
      sections: {
        ...
        lmStudio: {
          ...
          codeLanguage: 'python',
          rows: [
            { '平台': '[LM Studio](https://lmstudio.ai)', '端口': 'localhost:1234', '最适用途': 'GUI用户，可视化模型管理', '需要GPU': '否（CPU可运行）' },
            { '平台': '[Ollama](https://ollama.com)', '端口': 'localhost:11434', '最适用途': '脚本、自动化、生产环境', '需要GPU': '否（CPU可运行）' },
            { '平台': '[vLLM](https://github.com/vllm-project/vllm)', '端口': 'localhost:8000', '最适用途': '多GPU、高吞吐量服务器', '需要GPU': '推荐' },
          ],
        ...
        aiCodingTools: {
          ...
          rows: [
            { '工具': '[Cline](https://cline.bot)', '配置位置': 'VS Code扩展设置 → API Provider → OpenAI Compatible', '本地Base URL': 'http://localhost:11434/v1（Ollama）或:1234/v1（LM Studio）' },
            { '工具': '[Roo Code](https://github.com/RooCodeInc/Roo-Code)', '配置位置': 'VS Code扩展设置 → API Provider（与Cline相同模式）', '本地Base URL': 'http://localhost:11434/v1（Ollama）或:1234/v1（LM Studio）' },
            { '工具': '[Aider](https://aider.chat)', '配置位置': 'OPENAI_API_BASE / OPENAI_API_KEY 环境变量或CLI参数', '本地Base URL': 'http://localhost:11434/v1（Ollama）或:1234/v1（LM Studio）' },
          ],
    ...
    es: {
      ...
      sections: {
        ...
        lmStudio: {
          ...
          codeLanguage: 'python',
          rows: [
            { 'Plataforma': '[LM Studio](https://lmstudio.ai)', 'Puerto': 'localhost:1234', 'Ideal para': 'Usuarios GUI, gestión visual de modelos', 'GPU requerida': 'No (CPU funciona)' },
            { 'Plataforma': '[Ollama](https://ollama.com)', 'Puerto': 'localhost:11434', 'Ideal para': 'Scripts, automatización, producción', 'GPU requerida': 'No (CPU funciona)' },
            { 'Plataforma': '[vLLM](https://github.com/vllm-project/vllm)', 'Puerto': 'localhost:8000', 'Ideal para': 'Multi-GPU, servidores de alto rendimiento', 'GPU requerida': 'Recomendada' },
          ],
        ...
        aiCodingTools: {
          ...
          rows: [
            { 'Herramienta': '[Cline](https://cline.bot)', 'Ubicación de configuración': 'Ajustes de la extensión VS Code → API Provider → OpenAI Compatible', 'Base URL local': 'http://localhost:11434/v1 (Ollama) o :1234/v1 (LM Studio)' },
            { 'Herramienta': '[Roo Code](https://github.com/RooCodeInc/Roo-Code)', 'Ubicación de configuración': 'Ajustes de la extensión VS Code → API Provider (mismo patrón que Cline)', 'Base URL local': 'http://localhost:11434/v1 (Ollama) o :1234/v1 (LM Studio)' },
            { 'Herramienta': '[Aider](https://aider.chat)', 'Ubicación de configuración': 'Variables de entorno OPENAI_API_BASE / OPENAI_API_KEY u opciones CLI', 'Base URL local': 'http://localhost:11434/v1 (Ollama) o :1234/v1 (LM Studio)' },
          ],
    ...
    ar: {
      ...
      sections: {
        ...
        lmStudio: {
          ...
          codeLanguage: 'python',
          rows: [
            { 'Plataforma': '[LM Studio](https://lmstudio.ai)', 'Puerto': 'localhost:1234', 'Ideal para': 'مستخدمو الواجهة الرسومية، الإدارة البصرية للنماذج', 'GPU requerida': 'لا (يعمل على CPU)' },
            { 'Plataforma': '[Ollama](https://ollama.com)', 'Puerto': 'localhost:11434', 'Ideal para': 'النصوص البرمجية، الأتمتة، الإنتاج', 'GPU requerida': 'لا (يعمل على CPU)' },
            { 'Plataforma': '[vLLM](https://github.com/vllm-project/vllm)', 'Puerto': 'localhost:8000', 'Ideal para': 'تعدد وحدات GPU، خوادم عالية الأداء', 'GPU requerida': 'مُوصى بها' },
          ],
          columns: ['Plataforma', 'Puerto', 'Ideal para', 'GPU requerida'],
        },
        javascript: {
        ...
        aiCodingTools: {
          ...
          rows: [
            { 'الأداة': '[Cline](https://cline.bot)', 'موقع الإعداد': 'إعدادات إضافة VS Code ← API Provider ← OpenAI Compatible', 'Base URL المحلي': 'http://localhost:11434/v1 (Ollama) أو :1234/v1 (LM Studio)' },
            { 'الأداة': '[Roo Code](https://github.com/RooCodeInc/Roo-Code)', 'موقع الإعداد': 'إعدادات إضافة VS Code ← API Provider (النمط نفسه لـ Cline)', 'Base URL المحلي': 'http://localhost:11434/v1 (Ollama) أو :1234/v1 (LM Studio)' },
            { 'الأداة': '[Aider](https://aider.chat)', 'موقع الإعداد': 'متغيّرا البيئة OPENAI_API_BASE / OPENAI_API_KEY أو خيارات CLI', 'Base URL المحلي': 'http://localhost:11434/v1 (Ollama) أو :1234/v1 (LM Studio)' },
          ],
  ...
  ko: {
      ...
      sections: {
        ...
        lmStudio: {
          ...
          codeLanguage: 'python',
          rows: [
            { 'Platform': '[LM Studio](https://lmstudio.ai)', 'Port': 'localhost:1234', 'Best For': 'GUI 사용자, 시각적 모델 관리', 'GPU Required': '아니오 (CPU 가능)' },
            { 'Platform': '[Ollama](https://ollama.com)', 'Port': 'localhost:11434', 'Best For': '스크립팅, 자동화, 프로덕션', 'GPU Required': '아니오 (CPU 가능)' },
            { 'Platform': '[vLLM](https://github.com/vllm-project/vllm)', 'Port': 'localhost:8000', 'Best For': '다중 GPU, 고처리량 서버', 'GPU Required': '권장' },
          ],
          columns: ['Platform', 'Port', 'Best For', 'GPU Required'],
        },
        javascript: {
        ...
        aiCodingTools: {
          ...
          rows: [
            { 'Tool': '[Cline](https://cline.bot)', 'Config Location': 'VS Code 확장 설정 → API Provider → OpenAI Compatible', 'Local Base URL': 'http://localhost:11434/v1 (Ollama) 또는 :1234/v1 (LM Studio)' },
            { 'Tool': '[Roo Code](https://github.com/RooCodeInc/Roo-Code)', 'Config Location': 'VS Code 확장 설정 → API Provider (Cline과 동일한 패턴)', 'Local Base URL': 'http://localhost:11434/v1 (Ollama) 또는 :1234/v1 (LM Studio)' },
            { 'Tool': '[Aider](https://aider.chat)', 'Config Location': 'OPENAI_API_BASE / OPENAI_API_KEY 환경 변수 또는 CLI 플래그', 'Local Base URL': 'http://localhost:11434/v1 (Ollama) 또는 :1234/v1 (LM Studio)' },
          ],
          columns: ['Tool', 'Config Location', 'Local Base URL'],
        },
        regionalContext: {
