...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      seoTitle: 'Ollama OpenAI API 2026: 3-Step Integration Guide',
      ...
      metaDescription: 'Connect Python and Node.js to Ollama via OpenAI API in 3 steps. Change base_url, set api_key. Streaming and function calling work seamlessly.',
...
schema: {
    ...
    de: {
      ...
      seoTitle: 'OpenAI API mit Ollama 2026: Python in 3 Schritten',
      ...
      metaDescription: 'Verbinde Python und Node.js mit Ollama via OpenAI API in 3 Schritten. Ändere base_url, setze api_key. Streaming und Function Calling funktionieren.',
      publishDate: '2026-04-04',
      readTime: '10 min read',
      educationalLevel: 'Beginner to Advanced',
      primaryTerm: 'OpenAI-compatible API',
schema: {
 ...
 isTldr: true, items: ['**Bestes Reasoning im kleinen Format**: Phi-4 Mini 3.8B -- 68% MMLU, 70% HumanEval, läuft auf 4 GB RAM.', '**Schnellste auf CPU**: Gemma 2 2B -- 40-60 tok/sek auf jedem modernen Laptop, 1,7 GB RAM.', '**Bestes kleines Codierungsmodell**: Qwen2.5 3B -- 65% HumanEval bei ~2 GB RAM.', '**Beste Universal-3B**: Llama 3.2 3B -- beste Community-Unterstützung, 128K Kontext, 2,5 GB RAM.', 'Seit May 2026 produziert kein Sub-2B-Modell Ausgabequalität, die für professionelle Aufgaben geeignet ist. Verwenden Sie 3B+ für echte Arbeit.'] },
    ...
    fr: {
      ...
      seoTitle: 'Ollama OpenAI API 2026 : Intégration en 3 étapes',
      ...
      metaDescription: 'Connectez Python et Node.js à Ollama via l\'API compatible OpenAI en 3 étapes. Modifiez base_url, définissez api_key. Streaming et Function Calling inclus.',
      publishDate: '2026-04-04',
...
schema: {
    ...
    ja: {
      ...
      seoTitle: 'Ollama OpenAI互換API 2026：3ステップガイド',
      ...
      metaDescription: 'PythonとNode.jsをOllamaのOpenAI互換APIに接続。base_urlを変更、api_keyを設定、ストリーミングと関数呼び出しをサポート。',
      publishDate: '2026-04-04',
      dateModified: '2026-04-16',
      readTime: '10分で読める',
      educationalLevel: 'Beginner to Advanced',
...
schema: {
    ...
    zh: {
      ...
      seoTitle: 'Ollama OpenAI兼容API 2026：3步集成指南',
      ...
      metaDescription: '在3个步骤中将Python和Node.js连接到Ollama的OpenAI兼容API。更改base_url、设置api_key、支持流式输出和函数调用。',
      publishDate: '2026-04-04',
      dateModified: '2026-04-16',
      readTime: '阅读约10分钟',
      educationalLevel: 'Beginner to Advanced',
