...
schema: {
    ...
    es: {
      ...
      schema: {
        ...
        'url': 'https://www.promptquorum.com/es/es/local-llms/local-llm-openai-compatible-api',
        'datePublished': '2026-04-04',
        'dateModified': '2026-05-17',
        'author': { '@type': 'Person', 'name': 'Hans Kuepper' },
        'publisher': { '@type': 'Organization', 'name': 'PromptQuorum', 'url': 'https://www.promptquorum.com' },
    ...
    ar: {
      ...
      seoTitle: 'واجهة OpenAI المحلية مع Ollama وLM Studio — 2026',
      ...
      metaDescription: 'غيّر سطرين: base_url إلى localhost:11434 أو 1234. SDK الرسمي لـPython وNode.js يعمل مباشرةً مع دعم البث المتدفق واستدعاء الدوال دون تعديل إضافي.',
      publishDate: '2026-04-04',
