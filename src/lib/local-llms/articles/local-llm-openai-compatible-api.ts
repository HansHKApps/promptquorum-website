    ...
    de: {
      ...
      sections: {
        ...
        whatIsOpenAI: {
          ...
          content: [
            '**OpenAI-kompatibel bedeutet, dass der API-Endpoint Responses in gleichem Format wie OpenAI API zurückgibt.** Dies ermöglicht jeder Bibliothek oder jedem Tool, das für OpenAI gebaut wurde, mit lokalen Modellen zu arbeiten, indem nur auf andere URL gezeigt wird. Erfahren Sie, wie [Ollama vs LM Studio](/local-llms/ollama-vs-lm-studio?lang=de) diese Standard-Implementierung vergleichen.',
