...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      metaDescription: 'Fine-tune Llama 3.1 8B on 8 GB VRAM in 1–2 hours using Unsloth (4× faster, QLoRA). 500 training examples minimum. Full code + LoRA vs RAG decision guide.',
...
schema: {
    ...
    es: {
      freshness_tier: 'annual',
      theme: 'Advanced Techniques',
      title: 'Fine-Tuning LoRA para LLMs Locales 2026: Tutorial de Unsloth en 8 GB de VRAM con Llama 3.1',
      ...
      metaDescription: 'Haz fine-tuning de Llama 3.1 8B con LoRA en 8 GB de VRAM en 1–2 horas con Unsloth (4× más rápido, QLoRA). Mínimo 500 ejemplos. Código y guía LoRA vs RAG.',
      publishDate: '2026-04-04',
      ...
      schema: {
        ...
        'about': [
          ...
          { '@type': 'Thing', 'name': 'Fine-tune de Llama 3.1' },
          { '@type': 'Thing', 'name': 'LoRA vs RAG' },
        ],
