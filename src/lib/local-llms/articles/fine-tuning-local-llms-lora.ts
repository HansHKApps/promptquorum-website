...
schema: {
    ...
    ar: {
      ...
      seoTitle: 'الضبط الدقيق بـ LoRA لنماذج LLM المحلية 2026: Unsloth على 8 GB',
      ...
      metaDescription: 'اضبط Llama 3.3 8B بدقة بـ LoRA على 8 GB من VRAM في 1–2 ساعة مع Unsloth (أسرع بـ 4×، QLoRA). 500 مثال كحد أدنى. كود ودليل LoRA مقابل RAG.',
      publishDate: '2026-04-04',
