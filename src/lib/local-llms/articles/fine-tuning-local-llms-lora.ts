      ...
      sections: {
        ...
        sources: {
          ...
          items: [
            ...
            'Unsloth. (2026). "Train LLMs up to 2× faster with 70% less VRAM (Unsloth)." https://github.com/unslothai/unsloth — Schnellstes LoRA-Framework, unterstützt Llama 3.x, Qwen3, Mistral mit bis zu 2× Trainings-Speedup.',
      ...
      sections: {
        ...
        sources: {
          ...
          items: [
            ...
            'Unsloth. (2026). "Train LLMs up to 2× faster with 70% less VRAM (Unsloth)." https://github.com/unslothai/unsloth — Framework LoRA le plus rapide, supporte Llama 3.x, Qwen3, Mistral avec jusqu\'à 2× speedup.',
      ...
      sections: {
        ...
        sources: {
          ...
          items: [
            ...
            'Unsloth. (2026). "Train LLMs up to 2× faster with 70% less VRAM (Unsloth)." https://github.com/unslothai/unsloth — 가장 빠른 LoRA 프레임워크, Llama 3.x, Qwen3, Mistral을 최대 2배 학습 가속으로 지원.',
