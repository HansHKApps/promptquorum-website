...
schema: {
    ...
    es: {
      ...
      seoTitle: 'Fine-Tuning LoRA para LLMs Locales 2026: Unsloth en 8 GB VRAM',
      ...
      metaDescription: 'Haz fine-tuning de Llama 3.1 8B con LoRA en 8 GB de VRAM en 1–2 horas usando Unsloth (4× más rápido, QLoRA). Mínimo 500 ejemplos de entrenamiento. Código completo + guía para decidir entre LoRA y RAG.',
      publishDate: '2026-04-04',
