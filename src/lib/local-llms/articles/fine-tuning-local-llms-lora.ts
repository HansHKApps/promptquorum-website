...
schema: {
    ...
    ar: {
      ...
      metaDescription: 'اضبط Llama 3.3 8B بدقة على 8 GB VRAM خلال 1–2 ساعة باستخدام Unsloth (أسرع بـ 2× وفق unsloth.ai) عبر QLoRA. يكفي 500 مثال تدريبي. كود كامل ومقارنة LoRA مقابل RAG.',
      publishDate: '2026-04-04',
