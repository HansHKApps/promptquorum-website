...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    seoTitle: '70B Models on M5 Max 128GB: 12–20 tok/s, Matches GPT-4o Quality',
    ...
    metaDescription: 'M5 Max 128GB runs 70B models at 12–20 tok/s. Q5 quality matches GPT-4o within 3%. Complete setup with Ollama/MLX, quantization guide, benchmarks.',
    ...
    quickAnswerTop: {
      ...
      ja: {
        ...
        answer: 'はい。Llama 3.1 70B Q5_K_Mは12–16 tok/sで動作します。Q4_K_Mで15–20 tok/s。Q8_0で8–12 tok/s（ロスレス）。すべて128GBの統一メモリに適合します。Ollamaでのセットアップは10分で完了。70B Q5は標準ベンチマークでGPT-4oの3%以内の品質です。',
        bullets: [
          ...
          'MMLU: 70B Q5 = 86.1 vs GPT-4o = 88.7（3%ギャップ）',
      ...
      zh: {
        ...
        answer: '可以。Llama 3.1 70B Q5_K_M以12–16 tok/s运行。Q4_K_M以15–20 tok/s运行。Q8_0以8–12 tok/s运行（无损）。所有这些都适合128GB统一内存。使用Ollama的设置耗时10分钟。70B Q5在标准基准上的质量在GPT-4o的3%范围内。',
        bullets: [
          '70B Q4_K_M：42 GB、15–20 tok/s、质量良好',
          '70B Q5_K_M：49 GB、12–16 tok/s、非常好（推荐）',
          '70B Q8_0：74 GB、8–12 tok/s、无损',
          '唯一无需复杂多GPU的消费级选项',
          'MMLU：70B Q5 = 86.1 vs GPT-4o = 88.7（3%差距）',
    ...
    print(chunk, end="", flush=True)`,
      ...
      relatedArticles: {
        ...
        items: [
          ...
          '[Apple Silicon vs NVIDIA GPU für lokale LLMs](/power-local-llm/apple-mlx-vs-nvidia-cuda-local-llm-2026?lang=de) — plattformübergreifender Hardware-Vergleich',
    ...
    sections: {
      ...
      relatedArticles: {
        ...
        items: [
          ...
          '[Apple Silicon vs GPU NVIDIA pour LLMs locaux](/power-local-llm/apple-mlx-vs-nvidia-cuda-local-llm-2026?lang=fr) — Comparaison matériel cross-platform',
    ...
    print(chunk, end="", flush=True)`,
      ...
      relatedArticles: {
        ...
        items: [
          ...
          '[Apple Silicon対NVIDIA GPUでローカルLLM](/power-local-llm/apple-mlx-vs-nvidia-cuda-local-llm-2026?lang=ja) — クロスプラットフォームハードウェア比較',
    ...
    print(chunk, end="", flush=True)`,
      ...
      relatedArticles: {
        ...
        items: [
          ...
          '[Apple Silicon对英伟达GPU本地LLM](/power-local-llm/apple-mlx-vs-nvidia-cuda-local-llm-2026?lang=zh) — 跨平台硬件对比',
