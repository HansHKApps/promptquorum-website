...
ollama pull mixtral:8x22b`,
      ...
      vsCloud: {
        ...
        tableFormat: true,
        columns: ['Métrica', '70B Q5 local (M5 Max)', 'GPT-5.5 API', 'Claude Sonnet 3.5', 'Gemini 3.5 Pro'],
        rows: [
          { 'Métrica': 'Calidad (MMLU)', '70B Q5 local (M5 Max)': '86.1', 'GPT-5.5 API': '88.7', 'Claude Sonnet 3.5': '88.7', 'Gemini 3.5 Pro': '85.9' },
          { 'Métrica': 'Velocidad (tok/s)', '70B Q5 local (M5 Max)': '12–16', 'GPT-5.5 API': '50–80', 'Claude Sonnet 3.5': '50–80', 'Gemini 3.5 Pro': '60–100' },
          { 'Métrica': 'Latencia primer token', '70B Q5 local (M5 Max)': '1–2 seg', 'GPT-5.5 API': '0.3–0.8 seg', 'Claude Sonnet 3.5': '0.4–0.9 seg', 'Gemini 3.5 Pro': '0.5–1 seg' },
          { 'Métrica': 'Costo por 1M tokens', '70B Q5 local (M5 Max)': '$0', 'GPT-5.5 API': '$2.50/$10.00', 'Claude Sonnet 3.5': '$3.00/$15.00', 'Gemini 3.5 Pro': '$1.25/$5.00' },
          { 'Métrica': 'Costo/mes (5M tokens)', '70B Q5 local (M5 Max)': '$0', 'GPT-5.5 API': '$50–150', 'Claude Sonnet 3.5': '$75–200', 'Gemini 3.5 Pro': '$30–80' },
          { 'Métrica': 'Privacidad', '70B Q5 local (M5 Max)': '100% local', 'GPT-5.5 API': 'Enviado a OpenAI', 'Claude Sonnet 3.5': 'Enviado a Anthropic', 'Gemini 3.5 Pro': 'Enviado a Google' },
          { 'Métrica': 'Requiere internet', '70B Q5 local (M5 Max)': 'No', 'GPT-5.5 API': 'Sí', 'Claude Sonnet 3.5': 'Sí', 'Gemini 3.5 Pro': 'Sí' },
          { 'Métrica': 'Límites de uso', '70B Q5 local (M5 Max)': 'Ninguno', 'GPT-5.5 API': 'Por nivel', 'Claude Sonnet 3.5': 'Por nivel', 'Gemini 3.5 Pro': 'Por nivel' },
          { 'Métrica': 'Personalización', '70B Q5 local (M5 Max)': 'Total (fine-tuning local)', 'GPT-5.5 API': 'Limitada', 'Claude Sonnet 3.5': 'Limitada', 'Gemini 3.5 Pro': 'Limitada' },
        ],
...
ollama pull mixtral:8x22b`,
      ...
      vsCloud: {
        ...
        columns: ['Métrica', '70B Q5 local (M5 Max)', 'GPT-5.5 API', 'Claude Sonnet 3.5', 'Gemini 3.5 Pro'],
        rows: [
          { 'Métrica': 'الجودة (MMLU)', '70B Q5 local (M5 Max)': '86.1', 'GPT-5.5 API': '88.7', 'Claude Sonnet 3.5': '88.7', 'Gemini 3.5 Pro': '85.9' },
          { 'Métrica': 'السرعة (token/ث)', '70B Q5 local (M5 Max)': '12–16', 'GPT-5.5 API': '50–80', 'Claude Sonnet 3.5': '50–80', 'Gemini 3.5 Pro': '60–100' },
          { 'Métrica': 'كمون أول token', '70B Q5 local (M5 Max)': '1–2 ثانية', 'GPT-5.5 API': '0.3–0.8 ثانية', 'Claude Sonnet 3.5': '0.4–0.9 ثانية', 'Gemini 3.5 Pro': '0.5–1 ثانية' },
          { 'Métrica': 'التكلفة لكل 1M token', '70B Q5 local (M5 Max)': '$0', 'GPT-5.5 API': '$2.50/$10.00', 'Claude Sonnet 3.5': '$3.00/$15.00', 'Gemini 3.5 Pro': '$1.25/$5.00' },
          { 'Métrica': 'التكلفة/شهر (5M token)', '70B Q5 local (M5 Max)': '$0', 'GPT-5.5 API': '$50–150', 'Claude Sonnet 3.5': '$75–200', 'Gemini 3.5 Pro': '$30–80' },
          { 'Métrica': 'الخصوصية', '70B Q5 local (M5 Max)': '100% محلي', 'GPT-5.5 API': 'يُرسَل إلى OpenAI', 'Claude Sonnet 3.5': 'يُرسَل إلى Anthropic', 'Gemini 3.5 Pro': 'يُرسَل إلى Google' },
          { 'Métrica': 'يتطلب إنترنت', '70B Q5 local (M5 Max)': 'لا', 'GPT-5.5 API': 'نعم', 'Claude Sonnet 3.5': 'نعم', 'Gemini 3.5 Pro': 'نعم' },
          { 'Métrica': 'حدود الاستخدام', '70B Q5 local (M5 Max)': 'لا شيء', 'GPT-5.5 API': 'حسب المستوى', 'Claude Sonnet 3.5': 'حسب المستوى', 'Gemini 3.5 Pro': 'حسب المستوى' },
          { 'Métrica': 'التخصيص', '70B Q5 local (M5 Max)': 'كامل (fine-tuning محلي)', 'GPT-5.5 API': 'محدود', 'Claude Sonnet 3.5': 'محدود', 'Gemini 3.5 Pro': 'محدود' },
        ],
...
ollama pull mixtral:8x22b`,
      ...
      vsCloud: {
        ...
        tableFormat: true,
        columns: ['Kennzahl', '70B Q5 Lokal (M5 Max)', 'GPT-5.5 API', 'Claude Sonnet 3.5', 'Gemini 3.5 Pro'],
        rows: [
          { 'Kennzahl': 'Qualität (MMLU)', '70B Q5 Lokal (M5 Max)': '86,1', 'GPT-5.5 API': '88,7', 'Claude Sonnet 3.5': '88,7', 'Gemini 3.5 Pro': '85,9' },
          { 'Kennzahl': 'Geschwindigkeit (tok/s)', '70B Q5 Lokal (M5 Max)': '12–16', 'GPT-5.5 API': '50–80', 'Claude Sonnet 3.5': '50–80', 'Gemini 3.5 Pro': '60–100' },
          { 'Kennzahl': 'Erstes Token (Latenz)', '70B Q5 Lokal (M5 Max)': '1–2 Sek.', 'GPT-5.5 API': '0,3–0,8 Sek.', 'Claude Sonnet 3.5': '0,4–0,9 Sek.', 'Gemini 3.5 Pro': '0,5–1 Sek.' },
          { 'Kennzahl': 'Kosten pro 1M Token', '70B Q5 Lokal (M5 Max)': '0 €', 'GPT-5.5 API': '2,50 $/10,00 $', 'Claude Sonnet 3.5': '3,00 $/15,00 $', 'Gemini 3.5 Pro': '1,25 $/5,00 $' },
          { 'Kennzahl': 'Kosten/Monat (5M Token)', '70B Q5 Lokal (M5 Max)': '0 €', 'GPT-5.5 API': '50–150 $', 'Claude Sonnet 3.5': '75–200 $', 'Gemini 3.5 Pro': '30–80 $' },
          { 'Kennzahl': 'Datenschutz', '70B Q5 Lokal (M5 Max)': '100 % lokal', 'GPT-5.5 API': 'Gesendet an OpenAI', 'Claude Sonnet 3.5': 'Gesendet an Anthropic', 'Gemini 3.5 Pro': 'Gesendet an Google' },
          { 'Kennzahl': 'Internet erforderlich', '70B Q5 Lokal (M5 Max)': 'Nein', 'GPT-5.5 API': 'Ja', 'Claude Sonnet 3.5': 'Ja', 'Gemini 3.5 Pro': 'Ja' },
          { 'Kennzahl': 'Ratenlimits', '70B Q5 Lokal (M5 Max)': 'Keine', 'GPT-5.5 API': 'Stufenbasiert', 'Claude Sonnet 3.5': 'Stufenbasiert', 'Gemini 3.5 Pro': 'Stufenbasiert' },
          { 'Kennzahl': 'Anpassbarkeit', '70B Q5 Lokal (M5 Max)': 'Vollständig (lokal fine-tunen)', 'GPT-5.5 API': 'Begrenzt', 'Claude Sonnet 3.5': 'Begrenzt', 'Gemini 3.5 Pro': 'Begrenzt' },
        ],
...
ollama pull mixtral:8x22b`,
      ...
      vsCloud: {
        ...
        tableFormat: true,
        columns: ['指標', '70B Q5ローカル（M5 Max）', 'GPT-5.5 API', 'Claude Sonnet 3.5', 'Gemini 3.5 Pro'],
        rows: [
          { '指標': '品質（MMLU）', '70B Q5ローカル（M5 Max）': '86.1', 'GPT-5.5 API': '88.7', 'Claude Sonnet 3.5': '88.7', 'Gemini 3.5 Pro': '85.9' },
          { '指標': '速度（tok/s）', '70B Q5ローカル（M5 Max）': '12〜16', 'GPT-5.5 API': '50〜80', 'Claude Sonnet 3.5': '50〜80', 'Gemini 3.5 Pro': '60〜100' },
          { '指標': '最初のトークン遅延', '70B Q5ローカル（M5 Max）': '1〜2秒', 'GPT-5.5 API': '0.3〜0.8秒', 'Claude Sonnet 3.5': '0.4〜0.9秒', 'Gemini 3.5 Pro': '0.5〜1秒' },
          { '指標': '1Mトークンあたりのコスト', '70B Q5ローカル（M5 Max）': '$0', 'GPT-5.5 API': '$2.50/$10.00', 'Claude Sonnet 3.5': '$3.00/$15.00', 'Gemini 3.5 Pro': '$1.25/$5.00' },
          { '指標': 'コスト/月（5Mトークン）', '70B Q5ローカル（M5 Max）': '$0', 'GPT-5.5 API': '$50〜150', 'Claude Sonnet 3.5': '$75〜200', 'Gemini 3.5 Pro': '$30〜80' },
          { '指標': 'プライバシー', '70B Q5ローカル（M5 Max）': '100%ローカル', 'GPT-5.5 API': 'OpenAIに送信', 'Claude Sonnet 3.5': 'Anthropicに送信', 'Gemini 3.5 Pro': 'Googleに送信' },
          { '指標': 'インターネット必須', '70B Q5ローカル（M5 Max）': 'いいえ', 'GPT-5.5 API': 'はい', 'Claude Sonnet 3.5': 'はい', 'Gemini 3.5 Pro': 'はい' },
          { '指標': 'レート制限', '70B Q5ローカル（M5 Max）': 'なし', 'GPT-5.5 API': 'ティアベース', 'Claude Sonnet 3.5': 'ティアベース', 'Gemini 3.5 Pro': 'ティアベース' },
          { '指標': 'カスタマイズ', '70B Q5ローカル（M5 Max）': '完全（ローカルファインチューニング）', 'GPT-5.5 API': '限定的', 'Claude Sonnet 3.5': '限定的', 'Gemini 3.5 Pro': '限定的' },
        ],
...
ollama pull mixtral:8x22b`,
      ...
      vsCloud: {
        ...
        tableFormat: true,
        columns: ['指标', '70B Q5本地（M5 Max）', 'GPT-5.5 API', 'Claude Sonnet 3.5', 'Gemini 3.5 Pro'],
        rows: [
          { '指标': '质量（MMLU）', '70B Q5本地（M5 Max）': '86.1', 'GPT-5.5 API': '88.7', 'Claude Sonnet 3.5': '88.7', 'Gemini 3.5 Pro': '85.9' },
          { '指标': '速度（tok/s）', '70B Q5本地（M5 Max）': '12–16', 'GPT-5.5 API': '50–80', 'Claude Sonnet 3.5': '50–80', 'Gemini 3.5 Pro': '60–100' },
          { '指标': '首个token延迟', '70B Q5本地（M5 Max）': '1–2秒', 'GPT-5.5 API': '0.3–0.8秒', 'Claude Sonnet 3.5': '0.4–0.9秒', 'Gemini 3.5 Pro': '0.5–1秒' },
          { '指标': '每百万token费用', '70B Q5本地（M5 Max）': '$0', 'GPT-5.5 API': '$2.50/$10.00', 'Claude Sonnet 3.5': '$3.00/$15.00', 'Gemini 3.5 Pro': '$1.25/$5.00' },
          { '指标': '月费（500万token）', '70B Q5本地（M5 Max）': '$0', 'GPT-5.5 API': '$50–150', 'Claude Sonnet 3.5': '$75–200', 'Gemini 3.5 Pro': '$30–80' },
          { '指标': '隐私保护', '70B Q5本地（M5 Max）': '100%本地', 'GPT-5.5 API': '发送至OpenAI', 'Claude Sonnet 3.5': '发送至Anthropic', 'Gemini 3.5 Pro': '发送至Google' },
          { '指标': '需要互联网', '70B Q5本地（M5 Max）': '否', 'GPT-5.5 API': '是', 'Claude Sonnet 3.5': '是', 'Gemini 3.5 Pro': '是' },
          { '指标': '速率限制', '70B Q5本地（M5 Max）': '无', 'GPT-5.5 API': '分级限制', 'Claude Sonnet 3.5': '分级限制', 'Gemini 3.5 Pro': '分级限制' },
          { '指标': '可定制性', '70B Q5本地（M5 Max）': '完全（本地微调）', 'GPT-5.5 API': '有限', 'Claude Sonnet 3.5': '有限', 'Gemini 3.5 Pro': '有限' },
        ],
...
ollama pull mixtral:8x22b`,
      ...
      vsCloud: {
        ...
        tableFormat: true,
        columns: ['지표', '70B Q5 로컬 (M5 Max)', 'GPT-5.5 API', 'Claude Sonnet 3.5', 'Gemini 3.5 Pro'],
        rows: [
          { '지표': '품질 (MMLU)', '70B Q5 로컬 (M5 Max)': '86.1', 'GPT-5.5 API': '88.7', 'Claude Sonnet 3.5': '88.7', 'Gemini 3.5 Pro': '85.9' },
          { '지표': '속도 (tok/s)', '70B Q5 로컬 (M5 Max)': '12–16', 'GPT-5.5 API': '50–80', 'Claude Sonnet 3.5': '50–80', 'Gemini 3.5 Pro': '60–100' },
          { '지표': '첫 토큰 지연', '70B Q5 로컬 (M5 Max)': '1–2초', 'GPT-5.5 API': '0.3–0.8초', 'Claude Sonnet 3.5': '0.4–0.9초', 'Gemini 3.5 Pro': '0.5–1초' },
          { '지표': '1M 토큰당 비용', '70B Q5 로컬 (M5 Max)': '$0', 'GPT-5.5 API': '$2.50/$10.00', 'Claude Sonnet 3.5': '$3.00/$15.00', 'Gemini 3.5 Pro': '$1.25/$5.00' },
          { '지표': '월 비용 (5M 토큰)', '70B Q5 로컬 (M5 Max)': '$0', 'GPT-5.5 API': '$50–150', 'Claude Sonnet 3.5': '$75–200', 'Gemini 3.5 Pro': '$30–80' },
          { '지표': '개인정보 보호', '70B Q5 로컬 (M5 Max)': '100% 로컬', 'GPT-5.5 API': 'OpenAI로 전송', 'Claude Sonnet 3.5': 'Anthropic으로 전송', 'Gemini 3.5 Pro': 'Google로 전송' },
          { '지표': '인터넷 필요', '70B Q5 로컬 (M5 Max)': '아니오', 'GPT-5.5 API': '예', 'Claude Sonnet 3.5': '예', 'Gemini 3.5 Pro': '예' },
          { '지표': '속도 제한', '70B Q5 로컬 (M5 Max)': '없음', 'GPT-5.5 API': '티어 기반', 'Claude Sonnet 3.5': '티어 기반', 'Gemini 3.5 Pro': '티어 기반' },
          { '지표': '커스터마이제이션', '70B Q5 로컬 (M5 Max)': '완전 지원 (로컬 파인튜닝)', 'GPT-5.5 API': '제한됨', 'Claude Sonnet 3.5': '제한됨', 'Gemini 3.5 Pro': '제한됨' },
        ],
