...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    heroImage: '/images/running-70b-models-apple-silicon-m5-max-hardware-comparison-hero-en.png',
    ...
    sections: {
      ...
      hardware: {
        ...
        image: '/images/running-70b-models-apple-silicon-m5-max-hardware-comparison-hero-en.png',
...
def detect_recursion(threshold=900):
    ...
    return decorator`,
      ...
      quantization: {
        ...
        image: '/images/running-70b-models-apple-silicon-m5-max-quantization-tradeoffs-hero-en.png',
...
for chunk in stream_generate(model, tokenizer, "Explain quantum computing", max_tokens=500):
  ...
  es: {
    ...
    heroImage: '/images/running-70b-models-apple-silicon-m5-max-hardware-comparison-hero-es.png',
    ...
    sections: {
      ...
      hardware: {
        ...
        image: '/images/running-70b-models-apple-silicon-m5-max-hardware-comparison-hero-es.png',
...
def detect_recursion(threshold=900):
    ...
    return decorator`,
      ...
      quantization: {
        ...
        image: '/images/running-70b-models-apple-silicon-m5-max-quantization-tradeoffs-hero-es.png',
...
for chunk in stream_generate(model, tokenizer, "Explica la computación cuántica", max_tokens=500):
  ...
  ar: {
    ...
    heroImage: '/images/running-70b-models-apple-silicon-m5-max-hardware-comparison-hero-ar.png',
    ...
    sections: {
      ...
      hardware: {
        ...
        image: '/images/running-70b-models-apple-silicon-m5-max-hardware-comparison-hero-ar.png',
...
def detect_recursion(threshold=900):
    ...
    return decorator`,
      ...
      quantization: {
        ...
        image: '/images/running-70b-models-apple-silicon-m5-max-quantization-tradeoffs-hero-ar.png',
...
for chunk in stream_generate(model, tokenizer, "Explica la computación cuántica", max_tokens=500):
  ...
  pt: {
    ...
    heroImage: '/images/running-70b-models-apple-silicon-m5-max-hardware-comparison-hero-pt.png',
    publishDate: '2026-05-15',
  ...
  de: {
    ...
    heroImage: '/images/running-70b-models-apple-silicon-m5-max-hardware-comparison-hero-de.png',
    ...
    sections: {
      ...
      hardware: {
        ...
        image: '/images/running-70b-models-apple-silicon-m5-max-hardware-comparison-hero-de.png',
...
def detect_recursion(threshold=900):
    ...
    return decorator`,
      ...
      quantization: {
        ...
        image: '/images/running-70b-models-apple-silicon-m5-max-quantization-tradeoffs-hero-de.png',
...
for chunk in stream_generate(model, tokenizer, "Erkläre Quantencomputing", max_tokens=500):
  ...
  fr: {
    ...
    heroImage: '/images/running-70b-models-apple-silicon-m5-max-hardware-comparison-hero-fr.png',
    ...
    sections: {
      ...
      hardware: {
        ...
        image: '/images/running-70b-models-apple-silicon-m5-max-hardware-comparison-hero-fr.png',
      ...
      quantization: {
        ...
        image: '/images/running-70b-models-apple-silicon-m5-max-quantization-tradeoffs-hero-fr.png',
  ...
  ja: {
    ...
    heroImage: '/images/running-70b-models-apple-silicon-m5-max-hardware-comparison-hero-ja.png',
    ...
    sections: {
      ...
      hardware: {
        ...
        image: '/images/running-70b-models-apple-silicon-m5-max-hardware-comparison-hero-ja.png',
...
def detect_recursion(threshold=900):
    ...
    return decorator`,
      ...
      quantization: {
        ...
        image: '/images/running-70b-models-apple-silicon-m5-max-quantization-tradeoffs-hero-ja.png',
...
for chunk in stream_generate(model, tokenizer, "量子コンピューティングを説明してください", max_tokens=500):
  ...
  zh: {
    ...
    heroImage: '/images/running-70b-models-apple-silicon-m5-max-hardware-comparison-hero-zh.png',
    ...
    sections: {
      ...
      hardware: {
        ...
        image: '/images/running-70b-models-apple-silicon-m5-max-hardware-comparison-hero-zh.png',
...
def detect_recursion(threshold=900):
    ...
    return decorator`,
      ...
      quantization: {
        ...
        image: '/images/running-70b-models-apple-silicon-m5-max-quantization-tradeoffs-hero-zh.png',
...
for chunk in stream_generate(model, tokenizer, "解释量子计算", max_tokens=500):
  ...
  ko: {
    ...
    heroImage: '/images/running-70b-models-apple-silicon-m5-max-hardware-comparison-hero-ko.png',
    ...
    sections: {
      ...
      hardware: {
        ...
        image: '/images/running-70b-models-apple-silicon-m5-max-hardware-comparison-hero-ko.png',
...
def detect_recursion(threshold=900):
    ...
    return decorator`,
      ...
      quantization: {
        ...
        image: '/images/running-70b-models-apple-silicon-m5-max-quantization-tradeoffs-hero-ko.png',
