...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    seoTitle: 'Running 70B Models on M5 Max: Setup, Quantization, Quality',
    ...
    metaDescription: 'Run 70B LLMs on M5 Max 128GB: setup guide, Q4/Q5/Q8 quantization, 12–20 tok/s, quality vs GPT-4o, cost comparison. Full 2026 guide.',
...
for chunk in stream_generate(model, tokenizer, "Explain quantum computing", max_tokens=500):
  ...
  de: {
    ...
    seoTitle: '70B-Modelle auf M5 Max: Setup, Quantisierung, Qualität',
    ...
    metaDescription: '70B LLMs auf M5 Max 128 GB: Setup-Anleitung, Q4/Q5/Q8-Quantisierung, 12–20 tok/s, Qualität vs GPT-4o, Kostenvergleich. Vollständiger Leitfaden.',
...
for chunk in stream_generate(model, tokenizer, "Erkläre Quantencomputing", max_tokens=500):
  ...
  ja: {
    ...
    seoTitle: 'Apple Silicon M5 Max：70B モデル実行',
    ...
    metaDescription: 'M5 Max 128GBで70B LLM実行：完全セットアップ、Q4/Q5/Q8量子化、12～20 tok/s、GPT-4o品質比較、コスト分析。モデル選択、性能最適化、実装ガイド。',
...
for chunk in stream_generate(model, tokenizer, "量子コンピューティングを説明してください", max_tokens=500):
  ...
  zh: {
    ...
    seoTitle: 'Apple Silicon M5 Max：运行70B模型',
    ...
    metaDescription: 'M5 Max 128GB运行70B LLM：完整配置、Q4/Q5/Q8量化、12～20 tok/s、GPT-4o质量对比、成本分析。模型选择、性能优化、实现指南。',
