...
def detect_recursion(threshold=900):
    ...
    return decorator`,
      ...
      alternatives: {
        ...
        note: 'Recommendations by use case: General reasoning → Llama 3.3 70B Q5. Code → DeepSeek 67B. Non-English → Qwen3 72B. Document Q&A → Command R+. Maximum speed → Mixtral 8x22B (MoE uses fewer active params).',
      },
      alternativesPull: {
