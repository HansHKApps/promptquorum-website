    ...
    sections: {
      ...
      byUsecase: {
        ...
        rows: [
          ...
          { 'Use Case': 'RAG / Q&A', 'Best for 36GB Mac': 'Llama 3.3 8B + nomic-embed', 'Best for 64GB Mac': '[Llama 3.3 8B](/power-local-llm/local-rag-for-private-business-data) + bge-large', 'Best for 128GB Mac': 'Llama 3.3 70B + bge-large' },
    ...
    sections: {
      ...
      byUsecase: {
        ...
        rows: [
          ...
          { 'Caso de uso': 'RAG / preguntas y respuestas', 'Mejor para Mac 36 GB': 'Llama 3.3 8B + nomic-embed', 'Mejor para Mac 64 GB': '[Llama 3.3 8B](/es/power-local-llm/local-rag-for-private-business-data) + bge-large', 'Mejor para Mac 128 GB': 'Llama 3.3 70B + bge-large' },
...
ollama pull aya-expanse:32b         # traducción`,
  ...
  ar: {
    ...
    metaDescription: 'أفضل نماذج ⁨Ollama⁩ لـ ⁨Apple Silicon⁩: ⁨Phi-4⁩ للـ ⁨16 GB⁩، ⁨Llama 3.3 8B Q8⁩ للـ ⁨36 GB⁩ بـ ⁨38 tok/s⁩، ⁨Qwen3 34B Q5⁩ للـ ⁨64 GB⁩ بـ ⁨18 tok/s⁩، ⁨Llama 3.3 70B Q5⁩ للـ ⁨128 GB⁩. عبر ⁨Ollama⁩ على ⁨Metal⁩.',
    ...
    sections: {
      ...
      byUsecase: {
        ...
        rows: [
          ...
          { 'حالة الاستخدام': 'RAG / الأسئلة والأجوبة', 'الأفضل لـ Mac 36 GB': 'Llama 3.3 8B + nomic-embed', 'الأفضل لـ Mac 64 GB': '[Llama 3.3 8B](/ar/power-local-llm/local-rag-for-private-business-data) + bge-large', 'الأفضل لـ Mac 128 GB': 'Llama 3.3 70B + bge-large' },
    ...
    sections: {
      ...
      byUsecase: {
        ...
        rows: [
          ...
          { 'Caso de uso': 'RAG / perguntas e respostas', 'Melhor para Mac 36 GB': 'Llama 3.3 8B + nomic-embed', 'Melhor para Mac 64 GB': '[Llama 3.3 8B](/pt/power-local-llm/local-rag-for-private-business-data) + bge-large', 'Melhor para Mac 128 GB': 'Llama 3.3 70B + bge-large' },
    ...
    sections: {
      ...
      byUsecase: {
        ...
        rows: [
          ...
          { 'Anwendungsfall': 'RAG / Frage & Antwort', 'Bestes für 36-GB-Mac': 'Llama 3.3 8B + nomic-embed', 'Bestes für 64-GB-Mac': '[Llama 3.3 8B](/de/power-local-llm/local-rag-for-private-business-data) + bge-large', 'Bestes für 128-GB-Mac': 'Llama 3.3 70B + bge-large' },
    ...
    sections: {
      ...
      byUsecase: {
        ...
        rows: [
          ...
          { 'Cas d\'usage': 'RAG / Q&R', 'Meilleur pour Mac 36 Go': 'Llama 3.3 8B + nomic-embed', 'Meilleur pour Mac 64 Go': '[Llama 3.3 8B](/fr/power-local-llm/local-rag-for-private-business-data) + bge-large', 'Meilleur pour Mac 128 Go': 'Llama 3.3 70B + bge-large' },
...
ollama pull aya-expanse:32b         # traduction`,
      ...
      faq: {
        ...
        faqs: [
          ...
          { q: 'Que peut exécuter un MacBook Air M5 ?', a: 'Le MacBook Air M5 est proposé sans ventilateur et dispose généralement de 16 à 32 Go de mémoire unifiée : le considérer comme un Mac de niveau 16 Go ou 36 Go selon le tableau ci-dessus — Phi-4 sans difficulté, Llama 3.3 8B Q8 à partir de 24 Go. Des générations longues et soutenues peuvent légèrement throttler sans ventilateur — s\'attendre à la fourchette basse des tok/s M5 Pro indiqués dans cet article.' },
    ...
    sections: {
      ...
      byUsecase: {
        ...
        rows: [
          ...
          { 'ユースケース': 'RAG / Q&A', '36GB Mac向けベスト': 'Llama 3.3 8B + nomic-embed', '64GB Mac向けベスト': '[Llama 3.3 8B](/ja/power-local-llm/local-rag-for-private-business-data) + bge-large', '128GB Mac向けベスト': 'Llama 3.3 70B + bge-large' },
...
ollama pull aya-expanse:32b         # 翻訳`,
      ...
      faq: {
        ...
        faqs: [
          ...
          { q: 'MacBook Air M5では何が実行できますか？', a: 'MacBook Air M5はファンレス設計で、ユニファイドメモリは通常16〜32GB — 上記の表では16GBまたは36GBティアのMacとして扱ってください：Phi-4は快適に動作し、24GB以上あればLlama 3.3 8B Q8も可能です。ファンがないため、長時間の連続生成ではわずかにスロットリングする可能性があります — この記事のM5 Pro tok/s範囲の下限を目安にしてください。' },
    ...
    sections: {
      ...
      byUsecase: {
        ...
        rows: [
          ...
          { '用例': 'RAG/问答', '36GB Mac最佳': 'Llama 3.3 8B + nomic-embed', '64GB Mac最佳': '[Llama 3.3 8B](/zh/power-local-llm/local-rag-for-private-business-data) + bge-large', '128GB Mac最佳': 'Llama 3.3 70B + bge-large' },
...
ollama pull aya-expanse:32b         # 翻译`,
      ...
      faq: {
        ...
        faqs: [
          ...
          { q: 'MacBook Air M5能运行什么模型？', a: 'MacBook Air M5采用无风扇设计，统一内存通常为16–32 GB，因此可将其视为上表中的16GB或36GB档位Mac：Phi-4可轻松运行，若配置24GB以上则可运行Llama 3.3 8B Q8。由于没有风扇散热，长时间持续生成可能会略微降频——预计性能处于本文M5 Pro tok/s区间的下限。' },
    ...
    sections: {
      ...
      byUsecase: {
        ...
        rows: [
          ...
          { '사용 사례': 'RAG / Q&A', '36GB Mac 최적': 'Llama 3.3 8B + nomic-embed', '64GB Mac 최적': '[Llama 3.3 8B](/power-local-llm/local-rag-for-private-business-data) + bge-large', '128GB Mac 최적': 'Llama 3.3 70B + bge-large' },
...
ollama pull aya-expanse:32b         # 번역`,
      ...
      faq: {
        ...
        faqs: [
          ...
          { q: 'MacBook Air M5는 어떤 모델을 실행할 수 있습니까?', a: 'MacBook Air M5는 팬리스 설계이며 일반적으로 16~32 GB의 통합 메모리를 탑재하므로, 위 표의 16GB 또는 36GB 등급 Mac으로 취급하십시오: Phi-4는 여유롭게 실행되며, 24GB 이상이면 Llama 3.3 8B Q8도 가능합니다. 팬이 없어 장시간 생성 시 성능이 약간 저하될 수 있으므로 이 문서의 M5 Pro tok/s 범위 중 낮은 쪽을 예상하십시오.' },
