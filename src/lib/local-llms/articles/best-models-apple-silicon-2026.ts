  ...
  en: {
    ...
    sections: {
      byTier: {
        ...
        imageCaption: 'Best Model by Mac Memory Tier -- Updated quarterly -- last verified July 2026',
      },
      qualityBenchmarks: {
  ...
  es: {
    ...
    sections: {
      byTier: {
        ...
        content: 'Última verificación: 2026-07-14. Las recomendaciones pueden cambiar con nuevos lanzamientos. Actualizamos esta página trimestralmente.',
        ...
        imageCaption: 'Mejor Modelo por Nivel de Memoria de Mac -- Actualizado trimestralmente — última verificación julio 2026',
      },
      qualityBenchmarks: {
        id: 'quality-benchmarks',
  ...
  ar: {
    ...
    sections: {
      byTier: {
        ...
        content: 'آخر تحقق: 2026-07-14. قد تتغير التوصيات مع الإصدارات الجديدة. نحدّث هذه الصفحة فصلياً.',
        ...
        imageCaption: 'أفضل نموذج حسب فئة ذاكرة Mac -- يُحدَّث فصليًا — آخر تحقق يوليو 2026',
      },
      qualityBenchmarks: {
        id: 'quality-benchmarks',
  ...
  pt: {
    ...
    sections: {
      byTier: {
        ...
        content: 'Última verificação: 2026-07-14. As recomendações podem mudar com novos lançamentos. Atualizamos esta página trimestralmente.',
        ...
        imageCaption: 'Melhor Modelo por Nível de Memória do Mac -- Atualizado trimestralmente — última verificação julho de 2026',
      },
      qualityBenchmarks: {
        id: 'quality-benchmarks',
  ...
  de: {
    ...
    sections: {
      byTier: {
        ...
        content: 'Zuletzt verifiziert: 2026-07-14. Modellempfehlungen können sich mit neuen Releases ändern. Wir aktualisieren diese Seite vierteljährlich.',
        ...
        imageCaption: 'Bestes Modell nach Mac-Speicherklasse -- Vierteljährlich aktualisiert — zuletzt geprüft Juli 2026',
      },
      qualityBenchmarks: {
        id: 'quality-benchmarks',
  ...
  fr: {
    ...
    sections: {
      byTier: {
        ...
        content: 'Dernière vérification : 2026-07-14. Les recommandations peuvent évoluer avec les nouveaux modèles. Mise à jour trimestrielle.',
        ...
        imageCaption: 'Meilleur Modèle par Niveau de Mémoire Mac -- Mis à jour trimestriellement — dernière vérification juillet 2026',
      },
      qualityBenchmarks: {
        id: 'quality-benchmarks',
  ...
  ja: {
    ...
    sections: {
      byTier: {
        ...
        content: '最終確認：2026-07-14。モデル推奨は新モデルのリリースとともに変わる可能性があります。四半期ごとに更新。',
        ...
        imageCaption: 'Macメモリ階層別最良モデル -- 四半期ごとに更新——最終確認2026年7月',
      },
      qualityBenchmarks: {
        id: 'quality-benchmarks',
  ...
  zh: {
    ...
    sections: {
      byTier: {
        id: 'by-tier',
        title: '按Mac内存的最佳模型推荐',
        content: '最后验证：2026-07-14。随着新模型发布，推荐可能会变化。每季度更新此页面。',
        ...
        imageCaption: '按Mac内存档位划分的最佳模型 -- 每季度更新——最后验证于2026年7月',
      },
      qualityBenchmarks: {
        id: 'quality-benchmarks',
  ...
  ko: {
    ...
    sections: {
      byTier: {
        ...
        content: '최종 검증: 2026-07-14. 새로운 모델 출시에 따라 추천 모델이 변경될 수 있습니다. 이 페이지는 분기별로 업데이트됩니다.',
        ...
        imageCaption: 'Mac 메모리 등급별 최적 모델 -- 분기별 업데이트 — 마지막 확인 2026년 7월',
      },
      qualityBenchmarks: {
        id: 'quality-benchmarks',
