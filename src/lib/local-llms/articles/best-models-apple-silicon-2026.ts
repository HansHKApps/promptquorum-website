...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    intro: 'Best local LLM model recommendations for every Apple Silicon Mac. Specific model picks for 16GB (Phi-4), 36GB (Llama 3.1 8B), 64GB (Qwen2 34B), 128GB (Llama 3.3 70B) with tok/s numbers on M5 Pro/Max.',
    ...
    heroImage: '/images/best-models-apple-silicon-2026-by-tier-hero-en.webp',
    ...
    current_models_mentioned: ['Phi-4', 'Llama 3.1 8B', 'Qwen3 14B', 'Qwen3 34B', 'Mistral 8x7B', 'Llama 3.3 70B'],
    current_hardware_mentioned: ['M5 Pro', 'M5 Max', 'M6', 'M5 Ultra'],
    ...
    leadAnswerBlock: '**16GB: Phi-4. 36GB: Llama 3.1 8B Q8 (~38 tok/s). 64GB: Qwen3 34B Q5 (~18 tok/s). 128GB: Llama 3.3 70B Q5 (~14 tok/s M5 Pro, ~16 tok/s M5 Max). All run via Ollama on Metal.**',
    quickAnswerTop: {
      en: {
        question: 'Which LLM model should I run on my Mac?',
        answer: '16GB → Phi-4. 36GB → Llama 3.1 8B or Qwen3 14B. 64GB → Qwen3 34B. 128GB → Llama 3.3 70B. Performance: 30-40 tok/s (8B), 15-20 tok/s (34B), 12-18 tok/s (70B) on M5 Pro.',
        bullets: ['16GB: Phi-4 3.8B', '36GB: Llama 3.1 8B Q8 (38 tok/s)', '64GB: Qwen3 34B Q5 (18 tok/s)', '128GB: Llama 3.3 70B Q5 (14–16 tok/s)', 'Use quantization: Q4/Q5 are standard', 'All available via Ollama'],
    ...
    sections: {
      byTier: {
        ...
        content: 'Last verified: 2026-08-27. Apple\'s August 25, 2026 refresh: Mac mini ships in M6 (32GB max, from $899) and M5 Pro (64GB max, from $1,699) configurations; Mac Studio ships in M5 Max (128GB max, from $2,499) and M5 Ultra (up to 512GB, from $5,499). All ship September 22, 2026 (the 512GB configuration ships late October 2026). Model recommendations may shift as new models release. We update this page quarterly.',
        ...
        rows: [
          ...
          { 'Memory': '36 GB', 'Primary Pick': 'Llama 3.1 8B', 'Quantization': 'Q8', 'Size': '8.5 GB', 'M5 Pro tok/s': '38–45', 'M5 Max tok/s': '75–85', 'Alternative': 'Qwen3 14B Q4 (8.5 GB)' },
        ...
        note: 'Sizes are GGUF format. MLX 4-bit equivalents are comparable. The 36GB tier maps to entry MacBook Pro M-Pro/M-Max configurations rather than Mac mini or Mac Studio — as of the August 2026 refresh, Mac mini and Mac Studio jump directly from 32GB to 64GB.',
        image: '/images/best-models-apple-silicon-2026-by-tier-hero-en.webp',
        imageCaption: 'Best Model by Mac Memory Tier -- Updated quarterly -- last verified August 2026',
      },
      qualityBenchmarks: {
        ...
        image: '/images/best-models-apple-silicon-2026-quality-benchmarks-hero-en.webp',
        imageCaption: 'Model Quality Benchmarks (2026) -- MMLU and average score',
      },
      byUsecase: {
        id: 'by-usecase',
        ...
        rows: [
          { 'Use Case': 'Coding (general)', 'Best for 36GB Mac': 'Llama 3.1 8B', 'Best for 64GB Mac': 'DeepSeek Coder V2 16B', 'Best for 128GB Mac': 'Llama 3.3 70B' },
          ...
          { 'Use Case': 'Long-form writing', 'Best for 36GB Mac': 'Llama 3.1 8B Q8', 'Best for 64GB Mac': 'Qwen3 34B Q5', 'Best for 128GB Mac': 'Llama 3.3 70B Q5' },
          ...
          { 'Use Case': 'RAG / Q&A', 'Best for 36GB Mac': 'Llama 3.1 8B + nomic-embed', 'Best for 64GB Mac': '[Llama 3.1 8B](/power-local-llm/local-rag-for-private-business-data) + bge-large', 'Best for 128GB Mac': 'Llama 3.3 70B + bge-large' },
          ...
          { 'Use Case': 'Summarization', 'Best for 36GB Mac': 'Llama 3.1 8B', 'Best for 64GB Mac': 'Qwen3 34B', 'Best for 128GB Mac': 'Llama 3.3 70B' },
      ...
      avoid: {
        ...
        callouts: [
          { type: 'warning', text: '**Llama 2 (any size) no longer recommended** — superseded by Llama 3.3; standard leaderboards show notably weaker results compared to newer releases. Still appears in older tutorials — do not follow them. Replace with: Llama 3.1 8B.' },
          { type: 'warning', text: '**Avoid Vicuna, Alpaca, WizardLM** — 2023-era community fine-tunes. Modern base models (Llama 3.3, Qwen3) already match or exceed their performance. Replace with: Qwen3 14B or Llama 3.1 8B.' },
          ...
          { type: 'warning', text: '**Use caution with models showing low recent development activity** — StableLM, RedPajama, MPT, Pythia: low recent commit activity (as of mid-2026). Use models from Meta, Alibaba, Mistral, Microsoft with regular updates.' },
        ],
      },
      formatReference: {
        id: 'format-reference',
...
ollama pull aya-expanse:32b         # translation`,
      ...
      relatedArticles: {
        ...
        items: [
          ...
          '[Apple\'s On-Device AI vs Real Local LLMs: What WWDC 2026 Actually Changed](/local-llms/apple-on-device-ai-vs-local-llms) -- Apple on-device AI vs local LLMs',
        ],
      },
      faq: {
        id: 'faq',
        faqs: [
          ...
          { q: 'Can I run Llama 3.3 405B on a Mac?', a: 'Not on previous-generation Macs. Llama 3.3 405B requires 200+ GB even at Q4 quantization. Apple\'s Mac Studio M5 Ultra, announced August 25, 2026 (shipping September 22, 2026; the 512GB configuration ships late October 2026), offers up to 512GB of unified memory starting at $5,499 — enough headroom to run 405B at Q4 quantization for the first time on consumer Apple hardware.' },
          ...
          { q: 'What is the smallest model that is actually useful?', a: 'Phi-4 at 3.8B parameters. It scores 84.8 on MMLU — matching some 8B models from 2024. For chat and Q&A it is surprisingly capable. For coding or complex reasoning, jump to Llama 3.1 8B or [Qwen3 14B](/local-llms/qwen-vs-llama-vs-mistral).' },
          ...
          { q: 'What can a MacBook Air M5 run?', a: 'The MacBook Air M5 ships with a fanless design and typically 16–32 GB of unified memory, so treat it as a 16 GB or 36 GB tier Mac from the table above: Phi-4 comfortably, Llama 3.1 8B Q8 if you have 24 GB+. Sustained long generations may throttle slightly without a fan — expect the lower end of the M5 Pro tok/s ranges in this article.' },
  ...
  es: {
    ...
    specific_year: 2026,
    theme: 'Hardware & Performance',
    title: 'Mejores modelos Ollama para Apple Silicon 2026: Recomendaciones para 16 GB, 36 GB, 64 GB, 128 GB',
    seoTitle: 'Mejores modelos Ollama para Apple Silicon 2026: 16 GB–128 GB',
    intro: 'Las mejores recomendaciones de modelos LLM locales para cada Mac con Apple Silicon. Selecciones concretas para 16 GB (Phi-4), 36 GB (Llama 3.1 8B), 64 GB (Qwen2 34B), 128 GB (Llama 3.3 70B) con datos de tok/s en M5 Pro/Max.',
    metaDescription: 'Mejores modelos Ollama para Apple Silicon: Phi-4 (16 GB), Llama 8B (36 GB), Qwen 34B (64 GB) y Llama 70B (128 GB). Velocidad tok/s y cuantización.',
    heroImage: '/images/best-models-apple-silicon-2026-by-tier-hero-es.webp',
    twitterDescription: 'Mejores modelos Ollama para tu Mac: 16 GB→Phi-4, 36 GB→Llama 8B, 64 GB→Qwen 34B, 128 GB→Llama 70B. Probados en M5 2026.',
    publishDate: '2026-05-15',
    dateModified: '2026-08-27',
    current_models_mentioned: ['Phi-4', 'Llama 3.1 8B', 'Qwen3 14B', 'Qwen3 34B', 'Mistral 8x7B', 'Llama 3.3 70B'],
    current_hardware_mentioned: ['M5 Pro', 'M5 Max', 'M6', 'M5 Ultra'],
    ...
    sections: {
      byTier: {
        ...
        content: 'Última verificación: 2026-08-27. Actualización de Apple del 25 de agosto de 2026: el Mac mini se ofrece en configuraciones M6 (32 GB máx., desde $899) y M5 Pro (64 GB máx., desde $1,699); el Mac Studio se ofrece en M5 Max (128 GB máx., desde $2,499) y M5 Ultra (hasta 512 GB, desde $5,499). Todos se envían el 22 de septiembre de 2026 (la configuración de 512 GB se envía a finales de octubre de 2026). Las recomendaciones pueden cambiar con nuevos lanzamientos. Actualizamos esta página trimestralmente.',
        ...
        rows: [
          ...
          { 'Memoria': '36 GB', 'Elección principal': 'Llama 3.1 8B', 'Cuantización': 'Q8', 'Tamaño': '8,5 GB', 'M5 Pro tok/s': '38–45', 'M5 Max tok/s': '75–85', 'Alternativa': 'Qwen3 14B Q4 (8,5 GB)' },
        ...
        note: 'Los tamaños son en formato GGUF. Los equivalentes MLX 4-bit son comparables. Los precios pueden variar según tu país. El nivel de 36 GB corresponde a las configuraciones base del MacBook Pro M-Pro/M-Max, no al Mac mini ni al Mac Studio — desde la actualización de agosto de 2026, el Mac mini y el Mac Studio pasan directamente de 32 GB a 64 GB.',
        image: '/images/best-models-apple-silicon-2026-by-tier-hero-es.webp',
        imageCaption: 'Mejor Modelo por Nivel de Memoria de Mac -- Actualizado trimestralmente — última verificación agosto 2026',
      },
      qualityBenchmarks: {
        id: 'quality-benchmarks',
        ...
        image: '/images/best-models-apple-silicon-2026-quality-benchmarks-hero-es.webp',
        imageCaption: 'Benchmarks de Calidad de Modelos (2026) -- MMLU y puntuación promedio',
      },
      byUsecase: {
        id: 'by-usecase',
        ...
        rows: [
          { 'Caso de uso': 'Programación (general)', 'Mejor para Mac 36 GB': 'Llama 3.1 8B', 'Mejor para Mac 64 GB': 'DeepSeek Coder V2 16B', 'Mejor para Mac 128 GB': 'Llama 3.3 70B' },
          ...
          { 'Caso de uso': 'Escritura larga', 'Mejor para Mac 36 GB': 'Llama 3.1 8B Q8', 'Mejor para Mac 64 GB': 'Qwen3 34B Q5', 'Mejor para Mac 128 GB': 'Llama 3.3 70B Q5' },
          ...
          { 'Caso de uso': 'RAG / preguntas y respuestas', 'Mejor para Mac 36 GB': 'Llama 3.1 8B + nomic-embed', 'Mejor para Mac 64 GB': '[Llama 3.1 8B](/es/power-local-llm/local-rag-for-private-business-data) + bge-large', 'Mejor para Mac 128 GB': 'Llama 3.3 70B + bge-large' },
          ...
          { 'Caso de uso': 'Resumen', 'Mejor para Mac 36 GB': 'Llama 3.1 8B', 'Mejor para Mac 64 GB': 'Qwen3 34B', 'Mejor para Mac 128 GB': 'Llama 3.3 70B' },
      ...
      avoid: {
        ...
        callouts: [
          { type: 'warning', text: '**Llama 2 (cualquier tamaño) ya no se recomienda** — reemplazado por Llama 3.3; los leaderboards estándar muestran resultados notablemente más débiles en comparación con las versiones recientes. Sigue apareciendo en tutoriales antiguos — no los sigas. Reemplaza con: Llama 3.1 8B.' },
          { type: 'warning', text: '**Evita Vicuna, Alpaca, WizardLM** — Fine-tunes comunitarios de 2023. Los modelos base modernos (Llama 3.3, Qwen3) igualan o superan su rendimiento. Reemplaza con: Qwen3 14B o Llama 3.1 8B.' },
          ...
          { type: 'warning', text: '**Ten precaución con modelos de baja actividad reciente** — StableLM, RedPajama, MPT, Pythia: con baja actividad de desarrollo reciente (a mediados de 2026). Usa modelos de Meta, Alibaba, Mistral, Microsoft con actualizaciones regulares.' },
        ],
      },
      formatReference: {
        id: 'format-reference',
...
ollama pull aya-expanse:32b         # traducción`,
        codeLanguage: 'bash',
        note: 'Cada modelo pesa varios GB. El espacio total en disco para varios modelos puede alcanzar los 50–100 GB. Comprueba el uso con `du -sh ~/.ollama/`. Los usuarios de LM Studio pueden descargar los mismos pesos GGUF o MLX directamente desde su explorador de modelos integrado, sin usar la CLI.',
      },
      relatedArticles: {
        id: 'related-articles',
        ...
        items: [
          ...
          '[La IA on-device de Apple vs los LLM locales reales: qué cambió realmente en WWDC 2026](/es/local-llms/apple-on-device-ai-vs-local-llms) -- Apple on-device AI vs local LLMs',
        ],
      },
      faq: {
        id: 'faq',
        faqs: [
          ...
          { q: '¿Puedo ejecutar Llama 3.3 405B en un Mac?', a: 'En Macs de generaciones anteriores, no. Llama 3.3 405B requiere más de 200 GB incluso con cuantización Q4. El Mac Studio M5 Ultra de Apple, anunciado el 25 de agosto de 2026 (con envíos desde el 22 de septiembre de 2026; la configuración de 512 GB se envía a finales de octubre de 2026), ofrece hasta 512 GB de memoria unificada desde $5,499 — margen suficiente para ejecutar 405B con cuantización Q4 por primera vez en hardware de consumo de Apple.' },
          ...
          { q: '¿Cuál es el modelo más pequeño que realmente es útil?', a: 'Phi-4 con 3,8B parámetros. Obtiene 84,8 en MMLU — igualando algunos modelos 8B de 2024. Para chat y preguntas y respuestas es sorprendentemente capaz. Para programación o razonamiento complejo, pasa a Llama 3.1 8B o [Qwen3 14B](/es/local-llms/qwen-vs-llama-vs-mistral).' },
          { q: '¿vLLM funciona en Apple Silicon?', a: 'El soporte de Metal en vLLM es limitado comparado con su ruta CUDA — las optimizaciones de throughput y batching que hacen atractivo a vLLM en GPUs Nvidia apenas se aplican en Mac. Para Apple Silicon, Ollama (llama.cpp/Metal) o LM Studio (GGUF/MLX) ofrecen mejor tok/s para un solo usuario y una configuración más sencilla. Considera vLLM solo si atiendes muchas solicitudes concurrentes desde un equipo Linux/Nvidia junto a tu Mac.' },
          { q: '¿Qué puede ejecutar un MacBook Air M5?', a: 'El MacBook Air M5 tiene diseño sin ventilador y normalmente 16–32 GB de memoria unificada, así que trátalo como un Mac de nivel 16 GB o 36 GB de la tabla anterior: Phi-4 sin problemas, Llama 3.1 8B Q8 si tienes 24 GB o más. Las generaciones largas y sostenidas pueden ralentizarse ligeramente al no tener ventilador — espera el extremo inferior de los rangos de tok/s del M5 Pro indicados en este artículo.' },
          { q: '¿Cuál es la mejor configuración para un MacBook Pro M5 Max con 128 GB de RAM?', a: 'Llama 3.3 70B Q5 (49 GB) para uso diario, con margen para mantener un segundo modelo — Qwen3 14B Q5 o DeepSeek Coder V2 16B — cargado simultáneamente mediante `OLLAMA_MAX_LOADED_MODELS=2`. Espera entre ~14 y 18 tok/s en 70B Q5. Si quieres máxima calidad y toleras ~9–12 tok/s, Llama 3.3 70B Q8 (74 GB) también cabe.' },
        ],
      },
    },
  ...
  ar: {
    ...
    specific_year: 2026,
    theme: 'Hardware & Performance',
    title: 'أفضل نماذج ⁨Ollama⁩ لـ ⁨Apple Silicon 2026⁩: توصيات لـ ⁨16 GB⁩ و⁨36 GB⁩ و⁨64 GB⁩ و⁨128 GB⁩',
    seoTitle: 'أفضل نماذج ⁨Ollama⁩ لـ ⁨Apple Silicon 2026⁩: ⁨16⁩ إلى ⁨128 GB⁩',
    intro: 'أفضل توصيات نماذج LLM المحلية لكل جهاز Mac مزود بـ Apple Silicon. اختيارات محددة لـ 16 GB (Phi-4)، و36 GB (Llama 3.1 8B)، و64 GB (Qwen2 34B)، و128 GB (Llama 3.3 70B) مع بيانات tok/s على M5 Pro/Max.',
    metaDescription: 'أفضل نماذج ⁨Ollama⁩ لـ ⁨Apple Silicon⁩: ⁨Phi-4⁩ للـ ⁨16 GB⁩، ⁨Llama 3.1 8B Q8⁩ للـ ⁨36 GB⁩ بـ ⁨38 tok/s⁩، ⁨Qwen3 34B Q5⁩ للـ ⁨64 GB⁩ بـ ⁨18 tok/s⁩، ⁨Llama 3.3 70B Q5⁩ للـ ⁨128 GB⁩. عبر ⁨Ollama⁩ على ⁨Metal⁩.',
    heroImage: '/images/best-models-apple-silicon-2026-by-tier-hero-ar.webp',
    twitterDescription: 'أفضل نماذج ⁨Ollama⁩ لجهاز ⁨Mac⁩: ⁨16 GB⁩→⁨Phi-4⁩، ⁨36 GB⁩→⁨Llama 8B⁩، ⁨64 GB⁩→⁨Qwen 34B⁩، ⁨128 GB⁩→⁨Llama 70B⁩. مختبرة على ⁨M5 2026⁩.',
    publishDate: '2026-05-15',
    dateModified: '2026-08-27',
    current_models_mentioned: ['Phi-4', 'Llama 3.1 8B', 'Qwen3 14B', 'Qwen3 34B', 'Mistral 8x7B', 'Llama 3.3 70B'],
    current_hardware_mentioned: ['M5 Pro', 'M5 Max', 'M6', 'M5 Ultra'],
    ...
    leadAnswerBlock: '**16 GB: Phi-4. 36 GB: Llama 3.1 8B Q8 (~38 tok/s). 64 GB: Qwen3 34B Q5 (~18 tok/s). 128 GB: Llama 3.3 70B Q5 (~14 tok/s على M5 Pro، ~16 tok/s على M5 Max). جميعها تعمل عبر Ollama على Metal.**',
    ...
    sections: {
      byTier: {
        ...
        content: 'آخر تحقق: 2026-08-27. تحديث Apple في 25 أغسطس 2026: يأتي Mac mini بتكوينات M6 (بحد أقصى 32 GB، ابتداءً من 899 دولارًا) وM5 Pro (بحد أقصى 64 GB، ابتداءً من 1,699 دولارًا)؛ ويأتي Mac Studio بتكوينات M5 Max (بحد أقصى 128 GB، ابتداءً من 2,499 دولارًا) وM5 Ultra (حتى 512 GB، ابتداءً من 5,499 دولارًا). تُشحن جميعها في 22 سبتمبر 2026 (تُشحن نسخة 512 GB أواخر أكتوبر 2026). قد تتغير التوصيات مع الإصدارات الجديدة. نحدّث هذه الصفحة فصلياً.',
        columns: ['الذاكرة', 'الاختيار الأول', 'التكميم', 'الحجم', 'M5 Pro tok/s', 'M5 Max tok/s', 'البديل'],
        rows: [
          { 'الذاكرة': '16 GB', 'الاختيار الأول': 'Phi-4', 'التكميم': 'Q4_K_M', 'الحجم': '2.5 GB', 'M5 Pro tok/s': '60–70', 'M5 Max tok/s': '110–130', 'البديل': 'Llama 3.1 8B Q4 (ضيق)' },
          { 'الذاكرة': '36 GB', 'الاختيار الأول': 'Llama 3.1 8B', 'التكميم': 'Q8', 'الحجم': '8.5 GB', 'M5 Pro tok/s': '38–45', 'M5 Max tok/s': '75–85', 'البديل': 'Qwen3 14B Q4 (8.5 GB)' },
        ...
        note: 'الأحجام بصيغة GGUF. المكافئات MLX بدقة 4-bit متقاربة. قد تختلف الأسعار حسب بلدك. تُقابل فئة 36 GB تكوينات MacBook Pro الأساسية بمعالج M-Pro/M-Max وليس Mac mini أو Mac Studio — فمنذ تحديث أغسطس 2026، ينتقل Mac mini وMac Studio مباشرةً من 32 GB إلى 64 GB.',
        image: '/images/best-models-apple-silicon-2026-by-tier-hero-ar.webp',
        imageCaption: 'أفضل نموذج حسب فئة ذاكرة Mac -- يُحدَّث فصليًا — آخر تحقق أغسطس 2026',
      },
      qualityBenchmarks: {
        id: 'quality-benchmarks',
        ...
        rows: [
          ...
          { 'النموذج': 'Llama 3.1 8B', 'MMLU': '73.0', 'HumanEval': '72.6', 'GSM8K': '84.5', 'المتوسط': '76.7', 'ملاحظات': 'جيد لكل شيء' },
        ...
        image: '/images/best-models-apple-silicon-2026-quality-benchmarks-hero-ar.webp',
        imageCaption: 'معايير جودة النماذج (2026) -- MMLU والمتوسط',
      },
      byUsecase: {
        id: 'by-usecase',
        ...
        rows: [
          { 'حالة الاستخدام': 'البرمجة (عام)', 'الأفضل لـ Mac 36 GB': 'Llama 3.1 8B', 'الأفضل لـ Mac 64 GB': 'DeepSeek Coder V2 16B', 'الأفضل لـ Mac 128 GB': 'Llama 3.3 70B' },
          ...
          { 'حالة الاستخدام': 'الكتابة الطويلة', 'الأفضل لـ Mac 36 GB': 'Llama 3.1 8B Q8', 'الأفضل لـ Mac 64 GB': 'Qwen3 34B Q5', 'الأفضل لـ Mac 128 GB': 'Llama 3.3 70B Q5' },
          ...
          { 'حالة الاستخدام': 'RAG / الأسئلة والأجوبة', 'الأفضل لـ Mac 36 GB': 'Llama 3.1 8B + nomic-embed', 'الأفضل لـ Mac 64 GB': '[Llama 3.1 8B](/ar/power-local-llm/local-rag-for-private-business-data) + bge-large', 'الأفضل لـ Mac 128 GB': 'Llama 3.3 70B + bge-large' },
          ...
          { 'حالة الاستخدام': 'التلخيص', 'الأفضل لـ Mac 36 GB': 'Llama 3.1 8B', 'الأفضل لـ Mac 64 GB': 'Qwen3 34B', 'الأفضل لـ Mac 128 GB': 'Llama 3.3 70B' },
      ...
      avoid: {
        ...
        callouts: [
          { type: 'warning', text: '**Llama 2 (أي حجم) لم يعد موصى به** — تم استبداله بـ Llama 3.3؛ تُظهر لوحات الصدارة القياسية نتائج أضعف بشكل ملحوظ مقارنةً بالإصدارات الأحدث. لا يزال يظهر في الدروس القديمة — لا تتبعها. استبدله بـ: Llama 3.1 8B.' },
          { type: 'warning', text: '**تجنّب Vicuna وAlpaca وWizardLM** — ضبط دقيق مجتمعي من 2023. تضاهي النماذج الأساسية الحديثة (Llama 3.3، Qwen3) أداءها أو تتفوق عليه. استبدلها بـ: Qwen3 14B أو Llama 3.1 8B.' },
          ...
          { type: 'warning', text: '**توخَّ الحذر مع النماذج ذات نشاط التطوير المنخفض** — StableLM، RedPajama، MPT، Pythia: ذات نشاط تطوير حديث منخفض (منتصف 2026). استخدم نماذج من Meta وAlibaba وMistral وMicrosoft ذات التحديثات المنتظمة.' },
        ],
      },
      formatReference: {
        id: 'format-reference',
...
ollama pull aya-expanse:32b         # traducción`,
        codeLanguage: 'bash',
        note: 'يزن كل نموذج عدة GB. قد تصل مساحة القرص الإجمالية لعدة نماذج إلى 50–100 GB. تحقق من الاستخدام بـ `du -sh ~/.ollama/`. يمكن لمستخدمي LM Studio تنزيل أوزان GGUF أو MLX نفسها مباشرةً من متصفح النماذج داخل التطبيق بدلاً من سطر الأوامر.',
      },
      relatedArticles: {
        id: 'related-articles',
        ...
        items: [
          ...
          '[الذكاء الاصطناعي المحلي من Apple مقابل نماذج LLM المستضافة ذاتياً: ما الذي غيّرته WWDC 2026 فعلاً](/ar/local-llms/apple-on-device-ai-vs-local-llms) -- Apple on-device AI vs local LLMs',
        ],
      },
      faq: {
        id: 'faq',
        faqs: [
          ...
          { q: 'أي نموذج أفضل للمبتدئين؟', a: 'Llama 3.1 8B. متاح على نطاق واسع، بجودة إخراج جيدة وسجل مُثبت. يعمل على أي Mac M1+.' },
          ...
          { q: 'هل يمكنني تشغيل Llama 3.3 405B على جهاز Mac؟', a: 'ليس على أجهزة Mac من الأجيال السابقة. يتطلب Llama 3.3 405B أكثر من 200 GB حتى مع تكميم Q4. جهاز Mac Studio M5 Ultra من Apple، الذي أُعلن عنه في 25 أغسطس 2026 (بشحن يبدأ في 22 سبتمبر 2026؛ وتُشحن نسخة 512 GB أواخر أكتوبر 2026)، يوفر ذاكرة موحدة تصل إلى 512 GB بسعر يبدأ من 5,499 دولارًا — وهي مساحة كافية لتشغيل 405B بتكميم Q4 لأول مرة على عتاد Apple الاستهلاكي.' },
          ...
          { q: 'ما أصغر نموذج مفيد فعلاً؟', a: 'Phi-4 بـ 3.8B معامل. يحصل على 84.8 في MMLU — مضاهياً بعض نماذج 8B من 2024. للدردشة والأسئلة والأجوبة، إنه قادر بشكل مفاجئ. للبرمجة أو الاستدلال المعقد، انتقل إلى Llama 3.1 8B أو [Qwen3 14B](/ar/local-llms/qwen-vs-llama-vs-mistral).' },
          { q: 'هل يعمل vLLM على Apple Silicon؟', a: 'دعم vLLM لـ Metal محدود مقارنةً بمساره على CUDA — تحسينات الإنتاجية والتجميع (batching) التي تجعل vLLM جذاباً على معالجات Nvidia الرسومية لا تنطبق إلى حد كبير على Mac. بالنسبة لـ Apple Silicon، تمنحك Ollama (llama.cpp/Metal) أو LM Studio (GGUF/MLX) معدل tok/s أفضل للمستخدم الواحد وإعداداً أسهل. لا تفكّر في vLLM إلا إذا كنت تخدم عدداً كبيراً من الطلبات المتزامنة من جهاز Linux/Nvidia إلى جانب جهاز Mac لديك.' },
          { q: 'ماذا يمكن لجهاز MacBook Air M5 تشغيله؟', a: 'يأتي MacBook Air M5 بتصميم بلا مروحة وعادةً بذاكرة موحدة تتراوح بين 16 و32 GB، لذا عامله كجهاز Mac من فئة 16 GB أو 36 GB من الجدول أعلاه: Phi-4 براحة، وLlama 3.1 8B Q8 إذا كانت لديك 24 GB أو أكثر. قد تنخفض السرعة قليلاً في التوليد الطويل المستمر بسبب غياب المروحة — توقّع الطرف الأدنى من نطاقات tok/s الخاصة بـ M5 Pro في هذا المقال.' },
          { q: 'ما أفضل إعداد لجهاز MacBook Pro M5 Max بذاكرة 128GB؟', a: 'Llama 3.3 70B Q5 (49 GB) للاستخدام اليومي، مع مساحة كافية لإبقاء نموذج ثانٍ — Qwen3 14B Q5 أو DeepSeek Coder V2 16B — محمّلاً في الوقت نفسه عبر `OLLAMA_MAX_LOADED_MODELS=2`. توقّع نحو 14–18 tok/s على 70B Q5. إذا أردت أقصى جودة ويمكنك تحمّل نحو 9–12 tok/s، فإن Llama 3.3 70B Q8 (74 GB) يتناسب أيضاً.' },
        ],
      },
    },
  ...
  pt: {
    ...
    specific_year: 2026,
    theme: 'Hardware & Performance',
    title: 'Melhores modelos Ollama para Apple Silicon 2026: Recomendações para 16 GB, 36 GB, 64 GB, 128 GB',
    seoTitle: 'Melhores modelos Ollama para Apple Silicon 2026: 16 GB–128 GB',
    intro: 'As melhores recomendações de modelos LLM locais para cada Mac com Apple Silicon. Escolhas concretas para 16 GB (Phi-4), 36 GB (Llama 3.1 8B), 64 GB (Qwen2 34B), 128 GB (Llama 3.3 70B) com dados de tok/s em M5 Pro/Max.',
    metaDescription: 'Melhores modelos Ollama para Apple Silicon: Phi-4 (16 GB), Llama 8B (36 GB), Qwen 34B (64 GB) e Llama 70B (128 GB). Velocidade tok/s e quantização.',
    heroImage: '/images/best-models-apple-silicon-2026-by-tier-hero-pt.webp',
    twitterDescription: 'Melhores modelos Ollama para o seu Mac: 16 GB→Phi-4, 36 GB→Llama 8B, 64 GB→Qwen 34B, 128 GB→Llama 70B. Testados no M5 2026.',
    publishDate: '2026-05-15',
    dateModified: '2026-08-27',
    current_models_mentioned: ['Phi-4', 'Llama 3.1 8B', 'Qwen3 14B', 'Qwen3 34B', 'Mistral 8x7B', 'Llama 3.3 70B'],
    current_hardware_mentioned: ['M5 Pro', 'M5 Max', 'M6', 'M5 Ultra'],
    ...
    leadAnswerBlock: '**16 GB: Phi-4. 36 GB: Llama 3.1 8B Q8 (~38 tok/s). 64 GB: Qwen3 34B Q5 (~18 tok/s). 128 GB: Llama 3.3 70B Q5 (~14 tok/s M5 Pro, ~16 tok/s M5 Max). Todos funcionam via Ollama no Metal.**',
    quickAnswerTop: {
      ...
      pt: {
        ...
        answer: '16 GB → Phi-4. 36 GB → Llama 3.1 8B ou Qwen3 14B. 64 GB → Qwen3 34B. 128 GB → Llama 3.3 70B. Desempenho: 30-40 tok/s (8B), 15-20 tok/s (34B), 12-18 tok/s (70B) no M5 Pro.', // VERIFY
        bullets: ['16 GB: Phi-4 3.8B', '36 GB: Llama 3.1 8B Q8 (38 tok/s)', '64 GB: Qwen3 34B Q5 (18 tok/s)', '128 GB: Llama 3.3 70B Q5 (14–16 tok/s)', 'Use quantização: Q4/Q5 são o padrão', 'Todos disponíveis via Ollama'], // VERIFY
        updatedDate: '2026-05-15',
      },
    },
    toc: [
    ...
    sections: {
      byTier: {
        ...
        content: 'Última verificação: 2026-08-27. Atualização da Apple em 25 de agosto de 2026: o Mac mini passa a vir em configurações M6 (até 32 GB, a partir de US$ 899) e M5 Pro (até 64 GB, a partir de US$ 1.699); o Mac Studio passa a vir em M5 Max (até 128 GB, a partir de US$ 2.499) e M5 Ultra (até 512 GB, a partir de US$ 5.499). Todos com envio a partir de 22 de setembro de 2026 (a configuração de 512 GB chega no final de outubro de 2026). As recomendações podem mudar com novos lançamentos. Atualizamos esta página trimestralmente.',
        columns: ['Memória', 'Escolha principal', 'Quantização', 'Tamanho', 'M5 Pro tok/s', 'M5 Max tok/s', 'Alternativa'],
        rows: [
          { 'Memória': '16 GB', 'Escolha principal': 'Phi-4', 'Quantização': 'Q4_K_M', 'Tamanho': '2,5 GB', 'M5 Pro tok/s': '60–70', 'M5 Max tok/s': '110–130', 'Alternativa': 'Llama 3.1 8B Q4 (no limite)' },
          { 'Memória': '36 GB', 'Escolha principal': 'Llama 3.1 8B', 'Quantização': 'Q8', 'Tamanho': '8,5 GB', 'M5 Pro tok/s': '38–45', 'M5 Max tok/s': '75–85', 'Alternativa': 'Qwen3 14B Q4 (8,5 GB)' },
        ...
        note: 'Os tamanhos são em formato GGUF. Os equivalentes MLX 4-bit são comparáveis. Os preços variam conforme o país; no Brasil, a Apple cobra valores bem mais altos em reais. O nível de 36 GB corresponde às configurações básicas do MacBook Pro M-Pro/M-Max, não ao Mac mini nem ao Mac Studio — desde a atualização de agosto de 2026, o Mac mini e o Mac Studio pulam diretamente de 32 GB para 64 GB.',
        image: '/images/best-models-apple-silicon-2026-by-tier-hero-pt.webp',
        imageCaption: 'Melhor Modelo por Nível de Memória do Mac -- Atualizado trimestralmente — última verificação agosto de 2026',
      },
      qualityBenchmarks: {
        id: 'quality-benchmarks',
        ...
        rows: [
          ...
          { 'Modelo': 'Llama 3.1 8B', 'MMLU': '73,0', 'HumanEval': '72,6', 'GSM8K': '84,5', 'Média': '76,7', 'Notas': 'Bom para tudo' },
        ...
        image: '/images/best-models-apple-silicon-2026-quality-benchmarks-hero-pt.webp',
        imageCaption: 'Benchmarks de Qualidade dos Modelos (2026) -- MMLU e pontuação média',
      },
      byUsecase: {
        id: 'by-usecase',
        ...
        rows: [
          { 'Caso de uso': 'Programação (geral)', 'Melhor para Mac 36 GB': 'Llama 3.1 8B', 'Melhor para Mac 64 GB': 'DeepSeek Coder V2 16B', 'Melhor para Mac 128 GB': 'Llama 3.3 70B' },
          ...
          { 'Caso de uso': 'Escrita longa', 'Melhor para Mac 36 GB': 'Llama 3.1 8B Q8', 'Melhor para Mac 64 GB': 'Qwen3 34B Q5', 'Melhor para Mac 128 GB': 'Llama 3.3 70B Q5' },
          ...
          { 'Caso de uso': 'RAG / perguntas e respostas', 'Melhor para Mac 36 GB': 'Llama 3.1 8B + nomic-embed', 'Melhor para Mac 64 GB': '[Llama 3.1 8B](/pt/power-local-llm/local-rag-for-private-business-data) + bge-large', 'Melhor para Mac 128 GB': 'Llama 3.3 70B + bge-large' },
          ...
          { 'Caso de uso': 'Resumo', 'Melhor para Mac 36 GB': 'Llama 3.1 8B', 'Melhor para Mac 64 GB': 'Qwen3 34B', 'Melhor para Mac 128 GB': 'Llama 3.3 70B' },
      ...
      avoid: {
        ...
        callouts: [
          { type: 'warning', text: '**Llama 2 (qualquer tamanho) já não é recomendado** — substituído por Llama 3.3; os leaderboards padrão mostram resultados notavelmente mais fracos em comparação com as versões mais recentes. Ainda aparece em tutoriais antigos — não os siga. Substitua por: Llama 3.1 8B.' },
          { type: 'warning', text: '**Evite Vicuna, Alpaca, WizardLM** — Fine-tunes da comunidade de 2023. Os modelos base modernos (Llama 3.3, Qwen3) igualam ou superam o desempenho deles. Substitua por: Qwen3 14B ou Llama 3.1 8B.' },
          ...
          { type: 'warning', text: '**Tenha cautela com modelos com baixa atividade recente** — StableLM, RedPajama, MPT, Pythia: com pouca atividade de desenvolvimento recente (meados de 2026). Use modelos da Meta, Alibaba, Mistral, Microsoft com atualizações regulares.' },
        ],
      },
      formatReference: {
        id: 'format-reference',
...
ollama pull aya-expanse:32b         # tradução`,
        codeLanguage: 'bash',
        note: 'Cada modelo pesa vários GB. O espaço total em disco para vários modelos pode alcançar 50–100 GB. Verifique o uso com `du -sh ~/.ollama/`. Usuários do LM Studio podem baixar os mesmos pesos GGUF ou MLX diretamente pelo navegador de modelos do próprio app, sem precisar da linha de comando.',
      },
      relatedArticles: {
        id: 'related-articles',
        ...
        items: [
          ...
          '[A IA no dispositivo da Apple vs LLMs locais reais: o que a WWDC 2026 mudou de verdade](/pt/local-llms/apple-on-device-ai-vs-local-llms) -- Apple on-device AI vs local LLMs',
        ],
      },
      faq: {
        id: 'faq',
        faqs: [
          ...
          { q: 'Qual modelo é melhor para iniciantes?', a: 'Llama 3.1 8B. Amplamente disponível, boa qualidade de saída e histórico comprovado. Funciona em qualquer Mac M1+.' },
          ...
          { q: 'Posso rodar o Llama 3.3 405B em um Mac?', a: 'Nos Macs de gerações anteriores, não. O Llama 3.3 405B exige mais de 200 GB mesmo com quantização Q4. O Mac Studio M5 Ultra da Apple, anunciado em 25 de agosto de 2026 (com envio a partir de 22 de setembro de 2026; a configuração de 512 GB chega no final de outubro de 2026), oferece até 512 GB de memória unificada a partir de US$ 5.499 — margem suficiente para rodar o 405B em quantização Q4 pela primeira vez em hardware de consumo da Apple.' },
          ...
          { q: 'Qual é o menor modelo que realmente é útil?', a: 'Phi-4 com 3,8B parâmetros. Obtém 84,8 no MMLU — igualando alguns modelos 8B de 2024. Para chat e perguntas e respostas é surpreendentemente capaz. Para programação ou raciocínio complexo, passe para o Llama 3.1 8B ou [Qwen3 14B](/pt/local-llms/qwen-vs-llama-vs-mistral).' },
          { q: 'O vLLM roda em Apple Silicon?', a: 'O suporte do vLLM ao Metal é limitado se comparado ao caminho CUDA — as otimizações de throughput e batching que tornam o vLLM atraente em GPUs Nvidia praticamente não se aplicam no Mac. Para Apple Silicon, o Ollama (llama.cpp/Metal) ou o LM Studio (GGUF/MLX) entregam melhor tok/s para uso individual e configuração mais simples. Considere o vLLM só se você estiver atendendo muitas requisições simultâneas em uma máquina Linux/Nvidia ao lado do seu Mac.' },
          { q: 'O que um MacBook Air M5 consegue rodar?', a: 'O MacBook Air M5 vem em design sem ventoinha e tipicamente com 16–32 GB de memória unificada, então trate-o como um Mac de nível 16 GB ou 36 GB conforme a tabela acima: Phi-4 tranquilamente, Llama 3.1 8B Q8 se você tiver 24 GB ou mais. Gerações longas e contínuas podem sofrer leve throttling sem ventoinha — espere a faixa inferior dos valores de tok/s do M5 Pro citados neste artigo.' },
          { q: 'Qual é a melhor configuração para um MacBook Pro M5 Max com 128 GB de RAM?', a: 'Llama 3.3 70B Q5 (49 GB) para uso diário, com folga para manter um segundo modelo — Qwen3 14B Q5 ou DeepSeek Coder V2 16B — carregado simultaneamente via `OLLAMA_MAX_LOADED_MODELS=2`. Espere ~14–18 tok/s no 70B Q5. Se você quiser qualidade máxima e tolerar ~9–12 tok/s, o Llama 3.3 70B Q8 (74 GB) também cabe.' },
        ],
      },
    },
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/pt/local-llms/best-models-apple-silicon-2026',
      inLanguage: 'pt-BR',
      datePublished: '2026-05-15',
      dateModified: '2026-08-27',
      author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
  ...
  de: {
    ...
    specific_year: 2026,
    theme: 'Hardware & Performance',
    title: 'Beste Ollama-Modelle für Apple Silicon 2026: Empfehlungen für 16 GB, 36 GB, 64 GB, 128 GB',
    seoTitle: 'Beste Ollama-Modelle für Apple Silicon 2026: 16–128 GB',
    intro: 'Beste lokale LLM-Modellempfehlungen für jeden Apple-Silicon-Mac. Konkrete Modellauswahl für 16 GB (Phi-4), 36 GB (Llama 3.1 8B), 64 GB (Qwen2 34B), 128 GB (Llama 3.3 70B) mit tok/s-Werten auf M5 Pro/Max.',
    metaDescription: 'Beste Ollama-Modelle für Apple Silicon: Phi-4 (16 GB), Llama 8B (36 GB), Qwen 34B (64 GB), Llama 70B (128 GB). Token/s-Geschwindigkeit, Quantisierung, Upgrade-Tipps.',
    heroImage: '/images/best-models-apple-silicon-2026-by-tier-hero-de.webp',
    twitterDescription: 'Beste Ollama-Modelle für Ihren Mac: 16 GB→Phi-4, 36 GB→Llama 8B, 64 GB→Qwen 34B, 128 GB→Llama 70B. Getestet auf M5 2026.',
    publishDate: '2026-05-15',
    dateModified: '2026-08-27',
    current_models_mentioned: ['Phi-4', 'Llama 3.1 8B', 'Qwen3 14B', 'Qwen3 34B', 'Mistral 8x7B', 'Llama 3.3 70B'],
    current_hardware_mentioned: ['M5 Pro', 'M5 Max', 'M6', 'M5 Ultra'],
    ...
    leadAnswerBlock: '**16 GB: Phi-4. 36 GB: Llama 3.1 8B Q8 (~38 tok/s). 64 GB: Qwen3 34B Q5 (~18 tok/s). 128 GB: Llama 3.3 70B Q5 (~14 tok/s M5 Pro, ~16 tok/s M5 Max). Alle laufen über Ollama auf Metal.**',
    quickAnswerTop: {
      en: { question: '', answer: '', bullets: [], updatedDate: '2026-05-15' },
      de: {
        question: 'Welches LLM-Modell sollte ich auf meinem Mac verwenden?',
        answer: '16 GB → Phi-4. 36 GB → Llama 3.1 8B oder Qwen3 14B. 64 GB → Qwen3 34B. 128 GB → Llama 3.3 70B. Leistung: 30–40 tok/s (8B), 15–20 tok/s (34B), 12–18 tok/s (70B) auf M5 Pro.',
        bullets: ['16 GB: Phi-4 3,8B', '36 GB: Llama 3.1 8B Q8 (38 tok/s)', '64 GB: Qwen3 34B Q5 (18 tok/s)', '128 GB: Llama 3.3 70B Q5 (14–16 tok/s)', 'Quantisierung verwenden: Q4/Q5 sind Standard', 'Alle über Ollama verfügbar'],
        updatedDate: '2026-05-15',
      },
      fr: { question: '', answer: '', bullets: [], updatedDate: '2026-05-15' },
      ja: { question: '', answer: '', bullets: [], updatedDate: '2026-05-15' },
    ...
    sections: {
      byTier: {
        ...
        content: 'Zuletzt verifiziert: 2026-08-27. Apples Refresh vom 25. August 2026: Der Mac mini ist jetzt in den Konfigurationen M6 (max. 32 GB, ab 899 $) und M5 Pro (max. 64 GB, ab 1.699 $) erhältlich; der Mac Studio in M5 Max (max. 128 GB, ab 2.499 $) und M5 Ultra (bis zu 512 GB, ab 5.499 $). Alle Modelle werden ab dem 22. September 2026 ausgeliefert (die 512-GB-Konfiguration erst Ende Oktober 2026). Modellempfehlungen können sich mit neuen Releases ändern. Wir aktualisieren diese Seite vierteljährlich.',
        ...
        rows: [
          ...
          { 'Speicher': '36 GB', 'Primäre Wahl': 'Llama 3.1 8B', 'Quantisierung': 'Q8', 'Größe': '8,5 GB', 'M5 Pro tok/s': '38–45', 'M5 Max tok/s': '75–85', 'Alternative': 'Qwen3 14B Q4 (8,5 GB)' },
        ...
        note: 'Größen im GGUF-Format. MLX 4-Bit-Äquivalente sind vergleichbar. Die 36-GB-Stufe entspricht den Basiskonfigurationen des MacBook Pro mit M-Pro/M-Max und nicht dem Mac mini oder Mac Studio — seit dem Refresh im August 2026 springen Mac mini und Mac Studio direkt von 32 GB auf 64 GB.',
        image: '/images/best-models-apple-silicon-2026-by-tier-hero-de.webp',
        imageCaption: 'Bestes Modell nach Mac-Speicherklasse -- Vierteljährlich aktualisiert — zuletzt geprüft August 2026',
      },
      qualityBenchmarks: {
        id: 'quality-benchmarks',
        ...
        image: '/images/best-models-apple-silicon-2026-quality-benchmarks-hero-de.webp',
        imageCaption: 'Modellqualitäts-Benchmarks (2026) -- MMLU und Durchschnittswert',
      },
      byUsecase: {
        id: 'by-usecase',
        ...
        rows: [
          { 'Anwendungsfall': 'Programmierung (allgemein)', 'Bestes für 36-GB-Mac': 'Llama 3.1 8B', 'Bestes für 64-GB-Mac': 'DeepSeek Coder V2 16B', 'Bestes für 128-GB-Mac': 'Llama 3.3 70B' },
          ...
          { 'Anwendungsfall': 'Langtexte verfassen', 'Bestes für 36-GB-Mac': 'Llama 3.1 8B Q8', 'Bestes für 64-GB-Mac': 'Qwen3 34B Q5', 'Bestes für 128-GB-Mac': 'Llama 3.3 70B Q5' },
          ...
          { 'Anwendungsfall': 'RAG / Frage & Antwort', 'Bestes für 36-GB-Mac': 'Llama 3.1 8B + nomic-embed', 'Bestes für 64-GB-Mac': '[Llama 3.1 8B](/de/power-local-llm/local-rag-for-private-business-data) + bge-large', 'Bestes für 128-GB-Mac': 'Llama 3.3 70B + bge-large' },
          ...
          { 'Anwendungsfall': 'Zusammenfassung', 'Bestes für 36-GB-Mac': 'Llama 3.1 8B', 'Bestes für 64-GB-Mac': 'Qwen3 34B', 'Bestes für 128-GB-Mac': 'Llama 3.3 70B' },
      ...
      avoid: {
        ...
        callouts: [
          { type: 'warning', text: '**Llama 2 (jede Größe) nicht mehr empfohlen** — von Llama 3.3 abgelöst; Standard-Leaderboards zeigen deutlich schwächere Ergebnisse gegenüber neueren Releases. Taucht noch in älteren Tutorials auf — diesen nicht folgen. Ersetzen durch: Llama 3.1 8B.' },
          { type: 'warning', text: '**Vicuna, Alpaca, WizardLM vermeiden** — Community-Feinabstimmungen aus 2023. Moderne Basismodelle (Llama 3.3, Qwen3) entsprechen oder übertreffen ihre Leistung. Ersetzen durch: Qwen3 14B oder Llama 3.1 8B.' },
          ...
          { type: 'warning', text: '**Bei Modellen mit geringer Entwicklungsaktivität Vorsicht walten lassen** — StableLM, RedPajama, MPT, Pythia: mit geringer neuerer Entwicklungsaktivität (Stand Mitte 2026). Modelle von Meta, Alibaba, Mistral, Microsoft mit regelmäßigen Updates verwenden.' },
        ],
      },
      formatReference: {
        id: 'format-reference',
        ...
        note: 'Größen in diesem Artikel sind GGUF Q4_K_M, sofern nicht anders angegeben. MLX 4-Bit-Äquivalente sind ähnlich groß. Für genaue Bytes die Modellkarte auf HuggingFace prüfen. llama.cpp führt GGUF direkt über das Metal-Backend aus und ist die Grundlage, auf der Ollama intern aufbaut — MLX ist Apples eigenes Framework und ist bei MLX-nativen Builds auf demselben Chip tendenziell schneller. LM Studio unterstützt sowohl GGUF als auch MLX und erlaubt es, das Backend pro Modell direkt in der Benutzeroberfläche zu wechseln.',
      },
      downloadGuide: {
        id: 'download-guide',
...
ollama pull aya-expanse:32b         # Übersetzung`,
        codeLanguage: 'bash',
        note: 'Jedes Modell ist mehrere GB groß. Der gesamte Speicherplatz für mehrere Modelle kann 50–100 GB erreichen. Verwendung prüfen mit `du -sh ~/.ollama/`. LM-Studio-Nutzer können dieselben GGUF- oder MLX-Gewichte direkt über den integrierten Modell-Browser statt über die Kommandozeile herunterladen.',
      },
      relatedArticles: {
        id: 'related-articles',
        ...
        items: [
          ...
          '[Apples On-Device-KI vs. echte lokale LLMs: Was WWDC 2026 wirklich geändert hat](/de/local-llms/apple-on-device-ai-vs-local-llms) -- Apple on-device AI vs local LLMs',
        ],
      },
      faq: {
        id: 'faq',
        faqs: [
          ...
          { q: 'Kann ich Llama 3.3 405B auf einem Mac ausführen?', a: 'Auf Macs der vorherigen Generation nicht. Llama 3.3 405B benötigt selbst bei Q4-Quantisierung über 200 GB. Apples Mac Studio M5 Ultra, angekündigt am 25. August 2026 (Auslieferung ab 22. September 2026; die 512-GB-Konfiguration erst Ende Oktober 2026), bietet bis zu 512 GB vereinigten Speicher ab 5.499 $ — genug Spielraum, um 405B erstmals in Q4-Quantisierung auf Consumer-Apple-Hardware auszuführen.' },
          ...
          { q: 'Eignen sich lokale Modelle für den Mittelstand?', a: 'Ja. Mit einem Mac Mini M5 Pro (64 GB, ca. 1.650 €) lassen sich mehrere 8B- bis 34B-Modelle dauerhaft betreiben. Im Vergleich zu Cloud-APIs (GPT-4: ca. 50–200 €/Monat pro Nutzer) amortisiert sich die Hardware innerhalb von 6–18 Monaten. Besonders für DSGVO-konforme Verarbeitung vertraulicher Dokumente (z. B. Verträge, Kundenanfragen) ist die lokale Option attraktiv.' },
          { q: 'Läuft vLLM auf Apple Silicon?', a: 'Die Metal-Unterstützung von vLLM ist im Vergleich zum CUDA-Pfad eingeschränkt — die Durchsatz- und Batching-Optimierungen, die vLLM auf Nvidia-GPUs attraktiv machen, greifen auf dem Mac größtenteils nicht. Für Apple Silicon liefern Ollama (llama.cpp/Metal) oder LM Studio (GGUF/MLX) bessere Einzelnutzer-tok/s und eine einfachere Einrichtung. vLLM lohnt sich nur, wenn viele gleichzeitige Anfragen von einer Linux/Nvidia-Maschine neben dem Mac bedient werden.' },
          { q: 'Was schafft ein MacBook Air M5?', a: 'Das MacBook Air M5 hat ein lüfterloses Design und in der Regel 16–32 GB vereinigten Speicher — es entspricht also der 16-GB- oder 36-GB-Stufe aus der obigen Tabelle: Phi-4 problemlos, Llama 3.1 8B Q8 ab 24 GB aufwärts. Bei anhaltend langen Generierungen kann es ohne Lüfter leicht drosseln — im unteren Bereich der M5-Pro-tok/s-Werte aus diesem Artikel bleiben.' },
          { q: 'Was ist das beste Setup für ein MacBook Pro M5 Max mit 128 GB RAM?', a: 'Llama 3.3 70B Q5 (49 GB) für den täglichen Einsatz, mit genug Spielraum, um gleichzeitig ein zweites Modell — Qwen3 14B Q5 oder DeepSeek Coder V2 16B — über `OLLAMA_MAX_LOADED_MODELS=2` geladen zu halten. Zu erwarten sind ca. 14–18 tok/s bei 70B Q5. Wer maximale Qualität möchte und ~9–12 tok/s toleriert, kann auch Llama 3.3 70B Q8 (74 GB) nutzen — das passt ebenfalls.' },
        ],
      },
    },
  ...
  fr: {
    ...
    specific_year: 2026,
    theme: 'Hardware & Performance',
    title: 'Meilleurs modèles Ollama pour Apple Silicon 2026 : Recommandations 16 Go, 36 Go, 64 Go, 128 Go',
    seoTitle: 'Meilleurs modèles Ollama pour Apple Silicon 2026 : 16–128 Go',
    intro: 'Meilleures recommandations de modèles LLM locaux pour chaque Mac Apple Silicon. Sélections concrètes pour 16 Go (Phi-4), 36 Go (Llama 3.1 8B), 64 Go (Qwen2 34B), 128 Go (Llama 3.3 70B) avec les performances tok/s sur M5 Pro/Max.',
    metaDescription: 'Meilleurs modèles Ollama pour Apple Silicon : Phi-4 (16 Go), Llama 8B (36 Go), Qwen 34B (64 Go), Llama 70B (128 Go). Vitesses tok/s, quantification, conseils de mise à niveau.',
    heroImage: '/images/best-models-apple-silicon-2026-by-tier-hero-fr.webp',
    twitterDescription: 'Meilleurs modèles Ollama pour votre Mac : 16 Go→Phi-4, 36 Go→Llama 8B, 64 Go→Qwen 34B, 128 Go→Llama 70B. Testés sur M5 2026.',
    publishDate: '2026-05-15',
    dateModified: '2026-08-27',
    current_models_mentioned: ['Phi-4', 'Llama 3.1 8B', 'Qwen3 14B', 'Qwen3 34B', 'Mistral 8x7B', 'Llama 3.3 70B'],
    current_hardware_mentioned: ['M5 Pro', 'M5 Max', 'M6', 'M5 Ultra'],
    ...
    leadAnswerBlock: '**16 Go : Phi-4. 36 Go : Llama 3.1 8B Q8 (~38 tok/s). 64 Go : Qwen3 34B Q5 (~18 tok/s). 128 Go : Llama 3.3 70B Q5 (~14 tok/s M5 Pro, ~16 tok/s M5 Max). Tous via Ollama sur Metal.**',
    quickAnswerTop: {
      en: { question: '', answer: '', bullets: [], updatedDate: '2026-05-15' },
      de: { question: '', answer: '', bullets: [], updatedDate: '2026-05-15' },
      fr: {
        question: 'Quel modèle LLM devrais-je utiliser sur mon Mac ?',
        answer: '16 Go → Phi-4. 36 Go → Llama 3.1 8B ou Qwen3 14B. 64 Go → Qwen3 34B. 128 Go → Llama 3.3 70B. Performance : 30–40 tok/s (8B), 15–20 tok/s (34B), 12–18 tok/s (70B) sur M5 Pro.',
        bullets: ['16 Go : Phi-4 3,8B', '36 Go : Llama 3.1 8B Q8 (38 tok/s)', '64 Go : Qwen3 34B Q5 (18 tok/s)', '128 Go : Llama 3.3 70B Q5 (14–16 tok/s)', 'Utiliser la quantification : Q4/Q5 sont standards', 'Tous disponibles via Ollama'],
        updatedDate: '2026-05-15',
      },
      ja: { question: '', answer: '', bullets: [], updatedDate: '2026-05-15' },
      zh: { question: '', answer: '', bullets: [], updatedDate: '2026-05-15' },
    ...
    sections: {
      byTier: {
        ...
        content: 'Dernière vérification : 2026-08-27. Mise à jour Apple du 25 août 2026 : le Mac mini est désormais proposé en configurations M6 (32 Go max, à partir de 899 $) et M5 Pro (64 Go max, à partir de 1 699 $) ; le Mac Studio en M5 Max (128 Go max, à partir de 2 499 $) et M5 Ultra (jusqu\'à 512 Go, à partir de 5 499 $). Livraison à partir du 22 septembre 2026 (la configuration 512 Go arrive fin octobre 2026). Les recommandations peuvent évoluer avec les nouveaux modèles. Mise à jour trimestrielle.',
        ...
        rows: [
          ...
          { 'Mémoire': '36 Go', 'Choix principal': 'Llama 3.1 8B', 'Quantification': 'Q8', 'Taille': '8,5 Go', 'M5 Pro tok/s': '38–45', 'M5 Max tok/s': '75–85', 'Alternative': 'Qwen3 14B Q4 (8,5 Go)' },
        ...
        note: 'Tailles au format GGUF. Les équivalents MLX 4-bit sont comparables. Le palier 36 Go correspond aux configurations de base du MacBook Pro M-Pro/M-Max, et non au Mac mini ou au Mac Studio — depuis la mise à jour d\'août 2026, le Mac mini et le Mac Studio passent directement de 32 Go à 64 Go.',
        image: '/images/best-models-apple-silicon-2026-by-tier-hero-fr.webp',
        imageCaption: 'Meilleur Modèle par Niveau de Mémoire Mac -- Mis à jour trimestriellement — dernière vérification août 2026',
      },
      qualityBenchmarks: {
        id: 'quality-benchmarks',
        ...
        image: '/images/best-models-apple-silicon-2026-quality-benchmarks-hero-fr.webp',
        imageCaption: 'Benchmarks de Qualité des Modèles (2026) -- MMLU et score moyen',
      },
      byUsecase: {
        id: 'by-usecase',
        ...
        rows: [
          { 'Cas d\'usage': 'Programmation (général)', 'Meilleur pour Mac 36 Go': 'Llama 3.1 8B', 'Meilleur pour Mac 64 Go': 'DeepSeek Coder V2 16B', 'Meilleur pour Mac 128 Go': 'Llama 3.3 70B' },
          ...
          { 'Cas d\'usage': 'Rédaction longue', 'Meilleur pour Mac 36 Go': 'Llama 3.1 8B Q8', 'Meilleur pour Mac 64 Go': 'Qwen3 34B Q5', 'Meilleur pour Mac 128 Go': 'Llama 3.3 70B Q5' },
          ...
          { 'Cas d\'usage': 'RAG / Q&R', 'Meilleur pour Mac 36 Go': 'Llama 3.1 8B + nomic-embed', 'Meilleur pour Mac 64 Go': '[Llama 3.1 8B](/fr/power-local-llm/local-rag-for-private-business-data) + bge-large', 'Meilleur pour Mac 128 Go': 'Llama 3.3 70B + bge-large' },
          ...
          { 'Cas d\'usage': 'Résumé', 'Meilleur pour Mac 36 Go': 'Llama 3.1 8B', 'Meilleur pour Mac 64 Go': 'Qwen3 34B', 'Meilleur pour Mac 128 Go': 'Llama 3.3 70B' },
      ...
      avoid: {
        ...
        callouts: [
          { type: 'warning', text: '**Llama 2 (toute taille) n\'est plus recommandé** — remplacé par Llama 3.3 ; les leaderboards standards montrent des résultats nettement plus faibles par rapport aux versions récentes. Apparaît encore dans d\'anciens tutoriels — ne pas les suivre. Remplacer par : Llama 3.1 8B.' },
          { type: 'warning', text: '**Éviter Vicuna, Alpaca, WizardLM** — Ajustements communautaires de 2023. Les modèles de base modernes (Llama 3.3, Qwen3) égalent ou surpassent leurs performances. Remplacer par : Qwen3 14B ou Llama 3.1 8B.' },
          ...
          { type: 'warning', text: '**Faire preuve de prudence avec les modèles peu développés récemment** — StableLM, RedPajama, MPT, Pythia : avec peu d\'activité de développement récente (mi-2026). Utiliser des modèles de Meta, Alibaba, Mistral, Microsoft avec des mises à jour régulières.' },
        ],
      },
      formatReference: {
        id: 'format-reference',
        ...
        note: 'Les tailles dans cet article sont GGUF Q4_K_M sauf indication. Les équivalents MLX 4-bit sont similaires. Pour les octets exacts, consulter la fiche modèle sur HuggingFace. llama.cpp exécute directement les fichiers GGUF sur le backend Metal et c\'est ce qu\'Ollama utilise en interne — MLX est le framework propriétaire d\'Apple et tend à être plus rapide pour les builds natifs MLX sur la même puce. LM Studio prend en charge à la fois GGUF et MLX et permet de changer de backend par modèle depuis son interface.',
      },
      downloadGuide: {
        id: 'download-guide',
...
ollama pull aya-expanse:32b         # traduction`,
        codeLanguage: 'bash',
        note: 'Chaque modèle pèse plusieurs Go. L\'espace total pour plusieurs modèles peut atteindre 50–100 Go. Vérifier avec `du -sh ~/.ollama/`. Les utilisateurs de LM Studio peuvent télécharger les mêmes poids GGUF ou MLX directement depuis son navigateur de modèles intégré, sans passer par la ligne de commande.',
      },
      relatedArticles: {
        id: 'related-articles',
        ...
        items: [
          ...
          '[L\'IA on-device d\'Apple vs les vrais LLM locaux : ce que WWDC 2026 a vraiment changé](/fr/local-llms/apple-on-device-ai-vs-local-llms) -- Apple on-device AI vs local LLMs',
        ],
      },
      faq: {
        id: 'faq',
        faqs: [
          ...
          { q: 'Puis-je exécuter Llama 3.3 405B sur un Mac ?', a: 'Pas sur les Mac de générations précédentes. Llama 3.3 405B nécessite plus de 200 Go même en quantification Q4. Le Mac Studio M5 Ultra d\'Apple, annoncé le 25 août 2026 (livraison à partir du 22 septembre 2026 ; la configuration 512 Go arrive fin octobre 2026), offre jusqu\'à 512 Go de mémoire unifiée à partir de 5 499 $ — une marge suffisante pour exécuter 405B en quantification Q4 pour la première fois sur du matériel Apple grand public.' },
          ...
          { q: 'Quel est le plus petit modèle vraiment utile ?', a: 'Phi-4 à 3,8B paramètres. Il obtient 84,8 sur MMLU — équivalent à certains modèles 8B de 2024. Pour le chat et les Q&R, il est étonnamment capable. Pour la programmation ou le raisonnement complexe, passer à Llama 3.1 8B ou [Qwen3 14B](/fr/local-llms/qwen-vs-llama-vs-mistral).' },
          { q: 'vLLM fonctionne-t-il sur Apple Silicon ?', a: 'Le support Metal de vLLM est limité comparé à son chemin CUDA — les optimisations de débit et de traitement par lots qui rendent vLLM attractif sur les GPU Nvidia ne s\'appliquent en grande partie pas sur Mac. Sur Apple Silicon, Ollama (llama.cpp/Metal) ou LM Studio (GGUF/MLX) offrent de meilleurs tok/s en utilisateur unique et une installation plus simple. N\'envisager vLLM que si vous servez de nombreuses requêtes simultanées depuis une machine Linux/Nvidia en complément de votre Mac.' },
          { q: 'Que peut exécuter un MacBook Air M5 ?', a: 'Le MacBook Air M5 est proposé sans ventilateur et dispose généralement de 16 à 32 Go de mémoire unifiée : le considérer comme un Mac de niveau 16 Go ou 36 Go selon le tableau ci-dessus — Phi-4 sans difficulté, Llama 3.1 8B Q8 à partir de 24 Go. Des générations longues et soutenues peuvent légèrement throttler sans ventilateur — s\'attendre à la fourchette basse des tok/s M5 Pro indiqués dans cet article.' },
          { q: 'Quelle est la meilleure configuration pour un MacBook Pro M5 Max avec 128 Go de RAM ?', a: 'Llama 3.3 70B Q5 (49 Go) pour un usage quotidien, avec la marge nécessaire pour garder un second modèle chargé simultanément — Qwen3 14B Q5 ou DeepSeek Coder V2 16B — via `OLLAMA_MAX_LOADED_MODELS=2`. Prévoir environ 14–18 tok/s sur 70B Q5. Pour une qualité maximale et si vous tolérez environ 9–12 tok/s, Llama 3.3 70B Q8 (74 Go) tient également en mémoire.' },
        ],
      },
    },
  ...
  ja: {
    ...
    specific_year: 2026,
    theme: 'Hardware & Performance',
    title: 'Apple Silicon向けベストOllamaモデル2026：16GB、36GB、64GB、128GBの推奨モデル',
    seoTitle: 'Apple Silicon 2026向けベストOllamaモデル：16GB–128GB',
    intro: 'すべてのApple Silicon Mac向けベストローカルLLMモデル推奨。16GB（Phi-4）、36GB（Llama 3.1 8B）、64GB（Qwen2 34B）、128GB（Llama 3.3 70B）の具体的なモデル選択とM5 Pro/MaxのTok/s数値。',
    metaDescription: 'Apple Silicon向けベストOllamaモデル：Phi-4（16GB）、Llama 8B（36GB）、Qwen 34B（64GB）、Llama 70B（128GB）。tok/s速度比較、量子化方式、アップグレード時期。',
    heroImage: '/images/best-models-apple-silicon-2026-by-tier-hero-ja.webp',
    twitterDescription: 'MacのベストOllamaモデル：16GB→Phi-4、36GB→Llama 8B、64GB→Qwen 34B、128GB→Llama 70B。M5 2026でテスト済み。',
    publishDate: '2026-05-15',
    dateModified: '2026-08-27',
    current_models_mentioned: ['Phi-4', 'Llama 3.1 8B', 'Qwen3 14B', 'Qwen3 34B', 'Mistral 8x7B', 'Llama 3.3 70B'],
    current_hardware_mentioned: ['M5 Pro', 'M5 Max', 'M6', 'M5 Ultra'],
    ...
    leadAnswerBlock: '**16GB：Phi-4。36GB：Llama 3.1 8B Q8（約38 tok/s）。64GB：Qwen3 34B Q5（約18 tok/s）。128GB：Llama 3.3 70B Q5（約14 tok/s M5 Pro、約16 tok/s M5 Max）。すべてMetal上のOllamaで動作。**',
    quickAnswerTop: {
      en: { question: '', answer: '', bullets: [], updatedDate: '2026-05-15' },
      de: { question: '', answer: '', bullets: [], updatedDate: '2026-05-15' },
      fr: { question: '', answer: '', bullets: [], updatedDate: '2026-05-15' },
      ja: {
        ...
        answer: '16GB → Phi-4。36GB → Llama 3.1 8BまたはQwen3 14B。64GB → Qwen3 34B。128GB → Llama 3.3 70B。パフォーマンス：M5 Proで30–40 tok/s（8B）、15–20 tok/s（34B）、12–18 tok/s（70B）。',
        bullets: ['16GB：Phi-4 3.8B', '36GB：Llama 3.1 8B Q8（38 tok/s）', '64GB：Qwen3 34B Q5（18 tok/s）', '128GB：Llama 3.3 70B Q5（14–16 tok/s）', '量子化を使用：Q4/Q5が標準', 'すべてOllamaで利用可能'],
        updatedDate: '2026-05-15',
      },
      zh: { question: '', answer: '', bullets: [], updatedDate: '2026-05-15' },
    },
    ...
    sections: {
      byTier: {
        ...
        content: '最終確認：2026-08-27。Appleが2026年8月25日に発表した刷新内容：Mac miniはM6（最大32GB、899ドルから）とM5 Pro（最大64GB、1,699ドルから）の構成に、Mac StudioはM5 Max（最大128GB、2,499ドルから）とM5 Ultra（最大512GB、5,499ドルから）の構成になりました。出荷は2026年9月22日から（512GB構成は2026年10月下旬出荷）。モデル推奨は新モデルのリリースとともに変わる可能性があります。四半期ごとに更新。',
        ...
        rows: [
          ...
          { 'メモリ': '36 GB', '第一選択': 'Llama 3.1 8B', '量子化': 'Q8', 'サイズ': '8.5 GB', 'M5 Pro tok/s': '38–45', 'M5 Max tok/s': '75–85', '代替': 'Qwen3 14B Q4（8.5 GB）' },
        ...
        note: 'サイズはGGUFフォーマット。MLX 4ビット相当品は同等です。36GB階層はMac miniやMac StudioではなくMacBook ProのM-Pro/M-Max基本構成に対応します——2026年8月の刷新以降、Mac miniとMac Studioは32GBから直接64GBへ移行します。',
        image: '/images/best-models-apple-silicon-2026-by-tier-hero-ja.webp',
        imageCaption: 'Macメモリ階層別最良モデル -- 四半期ごとに更新——最終確認2026年8月',
      },
      qualityBenchmarks: {
        id: 'quality-benchmarks',
        ...
        image: '/images/best-models-apple-silicon-2026-quality-benchmarks-hero-ja.webp',
        imageCaption: 'モデル品質ベンチマーク（2026年） -- MMLUと平均スコア',
      },
      byUsecase: {
        id: 'by-usecase',
        ...
        rows: [
          { 'ユースケース': 'コーディング（一般）', '36GB Mac向けベスト': 'Llama 3.1 8B', '64GB Mac向けベスト': 'DeepSeek Coder V2 16B', '128GB Mac向けベスト': 'Llama 3.3 70B' },
          ...
          { 'ユースケース': '長文ライティング', '36GB Mac向けベスト': 'Llama 3.1 8B Q8', '64GB Mac向けベスト': 'Qwen3 34B Q5', '128GB Mac向けベスト': 'Llama 3.3 70B Q5' },
          ...
          { 'ユースケース': 'RAG / Q&A', '36GB Mac向けベスト': 'Llama 3.1 8B + nomic-embed', '64GB Mac向けベスト': '[Llama 3.1 8B](/ja/power-local-llm/local-rag-for-private-business-data) + bge-large', '128GB Mac向けベスト': 'Llama 3.3 70B + bge-large' },
          ...
          { 'ユースケース': '要約', '36GB Mac向けベスト': 'Llama 3.1 8B', '64GB Mac向けベスト': 'Qwen3 34B', '128GB Mac向けベスト': 'Llama 3.3 70B' },
      ...
      avoid: {
        ...
        callouts: [
          { type: 'warning', text: '**Llama 2（全サイズ）は推奨されなくなりました** — Llama 3.3に置き換えられており、標準的なリーダーボードでは新しいリリースと比較して著しく弱い結果を示しています。古いチュートリアルにまだ登場する — 従わないこと。代替：Llama 3.1 8B。' },
          { type: 'warning', text: '**Vicuna、Alpaca、WizardLMは避ける** — 2023年のコミュニティファインチューン。現代のベースモデル（Llama 3.3、Qwen3）が同等以上のパフォーマンス。代替：Qwen3 14BまたはLlama 3.1 8B。' },
          ...
          { type: 'warning', text: '**最近の開発活動が少ないモデルには注意が必要** — StableLM、RedPajama、MPT、Pythia：最近のコミット活動が少ない（2026年中頃時点）。定期的なアップデートがあるMeta、Alibaba、Mistral、Microsoftのモデルを使用。' },
        ],
      },
      formatReference: {
        id: 'format-reference',
        ...
        note: 'この記事のサイズは特記なき限りGGUF Q4_K_M。MLX 4ビット相当品は同様のサイズ。正確なバイト数はHuggingFaceのモデルカードを確認。llama.cppはMetalバックエンド上でGGUFを直接実行し、Ollamaも内部でこれを使用しています——MLXはApple独自のフレームワークで、同じチップ上でもMLXネイティブビルドではより高速になる傾向があります。LM StudioはGGUFとMLXの両方をサポートし、UIからモデルごとにバックエンドを切り替えられます。',
      },
      downloadGuide: {
        id: 'download-guide',
...
ollama pull aya-expanse:32b         # 翻訳`,
        codeLanguage: 'bash',
        note: '各モデルは数GB。複数モデルの合計ディスク使用量は50–100GBに達する可能性があります。`du -sh ~/.ollama/`で使用量を確認。LM Studioユーザーは、CLIの代わりにアプリ内のモデルブラウザから同じGGUFまたはMLXウェイトを直接プルできます。',
      },
      relatedArticles: {
        id: 'related-articles',
        title: '関連記事',
        items: [
          ...
          '[AppleのオンデバイスAI対ローカルLLM：WWDC 2026で実際に何が変わったか](/ja/local-llms/apple-on-device-ai-vs-local-llms) -- Apple on-device AI vs local LLMs',
        ],
      },
      faq: {
        id: 'faq',
        faqs: [
          ...
          { q: 'MacでLlama 3.3 405Bを実行できますか？', a: '従来世代のMacでは不可能です。Llama 3.3 405BはQ4量子化でも200GB以上必要です。Appleが2026年8月25日に発表したMac Studio M5 Ultra（出荷は2026年9月22日から、512GB構成は2026年10月下旬出荷）は最大512GBのユニファイドメモリを5,499ドルから搭載しており、コンシューマー向けApple製ハードウェアとして初めてQ4量子化で405Bを実行できる余裕があります。' },
          ...
          { q: '実際に役立つ最小のモデルは何ですか？', a: 'Phi-4（3.8Bパラメータ）。MMPUで84.8を獲得 — 2024年の一部の8Bモデルと同等。チャットやQ&Aでは驚くほど有能です。コーディングや複雑な推論はLlama 3.1 8Bや[Qwen3 14B](/ja/local-llms/qwen-vs-llama-vs-mistral)に進んでください。' },
          { q: 'vLLMはApple Siliconで動作しますか？', a: 'vLLMのMetalサポートはCUDAパスに比べて限定的です — vLLMをNvidia GPUで魅力的にしているスループットやバッチ処理の最適化は、Macにはほとんど当てはまりません。Apple SiliconではOllama（llama.cpp/Metal）やLM Studio（GGUF/MLX）の方がシングルユーザーのtok/sが高く、セットアップも簡単です。vLLMを検討すべきは、MacとあわせてLinux/NvidiaマシンでLLMを提供し、多数の同時リクエストを処理する場合のみです。' },
          { q: 'MacBook Air M5では何が実行できますか？', a: 'MacBook Air M5はファンレス設計で、ユニファイドメモリは通常16〜32GB — 上記の表では16GBまたは36GBティアのMacとして扱ってください：Phi-4は快適に動作し、24GB以上あればLlama 3.1 8B Q8も可能です。ファンがないため、長時間の連続生成ではわずかにスロットリングする可能性があります — この記事のM5 Pro tok/s範囲の下限を目安にしてください。' },
          { q: '128GB RAMを搭載したMacBook Pro M5 Maxに最適な構成は？', a: '日常使いにはLlama 3.3 70B Q5（49 GB）。`OLLAMA_MAX_LOADED_MODELS=2`で2つ目のモデル — Qwen3 14B Q5またはDeepSeek Coder V2 16B — を同時にロードする余裕もあります。70B Q5では約14〜18 tok/sが目安です。最高品質を求め、約9〜12 tok/sを許容できるならLlama 3.3 70B Q8（74 GB）も収まります。' },
        ],
      },
    },
  ...
  zh: {
    ...
    specific_year: 2026,
    theme: 'Hardware & Performance',
    title: 'Apple Silicon最佳Ollama模型2026：16GB、36GB、64GB、128GB推荐',
    seoTitle: 'Apple Silicon 2026最佳Ollama模型：16GB–128GB',
    intro: '适用于每款Apple Silicon Mac的最佳本地LLM模型推荐。16GB（Phi-4）、36GB（Llama 3.1 8B）、64GB（Qwen2 34B）、128GB（Llama 3.3 70B）的具体模型选择，附M5 Pro/Max的tok/s数据。',
    metaDescription: 'Apple Silicon最佳Ollama模型：Phi-4（16GB）、Llama 8B（36GB）、Qwen 34B（64GB）、Llama 70B（128GB）推荐选择。Token/秒速度对比、量化方式、升级时机指南。',
    heroImage: '/images/best-models-apple-silicon-2026-by-tier-hero-zh.webp',
    twitterDescription: '你的Mac最佳Ollama模型：16GB→Phi-4，36GB→Llama 8B，64GB→Qwen 34B，128GB→Llama 70B。2026年M5实测。',
    publishDate: '2026-05-15',
    dateModified: '2026-08-27',
    current_models_mentioned: ['Phi-4', 'Llama 3.1 8B', 'Qwen3 14B', 'Qwen3 34B', 'Mistral 8x7B', 'Llama 3.3 70B'],
    current_hardware_mentioned: ['M5 Pro', 'M5 Max', 'M6', 'M5 Ultra'],
    ...
    leadAnswerBlock: '**16GB：Phi-4。36GB：Llama 3.1 8B Q8（约38 tok/s）。64GB：Qwen3 34B Q5（约18 tok/s）。128GB：Llama 3.3 70B Q5（约14 tok/s M5 Pro，约16 tok/s M5 Max）。全部通过Metal上的Ollama运行。**',
    quickAnswerTop: {
      en: { question: '', answer: '', bullets: [], updatedDate: '2026-05-15' },
      de: { question: '', answer: '', bullets: [], updatedDate: '2026-05-15' },
      fr: { question: '', answer: '', bullets: [], updatedDate: '2026-05-15' },
      ...
      zh: {
        ...
        answer: '16GB → Phi-4。36GB → Llama 3.1 8B或Qwen3 14B。64GB → Qwen3 34B。128GB → Llama 3.3 70B。性能：M5 Pro上30–40 tok/s（8B）、15–20 tok/s（34B）、12–18 tok/s（70B）。',
        bullets: ['16GB：Phi-4 3.8B', '36GB：Llama 3.1 8B Q8（38 tok/s）', '64GB：Qwen3 34B Q5（18 tok/s）', '128GB：Llama 3.3 70B Q5（14–16 tok/s）', '使用量化：Q4/Q5是标准', '全部通过Ollama获取'],
        updatedDate: '2026-05-15',
      },
    },
    toc: [
    ...
    sections: {
      byTier: {
        id: 'by-tier',
        title: '按Mac内存的最佳模型推荐',
        content: '最后验证：2026-08-27。苹果于2026年8月25日发布的更新：Mac mini现提供M6（最高32GB，起价$899）和M5 Pro（最高64GB，起价$1,699）配置；Mac Studio提供M5 Max（最高128GB，起价$2,499）和M5 Ultra（最高512GB，起价$5,499）配置。均于2026年9月22日开始发货（512GB配置于2026年10月下旬发货）。随着新模型发布，推荐可能会变化。每季度更新此页面。',
        ...
        rows: [
          ...
          { '内存': '36 GB', '主要推荐': 'Llama 3.1 8B', '量化': 'Q8', '大小': '8.5 GB', 'M5 Pro tok/s': '38–45', 'M5 Max tok/s': '75–85', '备选': 'Qwen3 14B Q4（8.5 GB）' },
        ...
        note: '大小为GGUF格式。MLX 4位等效版本可比。36GB档位对应的是MacBook Pro M-Pro/M-Max的入门配置，而非Mac mini或Mac Studio——自2026年8月更新以来，Mac mini和Mac Studio已从32GB直接跳到64GB。',
        image: '/images/best-models-apple-silicon-2026-by-tier-hero-zh.webp',
        imageCaption: '按Mac内存档位划分的最佳模型 -- 每季度更新——最后验证于2026年8月',
      },
      qualityBenchmarks: {
        id: 'quality-benchmarks',
        ...
        image: '/images/best-models-apple-silicon-2026-quality-benchmarks-hero-zh.webp',
        imageCaption: '模型质量基准测试（2026年） -- MMLU与平均分',
      },
      byUsecase: {
        id: 'by-usecase',
        title: '按用例的最佳模型（2026）',
        ...
        rows: [
          { '用例': '编程（通用）', '36GB Mac最佳': 'Llama 3.1 8B', '64GB Mac最佳': 'DeepSeek Coder V2 16B', '128GB Mac最佳': 'Llama 3.3 70B' },
          { '用例': '编程（Python）', '36GB Mac最佳': 'DeepSeek Coder V2 Lite', '64GB Mac最佳': 'DeepSeek Coder V2 16B', '128GB Mac最佳': 'DeepSeek Coder V2 236B' },
          { '用例': '长文写作', '36GB Mac最佳': 'Llama 3.1 8B Q8', '64GB Mac最佳': 'Qwen3 34B Q5', '128GB Mac最佳': 'Llama 3.3 70B Q5' },
          ...
          { '用例': 'RAG/问答', '36GB Mac最佳': 'Llama 3.1 8B + nomic-embed', '64GB Mac最佳': '[Llama 3.1 8B](/zh/power-local-llm/local-rag-for-private-business-data) + bge-large', '128GB Mac最佳': 'Llama 3.3 70B + bge-large' },
          ...
          { '用例': '摘要', '36GB Mac最佳': 'Llama 3.1 8B', '64GB Mac最佳': 'Qwen3 34B', '128GB Mac最佳': 'Llama 3.3 70B' },
      ...
      avoid: {
        ...
        callouts: [
          { type: 'warning', text: '**Llama 2（任何尺寸）不再推荐** — 已被Llama 3.3取代；标准排行榜显示与新版本相比结果明显较弱。仍出现在旧教程中——不要遵循它们。替代：Llama 3.1 8B。' },
          { type: 'warning', text: '**避免Vicuna、Alpaca、WizardLM** — 2023年的社区微调版本。现代基础模型（Llama 3.3、Qwen3）已达到或超过其性能。替代：Qwen3 14B或Llama 3.1 8B。' },
          ...
          { type: 'warning', text: '**对近期开发活动较少的模型保持谨慎** — StableLM、RedPajama、MPT、Pythia：近期提交活动较少（截至2026年中）。使用Meta、阿里巴巴、Mistral、微软的定期更新模型。' },
        ],
      },
      formatReference: {
        id: 'format-reference',
        ...
        note: '本文中的大小为GGUF Q4_K_M，除非另有说明。MLX 4位等效大小类似。确切字节数请查看HuggingFace上的模型卡。llama.cpp直接在Metal后端运行GGUF，Ollama底层正是使用它——MLX是苹果自家的框架，在同一芯片上运行MLX原生构建版本时往往更快。LM Studio同时支持GGUF和MLX，可在其界面中按模型切换后端。',
      },
      downloadGuide: {
        id: 'download-guide',
        title: '快速参考：下载这些模型',
...
ollama pull aya-expanse:32b         # 翻译`,
        codeLanguage: 'bash',
        note: '每个模型几GB。多个模型的总磁盘空间可达50–100 GB。用`du -sh ~/.ollama/`检查使用量。LM Studio用户也可以直接通过其内置模型浏览器下载相同的GGUF或MLX权重，无需使用命令行。',
      },
      relatedArticles: {
        id: 'related-articles',
        title: '相关文章',
        items: [
          ...
          '[Apple的本地AI与真正的本地LLM：WWDC 2026到底改变了什么](/zh/local-llms/apple-on-device-ai-vs-local-llms) -- Apple on-device AI vs local LLMs',
        ],
      },
      faq: {
        id: 'faq',
        faqs: [
          ...
          { q: '我可以在Mac上运行Llama 3.3 405B吗？', a: '上一代Mac不行。即使在Q4量化下，Llama 3.3 405B也需要200GB以上内存。苹果于2026年8月25日发布的Mac Studio M5 Ultra（2026年9月22日开始发货，512GB配置于2026年10月下旬发货）提供最高512GB统一内存，起价$5,499——这是消费级苹果硬件首次有足够空间以Q4量化运行405B。' },
          ...
          { q: '实际有用的最小模型是什么？', a: 'Phi-4，3.8B参数。MMLU得分84.8——与2024年的一些8B模型相当。对于聊天和问答出乎意料地强大。编程或复杂推理请选择Llama 3.1 8B或[Qwen3 14B](/zh/local-llms/qwen-vs-llama-vs-mistral)。' },
          { q: 'vLLM能在Apple Silicon上运行吗？', a: '与CUDA路径相比，vLLM的Metal支持有限——使其在Nvidia GPU上具有吸引力的吞吐量和批处理优化，大多不适用于Mac。对于Apple Silicon，Ollama（llama.cpp/Metal）或LM Studio（GGUF/MLX）能提供更好的单用户tok/s表现和更简单的设置。只有当你需要在Mac之外的Linux/Nvidia主机上同时处理大量并发请求时，才考虑使用vLLM。' },
          { q: 'MacBook Air M5能运行什么模型？', a: 'MacBook Air M5采用无风扇设计，统一内存通常为16–32 GB，因此可将其视为上表中的16GB或36GB档位Mac：Phi-4可轻松运行，若配置24GB以上则可运行Llama 3.1 8B Q8。由于没有风扇散热，长时间持续生成可能会略微降频——预计性能处于本文M5 Pro tok/s区间的下限。' },
          { q: '配备128GB内存的MacBook Pro M5 Max最佳配置是什么？', a: '日常使用推荐Llama 3.3 70B Q5（49 GB），并留有余量通过`OLLAMA_MAX_LOADED_MODELS=2`同时加载第二个模型——Qwen3 14B Q5或DeepSeek Coder V2 16B。70B Q5预计可达约14–18 tok/s。如果追求最高质量且能接受约9–12 tok/s，Llama 3.3 70B Q8（74 GB）同样适配。' },
        ],
      },
    },
  ...
  ko: {
    ...
    specific_year: 2026,
    theme: '하드웨어 & 성능',
    title: 'Apple Silicon 최적 Ollama 모델 2026: 16GB, 36GB, 64GB, 128GB별 추천',
    seoTitle: 'Apple Silicon 최적 Ollama 모델 2026: 16GB~128GB',
    intro: 'Apple Silicon Mac 메모리 용량별 로컬 LLM 모델 추천입니다. 16GB(Phi-4), 36GB(Llama 3.1 8B), 64GB(Qwen2 34B), 128GB(Llama 3.3 70B)에 대한 구체적인 모델 선택과 M5 Pro/Max에서의 tok/s 성능 수치를 제공합니다.',
    metaDescription: 'Apple Silicon 최적 Ollama 모델: Phi-4(16GB), Llama 8B(36GB), Qwen 34B(64GB), Llama 70B(128GB). Tok/s 속도, 양자화, 업그레이드 시점 안내.',
    heroImage: '/images/best-models-apple-silicon-2026-by-tier-hero-ko.webp',
    twitterDescription: 'Mac용 최적 Ollama 모델: 16GB→Phi-4, 36GB→Llama 8B, 64GB→Qwen 34B, 128GB→Llama 70B. M5 2026에서 테스트 완료.',
    publishDate: '2026-05-15',
    dateModified: '2026-08-27',
    current_models_mentioned: ['Phi-4', 'Llama 3.1 8B', 'Qwen3 14B', 'Qwen3 34B', 'Mistral 8x7B', 'Llama 3.3 70B'],
    current_hardware_mentioned: ['M5 Pro', 'M5 Max', 'M6', 'M5 Ultra'],
    ...
    leadAnswerBlock: '**16GB: Phi-4. 36GB: Llama 3.1 8B Q8 (~38 tok/s). 64GB: Qwen3 34B Q5 (~18 tok/s). 128GB: Llama 3.3 70B Q5 (~14 tok/s M5 Pro, ~16 tok/s M5 Max). 모두 Metal 기반 Ollama를 통해 실행됩니다.**',
    quickAnswerTop: {
      en: {
        question: 'Mac에서 어떤 LLM 모델을 실행해야 합니까?',
        answer: '16GB → Phi-4. 36GB → Llama 3.1 8B 또는 Qwen3 14B. 64GB → Qwen3 34B. 128GB → Llama 3.3 70B. M5 Pro 기준 성능: 30~40 tok/s(8B), 15~20 tok/s(34B), 12~18 tok/s(70B).',
        bullets: ['16GB: Phi-4 3.8B', '36GB: Llama 3.1 8B Q8 (38 tok/s)', '64GB: Qwen3 34B Q5 (18 tok/s)', '128GB: Llama 3.3 70B Q5 (14~16 tok/s)', '양자화 활용: Q4/Q5가 표준', '모두 Ollama에서 이용 가능'],
        updatedDate: '2026-05-15',
      },
      de: { question: '', answer: '', bullets: [], updatedDate: '2026-05-15' },
      fr: { question: '', answer: '', bullets: [], updatedDate: '2026-05-15' },
      ...
      ko: {
        question: 'Mac에서 어떤 LLM 모델을 실행해야 합니까?',
        answer: '16GB → Phi-4. 36GB → Llama 3.1 8B 또는 Qwen3 14B. 64GB → Qwen3 34B. 128GB → Llama 3.3 70B. M5 Pro 기준 성능: 30~40 tok/s(8B), 15~20 tok/s(34B), 12~18 tok/s(70B).',
        bullets: ['16GB: Phi-4 3.8B', '36GB: Llama 3.1 8B Q8 (38 tok/s)', '64GB: Qwen3 34B Q5 (18 tok/s)', '128GB: Llama 3.3 70B Q5 (14~16 tok/s)', '양자화 활용: Q4/Q5가 표준입니다', '모두 Ollama를 통해 이용 가능합니다'],
        updatedDate: '2026-05-15',
      },
    },
    toc: [
    ...
    sections: {
      byTier: {
        ...
        content: '최종 검증: 2026-08-27. Apple의 2026년 8월 25일 라인업 개편: Mac mini는 M6(최대 32GB, $899부터)와 M5 Pro(최대 64GB, $1,699부터) 구성으로, Mac Studio는 M5 Max(최대 128GB, $2,499부터)와 M5 Ultra(최대 512GB, $5,499부터) 구성으로 제공됩니다. 모든 모델은 2026년 9월 22일부터 출시되며(512GB 구성은 2026년 10월 말 출시), 새로운 모델 출시에 따라 추천 모델이 변경될 수 있습니다. 이 페이지는 분기별로 업데이트됩니다.',
        columns: ['메모리', '주요 추천', '양자화', '크기', 'M5 Pro tok/s', 'M5 Max tok/s', '대안'],
        rows: [
          { '메모리': '16 GB', '주요 추천': 'Phi-4', '양자화': 'Q4_K_M', '크기': '2.5 GB', 'M5 Pro tok/s': '60–70', 'M5 Max tok/s': '110–130', '대안': 'Llama 3.1 8B Q4 (여유 없음)' },
          { '메모리': '36 GB', '주요 추천': 'Llama 3.1 8B', '양자화': 'Q8', '크기': '8.5 GB', 'M5 Pro tok/s': '38–45', 'M5 Max tok/s': '75–85', '대안': 'Qwen3 14B Q4 (8.5 GB)' },
        ...
        note: '크기는 GGUF 형식 기준입니다. MLX 4비트 동등 모델은 비슷한 크기입니다. 36GB 등급은 Mac mini나 Mac Studio가 아니라 MacBook Pro M-Pro/M-Max 기본 구성에 해당합니다 — 2026년 8월 라인업 개편 이후 Mac mini와 Mac Studio는 32GB에서 바로 64GB로 건너뜁니다.',
        image: '/images/best-models-apple-silicon-2026-by-tier-hero-ko.webp',
        imageCaption: 'Mac 메모리 등급별 최적 모델 -- 분기별 업데이트 — 마지막 확인 2026년 8월',
      },
      qualityBenchmarks: {
        id: 'quality-benchmarks',
        ...
        rows: [
          ...
          { '모델': 'Llama 3.1 8B', 'MMLU': '73.0', 'HumanEval': '72.6', 'GSM8K': '84.5', '평균': '76.7', '비고': '안정적인 범용 모델' },
        ...
        image: '/images/best-models-apple-silicon-2026-quality-benchmarks-hero-ko.webp',
        imageCaption: '모델 품질 벤치마크 (2026) -- MMLU 및 평균 점수',
      },
      byUsecase: {
        id: 'by-usecase',
        ...
        rows: [
          { '사용 사례': '코딩 (일반)', '36GB Mac 최적': 'Llama 3.1 8B', '64GB Mac 최적': 'DeepSeek Coder V2 16B', '128GB Mac 최적': 'Llama 3.3 70B' },
          { '사용 사례': '코딩 (Python)', '36GB Mac 최적': 'DeepSeek Coder V2 Lite', '64GB Mac 최적': 'DeepSeek Coder V2 16B', '128GB Mac 최적': 'DeepSeek Coder V2 236B' },
          { '사용 사례': '장문 글쓰기', '36GB Mac 최적': 'Llama 3.1 8B Q8', '64GB Mac 최적': 'Qwen3 34B Q5', '128GB Mac 최적': 'Llama 3.3 70B Q5' },
          ...
          { '사용 사례': 'RAG / Q&A', '36GB Mac 최적': 'Llama 3.1 8B + nomic-embed', '64GB Mac 최적': '[Llama 3.1 8B](/power-local-llm/local-rag-for-private-business-data) + bge-large', '128GB Mac 최적': 'Llama 3.3 70B + bge-large' },
          ...
          { '사용 사례': '요약', '36GB Mac 최적': 'Llama 3.1 8B', '64GB Mac 최적': 'Qwen3 34B', '128GB Mac 최적': 'Llama 3.3 70B' },
      ...
      avoid: {
        ...
        callouts: [
          { type: 'warning', text: '**Llama 2 (모든 크기) 사용 금지** — Llama 3.3로 대체됨. 동일 파라미터 수 대비 품질이 30~50% 낮음. 구형 튜토리얼에 여전히 등장하므로 따르지 마십시오. 대체 모델: Llama 3.1 8B.' },
          { type: 'warning', text: '**Vicuna, Alpaca, WizardLM 사용 금지** — 2023년대 커뮤니티 파인튜닝 모델. 현재 베이스 모델(Llama 3.3, Qwen3)이 이미 동등하거나 우수한 성능을 발휘합니다. 대체 모델: Qwen3 14B 또는 Llama 3.1 8B.' },
          ...
          { type: 'warning', text: '**최근 개발 활동이 적은 모델 주의 필요** — StableLM, RedPajama, MPT, Pythia: 최근 커밋 활동이 적음 (2026년 중반 기준). 정기 업데이트를 제공하는 Meta, Alibaba, Mistral, Microsoft의 모델을 사용하십시오.' },
        ],
      },
      formatReference: {
        id: 'format-reference',
        ...
        note: '이 문서의 크기는 별도 명시가 없는 한 GGUF Q4_K_M 기준입니다. MLX 4비트 동등 모델은 크기가 비슷합니다. 정확한 바이트 수는 HuggingFace의 모델 카드를 확인하십시오. llama.cpp는 Metal 백엔드에서 GGUF를 직접 실행하며, Ollama가 내부적으로 사용하는 방식이 바로 이것입니다 — MLX는 Apple 자체 프레임워크로, 동일 칩에서 MLX 전용 빌드를 실행할 때 더 빠른 경향이 있습니다. LM Studio는 GGUF와 MLX를 모두 지원하며 UI에서 모델별로 백엔드를 전환할 수 있습니다.',
      },
      downloadGuide: {
        id: 'download-guide',
...
ollama pull aya-expanse:32b         # 번역`,
        codeLanguage: 'bash',
        note: '각 모델은 수 GB 크기입니다. 여러 모델을 보유할 경우 총 디스크 사용량이 50~100 GB에 달할 수 있습니다. `du -sh ~/.ollama/`로 사용량을 확인하십시오. LM Studio 사용자는 CLI 대신 앱 내 모델 브라우저에서 동일한 GGUF 또는 MLX 가중치를 직접 받을 수 있습니다.',
      },
      relatedArticles: {
        id: 'related-articles',
        title: '관련 문서',
        items: [
          ...
          '[Apple 온디바이스 AI vs 실제 로컬 LLM: WWDC 2026이 실제로 바꾼 것](/ko/local-llms/apple-on-device-ai-vs-local-llms) -- Apple on-device AI vs local LLMs',
        ],
      },
      faq: {
        id: 'faq',
        faqs: [
          ...
          { q: '초보자에게 가장 좋은 모델은 무엇입니까?', a: 'Llama 3.1 8B입니다. 광범위하게 제공되며 출력 품질이 우수하고 검증된 실적을 보유하고 있습니다. M1 이상의 모든 Mac에서 실행됩니다.' },
          ...
          { q: 'Mac에서 Llama 3.3 405B를 실행할 수 있습니까?', a: '이전 세대 Mac에서는 불가능합니다. Llama 3.3 405B는 Q4 양자화에서도 200GB 이상이 필요합니다. 2026년 8월 25일 발표된 Apple의 Mac Studio M5 Ultra(2026년 9월 22일 출시 시작, 512GB 구성은 2026년 10월 말 출시)는 최대 512GB의 통합 메모리를 $5,499부터 제공하며, 소비자용 Apple 하드웨어 최초로 Q4 양자화로 405B를 실행할 수 있는 여유를 확보했습니다.' },
          ...
          { q: '실제로 유용한 최소 모델은 무엇입니까?', a: '파라미터 3.8B의 Phi-4입니다. MMLU 점수 84.8로 일부 2024년 8B 모델에 필적합니다. 채팅과 Q&A에서 놀랍도록 유능합니다. 코딩이나 복잡한 추론에는 Llama 3.1 8B 또는 [Qwen3 14B](/local-llms/qwen-vs-llama-vs-mistral)로 이동하십시오.' },
          { q: 'vLLM이 Apple Silicon에서 실행됩니까?', a: 'vLLM의 Metal 지원은 CUDA 경로에 비해 제한적입니다 — Nvidia GPU에서 vLLM을 매력적으로 만드는 처리량 및 배칭 최적화가 Mac에서는 대부분 적용되지 않습니다. Apple Silicon에서는 Ollama(llama.cpp/Metal) 또는 LM Studio(GGUF/MLX)가 단일 사용자 기준 더 나은 tok/s와 더 쉬운 설정을 제공합니다. vLLM은 Mac과 함께 Linux/Nvidia 서버에서 많은 동시 요청을 처리해야 하는 경우에만 고려하십시오.' },
          { q: 'MacBook Air M5는 어떤 모델을 실행할 수 있습니까?', a: 'MacBook Air M5는 팬리스 설계이며 일반적으로 16~32 GB의 통합 메모리를 탑재하므로, 위 표의 16GB 또는 36GB 등급 Mac으로 취급하십시오: Phi-4는 여유롭게 실행되며, 24GB 이상이면 Llama 3.1 8B Q8도 가능합니다. 팬이 없어 장시간 생성 시 성능이 약간 저하될 수 있으므로 이 문서의 M5 Pro tok/s 범위 중 낮은 쪽을 예상하십시오.' },
          { q: '128GB RAM MacBook Pro M5 Max에 가장 적합한 구성은 무엇입니까?', a: '일상 사용에는 Llama 3.3 70B Q5(49 GB)를 추천하며, `OLLAMA_MAX_LOADED_MODELS=2`를 통해 Qwen3 14B Q5 또는 DeepSeek Coder V2 16B와 같은 두 번째 모델을 동시에 로드할 여유가 있습니다. 70B Q5에서 약 14~18 tok/s를 예상할 수 있습니다. 최고 품질을 원하고 약 9~12 tok/s를 감내할 수 있다면 Llama 3.3 70B Q8(74 GB)도 탑재 가능합니다.' },
        ],
      },
    },
