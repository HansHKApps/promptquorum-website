...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    current_models_mentioned: ['Phi-4', 'Llama 3.3 8B', 'Qwen2.5 14B', 'Qwen2.5 34B', 'Mistral 8x7B', 'Llama 3.3 70B'],
    ...
    leadAnswerBlock: '**16GB: Phi-4. 36GB: Llama 3.3 8B Q8 (~38 tok/s). 64GB: Qwen2.5 34B Q5 (~18 tok/s). 128GB: Llama 3.3 70B Q5 (~14 tok/s M5 Pro, ~16 tok/s M5 Max). All run via Ollama on Metal.**',
    quickAnswerTop: {
      en: {
        question: 'Which LLM model should I run on my Mac?',
        answer: '16GB → Phi-4. 36GB → Llama 3.3 8B or Qwen2.5 14B. 64GB → Qwen2.5 34B. 128GB → Llama 3.3 70B. Performance: 30-40 tok/s (8B), 15-20 tok/s (34B), 12-18 tok/s (70B) on M5 Pro.',
        bullets: ['16GB: Phi-4 3.8B', '36GB: Llama 3.3 8B Q8 (38 tok/s)', '64GB: Qwen2.5 34B Q5 (18 tok/s)', '128GB: Llama 3.3 70B Q5 (14–16 tok/s)', 'Use quantization: Q4/Q5 are standard', 'All available via Ollama'],
    ...
    sections: {
      byTier: {
        ...
        rows: [
          ...
          { 'Memory': '36 GB', 'Primary Pick': 'Llama 3.3 8B', 'Quantization': 'Q8', 'Size': '8.5 GB', 'M5 Pro tok/s': '38–45', 'M5 Max tok/s': '75–85', 'Alternative': 'Qwen2.5 14B Q4 (8.5 GB)' },
          { 'Memory': '48 GB', 'Primary Pick': 'Qwen2.5 14B', 'Quantization': 'Q8', 'Size': '16 GB', 'M5 Pro tok/s': '25–30', 'M5 Max tok/s': '50–60', 'Alternative': 'Mixtral 8x22B Q4 (26 GB)' },
          { 'Memory': '64 GB', 'Primary Pick': 'Qwen2.5 34B', 'Quantization': 'Q5', 'Size': '24 GB', 'M5 Pro tok/s': '18–22', 'M5 Max tok/s': '35–42', 'Alternative': 'Mixtral 8x22B Q5 (32 GB)' },
          { 'Memory': '96 GB', 'Primary Pick': 'Llama 3.3 70B', 'Quantization': 'Q4', 'Size': '42 GB', 'M5 Pro tok/s': '10–13', 'M5 Max tok/s': '20–25', 'Alternative': 'Qwen2.5 72B Q4 (44 GB)' },
          { 'Memory': '128 GB', 'Primary Pick': 'Llama 3.3 70B', 'Quantization': 'Q5', 'Size': '49 GB', 'M5 Pro tok/s': '8–11', 'M5 Max tok/s': '14–18', 'Alternative': 'Qwen2.5 72B Q5 (51 GB)' },
      ...
      qualityBenchmarks: {
        ...
        note: 'Qwen2.5 72B on a 128GB Mac approaches GPT-5.5 quality at zero ongoing cost. This is the most important development in local AI in 2026.',
      },
      byUsecase: {
        id: 'by-usecase',
        ...
        rows: [
          ...
          { 'Use Case': 'Long-form writing', 'Best for 36GB Mac': 'Llama 3.3 8B Q8', 'Best for 64GB Mac': 'Qwen2.5 34B Q5', 'Best for 128GB Mac': 'Llama 3.3 70B Q5' },
          ...
          { 'Use Case': 'Summarization', 'Best for 36GB Mac': 'Llama 3.3 8B', 'Best for 64GB Mac': 'Qwen2.5 34B', 'Best for 128GB Mac': 'Llama 3.3 70B' },
      ...
      avoid: {
        ...
        callouts: [
          ...
          { type: 'warning', text: '**Avoid Vicuna, Alpaca, WizardLM** — 2023-era community fine-tunes. Modern base models (Llama 3.3, Qwen2.5) already match or exceed their performance. Replace with: Qwen2.5 14B or Llama 3.3 8B.' },
...
ollama pull aya-expanse:32b         # translation`,
      ...
      faq: {
        ...
        faqs: [
          ...
          { q: 'What is the best local LLM in 2026?', a: 'For most users on Apple Silicon: Qwen2.5 (any size that fits your Mac) currently leads on quality benchmarks. Llama 3.3 70B is comparable for 128GB Macs. For under 16GB: [Phi-4](/local-llms/llm-quantization-explained) punches above its weight at 3.8B parameters, matching 8B models from 2024.' },
          ...
          { q: 'Is Qwen better than Llama for local use?', a: 'For most tasks, Qwen2.5 slightly beats Llama 3.3 at the same parameter count on benchmarks (1–3 points on MMLU). Llama has wider community support and more fine-tunes available. Most users will not notice the difference — pick based on availability and fine-tune ecosystem.' },
          { q: 'What is the smallest model that is actually useful?', a: 'Phi-4 at 3.8B parameters. It scores 84.8 on MMLU — matching some 8B models from 2024. For chat and Q&A it is surprisingly capable. For coding or complex reasoning, jump to Llama 3.3 8B or [Qwen2.5 14B](/local-llms/qwen-vs-llama-vs-mistral).' },
        ],
      },
    },
...
ollama pull aya-expanse:32b         # traducción`,
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/es/local-llms/best-models-apple-silicon-2026?lang=es',
      inLanguage: 'es',
