...
ollama pull aya-expanse:32b         # translation`,
  ...
  de: {
    ...
    seoTitle: 'Beste lokale LLM-Modelle für Apple Silicon 2026: Empfehlungen 16 GB 36 GB 64 GB 128 GB',
    ...
    metaDescription: 'Beste LLM-Modelle für Apple Silicon: Empfehlungen für 16 GB, 36 GB, 64 GB, 128 GB Mac mit konkreten Modellnamen und tok/s-Geschwindigkeiten.',
    ...
    sections: {
      ...
      byUsecase: {
        ...
        rows: [
          ...
          { 'Anwendungsfall': 'RAG / Frage & Antwort', 'Bestes für 36-GB-Mac': 'Llama 3.1 8B + nomic-embed', 'Bestes für 64-GB-Mac': '[Llama 3.1 8B](/local-llms/local-rag-for-private-business-data?lang=de) + bge-large', 'Bestes für 128-GB-Mac': 'Llama 3.1 70B + bge-large' },
          { 'Anwendungsfall': 'Vision / Multimodal', 'Bestes für 36-GB-Mac': 'LLaVA 7B', 'Bestes für 64-GB-Mac': '[Llama 3.2 Vision 11B](/power-local-llm/local-vision-models-llava-ollama-2026?lang=de)', 'Bestes für 128-GB-Mac': 'Llama 3.2 Vision 90B' },
      ...
      avoid: {
        ...
        callouts: [
          ...
          { type: 'warning', text: '**Falcon 180B vermeiden** — Passt nicht auf Consumer-Apple-Silicon. [Llama 3.1 70B](/local-llms/running-70b-models-apple-silicon-m5-max?lang=de) (kleiner) übertrifft es. Ersetzen durch: Llama 3.1 70B Q5.' },
          { type: 'warning', text: '**FP16-Quantisierung auf Consumer-Hardware vermeiden** — Llama 3.1 70B FP16 = 140 GB, passt auf keinen Mac. Qualitätsgewinn gegenüber Q5 ist unter 1%. Ersetzen durch: [Q4_K_M oder Q5_K_M](/local-llms/llm-quantization-explained?lang=de).' },
      ...
      formatReference: {
        ...
        rows: [
          { 'Format': 'GGUF Q4_K_M', 'Verwendet von': '[Ollama](/local-llms/ollama-on-mac-apple-silicon-setup-2026?lang=de), llama.cpp', 'Größe vs. Original': '~30% von FP16' },
          { 'Format': 'GGUF Q5_K_M', 'Verwendet von': '[Ollama](/local-llms/ollama-on-mac-apple-silicon-setup-2026?lang=de), llama.cpp', 'Größe vs. Original': '~35% von FP16' },
          { 'Format': 'GGUF Q8_0', 'Verwendet von': '[Ollama](/local-llms/ollama-on-mac-apple-silicon-setup-2026?lang=de), llama.cpp', 'Größe vs. Original': '~50% von FP16' },
...
ollama pull aya-expanse:32b         # Übersetzung`,
      ...
      relatedArticles: {
        ...
        items: [
          ...
          '[Ollama auf Mac Setup-Anleitung](/local-llms/ollama-on-mac-apple-silicon-setup-2026?lang=de)',
          ...
          '[Qwen vs Llama vs Mistral Vergleich](/local-llms/qwen-vs-llama-vs-mistral?lang=de)',
        ],
      },
      faq: {
        id: 'faq',
  ...
  fr: {
    ...
    seoTitle: 'Meilleurs LLM locaux Apple Silicon 2026 : Recommandations 16 Go 36 Go 64 Go 128 Go',
    ...
    metaDescription: 'Meilleurs modèles LLM pour Apple Silicon : recommandations pour Mac 16 Go, 36 Go, 64 Go, 128 Go avec noms de modèles et vitesses tok/s.',
    ...
    sections: {
      ...
      byUsecase: {
        ...
        rows: [
          ...
          { 'Cas d\'usage': 'RAG / Q&R', 'Meilleur pour Mac 36 Go': 'Llama 3.1 8B + nomic-embed', 'Meilleur pour Mac 64 Go': '[Llama 3.1 8B](/local-llms/local-rag-for-private-business-data?lang=fr) + bge-large', 'Meilleur pour Mac 128 Go': 'Llama 3.1 70B + bge-large' },
          { 'Cas d\'usage': 'Vision / multimodal', 'Meilleur pour Mac 36 Go': 'LLaVA 7B', 'Meilleur pour Mac 64 Go': '[Llama 3.2 Vision 11B](/power-local-llm/local-vision-models-llava-ollama-2026?lang=fr)', 'Meilleur pour Mac 128 Go': 'Llama 3.2 Vision 90B' },
      ...
      avoid: {
        ...
        callouts: [
          ...
          { type: 'warning', text: '**Éviter Falcon 180B** — Ne tient pas sur Apple Silicon grand public. [Llama 3.1 70B](/local-llms/running-70b-models-apple-silicon-m5-max?lang=fr) (plus petit) le surpasse. Remplacer par : Llama 3.1 70B Q5.' },
          { type: 'warning', text: '**Éviter la quantification FP16 sur matériel grand public** — Llama 3.1 70B FP16 = 140 Go, ne tient sur aucun Mac. Le gain de qualité par rapport à Q5 est inférieur à 1%. Remplacer par : [Q4_K_M ou Q5_K_M](/local-llms/llm-quantization-explained?lang=fr).' },
      ...
      formatReference: {
        ...
        rows: [
          { 'Format': 'GGUF Q4_K_M', 'Utilisé par': '[Ollama](/local-llms/ollama-on-mac-apple-silicon-setup-2026?lang=fr), llama.cpp', 'Taille vs original': '~30% de FP16' },
          { 'Format': 'GGUF Q5_K_M', 'Utilisé par': '[Ollama](/local-llms/ollama-on-mac-apple-silicon-setup-2026?lang=fr), llama.cpp', 'Taille vs original': '~35% de FP16' },
          { 'Format': 'GGUF Q8_0', 'Utilisé par': '[Ollama](/local-llms/ollama-on-mac-apple-silicon-setup-2026?lang=fr), llama.cpp', 'Taille vs original': '~50% de FP16' },
...
ollama pull aya-expanse:32b         # traduction`,
      ...
      relatedArticles: {
        ...
        items: [
          ...
          '[Guide d\'installation Ollama sur Mac](/local-llms/ollama-on-mac-apple-silicon-setup-2026?lang=fr)',
          '[Exécuter des modèles 70B sur Apple Silicon](/local-llms/running-70b-models-apple-silicon-m5-max?lang=fr)',
          '[La quantification LLM expliquée](/local-llms/llm-quantization-explained?lang=fr)',
          '[Comparaison Qwen vs Llama vs Mistral](/local-llms/qwen-vs-llama-vs-mistral?lang=fr)',
        ],
      },
      faq: {
        id: 'faq',
        faqs: [
          ...
          { q: 'Quel est le plus petit modèle vraiment utile ?', a: 'Phi-4 à 3,8B paramètres. Il obtient 84,8 sur MMLU — équivalent à certains modèles 8B de 2024. Pour le chat et les Q&R, il est étonnamment capable. Pour la programmation ou le raisonnement complexe, passer à Llama 3.1 8B ou [Qwen2.5 14B](/local-llms/qwen-vs-llama-vs-mistral?lang=fr).' },
        ],
      },
    },
  ...
  ja: {
    ...
    seoTitle: 'Apple Silicon向けベストローカルLLM 2026：推奨モデル16GB 36GB 64GB 128GB',
    ...
    metaDescription: 'Apple Silicon向けベストLLMモデル：16GB、36GB、64GB、128GB Macの推奨モデル名とtok/s速度。',
    ...
    sections: {
      ...
      byUsecase: {
        ...
        rows: [
          ...
          { 'ユースケース': 'RAG / Q&A', '36GB Mac向けベスト': 'Llama 3.1 8B + nomic-embed', '64GB Mac向けベスト': '[Llama 3.1 8B](/local-llms/local-rag-for-private-business-data?lang=ja) + bge-large', '128GB Mac向けベスト': 'Llama 3.1 70B + bge-large' },
          { 'ユースケース': 'ビジョン / マルチモーダル', '36GB Mac向けベスト': 'LLaVA 7B', '64GB Mac向けベスト': '[Llama 3.2 Vision 11B](/power-local-llm/local-vision-models-llava-ollama-2026?lang=ja)', '128GB Mac向けベスト': 'Llama 3.2 Vision 90B' },
      ...
      avoid: {
        ...
        callouts: [
          ...
          { type: 'warning', text: '**Falcon 180Bは避ける** — コンシューマーApple Siliconには収まらない。[Llama 3.1 70B](/local-llms/running-70b-models-apple-silicon-m5-max?lang=ja)（より小型）が上回る。代替：Llama 3.1 70B Q5。' },
          { type: 'warning', text: '**コンシューマーハードウェアでのFP16量子化は避ける** — Llama 3.1 70B FP16 = 140GB、どのMacにも収まらない。Q5に対する品質向上は1%未満。代替：[Q4_K_MまたはQ5_K_M](/local-llms/llm-quantization-explained?lang=ja)。' },
      ...
      formatReference: {
        ...
        rows: [
          { 'フォーマット': 'GGUF Q4_K_M', '使用ツール': '[Ollama](/local-llms/ollama-on-mac-apple-silicon-setup-2026?lang=ja)、llama.cpp', 'オリジナル比サイズ': 'FP16の約30%' },
          { 'フォーマット': 'GGUF Q5_K_M', '使用ツール': '[Ollama](/local-llms/ollama-on-mac-apple-silicon-setup-2026?lang=ja)、llama.cpp', 'オリジナル比サイズ': 'FP16の約35%' },
          { 'フォーマット': 'GGUF Q8_0', '使用ツール': '[Ollama](/local-llms/ollama-on-mac-apple-silicon-setup-2026?lang=ja)、llama.cpp', 'オリジナル比サイズ': 'FP16の約50%' },
...
ollama pull aya-expanse:32b         # 翻訳`,
      ...
      relatedArticles: {
        ...
        items: [
          ...
          '[M5 Pro vs M5 Maxベンチマーク2026](/local-llms/m5-pro-max-llm-benchmarks-2026?lang=ja)',
          ...
          '[Mac用Ollamaセットアップガイド](/local-llms/ollama-on-mac-apple-silicon-setup-2026?lang=ja)',
          '[Apple Siliconで70Bモデルを実行する](/local-llms/running-70b-models-apple-silicon-m5-max?lang=ja)',
          '[LLM量子化の説明](/local-llms/llm-quantization-explained?lang=ja)',
          '[Qwen vs Llama vs Mistral 比較](/local-llms/qwen-vs-llama-vs-mistral?lang=ja)',
        ],
      },
      faq: {
        id: 'faq',
        faqs: [
          ...
          { q: '実際に役立つ最小のモデルは何ですか？', a: 'Phi-4（3.8Bパラメータ）。MMPUで84.8を獲得 — 2024年の一部の8Bモデルと同等。チャットやQ&Aでは驚くほど有能です。コーディングや複雑な推論はLlama 3.1 8Bや[Qwen2.5 14B](/local-llms/qwen-vs-llama-vs-mistral?lang=ja)に進んでください。' },
        ],
      },
    },
  ...
  zh: {
    ...
    seoTitle: 'Apple Silicon最佳本地LLM 2026：推荐模型16GB 36GB 64GB 128GB',
    ...
    metaDescription: 'Apple Silicon最佳LLM模型：16GB、36GB、64GB、128GB Mac推荐，含具体模型名称和tok/s速度。',
    ...
    sections: {
      ...
      byUsecase: {
        ...
        rows: [
          ...
          { '用例': 'RAG/问答', '36GB Mac最佳': 'Llama 3.1 8B + nomic-embed', '64GB Mac最佳': '[Llama 3.1 8B](/local-llms/local-rag-for-private-business-data?lang=zh) + bge-large', '128GB Mac最佳': 'Llama 3.1 70B + bge-large' },
          { '用例': '视觉/多模态', '36GB Mac最佳': 'LLaVA 7B', '64GB Mac最佳': '[Llama 3.2 Vision 11B](/power-local-llm/local-vision-models-llava-ollama-2026?lang=zh)', '128GB Mac最佳': 'Llama 3.2 Vision 90B' },
      ...
      avoid: {
        ...
        callouts: [
          ...
          { type: 'warning', text: '**避免Falcon 180B** — 不适合消费级Apple Silicon。[Llama 3.1 70B](/local-llms/running-70b-models-apple-silicon-m5-max?lang=zh)（更小）超越它。替代：Llama 3.1 70B Q5。' },
          { type: 'warning', text: '**避免消费硬件上的FP16量化** — Llama 3.1 70B FP16 = 140 GB，任何Mac都装不下。相比Q5的质量提升不足1%。替代：[Q4_K_M或Q5_K_M](/local-llms/llm-quantization-explained?lang=zh)。' },
      ...
      formatReference: {
        ...
        rows: [
          { '格式': 'GGUF Q4_K_M', '使用工具': '[Ollama](/local-llms/ollama-on-mac-apple-silicon-setup-2026?lang=zh)、llama.cpp', '相对原始大小': 'FP16的约30%' },
          { '格式': 'GGUF Q5_K_M', '使用工具': '[Ollama](/local-llms/ollama-on-mac-apple-silicon-setup-2026?lang=zh)、llama.cpp', '相对原始大小': 'FP16的约35%' },
          { '格式': 'GGUF Q8_0', '使用工具': '[Ollama](/local-llms/ollama-on-mac-apple-silicon-setup-2026?lang=zh)、llama.cpp', '相对原始大小': 'FP16的约50%' },
...
ollama pull aya-expanse:32b         # 翻译`,
      ...
      relatedArticles: {
        ...
        items: [
          ...
          '[M5 Pro vs M5 Max基准测试2026](/local-llms/m5-pro-max-llm-benchmarks-2026?lang=zh)',
          ...
          '[Ollama Mac安装指南](/local-llms/ollama-on-mac-apple-silicon-setup-2026?lang=zh)',
          '[在Apple Silicon上运行70B模型](/local-llms/running-70b-models-apple-silicon-m5-max?lang=zh)',
          '[LLM量化解释](/local-llms/llm-quantization-explained?lang=zh)',
          '[Qwen vs Llama vs Mistral比较](/local-llms/qwen-vs-llama-vs-mistral?lang=zh)',
        ],
      },
      faq: {
        id: 'faq',
        faqs: [
          ...
          { q: '实际有用的最小模型是什么？', a: 'Phi-4，3.8B参数。MMLU得分84.8——与2024年的一些8B模型相当。对于聊天和问答出乎意料地强大。编程或复杂推理请选择Llama 3.1 8B或[Qwen2.5 14B](/local-llms/qwen-vs-llama-vs-mistral?lang=zh)。' },
        ],
      },
    },
