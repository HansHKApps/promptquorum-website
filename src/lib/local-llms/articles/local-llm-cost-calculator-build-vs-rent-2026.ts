...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'حاسبة تكلفة LLM المحلي 2026: البناء مقابل الاستئجار',
    metaDescription: 'إجمالي تكلفة الملكية الكامل 2026: محطة عمل GPU محلية مقابل الاستئجار السحابي (RunPod، Lambda Labs). نقطة التعادل عند نحو 1800 ساعة GPU. مع حاسبة الكهرباء.',
    educationalLevel: 'Intermediate',
    affiliateDisclosure: true,
    publishDate: '2026-05-26',
