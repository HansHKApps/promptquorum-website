...
schema: {
        ...
        url: 'https://www.promptquorum.com/local-llms/vram-calculator-local-llm?lang=de',
        inLanguage: 'de'
      },
      faqSchema: {
        '@context': 'https://schema.org',
...
schema: {
        ...
        url: 'https://www.promptquorum.com/local-llms/vram-calculator-local-llm?lang=ja',
        inLanguage: 'ja'
      },
      faqSchema: {
        '@context': 'https://schema.org',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          title: '関連読み物',
          items: [
            '[ローカルLLMハードウェアガイド2026](/local-llms/local-llm-hardware-guide-2026?lang=ja) -- 予算に合わせた完全なGPUとCPUの推奨事項。',
            '[ローカルLLMに最適なGPU](/local-llms/best-gpus-for-local-llms?lang=ja) -- RTX 4090、4080、4070 Tiのベンチマークとコスト分析。',
            '[24GB VRAMで70Bモデルを実行](/local-llms/run-70b-models-24gb-vram?lang=ja) -- 大型モデルの量子化とオフロードテクニック。',
            '[LLM量子化の解説](/local-llms/llm-quantization-explained?lang=ja) -- Q4、Q5、Q8形式と品質トレードオフの詳細。',
            '[ローカルLLMの消費電力](/local-llms/local-llm-power-consumption?lang=ja) -- 電源、冷却、電気代の分析。',
            '[マルチGPUローカルLLM](/local-llms/multi-gpu-local-llms?lang=ja) -- 70B以上のモデルのレイヤー分割と分散推論。',
          ],
        },
        sources: {
          id: 'sources',
...
schema: {
        ...
        speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
        url: 'https://www.promptquorum.com/local-llms/vram-calculator-local-llm?lang=zh',
        inLanguage: 'zh',
      },
      faqSchema: {
        '@context': 'https://schema.org',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          title: '相关阅读',
          items: [
            '[本地LLM硬件指南2026](/local-llms/local-llm-hardware-guide-2026?lang=zh) -- 针对您预算的完整GPU和CPU推荐。',
            '[本地LLM最佳GPU](/local-llms/best-gpus-for-local-llms?lang=zh) -- RTX 4090、4080、4070 Ti基准测试和成本分析。',
            '[在24GB VRAM上运行70B模型](/local-llms/run-70b-models-24gb-vram?lang=zh) -- 大型模型的量化和卸载技术。',
            '[LLM量化详解](/local-llms/llm-quantization-explained?lang=zh) -- Q4、Q5、Q8格式和质量权衡深度解析。',
            '[本地LLM功耗分析](/local-llms/local-llm-power-consumption?lang=zh) -- 电源、散热和电费分析。',
            '[多GPU本地LLM](/local-llms/multi-gpu-local-llms?lang=zh) -- 70B及以上模型的层分割和分布式推理。',
          ],
        },
        sources: {
          id: 'sources',
