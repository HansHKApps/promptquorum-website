    ...
    es: {
      ...
      sections: {
        ...
        hardwareGuide: {
          ...
          items: [
            '**RTX 3060 (12 GB):** Mejor modelo: Qwen3 7B Q5 (4,4 GB) ✓. Alternativa: un modelo de 8B Q4 (4 GB) ✓. No posible: modelos de 32B+.',
    ...
    ar: {
      ...
      sections: {
        ...
        hardwareGuide: {
          ...
          items: [
            '**RTX 3060 (12 GB):** أفضل نموذج: Qwen3 7B Q5 (4.4 GB) ✓. بديل: نموذج 8B Q4 (4 GB) ✓. غير ممكن: نماذج 32B+.',
...
schema: {
      ...
      sections: {
        ...
        hardwareGuide: {
          ...
          items: [
            '**RTX 3060（12 GB）：** 最適モデル：Qwen3 7B Q5（4.4 GB）✓。代替：8Bモデル Q4（4 GB）✓。不可能：32B以上のモデル。',
...
schema: {
      ...
      sections: {
        ...
        hardwareGuide: {
          ...
          items: [
            '**RTX 3060（12 GB）：** 最佳模型：Qwen3 7B Q5（4.4 GB）✓。备选：8B模型 Q4（4 GB）✓。不可用：32B及以上模型。',
    ...
    heroImage: '/images/vram-calculator-local-llm-overview-hero-ko.webp',
      ...
      sections: {
        ...
        hardwareGuide: {
          ...
          items: [
            '**RTX 3060 (12 GB):** 최선의 모델: Qwen3 7B Q5(4.4 GB) ✓. 대안: 8B 모델 Q4(4 GB) ✓. 불가: 32B 이상 모델.',
