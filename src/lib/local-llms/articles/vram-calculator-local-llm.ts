...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      heroImage: '/images/vram-calculator-local-llm-overview-hero-en.webp',
      seoTitle: 'VRAM Calculator 2026: 7B/13B/70B LLM GPU Requirements (Q4, Q5, Q8)',
      intro: 'Interactive VRAM calculator for local LLMs. Enter model size, quantization, context length, and batch size to calculate exact GPU VRAM needs. Works for 1B–405B models at FP16, Q8, Q5, Q4 quantization. Updated August 2026 with RTX 5090, 5080, 4090 fit analysis and overhead calculations.',
...
schema: {
        ...
        step: [
          {
            ...
            text: 'Determine the parameter count in billions (e.g., 7B = 7 billion parameters, 13B = 13 billion). Common models: Llama 3.2 (7B, 13B), Qwen3 (7B, 14B, 32B, 72B), Mistral 3.1 (7B, 32B), Claude (varies).'
          },
          {
            '@type': 'HowToStep',
            position: 2,
      ...
      gammaDescription: 'The slide deck below covers: VRAM formula (Model Billions × Quantization Bits) ÷ 8, quantization levels Q2–FP16 with quality trade-offs, quick reference table (3B–70B models), real-world GPU scenarios (RTX 5090, 4090, M5 Max), and regional compliance (EU GDPR, Japan APPI, China Data Security Law). Download the PDF as a VRAM calculator reference card.',
      sections: {
        tldr: {
          id: 'key-takeaways',
        ...
        quickFacts: {
          ...
          items: [
            '**RTX 5090 (32 GB):** a 7B model at Q4 (3.5 GB), a 13B model at Q5 (8.1 GB), a 70B model at Q4 (35 GB) without offloading',
            '**RTX 4090 (24 GB):** a 7B model at Q4 (3.5 GB), a 13B model at Q5 (8.1 GB), a 70B model at Q4 with offloading',
            '**RTX 5070 Ti (16 GB):** a 7B model at Q4 (3.5 GB), a 13B model at Q5 (8.1 GB), a 32B model at Q4 (16 GB)',
            '**M5 Max Mac (36 GB unified):** a 13B model at FP16 (26 GB), 70B not possible without extreme quantization',
        ...
        realWorld: {
          ...
          imageCaption: 'Real-world GPU scenarios: RTX 5090 (32 GB), RTX 4090 (24 GB), RTX 5070 Ti (16 GB), M5 Max Mac (36 GB), and RTX 5070 (12 GB) — what different model sizes each can run at various quantization levels.',
          content: [
          ...
          items: [
            '**RTX 5070 Ti (16 GB)**: a 7B model at Q4 = 3.5 GB ✓ (plenty of room). A 13B model at Q5 = 8.1 GB ✓ (comfortable, room for context/batching).',
            '**RTX 5090 (32 GB)**: a 70B model at Q4 = 35 GB ✗ (still tight, needs Q3 or a bit of offloading). A 32B model at Q5 = 20 GB ✓ (comfortable). RTX 4090 (24 GB, previous gen) needs offloading for 70B at Q4 (slow, 3-5 tok/sec).',
            '**M5 Max Mac (36 GB)**: a 13B model at FP16 = 26 GB ✓ (works). A 70B model = impossible (even at Q2, ~70% quality loss).',
          ],
        },
        overhead: {
          id: 'hidden-overhead',
        ...
        hardwareGuide: {
          ...
          items: [
            '**RTX 5070 (12 GB):** Best model: Qwen3 8B Q5 (5 GB) ✓. Alternative: a 7B model Q4 (3.5 GB) ✓. Not possible: 32B+ models.',
            '**RTX 4070 (12 GB, previous gen):** Best model: Qwen3 14B Q4 (7 GB) ✓. With headroom: a 8B model Q5 (5 GB) ✓. Not possible: 32B models.',
            '**RTX 5070 Ti (16 GB):** Best model: Qwen3 14B Q5 (8.75 GB) ✓ comfortable. Tight fit: a 13B model Q4 (6.5 GB) ✓. Good for: light batch processing.',
            '**RTX 4080 (16 GB, previous gen):** Best model: Qwen3 32B Q4 (16 GB) ✓ tight. Comfortable: Mistral Small Q5 (~15 GB) ✓. Recommended: a 13B model Q8 (13 GB) ✓.',
            '**RTX 4090 (24 GB):** Best model: Qwen3 32B Q5 (20 GB) ✓. With offload: a 70B model Q4 (35 GB – needs offloading). Comfortable: Any 32B at Q5/Q8.',
            '**RTX 5090 (32 GB):** Best model: a 70B model Q4 (35 GB – tight fit, Q3 recommended for headroom). Comfortable: 32B+ at Q5/Q8 with batching room to spare.',
          ],
        },
        accuracy: {
          id: 'accuracy',
    ...
    es: {
      ...
      heroImage: '/images/vram-calculator-local-llm-overview-hero-es.webp',
        ...
        step: [
          {
            ...
            text: 'Determina el número de parámetros en miles de millones (p. ej., 7B = 7000 millones de parámetros, 13B = 13 000 millones). Modelos comunes: Llama 3.2 (7B, 13B), Qwen3 (7B, 14B, 32B, 72B), Mistral 3.1 (7B, 32B), Claude (varía).'
          },
          {
            '@type': 'HowToStep',
            position: 2,
      ...
      sections: {
        ...
        quickFacts: {
          ...
          items: [
            '**RTX 4090 (24 GB):** un modelo de 7B en Q4 (3,5 GB), 13B en Q5 (8,1 GB), 70B en Q4 con descarga',
            '**RTX 4080 (16 GB):** un modelo de 7B en Q4 (3,5 GB), 13B en Q5 (8,1 GB), 32B en Q4 (16 GB)',
            '**RTX 4070 Ti (12 GB):** un modelo de 7B en Q4 (3,5 GB), 13B en Q5 (8,1 GB con margen ajustado)',
            '**M5 Max Mac (36 GB unificados):** un modelo de 13B en FP16 (26 GB), 70B no es posible sin cuantización extrema',
        ...
        realWorld: {
          ...
          imageCaption: 'Escenarios GPU del mundo real: RTX 4090 (24 GB), RTX 4080 (16 GB), RTX 4070 Ti (12 GB), M5 Max Mac (36 GB) y RTX 3060 (12 GB): qué modelos Llama 3.3 puede ejecutar cada uno a varios niveles de cuantización.',
          content: [
          ...
          items: [
            '**RTX 4070 Ti (12 GB)**: un modelo de 7B en Q4 = 3,5 GB ✓ (mucho margen). un modelo de 13B en Q5 = 8,1 GB ✓ (ajustado, pero funciona sin contexto ni procesamiento por lotes).',
            ...
            '**M5 Max Mac (36 GB)**: un modelo de 13B en FP16 = 26 GB ✓ (funciona). Llama 3.3 70B = imposible (incluso en Q2, ~70 % de pérdida de calidad).',
          ],
        },
        overhead: {
          id: 'hidden-overhead',
        ...
        hardwareGuide: {
          ...
          items: [
            '**RTX 3060 (12 GB):** Mejor modelo: Qwen3 8B Q5 (4,4 GB) ✓. Alternativa: un modelo de 8B Q4 (4 GB) ✓. No posible: modelos de 32B+.',
            '**RTX 4070 (12 GB):** Mejor modelo: Qwen3 13B Q4 (6,5 GB) ✓. Con margen: un modelo de 8B Q5 (5 GB) ✓. No posible: modelos de 32B.',
            '**RTX 4070 Ti (12 GB):** Mejor modelo: Qwen3 13B Q5 (8,1 GB) ✓. Ajustado: un modelo de 13B Q4 (6,5 GB) ✓. No ideal: procesamiento por lotes.',
            '**RTX 4080 (16 GB):** Mejor modelo: Qwen3 32B Q4 (16 GB) ✓ ajustado. Cómodo: Mistral 3.1 24B Q5 (15 GB) ✓. Recomendado: un modelo de 13B Q8 (13 GB) ✓.',
    ...
    ar: {
      ...
      heroImage: '/images/vram-calculator-local-llm-overview-hero-ar.webp',
      ...
      sections: {
        ...
        quickFacts: {
          ...
          items: [
            '**RTX 4090 (24 GB):** نموذج 7B بـ Q4 (3.5 GB)، 13B بـ Q5 (8.1 GB)، 70B بـ Q4 مع تفريغ',
            '**RTX 4080 (16 GB):** نموذج 7B بـ Q4 (3.5 GB)، 13B بـ Q5 (8.1 GB)، 32B بـ Q4 (16 GB)',
            '**RTX 4070 Ti (12 GB):** نموذج 7B بـ Q4 (3.5 GB)، 13B بـ Q5 (8.1 GB بهامش ضيق)',
            '**M5 Max Mac (36 GB موحّدة):** نموذج 13B بـ FP16 (26 GB)، 70B غير ممكن دون تكميم متطرف',
        ...
        quantization: {
          ...
          rows: [
            { 'التكميم': 'FP16 (16 بت)', 'تقليل الحجم': 'لا شيء (أساس)', 'الجودة': '100% (مثالية)', 'السرعة': 'أساس', 'حالة الاستخدام': 'بحث، ضبط دقيق' },
            { 'التكميم': 'Q8 (8 بت)', 'تقليل الحجم': '50%', 'الجودة': '99% (غير محسوس)', 'السرعة': 'أساس', 'حالة الاستخدام': 'إنتاج، خوادم محلية' },
            { 'التكميم': 'Q6 (6 بت)', 'تقليل الحجم': '62.5%', 'الجودة': '98% (طفيف)', 'السرعة': 'أساس', 'حالة الاستخدام': 'استخدام متوازن' },
            { 'التكميم': 'Q5 (5 بت)', 'تقليل الحجم': '68.75%', 'الجودة': '95% (فقدان طفيف)', 'السرعة': 'أساس', 'حالة الاستخدام': 'ضغط جيد، استهلاكي' },
            { 'التكميم': 'Q4 (4 بت)', 'تقليل الحجم': '75%', 'الجودة': '90–95% (مقبول)', 'السرعة': 'أساس', 'حالة الاستخدام': 'أقصى ضغط' },
            { 'التكميم': 'Q3 (3 بت)', 'تقليل الحجم': '81%', 'الجودة': '80–85% (فقدان ملحوظ)', 'السرعة': 'أسرع', 'حالة الاستخدام': 'ضغط متطرف، CPU' },
            { 'التكميم': 'Q2 (2 بت)', 'تقليل الحجم': '87.5%', 'الجودة': '70% (فقدان مرئي)', 'السرعة': 'الأسرع', 'حالة الاستخدام': 'نماذج صغيرة، أجهزة الحافة' },
          ],
        ...
        quickRef: {
          ...
          rows: [
            { 'النموذج': '3B', 'FP16': '6 GB', 'Q8': '3 GB', 'Q5': '1.9 GB', 'Q4': '1.5 GB' },
            { 'النموذج': '7B', 'FP16': '14 GB', 'Q8': '7 GB', 'Q5': '4.4 GB', 'Q4': '3.5 GB' },
            { 'النموذج': '13B', 'FP16': '26 GB', 'Q8': '13 GB', 'Q5': '8.1 GB', 'Q4': '6.5 GB' },
            { 'النموذج': '32B', 'FP16': '64 GB', 'Q8': '32 GB', 'Q5': '20 GB', 'Q4': '16 GB' },
            { 'النموذج': '70B', 'FP16': '140 GB', 'Q8': '70 GB', 'Q5': '43.75 GB', 'Q4': '35 GB' },
          ],
        ...
        realWorld: {
          ...
          items: [
            '**RTX 4070 Ti (12 GB)**: نموذج 7B بـ Q4 = 3.5 GB ✓ (هامش كبير). نموذج 13B بـ Q5 = 8.1 GB ✓ (ضيق، لكنه يعمل دون سياق أو معالجة بالدُفعات).',
            ...
            '**M5 Max Mac (36 GB)**: نموذج 13B بـ FP16 = 26 GB ✓ (يعمل). Llama 3.3 70B = مستحيل (حتى بـ Q2، ~70% فقدان جودة).',
          ],
        },
        overhead: {
          id: 'hidden-overhead',
        ...
        hardwareGuide: {
          ...
          items: [
            '**RTX 3060 (12 GB):** أفضل نموذج: Qwen3 8B Q5 (4.4 GB) ✓. بديل: نموذج 8B Q4 (4 GB) ✓. غير ممكن: نماذج 32B+.',
            '**RTX 4070 (12 GB):** أفضل نموذج: Qwen3 13B Q4 (6.5 GB) ✓. بهامش: نموذج 8B Q5 (5 GB) ✓. غير ممكن: نماذج 32B.',
            '**RTX 4070 Ti (12 GB):** أفضل نموذج: Qwen3 13B Q5 (8.1 GB) ✓. ضيق: نموذج 13B Q4 (6.5 GB) ✓. غير مثالي: المعالجة بالدُفعات.',
            '**RTX 4080 (16 GB):** أفضل نموذج: Qwen3 32B Q4 (16 GB) ✓ ضيق. مريح: Mistral 3.1 24B Q5 (15 GB) ✓. موصى به: نموذج 13B Q8 (13 GB) ✓.',
    ...
    pt: {
      ...
      theme: 'Hardware & Performance',
      title: 'Calculadora de VRAM 2026: Requisitos de GPU para LLMs 7B/13B/70B (Q4, Q5, Q8)',
      heroImage: '/images/vram-calculator-local-llm-overview-hero-pt.webp',
      seoTitle: 'Calculadora de VRAM 2026: GPU para LLMs 7B, 13B e 70B',
      intro: 'Calculadora interativa de VRAM para LLMs locais. Insira o tamanho do modelo, a quantização, o comprimento do contexto e o tamanho do lote para calcular exatamente quanta VRAM de GPU você precisa. Compatível com modelos de 1B a 405B em FP16, Q8, Q5 e Q4. Atualizado em abril de 2026 com análise de compatibilidade para RTX 4090, 4080, 3060 e cálculos de sobrecarga.',
      metaDescription: 'Calcule os requisitos exatos de GPU para LLMs de 7B (3,5 GB em Q4), 13B (6,5 GB em Q4) e 70B (35 GB em Q4). Compatibilidade com RTX 4090, 4080 e 4070 Ti.',
      publishDate: '2026-04-04',
      next_refresh_due: '2026-10-04',
      leadAnswerBlock: '**Este guia explica como calcular os requisitos exatos de VRAM para qualquer combinação de modelo e hardware. A fórmula é simples: (Tamanho do modelo em GB × Bits de quantização) ÷ 8 = VRAM necessária.**',
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        headline: 'Calculadora de VRAM para LLMs locais: Calcule os requisitos exatos de GPU',
        description: 'Calculadora de VRAM para LLMs locais 2026: use a fórmula VRAM = (Bilhões do modelo × Bits de quantização) ÷ 8. Exemplos com RTX 4090, 4080, M5 Max com dados de sobrecarga.',
      ...
      sections: {
        tldr: {
          ...
          snippetBlocks: [
            { type: 'one-sentence', text: 'Para calcular a VRAM necessária: multiplique os bilhões de parâmetros pelo fator de quantização (Q4 = 0,5, Q5 = 0,625, Q8 = 1, FP16 = 2) e adicione 15-20% de overhead.' },
            { type: 'plain-terms', text: 'Quantização é como compactar um arquivo. Q4 significa que cada número no modelo usa apenas 4 bits em vez de 16 (FP16), reduzindo o tamanho pela metade com perda mínima de qualidade.' },
          ],
        },
        vramTable: {
          id: 'vram-table',
          title: 'Tabela de VRAM por tamanho de modelo e quantização',
          rows: [
            { 'Tamanho do modelo': '7B', 'Q4_K_M': '3,5-4,5 GB', 'Q5_K_M': '4,5-5,5 GB', 'Q8_0': '7-8,5 GB', 'FP16': '14-16 GB' },
            { 'Tamanho do modelo': '13B', 'Q4_K_M': '6,5-8 GB', 'Q5_K_M': '8-10 GB', 'Q8_0': '13-15 GB', 'FP16': '26-28 GB' },
            { 'Tamanho do modelo': '34B', 'Q4_K_M': '17-21 GB', 'Q5_K_M': '21-26 GB', 'Q8_0': '34-40 GB', 'FP16': '68-72 GB' },
            { 'Tamanho do modelo': '70B', 'Q4_K_M': '35-43 GB', 'Q5_K_M': '44-53 GB', 'Q8_0': '70-82 GB', 'FP16': '140-160 GB' },
          ],
          columns: ['Tamanho do modelo', 'Q4_K_M', 'Q5_K_M', 'Q8_0', 'FP16'],
          tableFormat: true,
        },
        gpuCompatibility: {
          id: 'gpu-compatibility',
          title: 'Compatibilidade de GPU por tamanho de modelo',
          rows: [
            { 'GPU': 'RTX 3060 12GB', 'VRAM': '12 GB', 'Modelo recomendado': '7B em Q4_K_M', 'Velocidade típica': '50-60 tok/s' },
            { 'GPU': 'RTX 4070 12GB', 'VRAM': '12 GB', 'Modelo recomendado': '7B-13B em Q4_K_M', 'Velocidade típica': '60-80 tok/s' },
            { 'GPU': 'RTX 4080 16GB', 'VRAM': '16 GB', 'Modelo recomendado': '13B em Q5, 27B em Q4', 'Velocidade típica': '50-70 tok/s' },
            { 'GPU': 'RTX 3090 24GB', 'VRAM': '24 GB', 'Modelo recomendado': '32B em Q4_K_M', 'Velocidade típica': '25-35 tok/s' },
            { 'GPU': 'RTX 4090 24GB', 'VRAM': '24 GB', 'Modelo recomendado': '32B em Q4_K_M', 'Velocidade típica': '30-45 tok/s' },
            { 'GPU': 'M3 Max 48GB', 'VRAM': '48 GB (unificada)', 'Modelo recomendado': '70B em Q4 com offload parcial', 'Velocidade típica': '15-25 tok/s' },
          ],
          columns: ['GPU', 'VRAM', 'Modelo recomendado', 'Velocidade típica'],
          tableFormat: true,
        },
        faqSection: {
          id: 'faq',
          ...
          faqs: [
            { q: 'Como calculo a VRAM necessária para um modelo local?', a: 'Fórmula: Bilhões de parâmetros × Bytes por parâmetro = VRAM base. Q4 = 0,5 bytes/parâmetro, Q5 = 0,625, Q8 = 1, FP16 = 2. Adicione 15-20% de overhead para contexto e buffers. Exemplo: 7B modelo em Q4_K_M = 7 × 0,5 × 1,2 = 4,2 GB de VRAM total.' },
            { q: 'Quanto VRAM o Llama 3.3 70B precisa?', a: 'Em Q4_K_M: 35-43 GB. Em Q2: 17,5 GB (mas com perda de qualidade significativa). Para rodar completamente em VRAM, você precisa de 2× RTX 3090 (48 GB) ou um Apple Silicon com 48+ GB de memória unificada.' },
            { q: 'Posso executar modelos 7B em uma GPU de 6 GB?', a: 'Sim, em Q4_K_M. Um modelo 7B em Q4_K_M usa ~3,5-4,5 GB de VRAM. Uma RTX 3060 6GB consegue carregar e executar modelos 7B, mas sem margem para janelas de contexto grandes. Para 8K tokens de contexto, você precisará de 8 GB.' },
            { q: 'O que acontece se meu modelo for maior que minha VRAM?', a: 'O Ollama e llama.cpp automaticamente descarregam camadas para a RAM do sistema. O modelo funciona, mas a velocidade de inferência cai drasticamente (tipicamente 10-20× mais lento). Para uso interativo, use um modelo que caiba completamente na VRAM.' },
            { q: 'Apple Silicon conta como VRAM?', a: 'Sim. O Apple Silicon usa memória unificada que serve tanto para CPU quanto para GPU. Um M3 Max com 48 GB de memória unificada pode ser tratado como 48 GB de VRAM para fins de cálculo de LLM. O desempenho é excelente — sem offloading para RAM separada.' },
          ],
        },
        relatedReading: {
          id: 'related-reading',
          ...
          items: [
            '[Executar modelos de 70B com 24 GB de VRAM](/pt/local-llms/run-70b-models-24gb-vram) -- Técnicas de quantização e offloading para modelos grandes.',
            '[Quantização de LLM explicada](/pt/local-llms/llm-quantization-explained) -- Análise aprofundada dos formatos Q4, Q5, Q8 e suas compensações de qualidade.',
            '[LLMs locais com múltiplas GPUs](/pt/local-llms/multi-gpu-local-llms) -- Divisão de camadas e inferência distribuída para modelos de 70B+.',
          ],
        },
        sources: {
          id: 'sources',
          title: 'Fontes',
          items: [
            '[Especificação GGUF](https://github.com/ggerganov/ggml/blob/master/docs/gguf.md) -- Documentação de ggerganov/ggml sobre o formato de arquivo quantizado.',
            '[Documentação de quantização do Transformers](https://huggingface.co/docs/transformers/quantization) -- Guia oficial do Hugging Face sobre métodos de quantização.',
            '[Documentação do Ollama](https://ollama.ai) -- Guias oficiais do Ollama para gerenciamento de modelos.',
          ],
        },
      },
    },
...
schema: {
    ...
    fr: {
      ...
      heroImage: '/images/vram-calculator-local-llm-overview-hero-fr.webp',
...
schema: {
      ...
      howToSchema: {
        ...
        inLanguage: 'ja',
        step: [
          { '@type': 'HowToStep', position: 1, name: 'モデルサイズを特定する', text: 'パラメータ数を十億単位で確認します（例：7B = 70億パラメータ、13B = 130億）。一般的なモデル：Llama 3.2（7B、13B）、Qwen3（7B、14B、32B、72B）、Mistral 3.1（7B、32B）、Claude（サイズは様々）。' },
      ...
      sections: {
        ...
        quickFacts: {
          ...
          items: [
            '**RTX 4090（24 GB）：** 7Bモデル（Q4で3.5 GB）、13B（Q5で8.1 GB）、70B（Q4でオフロードあり）',
            '**RTX 4080（16 GB）：** 7Bモデル（Q4で3.5 GB）、13B（Q5で8.1 GB）、32B（Q4で16 GB）',
            '**RTX 4070 Ti（12 GB）：** 7Bモデル（Q4で3.5 GB）、13B（Q5で8.1 GB、ギリギリ）',
            '**M5 Max Mac（36 GB統合）：** 13Bモデル（FP16で26 GB）、70Bは極端な量子化なしでは不可能',
        ...
        realWorld: {
          ...
          title: '実際の使用例',
          image: '/images/vram-calculator-local-llm-gpu-scenarios-en.svg',
          imageCaption: '実際のGPUシナリオ：RTX 4090（24 GB）、RTX 4080（16 GB）、RTX 4070 Ti（12 GB）、M5 Max Mac（36 GB）、RTX 3060（12 GB）——各GPUがさまざまな量子化レベルで実行できるLlama 3.3モデル。',
          content: [
            '一般的なシナリオの実際のVRAM計算：',
            '⚠️ **警告：** これらの計算はモデルウェイトのみです。コンテキスト、バッチ処理、システムオーバーヘッドのために25〜40%を追加してください。例：13B Q5 = 8.1 GBモデル + 2〜3 GBオーバーヘッド = 実際には10〜11 GB。',
          ],
          items: [
            '**RTX 4070 Ti（12 GB）**：7Bモデル（Q4で3.5 GB）✓（余裕あり）。13Bモデル（Q5で8.1 GB）✓（コンテキスト/バッチなしでギリギリ動作）。',
            '**RTX 4090（24 GB）**：Llama 3.3 70B（Q5で43.75 GB）✗（大きすぎ）。Llama 3.3 70B（Q4で35 GB）✗（まだ大きすぎ）。Llama 3.3 70B（Q4でオフロードあり）= 動作可（遅い、毎秒3〜5トークン）。',
            '**M5 Max Mac（36 GB）**：13Bモデル（FP16で26 GB）✓（動作可）。Llama 3.3 70B = 不可能（Q2でも品質損失約70%）。',
          ],
        },
        overhead: {
          id: 'hidden-overhead',
        ...
        hardwareGuide: {
          ...
          items: [
            '**RTX 3060（12 GB）：** 最適モデル：Qwen3 8B Q5（4.4 GB）✓。代替：8Bモデル Q4（4 GB）✓。不可能：32B以上のモデル。',
            '**RTX 4070（12 GB）：** 最適モデル：Qwen3 13B Q4（6.5 GB）✓。余裕あり：8Bモデル Q5（5 GB）✓。不可能：32Bモデル。',
            '**RTX 4070 Ti（12 GB）：** 最適モデル：Qwen3 13B Q5（8.1 GB）✓。ギリギリ：13Bモデル Q4（6.5 GB）✓。非推奨：バッチ処理。',
            '**RTX 4080（16 GB）：** 最適モデル：Qwen3 32B Q4（16 GB）✓ギリギリ。余裕あり：Mistral 3.1 24B Q5（15 GB）✓。推奨：13Bモデル Q8（13 GB）✓。',
    ...
    zh: {
      ...
      heroImage: '/images/vram-calculator-local-llm-overview-hero-zh.webp',
...
schema: {
      ...
      howToSchema: {
        ...
        inLanguage: 'zh',
        step: [
          { '@type': 'HowToStep', position: 1, name: '确定模型大小', text: '确定参数数量（以十亿为单位，例如7B = 70亿参数，13B = 130亿）。常见模型：Llama 3.2（7B、13B）、Qwen3（7B、14B、32B、72B）、Mistral 3.1（7B、32B）、Claude（大小不等）。' },
      ...
      sections: {
        ...
        quickFacts: {
          ...
          items: [
            '**RTX 4090（24 GB）：** 7B模型（Q4需3.5 GB）、13B（Q5需8.1 GB）、70B（Q4需卸载）',
            '**RTX 4080（16 GB）：** 7B模型（Q4需3.5 GB）、13B（Q5需8.1 GB）、32B（Q4需16 GB）',
            '**RTX 4070 Ti（12 GB）：** 7B模型（Q4需3.5 GB）、13B（Q5需8.1 GB，较紧张）',
            '**M5 Max Mac（36 GB统一内存）：** 13B模型（FP16需26 GB）、70B无极端量化则不可用',
        ...
        realWorld: {
          ...
          title: '实际使用案例',
          image: '/images/vram-calculator-local-llm-gpu-scenarios-en.svg',
          imageCaption: '实际GPU场景：RTX 4090（24 GB）、RTX 4080（16 GB）、RTX 4070 Ti（12 GB）、M5 Max Mac（36 GB）和RTX 3060（12 GB）——各GPU在不同量化级别下能运行的Llama 3.3模型。',
          content: [
            '常见场景的实际VRAM计算：',
            '⚠️ **警告：** 以下计算仅针对模型权重。请为上下文、批处理和系统开销额外预留25-40%。示例：13B Q5 = 8.1 GB模型 + 2-3 GB开销 = 实际需要10-11 GB。',
          ],
          items: [
            '**RTX 4070 Ti（12 GB）**：7B模型（Q4需3.5 GB）✓（空间充裕）。13B模型（Q5需8.1 GB）✓（不含上下文/批处理时勉强可用）。',
            '**RTX 4090（24 GB）**：Llama 3.3 70B（Q5需43.75 GB）✗（太大）。Llama 3.3 70B（Q4需35 GB）✗（仍太大）。Llama 3.3 70B（Q4含卸载）= 可用（较慢，每秒3-5个token）。',
            '**M5 Max Mac（36 GB）**：13B模型（FP16需26 GB）✓（可用）。Llama 3.3 70B = 不可能（即使Q2，质量损失约70%）。',
          ],
        },
        overhead: {
          id: 'hidden-overhead',
        ...
        hardwareGuide: {
          ...
          items: [
            '**RTX 3060（12 GB）：** 最佳模型：Qwen3 8B Q5（4.4 GB）✓。备选：8B模型 Q4（4 GB）✓。不可用：32B及以上模型。',
            '**RTX 4070（12 GB）：** 最佳模型：Qwen3 13B Q4（6.5 GB）✓。余量充足：8B模型 Q5（5 GB）✓。不可用：32B模型。',
            '**RTX 4070 Ti（12 GB）：** 最佳模型：Qwen3 13B Q5（8.1 GB）✓。较紧张：13B模型 Q4（6.5 GB）✓。不推荐：批处理。',
            '**RTX 4080（16 GB）：** 最佳模型：Qwen3 32B Q4（16 GB）✓较紧张。舒适：Mistral 3.1 24B Q5（15 GB）✓。推荐：13B模型 Q8（13 GB）✓。',
  ...
  ko: {
    ...
    heroImage: '/images/vram-calculator-local-llm-overview-hero-ko.webp',
      ...
      toc: [
        ...
        { label: 'VRAM 공식', anchor: '#vram-formula' },
        { label: '인터랙티브 계산기', anchor: '#interactive-calculator' },
        { label: '양자화 수준 설명', anchor: '#quantization-levels' },
        { label: '빠른 참조 표', anchor: '#quick-reference' },
        { label: '실제 사례', anchor: '#real-world-examples' },
        { label: '내 모델에 맞는 GPU는?', anchor: '#hardware-fit' },
        { label: '숨겨진 VRAM 오버헤드', anchor: '#hidden-overhead' },
        { label: '정확도와 오차 범위', anchor: '#accuracy' },
        { label: '흔한 실수', anchor: '#common-mistakes' },
        { label: '지역별 배포', anchor: '#regional-context' },
        { label: 'FAQ', anchor: '#faq' },
        { label: '관련 읽기', anchor: '#related-reading' },
      ],
      gammaEmbedUrl: '/presentations/vram-calculator-local-llm-static.html',
      gammaDescription: '아래 슬라이드 덱은 다음 내용을 다룹니다: VRAM 공식 (모델 파라미터 수(B) × 양자화 비트) ÷ 8, Q2~FP16 양자화 수준과 품질 절충점, 빠른 참조 표(3B~70B 모델), 실제 GPU 시나리오(RTX 4090, 4080, M5 Max), 지역 규정 준수(EU GDPR, 일본 APPI, 중국 데이터보안법). PDF를 VRAM 계산기 참조 카드로 다운로드하십시오.',
      sections: {
        tldr: {
          id: 'key-takeaways',
          isTldr: true,
        ...
        quickFacts: {
          id: 'quick-facts',
          title: '빠른 사실: GPU별 VRAM 요구 사항',
          items: [
            '**RTX 4090 (24 GB):** 7B 모델(Q4, 3.5 GB), 13B(Q5, 8.1 GB), 70B는 오프로딩 사용 시 Q4로 가능',
            '**RTX 4080 (16 GB):** 7B 모델(Q4, 3.5 GB), 13B(Q5, 8.1 GB), 32B(Q4, 16 GB)',
            '**RTX 4070 Ti (12 GB):** 7B 모델(Q4, 3.5 GB), 13B(Q5, 8.1 GB, 여유 공간 부족)',
            '**M5 Max Mac (36 GB 통합 메모리):** 13B 모델(FP16, 26 GB), 70B는 극단적 양자화 없이 불가',
        ...
        inOneSentence: {
          id: 'in-one-sentence',
          title: '한 문장 요약',
          content: '필요한 VRAM(GB)은 모델 파라미터 수(B)에 양자화 비트(FP16의 경우 16, Q8은 8, Q4는 4 등)를 곱한 뒤 8로 나눈 값입니다.',
        },
        inPlainTerms: {
          id: 'in-plain-terms',
          title: '쉬운 설명',
          content: 'VRAM을 책장 공간으로 생각하십시오. 두꺼운 책(70B처럼 파라미터가 많은 모델)은 더 많은 공간을 차지하고, 얇은 책(Q4 양자화)은 두꺼운 책(FP16)보다 공간을 덜 차지합니다. 공식은 필요한 "책장 칸 수(GB)"를 정확히 알려줍니다. 대화, 동시 요청 처리, 시스템 소프트웨어를 위해 항상 여분의 공간을 남겨 두십시오.',
        },
        formula: {
          id: 'vram-formula',
          title: 'VRAM 공식이란 무엇입니까?',
          image: '/images/vram-calculator-local-llm-formula-en.svg',
          imageCaption: 'VRAM 공식과 3가지 계산 예시: 7B 모델 Q4 = 3.5 GB, 13B Q5 = 8.1 GB, 70B Q8 = 70 GB. 컨텍스트, 배칭, 시스템 오버헤드를 위해 항상 25~40% 버퍼를 추가하십시오.',
          content: [
            'VRAM 요구량 공식은 놀랍도록 단순합니다:',
            '💡 **프로 팁:** 이 공식은 모델 가중치만 계산합니다. 컨텍스트, 배칭, 시스템 오버헤드로 인해 실제 VRAM 사용량은 25~40% 더 높습니다. 항상 안전 마진을 추가하십시오.',
          ],
          codeBlock: 'VRAM (GB) = (모델 크기(B) × 양자화 비트) ÷ 8\n\n예시:\n- 7B 모델, 4비트 양자화\n- (7 × 4) ÷ 8 = 3.5 GB\n\n- 13B 모델, 5비트 양자화\n- (13 × 5) ÷ 8 = 8.125 GB\n\n- 70B 모델, 8비트 양자화\n- (70 × 8) ÷ 8 = 70 GB',
          codeLanguage: 'bash',
        },
        calculator: {
          id: 'interactive-calculator',
        ...
        quantization: {
          id: 'quantization-levels',
          title: '양자화 수준이란 무엇입니까?',
          image: '/images/vram-calculator-local-llm-quant-levels-en.svg',
          imageCaption: '양자화 수준 비교: FP16(품질 100%), Q8(99%), Q5(95%, 권장), Q4(90~95%), Q3(80~85%), Q2(70%). Q5는 7B 모델을 14 GB에서 4.4 GB로 줄이면서 품질 손실은 5%에 불과합니다.',
          content: '🔍 **핵심 인사이트:** 양자화는 파일 크기와 품질을 맞바꿉니다. Q5가 최적의 균형점입니다(품질 95%, 크기 68% 감소). Q4는 대부분의 사용자에게 적합합니다. Q3 이하는 엣지 디바이스나 VRAM이 심각하게 부족한 경우에만 사용하십시오.',
          rows: [
            { '양자화': 'FP16 (16비트)', '크기 감소': '없음 (기준)', '품질': '100% (완벽)', '속도': '기준', '사용 사례': '연구, 파인튜닝' },
            { '양자화': 'Q8 (8비트)', '크기 감소': '50%', '품질': '99% (차이 없음)', '속도': '기준', '사용 사례': '프로덕션, 로컬 서버' },
            { '양자화': 'Q6 (6비트)', '크기 감소': '62.5%', '품질': '98% (미미한 차이)', '속도': '기준', '사용 사례': '균형 사용' },
            { '양자화': 'Q5 (5비트)', '크기 감소': '68.75%', '품질': '95% (약간의 손실)', '속도': '기준', '사용 사례': '좋은 압축, 소비자용' },
            { '양자화': 'Q4 (4비트)', '크기 감소': '75%', '품질': '90~95% (허용 가능)', '속도': '기준', '사용 사례': '최대 압축' },
            { '양자화': 'Q3 (3비트)', '크기 감소': '81%', '품질': '80~85% (눈에 띄는 손실)', '속도': '더 빠름', '사용 사례': '극단적 압축, CPU용' },
            { '양자화': 'Q2 (2비트)', '크기 감소': '87.5%', '품질': '70% (가시적 손실)', '속도': '가장 빠름', '사용 사례': '소형 모델, 엣지 디바이스' },
          ],
          columns: ['양자화', '크기 감소', '품질', '속도', '사용 사례'],
        },
        quickRef: {
          id: 'quick-reference',
          title: '빠른 참조 표: 모델 및 양자화별 VRAM',
          image: '/images/vram-calculator-local-llm-quick-ref-en.svg',
          imageCaption: 'VRAM 빠른 참조 매트릭스: FP16, Q8, Q5, Q4 양자화에서 3B~70B 모델. 초록색 = 12 GB GPU에 적합. 황색 = 16~24 GB 필요. 빨간색 = 40 GB 이상 또는 멀티 GPU 필요.',
          rows: [
            { '모델': '3B', 'FP16': '6 GB', 'Q8': '3 GB', 'Q5': '1.9 GB', 'Q4': '1.5 GB' },
            { '모델': '7B', 'FP16': '14 GB', 'Q8': '7 GB', 'Q5': '4.4 GB', 'Q4': '3.5 GB' },
            { '모델': '13B', 'FP16': '26 GB', 'Q8': '13 GB', 'Q5': '8.1 GB', 'Q4': '6.5 GB' },
            { '모델': '32B', 'FP16': '64 GB', 'Q8': '32 GB', 'Q5': '20 GB', 'Q4': '16 GB' },
            { '모델': '70B', 'FP16': '140 GB', 'Q8': '70 GB', 'Q5': '43.75 GB', 'Q4': '35 GB' },
          ],
          columns: ['모델', 'FP16', 'Q8', 'Q5', 'Q4'],
        },
        realWorld: {
          id: 'real-world-examples',
          title: '실제 사례',
          image: '/images/vram-calculator-local-llm-gpu-scenarios-en.svg',
          imageCaption: '실제 GPU 시나리오: RTX 4090(24 GB), RTX 4080(16 GB), RTX 4070 Ti(12 GB), M5 Max Mac(36 GB), RTX 3060(12 GB) — 각 GPU에서 다양한 양자화 수준으로 실행 가능한 Llama 3.3 모델.',
          content: [
          ...
          items: [
            '**RTX 4070 Ti (12 GB)**: 7B 모델 Q4 = 3.5 GB ✓(여유 충분). 13B 모델 Q5 = 8.1 GB ✓(컨텍스트/배칭 없이 작동).',
            '**RTX 4090 (24 GB)**: Llama 3.3 70B Q5 = 43.75 GB ✗(너무 큼). Llama 3.3 70B Q4 = 35 GB ✗(여전히 초과). Llama 3.3 70B Q4 + 오프로딩 = 작동(느림, 3~5 tok/sec).',
            '**M5 Max Mac (36 GB)**: 13B 모델 FP16 = 26 GB ✓(작동). Llama 3.3 70B = 불가(Q2에서도 품질 손실 ~70%).',
          ],
        },
        overhead: {
          id: 'hidden-overhead',
          title: '숨겨진 VRAM 오버헤드를 어떻게 고려해야 합니까?',
          image: '/images/vram-calculator-local-llm-overhead-en.svg',
          imageCaption: '숨겨진 VRAM 오버헤드 분석: 컨텍스트 윈도우(4k 토큰 기준 2~3 GB), 배치 처리(batch=4 시 ×4), 시스템 오버헤드(500 MB~1 GB), 총 안전 마진 25~40%.',
          content: [
        ...
        hardwareGuide: {
          id: 'hardware-fit',
          title: '내 GPU에 맞는 로컬 LLM은? 2026 가이드',
          content: [
            '위의 인터랙티브 계산기를 사용하여 정확한 적합 여부를 확인하십시오. 아래는 일반적인 GPU 시나리오와 권장 모델입니다.',
          ],
          items: [
            '**RTX 3060 (12 GB):** 최선의 모델: Qwen3 8B Q5(4.4 GB) ✓. 대안: 8B 모델 Q4(4 GB) ✓. 불가: 32B 이상 모델.',
            '**RTX 4070 (12 GB):** 최선의 모델: Qwen3 13B Q4(6.5 GB) ✓. 여유 있는 옵션: 8B 모델 Q5(5 GB) ✓. 불가: 32B 모델.',
            '**RTX 4070 Ti (12 GB):** 최선의 모델: Qwen3 13B Q5(8.1 GB) ✓. 빡빡한 적합: 13B 모델 Q4(6.5 GB) ✓. 비권장: 배치 처리.',
            '**RTX 4080 (16 GB):** 최선의 모델: Qwen3 32B Q4(16 GB) ✓ 빡빡. 여유 있는 옵션: Mistral 3.1 24B Q5(15 GB) ✓. 권장: 13B 모델 Q8(13 GB) ✓.',
        ...
        accuracy: {
          ...
          title: '공식은 얼마나 정확합니까?',
          image: '/images/vram-calculator-local-llm-accuracy-en.svg',
          imageCaption: 'VRAM 공식 정확도 ±10%: 양자화 형식(GGUF vs GPTQ vs AWQ), 모델 아키텍처(Transformer vs MoE), 추론 엔진(vLLM vs llama.cpp vs Ollama)에 따른 차이.',
          content: [
        ...
        commonMistakes: {
          id: 'common-mistakes',
          title: 'VRAM 계산에서 흔히 저지르는 실수',
          image: '/images/vram-calculator-local-llm-mistakes-en.svg',
          imageCaption: '4가지 흔한 VRAM 실수: 컨텍스트 오버헤드 간과(1.5~3 GB 추가), 70B 파라미터를 70 GB VRAM으로 혼동, 시스템 오버헤드 1~2 GB 무시, 계산된 크기 그대로의 GPU 구매(25% 마진 없음).',
          items: [
        ...
        faqSection: {
          id: 'faq',
          title: 'FAQ: VRAM 및 GPU 요구 사항',
          faqs: [
            { q: '이 공식은 모든 모델 유형에 적용됩니까?', a: '예. (모델 파라미터 수(B) × 양자화 비트) ÷ 8 공식은 모든 Transformer 기반 모델(Llama, Qwen, Mistral, Claude 등)에 적용됩니다. 비-Transformer 아키텍처(RNN 등)는 드물며 조정이 필요할 수 있습니다.' },
            { q: '어떤 양자화 수준을 사용해야 합니까?', a: '대부분의 용도에서: Q5가 최적의 균형을 제공합니다(품질 95%, 크기 68% 감소). 소비자용 GPU: Q4가 표준입니다(품질 90~95%, 75% 감소). 프로덕션용: VRAM이 허용한다면 Q8(품질 99%). 다른 선택이 없는 경우를 제외하고 Q3 이하는 피하십시오.' },
            { q: '시스템 RAM은 얼마나 필요합니까?', a: '오프로딩을 위해 최소 16 GB가 필요합니다. VRAM 오프로딩(CPU 유출)을 사용하는 경우 시스템 RAM이 대체 저장소가 됩니다. 배치 처리의 경우 모델 오프로드 요구 사항 외에 8~16 GB의 시스템 RAM을 추가하십시오. 단일 사용자 채팅의 경우 16 GB로 충분합니다.' },
            { q: '배치 크기가 VRAM 계산에 영향을 줍니까?', a: '예. 공식은 단일 요청에 대한 VRAM을 계산합니다. 배치 크기는 VRAM을 선형으로 증가시킵니다: 동시 요청이 추가될 때마다 컨텍스트 길이에 따라 약 500 MB~2 GB가 추가됩니다. batch=4로 실행하는 경우 계산된 양에 2~8 GB를 추가하십시오.' },
            { q: '12 GB GPU에서 70B 모델을 실행할 수 있습니까?', a: '극단적 양자화(Q2, 품질 손실 ~70%)와 CPU 오프로딩(매우 느림, 1~3 tokens/sec)을 사용해야만 가능합니다. 실용적이지 않습니다. 더 나은 옵션: 13B 모델 Q4(동일한 VRAM, 훨씬 빠르고 품질도 우수)를 사용하십시오.' },
            { q: '실제 VRAM 사용량이 계산된 값보다 낮으면 어떻게 됩니까?', a: '공식은 보수적이며 오버헤드를 포함합니다. 실제 사용량이 낮다는 것은 배치 처리, 긴 컨텍스트, 또는 안전 마진을 위한 여유 공간이 더 있다는 의미입니다. nvidia-smi를 사용하여 실제 사용량을 측정한 다음 모델을 벤치마크하여 성능을 확인하십시오.' },
          ],
        },
        relatedReading: {
          id: 'related-reading',
        ...
        sources: {
          ...
          title: '출처',
          items: [
            '[GGUF 명세](https://github.com/ggerganov/ggml/blob/master/docs/gguf.md) -- ggerganov/ggml의 양자화 파일 형식 문서.',
            '[Transformers 양자화 문서](https://huggingface.co/docs/transformers/quantization) -- Hugging Face 공식 양자화 방법 가이드.',
            '[Ollama 문서](https://ollama.ai) -- 모델 관리를 위한 공식 Ollama 가이드.',
            '[vLLM 성능 가이드](https://docs.vllm.ai) -- vLLM 프레임워크 최적화 문서.',
            'VRAM이 모델 크기를 제한하지만, 모델 크기만이 출력 품질의 유일한 제한 요소는 아닙니다. 더 큰 컨텍스트 윈도우는 더 나은 응답을 가능하게 합니다: [컨텍스트 윈도우 설명](https://www.promptquorum.com/prompt-engineering/context-windows-explained-why-ai-forgets)에서 제한 안에서 작동하는 방법을 확인하십시오.',
          ],
        },
      },
    },
