...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      seoTitle: 'Mistral Small 24B vs Qwen 2.5 14B vs Llama 3.1 8B: 2026 Benchmarks',
      ...
      metaDescription: 'Mistral Small 24B vs Qwen 2.5 14B vs Llama 3.1 8B: tool calling, reasoning, and coding benchmarks. Full MMLU, HumanEval, MATH comparison. 2026 updated.',
    ...
    de: {
      ...
      metaDescription: 'Mistral Small 24B vs Qwen 2.5 14B vs Llama 3.1 8B: Tool Calling, Reasoning und Coding-Benchmarks. MMLU, HumanEval, MATH-Vergleiche. 2026 aktualisiert.',
      publishDate: '2026-04-04',
      dateModified: '2026-05-03',
...
schema: {
    ...
    fr: {
      ...
      seoTitle: 'Mistral Small 24B vs Qwen 2.5 14B vs Llama 3.1 8B : Benchmarks 2026',
      ...
      metaDescription: 'Mistral Small 24B vs Qwen 2.5 14B vs Llama 3.1 8B : appels d\'outils, raisonnement, programmation. MMLU, HumanEval, MATH comparés. Mis à jour 2026.',
      publishDate: '2026-04-04',
      dateModified: '2026-05-03',
    ...
    ja: {
      ...
      seoTitle: 'Mistral Small 24B vs Qwen 2.5 14B vs Llama 3.1 8B：2026ベンチマーク',
      ...
      metaDescription: 'Mistral Small 24BとQwen 2.5 14BとLlama 3.1 8Bを比較：ツールコーリング、推論、コーディングベンチマーク。MMLU、HumanEval、MATH完全対比。2026年更新。',
      publishDate: '2026-04-04',
      dateModified: '2026-05-03',
      readTime: '9分読込',
      educationalLevel: 'Intermediate',
...
schema: {
    ...
    zh: {
      ...
      seoTitle: 'Mistral Small 24B vs Qwen 2.5 14B vs Llama 3.1 8B：2026基准测试',
      ...
      metaDescription: 'Mistral Small 24B、Qwen 2.5 14B、Llama 3.1 8B：工具调用、推理、编码基准完全对比。MMLU、HumanEval、MATH详细对标。2026年更新。',
      publishDate: '2026-04-04',
      dateModified: '2026-05-03',
      readTime: '9分钟阅读',
      educationalLevel: 'Intermediate',
