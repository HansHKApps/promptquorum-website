...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      sections: {
        ...
        legacyBenchmark: {
          ...
          items: [
            ...
            '**When to upgrade Llama 3.1 8B → Llama 4 Scout**: only if you have ~55 GB+ VRAM at Q4 (Scout\'s 16-expert MoE activates 17B/109B params but needs ~55 GB at Q4; it fits a 24 GB GPU only at 1.78-bit, ~20 tok/s) and you need its 10M-token context (vs Llama 3.3\'s 128K) or multimodal input. On a single 24 GB consumer GPU, Qwen 3.6 27B (fits 24 GB at Q4) is the better upgrade.',
      ...
      schema: {
        ...
        'description': 'Full benchmark comparison: Qwen 3.6 27B (77.2% SWE-bench, best on 24 GB), Llama 4 Scout (MoE, 10M context, ~55 GB VRAM), Mistral Small 24B + legacy Mistral 24B/Qwen 3 14B/Llama 3.1 8B.',
    ...
    es: {
      ...
      schema: {
        ...
        'description': 'Comparativa completa de benchmarks: Qwen 3.6 27B (77,2% SWE-bench, mejor en 24 GB), Llama 4 Scout (MoE, contexto 10M, ~55 GB VRAM), Mistral Small 24B + modelos heredados Mistral 24B/Qwen 3 14B/Llama 3.1 8B.',
    ...
    ar: {
      ...
      schema: {
        ...
        'description': 'مقارنة معايير كاملة: Qwen 3.6 27B (77.2% SWE-bench، الأفضل بـ 24 GB)، Llama 4 Scout (MoE، سياق 10M، ~55 GB VRAM)، Mistral Small 24B + النماذج القديمة Mistral 24B/Qwen 3 14B/Llama 3.1 8B.',
...
schema: {
        ...
        'description': 'Vollständiger Benchmark-Vergleich: Qwen 3.6 27B (77,2% SWE-bench, am besten auf 24 GB), Llama 4 Scout (MoE, 10M context, ~55 GB VRAM), Mistral Small 24B + Legacy-Modelle Mistral 24B/Qwen 3 14B/Llama 3.1 8B.',
    ...
    fr: {
      ...
      sections: {
        ...
        sizeComparison: {
          ...
          content: [
            '**Classes 3B-7B** : Qwen 3.6 7B domine le codage (SWE-bench 58%, HumanEval 89%). Llama 4 3B et Qwen3 8B offrent un bon support écosystème. Pour tâches non-codage, Llama 3.1 8B égale Qwen 3.6 7B en qualité anglaise.',
      ...
      schema: {
        ...
        'description': 'Comparaison complète : Qwen 3.6 27B (77,2% SWE-bench, meilleur sur 24 Go), Llama 4 Scout (MoE, contexte 10M, ~55 Go VRAM), Mistral Small 24B + Mistral 24B/Qwen 3 14B/Llama 3.1 8B legacy.',
...
schema: {
  ...
  ko: {
      ...
      sections: {
        ...
        legacyBenchmark: {
          ...
          items: [
            ...
            '**Llama 3.1 8B → Llama 4 Scout 업그레이드 시기**: Q4에서 ~55 GB+ VRAM이 있는 경우에만(Scout의 16개 전문가 MoE는 17B/109B 파라미터를 활성화하지만 Q4에서 ~55 GB가 필요하고, 1.78비트에서만 24 GB GPU에 맞음, ~20 tok/s) 그리고 10M 토큰 컨텍스트(Llama 3.3의 128K 대비) 또는 멀티모달 입력이 필요한 경우. 단일 24 GB 소비자용 GPU에서는 Qwen 3.6 27B(Q4에서 24 GB 탑재)가 더 나은 업그레이드입니다.',
      ...
      schema: {
        ...
        'description': '전체 벤치마크 비교: Qwen 3.6 27B(77.2% SWE-bench, 24 GB 최고), Llama 4 Scout(MoE, 10M 컨텍스트, ~55 GB VRAM), Mistral Small 24B + 레거시 Mistral 24B/Qwen 3 14B/Llama 3.1 8B.',
        'url': 'https://www.promptquorum.com/local-llms/qwen-vs-llama-vs-mistral',
        'author': { '@type': 'Person', 'name': 'Hans Kuepper', 'sameAs': 'https://www.linkedin.com/in/hanskuepper/' },
        'datePublished': '2026-04-04',
        'dateModified': '2026-06-01',
