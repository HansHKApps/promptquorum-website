      ...
      sections: {
        ...
        legacyBenchmark: {
          ...
          items: [
            ...
            '**When to upgrade Llama 3.1 8B → Llama 4 Scout**: if you have 12 GB+ VRAM (Scout\'s MoE architecture activates 17B/109B params, ~10 GB VRAM), need long-context reasoning (Scout supports 10M tokens vs Llama 3.1\'s 128K), or want frontier-class performance per VRAM (Scout outperforms most dense 13B models).',
            ...
            '• **Have 12+ GB VRAM**: Skip dense models entirely — use Llama 4 Scout (MoE, 10M context) for the best quality-per-VRAM ratio in 2026.',
          ],
        },
        regionalContext: {
          id: 'regional-context',
    ...
    es: {
      ...
      sections: {
        ...
        overview: {
          ...
          rows: [
            ...
            { 'Familia': 'Llama 4', 'Desarrollador': 'Meta', 'Versiones actuales': 'Scout (17B activo/109B MoE, contexto 10M), Maverick (17B activo/400B MoE), Legado: 3.3 70B', 'Licencia': 'Llama Community (personalizada)' },
        ...
        benchmarks: {
          ...
          rows: [
            ...
            { 'Modelo': 'Llama 4 Scout 17B (MoE)', 'MMLU': '—', 'SWE-bench': '—', 'MATH': '—', 'RAM (Q4_K_M)': '~10 GB' },
        ...
        llama: {
          id: 'llama-3',
          title: '¿Por qué Llama 4 es el más versátil?',
          content: [
        ...
        sizeBySizeComparison: {
          ...
          content: [
            ...
            'Qwen, Llama y Mistral cubren el panorama del código abierto. Para una comparativa que incluya alternativas comerciales — GPT-4o, Claude Sonnet 4.6 y Gemini 3.1 Pro — y cuándo elegir propietario frente a código abierto, consulta [cómo elegir el modelo de IA adecuado](https://www.promptquorum.com/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model).',
          ],
          image: '/images/qwen-vs-llama-vs-mistral-size-classes-en.svg',
          imageCaption: 'Cinco clases de LLM local: 3-4B (Llama 4 3B, ~2 GB), 7-8B (Qwen3 8B, ~5 GB), MoE (Llama 4 Scout, ~10 GB), 14-24B (Mistral Small 3.1, ~14 GB), 70-72B (Qwen3 72B, ~43 GB) -- todos ejecutables mediante Ollama.',
        },
        legacyBenchmark: {
          id: 'legacy-benchmark-reference',
        ...
        faqSection: {
          ...
          faqs: [
            { q: '¿Qwen o Llama es mejor para mi caso de uso?', a: 'Para programación y tareas multilingües: Qwen 3.6 27B (77,2% SWE-bench) o Qwen3 8B. Para razonamiento en inglés: Llama 3.3 70B o Llama 4 Scout para eficiencia. Para máxima calidad por GB de RAM: Mistral Small 3.1. Prueba con prompts de ejemplo de tu carga de trabajo real.' },
            ...
            { q: '¿Los tres pueden ejecutarse con 8 GB de VRAM?', a: 'Sí, todos pueden ejecutar modelos de 7B a cuantización Q4 con 8 GB. Qwen3 8B usa ~5 GB, Llama 3.1 8B usa ~5,5 GB, Mistral 7B usa ~4,5 GB a Q4_K_M. Llama 4 Scout (17B activo, MoE) NO cabe en 8 GB — necesita 12 GB.' },
            { q: '¿Necesito una RTX 5090 para ejecutarlos?', a: 'No. La RTX 5070 (12 GB) ejecuta modelos de 7B cómodamente y también gestiona Llama 4 Scout. La RTX 5060 Ti (8 GB) maneja todas las variantes de 7B. La RTX 5090 es exagerada a menos que ejecutes modelos de 70B en producción.' },
      ...
      howToSchema: {
        ...
        'step': [
          ...
          { '@type': 'HowToStep', 'position': 2, 'name': 'Comprueba tus restricciones de hardware', 'text': 'Anota tu VRAM disponible: 5 GB (modelos 8B), 12 GB (Scout/gama media), 16 GB (24B) o 40+ GB (70B+).' },
          { '@type': 'HowToStep', 'position': 3, 'name': 'Revisa las puntuaciones de benchmark', 'text': 'Qwen 3.6 lidera SWE-bench (77,2% a 27B), Qwen3 72B lidera MATH (84%), Llama 4 Scout domina contexto (10M tokens), Mistral maximiza calidad por GB (Small 3.1 a 14 GB).' },
          { '@type': 'HowToStep', 'position': 4, 'name': 'Selecciona el modelo y la variante', 'text': 'Qwen3 para programación/multilingüe, Llama 4 Scout para eficiencia/contexto, Llama 3.3 para razonamiento en inglés, Mistral Small 3.1 para RAM limitada, Devstral para programación agentiva, Codestral para IDE.' },
      ...
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        'name': 'Comparativa de familias de modelos: Qwen3, Llama 4 y Mistral (mayo 2026)',
        'numberOfItems': 10,
        'itemListElement': [
          {
            '@type': 'ListItem',
          ...
          },
          {
            ...
            'position': 3,
            'name': 'Llama 4 Scout 17B (MoE)',
            'description': 'Mejor para contexto largo y eficiencia. 17B activo / 109B total, contexto de 10M tokens, ~10 GB VRAM, arquitectura MoE.'
          },
          {
            '@type': 'ListItem',
            'position': 4,
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '¿Los tres pueden ejecutarse con 8 GB de VRAM?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Sí, todos pueden ejecutar modelos de 7B-8B a cuantización Q4 con 8 GB. Qwen3 8B usa ~5 GB, Llama 3.1 8B usa ~5,5 GB, Mistral 7B usa ~4,5 GB a Q4_K_M. Llama 4 Scout (17B activo, MoE) NO cabe en 8 GB — necesita 12 GB.' } },
      ...
      gammaEmbedUrl: '/presentations/qwen-vs-llama-vs-mistral-static.html',
      gammaDescription: 'La presentación a continuación cubre: comparativa de benchmarks Qwen 3.6 vs Llama 4 Scout vs Mistral (mayo 2026 — SWE-bench, eficiencia MoE), qué modelo gana por tarea (programación, multilingüe, contexto largo, eficiencia de RAM), comparativa por tamaño incluyendo el nivel MoE, Devstral para programación agentiva, Codestral para IDE y comandos de inicio rápido con Ollama. Descarga el PDF como tarjeta de referencia para selección de modelos LLM locales.',
    },
    de: {
      theme: 'Best Models',
      ...
      sections: {
        ...
        sizeComparison: {
          ...
          content: [
            ...
            'Comparaison avec modèles propriétaires : voir [GPT vs Claude vs Gemini : comment choisir](https://www.promptquorum.com/fr/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model).',
          ],
