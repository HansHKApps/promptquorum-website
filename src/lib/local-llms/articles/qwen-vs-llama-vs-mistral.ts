...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      metaDescription: 'Qwen 3.6 27B: 77.2% SWE-bench, best on 24 GB. Llama 4 Scout: MoE, 10M context, ~55 GB VRAM. Mistral Small 3.1: 79% MMLU. Plus Qwen 2.5 14B vs Llama 3.1 8B vs Mistral 24B.',
      ...
      sections: {
        ...
        legacyCallout: {
          ...
          callouts: [
            {
              type: 'info',
              text: '📌 Looking for the older comparison? Jump to Mistral 24B vs Qwen 2.5 14B vs Llama 3.1 8B Legacy Benchmarks below.',
            },
          ],
        },
        overview: {
        ...
        legacyBenchmark: {
          ...
          title: 'Mistral Small 24B vs Qwen 2.5 14B vs Llama 3.1 8B: Legacy Benchmark Reference',
          ...
          items: [
            ...
            '**When to upgrade Llama 3.1 8B → Llama 4 Scout**: only if you have ~55 GB+ VRAM at Q4 (Scout\'s 16-expert MoE activates 17B/109B params but needs ~55 GB at Q4; it fits a 24 GB GPU only at 1.78-bit, ~20 tok/s) and you need its 10M-token context (vs Llama 3.1\'s 128K) or multimodal input. On a single 24 GB consumer GPU, Qwen 3.6 27B (fits 24 GB at Q4) is the better upgrade.',
            ...
            '• **Have 8 GB RAM, doing general chat**: Stay on Llama 3.1 8B or Mistral 7B v0.3.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'Can all three run on 8 GB VRAM?', a: 'Yes, all can run 7B models at Q4 quantization on 8 GB. Qwen3 8B uses ~5 GB, Llama 3.1 8B uses ~5.5 GB, Mistral 7B uses ~4.5 GB at Q4_K_M. Llama 4 Scout (MoE) does NOT fit 8 GB — it needs ~55 GB VRAM at Q4.' },
      ...
      schema: {
        ...
        'description': 'Full benchmark comparison: Qwen 3.6 27B (77.2% SWE-bench, best on 24 GB), Llama 4 Scout (MoE, 10M context, ~55 GB VRAM), Mistral Small 24B + legacy Mistral 24B/Qwen 2.5 14B/Llama 3.1 8B.',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Can all three run on 8 GB VRAM?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, all can run 7B-8B models at Q4 quantization on 8 GB. Qwen3 8B uses ~5 GB, Llama 3.1 8B uses ~5.5 GB, Mistral 7B uses ~4.5 GB at Q4_K_M. Llama 4 Scout (MoE) does NOT fit 8 GB — it needs ~55 GB VRAM at Q4.' } },
    ...
    es: {
      ...
      metaDescription: 'Qwen 3.6 27B: 77,2% SWE-bench, mejor en 24 GB. Llama 4 Scout: MoE, contexto 10M, ~55 GB VRAM. Mistral Small 3.1: 79% MMLU. Más: Qwen 2.5 14B vs Llama 3.1 8B vs Mistral 24B.',
      publishDate: '2026-04-04',
      dateModified: '2026-06-01',
      next_refresh_due: '2026-06-30',
      ...
      sections: {
        ...
        legacyCallout: {
          ...
          callouts: [
            {
              type: 'info',
              text: '📌 ¿Buscas la comparativa anterior? Salta a los benchmarks heredados de Mistral 24B vs Qwen 2.5 14B vs Llama 3.1 8B más abajo.',
            },
          ],
        },
        overview: {
        ...
        benchmarks: {
          ...
          rows: [
            ...
            { 'Modelo': 'Mistral 7B v0.3', 'MMLU': '64%', 'SWE-bench': '—', 'MATH': '28%', 'RAM (Q4_K_M)': '4,5 GB' },
          ],
        ...
        toolCalling: {
          ...
          rows: [
            ...
            { 'Modelo': 'Mistral 7B v0.3', 'Tool Calling': '⚠️ Limitado', 'Razonamiento (MATH)': '28%', 'Mejor para': 'No recomendado para tool calling' },
          ],
        ...
        sizeBySizeComparison: {
          ...
          content: [
            ...
            '**Clase 7B-8B**: Qwen3 8B (~5 GB) y Llama 3.1 8B (~5,5 GB) superan significativamente a Mistral 7B v0.3. Qwen3 8B lidera en [programación](/es/local-llms/best-local-llms-for-coding); Llama 3.1 8B lidera en seguimiento de instrucciones en inglés.',
        ...
        legacyBenchmark: {
          id: 'legacy-benchmark-reference',
          title: 'Mistral Small 24B vs Qwen 2.5 14B vs Llama 3.1 8B: Referencia de benchmarks heredados',
          content: 'Muchos desarrolladores aún ejecutan la generación anterior: Mistral Small 24B (2024), Qwen 2.5 14B (2024) y Llama 3.1 8B (2024). Estos modelos siguen disponibles en Ollama y están ampliamente desplegados en producción. Esta sección los compara directamente para los equipos que aún no han actualizado y explica cuándo tiene sentido actualizar a Qwen 3, Llama 4 o Mistral actual.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: '¿Los tres pueden ejecutarse con 8 GB de VRAM?', a: 'Sí, todos pueden ejecutar modelos de 7B a cuantización Q4 con 8 GB. Qwen3 8B usa ~5 GB, Llama 3.1 8B usa ~5,5 GB, Mistral 7B usa ~4,5 GB a Q4_K_M. Llama 4 Scout (MoE) NO cabe en 8 GB — requiere ~55 GB de VRAM a Q4.' },
      ...
      schema: {
        ...
        'description': 'Comparativa completa de benchmarks: Qwen 3.6 27B (77,2% SWE-bench, mejor en 24 GB), Llama 4 Scout (MoE, contexto 10M, ~55 GB VRAM), Mistral Small 24B + modelos heredados Mistral 24B/Qwen 2.5 14B/Llama 3.1 8B.',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '¿Los tres pueden ejecutarse con 8 GB de VRAM?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Sí, todos pueden ejecutar modelos de 7B-8B a cuantización Q4 con 8 GB. Qwen3 8B usa ~5 GB, Llama 3.1 8B usa ~5,5 GB, Mistral 7B usa ~4,5 GB a Q4_K_M. Llama 4 Scout (MoE) NO cabe en 8 GB — requiere ~55 GB de VRAM a Q4.' } },
    ...
    de: {
      ...
      metaDescription: 'Qwen 3.6 27B: 77,2% SWE-bench, am besten auf 24 GB. Llama 4 Scout MoE: 10M-Kontext, ~55 GB VRAM. Mistral 3.1: 79% MMLU. Qwen 2.5 14B vs Llama 3.1 8B vs Mistral 24B.',
      nextStep: {
      ...
      sections: {
        ...
        legacyCallout: {
          ...
          callouts: [
            {
              type: 'info',
              text: '📌 Suchen Sie den älteren Vergleich? Springen Sie zu Mistral 24B vs Qwen 2.5 14B vs Llama 3.1 8B Legacy Benchmarks unten.',
            },
          ],
        },
        overview: {
...
schema: {
        ...
        'description': 'Vollständiger Benchmark-Vergleich: Qwen 3.6 27B (77,2% SWE-bench, am besten auf 24 GB), Llama 4 Scout (MoE, 10M context, ~55 GB VRAM), Mistral Small 24B + Legacy-Modelle Mistral 24B/Qwen 2.5 14B/Llama 3.1 8B.',
    ...
    fr: {
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '**Débuter sur 8 GB RAM** : Llama 4 3B ou Mistral 7B ; pour 24 GB, Qwen 3.6 27B est le meilleur choix global.',
          ],
        },
        overview: {
      ...
      schema: {
        ...
        'description': 'Comparaison complète : Qwen 3.6 27B (77,2% SWE-bench, meilleur sur 24 Go), Llama 4 Scout (MoE, contexte 10M, ~55 Go VRAM), Mistral Small 24B + Mistral 24B/Qwen 2.5 14B/Llama 3.1 8B legacy.',
