...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      theme: 'Best Models',
      title: 'Qwen3 vs Llama 3.3 vs Mistral in 2026: Full Benchmark Comparison',
      seoTitle: 'Qwen3 vs Llama 3.3 vs Mistral 2026: Benchmarks Compared',
      ...
      toc: [
        ...
        { label: 'Qwen3: Strengths and Weaknesses', anchor: '#qwen2-5' },
      ...
      sections: {
        ...
        benchmarks: {
          ...
          content: 'SWE-bench (real-world multi-file coding) is now more relevant than HumanEval (single-function Python) for evaluating coding models. Llama 4 Scout benchmarks are limited due to its recent release and MoE architecture making direct comparison complex. Dashes indicate benchmarks not yet published or not applicable.',
        },
        qwen: {
          id: 'qwen2-5',
        ...
        byTask: {
          ...
          rows: [
            ...
            { 'Task': 'Beginner first model', 'Winner': 'Llama 3.2 3B', 'Why': 'Best documented, most community support — unchanged' },
          ],
        ...
        sizeBySizeComparison: {
          ...
          content: [
            '**3B-4B class**: Qwen3 3B and Phi-4 Mini 3.8B outperform Llama 3.2 3B on coding and math. For general English use, Llama 3.2 3B is more reliable.',
      ...
      schema: {
        ...
        '@type': 'TechArticle',
        'headline': 'Qwen 3.6 vs Llama 4 Scout vs Mistral 2026: May Benchmark Comparison',
    ...
    de: {
      theme: 'Best Models',
      title: 'Qwen3 vs Llama 3.3 vs Mistral 2026: Vollständiger Benchmark-Vergleich',
      ...
      sections: {
        ...
        llama: {
          ...
          content: [
            ...
            '**Schwächen**: Keine native mehrsprachige Unterstützung jenseits grundlegender Funktionalität; Llama 3.2 3B kann mit Qwen3 3B und Phi-4 Mini beim Coding und bei Mathematik nicht mithalten, obwohl dieselbe Parameteranzahl.',
          ],
        },
        mistral: {
          id: 'mistral',
        ...
        sizeBySizeComparison: {
          ...
          content: [
            '**3B-4B Klasse**: Qwen3 3B und [Phi-4 Mini 3.8B](/local-llms/best-beginner-local-llm-models) übertrumpfen Llama 3.2 3B beim Coding und Mathematik. Für allgemeine englische Nutzung ist Llama 3.2 3B zuverlässiger.',
          ...
          imageCaption: 'Vier lokale LLM-Größenklassen: 3-4B (Llama 3.2 3B, ~2 GB RAM), 7-8B (Qwen3 7B, ~4,7 GB), 14-24B (Mistral Small 3.1, ~14 GB), 70-72B (Qwen3 72B, ~43 GB) -- alle via Ollama.',
        },
        gettingStarted: {
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'Welches Local LLM unterstützt die meisten Sprachen?', a: 'Qwen3 unterstützt nativ 29 Sprachen, darunter Arabisch, Japanisch, Koreanisch, Chinesisch und alle wichtigen europäischen Sprachen. Llama 3.2 unterstützt offiziell 8 Sprachen. Mistral-Modelle konzentrieren sich primär auf Englisch und große europäische Sprachen.' },
            { q: 'Welches Modell sollte ich mit 8 GB RAM wählen?', a: 'Mit 8 GB RAM verwenden Sie Llama 3.2 3B (Q4, ~2 GB) für allgemeine Aufgaben oder Qwen3 7B (Q4, ~4,7 GB) für Coding. Beide laufen mit 15-25 Token/Sec auf einer CPU mit 8 GB RAM. Installieren Sie mit: ollama pull llama3.2:3b oder ollama pull qwen2.5:7b.' },
...
schema: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Was ist das beste GGUF Chat-Modell 2026?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Bei 7B: Llama 3.2 3B-instruct-Q4_K_M oder Qwen3-7B-instruct-Q4_K_M -- beide 72% HumanEval. Bei 14B: Qwen3-14B-instruct-Q4_K_M (75% HumanEval, 9 GB). Bei 24B: Mistral-Small-3.1-24B-instruct-Q4_K_M (74% HumanEval, 14 GB). Beste Qualität Single-GPU: Qwen3-32B-instruct-Q4_K_M (79% HumanEval, 20 GB).' } },
    ...
    fr: {
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '**Débuter sur 8 GB RAM** : Llama 3.2 3B ou Mistral 7B ; Llama 4 Scout déjà disponible sur 12 GB.',
          ],
        },
        overview: {
        ...
        byTask: {
          ...
          rows: [
            ...
            { 'Tâche': 'Premier modèle (débutant)', 'Gagnant': 'Llama 3.2 3B', 'Pourquoi': 'Meilleur documenté, support communautaire maximal' },
          ],
        ...
        sizeComparison: {
          ...
          content: [
            '**Classes 3B-7B** : Qwen 3.6 7B domine le codage (SWE-bench 58%, HumanEval 89%). Llama 3.2 3B et Llama 4 Scout 8B offrent support écosystème le plus large. Pour tâches non-codage, Llama 3.1 8B égale Qwen 3.6 7B en qualité anglaise.',
          ...
          imageCaption: 'Cinq classes de taille mai 2026 : 3-7B (Qwen 3.6 7B codage, Llama 3.2 3B basique), 14-24B (Qwen 14B codage, Mistral 14 GB efficacité), MoE (Llama 4 Scout 10M contexte), 32-72B (Qwen 32B/72B, Llama 3.3 70B), tout via Ollama.',
        },
        howToGetStarted: {
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'Qwen 3.6 remplace-t-il GPT-5.5 pour codage ?', a: 'Partiellement. Qwen 3.6 72B : 92% HumanEval, 77.2% SWE-bench. GPT-5.5 : ~95% HumanEval estimé, 80%+ SWE-bench. Écart 3-5%. Pour refonte simple : Qwen suffisant. Pour refonte complexe : cloud conserve avantage.' },
            ...
            { q: 'Quelle famille pour débuter en mai 2026 ?', a: 'Llama 3.2 3B : meilleure documentation, communauté maximal. Exécutez : ollama run llama3.2:3b (nécessite 8 GB RAM, pas GPU). Chaque outil (Ollama, LM Studio, OpenWebUI) supporte Llama par défaut.' },
          ],
        },
      },
      schema: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Qwen 3.6 remplace-t-il GPT-5.5 pour codage ?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Partiellement. Qwen 3.6 72B : 92% HumanEval, 77.2% SWE-bench. GPT-5.5 : ~95% HumanEval, 80%+ SWE-bench estimé. Écart 3-5%. Refonte simple : Qwen suffisant. Refonte complexe : cloud conserve avantage.' } },
          ...
          { '@type': 'Question', 'name': 'Quelle famille pour débuter en mai 2026 ?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Llama 3.2 3B : meilleure documentation, communauté maximal. Commande : ollama run llama3.2:3b (nécessite 8 GB RAM, pas GPU). Chaque outil (Ollama, LM Studio, OpenWebUI) supporte Llama par défaut.' } },
        ],
      },
      howToSchema: {
        '@context': 'https://schema.org',
        ...
        'step': [
          ...
          { '@type': 'HowToStep', 'name': 'Vérifier VRAM disponible', 'text': '8 GB : Llama 3.2 3B ou Qwen 3.6 7B. 12 GB : Llama 4 Scout MoE (10 GB) ou Qwen 3.6 14B (9 GB). 16 GB : Mistral Small 3.1 24B (14 GB). 40+ GB : Qwen 3.6 72B ou Llama 3.3 70B.' },
      ...
      sections: {
        ...
        llama: {
          ...
          content: [
            ...
            '**弱み**：基本的な機能を超えた多言語ネイティブサポートなし；Llama 3.2 3Bは同じパラメータ数であるにもかかわらずQwen3 3BおよびPhi-4 Miniのコーディングと数学で遅い。',
          ],
        },
        mistral: {
        ...
        sizeBySizeComparison: {
          ...
          content: [
            '**3B～4Bクラス**：Qwen3 3Bおよび[Phi-4 Mini 3.8B](/local-llms/best-beginner-local-llm-models)はLlama 3.2 3Bをコーディングと数学で上回る。一般的な英語使用の場合、Llama 3.2 3Bはより信頼性が高い。',
          ...
          imageCaption: '4つのローカルLLMサイズクラス：3-4B（Llama 3.2 3B、約2GB RAM）、7-8B（Qwen3 7B、約4.7GB）、14-24B（Mistral Small 3.1、約14GB）、70-72B（Qwen3 72B、約43GB）。',
        },
        gettingStarted: {
          title: '各ファミリーで始める方法',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: '最も多くの言語をサポートするLocal LLMはどれですか？', a: 'Qwen3は、アラビア語、日本語、韓国語、中国語、すべての主要ヨーロッパ言語を含む29言語をネイティブにサポート。Llama 3.2は公式に8言語をサポート。Mistralモデルは主に英語と主要ヨーロッパ言語に焦点を当てる。' },
            { q: '8 GB RAMでどのモデルを選ぶべき？', a: '8 GB RAMで、一般的なタスクの場合はLlama 3.2 3B（Q4、〜2 GB）またはコーディングの場合はQwen3 7B（Q4、〜4.7 GB）を使用。どちらも8 GB RAMのCPUで15～25トークン/秒で実行。以下でインストール：ollama pull llama3.2:3b またはollama pull qwen2.5:7b。' },
            ...
            { q: 'Qwen3はコーディングタスク用のGPT-4を置き換えることができますか？', a: '多くの標準コーディングタスク（Python、JavaScript、SQL生成）では、Qwen3 72B（87% HumanEval）は標準ベンチマークでGPT-5.5の5～10%以内で実行。複雑なマルチファイル再構成の場合、クラウドモデルはまだ利点を保持。' },
...
schema: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '2026年の最高のGGUFチャットモデルは何ですか？', 'acceptedAnswer': { '@type': 'Answer', 'text': '7Bで：Llama 3.2 3B-instruct-Q4_K_Mまたはqwen2.5-7B-instruct-Q4_K_M----両者72% HumanEval。14Bで：Qwen3-14B-instruct-Q4_K_M（75% HumanEval、9GB）。24Bで：Mistral-Small-3.1-24B-instruct-Q4_K_M（74% HumanEval、14GB）。最高品質Single-GPU：Qwen3-32B-instruct-Q4_K_M（79% HumanEval、20GB）。' } },
      ...
      sections: {
        ...
        llama: {
          ...
          content: [
            ...
            '**劣势**：基本功能外没有原生多语言支持；Llama 3.2 3B在编码和数学上不及Qwen3 3B和Phi-4 Mini，尽管参数数相同。',
          ],
        },
        mistral: {
        ...
        sizeBySizeComparison: {
          ...
          content: [
            '**3B-4B级**：Qwen3 3B和[Phi-4 Mini 3.8B](/local-llms/best-beginner-local-llm-models)在编码和数学上超越Llama 3.2 3B。对于一般英文使用，Llama 3.2 3B更可靠。',
          ...
          imageCaption: '四种本地LLM规模类别：3-4B（Llama 3.2 3B，约2GB内存）、7-8B（Qwen3 7B，约4.7GB）、14-24B（Mistral Small 3.1，约14GB）、70-72B（Qwen3 72B，约43GB）。',
        },
        gettingStarted: {
          title: '如何开始每个族',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: '哪个本地LLM支持最多语言？', a: 'Qwen3原生支持29种语言，包括阿拉伯语、日语、韩语、中文和所有主要欧洲语言。Llama 3.2官方支持8种语言。Mistral模型主要关注英语和主要欧洲语言。' },
            { q: '8 GB RAM下应选择哪个模型？', a: '有8 GB RAM时，对一般任务使用Llama 3.2 3B（Q4，约2 GB）或编码使用Qwen3 7B（Q4，约4.7 GB）。两者在8 GB RAM的CPU上以15-25令牌/秒运行。安装方式：ollama pull llama3.2:3b 或 ollama pull qwen2.5:7b。' },
            ...
            { q: 'Qwen3能否替代编码任务的GPT-4？', a: '对于许多标准编码任务（Python、JavaScript、SQL生成），Qwen3 72B（87% HumanEval）在标准基准上以5-10%的差距执行GPT-5.5。对于复杂的多文件重构，云模型仍保持优势。' },
...
schema: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '2026年最佳GGUF聊天模型是什么？', 'acceptedAnswer': { '@type': 'Answer', 'text': '7B：Llama 3.2 3B-instruct-Q4_K_M或Qwen3-7B-instruct-Q4_K_M----两者72% HumanEval。14B：Qwen3-14B-instruct-Q4_K_M（75% HumanEval，9GB）。24B：Mistral-Small-3.1-24B-instruct-Q4_K_M（74% HumanEval，14GB）。最佳单GPU质量：Qwen3-32B-instruct-Q4_K_M（79% HumanEval，20GB）。' } },
