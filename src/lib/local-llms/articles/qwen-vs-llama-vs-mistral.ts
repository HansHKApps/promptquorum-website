...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      metaDescription: 'Qwen 3.6 27B: 77.2% SWE-bench, best on 24 GB. Llama 4 Scout: MoE, 10M context, ~55 GB VRAM. Mistral Small 3.1: 79% MMLU. Plus Qwen 2.5 14B vs Llama 3.3 8B vs Mistral 24B.',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '**Legacy models still relevant**: Mistral Small 24B, Qwen 2.5 14B, and Llama 3.3 8B remain widely deployed. The "Legacy Benchmark Reference" section below covers when to upgrade vs when to stay.',
          ],
        },
        legacyCallout: {
          id: 'legacy-callout',
          callouts: [
            {
              type: 'info',
              text: '📌 Looking for the older comparison? Jump to Mistral 24B vs Qwen 2.5 14B vs Llama 3.3 8B Legacy Benchmarks below.',
            },
          ],
        },
        overview: {
        ...
        legacyBenchmark: {
          ...
          title: 'Mistral Small 24B vs Qwen 2.5 14B vs Llama 3.3 8B: Legacy Benchmark Reference',
          content: 'Many developers still run the previous generation: Mistral Small 24B (2024), Qwen 2.5 14B (2024), and Llama 3.3 8B (2024). These models remain available on Ollama and are widely deployed in production. This section compares them directly for teams who haven\'t upgraded yet, and explains when upgrading to Qwen 3, Llama 4, or current Mistral makes sense.',
          ...
          rows: [
            ...
            { Model: 'Qwen 2.5 14B', Parameters: '14B dense', 'RAM (Q4_K_M)': '8 GB', MMLU: '73%', HumanEval: '71%', 'Best For': 'Coding on mid-range hardware' },
          ...
          items: [
            ...
            '**When to upgrade Qwen 2.5 14B → Qwen 3 14B or Qwen 3.6 27B**: if you need SWE-bench performance (Qwen 3.6 27B scores 77.2%, the best dense coding model in 2026), already on 16 GB RAM, or need 29-language native support (Qwen 3 expanded multilingual coverage).',
            ...
            '**Stay on legacy models if**: your fine-tunes are built on Llama 3.3 8B or Qwen 2.5 (migration cost > benefit), production stability matters more than benchmarks (legacy models are battle-tested), or your workload doesn\'t require the new capabilities (general chat, summarization, basic Q&A).',
            '**Quick decision matrix for legacy users**:',
            '• **Have 8 GB RAM, doing general chat**: Stay on Llama 3.3 8B or Mistral Small v0.3.',
            '• **Have 12-16 GB RAM, doing coding**: Upgrade Qwen 2.5 14B → Qwen 3 14B or Qwen 3.6 27B.',
        ...
        updateLog: {
          ...
          title: 'Update Log',
          items: [
            '**2026-05-17:** Added Legacy Benchmark Reference section comparing Mistral Small 24B, Qwen 2.5 14B, and Llama 3.3 8B. Updated title to bridge legacy and current model searches.',
          ],
        },
      },
      schema: {
        ...
        'description': 'Full benchmark comparison: Qwen 3.6 27B (77.2% SWE-bench, best on 24 GB), Llama 4 Scout (MoE, 10M context, ~55 GB VRAM), Mistral Small 24B + legacy Mistral 24B/Qwen 2.5 14B/Llama 3.3 8B.',
    ...
    es: {
      ...
      metaDescription: 'Qwen 3.6 27B: 77,2% SWE-bench, mejor en 24 GB. Llama 4 Scout: MoE, contexto 10M, ~55 GB VRAM. Mistral Small 3.1: 79% MMLU. Más: Qwen 2.5 14B vs Llama 3.3 8B vs Mistral 24B.',
      publishDate: '2026-04-04',
      dateModified: '2026-06-01',
      next_refresh_due: '2026-06-30',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '**Modelos heredados aún relevantes**: Mistral Small 24B, Qwen 2.5 14B y Llama 3.3 8B siguen ampliamente desplegados. La sección "Referencia de benchmarks heredados" a continuación cubre cuándo actualizar versus cuándo quedarse.',
          ],
        },
        legacyCallout: {
          id: 'legacy-callout',
          callouts: [
            {
              type: 'info',
              text: '📌 ¿Buscas la comparativa anterior? Salta a los benchmarks heredados de Mistral 24B vs Qwen 2.5 14B vs Llama 3.3 8B más abajo.',
            },
          ],
        },
        overview: {
        ...
        legacyBenchmark: {
          id: 'legacy-benchmark-reference',
          title: 'Mistral Small 24B vs Qwen 2.5 14B vs Llama 3.3 8B: Referencia de benchmarks heredados',
          content: 'Muchos desarrolladores aún ejecutan la generación anterior: Mistral Small 24B (2024), Qwen 2.5 14B (2024) y Llama 3.3 8B (2024). Estos modelos siguen disponibles en Ollama y están ampliamente desplegados en producción. Esta sección los compara directamente para los equipos que aún no han actualizado y explica cuándo tiene sentido actualizar a Qwen 3, Llama 4 o Mistral actual.',
          ...
          rows: [
            ...
            { Modelo: 'Qwen 2.5 14B', Parámetros: '14B denso', 'RAM (Q4_K_M)': '8 GB', MMLU: '73%', HumanEval: '71%', 'Mejor para': 'Programación en hardware de gama media' },
        ...
        updateLog: {
          ...
          items: [
            '**2026-05-17:** Añadida la sección "Referencia de benchmarks heredados" comparando Mistral Small 24B, Qwen 2.5 14B y Llama 3.3 8B. Título actualizado para conectar búsquedas de modelos heredados y actuales.',
          ],
        },
      },
      schema: {
        ...
        'description': 'Comparativa completa de benchmarks: Qwen 3.6 27B (77,2% SWE-bench, mejor en 24 GB), Llama 4 Scout (MoE, contexto 10M, ~55 GB VRAM), Mistral Small 24B + modelos heredados Mistral 24B/Qwen 2.5 14B/Llama 3.3 8B.',
    ...
    de: {
      ...
      metaDescription: 'Qwen 3.6 27B: 77,2% SWE-bench, am besten auf 24 GB. Llama 4 Scout MoE: 10M-Kontext, ~55 GB VRAM. Mistral 3.1: 79% MMLU. Qwen 2.5 14B vs Llama 3.3 8B vs Mistral 24B.',
      nextStep: {
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '**Legacy-Modelle noch relevant**: Mistral Small 24B, Qwen 2.5 14B und Llama 3.3 8B sind noch weit verbreitet. Der Abschnitt "Legacy Benchmark Reference" unten erklärt, wann ein Upgrade sinnvoll ist.',
          ],
        },
        legacyCallout: {
          id: 'legacy-callout',
          callouts: [
            {
              type: 'info',
              text: '📌 Suchen Sie den älteren Vergleich? Springen Sie zu Mistral 24B vs Qwen 2.5 14B vs Llama 3.3 8B Legacy Benchmarks unten.',
            },
          ],
        },
        overview: {
        ...
        updateLog: {
          ...
          items: [
            '**2026-05-17:** Abschnitt "Legacy Benchmark Reference" hinzugefügt, der Mistral Small 24B, Qwen 2.5 14B und Llama 3.3 8B vergleicht. Titel aktualisiert, um Legacy- und aktuelle Modellsuchen zu überbrücken.',
          ],
        },
      },
schema: {
        ...
        'description': 'Vollständiger Benchmark-Vergleich: Qwen 3.6 27B (77,2% SWE-bench, am besten auf 24 GB), Llama 4 Scout (MoE, 10M context, ~55 GB VRAM), Mistral Small 24B + Legacy-Modelle Mistral 24B/Qwen 2.5 14B/Llama 3.3 8B.',
    ...
    fr: {
      ...
      schema: {
        ...
        'description': 'Comparaison complète : Qwen 3.6 27B (77,2% SWE-bench, meilleur sur 24 Go), Llama 4 Scout (MoE, contexte 10M, ~55 Go VRAM), Mistral Small 24B + Mistral 24B/Qwen 2.5 14B/Llama 3.3 8B legacy.',
