...
schema: {
    ...
    es: {
      ...
      schema: {
        ...
        'url': 'https://www.promptquorum.com/es/es/local-llms/desktop-vs-webui-local-llm',
        'datePublished': '2026-04-04',
    ...
    ar: {
      ...
      seoTitle: 'LM Studio وJan AI مقابل Open WebUI لنماذج LLM المحلية',
      ...
      metaDescription: 'LM Studio وJan AI أسهل للمستخدمين العامين. Open WebUI قابل للمشاركة وأقوى للإنتاج. قارن الميزات والتوافق وقابلية التوسّع في نشر LLM المحلي.',
      publishDate: '2026-04-04',
