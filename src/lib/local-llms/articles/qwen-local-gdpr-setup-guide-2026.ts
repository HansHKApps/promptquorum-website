...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  es: {
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/es/es/local-llms/qwen-local-gdpr-setup-guide-2026',
      inLanguage: 'es',
  ...
  ar: {
    ...
    seoTitle: 'إعداد Qwen محلي متوافق مع GDPR 2026',
    metaDescription: 'دليل خطوة بخطوة لتشغيل Qwen 3 14B محليًا بامتثال GDPR: Ollama، وعزل الشبكة، وتشفير القرص، وسجل تدقيق المادة 30.',
    publishDate: '2026-05-22',
    dateModified: '2026-05-22',
  ...
  pt: {
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/pt/pt/local-llms/qwen-local-gdpr-setup-guide-2026',
      inLanguage: 'pt-BR',
      datePublished: '2026-05-22',
      dateModified: '2026-05-22',
      author: { '@type': 'Person', name: 'Hans Kuepper' },
