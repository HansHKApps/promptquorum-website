  ...
  fr: {
    ...
    sections: {
      ...
      related: {
        ...
        items: [
          '[Meilleurs mini PC Local LLMs](/local-llms/best-mini-pcs-local-llm?lang=fr)',
          '[Guide matériel Local LLM 2026](/local-llms/local-llm-hardware-guide-2026?lang=fr)',
          '[GPU vs CPU vs Apple Silicon](/local-llms/gpu-vs-cpu-vs-apple-silicon?lang=fr)',
          '[Combien VRAM besoin?](/local-llms/how-much-vram-local-llm?lang=fr)',
          '[Meilleurs LLMs locaux 2026](/local-llms/best-local-llms-2026?lang=fr)',
          '[Quantification LLM expliqué](/local-llms/llm-quantization-explained?lang=fr)',
        ],
      },
    },
    supplementalSchema: {
  ...
  ja: {
    ...
    sections: {
      ...
      related: {
        ...
        items: [
          '[最良ミニPCローカルLLM](/local-llms/best-mini-pcs-local-llm?lang=ja)',
          '[ローカルLLMハードウェアガイド2026](/local-llms/local-llm-hardware-guide-2026?lang=ja)',
          '[GPU vs CPU vs Appleシリコン](/local-llms/gpu-vs-cpu-vs-apple-silicon?lang=ja)',
          '[VRAMは何GB必要?](/local-llms/how-much-vram-local-llm?lang=ja)',
          '[最良ローカルLLM 2026](/local-llms/best-local-llms-2026?lang=ja)',
  ...
  zh: {
    ...
    sections: {
      ...
      related: {
        ...
        items: [
          '[最佳本地LLM迷你PC](/local-llms/best-mini-pcs-local-llm?lang=zh)',
          '[本地LLM硬件指南2026](/local-llms/local-llm-hardware-guide-2026?lang=zh)',
          '[GPU vs CPU vs Apple芯片](/local-llms/gpu-vs-cpu-vs-apple-silicon?lang=zh)',
          '[需要多少VRAM?](/local-llms/how-much-vram-local-llm?lang=zh)',
