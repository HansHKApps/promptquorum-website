    ...
    sections: {
      ...
      'why-amd': {
        ...
        items: [
          ...
          '**La iGPU rivaliza con GPUs discretas:** La Radeon 8060S (RDNA 3.5) ofrece cómputo equivalente a la RTX 4070 con una décima parte del consumo eléctrico. Llama 3.1 70B Q4 corre a 20–30 tok/s.',
      ...
      'minisforum-ms-a2': {
        ...
        bestFor: 'Desarrolladores que ejecutan Llama 3.1/4 70B Q4 o modelos Qwen 32B con ventanas de contexto estándar. Equipos que compran varias unidades (Minisforum ofrece precios B2B). Compradores de la UE que priorizan envíos rápidos.',
      ...
      'gmktec-evo-x2': {
        ...
        strengths: [
          ...
          'Rendimiento decente: la Radeon 8050S gestiona Llama 3.1 13B, Mistral 24B y Qwen 14B con fluidez.',
      ...
      benchmarks: {
        ...
        items: [
          ...
          'Llama 3.1 70B (Q4_K_M): Minisforum/Beelink/AOOSTAR ~18–22 tok/s (estimado). GMKtec EVO-X2 ~14–16 tok/s.',
          'Qwen 2.5 32B (Q5_K_M): Minisforum/Beelink/AOOSTAR ~35–40 tok/s. GMKtec ~30 tok/s.',
    ...
    sections: {
      ...
      'why-amd': {
        ...
        items: [
          ...
          '**iGPU rival GPU discrets:** Radeon 8060S (RDNA 3.5) fournit compute classe RTX 4070 à 1/10ème puissance. Llama 3.1 70B Q4 tourne à 20–30 tok/s.',
      ...
      'minisforum-ms-a2': {
        ...
        bestFor: 'Devs exécutant Llama 3.1/3.3 70B Q4 ou modèles Qwen 32B contextes standard. Équipes achetant plusieurs unités. Acheteurs EU priorité livraison rapide.',
      ...
      'gmktec-evo-x2': {
        ...
        strengths: [
          ...
          'Perf adequt: Radeon 8050S gère Llama 3.1 13B, Mistral 24B, Qwen 14B smooth.',
    ...
    sections: {
      ...
      'why-amd': {
        ...
        items: [
          ...
          '**50 TOPS NPU加速(Max+ 395):**LLM推論の重い計算をNPUに委譲→消費電力削減・同時処理向上。Llama 3.1 70B Q4を128GB環境で複数実行可能。',
      ...
      'gmktec-evo-x2': {
        ...
        strengths: [
          ...
          '30–40B推論:Llama 3.1 32B Q4 = 45–55 tok/s。チャット・要約・抽出タスク十分。',
    ...
    sections: {
      ...
      'why-amd': {
        ...
        items: [
          ...
          '**50 TOPS NPU加速(Max+ 395):**LLM重型计算卸载到NPU→降低功耗、提高吞吐量。Llama 3.1 70B Q4在128GB环境可并行运行多个。',
      ...
      'gmktec-evo-x2': {
        ...
        strengths: [
          ...
          '30–40B推理:Llama 3.1 32B Q4 = 45–55 tok/s。聊天、总结、提取任务充分。',
