...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      heroImage: '/images/private-local-ai-for-business-overview-hero-en.png',
...
de: {
      ...
      heroImage: '/images/private-local-ai-for-business-overview-hero-de.png',
...
schema: {
  ...
  fr: {
    ...
    heroImage: '/images/private-local-ai-for-business-overview-hero-fr.png',
...
schema: {
  ...
  ja: {
    ...
    heroImage: '/images/private-local-ai-for-business-overview-hero-ja.png',
...
schema: {
  ...
  zh: {
    ...
    heroImage: '/images/private-local-ai-for-business-overview-hero-zh.png',
...
schema: {
  ...
  es: {
    ...
    heroImage: '/images/private-local-ai-for-business-overview-hero-es.png',
  ...
  ar: {
    ...
    heroImage: '/images/private-local-ai-for-business-overview-hero-ar.png',
  ...
  pt: {
    ...
    heroImage: '/images/private-local-ai-for-business-overview-hero-pt.png',
  ...
  ko: {
    ...
    heroImage: '/images/private-local-ai-for-business-overview-hero-ko.png',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          title: '관련 자료',
          items: [
            '[멀티 GPU 로컬 LLM](/local-llms/multi-gpu-local-llms) -- 여러 GPU에서 추론 확장.',
            '[로컬 LLM 전력 소비](/local-llms/local-llm-power-consumption) -- 냉각 및 인프라 비용.',
            '[로컬 LLM 파인튜닝 LoRA](/local-llms/fine-tuning-local-llms-lora) -- 비즈니스 워크플로우를 위한 커스텀 모델.',
