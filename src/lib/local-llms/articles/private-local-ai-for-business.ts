      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: { '@type': 'Answer', text: 'As of April 2026: Llama 3.3 70B (Apache 2.0, free commercial use <700M users), Qwen 2.5 72B (Apache 2.0), Mistral Small 3.1 24B (Apache 2.0). All three are commercially licensable at no cost.' },
          },
          {
            '@type': 'Question',
...
schema: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Welche Open-Source-Modelle für geschäftliche Nutzung?', acceptedAnswer: { '@type': 'Answer', text: 'April 2026: Llama 3.1 8B (Apache 2.0, kommerziell kostenlos), Qwen 2.5 7B (Apache 2.0), Mistral 7B v0.3 (Apache 2.0). Alle sind kommerziell kostenlos lizenziert.' } },
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Petites équipes (5–20 utilisateurs) : 1× RTX 5090 (32 GB, 1 800 €) pour Llama 3.1 8B ou Mistral 7B. Production (20–100 utilisateurs) : 2× RTX 5090 (64 GB, 3 600 €) pour Llama 3.3 70B via parallélisme tenseur. Entreprise (100+ utilisateurs) : 4× RTX 5090 ou 2× A100 80GB (7 200–27 000 €) pour concurrence élevée + RAG. Budget réseau, refroidissement et alimentations redondantes.'
            },
            {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Avril 2026 : Llama 3.1 8B (Apache 2.0, gratuit usage commercial), Qwen 2.5 7B (Apache 2.0), Mistral 7B v0.3 (Apache 2.0). Tous trois commercialement licenciables gratuitement.'
            }
          },
          {
            '@type': 'Question',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: '小規模チーム（5–20ユーザー）： 1× RTX 5090（32 GB、¥235,000）Llama 3.1 8B または Mistral 7B 用。本番環境（20–100ユーザー）： 2× RTX 5090（64 GB、¥470,000）テンソル並列処理経由で Llama 3.3 70B 用。エンタープライズ（100+ ユーザー）： 4× RTX 5090 または 2× A100 80GB（¥940,000–¥3,555,000）高同時実行 + RAG 用。ネットワーク、冷却、冗長電源を予算化します。'
            },
            {
            ...
            },
            {
              ...
              a: '2026年4月のビジネスデプロイメント ： Llama 3.3 70B（Meta、Llama Community License — 7億ユーザー未満の商用利用無料）、Qwen2.5 72B（Alibaba、Apache 2.0）、Mistral Small 3.1 24B（Mistral AI、Apache 2.0）。小規模デプロイメント ： Llama 3.1 8B、Qwen2.5 7B、Phi-4 Mini 3.8B。すべて商用ライセンス無料。本番デプロイ前にライセンスを確認します。'
            },
            {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: '2026年4月 ： Llama 3.1 8B（Apache 2.0、商用無料）、Qwen 2.5 7B（Apache 2.0）、Mistral 7B v0.3（Apache 2.0）。すべて3つとも商用ライセンス無料です。'
            }
          },
          {
            '@type': 'Question',
      ...
      sections: {
        ...
        faqSection: {
          ...
          faqs: [
            ...
            {
              q: '本地AI部署需要什么硬件？',
              a: '小型团队（5–20用户）：1× RTX 5090（32 GB，$2,000）用于Llama 3.1 8B或Mistral 7B。生产（20–100用户）：2× RTX 5090（64 GB，$4,000）通过张量并行处理Llama 3.3 70B。企业（100+用户）：4× RTX 5090或2× A100 80GB（$8K–$30K）用于高并发 + RAG。预算网络、冷却和冗余电源。'
            },
            {
              q: '如何使用本地LLM满足金融合规要求？',
            ...
            {
              q: '哪些开源模型最适合业务使用？',
              a: '2026年4月业务部署：Llama 3.3 70B（Meta、Llama Community License——商业使用免费），Qwen2.5 72B（Alibaba、Apache 2.0），Mistral Small 3.1 24B（Mistral AI、Apache 2.0）。小型部署：Llama 3.1 8B、Qwen2.5 7B、Phi-4 Mini 3.8B。全部商业许可免费。生产部署前验证许可。'
            },
            {
              q: '本地AI vs 云API的延迟？',
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: '2026年4月：Llama 3.1 8B（Apache 2.0、商用免费）、Qwen 2.5 7B（Apache 2.0）、Mistral 7B v0.3（Apache 2.0）。全部三个商用许可免费。'
            }
          },
          {
            '@type': 'Question',
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: { '@type': 'Answer', text: 'En abril de 2026: Llama 3.3 70B (Apache 2.0, uso comercial gratuito <700M usuarios), Qwen 2.5 72B (Apache 2.0), Mistral Small 3.1 24B (Apache 2.0). Los tres tienen licencia comercial sin coste.' },
          },
          {
            '@type': 'Question',
