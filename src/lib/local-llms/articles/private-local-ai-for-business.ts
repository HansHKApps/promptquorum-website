...
schema: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Welche Open-Source-Modelle für geschäftliche Nutzung?', acceptedAnswer: { '@type': 'Answer', text: 'April 2026: Llama 3.3 8B (Apache 2.0, kommerziell kostenlos), Qwen 2.5 7B (Apache 2.0), Mistral Small v0.3 (Apache 2.0). Alle sind kommerziell kostenlos lizenziert.' } },
