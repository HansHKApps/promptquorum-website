    ...
    es: {
      ...
      sections: {
        ...
        faqSection: {
          ...
          faqs: [
            ...
            {
              q: '¿Cómo se compara la calidad local 70B con GPT-4o?',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '¿Cómo se compara la calidad local 70B con GPT-4o?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'En los benchmarks MMLU y HumanEval, Llama 3.3 70B (82%, 88%) y Qwen2.5 72B (84%, 87%) igualan o superan ligeramente los puntajes de GPT-4 (2023). GPT-4o (2024) puntúa más alto en tareas intensivas en razonamiento. Para seguimiento general de instrucciones, resumen y generación de código, los modelos locales 70B son competitivos con GPT-4o en la mayoría de tareas.' } },
