      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[حاسوب لـ LLM محلي بأقل من 1000 دولار](/ar/local-llms/local-llm-pc-build-1000) -- دليل عتاد اقتصادي لنماذج 7B-13B عندما يكون عتاد 70B خارج الميزانية',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[1000달러 미만 로컬 LLM PC 빌드](/local-llms/local-llm-pc-build-1000) — 70B 하드웨어 예산이 부족할 때 7B~13B 모델을 위한 예산 하드웨어 가이드',
