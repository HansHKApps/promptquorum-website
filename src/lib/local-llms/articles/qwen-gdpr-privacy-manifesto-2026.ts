...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'Qwen 3 وGDPR في الاتحاد الأوروبي 2026: امتثال محلي',
    ...
    metaDescription: 'Qwen 3 محليًا يلغي نقل البيانات بموجب المادة 44 من GDPR — صفر مخاطر النقل عبر الحدود. متطلبات إقامة البيانات في الاتحاد الأوروبي 2026.',
    publishDate: '2026-05-16',
    dateModified: '2026-05-16',
