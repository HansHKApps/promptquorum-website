...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    metaDescription: 'Qwen 3 المنشور محليًا يلغي نقل البيانات بموجب المادة 44 من GDPR — بياناتك لا تغادر خادمك. Apache 2.0، 92.1% HumanEval، 16 GB VRAM، متوافق بالتصميم.',
    publishDate: '2026-05-16',
    dateModified: '2026-05-16',
