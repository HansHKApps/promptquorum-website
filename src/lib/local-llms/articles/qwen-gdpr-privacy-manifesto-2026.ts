...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    seoTitle: 'Local LLMs: GDPR Compliance & Open Weights 2026',
    ...
    metaDescription: 'Why open-weight models like Qwen 3.6 27B are GDPR-compliant by design. Local deployment eliminates Article 44 transfers, provides data sovereignty for EU organisations.',
