...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  es: {
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/es/es/local-llms/qwen-gdpr-privacy-manifesto-2026',
      inLanguage: 'es',
  ...
  ar: {
    ...
    seoTitle: 'Qwen 3 وGDPR: هل يمكنك استخدامه في الاتحاد الأوروبي 2026؟',
    ...
    metaDescription: 'Qwen 3 المنشور محليًا يلغي مشكلات النقل بموجب المادة 44 من GDPR: البيانات لا تغادر خادمك أبدًا. إقامة البيانات في الاتحاد الأوروبي.',
    publishDate: '2026-05-16',
    dateModified: '2026-05-16',
