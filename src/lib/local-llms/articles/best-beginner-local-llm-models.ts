...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      intro: 'The five best local LLM models for beginners in 2026 are Meta Llama 3.2 3B, Microsoft Phi-4 Mini, Google Gemma 3 2B, Mistral Small v0.3, and Qwen2.5 7B. Each runs on consumer hardware with 4-8 GB of RAM and produces output quality suitable for everyday tasks.',
      leadAnswerBlock: '**The five best local LLM models for beginners in 2026 are Llama 3.2 3B, Phi-4 Mini 3.8B, Gemma 3 2B, Mistral Small v0.3, and Qwen2.5 7B. All run on 4-8 GB RAM with a single Ollama command.**',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Best 7B all-rounder: **Mistral Small v0.3** -- reliable, function calling support, and Apache 2.0 licence. As of April 2026, Qwen2.5 7B outperforms it on coding and Llama 3.3 8B leads on English reasoning at the same RAM tier.',
            'Best for multilingual and coding: **Qwen2.5 7B** -- outperforms Mistral Small on coding benchmarks and supports 29 languages natively.',
        ...
        mistral7b: {
          ...
          content: [
            '**Mistral Small v0.3 is a reliable general-purpose 7B model with a clean instruction format and function calling support.** As of April 2026, Qwen2.5 7B outperforms it on coding benchmarks and Llama 3.3 8B leads on English reasoning -- but Mistral Small remains a strong choice for EU data sovereignty contexts because Mistral AI is a French company with Apache 2.0 licensing on this model.',
        ...
        qwen25: {
          ...
          content: [
            '**Qwen2.5 7B outperforms Mistral Small on HumanEval (coding) and MBPP benchmarks and natively supports 29 languages including Chinese, Japanese, Korean, Arabic, and all major European languages.** It is the recommended choice for non-English workflows or coding-heavy use cases.',
            'Qwen2.5 7B uses a 128K context window (vs. 32K for Mistral Small) and supports structured output with JSON mode. The model is available in instruct and base variants -- for chat use, always use the instruct version. See the [Qwen vs Llama vs Mistral benchmark comparison](/local-llms/qwen-vs-llama-vs-mistral) for detailed benchmark data.',
          ],
          rows: [
            { 'Spec': 'Parameters', 'Value': '7B' },
        ...
        whichToStart: {
          ...
          imageCaption: 'RAM-based model selection guide -- Gemma 2 2B at ≤4 GB RAM, Llama 3.2 3B at 8 GB (best first model), Qwen2.5 7B at 8 GB+ for multilingual and coding workloads. All run via `ollama run` with no manual configuration.',
        },
        regionalContext: {
          id: 'regional-context',
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Choosing Mistral Small as the default 7B model:** Mistral Small v0.3 was the community standard in 2023-2024 but is now outperformed by Qwen2.5 7B on coding and Llama 3.3 8B on English tasks at the same RAM requirement. If your tool defaults to `ollama run mistral`, switch to `ollama run qwen2.5:7b` or `ollama run llama3.2` for better results without increasing RAM.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Yes for: summarization, simple Q&A, basic code explanation, and conversational chat. No for: multi-step reasoning, complex coding, and long-form structured writing. For those tasks, upgrade to Llama 3.3 8B or Qwen2.5 7B with 8 GB RAM.',
            },
            {
            ...
            },
            {
              ...
              a: 'Qwen2.5 7B leads on HumanEval among the five models. For even better coding, use the dedicated code variant: `ollama run qwen2.5-coder:7b`. Phi-4 Mini 3.8B is the best coding model if limited to 4-6 GB RAM (70% HumanEval at 2.5 GB RAM).',
            },
            {
...
schema: {
      ...
      gammaDescription: 'Interactive 14-slide deck: 5 best beginner local LLM models for 2026 -- Llama 3.2 3B (2.5 GB RAM), Phi-4 Mini (2.5 GB), Gemma 3 2B (1.7 GB), Mistral Small (4.5 GB), Qwen2.5 7B (4.7 GB). Covers model comparison table, RAM decision guide, regional compliance (EU/Japan/China), common mistakes, and first-run steps. Download the PDF as a beginner local LLM reference card.',
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
    ...
    es: {
      ...
      intro: 'Los cinco mejores modelos LLM locales para principiantes en 2026 son Meta Llama 3.2 3B, Microsoft Phi-4 Mini, Google Gemma 3 2B, Mistral Small v0.3 y Qwen2.5 7B. Cada uno funciona en hardware de consumo con 4-8 GB de RAM y produce calidad de salida adecuada para tareas cotidianas.',
      leadAnswerBlock: '**Los cinco mejores modelos LLM locales para principiantes en 2026 son Llama 3.2 3B, Phi-4 Mini 3.8B, Gemma 3 2B, Mistral Small v0.3 y Qwen2.5 7B. Todos funcionan con 4-8 GB de RAM con un solo comando de Ollama.**',
      ...
      toc: [
        ...
        { label: '#5 Qwen2.5 7B -- Mejor para multilingüe', anchor: '#qwen2-5-7b' },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Mejor modelo 7B todoterreno: **Mistral Small v0.3** -- fiable, con soporte de llamadas a funciones y licencia Apache 2.0. A partir de abril de 2026, Qwen2.5 7B lo supera en codificación y Llama 3.3 8B lidera en razonamiento en inglés en el mismo nivel de RAM.',
            'Mejor para multilingüe y codificación: **Qwen2.5 7B** -- supera a Mistral Small en benchmarks de codificación y soporta 29 idiomas de forma nativa.',
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Guía de despliegue local de Qwen (2026)](/es/local-llms/qwen-local-deployment-guide-2026) -- Configuración de Qwen2.5 7B para principiantes mediante Ollama: un comando para empezar.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Sí para: resúmenes, preguntas y respuestas simples, explicación básica de código y chat conversacional. No para: razonamiento de varios pasos, codificación compleja y escritura estructurada larga. Para esas tareas, actualiza a Llama 3.3 8B o Qwen2.5 7B con 8 GB de RAM.',
            },
            {
            ...
            },
            {
              ...
              a: 'Qwen2.5 7B lidera en HumanEval entre los cinco modelos. Para una codificación aún mejor, usa la variante de código dedicada: `ollama run qwen2.5-coder:7b`. Phi-4 Mini 3.8B es el mejor modelo de codificación si estás limitado a 4-6 GB de RAM (70% HumanEval con 2,5 GB de RAM).',
            },
            {
              q: '¿Qué modelo debo usar para idiomas distintos al inglés?',
              a: 'Qwen2.5 7B soporta 29 idiomas de forma nativa, incluyendo chino, japonés, coreano, árabe y todos los principales idiomas europeos. Procesa texto en idiomas distintos al inglés de forma más eficiente que Llama o Mistral.',
            },
            {
      ...
      gammaEmbedUrl: '/presentations/best-beginner-local-llm-models-static.html',
      gammaDescription: 'Presentación interactiva de 14 diapositivas: 5 mejores modelos LLM locales para principiantes en 2026 -- Llama 3.2 3B (2,5 GB RAM), Phi-4 Mini (2,5 GB), Gemma 3 2B (1,7 GB), Mistral Small (4,5 GB), Qwen2.5 7B (4,7 GB). Cubre tabla de comparación de modelos, guía de decisión por RAM, cumplimiento regional (UE/Japón/China), errores comunes y primeros pasos. Descarga el PDF como tarjeta de referencia de LLM local para principiantes.',
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 5, name: 'Qwen2.5 7B', description: '4,7 GB RAM. 10-18 tok/s CPU. Contexto de 128K. Mejor codificación + multilingüe. ollama run qwen2.5:7b' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
    ...
    de: {
      ...
      intro: 'Die fünf besten lokalen LLM-Modelle für Einsteiger in 2026 sind Meta Llama 3.2 3B, Microsoft Phi-4 Mini, Google Gemma 3 2B, Mistral Small v0.3 und Qwen2.5 7B. Jedes läuft auf Consumer-Hardware mit 4–8 GB RAM und erzeugt Ausgabequalität, die für alltägliche Aufgaben geeignet ist. Llama 3.2 3B benötigt 2,5 GB RAM bei 25–45 Tok/s. Phi-4 Mini erreicht 68 % MMLU und 70 % HumanEval bei nur 2,5 GB RAM. Gemma 3 2B läuft mit 1,7 GB bei 40–60 Tok/s – das schnellste Modell dieser Liste.',
      leadAnswerBlock: '**Die fünf besten lokalen LLM-Modelle für Einsteiger in 2026 sind Llama 3.2 3B, Phi-4 Mini 3.8B, Gemma 3 2B, Mistral Small v0.3 und Qwen2.5 7B. Alle laufen auf 4–8 GB RAM und starten mit einem einzigen Ollama-Befehl.**',
      ...
      toc: [
        ...
        { label: '#5 Qwen2.5 7B – Bestes für Mehrsprachigkeit', anchor: '#qwen2-5-7b' },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Bestes 7B-Allround-Modell: **Mistral Small v0.3** – zuverlässig, Function-Calling-Unterstützung und Apache-2.0-Lizenz. Stand April 2026 übertrifft Qwen2.5 7B es bei Coding-Benchmarks und Llama 3.3 8B beim englischen Reasoning auf demselben RAM-Niveau.',
            'Bestes Modell für Mehrsprachigkeit und Coding: **Qwen2.5 7B** – übertrifft Mistral Small bei Coding-Benchmarks und unterstützt nativ 29 Sprachen.',
          ],
        },
        quickStart: {
          id: 'quick-start',
        ...
        qwen25: {
          ...
          content: [
            '**Qwen2.5 7B übertrifft Mistral Small bei HumanEval (Coding) und MBPP-Benchmarks und unterstützt nativ 29 Sprachen, darunter Chinesisch, Japanisch, Koreanisch, Arabisch und alle wichtigen europäischen Sprachen.** Es ist die empfohlene Wahl für nicht-englische Workflows oder coding-intensive Anwendungsfälle.',
            'Qwen2.5 7B verwendet ein 128K-Kontextfenster (vs. 32K bei Mistral Small) und unterstützt strukturierte Ausgaben mit JSON-Modus. Das Modell ist in Instruct- und Base-Varianten verfügbar – für Chat-Nutzung immer die Instruct-Version verwenden. Siehe den [Qwen vs Llama vs Mistral Benchmark-Vergleich](/de/local-llms/qwen-vs-llama-vs-mistral) für detaillierte Benchmark-Daten.',
          ],
          rows: [
            { 'Spezifikation': 'Parameter', 'Wert': '7B' },
        ...
        fullComparison: {
          ...
          rows: [
            ...
            { 'Modell': 'Qwen2.5 7B', 'RAM': '4,7 GB', 'Geschwindigkeit (CPU)': '10–18 Tok/s', 'Kontext': '128K', 'Einsatzgebiet': 'Mehrsprachigkeit, Coding' },
          ],
        ...
        whichToStart: {
          ...
          imageCaption: 'RAM-basierter Modell-Auswahlführer – Gemma 3 2B bei ≤4 GB RAM, Llama 3.2 3B bei 8 GB (bestes erstes Modell), Qwen2.5 7B bei 8 GB+ für mehrsprachige und Coding-Workflows. Alle starten mit `ollama run` ohne manuelle Konfiguration.',
        },
        regionalContext: {
          id: 'regional-context',
          ...
          faqs: [
            {
              ...
              a: 'Llama 3.2 3B für die meisten Benutzer – läuft auf jeder Maschine mit 4 GB RAM, lädt in unter 5 Minuten herunter und bietet starke Anweisungsverarbeitung. Bei 8 GB RAM bietet Qwen2.5 7B bessere Coding- und Mehrsprachigkeits-Leistung. Für absolut niedrigsten RAM läuft Gemma 3 2B mit 1,7 GB bei 40–60 Tok/s auf der CPU.',
            },
            {
            ...
            },
            {
              ...
              a: 'Ja für: Zusammenfassungen, einfaches Q&A, grundlegende Code-Erklärungen und konversationellen Chat. Nein für: mehrstufiges Reasoning, komplexes Coding und langes strukturiertes Schreiben. Für diese Aufgaben upgraden Sie auf Llama 3.3 8B oder Qwen2.5 7B mit 8 GB RAM.',
            },
            {
            ...
            },
            {
              ...
              a: 'Qwen2.5 7B führt bei HumanEval unter den fünf Modellen. Für noch besseres Coding verwenden Sie die dedizierte Code-Variante: `ollama run qwen2.5-coder:7b`. Phi-4 Mini 3.8B ist das beste Coding-Modell, wenn Sie auf 4–6 GB RAM beschränkt sind (70 % HumanEval bei 2,5 GB RAM).',
            },
            {
              q: 'Welches Modell sollte ich für nicht-englische Sprachen verwenden?',
              a: 'Qwen2.5 7B unterstützt nativ 29 Sprachen, darunter Chinesisch, Japanisch, Koreanisch, Arabisch und alle wichtigen europäischen Sprachen. Es verarbeitet nicht-englische Texte effizienter als Llama oder Mistral.',
            },
            {
            ...
            },
            {
              ...
              a: 'Ja – lokale LLMs via Ollama eignen sich besonders gut für KMU, die sensible Geschäftsdaten schützen müssen. Kein Datentransfer an Cloud-APIs bedeutet weniger Compliance-Risiko und niedrigere laufende Kosten. Für den Mittelstand empfiehlt sich Mistral Small v0.3 (EU-Herkunft, Apache 2.0) für regulierte Bereiche oder Qwen2.5 7B für mehrsprachige und Coding-Workflows. Die BSI-IT-Grundschutz-Kompendium-Anforderungen für den Einsatz von KI-Systemen werden durch lokal ausgeführte, versionierte Modelle erfüllt.',
            },
            {
...
schema: {
      ...
      gammaEmbedUrl: '/presentations/best-beginner-local-llm-models-static.html',
      gammaDescription: 'Interaktives 14-Folien-Deck: 5 beste Einsteiger-LLMs 2026 — Llama 3.2 3B (2,5 GB RAM), Phi-4 Mini (2,5 GB), Gemma 3 2B (1,7 GB), Mistral Small (4,5 GB), Qwen2.5 7B (4,7 GB). Vergleichstabelle, RAM-Entscheidungsleitfaden, regionale Compliance und erste Schritte. PDF als Referenzkarte herunterladen.',
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 5, 'name': 'Qwen2.5 7B', 'description': '4,7 GB RAM. 10–18 Tok/s CPU. 128K-Kontext. Bestes Coding + Mehrsprachigkeit. ollama run qwen2.5:7b' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Welches Modell ist am besten für Coding-Aufgaben?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Qwen2.5 7B führt bei HumanEval. Für noch besseres Coding: `ollama run qwen2.5-coder:7b`. Phi-4 Mini ist das beste Coding-Modell bei 4–6 GB RAM (70 % HumanEval bei 2,5 GB RAM).' } },
          { '@type': 'Question', 'name': 'Welches Modell sollte ich für nicht-englische Sprachen verwenden?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Qwen2.5 7B unterstützt nativ 29 Sprachen, darunter Chinesisch, Japanisch, Koreanisch, Arabisch und alle wichtigen europäischen Sprachen.' } },
    ...
    fr: {
      ...
      intro: 'Les cinq meilleurs modèles LLM locaux pour débutants en 2026 sont Meta Llama 3.2 3B, Microsoft Phi-4 Mini, Google Gemma 3 2B, Mistral Small v0.3 et Qwen2.5 7B. Chacun fonctionne sur du matériel grand public avec 4–8 Go de RAM. Llama 3.2 3B utilise 2.5 Go RAM à 25–45 tok/s. Phi-4 Mini atteint 68 % MMLU et 70 % HumanEval avec seulement 2.5 Go RAM. Gemma 3 2B tourne avec 1.7 Go à 40–60 tok/s — le modèle le plus rapide de cette liste.',
      leadAnswerBlock: '**Les cinq meilleurs modèles LLM locaux pour débutants en 2026 sont Llama 3.2 3B, Phi-4 Mini 3.8B, Gemma 3 2B, Mistral Small v0.3 et Qwen2.5 7B. Tous fonctionnent avec 4–8 Go de RAM et se lancent avec une seule commande Ollama.**',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Meilleur 7B polyvalent : **Mistral Small v0.3** — fiable, prise en charge des appels de fonction, licence Apache 2.0. Qwen2.5 7B le surpasse en code et Llama 3.3 8B en raisonnement anglais.',
            'Meilleur pour le multilingue et le code : **Qwen2.5 7B** — surpasse Mistral Small sur les benchmarks de code et supporte 29 langues nativement.',
          ],
        },
        quickStart: {
          id: 'quick-start',
        ...
        mistral7b: {
          ...
          content: [
            '**Mistral Small v0.3 est un modèle 7B polyvalent fiable avec un format d\'instructions clair et la prise en charge des appels de fonction.** Qwen2.5 7B le surpasse sur les benchmarks de code et Llama 3.3 8B en raisonnement anglais — mais Mistral Small reste un choix solide pour les contextes de souveraineté des données en UE, Mistral AI étant une entreprise française avec une licence Apache 2.0.',
        ...
        qwen25: {
          ...
          content: [
            '**Qwen2.5 7B surpasse Mistral Small sur HumanEval (code) et les benchmarks MBPP, et supporte nativement 29 langues dont le chinois, le japonais, le coréen, l\'arabe et toutes les principales langues européennes.** C\'est le choix recommandé pour les workflows non-anglophones ou intensifs en code.',
            'Qwen2.5 7B utilise une fenêtre de contexte de 128K (contre 32K pour Mistral Small) et supporte les sorties structurées avec le mode JSON. Pour les données de benchmarks détaillées, consultez la [comparaison Qwen vs Llama vs Mistral](/fr/local-llms/qwen-vs-llama-vs-mistral).',
          ],
          rows: [
            { 'Spécification': 'Paramètres', 'Valeur': '7B' },
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Choisir Mistral Small comme modèle par défaut :** Mistral Small v0.3 était le standard communautaire en 2023–2024 mais est maintenant surpassé par Qwen2.5 7B en code et Llama 3.3 8B en anglais. Passez à `ollama run qwen2.5:7b` ou `ollama run llama3.2` pour de meilleurs résultats.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Oui pour : synthèse, Q&A simple, explication de code de base, chat. Non pour : raisonnement multi-étapes, code complexe, rédaction structurée longue. Pour ces tâches, passez à Llama 3.3 8B ou Qwen2.5 7B avec 8 Go de RAM.',
            },
            {
...
schema: {
    ...
    ja: {
      ...
      intro: '2026年の初心者向けローカルLLMベスト5は、Meta Llama 3.2 3B、Microsoft Phi-4 Mini、Google Gemma 3 2B、Mistral Small v0.3、Qwen2.5 7Bです。すべて4〜8 GBのRAMで動作します。Llama 3.2 3Bは2.5 GB RAMで25〜45トークン/秒。Phi-4 Miniは2.5 GB RAMで68% MMLU・70% HumanEvalを達成。Gemma 3 2Bは1.7 GBで40〜60トークン/秒——このリストで最速です。',
      leadAnswerBlock: '**2026年の初心者向けローカルLLMベスト5はLlama 3.2 3B、Phi-4 Mini 3.8B、Gemma 3 2B、Mistral Small v0.3、Qwen2.5 7Bです。4〜8 GB RAMで動作し、Ollamaコマンド1つで起動できます。**',
      ...
      toc: [
        ...
        { label: '#5 Qwen2.5 7B — 多言語対応に最適', anchor: '#qwen2-5-7b' },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '最良の7Bオールラウンダー：**Mistral Small v0.3** — 信頼性が高く、Function Calling対応、Apache 2.0ライセンス。2026年4月時点でQwen2.5 7Bがコーディングで、Llama 3.3 8Bが英語推論で上回る。',
            '多言語・コーディングに最適：**Qwen2.5 7B** — コーディングベンチマークでMistral Smallを超え、29言語にネイティブ対応。',
          ],
        },
        quickStart: {
          id: 'quick-start',
        ...
        mistral7b: {
          ...
          content: [
            '**Mistral Small v0.3は明確な指示フォーマットとFunction Calling対応を持つ信頼性の高い汎用7Bモデルです。** 2026年4月時点でQwen2.5 7Bがコーディングベンチマークで、Llama 3.3 8Bが英語推論で上回っていますが——Mistral AIがApache 2.0ライセンスのフランス企業であるため、EUデータ主権の文脈で依然として有力な選択肢です。',
        ...
        qwen25: {
          ...
          content: [
            '**Qwen2.5 7BはHumanEval（コーディング）とMBPPベンチマークでMistral Smallを超え、中国語・日本語・韓国語・アラビア語・主要欧州語を含む29言語にネイティブ対応しています。** 非英語ワークフローやコーディング主体のユースケースに推奨される選択肢です。',
            'Qwen2.5 7Bは128Kコンテキストウィンドウ（Mistral Smallの32Kと比較）を使用し、JSONモードによる構造化出力をサポートします。モデルはInstructバージョンとBaseバージョンで利用可能——チャット用途には必ずInstructバージョンを使用してください。詳細なベンチマークデータは[Qwen vs Llama vs Mistralベンチマーク比較](/ja/local-llms/qwen-vs-llama-vs-mistral)を参照。',
          ],
          rows: [
            { 'スペック': 'パラメータ数', '値': '7B' },
        ...
        fullComparison: {
          ...
          rows: [
            ...
            { 'モデル': 'Qwen2.5 7B', 'RAM': '4.7 GB', '速度（CPU）': '10〜18トークン/秒', 'コンテキスト': '128K', '最適用途': '多言語・コーディング' },
          ],
        ...
        whichToStart: {
          ...
          imageCaption: 'RAMに基づくモデル選択ガイド — ≤4 GB RAMでGemma 3 2B、8 GBでLlama 3.2 3B（最初のモデルとして最適）、8 GB+で多言語・コーディング用途にQwen2.5 7B。すべて手動設定なしで`ollama run`で起動。',
        },
        regionalContext: {
          id: 'regional-context',
          title: '地域に応じたモデル選択は？',
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Mistral Smallをデフォルトの7Bモデルに選ぶ：** Mistral Small v0.3は2023〜2024年のコミュニティ標準でしたが、現在はコーディングでQwen2.5 7Bに、英語タスクでLlama 3.3 8Bに同じRAM要件で上回られています。ツールがデフォルトで`ollama run mistral`を使う場合、RAMを増やさずに良い結果を得るために`ollama run qwen2.5:7b`または`ollama run llama3.2`に切り替えてください。',
          ...
          faqs: [
            {
              ...
              a: 'ほとんどのユーザーにはLlama 3.2 3B——4 GB RAMのどのマシンでも動作し、5分以内にダウンロードでき、優れた指示追従出力を提供します。8 GB RAMにはQwen2.5 7Bがより良いコーディングと多言語性能を提供。最低RAMにはGemma 3 2Bが1.7 GBでCPUで40〜60トークン/秒で動作。',
            },
            {
            ...
            },
            {
              ...
              a: '可：要約、シンプルなQ&A、基本的なコード説明、会話チャット。不可：多段階推論、複雑なコーディング、長形式の構造化文章作成。それらのタスクには8 GB RAMでLlama 3.3 8BまたはQwen2.5 7Bにアップグレード。',
            },
            {
            ...
            },
            {
              ...
              a: 'Qwen2.5 7Bが5モデルの中でHumanEvalをリード。さらに良いコーディングには専用コードバリアントを使用：`ollama run qwen2.5-coder:7b`。4〜6 GB RAMに限定される場合はPhi-4 Mini 3.8Bが最良のコーディングモデル（2.5 GB RAMで70% HumanEval）。',
            },
            {
              q: '日本語や非英語言語にはどのモデルを使うべきですか？',
              a: 'Qwen2.5 7Bは中国語・日本語・韓国語・アラビア語・主要欧州語を含む29言語をネイティブサポートします。日本語テキストをLlamaやMistralより効率的に処理し、トークン効率が30〜40%向上します。',
            },
            {
...
schema: {
      ...
      gammaEmbedUrl: '/presentations/best-beginner-local-llm-models-static.html',
      gammaDescription: 'インタラクティブ14スライドデッキ：2026年初心者向けローカルLLMベスト5 — Llama 3.2 3B（2.5 GB RAM）、Phi-4 Mini（2.5 GB）、Gemma 3 2B（1.7 GB）、Mistral Small（4.5 GB）、Qwen2.5 7B（4.7 GB）。モデル比較表、RAM決定ガイド、地域別コンプライアンス、最初のステップを網羅。PDFを初心者ローカルLLMリファレンスカードとしてダウンロード。',
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 5, 'name': 'Qwen2.5 7B', 'description': '4.7 GB RAM。10〜18トークン/秒CPU。128Kコンテキスト。最良のコーディング+多言語対応。ollama run qwen2.5:7b' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Llama 3.2 3Bは日常的なタスクに十分ですか？', 'acceptedAnswer': { '@type': 'Answer', 'text': '可：要約、シンプルなQ&A、基本的なコード説明、会話チャット。不可：多段階推論、複雑なコーディング、長形式文章作成。それらには8 GB RAMでLlama 3.3 8BかQwen2.5 7Bに。' } },
          ...
          { '@type': 'Question', 'name': 'コーディングタスクに最適なモデルはどれですか？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Qwen2.5 7BがHumanEvalをリード。さらに良いコーディングには`ollama run qwen2.5-coder:7b`。4〜6 GB RAMに限定ならPhi-4 Mini 3.8Bが最良（2.5 GB RAMで70% HumanEval）。' } },
          { '@type': 'Question', 'name': '日本語ワークフローにはどのモデルを使うべきですか？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Qwen2.5 7Bが日本語ワークフローに最適——ネイティブ日本語トークン化でLlamaやMistralより30〜40%優れたトークン効率。コマンド：`ollama run qwen2.5:7b`。' } },
    ...
    zh: {
      ...
      intro: '2026年面向初学者的五款最佳本地LLM是Meta Llama 3.2 3B、Microsoft Phi-4 Mini、Google Gemma 3 2B、Mistral Small v0.3和Qwen2.5 7B。每款都可在配备4–8 GB内存的消费级硬件上运行。Llama 3.2 3B使用2.5 GB内存，速度达25–45词/秒。Phi-4 Mini仅需2.5 GB内存即可获得68% MMLU和70% HumanEval成绩。Gemma 3 2B仅需1.7 GB内存，速度达40–60词/秒——是本列表中最快的模型。',
      leadAnswerBlock: '**2026年初学者最佳本地LLM五款：Llama 3.2 3B、Phi-4 Mini 3.8B、Gemma 3 2B、Mistral Small v0.3和Qwen2.5 7B。均可在4–8 GB内存下运行，通过单条Ollama命令启动。**',
      ...
      toc: [
        ...
        { label: '#5 Qwen2.5 7B — 多语言最佳选择', anchor: '#qwen2-5-7b' },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '最佳7B全能模型：**Mistral Small v0.3** — 可靠、支持函数调用、Apache 2.0许可。截至2026年4月，Qwen2.5 7B在编程基准上优于它，Llama 3.3 8B在英语推理上领先——但Mistral Small仍是EU合规场景的有力选择。',
            '多语言和编程最佳：**Qwen2.5 7B** — 在编程基准上优于Mistral Small，原生支持29种语言，包括中文。',
          ],
        },
        quickStart: {
          id: 'quick-start',
        ...
        mistral7b: {
          ...
          content: [
            '**Mistral Small v0.3是一款可靠的通用7B模型，具有简洁的指令格式和函数调用支持。** 截至2026年4月，Qwen2.5 7B在编程基准上优于它，Llama 3.3 8B在英语推理上领先——但Mistral Small因Mistral AI是法国公司且该模型采用Apache 2.0许可，在EU数据主权场景中仍是有力选择。',
        ...
        qwen25: {
          ...
          content: [
            '**Qwen2.5 7B在HumanEval（编程）和MBPP基准上优于Mistral Small，原生支持29种语言，包括中文、日语、韩语、阿拉伯语和所有主要欧洲语言。** 它是非英语工作流或以编程为主用例的推荐选择。',
            'Qwen2.5 7B使用128K上下文窗口（Mistral Small为32K），支持带JSON模式的结构化输出。该模型提供instruct和base变体——用于对话时，始终使用instruct版本。详细基准数据请参见[Qwen vs Llama vs Mistral基准对比](/zh/local-llms/qwen-vs-llama-vs-mistral)。',
          ],
          rows: [
            { '规格': '参数量', '值': '7B' },
        ...
        fullComparison: {
          ...
          rows: [
            ...
            { '模型': 'Qwen2.5 7B', 'RAM': '4.7 GB', '速度（CPU）': '10–18词/秒', '上下文': '128K', '最适用途': '多语言、编程' },
          ],
        ...
        whichToStart: {
          ...
          imageCaption: '基于内存的模型选择指南——≤4 GB内存用Gemma 2 2B，8 GB内存用Llama 3.2 3B（最佳首选），8 GB+多语言和编程工作负载用Qwen2.5 7B。所有模型均通过`ollama run`运行，无需手动配置。',
        },
        regionalContext: {
          id: 'regional-context',
          title: '如何根据所在地区选择模型？',
          content: [
            ...
            '**企业部署（银行、医疗、法律）**：对于在本地运行LLM的中国大型企业，Qwen2.5 7B（阿里巴巴，MIT许可）提供了最简洁的合规叙述。Apache 2.0许可的Mistral Small可作为需要EU-China双合规文档的场景备选。建议在所有企业部署中：在设置前禁用Ollama遥测（`OLLAMA_NO_ANALYTICS=1`），对模型权重启用完整磁盘加密，并审计所有安装的推理引擎扩展。',
          ],
        },
        nextSteps: {
          id: 'how-to-download',
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**将Mistral Small作为默认7B模型**：Mistral Small v0.3曾是2023–2024年的社区标准，但现在在编程方面已被Qwen2.5 7B超越，在英语任务上被Llama 3.3 8B超越，且RAM需求相同。如果您的工具默认使用`ollama run mistral`，请切换到`ollama run qwen2.5:7b`或`ollama run llama3.2`以获得更好结果，而无需增加内存。',
          ...
          faqs: [
            {
              ...
              a: '大多数用户推荐Llama 3.2 3B——可在任何4 GB内存的机器上运行，下载时间不到5分钟，指令遵循输出质量强。8 GB内存时，Qwen2.5 7B提供更好的编程和多语言性能。内存要求最低的是Gemma 3 2B，仅需1.7 GB，CPU上运行速度40–60词/秒。',
            },
            {
              q: '运行本地LLM的最低内存是多少？',
            ...
            },
            {
              ...
              a: '适合以下场景：摘要、简单问答、基础代码说明和对话聊天。不适合：多步推理、复杂编程和长格式结构化写作。对于这些任务，请在8 GB内存下升级到Llama 3.3 8B或Qwen2.5 7B。',
            },
            {
              q: '3B和7B模型有什么区别？',
            ...
            {
              q: '哪款模型最适合编程任务？',
              a: 'Qwen2.5 7B在五款模型中HumanEval得分最高。要获得更好的编程效果，请使用专用代码变体：`ollama run qwen2.5-coder:7b`。Phi-4 Mini 3.8B是4–6 GB内存限制下最好的编程模型（2.5 GB内存达70% HumanEval）。',
            },
            {
              q: '哪款模型适合中文或非英语语言？',
              a: 'Qwen2.5 7B原生支持29种语言，包括中文、日语、韩语、阿拉伯语和所有主要欧洲语言。与Llama或Mistral相比，它处理中文文本的效率更高，分词开销更低。',
            },
            {
              q: '这些模型用于私人数据安全吗？',
...
schema: {
      ...
      gammaEmbedUrl: '/presentations/best-beginner-local-llm-models-static.html',
      gammaDescription: '交互式14张幻灯片：2026年初学者最佳本地LLM — Llama 3.2 3B（2.5 GB内存）、Phi-4 Mini（2.5 GB）、Gemma 3 2B（1.7 GB）、Mistral Small（4.5 GB）、Qwen2.5 7B（4.7 GB）。模型对比表、内存决策指南、地区合规性和入门步骤。下载PDF作为初学者本地LLM参考卡。',
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 5, 'name': 'Qwen2.5 7B', 'description': '4.7 GB内存，10–18词/秒CPU，128K上下文，最佳编程+多语言，29种语言支持。ollama run qwen2.5:7b' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Llama 3.2 3B足够满足日常任务吗？', 'acceptedAnswer': { '@type': 'Answer', 'text': '适合：摘要、简单问答、基础代码说明和对话聊天。不适合：多步推理、复杂编程和长格式结构化写作。对于这些任务，请在8 GB内存下升级到Llama 3.3 8B或Qwen2.5 7B。' } },
          ...
          { '@type': 'Question', 'name': '哪款模型最适合编程任务？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Qwen2.5 7B在五款模型中HumanEval得分最高。要获得更好的编程效果，请使用专用代码变体：ollama run qwen2.5-coder:7b。Phi-4 Mini 3.8B是4–6 GB内存限制下最好的编程模型。' } },
          { '@type': 'Question', 'name': '哪款模型适合中文或非英语语言？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Qwen2.5 7B原生支持29种语言，包括中文、日语、韩语、阿拉伯语和所有主要欧洲语言。与Llama或Mistral相比，它处理中文文本的效率更高，分词开销更低。' } },
