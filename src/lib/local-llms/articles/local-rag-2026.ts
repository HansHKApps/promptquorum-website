    ...
    ja: {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          title: '関連記事',
          items: [
            '[RAG の高度な手法](/local-llms/advanced-rag-techniques?lang=ja) -- 再ランキング、クエリ展開、ハイブリッド検索',
            '[ローカル LLM ハイブリッドアーキテクチャ](/local-llms/local-llm-hybrid-architectures?lang=ja) -- 複数モデル、複数GPU、分散',
            '[プロンプトエンジニアリング for RAG](/local-llms/prompt-engineering-rag?lang=ja) -- 検索結果を使った効果的なプロンプト',
            '[Ollama + RAG パイプラインの実装](/local-llms/ollama-rag-implementation?lang=ja) -- ステップバイステップコード例',
          ],
        },
        sources: {
          id: 'sources',
      ...
      schema: {
        ...
        url: 'https://www.promptquorum.com/local-llms/local-rag-2026?lang=ja',
        inLanguage: 'ja',
        datePublished: '2026-04-04',
    ...
    zh: {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          title: '相关阅读',
          items: [
            '[RAG高级技术](/local-llms/advanced-rag-techniques?lang=zh) -- 重新排序、查询扩展、混合搜索',
            '[本地大语言模型混合架构](/local-llms/local-llm-hybrid-architectures?lang=zh) -- 多模型、多GPU、分布式',
            '[RAG的提示工程](/local-llms/prompt-engineering-rag?lang=zh) -- 使用检索结果的有效提示',
            '[Ollama + RAG管道实现](/local-llms/ollama-rag-implementation?lang=zh) -- 分步代码示例',
          ],
        },
        sources: {
          id: 'sources',
      ...
      schema: {
        ...
        url: 'https://www.promptquorum.com/local-llms/local-rag-2026?lang=zh',
        inLanguage: 'zh',
        datePublished: '2026-04-04',
        dateModified: '2026-04-19',
        author: { '@type': 'Organization', 'name': 'PromptQuorum' },
