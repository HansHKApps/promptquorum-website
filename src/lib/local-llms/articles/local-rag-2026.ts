...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      heroImage: '/images/local-rag-2026-overview-hero-en.webp',
      dateModified: '2026-08-31',
      seoTitle: 'Local RAG 2026 Guide',
      intro: 'Retrieval-Augmented Generation (RAG) lets your local LLM answer questions about your own documents. You upload PDFs and text files, the system converts them to embeddings, stores them in a vector database, and retrieves relevant chunks when answering questions. Local RAG is production-ready and eliminates API costs.',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'Local RAG lets a local LLM answer questions about your own documents by converting PDFs and text files into embeddings, storing them in a vector database, and retrieving the most relevant chunks to feed into the model when you ask a question.' },
            { type: 'plain-terms', text: "RAG is how you get an AI model to actually know about your files instead of just what it learned during training. You upload documents once, the system breaks them into pieces and turns each piece into a searchable numeric representation, then pulls the most relevant pieces back out whenever you ask a question -- all running locally, with no per-query API bill." },
          ],
          items: [
            ...
            'Local RAG is faster and cheaper than cloud APIs. Quality depends on retrieval accuracy and prompt engineering.',
          ],
        },
        howRag: {
        ...
        chunking: {
          ...
          content: [
            ...
            'Semantic chunking with 500-1000 token chunks and 20% overlap is optimal for most use cases.',
          ],
        ...
        vectorDatabases: {
          ...
          rows: [
            { 'Database': 'Chroma', 'Type': 'Embedded', 'Capacity': '<1M docs', 'Setup Effort': 'pip install', 'Best For': 'Prototyping, small RAG' },
            { 'Database': 'Qdrant', 'Type': 'Distributed', 'Capacity': 'Unlimited', 'Setup Effort': 'Docker or cloud', 'Best For': 'Production, scalable' },
            { 'Database': 'Milvus', 'Type': 'Distributed', 'Capacity': 'Unlimited', 'Setup Effort': 'Complex', 'Best For': 'Enterprise, massive scale' },
            { 'Database': 'Weaviate', 'Type': 'Graph + Vector', 'Capacity': 'Unlimited', 'Setup Effort': 'Docker', 'Best For': 'Complex queries, relationships' },
            { 'Database': 'Pinecone (cloud)', 'Type': 'Managed', 'Capacity': 'Unlimited', 'Setup Effort': 'API key', 'Best For': 'Serverless, hands-off' },
          ],
        ...
        embeddings: {
          ...
          rows: [
            { 'Model': 'nomic-embed-text (local)', 'Vector Dimensions': '768', 'Speed': 'Fast', 'Quality': 'Excellent', 'Recommendation': 'Best for local RAG' },
            { 'Model': 'bge-m3 (local)', 'Vector Dimensions': '1024', 'Speed': 'Fast', 'Quality': 'Excellent', 'Recommendation': 'Multilingual support' },
            { 'Model': 'OpenAI text-embedding-3 (cloud)', 'Vector Dimensions': '3072', 'Speed': 'Very fast', 'Quality': 'Best in class', 'Recommendation': 'Hybrid approach' },
            { 'Model': 'Cohere (cloud)', 'Vector Dimensions': '4096', 'Speed': 'Fast', 'Quality': 'Excellent', 'Recommendation': 'Production cloud RAG' },
          ],
        ...
        evaluation: {
          ...
          content: [
            ...
            'Automated evaluation tools (like Ragas) can measure retrieval and generation metrics automatically.',
          ],
        },
        production: {
          id: 'production',
...
schema: {
    ...
    es: {
      ...
      heroImage: '/images/local-rag-2026-overview-hero-es.webp',
      seoTitle: 'Guía RAG Local 2026',
      intro: 'La Generación Aumentada por Recuperación (RAG) permite que tu LLM local responda preguntas sobre tus propios documentos. Subes PDFs y archivos de texto, el sistema los convierte en embeddings, los almacena en una base de datos vectorial y recupera los fragmentos relevantes al responder preguntas. El RAG local está listo para producción y elimina los costos de API.',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'El RAG local permite que un LLM local responda preguntas sobre tus propios documentos, convirtiendo PDFs y archivos de texto en embeddings, almacenándolos en una base de datos vectorial y recuperando los fragmentos más relevantes para pasárselos al modelo cuando haces una pregunta.' },
            { type: 'plain-terms', text: 'RAG es la forma de lograr que un modelo de IA realmente conozca tus archivos, en lugar de solo lo que aprendió durante el entrenamiento. Subes documentos una vez, el sistema los divide en fragmentos y convierte cada uno en una representación numérica buscable, y luego recupera los fragmentos más relevantes cada vez que haces una pregunta -- todo funcionando localmente, sin factura de API por consulta.' },
          ],
          items: [
            ...
            'El RAG local es más rápido y económico que las APIs en la nube. La calidad depende de la precisión de recuperación y el prompt engineering.',
          ],
        },
        howRag: {
        ...
        chunking: {
          ...
          content: [
            ...
            'El chunking semántico con fragmentos de 500-1000 tokens y 20% de superposición es óptimo para la mayoría de los casos de uso.',
          ],
        ...
        embeddings: {
          ...
          rows: [
            { 'Modelo': 'nomic-embed-text (local)', 'Dimensiones del vector': '768', 'Velocidad': 'Rápida', 'Calidad': 'Excelente', 'Recomendación': 'Mejor para RAG local' },
            { 'Modelo': 'bge-m3 (local)', 'Dimensiones del vector': '1024', 'Velocidad': 'Rápida', 'Calidad': 'Excelente', 'Recomendación': 'Soporte multilingüe' },
            { 'Modelo': 'OpenAI text-embedding-3 (cloud)', 'Dimensiones del vector': '3072', 'Velocidad': 'Muy rápida', 'Calidad': 'La mejor de su clase', 'Recomendación': 'Enfoque híbrido' },
            { 'Modelo': 'Cohere (cloud)', 'Dimensiones del vector': '4096', 'Velocidad': 'Rápida', 'Calidad': 'Excelente', 'Recomendación': 'RAG en cloud de producción' },
          ],
        ...
        evaluation: {
          ...
          content: [
            ...
            'Las herramientas de evaluación automatizada (como Ragas) pueden medir métricas de recuperación y generación de forma automática.',
          ],
        },
        production: {
          id: 'production',
    ...
    ar: {
      ...
      heroImage: '/images/local-rag-2026-overview-hero-ar.webp',
      seoTitle: '⁨RAG⁩ المحلي ⁨2026⁩: بناء أنظمة استرجاع وقواعد متجهية',
      intro: 'يُتيح التوليد المعزَّز بالاسترجاع (RAG) لنموذج LLM المحلي الإجابة عن أسئلة حول مستنداتك الخاصة. ترفع ملفات PDF وملفات نصية، ويحوّلها النظام إلى embeddings، ويخزّنها في قاعدة بيانات متجهية، ويسترجع الأجزاء ذات الصلة عند الإجابة عن الأسئلة. RAG المحلي جاهز للإنتاج ويلغي تكاليف API.',
      metaDescription: '⁨RAG⁩ المحلي ⁨2026⁩: أنشئ أنظمة أسئلة وأجوبة على مستنداتك بقواعد بيانات متجهية وتقسيم ذكي. استراتيجيات الاسترجاع، نماذج التضمين، ومقارنة أطر العمل.',
      publishDate: '2026-04-04',
      dateModified: '2026-08-28',
      leadAnswerBlock: '**يُتيح التوليد المعزَّز بالاسترجاع (RAG) لنموذج LLM المحلي الإجابة عن أسئلة حول مستنداتك الخاصة. ترفع ملفات PDF وملفات نصية، ويحوّلها النظام إلى embeddings، ويخزّنها في قاعدة بيانات متجهية، ويسترجع الأجزاء ذات الصلة عند الإجابة عن الأسئلة.**',
      ...
      toc: [
        ...
        { label: 'خط أنابيب الاسترجاع', anchor: '#retrieval' },
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'يتيح RAG المحلي لنموذج LLM محلي الإجابة عن أسئلة حول مستنداتك الخاصة عن طريق تحويل ملفات PDF والنصوص إلى embeddings، وتخزينها في قاعدة بيانات متجهية، واسترجاع الأجزاء الأكثر صلة لتغذية النموذج بها عند طرح سؤال.' },
            { type: 'plain-terms', text: 'RAG هو الطريقة التي تجعل بها نموذج الذكاء الاصطناعي يعرف فعلاً محتوى ملفاتك، بدلاً من الاكتفاء بما تعلّمه أثناء التدريب. ترفع المستندات مرة واحدة، ويقسّمها النظام إلى أجزاء ويحوّل كل جزء إلى تمثيل رقمي قابل للبحث، ثم يسترجع الأجزاء الأكثر صلة كلما طرحت سؤالاً -- كل ذلك يعمل محلياً دون فاتورة API لكل استعلام.' },
          ],
          items: [
            ...
            'RAG المحلي أسرع وأرخص من واجهات API السحابية. تعتمد الجودة على دقة الاسترجاع وهندسة المطالبات.',
          ],
        },
        howRag: {
        ...
        chunking: {
          ...
          content: [
            ...
            'التقسيم الدلالي بأجزاء 500-1000 رمز وتداخل 20% هو الأمثل لمعظم حالات الاستخدام.',
          ],
          codeBlock: '# Python: semantic chunking example\nfrom langchain.text_splitter import RecursiveCharacterTextSplitter\n\nsplitter = RecursiveCharacterTextSplitter(\n  chunk_size=1000,\n  chunk_overlap=200,  # 20% overlap\n  separators=["\\n\\n", "\\n", ".", " "]  # Split on paragraph, then sentence\n)\nchunks = splitter.split_documents(documents)\nprint(f"Created {len(chunks)} chunks")',
          codeLanguage: 'python',
        },
        vectorDatabases: {
          ...
          rows: [
            { 'قاعدة البيانات': 'Chroma', 'النوع': 'مدمجة', 'السعة': '<مليون مستند', 'جهد الإعداد': 'pip install', 'الأفضل لـ': 'النماذج الأولية، RAG صغير' },
            { 'قاعدة البيانات': 'Qdrant', 'النوع': 'موزّعة', 'السعة': 'غير محدودة', 'جهد الإعداد': 'Docker أو سحابة', 'الأفضل لـ': 'الإنتاج، قابلة للتوسّع' },
            { 'قاعدة البيانات': 'Milvus', 'النوع': 'موزّعة', 'السعة': 'غير محدودة', 'جهد الإعداد': 'معقّد', 'الأفضل لـ': 'مؤسسات، نطاق كبير' },
            { 'قاعدة البيانات': 'Weaviate', 'النوع': 'رسم بياني + متجه', 'السعة': 'غير محدودة', 'جهد الإعداد': 'Docker', 'الأفضل لـ': 'استعلامات معقّدة، علاقات' },
            { 'قاعدة البيانات': 'Pinecone (سحابة)', 'النوع': 'مُدارة', 'السعة': 'غير محدودة', 'جهد الإعداد': 'مفتاح API', 'الأفضل لـ': 'بلا خادم، بلا صيانة' },
          ],
        ...
        embeddings: {
          ...
          rows: [
            ...
            { 'النموذج': 'bge-m3 (محلي)', 'أبعاد المتجه': '1024', 'السرعة': 'سريع', 'الجودة': 'ممتاز', 'التوصية': 'دعم متعدد اللغات' },
            { 'النموذج': 'OpenAI text-embedding-3 (سحابي)', 'أبعاد المتجه': '3072', 'السرعة': 'سريع جدًا', 'الجودة': 'الأفضل في فئته', 'التوصية': 'نهج هجين' },
            { 'النموذج': 'Cohere (سحابي)', 'أبعاد المتجه': '4096', 'السرعة': 'سريع', 'الجودة': 'ممتاز', 'التوصية': 'RAG سحابي للإنتاج' },
          ],
        ...
        evaluation: {
          ...
          content: [
            ...
            'يمكن لأدوات التقييم الآلي (مثل Ragas) قياس مقاييس الاسترجاع والتوليد تلقائيًا.',
          ],
        },
        production: {
          id: 'production',
        ...
        faqSection: {
          id: 'faq',
          title: 'الأسئلة الشائعة حول RAG المحلي',
          faqs: [
            {
              q: 'كم عدد المستندات التي يتعامل معها RAG المحلي؟',
              a: 'يتعامل Chroma مع 100 ألف إلى مليون مستند على عتاد استهلاكي. يتوسّع Qdrant إلى مليارات بإعداد موزّع. فوق مليون، استخدم Qdrant أو Milvus.',
            },
            {
              q: 'ما زمن الاستجابة الذي يجب أن أتوقّعه؟',
              a: 'استعلام embedding (nomic-embed-text على CPU): 50-200 مللي ثانية. الاسترجاع (Chroma على القرص): 10-50 مللي ثانية. توليد LLM: 2-10 ثوانٍ (يعتمد على حجم النموذج). الإجمالي: 2-10 ثوانٍ لكل استعلام.',
            },
            {
              q: 'هل يستطيع RAG التعامل مع تحديثات المستندات في الوقت الفعلي؟',
              a: 'نعم. أضف مستندات جديدة إلى قاعدة البيانات المتجهية ديناميكيًا. زمن استجابة الفهرسة 100-500 مللي ثانية لكل مستند، لذا فإن التحديثات في الوقت الفعلي قابلة للتطبيق.',
            },
            {
              q: 'هل RAG المحلي أرخص من واجهات API السحابية؟',
              a: 'نعم. بلا تكلفة لكل رمز، بلا مكالمات API لخدمات خارجية. إعداد embeddings لمرة واحدة ثم استعلامات مجانية.',
            },
            {
              q: 'هل يمكنني استخدام embeddings سحابية مع نماذج LLM محلية؟',
              a: 'نعم. استخدم embeddings من OpenAI أو Cohere أو خدمات سحابية أخرى للفهرسة ثم نماذج LLM محلية للتوليد. نهج هجين.',
            },
          ],
        },
        relatedReading: {
          ...
          items: [
            '[أفضل أدوات RAG المحلية](/ar/local-llms/best-local-rag-tools) -- قواعد بيانات متجهية وأطر عمل.',
            '[دليل هندسة المطالبات](/ar/prompt-engineering) -- تحسين المطالبات لـRAG.',
            '[واجهة API متوافقة مع OpenAI لـLLM محلي](/ar/local-llms/local-llm-openai-compatible-api) -- كشف RAG كواجهة API.',
            '[الضبط الدقيق لنماذج LLM المحلية بـLoRA](/ar/local-llms/fine-tuning-local-llms-lora) -- الجمع بين الضبط الدقيق وRAG.',
          ],
        },
        sources: {
          id: 'sources',
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': 'RAG محلي 2026: ابنِ أنظمة أسئلة وأجوبة دون واجهات API سحابية',
        ...
        'about': [
          ...
          { '@type': 'Thing', 'name': 'نماذج embedding' },
          { '@type': 'Thing', 'name': 'Chroma' },
          { '@type': 'Thing', 'name': 'Qdrant' },
        ],
        'mentions': [
      ...
      faqSchema: {
        ...
        '@type': 'FAQPage',
        'mainEntity': [
          { '@type': 'Question', 'name': 'كم عدد المستندات التي يتعامل معها RAG المحلي؟', 'acceptedAnswer': { '@type': 'Answer', 'text': 'يتعامل Chroma مع 100 ألف إلى مليون مستند على عتاد استهلاكي. يتوسّع Qdrant إلى مليارات بإعداد موزّع. فوق مليون، استخدم Qdrant أو Milvus.' } },
          { '@type': 'Question', 'name': 'ما زمن الاستجابة الذي يجب أن أتوقّعه؟', 'acceptedAnswer': { '@type': 'Answer', 'text': 'استعلام embedding (nomic-embed-text على CPU): 50-200 مللي ثانية. الاسترجاع (Chroma على القرص): 10-50 مللي ثانية. توليد LLM: 2-10 ثوانٍ. الإجمالي: 2-10 ثوانٍ لكل استعلام.' } },
          { '@type': 'Question', 'name': 'هل يستطيع RAG التعامل مع تحديثات المستندات في الوقت الفعلي؟', 'acceptedAnswer': { '@type': 'Answer', 'text': 'نعم. أضف مستندات جديدة إلى قاعدة البيانات المتجهية ديناميكيًا. زمن استجابة الفهرسة 100-500 مللي ثانية لكل مستند، لذا فإن التحديثات في الوقت الفعلي قابلة للتطبيق.' } },
          { '@type': 'Question', 'name': 'هل RAG المحلي أرخص من واجهات API السحابية؟', 'acceptedAnswer': { '@type': 'Answer', 'text': 'نعم. بلا تكلفة لكل رمز، بلا مكالمات API لخدمات خارجية. إعداد embeddings لمرة واحدة ثم استعلامات مجانية.' } },
          { '@type': 'Question', 'name': 'هل يمكنني استخدام embeddings سحابية مع نماذج LLM محلية؟', 'acceptedAnswer': { '@type': 'Answer', 'text': 'نعم. استخدم embeddings من OpenAI أو Cohere أو خدمات سحابية أخرى للفهرسة ثم نماذج LLM محلية للتوليد. نهج هجين.' } },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        'name': 'RAG محلي 2026: الأساسيات',
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'قسّم المستندات بشكل صحيح', 'description': 'تقسيم المستندات إلى أجزاء 500-1000 رمز بتداخل 20%. يحافظ التقسيم الدلالي على المعنى أفضل من الحجم الثابت.' },
          { '@type': 'ListItem', 'position': 2, 'name': 'اختر قاعدة بيانات متجهية', 'description': 'Chroma لأقل من مليون مستند على عتاد استهلاكي. Qdrant لـRAG موزّع وقابل للتوسّع في الإنتاج.' },
          { '@type': 'ListItem', 'position': 3, 'name': 'قيّم جودة الاسترجاع', 'description': 'قِس الدقة والاستدعاء. استرجاع سيئ = هلوسات. استخدم أدوات آلية مثل Ragas للتقييم.' },
        ],
      },
    },
    pt: {
      ...
      heroImage: '/images/local-rag-2026-overview-hero-pt.webp',
      seoTitle: 'Guia RAG Local 2026',
      intro: 'A Geração Aumentada por Recuperação (RAG) permite que seu LLM local responda perguntas sobre seus próprios documentos. Você faz upload de PDFs e arquivos de texto, o sistema os converte em embeddings, armazena em um banco de dados vetorial e recupera os fragmentos relevantes ao responder perguntas. O RAG local está pronto para produção e elimina os custos de API.',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'O RAG local permite que um LLM local responda perguntas sobre seus próprios documentos, convertendo PDFs e arquivos de texto em embeddings, armazenando-os em um banco de dados vetorial e recuperando os trechos mais relevantes para alimentar o modelo ao fazer uma pergunta.' },
            { type: 'plain-terms', text: 'RAG é a forma de fazer um modelo de IA realmente conhecer seus arquivos, em vez de apenas o que aprendeu durante o treinamento. Você envia os documentos uma vez, o sistema os divide em pedaços e transforma cada um em uma representação numérica pesquisável, e depois recupera os pedaços mais relevantes sempre que você faz uma pergunta -- tudo rodando localmente, sem cobrança de API por consulta.' },
          ],
          items: [
            ...
            'O RAG local é mais rápido e econômico que as APIs na nuvem. A qualidade depende da precisão de recuperação e do prompt engineering.',
          ],
        },
        howRag: {
        ...
        chunking: {
          ...
          content: [
            ...
            'O chunking semântico com fragmentos de 500–1.000 tokens e 20% de sobreposição é ideal para a maioria dos casos de uso.',
          ],
        ...
        embeddings: {
          ...
          rows: [
            { 'Modelo': 'nomic-embed-text (local)', 'Dimensões do vetor': '768', 'Velocidade': 'Rápida', 'Qualidade': 'Excelente', 'Recomendação': 'Melhor para RAG local' },
            { 'Modelo': 'bge-m3 (local)', 'Dimensões do vetor': '1024', 'Velocidade': 'Rápida', 'Qualidade': 'Excelente', 'Recomendação': 'Suporte multilíngue' },
            { 'Modelo': 'OpenAI text-embedding-3 (nuvem)', 'Dimensões do vetor': '3072', 'Velocidade': 'Muito rápida', 'Qualidade': 'Melhor da classe', 'Recomendação': 'Abordagem híbrida' },
            { 'Modelo': 'Cohere (nuvem)', 'Dimensões do vetor': '4096', 'Velocidade': 'Rápida', 'Qualidade': 'Excelente', 'Recomendação': 'RAG na nuvem de produção' },
          ],
        ...
        evaluation: {
          ...
          content: [
            ...
            'Ferramentas de avaliação automatizada (como Ragas) podem medir métricas de recuperação e geração automaticamente.',
          ],
        },
        production: {
          id: 'production',
    ...
    de: {
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'Lokales RAG ermöglicht es einem lokalen LLM, Fragen zu Ihren eigenen Dokumenten zu beantworten, indem PDFs und Textdateien in Embeddings umgewandelt, in einer Vektordatenbank gespeichert und die relevantesten Abschnitte abgerufen werden, um sie dem Modell bei einer Frage zuzuführen.' },
            { type: 'plain-terms', text: 'RAG ist der Weg, ein KI-Modell tatsächlich über die eigenen Dateien Bescheid wissen zu lassen, statt nur über das, was es beim Training gelernt hat. Man lädt Dokumente einmal hoch, das System zerlegt sie in Abschnitte und wandelt jeden in eine durchsuchbare numerische Darstellung um, und ruft dann bei jeder Frage die relevantesten Abschnitte ab -- alles läuft lokal, ohne API-Rechnung pro Anfrage.' },
          ],
          items: [
            ...
            'Lokales RAG ist schneller und billiger als Cloud-APIs. Qualität hängt von Abruf-Genauigkeit und Prompt-Engineering ab.',
          ],
        },
        howRag: {
        ...
        chunking: {
          ...
          content: [
            ...
            'Semantisches Chunking mit 500-1000-Token-Chunks und 20% Überlappung ist optimal für die meisten Anwendungsfälle.',
          ],
        ...
        evaluation: {
          ...
          content: [
            ...
            'Automatisierte Evaluierungs-Tools (wie Ragas) können Abruf- und Generierungs-Metriken automatisch messen.',
          ],
        },
        production: {
          id: 'production',
    ...
    fr: {
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: "Le RAG local permet à un LLM local de répondre à des questions sur vos propres documents en convertissant les fichiers PDF et texte en embeddings, en les stockant dans une base de données vectorielle et en récupérant les extraits les plus pertinents à fournir au modèle lors d'une question." },
            { type: 'plain-terms', text: "Le RAG est le moyen de faire en sorte qu'un modèle d'IA connaisse réellement vos fichiers, plutôt que seulement ce qu'il a appris pendant son entraînement. Vous téléversez les documents une fois, le système les découpe en morceaux et transforme chacun en une représentation numérique consultable, puis récupère les morceaux les plus pertinents à chaque question -- le tout en local, sans facture API par requête." },
          ],
          items: [
            ...
            'RAG local est plus rapide et moins cher que les APIs cloud. Qualité dépend de la précision de récupération et du prompt engineering.',
          ],
        },
        howRag: {
        ...
        chunking: {
          ...
          content: [
            ...
            'Chunking sémantique avec chunks 500-1000 tokens et chevauchement 20% est optimal pour la plupart des cas.',
          ],
        ...
        evaluation: {
          ...
          content: [
            ...
            'Outils d\'évaluation automatisés (comme Ragas) peuvent mesurer métriques récupération et génération automatiquement.',
          ],
        },
        production: {
          id: 'production',
...
schema: {
    ...
    ja: {
      ...
      heroImage: '/images/local-rag-2026-overview-hero-ja.webp',
      seoTitle: 'ローカルRAG 2026ガイド',
      intro: 'Retrieval-Augmented Generation（RAG）を使うと、ローカルLLMがあなた独自の文書についての質問に答えられます。PDFやテキストファイルをアップロードすると、システムが埋め込みベクトル（embeddings）に変換し、ベクターデータベースに保存され、質問に答えるときに関連チャンクを検索します。ローカルRAGは本番環境で使用でき、APIコストを排除します。',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'ローカルRAGを使うと、ローカルLLMはPDFやテキストファイルを埋め込みベクトルに変換し、ベクターデータベースに保存し、質問された際に最も関連性の高いチャンクを取得してモデルに渡すことで、あなた自身の文書について質問に答えられるようになります。' },
            { type: 'plain-terms', text: 'RAGとは、AIモデルが学習時に覚えたことだけでなく、あなたのファイルの内容を実際に知っている状態にする仕組みです。文書を一度アップロードすると、システムはそれを細かく分割し、それぞれを検索可能な数値表現に変換します。そして質問するたびに最も関連性の高い部分を取り出してモデルに渡します -- すべてローカルで動作し、クエリごとのAPI料金は発生しません。' },
          ],
          items: [
            ...
            'ローカルRAGはクラウドAPIより高速かつ安価です。品質は検索精度とプロンプトエンジニアリングに依存します。',
          ],
        },
        howRag: {
        ...
        chunking: {
          ...
          content: [
            ...
            'セマンティックチャンキングで500～1000トークンチャンクと20%オーバーラップがほとんどのユースケースで最適です。',
          ],
        ...
        embeddings: {
          ...
          rows: [
            { 'モデル': 'nomic-embed-text（ローカル）', 'ベクトル次元': '768', '速度': '速い', '品質': '優秀', '推奨': 'ローカルRAGに最適' },
            { 'モデル': 'bge-m3（ローカル）', 'ベクトル次元': '1024', '速度': '速い', '品質': '優秀', '推奨': '多言語対応' },
            { 'モデル': 'OpenAI text-embedding-3（クラウド）', 'ベクトル次元': '3072', '速度': '非常に速い', '品質': '最高のクラス', '推奨': 'ハイブリッドアプローチ' },
            { 'モデル': 'Cohere（クラウド）', 'ベクトル次元': '4096', '速度': '速い', '品質': '優秀', '推奨': '本番環境クラウドRAG' },
          ],
        ...
        sources: {
          ...
          title: '参考資料',
          items: [
            'LangChain ドキュメンテーション -- [python.langchain.com/docs/use_cases/question_answering/](https://python.langchain.com/docs/use_cases/question_answering/)',
            'RAG ベンチマーク -- [github.com/explodinggradients/ragas](https://github.com/explodinggradients/ragas)',
            'Embedding モデル比較 -- [huggingface.co/spaces/mteb/leaderboard](https://huggingface.co/spaces/mteb/leaderboard)',
            'Qdrant ドキュメンテーション -- [qdrant.tech/documentation/](https://qdrant.tech/documentation/)',
          ],
        },
      },
      schema: {
    ...
    zh: {
      ...
      heroImage: '/images/local-rag-2026-overview-hero-zh.webp',
      seoTitle: '本地RAG 2026完整指南',
      intro: 'Retrieval-Augmented Generation（RAG）让你的本地大语言模型能回答你自己文档中的问题。上传PDF和文本文件，系统将其转换为嵌入向量，存储在向量数据库中，在回答问题时检索相关内容。本地RAG已可投入生产，完全消除API成本。',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: '本地RAG通过将PDF和文本文件转换为嵌入向量、存储在向量数据库中，并在提问时检索最相关的片段提供给模型，让本地LLM能够回答关于你自己文档的问题。' },
            { type: 'plain-terms', text: 'RAG是让AI模型真正了解你的文件内容，而不仅仅依赖训练时学到的知识的方法。你只需上传一次文档，系统会将其拆分成小块并把每一块转换为可搜索的数字表示，然后在你每次提问时检索出最相关的部分交给模型——全部在本地运行，无需为每次查询支付API费用。' },
          ],
          items: [
            ...
            '本地RAG比云API更快更便宜。质量取决于检索准确性和提示工程。',
          ],
        },
        howRag: {
          title: 'RAG 如何分步骤工作？',
        ...
        chunking: {
          ...
          content: [
            ...
            '使用500-1000个令牌的语义分块和20%重叠对大多数用例最优。',
          ],
        ...
        embeddings: {
          ...
          title: '应选择哪个嵌入模型？',
          rows: [
            { '模型': 'nomic-embed-text（本地）', '向量维度': '768', '速度': '快', '质量': '优秀', '推荐': '本地RAG最佳' },
            { '模型': 'bge-m3（本地）', '向量维度': '1024', '速度': '快', '质量': '优秀', '推荐': '多语言支持' },
            { '模型': 'OpenAI text-embedding-3（云）', '向量维度': '3072', '速度': '非常快', '质量': '业界最佳', '推荐': '混合方案' },
            { '模型': 'Cohere（云）', '向量维度': '4096', '速度': '快', '质量': '优秀', '推荐': '生产云RAG' },
          ],
        ...
        sources: {
          ...
          title: '参考资源',
          items: [
            'LangChain文档 -- [python.langchain.com/docs/use_cases/question_answering/](https://python.langchain.com/docs/use_cases/question_answering/)',
            'RAG基准测试 -- [github.com/explodinggradients/ragas](https://github.com/explodinggradients/ragas)',
            '嵌入模型对比 -- [huggingface.co/spaces/mteb/leaderboard](https://huggingface.co/spaces/mteb/leaderboard)',
            'Qdrant文档 -- [qdrant.tech/documentation/](https://qdrant.tech/documentation/)',
          ],
        },
      },
      schema: {
  ...
  ko: {
    ...
    heroImage: '/images/local-rag-2026-overview-hero-ko.webp',
      seoTitle: '로컬 RAG 2026 가이드',
      intro: 'Retrieval-Augmented Generation (RAG)을 사용하면 로컬 LLM이 사용자 본인의 문서에 대한 질문에 답변할 수 있습니다. PDF와 텍스트 파일을 업로드하면 시스템이 이를 임베딩으로 변환하고 벡터 데이터베이스에 저장한 후, 질문에 답변할 때 관련 청크를 검색합니다. 로컬 RAG는 프로덕션 환경에서 사용 가능한 수준이며 API 비용을 완전히 제거합니다.',
      metaDescription: '로컬 RAG 2026: 문서 Q&A 시스템, 벡터 데이터베이스, 청킹 전략, 검색 최적화 방법을 다루는 완전한 가이드.',
      publishDate: '2026-04-04',
      dateModified: '2026-08-31',
      leadAnswerBlock: 'Retrieval-Augmented Generation (RAG)을 사용하면 로컬 LLM이 사용자 본인의 문서에 대한 질문에 답변할 수 있습니다. PDF와 텍스트 파일을 업로드하면 시스템이 이를 임베딩으로 변환하고 벡터 데이터베이스에 저장한 후, 질문에 답변할 때 관련 청크를 검색합니다.',
      audience: '일반 소비자용 하드웨어에서 처음으로 로컬 LLM을 실행하는 초보자',
      readTime: '14분 읽기',
      educationalLevel: '중급에서 고급',
      ...
      toc: [
        ...
        { label: '검색 파이프라인', anchor: '#retrieval' },
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: '로컬 RAG는 PDF와 텍스트 파일을 임베딩으로 변환하고 벡터 데이터베이스에 저장한 뒤, 질문할 때 가장 관련성 높은 청크를 검색해 모델에 제공함으로써 로컬 LLM이 사용자 자신의 문서에 대한 질문에 답할 수 있게 해줍니다.' },
            { type: 'plain-terms', text: 'RAG는 AI 모델이 학습 당시 배운 내용뿐 아니라 실제로 여러분의 파일 내용을 알게 만드는 방법입니다. 문서를 한 번 업로드하면 시스템이 이를 조각으로 나누고 각 조각을 검색 가능한 숫자 표현으로 변환한 뒤, 질문할 때마다 가장 관련성 높은 조각을 다시 꺼내옵니다 -- 이 모든 과정이 로컬에서 실행되며 쿼리당 API 요금도 없습니다.' },
          ],
          items: [
            ...
            '로컬 RAG는 클라우드 API보다 빠르고 저렴합니다. 품질은 검색 정확도와 프롬프트 엔지니어링에 달려 있습니다.',
          ],
        },
        howRag: {
        ...
        chunking: {
          ...
          content: [
            ...
            '20% 오버랩이 적용된 500~1000 토큰 청크의 의미론적 청킹이 대부분의 사용 사례에 최적입니다.',
          ],
          codeBlock: '# Python: semantic chunking example\nfrom langchain.text_splitter import RecursiveCharacterTextSplitter\n\nsplitter = RecursiveCharacterTextSplitter(\n  chunk_size=1000,\n  chunk_overlap=200,  # 20% overlap\n  separators=["\\n\\n", "\\n", ".", " "]  # Split on paragraph, then sentence\n)\nchunks = splitter.split_documents(documents)\nprint(f"Created {len(chunks)} chunks")',
          codeLanguage: 'python',
        },
        vectorDatabases: {
          ...
          rows: [
            { 'Database': 'Chroma', '유형': '내장형', '용량': '100만 건 미만', '설정 난이도': 'pip install', '최적 사용 사례': '프로토타이핑, 소규모 RAG' },
            { 'Database': 'Qdrant', '유형': '분산형', '용량': '무제한', '설정 난이도': 'Docker 또는 클라우드', '최적 사용 사례': '프로덕션, 확장 가능' },
            { 'Database': 'Milvus', '유형': '분산형', '용량': '무제한', '설정 난이도': '복잡', '최적 사용 사례': '엔터프라이즈, 대규모' },
            { 'Database': 'Weaviate', '유형': '그래프 + 벡터', '용량': '무제한', '설정 난이도': 'Docker', '최적 사용 사례': '복잡한 쿼리, 관계형' },
            { 'Database': 'Pinecone (클라우드)', '유형': '관리형', '용량': '무제한', '설정 난이도': 'API 키', '최적 사용 사례': '서버리스, 관리 불필요' },
          ],
        ...
        embeddings: {
          ...
          rows: [
            { '모델': 'nomic-embed-text (로컬)', '벡터 차원': '768', '속도': '빠름', '품질': '우수', '권장 사항': '로컬 RAG에 최적' },
            { '모델': 'bge-m3 (로컬)', '벡터 차원': '1024', '속도': '빠름', '품질': '우수', '권장 사항': '다국어 지원' },
            { '모델': 'OpenAI text-embedding-3 (클라우드)', '벡터 차원': '3072', '속도': '매우 빠름', '품질': '최고 수준', '권장 사항': '하이브리드 방식' },
            { '모델': 'Cohere (클라우드)', '벡터 차원': '4096', '속도': '빠름', '품질': '우수', '권장 사항': '프로덕션 클라우드 RAG' },
          ],
        ...
        evaluation: {
          ...
          content: [
            ...
            'Ragas와 같은 자동화된 평가 도구가 검색 및 생성 지표를 자동으로 측정할 수 있습니다.',
          ],
        },
        production: {
          id: 'production',
        ...
        faqSection: {
          ...
          faqs: [
            {
              q: '로컬 RAG는 몇 개의 문서를 처리할 수 있습니까?',
              a: 'Chroma는 일반 소비자용 하드웨어에서 10만~100만 건의 문서를 처리합니다. Qdrant는 분산 설정으로 수십억 건까지 확장됩니다. 100만 건을 초과하는 경우 Qdrant 또는 Milvus를 사용하십시오.',
            },
            {
              q: '예상 지연 시간은 어느 정도입니까?',
              a: '임베딩 쿼리 (CPU의 nomic-embed-text): 50~200ms. 검색 (디스크의 Chroma): 10~50ms. LLM 생성: 2~10초 (모델 크기에 따라 다름). 총합: 쿼리당 2~10초.',
            },
            {
              q: 'RAG는 실시간 문서 업데이트를 처리할 수 있습니까?',
              a: '예. 벡터 DB에 새 문서를 동적으로 추가할 수 있습니다. 인덱싱 지연 시간은 문서당 100~500ms이므로 실시간 업데이트가 실용적입니다.',
            },
            {
              q: '로컬 RAG는 클라우드 API보다 저렴합니까?',
              a: '예. 토큰당 비용이 없고 외부 서비스에 대한 API 호출도 없습니다. 임베딩을 한 번 설정하면 이후 쿼리는 무료입니다.',
            },
            {
              q: '클라우드 임베딩을 로컬 LLM과 함께 사용할 수 있습니까?',
              a: '예. 인덱싱에는 OpenAI, Cohere 또는 다른 클라우드 임베딩을 사용하고, 생성에는 로컬 LLM을 사용할 수 있습니다. 하이브리드 방식입니다.',
            },
          ],
        },
        relatedReading: {
