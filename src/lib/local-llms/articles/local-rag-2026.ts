      ...
      sections: {
        ...
        vectorDatabases: {
          ...
          rows: [
            ...
            { 'Database': 'Milvus', 'Type': '분산형', 'Capacity': '무제한', 'Setup': '복잡', 'Best For': '엔터프라이즈, 대규모' },
            { 'Database': 'Weaviate', 'Type': '그래프 + 벡터', 'Capacity': '무제한', 'Setup': 'Docker', 'Best For': '복잡한 쿼리, 관계형' },
            { 'Database': 'Pinecone (클라우드)', 'Type': '관리형', 'Capacity': '무제한', 'Setup': 'API 키', 'Best For': '서버리스, 관리 불필요' },
          ],
        ...
        embeddings: {
          ...
          rows: [
            ...
            { 'Model': 'bge-m3 (로컬)', 'Dimensions': '1024', 'Speed': '빠름', 'Quality': '우수', 'Recommendation': '다국어 지원' },
            { 'Model': 'OpenAI text-embedding-3 (클라우드)', 'Dimensions': '3072', 'Speed': '매우 빠름', 'Quality': '최고 수준', 'Recommendation': '하이브리드 방식' },
            { 'Model': 'Cohere (클라우드)', 'Dimensions': '4096', 'Speed': '빠름', 'Quality': '우수', 'Recommendation': '프로덕션 클라우드 RAG' },
          ],
