      ...
      sections: {
        ...
        vectorDatabases: {
          ...
          rows: [
            ...
            { 'Base de datos': 'Milvus', 'Tipo': 'موزّعة', 'Capacidad': 'غير محدودة', 'Esfuerzo de configuración': 'معقّد', 'Ideal para': 'مؤسسات، نطاق كبير' },
            { 'Base de datos': 'Weaviate', 'Tipo': 'رسم بياني + متجه', 'Capacidad': 'غير محدودة', 'Esfuerzo de configuración': 'Docker', 'Ideal para': 'استعلامات معقّدة، علاقات' },
            { 'Base de datos': 'Pinecone (سحابة)', 'Tipo': 'مُدارة', 'Capacidad': 'غير محدودة', 'Esfuerzo de configuración': 'مفتاح API', 'Ideal para': 'بلا خادم، بلا صيانة' },
          ],
          columns: ['Base de datos', 'Tipo', 'Capacidad', 'Esfuerzo de configuración', 'Ideal para'],
        },
        embeddings: {
          ...
          rows: [
            { 'Modelo': 'nomic-embed-text (محلي)', 'Dimensiones': '768', 'Velocidad': 'سريع', 'Calidad': 'ممتاز', 'Recomendación': 'الأفضل لـRAG المحلي' },
            { 'Modelo': 'bge-m3 (محلي)', 'Dimensiones': '1024', 'Velocidad': 'سريع', 'Calidad': 'ممتاز', 'Recomendación': 'دعم متعدد اللغات' },
            { 'Modelo': 'OpenAI text-embedding-3 (سحابي)', 'Dimensiones': '3072', 'Velocidad': 'سريع جدًا', 'Calidad': 'الأفضل في فئته', 'Recomendación': 'نهج هجين' },
            { 'Modelo': 'Cohere (سحابي)', 'Dimensiones': '4096', 'Velocidad': 'سريع', 'Calidad': 'ممتاز', 'Recomendación': 'RAG سحابي للإنتاج' },
          ],
          columns: ['Modelo', 'Dimensiones del vector', 'Velocidad', 'Calidad', 'Recomendación'],
        },
        retrieval: {
