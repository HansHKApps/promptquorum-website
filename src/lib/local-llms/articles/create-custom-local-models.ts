...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      intro: 'Creating custom local LLMs means fine-tuning an existing model or pre-training from scratch. As of August 2026, fine-tuning with LoRA is practical on consumer hardware: 500 examples, 8 GB VRAM, 1–2 hours, $100–500. Pre-training costs $50K–500K and requires 10B+ tokens — justified only for rare proprietary needs. This guide covers both approaches: the 7-step fine-tuning path with Unsloth, the decision matrix for fine-tuning vs pre-training vs RAG, and deployment to [Ollama](https://ollama.com/).',
      ...
      leadAnswerBlock: 'Creating custom local LLMs means fine-tuning an existing model or pre-training from scratch. As of August 2026, fine-tuning with LoRA is practical on consumer hardware: 500 examples, 8 GB VRAM, 1–2 hours, $100–500. Pre-training costs $50K–500K and requires 10B+ tokens — justified only for rare proprietary needs. This guide covers both approaches: the 7-step fine-tuning path with Unsloth, the decision matrix for fine-tuning vs pre-training vs RAG, and deployment to Ollama.',
...
schema: {
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'As of August 2026, pre-training is rarely justified unless you need proprietary model.',
          ],
        },
        ftVsPt: {
    ...
    es: {
      ...
      publishDate: '2026-04-04',
      dateModified: '2026-08-28',
      leadAnswerBlock: 'Crear LLMs locales personalizados significa hacer fine-tuning de un modelo existente o pre-entrenar desde cero. A partir de agosto de 2026, el fine-tuning con LoRA es práctico en hardware de consumo: 500 ejemplos, 8 GB VRAM, 1–2 horas, $100–500. El pre-training cuesta $50K–500K y requiere más de 10B tokens — justificado solo para necesidades propietarias excepcionales. Esta guía cubre ambos enfoques: el camino de fine-tuning en 7 pasos con Unsloth, la matriz de decisión entre fine-tuning vs pre-training vs RAG, y el despliegue en Ollama.',
...
schema: {
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'A partir de agosto de 2026, el pre-training rara vez está justificado a menos que necesites un modelo propietario.',
          ],
        },
        ftVsPt: {
          id: 'finetuning-vs-pretraining',
    ...
    ar: {
      ...
      intro: 'إنشاء نماذج LLM محلية مخصصة يعني الضبط الدقيق لنموذج موجود أو التدريب المسبق من الصفر. اعتباراً من أغسطس 2026، الضبط الدقيق بـ LoRA عملي على العتاد الاستهلاكي: 500 مثال، 8 GB VRAM، 1–2 ساعة، 100–500 دولار. يكلّف التدريب المسبق 50 ألف–500 ألف دولار ويتطلب أكثر من 10 مليارات رمز — مبرَّر فقط للاحتياجات المملوكة الاستثنائية. يغطي هذا الدليل النهجين: مسار الضبط الدقيق بـ 7 خطوات مع Unsloth، ومصفوفة القرار بين الضبط الدقيق والتدريب المسبق وRAG، والنشر على [Ollama](https://ollama.com/).',
...
schema: {
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'اعتباراً من أغسطس 2026، نادراً ما يكون التدريب المسبق مبرَّراً ما لم تحتج نموذجاً مملوكاً.',
          ],
        },
        ftVsPt: {
          id: 'finetuning-vs-pretraining',
    ...
    pt: {
      ...
      publishDate: '2026-04-04',
      leadAnswerBlock: 'Criar LLMs locais personalizados significa fazer fine-tuning de um modelo existente ou pré-treinar do zero. A partir de agosto de 2026, o fine-tuning com LoRA é prático em hardware de consumo: 500 exemplos, 8 GB VRAM, 1–2 horas, $100–500. O pré-treinamento custa $50K–500K e requer mais de 10B de tokens — justificado apenas para necessidades proprietárias excepcionais.',
...
schema: {
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Ab August 2026 ist Pre-Training selten begründet, außer Sie benötigen proprietäres Modell.',
          ],
        },
        ftVsPt: {
          id: 'finetuning-vs-pretraining',
    ...
    fr: {
      ...
      publishDate: '2026-04-04',
      dateModified: '2026-08-28',
      leadAnswerBlock: 'Créer des LLMs locaux personnalisés signifie affiner un modèle existant ou pré-entraîner à partir de zéro. En août 2026, le fine-tuning avec LoRA est pratique sur du matériel grand public : 500 exemples, 8 GB VRAM, 1–2 heures, 100–500 €.',
...
schema: {
    ...
    ja: {
      ...
      intro: 'カスタム ローカル LLM を構築するとは、既存モデルを fine-tune するか、ゼロから pre-train することを意味します。2026 年 8 月現在、LoRA による fine-tuning はコンシューマー ハードウェアで実用的です：500 サンプル、8 GB VRAM、1～2 時間、¥15,000～30,000。Pre-training には ¥6,000,000～60,000,000 かかり、100 億+ トークンが必要です—稀な独自ニーズのみ正当化されます。このガイドは両方のアプローチをカバーしています：Unsloth を使用した 7 ステップ fine-tuning パス、fine-tuning vs. pre-training vs. RAG の決定マトリックス、および Ollama への デプロイメント。',
      metaDescription: 'Llama 3.1 8BをLoRAで微調整：500例、8GB VRAM、1–2時間、$100–500。事前訓練：10B+トークン、数週間、$50K–500K。判断マトリクスとOllamaデプロイ手順付き。',
      publishDate: '2026-04-04',
      dateModified: '2026-08-28',
      leadAnswerBlock: 'カスタム ローカル LLM を構築するとは、既存モデルを fine-tune するか、ゼロから pre-train することを意味します。2026 年 8 月現在、LoRA による fine-tuning はコンシューマー ハードウェアで実用的です：500 サンプル、8 GB VRAM、1～2 時間、¥15,000～30,000。',
...
schema: {
    ...
    zh: {
      ...
      intro: '创建自定义本地 LLM 意味着微调现有模型或从零开始预训练。截至 2026 年 8 月，使用 LoRA 的微调在消费级硬件上可行：500 个样本、8GB VRAM、1-2 小时、$100-500。预训练成本为 $50,000-500,000，需要 100 亿+ tokens——仅对罕见的专有需求合理。本指南涵盖两种方法：使用 Unsloth 的 7 步微调路径、微调 vs. 预训练 vs. RAG 决策矩阵以及 Ollama 部署。',
      metaDescription: '用LoRA微调Llama 3.1 8B：500个样本，8GB显存，1–2小时，$100–500。预训练：10B+令牌，数周，$50K–500K。含决策矩阵与Ollama部署指南。',
      publishDate: '2026-04-04',
      dateModified: '2026-08-28',
      leadAnswerBlock: '创建自定义本地 LLM 意味着微调现有模型或从零开始预训练。截至 2026 年 8 月，使用 LoRA 的微调在消费级硬件上可行：500 个样本、8GB VRAM、1-2 小时、$100-500。',
...
schema: {
  ...
  ko: {
    ...
    heroImage: '/images/create-custom-local-models-overview-hero-ko.webp',
      ...
      intro: '커스텀 로컬 LLM을 만드는 방법은 기존 모델을 파인튜닝하거나 처음부터 사전학습하는 두 가지가 있습니다. 2026년 8월 기준, LoRA를 활용한 파인튜닝은 소비자용 하드웨어에서도 실용적입니다: 예시 500개, VRAM 8 GB, 1~2시간, $100~500. 사전학습은 $5만~50만이 소요되며 100억 개 이상의 토큰이 필요합니다 — 특수한 독점 목적에만 정당화됩니다. 이 가이드에서는 두 가지 접근 방식을 모두 다룹니다: Unsloth를 활용한 7단계 파인튜닝 경로, 파인튜닝 vs 사전학습 vs RAG 의사결정 매트릭스, 그리고 [Ollama](https://ollama.com/) 배포 방법.',
      ...
      publishDate: '2026-04-04',
      dateModified: '2026-08-28',
      leadAnswerBlock: '커스텀 로컬 LLM을 만드는 방법은 기존 모델을 파인튜닝하거나 처음부터 사전학습하는 두 가지가 있습니다. 2026년 8월 기준, LoRA를 활용한 파인튜닝은 소비자용 하드웨어에서도 실용적입니다: 예시 500개, VRAM 8 GB, 1~2시간, $100~500. 사전학습은 $5만~50만이 소요되며 100억 개 이상의 토큰이 필요합니다 — 특수한 독점 목적에만 정당화됩니다. 이 가이드에서는 Unsloth를 활용한 7단계 파인튜닝 경로, 파인튜닝 vs 사전학습 vs RAG 의사결정 매트릭스, 그리고 Ollama 배포 방법을 다룹니다.',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '2026년 8월 기준, 독점 모델이 필요한 경우가 아니면 사전학습은 거의 정당화되지 않습니다.',
          ],
        },
        ftVsPt: {
          id: 'finetuning-vs-pretraining',
