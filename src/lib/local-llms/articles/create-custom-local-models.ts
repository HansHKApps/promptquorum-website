...
schema: {
    ...
    es: {
      ...
      seoTitle: 'Crear LLMs Locales Personalizados 2026: Fine-Tune por $500 vs Pre-Training $50K',
      ...
      metaDescription: 'Fine-tune Llama 3.1 8B con LoRA: 500 ejemplos, 8 GB VRAM, 1–2 horas, $100–500. Pre-training: 10B+ tokens, semanas, $50K–500K. Matriz de decisión y guía de despliegue en Ollama.',
      publishDate: '2026-04-04',
      dateModified: '2026-04-24',
...
schema: {
      ...
      howToSchema: {
        ...
        step: [
          ...
          { '@type': 'HowToStep', 'position': 2, 'name': 'Elige el modelo base (Llama 3.1 8B o Qwen2.5 7B)', 'text': 'Usa la variante instruction-tuned para mejores resultados' },
