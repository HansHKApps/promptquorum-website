...
schema: {
    ...
    es: {
      ...
      seoTitle: 'LLMs Locales para Programar 2026: Qwen2.5-Coder 92% HumanEval',
      ...
      metaDescription: 'Qwen2.5-Coder 32B: 92,7% HumanEval, funciona con 24 GB de VRAM. Qwen2.5-Coder 7B: 72% con 5 GB. Generación de código, revisión y escritura de pruebas con Ollama + VS Code. Tabla completa de benchmarks.',
      publishDate: '2026-04-04',
      dateModified: '2026-04-24',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 5, 'name': 'Mistral 7B', 'description': '61% HumanEval. 4,5 GB VRAM Q4. Ligero, conforme con el RGPD de la UE.' },
