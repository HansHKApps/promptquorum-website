      ...
      sections: {
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Not using a coding-specific model.** General-purpose models (Llama 3.3 8B, Mistral Small) score 15–25% lower on HumanEval than coding models (Qwen2.5-Coder 7B: 72% vs Llama 3.3 8B: 55%). Always use a model trained specifically for code. In Ollama: `ollama pull qwen2.5-coder:7b` — not `ollama pull llama3.1:8b` for coding tasks.',
          ],
      ...
      sections: {
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Kein Programmierungsmodell verwenden.** Allzweck-Modelle (Llama 3.3 8B, Mistral Small) erzielen 15–25% niedrigere Ergebnisse auf HumanEval als Programmierungsmodelle (Qwen2.5-Coder 7B: 72% vs. Llama 3.3 8B: 55%). Nutzen Sie immer ein Modell, das speziell für Code trainiert wurde. In Ollama: `ollama pull qwen2.5-coder:7b` — nicht `ollama pull llama3.1:8b` für Programmierungsaufgaben.',
          ],
        },
        faqSection: {
          id: 'faq',
      ...
      sections: {
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Ne pas utiliser un modèle spécialisé en programmation.** Les modèles polyvalents (Llama 3.3 8B, Mistral Small) obtiennent 15–25% de moins sur HumanEval que les modèles de programmation (Qwen2.5-Coder 7B : 72% vs Llama 3.3 8B : 55%). Utilisez toujours un modèle entraîné spécifiquement pour le code. Dans Ollama : `ollama pull qwen2.5-coder:7b` — pas `ollama pull llama3.1:8b` pour les tâches de programmation.',
          ],
        },
        faqSection: {
          id: 'faq',
      ...
      sections: {
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**プログラミング固有モデルを使わない。** 汎用モデル（Llama 3.3 8B、Mistral Small）はプログラミングモデル（Qwen2.5-Coder 7B: 72% vs Llama 3.3 8B: 55%）より15～25%低いHumanEval結果を得ます。常にコード用に特別に訓練されたモデルを使用してください。Ollama：`ollama pull qwen2.5-coder:7b` — プログラミングタスクに `ollama pull llama3.1:8b` ではなく。',
          ],
        },
        faqSection: {
          id: 'faq',
      ...
      sections: {
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**不使用编程特定模型。** 通用模型（Llama 3.3 8B、Mistral Small）在HumanEval上比编程模型低15-25%（Qwen2.5-Coder 7B: 72% vs Llama 3.3 8B: 55%）。始终使用针对代码专门训练的模型。在Ollama中：`ollama pull qwen2.5-coder:7b` — 编程任务不要 `ollama pull llama3.1:8b`。',
          ],
        },
        faqSection: {
          id: 'faq',
...
schema: {
    ...
    es: {
      ...
      seoTitle: 'LLMs locales para programar 2026: Qwen2.5-Coder al 92%',
      intro: 'Los LLMs locales pueden ayudarte con la programación: generar código repetitivo, revisar código, escribir pruebas y explicar funciones. A partir de abril de 2026, modelos como Qwen2.5-Coder 32B y CodeLlama 34B alcanzan entre el 72 y el 92,7% de precisión en los benchmarks HumanEval. La velocidad es menor que en la nube (2-5 seg por respuesta), pero el código nunca sale de tu máquina.',
      metaDescription: 'Qwen2.5-Coder 32B: 92,7% HumanEval con 24 GB de VRAM. Qwen2.5-Coder 7B: 72% con 5 GB. Genera, revisa y prueba código con Ollama + VS Code. Con benchmarks.',
      publishDate: '2026-04-04',
      dateModified: '2026-04-24',
      leadAnswerBlock: '**Los LLMs locales pueden ayudarte con la programación: generar código repetitivo, revisar código, escribir pruebas y explicar funciones. A partir de abril de 2026, modelos como Qwen2.5-Coder 32B (92,7% HumanEval) y CodeLlama 34B (75% HumanEval) alcanzan precisión de vanguardia en benchmarks de programación.**',
      ...
      sections: {
        ...
        bestModels: {
          ...
          callouts: [
            { type: 'tip', text: '**Consejo Pro:** Empieza con Qwen2.5-Coder 7B si tienes 4-6 GB de VRAM (72% de precisión). Para máxima precisión, usa Qwen2.5-Coder 32B con 24 GB+ de VRAM (92,7% de precisión). CodeLlama 34B es una sólida opción intermedia con un 75%.' },
          ],
          rows: [
            { 'Modelo': 'Qwen2.5-Coder 32B', 'HumanEval': '92,7%', 'VRAM': '22 GB', 'Velocidad': 'Lenta (3-5 seg)', 'Mejor para': 'Máxima precisión' },
            { 'Modelo': 'CodeLlama 34B', 'HumanEval': '75%', 'VRAM': '22 GB', 'Velocidad': 'Lenta (3-5 seg)', 'Mejor para': 'Alta calidad' },
            { 'Modelo': 'Qwen2.5-Coder 7B', 'HumanEval': '72%', 'VRAM': '4,7 GB', 'Velocidad': 'Muy rápida', 'Mejor para': 'Equilibrio velocidad/calidad' },
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**No usar un modelo específico para programación.** Los modelos de propósito general (Llama 3.3 8B, Mistral Small) obtienen entre un 15 y un 25% menos en HumanEval que los modelos de programación (Qwen2.5-Coder 7B: 72% vs Llama 3.3 8B: 55%). Usa siempre un modelo entrenado específicamente para código. En Ollama: `ollama pull qwen2.5-coder:7b` — no `ollama pull llama3.1:8b` para tareas de programación.',
          ],
          ...
          faqs: [
            {
              ...
              a: 'Qwen2.5-Coder 32B (92,7% HumanEval) para máxima calidad con 24 GB de VRAM. Qwen2.5-Coder 7B (72%) para velocidad con 5 GB de VRAM. Para usuarios de MacBook con Apple Silicon: Qwen2.5-Coder 7B via Ollama funciona a 30-60 tokens/seg en M1 Pro+.',
            },
            {
              q: '¿Cómo se compara Qwen2.5-Coder 32B con GitHub Copilot?',
              a: 'Qwen2.5-Coder 32B obtiene un 92,7% en HumanEval — a solo un 2% del backend GPT-5.2 de Copilot (~94%). Velocidad: local son 2-5 segundos por sugerencia vs los ~300 ms de Copilot (ventaja de la nube). La calidad es prácticamente equivalente. Privacidad: el local mantiene el código en el dispositivo. Coste: el local es $0/mes tras el hardware; Copilot es $19/mes ($228/año).',
            },
            {
              q: '¿Puedo usar un LLM de programación local en VS Code?',
              a: 'Sí — instala la extensión Continue.dev (gratuita, de código abierto). Configúrala para conectarse a Ollama en localhost:11434. El autocompletado en línea se activa con Tab o Ctrl+Shift+\\\\. Continue.dev es compatible con Qwen2.5-Coder, DeepSeek-Coder y todos los modelos de Ollama.',
            },
            {
            ...
            },
            {
              ...
              a: 'Mínimo: 5 GB de VRAM para Qwen2.5-Coder 7B Q4. Recomendado: 8 GB para inferencia 7B cómoda. Premium: 24 GB para Qwen2.5-Coder 32B (máxima calidad). RTX 4060 Ti (8 GB) ejecuta modelos 7B. RTX 4070 (12 GB) ejecuta modelos 14-16B. RTX 4090/5090 (24-32 GB) ejecuta modelos 32B.',
            },
            {
            ...
            },
            {
              ...
              a: 'Qwen2.5-Coder 32B y DeepSeek-Coder-V2 soportan más de 90 lenguajes, incluyendo Python, JavaScript, TypeScript, Rust, Go, Java, C++, SQL, Bash y Ruby. CodeLlama es el más fuerte en Python y C++. Para lenguajes de nicho (Haskell, Erlang, Elixir), Qwen2.5-Coder 32B tiene la cobertura más amplia.',
            },
          ],
        },
        relatedReading: {
        ...
        sources: {
          ...
          items: [
            ...
            '[Ficha del modelo Qwen2.5-Coder](https://github.com/QwenLM/Qwen2.5-Coder) — Especificaciones del modelo Qwen2.5-Coder y resultados de evaluación',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '¿Cuánta VRAM necesito para un LLM de programación local?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Mínimo: 5 GB para Qwen2.5-Coder 7B Q4. Recomendado: 8 GB. Premium: 24 GB para Qwen2.5-Coder 32B. RTX 4060 Ti (8 GB) para 7B. RTX 4070 (12 GB) para 14-16B. RTX 4090 (24 GB) para 32B.' } },
          { '@type': 'Question', 'name': '¿El LLM de programación local soporta autocompletado como Copilot?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Sí — mediante Continue.dev o Cursor. Ambos soportan FIM (fill-in-the-middle). Qwen2.5-Coder 7B soporta FIM de forma nativa. Tiempo de respuesta: 1-3 segundos en GPU vs 200-300 ms de Copilot.' } },
          { '@type': 'Question', 'name': '¿Puedo ajustar finamente un modelo de programación con mi base de código?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Sí — usa LoRA/QLoRA con Unsloth. Prepara más de 500 ejemplos en formato de instrucción. El ajuste fino de Qwen2.5-Coder 7B tarda 1-2 horas con 8 GB de VRAM. Mejora típica: 10-15%.' } },
          { '@type': 'Question', 'name': '¿Qué LLM de programación soporta más lenguajes de programación?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Qwen2.5-Coder 32B y DeepSeek-Coder-V2 soportan más de 90 lenguajes: Python, JavaScript, TypeScript, Rust, Go, Java, C++, SQL, Bash, Ruby. Para lenguajes de nicho: Qwen2.5-Coder 32B.' } },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'Qwen2.5-Coder 7B', 'description': '72% HumanEval. 4,7 GB VRAM Q4. Modelo de programación más rápido y equilibrado. ollama pull qwen2.5-coder:7b' },
