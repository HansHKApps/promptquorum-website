...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      current_models_mentioned: ['Kimi K2.6', 'Qwen3.8-27B', 'Devstral Small 24B', 'Codestral 22B', 'Qwen3 8B', 'gpt-oss:20b'],
      ...
      sections: {
        ...
        bestModels: {
          ...
          callouts: [
            { type: 'tip', text: '**Pro Tip:** Start with Qwen3 8B if you have 5–8 GB VRAM (~76% HumanEval, FIM autocomplete support). For agentic multi-file workflows, use Devstral Small 24B (16 GB VRAM). For maximum SWE-bench accuracy, use Kimi K2.6 quantized (58.6 SWE-Bench Pro) or Qwen3.8-27B (61.7% SWE-bench, 24 GB VRAM, dense).' },
          ],
          rows: [
            ...
            { 'Model': 'Qwen3.8-27B', 'SWE-bench': '61.7%', 'HumanEval (legacy)': '—', 'VRAM': '22 GB', 'Speed': 'Slow (3-5 sec)', 'Best For': 'Best dense model' },
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Yes — install the Continue.dev extension (free, open source). Configure it to connect to Ollama at localhost:11434. Inline completions trigger with Tab or Ctrl+Shift+\\\\. Continue.dev supports Kimi K2.6, Qwen3.8-27B, Devstral Small 24B, Codestral 22B, Qwen3 8B, and all Ollama models.',
            },
            {
              q: 'Is Copilot or local LLM better for a proprietary codebase?',
              a: 'Local LLM. With Copilot, your code is sent to Microsoft/OpenAI servers for inference. With a local model on Ollama, code never leaves your machine. For regulated industries (finance, healthcare, defense), local is the only compliant option. The quality gap versus cloud models has narrowed significantly since SWE-bench-tuned models like Kimi K2.6 and Qwen3.8-27B became available.',
            },
            {
              q: 'How much VRAM do I need for a local coding LLM?',
              a: 'Minimum: 5 GB VRAM for Qwen3 8B. Recommended: 16 GB for Devstral Small 24B or Qwen3.8-27B. Premium: 20+ GB for Kimi K2.6 (quantized), best overall quality. RTX 4060 Ti (8 GB) runs Qwen3 8B. RTX 4070/4070 Ti (12–16 GB) runs Devstral Small 24B or Codestral 22B. RTX 4090/5090 (24–32 GB) runs Qwen3.8-27B or Kimi K2.6 quantized.',
            },
            {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Local AI Code Review vs. CodeRabbit](/local-llms/local-ai-code-review-vs-coderabbit) — Whether a self-hosted Qwen3-Coder + PR-Agent pipeline can replace a SaaS review bot, and the honest trade-offs of each.',
        ...
        sources: {
          ...
          items: [
            ...
            '**Qwen Team. (2026).** "Qwen3.8 Technical Report" — 61.7% SWE-bench, dense architecture',
...
schema: {
        ...
        'description': 'Local coding models (Kimi K2.6: 58.6 SWE-Bench Pro, Qwen3.8-27B: 61.7% SWE-bench) generate, review, and test code privately without cloud APIs. Complete setup guides for VS Code and Cursor.',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'How much VRAM do I need for a local coding LLM?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Minimum: 5 GB for Qwen3 8B. Recommended: 16 GB for Devstral Small 24B or Qwen3.8-27B. Premium: 20+ GB for Kimi K2.6 quantized. RTX 4060 Ti (8 GB) runs Qwen3 8B. RTX 4070/4070 Ti (12–16 GB) runs Devstral Small 24B or Codestral 22B. RTX 4090/5090 (24–32 GB) runs Qwen3.8-27B or Kimi K2.6 quantized.' } },
          ...
          { '@type': 'Question', 'name': 'Which coding LLM supports the most programming languages?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Qwen3.8-27B and Kimi K2.6 both support 90+ languages: Python, JavaScript, TypeScript, Rust, Go, Java, C++, SQL, Bash, Ruby. Devstral Small 24B and Codestral 22B are strongest on Python, JavaScript, TypeScript, Go, Rust. Best for niche languages: Qwen3.8-27B and Kimi K2.6.' } },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 2, 'name': 'Qwen3.8-27B', 'description': '61.7% SWE-bench. 24 GB VRAM. Best dense (non-MoE) coding model. ollama run qwen3.8:27b' },
    ...
    de: {
      ...
      gammaEmbedUrl: '/presentations/local-llms-for-coding-workflows-static.html',
      gammaDescription: 'Das Foliendeck unten behandelt: beste lokale Programmiermodelle (Kimi K2.6 58,6 SWE-Bench Pro, Qwen3.8-27B 61,7% SWE-bench), Code-Generierung mit Prompt Engineering, Code-Review-Workflows, Test-Generierung, VS Code/Cursor IDE-Integration und häufige Fehler. PDF als lokale Programmier-KI-Referenzkarte herunterladen. (Das Foliendeck spiegelt Daten von April 2026 wider; die Empfehlungen im obigen Text sind auf dem Stand von Juli 2026.)',
      sections: {
        tldr: {
          id: 'key-takeaways',
          isTldr: true,
        ...
        bestModels: {
          ...
          rows: [
            ...
            { 'Modell': 'Qwen3.8-27B', 'SWE-bench': '61,7%', 'HumanEval (Legacy)': '—', 'VRAM': '22 GB', 'Geschwindigkeit': 'Langsam (3–5 Sek.)', 'Am besten für': 'Bestes dichtes Modell' },
          ...
          faqs: [
            {
              ...
              a: 'Stand Juli 2026: Kimi K2.6 (58,6 SWE-Bench Pro, MoE) für maximale Genauigkeit. Qwen3.8-27B (61,7% SWE-bench) für die beste Qualität unter den dichten Modellen auf 24 GB VRAM. Devstral Small 24B für agentisches Multi-Datei-Programmieren. Codestral 22B für IDE-Autovervollständigung. Qwen3 8B für 8 GB VRAM. Für MacBook-Nutzer mit Apple Silicon: Qwen3 8B läuft via Ollama gut auf M1 Pro+.',
            },
            {
        ...
        sources: {
          ...
          items: [
            ...
            '**Qwen Team. (2026).** "Qwen3.8 Technical Report" — 61,7% SWE-bench, dichte Architektur',
...
schema: {
        ...
        'description': 'Lokale Programmierungsmodelle (Kimi K2.6: 58,6 SWE-Bench Pro, Qwen3.8-27B: 61,7% SWE-bench) generieren, überprüfen und testen Code privat ohne Cloud-APIs. Komplette Setup-Anleitungen für VS Code und Cursor.',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Wie viel VRAM benötige ich für ein lokales Programmierungsmodell?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Minimum: 5 GB für Qwen3 8B. Empfohlen: 16 GB für Devstral Small 24B oder Qwen3.8-27B. Premium: 20+ GB für Kimi K2.6 quantisiert. RTX 4060 Ti (8 GB) für Qwen3 8B. RTX 4070/4070 Ti (12–16 GB) für Devstral Small 24B oder Codestral 22B. RTX 4090/5090 (24–32 GB) für Qwen3.8-27B oder Kimi K2.6 quantisiert.' } },
          ...
          { '@type': 'Question', 'name': 'Welches Programmierungsmodell unterstützt die meisten Programmiersprachen?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Qwen3.8-27B und Kimi K2.6 unterstützen 90+ Sprachen: Python, JavaScript, TypeScript, Rust, Go, Java, C++, SQL, Bash, Ruby. Devstral Small 24B und Codestral 22B sind am stärksten bei Python, JavaScript, TypeScript, Go, Rust. Am umfassendsten für Nischensprachen: Qwen3.8-27B und Kimi K2.6.' } },
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 2, 'name': 'Qwen3.8-27B', 'description': '61,7% SWE-bench. 24 GB VRAM. Bestes dichtes (Nicht-MoE) Programmierungsmodell. ollama run qwen3.8:27b' },
    ...
    fr: {
      ...
      gammaEmbedUrl: '/presentations/local-llms-for-coding-workflows-static.html',
      gammaDescription: 'Le diaporama ci-dessous couvre : les meilleurs modèles de programmation locale (Kimi K2.6 58,6 SWE-Bench Pro, Qwen3.8-27B 61,7% SWE-bench), la génération de code avec l\'ingénierie des prompts, les workflows d\'examen de code, la génération de tests, l\'intégration IDE VS Code/Cursor et les erreurs courantes. Télécharger le PDF comme carte de référence pour l\'IA locale. (Le diaporama reflète les données d\'avril 2026 ; les recommandations du texte ci-dessus sont à jour en juillet 2026.)',
      sections: {
        tldr: {
          id: 'key-takeaways',
          isTldr: true,
        ...
        bestModels: {
          ...
          rows: [
            ...
            { 'Modèle': 'Qwen3.8-27B', 'SWE-bench': '61,7%', 'HumanEval (legacy)': '—', 'VRAM': '22 GB', 'Vitesse': 'Lente (3–5 sec)', 'Meilleur pour': 'Meilleur modèle dense' },
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Oui — installez l\'extension Continue.dev (gratuite, open source). Configurez-la pour se connecter à Ollama sur localhost:11434. Les complétions en ligne se déclenchent avec Tab ou Ctrl+Maj+\\\\. Continue.dev supporte Kimi K2.6, Qwen3.8-27B, Devstral Small 24B, Codestral 22B, Qwen3 8B et tous les modèles Ollama.',
            },
            {
              q: 'Copilot ou LLM local pour une base de code propriétaire ?',
              a: 'LLM local. Avec Copilot, votre code est envoyé aux serveurs Microsoft/OpenAI pour l\'inférence. Avec un modèle local sur Ollama, le code ne quitte jamais votre machine. Pour les secteurs réglementés (finance, santé, défense), local est la seule option conforme. L\'écart de qualité avec le cloud s\'est nettement réduit depuis l\'arrivée de modèles optimisés SWE-bench comme Kimi K2.6 et Qwen3.8-27B.',
            },
            {
              q: 'Combien de VRAM me faut-il pour un LLM de programmation local ?',
              a: 'Minimum : 5 GB de VRAM pour Qwen3 8B. Recommandé : 16 GB pour Devstral Small 24B ou Qwen3.8-27B. Premium : 20+ GB pour Kimi K2.6 (quantifié), meilleure qualité globale. RTX 4060 Ti (8 GB) exécute Qwen3 8B. RTX 4070/4070 Ti (12–16 GB) exécute Devstral Small 24B ou Codestral 22B. RTX 4090/5090 (24–32 GB) exécute Qwen3.8-27B ou Kimi K2.6 quantifié.',
            },
            {
        ...
        sources: {
          ...
          items: [
            ...
            '**Qwen Team. (2026).** « Qwen3.8 Technical Report » — 61,7% SWE-bench, architecture dense',
...
schema: {
        ...
        'description': 'Modèles de programmation locaux (Kimi K2.6 : 58,6 SWE-Bench Pro, Qwen3.8-27B : 61,7% SWE-bench) génèrent, examinent et testent le code en privé sans APIs cloud. Guides complets de configuration pour VS Code et Cursor.',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Combien de VRAM me faut-il pour un LLM de programmation local ?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Minimum : 5 GB pour Qwen3 8B. Recommandé : 16 GB pour Devstral Small 24B ou Qwen3.8-27B. Premium : 20+ GB pour Kimi K2.6 quantifié. RTX 4060 Ti (8 GB) pour Qwen3 8B. RTX 4070/4070 Ti (12–16 GB) pour Devstral Small 24B ou Codestral 22B. RTX 4090/5090 (24–32 GB) pour Qwen3.8-27B ou Kimi K2.6 quantifié.' } },
          ...
          { '@type': 'Question', 'name': 'Quel LLM de programmation supporte le plus de langages ?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Qwen3.8-27B et Kimi K2.6 supportent tous deux 90+ langages : Python, JavaScript, TypeScript, Rust, Go, Java, C++, SQL, Bash, Ruby. Devstral Small 24B et Codestral 22B sont les plus solides en Python, JavaScript, TypeScript, Go, Rust. Pour les langages de niche : Qwen3.8-27B et Kimi K2.6.' } },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 2, 'name': 'Qwen3.8-27B', 'description': '61,7% SWE-bench. 24 GB VRAM. Meilleur modèle dense (non-MoE). ollama run qwen3.8:27b' },
    ...
    ja: {
      ...
      intro: 'ローカルLLMはプログラミングを支援します：ボイラープレート生成、コード審査、テスト作成、関数説明。2026年7月時点で、Kimi K2.6（58.6 SWE-Bench Pro）とQwen3.8-27B（61.7% SWE-bench）がローカルプログラミングベンチマークをリードしています——SWE-benchが実践的なプログラミングベンチマークの主流としてHumanEvalに取って代わりました。クラウド（2～5秒/応答）より遅いですが、コードはプライベートです。',
      ...
      publishDate: '2026-04-04',
      dateModified: '2026-08-28',
      leadAnswerBlock: '**ローカルLLMはプログラミングを支援します：ボイラープレート生成、コード審査、テスト作成、関数説明。2026年7月時点で、Kimi K2.6（58.6 SWE-Bench Pro、MoE）がトップのローカルプログラミングモデルであり、Qwen3.8-27B（61.7% SWE-bench）が最良のdenseモデルとして続きます——SWE-bench（実際のGitHub issue解決）がプログラミングベンチマークの主流としてHumanEvalに取って代わりました。**',
      ...
      gammaEmbedUrl: '/presentations/local-llms-for-coding-workflows-static.html',
      gammaDescription: '下のスライドデッキは以下をカバーしています：ベストローカルコーディングモデル（Kimi K2.6 58.6 SWE-Bench Pro、Qwen3.8-27B 61.7% SWE-bench）、プロンプトエンジニアリングを使用したコード生成、コード審査ワークフロー、テスト生成、VS Code/Cursor IDE統合、よくある間違い。PDFをローカルコーディングAIリファレンスカードとしてダウンロード。（スライドデッキは2026年4月のモデルデータを反映しています。上記テキストの推奨事項は2026年7月時点で最新です。）',
      sections: {
        tldr: {
          id: 'key-takeaways',
          isTldr: true,
        ...
        bestModels: {
          ...
          callouts: [
            { type: 'tip', text: '**Pro Tip：** VRAMが5～8 GBならQwen3 8Bから始めてください（~76% HumanEval、FIMオートコンプリート対応）。agenticなマルチファイルワークフローにはDevstral Small 24B（16 GB VRAM）を使用してください。最大SWE-bench精度が必要なら、Kimi K2.6量子化版（58.6 SWE-Bench Pro）またはQwen3.8-27B（61.7% SWE-bench、24 GB VRAM、dense）を使用してください。' },
          ],
          rows: [
            { 'モデル': 'Kimi K2.6', 'SWE-bench': '58.6（SWE-Bench Pro）', 'HumanEval（レガシー）': '—', 'VRAM': '可変（量子化）', '速度': '遅い（3～5秒）', '最適用途': '最大精度、MoE' },
            { 'モデル': 'Qwen3.8-27B', 'SWE-bench': '61.7%', 'HumanEval（レガシー）': '—', 'VRAM': '22 GB', '速度': '遅い（3～5秒）', '最適用途': '最良のdenseモデル' },
          ...
          faqs: [
            {
              ...
              a: '2026年7月時点：最大精度ならKimi K2.6（58.6 SWE-Bench Pro、MoE）。24 GB VRAMで最良のdense品質ならQwen3.8-27B（61.7% SWE-bench）。agenticなマルチファイルプログラミングにはDevstral Small 24B。IDEオートコンプリートにはCodestral 22B。8 GB VRAMにはQwen3 8B。Apple SiliconのMacBookユーザー：Qwen3 8Bは Ollama経由でM1 Pro+上で快適に動作します。',
            },
            {
            ...
            },
            {
              ...
              a: 'はい——Continue.dev拡張をインストール（無料、オープンソース）。localhost:11434のOllamaに接続するよう設定。TabまたはCtrl+Shift+\\\\でインラインサジェストをトリガー。Continue.devはKimi K2.6、Qwen3.8-27B、Devstral Small 24B、Codestral 22B、Qwen3 8B、全Ollamaモデルをサポート。',
            },
            {
              q: 'proprietary codebaseにはCopilotまたはローカルLLMか',
              a: 'ローカルLLM。Copilotでは推論のためコードがMicrosoft/OpenAIサーバーに送られます。Ollama上のローカルモデルはコードがマシンを離れません。規制産業（金融、医療、防衛）ではローカルが唯一のコンプライアント選択肢。Kimi K2.6やQwen3.8-27BのようなSWE-bench最適化モデルの登場により、クラウドとの品質差は大幅に縮小しています。',
            },
            {
              q: 'ローカルプログラミングLLMに必要なVRAM量は',
              a: 'Minimum：Qwen3 8B向け5 GB VRAM。推奨：Devstral Small 24BまたはQwen3.8-27B向け16 GB。Premium：Kimi K2.6（量子化）向け20+ GB、最高の総合品質。RTX 4060 Ti（8 GB）はQwen3 8Bを実行。RTX 4070/4070 Ti（12～16 GB）はDevstral Small 24BまたはCodestral 22Bを実行。RTX 4090/5090（24～32 GB）はQwen3.8-27BまたはKimi K2.6量子化版を実行。',
            },
            {
            ...
            },
            {
              ...
              a: 'Qwen3.8-27BとKimi K2.6はどちらも90+言語をサポート：Python、JavaScript、TypeScript、Rust、Go、Java、C++、SQL、Bash、Ruby。Devstral Small 24BとCodestral 22BはPython、JavaScript、TypeScript、Go、Rustで最も強力です。Niche言語（Haskell、Erlang、Elixir）：Qwen3.8-27BとKimi K2.6が最広範囲。',
            },
          ],
        },
        relatedReading: {
        ...
        sources: {
          ...
          items: [
            ...
            '**Qwen Team.（2026年）.** 「Qwen3.8 Technical Report」 — 61.7% SWE-bench、denseアーキテクチャ',
...
schema: {
        ...
        'description': 'ローカルプログラミングモデル（Kimi K2.6: 58.6 SWE-Bench Pro、Qwen3.8-27B: 61.7% SWE-bench）はクラウドAPIなしでコード生成、審査、テストを行います。VS CodeとCursorの完全セットアップガイド。',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'ローカルプログラミングLLMに必要なVRAM量は', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Minimum：Qwen3 8B向け5 GB。推奨：Devstral Small 24BまたはQwen3.8-27B向け16 GB。Premium：Kimi K2.6量子化向け20+ GB。RTX 4060 Ti（8 GB）でQwen3 8B。RTX 4070/4070 Ti（12～16 GB）でDevstral Small 24BまたはCodestral 22B。RTX 4090/5090（24～32 GB）でQwen3.8-27BまたはKimi K2.6量子化版。' } },
          ...
          { '@type': 'Question', 'name': 'プログラミング言語をもっともサポートするプログラミングLLMは', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Qwen3.8-27BとKimi K2.6は90+言語をサポート：Python、JavaScript、TypeScript、Rust、Go、Java、C++、SQL、Bash、Ruby。Devstral Small 24BとCodestral 22BはPython、JavaScript、TypeScript、Go、Rustで最も強力。最広範囲：Qwen3.8-27BとKimi K2.6。' } },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 2, 'name': 'Qwen3.8-27B', 'description': '61.7% SWE-bench。24 GB VRAM。最良のdense（非MoE）プログラミングモデル。ollama run qwen3.8:27b' },
    ...
    zh: {
      ...
      intro: '本地LLM可协助编程：生成样板代码、审查代码、编写测试和解释函数。截至2026年7月，Kimi K2.6（58.6 SWE-Bench Pro）和Qwen3.8-27B（61.7% SWE-bench）领先本地编程基准——SWE-bench已取代HumanEval成为主流的实用编程基准。速度比云端慢（2-5秒/响应），但代码保持私密。',
      ...
      publishDate: '2026-04-04',
      dateModified: '2026-08-28',
      leadAnswerBlock: '**本地LLM可协助编程：生成样板代码、审查代码、编写测试和解释函数。截至2026年7月，Kimi K2.6（58.6 SWE-Bench Pro，MoE）是最佳本地编程模型，其次是Qwen3.8-27B（61.7% SWE-bench）作为最佳稠密模型选项——SWE-bench（真实GitHub问题解决）已取代HumanEval成为主要编程基准。**',
      ...
      gammaEmbedUrl: '/presentations/local-llms-for-coding-workflows-static.html',
      gammaDescription: '下面的幻灯片涵盖：最佳本地编程模型（Kimi K2.6 58.6 SWE-Bench Pro、Qwen3.8-27B 61.7% SWE-bench）、使用提示工程的代码生成、代码审查工作流、测试生成、VS Code/Cursor IDE集成和常见错误。将PDF下载为本地编程AI参考卡。（幻灯片反映的是2026年4月的模型数据；上文的建议以2026年7月为准。）',
      sections: {
        tldr: {
          id: 'key-takeaways',
          isTldr: true,
        ...
        bestModels: {
          ...
          callouts: [
            { type: 'tip', text: '**专业提示：** 如果您有5-8 GB VRAM，从Qwen3 8B开始（约76% HumanEval，支持FIM自动补全）。对于agentic多文件工作流，使用Devstral Small 24B（16 GB VRAM）。为获得最大SWE-bench精度，使用量化后的Kimi K2.6（58.6 SWE-Bench Pro）或Qwen3.8-27B（61.7% SWE-bench，24 GB VRAM，稠密模型）。' },
          ],
          rows: [
            { '模型': 'Kimi K2.6', 'SWE-bench': '58.6（SWE-Bench Pro）', 'HumanEval（传统）': '—', 'VRAM': '可变（量化）', '速度': '慢（3-5秒）', '最佳用途': '最大精度，MoE' },
            { '模型': 'Qwen3.8-27B', 'SWE-bench': '61.7%', 'HumanEval（传统）': '—', 'VRAM': '22 GB', '速度': '慢（3-5秒）', '最佳用途': '最佳稠密模型' },
          ...
          faqs: [
            {
              ...
              a: '截至2026年7月：Kimi K2.6（58.6 SWE-Bench Pro，MoE）追求最大精度。Qwen3.8-27B（61.7% SWE-bench）在24 GB VRAM上提供最佳稠密模型质量。Devstral Small 24B用于agentic多文件编程。Codestral 22B用于IDE自动补全。Qwen3 8B适合8 GB VRAM。MacBook Apple Silicon用户：Qwen3 8B通过Ollama在M1 Pro+上运行流畅。',
            },
            {
            ...
            },
            {
              ...
              a: '可以——安装Continue.dev扩展（免费、开源）。配置其连接到localhost:11434上的Ollama。使用Tab或Ctrl+Shift+\\\\触发内联建议。Continue.dev支持Kimi K2.6、Qwen3.8-27B、Devstral Small 24B、Codestral 22B、Qwen3 8B和所有Ollama模型。',
            },
            {
              q: '对于专有代码库，Copilot还是本地LLM更好？',
              a: '本地LLM。使用Copilot时，您的代码会被发送到Microsoft/OpenAI服务器进行推理。使用Ollama上的本地模型时，代码永不离开您的机器。对于受监管的行业（金融、医疗、防卫），本地是唯一的合规选择。自Kimi K2.6和Qwen3.8-27B等SWE-bench优化模型问世以来，与云端的质量差距已大幅缩小。',
            },
            {
              q: '本地编程LLM需要多少VRAM？',
              a: '最小：Qwen3 8B需要5 GB VRAM。建议：Devstral Small 24B或Qwen3.8-27B需要16 GB。高级：Kimi K2.6（量化）需要20+ GB，可获得最佳综合质量。RTX 4060 Ti（8 GB）运行Qwen3 8B。RTX 4070/4070 Ti（12-16 GB）运行Devstral Small 24B或Codestral 22B。RTX 4090/5090（24-32 GB）运行Qwen3.8-27B或量化后的Kimi K2.6。',
            },
            {
            ...
            {
              q: '哪个编程LLM支持最多编程语言？',
              a: 'Qwen3.8-27B和Kimi K2.6都支持90+种语言：Python、JavaScript、TypeScript、Rust、Go、Java、C++、SQL、Bash、Ruby。Devstral Small 24B和Codestral 22B在Python、JavaScript、TypeScript、Go和Rust上最强。对于小众语言（Haskell、Erlang、Elixir），Qwen3.8-27B和Kimi K2.6覆盖范围最广。',
            },
          ],
        },
        relatedReading: {
        ...
        sources: {
          ...
          items: [
            ...
            '**Qwen Team.（2026年）.** "Qwen3.8 Technical Report" — 61.7% SWE-bench，稠密架构',
...
schema: {
        ...
        'description': '本地编程模型（Kimi K2.6: 58.6 SWE-Bench Pro、Qwen3.8-27B: 61.7% SWE-bench）无需云API即可生成、审查和测试代码。VS Code和Cursor完整设置指南。',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '本地编程LLM需要多少VRAM？', 'acceptedAnswer': { '@type': 'Answer', 'text': '最小：Qwen3 8B需要5 GB。建议：Devstral Small 24B或Qwen3.8-27B需要16 GB。高级：Kimi K2.6量化需要20+ GB。RTX 4060 Ti（8 GB）用于Qwen3 8B。RTX 4070/4070 Ti（12-16 GB）用于Devstral Small 24B或Codestral 22B。RTX 4090/5090（24-32 GB）用于Qwen3.8-27B或量化后的Kimi K2.6。' } },
          ...
          { '@type': 'Question', 'name': '哪个编程LLM支持最多编程语言？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Qwen3.8-27B和Kimi K2.6都支持90+种语言：Python、JavaScript、TypeScript、Rust、Go、Java、C++、SQL、Bash、Ruby。Devstral Small 24B和Codestral 22B在Python、JavaScript、TypeScript、Go、Rust上最强。最广范围：Qwen3.8-27B和Kimi K2.6。' } },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 2, 'name': 'Qwen3.8-27B', 'description': '61.7% SWE-bench。24 GB VRAM。最佳稠密（非MoE）编程模型。ollama run qwen3.8:27b' },
    ...
    es: {
      ...
      intro: 'Los LLMs locales pueden ayudarte con la programación: generar código repetitivo, revisar código, escribir pruebas y explicar funciones. Desde julio de 2026, Kimi K2.6 (58,6 SWE-Bench Pro) y Qwen3.8-27B (61,7% SWE-bench) lideran los benchmarks de programación local — SWE-bench ha reemplazado a HumanEval como el benchmark de programación práctico de referencia. La velocidad es menor que en la nube (2-5 seg por respuesta), pero el código nunca sale de tu máquina.',
      ...
      publishDate: '2026-04-04',
      dateModified: '2026-08-28',
      leadAnswerBlock: '**Los LLMs locales pueden ayudarte con la programación: generar código repetitivo, revisar código, escribir pruebas y explicar funciones. Desde julio de 2026, Kimi K2.6 (58,6 SWE-Bench Pro, MoE) es el mejor modelo de programación local, seguido de Qwen3.8-27B (61,7% SWE-bench) como la mejor opción densa — SWE-bench (resolución de incidencias reales de GitHub) ha reemplazado a HumanEval como el benchmark de programación de referencia.**',
      ...
      sections: {
        ...
        bestModels: {
          ...
          rows: [
            ...
            { 'Modelo': 'Qwen3.8-27B', 'SWE-bench': '61,7%', 'HumanEval (legado)': '—', 'VRAM': '22 GB', 'Velocidad': 'Lenta (3-5 seg)', 'Mejor para': 'Mejor modelo denso' },
        ...
        sources: {
          ...
          items: [
            ...
            '**Qwen Team. (2026).** "Qwen3.8 Technical Report" — 61,7% SWE-bench, arquitectura densa',
      ...
      schema: {
        ...
        'description': 'Modelos de programación local (Kimi K2.6: 58,6 SWE-Bench Pro, Qwen3.8-27B: 61,7% SWE-bench) generan, revisan y prueban código de forma privada sin APIs en la nube. Guías completas de configuración para VS Code y Cursor.',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '¿Qué LLM de programación soporta más lenguajes de programación?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Qwen3.8-27B y Kimi K2.6 soportan más de 90 lenguajes: Python, JavaScript, TypeScript, Rust, Go, Java, C++, SQL, Bash, Ruby. Devstral Small 24B y Codestral 22B son los más fuertes en Python, JavaScript, TypeScript, Go, Rust. Para lenguajes de nicho: Qwen3.8-27B y Kimi K2.6.' } },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 2, 'name': 'Qwen3.8-27B', 'description': '61,7% SWE-bench. 24 GB VRAM. Mejor modelo denso (no MoE). ollama run qwen3.8:27b' },
    ...
    ar: {
      ...
      intro: 'يمكن لنماذج LLM المحلية مساعدتك في البرمجة: توليد الشيفرة المتكررة، ومراجعة الشيفرة، وكتابة الاختبارات، وشرح الدوال. اعتبارًا من يوليو 2026، يتصدّر Kimi K2.6 (58.6 SWE-Bench Pro) وQwen3.8-27B (61.7% SWE-bench) معايير البرمجة المحلية — وقد حلّ SWE-bench محل HumanEval كمعيار البرمجة العملي الرئيسي. السرعة أقل من السحابة (2-5 ثوانٍ لكل استجابة)، لكن الشيفرة لا تغادر جهازك أبدًا.',
      ...
      publishDate: '2026-04-04',
      dateModified: '2026-08-28',
      leadAnswerBlock: '**يمكن لنماذج LLM المحلية مساعدتك في البرمجة: توليد الشيفرة المتكررة، ومراجعة الشيفرة، وكتابة الاختبارات، وشرح الدوال. اعتبارًا من يوليو 2026، يُعدّ Kimi K2.6 (58.6 SWE-Bench Pro، MoE) أفضل نموذج برمجة محلي، يليه Qwen3.8-27B (61.7% SWE-bench) كأفضل خيار كثيف — وقد حلّ SWE-bench (حل مشكلات GitHub الحقيقية) محل HumanEval كمعيار البرمجة الرئيسي.**',
      ...
      gammaEmbedUrl: '/presentations/local-llms-for-coding-workflows-static.html',
      gammaDescription: 'يغطي العرض التقديمي أدناه: أفضل نماذج البرمجة المحلية (Kimi K2.6 بـ58.6 SWE-Bench Pro، Qwen3.8-27B بـ61.7% SWE-bench)، توليد الشيفرة بهندسة المطالبات، سير عمل مراجعة الشيفرة، توليد الاختبارات، التكامل مع IDE VS Code/Cursor والأخطاء الشائعة. نزّل ملف PDF كبطاقة مرجعية للذكاء الاصطناعي البرمجي المحلي. (يعكس العرض بيانات أبريل 2026؛ التوصيات في النص أعلاه محدّثة حتى يوليو 2026.)',
      sections: {
        tldr: {
          id: 'key-takeaways',
          isTldr: true,
        ...
        bestModels: {
          ...
          callouts: [
            { type: 'tip', text: '**نصيحة احترافية:** ابدأ بـQwen3 8B إذا كان لديك 5-8 GB من VRAM (~76% HumanEval، يدعم الإكمال التلقائي FIM). لسير العمل الوكيلي متعدد الملفات، استخدم Devstral Small 24B (16 GB من VRAM). لأقصى دقة SWE-bench، استخدم Kimi K2.6 بصيغة مكمّمة (58.6 SWE-Bench Pro) أو Qwen3.8-27B (61.7% SWE-bench، 22 GB من VRAM، كثيف).' },
          ],
          rows: [
            ...
            { 'النموذج': 'Qwen3.8-27B', 'SWE-bench': '61.7%', 'HumanEval (قديم)': '—', 'VRAM': '22 GB', 'السرعة': 'بطيئة (3-5 ثوانٍ)', 'الأفضل لـ': 'أفضل نموذج كثيف' },
          ...
          faqs: [
            {
              ...
              a: 'اعتبارًا من يوليو 2026: Kimi K2.6 (58.6 SWE-Bench Pro، MoE) لأقصى دقة. Qwen3.8-27B (61.7% SWE-bench) لأفضل جودة كثيفة بـ22 GB من VRAM. Devstral Small 24B للبرمجة الوكيلية متعددة الملفات. Codestral 22B للإكمال التلقائي في IDE. Qwen3 8B لـ8 GB من VRAM. لمستخدمي MacBook بـApple Silicon: يعمل Qwen3 8B عبر Ollama بشكل جيد على M1 Pro+.',
            },
            {
            ...
            },
            {
              ...
              a: 'نعم — ثبّت إضافة Continue.dev (مجانية، مفتوحة المصدر). اضبطها للاتصال بـOllama على localhost:11434. يُفعَّل الإكمال التلقائي المضمّن بـTab أو Ctrl+Shift+\\\\. يدعم Continue.dev نماذج Kimi K2.6 وQwen3.8-27B وDevstral Small 24B وCodestral 22B وQwen3 8B وجميع نماذج Ollama.',
            },
            {
              q: 'أيهما أفضل لقاعدة شيفرة خاصة: Copilot أم نموذج LLM محلي؟',
              a: 'نموذج LLM محلي. مع Copilot، تُرسَل شيفرتك إلى خوادم Microsoft/OpenAI للاستدلال. مع نموذج محلي في Ollama، لا تغادر الشيفرة جهازك أبدًا. للقطاعات الخاضعة للتنظيم (المالية، الصحية، الدفاع)، المحلي هو الخيار المتوافق الوحيد. تقلّص فارق الجودة مع السحابة بشكل ملحوظ منذ ظهور نماذج مُحسَّنة لـSWE-bench مثل Kimi K2.6 وQwen3.8-27B.',
            },
            {
              q: 'كم أحتاج من VRAM لنموذج LLM برمجي محلي؟',
              a: 'الحد الأدنى: 5 GB من VRAM لـQwen3 8B. الموصى به: 16 GB لـDevstral Small 24B أو Qwen3.8-27B. المتميّز: 20+ GB لـKimi K2.6 (مكمّم)، لأفضل جودة إجمالية. RTX 4060 Ti (8 GB) تُشغّل Qwen3 8B. RTX 4070/4070 Ti (12-16 GB) تُشغّل Devstral Small 24B أو Codestral 22B. RTX 4090/5090 (24-32 GB) تُشغّل Qwen3.8-27B أو Kimi K2.6 المكمّم.',
            },
            {
        ...
        sources: {
          ...
          items: [
            ...
            '**Qwen Team. (2026).** "Qwen3.8 Technical Report" — 61.7% SWE-bench، بنية كثيفة',
      ...
      schema: {
        ...
        'description': 'نماذج البرمجة المحلية (Kimi K2.6: 58.6 SWE-Bench Pro، Qwen3.8-27B: 61.7% SWE-bench) تولّد وتراجع وتختبر الشيفرة بخصوصية دون واجهات API سحابية. أدلة إعداد كاملة لـVS Code وCursor.',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'كم أحتاج من VRAM لنموذج LLM برمجي محلي؟', 'acceptedAnswer': { '@type': 'Answer', 'text': 'الحد الأدنى: 5 GB لـQwen3 8B. الموصى به: 16 GB لـDevstral Small 24B أو Qwen3.8-27B. المتميّز: 20+ GB لـKimi K2.6 المكمّم. RTX 4060 Ti (8 GB) لـQwen3 8B. RTX 4070/4070 Ti (12-16 GB) لـDevstral Small 24B أو Codestral 22B. RTX 4090/5090 (24-32 GB) لـQwen3.8-27B أو Kimi K2.6 المكمّم.' } },
          ...
          { '@type': 'Question', 'name': 'أي نموذج LLM برمجي يدعم أكبر عدد من لغات البرمجة؟', 'acceptedAnswer': { '@type': 'Answer', 'text': 'يدعم Qwen3.8-27B وKimi K2.6 كلاهما أكثر من 90 لغة: Python وJavaScript وTypeScript وRust وGo وJava وC++ وSQL وBash وRuby. أما Devstral Small 24B وCodestral 22B فهما الأقوى في Python وJavaScript وTypeScript وGo وRust. للغات المتخصصة: Qwen3.8-27B وKimi K2.6.' } },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 2, 'name': 'Qwen3.8-27B', 'description': '61.7% SWE-bench. 24 GB VRAM. أفضل نموذج كثيف (غير MoE). ollama run qwen3.8:27b' },
    ...
    pt: {
      ...
      schema: {
        ...
        'description': 'Kimi K2.6: 58,6 SWE-Bench Pro. Qwen3.8-27B: 61,7% SWE-bench. Benchmarks, integração VS Code e fluxos de trabalho para geração, revisão e teste de código local.',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 2, 'name': 'Qwen3.8-27B', 'description': '61,7% SWE-bench. 24 GB VRAM. Melhor modelo denso (não MoE). ollama run qwen3.8:27b' },
  ...
  ko: {
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 2, 'name': 'Qwen3.8-27B', 'description': '61.7% SWE-bench. 22GB VRAM. 최고의 dense(비 MoE) 코딩 모델. ollama run qwen3.8:27b' },
