    ...
    en: {
      ...
      sections: {
        ...
        codeGeneration: {
          ...
          image: '/images/local-llms-for-coding-workflows-generation-workflow-hero-en.webp',
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Not using a coding-specific model.** Coding-specific models score 5–15% higher on HumanEval than general-purpose models at the same size — Llama 3.1 8B scores 72% on HumanEval, competitive but still behind dedicated coding models. Always use a model trained or fine-tuned specifically for code. In Ollama: `ollama pull qwen3:8b` — not `ollama pull llama3.1:8b` for coding tasks.',
          ],
          image: '/images/local-llms-for-coding-workflows-mistakes-hero-en.webp',
...
schema: {
    ...
    de: {
      ...
      heroImage: '/images/local-llms-for-coding-workflows-generation-workflow-hero-de.webp',
      publishDate: '2026-04-04',
      dateModified: '2026-07-14',
      ...
      sections: {
        ...
        codeGeneration: {
          ...
          image: '/images/local-llms-for-coding-workflows-generation-workflow-hero-de.webp',
        ...
        ideIntegration: {
          ...
          image: '/images/local-llms-for-coding-workflows-ide-setup-hero-de.webp',
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Kein Programmierungsmodell verwenden.** Programmierspezifische Modelle erzielen 5–15% höhere HumanEval-Ergebnisse als Allzweck-Modelle gleicher Größe — Llama 3.1 8B erreicht 72% auf HumanEval, konkurrenzfähig, aber weiterhin hinter dedizierten Programmiermodellen. Nutzen Sie immer ein Modell, das speziell für Code trainiert oder fein abgestimmt wurde. In Ollama: `ollama pull qwen3:8b` — nicht `ollama pull llama3.1:8b` für Programmierungsaufgaben.',
          ],
          image: '/images/local-llms-for-coding-workflows-mistakes-hero-de.webp',
...
schema: {
    ...
    fr: {
      ...
      heroImage: '/images/local-llms-for-coding-workflows-generation-workflow-hero-fr.webp',
      publishDate: '2026-04-04',
      dateModified: '2026-07-14',
      ...
      sections: {
        ...
        codeGeneration: {
          ...
          image: '/images/local-llms-for-coding-workflows-generation-workflow-hero-fr.webp',
        ...
        ideIntegration: {
          ...
          image: '/images/local-llms-for-coding-workflows-ide-setup-hero-fr.webp',
...
schema: {
    ...
    ja: {
      ...
      heroImage: '/images/local-llms-for-coding-workflows-generation-workflow-hero-ja.webp',
      publishDate: '2026-04-04',
      dateModified: '2026-07-14',
      ...
      sections: {
        ...
        codeGeneration: {
          ...
          image: '/images/local-llms-for-coding-workflows-generation-workflow-hero-ja.webp',
        ...
        ideIntegration: {
          ...
          image: '/images/local-llms-for-coding-workflows-ide-setup-hero-ja.webp',
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**プログラミング固有モデルを使わない。** プログラミング特化モデルは同サイズの汎用モデルよりHumanEvalで5～15%高いスコアを得ます——Llama 3.1 8BはHumanEvalで72%を記録し競争力がありますが、専用プログラミングモデルにはまだ及びません。常にコード用に特別に訓練または微調整されたモデルを使用してください。Ollama：`ollama pull qwen3:8b` — プログラミングタスクに `ollama pull llama3.1:8b` ではなく。',
          ],
          image: '/images/local-llms-for-coding-workflows-mistakes-hero-ja.webp',
...
schema: {
    ...
    zh: {
      ...
      heroImage: '/images/local-llms-for-coding-workflows-generation-workflow-hero-zh.webp',
      publishDate: '2026-04-04',
      dateModified: '2026-07-14',
      ...
      sections: {
        ...
        codeGeneration: {
          ...
          image: '/images/local-llms-for-coding-workflows-generation-workflow-hero-zh.webp',
        ...
        ideIntegration: {
          ...
          image: '/images/local-llms-for-coding-workflows-ide-setup-hero-zh.webp',
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**不使用编程特定模型。** 编程专用模型在HumanEval上比同等规模的通用模型高5-15%——Llama 3.1 8B在HumanEval上获得72%，具有竞争力，但仍落后于专用编程模型。始终使用专门为代码训练或微调的模型。在Ollama中：`ollama pull qwen3:8b` — 编程任务不要 `ollama pull llama3.1:8b`。',
          ],
          image: '/images/local-llms-for-coding-workflows-mistakes-hero-zh.webp',
...
schema: {
    ...
    es: {
      ...
      heroImage: '/images/local-llms-for-coding-workflows-generation-workflow-hero-es.webp',
      publishDate: '2026-04-04',
      dateModified: '2026-07-14',
      ...
      sections: {
        ...
        codeGeneration: {
          ...
          image: '/images/local-llms-for-coding-workflows-generation-workflow-hero-es.webp',
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**No usar un modelo específico para programación.** Los modelos específicos para programación obtienen entre un 5 y un 15% más en HumanEval que los modelos de propósito general del mismo tamaño — Llama 3.1 8B obtiene un 72% en HumanEval, competitivo pero aún por detrás de los modelos de programación dedicados. Usa siempre un modelo entrenado o afinado específicamente para código. En Ollama: `ollama pull qwen3:8b` — no `ollama pull llama3.1:8b` para tareas de programación.',
          ],
          image: '/images/local-llms-for-coding-workflows-mistakes-hero-es.webp',
    ...
    ar: {
      ...
      heroImage: '/images/local-llms-for-coding-workflows-generation-workflow-hero-ar.webp',
      publishDate: '2026-04-04',
      dateModified: '2026-07-14',
      ...
      sections: {
        ...
        codeGeneration: {
          ...
          image: '/images/local-llms-for-coding-workflows-generation-workflow-hero-ar.webp',
    ...
    pt: {
      ...
      heroImage: '/images/local-llms-for-coding-workflows-generation-workflow-hero-pt.webp',
      publishDate: '2026-04-04',
      dateModified: '2026-07-14',
  ...
  ko: {
      ...
      sections: {
        ...
        codeGeneration: {
          ...
          image: '/images/local-llms-for-coding-workflows-generation-workflow-hero-ko.webp',
