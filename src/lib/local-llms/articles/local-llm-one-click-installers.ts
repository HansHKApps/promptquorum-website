...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      intro: 'Four tools let you run local LLMs without any manual configuration: Ollama, LM Studio, Jan AI, and GPT4All. As of August 2026, each installs in under 5 minutes and manages model downloads automatically. The right choice depends on whether you prefer a terminal or GUI, need an API server, or want the simplest possible setup.',
      ...
      leadAnswerBlock: '**Four tools let you run local LLMs without any manual configuration: Ollama, LM Studio, Jan AI, and GPT4All. As of August 2026, each installs in under 5 minutes and manages model downloads automatically.**',
      ...
      sections: {
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'Can I use the same model files with all four installers?', a: 'Partially. All four use GGUF-format models (llama.cpp-compatible), but each tool stores them in its own directory by default. You can point Jan AI and LM Studio to the same GGUF file on disk to avoid duplicate downloads. As of August 2026, Ollama supports importing raw GGUF files directly: `ollama create mymodel -f ./model.gguf`. This narrows the gap — you can now load any GGUF into Ollama without re-downloading from the Ollama library.' },
            ...
            { q: 'Is Ollama open source, and what licence does it use?', a: 'Yes. Ollama is MIT-licensed open source (github.com/ollama/ollama), free with no usage limits or paid tiers, and its source confirms no telemetry collection. Your only cost is your own hardware.' },
          ],
        },
      },
schema: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Is Ollama open source, and what licence does it use?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Ollama is MIT-licensed open source (github.com/ollama/ollama), free with no usage limits or paid tiers, and its source confirms no telemetry collection.' } },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
      ...
      sections: {
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: '¿Ollama es de código abierto y qué licencia utiliza?', a: 'Sí. Ollama es de código abierto con licencia MIT (github.com/ollama/ollama), gratuito, sin límites de uso ni planes de pago, y su código fuente confirma que no recopila telemetría. Tu único coste es tu propio hardware.' },
          ],
        },
      },
      schema: {
      ...
      sections: {
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'هل Ollama مفتوح المصدر، وما الرخصة التي يستخدمها؟', a: 'نعم. Ollama مفتوح المصدر برخصة MIT (github.com/ollama/ollama)، مجاني بلا حدود استخدام أو باقات مدفوعة، وتؤكّد شيفرته المصدرية عدم جمع أي بيانات قياس عن بُعد. تكلفتك الوحيدة هي عتادك الخاص.' },
          ],
        },
      },
      schema: {
    ...
    pt: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'O Ollama é de código aberto e qual licença utiliza?', acceptedAnswer: { '@type': 'Answer', text: 'Sim. O Ollama é de código aberto sob licença MIT (github.com/ollama/ollama), gratuito, sem limites de uso ou planos pagos, e seu código-fonte confirma que não coleta telemetria.' } },
        ],
      },
      sections: {
        tldr: {
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'O Ollama é de código aberto e qual licença utiliza?', a: 'Sim. O Ollama é de código aberto sob licença MIT (github.com/ollama/ollama), gratuito, sem limites de uso ou planos pagos, e seu código-fonte confirma que não coleta telemetria. Seu único custo é o seu próprio hardware.' },
          ],
        },
      },
    },
