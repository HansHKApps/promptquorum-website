    ...
    en: {
      ...
      sections: {
        ...
        ollama: {
          ...
          imageCaption: 'Ollama installation in 3 steps: visit ollama.com/download, run the .pkg or .exe installer, then run ollama run llama4:scout in the terminal. Ollama installs as a background service and exposes an OpenAI-compatible API at localhost:11434.',
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Not trying Llama 4 Scout on first install.** Many guides still recommend `ollama run llama3.2` as the first command. Llama 4 Scout (MoE, 17B active, ~10 GB VRAM) is now the best starting model on any machine with 12+ GB VRAM — significantly better quality than Llama 3.2 3B. Run `ollama run llama4:scout` instead.',
          ],
      ...
      sections: {
        ...
        ollama: {
          ...
          content: [
            ...
            'Ollama mantiene una biblioteca de modelos curada en ollama.com/library con más de 4.500 modelos (curados + contribuciones de la comunidad). Cada modelo se descarga con un único comando: `ollama pull llama4:scout`. Los modelos se almacenan en `~/.ollama/models`.',
          ],
          rows: [
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**No probar Llama 4 Scout en la primera instalación.** Muchas guías aún recomiendan `ollama run llama3.2` como primer comando. Llama 4 Scout (MoE, 17B activo, ~10 GB VRAM) es ahora el mejor modelo de inicio en cualquier máquina con 12+ GB VRAM — significativamente mejor en calidad que Llama 3.2 3B. Ejecuta `ollama run llama4:scout` en su lugar.',
          ],
