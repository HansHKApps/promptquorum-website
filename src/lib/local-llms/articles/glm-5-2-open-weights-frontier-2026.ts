...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    seoTitle: "GLM-5.2: Open-Weights LLM Standing (Aug 2026)",
  ...
  ar: {
    ...
    seoTitle: 'GLM-5.2: وضع نموذج الأوزان المفتوحة (أغسطس 2026)',
  ...
  de: {
    ...
    seoTitle: 'GLM-5.2: Open-Weights-LLM-Stand (Aug. 2026)',
  ...
  fr: {
    ...
    seoTitle: 'GLM-5.2 : état du LLM open-weights (août 2026)',
  ...
  ja: {
    ...
    seoTitle: 'GLM-5.2：オープンウェイトLLMの現状（2026年8月）',
  ...
  ko: {
    ...
    seoTitle: 'GLM-5.2: 오픈 웨이트 LLM 현황 (2026년 8월)',
  ...
  zh: {
    ...
    seoTitle: 'GLM-5.2：开源权重 LLM 现状（2026年8月）',
