...
schema: {
    ...
    ar: {
      ...
      next_refresh_due: '2026-06-30',
      theme: 'Best Models',
      title: 'تكميم LLM: شرح Q4 مقابل Q5 مقابل Q8 (متى تستخدم كل واحد)',
      seoTitle: 'تكميم LLM 2026: Q4_K_M مقابل Q8_0 — دليل VRAM',
      intro: 'دليل كامل لاختيار تكميم LLM المناسب لعتادك: Q4_K_M لـ 6–8 GB من VRAM، Q5_K_M لـ 16 GB، Q8_0 لـ 24+ GB. يشمل شرح صيغة GGUF، وتفصيل فقدان الجودة حسب مستوى التكميم، والتقنيات المتقدمة (التفريغ إلى CPU وتقسيم الطبقات متعدد GPU). تعلّم كيفية تشغيل Llama 3.3 70B على RTX 4090 عبر التفريغ، أو 2× RTX 4090 عبر تقسيم الطبقات، أو Mac Studio M2 Ultra بشكل أصلي. محدّث مايو 2026.',
      metaDescription: 'Q4_K_M يستخدم 4.5 GB لنموذج 7B مع فقدان جودة 1-3%؛ Q8_0 شبه مثالي بـ 24+ GB VRAM. اختر التكميم المناسب لعتادك مع جداول GGUF 2026.',
      publishDate: '2026-04-04',
      dateModified: '2026-05-17',
      current_models_mentioned: ['Llama 3.3 70B', 'Llama 3.3 8B', 'Qwen3', 'Mistral'],
      current_hardware_mentioned: ['RTX 4090', 'RTX 4060 Ti', 'RTX 5090', 'Mac Studio M2 Ultra'],
    ...
    pt: {
      ...
      next_refresh_due: '2026-06-30',
      theme: 'Best Models',
      title: 'Quantização de LLM: Q4 vs Q5 vs Q8 explicado (quando usar cada um)',
      seoTitle: 'Quantização LLM 2026: Q4_K_M vs Q8_0 — Guia de VRAM',
      ...
      metaDescription: 'Entenda a quantização de LLM em 2026: diferenças entre Q4_K_M, Q5_K_M e Q8_0. Economia de memória, trade-offs de qualidade e recomendações por caso de uso.',
      publishDate: '2026-04-04',
      dateModified: '2026-05-17',
...
schema: {
  ...
  ko: {
      ...
      next_refresh_due: '2026-06-30',
      theme: 'Best Models',
      title: 'LLM 양자화: Q4 vs Q5 vs Q8 완전 해설 (각 방식의 사용 시점)',
      seoTitle: 'LLM 양자화 2026: Q4_K_M vs Q8_0 VRAM 가이드',
      intro: 'LLM 양자화 선택 완전 가이드: 6–8 GB VRAM에는 Q4_K_M, 16 GB에는 Q5_K_M, 24+ GB에는 Q8_0을 권장합니다. GGUF 형식 해설, 양자화 수준별 품질 손실 분석, 그리고 CPU 오프로딩·멀티 GPU 레이어 분할 같은 고급 기법을 다룹니다. RTX 4090 단일 GPU(오프로딩), 2× RTX 4090(레이어 분할), Mac Studio M2 Ultra(네이티브)로 Llama 3.3 70B를 실행하는 방법을 설명합니다. 2026년 5월 업데이트.',
      metaDescription: '2026년 LLM 양자화 완전 이해: Q4_K_M, Q5_K_M, Q8_0 차이점. 메모리 절약량, 품질 트레이드오프, 모델 크기 표, 사용 사례별 권장 사항.',
      publishDate: '2026-04-04',
      dateModified: '2026-05-17',
      current_models_mentioned: ['Llama 3.3 70B', 'Llama 3.3 8B', 'Qwen3', 'Mistral'],
      current_hardware_mentioned: ['RTX 4090', 'RTX 4060 Ti', 'RTX 5090', 'Mac Studio M2 Ultra'],
