...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      next_refresh_due: '2026-09-20',
      theme: 'Best Models',
      title: 'What Is Q4_K_M Quantization? LLM Quantization Explained 2026',
      seoTitle: 'Q4_K_M Quantization Explained: GGUF, Offloading & Memory Impact',
      intro: 'Complete guide to LLM quantization (Q4_K_M, Q5_K_M, Q8_0, GGUF) plus advanced VRAM reduction techniques: CPU offloading and multi-GPU layer splitting. Learn how to run Llama 3.3 70B on RTX 4090 via offloading, 2× RTX 4090 via layer splitting, or Mac Studio M2 Ultra natively. As of April 2026, combining techniques enables enterprise-scale local inference.',
      metaDescription: 'What is Q4_K_M quantization? Learn how GGUF quantization works, Q4 vs Q5 vs Q8, and how to run large LLMs using offloading and layer splitting in 2026.',
      publishDate: '2026-04-04',
      leadAnswerBlock: '**LLM quantization reduces model weight precision from 32-bit or 16-bit floats to 4-bit or 8-bit integers, cutting RAM requirements by 50-75% with minimal quality loss. Offloading and layer splitting extend these techniques beyond single-GPU constraints.**',
      ...
      sections: {
        ...
        whichQuantization: {
          ...
          items: [
            '**4-8 GB RAM available**: Q4_K_M -- the [best balance for constrained hardware](/local-llms/best-beginner-local-llm-models).',
...
schema: {
        ...
        '@type': 'TechArticle',
        'headline': 'Q4_K_M Quantization Explained: GGUF, Offloading & Memory Impact',
        'description': 'What is Q4_K_M quantization? Learn how GGUF quantization works, Q4 vs Q5 vs Q8, and how to run large LLMs using offloading and layer splitting in 2026.',
    ...
    de: {
      theme: 'Beste Modelle',
      title: 'LLM-Quantisierung 2026: Q4, Q5, Q8 + Offloading & Layer Splitting',
      seoTitle: 'LLM-Quantisierung 2026: Q4, Offloading & Layer Splitting',
      intro: 'Vollständiger Leitfaden zur LLM-Quantisierung (Q4_K_M, Q5_K_M, Q8_0, GGUF) sowie zu erweiterten VRAM-Reduktions-Techniken: CPU-Offloading und Multi-GPU-Layer-Splitting. Erfahren Sie, wie Sie Llama 3.3 70B auf RTX 4090 via Offloading, 2× RTX 4090 via Layer Splitting oder Mac Studio M2 Ultra nativ ausführen. Ab April 2026 ermöglicht die Kombination dieser Techniken lokale Inference im Enterprise-Maßstab.',
      metaDescription: 'LLM-Quantisierung 2026: Q4_K_M bis Q8, CPU-Offloading und Layer Splitting. Llama 3.3 70B auf Single-GPU (Offload), Dual-GPU (Split) oder Mac Studio M2 Ultra (nativ). Befehle und Benchmarks.',
      publishDate: '2026-04-04',
      dateModified: '2026-04-20',
      ...
      sections: {
        ...
        whichQuantization: {
          id: 'which-quantization',
          title: 'Welche Quantisierungsstufe sollten Sie verwenden?',
          items: [
            '**4-8 GB RAM verfügbar**: Q4_K_M -- die [beste Balance für eingeschränkte Hardware](/local-llms/best-beginner-local-llm-models?lang=de).',
            '**8-16 GB RAM verfügbar**: Q5_K_M oder Q6_K -- bessere Qualität mit komfortablem RAM-Puffer.',
            '**16+ GB RAM verfügbar**: Q8_0 -- quasi verlustfreie Qualität, kein Grund für niedrigere Quantisierung.',
