...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      toc: [
        ...
        { label: 'Mac Studio M5 Ultra: Native 70B Without Offloading', anchor: '#mac-studio' },
      ...
      sections: {
        ...
        quantizationLevels: {
          ...
          image: '/images/llm-quantization-explained-quant-levels-hero-en.webp',
        ...
        kvCacheQuantization: {
          ...
          content: [
            ...
            '- **llama.cpp**: Start the server with `--cache-type-k q8_0 --cache-type-v q8_0` (short form: `-ctk q8_0 -ctv q8_0`). Use `q4_0` instead of `q8_0` to halve the KV cache again.',
        ...
        macStudio: {
          id: 'mac-studio',
          title: 'Can Mac Studio M5 Ultra Run 70B Models Without Offloading?',
          content: [
            '**Mac Studio with M5 Ultra (from $5,499, 96 GB unified memory standard, up to 512 GB) runs Llama 3.3 70B at Q4 natively — no offloading, no layer splitting required.**',
            'Apple refreshed the Mac Studio lineup on August 25, 2026 with two chips: M5 Max ($2,499, up to 128 GB unified memory, up to 614 GB/s bandwidth per Apple\'s published specs) and M5 Ultra ($5,499 starting at 96 GB, up to 512 GB, up to 1.2 TB/s bandwidth per Apple\'s published specs). Both replace the previous M2 Ultra generation (192 GB max, ~800 GB/s). DDR5 system RAM offloading is still capped at ~90 GB/s -- that bandwidth gap is why unified memory outperforms CPU-RAM offloading for 70B-class models.',
            'Independent throughput benchmarks for M5 Max and M5 Ultra are not yet available. Standard configurations ship September 22, 2026, and the 512 GB M5 Ultra configuration ships in late October 2026. PromptQuorum has not tested this hardware -- tokens-per-second figures below are omitted for the new chips until independent measurements exist.',
          ],
          rows: [
            ...
            { 'Setup': 'Mac Studio M5 Ultra (96 GB+)', 'Model': 'Llama 3.3 70B Q4', 'Speed': 'Not yet benchmarked', 'Complexity': 'Low (plug & play)' },
          ],
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Yes, but slowly. Quantize to Q4 (35 GB), offload 11 GB to system RAM. Expect 5-10 tok/sec — too slow for real-time chat, fine for batch processing. For practical 70B inference: 2× RTX 4090 with layer splitting (~100 tok/sec) or Mac Studio with M5 Ultra, which fits the model natively in unified memory (independent tok/sec benchmarks aren\'t available yet -- the chip ships September 22, 2026).',
            },
            {
            ...
            {
              q: 'Does Mac Studio M5 Ultra need quantization for 70B models?',
              a: 'Only mild quantization. Mac Studio with M5 Ultra starts at 96 GB unified memory (up to 512 GB) and holds Llama 3.3 70B at Q4 (35 GB) natively — no offloading or layer splitting. At Q5, 70B still fits (44 GB). FP16 70B (140 GB) also fits but runs slower. Q4 is the sweet spot for Mac Studio 70B workflows.',
            },
            {
              q: 'Which technique combination is best for my hardware?',
              a: 'Single RTX 4090 (24 GB): Q4 + offloading for 70B (slow). Q5 native for 32B (fast). 2× RTX 4090 (48 GB): Q5 + layer splitting for 70B (100 tok/sec). RTX 5090 (32 GB): Q4 native for 70B (10-12 tok/sec). Mac Studio with M5 Ultra (96–512 GB): Q4 native for 70B with no offloading needed -- independent tok/sec benchmarks are pending the chip\'s September 22, 2026 launch.',
            },
          ],
        },
        sources: {
...
schema: {
        ...
        'image': [
          {
            '@type': 'ImageObject',
            'url': 'https://www.promptquorum.com/images/llm-quantization-explained-quant-levels-hero-en.webp',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes, but slowly. Quantize to Q4 (35 GB), offload 11 GB to system RAM. Expect 5-10 tok/sec — too slow for real-time chat, fine for batch processing. For practical 70B inference: 2× RTX 4090 with layer splitting (~100 tok/sec) or Mac Studio with M5 Ultra, which fits the model natively in unified memory (independent tok/sec benchmarks aren\'t available yet -- the chip ships September 22, 2026).' },
          },
          {
            '@type': 'Question',
          ...
          {
            '@type': 'Question',
            'name': 'Does Mac Studio M5 Ultra need quantization for 70B models?',
            'acceptedAnswer': { '@type': 'Answer', 'text': 'Only mild quantization. Mac Studio with M5 Ultra starts at 96 GB unified memory (up to 512 GB) and holds Llama 3.3 70B at Q4 (35 GB) natively — no offloading or layer splitting. At Q5, 70B still fits (44 GB). FP16 70B (140 GB) also fits but runs slower. Q4 is the sweet spot for Mac Studio 70B workflows.' },
          },
          {
            '@type': 'Question',
            'name': 'Which technique combination is best for my hardware?',
            'acceptedAnswer': { '@type': 'Answer', 'text': 'Single RTX 4090 (24 GB): Q4 + offloading for 70B (slow). Q5 native for 32B (fast). 2× RTX 4090 (48 GB): Q5 + layer splitting for 70B (100 tok/sec). RTX 5090 (32 GB): Q4 native for 70B (10-12 tok/sec). Mac Studio with M5 Ultra (96–512 GB): Q4 native for 70B with no offloading needed -- independent tok/sec benchmarks are pending the chip\'s September 22, 2026 launch.' },
          },
        ],
      },
      supplementalSchema: {
    ...
    es: {
      ...
      intro: 'Guía completa para elegir la cuantización de LLM adecuada para tu hardware: Q4_K_M para 6–8 GB de VRAM, Q5_K_M para 16 GB, Q8_0 para 24+ GB. Incluye el formato GGUF explicado, desglose de pérdida de calidad por nivel de cuantización y técnicas avanzadas (CPU offloading y layer splitting multi-GPU). Aprende a ejecutar Llama 3.3 70B en RTX 4090 mediante offloading, 2× RTX 4090 mediante layer splitting o Mac Studio con M5 Ultra de forma nativa. Ahora incluye comparaciones directas de Q4_0 vs Q4_K_M, Q4_K_M vs Q4_K_S, Q8_0 vs Q4_K_M y Q8_0 vs Q8_K_XL. Actualizado en agosto de 2026.',
      ...
      toc: [
        ...
        { label: 'Mac Studio M5 Ultra: 70B nativo sin offloading', anchor: '#mac-studio' },
      ...
      sections: {
        ...
        quantizationLevels: {
          ...
          image: '/images/llm-quantization-explained-quant-levels-hero-es.webp',
        ...
        kvCacheQuantization: {
          ...
          content: [
            ...
            '- **llama.cpp**: Inicia el servidor con `--cache-type-k q8_0 --cache-type-v q8_0` (forma corta: `-ctk q8_0 -ctv q8_0`). Usa `q4_0` en lugar de `q8_0` para reducir el caché KV a la mitad otra vez.',
        ...
        macStudio: {
          id: 'mac-studio',
          title: 'Mac Studio M5 Ultra: 70B nativo sin offloading',
          content: [
            '**Mac Studio con M5 Ultra (desde $5,499, 96 GB de memoria unificada de serie, hasta 512 GB) ejecuta Llama 3.3 70B en Q4 de forma nativa — sin offloading, sin layer splitting.**',
            'Apple renovó la línea Mac Studio el 25 de agosto de 2026 con dos chips: M5 Max ($2,499, hasta 128 GB de memoria unificada, hasta 614 GB/s de ancho de banda según las especificaciones publicadas por Apple) y M5 Ultra ($5,499 desde 96 GB, hasta 512 GB, hasta 1.2 TB/s de ancho de banda según Apple). Ambos sustituyen a la generación anterior M2 Ultra (192 GB máx., ~800 GB/s). El offloading de RAM DDR5 del sistema sigue limitado a ~90 GB/s -- esa diferencia de ancho de banda es la razón por la que la memoria unificada supera al offloading en modelos de la escala de 70B.',
            'Aún no existen benchmarks de rendimiento independientes para M5 Max ni M5 Ultra. Las configuraciones estándar salen a la venta el 22 de septiembre de 2026, y la configuración de 512 GB del M5 Ultra llega en octubre de 2026. PromptQuorum no ha probado este hardware -- las cifras de tokens por segundo se omiten para los chips nuevos hasta que existan mediciones independientes.',
          ],
          rows: [
            ...
            { 'Configuración': 'Mac Studio M5 Ultra (96 GB+)', 'Modelo': 'Llama 3.3 70B Q4', 'Velocidad': 'Aún no evaluado', 'Complejidad': 'Baja (plug & play)' },
          ],
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Sí, pero lento. Cuantiza a Q4 (35 GB), hace offload de 11 GB a la RAM del sistema. Espera 5-10 tok/seg — demasiado lento para chat en tiempo real, bien para procesamiento por lotes. Para inferencia práctica de 70B: 2× RTX 4090 con layer splitting (~100 tok/seg) o Mac Studio con M5 Ultra, que aloja el modelo de forma nativa en memoria unificada (aún no hay benchmarks independientes de tok/seg -- el chip sale a la venta el 22 de septiembre de 2026).',
            },
            {
            ...
            {
              q: '¿Mac Studio M5 Ultra necesita cuantización para modelos de 70B?',
              a: 'Solo cuantización leve. Mac Studio con M5 Ultra parte de 96 GB de memoria unificada (hasta 512 GB) y contiene Llama 3.3 70B en Q4 (35 GB) de forma nativa — sin offloading ni layer splitting. En Q5, 70B todavía cabe (44 GB). FP16 70B (140 GB) también cabe pero funciona más lento. Q4 es el punto óptimo para flujos de trabajo de 70B en Mac Studio.',
            },
            {
              q: '¿Qué combinación de técnicas es mejor para mi hardware?',
              a: 'RTX 4090 única (24 GB): Q4 + offloading para 70B (lento). Q5 nativo para 32B (rápido). 2× RTX 4090 (48 GB): Q5 + layer splitting para 70B (100 tok/seg). RTX 5090 (32 GB): Q4 nativo para 70B (10-12 tok/seg). Mac Studio con M5 Ultra (96–512 GB): Q4 nativo para 70B sin necesidad de offloading -- los benchmarks independientes de tok/seg están pendientes del lanzamiento del chip el 22 de septiembre de 2026.',
            },
          ],
        },
        sources: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          {
            '@type': 'Question',
            'name': '¿Mac Studio M5 Ultra necesita cuantización para modelos de 70B?',
            'acceptedAnswer': { '@type': 'Answer', 'text': 'Solo cuantización leve. Mac Studio con M5 Ultra parte de 96 GB de memoria unificada (hasta 512 GB) y contiene Llama 3.3 70B en Q4 (35 GB) de forma nativa — sin offloading ni layer splitting. En Q5, 70B todavía cabe (44 GB). FP16 70B (140 GB) también cabe pero funciona más lento. Q4 es el punto óptimo para flujos de trabajo de 70B en Mac Studio.' },
          },
          {
            '@type': 'Question',
            'name': '¿Qué combinación de técnicas es mejor para mi hardware?',
            'acceptedAnswer': { '@type': 'Answer', 'text': 'RTX 4090 única (24 GB): Q4 + offloading para 70B (lento). Q5 nativo para 32B (rápido). 2× RTX 4090 (48 GB): Q5 + layer splitting para 70B (100 tok/seg). RTX 5090 (32 GB): Q4 nativo para 70B (10-12 tok/seg). Mac Studio con M5 Ultra (96–512 GB): Q4 nativo para 70B sin necesidad de offloading -- los benchmarks independientes de tok/seg están pendientes del lanzamiento del chip el 22 de septiembre de 2026.' },
          },
        ],
      },
      supplementalSchema: {
    ...
    ar: {
      ...
      intro: 'دليل كامل لاختيار تكميم LLM المناسب لعتادك: Q4_K_M لـ 6–8 GB من VRAM، Q5_K_M لـ 16 GB، Q8_0 لـ 24+ GB. يشمل شرح صيغة GGUF، وتفصيل فقدان الجودة حسب مستوى التكميم، والتقنيات المتقدمة (التفريغ إلى CPU وتقسيم الطبقات متعدد GPU). تعلّم كيفية تشغيل Llama 3.3 70B على RTX 4090 عبر التفريغ، أو 2× RTX 4090 عبر تقسيم الطبقات، أو Mac Studio بمعالج M5 Ultra بشكل أصلي. يتضمن هذا الدليل الآن مقارنات مباشرة وجهاً لوجه: Q4_0 مقابل Q4_K_M، وQ4_K_M مقابل Q4_K_S، وQ8_0 مقابل Q4_K_M، وQ8_0 مقابل Q8_K_XL. محدّث أغسطس 2026.',
      ...
      toc: [
        ...
        { label: 'Mac Studio M5 Ultra: 70B أصلي دون تفريغ', anchor: '#mac-studio' },
      ...
      sections: {
        ...
        quantizationLevels: {
          ...
          image: '/images/llm-quantization-explained-quant-levels-hero-ar.webp',
        ...
        kvCacheQuantization: {
          ...
          content: [
            ...
            '- **llama.cpp**: شغّل الخادم باستخدام `--cache-type-k q8_0 --cache-type-v q8_0` (الصيغة المختصرة: `-ctk q8_0 -ctv q8_0`). واستخدم `q4_0` بدل `q8_0` لتقليص ذاكرة KV إلى النصف مجددًا.',
        ...
        macStudio: {
          id: 'mac-studio',
          title: 'Mac Studio M5 Ultra: 70B أصلي دون تفريغ',
          content: [
            '**يشغّل Mac Studio بمعالج M5 Ultra (يبدأ من $5,499 مع 96 GB ذاكرة موحدة، ويصل إلى 512 GB) نموذج Llama 3.3 70B بصيغة Q4 بشكل أصلي — دون تفريغ، دون تقسيم طبقات.**',
            'جدّدت Apple تشكيلة Mac Studio في 25 أغسطس 2026 بمعالجين: M5 Max ($2,499، حتى 128 GB ذاكرة موحدة، حتى 614 GB/ث وفق مواصفات Apple الرسمية) وM5 Ultra ($5,499 بدءاً من 96 GB وحتى 512 GB، بسرعة تصل إلى 1.2 TB/ث وفق مواصفات Apple). يحل الاثنان محل جيل M2 Ultra السابق (192 GB كحد أقصى، ~800 GB/ث). لا يزال التفريغ إلى RAM DDR5 النظام محدوداً بـ ~90 GB/ث -- وهذه الفجوة في عرض النطاق هي سبب تفوق الذاكرة الموحدة على التفريغ في نماذج بحجم 70B.',
            'لا تتوفر بعد اختبارات أداء مستقلة لمعالجي M5 Max وM5 Ultra. تُطرح التشكيلات القياسية للبيع في 22 سبتمبر 2026، فيما تصل نسخة M5 Ultra بسعة 512 GB في أواخر أكتوبر 2026. لم تختبر PromptQuorum هذا العتاد -- لذلك تُحذف أرقام الرموز في الثانية للمعالجين الجديدين حتى تتوفر قياسات مستقلة.',
          ],
          rows: [
            ...
            { 'الإعداد': 'Mac Studio M5 Ultra (96 GB+)', 'النموذج': 'Llama 3.3 70B Q4', 'السرعة': 'لم يُختبر بعد', 'التعقيد': 'منخفض (توصيل وتشغيل)' },
          ],
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'نعم، لكن ببطء. كمّم إلى Q4 (35 GB)، فرّغ 11 GB إلى RAM النظام. توقع 5-10 رموز/ث — بطيء جداً للمحادثة في الوقت الفعلي، جيد للمعالجة الدفعية. للاستدلال العملي لـ 70B: 2× RTX 4090 بتقسيم الطبقات (~100 رمز/ث) أو Mac Studio بمعالج M5 Ultra، الذي يستوعب النموذج بشكل أصلي في الذاكرة الموحدة (لا تتوفر بعد اختبارات أداء مستقلة -- يُطرح المعالج للبيع في 22 سبتمبر 2026).',
            },
            {
            ...
            {
              q: 'هل يحتاج Mac Studio M5 Ultra إلى تكميم لنماذج 70B؟',
              a: 'تكميم خفيف فقط. يبدأ Mac Studio بمعالج M5 Ultra من 96 GB ذاكرة موحدة (حتى 512 GB) ويستوعب Llama 3.3 70B بصيغة Q4 (35 GB) بشكل أصلي — دون تفريغ أو تقسيم طبقات. بصيغة Q5، لا يزال 70B يتسع (44 GB). FP16 70B (140 GB) يتسع أيضاً لكنه يعمل أبطأ. Q4 هو النقطة المثالية لسير عمل 70B على Mac Studio.',
            },
            {
              q: 'أي مزيج من التقنيات أفضل لعتادي؟',
              a: 'RTX 4090 واحدة (24 GB): Q4 + تفريغ لـ 70B (بطيء). Q5 أصلي لـ 32B (سريع). 2× RTX 4090 (48 GB): Q5 + تقسيم طبقات لـ 70B (100 رمز/ث). RTX 5090 (32 GB): Q4 أصلي لـ 70B (10-12 رمز/ث). Mac Studio بمعالج M5 Ultra (96–512 GB): Q4 أصلي لـ 70B دون الحاجة إلى تفريغ -- اختبارات الأداء المستقلة بانتظار إطلاق المعالج في 22 سبتمبر 2026.',
            },
          ],
        },
        sources: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': { '@type': 'Answer', 'text': 'نعم، لكن ببطء. كمّم إلى Q4 (35 GB)، فرّغ 11 GB إلى RAM النظام. توقع 5-10 رموز/ث — بطيء جداً للمحادثة في الوقت الفعلي، جيد للمعالجة الدفعية. للاستدلال العملي لـ 70B: 2× RTX 4090 بتقسيم الطبقات (~100 رمز/ث) أو Mac Studio بمعالج M5 Ultra، الذي يستوعب النموذج بشكل أصلي في الذاكرة الموحدة (لا تتوفر بعد اختبارات أداء مستقلة -- يُطرح المعالج للبيع في 22 سبتمبر 2026).' },
          },
          {
            '@type': 'Question',
          ...
          {
            '@type': 'Question',
            'name': 'هل يحتاج Mac Studio M5 Ultra إلى تكميم لنماذج 70B؟',
          ...
          },
          {
            ...
            'acceptedAnswer': { '@type': 'Answer', 'text': 'RTX 4090 واحدة (24 GB): Q4 + تفريغ لـ 70B (بطيء). Q5 أصلي لـ 32B (سريع). 2× RTX 4090 (48 GB): Q5 + تقسيم طبقات لـ 70B (100 رمز/ث). RTX 5090 (32 GB): Q4 أصلي لـ 70B (10-12 رمز/ث). Mac Studio بمعالج M5 Ultra (96–512 GB): Q4 أصلي لـ 70B دون الحاجة إلى تفريغ -- اختبارات الأداء المستقلة بانتظار إطلاق المعالج في 22 سبتمبر 2026.' },
          },
        ],
      },
      supplementalSchema: {
    ...
    pt: {
      ...
      toc: [
        ...
        { label: 'Mac Studio M5 Ultra: 70B nativo sem offloading', anchor: '#mac-studio' },
        { label: 'Contexto regional', anchor: '#regional-context' },
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          {
            '@type': 'Question',
            'name': 'O Mac Studio M5 Ultra precisa de quantização para modelos de 70B?',
            'acceptedAnswer': { '@type': 'Answer', 'text': 'Apenas quantização leve. O Mac Studio com M5 Ultra parte de 96 GB de memória unificada (até 512 GB) e comporta o Llama 3.3 70B em Q4 (35 GB) nativamente — sem offloading nem layer splitting. Q4 é o ponto ideal para workflows de 70B no Mac Studio.' },
          },
          {
            '@type': 'Question',
            'name': 'Qual combinação de técnicas é melhor para meu hardware?',
            'acceptedAnswer': { '@type': 'Answer', 'text': 'RTX 4090 única (24 GB): Q4 + offloading para 70B. 2× RTX 4090 (48 GB): Q5 + layer splitting para 70B (100 tok/s). Mac Studio com M5 Ultra (96–512 GB): Q4 nativo para 70B, sem necessidade de offloading -- benchmarks independentes de tok/s aguardam o lançamento do chip em 22 de setembro de 2026.' },
          },
        ],
      },
      supplementalSchema: {
      ...
      sections: {
        ...
        quantizationLevels: {
          ...
          image: '/images/llm-quantization-explained-quant-levels-hero-pt.webp',
        ...
        macStudio: {
          id: 'mac-studio',
          title: 'Mac Studio M5 Ultra: 70B nativo sem offloading',
          content: [
          ...
          rows: [
            ...
            { 'Setup': 'Mac Studio M5 Ultra (96 GB+)', 'Modelo': 'Llama 3.3 70B Q4', 'Velocidade': 'Ainda não avaliado', 'Complexidade': 'Baixa (plug & play)' },
          ],
    ...
    de: {
      ...
      toc: [
        ...
        { label: 'Mac Studio M5 Ultra: Natives 70B ohne Offloading', anchor: '#mac-studio' },
      ...
      sections: {
        ...
        quantizationLevels: {
          ...
          image: '/images/llm-quantization-explained-quant-levels-hero-de.webp',
        ...
        kvCacheQuantization: {
          ...
          content: [
            ...
            '- **llama.cpp**: Starten Sie den Server mit `--cache-type-k q8_0 --cache-type-v q8_0` (Kurzform: `-ctk q8_0 -ctv q8_0`). Mit `q4_0` statt `q8_0` halbiert sich der KV-Cache noch einmal.',
        ...
        hybrid: {
          ...
          items: [
            ...
            '**Mac Studio mit M5 Ultra**: Nativer 70B-Betrieb mit 96-512 GB Unified Memory -- kein Offloading erforderlich. Unabhängige Tokens/Sek.-Messwerte stehen noch aus (Marktstart 22. September 2026), aber die geringe Systemkomplexität bleibt.',
          ],
        },
        tradeoffs: {
          id: 'tradeoffs',
        ...
        macStudio: {
          id: 'mac-studio',
          title: 'Mac Studio M5 Ultra: Natives 70B ohne Offloading',
          content: [
            '**Mac Studio mit M5 Ultra (ab 6.599 €, 96 GB Unified Memory serienmäßig, bis zu 512 GB) führt Llama 3.3 70B bei Q4 nativ aus -- kein Offloading, kein Layer Splitting erforderlich.**',
            'Apple hat die Mac-Studio-Reihe am 25. August 2026 mit zwei Chips erneuert: M5 Max (2.999 €, bis zu 128 GB Unified Memory, bis zu 614 GB/s Bandbreite laut Apples veröffentlichten Spezifikationen) und M5 Ultra (ab 6.599 € mit 96 GB, bis zu 512 GB, bis zu 1,2 TB/s Bandbreite laut Apple). Beide ersetzen die vorherige M2-Ultra-Generation (max. 192 GB, ~800 GB/s). Das Offloading in DDR5-System-RAM bleibt bei ~90 GB/s gedeckelt -- dieser Bandbreitenunterschied erklärt, warum Unified Memory bei Modellen der 70B-Klasse dem Offloading überlegen ist.',
            'Unabhängige Durchsatz-Benchmarks für M5 Max und M5 Ultra liegen noch nicht vor. Die Standardkonfigurationen kommen am 22. September 2026 in den Handel, die 512-GB-Konfiguration des M5 Ultra folgt Ende Oktober 2026. PromptQuorum hat diese Hardware nicht getestet -- Tokens-pro-Sekunde-Werte werden für die neuen Chips daher ausgelassen, bis unabhängige Messungen vorliegen.',
          ],
          rows: [
            ...
            { 'Setup': 'Mac Studio M5 Ultra (ab 96 GB)', 'Modell': 'Llama 3.3 70B Q4', 'Geschwindigkeit': 'Noch nicht getestet', 'Komplexität': 'Niedrig' },
          ],
          columns: ['Setup', 'Modell', 'Geschwindigkeit', 'Komplexität'],
          note: '2× RTX 4090 Workstation: ~4.500 €. Mac Studio M5 Ultra (96 GB): ab 6.599 €.',
        },
        regionalContext: {
          id: 'regional-context',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Ja, mit Offloading. Llama 3.3 70B Q4_K_M benötigt ~40 GB -- mehr als die 24 GB VRAM der RTX 4090. Mit CPU-Offloading werden ~24 GB in VRAM geladen und der Rest in System-RAM. Die Geschwindigkeit beträgt 5-10 Tokens/Sek. gegenüber 40-50 Tokens/Sek. bei vollständiger GPU-Auslastung. Für bessere Leistung empfehlen sich 2× RTX 4090 mit Layer Splitting (~100 Tokens/Sek.) oder Mac Studio mit M5 Ultra, der das Modell nativ im Unified Memory unterbringt (unabhängige Tokens/Sek.-Messwerte liegen noch nicht vor -- der Chip kommt am 22. September 2026 in den Handel).',
            },
            {
            ...
            {
              q: 'Benötigt Mac Studio M5 Ultra Quantisierung für 70B-Modelle?',
              a: 'Nein -- Mac Studio mit M5 Ultra bietet mindestens 96 GB Unified Memory (bis zu 512 GB) und läuft Llama 3.3 70B bei FP16 (140 GB) oder Q4_K_M nativ. Kein Offloading erforderlich, da das gesamte Modell in Unified Memory passt. Q4_K_M wird dennoch empfohlen, da die Speicherbandbreite der limitierende Faktor bleibt und Q4_K_M in früheren Mac-Studio-Generationen durchgängig schneller lief als FP16 bei gleicher Bandbreite.',
            },
            {
...
schema: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          {
            '@type': 'Question',
            'name': 'Benötigt Mac Studio M5 Ultra Quantisierung für 70B-Modelle?',
            'acceptedAnswer': { '@type': 'Answer', 'text': 'Nein -- Mac Studio mit M5 Ultra bietet mindestens 96 GB Unified Memory und führt Llama 3.3 70B nativ aus. Q4_K_M wird dennoch für bessere Geschwindigkeit empfohlen; unabhängige Tok/Sek.-Messwerte für den neuen Chip liegen noch nicht vor.' },
          },
          {
            '@type': 'Question',
    ...
    fr: {
      ...
      toc: [
        ...
        { label: 'Mac Studio M5 Ultra : 70B natif sans offloading', anchor: '#mac-studio' },
      ...
      sections: {
        ...
        quantizationLevels: {
          ...
          image: '/images/llm-quantization-explained-quant-levels-hero-fr.webp',
        ...
        kvCacheQuantization: {
          ...
          content: [
            ...
            '- **llama.cpp** : démarrez le serveur avec `--cache-type-k q8_0 --cache-type-v q8_0` (forme courte : `-ctk q8_0 -ctv q8_0`). Utilisez `q4_0` au lieu de `q8_0` pour diviser encore par deux le cache KV.',
        ...
        hybrid: {
          ...
          items: [
            ...
            '**Mac Studio avec M5 Ultra** : exécution native 70B avec 96-512 GB de mémoire unifiée -- pas d\'offloading requis. Les mesures indépendantes en tokens/sec ne sont pas encore disponibles (commercialisation le 22 septembre 2026), mais la faible complexité système reste acquise.',
          ],
        },
        tradeoffs: {
          id: 'tradeoffs',
        ...
        macStudio: {
          id: 'mac-studio',
          title: 'Mac Studio M5 Ultra : 70B natif sans offloading',
          content: [
            '**Mac Studio avec M5 Ultra (à partir de 6 599 €, 96 GB de mémoire unifiée de série, jusqu\'à 512 GB) exécute Llama 3.3 70B en Q4 nativement -- aucun offloading, aucun layer splitting requis.**',
            'Apple a renouvelé la gamme Mac Studio le 25 août 2026 avec deux puces : M5 Max (2 999 €, jusqu\'à 128 GB de mémoire unifiée, jusqu\'à 614 GB/s de bande passante selon les spécifications publiées par Apple) et M5 Ultra (à partir de 6 599 € avec 96 GB, jusqu\'à 512 GB, jusqu\'à 1,2 TB/s de bande passante selon Apple). Les deux remplacent la génération M2 Ultra précédente (192 GB max, ~800 GB/s). L\'offloading vers la RAM système DDR5 reste plafonné à ~90 GB/s -- cet écart de bande passante explique pourquoi la mémoire unifiée surpasse l\'offloading sur les modèles de la classe 70B.',
            'Aucun benchmark de débit indépendant n\'est encore disponible pour les puces M5 Max et M5 Ultra. Les configurations standard arrivent en boutique le 22 septembre 2026, et la configuration 512 GB du M5 Ultra suit fin octobre 2026. PromptQuorum n\'a pas testé ce matériel -- les chiffres en tokens par seconde sont donc omis pour les nouvelles puces tant qu\'aucune mesure indépendante n\'existe.',
          ],
          rows: [
            ...
            { 'Configuration': 'Mac Studio M5 Ultra (96 GB+)', 'Modèle': 'Llama 3.3 70B Q4', 'Vitesse': 'Pas encore testé', 'Complexité': 'Faible' },
          ],
          columns: ['Configuration', 'Modèle', 'Vitesse', 'Complexité'],
          note: 'Station de travail 2× RTX 4090 : ~4 500 €. Mac Studio M5 Ultra (96 GB) : à partir de 6 599 €.',
        },
        regionalContext: {
          id: 'regional-context',
...
schema: {
    ...
    ja: {
      ...
      intro: 'LLM量子化（Q4_K_M、Q5_K_M、Q8_0、GGUF）と、CPUオフロードおよびマルチGPUレイヤースプリッティングによる高度なVRAM削減技術の完全ガイド。RTX 4090でオフロードを使用したLlama 3.3 70Bの実行方法、2× RTX 4090でのレイヤースプリッティング、またはMac Studio（M5 Ultra搭載）でのネイティブ実行方法を学びます。本ガイドには直接比較（Q4_0 vs Q4_K_M、Q4_K_M vs Q4_K_S、Q8_0 vs Q4_K_M、Q8_0 vs Q8_K_XL）も含まれます。2026年8月更新。',
      ...
      toc: [
        ...
        { label: 'Mac Studio M5 Ultra：オフロードなしのネイティブ70B', anchor: '#mac-studio' },
      ...
      sections: {
        ...
        quantizationLevels: {
          ...
          image: '/images/llm-quantization-explained-quant-levels-hero-ja.webp',
        ...
        kvCacheQuantization: {
          ...
          content: [
            ...
            '- **llama.cpp**：サーバー起動時に `--cache-type-k q8_0 --cache-type-v q8_0`（短縮形は `-ctk q8_0 -ctv q8_0`）を指定します。`q8_0` の代わりに `q4_0` を使うと KV キャッシュはさらに半分になります。',
        ...
        hybrid: {
          ...
          items: [
            ...
            '**Mac Studio（M5 Ultra搭載）**：96〜512GBユニファイドメモリでネイティブ70B動作 -- オフロード不要。独立したtok/secの測定値はまだ存在しません（発売は2026年9月22日）が、システム構成の単純さは変わりません。',
          ],
        },
        tradeoffs: {
          id: 'tradeoffs',
        ...
        macStudio: {
          id: 'mac-studio',
          title: 'Mac Studio M5 Ultra：オフロードなしのネイティブ70B',
          content: [
            '**Mac Studio（M5 Ultra搭載、¥949,800から、96GBユニファイドメモリを標準搭載、最大512GBまで拡張可能）はLlama 3.3 70BをQ4でネイティブに実行します -- オフロードもレイヤースプリッティングも不要です。**',
            'Appleは2026年8月25日にMac Studioラインナップを刷新し、2つのチップを発表しました：M5 Max（¥419,800、最大128GBユニファイドメモリ、Apple公表値で最大614GB/sの帯域幅）とM5 Ultra（¥949,800から96GB、最大512GB、Apple公表値で最大1.2TB/sの帯域幅）です。両モデルとも従来のM2 Ultra世代（最大192GB、~800GB/s）を置き換えます。オフロード用のDDR5システムRAMは依然として~90GB/sに制限されており、この帯域幅の差が、70Bクラスのモデルでユニファイドメモリがオフロードを上回る理由です。',
            'M5 MaxおよびM5 Ultraの独立したスループットベンチマークはまだ存在しません。標準構成は2026年9月22日に発売され、M5 Ultraの512GB構成は2026年10月下旬に登場予定です。PromptQuorumはこのハードウェアをテストしていません -- そのため、独立した測定値が存在するまで、新チップについてはトークン/秒の数値を省略しています。',
          ],
          rows: [
            ...
            { 'セットアップ': 'Mac Studio M5 Ultra（96GB〜）', 'モデル': 'Llama 3.3 70B Q4', '速度': '未測定', '複雑さ': '低' },
          ],
          columns: ['セットアップ', 'モデル', '速度', '複雑さ'],
          costNote: '2× RTX 4090ワークステーション：~¥700,000。Mac Studio M5 Ultra（96 GB）：¥949,800から。',
        },
        regionalContext: {
          id: 'regional-context',
...
schema: {
    ...
    zh: {
      ...
      intro: 'LLM量化（Q4_K_M、Q5_K_M、Q8_0、GGUF）及高级VRAM减少技术的完整指南：CPU卸载和多GPU层分割。了解如何通过卸载在RTX 4090上运行Llama 3.3 70B，通过层分割使用2× RTX 4090，或在搭载M5 Ultra的Mac Studio上原生运行。本指南现已新增逐一对决比较（Q4_0 vs Q4_K_M、Q4_K_M vs Q4_K_S、Q8_0 vs Q4_K_M、Q8_0 vs Q8_K_XL）。2026年8月更新。',
      ...
      toc: [
        ...
        { label: 'Mac Studio M5 Ultra：无需卸载的原生70B', anchor: '#mac-studio' },
      ...
      sections: {
        ...
        quantizationLevels: {
          ...
          image: '/images/llm-quantization-explained-quant-levels-hero-zh.webp',
        ...
        macStudio: {
          id: 'mac-studio',
          title: 'Mac Studio M5 Ultra：无需卸载的原生70B',
          content: [
          ...
          rows: [
            ...
            { '配置': 'Mac Studio M5 Ultra（96GB起）', '模型': 'Llama 3.3 70B Q4', '速度': '尚未测试', '复杂度': '低' },
          ],
          columns: ['配置', '模型', '速度', '复杂度'],
          costNote: '2× RTX 4090工作站：约$4,500。Mac Studio M5 Ultra（96 GB）：$5,499起。',
        },
        regionalContext: {
          id: 'regional-context',
          title: '本地LLM量化的地域背景',
...
schema: {
  ...
  ko: {
      ...
      intro: 'LLM 양자화 선택 완전 가이드: 6–8 GB VRAM에는 Q4_K_M, 16 GB에는 Q5_K_M, 24+ GB에는 Q8_0을 권장합니다. GGUF 형식 해설, 양자화 수준별 품질 손실 분석, 그리고 CPU 오프로딩·멀티 GPU 레이어 분할 같은 고급 기법을 다룹니다. RTX 4090 단일 GPU(오프로딩), 2× RTX 4090(레이어 분할), M5 Ultra 탑재 Mac Studio(네이티브)로 Llama 3.3 70B를 실행하는 방법을 설명합니다. 이번 가이드에는 정면 비교도 포함됩니다: Q4_0 vs Q4_K_M, Q4_K_M vs Q4_K_S, Q8_0 vs Q4_K_M, Q8_0 vs Q8_K_XL. 2026년 8월 업데이트.',
      ...
      toc: [
        ...
        { label: 'Mac Studio M5 Ultra: 오프로딩 없이 70B 네이티브 실행', anchor: '#mac-studio' },
      ...
      sections: {
        ...
        macStudio: {
          id: 'mac-studio',
          title: 'Mac Studio M5 Ultra: 오프로딩 없이 70B 네이티브 실행',
          content: [
          ...
          rows: [
            ...
            { '구성': 'Mac Studio M5 Ultra (96 GB~)', '모델': 'Llama 3.3 70B Q4', '속도': '아직 미측정', '복잡도': '낮음 (플러그 앤 플레이)' },
          ],
