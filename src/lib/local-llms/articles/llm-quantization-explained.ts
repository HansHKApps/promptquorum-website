...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      theme: 'Best Models',
      title: 'How to Choose LLM Quantization: Q4_K_M for 6GB VRAM, Updated 2026',
      seoTitle: 'LLM Quantization Guide: Q4_K_M (6GB), Q5_K_M (16GB), Q8_0 (24GB+), 2026',
      ...
      metaDescription: 'Choose the right LLM quantization for your VRAM: 6GB=Q4_K_M (~4.5GB 7B model), 16GB=Q5_K_M, 24GB+=Q8_0. Q4_K_M has only 1–3% quality loss. Updated May 2026.',
...
schema: {
        ...
        '@type': 'TechArticle',
        'headline': 'LLM Quantization Guide: Q4_K_M (6GB), Q5_K_M (16GB), Q8_0 (24GB+), 2026',
        'description': 'Choose the right LLM quantization for your VRAM: 6GB=Q4_K_M (~4.5GB 7B model), 16GB=Q5_K_M, 24GB+=Q8_0. Q4_K_M has only 1–3% quality loss. Updated May 2026.',
    ...
    de: {
      theme: 'Beste Modelle',
      title: 'LLM-Quantisierung wählen: Q4_K_M für 6 GB VRAM, aktualisiert 2026',
      seoTitle: 'LLM-Quantisierungsleitfaden: Q4_K_M (6GB), Q5_K_M (16GB), Q8_0 (24GB+), 2026',
      ...
      metaDescription: 'Wählen Sie die richtige LLM-Quantisierung für Ihre VRAM: 6GB=Q4_K_M (~4,5GB 7B-Modell), 16GB=Q5_K_M, 24GB+=Q8_0. Q4_K_M hat nur 1–3% Qualitätsverlust. Aktualisiert Mai 2026.',
      publishDate: '2026-04-04',
      dateModified: '2026-05-07',
      current_models_mentioned: ['Llama 3.3 70B', 'Llama 3.1 8B', 'Qwen2.5', 'Mistral'],
      current_hardware_mentioned: ['RTX 4090', 'RTX 4060 Ti', 'RTX 5090', 'Mac Studio M2 Ultra'],
...
schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': 'LLM-Quantisierung 2026: Q4, Q5, Q8 + Offloading & Layer Splitting',
        'description': 'LLM-Quantisierung reduziert Modellgewichte von 32-Bit oder 16-Bit Fließkommazahlen auf 4-Bit oder 8-Bit Ganzzahlen und spart 50-75% RAM mit minimalem Qualitätsverlust.',
        'datePublished': '2026-04-04',
    ...
    fr: {
      ...
      title: 'Quantification LLM 2026 : Q4, Q5, Q8 + Offloading & Layer Splitting',
      seoTitle: 'Quantification LLM 2026 : Q4_K_M, Offloading & Layer Splitting',
      ...
      metaDescription: 'Quantification LLM 2026 : Q4_K_M à Q8, offloading CPU et layer splitting. Llama 3.3 70B sur GPU unique (offload), dual-GPU (split) ou Mac Studio M2 Ultra (natif). Commandes et benchmarks.',
      publishDate: '2026-04-04',
      dateModified: '2026-05-07',
      current_models_mentioned: ['Llama 3.3 70B', 'Llama 3.1 8B', 'Qwen2.5', 'Mistral'],
      current_hardware_mentioned: ['RTX 4090', 'RTX 4060 Ti', 'RTX 5090', 'Mac Studio M2 Ultra'],
...
schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': 'Quantification LLM 2026 : Q4, Q5, Q8 + Offloading & Layer Splitting',
        'description': 'La quantification LLM réduit les poids du modèle de nombres flottants 32 bits ou 16 bits à des entiers 4 bits ou 8 bits, économisant 50-75% de RAM avec une perte minimale.',
        'datePublished': '2026-04-04',
        'dateModified': '2026-04-20',
    ...
    ja: {
      theme: 'ベストモデル',
      title: 'LLM量子化2026：Q4、Q5、Q8 + オフロードとレイヤースプリッティング',
      seoTitle: 'LLM量子化2026：Q4_K_M、オフロード、レイヤースプリッティング',
      ...
      metaDescription: 'LLM量子化2026：Q4_K_MからQ8、CPUオフロード、レイヤースプリッティング。Llama 3.3 70BをシングルGPU（オフロード）、デュアルGPU（スプリット）、またはMac Studio M2 Ultra（ネイティブ）で実行。コマンドとベンチマーク付き。',
      publishDate: '2026-04-04',
      dateModified: '2026-05-07',
      current_models_mentioned: ['Llama 3.3 70B', 'Llama 3.1 8B', 'Qwen2.5', 'Mistral'],
      current_hardware_mentioned: ['RTX 4090', 'RTX 4060 Ti', 'RTX 5090', 'Mac Studio M2 Ultra'],
...
schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': 'LLM量子化2026：Q4、Q5、Q8 + オフロードとレイヤースプリッティング',
    ...
    zh: {
      theme: '量化入门',
      title: '本地LLM量化2026：Q4、Q5、Q8 + 卸载与层分割完全指南',
      seoTitle: '本地LLM量化2026：Q4_K_M、卸载与层分割',
      ...
      metaDescription: 'LLM量化2026：Q4_K_M至Q8、CPU卸载、层分割。在单GPU（卸载）、双GPU（分割）或Mac Studio M2 Ultra（原生）上运行Llama 3.3 70B。含命令和基准测试。',
      publishDate: '2026-04-04',
      dateModified: '2026-05-07',
      current_models_mentioned: ['Llama 3.3 70B', 'Llama 3.1 8B', 'Qwen2.5', 'Mistral'],
      current_hardware_mentioned: ['RTX 4090', 'RTX 4060 Ti', 'RTX 5090', 'Mac Studio M2 Ultra'],
...
schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': '本地LLM量化2026：Q4、Q5、Q8 + 卸载与层分割指南',
        'description': 'LLM量化通过将模型权重精度从32位或16位浮点数降低到4位或8位整数，将RAM需求减少50-75%，质量损失最小。',
