...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      theme: 'Best Models',
      title: 'Which LLM Quantization Should You Use? Q4_K_M, Q5_K_M, Q8_0 Compared (2026)',
      seoTitle: 'Which LLM Quantization: Q4_K_M vs Q5_K_M vs Q8_0 (2026)',
      ...
      metaDescription: 'Choose the right LLM quantization for your hardware. Q4_K_M for 6-8GB VRAM, Q5_K_M for 16GB, Q8_0 for 24GB+. 2026 guide with RAM tables.',
