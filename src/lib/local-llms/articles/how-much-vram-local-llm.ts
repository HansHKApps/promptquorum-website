...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      current_models_mentioned: ['Qwen 3.6 35B-A3B', 'DeepSeek V4-Flash', 'Llama 4 Scout', 'Kimi K2', 'gpt-oss:20b'],
      ...
      sections: {
        ...
        'by-model-size': {
          ...
          rows: [
            ...
            { 'Model Size': 'Kimi K2 (32B active / 1T total, MoE)*', 'FP32 (No Quantization)': '128 GB', 'Q8 (8-bit)': '32 GB', 'Q5 (5-bit)': '20 GB', 'Q4 (4-bit)': '16 GB', 'Recommended GPU': '2× RTX 4090 or RTX 5090 32 GB (Q4 only)' },
          ],
      ...
      sections: {
        ...
        'by-model-size': {
          ...
          rows: [
            ...
            { 'Tamaño del modelo': 'Kimi K2 (32B activos / 1T total, MoE)*', 'FP32 (sin cuantización)': '128 GB', 'Q8 (8 bits)': '32 GB', 'Q5 (5 bits)': '20 GB', 'Q4 (4 bits)': '16 GB', 'GPU recomendada': '2× RTX 4090 o RTX 5090 32 GB (solo Q4)' },
          ],
      ...
      sections: {
        ...
        'by-model-size': {
          ...
          rows: [
            ...
            { 'حجم النموذج': 'Kimi K2 (32B نشطة / 1T إجمالي، MoE)*', 'FP32 (دون تكميم)': '128 GB', 'Q8 (8 بت)': '32 GB', 'Q5 (5 بت)': '20 GB', 'Q4 (4 بت)': '16 GB', 'GPU الموصى بها': '2× RTX 4090 أو RTX 5090 32 GB (Q4 فقط)' },
          ],
      ...
      sections: {
        ...
        'by-model-size': {
          ...
          rows: [
            ...
            { 'Tamanho do modelo': 'Kimi K2 (32B ativos / 1T total, MoE)*', 'FP32 (sem quantização)': '128 GB', 'Q8 (8 bits)': '32 GB', 'Q5 (5 bits)': '20 GB', 'Q4 (4 bits)': '16 GB', 'GPU recomendada': '2× RTX 4090 ou RTX 5090 32 GB (só Q4)' },
          ],
      ...
      sections: {
        ...
        byModelSize: {
          ...
          rows: [
            ...
            { 'Taille du modèle': 'Kimi K2 (32B actif / 1T total, MoE)*', 'FP32': '128 GB', 'Q8': '32 GB', 'Q5': '20 GB', 'Q4': '16 GB', 'GPU recommandé': '2× RTX 5090 ou A100 80GB' },
          ],
      ...
      sections: {
        ...
        'by-model-size': {
          ...
          rows: [
            ...
            { '모델 크기': 'Kimi K2 (32B 활성 / 1T 총량, MoE)*', 'FP32 (양자화 없음)': '128 GB', 'Q8 (8비트)': '32 GB', 'Q5 (5비트)': '20 GB', 'Q4 (4비트)': '16 GB', '권장 GPU': '2× RTX 4090 또는 RTX 5090 32 GB(Q4 전용)' },
          ],
