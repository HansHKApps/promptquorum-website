...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      title: 'VRAM Rule of Thumb: 7B=8GB, 70B=48GB (2026 Guide)',
      seoTitle: 'VRAM Rule of Thumb: 7B=8GB, 70B=48GB (2026 Guide)',
      ...
      metaDescription: 'VRAM rule of thumb: 7B=8GB, 13B=16GB, 70B=48GB (Q4). Simple calculator + formula for every model size and quantization level.',
