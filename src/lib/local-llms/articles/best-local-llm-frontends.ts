    ...
    en: {
      ...
      sections: {
        ...
        topFrontends: {
          ...
          image: '/images/best-local-llm-frontends-frontend-selection-hero-en.webp',
        ...
        openWebUI: {
          ...
          image: '/images/best-local-llm-frontends-architecture-hero-en.webp',
...
schema: {
    ...
    de: {
      ...
      heroImage: '/images/best-local-llm-frontends-frontend-selection-hero-de.webp',
      publishDate: '2026-04-04',
      dateModified: '2026-08-29',
      leadAnswerBlock: '**Ein Frontend (oder Chat-Oberfläche) ist die Schnittstelle, mit der Sie mit Ihrem lokalen LLM interagieren. Ollama und LM Studio können Modelle ausführen, aber für ein poliertes Chat-Erlebnis verwenden die meisten Entwickler ein Frontend von Drittanbietern. Ab Juli 2026 ist Open WebUI die funktionsreichste Option (140.000+ GitHub-Sterne), Enchanted UI ist die beste native macOS/iOS/visionOS-App, und Jan AI bietet eine Offline-Desktop-Alternative für Windows, macOS und Linux.**',
      ...
      sections: {
        ...
        topFrontends: {
          ...
          image: '/images/best-local-llm-frontends-frontend-selection-hero-de.webp',
        ...
        openWebUI: {
          ...
          image: '/images/best-local-llm-frontends-architecture-hero-de.webp',
        ...
        regionalContext: {
          ...
          content: [
            ...
            '**Japan (METI)**',
            'METI AI-Governance-Richtlinien erfordern die Dokumentation von AI-Tool-Versionen in Produktionsbereitstellungen. Die Open WebUI-Version ist in Einstellungen → Über sichtbar, und Docker-Image-Tags ermöglichen genaue Versions-Fixierung für Compliance-Records. Für japanische Enterprise-Teams ist Open WebUI mit Qwen3 8B (`ollama run qwen3:8b`) der empfohlene Stack -- native japanische Tokenisierung bietet bessere Qualität für japanische Dokument-Q&A in der RAG-Funktion.',
            '**China**',
...
schema: {
    ...
    fr: {
      ...
      heroImage: '/images/best-local-llm-frontends-frontend-selection-hero-fr.webp',
      publishDate: '2026-04-04',
      dateModified: '2026-08-28',
      leadAnswerBlock: '**Une interface (ou chat UI) est l\'interface avec laquelle vous interagissez avec votre LLM local. Ollama et LM Studio peuvent exécuter des modèles, mais pour une expérience de chat soignée, la plupart des développeurs utilisent une interface tierce. En juillet 2026, Open WebUI est l\'option la plus riche en fonctionnalités (140 000+ étoiles GitHub), Enchanted UI est la meilleure application native macOS/iOS/visionOS, et Jan AI fournit une alternative de bureau hors ligne pour Windows, macOS et Linux.**',
      ...
      sections: {
        ...
        topFrontends: {
          ...
          image: '/images/best-local-llm-frontends-frontend-selection-hero-fr.webp',
        ...
        openWebUI: {
          ...
          image: '/images/best-local-llm-frontends-architecture-hero-fr.webp',
...
schema: {
    ...
    ja: {
      ...
      heroImage: '/images/best-local-llm-frontends-frontend-selection-hero-ja.webp',
      publishDate: '2026-04-04',
      dateModified: '2026-08-28',
      leadAnswerBlock: '**フロントエンド（チャットUI）はローカルLLMと対話するインターフェースです。OllamaとLM Studioはモデル実行可能ですが、より洗練されたチャット体験のため、ほとんどの開発者はサードパーティフロントエンド使用します。2026年7月現在、Open WebUIが最も機能豊富（GitHub 140,000+スター）、Enchanted UIが最高のmacOS/iOS/visionOSネイティブアプリ、Jan AIがWindows・macOS・Linux対応のオフラインデスクトップ代替案提供。**',
      readTime: '11分で読める',
      educationalLevel: 'Beginner to Advanced',
      ...
      sections: {
        ...
        topFrontends: {
          ...
          image: '/images/best-local-llm-frontends-frontend-selection-hero-ja.webp',
        ...
        openWebUI: {
          ...
          image: '/images/best-local-llm-frontends-architecture-hero-ja.webp',
...
schema: {
    ...
    zh: {
      ...
      heroImage: '/images/best-local-llm-frontends-frontend-selection-hero-zh.webp',
      publishDate: '2026-04-04',
      dateModified: '2026-08-28',
      leadAnswerBlock: '**前端（聊天UI）是与本地LLM互动的界面。Ollama和LM Studio可运行模型，但为获得精细的聊天体验，大多数开发者使用第三方前端。截至2026年7月，Open WebUI功能最丰富（GitHub 140,000+星），Enchanted UI是最佳macOS/iOS/visionOS原生应用，Jan AI提供支持Windows、macOS和Linux的离线桌面替代方案。**',
      readTime: '阅读约11分钟',
      educationalLevel: 'Beginner to Advanced',
      primaryTerm: '本地LLM前端',
      toc: [
      ...
      sections: {
        ...
        topFrontends: {
          ...
          image: '/images/best-local-llm-frontends-frontend-selection-hero-zh.webp',
        ...
        openWebUI: {
          ...
          image: '/images/best-local-llm-frontends-architecture-hero-zh.webp',
...
schema: {
    ...
    es: {
      ...
      heroImage: '/images/best-local-llm-frontends-frontend-selection-hero-es.webp',
      publishDate: '2026-04-04',
      dateModified: '2026-08-29',
      ...
      sections: {
        ...
        topFrontends: {
          ...
          image: '/images/best-local-llm-frontends-frontend-selection-hero-es.webp',
        ...
        openWebUI: {
          ...
          image: '/images/best-local-llm-frontends-architecture-hero-es.webp',
    ...
    ar: {
      ...
      heroImage: '/images/best-local-llm-frontends-frontend-selection-hero-ar.webp',
      publishDate: '2026-04-04',
      dateModified: '2026-08-29',
      ...
      sections: {
        ...
        topFrontends: {
          ...
          image: '/images/best-local-llm-frontends-frontend-selection-hero-ar.webp',
        ...
        openWebUI: {
          ...
          image: '/images/best-local-llm-frontends-architecture-hero-ar.webp',
        ...
        regionalContext: {
          ...
          content: [
            ...
            '**اليابان (METI)**',
            'تتطلب إرشادات حوكمة الذكاء الاصطناعي من METI توثيق إصدارات أدوات الذكاء الاصطناعي في عمليات النشر الإنتاجية. إصدار Open WebUI مرئي في الإعدادات ← حول، وتوفّر وسوم صور Docker إصداراً دقيقاً لسجلات الامتثال. للفرق المؤسسية اليابانية، المنظومة الموصى بها هي Open WebUI مع Qwen3 8B (`ollama run qwen3:8b`): يقدّم التقطيع الأصلي باليابانية جودة أفضل لوظيفة RAG مع مستندات بتلك اللغة.',
            '**الصين**',
    ...
    pt: {
      ...
      heroImage: '/images/best-local-llm-frontends-frontend-selection-hero-pt.webp',
      publishDate: '2026-04-04',
      dateModified: '2026-08-29',
      ...
      sections: {
        ...
        topFrontends: {
          ...
          image: '/images/best-local-llm-frontends-frontend-selection-hero-pt.webp',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'O Open WebUI funciona em português?', a: 'Sim. Open WebUI tem localização em português. A qualidade das respostas em português depende do modelo -- Qwen3 8B ou Llama 3.1 8B têm bom suporte em português.' },
            ...
            { q: 'Posso rodar vários frontends simultaneamente?', a: 'Sim. Todos os frontends se conectam à mesma API do Ollama (localhost:11434). Você pode ter Open WebUI, Enchanted UI e Continue.dev rodando ao mesmo tempo, usando o mesmo modelo. Isso não dobra o uso de VRAM -- todos compartilham a mesma instância do modelo.' },
            { q: 'Qual frontend é melhor para RAG?', a: 'O Open WebUI tem a implementação de RAG de uso geral mais madura entre os frontends deste guia -- envie documentos e o modelo responde perguntas sobre eles. Se Q&A de documentos for seu caso de uso principal, o AnythingLLM (60.000+ estrelas no GitHub) é construído especificamente em torno de workspaces de RAG.' },
            { q: 'Preciso de um frontend afinal?', a: 'Não. O Ollama fornece uma API REST em localhost:11434. Você pode escrever scripts em Python, JavaScript ou bash para interagir diretamente com o modelo via API, sem frontend nenhum. Um frontend é só para conveniência e interação visual.' },
            { q: 'Qual frontend funciona no Linux?', a: 'Open WebUI, Jan AI, Lobe Chat e Gradio/Streamlit funcionam no Linux. O Jan AI adicionou aceleração de GPU AMD ROCm/HIP no Linux na v0.8.2 (junho de 2026). O Enchanted UI é exclusivo para iOS/macOS/visionOS e não tem versão para Linux.' },
            { q: 'Posso hospedar um frontend em um servidor remoto?', a: 'Sim. Todos os frontends são aplicações web (ou podem ser conteinerizados). Você pode rodar o Ollama em um servidor e o Open WebUI no Docker, e acessá-lo do seu notebook via HTTP. Certifique-se de proteger a interface com autenticação ou firewall.' },
            { q: 'Qual frontend usa menos RAM?', a: 'O Enchanted UI adiciona uma sobrecarga mínima de RAM como app nativo (bem abaixo de 200 MB), pois não tem Docker nem camada de banco de dados. Jan AI e Continue.dev também adicionam pouca sobrecarga. O Open WebUI no Docker adiciona aproximadamente 500 MB-1 GB de sobrecarga.' },
            { q: 'Posso usar esses frontends com o LM Studio em vez do Ollama?', a: 'Sim. O Open WebUI funciona com qualquer API compatível com OpenAI, incluindo a API do LM Studio em localhost:1234. A API REST do LM Studio já atingiu uma versão estável v1 e também adicionou um endpoint compatível com Anthropic.' },
            { q: 'Qual frontend é melhor para uma equipe de 5+ desenvolvedores?', a: 'Open WebUI. É o único frontend desta lista projetado para implantação multiusuário: autenticação, históricos de conversa separados por usuário, bases de conhecimento compartilhadas e controles de administração. Requer 12+ GB de RAM no servidor host.' },
          ],
        },
        relatedReading: {
          id: 'related-reading',
  ...
  heroImage: '/images/best-local-llm-frontends-frontend-selection-hero-ko.webp',
  publishDate: '2026-04-04',
  ...
  sections: {
    ...
    topFrontends: {
      ...
      image: '/images/best-local-llm-frontends-frontend-selection-hero-ko.webp',
    ...
    openWebUI: {
      ...
      image: '/images/best-local-llm-frontends-architecture-hero-ko.webp',
    ...
    regionalContext: {
      ...
      content: [
        ...
        '**일본 (METI)**',
        'METI AI 거버넌스 지침은 프로덕션 배포에서 AI 도구 버전을 문서화하도록 요구합니다. Open WebUI 버전은 설정 → 정보에서 확인할 수 있으며, Docker 이미지 태그는 컴플라이언스 기록을 위한 정확한 버전 고정을 제공합니다. 일본 기업 팀의 경우, Qwen3 8B와 함께한 Open WebUI(`ollama run qwen3:8b`)가 권장 스택입니다 — 네이티브 일본어 토크나이제이션은 RAG 기능에서 일본어 문서 Q&A에 더 나은 품질을 제공합니다.',
        '**중국**',
