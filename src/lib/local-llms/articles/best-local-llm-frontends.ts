      ...
      sections: {
        ...
        regionalContext: {
          ...
          content: [
            ...
            '**Japan (METI)**',
            'METI AI-Governance-Richtlinien erfordern die Dokumentation von AI-Tool-Versionen in Produktionsbereitstellungen. Die Open WebUI-Version ist in Einstellungen → Über sichtbar, und Docker-Image-Tags ermöglichen genaue Versions-Fixierung für Compliance-Records. Für japanische Enterprise-Teams ist Open WebUI mit Qwen3 7B (`ollama run qwen3:7b`) der empfohlene Stack -- native japanische Tokenisierung bietet bessere Qualität für japanische Dokument-Q&A in der RAG-Funktion.',
            '**China**',
      ...
      sections: {
        ...
        regionalContext: {
          ...
          content: [
            ...
            '**اليابان (METI)**',
            'تتطلب إرشادات حوكمة الذكاء الاصطناعي من METI توثيق إصدارات أدوات الذكاء الاصطناعي في عمليات النشر الإنتاجية. إصدار Open WebUI مرئي في الإعدادات ← حول، وتوفّر وسوم صور Docker إصداراً دقيقاً لسجلات الامتثال. للفرق المؤسسية اليابانية، المنظومة الموصى بها هي Open WebUI مع Qwen3 7B (`ollama run qwen3:7b`): يقدّم التقطيع الأصلي باليابانية جودة أفضل لوظيفة RAG مع مستندات بتلك اللغة.',
            '**الصين**',
  ...
  sections: {
    ...
    regionalContext: {
      ...
      content: [
        ...
        '**일본 (METI)**',
        'METI AI 거버넌스 지침은 프로덕션 배포에서 AI 도구 버전을 문서화하도록 요구합니다. Open WebUI 버전은 설정 → 정보에서 확인할 수 있으며, Docker 이미지 태그는 컴플라이언스 기록을 위한 정확한 버전 고정을 제공합니다. 일본 기업 팀의 경우, Qwen3 7B와 함께한 Open WebUI(`ollama run qwen3:7b`)가 권장 스택입니다 — 네이티브 일본어 토크나이제이션은 RAG 기능에서 일본어 문서 Q&A에 더 나은 품질을 제공합니다.',
        '**중국**',
