      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Ab Mai 2026 haben sich GPU-Preise stabilisiert; CPU/RAM sind weniger kritisch als GPU VRAM für die LLM-Geschwindigkeit.',
          ],
        },
        vramMath: {
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '2026年5月現在、GPU価格は安定しています。CPU/RAMはLLM速度の観点から GPU VRAMほど重要ではありません。',
          ],
        },
        vramMath: {
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '截至2026年5月，GPU价格已稳定。在LLM速度方面，CPU/RAM不如GPU VRAM关键。',
          ],
        },
        vramMath: {
          title: '如何计算VRAM要求？',
