...
schema: {
    ...
    ar: {
      ...
      metaDescription: 'متطلبات عتاد ⁨LLM⁩ المحلي حسب ⁨VRAM⁩: أفضل النماذج لبطاقات ⁨8⁩ و⁨16⁩ و⁨24 GB⁩ إضافة إلى الاحتياجات الدقيقة لـ ⁨70B⁩ و⁨GLM-5.3⁩. ⁨RTX 50-series⁩ و⁨Apple M5⁩ وأسعار يوليو ⁨2026⁩.',
...
schema: {
    ...
    ja: {
      ...
      metaDescription: 'VRAM別ローカルLLMハードウェア要件：8、16、24 GB GPU向けベストモデルと70BおよびGLM-5.3をローカルで動かすために必要なもの。RTX 50シリーズ、Apple M5、2026年7月価格。',
...
schema: {
    ...
    zh: {
      ...
      metaDescription: '按显存划分的本地LLM硬件要求：8、16和24 GB GPU的最佳模型，以及70B和GLM-5.3的精确需求。RTX 50系列、Apple M5、2026年7月价格。',
...
schema: {
  ...
  ko: {
      ...
      metaDescription: 'VRAM별 LLM 하드웨어 요구 사항: 8, 16, 24GB GPU를 위한 최적 모델과 70B 및 GLM-5.3에 정확히 필요한 사양. RTX 50 시리즈, Apple M5, 2026년 7월 가격.',
