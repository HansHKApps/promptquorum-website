...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      lastFactChecked: '2026-09-01',
      dateModified: '2026-09-16',
      last_seo_review: '2026-07-14',
      current_models_mentioned: ['Llama 3.1 8B', 'Llama 3.3 70B', 'Qwen3 8B/14B/32B', 'Qwen3.6 27B', 'DeepSeek-R1', 'Mistral Small 3.1 24B / Small 4', 'Devstral Small 24B', 'Phi-4 Mini', 'Gemma 3 4B', 'Llama 4 Scout/Maverick', 'Kimi K2.6/K2.7 Code', 'GLM-5.3'],
      current_benchmarks_used: ['SWE-bench'],
      current_hardware_mentioned: ['RTX 5060 Ti', 'RTX 5070', 'RTX 5070 Ti', 'RTX 5080', 'RTX 5090', 'RTX 4090 (EOL/used)', 'RTX 3090', 'RX 9070 XT', 'DGX Spark', 'Apple M5 Pro/Max', 'Mac mini M6', 'Mac Studio M5 Ultra'],
      ...
      quickAnswerTop: {
        en: {
          ...
          answer: 'To run a local LLM in 2026 you need at minimum an 8 GB VRAM GPU (NVIDIA RTX 5060 Ti or Apple M2) for 7B models, 12 GB for 14B models, 16 GB for 24B models, 24 GB for 32B models, and 40 GB+ for 70B models. Rule of thumb for 4-bit quantization: VRAM in GB ≈ parameters in billions × 0.6 — a 7B model needs roughly 4-5 GB. Apple Silicon (M3/M4/M5) is the best value for most users due to unified memory. Frontier open-weight MoE models like GLM-5.3 (744B total) are the exception — they need ~239 GB even at aggressive 2-bit quantization, beyond any single consumer GPU or the 128 GB DGX Spark.',
          bullets: [
            '7B models (Mistral, Phi-4 Mini): 4-5 GB VRAM at Q4_K_M (8 GB card recommended) — RTX 5060 Ti, RTX 4060, Mac M2',
            ...
            'GLM-5.3 (744B MoE, 40B active): ~239 GB even at 2-bit — needs a 4× RTX 3090/4090 rig with 192 GB+ RAM or a 512 GB Mac Studio (M5 Ultra)',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'Local LLM hardware is determined by VRAM: 7B models need 8 GB, 13B–14B need 12–16 GB, and 70B models need 35–48 GB — a used RTX 4060 8 GB (~$280) is the best entry-level GPU in 2026.' },
          ...
          items: [
            '**7B Q4 rule of thumb**: a 7B model at Q4_K_M quantization needs about 4-5 GB of VRAM (or system RAM for CPU inference) — roughly 0.6 GB per billion parameters at 4-bit. This is the fastest way to estimate memory for any 7B-class model without doing the full VRAM math below.',
            ...
            '**CPU-only (16 GB system RAM)**: Llama 3.2 3B Q8 (20 tok/sec) or Phi-4 Mini Q4_K_M (25 tok/sec). A used RTX 4060 8 GB (~$280) or new RTX 5060 Ti 16 GB (~$585) is 5-10× faster.',
            ...
            '**Current prices**: the GDDR7 shortage has worsened, not eased — RTX 5090 street pricing has climbed past $4,300–$5,000+, and the RTX 4090 remains discontinued. Budget-conscious buyers should also check AMD\'s RX 9070 XT (16 GB GDDR6, ~$690–740) — GDDR6 has dodged most of the shortage, making it noticeably cheaper than the RTX 5070 Ti at similar VRAM. Buy from in-stock listings; check live prices before purchase.',
        ...
        bestGPUs: {
          ...
          content: [
            '**The in-stock choice for local LLMs is the NVIDIA RTX 50-series (Blackwell): 5060 Ti, 5070, 5070 Ti, 5080, 5090.** The RTX 40-series (4060, 4070 Ti, 4090) is discontinued and now sells scarce and above its old prices on the used market. The 2026 GDDR7/memory shortage has continued to worsen, pushing even 50-series cards further above MSRP, so treat every figure below as a typical street price and check live listings before buying. Recommendations by use case:',
          ],
          items: [
            '**For 7B Models (Mistral, Phi-4, Llama 3.1) — Budget:** RTX 5060 Ti 16 GB (~$585, about 40% over its $429 MSRP) or a used RTX 4060 8 GB (~$280). Runs any 7B model at Q4_K_M (~4-5 GB). Speed: 50–70 tok/sec. Tier: Budget enthusiasts.',
            '**For 14B Models (Qwen3 14B, DeepSeek-R1) — Mainstream:** RTX 5070 (12 GB, ~$880). Best price-to-performance new card. Qwen3 14B Q4_K_M runs well with headroom. Speed: 85–110 tok/sec. Tier: Most popular.',
            '**For 24-32B Models (Qwen3.6, Mistral Small) — Mid-Range:** RTX 5070 Ti (16 GB, ~$979) or RTX 5080 (16 GB, ~$1,450). Runs Mistral Small 3.1 24B and Devstral Small 24B Q4_K_M. Speed: 110–150 tok/sec. Tier: Professional developers. Budget alternative: AMD RX 9070 XT (16 GB GDDR6, ~$690–740) — GDDR6 has largely dodged the shortage, so it now undercuts the RTX 5070 Ti by $150–250 at similar VRAM, though ROCm has narrower local-LLM tooling support than CUDA.',
            '**For 70B Models (Llama 3.3) — High-End:** RTX 5090 (32 GB, ~$2,000 MSRP but ~$4,300–5,000+ street and still climbing) fits 70B at Q4_K_M with light CPU offload. A used RTX 4090 (24 GB, ~$2,300) runs 70B only at Q2_K. For full Q4_K_M, use dual RTX 5090. Speed: ~200 tok/sec (5090, smaller models). Tier: Research + production.',
            '**For GLM-5.3 (744B MoE, 40B active) — Extreme:** no single consumer GPU is enough. The 2-bit dynamic GGUF still needs ~239 GB combined VRAM/RAM. Realistic local paths: a 4× RTX 3090/4090 rig with 192 GB+ system RAM, or a 512 GB Mac Studio (M5 Ultra), both around 3–9 tok/sec via CPU/GPU hybrid offload.',
          ...
          rows: [
            { 'GPU': 'RTX 5060 Ti (16 GB)', 'Best For': '7-13B models', 'Price': '~$585', 'Speed': '50–70 tok/s', 'Tier': 'Budget' },
            { 'GPU': 'RTX 5070 (12 GB)', 'Best For': '14B models', 'Price': '~$880', 'Speed': '85–110 tok/s', 'Tier': 'Mainstream' },
            { 'GPU': 'RX 9070 XT (16 GB)', 'Best For': '24-32B models', 'Price': '~$690–740', 'Speed': '90–130 tok/s', 'Tier': 'Budget alternative' },
            ...
            { 'GPU': 'RTX 5090 (32 GB)', 'Best For': '70B (Q4, light offload)', 'Price': '~$2,000 MSRP (~$4,300–5,000+ street)', 'Speed': '~200 tok/s', 'Tier': 'High-end' },
            { 'GPU': 'Dual RTX 5090', 'Best For': '70B (Q4) full', 'Price': '~$8,600–10,000', 'Speed': '300+ tok/s', 'Tier': 'Enterprise' },
            { 'GPU': 'Mac M5 Max 128GB', 'Best For': '70B (Q4)', 'Price': '~$6,000', 'Speed': '~12–15 tok/s (70B)', 'Tier': 'Pro laptop' },
            { 'GPU': '4× RTX 3090/4090 + 192GB RAM', 'Best For': 'GLM-5.3 (2-bit)', 'Price': '~$6,000–9,000', 'Speed': '3–9 tok/s', 'Tier': 'Extreme MoE' },
          ],
          columns: ['GPU', 'Best For', 'Price', 'Speed', 'Tier'],
          callouts: [
            { type: 'warning', text: 'GPU pricing is volatile and still worsening. The GDDR7 shortage has pushed the RTX 5090 street price past $4,300–$5,000+ — more than double its $1,999 MSRP — and the discontinued RTX 4090 now costs more used than it did new. The prices above are typical street figures — always check current listings before buying. AMD\'s GDDR6-based RX 9070 XT is a notable exception: it has largely avoided the price spike.' },
          ],
        },
        vramMath: {
          id: 'vram-math',
        ...
        kvCache: {
          ...
          content: [
            ...
            '**These figures assume fp16 (2 bytes per element) for the K and V tensors.** Quantized KV cache (e.g. `--cache-type-k q8_0` in llama.cpp) uses roughly half the VRAM shown in the table.',
          ],
          ...
          rows: [
            ...
            { 'Model': 'Llama 3.3 70B', '4K context': '1.25 GB', '32K context': '10 GB', '128K context': '40 GB' },
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'Rule of thumb: this percentage shrinks as model size grows -- KV cache scales with layer count, while model weight size scales with total parameters, and layers grow more slowly than parameters as models get larger. Llama 3.1 8B (32 layers): a 32K-context cache is ~4 GB against ~4.7 GB of Q4_K_M weights (~85%). Llama 3.3 70B (80 layers): a 32K-context cache is ~10 GB against ~40 GB of Q4_K_M weights (~25%). Ollama default context is 2,048 tokens. To set higher: PARAMETER num_ctx 32768 in your Modelfile.' },
          ],
        },
        gpuRecommendations: {
          ...
          rows: [
            { 'Tier': 'Budget (~$585)', 'GPU': 'RTX 5060 Ti', 'VRAM': '16 GB', 'Best For': '7-13B models', 'Speed': '~60 tok/s' },
            { 'Tier': 'Mainstream (~$880)', 'GPU': 'RTX 5070', 'VRAM': '12 GB', 'Best For': '7-14B models', 'Speed': '~90 tok/s' },
            { 'Tier': 'Mid (~$979)', 'GPU': 'RTX 5070 Ti', 'VRAM': '16 GB', 'Best For': '14-32B models', 'Speed': '~110 tok/s' },
            { 'Tier': 'High (~$1,450)', 'GPU': 'RTX 5080', 'VRAM': '16 GB', 'Best For': '14-32B models', 'Speed': '~130 tok/s' },
            { 'Tier': 'Top (~$4,300–5,000+ street)', 'GPU': 'RTX 5090', 'VRAM': '32 GB', 'Best For': '70B (Q4, light offload)', 'Speed': '~200 tok/s' },
          ...
          imageCaption: 'GPU tier recommendations (street prices): ~$585 RTX 5060 Ti (16GB, 7-13B, 60 tok/s), ~$880 RTX 5070 (12GB, 14B, 90 tok/s), ~$1,450 RTX 5080 (16GB, 14-32B, 130 tok/s), ~$4,300–5,000+ RTX 5090 (32GB, 70B, 200 tok/s), $4,699 DGX Spark (128GB, large MoE). GPU choice matters 10× more than CPU.',
        },
        vramTiers: {
          id: 'vram-tiers',
        ...
        modelsFor12GB: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'RTX 3060 12GB is the budget entry point (~$285 used). It runs all 12 GB models but at ~60-70 tok/sec vs ~80-90 tok/sec on RTX 4070 Ti due to older memory architecture.' },
          ],
        },
        modelsFor24GB: {
          id: 'models-24gb',
        ...
        cpuOnlyInference: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'CPU vs GPU speed reality: A used NVIDIA RTX 3060 12 GB (~$285) runs Llama 3.1 8B at 70+ tok/sec -- 5-8× faster than the Ryzen 9 7950X at CPU-only inference. If speed matters, buy a GPU before adding RAM.' },
          ...
          imageCaption: 'CPU-only inference speeds on Ryzen 9 7950X: Gemma 2 2B Q8_0 (28 tok/sec fastest), Phi-4 Mini Q4_K_M (25 tok/sec best choice), Llama 3.1 8B Q8_0 (8 tok/sec). A used RTX 3060 ($285) achieves 5-8× faster.',
        },
        storage: {
          id: 'storage',
        ...
        cantAffordHardware: {
          ...
          content: [
            'If a $280–400 GPU is outside your budget, or your laptop is too old to support modern inference engines, **local LLMs may not be cost-effective for you in 2026**.',
        ...
        mac: {
          ...
          content: [
            ...
            'The M5 Max with 128 GB unified memory (up to 614 GB/s) runs 70B models at Q4_K_M comfortably — roughly 12-15 tok/sec — in a laptop or Mac Studio form factor. The M5 Pro (up to 64 GB unified, 307 GB/s) handles 32B models with generous headroom for KV cache and multitasking. Note the M5 Max still falls far short of the ~239 GB GLM-5.3 needs even at 2-bit -- an area where Apple\'s unified memory ceiling matters more than raw speed.',
            '**Apple refreshed the Mac mini and Mac Studio lineup on August 25, 2026, shipping September 22, 2026.** The Mac mini now comes in M6 (from $899, 32 GB max unified memory, 170 GB/s) and M5 Pro (from $1,699, 64 GB max, 307 GB/s) configurations. The Mac Studio steps up to M5 Max (from $2,499, 128 GB max) and M5 Ultra (from $5,499 at 96 GB, up to 256 GB or 512 GB in the top configuration -- the 512 GB build ships late October 2026 and is expected to cost well above $10,000). The outgoing M4 Mac mini (from $599) and M4 Pro Mac mini (up to $2,299, 64 GB max), plus the previous Mac Studio M4 Max / M3 Ultra, are now the prior generation.',
            'No independent tok/sec benchmarks exist yet for the M6 or M5 Ultra chips -- Apple has not published third-party-verified inference figures for either as of this writing. For the first time, a single Mac can theoretically hold GLM-5.3 (744B MoE, ~239 GB at 2-bit) in unified memory: the top-configuration 512 GB Mac Studio M5 Ultra exceeds that footprint with room to spare. Until real-world benchmarks land, a 4× RTX 3090/4090 rig remains the better-documented local path for GLM-5.3-class models.',
          ...
          rows: [
            ...
            { 'Mac': 'Mac mini M6 (from $899)', 'GPU Memory': '32 GB unified, 170 GB/s', 'Best For': '8-14B models', 'Limitation': 'No 32B+ headroom' },
            { 'Mac': 'M5 Pro (MacBook Pro / Mac mini, from $1,699)', 'GPU Memory': '64 GB unified, 307 GB/s', 'Best For': '32B models comfortably', 'Limitation': 'Llama 4 Scout runs well' },
            { 'Mac': 'M5 Max (MacBook Pro / Studio, from $2,499)', 'GPU Memory': '128 GB unified, up to 614 GB/s', 'Best For': '70B models at Q4_K_M', 'Limitation': '~12-15 tok/sec on 70B' },
            { 'Mac': 'Mac Studio M5 Ultra (from $5,499)', 'GPU Memory': '96-512 GB unified', 'Best For': '70B+ and large MoE capacity', 'Limitation': '512 GB ships Oct 2026; no benchmarks yet' },
          ],
          columns: ['Mac', 'GPU Memory', 'Best For', 'Limitation'],
          image: '/images/mac-hardware-comparison-en.svg',
          imageCaption: 'Mac hardware comparison: 8 GB M-series (3-4B models), M3 Pro 16" (18GB, 7-8B), Mac mini M6 (32GB, 8-14B, $899), M5 Pro (64GB, 32B, $1,699), M5 Max (128GB, 70B at Q4_K_M ~12-15 tok/sec, $2,499), Mac Studio M5 Ultra (up to 512GB, 70B+/GLM-5.3 capacity, $5,499). 16 GB unified is the comfortable minimum for 7B models on a Mac.',
        },
        serverVsConsumer: {
          ...
          imageCaption: 'Consumer vs server hardware: RTX 5090 (~$4,300–5,000+ street, 32GB, single-user, part-time) vs RTX 6000 Ada ($7,000+, 48GB, multi-user, 24/7 duty). Start with consumer hardware; upgrade to server-grade only if running production services.',
        },
        dgxSpark: {
          id: 'dgx-spark',
          ...
          rows: [
            ...
            { 'Spec': 'GLM-5.3 at 2-bit (~239 GB)', 'Value': '❌ does not fit' },
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'Is an RTX 3060 12GB still worth it for local LLMs in 2026?', a: 'RTX 3060 (12 GB) is dated (2021 architecture). It handles 7B-13B models at Q4 but produces 40-60 tokens/sec. A used one runs ~$285; a new RTX 5070 (~$880) or RTX 5060 Ti 16 GB (~$585) runs 2-3× faster. The RTX 3060 is only worth keeping as a secondary GPU for multi-card setups.' },
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Prompt Engineering for Local LLMs](/local-llms/prompt-engineering-for-local-models) -- optimize prompts for local model constraints',
        ...
        sources: {
          ...
          title: 'Sources',
          items: [
            'NVIDIA. (2026). "GeForce GPU Specifications." [www.nvidia.com/en-us/geforce/graphics-cards/](https://www.nvidia.com/en-us/geforce/graphics-cards/) -- Official VRAM and bandwidth specs for RTX 40-series and RTX 50-series GPUs.',
            'Apple. (2026). "Apple M5 Chip." [www.apple.com/mac/](https://www.apple.com/mac/) -- M5 Pro/Max specifications, memory bandwidth, LLM performance claims. M5 is the first Mac that comfortably runs 70B models at Q4_K_M.',
            'NVIDIA. (2025). "DGX Spark Product Page." [www.nvidia.com/en-us/products/workstations/dgx-spark/](https://www.nvidia.com/en-us/products/workstations/dgx-spark/) -- Official specs for GB10 Grace Blackwell Superchip and 128 GB unified memory.',
            'Meta AI. (2024). "Llama 3.3 Model Card." [llama.meta.com/](https://llama.meta.com/) -- Official Llama 3.3 70B specifications and VRAM requirements.',
            'Meta AI. (2025). "Llama 4 Model Card." [llama.meta.com/](https://llama.meta.com/) -- Llama 4 Scout/Maverick MoE architecture, VRAM requirements.',
            'Z.ai. (2026). "GLM-5.3: Built for Long-Horizon Tasks." [huggingface.co/blog/zai-org/glm-52-blog](https://huggingface.co/blog/zai-org/glm-52-blog) -- Official GLM-5.3 model card: 744B total / 40B active MoE architecture, MIT license, release date.',
          ],
        },
      },
schema: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'RTX 3060 (12 GB) is dated (2021 architecture). It handles 7B-13B models at Q4 but produces 40-60 tokens/sec. A used one runs ~$285; a new RTX 5070 (~$880) or RTX 5060 Ti 16 GB (~$585) runs 2-3× faster. The RTX 3060 is only worth keeping as a secondary GPU for multi-card setups.',
            },
          },
          {
            '@type': 'Question',
      ...
      itemListSchema: {
        ...
        'numberOfItems': 7,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'Budget (~$585)', 'description': 'RTX 5060 Ti with 16 GB VRAM. Runs 7-13B models at ~60 tokens/sec. Best value new card.' },
          { '@type': 'ListItem', 'position': 2, 'name': 'Mainstream (~$880)', 'description': 'RTX 5070 with 12 GB VRAM. Runs 7-14B models at ~90 tokens/sec. Best price-to-performance.' },
          ...
          { '@type': 'ListItem', 'position': 4, 'name': 'High (~$1,450)', 'description': 'RTX 5080 with 16 GB VRAM. Runs 14-32B models at ~130 tokens/sec. Recommended.' },
          { '@type': 'ListItem', 'position': 5, 'name': 'Top (~$4,300–5,000+ street)', 'description': 'RTX 5090 with 32 GB VRAM. Runs 70B at Q4_K_M with light offload. ~200 tokens/sec. Worsening memory shortage keeps prices more than double the $1,999 MSRP.' },
    ...
    es: {
      ...
      quickAnswerTop: {
        es: {
          ...
          answer: 'Para ejecutar un LLM local en 2026 necesitas como mínimo una GPU con 8 GB de VRAM (NVIDIA RTX 5060 Ti o Apple M2) para modelos de 7B, 12 GB para modelos de 14B, 16 GB para modelos de 24B, 24 GB para modelos de 32B, y 40 GB+ para modelos de 70B. Regla general para cuantización de 4 bits: VRAM en GB ≈ parámetros en miles de millones × 0,6 — un modelo de 7B necesita aproximadamente 4-5 GB. Apple Silicon (M3/M4/M5) es la mejor relación calidad-precio para la mayoría de usuarios gracias a su memoria unificada. Los modelos MoE de pesos abiertos de vanguardia como GLM-5.3 (744B en total) son la excepción — necesitan ~239 GB incluso con cuantización agresiva de 2 bits, más allá de lo que ofrece cualquier GPU de consumo individual o el DGX Spark de 128 GB.',
          bullets: [
            'Modelos de 7B (Mistral, Phi-4 Mini): 4-5 GB de VRAM en Q4_K_M (se recomienda tarjeta de 8 GB) — RTX 5060 Ti, RTX 4060, Mac M2',
            ...
            'GLM-5.3 (744B MoE, 40B activos): ~239 GB incluso a 2 bits — necesita una configuración con 4× RTX 3090/4090 y 192 GB+ de RAM o un Mac Studio de 512 GB (M5 Ultra)',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '**Solo CPU (16 GB de RAM del sistema)**: Llama 3.2 3B Q8 (20 tok/seg) o Phi-4 Mini Q4_K_M (25 tok/seg). Una RTX 4060 8 GB usada (~$280) o una RTX 5060 Ti 16 GB nueva (~$585) es 5-10× más rápida.',
            ...
            '**Precios actuales**: la escasez de GDDR7 ha empeorado, no se ha aliviado — el precio de calle de la RTX 5090 ha subido por encima de $4.300–$5.000+, y la RTX 4090 sigue descontinuada. Los compradores con presupuesto ajustado también deberían fijarse en la AMD RX 9070 XT (16 GB GDDR6, ~$690–740) — la GDDR6 ha esquivado la mayor parte de la escasez, lo que la hace notablemente más barata que la RTX 5070 Ti con una VRAM similar. Compra en anuncios con stock disponible; comprueba los precios actuales antes de comprar.',
        ...
        bestGPUs: {
          ...
          items: [
            '**Para modelos de 7B (Mistral, Phi-4, Llama 3.1) — Económica:** RTX 5060 Ti 16 GB (~$585, en torno a un 40 % por encima de su PVP de 429 $) o una RTX 4060 8 GB usada (~$280). Ejecuta cualquier modelo de 7B en Q4_K_M (~4-5 GB). Velocidad: 50–70 tok/seg. Nivel: Entusiastas con presupuesto ajustado.',
            '**Para modelos de 14B (Qwen3 14B, DeepSeek-R1) — Mayoritaria:** RTX 5070 (12 GB, ~$880). Mejor tarjeta nueva en relación precio-rendimiento. Qwen3 14B Q4_K_M funciona bien con margen. Velocidad: 85–110 tok/seg. Nivel: La más popular.',
            '**Para modelos de 24-32B (Qwen3.6, Mistral Small) — Gama media:** RTX 5070 Ti (16 GB, ~$979) o RTX 5080 (16 GB, ~$1.249). Ejecuta Mistral Small 3.1 24B y Devstral Small 24B Q4_K_M. Velocidad: 110–150 tok/seg. Nivel: Desarrolladores profesionales. Alternativa económica: AMD RX 9070 XT (16 GB GDDR6, ~$690–740) — la GDDR6 ha esquivado en gran medida la escasez, por lo que ahora es $150–250 más barata que la RTX 5070 Ti con una VRAM similar, aunque ROCm tiene un soporte de herramientas para LLM local más limitado que CUDA.',
            ...
            '**Para GLM-5.3 (744B MoE, 40B activos) — Extremo:** ninguna GPU de consumo individual es suficiente. El GGUF dinámico de 2 bits sigue necesitando ~239 GB combinados de VRAM/RAM. Rutas locales realistas: una configuración con 4× RTX 3090/4090 y 192 GB+ de RAM del sistema, o un Mac Studio de 512 GB (M5 Ultra), ambas en torno a 3–9 tok/seg mediante descarga híbrida CPU/GPU.',
          ...
          rows: [
            { 'GPU': 'RTX 5060 Ti (16 GB)', 'Mejor para': 'Modelos de 7-13B', 'Precio': '~$585', 'Velocidad': '50–70 tok/s', 'Nivel': 'Económica' },
            { 'GPU': 'RTX 5070 (12 GB)', 'Mejor para': 'Modelos de 14B', 'Precio': '~$880', 'Velocidad': '85–110 tok/s', 'Nivel': 'Mayoritaria' },
            { 'GPU': 'RX 9070 XT (16 GB)', 'Mejor para': 'Modelos de 24-32B', 'Precio': '~$690–740', 'Velocidad': '90–130 tok/s', 'Nivel': 'Alternativa económica' },
            ...
            { 'GPU': 'RTX 5090 (32 GB)', 'Mejor para': '70B (Q4, descarga ligera)', 'Precio': '~$2.000 MSRP (~$4.300–5.000+ de calle)', 'Velocidad': '~200 tok/s', 'Nivel': 'Gama alta' },
            { 'GPU': 'RTX 5090 doble', 'Mejor para': '70B (Q4) completo', 'Precio': '~$8.600–10.000', 'Velocidad': '300+ tok/s', 'Nivel': 'Empresarial' },
            { 'GPU': 'Mac M5 Max 128GB', 'Mejor para': '70B (Q4)', 'Precio': '~$6.000', 'Velocidad': '~12–15 tok/s (70B)', 'Nivel': 'Portátil pro' },
            { 'GPU': '4× RTX 3090/4090 + 192GB RAM', 'Mejor para': 'GLM-5.3 (2 bits)', 'Precio': '~$6.000–9.000', 'Velocidad': '3–9 tok/s', 'Nivel': 'MoE extremo' },
          ],
          columns: ['GPU', 'Mejor para', 'Precio', 'Velocidad', 'Nivel'],
          callouts: [
            { type: 'warning', text: 'Los precios de GPU son volátiles y siguen empeorando. La escasez de GDDR7 ha empujado la RTX 5090 de un precio de calle de $4.300–$5.000+ — más del doble de su MSRP de $1.999 — y la descontinuada RTX 4090 ahora cuesta más usada de lo que costaba nueva. Los precios anteriores son cifras de calle típicas — comprueba siempre los anuncios actuales antes de comprar. La AMD RX 9070 XT, basada en GDDR6, es una excepción notable: ha evitado en gran medida el pico de precios.' },
          ],
        },
        vramMath: {
          id: 'vram-math',
        ...
        kvCache: {
          ...
          content: [
            ...
            '**Estas cifras asumen fp16 (2 bytes por elemento) para los tensores K y V.** Una caché KV cuantizada (por ejemplo, `--cache-type-k q8_0` en llama.cpp) usa aproximadamente la mitad de la VRAM mostrada en la tabla.',
          ],
          ...
          rows: [
            ...
            { 'Modelo': 'Llama 3.3 70B', 'Contexto 4K': '1.25 GB', 'Contexto 32K': '10 GB', 'Contexto 128K': '40 GB' },
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'Regla general: este porcentaje se reduce a medida que el modelo crece -- la caché KV escala con el número de capas, mientras que el tamaño de los pesos escala con el total de parámetros, y las capas crecen más lento que los parámetros a medida que los modelos aumentan de tamaño. Llama 3.1 8B (32 capas): una caché de contexto de 32K es de ~4 GB frente a ~4,7 GB de pesos en Q4_K_M (~85%). Llama 3.3 70B (80 capas): una caché de contexto de 32K es de ~10 GB frente a ~40 GB de pesos en Q4_K_M (~25%). El contexto por defecto de Ollama es de 2.048 tokens. Para ponerlo más alto: PARAMETER num_ctx 32768 en tu Modelfile.' },
          ],
        },
        gpuRecommendations: {
          id: 'gpu-recommendations',
          ...
          rows: [
            { 'Nivel': 'Económica (~$585)', 'GPU': 'RTX 5060 Ti', 'VRAM': '16 GB', 'Mejor para': 'Modelos de 7-13B', 'Velocidad': '~60 tok/s' },
            { 'Nivel': 'Mayoritaria (~$880)', 'GPU': 'RTX 5070', 'VRAM': '12 GB', 'Mejor para': 'Modelos de 7-14B', 'Velocidad': '~90 tok/s' },
            ...
            { 'Nivel': 'Tope (~$4.300–5.000+ de calle)', 'GPU': 'RTX 5090', 'VRAM': '32 GB', 'Mejor para': '70B (Q4, descarga ligera)', 'Velocidad': '~200 tok/s' },
          ...
          imageCaption: 'Recomendaciones de niveles de GPU (precios de calle): ~$585 RTX 5060 Ti (16GB, 7-13B, 60 tok/s), ~$880 RTX 5070 (12GB, 14B, 90 tok/s), ~$1.249 RTX 5080 (16GB, 14-32B, 130 tok/s), ~$4.300–5.000+ RTX 5090 (32GB, 70B, 200 tok/s), $4.699 DGX Spark (128GB, MoE grande). La elección de GPU importa 10× más que la CPU.',
        },
        vramTiers: {
          id: 'vram-tiers',
        ...
        modelsFor12GB: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'La RTX 3060 12GB es el punto de entrada económico (~$285 usada). Ejecuta todos los modelos de 12 GB pero a ~60-70 tok/seg frente a ~80-90 tok/seg en la RTX 4070 Ti debido a su arquitectura de memoria más antigua.' },
          ],
        },
        modelsFor24GB: {
          id: 'models-24gb',
        ...
        cpuOnlyInference: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'Realidad de velocidad CPU vs GPU: una NVIDIA RTX 3060 12 GB usada (~$285) ejecuta Llama 3.1 8B a más de 70 tok/seg -- 5-8× más rápido que el Ryzen 9 7950X en inferencia solo por CPU. Si la velocidad importa, compra una GPU antes de añadir RAM.' },
          ...
          imageCaption: 'Velocidades de inferencia solo por CPU en Ryzen 9 7950X: Gemma 2 2B Q8_0 (28 tok/seg, el más rápido), Phi-4 Mini Q4_K_M (25 tok/seg, mejor opción), Llama 3.1 8B Q8_0 (8 tok/seg). Una RTX 3060 usada ($285) logra 5-8× más rápido.',
        },
        storage: {
          id: 'storage',
        ...
        cantAffordHardware: {
          ...
          content: [
            'Si una GPU de $280–400 está fuera de tu presupuesto, o tu portátil es demasiado antiguo para soportar los motores de inferencia modernos, **puede que los LLM locales no sean rentables para ti en 2026**.',
        ...
        mac: {
          ...
          content: [
            ...
            'El M5 Max con 128 GB de memoria unificada (hasta 614 GB/s) ejecuta modelos de 70B en Q4_K_M con comodidad — aproximadamente 12-15 tok/seg — en un formato de portátil o Mac Studio. El M5 Pro (hasta 64 GB unificada, 307 GB/s) maneja modelos de 32B con margen generoso para la caché KV y la multitarea. Ten en cuenta que el M5 Max se queda muy corto frente a los ~239 GB que necesita GLM-5.3 incluso a 2 bits -- un área donde el techo de memoria unificada de Apple importa más que la velocidad bruta.',
            '**Apple renovó la gama Mac mini y Mac Studio el 25 de agosto de 2026, con envíos a partir del 22 de septiembre de 2026.** El Mac mini ahora llega en configuraciones M6 (desde $899, hasta 32 GB de memoria unificada, 170 GB/s) y M5 Pro (desde $1.699, hasta 64 GB, 307 GB/s). El Mac Studio sube a M5 Max (desde $2.499, hasta 128 GB) y M5 Ultra (desde $5.499 con 96 GB, hasta 256 GB o 512 GB en la configuración máxima -- el modelo de 512 GB llega a finales de octubre de 2026 y se espera que cueste bastante más de $10.000). El Mac mini M4 saliente (desde $599) y el Mac mini M4 Pro (hasta $2.299, 64 GB máximo), junto con el Mac Studio M4 Max / M3 Ultra anterior, pasan ahora a ser la generación previa.',
            'Todavía no existen benchmarks independientes de tok/seg para los chips M6 o M5 Ultra -- Apple no ha publicado cifras de inferencia verificadas por terceros para ninguno de los dos. Por primera vez, un solo Mac puede alojar teóricamente GLM-5.3 (744B MoE, ~239 GB en 2 bits) en memoria unificada: la configuración máxima del Mac Studio M5 Ultra de 512 GB supera ese requisito con margen de sobra. Hasta que existan benchmarks reales, una configuración con 4× RTX 3090/4090 sigue siendo la vía local mejor documentada para modelos de la clase GLM-5.3.',
          ...
          rows: [
            ...
            { 'Mac': 'Mac mini M6 (desde $899)', 'Memoria GPU': '32 GB unificada, 170 GB/s', 'Mejor para': 'Modelos de 8-14B', 'Limitación': 'Sin margen para 32B+' },
            { 'Mac': 'M5 Pro (MacBook Pro / Mac mini, desde $1.699)', 'Memoria GPU': '64 GB unificada, 307 GB/s', 'Mejor para': 'Modelos de 32B con comodidad', 'Limitación': 'Llama 4 Scout funciona bien' },
            { 'Mac': 'M5 Max (MacBook Pro / Studio, desde $2.499)', 'Memoria GPU': '128 GB unificada, hasta 614 GB/s', 'Mejor para': 'Modelos de 70B en Q4_K_M', 'Limitación': '~12-15 tok/seg en 70B' },
            { 'Mac': 'Mac Studio M5 Ultra (desde $5.499)', 'Memoria GPU': '96-512 GB unificada', 'Mejor para': '70B+ y MoE grandes', 'Limitación': '512 GB llega en oct. 2026; sin benchmarks aún' },
          ],
          columns: ['Mac', 'Memoria GPU', 'Mejor para', 'Limitación'],
          image: '/images/mac-hardware-comparison-es.svg',
          imageCaption: 'Comparación de hardware Mac: serie M 8 GB (modelos de 3-4B), M3 Pro 16" (18GB, 7-8B), Mac mini M6 (32GB, 8-14B, $899), M5 Pro (64GB, 32B, $1.699), M5 Max (128GB, 70B en Q4_K_M ~12-15 tok/seg, $2.499), Mac Studio M5 Ultra (hasta 512GB, capacidad para GLM-5.3, $5.499). 16 GB unificada es el mínimo cómodo para modelos de 7B en un Mac.',
        },
        serverVsConsumer: {
          id: 'server-vs-consumer',
          ...
          imageCaption: 'Hardware de consumo vs servidor: RTX 5090 (~$4.300–5.000+ de calle, 32GB, monousuario, tiempo parcial) vs RTX 6000 Ada ($7.000+, 48GB, multiusuario, servicio 24/7). Empieza con hardware de consumo; sube a grado servidor solo si ejecutas servicios de producción.',
        },
        dgxSpark: {
          id: 'dgx-spark',
          ...
          rows: [
            ...
            { 'Especificación': 'GLM-5.3 en 2 bits (~239 GB)', 'Valor': '❌ no cabe' },
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Ingeniería de prompts para LLM locales](/es/local-llms/prompt-engineering-for-local-models) -- optimiza prompts para las restricciones de los modelos locales',
        ...
        sources: {
          ...
          title: 'Fuentes',
          items: [
            'NVIDIA. (2026). "GeForce GPU Specifications." [www.nvidia.com/en-us/geforce/graphics-cards/](https://www.nvidia.com/en-us/geforce/graphics-cards/) -- Especificaciones oficiales de VRAM y ancho de banda para las GPU de la serie RTX 40 y RTX 50.',
            'Apple. (2026). "Apple M5 Chip." [www.apple.com/mac/](https://www.apple.com/mac/) -- Especificaciones del M5 Pro/Max, ancho de banda de memoria, afirmaciones de rendimiento de LLM. El M5 es el primer Mac que ejecuta cómodamente modelos de 70B en Q4_K_M.',
            'NVIDIA. (2025). "DGX Spark Product Page." [www.nvidia.com/en-us/products/workstations/dgx-spark/](https://www.nvidia.com/en-us/products/workstations/dgx-spark/) -- Especificaciones oficiales del superchip GB10 Grace Blackwell y los 128 GB de memoria unificada.',
            'Meta AI. (2024). "Llama 3.3 Model Card." [llama.meta.com/](https://llama.meta.com/) -- Especificaciones oficiales de Llama 3.3 70B y requisitos de VRAM.',
            'Meta AI. (2025). "Llama 4 Model Card." [llama.meta.com/](https://llama.meta.com/) -- Arquitectura MoE de Llama 4 Scout/Maverick, requisitos de VRAM.',
            'Z.ai. (2026). "GLM-5.3: Built for Long-Horizon Tasks." [huggingface.co/blog/zai-org/glm-52-blog](https://huggingface.co/blog/zai-org/glm-52-blog) -- Ficha oficial del modelo GLM-5.3: arquitectura MoE de 744B totales / 40B activos, licencia MIT, fecha de lanzamiento.',
          ],
        },
      },
schema: {
      ...
      itemListSchema: {
        ...
        'numberOfItems': 7,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'Económica (~$585)', 'description': 'RTX 5060 Ti con 16 GB de VRAM. Ejecuta modelos de 7-13B a ~60 tokens/seg. Mejor tarjeta nueva en relación calidad-precio.' },
          { '@type': 'ListItem', 'position': 2, 'name': 'Mayoritaria (~$880)', 'description': 'RTX 5070 con 12 GB de VRAM. Ejecuta modelos de 7-14B a ~90 tokens/seg. Mejor relación precio-rendimiento.' },
          ...
          { '@type': 'ListItem', 'position': 5, 'name': 'Tope (~$4.300–5.000+ de calle)', 'description': 'RTX 5090 con 32 GB de VRAM. Ejecuta un 70B en Q4_K_M con descarga ligera. ~200 tokens/seg. La escasez de memoria, que sigue empeorando, mantiene los precios muy por encima del MSRP de $1.999.' },
    ...
    ar: {
      ...
      quickAnswerTop: {
        ar: {
          ...
          answer: 'لتشغيل LLM محلي في 2026 تحتاج كحد أدنى إلى GPU بسعة 8 GB VRAM (NVIDIA RTX 5060 Ti أو Apple M2) لنماذج 7B، و12 GB لنماذج 14B، و16 GB لنماذج 24B، و24 GB لنماذج 32B، و40 GB+ لنماذج 70B. قاعدة سريعة: نموذج 7B عند Q4 يحتاج ~4-5 GB فقط -- نحو 0.6 GB لكل مليار معامل. تُعد Apple Silicon (M3/M4/M5) أفضل قيمة لمعظم المستخدمين بفضل الذاكرة الموحدة.',
          bullets: [
            ...
            'GLM-5.3 (744B MoE، 40B نشط): ~239 GB حتى عند تكميم 2-بت — يحتاج نظام 4× RTX 3090/4090 بذاكرة نظام 192 GB+ أو Mac Studio بسعة 512 GB (M5 Ultra)',
          ],
          updatedDate: '2026-09-01',
        },
      },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '**CPU فقط (ذاكرة نظام 16 GB)**: Llama 3.2 3B Q8 (20 tok/sec) أو Phi-4 Mini Q4_K_M (25 tok/sec). بطاقة RTX 4060 8 GB مستعملة (~$280) أو RTX 5060 Ti 16 GB جديدة (~$585) أسرع 5-10×.',
            ...
            '**الأسعار الحالية**: ارتفع سعر RTX 5090 في السوق إلى ما يفوق $4,300-$5,000+، ولا يزال يرتفع، بسبب استمرار نقص GDDR7 وإيقاف RTX 4090. بديل أرخص إلى حد كبير غير متأثر تقريبًا بالنقص: AMD RX 9070 XT (16 GB GDDR6، ~$690–740). اشترِ من سلسلة RTX 50 المتوفرة في المخزون أو فكّر في بطاقة AMD؛ تحقق من الأسعار الحية قبل الشراء.',
        ...
        bestGPUs: {
          ...
          items: [
            '**لنماذج 7B (Mistral، Phi-4، Llama 3.1) — اقتصادية:** RTX 5060 Ti 16 GB (~$585، أي نحو 40% فوق سعره المُعلن البالغ 429 دولاراً) أو RTX 4060 8 GB مستعملة (~$280). تشغّل أي نموذج 7B عند Q4_K_M. السرعة: 50–70 tok/sec. المستوى: الهواة الاقتصاديون.',
            '**لنماذج 14B (Qwen3 14B، DeepSeek-R1) — السائد:** RTX 5070 (12 GB، ~$880). أفضل بطاقة جديدة من حيث السعر مقابل الأداء. يعمل Qwen3 14B Q4_K_M جيدًا مع هامش. السرعة: 85–110 tok/sec. المستوى: الأكثر شعبية.',
            '**لنماذج 24-32B (Qwen3.6، Mistral Small) — المتوسط:** RTX 5070 Ti (16 GB، ~$979) أو RTX 5080 (16 GB، ~$1,450). تشغّل Mistral Small 3.1 24B وDevstral Small 24B Q4_K_M. السرعة: 110–150 tok/sec. المستوى: المطورون المحترفون. بديل اقتصادي: AMD RX 9070 XT (16 GB GDDR6، ~$690–740) يشغّل نفس النماذج بسرعة مشابهة تقريبًا وهو غير متأثر تقريبًا بنقص GDDR7.',
            ...
            '**لـ GLM-5.3 (744B MoE، 40B نشط) — أقصى درجة:** لا توجد بطاقة GPU استهلاكية واحدة كافية. لا يزال GGUF الديناميكي بتكميم 2-بت يحتاج ~239 GB VRAM/RAM مجتمعة. المسارات المحلية الواقعية: نظام 4× RTX 3090/4090 بذاكرة نظام 192 GB+، أو Mac Studio بسعة 512 GB (M5 Ultra)، وكلاهما بسرعة تقارب 3-9 tok/sec عبر إزاحة هجينة CPU/GPU.',
          ...
          rows: [
            { 'GPU': 'RTX 5060 Ti (16 GB)', 'الأفضل لـ': 'نماذج 7-13B', 'السعر': '~$585', 'السرعة': '50–70 tok/s', 'المستوى': 'اقتصادية' },
            { 'GPU': 'RTX 5070 (12 GB)', 'الأفضل لـ': 'نماذج 14B', 'السعر': '~$880', 'السرعة': '85–110 tok/s', 'المستوى': 'سائد' },
            { 'GPU': 'RTX 5070 Ti / 5080 (16 GB)', 'الأفضل لـ': 'نماذج 24-32B', 'السعر': '~$979–1,249', 'السرعة': '110–150 tok/s', 'المستوى': 'احترافي' },
            { 'GPU': 'RX 9070 XT (16 GB)', 'الأفضل لـ': 'نماذج 24-32B', 'السعر': '~$690–740', 'السرعة': '90–130 tok/s', 'المستوى': 'بديل اقتصادي' },
            { 'GPU': 'RTX 4090 (24 GB، مستعملة)', 'الأفضل لـ': '32B، 70B (Q2)', 'السعر': '~$2,300', 'السرعة': '150–180 tok/s', 'المستوى': 'EOL / مستعملة' },
            { 'GPU': 'RTX 5090 (32 GB)', 'الأفضل لـ': '70B (Q4، إزاحة خفيفة)', 'السعر': '~$2,000 MSRP (~$4,300–5,000+ في السوق)', 'السرعة': '~200 tok/s', 'المستوى': 'راقٍ' },
            { 'GPU': 'RTX 5090 مزدوجة', 'الأفضل لـ': '70B (Q4) كامل', 'السعر': '~$8,600–10,000', 'السرعة': '300+ tok/s', 'المستوى': 'مؤسسي' },
            { 'GPU': '4× RTX 3090/4090 + 192GB RAM', 'الأفضل لـ': 'GLM-5.3 (2-بت)', 'السعر': '~$6,000–9,000', 'السرعة': '3–9 tok/s', 'المستوى': 'MoE أقصى' },
        ...
        kvCache: {
          ...
          content: [
            ...
            '**تفترض هذه الأرقام دقة fp16 (2 بايت لكل عنصر) لموترات K وV.** يستخدم KV cache المكمَّم (مثل `--cache-type-k q8_0` في llama.cpp) نصف VRAM تقريبًا مقارنة بالأرقام الموضحة في الجدول.',
          ],
          columns: ['النموذج', 'سياق 4K', 'سياق 32K', 'سياق 128K'],
          rows: [
            { 'النموذج': 'Llama 3.1 8B', 'سياق 4K': '0.5 GB', 'سياق 32K': '4 GB', 'سياق 128K': '16 GB' },
            { 'النموذج': 'Llama 3.3 70B', 'سياق 4K': '1.25 GB', 'سياق 32K': '10 GB', 'سياق 128K': '40 GB' },
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'قاعدة عامة: تتقلص هذه النسبة كلما زاد حجم النموذج -- يتناسب حجم KV cache مع عدد الطبقات، بينما يتناسب حجم أوزان النموذج مع إجمالي المعاملات، وتنمو الطبقات بمعدل أبطأ من المعاملات كلما كبرت النماذج. Llama 3.1 8B (32 طبقة): ذاكرة تخزين مؤقت لسياق 32K تبلغ ~4 GB مقابل ~4.7 GB من أوزان Q4_K_M (~85%). Llama 3.3 70B (80 طبقة): ذاكرة تخزين مؤقت لسياق 32K تبلغ ~10 GB مقابل ~40 GB من أوزان Q4_K_M (~25%). السياق الافتراضي لـ Ollama هو 2,048 رمزًا. لضبط قيمة أعلى: PARAMETER num_ctx 32768 في Modelfile الخاص بك.' },
          ],
        },
        gpuRecommendations: {
          id: 'gpu-recommendations',
          ...
          rows: [
            { 'المستوى': 'اقتصادية (~$585)', 'GPU': 'RTX 5060 Ti', 'VRAM': '16 GB', 'الأفضل لـ': 'نماذج 7-13B', 'السرعة': '~60 tok/s' },
            { 'المستوى': 'سائد (~$880)', 'GPU': 'RTX 5070', 'VRAM': '12 GB', 'الأفضل لـ': 'نماذج 7-14B', 'السرعة': '~90 tok/s' },
            { 'المستوى': 'متوسط (~$979)', 'GPU': 'RTX 5070 Ti', 'VRAM': '16 GB', 'الأفضل لـ': 'نماذج 14-32B', 'السرعة': '~110 tok/s' },
            { 'المستوى': 'عالٍ (~$1,450)', 'GPU': 'RTX 5080', 'VRAM': '16 GB', 'الأفضل لـ': 'نماذج 14-32B', 'السرعة': '~130 tok/s' },
            { 'المستوى': 'الأعلى (~$4,300–5,000+ في السوق)', 'GPU': 'RTX 5090', 'VRAM': '32 GB', 'الأفضل لـ': '70B (Q4، إزاحة خفيفة)', 'السرعة': '~200 tok/s' },
          ...
          imageCaption: 'توصيات مستويات GPU (أسعار السوق): ~$585 RTX 5060 Ti (16GB، 7-13B، 60 tok/s)، ~$880 RTX 5070 (12GB، 14B، 90 tok/s)، ~$1,450 RTX 5080 (16GB، 14-32B، 130 tok/s)، ~$4,300–5,000+ RTX 5090 (32GB، 70B، 200 tok/s)، $4,699 DGX Spark (128GB، MoE كبير). اختيار GPU يهم 10× أكثر من CPU.',
        },
        vramTiers: {
          id: 'vram-tiers',
        ...
        modelsFor12GB: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'RTX 3060 12GB هي نقطة الدخول الاقتصادية (~$285 مستعملة). تشغّل جميع نماذج 12 GB لكن بسرعة ~60-70 tok/sec مقابل ~80-90 tok/sec على RTX 4070 Ti بسبب بنية الذاكرة الأقدم.' },
          ],
        },
        modelsFor24GB: {
          id: 'models-24gb',
        ...
        cpuOnlyInference: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'واقع سرعة CPU مقابل GPU: تشغّل NVIDIA RTX 3060 12 GB مستعملة (~$285) نموذج Llama 3.1 8B بسرعة 70+ tok/sec -- أسرع 5-8× من Ryzen 9 7950X في الاستدلال على CPU فقط. إذا كانت السرعة مهمة، اشترِ GPU قبل إضافة ذاكرة.' },
          ...
          imageCaption: 'سرعات الاستدلال على CPU فقط بمعالج Ryzen 9 7950X: Gemma 2 2B Q8_0 (28 tok/sec الأسرع)، Phi-4 Mini Q4_K_M (25 tok/sec أفضل خيار)، Llama 3.1 8B Q8_0 (8 tok/sec). تحقق RTX 3060 مستعملة ($285) سرعة أعلى 5-8×.',
        },
        storage: {
          id: 'storage',
        ...
        cantAffordHardware: {
          ...
          content: [
            'إذا كانت GPU بسعر $280–400 خارج ميزانيتك، أو كان حاسوبك المحمول قديمًا جدًا لدعم محركات الاستدلال الحديثة، **فقد لا تكون نماذج LLM المحلية فعّالة من حيث التكلفة لك في 2026**.',
        ...
        mac: {
          ...
          content: [
            ...
            'يشغّل M5 Max بذاكرة موحدة 128 GB (حتى 614 GB/s) نماذج 70B عند Q4_K_M بشكل مريح — نحو 12-15 tok/sec — في حاسوب محمول أو بشكل Mac Studio. يتعامل M5 Pro (حتى 64 GB موحدة، 307 GB/s) مع نماذج 32B بهامش سخي لـ KV cache وتعدد المهام. يُلاحَظ أن M5 Max لا يزال بعيدًا كل البعد عن احتياجات GLM-5.3 البالغة ~239 GB حتى عند تكميم 2-بت -- وهذا مجال تكون فيه سعة الذاكرة الموحدة لدى Apple أهم من السرعة الخام.',
            '**جدّدت Apple تشكيلة Mac mini وMac Studio في 25 أغسطس 2026، مع الشحن اعتبارًا من 22 سبتمبر 2026.** يأتي Mac mini الآن بإصدارَي M6 (من $899، حتى 32 GB ذاكرة موحدة، 170 GB/s) وM5 Pro (من $1,699، حتى 64 GB، 307 GB/s). ويرتقي Mac Studio إلى M5 Max (من $2,499، حتى 128 GB) وM5 Ultra (من $5,499 بذاكرة 96 GB، وحتى 256 GB أو 512 GB في أعلى تكوين -- علمًا أن نسخة 512 GB تشحن أواخر أكتوبر 2026 ويُتوقع أن يتجاوز سعرها $10,000 بوضوح). أصبح Mac mini M4 السابق (من $599) وMac mini M4 Pro (حتى $2,299، بحد أقصى 64 GB)، إلى جانب Mac Studio M4 Max / M3 Ultra السابق، هي الجيل السابق الآن.',
            'لا توجد بعد قياسات أداء (tok/sec) مستقلة لشريحتَي M6 أو M5 Ultra -- لم تنشر Apple بعد أرقام استدلال موثقة من جهات خارجية لأي منهما. ولأول مرة، يمكن نظريًا لجهاز Mac واحد استيعاب GLM-5.3 (744B MoE، حوالي 239 GB عند تكميم 2-بت) في الذاكرة الموحدة: يتجاوز أعلى تكوين لـ Mac Studio M5 Ultra بسعة 512 GB هذا المتطلب بهامش واسع. وإلى حين ظهور قياسات أداء واقعية، يظل نظام 4× RTX 3090/4090 هو المسار المحلي الأفضل توثيقًا لنماذج من فئة GLM-5.3.',
          ...
          rows: [
            ...
            { 'Mac': 'Mac mini M6 (من $899)', 'ذاكرة GPU': '32 GB موحدة، 170 GB/s', 'الأفضل لـ': 'نماذج 8-14B', 'القيد': 'لا هامش لنماذج 32B+' },
            { 'Mac': 'M5 Pro (MacBook Pro / Mac mini، من $1,699)', 'ذاكرة GPU': '64 GB موحدة، 307 GB/s', 'الأفضل لـ': 'نماذج 32B بشكل مريح', 'القيد': 'يعمل Llama 4 Scout جيدًا' },
            { 'Mac': 'M5 Max (MacBook Pro / Studio، من $2,499)', 'ذاكرة GPU': '128 GB موحدة، حتى 614 GB/s', 'الأفضل لـ': 'نماذج 70B عند Q4_K_M', 'القيد': '~12-15 tok/sec على 70B' },
            { 'Mac': 'Mac Studio M5 Ultra (من $5,499)', 'ذاكرة GPU': '96-512 GB موحدة', 'الأفضل لـ': '70B+ ونماذج MoE كبيرة', 'القيد': '512 GB تشحن أكتوبر 2026؛ لا قياسات بعد' },
          ],
          columns: ['Mac', 'ذاكرة GPU', 'الأفضل لـ', 'القيد'],
          image: '/images/mac-hardware-comparison-ar.svg',
          imageCaption: 'مقارنة عتاد Mac: سلسلة M بذاكرة 8 GB (نماذج 3-4B)، M3 Pro 16" (18GB، 7-8B)، Mac mini M6 (32GB، 8-14B، $899)، M5 Pro (64GB، 32B، $1,699)، M5 Max (128GB، 70B عند Q4_K_M ~12-15 tok/sec، $2,499)، Mac Studio M5 Ultra (حتى 512GB، سعة لـ GLM-5.3، $5,499). 16 GB موحدة هو الحد الأدنى المريح لنماذج 7B على Mac.',
        },
        serverVsConsumer: {
          id: 'server-vs-consumer',
        ...
        dgxSpark: {
          ...
          rows: [
            ...
            { 'المواصفة': 'GLM-5.3 عند تكميم 2-بت (~239 GB)', 'القيمة': '❌ لا يتسع' },
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'هل لا تزال RTX 3060 12GB تستحق العناء لنماذج LLM المحلية في 2026؟', a: 'RTX 3060 (12 GB) قديمة (بنية 2021). تتعامل مع نماذج 7B-13B عند Q4 لكنها تنتج 40-60 رمز/ثانية. مستعملة تُباع بـ ~$285؛ RTX 5070 جديدة (~$880) أو RTX 5060 Ti 16 GB (~$585) تعمل أسرع 2-3×. RTX 3060 تستحق الاحتفاظ بها فقط كـ GPU ثانوية لإعدادات متعددة البطاقات.' },
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[هندسة الموجهات لنماذج LLM المحلية](/ar/local-llms/prompt-engineering-for-local-models) -- حسّن الموجهات لقيود النماذج المحلية',
        ...
        sources: {
          ...
          title: 'المصادر',
          items: [
            'NVIDIA. (2026). "GeForce GPU Specifications." [www.nvidia.com/en-us/geforce/graphics-cards/](https://www.nvidia.com/en-us/geforce/graphics-cards/) -- مواصفات VRAM وعرض النطاق الرسمية لبطاقات RTX 40-series وRTX 50-series.',
            'Apple. (2026). "Apple M5 Chip." [www.apple.com/mac/](https://www.apple.com/mac/) -- مواصفات M5 Pro/Max، عرض نطاق الذاكرة، ادعاءات أداء LLM. M5 هو أول Mac يشغّل نماذج 70B عند Q4_K_M بشكل مريح.',
            'NVIDIA. (2025). "DGX Spark Product Page." [www.nvidia.com/en-us/products/workstations/dgx-spark/](https://www.nvidia.com/en-us/products/workstations/dgx-spark/) -- مواصفات رسمية لشريحة GB10 Grace Blackwell Superchip والذاكرة الموحدة 128 GB.',
            'Meta AI. (2024). "Llama 3.3 Model Card." [llama.meta.com/](https://llama.meta.com/) -- مواصفات Llama 3.3 70B الرسمية ومتطلبات VRAM.',
            'Meta AI. (2025). "Llama 4 Model Card." [llama.meta.com/](https://llama.meta.com/) -- بنية Llama 4 Scout/Maverick MoE، متطلبات VRAM.',
            'Z.ai. (2026). "GLM-5.3: Built for Long-Horizon Tasks." [huggingface.co/blog/zai-org/glm-52-blog](https://huggingface.co/blog/zai-org/glm-52-blog) -- بطاقة نموذج GLM-5.3 الرسمية: بنية MoE بـ744B إجمالي / 40B نشط، ترخيص MIT، تاريخ الإصدار.',
          ],
        },
      },
schema: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'RTX 3060 (12 GB) قديمة (بنية 2021). تتعامل مع نماذج 7B-13B عند Q4 لكنها تنتج 40-60 رمز/ثانية. مستعملة تُباع بـ ~$285؛ RTX 5070 جديدة (~$880) أو RTX 5060 Ti 16 GB (~$585) تعمل أسرع 2-3×. RTX 3060 تستحق الاحتفاظ بها فقط كـ GPU ثانوية لإعدادات متعددة البطاقات.',
            },
          },
          {
            '@type': 'Question',
      ...
      itemListSchema: {
        ...
        'numberOfItems': 7,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'اقتصادية (~$585)', 'description': 'RTX 5060 Ti بسعة 16 GB VRAM. تشغّل نماذج 7-13B بسرعة ~60 رمز/ثانية. أفضل قيمة لبطاقة جديدة.' },
          { '@type': 'ListItem', 'position': 2, 'name': 'سائد (~$880)', 'description': 'RTX 5070 بسعة 12 GB VRAM. تشغّل نماذج 7-14B بسرعة ~90 رمز/ثانية. أفضل سعر مقابل أداء.' },
          ...
          { '@type': 'ListItem', 'position': 4, 'name': 'عالٍ (~$1,450)', 'description': 'RTX 5080 بسعة 16 GB VRAM. تشغّل نماذج 14-32B بسرعة ~130 رمز/ثانية. موصى به.' },
          { '@type': 'ListItem', 'position': 5, 'name': 'الأعلى (~$4,300–5,000+ في السوق)', 'description': 'RTX 5090 بسعة 32 GB VRAM. تشغّل 70B عند Q4_K_M بإزاحة خفيفة. ~200 رمز/ثانية. نقص الذاكرة المتفاقم يبقي الأسعار فوق MSRP البالغ $1,999 بكثير.' },
    ...
    pt: {
      ...
      quickAnswerTop: {
        pt: {
          ...
          answer: 'Para rodar um LLM local em 2026 você precisa, no mínimo, de uma GPU com 8 GB de VRAM (NVIDIA RTX 5060 Ti ou Apple M2) para modelos 7B, 12 GB para modelos 14B, 16 GB para modelos 24B, 24 GB para modelos 32B, e 40 GB+ para modelos 70B. Regra prática para quantização de 4 bits: VRAM em GB ≈ parâmetros em bilhões × 0,6 — um modelo 7B precisa de cerca de 4-5 GB. O Apple Silicon (M3/M4/M5) é o melhor custo-benefício para a maioria dos usuários graças à memória unificada. Modelos MoE de fronteira e pesos abertos como o GLM-5.3 (744B no total) são a exceção — precisam de ~239 GB mesmo em quantização agressiva de 2 bits, além de qualquer GPU de consumo única ou da DGX Spark de 128 GB.',
          bullets: [
            'Modelos 7B (Mistral, Phi-4 Mini): 4-5 GB de VRAM em Q4_K_M (placa de 8 GB recomendada) — RTX 5060 Ti, RTX 4060, Mac M2',
            ...
            'GLM-5.3 (744B MoE, 40B ativos): ~239 GB mesmo em 2 bits — precisa de uma configuração com 4× RTX 3090/4090 e 192 GB+ de RAM ou um Mac Studio de 512 GB (M5 Ultra)',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'O hardware para LLMs locais é determinado pela VRAM: modelos 7B precisam de 8 GB, 13–14B precisam de 12–16 GB, e modelos 70B precisam de 35–48 GB — uma RTX 4060 8 GB usada (~US$280) é a melhor GPU de entrada em 2026.' },
          ...
          items: [
            ...
            '**Apenas CPU (16 GB de RAM do sistema)**: Llama 3.2 3B Q8 (20 tok/sec) ou Phi-4 Mini Q4_K_M (25 tok/sec). Uma RTX 4060 8 GB usada (~$280) ou uma RTX 5060 Ti 16 GB nova (~$585) é 5-10× mais rápida.',
            ...
            '**Preços atuais**: a escassez de GDDR7 piorou, não melhorou — o preço de rua da RTX 5090 subiu para $4.300–$5.000+, e a RTX 4090 continua descontinuada. Compradores com orçamento apertado também devem considerar a RX 9070 XT da AMD (16 GB GDDR6, ~$690–740) — a GDDR6 escapou da maior parte da escassez, tornando-a visivelmente mais barata que a RTX 5070 Ti com VRAM similar. Compre de anúncios em estoque; verifique os preços ao vivo antes da compra.',
        ...
        bestGPUs: {
          ...
          items: [
            '**Para Modelos 7B (Mistral, Phi-4, Llama 3.1) — Econômica:** RTX 5060 Ti 16 GB (~$585, cerca de 40% acima do preço de tabela de US$ 429) ou uma RTX 4060 8 GB usada (~$280). Roda qualquer modelo 7B em Q4_K_M (~4-5 GB). Velocidade: 50–70 tok/sec. Faixa: Entusiastas econômicos.',
            '**Para Modelos 14B (Qwen3 14B, DeepSeek-R1) — Mainstream:** RTX 5070 (12 GB, ~$880). Melhor placa nova em custo-benefício. O Qwen3 14B Q4_K_M roda bem com folga. Velocidade: 85–110 tok/sec. Faixa: Mais popular.',
            '**Para Modelos 24-32B (Qwen3.6, Mistral Small) — Intermediária:** RTX 5070 Ti (16 GB, ~$979) ou RTX 5080 (16 GB, ~$1,450). Roda Mistral Small 3.1 24B e Devstral Small 24B Q4_K_M. Velocidade: 110–150 tok/sec. Faixa: Desenvolvedores profissionais. Alternativa econômica: AMD RX 9070 XT (16 GB GDDR6, ~$690–740) — a GDDR6 escapou em grande parte da escassez, então agora ela custa $150–250 a menos que a RTX 5070 Ti com VRAM similar, embora o ROCm tenha suporte de ferramentas para LLM local mais limitado que o CUDA.',
          ...
          rows: [
            { 'GPU': 'RTX 5060 Ti (16 GB)', 'Melhor Para': 'modelos 7-13B', 'Preço': '~$585', 'Velocidade': '50–70 tok/s', 'Faixa': 'Econômica' },
            { 'GPU': 'RTX 5070 (12 GB)', 'Melhor Para': 'modelos 14B', 'Preço': '~$880', 'Velocidade': '85–110 tok/s', 'Faixa': 'Mainstream' },
            { 'GPU': 'RX 9070 XT (16 GB)', 'Melhor Para': 'modelos 24-32B', 'Preço': '~$690–740', 'Velocidade': '90–130 tok/s', 'Faixa': 'Alternativa econômica' },
        ...
        kvCache: {
          ...
          content: [
            ...
            '**Esses valores assumem fp16 (2 bytes por elemento) para os tensores K e V.** Um cache KV quantizado (por exemplo, `--cache-type-k q8_0` no llama.cpp) usa aproximadamente metade da VRAM mostrada na tabela.',
          ],
          columns: ['Modelo', 'contexto 4K', 'contexto 32K', 'contexto 128K'],
          rows: [
            { 'Modelo': 'Llama 3.1 8B', 'contexto 4K': '0.5 GB', 'contexto 32K': '4 GB', 'contexto 128K': '16 GB' },
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'Regra geral: essa porcentagem diminui à medida que o modelo cresce -- o cache KV escala com o número de camadas, enquanto o tamanho dos pesos do modelo escala com o total de parâmetros, e as camadas crescem mais devagar que os parâmetros conforme os modelos ficam maiores. Llama 3.1 8B (32 camadas): um cache de contexto de 32K é de ~4 GB contra ~4,7 GB de pesos em Q4_K_M (~85%). Llama 3.3 70B (80 camadas): um cache de contexto de 32K é de ~10 GB contra ~40 GB de pesos em Q4_K_M (~25%). O contexto padrão do Ollama é 2.048 tokens. Para definir um valor maior: PARAMETER num_ctx 32768 no seu Modelfile.' },
          ],
        },
        gpuRecommendations: {
          id: 'gpu-recommendations',
          ...
          rows: [
            { 'Faixa': 'Econômica (~$585)', 'GPU': 'RTX 5060 Ti', 'VRAM': '16 GB', 'Melhor Para': 'modelos 7-13B', 'Velocidade': '~60 tok/s' },
            { 'Faixa': 'Mainstream (~$880)', 'GPU': 'RTX 5070', 'VRAM': '12 GB', 'Melhor Para': 'modelos 7-14B', 'Velocidade': '~90 tok/s' },
            { 'Faixa': 'Intermediária (~$979)', 'GPU': 'RTX 5070 Ti', 'VRAM': '16 GB', 'Melhor Para': 'modelos 14-32B', 'Velocidade': '~110 tok/s' },
            { 'Faixa': 'Alta (~$1,450)', 'GPU': 'RTX 5080', 'VRAM': '16 GB', 'Melhor Para': 'modelos 14-32B', 'Velocidade': '~130 tok/s' },
            { 'Faixa': 'Topo (~$4,300–5,000+ de rua)', 'GPU': 'RTX 5090', 'VRAM': '32 GB', 'Melhor Para': '70B (Q4, leve offload)', 'Velocidade': '~200 tok/s' },
          ...
          imageCaption: 'Recomendações de faixas de GPU (preços de rua): ~$585 RTX 5060 Ti (16GB, 7-13B, 60 tok/s), ~$880 RTX 5070 (12GB, 14B, 90 tok/s), ~$1,450 RTX 5080 (16GB, 14-32B, 130 tok/s), ~$4,300–5,000+ RTX 5090 (32GB, 70B, 200 tok/s), $4,699 DGX Spark (128GB, grande MoE). A escolha da GPU importa 10× mais que a CPU.',
        },
        vramTiers: {
          id: 'vram-tiers',
        ...
        modelsFor12GB: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'A RTX 3060 12GB é o ponto de entrada econômico (~$285 usada). Ela roda todos os modelos de 12 GB, mas a ~60-70 tok/sec vs ~80-90 tok/sec na RTX 4070 Ti, devido à arquitetura de memória mais antiga.' },
          ],
        },
        modelsFor24GB: {
          id: 'models-24gb',
        ...
        cpuOnlyInference: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'Realidade de velocidade CPU vs GPU: Uma NVIDIA RTX 3060 12 GB usada (~$285) roda o Llama 3.1 8B a 70+ tok/sec -- 5-8× mais rápido que o Ryzen 9 7950X em inferência apenas por CPU. Se a velocidade importa, compre uma GPU antes de adicionar RAM.' },
          ...
          imageCaption: 'Velocidades de inferência apenas por CPU no Ryzen 9 7950X: Gemma 2 2B Q8_0 (28 tok/sec mais rápido), Phi-4 Mini Q4_K_M (25 tok/sec melhor escolha), Llama 3.1 8B Q8_0 (8 tok/sec). Uma RTX 3060 usada ($285) atinge 5-8× mais rápido.',
        },
        storage: {
          id: 'storage',
        ...
        cantAffordHardware: {
          ...
          content: [
            'Se uma GPU de $280–400 está fora do seu orçamento, ou seu laptop é antigo demais para suportar motores de inferência modernos, **os LLMs locais podem não ser custo-efetivos para você em 2026**.',
        ...
        mac: {
          ...
          content: [
            ...
            'O M5 Max com 128 GB de memória unificada (até 614 GB/s) roda modelos 70B em Q4_K_M confortavelmente — cerca de 12-15 tok/sec — em formato de laptop ou Mac Studio. O M5 Pro (até 64 GB unificada, 307 GB/s) lida com modelos 32B com folga generosa para cache KV e multitarefa. Vale notar que o M5 Max ainda fica bem aquém dos ~239 GB que o GLM-5.3 precisa mesmo em 2 bits -- uma área em que o teto de memória unificada da Apple pesa mais que a velocidade bruta.',
            '**A Apple renovou a linha Mac mini e Mac Studio em 25 de agosto de 2026, com envios a partir de 22 de setembro de 2026.** O Mac mini agora vem nas configurações M6 (a partir de $899, até 32 GB de memória unificada, 170 GB/s) e M5 Pro (a partir de $1.699, até 64 GB, 307 GB/s). O Mac Studio sobe para M5 Max (a partir de $2.499, até 128 GB) e M5 Ultra (a partir de $5.499 com 96 GB, até 256 GB ou 512 GB na configuração máxima -- a versão de 512 GB chega no fim de outubro de 2026 e deve custar bem acima de $10.000). O Mac mini M4 anterior (a partir de $599) e o Mac mini M4 Pro (até $2.299, 64 GB no máximo), junto com o Mac Studio M4 Max / M3 Ultra anterior, agora são a geração antiga.',
            'Ainda não existem benchmarks independentes de tok/sec para os chips M6 ou M5 Ultra -- a Apple não publicou números de inferência verificados por terceiros para nenhum dos dois até o momento. Pela primeira vez, um único Mac pode comportar teoricamente o GLM-5.3 (744B MoE, ~239 GB em 2 bits) em memória unificada: a configuração máxima do Mac Studio M5 Ultra de 512 GB supera essa necessidade com folga. Até que existam benchmarks reais, uma configuração com 4× RTX 3090/4090 continua sendo o caminho local mais bem documentado para modelos da classe GLM-5.3.',
          ...
          rows: [
            ...
            { 'Mac': 'Mac mini M6 (a partir de $899)', 'Memória de GPU': '32 GB unificada, 170 GB/s', 'Melhor Para': 'modelos 8-14B', 'Limitação': 'Sem folga para 32B+' },
            { 'Mac': 'M5 Pro (MacBook Pro / Mac mini, a partir de $1.699)', 'Memória de GPU': '64 GB unificada, 307 GB/s', 'Melhor Para': 'modelos 32B confortavelmente', 'Limitação': 'O Llama 4 Scout roda bem' },
            { 'Mac': 'M5 Max (MacBook Pro / Studio, a partir de $2.499)', 'Memória de GPU': '128 GB unificada, até 614 GB/s', 'Melhor Para': 'modelos 70B em Q4_K_M', 'Limitação': '~12-15 tok/sec em 70B' },
            { 'Mac': 'Mac Studio M5 Ultra (a partir de $5.499)', 'Memória de GPU': '96-512 GB unificada', 'Melhor Para': '70B+ e MoE grandes', 'Limitação': '512 GB chega em out. 2026; sem benchmarks ainda' },
          ],
          columns: ['Mac', 'Memória de GPU', 'Melhor Para', 'Limitação'],
          image: '/images/mac-hardware-comparison-pt.svg',
          imageCaption: 'Comparação de hardware Mac: série M 8 GB (modelos 3-4B), M3 Pro 16" (18GB, 7-8B), Mac mini M6 (32GB, 8-14B, $899), M5 Pro (64GB, 32B, $1.699), M5 Max (128GB, 70B em Q4_K_M ~12-15 tok/sec, $2.499), Mac Studio M5 Ultra (até 512GB, capacidade para GLM-5.3, $5.499). 16 GB unificada é o mínimo confortável para modelos 7B em um Mac.',
        },
        serverVsConsumer: {
          id: 'server-vs-consumer',
          ...
          imageCaption: 'Hardware de consumidor vs servidor: RTX 5090 (~$4,300–5,000+ de rua, 32GB, monousuário, meio período) vs RTX 6000 Ada ($7,000+, 48GB, multiusuário, regime 24/7). Comece com hardware de consumo; migre para nível servidor apenas se rodar serviços de produção.',
        },
        dgxSpark: {
          id: 'dgx-spark',
          ...
          rows: [
            ...
            { 'Especificação': 'GLM-5.3 em 2-bit (~239 GB)', 'Valor': '❌ não cabe' },
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Engenharia de Prompt para LLMs Locais](/pt/local-llms/prompt-engineering-for-local-models) -- otimize prompts para as restrições de modelos locais',
        ...
        sources: {
          ...
          title: 'Fontes',
          items: [
            'NVIDIA. (2026). "GeForce GPU Specifications." [www.nvidia.com/en-us/geforce/graphics-cards/](https://www.nvidia.com/en-us/geforce/graphics-cards/) -- Especificações oficiais de VRAM e largura de banda para as GPUs RTX série 40 e RTX série 50.',
            'Apple. (2026). "Apple M5 Chip." [www.apple.com/mac/](https://www.apple.com/mac/) -- Especificações do M5 Pro/Max, largura de banda de memória, alegações de desempenho de LLM. O M5 é o primeiro Mac que roda confortavelmente modelos 70B em Q4_K_M.',
            'NVIDIA. (2025). "DGX Spark Product Page." [www.nvidia.com/en-us/products/workstations/dgx-spark/](https://www.nvidia.com/en-us/products/workstations/dgx-spark/) -- Especificações oficiais do Superchip GB10 Grace Blackwell e dos 128 GB de memória unificada.',
            'Meta AI. (2024). "Llama 3.3 Model Card." [llama.meta.com/](https://llama.meta.com/) -- Especificações oficiais e requisitos de VRAM do Llama 3.3 70B.',
            'Meta AI. (2025). "Llama 4 Model Card." [llama.meta.com/](https://llama.meta.com/) -- Arquitetura MoE do Llama 4 Scout/Maverick, requisitos de VRAM.',
            'Z.ai. (2026). "GLM-5.3: Built for Long-Horizon Tasks." [huggingface.co/blog/zai-org/glm-52-blog](https://huggingface.co/blog/zai-org/glm-52-blog) -- Ficha oficial do modelo GLM-5.3: arquitetura MoE de 744B total / 40B ativos, licença MIT, data de lançamento.',
          ],
        },
      },
schema: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'A RTX 3060 (12 GB) está datada (arquitetura de 2021). Ela lida com modelos 7B-13B em Q4 mas produz 40-60 tokens/sec. Uma usada custa ~$285; uma RTX 5070 nova (~$880) ou RTX 5060 Ti 16 GB (~$585) roda 2-3× mais rápido. A RTX 3060 só vale a pena manter como GPU secundária para configurações com múltiplas placas.',
            },
          },
          {
            '@type': 'Question',
      ...
      itemListSchema: {
        ...
        'numberOfItems': 7,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'Econômica (~$585)', 'description': 'RTX 5060 Ti com 16 GB de VRAM. Roda modelos 7-13B a ~60 tokens/sec. Melhor custo-benefício em placa nova.' },
          { '@type': 'ListItem', 'position': 2, 'name': 'Mainstream (~$880)', 'description': 'RTX 5070 com 12 GB de VRAM. Roda modelos 7-14B a ~90 tokens/sec. Melhor custo-benefício.' },
          ...
          { '@type': 'ListItem', 'position': 4, 'name': 'Alta (~$1,450)', 'description': 'RTX 5080 com 16 GB de VRAM. Roda modelos 14-32B a ~130 tokens/sec. Recomendada.' },
          { '@type': 'ListItem', 'position': 5, 'name': 'Topo (~$4,300–5,000+ de rua)', 'description': 'RTX 5090 com 32 GB de VRAM. Roda 70B em Q4_K_M com leve offload. ~200 tokens/sec. A escassez de memória, que continua piorando, mantém os preços bem acima do MSRP de $1,999.' },
    ...
    de: {
      ...
      quickAnswerTop: {
        de: {
          ...
          answer: 'Um 2026 ein lokales LLM zu betreiben, brauchst du mindestens eine GPU mit 8 GB VRAM (NVIDIA RTX 5060 Ti oder Apple M2) fuer 7B-Modelle, 12 GB fuer 14B-Modelle, 16 GB fuer 24B-Modelle, 24 GB fuer 32B-Modelle und 40 GB+ fuer 70B-Modelle. Faustregel fuer 4-Bit-Quantisierung: VRAM in GB ≈ Parameter in Milliarden × 0,6 -- ein 7B-Modell braucht demnach rund 4-5 GB. Apple Silicon (M3/M4/M5) bietet dank Unified Memory fuer die meisten Nutzer das beste Preis-Leistungs-Verhaeltnis. Grenzsetzende Open-Weight-MoE-Modelle wie GLM-5.3 (744B gesamt) sind die Ausnahme -- sie brauchen ~239 GB selbst bei aggressiver 2-Bit-Quantisierung, mehr als jede einzelne Consumer-GPU oder der 128-GB-DGX-Spark fasst.',
          bullets: [
            '7B-Modelle (Mistral, Phi-4 Mini): 4-5 GB VRAM bei Q4_K_M (8-GB-Karte empfohlen) — RTX 5060 Ti, RTX 4060, Mac M2',
            ...
            'GLM-5.3 (744B MoE, 40B aktiv): ~239 GB selbst bei 2-Bit — braucht ein 4×-RTX-3090/4090-Rig mit 192 GB+ RAM oder einen Mac Studio mit 512 GB (M5 Ultra)',
      ...
      sections: {
        tldr: {
          ...
          items: [
            '**7B-Q4-Faustregel**: Ein 7B-Modell bei Q4_K_M-Quantisierung braucht etwa 4-5 GB VRAM (oder Arbeitsspeicher bei CPU-Inferenz) -- rund 0,6 GB pro Milliarde Parameter bei 4-Bit. Das ist der schnellste Weg, den Speicherbedarf fuer jedes 7B-Modell abzuschaetzen, ohne die vollstaendige VRAM-Rechnung weiter unten durchzufuehren.',
            ...
            '**CPU-only (16 GB Arbeitsspeicher)**: Llama 3.2 3B Q8 (20 tok/sec) oder Phi-4 Mini Q4_K_M (25 tok/sec). Eine gebrauchte RTX 4060 8 GB (~$280) oder neue RTX 5060 Ti 16 GB (~$585) ist 5-10x schneller.',
        ...
        bestGPUs: {
          ...
          items: [
            '**Fuer 7B-Modelle (Mistral, Phi-4, Llama 3.1) — Budget:** RTX 5060 Ti 16 GB (~$585, rund 40 % über der UVP von 429 $) oder eine gebrauchte RTX 4060 8 GB (~$280). Betreibt jedes 7B-Modell bei Q4_K_M (~4-5 GB). Geschwindigkeit: 50–70 tok/sec. Stufe: Budget-Enthusiasten.',
            '**Fuer 14B-Modelle (Qwen3 14B, DeepSeek-R1) — Mainstream:** RTX 5070 (12 GB, ~$880). Beste Preis-Leistung als Neukarte. Qwen3 14B Q4_K_M laeuft gut mit Reserve. Geschwindigkeit: 85–110 tok/sec. Stufe: Am beliebtesten.',
            '**Fuer 24-32B-Modelle (Qwen3.6, Mistral Small) — Mittelklasse:** RTX 5070 Ti (16 GB, ~$979) oder RTX 5080 (16 GB, ~$1.249). Betreibt Mistral Small 3.1 24B und Devstral Small 24B Q4_K_M. Geschwindigkeit: 110–150 tok/sec. Stufe: Professionelle Entwickler. Budget-Alternative: AMD RX 9070 XT (16 GB GDDR6, ~$690–740) — GDDR6 ist der Knappheit weitgehend entgangen, wodurch sie die RTX 5070 Ti bei aehnlichem VRAM um $150–250 unterbietet, auch wenn ROCm eine schmalere lokale-LLM-Tooling-Unterstuetzung als CUDA bietet.',
            '**Fuer 70B-Modelle (Llama 3.3) — High-End:** RTX 5090 (32 GB, ~$2.000 UVP, aber ~$4.300–5.000+ Strasse und weiter steigend) fasst 70B bei Q4_K_M mit leichtem CPU-Offload. Eine gebrauchte RTX 4090 (24 GB, ~$2.300) betreibt 70B nur bei Q2_K. Fuer volles Q4_K_M nutze Dual RTX 5090. Geschwindigkeit: ~200 tok/sec (5090, kleinere Modelle). Stufe: Forschung + Produktion.',
            '**Fuer GLM-5.3 (744B MoE, 40B aktiv) — Extrem:** keine einzelne Consumer-GPU reicht aus. Die 2-Bit-dynamische GGUF braucht weiterhin ~239 GB kombinierten VRAM/RAM. Realistische lokale Wege: ein 4×-RTX-3090/4090-Rig mit 192 GB+ Arbeitsspeicher oder ein Mac Studio mit 512 GB (M5 Ultra), beide bei rund 3–9 tok/sec via CPU/GPU-Hybrid-Offload.',
          ...
          rows: [
            { 'GPU': 'RTX 5060 Ti (16 GB)', 'Best For': '7-13B-Modelle', 'Price': '~$585', 'Speed': '50–70 tok/s', 'Tier': 'Budget' },
            { 'GPU': 'RTX 5070 (12 GB)', 'Best For': '14B-Modelle', 'Price': '~$880', 'Speed': '85–110 tok/s', 'Tier': 'Mainstream' },
            { 'GPU': 'RX 9070 XT (16 GB)', 'Best For': '24-32B-Modelle', 'Price': '~$690–740', 'Speed': '90–130 tok/s', 'Tier': 'Budget-Alternative' },
            ...
            { 'GPU': 'RTX 5090 (32 GB)', 'Best For': '70B (Q4, leichter Offload)', 'Price': '~$2.000 UVP (~$4.300–5.000+ Strasse)', 'Speed': '~200 tok/s', 'Tier': 'High-End' },
            { 'GPU': 'Dual RTX 5090', 'Best For': '70B (Q4) voll', 'Price': '~$8.600–10.000', 'Speed': '300+ tok/s', 'Tier': 'Enterprise' },
            { 'GPU': 'Mac M5 Max 128GB', 'Best For': '70B (Q4)', 'Price': '~$6.000', 'Speed': '~12–15 tok/s (70B)', 'Tier': 'Pro-Laptop' },
            { 'GPU': '4× RTX 3090/4090 + 192GB RAM', 'Best For': 'GLM-5.3 (2-Bit)', 'Price': '~$6.000–9.000', 'Speed': '3–9 tok/s', 'Tier': 'Extreme MoE' },
          ],
          columns: ['GPU', 'Best For', 'Price', 'Speed', 'Tier'],
          callouts: [
            { type: 'warning', text: 'Die Preisgestaltung ist volatil und verschaerft sich weiter. Die GDDR7-Knappheit hat die RTX 5090 auf $4.300–$5.000+ Strassenpreis getrieben — mehr als das Doppelte ihrer UVP von $1.999 — und die eingestellte RTX 4090 kostet gebraucht nun mehr als neu. Die obigen Preise sind typische Strassenwerte — pruefe vor dem Kauf stets die aktuellen Angebote. AMDs GDDR6-basierte RX 9070 XT ist eine bemerkenswerte Ausnahme: Sie ist dem Preisanstieg weitgehend entgangen.' },
          ],
        },
        vramMath: {
          id: 'vram-math',
        ...
        kvCache: {
          ...
          content: [
            ...
            '**Diese Werte gehen von fp16 (2 Byte pro Element) fuer die K- und V-Tensoren aus.** Ein quantisierter KV-Cache (z. B. `--cache-type-k q8_0` in llama.cpp) benoetigt etwa die Haelfte des in der Tabelle gezeigten VRAM.',
          ],
          ...
          rows: [
            ...
            { 'Modell': 'Llama 3.3 70B', '4K Kontext': '1.25 GB', '32K Kontext': '10 GB', '128K Kontext': '40 GB' },
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'Faustregel: Dieser Prozentsatz sinkt, je groesser das Modell wird -- der KV-Cache skaliert mit der Anzahl der Layer, waehrend die Groesse der Modellgewichte mit der Gesamtzahl der Parameter skaliert, und Layer wachsen bei groesseren Modellen langsamer als Parameter. Llama 3.1 8B (32 Layer): Ein 32K-Kontext-Cache betraegt ~4 GB gegenueber ~4,7 GB Q4_K_M-Gewichten (~85 %). Llama 3.3 70B (80 Layer): Ein 32K-Kontext-Cache betraegt ~10 GB gegenueber ~40 GB Q4_K_M-Gewichten (~25 %). Der Ollama-Standardkontext betraegt 2.048 Token. Fuer hoehere Werte: PARAMETER num_ctx 32768 in deinem Modelfile.' },
          ],
        },
        gpuRecommendations: {
          id: 'gpu-recommendations',
          ...
          rows: [
            { 'Stufe': 'Budget (~$585)', 'GPU': 'RTX 5060 Ti', 'VRAM': '16 GB', 'Best For': '7-13B-Modelle', 'Geschwindigkeit': '~60 tok/s' },
            { 'Stufe': 'Mainstream (~$880)', 'GPU': 'RTX 5070', 'VRAM': '12 GB', 'Best For': '7-14B-Modelle', 'Geschwindigkeit': '~90 tok/s' },
            ...
            { 'Stufe': 'Top (~$4.300–5.000+ Strasse)', 'GPU': 'RTX 5090', 'VRAM': '32 GB', 'Best For': '70B (Q4, leichter Offload)', 'Geschwindigkeit': '~200 tok/s' },
          ...
          imageCaption: 'GPU-Stufenempfehlungen (Strassenpreise): ~$585 RTX 5060 Ti (16GB, 7-13B, 60 tok/s), ~$880 RTX 5070 (12GB, 14B, 90 tok/s), ~$1.249 RTX 5080 (16GB, 14-32B, 130 tok/s), ~$4.300–5.000+ RTX 5090 (32GB, 70B, 200 tok/s), $4.699 DGX Spark (128GB, grosse MoE). Die GPU-Wahl ist 10x wichtiger als die CPU.',
        },
        vramTiers: {
          id: 'vram-tiers',
        ...
        modelsFor12GB: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'RTX 3060 12GB ist der Budget-Einstieg (~$285 gebraucht). Sie betreibt alle 12-GB-Modelle, aber mit ~60-70 tok/sec gegenueber ~80-90 tok/sec auf der RTX 4070 Ti aufgrund der aelteren Speicherarchitektur.' },
          ],
        },
        modelsFor24GB: {
          id: 'models-24gb',
        ...
        cpuOnlyInference: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'CPU- vs. GPU-Geschwindigkeit in der Realitaet: Eine gebrauchte NVIDIA RTX 3060 12 GB (~$285) betreibt Llama 3.1 8B mit 70+ tok/sec -- 5-8x schneller als der Ryzen 9 7950X bei CPU-only-Inferenz. Wenn Geschwindigkeit zaehlt, kaufe eine GPU, bevor du RAM ergaenzt.' },
          ...
          imageCaption: 'CPU-only-Inferenzgeschwindigkeiten auf Ryzen 9 7950X: Gemma 2 2B Q8_0 (28 tok/sec am schnellsten), Phi-4 Mini Q4_K_M (25 tok/sec beste Wahl), Llama 3.1 8B Q8_0 (8 tok/sec). Eine gebrauchte RTX 3060 ($285) erreicht 5-8x schneller.',
        },
        storage: {
          id: 'storage',
        ...
        cantAffordHardware: {
          ...
          content: [
            'Wenn eine GPU fuer $280–400 ausserhalb deines Budgets liegt oder dein Laptop zu alt ist, um moderne Inferenz-Engines zu unterstuetzen, **sind lokale LLMs fuer dich 2026 moeglicherweise nicht kosteneffizient**.',
        ...
        mac: {
          ...
          content: [
            ...
            'Der M5 Max mit 128 GB Unified Memory (bis zu 614 GB/s) betreibt 70B-Modelle bei Q4_K_M bequem — etwa 12-15 tok/sec — im Laptop- oder Mac-Studio-Formfaktor. Der M5 Pro (bis zu 64 GB unified, 307 GB/s) bewaeltigt 32B-Modelle mit grosszuegiger Reserve fuer KV-Cache und Multitasking. Beachte, dass der M5 Max den ~239-GB-Bedarf von GLM-5.3 selbst bei 2-Bit noch weit verfehlt -- ein Bereich, in dem Apples Unified-Memory-Obergrenze mehr zaehlt als reine Geschwindigkeit.',
            '**Apple hat die Mac-mini- und Mac-Studio-Reihe am 25. August 2026 aufgefrischt, Auslieferung ab 22. September 2026.** Der Mac mini kommt jetzt in den Konfigurationen M6 (ab $899, bis zu 32 GB Unified Memory, 170 GB/s) und M5 Pro (ab $1.699, bis zu 64 GB, 307 GB/s). Der Mac Studio steigt auf M5 Max (ab $2.499, bis zu 128 GB) und M5 Ultra (ab $5.499 mit 96 GB, bis zu 256 GB oder 512 GB in der Top-Konfiguration -- das 512-GB-Modell liefert Ende Oktober 2026 aus und duerfte deutlich ueber $10.000 kosten). Der bisherige M4 Mac mini (ab $599) und der M4 Pro Mac mini (bis $2.299, maximal 64 GB) sowie der vorherige Mac Studio M4 Max / M3 Ultra sind jetzt die Vorgaengergeneration.',
            'Fuer die Chips M6 und M5 Ultra gibt es noch keine unabhaengigen Tok/sec-Benchmarks -- Apple hat fuer beide bislang keine von Dritten verifizierten Inferenzwerte veroeffentlicht. Erstmals kann ein einzelner Mac GLM-5.3 (744B MoE, ~239 GB bei 2-Bit) theoretisch im Unified Memory unterbringen: Die Top-Konfiguration des Mac Studio M5 Ultra mit 512 GB uebertrifft diesen Bedarf mit deutlichem Spielraum. Bis reale Benchmarks vorliegen, bleibt ein 4x-RTX-3090/4090-Rig der besser dokumentierte lokale Weg fuer Modelle der GLM-5.3-Klasse.',
          ...
          rows: [
            ...
            { 'Mac': 'Mac mini M6 (ab $899)', 'GPU Memory': '32 GB unified, 170 GB/s', 'Best For': '8-14B-Modelle', 'Limitation': 'Kein Spielraum fuer 32B+' },
            { 'Mac': 'M5 Pro (MacBook Pro / Mac mini, ab $1.699)', 'GPU Memory': '64 GB unified, 307 GB/s', 'Best For': '32B-Modelle bequem', 'Limitation': 'Llama 4 Scout laeuft gut' },
            { 'Mac': 'M5 Max (MacBook Pro / Studio, ab $2.499)', 'GPU Memory': '128 GB unified, bis zu 614 GB/s', 'Best For': '70B-Modelle bei Q4_K_M', 'Limitation': '~12-15 tok/sec bei 70B' },
            { 'Mac': 'Mac Studio M5 Ultra (ab $5.499)', 'GPU Memory': '96-512 GB unified', 'Best For': '70B+ und grosse MoE-Modelle', 'Limitation': '512 GB ab Okt. 2026; noch keine Benchmarks' },
          ],
          columns: ['Mac', 'GPU Memory', 'Best For', 'Limitation'],
          image: '/images/mac-hardware-comparison-de.svg',
          imageCaption: 'Mac-Hardware-Vergleich: 8 GB M-Serie (3-4B-Modelle), M3 Pro 16" (18GB, 7-8B), Mac mini M6 (32GB, 8-14B, $899), M5 Pro (64GB, 32B, $1.699), M5 Max (128GB, 70B bei Q4_K_M ~12-15 tok/sec, $2.499), Mac Studio M5 Ultra (bis 512GB, GLM-5.3-Kapazitaet, $5.499). 16 GB unified ist das komfortable Minimum fuer 7B-Modelle auf einem Mac.',
        },
        serverVsConsumer: {
          id: 'server-vs-consumer',
          ...
          imageCaption: 'Consumer- vs. Server-Hardware: RTX 5090 (~$4.300–5.000+ Strasse, 32GB, Einzelnutzer, Teilzeit) vs. RTX 6000 Ada ($7.000+, 48GB, Multi-User, 24/7-Betrieb). Beginne mit Consumer-Hardware; ruestest nur auf Server-Klasse auf, wenn du Produktionsdienste betreibst.',
        },
        dgxSpark: {
          id: 'dgx-spark',
          ...
          rows: [
            ...
            { 'Spec': 'GLM-5.3 bei 2-Bit (~239 GB)', 'Wert': '❌ passt nicht' },
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Prompt Engineering fuer lokale LLMs](/de/local-llms/prompt-engineering-for-local-models) -- optimiere Prompts fuer die Einschraenkungen lokaler Modelle',
        ...
        sources: {
          ...
          title: 'Quellen',
          items: [
            'NVIDIA. (2026). "GeForce GPU Specifications." [www.nvidia.com/en-us/geforce/graphics-cards/](https://www.nvidia.com/en-us/geforce/graphics-cards/) -- Offizielle VRAM- und Bandbreitenspezifikationen fuer RTX-40-Serie und RTX-50-Serie-GPUs.',
            'Apple. (2026). "Apple M5 Chip." [www.apple.com/mac/](https://www.apple.com/mac/) -- M5 Pro/Max-Spezifikationen, Speicherbandbreite, LLM-Leistungsangaben. M5 ist der erste Mac, der 70B-Modelle bei Q4_K_M bequem betreibt.',
            'NVIDIA. (2025). "DGX Spark Product Page." [www.nvidia.com/en-us/products/workstations/dgx-spark/](https://www.nvidia.com/en-us/products/workstations/dgx-spark/) -- Offizielle Spezifikationen fuer GB10 Grace Blackwell Superchip und 128 GB Unified Memory.',
            'Meta AI. (2024). "Llama 3.3 Model Card." [llama.meta.com/](https://llama.meta.com/) -- Offizielle Llama 3.3 70B-Spezifikationen und VRAM-Anforderungen.',
            'Meta AI. (2025). "Llama 4 Model Card." [llama.meta.com/](https://llama.meta.com/) -- Llama 4 Scout/Maverick MoE-Architektur, VRAM-Anforderungen.',
            'Z.ai. (2026). "GLM-5.3: Built for Long-Horizon Tasks." [huggingface.co/blog/zai-org/glm-52-blog](https://huggingface.co/blog/zai-org/glm-52-blog) -- Offizielle GLM-5.3-Modellkarte: 744B-gesamt / 40B-aktiv-MoE-Architektur, MIT-Lizenz, Veroeffentlichungsdatum.',
          ],
        },
      },
schema: {
      ...
      itemListSchema: {
        ...
        'numberOfItems': 7,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'Budget (~$585)', 'description': 'RTX 5060 Ti mit 16 GB VRAM. Betreibt 7-13B-Modelle mit ~60 Token/sec. Beste Preis-Leistung als Neukarte.' },
          { '@type': 'ListItem', 'position': 2, 'name': 'Mainstream (~$880)', 'description': 'RTX 5070 mit 12 GB VRAM. Betreibt 7-14B-Modelle mit ~90 Token/sec. Beste Preis-Leistung.' },
          ...
          { '@type': 'ListItem', 'position': 5, 'name': 'Top (~$4.300–5.000+ Strasse)', 'description': 'RTX 5090 mit 32 GB VRAM. Betreibt 70B bei Q4_K_M mit leichtem Offload. ~200 Token/sec. Die sich verschaerfende Speicherknappheit haelt die Preise bei mehr als dem Doppelten der UVP von $1.999.' },
    ...
    fr: {
      ...
      quickAnswerTop: {
        fr: {
          ...
          answer: 'Pour faire tourner un LLM local en 2026, il faut au minimum un GPU de 8 Go de VRAM (NVIDIA RTX 5060 Ti ou Apple M2) pour les modeles 7B, 12 Go pour les modeles 14B, 16 Go pour les modeles 24B, 24 Go pour les modeles 32B, et 40 Go+ pour les modeles 70B. Regle empirique : ~0,6 Go de VRAM par milliard de parametres en Q4. Apple Silicon (M3/M4/M5) offre le meilleur rapport qualite-prix pour la plupart des utilisateurs grace a la memoire unifiee.',
          bullets: [
            ...
            'GLM-5.3 (744B MoE, 40B actifs) : ~239 Go meme en 2 bits — necessite un rig 4x RTX 3090/4090 avec 192 Go+ de RAM ou un Mac Studio 512 Go (M5 Ultra)',
      ...
      sections: {
        tldr: {
          ...
          snippetBlocks: [
            ...
            { type: 'one-sentence', text: 'Regle rapide pour un 7B en Q4 : ~4-5 Go de VRAM, soit environ 0,6 Go par milliard de parametres a 4 bits -- utile pour estimer n\'importe quelle taille de modele sans calculatrice.' },
          ],
          items: [
            ...
            '**CPU seul (16 Go de RAM systeme)** : Llama 3.2 3B Q8 (20 tok/sec) ou Phi-4 Mini Q4_K_M (25 tok/sec). Une RTX 4060 8 Go d\'occasion (~$280) ou une RTX 5060 Ti 16 Go neuve (~$585) est 5-10x plus rapide.',
            ...
            '**Prix actuels** : une penurie de GDDR7 a pousse le prix de rue de la RTX 5090 au-dessus de $4,300-5,000+, et ca continue de grimper. La serie RTX 40 (dont la RTX 4090) est arretee. La AMD RX 9070 XT (16 Go GDDR6, ~$690–740) est une alternative moins chere largement epargnee par la penurie de GDDR7.',
        ...
        bestGPUs: {
          ...
          items: [
            '**Pour les modeles 7B (Mistral, Phi-4, Llama 3.1) — Economique :** RTX 5060 Ti 16 Go (~$585, environ 40 % au-dessus de son tarif conseille de 429 $) ou une RTX 4060 8 Go d\'occasion (~$280). Fait tourner tout modele 7B en Q4_K_M. Vitesse : 50-70 tok/sec. Palier : passionnes a budget serre.',
            '**Pour les modeles 14B (Qwen3 14B, DeepSeek-R1) — Grand public :** RTX 5070 (12 Go, ~$880). Meilleure carte neuve en rapport prix-performance. Qwen3 14B Q4_K_M tourne bien avec de la marge. Vitesse : 85-110 tok/sec. Palier : le plus populaire.',
            '**Pour les modeles 24-32B (Qwen3.6, Mistral Small) — Milieu de gamme :** RTX 5070 Ti (16 Go, ~$979) ou RTX 5080 (16 Go, ~$1,450). Fait tourner Mistral Small 3.1 24B et Devstral Small 24B Q4_K_M. Vitesse : 110-150 tok/sec. Palier : developpeurs professionnels. Alternative budget : la AMD RX 9070 XT (16 Go, ~$690–740) fait aussi tourner cette classe de modeles et reste largement epargnee par la penurie de GDDR7.',
            '**Pour les modeles 70B (Llama 3.3) — Haut de gamme :** RTX 5090 (32 Go, ~$2,000 prix conseille mais ~$4,300-5,000+ en rue) accueille le 70B en Q4_K_M avec un leger deport CPU. Une RTX 4090 d\'occasion (24 Go, ~$2,300) ne fait tourner le 70B qu\'en Q2_K. Pour le Q4_K_M complet, utilisez une double RTX 5090. Vitesse : ~200 tok/sec (5090, modeles plus petits). Palier : recherche + production.',
            ...
            '**Pour GLM-5.3 (744B MoE, 40B actifs) — Extreme :** aucun GPU grand public seul ne suffit. Le GGUF dynamique en 2 bits necessite encore ~239 Go de VRAM/RAM combinees. Chemins locaux realistes : un rig 4x RTX 3090/4090 avec 192 Go+ de RAM systeme, ou un Mac Studio 512 Go (M5 Ultra), les deux tournant a environ 3-9 tok/sec via deport hybride CPU/GPU.',
          ],
          rows: [
            { 'GPU': 'RTX 5060 Ti (16 GB)', 'Best For': 'modeles 7-13B', 'Price': '~$585', 'Speed': '50-70 tok/s', 'Tier': 'Economique' },
            { 'GPU': 'RTX 5070 (12 GB)', 'Best For': 'modeles 14B', 'Price': '~$880', 'Speed': '85-110 tok/s', 'Tier': 'Grand public' },
            { 'GPU': 'RX 9070 XT (16 GB)', 'Best For': 'modeles 24-32B', 'Price': '~$690–740', 'Speed': '90-130 tok/s', 'Tier': 'Alternative budget' },
            ...
            { 'GPU': 'RTX 5090 (32 GB)', 'Best For': '70B (Q4, leger deport)', 'Price': '~$2,000 conseille (~$4,300-5,000+ rue)', 'Speed': '~200 tok/s', 'Tier': 'Haut de gamme' },
            { 'GPU': 'Double RTX 5090', 'Best For': '70B (Q4) complet', 'Price': '~$8,600-10,000', 'Speed': '300+ tok/s', 'Tier': 'Entreprise' },
            { 'GPU': '4x RTX 3090/4090 + 192GB RAM', 'Best For': 'GLM-5.3 (2-bit)', 'Price': '~$6,000-9,000', 'Speed': '3-9 tok/s', 'Tier': 'MoE extreme' },
            { 'GPU': 'Mac M5 Max 128GB', 'Best For': '70B (Q4)', 'Price': '~$6,000', 'Speed': '~12-15 tok/s (70B)', 'Tier': 'Portable pro' },
          ],
          columns: ['GPU', 'Best For', 'Price', 'Speed', 'Tier'],
          callouts: [
            { type: 'warning', text: 'Les prix des GPU sont volatils et la penurie de GDDR7/memoire s\'aggrave. La RTX 5090 est passee au-dessus de $4,300-5,000+, et la RTX 4090 arretee coute desormais plus cher d\'occasion que neuve. Exception notable : la AMD RX 9070 XT (GDDR6) reste largement epargnee et proche de son prix conseille. Les prix ci-dessus sont des chiffres de rue typiques — verifiez toujours les annonces actuelles avant d\'acheter.' },
          ],
        },
        vramMath: {
          id: 'vram-math',
        ...
        kvCache: {
          ...
          content: [
            ...
            '**Ces chiffres supposent du fp16 (2 octets par element) pour les tenseurs K et V.** Un cache KV quantifie (par ex. `--cache-type-k q8_0` dans llama.cpp) utilise environ la moitie de la VRAM indiquee dans le tableau.',
          ],
          ...
          rows: [
            ...
            { 'Modele': 'Llama 3.3 70B', 'contexte 4K': '1.25 GB', 'contexte 32K': '10 GB', 'contexte 128K': '40 GB' },
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'Regle empirique : ce pourcentage diminue a mesure que le modele grandit -- le cache KV augmente avec le nombre de couches, tandis que la taille des poids du modele augmente avec le nombre total de parametres, et les couches croissent plus lentement que les parametres a mesure que les modeles grossissent. Llama 3.1 8B (32 couches) : un cache de contexte 32K est d\'environ ~4 Go contre ~4,7 Go de poids Q4_K_M (~85 %). Llama 3.3 70B (80 couches) : un cache de contexte 32K est d\'environ ~10 Go contre ~40 Go de poids Q4_K_M (~25 %). Le contexte par defaut d\'Ollama est de 2 048 tokens. Pour l\'augmenter : PARAMETER num_ctx 32768 dans votre Modelfile.' },
          ],
        },
        gpuRecommendations: {
          id: 'gpu-recommendations',
          ...
          columns: ['Tier', 'GPU', 'VRAM', 'Best For', 'Speed'],
          rows: [
            { 'Tier': 'Economique (~$585)', 'GPU': 'RTX 5060 Ti', 'VRAM': '16 GB', 'Best For': 'modeles 7-13B', 'Speed': '~60 tok/s' },
            { 'Tier': 'Grand public (~$880)', 'GPU': 'RTX 5070', 'VRAM': '12 GB', 'Best For': 'modeles 7-14B', 'Speed': '~90 tok/s' },
            { 'Tier': 'Milieu (~$979)', 'GPU': 'RTX 5070 Ti', 'VRAM': '16 GB', 'Best For': 'modeles 14-32B', 'Speed': '~110 tok/s' },
            { 'Tier': 'Eleve (~$1,450)', 'GPU': 'RTX 5080', 'VRAM': '16 GB', 'Best For': 'modeles 14-32B', 'Speed': '~130 tok/s' },
            { 'Tier': 'Sommet (~$4,300-5,000+ rue)', 'GPU': 'RTX 5090', 'VRAM': '32 GB', 'Best For': '70B (Q4, leger deport)', 'Speed': '~200 tok/s' },
          ...
          imageCaption: 'Recommandations de paliers de GPU (prix de rue) : ~$585 RTX 5060 Ti (16 Go, 7-13B, 60 tok/s), ~$880 RTX 5070 (12 Go, 14B, 90 tok/s), ~$1,450 RTX 5080 (16 Go, 14-32B, 130 tok/s), ~$4,300-5,000+ RTX 5090 (32 Go, 70B, 200 tok/s), $4,699 DGX Spark (128 Go, grand MoE). Le choix du GPU compte 10x plus que le CPU.',
        },
        vramTiers: {
          id: 'vram-tiers',
        ...
        modelsFor12GB: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'La RTX 3060 12 Go est le point d\'entree economique (~$285 d\'occasion). Elle fait tourner tous les modeles 12 Go mais a ~60-70 tok/sec contre ~80-90 tok/sec sur RTX 4070 Ti en raison d\'une architecture memoire plus ancienne.' },
          ],
        },
        modelsFor24GB: {
          id: 'models-24gb',
        ...
        cpuOnlyInference: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'Realite vitesse CPU vs GPU : une NVIDIA RTX 3060 12 Go d\'occasion (~$285) fait tourner Llama 3.1 8B a 70+ tok/sec -- 5-8x plus vite que le Ryzen 9 7950X en inference CPU seul. Si la vitesse compte, achetez un GPU avant d\'ajouter de la RAM.' },
          ...
          imageCaption: 'Vitesses d\'inference CPU seul sur Ryzen 9 7950X : Gemma 2 2B Q8_0 (28 tok/sec le plus rapide), Phi-4 Mini Q4_K_M (25 tok/sec meilleur choix), Llama 3.1 8B Q8_0 (8 tok/sec). Une RTX 3060 d\'occasion ($285) atteint 5-8x plus vite.',
        },
        storage: {
          id: 'storage',
        ...
        cantAffordHardware: {
          ...
          content: [
            'Si un GPU a $280-400 depasse votre budget, ou si votre portable est trop ancien pour prendre en charge les moteurs d\'inference modernes, **les LLM locaux ne seront peut-etre pas rentables pour vous en 2026**.',
        ...
        mac: {
          ...
          content: [
            ...
            'Le M5 Max avec 128 Go de memoire unifiee (jusqu\'a 614 Go/s) fait tourner les modeles 70B en Q4_K_M confortablement — environ 12-15 tok/sec — dans un portable ou un Mac Studio. Le M5 Pro (jusqu\'a 64 Go unifies, 307 Go/s) gere les modeles 32B avec une marge genereuse pour le cache KV et le multitache.',
            '**Apple a renouvele la gamme Mac mini et Mac Studio le 25 aout 2026, avec des livraisons a partir du 22 septembre 2026.** Le Mac mini se decline desormais en M6 (a partir de 899 $, jusqu\'a 32 Go de memoire unifiee, 170 Go/s) et M5 Pro (a partir de 1 699 $, jusqu\'a 64 Go, 307 Go/s). Le Mac Studio monte en gamme avec le M5 Max (a partir de 2 499 $, jusqu\'a 128 Go) et le M5 Ultra (a partir de 5 499 $ pour 96 Go, jusqu\'a 256 Go ou 512 Go en configuration maximale -- le modele 512 Go sera livre fin octobre 2026 et devrait couter bien plus de 10 000 $). Le Mac mini M4 sortant (a partir de 599 $) et le Mac mini M4 Pro (jusqu\'a 2 299 $, 64 Go max), ainsi que le precedent Mac Studio M4 Max / M3 Ultra, appartiennent desormais a la generation precedente.',
            'Aucun benchmark independant de tok/sec n\'existe encore pour les puces M6 ou M5 Ultra -- Apple n\'a publie aucun chiffre d\'inference verifie par un tiers pour l\'une ou l\'autre a ce jour. Pour la premiere fois, un seul Mac peut theoriquement contenir GLM-5.3 (744B MoE, ~239 Go en 2 bits) en memoire unifiee : la configuration maximale du Mac Studio M5 Ultra a 512 Go depasse largement ce besoin. En attendant des benchmarks reels, un rig 4x RTX 3090/4090 reste la voie locale la mieux documentee pour les modeles de la classe GLM-5.3.',
            ...
            'A noter : meme le M5 Max reste tres loin des ~239 Go necessaires pour GLM-5.3, meme en 2 bits -- un domaine ou le plafond de memoire unifiee d\'Apple compte plus que la vitesse brute.',
          ],
          rows: [
            ...
            { 'Mac': 'Mac mini M6 (a partir de 899 $)', 'GPU Memory': '32 GB unifies, 170 GB/s', 'Best For': 'modeles 8-14B', 'Limitation': 'Pas de marge pour 32B+' },
            { 'Mac': 'M5 Pro (MacBook Pro / Mac mini, a partir de 1 699 $)', 'GPU Memory': '64 GB unifies, 307 GB/s', 'Best For': 'modeles 32B confortablement', 'Limitation': 'Llama 4 Scout tourne bien' },
            { 'Mac': 'M5 Max (MacBook Pro / Studio, a partir de 2 499 $)', 'GPU Memory': '128 GB unifies, jusqu\'a 614 GB/s', 'Best For': 'modeles 70B en Q4_K_M', 'Limitation': '~12-15 tok/sec sur 70B' },
            { 'Mac': 'Mac Studio M5 Ultra (a partir de 5 499 $)', 'GPU Memory': '96-512 GB unifies', 'Best For': '70B+ et gros modeles MoE', 'Limitation': '512 Go livre oct. 2026 ; pas encore de benchmarks' },
          ],
          columns: ['Mac', 'GPU Memory', 'Best For', 'Limitation'],
          image: '/images/mac-hardware-comparison-fr.svg',
          imageCaption: 'Comparaison du materiel Mac : serie M 8 Go (modeles 3-4B), M3 Pro 16" (18 Go, 7-8B), Mac mini M6 (32 Go, 8-14B, 899 $), M5 Pro (64 Go, 32B, 1 699 $), M5 Max (128 Go, 70B en Q4_K_M ~12-15 tok/sec, 2 499 $), Mac Studio M5 Ultra (jusqu\'a 512 Go, capacite GLM-5.3, 5 499 $). 16 Go unifies est le minimum confortable pour les modeles 7B sur un Mac.',
        },
        serverVsConsumer: {
          id: 'server-vs-consumer',
        ...
        dgxSpark: {
          ...
          content: [
            '**Le NVIDIA DGX Spark ($4,699 en fevrier 2026, contre $3,999 a son lancement) est un ordinateur IA de bureau compact de 128 Go qui peut contenir entierement Llama 3.3 70B en Q8_0 en memoire unifiee -- mais son plafond de 128 Go n\'est pas illimite : GLM-5.3 (744B au total, 40B actifs, sorti en juin 2026) necessite ~239 Go meme en quantification 2 bits et ne tient pas dans un seul DGX Spark.** Les Apple Mac Studio / MacBook Pro a 128 Go et les systemes AMD Strix Halo 128 Go peuvent faire de meme pour le 70B, il n\'est donc pas unique — mais il est livre avec la pile logicielle CUDA de NVIDIA.',
          ...
          rows: [
            ...
            { 'Spec': 'GLM-5.3 en 2-bit (~239 GB)', 'Value': '❌ ne tient pas' },
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'Une RTX 3060 12 Go vaut-elle encore le coup pour les LLM locaux en 2026 ?', a: 'La RTX 3060 (12 Go) est datee (architecture 2021). Elle gere les modeles 7B-13B en Q4 mais produit 40-60 tokens/sec. Une carte d\'occasion coute ~$285 ; une RTX 5070 neuve (~$880) ou RTX 5060 Ti 16 Go (~$585) tourne 2-3x plus vite. La RTX 3060 ne vaut le coup qu\'en GPU secondaire pour les configurations multi-cartes.' },
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Ingenierie de prompt pour LLM locaux](/fr/local-llms/prompt-engineering-for-local-models) -- optimisez les prompts pour les contraintes des modeles locaux',
        ...
        sources: {
          ...
          title: 'Sources',
          items: [
            'NVIDIA. (2026). "GeForce GPU Specifications." [www.nvidia.com/en-us/geforce/graphics-cards/](https://www.nvidia.com/en-us/geforce/graphics-cards/) -- Specifications officielles de VRAM et de bande passante pour les GPU RTX serie 40 et serie 50.',
            'Apple. (2026). "Apple M5 Chip." [www.apple.com/mac/](https://www.apple.com/mac/) -- Specifications M5 Pro/Max, bande passante memoire, declarations de performance LLM. Le M5 est le premier Mac qui fait tourner confortablement les modeles 70B en Q4_K_M.',
            'NVIDIA. (2025). "DGX Spark Product Page." [www.nvidia.com/en-us/products/workstations/dgx-spark/](https://www.nvidia.com/en-us/products/workstations/dgx-spark/) -- Specifications officielles du superpuce GB10 Grace Blackwell et des 128 Go de memoire unifiee.',
            'Meta AI. (2024). "Llama 3.3 Model Card." [llama.meta.com/](https://llama.meta.com/) -- Specifications officielles et besoins en VRAM de Llama 3.3 70B.',
            'Meta AI. (2025). "Llama 4 Model Card." [llama.meta.com/](https://llama.meta.com/) -- Architecture MoE et besoins en VRAM de Llama 4 Scout/Maverick.',
            'Z.ai. (2026). "GLM-5.3: Built for Long-Horizon Tasks." [huggingface.co/blog/zai-org/glm-52-blog](https://huggingface.co/blog/zai-org/glm-52-blog) -- Fiche officielle du modele GLM-5.3 : architecture MoE 744B au total / 40B actifs, licence MIT, date de sortie.',
          ],
        },
      },
schema: {
      ...
      itemListSchema: {
        ...
        'numberOfItems': 7,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'Economique (~$585)', 'description': 'RTX 5060 Ti avec 16 Go de VRAM. Fait tourner les modeles 7-13B a ~60 tokens/sec. Meilleure carte neuve en rapport qualite-prix.' },
          { '@type': 'ListItem', 'position': 2, 'name': 'Grand public (~$880)', 'description': 'RTX 5070 avec 12 Go de VRAM. Fait tourner les modeles 7-14B a ~90 tokens/sec. Meilleur rapport prix-performance.' },
          ...
          { '@type': 'ListItem', 'position': 4, 'name': 'Eleve (~$1,450)', 'description': 'RTX 5080 avec 16 Go de VRAM. Fait tourner les modeles 14-32B a ~130 tokens/sec. Recommande.' },
          { '@type': 'ListItem', 'position': 5, 'name': 'Sommet (~$4,300-5,000+ rue)', 'description': 'RTX 5090 avec 32 Go de VRAM. Fait tourner le 70B en Q4_K_M avec un leger deport. ~200 tokens/sec. La penurie de memoire qui s\'aggrave maintient les prix bien au-dessus du prix conseille de $1,999.' },
    ...
    ja: {
      ...
      quickAnswerTop: {
        ja: {
          ...
          answer: '2026年にローカルLLMを実行するには、7Bモデルの場合は最低8 GB VRAM GPU（NVIDIA RTX 5060 TiまたはApple M2）、14Bモデルの場合は12 GB、24Bモデルの場合は16 GB、32Bモデルの場合は24 GB、70Bモデルの場合は40 GB以上が必要です。4ビット量子化の目安：VRAM（GB）≈ パラメータ数（billion）× 0.6 — 7Bモデルならおよそ4〜5 GBです。Apple Silicon（M3/M4/M5）はユニファイドメモリのため、ほとんどのユーザーにとって最高の価値です。GLM-5.3（合計744B）のようなフロンティア級のオープンウェイトMoEモデルは例外で、積極的な2ビット量子化でも約239 GBを必要とし、単一のコンシューマーGPUや128 GBのDGX Sparkを超えます。',
          bullets: [
            '7B モデル（Mistral、Phi-4 Mini）：Q4_K_Mで4〜5 GB VRAM（8 GBカード推奨） — RTX 5060 Ti、RTX 4060、Mac M2',
            ...
            'GLM-5.3（744B MoE、40Bアクティブ）：2ビットでも約239 GB — 192 GB以上のRAMを搭載した4× RTX 3090/4090構成、または512 GBのMac Studio（M5 Ultra）が必要',
      ...
      sections: {
        tldr: {
          ...
          items: [
            '**7B Q4の目安**：Q4_K_M量子化の7Bモデルは約4〜5 GBのVRAM（またはCPU推論の場合はシステムRAM）を必要とします — 4ビットでパラメータ10億あたり約0.6 GBです。下記のフルVRAM計算をせずに、あらゆる7Bクラスモデルのメモリを見積もる最も速い方法です。',
            ...
            '**CPUのみ（システムRAM 16 GB）**：Llama 3.2 3B Q8（20 tok/sec）またはPhi-4 Mini Q4_K_M（25 tok/sec）。中古のRTX 4060 8 GB（約$280）または新品のRTX 5060 Ti 16 GB（約$585）なら5〜10倍高速です。',
            ...
            '**現在の価格**：GDDR7不足は緩和されずむしろ悪化しており、RTX 5090の実勢価格は$4,300〜$5,000以上まで上昇し、なお上昇を続けています。生産終了のRTX 4090も高止まりしたままです。予算重視の購入者はAMDのRX 9070 XT（16 GB GDDR6、約$630〜700）もチェックしましょう — GDDR6は不足の影響をほとんど受けておらず、GDDR7不足の影響を大きく受けていない分、割安な代替になっています。在庫のあるRTX 50シリーズから購入し、購入前にライブ価格を確認してください。',
        ...
        bestGPUs: {
          ...
          items: [
            '**7Bモデル（Mistral、Phi-4、Llama 3.1）向け — 予算重視：** RTX 5060 Ti 16 GB（約$585、希望小売価格429ドルより約40%高い）または中古のRTX 4060 8 GB（約$280）。あらゆる7BモデルをQ4_K_M（約4〜5 GB）で実行。速度：50〜70 tok/sec。ティア：予算重視の愛好家。',
            '**14Bモデル（Qwen3 14B、DeepSeek-R1）向け — メインストリーム：** RTX 5070（12 GB、約$880）。新品で最良の価格対性能のカード。Qwen3 14B Q4_K_Mが余裕をもって良好に動作します。速度：85〜110 tok/sec。ティア：最も人気。',
            '**24〜32Bモデル（Qwen3.6、Mistral Small）向け — ミドルレンジ：** RTX 5070 Ti（16 GB、約$979）またはRTX 5080（16 GB、約$1,450）。Mistral Small 3.1 24BおよびDevstral Small 24B Q4_K_Mを実行。速度：110〜150 tok/sec。ティア：プロの開発者。予算重視の代替：AMD RX 9070 XT（16 GB GDDR6、約$630〜700） — GDDR6はほぼ不足の影響を受けていないため、同程度のVRAMでRTX 5070 Tiより$150〜250安くなっています。ただしROCmはCUDAに比べローカルLLM向けツールのサポートが限定的です。',
            '**70Bモデル（Llama 3.3）向け — ハイエンド：** RTX 5090（32 GB、MSRP約$2,000だが実勢約$4,300〜5,000以上でなお上昇中）は軽いCPUオフロードで70BをQ4_K_Mで収めます。中古のRTX 4090（24 GB、約$2,300）は70BをQ2_Kでのみ実行可能。完全なQ4_K_MにはデュアルRTX 5090を使用。速度：約200 tok/sec（5090、より小さなモデル）。ティア：研究＋本番。',
            '**GLM-5.3（744B MoE、40Bアクティブ）向け — エクストリーム：** 単一のコンシューマーGPUでは足りません。2ビットのダイナミックGGUFでも約239 GBの合計VRAM/RAMが必要です。現実的なローカル構成は、192 GB以上のシステムRAMを搭載した4× RTX 3090/4090構成、または512 GBのMac Studio（M5 Ultra）で、いずれもCPU/GPUハイブリッドオフロード経由で約3〜9 tok/secとなります。',
          ...
          columns: ['GPU', 'Best For', 'Price', 'Speed', 'Tier'],
          callouts: [
            { type: 'warning', text: '現在の価格は変動が激しく、なお悪化しています。GDDR7不足によりRTX 5090の実勢価格は$4,300〜$5,000以上まで上昇しました — $1,999のMSRPの2倍以上です。生産終了のRTX 4090は新品時より中古の方が高くなっています。上記の価格は典型的な実勢価格です — 購入前に必ず現在の出品を確認してください。AMDのGDDR6ベースのRX 9070 XTは注目すべき例外で、価格急騰をほぼ回避しています。' },
          ],
        },
        vramMath: {
          id: 'vram-math',
        ...
        kvCache: {
          ...
          content: [
            ...
            '**これらの数値は、KテンソルとVテンソルにfp16（要素あたり2バイト）を使用していることを前提としています。** 量子化されたKVキャッシュ（llama.cppの `--cache-type-k q8_0` など）は、表の値のおよそ半分のVRAMで済みます。',
          ],
          columns: ['モデル', '4Kコンテキスト', '32Kコンテキスト', '128Kコンテキスト'],
          rows: [
            { 'モデル': 'Llama 3.1 8B', '4Kコンテキスト': '0.5 GB', '32Kコンテキスト': '4 GB', '128Kコンテキスト': '16 GB' },
            { 'モデル': 'Llama 3.3 70B', '4Kコンテキスト': '1.25 GB', '32Kコンテキスト': '10 GB', '128Kコンテキスト': '40 GB' },
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: '目安：このパーセンテージはモデルが大きくなるにつれて小さくなります — KVキャッシュはレイヤー数に比例して増加する一方、モデルの重みのサイズは総パラメータ数に比例して増加し、モデルが大きくなるほどレイヤー数の増加はパラメータ数の増加より緩やかになります。Llama 3.1 8B（32レイヤー）：32Kコンテキストのキャッシュは約4 GBで、Q4_K_Mの重み約4.7 GBに対して約85%です。Llama 3.3 70B（80レイヤー）：32Kコンテキストのキャッシュは約10 GBで、Q4_K_Mの重み約40 GBに対して約25%です。Ollamaのデフォルトコンテキストは2,048トークンです。より高く設定するには：Modelfileで PARAMETER num_ctx 32768。' },
          ],
        },
        gpuRecommendations: {
          id: 'gpu-recommendations',
          ...
          rows: [
            { 'ティア': 'Budget (~$585)', 'GPU': 'RTX 5060 Ti', 'VRAM': '16 GB', '最適な用途': '7-13B models', '速度': '~60 tok/s' },
            { 'ティア': 'Mainstream (~$880)', 'GPU': 'RTX 5070', 'VRAM': '12 GB', '最適な用途': '7-14B models', '速度': '~90 tok/s' },
            { 'ティア': 'Mid (~$979)', 'GPU': 'RTX 5070 Ti', 'VRAM': '16 GB', '最適な用途': '14-32B models', '速度': '~110 tok/s' },
            { 'ティア': 'High (~$1,450)', 'GPU': 'RTX 5080', 'VRAM': '16 GB', '最適な用途': '14-32B models', '速度': '~130 tok/s' },
            { 'ティア': 'Top (~$4,300–5,000+ street)', 'GPU': 'RTX 5090', 'VRAM': '32 GB', '最適な用途': '70B (Q4, light offload)', '速度': '~200 tok/s' },
          ...
          imageCaption: 'GPUティアの推奨（実勢価格）：約$585 RTX 5060 Ti（16GB、7-13B、60 tok/s）、約$880 RTX 5070（12GB、14B、90 tok/s）、約$1,450 RTX 5080（16GB、14-32B、130 tok/s）、約$4,300〜5,000以上 RTX 5090（32GB、70B、200 tok/s）、$4,699 DGX Spark（128GB、大規模MoE）。GPUの選択はCPUより10倍重要です。',
        },
        vramTiers: {
          id: 'vram-tiers',
          ...
          items: [
            ...
            '**48 GB以上 VRAM（RTX 6000 Ada、A100、DGX Spark）：** Llama 3.3 70B Q4_K_M（40 GB、完全に収まる）。Llama 4 Scout（17Bアクティブ／109B合計 MoE、Q4で約55 GB — 最良のロングコンテキスト10Mトークン／マルチモーダルの選択肢）。Llama 4 Maverick（17Bアクティブ、400B合計、MoE）。Llama 3.3 70B Q8_0（70 GB — 80 GB A100が必要）。NVIDIA DGX Spark（128 GBユニファイド）は、Q8_0での70Bまでのすべてのオープンウェイトモデルを58 GBの余裕をもって収めます — ただし最新のフロンティア級MoEモデルは別です：GLM-5.3（合計744B、40Bアクティブ）は積極的な2ビット量子化でも約239 GBを必要とし、DGX Sparkや単一の128 GB Mac Studioを大きく超えます。',
          ],
        },
        calculator: {
          id: 'interactive-calculator',
        ...
        modelsFor12GB: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'RTX 3060 12GBは予算重視のエントリーポイント（中古約$285）です。すべての12 GBモデルを実行しますが、古いメモリアーキテクチャのため、RTX 4070 Tiの約80〜90 tok/secに対して約60〜70 tok/secです。' },
          ],
        },
        modelsFor24GB: {
          id: 'models-24gb',
        ...
        cpuOnlyInference: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'CPU vs GPU速度の現実：中古のNVIDIA RTX 3060 12 GB（約$285）はLlama 3.1 8Bを70 tok/sec以上で実行します — CPUのみの推論におけるRyzen 9 7950Xより5〜8倍高速です。速度が重要なら、RAMを追加する前にGPUを購入してください。' },
          ...
          imageCaption: 'Ryzen 9 7950XでのCPUのみの推論速度：Gemma 2 2B Q8_0（28 tok/sec、最速）、Phi-4 Mini Q4_K_M（25 tok/sec、ベストな選択肢）、Llama 3.1 8B Q8_0（8 tok/sec）。中古のRTX 3060（$285）は5〜8倍高速を達成します。',
        },
        storage: {
          id: 'storage',
        ...
        cantAffordHardware: {
          ...
          content: [
            '$280〜400のGPUが予算を超える場合、またはラップトップが古すぎて最新の推論エンジンをサポートできない場合、**ローカルLLMは2026年のあなたにとって費用対効果が良くないかもしれません**。',
            '**実際のコストを計算しましょう：**',
        ...
        mac: {
          ...
          content: [
            ...
            '128 GBユニファイドメモリ（最大614 GB/s）を備えたM5 Maxは、ラップトップまたはMac Studioフォームファクタで70BモデルをQ4_K_Mで快適に — およそ12〜15 tok/secで — 実行します。M5 Pro（最大64 GBユニファイド、307 GB/s）は、KVキャッシュとマルチタスクのための十分な余裕をもって32Bモデルを扱います。M5 Maxでも、2ビット量子化であってもGLM-5.3が必要とする約239 GBには遠く及ばないことに注意してください — ここではAppleのユニファイドメモリの上限が、生の速度以上に重要になります。',
            '**Appleは2026年8月25日にMac miniとMac Studioのラインアップを刷新し、2026年9月22日から出荷を開始しました。** Mac miniは現在、M6（$899から、ユニファイドメモリ最大32 GB、170 GB/s）とM5 Pro（$1,699から、最大64 GB、307 GB/s）の構成になっています。Mac StudioはM5 Max（$2,499から、最大128 GB）とM5 Ultra（96 GBで$5,499から、最上位構成では256 GBまたは512 GBまで — 512 GB構成は2026年10月下旬に出荷予定で、価格は$10,000を大きく上回る見込み）にアップグレードされました。従来のM4 Mac mini（$599から）とM4 Pro Mac mini（最大$2,299、64 GBまで）、および従来のMac Studio M4 Max/M3 Ultraは、現在は旧世代となっています。',
            'M6またはM5 Ultraチップについては、独立したtok/secベンチマークはまだ存在しません — Appleはどちらについても第三者検証済みの推論性能値を公表していません。初めて、単一のMacがGLM-5.3（744B MoE、2ビットで約239 GB）を理論上ユニファイドメモリに収められるようになりました：最上位構成の512 GB Mac Studio M5 Ultraは、この必要量を十分な余裕をもって上回ります。実際のベンチマークが登場するまでは、4× RTX 3090/4090構成がGLM-5.3クラスのモデルにとって、より裏付けのあるローカル手段のままです。',
          ...
          rows: [
            { 'Mac': 'M-series 8 GB (Air / base)', 'GPU Memory': '8 GB unified', 'Best For': '3-4B models (Phi-4 Mini, Gemma 3 4B)', 'Limitation': '7B borderline; OS competes for RAM' },
            { 'Mac': 'M3 Pro MacBook Pro 16"', 'GPU Memory': '18 GB unified', 'Best For': '7-8B models (fast)', 'Limitation': 'Can run 14B slowly' },
            { 'Mac': 'Mac mini M6（$899から）', 'GPU Memory': '32 GB unified, 170 GB/s', 'Best For': '8-14B models', 'Limitation': 'No 32B+ headroom' },
            { 'Mac': 'M5 Pro (MacBook Pro / Mac mini、$1,699から)', 'GPU Memory': '64 GB unified, 307 GB/s', 'Best For': '32B models comfortably', 'Limitation': 'Llama 4 Scout runs well' },
            { 'Mac': 'M5 Max (MacBook Pro / Studio、$2,499から)', 'GPU Memory': '128 GB unified, up to 614 GB/s', 'Best For': '70B models at Q4_K_M', 'Limitation': '~12-15 tok/sec on 70B' },
            { 'Mac': 'Mac Studio M5 Ultra（$5,499から）', 'GPU Memory': '96-512 GB unified', 'Best For': '70B+ and large MoE', 'Limitation': '512GB is Oct 2026; no benchmarks yet' },
          ],
          columns: ['Mac', 'GPU Memory', 'Best For', 'Limitation'],
          image: '/images/mac-hardware-comparison-ja.svg',
          imageCaption: 'Macハードウェア比較：8 GB Mシリーズ（3〜4Bモデル）、M3 Pro 16"（18GB、7〜8B）、Mac mini M6（32GB、8-14B、$899）、M5 Pro（64GB、32B、$1,699）、M5 Max（128GB、70BをQ4_K_Mで約12〜15 tok/sec、$2,499）、Mac Studio M5 Ultra（最大512GB、GLM-5.3級の容量、$5,499）。16 GBユニファイドがMacで7Bモデルを使うための快適な最小値です。',
        },
        serverVsConsumer: {
          id: 'server-vs-consumer',
          ...
          imageCaption: 'コンシューマー vs サーバーハードウェア：RTX 5090（実勢約$4,300〜5,000以上、32GB、シングルユーザー、パートタイム）vs RTX 6000 Ada（$7,000以上、48GB、マルチユーザー、24時間365日の稼働）。コンシューマーハードウェアから始め、本番サービスを実行する場合のみサーバーグレードにアップグレードしましょう。',
        },
        dgxSpark: {
          id: 'dgx-spark',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'RTX 3060 12GBは2026年もローカルLLMに値しますか？', a: 'RTX 3060（12 GB）は古い（2021年アーキテクチャ）です。7B〜13BモデルをQ4で扱いますが40〜60トークン/秒を生み出します。中古は約$285、新品のRTX 5070（約$880）またはRTX 5060 Ti 16 GB（約$585）は2〜3倍高速です。RTX 3060はマルチカード構成のセカンダリGPUとしてのみ保持する価値があります。' },
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[ローカルLLM向けプロンプトエンジニアリング](/ja/local-llms/prompt-engineering-for-local-models) -- ローカルモデルの制約に合わせてプロンプトを最適化',
        ...
        sources: {
          ...
          title: '出典',
          items: [
            'NVIDIA. (2026). "GeForce GPU Specifications." [www.nvidia.com/en-us/geforce/graphics-cards/](https://www.nvidia.com/en-us/geforce/graphics-cards/) -- RTX 40シリーズおよびRTX 50シリーズGPUの公式VRAMと帯域幅仕様。',
            'Apple. (2026). "Apple M5 Chip." [www.apple.com/mac/](https://www.apple.com/mac/) -- M5 Pro/Maxの仕様、メモリ帯域幅、LLM性能の主張。M5は70BモデルをQ4_K_Mで快適に実行する初のMacです。',
            'NVIDIA. (2025). "DGX Spark Product Page." [www.nvidia.com/en-us/products/workstations/dgx-spark/](https://www.nvidia.com/en-us/products/workstations/dgx-spark/) -- GB10 Grace Blackwell Superchipと128 GBユニファイドメモリの公式仕様。',
            'Meta AI. (2024). "Llama 3.3 Model Card." [llama.meta.com/](https://llama.meta.com/) -- 公式のLlama 3.3 70B仕様とVRAM要件。',
            'Meta AI. (2025). "Llama 4 Model Card." [llama.meta.com/](https://llama.meta.com/) -- Llama 4 Scout/Maverick MoEアーキテクチャ、VRAM要件。',
            'Z.ai. (2026). "GLM-5.3: Built for Long-Horizon Tasks." [huggingface.co/blog/zai-org/glm-52-blog](https://huggingface.co/blog/zai-org/glm-52-blog) -- 公式GLM-5.3モデルカード：744B合計／40BアクティブのMoEアーキテクチャ、MITライセンス、リリース日。',
          ],
        },
      },
schema: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'RTX 3060（12 GB）は古い（2021年アーキテクチャ）です。7B〜13BモデルをQ4で扱いますが40〜60トークン/秒を生み出します。中古は約$285、新品のRTX 5070（約$880）またはRTX 5060 Ti 16 GB（約$585）は2〜3倍高速です。RTX 3060はマルチカード構成のセカンダリGPUとしてのみ保持する価値があります。',
            },
          },
          {
            '@type': 'Question',
      ...
      itemListSchema: {
        ...
        'numberOfItems': 7,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'Budget (~$585)', 'description': 'RTX 5060 Ti、16 GB VRAM。7〜13Bモデルを約60トークン/秒で実行。新品で最良の価値のカード。' },
          { '@type': 'ListItem', 'position': 2, 'name': 'Mainstream (~$880)', 'description': 'RTX 5070、12 GB VRAM。7〜14Bモデルを約90トークン/秒で実行。最良の価格対性能。' },
          { '@type': 'ListItem', 'position': 3, 'name': 'Mid (~$979)', 'description': 'RTX 5070 Ti、16 GB VRAM。14〜32Bモデルを約110トークン/秒で実行。堅実な性能。' },
          { '@type': 'ListItem', 'position': 4, 'name': 'High (~$1,450)', 'description': 'RTX 5080、16 GB VRAM。14〜32Bモデルを約130トークン/秒で実行。推奨。' },
          { '@type': 'ListItem', 'position': 5, 'name': 'Top (~$4,300–5,000+ street)', 'description': 'RTX 5090、32 GB VRAM。軽いオフロードで70BをQ4_K_Mで実行。約200トークン/秒。悪化するメモリ不足により価格は$1,999のMSRPの2倍以上のままです。' },
    ...
    zh: {
      ...
      seoTitle: 'GPU vs 迷你PC vs Mac：2026年本地LLM硬件该怎么选？',
      ...
      metaDescription: '对比GPU、迷你PC和Mac运行本地LLM：性价比、显存需求(8B–70B)、实测速度。附RTX 50系列与Apple M5选购建议，助你不花冤枉钱。',
      ...
      quickAnswerTop: {
        zh: {
          ...
          answer: '在2026年运行本地LLM，运行7B模型至少需要一张8 GB显存的GPU（NVIDIA RTX 5060 Ti或Apple M2），14B模型需要12 GB，24B模型需要16 GB，32B模型需要24 GB，70B模型需要40 GB以上。4位量化经验法则：显存（GB）≈ 参数（十亿）× 0.6——一个7B模型大约需要4-5 GB。由于统一内存，Apple Silicon（M3/M4/M5）对大多数用户来说是最佳性价比。GLM-5.3等前沿开放权重MoE模型（总计744B）是例外——即使采用激进的2-bit量化也需要约239 GB，超出任何单张消费级GPU或128 GB DGX Spark的能力。',
          bullets: [
            '7B 模型（Mistral、Phi-4 Mini）：Q4_K_M 下 4-5 GB 显存（建议使用 8 GB 显卡）— RTX 5060 Ti、RTX 4060、Mac M2',
            ...
            'GLM-5.3（744B MoE，40B 激活）：即使 2-bit 量化也需要约 239 GB —— 需要 4× RTX 3090/4090 配 192 GB+ 内存的主机，或 512 GB 的 Mac Studio（M5 Ultra）',
      ...
      sections: {
        tldr: {
          ...
          items: [
            '**7B Q4 经验法则**：Q4_K_M 量化下的 7B 模型大约需要 4-5 GB 显存（纯CPU推理则为系统内存）——4位精度下每十亿参数约 0.6 GB。这是无需完整显存计算即可快速估算任意 7B 级模型内存需求的方法。',
            ...
            '**纯CPU（16 GB 系统内存）**：Llama 3.2 3B Q8（20 tok/sec）或 Phi-4 Mini Q4_K_M（25 tok/sec）。一张二手 RTX 4060 8 GB（~$280）或全新 RTX 5060 Ti 16 GB（~$585）要快 5-10 倍。',
            ...
            '**价格**：GDDR7 短缺不但没有缓解反而恶化——RTX 5090 街价已攀升至 4,300-5,000 美元以上，且仍在上涨，RTX 4090 仍处于停产状态。预算有限的买家可关注 AMD RX 9070 XT（16 GB GDDR6，约 630-700 美元）——GDDR6 基本躲过了此次短缺，价格明显低于同显存的 RTX 5070 Ti。从有货的渠道购买；购买前查看实时价格。',
        ...
        bestGPUs: {
          ...
          items: [
            '**用于 7B 模型（Mistral、Phi-4、Llama 3.1）— 预算型：** RTX 5060 Ti 16 GB（~$585，比 429 美元官方定价高约 40%）或二手 RTX 4060 8 GB（~$280）。可在 Q4_K_M（~4-5 GB）下运行任何 7B 模型。速度：50–70 tok/sec。档位：预算型爱好者。',
            '**用于 14B 模型（Qwen3 14B、DeepSeek-R1）— 主流型：** RTX 5070（12 GB，~$880）。性价比最佳的新卡。Qwen3 14B Q4_K_M 运行良好且有余量。速度：85–110 tok/sec。档位：最受欢迎。',
            '**用于 24-32B 模型（Qwen3.6、Mistral Small）— 中端型：** RTX 5070 Ti（16 GB，~$979）或 RTX 5080（16 GB，~$1,450）。可运行 Mistral Small 3.1 24B 和 Devstral Small 24B Q4_K_M。速度：110–150 tok/sec。档位：专业开发者。预算替代方案：AMD RX 9070 XT（16 GB GDDR6，~$690–740）——GDDR6 基本躲过了短缺，因此在相近显存下比 RTX 5070 Ti 便宜 $150–250，不过 ROCm 在本地LLM工具生态上不如 CUDA 完善。',
            '**用于 70B 模型（Llama 3.3）— 高端型：** RTX 5090（32 GB，~$2,000 MSRP 但街价 ~$4,300–5,000+ 且仍在攀升）在轻度 CPU 卸载下可容纳 Q4_K_M 的 70B。二手 RTX 4090（24 GB，~$2,300）仅能在 Q2_K 下运行 70B。要完整运行 Q4_K_M，请使用双 RTX 5090。速度：~200 tok/sec（5090，较小模型）。档位：研究 + 生产。',
            '**用于 GLM-5.3（744B MoE，40B 激活）— 极限型：** 没有任何单张消费级 GPU 足够。2-bit 动态 GGUF 仍需要约 239 GB 的显存/内存总和。现实的本地方案：4× RTX 3090/4090 配 192 GB+ 系统内存的主机，或 512 GB 的 Mac Studio（M5 Ultra），两者通过 CPU/GPU 混合卸载均约为 3–9 tok/sec。',
          ...
          rows: [
            { 'GPU': 'RTX 5060 Ti (16 GB)', '最适合': '7-13B 模型', '价格': '~$585', '速度': '50–70 tok/s', '档位': '预算型' },
            { 'GPU': 'RTX 5070 (12 GB)', '最适合': '14B 模型', '价格': '~$880', '速度': '85–110 tok/s', '档位': '主流型' },
            { 'GPU': 'RX 9070 XT (16 GB)', '最适合': '24-32B 模型', '价格': '~$690–740', '速度': '90–130 tok/s', '档位': '预算替代方案' },
            ...
            { 'GPU': 'RTX 5090 (32 GB)', '最适合': '70B (Q4, 轻度卸载)', '价格': '~$2,000 MSRP（街价 ~$4,300–5,000+）', '速度': '~200 tok/s', '档位': '高端型' },
            { 'GPU': 'Dual RTX 5090', '最适合': '70B (Q4) 完整', '价格': '~$8,600–10,000', '速度': '300+ tok/s', '档位': '企业级' },
            { 'GPU': 'Mac M5 Max 128GB', '最适合': '70B (Q4)', '价格': '~$6,000', '速度': '~12–15 tok/s (70B)', '档位': '专业笔记本' },
            { 'GPU': '4× RTX 3090/4090 + 192GB RAM', '最适合': 'GLM-5.3 (2-bit)', '价格': '~$6,000–9,000', '速度': '3–9 tok/s', '档位': '极限 MoE' },
          ],
          columns: ['GPU', '最适合', '价格', '速度', '档位'],
          callouts: [
            { type: 'warning', text: '的价格波动剧烈且仍在恶化。GDDR7/内存短缺已将 RTX 5090 的街价推高至 4,300-5,000 美元以上——超过其 $1,999 MSRP 的两倍以上，而停产的 RTX 4090 现在的二手价格比新机时还高。上面的价格是典型街价——购买前请始终查看当前报价。AMD 基于 GDDR6 的 RX 9070 XT 是一个明显的例外：它基本未受此次涨价影响。' },
          ],
        },
        vramMath: {
          id: 'vram-math',
        ...
        kvCache: {
          ...
          content: [
            ...
            '**这些数字假设 K 和 V 张量使用 fp16（每个元素 2 字节）。** 量化后的 KV 缓存（例如 llama.cpp 中的 `--cache-type-k q8_0`）所需显存约为表中数值的一半。',
          ],
          columns: ['模型', '4K 上下文', '32K 上下文', '128K 上下文'],
          rows: [
            { '模型': 'Llama 3.1 8B', '4K 上下文': '0.5 GB', '32K 上下文': '4 GB', '128K 上下文': '16 GB' },
            { '模型': 'Llama 3.3 70B', '4K 上下文': '1.25 GB', '32K 上下文': '10 GB', '128K 上下文': '40 GB' },
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: '经验法则：随着模型变大，这个百分比会缩小——KV 缓存随层数增长，而模型权重大小随参数总量增长，且模型越大，层数的增长速度比参数量的增长速度越慢。Llama 3.1 8B（32 层）：32K 上下文缓存约为 4 GB，相对于约 4.7 GB 的 Q4_K_M 权重（约 85%）。Llama 3.3 70B（80 层）：32K 上下文缓存约为 10 GB，相对于约 40 GB 的 Q4_K_M 权重（约 25%）。Ollama 默认上下文为 2,048 个 token。要设置更高：在 Modelfile 中使用 PARAMETER num_ctx 32768。' },
          ],
        },
        gpuRecommendations: {
          id: 'gpu-recommendations',
          ...
          rows: [
            ...
            { '档位': '主流型 (~$880)', 'GPU': 'RTX 5070', '显存': '12 GB', '最适合': '7-14B 模型', '速度': '~90 tok/s' },
            { '档位': '中端 (~$979)', 'GPU': 'RTX 5070 Ti', '显存': '16 GB', '最适合': '14-32B 模型', '速度': '~110 tok/s' },
            { '档位': '高端 (~$1,450)', 'GPU': 'RTX 5080', '显存': '16 GB', '最适合': '14-32B 模型', '速度': '~130 tok/s' },
            { '档位': '顶级 (街价 ~$4,300–5,000+)', 'GPU': 'RTX 5090', '显存': '32 GB', '最适合': '70B (Q4, 轻度卸载)', '速度': '~200 tok/s' },
        ...
        modelsFor12GB: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'RTX 3060 12GB 是预算入门点（二手 ~$285）。它能运行所有 12 GB 模型，但由于较旧的内存架构，速度为 ~60-70 tok/sec，而 RTX 4070 Ti 为 ~80-90 tok/sec。' },
          ],
        },
        modelsFor24GB: {
          id: 'models-24gb',
        ...
        cpuOnlyInference: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'CPU vs GPU 速度现实：二手 NVIDIA RTX 3060 12 GB（~$285）以 70+ tok/sec 运行 Llama 3.1 8B——比纯CPU推理的 Ryzen 9 7950X 快 5-8 倍。如果速度重要，先买 GPU 再加内存。' },
          ...
          imageCaption: 'Ryzen 9 7950X 上的纯CPU推理速度：Gemma 2 2B Q8_0（28 tok/sec 最快），Phi-4 Mini Q4_K_M（25 tok/sec 最佳选择），Llama 3.1 8B Q8_0（8 tok/sec）。二手 RTX 3060（$285）快 5-8 倍。',
        },
        storage: {
          id: 'storage',
          title: '你需要多少存储？',
        ...
        cantAffordHardware: {
          ...
          title: '如果你买不起硬件怎么办？',
          content: [
            '如果 $280–400 的 GPU 超出你的预算，或你的笔记本太旧无法支持现代推理引擎，**本地LLM在2026年对你来说可能并不划算**。',
            '**计算真实成本：**',
        ...
        mac: {
          ...
          content: [
            ...
            '配备 128 GB 统一内存（高达 614 GB/s）的 M5 Max 可在笔记本或 Mac Studio 形态中舒适地运行 Q4_K_M 下的 70B 模型——大约 12-15 tok/sec。M5 Pro（高达 64 GB 统一内存，307 GB/s）处理 32B 模型并为 KV 缓存和多任务留有充裕余量。需要注意的是，M5 Max 即使在 2-bit 量化下也远远无法满足 GLM-5.3 约 239 GB 的需求——这是一个 Apple 统一内存上限比原始速度更重要的领域。',
            '**Apple 于 2026 年 8 月 25 日更新了 Mac mini 和 Mac Studio 阵容，自 2026 年 9 月 22 日起开始发货。** Mac mini 现在提供 M6（起售价 $899，统一内存最高 32 GB，170 GB/s）和 M5 Pro（起售价 $1,699，最高 64 GB，307 GB/s）配置。Mac Studio 升级为 M5 Max（起售价 $2,499，最高 128 GB）和 M5 Ultra（96 GB 起售价 $5,499，顶配可达 256 GB 或 512 GB——512 GB 版本于 2026 年 10 月下旬发货，预计售价远超 $10,000）。此前的 M4 Mac mini（起售价 $599）和 M4 Pro Mac mini（最高 $2,299，最多 64 GB），以及此前的 Mac Studio M4 Max / M3 Ultra，现在已是上一代产品。',
            'M6 或 M5 Ultra 芯片目前还没有独立的 tok/sec 基准测试——截至目前，Apple 尚未公布任何一方经第三方验证的推理数据。首次出现的情况是：单台 Mac 理论上可以在统一内存中容纳 GLM-5.3（744B MoE，2-bit 下约 239 GB）：顶配的 512 GB Mac Studio M5 Ultra 大幅超出这一需求。在真实基准测试出现之前，对于 GLM-5.3 级别的模型，4× RTX 3090/4090 主机仍是文档更完善的本地方案。',
          ...
          rows: [
            ...
            { 'Mac': 'Mac mini M6（起售价 $899）', 'GPU内存': '32 GB 统一, 170 GB/s', '最适合': '8-14B 模型', '局限': '没有 32B+ 的余量' },
            { 'Mac': 'M5 Pro（MacBook Pro / Mac mini，起售价 $1,699）', 'GPU内存': '64 GB 统一, 307 GB/s', '最适合': '舒适运行 32B 模型', '局限': 'Llama 4 Scout 运行良好' },
            { 'Mac': 'M5 Max（MacBook Pro / Studio，起售价 $2,499）', 'GPU内存': '128 GB 统一, 高达 614 GB/s', '最适合': 'Q4_K_M 下的 70B 模型', '局限': '70B 上 ~12-15 tok/sec' },
            { 'Mac': 'Mac Studio M5 Ultra（起售价 $5,499）', 'GPU内存': '96-512 GB 统一', '最适合': '70B+ 及大型 MoE 模型', '局限': '512GB 于2026年10月发货；暂无基准测试' },
          ],
          columns: ['Mac', 'GPU内存', '最适合', '局限'],
          image: '/images/mac-hardware-comparison-zh.svg',
          imageCaption: 'Mac 硬件对比：8 GB M 系列（3-4B 模型），M3 Pro 16"（18GB，7-8B），Mac mini M6（32GB，8-14B，$899），M5 Pro（64GB，32B，$1,699），M5 Max（128GB，Q4_K_M 下的 70B ~12-15 tok/sec，$2,499），Mac Studio M5 Ultra（最高 512GB，具备 GLM-5.3 级容量，$5,499）。16 GB 统一内存是 Mac 上 7B 模型的舒适最低配置。',
        },
        serverVsConsumer: {
          id: 'server-vs-consumer',
          ...
          items: [
            '**消费级（RTX 5090）**：~$2,000 MSRP（截至 2026 年 7 月街价 ~$4,300–5,000+），32 GB 显存，单用户，在持续负载下易热降频。',
          ...
          imageCaption: '消费级 vs 服务器硬件：RTX 5090（街价 ~$4,300–5,000+，32GB，单用户，兼职）vs RTX 6000 Ada（$7,000+，48GB，多用户，24/7 工作负荷）。从消费级硬件起步；仅在运行生产服务时升级到服务器级。',
        },
        dgxSpark: {
          id: 'dgx-spark',
          ...
          content: [
            ...
            '基于 GB10 Grace Blackwell Superchip 构建，DGX Spark 于 2025 年 10 月发布，配备 128 GB LPDDR5x 统一内存。注意：其真实内存带宽约为 273 GB/s，因此稠密 70B 的 token 生成很慢——独立测试（LMSYS）测得 Llama 70B 上约 3 tok/sec。标称的 FP4 计算数字并不转化为快速的单流解码。DGX Spark 最适合大型混合专家模型（Llama 4 Scout/Maverick、Kimi K2），其中每个 token 仅激活一小部分参数——但其 128 GB 上限并非无限：GLM-5.3（744B 总参数，40B 激活，2026 年 6 月发布）即使在 2-bit 量化下也需要约 239 GB，单台 DGX Spark 无法容纳。',
          ],
          columns: ['规格', '数值'],
          rows: [
            ...
            { '规格': 'GLM-5.3 at 2-bit (~239 GB)', '数值': '❌ 无法装入' },
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: '2026 年 RTX 3060 12GB 对本地LLM还值得吗？', a: 'RTX 3060（12 GB）已过时（2021 架构）。它在 Q4 下处理 7B-13B 模型，但产出 40-60 tokens/sec。二手约 $285；全新 RTX 5070（~$880）或 RTX 5060 Ti 16 GB（~$585）快 2-3 倍。RTX 3060 仅在多卡配置中作为辅助 GPU 时才值得保留。' },
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[本地LLM的提示工程](/zh/local-llms/prompt-engineering-for-local-models) -- 针对本地模型约束优化提示',
        ...
        sources: {
          ...
          title: '来源',
          items: [
            'NVIDIA. (2026). "GeForce GPU Specifications." [www.nvidia.com/en-us/geforce/graphics-cards/](https://www.nvidia.com/en-us/geforce/graphics-cards/) -- RTX 40 系列和 RTX 50 系列 GPU 的官方显存和带宽规格。',
            'Apple. (2026). "Apple M5 Chip." [www.apple.com/mac/](https://www.apple.com/mac/) -- M5 Pro/Max 规格、内存带宽、LLM 性能声明。M5 是首台能舒适运行 Q4_K_M 下 70B 模型的 Mac。',
            'NVIDIA. (2025). "DGX Spark Product Page." [www.nvidia.com/en-us/products/workstations/dgx-spark/](https://www.nvidia.com/en-us/products/workstations/dgx-spark/) -- GB10 Grace Blackwell Superchip 和 128 GB 统一内存的官方规格。',
            'Meta AI. (2024). "Llama 3.3 Model Card." [llama.meta.com/](https://llama.meta.com/) -- 官方 Llama 3.3 70B 规格和显存要求。',
            'Meta AI. (2025). "Llama 4 Model Card." [llama.meta.com/](https://llama.meta.com/) -- Llama 4 Scout/Maverick MoE 架构、显存要求。',
            'Z.ai. (2026). "GLM-5.3: Built for Long-Horizon Tasks." [huggingface.co/blog/zai-org/glm-52-blog](https://huggingface.co/blog/zai-org/glm-52-blog) -- GLM-5.3 官方模型卡：744B 总参数 / 40B 激活的 MoE 架构、MIT 许可证、发布日期。',
          ],
        },
      },
schema: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'RTX 3060（12 GB）已过时（2021 架构）。它在 Q4 下处理 7B-13B 模型，但产出 40-60 tokens/sec。二手约 $285；全新 RTX 5070（~$880）或 RTX 5060 Ti 16 GB（~$585）快 2-3 倍。RTX 3060 仅在多卡配置中作为辅助 GPU 时才值得保留。',
            },
          },
          {
            '@type': 'Question',
      ...
      itemListSchema: {
        ...
        'numberOfItems': 7,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': '预算型 (~$585)', 'description': 'RTX 5060 Ti，16 GB 显存。以 ~60 tokens/sec 运行 7-13B 模型。性价比最佳的新卡。' },
          { '@type': 'ListItem', 'position': 2, 'name': '主流型 (~$880)', 'description': 'RTX 5070，12 GB 显存。以 ~90 tokens/sec 运行 7-14B 模型。最佳性价比。' },
          { '@type': 'ListItem', 'position': 3, 'name': '中端 (~$979)', 'description': 'RTX 5070 Ti，16 GB 显存。以 ~110 tokens/sec 运行 14-32B 模型。稳健性能。' },
          { '@type': 'ListItem', 'position': 4, 'name': '高端 (~$1,450)', 'description': 'RTX 5080，16 GB 显存。以 ~130 tokens/sec 运行 14-32B 模型。推荐。' },
          { '@type': 'ListItem', 'position': 5, 'name': '顶级 (街价 ~$4,300–5,000+)', 'description': 'RTX 5090，32 GB 显存。以轻度卸载运行 Q4_K_M 下的 70B。~200 tokens/sec。持续恶化的内存短缺使价格远高于 $1,999 MSRP。' },
  ...
  ko: {
      ...
      quickAnswerTop: {
        ko: {
          ...
          answer: '2026년에 로컬 LLM을 실행하려면 7B 모델의 경우 최소 8GB VRAM GPU(NVIDIA RTX 3060 또는 Apple M2), 13B 모델의 경우 24GB, 70B 모델의 경우 48GB 이상이 필요합니다. 4비트 양자화 경험 법칙: VRAM(GB) ≈ 파라미터 수(십억 단위) × 0.6 — 7B 모델은 약 4~5GB면 됩니다. 통합 메모리 덕분에 Apple Silicon(M3/M4/M5)이 대부분의 사용자에게 최고의 가성비를 제공합니다. GLM-5.3(총 744B)와 같은 최신 오픈 가중치 MoE 모델은 예외입니다 — 공격적인 2비트 양자화에서도 약 239GB가 필요하며, 단일 소비자용 GPU나 128GB DGX Spark로도 부족합니다.',
          bullets: [
            ...
            'GLM-5.3(744B MoE, 활성 40B): 2비트에서도 ~239GB — 192GB 이상 RAM을 갖춘 4× RTX 3090/4090 조합 또는 512GB Mac Studio(M5 Ultra) 필요',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: '로컬 LLM 하드웨어는 VRAM으로 결정됩니다: 7B 모델은 8 GB, 13–14B는 12–16 GB, 70B 모델은 35–48 GB가 필요합니다. 2026년 입문용 최적 GPU는 중고 RTX 4060 8 GB(약 $280)입니다.' },
          ...
          items: [
            '**7B Q4 경험 법칙**: 7B 모델은 Q4_K_M 양자화에서 약 4~5GB VRAM(또는 CPU 추론 시 시스템 RAM)이 필요합니다 — 4비트 기준 파라미터 10억 개당 약 0.6GB입니다. 아래의 전체 VRAM 계산 없이 7B급 모델의 메모리를 가장 빠르게 추정하는 방법입니다.',
            ...
            '**CPU 전용(16GB 시스템 RAM)**: Llama 3.2 3B Q8(20 tok/sec) 또는 Phi-4 Mini Q4_K_M(25 tok/sec). 중고 RTX 4060 8GB(~$150) 또는 RTX 5060 Ti 12GB(~$280)는 5~10배 더 빠릅니다.',
            '**Apple M5 Max(128GB 통합)**: 최초로 70B 모델을 Q4_K_M으로 실행하는 Mac — 노트북 또는 Mac Studio 폼 팩터에서 듀얼 RTX 4090 데스크톱과 비교 가능한 성능.',
            '**현재 가격**: GDDR7 공급 부족이 완화되지 않고 악화되었습니다 — RTX 5090 실거래가는 $4,300~$5,000+까지 계속 상승 중입니다. 예산이 부족하다면 AMD RX 9070 XT(16GB GDDR6, ~$630~700)도 확인하십시오 — GDDR6는 이번 공급 부족의 영향을 크게 받지 않아 상대적으로 저렴합니다.',
        ...
        bestGPUs: {
          ...
          items: [
            ...
            '**33B 모델(Qwen3, Mistral Small)용 — 중급:** RTX 4080 또는 RTX 5080(16GB VRAM, ~$1000~1200). Devstral Small 24B Q4_K_M 실행 가능. 속도: 110~140 tok/sec. 티어: 전문 개발자. 예산형 대안: AMD RX 9070 XT(16GB GDDR6, ~$630~700) — GDDR6는 GDDR7 공급 부족의 영향을 크게 받지 않아 비슷한 VRAM 대비 더 저렴합니다.',
            '**70B 모델(Llama 3.3, Qwen 3.6)용 — 고급:** RTX 4090은 단종되어 중고로만 구할 수 있으며(24GB VRAM, EOL 가격대 ~$2,000~2,600, 평균 ~$2,300). Q3_K_M(~25GB)으로 70B 실행. Q4_K_M(40GB)을 위해서는 듀얼 RTX 4090 사용. 속도: 단일 GPU 기준 150~180 tok/sec. 티어: 연구 + 프로덕션.',
            '**GLM-5.3(744B MoE, 활성 40B)용 — 익스트림:** 단일 소비자용 GPU로는 부족합니다. 2비트 동적 GGUF조차 VRAM/RAM 합계 ~239GB가 필요합니다. 현실적인 로컬 경로: 192GB 이상 시스템 RAM을 갖춘 4× RTX 3090/4090 조합, 또는 512GB Mac Studio(M5 Ultra) — 둘 다 CPU/GPU 하이브리드 오프로드로 약 3~9 tok/sec입니다.',
          ...
          rows: [
            ...
            { 'GPU': 'RX 9070 XT (16GB)', '최적 용도': '24~32B 모델', '가격': '~$630~700', '속도': '90~130 tok/s', '티어': '예산형 대안' },
            { 'GPU': 'RTX 4080 / RTX 5080 (16GB)', '최적 용도': '33B 모델', '가격': '~$1000~1200', '속도': '110~140 tok/s', '티어': '전문가용' },
            { 'GPU': 'RTX 4090 (24GB, 중고)', '최적 용도': '70B (Q3)', '가격': '~$2,300 (EOL, $2,000~2,600)', '속도': '150~180 tok/s', '티어': 'EOL / 중고' },
            { 'GPU': '듀얼 RTX 4090', '최적 용도': '70B (Q4)', '가격': '~$4,000~4,600', '속도': '280~360 tok/s', '티어': '엔터프라이즈' },
            { 'GPU': 'Mac M5 Max 128GB', '최적 용도': '70B (Q4)', '가격': '~$6000', '속도': '120~160 tok/s', '티어': '프로 노트북' },
            { 'GPU': '4× RTX 3090/4090 + 192GB RAM', '최적 용도': 'GLM-5.3 (2-bit)', '가격': '~$6,000~9,000', '속도': '3~9 tok/s', '티어': '익스트림 MoE' },
          ],
        ...
        kvCache: {
          ...
          content: [
            ...
            '**이 수치는 K 및 V 텐서에 fp16(요소당 2바이트)을 사용한다고 가정합니다.** 양자화된 KV 캐시(예: llama.cpp의 `--cache-type-k q8_0`)는 표에 표시된 값의 약 절반의 VRAM을 사용합니다.',
          ],
          columns: ['모델', '4K 컨텍스트', '32K 컨텍스트', '128K 컨텍스트'],
          rows: [
            { '모델': 'Llama 3.1 8B', '4K 컨텍스트': '0.5GB', '32K 컨텍스트': '4GB', '128K 컨텍스트': '16GB' },
            { '모델': 'Llama 3.3 70B', '4K 컨텍스트': '1.25GB', '32K 컨텍스트': '10GB', '128K 컨텍스트': '40GB' },
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: '경험 법칙: 이 비율은 모델이 커질수록 줄어듭니다 — KV 캐시는 레이어 수에 비례해 증가하는 반면, 모델 가중치 크기는 전체 파라미터 수에 비례해 증가하며, 모델이 커질수록 레이어 수는 파라미터 수보다 더 천천히 증가합니다. Llama 3.1 8B(레이어 32개): 32K 컨텍스트 캐시는 약 4GB로 Q4_K_M 가중치 약 4.7GB 대비 약 85%입니다. Llama 3.3 70B(레이어 80개): 32K 컨텍스트 캐시는 약 10GB로 Q4_K_M 가중치 약 40GB 대비 약 25%입니다. Ollama 기본 컨텍스트는 2,048 토큰입니다. 높이려면 Modelfile에서 PARAMETER num_ctx 32768을 설정하십시오.' },
          ],
        },
        gpuRecommendations: {
          id: 'gpu-recommendations',
          ...
          rows: [
            ...
            { '티어': '최상급(~$4,300~5,000+ 실거래가)', 'GPU': 'RTX 5090', 'VRAM': '32GB', '최적 용도': '70B (경량 오프로드)', '속도': '~200 tok/s' },
        ...
        modelsFor12GB: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'RTX 3060 12GB는 예산 진입점(~$285 중고)입니다. 모든 12GB 모델을 실행하지만 구형 메모리 아키텍처로 인해 RTX 4070 Ti의 ~80~90 tok/sec에 비해 ~60~70 tok/sec 속도를 냅니다.' },
          ],
        },
        modelsFor24GB: {
          id: 'models-24gb',
        ...
        cpuOnlyInference: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'CPU vs GPU 속도 현실: 중고 NVIDIA RTX 3060 12GB(~$285)는 Llama 3.1 8B를 70+ tok/sec로 실행합니다 — CPU 전용 추론에서 Ryzen 9 7950X보다 5~8배 빠릅니다. 속도가 중요하다면 RAM 추가 전에 GPU를 구매하십시오.' },
          ...
          image: '/images/cpu-inference-speed-en.svg',
          imageCaption: 'Ryzen 9 7950X에서의 CPU 전용 추론 속도: Gemma 2 2B Q8_0(28 tok/sec 최고), Phi-4 Mini Q4_K_M(25 tok/sec 최선의 선택), Llama 3.1 8B Q8_0(8 tok/sec). 중고 RTX 3060($285)은 5~8배 더 빠른 속도를 달성합니다.',
        },
        storage: {
          id: 'storage',
        ...
        cantAffordHardware: {
          ...
          content: [
            '$280~400 GPU가 예산 범위를 벗어나거나 노트북이 너무 오래되어 최신 추론 엔진을 지원하지 못한다면, **2026년에 로컬 LLM은 비용 효율적이지 않을 수 있습니다**.',
            '**실제 비용 계산:**',
        ...
        mac: {
          ...
          content: [
            ...
            '128GB 통합 메모리를 갖춘 M5 Max는 Q4_K_M으로 70B 모델을 편안하게 실행하는 최초의 Apple Silicon 칩입니다 — 노트북 또는 Mac Studio 폼 팩터에서 듀얼 RTX 4090 데스크톱과 비교 가능합니다. 64GB 통합 메모리를 갖춘 M5 Pro는 KV 캐시와 멀티태스킹을 위한 넉넉한 여유 공간으로 32B 모델을 처리합니다. 다만 M5 Max조차 2비트에서도 ~239GB가 필요한 GLM-5.3에는 여전히 크게 못 미칩니다 -- 이 영역에서는 속도보다 Apple의 통합 메모리 상한선이 더 중요한 제약입니다.',
            '**Apple은 2026년 8월 25일 Mac mini와 Mac Studio 라인업을 새로 선보였으며, 2026년 9월 22일부터 출하됩니다.** Mac mini는 이제 M6($899부터, 통합 메모리 최대 32GB, 170GB/s)와 M5 Pro($1,699부터, 최대 64GB, 307GB/s) 구성으로 제공됩니다. Mac Studio는 M5 Max($2,499부터, 최대 128GB)와 M5 Ultra(96GB 기준 $5,499부터, 최상위 구성에서는 256GB 또는 512GB까지 — 512GB 모델은 2026년 10월 말 출하되며 가격은 $10,000를 크게 웃돌 것으로 예상)로 상위 등급이 확장되었습니다. 기존의 M4 Mac mini($599부터)와 M4 Pro Mac mini(최대 $2,299, 최대 64GB), 그리고 이전 Mac Studio M4 Max/M3 Ultra는 이제 이전 세대 제품입니다.',
            'M6나 M5 Ultra 칩에 대한 독립적인 tok/sec 벤치마크는 아직 존재하지 않습니다 -- Apple은 현재까지 두 칩 모두에 대해 제3자가 검증한 추론 성능 수치를 공개하지 않았습니다. 처음으로 단일 Mac이 이론적으로 GLM-5.3(744B MoE, 2비트에서 약 239GB)를 통합 메모리에 담을 수 있게 되었습니다: 최상위 구성인 512GB Mac Studio M5 Ultra는 이 요구량을 여유롭게 상회합니다. 실제 벤치마크가 나오기 전까지는 4× RTX 3090/4090 구성이 GLM-5.3급 모델을 위한 더 검증된 로컬 경로로 남아 있습니다.',
          ],
          rows: [
            { 'Mac': 'M3 MacBook Pro 16"', 'GPU 메모리': '18GB 통합', '최적 용도': '7B 모델(빠름)', '제한': '13B는 느리게 실행 가능' },
            { 'Mac': 'Mac mini M6($899부터)', 'GPU 메모리': '32GB 통합, 170GB/s', '최적 용도': '8~14B 모델', '제한': '32B 이상은 여유 없음' },
            { 'Mac': 'M5 Pro (MacBook Pro / Mac mini, $1,699부터)', 'GPU 메모리': '64GB 통합, 307GB/s', '최적 용도': '30B 모델 편안하게', '제한': 'Llama 4 Scout 원활하게 실행' },
            { 'Mac': 'M5 Max (MacBook Pro / Studio, $2,499부터)', 'GPU 메모리': '128GB 통합, 최대 614GB/s', '최적 용도': 'Q4_K_M에서 70B 모델', '제한': '70B를 제대로 수용하는 최초의 Mac' },
            { 'Mac': 'Mac Studio M5 Ultra($5,499부터)', 'GPU 메모리': '96~512GB 통합', '최적 용도': '70B+ 및 대형 MoE 모델', '제한': '512GB는 2026년 10월 출하; 벤치마크 아직 없음' },
          ],
          columns: ['Mac', 'GPU 메모리', '최적 용도', '제한'],
          image: '/images/mac-hardware-comparison-en.svg',
          imageCaption: 'Mac 하드웨어 비교: M3 MacBook Pro 16"(18GB, 7B), Mac mini M6(32GB, 8~14B, $899), M5 Pro(64GB, 30B, $1,699), M5 Max(128GB, Q4_K_M에서 70B, $2,499), Mac Studio M5 Ultra(최대 512GB, GLM-5.3급 용량, $5,499). M5 Max는 듀얼 RTX 4090 데스크톱에 필적하는 70B 모델을 처리하는 최초의 Mac입니다.',
        },
        serverVsConsumer: {
          id: 'server-vs-consumer',
          ...
          items: [
            '**소비자용(RTX 4090, 중고/EOL)**: ~$2,300(EOL 가격대 $2,000~2,600), 24GB VRAM, 단일 사용자, 지속적인 부하에서 열 제한 발생 가능.',
          ...
          image: '/images/server-vs-consumer-en.svg',
          imageCaption: '소비자용 vs 서버용 하드웨어: RTX 4090(~$2,300, 중고/EOL, 24GB, 단일 사용자, 부분 시간) vs RTX 6000 Ada($5000+, 48GB, 다중 사용자, 24/7). 소비자용 하드웨어로 시작하고, 프로덕션 서비스를 운영할 때만 서버급으로 업그레이드하십시오.',
        },
        dgxSpark: {
          id: 'dgx-spark',
          ...
          content: [
            ...
            'GB10 Grace Blackwell Superchip을 기반으로 구축된 DGX Spark는 128GB LPDDR5x 통합 메모리를 갖춘 컴팩트 데스크톱 AI 컴퓨터로 2025년 말에 출시되었습니다. 2026년 6월 기준으로 DGX Spark는 Llama 4 Scout와 Maverick을 메모리에 완전히 실행하고, Kimi K2.6(양자화)도 실행하여 이 티어에서 멀티 GPU 설정에 적합합니다 -- 하지만 128GB 한도가 무제한은 아닙니다: GLM-5.3(총 744B, 활성 40B, 2026년 6월 출시)는 2비트 양자화에서도 ~239GB가 필요하여 단일 DGX Spark에는 맞지 않습니다.',
          ],
          columns: ['사양', '값'],
          rows: [
            ...
            { '사양': 'GLM-5.3 @ 2-bit (~239GB)', '값': '❌ 수용 불가' },
            { '사양': '추론 속도(70B)', '값': '18~28 tok/s' },
            { '사양': '가격', '값': '$4,699' },
            { '사양': 'OS', '값': 'DGX OS(Ubuntu), Ollama 사전 설치' },
            { '사양': 'vs RTX 4090', '값': '5× 더 많은 VRAM, EOL 중고가(~$2,300) 대비 약 2배 더 비싼 가격' },
          ],
          callouts: [
            { type: 'keyPoint', text: '중고 2× RTX 4090(합산 48GB, EOL 가격대 기준 ~$4,000~4,600)과 비교: DGX Spark($4,699)는 2.7배 더 많은 메모리를 약 $100의 프리미엄으로 제공합니다. Q8_0 품질에서 70B가 특별히 필요하지 않은 한 RTX 4090 쌍이 여전히 더 나은 가성비입니다.' },
          ],
        },
        commonMistakes: {
          id: 'common-mistakes',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            {
              q: 'Q4 양자화에서 7B 모델의 메모리 경험 법칙은 무엇입니까?',
              a: '7B 모델은 Q4_K_M 양자화에서 약 4~5GB의 VRAM(또는 CPU 전용 추론 시 시스템 RAM)이 필요합니다 -- 4비트 정밀도 기준 파라미터 10억 개당 약 0.6GB입니다. 이는 선형적으로 확장됩니다: 14B 모델은 ~9GB, 32B 모델은 ~19GB, 70B 모델은 ~40GB가 필요하며, 모두 Q4_K_M 기준입니다.',
            },
            {
              q: 'GLM-5.3를 로컬에서 실행하려면 어떤 하드웨어가 필요합니까?',
              a: 'GLM-5.3(Z.ai, 2026년 6월 출시)는 토큰당 40B가 활성화되는 744B 파라미터 MoE 모델입니다. 가장 공격적인 2비트 동적 GGUF조차 VRAM/RAM 합계로 ~239GB가 필요합니다 -- 단일 RTX 5090(32GB), 128GB DGX Spark, 128GB Mac Studio로도 부족합니다. 현실적인 로컬 경로는 192GB 이상 시스템 RAM을 갖춘 4× RTX 3090/4090 조합, 또는 512GB Mac Studio(M5 Ultra)이며, 둘 다 CPU/GPU 하이브리드 오프로드로 약 3~9 tokens/sec로 동작합니다. 대부분의 사용자에게 GLM-5.3는 사실상 클라우드 전용입니다.',
            },
          ],
        },
        relatedReading: {
        ...
        sources: {
          ...
          title: '출처',
          items: [
            'NVIDIA. (2026). "GeForce GPU Specifications." [www.nvidia.com/en-us/geforce/graphics-cards/](https://www.nvidia.com/en-us/geforce/graphics-cards/) -- RTX 40 시리즈 및 RTX 50 시리즈 GPU의 공식 VRAM 및 대역폭 사양.',
            'Apple. (2026). "Apple M5 Chip." [www.apple.com/mac/](https://www.apple.com/mac/) -- M5 Pro/Max 사양, 메모리 대역폭, LLM 성능 주장. M5는 Q4_K_M에서 70B 모델을 편안하게 실행하는 최초의 Mac입니다.',
            'NVIDIA. (2025). "DGX Spark Product Page." [www.nvidia.com/en-us/products/workstations/dgx-spark/](https://www.nvidia.com/en-us/products/workstations/dgx-spark/) -- GB10 Grace Blackwell Superchip 및 128GB 통합 메모리 공식 사양.',
            'Meta AI. (2024). "Llama 3.3 Model Card." [llama.meta.com/](https://llama.meta.com/) -- 공식 Llama 3.3 70B 사양 및 VRAM 요구 사항.',
            'Meta AI. (2025). "Llama 4 Model Card." [llama.meta.com/](https://llama.meta.com/) -- Llama 4 Scout/Maverick MoE 아키텍처, VRAM 요구 사항.',
            'Z.ai. (2026). "GLM-5.3: Built for Long-Horizon Tasks." [huggingface.co/blog/zai-org/glm-52-blog](https://huggingface.co/blog/zai-org/glm-52-blog) -- GLM-5.3 공식 모델 카드: 총 744B / 활성 40B MoE 아키텍처, MIT 라이선스, 출시일.',
          ],
        },
      },
      howToSchema: {
      ...
      itemListSchema: {
        ...
        'numberOfItems': 7,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': '예산형(~$585)', 'description': '16GB VRAM의 RTX 5060 Ti. 7~13B 모델을 ~60 tok/sec로 실행. 가성비가 가장 좋은 신제품 카드.' },
          { '@type': 'ListItem', 'position': 2, 'name': '메인스트림(~$880)', 'description': '12GB VRAM의 RTX 5070. 7~14B 모델을 ~90 tok/sec로 실행. 최고의 가격 대비 성능.' },
          { '@type': 'ListItem', 'position': 3, 'name': '중급(~$979)', 'description': '16GB VRAM의 RTX 5070 Ti. 14~32B 모델을 ~110 tok/sec로 실행. 안정적인 성능.' },
          { '@type': 'ListItem', 'position': 4, 'name': '고급(~$1,450)', 'description': '16GB VRAM의 RTX 5080. 14~32B 모델을 ~130 tok/sec로 실행. 추천.' },
