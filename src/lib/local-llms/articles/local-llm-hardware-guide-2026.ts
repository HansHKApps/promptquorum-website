      ...
      sections: {
        ...
        bestGPUs: {
          ...
          items: [
            ...
            '**For 14B Models (Llama 3.3, DeepSeek-R1) — Mainstream:** RTX 4070 Ti (12 GB VRAM, ~$500–600). Best price-to-performance. Qwen2.5 14B Q4_K_M runs well. Speed: 85–120 tok/sec. Tier: Most popular.',
        ...
        vramTiers: {
          ...
          items: [
            ...
            '**12 GB VRAM (RTX 4070 Ti, RTX 5070, Intel B770):** Llama 3.3 8B (4.7 GB, fast with headroom). Qwen2.5 14B Q4_K_M (8.5 GB, better reasoning on budget). Qwen3 8B (5 GB, best multilingual + coding). DeepSeek-R1 8B (5 GB, best reasoning). Avoid 30B+ and MoE models like Llama 4 Scout (~55 GB at Q4).',
        ...
        modelsFor12GB: {
          ...
          content: [
            ...
            'Llama 3.3 8B at Q8_0 is the most reliable choice for conservative setups: 9 GB VRAM, 80 tok/sec, and full instruction-following quality. Qwen2.5 14B at Q4_K_M also fits at ~8.5 GB and delivers notably better reasoning than the 8B tier.',
          ],
          rows: [
          ...
          callouts: [
            { type: 'proTip', text: '🏆 Best overall for 12 GB: Llama 3.3 8B Q8_0 at ~9 GB, 80 tok/sec. For better reasoning on the same card, use Qwen2.5 14B Q4_K_M at ~8.5 GB. Llama 4 Scout does not fit -- its 109B total MoE experts need ~55 GB at Q4.' },
        ...
        llamaCppSpeed: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'RTX 4070 Ti speed reference: Llama 3.3 8B Q4_K_M = 85-95 tok/sec. Llama 3.3 13B Q4_K_M = 60-70 tok/sec. Qwen2.5 7B Q8_0 = 90-95 tok/sec. These assume --n-gpu-layers 99 and --ctx-size 2048.' },
      ...
      sections: {
        ...
        bestGPUs: {
          ...
          items: [
            ...
            '**Para modelos 14B (Llama 3.3, DeepSeek-R1) — Mainstream:** RTX 4070 Ti (12 GB VRAM, ~$500–600). Mejor relación precio-rendimiento. Qwen2.5 14B Q4_K_M funciona bien. Velocidad: 85–120 tok/s. Nivel: El más popular.',
        ...
        vramTiers: {
          ...
          items: [
            ...
            '**12 GB VRAM (RTX 4070 Ti, RTX 5070, Intel B770):** Llama 3.3 8B (4,7 GB, rápido con margen). Qwen2.5 14B Q4_K_M (8,5 GB, mejor razonamiento en presupuesto). Qwen3 8B (5 GB, mejor multilingüe + programación). DeepSeek-R1 8B (5 GB, mejor razonamiento). Evita 30B+ y modelos MoE como Llama 4 Scout (~55 GB en Q4).',
        ...
        modelsFor12GB: {
          ...
          content: [
            ...
            'Llama 3.3 8B en Q8_0 es la opción más confiable para configuraciones conservadoras: 9 GB de VRAM, 80 tok/s y calidad completa de seguimiento de instrucciones. Qwen2.5 14B en Q4_K_M también cabe a ~8,5 GB y ofrece un razonamiento notablemente mejor que el nivel 8B.',
          ],
          rows: [
          ...
          callouts: [
            { type: 'proTip', text: '🏆 Mejor general para 12 GB: Llama 3.3 8B Q8_0 a ~9 GB, 80 tok/s. Para mejor razonamiento en la misma tarjeta, usa Qwen2.5 14B Q4_K_M a ~8,5 GB. Llama 4 Scout no cabe -- sus 109B expertos totales MoE necesitan ~55 GB en Q4.' },
        ...
        llamaCppSpeed: {
          ...
          callouts: [
            ...
            { type: 'keyPoint', text: 'Referencia de velocidad RTX 4070 Ti: Llama 3.3 8B Q4_K_M = 85-95 tok/s. Llama 3.3 13B Q4_K_M = 60-70 tok/s. Qwen2.5 7B Q8_0 = 90-95 tok/s. Estos valores asumen --n-gpu-layers 99 y --ctx-size 2048.' },
