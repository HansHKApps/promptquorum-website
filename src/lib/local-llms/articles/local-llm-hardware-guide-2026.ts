...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      current_hardware_mentioned: ['RTX 5060 Ti', 'RTX 5070', 'RTX 5070 Ti', 'RTX 5080', 'RTX 5090', 'RTX 4090 (EOL/used)', 'RTX 3090', 'RX 9070 XT', 'DGX Spark', 'Apple M5 Pro/Max'],
      ...
      quickAnswerTop: {
        en: {
          ...
          bullets: [
            ...
            'GLM-5.2 (744B MoE, 40B active): ~239 GB even at 2-bit — needs a 4× RTX 3090/4090 rig with 192 GB+ RAM or a 256 GB+ Mac Studio',
      ...
      sections: {
        ...
        bestGPUs: {
          ...
          items: [
            ...
            '**For GLM-5.2 (744B MoE, 40B active) — Extreme:** no single consumer GPU is enough. The 2-bit dynamic GGUF still needs ~239 GB combined VRAM/RAM. Realistic local paths: a 4× RTX 3090/4090 rig with 192 GB+ system RAM, or a 256 GB+ Mac Studio, both around 3–9 tok/sec via CPU/GPU hybrid offload.',
        ...
        mac: {
          ...
          content: [
            ...
            'The M5 Max with 128 GB unified memory (up to 614 GB/s) runs 70B models at Q4_K_M comfortably — roughly 12-15 tok/sec — in a laptop or Mac Studio form factor. The M5 Pro (up to 64 GB unified, 307 GB/s) handles 32B models with generous headroom for KV cache and multitasking. As of July 2026 the M5 Max is the top shipping Apple Silicon; an M5 Ultra Mac Studio is rumoured but not yet released. Note the M5 Max still falls far short of the ~239 GB GLM-5.2 needs even at 2-bit -- an area where Apple\'s unified memory ceiling matters more than raw speed.',
      ...
      quickAnswerTop: {
        es: {
          ...
          bullets: [
            ...
            'GLM-5.2 (744B MoE, 40B activos): ~239 GB incluso a 2 bits — necesita una configuración con 4× RTX 3090/4090 y 192 GB+ de RAM o un Mac Studio de 256 GB+',
      ...
      quickAnswerTop: {
        ar: {
          ...
          bullets: [
            ...
            'GLM-5.2 (744B MoE، 40B نشط): ~239 GB حتى عند تكميم 2-بت — يحتاج نظام 4× RTX 3090/4090 بذاكرة نظام 192 GB+ أو Mac Studio بسعة 256 GB+',
          ],
          updatedDate: '2026-07-14',
        },
      },
      ...
      quickAnswerTop: {
        pt: {
          ...
          bullets: [
            ...
            'GLM-5.2 (744B MoE, 40B ativos): ~239 GB mesmo em 2 bits — precisa de uma configuração com 4× RTX 3090/4090 e 192 GB+ de RAM ou um Mac Studio de 256 GB+',
      ...
      quickAnswerTop: {
        de: {
          ...
          bullets: [
            ...
            'GLM-5.2 (744B MoE, 40B aktiv): ~239 GB selbst bei 2-Bit — braucht ein 4×-RTX-3090/4090-Rig mit 192 GB+ RAM oder einen Mac Studio mit 256 GB+',
      ...
      sections: {
        ...
        mac: {
          ...
          content: [
            ...
            'Der M5 Max mit 128 GB Unified Memory (bis zu 614 GB/s) betreibt 70B-Modelle bei Q4_K_M bequem — etwa 12-15 tok/sec — im Laptop- oder Mac-Studio-Formfaktor. Der M5 Pro (bis zu 64 GB unified, 307 GB/s) bewaeltigt 32B-Modelle mit grosszuegiger Reserve fuer KV-Cache und Multitasking. Stand Juli 2026 ist der M5 Max das staerkste ausgelieferte Apple Silicon; ein M5 Ultra Mac Studio wird geruechtet, aber noch nicht veroeffentlicht. Beachte, dass der M5 Max den ~239-GB-Bedarf von GLM-5.2 selbst bei 2-Bit noch weit verfehlt -- ein Bereich, in dem Apples Unified-Memory-Obergrenze mehr zaehlt als reine Geschwindigkeit.',
      ...
      quickAnswerTop: {
        fr: {
          ...
          bullets: [
            ...
            'GLM-5.2 (744B MoE, 40B actifs) : ~239 Go meme en 2 bits — necessite un rig 4x RTX 3090/4090 avec 192 Go+ de RAM ou un Mac Studio 256 Go+',
      ...
      quickAnswerTop: {
        ja: {
          ...
          bullets: [
            ...
            'GLM-5.2（744B MoE、40Bアクティブ）：2ビットでも約239 GB — 192 GB以上のRAMを搭載した4× RTX 3090/4090構成、または256 GB以上のMac Studioが必要',
      ...
      sections: {
        ...
        bestGPUs: {
          ...
          items: [
            ...
            '**GLM-5.2（744B MoE、40Bアクティブ）向け — エクストリーム：** 単一のコンシューマーGPUでは足りません。2ビットのダイナミックGGUFでも約239 GBの合計VRAM/RAMが必要です。現実的なローカル構成は、192 GB以上のシステムRAMを搭載した4× RTX 3090/4090構成、または256 GB以上のMac Studioで、いずれもCPU/GPUハイブリッドオフロード経由で約3〜9 tok/secとなります。',
        ...
        mac: {
          ...
          content: [
            ...
            '128 GBユニファイドメモリ（最大614 GB/s）を備えたM5 Maxは、ラップトップまたはMac Studioフォームファクタで70BモデルをQ4_K_Mで快適に — およそ12〜15 tok/secで — 実行します。M5 Pro（最大64 GBユニファイド、307 GB/s）は、KVキャッシュとマルチタスクのための十分な余裕をもって32Bモデルを扱います。2026年7月時点でM5 Maxは出荷中の最上位Apple Siliconです。M5 Ultra Mac Studioは噂されていますがまだ発売されていません。M5 Maxでも、2ビット量子化であってもGLM-5.2が必要とする約239 GBには遠く及ばないことに注意してください — ここではAppleのユニファイドメモリの上限が、生の速度以上に重要になります。',
      ...
      quickAnswerTop: {
        zh: {
          ...
          bullets: [
            ...
            'GLM-5.2（744B MoE，40B 激活）：即使 2-bit 量化也需要约 239 GB —— 需要 4× RTX 3090/4090 配 192 GB+ 内存的主机，或 256 GB+ 的 Mac Studio',
      ...
      sections: {
        ...
        bestGPUs: {
          ...
          items: [
            ...
            '**用于 GLM-5.2（744B MoE，40B 激活）— 极限型：** 没有任何单张消费级 GPU 足够。2-bit 动态 GGUF 仍需要约 239 GB 的显存/内存总和。现实的本地方案：4× RTX 3090/4090 配 192 GB+ 系统内存的主机，或 256 GB+ 的 Mac Studio，两者通过 CPU/GPU 混合卸载均约为 3–9 tok/sec。',
        ...
        mac: {
          ...
          content: [
            ...
            '配备 128 GB 统一内存（高达 614 GB/s）的 M5 Max 可在笔记本或 Mac Studio 形态中舒适地运行 Q4_K_M 下的 70B 模型——大约 12-15 tok/sec。M5 Pro（高达 64 GB 统一内存，307 GB/s）处理 32B 模型并为 KV 缓存和多任务留有充裕余量。截至 2026 年 7 月，M5 Max 是出货的顶级 Apple Silicon；传闻有 M5 Ultra Mac Studio 但尚未发布。需要注意的是，M5 Max 即使在 2-bit 量化下也远远无法满足 GLM-5.2 约 239 GB 的需求——这是一个 Apple 统一内存上限比原始速度更重要的领域。',
      ...
      quickAnswerTop: {
        ko: {
          ...
          bullets: [
            ...
            'GLM-5.2(744B MoE, 활성 40B): 2비트에서도 ~239GB — 192GB 이상 RAM을 갖춘 4× RTX 3090/4090 조합 또는 256GB 이상 Mac Studio 필요',
      ...
      sections: {
        ...
        bestGPUs: {
          ...
          items: [
            ...
            '**GLM-5.2(744B MoE, 활성 40B)용 — 익스트림:** 단일 소비자용 GPU로는 부족합니다. 2비트 동적 GGUF조차 VRAM/RAM 합계 ~239GB가 필요합니다. 현실적인 로컬 경로: 192GB 이상 시스템 RAM을 갖춘 4× RTX 3090/4090 조합, 또는 256GB 이상 Mac Studio — 둘 다 CPU/GPU 하이브리드 오프로드로 약 3~9 tok/sec입니다.',
