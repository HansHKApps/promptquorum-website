...
schema: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Does an RTX 4070 laptop support LLM quantization?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes. RTX 4070 laptops (8 GB VRAM) support Q4 and Q5 quantization for 7-13B models at 50-70 tokens/sec. Opus 4.7 Sonnet laptops with RTX 4090M (24 GB) handle 30B models. Quantization is essential for laptop inference—without it, only 3-7B models fit in 8 GB VRAM.' } },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
    ...
    es: {
      ...
      seoTitle: 'Hardware LLM Local 2026: Guía de VRAM y GPU para 7B a 70B',
      ...
      metaDescription: 'Modelos 7B necesitan 8 GB VRAM, 13B necesitan 16 GB, 70B necesitan 40 GB en Q4. RTX 4070 Ti para 14B, RTX 4090 para 32B, M5 Max para 70B. Benchmarks GPU, mayo 2026.',
      publishDate: '2026-04-04',
      ...
      sections: {
        ...
        vramMath: {
          ...
          rows: [
            { 'Modelo': 'Llama 4 Scout 17B (activo)', 'FP16': '~34 GB', 'Q8_0': '~18 GB', 'Q5_K_M': '~12 GB', 'Q4_K_M': '~10 GB' },
        ...
        modelsFor12GB: {
          ...
          rows: [
            { 'Modelo': 'Llama 4 Scout 17B', 'Cuantización': 'Q4_K_M', 'VRAM usada': '~10 GB', 'Velocidad (RTX 4070 Ti)': '~65 tok/s', 'Ideal para': 'Mejor general (MoE)', '¿Cabe en 12 GB?': '✅ Sí' },
            { 'Modelo': 'Llama 3.1 8B', 'Cuantización': 'Q8_0', 'VRAM usada': '~9 GB', 'Velocidad (RTX 4070 Ti)': '80 tok/s', 'Ideal para': 'Chat general + programación', '¿Cabe en 12 GB?': '✅ Sí' },
          ...
          callouts: [
            { type: 'proTip', text: '🏆 Mejor general para 12 GB: Llama 4 Scout 17B Q4_K_M a ~10 GB. La arquitectura MoE significa 17B parámetros activos con 109B en total — mejor calidad que cualquier modelo denso 8B a costo similar de VRAM. Si prefieres modelos densos, usa Llama 3.1 8B Q8_0 a ~9 GB.' },
