...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      heroImage: '/images/run-70b-models-24gb-vram-overview-hero-en.webp',
      seoTitle: 'Run 70B Models on 24 GB VRAM: Complete Setup Guide 2026',
      intro: 'Running a 70B model (normally requires 40+ GB) on 24 GB VRAM is possible with aggressive quantization (Q2-Q3) and layer offloading, but the result is slow (~3-5 tokens/sec). This is impractical for real-time chat but viable for batch processing or experimentation.',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'A 70B model, which normally needs 40+ GB of VRAM, can run on a 24 GB card using aggressive Q2-Q3 quantization and layer offloading, but the result is slow at only 3-5 tokens per second -- impractical for real-time chat but usable for batch jobs or experimentation.' },
            { type: 'plain-terms', text: "You can technically squeeze a 70B model onto a 24 GB graphics card, but it's a workaround, not a good experience. The model gets compressed hard and the GPU has to swap parts in and out of memory constantly, so responses trickle out slowly. It's fine if you're running something overnight or just testing whether the model works at all, but not for a live conversation." },
          ],
          items: [
            ...
            'This is a constraint workaround, not a recommended approach.',
          ],
        },
        limits: {
          id: 'limits',
          ...
          rows: [
            { 'Quantization': 'FP16 (baseline)', 'Model Size': '140 GB', 'Fits 24GB?': 'No' },
            { 'Quantization': 'Q8 (8-bit)', 'Model Size': '70 GB', 'Fits 24GB?': 'No' },
            { 'Quantization': 'Q5 (5-bit)', 'Model Size': '43.75 GB', 'Fits 24GB?': 'No' },
            { 'Quantization': 'Q4 (4-bit)', 'Model Size': '35 GB', 'Fits 24GB?': 'No (with offloading: maybe)' },
            { 'Quantization': 'Q3 (3-bit)', 'Model Size': '26 GB', 'Fits 24GB?': 'No (barely)' },
            { 'Quantization': 'Q2 (2-bit)', 'Model Size': '17.5 GB', 'Fits 24GB?': 'Yes' },
          ],
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Overnight batch processing — tasks where you submit 100+ prompts and retrieve results hours later. Examples: document analysis, code review batches, dataset annotation. Real-time chat is impractical at 1–8 tokens/sec. For interactive use, a second RTX 4090 ($2,000–$2,600 used market) with layer splitting achieves ~100 tokens/sec — a far better investment.',
            },
            {
...
schema: {
    ...
    de: {
      ...
      heroImage: '/images/run-70b-models-24gb-vram-overview-hero-de.webp',
      seoTitle: '70B-Modelle mit 24 GB VRAM ausführen 2026',
      intro: 'Ein 70B-Modell (normalerweise 40+ GB erforderlich) auf 24 GB VRAM auszuführen ist mit aggressiver Quantisierung (Q2-Q3) und Layer-Offloading möglich, aber das Ergebnis ist langsam (~3-5 Token/Sek.). Dies ist unpraktisch für Echtzeit-Chat, aber praktikabel für Batch-Verarbeitung oder Experimente.',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'Ein 70B-Modell, das normalerweise 40+ GB VRAM benötigt, kann mit aggressiver Q2-Q3-Quantisierung und Layer-Offloading auf einer 24-GB-Karte laufen, allerdings nur mit 3-5 Tokens pro Sekunde -- unpraktisch für Echtzeit-Chat, aber nutzbar für Batch-Jobs oder Experimente.' },
            { type: 'plain-terms', text: 'Technisch lässt sich ein 70B-Modell auf eine 24-GB-Grafikkarte quetschen, aber es ist eher ein Workaround als eine gute Erfahrung. Das Modell wird stark komprimiert, und die GPU muss ständig Teile in und aus dem Speicher tauschen, sodass Antworten nur tröpfchenweise kommen. Für einen Lauf über Nacht oder zum Testen, ob das Modell überhaupt funktioniert, ist das in Ordnung -- für ein Live-Gespräch nicht.' },
          ],
          items: [
            ...
            'Dies ist eine Constraint-Behebung, keine empfohlene Methode.',
          ],
        },
        limits: {
          id: 'limits',
          ...
          rows: [
            { 'Quantisierung': 'FP16 (Baseline)', 'Modellgröße': '140 GB', 'Passt in 24GB?': 'Nein' },
            { 'Quantisierung': 'Q8 (8-Bit)', 'Modellgröße': '70 GB', 'Passt in 24GB?': 'Nein' },
            { 'Quantisierung': 'Q5 (5-Bit)', 'Modellgröße': '43,75 GB', 'Passt in 24GB?': 'Nein' },
            { 'Quantisierung': 'Q4 (4-Bit)', 'Modellgröße': '35 GB', 'Passt in 24GB?': 'Nein (mit Offloading: vielleicht)' },
            { 'Quantisierung': 'Q3 (3-Bit)', 'Modellgröße': '26 GB', 'Passt in 24GB?': 'Nein (knapp)' },
            { 'Quantisierung': 'Q2 (2-Bit)', 'Modellgröße': '17,5 GB', 'Passt in 24GB?': 'Ja' },
          ],
    ...
    fr: {
      ...
      heroImage: '/images/run-70b-models-24gb-vram-overview-hero-fr.webp',
      seoTitle: 'Exécuter des modèles 70B sur 24 Go de VRAM : Guide complet 2026',
      intro: 'Exécuter un modèle 70B (nécessite normalement 40+ Go) sur 24 Go de VRAM est possible avec une quantification agressive (Q2-Q3) et un déchargement de couches, mais le résultat est lent (~3-5 tokens/sec). C\'est peu pratique pour le chat en temps réel, mais viable pour le traitement par lot ou les expériences.',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: "Un modèle 70B, qui nécessite normalement 40+ Go de VRAM, peut tourner sur une carte 24 Go avec une quantification agressive Q2-Q3 et un déchargement de couches, mais le résultat est lent, à seulement 3-5 tokens par seconde -- peu pratique pour le chat en temps réel mais utilisable pour des tâches par lot ou de l'expérimentation." },
            { type: 'plain-terms', text: "On peut techniquement caser un modèle 70B sur une carte graphique de 24 Go, mais c'est un contournement, pas une bonne expérience. Le modèle est fortement compressé et le GPU doit constamment échanger des parties en mémoire, donc les réponses arrivent au compte-gouttes. C'est acceptable pour un traitement de nuit ou pour tester si le modèle fonctionne, mais pas pour une conversation en direct." },
          ],
          items: [
            ...
            'C\'est une solution de contournement, pas une approche recommandée.',
          ],
        },
        limits: {
          id: 'limits',
          ...
          rows: [
            { 'Quantification': 'FP16 (baseline)', 'Taille du modèle': '140 Go', 'Convient en 24 Go?': 'Non' },
            { 'Quantification': 'Q8 (8-bit)', 'Taille du modèle': '70 Go', 'Convient en 24 Go?': 'Non' },
            { 'Quantification': 'Q5 (5-bit)', 'Taille du modèle': '43.75 Go', 'Convient en 24 Go?': 'Non' },
            { 'Quantification': 'Q4 (4-bit)', 'Taille du modèle': '35 Go', 'Convient en 24 Go?': 'Non (avec déchargement : peut-être)' },
            { 'Quantification': 'Q3 (3-bit)', 'Taille du modèle': '26 Go', 'Convient en 24 Go?': 'Non (juste)' },
            { 'Quantification': 'Q2 (2-bit)', 'Taille du modèle': '17.5 Go', 'Convient en 24 Go?': 'Oui' },
          ],
    ...
    ja: {
      ...
      heroImage: '/images/run-70b-models-24gb-vram-overview-hero-ja.webp',
      seoTitle: '24GB VRAMで70Bモデルを実行: 完全セットアップガイド 2026',
      intro: '70Bモデル（通常40GB以上必要）を24GB VRAMで実行することは、積極的な量子化（Q2-Q3）とレイヤーオフロードで可能ですが、結果は遅い（〜3-5 tokens/秒）。リアルタイムチャットには非実用的ですが、バッチ処理または実験用途には実行可能です。',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: '通常40GB以上のVRAMが必要な70Bモデルは、積極的なQ2-Q3量子化とレイヤーオフロードを使えば24GBのカードでも動作しますが、結果は毎秒わずか3〜5トークンと遅く、リアルタイムチャットには非実用的ですが、バッチ処理や実験には使えます。' },
            { type: 'plain-terms', text: '技術的には24GBのグラフィックカードに70Bモデルを詰め込むことはできますが、それは回避策であり、良い体験ではありません。モデルは強く圧縮され、GPUは常にメモリの内容を入れ替える必要があるため、応答がゆっくりとしか出てきません。一晩かけて処理する場合や、モデルが動くかどうかをテストするだけなら問題ありませんが、リアルタイムの会話には向きません。' },
          ],
          items: [
        ...
        limits: {
          ...
          rows: [
            { '量子化': 'FP16（ベースライン）', 'モデルサイズ': '140GB', '24GBに適合？': 'いいえ' },
            { '量子化': 'Q8（8ビット）', 'モデルサイズ': '70GB', '24GBに適合？': 'いいえ' },
            { '量子化': 'Q5（5ビット）', 'モデルサイズ': '43.75GB', '24GBに適合？': 'いいえ' },
            { '量子化': 'Q4（4ビット）', 'モデルサイズ': '35GB', '24GBに適合？': 'いいえ（オフロード時：おそらく）' },
            { '量子化': 'Q3（3ビット）', 'モデルサイズ': '26GB', '24GBに適合？': 'いいえ（辛うじて）' },
            { '量子化': 'Q2（2ビット）', 'モデルサイズ': '17.5GB', '24GBに適合？': 'はい' },
          ],
    ...
    zh: {
      ...
      heroImage: '/images/run-70b-models-24gb-vram-overview-hero-zh.webp',
      seoTitle: '在24GB VRAM上运行70B模型：完整设置指南2026',
      intro: '在24GB VRAM上运行70B模型（通常需要40GB以上）是可能的，使用积极量化（Q2-Q3）和层卸载，但结果较慢（约3-5 tokens/秒）。这对实时聊天不实用，但适用于批处理或实验。',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: '通常需要40GB以上显存的70B模型，通过激进的Q2-Q3量化和层卸载可以在24GB显卡上运行，但结果很慢，每秒仅3-5个令牌——不适合实时聊天，但可用于批处理或实验。' },
            { type: 'plain-terms', text: '从技术上讲，你可以把70B模型塞进24GB的显卡，但这只是一种权宜之计，而不是良好的体验。模型被大幅压缩，GPU必须不断在显存中交换数据，所以响应会一点点慢慢出来。如果你是让它跑一整夜，或者只是测试模型能不能运行，这没问题，但不适合实时对话。' },
          ],
          items: [
        ...
        limits: {
          ...
          rows: [
            { '量化': 'FP16（基准）', '模型大小': '140GB', '适合24GB？': '否' },
            { '量化': 'Q8（8位）', '模型大小': '70GB', '适合24GB？': '否' },
            { '量化': 'Q5（5位）', '模型大小': '43.75GB', '适合24GB？': '否' },
            { '量化': 'Q4（4位）', '模型大小': '35GB', '适合24GB？': '否（卸载时：可能）' },
            { '量化': 'Q3（3位）', '模型大小': '26GB', '适合24GB？': '否（勉强）' },
            { '量化': 'Q2（2位）', '模型大小': '17.5GB', '适合24GB？': '是' },
          ],
    ...
    es: {
      ...
      heroImage: '/images/run-70b-models-24gb-vram-overview-hero-es.webp',
      seoTitle: 'Ejecutar modelos 70B en 24 GB de VRAM: guía completa 2026',
      intro: 'Ejecutar un modelo 70B (que normalmente requiere más de 40 GB) en 24 GB de VRAM es posible con cuantización agresiva (Q2-Q3) y offloading de capas, pero el resultado es lento (~3-5 tokens/seg). Esto es impráctico para chat en tiempo real, pero viable para procesamiento por lotes o experimentación.',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'Un modelo de 70B, que normalmente necesita más de 40 GB de VRAM, puede ejecutarse en una tarjeta de 24 GB usando cuantización agresiva Q2-Q3 y offloading de capas, pero el resultado es lento, solo 3-5 tokens por segundo -- impráctico para chat en tiempo real pero utilizable para trabajos por lotes o experimentación.' },
            { type: 'plain-terms', text: 'Técnicamente puedes meter un modelo de 70B en una tarjeta gráfica de 24 GB, pero es una solución de emergencia, no una buena experiencia. El modelo se comprime mucho y la GPU tiene que intercambiar partes constantemente dentro y fuera de la memoria, así que las respuestas salen a cuentagotas. Está bien si lo dejas corriendo toda la noche o solo quieres probar si el modelo funciona, pero no para una conversación en vivo.' },
          ],
          items: [
            ...
            'Esto es una solución a una restricción, no un enfoque recomendado.',
          ],
        },
        limits: {
          id: 'limits',
          ...
          rows: [
            { 'Cuantización': 'FP16 (base)', 'Tamaño del modelo': '140 GB', '¿Cabe en 24 GB?': 'No' },
            { 'Cuantización': 'Q8 (8 bits)', 'Tamaño del modelo': '70 GB', '¿Cabe en 24 GB?': 'No' },
            { 'Cuantización': 'Q5 (5 bits)', 'Tamaño del modelo': '43,75 GB', '¿Cabe en 24 GB?': 'No' },
            { 'Cuantización': 'Q4 (4 bits)', 'Tamaño del modelo': '35 GB', '¿Cabe en 24 GB?': 'No (con offloading: quizás)' },
            { 'Cuantización': 'Q3 (3 bits)', 'Tamaño del modelo': '26 GB', '¿Cabe en 24 GB?': 'No (por poco)' },
            { 'Cuantización': 'Q2 (2 bits)', 'Tamaño del modelo': '17,5 GB', '¿Cabe en 24 GB?': 'Sí' },
          ],
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Procesamiento por lotes nocturno — tareas en las que envías 100+ prompts y recuperas resultados horas después. Ejemplos: análisis de documentos, revisiones de código por lotes, anotación de conjuntos de datos. El chat en tiempo real es impráctíco a 1-8 tokens/seg. Para uso interactivo, una segunda RTX 4090 ($2.000–$2.600 mercado de segunda mano) con división de capas alcanza ~100 tokens/seg — una inversión mucho mejor.',
            },
            {
    ...
    ar: {
      ...
      heroImage: '/images/run-70b-models-24gb-vram-overview-hero-ar.webp',
      seoTitle: 'تشغيل نماذج ⁨70B⁩ على ⁨24 GB VRAM⁩: تكميم ⁨Q4⁩_⁨K⁩_⁨M⁩',
      intro: 'تشغيل نموذج 70B (يتطلب عادةً أكثر من 40 GB) على 24 GB من VRAM ممكن بتكميم قوي (Q2-Q3) وتفريغ الطبقات، لكن النتيجة بطيئة (~3-5 token/ثانية). هذا غير عملي للدردشة الفورية، لكنه قابل للتطبيق للمعالجة بالدُفعات أو التجريب.',
      metaDescription: '⁨Llama 70B⁩ يتسع في ⁨24 GB VRAM⁩ عند ⁨Q2⁩ بحجم ⁨17.5 GB⁩ وسرعة ⁨5⁩–⁨8 token⁩/ث. ⁨Q4⁩ مع تفريغ ⁨11 GB⁩ للـ ⁨RAM⁩ يعطي ⁨1⁩–⁨3 token⁩/ث. مقارنة الأداء والبدائل.',
      publishDate: '2026-04-04',
      dateModified: '2026-08-31',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'يمكن لنموذج 70B، الذي يحتاج عادةً إلى أكثر من 40 GB من VRAM، أن يعمل على بطاقة 24 GB باستخدام تكميم قوي Q2-Q3 وتفريغ الطبقات، لكن النتيجة بطيئة -- فقط 3-5 tokens في الثانية -- غير عملية للدردشة الفورية لكنها قابلة للاستخدام في المهام الدُفعية أو التجريب.' },
            { type: 'plain-terms', text: 'يمكنك تقنياً حشر نموذج 70B في بطاقة رسومات بذاكرة 24 GB، لكنه حل مؤقت وليس تجربة جيدة. يُضغط النموذج بشدة، ويضطر GPU لتبديل الأجزاء داخل وخارج الذاكرة باستمرار، لذا تخرج الردود ببطء شديد. هذا مقبول إذا كنت تشغّله طوال الليل أو تختبر فقط ما إذا كان النموذج يعمل أصلاً، لكنه غير مناسب لمحادثة مباشرة.' },
          ],
          items: [
        ...
        limits: {
          ...
          rows: [
            { 'Cuantización': 'FP16 (الأساس)', 'Tamaño del modelo': '140 GB', '¿Cabe en 24 GB?': 'لا' },
            { 'Cuantización': 'Q8 (8 بت)', 'Tamaño del modelo': '70 GB', '¿Cabe en 24 GB?': 'لا' },
            { 'Cuantización': 'Q5 (5 بت)', 'Tamaño del modelo': '43.75 GB', '¿Cabe en 24 GB?': 'لا' },
            { 'Cuantización': 'Q4 (4 بت)', 'Tamaño del modelo': '35 GB', '¿Cabe en 24 GB?': 'لا (مع التفريغ: ربما)' },
            { 'Cuantización': 'Q3 (3 بت)', 'Tamaño del modelo': '26 GB', '¿Cabe en 24 GB?': 'لا (بفارق ضئيل)' },
            { 'Cuantización': 'Q2 (2 بت)', 'Tamaño del modelo': '17.5 GB', '¿Cabe en 24 GB?': 'نعم' },
          ],
          columns: ['Cuantización', 'Tamaño del modelo', '¿Cabe en 24 GB?'],
          image: '/images/run-70b-models-24gb-vram-quantization-fit-en.svg',
    ...
    pt: {
      ...
      heroImage: '/images/run-70b-models-24gb-vram-overview-hero-pt.webp',
      seoTitle: 'Executar modelos 70B em 24 GB de VRAM: guia completo 2026',
      intro: 'Executar um modelo 70B (que normalmente requer mais de 40 GB) em 24 GB de VRAM é possível com quantização agressiva (Q2-Q3) e offloading de camadas, mas o resultado é lento (~3-5 tokens/seg). Isso é impraticável para chat em tempo real, mas viável para processamento em lotes ou experimentação.',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'Um modelo 70B, que normalmente precisa de mais de 40 GB de VRAM, pode rodar em uma placa de 24 GB usando quantização agressiva Q2-Q3 e offloading de camadas, mas o resultado é lento, apenas 3-5 tokens por segundo -- impraticável para chat em tempo real, mas utilizável para trabalhos em lote ou experimentação.' },
            { type: 'plain-terms', text: 'Tecnicamente dá para encaixar um modelo 70B em uma placa de vídeo de 24 GB, mas isso é um paliativo, não uma boa experiência. O modelo é fortemente comprimido e a GPU precisa trocar partes constantemente dentro e fora da memória, então as respostas saem aos poucos. Tudo bem se você deixar rodando durante a noite ou só quiser testar se o modelo funciona, mas não serve para uma conversa ao vivo.' },
          ],
          items: [
            ...
            'Isso é uma solução alternativa para uma restrição, não uma abordagem recomendada.',
          ],
        },
        limits: {
          id: 'limits',
          ...
          rows: [
            { 'Quantização': 'FP16 (base)', 'Tamanho do modelo': '140 GB', 'Cabe em 24 GB?': 'Não' },
            { 'Quantização': 'Q8 (8 bits)', 'Tamanho do modelo': '70 GB', 'Cabe em 24 GB?': 'Não' },
            { 'Quantização': 'Q5 (5 bits)', 'Tamanho do modelo': '43,75 GB', 'Cabe em 24 GB?': 'Não' },
            { 'Quantização': 'Q4 (4 bits)', 'Tamanho do modelo': '35 GB', 'Cabe em 24 GB?': 'Não (com offloading: talvez)' },
            { 'Quantização': 'Q3 (3 bits)', 'Tamanho do modelo': '26 GB', 'Cabe em 24 GB?': 'Não (por pouco)' },
            { 'Quantização': 'Q2 (2 bits)', 'Tamanho do modelo': '17,5 GB', 'Cabe em 24 GB?': 'Sim' },
          ],
  ...
  ko: {
    ...
    heroImage: '/images/run-70b-models-24gb-vram-overview-hero-ko.webp',
      seoTitle: '24GB VRAM에서 70B 모델 실행: 완전 설정 가이드 2026',
      intro: '70B 모델(일반적으로 40GB 이상 필요)을 24GB VRAM에서 실행하려면 공격적인 양자화(Q2-Q3)와 레이어 오프로딩이 필요하지만, 속도가 느립니다(~3-5 토큰/초). 실시간 채팅에는 적합하지 않지만, 배치 처리나 실험 목적으로는 활용 가능합니다.',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: '일반적으로 40GB 이상의 VRAM이 필요한 70B 모델도 공격적인 Q2-Q3 양자화와 레이어 오프로딩을 사용하면 24GB 카드에서 실행할 수 있지만, 결과는 초당 3~5 토큰으로 느려서 실시간 채팅에는 적합하지 않고 배치 작업이나 실험용으로만 쓸 수 있습니다.' },
            { type: 'plain-terms', text: '기술적으로는 70B 모델을 24GB 그래픽 카드에 욱여넣을 수 있지만, 이는 임시방편이지 좋은 경험은 아닙니다. 모델이 강하게 압축되고 GPU가 메모리 안팎으로 데이터를 계속 교체해야 하므로 응답이 조금씩 느리게 나옵니다. 밤새 돌려두거나 모델이 작동하는지만 확인하고 싶다면 괜찮지만, 실시간 대화에는 적합하지 않습니다.' },
          ],
          items: [
        ...
        limits: {
          ...
          rows: [
            { 'Quantization': 'FP16 (기준)', 'Model Size': '140 GB', 'Fits 24GB?': '불가' },
            { 'Quantization': 'Q8 (8비트)', 'Model Size': '70 GB', 'Fits 24GB?': '불가' },
            { 'Quantization': 'Q5 (5비트)', 'Model Size': '43.75 GB', 'Fits 24GB?': '불가' },
            { 'Quantization': 'Q4 (4비트)', 'Model Size': '35 GB', 'Fits 24GB?': '불가 (오프로딩 시 가능)' },
            { 'Quantization': 'Q3 (3비트)', 'Model Size': '26 GB', 'Fits 24GB?': '불가 (근소하게 초과)' },
            { 'Quantization': 'Q2 (2비트)', 'Model Size': '17.5 GB', 'Fits 24GB?': '가능' },
          ],
          columns: ['Quantization', 'Model Size', 'Fits 24GB?'],
          image: '/images/run-70b-models-24gb-vram-quantization-fit-en.svg',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: '야간 배치 처리 — 100개 이상의 프롬프트를 제출하고 몇 시간 후에 결과를 가져오는 작업. 예: 문서 분석, 코드 리뷰 배치, 데이터셋 어노테이션. 1–8 토큰/초에서 실시간 채팅은 비실용적입니다. 인터랙티브 사용에는 레이어 분할이 가능한 두 번째 RTX 4090($2,000–$2,600 중고 시장)이 ~100 토큰/초를 달성하여 훨씬 나은 투자입니다.',
            },
            {
