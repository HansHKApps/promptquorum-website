...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Enterprise LLM Inference Servers 2026](/power-local-llm/enterprise-llm-inference-servers-vllm-tgi-nim) — vLLM, TGI, and NVIDIA NIM compared for the serving software that runs on this hardware.',
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/local-llms/enterprise-gpu-server-buying-guide',
  ...
  de: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Enterprise-LLM-Inferenz-Server 2026](/de/power-local-llm/enterprise-llm-inference-servers-vllm-tgi-nim) — vLLM, TGI und NVIDIA NIM im Vergleich für die Serving-Software auf dieser Hardware.',
    ...
    schema: {
      ...
      author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      url: 'https://www.promptquorum.com/de/local-llms/enterprise-gpu-server-buying-guide',
      speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
      educationalLevel: 'Advanced',
      proficiencyLevel: 'Advanced',
  ...
  fr: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Serveurs d\'inférence LLM entreprise 2026](/fr/power-local-llm/enterprise-llm-inference-servers-vllm-tgi-nim) — vLLM, TGI et NVIDIA NIM comparés pour le logiciel de service tournant sur ce matériel.',
    ...
    schema: {
      ...
      author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      url: 'https://www.promptquorum.com/fr/local-llms/enterprise-gpu-server-buying-guide',
      speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
      educationalLevel: 'Advanced',
      proficiencyLevel: 'Advanced',
  ...
  es: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Servidores de inferencia LLM empresarial 2026](/es/power-local-llm/enterprise-llm-inference-servers-vllm-tgi-nim) — vLLM, TGI y NVIDIA NIM comparados como software de servicio para este hardware.',
    ...
    schema: {
      ...
      author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      url: 'https://www.promptquorum.com/es/local-llms/enterprise-gpu-server-buying-guide',
      speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
      educationalLevel: 'Advanced',
      proficiencyLevel: 'Advanced',
  ...
  pt: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Servidores de inferência LLM corporativos 2026](/pt/power-local-llm/enterprise-llm-inference-servers-vllm-tgi-nim) — vLLM, TGI e NVIDIA NIM comparados como software de atendimento para esse hardware.',
    ...
    schema: {
      ...
      author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      url: 'https://www.promptquorum.com/pt/local-llms/enterprise-gpu-server-buying-guide',
      speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
      educationalLevel: 'Advanced',
      proficiencyLevel: 'Advanced',
  ...
  ja: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[エンタープライズLLM推論サーバー2026](/ja/power-local-llm/enterprise-llm-inference-servers-vllm-tgi-nim)——このハードウェア上で動く配信ソフトウェアとしてvLLM、TGI、NVIDIA NIMを比較。',
    ...
    schema: {
      ...
      author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      url: 'https://www.promptquorum.com/ja/local-llms/enterprise-gpu-server-buying-guide',
      speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
      educationalLevel: 'Advanced',
      proficiencyLevel: 'Advanced',
  ...
  zh: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026企业级LLM推理服务器](/zh/power-local-llm/enterprise-llm-inference-servers-vllm-tgi-nim)——对比运行在这类硬件上的服务软件vLLM、TGI和NVIDIA NIM。',
    ...
    schema: {
      ...
      author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      url: 'https://www.promptquorum.com/zh/local-llms/enterprise-gpu-server-buying-guide',
      speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
      educationalLevel: 'Advanced',
      proficiencyLevel: 'Advanced',
  ...
  ar: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[خوادم استدلال النماذج اللغوية المؤسسية 2026](/ar/power-local-llm/enterprise-llm-inference-servers-vllm-tgi-nim) — مقارنة بين vLLM وTGI وNVIDIA NIM كبرمجيات خدمة تعمل على هذا الجهاز.',
    ...
    schema: {
      ...
      author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      url: 'https://www.promptquorum.com/ar/local-llms/enterprise-gpu-server-buying-guide',
      speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
      educationalLevel: 'Advanced',
      proficiencyLevel: 'Advanced',
  ...
  ko: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026 엔터프라이즈 LLM 추론 서버](/ko/power-local-llm/enterprise-llm-inference-servers-vllm-tgi-nim) — 이 하드웨어에서 실행되는 서빙 소프트웨어로서 vLLM, TGI, NVIDIA NIM 비교.',
    ...
    schema: {
      ...
      author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      url: 'https://www.promptquorum.com/ko/local-llms/enterprise-gpu-server-buying-guide',
      speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
      educationalLevel: 'Advanced',
      proficiencyLevel: 'Advanced',
