...
schema: {
    ...
    ar: {
      ...
      seoTitle: 'Ollama مقابل LM Studio 2026: السرعة والميزات والإعداد',
      ...
      metaDescription: 'Ollama مقابل LM Studio 2026: كلاهما يشغّل نفس النماذج بنفس السرعة. CLI مقابل GUI، تكامل API، 4,500+ نموذج، ومتى تختار كلًا منهما.',
      dateModified: '2026-05-17',
      publishDate: '2026-04-04',
