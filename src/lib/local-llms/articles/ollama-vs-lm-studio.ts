...
schema: {
    ...
    ar: {
      ...
      next_refresh_due: '2026-11-04',
      theme: 'Tools & Interfaces',
      title: 'Ollama مقابل LM Studio 2026: CLI مقابل GUI — السرعة وAPI والخصوصية والإعداد',
      ...
      metaDescription: 'Ollama وLM Studio يشغّلان نفس النماذج بنفس السرعة. CLI مقابل GUI: اختر Ollama للأتمتة وAPI، واختر LM Studio للاستخدام التفاعلي وإدارة 4,500+ نموذج.',
      dateModified: '2026-05-17',
      publishDate: '2026-04-04',
