...
schema: {
    ...
    fr: {
      ...
      seoTitle: 'Ollama vs LM Studio 2026 : Vitesse, Fonctionnalités & Configuration',
    ...
    es: {
      ...
      metaDescription: 'Ollama vs LM Studio 2026: ambos corren los mismos modelos a igual velocidad. CLI vs GUI, integración API, 4.500+ modelos y cuándo elegir cada uno.',
      dateModified: '2026-06-19',
      publishDate: '2026-04-04',
    ...
    ar: {
      ...
      metaDescription: '⁨Ollama⁩ و⁨LM Studio⁩ يشغّلان نفس النماذج بنفس السرعة. ⁨CLI⁩ مقابل ⁨GUI⁩: ⁨Ollama⁩ للأتمتة و⁨API⁩، و⁨LM Studio⁩ للاستخدام التفاعلي وإدارة ⁨4⁩,⁨500⁩+ نموذج.',
      dateModified: '2026-06-19',
      publishDate: '2026-04-04',
    ...
    pt: {
      ...
      metaDescription: 'Ollama vs LM Studio 2026: ambos rodam os mesmos modelos na mesma velocidade. CLI vs GUI, integração API, 4.500+ modelos e quando escolher cada um.',
      dateModified: '2026-06-19',
      publishDate: '2026-04-04',
  ...
  ko: {
      ...
      metaDescription: 'Ollama vs LM Studio 2026: 두 도구 모두 동일한 모델을 동일한 속도로 실행합니다. CLI vs GUI, API 통합, 4,500개 이상의 모델, 설정 단계, 그리고 각 도구를 선택해야 하는 경우.',
      dateModified: '2026-06-19',
      publishDate: '2026-04-04',
