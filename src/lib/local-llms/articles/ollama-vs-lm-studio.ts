      ...
      sections: {
        ...
        api: {
          ...
          content: [
            ...
            'Ollama and LM Studio are just two entries in a much larger ecosystem. See the [Local LLM Software Directory](/power-local-llm/local-llm-software-directory) for 164 tools across runtimes, desktop apps, RAG, coding, and agents — each with a description, licence, and link.',
          ],
