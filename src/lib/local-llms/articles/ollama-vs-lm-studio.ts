...
schema: {
    ...
    ja: {
      ...
      seoTitle: 'Ollama vs LM Studio 2026: CLI vs GUI 比較',
      ...
      metaDescription: 'Ollama (CLI + API ポート 11434) vs LM Studio (デスクトップ GUI)。同一速度、同一モデル、異なるワークフロー。比較表、セットアップ手順、4 500+ モデル。',
      dateModified: '2026-05-05',
      publishDate: '2026-04-04',
      ...
      sections: {
        ...
        whenLmStudio: {
          ...
          callout: '⚠️ **警告:** LM Studio はデフォルトで匿名ユーザー分析を収集。プライバシー重視デプロイメント時はインストール直後に無効化: 設定 → プライバシー → 匿名使用データ送信 → オフ。Ollama はデフォルトでテレメトリなし。',
        },
        regionalContext: {
          id: 'regional-context',
