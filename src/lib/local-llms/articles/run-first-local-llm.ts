        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Ollama installieren (ollama.com), `ollama pull llama3.2:3b` ausführen, dann `ollama run llama3.2:3b` ausführen. Das ist alles. Drei Befehle, 2-5 Minuten, und Sie haben ein funktionierendes KI-Modell auf Ihrem Rechner -- nach dem initialen Download ohne Internetverbindung.',
            },
            {
    ...
    heroImage: '/images/run-first-local-llm-overview-hero-ko.webp',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '로컬 LLM을 처음 실행하는 가장 쉬운 방법은 무엇인가요?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Ollama(ollama.com)를 설치하고, `ollama pull llama3.2:3b`를 실행한 다음, `ollama run llama3.2:3b`를 실행하십시오. 이것이 전부입니다. 세 개의 명령어, 2~5분이면 인터넷 연결 없이도 기기에서 작동하는 AI 모델을 갖게 됩니다.' } },
