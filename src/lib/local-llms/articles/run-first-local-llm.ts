    ...
    en: {
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'Running your first local LLM takes under 10 minutes: install Ollama, run one command like `ollama run llama3.2` to pull a small model, and start chatting in your terminal with no API key, account, or internet connection required after the initial download.' },
            { type: 'plain-terms', text: "You don't need any special setup to try a local AI model. Install one free program (Ollama), type a single command, and it downloads a small model and opens a chat right in your terminal. After that first download, it works completely offline -- no account, no API key, no monthly bill." },
          ],
          items: [
        ...
        step2: {
          ...
          imageCaption: 'First model picker by RAM: 4 GB fits llama3.2:1b (1.3 GB), 8 GB fits Llama 3.2 3B (2 GB, recommended start), 8-16 GB fits Llama 3.1 8B (4.7 GB), 16+ GB fits mistral:7b or qwen2.5:7b (4-5 GB).',
        },
        step3: {
        ...
        whatToExpect: {
          ...
          content: [
            ...
            '**Quality** from `llama3.2:3b` is noticeably lower than GPT-5.6 or Claude Opus 5 on complex tasks. For summarization, simple Q&A, and code explanation, the output is useful. For multi-step reasoning or long-form writing, upgrade to an 8B or 13B model.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Install Ollama ([ollama.com](https://ollama.com)), run `ollama pull llama3.2:3b`, then run `ollama run llama3.2:3b`. That is all. Three commands, 2-5 minutes, and you have a working AI model on your machine with no internet needed after the initial download.',
            },
            {
...
schema: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Install Ollama ([ollama.com](https://ollama.com)), run `ollama pull llama3.2:3b`, then run `ollama run llama3.2:3b`. That is all. Three commands, 2-5 minutes, and you have a working AI model on your machine with no internet needed after the initial download.'
            }
          },
          {
            '@type': 'Question',
    ...
    es: {
      ...
      heroImage: '/images/run-first-local-llm-overview-hero-es.webp',
      dateModified: '2026-08-28',
      seoTitle: 'Ejecuta tu primer LLM local en 10 minutos (paso a paso)',
      intro: 'Ejecutar tu primer LLM local con Ollama tarda menos de 10 minutos. Instala Ollama, ejecuta un comando para descargar un modelo y empieza a chatear en tu terminal — sin API key, sin cuenta y sin conexión a internet después de la descarga inicial. Un modelo rápido para principiantes es Llama 3.2 3B, que alcanza 25-45 tokens/seg en una CPU moderna de laptop.',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'Ejecutar tu primer LLM local lleva menos de 10 minutos: instala Ollama, ejecuta un comando como `ollama run llama3.2` para descargar un modelo pequeño, y empieza a chatear en tu terminal sin necesidad de API key, cuenta ni conexión a internet después de la descarga inicial.' },
            { type: 'plain-terms', text: 'No necesitas ninguna configuración especial para probar un modelo de IA local. Instala un programa gratuito (Ollama), escribe un solo comando, y descargará un modelo pequeño y abrirá un chat directamente en tu terminal. Después de esa primera descarga, funciona completamente sin conexión: sin cuenta, sin API key, sin factura mensual.' },
          ],
          items: [
        ...
        step2: {
          id: 'step-2-choose-your-first-model',
          ...
          image: '/images/run-first-local-llm-ram-model-picker-en.svg',
          imageCaption: 'Selector del primer modelo por RAM: 4 GB para llama3.2:1b (1,3 GB), 8 GB para Llama 3.2 3B (2 GB, inicio recomendado), 8-16 GB para Llama 3.1 8B (4,7 GB), 16+ GB para mistral:7b o qwen2.5:7b (4-5 GB).',
        },
        step3: {
          id: 'step-3-pull-the-model',
        ...
        whatToExpect: {
          ...
          content: [
            ...
            '**Calidad** de `llama3.2:3b` notablemente inferior a GPT-5.6 o Claude Opus 5 en tareas complejas. Para resúmenes, preguntas y respuestas simples y explicación de código, el resultado es útil. Para razonamiento en múltiples pasos o escritura de formato largo, actualiza a un modelo 8B o 13B.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Instala Ollama ([ollama.com](https://ollama.com)), ejecuta `ollama pull llama3.2:3b` y luego `ollama run llama3.2:3b`. Eso es todo. Tres comandos, 2-5 minutos y tienes un modelo de IA funcionando en tu máquina sin necesidad de internet después de la descarga inicial.',
            },
            {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Instala Ollama ([ollama.com](https://ollama.com)), ejecuta `ollama pull llama3.2:3b` y luego `ollama run llama3.2:3b`. Eso es todo. Tres comandos, 2-5 minutos y tienes un modelo de IA funcionando en tu máquina sin necesidad de internet después de la descarga inicial.'
            }
          },
          {
            '@type': 'Question',
    ...
    ar: {
      ...
      heroImage: '/images/run-first-local-llm-overview-hero-ar.webp',
      dateModified: '2026-08-28',
      seoTitle: 'تشغيل أول ⁨LLM⁩ محلي مع ⁨Ollama⁩ في ⁨10⁩ دقائق خطوة بخطوة',
      intro: 'تشغيل أول نموذج LLM محلي مع Ollama يستغرق أقل من 10 دقائق. ثبّت Ollama، ونفّذ أمرًا لتنزيل نموذج، وابدأ الدردشة في طرفيتك — بلا مفتاح API، وبلا حساب، وبلا اتصال بالإنترنت بعد التنزيل الأولي. من النماذج السريعة للمبتدئين Llama 3.2 3B الذي يصل إلى 25-45 token/ثانية على CPU حديث لحاسوب محمول.',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'يستغرق تشغيل أول نموذج LLM محلي أقل من 10 دقائق: ثبّت Ollama، ونفّذ أمراً مثل `ollama run llama3.2` لتنزيل نموذج صغير، وابدأ الدردشة في طرفيتك دون الحاجة إلى مفتاح API أو حساب أو اتصال بالإنترنت بعد التنزيل الأولي.' },
            { type: 'plain-terms', text: 'لا تحتاج إلى أي إعداد خاص لتجربة نموذج ذكاء اصطناعي محلي. ثبّت برنامجاً مجانياً (Ollama)، اكتب أمراً واحداً، وسيقوم بتنزيل نموذج صغير وفتح محادثة مباشرة في طرفيتك. بعد ذلك التنزيل الأول، يعمل بلا اتصال بالإنترنت تماماً -- بلا حساب، وبلا مفتاح API، وبلا فاتورة شهرية.' },
          ],
          items: [
        ...
        step2: {
          ...
          rows: [
            { 'ذاكرة RAM لديك': '4 GB', 'النموذج الموصى به': 'llama3.2:1b', 'حجم التنزيل': '~1.3 GB', 'السبب': 'أصغر نموذج Llama مفيد' },
            { 'ذاكرة RAM لديك': '8 GB', 'النموذج الموصى به': 'Llama 3.2 3B', 'حجم التنزيل': '~2 GB', 'السبب': 'أفضل نسبة جودة/حجم للمبتدئين' },
            { 'ذاكرة RAM لديك': '8-16 GB', 'النموذج الموصى به': 'Llama 3.1 8B', 'حجم التنزيل': '~4.7 GB', 'السبب': 'نموذج عام عالي الأداء' },
            { 'ذاكرة RAM لديك': '16+ GB', 'النموذج الموصى به': 'mistral:7b أو qwen2.5:7b', 'حجم التنزيل': '~4-5 GB', 'السبب': 'جودة تنافسية، استدلال سريع' },
          ],
          columns: ['ذاكرة RAM لديك', 'النموذج الموصى به', 'حجم التنزيل', 'السبب'],
          image: '/images/run-first-local-llm-ram-model-picker-en.svg',
          imageCaption: 'اختيار أول نموذج حسب RAM: 4 GB لـ llama3.2:1b (1.3 GB)، 8 GB لـ Llama 3.2 3B (2 GB، البداية الموصى بها)، 8-16 GB لـ Llama 3.1 8B (4.7 GB)، 16+ GB لـ mistral:7b أو qwen2.5:7b (4-5 GB).',
        },
        step3: {
          id: 'step-3-pull-the-model',
        ...
        whatToExpect: {
          ...
          content: [
            ...
            '**جودة** `llama3.2:3b` أدنى بشكل ملحوظ من GPT-5.6 أو Claude Opus 5 في المهام المعقدة. للتلخيص والأسئلة والأجوبة البسيطة وشرح الكود، النتيجة مفيدة. للاستدلال متعدد الخطوات أو الكتابة الطويلة، رقِّ إلى نموذج 8B أو 13B.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'ثبّت Ollama ([ollama.com](https://ollama.com))، ونفّذ `ollama pull llama3.2:3b` ثم `ollama run llama3.2:3b`. هذا كل شيء. ثلاثة أوامر، 2-5 دقائق، ولديك نموذج ذكاء اصطناعي يعمل على جهازك دون حاجة إلى الإنترنت بعد التنزيل الأولي.',
            },
            {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'ثبّت Ollama ([ollama.com](https://ollama.com))، ونفّذ `ollama pull llama3.2:3b` ثم `ollama run llama3.2:3b`. هذا كل شيء. ثلاثة أوامر، 2-5 دقائق، ولديك نموذج ذكاء اصطناعي يعمل على جهازك دون حاجة إلى الإنترنت بعد التنزيل الأولي.'
            }
          },
          {
            '@type': 'Question',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'Llama 3.1 8B', 'description': '8-16 GB من RAM. تنزيل 4.7 GB. أداء عام عالٍ.' },
    ...
    de: {
      ...
      heroImage: '/images/run-first-local-llm-overview-hero-de.webp',
      dateModified: '2026-08-28',
      ...
      publishDate: '2026-04-04',
      leadAnswerBlock: '**Dein erstes lokales LLM mit Ollama auszuführen dauert weniger als 10 Minuten. Installiere Ollama, führe einen Befehl aus, um ein Modell zu laden, und beginne, in deinem Terminal zu chatten -- kein API-Schlüssel, kein Konto und keine Internetverbindung nach dem initialen Download erforderlich.**',
      ...
      toc: [
        ...
        { label: 'Schritt 1: Ollama installieren', anchor: '#step-1-install-ollama' },
        { label: 'Schritt 2: Erstes Modell wählen', anchor: '#step-2-choose-your-first-model' },
        { label: 'Schritt 3: Modell herunterladen', anchor: '#step-3-pull-the-model' },
        { label: 'Schritt 4: Ausführen und chatten', anchor: '#step-4-run-and-chat' },
        { label: 'Was erwarten: Geschwindigkeit und Qualität', anchor: '#what-to-expect' },
        { label: 'Jenseits des Terminals', anchor: '#beyond-the-terminal' },
...
schema: {
      ...
      faqSchema: {
        ...
        '@type': 'FAQPage',
        'mainEntity': [
          { '@type': 'Question', 'name': 'Die Antwort des Modells ist sehr langsam -- ist das normal?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Auf reiner CPU-Hardware sind 8-20 Tokens/Sek für ein 7B-Modell normal. Jedes Token entspricht etwa 0,75 Wörtern. Bei 10 Tokens/Sek dauert eine 100-Wort-Antwort etwa 13 Sekunden. Um die Inferenz zu beschleunigen: ein kleineres Modell verwenden (3B statt 8B), GPU-Offloading aktivieren, falls verfügbar, oder das Quantisierungslevel Q4_K_M nutzen, das gängigste und schnellste Setup.' } },
          { '@type': 'Question', 'name': 'Kann ich zwei Modelle gleichzeitig ausführen?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Ollama kann mehrere Modelle gleichzeitig geladen halten, wenn genug RAM vorhanden ist. Standardmäßig entlädt Ollama ein Modell nach 5 Minuten Inaktivität. Dies lässt sich mit der Umgebungsvariable OLLAMA_KEEP_ALIVE ändern. Zwei 7B-Modelle gleichzeitig auszuführen benötigt ~16 GB RAM.' } },
          { '@type': 'Question', 'name': 'Wie stoppe ich Ollama im Hintergrund?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Auf macOS: Klicken Sie auf das Llama-Symbol in der Menüleiste und wählen Sie Beenden. Auf Linux: führen Sie `systemctl stop ollama` aus. Auf Windows: Rechtsklick auf das Symbol im Systemtray und Beenden wählen. Um zu verhindern, dass Ollama beim Login startet, entfernen Sie es aus den Autostart-Einträgen.' } },
          { '@type': 'Question', 'name': 'Was ist der einfachste Weg, ein lokales LLM zum ersten Mal auszuführen?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Ollama installieren ([ollama.com](https://ollama.com)), `ollama pull llama3.2:3b` ausführen, dann `ollama run llama3.2:3b` ausführen. Das ist alles. Drei Befehle, 2-5 Minuten, und Sie haben ein funktionierendes KI-Modell auf Ihrem Rechner -- nach dem initialen Download ohne Internetverbindung.' } },
          { '@type': 'Question', 'name': 'Woran erkenne ich, dass mein lokales LLM korrekt läuft?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Führen Sie `ollama ps` im Terminal aus. Läuft das Modell, erscheint es in der Liste mit Name, Größe und Speichernutzung. Senden Sie einen einfachen Prompt wie „Was ist 2+2?" -- antwortet das Modell mit „4", funktioniert es korrekt.' } },
          { '@type': 'Question', 'name': 'Benötigt mein Rechner eine GPU, um ein lokales LLM auszuführen?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Nein. Lokale LLMs laufen auf der CPU. Eine GPU macht die Inferenz 5-10× schneller, aber CPU-only ist für das Lernen und viele reale Anwendungsfälle ausreichend. Moderne Laptops mit Apple M1/M2, AMD Ryzen oder Intel-CPUs der 12. Generation können 3B-7B-Modelle mit angemessener Geschwindigkeit (10-30 Tokens/Sek) ausführen.' } },
          { '@type': 'Question', 'name': 'Wie viel Speicherplatz benötigt ein lokales LLM?', 'acceptedAnswer': { '@type': 'Answer', 'text': '`llama3.2:1b` benötigt 1,3 GB, `llama3.2:3b` 2 GB, `llama3.1:8b` 4,7 GB. Das sind die komprimierten Größen, wie Ollama sie speichert. Nach dem Laden in den RAM für die Inferenz unterscheiden sich die Größen.' } },
          { '@type': 'Question', 'name': 'Kann ich mein lokales LLM ohne Internetverbindung nutzen?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Ja, vollständig. Laden Sie das Modell einmal mit Ollama herunter (Internet erforderlich), danach läuft es für immer lokal ohne Internet. Ideal für private Netzwerke, Flugzeuge oder vollständig offline Umgebungen.' } },
          { '@type': 'Question', 'name': 'Wie unterscheidet sich ein lokales LLM von ChatGPT?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'ChatGPT läuft auf Servern von Anthropic. Lokale LLMs laufen auf Ihrem Rechner. Lokal = keine Daten verlassen das Gerät, volle Privatsphäre, keine laufenden API-Kosten. ChatGPT = bessere Qualität bei komplexen Aufgaben, benötigt Internet und ein kostenpflichtiges Abo. Beide haben Vor- und Nachteile.' } },
          { '@type': 'Question', 'name': 'Was ist das beste erste Modell zum Ausprobieren mit Ollama?', 'acceptedAnswer': { '@type': 'Answer', 'text': '`ollama pull llama3.2:3b` -- es ist 2 GB groß, läuft auf jedem modernen Laptop, liefert kompetente Antworten und ist der von Ollama empfohlene Einstiegspunkt.' } },
        ]
      },
      howToSchema: {
        '@context': 'https://schema.org',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'Llama 3.1 8B', 'description': '8-16 GB RAM. 4,7 GB Download. Starkes Allzweckmodell.' },
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'Ihr erstes lokales LLM auszuführen dauert unter 10 Minuten: Ollama installieren, mit einem Befehl wie `ollama run llama3.2` ein kleines Modell laden und im Terminal chatten -- ohne API-Schlüssel, Konto oder Internetverbindung nach dem ersten Download.' },
            { type: 'plain-terms', text: 'Sie brauchen keine besondere Einrichtung, um ein lokales KI-Modell auszuprobieren. Installieren Sie ein kostenloses Programm (Ollama), geben Sie einen einzigen Befehl ein, und es lädt ein kleines Modell herunter und öffnet einen Chat direkt im Terminal. Nach diesem ersten Download läuft alles komplett offline -- kein Konto, kein API-Schlüssel, keine monatliche Rechnung.' },
          ],
          items: [
        ...
        step1: {
          ...
          content: 'Ollama ist der schnellste Weg, ein lokales LLM auszuführen. Installieren Sie es mit einem Befehl oder einem 2-Minuten-Download:',
          codeBlock: '# macOS (Homebrew)\nbrew install ollama\n\n# Linux\ncurl -fsSL https://ollama.com/install.sh | sh\n\n# Windows: Installer von ollama.com/download herunterladen',
          codeLanguage: 'bash',
          image: '/images/run-first-local-llm-setup-flow-en.svg',
          imageCaption: 'Von der Installation zur ersten Antwort in 4 Schritten: Ollama installieren (~2 Min), llama3.2:3b herunterladen (~2 GB, 2-5 Min), ausführen und chatten, dann erste Antwort nach 5-30 Sekunden Ladezeit -- unter 10 Minuten insgesamt, vollständig offline nach dem Download.',
        },
        step1Detail: {
          title: 'Prüfen, ob Ollama läuft',
          content: 'Bestätigen Sie nach der Installation, dass Ollama aktiv ist:',
          codeBlock: 'curl http://localhost:11434\n# Erwartete Ausgabe: Ollama is running',
          codeLanguage: 'bash',
        },
        step2: {
          id: 'step-2-choose-your-first-model',
          title: 'Schritt 2: Erstes Modell wählen',
          content: 'Wählen Sie ein Modell passend zu Ihrem verfügbaren RAM. Im Zweifel starten Sie mit `llama3.2:3b` -- es läuft auf jedem Rechner mit 4 GB RAM und liefert brauchbare Ergebnisse:',
          rows: [
            { 'Ihr RAM': '4 GB', 'Empfohlenes Modell': 'llama3.2:1b', 'Downloadgröße': '~1,3 GB', 'Warum': 'Kleinstes brauchbares Llama-Modell' },
            { 'Ihr RAM': '8 GB', 'Empfohlenes Modell': 'Llama 3.2 3B', 'Downloadgröße': '~2 GB', 'Warum': 'Bestes Verhältnis Qualität/Größe für Einsteiger' },
            { 'Ihr RAM': '8-16 GB', 'Empfohlenes Modell': 'Llama 3.1 8B', 'Downloadgröße': '~4,7 GB', 'Warum': 'Starkes Allzweckmodell' },
            { 'Ihr RAM': '16+ GB', 'Empfohlenes Modell': 'mistral:7b oder qwen2.5:7b', 'Downloadgröße': '~4-5 GB', 'Warum': 'Wettbewerbsfähige Qualität, schnelle Inferenz' },
          ],
          columns: ['Ihr RAM', 'Empfohlenes Modell', 'Downloadgröße', 'Warum'],
          image: '/images/run-first-local-llm-ram-model-picker-en.svg',
          imageCaption: 'Erste Modellwahl nach RAM: 4 GB passt zu llama3.2:1b (1,3 GB), 8 GB passt zu Llama 3.2 3B (2 GB, empfohlener Start), 8-16 GB passt zu Llama 3.1 8B (4,7 GB), 16+ GB passt zu mistral:7b oder qwen2.5:7b (4-5 GB).',
        },
        step3: {
          id: 'step-3-pull-the-model',
          title: 'Schritt 3: Modell herunterladen',
          content: 'Laden Sie das Modell mit `ollama pull` herunter. Das Modell wird unter `~/.ollama/models` gespeichert und muss nur einmal heruntergeladen werden:',
          codeBlock: 'ollama pull llama3.2\n\n# Oder eine bestimmte Größenvariante laden\nollama pull llama3.2:3b\nollama pull llama3.1:8b',
          codeLanguage: 'bash',
        },
        step3Progress: {
          title: 'Wie sieht der Download aus?',
          content: 'Ollama zeigt den Download-Fortschritt im Terminal an. Ein `llama3.2:3b`-Modell dauert 2-5 Minuten bei einer typischen Breitbandverbindung. Das Modell wird komprimiert gespeichert -- der 2 GB-Download erweitert sich auf der Festplatte auf etwa 2,3 GB.',
          codeBlock: 'pulling manifest\npulling 966de95ca8dc... 100% ▕████████████████▏ 1.9 GB\npulling 9f436a92eb8b... 100% ▕████████████████▏   42 B\nverifying sha256 digest\nwriting manifest\nsuccess',
          codeLanguage: 'text',
        },
        step4: {
          id: 'step-4-run-and-chat',
          title: 'Schritt 4: Modell ausführen und ersten Prompt senden',
          content: 'Starten Sie eine interaktive Chat-Sitzung:',
          codeBlock: 'ollama run llama3.2\n\n# Ollama lädt das Modell und zeigt einen Prompt:\n>>> Send a message (/? for help)',
          codeLanguage: 'bash',
        },
        step4Chat: {
          title: 'Ihr erstes Gespräch',
          content: 'Geben Sie eine Nachricht ein und drücken Sie Enter. Das Modell streamt seine Antwort Token für Token:',
          codeBlock: '>>> What are local LLMs?\n\nLocal LLMs (large language models) are AI models that run entirely\non your own hardware -- your laptop, desktop, or server. Unlike cloud\nservices such as ChatGPT or Claude, local LLMs process everything\nlocally with no data sent to external servers...',
          codeLanguage: 'text',
        },
        whatToExpect: {
          id: 'what-to-expect',
          title: 'Was erwarten: Geschwindigkeit, Qualität und Einschränkungen',
          content: [
        ...
        beyondTerminal: {
          id: 'beyond-the-terminal',
          title: 'Wie nutzen Sie Ihr lokales LLM jenseits des Terminals?',
          content: 'Der Ollama-Terminal-Chat ist nützlich zum Testen, aber die meisten realen Anwendungsfälle brauchen eine bessere Oberfläche:',
          items: [
            ...
            '**LM Studio**: bevorzugen Sie eine Desktop-GUI, deckt [So installieren Sie LM Studio](/de/local-llms/how-to-install-lm-studio) das komplette Setup ab. Der integrierte Chat von LM Studio ist poliert und unterstützt Gesprächsverlauf.',
        ...
        regionalContext: {
          id: 'regional-context',
          title: 'Ihr erstes lokales LLM ausführen: Regionaler Kontext',
          content: [
        ...
        faqSection: {
          id: 'faq',
          title: 'Häufige Fragen zum ersten lokalen LLM',
          faqs: [
            {
              q: 'Die Antwort des Modells ist sehr langsam -- ist das normal?',
              a: 'Auf reiner CPU-Hardware sind 8-20 Tokens/Sek für ein 7B-Modell normal. Jedes Token entspricht etwa 0,75 Wörtern. Bei 10 Tokens/Sek dauert eine 100-Wort-Antwort etwa 13 Sekunden. Um die Inferenz zu beschleunigen: ein kleineres Modell verwenden (3B statt 8B), GPU-Offloading aktivieren, falls verfügbar, oder das Quantisierungslevel Q4_K_M nutzen, das gängigste und schnellste Setup.',
            },
            {
              q: 'Kann ich zwei Modelle gleichzeitig ausführen?',
              a: 'Ollama kann mehrere Modelle gleichzeitig geladen halten, wenn genug RAM vorhanden ist. Standardmäßig entlädt Ollama ein Modell nach 5 Minuten Inaktivität. Dies lässt sich mit der Umgebungsvariable OLLAMA_KEEP_ALIVE ändern. Zwei 7B-Modelle gleichzeitig auszuführen benötigt ~16 GB RAM.',
            },
            {
              q: 'Wie stoppe ich Ollama im Hintergrund?',
              a: 'Auf macOS: Klicken Sie auf das Llama-Symbol in der Menüleiste und wählen Sie Beenden. Auf Linux: führen Sie `systemctl stop ollama` aus. Auf Windows: Rechtsklick auf das Symbol im Systemtray und Beenden wählen. Um zu verhindern, dass Ollama beim Login startet, entfernen Sie es aus den Autostart-Einträgen.',
            },
            {
              q: 'Was ist der einfachste Weg, ein lokales LLM zum ersten Mal auszuführen?',
              a: 'Ollama installieren ([ollama.com](https://ollama.com)), `ollama pull llama3.2:3b` ausführen, dann `ollama run llama3.2:3b` ausführen. Das ist alles. Drei Befehle, 2-5 Minuten, und Sie haben ein funktionierendes KI-Modell auf Ihrem Rechner -- nach dem initialen Download ohne Internetverbindung.',
            },
            {
              q: 'Woran erkenne ich, dass mein lokales LLM korrekt läuft?',
              a: 'Führen Sie `ollama ps` im Terminal aus. Läuft das Modell, erscheint es in der Liste mit Name, Größe und Speichernutzung. Senden Sie einen einfachen Prompt wie „Was ist 2+2?" -- antwortet das Modell mit „4", funktioniert es korrekt.',
            },
            {
              q: 'Benötigt mein Rechner eine GPU, um ein lokales LLM auszuführen?',
              a: 'Nein. Lokale LLMs laufen auf der CPU. Eine GPU macht die Inferenz 5-10× schneller, aber CPU-only ist für das Lernen und viele reale Anwendungsfälle ausreichend. Moderne Laptops mit Apple M1/M2, AMD Ryzen oder Intel-CPUs der 12. Generation können 3B-7B-Modelle mit angemessener Geschwindigkeit (10-30 Tokens/Sek) ausführen.',
            },
            {
              q: 'Wie viel Speicherplatz benötigt ein lokales LLM?',
              a: '`llama3.2:1b` benötigt 1,3 GB, `llama3.2:3b` 2 GB, `llama3.1:8b` 4,7 GB. Das sind die komprimierten Größen, wie Ollama sie speichert. Nach dem Laden in den RAM für die Inferenz unterscheiden sich die Größen (siehe [Wie viel VRAM für ein lokales LLM](/de/local-llms/how-much-vram-local-llm) für Details).',
            },
            {
              q: 'Kann ich mein lokales LLM ohne Internetverbindung nutzen?',
              a: 'Ja, vollständig. Laden Sie das Modell einmal mit Ollama herunter (Internet erforderlich), danach läuft es für immer lokal ohne Internet. Ideal für private Netzwerke, Flugzeuge oder vollständig offline Umgebungen.',
            },
            {
              q: 'Wie unterscheidet sich ein lokales LLM von ChatGPT?',
              a: 'ChatGPT läuft auf Servern von Anthropic. Lokale LLMs laufen auf Ihrem Rechner. Lokal = keine Daten verlassen das Gerät, volle Privatsphäre, keine laufenden API-Kosten. ChatGPT = bessere Qualität bei komplexen Aufgaben, benötigt Internet und ein kostenpflichtiges Abo. Beide haben Vor- und Nachteile.',
            },
            {
              q: 'Was ist das beste erste Modell zum Ausprobieren mit Ollama?',
              a: '`ollama pull llama3.2:3b` -- es ist 2 GB groß, läuft auf jedem modernen Laptop, liefert kompetente Antworten und ist der von Ollama empfohlene Einstiegspunkt. Sehen Sie danach [Beste Anfänger-Lokale-LLM-Modelle](/de/local-llms/best-beginner-local-llm-models) für Alternativen passend zu Ihrer Hardware.',
            },
          ],
        },
        nextSteps: {
          title: 'Nächste Schritte nach dem ersten Durchlauf',
          content: 'Jetzt, da Sie ein funktionierendes lokales LLM haben, erkunden Sie, was es kann. Um zu verstehen, welche Modelle für Ihre Hardware am besten geeignet sind, siehe [Beste Anfänger-Lokale-LLM-Modelle](/de/local-llms/best-beginner-local-llm-models). Für laptop-spezifische Performance-Tipps siehe [Lokale LLMs auf einem Laptop ausführen](/de/local-llms/local-llm-on-laptop). Für Best Practices zu Datenschutz und Sicherheit siehe die [Checkliste für Sicherheit und Datenschutz bei lokalen LLMs](/de/local-llms/local-llm-security-privacy-checklist).',
        },
        sources: {
          id: 'sources',
          title: 'Quellen',
          items: [
            '[**Ollama-Modellbibliothek**](https://ollama.com/library) -- Offizielle Liste herunterladbarer Modelle und ihrer Spezifikationen',
            '[**Ollama GitHub-Repository**](https://github.com/ollama/ollama) -- Open-Source-Code, Dokumentation und Issue-Tracking',
            '[**Meta Llama 3.2 Model Card**](https://llama.meta.com/) -- Offizielle Spezifikationen, Trainingsdaten und Performance-Benchmarks',
          ],
        },
        commonMistakes: {
          id: 'common-mistakes',
          title: 'Häufige Fehler nach dem ersten Durchlauf',
          items: [
        ...
        relatedReading: {
          ...
          items: [
            '[So installieren Sie Ollama](/de/local-llms/how-to-install-ollama) -- Installation und Einrichtung',
            '[So installieren Sie LM Studio](/de/local-llms/how-to-install-lm-studio) -- GUI-Alternative',
            '[Beste Anfänger-Lokale-LLM-Modelle](/de/local-llms/best-beginner-local-llm-models) -- Modellempfehlungen passend zu Ihrer Hardware',
            '[Was sind lokale LLMs?](/de/local-llms/what-are-local-llms) -- Kernkonzepte und Funktionsweise',
            '[Fehlerbehebung beim lokalen LLM-Setup](/de/local-llms/troubleshooting-local-llm-setup) -- Langsame Inferenz, GPU-Erkennung und häufige Fehler beheben',
            '[Lokales LLM OpenAI-kompatible API](/de/local-llms/local-llm-openai-compatible-api) -- Laufendes Ollama mit Python und anderen Anwendungen verbinden',
            'Ihr erstes lokales LLM läuft. Lernen Sie jetzt, es effektiv zu prompten: [Was ist Prompt Engineering](https://www.promptquorum.com/de/prompt-engineering/what-is-prompt-engineering) vermittelt die Grundlagen.',
          ],
        },
      },
    },
    fr: {
      ...
      publishDate: '2026-04-04',
      leadAnswerBlock: '**Exécuter votre premier LLM local prend moins de 10 minutes avec Ollama. Installez Ollama, exécutez une commande pour charger un modèle, et commencez à discuter dans votre terminal -- pas de clé API, pas de compte, et pas de connexion Internet après le téléchargement initial.**',
      audience: 'Débutants qui exécutent leur premier LLM local sur du matériel grand public',
      readTime: '7 min read',
      heroComponent: 'LLMImageSelector',
      educationalLevel: 'Beginner',
      ...
      toc: [
        ...
        { label: 'Étape 1 : Installer Ollama', anchor: '#step-1-install-ollama' },
        { label: 'Étape 2 : Choisir votre premier modèle', anchor: '#step-2-choose-your-first-model' },
        { label: 'Étape 3 : Télécharger le modèle', anchor: '#step-3-pull-the-model' },
        { label: 'Étape 4 : Exécuter et discuter', anchor: '#step-4-run-and-chat' },
        { label: 'À quoi s\'attendre : vitesse et qualité', anchor: '#what-to-expect' },
        { label: 'Au-delà du terminal', anchor: '#beyond-the-terminal' },
...
schema: {
      ...
      faqSchema: {
        ...
        '@type': 'FAQPage',
        'mainEntity': [
          { '@type': 'Question', 'name': 'La réponse du modèle est très lente -- est-ce normal ?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Sur un matériel CPU uniquement, 8-20 tokens/sec est normal pour un modèle 7B. Chaque token représente environ 0,75 mot. À 10 tokens/sec, une réponse de 100 mots prend environ 13 secondes. Pour accélérer l\'inférence, utilisez un modèle plus petit (3B au lieu de 8B), activez le déchargement GPU si disponible, ou utilisez le niveau de quantification Q4_K_M qui est le paramètre commun le plus rapide.' } },
          { '@type': 'Question', 'name': 'Puis-je exécuter deux modèles en même temps ?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Ollama peut garder plusieurs modèles chargés simultanément si vous avez assez de RAM. Par défaut, Ollama décharge un modèle après 5 minutes d\'inactivité. Vous pouvez changer cela avec la variable d\'environnement OLLAMA_KEEP_ALIVE. L\'exécution de deux modèles 7B simultanément nécessite ~16 Go de RAM.' } },
          { '@type': 'Question', 'name': 'Comment arrêter Ollama en arrière-plan ?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Sur macOS : cliquez sur l\'icône llama dans la barre de menu et sélectionnez Quitter. Sur Linux : exécutez `systemctl stop ollama`. Sur Windows : clic droit sur l\'icône dans la barre système et sélectionnez Quitter. Pour empêcher Ollama de démarrer à la connexion, retirez-le de vos éléments de démarrage.' } },
          { '@type': 'Question', 'name': 'Quelle est la façon la plus simple d\'exécuter un LLM local pour la première fois ?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Installez Ollama ([ollama.com](https://ollama.com)), exécutez `ollama pull llama3.2:3b`, puis `ollama run llama3.2:3b`. C\'est tout. Trois commandes, 2-5 minutes, et vous avez un modèle IA fonctionnel sur votre machine, sans Internet requis après le téléchargement initial.' } },
          { '@type': 'Question', 'name': 'Comment savoir si mon LLM local fonctionne correctement ?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Exécutez `ollama ps` dans le terminal. Si le modèle fonctionne, il apparaîtra dans la liste avec son nom, sa taille et son utilisation mémoire. Envoyez un prompt simple comme "Combien font 2+2 ?" -- si la réponse est "4", le modèle fonctionne correctement.' } },
          { '@type': 'Question', 'name': 'Mon ordinateur a-t-il besoin d\'un GPU pour exécuter un LLM local ?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Non. Les LLMs locaux s\'exécutent sur CPU. Un GPU rend l\'inférence 5-10× plus rapide, mais CPU seul convient pour l\'apprentissage et beaucoup de cas d\'usage réels. Les laptops modernes avec Apple M1/M2, AMD Ryzen ou Intel 12e génération peuvent exécuter des modèles 3B-7B à des vitesses raisonnables (10-30 tokens/sec).' } },
          { '@type': 'Question', 'name': 'Combien d\'espace disque occupe un LLM local ?', 'acceptedAnswer': { '@type': 'Answer', 'text': '`llama3.2:1b` fait 1,3 Go, `llama3.2:3b` fait 2 Go, `llama3.1:8b` fait 4,7 Go. Ce sont les tailles compressées telles que stockées par Ollama. Après chargement en RAM pour l\'inférence, les tailles diffèrent.' } },
          { '@type': 'Question', 'name': 'Puis-je utiliser mon LLM local sans connexion Internet ?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Oui, complètement. Téléchargez le modèle une fois avec Ollama (nécessite Internet), puis exécutez en local pour toujours sans Internet. Parfait pour les réseaux privés, les avions ou les environnements totalement hors ligne.' } },
          { '@type': 'Question', 'name': 'En quoi un LLM local diffère-t-il de ChatGPT ?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'ChatGPT fonctionne sur les serveurs d\'Anthropic. Les LLMs locaux fonctionnent sur votre machine. Local = zéro donnée quitte votre appareil, pleine confidentialité, aucun coût API. ChatGPT = meilleure qualité sur les tâches complexes, nécessite Internet et un abonnement payant.' } },
          { '@type': 'Question', 'name': 'Quel est le meilleur premier modèle à essayer avec Ollama ?', 'acceptedAnswer': { '@type': 'Answer', 'text': '`ollama pull llama3.2:3b` -- il fait 2 Go, fonctionne sur n\'importe quel laptop moderne, produit des réponses compétentes, et est le point de départ recommandé par Ollama.' } },
        ]
      },
      howToSchema: {
        '@context': 'https://schema.org',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'Llama 3.1 8B', 'description': '8-16 Go de RAM. Téléchargement de 4,7 Go. Modèle polyvalent performant.' },
      ...
      sections: {
        tldr: { id: 'key-takeaways', isTldr: true, snippetBlocks: [
            { type: 'one-sentence', text: "Exécuter votre premier LLM local prend moins de 10 minutes : installez Ollama, lancez une commande comme `ollama run llama3.2` pour télécharger un petit modèle, et discutez dans votre terminal sans clé API, compte ni connexion Internet après le téléchargement initial." },
            { type: 'plain-terms', text: "Aucune configuration particulière n'est nécessaire pour essayer un modèle d'IA local. Installez un programme gratuit (Ollama), tapez une seule commande, et il télécharge un petit modèle et ouvre un chat directement dans votre terminal. Après ce premier téléchargement, tout fonctionne entièrement hors ligne -- pas de compte, pas de clé API, pas de facture mensuelle." },
          ], items: ['Le chemin le plus rapide : installez Ollama → exécutez `ollama run llama3.2` → discutez dans votre terminal. Durée totale : moins de 5 minutes avec une connexion rapide.', 'Pour les machines avec 8 Go de RAM : commencez avec `llama3.2:3b` (2 Go de téléchargement) ou `phi4-mini` (2,3 Go). Les deux fonctionnent sur n\'importe quel laptop moderne.', 'Attendez 15-40 tokens/sec sur CPU, 60-120 tokens/sec sur un GPU milieu de gamme ou Apple Silicon.', 'Les premières réponses peuvent sembler plus lentes que les APIs cloud -- les modèles locaux échangent vitesse contre confidentialité et coût zéro.', 'Après le téléchargement initial du modèle, tout fonctionne hors ligne. Aucune connexion Internet requise pour les sessions suivantes.'] },
        step1: {
          id: 'step-1-install-ollama', title: 'Étape 1 : Installer Ollama', content: 'Ollama est le moyen le plus rapide d\'exécuter un LLM local. Installez-le avec une commande ou un téléchargement de 2 minutes :', codeBlock: '# macOS (Homebrew)\nbrew install ollama\n\n# Linux\ncurl -fsSL https://ollama.com/install.sh | sh\n\n# Windows: download installer from ollama.com/download', codeLanguage: 'bash' },
    ...
    ja: {
      ...
      heroImage: '/images/run-first-local-llm-overview-hero-ja.webp',
      dateModified: '2026-08-28',
      seoTitle: 'Ollamaで初めてのローカルLLMを10分で起動するステップバイステップガイド2026',
      intro: 'Ollamaを使用して初めてのローカルLLMを実行するには10分以下かかります。Ollamaをインストールし、1つのコマンドを実行してモデルをロードし、ターミナルでチャットを開始します。APIキー、アカウント、初期ダウンロード後のインターネット接続は不要です。初心者向けの高速なモデルとしてLlama 3.2 3Bがあり、モダンノートパソコンのCPUで25～45トークン/秒です。',
      metaDescription: 'Ollamaを使って初めてのローカルLLMを10分以内で実行。インストール、モデルダウンロード、初回プロンプト実行まで完全解説。Mac・Windows・Linux対応、クラウド不要。',
      publishDate: '2026-04-04',
      leadAnswerBlock: '**Ollamaを使用すれば、初めてのローカルLLMを10分以内で実行できます。Ollamaをインストールし、1つのコマンドを実行してモデルをロードし、ターミナルでチャットを開始します。APIキー、アカウント、初期ダウンロード後のインターネット接続は不要です。**',
      ...
      toc: [
        ...
        { label: 'ステップ4：実行してチャット', anchor: '#step-4-run-and-chat' },
        { label: '期待できること：速度と品質', anchor: '#what-to-expect' },
        { label: 'ターミナル以外での活用', anchor: '#beyond-the-terminal' },
...
schema: {
      ...
      faqSchema: {
        ...
        '@type': 'FAQPage',
        'mainEntity': [
          { '@type': 'Question', 'name': 'モデルのレスポンスが非常に遅い -- これは正常ですか？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'CPU専用ハードウェアでは、7Bモデルの場合8-20トークン/秒は正常です。各トークンは約0.75単語に相当します。10トークン/秒で100単語のレスポンスには約13秒かかります。推論を高速化するには、より小さいモデル（8Bの代わりに3B）を使用するか、対応GPUがある場合はGPUオフロードを有効にするか、最も一般的で最速の設定であるQ4_K_M量子化レベルを使用してください。' } },
          { '@type': 'Question', 'name': '2つのモデルを同時に実行できますか？', 'acceptedAnswer': { '@type': 'Answer', 'text': '十分なRAMがあれば、Ollamaは複数のモデルを同時にロードした状態に保てます。デフォルトでは、Ollamaは5分間の非活性後にモデルをアンロードします。OLLAMA_KEEP_ALIVE環境変数でこれを変更できます。2つの7Bモデルを同時に実行するには約16 GBのRAMが必要です。' } },
          { '@type': 'Question', 'name': 'Ollamaをバックグラウンドで動作しないようにするには？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'macOS：メニューバーのllamaアイコンをクリックして「終了」を選択。Linux：`systemctl stop ollama`を実行。Windows：システムトレイのアイコンを右クリックして「終了」を選択。ログイン時にOllamaが起動しないようにするには、スタートアップ項目から削除してください。' } },
          { '@type': 'Question', 'name': '初めてローカルLLMを実行する最も簡単な方法は？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Ollamaをインストールし（ollama.com）、`ollama pull llama3.2:3b`を実行し、次に`ollama run llama3.2:3b`を実行します。それだけです。3つのコマンド、2-5分で、初期ダウンロード後はインターネット不要のAIモデルがマシン上で動作します。' } },
          { '@type': 'Question', 'name': 'ローカルLLMが正常に動作しているか確認するには？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'ターミナルで`ollama ps`を実行します。モデルが実行中であれば、名前、サイズ、メモリ使用量とともにリストに表示されます。「2+2は？」のような簡単なプロンプトを送って、「4」と返ってくれば正常に動作しています。' } },
          { '@type': 'Question', 'name': 'ローカルLLMを実行するのにGPUは必要ですか？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'いいえ。ローカルLLMはCPUで動作します。GPUは推論を5-10倍速くしますが、学習や多くの実際のユースケースにはCPU専用でも問題ありません。Apple M1/M2、AMD Ryzen、またはIntel第12世代CPUを搭載した最新のノートパソコンは3B-7Bモデルを合理的な速度（10-30トークン/秒）で実行できます。' } },
          { '@type': 'Question', 'name': 'ローカルLLMはどれくらいのディスクスペースを使いますか？', 'acceptedAnswer': { '@type': 'Answer', 'text': '`llama3.2:1b`は1.3 GB、`llama3.2:3b`は2 GB、`llama3.1:8b`は4.7 GBです。これらはOllamaが保存する圧縮サイズです。RAMにロードして推論する際にはサイズが異なります。' } },
          { '@type': 'Question', 'name': 'インターネット接続なしでローカルLLMを使用できますか？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'はい、完全に。Ollamaでモデルを一度ダウンロードし（インターネット必要）、その後は永遠にインターネットなしでローカルで実行できます。プライベートネットワーク、飛行機内、または完全なオフライン環境に最適です。' } },
          { '@type': 'Question', 'name': 'ローカルLLMとChatGPTの違いは？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'ChatGPTはAnthropicのサーバーで動作します。ローカルLLMはあなたのマシンで動作します。ローカル = デバイスからデータが一切出ない、完全なプライバシー、APIコストなし。ChatGPT = 複雑なタスクでより高い品質、インターネットと有料サブスクリプションが必要。' } },
          { '@type': 'Question', 'name': 'Ollamaで試すべき最初のモデルは？', 'acceptedAnswer': { '@type': 'Answer', 'text': '`ollama pull llama3.2:3b` -- 2 GBで、あらゆる最新ノートパソコンで動作し、有能な回答を生成し、Ollamaが推奨するスタート地点です。' } },
        ]
      },
      howToSchema: {
        '@context': 'https://schema.org',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'Llama 3.1 8B', 'description': '8-16 GB RAM。4.7 GBダウンロード。強力な汎用モデル。' },
          { '@type': 'ListItem', 'position': 4, 'name': 'mistral:7b または qwen2.5:7b', 'description': '16 GB以上のRAM。4-5 GBダウンロード。競争力のある品質。' },
        ]
      },
      sections: {
        tldr: { id: 'key-takeaways', isTldr: true, snippetBlocks: [
            { type: 'one-sentence', text: '初めてのローカルLLM実行は10分もかかりません。Ollamaをインストールし、`ollama run llama3.2`のようなコマンドで小さなモデルをダウンロードし、ターミナルでチャットを始めるだけで、初回ダウンロード後はAPIキー、アカウント、インターネット接続が不要です。' },
            { type: 'plain-terms', text: 'ローカルAIモデルを試すのに特別な設定は必要ありません。無料プログラム（Ollama）をインストールし、コマンドを1つ入力するだけで、小さなモデルがダウンロードされ、ターミナルで直接チャットが開始されます。この最初のダウンロードの後は、アカウントもAPIキーも月額料金も不要で、完全にオフラインで動作します。' },
          ], items: ['最速の手順：Ollamaをインストール → `ollama run llama3.2`を実行 → ターミナルでチャット。高速接続なら合計5分以内。', '8 GBのRAMマシン：`llama3.2:3b`（2 GBのダウンロード）または`phi4-mini`（2.3 GB）から始めてください。どちらも最新のノートパソコンで動作します。', 'CPUで15-40トークン/秒、ミッドレンジGPUまたはApple Siliconで60-120トークン/秒が期待できます。', '最初のレスポンスはクラウドAPIより遅く感じる場合があります。ローカルモデルは速度をプライバシーとゼロコストと交換します。', '初期モデルのダウンロード後は、すべてオフラインで動作します。次回以降のセッションにインターネット接続は不要です。'] },
        step1: {
          id: 'step-1-install-ollama', title: 'ステップ1：Ollamaをインストール', content: 'Ollamaはローカルで動作するLLMを実行する最速の方法です。1つのコマンドまたは2分のダウンロードでインストールできます：', codeBlock: '# macOS (Homebrew)\nbrew install ollama\n\n# Linux\ncurl -fsSL https://ollama.com/install.sh | sh\n\n# Windows: download installer from ollama.com/download', codeLanguage: 'bash', image: '/images/run-first-local-llm-setup-flow-en.svg', imageCaption: 'インストールから最初の応答まで4ステップ：Ollamaをインストール（約2分）、llama3.2:3bをダウンロード（約2 GB、2〜5分）、実行してチャット、モデル読み込み5〜30秒後に最初の応答。合計10分未満、ダウンロード後は完全オフラインで動作。' },
        step1Detail: { title: 'Ollamaが動作していることを確認', content: 'インストール後、Ollamaがアクティブであることを確認します：', codeBlock: 'curl http://localhost:11434\n# Expected output: Ollama is running', codeLanguage: 'bash' },
        step2: {
          id: 'step-2-choose-your-first-model', title: 'ステップ2：最初のモデルを選択', content: '利用可能なRAMに基づいてモデルを選択します。迷った場合は`llama3.2:3b`から始めてください。4 GBのRAMを搭載したあらゆるマシンで動作し、有用な出力を生成します：', rows: [{ 'お使いのRAM': '4 GB', '推奨モデル': 'llama3.2:1b', 'ダウンロードサイズ': '約1.3 GB', '理由': '最小限の使えるLlamaモデル' }, { 'お使いのRAM': '8 GB', '推奨モデル': 'Llama 3.2 3B', 'ダウンロードサイズ': '約2 GB', '理由': '初心者向けの最高の品質/サイズ比' }, { 'お使いのRAM': '8-16 GB', '推奨モデル': 'Llama 3.1 8B', 'ダウンロードサイズ': '約4.7 GB', '理由': '強力な汎用モデル' }, { 'お使いのRAM': '16 GB以上', '推奨モデル': 'mistral:7b または qwen2.5:7b', 'ダウンロードサイズ': '約4-5 GB', '理由': '競争力のある品質、高速な推論' }], columns: ['お使いのRAM', '推奨モデル', 'ダウンロードサイズ', '理由'], image: '/images/run-first-local-llm-ram-model-picker-en.svg', imageCaption: 'RAM別の最初のモデル選び：4 GBはllama3.2:1b（1.3 GB）、8 GBはLlama 3.2 3B（2 GB、推奨の出発点）、8-16 GBはLlama 3.1 8B（4.7 GB）、16 GB以上はmistral:7bまたはqwen2.5:7b（4-5 GB）。' },
        step3: {
          id: 'step-3-pull-the-model', title: 'ステップ3：モデルをダウンロード', content: '`ollama pull`でモデルをダウンロードします。モデルは`~/.ollama/models`に保存され、一度だけダウンロードすれば使えます：', codeBlock: 'ollama pull llama3.2\n\n# Or pull a specific size variant\nollama pull llama3.2:3b\nollama pull llama3.1:8b', codeLanguage: 'bash' },
    ...
    zh: {
      ...
      heroImage: '/images/run-first-local-llm-overview-hero-zh.webp',
      dateModified: '2026-08-28',
      seoTitle: '10分钟内用Ollama运行第一个本地LLM：分步安装指南2026',
      intro: '使用Ollama运行您的第一个本地LLM只需不到10分钟。安装Ollama，运行一个命令加载模型，然后在您的终端中开始聊天----无需API密钥、账户，初始下载后也无需互联网连接。适合初学者的快速模型是Llama 3.2 3B，在现代笔记本电脑CPU上可达25-45个令牌/秒。',
      metaDescription: '用Ollama在10分钟内运行第一个本地LLM：安装、模型下载、首次推理完整指南。支持Mac、Windows、Linux，无需云端或GPU。',
      publishDate: '2026-04-04',
      leadAnswerBlock: '**使用Ollama运行您的第一个本地LLM只需不到10分钟。安装Ollama，运行一个命令加载模型，然后在您的终端中开始聊天——无需API密钥、账户，初始下载后也无需互联网连接。**',
      ...
      toc: [
        ...
        { label: '第一步：安装Ollama', anchor: '#step-1-install-ollama' },
        { label: '第二步：选择您的第一个模型', anchor: '#step-2-choose-your-first-model' },
        { label: '第三步：下载模型', anchor: '#step-3-pull-the-model' },
        { label: '第四步：运行并聊天', anchor: '#step-4-run-and-chat' },
        { label: '预期效果：速度与质量', anchor: '#what-to-expect' },
        { label: '终端之外的用法', anchor: '#beyond-the-terminal' },
...
schema: {
      ...
      faqSchema: {
        ...
        '@type': 'FAQPage',
        'mainEntity': [
          { '@type': 'Question', 'name': '模型响应非常慢——这正常吗？', 'acceptedAnswer': { '@type': 'Answer', 'text': '在纯CPU硬件上，7B模型8-20个令牌/秒是正常的。每个令牌约0.75个词。10个令牌/秒时，100个词的响应大约需要13秒。要加速推理，使用较小模型（3B而不是8B），如有兼容GPU则启用GPU卸载，或使用Q4_K_M量化级别（最快的常用设置）。' } },
          { '@type': 'Question', 'name': '我可以同时运行两个模型吗？', 'acceptedAnswer': { '@type': 'Answer', 'text': '如果有足够的RAM，Ollama可以同时保持多个模型加载。默认情况下，Ollama在5分钟不活动后卸载模型。可通过OLLAMA_KEEP_ALIVE环境变量更改。同时运行两个7B模型需要约16 GB RAM。' } },
          { '@type': 'Question', 'name': '如何停止Ollama在后台运行？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'macOS：点击菜单栏中的llama图标并选择退出。Linux：运行`systemctl stop ollama`。Windows：右键单击系统托盘图标并选择退出。要防止Ollama在登录时启动，请将其从启动项中移除。' } },
          { '@type': 'Question', 'name': '首次运行本地LLM最简单的方法是什么？', 'acceptedAnswer': { '@type': 'Answer', 'text': '安装Ollama（ollama.com），运行`ollama pull llama3.2:3b`，然后运行`ollama run llama3.2:3b`。就这样。三条命令，2-5分钟，您就在机器上拥有了一个可用的AI模型，初始下载后无需互联网。' } },
          { '@type': 'Question', 'name': '如何知道本地LLM是否正常工作？', 'acceptedAnswer': { '@type': 'Answer', 'text': '在终端运行`ollama ps`。如果模型在运行，它会在列表中显示其名称、大小和内存使用情况。发送一个简单提示词如"2+2等于几？"——如果回答"4"，模型工作正常。' } },
          { '@type': 'Question', 'name': '运行本地LLM需要GPU吗？', 'acceptedAnswer': { '@type': 'Answer', 'text': '不需要。本地LLM在CPU上运行。GPU使推理速度快5-10倍，但对于学习和许多实际用例，纯CPU也完全可以。搭载Apple M1/M2、AMD Ryzen或英特尔第12代CPU的现代笔记本电脑可以以合理速度（10-30个令牌/秒）运行3B-7B模型。' } },
          { '@type': 'Question', 'name': '本地LLM占用多少磁盘空间？', 'acceptedAnswer': { '@type': 'Answer', 'text': '`llama3.2:1b`为1.3 GB，`llama3.2:3b`为2 GB，`llama3.1:8b`为4.7 GB。这些是Ollama存储的压缩大小。加载到RAM中进行推理后，大小会有所不同。' } },
          { '@type': 'Question', 'name': '没有互联网连接可以使用本地LLM吗？', 'acceptedAnswer': { '@type': 'Answer', 'text': '可以，完全可以。用Ollama下载一次模型（需要互联网），然后永久在本地运行，完全不需要互联网。适合私人网络、飞机上或完全离线环境。' } },
          { '@type': 'Question', 'name': '本地LLM与ChatGPT有何不同？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'ChatGPT在Anthropic的服务器上运行。本地LLM在您的机器上运行。本地 = 零数据离开设备，完全隐私，无API费用。ChatGPT = 复杂任务质量更高，需要互联网和付费订阅。' } },
          { '@type': 'Question', 'name': 'Ollama中最值得尝试的第一个模型是什么？', 'acceptedAnswer': { '@type': 'Answer', 'text': '`ollama pull llama3.2:3b`——2 GB，在任何现代笔记本电脑上运行，产生有竞争力的答案，是Ollama推荐的起点。' } },
        ]
      },
      howToSchema: {
        '@context': 'https://schema.org',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'Llama 3.1 8B', 'description': '8-16 GB RAM。4.7 GB下载。强大的通用模型。' },
          { '@type': 'ListItem', 'position': 4, 'name': 'mistral:7b 或 qwen2.5:7b', 'description': '16+ GB RAM。4-5 GB下载。有竞争力的质量。' },
        ]
      },
      sections: {
        tldr: { id: 'key-takeaways', isTldr: true, snippetBlocks: [
            { type: 'one-sentence', text: '运行你的第一个本地LLM不到10分钟：安装Ollama，运行像`ollama run llama3.2`这样的命令下载一个小模型，然后在终端中开始聊天，初始下载后无需API密钥、账户或互联网连接。' },
            { type: 'plain-terms', text: '试用本地AI模型不需要任何特殊设置。安装一个免费程序（Ollama），输入一条命令，它就会下载一个小模型并直接在终端打开聊天。首次下载完成后，一切完全离线运行——无需账户、无需API密钥、无需月费。' },
          ], items: ['最快路径：安装Ollama → 运行`ollama run llama3.2` → 在终端开始聊天。网速较快时全程不超过5分钟。', '8 GB RAM机器：从`llama3.2:3b`（2 GB下载）或`phi4-mini`（2.3 GB）开始。两者均可在任何现代笔记本电脑上运行。', 'CPU上预计15-40个令牌/秒，中端GPU或Apple Silicon上预计60-120个令牌/秒。', '首次响应可能比云API慢——本地模型以速度换取隐私和零成本。', '初始模型下载后，一切都在离线状态运行。后续会话无需互联网连接。'] },
        step1: {
          id: 'step-1-install-ollama', title: '第一步：安装Ollama', content: 'Ollama是运行本地LLM的最快方式。用一条命令或2分钟下载完成安装：', codeBlock: '# macOS (Homebrew)\nbrew install ollama\n\n# Linux\ncurl -fsSL https://ollama.com/install.sh | sh\n\n# Windows: download installer from ollama.com/download', codeLanguage: 'bash', image: '/images/run-first-local-llm-setup-flow-en.svg', imageCaption: '从安装到首个响应共4步：安装Ollama（约2分钟）、下载llama3.2:3b（约2 GB，2-5分钟）、运行并聊天，模型加载5-30秒后获得首个响应——总计不到10分钟，下载完成后完全离线运行。' },
        step1Detail: { title: '验证Ollama正在运行', content: '安装后，确认Ollama处于活动状态：', codeBlock: 'curl http://localhost:11434\n# Expected output: Ollama is running', codeLanguage: 'bash' },
        step2: {
          id: 'step-2-choose-your-first-model', title: '第二步：选择您的第一个模型', content: '根据可用RAM选择模型。拿不准时，从`llama3.2:3b`开始——它可在4 GB RAM的任何机器上运行并产生有用输出：', rows: [{ '您的RAM': '4 GB', '推荐模型': 'llama3.2:1b', '下载大小': '约1.3 GB', '原因': '最小可用的Llama模型' }, { '您的RAM': '8 GB', '推荐模型': 'Llama 3.2 3B', '下载大小': '约2 GB', '原因': '初学者最佳质量/大小比' }, { '您的RAM': '8-16 GB', '推荐模型': 'Llama 3.1 8B', '下载大小': '约4.7 GB', '原因': '强大的通用模型' }, { '您的RAM': '16 GB以上', '推荐模型': 'mistral:7b 或 qwen2.5:7b', '下载大小': '约4-5 GB', '原因': '有竞争力的质量，推理速度快' }], columns: ['您的RAM', '推荐模型', '下载大小', '原因'], image: '/images/run-first-local-llm-ram-model-picker-en.svg', imageCaption: '按RAM选择首个模型：4 GB选llama3.2:1b（1.3 GB）、8 GB选Llama 3.2 3B（2 GB，推荐起点）、8-16 GB选Llama 3.1 8B（4.7 GB）、16 GB以上选mistral:7b或qwen2.5:7b（4-5 GB）。' },
        step3: {
          id: 'step-3-pull-the-model', title: '第三步：下载模型', content: '使用`ollama pull`下载模型。模型保存到`~/.ollama/models`，只需下载一次：', codeBlock: 'ollama pull llama3.2\n\n# Or pull a specific size variant\nollama pull llama3.2:3b\nollama pull llama3.1:8b', codeLanguage: 'bash' },
    ...
    pt: {
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'Rodar seu primeiro LLM local leva menos de 10 minutos: instale o Ollama, execute um comando como `ollama run llama3.2` para baixar um modelo pequeno e comece a conversar no seu terminal, sem exigir chave de API, conta ou conexão à internet após o download inicial.' },
            { type: 'plain-terms', text: 'Você não precisa de nenhuma configuração especial para experimentar um modelo de IA local. Instale um programa gratuito (Ollama), digite um único comando, e ele baixará um modelo pequeno e abrirá um chat direto no terminal. Depois desse primeiro download, tudo funciona totalmente offline -- sem conta, sem chave de API, sem fatura mensal.' },
          ],
          items: [
        ...
        step2: {
          ...
          rows: [
            ...
            { 'Sua RAM': '8-16 GB', 'Modelo recomendado': 'Llama 3.1 8B', 'Tamanho do download': '~4,7 GB', 'Por quê': 'Modelo de propósito geral de alto desempenho' },
          ...
          image: '/images/run-first-local-llm-ram-model-picker-en.svg',
          imageCaption: 'Escolha do primeiro modelo por RAM: 4 GB para llama3.2:1b (1,3 GB), 8 GB para Llama 3.2 3B (2 GB, ponto de partida recomendado), 8-16 GB para Llama 3.1 8B (4,7 GB), 16+ GB para mistral:7b ou qwen2.5:7b (4-5 GB).',
        },
        step3: {
          id: 'step-3-pull-the-model',
        ...
        whatToExpect: {
          ...
          content: [
            ...
            '**Qualidade** do `llama3.2:3b` é nitidamente inferior ao GPT-5.6 ou ao Claude Opus 5 em tarefas complexas. Para resumos, perguntas e respostas simples e explicação de código, o resultado é útil. Para raciocínio em várias etapas ou escrita longa, faça upgrade para um modelo 8B ou 13B.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Instale o Ollama ([ollama.com](https://ollama.com)), execute `ollama pull llama3.2:3b` e depois `ollama run llama3.2:3b`. É isso. Três comandos, 2-5 minutos e você tem um modelo de IA funcionando na sua máquina sem precisar de internet após o download inicial.',
            },
            {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Instale o Ollama ([ollama.com](https://ollama.com)), execute `ollama pull llama3.2:3b` e depois `ollama run llama3.2:3b`. É isso. Três comandos, 2-5 minutos e você tem um modelo de IA funcionando na sua máquina sem precisar de internet após o download inicial.'
            }
          },
          {
            '@type': 'Question',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'Llama 3.1 8B', 'description': '8-16 GB de RAM. Download de 4,7 GB. Alto desempenho de propósito geral.' },
  ...
  ko: {
    ...
    heroImage: '/images/run-first-local-llm-overview-hero-ko.webp',
      dateModified: '2026-08-28',
      seoTitle: '로컬 LLM 처음 실행하기 10분 완성 (단계별 안내)',
      intro: 'Ollama를 사용하면 로컬 LLM을 10분 이내에 실행할 수 있습니다. Ollama를 설치하고 명령어 하나로 모델을 다운로드한 후, 터미널에서 바로 대화를 시작하십시오. API 키, 계정, 최초 다운로드 이후의 인터넷 연결이 전혀 필요하지 않습니다. 초보자에게 적합한 빠른 모델로 최신 노트북 CPU에서 초당 25~45 토큰을 처리하는 Llama 3.2 3B가 있습니다.',
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': '로컬 LLM 처음 실행하기 10분 완성 (단계별 안내)',
        'description': 'Ollama로 로컬 LLM을 10분 이내에 실행하십시오: 설치, 3B 모델 다운로드, 첫 응답 확인까지 — 다운로드 후에는 API 키나 인터넷이 필요 없습니다.',
        'url': 'https://www.promptquorum.com/ko/local-llms/run-first-local-llm',
        'datePublished': '2026-04-04',
        'dateModified': '2026-08-26',
        'author': { '@type': 'Person', 'name': 'Hans Kuepper', 'sameAs': 'https://www.linkedin.com/in/hanskuepper/' },
        'publisher': { '@type': 'Organization', 'name': 'PromptQuorum', 'url': 'https://www.promptquorum.com' },
        ...
        'about': [
          ...
          { '@type': 'Thing', 'name': 'Llama 3.2' },
          { '@type': 'Thing', 'name': 'local LLM' },
          { '@type': 'Thing', 'name': 'AI 모델 설정' },
          { '@type': 'Thing', 'name': '터미널 명령어' }
        ],
        'speakable': {
          '@type': 'SpeakableSpecification',
          'cssSelector': ['.article-intro', '.key-takeaways', '#faq']
      ...
      faqSchema: {
        ...
        '@type': 'FAQPage',
        'mainEntity': [
          { '@type': 'Question', 'name': '모델 응답이 매우 느립니다. 정상인가요?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'CPU 전용 하드웨어에서 7B 모델의 경우 초당 8~20 토큰은 정상입니다. 각 토큰은 약 0.75개의 단어에 해당합니다. 초당 10 토큰이라면 100단어 응답에 약 13초가 걸립니다. 추론 속도를 높이려면 더 작은 모델(8B 대신 3B)을 사용하거나, 호환 GPU가 있다면 GPU 오프로딩을 활성화하거나, 가장 빠른 일반 설정인 Q4_K_M 양자화 수준을 사용하십시오.' } },
          { '@type': 'Question', 'name': '두 모델을 동시에 실행할 수 있나요?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'RAM이 충분하다면 Ollama는 여러 모델을 동시에 로드된 상태로 유지할 수 있습니다. 기본적으로 Ollama는 5분 비활성 후 모델을 언로드합니다. OLLAMA_KEEP_ALIVE 환경 변수로 이를 변경할 수 있습니다. 두 개의 7B 모델을 동시에 실행하려면 약 16 GB의 RAM이 필요합니다.' } },
          { '@type': 'Question', 'name': 'Ollama가 백그라운드에서 실행되는 것을 중지하려면 어떻게 하나요?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'macOS: 메뉴 바의 llama 아이콘을 클릭하고 Quit을 선택하십시오. Linux: `systemctl stop ollama`를 실행하십시오. Windows: 시스템 트레이 아이콘을 오른쪽 클릭하고 Quit을 선택하십시오. 로그인 시 Ollama가 시작되지 않도록 하려면 시작 항목에서 제거하십시오.' } },
          { '@type': 'Question', 'name': '로컬 LLM을 처음 실행하는 가장 쉬운 방법은 무엇인가요?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Ollama([ollama.com](https://ollama.com))를 설치하고, `ollama pull llama3.2:3b`를 실행한 다음, `ollama run llama3.2:3b`를 실행하십시오. 이것이 전부입니다. 세 개의 명령어, 2~5분이면 인터넷 연결 없이도 기기에서 작동하는 AI 모델을 갖게 됩니다.' } },
          { '@type': 'Question', 'name': '로컬 LLM이 정상적으로 작동하는지 어떻게 알 수 있나요?', 'acceptedAnswer': { '@type': 'Answer', 'text': '터미널에서 `ollama ps`를 실행하십시오. 모델이 실행 중이라면 이름, 크기, 메모리 사용량과 함께 목록에 표시됩니다. "2+2는 얼마인가요?"와 같은 간단한 프롬프트를 보내십시오. "4"라고 응답하면 모델이 정상적으로 작동하는 것입니다.' } },
          { '@type': 'Question', 'name': '로컬 LLM을 실행하려면 GPU가 필요한가요?', 'acceptedAnswer': { '@type': 'Answer', 'text': '아닙니다. 로컬 LLM은 CPU에서도 실행됩니다. GPU를 사용하면 추론 속도가 5~10배 빨라지지만, CPU 전용으로도 학습 및 많은 실제 사용 사례에 충분합니다. Apple M1/M2, AMD Ryzen, 또는 Intel 12세대 CPU가 탑재된 최신 노트북은 3B~7B 모델을 합리적인 속도(초당 10~30 토큰)로 실행할 수 있습니다.' } },
          { '@type': 'Question', 'name': '로컬 LLM은 디스크 공간을 얼마나 차지하나요?', 'acceptedAnswer': { '@type': 'Answer', 'text': '`llama3.2:1b`는 1.3 GB, `llama3.2:3b`는 2 GB, `llama3.1:8b`는 4.7 GB입니다. 이는 Ollama가 저장하는 압축 크기입니다. 추론을 위해 RAM에 로드될 때 크기가 달라집니다.' } },
          { '@type': 'Question', 'name': '인터넷 연결 없이 로컬 LLM을 사용할 수 있나요?', 'acceptedAnswer': { '@type': 'Answer', 'text': '네, 완전히 가능합니다. Ollama로 모델을 한 번 다운로드(인터넷 필요)하면 이후에는 인터넷 없이 영구적으로 로컬에서 실행할 수 있습니다. 사설 네트워크, 비행기, 또는 완전한 오프라인 환경에 적합합니다.' } },
          { '@type': 'Question', 'name': '로컬 LLM은 ChatGPT와 어떻게 다른가요?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'ChatGPT는 Anthropic의 서버에서 실행됩니다. 로컬 LLM은 사용자의 기기에서 실행됩니다. 로컬 = 데이터가 기기 밖으로 나가지 않음, 완전한 프라이버시, 지속적인 API 비용 없음. ChatGPT = 복잡한 작업에서 더 높은 품질, 인터넷 및 유료 구독 필요. 두 방식 모두 장단점이 있습니다.' } },
          { '@type': 'Question', 'name': 'Ollama로 처음 시도해볼 최적의 모델은 무엇인가요?', 'acceptedAnswer': { '@type': 'Answer', 'text': '`ollama pull llama3.2:3b` — 용량이 2 GB이고 최신 노트북에서 실행되며 적절한 답변을 제공합니다. Ollama가 권장하는 시작점입니다.' } },
        ]
      },
      howToSchema: {
        '@context': 'https://schema.org',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'Llama 3.1 8B', 'description': 'RAM 8~16GB. 다운로드 4.7GB. 강력한 범용 모델.' },
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: '첫 로컬 LLM 실행은 10분도 걸리지 않습니다. Ollama를 설치하고 `ollama run llama3.2`와 같은 명령어 하나로 작은 모델을 다운로드한 뒤 터미널에서 바로 대화를 시작할 수 있으며, 최초 다운로드 이후에는 API 키, 계정, 인터넷 연결이 필요 없습니다.' },
            { type: 'plain-terms', text: '로컬 AI 모델을 사용해보는 데 특별한 설정은 필요 없습니다. 무료 프로그램(Ollama)을 설치하고 명령어 하나만 입력하면 작은 모델을 다운로드하고 터미널에서 바로 채팅이 시작됩니다. 첫 다운로드 이후에는 계정도, API 키도, 월 요금도 없이 완전히 오프라인으로 작동합니다.' },
          ],
          items: [
        ...
        step2: {
          ...
          rows: [
            ...
            { '보유 RAM': '8~16 GB', '권장 모델': 'Llama 3.1 8B', '다운로드 크기': '약 4.7 GB', '이유': '강력한 범용 모델' },
            { '보유 RAM': '16 GB 이상', '권장 모델': 'mistral:7b 또는 qwen2.5:7b', '다운로드 크기': '약 4~5 GB', '이유': '우수한 품질, 빠른 추론 속도' },
          ],
          columns: ['보유 RAM', '권장 모델', '다운로드 크기', '이유'],
          image: '/images/run-first-local-llm-ram-model-picker-en.svg',
          imageCaption: 'RAM별 첫 모델 선택: 4GB는 llama3.2:1b(1.3GB), 8GB는 Llama 3.2 3B(2GB, 추천 시작점), 8~16GB는 Llama 3.1 8B(4.7GB), 16GB 이상은 mistral:7b 또는 qwen2.5:7b(4~5GB).',
        },
        step3: {
          id: 'step-3-pull-the-model',
          title: '3단계: 모델 다운로드',
        ...
        whatToExpect: {
          ...
          content: [
            ...
            '`llama3.2:3b`의 **품질**은 복잡한 작업에서 GPT-5.6나 Claude Opus 5보다 눈에 띄게 낮습니다. 요약, 간단한 Q&A, 코드 설명에서는 충분히 유용한 결과를 제공합니다. 다단계 추론이나 장문 작성에는 8B 또는 13B 모델로 업그레이드하십시오.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Ollama([ollama.com](https://ollama.com))를 설치하고, `ollama pull llama3.2:3b`를 실행한 다음, `ollama run llama3.2:3b`를 실행하십시오. 이것이 전부입니다. 세 개의 명령어, 2~5분이면 인터넷 연결 없이도 기기에서 작동하는 AI 모델을 갖게 됩니다.',
            },
            {
