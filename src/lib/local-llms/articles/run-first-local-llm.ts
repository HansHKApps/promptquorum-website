...
schema: {
    ...
    es: {
      ...
      schema: {
        ...
        'url': 'https://www.promptquorum.com/es/es/local-llms/run-first-local-llm',
        'datePublished': '2026-04-04',
        'dateModified': '2026-04-18',
    ...
    ar: {
      ...
      seoTitle: 'LLM محلي أول مع Ollama في 10 دقائق: خطوات مضمونة',
      ...
      metaDescription: 'Llama 3.2 3B ينتج 25–45 token/ثانية بلا GPU: ثبّت Ollama، نزّل النموذج بأمر واحد، وابدأ الدردشة دون مفتاح API أو إنترنت دائم.',
      publishDate: '2026-04-04',
