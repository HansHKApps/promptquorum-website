...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      heroImage: '/images/used-gpus-for-local-llms-overview-hero-en.png',
...
schema: {
    ...
    es: {
      ...
      heroImage: '/images/used-gpus-for-local-llms-overview-hero-es.png',
    ...
    ar: {
      ...
      heroImage: '/images/used-gpus-for-local-llms-overview-hero-ar.png',
    ...
    pt: {
      ...
      heroImage: '/images/used-gpus-for-local-llms-overview-hero-pt.png',
    ...
    de: {
      ...
      heroImage: '/images/used-gpus-for-local-llms-overview-hero-de.png',
    ...
    fr: {
      ...
      heroImage: '/images/used-gpus-for-local-llms-overview-hero-fr.png',
    ...
    ja: {
      ...
      heroImage: '/images/used-gpus-for-local-llms-overview-hero-ja.png',
    ...
    zh: {
      ...
      heroImage: '/images/used-gpus-for-local-llms-overview-hero-zh.png',
  ...
  ko: {
    ...
    heroImage: '/images/used-gpus-for-local-llms-overview-hero-ko.png',
      ...
      toc: [
        ...
        { label: '중고 GPU는 어디서 구매해야 하나?', anchor: '#where-to-buy' },
        { label: '구매 전 중고 GPU를 테스트하는 방법은?', anchor: '#testing' },
        { label: '중고 GPU 구매 시 흔한 실수', anchor: '#mistakes' },
        { label: 'FAQ', anchor: '#faq' },
      ],
      sections: {
        tldr: {
          ...
          items: [
            ...
            '게이밍 카드(전 게이밍용 리셀 제품)는 채굴용 카드보다 안전합니다. 일반적인 게임 사용은 24/7 채굴만큼 VRAM에 부하를 주지 않습니다.',
            'eBay(구매자 보호 포함), Facebook Marketplace(현장 테스트 가능), Craigslist(현지 거래, 현장 테스트 필수)가 최선의 구매 채널입니다.',
            '거래 확정 전 MemtestG80(GPU 메모리 테스트)을 1~2시간 실행하십시오. 불량 VRAM은 즉시 오류로 나타납니다.',
            '이력 불명 카드는 5~10% 추가 할인을 요구하십시오. 너무 좋은 가격의 제품은 문제가 있을 가능성이 높습니다.',
            'RTX A100, L40S 등 전 서버/데이터센터 카드는 상태를 확실히 알 수 없다면 피하십시오. 발열이 심하고 써멀 스로틀링 손상이 있을 수 있습니다.',
          ],
        },
        'safest-cards': {
          id: 'safest-cards',
          title: '가장 안전하게 구매할 수 있는 중고 GPU는?',
          items: [
            '**RTX 3060 12GB** ($200~250): 중고 시장 거래량이 매우 많습니다. VRAM이 안정적이고 구형 아키텍처로 인한 불량률이 낮습니다. 안전한 선택입니다.',
            '**RTX 3080 10GB** ($350~400): 인기 있는 게이밍 카드입니다. VRAM 이력이 견고합니다. 10GB는 일부 70B 모델에 다소 부족하지만 활용 가능합니다. 안전합니다.',
            '**RTX 4090 24GB** ($1,000~1,300): 프리미엄 가격이지만 높은 중고 거래량으로 불량률 데이터가 충분합니다. VRAM 불량은 드뭅니다. 적정 가격이라면 안전합니다.',
            '**RTX 3090 24GB** ($400~600): 고사양 제품이며 불량률이 상대적으로 낮습니다. $500 미만으로 구할 수 있다면 좋은 선택입니다.',
          ],
        },
        'pricing': {
          id: 'pricing',
          title: '중고 GPU 적정 가격은 얼마인가?',
          content: [
            '**기준: 소비자 권장 소매가(MSRP) 대비** 중고 시장 가격 (2026년 4월 기준).',
          ],
          items: [
            'RTX 3060 12GB: MSRP $329 → 중고 $200~250 (39~62% 할인)',
            'RTX 3080 10GB: MSRP $699 → 중고 $350~400 (50~55% 할인)',
            'RTX 4090 24GB: MSRP $1,499 → 중고 $1,000~1,300 (13~33% 할인, 신형이라 할인폭이 작음)',
          ],
        },
        'mining-vs-gaming': {
          id: 'mining-vs-gaming',
          title: '채굴용 카드 vs 게이밍 카드: 차이점은?',
          content: [
            '**채굴용 카드**는 1~3년간 24/7 풀 컴퓨팅 부하로 가동되었습니다. 반복적인 열 사이클 스트레스는 VRAM에 치명적입니다. 현재 VRAM 오류 발생 확률이 10~20%에 달합니다.',
            '**게이밍 카드**는 하루 4~8시간 불규칙적 부하로 사용되었습니다. 스트레스가 적어 VRAM 수명이 더 깁니다. 더 안전합니다.',
            '외관상: 채굴용 카드는 심한 사용 흔적(먼지, 열 손상, 라벨 박리)이 있는 경우가 많습니다. 게이밍 카드는 더 깔끔합니다.',
            '가격: 동일 모델 기준 채굴용 카드가 $50~100 저렴합니다. 현장 테스트 없이는 리스크 대비 가치가 없습니다.',
          ],
        },
        'where-to-buy': {
          id: 'where-to-buy',
          title: '중고 GPU는 어디서 구매해야 하나?',
          items: [
            '**eBay**: 구매자 보호가 가장 뛰어납니다. 판매자 평점 확인 가능. 배송 포함. 불량 도착(DOA) 시 반품 가능. 1~2주 소요됩니다.',
            '**Facebook Marketplace**: 현지 거래로 결제 전 현장 테스트 가능. 배송 리스크 없음. 즉시 수령 가능. Craigslist보다 거래 풀이 큽니다.',
            '**Craigslist**: 최저 가격. 현지 거래만 가능. 사기 위험이 가장 높습니다. 안전한 공공장소에서 만나 즉시 테스트할 수 있는 경우에만 이용하십시오.',
            '**지역 컴퓨터 수리점**: 중고 재고를 보유하는 경우가 많습니다. 반품 정책을 문의할 수 있습니다. eBay 대비 10~15% 높은 가격이지만 신뢰도가 높습니다.',
          ],
        },
        'testing': {
          id: 'testing',
          title: '구매 전 중고 GPU를 테스트하는 방법은?',
          content: [
            '**1. 외관 점검: 물리적 손상, 소손 부품, 캐패시터 누액 여부를 확인합니다.**',
            '2. 테스트 시스템에 설치: OS 부팅 후 GPU-Z를 실행합니다. 클럭 속도(사양 일치 여부)와 온도 수치를 확인합니다.',
            '3. MemtestG80 실행(무료): VRAM의 90%를 할당하고 1~2시간 실행합니다. 불량 메모리는 오류로 즉시 나타납니다.',
            '4. FurMark 실행(스트레스 테스트): 풀 부하로 30분간 실행합니다. 카드가 크래시되거나 심하게 스로틀링되면 안 됩니다.',
            '5. VRAM 대역폭 확인(CrystalDiskInfo 또는 GPU-Z): 사양과 비교합니다. 현저히 낮으면 잠재적 열화 가능성이 있습니다.',
            'eBay/Craigslist에서 중고 구매 시, 판매자에게 이 테스트를 수행하고 스크린샷 증거를 제공하도록 요청하십시오.',
          ],
        },
        'mistakes': {
          id: 'mistakes',
          title: '중고 GPU 구매 시 흔한 실수',
          items: [
            '테스트 없이 "MSRP 대비 $250 할인"된 채굴용 RTX 3080 구매 — VRAM이 열화된 경우가 많으며 부하 시 오류가 발생합니다.',
            '"거의 새것 상태"를 VRAM 정상으로 오해 — 외관과 부품 상태는 별개입니다. 반드시 스트레스 테스트를 실시하십시오.',
            '구매자 보호 없이(eBay 외) 배송으로 GPU 구매 대금 선결제 — 불량으로 도착해도 구제받을 방법이 없습니다.',
          ],
        },
        'faqSection': {
          id: 'faq',
          ...
          faqs: [
            ...
            { q: '중고로 구매할 수 있는 가장 오래된 RTX 세대는 무엇인가요?', a: 'RTX 2000 시리즈(2060, 2080)는 매우 오래된 제품입니다(2018년 출시). $80 미만에만 구매하십시오. RTX 3000 시리즈(2020~2021년 출시)가 안전한 기준선입니다.' },
            { q: '중고 RTX 4070과 RTX 3080 중 무엇을 선택해야 하나요?', a: 'RTX 3080(10GB, 중고 $350~400)이 로컬 LLM용으로는 4070(12GB, 중고 $450~550)보다 가성비가 높습니다. 4070이 신형이지만 성능 차이는 약 15%에 불과합니다.' },
            { q: 'eBay에서 구매한 중고 GPU를 1개월 후 불량으로 반품할 수 있나요?', a: '판매자 정책에 따라 다릅니다. 대부분 14일 반품을 허용합니다. 30일이 지나면 제조 결함(중고 카드에는 드뭄)이 없는 한 구제받기 어렵습니다.' },
            { q: '반품 보호가 있는 GPU에 20% 추가 비용을 지불할 가치가 있나요?', a: '그렇습니다. $250짜리 GPU 기준 약 $30~50의 추가 비용이지만, 구매 후 카드가 불량이 될 경우 $250 손실을 방지할 수 있습니다.' },
            { q: '중고 RTX 3090과 RTX 4090 중 무엇을 선택해야 하나요?', a: '예산이 허락한다면 RTX 4090($1,000~1,300)을 선택하십시오. 전력 효율이 더 높고 아키텍처가 최신입니다. RTX 3090은 7B 모델에는 과사양이며 중고 가격도 크게 저렴하지 않습니다(약 $500~600).' },
          ],
        },
        'relatedReading': {
          id: 'related-reading',
        ...
        'sources': {
          ...
          title: '출처',
          items: [
            'eBay GPU 가격 이력 및 시장 데이터 (2026년 4월)',
            'VRAM 검증을 위한 MemtestG80 및 GPU 스트레스 테스트 도구 문서',
            '열 특성 및 클럭 속도 기준선을 위한 GPU-Z 사양 데이터베이스',
          ],
        },
      },
      itemListSchema: {
