...
schema: {
    ...
    ar: {
      ...
      seoTitle: 'LLM محلي للكتابة الإبداعية 2026: Llama وMistral',
      ...
      metaDescription: 'Llama 3.3 70B يقدّم أفضل جودة نثر محلياً. Mistral Small 3.1 24B الأمثل بـ 16 GB RAM. نماذج مضبوطة كـ Fimbulvetr متخصصة في الروايات وتقمّص الأدوار.',
      publishDate: '2026-04-04',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[دليل ضبط نماذج LLM المحلية بدقة](/ar/local-llms/fine-tuning-local-llms) — كيفية ضبط النماذج بأسلوب كتابتك',
            '[مقارنة Ollama مقابل LM Studio](/ar/local-llms/ollama-vs-lm-studio) — أي أداة أفضل لسير العمل الإبداعي',
            '[شرح درجة الحرارة ومعاملات أخذ العينات](/ar/local-llms/temperature-sampling-local-llm) — أتقن التحكم في المخرجات الإبداعية',
          ],
        },
      },
    },
    pt: {
      ...
      schema: {
        ...
        'datePublished': '2026-04-04',
        'dateModified': '2026-04-18',
        'url': 'https://www.promptquorum.com/pt/pt/local-llms/best-local-llms-for-creative-writing',
        'proficiencyLevel': 'Beginner',
        'about': [
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Guia de fine-tuning de LLMs locais](/pt/local-llms/fine-tuning-local-llms) — Como fazer fine-tune de modelos com o seu estilo de escrita',
            ...
            '[Temperatura e parâmetros de amostragem explicados](/pt/local-llms/temperature-sampling-local-llm) — Domine o controle da saída criativa',
          ],
        },
      },
    },
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[로컬 LLM 파인튜닝 가이드](/local-llms/fine-tuning-local-llms) -- 귀하의 글쓰기 스타일로 모델을 파인튜닝하는 방법',
            '[Ollama vs LM Studio 비교](/local-llms/ollama-vs-lm-studio) -- 창작 워크플로우에 가장 적합한 도구',
            '[온도 및 샘플링 매개변수 설명](/local-llms/temperature-sampling-local-llm) -- 창작 출력 제어 마스터하기',
          ],
        },
      },
    },
