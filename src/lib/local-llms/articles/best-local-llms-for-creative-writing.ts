...
schema: {
    ...
    ar: {
      ...
      seoTitle: 'أفضل نماذج LLM المحلية للكتابة الإبداعية 2026',
      ...
      metaDescription: 'أفضل 4 نماذج LLM محلية للكتابة الإبداعية: Llama 3.3 70B (أفضل نثر)، Mistral 24B (الأفضل في 16 GB) والنماذج المضبوطة للأصوات المتخصصة.',
      publishDate: '2026-04-04',
