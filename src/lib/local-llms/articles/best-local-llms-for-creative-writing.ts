      ...
      sections: {
        ...
        faqSection: {
          ...
          faqs: [
            ...
            {
              q: 'أي نموذج LLM محلي أفضل لبناء عوالم الخيال العلمي؟',
      ...
      sections: {
        ...
        faqSection: {
          ...
          faqs: [
            ...
            {
              q: 'Qual LLM local é melhor para a construção de mundos de ficção científica?',
      ...
      sections: {
        ...
        faqSection: {
          ...
          faqs: [
            ...
            {
              q: 'SF 세계 구축에 가장 좋은 로컬 LLM은 무엇입니까?',
