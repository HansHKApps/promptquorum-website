...
uptime`,
  ...
  ar: {
    ...
    seoTitle: 'Mac Mini M5 خادم ذكاء اصطناعي محلي: 35 دولارًا سنويًا',
    ...
    metaDescription: 'Mac Mini M5 Pro 64 GB: خادم ذكاء اصطناعي دائم التشغيل، 25–55 واط، 26–39 دولارًا سنويًا. Ollama وWhisper STT وRAG ومساعد صوتي. صامت وبلا إعادة تشغيل.',
