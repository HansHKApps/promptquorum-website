...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    heroImage: '/images/mac-mini-m5-local-ai-server-overview-hero-en.png',
...
uptime`,
  ...
  de: {
    ...
    next_refresh_due: '2026-11-15',
    theme: 'Hardware & Performance',
    heroImage: '/images/mac-mini-m5-local-ai-server-overview-hero-de.png',
...
uptime`,
  ...
  fr: {
    ...
    next_refresh_due: '2026-11-15',
    theme: 'Hardware & Performance',
    heroImage: '/images/mac-mini-m5-local-ai-server-overview-hero-fr.png',
...
uptime`,
  ...
  ja: {
    ...
    next_refresh_due: '2026-11-15',
    theme: 'Hardware & Performance',
    heroImage: '/images/mac-mini-m5-local-ai-server-overview-hero-ja.png',
...
uptime`,
  ...
  zh: {
    ...
    next_refresh_due: '2026-11-15',
    theme: 'Hardware & Performance',
    heroImage: '/images/mac-mini-m5-local-ai-server-overview-hero-zh.png',
...
uptime`,
  ...
  es: {
    ...
    next_refresh_due: '2026-11-15',
    theme: 'Hardware & Performance',
    heroImage: '/images/mac-mini-m5-local-ai-server-overview-hero-es.png',
...
uptime`,
  ...
  ar: {
    ...
    next_refresh_due: '2026-11-15',
    theme: 'Hardware & Performance',
    heroImage: '/images/mac-mini-m5-local-ai-server-overview-hero-ar.png',
    title: '⁨Mac Mini M5⁩ كخادم ذكاء اصطناعي محلي ⁨2026⁩: ⁨LLM⁩ و⁨Whisper⁩ و⁨RAG⁩ ومساعد صوتي ⁨24/7⁩',
    seoTitle: '⁨Mac Mini M5⁩ خادم ذكاء محلي: ⁨35⁩ دولارًا سنويًا',
...
uptime`,
  ...
  pt: {
    ...
    quickAnswerTop: {
      pt: {
        question: 'Por que usar o Mac Mini M5 como servidor de IA local?',
        answer: 'Silencioso (sem ventilador ou quase silencioso), 25–55 W (vs 300 W+ de um PC com GPU), $26–39/ano em energia (vs $263–394 de uma GPU), $1.199 custo único. Executa Ollama 34B LLM + Whisper + RAG simultaneamente em 64 GB de memória unificada.',
        bullets: [
          'M5 Pro 64 GB: $1.199 — melhor custo-benefício',
          'Consumo: 25–55 W (vs 300 W+ de um PC com GPU)',
          'Energia anual: $26–39 (vs $263–394 de uma GPU)',
          'Silencioso: quase sem ventilador sob cargas LLM típicas',
          'API REST acessível de todos os dispositivos da LAN',
          'Se paga frente a 4 assinaturas do ChatGPT Plus em ~15 meses',
        ],
        updatedDate: '2026-05-15',
      },
    },
    ...
    sections: {
      why: {
        id: 'why',
        title: 'Por que o Mac Mini M5 é o servidor de IA ideal',
        content: [
  ...
  ko: {
    ...
    next_refresh_due: '2026-11-15',
    theme: 'Hardware & Performance',
    heroImage: '/images/mac-mini-m5-local-ai-server-overview-hero-ko.png',
    title: 'Mac Mini M5를 로컬 AI 서버로 활용하기 2026: 상시 구동 LLM, Whisper, RAG, 음성 어시스턴트',
    seoTitle: 'Mac Mini M5 로컬 AI 서버: 24/7 상시 구동',
    intro: 'Mac Mini M5 Pro 64GB를 조용하고 항상 켜진 상태의 로컬 AI 서버로 운영하는 완전 가이드입니다. Ollama LLM, Whisper STT, RAG 파이프라인, 음성 어시스턴트 스택을 다룹니다. 연간 전기 요금은 약 $26–39입니다. 실제 명령어, 사용 사례, 비용 분석, 5년 총 소유 비용 분석을 포함한 단계별 설정 안내를 제공합니다.',
    ...
    leadAnswerBlock: '**2026년 기준 $1,199의 Mac mini M5 Pro 64GB는 최고의 가성비 상시 구동 AI 서버입니다. 무소음(팬리스에 가까움), 소비 전력 25-55W, 연간 전기 요금 $26-39. Ollama 34B 모델, Whisper STT, RAG 파이프라인, 음성 어시스턴트를 동시에 실행합니다. ChatGPT Plus 4개 구독 대비 15개월 만에 본전을 회수합니다.**',
    nextStep: {
    ...
    sections: {
      why: {
        id: 'why',
        title: 'Mac Mini M5가 이상적인 AI 서버인 이유',
        content: [
