...
# - task_type: private    → model: qwen3.6:27b  (local Ollama, no cloud egress)`,
      ...
      relatedReading: {
        ...
        items: [
          '[Qwen 3.6 vs Claude Sonnet 4.6 vs DeepSeek — 2026 Comparison](/local-llms/qwen-vs-claude-vs-deepseek-local-2026)',
...
# - task_type: private    → model: qwen3.6:27b  (local Ollama, no cloud egress)`,
      ...
      relatedReading: {
        ...
        items: [
          '[Qwen 3.6 vs Claude Sonnet 4.6 vs DeepSeek — Comparativa 2026](/es/local-llms/qwen-vs-claude-vs-deepseek-local-2026)',
...
# - task_type: private    → model: qwen3.6:27b  (local Ollama, no cloud egress)`,
      ...
      relatedReading: {
        ...
        items: [
          '[Qwen 3.6 vs. Claude Sonnet 4.6 vs. DeepSeek — Vergleich 2026](/de/local-llms/qwen-vs-claude-vs-deepseek-local-2026)',
...
# - task_type: private    → model: qwen3.6:27b  (local Ollama, no cloud egress)`,
      ...
      relatedReading: {
        ...
        items: [
          '[Qwen 3.6 vs Claude Sonnet 4.6 vs DeepSeek — Comparatif 2026](/fr/local-llms/qwen-vs-claude-vs-deepseek-local-2026)',
...
# - task_type: private    → model: qwen3.6:27b  (local Ollama, no cloud egress)`,
      ...
      relatedReading: {
        ...
        title: '関連記事',
        items: [
          '[Qwen 3.6 vs Claude Sonnet 4.6 vs DeepSeek — 2026年比較](/ja/local-llms/qwen-vs-claude-vs-deepseek-local-2026)',
...
# - task_type: private    → model: qwen3.6:27b  (local Ollama, no cloud egress)`,
      ...
      relatedReading: {
        ...
        title: '相关阅读',
        items: [
          '[Qwen 3.6 vs Claude Sonnet 4.6 vs DeepSeek — 2026年全面对比](/zh/local-llms/qwen-vs-claude-vs-deepseek-local-2026)',
  ...
  ko: {
    ...
    sections: {
      ...
      whyLocal: {
        ...
        content: [
          '2026년에 Qwen 3를 로컬에서 실행하면 HumanEval 기준 92.1%에 달하는 모델을 토큰당 €0의 비용으로 이용할 수 있습니다 — 코딩 작업에서 Claude Sonnet 4.6와 비슷하거나 이를 능가하는 수준입니다. 하드웨어 비용이 상각되면 모든 프롬프트가 무료입니다. 하루 1,000만 토큰을 생성하는 5인 개발팀의 경우, 로컬 추론은 Claude Sonnet 4.6 API 가격 대비 월 ~$900를 절감합니다.',
...
# - task_type: private    → model: qwen3.6:27b  (로컬 Ollama, 클라우드 유출 없음)`,
      ...
      powerTco: {
        ...
        content: [
          ...
          '단일 개발자 기준 하루 1,000만 토큰의 Claude Sonnet 4.6 API와 비교: 1,000만 토큰 × $3/100만 × 250일 = **연간 $7,500**.',
        ],
        rows: [
          { Option: 'Claude Sonnet 4.6 API', 'Hardware': '—', 'Electricity/year (EU)': '—', 'API cost/year (10M tok/day)': '$7,500', 'Break-even': '—' },
      ...
      relatedReading: {
        ...
        title: '관련 자료',
        items: [
          '[Qwen 3.6 vs Claude Sonnet 4.6 vs DeepSeek — 2026년 비교](/local-llms/qwen-vs-claude-vs-deepseek-local-2026)',
