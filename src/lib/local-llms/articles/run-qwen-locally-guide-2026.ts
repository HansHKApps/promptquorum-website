...
# - task_type: private    → model: qwen3.6:27b  (local Ollama, no cloud egress)`,
      ...
      faq: {
        ...
        title: '常见问题',
        faqs: [
          { q: 'What is the minimum hardware to run Qwen 3 locally?', a: 'For Qwen 3.6 27B at Q4_K_M quantization: 16 GB VRAM (RTX 4080 or RTX 3090). For Apple Silicon: M3 Pro with 36 GB unified memory or M3 Max with 48 GB. For the smaller Qwen 3 14B: 9 GB VRAM (RTX 3080 or RTX 4070). Qwen3 8B runs on 5 GB VRAM (GTX 1080 or better).' },
...
# - task_type: private    → model: qwen3.6:27b  (local Ollama, no cloud egress)`,
      ...
      faq: {
        ...
        faqs: [
          { q: 'ما الحد الأدنى من الأجهزة لتشغيل Qwen 3 محليًا؟', a: 'لـ Qwen 3.6 27B بتكميم Q4_K_M: 16 GB VRAM (RTX 4080 أو RTX 3090). لـ Apple Silicon: M3 Pro بذاكرة موحدة 36 GB أو M3 Max بـ 48 GB. لـ Qwen 3 14B الأصغر: 9 GB VRAM (RTX 3080 أو RTX 4070). يعمل Qwen3 8B بـ 5 GB VRAM (GTX 1080 أو أفضل).' },
...
# - task_type: private    → model: qwen3.6:27b  (local Ollama, no cloud egress)`,
      ...
      faq: {
        ...
        title: 'よくある質問',
        faqs: [
          { q: 'Qwen 3をローカルで実行するための最小ハードウェアは？', a: 'Q4_K_M量子化のQwen 3.6 27Bの場合：16 GB VRAM（RTX 4080またはRTX 3090）。Apple Siliconの場合：36 GB統合メモリのM3 Proまたは48 GBのM3 Max。小さいQwen 3 14Bの場合：9 GB VRAM（RTX 3080またはRTX 4070）。Qwen3 8Bは5 GB VRAM（GTX 1080以上）で動作します。' },
...
# - task_type: private    → model: qwen3.6:27b  (local Ollama, no cloud egress)`,
      ...
      faq: {
        ...
        title: '常见问题',
        faqs: [
          { q: '在本地运行Qwen 3的最低硬件要求是什么？', a: 'Q4_K_M量化的Qwen 3.6 27B：16 GB显存（RTX 4080或RTX 3090）。Apple Silicon：36 GB统一内存的M3 Pro或48 GB的M3 Max。较小的Qwen 3 14B：9 GB显存（RTX 3080或RTX 4070）。Qwen3 8B可在5 GB显存（GTX 1080或更好）上运行。' },
...
# - task_type: private    → model: qwen3.6:27b  (로컬 Ollama, 클라우드 유출 없음)`,
      ...
      faq: {
        ...
        title: '자주 묻는 질문',
        faqs: [
          { q: 'Qwen 3를 로컬에서 실행하기 위한 최소 하드웨어는 무엇인가요?', a: 'Q4_K_M 양자화의 Qwen 3.6 27B의 경우: 16GB VRAM GPU — RTX 4080 또는 RTX 3090. Apple Silicon의 경우: 36GB 통합 메모리의 M3 Pro 또는 48GB의 M3 Max. 더 작은 Qwen 3 14B의 경우: 9GB VRAM(RTX 3080 또는 RTX 4070). Qwen3 8B는 5GB VRAM(GTX 1080 이상)에서 실행됩니다.' },
