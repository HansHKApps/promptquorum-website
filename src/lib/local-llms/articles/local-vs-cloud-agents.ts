...
schema: {
    ...
    ar: {
      ...
      metaDescription: 'الوكلاء السحابيون يستجيبون خلال 100–300 مللي ثانية بتكلفة 20$/مليون رمز. الوكلاء المحليون يستغرقون 2–5 ثوانٍ بتكلفة 0$. نقطة التعادل 50 مليون رمز/شهر.',
      publishDate: '2026-04-04',
      dateModified: '2026-04-24',
...
schema: {
  ...
  ko: {
      ...
      seoTitle: '로컬 vs 클라우드 AI 에이전트 2026: 어느 쪽이 귀하의 사용 사례에 더 적합합니까?',
