...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      heroImage: '/images/local-vs-cloud-agents-overview-hero-en.png',
...
schema: {
    ...
    es: {
      ...
      heroImage: '/images/local-vs-cloud-agents-overview-hero-es.png',
    ...
    ar: {
      ...
      heroImage: '/images/local-vs-cloud-agents-overview-hero-ar.png',
      ...
      sections: {
        ...
        cost: {
          ...
          columns: ['Volumen mensual', 'Cloud (GPT-4)', 'Cloud (Claude)', 'Local (amortizado)'],
          rows: [
            { 'Volumen mensual': 'مليون رمز/شهر', 'Cloud (GPT-4)': '20$', 'Cloud (Claude)': '20$', 'Local (amortizado)': '50$ (تكلفة عتاد)' },
            { 'Volumen mensual': '10 ملايين رمز/شهر', 'Cloud (GPT-4)': '200$', 'Cloud (Claude)': '200$', 'Local (amortizado)': '50$' },
            { 'Volumen mensual': '100 مليون رمز/شهر', 'Cloud (GPT-4)': '2,000$', 'Cloud (Claude)': '2,000$', 'Local (amortizado)': '50$ + كهرباء' },
            { 'Volumen mensual': 'مليار رمز/شهر', 'Cloud (GPT-4)': '20,000$', 'Cloud (Claude)': '20,000$', 'Local (amortizado)': '300$' },
          ],
          image: '/images/local-vs-cloud-agents-cost-breakeven-es.svg',
        ...
        capabilities: {
          ...
          columns: ['Tarea', 'Agentes Cloud', 'Agentes locales'],
          rows: [
            { 'Tarea': 'استدلال متعدد المراحل', 'Agentes Cloud': 'ممتاز (GPT-4، Claude)', 'Agentes locales': 'جيد (13B+، DeepSeek-R1)' },
        ...
        hybrid: {
          ...
          image: '/images/local-vs-cloud-agents-hybrid-flow-es.svg',
          imageCaption: 'النهج الهجين: وجّه الاستعلامات البسيطة إلى الوكلاء المحليين (Llama 13B، ثانيتان، مجاني) وصعّد الاستدلال المعقّد إلى السحابة (GPT-4، 200 مللي ثانية، 0.02$). النتيجة: خفض 80% في التكاليف دون خسارة جودة في المشكلات الصعبة.',
        },
        regionalContext: {
          id: 'regional-context',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'لنماذج 70B: على الأرجح ضمن 90% من جودة GPT-4 بنهاية 2027. لنماذج 13B: ليس بعد. تتقلّص الفجوة العملية، لكن السحابة تحتفظ بميزة في الاستدلال الجديد والمعرفة الواسعة بالعالم.',
            },
          ],
        },
        relatedReading: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'هل سيضاهي الوكلاء المحليون جودة السحابة في 2027؟', 'acceptedAnswer': { '@type': 'Answer', 'text': 'لنماذج 70B: على الأرجح ضمن 90% من جودة GPT-4 بنهاية 2027. لنماذج 13B: ليس بعد. تتقلّص الفجوة، لكن السحابة تحتفظ بميزة في الاستدلال الجديد.' } },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
    ...
    pt: {
      ...
      heroImage: '/images/local-vs-cloud-agents-overview-hero-pt.png',
    ...
    de: {
      ...
      heroImage: '/images/local-vs-cloud-agents-overview-hero-de.png',
...
schema: {
    ...
    fr: {
      ...
      heroImage: '/images/local-vs-cloud-agents-overview-hero-fr.png',
...
schema: {
    ...
    ja: {
      ...
      heroImage: '/images/local-vs-cloud-agents-overview-hero-ja.png',
...
schema: {
    ...
    zh: {
      ...
      heroImage: '/images/local-vs-cloud-agents-overview-hero-zh.png',
...
schema: {
  ...
  ko: {
    ...
    heroImage: '/images/local-vs-cloud-agents-overview-hero-ko.png',
      ...
      sections: {
        ...
        cost: {
          ...
          rows: [
            { '월간 사용량': '월 100만 토큰', '클라우드 (GPT-4)': '$20', '클라우드 (Claude)': '$20', '로컬 (상각)': '$50 (하드웨어 비용)' },
            { '월간 사용량': '월 1,000만 토큰', '클라우드 (GPT-4)': '$200', '클라우드 (Claude)': '$200', '로컬 (상각)': '$50' },
            { '월간 사용량': '월 1억 토큰', '클라우드 (GPT-4)': '$2,000', '클라우드 (Claude)': '$2,000', '로컬 (상각)': '$50 + 전기료' },
            { '월간 사용량': '월 10억 토큰', '클라우드 (GPT-4)': '$20,000', '클라우드 (Claude)': '$20,000', '로컬 (상각)': '$300' },
          ],
          image: '/images/local-vs-cloud-agents-cost-breakeven-en.svg',
        ...
        capabilities: {
          ...
          rows: [
            { '작업': '다단계 추론', '클라우드 에이전트': '우수 (GPT-4, Claude)', '로컬 에이전트': '양호 (13B+, DeepSeek-R1)' },
        ...
        hybrid: {
          ...
          image: '/images/local-vs-cloud-agents-hybrid-flow-en.svg',
          imageCaption: '하이브리드 방식: 단순한 쿼리는 로컬 에이전트(Llama 13B, 2초, 무료)로 라우팅하고, 복잡한 추론은 클라우드(GPT-4, 200ms, $0.02)로 에스컬레이션합니다. 결과: 어려운 문제에서 품질 손실 없이 80%의 비용 절감.',
        },
        regionalContext: {
          id: 'regional-context',
          title: '지역별 고려 사항',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: '70B 모델의 경우: 2027년 말까지 GPT-4 품질의 90% 이내에 도달할 가능성이 높습니다. 13B 모델의 경우: 아직은 어렵습니다. 실제 격차는 좁혀지고 있지만, 클라우드는 새로운 추론과 광범위한 세계 지식에서 여전히 우위를 유지합니다.',
            },
          ],
        },
        relatedReading: {
