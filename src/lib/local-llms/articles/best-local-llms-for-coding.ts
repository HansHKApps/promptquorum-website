      ...
      sections: {
        ...
        quickFacts: {
          ...
          items: [
            ...
            '**High-end setup:** 20+ GB (runs Kimi K2.6 quantized, Laguna XS 2.1, or Qwen2.5-Coder 32B for maximum quality).',
          ],
        },
...
schema: {
      ...
      gammaDescription: 'Interactive 14-slide presentation covering: HumanEval benchmark comparison, hardware-matched model selection (8GB, 16GB, 20+GB RAM), Qwen2.5-Coder 32B (87%) vs DeepSeek-Coder V2 Lite (81%) vs Qwen3 8B (72%), and IDE integration with Continue.dev. Note: slides reflect the June 2026 refresh; the July 2026 update above (Kimi K2.7 Code, Laguna XS 2.1) is not yet reflected in the deck. Download the reference card as PDF.',
    },
    es: {
      freshness_tier: 'monthly',
      next_refresh_due: '2026-09-28',
    ...
    ar: {
      ...
      sections: {
        ...
        quickFacts: {
          ...
          items: [
            ...
            '**إعداد الفئة العليا:** 20+ GB (يشغّل Kimi K2.6 مكمَّماً أو Qwen2.5-Coder 32B لأقصى جودة).',
          ],
        },
        bestModelsQuickPicks: {
          id: 'best-models-quick-picks',
          ...
          items: [
            ...
            '👉 **لأقصى جودة (20+ GB):** استخدم Kimi K2.6 مكمَّماً أو Qwen2.5-Coder 32B للقدرة دون اتصال.',
          ],
          callouts: [
        ...
        humanEvalTable: {
          ...
          rows: [
            ...
            { 'النموذج': 'Qwen2.5-Coder 32B', 'HumanEval': '87%', 'SWE-bench': '—', 'RAM': '20 GB', 'FIM': 'نعم' },
          ...
          imageCaption: 'درجات كل نموذج (يوليو 2026): يتصدر Qwen2.5-Coder 32B بنسبة 87% في HumanEval، ويحقق DeepSeek V4 Flash 78/100 في اختبارات واقعية مستقلة، ويصل Qwen 3.6 27B إلى 77.2% في SWE-bench، ويحقق Laguna XS 2.1 نسبة 70.9% في SWE-bench Verified كأحدث منافس وكيل، ويبلغ Qwen3 8B نحو 76% في HumanEval، بينما يحقق Kimi K2.6 درجة 58.6 في اختبار SWE-Bench Pro الأصعب.',
          callouts: [
        ...
        speedQualityTable: {
          ...
          callouts: [
            ...
            { type: 'practice', text: '**توصية عملية:** اختر حسب نوع المهمة. لتوليد الكود الدفعي أو مراجعات إعادة الهيكلة، استخدم Qwen2.5-Coder 32B (جودة أعلى، زمن استجابة مقبول). للإكمال التلقائي في بيئة التطوير في الوقت الفعلي، استخدم Codestral 22B أو Qwen3 8B (السرعة حاسمة). للأجهزة بسعة 16 GB، وازن مع DeepSeek-Coder V2 Lite.' },
          ],
        },
        whichCodingModel: {
      ...
      gammaEmbedUrl: '/presentations/best-local-llms-for-coding-static.html',
      gammaDescription: 'عرض تقديمي تفاعلي من 14 شريحة يغطي: مقارنة معيار HumanEval، واختيار نموذج مطابق للعتاد (8GB، 16GB، 20+GB RAM)، وQwen2.5-Coder 32B (87%) مقابل DeepSeek-Coder V2 Lite (81%) مقابل Qwen3 8B (72%) والتكامل مع بيئة التطوير عبر Continue.dev. نزّل بطاقة المرجع بصيغة PDF.',
    },
    pt: {
      freshness_tier: 'monthly',
      next_refresh_due: '2026-09-28',
      ...
      sections: {
        ...
        quickFacts: {
          ...
          items: [
            ...
            '**Configuração avançada:** 20+ GB (roda Kimi K2.6 quantizado ou Qwen2.5-Coder 32B para qualidade máxima).',
          ],
        },
        bestModelsQuickPicks: {
          id: 'best-models-quick-picks',
          ...
          items: [
            ...
            '👉 **Para qualidade máxima (20+ GB):** use o Kimi K2.6 quantizado ou o Qwen2.5-Coder 32B para capacidade offline.',
          ],
          callouts: [
        ...
        humanEvalTable: {
          ...
          rows: [
            ...
            { 'Modelo': 'Qwen2.5-Coder 32B', 'HumanEval': '87%', 'SWE-bench': '—', 'RAM': '20 GB', 'FIM': 'Sim' },
      ...
      sections: {
        ...
        quickFacts: {
          ...
          items: [
            ...
            '**High-End-Einrichtung:** 20+ GB (führt Kimi K2.6 quantisiert, Laguna XS 2.1 oder Qwen2.5-Coder 32B für maximale Qualität aus).',
          ],
        },
        bestModelsQuickPicks: {
          id: 'best-models-quick-picks',
          ...
          items: [
            ...
            '👉 **Für maximale Qualität (20+ GB):** Kimi K2.6 quantisiert oder Qwen2.5-Coder 32B.',
          ],
          callouts: [
        ...
        humanEvalTable: {
          ...
          rows: [
            ...
            { 'Modell': 'Qwen2.5-Coder 32B', 'HumanEval': '87%', 'SWE-bench': '—', 'RAM': '20 GB', 'FIM': 'Ja' },
          ...
          imageCaption: 'Benchmark-Ergebnisse nach Modell (2026): Qwen2.5-Coder 32B führt mit 87% HumanEval, DeepSeek V4 Flash erreicht 78/100 im unabhängigen Praxistest, Qwen 3.6 27B liegt bei 77,2% SWE-bench, Laguna XS 2.1 erreicht 70,9% SWE-bench Verified als neuester Agenten-Herausforderer, Qwen3 8B bei ca. 76% HumanEval, und Kimi K2.6 erzielt 58,6 im schwereren SWE-Bench Pro.',
          callouts: [
...
schema: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Können lokale LLMs GPT-5.6 für Programmierung ersetzen?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Nein. Qwen2.5-Coder 32B (87% HumanEval) vs. GPT-5.6 (~92% effektiv). Lokale Modelle liegen zurück bei: aktuellem Framework-Wissen (APIs nach Trainingscutoff), komplexem Multi-File-Reasoning (100k+ Tokens) und Debugging-Genauigkeit. Beste lokale Modelle sind bei Funktionsgenerierung wettbewerbsfähig, nicht bei System-Level-Design.' } },
      ...
      sections: {
        ...
        quickFacts: {
          ...
          items: [
            ...
            '**Installation haut de gamme** : 20+ GB (exécute Kimi K2.6 quantifié, Laguna XS 2.1 ou Qwen2.5-Coder 32B pour une qualité maximale).',
          ],
        },
        bestModelsQuickPicks: {
          id: 'best-models-quick-picks',
          ...
          items: [
            ...
            '👉 **Pour une qualité maximale (20+ GB)** : Kimi K2.6 quantifié ou Qwen2.5-Coder 32B.',
          ],
          callouts: [
        ...
        humanEvalTable: {
          ...
          rows: [
            ...
            { 'Modèle': 'Qwen2.5-Coder 32B', 'HumanEval': '87%', 'SWE-bench': '—', 'RAM': '20 Go', 'FIM': 'Oui' },
          ...
          imageCaption: 'Scores de benchmark par modèle (juillet 2026) : Qwen2.5-Coder 32B en tête avec 87% HumanEval, DeepSeek V4 Flash obtient 78/100 en conditions réelles indépendantes, Qwen 3.6 27B atteint 77.2% SWE-bench, Laguna XS 2.1 atteint 70,9% SWE-bench Verified comme nouveau challenger agentique, Qwen3 8B environ 76% HumanEval, et Kimi K2.6 obtient 58.6 sur le SWE-Bench Pro, plus exigeant.',
          callouts: [
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'Les LLMs locaux peuvent-ils remplacer GPT-5.6 pour la programmation?', a: 'Non. Qwen2.5-Coder 32B (87% HumanEval) vs GPT-5.6 (~92% effectif). Les modèles locaux traînent sur : la connaissance récente du framework (APIs post-entraînement), le raisonnement multi-fichiers complexe (100k+ jetons) et la précision du débogage. Les meilleur modèles locaux sont compétitifs sur la génération de fonction, pas sur la conception au niveau système.' },
...
schema: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Les LLMs locaux peuvent-ils remplacer GPT-5.6 pour la programmation?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Non. Qwen2.5-Coder 32B (87% HumanEval) vs GPT-5.6 (~92% effectif). Les modèles locaux traînent sur : la connaissance récente du framework (APIs post-entraînement), le raisonnement multi-fichiers complexe (100k+ jetons) et la précision du débogage. Les meilleur modèles locaux sont compétitifs sur la génération de fonction, pas sur la conception au niveau système.' } },
      ...
      sections: {
        ...
        humanEvalTable: {
          ...
          rows: [
            ...
            { 'モデル': 'Qwen2.5-Coder 32B', 'HumanEval': '87%', 'SWE-bench': '—', 'RAM': '20 GB', 'FIM': '対応' },
          ...
          imageCaption: 'モデル別ベンチマークスコア:Qwen2.5-Coder 32BがHumanEval 87%で首位、DeepSeek V4 Flashは独立したリアルワールドテストで78/100、Qwen 3.6 27BはSWE-benchで77.2%、Laguna XS 2.1は最新のエージェント型対抗モデルとしてSWE-bench Verified 70.9%、Qwen3 8Bは約76% HumanEval、Kimi K2.6はより困難なSWE-Bench Proで58.6を記録。',
          callouts: [
        ...
        quickFacts: {
          ...
          items: [
            ...
            '**ハイエンドセットアップ：** 20+ GB（Kimi K2.6量子化、Laguna XS 2.1、またはQwen2.5-Coder 32Bで最高品質）',
          ],
        },
        bestModelsQuickPicks: {
          id: 'best-models-quick-picks',
...
schema: {
    ...
    zh: {
      ...
      intro: '2026年7月，用于编码的最佳本地LLM是Kimi K2.6（58.6 SWE-Bench Pro、MoE、修改版MIT许可证）、Qwen 3.6 27B（77.2% SWE基准、最佳密集模型）和Devstral Small 24B（24B级最佳代理编码）。最新代理编码挑战者是Laguna XS 2.1（Poolside，SWE-bench Verified 70.9%，256K上下文），同时新增编程专用的Kimi K2.7 Code（Moonshot AI）。对于8GB机器，Qwen3 8B取代了之前的Qwen2.5-Coder 7B推荐。所有都通过Ollama本地运行。',
      ...
      sections: {
        ...
        humanEvalTable: {
          ...
          rows: [
            ...
            { '模型': 'Qwen2.5-Coder 32B', 'HumanEval': '87%', 'SWE-bench': '—', 'RAM': '20 GB', 'FIM': '支持' },
          ...
          imageCaption: '各模型基准得分(2026年7月):Qwen2.5-Coder 32B以87% HumanEval领先,DeepSeek V4 Flash在独立真实场景测试中获得78/100,Qwen 3.6 27B达到77.2% SWE-bench,Laguna XS 2.1作为最新代理编码挑战者达到70.9% SWE-bench Verified,Qwen3 8B约76% HumanEval,Kimi K2.6在更难的SWE-Bench Pro上获得58.6分。',
          callouts: [
        ...
        quickFacts: {
          ...
          items: [
            ...
            '**高端配置：** 20+ GB（运行Kimi K2.6量化版、Laguna XS 2.1或Qwen2.5-Coder 32B以获得最高质量）',
          ],
        },
        bestModelsQuickPicks: {
          id: 'best-models-quick-picks',
      ...
      sections: {
        ...
        quickFacts: {
          ...
          items: [
            ...
            '**고성능 사양:** 20 GB 이상 (양자화된 Kimi K2.6 또는 최고 품질을 위한 Qwen2.5-Coder 32B 실행 가능).',
          ],
        },
        bestModelsQuickPicks: {
          id: 'best-models-quick-picks',
          ...
          items: [
            ...
            '👉 **최대 품질 (20 GB 이상):** 오프라인 기능을 위해 양자화된 Kimi K2.6 또는 Qwen2.5-Coder 32B를 사용하십시오.',
          ],
          callouts: [
        ...
        humanEvalTable: {
          ...
          rows: [
            ...
            { 'Model': 'Qwen2.5-Coder 32B', 'HumanEval': '87%', 'SWE-bench': '—', 'RAM': '20 GB', 'FIM': '지원' },
          ...
          imageCaption: '코딩 벤치마크 점수(2026년 7월): Qwen2.5-Coder 32B가 HumanEval 87%로 선두이며, DeepSeek V4 Flash는 독립 실측 테스트에서 78/100을 기록했습니다. Qwen 3.6 27B는 SWE-bench 77.2%를 달성했고, Laguna XS 2.1은 최신 에이전틱 도전자로 SWE-bench Verified 70.9%를 기록했습니다. Qwen3 8B는 HumanEval 약 76%, Kimi K2.6은 더 어려운 SWE-Bench Pro에서 58.6점을 기록했습니다.',
          callouts: [
        ...
        speedQualityTable: {
          ...
          callouts: [
            ...
            { type: 'practice', text: '**실용적인 권장 사항:** 작업 유형에 따라 선택하십시오. 일괄 코드 생성이나 리팩토링 검토에는 Qwen2.5-Coder 32B(높은 품질, 허용 가능한 지연)를 사용하십시오. 실시간 IDE 자동 완성에는 Codestral 22B 또는 Qwen3 8B(속도 최우선)를 사용하십시오. 16 GB 환경에서는 DeepSeek-Coder V2 Lite로 균형을 맞추십시오.' },
          ],
        },
        whichCodingModel: {
        ...
        regionalContext: {
          ...
          content: [
            ...
            'Qwen2.5-Coder 32B (Alibaba, Apache 2.0)와 DeepSeek-Coder V2 (DeepSeek, MIT) 모두 완전한 온프레미스 실행이 가능합니다. EU 내에서 EU 출신 모델을 선호하는 조직의 경우: Mistral AI (프랑스)의 코딩 지원 모델(Mistral Small 3.1, Codestral)이 Apache 2.0 라이선스를 가지고 있습니다. EU AI 법(2025년 2월 시행)은 중요 인프라를 위한 AI 지원 코드 생성을 잠재적으로 고위험으로 분류합니다 — 온프레미스 추론은 파이프라인을 기존 보안 경계 내에 유지합니다.',
            '**일본 (METI)**',
            ...
            '**중국**',
            '중국의 데이터보안법(数据安全法)에 따라 중요 정보 인프라의 소스 코드는 외국 클라우드 서비스에서 처리될 수 없습니다. Qwen3-Coder (Alibaba, Apache 2.0)는 중국 기업의 코딩 워크플로우에 자연스러운 선택입니다 — 중국 개발사, Apache 2.0 라이선스, Ollama를 통한 완전한 온프레미스 배포. 2026년 7월 기준, Qwen2.5-Coder 32B는 HumanEval에서 가장 높은 점수의 중국산 모델로 남아 있으며, SWE-Bench Pro 전체 1위는 Kimi K2.6(Moonshot AI)입니다.',
          ],
        },
        commonMistakes: {
          id: 'common-mistakes',
