...
schema: {
    ...
    de: {
      ...
      metaDescription: 'Mai 2026: Kimi K2.6 (87/100 Real-World) ist das beste lokale Programmier-LLM. Vergleich mit Qwen 3.6 27B (77,2% SWE-bench) und Devstral 24B. SWE-bench ersetzt HumanEval.',
      publishDate: '2026-04-04',
      ...
      sections: {
        ...
        userPersonas: {
          ...
          items: [
            '**Anfänger (keine Erfahrung mit lokalem LLM):** [LM Studio](/local-llms/how-to-install-lm-studio?lang=de) + Qwen3 8B -- GUI, kein Terminal nötig, beinhaltet FIM für Code-Completion, 5 GB VRAM.',
...
schema: {
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 2, 'name': 'Qwen 3.6 27B', 'description': '81% HumanEval. 10 GB RAM. MoE-Architektur. FIM-Unterstützung. ollama run deepseek-coder-v2:16b', 'url': 'https://www.promptquorum.com/local-llms/best-local-llms-for-coding?lang=de#deepseek-coder-v2' },
          { '@type': 'ListItem', 'position': 3, 'name': 'Qwen3 8B', 'description': '72% HumanEval. 4,7 GB RAM. Best für 8-GB-Maschinen. FIM. ollama run qwen2.5-coder:7b', 'url': 'https://www.promptquorum.com/local-llms/best-local-llms-for-coding?lang=de#qwen25-coder-7b' },
          { '@type': 'ListItem', 'position': 4, 'name': 'Codestral 22B', 'description': '67% HumanEval. Beste FIM-Autovervollständigung. 9 GB RAM. 600+ Sprachen.', 'url': 'https://www.promptquorum.com/local-llms/best-local-llms-for-coding?lang=de#starcoder2-15b' },
    ...
    fr: {
      ...
      seoTitle: 'Meilleurs LLMs pour le code 2026 : Kimi K2.6 (87/100) vs Qwen 3.6',
      ...
      metaDescription: 'Mai 2026 : Kimi K2.6 (87/100 real-world) est le meilleur LLM local pour la programmation. Comparé avec Qwen 3.6 27B (77,2% SWE-bench) et Devstral 24B. SWE-bench remplace HumanEval.',
      publishDate: '2026-04-04',
      ...
      sections: {
        ...
        userPersonas: {
          ...
          items: [
            '**Débutant (pas d\'expérience LLM local)** : [LM Studio](/local-llms/how-to-install-lm-studio?lang=fr) + Qwen3 8B — GUI, pas de terminal nécessaire, inclut FIM pour la complétion de code.',
...
schema: {
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 2, 'name': 'Qwen 3.6 27B', 'description': '81% HumanEval. 10 GB RAM. Architecture MoE. Support FIM. ollama run deepseek-coder-v2:16b', 'url': 'https://www.promptquorum.com/local-llms/best-local-llms-for-coding?lang=fr#deepseek-coder-v2' },
          { '@type': 'ListItem', 'position': 3, 'name': 'Qwen3 8B', 'description': '72% HumanEval. 4.5 GB RAM. Meilleur pour machines 8 GB. FIM. ollama run qwen2.5-coder:7b', 'url': 'https://www.promptquorum.com/local-llms/best-local-llms-for-coding?lang=fr#qwen25-coder-7b' },
          { '@type': 'ListItem', 'position': 4, 'name': 'Codestral 22B', 'description': '67% HumanEval. Meilleure autocomplétion FIM. 9 GB RAM. 600+ langues.', 'url': 'https://www.promptquorum.com/local-llms/best-local-llms-for-coding?lang=fr#starcoder2-15b' },
...
schema: {
    ...
    zh: {
      ...
      seoTitle: '2026年最佳编程本地LLM：Kimi K2.6（87/100）vs Qwen 3.6',
