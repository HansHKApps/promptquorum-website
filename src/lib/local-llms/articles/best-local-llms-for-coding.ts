    ...
    es: {
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 2, 'name': 'Qwen 3.6 27B', 'description': '81% HumanEval. 10 GB RAM. Arquitectura MoE. Soporte FIM. ollama run deepseek-coder-v2:16b', 'url': 'https://www.promptquorum.com/es/local-llms/best-local-llms-for-coding#deepseek-coder-v2?lang=es' },
