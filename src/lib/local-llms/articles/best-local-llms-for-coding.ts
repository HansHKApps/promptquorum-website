    ...
    en: {
      ...
      quickAnswerTop: {
        en: {
          ...
          answer: 'Kimi K2.6 (87/100 real-world, MoE, MIT license) is the best overall. Qwen 3.6 27B (77.2% SWE-bench) is best dense model. For agentic coding: Devstral Small 24B. For 8 GB RAM: Qwen3 8B. For IDE autocomplete: Codestral 22B. All run locally via Ollama.',
          bullets: [
            'Kimi K2.6 — best overall coding model, 87/100 real-world benchmark, MoE (42B active / 1T total)',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          items: [
            '**Best overall coding model**: Kimi K2.6 — 87/100 real-world benchmark, MoE architecture (42B active / 1T total), MIT license. Best dense model: Qwen 3.6 27B — 77.2% SWE-bench.',
        ...
        quickFacts: {
          ...
          items: [
            '**Best overall (max quality):** Kimi K2.6 — 87/100 real-world benchmark, MoE (42B active), MIT license. Needs quantization for consumer hardware.',
        ...
        bestModelsQuickPicks: {
          ...
          items: [
            '**Best overall:** Kimi K2.6 (quantized) — 87/100 real-world benchmark, MoE architecture, MIT license. `ollama run kimi-k2.6`',
        ...
        inOneSentence: {
          ...
          content: ['The best local coding models in May 2026 are Kimi K2.6 (87/100 real-world, MoE) for maximum quality, Qwen 3.6 27B (77.2% SWE-bench) as best dense model, and Qwen3 8B for 8 GB RAM.'],
        },
        plainTerms: {
          id: 'in-plain-terms',
        ...
        whatMakesGood: {
          ...
          content: [
            '**In 2026, SWE-bench has largely replaced HumanEval as the primary practical coding benchmark.** SWE-bench tests the model\'s ability to resolve real GitHub issues — multi-file changes, understanding codebases, writing tests — not just generating single functions. Qwen 3.6 27B scores 77.2% on SWE-bench; Kimi K2.6 scores 87/100 on real-world multi-file coding benchmarks.',
        ...
        qwen25coder32: {
          ...
          content: [
            '**Kimi K2.6 (Moonshot AI) is the highest-performing locally-runnable coding model in May 2026.** It scored 87/100 on real-world coding benchmarks — the first non-Western model to reach Tier A. MoE architecture with 42B active parameters out of 1T total. MIT license — fully commercial-friendly.',
          ...
          callouts: [
            { type: 'insight', text: 'Kimi K2.6 uses MoE architecture: only 42B parameters are active per token, not 1T. This makes it faster and more efficient than its total parameter count suggests. MoE models run on hardware that dense 70B models require.' },
          ],
          rows: [
            { 'Spec': 'Real-world benchmark score', 'Value': '87/100' },
            { 'Spec': 'Architecture', 'Value': 'MoE (42B active / 1T total)' },
            { 'Spec': 'License', 'Value': 'MIT (full commercial use)' },
        ...
        humanEvalTable: {
          ...
          rows: [
            { 'Model': 'Kimi K2.6 (MoE)', 'HumanEval': '—', 'SWE-bench': '87/100 (real-world)', 'RAM': 'varies (quantized)', 'FIM': '—' },
        ...
        codingExamples: {
          ...
          numberedItems: [
            '**Python function debugging** -- Kimi K2.6 (87/100 real-world) identifies the bug (off-by-one loop condition) in 1–2 responses. Qwen 3.6 27B (77.2% SWE-bench) solves it in 2–3 passes. Codestral 22B requires rephrasing for accurate detection. **Winner:** Kimi K2.6 for debugging accuracy and speed.',
          ...
          callouts: [
            { type: 'insight', text: 'Real-world coding tasks (SWE-bench) favor larger models. Kimi K2.6 (87/100) and Qwen 3.6 27B (77.2% SWE-bench) score ~5–10% higher on practical debugging and refactoring than Qwen3 8B. For everyday scripting, the gap narrows significantly.' },
          ],
        },
        speedQualityTable: {
        ...
        whichCodingModel: {
          ...
          imageCaption: 'Hardware-matched model selection (May 2026): 8 GB RAM → Qwen3 8B (5 GB VRAM, improved coding); 16 GB RAM → Devstral Small 24B (16 GB VRAM, agentic coding) or Qwen 3.6 27B (77.2% SWE-bench); 20+ GB RAM → Kimi K2.6 quantized (87/100 real-world, best local quality).',
        },
        codingLlm8gb: {
        ...
        comparisonDecision: {
          ...
          rows: [
            { 'Model': 'Kimi K2.6 (quantized)', 'Best For': 'Maximum local quality, real-world benchmarks', 'VRAM': 'varies (quantized)', 'Speed': '15–25 tok/sec', 'Strength': '87/100 real-world, MoE (42B active / 1T total), MIT license', 'When to Pick': 'You need maximum local quality and offline capability for debugging/refactoring' },
            ...
            { 'Model': 'GPT-4o (cloud)', 'Best For': 'Latest APIs, complex reasoning, peak performance', 'VRAM': 'N/A (cloud)', 'Speed': '<1 sec', 'Strength': 'Best accuracy, latest knowledge cutoff (2024), multi-file reasoning', 'When to Pick': 'You need peak performance, real-time latency, or latest framework knowledge' },
        ...
        faqSection: {
          title: 'FAQ',
          faqs: [
            { q: 'What is the best local LLM for coding in May 2026?', a: 'Kimi K2.6 — 87/100 real-world coding (MoE, MIT license). Best dense model: Qwen 3.6 27B — 77.2% SWE-bench, 22 GB VRAM. For 8 GB machines: Qwen3 8B. For IDE autocomplete: Codestral 22B.' },
            ...
            { q: 'What is Kimi K2.6 and is it safe to use?', a: 'Kimi K2.6 is an open-source coding model from Moonshot AI (China), released under MIT license. It uses MoE architecture (42B active / 1T total parameters) and scored 87/100 on real-world coding benchmarks. When running locally via Ollama, no data is sent externally — your code stays on your machine regardless of the model\'s origin. MIT license permits full commercial use without restrictions.' },
        ...
        sources: {
          ...
          title: 'Sources',
          items: [
            '**Moonshot AI. (2026).** "Kimi K2.6" — MoE architecture, MIT license, real-world coding benchmarks',
...
schema: {
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 2, 'name': 'Qwen 3.6 27B', 'description': '81% HumanEval. 10 GB RAM. MoE architecture. FIM support. ollama run deepseek-coder-v2:16b', 'url': 'https://www.promptquorum.com/local-llms/best-local-llms-for-coding#deepseek-coder-v2' },
    ...
    es: {
      ...
      sections: {
        ...
        inOneSentence: {
          id: 'in-one-sentence',
          title: 'En una frase',
          content: ['Los mejores modelos locales de programación en mayo de 2026 son Kimi K2.6 (87/100 en pruebas reales, MoE) para máxima calidad, Qwen 3.6 27B (77,2% SWE-bench) como mejor modelo denso y Qwen3 8B para 8 GB de RAM.'],
        },
        plainTerms: {
          id: 'in-plain-terms',
        ...
        qwen25coder32: {
          ...
          callouts: [
            { type: 'insight', text: 'Kimi K2.6 usa arquitectura MoE: solo 42B parámetros están activos por token, no 1T. Esto lo hace más rápido y eficiente de lo que sugiere su conteo total de parámetros. Los modelos MoE se ejecutan en el hardware que requieren los modelos densos de 70B.' },
          ],
          rows: [
            { 'Especificación': 'Puntuación en benchmark real', 'Valor': '87/100' },
            { 'Especificación': 'Arquitectura', 'Valor': 'MoE (42B activos / 1T total)' },
            { 'Especificación': 'Licencia', 'Valor': 'MIT (uso comercial completo)' },
        ...
        humanEvalTable: {
          ...
          rows: [
            { 'Modelo': 'Kimi K2.6 (MoE)', 'HumanEval': '—', 'SWE-bench': '87/100 (real)', 'RAM': 'variable (cuantizado)', 'FIM': '—' },
        ...
        codingExamples: {
          ...
          numberedItems: [
            '**Depuración de función Python** -- Kimi K2.6 (87/100 real) identifica el error (condición de bucle fuera de límites) en 1–2 respuestas. Qwen 3.6 27B (77,2% SWE-bench) lo resuelve en 2–3 intentos. Codestral 22B requiere reformular para detección precisa. **Ganador:** Kimi K2.6 por precisión y velocidad en depuración.',
          ...
          callouts: [
            { type: 'insight', text: 'Las tareas de programación reales (SWE-bench) favorecen a los modelos más grandes. Kimi K2.6 (87/100) y Qwen 3.6 27B (77,2% SWE-bench) puntúan ~5–10% más alto en depuración práctica y refactorización que Qwen3 8B. Para scripting cotidiano, la brecha se reduce significativamente.' },
          ],
        },
        speedQualityTable: {
          id: 'speed-quality-table',
        ...
        whichCodingModel: {
          ...
          image: '/images/best-local-llms-for-coding-hardware-selection-en.svg',
          imageCaption: 'Selección de modelo ajustada al hardware (mayo 2026): 8 GB de RAM → Qwen3 8B (5 GB de VRAM, programación mejorada); 16 GB de RAM → Devstral Small 24B (16 GB de VRAM, codificación agéntica) o Qwen 3.6 27B (77,2% SWE-bench); 20+ GB de RAM → Kimi K2.6 cuantizado (87/100 real, mejor calidad local).',
        },
        codingLlm8gb: {
          id: 'coding-llm-8gb-vram',
        ...
        comparisonDecision: {
          ...
          rows: [
            { 'Modelo': 'Kimi K2.6 (cuantizado)', 'Mejor para': 'Máxima calidad local, benchmarks reales', 'VRAM': 'variable (cuantizado)', 'Velocidad': '15–25 tok/seg', 'Fortaleza': '87/100 real, MoE (42B activos / 1T total), licencia MIT', 'Cuándo elegirlo': 'Necesitas máxima calidad local y capacidad sin conexión para depuración/refactorización' },
            ...
            { 'Modelo': 'GPT-4o (nube)', 'Mejor para': 'APIs actuales, razonamiento complejo, máximo rendimiento', 'VRAM': 'N/A (nube)', 'Velocidad': '<1 seg', 'Fortaleza': 'Mejor precisión, corte de conocimiento más reciente (2024), razonamiento multi-archivo', 'Cuándo elegirlo': 'Necesitas máximo rendimiento, latencia en tiempo real o conocimiento del framework más reciente' },
        ...
        faqSection: {
          title: 'FAQ',
          faqs: [
            { q: '¿Cuál es el mejor LLM local para programación en mayo de 2026?', a: 'Kimi K2.6 — 87/100 en programación real (MoE, licencia MIT). Mejor modelo denso: Qwen 3.6 27B — 77,2% SWE-bench, 22 GB de VRAM. Para máquinas de 8 GB: Qwen3 8B. Para autocompletado en IDE: Codestral 22B.' },
            ...
            { q: '¿Pueden los LLMs locales reemplazar a GPT-4o para programación?', a: 'No. Los modelos locales (Kimi K2.6 87/100, Qwen 3.6 27B 77,2% SWE-bench) se quedan atrás en: conocimiento del framework más reciente (APIs posteriores al corte de entrenamiento), razonamiento multi-archivo complejo (100k+ tokens) y precisión de depuración. Sin embargo, Kimi K2.6 y Qwen 3.6 han reducido significativamente la brecha en tareas de codificación multi-archivo.' },
      ...
      itemListSchema: {
        ...
        'numberOfItems': 5,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'Qwen2.5-Coder 32B', 'description': '87% HumanEval. 79% MBPP. 20 GB RAM. 40+ lenguajes. Soporte FIM. ollama run qwen2.5-coder:32b', 'url': 'https://www.promptquorum.com/es/local-llms/best-local-llms-for-coding#qwen25-coder-32b' },
          { '@type': 'ListItem', 'position': 2, 'name': 'Qwen 3.6 27B', 'description': '81% HumanEval. 10 GB RAM. Arquitectura MoE. Soporte FIM. ollama run deepseek-coder-v2:16b', 'url': 'https://www.promptquorum.com/es/local-llms/best-local-llms-for-coding#deepseek-coder-v2' },
    ...
    de: {
      ...
      intro: 'Die besten lokalen LLMs für Programmierung im Mai 2026 sind Kimi K2.6 (87/100 Real-World, MoE, MIT-Lizenz), Qwen 3.6 27B (77,2% SWE-bench, bestes dichtes Modell) und Devstral Small 24B (beste agentic Programmierung). Für 8-GB-Maschinen ersetzt Qwen3 8B die bisherige Qwen3 8B Empfehlung. Alle laufen lokal über Ollama.',
      metaDescription: 'Mai 2026: Kimi K2.6 (87/100) ist das beste Programmier-LLM. Vergleich mit Qwen 3.6 27B (77,2% SWE-bench) und Devstral 24B. SWE-bench ersetzt HumanEval.',
      publishDate: '2026-04-04',
      leadAnswerBlock: '**Im Mai 2026 sind die besten lokalen Programmiermodelle Kimi K2.6 (87/100 Real-World, MoE, MIT-Lizenz) für maximale Qualität, Qwen 3.6 27B (77,2% SWE-bench, bestes dichtes Modell) für ausgewogene Leistung und Devstral Small 24B (beste für Agentic Workflows). Für 8 GB RAM: Qwen3 8B. Alle laufen über Ollama lokal für Offline-, privale Codegenerierung ohne Cloud-API-Kosten.** Im Gegensatz zu HumanEval, das einzelne Funktionen testet, testet SWE-bench (Lösen echter GitHub-Probleme) jetzt die primäre Benchmark für praktisches Programmieren 2026.',
      ...
      sections: {
        ...
        whichCodingModel: {
          ...
          imageCaption: 'Hardware-angepasste Modellauswahl (Mai 2026): 8 GB RAM → Qwen3 8B (5 GB VRAM, verbesserte Programmierung); 16 GB RAM → Devstral Small 24B (16 GB VRAM, agentic Programmierung) oder Qwen 3.6 27B (77,2% SWE-bench); 20+ GB RAM → Kimi K2.6 quantisiert (87/100 Real-World, beste lokale Qualität).',
        },
        codingLlm8gb: {
          id: 'coding-llm-8gb-vram',
        ...
        faqSection: {
          title: 'FAQ',
          faqs: [
            { q: 'Was ist das beste lokale LLM für Programmierung 2026?', a: 'Qwen2.5-Coder 32B -- 87% HumanEval, 79% MBPP, 40+ Programmiersprachen, 128K Kontext, FIM-Unterstützung. Erfordert ~20 GB RAM bei Q4_K_M. Für 8-GB-Maschinen: Qwen3 8B (72% HumanEval, 4,7 GB RAM).' },
...
schema: {
    ...
    fr: {
      ...
      intro: 'En mai 2026, les meilleurs LLMs locaux pour la programmation sont Kimi K2.6 (87/100 real-world, MoE, licence MIT), Qwen 3.6 27B (77,2% SWE-bench, meilleur modèle dense) et Devstral Small 24B (meilleur pour la programmation agentive). Pour les machines 8 GB, Qwen3 8B remplace la recommandation précédente Qwen2.5-Coder 7B. Tous fonctionnent localement via Ollama.',
      metaDescription: 'Mai 2026 : Kimi K2.6 (87/100 real-world) est le meilleur LLM local pour la programmation. Comparé avec Qwen 3.6 27B (77,2% SWE-bench) et Devstral 24B.',
      publishDate: '2026-04-04',
      ...
      sections: {
        ...
        faqSection: {
          title: 'FAQ',
          faqs: [
            { q: 'Quel est le meilleur LLM local pour la programmation en 2026?', a: 'Qwen2.5-Coder 32B — 87% HumanEval, 79% MBPP, 40+ langages de programmation, 128K contexte, support FIM. Nécessite ~20 GB RAM à Q4_K_M. Pour les machines 8 GB : Qwen3 8B (72% HumanEval, 4.5 GB RAM).' },
...
schema: {
    ...
    ja: {
      ...
      intro: '2026年5月のコーディング用最高のローカルLLMはKimi K2.6（87/100 real-world、MoE、MITライセンス）、Qwen 3.6 27B（77.2% SWE-bench、最高の密集モデル）、Devstral Small 24B（最高のエージェントコーディング）です。8GB マシンの場合、Qwen3 8B が以前の Qwen2.5-Coder 7B の推奨に置き換わります。すべて Ollama 経由でローカルで実行されます。',
      metaDescription: '2026年5月：Kimi K2.6（87/100 real-world）はコーディング用最高のローカルLLMです。Qwen 3.6 27B（77.2% SWE-bench）とDevstral 24B との比較。SWE-benchがHumanEvalに取って代わります。',
      publishDate: '2026-04-04',
      leadAnswerBlock: '**2026年5月の最高のローカルコーディングモデルはKimi K2.6（87/100 real-world、MoE、MIT ライセンス）で最高品質、Qwen 3.6 27B（77.2% SWE-bench、最高の密集モデル）でバランスのとれたパフォーマンス、Devstral Small 24B（エージェントワークフロー最高）です。8GB RAM：Qwen3 8B。すべて Ollama を介してローカルで実行され、クラウド API コストなしのオフライン プライベート コード生成が可能です。** 単一関数をテストする HumanEval とは異なり、SWE-bench（実際の GitHub 問題の解決）は 2026 年の実践的なコーディングの主要ベンチマークです。',
...
schema: {
      ...
      faqSchema: {
        ...
        inLanguage: 'ja',
        mainEntity: [
          { '@type': 'Question', 'name': '2026年に最高のコーディング用ローカルLLMは？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Qwen2.5-Coder 32B――87% HumanEval、79% MBPP、40以上のプログラミング言語、128K コンテキスト、FIMサポート。Q4_K_Mで~20 GB RAMが必要。8 GBマシン用：Qwen3 8B（72% HumanEval、4.7 GB RAM）。' } },
    ...
    zh: {
      ...
      intro: '2026年5月，用于编码的最佳本地LLM是Kimi K2.6（87/100实际应用、MoE、MIT许可证）、Qwen 3.6 27B（77.2% SWE基准、最佳密集模型）和Devstral Small 24B（最佳代理编码）。对于8GB机器，Qwen3 8B取代了之前的Qwen2.5-Coder 7B推荐。所有都通过Ollama本地运行。',
      metaDescription: '2026年5月：Kimi K2.6（87/100实际应用）是最佳本地编码LLM。与Qwen 3.6 27B（77.2% SWE基准）和Devstral 24B对比。SWE基准取代HumanEval。',
      publishDate: '2026-04-04',
      leadAnswerBlock: '**2026年5月，最佳本地编码模型是Kimi K2.6（87/100实际应用、MoE、MIT许可证）提供最高品质，Qwen 3.6 27B（77.2% SWE基准、最佳密集模型）提供均衡性能，Devstral Small 24B（代理工作流最佳）。8GB RAM：Qwen3 8B。所有通过Ollama本地运行，无云API成本的离线私密代码生成。** 与测试单个函数的HumanEval不同，SWE基准（解决实际GitHub问题）现在是2026年实际编码的主要基准。',
...
schema: {
      ...
      faqSchema: {
        ...
        inLanguage: 'zh',
        mainEntity: [
          { '@type': 'Question', 'name': '2026年最佳本地编码LLM是什么？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Qwen2.5-Coder 32B——87% HumanEval、79% MBPP、40+编程语言、128K上下文、FIM支持。Q4_K_M需约20 GB RAM。8 GB机器：Qwen3 8B（72% HumanEval、4.7 GB RAM）。' } },
