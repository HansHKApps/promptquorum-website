    ...
    en: {
      ...
      sections: {
        ...
        qwen25coder32: {
          ...
          rows: [
            { 'Spec': 'SWE-Bench Pro score', 'Value': '58.6 (ties GPT-5.6)' },
    ...
    es: {
      ...
      sections: {
        ...
        qwen25coder32: {
          ...
          rows: [
            { 'Especificación': 'Puntuación SWE-Bench Pro', 'Valor': '58.6 (empata con GPT-5.6)' },
    ...
    ar: {
      ...
      sections: {
        ...
        qwen25coder32: {
          ...
          rows: [
            { 'المواصفة': 'نتيجة SWE-Bench Pro', 'القيمة': '58.6 (يتعادل مع GPT-5.6)' },
    ...
    pt: {
      ...
      sections: {
        ...
        inOneSentence: {
          id: 'in-one-sentence',
          title: 'Em Uma Frase',
          content: ['Os melhores modelos de código locais em junho de 2026 são o Kimi K2.6 (58,6 SWE-Bench Pro, MoE) para qualidade máxima, o Qwen 3.6 27B (77,2% SWE-bench) como melhor modelo denso, e o Qwen3 8B para 8 GB de RAM.'],
        },
        plainTerms: {
          id: 'in-plain-terms',
        ...
        devstral: {
          id: 'devstral-small',
          title: '#3 Devstral Small 24B -- Melhor para Codificação Agêntica',
          content: [
        ...
        humanEvalTable: {
          ...
          imageCaption: 'Pontuações por modelo (junho de 2026): o Qwen3-Coder 32B lidera com 87% no HumanEval, o DeepSeek V4 Flash obtém 78/100 em testes independentes de cenário real, o Qwen 3.6 27B atinge 77,2% no SWE-bench, o Qwen3 8B chega a ~76% no HumanEval, e o Kimi K2.6 marca 58,6 no SWE-Bench Pro, mais exigente.',
          callouts: [
        ...
        whichCodingModel: {
          ...
          imageCaption: 'Seleção de modelo por hardware (junho de 2026): 8 GB de RAM → Qwen3 8B (5 GB de VRAM, código aprimorado); 16 GB de RAM → Devstral Small 24B (16 GB de VRAM, código agêntico) ou Qwen 3.6 27B (77,2% SWE-bench); 20+ GB de RAM → Kimi K2.6 quantizado (58,6 SWE-Bench Pro, melhor qualidade local).',
        },
        codingLlm8gb: {
          id: 'coding-llm-8gb-vram',
      ...
      sections: {
        ...
        qwen25coder32: {
          ...
          content: [
            ...
            'Bei Q4_K_M-Quantisierung erfordert es ~20 GB RAM -- machbar auf Workstations und MacBooks mit 24+ GB shared memory. Response-Qualität bei komplexen Multi-File-Refactoring und Algorithmus-Design-Aufgaben ist wettbewerbsfähig mit GPT-5.6.',
          ],
          callouts: [
        ...
        humanEvalTable: {
          title: 'Wie vergleichen sich Codierungsmodelle? HumanEval + SWE-bench (Juni 2026)',
          rows: [
      ...
      sections: {
        ...
        qwen25coder32: {
          ...
          content: [
            ...
            'À la quantification Q4_K_M, il nécessite ~20 GB RAM — gérable sur les postes de travail et MacBooks avec 24+ GB de mémoire unifiée. La qualité des réponses sur les tâches complexes de refactorisation multi-fichiers et de conception d\'algorithmes est compétitive avec GPT-5.6.',
          ],
          callouts: [
        ...
        humanEvalTable: {
          title: 'Comment les modèles de codage se comparent-ils ? HumanEval + SWE-bench (juin 2026)',
          rows: [
...
schema: {
    ...
    ja: {
      ...
      sections: {
        ...
        humanEvalTable: {
          id: 'humaneval-table',
          title: 'コーディングモデル比較:HumanEval + SWE-bench(2026年6月)',
          ...
          imageCaption: 'モデル別ベンチマークスコア(2026年6月):Qwen3-Coder 32BがHumanEval 87%で首位、DeepSeek V4 Flashは独立したリアルワールドテストで78/100、Qwen 3.6 27BはSWE-benchで77.2%、Qwen3 8Bは約76% HumanEval、Kimi K2.6はより困難なSWE-Bench Proで58.6を記録。',
          callouts: [
...
schema: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', 'name': 'ローカルLLMはプログラミング用GPT-5.6に代わる？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'いいえ。Qwen3-Coder 32B（87% HumanEval）対GPT-5.6（~92%実効）。ローカルモデルは以下で遅延：最近のフレームワーク知識（学習後API）、複雑なマルチファイルの推論（100k+トークン）、デバッグ精度。最高ローカルモデルは関数生成で競争的、システムレベル設計ではない。' } },
    ...
    zh: {
      ...
      sections: {
        ...
        humanEvalTable: {
          id: 'humaneval-table',
          title: '编码模型对比:HumanEval + SWE-bench(2026年6月)',
          ...
          imageCaption: '各模型基准得分(2026年6月):Qwen3-Coder 32B以87% HumanEval领先,DeepSeek V4 Flash在独立真实场景测试中获得78/100,Qwen 3.6 27B达到77.2% SWE-bench,Qwen3 8B约76% HumanEval,Kimi K2.6在更难的SWE-Bench Pro上获得58.6分。',
          callouts: [
...
schema: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', 'name': '本地LLM能替代编程用GPT-5.6吗？', 'acceptedAnswer': { '@type': 'Answer', 'text': '不能。Qwen3-Coder 32B（87% HumanEval）对GPT-5.6（~92%实效）。本地模型滞后于：最新框架知识（训练后API）、复杂多文件推理（100k+token）、调试精度。最佳本地模型在函数生成上竞争性强，系统级设计上不行。' } },
  ...
  ko: {
      ...
      sections: {
        ...
        qwen25coder32: {
          ...
          rows: [
            { 'Spec': 'SWE-Bench Pro 점수', 'Value': '58.6 (GPT-5.6과 동등)' },
