      ...
      sections: {
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'Qwen3-CoderとQwen3の違い？', a: 'Qwen3-Coderはコードコーパスで特別にファインチューンおよびFIMサポート。Qwen3は汎用モデル。HumanEvalではQwen3 8BとQwen3 7Bは類似スコア（72%）だが、Qwen3-Coderはコード補完機能を含み、汎用モデルにはこれがない。' },
...
schema: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', 'name': 'Qwen3-CoderとQwen3の違い？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Qwen3-Coderはコードコーパスで特別にファインチューンおよびFIMサポート。Qwen3は汎用モデル。HumanEvalではQwen3 8BとQwen3 7Bは類似スコア（72%）だが、Qwen3-Coderはコード補完機能を含み、汎用モデルにはこれがない。' } },
      ...
      sections: {
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'Qwen3-Coder与Qwen3有何区别？', a: 'Qwen3-Coder专门在代码语料库上微调并包含FIM支持。Qwen3是通用模型。HumanEval上Qwen3 8B和Qwen3 7B分数相似（72%），但Qwen3-Coder包含代码补全特性，通用模型没有这些功能。' },
...
schema: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', 'name': 'Qwen3-Coder与Qwen3有何区别？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Qwen3-Coder专门在代码语料库上微调并包含FIM支持。Qwen3是通用模型。HumanEval上Qwen3 8B和Qwen3 7B分数相似（72%），但Qwen3-Coder包含代码补全特性，通用模型没有这些功能。' } },
