...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      current_models_mentioned: ['Kimi K2', 'Qwen 3.6 27B', 'Devstral Small 24B', 'Codestral 22B', 'qwen3-coder:30b', 'gpt-oss:20b', 'Qwen3 8B'],
      theme: 'Best Models',
      title: 'Best Local LLMs for Coding 2026: Kimi K2 vs Qwen vs Devstral',
      seoTitle: 'Best Local Coding LLMs 2026: Kimi K2, Qwen, Devstral',
      intro: 'The best local LLMs for coding in June 2026 are Kimi K2 (58.6 SWE-Bench Pro, MoE, Modified MIT license), Qwen 3.6 27B (77.2% SWE-bench, best dense model), and Devstral Small 24B (best agentic coding). For 8 GB machines, Qwen3 8B is the top pick (5 GB VRAM). All run locally via Ollama.',
      metaDescription: 'Kimi K2 leads at 58.6 SWE-Bench Pro, Qwen 3.6 27B hits 77.2% SWE-bench, Devstral 24B wins agentic coding. Compare VRAM, speed and benchmarks on Ollama.',
      publishDate: '2026-04-04',
      dateModified: '2026-06-19',
      leadAnswerBlock: '**In June 2026, the best local coding models are Kimi K2 (58.6 SWE-Bench Pro, MoE, Modified MIT license) for maximum quality, Qwen 3.6 27B (77.2% SWE-bench, best dense model) for balanced performance, and Devstral Small 24B (best for agentic workflows). For 8 GB RAM: Qwen3 8B. All run via Ollama locally for offline, private code generation without cloud API costs.** Unlike HumanEval which tests single functions, SWE-bench (solving real GitHub issues) is now the primary benchmark for practical coding in 2026.',
      quickAnswerTop: {
        en: {
          question: 'What is the best local LLM for coding in June 2026?',
          answer: 'Kimi K2 (58.6 SWE-Bench Pro, MoE, Modified MIT license) is the best overall. Qwen 3.6 27B (77.2% SWE-bench) is best dense model. For agentic coding: Devstral Small 24B. For 8 GB RAM: Qwen3 8B. For IDE autocomplete: Codestral 22B. All run locally via Ollama.',
          bullets: [
            'Kimi K2 — best overall coding model, 58.6 SWE-Bench Pro, MoE (32B active / 1T total)',
        ...
        de: {
          ...
          answer: 'Das beste lokale Coding-LLM Juni 2026 ist Kimi K2 (58.6 SWE-Bench Pro, MoE, Modified MIT-Lizenz) für maximale Qualität. Bestes dichtes Modell: Qwen 3.6 27B (77,2% SWE-bench). Für 8 GB RAM: Qwen3 8B. Alle laufen lokal via Ollama.',
          bullets: [
            'Kimi K2 — bestes Coding-Modell, 58.6 SWE-Bench Pro, MoE (32B aktiv / 1T total)',
        ...
        fr: {
          ...
          answer: 'Le meilleur LLM local pour coder en juin 2026 est Kimi K2 (58.6 SWE-Bench Pro, MoE, licence MIT modifiée) pour la qualité maximale. Meilleur dense: Qwen 3.6 27B (77,2% SWE-bench). Pour 8 GB RAM: Qwen3 8B. Tous via Ollama.',
          bullets: [
            'Kimi K2 — meilleur modele de code, 58.6 SWE-Bench Pro, MoE (32B actif / 1T total)',
        ...
        ja: {
          ...
          answer: '2026年6月のコーディング向け最高のローカルLLMはKimi K2（58.6 SWE-Bench Pro、MoE、Modified MITライセンス）です。最高の密集モデルはQwen 3.6 27B（77.2% SWE-bench）です。エージェントコーディング：Devstral Small 24B。8GB RAM：Qwen3 8B。すべてOllamaを通じてローカルで実行します。',
          bullets: [
            'Kimi K2 — 最高のコーディングモデル、58.6 SWE-Bench Pro、MoE（32B active / 1T total）',
        ...
        zh: {
          ...
          answer: '2026年6月最佳的本地编程LLM是Kimi K2（58.6 SWE-Bench Pro、MoE、修改版MIT许可证）。最佳密集模型为Qwen 3.6 27B（77.2% SWE-bench）。代理编码：Devstral Small 24B。8GB RAM：Qwen3 8B。全部通过Ollama在本地运行。',
          bullets: [
            'Kimi K2 — 最佳编程模型，58.6 SWE-Bench Pro，MoE（32B active / 1T total）',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'The best local coding LLMs in June 2026 are Kimi K2 (58.6 SWE-Bench Pro, MoE, Modified MIT) for maximum quality and Qwen 3.6 27B (77.2% SWE-bench) for balanced performance on consumer hardware.' },
            { type: 'plain-terms', text: 'SWE-bench measures how well an AI fixes real GitHub bugs — higher is better. Kimi K2 is a large "mixture-of-experts" model that activates only 32B of its 1T parameters per query, giving top accuracy at manageable GPU cost.' },
          ],
          items: [
            '**Best overall coding model**: Kimi K2 — 58.6 SWE-Bench Pro, MoE architecture (32B active / 1T total), Modified MIT license. Best dense model: Qwen 3.6 27B — 77.2% SWE-bench.',
        ...
        quickFacts: {
          ...
          items: [
            '**Best overall (max quality):** Kimi K2 — 58.6 SWE-Bench Pro, MoE (32B active), Modified MIT license. Needs quantization for consumer hardware.',
            ...
            '**High-end setup:** 20+ GB (runs Kimi K2 quantized or Qwen3-Coder 32B for maximum quality).',
          ],
        },
        bestModelsQuickPicks: {
          ...
          items: [
            '**Best overall:** Kimi K2 (quantized) — 58.6 SWE-Bench Pro, MoE architecture, Modified MIT license. `ollama run kimi-k2`',
            ...
            '👉 **For maximum quality (20+ GB):** use Kimi K2 quantized or Qwen3-Coder 32B for offline capability.',
          ],
          callouts: [
            { type: 'practice', text: 'Match model size to your hardware first. If you have 8 GB, use Qwen3 8B. If you have 16+ GB, use Qwen 3.6 27B or Devstral Small 24B. If you have 20+ GB, use Kimi K2 (quantized) for best real-world performance. Do not waste time downloading larger models that will run out of memory.' },
          ],
        },
        inOneSentence: {
          id: 'in-one-sentence',
          title: 'In One Sentence',
          content: ['The best local coding models in June 2026 are Kimi K2 (58.6 SWE-Bench Pro, MoE) for maximum quality, Qwen 3.6 27B (77.2% SWE-bench) as best dense model, and Qwen3 8B for 8 GB RAM.'],
        },
        plainTerms: {
          id: 'in-plain-terms',
        ...
        whatMakesGood: {
          ...
          content: [
            '**In 2026, SWE-bench has largely replaced HumanEval as the primary practical coding benchmark.** SWE-bench tests the model\'s ability to resolve real GitHub issues — multi-file changes, understanding codebases, writing tests — not just generating single functions. Qwen 3.6 27B scores 77.2% on SWE-bench; Kimi K2 scores 58.6 on SWE-Bench Pro.',
        ...
        qwen25coder32: {
          title: '#1 Kimi K2 — Best Overall Local Coding LLM',
          content: [
            '**Kimi K2 (Moonshot AI) is the highest-performing locally-runnable coding model in June 2026.** It scored 58.6 on SWE-Bench Pro — the first non-Western model to reach Tier A. MoE architecture with 32B active parameters out of 1T total. Modified MIT license — commercial use permitted.',
            'Available via `ollama run kimi-k2`. Needs quantization for consumer hardware. Strong on multi-file edits, session-based multi-turn coding, and API usage correctness. Response quality on complex refactoring and algorithm design tasks is competitive with frontier cloud models.',
          ],
          callouts: [
            { type: 'insight', text: 'Kimi K2 uses MoE architecture: only 32B parameters are active per token, not 1T. This makes it faster and more efficient than its total parameter count suggests. MoE models run on hardware that dense 70B models require.' },
          ],
          rows: [
            ...
            { 'Spec': 'Ollama command', 'Value': 'ollama run kimi-k2' },
          ],
          columns: ['Spec', 'Value'],
        },
        deepseek: {
        ...
        humanEvalTable: {
          ...
          rows: [
            { 'Model': 'Kimi K2 (MoE)', 'HumanEval': '—', 'SWE-bench': '58.6 (SWE-Bench Pro)', 'RAM': 'varies (quantized)', 'FIM': '—' },
        ...
        codingExamples: {
          ...
          numberedItems: [
            '**Python function debugging** -- Kimi K2 (58.6 SWE-Bench Pro) identifies the bug (off-by-one loop condition) in 1–2 responses. Qwen 3.6 27B (77.2% SWE-bench) solves it in 2–3 passes. Codestral 22B requires rephrasing for accurate detection. **Winner:** Kimi K2 for debugging accuracy and speed.',
            '**Multi-file code refactoring** -- Qwen 3.6 27B excels at multi-file changes because all 27B parameters are active (dense model). Kimi K2 (MoE) routes differently per token but achieves similar results faster. Devstral Small 24B designed specifically for multi-file workflows via tool calling. **Winner:** Qwen 3.6 27B for consistent multi-file reasoning.',
            '**FIM / IDE autocomplete (VS Code)** -- Codestral 22B and Qwen3 8B (via Continue.dev) both complete multi-line function bodies accurately from context on both sides of the cursor. Kimi K2 cannot perform FIM (not trained for it). **Winner:** Codestral 22B and Qwen3 8B for IDE integration.',
            '**TypeScript type inference** -- Kimi K2 correctly infers union types and generic constraints. Qwen 3.6 27B scores 85%+ accuracy on type inference tasks. Qwen3 8B fails 15%+ of complex type refinement prompts. **Winner:** Kimi K2 for complex type systems and multi-file type tracking.',
          ],
          callouts: [
            { type: 'insight', text: 'Real-world coding tasks (SWE-bench) favor larger models. Kimi K2 (58.6 SWE-Bench Pro) and Qwen 3.6 27B (77.2% SWE-bench) score ~5–10% higher on practical debugging and refactoring than Qwen3 8B. For everyday scripting, the gap narrows significantly.' },
          ],
        },
        speedQualityTable: {
          ...
          rows: [
            { 'Task': 'Generate REST API (100-line boilerplate)', 'Kimi K2': '18–32 tok/sec | ✓ Correct routes + error handling', 'Qwen 3.6 27B': '12–18 tok/sec | ✓ Correct routes', 'Qwen3 8B': '30–45 tok/sec | ⚠️ Missing validation', 'Codestral 22B': '28–38 tok/sec | ⚠️ Generic output' },
            { 'Task': 'Debug SQL query (complex JOIN)', 'Kimi K2': '15–25 tok/sec | ✓ Correct index + optimization hints', 'Qwen 3.6 27B': '12–20 tok/sec | ✓ Correct index', 'Qwen3 8B': '20–30 tok/sec | ⚠️ Partial solution', 'Codestral 22B': '18–28 tok/sec | ✗ Wrong index' },
            { 'Task': 'Write unit tests (3–5 test cases)', 'Kimi K2': '16–28 tok/sec | ✓ Edge case + security coverage', 'Qwen 3.6 27B': '14–22 tok/sec | ✓ Good coverage', 'Qwen3 8B': '28–40 tok/sec | ⚠️ Happy path only', 'Codestral 22B': '25–35 tok/sec | ⚠️ Happy path only' },
            { 'Task': 'FIM autocomplete (cursor mid-line)', 'Kimi K2': 'N/A (not trained for FIM)', 'Qwen 3.6 27B': 'N/A (not optimized)', 'Qwen3 8B': '50+ tok/sec | ✓ Accurate (FIM)', 'Codestral 22B': '60+ tok/sec | ✓ Fastest & most accurate FIM' },
          ],
          columns: ['Task', 'Kimi K2', 'Qwen 3.6 27B', 'Qwen3 8B', 'Codestral 22B'],
          callouts: [
            { type: 'tip', text: '**Key insight:** Kimi K2 and Qwen 3.6 27B are slower but more accurate for reasoning tasks (debugging, SQL optimization, security). Qwen3 8B is faster for generation tasks (API boilerplate, test scaffolding). For IDE autocomplete, ONLY use FIM-optimized models (Codestral 22B, Qwen3 8B).' },
        ...
        whichCodingModel: {
          ...
          items: [
            ...
            '**20+ GB RAM (best quality)**: `ollama run kimi-k2` (quantized) or `ollama run qwen3.6:27b` -- Kimi K2 58.6 SWE-Bench Pro, Qwen 3.6 77.2% SWE-bench.',
          ...
          imageCaption: 'Hardware-matched model selection (June 2026): 8 GB RAM → Qwen3 8B (5 GB VRAM, improved coding); 16 GB RAM → Devstral Small 24B (16 GB VRAM, agentic coding) or Qwen 3.6 27B (77.2% SWE-bench); 20+ GB RAM → Kimi K2 quantized (58.6 SWE-Bench Pro, best local quality).',
        },
        codingLlm8gb: {
        ...
        userPersonas: {
          ...
          items: [
            ...
            '**Advanced developer (debugging, refactoring, complex reasoning):** Ollama + Qwen 3.6 27B (dense model, consistent reasoning) or Kimi K2 (quantized, maximum quality 58.6 SWE-Bench Pro) -- handles multi-file context and algorithm design.',
          ...
          callouts: [
            ...
            { type: 'insight', text: 'Beginner → intermediate → advanced is also a progression in hardware requirements. Start with Qwen3 8B (8 GB), upgrade to Devstral Small 24B (16 GB) as you add tools and workflows, graduate to Qwen 3.6 27B or Kimi K2 (20+ GB) only if you need maximum reasoning quality.' },
          ],
        },
        whenNotToUse: {
          id: 'when-not-to-use',
        ...
        comparisonDecision: {
          ...
          rows: [
            { 'Model': 'Kimi K2 (quantized)', 'Best For': 'Maximum local quality, real-world benchmarks', 'VRAM': 'varies (quantized)', 'Speed': '15–25 tok/sec', 'Strength': '58.6 SWE-Bench Pro, MoE (32B active / 1T total), Modified MIT license', 'When to Pick': 'You need maximum local quality and offline capability for debugging/refactoring' },
          ...
          content: [
            '**Unsure which coding model to pick?** PromptQuorum lets you send one prompt to multiple models simultaneously (Kimi K2, Qwen 3.6, Devstral, GPT-5.5, Claude) and see side-by-side outputs, real response times, and accuracy on YOUR code. Try [PromptQuorum free — 5 minutes, no signup](https://www.promptquorum.com/).',
          ],
        },
        regionalContext: {
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Ignoring MoE models because the total parameter count looks too large:** Kimi K2 has 1T total parameters but only 32B are active per token. MoE models run faster and use less VRAM than their total parameter count suggests. A 1T MoE model can run on hardware that a 70B dense model requires.',
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Chain-of-Thought Prompting](/prompt-engineering/chain-of-thought-prompting) — improves debugging output quality on Kimi K2 and Qwen3',
            ...
            '[LLM Quantization Explained](/local-llms/llm-quantization-explained) -- RAM requirements for Kimi K2 and Qwen 3.6 at different quantization levels',
        ...
        faqSection: {
          ...
          faqs: [
            { q: 'What is the best local LLM for coding in June 2026?', a: 'Kimi K2 — 58.6 SWE-Bench Pro (MoE, Modified MIT license). Best dense model: Qwen 3.6 27B — 77.2% SWE-bench, 22 GB VRAM. For 8 GB machines: Qwen3 8B. For IDE autocomplete: Codestral 22B.' },
            ...
            { q: 'Can local LLMs replace GPT-5.5 for coding?', a: 'No. Local models (Kimi K2 58.6 SWE-Bench Pro, Qwen 3.6 27B 77.2% SWE-bench) lag on: latest framework knowledge (APIs post-training cutoff), complex multi-file reasoning (100k+ tokens), and debugging accuracy. However, Kimi K2 and Qwen 3.6 have narrowed the gap significantly on multi-file coding tasks.' },
            ...
            { q: 'Can I use local coding models for SQL generation?', a: 'Yes -- Qwen 3.6 27B and Kimi K2 both perform well on SQL generation tasks. Provide the table schema in the prompt context. For complex multi-join queries, use 32K context to include the full schema. Set a system prompt: "You are an expert SQL developer. Generate only valid SQL."' },
            ...
            { q: 'What is Kimi K2 and is it safe to use?', a: 'Kimi K2 is an open-source coding model from Moonshot AI (China), released under a Modified MIT license. It uses MoE architecture (32B active / 1T total parameters) and scored 58.6 on SWE-Bench Pro. When running locally via Ollama, no data is sent externally — your code stays on your machine regardless of the model\'s origin. Modified MIT license permits commercial use.' },
        ...
        sources: {
          ...
          title: 'Sources',
          items: [
            '**Moonshot AI. (2026).** "Kimi K2" — MoE architecture, Modified MIT license, SWE-Bench Pro',
...
schema: {
        ...
        'headline': 'Best Coding LLMs 2026: Kimi K2 (58.6 SWE-Bench Pro) vs Qwen 3.6 vs Devstral',
        'description': 'June 2026: Kimi K2 (58.6 SWE-Bench Pro) is the best local coding LLM. Compare with Qwen 3.6 27B (77.2% SWE-bench) and Devstral 24B. SWE-bench replaces HumanEval.',
      ...
      faqSchema: {
        ...
        '@type': 'FAQPage',
        'mainEntity': [
          { '@type': 'Question', 'name': 'What is the best local LLM for coding in 2026?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Kimi K2 -- 58.6 SWE-Bench Pro (MoE, Modified MIT license) is the best overall. Best dense model: Qwen 3.6 27B -- 77.2% SWE-bench, 22 GB VRAM. For agentic coding: Devstral Small 24B. For 8 GB machines: Qwen3 8B.' } },
      ...
      itemListSchema: {
        ...
        'numberOfItems': 5,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'Kimi K2', 'description': '58.6 SWE-Bench Pro. MoE (32B active / 1T total). Modified MIT license. Best overall. ollama run kimi-k2', 'url': 'https://www.promptquorum.com/local-llms/best-local-llms-for-coding#qwen25-coder-32b' },
    ...
    es: {
      ...
      next_refresh_due: '2026-06-30',
      theme: 'Best Models',
      title: 'Mejores LLMs locales para programación 2026: Kimi K2 vs Qwen vs Devstral',
      seoTitle: 'Mejores LLM locales para código 2026: Kimi K2, Qwen',
      intro: 'Los mejores LLMs locales para programación en junio de 2026 son Kimi K2 (58.6 SWE-Bench Pro, MoE, licencia MIT modificada), Qwen 3.6 27B (77,2% en SWE-bench, mejor modelo denso) y Devstral Small 24B (mejor para codificación agéntica). Para máquinas con 8 GB, Qwen3 8B reemplaza la recomendación anterior de Qwen3-Coder 7B. Todos se ejecutan localmente a través de Ollama.',
      metaDescription: 'Kimi K2 lidera con 58.6 SWE-Bench Pro, Qwen 3.6 27B logra 77,2% SWE-bench y Devstral 24B gana en código agéntico. VRAM, velocidad y benchmarks en Ollama.',
      publishDate: '2026-04-04',
      dateModified: '2026-06-19',
      leadAnswerBlock: '**En junio de 2026, los mejores modelos de programación locales son Kimi K2 (58.6 SWE-Bench Pro, MoE, licencia MIT modificada) para máxima calidad, Qwen 3.6 27B (77,2% SWE-bench, mejor modelo denso) para rendimiento equilibrado y Devstral Small 24B (mejor para flujos de trabajo agénticos). Para 8 GB de RAM: Qwen3 8B. Todos se ejecutan vía Ollama localmente para generación de código sin conexión, privada y sin costos de API en la nube.** A diferencia de HumanEval que evalúa funciones individuales, SWE-bench (resolución de issues reales de GitHub) es ahora el benchmark principal para programación práctica en 2026.',
      quickAnswerTop: {
        en: {
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'Los mejores LLM locales para programación en junio de 2026 son Kimi K2 (58,6 SWE-Bench Pro, MoE, licencia Modified MIT) para máxima calidad y Qwen 3.6 27B (77,2% SWE-bench) para rendimiento equilibrado en hardware de consumo.' },
            { type: 'plain-terms', text: 'SWE-bench mide qué tan bien una IA corrige bugs reales de GitHub — cuanto más alto, mejor. Kimi K2 es un modelo de "mezcla de expertos" que activa solo 32B de sus 1T de parámetros por consulta.' },
          ],
          items: [
            '**Mejor modelo de programación en general**: Kimi K2 — 58.6 en SWE-Bench Pro, arquitectura MoE (32B activos / 1T total), licencia MIT modificada. Mejor modelo denso: Qwen 3.6 27B — 77,2% SWE-bench.',
        ...
        quickFacts: {
          ...
          items: [
            '**Mejor en general (máxima calidad):** Kimi K2 — 58.6 en SWE-Bench Pro, MoE (32B activos), licencia MIT modificada. Necesita cuantización para hardware de consumo.',
            ...
            '**Configuración de gama alta:** 20+ GB (ejecuta Kimi K2 cuantizado o Qwen3-Coder 32B para máxima calidad).',
          ],
        },
        bestModelsQuickPicks: {
          id: 'best-models-quick-picks',
          ...
          items: [
            '**Mejor en general:** Kimi K2 (cuantizado) — 58.6 en SWE-Bench Pro, arquitectura MoE, licencia MIT modificada. `ollama run kimi-k2`',
            ...
            '👉 **Para máxima calidad (20+ GB):** usa Kimi K2 cuantizado o Qwen3-Coder 32B para capacidad sin conexión.',
          ],
          callouts: [
            { type: 'practice', text: 'Ajusta primero el tamaño del modelo a tu hardware. Si tienes 8 GB, usa Qwen3 8B. Si tienes 16+ GB, usa Qwen 3.6 27B o Devstral Small 24B. Si tienes 20+ GB, usa Kimi K2 (cuantizado) para el mejor rendimiento real. No pierdas tiempo descargando modelos más grandes que se quedarán sin memoria.' },
          ],
        },
        inOneSentence: {
          id: 'in-one-sentence',
          title: 'En una frase',
          content: ['Los mejores modelos locales de programación en junio de 2026 son Kimi K2 (58.6 SWE-Bench Pro, MoE) para máxima calidad, Qwen 3.6 27B (77,2% SWE-bench) como mejor modelo denso y Qwen3 8B para 8 GB de RAM.'],
        },
        plainTerms: {
          id: 'in-plain-terms',
        ...
        qwen25coder32: {
          title: '#1 Kimi K2 — Mejor LLM local de programación en general',
          content: [
            '**Kimi K2 (Moonshot AI) es el modelo de programación ejecutable localmente con mayor rendimiento en junio de 2026.** Puntuó 58.6 en SWE-Bench Pro — el primer modelo no occidental en alcanzar el Nivel A. Arquitectura MoE con 32B parámetros activos de un total de 1T. Licencia MIT modificada — uso comercial permitidoe compatible con uso comercial.',
            'Disponible vía `ollama run kimi-k2`. Requiere cuantización para hardware de consumo. Destaca en ediciones multi-archivo, codificación multi-turno basada en sesión y corrección de uso de API. La calidad de respuesta en tareas complejas de refactorización y diseño de algoritmos es competitiva con los mejores modelos en la nube.',
          ],
          callouts: [
            { type: 'insight', text: 'Kimi K2 usa arquitectura MoE: solo 32B parámetros están activos por token, no 1T. Esto lo hace más rápido y eficiente de lo que sugiere su conteo total de parámetros. Los modelos MoE se ejecutan en el hardware que requieren los modelos densos de 70B.' },
          ],
          rows: [
            ...
            { 'Especificación': 'Comando Ollama', 'Valor': 'ollama run kimi-k2' },
          ],
        ...
        humanEvalTable: {
          ...
          rows: [
            { 'Modelo': 'Kimi K2 (MoE)', 'HumanEval': '—', 'SWE-bench': '58.6 (SWE-Bench Pro)', 'RAM': 'variable (cuantizado)', 'FIM': '—' },
        ...
        codingExamples: {
          ...
          numberedItems: [
            '**Depuración de función Python** -- Kimi K2 (58.6 SWE-Bench Pro) identifica el error (condición de bucle fuera de límites) en 1–2 respuestas. Qwen 3.6 27B (77,2% SWE-bench) lo resuelve en 2–3 intentos. Codestral 22B requiere reformular para detección precisa. **Ganador:** Kimi K2 por precisión y velocidad en depuración.',
            '**Refactorización de código multi-archivo** -- Qwen 3.6 27B destaca en cambios multi-archivo porque los 27B parámetros están activos (modelo denso). Kimi K2 (MoE) enruta de forma diferente por token pero logra resultados similares más rápido. Devstral Small 24B está diseñado específicamente para flujos multi-archivo mediante llamadas a herramientas. **Ganador:** Qwen 3.6 27B para razonamiento multi-archivo consistente.',
            '**FIM / autocompletado en IDE (VS Code)** -- Codestral 22B y Qwen3 8B (vía Continue.dev) completan cuerpos de función multi-línea con precisión a partir del contexto de ambos lados del cursor. Kimi K2 no puede realizar FIM (no fue entrenado para ello). **Ganador:** Codestral 22B y Qwen3 8B para integración con IDE.',
            '**Inferencia de tipos TypeScript** -- Kimi K2 infiere correctamente tipos unión y restricciones genéricas. Qwen 3.6 27B puntúa 85%+ de precisión en tareas de inferencia de tipos. Qwen3 8B falla más del 15% de las prompts de refinamiento de tipos complejos. **Ganador:** Kimi K2 para sistemas de tipos complejos y seguimiento de tipos multi-archivo.',
          ],
          callouts: [
            { type: 'insight', text: 'Las tareas de programación reales (SWE-bench) favorecen a los modelos más grandes. Kimi K2 (58.6 SWE-Bench Pro) y Qwen 3.6 27B (77,2% SWE-bench) puntúan ~5–10% más alto en depuración práctica y refactorización que Qwen3 8B. Para scripting cotidiano, la brecha se reduce significativamente.' },
          ],
        },
        speedQualityTable: {
          id: 'speed-quality-table',
          ...
          rows: [
            { 'Tarea': 'Generar API REST (100 líneas de boilerplate)', 'Kimi K2': '18–32 tok/seg | ✓ Rutas correctas + manejo de errores', 'Qwen 3.6 27B': '12–18 tok/seg | ✓ Rutas correctas', 'Qwen3 8B': '30–45 tok/seg | ⚠️ Falta validación', 'Codestral 22B': '28–38 tok/seg | ⚠️ Salida genérica' },
            { 'Tarea': 'Depurar consulta SQL (JOIN complejo)', 'Kimi K2': '15–25 tok/seg | ✓ Índice correcto + sugerencias de optimización', 'Qwen 3.6 27B': '12–20 tok/seg | ✓ Índice correcto', 'Qwen3 8B': '20–30 tok/seg | ⚠️ Solución parcial', 'Codestral 22B': '18–28 tok/seg | ✗ Índice incorrecto' },
            { 'Tarea': 'Escribir pruebas unitarias (3–5 casos)', 'Kimi K2': '16–28 tok/seg | ✓ Cobertura de casos límite + seguridad', 'Qwen 3.6 27B': '14–22 tok/seg | ✓ Buena cobertura', 'Qwen3 8B': '28–40 tok/seg | ⚠️ Solo camino feliz', 'Codestral 22B': '25–35 tok/seg | ⚠️ Solo camino feliz' },
            { 'Tarea': 'Autocompletado FIM (cursor a media línea)', 'Kimi K2': 'N/A (no entrenado para FIM)', 'Qwen 3.6 27B': 'N/A (no optimizado)', 'Qwen3 8B': '50+ tok/seg | ✓ Preciso (FIM)', 'Codestral 22B': '60+ tok/seg | ✓ FIM más rápido y preciso' },
          ],
          columns: ['Tarea', 'Kimi K2', 'Qwen 3.6 27B', 'Qwen3 8B', 'Codestral 22B'],
          callouts: [
            { type: 'tip', text: '**Conclusión clave:** Kimi K2 y Qwen 3.6 27B son más lentos pero más precisos para tareas de razonamiento (depuración, optimización SQL, seguridad). Qwen3 8B es más rápido para tareas de generación (boilerplate de API, andamiaje de pruebas). Para autocompletado en IDE, usa SOLO modelos optimizados para FIM (Codestral 22B, Qwen3 8B).' },
        ...
        whichCodingModel: {
          ...
          items: [
            ...
            '**20+ GB de RAM (mejor calidad)**: `ollama run kimi-k2` (cuantizado) o `ollama run qwen3.6:27b` -- Kimi K2 58.6 SWE-Bench Pro, Qwen 3.6 77,2% SWE-bench.',
          ...
          image: '/images/best-local-llms-for-coding-hardware-selection-en.svg',
          imageCaption: 'Selección de modelo ajustada al hardware (junio 2026): 8 GB de RAM → Qwen3 8B (5 GB de VRAM, programación mejorada); 16 GB de RAM → Devstral Small 24B (16 GB de VRAM, codificación agéntica) o Qwen 3.6 27B (77,2% SWE-bench); 20+ GB de RAM → Kimi K2 cuantizado (58.6 SWE-Bench Pro, mejor calidad local).',
        },
        codingLlm8gb: {
          id: 'coding-llm-8gb-vram',
        ...
        userPersonas: {
          ...
          items: [
            ...
            '**Desarrollador avanzado (depuración, refactorización, razonamiento complejo):** Ollama + Qwen 3.6 27B (modelo denso, razonamiento consistente) o Kimi K2 (cuantizado, máxima calidad 58.6 SWE-Bench Pro) -- maneja contexto multi-archivo y diseño de algoritmos.',
          ...
          callouts: [
            ...
            { type: 'insight', text: 'Principiante → intermedio → avanzado también es una progresión en requisitos de hardware. Comienza con Qwen3 8B (8 GB), actualiza a Devstral Small 24B (16 GB) cuando añadas herramientas y flujos de trabajo, avanza a Qwen 3.6 27B o Kimi K2 (20+ GB) solo si necesitas máxima calidad de razonamiento.' },
          ],
        },
        whenNotToUse: {
          id: 'when-not-to-use',
        ...
        comparisonDecision: {
          ...
          content: [
            '**¿No estás seguro de qué modelo de programación elegir?** PromptQuorum te permite enviar un prompt a múltiples modelos simultáneamente (Kimi K2, Qwen 3.6, Devstral, GPT-5.5, Claude) y ver salidas comparativas, tiempos de respuesta reales y precisión en TU código. Prueba [PromptQuorum gratis — 5 minutos, sin registro](https://www.promptquorum.com/).',
          ],
        },
        regionalContext: {
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Ignorar los modelos MoE porque el conteo total de parámetros parece demasiado grande:** Kimi K2 tiene 1T parámetros totales pero solo 32B están activos por token. Los modelos MoE se ejecutan más rápido y usan menos VRAM de lo que sugiere su conteo total de parámetros. Un modelo MoE de 1T puede ejecutarse en el hardware que requiere un modelo denso de 70B.',
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Prompting en cadena de pensamiento](/es/prompt-engineering/chain-of-thought-prompting) — mejora la calidad de salida de depuración en Kimi K2 y Qwen3',
            ...
            '[Cuantización de LLM explicada](/es/local-llms/llm-quantization-explained) -- requisitos de RAM para Kimi K2 y Qwen 3.6 en diferentes niveles de cuantización',
        ...
        faqSection: {
          ...
          faqs: [
            { q: '¿Cuál es el mejor LLM local para programación en junio de 2026?', a: 'Kimi K2 — 58.6 SWE-Bench Pro (MoE, licencia MIT modificada). Mejor modelo denso: Qwen 3.6 27B — 77,2% SWE-bench, 22 GB de VRAM. Para máquinas de 8 GB: Qwen3 8B. Para autocompletado en IDE: Codestral 22B.' },
            ...
            { q: '¿Pueden los LLMs locales reemplazar a GPT-5.5 para programación?', a: 'No. Los modelos locales (Kimi K2 58.6 SWE-Bench Pro, Qwen 3.6 27B 77,2% SWE-bench) se quedan atrás en: conocimiento del framework más reciente (APIs posteriores al corte de entrenamiento), razonamiento multi-archivo complejo (100k+ tokens) y precisión de depuración. Sin embargo, Kimi K2 y Qwen 3.6 han reducido significativamente la brecha en tareas de codificación multi-archivo.' },
        ...
        sources: {
          ...
          title: 'Fuentes',
          items: [
            '**Moonshot AI. (2026).** "Kimi K2" — arquitectura MoE, licencia MIT modificada, SWE-Bench Pro',
      ...
      schema: {
        ...
        'headline': 'Mejores LLMs locales para programación 2026: Kimi K2 (58.6 SWE-Bench Pro) vs Qwen 3.6 vs Devstral',
        'description': 'Junio 2026: Kimi K2 (58.6 SWE-Bench Pro) es el mejor LLM local de programación. Comparación con Qwen 3.6 27B (77,2% SWE-bench) y Devstral 24B. SWE-bench reemplaza a HumanEval.',
        'datePublished': '2026-04-04',
        'dateModified': '2026-06-19',
        'author': { '@type': 'Person', 'name': 'Hans Kuepper', 'sameAs': 'https://www.linkedin.com/in/hanskuepper/' },
        'publisher': { '@type': 'Organization', 'name': 'PromptQuorum', 'url': 'https://www.promptquorum.com' },
      ...
      faqSchema: {
        ...
        '@type': 'FAQPage',
        'mainEntity': [
          { '@type': 'Question', 'name': '¿Cuál es el mejor LLM local para programación en 2026?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Kimi K2 — 58.6 SWE-Bench Pro (MoE, licencia MIT modificada). Mejor modelo denso: Qwen 3.6 27B — 77,2% SWE-bench, 22 GB de VRAM. Para máquinas de 8 GB: Qwen3 8B (72% HumanEval, 4,7 GB de RAM).' } },
          ...
          { '@type': 'Question', 'name': '¿Puedo usar modelos locales de programación para generación de SQL?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Sí -- Qwen 3.6 27B y Kimi K2 ambos funcionan bien en tareas de generación de SQL. Proporciona el esquema de la tabla en el contexto del prompt. Para consultas multi-JOIN complejas, usa contexto de 32K para incluir el esquema completo. Configura un prompt del sistema: "Eres un experto desarrollador SQL. Genera solo SQL válido."' } },
      ...
      itemListSchema: {
        ...
        'numberOfItems': 5,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'Kimi K2', 'description': '58.6 SWE-Bench Pro. MoE (32B activos / 1T total). Licencia MIT modificada. Mejor en general. ollama run kimi-k2', 'url': 'https://www.promptquorum.com/es/local-llms/best-local-llms-for-coding#qwen25-coder-32b' },
    ...
    ar: {
      ...
      next_refresh_due: '2026-06-30',
      theme: 'Best Models',
      title: 'أفضل نماذج ⁨LLM⁩ المحلية للبرمجة ⁨2026⁩: ⁨Kimi K2⁩ مقابل ⁨Qwen⁩ مقابل ⁨Devstral⁩',
      seoTitle: 'أفضل ⁨LLM⁩ للبرمجة ⁨2026⁩: ⁨Kimi K2⁩ و⁨Qwen⁩ و⁨Devstral⁩',
      intro: 'أفضل نماذج LLM المحلية للبرمجة في يونيو 2026 هي Kimi K2 (58.6 SWE-Bench Pro، MoE، رخصة MIT معدّلة)، وQwen 3.6 27B (77.2% في SWE-bench، أفضل نموذج كثيف)، وDevstral Small 24B (الأفضل للبرمجة الوكيلة). للأجهزة بسعة 8 GB، يحل Qwen3 8B محل التوصية السابقة Qwen3-Coder 7B. تعمل جميعها محلياً عبر Ollama.',
      metaDescription: '⁨Kimi K2⁩ يتصدر بـ ⁨58.6⁩ في ⁨SWE-Bench Pro⁩، ⁨Qwen 3.6 27B⁩ يبلغ ⁨77.2%⁩ في ⁨SWE-bench⁩، ⁨Devstral 24B⁩ الأفضل للبرمجة الوكيلة. قارن ⁨VRAM⁩ عبر ⁨Ollama⁩.',
      publishDate: '2026-04-04',
      dateModified: '2026-06-19',
      leadAnswerBlock: '**في يونيو 2026، أفضل نماذج البرمجة المحلية هي Kimi K2 (58.6 SWE-Bench Pro، MoE، رخصة MIT معدّلة) لأقصى جودة، وQwen 3.6 27B (77.2% SWE-bench، أفضل نموذج كثيف) لأداء متوازن، وDevstral Small 24B (الأفضل لسير العمل الوكيل). لـ 8 GB من RAM: Qwen3 8B. تعمل جميعها عبر Ollama محلياً لتوليد كود دون اتصال وخاص ودون تكاليف API سحابية.** على عكس HumanEval الذي يقيّم الدوال الفردية، أصبح SWE-bench (حل مشكلات GitHub الحقيقية) المعيار الأساسي للبرمجة العملية في 2026.',
      quickAnswerTop: {
        ar: {
          question: 'ما أفضل نموذج LLM محلي للبرمجة في يونيو 2026؟',
          answer: 'Kimi K2 (58.6 SWE-Bench Pro، MoE، رخصة MIT معدّلة) هو الأفضل عموماً. Qwen 3.6 27B (77.2% SWE-bench) هو أفضل نموذج كثيف. للبرمجة الوكيلة: Devstral Small 24B. لـ 8 GB من RAM: Qwen3 8B. للإكمال التلقائي في بيئة التطوير: Codestral 22B. تعمل جميعها محلياً عبر Ollama.',
          bullets: [
            'Kimi K2 — أفضل نموذج برمجة عموماً، 58.6 SWE-Bench Pro، MoE (32B نشطة / 1T إجمالاً)',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'أفضل نماذج LLM المحلية للبرمجة في يونيو 2026: Kimi K2 (58.6 SWE-Bench Pro، MoE، ترخيص Modified MIT) للجودة القصوى، وQwen 3.6 27B (77.2% SWE-bench) للأداء المتوازن على أجهزة المستهلكين.' },
            { type: 'plain-terms', text: 'يقيس SWE-bench مدى قدرة الذكاء الاصطناعي على إصلاح أخطاء GitHub الحقيقية — كلما ارتفع، كان أفضل. Kimi K2 نموذج "خليط من الخبراء" يُفعِّل 32B فقط من أصل 1T من المعاملات في كل استعلام.' },
          ],
          items: [
            '**أفضل نموذج برمجة عموماً**: Kimi K2 — 58.6 في SWE-Bench Pro، بنية MoE (32B نشطة / 1T إجمالاً)، رخصة MIT معدّلة. أفضل نموذج كثيف: Qwen 3.6 27B — 77.2% SWE-bench.',
        ...
        quickFacts: {
          ...
          items: [
            '**الأفضل عموماً (أقصى جودة):** Kimi K2 — 58.6 في SWE-Bench Pro، MoE (32B نشطة)، رخصة MIT معدّلة. يحتاج تكميماً للعتاد الاستهلاكي.',
            ...
            '**إعداد الفئة العليا:** 20+ GB (يشغّل Kimi K2 مكمَّماً أو Qwen3-Coder 32B لأقصى جودة).',
          ],
        },
        bestModelsQuickPicks: {
          id: 'best-models-quick-picks',
          ...
          items: [
            '**الأفضل عموماً:** Kimi K2 (مكمَّم) — 58.6 في SWE-Bench Pro، بنية MoE، رخصة MIT معدّلة. `ollama run kimi-k2`',
            ...
            '👉 **لأقصى جودة (20+ GB):** استخدم Kimi K2 مكمَّماً أو Qwen3-Coder 32B للقدرة دون اتصال.',
          ],
          callouts: [
            { type: 'practice', text: 'طابق حجم النموذج مع عتادك أولاً. إذا كان لديك 8 GB، استخدم Qwen3 8B. إذا كان لديك 16+ GB، استخدم Qwen 3.6 27B أو Devstral Small 24B. إذا كان لديك 20+ GB، استخدم Kimi K2 (مكمَّم) لأفضل أداء حقيقي. لا تضع وقتك في تنزيل نماذج أكبر ستنفد ذاكرتها.' },
          ],
        },
        inOneSentence: {
          id: 'in-one-sentence',
          title: 'في جملة واحدة',
          content: ['أفضل نماذج البرمجة المحلية في يونيو 2026 هي Kimi K2 (58.6 SWE-Bench Pro، MoE) لأقصى جودة، وQwen 3.6 27B (77.2% SWE-bench) كأفضل نموذج كثيف، وQwen3 8B لـ 8 GB من RAM.'],
        },
        plainTerms: {
          id: 'in-plain-terms',
          title: 'بعبارات بسيطة',
        ...
        qwen25coder32: {
          title: '#1 Kimi K2 — أفضل نموذج LLM محلي للبرمجة عموماً',
          content: [
            '**Kimi K2 (Moonshot AI) هو نموذج البرمجة القابل للتشغيل محلياً الأعلى أداءً في يونيو 2026.** حقق نتيجة 58.6 في SWE-Bench Pro — أول نموذج غير غربي يصل إلى المستوى A. بنية MoE بـ 32B معامل نشط من إجمالي 1T. رخصة MIT معدّلة — متوافق مع الاستخدام التجاري.',
            'متوفر عبر `ollama run kimi-k2`. يتطلب تكميماً للعتاد الاستهلاكي. يتفوق في التعديلات متعددة الملفات والبرمجة متعددة الأدوار القائمة على الجلسة وتصحيح استخدام API. جودة الاستجابة في مهام إعادة الهيكلة المعقدة وتصميم الخوارزميات تنافسية مع أفضل النماذج السحابية.',
          ],
          callouts: [
            { type: 'insight', text: 'يستخدم Kimi K2 بنية MoE: 32B معامل فقط نشط لكل رمز، وليس 1T. هذا يجعله أسرع وأكثر كفاءة مما يوحي به إجمالي عدد معاملاته. تعمل نماذج MoE على العتاد الذي تتطلبه النماذج الكثيفة بحجم 70B.' },
          ],
          rows: [
            ...
            { 'المواصفة': 'أمر Ollama', 'القيمة': 'ollama run kimi-k2' },
          ],
        ...
        humanEvalTable: {
          ...
          rows: [
            { 'النموذج': 'Kimi K2 (MoE)', 'HumanEval': '—', 'SWE-bench': '58.6 (SWE-Bench Pro)', 'RAM': 'متغير (مكمَّم)', 'FIM': '—' },
        ...
        codingExamples: {
          ...
          numberedItems: [
            '**تصحيح دالة Python** -- يحدد Kimi K2 (58.6 SWE-Bench Pro) الخطأ (شرط حلقة خارج الحدود) في 1–2 استجابة. يحلّه Qwen 3.6 27B (77.2% SWE-bench) في 2–3 محاولات. يتطلب Codestral 22B إعادة صياغة للكشف الدقيق. **الفائز:** Kimi K2 للدقة والسرعة في التصحيح.',
            '**إعادة هيكلة كود متعدد الملفات** -- يتفوق Qwen 3.6 27B في التغييرات متعددة الملفات لأن الـ 27B معامل نشطة (نموذج كثيف). يوجّه Kimi K2 (MoE) بشكل مختلف لكل رمز لكنه يحقق نتائج مماثلة أسرع. صُمّم Devstral Small 24B خصيصاً لسير العمل متعدد الملفات عبر استدعاء الأدوات. **الفائز:** Qwen 3.6 27B للاستدلال متعدد الملفات المتسق.',
            '**FIM / الإكمال التلقائي في بيئة التطوير (VS Code)** -- يكمل Codestral 22B وQwen3 8B (عبر Continue.dev) أجساماً دالية متعددة الأسطر بدقة من سياق جانبي المؤشر. لا يستطيع Kimi K2 إجراء FIM (لم يُدرَّب عليه). **الفائز:** Codestral 22B وQwen3 8B للتكامل مع بيئة التطوير.',
            '**استنتاج أنواع TypeScript** -- يستنتج Kimi K2 بشكل صحيح أنواع الاتحاد وقيود الأنواع العامة. يحقق Qwen 3.6 27B دقة 85%+ في مهام استنتاج الأنواع. يفشل Qwen3 8B في أكثر من 15% من موجّهات تنقيح الأنواع المعقدة. **الفائز:** Kimi K2 لأنظمة الأنواع المعقدة وتتبع الأنواع متعدد الملفات.',
          ],
          callouts: [
            { type: 'insight', text: 'تفضّل مهام البرمجة الحقيقية (SWE-bench) النماذج الأكبر. يحقق Kimi K2 (58.6 SWE-Bench Pro) وQwen 3.6 27B (77.2% SWE-bench) نتائج أعلى بـ ~5–10% في التصحيح العملي وإعادة الهيكلة من Qwen3 8B. للبرمجة النصية اليومية، تضيق الفجوة بشكل ملحوظ.' },
          ],
        },
        speedQualityTable: {
          id: 'speed-quality-table',
          ...
          rows: [
            { 'المهمة': 'توليد REST API (100 سطر نموذجي)', 'Kimi K2': '18–32 tok/ث | ✓ مسارات صحيحة + معالجة أخطاء', 'Qwen 3.6 27B': '12–18 tok/ث | ✓ مسارات صحيحة', 'Qwen3 8B': '30–45 tok/ث | ⚠️ تفتقر إلى التحقق', 'Codestral 22B': '28–38 tok/ث | ⚠️ مخرجات عامة' },
            { 'المهمة': 'تصحيح استعلام SQL (JOIN معقد)', 'Kimi K2': '15–25 tok/ث | ✓ فهرس صحيح + اقتراحات تحسين', 'Qwen 3.6 27B': '12–20 tok/ث | ✓ فهرس صحيح', 'Qwen3 8B': '20–30 tok/ث | ⚠️ حل جزئي', 'Codestral 22B': '18–28 tok/ث | ✗ فهرس خاطئ' },
            { 'المهمة': 'كتابة اختبارات وحدة (3–5 حالات)', 'Kimi K2': '16–28 tok/ث | ✓ تغطية الحالات الحدية + الأمان', 'Qwen 3.6 27B': '14–22 tok/ث | ✓ تغطية جيدة', 'Qwen3 8B': '28–40 tok/ث | ⚠️ المسار السعيد فقط', 'Codestral 22B': '25–35 tok/ث | ⚠️ المسار السعيد فقط' },
            { 'المهمة': 'إكمال FIM التلقائي (مؤشر في منتصف السطر)', 'Kimi K2': 'غير متاح (لم يُدرَّب على FIM)', 'Qwen 3.6 27B': 'غير متاح (غير محسّن)', 'Qwen3 8B': '50+ tok/ث | ✓ دقيق (FIM)', 'Codestral 22B': '60+ tok/ث | ✓ FIM أسرع وأدق' },
          ],
          columns: ['المهمة', 'Kimi K2', 'Qwen 3.6 27B', 'Qwen3 8B', 'Codestral 22B'],
          callouts: [
            { type: 'tip', text: '**الخلاصة الرئيسية:** Kimi K2 وQwen 3.6 27B أبطأ لكن أدق لمهام الاستدلال (التصحيح، تحسين SQL، الأمان). Qwen3 8B أسرع لمهام التوليد (نموذج API، هيكلة الاختبارات). للإكمال التلقائي في بيئة التطوير، استخدم نماذج محسّنة لـ FIM فقط (Codestral 22B، Qwen3 8B).' },
        ...
        whichCodingModel: {
          ...
          items: [
            ...
            '**20+ GB من RAM (أفضل جودة)**: `ollama run kimi-k2` (مكمَّم) أو `ollama run qwen3.6:27b` -- Kimi K2 بـ 58.6 SWE-Bench Pro، Qwen 3.6 بـ 77.2% SWE-bench.',
          ...
          image: '/images/best-local-llms-for-coding-hardware-selection-en.svg',
          imageCaption: 'اختيار نموذج مطابق للعتاد (يونيو 2026): 8 GB من RAM ← Qwen3 8B (5 GB من VRAM، برمجة محسّنة)؛ 16 GB من RAM ← Devstral Small 24B (16 GB من VRAM، برمجة وكيلة) أو Qwen 3.6 27B (77.2% SWE-bench)؛ 20+ GB من RAM ← Kimi K2 مكمَّم (58.6 SWE-Bench Pro، أفضل جودة محلية).',
        },
        codingLlm8gb: {
          id: 'coding-llm-8gb-vram',
        ...
        userPersonas: {
          ...
          items: [
            ...
            '**مطوّر متقدم (تصحيح، إعادة هيكلة، استدلال معقد):** Ollama + Qwen 3.6 27B (نموذج كثيف، استدلال متسق) أو Kimi K2 (مكمَّم، أقصى جودة 58.6 SWE-Bench Pro) -- يتعامل مع السياق متعدد الملفات وتصميم الخوارزميات.',
          ...
          callouts: [
            ...
            { type: 'insight', text: 'مبتدئ ← متوسط ← متقدم هو أيضاً تدرّج في متطلبات العتاد. ابدأ بـ Qwen3 8B (8 GB)، رقِّ إلى Devstral Small 24B (16 GB) عند إضافة الأدوات وسير العمل، تقدّم إلى Qwen 3.6 27B أو Kimi K2 (20+ GB) فقط إذا كنت تحتاج أقصى جودة استدلال.' },
          ],
        },
        whenNotToUse: {
          id: 'when-not-to-use',
        ...
        comparisonDecision: {
          ...
          rows: [
            { 'النموذج': 'Kimi K2 (مكمَّم)', 'الأفضل لـ': 'أقصى جودة محلية، اختبارات حقيقية', 'VRAM': 'متغير (مكمَّم)', 'السرعة': '15–25 tok/ث', 'القوة': '58.6 SWE-Bench Pro، MoE (32B نشطة / 1T إجمالاً)، رخصة MIT معدّلة', 'متى تختاره': 'تحتاج أقصى جودة محلية وقدرة دون اتصال للتصحيح/إعادة الهيكلة' },
          ...
          content: [
            '**لست متأكداً من نموذج البرمجة الذي تختاره؟** يتيح لك PromptQuorum إرسال موجّه إلى نماذج متعددة في آن واحد (Kimi K2، Qwen 3.6، Devstral، GPT-5.5، Claude) ورؤية مخرجات مقارنة وأوقات استجابة حقيقية ودقة على كودك أنت. جرّب [PromptQuorum مجاناً — 5 دقائق، دون تسجيل](https://www.promptquorum.com/).',
          ],
        },
        regionalContext: {
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**تجاهل نماذج MoE لأن إجمالي عدد المعاملات يبدو كبيراً جداً:** يملك Kimi K2 1T معامل إجمالاً لكن 32B فقط نشطة لكل رمز. تعمل نماذج MoE أسرع وتستخدم VRAM أقل مما يوحي به إجمالي عدد معاملاتها. نموذج MoE بـ 1T يمكن أن يعمل على العتاد الذي يتطلبه نموذج كثيف بحجم 70B.',
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[الموجّهات بسلسلة التفكير](/ar/prompt-engineering/chain-of-thought-prompting) — تحسّن جودة مخرجات التصحيح في Kimi K2 وQwen3',
            ...
            '[شرح تكميم LLM](/ar/local-llms/llm-quantization-explained) -- متطلبات RAM لـ Kimi K2 وQwen 3.6 عند مستويات تكميم مختلفة',
        ...
        faqSection: {
          ...
          faqs: [
            { q: 'ما أفضل نموذج LLM محلي للبرمجة في يونيو 2026؟', a: 'Kimi K2 — 58.6 SWE-Bench Pro (MoE، رخصة MIT معدّلة). أفضل نموذج كثيف: Qwen 3.6 27B — 77.2% SWE-bench، 22 GB من VRAM. للأجهزة بسعة 8 GB: Qwen3 8B. للإكمال التلقائي في بيئة التطوير: Codestral 22B.' },
            ...
            { q: 'هل يمكنني استخدام نماذج البرمجة المحلية لتوليد SQL؟', a: 'نعم -- يعمل Qwen 3.6 27B وKimi K2 جيداً في مهام توليد SQL. قدّم مخطط الجدول في سياق الموجّه. للاستعلامات متعددة JOIN المعقدة، استخدم سياق 32K لتضمين المخطط الكامل. اضبط موجّه نظام: "أنت مطوّر SQL خبير. ولّد SQL صالحاً فقط."' },
        ...
        sources: {
          ...
          title: 'المصادر',
          items: [
            '**Moonshot AI. (2026).** "Kimi K2" — بنية MoE، رخصة MIT معدّلة، SWE-Bench Pro',
      ...
      schema: {
        ...
        'headline': 'أفضل نماذج LLM المحلية للبرمجة 2026: Kimi K2 (58.6 SWE-Bench Pro) مقابل Qwen 3.6 مقابل Devstral',
        'description': 'يونيو 2026: Kimi K2 (58.6 SWE-Bench Pro) هو أفضل نموذج LLM محلي للبرمجة. مقارنة بـ Qwen 3.6 27B (77.2% SWE-bench) وDevstral 24B. يحل SWE-bench محل HumanEval.',
        'datePublished': '2026-04-04',
        'dateModified': '2026-06-19',
        'author': { '@type': 'Person', 'name': 'Hans Kuepper', 'sameAs': 'https://www.linkedin.com/in/hanskuepper/' },
        'publisher': { '@type': 'Organization', 'name': 'PromptQuorum', 'url': 'https://www.promptquorum.com' },
      ...
      faqSchema: {
        ...
        '@type': 'FAQPage',
        'mainEntity': [
          { '@type': 'Question', 'name': 'ما أفضل نموذج LLM محلي للبرمجة في 2026؟', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Kimi K2 — 58.6 SWE-Bench Pro (MoE، رخصة MIT معدّلة). أفضل نموذج كثيف: Qwen 3.6 27B — 77.2% SWE-bench، 22 GB من VRAM. للأجهزة بسعة 8 GB: Qwen3 8B (72% HumanEval، 4.7 GB من RAM).' } },
      ...
      itemListSchema: {
        ...
        'numberOfItems': 5,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'Kimi K2', 'description': '58.6 SWE-Bench Pro. MoE (32B نشطة / 1T إجمالاً). رخصة MIT معدّلة. الأفضل عموماً. ollama run kimi-k2', 'url': 'https://www.promptquorum.com/ar/local-llms/best-local-llms-for-coding#qwen25-coder-32b' },
    ...
    pt: {
      ...
      next_refresh_due: '2026-06-30',
      theme: 'Best Models',
      title: 'Melhores LLMs locais para programação 2026: Kimi K2 vs Qwen vs Devstral',
      seoTitle: 'Melhor LLM local para código 2026: Kimi K2, Qwen',
      intro: 'Os melhores LLMs locais para programação em junho de 2026 são Kimi K2 (58,6 SWE-Bench Pro, MoE, licença MIT modificada), Qwen 3.6 27B (77,2% no SWE-bench, melhor modelo denso) e Devstral Small 24B (melhor para codificação agêntica). Para máquinas com 8 GB, Qwen3 8B é a recomendação para hardware limitado. Todos rodam localmente via Ollama.',
      metaDescription: 'Kimi K2 lidera com 58,6 SWE-Bench Pro, Qwen 3.6 27B atinge 77,2% SWE-bench e Devstral 24B vence em código agêntico. VRAM, velocidade e benchmarks no Ollama.',
      publishDate: '2026-04-04',
      dateModified: '2026-06-19',
      leadAnswerBlock: '**Em junho de 2026, os melhores modelos de programação locais são Kimi K2 (58,6 SWE-Bench Pro, MoE, licença MIT modificada) para qualidade máxima, Qwen 3.6 27B (77,2% SWE-bench, melhor modelo denso) para desempenho equilibrado e Devstral Small 24B (melhor para fluxos de trabalho agênticos). Para 8 GB de RAM: Qwen3 8B. Todos rodam via Ollama localmente para geração de código offline, privada e sem custos de API na nuvem.**',
      quickAnswerTop: {
        en: {
          question: 'What is the best local LLM for coding in junho de 2026?',
          answer: 'Kimi K2 is the best overall. Qwen 3.6 27B is best dense model. For 8 GB RAM: Qwen3 8B.',
          bullets: [],
          updatedDate: '2026-05-04',
        },
        pt: {
          question: 'Qual é o melhor LLM local para programação em junho de 2026?',
          answer: 'Kimi K2 (58,6 SWE-Bench Pro, MoE, licença MIT modificada) é o melhor no geral. Qwen 3.6 27B (77,2% SWE-bench) é o melhor modelo denso. Para codificação agêntica: Devstral Small 24B. Para 8 GB de RAM: Qwen3 8B. Todos rodam localmente via Ollama.',
          bullets: [
            'Kimi K2 -- melhor modelo de código no geral, 58,6 SWE-Bench Pro, MoE (32B ativo / 1T total)',
      ...
      toc: [
        ...
        { label: '#1 Kimi K2 -- Melhor modelo de código no geral', anchor: '#kimi-k2' },
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'Os melhores LLMs locais para programação em junho de 2026 são Kimi K2 (58,6 SWE-Bench Pro, MoE, licença Modified MIT) para qualidade máxima e Qwen 3.6 27B (77,2% SWE-bench) para desempenho equilibrado em hardware consumidor.' },
            { type: 'plain-terms', text: 'SWE-bench mede quão bem uma IA corrige bugs reais do GitHub — quanto maior, melhor. Kimi K2 é um modelo de "mistura de especialistas" que ativa apenas 32B de seus 1T de parâmetros por consulta.' },
          ],
          items: [
            '**Melhor no geral (junho 2026):** Kimi K2 -- 58,6 SWE-Bench Pro, MoE (32B ativo / 1T total), licença MIT modificada. Para máquinas com 24+ GB VRAM.',
        ...
        kimi: {
          id: 'kimi-k2',
          title: '#1 Kimi K2 -- Melhor modelo de código local no geral (junho 2026)',
          content: [
            '**Kimi K2 da Moonshot AI lidera com 58,6 no SWE-Bench Pro** -- o benchmark de resolução de issues reais do GitHub. É um modelo MoE com 32B parâmetros ativos de 1T totais, o que significa que roda na velocidade de um modelo 32B mas com qualidade de modelo maior.',
          ...
          rows: [
            ...
            { 'Especificação': 'Comando Ollama', 'Valor': 'ollama run kimi-k2' },
          ],
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Ignorar modelos MoE** -- Kimi K2 (MoE, 32B ativo) roda na velocidade de um modelo 32B mas com qualidade de modelo muito maior. MoE é agora viável localmente.',
      ...
      gammaEmbedUrl: '/presentations/best-local-llms-for-coding-static.html',
      gammaDescription: 'A apresentação cobre: comparação de benchmark SWE-bench e HumanEval, seleção de modelo ajustada ao hardware (8GB, 16GB, 22GB+ VRAM), Kimi K2 (58,6 SWE-Bench Pro) vs Qwen 3.6 27B (77,2% SWE-bench) vs Qwen3 8B (72% HumanEval) e integração IDE com Continue.dev. Baixe o PDF como cartão de referência.',
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'headline': 'Melhores LLMs locais para programação 2026',
        'description': 'Junho 2026: Kimi K2 (58,6 SWE-Bench Pro) é o melhor LLM local para código. Comparado com Qwen 3.6 27B e Devstral 24B.',
    ...
    de: {
      ...
      next_refresh_due: '2026-06-30',
      theme: 'Beste Modelle',
      title: 'Beste lokale LLMs für Programmierung 2026: Kimi K2 vs Qwen vs Devstral',
      seoTitle: 'Beste Coding-LLMs 2026: Kimi K2, Qwen, Devstral',
      intro: 'Die besten lokalen LLMs für Programmierung im Juni 2026 sind Kimi K2 (58.6 SWE-Bench Pro, MoE, Modified MIT-Lizenz), Qwen 3.6 27B (77,2% SWE-bench, bestes dichtes Modell) und Devstral Small 24B (beste agentic Programmierung). Für 8-GB-Maschinen ist Qwen3 8B die Top-Empfehlung (5 GB VRAM). Alle laufen lokal über Ollama.',
      metaDescription: 'Kimi K2 führt mit 58.6 SWE-Bench Pro, Qwen 3.6 27B erreicht 77,2% SWE-bench, Devstral 24B für agentic Coding. VRAM, Tempo und Benchmarks via Ollama.',
      publishDate: '2026-04-04',
      dateModified: '2026-06-19',
      leadAnswerBlock: '**Im Juni 2026 sind die besten lokalen Programmiermodelle Kimi K2 (58.6 SWE-Bench Pro, MoE, Modified MIT-Lizenz) für maximale Qualität, Qwen 3.6 27B (77,2% SWE-bench, bestes dichtes Modell) für ausgewogene Leistung und Devstral Small 24B (beste für Agentic Workflows). Für 8 GB RAM: Qwen3 8B. Alle laufen über Ollama lokal für Offline-, privale Codegenerierung ohne Cloud-API-Kosten.** Im Gegensatz zu HumanEval, das einzelne Funktionen testet, testet SWE-bench (Lösen echter GitHub-Probleme) jetzt die primäre Benchmark für praktisches Programmieren 2026.',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'Die besten lokalen Coding-LLMs im Juni 2026 sind Kimi K2 (58,6 SWE-Bench Pro, MoE, Modified MIT) für maximale Qualität und Qwen 3.6 27B (77,2 % SWE-bench) für ausgewogene Leistung auf Consumer-Hardware.' },
            { type: 'plain-terms', text: 'SWE-bench misst, wie gut eine KI echte GitHub-Bugs behebt — höher ist besser. Kimi K2 ist ein großes „Mixture-of-Experts"-Modell, das pro Anfrage nur 32B von 1T Parametern aktiviert.' },
          ],
          items: [
            '**Bestes Programmiermodell insgesamt**: Kimi K2 — 58.6 SWE-Bench Pro, MoE-Architektur (32B aktiv / 1T insgesamt), Modified MIT-Lizenz. Bestes dichtes Modell: Qwen 3.6 27B — 77,2% SWE-bench.',
        ...
        quickFacts: {
          ...
          items: [
            '**Best insgesamt (maximale Qualität):** Kimi K2 — 58.6 SWE-Bench Pro, MoE (32B aktiv / 1T total), Modified MIT-Lizenz, quantisiert für Consumer-Hardware.',
        ...
        bestModelsQuickPicks: {
          ...
          items: [
            '**Best insgesamt:** Kimi K2 — 58.6 SWE-Bench Pro, MoE (32B aktiv), Modified MIT-Lizenz. Bestes dichtes Modell: Qwen 3.6 27B — 77,2% SWE-bench, 22 GB VRAM.',
        ...
        whichCodingModel: {
          ...
          items: [
            ...
            '**20+ GB RAM (beste Qualität)**: `ollama run kimi-k2` (quantisiert) oder `ollama run qwen3.6:27b` -- Kimi K2 58.6 SWE-Bench Pro, Qwen 3.6 77,2% SWE-bench.',
          ...
          imageCaption: 'Hardware-angepasste Modellauswahl (Juni 2026): 8 GB RAM → Qwen3 8B (5 GB VRAM, verbesserte Programmierung); 16 GB RAM → Devstral Small 24B (16 GB VRAM, agentic Programmierung) oder Qwen 3.6 27B (77,2% SWE-bench); 20+ GB RAM → Kimi K2 quantisiert (58.6 SWE-Bench Pro, beste lokale Qualität).',
        },
        codingLlm8gb: {
          id: 'coding-llm-8gb-vram',
        ...
        userPersonas: {
          ...
          items: [
            ...
            '**Advanced Entwickler (Debugging, Refactoring, komplexes Reasoning):** Ollama + Qwen 3.6 27B (dichtes Modell, konsistentes Reasoning) oder Kimi K2 (quantisiert, maximale Qualität 58.6 SWE-Bench Pro) -- bewältigt Multi-File-Kontext und Algorithmus-Design.',
          ...
          callouts: [
            ...
            { type: 'insight', text: 'Anfänger → Fortgeschrittene → Experte ist auch eine Progression in Hardware-Anforderungen. Starte mit Qwen3 8B (8 GB), upgrade zu Devstral Small 24B (16 GB), wenn du Tools und Workflows hinzufügst, graduiere zu Qwen 3.6 27B oder Kimi K2 (20+ GB) nur wenn du maximale Reasoning-Qualität benötigst.' },
          ],
        },
        whenNotToUse: {
          id: 'when-not-to-use',
        ...
        faqSection: {
          ...
          faqs: [
            { q: 'Was ist das beste lokale LLM für Programmierung 2026?', a: 'Kimi K2 -- 58.6 SWE-Bench Pro (MoE, Modified MIT-Lizenz) ist insgesamt am besten. Bestes dichtes Modell: Qwen 3.6 27B -- 77,2% SWE-bench, 22 GB VRAM. Für agentic Coding: Devstral Small 24B. Für 8-GB-Maschinen: Qwen3 8B.' },
...
schema: {
        ...
        'headline': 'Beste lokale LLMs für Programmierung 2026: Kimi K2 (58.6 SWE-Bench Pro) vs Qwen 3.6',
        'description': 'Juni 2026: Kimi K2 (58.6 SWE-Bench Pro) ist das beste lokale Programmier-LLM. Vergleich mit Qwen 3.6 27B (77,2% SWE-bench) und Devstral 24B. SWE-bench ersetzt HumanEval.',
        'datePublished': '2026-04-04',
        'dateModified': '2026-06-19',
        'author': { '@type': 'Person', 'name': 'Hans Kuepper', 'sameAs': 'https://www.linkedin.com/in/hanskuepper/' },
        'publisher': { '@type': 'Organization', 'name': 'PromptQuorum', 'url': 'https://www.promptquorum.com' },
      ...
      faqSchema: {
        ...
        '@type': 'FAQPage',
        'mainEntity': [
          { '@type': 'Question', 'name': 'Was ist das beste lokale LLM für Programmierung 2026?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Kimi K2 -- 58.6 SWE-Bench Pro (MoE, Modified MIT-Lizenz) ist insgesamt am besten. Bestes dichtes Modell: Qwen 3.6 27B -- 77,2% SWE-bench, 22 GB VRAM. Für agentic Coding: Devstral Small 24B. Für 8-GB-Maschinen: Qwen3 8B.' } },
    ...
    fr: {
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: 'Les meilleurs LLM locaux pour le code en juin 2026 sont Kimi K2 (58,6 SWE-Bench Pro, MoE, licence Modified MIT) pour la qualité maximale et Qwen 3.6 27B (77,2 % SWE-bench) pour les performances équilibrées.' },
            { type: 'plain-terms', text: 'SWE-bench mesure la capacité d\'une IA à corriger de vrais bugs GitHub — plus le score est élevé, mieux c\'est. Kimi K2 est un modèle « mixture-of-experts » qui n\'active que 32B de ses 1T de paramètres par requête.' },
          ],
          items: [
            '**Meilleur modèle de programmation global** : Kimi K2 — 58.6 SWE-Bench Pro, MoE (32B actif / 1T total), licence MIT modifiée. Meilleur modèle dense : Qwen 3.6 27B — 77,2% SWE-bench.',
        ...
        quickFacts: {
          ...
          items: [
            '**Meilleur global (qualité maximale)** : Kimi K2 — 58.6 SWE-Bench Pro, MoE (32B actif / 1T total), licence MIT modifiée, quantifié pour le matériel grand public.',
        ...
        bestModelsQuickPicks: {
          ...
          items: [
            '**Meilleur global** : Kimi K2 — 58.6 SWE-Bench Pro, MoE (32B actif), licence MIT modifiée. Meilleur modèle dense : Qwen 3.6 27B — 77,2% SWE-bench, 22 GB VRAM.',
        ...
        faqSection: {
          ...
          faqs: [
            { q: 'Quel est le meilleur LLM local pour la programmation en 2026?', a: 'Kimi K2 — 58.6 SWE-Bench Pro (MoE, licence MIT modifiée) est le meilleur global. Meilleur modèle dense : Qwen 3.6 27B — 77,2% SWE-bench, 22 GB VRAM. Pour la programmation agentive : Devstral Small 24B. Pour les machines 8 GB : Qwen3 8B.' },
...
schema: {
        ...
        'headline': 'Meilleurs LLMs locaux pour la programmation 2026 : Kimi K2 (58.6 SWE-Bench Pro) vs Qwen 3.6',
        'description': 'Juin 2026 : Kimi K2 (58.6 SWE-Bench Pro) est le meilleur LLM local pour la programmation. Comparé avec Qwen 3.6 27B (77,2% SWE-bench) et Devstral 24B. SWE-bench remplace HumanEval.',
        'datePublished': '2026-04-04',
        'dateModified': '2026-06-19',
        'author': { '@type': 'Person', 'name': 'Hans Kuepper', 'sameAs': 'https://www.linkedin.com/in/hanskuepper/' },
        'publisher': { '@type': 'Organization', 'name': 'PromptQuorum', 'url': 'https://www.promptquorum.com' },
      ...
      faqSchema: {
        ...
        '@type': 'FAQPage',
        'mainEntity': [
          { '@type': 'Question', 'name': 'Quel est le meilleur LLM local pour la programmation en 2026?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Kimi K2 — 58.6 SWE-Bench Pro (MoE, licence MIT modifiée) est le meilleur global. Meilleur modèle dense : Qwen 3.6 27B — 77,2% SWE-bench, 22 GB VRAM. Pour la programmation agentive : Devstral Small 24B. Pour les machines 8 GB : Qwen3 8B.' } },
    ...
    ja: {
      ...
      next_refresh_due: '2026-06-30',
      theme: 'ベストモデル',
      title: '2026年最高のコーディング用ローカルLLM：Kimi K2 vs Qwen vs Devstral',
      seoTitle: 'コーディング向けローカルLLM 2026：Kimi K2・Qwen・Devstral',
      intro: '2026年6月のコーディング用最高のローカルLLMはKimi K2（58.6 SWE-Bench Pro、MoE、Modified MITライセンス）、Qwen 3.6 27B（77.2% SWE-bench、最高の密集モデル）、Devstral Small 24B（最高のエージェントコーディング）です。8GB マシンの場合、Qwen3 8B が以前の Qwen3-Coder 7B の推奨に置き換わります。すべて Ollama 経由でローカルで実行されます。',
      metaDescription: 'Kimi K2は58.6 SWE-Bench Proで首位、Qwen 3.6 27Bは77.2% SWE-bench、Devstral 24Bはエージェントコーディングに最適。VRAM・速度・ベンチマークをOllamaで比較。',
      publishDate: '2026-04-04',
      dateModified: '2026-06-19',
      leadAnswerBlock: '**2026年6月の最高のローカルコーディングモデルはKimi K2（58.6 SWE-Bench Pro、MoE、Modified MIT ライセンス）で最高品質、Qwen 3.6 27B（77.2% SWE-bench、最高の密集モデル）でバランスのとれたパフォーマンス、Devstral Small 24B（エージェントワークフロー最高）です。8GB RAM：Qwen3 8B。すべて Ollama を介してローカルで実行され、クラウド API コストなしのオフライン プライベート コード生成が可能です。** 単一関数をテストする HumanEval とは異なり、SWE-bench（実際の GitHub 問題の解決）は 2026 年の実践的なコーディングの主要ベンチマークです。',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: '2026年6月のベストなローカルコーディングLLMは、最高品質のKimi K2（SWE-Bench Pro 58.6、MoE、Modified MITライセンス）と、コンシューマーハードウェアでバランスの良いQwen 3.6 27B（SWE-bench 77.2%）。' },
            { type: 'plain-terms', text: 'SWE-benchは、AIが実際のGitHubバグをどれだけ修正できるかを測定するスコアです。高いほど良い。Kimi K2はMixture-of-Expertsモデルで、クエリごとに1Tパラメータのうち32Bだけを使用します。' },
          ],
          items: [
            '**最高のコーディングモデル**：Kimi K2――58.6 SWE-Bench Pro、MoE（32B active / 1T total）、Modified MITライセンス。最高の密集モデル：Qwen 3.6 27B――77.2% SWE-bench',
        ...
        quickFacts: {
          ...
          items: [
            '**最高の全体（最大品質）：** Kimi K2――58.6 SWE-Bench Pro、MoE（32B active / 1T total）、Modified MITライセンス、Consumer向けに量子化',
        ...
        bestModelsQuickPicks: {
          ...
          items: [
            '**最高の全体：** Kimi K2――58.6 SWE-Bench Pro、MoE（32B active）、Modified MITライセンス。最高の密集モデル：Qwen 3.6 27B――77.2% SWE-bench、22 GB VRAM',
...
schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        headline: '2026年最高のコーディング用ローカルLLM：Kimi K2（58.6 SWE-Bench Pro）vs Qwen 3.6',
        description: '2026年6月：Kimi K2（58.6 SWE-Bench Pro）はコーディング用最高のローカルLLM。Qwen 3.6 27B（77.2% SWE基準）とDevstral 24Bとの比較。SWE基準がHumanEvalに取って代わります。',
        datePublished: '2026-04-04',
      ...
      faqSchema: {
        ...
        inLanguage: 'ja',
        mainEntity: [
          { '@type': 'Question', 'name': '2026年に最高のコーディング用ローカルLLMは？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Kimi K2――58.6 SWE-Bench Pro（MoE、Modified MITライセンス）が総合的に最高です。最高の密集モデルはQwen 3.6 27B――77.2% SWE-bench、22 GB VRAM。エージェントコーディング：Devstral Small 24B。8 GBマシン用：Qwen3 8B。' } },
    ...
    zh: {
      ...
      next_refresh_due: '2026-06-30',
      theme: '最佳模型',
      title: '2026年最佳本地编码LLM：Kimi K2 vs Qwen vs Devstral',
      seoTitle: '2026年最佳本地编程LLM：Kimi K2、Qwen、Devstral',
      intro: '2026年6月，用于编码的最佳本地LLM是Kimi K2（58.6 SWE-Bench Pro、MoE、修改版MIT许可证）、Qwen 3.6 27B（77.2% SWE基准、最佳密集模型）和Devstral Small 24B（最佳代理编码）。对于8GB机器，Qwen3 8B取代了之前的Qwen3-Coder 7B推荐。所有都通过Ollama本地运行。',
      metaDescription: 'Kimi K2以58.6 SWE-Bench Pro领先，Qwen 3.6 27B达77.2% SWE基准，Devstral 24B最适合代理编码。在Ollama上对比VRAM、速度与基准成绩。',
      publishDate: '2026-04-04',
      dateModified: '2026-06-19',
      leadAnswerBlock: '**2026年6月，最佳本地编码模型是Kimi K2（58.6 SWE-Bench Pro、MoE、修改版MIT许可证）提供最高品质，Qwen 3.6 27B（77.2% SWE基准、最佳密集模型）提供均衡性能，Devstral Small 24B（代理工作流最佳）。8GB RAM：Qwen3 8B。所有通过Ollama本地运行，无云API成本的离线私密代码生成。** 与测试单个函数的HumanEval不同，SWE基准（解决实际GitHub问题）现在是2026年实际编码的主要基准。',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: '2026年6月最佳本地编程LLM：Kimi K2（SWE-Bench Pro 58.6、MoE、Modified MIT许可）质量最高；Qwen 3.6 27B（SWE-bench 77.2%）在消费级硬件上性能均衡。' },
            { type: 'plain-terms', text: 'SWE-bench衡量AI修复真实GitHub漏洞的能力，分数越高越好。Kimi K2是混合专家模型，每次查询只激活1T参数中的32B，在较高精度的同时降低了GPU成本。' },
          ],
          items: [
            '**最佳编码模型**：Kimi K2——58.6 SWE-Bench Pro，MoE（32B active / 1T total），修改版MIT许可证。最佳密集模型：Qwen 3.6 27B——77.2% SWE-bench',
        ...
        quickFacts: {
          ...
          items: [
            '**最佳整体（最大质量）：** Kimi K2——58.6 SWE-Bench Pro、MoE（32B active / 1T total）、修改版MIT许可证、为消费级硬件量化',
        ...
        bestModelsQuickPicks: {
          ...
          items: [
            '**最佳整体：** Kimi K2——58.6 SWE-Bench Pro、MoE（32B active）、修改版MIT许可证。最佳密集模型：Qwen 3.6 27B——77.2% SWE-bench、22 GB VRAM',
...
schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        headline: '2026年最佳本地编码LLM：Kimi K2（58.6 SWE-Bench Pro）vs Qwen 3.6',
        description: '2026年6月：Kimi K2（58.6 SWE-Bench Pro）是最佳本地编码LLM。与Qwen 3.6 27B（77.2% SWE基准）和Devstral 24B对比。SWE基准取代HumanEval。',
        datePublished: '2026-04-04',
        dateModified: '2026-06-03',
      ...
      faqSchema: {
        ...
        inLanguage: 'zh',
        mainEntity: [
          { '@type': 'Question', 'name': '2026年最佳本地编码LLM是什么？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Kimi K2——58.6 SWE-Bench Pro（MoE、修改版MIT许可证）综合最佳。最佳密集模型为Qwen 3.6 27B——77.2% SWE-bench、22 GB VRAM。代理编码：Devstral Small 24B。8 GB机器：Qwen3 8B。' } },
  ...
  ko: {
      ...
      current_models_mentioned: ['Kimi K2', 'Qwen 3.6 27B', 'Devstral Small 24B', 'Codestral 22B', 'qwen3-coder:30b', 'gpt-oss:20b', 'Qwen3 8B'],
      theme: '최고의 모델',
      title: '2026 최고의 코딩 로컬 LLM: Kimi K2 vs Qwen vs Devstral',
      seoTitle: '2026년 최고의 로컬 코딩 LLM: Qwen vs DeepSeek vs Llama',
      intro: '2026년 6월 기준 코딩에 최적화된 로컬 LLM은 Kimi K2(SWE-Bench Pro 58.6점, MoE 아키텍처, Modified MIT 라이선스), Qwen 3.6 27B(SWE-bench 77.2%, 최고의 밀집형 모델), Devstral Small 24B(에이전트 코딩에 최적)입니다. 8GB 메모리 환경에서는 Qwen3 8B가 권장 모델입니다. 모든 모델은 Ollama를 통해 로컬에서 실행됩니다.',
      ...
      publishDate: '2026-04-04',
      leadAnswerBlock: '**2026년 6월 기준 최고의 로컬 코딩 모델은 최대 품질을 위한 Kimi K2(SWE-Bench Pro 58.6점, MoE 아키텍처, Modified MIT 라이선스), 균형 잡힌 성능을 위한 Qwen 3.6 27B(SWE-bench 77.2%, 최고의 밀집형 모델), 에이전트 워크플로우를 위한 Devstral Small 24B입니다. 8GB RAM 환경에서는 Qwen3 8B가 권장됩니다. 모든 모델은 Ollama를 통해 로컬에서 실행되므로 클라우드 API 비용 없이 오프라인으로 비공개 코드 생성이 가능합니다.** 단일 함수만 테스트하는 HumanEval과 달리, SWE-bench(실제 GitHub 이슈 해결 능력 평가)는 2026년 실무 코딩의 주요 벤치마크로 자리 잡았습니다.',
      quickAnswerTop: {
        ko: {
          question: '2026년 6월 기준 코딩에 가장 적합한 로컬 LLM은 무엇입니까?',
          answer: 'Kimi K2(SWE-Bench Pro 58.6점, MoE 아키텍처, Modified MIT 라이선스)이 전반적으로 최고입니다. Qwen 3.6 27B(SWE-bench 77.2%)는 최고의 밀집형 모델입니다. 에이전트 코딩에는 Devstral Small 24B, 8GB RAM 환경에는 Qwen3 8B, IDE 자동 완성에는 Codestral 22B를 사용하십시오. 모든 모델은 Ollama를 통해 로컬에서 실행됩니다.',
          bullets: [
            'Kimi K2 — 전체 최고 코딩 모델, SWE-Bench Pro 58.6점, MoE (32B 활성 / 1T 전체)',
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          snippetBlocks: [
            { type: 'one-sentence', text: '2026년 6월 최고의 로컬 코딩 LLM: 최대 품질을 위한 Kimi K2(SWE-Bench Pro 58.6, MoE, Modified MIT 라이선스)과 소비자용 하드웨어에서 균형 잡힌 성능의 Qwen 3.6 27B(SWE-bench 77.2%).' },
            { type: 'plain-terms', text: 'SWE-bench는 AI가 실제 GitHub 버그를 얼마나 잘 수정하는지 측정합니다 — 높을수록 좋습니다. Kimi K2은 쿼리당 1T 파라미터 중 32B만 활성화하는 전문가 혼합 모델입니다.' },
          ],
          items: [
            '**전체 최고 코딩 모델**: Kimi K2 — SWE-Bench Pro 58.6점, MoE 아키텍처 (32B 활성 / 1T 전체), Modified MIT 라이선스. 최고의 밀집형 모델: Qwen 3.6 27B — SWE-bench 77.2%.',
        ...
        quickFacts: {
          ...
          items: [
            '**전체 최고 (최대 품질):** Kimi K2 — SWE-Bench Pro 58.6점, MoE (32B 활성), Modified MIT 라이선스. 일반 소비자 하드웨어에서 사용하려면 양자화 필요.',
            ...
            '**고성능 사양:** 20 GB 이상 (양자화된 Kimi K2 또는 최고 품질을 위한 Qwen3-Coder 32B 실행 가능).',
          ],
        },
        bestModelsQuickPicks: {
          id: 'best-models-quick-picks',
          ...
          items: [
            '**전체 최고:** Kimi K2 (양자화) — SWE-Bench Pro 58.6점, MoE 아키텍처, Modified MIT 라이선스. `ollama run kimi-k2`',
            ...
            '👉 **최대 품질 (20 GB 이상):** 오프라인 기능을 위해 양자화된 Kimi K2 또는 Qwen3-Coder 32B를 사용하십시오.',
          ],
          callouts: [
            { type: 'practice', text: '먼저 하드웨어에 맞는 모델 크기를 선택하십시오. 8 GB의 경우 Qwen3 8B를, 16 GB 이상의 경우 Qwen 3.6 27B 또는 Devstral Small 24B를, 20 GB 이상의 경우 최고의 실제 성능을 위해 Kimi K2 (양자화)을 사용하십시오. 메모리 부족으로 실행이 불가능한 대형 모델을 내려받는 데 시간을 낭비하지 마십시오.' },
          ],
        },
        inOneSentence: {
          id: 'in-one-sentence',
          title: '한 문장으로',
          content: ['2026년 6월 기준 최고의 로컬 코딩 모델은 최대 품질을 위한 Kimi K2(SWE-Bench Pro 58.6점, MoE), 최고의 밀집형 모델인 Qwen 3.6 27B(SWE-bench 77.2%), 그리고 8 GB RAM 환경을 위한 Qwen3 8B입니다.'],
        },
        plainTerms: {
          id: 'in-plain-terms',
          title: '쉬운 말로',
        ...
        whatMakesGood: {
          ...
          content: [
            '**2026년에는 SWE-bench가 실용적 코딩의 1차 벤치마크로 HumanEval을 대부분 대체했습니다.** SWE-bench는 단순한 함수 생성이 아니라 실제 GitHub 이슈 해결 능력, 즉 멀티파일 변경, 코드베이스 이해, 테스트 작성을 평가합니다. Qwen 3.6 27B는 SWE-bench에서 77.2%를, Kimi K2는 SWE-Bench Pro에서 58.6점을 기록했습니다.',
        ...
        qwen25coder32: {
          title: '#1 Kimi K2 — 전체 최고 로컬 코딩 LLM',
          content: [
            '**Kimi K2 (Moonshot AI)는 2026년 6월 기준 로컬에서 실행 가능한 최고 성능의 코딩 모델입니다.** SWE-Bench Pro에서 58.6점을 기록하며 Tier A에 처음 진입한 비서구권 모델입니다. 총 1T 파라미터 중 32B가 활성화되는 MoE 아키텍처를 사용합니다. Modified MIT 라이선스로 상업적 이용이 허용됩니다.',
            '`ollama run kimi-k2`으로 실행 가능합니다. 일반 소비자 하드웨어에서는 양자화가 권장됩니다. 멀티파일 편집, 세션 기반 멀티턴 코딩, API 사용 정확도에서 강점을 보입니다. 복잡한 리팩토링 및 알고리즘 설계 작업에서 최첨단 클라우드 모델에 필적하는 품질을 제공합니다.',
          ],
          callouts: [
            { type: 'insight', text: 'Kimi K2은 MoE 아키텍처를 사용합니다. 토큰당 활성화되는 파라미터는 1T가 아닌 32B입니다. 따라서 총 파라미터 수가 시사하는 것보다 빠르고 효율적입니다. MoE 모델은 밀집형 70B 모델이 필요로 하는 하드웨어에서 실행됩니다.' },
          ],
          rows: [
            ...
            { 'Spec': 'Ollama 명령어', 'Value': 'ollama run kimi-k2' },
          ],
          columns: ['Spec', 'Value'],
        },
        deepseek: {
        ...
        humanEvalTable: {
          ...
          rows: [
            { 'Model': 'Kimi K2 (MoE)', 'HumanEval': '—', 'SWE-bench': '58.6 (SWE-Bench Pro)', 'RAM': '다양 (양자화)', 'FIM': '—' },
        ...
        codingExamples: {
          ...
          numberedItems: [
            '**Python 함수 디버깅** — Kimi K2 (SWE-Bench Pro 58.6점)은 버그(오프바이원 루프 조건)를 1–2회의 응답으로 찾아냅니다. Qwen 3.6 27B (SWE-bench 77.2%)는 2–3번의 시도로 해결합니다. Codestral 22B는 정확한 감지를 위해 재표현이 필요합니다. **승자:** 디버깅 정확도와 속도에서 Kimi K2.',
            '**멀티파일 코드 리팩토링** — Qwen 3.6 27B는 27B 파라미터 전체가 활성화(밀집형 모델)되어 멀티파일 변경에 탁월합니다. Kimi K2 (MoE)는 토큰마다 다르게 라우팅되지만 더 빠르게 유사한 결과를 냅니다. Devstral Small 24B는 툴 콜링을 통한 멀티파일 워크플로우를 위해 특별히 설계되었습니다. **승자:** 일관된 멀티파일 추론에서 Qwen 3.6 27B.',
            '**FIM / IDE 자동 완성 (VS Code)** — Codestral 22B와 Qwen3 8B (Continue.dev 경유) 모두 커서 양쪽 맥락을 활용해 멀티라인 함수 본문을 정확하게 완성합니다. Kimi K2는 FIM을 지원하지 않습니다(훈련되지 않음). **승자:** IDE 통합에서 Codestral 22B와 Qwen3 8B.',
            '**TypeScript 타입 추론** — Kimi K2는 유니온 타입과 제네릭 제약 조건을 올바르게 추론합니다. Qwen 3.6 27B는 타입 추론 작업에서 85% 이상의 정확도를 기록합니다. Qwen3 8B는 복잡한 타입 정제 프롬프트의 15% 이상에서 실패합니다. **승자:** 복잡한 타입 시스템과 멀티파일 타입 추적에서 Kimi K2.',
          ],
          callouts: [
            { type: 'insight', text: '실제 코딩 작업(SWE-bench)에서는 대형 모델이 유리합니다. Kimi K2 (SWE-Bench Pro 58.6점)과 Qwen 3.6 27B (SWE-bench 77.2%)는 실용적인 디버깅과 리팩토링에서 Qwen3 8B보다 약 5–10% 더 높은 점수를 기록합니다. 일상적인 스크립팅에서는 격차가 크게 좁혀집니다.' },
          ],
        },
        speedQualityTable: {
          id: 'speed-quality-table',
          ...
          rows: [
            { 'Task': 'REST API 생성 (100줄 보일러플레이트)', 'Kimi K2': '18–32 tok/sec | ✓ 올바른 라우트 + 오류 처리', 'Qwen 3.6 27B': '12–18 tok/sec | ✓ 올바른 라우트', 'Qwen3 8B': '30–45 tok/sec | ⚠️ 유효성 검사 누락', 'Codestral 22B': '28–38 tok/sec | ⚠️ 일반적인 출력' },
            { 'Task': 'SQL 쿼리 디버깅 (복잡한 JOIN)', 'Kimi K2': '15–25 tok/sec | ✓ 올바른 인덱스 + 최적화 힌트', 'Qwen 3.6 27B': '12–20 tok/sec | ✓ 올바른 인덱스', 'Qwen3 8B': '20–30 tok/sec | ⚠️ 부분적 해결', 'Codestral 22B': '18–28 tok/sec | ✗ 잘못된 인덱스' },
            { 'Task': '단위 테스트 작성 (3–5개 테스트 케이스)', 'Kimi K2': '16–28 tok/sec | ✓ 엣지 케이스 + 보안 커버리지', 'Qwen 3.6 27B': '14–22 tok/sec | ✓ 양호한 커버리지', 'Qwen3 8B': '28–40 tok/sec | ⚠️ 정상 경로만', 'Codestral 22B': '25–35 tok/sec | ⚠️ 정상 경로만' },
            { 'Task': 'FIM 자동 완성 (커서 중간)', 'Kimi K2': 'N/A (FIM 미지원)', 'Qwen 3.6 27B': 'N/A (최적화 안됨)', 'Qwen3 8B': '50+ tok/sec | ✓ 정확 (FIM)', 'Codestral 22B': '60+ tok/sec | ✓ 가장 빠르고 정확한 FIM' },
          ],
          columns: ['Task', 'Kimi K2', 'Qwen 3.6 27B', 'Qwen3 8B', 'Codestral 22B'],
          callouts: [
            { type: 'tip', text: '**핵심 인사이트:** Kimi K2와 Qwen 3.6 27B는 추론 작업(디버깅, SQL 최적화, 보안)에서 더 느리지만 정확합니다. Qwen3 8B는 생성 작업(API 보일러플레이트, 테스트 스캐폴딩)에서 더 빠릅니다. IDE 자동 완성에는 FIM 최적화 모델(Codestral 22B, Qwen3 8B)만 사용하십시오.' },
        ...
        whichCodingModel: {
          ...
          items: [
            ...
            '**20 GB 이상 RAM (최고 품질)**: `ollama run kimi-k2` (양자화) 또는 `ollama run qwen3.6:27b` — Kimi K2 SWE-Bench Pro 58.6점, Qwen 3.6 SWE-bench 77.2%.',
          ...
          image: '/images/best-local-llms-for-coding-hardware-selection-en.svg',
          imageCaption: '하드웨어 맞춤 모델 선택 (2026년 6월): 8 GB RAM → Qwen3 8B (VRAM 5 GB, 향상된 코딩); 16 GB RAM → Devstral Small 24B (VRAM 16 GB, 에이전트 코딩) 또는 Qwen 3.6 27B (SWE-bench 77.2%); 20 GB 이상 RAM → 양자화된 Kimi K2 (SWE-Bench Pro 58.6점, 최고 로컬 품질).',
        },
        codingLlm8gb: {
          id: 'coding-llm-8gb-vram',
        ...
        userPersonas: {
          ...
          items: [
            ...
            '**고급 개발자 (디버깅, 리팩토링, 복잡한 추론):** Ollama + Qwen 3.6 27B (밀집형 모델, 일관된 추론) 또는 Kimi K2 (양자화, SWE-Bench Pro 58.6점 최고 품질) — 멀티파일 맥락과 알고리즘 설계 처리.',
          ...
          callouts: [
            ...
            { type: 'insight', text: '초보자 → 중급자 → 고급자는 하드웨어 요구사항의 진행이기도 합니다. Qwen3 8B (8 GB)로 시작하고, 도구와 워크플로우가 늘어남에 따라 Devstral Small 24B (16 GB)로 업그레이드하며, 최고의 추론 품질이 필요할 때만 Qwen 3.6 27B 또는 Kimi K2 (20 GB 이상)으로 진행하십시오.' },
          ],
        },
        whenNotToUse: {
          id: 'when-not-to-use',
        ...
        comparisonDecision: {
          ...
          rows: [
            { 'Model': 'Kimi K2 (양자화)', 'Best For': '최대 로컬 품질, 실제 환경 벤치마크', 'VRAM': '다양 (양자화)', 'Speed': '15–25 tok/sec', 'Strength': 'SWE-Bench Pro 58.6점, MoE (32B 활성 / 1T 전체), Modified MIT 라이선스', 'When to Pick': '디버깅/리팩토링을 위한 최대 로컬 품질과 오프라인 기능이 필요할 때' },
          ...
          columns: ['Model', 'Best For', 'VRAM', 'Speed', 'Strength', 'When to Pick'],
          content: [
            '**어떤 코딩 모델을 선택해야 할지 모르겠습니까?** PromptQuorum을 사용하면 하나의 프롬프트를 여러 모델(Kimi K2, Qwen 3.6, Devstral, GPT-5.5, Claude)에 동시에 전송하고 실제 코드에 대한 나란히 보기 출력, 실제 응답 시간, 정확도를 확인할 수 있습니다. [PromptQuorum 무료 체험 — 5분, 회원가입 불필요](https://www.promptquorum.com/).',
          ],
        },
        regionalContext: {
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**총 파라미터 수가 너무 커 보인다고 MoE 모델을 무시하는 것:** Kimi K2는 총 1T 파라미터를 갖지만 토큰당 32B만 활성화됩니다. MoE 모델은 총 파라미터 수가 시사하는 것보다 빠르고 VRAM을 적게 사용합니다. 1T MoE 모델은 밀집형 70B 모델이 필요로 하는 하드웨어에서 실행될 수 있습니다.',
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[연쇄적 사고 프롬프팅](/prompt-engineering/chain-of-thought-prompting) — Kimi K2와 Qwen3에서 디버깅 출력 품질 향상',
            ...
            '[LLM 양자화 설명](/local-llms/llm-quantization-explained) — 다양한 양자화 수준에서 Kimi K2와 Qwen 3.6의 RAM 요구사항',
        ...
        faqSection: {
          ...
          title: '자주 묻는 질문',
          faqs: [
            { q: '2026년 6월 기준 코딩에 가장 적합한 로컬 LLM은 무엇입니까?', a: 'Kimi K2 — SWE-Bench Pro 58.6점 (MoE, Modified MIT 라이선스). 최고의 밀집형 모델: Qwen 3.6 27B — SWE-bench 77.2%, VRAM 22 GB. 8 GB 환경: Qwen3 8B. IDE 자동 완성: Codestral 22B.' },
            ...
            { q: '로컬 LLM이 코딩에서 GPT-5.5를 대체할 수 있습니까?', a: '아니오. 로컬 모델(Kimi K2 SWE-Bench Pro 58.6점, Qwen 3.6 27B SWE-bench 77.2%)은 다음에서 뒤처집니다: 최신 프레임워크 지식 (학습 마감일 이후 API), 대형 코드베이스 복잡한 멀티파일 추론 (100k+ 토큰), 디버깅 정확도. 그러나 Kimi K2와 Qwen 3.6는 멀티파일 코딩 작업에서 격차를 크게 좁혔습니다.' },
            ...
            { q: '로컬 코딩 모델을 SQL 생성에 사용할 수 있습니까?', a: '예 — Qwen 3.6 27B와 Kimi K2 모두 SQL 생성 작업에서 우수한 성능을 보입니다. 프롬프트 컨텍스트에 테이블 스키마를 포함하십시오. 복잡한 멀티조인 쿼리에는 전체 스키마를 포함하기 위해 32K 컨텍스트를 사용하십시오. 시스템 프롬프트를 설정하십시오: "당신은 전문 SQL 개발자입니다. 유효한 SQL만 생성하십시오."' },
            ...
            { q: 'Kimi K2란 무엇이며 사용해도 안전합니까?', a: 'Kimi K2는 Modified MIT 라이선스로 출시된 Moonshot AI (중국)의 오픈소스 코딩 모델입니다. MoE 아키텍처 (32B 활성 / 1T 전체 파라미터)를 사용하며 SWE-Bench Pro에서 58.6점을 기록했습니다. Ollama를 통해 로컬에서 실행 시 데이터가 외부로 전송되지 않습니다 — 모델의 출신지에 관계없이 코드가 시스템에 남습니다. Modified MIT 라이선스는 상업적 이용을 허용합니다.' },
        ...
        sources: {
          ...
          title: '출처',
          items: [
            '**Moonshot AI. (2026).** "Kimi K2" — MoE 아키텍처, Modified MIT 라이선스, SWE-Bench Pro',
