    ...
    en: {
      ...
      sections: {
        ...
        codingExamples: {
          ...
          numberedItems: [
            '**Python function debugging** -- Qwen2.5-Coder 32B identifies the bug (off-by-one loop condition) in 1–2 responses. DeepSeek-Coder V2 Lite solves it in 2–3 passes. Codestral 22B requires rephrasing the bug description for accurate detection. **Winner:** Qwen2.5-Coder for debugging accuracy.',
            '**SQL query optimization** -- Given a table schema and a slow JOIN, Qwen2.5-Coder 32B and DeepSeek-Coder V2 Lite both suggest the correct index. Qwen3 8B suggests a partial index but misses the composite key optimization. **Winner:** 32B/V2 Lite for complex schema reasoning.',
            '**FIM / IDE autocomplete (VS Code)** -- Codestral 22B and Qwen3 8B (via Continue.dev) both complete multi-line function bodies accurately from context on both sides of the cursor. Llama 3.1 8B cannot perform FIM. **Winner:** Starcoder2 and Qwen3 8B for IDE integration.',
        ...
        speedQualityTable: {
          ...
          rows: [
            { 'Task': 'Generate REST API (100-line boilerplate)', 'Qwen2.5-Coder 32B': '20–40 tok/sec | ✓ Correct routes', 'DeepSeek V2 Lite': '25–35 tok/sec | ✓ Correct routes', 'Qwen3 8B': '30–45 tok/sec | ⚠️ Missing validation', 'Codestral 22B': '28–38 tok/sec | ⚠️ Generic output' },
            { 'Task': 'Debug SQL query (complex JOIN)', 'Qwen2.5-Coder 32B': '12–20 tok/sec | ✓ Correct index', 'DeepSeek V2 Lite': '15–25 tok/sec | ✓ Correct index', 'Qwen3 8B': '20–30 tok/sec | ⚠️ Partial solution', 'Codestral 22B': '18–28 tok/sec | ✗ Wrong index' },
            { 'Task': 'Write unit tests (3–5 test cases)', 'Qwen2.5-Coder 32B': '18–32 tok/sec | ✓ Edge case coverage', 'DeepSeek V2 Lite': '22–28 tok/sec | ✓ Good coverage', 'Qwen3 8B': '28–40 tok/sec | ⚠️ Happy path only', 'Codestral 22B': '25–35 tok/sec | ⚠️ Happy path only' },
            { 'Task': 'FIM autocomplete (cursor mid-line)', 'Qwen2.5-Coder 32B': 'N/A (not optimized)', 'DeepSeek V2 Lite': 'N/A (not optimized)', 'Qwen3 8B': '50+ tok/sec | ✓ Accurate (FIM)', 'Codestral 22B': '60+ tok/sec | ✓ Fastest FIM' },
          ],
          columns: ['Task', 'Qwen2.5-Coder 32B', 'DeepSeek V2 Lite', 'Qwen3 8B', 'Codestral 22B'],
          callouts: [
        ...
        whichCodingModel: {
          ...
          items: [
            ...
            '**IDE autocomplete in VS Code**: Codestral 22B via Continue.dev -- FIM-optimized for cursor position completion.',
            '**Already running Llama 3.1 8B**: skip downloading a separate model -- coding quality is equivalent to Qwen3 8B for everyday tasks.',
          ],
          callouts: [
            { type: 'practice', text: 'Match model size to your hardware first, then optimize for your use case. If you have 8 GB, Qwen3 8B is the best choice. Do not waste time downloading larger models that will OOM. Better to have a model that runs than the perfect model that crashes.' },
          ],
          image: '/images/best-local-llms-for-coding-hardware-selection-en.svg',
          imageCaption: 'Hardware-matched model selection: 8 GB RAM → Qwen3 8B (72% HumanEval, 4.7 GB used); 16 GB RAM → DeepSeek-Coder V2 16B (81% HumanEval, 10 GB used); 20+ GB RAM → Qwen2.5-Coder 32B (87% HumanEval, highest quality).',
        },
        userPersonas: {
          id: 'user-personas',
          title: '🧭 Who Should Use What: Personas and Recommendations',
          items: [
            '**Beginner (no local LLM experience):** [LM Studio](/local-llms/how-to-install-lm-studio) + Qwen3 8B -- GUI, no terminal needed, includes FIM for code completion.',
            '**Laptop developer (8–16 GB RAM, everyday coding):** Ollama + Qwen3 8B or DeepSeek-Coder V2 Lite -- balanced quality and performance, runs smoothly for hours.',
            ...
            '**IDE-first workflow (VS Code, Cursor, JetBrains):** Continue.dev + Codestral 22B -- FIM-optimized for in-editor code completion at cursor position.',
          ...
          callouts: [
            { type: 'warning', text: '❌ **Avoid:** Running Qwen2.5-Coder 32B on machines with <20 GB free RAM. Latency becomes unusable (1–3 tokens/sec). Either use Qwen3 8B or DeepSeek-Coder V2 Lite on smaller machines.' },
        ...
        comparisonDecision: {
          ...
          rows: [
            { 'Model': 'Kimi K2.6 (quantized)', 'Best For': 'Maximum local quality, real-world benchmarks', 'VRAM': 'varies (quantized)', 'Speed': '12-20 tok/sec', 'Strength': '87/100 real-world, MoE (42B active / 1T total), MIT license', 'When to Pick': 'You need maximum local quality and offline capability' },
            { 'Model': 'Qwen 3.6 27B', 'Best For': 'Best dense model, multi-file reasoning', 'VRAM': '~22 GB', 'Speed': '10-18 tok/sec', 'Strength': '77.2% SWE-bench, all parameters active, consistent reasoning', 'When to Pick': 'You have 22+ GB RAM and want predictable performance' },
...
schema: {
    ...
    de: {
      ...
      metaDescription: 'Beste LLMs für Coding 2026: Qwen2.5-Coder 32B (87 %), DeepSeek-Coder V2 Lite (81 %), Qwen3 8B (72 %). Ollama-Setup inklusive.',
      publishDate: '2026-04-04',
      ...
      sections: {
        ...
        whichCodingModel: {
          ...
          items: [
            ...
            '**IDE-Autovervollständigung in VS Code**: Codestral 22B über Continue.dev -- FIM-optimiert für Cursor-Position-Completion.',
            '**Llama 3.1 8B läuft bereits**: überspringe den Download eines separaten Modells -- Programmierqualität ist äquivalent zu Qwen3 8B für Alltagsaufgaben.',
          ],
          callouts: [
            { type: 'practice', text: 'Passe die Modellgröße zuerst an deine Hardware an, dann optimiere für deinen Use-Case. Wenn du 8 GB hast, ist Qwen3 8B die beste Wahl. Verschwende keine Zeit mit dem Download größerer Modelle, die den Speicher überlasten werden. Besser ein Modell, das läuft, als das perfekte Modell, das abstürzt.' },
          ],
          image: '/images/best-local-llms-for-coding-hardware-selection-de.svg',
          imageCaption: 'Hardware-angepasste Modellauswahl: 8 GB RAM → Qwen3 8B (72% HumanEval, 4,7 GB genutzt); 16 GB RAM → DeepSeek-Coder V2 16B (81% HumanEval, 10 GB genutzt); 20+ GB RAM → Qwen2.5-Coder 32B (87% HumanEval, höchste Qualität).',
        },
        userPersonas: {
          id: 'user-personas',
          title: '🧭 Wer sollte was verwenden: Personas und Empfehlungen',
          items: [
            '**Anfänger (keine Erfahrung mit lokalem LLM):** [LM Studio](/local-llms/how-to-install-lm-studio?lang=de) + Qwen3 8B -- GUI, kein Terminal nötig, beinhaltet FIM für Code-Completion.',
            '**Laptop-Entwickler (8–16 GB RAM, Alltagsprogrammierung):** Ollama + Qwen3 8B oder DeepSeek-Coder V2 Lite -- ausgewogene Qualität und Performance, läuft stundenlang reibungslos.',
            ...
            '**IDE-First-Workflow (VS Code, Cursor, JetBrains):** Continue.dev + Codestral 22B -- FIM-optimiert für Code-Completion im In-Editor bei Cursor-Position.',
          ...
          callouts: [
            { type: 'warning', text: '❌ **Vermeiden:** Qwen2.5-Coder 32B auf Maschinen mit <20 GB freiem RAM laufen lassen. Latenz wird unbrauchbar (1–3 Tokens/Sek.). Verwende entweder Qwen3 8B oder DeepSeek-Coder V2 Lite auf kleineren Maschinen.' },
...
schema: {
        ...
        'description': 'Die besten lokalen LLMs für Programmierung im Jahr 2026 sind Qwen2.5-Coder 32B (87% HumanEval), DeepSeek-Coder V2 Lite (81%) und Qwen3 8B (72%). Alle drei laufen lokal über Ollama.',
        'datePublished': '2026-04-04',
        'dateModified': '2026-04-18',
        'author': { '@type': 'Person', 'name': 'Hans Kuepper', 'sameAs': 'https://www.promptquorum.com/author/hans-kuepper' },
        'publisher': { '@type': 'Organization', 'name': 'PromptQuorum', 'url': 'https://www.promptquorum.com' },
    ...
    fr: {
      ...
      metaDescription: 'Meilleurs LLMs pour le code 2026 : Qwen2.5-Coder 32B (87 % HumanEval), DeepSeek V2 Lite (81 %), Qwen3 8B (72 %). Configuration Ollama incluse.',
      publishDate: '2026-04-04',
...
schema: {
        ...
        'description': 'En 2026, les meilleurs LLMs locaux pour la programmation sont Qwen2.5-Coder 32B (87% HumanEval), DeepSeek-Coder V2 Lite (81%) et Qwen3 8B (72%). Tous trois s\'exécutent localement via Ollama.',
        'datePublished': '2026-04-04',
        'dateModified': '2026-04-18',
        'author': { '@type': 'Person', 'name': 'Hans Kuepper', 'sameAs': 'https://www.promptquorum.com/author/hans-kuepper' },
        'publisher': { '@type': 'Organization', 'name': 'PromptQuorum', 'url': 'https://www.promptquorum.com' },
    ...
    ja: {
      ...
      metaDescription: '2026年コーディング最強ローカルLLM：Qwen2.5-Coder 32Bが87% HumanEval、DeepSeek-Coder V2 Liteが81%、Qwen3 8Bが72%。VRAM要件とOllama設定付き。',
      publishDate: '2026-04-04',
...
schema: {
        ...
        description: '2026年最高のコーディング用ローカルLLM：Qwen2.5-Coder 32B（87% HumanEval）、DeepSeek-Coder V2 Lite（81%）、Qwen3 8B（72%）。Ollama設定を含む。',
        datePublished: '2026-04-04',
        dateModified: '2026-04-18',
    ...
    zh: {
      ...
      metaDescription: '2026年最佳本地编程LLM：Qwen2.5-Coder 32B达87% HumanEval，DeepSeek-Coder V2 Lite为81%，Qwen3 8B为72%。含VRAM要求与Ollama配置指南。',
      publishDate: '2026-04-04',
...
schema: {
        ...
        description: '2026年最佳本地编码LLM：Qwen2.5-Coder 32B（87% HumanEval）、DeepSeek-Coder V2 Lite（81%）、Qwen3 8B（72%）。含Ollama设置。',
        datePublished: '2026-04-04',
        dateModified: '2026-04-18',
