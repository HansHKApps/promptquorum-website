...
schema: {
    ...
    es: {
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'NewsArticle',
        'url': 'https://www.promptquorum.com/es/es/local-llms/best-local-llms-for-coding',
      ...
      itemListSchema: {
        ...
        'numberOfItems': 5,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'Kimi K2.6', 'description': '58.6 SWE-Bench Pro. MoE (32B activos / 1T total). Licencia MIT modificada. Mejor en general. ollama run kimi-k2.6', 'url': 'https://www.promptquorum.com/es/es/local-llms/best-local-llms-for-coding#qwen25-coder-32b' },
          { '@type': 'ListItem', 'position': 2, 'name': 'Qwen 3.6 27B', 'description': '77,2% SWE-bench. 22 GB VRAM. Mejor modelo denso. Soporte FIM. ollama run qwen3.6:27b', 'url': 'https://www.promptquorum.com/es/es/local-llms/best-local-llms-for-coding#deepseek-coder-v2' },
          { '@type': 'ListItem', 'position': 3, 'name': 'Qwen3 8B', 'description': '72% HumanEval. 4,7 GB RAM. Mejor para máquinas de 8 GB. FIM. ollama run qwen2.5-coder:7b', 'url': 'https://www.promptquorum.com/es/es/local-llms/best-local-llms-for-coding#qwen25-coder-7b' },
          { '@type': 'ListItem', 'position': 4, 'name': 'Codestral 22B', 'description': '67% HumanEval. Mejor autocompletado FIM. 9 GB RAM. 600+ lenguajes.', 'url': 'https://www.promptquorum.com/es/es/local-llms/best-local-llms-for-coding#starcoder2-15b' },
          { '@type': 'ListItem', 'position': 5, 'name': 'Llama 3.3 8B', 'description': '72% HumanEval. 5,5 GB RAM. Alternativa general. ollama run llama3.2', 'url': 'https://www.promptquorum.com/es/es/local-llms/best-local-llms-for-coding#llama-31-8b' },
        ],
      },
      gammaEmbedUrl: '/presentations/best-local-llms-for-coding-static.html',
