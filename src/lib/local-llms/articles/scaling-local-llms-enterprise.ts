    ...
    en: {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            '[Enterprise LLM Inference Servers 2026](/power-local-llm/enterprise-llm-inference-servers-vllm-tgi-nim) -- vLLM, TGI, and NVIDIA NIM compared for multi-GPU, multi-tenant serving infrastructure.',
            ...
            '[Enterprise GPU Server Buying Guide 2026](/local-llms/enterprise-gpu-server-buying-guide) -- Dell, Lenovo, HPE, and Supermicro rack-scale GPU servers compared for the hardware procurement behind this rollout.',
          ],
        },
        sources: {
          id: 'sources',
    ...
    es: {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            '[Servidores de inferencia LLM empresarial 2026](/es/power-local-llm/enterprise-llm-inference-servers-vllm-tgi-nim) -- vLLM, TGI y NVIDIA NIM comparados para infraestructura de servicio multi-GPU y multiusuario.',
    ...
    ar: {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            '[خوادم استدلال LLM للمؤسسات 2026](/ar/power-local-llm/enterprise-llm-inference-servers-vllm-tgi-nim) -- مقارنة vLLM وTGI وNVIDIA NIM كبنية تحتية للخدمة متعددة وحدات المعالجة الرسومية والمستأجرين.',
    ...
    pt: {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            '[Servidores de inferência LLM para empresas 2026](/pt/power-local-llm/enterprise-llm-inference-servers-vllm-tgi-nim) — vLLM, TGI e NVIDIA NIM comparados para serving multi-GPU e multiusuário.',
    ...
    de: {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            '[Enterprise-LLM-Inferenzserver 2026](/de/power-local-llm/enterprise-llm-inference-servers-vllm-tgi-nim) -- vLLM, TGI und NVIDIA NIM im Vergleich für Multi-GPU-Mehrnutzer-Serving-Infrastruktur.',
    ...
    fr: {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            '[Serveurs d\'inférence LLM en entreprise 2026](/fr/power-local-llm/enterprise-llm-inference-servers-vllm-tgi-nim) -- vLLM, TGI et NVIDIA NIM comparés pour une infrastructure de serving multi-GPU et multi-utilisateurs.',
    ...
    ja: {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          title: '関連資料',
          items: [
            '[エンタープライズLLM推論サーバー2026](/ja/power-local-llm/enterprise-llm-inference-servers-vllm-tgi-nim) -- マルチGPU・マルチテナントのサービング基盤としてvLLM・TGI・NVIDIA NIMを比較。',
    ...
    zh: {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          title: '相关阅读',
          items: [
            '[企业级LLM推理服务器2026](/zh/power-local-llm/enterprise-llm-inference-servers-vllm-tgi-nim) -- 从多GPU、多租户服务基础设施角度比较vLLM、TGI和NVIDIA NIM。',
    ...
    heroImage: '/images/scaling-local-llms-enterprise-overview-hero-ko.webp',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          title: '관련 자료',
          items: [
            '[엔터프라이즈 LLM 추론 서버 2026](/ko/power-local-llm/enterprise-llm-inference-servers-vllm-tgi-nim) -- 멀티 GPU, 다중 테넌트 서빙 인프라 관점에서 vLLM, TGI, NVIDIA NIM을 비교합니다.',
