...
schema: {
    ...
    es: {
      ...
      schema: {
        ...
        'url': 'https://www.promptquorum.com/es/es/local-llms/scaling-local-llms-enterprise',
        'datePublished': '2026-04-04',
        'dateModified': '2026-04-19',
    ...
    ar: {
      ...
      seoTitle: 'نماذج LLM المحلية على نطاق المؤسسات',
      ...
      metaDescription: 'وسّع نماذج LLM المحلية: Kubernetes، وموازنة الحمل، والتكرار، والمراقبة. نشر إنتاجي متعدد GPU.',
      publishDate: '2026-04-04',
