...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    seoTitle: 'Qwen Local Deployment Guide 2026: Qwen2.5, Coder & VL Setup',
...
curl http://localhost:11434/v1/chat/completions \\
  ...
  fr: {
    ...
    metaDescription: 'Déployer Qwen2.5 (7B–72B), Qwen2.5-Coder et Qwen2-VL en local en 2026. Exigences VRAM, setup Ollama + LM Studio, benchmarks Q4_K_M et guide par niveau matériel.',
    publishDate: '2026-05-26',
    dateModified: '2026-05-26',
...
curl http://localhost:11434/v1/chat/completions \\
  ...
  de: {
    ...
    seoTitle: 'Qwen Lokal-Deployment 2026: Qwen2.5, Coder & VL Setup-Guide',
...
curl http://localhost:11434/v1/chat/completions \\
  ...
  ja: {
    ...
    seoTitle: 'Qwenローカルデプロイ2026：Qwen2.5・Coder・VLセットアップ完全ガイド',
    ...
    metaDescription: 'Qwen2.5（7B〜72B）・Qwen2.5-Coder・Qwen2-VLをローカルで動かす2026年版ガイド。VRAM要件、Ollama+LM Studioセットアップ、Q4_K_Mベンチマーク、ハードウェア選定まで。',
    publishDate: '2026-05-26',
    dateModified: '2026-05-26',
    readTime: '14分で読める',
    educationalLevel: 'Intermediate',
...
curl http://localhost:11434/v1/chat/completions \\
  ...
  zh: {
    ...
    seoTitle: 'Qwen本地部署2026：Qwen2.5、Coder和VL完整设置指南',
    ...
    metaDescription: '2026年本地运行Qwen2.5（7B–72B）、Qwen2.5-Coder和Qwen2-VL完整指南。显存要求、Ollama+LM Studio设置、Q4_K_M基准测试及硬件层级选购建议。',
    publishDate: '2026-05-26',
    dateModified: '2026-05-26',
    readTime: '阅读约14分钟',
    educationalLevel: 'Intermediate',
