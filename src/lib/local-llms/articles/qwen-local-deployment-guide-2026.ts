...
curl http://localhost:11434/v1/chat/completions \\
  ...
  ar: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Qwen Models',
    title: 'دليل النشر المحلي لـ ⁨Qwen 2026⁩: شغّل ⁨Qwen3⁩ و⁨Coder⁩ و⁨VL⁩ على كل مستوى أجهزة',
    seoTitle: '⁨Qwen3⁩ محليًا ⁨2026⁩: دليل ⁨Coder⁩ و⁨VL⁩ ومستويات الأجهزة',
    ...
    metaDescription: '⁨Qwen3 7B⁩ يعمل بـ ⁨5.5 GB VRAM⁩ عبر ⁨Ollama⁩ بأمر واحد. ⁨Qwen3-Coder 32B⁩ يحقق ⁨92.7% HumanEval⁩ على ⁨RTX 4090⁩. متطلبات ⁨VRAM⁩ وإعداد ⁨LM Studio⁩ و⁨Q4⁩_⁨K⁩_⁨M 2026⁩.',
    publishDate: '2026-05-26',
    dateModified: '2026-05-26',
