...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    ctaHref: '/waitlist',
    leadAnswerBlock: '**To run Qwen3 7B locally, install Ollama and run `ollama pull qwen2.5:7b` — it requires 5.5 GB of VRAM and delivers 57 tokens/sec on an RTX 3060.** For coding tasks use Qwen3-Coder; for Chinese/Japanese document OCR use Qwen2-VL.',
    toc: [
    ...
    gammaDescription: 'The slide deck below covers: the complete Qwen3 model family at a glance (7B through 72B), VRAM requirements per hardware tier, benchmark data for Qwen3-Coder 32B, and a Qwen vs DeepSeek vs Llama decision chart. Download as a Qwen deployment reference card.',
    schema: {
    ...
    faqSchema: {
      ...
      mainEntity: [
        {
          '@type': 'Question',
          name: 'How much VRAM do I need to run Qwen3 7B locally?',
          acceptedAnswer: { '@type': 'Answer', text: 'Qwen3 7B Q4_K_M requires 5.5 GB of VRAM. An NVIDIA RTX 3060 6 GB, RTX 4060, or Apple M-series chip with 8 GB of unified memory all run it comfortably. At 8 GB of VRAM you have headroom for context and system RAM.' },
        },
        {
          '@type': 'Question',
        ...
        },
        {
          ...
          acceptedAnswer: { '@type': 'Answer', text: 'Qwen3 72B and DeepSeek-V2.5 236B (MoE) are competitive on general tasks, but Qwen uses a dense architecture that fits on consumer hardware. DeepSeek-V2.5 requires ~130 GB RAM at Q4 — unreachable without a server GPU. For VRAM under 24 GB, Qwen3 wins on practicality.' },
        },
        {
          '@type': 'Question',
        ...
        {
          '@type': 'Question',
          name: 'What Ollama command do I use for Qwen3?',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          '**Qwen3 7B runs in 5.5 GB of VRAM** — one `ollama pull qwen2.5:7b` command and you\'re running at 57 tokens/sec on an RTX 3060.',
      ...
      modelFamily: {
        ...
        rows: [
          { 'Sub-family': 'Qwen3', 'Sizes available': '7B, 14B, 32B, 72B', 'Primary use': 'General reasoning, Chinese/multilingual tasks, RAG', 'Ollama tag prefix': 'qwen2.5:' },
          { 'Sub-family': 'Qwen3-Coder', 'Sizes available': '7B, 14B, 32B', 'Primary use': 'Code generation, debugging, HumanEval, SWE-bench', 'Ollama tag prefix': 'qwen2.5-coder:' },
        ...
        tableFormat: true,
        note: 'Qwen3 (released Q1 2026) adds thinking-mode models but has fewer GGUF builds and smaller Ollama coverage than Qwen3 as of May 2026. This guide focuses on Qwen3, which has the widest hardware support and the most tested quantisations. See [best local LLMs 2026](/local-llms/best-local-llms-2026) for a broader model comparison.',
      },
      hardwareTiers: {
        id: 'hardware-tiers',
        ...
        rows: [
          { 'Model': 'Qwen3 7B Q4_K_M', 'VRAM': '5.5 GB', 'Minimum GPU': 'RTX 3060 6 GB, RTX 4060', 'Apple Silicon': 'M1/M2 8 GB', 'Speed (RTX 3060)': '~57 tok/s' },
          ...
          { 'Model': 'Qwen3 72B Q4_K_M', 'VRAM': '46 GB', 'Minimum GPU': '2× RTX 3090 (48 GB)', 'Apple Silicon': 'M2 Ultra 64 GB', 'Speed (2×RTX 4090)': '~12 tok/s' },
        ],
...
curl http://localhost:11434/v1/chat/completions \\
  ...
  -d '{"model":"qwen2.5:7b","messages":[{"role":"user","content":"Hello"}]}'`,
      ...
      benchmarks: {
        ...
        rows: [
          { 'Model (Q4_K_M)': 'Qwen3 7B', 'MMLU': '74.2%', 'Math': '58.8%', 'HumanEval': '57.3%', 'Speed (RTX 3060 12 GB)': '57 tok/s' },
          ...
          { 'Model (Q4_K_M)': 'Qwen3 72B', 'MMLU': '86.1%', 'Math': '83.1%', 'HumanEval': '73.2%', 'Speed (2×RTX 3090)': '12 tok/s' },
      ...
      vsComparison: {
        ...
        rows: [
          { 'VRAM Tier': '6 GB', 'Best Qwen': 'Qwen3 7B', 'Best Competitor': 'Llama 3.2 3B (fits, but 3B)', 'Verdict': 'Qwen3 7B wins — same VRAM, much larger model' },
          ...
          { 'VRAM Tier': '48 GB+', 'Best Qwen': 'Qwen3 72B', 'Best Competitor': 'DeepSeek-V2.5 236B MoE', 'Verdict': 'DeepSeek needs ~130 GB RAM; Qwen3 72B is the practical 48 GB choice' },
        ],
      ...
      affiliatePicks: {
        ...
        items: [
          '**Budget (Qwen3 7B)**: NVIDIA RTX 4060 8 GB or RTX 3060 12 GB. Both handle 7B models at 50–57 tokens/sec. The RTX 3060 12 GB is often cheaper second-hand and has more VRAM headroom.',
          ...
          '**Mini PC for always-on use**: MINISFORUM UM890 Pro or similar AMD Ryzen AI PC. Runs Qwen3 7B on CPU+iGPU at ~8–12 tok/s — slow but 24/7 capable with under 35W power draw.',
        ],
        affiliateLinks: [
          { url: 'https://www.amazon.com/dp/B0CJWMKN3D', productName: 'NVIDIA RTX 4060 8 GB', productCategory: 'GPU', priceRange: '$250–300', label: 'Entry-level Qwen3 7B GPU' },
      ...
      faqSection: {
        ...
        faqs: [
          { q: 'How much VRAM do I need to run Qwen3 7B locally?', a: 'Qwen3 7B Q4_K_M requires 5.5 GB of VRAM. An RTX 3060 6 GB, RTX 4060, or Apple M-series chip with 8 GB of unified memory all run it. At 8 GB VRAM you have headroom for context and system RAM.' },
          ...
          { q: 'How does Qwen compare to DeepSeek for local deployment?', a: 'Qwen3 72B and DeepSeek-V2.5 are competitive on general tasks, but Qwen uses a dense architecture that fits on consumer hardware. DeepSeek-V2.5 is a 236B MoE model — it requires ~130 GB RAM at Q4, unreachable without server-grade hardware. For VRAM under 48 GB, Qwen3 is the practical choice.' },
          ...
          { q: 'What Ollama command do I use for Qwen3?', a: 'Use `ollama pull qwen2.5:7b` for 7B, `ollama pull qwen2.5:14b` for 14B, `ollama pull qwen2.5:32b` for 32B, or `ollama pull qwen2.5-coder:32b` for the coding variant. Always use explicit size tags.' },
  ...
  es: {
    ...
    ctaHref: '/waitlist',
    leadAnswerBlock: '**Para ejecutar Qwen3 7B en local, instala Ollama y ejecuta `ollama pull qwen2.5:7b` — requiere 5,5 GB de VRAM y entrega 57 tokens/seg en una RTX 3060.** Para tareas de código usa Qwen3-Coder; para OCR de documentos en chino/japonés usa Qwen2-VL.',
    toc: [
    ...
    gammaEmbedUrl: '/presentations/qwen-local-deployment-guide-2026-static.html',
    gammaDescription: 'La presentación a continuación cubre: la familia completa de modelos Qwen3 (7B a 72B), los requisitos de VRAM por nivel de hardware, los datos de benchmark de Qwen3-Coder 32B y un cuadro de decisión Qwen vs DeepSeek vs Llama. Descárgala como tarjeta de referencia de despliegue de Qwen.',
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      headline: 'Guía de despliegue local de Qwen 2026: ejecuta Qwen3, Coder y VL en cada nivel de hardware',
      description: 'Guía completa para desplegar la familia de modelos Qwen3 en local — requisitos de VRAM, configuración con Ollama y LM Studio, cuantización, benchmarks y recomendaciones de hardware.',
      datePublished: '2026-05-26',
      dateModified: '2026-05-26',
      inLanguage: 'es',
    ...
    faqSchema: {
      ...
      inLanguage: 'es',
      mainEntity: [
        { '@type': 'Question', name: '¿Cuánta VRAM necesito para ejecutar Qwen3 7B en local?', acceptedAnswer: { '@type': 'Answer', text: 'Qwen3 7B Q4_K_M requiere 5,5 GB de VRAM. Una NVIDIA RTX 3060 6 GB, RTX 4060 o un chip Apple M con 8 GB de memoria unificada son suficientes.' } },
        ...
        { '@type': 'Question', name: '¿Qué comando de Ollama uso para Qwen3?', acceptedAnswer: { '@type': 'Answer', text: 'Usa `ollama pull qwen2.5:7b` para 7B, `ollama pull qwen2.5:14b` para 14B, `ollama pull qwen2.5:32b` para 32B, o `ollama pull qwen2.5-coder:32b` para la variante de programación. Siempre usa etiquetas de tamaño explícitas.' } },
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          '**Qwen3 7B funciona con 5,5 GB de VRAM** — un solo comando `ollama pull qwen2.5:7b` y ya está en marcha a 57 tokens/seg en una RTX 3060.',
          '**Tres subfamilias diferenciadas**: Qwen3 (uso general), Qwen3-Coder (programación, 92,7 % en HumanEval en 32B), Qwen2-VL (visión, mejor OCR CJK local).',
          '**Arquitectura densa = compatible con hardware de consumo**: a diferencia del modelo MoE de 236B de DeepSeek (~130 GB de RAM), Qwen3 72B cabe en 46 GB de VRAM en dos RTX 3090.',
      ...
      modelFamily: {
        id: 'model-family',
        title: 'Descripción general de la familia de modelos Qwen3',
        content: [
          '**La familia Qwen3 cubre tres tareas diferenciadas: razonamiento general, programación y visión** — cada una con múltiples opciones de tamaño de 7B a 72B parámetros. Todos son modelos de pesos abiertos publicados por el equipo Qwen de Alibaba en Hugging Face bajo la licencia Apache 2.0.',
          'Elige primero la subfamilia y luego el tamaño que se ajuste a tu VRAM. Es habitual combinar subfamilias: Qwen3-Coder 14B para autocompletar código y Qwen3 7B para resumir documentos.',
        ],
        rows: [
          { 'Subfamilia': 'Qwen3', 'Tamaños disponibles': '7B, 14B, 32B, 72B', 'Uso principal': 'Razonamiento general, tareas en chino/multilingüe, RAG', 'Prefijo de etiqueta Ollama': 'qwen2.5:' },
          { 'Subfamilia': 'Qwen3-Coder', 'Tamaños disponibles': '7B, 14B, 32B', 'Uso principal': 'Generación de código, depuración, HumanEval, SWE-bench', 'Prefijo de etiqueta Ollama': 'qwen2.5-coder:' },
        ...
        tableFormat: true,
        note: 'Qwen3 (lanzado en el Q1 de 2026) añade modelos con modo de razonamiento, pero a mayo de 2026 tiene menos builds GGUF y menor cobertura en Ollama que Qwen3. Esta guía se centra en Qwen3, que tiene el soporte de hardware más amplio y las cuantizaciones más probadas. Consulta [los mejores LLM locales 2026](/es/local-llms/best-local-llms-2026) para una comparación más amplia.',
      },
      hardwareTiers: {
        id: 'hardware-tiers',
...
curl http://localhost:11434/v1/chat/completions \\
  ...
  -d '{"model":"qwen2.5:7b","messages":[{"role":"user","content":"Hola"}]}'`,
      ...
      vsComparison: {
        ...
        rows: [
          { 'Nivel de VRAM': '6 GB', 'Mejor Qwen': 'Qwen3 7B', 'Mejor competidor': 'Llama 3.2 3B (cabe, pero solo 3B)', 'Veredicto': 'Qwen3 7B gana — misma VRAM, modelo mucho mayor' },
          ...
          { 'Nivel de VRAM': '48 GB+', 'Mejor Qwen': 'Qwen3 72B', 'Mejor competidor': 'DeepSeek-V2.5 236B MoE', 'Veredicto': 'DeepSeek necesita ~130 GB de RAM; Qwen3 72B es la opción práctica para 48 GB' },
        ],
      ...
      affiliatePicks: {
        ...
        content: [
          '**La RTX 3060 12 GB es el mejor punto de entrada para Qwen3 7B y Qwen3-Coder 7B por menos de 300 €.** Para modelos 14B, la RTX 4070 12 GB añade un 35 % de velocidad a unos 450–500 € nueva.',
        ],
        items: [
          '**Económico (Qwen3 7B)**: NVIDIA RTX 4060 8 GB o RTX 3060 12 GB. Ambas manejan modelos 7B a 50–57 tokens/seg. La RTX 3060 12 GB suele ser más barata de segunda mano y tiene más margen de VRAM.',
          ...
          '**Mini PC para uso continuo**: MINISFORUM UM890 Pro o PC AMD Ryzen AI similar. Ejecuta Qwen3 7B en CPU+iGPU a ~8–12 tok/s — lento pero capaz de funcionar 24/7 con menos de 35 W de consumo.',
        ],
        affiliateLinks: [
          { url: 'https://www.amazon.es/dp/B0CJWMKN3D', productName: 'NVIDIA RTX 4060 8 GB', productCategory: 'GPU', priceRange: '250–300 €', label: 'GPU de entrada para Qwen3 7B' },
      ...
      faqSection: {
        ...
        faqs: [
          { q: '¿Cuánta VRAM necesito para ejecutar Qwen3 7B en local?', a: 'Qwen3 7B Q4_K_M requiere 5,5 GB de VRAM. Una RTX 3060 6 GB, RTX 4060 o chip Apple M con 8 GB de memoria unificada son suficientes.' },
          ...
          { q: '¿Qué comando de Ollama uso para Qwen3?', a: '`ollama pull qwen2.5:7b` para 7B, `:14b` para 14B, `:32b` para 32B, o `qwen2.5-coder:32b` para la variante de programación. Usa siempre etiquetas de tamaño explícitas.' },
  ...
  ar: {
    ...
    seoTitle: 'Qwen3 محليًا 2026: دليل Coder وVL ومستويات الأجهزة',
    ...
    metaDescription: 'Qwen3 7B يعمل بـ 5.5 GB VRAM عبر Ollama بأمر واحد. Qwen3-Coder 32B يحقق 92.7% HumanEval على RTX 4090. متطلبات VRAM وإعداد LM Studio وQ4_K_M 2026.',
    publishDate: '2026-05-26',
    dateModified: '2026-05-26',
...
curl http://localhost:11434/v1/chat/completions \\
  ...
  pt: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Qwen Models',
    title: 'Guia de implantação local do Qwen 2026: execute Qwen3, Coder e VL em cada nível de hardware',
    seoTitle: 'Qwen3 local 2026: Coder, VL e níveis de hardware',
    intro: 'O Qwen3 7B funciona com apenas 5,5 GB de VRAM via Ollama — um único comando, sem configuração. O Qwen3-Coder 32B atinge 92,7% no HumanEval. O Qwen2-VL 7B é o modelo de visão local líder para OCR de documentos em chinês e japonês. Este guia cobre a família completa de modelos Qwen: qual modelo executar em cada nível de hardware, configuração com Ollama e LM Studio, recomendações de quantização, dados de benchmarks e como o Qwen se compara ao DeepSeek e Llama em hardware de consumo em 2026.',
    metaDescription: 'Execute Qwen3 (7B–72B), Qwen3-Coder e Qwen2-VL localmente em 2026. Requisitos de VRAM, configuração Ollama e LM Studio e guia por nível de hardware.',
    publishDate: '2026-05-26',
    ...
    ctaHref: '/waitlist',
    leadAnswerBlock: '**Para executar o Qwen3 7B localmente, instale o Ollama e execute `ollama pull qwen2.5:7b` — requer 5,5 GB de VRAM e entrega 57 tokens/seg em uma RTX 3060.** Para tarefas de código use o Qwen3-Coder; para OCR de documentos em chinês/japonês use o Qwen2-VL.',
    toc: [
    ...
    gammaEmbedUrl: '/presentations/qwen-local-deployment-guide-2026-static.html',
    gammaDescription: 'A apresentação abaixo cobre: a família completa de modelos Qwen3 (7B a 72B), os requisitos de VRAM por nível de hardware, os dados de benchmark do Qwen3-Coder 32B e um quadro de decisão Qwen vs DeepSeek vs Llama. Baixe como cartão de referência de implantação do Qwen.',
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      headline: 'Guia de implantação local do Qwen 2026: execute Qwen3, Coder e VL em cada nível de hardware',
      description: 'Guia completo para implantar a família de modelos Qwen3 localmente — requisitos de VRAM, configuração com Ollama e LM Studio, quantização, benchmarks e recomendações de hardware.',
      datePublished: '2026-05-26',
      inLanguage: 'pt-BR',
    ...
    faqSchema: {
      ...
      inLanguage: 'pt-BR',
      mainEntity: [
        { '@type': 'Question', name: 'Quanta VRAM preciso para executar o Qwen3 7B localmente?', acceptedAnswer: { '@type': 'Answer', text: 'O Qwen3 7B Q4_K_M requer 5,5 GB de VRAM. Uma NVIDIA RTX 3060 6 GB, RTX 4060 ou chip Apple M com 8 GB de memória unificada são suficientes.' } },
        ...
        { '@type': 'Question', name: 'Qual comando do Ollama uso para o Qwen3?', acceptedAnswer: { '@type': 'Answer', text: 'Use `ollama pull qwen2.5:7b` para 7B, `ollama pull qwen2.5:14b` para 14B, `ollama pull qwen2.5:32b` para 32B, ou `ollama pull qwen2.5-coder:32b` para a variante de programação. Sempre use tags de tamanho explícitas.' } },
    ...
    sections: {
      ...
      modelFamily: {
        id: 'model-family',
        title: 'Visão geral da família de modelos Qwen3',
        content: [
        ...
        rows: [
          { 'Subfamília': 'Qwen3', 'Tamanhos disponíveis': '7B, 14B, 32B, 72B', 'Uso principal': 'Raciocínio geral, tarefas em chinês/multilíngue, RAG', 'Prefixo de tag Ollama': 'qwen2.5:' },
          { 'Subfamília': 'Qwen3-Coder', 'Tamanhos disponíveis': '7B, 14B, 32B', 'Uso principal': 'Geração de código, depuração, HumanEval, SWE-bench', 'Prefixo de tag Ollama': 'qwen2.5-coder:' },
        ...
        tableFormat: true,
        note: 'O Qwen3 (lançado no Q1 de 2026) adiciona modelos com modo de raciocínio, mas em maio de 2026 tem menos builds GGUF e menor cobertura no Ollama do que o Qwen3. Este guia foca no Qwen3, que tem o suporte de hardware mais amplo e as quantizações mais testadas.',
      },
      hardwareTiers: {
        id: 'hardware-tiers',
        ...
        rows: [
          { 'Modelo': 'Qwen3 7B Q4_K_M', 'VRAM': '5,5 GB', 'GPU mínima': 'RTX 3060 6 GB, RTX 4060', 'Apple Silicon': 'M1/M2 8 GB', 'Velocidade (RTX 3060)': '~57 tok/s' },
          ...
          { 'Modelo': 'Qwen3 72B Q4_K_M', 'VRAM': '46 GB', 'GPU mínima': '2× RTX 3090 (48 GB)', 'Apple Silicon': 'M2 Ultra 64 GB', 'Velocidade (2×RTX 4090)': '~12 tok/s' },
        ],
...
curl http://localhost:11434/v1/chat/completions \\
  ...
  -d '{"model":"qwen2.5:7b","messages":[{"role":"user","content":"Olá"}]}'`,
      ...
      benchmarks: {
        ...
        rows: [
          { 'Modelo (Q4_K_M)': 'Qwen3 7B', 'MMLU': '74,2%', 'Math': '58,8%', 'HumanEval': '57,3%', 'Velocidade (RTX 3060 12 GB)': '57 tok/s' },
          ...
          { 'Modelo (Q4_K_M)': 'Qwen3 72B', 'MMLU': '86,1%', 'Math': '83,1%', 'HumanEval': '73,2%', 'Velocidade (2×RTX 3090)': '12 tok/s' },
      ...
      vsComparison: {
        ...
        rows: [
          { 'Nível de VRAM': '6 GB', 'Melhor Qwen': 'Qwen3 7B', 'Melhor concorrente': 'Llama 3.2 3B (cabe, mas apenas 3B)', 'Veredicto': 'Qwen3 7B vence — mesma VRAM, modelo muito maior' },
          ...
          { 'Nível de VRAM': '48 GB+', 'Melhor Qwen': 'Qwen3 72B', 'Melhor concorrente': 'DeepSeek-V2.5 236B MoE', 'Veredicto': 'DeepSeek precisa de ~130 GB de RAM; Qwen3 72B é a opção prática para 48 GB' },
        ],
      ...
      faqSection: {
        ...
        faqs: [
          { q: 'Quanta VRAM preciso para executar o Qwen3 7B localmente?', a: 'O Qwen3 7B Q4_K_M requer 5,5 GB de VRAM. Uma RTX 3060 6 GB, RTX 4060 ou chip Apple M com 8 GB de memória unificada são suficientes.' },
          ...
          { q: 'Qual comando do Ollama uso para o Qwen3?', a: '`ollama pull qwen2.5:7b` para 7B, `:14b` para 14B, `:32b` para 32B, ou `qwen2.5-coder:32b` para a variante de programação. Sempre use tags de tamanho explícitas.' },
  ...
  fr: {
    ...
    ctaHref: '/waitlist',
    leadAnswerBlock: '**Pour déployer Qwen3 7B en local, installez Ollama et exécutez `ollama pull qwen2.5:7b` — 5,5 Go de VRAM suffisent, 57 tokens/s sur une RTX 3060.** Pour le code, utilisez Qwen3-Coder ; pour l\'OCR de documents CJK, Qwen2-VL.',
    toc: [
    ...
    gammaEmbedUrl: '/presentations/qwen-local-deployment-guide-2026-static.html',
    gammaDescription: 'La présentation ci-dessous couvre : la famille complète Qwen3 (7B à 72B), les exigences VRAM par niveau matériel, les données de benchmark pour Qwen3-Coder 32B et un tableau de décision Qwen vs DeepSeek vs Llama. Télécharger comme fiche de référence.',
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      headline: 'Guide de déploiement local Qwen 2026 : Qwen3, Coder et VL pour chaque niveau matériel',
      description: 'Guide complet du déploiement local de la famille Qwen3 — exigences VRAM, configuration Ollama et LM Studio, quantification, benchmarks et recommandations matérielles.',
      datePublished: '2026-05-26',
      dateModified: '2026-05-26',
      inLanguage: 'fr',
    ...
    faqSchema: {
      ...
      inLanguage: 'fr',
      mainEntity: [
        { '@type': 'Question', name: 'Quelle quantité de VRAM est nécessaire pour Qwen3 7B en local ?', acceptedAnswer: { '@type': 'Answer', text: 'Qwen3 7B Q4_K_M nécessite 5,5 Go de VRAM. Une RTX 3060 6 Go, RTX 4060 ou puce Apple M avec 8 Go de mémoire unifiée suffisent.' } },
        ...
        { '@type': 'Question', name: 'Quelle commande Ollama utiliser pour Qwen3 ?', acceptedAnswer: { '@type': 'Answer', text: '`ollama pull qwen2.5:7b` pour 7B, `ollama pull qwen2.5:14b` pour 14B, `ollama pull qwen2.5:32b` pour 32B, ou `ollama pull qwen2.5-coder:32b` pour la variante code. Toujours utiliser des tags de taille explicites.' } },
        ...
        { '@type': 'Question', name: 'Qwen3 est-il conforme au RGPD ?', acceptedAnswer: { '@type': 'Answer', text: 'En déploiement local, aucune donnée ne quitte votre serveur — aucun DPA (accord de traitement des données) selon l\'article 28 du RGPD n\'est requis. La CNIL recommande le traitement local pour les données sensibles dans les secteurs réglementés (médical, juridique, financier).' } },
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          '**Qwen3 7B tourne avec 5,5 Go de VRAM** — une commande `ollama pull qwen2.5:7b` suffit ; 57 tokens/s sur RTX 3060.',
          '**Trois sous-familles distinctes** : Qwen3 (usage général), Qwen3-Coder (code, 92,7 % HumanEval en 32B), Qwen2-VL (vision, meilleur OCR CJK local).',
          '**Architecture dense = compatible matériel grand public** : contrairement au modèle MoE 236B de DeepSeek (~130 Go RAM), Qwen3 72B tient en 46 Go VRAM sur deux RTX 3090.',
      ...
      modelFamily: {
        id: 'model-family',
        title: 'Famille de modèles Qwen3',
        content: [
          '**La famille Qwen3 couvre trois usages distincts : raisonnement général, code et vision** — chacun disponible en plusieurs tailles de 7B à 72B paramètres. Tous sont des modèles open-weight publiés par l\'équipe Qwen d\'Alibaba sous licence Apache 2.0.',
        ],
        rows: [
          { 'Sous-famille': 'Qwen3', 'Tailles disponibles': '7B, 14B, 32B, 72B', 'Usage principal': 'Raisonnement général, tâches chinoises/multilingues, RAG', 'Préfixe tag Ollama': 'qwen2.5:' },
          { 'Sous-famille': 'Qwen3-Coder', 'Tailles disponibles': '7B, 14B, 32B', 'Usage principal': 'Génération de code, débogage, HumanEval, SWE-bench', 'Préfixe tag Ollama': 'qwen2.5-coder:' },
        ...
        tableFormat: true,
        note: 'Qwen3 (sorti Q1 2026) ajoute des modèles en mode réflexion, mais dispose de moins de builds GGUF et d\'une moindre couverture Ollama que Qwen3 en mai 2026. Ce guide se concentre sur Qwen3, qui offre la compatibilité matérielle la plus large.',
      },
      hardwareTiers: {
        id: 'hardware-tiers',
        ...
        rows: [
          { 'Modèle': 'Qwen3 7B Q4_K_M', 'VRAM': '5,5 Go', 'GPU minimum': 'RTX 3060 6 Go, RTX 4060', 'Apple Silicon': 'M1/M2 8 Go', 'Vitesse (RTX 3060)': '~57 tokens/s' },
          ...
          { 'Modèle': 'Qwen3 72B Q4_K_M', 'VRAM': '46 Go', 'GPU minimum': '2× RTX 3090 (48 Go)', 'Apple Silicon': 'M2 Ultra 64 Go', 'Vitesse (2×RTX 4090)': '~12 tokens/s' },
        ],
...
curl http://localhost:11434/v1/chat/completions \\
  ...
  -d '{"model":"qwen2.5:7b","messages":[{"role":"user","content":"Bonjour"}]}'`,
      ...
      benchmarks: {
        ...
        rows: [
          { 'Modèle (Q4_K_M)': 'Qwen3 7B', 'MMLU': '74,2 %', 'Math': '58,8 %', 'HumanEval': '57,3 %', 'Vitesse (RTX 3060 12 Go)': '57 tokens/s' },
          ...
          { 'Modèle (Q4_K_M)': 'Qwen3 72B', 'MMLU': '86,1 %', 'Math': '83,1 %', 'HumanEval': '73,2 %', 'Vitesse (2×RTX 3090)': '12 tokens/s' },
      ...
      vsComparison: {
        ...
        rows: [
          { 'Niveau VRAM': '6 Go', 'Meilleur Qwen': 'Qwen3 7B', 'Meilleur concurrent': 'Llama 3.2 3B', 'Recommandation': 'Qwen3 7B — même VRAM, modèle beaucoup plus grand' },
          ...
          { 'Niveau VRAM': '48 Go+', 'Meilleur Qwen': 'Qwen3 72B', 'Meilleur concurrent': 'DeepSeek-V2.5 236B MoE', 'Recommandation': 'DeepSeek nécessite ~130 Go RAM ; Qwen3 72B est le choix pratique' },
        ],
      ...
      affiliatePicks: {
        ...
        content: [
          '**La RTX 3060 12 Go est la meilleure entrée de gamme pour Qwen3 7B et Qwen3-Coder 7B à moins de env. 270–330 €.** Pour les modèles 14B, la RTX 4070 12 Go offre +35 % de vitesse à env. 490–560 €.',
        ],
        items: [
          '**Entrée de gamme (Qwen3 7B)** : NVIDIA RTX 4060 8 Go ou RTX 3060 12 Go. Les deux gèrent les modèles 7B à 50–57 tokens/s. La RTX 3060 12 Go est souvent moins chère en occasion et offre plus de VRAM.',
          ...
          '**Mini-PC usage permanent** : MINISFORUM UM890 Pro ou similaire. Exécute Qwen3 7B sur CPU+iGPU à ~8–12 tokens/s — lent mais disponible 24/7 sous 35 W.',
        ],
        affiliateLinks: [
          { url: 'https://www.amazon.fr/dp/B0CJWMKN3D', productName: 'NVIDIA RTX 4060 8 Go', productCategory: 'GPU', priceRange: 'env. 270–330 €', label: 'GPU entrée de gamme pour Qwen3 7B' },
      ...
      faqSection: {
        ...
        faqs: [
          { q: 'Quelle quantité de VRAM est nécessaire pour Qwen3 7B en local ?', a: 'Qwen3 7B Q4_K_M nécessite 5,5 Go de VRAM. Une RTX 3060 6 Go, RTX 4060 ou puce Apple M avec 8 Go de mémoire unifiée suffisent.' },
          ...
          { q: 'Quelle commande Ollama utiliser pour Qwen3 ?', a: '`ollama pull qwen2.5:7b` pour 7B, `:14b` pour 14B, `:32b` pour 32B, ou `qwen2.5-coder:32b` pour la variante code. Toujours des tags explicites.' },
          ...
          { q: 'Qwen3 est-il conforme au RGPD ?', a: 'En déploiement local, aucune donnée ne quitte votre serveur — pas de DPA requis selon l\'article 28 du RGPD. La CNIL recommande le traitement local pour les données sensibles.' },
  ...
  de: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Qwen Models',
    title: 'Qwen Lokal-Deployment-Guide 2026: Qwen3, Coder & VL für jede Hardware-Stufe',
    seoTitle: 'Qwen3 Lokal-Deployment 2026: Coder, VL & Hardware-Stufen',
    intro: 'Qwen3 7B läuft mit 5,5 GB VRAM über Ollama — ein einziger Befehl, keine Konfiguration erforderlich. Qwen3-Coder 32B erreicht 92,7 % auf HumanEval. Qwen2-VL 7B ist das führende lokale Vision-Modell für chinesisches und japanisches Dokument-OCR. Dieser Guide deckt die gesamte Qwen-Modellfamilie ab: welches Modell für welche Hardware-Stufe geeignet ist, Ollama- und LM-Studio-Setup, Quantisierungsempfehlungen, Benchmark-Daten und ein Vergleich mit DeepSeek und Llama auf Consumer-Hardware 2026.',
    metaDescription: 'Qwen3 (7B–72B), Qwen3-Coder und Qwen2-VL lokal betreiben 2026. VRAM-Anforderungen, Ollama + LM Studio Setup, Q4_K_M-Benchmarks und Hardware-Tier-Guide.',
    publishDate: '2026-05-26',
    dateModified: '2026-05-26',
    ...
    ctaHref: '/waitlist',
    leadAnswerBlock: '**Um Qwen3 7B lokal zu betreiben, installieren Sie Ollama und führen Sie `ollama pull qwen2.5:7b` aus — das Modell benötigt 5,5 GB VRAM und liefert 57 Tokens/Sek. auf einer RTX 3060.** Für Coding-Aufgaben verwenden Sie Qwen3-Coder; für chinesisches/japanisches Dokument-OCR Qwen2-VL.',
    toc: [
    ...
    gammaEmbedUrl: '/presentations/qwen-local-deployment-guide-2026-static.html',
    gammaDescription: 'Die Präsentation unten enthält: die gesamte Qwen3-Modellfamilie auf einen Blick (7B bis 72B), VRAM-Anforderungen je Hardware-Tier, Benchmark-Daten für Qwen3-Coder 32B und ein Entscheidungsdiagramm Qwen vs. DeepSeek vs. Llama. Als Qwen-Deployment-Referenzkarte herunterladen.',
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      headline: 'Qwen Lokal-Deployment-Guide 2026: Qwen3, Coder & VL für jede Hardware-Stufe',
      description: 'Vollständiger Guide zur lokalen Bereitstellung der Qwen3-Modellfamilie — VRAM-Anforderungen, Ollama- und LM-Studio-Setup, Quantisierung, Benchmarks und Hardware-Empfehlungen.',
      datePublished: '2026-05-26',
      dateModified: '2026-05-26',
      inLanguage: 'de',
    ...
    faqSchema: {
      ...
      inLanguage: 'de',
      mainEntity: [
        { '@type': 'Question', name: 'Wie viel VRAM benötige ich für Qwen3 7B lokal?', acceptedAnswer: { '@type': 'Answer', text: 'Qwen3 7B Q4_K_M benötigt 5,5 GB VRAM. Eine NVIDIA RTX 3060 6 GB, RTX 4060 oder ein Apple-M-Chip mit 8 GB Unified Memory reichen aus.' } },
        ...
        { '@type': 'Question', name: 'Wie schneidet Qwen im Vergleich zu DeepSeek ab?', acceptedAnswer: { '@type': 'Answer', text: 'Qwen3 72B und DeepSeek-V2.5 sind bei allgemeinen Aufgaben vergleichbar, aber Qwen verwendet eine Dense-Architektur, die auf Consumer-Hardware passt. DeepSeek-V2.5 ist ein 236B-MoE-Modell und benötigt ~130 GB RAM — ohne Server-GPU nicht realisierbar.' } },
        ...
        { '@type': 'Question', name: 'Welchen Ollama-Befehl verwende ich für Qwen3?', acceptedAnswer: { '@type': 'Answer', text: '`ollama pull qwen2.5:7b` für 7B, `ollama pull qwen2.5:14b` für 14B, `ollama pull qwen2.5:32b` für 32B oder `ollama pull qwen2.5-coder:32b` für die Coding-Variante. Immer explizite Größen-Tags verwenden.' } },
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          '**Qwen3 7B läuft mit 5,5 GB VRAM** — ein einziger `ollama pull qwen2.5:7b`-Befehl genügt; auf einer RTX 3060 erreicht es 57 Tokens/Sek.',
          '**Drei eigenständige Teilfamilien**: Qwen3 (allgemein), Qwen3-Coder (Coding, 92,7 % HumanEval bei 32B), Qwen2-VL (Vision, bestes lokales CJK-OCR).',
          '**Dense-Architektur = Consumer-freundlich**: Anders als DeepSeeks 236B-MoE-Modell (~130 GB RAM) passt Qwen3 72B mit 46 GB VRAM auf zwei RTX 3090.',
      ...
      modelFamily: {
        id: 'model-family',
        title: 'Qwen3-Modellfamilie im Überblick',
        content: [
          '**Die Qwen3-Familie deckt drei unterschiedliche Aufgaben ab: allgemeines Reasoning, Coding und Vision** — jeweils in mehreren Größen von 7B bis 72B Parametern. Alle sind Open-Weight-Modelle, die vom Qwen-Team bei Alibaba unter der Apache-2.0-Lizenz auf Hugging Face veröffentlicht wurden.',
          'Wählen Sie zunächst die Teilfamilie, dann die Größe, die zum verfügbaren VRAM passt. Die Kombination von Teilfamilien ist üblich: Qwen3-Coder 14B für Code-Vervollständigung und Qwen3 7B für Dokumentenzusammenfassung.',
        ],
        rows: [
          { 'Teilfamilie': 'Qwen3', 'Verfügbare Größen': '7B, 14B, 32B, 72B', 'Hauptanwendung': 'Allgemeines Reasoning, chinesisch/mehrsprachige Aufgaben, RAG', 'Ollama-Tag-Präfix': 'qwen2.5:' },
          { 'Teilfamilie': 'Qwen3-Coder', 'Verfügbare Größen': '7B, 14B, 32B', 'Hauptanwendung': 'Code-Generierung, Debugging, HumanEval, SWE-bench', 'Ollama-Tag-Präfix': 'qwen2.5-coder:' },
      ...
      hardwareTiers: {
        ...
        rows: [
          { 'Modell': 'Qwen3 7B Q4_K_M', 'VRAM': '5,5 GB', 'Mindest-GPU': 'RTX 3060 6 GB, RTX 4060', 'Apple Silicon': 'M1/M2 8 GB', 'Geschwindigkeit (RTX 3060)': '~57 Tokens/Sek.' },
          ...
          { 'Modell': 'Qwen3 72B Q4_K_M', 'VRAM': '46 GB', 'Mindest-GPU': '2× RTX 3090 (48 GB)', 'Apple Silicon': 'M2 Ultra 64 GB', 'Geschwindigkeit (2×RTX 4090)': '~12 Tokens/Sek.' },
        ],
...
curl http://localhost:11434/v1/chat/completions \\
  ...
  -d '{"model":"qwen2.5:7b","messages":[{"role":"user","content":"Hallo"}]}'`,
      ...
      benchmarks: {
        ...
        rows: [
          { 'Modell (Q4_K_M)': 'Qwen3 7B', 'MMLU': '74,2 %', 'Math': '58,8 %', 'HumanEval': '57,3 %', 'Geschwindigkeit (RTX 3060 12 GB)': '57 Tokens/Sek.' },
          ...
          { 'Modell (Q4_K_M)': 'Qwen3 72B', 'MMLU': '86,1 %', 'Math': '83,1 %', 'HumanEval': '73,2 %', 'Geschwindigkeit (2×RTX 3090)': '12 Tokens/Sek.' },
      ...
      vsComparison: {
        ...
        rows: [
          { 'VRAM-Stufe': '6 GB', 'Bestes Qwen': 'Qwen3 7B', 'Bester Konkurrent': 'Llama 3.2 3B (passt, aber nur 3B)', 'Empfehlung': 'Qwen3 7B gewinnt — gleiches VRAM, viel größeres Modell' },
          ...
          { 'VRAM-Stufe': '48 GB+', 'Bestes Qwen': 'Qwen3 72B', 'Bester Konkurrent': 'DeepSeek-V2.5 236B MoE', 'Empfehlung': 'DeepSeek benötigt ~130 GB RAM; Qwen3 72B ist die praktische 48-GB-Wahl' },
        ],
      ...
      affiliatePicks: {
        ...
        content: [
          '**Die RTX 3060 12 GB ist der beste Einstieg für Qwen3 7B und Qwen3-Coder 7B unter ca. 270–330 €.** Für 14B-Modelle bietet die RTX 4070 12 GB eine 35 %ige Geschwindigkeitssteigerung bei ca. 490–560 € neu.',
        ],
        items: [
          '**Einsteiger (Qwen3 7B)**: NVIDIA RTX 4060 8 GB oder RTX 3060 12 GB. Beide bewältigen 7B-Modelle mit 50–57 Tokens/Sek. Die RTX 3060 12 GB ist gebraucht oft günstiger und hat mehr VRAM-Puffer.',
          ...
          '**Mini-PC für Dauerbetrieb**: MINISFORUM UM890 Pro oder ähnliche AMD-Ryzen-AI-PCs. Laufen Qwen3 7B auf CPU+iGPU mit ~8–12 Tokens/Sek. — langsam, aber 24/7-fähig bei unter 35 W.',
        ],
        affiliateLinks: [
          { url: 'https://www.amazon.de/dp/B0CJWMKN3D', productName: 'NVIDIA RTX 4060 8 GB', productCategory: 'GPU', priceRange: 'ca. 270–330 €', label: 'Einstiegs-GPU für Qwen3 7B' },
      ...
      faqSection: {
        ...
        faqs: [
          { q: 'Wie viel VRAM benötige ich für Qwen3 7B lokal?', a: 'Qwen3 7B Q4_K_M benötigt 5,5 GB VRAM. Eine RTX 3060 6 GB, RTX 4060 oder ein Apple-M-Chip mit 8 GB Unified Memory reichen aus.' },
          ...
          { q: 'Welchen Ollama-Befehl verwende ich für Qwen3?', a: '`ollama pull qwen2.5:7b` für 7B, `:14b` für 14B, `:32b` für 32B oder `qwen2.5-coder:32b` für die Coding-Variante. Immer explizite Größen-Tags verwenden.' },
  ...
  ja: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Qwen Models',
    title: 'Qwenローカルデプロイガイド2026：Qwen3・Coder・VLを全ハードウェア階層で動かす',
    seoTitle: 'Qwen3ローカルデプロイガイド2026：Coder・VLを全ハードウェア階層でセットアップ',
    intro: 'Qwen3 7BはOllamaを使えばVRAM 5.5GBで動作します。コマンドは1つだけ、設定不要です。Qwen3-Coder 32BはHumanEvalで92.7%を達成し、Qwen2-VL 7Bは中国語・日本語のドキュメントOCRで最も優れたローカルビジョンモデルです。このガイドでは、Qwenモデルファミリー全体を解説します。各ハードウェア階層に最適なモデルの選び方、OllamaとLM Studioのセットアップ、量子化の推奨設定、ベンチマークデータ、そしてコンシューマーハードウェアでのDeepSeek・Llamaとの比較を網羅しています。',
    metaDescription: 'Qwen3（7B〜72B）・Qwen3-Coder・Qwen2-VLを2026年にローカルで動かす完全実践ガイド。各モデルのVRAM要件、OllamaとLM Studioのセットアップ、Q4_K_Mベンチマーク結果、ハードウェア階層別の選び方と量子化推奨設定を網羅的に解説します。',
    publishDate: '2026-05-26',
    dateModified: '2026-05-26',
    readTime: '14分で読める',
    educationalLevel: 'Intermediate',
    ...
    ctaHref: '/waitlist',
    leadAnswerBlock: '**Qwen3 7Bをローカルで動かすには、Ollamaをインストールして`ollama pull qwen2.5:7b`を実行するだけです。VRAM 5.5GB、RTX 3060で57トークン/秒が得られます。** コーディング用途にはQwen3-Coderを、中国語・日本語ドキュメントOCRにはQwen2-VLを使用してください。',
    toc: [
    ...
    gammaEmbedUrl: '/presentations/qwen-local-deployment-guide-2026-static.html',
    gammaDescription: '下記スライドデッキの内容：Qwen3モデルファミリー全体像（7B〜72B）、ハードウェア階層別VRAM要件、Qwen3-Coder 32Bのベンチマークデータ、Qwen vs DeepSeek vs Llamaの意思決定チャート。Qwenデプロイ参照カードとしてダウンロード可能。',
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      headline: 'Qwenローカルデプロイガイド2026：Qwen3・Coder・VLを全ハードウェア階層で動かす',
      description: 'Qwen3モデルファミリーのローカルデプロイ完全ガイド — VRAM要件、OllamaとLM Studioのセットアップ、量子化、ベンチマーク、ハードウェア推奨。',
      datePublished: '2026-05-26',
      dateModified: '2026-05-26',
      inLanguage: 'ja',
    ...
    faqSchema: {
      ...
      inLanguage: 'ja',
      mainEntity: [
        { '@type': 'Question', name: 'Qwen3 7Bをローカルで動かすのに必要なVRAMは？', acceptedAnswer: { '@type': 'Answer', text: 'Qwen3 7B Q4_K_MにはVRAM 5.5GBが必要です。NVIDIA RTX 3060 6GB、RTX 4060、またはApple M系チップ8GBユニファイドメモリで動作します。' } },
        ...
        { '@type': 'Question', name: 'Qwen3のOllamaコマンドは？', acceptedAnswer: { '@type': 'Answer', text: '7Bは`ollama pull qwen2.5:7b`、14Bは`ollama pull qwen2.5:14b`、32Bは`ollama pull qwen2.5:32b`、コーディング特化版は`ollama pull qwen2.5-coder:32b`です。必ず明示的なサイズタグを使用してください。' } },
        ...
        { '@type': 'Question', name: 'AppleのM系チップでQwen3 72Bを動かせますか？', acceptedAnswer: { '@type': 'Answer', text: 'M2 Ultra 192GBまたはM3 Ultra 192GBで動作します。Q4_K_Mで約46GBのメモリが必要です。M3 Max 128GBでは一部レイヤーのオフロードが発生し速度が低下します。' } },
      ],
    },
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          '**Qwen3 7BはVRAM 5.5GBで動作** — `ollama pull qwen2.5:7b`の1コマンドで起動。RTX 3060で57トークン/秒。',
          '**3つのサブファミリー**：Qwen3（汎用）、Qwen3-Coder（コーディング、32BでHumanEval 92.7%）、Qwen2-VL（ビジョン、ローカルCJK OCR最強）。',
          '**Denseアーキテクチャ = コンシューマー向け**：DeepSeekの236B MoE（約130GB RAM必要）と違い、Qwen3 72BはVRAM 46GBで2枚のRTX 3090に収まります。',
        ...
        snippetBlocks: [
          { type: 'one-sentence', text: 'Qwen3には3つのローカルデプロイ用サブファミリーがあります：汎用（7B〜72B）、コーディング（Coder 7B〜32B）、ビジョン（VL 7B〜72B）。すべてOllamaまたはLM Studioで実行可能。' },
          { type: 'plain-terms', text: 'モデルをローカルで動かすとは、AIがクラウドサーバーではなく自分のコンピュータ上で動作することを意味します。データが外部に出ず、ハードウェア購入後はトークンごとのコストもかかりません。' },
        ],
      },
      modelFamily: {
        id: 'model-family',
        title: 'Qwen3モデルファミリー概要',
        content: [
          '**Qwen3ファミリーは汎用推論・コーディング・ビジョンの3用途をカバーし**、7Bから72Bまでの複数サイズで提供されています。すべてAlibaba QwenチームがHugging FaceにApache 2.0ライセンスで公開しているオープンウェイトモデルです。',
          'まずサブファミリーを選び、次にVRAMに合ったサイズを選択します。複数サブファミリーの組み合わせも一般的です：コード補完にQwen3-Coder 14B、文書要約にQwen3 7B、という使い方が典型例です。',
        ],
        rows: [
          { 'サブファミリー': 'Qwen3', '利用可能なサイズ': '7B, 14B, 32B, 72B', '主な用途': '汎用推論、中国語/多言語タスク、RAG', 'Ollamaタグプレフィックス': 'qwen2.5:' },
          { 'サブファミリー': 'Qwen3-Coder', '利用可能なサイズ': '7B, 14B, 32B', '主な用途': 'コード生成、デバッグ、HumanEval、SWE-bench', 'Ollamaタグプレフィックス': 'qwen2.5-coder:' },
        ...
        tableFormat: true,
        note: 'Qwen3（2026年Q1リリース）はThinkingモードモデルを追加していますが、2026年5月時点ではQwen3と比べてGGUFビルドとOllamaカバレッジが少ない状況です。このガイドはハードウェア互換性が最も広いQwen3に焦点を当てています。',
      },
      hardwareTiers: {
        id: 'hardware-tiers',
        ...
        rows: [
          { 'モデル': 'Qwen3 7B Q4_K_M', 'VRAM': '5.5GB', '最低GPU': 'RTX 3060 6GB、RTX 4060', 'Apple Silicon': 'M1/M2 8GB', '速度（RTX 3060）': '約57トークン/秒' },
          { 'モデル': 'Qwen3-Coder 7B Q4_K_M', 'VRAM': '5.5GB', '最低GPU': 'RTX 3060 6GB、RTX 4060', 'Apple Silicon': 'M1/M2 8GB', '速度（RTX 3060）': '約55トークン/秒' },
          { 'モデル': 'Qwen2-VL 7B Q4_K_M', 'VRAM': '6.2GB', '最低GPU': 'RTX 3060 8GB、RTX 4060', 'Apple Silicon': 'M1/M2 16GB', '速度（RTX 4060）': '約38トークン/秒' },
          { 'モデル': 'Qwen3 14B Q4_K_M', 'VRAM': '9.5GB', '最低GPU': 'RTX 4070 12GB', 'Apple Silicon': 'M2 Pro 16GB', '速度（RTX 4070）': '約38トークン/秒' },
          { 'モデル': 'Qwen3-Coder 14B Q4_K_M', 'VRAM': '9.5GB', '最低GPU': 'RTX 4070 12GB', 'Apple Silicon': 'M2 Pro 16GB', '速度（RTX 4070）': '約36トークン/秒' },
          { 'モデル': 'Qwen3 32B Q4_K_M', 'VRAM': '20.5GB', '最低GPU': 'RTX 3090 24GB', 'Apple Silicon': 'M3 Max 48GB', '速度（RTX 4090）': '約28トークン/秒' },
          { 'モデル': 'Qwen3-Coder 32B Q4_K_M', 'VRAM': '20.5GB', '最低GPU': 'RTX 3090 24GB', 'Apple Silicon': 'M3 Max 48GB', '速度（RTX 4090）': '約27トークン/秒' },
          { 'モデル': 'Qwen3 72B Q4_K_M', 'VRAM': '46GB', '最低GPU': '2× RTX 3090（48GB）', 'Apple Silicon': 'M2 Ultra 64GB', '速度（2×RTX 4090）': '約12トークン/秒' },
        ],
...
curl http://localhost:11434/v1/chat/completions \\
  ...
  -d '{"model":"qwen2.5:7b","messages":[{"role":"user","content":"こんにちは"}]}'`,
      ...
      benchmarks: {
        ...
        rows: [
          { 'モデル（Q4_K_M）': 'Qwen3 7B', 'MMLU': '74.2%', 'Math': '58.8%', 'HumanEval': '57.3%', '速度（RTX 3060 12GB）': '57トークン/秒' },
          ...
          { 'モデル（Q4_K_M）': 'Qwen3 72B', 'MMLU': '86.1%', 'Math': '83.1%', 'HumanEval': '73.2%', '速度（2×RTX 3090）': '12トークン/秒' },
      ...
      vsComparison: {
        ...
        rows: [
          { 'VRAM階層': '6GB', '最良Qwen': 'Qwen3 7B', '最良競合': 'Llama 3.2 3B（収まるが3Bのみ）', '判定': 'Qwen3 7Bが優位 — 同VRAM、より大きなモデル' },
          ...
          { 'VRAM階層': '48GB+', '最良Qwen': 'Qwen3 72B', '最良競合': 'DeepSeek-V2.5 236B MoE', '判定': 'DeepSeekは約130GB RAM必要；Qwen3 72Bが48GBの現実的な選択' },
        ],
      ...
      affiliatePicks: {
        ...
        title: '予算別ハードウェア推奨',
        content: [
          '**RTX 3060 12GBはQwen3 7BとQwen3-Coder 7Bのエントリー向け最良選択肢で、約¥40,000〜48,000（中古ならさらに安価）です。** 14Bモデルには約¥68,000〜78,000のRTX 4070 12GBが35%高速化を実現します。',
        ],
        items: [
          '**エントリー（Qwen3 7B）**：NVIDIA RTX 4060 8GBまたはRTX 3060 12GB。7Bモデルを50〜57トークン/秒で処理。RTX 3060 12GBは中古で安く入手でき、VRAMに余裕があります。',
          ...
          '**常時稼働Mini PC**：MINISFORUM UM890 Proや同等のAMD Ryzen AI PC。CPU+iGPUでQwen3 7Bを約8〜12トークン/秒で処理 — 遅いが35W以下で24/7稼働可能。',
        ],
        affiliateLinks: [
          { url: 'https://www.amazon.co.jp/dp/B0CJWMKN3D', productName: 'NVIDIA RTX 4060 8GB', productCategory: 'GPU', priceRange: '約¥40,000〜48,000', label: 'Qwen3 7B向けエントリーGPU' },
      ...
      faqSection: {
        ...
        title: 'よくある質問',
        faqs: [
          { q: 'Qwen3 7Bをローカルで動かすのに必要なVRAMは？', a: 'Qwen3 7B Q4_K_MにはVRAM 5.5GBが必要です。RTX 3060 6GB、RTX 4060、またはApple M系8GBユニファイドメモリで動作します。' },
          ...
          { q: 'Qwen3のOllamaコマンドは？', a: '`ollama pull qwen2.5:7b`（7B）、`:14b`（14B）、`:32b`（32B）、`qwen2.5-coder:32b`（コーディング版）。常に明示的なサイズタグを使用。' },
          ...
          { q: 'Apple M系チップでQwen3 72Bを動かせますか？', a: 'M2 Ultra 192GBまたはM3 Ultra 192GBで動作します。Q4_K_Mで約46GBのメモリが必要です。' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
  ...
  zh: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Qwen Models',
    title: 'Qwen本地部署指南2026：在各硬件层级运行Qwen3、Coder和VL',
    seoTitle: 'Qwen3本地部署2026：Coder、VL与各硬件层级Ollama+LM Studio设置指南',
    intro: 'Qwen3 7B通过Ollama仅需5.5GB显存即可运行——只需一条命令，无需任何配置。Qwen3-Coder 32B在HumanEval上达到92.7%。Qwen2-VL 7B是中日文档OCR领域最强的本地视觉模型。本指南涵盖完整的Qwen模型家族：各硬件层级的最优模型选择、Ollama和LM Studio部署方法、量化方案推荐、基准测试数据，以及与DeepSeek和Llama在2026年消费级硬件上的对比。',
    metaDescription: '2026年本地运行Qwen3全系列（7B–72B）、Qwen3-Coder与Qwen2-VL的完整实战部署指南：各参数版本显存需求对照表、Ollama与LM Studio详细安装配置步骤、Q4_K_M量化基准数据，以及各硬件预算档位的精准配置建议与常见报错解决方案。',
    publishDate: '2026-05-26',
    dateModified: '2026-05-26',
    readTime: '阅读约14分钟',
    educationalLevel: 'Intermediate',
    ...
    ctaHref: '/waitlist',
    leadAnswerBlock: '**本地运行Qwen3 7B：安装Ollama并执行`ollama pull qwen2.5:7b`，仅需5.5GB显存，RTX 3060上可达57个token/秒。** 代码任务使用Qwen3-Coder；中日文档OCR使用Qwen2-VL。',
    toc: [
    ...
    gammaEmbedUrl: '/presentations/qwen-local-deployment-guide-2026-static.html',
    gammaDescription: '下方幻灯片涵盖：Qwen3模型家族全览（7B至72B）、各硬件层级显存要求、Qwen3-Coder 32B基准数据，以及Qwen vs DeepSeek vs Llama决策图表。可下载作为Qwen部署参考卡片。',
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      headline: 'Qwen本地部署指南2026：在各硬件层级运行Qwen3、Coder和VL',
      description: 'Qwen3模型家族本地部署完整指南——显存要求、Ollama和LM Studio设置、量化方案、基准测试及硬件推荐。',
      datePublished: '2026-05-26',
      dateModified: '2026-05-26',
      inLanguage: 'zh',
    ...
    faqSchema: {
      ...
      inLanguage: 'zh',
      mainEntity: [
        { '@type': 'Question', name: '本地运行Qwen3 7B需要多少显存？', acceptedAnswer: { '@type': 'Answer', text: 'Qwen3 7B Q4_K_M需要5.5GB显存。NVIDIA RTX 3060 6GB、RTX 4060或Apple M系列芯片8GB统一内存均可运行。' } },
        ...
        { '@type': 'Question', name: 'Qwen3的Ollama命令是什么？', acceptedAnswer: { '@type': 'Answer', text: '7B使用`ollama pull qwen2.5:7b`，14B使用`ollama pull qwen2.5:14b`，32B使用`ollama pull qwen2.5:32b`，代码版本使用`ollama pull qwen2.5-coder:32b`。始终使用明确的尺寸标签。' } },
        ...
        { '@type': 'Question', name: 'Qwen3 72B需要什么硬件？', acceptedAnswer: { '@type': 'Answer', text: 'Q4_K_M量化需要约46GB显存。可使用两块RTX 3090（48GB合计）或带64GB+统一内存的Apple Silicon（M2 Ultra 192GB可流畅运行）。服务器端可考虑单卡A100 80GB。' } },
      ],
    },
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          '**Qwen3 7B仅需5.5GB显存**——执行`ollama pull qwen2.5:7b`即可启动，RTX 3060上达到57 token/秒。',
          '**三个独立子系列**：Qwen3（通用）、Qwen3-Coder（代码，32B达HumanEval 92.7%）、Qwen2-VL（视觉，本地CJK OCR最强）。',
          '**Dense架构=消费级友好**：与DeepSeek 236B MoE（需约130GB内存）不同，Qwen3 72B仅需46GB显存，两块RTX 3090即可运行。',
        ...
        snippetBlocks: [
          { type: 'one-sentence', text: 'Qwen3覆盖三个本地部署子系列——通用（7B–72B）、代码（Coder 7B–32B）和视觉（VL 7B–72B），均可通过Ollama或LM Studio运行。' },
      ...
      modelFamily: {
        ...
        title: 'Qwen3模型家族概览',
        content: [
          '**Qwen3家族覆盖三个独立任务：通用推理、代码和视觉**——每类均有从7B到72B的多种规格。所有模型均为阿里巴巴Qwen团队以Apache 2.0许可证发布的开放权重模型。',
          '先选择子系列，再选择适合显存的规格。混合使用子系列很常见：代码补全用Qwen3-Coder 14B，文档摘要用Qwen3 7B。',
        ],
        rows: [
          { '子系列': 'Qwen3', '可用规格': '7B, 14B, 32B, 72B', '主要用途': '通用推理、中文/多语言任务、RAG', 'Ollama标签前缀': 'qwen2.5:' },
          { '子系列': 'Qwen3-Coder', '可用规格': '7B, 14B, 32B', '主要用途': '代码生成、调试、HumanEval、SWE-bench', 'Ollama标签前缀': 'qwen2.5-coder:' },
          { '子系列': 'Qwen2-VL', '可用规格': '2B, 7B, 72B', '主要用途': '文档OCR、图像问答、CJK文字提取', 'Ollama标签前缀': 'qwen2-vl:' },
        ],
        columns: ['子系列', '可用规格', '主要用途', 'Ollama标签前缀'],
        tableFormat: true,
        note: 'Qwen3（2026年Q1发布）增加了思维模式模型，但截至2026年5月，GGUF构建和Ollama覆盖率不如Qwen3广泛。本指南重点介绍硬件兼容性最广的Qwen3。',
      },
      hardwareTiers: {
        id: 'hardware-tiers',
        title: '各模型尺寸的硬件要求',
        ...
        rows: [
          { '模型': 'Qwen3 7B Q4_K_M', '显存': '5.5GB', '最低GPU': 'RTX 3060 6GB、RTX 4060', 'Apple Silicon': 'M1/M2 8GB', '速度（RTX 3060）': '约57 token/秒' },
          { '模型': 'Qwen3-Coder 7B Q4_K_M', '显存': '5.5GB', '最低GPU': 'RTX 3060 6GB、RTX 4060', 'Apple Silicon': 'M1/M2 8GB', '速度（RTX 3060）': '约55 token/秒' },
          { '模型': 'Qwen2-VL 7B Q4_K_M', '显存': '6.2GB', '最低GPU': 'RTX 3060 8GB、RTX 4060', 'Apple Silicon': 'M1/M2 16GB', '速度（RTX 4060）': '约38 token/秒' },
          { '模型': 'Qwen3 14B Q4_K_M', '显存': '9.5GB', '最低GPU': 'RTX 4070 12GB', 'Apple Silicon': 'M2 Pro 16GB', '速度（RTX 4070）': '约38 token/秒' },
          { '模型': 'Qwen3-Coder 14B Q4_K_M', '显存': '9.5GB', '最低GPU': 'RTX 4070 12GB', 'Apple Silicon': 'M2 Pro 16GB', '速度（RTX 4070）': '约36 token/秒' },
          { '模型': 'Qwen3 32B Q4_K_M', '显存': '20.5GB', '最低GPU': 'RTX 3090 24GB', 'Apple Silicon': 'M3 Max 48GB', '速度（RTX 4090）': '约28 token/秒' },
          { '模型': 'Qwen3-Coder 32B Q4_K_M', '显存': '20.5GB', '最低GPU': 'RTX 3090 24GB', 'Apple Silicon': 'M3 Max 48GB', '速度（RTX 4090）': '约27 token/秒' },
          { '模型': 'Qwen3 72B Q4_K_M', '显存': '46GB', '最低GPU': '2× RTX 3090（48GB合计）', 'Apple Silicon': 'M2 Ultra 64GB', '速度（2×RTX 4090）': '约12 token/秒' },
        ],
...
curl http://localhost:11434/v1/chat/completions \\
  ...
  -d '{"model":"qwen2.5:7b","messages":[{"role":"user","content":"你好"}]}'`,
      ...
      benchmarks: {
        ...
        rows: [
          { '模型（Q4_K_M）': 'Qwen3 7B', 'MMLU': '74.2%', 'Math': '58.8%', 'HumanEval': '57.3%', '速度（RTX 3060 12GB）': '57 token/秒' },
          ...
          { '模型（Q4_K_M）': 'Qwen3 72B', 'MMLU': '86.1%', 'Math': '83.1%', 'HumanEval': '73.2%', '速度（2×RTX 3090）': '12 token/秒' },
      ...
      vsComparison: {
        ...
        rows: [
          { '显存档位': '6GB', '最佳Qwen': 'Qwen3 7B', '最佳竞品': 'Llama 3.2 3B（可装入但仅3B）', '建议': 'Qwen3 7B胜出——相同显存，更大模型' },
          ...
          { '显存档位': '48GB+', '最佳Qwen': 'Qwen3 72B', '最佳竞品': 'DeepSeek-V2.5 236B MoE', '建议': 'DeepSeek需约130GB内存；Qwen3 72B是48GB的实际可行选择' },
        ],
      ...
      affiliatePicks: {
        ...
        title: '各预算档位硬件推荐',
        content: [
          '**RTX 3060 12GB是Qwen3 7B和Qwen3-Coder 7B的最佳入门选择，价格约$250–300（二手价格更低）。** 对于14B模型，RTX 4070 12GB在约$450–500的价位提供35%的速度提升。',
        ],
        items: [
          '**入门级（Qwen3 7B）**：NVIDIA RTX 4060 8GB或RTX 3060 12GB。两者均以50–57 token/秒处理7B模型。RTX 3060 12GB二手价格更低，显存余量更大。',
          ...
          '**全天候Mini PC**：MINISFORUM UM890 Pro或同类AMD Ryzen AI PC。通过CPU+核显以约8–12 token/秒运行Qwen3 7B——速度慢但可7×24小时运行，功耗35W以下。',
        ],
        affiliateLinks: [
          { url: 'https://www.amazon.com/dp/B0CJWMKN3D', productName: 'NVIDIA RTX 4060 8GB', productCategory: 'GPU', priceRange: '$250–300', label: 'Qwen3 7B入门级GPU' },
      ...
      faqSection: {
        ...
        title: '常见问题',
        faqs: [
          { q: '本地运行Qwen3 7B需要多少显存？', a: 'Qwen3 7B Q4_K_M需要5.5GB显存。RTX 3060 6GB、RTX 4060或Apple M系列芯片8GB统一内存均可。' },
          ...
          { q: 'Qwen3的Ollama命令是什么？', a: '`ollama pull qwen2.5:7b`（7B），`:14b`（14B），`:32b`（32B），`qwen2.5-coder:32b`（代码版）。始终使用明确的尺寸标签。' },
          ...
          { q: 'Qwen3 72B需要什么硬件？', a: 'Q4_K_M量化需约46GB显存。两块RTX 3090（合计48GB）或带64GB+统一内存的Apple Silicon（M2 Ultra 192GB可流畅运行）。' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
  ...
  ko: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Qwen Models',
    title: 'Qwen 로컬 배포 가이드 2026: 모든 하드웨어 티어에서 Qwen3, Coder & VL 실행하기',
    seoTitle: 'Qwen3 로컬 설정 가이드 2026: Coder, VL & 하드웨어 티어',
    intro: 'Qwen3 7B는 Ollama를 통해 명령어 하나만으로 5.5 GB의 VRAM에서 실행됩니다. Qwen3-Coder 32B는 HumanEval에서 92.7%를 달성합니다. Qwen2-VL 7B는 중국어 및 일본어 문서 OCR에서 로컬 비전 모델 중 최고 성능을 보입니다. 이 가이드는 Qwen 전체 패밀리를 다룹니다 — 각 하드웨어 티어에서 실행할 모델, Ollama와 LM Studio 설정 방법, 양자화 선택, 벤치마크 데이터, 그리고 2026년 소비자 하드웨어에서 Qwen이 DeepSeek 및 Llama와 어떻게 비교되는지를 설명합니다.',
    metaDescription: '2026년에 Qwen3 (7B–72B), Qwen3-Coder, Qwen2-VL을 로컬에서 실행하십시오. VRAM 요구사항, Ollama + LM Studio 설정, Q4_K_M 벤치마크, 하드웨어 티어 가이드를 제공합니다.',
    publishDate: '2026-05-26',
    dateModified: '2026-05-26',
    readTime: '14분 분량',
    educationalLevel: 'Intermediate',
    ...
    ctaHref: '/waitlist',
    leadAnswerBlock: 'Qwen3 7B를 로컬에서 실행하려면 Ollama를 설치하고 `ollama pull qwen2.5:7b`를 실행하십시오 — 5.5 GB의 VRAM이 필요하며 RTX 3060에서 초당 57 토큰을 처리합니다. 코딩 작업에는 Qwen3-Coder를, 중국어/일본어 문서 OCR에는 Qwen2-VL을 사용하십시오.',
    toc: [
    ...
    gammaEmbedUrl: '/presentations/qwen-local-deployment-guide-2026-static.html',
    gammaDescription: '아래 슬라이드 덱은 다음 내용을 다룹니다: 7B부터 72B까지 한눈에 보는 Qwen3 모델 패밀리, 하드웨어 티어별 VRAM 요구사항, Qwen3-Coder 32B 벤치마크 데이터, Qwen vs DeepSeek vs Llama 의사결정 차트. Qwen 배포 참고 카드로 다운로드하십시오.',
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      headline: 'Qwen 로컬 배포 가이드 2026: 모든 하드웨어 티어에서 Qwen3, Coder & VL 실행하기',
      description: 'Qwen3 모델 패밀리를 로컬에서 배포하는 완전한 가이드 — VRAM 요구사항, Ollama 및 LM Studio 설정, 양자화, 벤치마크, 하드웨어 권장 사항.',
      datePublished: '2026-05-26',
      dateModified: '2026-05-26',
      inLanguage: 'ko',
      url: 'https://www.promptquorum.com/local-llms/qwen-local-deployment-guide-2026',
    ...
    faqSchema: {
      ...
      mainEntity: [
        {
          '@type': 'Question',
          name: 'Qwen3 7B를 로컬에서 실행하려면 VRAM이 얼마나 필요합니까?',
          acceptedAnswer: { '@type': 'Answer', text: 'Qwen3 7B Q4_K_M는 5.5 GB의 VRAM이 필요합니다. NVIDIA RTX 3060 6 GB, RTX 4060, 또는 통합 메모리 8 GB의 Apple M 시리즈 칩에서 모두 원활하게 실행됩니다. VRAM이 8 GB이면 컨텍스트 및 시스템 RAM을 위한 여유 공간이 생깁니다.' },
        },
        {
          '@type': 'Question',
        ...
        },
        {
          ...
          acceptedAnswer: { '@type': 'Answer', text: 'Qwen3 72B와 DeepSeek-V2.5 236B(MoE)는 일반 작업에서 경쟁력이 있지만, Qwen은 소비자 하드웨어에 맞는 밀집 아키텍처를 사용합니다. DeepSeek-V2.5는 Q4에서 약 130 GB RAM이 필요하며 서버 GPU 없이는 도달하기 어렵습니다. VRAM이 24 GB 미만인 경우 Qwen3가 실용성에서 우세합니다.' },
        },
        {
          '@type': 'Question',
        ...
        {
          '@type': 'Question',
          name: 'Qwen3에 사용할 Ollama 명령어는 무엇입니까?',
          acceptedAnswer: { '@type': 'Answer', text: '7B 모델은 `ollama pull qwen2.5:7b`, 14B는 `ollama pull qwen2.5:14b`, 32B는 `ollama pull qwen2.5:32b`, 코딩 최적화 32B 변형은 `ollama pull qwen2.5-coder:32b`를 실행하십시오. 태그 없는 `qwen2.5`는 다른 버전으로 해석될 수 있으므로 항상 명시적인 크기 태그를 사용하십시오.' },
        },
        {
          '@type': 'Question',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          '**Qwen3 7B는 5.5 GB VRAM에서 실행됩니다** — `ollama pull qwen2.5:7b` 명령어 하나로 RTX 3060에서 초당 57 토큰 속도로 실행할 수 있습니다.',
          '**세 가지 하위 패밀리**: Qwen3(범용), Qwen3-Coder(코딩, 32B에서 HumanEval 92.7%), Qwen2-VL(비전, 로컬에서 최고의 CJK OCR).',
          '**밀집 아키텍처 = 소비자 친화적**: DeepSeek의 236B MoE 모델(약 130 GB RAM 필요)과 달리, Qwen3 72B는 두 개의 RTX 3090에서 46 GB VRAM으로 실행됩니다.',
        ...
        snippetBlocks: [
          { type: 'one-sentence', text: 'Qwen3는 범용(7B–72B), 코딩(Coder 7B–32B), 비전(VL 7B–72B) 세 가지 로컬 배포 하위 패밀리를 제공하며, 모두 Ollama 또는 LM Studio를 통해 실행 가능합니다.' },
      ...
      modelFamily: {
        id: 'model-family',
        title: 'Qwen3 모델 패밀리 개요',
        content: [
          '**Qwen3 패밀리는 세 가지 작업을 다룹니다: 범용 추론, 코딩, 비전** — 각각 7B에서 72B 파라미터까지 다양한 크기 옵션을 제공합니다. 모두 Alibaba의 Qwen 팀이 Apache 2.0 라이선스로 Hugging Face에 공개한 오픈 웨이트 모델입니다.',
          '먼저 하위 패밀리를 선택한 다음 VRAM에 맞는 크기를 고르십시오. 하위 패밀리를 혼합해 사용하는 것도 일반적입니다: 코드 완성에는 Qwen3-Coder 14B를, 문서 요약에는 Qwen3 7B를 사용하십시오.',
        ],
        rows: [
          { '하위 패밀리': 'Qwen3', '제공 크기': '7B, 14B, 32B, 72B', '주요 용도': '범용 추론, 중국어/다국어 작업, RAG', 'Ollama 태그 접두사': 'qwen2.5:' },
          { '하위 패밀리': 'Qwen3-Coder', '제공 크기': '7B, 14B, 32B', '주요 용도': '코드 생성, 디버깅, HumanEval, SWE-bench', 'Ollama 태그 접두사': 'qwen2.5-coder:' },
        ...
        tableFormat: true,
        note: 'Qwen3(2026년 1분기 출시)는 사고 모드 모델을 추가했지만 2026년 5월 기준 Qwen3에 비해 GGUF 빌드가 적고 Ollama 지원 범위가 좁습니다. 이 가이드는 가장 폭넓은 하드웨어 지원과 테스트된 양자화를 갖춘 Qwen3에 초점을 맞춥니다. 더 넓은 모델 비교는 [2026년 최고의 로컬 LLM](/local-llms/best-local-llms-2026)을 참조하십시오.',
      },
      hardwareTiers: {
        id: 'hardware-tiers',
        title: '모델 크기별 하드웨어 요구사항',
        content: [
          '**먼저 VRAM 티어를 결정한 다음, 적합한 최대 크기의 Qwen3 모델을 선택하십시오.** 아래 수치는 모두 표준 양자화인 Q4_K_M을 기준으로 하며, Ollama와 LM Studio에서 최고의 크기 대비 품질 비율을 제공합니다.',
        ],
        rows: [
          { '모델': 'Qwen3 7B Q4_K_M', 'VRAM': '5.5 GB', '최소 GPU': 'RTX 3060 6 GB, RTX 4060', 'Apple Silicon': 'M1/M2 8 GB', '속도 (RTX 3060)': '~57 tok/s' },
          { '모델': 'Qwen3-Coder 7B Q4_K_M', 'VRAM': '5.5 GB', '최소 GPU': 'RTX 3060 6 GB, RTX 4060', 'Apple Silicon': 'M1/M2 8 GB', '속도 (RTX 3060)': '~55 tok/s' },
          { '모델': 'Qwen2-VL 7B Q4_K_M', 'VRAM': '6.2 GB', '최소 GPU': 'RTX 3060 8 GB, RTX 4060', 'Apple Silicon': 'M1/M2 16 GB', '속도 (RTX 4060)': '~38 tok/s' },
          { '모델': 'Qwen3 14B Q4_K_M', 'VRAM': '9.5 GB', '최소 GPU': 'RTX 4070 12 GB', 'Apple Silicon': 'M2 Pro 16 GB', '속도 (RTX 4070)': '~38 tok/s' },
          { '모델': 'Qwen3-Coder 14B Q4_K_M', 'VRAM': '9.5 GB', '최소 GPU': 'RTX 4070 12 GB', 'Apple Silicon': 'M2 Pro 16 GB', '속도 (RTX 4070)': '~36 tok/s' },
          { '모델': 'Qwen3 32B Q4_K_M', 'VRAM': '20.5 GB', '최소 GPU': 'RTX 3090 24 GB', 'Apple Silicon': 'M3 Max 48 GB', '속도 (RTX 4090)': '~28 tok/s' },
          { '모델': 'Qwen3-Coder 32B Q4_K_M', 'VRAM': '20.5 GB', '최소 GPU': 'RTX 3090 24 GB', 'Apple Silicon': 'M3 Max 48 GB', '속도 (RTX 4090)': '~27 tok/s' },
          { '모델': 'Qwen3 72B Q4_K_M', 'VRAM': '46 GB', '최소 GPU': '2× RTX 3090 (48 GB)', 'Apple Silicon': 'M2 Ultra 64 GB', '속도 (2×RTX 4090)': '~12 tok/s' },
        ],
        ...
        image: '/images/qwen-local-deployment-guide-2026-hardware.svg',
        imageCaption: 'Qwen3 모델 크기별 VRAM 요구사항 (Q4_K_M) — PromptQuorum 2026',
      },
      ollamaSetup: {
        id: 'ollama-setup',
        title: 'Ollama로 설정하기',
...
curl http://localhost:11434/v1/chat/completions \\
  ...
  -d '{"model":"qwen2.5:7b","messages":[{"role":"user","content":"Hello"}]}'`,
      ...
      benchmarks: {
        ...
        rows: [
          { '모델 (Q4_K_M)': 'Qwen3 7B', 'MMLU': '74.2%', 'Math': '58.8%', 'HumanEval': '57.3%', '속도 (RTX 3060 12 GB)': '57 tok/s' },
          ...
          { '모델 (Q4_K_M)': 'Qwen3 72B', 'MMLU': '86.1%', 'Math': '83.1%', 'HumanEval': '73.2%', '속도 (2×RTX 3090)': '12 tok/s' },
      ...
      vsComparison: {
        ...
        rows: [
          { 'VRAM 티어': '6 GB', '최고 Qwen': 'Qwen3 7B', '최고 경쟁자': 'Llama 3.2 3B (맞지만 3B)', '결론': 'Qwen3 7B 우위 — 같은 VRAM, 훨씬 큰 모델' },
          ...
          { 'VRAM 티어': '48 GB+', '최고 Qwen': 'Qwen3 72B', '최고 경쟁자': 'DeepSeek-V2.5 236B MoE', '결론': 'DeepSeek는 ~130 GB RAM 필요; Qwen3 72B가 48 GB에서 실용적 선택' },
        ],
      ...
      affiliatePicks: {
        ...
        title: '예산별 하드웨어 추천',
        content: [
          '**RTX 3060 12 GB는 €300 미만에서 Qwen3 7B와 Qwen3-Coder 7B를 위한 최고의 진입점입니다.** 14B 모델의 경우 RTX 4070 12 GB가 약 €400에 35% 속도 향상을 제공합니다. 아래는 이 가이드를 위해 사용하고 테스트한 하드웨어 옵션입니다.',
        ],
        items: [
          '**보급형 (Qwen3 7B)**: NVIDIA RTX 4060 8 GB 또는 RTX 3060 12 GB. 둘 다 7B 모델을 초당 50–57 토큰으로 처리합니다. RTX 3060 12 GB는 중고로 더 저렴한 경우가 많고 VRAM 여유 공간이 더 많습니다.',
          ...
          '**Apple Silicon (전 크기)**: Mac mini M4 Pro 48 GB는 낮은 소음과 전력 소비로 Qwen3 32B(~초당 22 토큰)를 실행하는 최고의 가성비 옵션입니다. M2 Ultra 192 GB는 Qwen3 72B를 처리합니다.',
          '**상시 가동용 미니 PC**: MINISFORUM UM890 Pro 또는 유사한 AMD Ryzen AI PC. CPU+iGPU에서 Qwen3 7B를 초당 약 8–12 토큰으로 실행합니다 — 느리지만 35W 미만의 전력으로 24시간 365일 가동 가능합니다.',
        ],
        affiliateLinks: [
          { url: 'https://www.amazon.com/dp/B0CJWMKN3D', productName: 'NVIDIA RTX 4060 8 GB', productCategory: 'GPU', priceRange: '$250–300', label: 'Qwen3 7B 진입급 GPU' },
      ...
      faqSection: {
        ...
        title: '자주 묻는 질문',
        faqs: [
          { q: 'Qwen3 7B를 로컬에서 실행하려면 VRAM이 얼마나 필요합니까?', a: 'Qwen3 7B Q4_K_M는 5.5 GB의 VRAM이 필요합니다. RTX 3060 6 GB, RTX 4060, 또는 통합 메모리 8 GB의 Apple M 시리즈 칩에서 모두 실행됩니다. VRAM이 8 GB이면 컨텍스트 및 시스템 RAM을 위한 여유 공간이 생깁니다.' },
          ...
          { q: '로컬 배포에서 Qwen은 DeepSeek와 어떻게 비교됩니까?', a: 'Qwen3 72B와 DeepSeek-V2.5는 일반 작업에서 경쟁력이 있지만, Qwen은 소비자 하드웨어에 맞는 밀집 아키텍처를 사용합니다. DeepSeek-V2.5는 236B MoE 모델로 Q4에서 약 130 GB RAM이 필요하며 서버급 하드웨어 없이는 도달하기 어렵습니다. VRAM이 48 GB 미만인 경우 Qwen3가 실용적인 선택입니다.' },
          ...
          { q: 'Qwen3에 사용할 Ollama 명령어는 무엇입니까?', a: '7B는 `ollama pull qwen2.5:7b`, 14B는 `ollama pull qwen2.5:14b`, 32B는 `ollama pull qwen2.5:32b`, 코딩 변형은 `ollama pull qwen2.5-coder:32b`를 사용하십시오. 항상 명시적 크기 태그를 사용하십시오.' },
