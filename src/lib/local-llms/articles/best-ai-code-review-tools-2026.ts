...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    metaDescription: 'CodeRabbit is $24/user/mo and free for public repos, Greptile gives 50 credits free, Qodo is $30/mo prepaid credits. Platform support and real pricing.',
    ...
    schema: {
      ...
      description: 'Comparison of CodeRabbit, Greptile and Qodo as AI code review bots: verified pricing, Git platform support, context depth, self-hosting and affiliate programmes.',
  ...
  de: {
    ...
    metaDescription: 'CodeRabbit kostet 24 $/Nutzer/Monat und ist für öffentliche Repos gratis, Greptile gibt 50 Credits frei, Qodo 30 $/Monat auf Guthabenbasis.',
    educationalLevel: 'Advanced',
    ...
    schema: {
      ...
      description: 'Vergleich von CodeRabbit, Greptile und Qodo als KI-Code-Review-Bots: geprüfte Preise, Git-Plattformunterstützung, Kontexttiefe, Selbstbetrieb und Partnerprogramme.',
      datePublished: '2026-08-28',
      dateModified: '2026-08-28',
  ...
  es: {
    ...
    metaDescription: 'CodeRabbit cuesta 24 $/usuario/mes y es gratis en repos públicos, Greptile da 50 créditos gratis, Qodo 30 $/mes en créditos.',
    educationalLevel: 'Advanced',
    ...
    schema: {
      ...
      description: 'Comparativa de CodeRabbit, Greptile y Qodo como bots de revisión de código con IA: precios verificados, soporte de plataformas Git, profundidad de contexto, autoalojamiento y programas de afiliados. Com.',
      datePublished: '2026-08-28',
      dateModified: '2026-08-28',
  ...
  pt: {
    ...
    metaDescription: 'CodeRabbit custa US$ 24/usuario/mes e e gratuito em repositorios publicos, Greptile da 50 creditos, Qodo cobra US$ 30/mes em creditos.',
    educationalLevel: 'Advanced',
    ...
    schema: {
      ...
      description: 'Comparativo de CodeRabbit, Greptile e Qodo como bots de revisao de codigo com IA: precos verificados, suporte a plataformas Git, profundidade de contexto, auto-hospedagem e programas de afiliados.',
      datePublished: '2026-08-28',
      dateModified: '2026-08-28',
  ...
  ja: {
    ...
    metaDescription: 'CodeRabbitは月額24ドル／ユーザーで公開リポジトリは無料、Greptileは50クレジット、Qodoは月30ドルのクレジット制。',
    educationalLevel: 'Advanced',
  ...
  zh: {
    ...
    metaDescription: 'CodeRabbit 每用户每月 24 美元且公开仓库免费，Greptile 提供 50 个额度，Qodo 每月 30 美元额度制。',
    educationalLevel: 'Advanced',
    ...
    schema: {
      ...
      description: '对比 CodeRabbit、Greptile 与 Qodo 三款 AI 代码审查机器人：核实过的价格、Git 平台支持、上下文深度、自托管与联盟计划。',
      datePublished: '2026-08-28',
      dateModified: '2026-08-28',
  ...
  ar: {
    ...
    metaDescription: 'أداة CodeRabbit بـ24 دولارًا للمستخدم شهريًا ومجانية للمستودعات العامة، وGreptile تمنح 50 رصيدًا، وQodo بـ30 دولارًا شهريًا بنظام الأرصدة. أسعار.',
    educationalLevel: 'Advanced',
    ...
    schema: {
      ...
      description: 'مقارنة بين CodeRabbit وGreptile وQodo بوصفها روبوتات لمراجعة الكود بالذكاء الاصطناعي: أسعار موثقة، ودعم منصات Git، وعمق السياق، والاستضافة الذاتية، وبرامج العمولة. جرى.',
      datePublished: '2026-08-28',
      dateModified: '2026-08-28',
  ...
  ko: {
    ...
    schema: {
      ...
      description: 'AI 코드 리뷰 봇으로서 CodeRabbit, Greptile, Qodo를 비교합니다. 확인된 가격, Git 플랫폼 지원, 컨텍스트 깊이, 자체 호스팅, 제휴 프로그램까지.',
      datePublished: '2026-08-28',
      dateModified: '2026-08-28',
