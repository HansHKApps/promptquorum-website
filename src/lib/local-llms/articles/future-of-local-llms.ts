...
schema: {
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '**التنبؤ:** ستشغّل 50% من الشركات الكبرى الاستدلال المحلي للأحمال الحساسة قبل 2027.',
          ],
        },
        trendsSummary: {
          id: 'trends-summary',
    ...
    pt: {
      ...
      schema: {
        ...
        description: 'Os modelos 1–3B rivalizam com a qualidade 7B em 2026. Smartphones executam LLMs a 15–30 tok/s. Raciocínio melhora a precisão em 15–30%.',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '**예측:** 대형 기업의 50%가 2027년까지 민감한 업무에 대해 온프레미스 추론을 실행하게 될 것입니다.',
          ],
        },
        trendsSummary: {
          id: 'trends-summary',
