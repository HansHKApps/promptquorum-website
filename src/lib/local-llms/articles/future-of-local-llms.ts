  ...
  ko: {
      ...
      sections: {
        ...
        smallerModels: {
          ...
          content: [
            '**예 — 파라미터당 모델 품질이 빠르게 향상되고 있습니다.** Phi-4 Mini 3.8B는 MMLU에서 68%를 기록하고, Llama 3.2 3B는 58%를 기록합니다 — 둘 다 2023년의 Llama 3.3 7B(55% MMLU)에 필적합니다.',
            '동인: 향상된 어텐션 메커니즘, 합성 학습 데이터, 파라미터 공유, LoRA 방식의 압축.',
            '시사점: 1–3B 모델은 이제 4 GB RAM 하드웨어에서 요약, Q&A, 코드 자동완성에 실용적입니다.',
          ],
        },
        onDevice: {
          id: 'on-device',
        ...
        finetuningTools: {
          ...
          content: [
            '**2026년 말까지 GUI 기반 노코드 파인튜닝 플랫폼이 출시될 것으로 예상됩니다.** Unsloth와 Axolotl은 현재 커맨드라인 기술이 필요하지만, 차세대 도구는 드래그앤드롭 데이터셋 업로드와 원클릭 LoRA 학습을 제공할 것입니다.',
            '멀티 GPU 학습이 간편해지고 있습니다: 자동 샤딩 및 분산 학습이 주요 프레임워크의 로드맵 기능으로 기본 제공됩니다.',
            '현재 상태(2026년 4월): Unsloth로 RTX 4090에서 7B 모델을 1,000개 예제로 파인튜닝하는 데 약 30분이 소요됩니다. 2027년까지 10분 미만으로 줄어들 것으로 예상됩니다.',
          ],
        },
        reasoning: {
          id: 'reasoning',
        ...
        adoption: {
          ...
          content: [
            ...
            '장기 표준: 하이브리드 아키텍처(일상 업무는 로컬, 피크 용량과 최전선 모델은 클라우드).',
          ],
        },
        challenges: {
          id: 'challenges',
          ...
          items: [
            ...
            '**규제 불확실성:** 데이터 상주 법률(GDPR, HIPAA, 중국 DSL)이 진화하고 있습니다. 로컬 AI의 미래는 부분적으로 이러한 법률이 어떻게 집행되느냐에 달려 있습니다.',
          ],
        },
        commonMistakes: {
          id: 'common-mistakes',
          ...
          faqs: [
            {
              ...
              a: '파라미터당 더 높은 품질을 달성하는 소형 모델입니다. Phi-4 Mini 3.8B와 Llama 3.2 3B(2026)는 벤치마크에서 Llama 3.3 7B(2023)에 필적합니다. 향상된 어텐션, 합성 학습 데이터, 파라미터 공유 등의 아키텍처 개선이 모델 크기를 늘리지 않고 품질을 높이고 있습니다.',
            },
            {
            ...
            },
            {
              ...
              a: '2026년 말에서 2027년. Unsloth와 Axolotl은 현재 커맨드라인 기술이 필요합니다. 노코드 GUI 파인튜닝 플랫폼이 활발히 개발 중입니다. 현재 Unsloth로 RTX 4090에서 7B 모델을 1,000개 예제로 파인튜닝하는 데 약 30분이 소요됩니다 — 개발자에게 실용적인 기준점입니다.',
            },
            {
              q: '2027년까지 몇 개의 기업이 로컬 LLM을 운영하게 되나요?',
              a: '추정에 따르면 대형 기업(직원 1,000명 이상)의 50%가 2027년까지 최소 일부 추론을 온프레미스로 실행할 것이며, 주로 금융, 의료, 법률 분야가 해당됩니다. 2026년에는 규제 산업이 초기 도입자입니다. 2028년까지 하드웨어 비용이 하락하면서 중견 및 중소기업이 시장에 진입합니다.',
            },
            {
