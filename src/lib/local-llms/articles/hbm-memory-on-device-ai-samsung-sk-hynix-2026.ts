...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    schema: {
      ...
      'image': '[www.promptquorum.com/og-images/hbm-memory-on-device-ai-samsung-sk-hynix-2026.png](https://www.promptquorum.com/og-images/hbm-memory-on-device-ai-samsung-sk-hynix-2026.png)',
