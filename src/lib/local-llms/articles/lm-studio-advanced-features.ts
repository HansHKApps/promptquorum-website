...
schema: {
    ...
    es: {
      ...
      schema: {
        ...
        'url': 'https://www.promptquorum.com/es/es/local-llms/lm-studio-advanced-features',
        'datePublished': '2026-04-04',
        'dateModified': '2026-04-18',
        'author': { '@type': 'Person', 'name': 'Hans Kuepper' },
        'publisher': { '@type': 'Organization', 'name': 'PromptQuorum', 'url': 'https://www.promptquorum.com' },
    ...
    ar: {
      freshness_tier: 'semi_annual',
      theme: 'Tools & Interfaces',
      title: 'LM Studio: الميزات المتقدمة 2026 (GPU وLoRA والضبط الدقيق)',
      seoTitle: 'LM Studio 2026: واجهة API محلية وطبقات GPU وLoRA بالتفصيل',
      ...
      metaDescription: 'خادم API الخاص بـ LM Studio (المنفذ 1234) والتحكم في طبقات GPU وضبط نافذة السياق وتحميل LoRA والاستدلال على دفعات: دليل متقدم 2026.',
      publishDate: '2026-04-04',
