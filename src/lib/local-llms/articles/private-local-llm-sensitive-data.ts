...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      toc: [
        ...
        { label: 'Why Local LLMs for Compliance', anchor: '#key-takeaways' },
    ...
    es: {
      ...
      toc: [
        ...
        { label: 'Por qué LLM locales para el cumplimiento', anchor: '#key-takeaways' },
    ...
    ar: {
      ...
      toc: [
        ...
        { label: 'لماذا نماذج LLM المحلية للامتثال', anchor: '#key-takeaways' },
    ...
    pt: {
      ...
      toc: [
        ...
        { label: 'Por que LLMs locais para conformidade', anchor: '#key-takeaways' },
    ...
    fr: {
      ...
      toc: [
        ...
        { label: 'Pourquoi les LLM locaux pour la conformité ?', anchor: '#key-takeaways' },
        { label: 'FAQ', anchor: '#faq' },
      ],
      sections: {
        tldr: {
    ...
    ja: {
      ...
      toc: [
        ...
        { label: 'コンプライアンスのためのローカルLLMが必要な理由', anchor: '#key-takeaways' },
        { label: 'FAQ', anchor: '#faq' },
      ],
      sections: {
        tldr: {
    ...
    zh: {
      ...
      toc: [
        ...
        { label: '为什么本地LLM用于合规性', anchor: '#key-takeaways' },
 ...
 items: ['**Persönliche Daten (Medizin, Finanzen):** Daten können Ihre Kontrolle nicht verlassen. Lokales LLM auf isoliertem Netzwerk, verschlüsselte Speicherung, Zugriffsprotokolle.', '**Zahlungskartendaten:** Niemals Kartennummern in LLM eingeben. PCI-DSS verbietet dies. Nur zu Analysezwecken, nur letzte 4 Ziffern.', '**Anwaltsgeheimnis:** Vertrauliche Dateien können nicht das Anwaltzimmer verlassen. Netzwerk-isolierte Maschine, nur Papierausdruck.', '**Einrichtung:** Ollama oder vLLM auf Linux-Server, isoliert, verschlüsselte Dateisysteme (LUKS), Audit-Logs (ELK), kein Internet. Kosten: 3.000–5.000 € Hardware + 2.000 €/Jahr Updates.', '**DSGVO-konform:** Rechtsgrundlage Art. 6 Abs. 1 f) DSGVO (berechtigtes Interesse); Datenschutzmaßnahmen gemäß Art. 32 DSGVO; DPIA erforderlich (Art. 35).', '**vs Cloud-API:** Cloud = Anbieter kontrolliert Daten + Verantwortungsbruch. Lokal = Sie kontrollieren + Null-Risiko.'] },
  ...
  ko: {
    ...
    heroImage: '/images/private-local-llm-sensitive-data-overview-hero-ko.webp',
      ...
      toc: [
        { label: 'TLDR', anchor: '#key-takeaways' },
        { label: '컴플라이언스를 위한 로컬 LLM의 필요성', anchor: '#key-takeaways' },
        { label: 'FAQ', anchor: '#faq' },
      ],
      schema: {
        '@context': 'https://schema.org',
