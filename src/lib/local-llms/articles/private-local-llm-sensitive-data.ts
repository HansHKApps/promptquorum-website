    ...
    de: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Welches Modell sollte ich für medizinische Daten verwenden?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Llama 3.3 70B oder Qwen2.5 72B sind für Medizin-Textverarbeitung beste Optionen. Beide haben akademisches Feintuning auf biomedizinische Datensätze. Erfordern 48 GB VRAM (~6.500 € Hardware). Für kleinere Aufgaben: Llama 3.3 8B (8 GB VRAM, ~2.500 €).' }},
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 2, 'name': 'Krankenakten / Patientendaten (13B - 70B)', 'description': 'Qwen2.5 32B, Llama 3.3 70B: HIPAA-konform, klinische Zusammenfassungen' },
