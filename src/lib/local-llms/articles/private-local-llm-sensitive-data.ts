...
export const article: Partial<Record<Language, LLMArticle>> = {
    ...
    zh: {
      ...
      sections: {
        ...
        'relatedReading': {
          title: '相关阅读',
          items: [
            '[本地LLM团队设置](/local-llms/local-llm-setup-for-teams?lang=zh)',
            '[安全离线本地LLM工作流](/local-llms/secure-offline-local-llm-workflow?lang=zh)',
            '[企业使用本地LLM的原因](/local-llms/why-enterprises-use-local-llms?lang=zh)',
            '[本地LLM企业合规](/local-llms/enterprise-compliance-local-llms?lang=zh)',
            '[合规级本地LLM部署硬件指南](/local-llms/local-llm-hardware-guide-2026?lang=zh)',
            '[敏感数据处理所需VRAM](/local-llms/how-much-vram-local-llm?lang=zh)',
          ],
        },
        'sources': {
          title: '信息源',
    ...
    de: {
      ...
      sections: {
        ...
        relatedReading: { title: 'Verwandte Artikel', items: ['[DSGVO und KI: Compliance-Anforderungen für LLMs](/local-llms/gdpr-and-ai?lang=de)', '[Lokale LLM vs. Cloud-APIs: Sicherheitsvergleich](/local-llms/local-vs-cloud?lang=de)', '[Ollama auf Linux: Sichere Einrichtung für Unternehmen](/local-llms/ollama-enterprise?lang=de)', '[Air-Gapped Netzwerke: Schritt-für-Schritt-Anleitung](/local-llms/airgapped-guide?lang=de)', '[BDSG und IT-Sicherheit für KMU](/blog/bdsg-itsecurity-sme?lang=de)', '[PCI-DSS für KI-Systeme: Compliance-Checkliste](/local-llms/pci-dss-ai-systems?lang=de)'] },
