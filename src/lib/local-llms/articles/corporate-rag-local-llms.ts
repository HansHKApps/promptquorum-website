...
schema: {
    ...
    ar: {
      ...
      seoTitle: 'RAG مؤسسي بنماذج LLM محلية',
      ...
      metaDescription: 'RAG مؤسسي بنماذج LLM محلية: أسئلة وأجوبة آمنة للمستندات، قواعد معرفة مملوكة، مسارات تدقيق، تحكم وصول متعدد المستخدمين، مؤسسة.',
      publishDate: '2026-04-04',
