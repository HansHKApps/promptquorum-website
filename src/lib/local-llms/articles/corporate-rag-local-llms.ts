...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      heroImage: '/images/corporate-rag-local-llms-overview-hero-en.png',
...
schema: {
    ...
    es: {
      ...
      heroImage: '/images/corporate-rag-local-llms-overview-hero-es.png',
    ...
    ar: {
      ...
      heroImage: '/images/corporate-rag-local-llms-overview-hero-ar.png',
    ...
    pt: {
      ...
      heroImage: '/images/corporate-rag-local-llms-overview-hero-pt.png',
    ...
    de: {
      ...
      heroImage: '/images/corporate-rag-local-llms-overview-hero-de.png',
    ...
    fr: {
      ...
      heroImage: '/images/corporate-rag-local-llms-overview-hero-fr.png',
    ...
    ja: {
      ...
      heroImage: '/images/corporate-rag-local-llms-overview-hero-ja.png',
    ...
    zh: {
      ...
      heroImage: '/images/corporate-rag-local-llms-overview-hero-zh.png',
      seoTitle: '企业RAG本地LLM',
  ...
  ko: {
    ...
    heroImage: '/images/corporate-rag-local-llms-overview-hero-ko.png',
      ...
      sections: {
        ...
        useCases: {
          ...
          rows: [
            ...
            { 'Document Type': '계약서', 'Use': '조항 검색 ("해지 조항은 무엇입니까?")', 'Users': '법무, 구매' },
            { 'Document Type': '기술 문서', 'Use': 'API 레퍼런스, 코드 예제', 'Users': '엔지니어' },
            { 'Document Type': '연구 논문', 'Use': '지식 검색 ("양자 ML 관련 논문은 무엇이 있습니까?")', 'Users': 'R&D 팀' },
            { 'Document Type': '컴플라이언스 문서', 'Use': '규제 조회 ("데이터 보존에 관한 GDPR 요건은 무엇입니까?")', 'Users': '컴플라이언스, 법무' },
            { 'Document Type': '고객 문서', 'Use': '제품 문서, FAQ', 'Users': '지원, 영업' },
          ],
        ...
        relatedReading: {
          ...
          title: '관련 자료',
          items: [
            '[로컬 RAG 2026](/local-llms/local-rag-2026) -- 완전한 RAG 구현 가이드.',
            '[로컬 LLM 엔터프라이즈 확장](/local-llms/scaling-local-llms-enterprise) -- 다중 사용자 인프라.',
            '[기업이 로컬 LLM을 사용하는 이유](/local-llms/why-enterprises-use-local-llms) -- 비즈니스 사례.',
            '[엔터프라이즈 컴플라이언스 로컬 LLM](/local-llms/enterprise-compliance-local-llms) -- 문서 처리를 위한 컴플라이언스.',
          ],
        },
        sources: {
          id: 'sources',
