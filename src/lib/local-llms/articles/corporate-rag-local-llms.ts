    ...
    en: {
      ...
      sections: {
        ...
        useCases: {
          ...
          rows: [
            { 'Document Type': 'Employee handbook', 'RAG Use': 'Policy lookup ("How much PTO do I have?")', 'Typical Users': 'All employees' },
            { 'Document Type': 'Contracts', 'RAG Use': 'Clause search ("What\'s the termination clause?")', 'Typical Users': 'Legal, procurement' },
            { 'Document Type': 'Technical docs', 'RAG Use': 'API reference, code examples', 'Typical Users': 'Engineers' },
            { 'Document Type': 'Research papers', 'RAG Use': 'Knowledge discovery ("Papers on quantum ML?")', 'Typical Users': 'R&D teams' },
            { 'Document Type': 'Compliance docs', 'RAG Use': 'Regulatory lookup ("GDPR requirements for data retention?")', 'Typical Users': 'Compliance, legal' },
            { 'Document Type': 'Customer docs', 'RAG Use': 'Product documentation, FAQ', 'Typical Users': 'Support, sales' },
          ],
...
schema: {
  ...
  ko: {
    ...
    heroImage: '/images/corporate-rag-local-llms-overview-hero-ko.webp',
      ...
      audience: '프로덕션 또는 엔터프라이즈 환경에 로컬 LLM을 배포하는 엔지니어',
      readTime: '12분 읽기',
      educationalLevel: 'Advanced',
      primaryTerm: '기업 지식 베이스',
      toc: [
        { label: '핵심 요약', anchor: '#key-takeaways' },
        { label: '기업용 RAG 활용 사례', anchor: '#use-cases' },
        { label: '대규모 문서 수집', anchor: '#ingestion' },
        { label: '다중 사용자 RAG 아키텍처', anchor: '#architecture' },
        { label: '검색 품질 및 순위', anchor: '#retrieval-quality' },
        { label: '거버넌스 및 감사', anchor: '#governance' },
      ...
      sections: {
        ...
        useCases: {
          ...
          rows: [
            { 'Document Type': '직원 핸드북', 'RAG 활용': '정책 조회 ("연차가 얼마나 남았습니까?")', '주요 사용자': '전체 직원' },
            { 'Document Type': '계약서', 'RAG 활용': '조항 검색 ("해지 조항은 무엇입니까?")', '주요 사용자': '법무, 구매' },
            { 'Document Type': '기술 문서', 'RAG 활용': 'API 레퍼런스, 코드 예제', '주요 사용자': '엔지니어' },
            { 'Document Type': '연구 논문', 'RAG 활용': '지식 검색 ("양자 ML 관련 논문은 무엇이 있습니까?")', '주요 사용자': 'R&D 팀' },
            { 'Document Type': '컴플라이언스 문서', 'RAG 활용': '규제 조회 ("데이터 보존에 관한 GDPR 요건은 무엇입니까?")', '주요 사용자': '컴플라이언스, 법무' },
            { 'Document Type': '고객 문서', 'RAG 활용': '제품 문서, FAQ', '주요 사용자': '지원, 영업' },
          ],
        ...
        faqSection: {
          id: 'faq',
          title: '기업용 RAG에 관한 자주 묻는 질문은 무엇입니까?',
          faqs: [
            {
              q: '기업용 RAG는 문서를 몇 건까지 처리할 수 있습니까?',
              a: '평균 문서 크기와 응답 시간에 따라 다릅니다. 일반적인 범위는 1만~10만 건입니다. 검색 응답 시간은 1초 미만이어야 합니다. 더 느리다면 청킹 또는 임베딩을 최적화하십시오. 실제 문서 세트로 테스트하십시오.',
            },
            {
              q: '어떤 임베딩 모델을 사용해야 합니까?',
              a: '오픈소스 옵션: all-MiniLM-L6-v2(빠름, 우수), BAAI/bge-base-en-v1.5(더 높은 품질). 상용: OpenAI text-embedding-3-small. 로컬 배포 시에는 오픈소스를 사용하십시오. 품질 차이가 중요합니다. 더 좋은 임베딩일수록 더 좋은 검색 결과를 제공합니다.',
            },
            {
              q: '대화 기록을 유지하면서 문서를 업데이트하는 방법은 무엇입니까?',
              a: '대화 기록을 문서 임베딩과 별도로 저장하십시오. 임베딩은 주간 또는 월간 일정으로 업데이트하십시오. 이전 대화는 이전 문서 버전을 참조하지만 이는 문제가 없습니다. 버전 날짜를 문서화하기만 하면 됩니다.',
            },
            {
              q: '기밀 문서에 RAG를 사용할 수 있습니까?',
              a: '네, 로컬 RAG가 이상적입니다. 문서는 사내 네트워크에 유지되고, 쿼리는 외부에 기록되지 않으며, 역할 기반 권한으로 접근을 제어할 수 있습니다. 이는 HIPAA와 GDPR 요건을 충족합니다.',
            },
            {
              q: '의미 단위 청킹과 고정 크기 청킹의 차이는 무엇입니까?',
              a: '고정 크기(예: 512 토큰)는 더 간단하지만 주제를 문장 중간에서 끊습니다. 의미 단위 청킹은 문장 또는 단락 경계를 사용하여 의미를 보존합니다. 의미 단위 청킹은 RAG 품질에 더 유리하지만 설정에 더 많은 시간이 필요합니다.',
            },
            {
              q: 'RAG 품질은 어떻게 측정합니까?',
              a: '측정 지표: retrieval@k(상위 k 결과에서 올바른 문서 포함 여부), 응답 시간(1초 미만 목표), 사용자 만족도(직원 설문). 도메인 전문가와 함께 테스트하십시오. 그들은 "올바른" 답변이 어떤 것인지 알고 있습니다.',
            },
          ],
        },
        relatedReading: {
          ...
          title: '관련 자료',
          items: [
            '[로컬 RAG 2026](/ko/local-llms/local-rag-2026) -- 완전한 RAG 구현 가이드.',
            '[로컬 LLM 엔터프라이즈 확장](/ko/local-llms/scaling-local-llms-enterprise) -- 다중 사용자 인프라.',
            '[기업이 로컬 LLM을 사용하는 이유](/ko/local-llms/why-enterprises-use-local-llms) -- 비즈니스 사례.',
            '[엔터프라이즈 컴플라이언스 로컬 LLM](/ko/local-llms/enterprise-compliance-local-llms) -- 문서 처리를 위한 컴플라이언스.',
          ],
        },
        sources: {
          id: 'sources',
