...
schema: {
    ...
    ar: {
      ...
      seoTitle: 'LLM المحلي مقابل GPU السحابية: مقارنة تكاليف Paperspace وLambda Labs وAWS 2026',
      ...
      metaDescription: 'GPU محلية مقابل حوسبة سحابية: التكلفة لكل ساعة، تحليل نقطة التعادل. Lambda Labs، Paperspace، AWS.',
      publishDate: '2026-04-05',
      dateModified: '2026-04-19',
