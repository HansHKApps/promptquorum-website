...
schema: {
  ...
  schema: { '@context': 'https://schema.org', '@type': 'TechArticle', headline: 'Local LLMs vs. GPU Cloud: Comparaison des coûts 2026', description: 'Coût total de possession des LLM locaux vs. solutions GPU Cloud. Comparaison TCO, analyse ROI et optimisation des coûts pour les entreprises.', url: 'https://www.promptquorum.com/fr/local-llms/local-llm-vs-cloud-gpu-cost', inLanguage: 'fr', datePublished: '2026-01-15', dateModified: '2026-06-14', image: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/api/og/local-llm-vs-cloud-gpu-cost?lang=fr', width: 1200, height: 675 }, author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' }, publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' }, speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] } },
  ...
  schema: { '@context': 'https://schema.org', '@type': 'TechArticle', headline: '本地LLM与云GPU: 2026年成本比较', description: '本地LLM与云GPU解决方案的总拥有成本。TCO比较、ROI分析和企业成本优化。', url: 'https://www.promptquorum.com/zh/local-llms/local-llm-vs-cloud-gpu-cost', inLanguage: 'zh', datePublished: '2026-01-15', dateModified: '2026-06-14', image: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/api/og/local-llm-vs-cloud-gpu-cost?lang=zh', width: 1200, height: 675 }, author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' }, publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' }, speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] } },
