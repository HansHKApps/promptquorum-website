...
schema: {
  ...
  sections: {
    ...
    'relatedReading': { id: 'related-reading', title: 'Weiterführende Artikel', items: ['[Wann sollten Sie lokale und Cloud-LLM-Inferenz kombinieren?](/de/prompt-bites/hybrid-local-cloud-llm-strategy) -- die Architekturfrage, sobald Sie bereits wissen, was günstiger ist.'] },
  },
  schema: {
    '@context': 'https://schema.org',
    '@type': 'TechArticle',
  ...
  sections: {
    ...
    'relatedReading': { id: 'related-reading', title: '関連記事', items: ['[ローカルとクラウドのLLM推論を組み合わせるべきタイミングとは？](/ja/prompt-bites/hybrid-local-cloud-llm-strategy) -- どちらが安いかが分かった後の、アーキテクチャの選択について。'] },
  },
  schema: {
    '@context': 'https://schema.org',
    '@type': 'TechArticle',
