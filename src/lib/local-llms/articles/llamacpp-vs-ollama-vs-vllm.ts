...
schema: {
    ...
    ar: {
      ...
      seoTitle: 'llama.cpp مقابل Ollama مقابل vLLM 2026: السرعة والمعايير',
      ...
      metaDescription: 'llama.cpp: 38 tok/s (الأسرع). Ollama: إعداد في 5 دقائق (الأبسط). vLLM: 250+ tok/s في الدفعة (أعلى إنتاجية). معايير RTX 4090. 2026.',
      publishDate: '2026-04-05',
      dateModified: '2026-04-19',
