...
schema: {
    ...
    es: {
      ...
      seoTitle: 'llama.cpp vs Ollama vs vLLM 2026: Velocidad, Batching y Benchmarks GPU',
      ...
      metaDescription: 'llama.cpp: 38 tok/s por token (más rápido). Ollama: 5 minutos de setup (más simple). vLLM: 250+ tok/s en batch (mayor throughput). Benchmarks RTX 4090. Abril 2026.',
      publishDate: '2026-04-05',
      dateModified: '2026-04-19',
