...
export const article: Partial<Record<Language, LLMArticle>> = {
    en: {
      ...
      heroImage: '/images/laptop-vs-desktop-local-llm-overview-hero-en.png',
...
schema: {
    ...
    es: {
      ...
      heroImage: '/images/laptop-vs-desktop-local-llm-overview-hero-es.png',
    ...
    ar: {
      ...
      heroImage: '/images/laptop-vs-desktop-local-llm-overview-hero-ar.png',
    ...
    pt: {
      ...
      heroImage: '/images/laptop-vs-desktop-local-llm-overview-hero-pt.png',
    ...
    de: {
      ...
      heroImage: '/images/laptop-vs-desktop-local-llm-overview-hero-de.png',
...
schema: {
    ...
    fr: {
      ...
      heroImage: '/images/laptop-vs-desktop-local-llm-overview-hero-fr.png',
...
schema: {
    ...
    ja: {
      ...
      heroImage: '/images/laptop-vs-desktop-local-llm-overview-hero-ja.png',
...
schema: {
    ...
    zh: {
      ...
      heroImage: '/images/laptop-vs-desktop-local-llm-overview-hero-zh.png',
...
schema: {
  ...
  ko: {
    ...
    heroImage: '/images/laptop-vs-desktop-local-llm-overview-hero-ko.png',
      ...
      sections: {
        ...
        appleSilicon: {
          ...
          rows: [
            ...
            { 'Chip': 'Mac Mini M4 (데스크톱)', 'RAM Options': '16-64 GB', 'Speed (8B)': '20-25 tok/sec', 'Max Model': '13B Q4', 'Throttles?': '없음' },
            { 'Chip': 'Mac Studio M2 Ultra (데스크톱)', 'RAM Options': '64-192 GB', 'Speed (8B)': '50-60 tok/sec', 'Max Model': '70B Q4 네이티브', 'Throttles?': '없음' },
          ],
        },
        proTip: {
          id: 'pro-tip',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'MacBook Pro 16" M5 Max(128 GB 통합 메모리)는 Q4 양자화 포맷의 Llama 3.3 70B(~40 GB 필요)를 기술적으로 로드할 수 있는 최초의 노트북입니다. 그러나 열 스로틀링으로 인해 지속 추론이 15-18분으로 제한되어 실제 70B 작업에는 비실용적입니다. Mac Studio M2 Ultra는 스로틀링 없이 70B를 네이티브로 50-60 tok/sec로 실행할 수 있습니다. 지속적인 70B 성능을 위해서는 RTX 5090(32 GB VRAM)을 갖춘 데스크톱이 가장 실용적인 솔루션입니다.',
            },
            {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': { '@type': 'Answer', 'text': '외부 GPU 인클로저 없이는 표준 노트북으로 Llama 3.3 70B를 실행할 수 없습니다. Q4 양자화에서도 70B 모델은 ~40 GB VRAM이 필요합니다. Mac Studio M2 Ultra는 70B를 네이티브로 50-60 tok/sec로 실행할 수 있습니다. Apple 이외 시스템의 경우, CPU 오프로딩과 함께 RTX 4090(24 GB VRAM)을 갖춘 데스크톱이 실용적인 솔루션입니다.' },
          },
          {
            '@type': 'Question',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 5, 'name': 'Mac Studio M2 Ultra', 'description': '$4,000 · 50-60 tok/sec · ~$67/tok/sec · 스로틀링 없이 70B를 네이티브로 실행하는 유일한 소비자용 Mac.' },
        ],
      },
      gammaEmbedUrl: '/presentations/laptop-vs-desktop-local-llm-static.html',
