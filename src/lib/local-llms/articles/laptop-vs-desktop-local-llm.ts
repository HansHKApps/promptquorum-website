...
schema: {
  ...
  ko: {
      ...
      seoTitle: '로컬 LLM용 노트북 vs 데스크톱: 7배 비용 차이, 열 제한 데이터 및 2026 구매 가이드',
      ...
      metaDescription: '데스크톱 RTX 4070 Ti: 지속 80 tok/sec, tok/sec당 $19. MacBook M5 Max: 55-70 tok/sec(추정), 15-18분 후 스로틀링, tok/sec당 $100. 전체 열 데이터, 비용 분석, M5 Max 70B 지원 여부, 2026 구매 가이드.',
      publishDate: '2026-04-04',
      dateModified: '2026-05-05',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[로컬 LLM 양자화 방법](/local-llms/how-to-quantize-local-llm) — Q4/Q8 양자화로 제한된 VRAM에서 더 큰 모델 실행.',
            '[Ollama용 최고의 오픈소스 모델](/local-llms/top-open-source-models-ollama) — 하드웨어 등급별 최고의 Llama, Qwen, Mistral 모델.',
            '[로컬 LLM을 위한 프롬프트 엔지니어링](/prompt-engineering/prompt-engineering-for-local-llms) — 하드웨어 제약이 있는 로컬 모델을 위한 프롬프트 최적화.',
