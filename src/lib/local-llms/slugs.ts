...
export const LLM_SLUG_TO_KEY: Record<string, string> = {
  ...
  'open-weight-vs-open-source-ai-models': 'open-weight-vs-open-source-ai-models',
  ...
  'best-llm-api-gateway':                    'best-llm-api-gateway-2026',
  'best-ai-code-review-tools':               'best-ai-code-review-tools-2026',
  'local-ai-code-review-vs-coderabbit':      'local-ai-code-review-vs-coderabbit-2026',
  'best-llm-fine-tuning-framework':          'best-llm-fine-tuning-framework-2026',
  'best-ai-agent-framework':                 'best-ai-agent-framework-2026',
  'best-llm-evaluation-tools':               'best-llm-evaluation-tools-2026',
  'best-llm-observability-tools':            'best-llm-observability-tools-2026',
  'best-vector-database':                    'best-vector-database-2026',
  // Enterprise/B2B sprint 2026-09-02
  'enterprise-gpu-server-buying-guide':      'enterprise-gpu-server-buying-guide-2026',
