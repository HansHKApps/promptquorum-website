  ...
  en: {
    ...
    sections: {
      ...
      starterKit: {
        ...
        columns: ['Category', 'Device', 'Link', 'Why'],
        rows: [
          { 'Category': 'Hub', 'Device': 'Home Assistant Green', 'Link': '[Home Assistant Green](https://www.home-assistant.io/green/)', 'Why': 'Speaks all local protocols, runs offline', 'Description': 'Pre-built local hub for Zigbee, Z-Wave, Matter, and Thread; runs automations offline.' },
          { 'Category': 'Lighting', 'Device': 'Philips Hue Zigbee bulbs', 'Link': '[Philips Hue Zigbee bulbs](https://www.amazon.com/s?k=Philips+Hue+bulb)', 'Why': 'Instant local control', 'Description': 'Zigbee bulbs that pair to a local coordinator for instant, cloud-free control.' },
          { 'Category': 'Lock', 'Device': 'Yale Assure Lock (Z-Wave)', 'Link': '[Yale Assure Lock](https://shopyalehome.com/products/yale-assure-lock-2-touch-key-free-with-z-wave-plus)', 'Why': 'Reliable local security', 'Description': 'Z-Wave smart lock with reliable local control and no cloud dependency for core locking.' },
          { 'Category': 'Sensors', 'Device': 'Aqara P1 motion sensor', 'Link': '[Aqara P1 motion sensor](https://www.aqara.com/en/product/motion-sensor-p1/)', 'Why': 'Local automation triggers', 'Description': 'Zigbee motion sensor that triggers local automations with no internet dependency.' },
          { 'Category': 'Camera', 'Device': 'Reolink RLC-810A', 'Link': '[Reolink RLC-810A](https://reolink.com/product/rlc-810a/)', 'Why': 'Private AI detection, no fees', 'Description': 'RTSP/PoE camera compatible with Frigate for private, subscription-free AI detection.' },
          { 'Category': 'Plug', 'Device': 'SONOFF Zigbee smart plug', 'Link': '[SONOFF Zigbee smart plug](https://sonoff.tech/en-us/products/sonoff-zigbee-smart-plug-iplug-series-s40-lite)', 'Why': 'Local control, no cloud account', 'Description': 'Zigbee smart plug controlled locally through a hub, no cloud account required.' },
        ],
    ...
    sections: {
      ...
      starterKit: {
        ...
        rows: [
          ...
          { 'Categoria': 'Fechadura', 'Dispositivo': 'Yale Assure Lock (Z-Wave)', 'Link': '[Yale Assure Lock](https://shopyalehome.com/products/yale-assure-lock-2-touch-key-free-with-z-wave-plus)', 'Por quê': 'Segurança local confiável', 'Description': 'Fechadura inteligente Z-Wave com controle local confiável e sem dependência de nuvem para a função básica de tranca.' },
