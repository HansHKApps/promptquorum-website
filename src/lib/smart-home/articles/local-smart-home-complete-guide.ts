...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    intro:
      'يُشغِّل المنزل الذكي المحلي كل جهاز وكل أتمتة وكل أمر صوتي على أجهزتك المملوكة، دون حساب سحابي في الحلقة. يُعرِّف هذا الدليل النموذج المحلي أولًا، ويشرح سبب نموه في 2026، ويُفكِّك البنية طبقةً طبقة — المركز، والبروتوكولات، والصوت، وعقل الذكاء الاصطناعي المحلي — ويوضح ما يمكنك تشغيله في المنزل اليوم، وتكلفته، وكيفية البدء.',
    metaDescription:
      'المنزل الذكي المحلي يُشغِّل كل جهاز وأتمتة على أجهزتك الخاصة — بدون سحابة، يعمل دون إنترنت، خصوصية كاملة. الدليل الشامل لبنية 2026 المحلية أولًا.',
    twitterDescription:
      'ابنِ منزلًا ذكيًا بدون سحابة: كل جهاز وأتمتة وأمر صوتي يعمل على أجهزتك الخاصة. البنية المحلية أولًا الشاملة لعام 2026.',
    readTime: '11 دقائق للقراءة',
    educationalLevel: 'Intermediate',
    audience: 'أصحاب المنازل المهتمون بالخصوصية والذين يبنون منزلًا ذكيًا مستضافًا ذاتيًا',
    primaryTerm: 'local smart home',
    targetKeywords: [
      'منزل ذكي محلي بدون سحابة',
      'منزل ذكي محلي',
      'منزل ذكي مستضاف ذاتيًا',
      'منزل ذكي خاص',
      'منزل ذكي دون إنترنت',
    ],
    leadAnswerBlock:
      '**يعالج المنزل الذكي المحلي كل جهاز وأتمتة وأمر صوتي على أجهزتك الخاصة — لا حساب سحابي، ولا بيانات تغادر المنزل، وعمل كامل حتى عند انقطاع الإنترنت.** تتألف البنية من مركز محلي (Home Assistant)، وبروتوكولات محلية (Matter/Thread، وZigbee، وZ-Wave)، وصوت محلي، وجديد 2026 — نموذج لغوي محلي كعقل للأتمتة.',
    quickAnswerTop: {
      ar: {
        question: 'ما هو المنزل الذكي المحلي؟',
        answer:
          'المنزل الذكي المحلي هو إعداد يعمل فيه المركز والأجهزة والأتمتة والتحكم الصوتي على أجهزة في منزلك وليس في سحابة مورِّد. يستمر في العمل دون إنترنت، ولا يتطلب اشتراكات، ولا يُرسل بيانات استخدام إلى أطراف ثالثة. Home Assistant هو المركز المحلي الأولى الأكثر استخدامًا.',
        bullets: [
          'تعمل طبقة التحكم في منزلك (Home Assistant)، وليس في سحابة مورِّد',
          'يعمل أثناء انقطاع الإنترنت أو انهيار سحابة المورِّد',
          'لا اشتراكات ولا معالج بيانات خارجي',
          'الصوت المحلي (Whisper + Piper) يحل محل Alexa/Google',
          'يمكن لنموذج لغوي محلي أن يعمل كعقل أتمتة باللغة الطبيعية',
        ],
        updatedDate: '2026-06',
      },
    },
    toc: [
      ...
      { label: 'لماذا ينمو النهج المحلي', anchor: 'why-local' },
      { label: 'البنية المحلية أولًا', anchor: 'the-stack' },
      { label: 'ما يمكنك تشغيله محليًا', anchor: 'what-you-can-run' },
      { label: 'التكلفة والجهد', anchor: 'cost-effort' },
      { label: 'كيفية البدء', anchor: 'how-to-start' },
      { label: 'الأسئلة الشائعة', anchor: 'faq' },
    ],
    snippetBlocks: [
      { type: 'one-sentence', content: 'يُشغِّل المنزل الذكي المحلي المركز والأجهزة والأتمتة والتحكم الصوتي على أجهزتك المملوكة — لا حساب سحابي، ويستمر في العمل دون إنترنت.' },
      { type: 'plain-terms', content: 'تُوجِّه معظم المنازل الذكية الأوامر عبر سحابة مورِّد: تضغط زرًا فينتقل الطلب إلى خادم الشركة الذي يخبر جهازك بما يجب فعله. يُزيل المنزل الذكي المحلي الخادم من المعادلة. مركز في منزلك (عادةً Home Assistant) يتحدث مباشرةً إلى أجهزتك عبر البروتوكولات المحلية، لذا لا شيء يتوقف عند انقطاع الإنترنت ولا تغادر بيانات الاستخدام شبكتك.' },
    ],
    sections: {
      tldr: {
        id: 'tldr',
        ...
        isTldr: true,
        items: [
          'يعني التحكم المحلي بقاء مسار الأمر من المركز إلى الجهاز داخل منزلك؛ التحكم السحابي يُمرِّره عبر خادم مورِّد',
          'استخدم مركزًا محليًا (Home Assistant على Raspberry Pi أو جهاز كمبيوتر مصغر) كأساس',
          'فضِّل الأجهزة التي تتحدث Matter/Thread أو Zigbee أو Z-Wave — تعمل محليًا بدون جسر مورِّد',
          'استبدل Alexa/Google بالصوت المحلي: Home Assistant Assist + Whisper (كلام إلى نص) + Piper (نص إلى كلام)',
          'جديد 2026: نموذج لغوي محلي عبر Ollama يمكنه تشغيل التحكم بلغة طبيعية والأتمتة الواعية بالسياق على نفس الجهاز',
          'التبادل: جهد إعداد أولي أعلى مقابل الخصوصية والموثوقية دون إنترنت وبدون اشتراكات',
        ],
      },
      whatItMeans: {
        id: 'what-it-means',
        title: 'ما يعنيه المنزل الذكي المحلي فعليًا',
        content:
          '**يُبقي المنزل الذكي المحلي مسار التحكم — الرابط بين "أريد إضاءة النور" وإضاءته فعليًا — داخل منزلك بالكامل.** تُرسل المنازل الذكية السحابية الأمر إلى خادم مورِّد أولًا؛ المنازل الذكية المحلية لا تفعل ذلك. الخط الفاصل هو أين يُتخَذ القرار، وليس أي علامة تجارية تشتري.',
        items: [
          '**التحكم السحابي:** يُرسل تطبيقك أو مساعدك الصوتي الأمر إلى سحابة مورِّد تُعيد توجيهه إلى الجهاز. إذا انهارت السحابة أو الإنترنت، يتوقف الجهاز عن الاستجابة.',
          '**التحكم المحلي:** مركز في منزلك (Home Assistant) يُرسل الأمر مباشرةً إلى الجهاز عبر بروتوكول محلي. لا رحلة إنترنت ذهابًا وإيابًا، لا خادم خارجي.',
          '**لماذا يهم الفرق:** التحكم المحلي يحدد الخصوصية (لا سجلات استخدام تغادر المنزل)، والموثوقية (يعمل دون إنترنت)، والعمر الافتراضي (لا يمكن لإيقاف سحابة مورِّد تعطيل الجهاز).',
        ],
        columns: ['البُعد', 'المنزل الذكي السحابي', 'المنزل الذكي المحلي'],
        rows: [
          { 'البُعد': 'الخصوصية', 'المنزل الذكي السحابي': 'بيانات الاستخدام والصوت والكاميرا على خوادم المورِّد', 'المنزل الذكي المحلي': 'البيانات تبقى على أجهزتك' },
          { 'البُعد': 'يعمل دون إنترنت', 'المنزل الذكي السحابي': 'لا — معظم الميزات تحتاج السحابة', 'المنزل الذكي المحلي': 'نعم — يعمل على شبكتك المحلية' },
          { 'البُعد': 'الاشتراكات', 'المنزل الذكي السحابي': 'شائعة (تخزين الكاميرا، الميزات المميزة)', 'المنزل الذكي المحلي': 'لا شيء — تكلفة جهاز واحدة فقط' },
          { 'البُعد': 'موقع البيانات', 'المنزل الذكي السحابي': 'مركز بيانات المورِّد (في الخارج كثيرًا)', 'المنزل الذكي المحلي': 'منزلك' },
      ...
      whyLocal: {
        id: 'why-local',
        title: 'لماذا ينمو النهج المحلي أولًا في 2026',
        content:
          '**يتزايد اعتماد النهج المحلي أولًا لأن المقايضات السحابية أصبحت ملموسة: إيقاف التشغيل الذي يُعطِّل الأجهزة، والرسوم المتكررة، والانقطاعات، وانكشاف الخصوصية — في حين أصبح الذكاء الاصطناعي المحلي قابلًا للتشغيل في المنزل.** كل هذا أسباب محددة قابلة للتحقق لا مجرد تفضيل عام.',
        items: [
          '**إيقاف التشغيل السحابي يُعطِّل الأجهزة:** عندما يُوقف المورِّد سحابة منتج ما، قد تفقد الأجهزة المعتمدة وظائفها الأساسية بين عشية وضحاها. الأجهزة المحلية تستمر في العمل لأنها لا تحتاج شيئًا خارجيًا.',
          '**الموثوقية:** يستجيب المنزل الذكي المحلي أثناء انقطاع الإنترنت وحوادث سحابة المورِّد. لا تعتمد الأضواء والأقفال والأتمتة على توفر خادم بعيد.',
          '**الخصوصية:** تجمع الأجهزة السحابية أنماط الاستخدام والتسجيلات الصوتية ومقاطع الكاميرا. التحكم المحلي يُزيل المعالج الخارجي بالكامل — راجع [مخاطر خصوصية المنزل الذكي](/ar/smart-home/smart-home-privacy-risks).',
          '**لا اشتراكات:** يتجنب تسجيل الكاميرا المحلي والأتمتة المحلية الرسوم الشهرية التي تُلحقها المنظومات السحابية بالتخزين والميزات المميزة.',
          '**الذكاء الاصطناعي المحلي أصبح عمليًا الآن:** نماذج صغيرة قادرة تعمل على جهاز كمبيوتر مصغر، لذا يمكن لنموذج لغوي محلي أن يعمل كعقل الأتمتة — قدرة لم تكن متوفرة للمستخدمين المنزليين قبل سنوات قليلة. راجع [تشغيل منزلك الذكي بنموذج لغوي محلي](/ar/smart-home/local-llm-smart-home-complete-guide).',
        ],
      },
      theStack: {
        id: 'the-stack',
        title: 'البنية المحلية أولًا، طبقةً طبقة',
        content:
          '**المنزل الذكي المحلي أربع طبقات: مركز، وبروتوكولات أجهزة محلية، وصوت محلي، وعقل ذكاء اصطناعي محلي اختياري.** ابنِها بهذا الترتيب — المركز أولًا، والذكاء الاصطناعي أخيرًا.',
        numberedItems: [
          { title: 'المركز — Home Assistant', whyItMatters: 'طبقة التحكم. Home Assistant برنامج مفتوح المصدر يعمل على Raspberry Pi أو جهاز كمبيوتر مصغر أو NAS ويتحدث مباشرةً إلى أجهزتك. ابدأ هنا — راجع [بدء استخدام Home Assistant](/ar/smart-home/home-assistant-getting-started).' },
          { title: 'البروتوكولات — Matter/Thread، Zigbee، Z-Wave', whyItMatters: 'كيف تتواصل الأجهزة محليًا. Zigbee وZ-Wave معياران شبكيان ناضجان منخفضا الطاقة؛ Thread شبكة حديثة؛ Matter طبقة التوحيد. تعمل جميعها بدون سحابة مورِّد — راجع [التحكم المحلي بـ Matter](/ar/smart-home/matter-local-control-guide).' },
      ...
      whatYouCanRun: {
        id: 'what-you-can-run',
        title: 'ما يمكنك تشغيله محليًا اليوم',
        content:
          '**الإضاءة والمناخ والأمن وأجهزة الاستشعار والصوت وأتمتة الذكاء الاصطناعي تعمل جميعها محليًا في 2026 — السحابة اختيارية لا مطلوبة.** يُعيِّن الجدول أدناه كل فئة إلى خيارها المحلي.',
        columns: ['الفئة', 'الخيار المحلي', 'ملاحظات'],
        rows: [
          { 'الفئة': 'الإضاءة', 'الخيار المحلي': 'مصابيح Zigbee/Matter + Home Assistant', 'ملاحظات': 'استجابة محلية فورية؛ لا تسجيل دخول لتطبيق سحابي' },
          { 'الفئة': 'المناخ', 'الخيار المحلي': 'منظمات حرارة محلية / TRVs عبر Zigbee أو Z-Wave', 'ملاحظات': 'الجداول والأتمتة تعمل على المركز' },
          { 'الفئة': 'الأمن', 'الخيار المحلي': 'كاميرات محلية + Frigate', 'ملاحظات': 'كشف بالذكاء الاصطناعي على الجهاز؛ راجع الكاميرات بالذكاء الاصطناعي المحلي أدناه' },
          { 'الفئة': 'أجهزة الاستشعار', 'الخيار المحلي': 'استشعار الحركة والباب ودرجة الحرارة عبر Zigbee/Z-Wave', 'ملاحظات': 'تُشغِّل الأتمتة بدون إنترنت' },
          { 'الفئة': 'الصوت', 'الخيار المحلي': 'Assist + Whisper + Piper', 'ملاحظات': 'كلمة تنبيه وأوامر كاملة دون إنترنت' },
          { 'الفئة': 'أتمتة الذكاء الاصطناعي', 'الخيار المحلي': 'نموذج لغوي محلي عبر Ollama', 'ملاحظات': 'تحكم بلغة طبيعية وقواعد واعية بالسياق' },
        ],
        items: [
          'لكاميرات الذكاء الاصطناعي الخاصة تحديدًا، [Frigate](/ar/smart-home/local-ai-security-camera) يُشغِّل الكشف عن الأشياء والأشخاص محليًا بدون اشتراك.',
          'للأجهزة اللازمة لتشغيل كل هذا — بما في ذلك نموذج لغوي محلي — راجع [أفضل الأجهزة للمنزل الذكي المحلي](/ar/smart-home/best-hardware-for-local-smart-home).',
        ],
      },
      costEffort: {
        id: 'cost-effort',
        title: 'ما تكلفته والجهد الذي يستغرقه',
        content:
          '**يتبادل المنزل الذكي المحلي جهد إعداد أولي أعلى مقابل صفر اشتراكات وتحكم طويل الأمد.** الملخص الصادق: تقضي عطلة نهاية أسبوع وتكلفة أجهزة لمرة واحدة بدلًا من رسوم شهرية والارتباط بالمورِّد.',
        items: [
          '**الأجهزة:** Raspberry Pi يُشغِّل مركزًا محليًا أساسيًا؛ جهاز كمبيوتر مصغر هو الاختيار الأفضل إذا أردت تشغيل نموذج لغوي محلي أيضًا. خطِّط لتكلفة جهاز لمرة واحدة، لا رسومًا متكررة.',
          '**الجهد:** توقع منحنى تعلم لإعداد Home Assistant وإقران الأجهزة وكتابة أول أتمتة. العائد هو نظام لا يستطيع أي مورِّد تغييره أو إيقافه.',
          '**استخدم المسار المحلي أولًا إذا:** كانت الخصوصية أو الموثوقية دون إنترنت أو تجنب الاشتراكات تهمك.',
          '**ابقَ مع السحابة إذا:** أردت صفر صيانة ولا تلمس الإعداد أبدًا — لكن اقبل مقايضات البيانات والانقطاع والاشتراك في [لماذا المحلي يتفوق على السحابة](/ar/smart-home/why-local-smart-home-beats-cloud).',
        ],
      },
      howToStart: {
        id: 'how-to-start',
        title: 'كيفية البدء بمنزل ذكي محلي',
        content:
          '**ابدأ بالمركز وغرفة واحدة ثم توسَّع — لا تشترِ أجهزة لكامل المنزل أولًا.** أسرع مسار موثوق هو Home Assistant على Raspberry Pi أو جهاز كمبيوتر مصغر، ومنسِّق Zigbee، وبضعة أجهزة محلية.',
        numberedItems: [
          'ثبِّت Home Assistant على Raspberry Pi أو جهاز كمبيوتر مصغر — [دليل البدء](/ar/smart-home/home-assistant-getting-started).',
          'اختر أجهزة مع مجال للنمو إذا أردت ذكاءً اصطناعيًا محليًا — [دليل الأجهزة](/ar/smart-home/best-hardware-for-local-smart-home).',
          'أضف أجهزة محلية افتراضيًا عبر Matter/Thread أو Zigbee أو Z-Wave — [التحكم المحلي بـ Matter](/ar/smart-home/matter-local-control-guide).',
          'أضف الصوت المحلي بعد أن تعمل الأجهزة — [مساعد صوتي محلي](/ar/smart-home/local-voice-assistant-smart-home).',
          'أضف عقل النموذج اللغوي المحلي أخيرًا — [تشغيل منزلك الذكي بنموذج لغوي محلي](/ar/smart-home/local-llm-smart-home-complete-guide).',
          'لقرّاء دول الاتحاد الأوروبي، تحقق من الموقف الخصوصي — [منزل ذكي خاص متوافق مع GDPR](/ar/smart-home/private-smart-home-gdpr).',
        ],
      },
      faqSection: {
        id: 'faq',
        ...
        faqs: [
          { q: 'هل المنزل الذكي المحلي صعب الإعداد؟', a: 'يستغرق جهدًا أكثر من الإعداد السحابي plug-and-play، بشكل رئيسي تثبيت Home Assistant وإقران الأجهزة. معظم الناس يُشغِّلون مركزًا وأول أتمتة في عطلة نهاية أسبوع ثم يتوسعون تدريجيًا. لا يلزم برمجة للإعدادات الشائعة، وإن كان إعداد YAML متاحًا للأتمتة المتقدمة.' },
          { q: 'هل يعمل المنزل الذكي المحلي بدون إنترنت؟', a: 'نعم. لأن المركز والأجهزة يتواصلان عبر شبكتك المحلية، تستمر الأضواء والأقفال وأجهزة الاستشعار والأتمتة في العمل أثناء انقطاع الإنترنت أو سحابة المورِّد. تخسر فقط الإضافات المعتمدة على الإنترنت كالوصول عن بُعد والإشعارات السحابية.' },
          { q: 'هل أحتاج إلى اشتراك للمنزل الذكي المحلي؟', a: 'لا. Home Assistant مجاني ومفتوح المصدر، والأجهزة المحلية لا رسوم متكررة عليها. تدفع تكاليف أجهزة مرة واحدة فقط. إضافات مدفوعة اختيارية موجودة (مثلًا مرحِّل سحابي للوصول عن بُعد السهل)، لكن التحكم المحلي الأساسي لا يحتاج اشتراكًا.' },
          { q: 'هل يمكنني تشغيل الذكاء الاصطناعي محليًا لمنزلي الذكي؟', a: 'نعم. يمكن لنموذج لغوي محلي عبر Ollama أن يعمل كعميل محادثة وعقل أتمتة داخل Home Assistant، يُشغِّل التحكم في الأجهزة بلغة طبيعية على أجهزتك الخاصة بدون سحابة. جهاز كمبيوتر مصغر يتعامل مع النماذج الصغيرة بسهولة؛ راجع دليل المنزل الذكي بنموذج لغوي محلي.' },
          { q: 'هل المنزل الذكي المحلي متوافق مع GDPR؟', a: 'المعالجة المحلية تحتفظ ببيانات الأجهزة والصوت والكاميرا على أجهزة في منزلك، مما يدعم تقليل بيانات GDPR والإقامة بالتصميم لأنه لا يوجد معالج خارجي. راجع دليل المنزل الذكي الخاص المتوافق مع GDPR لقائمة التحقق للمشترين في الاتحاد الأوروبي.' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
        ...
        items: [
          '[Home Assistant: دليل البدء](/ar/smart-home/home-assistant-getting-started) — ثبِّت المركز المحلي الذي يُثبِّت البنية',
          '[لماذا المنزل الذكي المحلي يتفوق على السحابة](/ar/smart-home/why-local-smart-home-beats-cloud) — حجة الموثوقية والخصوصية والتكلفة',
          '[تشغيل منزلك الذكي بنموذج لغوي محلي](/ar/smart-home/local-llm-smart-home-complete-guide) — أضف عقلًا بذكاء اصطناعي بلغة طبيعية',
          '[بناء مساعد صوتي محلي كامل](/ar/smart-home/local-voice-assistant-smart-home) — استبدل Alexa بـ Assist + Whisper + Piper',
          '[كيفية تثبيت Ollama](/ar/local-llms/how-to-install-ollama) — تشغيل نموذج محلي (عبر المجموعات: آليات النموذج اللغوي)',
          '[أسهل تطبيق ذكاء اصطناعي محلي](/ar/power-local-llm/easiest-local-ai-app-windows-mac-linux) — تطبيقات ذكاء اصطناعي محلية يمكن تشغيلها على نفس الأجهزة',
        ],
      },
    },
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      headline: 'المنزل الذكي المحلي: الدليل الشامل بدون سحابة (2026)',
      description: 'المنزل الذكي المحلي يُشغِّل كل جهاز وأتمتة على أجهزتك الخاصة — بدون سحابة، يعمل دون إنترنت، خصوصية كاملة. الدليل الشامل لبنية 2026 المحلية أولًا.',
      url: 'https://www.promptquorum.com/ar/smart-home/local-smart-home-complete-guide',
      inLanguage: 'ar',
      author: { '@type': 'Person', name: 'Hans Kuepper' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      datePublished: '2026-06-04',
      dateModified: '2026-06-04',
      about: [{ '@type': 'Thing', name: 'المنزل الذكي المحلي' }, { '@type': 'Thing', name: 'Home Assistant' }, { '@type': 'Thing', name: 'خصوصية أتمتة المنزل' }],
      speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
    },
    faqSchema: {
      '@context': 'https://schema.org',
      ...
      inLanguage: 'ar',
      mainEntity: [
        { '@type': 'Question', name: 'هل المنزل الذكي المحلي صعب الإعداد؟', acceptedAnswer: { '@type': 'Answer', text: 'يستغرق جهدًا أكثر من الإعداد السحابي — بشكل رئيسي تثبيت Home Assistant وإقران الأجهزة — لكن معظم الناس يُشغِّلون مركزًا وأول أتمتة في عطلة نهاية أسبوع. لا برمجة مطلوبة للإعدادات الشائعة.' } },
        { '@type': 'Question', name: 'هل يعمل المنزل الذكي المحلي بدون إنترنت؟', acceptedAnswer: { '@type': 'Answer', text: 'نعم. المركز والأجهزة يتواصلان عبر شبكتك المحلية، لذا تستمر الأضواء والأقفال وأجهزة الاستشعار والأتمتة في العمل أثناء انقطاع الإنترنت أو سحابة المورِّد.' } },
        { '@type': 'Question', name: 'هل أحتاج إلى اشتراك للمنزل الذكي المحلي؟', acceptedAnswer: { '@type': 'Answer', text: 'لا. Home Assistant مجاني ومفتوح المصدر والأجهزة المحلية لا رسوم متكررة عليها. تدفع تكاليف أجهزة مرة واحدة فقط.' } },
        { '@type': 'Question', name: 'هل يمكنني تشغيل الذكاء الاصطناعي محليًا لمنزلي الذكي؟', acceptedAnswer: { '@type': 'Answer', text: 'نعم. يمكن لنموذج لغوي محلي عبر Ollama أن يعمل كعقل أتمتة داخل Home Assistant، يُشغِّل التحكم في الأجهزة بلغة طبيعية على أجهزتك الخاصة بدون سحابة.' } },
        { '@type': 'Question', name: 'هل المنزل الذكي المحلي متوافق مع GDPR؟', acceptedAnswer: { '@type': 'Answer', text: 'المعالجة المحلية تحتفظ ببيانات الأجهزة والصوت والكاميرا في منزلك، مما يدعم تقليل بيانات GDPR والإقامة بالتصميم لأنه لا معالج خارجي.' } },
      ],
    },
  },
  ...
  ja: {
    ...
    metaDescription:
      'ローカルスマートホーム完全ガイド（2026）：すべてのデバイスと自動化を自分のハードウェアで管理。クラウド不要、オフライン動作、完全プライベート。Home Assistant を中心にしたハブ・プロトコル・音声・ローカルAIの構成を解説。',
    twitterDescription:
    ...
    schema: {
      ...
      description: 'ローカルスマートホーム完全ガイド（2026）：すべてのデバイスと自動化を自分のハードウェアで管理。クラウド不要、オフライン動作、完全プライベート。Home Assistant を中心にしたハブ・プロトコル・音声・ローカルAIの構成を解説。',
  ...
  zh: {
    ...
    metaDescription:
      '本地智能家居完整搭建指南（2026）：所有设备与自动化在本地硬件上独立运行，无云端账号，断网可用，零订阅费用。涵盖 Home Assistant 中枢、本地通信协议、语音控制及本地AI自动化完整架构方案。',
    twitterDescription:
    ...
    schema: {
      ...
      description: '本地智能家居完整搭建指南（2026）：所有设备与自动化在本地硬件上独立运行，无云端账号，断网可用，零订阅费用。涵盖 Home Assistant 中枢、本地通信协议、语音控制及本地AI自动化完整架构方案。',
