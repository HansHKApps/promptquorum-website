    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Home Assistant Energy Dashboard: Complete Setup Guide (2026)](/smart-home/home-assistant-energy-dashboard-guide) — track and visualize your home energy use',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[لوحة Energy في Home Assistant: دليل الإعداد الكامل (⁨2026⁩)](/ar/smart-home/home-assistant-energy-dashboard-guide) — تتبّع استهلاك الطاقة المنزلي ومراقبته بصريًا',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Home Assistant Energie-Dashboard: Komplette Einrichtungsanleitung (2026)](/de/smart-home/home-assistant-energy-dashboard-guide) – Ihren Energieverbrauch erfassen und visualisieren',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Panel de Energía de Home Assistant: guía completa de configuración (2026)](/es/smart-home/home-assistant-energy-dashboard-guide) — visualiza y controla el consumo energético de tu hogar',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Home Assistant Energy 대시보드: 완전 설정 가이드 (2026년)](/ko/smart-home/home-assistant-energy-dashboard-guide) — 가정의 에너지 사용량을 추적하고 시각화',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Tableau de bord Énergie de Home Assistant : guide complet de configuration (2026)](/fr/smart-home/home-assistant-energy-dashboard-guide) — suivez et visualisez la consommation énergétique de votre logement',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Home Assistant Energyダッシュボード：完全設定ガイド（2026年）](/ja/smart-home/home-assistant-energy-dashboard-guide) — 家庭のエネルギー使用量を追跡・可視化する',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Painel de Energia do Home Assistant: guia completo de configuração (2026)](/pt/smart-home/home-assistant-energy-dashboard-guide) — acompanhe e visualize o consumo de energia da sua casa',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Home Assistant能源仪表盘：完整设置指南（2026年）](/zh/smart-home/home-assistant-energy-dashboard-guide) — 追踪并可视化家庭能源使用情况',
        ],
      },
    },
    schema: {
