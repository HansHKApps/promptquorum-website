...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    heroImage: '/images/home-assistant-getting-started-overview-hero-en.webp',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Best Balcony Solar Kits 2026](/balcony-solar/best-balcony-solar-kits-2026) — add solar monitoring to your Home Assistant setup',
          '[Home Assistant Energy Dashboard: Complete Setup Guide (2027)](/smart-home/home-assistant-energy-dashboard-guide) — track and visualize your home energy use',
        ],
      },
    },
    schema: {
  ...
  ar: {
    ...
    next_refresh_due: '2026-12-04',
    theme: 'Local-First Smart Home',
    heroImage: '/images/home-assistant-getting-started-overview-hero-ar.webp',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[أفضل أطقم الطاقة الشمسية للشرفة 2026](/ar/balcony-solar/best-balcony-solar-kits-2026) — أضف مراقبة الطاقة الشمسية إلى إعداد Home Assistant الخاص بك',
          '[لوحة Energy في Home Assistant: دليل الإعداد الكامل (⁨2027⁩)](/ar/smart-home/home-assistant-energy-dashboard-guide) — تتبّع استهلاك الطاقة المنزلي ومراقبته بصريًا',
        ],
      },
    },
    schema: {
  ...
  de: {
    ...
    next_refresh_due: '2026-12-04',
    theme: 'Local-First Smart Home',
    heroImage: '/images/home-assistant-getting-started-overview-hero-de.webp',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Beste Balkonkraftwerk-Sets 2026](/de/balcony-solar/best-balcony-solar-kits-2026) — Solar-Monitoring zu Ihrem Home Assistant hinzufügen',
          '[Home Assistant Energie-Dashboard: Komplette Einrichtungsanleitung (2027)](/de/smart-home/home-assistant-energy-dashboard-guide) – Ihren Energieverbrauch erfassen und visualisieren',
        ],
      },
    },
    schema: {
  ...
  es: {
    ...
    next_refresh_due: '2026-12-04',
    theme: 'Local-First Smart Home',
    heroImage: '/images/home-assistant-getting-started-overview-hero-es.webp',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Mejores kits de solar de balcón 2026](/es/balcony-solar/best-balcony-solar-kits-2026) — añade monitoreo solar a tu configuración de Home Assistant',
          '[Panel de Energía de Home Assistant: guía completa de configuración (2027)](/es/smart-home/home-assistant-energy-dashboard-guide) — visualiza y controla el consumo energético de tu hogar',
        ],
      },
    },
    schema: {
  ...
  ko: {
    ...
    next_refresh_due: '2026-12-04',
    theme: 'Local-First Smart Home',
    heroImage: '/images/home-assistant-getting-started-overview-hero-ko.webp',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026 최고의 발코니 태양광 키트](/ko/balcony-solar/best-balcony-solar-kits-2026) — Home Assistant 설정에 태양광 모니터링 추가',
          '[Home Assistant Energy 대시보드: 완전 설정 가이드 (2027년)](/ko/smart-home/home-assistant-energy-dashboard-guide) — 가정의 에너지 사용량을 추적하고 시각화',
        ],
      },
    },
    schema: {
  ...
  fr: {
    ...
    next_refresh_due: '2026-12-04',
    theme: 'Local-First Smart Home',
    heroImage: '/images/home-assistant-getting-started-overview-hero-fr.webp',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Meilleurs kits solaires de balcon 2026](/fr/balcony-solar/best-balcony-solar-kits-2026) — ajouter la surveillance solaire à votre configuration Home Assistant',
          '[Tableau de bord Énergie de Home Assistant : guide complet de configuration (2027)](/fr/smart-home/home-assistant-energy-dashboard-guide) — suivez et visualisez la consommation énergétique de votre logement',
        ],
      },
    },
    schema: {
  ...
  ja: {
    ...
    next_refresh_due: '2026-12-04',
    theme: 'Local-First Smart Home',
    heroImage: '/images/home-assistant-getting-started-overview-hero-ja.webp',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026年おすすめバルコニー太陽光キット](/ja/balcony-solar/best-balcony-solar-kits-2026) — Home Assistant セットアップに太陽光モニタリングを追加',
          '[Home Assistant Energyダッシュボード：完全設定ガイド（2027年）](/ja/smart-home/home-assistant-energy-dashboard-guide) — 家庭のエネルギー使用量を追跡・可視化する',
        ],
      },
    },
    schema: {
  ...
  pt: {
    ...
    next_refresh_due: '2026-12-04',
    theme: 'Local-First Smart Home',
    heroImage: '/images/home-assistant-getting-started-overview-hero-pt.webp',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Melhores kits de solar de varanda 2026](/pt/balcony-solar/best-balcony-solar-kits-2026) — adicione monitoramento solar à sua configuração do Home Assistant',
          '[Painel de Energia do Home Assistant: guia completo de configuração (2027)](/pt/smart-home/home-assistant-energy-dashboard-guide) — acompanhe e visualize o consumo de energia da sua casa',
        ],
      },
    },
    schema: {
  ...
  zh: {
    ...
    next_refresh_due: '2026-12-04',
    theme: 'Local-First Smart Home',
    heroImage: '/images/home-assistant-getting-started-overview-hero-zh.webp',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026年最佳阳台太阳能套件](/zh/balcony-solar/best-balcony-solar-kits-2026) — 为您的 Home Assistant 添加太阳能监控',
          '[Home Assistant能源仪表盘：完整设置指南（2027年）](/zh/smart-home/home-assistant-energy-dashboard-guide) — 追踪并可视化家庭能源使用情况',
        ],
      },
    },
    schema: {
