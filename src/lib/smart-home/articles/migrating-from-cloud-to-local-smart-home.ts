...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'الانتقال من Alexa إلى Home Assistant: التحكم المحلي (2026)',
    intro:
    ...
    metaDescription:
      'الانتقال من منزل ذكي سحابي إلى التحكم المحلي: مراجعة الاعتماديات، ونقل الأجهزة إلى Home Assistant، وإيقاف Alexa/Google، وإضافة صوت محلي. خطوة بخطوة.',
    twitterDescription:
