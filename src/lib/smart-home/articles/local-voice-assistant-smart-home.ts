    ...
    sections: {
      ...
      piper: {
        ...
        items: [
          ...
          "Piper's own GitHub repository moved to maintenance-only status in late 2025, but the packaged Home Assistant Wyoming add-on is unaffected and keeps working as described above; for future projects, Kokoro TTS is an actively developed local alternative worth evaluating.",
        ],
      },
      wyoming: {
        id: 'wyoming',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Persona Prompting](/prompt-engineering/persona-prompting) — give your voice assistant a defined personality, tone, and behavioral limits via the system prompt',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      piper: {
        ...
        items: [
          ...
          'انتقل مستودع Piper على GitHub إلى وضع الصيانة فقط في أواخر عام 2025، لكن إضافة Wyoming الجاهزة لـ Home Assistant تعمل دون تأثر كما هو موضح أعلاه؛ للمشاريع المستقبلية، يُعد Kokoro TTS بديلاً محليًا قيد التطوير النشط يستحق التقييم.',
        ],
      },
      wyoming: {
        id: 'wyoming',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[الـ Persona Prompting](/ar/prompt-engineering/persona-prompting) — امنح مساعدك الصوتي شخصية محددة ونبرة وحدودًا سلوكية عبر الـ system prompt',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      piper: {
        ...
        items: [
          ...
          'Das Piper-GitHub-Repository wechselte Ende 2025 in einen reinen Wartungsmodus, das gepackte Home-Assistant-Wyoming-Add-on funktioniert davon unberührt weiter wie oben beschrieben; für künftige Projekte ist Kokoro TTS eine aktiv weiterentwickelte lokale Alternative, die einen Blick wert ist.',
        ],
      },
      wyoming: {
        id: 'wyoming',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Persona Prompting](/de/prompt-engineering/persona-prompting) – geben Sie Ihrem Sprachassistenten eine definierte Persönlichkeit, Tonalität und Verhaltensgrenzen via System Prompt',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      piper: {
        ...
        items: [
          ...
          'El repositorio de GitHub de Piper pasó a modo de solo mantenimiento a finales de 2025, pero el add-on empaquetado de Wyoming para Home Assistant sigue funcionando sin cambios como se describe arriba; para proyectos futuros, Kokoro TTS es una alternativa local en desarrollo activo que vale la pena evaluar.',
        ],
      },
      wyoming: {
        id: 'wyoming',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Persona Prompting](/es/prompt-engineering/persona-prompting) — dale a tu asistente de voz una personalidad definida, tono y límites de comportamiento mediante el system prompt',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      piper: {
        ...
        items: [
          ...
          'Piper의 GitHub 저장소는 2025년 말 유지보수 전용 상태로 전환되었지만, 패키지된 Home Assistant Wyoming 애드온은 영향을 받지 않고 위에서 설명한 대로 계속 작동합니다. 향후 프로젝트에서는 활발히 개발되고 있는 로컬 대안인 Kokoro TTS도 검토할 가치가 있습니다.',
        ],
      },
      wyoming: {
        id: 'wyoming',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[페르소나 프롬프팅](/ko/prompt-engineering/persona-prompting) — 시스템 프롬프트로 음성 어시스턴트에 정의된 개성, 어조 및 행동 한계 부여',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      piper: {
        ...
        items: [
          ...
          'Le dépôt GitHub de Piper est passé en simple maintenance fin 2025, mais l\'add-on Wyoming empaqueté pour Home Assistant continue de fonctionner sans changement comme décrit ci-dessus ; pour de futurs projets, Kokoro TTS est une alternative locale activement développée qui mérite d\'être évaluée.',
        ],
      },
      wyoming: {
        id: 'wyoming',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Persona Prompting](/fr/prompt-engineering/persona-prompting) — donnez à votre assistant vocal une personnalité, un ton et des limites comportementales définis via le system prompt',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      piper: {
        ...
        items: [
          ...
          'Piper の GitHub リポジトリは2025年後半にメンテナンスのみの状態になりましたが、パッケージ化された Home Assistant の Wyoming アドオンは影響を受けず、上記のとおり引き続き動作します。今後のプロジェクトでは、活発に開発が続く Kokoro TTS もローカルの代替として検討する価値があります。',
        ],
      },
      wyoming: {
        id: 'wyoming',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[ペルソナプロンプティング](/ja/prompt-engineering/persona-prompting) — システムプロンプトで音声アシスタントにキャラクター、トーン、行動制限を設定する',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      piper: {
        ...
        items: [
          ...
          'O repositório do Piper no GitHub entrou em modo somente manutenção no fim de 2025, mas o add-on Wyoming empacotado para o Home Assistant continua funcionando normalmente como descrito acima; para projetos futuros, o Kokoro TTS é uma alternativa local em desenvolvimento ativo que vale a pena avaliar.',
        ],
      },
      wyoming: {
        id: 'wyoming',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Persona Prompting](/pt/prompt-engineering/persona-prompting) — dê ao seu assistente de voz uma personalidade, tom e limites de comportamento definidos via system prompt',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      piper: {
        ...
        items: [
          ...
          'Piper 的 GitHub 仓库已于 2025 年末进入仅维护状态，但打包好的 Home Assistant Wyoming 加载项不受影响，仍如上所述正常运行；对于未来的项目，积极开发中的本地方案 Kokoro TTS 值得评估。',
        ],
      },
      wyoming: {
        id: 'wyoming',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[角色提示](/zh/prompt-engineering/persona-prompting) — 通过系统提示词为语音助手设定明确的个性、语气和行为限制',
        ],
      },
    },
    schema: {
