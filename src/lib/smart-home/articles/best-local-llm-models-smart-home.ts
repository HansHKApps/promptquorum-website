...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'أفضل النماذج اللغوية المحلية لـ Home Assistant (2026)',
    intro:
    ...
    metaDescription:
      'أفضل نماذج LLM المحلية للتحكم في المنزل الذكي 2026: نماذج صغيرة وسريعة مع استدعاء الدوال تعمل على أجهزة متواضعة. قائمة مختصرة واختيارات حسب الميزانية.',
    twitterDescription:
