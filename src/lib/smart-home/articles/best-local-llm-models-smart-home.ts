    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Small Language Models for Smart Home Control (2027)](/smart-home/local-small-language-models-smart-home) — lighter models for constrained hardware',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[نماذج اللغة الصغيرة للتحكم في المنزل الذكي (⁨2027⁩)](/ar/smart-home/local-small-language-models-smart-home) — نماذج أخف للأجهزة المحدودة',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Kleine Sprachmodelle für die Smart-Home-Steuerung (2027)](/de/smart-home/local-small-language-models-smart-home) – leichtere Modelle für begrenzte Hardware',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Modelos de lenguaje pequeños para el control del hogar inteligente (2027)](/es/smart-home/local-small-language-models-smart-home) — modelos más ligeros para hardware limitado',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[스마트홈 제어를 위한 소형 언어 모델 (2027년)](/ko/smart-home/local-small-language-models-smart-home) — 제한된 하드웨어를 위한 더 가벼운 모델',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Petits modèles de langage pour le contrôle de la maison connectée (2027)](/fr/smart-home/local-small-language-models-smart-home) — des modèles plus légers pour du matériel limité',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[スマートホーム制御のための小規模言語モデル（2027年）](/ja/smart-home/local-small-language-models-smart-home) — 限られたハードウェア向けの軽量モデル',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Modelos de linguagem pequenos para o controle da casa inteligente (2027)](/pt/smart-home/local-small-language-models-smart-home) — modelos mais leves para hardware limitado',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[智能家居控制的小型语言模型（2027年）](/zh/smart-home/local-small-language-models-smart-home) — 适合硬件受限设备的轻量模型',
        ],
      },
    },
    schema: {
