    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Thread and Wi-Fi 7 Routers for Smart Homes (2027)](/smart-home/thread-14-wifi-7-routers-guide) — Thread border routers and Wi-Fi 7 networking',
          '[IKEA\'s Matter Ecosystem: Complete Guide (2027)](/smart-home/ikea-matter-ecosystem-guide-2027) — an ecosystem built on these protocols',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Thread وأجهزة توجيه Wi-Fi 7 للمنازل الذكية (2027)](/ar/smart-home/thread-14-wifi-7-routers-guide) — موجّهات Thread الحدودية وشبكات Wi-Fi 7',
          '[نظام IKEA البيئي لـ Matter: دليل شامل (2027)](/ar/smart-home/ikea-matter-ecosystem-guide-2027) — نظام بيئي مبني على هذه البروتوكولات',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Thread und Wi-Fi-7-Router für Smart Homes (2027)](/de/smart-home/thread-14-wifi-7-routers-guide) – Thread-Border-Router und Wi-Fi-7-Netzwerke',
          '[Das Matter-Ökosystem von IKEA: Kompletter Leitfaden (2027)](/de/smart-home/ikea-matter-ecosystem-guide-2027) – ein Ökosystem auf Basis dieser Protokolle',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Thread y routers Wi-Fi 7 para hogares inteligentes (2027)](/es/smart-home/thread-14-wifi-7-routers-guide) — routers frontera Thread y redes Wi-Fi 7',
          '[El ecosistema Matter de IKEA: guía completa (2027)](/es/smart-home/ikea-matter-ecosystem-guide-2027) — un ecosistema basado en estos protocolos',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[스마트홈을 위한 Thread와 Wi-Fi 7 라우터 (2027년)](/ko/smart-home/thread-14-wifi-7-routers-guide) — Thread 경계 라우터와 Wi-Fi 7 네트워크',
          '[IKEA의 Matter 생태계: 완전 가이드 (2027년)](/ko/smart-home/ikea-matter-ecosystem-guide-2027) — 이 프로토콜을 기반으로 하는 생태계',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Thread et routeurs Wi-Fi 7 pour maisons connectées (2027)](/fr/smart-home/thread-14-wifi-7-routers-guide) — routeurs frontaliers Thread et réseaux Wi-Fi 7',
          '[L\'écosystème Matter d\'IKEA : guide complet (2027)](/fr/smart-home/ikea-matter-ecosystem-guide-2027) — un écosystème bâti sur ces protocoles',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[スマートホーム向けThreadとWi-Fi 7ルーター（2027年）](/ja/smart-home/thread-14-wifi-7-routers-guide) — Threadボーダールーターと Wi-Fi 7 ネットワーク',
          '[IKEAのMatterエコシステム：完全ガイド（2027年）](/ja/smart-home/ikea-matter-ecosystem-guide-2027) — これらのプロトコル上に構築されたエコシステム',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Thread e roteadores Wi-Fi 7 para casas inteligentes (2027)](/pt/smart-home/thread-14-wifi-7-routers-guide) — roteadores de fronteira Thread e redes Wi-Fi 7',
          '[O ecossistema Matter da IKEA: guia completo (2027)](/pt/smart-home/ikea-matter-ecosystem-guide-2027) — um ecossistema construído sobre esses protocolos',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[智能家居的Thread与Wi-Fi 7路由器（2027年）](/zh/smart-home/thread-14-wifi-7-routers-guide) — Thread边界路由器与Wi-Fi 7网络',
          '[宜家的Matter生态系统：完整指南（2027年）](/zh/smart-home/ikea-matter-ecosystem-guide-2027) — 建立在这些协议之上的生态系统',
        ],
      },
    },
    schema: {
