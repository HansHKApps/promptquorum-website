  ...
  en: {
    ...
    sections: {
      ...
      quickPicks: {
        ...
        rows: [
          { 'Pick': 'Best for electric baseboard/floor heat (US/CA)', 'Product': 'Sinopé Zigbee thermostat', 'Protocol': 'Zigbee', 'Price': '$104.99–109.99' },
          { 'Pick': 'Best Matter hub + thermostat (US/CA)', 'Product': 'Aqara Thermostat Hub W200', 'Protocol': 'Matter', 'Price': '$159.99' },
          { 'Pick': 'Best Z-Wave option (US/CA)', 'Product': '2GIG-STZ-1', 'Protocol': 'Z-Wave Plus', 'Price': '$123.60' },
          { 'Pick': 'Best for European radiators', 'Product': 'tado° X (Radiator Thermostat X)', 'Protocol': 'Matter over Thread', 'Price': 'from €99.99' },
          { 'Pick': 'Best minimalist wall thermostat (EU/US)', 'Product': 'Eve Thermostat', 'Protocol': 'Matter over Thread', 'Price': '$129.95 / €119.95' },
          { 'Pick': 'Watch for — cloud-dependent', 'Product': 'Ecobee (standard integration)', 'Protocol': 'Cloud Polling', 'Price': 'varies' },
          { 'Pick': 'Watch for — mostly cloud', 'Product': 'Nest (except 4th-gen Learning Thermostat)', 'Protocol': 'Cloud SDM API / Matter on 4th-gen only', 'Price': 'varies' },
        ],
        affiliateLinks: [
  ...
  de: {
    ...
    sections: {
      ...
      quickPicks: {
        ...
        rows: [
          { 'Empfehlung': 'Beste Option für europäische Heizkörper', 'Produkt': 'tado° X (Heizkörperthermostat X)', 'Protokoll': 'Matter über Thread', 'Preis': 'ab 99,99 €' },
          { 'Empfehlung': 'Bester minimalistischer Wandthermostat', 'Produkt': 'Eve Thermostat', 'Protokoll': 'Matter über Thread', 'Preis': '119,95 €' },
          { 'Empfehlung': 'Nur USA/Kanada — elektrische Fußleisten-/Fußbodenheizung', 'Produkt': 'Sinopé Zigbee-Thermostat', 'Protokoll': 'Zigbee', 'Preis': '104,99–109,99 $' },
          { 'Empfehlung': 'Nur USA/Kanada — Matter-Hub + Thermostat', 'Produkt': 'Aqara Thermostat Hub W200', 'Protokoll': 'Matter', 'Preis': '159,99 $' },
          { 'Empfehlung': 'Nur USA/Kanada — Z-Wave', 'Produkt': '2GIG-STZ-1', 'Protokoll': 'Z-Wave Plus', 'Preis': '123,60 $' },
          { 'Empfehlung': 'Vorsicht — cloud-abhängig', 'Produkt': 'Ecobee (Standard-Integration)', 'Protokoll': 'Cloud Polling', 'Preis': 'variiert' },
        ],
        affiliateLinks: [
  ...
  fr: {
    ...
    sections: {
      ...
      quickPicks: {
        ...
        rows: [
          { 'Choix': 'Meilleur pour les radiateurs européens', 'Produit': 'tado° X (thermostat radiateur X)', 'Protocole': 'Matter sur Thread', 'Prix': 'à partir de 99,99 €' },
          { 'Choix': 'Meilleur thermostat mural minimaliste', 'Produit': 'Eve Thermostat', 'Protocole': 'Matter sur Thread', 'Prix': '119,95 €' },
          { 'Choix': 'États-Unis/Canada — plinthes/plancher électrique', 'Produit': 'Sinopé Zigbee', 'Protocole': 'Zigbee', 'Prix': '104,99–109,99 $' },
          { 'Choix': 'États-Unis/Canada — hub Matter + thermostat', 'Produit': 'Aqara Thermostat Hub W200', 'Protocole': 'Matter', 'Prix': '159,99 $' },
          { 'Choix': 'États-Unis/Canada — Z-Wave', 'Produit': '2GIG-STZ-1', 'Protocole': 'Z-Wave Plus', 'Prix': '123,60 $' },
          { 'Choix': 'À surveiller — dépendant du cloud', 'Produit': 'Ecobee (intégration standard)', 'Protocole': 'Cloud Polling', 'Prix': 'variable' },
        ],
        affiliateLinks: [
  ...
  ja: {
    ...
    sections: {
      ...
      quickPicks: {
        ...
        rows: [
          { 'おすすめ': '欧州のラジエーター向け', '製品': 'tado° X(ラジエーター用サーモスタットX)', 'プロトコル': 'Thread上のMatter', '価格': '99.99ユーロから' },
          { 'おすすめ': 'ミニマルな壁掛けサーモスタット', '製品': 'Eve Thermostat', 'プロトコル': 'Thread上のMatter', '価格': '129.95ドル/119.95ユーロ' },
          { 'おすすめ': '北米 — 電気床暖房/幅木暖房', '製品': 'Sinopé Zigbeeサーモスタット', 'プロトコル': 'Zigbee', '価格': '104.99〜109.99ドル' },
          { 'おすすめ': '北米 — Matterハブ兼サーモスタット', '製品': 'Aqara Thermostat Hub W200', 'プロトコル': 'Matter', '価格': '159.99ドル' },
          { 'おすすめ': '北米 — Z-Wave', '製品': '2GIG-STZ-1', 'プロトコル': 'Z-Wave Plus', '価格': '123.60ドル' },
          { 'おすすめ': '注意 — クラウド依存', '製品': 'Ecobee(標準連携)', 'プロトコル': 'Cloud Polling', '価格': '変動' },
        ],
        affiliateLinks: [
  ...
  zh: {
    ...
    sections: {
      ...
      quickPicks: {
        ...
        columns: ['推荐', '产品', '协议', '价格'],
        rows: [
          { '推荐': '欧洲散热器供暖首选', '产品': 'tado° X(散热器恒温器X)', '协议': '基于Thread的Matter', '价格': '起价99.99欧元' },
          { '推荐': '最简约的壁挂式恒温器', '产品': 'Eve Thermostat', '协议': '基于Thread的Matter', '价格': '129.95美元/119.95欧元' },
          { '推荐': '北美 — 电动踢脚线/地暖', '产品': 'Sinopé Zigbee恒温器', '协议': 'Zigbee', '价格': '104.99–109.99美元' },
          { '推荐': '北美 — Matter集线器兼恒温器', '产品': 'Aqara Thermostat Hub W200', '协议': 'Matter', '价格': '159.99美元' },
          { '推荐': '北美 — Z-Wave', '产品': '2GIG-STZ-1', '协议': 'Z-Wave Plus', '价格': '123.60美元' },
          { '推荐': '需留意 — 依赖云端', '产品': 'Ecobee(标准集成)', '协议': 'Cloud Polling', '价格': '价格不定' },
        ],
        affiliateLinks: [
  ...
  es: {
    ...
    sections: {
      ...
      quickPicks: {
        ...
        rows: [
          { 'Elección': 'Mejor para radiadores europeos', 'Producto': 'tado° X (termostato de radiador X)', 'Protocolo': 'Matter sobre Thread', 'Precio': 'desde 99,99 €' },
          { 'Elección': 'Mejor termostato de pared minimalista', 'Producto': 'Eve Thermostat', 'Protocolo': 'Matter sobre Thread', 'Precio': '129,95 $/119,95 €' },
          { 'Elección': 'EE. UU./Canadá — rodapié/suelo eléctrico', 'Producto': 'Sinopé Zigbee', 'Protocolo': 'Zigbee', 'Precio': '104,99–109,99 $' },
          { 'Elección': 'EE. UU./Canadá — hub Matter + termostato', 'Producto': 'Aqara Thermostat Hub W200', 'Protocolo': 'Matter', 'Precio': '159,99 $' },
          { 'Elección': 'EE. UU./Canadá — Z-Wave', 'Producto': '2GIG-STZ-1', 'Protocolo': 'Z-Wave Plus', 'Precio': '123,60 $' },
          { 'Elección': 'Cuidado — depende de la nube', 'Producto': 'Ecobee (integración estándar)', 'Protocolo': 'Cloud Polling', 'Precio': 'variable' },
        ],
        affiliateLinks: [
  ...
  pt: {
    ...
    sections: {
      ...
      quickPicks: {
        ...
        rows: [
          { 'Escolha': 'Melhor para radiadores europeus', 'Produto': 'tado° X (termostato de radiador X)', 'Protocolo': 'Matter sobre Thread', 'Preço': 'a partir de € 99,99' },
          { 'Escolha': 'Melhor termostato de parede minimalista', 'Produto': 'Eve Thermostat', 'Protocolo': 'Matter sobre Thread', 'Preço': 'US$ 129,95/€ 119,95' },
          { 'Escolha': 'EUA/Canadá — rodapé/piso elétrico', 'Produto': 'Sinopé Zigbee', 'Protocolo': 'Zigbee', 'Preço': 'US$ 104,99–109,99' },
          { 'Escolha': 'EUA/Canadá — hub Matter + termostato', 'Produto': 'Aqara Thermostat Hub W200', 'Protocolo': 'Matter', 'Preço': 'US$ 159,99' },
          { 'Escolha': 'EUA/Canadá — Z-Wave', 'Produto': '2GIG-STZ-1', 'Protocolo': 'Z-Wave Plus', 'Preço': 'US$ 123,60' },
          { 'Escolha': 'Atenção — dependente da nuvem', 'Produto': 'Ecobee (integração padrão)', 'Protocolo': 'Cloud Polling', 'Preço': 'variável' },
        ],
        affiliateLinks: [
          { label: 'tado° X termostato de radiador', url: 'https://shop.tado.com/en', productName: 'tado° X', productCategory: 'Smart thermostat' },
          { label: 'Eve Thermostat', url: 'https://www.evehome.com/en/eve-thermostat', productName: 'Eve Thermostat', productCategory: 'Smart thermostat' },
  ...
  ar: {
    ...
    sections: {
      ...
      quickPicks: {
        ...
        rows: [
          { 'الاختيار': 'الأفضل للمشعّات الأوروبية', 'المنتج': 'tado° X (منظم حرارة مشعّات X)', 'البروتوكول': 'Matter عبر Thread', 'السعر': 'ابتداءً من 99.99 يورو' },
          { 'الاختيار': 'أفضل منظم حائطي بسيط', 'المنتج': 'Eve Thermostat', 'البروتوكول': 'Matter عبر Thread', 'السعر': '129.95 دولار/119.95 يورو' },
          { 'الاختيار': 'أمريكا الشمالية — تدفئة أرضية/كهربائية', 'المنتج': 'Sinopé Zigbee', 'البروتوكول': 'Zigbee', 'السعر': '104.99–109.99 دولار' },
          { 'الاختيار': 'أمريكا الشمالية — محور Matter ومنظم حرارة', 'المنتج': 'Aqara Thermostat Hub W200', 'البروتوكول': 'Matter', 'السعر': '159.99 دولار' },
          { 'الاختيار': 'أمريكا الشمالية — Z-Wave', 'المنتج': '2GIG-STZ-1', 'البروتوكول': 'Z-Wave Plus', 'السعر': '123.60 دولار' },
          { 'الاختيار': 'انتبه — يعتمد على السحابة', 'المنتج': 'Ecobee (التكامل القياسي)', 'البروتوكول': 'Cloud Polling', 'السعر': 'متغير' },
        ],
        affiliateLinks: [
  ...
  ko: {
    ...
    sections: {
      ...
      quickPicks: {
        ...
        rows: [
          { '추천': '유럽 라디에이터 난방에 최적', '제품': 'tado° X(라디에이터 온도조절기 X)', '프로토콜': 'Thread 기반 Matter', '가격': '99.99유로부터' },
          { '추천': '가장 미니멀한 벽걸이형', '제품': 'Eve Thermostat', '프로토콜': 'Thread 기반 Matter', '가격': '129.95달러/119.95유로' },
          { '추천': '북미 — 전기 배선/바닥 난방', '제품': 'Sinopé Zigbee', '프로토콜': 'Zigbee', '가격': '104.99~109.99달러' },
          { '추천': '북미 — Matter 허브 겸 온도조절기', '제품': 'Aqara Thermostat Hub W200', '프로토콜': 'Matter', '가격': '159.99달러' },
          { '추천': '북미 — Z-Wave', '제품': '2GIG-STZ-1', '프로토콜': 'Z-Wave Plus', '가격': '123.60달러' },
          { '추천': '주의 — 클라우드 의존', '제품': 'Ecobee(표준 통합)', '프로토콜': 'Cloud Polling', '가격': '변동' },
        ],
        affiliateLinks: [
