...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  pt: {
    ...
    toc: [
      { label: 'Compre / Não compre', anchor: 'buy-skip-if' },
      { label: 'Nota das tomadas', anchor: 'scorecard' },
    ...
    sections: {
      buyIfSkipIf: {
        id: 'buy-skip-if',
        title: 'Compre / Não compre',
        sponsoredSlot: true,
        content: 'Guia rápido de decisão — uma tomada inteligente com monitoramento de energia atende ao que você realmente precisa? Avaliação da PromptQuorum baseada em especificações publicadas e documentação, não em testes práticos.',
        items: [
          '**Compre uma tomada inteligente com monitoramento de energia se:**',
          'Você quer dados de watts/kWh por dispositivo alimentando o painel de Energia do Home Assistant localmente',
          'Você tem dispositivos específicos de alto valor que vale a pena monitorar (máquina de lavar, secadora, servidor, geladeira)',
          'Você já usa Zigbee ou Z-Wave e quer uma tomada compatível com seu coordenador existente',
          'Você quer uma automação de LLM local para resumir "o que consumiu mais eletricidade ontem"',
          'Você quer detectar um defeito cedo (por exemplo, uma geladeira consumindo mais energia que o normal)',
          '**Não compre tomadas inteligentes se:**',
          'Você quer visibilidade de casa inteira ou de um circuito inteiro — use um sistema de alicate amperímetro no quadro de disjuntores',
          'Você quer monitorar a produção solar — mesma resposta: um sistema de alicate amperímetro, não uma tomada',
          'Você só quer controle liga/desliga sem dados de energia — uma tomada inteligente simples e bem mais barata já resolve isso',
          'Você quer monitorar um dispositivo que consome mais que a carga máxima nominal da tomada — verifique as especificações antes',
        ],
        affiliateLinks: [
      ...
      scorecard: {
        id: 'scorecard',
        title: 'Nota das tomadas inteligentes com monitoramento de energia',
        content:
          '**Avaliação da PromptQuorum, baseada em especificações do fabricante e na própria documentação de integração do Home Assistant — não um teste prático em laboratório com uma unidade física.** As notas refletem a adequação especificamente para monitoramento de energia local-first.',
        columns: ['Tomada', 'Dados de energia local', 'Custo-benefício', 'Melhor para'],
        rows: [
          { Tomada: 'Aqara Smart Plug', 'Dados de energia local': '9.5/10', 'Custo-benefício': '9/10', 'Melhor para': 'Casas com Zigbee, comprar várias de uma vez' },
          { Tomada: 'Zooz ZEN15 800LR', 'Dados de energia local': '9/10', 'Custo-benefício': '7.5/10', 'Melhor para': 'Casas com Z-Wave, cobertura de longo alcance' },
          { Tomada: 'Shelly Plug US Gen4', 'Dados de energia local': '9/10', 'Custo-benefício': '8.5/10', 'Melhor para': 'Sem coordenador existente, maior flexibilidade de protocolo' },
          { Tomada: 'Sonoff S31 (Wi-Fi)', 'Dados de energia local': '7.5/10', 'Custo-benefício': '9/10', 'Melhor para': 'Opção confirmada mais barata, orçamento reduzido' },
        ],
        note: 'Essas notas são a avaliação editorial da PromptQuorum, derivada de especificações verificadas e da própria documentação de integração do Home Assistant (veja "Como avaliamos" abaixo) — não são resultado de testes físicos da PromptQuorum com essas unidades.',
      },
      tldr: {
        id: 'tldr',
        title: 'Resumo',
        ...
        items: [
          ...
          'Esses são produtos dos EUA/Europa, sem canal de venda oficial confirmado no Brasil nem preço em reais — a Aqara Smart Plug (versão EU) aparece via marketplace na Amazon.com.br por cerca de R$ 347',
          ...
          'Esta página contém links de produtos, não links de afiliados — veja a transparência abaixo',
        ],
      },
      disclosure: {
        id: 'disclosure',
      ...
      comparison: {
        ...
        content: '**As quatro tomadas confirmadas, lado a lado, verificadas em 25/08/2026.**',
        columns: ['Tomada', 'Protocolo', 'Carga máx.', 'Dados de energia local', 'Preço'],
        rows: [
          { Tomada: 'Aqara Smart Plug', Protocolo: 'Zigbee 3.0', 'Carga máx.': '1875W', 'Dados de energia local': 'Sim (ZHA/Zigbee2MQTT)', Preço: 'US$ 20-35 / R$ 347 (UE, Amazon.com.br)' },
          { Tomada: 'Zooz ZEN15 800LR', Protocolo: 'Z-Wave Long Range (série 800)', 'Carga máx.': 'Ver anúncio', 'Dados de energia local': 'Sim (W/A/V/kWh)', Preço: 'US$ 37,95-48,95' },
          { Tomada: 'Shelly Plug US Gen4', Protocolo: 'Wi-Fi / Matter / Zigbee', 'Carga máx.': 'Ver anúncio', 'Dados de energia local': 'Sim (API local documentada)', Preço: 'US$ 19,99-24,99' },
          { Tomada: 'Sonoff S31', Protocolo: 'Wi-Fi', 'Carga máx.': 'Ver anúncio', 'Dados de energia local': 'Sim — mas NÃO a S31 Lite ZB', Preço: 'US$ 9,90-23,90' },
        ],
        items: [
          '**Nossa escolha se você não tem coordenador existente:** Shelly Plug US Gen4 — a única tomada aqui confirmada em três protocolos (Wi-Fi, Matter, Zigbee) com API local documentada, então se encaixa em quase qualquer configuração.',
          '**Nossa escolha pelo menor custo por unidade em vários dispositivos:** Aqara Smart Plug — barata o suficiente para comprar 3-4 unidades para os dispositivos listados em "O que monitorar" abaixo sem grande investimento. No Brasil, a versão EU aparece via marketplace na Amazon.com.br por cerca de R$ 347 — bem acima da conversão direta do preço em dólar, por causa de impostos de importação — e usa o formato de tomada Schuko (europeu), não o padrão brasileiro NBR 14136, então é necessário um adaptador.',
          'Nenhuma das quatro difere de forma significativa quanto a se o reporte de energia local realmente funciona — todas confirmam isso. A decisão real é adequação de protocolo e preço, não capacidade.',
        ],
        affiliateLinks: [
      ...
      whichOne: {
        ...
        items: [
          ...
          'Quer monitorar 4 ou mais dispositivos com orçamento limitado: Aqara Smart Plug × várias — o menor custo por unidade entre as opções confirmadas.',
      ...
      methodology: {
        id: 'methodology',
        title: 'Como avaliamos as tomadas inteligentes com monitoramento de energia',
        content:
          '**Esta análise não foi testada fisicamente pela PromptQuorum em unidades reais.** Foi construída a partir de especificações publicadas pelo fabricante, anúncios de varejistas e da própria documentação de integração do Home Assistant, claramente separadas abaixo para você saber o que é confirmado e o que é avaliação.',
        items: [
          '**Confirmado pelo fabricante:** protocolo, carga máxima nominal e preço oficial — obtidos diretamente das páginas de produto e lojas da Aqara, Zooz, Shelly e Sonoff/ITEAD, verificados em 25/08/2026.',
          '**Confirmado pela documentação do Home Assistant:** se as entidades de sensor de energia (watts, kWh, voltagem, amperagem) são expostas localmente pela integração relevante (ZHA, Zigbee2MQTT, Z-Wave JS, ou uma API Wi-Fi/Matter local) ou exigem conexão em nuvem — obtido da própria documentação de integração do Home Assistant, não de alegações de marketing do fabricante.',
          '**Avaliação da PromptQuorum:** a nota geral, as recomendações de compra/não compra e o filtro "qual tomada comprar" — julgamento editorial da PromptQuorum aplicado às especificações e documentação confirmadas acima, não um novo teste físico.',
          'Avaliamos tomadas inteligentes com monitoramento de energia em: reporte local de dados de energia confirmado (não apenas liga/desliga local), adequação de protocolo a configurações existentes, carga máxima nominal, preço, e suporte de integração documentado do Home Assistant para o modelo exato.',
        ],
      },
      faqSection: {
        id: 'faq',
        ...
        faqs: [
          ...
          { q: 'Qual é a melhor tomada inteligente com monitoramento de energia no geral?', a: 'Para a maioria dos compradores que já usam Zigbee, a Aqara Smart Plug (US$ 20-35; cerca de R$ 347 na versão EU via Amazon.com.br) oferece a melhor combinação de reporte local confirmado e baixo custo por unidade. Se você não tem coordenador existente, a Shelly Plug US Gen4 (US$ 19,99-24,99) é a opção confirmada mais flexível em protocolos, funcionando em Wi-Fi, Matter e Zigbee.' },
          ...
          { q: 'Essas tomadas são vendidas oficialmente no Brasil? Funcionam na rede elétrica brasileira?', a: 'Não há canal de venda oficial confirmado da fabricante no Brasil para nenhuma delas até esta verificação (26/08/2026). Via marketplace, a Aqara Smart Plug (versão EU) aparece na Amazon.com.br por cerca de R$ 347 — bem acima da conversão direta do preço em dólar, por causa de impostos de importação — mas usa o formato de tomada Schuko (europeu), não o padrão brasileiro NBR 14136, exigindo adaptador. A Sonoff S31 também aparece em revendedores no Mercado Livre, com o plugue americano NEMA e um adaptador incluído, mas sem preço oficial confirmado. Não encontramos oferta confiável da Zooz ZEN15 800LR nem da Shelly Plug US Gen4 especificamente no Brasil. Verifique a compatibilidade elétrica (127V/220V conforme a região) e o padrão de plugue antes de comprar.' },
          ...
          { q: 'Quantas tomadas de monitoramento de energia devo comprar para começar?', a: 'Duas ou três, nos seus dispositivos de maior valor (máquina de lavar/secadora, um servidor ou PC sempre ligado, uma geladeira ou freezer). Expanda apenas se os dados realmente mudarem o que você faz — monitorar cada dispositivo pequeno adiciona custo sem agregar muito valor.' },
          { q: 'Uma tomada inteligente é boa para monitorar o carregamento de veículos elétricos?', a: 'Geralmente não é a melhor opção — uma solução de energia dedicada para VE ou o próprio relatório do carregador é mais adequado do que uma tomada inteligente genérica, já que os padrões de carga e duração do carregamento de VEs diferem do monitoramento típico de eletrodomésticos.' },
          { q: 'O que devo verificar antes de comprar qualquer tomada com monitoramento de energia?', a: 'Confirme especificamente o reporte de energia local (não apenas liga/desliga) na documentação de integração do Home Assistant para o modelo exato, verifique a carga máxima nominal da tomada em relação ao seu dispositivo, e confirme se o padrão de tomada/plugue (NEMA dos EUA, Schuko/CEE 7 da Europa, NBR 14136 do Brasil, etc.) é compatível com sua região.' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
        ...
        items: [
          ...
          '[Melhores dispositivos para casa inteligente 2026](/pt/smart-home/best-smart-home-devices-2026) — o guia completo de compra por categoria em que esta tomada se encaixa',
          '[Automações de IA com uma LLM local](/pt/smart-home/ai-automations-local-llm) — construa a automação "o que consumiu mais eletricidade ontem"',
        ],
      },
    },
    schema: {
  ...
  ar: {
    ...
    sections: {
      buyIfSkipIf: {
        ...
        sponsoredSlot: true,
        content: 'دليل قرار سريع — هل يناسبك مقبس ذكي لمراقبة استهلاك الطاقة فعلاً؟ تقييم PromptQuorum استناداً إلى المواصفات والوثائق المنشورة، وليس اختباراً عملياً.',
        items: [
          '**اشترِ مقبساً ذكياً لمراقبة الطاقة إذا:**',
          'تريد بيانات واط/كيلوواط ساعة لكل جهاز تغذي لوحة معلومات الطاقة في Home Assistant محليًا',
          'لديك أجهزة معينة عالية القيمة تستحق المراقبة (غسالة، مجفف، خادم، ثلاجة)',
          'تستخدم بالفعل Zigbee أو Z-Wave وتريد مقبساً يتوافق مع منسّقك الحالي',
          'تريد أتمتة بنموذج LLM محلي تلخّص "ما الذي استهلك أكبر قدر من الكهرباء أمس؟"',
          'تريد اكتشاف عطل مبكراً (مثلاً ثلاجة تسحب طاقة أكثر من المعتاد)',
          '**تخطَّ المقابس الذكية إذا:**',
          'تريد رؤية شاملة للمنزل بأكمله أو لدائرة كاملة — استخدم نظام مِلقط CT على لوحة القواطع بدلاً من ذلك',
          'تريد مراقبة إنتاج الطاقة الشمسية — الإجابة نفسها، نظام مِلقط CT، وليس مقبساً',
          'تريد فقط التحكم بالتشغيل/الإيقاف دون بيانات طاقة — مقبس ذكي عادي أرخص بكثير يغطي ذلك',
          'تريد مراقبة جهاز يستهلك طاقة أعلى من الحمل الأقصى المقنَّن للمقبس — تحقق من التصنيفات أولاً',
        ],
        affiliateLinks: [
      ...
      scorecard: {
        id: 'scorecard',
        title: 'بطاقة تقييم المقابس الذكية لمراقبة الطاقة',
        content:
          '**تقييم PromptQuorum، استناداً إلى مواصفات الشركة المصنّعة ووثائق تكامل Home Assistant الرسمية — وليس اختباراً عملياً لوحدة فعلية.** تعكس الدرجات مدى الملاءمة لمراقبة الطاقة المحلية تحديداً.',
        columns: ['المقبس', 'بيانات الطاقة المحلية', 'القيمة', 'الأنسب لـ'],
        rows: [
          { المقبس: 'Aqara Smart Plug', 'بيانات الطاقة المحلية': '9.5/10', القيمة: '9/10', 'الأنسب لـ': 'أسر Zigbee، شراء عدة وحدات دفعة واحدة' },
          { المقبس: 'Zooz ZEN15 800LR', 'بيانات الطاقة المحلية': '9/10', القيمة: '7.5/10', 'الأنسب لـ': 'أسر Z-Wave، تغطية بعيدة المدى' },
          { المقبس: 'Shelly Plug US Gen4', 'بيانات الطاقة المحلية': '9/10', القيمة: '8.5/10', 'الأنسب لـ': 'دون منسّق حالي، أوسع مرونة بروتوكولات' },
          { المقبس: 'Sonoff S31 (Wi-Fi)', 'بيانات الطاقة المحلية': '7.5/10', القيمة: '9/10', 'الأنسب لـ': 'أرخص خيار مؤكد، إعدادات متعددة المقابس بميزانية محدودة' },
        ],
        note: 'هذه الدرجات هي تقييم PromptQuorum التحريري المستمد من المواصفات المؤكدة ووثائق تكامل Home Assistant الرسمية (راجع "كيف نُقيّم" أدناه) — وليست نتيجة اختبار فعلي لهذه الوحدات من قِبل PromptQuorum.',
      },
      tldr: {
        id: 'tldr',
        title: 'الخلاصة',
      ...
      comparison: {
        id: 'comparison',
        title: 'مقارنة مباشرة',
        content: '**جميع المقابس الأربعة المؤكدة، جنبًا إلى جنب، تم التحقق منها في 25/08/2026.**',
        columns: ['المقبس', 'البروتوكول', 'الحمل الأقصى', 'بيانات الطاقة المحلية', 'السعر'],
        rows: [
          { المقبس: 'Aqara Smart Plug', البروتوكول: 'Zigbee 3.0', 'الحمل الأقصى': '1875 واط', 'بيانات الطاقة المحلية': 'نعم (ZHA/Zigbee2MQTT)', السعر: '20-35 دولارًا' },
          { المقبس: 'Zooz ZEN15 800LR', البروتوكول: 'Z-Wave Long Range (سلسلة 800)', 'الحمل الأقصى': 'تحقق من الإدراج', 'بيانات الطاقة المحلية': 'نعم (واط/أمبير/فولت/كيلوواط ساعة)', السعر: '37.95-48.95 دولارًا' },
          { المقبس: 'Shelly Plug US Gen4', البروتوكول: 'Wi-Fi / Matter / Zigbee', 'الحمل الأقصى': 'تحقق من الإدراج', 'بيانات الطاقة المحلية': 'نعم (واجهة برمجة تطبيقات محلية موثّقة)', السعر: '19.99-24.99 دولارًا' },
          { المقبس: 'Sonoff S31', البروتوكول: 'Wi-Fi', 'الحمل الأقصى': 'تحقق من الإدراج', 'بيانات الطاقة المحلية': 'نعم — لكن ليس S31 Lite ZB', السعر: '9.90-23.90 دولارًا' },
        ],
        items: [
          '**اختيارنا إن لم يكن لديك منسّق حالي:** Shelly Plug US Gen4 — المقبس الوحيد هنا المؤكد عمله عبر ثلاثة بروتوكولات (Wi-Fi وMatter وZigbee) بواجهة برمجة تطبيقات محلية موثّقة، فهو يناسب أي إعداد تقريبًا.',
          '**اختيارنا لأقل تكلفة لكل وحدة عبر عدة أجهزة:** Aqara Smart Plug — رخيص بما يكفي لشراء 3-4 وحدات للأجهزة المذكورة في "ما يجب مراقبته" أدناه دون إنفاق كبير.',
          'لا تختلف هذه المقابس الأربعة بشكل جوهري في ما إذا كان الإبلاغ المحلي عن الطاقة يعمل فعلاً — فكلها تؤكد ذلك. القرار الحقيقي هو ملاءمة البروتوكول والسعر، وليس القدرة.',
        ],
        affiliateLinks: [
      ...
      whichOne: {
        ...
        items: [
          ...
          'تريد تتبع 4 أجهزة أو أكثر بميزانية محدودة: Aqara Smart Plug × عدة وحدات — أقل تكلفة لكل وحدة بين الخيارات المؤكدة.',
      ...
      methodology: {
        id: 'methodology',
        title: 'كيف نُقيّم المقابس الذكية لمراقبة الطاقة',
        content:
          '**لم يخضع هذا التقييم لاختبار عملي من قِبل PromptQuorum على وحدات فعلية.** بُني استناداً إلى المواصفات المنشورة من الشركة المصنّعة وقوائم تجار التجزئة ووثائق تكامل Home Assistant الرسمية، موضحة بشكل منفصل أدناه لتعرف ما هو مؤكد مقابل ما هو مُقيَّم.',
        items: [
          '**مؤكد من الشركة المصنّعة:** البروتوكول وتصنيف الحمل الأقصى والسعر الرسمي — مصدرها مباشرة صفحات منتجات وقوائم متاجر Aqara وZooz وShelly وSonoff/ITEAD، تم التحقق منها في 25/08/2026.',
          '**مؤكد من وثائق Home Assistant:** ما إذا كانت كيانات مستشعر الطاقة (الواط، كيلوواط الساعة، الفولت، الأمبير) متاحة محليًا عبر التكامل المعني (ZHA أو Zigbee2MQTT أو Z-Wave JS أو واجهة برمجة تطبيقات Wi-Fi/Matter محلية) أو تتطلب اتصالاً سحابيًا — مصدرها وثائق تكامل Home Assistant الرسمية، وليس ادعاءات تسويق الشركة المصنّعة.',
          '**تقييم PromptQuorum:** بطاقة التقييم وتوصيات الشراء/التخطي ومرشح "أي مقبس يجب أن تشتري" — حُكم PromptQuorum التحريري المطبَّق على المواصفات والوثائق المؤكدة أعلاه، وليس اختباراً فعليًا جديدًا.',
          'نُقيّم المقابس الذكية لمراقبة الطاقة بناءً على: الإبلاغ المحلي المؤكد عن بيانات الطاقة (وليس فقط التشغيل/الإيقاف المحلي)، وملاءمة البروتوكول للإعدادات الحالية، وتصنيف الحمل الأقصى، والسعر، ودعم تكامل Home Assistant الموثَّق للطراز المحدد.',
        ],
      },
      faqSection: {
        id: 'faq',
        ...
        faqs: [
          ...
          { q: 'ما هو أفضل مقبس ذكي لمراقبة الطاقة بشكل عام؟', a: 'بالنسبة لمعظم المشترين الذين يستخدمون Zigbee بالفعل، يقدّم مقبس Aqara الذكي (20-35 دولارًا) أفضل مزيج من الإبلاغ المحلي المؤكد وأقل تكلفة لكل وحدة. إذا لم يكن لديك منسّق حالي، فإن Shelly Plug US Gen4 (19.99-24.99 دولارًا) هو الخيار المؤكد الأكثر مرونة في البروتوكولات، إذ يعمل عبر Wi-Fi وMatter وZigbee.' },
          ...
          { q: 'كم عدد مقابس مراقبة الطاقة التي يجب أن أشتريها للبدء؟', a: 'اثنان أو ثلاثة، على أجهزتك الأعلى قيمة (غسالة/مجفف، خادم أو حاسوب يعمل باستمرار، ثلاجة أو مجمّد). وسّع فقط إذا غيّرت البيانات فعلاً ما تفعله — مراقبة كل جهاز صغير تضيف تكلفة دون قيمة تُذكر.' },
          { q: 'هل يصلح المقبس الذكي لمراقبة شحن السيارات الكهربائية؟', a: 'عادةً ليس الخيار الأنسب — يُعد حل طاقة مخصص للسيارات الكهربائية أو نظام الإبلاغ الخاص بالشاحن نفسه أنسب من مقبس ذكي عام، لأن نمط حمل شحن السيارات الكهربائية ومدته يختلفان عن أنماط مراقبة الأجهزة المعتادة.' },
          { q: 'ما الذي يجب التحقق منه قبل شراء أي مقبس لمراقبة الطاقة؟', a: 'تأكد تحديدًا من الإبلاغ المحلي عن الطاقة (وليس فقط التشغيل/الإيقاف) في وثائق تكامل Home Assistant للطراز المحدد، وتحقق من الحمل الأقصى المقنَّن للمقبس مقابل جهازك، وتأكد من أن معيار المقبس/المأخذ لديك (NEMA الأمريكي، Schuko/CEE 7 الأوروبي، BS 1363 البريطاني، إلخ) يطابق منطقتك.' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
        ...
        items: [
          ...
          '[أفضل أجهزة المنزل الذكي 2026](/ar/smart-home/best-smart-home-devices-2026) — دليل الشراء الكامل حسب الفئة الذي يندرج ضمنه هذا المقبس',
          '[أتمتة الذكاء الاصطناعي بنموذج LLM محلي](/ar/smart-home/ai-automations-local-llm) — لبناء أتمتة "ما الذي استهلك أكبر قدر من الكهرباء أمس؟"',
        ],
      },
    },
    schema: {
