    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Open Source vs Proprietary LLMs](/prompt-engineering/open-source-vs-proprietary-llms) — why choosing a local open model instead of a cloud API is the key decision behind this architecture',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[نماذج LLM المفتوحة المصدر مقابل المملوكة](/ar/prompt-engineering/open-source-vs-proprietary-llms) — لماذا اختيار نموذج مفتوح محلي بدلاً من واجهة برمجة السحابة هو القرار المحوري في هذه البنية',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Open-Source- vs. proprietäre LLMs](/de/prompt-engineering/open-source-vs-proprietary-llms) – warum die Wahl eines lokalen Open-Source-Modells statt einer Cloud-API die Schlüsselentscheidung hinter dieser Architektur ist',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[LLMs de código abierto vs propietarios](/es/prompt-engineering/open-source-vs-proprietary-llms) — por qué elegir un modelo local abierto en lugar de una API en la nube es la decisión clave de esta arquitectura',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[오픈소스 vs 독점 LLM](/ko/prompt-engineering/open-source-vs-proprietary-llms) — 클라우드 API 대신 로컬 오픈 모델을 선택하는 것이 이 아키텍처의 핵심 결정인 이유',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[LLMs open source vs propriétaires](/fr/prompt-engineering/open-source-vs-proprietary-llms) — pourquoi choisir un modèle local open source plutôt qu\'une API cloud est la décision clé de cette architecture',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[オープンソース vs 独自 LLM](/ja/prompt-engineering/open-source-vs-proprietary-llms) — クラウドAPIではなくローカルオープンモデルを選ぶことがこのアーキテクチャの核心的な選択である理由',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[LLMs de código aberto vs proprietários](/pt/prompt-engineering/open-source-vs-proprietary-llms) — por que escolher um modelo local aberto em vez de uma API na nuvem é a decisão central desta arquitetura',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[开源 vs 专有 LLM](/zh/prompt-engineering/open-source-vs-proprietary-llms) — 为何选择本地开源模型而非云端API是这套架构的核心决策',
        ],
      },
    },
    schema: {
