...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'المنزل الذكي بنموذج لغوي محلي 2026: الدليل الشامل',
    intro:
    ...
    metaDescription:
      'المنزل الذكي بنموذج لغوي محلي 2026: التحكم بلغة طبيعية والأتمتة الواعية بالسياق عبر Home Assistant + Ollama. بدون سحابة.',
    twitterDescription:
