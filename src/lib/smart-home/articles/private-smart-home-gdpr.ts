    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[The EU Data Act and Your Smart Home (2026)](/smart-home/eu-data-act-smart-home-2027) — how the EU Data Act complements GDPR',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[قانون البيانات الأوروبي ومنزلك الذكي (2026)](/ar/smart-home/eu-data-act-smart-home-2027) — كيف يكمّل قانون البيانات نظام GDPR',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Der EU Data Act und dein Smart Home (2026)](/de/smart-home/eu-data-act-smart-home-2027) – wie der EU Data Act die DSGVO ergänzt',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[La Ley de Datos de la UE y tu hogar inteligente (2026)](/es/smart-home/eu-data-act-smart-home-2027) — cómo la Ley de Datos complementa al RGPD',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[EU 데이터법과 당신의 스마트홈 (2026년)](/ko/smart-home/eu-data-act-smart-home-2027) — EU 데이터법이 GDPR을 보완하는 방식',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Le Data Act européen et votre maison connectée (2026)](/fr/smart-home/eu-data-act-smart-home-2027) — comment le Data Act complète le RGPD',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[EUデータ法とあなたのスマートホーム（2026年）](/ja/smart-home/eu-data-act-smart-home-2027) — EUデータ法がGDPRを補完する仕組み',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[A Lei de Dados da UE e sua casa inteligente (2026)](/pt/smart-home/eu-data-act-smart-home-2027) — como a Lei de Dados complementa o RGPD',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[欧盟《数据法案》与你的智能家居（2026年）](/zh/smart-home/eu-data-act-smart-home-2027) — 欧盟《数据法案》如何补充GDPR',
        ],
      },
    },
    schema: {
