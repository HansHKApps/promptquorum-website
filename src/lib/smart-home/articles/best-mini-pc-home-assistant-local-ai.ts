...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    quickAnswerTop: {
      en: {
        ...
        bullets: [
          ...
          'Ryzen AI step-up: GEEKOM A9 Max (Ryzen AI 9 HX 370) for efficient on-device vision',
    ...
    schema: {
      ...
      description: 'Best mini PC for Home Assistant 2026: Beelink SER8 (Ryzen, ~$650) for Frigate + a 7B model on Ollama; Intel N150 boxes (~$180–230) for budget. RAM and iGPU matter most.',
  ...
  ar: {
    ...
    quickAnswerTop: {
      ar: {
        ...
        bullets: [
          ...
          'ترقية Ryzen AI: GEEKOM A9 Max (Ryzen AI 9 HX 370) لرؤية فعّالة على الجهاز',
    ...
    schema: {
      ...
      description: 'أفضل mini PC لـ Home Assistant 2026: Beelink SER8 (Ryzen، نحو ‎$650‎) لـ Frigate + نموذج 7B على Ollama؛ صناديق Intel N150 (نحو ‎$180–230‎). RAM وiGPU الأهم.',
  ...
  de: {
    ...
    quickAnswerTop: {
      de: {
        ...
        bullets: [
          ...
          'Ryzen-AI-Aufstieg: GEEKOM A9 Max (Ryzen AI 9 HX 370) für effiziente On-Device-Bildverarbeitung',
    ...
    schema: {
      ...
      description: 'Bester Mini-PC für Home Assistant 2026: Beelink SER8 (Ryzen, ca. 650 €) für Frigate + ein 7B-Modell auf Ollama; Intel-N150-Geräte (ca. 180–230 €) fürs Budget. RAM und iGPU zählen am meisten.',
  ...
  es: {
    ...
    quickAnswerTop: {
      es: {
        ...
        bullets: [
          ...
          'Salto Ryzen AI: GEEKOM A9 Max (Ryzen AI 9 HX 370) para visión eficiente en el dispositivo',
    ...
    schema: {
      ...
      description: 'Mejor mini PC para Home Assistant 2026: Beelink SER8 (Ryzen, ~650 €) para Frigate + un modelo 7B con Ollama; equipos Intel N150 (~180–230 €) para presupuesto. La RAM y la iGPU importan más.',
  ...
  ko: {
    ...
    leadAnswerBlock:
      '**2026년 Home Assistant와 로컬 LLM을 위한 최고의 올라운드 미니 PC는 Beelink SER8(Ryzen 7 8845HS, Radeon 780M, 32 GB, 약 $650)입니다 — 허브와 Frigate, Ollama의 7B 모델을 하나의 기기에서 실행합니다.** 예산형 또는 거의 무소음 구성으로는 Beelink EQ14 또는 GMKtec G3 Plus 같은 Intel N150 기기(약 $180–230)가 Home Assistant와 소형 모델을 실행합니다. AI 지연 시간을 위해 원시 CPU 클럭보다 RAM과 iGPU를 우선시하십시오.',
    quickAnswerTop: {
      ko: {
        question: '2026년 Home Assistant와 로컬 AI에 가장 적합한 미니 PC는 무엇입니까?',
        answer:
          '대부분의 사용자에게는 Beelink SER8(Ryzen 7 8845HS, Radeon 780M, 32 GB, 약 $650)이 최고의 선택입니다 — 강력한 iGPU가 Home Assistant, Frigate, Whisper와 함께 Ollama의 7B 모델을 실행합니다. 예산이 빠듯하거나 거의 무소음 기기를 원한다면 Beelink EQ14 또는 GMKtec G3 Plus 같은 Intel N150 미니 PC(약 $180–230)가 Home Assistant와 소형 모델을 실행합니다. 효율적인 온-디바이스 비전에는 GEEKOM A9 Max 같은 Ryzen AI 미니 PC가 한 단계 위입니다.',
        bullets: [
          ...
          'Ryzen AI 업그레이드: GEEKOM A9 Max(Ryzen AI 9 HX 370)로 효율적인 온-디바이스 비전',
    ...
    schema: {
      ...
      description: '2026년 Home Assistant 최고의 미니 PC: Beelink SER8(Ryzen, 약 $650)로 Frigate + Ollama의 7B 모델; 예산용 Intel N150 기기(약 $180–230). RAM과 iGPU가 가장 중요합니다.',
  ...
  fr: {
    ...
    quickAnswerTop: {
      fr: {
        ...
        bullets: [
          ...
          'Montée Ryzen AI : GEEKOM A9 Max (Ryzen AI 9 HX 370) pour une vision efficace sur l\'appareil',
    ...
    schema: {
      ...
      description: 'Meilleur mini-PC pour Home Assistant 2026 : Beelink SER8 (Ryzen, ~650 €) pour Frigate + un modèle 7B sur Ollama ; machines Intel N150 (~180–230 €) pour le budget. La RAM et l\'iGPU comptent le plus.',
  ...
  ja: {
    ...
    leadAnswerBlock:
      '**2026年、Home Assistant とローカル LLM に最適なオールラウンドなミニPCは Beelink SER8（Ryzen 7 8845HS、Radeon 780M、32 GB、約¥94,800）です——ハブと Frigate、Ollama の 7B モデルを一台で動かします。** 予算重視やほぼ無音の構成なら、Beelink EQ14 や GMKtec G3 Plus といった Intel N150 機（約¥28,000〜35,000）が Home Assistant と小型モデルを動かします。AI のレイテンシのため、生の CPU クロックより RAM と iGPU を優先しましょう。',
    quickAnswerTop: {
      ja: {
        question: '2026年、Home Assistant とローカルAIに最適なミニPCは？',
        answer:
          '多くの人には Beelink SER8（Ryzen 7 8845HS、Radeon 780M、32 GB、約¥94,800）が最適です——強力な iGPU が Home Assistant、Frigate、Whisper と並べて Ollama の 7B モデルを動かします。予算重視やほぼ無音の機器なら、Beelink EQ14 や GMKtec G3 Plus といった Intel N150 のミニPC（約¥28,000〜35,000）が Home Assistant と小型モデルを動かします。効率的なオンデバイスの映像処理には、GEEKOM A9 Max のような Ryzen AI のミニPCが一段上です。',
        bullets: [
          'オールラウンド最適：Beelink SER8（Ryzen 7 8845HS、32 GB）約¥94,800——HA + Frigate + Ollama の 7B モデル',
          '予算重視／ほぼ無音：Intel N150（Beelink EQ14、GMKtec G3 Plus）約¥28,000〜35,000——HA + 小型モデル',
          'Ryzen AI の一段上：GEEKOM A9 Max（Ryzen AI 9 HX 370）で効率的なオンデバイス映像処理',
    ...
    schema: {
      ...
      description: 'Home Assistant 向け最適ミニPC（2026年）：Beelink SER8（Ryzen、約¥94,800）で Frigate＋Ollama の 7B モデル、予算重視は Intel N150 機（約¥28,000〜35,000）。RAM と iGPU が最重要。',
  ...
  pt: {
    ...
    quickAnswerTop: {
      pt: {
        ...
        bullets: [
          ...
          'Salto Ryzen AI: GEEKOM A9 Max (Ryzen AI 9 HX 370) para visão eficiente no dispositivo',
    ...
    schema: {
      ...
      description: 'Melhor mini PC para Home Assistant 2026: Beelink SER8 (Ryzen, ~R$ 5.000) para Frigate + um modelo 7B no Ollama; máquinas Intel N150 (~R$ 1.400–1.900) para orçamento. RAM e iGPU importam mais.',
  ...
  zh: {
    ...
    leadAnswerBlock:
      '**2026年 Home Assistant 加本地 LLM 的最佳全能迷你 PC 是 Beelink SER8（Ryzen 7 8845HS、Radeon 780M、32 GB，约 $650）——它在一台机器上运行中枢、Frigate 以及 Ollama 的 7B 模型。** 若追求预算或近乎无声的配置，Beelink EQ14 或 GMKtec G3 Plus 这类 Intel N150 机器（约 $180–230）可运行 Home Assistant 和一个小型模型。为了 AI 延迟，优先考虑内存和 iGPU，而非纯粹的 CPU 主频。',
    quickAnswerTop: {
      zh: {
        question: '2026年 Home Assistant 和本地 AI 用哪台迷你 PC 最好？',
        answer:
          '对大多数人，Beelink SER8（Ryzen 7 8845HS、Radeon 780M、32 GB，约 $650）是最佳选择——其强力 iGPU 可在 Home Assistant、Frigate 和 Whisper 之外运行 Ollama 的 7B 模型。若追求预算或近乎无声的机器，Beelink EQ14 或 GMKtec G3 Plus 这类 Intel N150 迷你 PC（约 $180–230）可运行 Home Assistant 加一个小型模型。要在设备端做高效视觉处理，可升级到 GEEKOM A9 Max 这类 Ryzen AI 迷你 PC。',
        bullets: [
          ...
          'Ryzen AI 升级：GEEKOM A9 Max（Ryzen AI 9 HX 370）用于设备端高效视觉处理',
    ...
    schema: {
      ...
      description: '2026年 Home Assistant 最佳迷你 PC：Beelink SER8（Ryzen，约 $650）运行 Frigate + Ollama 的 7B 模型；预算型 Intel N150 机器（约 $180–230）。内存与 iGPU 最重要。',
