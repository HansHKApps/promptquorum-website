  ...
  ko: {
    ...
    sections: {
      ...
      comparison: {
        ...
        rows: [
          { '제품': '[Beelink EQ14](/smart-home/beelink-eq14-local-ai-review)', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD(내장)', 'RAM(테스트/최대)': '16 GB / 최대 16 GB(SO-DIMM 1개)', '이더넷': '1GbE 2개', '저장소': 'M.2 NVMe SSD 1개', '대략적 가격(2026년 8월)': '약 $189–220', '유휴/일반 전력 소비': '유휴 약 5–12W, 부하 시 약 15–25W', '이런 경우에 최적': 'HA + 소형 모델' },
          { '제품': '[GMKtec G3 Plus](/smart-home/gmktec-g3-plus-local-ai-review)', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD(내장)', 'RAM(테스트/최대)': '16 GB / 공식 16 GB, 32 GB까지 보고됨(SO-DIMM 1개)', '이더넷': '2.5GbE 1개', '저장소': 'M.2 2개(2280 NVMe 최대 4TB + 2242 SATA 최대 2TB)', '대략적 가격(2026년 8월)': '약 $180–230', '유휴/일반 전력 소비': '유휴 약 5–12W, 부하 시 약 15–25W', '이런 경우에 최적': 'HA + 소형 모델, 예산 유연성' },
          { '제품': '[Beelink SER8](/smart-home/beelink-ser8-local-ai-review)', 'CPU': 'Ryzen 7 8845HS', 'GPU/iGPU': 'Radeon 780M', 'RAM(테스트/최대)': '32 GB / 최대 256 GB(DDR5 SO-DIMM 2개)', '이더넷': '2.5GbE 1개', '저장소': 'M.2 PCIe 4.0 2개(합산 최대 8TB)', '대략적 가격(2026년 8월)': '약 $650', '유휴/일반 전력 소비': '유휴 약 7–10W, 지속적인 AI 부하 시 약 45W 이상', '이런 경우에 최적': 'HA + Frigate + 7B 모델' },
          { '제품': '[Minisforum UM890 Pro](/smart-home/minisforum-um890-pro-local-ai-review)', 'CPU': 'Ryzen 9 8945HS', 'GPU/iGPU': 'SER8과 동일 등급', 'RAM(테스트/최대)': '32 GB / 최대 96 GB(DDR5 SO-DIMM 2개)', '이더넷': '2.5GbE 2개', '저장소': 'M.2 NVMe 2개 + 외부 확장용 OCuLink', '대략적 가격(2026년 8월)': '약 $649(32GB) / 약 $439 베어본', '유휴/일반 전력 소비': '유휴 약 7–9W, 지속 부하 시 약 54–90W', '이런 경우에 최적': 'SER8과 유사, 더 구성 가능' },
          { '제품': '[GEEKOM A9 Max](/smart-home/geekom-a9-max-local-ai-review)', 'CPU': 'Ryzen AI 9 HX 370', 'GPU/iGPU': 'Radeon 890M + NPU', 'RAM(테스트/최대)': '32 GB / 최대 128 GB(DDR5 SO-DIMM 2개)', '이더넷': '2.5GbE 2개', '저장소': 'M.2 NVMe SSD 2개', '대략적 가격(2026년 8월)': '약 $1,099–1,299', '유휴/일반 전력 소비': '유휴 약 7–9W, 일반 사용 시 약 20–34W', '이런 경우에 최적': '최강 온-디바이스 AI + 비전' },
        ],
        items: [
      ...
      aiCapabilities: {
        ...
        rows: [
          { '미니 PC': '[Beelink SER8](/smart-home/beelink-ser8-local-ai-review)', '로컬 AI(7B+)': '★★★★☆', 'Frigate(카메라)': '★★★★☆', '소음': '낮음(소형 팬)', '가격대': '$$$' },
          { '미니 PC': '[Beelink EQ14](/smart-home/beelink-eq14-local-ai-review)', '로컬 AI(7B+)': '★★☆☆☆', 'Frigate(카메라)': '★★★☆☆', '소음': '거의 무음', '가격대': '$' },
          { '미니 PC': '[GMKtec G3 Plus](/smart-home/gmktec-g3-plus-local-ai-review)', '로컬 AI(7B+)': '★★☆☆☆', 'Frigate(카메라)': '★★★☆☆', '소음': '거의 무음', '가격대': '$' },
          { '미니 PC': '[Minisforum UM890 Pro](/smart-home/minisforum-um890-pro-local-ai-review)', '로컬 AI(7B+)': '★★★★☆', 'Frigate(카메라)': '★★★★☆', '소음': '낮음-중간(부하 시 더 높음)', '가격대': '$$$' },
          { '미니 PC': '[GEEKOM A9 Max](/smart-home/geekom-a9-max-local-ai-review)', '로컬 AI(7B+)': '★★★★★', 'Frigate(카메라)': '★★★★★', '소음': '낮음-중간', '가격대': '$$$$' },
        ],
