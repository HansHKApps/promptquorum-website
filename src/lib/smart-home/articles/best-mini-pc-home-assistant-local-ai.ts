  ...
  en: {
    ...
    sections: {
      ...
      aiCapabilities: {
        ...
        columns: ['Mini PC', 'Local AI (7B+)', 'Frigate (cameras)', 'Noise', 'Price tier'],
        rows: [
          { 'Mini PC': '[Beelink SER8](/smart-home/beelink-ser8-local-ai-review)', 'Local AI (7B+)': '★★★★☆', 'Frigate (cameras)': '★★★★☆', 'Noise': 'Low (small fan)', 'Price tier': '$$$' },
          { 'Mini PC': '[Beelink EQ14](/smart-home/beelink-eq14-local-ai-review)', 'Local AI (7B+)': '★★☆☆☆', 'Frigate (cameras)': '★★★☆☆', 'Noise': 'Near-silent', 'Price tier': '$' },
          { 'Mini PC': '[GMKtec G3 Plus](/smart-home/gmktec-g3-plus-local-ai-review)', 'Local AI (7B+)': '★★☆☆☆', 'Frigate (cameras)': '★★★☆☆', 'Noise': 'Near-silent', 'Price tier': '$' },
          { 'Mini PC': '[Minisforum UM890 Pro](/smart-home/minisforum-um890-pro-local-ai-review)', 'Local AI (7B+)': '★★★★☆', 'Frigate (cameras)': '★★★★☆', 'Noise': 'Low-moderate (higher under load)', 'Price tier': '$$$' },
          { 'Mini PC': '[GEEKOM A9 Max](/smart-home/geekom-a9-max-local-ai-review)', 'Local AI (7B+)': '★★★★★', 'Frigate (cameras)': '★★★★★', 'Noise': 'Low-moderate', 'Price tier': '$$$$' },
        ],
  ...
  ar: {
    ...
    sections: {
      ...
      aiCapabilities: {
        ...
        columns: ['الجهاز', 'الذكاء الاصطناعي المحلي (7B+)', 'Frigate (الكاميرات)', 'الضوضاء', 'فئة السعر'],
        rows: [
          { 'الجهاز': '[Beelink SER8](/smart-home/beelink-ser8-local-ai-review)', 'الذكاء الاصطناعي المحلي (7B+)': '★★★★☆', 'Frigate (الكاميرات)': '★★★★☆', 'الضوضاء': 'منخفضة (مروحة صغيرة)', 'فئة السعر': '$$$' },
          { 'الجهاز': '[Beelink EQ14](/smart-home/beelink-eq14-local-ai-review)', 'الذكاء الاصطناعي المحلي (7B+)': '★★☆☆☆', 'Frigate (الكاميرات)': '★★★☆☆', 'الضوضاء': 'شبه صامت', 'فئة السعر': '$' },
          { 'الجهاز': '[GMKtec G3 Plus](/smart-home/gmktec-g3-plus-local-ai-review)', 'الذكاء الاصطناعي المحلي (7B+)': '★★☆☆☆', 'Frigate (الكاميرات)': '★★★☆☆', 'الضوضاء': 'شبه صامت', 'فئة السعر': '$' },
          { 'الجهاز': '[Minisforum UM890 Pro](/smart-home/minisforum-um890-pro-local-ai-review)', 'الذكاء الاصطناعي المحلي (7B+)': '★★★★☆', 'Frigate (الكاميرات)': '★★★★☆', 'الضوضاء': 'منخفضة إلى متوسطة (أعلى تحت الحِمل)', 'فئة السعر': '$$$' },
          { 'الجهاز': '[GEEKOM A9 Max](/smart-home/geekom-a9-max-local-ai-review)', 'الذكاء الاصطناعي المحلي (7B+)': '★★★★★', 'Frigate (الكاميرات)': '★★★★★', 'الضوضاء': 'منخفضة إلى متوسطة', 'فئة السعر': '$$$$' },
        ],
  ...
  de: {
    ...
    sections: {
      ...
      aiCapabilities: {
        ...
        columns: ['Mini-PC', 'Lokale KI (7B+)', 'Frigate (Kameras)', 'Lautstärke', 'Preisklasse'],
        rows: [
          { 'Mini-PC': '[Beelink SER8](/smart-home/beelink-ser8-local-ai-review)', 'Lokale KI (7B+)': '★★★★☆', 'Frigate (Kameras)': '★★★★☆', 'Lautstärke': 'Leise (kleiner Lüfter)', 'Preisklasse': '$$$' },
          { 'Mini-PC': '[Beelink EQ14](/smart-home/beelink-eq14-local-ai-review)', 'Lokale KI (7B+)': '★★☆☆☆', 'Frigate (Kameras)': '★★★☆☆', 'Lautstärke': 'Nahezu lautlos', 'Preisklasse': '$' },
          { 'Mini-PC': '[GMKtec G3 Plus](/smart-home/gmktec-g3-plus-local-ai-review)', 'Lokale KI (7B+)': '★★☆☆☆', 'Frigate (Kameras)': '★★★☆☆', 'Lautstärke': 'Nahezu lautlos', 'Preisklasse': '$' },
          { 'Mini-PC': '[Minisforum UM890 Pro](/smart-home/minisforum-um890-pro-local-ai-review)', 'Lokale KI (7B+)': '★★★★☆', 'Frigate (Kameras)': '★★★★☆', 'Lautstärke': 'Leise bis moderat (unter Last höher)', 'Preisklasse': '$$$' },
          { 'Mini-PC': '[GEEKOM A9 Max](/smart-home/geekom-a9-max-local-ai-review)', 'Lokale KI (7B+)': '★★★★★', 'Frigate (Kameras)': '★★★★★', 'Lautstärke': 'Leise bis moderat', 'Preisklasse': '$$$$' },
        ],
      ...
      faqSection: {
        ...
        faqs: [
          { q: 'Home Assistant Green oder lieber ein Mini-PC?', a: 'Das hängt davon ab, ob lokale KI dazukommen soll. Home Assistant Green ist die offizielle Fertiglösung: auspacken, einstecken, Home Assistant läuft. Für reine Automatisierung reicht das. Sobald aber ein lokales Sprachmodell über Ollama, Frigate-Objekterkennung oder Whisper dazukommen soll, fehlt dieser Klasse die Rechenleistung – dafür ist ein Mini-PC nötig. Wer heute nur Home Assistant will, später aber lokale KI plant, fährt mit einem N150-Rechner ab rund 180 € besser als mit zwei Anschaffungen.' },
    ...
    faqSchema: {
      ...
      inLanguage: 'de',
      mainEntity: [
        { '@type': 'Question', name: 'Home Assistant Green oder lieber ein Mini-PC?', acceptedAnswer: { '@type': 'Answer', text: 'Das hängt davon ab, ob lokale KI dazukommen soll. Home Assistant Green ist die offizielle Fertiglösung: auspacken, einstecken, Home Assistant läuft. Für reine Automatisierung reicht das. Sobald aber ein lokales Sprachmodell über Ollama, Frigate-Objekterkennung oder Whisper dazukommen soll, fehlt dieser Klasse die Rechenleistung – dafür ist ein Mini-PC nötig. Wer heute nur Home Assistant will, später aber lokale KI plant, fährt mit einem N150-Rechner ab rund 180 € besser als mit zwei Anschaffungen.' } },
        ...
        { '@type': 'Question', name: 'Taugt ein Mini-PC als KI-Server im Heimnetz?', acceptedAnswer: { '@type': 'Answer', text: 'Ja, aber nicht in der Budgetklasse. Ein Ryzen-7/9-Gerät mit 32 GB stellt über Ollama einen OpenAI-kompatiblen Endpunkt im Heimnetz bereit, den Home Assistant und andere Geräte gemeinsam nutzen können. Unter Dauerlast liegt der Verbrauch bei N150-Geräten bei etwa 15 bis 25 W und bei Ryzen-Geräten deutlich darüber. Ein N150-Rechner eignet sich als KI-Server nur für sehr kleine Modelle.' } },
  ...
  es: {
    ...
    sections: {
      ...
      aiCapabilities: {
        ...
        columns: ['Mini PC', 'IA local (7B+)', 'Frigate (cámaras)', 'Ruido', 'Nivel de precio'],
        rows: [
          { 'Mini PC': '[Beelink SER8](/smart-home/beelink-ser8-local-ai-review)', 'IA local (7B+)': '★★★★☆', 'Frigate (cámaras)': '★★★★☆', 'Ruido': 'Bajo (ventilador pequeño)', 'Nivel de precio': '$$$' },
          { 'Mini PC': '[Beelink EQ14](/smart-home/beelink-eq14-local-ai-review)', 'IA local (7B+)': '★★☆☆☆', 'Frigate (cámaras)': '★★★☆☆', 'Ruido': 'Casi silencioso', 'Nivel de precio': '$' },
          { 'Mini PC': '[GMKtec G3 Plus](/smart-home/gmktec-g3-plus-local-ai-review)', 'IA local (7B+)': '★★☆☆☆', 'Frigate (cámaras)': '★★★☆☆', 'Ruido': 'Casi silencioso', 'Nivel de precio': '$' },
          { 'Mini PC': '[Minisforum UM890 Pro](/smart-home/minisforum-um890-pro-local-ai-review)', 'IA local (7B+)': '★★★★☆', 'Frigate (cámaras)': '★★★★☆', 'Ruido': 'Bajo-moderado (más alto bajo carga)', 'Nivel de precio': '$$$' },
          { 'Mini PC': '[GEEKOM A9 Max](/smart-home/geekom-a9-max-local-ai-review)', 'IA local (7B+)': '★★★★★', 'Frigate (cámaras)': '★★★★★', 'Ruido': 'Bajo-moderado', 'Nivel de precio': '$$$$' },
        ],
  ...
  ko: {
    ...
    sections: {
      ...
      comparison: {
        ...
        rows: [
          { '제품': '[Beelink EQ14](/ko/smart-home/beelink-eq14-local-ai-review)', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD(내장)', 'RAM(테스트/최대)': '16 GB / 최대 16 GB(SO-DIMM 1개)', '이더넷': '1GbE 2개', '저장소': 'M.2 NVMe SSD 1개', '대략적 가격(2026년 8월)': '약 $189–220', '유휴/일반 전력 소비': '유휴 약 5–12W, 부하 시 약 15–25W', '이런 경우에 최적': 'HA + 소형 모델' },
          { '제품': '[GMKtec G3 Plus](/ko/smart-home/gmktec-g3-plus-local-ai-review)', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD(내장)', 'RAM(테스트/최대)': '16 GB / 공식 16 GB, 32 GB까지 보고됨(SO-DIMM 1개)', '이더넷': '2.5GbE 1개', '저장소': 'M.2 2개(2280 NVMe 최대 4TB + 2242 SATA 최대 2TB)', '대략적 가격(2026년 8월)': '약 $180–230', '유휴/일반 전력 소비': '유휴 약 5–12W, 부하 시 약 15–25W', '이런 경우에 최적': 'HA + 소형 모델, 예산 유연성' },
          { '제품': '[Beelink SER8](/ko/smart-home/beelink-ser8-local-ai-review)', 'CPU': 'Ryzen 7 8845HS', 'GPU/iGPU': 'Radeon 780M', 'RAM(테스트/최대)': '32 GB / 최대 256 GB(DDR5 SO-DIMM 2개)', '이더넷': '2.5GbE 1개', '저장소': 'M.2 PCIe 4.0 2개(합산 최대 8TB)', '대략적 가격(2026년 8월)': '약 $650', '유휴/일반 전력 소비': '유휴 약 7–10W, 지속적인 AI 부하 시 약 45W 이상', '이런 경우에 최적': 'HA + Frigate + 7B 모델' },
          { '제품': '[Minisforum UM890 Pro](/ko/smart-home/minisforum-um890-pro-local-ai-review)', 'CPU': 'Ryzen 9 8945HS', 'GPU/iGPU': 'SER8과 동일 등급', 'RAM(테스트/최대)': '32 GB / 최대 96 GB(DDR5 SO-DIMM 2개)', '이더넷': '2.5GbE 2개', '저장소': 'M.2 NVMe 2개 + 외부 확장용 OCuLink', '대략적 가격(2026년 8월)': '약 $649(32GB) / 약 $439 베어본', '유휴/일반 전력 소비': '유휴 약 7–9W, 지속 부하 시 약 54–90W', '이런 경우에 최적': 'SER8과 유사, 더 구성 가능' },
          { '제품': '[GEEKOM A9 Max](/ko/smart-home/geekom-a9-max-local-ai-review)', 'CPU': 'Ryzen AI 9 HX 370', 'GPU/iGPU': 'Radeon 890M + NPU', 'RAM(테스트/최대)': '32 GB / 최대 128 GB(DDR5 SO-DIMM 2개)', '이더넷': '2.5GbE 2개', '저장소': 'M.2 NVMe SSD 2개', '대략적 가격(2026년 8월)': '약 $1,099–1,299', '유휴/일반 전력 소비': '유휴 약 7–9W, 일반 사용 시 약 20–34W', '이런 경우에 최적': '최강 온-디바이스 AI + 비전' },
        ],
        items: [
      ...
      aiCapabilities: {
        ...
        columns: ['미니 PC', '로컬 AI(7B+)', 'Frigate(카메라)', '소음', '가격대'],
        rows: [
          { '미니 PC': '[Beelink SER8](/ko/smart-home/beelink-ser8-local-ai-review)', '로컬 AI(7B+)': '★★★★☆', 'Frigate(카메라)': '★★★★☆', '소음': '낮음(소형 팬)', '가격대': '$$$' },
          { '미니 PC': '[Beelink EQ14](/ko/smart-home/beelink-eq14-local-ai-review)', '로컬 AI(7B+)': '★★☆☆☆', 'Frigate(카메라)': '★★★☆☆', '소음': '거의 무음', '가격대': '$' },
          { '미니 PC': '[GMKtec G3 Plus](/ko/smart-home/gmktec-g3-plus-local-ai-review)', '로컬 AI(7B+)': '★★☆☆☆', 'Frigate(카메라)': '★★★☆☆', '소음': '거의 무음', '가격대': '$' },
          { '미니 PC': '[Minisforum UM890 Pro](/ko/smart-home/minisforum-um890-pro-local-ai-review)', '로컬 AI(7B+)': '★★★★☆', 'Frigate(카메라)': '★★★★☆', '소음': '낮음-중간(부하 시 더 높음)', '가격대': '$$$' },
          { '미니 PC': '[GEEKOM A9 Max](/ko/smart-home/geekom-a9-max-local-ai-review)', '로컬 AI(7B+)': '★★★★★', 'Frigate(카메라)': '★★★★★', '소음': '낮음-중간', '가격대': '$$$$' },
        ],
      ...
      unitReviews: {
        ...
        items: [
          '[Beelink SER8 — 전체 정보](/ko/smart-home/beelink-ser8-local-ai-review)',
          '[GEEKOM A9 Max — 전체 정보](/ko/smart-home/geekom-a9-max-local-ai-review)',
          '[Minisforum UM890 Pro — 전체 정보](/ko/smart-home/minisforum-um890-pro-local-ai-review)',
          '[Beelink EQ14 — 전체 정보](/ko/smart-home/beelink-eq14-local-ai-review)',
          '[GMKtec G3 Plus — 전체 정보](/ko/smart-home/gmktec-g3-plus-local-ai-review)',
        ],
      },
      relatedReading: {
        id: 'related-reading',
  ...
  fr: {
    ...
    sections: {
      ...
      aiCapabilities: {
        ...
        columns: ['Mini-PC', 'IA locale (7B+)', 'Frigate (caméras)', 'Bruit', 'Niveau de prix'],
        rows: [
          { 'Mini-PC': '[Beelink SER8](/smart-home/beelink-ser8-local-ai-review)', 'IA locale (7B+)': '★★★★☆', 'Frigate (caméras)': '★★★★☆', 'Bruit': 'Faible (petit ventilateur)', 'Niveau de prix': '$$$' },
          { 'Mini-PC': '[Beelink EQ14](/smart-home/beelink-eq14-local-ai-review)', 'IA locale (7B+)': '★★☆☆☆', 'Frigate (caméras)': '★★★☆☆', 'Bruit': 'Quasi silencieux', 'Niveau de prix': '$' },
          { 'Mini-PC': '[GMKtec G3 Plus](/smart-home/gmktec-g3-plus-local-ai-review)', 'IA locale (7B+)': '★★☆☆☆', 'Frigate (caméras)': '★★★☆☆', 'Bruit': 'Quasi silencieux', 'Niveau de prix': '$' },
          { 'Mini-PC': '[Minisforum UM890 Pro](/smart-home/minisforum-um890-pro-local-ai-review)', 'IA locale (7B+)': '★★★★☆', 'Frigate (caméras)': '★★★★☆', 'Bruit': 'Faible à modéré (plus élevé en charge)', 'Niveau de prix': '$$$' },
          { 'Mini-PC': '[GEEKOM A9 Max](/smart-home/geekom-a9-max-local-ai-review)', 'IA locale (7B+)': '★★★★★', 'Frigate (caméras)': '★★★★★', 'Bruit': 'Faible à modéré', 'Niveau de prix': '$$$$' },
        ],
  ...
  ja: {
    ...
    sections: {
      ...
      comparison: {
        ...
        rows: [
          { '機種': '[Beelink EQ14](/smart-home/beelink-eq14-local-ai-review)', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD（内蔵）', 'RAM（テスト構成／最大）': '16 GB／最大16 GB（SO-DIMM 1基）', 'イーサネット': '1GbE×2', 'ストレージ': 'M.2 NVMe SSD×1', 'おおよその価格（2026年8月）': '約¥28,000〜33,000', '待機時／通常時消費電力': '待機時約5〜12W、負荷時約15〜25W', 'こんな人に最適': 'HA + 小型モデル' },
          { '機種': '[GMKtec G3 Plus](/smart-home/gmktec-g3-plus-local-ai-review)', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD（内蔵）', 'RAM（テスト構成／最大）': '16 GB／公式16 GB、32 GBまで報告例あり（SO-DIMM 1基）', 'イーサネット': '2.5GbE×1', 'ストレージ': 'M.2×2（2280 NVMe最大4TB＋2242 SATA最大2TB）', 'おおよその価格（2026年8月）': '約¥28,000〜35,000', '待機時／通常時消費電力': '待機時約5〜12W、負荷時約15〜25W', 'こんな人に最適': 'HA + 小型モデル、予算の柔軟性' },
          { '機種': '[Beelink SER8](/smart-home/beelink-ser8-local-ai-review)', 'CPU': 'Ryzen 7 8845HS', 'GPU/iGPU': 'Radeon 780M', 'RAM（テスト構成／最大）': '32 GB／最大256 GB（DDR5 SO-DIMM×2）', 'イーサネット': '2.5GbE×1', 'ストレージ': 'M.2 PCIe 4.0×2（合計最大8TB）', 'おおよその価格（2026年8月）': '約¥94,800', '待機時／通常時消費電力': '待機時約7〜10W、持続的AI負荷時約45W以上', 'こんな人に最適': 'HA + Frigate + 7B モデル' },
          { '機種': '[Minisforum UM890 Pro](/smart-home/minisforum-um890-pro-local-ai-review)', 'CPU': 'Ryzen 9 8945HS', 'GPU/iGPU': 'SER8 と同クラス', 'RAM（テスト構成／最大）': '32 GB／最大96 GB（DDR5 SO-DIMM×2）', 'イーサネット': '2.5GbE×2', 'ストレージ': 'M.2 NVMe×2＋外部拡張用OCuLink', 'おおよその価格（2026年8月）': '約¥97,000（32GB）／約¥66,000（ベアボーン）', '待機時／通常時消費電力': '待機時約7〜9W、持続負荷時約54〜90W', 'こんな人に最適': 'SER8に類似、より構成の自由度が高い' },
          { '機種': '[GEEKOM A9 Max](/smart-home/geekom-a9-max-local-ai-review)', 'CPU': 'Ryzen AI 9 HX 370', 'GPU/iGPU': 'Radeon 890M + NPU', 'RAM（テスト構成／最大）': '32 GB／最大128 GB（DDR5 SO-DIMM×2）', 'イーサネット': '2.5GbE×2', 'ストレージ': 'M.2 NVMe SSD×2', 'おおよその価格（2026年8月）': '約¥165,000〜195,000', '待機時／通常時消費電力': '待機時約7〜9W、通常使用時約20〜34W', 'こんな人に最適': '最強のオンデバイスAI + 映像処理' },
        ],
        items: [
      ...
      aiCapabilities: {
        ...
        columns: ['ミニPC', 'ローカルAI（7B+）', 'Frigate（カメラ）', '静音性', '価格帯'],
        rows: [
          { 'ミニPC': '[Beelink SER8](/smart-home/beelink-ser8-local-ai-review)', 'ローカルAI（7B+）': '★★★★☆', 'Frigate（カメラ）': '★★★★☆', '静音性': '静か（小型ファン）', '価格帯': '$$$' },
          { 'ミニPC': '[Beelink EQ14](/smart-home/beelink-eq14-local-ai-review)', 'ローカルAI（7B+）': '★★☆☆☆', 'Frigate（カメラ）': '★★★☆☆', '静音性': 'ほぼ無音', '価格帯': '$' },
          { 'ミニPC': '[GMKtec G3 Plus](/smart-home/gmktec-g3-plus-local-ai-review)', 'ローカルAI（7B+）': '★★☆☆☆', 'Frigate（カメラ）': '★★★☆☆', '静音性': 'ほぼ無音', '価格帯': '$' },
          { 'ミニPC': '[Minisforum UM890 Pro](/smart-home/minisforum-um890-pro-local-ai-review)', 'ローカルAI（7B+）': '★★★★☆', 'Frigate（カメラ）': '★★★★☆', '静音性': '静か〜中程度（負荷時は上昇）', '価格帯': '$$$' },
          { 'ミニPC': '[GEEKOM A9 Max](/smart-home/geekom-a9-max-local-ai-review)', 'ローカルAI（7B+）': '★★★★★', 'Frigate（カメラ）': '★★★★★', '静音性': '静か〜中程度', '価格帯': '$$$$' },
        ],
  ...
  pt: {
    ...
    sections: {
      ...
      aiCapabilities: {
        ...
        columns: ['Mini PC', 'IA local (7B+)', 'Frigate (câmeras)', 'Ruído', 'Faixa de preço'],
        rows: [
          { 'Mini PC': '[Beelink SER8](/smart-home/beelink-ser8-local-ai-review)', 'IA local (7B+)': '★★★★☆', 'Frigate (câmeras)': '★★★★☆', 'Ruído': 'Silencioso (ventoinha pequena)', 'Faixa de preço': '$$$' },
          { 'Mini PC': '[Beelink EQ14](/smart-home/beelink-eq14-local-ai-review)', 'IA local (7B+)': '★★☆☆☆', 'Frigate (câmeras)': '★★★☆☆', 'Ruído': 'Quase inaudível', 'Faixa de preço': '$' },
          { 'Mini PC': '[GMKtec G3 Plus](/smart-home/gmktec-g3-plus-local-ai-review)', 'IA local (7B+)': '★★☆☆☆', 'Frigate (câmeras)': '★★★☆☆', 'Ruído': 'Quase inaudível', 'Faixa de preço': '$' },
          { 'Mini PC': '[Minisforum UM890 Pro](/smart-home/minisforum-um890-pro-local-ai-review)', 'IA local (7B+)': '★★★★☆', 'Frigate (câmeras)': '★★★★☆', 'Ruído': 'Silencioso a moderado (sobe sob carga)', 'Faixa de preço': '$$$' },
          { 'Mini PC': '[GEEKOM A9 Max](/smart-home/geekom-a9-max-local-ai-review)', 'IA local (7B+)': '★★★★★', 'Frigate (câmeras)': '★★★★★', 'Ruído': 'Silencioso a moderado', 'Faixa de preço': '$$$$' },
        ],
  ...
  zh: {
    ...
    sections: {
      ...
      comparison: {
        ...
        rows: [
          { '机型': '[Beelink EQ14](/smart-home/beelink-eq14-local-ai-review)', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD（集成）', '内存（测试配置 / 最大）': '16 GB / 最大 16 GB（1 根 SO-DIMM）', '以太网': '2x 1GbE', '存储': '1x M.2 NVMe SSD', '大致价格（2026年8月）': '约 $189–220', '待机/典型功耗': '待机约5–12W，负载约15–25W', '适合场景': 'HA + 一个小型模型' },
          { '机型': '[GMKtec G3 Plus](/smart-home/gmktec-g3-plus-local-ai-review)', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD（集成）', '内存（测试配置 / 最大）': '16 GB / 官方 16 GB，有用户报告可达 32 GB（1 根 SO-DIMM）', '以太网': '1x 2.5GbE', '存储': '2x M.2（2280 NVMe 最高 4TB + 2242 SATA 最高 2TB）', '大致价格（2026年8月）': '约 $180–230', '待机/典型功耗': '待机约5–12W，负载约15–25W', '适合场景': 'HA + 一个小型模型，预算灵活' },
          { '机型': '[Beelink SER8](/smart-home/beelink-ser8-local-ai-review)', 'CPU': 'Ryzen 7 8845HS', 'GPU/iGPU': 'Radeon 780M', '内存（测试配置 / 最大）': '32 GB / 最大 256 GB（2 根 DDR5 SO-DIMM）', '以太网': '1x 2.5GbE', '存储': '2x M.2 PCIe 4.0（合计最高 8TB）', '大致价格（2026年8月）': '约 $650', '待机/典型功耗': '待机约7–10W，持续 AI 负载约45W以上', '适合场景': 'HA + Frigate + 7B 模型' },
          { '机型': '[Minisforum UM890 Pro](/smart-home/minisforum-um890-pro-local-ai-review)', 'CPU': 'Ryzen 9 8945HS', 'GPU/iGPU': '与 SER8 同级别', '内存（测试配置 / 最大）': '32 GB / 最大 96 GB（2 根 DDR5 SO-DIMM）', '以太网': '2x 2.5GbE', '存储': '2x M.2 NVMe + 外接扩展用 OCuLink', '大致价格（2026年8月）': '约 $649（32GB）/ 约 $439（裸机）', '待机/典型功耗': '待机约7–9W，持续负载约54–90W', '适合场景': '类似 SER8，配置更灵活' },
          { '机型': '[GEEKOM A9 Max](/smart-home/geekom-a9-max-local-ai-review)', 'CPU': 'Ryzen AI 9 HX 370', 'GPU/iGPU': 'Radeon 890M + NPU', '内存（测试配置 / 最大）': '32 GB / 最大 128 GB（2 根 DDR5 SO-DIMM）', '以太网': '2x 2.5GbE', '存储': '2x M.2 NVMe SSD', '大致价格（2026年8月）': '约 $1,099–1,299', '待机/典型功耗': '待机约7–9W，典型使用约20–34W', '适合场景': '最强设备端 AI + 视觉处理' },
        ],
        items: [
      ...
      aiCapabilities: {
        ...
        columns: ['迷你 PC', '本地 AI（7B+）', 'Frigate（摄像头）', '噪音', '价格档位'],
        rows: [
          { '迷你 PC': '[Beelink SER8](/smart-home/beelink-ser8-local-ai-review)', '本地 AI（7B+）': '★★★★☆', 'Frigate（摄像头）': '★★★★☆', '噪音': '安静（小风扇）', '价格档位': '$$$' },
          { '迷你 PC': '[Beelink EQ14](/smart-home/beelink-eq14-local-ai-review)', '本地 AI（7B+）': '★★☆☆☆', 'Frigate（摄像头）': '★★★☆☆', '噪音': '几乎无声', '价格档位': '$' },
          { '迷你 PC': '[GMKtec G3 Plus](/smart-home/gmktec-g3-plus-local-ai-review)', '本地 AI（7B+）': '★★☆☆☆', 'Frigate（摄像头）': '★★★☆☆', '噪音': '几乎无声', '价格档位': '$' },
          { '迷你 PC': '[Minisforum UM890 Pro](/smart-home/minisforum-um890-pro-local-ai-review)', '本地 AI（7B+）': '★★★★☆', 'Frigate（摄像头）': '★★★★☆', '噪音': '安静到中等（负载下升高）', '价格档位': '$$$' },
          { '迷你 PC': '[GEEKOM A9 Max](/smart-home/geekom-a9-max-local-ai-review)', '本地 AI（7B+）': '★★★★★', 'Frigate（摄像头）': '★★★★★', '噪音': '安静到中等', '价格档位': '$$$$' },
        ],
