...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    toc: [
      ...
      { label: 'Suitability at a Glance', anchor: 'ai-capabilities' },
    ...
    sections: {
        ...
        rankedItems: [
          {
            ...
            verdict:
              'With a Ryzen 7 8845HS and Radeon 780M iGPU, this is expected to be the strongest single-box option in this guide for running Home Assistant, Frigate, and a 7B-class model on Ollama together. The 780M iGPU — not an NPU — does the heavy lifting for local-LLM inference. Independent community benchmarks of the Radeon 780M running a quantized 7B model (Q4_K_M) via [llama.cpp with Vulkan GPU offload](https://github.com/ggml-org/llama.cpp/discussions/10879) report roughly 8–18 tokens/sec depending on the specific model and context length — a useful reference point, though not a PromptQuorum measurement on this exact unit.',
            pros: [
              ...
              'One 2.5GbE port for a reliable wired connection',
            ],
            cons: [
      ...
      comparison: {
        ...
        rows: [
          { 'Model': 'Beelink EQ14', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD (integrated)', 'RAM (as tested / max)': '16 GB / 16 GB max (1 SO-DIMM)', 'Ethernet': 'Dual 1GbE', 'Storage': '1x M.2 NVMe SSD', 'Approx. price (Aug 2026)': '~$189–220', 'Idle / typical power': '~5–12W idle, ~15–25W under load', 'Best for': 'HA + a small model' },
          { 'Model': 'GMKtec G3 Plus', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD (integrated)', 'RAM (as tested / max)': '16 GB / officially 16 GB, up to 32 GB reported (1 SO-DIMM)', 'Ethernet': '1x 2.5GbE', 'Storage': 'Dual M.2 (2280 NVMe up to 4TB + 2242 SATA up to 2TB)', 'Approx. price (Aug 2026)': '~$180–230', 'Idle / typical power': '~5–12W idle, ~15–25W under load', 'Best for': 'HA + a small model, budget flexibility' },
          { 'Model': 'Beelink SER8', 'CPU': 'Ryzen 7 8845HS', 'GPU/iGPU': 'Radeon 780M', 'RAM (as tested / max)': '32 GB / up to 256 GB (2x DDR5 SO-DIMM)', 'Ethernet': '1x 2.5GbE', 'Storage': 'Dual M.2 PCIe 4.0 (up to 8TB combined)', 'Approx. price (Aug 2026)': '~$650', 'Idle / typical power': '~7–10W idle, ~45W+ under sustained AI load', 'Best for': 'HA + Frigate + a 7B model' },
          { 'Model': 'Minisforum UM890 Pro', 'CPU': 'Ryzen 9 8945HS', 'GPU/iGPU': 'Same class as SER8', 'RAM (as tested / max)': '32 GB / up to 96 GB (2x DDR5 SO-DIMM)', 'Ethernet': 'Dual 2.5GbE', 'Storage': 'Dual M.2 NVMe + OCuLink for external expansion', 'Approx. price (Aug 2026)': '~$649 (32GB) / ~$439 barebones', 'Idle / typical power': '~7–9W idle, ~54–90W under sustained load', 'Best for': 'Similar to SER8, more configurable' },
          { 'Model': 'GEEKOM A9 Max', 'CPU': 'Ryzen AI 9 HX 370', 'GPU/iGPU': 'Radeon 890M + NPU', 'RAM (as tested / max)': '32 GB / up to 128 GB (2x DDR5 SO-DIMM)', 'Ethernet': 'Dual 2.5GbE', 'Storage': 'Dual M.2 NVMe SSD', 'Approx. price (Aug 2026)': '~$1,099–1,299', 'Idle / typical power': '~7–9W idle, ~20–34W typical use', 'Best for': 'Strongest on-device AI + vision' },
        ],
        items: [
      ...
      aiCapabilities: {
        id: 'ai-capabilities',
        title: 'Suitability at a Glance',
        content:
          '**Ratings below reflect expected suitability based on each unit\'s published specifications and component class, not independently measured benchmarks by PromptQuorum on these exact units — treat this as a starting point for sizing your setup, not a guarantee.** ★★★★★ = excellent fit, ★★☆☆☆ = usable but limited.',
        columns: ['Mini PC', 'Home Assistant', 'Local AI (7B+)', 'Frigate (cameras)', 'Noise', 'Price tier'],
        rows: [
          { 'Mini PC': 'Beelink SER8', 'Home Assistant': '★★★★★', 'Local AI (7B+)': '★★★★☆', 'Frigate (cameras)': '★★★★☆', 'Noise': 'Low (small fan)', 'Price tier': '$$$' },
          { 'Mini PC': 'Beelink EQ14', 'Home Assistant': '★★★★★', 'Local AI (7B+)': '★★☆☆☆', 'Frigate (cameras)': '★★★☆☆', 'Noise': 'Near-silent', 'Price tier': '$' },
          { 'Mini PC': 'GMKtec G3 Plus', 'Home Assistant': '★★★★★', 'Local AI (7B+)': '★★☆☆☆', 'Frigate (cameras)': '★★★☆☆', 'Noise': 'Near-silent', 'Price tier': '$' },
          { 'Mini PC': 'Minisforum UM890 Pro', 'Home Assistant': '★★★★★', 'Local AI (7B+)': '★★★★☆', 'Frigate (cameras)': '★★★★☆', 'Noise': 'Low-moderate (higher under load)', 'Price tier': '$$$' },
          { 'Mini PC': 'GEEKOM A9 Max', 'Home Assistant': '★★★★★', 'Local AI (7B+)': '★★★★★', 'Frigate (cameras)': '★★★★★', 'Noise': 'Low-moderate', 'Price tier': '$$$$' },
        ],
        note: 'Frigate camera-count guidance (from Frigate\'s own planning documentation, not PromptQuorum testing): CPU-only detection struggles beyond a couple of cameras regardless of the box — Frigate\'s docs recommend hardware-accelerated detection (via the iGPU, a Coral USB accelerator, or an OpenVINO-compatible NPU) once you go past light, occasional-motion use. As a rough guide: N150-class boxes are comfortable with a handful of cameras (2–4) using GPU/Coral-assisted detection; Ryzen 780M/890M-class boxes with GPU-accelerated detection can reasonably handle a mid-size camera count (roughly 6–10) before you should plan for dedicated NVR hardware. Confirm against Frigate\'s planning guide for your specific camera count, resolution, and frame rate.',
      },
      decisionFilters: {
        id: 'best-for',
        title: 'Best For…',
      ...
      setupNotes: {
        ...
        note: 'Recommended software stack: for a single-purpose box, Home Assistant OS (HAOS) installed directly is the simplest path — it manages its own updates and add-ons with the least setup friction. If you want to run Frigate, Ollama, and Home Assistant as separate, independently updatable services on one machine — or plan to add other self-hosted apps later — a Proxmox (or similar hypervisor) layer with HAOS in its own VM and Frigate/Ollama in containers gives more flexibility at the cost of extra setup time. For Ollama specifically: pull a quantized model (Q4_K_M is a reasonable default for RAM-constrained boxes), and confirm GPU offload is active — on AMD iGPUs this typically means the Vulkan or ROCm backend is being used rather than falling back to CPU-only inference, which is significantly slower.',
      },
      faqSection: {
        id: 'faq',
  ...
  ar: {
    ...
    toc: [
      ...
      { label: 'مدى الملاءمة بلمحة', anchor: 'ai-capabilities' },
    ...
    sections: {
        ...
        rankedItems: [
          {
            ...
            verdict:
              'بمعالج Ryzen 7 8845HS وiGPU من طراز Radeon 780M، من المتوقع أن يكون هذا أقوى خيار جهاز واحد في هذا الدليل لتشغيل Home Assistant وFrigate ونموذج من فئة 7B على Ollama معًا. iGPU طراز 780M — وليس NPU — هو من يؤدي العمل الأثقل في استدلال LLM المحلي. تشير اختبارات مجتمعية مستقلة لتشغيل نموذج 7B مكمّم (Q4_K_M) عبر [llama.cpp مع تسريع Vulkan](https://github.com/ggml-org/llama.cpp/discussions/10879) على Radeon 780M إلى نحو ‎8–18‎ رمزًا/ثانية حسب النموذج المحدد وطول السياق — مرجع مفيد، لكنه ليس قياسًا أجرته PromptQuorum على هذا الجهاز بالتحديد.',
            pros: [
              ...
              'منفذ ‎2.5GbE‎ واحد لاتصال سلكي موثوق',
            ],
            cons: [
              'أغلى من صندوق N150',
      ...
      comparison: {
        ...
        rows: [
          { 'الجهاز': 'Beelink EQ14', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD (متكاملة)', 'RAM (المختبَرة/الأقصى)': '16 GB / أقصى 16 GB (منفذ SO-DIMM واحد)', 'الشبكة السلكية': 'منفذا ‎1GbE‎', 'التخزين': 'منفذ ‎M.2 NVMe‎ واحد', 'السعر التقريبي (أغسطس 2026)': '‎$189–220‎', 'استهلاك الطاقة عند الخمول/النموذجي': '‎5–12W‎ خمول، ‎15–25W‎ تحت الحِمل', 'الأفضل لـ': 'HA + نموذج صغير' },
          { 'الجهاز': 'GMKtec G3 Plus', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD (متكاملة)', 'RAM (المختبَرة/الأقصى)': '16 GB / رسميًا 16 GB، وأُفيد بـ 32 GB (منفذ SO-DIMM واحد)', 'الشبكة السلكية': 'منفذ ‎2.5GbE‎ واحد', 'التخزين': 'منفذا ‎M.2‎ (‎2280 NVMe‎ حتى ‎4TB‎ + ‎2242 SATA‎ حتى ‎2TB‎)', 'السعر التقريبي (أغسطس 2026)': '‎$180–230‎', 'استهلاك الطاقة عند الخمول/النموذجي': '‎5–12W‎ خمول، ‎15–25W‎ تحت الحِمل', 'الأفضل لـ': 'HA + نموذج صغير، مرونة في الميزانية' },
          { 'الجهاز': 'Beelink SER8', 'CPU': 'Ryzen 7 8845HS', 'GPU/iGPU': 'Radeon 780M', 'RAM (المختبَرة/الأقصى)': '32 GB / حتى 256 GB (منفذا ‎DDR5 SO-DIMM‎)', 'الشبكة السلكية': 'منفذ ‎2.5GbE‎ واحد', 'التخزين': 'منفذا ‎M.2 PCIe 4.0‎ (حتى ‎8TB‎ مجتمعة)', 'السعر التقريبي (أغسطس 2026)': '‎$650‎', 'استهلاك الطاقة عند الخمول/النموذجي': '‎7–10W‎ خمول، ‎45W+‎ تحت حِمل ذكاء اصطناعي مستدام', 'الأفضل لـ': 'HA + Frigate + نموذج 7B' },
          { 'الجهاز': 'Minisforum UM890 Pro', 'CPU': 'Ryzen 9 8945HS', 'GPU/iGPU': 'نفس فئة SER8', 'RAM (المختبَرة/الأقصى)': '32 GB / حتى 96 GB (منفذا ‎DDR5 SO-DIMM‎)', 'الشبكة السلكية': 'منفذا ‎2.5GbE‎', 'التخزين': 'منفذا ‎M.2 NVMe‎ + ‎OCuLink‎ للتوسعة الخارجية', 'السعر التقريبي (أغسطس 2026)': '‎$649‎ (32GB) / ‎$439‎ بدون تجهيزات', 'استهلاك الطاقة عند الخمول/النموذجي': '‎7–9W‎ خمول، ‎54–90W‎ تحت حِمل مستمر', 'الأفضل لـ': 'مشابه لـ SER8، أكثر قابلية للتكوين' },
          { 'الجهاز': 'GEEKOM A9 Max', 'CPU': 'Ryzen AI 9 HX 370', 'GPU/iGPU': 'Radeon 890M + NPU', 'RAM (المختبَرة/الأقصى)': '32 GB / حتى 128 GB (منفذا ‎DDR5 SO-DIMM‎)', 'الشبكة السلكية': 'منفذا ‎2.5GbE‎', 'التخزين': 'منفذا ‎M.2 NVMe‎', 'السعر التقريبي (أغسطس 2026)': '‎$1,099–1,299‎', 'استهلاك الطاقة عند الخمول/النموذجي': '‎7–9W‎ خمول، ‎20–34W‎ استخدام نموذجي', 'الأفضل لـ': 'أقوى ذكاء اصطناعي على الجهاز + رؤية' },
        ],
        items: [
      ...
      aiCapabilities: {
        id: 'ai-capabilities',
        title: 'مدى الملاءمة بلمحة',
        content:
          '**تعكس التقييمات أدناه مدى الملاءمة المتوقعة بناءً على المواصفات المنشورة لكل جهاز وفئة مكوناته، وليست اختبارات أداء قِيست بشكل مستقل من PromptQuorum على هذه الأجهزة بالتحديد — اعتبرها نقطة انطلاق لتحديد حجم إعدادك، لا ضمانًا.** ★★★★★ = ملاءمة ممتازة، ★★☆☆☆ = قابلة للاستخدام لكن محدودة.',
        columns: ['الجهاز', 'Home Assistant', 'الذكاء الاصطناعي المحلي (7B+)', 'Frigate (الكاميرات)', 'الضوضاء', 'فئة السعر'],
        rows: [
          { 'الجهاز': 'Beelink SER8', 'Home Assistant': '★★★★★', 'الذكاء الاصطناعي المحلي (7B+)': '★★★★☆', 'Frigate (الكاميرات)': '★★★★☆', 'الضوضاء': 'منخفضة (مروحة صغيرة)', 'فئة السعر': '$$$' },
          { 'الجهاز': 'Beelink EQ14', 'Home Assistant': '★★★★★', 'الذكاء الاصطناعي المحلي (7B+)': '★★☆☆☆', 'Frigate (الكاميرات)': '★★★☆☆', 'الضوضاء': 'شبه صامت', 'فئة السعر': '$' },
          { 'الجهاز': 'GMKtec G3 Plus', 'Home Assistant': '★★★★★', 'الذكاء الاصطناعي المحلي (7B+)': '★★☆☆☆', 'Frigate (الكاميرات)': '★★★☆☆', 'الضوضاء': 'شبه صامت', 'فئة السعر': '$' },
          { 'الجهاز': 'Minisforum UM890 Pro', 'Home Assistant': '★★★★★', 'الذكاء الاصطناعي المحلي (7B+)': '★★★★☆', 'Frigate (الكاميرات)': '★★★★☆', 'الضوضاء': 'منخفضة إلى متوسطة (أعلى تحت الحِمل)', 'فئة السعر': '$$$' },
          { 'الجهاز': 'GEEKOM A9 Max', 'Home Assistant': '★★★★★', 'الذكاء الاصطناعي المحلي (7B+)': '★★★★★', 'Frigate (الكاميرات)': '★★★★★', 'الضوضاء': 'منخفضة إلى متوسطة', 'فئة السعر': '$$$$' },
        ],
        note: 'إرشادات عدد كاميرات Frigate (من وثائق تخطيط Frigate الرسمية، وليست اختبارات من PromptQuorum): يواجه الكشف المعتمد على CPU فقط صعوبة بعد كاميرا أو اثنتين بغضّ النظر عن الجهاز — توصي وثائق Frigate بالكشف المُسرَّع بالأجهزة (عبر iGPU، أو مسرّع Coral USB، أو NPU متوافقة مع OpenVINO) بمجرد تجاوز الاستخدام الخفيف وغير المتكرر. كإرشاد تقريبي: أجهزة فئة N150 مريحة مع عدد قليل من الكاميرات (2–4) باستخدام كشف مدعوم بـ GPU/Coral؛ أما أجهزة فئة Ryzen 780M/890M مع كشف مُسرَّع بـ GPU فيمكنها التعامل بشكل معقول مع عدد كاميرات متوسط (نحو 6–10) قبل أن تحتاج لتخطيط أجهزة NVR مخصصة. تأكد من وثائق تخطيط Frigate لعدد الكاميرات والدقة ومعدل الإطارات الخاص بك.',
      },
      decisionFilters: {
        id: 'best-for',
        title: 'الأفضل لـ…',
      ...
      setupNotes: {
        ...
        note: 'مكدس البرمجيات الموصى به: لجهاز أحادي الغرض، يُعدّ تثبيت Home Assistant OS (HAOS) مباشرة أبسط طريق — إذ يدير تحديثاته وإضافاته بأقل قدر من التعقيد. إذا أردت تشغيل Frigate وOllama وHome Assistant كخدمات منفصلة قابلة للتحديث بشكل مستقل على جهاز واحد — أو تخطط لإضافة تطبيقات أخرى ذاتية الاستضافة لاحقًا — فإن طبقة Proxmox (أو مُفَعِّل تجازي مشابه) مع HAOS في آلة افتراضية خاصة به وFrigate/Ollama في حاويات تمنحك مرونة أكبر مقابل وقت إعداد إضافي. بخصوص Ollama تحديدًا: نزّل نموذجًا مكمّمًا (Q4_K_M خيار افتراضي معقول للأجهزة محدودة RAM)، وتأكد من تفعيل تسريع GPU — على وحدات iGPU من AMD، يعني هذا عادةً استخدام واجهة Vulkan أو ROCm بدلًا من الرجوع إلى الاستدلال بواسطة CPU فقط، وهو أبطأ بكثير.',
      },
      faqSection: {
        id: 'faq',
        title: 'أسئلة شائعة',
  ...
  de: {
    ...
    toc: [
      ...
      { label: 'Eignung auf einen Blick', anchor: 'ai-capabilities' },
    ...
    sections: {
        ...
        rankedItems: [
          {
            ...
            verdict:
              'Mit einem Ryzen 7 8845HS und einer Radeon-780M-iGPU dürfte dies die stärkste Einzelgerät-Option dieser Übersicht sein, um Home Assistant, Frigate und ein Modell der 7B-Klasse gemeinsam auf Ollama zu betreiben. Die 780M-iGPU – nicht eine NPU – übernimmt die Hauptarbeit bei der lokalen LLM-Inferenz. Unabhängige Community-Benchmarks eines quantisierten 7B-Modells (Q4_K_M) über [llama.cpp mit Vulkan-GPU-Offload](https://github.com/ggml-org/llama.cpp/discussions/10879) auf der Radeon 780M berichten von rund 8–18 Tokens/Sekunde, je nach Modell und Kontextlänge – ein nützlicher Referenzwert, aber keine PromptQuorum-Messung an diesem konkreten Gerät.',
            pros: [
              ...
              'Ein 2,5GbE-Anschluss für eine zuverlässige kabelgebundene Verbindung',
            ],
            cons: [
      ...
      setupNotes: {
        ...
        note: 'Empfohlener Software-Stack: Für ein Gerät mit einem einzigen Zweck ist die direkte Installation von Home Assistant OS (HAOS) der einfachste Weg – es verwaltet seine eigenen Updates und Add-ons mit dem geringsten Einrichtungsaufwand. Wenn Sie Frigate, Ollama und Home Assistant als separate, unabhängig aktualisierbare Dienste auf einem Gerät betreiben möchten – oder später weitere selbst gehostete Apps hinzufügen wollen –, bietet eine Proxmox-Schicht (oder ein ähnlicher Hypervisor) mit HAOS in einer eigenen VM und Frigate/Ollama in Containern mehr Flexibilität, kostet aber zusätzliche Einrichtungszeit. Speziell für Ollama: Laden Sie ein quantisiertes Modell (Q4_K_M ist ein vernünftiger Standard für RAM-begrenzte Geräte) und bestätigen Sie, dass GPU-Offload aktiv ist – bei AMD-iGPUs bedeutet das in der Regel, dass das Vulkan- oder ROCm-Backend genutzt wird statt auf reine CPU-Inferenz zurückzufallen, die deutlich langsamer ist.',
      },
      faqSection: {
        id: 'faq',
  ...
  es: {
    ...
    toc: [
      ...
      { label: 'Idoneidad de un Vistazo', anchor: 'ai-capabilities' },
    ...
    sections: {
        ...
        rankedItems: [
          {
            ...
            verdict:
              'Con un Ryzen 7 8845HS y una iGPU Radeon 780M, se espera que sea la opción de un solo equipo más potente de esta guía para ejecutar Home Assistant, Frigate y un modelo de clase 7B con Ollama juntos. La iGPU 780M — no una NPU — es la que realiza el trabajo pesado de la inferencia del LLM local. Pruebas independientes de la comunidad de un modelo 7B cuantizado (Q4_K_M) usando [llama.cpp con offload de GPU vía Vulkan](https://github.com/ggml-org/llama.cpp/discussions/10879) en la Radeon 780M reportan entre 8 y 18 tokens/segundo, según el modelo concreto y la longitud de contexto — un dato de referencia útil, aunque no una medición de PromptQuorum en este equipo exacto.',
            pros: [
              ...
              'Un puerto 2.5GbE para una conexión cableada fiable',
            ],
            cons: [
      ...
      aiCapabilities: {
        id: 'ai-capabilities',
        title: 'Idoneidad de un Vistazo',
        content:
          '**Las valoraciones de abajo reflejan la idoneidad esperada según las especificaciones publicadas y la clase de componentes de cada equipo, no benchmarks medidos de forma independiente por PromptQuorum en estos equipos concretos — trátalo como punto de partida para dimensionar tu instalación, no como una garantía.** ★★★★★ = excelente ajuste, ★★☆☆☆ = utilizable pero limitado.',
        columns: ['Mini PC', 'Home Assistant', 'IA local (7B+)', 'Frigate (cámaras)', 'Ruido', 'Nivel de precio'],
        rows: [
          { 'Mini PC': 'Beelink SER8', 'Home Assistant': '★★★★★', 'IA local (7B+)': '★★★★☆', 'Frigate (cámaras)': '★★★★☆', 'Ruido': 'Bajo (ventilador pequeño)', 'Nivel de precio': '$$$' },
          { 'Mini PC': 'Beelink EQ14', 'Home Assistant': '★★★★★', 'IA local (7B+)': '★★☆☆☆', 'Frigate (cámaras)': '★★★☆☆', 'Ruido': 'Casi silencioso', 'Nivel de precio': '$' },
          { 'Mini PC': 'GMKtec G3 Plus', 'Home Assistant': '★★★★★', 'IA local (7B+)': '★★☆☆☆', 'Frigate (cámaras)': '★★★☆☆', 'Ruido': 'Casi silencioso', 'Nivel de precio': '$' },
          { 'Mini PC': 'Minisforum UM890 Pro', 'Home Assistant': '★★★★★', 'IA local (7B+)': '★★★★☆', 'Frigate (cámaras)': '★★★★☆', 'Ruido': 'Bajo-moderado (más alto bajo carga)', 'Nivel de precio': '$$$' },
          { 'Mini PC': 'GEEKOM A9 Max', 'Home Assistant': '★★★★★', 'IA local (7B+)': '★★★★★', 'Frigate (cámaras)': '★★★★★', 'Ruido': 'Bajo-moderado', 'Nivel de precio': '$$$$' },
        ],
        note: 'Guía de número de cámaras para Frigate (de la propia documentación de planificación de Frigate, no pruebas de PromptQuorum): la detección solo con CPU tiene dificultades pasadas una o dos cámaras, sea cual sea el equipo — la documentación de Frigate recomienda detección acelerada por hardware (mediante la iGPU, un acelerador Coral USB, o una NPU compatible con OpenVINO) en cuanto superas el uso ligero y ocasional. Como guía aproximada: los equipos de clase N150 son cómodos con un puñado de cámaras (2–4) usando detección asistida por GPU/Coral; los equipos de clase Ryzen 780M/890M con detección acelerada por GPU pueden manejar razonablemente un número medio de cámaras (aproximadamente 6–10) antes de que convenga planificar hardware NVR dedicado. Confirma con la guía de planificación de Frigate para tu número de cámaras, resolución y fotogramas concretos.',
      },
      decisionFilters: {
        id: 'best-for',
        title: 'Ideal Para…',
      ...
      setupNotes: {
        ...
        note: 'Pila de software recomendada: para un equipo de propósito único, instalar Home Assistant OS (HAOS) directamente es el camino más simple — gestiona sus propias actualizaciones y complementos con la mínima fricción. Si quieres ejecutar Frigate, Ollama y Home Assistant como servicios separados y actualizables de forma independiente en un solo equipo — o planeas añadir otras apps autoalojadas más adelante —, una capa de Proxmox (u otro hipervisor similar) con HAOS en su propia VM y Frigate/Ollama en contenedores da más flexibilidad a costa de tiempo de configuración adicional. En cuanto a Ollama: descarga un modelo cuantizado (Q4_K_M es un valor por defecto razonable para equipos con RAM limitada) y confirma que el offload a GPU está activo — en iGPUs de AMD esto normalmente significa que se está usando el backend Vulkan o ROCm en lugar de caer en inferencia solo con CPU, que es notablemente más lenta.',
      },
      faqSection: {
        id: 'faq',
  ...
  ko: {
    ...
    toc: [
      ...
      { label: '적합성 한눈에 보기', anchor: 'ai-capabilities' },
    ...
    sections: {
        ...
        rankedItems: [
          {
            ...
            verdict:
              'Ryzen 7 8845HS와 Radeon 780M iGPU를 갖춘 이 제품은 Home Assistant, Frigate, 7B급 모델을 Ollama에서 함께 실행하는 데 있어 이 가이드에서 가장 강력한 단일 기기 옵션일 것으로 예상됩니다. 780M iGPU가 — NPU가 아니라 — 로컬 LLM 추론의 핵심 작업을 담당합니다. Radeon 780M에서 양자화된 7B 모델(Q4_K_M)을 [Vulkan GPU 오프로드를 적용한 llama.cpp](https://github.com/ggml-org/llama.cpp/discussions/10879)로 실행한 독립적인 커뮤니티 벤치마크에 따르면 모델과 컨텍스트 길이에 따라 초당 약 8–18 토큰이 보고되었습니다 — 유용한 참고치이지만, 이 정확한 기기에서 PromptQuorum이 측정한 값은 아닙니다.',
            pros: [
      ...
      comparison: {
        ...
        columns: ['제품', 'CPU', 'GPU/iGPU', 'RAM(테스트/최대)', '이더넷', '저장소', '대략적 가격(2026년 8월)', '유휴/일반 전력 소비', '이런 경우에 최적'],
        rows: [
          { '제품': 'Beelink EQ14', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD(내장)', 'RAM(테스트/최대)': '16 GB / 최대 16 GB(SO-DIMM 1개)', '이더넷': '1GbE 2개', '저장소': 'M.2 NVMe SSD 1개', '대략적 가격(2026년 8월)': '약 $189–220', '유휴/일반 전력 소비': '유휴 약 5–12W, 부하 시 약 15–25W', '이런 경우에 최적': 'HA + 소형 모델' },
          { '제품': 'GMKtec G3 Plus', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD(내장)', 'RAM(테스트/최대)': '16 GB / 공식 16 GB, 32 GB까지 보고됨(SO-DIMM 1개)', '이더넷': '2.5GbE 1개', '저장소': 'M.2 2개(2280 NVMe 최대 4TB + 2242 SATA 최대 2TB)', '대략적 가격(2026년 8월)': '약 $180–230', '유휴/일반 전력 소비': '유휴 약 5–12W, 부하 시 약 15–25W', '이런 경우에 최적': 'HA + 소형 모델, 예산 유연성' },
          { '제품': 'Beelink SER8', 'CPU': 'Ryzen 7 8845HS', 'GPU/iGPU': 'Radeon 780M', 'RAM(테스트/최대)': '32 GB / 최대 256 GB(DDR5 SO-DIMM 2개)', '이더넷': '2.5GbE 1개', '저장소': 'M.2 PCIe 4.0 2개(합산 최대 8TB)', '대략적 가격(2026년 8월)': '약 $650', '유휴/일반 전력 소비': '유휴 약 7–10W, 지속적인 AI 부하 시 약 45W 이상', '이런 경우에 최적': 'HA + Frigate + 7B 모델' },
          { '제품': 'Minisforum UM890 Pro', 'CPU': 'Ryzen 9 8945HS', 'GPU/iGPU': 'SER8과 동일 등급', 'RAM(테스트/최대)': '32 GB / 최대 96 GB(DDR5 SO-DIMM 2개)', '이더넷': '2.5GbE 2개', '저장소': 'M.2 NVMe 2개 + 외부 확장용 OCuLink', '대략적 가격(2026년 8월)': '약 $649(32GB) / 약 $439 베어본', '유휴/일반 전력 소비': '유휴 약 7–9W, 지속 부하 시 약 54–90W', '이런 경우에 최적': 'SER8과 유사, 더 구성 가능' },
          { '제품': 'GEEKOM A9 Max', 'CPU': 'Ryzen AI 9 HX 370', 'GPU/iGPU': 'Radeon 890M + NPU', 'RAM(테스트/최대)': '32 GB / 최대 128 GB(DDR5 SO-DIMM 2개)', '이더넷': '2.5GbE 2개', '저장소': 'M.2 NVMe SSD 2개', '대략적 가격(2026년 8월)': '약 $1,099–1,299', '유휴/일반 전력 소비': '유휴 약 7–9W, 일반 사용 시 약 20–34W', '이런 경우에 최적': '최강 온-디바이스 AI + 비전' },
        ],
        items: [
      ...
      aiCapabilities: {
        ...
        columns: ['미니 PC', 'Home Assistant', '로컬 AI(7B+)', 'Frigate(카메라)', '소음', '가격대'],
        rows: [
          { '미니 PC': 'Beelink SER8', 'Home Assistant': '★★★★★', '로컬 AI(7B+)': '★★★★☆', 'Frigate(카메라)': '★★★★☆', '소음': '낮음(소형 팬)', '가격대': '$$$' },
          { '미니 PC': 'Beelink EQ14', 'Home Assistant': '★★★★★', '로컬 AI(7B+)': '★★☆☆☆', 'Frigate(카메라)': '★★★☆☆', '소음': '거의 무음', '가격대': '$' },
          { '미니 PC': 'GMKtec G3 Plus', 'Home Assistant': '★★★★★', '로컬 AI(7B+)': '★★☆☆☆', 'Frigate(카메라)': '★★★☆☆', '소음': '거의 무음', '가격대': '$' },
          { '미니 PC': 'Minisforum UM890 Pro', 'Home Assistant': '★★★★★', '로컬 AI(7B+)': '★★★★☆', 'Frigate(카메라)': '★★★★☆', '소음': '낮음-중간(부하 시 더 높음)', '가격대': '$$$' },
          { '미니 PC': 'GEEKOM A9 Max', 'Home Assistant': '★★★★★', '로컬 AI(7B+)': '★★★★★', 'Frigate(카메라)': '★★★★★', '소음': '낮음-중간', '가격대': '$$$$' },
        ],
        note: 'Frigate 카메라 대수 가이드(PromptQuorum 테스트가 아닌 Frigate 자체 계획 문서 기준): CPU 전용 감지는 기기와 상관없이 카메라 한두 대만 넘어가도 어려움을 겪습니다 — Frigate 문서는 가벼운, 간헐적인 사용을 넘어서면 하드웨어 가속 감지(iGPU, Coral USB 가속기, 또는 OpenVINO 호환 NPU를 통해)를 권장합니다. 대략적인 기준으로: N150 등급 기기는 GPU/Coral 보조 감지로 카메라 몇 대(2–4대)까지 무난하며, GPU 가속 감지를 사용하는 Ryzen 780M/890M 등급 기기는 전용 NVR 하드웨어를 계획해야 하기 전까지 중간 규모의 카메라 대수(대략 6–10대)를 합리적으로 처리할 수 있습니다. 정확한 카메라 대수, 해상도, 프레임률에 대해서는 Frigate 계획 가이드로 확인하십시오.',
      },
      decisionFilters: {
        id: 'best-for',
        title: '이런 경우에 최적…',
      ...
      setupNotes: {
        ...
        note: '권장 소프트웨어 스택: 단일 목적 기기라면 Home Assistant OS(HAOS)를 직접 설치하는 것이 가장 간단한 방법입니다 — 자체 업데이트와 애드온을 최소한의 설정 부담으로 관리합니다. Frigate, Ollama, Home Assistant을 한 기기에서 독립적으로 업데이트 가능한 별도 서비스로 운영하고 싶거나 나중에 다른 셀프호스팅 앱을 추가할 계획이라면, HAOS를 자체 VM에, Frigate/Ollama를 컨테이너에 배치하는 Proxmox(또는 유사한 하이퍼바이저) 계층이 추가 설정 시간을 들이는 대신 더 큰 유연성을 제공합니다. Ollama 관련: 양자화된 모델을 받으십시오(RAM이 제한적인 기기에는 Q4_K_M이 합리적인 기본값입니다), GPU 오프로드가 활성화되어 있는지 확인하십시오 — AMD iGPU에서는 일반적으로 Vulkan 또는 ROCm 백엔드가 사용되는지 확인하는 것을 의미하며, 그렇지 않으면 훨씬 느린 CPU 전용 추론으로 대체됩니다.',
      },
      faqSection: {
        id: 'faq',
        title: '자주 묻는 질문',
  ...
  fr: {
    ...
    toc: [
      ...
      { label: 'Adéquation en un coup d\'œil', anchor: 'ai-capabilities' },
    ...
    sections: {
        ...
        rankedItems: [
          {
            ...
            verdict:
              'Avec un Ryzen 7 8845HS et un iGPU Radeon 780M, cette machine devrait être l\'option monoposte la plus puissante de ce guide pour faire tourner Home Assistant, Frigate et un modèle de classe 7B sur Ollama ensemble. C\'est l\'iGPU 780M — pas un NPU — qui fait le gros du travail pour l\'inférence LLM locale. Des benchmarks communautaires indépendants d\'un modèle 7B quantifié (Q4_K_M) via [llama.cpp avec offload GPU Vulkan](https://github.com/ggml-org/llama.cpp/discussions/10879) sur la Radeon 780M rapportent environ 8 à 18 tokens/seconde selon le modèle précis et la longueur de contexte — une référence utile, mais pas une mesure PromptQuorum sur cette machine exacte.',
            pros: [
              ...
              'Un port 2,5GbE pour une connexion filaire fiable',
            ],
            cons: [
      ...
      aiCapabilities: {
        id: 'ai-capabilities',
        title: 'Adéquation en un coup d\'œil',
        content:
          '**Les évaluations ci-dessous reflètent l\'adéquation attendue selon les spécifications publiées et la classe de composants de chaque machine, pas des benchmarks mesurés indépendamment par PromptQuorum sur ces machines précises — considérez-les comme un point de départ pour dimensionner votre installation, pas une garantie.** ★★★★★ = excellente adéquation, ★★☆☆☆ = utilisable mais limité.',
        columns: ['Mini-PC', 'Home Assistant', 'IA locale (7B+)', 'Frigate (caméras)', 'Bruit', 'Niveau de prix'],
        rows: [
          { 'Mini-PC': 'Beelink SER8', 'Home Assistant': '★★★★★', 'IA locale (7B+)': '★★★★☆', 'Frigate (caméras)': '★★★★☆', 'Bruit': 'Faible (petit ventilateur)', 'Niveau de prix': '$$$' },
          { 'Mini-PC': 'Beelink EQ14', 'Home Assistant': '★★★★★', 'IA locale (7B+)': '★★☆☆☆', 'Frigate (caméras)': '★★★☆☆', 'Bruit': 'Quasi silencieux', 'Niveau de prix': '$' },
          { 'Mini-PC': 'GMKtec G3 Plus', 'Home Assistant': '★★★★★', 'IA locale (7B+)': '★★☆☆☆', 'Frigate (caméras)': '★★★☆☆', 'Bruit': 'Quasi silencieux', 'Niveau de prix': '$' },
          { 'Mini-PC': 'Minisforum UM890 Pro', 'Home Assistant': '★★★★★', 'IA locale (7B+)': '★★★★☆', 'Frigate (caméras)': '★★★★☆', 'Bruit': 'Faible à modéré (plus élevé en charge)', 'Niveau de prix': '$$$' },
          { 'Mini-PC': 'GEEKOM A9 Max', 'Home Assistant': '★★★★★', 'IA locale (7B+)': '★★★★★', 'Frigate (caméras)': '★★★★★', 'Bruit': 'Faible à modéré', 'Niveau de prix': '$$$$' },
        ],
        note: 'Guide du nombre de caméras pour Frigate (issu de la documentation de planification propre à Frigate, pas de tests PromptQuorum) : la détection uniquement par CPU peine dès une ou deux caméras, quelle que soit la machine — la documentation de Frigate recommande une détection accélérée matériellement (via l\'iGPU, un accélérateur Coral USB, ou un NPU compatible OpenVINO) dès que vous dépassez un usage léger et occasionnel. Comme repère approximatif : les machines de classe N150 sont à l\'aise avec une poignée de caméras (2–4) en détection assistée par GPU/Coral ; les machines de classe Ryzen 780M/890M avec détection accélérée par GPU peuvent raisonnablement gérer un nombre moyen de caméras (environ 6–10) avant qu\'il ne faille prévoir du matériel NVR dédié. Confirmez avec le guide de planification de Frigate pour votre nombre de caméras, résolution et fréquence d\'images précis.',
      },
      decisionFilters: {
        id: 'best-for',
        title: 'Idéal pour…',
      ...
      setupNotes: {
        ...
        note: 'Pile logicielle recommandée : pour une machine à usage unique, installer directement Home Assistant OS (HAOS) est le chemin le plus simple — il gère ses propres mises à jour et modules complémentaires avec le moins de friction possible. Si vous voulez faire tourner Frigate, Ollama et Home Assistant comme des services séparés et mis à jour indépendamment sur une même machine — ou prévoyez d\'ajouter d\'autres applications auto-hébergées plus tard —, une couche Proxmox (ou un hyperviseur similaire) avec HAOS dans sa propre VM et Frigate/Ollama en conteneurs offre plus de flexibilité au prix d\'un temps de configuration supplémentaire. Pour Ollama spécifiquement : téléchargez un modèle quantifié (Q4_K_M est un choix par défaut raisonnable pour les machines à RAM limitée), et vérifiez que l\'offload GPU est actif — sur les iGPU AMD, cela signifie généralement que le backend Vulkan ou ROCm est utilisé plutôt qu\'un repli vers l\'inférence CPU seule, nettement plus lente.',
      },
      faqSection: {
        id: 'faq',
  ...
  ja: {
    ...
    toc: [
      ...
      { label: '適性の早見表', anchor: 'ai-capabilities' },
    ...
    sections: {
        ...
        rankedItems: [
          {
            ...
            verdict:
              'Ryzen 7 8845HS と Radeon 780M の iGPU を搭載し、Home Assistant、Frigate、Ollama の 7B クラスモデルを一緒に動かす上で、このガイドで最も強力な一台構成になると見込まれます。ローカル LLM 推論の主な処理を担うのは 780M iGPU であり、NPU ではありません。独立したコミュニティによるベンチマークでは、Radeon 780M 上で量子化された7Bモデル（Q4_K_M）を[VulkanのGPUオフロードを使ったllama.cpp](https://github.com/ggml-org/llama.cpp/discussions/10879)で実行した場合、モデルやコンテキスト長にもよりますが毎秒約8〜18トークンという結果が報告されています——参考にはなりますが、この機種そのものでPromptQuorumが測定した値ではありません。',
            pros: [
              '7B クラスのモデルに向いた強力な内蔵GPU',
              '32 GB RAM構成でハブとアドオンの余裕を確保',
              'Home Assistant、Frigate、Whisper を一台でこなせる',
              'この性能クラスとしては待機時消費電力が控えめ（比較表を参照）',
              '信頼性の高い有線接続用に2.5GbEポートを1基搭載',
            ],
            cons: [
              'N150 機より高価',
      ...
      comparison: {
        ...
        columns: ['機種', 'CPU', 'GPU/iGPU', 'RAM（テスト構成／最大）', 'イーサネット', 'ストレージ', 'おおよその価格（2026年8月）', '待機時／通常時消費電力', 'こんな人に最適'],
        rows: [
          { '機種': 'Beelink EQ14', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD（内蔵）', 'RAM（テスト構成／最大）': '16 GB／最大16 GB（SO-DIMM 1基）', 'イーサネット': '1GbE×2', 'ストレージ': 'M.2 NVMe SSD×1', 'おおよその価格（2026年8月）': '約¥28,000〜33,000', '待機時／通常時消費電力': '待機時約5〜12W、負荷時約15〜25W', 'こんな人に最適': 'HA + 小型モデル' },
          { '機種': 'GMKtec G3 Plus', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD（内蔵）', 'RAM（テスト構成／最大）': '16 GB／公式16 GB、32 GBまで報告例あり（SO-DIMM 1基）', 'イーサネット': '2.5GbE×1', 'ストレージ': 'M.2×2（2280 NVMe最大4TB＋2242 SATA最大2TB）', 'おおよその価格（2026年8月）': '約¥28,000〜35,000', '待機時／通常時消費電力': '待機時約5〜12W、負荷時約15〜25W', 'こんな人に最適': 'HA + 小型モデル、予算の柔軟性' },
          { '機種': 'Beelink SER8', 'CPU': 'Ryzen 7 8845HS', 'GPU/iGPU': 'Radeon 780M', 'RAM（テスト構成／最大）': '32 GB／最大256 GB（DDR5 SO-DIMM×2）', 'イーサネット': '2.5GbE×1', 'ストレージ': 'M.2 PCIe 4.0×2（合計最大8TB）', 'おおよその価格（2026年8月）': '約¥94,800', '待機時／通常時消費電力': '待機時約7〜10W、持続的AI負荷時約45W以上', 'こんな人に最適': 'HA + Frigate + 7B モデル' },
          { '機種': 'Minisforum UM890 Pro', 'CPU': 'Ryzen 9 8945HS', 'GPU/iGPU': 'SER8 と同クラス', 'RAM（テスト構成／最大）': '32 GB／最大96 GB（DDR5 SO-DIMM×2）', 'イーサネット': '2.5GbE×2', 'ストレージ': 'M.2 NVMe×2＋外部拡張用OCuLink', 'おおよその価格（2026年8月）': '約¥97,000（32GB）／約¥66,000（ベアボーン）', '待機時／通常時消費電力': '待機時約7〜9W、持続負荷時約54〜90W', 'こんな人に最適': 'SER8に類似、より構成の自由度が高い' },
          { '機種': 'GEEKOM A9 Max', 'CPU': 'Ryzen AI 9 HX 370', 'GPU/iGPU': 'Radeon 890M + NPU', 'RAM（テスト構成／最大）': '32 GB／最大128 GB（DDR5 SO-DIMM×2）', 'イーサネット': '2.5GbE×2', 'ストレージ': 'M.2 NVMe SSD×2', 'おおよその価格（2026年8月）': '約¥165,000〜195,000', '待機時／通常時消費電力': '待機時約7〜9W、通常使用時約20〜34W', 'こんな人に最適': '最強のオンデバイスAI + 映像処理' },
        ],
        items: [
      ...
      aiCapabilities: {
        ...
        columns: ['ミニPC', 'Home Assistant', 'ローカルAI（7B+）', 'Frigate（カメラ）', '静音性', '価格帯'],
        rows: [
          { 'ミニPC': 'Beelink SER8', 'Home Assistant': '★★★★★', 'ローカルAI（7B+）': '★★★★☆', 'Frigate（カメラ）': '★★★★☆', '静音性': '静か（小型ファン）', '価格帯': '$$$' },
          { 'ミニPC': 'Beelink EQ14', 'Home Assistant': '★★★★★', 'ローカルAI（7B+）': '★★☆☆☆', 'Frigate（カメラ）': '★★★☆☆', '静音性': 'ほぼ無音', '価格帯': '$' },
          { 'ミニPC': 'GMKtec G3 Plus', 'Home Assistant': '★★★★★', 'ローカルAI（7B+）': '★★☆☆☆', 'Frigate（カメラ）': '★★★☆☆', '静音性': 'ほぼ無音', '価格帯': '$' },
          { 'ミニPC': 'Minisforum UM890 Pro', 'Home Assistant': '★★★★★', 'ローカルAI（7B+）': '★★★★☆', 'Frigate（カメラ）': '★★★★☆', '静音性': '静か〜中程度（負荷時は上昇）', '価格帯': '$$$' },
          { 'ミニPC': 'GEEKOM A9 Max', 'Home Assistant': '★★★★★', 'ローカルAI（7B+）': '★★★★★', 'Frigate（カメラ）': '★★★★★', '静音性': '静か〜中程度', '価格帯': '$$$$' },
        ],
        note: 'Frigateのカメラ台数の目安（Frigate自身の計画ドキュメントに基づくもので、PromptQuorumのテストではありません）：CPUのみによる検知は機種を問わず1〜2台のカメラを超えると苦しくなります——Frigateのドキュメントでは、軽度・非頻繁な用途を超える場合、ハードウェアアクセラレーテッド検知（iGPU、Coral USBアクセラレータ、またはOpenVINO対応NPU経由）を推奨しています。大まかな目安として：N150クラスの機種はGPU/Coral支援検知でカメラ数台（2〜4台）まで無理なく対応でき、GPUアクセラレーテッド検知を使うRyzen 780M/890Mクラスの機種は、専用NVRハードウェアを検討すべき段階に至る前に、中規模のカメラ台数（おおよそ6〜10台）を妥当に処理できます。実際のカメラ台数、解像度、フレームレートについてはFrigateの計画ガイドで確認してください。',
      },
      decisionFilters: {
        id: 'best-for',
        title: 'こんな人に最適…',
      ...
      setupNotes: {
        ...
        note: '推奨ソフトウェアスタック：単一用途の機器であれば、Home Assistant OS（HAOS）を直接インストールするのが最もシンプルな方法です——独自のアップデートとアドオンを最小限の手間で管理できます。Frigate、Ollama、Home Assistantを一台の機器上で個別に更新可能なサービスとして運用したい場合や、後から他のセルフホスト型アプリを追加する予定がある場合は、HAOSを専用VMに、Frigate/OllamaをコンテナにまとめたProxmox（または類似のハイパーバイザー）層を用いると、設定に手間はかかりますがより柔軟になります。Ollamaに関して具体的には：量子化されたモデルをダウンロードし（RAMが限られた機器にはQ4_K_Mが妥当な既定値です）、GPUオフロードが有効になっているか確認してください——AMDのiGPUでは通常、VulkanまたはROCmバックエンドが使用されているかを意味し、そうでない場合ははるかに遅いCPUのみの推論にフォールバックしてしまいます。',
      },
      faqSection: {
        id: 'faq',
        title: 'よくある質問',
  ...
  pt: {
    ...
    toc: [
      ...
      { label: 'Idoneidade num Piscar de Olhos', anchor: 'ai-capabilities' },
      { label: 'Ideal para…', anchor: 'best-for' },
    ...
    sections: {
        ...
        rankedItems: [
          {
            ...
            verdict:
              'Com um Ryzen 7 8845HS e uma iGPU Radeon 780M, espera-se que esta seja a opção de uma só máquina mais forte deste guia para rodar o Home Assistant, o Frigate e um modelo de classe 7B no Ollama juntos. A iGPU 780M — não uma NPU — faz o trabalho pesado da inferência de LLM local. Em benchmarks publicados pela comunidade do llama.cpp com Vulkan, a 780M atinge cerca de 8–18 tokens/s em modelos de 7B quantizados em Q4_K_M ([discussão no GitHub](https://github.com/ggml-org/llama.cpp/discussions/10879)) — um valor útil como referência de faixa, não um número medido pela PromptQuorum.',
            pros: [
              ...
              'Uma porta 2,5GbE para uma conexão cabeada confiável',
            ],
            cons: [
      ...
      comparison: {
        ...
        rows: [
          { 'Modelo': 'Beelink EQ14', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD (integrada)', 'RAM (testada / máx.)': '16 GB / máx. 16 GB (1x SO-DIMM)', 'Ethernet': '2x 1GbE', 'Armazenamento': '1x SSD M.2 NVMe', 'Preço aprox. (ago. 2026)': '~R$ 1.400–1.900', 'Consumo em repouso/típico': '~5–12W em repouso, ~15–25W sob carga', 'Ideal para': 'HA + um modelo pequeno' },
      ...
      aiCapabilities: {
        id: 'ai-capabilities',
        title: 'Idoneidade num Piscar de Olhos',
        content:
          '**As avaliações abaixo são a idoneidade esperada com base nas especificações publicadas e na classe de componentes de cada máquina — não são benchmarks medidos de forma independente pela PromptQuorum nestas unidades. Use como ponto de partida para dimensionar sua instalação, não como garantia.** ★★★★★ = excelente idoneidade, ★★☆☆☆ = utilizável mas limitado.',
        columns: ['Mini PC', 'Home Assistant', 'IA local (7B+)', 'Frigate (câmeras)', 'Ruído', 'Faixa de preço'],
        rows: [
          { 'Mini PC': 'Beelink SER8', 'Home Assistant': '★★★★★', 'IA local (7B+)': '★★★★☆', 'Frigate (câmeras)': '★★★★☆', 'Ruído': 'Silencioso (ventoinha pequena)', 'Faixa de preço': '$$$' },
          { 'Mini PC': 'Beelink EQ14', 'Home Assistant': '★★★★★', 'IA local (7B+)': '★★☆☆☆', 'Frigate (câmeras)': '★★★☆☆', 'Ruído': 'Quase inaudível', 'Faixa de preço': '$' },
          { 'Mini PC': 'GMKtec G3 Plus', 'Home Assistant': '★★★★★', 'IA local (7B+)': '★★☆☆☆', 'Frigate (câmeras)': '★★★☆☆', 'Ruído': 'Quase inaudível', 'Faixa de preço': '$' },
          { 'Mini PC': 'Minisforum UM890 Pro', 'Home Assistant': '★★★★★', 'IA local (7B+)': '★★★★☆', 'Frigate (câmeras)': '★★★★☆', 'Ruído': 'Silencioso a moderado (sobe sob carga)', 'Faixa de preço': '$$$' },
          { 'Mini PC': 'GEEKOM A9 Max', 'Home Assistant': '★★★★★', 'IA local (7B+)': '★★★★★', 'Frigate (câmeras)': '★★★★★', 'Ruído': 'Silencioso a moderado', 'Faixa de preço': '$$$$' },
        ],
        note: 'Orientação sobre quantidade de câmeras no Frigate (baseada na própria documentação de planejamento do Frigate, não em testes da PromptQuorum): a detecção somente por CPU fica sobrecarregada além de 1–2 câmeras em qualquer uma dessas máquinas — a documentação do Frigate recomenda detecção acelerada por hardware (via iGPU, acelerador USB Coral ou NPU compatível com OpenVINO) além de um uso leve e pouco frequente. Como regra geral: máquinas classe N150 com detecção assistida por GPU/Coral lidam razoavelmente bem com um punhado de câmeras (2–4); máquinas classe Ryzen 780M/890M com detecção acelerada por GPU conseguem lidar de forma razoável com uma contagem média de câmeras (aproximadamente 6–10) antes de valer a pena considerar hardware de NVR dedicado. Confira a contagem real de câmeras, resolução e taxa de quadros no guia de planejamento do Frigate.',
      },
      decisionFilters: {
        id: 'best-for',
        title: 'Ideal para…',
      ...
      setupNotes: {
        ...
        note: 'Stack de software recomendado: para uma máquina de propósito único, instalar o Home Assistant OS (HAOS) diretamente é a forma mais simples — você gerencia suas próprias atualizações e add-ons com o mínimo de complicação. Se você quer o Frigate, o Ollama e o Home Assistant como serviços separados e atualizáveis individualmente na mesma máquina, ou planeja adicionar outros apps auto-hospedados depois, uma camada Proxmox (ou hipervisor similar) com o HAOS numa VM dedicada e o Frigate/Ollama em contêineres dá mais flexibilidade em troca de mais complexidade na configuração. No caso específico do Ollama: baixe um modelo quantizado (Q4_K_M é um padrão razoável para máquinas com RAM limitada) e confirme que o offload para GPU está ativo — em iGPUs AMD isso geralmente significa verificar se o backend Vulkan ou ROCm está em uso, e não recair na inferência somente por CPU, que é muito mais lenta.',
      },
      faqSection: {
        id: 'faq',
  ...
  zh: {
    ...
    toc: [
      ...
      { label: '适用性一览', anchor: 'ai-capabilities' },
    ...
    sections: {
        ...
        rankedItems: [
          {
            ...
            verdict:
              '搭载 Ryzen 7 8845HS 和 Radeon 780M iGPU，预计是本指南中一台机器同时运行 Home Assistant、Frigate 和 Ollama 上 7B 级模型的最强选择。780M iGPU——而非 NPU——承担本地 LLM 推理的主要工作。根据 llama.cpp 社区在 Vulkan 后端下发布的基准测试，780M 运行 Q4_K_M 量化的 7B 模型时约为 8–18 tokens/s（[GitHub 讨论](https://github.com/ggml-org/llama.cpp/discussions/10879)）——可作为参考区间，并非 PromptQuorum 自行测得的数据。',
            pros: [
              '为 7B 级模型配备强力集成 GPU',
              '32 GB 内存配置为中枢和加载项留出余量',
              '可在一台机器上处理 Home Assistant、Frigate 和 Whisper',
              '相对这一性能级别，待机功耗适中（见比较表）',
              '配备一个 2.5GbE 网口，可提供稳定的有线连接',
            ],
            cons: [
              '比 N150 机型贵',
              'AI 负载下功耗高于低功耗机型',
      ...
      comparison: {
        ...
        columns: ['机型', 'CPU', 'GPU/iGPU', '内存（测试配置 / 最大）', '以太网', '存储', '大致价格（2026年8月）', '待机/典型功耗', '适合场景'],
        rows: [
          { '机型': 'Beelink EQ14', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD（集成）', '内存（测试配置 / 最大）': '16 GB / 最大 16 GB（1 根 SO-DIMM）', '以太网': '2x 1GbE', '存储': '1x M.2 NVMe SSD', '大致价格（2026年8月）': '约 $189–220', '待机/典型功耗': '待机约5–12W，负载约15–25W', '适合场景': 'HA + 一个小型模型' },
          { '机型': 'GMKtec G3 Plus', 'CPU': 'Intel N150', 'GPU/iGPU': 'Intel UHD（集成）', '内存（测试配置 / 最大）': '16 GB / 官方 16 GB，有用户报告可达 32 GB（1 根 SO-DIMM）', '以太网': '1x 2.5GbE', '存储': '2x M.2（2280 NVMe 最高 4TB + 2242 SATA 最高 2TB）', '大致价格（2026年8月）': '约 $180–230', '待机/典型功耗': '待机约5–12W，负载约15–25W', '适合场景': 'HA + 一个小型模型，预算灵活' },
          { '机型': 'Beelink SER8', 'CPU': 'Ryzen 7 8845HS', 'GPU/iGPU': 'Radeon 780M', '内存（测试配置 / 最大）': '32 GB / 最大 256 GB（2 根 DDR5 SO-DIMM）', '以太网': '1x 2.5GbE', '存储': '2x M.2 PCIe 4.0（合计最高 8TB）', '大致价格（2026年8月）': '约 $650', '待机/典型功耗': '待机约7–10W，持续 AI 负载约45W以上', '适合场景': 'HA + Frigate + 7B 模型' },
          { '机型': 'Minisforum UM890 Pro', 'CPU': 'Ryzen 9 8945HS', 'GPU/iGPU': '与 SER8 同级别', '内存（测试配置 / 最大）': '32 GB / 最大 96 GB（2 根 DDR5 SO-DIMM）', '以太网': '2x 2.5GbE', '存储': '2x M.2 NVMe + 外接扩展用 OCuLink', '大致价格（2026年8月）': '约 $649（32GB）/ 约 $439（裸机）', '待机/典型功耗': '待机约7–9W，持续负载约54–90W', '适合场景': '类似 SER8，配置更灵活' },
          { '机型': 'GEEKOM A9 Max', 'CPU': 'Ryzen AI 9 HX 370', 'GPU/iGPU': 'Radeon 890M + NPU', '内存（测试配置 / 最大）': '32 GB / 最大 128 GB（2 根 DDR5 SO-DIMM）', '以太网': '2x 2.5GbE', '存储': '2x M.2 NVMe SSD', '大致价格（2026年8月）': '约 $1,099–1,299', '待机/典型功耗': '待机约7–9W，典型使用约20–34W', '适合场景': '最强设备端 AI + 视觉处理' },
        ],
        items: [
      ...
      aiCapabilities: {
        ...
        columns: ['迷你 PC', 'Home Assistant', '本地 AI（7B+）', 'Frigate（摄像头）', '噪音', '价格档位'],
        rows: [
          { '迷你 PC': 'Beelink SER8', 'Home Assistant': '★★★★★', '本地 AI（7B+）': '★★★★☆', 'Frigate（摄像头）': '★★★★☆', '噪音': '安静（小风扇）', '价格档位': '$$$' },
          { '迷你 PC': 'Beelink EQ14', 'Home Assistant': '★★★★★', '本地 AI（7B+）': '★★☆☆☆', 'Frigate（摄像头）': '★★★☆☆', '噪音': '几乎无声', '价格档位': '$' },
          { '迷你 PC': 'GMKtec G3 Plus', 'Home Assistant': '★★★★★', '本地 AI（7B+）': '★★☆☆☆', 'Frigate（摄像头）': '★★★☆☆', '噪音': '几乎无声', '价格档位': '$' },
          { '迷你 PC': 'Minisforum UM890 Pro', 'Home Assistant': '★★★★★', '本地 AI（7B+）': '★★★★☆', 'Frigate（摄像头）': '★★★★☆', '噪音': '安静到中等（负载下升高）', '价格档位': '$$$' },
          { '迷你 PC': 'GEEKOM A9 Max', 'Home Assistant': '★★★★★', '本地 AI（7B+）': '★★★★★', 'Frigate（摄像头）': '★★★★★', '噪音': '安静到中等', '价格档位': '$$$$' },
        ],
        note: 'Frigate 摄像头数量参考（基于 Frigate 官方规划文档，并非 PromptQuorum 的测试）：在这些机型上，仅靠 CPU 检测在超过 1–2 路摄像头后就会吃力——Frigate 文档建议，超出轻度、低频使用场景后应采用硬件加速检测（通过 iGPU、Coral USB 加速器，或支持 OpenVINO 的 NPU）。一般经验：N150 级机型配合 GPU/Coral 辅助检测可合理应对少量摄像头（2–4 路）；使用 GPU 加速检测的 Ryzen 780M/890M 级机型在需要考虑专用 NVR 硬件之前，可合理处理中等数量的摄像头（大约 6–10 路）。实际可支持的摄像头数量、分辨率和帧率请参考 Frigate 的规划指南。',
      },
      decisionFilters: {
        id: 'best-for',
        title: '适合场景…',
      ...
      setupNotes: {
        ...
        note: '推荐软件方案：如果只用于单一用途，直接安装 Home Assistant OS（HAOS）是最简单的方式——你只需以最少的麻烦管理自己的更新和插件。如果你希望 Frigate、Ollama 和 Home Assistant 在同一台机器上作为可独立更新的服务运行，或计划以后添加其他自托管应用，使用 Proxmox（或类似的虚拟化平台）——将 HAOS 放入专用虚拟机、Frigate/Ollama 放入容器——配置更复杂，但灵活性更高。关于 Ollama 的具体建议：下载一个量化模型（对于内存有限的机器，Q4_K_M 是合理的默认选择），并确认已启用 GPU 卸载——在 AMD iGPU 上，这通常意味着确认使用的是 Vulkan 或 ROCm 后端，而不是回退到慢得多的纯 CPU 推理。',
      },
      faqSection: {
        id: 'faq',
        title: '常见问题',
