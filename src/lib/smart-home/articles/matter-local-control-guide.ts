  ...
  en: {
    ...
    sections: {
      ...
      commissioning: {
        ...
        content:
          '**Commission Matter devices directly to your local controller so control stays on your network.** Matter\'s multi-admin feature lets a device join more than one fabric, and Matter 1.6\'s Joint Fabric (released June 2026) formalizes this by letting multiple user-authorized controllers co-administer the same shared network — see [Matter 1.6 Explained](/smart-home/matter-1-6-explained) for the full spec change.',
        numberedItems: [
          'Add the Matter integration in your local controller (e.g. Home Assistant).',
          'Scan the device\'s Matter QR/pairing code from the controller — or use NFC tap-to-pair if the device supports Matter 1.6\'s NFC-based commissioning.',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'What is Joint Fabric in Matter?', a: 'Joint Fabric, added in Matter 1.6 (June 2026), lets multiple user-authorized controllers formally co-administer the same shared Matter network — for example, a local controller like Home Assistant and a manufacturer app can both manage a device without one taking over the other\'s fabric. It builds on Matter\'s existing multi-admin capability rather than replacing it.' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
        ...
        items: [
          ...
          '[Matter 1.6 Explained: What\'s New (2026)](/smart-home/matter-1-6-explained) — what changed in the latest Matter version',
        ],
      },
    },
    schema: {
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'What is Joint Fabric in Matter?', acceptedAnswer: { '@type': 'Answer', text: 'Joint Fabric, added in Matter 1.6 (June 2026), lets multiple user-authorized controllers co-administer the same shared network, building on Matter\'s existing multi-admin capability.' } },
      ],
    },
  },
  ...
  ar: {
    ...
    sections: {
      ...
      commissioning: {
        ...
        content:
          '**وصِّل أجهزة Matter مباشرةً بمتحكمك المحلي حتى يبقى التحكم على شبكتك.** ميزة الإدارة المتعددة في Matter تتيح لجهاز الانضمام إلى أكثر من نسيج واحد، وتُضفي ميزة Joint Fabric في Matter 1.6 (الصادرة في يونيو 2026) طابعًا رسميًا على ذلك بالسماح لعدة متحكمات مخوَّلة بإدارة الشبكة المشتركة نفسها معًا — راجع [شرح Matter 1.6](/ar/smart-home/matter-1-6-explained) للاطلاع على التغيير الكامل في المواصفة.',
        numberedItems: [
          'أضف تكامل Matter في متحكمك المحلي (مثل Home Assistant).',
          'امسح رمز QR/الإقران الخاص بـ Matter للجهاز من المتحكم — أو استخدم الإقران بالمس عبر NFC إذا كان الجهاز يدعم التوصيل القائم على NFC في Matter 1.6.',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'ما هي ميزة Joint Fabric في Matter؟', a: 'ميزة Joint Fabric، المُضافة في Matter 1.6 (يونيو 2026)، تتيح لعدة متحكمات مخوَّلة من قِبل المستخدم إدارة الشبكة المشتركة نفسها بشكل رسمي معًا — على سبيل المثال، يمكن لمتحكم محلي مثل Home Assistant وتطبيق المورِّد أن يديرا الجهاز معًا دون أن يستحوذ أحدهما على نسيج الآخر. تُبنى هذه الميزة على قدرة الإدارة المتعددة الحالية في Matter بدلاً من استبدالها.' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
        ...
        items: [
          ...
          '[شرح Matter 1.6: ما الجديد (2026)](/ar/smart-home/matter-1-6-explained) — ما الذي تغير في أحدث إصدار من Matter',
        ],
      },
    },
    schema: {
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'ما هي ميزة Joint Fabric في Matter؟', acceptedAnswer: { '@type': 'Answer', text: 'ميزة Joint Fabric، المُضافة في Matter 1.6 (يونيو 2026)، تتيح لعدة متحكمات مخوَّلة إدارة الشبكة المشتركة نفسها معًا، مبنيةً على قدرة الإدارة المتعددة الحالية في Matter.' } },
      ],
    },
  },
  ...
  de: {
    ...
    sections: {
      ...
      commissioning: {
        ...
        content:
          '**Binden Sie Matter-Geräte direkt in Ihren lokalen Controller ein, damit die Steuerung in Ihrem Netzwerk bleibt.** Matters Multi-Admin-Funktion lässt ein Gerät mehr als einem Fabric beitreten, und Joint Fabric aus Matter 1.6 (veröffentlicht im Juni 2026) formalisiert dies: Mehrere vom Nutzer autorisierte Controller können dasselbe gemeinsame Netzwerk gemeinsam verwalten – siehe [Matter 1.6 erklärt](/de/smart-home/matter-1-6-explained) für die vollständige Spezifikationsänderung.',
        numberedItems: [
          'Fügen Sie die Matter-Integration in Ihrem lokalen Controller hinzu (z. B. Home Assistant).',
          'Scannen Sie den Matter-QR-/Kopplungscode des Geräts vom Controller aus – oder nutzen Sie NFC-Tap-to-Pair, falls das Gerät die NFC-basierte Einbindung von Matter 1.6 unterstützt.',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'Was ist Joint Fabric bei Matter?', a: 'Joint Fabric, eingeführt mit Matter 1.6 (Juni 2026), lässt mehrere vom Nutzer autorisierte Controller dasselbe gemeinsame Matter-Netzwerk formal gemeinsam verwalten – zum Beispiel können ein lokaler Controller wie Home Assistant und eine Hersteller-App ein Gerät gemeinsam steuern, ohne dass einer das Fabric des anderen übernimmt. Es baut auf Matters bestehender Multi-Admin-Fähigkeit auf, statt sie zu ersetzen.' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
        ...
        items: [
          ...
          '[Matter 1.6 erklärt: Was ist neu (2026)](/de/smart-home/matter-1-6-explained) – was sich in der neuesten Matter-Version geändert hat',
        ],
      },
    },
    schema: {
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Was ist Joint Fabric bei Matter?', acceptedAnswer: { '@type': 'Answer', text: 'Joint Fabric, eingeführt mit Matter 1.6 (Juni 2026), lässt mehrere vom Nutzer autorisierte Controller dasselbe gemeinsame Netzwerk gemeinsam verwalten – aufbauend auf Matters bestehender Multi-Admin-Fähigkeit.' } },
      ],
    },
  },
  ...
  es: {
    ...
    sections: {
      ...
      commissioning: {
        ...
        content:
          '**Vincula los dispositivos Matter directamente a tu controlador local para que el control se quede en tu red.** La función multi-admin de Matter permite que un dispositivo se una a más de un fabric, y Joint Fabric de Matter 1.6 (publicado en junio de 2026) formaliza esto al permitir que varios controladores autorizados por el usuario administren juntos la misma red compartida — consulta [Matter 1.6 explicado](/es/smart-home/matter-1-6-explained) para conocer el cambio completo de la especificación.',
        numberedItems: [
          'Añade la integración Matter en tu controlador local (p. ej. Home Assistant).',
          'Escanea el código QR/de emparejamiento Matter del dispositivo desde el controlador — o usa el emparejamiento por NFC si el dispositivo admite la vinculación NFC de Matter 1.6.',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: '¿Qué es Joint Fabric en Matter?', a: 'Joint Fabric, añadido en Matter 1.6 (junio de 2026), permite que varios controladores autorizados por el usuario administren formalmente la misma red Matter compartida — por ejemplo, un controlador local como Home Assistant y una app del fabricante pueden gestionar juntos un dispositivo sin que uno se apodere del fabric del otro. Se apoya en la función multi-admin existente de Matter en lugar de reemplazarla.' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
        ...
        items: [
          ...
          '[Matter 1.6 explicado: qué hay de nuevo (2026)](/es/smart-home/matter-1-6-explained) — qué cambió en la última versión de Matter',
        ],
      },
    },
    schema: {
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: '¿Qué es Joint Fabric en Matter?', acceptedAnswer: { '@type': 'Answer', text: 'Joint Fabric, añadido en Matter 1.6 (junio de 2026), permite que varios controladores autorizados administren juntos la misma red compartida, apoyándose en la función multi-admin existente de Matter.' } },
      ],
    },
  },
  ...
  ko: {
    ...
    sections: {
      ...
      commissioning: {
        ...
        title: '로컬 전용 커미셔닝',
        content:
          '**제어가 네트워크 내에 유지되도록 Matter 기기를 로컬 컨트롤러에 직접 커미셔닝하십시오.** Matter의 멀티-어드민 기능을 통해 기기가 여러 패브릭에 참여할 수 있습니다. Matter 1.6(2026년 6월 출시)의 Joint Fabric은 이를 공식화하여, 사용자가 승인한 여러 컨트롤러가 동일한 공유 네트워크를 함께 관리할 수 있게 합니다. 사양 변경의 전체 내용은 [Matter 1.6 해설](/ko/smart-home/matter-1-6-explained)을 참조하십시오.',
        numberedItems: [
          '로컬 컨트롤러(예: Home Assistant)에 Matter 통합을 추가하십시오.',
          '컨트롤러에서 기기의 Matter QR/페어링 코드를 스캔하십시오. 기기가 Matter 1.6의 NFC 기반 커미셔닝을 지원하면 NFC 탭 페어링도 사용할 수 있습니다.',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'Matter의 Joint Fabric이란 무엇입니까?', a: 'Joint Fabric은 Matter 1.6(2026년 6월 출시)에서 추가된 기능으로, 사용자가 승인한 여러 컨트롤러가 동일한 공유 Matter 네트워크를 공식적으로 함께 관리할 수 있게 합니다. 예를 들어 Home Assistant 같은 로컬 컨트롤러와 제조사 앱이 서로의 패브릭을 빼앗지 않고 기기를 함께 관리할 수 있습니다. 기존 멀티-어드민 기능을 대체하는 것이 아니라 그 위에 구축된 기능입니다.' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
        ...
        items: [
          ...
          '[Matter 1.6 해설: 무엇이 새로운가 (2026년)](/ko/smart-home/matter-1-6-explained) — 최신 Matter 버전에서 달라진 점',
        ],
      },
    },
    schema: {
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Matter의 Joint Fabric이란 무엇입니까?', acceptedAnswer: { '@type': 'Answer', text: 'Joint Fabric은 Matter 1.6(2026년 6월 출시)의 기능으로, 사용자가 승인한 여러 컨트롤러가 동일한 공유 네트워크를 함께 관리할 수 있게 합니다. 기존 멀티-어드민 기능 위에 구축되었습니다.' } },
      ],
    },
  },
  ...
  fr: {
    ...
    sections: {
      ...
      commissioning: {
        ...
        content:
          '**Appairez les appareils Matter directement à votre contrôleur local pour que le contrôle reste sur votre réseau.** La fonction multi-admin de Matter permet à un appareil de rejoindre plus d\'un fabric, et Joint Fabric, introduit avec Matter 1.6 (juin 2026), formalise cela en permettant à plusieurs contrôleurs autorisés par l\'utilisateur de co-administrer le même réseau partagé — voir [Matter 1.6 expliqué](/fr/smart-home/matter-1-6-explained) pour le détail de cette évolution de la spécification.',
        numberedItems: [
          'Ajoutez l\'intégration Matter dans votre contrôleur local (ex. Home Assistant).',
          'Scannez le code QR/d\'appairage Matter de l\'appareil depuis le contrôleur — ou utilisez l\'appairage NFC si l\'appareil prend en charge la mise en service NFC de Matter 1.6.',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'Qu\'est-ce que Joint Fabric dans Matter ?', a: 'Joint Fabric, ajouté avec Matter 1.6 (juin 2026), permet à plusieurs contrôleurs autorisés par l\'utilisateur de co-administrer formellement le même réseau Matter partagé — par exemple, un contrôleur local comme Home Assistant et une app du fabricant peuvent gérer un appareil ensemble sans que l\'un prenne le pas sur le fabric de l\'autre. Cette fonction s\'appuie sur la capacité multi-admin existante de Matter plutôt que de la remplacer.' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
        ...
        items: [
          ...
          '[Matter 1.6 expliqué : les nouveautés (2026)](/fr/smart-home/matter-1-6-explained) — les nouveautés de la dernière version de Matter',
        ],
      },
    },
    schema: {
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Qu\'est-ce que Joint Fabric dans Matter ?', acceptedAnswer: { '@type': 'Answer', text: 'Joint Fabric, ajouté avec Matter 1.6 (juin 2026), permet à plusieurs contrôleurs autorisés de co-administrer le même réseau partagé, en s\'appuyant sur la capacité multi-admin existante de Matter.' } },
      ],
    },
  },
  ...
  ja: {
    ...
    sections: {
      ...
      commissioning: {
        ...
        content:
          '**制御がネットワーク上にとどまるよう、Matter 機器を直接ローカルコントローラーにコミッショニングしましょう。** Matter のマルチアドミン機能は、機器が複数のファブリックに参加することを可能にします。さらに Matter 1.6（2026年6月リリース）の Joint Fabric は、複数のユーザー承認済みコントローラーが同じ共有ネットワークを正式に共同管理できるようにする機能です——仕様変更の詳細は[Matter 1.6 解説](/ja/smart-home/matter-1-6-explained)を参照してください。',
        numberedItems: [
          'ローカルコントローラー（例：Home Assistant）に Matter 統合を追加します。',
          'コントローラーから機器の Matter QR／ペアリングコードをスキャンします——機器が Matter 1.6 の NFC ベースのコミッショニングに対応していれば、NFC タップでのペアリングも使えます。',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'Matter の Joint Fabric とは何ですか？', a: 'Joint Fabric は Matter 1.6（2026年6月リリース）で追加された機能で、複数のユーザー承認済みコントローラーが同じ共有 Matter ネットワークを正式に共同管理できるようにします。例えば、Home Assistant のようなローカルコントローラーとメーカーのアプリが、互いのファブリックを奪い合うことなく同じ機器を管理できます。既存のマルチアドミン機能を置き換えるのではなく、その上に構築されています。' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
        ...
        items: [
          ...
          '[Matter 1.6を解説：新機能とは（2026年）](/ja/smart-home/matter-1-6-explained) — 最新のMatterバージョンで変わったこと',
        ],
      },
    },
    schema: {
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Matter の Joint Fabric とは何ですか？', acceptedAnswer: { '@type': 'Answer', text: 'Joint Fabric は Matter 1.6（2026年6月リリース）の機能で、複数のユーザー承認済みコントローラーが同じ共有ネットワークを共同管理できるようにします。既存のマルチアドミン機能の上に構築されています。' } },
      ],
    },
  },
  ...
  pt: {
    ...
    sections: {
      ...
      commissioning: {
        ...
        content:
          '**Emparelhe os dispositivos Matter diretamente ao seu controlador local para que o controle fique na sua rede.** O recurso multi-admin do Matter permite que um dispositivo entre em mais de um fabric, e o Joint Fabric do Matter 1.6 (lançado em junho de 2026) formaliza isso, permitindo que vários controladores autorizados pelo usuário administrem juntos a mesma rede compartilhada — veja [Matter 1.6 explicado](/pt/smart-home/matter-1-6-explained) para a mudança completa na especificação.',
        numberedItems: [
          'Adicione a integração Matter no seu controlador local (ex.: Home Assistant).',
          'Escaneie o código QR/de emparelhamento Matter do dispositivo a partir do controlador — ou use o emparelhamento por NFC se o dispositivo suportar a comissão via NFC do Matter 1.6.',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'O que é o Joint Fabric no Matter?', a: 'O Joint Fabric, adicionado no Matter 1.6 (junho de 2026), permite que vários controladores autorizados pelo usuário administrem formalmente a mesma rede Matter compartilhada — por exemplo, um controlador local como o Home Assistant e um app do fabricante podem gerenciar um dispositivo juntos sem que um tome o fabric do outro. Ele se baseia no recurso multi-admin já existente do Matter, em vez de substituí-lo.' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
        ...
        items: [
          ...
          '[Matter 1.6 explicado: o que há de novo (2026)](/pt/smart-home/matter-1-6-explained) — o que mudou na versão mais recente do Matter',
        ],
      },
    },
    schema: {
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'O que é o Joint Fabric no Matter?', acceptedAnswer: { '@type': 'Answer', text: 'O Joint Fabric, adicionado no Matter 1.6 (junho de 2026), permite que vários controladores autorizados administrem juntos a mesma rede compartilhada, com base no recurso multi-admin já existente do Matter.' } },
      ],
    },
  },
  ...
  zh: {
    ...
    sections: {
      ...
      commissioning: {
        ...
        title: '仅本地配网',
        content:
          '**把 Matter 设备直接配网到你的本地控制器，让控制保留在你的网络上。** Matter 的多管理员特性允许一台设备加入多个 fabric，Matter 1.6（2026年6月发布）的 Joint Fabric 将其正式化，允许多个经用户授权的控制器共同管理同一个共享网络——完整的规范变化参见[Matter 1.6 详解](/zh/smart-home/matter-1-6-explained)。',
        numberedItems: [
          '在你的本地控制器（如 Home Assistant）中添加 Matter 集成。',
          '从控制器扫描设备的 Matter 二维码/配对码——如果设备支持 Matter 1.6 的 NFC 配网，也可以使用 NFC 碰一碰配对。',
          '把它配网到你网络上的本地 fabric。',
          '在关闭厂商应用的情况下验证控制是否正常。',
        ],
      },
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'Matter 中的 Joint Fabric 是什么？', a: 'Joint Fabric 是 Matter 1.6（2026年6月发布）新增的功能，允许多个经用户授权的控制器正式共同管理同一个共享 Matter 网络——例如，像 Home Assistant 这样的本地控制器和厂商应用可以共同管理一台设备，而不会互相抢占对方的 fabric。它建立在 Matter 现有的多管理员能力之上，而不是取代它。' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
        ...
        items: [
          ...
          '[Matter 1.6 详解：有哪些新功能（2026年）](/zh/smart-home/matter-1-6-explained) — 最新Matter版本的变化',
        ],
      },
    },
    schema: {
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Matter 中的 Joint Fabric 是什么？', acceptedAnswer: { '@type': 'Answer', text: 'Joint Fabric 是 Matter 1.6（2026年6月发布）的功能，允许多个经用户授权的控制器共同管理同一个共享网络，建立在 Matter 现有的多管理员能力之上。' } },
      ],
    },
  },
}
