    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Matter 1.6 Explained: What\'s New (2027)](/smart-home/matter-1-6-explained) — what changed in the latest Matter version',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[شرح Matter 1.6: ما الجديد (2027)](/ar/smart-home/matter-1-6-explained) — ما الذي تغير في أحدث إصدار من Matter',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Matter 1.6 erklärt: Was ist neu (2027)](/de/smart-home/matter-1-6-explained) – was sich in der neuesten Matter-Version geändert hat',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Matter 1.6 explicado: qué hay de nuevo (2027)](/es/smart-home/matter-1-6-explained) — qué cambió en la última versión de Matter',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Matter 1.6 해설: 무엇이 새로운가 (2027년)](/ko/smart-home/matter-1-6-explained) — 최신 Matter 버전에서 달라진 점',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Matter 1.6 expliqué : les nouveautés (2027)](/fr/smart-home/matter-1-6-explained) — les nouveautés de la dernière version de Matter',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Matter 1.6を解説：新機能とは（2027年）](/ja/smart-home/matter-1-6-explained) — 最新のMatterバージョンで変わったこと',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Matter 1.6 explicado: o que há de novo (2027)](/pt/smart-home/matter-1-6-explained) — o que mudou na versão mais recente do Matter',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Matter 1.6 详解：有哪些新功能（2027年）](/zh/smart-home/matter-1-6-explained) — 最新Matter版本的变化',
        ],
      },
    },
    schema: {
