    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[System Prompt vs User Prompt: What\'s the Difference](/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference) — craft the system prompt that defines which devices your LLM can control',
          '[Constrained Prompting](/prompt-engineering/constrained-prompting) — the technique behind reliability guardrails: limit what the LLM is allowed to do',
          '[Reducing LLM Hallucinations in Home Automation (2027)](/smart-home/reducing-llm-hallucinations-home-automation) — stop the model from inventing device states',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[الفرق بين System Prompt وUser Prompt](/ar/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference) — أعِدَّ الـ system prompt الذي يحدد الأجهزة التي يمكن للنموذج التحكم بها',
          '[الضغط المقيَّد](/ar/prompt-engineering/constrained-prompting) — الأسلوب وراء ضمانات الموثوقية: حدِّد ما يُسمح للنموذج بفعله',
          '[تقليل هلوسة نماذج اللغة الكبيرة في أتمتة المنزل (2027)](/ar/smart-home/reducing-llm-hallucinations-home-automation) — امنع النموذج من اختلاق حالات الأجهزة',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[System Prompt vs. User Prompt: der Unterschied](/de/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference) – gestalten Sie den System Prompt, der festlegt, welche Geräte Ihr LLM steuern darf',
          '[Constrained Prompting](/de/prompt-engineering/constrained-prompting) – die Technik hinter Zuverlässigkeits-Leitplanken: begrenzen Sie, was das LLM tun darf',
          '[LLM-Halluzinationen in der Hausautomation reduzieren (2027)](/de/smart-home/reducing-llm-hallucinations-home-automation) – verhindern, dass das Modell Gerätezustände erfindet',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[System Prompt vs User Prompt: la diferencia](/es/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference) — diseña el system prompt que define qué dispositivos puede controlar tu LLM',
          '[Constrained Prompting](/es/prompt-engineering/constrained-prompting) — la técnica detrás de las salvaguardas de fiabilidad: limita lo que el LLM puede hacer',
          '[Reducir las alucinaciones de LLM en la domótica (2027)](/es/smart-home/reducing-llm-hallucinations-home-automation) — evita que el modelo invente estados de dispositivos',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[시스템 프롬프트 vs 사용자 프롬프트: 차이점](/ko/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference) — LLM이 제어할 수 있는 기기를 정의하는 시스템 프롬프트 작성',
          '[제약 프롬프팅](/ko/prompt-engineering/constrained-prompting) — 신뢰성 가드레일의 기법: LLM이 할 수 있는 것을 제한',
          '[홈 자동화에서 LLM 환각 줄이기 (2027)](/ko/smart-home/reducing-llm-hallucinations-home-automation) — 모델이 기기 상태를 지어내지 않도록 방지',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[System Prompt vs User Prompt : la différence](/fr/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference) — rédigez le system prompt qui définit quels appareils votre LLM peut contrôler',
          '[Constrained Prompting](/fr/prompt-engineering/constrained-prompting) — la technique derrière les garde-fous de fiabilité : limitez ce que le LLM est autorisé à faire',
          '[Réduire les hallucinations LLM dans la domotique (2027)](/fr/smart-home/reducing-llm-hallucinations-home-automation) — empêchez le modèle d\'inventer des états d\'appareils',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[システムプロンプト vs ユーザープロンプト：その違い](/ja/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference) — LLMが制御できるデバイスを定義するシステムプロンプトを作成する',
          '[制約付きプロンプティング](/ja/prompt-engineering/constrained-prompting) — 信頼性ガードレールの背後にある技術：LLMに許可する操作を制限する',
          '[ホームオートメーションにおけるLLM幻覚の低減（2027年）](/ja/smart-home/reducing-llm-hallucinations-home-automation) — モデルがデバイスの状態を捏造しないようにする',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[System Prompt vs User Prompt: a diferença](/pt/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference) — elabore o system prompt que define quais dispositivos seu LLM pode controlar',
          '[Constrained Prompting](/pt/prompt-engineering/constrained-prompting) — a técnica por trás das salvaguardas de confiabilidade: limite o que o LLM tem permissão de fazer',
          '[Reduzindo alucinações de LLM na automação residencial (2027)](/pt/smart-home/reducing-llm-hallucinations-home-automation) — impeça o modelo de inventar estados de dispositivos',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[系统提示词 vs 用户提示词：了解其中区别](/zh/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference) — 编写定义LLM可控制哪些设备的系统提示词',
          '[约束性提示](/zh/prompt-engineering/constrained-prompting) — 可靠性护栏背后的技术：限制LLM被允许执行的操作',
          '[减少家庭自动化中的LLM幻觉（2027年）](/zh/smart-home/reducing-llm-hallucinations-home-automation) — 防止模型编造设备状态',
        ],
      },
    },
    schema: {
