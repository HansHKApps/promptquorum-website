...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'أتمتة المنزل بالذكاء الاصطناعي 2026: نموذج LLM محلي يتجاوز IFTTT',
    intro:
    ...
    metaDescription:
      'بناء أتمتة منزلية تدرك السياق باستخدام نموذج LLM محلي: قواعد بلغة طبيعية تتفوق على if-this-then-that. أمثلة وتعليمات وبنية تقنية وضمانات.',
    twitterDescription:
