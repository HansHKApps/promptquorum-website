    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Reducing LLM Hallucinations in Home Automation (2026)](/smart-home/reducing-llm-hallucinations-home-automation) — stop the model from inventing device states',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[تقليل هلوسة نماذج اللغة الكبيرة في أتمتة المنزل (2026)](/ar/smart-home/reducing-llm-hallucinations-home-automation) — امنع النموذج من اختلاق حالات الأجهزة',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[LLM-Halluzinationen in der Hausautomation reduzieren (2026)](/de/smart-home/reducing-llm-hallucinations-home-automation) – verhindern, dass das Modell Gerätezustände erfindet',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Reducir las alucinaciones de LLM en la domótica (2026)](/es/smart-home/reducing-llm-hallucinations-home-automation) — evita que el modelo invente estados de dispositivos',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[홈 자동화에서 LLM 환각 줄이기 (2026)](/ko/smart-home/reducing-llm-hallucinations-home-automation) — 모델이 기기 상태를 지어내지 않도록 방지',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Réduire les hallucinations LLM dans la domotique (2026)](/fr/smart-home/reducing-llm-hallucinations-home-automation) — empêchez le modèle d\'inventer des états d\'appareils',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[ホームオートメーションにおけるLLM幻覚の低減（2026年）](/ja/smart-home/reducing-llm-hallucinations-home-automation) — モデルがデバイスの状態を捏造しないようにする',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Reduzindo alucinações de LLM na automação residencial (2026)](/pt/smart-home/reducing-llm-hallucinations-home-automation) — impeça o modelo de inventar estados de dispositivos',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[减少家庭自动化中的LLM幻觉（2026年）](/zh/smart-home/reducing-llm-hallucinations-home-automation) — 防止模型编造设备状态',
        ],
      },
    },
    schema: {
