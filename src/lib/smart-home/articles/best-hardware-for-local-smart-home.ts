    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Local LLM step-up: a Ryzen mini PC (32GB RAM, ~$649) or a used RTX 3090 box (~$850–1,050 — prices have risen well above 2024–2025 levels)',
      ...
      quickPicks: {
        ...
        rows: [
          ...
          { 'Your goal': 'HA + a larger local LLM', 'Buy this': '[Used RTX 3090 server](#server)', 'Est. price (Aug 2026)': '~$850–1,050 (GPU only)' },
        ],
        tableFormat: true,
      ...
      server: {
        ...
        affiliateLinks: [
          { label: 'Check RTX 3090 used listings →', url: 'https://www.ebay.com/sch/i.html?_nkw=RTX+3090', productName: 'NVIDIA RTX 3090 24GB (used)', productCategory: 'GPU', priceRange: '~$850–1,050' },
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Best Smart Home Hubs for Local Control (2026)](/smart-home/best-smart-home-hubs-2027) — dedicated hub picks',
          '[NVIDIA Jetson Orin Nano for Smart Home AI: Review (2026)](/smart-home/nvidia-jetson-orin-nano-smart-home-review) — GPU-class local AI hardware',
          '[Best Zigbee and Thread USB Dongles (2026)](/smart-home/best-zigbee-thread-dongles-2027) — radio hardware for Zigbee and Thread',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[أفضل محاور المنزل الذكي للتحكم المحلي (2026)](/ar/smart-home/best-smart-home-hubs-2027) — توصيات محاور مخصصة',
          '[مراجعة NVIDIA Jetson Orin Nano للذكاء الاصطناعي في المنزل الذكي (2026)](/ar/smart-home/nvidia-jetson-orin-nano-smart-home-review) — عتاد ذكاء اصطناعي محلي بمعالج رسومات',
          '[أفضل أجهزة USB Zigbee وThread (2026)](/ar/smart-home/best-zigbee-thread-dongles-2027) — عتاد لاسلكي لـ Zigbee وThread',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Die besten Smart-Home-Hubs für lokale Steuerung (2026)](/de/smart-home/best-smart-home-hubs-2027) – dedizierte Hub-Empfehlungen',
          '[NVIDIA Jetson Orin Nano für Smart-Home-KI: Test (2026)](/de/smart-home/nvidia-jetson-orin-nano-smart-home-review) – GPU-Hardware für lokale KI',
          '[Die besten Zigbee- und Thread-USB-Dongles (2026)](/de/smart-home/best-zigbee-thread-dongles-2027) – Funk-Hardware für Zigbee und Thread',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Los mejores hubs domóticos para control local (2026)](/es/smart-home/best-smart-home-hubs-2027) — hubs dedicados recomendados',
          '[NVIDIA Jetson Orin Nano para IA en el hogar inteligente: análisis (2026)](/es/smart-home/nvidia-jetson-orin-nano-smart-home-review) — hardware de IA local con GPU',
          '[Los mejores dongles USB Zigbee y Thread (2026)](/es/smart-home/best-zigbee-thread-dongles-2027) — hardware de radio para Zigbee y Thread',
        ],
      },
    },
    schema: {
  ...
  ko: {
    ...
    sections: {
      ...
      quickPicks: {
        ...
        columns: ['목표', '구매할 것', '예상 가격'],
        rows: [
          { '목표': 'Home Assistant만 사용', '구매할 것': '[Home Assistant Green 또는 Raspberry Pi 5](#raspberry-pi)', '예상 가격': '$199 (Green) / $180–305 (Pi 5)' },
          { '목표': 'HA + Frigate 카메라', '구매할 것': '[Intel N100/N150 미니 PC](#mini-pc)', '예상 가격': '약 $190–220' },
          { '목표': 'HA + 로컬 LLM', '구매할 것': '[Ryzen 미니 PC, RAM 32GB](#mini-pc)', '예상 가격': '약 $649' },
          { '목표': 'HA + 더 큰 로컬 LLM', '구매할 것': '[중고 RTX 3090 서버](#server)', '예상 가격': '약 $1,050–1,300 (GPU만)' },
        ],
        tableFormat: true,
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[로컬 제어를 위한 최고의 스마트홈 허브 (2026년)](/ko/smart-home/best-smart-home-hubs-2027) — 전용 허브 추천',
          '[스마트홈 AI용 NVIDIA Jetson Orin Nano 리뷰 (2026)](/ko/smart-home/nvidia-jetson-orin-nano-smart-home-review) — GPU 기반 로컬 AI 하드웨어',
          '[최고의 Zigbee 및 Thread USB 동글 (2026)](/ko/smart-home/best-zigbee-thread-dongles-2027) — Zigbee/Thread 무선 하드웨어',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Meilleurs hubs domotiques pour le contrôle local (2026)](/fr/smart-home/best-smart-home-hubs-2027) — hubs domotiques dédiés',
          '[NVIDIA Jetson Orin Nano pour la maison connectée : test (2026)](/fr/smart-home/nvidia-jetson-orin-nano-smart-home-review) — matériel IA local avec GPU',
          '[Meilleurs dongles USB Zigbee et Thread (2026)](/fr/smart-home/best-zigbee-thread-dongles-2027) — matériel radio Zigbee et Thread',
        ],
      },
    },
    schema: {
  ...
  ja: {
    ...
    sections: {
      ...
      quickPicks: {
        ...
        columns: ['目的', 'これを買う', '目安価格'],
        rows: [
          { '目的': 'Home Assistant のみ', 'これを買う': '[Home Assistant Green または Raspberry Pi 5](#raspberry-pi)', '目安価格': '約30,000円（Green）／約22,000〜38,000円（Pi 5）' },
          { '目的': 'HA＋Frigate カメラ', 'これを買う': '[Intel N100/N150 ミニPC](#mini-pc)', '目安価格': '約22,000〜27,000円' },
          { '目的': 'HA＋ローカルLLM', 'これを買う': '[Ryzen ミニPC、RAM 32GB](#mini-pc)', '目安価格': '約95,000〜100,000円' },
          { '目的': 'HA＋より大きなローカルLLM', 'これを買う': '[中古 RTX 3090 サーバー](#server)', '目安価格': '約130,000〜160,000円（GPUのみ）' },
        ],
        tableFormat: true,
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[ローカル制御向けベストスマートホームハブ（2026年）](/ja/smart-home/best-smart-home-hubs-2027) — 専用ハブのおすすめ',
          '[NVIDIA Jetson Orin Nanoでスマートホームaiを実現：レビュー（2026年）](/ja/smart-home/nvidia-jetson-orin-nano-smart-home-review) — GPU搭載のローカルAIハードウェア',
          '[最良のZigbee・Thread USBドングル(2026年版)](/ja/smart-home/best-zigbee-thread-dongles-2027) — Zigbee/Thread無線ハードウェア',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Os melhores hubs de casa inteligente para controle local (2026)](/pt/smart-home/best-smart-home-hubs-2027) — hubs dedicados recomendados',
          '[NVIDIA Jetson Orin Nano para IA em casa inteligente: análise (2026)](/pt/smart-home/nvidia-jetson-orin-nano-smart-home-review) — hardware de IA local com GPU',
          '[Os melhores dongles USB Zigbee e Thread (2026)](/pt/smart-home/best-zigbee-thread-dongles-2027) — hardware de rádio para Zigbee e Thread',
        ],
      },
    },
    schema: {
  ...
  zh: {
    ...
    sections: {
      ...
      quickPicks: {
        ...
        columns: ['你的目标', '该买', '预估价格'],
        rows: [
          { '你的目标': '仅 Home Assistant', '该买': '[Home Assistant Green 或 Raspberry Pi 5](#raspberry-pi)', '预估价格': '199 美元（Green）/ 180–305 美元（Pi 5）' },
          { '你的目标': 'HA + Frigate 摄像头', '该买': '[Intel N100/N150 迷你 PC](#mini-pc)', '预估价格': '约 190–220 美元' },
          { '你的目标': 'HA + 本地 LLM', '该买': '[Ryzen 迷你 PC，32GB 内存](#mini-pc)', '预估价格': '约 649 美元' },
          { '你的目标': 'HA + 更大的本地 LLM', '该买': '[二手 RTX 3090 服务器](#server)', '预估价格': '约 1,050–1,300 美元（仅 GPU）' },
        ],
        tableFormat: true,
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[本地控制最佳智能家居中枢（2026年）](/zh/smart-home/best-smart-home-hubs-2027) — 专用中枢推荐',
          '[NVIDIA Jetson Orin Nano智能家居AI评测（2026年）](/zh/smart-home/nvidia-jetson-orin-nano-smart-home-review) — 支持GPU的本地AI硬件',
          '[最佳Zigbee与Thread USB加密狗(2026年)](/zh/smart-home/best-zigbee-thread-dongles-2027) — Zigbee/Thread无线硬件',
        ],
      },
    },
    schema: {
