...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    heroImage: '/images/what-is-a-smart-home-overview-hero-en.webp',
    ...
    sections: {
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'What is Matter, and do I need it for a smart home?', a: 'Matter is a shared connectivity standard — backed by Amazon, Google, Apple, Samsung, and other manufacturers through the Connectivity Standards Alliance — that lets certified devices work across more than one ecosystem instead of locking you into a single app. You do not need Matter to build a smart home; Zigbee, Z-Wave, and Wi-Fi devices still work fine on their own. Choosing Matter-certified devices where available simply reduces the risk of being stuck if you switch ecosystems later.' },
          { q: 'Can I mix devices from different smart home ecosystems?', a: 'Yes, within limits. Matter-certified devices can join more than one ecosystem — a Matter lock, for example, can work with both Apple Home and Google Home. Devices without Matter support are usually tied to their own manufacturer app or protocol, so mixing brands works best when you check for Matter support first or choose a hub, like Home Assistant, that is built to bridge multiple protocols.' },
          { q: 'Does a smart home still work if the internet goes down?', a: 'It depends on whether control is local or cloud-based. Locally controlled devices — using Zigbee, Z-Wave, Thread, or a local hub like Home Assistant — keep running automations without internet. Cloud-controlled devices lose remote access and voice control during an outage, though many keep basic manual operation (a light switch still works even when the app does not).' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'What is Matter, and do I need it for a smart home?', acceptedAnswer: { '@type': 'Answer', text: 'Matter is a shared connectivity standard backed by Amazon, Google, Apple, Samsung, and others that lets certified devices work across more than one ecosystem. It is not required — Zigbee, Z-Wave, and Wi-Fi devices still work fine on their own.' } },
        { '@type': 'Question', name: 'Can I mix devices from different smart home ecosystems?', acceptedAnswer: { '@type': 'Answer', text: 'Yes, within limits. Matter-certified devices can join more than one ecosystem. Devices without Matter support are usually tied to their own manufacturer app or protocol, or a bridging hub like Home Assistant.' } },
        { '@type': 'Question', name: 'Does a smart home still work if the internet goes down?', acceptedAnswer: { '@type': 'Answer', text: 'Locally controlled devices (Zigbee, Z-Wave, Thread, or a local hub like Home Assistant) keep running automations without internet. Cloud-controlled devices lose remote access and voice control during an outage.' } },
      ],
    },
  },
  ...
  ar: {
    ...
    next_refresh_due: '2027-03-04',
    theme: 'Smart Home Foundations',
    heroImage: '/images/what-is-a-smart-home-overview-hero-ar.webp',
    title: 'ما هو المنزل الذكي؟ دليل المبتدئين لعام ⁨2026⁩',
    seoTitle: 'ما هو المنزل الذكي؟ الدليل الشامل للمبتدئين ⁨2026⁩',
    intro:
      'المنزل الذكي مجموعة من الأجهزة المتصلة التي تراقبها وتُشغّلها تلقائيًا وتتحكم بها عبر تطبيق أو صوت. يشرح هذا الدليل للمبتدئين الفكرة الأساسية وفئات الأجهزة وكيف تربط المحاور الأجهزة ببعضها، واختيار السحابة مقابل المحلي الذي يحدد الخصوصية في 2026، والمنظومات الرئيسية، وما الذي تفعله لاحقًا إذا أردت إعدادًا خاصًا.',
    metaDescription:
      '5 فئات من الأجهزة، 4 منظومات رئيسية، وقرار واحد محوري: السحابة أم المحلي. دليل المبتدئين الشامل لبناء المنزل الذكي في 2026.',
    twitterDescription:
      'ما هو المنزل الذكي؟ أجهزة متصلة تُشغّلها تلقائيًا وتتحكم بها عبر تطبيق أو صوت. دليل المبتدئين 2026 للفئات والمحاور والسحابة مقابل المحلي.',
    readTime: '8 دقائق للقراءة',
    educationalLevel: 'Beginner',
    audience: 'المبتدئون الذين يخططون لمنزلهم الذكي الأول',
    primaryTerm: 'smart home',
    targetKeywords: [
      'ما هو المنزل الذكي',
      'شرح المنزل الذكي',
      'أساسيات المنزل الذكي',
      'المنزل الذكي للمبتدئين',
      'السحابة مقابل المحلي في المنزل الذكي',
    ],
    leadAnswerBlock:
      '**المنزل الذكي مجموعة من الأجهزة المتصلة عبر الإنترنت أو محور — مصابيح وموازنات حرارة وأقفال وكاميرات وحساسات — يمكنك مراقبتها وتشغيلها تلقائيًا والتحكم بها من تطبيق أو بالصوت.** أهم قرار في 2026 هو السحابة مقابل التحكم المحلي، لأنه يحدد خصوصيتك وموثوقيتك.',
    quickAnswerTop: {
      ar: {
        question: 'ما هو المنزل الذكي؟',
        answer:
          'المنزل الذكي منزل تُتحكَّم بأجهزته المتصلة وتُشغَّل تلقائيًا عبر تطبيق أو محور أو أوامر صوتية. تشمل الأجهزة الإضاءة والمناخ والأمن والترفيه والحساسات. ما إذا كانت تعمل عبر سحابة المصنّع أو محليًا على محور يحدد مدى خصوصية النظام وموثوقيته.',
        bullets: [
          'أجهزة متصلة تُتحكَّم بها بتطبيق أو محور أو صوت',
          'الفئات: الإضاءة والمناخ والأمن والترفيه والحساسات',
          'المحور يربط الأجهزة ويُشغّل الأتمتات',
          'السحابة مقابل التحكم المحلي هو الاختيار الرئيسي في 2026',
          'المنظومات الرئيسية: Alexa وGoogle Home وApple Home وHome Assistant',
        ],
        updatedDate: '2026-06',
      },
    },
    toc: [
      ...
      { label: 'الفكرة الأساسية', anchor: 'core-idea' },
      { label: 'فئات الأجهزة', anchor: 'categories' },
      { label: 'المحاور وطريقة تواصل الأجهزة', anchor: 'hubs' },
      { label: 'السحابة مقابل المحلي', anchor: 'cloud-vs-local' },
      { label: 'المنظومات الرئيسية', anchor: 'ecosystems' },
      { label: 'ما تفعله لاحقًا', anchor: 'next' },
      { label: 'الأسئلة الشائعة', anchor: 'faq' },
    ],
    snippetBlocks: [
      { type: 'one-sentence', content: 'المنزل الذكي أجهزة متصلة — مصابيح وموازنات حرارة وأقفال وكاميرات وحساسات — تراقبها وتُشغّلها تلقائيًا وتتحكم بها بتطبيق أو صوت.' },
      { type: 'plain-terms', content: 'المنزل الذكي يعني ببساطة أجهزة يومية تتواصل مع بعضها ومعك. يمكنك إطفاء الأضواء من هاتفك، وتخفيض التدفئة عند خروجك، أو مطالبة سماعة بقفل الباب. السؤال الكبير هو ما إذا كان كل ذلك يعمل عبر سحابة شركة ما أو يبقى على محور في منزلك.' },
    ],
    sections: {
      tldr: {
        id: 'tldr',
        ...
        isTldr: true,
        items: [
          'المنزل الذكي أجهزة متصلة تُتحكَّم بها بتطبيق أو محور أو صوت',
          'الفئات الخمس الشائعة: الإضاءة والمناخ والأمن والترفيه والحساسات',
          'المحور ينسّق الأجهزة ويُشغّل الأتمتات لتعمل معًا',
          'التحكم السحابي يُوجّه الأوامر عبر خادم المورد؛ المحلي يُبقيها في المنزل',
          'التحكم المحلي يعني خصوصية أكبر وموثوقية بلا إنترنت — التمييز الرئيسي في 2026',
          'المنظومات الأربع الكبرى: Amazon Alexa وGoogle Home وApple Home وHome Assistant',
        ],
      },
      coreIdea: {
        id: 'core-idea',
        ...
        content:
          '**المنزل الذكي يحوّل الأجهزة العادية إلى أجهزة يمكنك مراقبتها وتشغيلها تلقائيًا والتحكم بها عن بُعد أو بالصوت.** الأتمتة — وهي تصرّف الأجهزة من تلقاء نفسها بناءً على محفّزات — هي ما يُميّز المنزل الذكي عن مجموعة من الأدوات التي تعمل عن بُعد.',
        items: [
          '**المراقبة:** رؤية حالة الجهاز (هل الباب مقفل، هل الجو دافئ) من أي مكان.',
          '**الأتمتة:** وضع قواعد ("أضئ ضوء الشرفة عند الغروب") لتتصرف الأجهزة دونك.',
          '**التحكم:** استخدام تطبيق أو مساعد صوتي لتشغيل الأجهزة مباشرة.',
        ],
      },
      categories: {
        id: 'categories',
        title: 'فئات أجهزة المنزل الذكي الخمس',
        content:
          '**تقع معظم أجهزة المنزل الذكي في خمس فئات: الإضاءة والمناخ والأمن والترفيه والحساسات.** كثير من الأجهزة متاح بنسختَين: سحابية فقط أو قادرة على العمل محليًا.',
        columns: ['الفئة', 'أمثلة على الأجهزة', 'السحابة أم المحلي'],
        rows: [
          { 'الفئة': 'الإضاءة', 'أمثلة على الأجهزة': 'مصابيح ذكية ومفاتيح وقوابس', 'السحابة أم المحلي': 'الاثنان (Zigbee/Matter محلي)' },
          { 'الفئة': 'المناخ', 'أمثلة على الأجهزة': 'موازنات حرارة وصمامات مشعّات ذكية', 'السحابة أم المحلي': 'الاثنان' },
          { 'الفئة': 'الأمن', 'أمثلة على الأجهزة': 'كاميرات وأقفال ذكية وأجراس أبواب', 'السحابة أم المحلي': 'غالبًا سحابي؛ توجد خيارات محلية' },
          { 'الفئة': 'الترفيه', 'أمثلة على الأجهزة': 'سماعات وتلفزيونات وأجهزة بث', 'السحابة أم المحلي': 'سحابي في معظمه' },
          { 'الفئة': 'الحساسات', 'أمثلة على الأجهزة': 'حركة وباب/نافذة ودرجة حرارة', 'السحابة أم المحلي': 'الاثنان (Zigbee/Z-Wave محلي)' },
        ],
      },
      hubs: {
        id: 'hubs',
        title: 'ما هو محور المنزل الذكي؟',
        content:
          '**المحور هو المنسّق الذي يُمكّن الأجهزة من التواصل مع بعضها وتشغيل الأتمتات، وغالبًا يجسر بروتوكولات لاسلكية مختلفة.** بعض المنظومات تستخدم محورًا مخصصًا؛ وأخرى تستخدم سماعة أو هاتفك.',
        items: [
          'المحور يجسر بروتوكولات مثل Zigbee وZ-Wave إلى شبكتك — اطّلع على [شرح بروتوكولات المنزل الذكي](/ar/smart-home/smart-home-protocols-explained).',
          'المحاور المحلية (مثل Home Assistant) تُشغّل الأتمتات بدون إنترنت.',
          'المنظومات السحابية قد لا تحتاج محورًا منفصلًا لكنها تعتمد على خوادمها.',
        ],
      },
      cloudVsLocal: {
        id: 'cloud-vs-local',
        title: 'السحابة مقابل المحلي: خط الفصل في 2026',
        content:
          '**التحكم السحابي يُرسل أوامرك إلى خادم المورد؛ التحكم المحلي يُبقيها داخل منزلك.** هذا هو الاختيار الذي يحدد الخصوصية والموثوقية بلا إنترنت وما إذا كان المورد قادرًا على تغيير أجهزتك أو إيقافها.',
        items: [
          '**السحابة:** إعداد سهل، لكن البيانات تغادر منزلك وقد تتوقف الميزات إذا أُوقفت الخدمة.',
          '**المحلي:** يتطلب إعدادًا أكثر، لكنه خاص وقادر على العمل بلا إنترنت وغير تابع لسحابة المورد — اطّلع على [الدليل الكامل للمنزل الذكي المحلي](/ar/smart-home/local-smart-home-complete-guide).',
          '**لماذا يجب على المبتدئين الاهتمام:** القرار يصعب التراجع عنه لاحقًا، لذا من الأفضل اتخاذه مبكرًا.',
        ],
      },
      ecosystems: {
        id: 'ecosystems',
        title: 'المنظومات الرئيسية',
        content:
          '**المنظومات الأربع الكبرى هي Amazon Alexa وGoogle Home وApple Home وHome Assistant — وتتمايز أكثر ما تتمايز في الخصوصية والتحكم المحلي.** Home Assistant هو بطل الخصوصية والمحلي؛ Alexa وGoogle سحابيان أولًا.',
        items: [
          '**Amazon Alexa:** دعم واسع للأجهزة، سحابي أولًا، يقوده الصوت.',
          '**Google Home:** دعم واسع وصوت قوي، سحابي أولًا.',
          '**Apple Home:** أكثر تركيزًا على الخصوصية مع بعض التحكم المحلي عبر محور المنزل.',
          '**Home Assistant:** مفتوح المصدر، محلي أولًا، الأكثر خصوصية — مقارن في [مقارنة المنظومات](/ar/smart-home/smart-home-ecosystems-compared).',
        ],
      },
      next: {
        id: 'next',
        title: 'ما تفعله لاحقًا',
        content:
          '**إذا كانت الخصوصية مهمة، ابدأ مسار المحلي أولًا؛ وإذا أردت الراحة فقط، فالمنظومة السحابية أسرع بداية.** في كلتا الحالتين، ابدأ بغرفة واحدة.',
        items: [
          'جديد وتريد مسارًا خطوة بخطوة؟ اطّلع على [المنزل الذكي للمبتدئين: من أين تبدأ](/ar/smart-home/smart-home-for-beginners-where-to-start).',
          'تهتم بالخصوصية؟ اطّلع على [الدليل الكامل للمنزل الذكي المحلي](/ar/smart-home/local-smart-home-complete-guide).',
        ],
      },
      faqSection: {
        id: 'faq',
        ...
        faqs: [
          { q: 'هل أحتاج محورًا للمنزل الذكي؟', a: 'ليس دائمًا. أجهزة Wi-Fi والمنظومات السحابية تعمل بدون محور مخصص، لكن المحور ضروري للبروتوكولات المحلية مثل Zigbee وZ-Wave وللتشغيل المحلي للأتمتات. المحور المحلي مثل Home Assistant يُبقي نظامك يعمل بلا إنترنت أيضًا.' },
          { q: 'هل المنزل الذكي آمن؟', a: 'يمكن أن يكون كذلك، لكن الأمان يعتمد على الأجهزة والإعداد. الأجهزة السحابية تُعرّض البيانات لخوادم المورد؛ الإعدادات المحلية تُبقي البيانات في المنزل. استخدم كلمات مرور قوية وحدّث البرامج الثابتة وفضّل الأجهزة القادرة محليًا للمناطق الحساسة كالكاميرات.' },
          { q: 'السحابة أم المحلي — أيهما أفضل للمبتدئين؟', a: 'المنظومات السحابية أسهل في البداية؛ الإعداد المحلي يتطلب جهدًا أكثر لكنه يوفر الخصوصية والموثوقية بلا إنترنت. إذا كانت الخصوصية تهمك، فالبداية المحلية تتجنب انتقالًا أصعب لاحقًا.' },
          { q: 'ما أرخص طريقة لبدء منزل ذكي؟', a: 'ابدأ بغرفة واحدة وبضعة أجهزة قادرة محليًا وبسعر معقول (مصباحان أو قابسان وحساس) إضافةً إلى محور. التوسع التدريجي يتجنب الإنفاق الزائد ويتيح لك التعلم قبل الالتزام بمنظومة.' },
          { q: 'ما هو Matter، وهل أحتاجه للمنزل الذكي؟', a: 'Matter معيار اتصال مشترك — تدعمه Amazon وGoogle وApple وSamsung وشركات أخرى عبر Connectivity Standards Alliance — يتيح للأجهزة المعتمدة العمل مع أكثر من منظومة بدلًا من حصرك في تطبيق واحد. لست بحاجة إلى Matter لبناء منزل ذكي؛ أجهزة Zigbee وZ-Wave وWi-Fi تعمل جيدًا بمفردها. اختيار أجهزة معتمدة من Matter عند توفرها يقلّل فقط من خطر التقيّد إذا غيّرت المنظومة لاحقًا.' },
          { q: 'هل يمكنني مزج أجهزة من منظومات منزل ذكي مختلفة؟', a: 'نعم، ضمن حدود. الأجهزة المعتمدة من Matter يمكنها الانضمام إلى أكثر من منظومة — فقفل Matter مثلًا يعمل مع Apple Home وGoogle Home معًا. الأجهزة غير المدعومة بـMatter تبقى عادة مرتبطة بتطبيق أو بروتوكول الشركة المصنّعة، لذا يعمل مزج العلامات التجارية بشكل أفضل إذا تحققت أولًا من دعم Matter أو اخترت محورًا مثل Home Assistant مصمَّمًا لربط بروتوكولات متعددة.' },
          { q: 'هل يستمر المنزل الذكي بالعمل إذا انقطع الإنترنت؟', a: 'يعتمد ذلك على ما إذا كان التحكم محليًا أم سحابيًا. الأجهزة التي تُتحكَّم بها محليًا — عبر Zigbee أوZ-Wave أوThread أو محور محلي مثل Home Assistant — تواصل تشغيل الأتمتات بدون إنترنت. الأجهزة السحابية تفقد الوصول عن بُعد والتحكم الصوتي أثناء الانقطاع، لكن كثيرًا منها يحتفظ بالتشغيل اليدوي الأساسي (مفتاح الإضاءة يعمل حتى لو تعطّل التطبيق).' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
        ...
        items: [
          '[الدليل الكامل للمنزل الذكي المحلي](/ar/smart-home/local-smart-home-complete-guide) — المسار الخاص بلا سحابة',
          '[تاريخ تكنولوجيا المنزل الذكي](/ar/smart-home/history-of-smart-home-technology) — كيف وصلنا إلى هنا',
          '[المنزل الذكي للمبتدئين: من أين تبدأ](/ar/smart-home/smart-home-for-beginners-where-to-start) — خطواتك الأولى',
          '[مقارنة منظومات المنزل الذكي](/ar/smart-home/smart-home-ecosystems-compared) — اختَر منصة',
        ],
      },
    },
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      headline: 'ما هو المنزل الذكي؟ دليل المبتدئين لعام 2026',
      description: 'المنزل الذكي هو أجهزة متصلة تتحكم بها عبر تطبيق أو صوت. دليل المبتدئين 2026: الفئات والمحاور واختيار السحابة مقابل المحلي والمنظومات الرئيسية.',
      url: 'https://www.promptquorum.com/ar/smart-home/what-is-a-smart-home',
      inLanguage: 'ar',
      author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      datePublished: '2026-06-04',
    ...
    faqSchema: {
      ...
      inLanguage: 'ar',
      mainEntity: [
        { '@type': 'Question', name: 'هل أحتاج محورًا للمنزل الذكي؟', acceptedAnswer: { '@type': 'Answer', text: 'ليس دائمًا. أجهزة Wi-Fi والمنظومات السحابية تعمل بدون محور مخصص، لكنه ضروري للبروتوكولات المحلية مثل Zigbee وZ-Wave وللأتمتة المحلية.' } },
        { '@type': 'Question', name: 'هل المنزل الذكي آمن؟', acceptedAnswer: { '@type': 'Answer', text: 'يمكن أن يكون كذلك بحسب الأجهزة والإعداد. الأجهزة السحابية تُعرّض البيانات لخوادم المورد؛ الإعدادات المحلية تُبقي البيانات في المنزل.' } },
        { '@type': 'Question', name: 'السحابة أم المحلي — أيهما أفضل للمبتدئين؟', acceptedAnswer: { '@type': 'Answer', text: 'السحابة أسهل للبدء؛ المحلي يتطلب جهدًا أكثر لكنه يوفر الخصوصية والموثوقية. إذا كانت الخصوصية تهمك فابدأ محليًا لتتجنب انتقالًا أصعب لاحقًا.' } },
        { '@type': 'Question', name: 'ما أرخص طريقة لبدء منزل ذكي؟', acceptedAnswer: { '@type': 'Answer', text: 'ابدأ بغرفة واحدة وبضعة أجهزة قادرة محليًا وبسعر معقول إضافةً إلى محور، ثم وسّع تدريجيًا.' } },
        { '@type': 'Question', name: 'ما هو Matter، وهل أحتاجه للمنزل الذكي؟', acceptedAnswer: { '@type': 'Answer', text: 'Matter معيار اتصال مشترك تدعمه Amazon وGoogle وApple وSamsung يتيح للأجهزة المعتمدة العمل مع أكثر من منظومة. ليس إلزاميًا؛ أجهزة Zigbee وZ-Wave وWi-Fi تعمل جيدًا بمفردها.' } },
        { '@type': 'Question', name: 'هل يمكنني مزج أجهزة من منظومات منزل ذكي مختلفة؟', acceptedAnswer: { '@type': 'Answer', text: 'نعم، ضمن حدود. الأجهزة المعتمدة من Matter تنضم لأكثر من منظومة. الأجهزة غير المدعومة تبقى مرتبطة بتطبيق الشركة المصنّعة أو بمحور جسر مثل Home Assistant.' } },
        { '@type': 'Question', name: 'هل يستمر المنزل الذكي بالعمل إذا انقطع الإنترنت؟', acceptedAnswer: { '@type': 'Answer', text: 'الأجهزة التي تُتحكَّم بها محليًا (Zigbee أوZ-Wave أوThread أو محور محلي مثل Home Assistant) تواصل تشغيل الأتمتات بدون إنترنت. الأجهزة السحابية تفقد الوصول عن بُعد والتحكم الصوتي أثناء الانقطاع.' } },
      ],
    },
  },
  ...
  de: {
    ...
    next_refresh_due: '2027-03-04',
    theme: 'Smart Home Foundations',
    heroImage: '/images/what-is-a-smart-home-overview-hero-de.webp',
    ...
    sections: {
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'Was ist Matter, und brauche ich es für ein Smart Home?', a: 'Matter ist ein gemeinsamer Konnektivitätsstandard – unterstützt von Amazon, Google, Apple, Samsung und weiteren Herstellern über die Connectivity Standards Alliance –, der zertifizierten Geräten erlaubt, mit mehr als einem Ökosystem zu funktionieren, statt Sie an eine einzige App zu binden. Sie brauchen Matter nicht, um ein Smart Home aufzubauen; Zigbee-, Z-Wave- und WLAN-Geräte funktionieren weiterhin gut für sich allein. Matter-zertifizierte Geräte zu wählen, wo verfügbar, verringert lediglich das Risiko, bei einem späteren Ökosystemwechsel festzustecken.' },
          { q: 'Kann ich Geräte aus verschiedenen Smart-Home-Ökosystemen mischen?', a: 'Ja, mit Einschränkungen. Matter-zertifizierte Geräte können mehr als einem Ökosystem beitreten – ein Matter-Schloss etwa kann sowohl mit Apple Home als auch mit Google Home funktionieren. Geräte ohne Matter-Unterstützung sind meist an die App oder das Protokoll des jeweiligen Herstellers gebunden. Das Mischen von Marken funktioniert daher am besten, wenn Sie zuerst auf Matter-Unterstützung prüfen oder einen Hub wie Home Assistant wählen, der mehrere Protokolle verbindet.' },
          { q: 'Funktioniert ein Smart Home noch, wenn das Internet ausfällt?', a: 'Das hängt davon ab, ob die Steuerung lokal oder cloudbasiert ist. Lokal gesteuerte Geräte – über Zigbee, Z-Wave, Thread oder einen lokalen Hub wie Home Assistant – führen Automatisierungen auch ohne Internet weiter aus. Cloudgesteuerte Geräte verlieren Fernzugriff und Sprachsteuerung bei einem Ausfall, viele behalten aber die einfache manuelle Bedienung (ein Lichtschalter funktioniert weiterhin, auch wenn die App das nicht tut).' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Was ist Matter, und brauche ich es für ein Smart Home?', acceptedAnswer: { '@type': 'Answer', text: 'Matter ist ein gemeinsamer Konnektivitätsstandard von Amazon, Google, Apple, Samsung und weiteren Herstellern, der zertifizierten Geräten erlaubt, mit mehr als einem Ökosystem zu funktionieren. Er ist nicht zwingend nötig; Zigbee-, Z-Wave- und WLAN-Geräte funktionieren auch allein.' } },
        { '@type': 'Question', name: 'Kann ich Geräte aus verschiedenen Smart-Home-Ökosystemen mischen?', acceptedAnswer: { '@type': 'Answer', text: 'Ja, mit Einschränkungen. Matter-zertifizierte Geräte können mehreren Ökosystemen beitreten. Geräte ohne Matter sind meist an die App des Herstellers oder einen Brücken-Hub wie Home Assistant gebunden.' } },
        { '@type': 'Question', name: 'Funktioniert ein Smart Home noch, wenn das Internet ausfällt?', acceptedAnswer: { '@type': 'Answer', text: 'Lokal gesteuerte Geräte (Zigbee, Z-Wave, Thread oder ein lokaler Hub wie Home Assistant) führen Automatisierungen auch ohne Internet aus. Cloudgesteuerte Geräte verlieren Fernzugriff und Sprachsteuerung bei einem Ausfall.' } },
      ],
    },
  },
  ...
  es: {
    ...
    next_refresh_due: '2027-03-04',
    theme: 'Smart Home Foundations',
    heroImage: '/images/what-is-a-smart-home-overview-hero-es.webp',
    ...
    sections: {
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: '¿Qué es Matter y lo necesito para un smart home?', a: 'Matter es un estándar de conectividad compartido —respaldado por Amazon, Google, Apple, Samsung y otros fabricantes a través de la Connectivity Standards Alliance— que permite que los dispositivos certificados funcionen en más de un ecosistema en lugar de dejarte atado a una sola app. No necesitas Matter para montar un smart home; los dispositivos Zigbee, Z-Wave y Wi-Fi siguen funcionando bien por sí solos. Elegir dispositivos certificados con Matter cuando estén disponibles simplemente reduce el riesgo de quedar atrapado si cambias de ecosistema más adelante.' },
          { q: '¿Puedo mezclar dispositivos de distintos ecosistemas de smart home?', a: 'Sí, con límites. Los dispositivos certificados con Matter pueden unirse a más de un ecosistema —una cerradura Matter, por ejemplo, puede funcionar tanto con Apple Home como con Google Home—. Los dispositivos sin Matter suelen quedar atados a la app o el protocolo de su propio fabricante, así que mezclar marcas funciona mejor si primero revisas el soporte de Matter o eliges un hub, como Home Assistant, diseñado para unir varios protocolos.' },
          { q: '¿Un smart home sigue funcionando si se cae internet?', a: 'Depende de si el control es local o basado en la nube. Los dispositivos con control local —mediante Zigbee, Z-Wave, Thread o un hub local como Home Assistant— siguen ejecutando automatizaciones sin internet. Los dispositivos controlados por la nube pierden el acceso remoto y el control por voz durante un corte, aunque muchos conservan el funcionamiento manual básico (un interruptor de luz sigue funcionando aunque la app no lo haga).' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: '¿Qué es Matter y lo necesito para un smart home?', acceptedAnswer: { '@type': 'Answer', text: 'Matter es un estándar de conectividad compartido, respaldado por Amazon, Google, Apple y Samsung, que permite que los dispositivos certificados funcionen en más de un ecosistema. No es obligatorio; los dispositivos Zigbee, Z-Wave y Wi-Fi funcionan bien por sí solos.' } },
        { '@type': 'Question', name: '¿Puedo mezclar dispositivos de distintos ecosistemas de smart home?', acceptedAnswer: { '@type': 'Answer', text: 'Sí, con límites. Los dispositivos certificados con Matter pueden unirse a más de un ecosistema. Los dispositivos sin Matter suelen quedar atados a la app del fabricante o a un hub puente como Home Assistant.' } },
        { '@type': 'Question', name: '¿Un smart home sigue funcionando si se cae internet?', acceptedAnswer: { '@type': 'Answer', text: 'Los dispositivos con control local (Zigbee, Z-Wave, Thread o un hub local como Home Assistant) siguen ejecutando automatizaciones sin internet. Los dispositivos controlados por la nube pierden el acceso remoto y el control por voz durante un corte.' } },
      ],
    },
  },
  ...
  ko: {
    ...
    next_refresh_due: '2027-03-04',
    theme: 'Smart Home Foundations',
    heroImage: '/images/what-is-a-smart-home-overview-hero-ko.webp',
    title: '스마트홈이란? 카테고리부터 허브까지, 2026 입문자 가이드',
    seoTitle: '스마트홈이란? 카테고리·허브·클라우드 대 로컬까지 2026 완전 가이드',
    intro:
    ...
    sections: {
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'Matter란 무엇이며, 스마트홈에 꼭 필요합니까?', a: 'Matter는 Amazon, Google, Apple, Samsung 등 여러 제조사가 Connectivity Standards Alliance를 통해 지원하는 공통 연결 표준으로, 인증된 기기가 하나의 앱에 묶이지 않고 여러 생태계에서 작동하도록 합니다. 스마트홈을 구축하는 데 Matter가 반드시 필요한 것은 아닙니다. Zigbee, Z-Wave, Wi-Fi 기기는 단독으로도 잘 작동합니다. 가능하다면 Matter 인증 기기를 선택하면 나중에 생태계를 바꿀 때 발이 묶일 위험을 줄일 수 있습니다.' },
          { q: '서로 다른 스마트홈 생태계의 기기를 혼합해서 사용할 수 있습니까?', a: '어느 정도는 가능합니다. Matter 인증 기기는 여러 생태계에 동시에 연결될 수 있습니다. 예를 들어 Matter 인증 잠금장치는 Apple Home과 Google Home 모두에서 작동합니다. Matter를 지원하지 않는 기기는 대개 자사 앱이나 프로토콜에 묶여 있으므로, 먼저 Matter 지원 여부를 확인하거나 Home Assistant처럼 여러 프로토콜을 연결하도록 설계된 허브를 선택하는 것이 브랜드를 혼합하는 데 가장 효과적입니다.' },
          { q: '인터넷이 끊겨도 스마트홈이 계속 작동합니까?', a: '제어 방식이 로컬인지 클라우드 기반인지에 따라 다릅니다. Zigbee, Z-Wave, Thread, 또는 Home Assistant 같은 로컬 허브로 로컬 제어되는 기기는 인터넷 없이도 자동화를 계속 실행합니다. 클라우드로 제어되는 기기는 장애 발생 시 원격 접속과 음성 제어를 잃지만, 많은 기기가 기본적인 수동 조작은 유지합니다(앱이 작동하지 않아도 조명 스위치는 작동합니다).' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      headline: '스마트홈이란? 카테고리부터 허브까지, 2026 입문자 가이드',
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Matter란 무엇이며, 스마트홈에 꼭 필요합니까?', acceptedAnswer: { '@type': 'Answer', text: 'Matter는 Amazon, Google, Apple, Samsung이 지원하는 공통 연결 표준으로, 인증된 기기가 여러 생태계에서 작동하도록 합니다. 필수는 아니며 Zigbee, Z-Wave, Wi-Fi 기기도 단독으로 잘 작동합니다.' } },
        { '@type': 'Question', name: '서로 다른 스마트홈 생태계의 기기를 혼합해서 사용할 수 있습니까?', acceptedAnswer: { '@type': 'Answer', text: '어느 정도는 가능합니다. Matter 인증 기기는 여러 생태계에 연결될 수 있습니다. 미지원 기기는 대개 제조사 앱이나 Home Assistant 같은 브리지 허브에 묶입니다.' } },
        { '@type': 'Question', name: '인터넷이 끊겨도 스마트홈이 계속 작동합니까?', acceptedAnswer: { '@type': 'Answer', text: 'Zigbee, Z-Wave, Thread, 또는 Home Assistant 같은 로컬 허브로 제어되는 기기는 인터넷 없이도 자동화를 계속 실행합니다. 클라우드 제어 기기는 장애 시 원격 접속과 음성 제어를 잃습니다.' } },
      ],
    },
  },
  ...
  fr: {
    ...
    next_refresh_due: '2027-03-04',
    theme: 'Smart Home Foundations',
    heroImage: '/images/what-is-a-smart-home-overview-hero-fr.webp',
    ...
    sections: {
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'Qu\'est-ce que Matter, et en ai-je besoin pour une maison connectée ?', a: 'Matter est une norme de connectivité commune — soutenue par Amazon, Google, Apple, Samsung et d\'autres fabricants via la Connectivity Standards Alliance — qui permet aux appareils certifiés de fonctionner avec plusieurs écosystèmes au lieu de vous enfermer dans une seule application. Matter n\'est pas indispensable : les appareils Zigbee, Z-Wave et Wi-Fi fonctionnent très bien seuls. Choisir des appareils certifiés Matter quand c\'est possible réduit simplement le risque d\'être bloqué si vous changez d\'écosystème plus tard.' },
          { q: 'Puis-je mélanger des appareils de différents écosystèmes de maison connectée ?', a: 'Oui, dans une certaine mesure. Les appareils certifiés Matter peuvent rejoindre plusieurs écosystèmes — une serrure Matter, par exemple, fonctionne avec Apple Home et Google Home. Les appareils sans Matter restent liés à l\'application ou au protocole de leur fabricant. Mélanger les marques fonctionne donc mieux si vous vérifiez d\'abord la compatibilité Matter ou choisissez un hub, comme Home Assistant, conçu pour relier plusieurs protocoles.' },
          { q: 'Une maison connectée fonctionne-t-elle encore sans internet ?', a: 'Cela dépend si le contrôle est local ou basé sur le cloud. Les appareils en contrôle local — via Zigbee, Z-Wave, Thread ou un hub local comme Home Assistant — continuent d\'exécuter les automatisations sans internet. Les appareils contrôlés par le cloud perdent l\'accès à distance et la commande vocale lors d\'une coupure, mais beaucoup conservent un fonctionnement manuel de base (un interrupteur fonctionne encore, même si l\'application non).' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Qu\'est-ce que Matter, et en ai-je besoin pour une maison connectée ?', acceptedAnswer: { '@type': 'Answer', text: 'Matter est une norme de connectivité commune soutenue par Amazon, Google, Apple et Samsung, qui permet aux appareils certifiés de fonctionner avec plusieurs écosystèmes. Elle n\'est pas indispensable ; les appareils Zigbee, Z-Wave et Wi-Fi fonctionnent bien seuls.' } },
        { '@type': 'Question', name: 'Puis-je mélanger des appareils de différents écosystèmes de maison connectée ?', acceptedAnswer: { '@type': 'Answer', text: 'Oui, dans une certaine mesure. Les appareils certifiés Matter peuvent rejoindre plusieurs écosystèmes. Les appareils sans Matter restent liés à l\'application du fabricant ou à un hub pont comme Home Assistant.' } },
        { '@type': 'Question', name: 'Une maison connectée fonctionne-t-elle encore sans internet ?', acceptedAnswer: { '@type': 'Answer', text: 'Les appareils en contrôle local (Zigbee, Z-Wave, Thread ou un hub local comme Home Assistant) continuent d\'exécuter les automatisations sans internet. Les appareils cloud perdent l\'accès à distance et la commande vocale lors d\'une coupure.' } },
      ],
    },
  },
  ...
  ja: {
    ...
    next_refresh_due: '2027-03-04',
    theme: 'Smart Home Foundations',
    heroImage: '/images/what-is-a-smart-home-overview-hero-ja.webp',
    ...
    sections: {
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'Matterとは何ですか？スマートホームに必要ですか？', a: 'Matterは、Amazon、Google、Apple、Samsungなどのメーカーが Connectivity Standards Alliance を通じて支持する共通の接続規格で、対応機器を1つのアプリに縛られず複数のエコシステムで使えるようにします。スマートホームを作るのにMatterは必須ではありません。Zigbee、Z-Wave、Wi-Fi機器は単独でも問題なく動作します。可能であればMatter対応機器を選ぶと、後でエコシステムを変える際に行き詰まるリスクを減らせます。' },
          { q: '異なるスマートホームエコシステムの機器を混在させられますか？', a: 'ある程度は可能です。Matter対応機器は複数のエコシステムに参加できます。たとえばMatter対応スマートロックはApple HomeとGoogle Homeの両方で動作します。Matter非対応機器は通常、自社のアプリやプロトコルに縛られます。そのため、まずMatter対応かどうかを確認するか、Home Assistantのような複数プロトコルを橋渡しするハブを選ぶと、ブランドの混在がうまくいきます。' },
          { q: 'インターネットが止まってもスマートホームは動きますか？', a: '制御がローカルかクラウドかによります。Zigbee、Z-Wave、Thread、またはHome Assistantのようなローカルハブでローカル制御される機器は、インターネットなしでも自動化を実行し続けます。クラウド制御の機器は障害時にリモートアクセスと音声制御を失いますが、多くは基本的な手動操作を維持します（アプリが使えなくても照明のスイッチは動きます）。' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Matterとは何ですか？スマートホームに必要ですか？', acceptedAnswer: { '@type': 'Answer', text: 'MatterはAmazon、Google、Apple、Samsungなどが支持する共通の接続規格で、対応機器を複数のエコシステムで使えるようにします。必須ではなく、Zigbee、Z-Wave、Wi-Fi機器も単独で問題なく動作します。' } },
        { '@type': 'Question', name: '異なるスマートホームエコシステムの機器を混在させられますか？', acceptedAnswer: { '@type': 'Answer', text: 'ある程度は可能です。Matter対応機器は複数のエコシステムに参加できます。非対応機器はメーカー独自のアプリや、Home Assistantのような橋渡し用ハブに縛られます。' } },
        { '@type': 'Question', name: 'インターネットが止まってもスマートホームは動きますか？', acceptedAnswer: { '@type': 'Answer', text: 'Zigbee、Z-Wave、Thread、Home Assistantのようなローカルハブで制御される機器は、インターネットなしでも自動化を実行し続けます。クラウド制御の機器は障害時にリモートアクセスと音声制御を失います。' } },
      ],
    },
  },
  ...
  pt: {
    ...
    next_refresh_due: '2027-03-04',
    theme: 'Smart Home Foundations',
    heroImage: '/images/what-is-a-smart-home-overview-hero-pt.webp',
    ...
    sections: {
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'O que é o Matter, e eu preciso dele para uma casa inteligente?', a: 'O Matter é um padrão de conectividade compartilhado — apoiado pela Amazon, Google, Apple, Samsung e outros fabricantes por meio da Connectivity Standards Alliance — que permite que dispositivos certificados funcionem em mais de um ecossistema, em vez de prender você a um único aplicativo. Você não precisa do Matter para montar uma casa inteligente; dispositivos Zigbee, Z-Wave e Wi-Fi continuam funcionando bem sozinhos. Escolher dispositivos certificados pelo Matter quando disponíveis apenas reduz o risco de ficar preso caso você troque de ecossistema depois.' },
          { q: 'Posso misturar dispositivos de ecossistemas de casa inteligente diferentes?', a: 'Sim, com limites. Dispositivos certificados pelo Matter podem entrar em mais de um ecossistema — uma fechadura Matter, por exemplo, funciona tanto com o Apple Home quanto com o Google Home. Dispositivos sem suporte a Matter costumam ficar presos ao aplicativo ou protocolo do próprio fabricante, então misturar marcas funciona melhor quando você verifica o suporte a Matter primeiro ou escolhe um hub, como o Home Assistant, feito para conectar vários protocolos.' },
          { q: 'Uma casa inteligente ainda funciona se a internet cair?', a: 'Depende se o controle é local ou baseado em nuvem. Dispositivos com controle local — usando Zigbee, Z-Wave, Thread ou um hub local como o Home Assistant — continuam executando automações sem internet. Dispositivos controlados pela nuvem perdem o acesso remoto e o controle por voz durante uma queda, mas muitos mantêm a operação manual básica (um interruptor de luz continua funcionando mesmo quando o aplicativo não funciona).' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'O que é o Matter, e eu preciso dele para uma casa inteligente?', acceptedAnswer: { '@type': 'Answer', text: 'O Matter é um padrão de conectividade compartilhado, apoiado por Amazon, Google, Apple e Samsung, que permite que dispositivos certificados funcionem em mais de um ecossistema. Não é obrigatório; dispositivos Zigbee, Z-Wave e Wi-Fi também funcionam bem sozinhos.' } },
        { '@type': 'Question', name: 'Posso misturar dispositivos de ecossistemas de casa inteligente diferentes?', acceptedAnswer: { '@type': 'Answer', text: 'Sim, com limites. Dispositivos certificados pelo Matter podem entrar em mais de um ecossistema. Dispositivos sem Matter costumam ficar presos ao app do fabricante ou a um hub-ponte como o Home Assistant.' } },
        { '@type': 'Question', name: 'Uma casa inteligente ainda funciona se a internet cair?', acceptedAnswer: { '@type': 'Answer', text: 'Dispositivos com controle local (Zigbee, Z-Wave, Thread ou um hub local como o Home Assistant) continuam executando automações sem internet. Dispositivos controlados pela nuvem perdem o acesso remoto e o controle por voz durante uma queda.' } },
      ],
    },
  },
  ...
  zh: {
    ...
    next_refresh_due: '2027-03-04',
    theme: 'Smart Home Foundations',
    heroImage: '/images/what-is-a-smart-home-overview-hero-zh.webp',
    title: '什么是智能家居？设备类别与中枢入门 2026新手指南',
    ...
    sections: {
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'Matter是什么？智能家居需要它吗？', a: 'Matter是一个共享的连接标准——由Amazon、Google、Apple、Samsung等厂商通过Connectivity Standards Alliance共同支持——让通过认证的设备可以在多个生态系统中使用，而不是被锁定在单一应用里。搭建智能家居并不需要Matter；Zigbee、Z-Wave和Wi-Fi设备单独使用也完全正常。在可选情况下选择通过Matter认证的设备，只是能降低日后更换生态系统时被卡住的风险。' },
          { q: '可以混用不同智能家居生态系统的设备吗？', a: '可以，但有限度。通过Matter认证的设备可以加入多个生态系统——例如一把Matter门锁可以同时兼容Apple Home和Google Home。不支持Matter的设备通常被锁定在自家厂商的应用或协议中，因此混用品牌时，最好先确认是否支持Matter，或选择像Home Assistant这样专为桥接多种协议设计的中枢。' },
          { q: '断网后智能家居还能用吗？', a: '这取决于控制方式是本地还是云端。使用Zigbee、Z-Wave、Thread或Home Assistant等本地中枢进行本地控制的设备，即使没有网络也能继续执行自动化。云端控制的设备在断网期间会失去远程访问和语音控制，但很多设备仍保留基本的手动操作（即使应用无法使用，灯的开关仍然能用）。' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      headline: '什么是智能家居？设备类别与中枢入门 2026新手指南',
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Matter是什么？智能家居需要它吗？', acceptedAnswer: { '@type': 'Answer', text: 'Matter是一个共享连接标准，由Amazon、Google、Apple、Samsung等厂商支持，让认证设备可在多个生态系统中使用。它并非必需；Zigbee、Z-Wave和Wi-Fi设备单独使用也正常。' } },
        { '@type': 'Question', name: '可以混用不同智能家居生态系统的设备吗？', acceptedAnswer: { '@type': 'Answer', text: '可以，但有限度。通过Matter认证的设备可加入多个生态系统。不支持Matter的设备通常被锁定在厂商自有应用或Home Assistant这样的桥接中枢中。' } },
        { '@type': 'Question', name: '断网后智能家居还能用吗？', acceptedAnswer: { '@type': 'Answer', text: '使用Zigbee、Z-Wave、Thread或Home Assistant等本地中枢控制的设备，断网后仍可继续执行自动化。云端控制的设备在断网期间会失去远程访问和语音控制。' } },
      ],
    },
  },
}
