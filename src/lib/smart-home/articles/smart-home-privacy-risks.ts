...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    metaDescription:
      'مخاطر الخصوصية في المنزل الذكي: جمع البيانات السحابية والميكروفونات الدائمة الاستماع وبث الكاميرا والاختراقات والمشاركة مع الأطراف الثالثة — وكيف يحل التحكم المحلي هذه المشكلة.',
    twitterDescription:
