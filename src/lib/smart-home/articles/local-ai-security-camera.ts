...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'كاميرات Frigate المحلية بالذكاء الاصطناعي 2026: الكشف الخاص',
    intro:
    ...
    metaDescription:
      'Frigate 2026: كاميرات أمان خاصة بذكاء اصطناعي محلي، كشف بدون سحابة وبدون اشتراك. الأجهزة، وإعداد Home Assistant، والتكلفة مقارنةً بالسحابة.',
    twitterDescription:
