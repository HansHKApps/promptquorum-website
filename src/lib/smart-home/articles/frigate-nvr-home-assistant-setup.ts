  ...
  driveway:
    ...
    review:
      ...
      sources: {
        ...
        title: 'Sources',
        items: [
          '**Frigate Recommended Hardware** — https://docs.frigate.video/frigate/hardware — published per-detector inference speeds and the statement that Coral is no longer recommended for new installations.',
          '**Frigate Object Detectors configuration** — https://docs.frigate.video/configuration/object_detectors — the full list of detector `type` values and the note that the CPU detector is not recommended.',
          '**Frigate Camera Setup** — https://docs.frigate.video/frigate/camera_setup — detect and record stream resolutions, frame rates, and I-frame interval guidance.',
          '**Frigate Zones configuration** — https://docs.frigate.video/configuration/zones — required_zones, loitering_time, inertia defaults, and speed estimation requirements.',
          '**Frigate Semantic Search** — https://docs.frigate.video/configuration/semantic_search — RAM and AVX2 requirements, Jina CLIP V1/V2 comparison, and reindexing behaviour.',
          '**Frigate Home Assistant integration** — https://docs.frigate.video/integrations/home-assistant — MQTT prerequisite and the entity types the integration creates.',
          '**Frigate releases on GitHub** — https://github.com/blakeblackshear/frigate/releases — version numbers and release dates for 0.17.x and the 0.18.0 betas.',
          '**Frigate+** — https://frigate.video/plus/ — subscription price, included fine-tunings, and label limitations.',
        ],
      },
    },
    schema: {
  ...
  driveway:
    ...
    review:
      ...
      sources: {
        ...
        title: 'Quellen',
        items: [
          '**Frigate — Empfohlene Hardware** — https://docs.frigate.video/frigate/hardware — veröffentlichte Inferenzzeiten je Detektor und die Aussage, dass Coral für Neuinstallationen nicht mehr empfohlen wird.',
          '**Frigate — Konfiguration der Objektdetektoren** — https://docs.frigate.video/configuration/object_detectors — die vollständige Liste der `type`-Werte und der Hinweis, dass der CPU-Detektor nicht empfohlen wird.',
          '**Frigate — Kameraeinrichtung** — https://docs.frigate.video/frigate/camera_setup — Auflösungen, Bildraten und I-Frame-Intervalle für Erkennungs- und Aufzeichnungsstream.',
          '**Frigate — Zonenkonfiguration** — https://docs.frigate.video/configuration/zones — required_zones, loitering_time, Standardwert von inertia und Voraussetzungen der Geschwindigkeitsschätzung.',
          '**Frigate — Semantische Suche** — https://docs.frigate.video/configuration/semantic_search — RAM- und AVX2-Anforderungen, Vergleich von Jina CLIP V1 und V2 sowie das Verhalten bei der Neuindizierung.',
          '**Frigate — Home-Assistant-Integration** — https://docs.frigate.video/integrations/home-assistant — MQTT als Voraussetzung und die von der Integration erzeugten Entitätstypen.',
          '**Frigate-Releases auf GitHub** — https://github.com/blakeblackshear/frigate/releases — Versionsnummern und Veröffentlichungsdaten für 0.17.x und die 0.18.0-Betas.',
          '**Frigate+** — https://frigate.video/plus/ — Abopreis, enthaltene Feinabstimmungen und Einschränkungen bei den Bezeichnungen.',
        ],
      },
    },
    schema: {
  ...
  driveway:
    ...
    review:
      ...
      sources: {
        ...
        title: 'Sources',
        items: [
          '**Frigate — Matériel recommandé** — https://docs.frigate.video/frigate/hardware — temps d\'inférence publiés par détecteur et mention que Coral n\'est plus recommandé pour les nouvelles installations.',
          '**Frigate — Configuration des détecteurs d\'objets** — https://docs.frigate.video/configuration/object_detectors — liste complète des valeurs `type` et remarque sur le détecteur CPU déconseillé.',
          '**Frigate — Configuration des caméras** — https://docs.frigate.video/frigate/camera_setup — résolutions, fréquences d\'images et intervalles d\'images clés pour la détection et l\'enregistrement.',
          '**Frigate — Configuration des zones** — https://docs.frigate.video/configuration/zones — required_zones, loitering_time, valeur par défaut d\'inertia et prérequis de l\'estimation de vitesse.',
          '**Frigate — Recherche sémantique** — https://docs.frigate.video/configuration/semantic_search — exigences de RAM et d\'AVX2, comparaison Jina CLIP V1 et V2, comportement de réindexation.',
          '**Frigate — Intégration Home Assistant** — https://docs.frigate.video/integrations/home-assistant — MQTT comme prérequis et types d\'entités créés par l\'intégration.',
          '**Versions de Frigate sur GitHub** — https://github.com/blakeblackshear/frigate/releases — numéros de version et dates de publication des 0.17.x et des bêtas 0.18.0.',
          '**Frigate+** — https://frigate.video/plus/ — prix de l\'abonnement, affinages inclus et limites sur les étiquettes.',
        ],
      },
    },
    schema: {
  ...
  driveway:
    ...
    review:
      ...
      sources: {
        ...
        title: '出典',
        items: [
          '**Frigate 推奨ハードウェア** — https://docs.frigate.video/frigate/hardware — 検出器ごとの公表推論時間と、新規インストールで Coral を推奨しないという記載。',
          '**Frigate 物体検出器の設定** — https://docs.frigate.video/configuration/object_detectors — 検出器 `type` の全一覧と、CPU 検出器を推奨しない旨の注記。',
          '**Frigate カメラ設定** — https://docs.frigate.video/frigate/camera_setup — 検出用・録画用ストリームの解像度、フレームレート、I フレーム間隔の指針。',
          '**Frigate ゾーン設定** — https://docs.frigate.video/configuration/zones — required_zones、loitering_time、inertia の既定値、速度推定の要件。',
          '**Frigate セマンティック検索** — https://docs.frigate.video/configuration/semantic_search — RAM と AVX2 の要件、Jina CLIP V1 / V2 の比較、再インデックスの挙動。',
          '**Frigate Home Assistant 連携** — https://docs.frigate.video/integrations/home-assistant — 前提となる MQTT と、統合が生成するエンティティ種別。',
          '**GitHub の Frigate リリース** — https://github.com/blakeblackshear/frigate/releases — 0.17.x および 0.18.0 ベータのバージョン番号とリリース日。',
          '**Frigate+** — https://frigate.video/plus/ — 契約価格、含まれるファインチューニング回数、ラベルの制約。',
        ],
      },
    },
    schema: {
  ...
  driveway:
    ...
    review:
      ...
      sources: {
        ...
        title: '参考来源',
        items: [
          '**Frigate 推荐硬件** — https://docs.frigate.video/frigate/hardware — 各检测器的官方推理耗时，以及不再推荐新装机使用 Coral 的说明。',
          '**Frigate 目标检测器配置** — https://docs.frigate.video/configuration/object_detectors — 检测器 `type` 取值的完整列表，以及不推荐 CPU 检测器的说明。',
          '**Frigate 摄像头设置** — https://docs.frigate.video/frigate/camera_setup — 检测与录像码流的分辨率、帧率与 I 帧间隔建议。',
          '**Frigate 区域配置** — https://docs.frigate.video/configuration/zones — required_zones、loitering_time、inertia 默认值与速度估算的前提条件。',
          '**Frigate 语义搜索** — https://docs.frigate.video/configuration/semantic_search — 内存与 AVX2 要求、Jina CLIP V1 与 V2 的比较、重建索引的行为。',
          '**Frigate Home Assistant 集成** — https://docs.frigate.video/integrations/home-assistant — MQTT 前置条件与集成生成的实体类型。',
          '**GitHub 上的 Frigate 版本发布** — https://github.com/blakeblackshear/frigate/releases — 0.17.x 与 0.18.0 测试版的版本号和发布日期。',
          '**Frigate+** — https://frigate.video/plus/ — 订阅价格、包含的微调次数与标签限制。',
        ],
      },
    },
    schema: {
  ...
  driveway:
    ...
    review:
      ...
      sources: {
        ...
        title: 'Fuentes',
        items: [
          '**Hardware recomendado de Frigate** — https://docs.frigate.video/frigate/hardware — tiempos de inferencia publicados por detector y la indicación de que Coral ya no se recomienda en instalaciones nuevas.',
          '**Configuración de detectores de objetos de Frigate** — https://docs.frigate.video/configuration/object_detectors — lista completa de valores de `type` y la nota de que el detector CPU no se recomienda.',
          '**Configuración de cámaras de Frigate** — https://docs.frigate.video/frigate/camera_setup — resoluciones, tasas de fotogramas e intervalos de fotograma I para detección y grabación.',
          '**Configuración de zonas de Frigate** — https://docs.frigate.video/configuration/zones — required_zones, loitering_time, valor por defecto de inertia y requisitos de la estimación de velocidad.',
          '**Búsqueda semántica de Frigate** — https://docs.frigate.video/configuration/semantic_search — requisitos de RAM y AVX2, comparación de Jina CLIP V1 y V2 y comportamiento de la reindexación.',
          '**Integración de Frigate con Home Assistant** — https://docs.frigate.video/integrations/home-assistant — MQTT como requisito previo y tipos de entidad que crea la integración.',
          '**Versiones de Frigate en GitHub** — https://github.com/blakeblackshear/frigate/releases — números de versión y fechas de publicación de las 0.17.x y las betas 0.18.0.',
          '**Frigate+** — https://frigate.video/plus/ — precio de la suscripción, afinados incluidos y limitaciones de etiquetas.',
        ],
      },
    },
    schema: {
  ...
  driveway:
    ...
    review:
      ...
      sources: {
        ...
        title: 'Fontes',
        items: [
          '**Hardware recomendado do Frigate** — https://docs.frigate.video/frigate/hardware — tempos de inferência publicados por detector e a informação de que o Coral já não é recomendado em instalações novas.',
          '**Configuração de detectores de objetos do Frigate** — https://docs.frigate.video/configuration/object_detectors — lista completa dos valores de `type` e a observação de que o detector CPU não é recomendado.',
          '**Configuração de câmeras do Frigate** — https://docs.frigate.video/frigate/camera_setup — resoluções, taxas de quadros e intervalos de quadro I para detecção e gravação.',
          '**Configuração de zonas do Frigate** — https://docs.frigate.video/configuration/zones — required_zones, loitering_time, valor padrão de inertia e requisitos da estimativa de velocidade.',
          '**Busca semântica do Frigate** — https://docs.frigate.video/configuration/semantic_search — requisitos de RAM e AVX2, comparação entre Jina CLIP V1 e V2 e comportamento da reindexação.',
          '**Integração do Frigate com o Home Assistant** — https://docs.frigate.video/integrations/home-assistant — MQTT como pré-requisito e os tipos de entidade criados pela integração.',
          '**Versões do Frigate no GitHub** — https://github.com/blakeblackshear/frigate/releases — números de versão e datas de lançamento das 0.17.x e das betas 0.18.0.',
          '**Frigate+** — https://frigate.video/plus/ — preço da assinatura, ajustes incluídos e limitações de rótulos.',
        ],
      },
    },
    schema: {
  ...
  driveway:
    ...
    review:
      ...
      sources: {
        ...
        title: 'المصادر',
        items: [
          '**العتاد الموصى به في Frigate** — https://docs.frigate.video/frigate/hardware — أزمنة الاستدلال المنشورة لكل كاشف، والنص على أن Coral لم يعد موصى به في التركيبات الجديدة.',
          '**إعداد كواشف الأجسام في Frigate** — https://docs.frigate.video/configuration/object_detectors — القائمة الكاملة لقيم `type` والملاحظة بأن كاشف المعالج غير موصى به.',
          '**إعداد الكاميرات في Frigate** — https://docs.frigate.video/frigate/camera_setup — الدقّات ومعدلات الإطارات وفواصل الإطار المفتاحي لتدفقَي الكشف والتسجيل.',
          '**إعداد المناطق في Frigate** — https://docs.frigate.video/configuration/zones — القيم required_zones و loitering_time والقيمة الافتراضية لـ inertia ومتطلبات تقدير السرعة.',
          '**البحث الدلالي في Frigate** — https://docs.frigate.video/configuration/semantic_search — متطلبات الذاكرة و AVX2، ومقارنة Jina CLIP V1 و V2، وسلوك إعادة الفهرسة.',
          '**تكامل Frigate مع Home Assistant** — https://docs.frigate.video/integrations/home-assistant — اشتراط MQTT وأنواع الكيانات التي ينشئها التكامل.',
          '**إصدارات Frigate على GitHub** — https://github.com/blakeblackshear/frigate/releases — أرقام الإصدارات وتواريخ الإطلاق لـ 0.17.x وبيتا 0.18.0.',
          '**Frigate+** — https://frigate.video/plus/ — سعر الاشتراك وعدد عمليات الضبط المشمولة وقيود التسميات.',
        ],
      },
    },
    schema: {
  ...
  driveway:
    ...
    review:
      ...
      sources: {
        ...
        title: '출처',
        items: [
          '**Frigate 권장 하드웨어** — https://docs.frigate.video/frigate/hardware — 디텍터별 공개 추론 시간과, 신규 설치에 Coral을 더 이상 권장하지 않는다는 서술.',
          '**Frigate 객체 디텍터 설정** — https://docs.frigate.video/configuration/object_detectors — 디텍터 `type` 값의 전체 목록과 CPU 디텍터를 권장하지 않는다는 주석.',
          '**Frigate 카메라 설정** — https://docs.frigate.video/frigate/camera_setup — 인식용·녹화용 스트림의 해상도, 프레임 레이트, I 프레임 간격 지침.',
          '**Frigate 존 설정** — https://docs.frigate.video/configuration/zones — required_zones, loitering_time, inertia 기본값, 속도 추정 요건.',
          '**Frigate 시맨틱 검색** — https://docs.frigate.video/configuration/semantic_search — RAM 및 AVX2 요건, Jina CLIP V1과 V2 비교, 재색인 동작.',
          '**Frigate Home Assistant 통합** — https://docs.frigate.video/integrations/home-assistant — 선행 조건인 MQTT와 통합이 생성하는 엔티티 유형.',
          '**GitHub의 Frigate 릴리스** — https://github.com/blakeblackshear/frigate/releases — 0.17.x 및 0.18.0 베타의 버전 번호와 릴리스 날짜.',
          '**Frigate+** — https://frigate.video/plus/ — 구독 가격, 포함된 파인튜닝 횟수, 라벨 제약.',
        ],
      },
    },
    schema: {
