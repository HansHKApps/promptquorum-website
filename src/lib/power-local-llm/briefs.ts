...
export const POWER_LLM_BRIEFS: Record<string, ArticleBrief> = {
  ...
  'best-local-llm-apps-iphone-2026': {
    ...
    externalLinks: [
      ...
      { url: '/directory', reasoning: 'directory reference for app listings' },
    ],
    structure: {
  ...
  'local-llm-with-obsidian-2026': {
    ...
    externalLinks: [
      ...
      { url: '/directory', reasoning: 'directory listing for Obsidian plugins' },
    ],
    structure: {
  ...
  'local-llm-with-logseq-and-joplin': {
    ...
    externalLinks: [
      { url: '/local-llms/best-local-llms-2026', reasoning: 'model authority for plugin configuration' },
      { url: '/directory', reasoning: 'directory listing for Logseq and Joplin AI tools' },
    ],
    structure: {
  ...
  'voice-assistant-local-mobile-offline': {
    ...
    externalLinks: [
      { url: '/local-llms/best-local-llms-2026', reasoning: 'model authority' },
      { url: '/directory', reasoning: 'directory for Whisper.cpp and Piper TTS entries' },
    ],
    structure: {
