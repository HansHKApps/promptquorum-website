...
import { article as a_local_llm_code_development_compared } from './articles/local-llm-code-development-compared'
import { article as a_local_llm_train_operate_compared } from './articles/local-llm-train-operate-compared'
...
import { article as a_noema_review } from './articles/noema-review'
import { article as a_ai_on_device_review } from './articles/ai-on-device-review'
import { article as a_on_device_ai_review } from './articles/on-device-ai-review'
...
import { article as a_vane_review } from './articles/vane-review'
...
import { article as a_goose_review } from './articles/goose-review'
import { article as a_atomic_bot_review } from './articles/atomic-bot-review'
...
export const powerLLMContent: Record<string, Partial<Record<Language, LLMArticle>>> = {
  ...
  'goose-review':                                      a_goose_review,
  // Atomic Bot review — 2026-09-12
  'atomic-bot-review':                                 a_atomic_bot_review,
  ...
  'noema-review':                                      a_noema_review,
  'ai-on-device-review':                                a_ai_on_device_review,
  // On Device AI review — 2026-09-12
  'on-device-ai-review':                                a_on_device_ai_review,
  ...
  'local-llm-code-development-compared':            a_local_llm_code_development_compared,
  'local-llm-train-operate-compared':               a_local_llm_train_operate_compared,
  ...
  'google-ai-edge-gallery-review':                 a_google_ai_edge_gallery_review,
