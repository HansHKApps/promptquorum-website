...
export const POWER_LLM_SLUG_TO_KEY: Record<string, string> = {
  ...
  'locally-uncensored-review':                'locally-uncensored-review',
  ...
  // Microsoft Agent Framework review — agent frameworks series — 2026-09-06
  'microsoft-agent-framework-review':             'microsoft-agent-framework-review',
  ...
  'pydantic-ai-review': 'pydantic-ai-review',
  ...
  'goose-review':                                 'goose-review',
  // Atomic Bot review — 2026-09-12
  'atomic-bot-review':                            'atomic-bot-review',
  ...
  'noema-review':                            'noema-review',
  'ai-on-device-review':                     'ai-on-device-review',
  'on-device-ai-review':                     'on-device-ai-review',
  ...
  'local-llm-code-development-compared':     'local-llm-code-development-compared',
  'local-llm-train-operate-compared':        'local-llm-train-operate-compared',
  ...
  'piper-vs-kokoro-tts':                     'piper-vs-kokoro-tts',
  'piper-vs-chatterbox-tts':                 'piper-vs-chatterbox-tts',
  'kokoro-vs-elevenlabs':                    'kokoro-vs-elevenlabs',
  'chatterbox-vs-elevenlabs':                'chatterbox-vs-elevenlabs',
  'best-tts-for-ollama':                     'best-tts-for-ollama',
  'best-local-tts-raspberry-pi':             'best-local-tts-raspberry-pi',
  'best-local-tts-mac':                      'best-local-tts-mac',
  'best-local-tts-nvidia-gpu':               'best-local-tts-nvidia-gpu',
