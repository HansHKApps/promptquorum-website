...
export const app: ToolRecord = {
  ...
  license: 'MIT',
  price: 'free',
  hardware: { ramGb: null, vramGb: null, cpuOnly: true, variesByModel: true }, // per github.com/AtomicBot-ai/atomic-agent README: "runs on everyday consumer GPUs and CPUs, no datacenter needed", "falls back to CPU when no GPU driver is available" — no fixed RAM/VRAM number stated, depends on the local model chosen via llama-server; verified 2026-09-13
