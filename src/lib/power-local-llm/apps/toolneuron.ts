...
export const app: ToolRecord = {
  ...
  license: 'MIT',
  price: 'free',
  hardware: { ramGb: null, vramGb: null, cpuOnly: null, variesByModel: true }, // per github.com/Siddhesh2377/ToolNeuron README, checked 2026-09-13 — states minSdk 31/compileSdk 37 and arm64-v8a/x86_64 ABIs but no minimum device RAM; on-device GGUF model loaded by the user determines the real floor, no fixed floor of its own
