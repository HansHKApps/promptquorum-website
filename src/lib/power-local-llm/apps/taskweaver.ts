...
export const app: ToolRecord = {
  ...
  license: 'MIT',
  price: 'free',
  hardware: { ramGb: null, vramGb: null, cpuOnly: null }, // per github.com/microsoft/TaskWeaver README, checked 2026-09-13 — no hardware/system-requirements section; depends entirely on the LLM backend the user configures, no fixed floor of its own
  stars: 6200,
