...
export const app: ToolRecord = {
  ...
  license: 'Apache-2.0',
  price: 'free',
  hardware: { ramGb: null, vramGb: null, cpuOnly: true, variesByModel: true }, // per github.com/exo-explore README: no fixed per-device minimum — only requirement is enough combined memory across the cluster to fit the model; heterogeneous clusters can include CPU-only/integrated-GPU devices, verified 2026-09-13
