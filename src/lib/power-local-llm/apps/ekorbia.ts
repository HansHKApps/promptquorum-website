...
export const app: ToolRecord = {
  ...
  license: 'MIT',
  price: 'free',
  hardware: { ramGb: null, vramGb: null, cpuOnly: null, variesByModel: true }, // ekorbia.com states no minimum spec; its own embeddings (nomic-embed-text) run CPU-only, but chat depends entirely on the connected Ollama/OpenAI backend, checked 2026-09-13
  stars: 1,
