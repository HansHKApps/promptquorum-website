...
export const app: ToolRecord = {
  ...
  compare: { localLlm: true, dockerDeploy: true, apiServer: true, multiFormat: true, citations: true, desktopApp: true, builtInEngine: true, ollama: true, customEndpoint: true, mcp: true, fileChat: true, voice: true },
