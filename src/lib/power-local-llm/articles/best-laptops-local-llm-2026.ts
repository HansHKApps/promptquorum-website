...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  pt: {
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/pt/pt/power-local-llm/best-laptops-local-llm-2026',
      inLanguage: 'pt-BR',
      datePublished: '2026-05-24',
      dateModified: '2026-05-24',
      author: { '@type': 'Person', name: 'Hans Kuepper' },
  ...
  ar: {
    ...
    seoTitle: 'أفضل لابتوب للنماذج اللغوية المحلية 2026: من MacBook إلى ThinkPad',
    intro:
    ...
    metaDescription:
      'أفضل أجهزة الكمبيوتر المحمولة لتشغيل النماذج اللغوية المحلية في 2026: MacBook Pro M5 Max وRazer Blade وThinkPad وASUS ROG. RAM وVRAM وسرعات الرموز الفعلية مقارَنة حسب الفئة السعرية.',
    twitterDescription:
