  ...
  ja: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        columns: ['ノートパソコン系統', 'メモリモデル', '7B速度（引用データ）', '最適な用途', '価格'],
        rows: [
          {
  ...
  zh: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        columns: ['笔记本系列', '内存模型', '7B 速度（引用数据）', '最适合', '价格'],
        rows: [
          {
  ...
  es: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        columns: ['Familia de portátiles', 'Modelo de memoria', 'Velocidad 7B (datos reutilizados)', 'Mejor para', 'Precio'],
        rows: [
          {
            ...
            'Precio': 'Gama media a premium; consultar precio actual',
          },
          {
          ...
          },
          {
            ...
            'Precio': 'Gama media; consultar precio actual',
          },
          {
  ...
  pt: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        columns: ['Família de notebooks', 'Modelo de memória', 'Velocidade 7B (dados reaproveitados)', 'Melhor para', 'Preço'],
        rows: [
          {
            ...
            'Preço': 'Médio a premium; verificar preço atual',
          },
          {
          ...
          },
          {
            ...
            'Preço': 'Médio; verificar preço atual',
          },
          {
  ...
  ko: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        columns: ['노트북 제품군', '메모리 모델', '7B 속도 (재사용 데이터)', '최적 용도', '가격'],
        rows: [
          {
