...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    metaDescription:
      'Local LLM electricity cost calculated: RTX 4090/3090/4070 and Mac mini M6 power draw, US ($0.184/kWh) and Germany (~€0.32/kWh) monthly cost, and whether an 800W balcony solar system can offset it.',
    twitterDescription:
      'What a local LLM actually costs in electricity — RTX 4090/3090/4070 and Mac mini M6 power draw, US vs. Germany monthly cost, and whether 800W balcony solar can realistically offset it.',
    ...
    quickAnswerTop: {
      en: {
        ...
        bullets: [
          ...
          'Mac mini M6: under 5W idle, up to ~55–74W during LLM inference',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Apple Silicon (Mac mini M6: under 5W idle, ~55–74W inference peak) costs a small fraction of a discrete-GPU rig to run',
      ...
      gpuPower: {
        ...
        rows: [
          ...
          { 'Hardware': 'Mac mini M6', 'Idle': 'Under 5W', 'Load / Inference': 'Up to ~55–74W' },
        ...
        items: [
          ...
          'Mac mini M4 (prior generation): independently measured at under 5W idle and up to ~65W during LLM inference (one measurement recorded a 50W peak specifically). A cluster of five Mac Minis running inference drew roughly 200W combined. The current Mac mini M6 measures similarly low at idle and up to ~55–74W under sustained load, per Notebookcheck\'s review.',
      ...
      monthlyCost: {
        ...
        rows: [
          ...
          { 'Usage pattern': '65W, 4 hrs/day (Mac mini M6)', 'kWh/day': '0.26 kWh', 'US cost/mo': '~$1.44', 'Germany cost/mo': '~€2.50–3.20' },
    ...
    schema: {
      ...
      'description': 'Local LLM electricity cost calculated: RTX 4090/3090/4070 and Mac mini M6 power draw, US and Germany monthly cost, and whether an 800W balcony solar system can offset it.',
      ...
      'inLanguage': 'en',
      'url': 'https://www.promptquorum.com/power-local-llm/local-llm-electricity-cost-balcony-solar',
  ...
  de: {
    ...
    metaDescription:
      'Stromkosten für lokale LLMs berechnet: RTX 4090/3090/4070 und Mac mini M6 Verbrauch, US- (0,184 $/kWh) und deutsche (~0,32 €/kWh) Monatskosten, und ob ein 800-W-Balkonkraftwerk das ausgleichen kann.',
    twitterDescription:
      'Was ein lokales LLM wirklich an Strom kostet — RTX 4090/3090/4070 und Mac mini M6 Verbrauch, US- vs. deutsche Monatskosten, und ob ein 800-W-Balkonkraftwerk das realistisch ausgleichen kann.',
    ...
    quickAnswerTop: {
      de: {
        ...
        bullets: [
          ...
          'Mac mini M6: unter 5 W Leerlauf, bis zu ca. 55–74 W bei LLM-Inferenz',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Apple Silicon (Mac mini M6: unter 5 W Leerlauf, ca. 55–74 W Inferenz-Spitze) kostet nur einen kleinen Bruchteil einer diskreten-GPU-Anlage im Betrieb',
      ...
      gpuPower: {
        ...
        rows: [
          ...
          { 'Hardware': 'Mac mini M6', 'Leerlauf': 'Unter 5 W', 'Last / Inferenz': 'Bis zu ca. 55–74 W' },
        ...
        items: [
          ...
          'Mac mini M4 (Vorgängergeneration): unabhängig gemessen mit unter 5 W im Leerlauf und bis zu ca. 65 W bei LLM-Inferenz (eine Messung ergab konkret eine Spitze von 50 W). Ein Cluster aus fünf Mac Minis unter Inferenzlast zog zusammen etwa 200 W. Der aktuelle Mac mini M6 misst laut Notebookcheck-Test ähnlich niedrig im Leerlauf und bis zu ca. 55–74 W unter anhaltender Last.',
      ...
      monthlyCost: {
        ...
        rows: [
          ...
          { 'Nutzungsmuster': '65 W, 4 Std./Tag (Mac mini M6)', 'kWh/Tag': '0,26 kWh', 'US-Kosten/Mon.': 'ca. 1,44 $', 'DE-Kosten/Mon.': 'ca. 2,50–3,20 €' },
    ...
    schema: {
      ...
      'description': 'Stromkosten für lokale LLMs berechnet: RTX 4090/3090/4070 und Mac mini M6 Verbrauch, US- und deutsche Monatskosten, und ob ein 800-W-Balkonkraftwerk das ausgleichen kann.',
      'datePublished': '2026-09-01',
      'dateModified': '2026-09-25',
      'author': {
        '@type': 'Person',
      ...
      'inLanguage': 'de',
      'url': 'https://www.promptquorum.com/de/power-local-llm/local-llm-electricity-cost-balcony-solar',
  ...
  fr: {
    ...
    metaDescription:
      'Coût électrique d\'un LLM local calculé : consommation RTX 4090/3090/4070 et Mac mini M6, coût mensuel aux États-Unis (0,184 $/kWh) et en Allemagne (~0,32 €/kWh), et si un solaire de balcon 800 W peut compenser.',
    twitterDescription:
      'Ce que coûte réellement un LLM local en électricité — consommation RTX 4090/3090/4070 et Mac mini M6, coût mensuel États-Unis vs. Allemagne, et si le solaire de balcon 800 W peut réalistement compenser.',
    ...
    quickAnswerTop: {
      fr: {
        ...
        bullets: [
          ...
          'Mac mini M6 : moins de 5 W au repos, jusqu\'à ~55–74 W pendant l\'inférence LLM',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Le silicium Apple (Mac mini M6 : moins de 5 W au repos, ~55–74 W en pic d\'inférence) coûte une petite fraction d\'une installation à GPU dédié',
      ...
      gpuPower: {
        ...
        rows: [
          ...
          { 'Matériel': 'Mac mini M6', 'Repos': 'Moins de 5 W', 'Charge / Inférence': 'Jusqu\'à ~55–74 W' },
        ...
        items: [
          ...
          'Mac mini M4 (génération précédente) : mesuré indépendamment à moins de 5 W au repos et jusqu\'à ~65 W pendant l\'inférence LLM (une mesure a spécifiquement relevé un pic de 50 W). Un cluster de cinq Mac Mini en pleine inférence a consommé environ 200 W au total. Le Mac mini M6 actuel mesure, selon le test de Notebookcheck, un repos tout aussi bas et jusqu\'à ~55–74 W en charge soutenue.',
      ...
      monthlyCost: {
        ...
        rows: [
          ...
          { 'Profil d\'usage': '65 W, 4 h/jour (Mac mini M6)', 'kWh/jour': '0,26 kWh', 'Coût US/mois': '~1,44 $', 'Coût DE/mois': '~2,50–3,20 €' },
    ...
    schema: {
      ...
      'description': 'Coût électrique d\'un LLM local calculé : consommation RTX 4090/3090/4070 et Mac mini M6, coût mensuel aux États-Unis et en Allemagne, et si un solaire de balcon 800 W peut compenser.',
      'datePublished': '2026-09-01',
      'dateModified': '2026-09-25',
      'author': {
        '@type': 'Person',
      ...
      'inLanguage': 'fr',
      'url': 'https://www.promptquorum.com/fr/power-local-llm/local-llm-electricity-cost-balcony-solar',
  ...
  ja: {
    ...
    metaDescription:
      'ローカルLLMの電気代を計算: RTX 4090/3090/4070とMac mini M6の消費電力、米国（$0.184/kWh）とドイツ（約€0.32/kWh）の月額コスト、800Wベランダ太陽光で相殺できるか。',
    twitterDescription:
      'ローカルLLMの実際の電気代 — RTX 4090/3090/4070とMac mini M6の消費電力、米国とドイツの月額コスト比較、800Wベランダ太陽光で現実的に相殺できるかを解説。',
    readTime: '10分で読める',
    educationalLevel: 'Intermediate',
    ...
    quickAnswerTop: {
      ja: {
        ...
        bullets: [
          ...
          'Mac mini M6: アイドル時5W未満、LLM推論時最大約55–74W',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Apple Silicon（Mac mini M6：アイドル時5W未満、推論ピーク約55–74W）は、単体GPU構成のごく一部のコストで運用できる',
      ...
      gpuPower: {
        ...
        rows: [
          ...
          { 'ハードウェア': 'Mac mini M6', 'アイドル': '5W未満', '負荷 / 推論': '最大約55–74W' },
        ...
        items: [
          ...
          'Mac mini M4(前世代): 独立した測定でアイドル時5W未満、LLM推論時最大約65W(ある測定ではピーク50Wを具体的に記録)。5台のMac Miniクラスタが推論を全力実行すると、合計で約200Wを消費した。Notebookcheckのレビューによれば、現行のMac mini M6もアイドル時は同程度に低く、持続負荷時は最大約55〜74Wである。',
      ...
      monthlyCost: {
        ...
        rows: [
          ...
          { '利用パターン': '65W・1日4時間（Mac mini M6）', '1日あたりkWh': '0.26kWh', '米国月額': '約$1.44', 'ドイツ月額': '約€2.50〜3.20' },
      ...
      faqSection: {
        ...
        faqs: [
          ...
          {
            q: 'ローカルAIにおいて、Mac mini M6はRTX 4090より運用コストが安いですか？',
            a: 'かなり安くなります。Mac mini M6はアイドル時5W未満、推論時最大約55–74Wであるのに対し、RTX 4090はアイドル時20〜33W、負荷時最大450Wです — 1日4時間の利用で、Mac Miniは米国で月額約$1.44、RTX 4090は約$6.60かかり、より重く長時間のワークロードではこの差はさらに大きく広がります。',
          },
          {
    ...
    schema: {
      ...
      'description': 'ローカルLLMの電気代を計算: RTX 4090/3090/4070とMac mini M6の消費電力、米国とドイツの月額コスト、800Wベランダ太陽光で相殺できるか。',
      'datePublished': '2026-09-01',
      'dateModified': '2026-09-25',
      'author': {
        '@type': 'Organization',
      ...
      'inLanguage': 'ja',
      'url': 'https://www.promptquorum.com/ja/power-local-llm/local-llm-electricity-cost-balcony-solar',
  ...
  zh: {
    ...
    metaDescription:
      '本地LLM电费计算:RTX 4090/3090/4070和Mac mini M6的功耗、美国($0.184/kWh)和德国(约€0.32/kWh)的月度电费,以及800W阳台光伏系统能否抵消这笔费用。',
    twitterDescription:
      '本地LLM实际电费是多少——RTX 4090/3090/4070和Mac mini M6功耗、美国与德国月度电费对比,以及800W阳台光伏能否切实抵消这笔支出。',
    readTime: '阅读约10分钟',
    educationalLevel: 'Intermediate',
    ...
    quickAnswerTop: {
      zh: {
        ...
        bullets: [
          ...
          'Mac mini M6:空闲低于5W,LLM推理时最高约55–74W',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Apple Silicon(Mac mini M6:空闲低于5W,推理峰值约55–74W)的运行成本仅为独立GPU设备的一小部分',
      ...
      gpuPower: {
        ...
        rows: [
          ...
          { '硬件': 'Mac mini M6', '空闲': '低于5W', '满载 / 推理': '最高约55–74W' },
        ...
        items: [
          ...
          'Mac mini M4(上一代):独立测试显示空闲功耗低于5W,LLM推理时最高约65W(其中一项测量具体记录了50W的峰值)。五台Mac Mini组成的集群在全力推理时合计功耗约200W。根据Notebookcheck的评测,现款Mac mini M6空闲功耗同样很低,持续满载时最高约55–74W。',
      ...
      monthlyCost: {
        ...
        rows: [
          ...
          { '使用模式': '65W,每天4小时(Mac mini M6)', '每天kWh': '0.26kWh', '美国月费用': '约$1.44', '德国月费用': '约€2.50–3.20' },
      ...
      faqSection: {
        ...
        faqs: [
          ...
          {
            q: '在本地AI方面,Mac mini M6比RTX 4090运行成本更低吗？',
            a: '明显更低。Mac mini M6空闲功耗低于5W,推理时最高约55–74W;而RTX 4090空闲功耗为20–33W,满载最高450W——按每天使用4小时计算,在美国Mac Mini的月费用约为$1.44,而RTX 4090约为$6.60,在更重、更长时间的工作负载下这一差距会进一步明显拉大。',
          },
          {
            q: '法国的阳台光伏功率上限与德国不同吗？',
    ...
    schema: {
      ...
      'description': '本地LLM电费计算:RTX 4090/3090/4070和Mac mini M6的功耗、美国和德国的月度电费,以及800W阳台光伏系统能否抵消这笔费用。',
      'datePublished': '2026-09-01',
      'dateModified': '2026-09-25',
      'author': {
        '@type': 'Organization',
      ...
      'inLanguage': 'zh',
      'url': 'https://www.promptquorum.com/zh/power-local-llm/local-llm-electricity-cost-balcony-solar',
  ...
  es: {
    ...
    metaDescription:
      'Coste eléctrico de un LLM local calculado: consumo de RTX 4090/3090/4070 y Mac mini M6, coste mensual en EE. UU. (0,184 $/kWh) y Alemania (~0,32 €/kWh), y si un solar de balcón de 800 W puede compensarlo.',
    twitterDescription:
      'Lo que realmente cuesta en electricidad un LLM local — consumo de RTX 4090/3090/4070 y Mac mini M6, coste mensual EE. UU. vs. Alemania, y si el solar de balcón de 800 W puede compensarlo de forma realista.',
    ...
    quickAnswerTop: {
      es: {
        ...
        bullets: [
          ...
          'Mac mini M6: menos de 5 W en reposo, hasta ~55–74 W durante la inferencia LLM',
    ...
    sections: {
      ...
      gpuPower: {
        ...
        rows: [
          ...
          { 'Hardware': 'Mac mini M6', 'Reposo': 'Menos de 5 W', 'Carga / Inferencia': 'Hasta ~55–74 W' },
      ...
      monthlyCost: {
        ...
        rows: [
          ...
          { 'Patrón de uso': '65 W, 4 h/día (Mac mini M6)', 'kWh/día': '0,26 kWh', 'Coste EE. UU./mes': '~$1.44', 'Coste Alemania/mes': '~€2,50–3,20' },
    ...
    schema: {
      ...
      'description': 'Coste eléctrico de un LLM local calculado: consumo de RTX 4090/3090/4070 y Mac mini M6, coste mensual en EE. UU. y Alemania, y si un solar de balcón de 800 W puede compensarlo.',
      'datePublished': '2026-09-01',
      'dateModified': '2026-09-25',
      'author': {
        '@type': 'Person',
      ...
      'inLanguage': 'es',
      'url': 'https://www.promptquorum.com/es/power-local-llm/local-llm-electricity-cost-balcony-solar',
  ...
  pt: {
    ...
    metaDescription:
      'Custo de energia de um LLM local calculado: consumo de RTX 4090/3090/4070 e Mac mini M6, custo mensal nos EUA ($0,184/kWh) e na Alemanha (~€0,32/kWh), e se um solar de varanda de 800 W consegue compensar.',
    twitterDescription:
      'O que um LLM local realmente custa em energia — consumo de RTX 4090/3090/4070 e Mac mini M6, custo mensal EUA vs. Alemanha, e se o solar de varanda de 800 W consegue compensar de forma realista.',
    ...
    quickAnswerTop: {
      pt: {
        ...
        bullets: [
          ...
          'Mac mini M6: menos de 5 W em repouso, até ~55–74 W durante a inferência de LLM',
    ...
    sections: {
      ...
      gpuPower: {
        ...
        rows: [
          ...
          { 'Hardware': 'Mac mini M6', 'Repouso': 'Menos de 5 W', 'Carga / Inferência': 'Até ~55–74 W' },
      ...
      monthlyCost: {
        ...
        rows: [
          ...
          { 'Padrão de uso': '65 W, 4 h/dia (Mac mini M6)', 'kWh/dia': '0,26 kWh', 'Custo EUA/mês': '~$1,44', 'Custo Alemanha/mês': '~€2,50–3,20' },
    ...
    schema: {
      ...
      'description': 'Custo de energia de um LLM local calculado: consumo de RTX 4090/3090/4070 e Mac mini M6, custo mensal nos EUA e na Alemanha, e se um solar de varanda de 800 W consegue compensar.',
      'datePublished': '2026-09-01',
      'dateModified': '2026-09-25',
      'author': {
        '@type': 'Person',
      ...
      'inLanguage': 'pt-BR',
      'url': 'https://www.promptquorum.com/pt/power-local-llm/local-llm-electricity-cost-balcony-solar',
  ...
  ar: {
    ...
    metaDescription:
      'تكلفة كهرباء LLM المحلي محسوبة: استهلاك RTX 4090/3090/4070 وMac mini M6، والتكلفة الشهرية في الولايات المتحدة ($0.184/kWh) وألمانيا (~0.32 يورو/kWh)، وهل يستطيع نظام شمسي للشرفة بقدرة 800 واط تعويض ذلك.',
    twitterDescription:
      'ما تكلفه فعليًا الكهرباء لتشغيل LLM محلي — استهلاك RTX 4090/3090/4070 وMac mini M6، مقارنة التكلفة الشهرية بين الولايات المتحدة وألمانيا، وهل يمكن لنظام شمسي للشرفة بقدرة 800 واط تعويض ذلك واقعيًا.',
    ...
    quickAnswerTop: {
      ar: {
        ...
        bullets: [
          ...
          'Mac mini M6: أقل من 5 واط في وضع الخمول، حتى نحو 55–74 واط أثناء استدلال LLM',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'رقائق Apple Silicon (Mac mini M6: أقل من 5 واط في وضع الخمول، ذروة استدلال نحو 55–74 واط) تكلّف جزءًا صغيرًا فقط من تكلفة جهاز ببطاقة رسومات منفصلة',
      ...
      gpuPower: {
        ...
        rows: [
          ...
          { 'الجهاز': 'Mac mini M6', 'وضع الخمول': 'أقل من 5 واط', 'الحمل / الاستدلال': 'حتى نحو 55–74 واط' },
        ...
        items: [
          ...
          'Mac mini M4 (الجيل السابق): قِيس بشكل مستقل بأقل من 5 واط في وضع الخمول وحتى نحو 65 واط أثناء استدلال LLM (سجّل أحد القياسات تحديدًا ذروة 50 واط). استهلكت مجموعة من خمسة أجهزة Mac Mini أثناء الاستدلال الكامل نحو 200 واط مجتمعة. ووفقًا لمراجعة Notebookcheck، يسجّل Mac mini M6 الحالي استهلاكًا منخفضًا بالمثل في وضع الخمول، وحتى نحو 55–74 واط تحت الحمل المستمر.',
      ...
      monthlyCost: {
        ...
        rows: [
          ...
          { 'نمط الاستخدام': '65 واط، 4 ساعات/يوم (Mac mini M6)', 'كيلوواط ساعة/يوم': '0.26 كيلوواط ساعة', 'تكلفة أمريكا/شهر': 'نحو 1.44 دولار', 'تكلفة ألمانيا/شهر': 'نحو 2.50–3.20 يورو' },
      ...
      faqSection: {
        ...
        faqs: [
          ...
          {
            q: 'هل يُعد Mac mini M6 أرخص تشغيلًا من RTX 4090 للذكاء الاصطناعي المحلي؟',
            a: 'بشكل كبير. يستهلك Mac mini M6 أقل من 5 واط في وضع الخمول وحتى نحو 55–74 واط أثناء الاستدلال، مقابل 20–33 واط في وضع الخمول وحتى 450 واط تحت الحمل لبطاقة RTX 4090 — عند استخدام 4 ساعات يوميًا، يكلّف Mac Mini نحو 1.44 دولار شهريًا في الولايات المتحدة مقابل نحو 6.60 دولار شهريًا لـRTX 4090، وتتسع الفجوة بشكل كبير مع أعباء العمل الأثقل والأطول.',
          },
          {
    ...
    schema: {
      ...
      'description': 'تكلفة كهرباء LLM المحلي محسوبة: استهلاك RTX 4090/3090/4070 وMac mini M6، والتكلفة الشهرية في الولايات المتحدة وألمانيا، وهل يستطيع نظام شمسي للشرفة بقدرة 800 واط تعويض ذلك.',
      'datePublished': '2026-09-01',
      'dateModified': '2026-09-25',
      'author': {
        '@type': 'Organization',
      ...
      'inLanguage': 'ar',
      'url': 'https://www.promptquorum.com/ar/power-local-llm/local-llm-electricity-cost-balcony-solar',
  ...
  ko: {
    ...
    metaDescription:
      '로컬 LLM 전기 요금 계산: RTX 4090/3090/4070과 Mac mini M6의 전력 소비, 미국($0.184/kWh)과 독일(약 €0.32/kWh)의 월 비용, 800W 발코니 태양광 시스템으로 상쇄할 수 있는지 여부.',
    twitterDescription:
      '로컬 LLM이 실제로 드는 전기 요금 — RTX 4090/3090/4070과 Mac mini M6의 전력 소비, 미국 대 독일 월 비용 비교, 800W 발코니 태양광으로 현실적으로 상쇄할 수 있는지 정리.',
    readTime: '10분 읽기',
    educationalLevel: 'Intermediate',
    ...
    quickAnswerTop: {
      ko: {
        ...
        bullets: [
          ...
          'Mac mini M6: 대기 시 5W 미만, LLM 추론 시 최대 약 55–74W',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Apple Silicon(Mac mini M6: 대기 시 5W 미만, 추론 피크 약 55–74W)은 독립 GPU 구성 대비 극히 일부의 비용으로 운영됩니다',
      ...
      gpuPower: {
        ...
        rows: [
          ...
          { '하드웨어': 'Mac mini M6', '대기': '5W 미만', '부하 / 추론': '최대 약 55–74W' },
        ...
        items: [
          ...
          'Mac mini M4(이전 세대): 독립적으로 측정한 결과 대기 시 5W 미만, LLM 추론 시 최대 약 65W였습니다(한 측정에서는 구체적으로 50W 피크를 기록). 5대의 Mac Mini로 구성된 클러스터가 전력을 다해 추론할 때 합계 약 200W를 소비했습니다. Notebookcheck 리뷰에 따르면 현재의 Mac mini M6도 대기 시 비슷하게 낮은 소비 전력을 보이며, 지속 부하 시 최대 약 55~74W입니다.',
      ...
      monthlyCost: {
        ...
        rows: [
          ...
          { '사용 패턴': '65W, 하루 4시간(Mac mini M6)', 'kWh/일': '0.26kWh', '미국 월 비용': '약 $1.44', '독일 월 비용': '약 €2.50~3.20' },
      ...
      faqSection: {
        ...
        faqs: [
          ...
          {
            q: '로컬 AI 용도로는 Mac mini M6가 RTX 4090보다 운영 비용이 저렴합니까?',
            a: '상당히 저렴합니다. Mac mini M6는 대기 시 5W 미만, 추론 시 최대 약 55–74W를 소비하는 반면, RTX 4090은 대기 시 20~33W, 부하 시 최대 450W를 소비합니다 — 하루 4시간 사용 기준으로 Mac Mini는 미국에서 월 약 $1.44, RTX 4090은 약 $6.60가 들며, 더 무겁고 더 오래 지속되는 워크로드에서는 이 격차가 크게 벌어집니다.',
          },
          {
    ...
    schema: {
      ...
      'description': '로컬 LLM 전기 요금 계산: RTX 4090/3090/4070과 Mac mini M6의 전력 소비, 미국과 독일의 월 비용, 800W 발코니 태양광 시스템으로 상쇄할 수 있는지 여부.',
      'datePublished': '2026-09-01',
      'dateModified': '2026-09-25',
      'author': {
        '@type': 'Organization',
      ...
      'inLanguage': 'ko',
      'url': 'https://www.promptquorum.com/ko/power-local-llm/local-llm-electricity-cost-balcony-solar',
