...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  es: {
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/es/power-local-llm/best-local-models-tool-calling-2026?lang=es',
      inLanguage: 'es',
      author: {
        '@type': 'Person',
        name: 'Hans Kuepper',
  ...
  pt: {
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/pt/power-local-llm/best-local-models-tool-calling-2026?lang=pt',
      inLanguage: 'pt-BR',
      author: {
        '@type': 'Person',
        name: 'Hans Kuepper',
