  ...
  fr: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Best Local LLM Apps for iPhone in 2026](/fr/power-local-llm/best-local-llm-apps-iphone-2026) — le comparatif iOS, avec des alternatives installables à LLM Farm.',
          '[Avis PocketPal AI](/fr/power-local-llm/pocketpal-ai-review) — une alternative gratuite, open source et installable directement pour iPhone, iPad et Android.',
          '[Avis Private LLM](/fr/power-local-llm/private-llm-review) — une alternative payante, closed source, réservée à Apple, avec un large catalogue de modèles.',
          '[Avis Enclave AI](/fr/power-local-llm/enclave-ai-review) — une alternative réservée à Apple avec automatisation Siri et Raccourcis.',
          '[Loci AI Review: Offline AI for iPhone, Android, iPad, Mac and Windows](/fr/power-local-llm/loci-ai-review-offline-local-ai) — une alternative payante, closed source, sur cinq plateformes, avec une bibliothèque de modèles organisée.',
        ],
      },
    },
    schema: {
  ...
  es: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Best Local LLM Apps for iPhone in 2026](/es/power-local-llm/best-local-llm-apps-iphone-2026) — el comparativo de iOS, con alternativas instalables a LLM Farm.',
          '[Análisis de PocketPal AI](/es/power-local-llm/pocketpal-ai-review) — una alternativa gratuita, de código abierto e instalable directamente para iPhone, iPad y Android.',
          '[Análisis de Private LLM](/es/power-local-llm/private-llm-review) — una alternativa de pago, de código cerrado, exclusiva de Apple, con un amplio catálogo de modelos.',
          '[Análisis de Enclave AI](/es/power-local-llm/enclave-ai-review) — una alternativa exclusiva de Apple con automatización de Siri y Atajos.',
          '[Loci AI Review: Offline AI for iPhone, Android, iPad, Mac and Windows](/es/power-local-llm/loci-ai-review-offline-local-ai) — una alternativa de pago, de código cerrado, en cinco plataformas, con una biblioteca de modelos seleccionada.',
        ],
      },
    },
    schema: {
  ...
  ja: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '関連記事',
        items: [
          '[Best Local LLM Apps for iPhone in 2026](/ja/power-local-llm/best-local-llm-apps-iphone-2026) — LLM Farmのインストール可能な代替アプリを比較したiOS向けまとめ記事。',
          '[PocketPal AIレビュー](/ja/power-local-llm/pocketpal-ai-review) — iPhone、iPad、Android向けの無料でオープンソース、ワンタップインストール可能な代替アプリ。',
          '[Private LLMレビュー](/ja/power-local-llm/private-llm-review) — Apple専用の有料でクローズドソースの代替アプリで、大規模な厳選モデルカタログを持つ。',
          '[Enclave AIレビュー](/ja/power-local-llm/enclave-ai-review) — SiriとShortcutsのオートメーションを備えたApple専用の代替アプリ。',
          '[Loci AI Review: Offline AI for iPhone, Android, iPad, Mac and Windows](/ja/power-local-llm/loci-ai-review-offline-local-ai) — 厳選モデルライブラリを持つ、5プラットフォーム対応の有料クローズドソース代替アプリ。',
        ],
      },
    },
    schema: {
  ...
  pt: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Best Local LLM Apps for iPhone in 2026](/pt/power-local-llm/best-local-llm-apps-iphone-2026) — o comparativo de iOS, com alternativas instaláveis ao LLM Farm.',
          '[Análise do PocketPal AI](/pt/power-local-llm/pocketpal-ai-review) — uma alternativa gratuita, de código aberto e instalável diretamente para iPhone, iPad e Android.',
          '[Análise do Private LLM](/pt/power-local-llm/private-llm-review) — uma alternativa paga, de código fechado, exclusiva da Apple, com um amplo catálogo de modelos.',
          ...
          '[Loci AI Review: Offline AI for iPhone, Android, iPad, Mac and Windows](/pt/power-local-llm/loci-ai-review-offline-local-ai) — uma alternativa paga, de código fechado, em cinco plataformas, com uma biblioteca de modelos selecionada.',
        ],
      },
    },
    schema: {
  ...
  zh: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '相关阅读',
        items: [
          '[Best Local LLM Apps for iPhone in 2026](/zh/power-local-llm/best-local-llm-apps-iphone-2026)——iOS 应用汇总,比较了 LLM Farm 的可安装替代方案。',
          '[PocketPal AI 评测](/zh/power-local-llm/pocketpal-ai-review)——一款面向 iPhone、iPad 和 Android 的免费、开源、可直接安装的替代方案。',
          '[Private LLM 评测](/zh/power-local-llm/private-llm-review)——一款仅限苹果平台的付费闭源替代方案,拥有庞大的精选模型目录。',
          '[Enclave AI 评测](/zh/power-local-llm/enclave-ai-review)——一款仅限苹果平台的替代方案,具备 Siri 和快捷指令自动化功能。',
          '[Loci AI Review: Offline AI for iPhone, Android, iPad, Mac and Windows](/zh/power-local-llm/loci-ai-review-offline-local-ai)——一款覆盖五个平台的付费闭源替代方案,拥有精选模型库。',
        ],
      },
    },
    schema: {
  ...
  ko: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '관련 읽을거리',
        items: [
          '[Best Local LLM Apps for iPhone in 2026](/ko/power-local-llm/best-local-llm-apps-iphone-2026) — LLM Farm의 설치 가능한 대안들을 비교한 iOS 앱 모음.',
          '[PocketPal AI 리뷰](/ko/power-local-llm/pocketpal-ai-review) — 아이폰, 아이패드, 안드로이드용 무료, 오픈소스, 탭 한 번으로 설치 가능한 대안.',
          '[Private LLM 리뷰](/ko/power-local-llm/private-llm-review) — 방대한 엄선된 모델 카탈로그를 갖춘, 애플 전용 유료 폐쇄형 소스 대안.',
          '[Enclave AI 리뷰](/ko/power-local-llm/enclave-ai-review) — Siri 및 단축어 자동화를 갖춘 애플 전용 대안.',
          '[Loci AI Review: Offline AI for iPhone, Android, iPad, Mac and Windows](/ko/power-local-llm/loci-ai-review-offline-local-ai) — 엄선된 모델 라이브러리를 갖춘, 다섯 개 플랫폼을 지원하는 유료 폐쇄형 소스 대안.',
        ],
      },
    },
    schema: {
  ...
  ar: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Best Local LLM Apps for iPhone in 2026](/ar/power-local-llm/best-local-llm-apps-iphone-2026) — مقارنة تطبيقات iOS، بما فيها بدائل قابلة للتثبيت لـLLM Farm.',
          '[مراجعة PocketPal AI](/ar/power-local-llm/pocketpal-ai-review) — بديل مجاني ومفتوح المصدر وقابل للتثبيت مباشرة لأجهزة iPhone وiPad وAndroid.',
          '[مراجعة Private LLM](/ar/power-local-llm/private-llm-review) — بديل مدفوع ومغلق المصدر مقتصر على منتجات Apple بكتالوج واسع من النماذج المُنتقاة.',
          '[مراجعة Enclave AI](/ar/power-local-llm/enclave-ai-review) — بديل مقتصر على منتجات Apple يتضمن أتمتة عبر Siri والاختصارات.',
          '[Loci AI Review: Offline AI for iPhone, Android, iPad, Mac and Windows](/ar/power-local-llm/loci-ai-review-offline-local-ai) — بديل مدفوع ومغلق المصدر يعمل على خمس منصات بمكتبة نماذج مُنتقاة.',
        ],
      },
    },
    schema: {
