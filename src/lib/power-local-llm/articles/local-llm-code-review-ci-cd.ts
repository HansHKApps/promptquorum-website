...
`,
      ...
      url: 'https://www.promptquorum.com/es/es/power-local-llm/local-llm-code-review-ci-cd',
      inLanguage: 'es',
...
`,
  ...
  ar: {
    ...
    seoTitle: 'مراجعة الكود بنموذج LLM محلي في CI/CD 2026: أتمتة مراجعات PR',
    intro:
    ...
    metaDescription:
      'مراجعة الكود بنموذج LLM محلي مستضاف ذاتياً في GitHub Actions: البنية، وملف YAML للسير العملي، وتحجيم الأجهزة حسب الفريق، ونموذج الأمان، ونقطة التعادل الاقتصادي مقابل GitHub Advanced Security.',
    twitterDescription:
