    ...
    sections: {
      ...
      recommendedStack: {
        ...
        items: [
          ...
          '**Coding-tuned model:** **Qwen3-Coder 30B** at Q4_K_M is the August 2026 default — strongest open-weight coding direction, 256K context, Apache 2.0 licence, fits on a 24 GB GPU. For 8–16 GB GPUs, use Qwen2.5-Coder 7B with the understanding that review quality drops noticeably.',
...
`,
      ...
      hardwareSizing: {
        ...
        rows: [
          { 'Team size': '~5 developers', 'GPU': 'RTX 4070 / 4070 Ti', 'VRAM': '12–16 GB', 'Concurrent reviews': '1 (Qwen2.5-Coder 7B only)', 'Approx. price': '$600–900' },
      ...
      commonMistakes: {
        ...
        items: [
          '**Mistake 1: starting with a 7B model on a 16 GB GPU.** Qwen2.5-Coder 7B reviews are noticeably worse than 30B reviews; developers lose trust quickly and the project gets shelved. If you cannot fit the 30B, either upgrade the GPU or use a cloud API for the first six months while you secure budget.',
    ...
    sections: {
      ...
      recommendedStack: {
        ...
        items: [
          ...
          '**Coding-optimiertes Modell:** **Qwen3-Coder 30B** bei Q4_K_M ist der August 2026 Standard — stärkste Open-Weight Coding Richtung, 256K Kontext, Apache 2.0 Lizenz, passt auf eine 24 GB GPU. Für 8–16 GB GPUs verwenden Sie Qwen2.5-Coder 7B mit dem Verständnis, dass Review Qualität merklich sinkt.',
...
`,
      ...
      hardwareSizing: {
        ...
        rows: [
          { 'Teamgröße': '~5 Entwickler', 'GPU': 'RTX 4070 / 4070 Ti', 'VRAM': '12–16 GB', 'Gleichzeitige Reviews': '1 (nur Qwen2.5-Coder 7B)', 'Ungefährer Preis': 'ca. 799–1.099 €' },
      ...
      commonMistakes: {
        ...
        items: [
          '**Fehler 1: Start mit einem 7B Modell auf einer 16 GB GPU.** Qwen2.5-Coder 7B Reviews sind merklich schlechter als 30B Reviews; Entwickler verlieren schnell Vertrauen und das Projekt wird abgestellt. Wenn Sie das 30B nicht passen können, upgraden Sie entweder die GPU oder verwenden Sie eine Cloud API für die ersten sechs Monate während Sie Budget sichern.',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Ja, aber die Workloads konkurrieren um die gleiche GPU und haben unterschiedliche Latenz Charakteristiken. Code Review ist asynchron und toleriert 30-sekündige Antworten; interaktive Code Generierung in einem Editor braucht Sub-2-sekündige Latenz. Empfohlenes Muster: verwenden Sie ein kleineres Modell (Qwen2.5-Coder 7B) für Editor Autocomplete auf Developer Maschinen und reservieren Sie den dedizierten GPU Server für Review-Klasse Workloads in CI.',
          },
          {
...
`, items: ['L\'exécuteur doit pouvoir atteindre `OLLAMA_HOST` via le réseau — auto-hébergé sur le même VPC, ou via Tailscale / WireGuard si le serveur GPU est ailleurs.', 'Le prompt système impose une réponse JSON structurée pour que l\'action puisse se brancher sur le verdict proprement. Sans `format: "json"` et un schéma strict dans le prompt, vous passerez du temps opérationnel à analyser la sortie free-form.', 'Le checkout `fetch-depth: 0` est nécessaire pour calculer une vraie diff contre la branche de base — les checkouts superficiels produisent des diffs malformées.', 'Pour les dépôts au-dessus d\'environ 50K lignes de code modifié par RP, tronquez ou fragmentez la diff avant d\'envoyer. Le contexte 256K sur Qwen3-Coder 30B est généreux, mais le contexte de travail pratique est plus proche de 64K–128K (voir [Best Local Coding Models in 2026](/fr/power-local-llm/best-local-coding-models-2026)).', 'Pour la profondeur du design de prompt — prompts système vs utilisateur, exemples, résultats structurés — voir [System Prompt vs User Prompt: What\'s the Difference](/fr/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference).'], callouts: [{ type: 'note', text: 'Ce flux de travail est intentionnellement minimal. Les déploiements production ajoutent : un cache codé par hash fichier + diff pour sauter les re-révisions de fichiers inchangés, les seuils de sévérité (bloc seulement sur `severity >= "high"`), la publication de commentaires en ligne (au lieu d\'un seul commentaire de synthèse), les variantes de prompt par langue et l\'ingestion de rétroaction du critique pour améliorer le prompt au fil du temps.' }] },
      hardwareSizing: { id: 'hardware-sizing', title: 'Dimensionnement du Matériel par Taille d\'Équipe', content: '**Une RTX 4090 (24 GB) gère confortablement une équipe de 15–25 développeurs.** Le goulot d\'étranglement sur une seule GPU n\'est pas le débit par révision — c\'est la concurrence aux moments de chasse aux RP (lundi matin, fin de sprint). Les règles de dimensionnement ci-dessous supposent Qwen3-Coder 30B à Q4_K_M et une différence RP typique de 50–500 lignes.', columns: ['Taille d\'Équipe', 'GPU', 'VRAM', 'Révisions Simultanées', 'Prix Approximatif (août 2026)'], rows: [{ 'Taille d\'Équipe': '~5 Développeurs', 'GPU': 'RTX 4070 / 4070 Ti', 'VRAM': '12–16 GB', 'Révisions Simultanées': '1 (seulement Qwen2.5-Coder 7B)', 'Prix Approximatif (août 2026)': 'env. 899–1 099 €' }, { 'Taille d\'Équipe': '15–25 Développeurs', 'GPU': 'RTX 4090 / 5090', 'VRAM': '24–32 GB', 'Révisions Simultanées': '1–3 (Qwen3-Coder 30B)', 'Prix Approximatif (août 2026)': 'env. 2 299–2 799 €' }, { 'Taille d\'Équipe': '25–50 Développeurs', 'GPU': 'L40S / A6000 Ada', 'VRAM': '48 GB', 'Révisions Simultanées': '3–6', 'Prix Approximatif (août 2026)': 'env. 8 999–9 999 €' }, { 'Taille d\'Équipe': '50–100 Développeurs', 'GPU': '2× RTX 4090 ou 1× H100', 'VRAM': '48 GB / 80 GB', 'Révisions Simultanées': '6–10', 'Prix Approximatif (août 2026)': 'env. 5 000 € (2× 4090) ou 27 000+ € (H100)' }, { 'Taille d\'Équipe': '100+ Développeurs', 'GPU': 'Multi-GPU H100 ou H200', 'VRAM': '160 GB+', 'Révisions Simultanées': '10+ avec vLLM', 'Prix Approximatif (août 2026)': 'env. 50 000+ €' }], callouts: [{ type: 'tip', text: 'Pour les équipes franchissant le seuil de 50 développeurs, passez de Ollama à vLLM. Ollama privilégie la facilité d\'utilisation ; vLLM privilégie le débit sur les GPU partagées. Le même modèle Qwen3-Coder 30B s\'exécute sur les deux — seul le serveur d\'inférence change.' }] },
...
`,
      ...
      commonMistakes: {
        ...
        items: [
          '**間違い 1：16 GB GPU上で7Bモデルで開始。** Qwen2.5-Coder 7BレビューはQwen3-Coder 30B より非常に悪い。開発者は迅速に信頼失い、プロジェクトはシェルフ。30Bに適応できない場合、ガイド 6 ヶ月間 GPU を確保しながらクラウド API を使用。',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'はい、しかし負荷が同じ GPU について競争し、異なる遅延特性があります。コードレビューは非同期で 30 秒応答を許容します。エディター相互作用のコード生成は 2 秒以下遅延が必要です。推奨パターン：エディター自動完成大きなモデル（Qwen2.5-Coder 7B）と小開発者の機械に予約し、セルフホスト GPU サーバーのクラス。',
          },
          {
...
`,
      ...
      hardwareSizing: {
        ...
        rows: [
          { 'Tamaño del equipo': '~5 desarrolladores', 'GPU': 'RTX 4070 / 4070 Ti', 'VRAM': '12–16 GB', 'Revisiones simultáneas': '1 (solo Qwen2.5-Coder 7B)', 'Precio aproximado (mayo 2026)': '$600–900' },
...
`,
      ...
      hardwareSizing: {
        ...
        rows: [
          { 'Tamanho da equipe': '~5 desenvolvedores', 'GPU': 'RTX 4070 / 4070 Ti', 'VRAM': '12–16 GB', 'Revisões simultâneas': '1 (apenas Qwen2.5-Coder 7B)', 'Preço aproximado (maio 2026)': '$600–900' },
    ...
    sections: {
      ...
      recommendedStack: {
        ...
        items: [
          ...
          '**نموذج مُضبَّط على البرمجة:** **Qwen3-Coder 30B** بتكميم Q4_K_M هو المعيار لأغسطس 2026 — أقوى نموذج مفتوح الأوزان للبرمجة، سياق 256K، ترخيص Apache 2.0، يناسب بطاقة GPU بسعة 24 جيجابايت. للبطاقات بسعة 8–16 جيجابايت، استخدم Qwen2.5-Coder 7B مع الأخذ بعين الاعتبار أن جودة المراجعة تنخفض بشكل ملحوظ.',
...
`,
      ...
      hardwareSizing: {
        ...
        rows: [
          { 'حجم الفريق': '~5 مطورين', 'بطاقة GPU': 'RTX 4070 / 4070 Ti', 'VRAM': '12–16 جيجابايت', 'المراجعات المتزامنة': '1 (Qwen2.5-Coder 7B فقط)', 'السعر التقريبي (أغسطس 2026)': '600–900 دولار' },
      ...
      commonMistakes: {
        ...
        items: [
          '**الخطأ 1: البدء بنموذج 7B على بطاقة GPU بسعة 16 جيجابايت.** مراجعات Qwen2.5-Coder 7B أدنى بشكل ملحوظ من نموذج 30B؛ يفقد المطورون الثقة بسرعة ويُهجر المشروع. إذا لم تتمكن من استضافة 30B فحسّن البطاقة أو استخدم واجهة API سحابية في الأشهر الستة الأولى بينما تضمن الميزانية.',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'نعم لكن عبء العمل يتنافس على البطاقة ذاتها ولها خصائص زمن استجابة مختلفة. مراجعة الكود غير متزامنة وتتحمل استجابات بـ 30 ثانية؛ توليد الكود التفاعلي في محرر يحتاج زمن استجابة أقل من ثانيتين. النمط الموصى به: استخدم نموذجاً أصغر (Qwen2.5-Coder 7B) للإكمال التلقائي في المحرر على أجهزة المطورين، واحتفظ بخادم GPU المخصص لأعمال فئة المراجعة في CI.',
          },
          {
    ...
    sections: {
      ...
      recommendedStack: {
        ...
        items: [
          ...
          '**코딩 조정 모델:** Q4_K_M의 **Qwen3-Coder 30B**는 2026년 8월 기준 표준입니다 — 코딩을 위한 가장 강력한 오픈 웨이트 방향, 256K 컨텍스트, Apache 2.0 라이선스, 24 GB GPU에 적합합니다. 8~16 GB GPU의 경우 Qwen2.5-Coder 7B를 사용하되 리뷰 품질이 현저히 낮아짐을 인식하십시오.',
...
`,
      ...
      hardwareSizing: {
        ...
        rows: [
          { '팀 규모': '개발자 ~5명', 'GPU': 'RTX 4070 / 4070 Ti', 'VRAM': '12~16 GB', '동시 리뷰': '1개 (Qwen2.5-Coder 7B만 가능)', '예상 가격': '$600~900' },
      ...
      commonMistakes: {
        ...
        items: [
          '**실수 1: 16 GB GPU에서 7B 모델로 시작하기.** Qwen2.5-Coder 7B 리뷰는 30B보다 현저히 나쁩니다; 개발자들은 빠르게 신뢰를 잃고 프로젝트가 포기됩니다. 30B를 호스팅할 수 없다면, 예산을 확보하는 동안 처음 6개월간 GPU를 업그레이드하거나 클라우드 API를 사용하십시오.',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: '예, 하지만 워크로드가 동일한 GPU를 경쟁하며 지연 시간 특성이 다릅니다. 코드 리뷰는 비동기적이고 30초 응답을 허용합니다; 에디터에서의 대화형 코드 생성은 2초 미만의 지연 시간이 필요합니다. 권장 패턴: 개발자 머신의 에디터 자동 완성에는 더 작은 모델(Qwen2.5-Coder 7B)을 사용하고, CI에서 리뷰급 워크로드를 위해 전용 GPU 서버를 예약하십시오.',
          },
          {
