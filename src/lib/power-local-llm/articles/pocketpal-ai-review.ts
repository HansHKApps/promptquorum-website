  ...
  fr: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Les meilleures applications LLM locales pour Android en 2026](/fr/power-local-llm/best-local-llm-apps-android-2026) — le panorama des applications Android, dont PocketPal AI, MLC Chat, Maid et Layla.',
          '[Les meilleures applications LLM locales pour iPhone en 2026](/fr/power-local-llm/best-local-llm-apps-iphone-2026) — l\'équivalent iOS, comparant PocketPal AI à Private LLM et Enclave AI.',
          '[Loci : test — IA hors ligne pour iPhone, Android, iPad, Mac et Windows](/fr/power-local-llm/loci-ai-review-offline-local-ai) — une alternative payante à source fermée sur cinq plateformes, avec une bibliothèque de modèles sélectionnée.',
          '[Les meilleurs modèles LLM mobiles en 2026 : Phi-4 Mini vs Gemma 4 vs SmolLM](/fr/power-local-llm/mobile-llm-models-phi4-gemma-smollm) — l\'article complémentaire sur les modèles, pour choisir quel modèle GGUF convient réellement à votre téléphone.',
          '[Enclave AI : test](/fr/power-local-llm/enclave-ai-review) — une alternative réservée à Apple avec automatisation Siri et Raccourcis.',
        ],
      },
    },
    schema: {
  ...
  es: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Las mejores apps de LLM local para Android en 2026](/es/power-local-llm/best-local-llm-apps-android-2026) — el repaso de apps para Android, incluidas PocketPal AI, MLC Chat, Maid y Layla.',
          '[Las mejores apps de LLM local para iPhone en 2026](/es/power-local-llm/best-local-llm-apps-iphone-2026) — el equivalente en iOS, comparando PocketPal AI con Private LLM y Enclave AI.',
          '[Reseña de Loci: IA sin conexión para iPhone, Android, iPad, Mac y Windows](/es/power-local-llm/loci-ai-review-offline-local-ai) — una alternativa de pago y código cerrado en cinco plataformas con biblioteca de modelos seleccionada.',
          '[Los mejores modelos LLM móviles en 2026: Phi-4 Mini vs Gemma 4 vs SmolLM](/es/power-local-llm/mobile-llm-models-phi4-gemma-smollm) — el artículo complementario sobre modelos, para elegir qué modelo GGUF cabe realmente en tu teléfono.',
          '[Reseña de Enclave AI](/es/power-local-llm/enclave-ai-review) — una alternativa exclusiva de Apple con automatización mediante Siri y Atajos.',
        ],
      },
    },
    schema: {
  ...
  ja: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '関連記事',
        items: [
          '[2026年版 Android向けベストローカルLLMアプリ](/ja/power-local-llm/best-local-llm-apps-android-2026) — PocketPal AI、MLC Chat、Maid、Laylaを含むAndroidアプリのまとめ。',
          '[2026年版 iPhone向けベストローカルLLMアプリ](/ja/power-local-llm/best-local-llm-apps-iphone-2026) — iOS版のまとめ。PocketPal AIとPrivate LLM、Enclave AIを比較。',
          '[Lociレビュー：iPhone、Android、iPad、Mac、Windows向けオフラインAI](/ja/power-local-llm/loci-ai-review-offline-local-ai) — キュレーション済みモデルライブラリを備えた、5プラットフォーム対応の有料クローズドソースの代替アプリ。',
          '[2026年版 ベストモバイルLLMモデル：Phi-4 Mini対Gemma 4対SmolLM](/ja/power-local-llm/mobile-llm-models-phi4-gemma-smollm) — どのGGUFモデルが実際にスマートフォンに収まるかを解説するモデル面の関連記事。',
          '[Enclave AIレビュー](/ja/power-local-llm/enclave-ai-review) — SiriとShortcutsによる自動化を備えたApple専用の代替アプリ。',
        ],
      },
    },
    schema: {
  ...
  pt: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Os melhores apps de LLM local para Android em 2026](/pt/power-local-llm/best-local-llm-apps-android-2026) — o panorama de apps para Android, incluindo PocketPal AI, MLC Chat, Maid e Layla.',
          '[Os melhores apps de LLM local para iPhone em 2026](/pt/power-local-llm/best-local-llm-apps-iphone-2026) — o equivalente para iOS, comparando PocketPal AI com Private LLM e Enclave AI.',
          '[Análise do Loci: IA offline para iPhone, Android, iPad, Mac e Windows](/pt/power-local-llm/loci-ai-review-offline-local-ai) — uma alternativa paga e de código fechado em cinco plataformas, com biblioteca de modelos curada.',
          '[Os melhores modelos LLM móveis em 2026: Phi-4 Mini vs Gemma 4 vs SmolLM](/pt/power-local-llm/mobile-llm-models-phi4-gemma-smollm) — o artigo complementar sobre modelos, para escolher qual modelo GGUF realmente cabe no seu celular.',
          '[Análise do Enclave AI](/pt/power-local-llm/enclave-ai-review) — uma alternativa exclusiva da Apple com automação via Siri e Atalhos.',
        ],
      },
    },
    schema: {
  ...
  ar: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[أفضل تطبيقات LLM المحلية لأندرويد في 2026](/ar/power-local-llm/best-local-llm-apps-android-2026) — استعراض تطبيقات Android، بما في ذلك PocketPal AI وMLC Chat وMaid وLayla.',
          '[أفضل تطبيقات LLM المحلية للآيفون في 2026](/ar/power-local-llm/best-local-llm-apps-iphone-2026) — النظير الخاص بنظام iOS، بمقارنة PocketPal AI مع Private LLM وEnclave AI.',
          '[مراجعة Loci: ذكاء اصطناعي دون اتصال لأجهزة iPhone وAndroid وiPad وMac وWindows](/ar/power-local-llm/loci-ai-review-offline-local-ai) — بديل مدفوع ومغلق المصدر عبر خمس منصات بمكتبة نماذج منتقاة.',
          '[أفضل نماذج LLM للهواتف في 2026: Phi-4 Mini مقابل Gemma 4 مقابل SmolLM](/ar/power-local-llm/mobile-llm-models-phi4-gemma-smollm) — المقال المكمّل الخاص بالنماذج، لاختيار النموذج GGUF المناسب فعلًا لهاتفك.',
          '[مراجعة Enclave AI](/ar/power-local-llm/enclave-ai-review) — بديل مخصص لأجهزة Apple فقط مع أتمتة عبر Siri وShortcuts.',
        ],
      },
    },
    schema: {
  ...
  zh: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '相关阅读',
        items: [
          '[2026年Android最佳本地LLM应用](/zh/power-local-llm/best-local-llm-apps-android-2026) —— Android 应用综述，包括 PocketPal AI、MLC Chat、Maid 和 Layla。',
          '[2026年iPhone最佳本地LLM应用](/zh/power-local-llm/best-local-llm-apps-iphone-2026) —— iOS 对应篇，对比 PocketPal AI 与 Private LLM、Enclave AI。',
          '[Loci测评：适用于iPhone、Android、iPad、Mac和Windows的离线AI](/zh/power-local-llm/loci-ai-review-offline-local-ai) —— 一款跨五个平台的付费闭源替代方案，配备精选模型库。',
          '[2026年最佳移动端LLM模型：Phi-4 Mini对比Gemma 4对比SmolLM](/zh/power-local-llm/mobile-llm-models-phi4-gemma-smollm) —— 模型层面的配套文章，帮你选择真正适合手机的 GGUF 模型。',
          '[Enclave AI测评](/zh/power-local-llm/enclave-ai-review) —— 一款配备 Siri 和 Shortcuts 自动化功能的 Apple 专属替代方案。',
        ],
      },
    },
    schema: {
  ...
  ko: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '관련 읽을거리',
        items: [
          '[2026년 Android 최고의 로컬 LLM 앱](/ko/power-local-llm/best-local-llm-apps-android-2026) — PocketPal AI, MLC Chat, Maid, Layla를 포함한 Android 앱 정리.',
          '[2026년 iPhone 최고의 로컬 LLM 앱](/ko/power-local-llm/best-local-llm-apps-iphone-2026) — iOS 버전 정리로, PocketPal AI와 Private LLM, Enclave AI를 비교.',
          '[Loci 리뷰: iPhone, Android, iPad, Mac, Windows용 오프라인 AI](/ko/power-local-llm/loci-ai-review-offline-local-ai) — 큐레이션된 모델 라이브러리를 갖춘 5개 플랫폼 지원 유료 클로즈드소스 대안.',
          '[2026년 최고의 모바일 LLM 모델: Phi-4 Mini vs Gemma 4 vs SmolLM](/ko/power-local-llm/mobile-llm-models-phi4-gemma-smollm) — 어떤 GGUF 모델이 실제로 스마트폰에 적합한지 다루는 모델 관련 자매 기사.',
          '[Enclave AI 리뷰](/ko/power-local-llm/enclave-ai-review) — Siri와 단축어 자동화를 갖춘 Apple 전용 대안.',
        ],
      },
    },
    schema: {
