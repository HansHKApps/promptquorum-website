...
Word ceiling: same length as the input paragraph. Do not add any new information. Do not remove any information that was in the original.`,
  ...
  ar: {
    ...
    seoTitle: 'أوامر النماذج اللغوية المحلية لكتّاب الخيال الأدبي: 15 قالباً 2026',
    intro:
    ...
    metaDescription:
      '15 قالب أوامر لكتّاب الخيال الأدبي باستخدام النماذج اللغوية المحلية. قوالب كتابة المشاهد وتطوير الشخصيات والحوار وبناء العوالم ونقل الأسلوب والمراجعة والتحرير — جاهزة للنسخ في Ollama وLM Studio.',
    twitterDescription:
...
Word ceiling: same length as the input paragraph. Do not add any new information. Do not remove any information that was in the original.`,
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[الأوامر الصفرية مقابل أوامر القليل من الأمثلة](/ar/prompt-engineering/zero-shot-vs-few-shot-prompting) — متى تدرج أمثلة في الأوامر ومتى تحذفها لمهام الخيال الأدبي.',
        ],
      },
    },
      schema: {
