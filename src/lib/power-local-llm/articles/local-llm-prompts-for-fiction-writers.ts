    ...
    sections: {
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**الأفضل للحوار:** Command R+ 104B أو Hermes 3 (تمييز أصوات الشخصيات؛ سجل محكي طبيعي).',
...
Word ceiling: same length as the input paragraph. Do not add any new information. Do not remove any information that was in the original.`,
      ...
      models: {
        ...
        rows: [
          ...
          { 'المهمة': 'الحوار / صوت الشخصية', 'النموذج الموصى به': 'Command R+ 104B أو Hermes 3', 'السبب': 'سجل محكي طبيعي؛ يُميز أصوات الشخصيات بشكل موثوق في التبادلات الموسَّعة' },
      ...
      sources: {
        ...
        items: [
          ...
          'مواصفات Command R+ 104B — [Cohere](https://cohere.com)',
