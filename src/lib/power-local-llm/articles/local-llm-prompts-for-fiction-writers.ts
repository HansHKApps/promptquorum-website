    ...
    sections: {
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**Best for dialogue:** Command A+ or Hermes 3 (character voice differentiation; naturalistic spoken register).',
...
Word ceiling: same length as the input paragraph. Do not add any new information. Do not remove any information that was in the original.`,
      ...
      sources: {
        ...
        items: [
          ...
          'Command A+ specification — [Cohere](https://cohere.com)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Zero-Shot vs Few-Shot Prompting](/prompt-engineering/zero-shot-vs-few-shot) — when to include examples in prompts and when to withhold them for fiction tasks.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**Bestes für Dialog:** Command A+ oder Hermes 3 (Charakterstimm-Differenzierung; naturalistisches Sprachregister).',
...
Word ceiling: same length as the input paragraph. Do not add any new information. Do not remove any information that was in the original.`,
      ...
      sources: {
        ...
        items: [
          ...
          'Command A+ Spezifikation — [Cohere](https://cohere.com)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Zero-Shot vs Few-Shot Prompting](/de/prompt-engineering/zero-shot-vs-few-shot) — wann Beispiele in Prompts eingeschlossen werden sollten und wann nicht für Belletristik-Aufgaben.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**Meilleur pour le dialogue :** Command A+ ou Hermes 3 (différenciation des voix ; registre oral naturaliste).',
...
Word ceiling: same length as the input paragraph. Do not add any new information. Do not remove any information that was in the original.`,
      ...
      sources: {
        ...
        items: [
          ...
          'Spécification Command A+ — [Cohere](https://cohere.com)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Zero-Shot vs Few-Shot Prompting](/fr/prompt-engineering/zero-shot-vs-few-shot) — quand inclure des exemples dans les prompts et quand les retenir pour les tâches de fiction.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**ダイアログに最良：** Command A+またはHermes 3（キャラクターの声の分化；ナチュラルな話し言葉レジスター）。',
...
Word ceiling: same length as the input paragraph. Do not add any new information. Do not remove any information that was in the original.`,
      ...
      sources: {
        ...
        items: [
          ...
          'Command A+仕様 — [Cohere](https://cohere.com)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Zero-Shot vs Few-Shot プロンプティング](/ja/prompt-engineering/zero-shot-vs-few-shot) — フィクションタスクでプロンプトにサンプルを含めるべき時と保留すべき時。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**最佳对话模型：** Command A+或Hermes 3（角色声音区分度高；自然的口语语域）。',
...
Word ceiling: same length as the input paragraph. Do not add any new information. Do not remove any information that was in the original.`,
      ...
      sources: {
        ...
        items: [
          ...
          'Command A+规格 — [Cohere](https://cohere.com)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Zero-Shot vs Few-Shot提示词](/zh/prompt-engineering/zero-shot-vs-few-shot) — 小说任务中何时在提示词中包含示例，何时保留它们。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**Mejor para diálogo:** Command A+ o Hermes 3 (diferenciación de voces de personajes; registro hablado naturalista).',
...
Word ceiling: same length as the input paragraph. Do not add any new information. Do not remove any information that was in the original.`,
      ...
      sources: {
        ...
        items: [
          ...
          'Especificación de Command A+ — [Cohere](https://cohere.com)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Zero-Shot vs Few-Shot Prompting](/es/prompt-engineering/zero-shot-vs-few-shot) — cuándo incluir ejemplos en los prompts y cuándo omitirlos para tareas de ficción.',
        ],
      },
    },
      schema: {
      ...
      url: 'https://www.promptquorum.com/es/power-local-llm/local-llm-prompts-for-fiction-writers',
      inLanguage: 'es',
    ...
    sections: {
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**Melhor para diálogo:** Command A+ ou Hermes 3 (diferenciação de vozes de personagens; registro falado naturalista).',
...
Word ceiling: same length as the input paragraph. Do not add any new information. Do not remove any information that was in the original.`,
      ...
      sources: {
        ...
        items: [
          ...
          'Especificação do Command A+ — [Cohere](https://cohere.com)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Zero-Shot vs Few-Shot Prompting](/pt/prompt-engineering/zero-shot-vs-few-shot) — quando incluir exemplos nos prompts e quando omiti-los para tarefas de ficção.',
        ],
      },
    },
      schema: {
  ...
  ar: {
    ...
    intro:
      'تُنتج النماذج اللغوية المحلية نصوصاً روائية أفضل بشكل ملحوظ عند تزويدها بأوامر مُهيكلة بدلاً من الطلبات المفتوحة. يتضمن هذا الدليل 15 قالب أوامر فعّالاً — لكتابة المشاهد وتطوير الشخصيات والحوار وبناء العوالم ونقل الأسلوب والمراجعة والمهام التحريرية — جميعها مختبرة على Llama 3.3 70B وQwen3 32B وMistral Large تعمل محلياً عبر Ollama أو LM Studio. كل قالب جاهز للنسخ واللصق ويتضمن ما يمكن تعديله بحسب النوع الأدبي.',
    metaDescription:
      '15 قالب أوامر مُختبر مع Llama 3.3 70B وQwen3 32B وMistral على Ollama وLM Studio: المشاهد والحوار والشخصيات وبناء العوالم، جاهزة للنسخ.',
    twitterDescription:
      '15 قالب أوامر للخيال الأدبي مع النماذج اللغوية المحلية: كتابة المشاهد والحوار وتطوير الشخصيات وبناء العوالم ونقل الأسلوب والمراجعة والتحرير. مختبرة على Llama 3.3 70B وQwen3 32B.',
    current_models_mentioned: [
      'Llama 3.3 70B',
      'Qwen3 32B',
      'Mistral Large',
    ...
    audience:
      'الروائيون وكتّاب القصص القصيرة والسينارييست ومصممو السرد في الألعاب، الذين يستخدمون النماذج اللغوية المحلية شركاءَ في الكتابة الأولى، ويبحثون عن هياكل أوامر موثوقة تُنتج مخرجات متسقة وقابلة للاستخدام.',
    readTime: '18 دقيقة قراءة',
    educationalLevel: 'Intermediate',
    primaryTerm: 'أوامر نماذج لغوية محلية للخيال الأدبي',
    targetKeywords: [
      'أوامر نماذج لغوية محلية لكتاب الخيال',
      'أوامر كتابة خيال أدبي ollama',
      'قالب أوامر مشهد نموذج لغوي',
      'أمر تطوير شخصية ذكاء اصطناعي محلي',
      'أمر حوار نموذج لغوي محلي',
      'قالب أوامر بناء عالم',
    ],
    leadAnswerBlock:
      '**أكثر تحسين ملموس في نتائج الخيال الأدبي من النموذج اللغوي المحلي يأتي من الانتقال من "اكتب مشهداً" إلى أمر مُهيكل من 5 أجزاء: النوع الأدبي + زاوية الرؤية + القيد الحسي + النبضة العاطفية + سقف عدد الكلمات. هذا الشكل وحده يُقلل المخرجات المسطحة والتلخيصية بنسبة ~60% من الناحية العملية — إذ يُنتج النموذج نثراً يُريك بدلاً من أن يُخبرك، لأن الأمر لا يترك مجالاً للهروب السهل. لتطوير الشخصيات، أكثر قالب موثوق هو "أمر التناقض": إعطاء الشخصية سمة مهيمنة وسلوكاً متناقضاً، ثم مطالبة النموذج بكتابة مشهد يكشف كليهما دون تسمية أي منهما. للحوار، حدد النص المضمر أولاً — ما يريد الشخصية قوله لكنه لن يقوله — ثم دع النموذج يكتب الجمل المنطوقة حول ذلك المعنى الخفي. للعمل التحريري، استخدم التحقق من اتساق الحبكة لاكتشاف أخطاء الاستمرارية، وتحليل الإيقاع لتحديد المناطق الرتيبة، وتوزيع الشرح لإعادة توزيع كتل المعلومات.**',
    quickAnswerTop: {
      ar: {
        question: 'ما أفضل قوالب الأوامر لكتّاب الخيال الأدبي الذين يستخدمون النماذج اللغوية المحلية؟',
        answer:
          'أكثر هيكل أوامر موثوق للخيال الأدبي هو: النوع الأدبي + زاوية الرؤية + القيد الحسي + النبضة العاطفية + سقف عدد الكلمات. ينتج هذا نثراً يُريك بدلاً من ملخص للحبكة. لتطوير الشخصيات، استخدم "أمر التناقض" (سمة مهيمنة + سلوك متناقض، كشف كليهما دون تسمية أي منهما). للحوار، حدد النص المضمر أولاً (ما تريده الشخصية لكنها لن تقوله)، ثم اكتب الجمل المنطوقة. لبناء العوالم، أرسِّخ في تفصيل حسي واحد قبل التوسع للخارج. تعمل هذه القوالب مع أي نموذج مضبوط على الإرشاد؛ النماذج الأكبر (Llama 3.3 70B وQwen3 32B) تحافظ على الالتزام بالقيود بشكل أفضل في التوليد الطويل.',
        bullets: [
          'أمر المشهد: النوع الأدبي + زاوية الرؤية + 1–2 تفاصيل حسية + نبضة عاطفية + سقف عدد الكلمات (150–400 كلمة).',
          'تطوير الشخصيات: سمة مهيمنة + سلوك متناقض، كشف كليهما دون تسمية أي منهما.',
          'الحوار: حدد النص المضمر أولاً (ما تريده الشخصية لكنها لن تقوله)، ثم ولّد الجمل المنطوقة.',
          'بناء العوالم: أرسِّخ في تفصيل حسي، توسَّع للخارج في حلقات متحدة المركز (غرفة → مبنى → حي → عالم).',
          'نقل الأسلوب: سمِّ 2–3 تقنيات محددة للكاتب المستهدف، الصق عينة جملتين، ثم ولّد باستخدام تلك التقنيات.',
          'المراجعة: الصق المسودة، سمِّ المشكلة المحددة (صوت مبني للمجهول، إفراط في الظروف، تحول زاوية رؤية)، اطلب إعادة الكتابة.',
          'التحرير: يكشف التحقق من الاتساق أخطاء الاستمرارية؛ يُعيِّن تحليل الإيقاع الفصولَ البطيئة؛ توزيع الشرح يُعيد توزيع كتل المعلومات.',
          'النماذج الأكبر تحافظ على الالتزام بالقيود بشكل أفضل؛ Llama 3.3 70B هو الخيار الافتراضي لمعظم مهام الخيال الأدبي.',
        ],
        updatedDate: '2026-05-07',
      },
    },
    toc: [
      ...
      { label: 'لماذا تهم الأوامر المُهيكلة', anchor: '#why-structure' },
      { label: 'أمثلة قبل / بعد', anchor: '#before-after' },
      { label: 'قوالب كتابة المشاهد (1–2)', anchor: '#scene-writing' },
      { label: 'قوالب تطوير الشخصيات (3–5)', anchor: '#character-development' },
      { label: 'قوالب الحوار (6–7)', anchor: '#dialogue' },
      { label: 'قوالب بناء العوالم (8–9)', anchor: '#worldbuilding' },
      { label: 'قوالب نقل الأسلوب (10–11)', anchor: '#style-transfer' },
      { label: 'قوالب المراجعة (12)', anchor: '#revision' },
      { label: 'القوالب التحريرية (13–15)', anchor: '#editorial-templates' },
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          '**الأوامر المُهيكلة تتفوق على الطلبات المفتوحة في الخيال الأدبي.** أمر مشهد من 5 أجزاء (النوع الأدبي + زاوية الرؤية + القيد الحسي + النبضة العاطفية + سقف الكلمات) يُنتج نثراً يُريك؛ "اكتب مشهداً" يُنتج ملخص حبكة. القالب هو التقنية.',
          '**أمر التناقض هو أكثر هيكل موثوق لتطوير الشخصيات.** أعطِ النموذج سمة مهيمنة وسلوكاً متناقضاً؛ اطلب منه الكشف عن كليهما دون تسمية أي منهما. ينتج هذا شخصيات ذات طبقات يجب على القارئ استنتاجها.',
          '**جودة الحوار تتضاعف حين تحدد النص المضمر قبل الجمل المنطوقة.** أخبر النموذج أولاً بما تريده الشخصية لكنها لن تقوله. تعمل الكلمات المنطوقة بعدها حول ذلك المعنى الخفي بشكل طبيعي.',
          '**حدود الكلمات تمنع الحشو.** حد 200 كلمة في أمر مشهد يُجبر على الضغط؛ النموذج يجب أن يكون دقيقاً. زِده بزيادات 100 كلمة عند الحاجة، لكن دائماً حدد سقفاً.',
          '**أوامر المراجعة تحتاج مشكلة مُسمَّاة.** "أعد كتابة هذا" يُنتج تغييراً ضئيلاً. "أعد الكتابة: احذف كل المبني للمجهول، يجب أن تبدأ كل جملة باسم ملموس أو فعل قوي" يُنتج تحسناً قابلاً للقياس.',
          '**القوالب التحريرية تعمل على مستوى المخطوطة.** التحقق من اتساق الحبكة وتحليل الإيقاع وتوزيع الشرح تعمل على المشاهد والفصول المكتملة — شغِّلها بعد الصياغة، ليس أثناءها.',
          '**النماذج الأكبر تحافظ على الالتزام بالقيود بشكل أفضل في التوليدات الطويلة.** Llama 3.3 70B وQwen3 32B يتبعان قيود مشهد 5 أجزاء بشكل موثوق؛ النماذج الأصغر تنحرف بعد ~200 رمز.',
          '**الواجهة أقل أهمية من النموذج والأمر.** Ollama وLM Studio وSillyTavern وAgnai كلها تمرر أمرك نصياً — الفرق في جودة الخيال الأدبي يكمن في النموذج + الأمر، ليس في الواجهة.',
        ],
      },
      quickFacts: {
        id: 'quick-facts',
        title: 'حقائق سريعة',
        items: [
          '**القوالب المغطاة:** 15 إجمالاً — كتابة المشاهد (2)، تطوير الشخصيات (3)، الحوار (2)، بناء العوالم (2)، نقل الأسلوب (2)، المراجعة (1)، التحرير (3).',
          '**مختبرة على:** Llama 3.3 70B وQwen3 32B وMistral Large — جميعها عبر Ollama على Apple M5 Max 64 GB وNVIDIA RTX 4090 24 GB.',
          '**حدود الكلمات:** 150–400 كلمة للمشاهد؛ 100–200 كلمة للحوار؛ 300–600 كلمة لمقاطع بناء العوالم.',
          '**أفضل نموذج عام للخيال الأدبي:** Llama 3.3 70B (اتباع تعليمات قوي، تماسك سردي، سياق طويل).',
          '**الأفضل لنقل الأسلوب:** Mistral Large (سجل نثري متسق في التوليدات الطويلة؛ يُعيد إنتاج أنماط صوت الكاتب بشكل موثوق).',
          '**الأفضل للحوار:** Command A+ أو Hermes 3 (تمييز أصوات الشخصيات؛ سجل محكي طبيعي).',
          '**أمر النظام:** حدد النوع الأدبي وزاوية الرؤية في رسالة نظام، ليس في دور المستخدم — يُرسِّخ كل توليد في الجلسة.',
        ],
      },
      whyStructure: {
        id: 'why-structure',
        title: 'لماذا تهم الأوامر المُهيكلة في الخيال الأدبي',
        content:
          '**نمط فشل النماذج اللغوية المحلية الافتراضي في الخيال الأدبي هو التلخيص: النموذج يُخبرك بما حدث بدلاً من إظهار المشهد.** يحدث هذا لأن النماذج المضبوطة على الإرشاد مُحسَّنة لإتمام المهام، ليس للانغماس السردي — والأمر الغامض ("اكتب مواجهة متوترة") يُفعِّل إرشادي التلخيص. أمر مُهيكل يُغلق هذا المسار. حين تحدد زاوية الرؤية وقيداً حسياً ونبضة عاطفية وسقف كلمات، لا يجد النموذج مساحة للتلخيص — يجب أن يُصوِّر. نمط الفشل الثانوي هو الانجراف: يبدأ النموذج بالنوع الأدبي والصوت اللذين حددتهما، ثم يعود إلى سجل كتابة ذكاء اصطناعي عام بعد 200–300 رمز. مراسي القيود (زاوية الرؤية، التركيز الحسي، سقف الكلمات) تُبطئ هذا الانجراف؛ أمر نظام يُسمي النوع الأدبي والصوت يوقفه تماماً.',
        callouts: [
          {
            type: 'tip',
            text: 'حدد النوع الأدبي وزاوية الرؤية في أمر النظام لجلسات متعددة الأدوار — انظر [أمر النظام مقابل أمر المستخدم](/ar/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference) لفهم سبب ترسيخه أفضل من التعليمات في دور المستخدم. ضع النوع الأدبي وزاوية الرؤية في رسالة النظام، ليس في دور المستخدم. كل توليد في الجلسة يرث القيد تلقائياً. مثال: "أنت مساعد خيال أدبي. كل النثر الذي تولّده مكتوب بضمير الغائب المقرَّب، الزمن الماضي، مع التركيز على التفاصيل الحسية والنص المضمر."',
          },
        ],
      },
      beforeAfter: {
        id: 'before-after',
        title: 'قبل / بعد: ما تفعله الأوامر المُهيكلة فعلاً',
        content:
          'الأزواج الثلاثة أدناه تُظهر بالضبط ما يتغير حين تنتقل من طلب غامض إلى أمر مُهيكل — كل زوج يغطي فئة قالب مختلفة ويصف المخرج الذي تحصل عليه مع كل نوع من الأوامر.',
      },
      beforeAfterScene: {
        id: 'before-after-scene',
        title: 'الزوج 1 — كتابة المشهد',
        promptExamples: [
          {
            label: '❌ أمر مشهد غامض',
            text: 'اكتب مشهد مواجهة متوترة في مطبخ.',
          },
          {
            label: '✅ أمر مشهد مُهيكل من 5 أجزاء',
            text: 'النوع الأدبي: خيال أدبي. زاوية الرؤية: ضمير الغائب المقرَّب، مايا. المرساة الحسية: رائحة القهوة المحترقة. النبضة العاطفية: تدرك مايا أن أخاها كذب — أظهر ذلك دون الإعلان عنه. سقف الكلمات: 200 كلمة.',
          },
        ],
        items: [
          '**المخرج الغامض:** 2–3 جمل ملخصة للحبكة. "واجهت مايا أخاها في المطبخ. كان التوتر بينهما واضحاً. تحرك بعصبية وأدار نظره." المشهد يُخبَر ولا يُرى. العالم الحسي غائب.',
          '**المخرج المُهيكل:** مشهد مُصوَّر بـ180 كلمة تُرسِّخ فيه رائحة القهوة المحترقة الحدثَ — ترى مايا ترسبات المرشح من ذلك الصباح، تدرك أن أخاها كان هناك حين قال إنه لم يكن، وينتهي المشهد بالتفصيل الجسدي ليديه على طاولة المطبخ. يظهر الفهم من النثر، لا من مشاعر مُعلنة.',
        ],
      },
      beforeAfterCharacter: {
        id: 'before-after-char',
        title: 'الزوج 2 — تطوير الشخصيات',
        promptExamples: [
          {
            label: '❌ أمر شخصية بقائمة سمات',
            text: 'إيلينا شجاعة وساخرة وفية.',
          },
          {
            label: '✅ أمر شخصية بالتناقض',
            text: 'إيلينا صادقة بشكل مَرَضي. تُخفي رسائل أختها عن والدتها. أظهر كليهما دون تسمية أي منهما. 200 كلمة.',
          },
        ],
        items: [
          '**المخرج بقائمة سمات:** شخصية تُوضح كل سمة بالتسلسل. "دخلت إيلينا الغرفة دون تردد — لم تخشَ شيئاً قط. \'بالطبع،\' قالت بسخرية. ستفعل أي شيء للناس الذين تحبهم." كل سمة تُوضَّح وتُشطب.',
          '**المخرج بالتناقض:** شخصية يجب على القارئ تفسيرها. إيلينا تُشير إلى الطلب الخاطئ للقهوة دون أن يطلب منها أحد (صادقة) بينما تدسّ مظروفاً في درج المطبخ قبل أن تدخل أمها (تُخفي). يجب على القارئ أن يستنتج الجرح الذي أنتج التناقض. تلك الفجوة هي الشخصية.',
        ],
      },
      beforeAfterDialogue: {
        id: 'before-after-dialogue',
        title: 'الزوج 3 — الحوار',
        promptExamples: [
          {
            label: '❌ أمر حوار مباشر',
            text: 'صديقان يتجادلان حول المال.',
          },
          {
            label: '✅ أمر حوار بالنص المضمر أولاً',
            text: 'النص المضمر: أ تريد طلب قرض من ب لكنها لن تقوله. ب يعلم لكنه يتظاهر بعدم المعرفة. 4 تبادلات، علامات "قال" فقط، لا نبضات حركية.',
          },
        ],
        items: [
          '**المخرج المباشر:** شخصيات تقول بالضبط ما تريده. "\'أنت مدين لي بمال،\' قال جيمس. \'أعلم وأنا آسف،\' قال بول." النص المضمر هو النص نفسه. لا شيء يمكن للقارئ استنتاجه.',
          '**المخرج بالنص المضمر أولاً:** أربعة تبادلات لا تذكر فيها أي شخصية المال أو القرض. يشكو (أ) من أن سيارته تحتاج إصلاحاً. يوافق (ب) على أن السيارة مشكلة. يقول (أ) ربما يتركها في الورشة بعض الوقت. يقول (ب) إن ورشته ممتلئة. الحاجة والتهرب مرئيان فقط فيما لم يُقَل.',
        ],
      },
      sceneWriting: {
        id: 'scene-writing',
        ...
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: 'أكثر أمر مشهد فعّال للنموذج اللغوي المحلي يحدد النوع الأدبي وزاوية الرؤية ومرساة حسية ونبضة عاطفية وسقف كلمات — هذه القيود الخمسة مجتمعة تُجبر النثر على الإظهار بدل الإخبار وتمنع نمط تلخيص النموذج الافتراضي.',
          },
          {
            type: 'plain-terms',
            text: 'بدلاً من "اكتب مشهد مواجهة متوترة"، جرّب: "النوع الأدبي: إثارة. زاوية الرؤية: ضمير الغائب المقرَّب، إيلينا. المرساة الحسية: طنين نظام التكييف. النبضة العاطفية: تدرك إيلينا أنها مخطئة — أظهر ذلك دون الإعلان عنه. سقف الكلمات: 200 كلمة." سيكون مخرج النموذج مشهداً محدداً لا ملخص حبكة. سقف الكلمات ليس اختيارياً — بدونه، سيحشو النموذج.',
          },
        ],
        items: [
          '**علامة النوع الأدبي** — كلمة أو عبارة واحدة (مثل: "رعب غوثي"، "غموض مريح"، "خيال علمي صلب") تُرسِّخ سجل النثر.',
          '**علامة زاوية الرؤية** — "ضمير الغائب المقرَّب، [الاسم]" أو "ضمير المتكلم" يُحدد الإطار النحوي ويُصفّي كل الملاحظات عبر وعي واحد.',
          '**المرساة الحسية** — تفصيل حسي محدد (رائحة الخرسانة المبللة، صوت ساعة، ملمس سجادة بالية) يُرسِّخ المشهد في العالم الجسدي ويمنع التجريد.',
          '**النبضة العاطفية** — سمِّ الحالة العاطفية التي يجب أن ينتهي إليها المشهد، ثم أضف "أظهر ذلك دون الإعلان عنه" — هذا يُفعِّل قيد الإظهار بدل الإخبار.',
          '**سقف الكلمات** — 150 كلمة للحظة مضغوطة؛ 250–300 كلمة لنبضة مشهد كاملة؛ 400 كلمة كحد أقصى قبل طلب مشهد ثانٍ بدل تمديد الأول.',
        ],
      },
      template1: {
        id: 'template-1',
        title: 'القالب 1 — هيكل مشهد من 5 أجزاء',
        content:
          'القالب الأساسي. العناصر الخمسة ضرورية — احذف أياً منها وتنخفض جودة المخرج بشكل قابل للقياس.',
        codeBlock: `Genre: [literary fiction / thriller / fantasy / horror / etc.]
POV: [first person / close third, character name]
Sensory anchor: [one specific sensory detail — smell, texture, sound]
Emotional beat: [what the POV character feels at the end of this scene — do not state it directly]
...
Write the scene. Do not summarise. Every sentence must render a moment, not describe one.`,
      ...
      template2: {
        id: 'template-2',
        title: 'القالب 2 — ضغط زمني للحركة / القتال',
        content:
          'يمنع النموذج من تلسكوب الحركة أو إضافة نثر تنفسي غير ضروري بين النبضات. قاعدة "ثانية واحدة لكل جملة" تفرض الدقة الميكانيكية وتحافظ على التسلسل الحركي.',
        codeBlock: `Genre: [action / thriller / fantasy combat]
POV: [close third / first person, character name]
Sensory anchor: [one physical sensation — impact, sound, texture]
Time rule: every sentence represents exactly 1 second of story time
...
Write the fight/action sequence. Enforce the time rule strictly — no sentence can span more than 1 second of story time.`,
      ...
      characterDevelopment: {
        id: 'character-development',
        title: 'قوالب تطوير الشخصيات (القوالب 3–5)',
        content:
          '**أمر التناقض يُنتج شخصيات أعمق من أي نهج قائم على قائمة سمات.** إعطاء النموذج قائمة سمات ("إيلينا شجاعة وساخرة وفية") يُنتج شخصية تُوضح تلك السمات. إعطاء النموذج سمة مهيمنة وسلوكاً متناقضاً يُنتج شخصية يجب على القارئ تفسيرها.',
        items: [
          '**سمة مهيمنة واحدة، سلوك متناقض واحد** — التناقض هو الشخصية؛ يستنتج القارئ الجرح أو التاريخ الذي أنتجه.',
          '**"لا تسمِّ أياً منهما ولا تشرح"** — هذه التعليمات تمنع النموذج من التعليق ("كانت متناقضة بطبعها…") وتُجبر المشهد على حمل المعنى.',
          '**أمر ديناميكية العلاقة:** "اكتب تبادلاً بـ200 كلمة بين [الشخصية أ] و[الشخصية ب] حيث تريد أ شيئاً X وتريد ب شيئاً Y — ولا تقول أي منهما ما تريده حقاً."',
        ],
        callouts: [
          {
            type: 'tip',
            text: 'استخدم ورقة الشخصية كأمر نظام لكامل الجلسة. أنشئ ورقة شخصية نصية بسيطة (الاسم، السمة المهيمنة، السلوك المتناقض، الجرح المركزي، سجل الكلام) وألصقها في رسالة النظام في بداية جلسة الكتابة. كل ظهور للشخصية في تلك الجلسة سيكون متسقاً. حدِّث الورقة مع تطور الشخصية عبر الفصول.',
          },
        ],
      },
      template3: {
        id: 'template-3',
        title: 'القالب 3 — أمر تناقض الشخصية',
        content:
          'أكثر هيكل موثوق لتطوير الشخصيات. يُنتج شخصيات ذات طبقات يجب على القارئ استنتاجها، بدلاً من شخصيات تُوضح قائمة سمات.',
        codeBlock: `Character name: [Name]
Dominant trait: [one trait — "relentlessly optimistic", "pathologically honest", "obsessively controlled"]
Contradicting behaviour: [one specific action that contradicts the trait — "hides her sister's letters", "lies to the one person who believes in him"]
...
Write a scene (200 words max) in which both the trait and the behaviour are present and visible. Do not name or explain either.`,
      ...
      template4: {
        id: 'template-4',
        title: 'القالب 4 — أمر عزل الصوت',
        content:
          'يعزل صوت الشخصية عن الحبكة وعلم النفس. مفيد لتأسيس سجل الكلام قبل كتابة الحوار، أو للتحقق من أن شخصية تبدو مميزة عن غيرها في نفس المخطوطة.',
        codeBlock: `Character: [Name]
Task: a mundane activity — [making coffee / waiting for a bus / washing dishes]
...
Write 5 lines of [Character]'s internal monologue during this task. Do not include plot information. Do not explain the character's psychology. Use the character's specific speech register only.`,
      ...
      template5: {
        id: 'template-5',
        title: 'القالب 5 — استخراج القصة الخلفية',
        content:
          'يُري القارئ ما شكّل الشخصية دون إظهار النسخة البالغة. القصة الخلفية المستنتجة من مشهد طفولة أكثر ديمومة من القصة الخلفية التي تُحكى.',
        codeBlock: `Character (adult version): [Name — include dominant trait and contradicting behaviour in one sentence]
...
Write a 150-word scene from [Character]'s childhood that makes their adult behaviour inevitable — but do not show the adult version of the character. Do not name the trait or explain the connection. Show the event; let the reader infer the rest.`,
      ...
      dialogue: {
        id: 'dialogue',
        title: 'قوالب الحوار (القوالب 6–7)',
        content:
          '**قالب الحوار بالنص المضمر أولاً يُنتج كلاماً طبيعياً.** معظم النماذج تُنتج افتراضياً شخصيات تقول بالضبط ما تريده — علامة واضحة على حوار مُولَّد بالذكاء الاصطناعي. تحديد النص المضمر قبل طلب الجمل المنطوقة يُجبر النموذج على بناء التهرب.',
        items: [
          '**حدد النص المضمر صراحةً** — ما تريده كل شخصية لكنها لن تقوله، ولماذا لن تقوله.',
          '**"بدون علامات حوار إلا \'قال\'"** — يُزيل عكّاز النموذج للعلامات العاطفية ("قال بغضب") ويُجبر الكلمات المنطوقة على حمل المشاعر.',
          '**"بدون نبضات حركية"** — يُزيل الشروحات الجانبية التي يستخدمها النموذج لملء فراغ الحوار ("ضمّت ذراعيها. تنهّد."). قصِّها في المراجعة.',
          '**أمر سجل النوع الأدبي:** "اكتب جدالاً من 5 تبادلات بين [علاقة] في [نوع أدبي]. الجدال سطحياً عن [موضوع أ]، لكن الجدال الحقيقي عن [موضوع ب]. لا تسمِّ الموضوع ب."',
          '**أمر المقاطعة:** "الشخصية أ في منتصف الجملة حين تقاطعها الشخصية ب. اكتب ذلك بحيث تكشف المقاطعة الحالة العاطفية لـ ب دون أن تقول ب كيف تشعر."',
        ],
        callouts: [
          {
            type: 'tip',
            text: 'لحوار متعدد الشخصيات، عيِّن لكل شخصية "سجل كلام" في أمر النظام قبل التوليد. مثال: "إيلينا: رسمية، دقيقة، لا تستخدم اختصارات. ماركوس: غير رسمي، يقاطع، يبدأ الجمل بـ\'انظر،\' أو \'المسألة هي.\'". سيحافظ النموذج على هذه السجلات دون الحاجة لتذكيره في كل دور.',
          },
        ],
      },
      template6: {
        id: 'template-6',
        title: 'القالب 6 — حوار بالنص المضمر أولاً',
        content:
          'حدد ما تريده كل شخصية لكنها لن تقوله قبل كتابة الجمل المنطوقة. يُجبر النموذج على بناء التهرب بدلاً من كتابة شخصيات تقول بالضبط ما تريده.',
        codeBlock: `Subtext (do not include this in the dialogue itself):
[Character A] wants [X] but will not ask for it directly because [reason].
[Character B] knows [X] is what A wants but pretends not to because [reason].
...
Write the dialogue. No dialogue tags except "said". No internal monologue. No action beats.`,
      ...
      template7: {
        id: 'template-7',
        title: 'القالب 7 — تمييز الصوت (3 توصيلات)',
        content:
          'تحقق مما إذا كانت أصوات الشخصيات مميزة بما يكفي للتعرف عليها دون إسناد. إذا كانت التوصيلات الثلاث تبدو متشابهة، أضف قيود سجل الكلام إلى أمر النظام قبل متابعة الجلسة.',
        codeBlock: `Piece of news: [state the news in one sentence]
...
Character 3: [Name — background and relationship to the news in one sentence]`,
      ...
      worldbuilding: {
        ...
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: 'أوامر بناء العوالم المُرسَّخة في تفصيل حسي واحد والمُهيكلة كحلقات متحدة المركز (كائن → غرفة → مبنى → شارع → حي) تُنتج وصفاً عالمياً غامراً بدلاً من فهارس موسوعية.',
          },
          {
            type: 'plain-terms',
            text: 'ابدأ بشيء صغير ومحدد — وزن عملة، رائحة مسبك، صوت بائع شارع محدد — واطلب من النموذج التوسع للخارج من هناك. توقف قبل الوصول إلى مستوى المدينة. مقاطع بناء عوالم قصيرة متعددة من مراسٍ مختلفة تبني عالماً أغنى من وصف شامل.',
          },
        ],
        items: [
          '**خصوصية المرساة** — كلما كانت المرساة أكثر تحديداً، كان العالم أكثر تحديداً. "رائحة السوق" غامضة. "رائحة الهيل والكلب المبلول من كشك البهارات في الزاوية" تُنتج عالماً محدداً.',
          '**حلقة التوقف** — أخبر النموذج أين يتوقف عن التوسع (غرفة، مبنى، حي، مدينة). بدون توقف، سيلخص العالم بأكمله.',
          '**"لا تسمِّ العالم"** — يمنع النموذج من إدراج إلقاءات معلومات ويُجبره على تصوير المشهد.',
          '**"لا تشرح التاريخ"** — يُزيل الانعكاس الموسوعي؛ التاريخ يظهر من التفاصيل لا من الشروحات.',
          '**أمر التقنية الضمنية:** "صف شارعاً في عالمك بتسمية كل جسم تلمسه شخصية في مشية 30 ثانية. بدون سرد — فقط أسماء الكائنات، بالتسلسل."',
        ],
        callouts: [
          {
            type: 'warning',
            text: 'تجنب فهارس بناء العوالم. إذا أنتج أمر بناء عالمك قائمة حقائق عن عالمك، فالأمر مجرَّد للغاية. كل استجابة ليست نثراً مُصوَّراً يجب إعادة الأمر بمرساة ملموسة. الفهارس أعراض أوامر من نوع "صف عالمي" — انتقل إلى "أرني [موقع محدد] من [زاوية رؤية محددة] في [لحظة محددة]."',
          },
        ],
      },
      template8: {
        id: 'template-8',
        title: 'القالب 8 — بناء عوالم بحلقات متحدة المركز',
        content:
          'يُرسِّخ في تفصيل حسي ويتوسع للخارج. يتجنب الفهارس الموسوعية ويُنتج وصفاً عالمياً غامراً يسكنه القارئ بدلاً من قراءته.',
        codeBlock: `Anchor: [one specific sensory detail — a smell, a sound, a texture]
POV: [observer character or omniscient]
Rings: expand from the anchor outward — object → room → building → street → district. Stop when you reach [ring level: room / building / street / district].
Word ceiling: [200–400 words]
...
Do not name the world. Do not explain the history. Show only what the POV character perceives in this moment.`,
        codeLanguage: 'نموذج بناء العالم',
      },
      template9: {
        id: 'template-9',
        title: 'القالب 9 — ثقافة الفصيل عبر الكائنات',
        content:
          'يكشف بناء العوالم عبر الثقافة المادية بدلاً من الوصف أو الشرح. ما تمتلكه الفصيلة وتستخدمه وتعرضه يخبر القارئ أكثر من أي شرح لمعتقداتها.',
        codeBlock: `Faction: [name and one-line description of their core belief or function]
...
Describe the interior of a building used by this faction — only through the objects in the room. Do not describe the people. Do not state their beliefs. Do not explain the purpose of any object. 150 words max.`,
      ...
      styleTransfer: {
        id: 'style-transfer',
        title: 'قوالب نقل الأسلوب (القوالب 10–11)',
        content:
          '**نقل الأسلوب يعمل حين تسمي التقنية لا فقط الكاتب.** "اكتب مثل كورماك مكارثي" يُنتج تقريباً عاماً — علامات ترقيم شحيحة ومواضيع غربية. "اكتب باستخدام تقنية مكارثي في الجمل الفرعية المتداخلة، فقط أسماء ملموسة، بدون علامات حوار" يُنتج شيئاً بدقة هيكلية حقيقية. للإطار الأشمل حول كيفية هيكلة الأوامر لإنتاج نتائج إبداعية محددة، انظر [إطار CRAFT](/ar/frameworks/craft).',
        items: [
          '**سمِّ التقنيات بتحديد** — "نثر موجز" غامض؛ "جمل تقريرية قصيرة، أسماء ملموسة، بدون معدِّلات" قابل للتنفيذ.',
          '**الصق عينة** — 2–3 جمل من نثر الكاتب الحقيقي تُفعِّل التعرف على الأنماط في النموذج بشكل أكثر فعالية من الوصف وحده.',
          '**"لا تقلّد العينة — أعد إنتاج التقنية"** — يمنع الاستعارة المباشرة لمقطع العينة.',
          '**نقل الزمن وزاوية الرؤية:** "أعد كتابة المقطع التالي: غيِّر من الغائب الماضي إلى المتكلم المضارع. احتفظ بجميع التفاصيل الحسية الملموسة. لا تضف معلومات حبكة جديدة. 200 كلمة كحد أقصى."',
          '**معايرة السجل:** اطلب من النموذج تسمية التقنيات التي يراها في مقطع تُقدمه قبل طلب نسخها — خطوة الاستخراج هذه تُحسِّن دقة التسمية.',
        ],
        callouts: [
          {
            type: 'tip',
            text: 'Mistral Large لنقل الأسلوب. يحافظ Mistral Large على سجل نثري متسق في التوليدات الطويلة أفضل من معظم النماذج القابلة للتشغيل محلياً. لمهام نقل الأسلوب حيث يهم اتساق السجل عبر فقرات متعددة، فضِّل Mistral Large على Llama 3.3 70B. لنقل الأسلوب في دفعات قصيرة (أقل من 300 كلمة)، أي نموذج 30B+ يعمل بشكل كافٍ.',
          },
        ],
      },
      template10: {
        id: 'template-10',
        title: 'القالب 10 — نقل الأسلوب بتقنيات مُسمَّاة',
        content:
          'يسمي تقنيات محددة بدلاً من اسم الكاتب فقط. يُنتج دقة هيكلية بدلاً من تقليد سطحي.',
        codeBlock: `Target style: [Author name]
Techniques to replicate (name 2–3 specifically):
1. [Technique — e.g., "sentence fragments for interiority"]
2. [Technique — e.g., "concrete Anglo-Saxon vocabulary, no Latinate abstractions"]
...
Now write [scene description] using these techniques. 200 words. Do not mimic the sample — replicate the technique.`,
        codeLanguage: 'نموذج نقل الأسلوب',
      },
      template11: {
        id: 'template-11',
        title: 'القالب 11 — نقل سجل النوع الأدبي',
        content:
          'ينقل النثر الموجود بين سجلات الأنواع الأدبية دون تغيير معلومات الحبكة. مفيد لإيجاد السجل المناسب لمشهد ما، أو للمراجعة حين لا يتطابق السجل مع النوع الأدبي.',
        codeBlock: `Source register: [thriller / romance / horror / literary fiction / commercial fiction / etc.]
Target register: [literary fiction / commercial fiction / genre X]
Specific changes: [longer sentences / more interiority / less action description / etc.]
...
[paste passage]`,
      ...
      revision: {
        id: 'revision',
        title: 'قوالب المراجعة (القالب 12)',
        content:
          '**أوامر المراجعة تحتاج مشكلة مُسمَّاة، لا تعليمة تحسين عامة.** "اجعل هذا أفضل" يُنتج تعديلات سطحية ضئيلة. "احذف كل البناء للمجهول؛ يجب أن تبدأ كل جملة باسم ملموس أو فعل مضارع نشط قوي" يُنتج تغييراً هيكلياً قابلاً للقياس.',
        items: [
          '**دائماً الصق المسودة، لا وصفاً لها.** أوامر المراجعة تعمل فقط حين تلصق النص الفعلي للمسودة. وصف المشكلة دون إظهار النثر يُنتج نصائح عامة بدلاً من مقطع مُعاد كتابته.',
          '**سمِّ المشكلة المحددة.** "أعد الكتابة" ليس كافياً. حدد مشكلة هيكلية: صوت مبني للمجهول، إفراط في الظروف، تحول زاوية رؤية، حشو أو إلقاء معلومات.',
          '**تصحيح تحول زاوية الرؤية:** "المقطع التالي يحتوي انتهاكات لزاوية الرؤية — نسمع أفكار شخصيات متعددة. أعد كتابته بضمير الغائب المقرَّب بشكل صارم لـ[اسم الشخصية]. احذف كل وصول داخلي لشخصيات أخرى."',
          '**تطبيع الحوار:** "الحوار التالي يبدو مكتوباً. أعد الكتابة: الشخصيات يمكنها مقاطعة بعضها، التحدث بجمل ناقصة، التحدث بشكل جانبي. احتفظ بنفس المعلومات المتبادلة."',
        ],
        callouts: [
          {
            type: 'tip',
            text: 'دائماً الصق المسودة، لا وصفاً لها. أوامر المراجعة تعمل فقط حين تلصق النص الفعلي للمسودة. الصق الفقرة أو التبادل المحدد، سمِّ المشكلة المحددة، وحدد سقف الكلمات لإعادة الكتابة.',
          },
        ],
      },
      template12: {
        id: 'template-12',
        title: 'القالب 12 — مجموعة مراجعة (ضغط، مبني للمجهول، تقليل ظروف)',
        content:
          'ثلاث تعليمات مراجعة تُسمي المشكلة المحددة. شغِّل كلاً منها بشكل منفصل — الجمع بين الثلاثة في أمر واحد يُنتج نتائج غير متسقة إذ يُعطي النموذج الأولوية لتعليمة على حساب الأخريات.',
        codeBlock: `--- COMPRESSION ---
The following scene is [N] words. Rewrite it in [N/2] words. Preserve the emotional beat and all sensory anchors. Cut dialogue tags, action beats, and transitions first:
...
[paste paragraph]`,
      ...
      editorialTemplates: {
        id: 'editorial-templates',
        title: 'القوالب التحريرية (القوالب 13–15)',
        content:
          '**القوالب التحريرية تعمل على مستوى المخطوطة بدلاً من مستوى المشهد.** تساعدك على اكتشاف أخطاء الاستمرارية قبل تراكمها، وتحديد مشاكل الإيقاع عبر فصل كامل، وإعادة توزيع الشرح المُلقى ككتل معلومات كنثر مُصوَّر. شغِّلها بعد الصياغة، ليس أثناءها.',
        callouts: [
          {
            type: 'tip',
            text: 'شغِّل القوالب التحريرية على مسودات كاملة، لا أعمال قيد الإنجاز. التحقق من اتساق الحبكة يتطلب 3 مشاهد على الأقل؛ تحليل الإيقاع يتطلب فصلاً كاملاً. تشغيلها على مقاطع غير مكتملة يُنتج نتائج إيجابية خاطئة ويُهدر نافذة السياق.',
          },
        ],
      },
      template13: {
        id: 'template-13',
        title: 'القالب 13 — التحقق من اتساق الحبكة',
        content:
          'يحدد أخطاء الاستمرارية قبل تراكمها عبر الفصول. شغِّله بعد كل 3–4 مشاهد جديدة لاكتشاف الأخطاء بينما لا تزال سهلة التصحيح.',
        codeBlock: `[paste the last 3 scenes here]
...
Output only a flag list — one sentence per flag, 150 words maximum total. Do not summarise the scenes. Do not suggest fixes. Flag only.`,
      ...
      template14: {
        id: 'template-14',
        title: 'القالب 14 — تحليل الإيقاع',
        content:
          'يُعيِّن الإيقاع عبر فصل لتحديد المناطق الرتيبة. مفيد حين يُقرأ الفصل جيداً على مستوى الجملة لكنه يبدو بطيئاً بشكل عام — علامات الإيقاع تُظهر من أين ينشأ الثقل.',
        codeBlock: `[paste chapter here]
...
No other commentary. No summaries. Diagnosis only.`,
      ...
      template15: {
        id: 'template-15',
        title: 'القالب 15 — توزيع الشرح',
        content:
          'يُعيد توزيع الشرح المُلقى ككتل معلومات عبر الحوار والحركة والتفصيل الحسي دون إضافة أو حذف أي معلومات. استخدمه حين تعمل فقرة كآلية تسليم حقائق بدلاً من مشهد.',
        codeBlock: `[paste paragraph with exposition]
...
Word ceiling: same length as the input paragraph. Do not add any new information. Do not remove any information that was in the original.`,
      ...
      models: {
        ...
        columns: ['المهمة', 'النموذج الموصى به', 'السبب'],
        rows: [
          { 'المهمة': 'كتابة المشاهد العامة', 'النموذج الموصى به': 'Llama 3.3 70B', 'السبب': 'اتباع تعليمات قوي، تماسك سردي، الخيار الأفضل للنثر المقيَّد' },
          { 'المهمة': 'نقل الأسلوب', 'النموذج الموصى به': 'Mistral Large', 'السبب': 'سجل نثري متسق في التوليدات الطويلة؛ أفضل دقة سجل بين النماذج القابلة للتشغيل محلياً' },
        ...
        callouts: [
          {
            type: 'tip',
            text: 'الحد الأدنى من متطلبات الأجهزة لنماذج الخيال الأدبي. Llama 3.3 70B مع تكميم Q4 يتطلب ~40 GB من VRAM أو ذاكرة موحدة (NVIDIA RTX 4090 24 GB على GPU مزدوج، أو Apple M5 Max 64 GB). Qwen3 32B بـQ4 يعمل بـ20–24 GB. Mistral Large بـQ4 يتطلب ~24 GB. للأجهزة ذات 16 GB، Qwen3 14B وMistral Small هما السقف العملي — كلاهما يتبع قوالب المشهد بشكل موثوق في التوليدات الأقصر.',
          },
        ],
      },
      commonMistakes: {
        ...
        title: 'أخطاء شائعة',
        items: [
          '**بدون سقف كلمات.** بدون سقف، يحشو النموذج — يضيف فقرات انتقالية ونبضات حركية وجمل ملخصة حتى ينفد من الرموز. دائماً حدد سقفاً.',
          '**قوائم سمات بدلاً من تناقضات.** قائمة من خمس سمات تُنتج شخصية تُوضح كل سمة بالتسلسل. تناقض بين سمتين يُنتج شخصية يجب على القارئ تفسيرها. استخدم هيكل التناقض.',
          '**"اكتب مثل [كاتب]" بدون أسماء تقنيات.** نقل الأسلوب باسم الكاتب فقط يُنتج تقليداً للنوع الأدبي، لا دقة التقنية. سمِّ التقنيات المحددة التي تريد نسخها.',
          '**بدون مرساة زاوية رؤية.** أمر مشهد بدون زاوية رؤية مُسمَّاة يُنتج تحولاً افتراضياً في زاوية الرؤية — النموذج يصل إلى الحالات الداخلية لجميع الشخصيات لأن لا شيء يمنعه. دائماً سمِّ شخصية زاوية الرؤية.',
          '**أوامر مراجعة بدون مسودة.** طلب تحسين "إيقاع" مشهد تصفه لكن لا تُظهره يُنتج نصائح عامة. الصق المقطع الفعلي.',
        ],
      },
      sources: {
        id: 'sources',
        title: 'المصادر',
        items: [
          'ورقة نموذج Llama 3.3 70B ومعايير اتباع التعليمات — [Meta AI Research](https://ai.meta.com)',
          'التقرير التقني لـ Qwen3 32B — [Alibaba Cloud / Qwen Team](https://qwenlm.github.io)',
          'توثيق نموذج Mistral Large — [Mistral AI](https://mistral.ai)',
          'مواصفات Command A+ — [Cohere](https://cohere.com)',
          'منهجية الضبط الدقيق لـ Hermes 3 — [Nous Research](https://nousresearch.com)',
        ],
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          {
            q: 'هل يمكن للنموذج اللغوي المحلي أن يحل محل شريك كتابة بشري في صياغة الخيال الأدبي؟',
            a: 'لمهام محددة — توليد مسودة أولى لمشهد، إنتاج تنويعات حوار، تفاصيل بناء العوالم — النماذج اللغوية المحلية شركاء صياغة سريعون وموثوقون. لا تُحل محل التفكير الاستراتيجي لشريك كتابة بشري: لا تستطيع تقييم ما إذا كان المشهد يناسب قوس القصة، وما إذا كان اختيار الشخصية مكتسباً عاطفياً، أو ما إذا كان إيقاع الفصل يعمل. استخدمها لمهام التوليد؛ احتفظ بالحكم البشري للقرارات الهيكلية.',
          },
          {
            q: 'ما الأفضل لكتابة الخيال الأدبي: Ollama أم LM Studio أم SillyTavern؟',
            a: 'لقوالب الأوامر المُهيكلة حيث ترسل أمراً كاملاً وتتلقى توليداً، Ollama (CLI أو API) وLM Studio (نقطة نهاية متوافقة مع OpenAI) متكافئان — الواجهة لا تؤثر على جودة المخرج. يضيف SillyTavern قيمة لرواية الأدوار متعددة الأدوار والحفاظ على بطاقات الشخصيات، لكن لأوامر كتابة المشاهد والمراجعة، واجهة دردشة بسيطة أو استدعاء API كافٍ.',
          },
          {
            q: 'هل تعمل قوالب الأوامر هذه مع النماذج الأصغر (7B–14B)؟',
            a: 'نعم، لكن الالتزام بالقيود يتدهور بعد ~150 رمزاً. النماذج الأصغر تتبع أول 2–3 قيود في أمر 5 أجزاء، ثم تنجرف نحو سجلها الأساسي. للنماذج 7B–14B: قلل سقف الكلمات (150 كلمة كحد أقصى)، استخدم قيوداً أقل في وقت واحد (3 أجزاء بدلاً من 5)، وتوقع مراجعة أو إعادة أمر أكثر تكراراً. Qwen3 14B هو أقوى نموذج صغير تم اختباره لاتباع الأوامر الخاصة بالخيال الأدبي.',
          },
          {
            q: 'كيف أحافظ على اتساق صوت الشخصية عبر جلسة رواية كاملة؟',
            a: 'أنشئ ورقة شخصية نصية بسيطة (الاسم، السمة المهيمنة، السلوك المتناقض، سجل الكلام، 3 أسطر حوار مثالية) وألصقها في رسالة النظام في بداية الجلسة. للجلسات الطويلة، لخص المشاهد المكتملة في وثيقة "سياق الجلسة" المستمرة وأدرج آخر 200–300 كلمة من أحدث مشهد في كل دور مستخدم. هذا يُقاوم انجراف السياق دون تجاوز نافذة السياق.',
          },
          {
          ...
          },
          {
            ...
            a: 'نعم. جميع القوالب في هذا الدليل نصوص بسيطة — تعمل في أي واجهة تمرر النص إلى نموذج محلي. في SillyTavern، ضع قيد النوع الأدبي وزاوية الرؤية في حقل أمر النظام؛ استخدم دور المستخدم للتعليمات المحددة للمشهد. في Agnai، الإعداد مكافئ. القوالب مستقلة عن الواجهة.',
          },
          {
            q: 'ما الطول المناسب لأمر المشهد؟',
            a: 'أمر مشهد من 50–100 كلمة يُنتج أفضل النتائج من الناحية العملية. الأوامر الأطول (200+ كلمة) يمكن أن تعمل للمشاهد المعقدة لكنها تزيد احتمال تجاهل النموذج لبعض القيود. للمشاهد المعقدة، قسِّم الأمر إلى مرحلتين: ولِّد المشهد أولاً، ثم شغِّل أمر مراجعة يضيف القيد الذي احتجزته.',
          },
          {
            q: 'هل أوامر نقل الأسلوب تنتهك حقوق النشر؟',
            a: 'نسخ تقنية الكاتب (هيكل الجملة، اختيارات الترقيم، السجل السردي) لا يُعد انتهاكاً لحقوق النشر — الأسلوب لا تحميه حقوق النشر. نسخ مقاطع نصية مطوَّلة من نص محمي بحقوق النشر يُعد انتهاكاً. تستخدم قوالب هذا الدليل عينات من 2–3 جمل كمراسٍ تقنية، وهو ما يقع ضمن الاستخدام التعليمي العادل القياسي، والمخرج المُولَّد يُعيد إنتاج التقنية لا المحتوى.',
          },
        ],
      },
      relatedReading: {
        ...
        items: [
          '[أفضل النماذج اللغوية المحلية للكتابة الإبداعية 2026](/ar/power-local-llm/best-local-llm-creative-writing-2026) — مقارنة النماذج لتوليد السرد وإعدادات أخذ العينات وخيارات غير المقيَّدة.',
          '[SillyTavern مقابل Agnai مقابل RisuAI: أفضل واجهة لعب أدوار محلية](/ar/power-local-llm/sillytavern-vs-agnai-vs-risuai-roleplay) — مقارنة الواجهات للعب الأدوار ببطاقات الشخصيات والخيال التعاوني.',
          '[كيفية تشغيل نموذج لغوي محلي لكتابة السيناريوهات ومسودات الروايات](/ar/power-local-llm/local-llm-screenwriting-and-novel-drafting) — سير عمل الكتابة طويلة الشكل وإدارة الفصول واستراتيجيات نافذة السياق.',
          '[النماذج اللغوية المحلية غير المقيَّدة للكتابة الإبداعية: الأخلاقيات والإعداد](/ar/power-local-llm/uncensored-local-llm-creative-writing-ethics) — أي النماذج تستخدم للمحتوى الناضج وانعكاسات الخصوصية وإطار الاستخدام المسؤول.',
          '[شرح الأوامر بسلسلة التفكير](/ar/prompt-engineering/chain-of-thought-prompting) — أوامر التفكير المُهيكل التي تنطبق على بناء حبكة الخيال الأدبي وتخطيط المشاهد.',
          '[الأوامر الصفرية مقابل أوامر القليل من الأمثلة](/ar/prompt-engineering/zero-shot-vs-few-shot) — متى تدرج أمثلة في الأوامر ومتى تحذفها لمهام الخيال الأدبي.',
        ],
      },
    },
      schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      headline: 'أوامر النماذج اللغوية المحلية لكتّاب الخيال الأدبي: 15 قالباً وتقنية (2026)',
      description: '15 قالب أوامر لكتّاب الخيال الأدبي باستخدام النماذج اللغوية المحلية. كتابة المشاهد وتطوير الشخصيات والحوار وبناء العوالم ونقل الأسلوب والمراجعة والقوالب التحريرية — جاهزة للنسخ في Ollama وLM Studio.',
      url: 'https://www.promptquorum.com/ar/power-local-llm/local-llm-prompts-for-fiction-writers',
      inLanguage: 'ar',
    ...
    sections: {
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**대화 최고:** Command A+ 또는 Hermes 3 (인물 목소리 차별화; 자연스러운 구어체 레지스터).',
...
Word ceiling: same length as the input paragraph. Do not add any new information. Do not remove any information that was in the original.`,
      ...
      sources: {
        ...
        items: [
          ...
          'Command A+ 사양 — [Cohere](https://cohere.com)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Zero-Shot vs Few-Shot 프롬프팅](/ko/prompt-engineering/zero-shot-vs-few-shot) — 소설 작업에서 프롬프트에 예시를 포함할 때와 생략할 때.',
        ],
      },
    },
    schema: {
