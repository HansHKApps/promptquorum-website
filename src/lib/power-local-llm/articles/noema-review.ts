    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Le répertoire complet des logiciels de LLM local](/fr/directory) — un répertoire plus large d\'outils de LLM local sur toutes les plateformes.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[本地 LLM 软件完整目录](/zh/directory) —— 涵盖各平台本地 LLM 工具的更广泛目录。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[دليل برمجيات LLM المحلية الكامل](/ar/directory) — دليل أوسع لأدوات LLM المحلية عبر جميع المنصات.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[로컬 LLM 소프트웨어 전체 디렉터리](/ko/directory) — 모든 플랫폼에 걸친 로컬 LLM 도구의 더 넓은 디렉터리.',
        ],
      },
    },
  },
