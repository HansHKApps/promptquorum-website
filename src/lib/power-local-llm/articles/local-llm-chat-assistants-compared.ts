  ...
  en: {
    ...
    sections: {
      ...
      desktopDifferences: {
        ...
        items: [
          '**Runs models itself.** [AnythingLLM](/power-local-llm/anythingllm-review), [Ekorbia](/power-local-llm/ekorbia-review), [GPT4All](/power-local-llm/gpt4all-review), [HilbertRaum](/power-local-llm/hilbertraum-review), [Jan](/power-local-llm/jan-review), [LM Studio](/power-local-llm/lm-studio-review), [Off Grid AI](/power-local-llm/off-grid-ai-review), [On Device AI](/power-local-llm/on-device-ai-review), [Osaurus](/power-local-llm/osaurus-ai-review) and [Sidekick](/power-local-llm/sidekick-review) document running models on their own, without a separate server.',
          ...
          '**Chat with your files.** [AnythingLLM](/power-local-llm/anythingllm-review), [BoltAI](/power-local-llm/boltai-review), [Ekorbia](/power-local-llm/ekorbia-review), [GPT4All](/power-local-llm/gpt4all-review), [HilbertRaum](/power-local-llm/hilbertraum-review), [Locally Uncensored](/power-local-llm/locally-uncensored-review), [Off Grid AI](/power-local-llm/off-grid-ai-review), [On Device AI](/power-local-llm/on-device-ai-review), [Osaurus](/power-local-llm/osaurus-ai-review) and [Sidekick](/power-local-llm/sidekick-review) document chatting with your own files.',
  ...
  de: {
    ...
    sections: {
      ...
      desktopDifferences: {
        ...
        items: [
          '**Führt Modelle selbst aus.** [AnythingLLM](/de/power-local-llm/anythingllm-review), [Ekorbia](/de/power-local-llm/ekorbia-review), [GPT4All](/de/power-local-llm/gpt4all-review), [HilbertRaum](/de/power-local-llm/hilbertraum-review), [Jan](/de/power-local-llm/jan-review), [LM Studio](/de/power-local-llm/lm-studio-review), [Off Grid AI](/de/power-local-llm/off-grid-ai-review), [On Device AI](/de/power-local-llm/on-device-ai-review), [Osaurus](/de/power-local-llm/osaurus-ai-review) und [Sidekick](/de/power-local-llm/sidekick-review) dokumentieren den eigenständigen Modellbetrieb ohne separaten Server.',
          ...
          '**Chat mit Ihren Dateien.** [AnythingLLM](/de/power-local-llm/anythingllm-review), [BoltAI](/de/power-local-llm/boltai-review), [Ekorbia](/de/power-local-llm/ekorbia-review), [GPT4All](/de/power-local-llm/gpt4all-review), [HilbertRaum](/de/power-local-llm/hilbertraum-review), [Locally Uncensored](/de/power-local-llm/locally-uncensored-review), [Off Grid AI](/de/power-local-llm/off-grid-ai-review), [On Device AI](/de/power-local-llm/on-device-ai-review), [Osaurus](/de/power-local-llm/osaurus-ai-review) und [Sidekick](/de/power-local-llm/sidekick-review) dokumentieren den Chat mit den eigenen Dateien.',
  ...
  fr: {
    ...
    sections: {
      ...
      desktopDifferences: {
        ...
        items: [
          '**Exécute les modèles lui-même.** [AnythingLLM](/fr/power-local-llm/anythingllm-review), [Ekorbia](/fr/power-local-llm/ekorbia-review), [GPT4All](/fr/power-local-llm/gpt4all-review), [HilbertRaum](/fr/power-local-llm/hilbertraum-review), [Jan](/fr/power-local-llm/jan-review), [LM Studio](/fr/power-local-llm/lm-studio-review), [Off Grid AI](/fr/power-local-llm/off-grid-ai-review), [On Device AI](/fr/power-local-llm/on-device-ai-review), [Osaurus](/fr/power-local-llm/osaurus-ai-review) et [Sidekick](/fr/power-local-llm/sidekick-review) documentent l\'exécution autonome de modèles, sans serveur séparé.',
          ...
          '**Chat avec vos fichiers.** [AnythingLLM](/fr/power-local-llm/anythingllm-review), [BoltAI](/fr/power-local-llm/boltai-review), [Ekorbia](/fr/power-local-llm/ekorbia-review), [GPT4All](/fr/power-local-llm/gpt4all-review), [HilbertRaum](/fr/power-local-llm/hilbertraum-review), [Locally Uncensored](/fr/power-local-llm/locally-uncensored-review), [Off Grid AI](/fr/power-local-llm/off-grid-ai-review), [On Device AI](/fr/power-local-llm/on-device-ai-review), [Osaurus](/fr/power-local-llm/osaurus-ai-review) et [Sidekick](/fr/power-local-llm/sidekick-review) documentent le chat avec vos propres fichiers.',
  ...
  es: {
    ...
    sections: {
      ...
      desktopDifferences: {
        ...
        items: [
          '**Ejecuta los modelos por sí misma.** [AnythingLLM](/es/power-local-llm/anythingllm-review), [Ekorbia](/es/power-local-llm/ekorbia-review), [GPT4All](/es/power-local-llm/gpt4all-review), [HilbertRaum](/es/power-local-llm/hilbertraum-review), [Jan](/es/power-local-llm/jan-review), [LM Studio](/es/power-local-llm/lm-studio-review), [Off Grid AI](/es/power-local-llm/off-grid-ai-review), [On Device AI](/es/power-local-llm/on-device-ai-review), [Osaurus](/es/power-local-llm/osaurus-ai-review) y [Sidekick](/es/power-local-llm/sidekick-review) documentan la ejecución de modelos por sí mismas, sin un servidor aparte.',
          ...
          '**Chat con tus archivos.** [AnythingLLM](/es/power-local-llm/anythingllm-review), [BoltAI](/es/power-local-llm/boltai-review), [Ekorbia](/es/power-local-llm/ekorbia-review), [GPT4All](/es/power-local-llm/gpt4all-review), [HilbertRaum](/es/power-local-llm/hilbertraum-review), [Locally Uncensored](/es/power-local-llm/locally-uncensored-review), [Off Grid AI](/es/power-local-llm/off-grid-ai-review), [On Device AI](/es/power-local-llm/on-device-ai-review), [Osaurus](/es/power-local-llm/osaurus-ai-review) y [Sidekick](/es/power-local-llm/sidekick-review) documentan el chat con tus propios archivos.',
  ...
  ja: {
    ...
    sections: {
      ...
      desktopDifferences: {
        ...
        items: [
          '**モデルの自力実行。**[AnythingLLM](/ja/power-local-llm/anythingllm-review)、[Ekorbia](/ja/power-local-llm/ekorbia-review)、[GPT4All](/ja/power-local-llm/gpt4all-review)、[HilbertRaum](/ja/power-local-llm/hilbertraum-review)、[Jan](/ja/power-local-llm/jan-review)、[LM Studio](/ja/power-local-llm/lm-studio-review)、[Off Grid AI](/ja/power-local-llm/off-grid-ai-review)、[On Device AI](/ja/power-local-llm/on-device-ai-review)、[Osaurus](/ja/power-local-llm/osaurus-ai-review)と[Sidekick](/ja/power-local-llm/sidekick-review)は、別のサーバーなしでモデルを自力で実行できると記載しています。',
          ...
          '**ファイルとのチャット。**[AnythingLLM](/ja/power-local-llm/anythingllm-review)、[BoltAI](/ja/power-local-llm/boltai-review)、[Ekorbia](/ja/power-local-llm/ekorbia-review)、[GPT4All](/ja/power-local-llm/gpt4all-review)、[HilbertRaum](/ja/power-local-llm/hilbertraum-review)、[Locally Uncensored](/ja/power-local-llm/locally-uncensored-review)、[Off Grid AI](/ja/power-local-llm/off-grid-ai-review)、[On Device AI](/ja/power-local-llm/on-device-ai-review)、[Osaurus](/ja/power-local-llm/osaurus-ai-review)と[Sidekick](/ja/power-local-llm/sidekick-review)は、自分のファイルとのチャットを記載しています。',
  ...
  pt: {
    ...
    sections: {
      ...
      desktopDifferences: {
        ...
        items: [
          '**Executa modelos por conta própria.** [AnythingLLM](/pt/power-local-llm/anythingllm-review), [Ekorbia](/pt/power-local-llm/ekorbia-review), [GPT4All](/pt/power-local-llm/gpt4all-review), [HilbertRaum](/pt/power-local-llm/hilbertraum-review), [Jan](/pt/power-local-llm/jan-review), [LM Studio](/pt/power-local-llm/lm-studio-review), [Off Grid AI](/pt/power-local-llm/off-grid-ai-review), [On Device AI](/pt/power-local-llm/on-device-ai-review), [Osaurus](/pt/power-local-llm/osaurus-ai-review) e [Sidekick](/pt/power-local-llm/sidekick-review) documentam a execução de modelos por conta própria, sem um servidor separado.',
          ...
          '**Chat com seus arquivos.** [AnythingLLM](/pt/power-local-llm/anythingllm-review), [BoltAI](/pt/power-local-llm/boltai-review), [Ekorbia](/pt/power-local-llm/ekorbia-review), [GPT4All](/pt/power-local-llm/gpt4all-review), [HilbertRaum](/pt/power-local-llm/hilbertraum-review), [Locally Uncensored](/pt/power-local-llm/locally-uncensored-review), [Off Grid AI](/pt/power-local-llm/off-grid-ai-review), [On Device AI](/pt/power-local-llm/on-device-ai-review), [Osaurus](/pt/power-local-llm/osaurus-ai-review) e [Sidekick](/pt/power-local-llm/sidekick-review) documentam a conversa com seus próprios arquivos.',
  ...
  ar: {
    ...
    sections: {
      ...
      desktopDifferences: {
        ...
        items: [
          '**تشغيل النماذج بنفسها.** [AnythingLLM](/ar/power-local-llm/anythingllm-review)، [Ekorbia](/ar/power-local-llm/ekorbia-review)، [GPT4All](/ar/power-local-llm/gpt4all-review)، [HilbertRaum](/ar/power-local-llm/hilbertraum-review)، [Jan](/ar/power-local-llm/jan-review)، [LM Studio](/ar/power-local-llm/lm-studio-review)، [Off Grid AI](/ar/power-local-llm/off-grid-ai-review)، [On Device AI](/ar/power-local-llm/on-device-ai-review)، [Osaurus](/ar/power-local-llm/osaurus-ai-review) و[Sidekick](/ar/power-local-llm/sidekick-review) توثّق تشغيل النماذج بنفسها دون خادم منفصل.',
          ...
          '**الدردشة مع ملفاتك.** [AnythingLLM](/ar/power-local-llm/anythingllm-review)، [BoltAI](/ar/power-local-llm/boltai-review)، [Ekorbia](/ar/power-local-llm/ekorbia-review)، [GPT4All](/ar/power-local-llm/gpt4all-review)، [HilbertRaum](/ar/power-local-llm/hilbertraum-review)، [Locally Uncensored](/ar/power-local-llm/locally-uncensored-review)، [Off Grid AI](/ar/power-local-llm/off-grid-ai-review)، [On Device AI](/ar/power-local-llm/on-device-ai-review)، [Osaurus](/ar/power-local-llm/osaurus-ai-review) و[Sidekick](/ar/power-local-llm/sidekick-review) توثّق الدردشة مع ملفاتك الخاصة.',
  ...
  ko: {
    ...
    sections: {
      ...
      desktopDifferences: {
        ...
        items: [
          '**자체 모델 실행.** [AnythingLLM](/ko/power-local-llm/anythingllm-review), [Ekorbia](/ko/power-local-llm/ekorbia-review), [GPT4All](/ko/power-local-llm/gpt4all-review), [HilbertRaum](/ko/power-local-llm/hilbertraum-review), [Jan](/ko/power-local-llm/jan-review), [LM Studio](/ko/power-local-llm/lm-studio-review), [Off Grid AI](/ko/power-local-llm/off-grid-ai-review), [On Device AI](/ko/power-local-llm/on-device-ai-review), [Osaurus](/ko/power-local-llm/osaurus-ai-review) 및 [Sidekick](/ko/power-local-llm/sidekick-review)는 별도의 서버 없이 자체적으로 모델을 실행하는 것을 문서화하고 있습니다.',
          ...
          '**파일과의 채팅.** [AnythingLLM](/ko/power-local-llm/anythingllm-review), [BoltAI](/ko/power-local-llm/boltai-review), [Ekorbia](/ko/power-local-llm/ekorbia-review), [GPT4All](/ko/power-local-llm/gpt4all-review), [HilbertRaum](/ko/power-local-llm/hilbertraum-review), [Locally Uncensored](/ko/power-local-llm/locally-uncensored-review), [Off Grid AI](/ko/power-local-llm/off-grid-ai-review), [On Device AI](/ko/power-local-llm/on-device-ai-review), [Osaurus](/ko/power-local-llm/osaurus-ai-review) 및 [Sidekick](/ko/power-local-llm/sidekick-review)는 자신의 파일과 채팅하는 기능을 문서화하고 있습니다.',
