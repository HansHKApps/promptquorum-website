    ...
    sections: {
      ...
      desktopApps: {
        ...
        rows: [
          ...
          { 'Tool': '**h2oGPT**', 'Link': '[github.com/h2oai/h2ogpt](https://github.com/h2oai/h2ogpt)', 'Description': 'Enterprise-feature-heavy desktop and server', 'License': 'Apache 2.0', 'Stars': '12k'},
    ...
    sections: {
      ...
      desktopApps: {
        ...
        rows: [
          ...
          { 'Tool': '**h2oGPT**', 'Link': '[github.com/h2oai/h2ogpt](https://github.com/h2oai/h2ogpt)', 'Beschreibung': 'Funktionsreiche Enterprise-Desktop- und Serveranwendung', 'Lizenz': 'Apache 2.0', 'Sterne': '12k'},
    ...
    sections: {
      ...
      desktopApps: {
        ...
        rows: [
          ...
          { 'Tool': '**h2oGPT**', 'Link': '[github.com/h2oai/h2ogpt](https://github.com/h2oai/h2ogpt)', 'Description': 'Application bureau et serveur riche en fonctionnalités enterprise', 'Licence': 'Apache 2.0', 'Étoiles': '12k'},
    ...
    sections: {
      ...
      desktopApps: {
        ...
        rows: [
          ...
          { 'Tool': '**h2oGPT**', 'Link': '[github.com/h2oai/h2ogpt](https://github.com/h2oai/h2ogpt)', '概要': 'エンタープライズ機能が充実したデスクトップ・サーバーアプリ', 'ライセンス': 'Apache 2.0', 'スター': '12k'},
    ...
    sections: {
      ...
      desktopApps: {
        ...
        rows: [
          ...
          { 'Tool': '**h2oGPT**', 'Link': '[github.com/h2oai/h2ogpt](https://github.com/h2oai/h2ogpt)', '描述': '企业功能丰富的桌面与服务器方案', '许可证': 'Apache 2.0', '星标': '12k'},
    ...
    sections: {
      ...
      desktopApps: {
        ...
        rows: [
          ...
          { 'Tool': '**h2oGPT**', 'Link': '[github.com/h2oai/h2ogpt](https://github.com/h2oai/h2ogpt)', 'Descripción': 'Escritorio y servidor con muchas funciones enterprise', 'Licencia': 'Apache 2.0', 'Estrellas': '12k'},
    ...
    sections: {
      ...
      desktopApps: {
        ...
        rows: [
          ...
          { 'Ferramenta': '**h2oGPT**', 'Link': '[github.com/h2oai/h2ogpt](https://github.com/h2oai/h2ogpt)', 'Descrição': 'Desktop e servidor com muitos recursos enterprise', 'Licença': 'Apache 2.0', 'Estrelas': '12k'},
    ...
    sections: {
      ...
      desktopApps: {
        ...
        rows: [
          ...
          { 'الأداة': '**h2oGPT**', 'الرابط': '[github.com/h2oai/h2ogpt](https://github.com/h2oai/h2ogpt)', 'الوصف': 'سطح مكتب وخادم مع ميزات مؤسسية كثيرة', 'الترخيص': 'Apache 2.0', 'النجوم': '12k'},
    ...
    sections: {
      ...
      desktopApps: {
        ...
        rows: [
          ...
          { '도구': '**h2oGPT**', '링크': '[github.com/h2oai/h2ogpt](https://github.com/h2oai/h2ogpt)', '설명': '많은 엔터프라이즈 기능을 갖춘 데스크톱 및 서버', '라이선스': 'Apache 2.0', '스타': '12k'},
