...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'أدوات النماذج اللغوية المحلية 2026: دليل 87 تطبيق + آخر التحديثات',
    affiliateDisclosure: true,
    intro:
    ...
    metaDescription:
      '87 أداة لتشغيل النماذج اللغوية محلياً: Ollama وLM Studio وGPT4All وJan.ai إضافة للمحمول وRAG والصوت وأطر العملاء. التراخيص والروابط وأحدث الإصدارات. محدَّث في يونيو 2026.',
    twitterDescription:
