...
embeddings.save("index_path")`,
      ...
      comparisonTable: {
        ...
        columns: ['Tool', 'Link', 'Architecture', 'Deployment', 'License', 'Best For'],
        rows: [
          { 'Tool': 'txtai', 'Link': '[github.com/neuml/txtai](https://github.com/neuml/txtai)', 'Architecture': 'Embedded vector DB + RAG/agents', 'Deployment': 'In-process, no server', 'License': 'Apache 2.0', 'Best For': 'Single-package Python RAG & agents' },
          { 'Tool': 'Chroma', 'Link': '[trychroma.com](https://www.trychroma.com)', 'Architecture': 'Vector database', 'Deployment': 'Embedded or server mode', 'License': 'Apache 2.0', 'Best For': 'Simple prototyping vector store' },
          { 'Tool': 'Qdrant', 'Link': '[qdrant.tech](https://qdrant.tech)', 'Architecture': 'Vector database', 'Deployment': 'Server (Docker/cloud)', 'License': 'Apache 2.0', 'Best For': 'Scaled, multi-client production search' },
          { 'Tool': 'LlamaIndex', 'Link': '[llamaindex.ai](https://llamaindex.ai)', 'Architecture': 'RAG/orchestration framework', 'Deployment': 'Needs external vector store', 'License': 'MIT', 'Best For': 'Data connectors atop any vector DB' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Best Vector Database 2026: Qdrant vs Pinecone vs Weaviate vs Chroma](/local-llms/best-vector-database-2026) — standalone vector database services for when an embedded index does not fit.',
        ],
      },
    },
  },
...
embeddings.save("index_path")`,
      ...
      comparisonTable: {
        ...
        columns: ['Tool', 'Link', 'Architektur', 'Deployment', 'Lizenz', 'Am besten für'],
        rows: [
          { 'Tool': 'txtai', 'Link': '[github.com/neuml/txtai](https://github.com/neuml/txtai)', 'Architektur': 'Eingebettete Vektor-DB + RAG/Agenten', 'Deployment': 'In-Process, kein Server', 'Lizenz': 'Apache 2.0', 'Am besten für': 'Ein Python-Paket für RAG & Agenten' },
          { 'Tool': 'Chroma', 'Link': '[trychroma.com](https://www.trychroma.com)', 'Architektur': 'Vektordatenbank', 'Deployment': 'Eingebettet oder Server-Modus', 'Lizenz': 'Apache 2.0', 'Am besten für': 'Einfacher Prototyp-Vektorspeicher' },
          { 'Tool': 'Qdrant', 'Link': '[qdrant.tech](https://qdrant.tech)', 'Architektur': 'Vektordatenbank', 'Deployment': 'Server (Docker/Cloud)', 'Lizenz': 'Apache 2.0', 'Am besten für': 'Skalierte Produktionssuche für viele Clients' },
          { 'Tool': 'LlamaIndex', 'Link': '[llamaindex.ai](https://llamaindex.ai)', 'Architektur': 'RAG-/Orchestrierungs-Framework', 'Deployment': 'Braucht externen Vektorspeicher', 'Lizenz': 'MIT', 'Am besten für': 'Datenanbindung auf jeder Vektor-DB' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Beste Vektordatenbank 2026: Qdrant vs Pinecone vs Weaviate vs Chroma](/de/local-llms/best-vector-database-2026) — eigenständige Vektordatenbank-Dienste, falls ein eingebetteter Index nicht ausreicht.',
        ],
      },
    },
  },
...
embeddings.save("index_path")`,
      ...
      comparisonTable: {
        ...
        columns: ['Outil', 'Lien', 'Architecture', 'Déploiement', 'Licence', 'Idéal pour'],
        rows: [
          { 'Outil': 'txtai', 'Lien': '[github.com/neuml/txtai](https://github.com/neuml/txtai)', 'Architecture': 'Base vectorielle embarquée + RAG/agents', 'Déploiement': 'In-process, sans serveur', 'Licence': 'Apache 2.0', 'Idéal pour': 'RAG et agents Python en un paquet' },
          { 'Outil': 'Chroma', 'Lien': '[trychroma.com](https://www.trychroma.com)', 'Architecture': 'Base vectorielle', 'Déploiement': 'Mode embarqué ou serveur', 'Licence': 'Apache 2.0', 'Idéal pour': 'Stockage vectoriel de prototypage simple' },
          { 'Outil': 'Qdrant', 'Lien': '[qdrant.tech](https://qdrant.tech)', 'Architecture': 'Base vectorielle', 'Déploiement': 'Serveur (Docker/cloud)', 'Licence': 'Apache 2.0', 'Idéal pour': 'Recherche multi-clients en production' },
          { 'Outil': 'LlamaIndex', 'Lien': '[llamaindex.ai](https://llamaindex.ai)', 'Architecture': 'Framework RAG/orchestration', 'Déploiement': 'Nécessite un stockage externe', 'Licence': 'MIT', 'Idéal pour': 'Connecteurs de données sur toute base vectorielle' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Meilleure base vectorielle 2026 : Qdrant vs Pinecone vs Weaviate vs Chroma](/fr/local-llms/best-vector-database-2026) — services de bases vectorielles autonomes pour quand un index embarqué ne suffit pas.',
        ],
      },
    },
  },
...
embeddings.save("index_path")`,
      ...
      comparisonTable: {
        ...
        columns: ['Herramienta', 'Enlace', 'Arquitectura', 'Despliegue', 'Licencia', 'Ideal para'],
        rows: [
          { 'Herramienta': 'txtai', 'Enlace': '[github.com/neuml/txtai](https://github.com/neuml/txtai)', 'Arquitectura': 'BD vectorial embebida + RAG/agentes', 'Despliegue': 'In-process, sin servidor', 'Licencia': 'Apache 2.0', 'Ideal para': 'RAG y agentes Python en un paquete' },
          { 'Herramienta': 'Chroma', 'Enlace': '[trychroma.com](https://www.trychroma.com)', 'Arquitectura': 'Base de datos vectorial', 'Despliegue': 'Modo embebido o servidor', 'Licencia': 'Apache 2.0', 'Ideal para': 'Almacén vectorial de prototipado simple' },
          { 'Herramienta': 'Qdrant', 'Enlace': '[qdrant.tech](https://qdrant.tech)', 'Arquitectura': 'Base de datos vectorial', 'Despliegue': 'Servidor (Docker/nube)', 'Licencia': 'Apache 2.0', 'Ideal para': 'Búsqueda de producción multi-cliente' },
          { 'Herramienta': 'LlamaIndex', 'Enlace': '[llamaindex.ai](https://llamaindex.ai)', 'Arquitectura': 'Framework RAG/orquestación', 'Despliegue': 'Necesita almacén externo', 'Licencia': 'MIT', 'Ideal para': 'Conectores de datos sobre cualquier BD vectorial' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Mejor base de datos vectorial 2026: Qdrant vs Pinecone vs Weaviate vs Chroma](/es/local-llms/best-vector-database-2026) — servicios de bases de datos vectoriales independientes para cuando un índice embebido no basta.',
        ],
      },
    },
  },
...
embeddings.save("index_path")`,
      ...
      comparisonTable: {
        ...
        columns: ['Ferramenta', 'Link', 'Arquitetura', 'Implantação', 'Licença', 'Ideal para'],
        rows: [
          { 'Ferramenta': 'txtai', 'Link': '[github.com/neuml/txtai](https://github.com/neuml/txtai)', 'Arquitetura': 'BD vetorial embutido + RAG/agentes', 'Implantação': 'In-process, sem servidor', 'Licença': 'Apache 2.0', 'Ideal para': 'RAG e agentes Python em um pacote' },
          { 'Ferramenta': 'Chroma', 'Link': '[trychroma.com](https://www.trychroma.com)', 'Arquitetura': 'Banco de dados vetorial', 'Implantação': 'Modo embutido ou servidor', 'Licença': 'Apache 2.0', 'Ideal para': 'Armazenamento vetorial de prototipagem simples' },
          { 'Ferramenta': 'Qdrant', 'Link': '[qdrant.tech](https://qdrant.tech)', 'Arquitetura': 'Banco de dados vetorial', 'Implantação': 'Servidor (Docker/nuvem)', 'Licença': 'Apache 2.0', 'Ideal para': 'Busca de produção multi-cliente' },
          { 'Ferramenta': 'LlamaIndex', 'Link': '[llamaindex.ai](https://llamaindex.ai)', 'Arquitetura': 'Framework RAG/orquestração', 'Implantação': 'Precisa de armazenamento externo', 'Licença': 'MIT', 'Ideal para': 'Conectores de dados sobre qualquer BD vetorial' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Melhor banco de dados vetorial 2026: Qdrant vs Pinecone vs Weaviate vs Chroma](/pt/local-llms/best-vector-database-2026) — serviços de bancos de dados vetoriais independentes para quando um índice embutido não é suficiente.',
        ],
      },
    },
  },
...
embeddings.save("index_path")`,
      ...
      comparisonTable: {
        ...
        columns: ['ツール', 'リンク', 'アーキテクチャ', 'デプロイ', 'ライセンス', '最適な用途'],
        rows: [
          { 'ツール': 'txtai', 'リンク': '[github.com/neuml/txtai](https://github.com/neuml/txtai)', 'アーキテクチャ': '組み込みベクトルDB+RAG/エージェント', 'デプロイ': 'In-process、サーバー不要', 'ライセンス': 'Apache 2.0', '最適な用途': '1パッケージで完結するPython製RAG/エージェント' },
          { 'ツール': 'Chroma', 'リンク': '[trychroma.com](https://www.trychroma.com)', 'アーキテクチャ': 'ベクトルデータベース', 'デプロイ': '組み込みまたはサーバーモード', 'ライセンス': 'Apache 2.0', '最適な用途': 'シンプルなプロトタイプ用ベクトルストア' },
          { 'ツール': 'Qdrant', 'リンク': '[qdrant.tech](https://qdrant.tech)', 'アーキテクチャ': 'ベクトルデータベース', 'デプロイ': 'サーバー(Docker/クラウド)', 'ライセンス': 'Apache 2.0', '最適な用途': '大規模・マルチクライアント本番検索' },
          { 'ツール': 'LlamaIndex', 'リンク': '[llamaindex.ai](https://llamaindex.ai)', 'アーキテクチャ': 'RAG/オーケストレーションフレームワーク', 'デプロイ': '外部ベクトルストアが必要', 'ライセンス': 'MIT', '最適な用途': '任意のベクトルDB上のデータコネクタ' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026年版 ベストベクトルデータベース:Qdrant vs Pinecone vs Weaviate vs Chroma](/ja/local-llms/best-vector-database-2026) — 組み込み型インデックスでは対応できない場合の独立型ベクトルデータベースサービス。',
        ],
      },
    },
  },
...
embeddings.save("index_path")`,
      ...
      comparisonTable: {
        ...
        columns: ['工具', '链接', '架构', '部署方式', '许可证', '最适合'],
        rows: [
          { '工具': 'txtai', '链接': '[github.com/neuml/txtai](https://github.com/neuml/txtai)', '架构': '嵌入式向量数据库+RAG/智能体', '部署方式': 'In-process,无需服务器', '许可证': 'Apache 2.0', '最适合': '单包完成的Python RAG与智能体' },
          { '工具': 'Chroma', '链接': '[trychroma.com](https://www.trychroma.com)', '架构': '向量数据库', '部署方式': '嵌入式或服务器模式', '许可证': 'Apache 2.0', '最适合': '简单的原型向量存储' },
          { '工具': 'Qdrant', '链接': '[qdrant.tech](https://qdrant.tech)', '架构': '向量数据库', '部署方式': '服务器(Docker/云)', '许可证': 'Apache 2.0', '最适合': '大规模多客户端生产搜索' },
          { '工具': 'LlamaIndex', '链接': '[llamaindex.ai](https://llamaindex.ai)', '架构': 'RAG/编排框架', '部署方式': '需要外部向量存储', '许可证': 'MIT', '最适合': '在任意向量数据库上的数据连接器' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026年最佳向量数据库:Qdrant对比Pinecone、Weaviate与Chroma](/zh/local-llms/best-vector-database-2026) — 当嵌入式索引无法满足需求时的独立向量数据库服务。',
        ],
      },
    },
  },
...
embeddings.save("index_path")`,
      ...
      comparisonTable: {
        ...
        columns: ['도구', '링크', '아키텍처', '배포', '라이선스', '최적 용도'],
        rows: [
          { '도구': 'txtai', '링크': '[github.com/neuml/txtai](https://github.com/neuml/txtai)', '아키텍처': '임베디드 벡터 DB + RAG/에이전트', '배포': 'In-process, 서버 불필요', '라이선스': 'Apache 2.0', '최적 용도': '단일 패키지 Python RAG·에이전트' },
          { '도구': 'Chroma', '링크': '[trychroma.com](https://www.trychroma.com)', '아키텍처': '벡터 데이터베이스', '배포': '임베디드 또는 서버 모드', '라이선스': 'Apache 2.0', '최적 용도': '간단한 프로토타입용 벡터 저장소' },
          { '도구': 'Qdrant', '링크': '[qdrant.tech](https://qdrant.tech)', '아키텍처': '벡터 데이터베이스', '배포': '서버(Docker/클라우드)', '라이선스': 'Apache 2.0', '최적 용도': '대규모 다중 클라이언트 프로덕션 검색' },
          { '도구': 'LlamaIndex', '링크': '[llamaindex.ai](https://llamaindex.ai)', '아키텍처': 'RAG/오케스트레이션 프레임워크', '배포': '외부 벡터 저장소 필요', '라이선스': 'MIT', '최적 용도': '모든 벡터 DB 위의 데이터 커넥터' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026년 최고의 벡터 데이터베이스: Qdrant vs Pinecone vs Weaviate vs Chroma](/ko/local-llms/best-vector-database-2026) — 임베디드 인덱스로 부족할 때를 위한 독립형 벡터 데이터베이스 서비스.',
        ],
      },
    },
  },
...
embeddings.save("index_path")`,
      ...
      comparisonTable: {
        ...
        columns: ['الأداة', 'الرابط', 'البنية', 'النشر', 'الترخيص', 'الأنسب لـ'],
        rows: [
          { 'الأداة': 'txtai', 'الرابط': '[github.com/neuml/txtai](https://github.com/neuml/txtai)', 'البنية': 'قاعدة بيانات متجهية مضمّنة + RAG/وكلاء', 'النشر': 'In-process، دون خادم', 'الترخيص': 'Apache 2.0', 'الأنسب لـ': 'RAG ووكلاء Python في حزمة واحدة' },
          { 'الأداة': 'Chroma', 'الرابط': '[trychroma.com](https://www.trychroma.com)', 'البنية': 'قاعدة بيانات متجهية', 'النشر': 'وضع مضمّن أو خادم', 'الترخيص': 'Apache 2.0', 'الأنسب لـ': 'مخزن متجهات بسيط للنماذج الأولية' },
          { 'الأداة': 'Qdrant', 'الرابط': '[qdrant.tech](https://qdrant.tech)', 'البنية': 'قاعدة بيانات متجهية', 'النشر': 'خادم (Docker/سحابة)', 'الترخيص': 'Apache 2.0', 'الأنسب لـ': 'بحث إنتاجي متعدد العملاء وواسع النطاق' },
          { 'الأداة': 'LlamaIndex', 'الرابط': '[llamaindex.ai](https://llamaindex.ai)', 'البنية': 'إطار عمل RAG/تنسيق', 'النشر': 'يحتاج مخزناً متجهياً خارجياً', 'الترخيص': 'MIT', 'الأنسب لـ': 'موصلات بيانات فوق أي قاعدة بيانات متجهية' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[أفضل قاعدة بيانات متجهية 2026: Qdrant مقابل Pinecone مقابل Weaviate مقابل Chroma](/ar/local-llms/best-vector-database-2026) — خدمات قواعد بيانات متجهية مستقلة عندما لا يكفي الفهرس المضمّن.',
        ],
      },
    },
  },
