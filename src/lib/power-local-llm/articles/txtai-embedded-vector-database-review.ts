...
embeddings.save("index_path")`,
      ...
      comparisonTable: {
        ...
        rows: [
          { 'Tool': 'txtai', 'Architecture': 'Embedded vector DB + RAG/agents', 'Deployment': 'In-process, no server', 'License': 'Apache 2.0', 'Best For': 'Single-package Python RAG & agents' },
          { 'Tool': 'Chroma', 'Architecture': 'Vector database', 'Deployment': 'Embedded or server mode', 'License': 'Apache 2.0', 'Best For': 'Simple prototyping vector store' },
          { 'Tool': 'Qdrant', 'Architecture': 'Vector database', 'Deployment': 'Server (Docker/cloud)', 'License': 'Apache 2.0', 'Best For': 'Scaled, multi-client production search' },
          { 'Tool': 'LlamaIndex', 'Architecture': 'RAG/orchestration framework', 'Deployment': 'Needs external vector store', 'License': 'MIT', 'Best For': 'Data connectors atop any vector DB' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
...
embeddings.save("index_path")`,
      ...
      comparisonTable: {
        ...
        rows: [
          { 'Tool': 'txtai', 'Architektur': 'Eingebettete Vektor-DB + RAG/Agenten', 'Deployment': 'In-Process, kein Server', 'Lizenz': 'Apache 2.0', 'Am besten für': 'Ein Python-Paket für RAG & Agenten' },
          { 'Tool': 'Chroma', 'Architektur': 'Vektordatenbank', 'Deployment': 'Eingebettet oder Server-Modus', 'Lizenz': 'Apache 2.0', 'Am besten für': 'Einfacher Prototyp-Vektorspeicher' },
          { 'Tool': 'Qdrant', 'Architektur': 'Vektordatenbank', 'Deployment': 'Server (Docker/Cloud)', 'Lizenz': 'Apache 2.0', 'Am besten für': 'Skalierte Produktionssuche für viele Clients' },
          { 'Tool': 'LlamaIndex', 'Architektur': 'RAG-/Orchestrierungs-Framework', 'Deployment': 'Braucht externen Vektorspeicher', 'Lizenz': 'MIT', 'Am besten für': 'Datenanbindung auf jeder Vektor-DB' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
...
embeddings.save("index_path")`,
      ...
      comparisonTable: {
        ...
        rows: [
          { 'Outil': 'txtai', 'Architecture': 'Base vectorielle embarquée + RAG/agents', 'Déploiement': 'In-process, sans serveur', 'Licence': 'Apache 2.0', 'Idéal pour': 'RAG et agents Python en un paquet' },
          { 'Outil': 'Chroma', 'Architecture': 'Base vectorielle', 'Déploiement': 'Mode embarqué ou serveur', 'Licence': 'Apache 2.0', 'Idéal pour': 'Stockage vectoriel de prototypage simple' },
          { 'Outil': 'Qdrant', 'Architecture': 'Base vectorielle', 'Déploiement': 'Serveur (Docker/cloud)', 'Licence': 'Apache 2.0', 'Idéal pour': 'Recherche multi-clients en production' },
          { 'Outil': 'LlamaIndex', 'Architecture': 'Framework RAG/orchestration', 'Déploiement': 'Nécessite un stockage externe', 'Licence': 'MIT', 'Idéal pour': 'Connecteurs de données sur toute base vectorielle' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
...
embeddings.save("index_path")`,
      ...
      comparisonTable: {
        ...
        rows: [
          { 'Herramienta': 'txtai', 'Arquitectura': 'BD vectorial embebida + RAG/agentes', 'Despliegue': 'In-process, sin servidor', 'Licencia': 'Apache 2.0', 'Ideal para': 'RAG y agentes Python en un paquete' },
          { 'Herramienta': 'Chroma', 'Arquitectura': 'Base de datos vectorial', 'Despliegue': 'Modo embebido o servidor', 'Licencia': 'Apache 2.0', 'Ideal para': 'Almacén vectorial de prototipado simple' },
          { 'Herramienta': 'Qdrant', 'Arquitectura': 'Base de datos vectorial', 'Despliegue': 'Servidor (Docker/nube)', 'Licencia': 'Apache 2.0', 'Ideal para': 'Búsqueda de producción multi-cliente' },
          { 'Herramienta': 'LlamaIndex', 'Arquitectura': 'Framework RAG/orquestación', 'Despliegue': 'Necesita almacén externo', 'Licencia': 'MIT', 'Ideal para': 'Conectores de datos sobre cualquier BD vectorial' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
...
embeddings.save("index_path")`,
      ...
      comparisonTable: {
        ...
        rows: [
          { 'Ferramenta': 'txtai', 'Arquitetura': 'BD vetorial embutido + RAG/agentes', 'Implantação': 'In-process, sem servidor', 'Licença': 'Apache 2.0', 'Ideal para': 'RAG e agentes Python em um pacote' },
          { 'Ferramenta': 'Chroma', 'Arquitetura': 'Banco de dados vetorial', 'Implantação': 'Modo embutido ou servidor', 'Licença': 'Apache 2.0', 'Ideal para': 'Armazenamento vetorial de prototipagem simples' },
          { 'Ferramenta': 'Qdrant', 'Arquitetura': 'Banco de dados vetorial', 'Implantação': 'Servidor (Docker/nuvem)', 'Licença': 'Apache 2.0', 'Ideal para': 'Busca de produção multi-cliente' },
          { 'Ferramenta': 'LlamaIndex', 'Arquitetura': 'Framework RAG/orquestração', 'Implantação': 'Precisa de armazenamento externo', 'Licença': 'MIT', 'Ideal para': 'Conectores de dados sobre qualquer BD vetorial' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
...
embeddings.save("index_path")`,
      ...
      comparisonTable: {
        ...
        rows: [
          { 'ツール': 'txtai', 'アーキテクチャ': '組み込みベクトルDB+RAG/エージェント', 'デプロイ': 'In-process、サーバー不要', 'ライセンス': 'Apache 2.0', '最適な用途': '1パッケージで完結するPython製RAG/エージェント' },
          { 'ツール': 'Chroma', 'アーキテクチャ': 'ベクトルデータベース', 'デプロイ': '組み込みまたはサーバーモード', 'ライセンス': 'Apache 2.0', '最適な用途': 'シンプルなプロトタイプ用ベクトルストア' },
          { 'ツール': 'Qdrant', 'アーキテクチャ': 'ベクトルデータベース', 'デプロイ': 'サーバー(Docker/クラウド)', 'ライセンス': 'Apache 2.0', '最適な用途': '大規模・マルチクライアント本番検索' },
          { 'ツール': 'LlamaIndex', 'アーキテクチャ': 'RAG/オーケストレーションフレームワーク', 'デプロイ': '外部ベクトルストアが必要', 'ライセンス': 'MIT', '最適な用途': '任意のベクトルDB上のデータコネクタ' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
...
embeddings.save("index_path")`,
      ...
      comparisonTable: {
        ...
        rows: [
          { '工具': 'txtai', '架构': '嵌入式向量数据库+RAG/智能体', '部署方式': 'In-process,无需服务器', '许可证': 'Apache 2.0', '最适合': '单包完成的Python RAG与智能体' },
          { '工具': 'Chroma', '架构': '向量数据库', '部署方式': '嵌入式或服务器模式', '许可证': 'Apache 2.0', '最适合': '简单的原型向量存储' },
          { '工具': 'Qdrant', '架构': '向量数据库', '部署方式': '服务器(Docker/云)', '许可证': 'Apache 2.0', '最适合': '大规模多客户端生产搜索' },
          { '工具': 'LlamaIndex', '架构': 'RAG/编排框架', '部署方式': '需要外部向量存储', '许可证': 'MIT', '最适合': '在任意向量数据库上的数据连接器' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
...
embeddings.save("index_path")`,
      ...
      comparisonTable: {
        ...
        rows: [
          { '도구': 'txtai', '아키텍처': '임베디드 벡터 DB + RAG/에이전트', '배포': 'In-process, 서버 불필요', '라이선스': 'Apache 2.0', '최적 용도': '단일 패키지 Python RAG·에이전트' },
          { '도구': 'Chroma', '아키텍처': '벡터 데이터베이스', '배포': '임베디드 또는 서버 모드', '라이선스': 'Apache 2.0', '최적 용도': '간단한 프로토타입용 벡터 저장소' },
          { '도구': 'Qdrant', '아키텍처': '벡터 데이터베이스', '배포': '서버(Docker/클라우드)', '라이선스': 'Apache 2.0', '최적 용도': '대규모 다중 클라이언트 프로덕션 검색' },
          { '도구': 'LlamaIndex', '아키텍처': 'RAG/오케스트레이션 프레임워크', '배포': '외부 벡터 저장소 필요', '라이선스': 'MIT', '최적 용도': '모든 벡터 DB 위의 데이터 커넥터' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
...
embeddings.save("index_path")`,
      ...
      comparisonTable: {
        ...
        rows: [
          { 'الأداة': 'txtai', 'البنية': 'قاعدة بيانات متجهية مضمّنة + RAG/وكلاء', 'النشر': 'In-process، دون خادم', 'الترخيص': 'Apache 2.0', 'الأنسب لـ': 'RAG ووكلاء Python في حزمة واحدة' },
          { 'الأداة': 'Chroma', 'البنية': 'قاعدة بيانات متجهية', 'النشر': 'وضع مضمّن أو خادم', 'الترخيص': 'Apache 2.0', 'الأنسب لـ': 'مخزن متجهات بسيط للنماذج الأولية' },
          { 'الأداة': 'Qdrant', 'البنية': 'قاعدة بيانات متجهية', 'النشر': 'خادم (Docker/سحابة)', 'الترخيص': 'Apache 2.0', 'الأنسب لـ': 'بحث إنتاجي متعدد العملاء وواسع النطاق' },
          { 'الأداة': 'LlamaIndex', 'البنية': 'إطار عمل RAG/تنسيق', 'النشر': 'يحتاج مخزناً متجهياً خارجياً', 'الترخيص': 'MIT', 'الأنسب لـ': 'موصلات بيانات فوق أي قاعدة بيانات متجهية' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
