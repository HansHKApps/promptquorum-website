...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    primaryTerm: 'txtai',
    title: 'txtai Review: The Embedded Vector Database That Skips the Server',
    seoTitle: 'txtai Review: Embedded Vector DB, No Server Needed',
...
embeddings.save("index_path")`,
  ...
  de: {
    ...
    primaryTerm: 'txtai',
    title: 'txtai im Test: Vektordatenbank ohne separaten Server (Apache 2.0)',
    seoTitle: 'txtai Test: Eingebettete Vektordatenbank, kein Server',
...
embeddings.save("index_path")`,
  ...
  fr: {
    ...
    primaryTerm: 'txtai',
    title: 'txtai: la base vectorielle embarquée, sans serveur à déployer (guide)',
    seoTitle: 'txtai: base vectorielle embarquée, sans serveur',
...
embeddings.save("index_path")`,
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Répertoire des logiciels LLM locaux](/fr/directory) — le catalogue complet des outils d\'IA locale dont fait partie cet article.',
  ...
  es: {
    ...
    primaryTerm: 'txtai',
    title: 'txtai: la base de datos vectorial embebida que no necesita servidor',
    seoTitle: 'txtai: base vectorial embebida, sin servidor',
...
embeddings.save("index_path")`,
  ...
  pt: {
    ...
    primaryTerm: 'txtai',
    title: 'txtai: o banco de dados vetorial embutido que dispensa servidor',
    seoTitle: 'txtai: banco vetorial embutido, sem servidor',
...
embeddings.save("index_path")`,
  ...
  ja: {
    ...
    primaryTerm: 'txtai',
    title: 'txtai比較:サーバー不要の組み込みベクトルDB（Apache 2.0）',
    seoTitle: 'txtaiレビュー:サーバー不要の組み込みベクトルDB',
...
embeddings.save("index_path")`,
  ...
  zh: {
    ...
    primaryTerm: 'txtai',
    title: 'txtai 评测:无需服务器的嵌入式向量数据库（Apache 2.0）',
    seoTitle: 'txtai:嵌入式向量数据库，无需部署服务器',
...
embeddings.save("index_path")`,
  ...
  ko: {
    ...
    primaryTerm: 'txtai',
    title: 'txtai 리뷰: 서버 없는 임베디드 벡터 DB (Apache 2.0)',
    seoTitle: 'txtai: 서버 불필요한 임베디드 벡터 DB',
...
embeddings.save("index_path")`,
  ...
  ar: {
    ...
    primaryTerm: 'txtai',
    title: 'مراجعة txtai: قاعدة بيانات متجهية مضمّنة بلا خادم (Apache 2.0)',
    seoTitle: 'txtai: قاعدة بيانات متجهية مضمّنة دون خادم',
...
embeddings.save("index_path")`,
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[دليل برمجيات نماذج اللغة المحلية](/ar/directory) — الكتالوج الكامل لأدوات الذكاء الاصطناعي المحلي الذي ينتمي إليه هذا المقال.',
