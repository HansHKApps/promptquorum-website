  ...
  en: {
    ...
    sections: {
      ...
      ownershipRisk: {
        ...
        content: [
          '**AI-generated marketing and design assets may be substantially unprotectable under copyright in jurisdictions that require human authorship, and that gap has a specific practical consequence: if a competitor copies your AI-generated campaign, you may have no copyright claim available even though copying obviously happened.** Copyright law was built around human creativity, and several major jurisdictions still apply that requirement directly to AI output.',
      ...
      jurisdiction: {
        ...
        content: [
          ...
          'For commercial content, the practical shape of the ownership risk described in Risk A above tracks this standard directly: the more a human materially shapes, edits, or restructures an AI-generated draft, and the better that process is documented, the stronger the resulting ownership position — while output that goes essentially unedited from a single prompt to publication sits in the weakest position.',
          'This section is general orientation, not legal advice — confirm current guidance and its application to your specific content with counsel before relying on a copyright claim over AI-assisted material.',
        ],
      },
      faqSection: {
        id: 'faq',
  ...
  de: {
    ...
    sections: {
      ...
      ownershipRisk: {
        ...
        content: [
          '**KI-generierte Marketing- und Design-Assets sind in Jurisdiktionen mit menschlicher Autorenschaftspflicht urheberrechtlich möglicherweise weitgehend nicht schutzfähig — mit einer konkreten praktischen Folge: Kopiert ein Wettbewerber Ihre KI-generierte Kampagne, steht Ihnen unter Umständen kein Urheberrechtsanspruch zur Verfügung, obwohl offensichtlich kopiert wurde.** Das Urheberrecht wurde um menschliche Kreativität herum aufgebaut, und mehrere wichtige Jurisdiktionen wenden diese Anforderung weiterhin direkt auf KI-Ausgaben an.',
      ...
      jurisdiction: {
        ...
        content: [
          ...
          'Dieser Abschnitt bietet allgemeine Orientierung und ersetzt keine Rechtsberatung — klären Sie die Anwendung auf Ihren konkreten Fall vor einer Entscheidung mit einer Rechtsberatung ab.',
        ],
      },
      faqSection: {
        id: 'faq',
  ...
  fr: {
    ...
    sections: {
      ...
      ownershipRisk: {
        ...
        content: [
          '**Les actifs marketing et design générés par IA peuvent être largement non protégeables par le droit d\'auteur dans les juridictions exigeant une paternité humaine, avec une conséquence pratique précise : si un concurrent copie votre campagne générée par IA, vous pourriez ne disposer d\'aucun recours en droit d\'auteur, alors même que la copie est manifeste.** Le droit d\'auteur a été construit autour de la créativité humaine, et plusieurs juridictions majeures appliquent encore cette exigence directement aux résultats IA.',
      ...
      jurisdiction: {
        ...
        content: [
          ...
          'Cette section constitue une orientation générale, pas un avis juridique — vérifiez son application à votre situation avec un conseil avant toute décision.',
        ],
      },
      faqSection: {
        id: 'faq',
    ...
    sections: {
      ...
      jurisdiction: {
        ...
        content: [
          ...
          'Esta sección es una orientación general, no asesoramiento legal — confirma su aplicación a tu caso concreto con un abogado antes de tomar decisiones.',
        ],
      },
      faqSection: {
        id: 'faq',
  ...
  pt: {
    ...
    sections: {
      ...
      ownershipRisk: {
        ...
        content: [
          '**Ativos de marketing e design gerados por IA podem ser substancialmente não protegíveis por direitos autorais em jurisdições que exigem autoria humana, e essa lacuna tem uma consequência prática específica: se um concorrente copiar sua campanha gerada por IA, você pode não ter nenhuma reivindicação de direitos autorais disponível mesmo que a cópia seja evidente.** O direito autoral foi construído em torno da criatividade humana, e várias jurisdições importantes ainda aplicam esse requisito diretamente às saídas de IA.',
      ...
      jurisdiction: {
        ...
        content: [
          ...
          'Esta seção é uma orientação geral, não é aconselhamento jurídico — confirme a aplicação ao seu caso específico com um advogado antes de tomar decisões.',
        ],
      },
      faqSection: {
        id: 'faq',
  ...
  zh: {
    ...
    sections: {
      ...
      ownershipRisk: {
        ...
        title: '风险 A：我们能拥有它吗？',
        content: [
          '**在要求人类作者身份的司法辖区，AI 生成的营销和设计素材在版权上可能基本无法受到保护，这个缺口有一个非常具体的实际后果：如果竞争对手复制了您的 AI 生成营销活动，即便复制行为显而易见，您也可能没有任何版权主张可以阻止对方。** 版权法是围绕人类创造力构建的，多个主要司法辖区仍将这一要求直接适用于 AI 输出。',
      ...
      jurisdiction: {
        ...
        content: [
          ...
          '本节仅为一般性介绍，不构成法律意见——在依赖任何具体判例或结论之前，请就您的具体情况咨询专业法律顾问。',
        ],
      },
      faqSection: {
        id: 'faq',
  ...
  ja: {
    ...
    sections: {
      ...
      ownershipRisk: {
        ...
        title: 'リスクA：所有できるか？',
        content: [
          '**AI生成のマーケティング素材やデザイン素材は、人間の著作者性を要求する法域では著作権による保護をほぼ受けられない場合があり、これには具体的な実務上の帰結が伴います。競合他社があなたのAI生成キャンペーンを複製した場合、明らかに複製が行われたにもかかわらず、著作権に基づく主張ができない可能性があるということです。** 著作権法は人間の創造性を中心に構築されており、複数の主要法域では、この要件が今なおAIアウトプットに直接適用されています。',
      ...
      jurisdiction: {
        ...
        content: [
          ...
          'この分野は日本国内でも発展途上であり、AI生成コンテンツの著作権・営業秘密に特化した確立判例は本記事執筆時点で限られています。本節は一般的な情報提供であり法的助言ではありません。具体的な判断は専門家にご確認ください。',
        ],
      },
      faqSection: {
        id: 'faq',
  ...
  ar: {
    ...
    sections: {
      ...
      ownershipRisk: {
        ...
        content: [
          '**قد تكون أصول التسويق والتصميم المولَّدة بالذكاء الاصطناعي غير قابلة للحماية بحقوق النشر إلى حد كبير في الولايات القضائية التي تشترط تأليفًا بشريًا، ولهذه الفجوة نتيجة عملية محددة: إذا نسخ منافس حملتك المولَّدة بالذكاء الاصطناعي، فقد لا تملك أي مطالبة بحقوق النشر متاحة رغم أن النسخ حدث بوضوح.** بُني قانون حقوق النشر حول الإبداع البشري، ولا تزال عدة ولايات قضائية رئيسية تطبّق هذا الشرط مباشرةً على مخرجات الذكاء الاصطناعي.',
      ...
      jurisdiction: {
        ...
        content: [
          ...
          'هذا مجال لا يزال محدود التغطية القانونية الخاصة بملكية مخرجات الذكاء الاصطناعي في المنطقة حتى الآن، وهذا القسم توجيه عام وليس استشارة قانونية — تأكد من انطباقه على وضعك الخاص مع مستشار قانوني مختص قبل اتخاذ أي قرار.',
        ],
      },
      faqSection: {
        id: 'faq',
  ...
  ko: {
    ...
    sections: {
      ...
      ownershipRisk: {
        ...
        content: [
          '**AI가 생성한 마케팅 및 디자인 자산은 인간 저작을 요구하는 법역에서 상당 부분 저작권으로 보호받지 못할 수 있으며, 이 공백에는 구체적인 실무적 결과가 따릅니다 — 경쟁사가 귀사의 AI 생성 캠페인을 복제하더라도, 복제가 명백함에도 불구하고 저작권 청구권이 전혀 없을 수 있다는 것입니다.** 저작권법은 인간의 창의성을 중심으로 만들어졌으며, 여러 주요 법역은 이 요건을 여전히 AI 결과물에 직접 적용하고 있습니다.',
      ...
      jurisdiction: {
        ...
        content: [
          ...
          'AI 생성 콘텐츠의 저작권·영업비밀 문제에 특화된 확립된 판례는 이 글 작성 시점 기준으로 아직 제한적입니다. 이 섹션은 일반적인 정보 제공이며 법률 자문이 아닙니다 — 구체적인 판단은 반드시 전문가와 확인하십시오.',
        ],
      },
      faqSection: {
        id: 'faq',
