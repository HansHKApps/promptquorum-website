    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[دليل برمجيات Llm المحلي 2026](/ar/power-local-llm/local-llm-software-directory) — دليل تطبيقات وأدوات شامل لجميع المنصات.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Lokale LLM-Softwareverzeichnis 2026](/de/power-local-llm/local-llm-software-directory) — umfassendes App- und Tool-Verzeichnis für alle Plattformen.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Directorio de software de IA local 2026](/es/power-local-llm/local-llm-software-directory) — directorio de aplicaciones y herramientas comprensivo para todas las plataformas.',
        ],
      },
    },
  },
  ...
  sections: {
    ...
    relatedReading: {
      ...
      items: [
        ...
        '[Répertoire logiciel LLM local 2026](/fr/power-local-llm/local-llm-software-directory) — répertoire d\'applications et outils complet pour toutes plates-formes.',
      ],
    },
  },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[ローカルLLMソフトウェアディレクトリ2026](/ja/power-local-llm/local-llm-software-directory) — すべてのプラットフォーム向けの包括的なアプリとツールディレクトリ。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[로컬 LLM 소프트웨어 디렉토리 2026](/ko/power-local-llm/local-llm-software-directory) — 모든 플랫폼을 위한 포괄적인 앱 및 도구 디렉토리.',
        ],
      },
    },
  },
  ...
  sections: {
    ...
    relatedReading: {
      ...
      items: [
        ...
        '[Diretório de Software de IA Local 2026](/pt/power-local-llm/local-llm-software-directory) — diretório abrangente de app e ferramenta para todas as plataformas.',
      ],
    },
  },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[本地 LLM 软件目录 2026](/zh/power-local-llm/local-llm-software-directory) — 所有平台的综合应用和工具目录。',
        ],
      },
    },
  },
