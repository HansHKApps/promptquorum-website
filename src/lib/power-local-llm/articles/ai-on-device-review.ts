    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[O diretório completo de software LLM local](/pt/directory) — um diretório mais amplo de ferramentas LLM locais em todas as plataformas.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[完整的本地 LLM 软件目录](/zh/directory) — 涵盖所有平台的本地 LLM 工具更广泛目录。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[الدليل الكامل لبرامج نماذج اللغة المحلية](/ar/directory) — دليل أوسع لأدوات نماذج اللغة المحلية عبر جميع المنصات.',
        ],
      },
    },
  },
