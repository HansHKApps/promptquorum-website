    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/directory) — directory listings for Logseq, Joplin, Ollama, logseq-copilot, and Jarvis with licences and links.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Directorio de software de LLM local 2026](/es/directory) — entradas del directorio para Logseq, Joplin, Ollama, logseq-copilot y Jarvis con licencias y enlaces.',
        ],
      },
    },
      schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Diretório de software de LLM local 2026](/pt/directory) — entradas do diretório para Logseq, Joplin, Ollama, logseq-copilot e Jarvis com licenças e links.',
        ],
      },
    },
      schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Lokale-LLM-Software-Verzeichnis 2026](/de/directory) — Verzeichnis-Einträge für Logseq, Joplin, Ollama, logseq-copilot und Jarvis mit Lizenzen und Links.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Annuaire logiciels LLM local 2026](/fr/directory) — entrées d\'annuaire pour Logseq, Joplin, Ollama, logseq-copilot et Jarvis avec licences et liens.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[ローカル LLM ソフトウェアディレクトリ 2026](/ja/directory) — Logseq、Joplin、Ollama、logseq-copilot、Jarvis のディレクトリエントリ、ライセンスとリンク付き。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[本地 LLM 软件目录 2026](/zh/directory) ——Logseq、Joplin、Ollama、logseq-copilot 和 Jarvis 的目录条目，含许可和链接。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[دليل برامج LLM المحلية 2026](/ar/directory) — إدخالات الدليل لـ Logseq وJoplin وOllama وlogseq-copilot وJarvis مع التراخيص والروابط.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[로컬 LLM 소프트웨어 디렉터리 2026](/ko/directory) — 라이선스 및 링크와 함께 Logseq, Joplin, Ollama, logseq-copilot, Jarvis 디렉터리 항목.',
        ],
      },
    },
    schema: {
