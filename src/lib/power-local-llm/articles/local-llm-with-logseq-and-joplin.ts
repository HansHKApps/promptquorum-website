...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'Logseq + Joplin مع LLM محلي: ملاحظات ذكية بدون سحابة 2026',
    intro:
    ...
    metaDescription:
      'Logseq + logseq-copilot مقابل Joplin + Jarvis على Ollama: بديل خاص لـ Notion AI. مزامنة بدون سحابة، وضعية GDPR، فجوة ملحقات الجوّال. 2026.',
    twitterDescription:
