...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  de: {
    ...
    metaDescription: 'Kein Terminal. Kein Python. Kein Docker. 5 lokale KI-Apps, die nicht-technische Nutzer in 10 Minuten installieren. Mit echten Anfängern getestet. 2026.',
