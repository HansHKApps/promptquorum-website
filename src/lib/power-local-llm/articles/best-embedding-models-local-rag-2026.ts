    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[RAG説明：2026年実際のデータでAI回答を接地する方法](/prompt-engineering/rag-explained?lang=ja) —取得増幅生成の概念レイヤー。',
          '[ローカルLLMハードウェアガイド2026](/local-llms/local-llm-hardware-guide-2026?lang=ja) —埋め込みワークロード向けのGPUとRAM。',
