...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  pt: {
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/pt/pt/power-local-llm/autonomous-local-agents-actually-work',
      inLanguage: 'pt-BR',
      datePublished: '2026-05-24',
      dateModified: '2026-05-24',
      author: { '@type': 'Person', name: 'Hans Kuepper' },
  ...
  ar: {
    ...
    seoTitle: 'وكلاء الذكاء الاصطناعي المحليون 2026: ما يعمل وما يفشل',
    intro:
    ...
    metaDescription:
      '6 أطر عمل لوكلاء الذكاء الاصطناعي المحليين اختُبرت في 5 مهام حقيقية: نجح اثنان، وأخفق ثلاثة بطرق لا تكشفها العروض، وكان واحد عديم الفائدة. Cline وLangGraph وAutoGPT وMetaGPT تحت المجهر.',
    twitterDescription:
