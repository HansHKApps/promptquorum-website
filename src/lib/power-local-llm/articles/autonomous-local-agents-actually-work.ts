...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'وكلاء الذكاء الاصطناعي المحليون 2026: اختبار 6 أطر عمل',
    intro:
    ...
    metaDescription:
      '6 أطر عمل لوكلاء الذكاء الاصطناعي اختُبرت في 5 مهام حقيقية: نجح اثنان بموثوقية، وأخفق 3 بطرق لا تُظهرها العروض. Cline وLangGraph وAutoGPT وMetaGPT.',
    twitterDescription:
