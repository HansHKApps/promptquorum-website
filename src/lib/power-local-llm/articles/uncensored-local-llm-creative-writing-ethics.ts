...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'نماذج LLM المحلية بدون قيود للكتابة الإبداعية 2026',
    intro:
    ...
    metaDescription:
      'نماذج LLM المحلية بدون قيود للكتابة الإبداعية: النماذج الموصى بها، الإعداد على Ollama، الأخلاقيات، حالات الاستخدام، والحدود الواجب الحفاظ عليها.',
    twitterDescription:
