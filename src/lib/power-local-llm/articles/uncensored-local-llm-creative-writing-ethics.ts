    ...
    sections: {
      ...
      whatUncensoredMeans: {
        ...
        items: [
          ...
          '**呼び方の違い：** 日本語では「無検閲」「検閲なし」「非検閲」「無修正」「規制なし」「制限なし」がほぼ同じ意味で使われ、英語の uncensored / unrestricted / abliterated に対応します。「無修正」はアダルトメディア由来の口語表現ですが、ローカルLLMの文脈では本記事の「無検閲」と同じくRLHFの拒否層を外したファインチューンを指します。モデルを探すときは uncensored / abliterated / dolphin といったタグが目印になります。',
        ],
        snippetBlocks: [
          {
            type: 'one-sentence',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: '同じものを指します。ローカルLLMの文脈では「無検閲」「検閲なし」「非検閲」「無修正」「規制なし」はいずれもRLHFの拒否層を外したファインチューンのことで、技術的な区別はありません。「無修正」はアダルトメディア由来の口語表現、「非検閲」はやや硬い表現という語感の差だけです。Ollamaやモデル配布ページで探すときは uncensored、abliterated、dolphin といった英語のタグが目印になります。',
          },
          {
