...
export const article: Partial<Record<Language, LLMArticle>> = {
    ...
    sections: {
      ...
      models: {
        ...
        items: [
          ...
          image: '/images/uncensored-local-llm-creative-writing-ethics-model-comparison-hero-en.webp',
      ...
      workflow: {
        ...
        callouts: [
          ...
          image: '/images/uncensored-local-llm-creative-writing-ethics-workflow-hero-en.webp',
    ...
    sections: {
      ...
      models: {
        ...
        items: [
          ...
          image: '/images/uncensored-local-llm-creative-writing-ethics-model-comparison-hero-de.webp',
      ...
      workflow: {
        ...
        callouts: [
          ...
          image: '/images/uncensored-local-llm-creative-writing-ethics-workflow-hero-de.webp',
    ...
    sections: {
      ...
      models: {
        ...
        items: [
          ...
          image: '/images/uncensored-local-llm-creative-writing-ethics-model-comparison-hero-fr.webp',
      ...
      workflow: {
        ...
        callouts: [
          ...
          image: '/images/uncensored-local-llm-creative-writing-ethics-workflow-hero-fr.webp',
  ...
  ja: {
    ...
    seoTitle: '無検閲ローカルLLM 5選：日本語小説と倫理 2026',
    intro:
    ...
    metaDescription:
      '小説・ダークフィクション向け無検閲ローカルLLMはHermes 3とDolphin 3.0が最適。無修正/非検閲モデル5つをVRAM別に比較し、日本語で書く場合のモデル選び、LM StudioとOllamaの設定、倫理的責任まで解説。',
    ...
    toc: [
      ...
      { label: '日本語で書く場合のモデル選び', anchor: '#japanese' },
    ...
    sections: {
      ...
      whatUncensoredMeans: {
        ...
        items: [
          ...
          '**呼び方の違い：** 日本語では「無検閲」「検閲なし」「非検閲」「無修正」「規制なし」「無規制」「制限なし」がほぼ同じ意味で使われ、英語の uncensored / unrestricted / abliterated に対応します。「無修正」はアダルトメディア由来の口語表現ですが、ローカルLLMの文脈では本記事の「無検閲」と同じくRLHFの拒否層を外したファインチューンを指します。モデルを探すときは uncensored / abliterated / dolphin といったタグが目印になります。',
        ],
        snippetBlocks: [
          {
            type: 'one-sentence',
      ...
      models: {
        ...
        items: [
          ...
          image: '/images/uncensored-local-llm-creative-writing-ethics-model-comparison-hero-ja.webp',
      ...
      japanese: {
        ...
        callouts: [
          {
            type: 'tip',
            text: '日本語での出力品質を確かめる最短の方法は、同じ場面を英語と日本語の両方で生成して読み比べることです。同じプロンプト・同じ量子化で日本語側だけ文体が崩れる、敬体と常体が混ざる、キャラクターの一人称が途中で変わる――こうした症状が出る場合、原因はモデルの無検閲度ではなくベースモデルの日本語力です。より大きなLlama系ベースに移すか、二段階の手順に切り替えてください。',
          },
        ],
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: '無検閲ローカルLLMはいずれも英語中心のベースモデル上に作られているため、日本語の小説では収まる範囲で最大のLlama系ベースを選ぶか、英語で生成してから日本語に書き直す二段階の手順が現実的です。',
          },
          {
            type: 'plain-terms',
            text: '無検閲モデルは「拒否をなくす」ための追加学習を英語のデータで行っています。そのため日本語で書かせると、英語のときより文章が不安定になります。日本語をたくさん書かせたい場合は、大きめのLlama系モデルを使うか、まず英語で書かせてから日本語に直す二段構えが安全です。',
          },
        ],
      },
      setup: {
      ...
      workflow: {
        ...
        callouts: [
          ...
          image: '/images/uncensored-local-llm-creative-writing-ethics-workflow-hero-ja.webp',
      ...
      faq: {
        ...
        faqs: [
          {
            q: 'LM Studioで無検閲モデルを使うには設定変更が必要ですか？',
            a: '不要です。LM Studio自体に検閲層はなく、拒否が出るかどうかは読み込んだモデルの性質だけで決まります。標準モデルが拒否するのはLM Studioの設定ではなくモデル側のRLHF層によるもので、設定画面で解除できる項目ではありません。Hermes 3やDolphin 3.0のGGUFファイルを読み込めば、追加設定なしで無検閲の挙動になります。ローカルサーバータブから`http://localhost:1234`にOpenAI互換エンドポイントを公開すれば、SillyTavernやAgnaiからも同じモデルを使えます。',
          },
          {
            q: '「脱獄（ジェイルブレイク）」と無検閲モデルは同じものですか？',
            a: '別のものです。脱獄は、検閲のかかったクラウドモデルに対してプロンプトの工夫で拒否を回避させる手法を指します。モデルの重み自体は変わっておらず、提供元の利用規約に違反する可能性があり、対策が入れば効かなくなります。無検閲モデルは拒否層そのものを追加学習で外した重みを自分のハードウェアで動かすもので、プロンプトの小細工を必要とせず、提供元のサーバーを経由しません。フィクション執筆で結果の安定性が必要なら、脱獄プロンプトより無検閲モデルのほうが確実です。',
          },
          {
            q: '無検閲モデルは無料ですか。NSFWコンテンツにも使えますか？',
            a: '本記事で扱うモデルはすべて無料で、Ollamaのモデルライブラリやモデル配布サイトからダウンロードできます。かかる費用は電気代と、モデルを動かすハードウェアだけです。NSFWを含む成人向けの描写も技術的には生成できますが、それが適切なのは成人読者向けの創作フィクションに使う場合に限られます。実在人物の非合意的な描写、未成年者を性的文脈に置くコンテンツ、現実の加害に転用できる手順の生成は、ローカル実行で技術的に可能であっても許容されません。詳しくは「適切でない場面」の節を参照してください。',
          },
          {
            q: '無検閲のローカル画像生成にも同じモデルを使えますか？',
            a: '使えません。本記事で扱う無検閲モデルはテキスト生成用の大規模言語モデル（LLM）で、画像は生成しません。ローカルでの画像生成はStable Diffusionのような拡散モデルと、ComfyUIやAUTOMATIC1111といった別系統のツールを使います。仕組みが異なるため、OllamaやLM Studioで画像生成モデルを動かすことはできません。小説の挿絵など画像も必要な場合は、テキスト用と画像用で別々の環境を用意することになります。',
          },
          {
            q: '無検閲ローカルLLMは日本語で小説を書けますか？',
            a: '書けますが、英語の場合とモデル選びが変わります。Hermes 3やDolphin 3.0のような無検閲ファインチューンは主に英語データで追加学習されているため、ベースのLlama 3.3やMistralが持っていた日本語力が薄まる傾向があります。日本語の分量が多い原稿では、多言語データを厚く学習したQwen3 32Bのような多言語ベースのモデルを使うか、英語で生成してから日本語に書き直すワークフローのほうが安定します。日本語はトークン消費も大きいため、同じコンテキスト長でも実際に入る文字数は英語より少なくなります。',
          },
          {
            q: '「無修正モデル」「非検閲モデル」は無検閲モデルと違うものですか？',
            a: '同じものを指します。ローカルLLMの文脈では「無検閲」「検閲なし」「非検閲」「無修正」「規制なし」「無規制」はいずれもRLHFの拒否層を外したファインチューンのことで、技術的な区別はありません。「無修正」はアダルトメディア由来の口語表現、「非検閲」はやや硬い表現という語感の差だけです。Ollamaやモデル配布ページで探すときは uncensored、abliterated、dolphin といった英語のタグが目印になります。',
          },
          {
    ...
    sections: {
      ...
      models: {
        ...
        items: [
          ...
          image: '/images/uncensored-local-llm-creative-writing-ethics-model-comparison-hero-zh.webp',
      ...
      workflow: {
        ...
        callouts: [
          ...
          image: '/images/uncensored-local-llm-creative-writing-ethics-workflow-hero-zh.webp',
  ...
  es: {
    ...
    sections: {
      ...
      models: {
        ...
        items: [
          ...
          image: '/images/uncensored-local-llm-creative-writing-ethics-model-comparison-hero-es.webp',
      ...
      workflow: {
        ...
        callouts: [
          ...
          image: '/images/uncensored-local-llm-creative-writing-ethics-workflow-hero-es.webp',
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/es/power-local-llm/uncensored-local-llm-creative-writing-ethics',
      inLanguage: 'es',
  ...
  ko: {
    ...
    audience:
      '클라우드 서비스의 거부 없이 성인용 또는 어두운 콘텐츠를 생성할 수 있는 로컬 LLM이 필요한 픽션 작가, 소설가, 비디오 게임 내러티브 디자이너 및 창의적 전문가로, 그러한 사용에서 자신의 윤리적 책임을 이해하고자 합니다.',
    readTime: '13분 분량',
    educationalLevel: 'Intermediate',
    primaryTerm: '무검열 로컬 LLM 창의적 글쓰기',
    targetKeywords: [
      '창의적 글쓰기 무검열 로컬 LLM',
      'Ollama 무검열 모델',
      'Hermes 3 창의적 글쓰기',
      'Dolphin Mistral 무검열 설정',
      '로컬 LLM 어두운 픽션',
      '무검열 AI 글쓰기 윤리',
    ],
    leadAnswerBlock:
    ...
    quickAnswerTop: {
      ko: {
        ...
        bullets: [
          ...
          '기본 윤리 한계는 모델에 관계없이 적용됩니다: 미성년자 없음, 실제 인물의 비동의적 묘사 없음.',
          '배포 책임: 출력물로 하는 일은 자체 저작 콘텐츠와 동일한 법적 무게를 가집니다.',
          '롤플레이 프론트엔드의 경우, SillyTavern과 Agnai는 Ollama 무검열 모델에 깔끔하게 연결됩니다.',
        ],
        updatedDate: '2026-05-07',
      },
    },
    toc: [
      ...
      { label: '"무검열"이 실제로 의미하는 것', anchor: '#what-uncensored-means' },
      { label: '테스트 방법', anchor: '#how-we-tested' },
      { label: '무검열 모델이 픽션에 적합한 경우', anchor: '#appropriate-use' },
      { label: '적합하지 않은 경우', anchor: '#inappropriate-use' },
      { label: '모델 비교', anchor: '#models' },
      { label: '설정: Ollama와 LM Studio', anchor: '#setup' },
      { label: '남아있는 윤리적 책임', anchor: '#ethics' },
      { label: '실용적인 워크플로우', anchor: '#workflow' },
    ...
    sections: {
      ...
      whatUncensoredMeans: {
        ...
        callouts: [
          {
            type: 'tip',
            text: '무검열이 제어 불가를 의미하지 않습니다. 무검열 모델은 프롬프트 구조를 따르고, 단어 제한을 존중하며, 캐릭터 목소리를 유지하고, 수정 지시에 응답합니다. 차이점은 원치 않는 콘텐츠 경고를 추가하지 않고, 도덕적으로 어두운 방향을 거부하지 않으며, 장면이 해를 나타낸다고 신호하기 위해 캐릭터를 깨지 않는다는 것입니다. 다른 모델과 마찬가지로 픽션 글쓰기 템플릿의 구조화된 프롬프트를 사용하십시오 — 시스템 프롬프트와 사용자 프롬프트의 구별이 모델의 무검열 수준보다 더 중요합니다. 이유는 [시스템 프롬프트 vs 사용자 프롬프트](/ko/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference)를 참조하십시오.',
          },
        ],
        items: [
        ...
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: '로컬 LLM 무검열 파인튜닝은 RLHF 안전 거부 레이어를 제거하면서 지시 따르기 능력을 유지합니다 — 리디렉션, 설교, 장면 중간 정지 없이 어두운 창의적 방향을 따릅니다.',
          },
          {
            type: 'plain-terms',
            text: 'Llama 3.3 70B 같은 표준 모델은 고문을 묘사하는 장면, 도덕적으로 복잡한 악당의 독백, 노골적인 로맨틱 콘텐츠 중간에 멈추고 출력을 거부하거나 부드럽게 만듭니다. Hermes 3(동일한 기반의 무검열 버전)는 중단 없이 동일한 품질 수준으로 같은 장면을 통해 프롬프트를 따릅니다. 산문 품질은 동등합니다; 차이는 거부 레이어에 있습니다.',
          },
        ],
      },
      howWeTested: {
      ...
      appropriateUse: {
        ...
        callouts: [
          {
            type: 'tip',
            text: '무검열 모델로 전환하기 전에 표준 인스트럭트 모델에서 프롬프트를 테스트하십시오. 잘 구조화된 시스템 프롬프트와 장면 제약이 있는 Llama 3.3 70B와 Qwen3 32B는 거부 없이 대부분의 성인 문학 콘텐츠를 생성합니다. 무검열 파인튜닝은 노골적인 성적 콘텐츠와 더 극단적인 폭력 묘사에서 더 많은 가치를 추가합니다 — 어두운 심리, 도덕적 복잡성, 일반적으로 어두운 테마에서는 아닙니다.',
          },
        ],
      },
      inappropriateUse: {
        id: 'inappropriate-use',
        title: '무검열 모델이 적합하지 않은 경우',
        content:
          '**클라우드 적용의 부재가 법적, 윤리적 의무의 부재를 의미하지 않습니다.** 이러한 범주는 모델, 플랫폼, 기기가 네트워크에서 격리되어 있는지 여부에 관계없이 적용되는 절대적 한계를 나타냅니다.',
        callouts: [
          {
            type: 'warning',
            text: '설정에 관계없는 절대적 한계. 어떤 로컬 설정도 다음에 대한 법적 또는 윤리적 책임을 제거하지 않습니다: (1) 미성년자가 포함된 성적 콘텐츠 — 사실상 모든 관할권에서 법률에 의한 절대 금지; (2) 식별 가능한 실제 인물의 비동의적 성적 묘사 — 이는 생성 방법에 관계없이 NCII(비동의적 친밀한 이미지)를 구성합니다; (3) 특정 목표에 대한 실제 폭력을 조장하기 위해 설계된 콘텐츠. 이러한 한계는 로컬, 클라우드, 또는 격리된 기기에서 모델이 실행되는 경우에도 적용됩니다.',
          },
        ],
        items: [
      ...
      models: {
        ...
        rows: [
          ...
          { '모델': 'Standard Llama 3.3 70B', '기반': 'Llama 3.3 70B', 'VRAM (Q4)': '~42 GB', '거부율': '제한적', '지시 품질': '★★★★★', '극단적 표류': '없음', '최적': '어두운 테마, 도덕적 복잡성, 폭력 — 노골적인 성적 콘텐츠 없이' },
        ],
        callouts: [
          {
            type: 'tip',
            text: '가장 공격적인 무검열 파인튜닝이 아닌 Hermes 3로 시작하십시오. 완전히 제거된 모델(Wizard-Uncensored, Erebus)은 가장 넓은 콘텐츠 범위를 가지지만 복잡한 픽션 작업에서 지시 따르기가 현저히 약합니다 — 제약에서 더 빠르게 이탈하고, 더 긴 생성에서 더 낮은 품질의 산문을 생성하며, 덜 안정적으로 캐릭터 목소리를 유지합니다. 무검열 콘텐츠와 품질 산문 모두 필요한 픽션의 경우, Hermes 3가 최선의 절충점입니다.',
          },
        ],
        items: [
          ...
          image: '/images/uncensored-local-llm-creative-writing-ethics-model-comparison-hero-ko.webp',
      ...
      setup: {
        ...
        promptExamples: [
          {
            label: 'Ollama: Hermes 3 다운로드 및 실행',
            text: '# Pull the model\nollama pull nous-hermes3:70b-llama3.3-q4_K_M\n\n# Run it\nollama run nous-hermes3:70b-llama3.3-q4_K_M\n\n# Serve via API (for SillyTavern / Agnai / LM Studio-compatible tools)\nollama serve\n# API available at http://localhost:11434',
          },
          {
            label: 'Ollama: Dolphin 3.0 Mistral 24B 다운로드 및 실행',
            text: '# Pull the model\nollama pull dolphin3:24b-mistral-q4_K_M\n\n# Verify it loaded\nollama list\n\n# Run a test prompt\nollama run dolphin3:24b-mistral-q4_K_M "Write a 100-word villain monologue, gothic register, no disclaimers."',
          },
        ],
        items: [
        ...
        callouts: [
          {
            type: 'tip',
            text: '무검열 모델과 표준 모델을 분리하여 유지하고 싶은 작가의 경우, OLLAMA_HOST 환경 변수를 사용하여 다른 포트에서 두 개의 Ollama 인스턴스를 생성하십시오. 예: OLLAMA_HOST=127.0.0.1:11435 ollama serve. 이렇게 하면 다른 작업을 위한 표준 Ollama 인스턴스를 유지하면서 SillyTavern 또는 Agnai를 무검열 인스턴스로 가리킬 수 있습니다.',
          },
        ],
      },
      ethics: {
        ...
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: '로컬 설정은 클라우드 서비스 약관 제한을 제거하지만, 법적 저작 책임, 해 조장 책임, 공개적으로 배포된 창의적 작품에 적용되는 윤리적 의무를 제거하지 않습니다.',
          },
          {
            type: 'plain-terms',
            text: '무검열 로컬 모델을 당신이 주는 모든 지시를 따르는 매우 유능한 글쓰기 조수로 생각하십시오. 생성하고 배포하는 것의 법적, 윤리적 무게는 도구가 아닌 당신에게 있습니다. 인간 저작 픽션에 적용되는 것과 동일한 법률 — 미성년자, 실제 인물, 음란물, 선동에 관한 — 이 공개적으로 배포된 AI 생성 픽션에 적용됩니다. 어떤 플랫폼도 로컬에서 콘텐츠 생성을 막지 않는다는 사실이 게시할 경우 법적으로 책임지는 것에 대해 변하지 않습니다.',
          },
        ],
        items: [
        ...
        callouts: [
          {
            type: 'warning',
            text: '무검열 모델을 사용하는 작가들 사이에서 가장 흔한 윤리적 실수는 로컬 생성을 맥락이 없는 구역으로 취급하는 것입니다. 로컬 생성은 플랫폼 정책 적용이 없음을 의미합니다 — 법, 책임, 해가 없음을 의미하지 않습니다. 콘텐츠 조정자의 부재는 허가가 아닙니다.',
          },
        ],
      },
      workflow: {
        id: 'workflow',
        title: '픽션 작가를 위한 실용적인 워크플로우',
        content:
        ...
        items: [
          ...
          '**특정 장면을 위해 무검열 모델로 전환.** Ollama에서 특정 장면을 위해 `ollama run nous-hermes3:70b-llama3.3-q4_K_M`을 실행하십시오. SillyTavern에서 세션별 API 설정에서 모델을 전환하십시오. 세션 간에 교차되는 데이터가 없습니다.',
          '**동일한 프롬프트 템플릿 사용.** [픽션 작가를 위한 로컬 LLM 프롬프트](/ko/power-local-llm/local-llm-prompts-for-fiction-writers)의 5부 장면 템플릿, 서브텍스트 대화 구조, 캐릭터 모순 프롬프트는 무검열 모델에서 동일하게 작동합니다. 다른 프롬프트 구조가 필요하지 않습니다.',
        ...
        callouts: [
          ...
          image: '/images/uncensored-local-llm-creative-writing-ethics-workflow-hero-ko.webp',
      ...
      sources: {
        ...
        title: '출처',
        items: [
          'Hermes 3 모델 카드 및 파인튜닝 방법론 — [Nous Research](https://nousresearch.com)',
          'Dolphin 3.0 Mistral 기술 문서 — [Cognitive Computations / Eric Hartford](https://huggingface.co/cognitivecomputations)',
          'RLHF 기법 및 정렬 개요 — [Anthropic Research](https://anthropic.com/research)',
          'EU AI Act 제5조 — 미성년자 포함 콘텐츠를 포함한 금지된 AI 관행 — [EUR-Lex](https://eur-lex.europa.eu)',
          'NCII(비동의적 친밀한 이미지) — 법적 프레임워크 개요 — [Cyber Civil Rights Initiative](https://cybercivilrights.org)',
        ],
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          {
            q: '무검열 로컬 LLM 실행이 합법적입니까?',
            a: '무검열 로컬 LLM 실행은 대부분의 관할권에서 합법적입니다 — 오픈 소스 AI 소프트웨어 소유를 금지하는 법률은 없습니다. 생성하고 배포하는 것은 다른 자체 저작 콘텐츠와 동일한 법률의 적용을 받습니다: 음란물 법, NCII 법, 명예훼손 법, 미성년자 포함 콘텐츠에 관한 법률. 실행이 합법적이라는 것이 제한 없이 게시하거나 공유하거나 배포하는 것이 합법적임을 의미하지 않습니다.',
          },
          {
            q: 'Hermes 3와 Dolphin 3.0의 차이는 무엇입니까?',
            a: 'Hermes 3(Nous Research)는 선택적으로 무검열됩니다 — 성인 콘텐츠에 대한 거부를 줄이면서 극단적 범주에 대한 일부 장벽을 유지합니다. 지시 따르기는 기본 모델 Llama 3.3 70B에 가까운 수준으로 우수합니다. Dolphin 3.0(Cognitive Computations)은 더 넓은 콘텐츠 범위에서 더 광범위하게 무검열되지만, 여러 제약이 있는 복잡한 장면에서 지시 따르기가 약간 더 약합니다. Hermes 3는 산문 품질이 중요한 픽션의 경우 최선의 기본 선택이고; Dolphin 3.0은 16–24GB 시스템에서 가장 넓은 콘텐츠 범위가 필요할 때 최선의 선택입니다.',
          },
          {
            q: '어두운 픽션을 쓰기 위해 무검열 모델이 필요합니까?',
            a: '대부분의 어두운 픽션에는 필요하지 않습니다. Llama 3.3 70B와 Qwen3 32B 같은 표준 인스트럭트 모델은 올바르게 프롬프트되면 폭력, 도덕적 복잡성, 어두운 심리, 악당의 내면, 트라우마, 대부분의 문학적 어두움을 거부 없이 생성합니다. 안정적으로 거부하는 것은 노골적인 성적 콘텐츠와 더 작은 극단적 시나리오 집합입니다. 어두운 픽션에 노골적인 성적 콘텐츠가 포함되지 않는다면, 먼저 표준 모델을 테스트하십시오 — 무검열 버전이 필요하지 않을 수 있습니다.',
          },
          {
            q: 'SillyTavern 또는 Agnai에서 무검열 모델을 사용할 수 있습니까?',
            a: '네. SillyTavern과 Agnai 모두 OpenAI 호환 엔드포인트에 연결됩니다 — 포트 11434에서 로컬로 실행 중인 Ollama 포함. Ollama에서 무검열 모델을 다운로드하고, `ollama serve`를 시작하고, SillyTavern이나 Agnai에서 OpenAI 호환 API를 선택하고 `http://localhost:11434/v1`로 가리키십시오. 모델 목록에서 무검열 모델을 선택하십시오. 추가 설정이 필요하지 않습니다.',
          },
          {
            q: '무검열 모델이 홈 네트워크에서 안전합니까?',
            a: 'Ollama와 LM Studio의 기본 설정인 localhost에 바인딩될 때 그렇습니다. API는 기기에서만 접근할 수 있습니다. 홈 네트워크에서 포트를 노출하는 경우(예: 전화에서 접근하기 위해), 방화벽 규칙이 신뢰할 수 있는 기기로 접근을 제한하는지 확인하십시오. 인증 없이 공개 인터넷에 Ollama API를 노출하지 마십시오 — 기본 설정에는 인증이 없습니다.',
          },
          {
            q: '로컬에서 생성한 콘텐츠는 어떻게 됩니까?',
            a: '자동으로는 아무것도 일어나지 않습니다. 로컬에서 생성된 콘텐츠는 서버로 전송되지 않고, 클라우드 서비스에 의해 기록되지 않으며, 모델 훈련에 사용되지 않습니다. 기기에서만 존재하며, 앱의 로컬 저장소(채팅 기록 파일, 캐릭터 카드 등)에 저장됩니다. 저장, 삭제, 공유를 제어합니다. 이것이 클라우드 대안에 비해 로컬 무검열 생성의 주요 구조적 프라이버시 이점입니다.',
          },
          {
            q: '같은 글쓰기 프로젝트에서 무검열 모델과 표준 모델을 혼합할 수 있습니까?',
            a: '네, 이것이 권장 워크플로우입니다. 대부분의 산문에는 표준 모델(Llama 3.3 70B, Qwen3 32B)을 사용하십시오 — 표준 모델은 대부분의 어두운 콘텐츠에 대해 고품질 문학적 산문을 생성합니다. 표준 모델이 거부하는 콘텐츠가 필요한 특정 장면을 위해 Hermes 3나 Dolphin 3.0으로 전환하십시오. 동일한 프롬프트 템플릿이 두 모델 모두에서 작동합니다; 산문 스타일은 장면별 혼합이 출력에서 감지되지 않을 만큼 충분히 일관됩니다.',
          },
          {
            q: '무검열 모델로 콘텐츠 생성이 저작권에 영향을 미칩니까?',
            a: '아니요 — AI 생성 콘텐츠의 저작권 상황은 모델이 검열되었는지 무검열인지와 관계없이 동일합니다. AI 출력에 대한 저작권법은 2026년 기준으로 대부분의 관할권에서 불확실합니다; 일반적인 입장은 인간 저작 요소(프롬프트 설계, 선택, 배치, 실질적 편집)가 보호될 수 있는 반면, 원시 AI 출력은 그렇지 않다는 것입니다. 무검열 모델을 사용해도 이 분석이 바뀌지 않습니다.',
          },
          {
            q: '무검열 파인튜닝이 일반 지식을 잃습니까?',
            a: '특정 영역에서는 미미하게. 무검열화 파인튜닝은 일반적으로 사실 검색, 수학, 코딩 벤치마크에서 기본 모델에서 약간 이탈할 수 있는 전체 정밀도 재훈련 단계입니다 — 일반적으로 표준 벤치마크에서 1–3 퍼센트 포인트. 픽션 글쓰기 작업의 경우 출력 품질에서 감지할 수 없습니다. 픽션과 기술 작업(연구 노트, 코드 검토) 모두에 같은 모델이 필요한 경우, 표준 버전과 무검열 버전을 모두 설치하고 작업에 따라 전환하십시오. Hermes 3는 완전히 제거된 모델보다 일반적인 능력을 더 잘 유지합니다.',
          },
          {
      ...
      relatedReading: {
        ...
        title: '관련 읽을거리',
        items: [
          '[2026년 창의적 글쓰기를 위한 최고의 로컬 LLM](/ko/power-local-llm/best-local-llm-creative-writing-2026) — 내러티브 생성을 위한 모델 선택, 샘플링 설정, 성능을 포함한 모델 비교.',
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      headline: '창의적 글쓰기를 위한 무검열 로컬 LLM: 작가가 필요로 할 때 (2026)',
      description: '창의적 글쓰기를 위한 무검열 로컬 LLM: 사용할 모델, Ollama 설정, 윤리적 책임, 적합한 사용 사례, 작가가 항상 유지해야 할 한계.',
      url: 'https://www.promptquorum.com/ko/power-local-llm/uncensored-local-llm-creative-writing-ethics',
      inLanguage: 'ko',
      'author': { '@type': 'Person', 'name': 'Hans Kuepper', 'sameAs': 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', 'name': 'PromptQuorum', 'url': 'https://www.promptquorum.com' },
      'proficiencyLevel': 'Intermediate',
  ...
  pt: {
    ...
    audience:
      'Escritores de ficção, romancistas, designers de narrativa de videogames e profissionais criativos que precisam de LLMs locais capazes de gerar conteúdo adulto ou sombrio sem recusas de serviços em nuvem, e que querem entender suas responsabilidades éticas nesse uso.',
    readTime: '13 min de leitura',
    educationalLevel: 'Intermediate',
    primaryTerm: 'uncensored local LLM escrita criativa',
    targetKeywords: [
      'llm local sem censura escrita criativa',
      'modelos ollama sem censura',
      'hermes 3 escrita criativa',
      'dolphin mistral sem censura configuracao',
      'llm local ficcao sombria',
    ...
    quickAnswerTop: {
      pt: {
        ...
        bullets: [
          ...
          'A linha ética de base se aplica independentemente do modelo: sem menores, sem representações não consentidas de pessoas reais.',
          'Responsabilidade de distribuição: o que você faz com o resultado tem o mesmo peso legal que qualquer outro conteúdo de autoria própria.',
          'Para frontends de roleplay, o SillyTavern e o Agnai se conectam de forma limpa aos modelos sem censura do Ollama.',
        ],
        updatedDate: '2026-05-07',
      },
    },
    toc: [
      ...
      { label: 'O que "sem censura" realmente significa', anchor: '#what-uncensored-means' },
      { label: 'Como testamos', anchor: '#how-we-tested' },
      { label: 'Quando modelos sem censura são apropriados', anchor: '#appropriate-use' },
      { label: 'Quando não são', anchor: '#inappropriate-use' },
      { label: 'Comparação de modelos', anchor: '#models' },
      { label: 'Configuração: Ollama e LM Studio', anchor: '#setup' },
      { label: 'Responsabilidades éticas que permanecem', anchor: '#ethics' },
      { label: 'Fluxo de trabalho prático', anchor: '#workflow' },
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**O Dolphin 3.0 Mistral é a opção mais leve para máquinas de 16–24 GB.** Alcance de saída sem censura mais amplo que o Hermes 3, mas aderência a instruções mais fraca em cenas complexas. Adequado para ficção curta, exploração de prompts e teste de estilo.',
          '**O SillyTavern e o Agnai se conectam de forma limpa aos modelos sem censura do Ollama.** Aponte qualquer um dos frontends para o endpoint compatível com OpenAI do Ollama e selecione o modelo sem censura. Nenhuma configuração adicional é necessária.',
        ],
      },
      quickFacts: {
        id: 'quick-facts',
        ...
        items: [
          ...
          '**Privacidade:** tudo em local — sem chamadas de API em nuvem, sem registro, sem coleta de dados de treinamento.',
          '**Limites éticos absolutos:** nenhum conteúdo sexual envolvendo menores (proibição absoluta), nenhuma representação sexual não consentida de pessoas reais identificáveis, nenhum conteúdo projetado para facilitar violência no mundo real.',
          '**Distribuição:** o resultado que você publica carrega responsabilidade de autoria independentemente do método de geração.',
        ],
      },
      whatUncensoredMeans: {
        id: 'what-uncensored-means',
        title: 'O que "sem censura" realmente significa',
        content:
          '**"Sem censura" no contexto de fine-tunes de LLM local significa treinamento de segurança RLHF (aprendizado por reforço a partir de feedback humano) reduzido — não a remoção de todas as restrições do modelo.** Modelos padrão com ajuste de instruções são treinados com camadas RLHF que os fazem recusar categorias específicas de conteúdo: conteúdo sexual explícito, violência detalhada, psicologia sombria que se assemelha a um modelo de dano real. Fine-tunes sem censura (Hermes 3, Dolphin, Wizard, Erebus) removem ou reduzem essas camadas RLHF do modelo base, deixando a capacidade de aderência a instruções intacta mas eliminando os comportamentos de recusa. O resultado é um modelo que segue seus prompts de ficção através de conteúdo sombrio sem redirecionar, moralizar ou parar no meio da cena.',
        callouts: [
          {
            type: 'tip',
            text: 'Sem censura não significa ingovernável. Modelos sem censura ainda seguem a estrutura dos prompts, respeitam os limites de palavras, mantêm a voz dos personagens e respondem às instruções de revisão. A diferença é que não adicionam avisos de conteúdo não solicitados, não recusam direções moralmente sombrias nem quebram o personagem para sinalizar que uma cena representa dano. Use prompts estruturados dos modelos de escrita de ficção como faria com qualquer outro modelo — a distinção entre system prompt e user prompt importa mais do que o nível de remoção de censura do modelo. Veja [System Prompt vs User Prompt](/pt/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference) para entender por quê.',
          },
        ],
        items: [
          '**O que é removido:** os comportamentos de recusa para categorias específicas de conteúdo (conteúdo sexual explícito, violência gráfica, conteúdo psicológico sombrio).',
          '**O que é preservado:** a aderência a instruções, a consistência dos personagens, a adesão à estrutura dos prompts, a qualidade linguística.',
          '**Graus de remoção de censura:** o Hermes 3 está seletivamente sem censura (conteúdo adulto sim, mas preserva algumas barreiras para conteúdo extremo). A série Dolphin está mais amplamente sem censura. Modelos totalmente abliterados (Wizard-Uncensored, Erebus) têm a remoção de barreiras mais agressiva — e a aderência a instruções mais fraca para tarefas de ficção complexas.',
          '**A qualidade do modelo base importa:** a remoção de censura degrada a qualidade das instruções se o modelo base for fraco. O Hermes 3 sobre o Llama 3.3 70B preserva a forte aderência a instruções do Llama 3.3; o Dolphin 3.0 sobre o Mistral Small é limitado pela base menor.',
        ],
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: 'Fine-tunes de LLM local sem censura removem as camadas de recusa de segurança RLHF enquanto preservam a capacidade de aderência a instruções — seguem direções criativas sombrias sem redirecionar, moralizar ou parar no meio da cena.',
          },
          {
            type: 'plain-terms',
            text: 'Um modelo padrão como o Llama 3.3 70B para no meio de uma cena que representa tortura, o monólogo de um vilão moralmente complexo ou conteúdo romântico explícito, e recusa ou suaviza o resultado. O Hermes 3 (a versão sem censura sobre a mesma base) segue seu prompt através da mesma cena no mesmo nível de qualidade sem interrupção. A qualidade da prosa é equivalente; a diferença está na camada de recusa.',
          },
        ],
      },
      howWeTested: {
        ...
        title: 'Como testamos',
        content:
          'Os veredictos de modelos neste guia baseiam-se em um pequeno teste qualitativo — um indicador de direção, não um benchmark revisado por pares. Para um tema em que os leitores decidem se confiam em recomendações de modelos sobre um assunto sensível, a transparência sobre o método importa.',
        items: [
          '**Conjunto de prompts:** 10 prompts em 5 categorias — monólogo do vilão, cena de romance adulto, violência gráfica em ficção de guerra, narrador moralmente complexo, cena psicológica sombria (2 prompts por categoria).',
          '**Execuções por modelo:** cada prompt executado 3 vezes por modelo.',
          '**Taxa de recusa:** porcentagem de execuções em que o modelo recusou, redirecionou ou suavizou o conteúdo solicitado sem instrução.',
          '**Medição de desvio:** porcentagem de execuções em que o modelo adicionou escalada não solicitada — extremidade gratuita além do que o prompt especificava.',
          '**Backend:** Ollama 0.5+ com quantização Q4_K_M para todos os modelos.',
          '**Restrição de honestidade:** pequeno teste qualitativo. Os resultados indicam diferenças de direção entre modelos, não uma medição numérica precisa. Trate os valores de Desvio para Extremos e Taxa de Recusa da tabela como julgamentos representativos.',
        ],
      },
      appropriateUse: {
        id: 'appropriate-use',
        title: 'Quando modelos sem censura são apropriados para ficção',
        content:
          '**Modelos sem censura são apropriados quando sua ficção genuinamente precisa de conteúdo que os serviços em nuvem recusam, seu público é adulto e o propósito é a expressão criativa.** A maioria dos escritores de ficção recorre a modelos sem censura para um ou mais destes casos de uso específicos.',
        items: [
          '**Psicologia e monólogos de vilões:** personagens vilões moralmente coerentes que não são interrompidos pelo modelo quebrando o personagem para adicionar avisos no meio do monólogo.',
          '**Conteúdo romântico e sexual adulto:** cenas explícitas entre personagens fictícios adultos em romance, erótica ou ficção literária que exigem conteúdo sexual que os serviços em nuvem bloqueiam.',
          '**Violência gráfica em ficção de gênero:** romances de guerra, thrillers policiais, terror — cenas em que a violência é fundamental para o impacto emocional e suavizá-la destrói a cena.',
          '**Trauma e escuridão psicológica:** narrativas de sobreviventes, ficção sobre vícios, histórias de abuso — conteúdo que exige uma representação sem filtros para ter peso autêntico.',
          '**Narradores moralmente não confiáveis:** narradores que estão errados, que racionalizam o dano, que são cruéis ou intolerantes dentro da ficção — personagens que exigem que o modelo expresse pontos de vista que normalmente recusaria.',
          '**Roleplay sombrio e ficção colaborativa:** cenários de longa duração envolvendo conflito, complexidade moral e temas adultos em que um modelo padrão quebra a ficção para inserir recusas.',
        ],
        callouts: [
          {
            type: 'tip',
            text: 'Antes de trocar para um modelo sem censura, teste seu prompt primeiro em um modelo padrão com ajuste de instruções. O Llama 3.3 70B e o Qwen3 32B com um system prompt bem estruturado e restrições de cena geram a maior parte do conteúdo literário adulto sem recusas. Fine-tunes sem censura agregam mais valor para conteúdo sexual explícito e as representações mais extremas de violência — não para escuridão psicológica, complexidade moral ou temas sombrios em geral.',
          },
        ],
      },
      inappropriateUse: {
        id: 'inappropriate-use',
        title: 'Quando modelos sem censura não são apropriados',
        content:
          '**A ausência de aplicação em nuvem não significa a ausência de obrigações legais e éticas.** Estas categorias representam limites absolutos que se aplicam independentemente do modelo, da plataforma ou de a sua máquina estar isolada da rede.',
        callouts: [
          {
            type: 'warning',
            text: 'Limites absolutos independentemente da configuração. Nenhuma configuração local elimina a responsabilidade legal ou ética por: (1) conteúdo sexual envolvendo menores — proibição absoluta por lei em praticamente todas as jurisdições; (2) representações sexuais não consentidas de pessoas reais identificáveis — isso constitui NCII (imagens íntimas não consensuais) independentemente do método de geração; (3) conteúdo projetado para facilitar violência no mundo real contra alvos específicos. Esses limites se aplicam quer seu modelo rode em local, em nuvem ou em uma máquina isolada da rede.',
          },
        ],
        items: [
          '**Conteúdo sexual envolvendo menores:** proibição legal absoluta em todas as principais jurisdições independentemente do enquadramento fictício ou do método de geração. Isso não é uma política do modelo — é a lei.',
          '**Representações sexuais não consentidas de pessoas reais:** as leis sobre NCII se aplicam a conteúdo gerado por IA de pessoas reais identificáveis em um número crescente de jurisdições. "Gerado por IA" não é uma defesa.',
          '**Conteúdo projetado para facilitar dano real:** usar um enquadramento fictício para extrair informações ou conteúdo que permita diretamente violência ou dano no mundo real elimina a proteção fictícia.',
          '**Distribuição pública sem responsabilidade de autoria:** o conteúdo que você publica, distribui ou compartilha carrega responsabilidade de autoria. "Uma IA escreveu" não transfere essa responsabilidade.',
          '**Ficção de assédio:** gerar ficção cujo propósito é prejudicar, intimidar ou assediar uma pessoa real específica — independentemente de ser enquadrada como ficção.',
        ],
      },
      models: {
        id: 'models',
        title: 'Comparação de modelos: opções sem censura para ficção',
        content:
          '**Nem todos os modelos sem censura são iguais — o grau de remoção de RLHF e a qualidade do modelo base importam para os casos de uso de escrita de ficção.**',
        columns: ['Modelo', 'Base', 'VRAM (Q4)', 'Taxa de recusa', 'Qualidade de instruções', 'Desvio para extremos', 'Ideal para'],
        rows: [
          { 'Modelo': 'Hermes 3 [Llama](https://ollama.com/library/llama3.3) 3.3 70B', 'Base': 'Llama 3.3 70B', 'VRAM (Q4)': '~42 GB', 'Taxa de recusa': 'Seletiva', 'Qualidade de instruções': '★★★★★', 'Desvio para extremos': 'Baixo', 'Ideal para': 'Opção padrão para ficção séria — melhor aderência a instruções + capacidade sem censura' },
          { 'Modelo': 'Dolphin 3.0 [Mistral](https://ollama.com/library/mistral) 24B', 'Base': 'Mistral 24B', 'VRAM (Q4)': '~16 GB', 'Taxa de recusa': 'Ampla', 'Qualidade de instruções': '★★★★☆', 'Desvio para extremos': 'Baixo-moderado', 'Ideal para': 'Sistemas de 16–24 GB; conteúdo adulto em um alcance mais amplo' },
          { 'Modelo': 'Dolphin 3.0 Mistral Small', 'Base': 'Mistral Small', 'VRAM (Q4)': '~8 GB', 'Taxa de recusa': 'Ampla', 'Qualidade de instruções': '★★★☆☆', 'Desvio para extremos': 'Moderado', 'Ideal para': 'Sistemas com pouca VRAM; rascunhos curtos, teste de prompts' },
          { 'Modelo': 'Hermes 3 Llama 3.2 8B', 'Base': 'Llama 3.2 8B', 'VRAM (Q4)': '~5 GB', 'Taxa de recusa': 'Seletiva', 'Qualidade de instruções': '★★★☆☆', 'Desvio para extremos': 'Baixo', 'Ideal para': 'Recursos limitados; diálogos e cenas mais curtas' },
          { 'Modelo': 'Standard Llama 3.3 70B', 'Base': 'Llama 3.3 70B', 'VRAM (Q4)': '~42 GB', 'Taxa de recusa': 'Limitada', 'Qualidade de instruções': '★★★★★', 'Desvio para extremos': 'Nenhum', 'Ideal para': 'Temas sombrios, complexidade moral, violência — sem precisar de conteúdo sexual explícito' },
        ],
        callouts: [
          {
            type: 'tip',
            text: 'Comece com o Hermes 3, não com o fine-tune sem censura mais agressivo. Modelos totalmente abliterados (Wizard-Uncensored, Erebus) têm o alcance de conteúdo mais amplo mas uma aderência a instruções perceptivelmente mais fraca em tarefas de ficção complexas — desviam-se das restrições mais rápido, produzem prosa de menor qualidade em gerações mais longas e mantêm a voz dos personagens com menos confiabilidade. Para ficção que exige tanto conteúdo sem censura quanto prosa de qualidade, o Hermes 3 é a melhor compensação.',
          },
        ],
        items: [
          ...
          image: '/images/uncensored-local-llm-creative-writing-ethics-model-comparison-hero-pt.webp',
      ...
      setup: {
        ...
        content:
          '**Tanto o Ollama quanto o LM Studio servem modelos sem censura por meio de uma API local compatível com OpenAI — o que significa que o SillyTavern, o Agnai e qualquer outra ferramenta que fale com um endpoint local funcionam sem configuração adicional.**',
        promptExamples: [
          {
            label: 'Ollama: baixar e executar o Hermes 3',
            text: '# Pull the model\nollama pull nous-hermes3:70b-llama3.3-q4_K_M\n\n# Run it\nollama run nous-hermes3:70b-llama3.3-q4_K_M\n\n# Serve via API (for SillyTavern / Agnai / LM Studio-compatible tools)\nollama serve\n# API available at http://localhost:11434',
          },
          {
            label: 'Ollama: baixar e executar o Dolphin 3.0 Mistral 24B',
            text: '# Pull the model\nollama pull dolphin3:24b-mistral-q4_K_M\n\n# Verify it loaded\nollama list\n\n# Run a test prompt\nollama run dolphin3:24b-mistral-q4_K_M "Write a 100-word villain monologue, gothic register, no disclaimers."',
          },
        ],
        items: [
        ...
        callouts: [
          {
            type: 'tip',
            text: 'Para escritores que querem manter os modelos sem censura e os padrão separados, crie duas instâncias do Ollama em portas diferentes usando a variável de ambiente OLLAMA_HOST. Exemplo: OLLAMA_HOST=127.0.0.1:11435 ollama serve. Isso permite apontar o SillyTavern ou o Agnai para a instância sem censura enquanto mantém sua instância padrão do Ollama para outras tarefas.',
          },
        ],
      },
      ethics: {
        id: 'ethics',
        title: 'Responsabilidades éticas que permanecem',
        content:
          '**Rodar um modelo em local sem aplicação de políticas em nuvem não elimina suas responsabilidades como escritor e editor.** O arcabouço ético que se aplica à ficção de autoria humana se aplica igualmente à ficção assistida por IA.',
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: 'A configuração local elimina as restrições de ToS em nuvem, mas não elimina a responsabilidade legal de autoria, a responsabilidade por facilitação de dano nem as obrigações éticas que se aplicam a qualquer obra criativa publicada.',
          },
          {
            type: 'plain-terms',
            text: 'Pense no modelo local sem censura como um assistente de escrita muito capaz que seguirá qualquer direção que você der. O peso legal e ético do que você produz e distribui recai sobre você, não sobre a ferramenta. As mesmas leis que se aplicam à ficção de autoria humana — sobre menores, pessoas reais, obscenidade e incitação — se aplicam à ficção gerada por IA distribuída publicamente. O fato de nenhuma plataforma impedir você de gerar o conteúdo em local não muda aquilo pelo que você é legalmente responsável se o publicar.',
          },
        ],
        items: [
          '**Responsabilidade de autoria:** você é o autor da ficção assistida por IA. "A IA gerou" não transfere o copyright, não elimina a responsabilidade nem constitui uma defesa para conteúdo que viole a lei.',
          '**Consciência da jurisdição:** as leis sobre obscenidade, NCII e conteúdo nocivo variam por jurisdição. Conteúdo legal de produzir em um país pode constituir um crime de distribuir em outro.',
          '**Pessoas reais:** gerar conteúdo fictício negativo sobre pessoas reais identificáveis — mesmo em enquadramentos claramente fictícios — carrega risco de difamação e NCII dependendo do conteúdo.',
          '**Verificação de idade para distribuição:** se você distribui conteúdo adulto ou maduro produzido com modelos sem censura em uma plataforma pública, as obrigações de verificação de idade que se aplicam a qualquer editor de conteúdo adulto se aplicam a você.',
          '**Arquivamento responsável:** o conteúdo sem censura gerado localmente deve ser tratado com a mesma disciplina de armazenamento que qualquer outro material sensível — não armazenar em diretórios sincronizados com a nuvem, não compartilhar involuntariamente.',
        ],
        callouts: [
          {
            type: 'warning',
            text: 'O erro ético mais comum entre escritores que usam modelos sem censura é tratar a geração local como uma zona livre de contexto. A geração local significa que não há aplicação de políticas de plataforma — não significa que não há lei, responsabilidade nem dano. A ausência de um moderador de conteúdo não é uma autorização.',
          },
        ],
      },
      workflow: {
        id: 'workflow',
        title: 'Fluxo de trabalho prático para escritores de ficção',
        content:
          '**A maioria dos escritores de ficção que usam modelos sem censura os utiliza para cenas específicas em vez de como substituto padrão do seu modelo padrão.** O fluxo de trabalho a seguir apoia esse uso direcionado.',
        items: [
          '**Rascunhe as cenas padrão com um modelo padrão.** O Llama 3.3 70B ou o Qwen3 32B lidam com a maior parte da prosa literária, incluindo temas sombrios, complexidade moral e profundidade psicológica. Reserve o modelo sem censura para cenas que especificamente exijam conteúdo que o modelo padrão recusa.',
          '**Troque para o modelo sem censura em cenas direcionadas.** No Ollama, execute `ollama run nous-hermes3:70b-llama3.3-q4_K_M` para a cena específica. No SillyTavern, troque o modelo nas configurações de API por sessão. Nenhum dado cruza entre as sessões.',
          '**Use os mesmos modelos de prompts.** O modelo de cena de 5 partes, a estrutura de diálogo de subtexto e os prompts de contradição de personagens de [Prompts de LLM local para escritores de ficção](/pt/power-local-llm/local-llm-prompts-for-fiction-writers) funcionam de maneira idêntica nos modelos sem censura. Você não precisa de estruturas de prompt diferentes.',
          '**Não adicione instruções de geração de conteúdo que não apareceriam em um brief de autoria humana por razões legais.** O modelo é uma ferramenta, não uma estrutura de permissão. Se você não incluiria uma instrução em um brief para um ilustrador ou ghostwriter humano por razões legais, não a inclua no prompt do modelo.',
          '**Revise o resultado antes de distribuí-lo.** Modelos sem censura ocasionalmente produzem conteúdo que supera a escuridão solicitada ou desliza para estereótipos. A revisão editorial padrão de conteúdo assistido por IA se aplica.',
        ],
        callouts: [
          {
            type: 'tip',
          ...
          image: '/images/uncensored-local-llm-creative-writing-ethics-workflow-hero-pt.webp',
      ...
      commonMistakes: {
        ...
        title: 'Erros comuns',
        items: [
          '**Recorrer por padrão ao modelo sem censura mais agressivo.** Modelos totalmente abliterados (Wizard-Uncensored, Erebus) têm a aderência a instruções mais fraca para cenas complexas. O Hermes 3 é uma melhor compensação para a qualidade da ficção.',
          '**Usar modelos sem censura para conteúdo que modelos padrão gerariam.** A complexidade moral, a psicologia sombria, a violência e os temas adultos em prosa literária raramente exigem um fine-tune sem censura. Saiba exatamente o que você precisa antes de trocar.',
          '**Tratar a geração local como uma zona legalmente livre de contexto.** A ausência de aplicação de políticas em nuvem não significa ausência de lei. As responsabilidades de autoria para distribuição, pessoas reais e menores se aplicam independentemente.',
          '**Não especificar limites de palavras.** Modelos sem censura enchem o conteúdo sombrio para ocupar espaço com a mesma facilidade que qualquer outro modelo. Use as mesmas restrições de limite de palavras dos modelos de ficção.',
          '**Armazenar o resultado em diretórios sincronizados com a nuvem.** O conteúdo adulto gerado localmente sincronizado com o iCloud, o Google Drive ou o OneDrive pode violar os termos de serviço dessas plataformas. Armazene somente localmente.',
        ],
      },
      sources: {
        id: 'sources',
        title: 'Fontes',
        items: [
          'Ficha do modelo Hermes 3 e metodologia de fine-tuning — [Nous Research](https://nousresearch.com)',
          'Documentação técnica do Dolphin 3.0 Mistral — [Cognitive Computations / Eric Hartford](https://huggingface.co/cognitivecomputations)',
          'Visão geral de técnicas de RLHF e alinhamento — [Anthropic Research](https://anthropic.com/research)',
          'Artigo 5 da Lei de IA da UE — práticas de IA proibidas, incluindo conteúdo envolvendo menores — [EUR-Lex](https://eur-lex.europa.eu)',
          'NCII (imagens íntimas não consensuais) — visão geral do arcabouço legal — [Cyber Civil Rights Initiative](https://cybercivilrights.org)',
        ],
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          {
            q: 'É legal executar LLMs locais sem censura?',
            a: 'Executar um LLM local sem censura é legal na maioria das jurisdições — não existe nenhuma lei contra possuir software de IA de código aberto. O que você gera e distribui com ele está sujeito às mesmas leis que qualquer outro conteúdo de autoria própria: lei de obscenidade, lei de NCII, lei de difamação e leis sobre conteúdo envolvendo menores. Legal de executar não significa legal de publicar, compartilhar ou distribuir sem limite.',
          },
          {
            q: 'Qual é a diferença entre o Hermes 3 e o Dolphin 3.0?',
            a: 'O Hermes 3 (Nous Research) está seletivamente sem censura — reduz as recusas para conteúdo adulto enquanto preserva algumas barreiras para as categorias extremas. A aderência a instruções é excelente, próxima do modelo base Llama 3.3 70B. O Dolphin 3.0 (Cognitive Computations) está mais amplamente sem censura em um alcance de conteúdo mais amplo, mas a aderência a instruções é ligeiramente mais fraca em cenas complexas com múltiplas restrições. O Hermes 3 é a melhor opção padrão para ficção em que a qualidade da prosa importa; o Dolphin 3.0 é a melhor opção quando você precisa do alcance de conteúdo mais amplo em um sistema de 16–24 GB.',
          },
          {
            q: 'Preciso de um modelo sem censura para escrever ficção sombria?',
            a: 'Não, para a maioria da ficção sombria. Modelos padrão com ajuste de instruções como o Llama 3.3 70B e o Qwen3 32B geram violência, complexidade moral, psicologia sombria, interioridade do vilão, trauma e a maior parte da escuridão literária sem recusas quando recebem o prompt correto. O que eles recusam de forma confiável é conteúdo sexual explícito e um conjunto mais restrito de cenários extremos. Se sua ficção sombria não inclui conteúdo sexual explícito, teste primeiro um modelo padrão — você pode não precisar da versão sem censura.',
          },
          {
            q: 'Posso usar modelos sem censura no SillyTavern ou no Agnai?',
            a: 'Sim. Tanto o SillyTavern quanto o Agnai se conectam a qualquer endpoint compatível com OpenAI — incluindo o Ollama rodando localmente na porta 11434. Baixe o modelo sem censura no Ollama, inicie `ollama serve`, e no SillyTavern ou no Agnai selecione a API compatível com OpenAI e aponte-a para `http://localhost:11434/v1`. Selecione seu modelo sem censura na lista de modelos. Nenhuma configuração adicional é necessária.',
          },
          {
            q: 'Modelos sem censura são seguros para usar em uma rede doméstica?',
            a: 'Sim, quando configurados para vincular ao localhost (a configuração padrão no Ollama e no LM Studio). A API só é acessível a partir da sua máquina. Se você expuser a porta na sua rede doméstica (por exemplo, para acessar de um celular), garanta que as regras de firewall restrinjam o acesso a dispositivos confiáveis. Não exponha a API do Ollama à internet pública sem autenticação — a configuração padrão não tem autenticação.',
          },
          {
            q: 'O que acontece com o conteúdo que eu gero localmente?',
            a: 'Nada acontece com ele automaticamente. O conteúdo gerado localmente não é enviado a nenhum servidor, registrado por nenhum serviço em nuvem nem usado para o treinamento do modelo. Ele existe apenas no seu dispositivo, no armazenamento local do seu aplicativo (arquivos de histórico de chat, fichas de personagens, etc.). Você controla o que guarda, o que apaga e o que compartilha. Essa é a principal vantagem estrutural de privacidade da geração local sem censura frente às alternativas em nuvem.',
          },
          {
            q: 'Posso misturar modelos sem censura e padrão no mesmo projeto de escrita?',
            a: 'Sim, e este é o fluxo de trabalho recomendado. Use um modelo padrão (Llama 3.3 70B, Qwen3 32B) para a maior parte da prosa — modelos padrão produzem prosa literária de alta qualidade para a maior parte do conteúdo sombrio. Troque para o Hermes 3 ou o Dolphin 3.0 em cenas específicas que exijam conteúdo que o modelo padrão recusa. Os mesmos modelos de prompts funcionam em ambos; o estilo da prosa é consistente o suficiente para que a mistura por cena não seja detectável no resultado.',
          },
          {
            q: 'Gerar conteúdo com um modelo sem censura afeta o copyright?',
            a: 'Não — a situação de copyright para conteúdo gerado por IA é idêntica independentemente de o modelo ser censurado ou sem censura. A lei de copyright para a saída de IA é incerta na maioria das jurisdições em 2026; a posição geral é que os elementos de autoria humana (design de prompts, seleção, disposição, edição substancial) podem ser protegíveis, enquanto a saída bruta de IA não é. Usar um modelo sem censura não muda essa análise.',
          },
          {
            q: 'Fine-tunes sem censura perdem conhecimento geral?',
            a: 'Marginalmente, em áreas restritas. Fine-tunes de remoção de censura são tipicamente passes de retreinamento de precisão completa que podem desviar-se ligeiramente do modelo base em recuperação de fatos, matemática e benchmarks de programação — geralmente de 1 a 3 pontos percentuais em benchmarks padrão. Para tarefas de escrita de ficção, isso é indetectável na qualidade do resultado. Se você precisa do mesmo modelo para ficção e trabalho técnico (notas de pesquisa, revisão de código), mantenha tanto a versão padrão quanto a sem censura instaladas e troque por tarefa. O Hermes 3 preserva a capacidade geral melhor que os modelos totalmente abliterados.',
          },
          {
      ...
      relatedReading: {
        ...
        items: [
          '[Melhores LLMs locais para escrita criativa 2026](/pt/power-local-llm/best-local-llm-creative-writing-2026) — comparação de modelos que inclui as seleções de modelos, os ajustes de amostragem e o desempenho para a geração narrativa.',
  ...
  ar: {
    ...
    audience:
      'كتّاب الخيال والروائيون ومصممو السرد في الألعاب والمحترفون الإبداعيون الذين يحتاجون نماذج LLM محلية قادرة على توليد محتوى بالغ أو مظلم دون رفض الخدمات السحابية، ويريدون فهم مسؤولياتهم الأخلاقية في هذا الاستخدام.',
    readTime: '13 دقيقة قراءة',
    educationalLevel: 'Intermediate',
    primaryTerm: 'نماذج LLM محلية بدون قيود كتابة إبداعية',
    targetKeywords: [
      'llm محلي بدون قيود كتابة إبداعية',
      'نماذج ollama بدون قيود',
      'hermes 3 كتابة إبداعية',
      'dolphin mistral بدون قيود إعداد',
      'llm محلي خيال مظلم',
    ...
    quickAnswerTop: {
      ar: {
        ...
        bullets: [
          ...
          'الخط الأخلاقي الأساسي مطبّق بصرف النظر عن النموذج: لا قاصرين، لا تمثيلات غير موافق عليها لأشخاص حقيقيين.',
          'مسؤولية التوزيع: ما تنشره يحمل نفس المسؤولية القانونية كأي محتوى تأليف ذاتي آخر.',
          'لواجهات الـ roleplay: SillyTavern و Agnai يتصلان بسلاسة مع نماذج Ollama بدون قيود.',
        ],
        updatedDate: '2026-05-07',
      },
    },
    toc: [
      ...
      { label: 'ماذا تعني "بدون قيود" حقًا', anchor: '#what-uncensored-means' },
      { label: 'كيف اختبرنا', anchor: '#how-we-tested' },
      { label: 'متى تكون النماذج بدون قيود مناسبة', anchor: '#appropriate-use' },
      { label: 'متى لا تكون مناسبة', anchor: '#inappropriate-use' },
      { label: 'مقارنة النماذج', anchor: '#models' },
      { label: 'الإعداد: Ollama و LM Studio', anchor: '#setup' },
      { label: 'المسؤوليات الأخلاقية التي تبقى', anchor: '#ethics' },
      { label: 'سير العمل العملي', anchor: '#workflow' },
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**Dolphin 3.0 Mistral هو الخيار الأخف لأجهزة 16-24 جيجابايت.** نطاق ناتج أوسع بدون قيود من Hermes 3، لكن اتباع تعليمات أضعف في المشاهد المعقدة. مناسب للخيال القصير واستكشاف الموجّهات واختبار الأسلوب.',
          '**SillyTavern و Agnai يتصلان بسلاسة مع نماذج Ollama بدون قيود.** وجّه أيًا من الواجهتين إلى نقطة النهاية المتوافقة مع OpenAI في Ollama واختر النموذج بدون قيود. لا إعداد إضافي مطلوب.',
        ],
      },
      quickFacts: {
        id: 'quick-facts',
        ...
        items: [
          ...
          '**الخصوصية:** كل شيء محلي — لا مكالمات API سحابية، لا سجلات، لا جمع بيانات تدريب.',
          '**الحدود الأخلاقية المطلقة:** لا محتوى جنسيًا يُشرك قاصرين (حظر مطلق)، لا تمثيلات جنسية غير موافق عليها لأشخاص حقيقيين محددين، لا محتوى مُصمَّمًا لتسهيل عنف واقعي.',
          '**التوزيع:** المحتوى الذي تنشره يحمل مسؤولية التأليف بصرف النظر عن طريقة التوليد.',
        ],
      },
      whatUncensoredMeans: {
        id: 'what-uncensored-means',
        title: 'ماذا تعني "بدون قيود" حقًا',
        content:
          '**"بدون قيود" في سياق النسخ المعدَّلة من نماذج LLM المحلية يعني تدريب أمان RLHF (التعلم المعزز من ردود الفعل البشرية) مُخفَّفًا، لا إزالة جميع قيود النموذج.** النماذج القياسية ذات الضبط بالتعليمات تُدرَّب بطبقات RLHF تجعلها ترفض فئات محددة من المحتوى: المحتوى الجنسي الصريح، العنف المفصَّل، علم النفس المظلم الذي يشبه قالب أذى واقعي. النسخ المعدَّلة بدون قيود (Hermes 3، Dolphin، Wizard، Erebus) تزيل أو تخفف طبقات RLHF هذه من النموذج الأساسي، تاركةً قدرة اتباع التعليمات سليمة لكن مزيلةً سلوكيات الرفض. النتيجة نموذج يتبع موجّهات الخيال عبر محتوى مظلم دون إعادة توجيه أو وعظ أو توقف في منتصف المشهد.',
        callouts: [
          {
            type: 'tip',
            text: 'بدون قيود لا تعني غير قابلة للتحكم. النماذج بدون قيود تتبع بنية الموجّهات وتحترم حدود الكلمات وتحافظ على صوت الشخصيات وتستجيب لتعليمات المراجعة. الفرق أنها لا تضيف تحذيرات محتوى غير مطلوبة، لا ترفض الاتجاهات الأخلاقية المظلمة ولا تكسر الشخصية للإشارة إلى أن مشهدًا يمثل أذى. استخدم موجّهات منظمة من قوالب كتابة الخيال كما تفعل مع أي نموذج آخر — التمييز بين system prompt و user prompt أهم من مستوى إزالة القيود في النموذج.',
          },
        ],
        items: [
          '**ما يُزال:** سلوكيات الرفض لفئات محددة من المحتوى (المحتوى الجنسي الصريح، العنف الرسومي، المحتوى النفسي المظلم).',
          '**ما يبقى:** اتباع التعليمات، اتساق الشخصيات، الالتزام ببنية الموجّهات، الجودة اللغوية.',
          '**درجات إزالة القيود:** Hermes 3 محدود إزالة القيود (المحتوى البالغ نعم، لكن يحتفظ ببعض الحواجز للمحتوى المتطرف). سلسلة Dolphin أوسع إزالة للقيود. النماذج المُعَدَّلة كليًا (Wizard-Uncensored، Erebus) لديها أعدوانية إزالة حواجز — واتباع تعليمات أضعف لمهام الخيال المعقدة.',
          '**جودة النموذج الأساسي تهم:** إزالة القيود تُدهور جودة التعليمات إذا كان النموذج الأساسي ضعيفًا. Hermes 3 على Llama 3.3 70B يحتفظ باتباع التعليمات القوي لـ Llama 3.3؛ Dolphin 3.0 على Mistral Small مُقيَّد بالأساس الأصغر.',
        ],
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: 'النسخ المعدَّلة من نماذج LLM المحلية بدون قيود تزيل طبقات رفض أمان RLHF مع الاحتفاظ بقدرة اتباع التعليمات — تتبع التوجيهات الإبداعية المظلمة دون إعادة توجيه أو وعظ أو توقف في منتصف المشهد.',
          },
          {
            type: 'plain-terms',
            text: 'نموذج قياسي مثل Llama 3.3 70B يتوقف في منتصف مشهد يمثل تعذيبًا أو مونولوج شرير معقد أخلاقيًا أو محتوى رومانسيًا صريحًا، ويرفض أو يلطّف الناتج. Hermes 3 (النسخة المعدَّلة بدون قيود على نفس الأساس) يتبع موجّهك خلال نفس المشهد بنفس مستوى الجودة دون انقطاع. جودة النثر متكافئة؛ الفرق في طبقة الرفض.',
          },
        ],
      },
      howWeTested: {
        ...
        title: 'كيف اختبرنا',
        content:
          'الأحكام على النماذج في هذا الدليل مستندة إلى اختبار نوعي صغير — مؤشر اتجاه، لا معيار محكَّم بالأقران. لموضوع يقرر فيه القراء الوثوق بتوصيات النماذج في مسألة حساسة، الشفافية حول المنهج مهمة.',
        items: [
          '**مجموعة الموجّهات:** 10 موجّهات في 5 فئات — مونولوج الشرير، مشهد رومانسي بالغ، عنف رسومي في خيال حرب، راوٍ أخلاقيًا غير موثوق، مشهد نفسي مظلم (موجّهان لكل فئة).',
          '**تشغيلات لكل نموذج:** كل موجّه يُشغَّل 3 مرات لكل نموذج.',
          '**معدل الرفض:** نسبة التشغيلات التي رفض فيها النموذج أو أعاد توجيه أو لطّف المحتوى المطلوب دون تعليمات.',
          '**قياس الانجراف:** نسبة التشغيلات التي أضاف فيها النموذج تصعيدًا غير مطلوب — تطرف مجاني يتجاوز ما حدده الموجّه.',
          '**الخلفية:** Ollama 0.5+ مع تكميم Q4_K_M لجميع النماذج.',
          '**قيد الأمانة:** اختبار نوعي صغير. النتائج تشير إلى اختلافات الاتجاه بين النماذج، لا قياس عددي دقيق. عامل قيم الانجراف نحو التطرف ومعدل الرفض في الجدول كأحكام تمثيلية.',
        ],
      },
      appropriateUse: {
        id: 'appropriate-use',
        title: 'متى تكون النماذج بدون قيود مناسبة للخيال',
        content:
          '**النماذج بدون قيود مناسبة حين يحتاج خيالك فعلًا محتوى ترفضه الخدمات السحابية، وجمهورك بالغ، والغرض تعبير إبداعي.** معظم كتّاب الخيال يلجأون إلى نماذج بدون قيود لواحدة أو أكثر من حالات الاستخدام المحددة هذه.',
        items: [
          '**علم نفس الأشرار ومونولوجاتهم:** شخصيات شريرة أخلاقيًا متسقة لا تتعرض لانقطاع من النموذج الذي يكسر الشخصية لإضافة تحذيرات في منتصف المونولوج.',
          '**المحتوى الرومانسي والجنسي البالغ:** مشاهد صريحة بين شخصيات خيالية بالغة في روايات الرومانس أو الإيروتيكا أو الخيال الأدبي التي تتطلب محتوى جنسيًا تحجبه الخدمات السحابية.',
          '**العنف الرسومي في خيال النوع:** روايات حرب وإثارة جريمة ورعب — مشاهد حيث العنف أساسي للأثر العاطفي وتلطيفه يدمر المشهد.',
          '**الصدمة والظلام النفسي:** روايات الناجين وخيال الإدمان وقصص الإساءة — محتوى يتطلب تمثيلًا غير مرشَّح لامتلاك وزن أصيل.',
          '**الرواة الأخلاقيون غير الموثوقين:** رواة مخطئون يبررون الأذى أو قساة أو متعصبون داخل الخيال — شخصيات تتطلب من النموذج التعبير عن وجهات نظر يرفضها عادةً.',
          '**الـ roleplay المظلم والخيال التعاوني:** سيناريوهات طويلة الأمد مع صراعات وتعقيد أخلاقي وموضوعات بالغة حيث نموذج قياسي يكسر الخيال ليُدرج رفضًا.',
        ],
        callouts: [
          {
            type: 'tip',
            text: 'قبل التبديل إلى نموذج بدون قيود، اختبر موجّهك على نموذج قياسي ذي ضبط تعليمات. Llama 3.3 70B و Qwen3 32B مع system prompt منظم جيدًا وقيود المشهد يولّدان معظم المحتوى الأدبي البالغ دون رفض. النسخ المعدَّلة بدون قيود تضيف قيمة أكبر للمحتوى الجنسي الصريح وتمثيلات العنف الأكثر تطرفًا — لا للظلام النفسي والتعقيد الأخلاقي والموضوعات المظلمة بشكل عام.',
          },
        ],
      },
      inappropriateUse: {
        id: 'inappropriate-use',
        title: 'متى لا تكون النماذج بدون قيود مناسبة',
        content:
          '**غياب التطبيق السحابي لا يعني غياب الالتزامات القانونية والأخلاقية.** هذه الفئات تمثل حدودًا مطلقة تسري بصرف النظر عن النموذج أو المنصة أو ما إذا كان جهازك معزولًا عن الشبكة.',
        callouts: [
          {
            type: 'warning',
            text: 'حدود مطلقة بصرف النظر عن الإعداد. لا إعداد محلي يلغي المسؤولية القانونية أو الأخلاقية عن: (1) المحتوى الجنسي الذي يُشرك قاصرين — حظر مطلق بموجب القانون في كل الولايات القضائية تقريبًا؛ (2) التمثيلات الجنسية غير الموافق عليها لأشخاص حقيقيين محددين — هذا يشكّل NCII (صور حميمة غير موافق عليها) بصرف النظر عن طريقة التوليد؛ (3) المحتوى المُصمَّم لتسهيل عنف واقعي ضد أهداف محددة. هذه الحدود تسري سواء عمل نموذجك محليًا أو سحابيًا أو على جهاز معزول.',
          },
        ],
        items: [
          '**المحتوى الجنسي الذي يُشرك قاصرين:** حظر قانوني مطلق في جميع الولايات القضائية الرئيسية، بصرف النظر عن الإطار الخيالي أو طريقة التوليد. هذا ليس سياسة نموذج — هذا القانون.',
          '**التمثيلات الجنسية غير الموافق عليها لأشخاص حقيقيين:** قوانين NCII تسري على المحتوى المولَّد بالذكاء الاصطناعي لأشخاص حقيقيين محددين في عدد متزايد من الولايات القضائية. "ولّده الذكاء الاصطناعي" ليس دفاعًا.',
          '**المحتوى المُصمَّم لتسهيل ضرر واقعي:** استخدام إطار خيالي لاستخراج معلومات أو محتوى يُتيح مباشرةً عنفًا أو ضررًا واقعيًا يزيل الحماية الخيالية.',
          '**التوزيع العام دون مسؤولية التأليف:** المحتوى الذي تنشره أو توزعه أو تشاركه يحمل مسؤولية التأليف. "ذكاء اصطناعي ولّده" لا تنقل تلك المسؤولية.',
          '**خيال المضايقة:** توليد خيال يهدف إلى إيذاء شخص حقيقي محدد أو تخويفه أو مضايقته — بصرف النظر عما إذا كان مُؤطَّرًا كخيال.',
        ],
      },
      models: {
        id: 'models',
        title: 'مقارنة النماذج: الخيارات بدون قيود للخيال',
        content:
        ...
        rows: [
          ...
          { 'النموذج': 'Standard Llama 3.3 70B', 'الأساس': 'Llama 3.3 70B', 'VRAM (Q4)': '~42 جيجابايت', 'معدل الرفض': 'محدود', 'جودة التعليمات': '★★★★★', 'الانجراف للتطرف': 'لا شيء', 'الأفضل لـ': 'الموضوعات المظلمة والتعقيد الأخلاقي والعنف — دون الحاجة لمحتوى جنسي صريح' },
        ],
        callouts: [
          {
            type: 'tip',
            text: 'ابدأ بـ Hermes 3، لا بالنسخة المعدَّلة الأكثر عدوانية. النماذج المعدَّلة كليًا (Wizard-Uncensored، Erebus) لديها أوسع نطاق محتوى لكن اتباع تعليمات أضعف ملحوظًا في مهام الخيال المعقدة — تنجرف أسرع من القيود وتنتج نثرًا أقل جودةً في الأجيال الأطول وتحافظ على صوت الشخصيات بموثوقية أقل. للخيال الذي يتطلب محتوى بدون قيود ونثرًا عالي الجودة، Hermes 3 هو أفضل توازن.',
          },
        ],
        items: [
          ...
          image: '/images/uncensored-local-llm-creative-writing-ethics-model-comparison-hero-ar.webp',
      ...
      setup: {
        ...
        content:
          '**كلٌّ من Ollama و LM Studio يخدم النماذج بدون قيود عبر API محلية متوافقة مع OpenAI — مما يعني أن SillyTavern و Agnai وأي أداة أخرى تتحدث مع نقطة نهاية محلية تعمل دون إعداد إضافي.**',
        promptExamples: [
          {
            label: 'Ollama: تنزيل وتشغيل Hermes 3',
            text: '# Pull the model\nollama pull nous-hermes3:70b-llama3.3-q4_K_M\n\n# Run it\nollama run nous-hermes3:70b-llama3.3-q4_K_M\n\n# Serve via API (for SillyTavern / Agnai / LM Studio-compatible tools)\nollama serve\n# API available at http://localhost:11434',
          },
          {
            label: 'Ollama: تنزيل وتشغيل Dolphin 3.0 Mistral 24B',
            text: '# Pull the model\nollama pull dolphin3:24b-mistral-q4_K_M\n\n# Verify it loaded\nollama list\n\n# Run a test prompt\nollama run dolphin3:24b-mistral-q4_K_M "Write a 100-word villain monologue, gothic register, no disclaimers."',
          },
        ],
        items: [
        ...
        callouts: [
          {
            type: 'tip',
            text: 'للكتّاب الذين يريدون إبقاء النماذج بدون قيود والقياسية منفصلة، أنشئ نسختين من Ollama على منافذ مختلفة باستخدام متغير البيئة OLLAMA_HOST. مثال: OLLAMA_HOST=127.0.0.1:11435 ollama serve. هذا يتيح توجيه SillyTavern أو Agnai إلى النسخة بدون قيود مع الاحتفاظ بنسخة Ollama القياسية للمهام الأخرى.',
          },
        ],
      },
      ethics: {
        id: 'ethics',
        title: 'المسؤوليات الأخلاقية التي تبقى',
        content:
          '**تشغيل نموذج محليًا بدون تطبيق سياسات سحابية لا يلغي مسؤولياتك ككاتب ومحرر.** الإطار الأخلاقي المطبَّق على الخيال البشري التأليف ينطبق بالمثل على الخيال المُساعَد بالذكاء الاصطناعي.',
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: 'الإعداد المحلي يلغي قيود شروط خدمة السحابة، لكن لا يلغي المسؤولية القانونية للتأليف ولا المسؤولية عن تسهيل الأذى ولا الالتزامات الأخلاقية المطبَّقة على أي عمل إبداعي منشور.',
          },
          {
            type: 'plain-terms',
            text: 'فكر في النموذج المحلي بدون قيود كمساعد كتابة بالغ القدرة سيتبع أي تعليمات تعطيه إياها. العبء القانوني والأخلاقي لما تنتجه وتوزعه يقع عليك، لا على الأداة. نفس القوانين المطبَّقة على الخيال البشري التأليف — عن القاصرين والأشخاص الحقيقيين والفحش والتحريض — تنطبق على الخيال المولَّد بالذكاء الاصطناعي الموزَّع علنًا. حقيقة أنه لا منصة تمنعك من توليد المحتوى محليًا لا تغير ما أنت مسؤول عنه قانونيًا إذا نشرته.',
          },
        ],
        items: [
          '**مسؤولية التأليف:** أنت مؤلف الخيال المُساعَد بالذكاء الاصطناعي. "الذكاء الاصطناعي ولّده" لا تنقل حق النشر، لا تلغي المسؤولية، ولا تُشكّل دفاعًا عن المحتوى المخالف للقانون.',
          '**الوعي بالولاية القضائية:** قوانين الفحش والـ NCII والمحتوى الضار تختلف بالولاية القضائية. المحتوى القانوني الإنتاج في دولة قد يشكّل جريمة جنائية التوزيع في أخرى.',
          '**الأشخاص الحقيقيون:** توليد محتوى خيالي سلبي عن أشخاص حقيقيين محددين — حتى في أطر خيالية واضحة — يحمل مخاطر تشهير وـ NCII حسب المحتوى.',
          '**التحقق من السن للتوزيع:** إذا وزّعت محتوى بالغًا أو ناضجًا مولَّدًا بنماذج بدون قيود على منصة عامة، تنطبق عليك التزامات التحقق من السن المقابلة لأي ناشر محتوى بالغ.',
          '**الأرشفة المسؤولة:** المحتوى بدون قيود المولَّد محليًا يجب معاملته بنفس انضباط التخزين المطبَّق على أي مواد حساسة أخرى — لا تخزين في مجلدات متزامنة مع السحابة، لا مشاركة غير مقصودة.',
        ],
        callouts: [
          {
            type: 'warning',
            text: 'الخطأ الأخلاقي الأكثر شيوعًا بين الكتّاب الذين يستخدمون نماذج بدون قيود هو معاملة التوليد المحلي كمنطقة خالية من السياق. التوليد المحلي يعني أنه لا تطبيق لسياسات المنصة — لا يعني أنه لا قانون ولا مسؤولية ولا ضرر. غياب مشرف المحتوى ليس تفويضًا.',
          },
        ],
      },
      workflow: {
        id: 'workflow',
        title: 'سير العمل العملي لكتّاب الخيال',
        content:
          '**معظم كتّاب الخيال الذين يستخدمون نماذج بدون قيود يستخدمونها لمشاهد محددة بدلًا من استبدال نموذجهم القياسي الافتراضي بها.** سير العمل أدناه يدعم هذا الاستخدام المحدد.',
        items: [
          '**اكتب المشاهد القياسية بنموذج قياسي.** Llama 3.3 70B أو Qwen3 32B يتعاملان مع معظم النثر الأدبي بما فيه الموضوعات المظلمة والتعقيد الأخلاقي وعمق علم النفس. احتفظ بالنموذج بدون قيود للمشاهد التي تتطلب تحديدًا محتوى يرفضه النموذج القياسي.',
          '**بدّل إلى النموذج بدون قيود للمشاهد المحددة.** في Ollama، شغّل `ollama run nous-hermes3:70b-llama3.3-q4_K_M` للمشهد المحدد. في SillyTavern، بدّل النموذج في إعدادات الـ API لكل جلسة. لا بيانات تنتقل بين الجلسات.',
          '**استخدم نفس قوالب الموجّهات.** قالب مشهد الـ 5 أجزاء وبنية حوار الـ subtext وموجّهات تناقض الشخصيات من [موجّهات LLM المحلية لكتّاب الخيال](/ar/power-local-llm/local-llm-prompts-for-fiction-writers) تعمل بشكل مطابق في النماذج بدون قيود. لا تحتاج بنى موجّهات مختلفة.',
          '**لا تضف تعليمات توليد محتوى لن تظهر في موجز عمل لمؤلف بشري لأسباب قانونية.** النموذج أداة، لا بنية أذونات. إذا لم تُضمّن تعليمة في موجز لمصوّر أو كاتب خفي بشري لأسباب قانونية، لا تُضمّنها في موجّه النموذج.',
          '**راجع الناتج قبل توزيعه.** النماذج بدون قيود أحيانًا تنتج محتوى يتجاوز الظلام المطلوب أو ينجرف نحو صور نمطية. المراجعة التحريرية القياسية للمحتوى المُساعَد بالذكاء الاصطناعي تسري.',
        ],
        callouts: [
          {
            type: 'tip',
          ...
          image: '/images/uncensored-local-llm-creative-writing-ethics-workflow-hero-ar.webp',
      ...
      commonMistakes: {
        ...
        items: [
          '**التقصير الافتراضي نحو النموذج الأكثر عدوانية بدون قيود.** النماذج المعدَّلة كليًا (Wizard-Uncensored، Erebus) لديها أضعف اتباع تعليمات للمشاهد المعقدة. Hermes 3 توازن أفضل لجودة الخيال.',
          '**استخدام النماذج بدون قيود لمحتوى ستولّده النماذج القياسية.** التعقيد الأخلاقي وعلم النفس المظلم والعنف والموضوعات البالغة في النثر الأدبي نادرًا ما تتطلب نسخة معدَّلة. حدد ما تحتاجه بالضبط قبل التبديل.',
          '**معاملة التوليد المحلي كمنطقة خالية قانونيًا.** غياب تطبيق السياسات السحابية لا يعني غياب القانون. مسؤوليات التأليف للتوزيع والأشخاص الحقيقيين والقاصرين تسري بصرف النظر.',
          '**عدم تحديد حدود الكلمات.** النماذج بدون قيود تملأ المحتوى المظلم لملء المساحة بنفس سهولة أي نموذج آخر. استخدم نفس قيود حدود الكلمات من قوالب الخيال.',
          '**تخزين الناتج في مجلدات متزامنة مع السحابة.** المحتوى البالغ المولَّد محليًا المتزامن مع iCloud أو Google Drive أو OneDrive قد ينتهك شروط خدمة تلك المنصات. خزّن محليًا فقط.',
        ],
      },
      sources: {
        id: 'sources',
        title: 'المصادر',
        items: [
          'بطاقة نموذج Hermes 3 ومنهجية الضبط الدقيق — [Nous Research](https://nousresearch.com)',
          'الوثائق التقنية لـ Dolphin 3.0 Mistral — [Cognitive Computations / Eric Hartford](https://huggingface.co/cognitivecomputations)',
          'نظرة عامة على تقنيات RLHF والمحاذاة — [Anthropic Research](https://anthropic.com/research)',
          'المادة 5 من قانون الذكاء الاصطناعي الأوروبي — الممارسات المحظورة بما فيها المحتوى الذي يُشرك القاصرين — [EUR-Lex](https://eur-lex.europa.eu)',
          'NCII (الصور الحميمة غير الموافق عليها) — نظرة عامة على الإطار القانوني — [Cyber Civil Rights Initiative](https://cybercivilrights.org)',
        ],
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          {
            q: 'هل تشغيل نماذج LLM المحلية بدون قيود قانوني؟',
            a: 'تشغيل نموذج LLM محلي بدون قيود قانوني في معظم الولايات القضائية — لا يوجد قانون ضد امتلاك برامج ذكاء اصطناعي مفتوحة المصدر. ما تولّده وتوزعه بها يخضع لنفس القوانين المطبَّقة على أي محتوى تأليف ذاتي: قانون الفحش وقانون NCII وقانون التشهير وقوانين المحتوى الذي يُشرك القاصرين. قانوني التشغيل لا يعني قانوني النشر والمشاركة والتوزيع بلا حدود.',
          },
          {
            q: 'ما الفرق بين Hermes 3 و Dolphin 3.0؟',
            a: 'Hermes 3 (Nous Research) محدود إزالة القيود — يخفض الرفض للمحتوى البالغ مع الاحتفاظ ببعض الحواجز للفئات المتطرفة. اتباع التعليمات ممتاز، قريب من نموذج Llama 3.3 70B الأساسي. Dolphin 3.0 (Cognitive Computations) أوسع إزالة للقيود على نطاق محتوى أوسع، لكن اتباع التعليمات أضعف قليلًا في المشاهد المعقدة ذات القيود المتعددة. Hermes 3 هو الخيار الافتراضي الأفضل للخيال الذي تهم فيه جودة النثر؛ Dolphin 3.0 هو الأفضل حين تحتاج أوسع نطاق محتوى على نظام 16-24 جيجابايت.',
          },
          {
            q: 'هل أحتاج نموذجًا بدون قيود لكتابة الخيال المظلم؟',
            a: 'لا، لمعظم الخيال المظلم. النماذج القياسية ذات الضبط بالتعليمات مثل Llama 3.3 70B و Qwen3 32B تولّد العنف والتعقيد الأخلاقي وعلم النفس المظلم وداخلية الشرير والصدمة ومعظم الظلام الأدبي دون رفض حين تُعطى موجّهًا صحيحًا. ما ترفضه بشكل موثوق هو المحتوى الجنسي الصريح ومجموعة أضيق من السيناريوهات المتطرفة. إذا لم يتضمن خيالك المظلم محتوى جنسيًا صريحًا، اختبر أولًا نموذجًا قياسيًا — قد لا تحتاج النسخة بدون قيود.',
          },
          {
            q: 'هل يمكن استخدام النماذج بدون قيود في SillyTavern أو Agnai؟',
            a: 'نعم. SillyTavern و Agnai يتصلان بأي نقطة نهاية متوافقة مع OpenAI — بما فيها Ollama يعمل محليًا على المنفذ 11434. نزّل النموذج بدون قيود في Ollama، شغّل `ollama serve`، وفي SillyTavern أو Agnai اختر الـ API المتوافقة مع OpenAI واضبطها على `http://localhost:11434/v1`. اختر نموذجك بدون قيود من قائمة النماذج. لا إعداد إضافي مطلوب.',
          },
          {
            q: 'هل النماذج بدون قيود آمنة على شبكة منزلية؟',
            a: 'نعم، حين تكون مُهيَّأة للربط بـ localhost (الإعداد الافتراضي في Ollama و LM Studio). الـ API متاحة فقط من جهازك. إذا كشفت المنفذ على شبكتك المنزلية (مثلًا للوصول من هاتف)، تأكد من أن قواعد الجدار الناري تقيّد الوصول على الأجهزة الموثوقة. لا تكشف API Ollama للإنترنت العام بدون مصادقة — الإعداد الافتراضي لا يحتوي على مصادقة.',
          },
          {
            q: 'ماذا يحدث بالمحتوى الذي أولّده محليًا؟',
            a: 'لا شيء يحدث تلقائيًا. المحتوى المولَّد محليًا لا يُرسَل إلى أي خادم، ولا يُسجَّله أي خدمة سحابية، ولا يُستخدم لتدريب النموذج. يوجد فقط على جهازك، في التخزين المحلي لتطبيقك (ملفات سجل الدردشة وبطاقات الشخصيات وما إلى ذلك). أنت تتحكم في ما تحتفظ به وما تحذفه وما تشاركه. هذه الميزة الهيكلية الرئيسية للخصوصية في التوليد المحلي بدون قيود مقابل البدائل السحابية.',
          },
          {
            q: 'هل يمكن مزج النماذج بدون قيود والقياسية في نفس مشروع الكتابة؟',
            a: 'نعم، وهذا هو سير العمل الموصى به. استخدم نموذجًا قياسيًا (Llama 3.3 70B أو Qwen3 32B) لمعظم النثر — النماذج القياسية تنتج نثرًا أدبيًا عالي الجودة لمعظم المحتوى المظلم. بدّل إلى Hermes 3 أو Dolphin 3.0 للمشاهد المحددة التي تتطلب محتوى يرفضه النموذج القياسي. نفس قوالب الموجّهات تعمل في كليهما؛ أسلوب النثر متسق بما يكفي لعدم كشف الخلط لكل مشهد في الناتج.',
          },
          {
            q: 'هل يؤثر توليد محتوى بنموذج بدون قيود على حق النشر؟',
            a: 'لا — وضع حق النشر للمحتوى المولَّد بالذكاء الاصطناعي متطابق بصرف النظر عما إذا كان النموذج قياسيًا أو بدون قيود. قانون حق النشر لناتج الذكاء الاصطناعي غير مؤكد في معظم الولايات القضائية في 2026؛ الموقف العام أن عناصر التأليف البشري (تصميم الموجّهات والاختيار والترتيب والتحرير الجوهري) قد تكون محمية، بينما الناتج الخام للذكاء الاصطناعي ليس كذلك. استخدام نموذج بدون قيود لا يغيّر هذا التحليل.',
          },
          {
            q: 'هل تفقد النسخ المعدَّلة بدون قيود المعرفة العامة؟',
            a: 'بشكل هامشي، في مجالات محدودة. النسخ المعدَّلة لإزالة القيود عادةً تكون جولات إعادة تدريب كاملة الدقة قد تنحرف قليلًا عن النموذج الأساسي في استرجاع الحقائق والرياضيات ومعايير البرمجة — عادةً 1-3 نقاط مئوية في المعايير القياسية. لمهام كتابة الخيال، هذا غير محسوس في جودة الناتج. إذا احتجت نفس النموذج للخيال والعمل التقني (ملاحظات بحثية ومراجعة كود)، احتفظ بالنسختين القياسية وبدون القيود مُثبَّتتين وبدّل حسب المهمة. Hermes 3 يحافظ على القدرة العامة أفضل من النماذج المعدَّلة كليًا.',
          },
          {
      ...
      relatedReading: {
        ...
        title: 'قراءة ذات صلة',
        items: [
          '[أفضل نماذج LLM المحلية للكتابة الإبداعية 2026](/ar/power-local-llm/best-local-llm-creative-writing-2026) — مقارنة النماذج التي تتضمن الاختيارات الموصى بها وضبط أخذ العينات والأداء لتوليد السرد.',
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      headline: 'نماذج LLM المحلية بدون قيود للكتابة الإبداعية: متى يحتاجها الكتّاب (2026)',
      description: 'نماذج LLM المحلية بدون قيود للكتابة الإبداعية: النماذج الموصى بها، الإعداد على Ollama، المسؤوليات الأخلاقية، حالات الاستخدام المناسبة والحدود الواجب الحفاظ عليها دائمًا.',
      url: 'https://www.promptquorum.com/ar/power-local-llm/uncensored-local-llm-creative-writing-ethics',
      inLanguage: 'ar',
      author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      'proficiencyLevel': 'Intermediate',
