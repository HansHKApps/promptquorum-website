...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    targetKeywords: [
      ...
      'coqui xtts v2 supported languages',
      ...
      comparisonTable: {
        ...
        content:
          'All local TTS engines compared across the metrics that matter most for production deployment.',
                  image: '/images/local-tts-voice-cloning-piper-coqui-xtts-vram-by-engine-hero-en.webp',
...
snippetBlocks: [
        ...
        columns: ['Tool', 'Link', 'Quality', 'Speed', 'Voice Cloning', 'Multilingual', 'VRAM', 'License', 'MOS (English)'],
        rows: [
          {
            'Tool': 'Piper',
            'Link': '[github.com/rhasspy/piper](https://github.com/rhasspy/piper)',
            'Quality': 'Good',
            'Speed': 'Very fast (CPU)',
            'Voice Cloning': 'No',
          ...
          {
            'Tool': 'Kokoro',
            'Link': '[github.com/hexgrad/kokoro](https://github.com/hexgrad/kokoro)',
            'Quality': 'Very good',
            'Speed': 'Fast (CPU)',
            'Voice Cloning': 'No',
          ...
          {
            'Tool': 'Coqui TTS',
            'Link': '[github.com/coqui-ai/TTS](https://github.com/coqui-ai/TTS)',
            'Quality': 'Very good',
            'Speed': 'Medium',
            'Voice Cloning': 'Yes',
            'Multilingual': 'Yes (20+ langs)',
          ...
          {
            'Tool': 'XTTS v2',
            'Link': '[huggingface.co/coqui/XTTS-v2](https://huggingface.co/coqui/XTTS-v2)',
            'Quality': 'Excellent',
            'Speed': 'Slow',
          ...
          {
            'Tool': 'F5-TTS',
            'Link': '[github.com/SWivid/F5-TTS](https://github.com/SWivid/F5-TTS)',
            'Quality': 'Excellent',
            'Speed': 'Medium-fast',
          ...
          {
            'Tool': 'Bark',
            'Link': '[github.com/suno-ai/bark](https://github.com/suno-ai/bark)',
          ...
          {
            'Tool': 'StyleTTS 2',
            'Link': '[github.com/yl4579/StyleTTS2](https://github.com/yl4579/StyleTTS2)',
          ...
          {
            'Tool': 'Tortoise',
            'Link': '[github.com/neonbjb/tortoise-tts](https://github.com/neonbjb/tortoise-tts)',
            'Quality': 'Excellent',
...
snippetBlocks: [
        ...
        columns: ['Tool', 'Link', 'License', 'Commercial OK?', 'Key Condition'],
        rows: [
          {
            'Tool': 'Piper',
            'Link': '[github.com/rhasspy/piper](https://github.com/rhasspy/piper)',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'No — they are separate projects. Coqui STT was a speech-to-text engine (a fork of Mozilla DeepSpeech), licensed under Mozilla Public License 2.0. Coqui Inc discontinued and archived Coqui STT before the company shut down in January 2024, and it has not been meaningfully updated since. Coqui TTS (the text-to-speech toolkit covered in this guide, MPL 2.0) and XTTS v2 (the voice-cloning model, CPML) are unrelated to Coqui STT and are still usable today under their respective licenses. If you need local speech-to-text now, use Whisper.cpp or faster-whisper instead of the discontinued Coqui STT — see our [local speech-to-text comparison](/power-local-llm/local-whisper-stt-comparison-2026).',
          },
        ],
      },
      sources: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        content: 'Alle lokalen TTS-Engines im Vergleich anhand der wichtigsten Metriken für den Produktionseinsatz.',
                  image: '/images/local-tts-voice-cloning-piper-coqui-xtts-vram-by-engine-hero-de.webp',
...
snippetBlocks: [
        ...
        columns: ['Tool', 'Link', 'Qualität', 'Geschwindigkeit', 'Voice-Cloning', 'Mehrsprachig', 'VRAM', 'Lizenz', 'MOS (Englisch)'],
        rows: [
          { 'Tool': 'Piper', 'Link': '[github.com/rhasspy/piper](https://github.com/rhasspy/piper)', 'Qualität': 'Gut', 'Geschwindigkeit': 'Sehr schnell (CPU)', 'Voice-Cloning': 'Nein', 'Mehrsprachig': 'Ja (20+ Sprachen)', 'VRAM': 'Nur CPU', 'Lizenz': 'MIT', 'MOS (Englisch)': '~3,5' },
          { 'Tool': 'Kokoro', 'Link': '[github.com/hexgrad/kokoro](https://github.com/hexgrad/kokoro)', 'Qualität': 'Sehr gut', 'Geschwindigkeit': 'Schnell (CPU)', 'Voice-Cloning': 'Nein', 'Mehrsprachig': 'Englisch + wachsend', 'VRAM': 'CPU / 1–2 GB', 'Lizenz': 'Apache 2.0', 'MOS (Englisch)': '~4,0' },
          { 'Tool': 'Coqui TTS', 'Link': '[github.com/coqui-ai/TTS](https://github.com/coqui-ai/TTS)', 'Qualität': 'Sehr gut', 'Geschwindigkeit': 'Mittel', 'Voice-Cloning': 'Ja', 'Mehrsprachig': 'Ja (20+ Sprachen)', 'VRAM': '2–4 GB', 'Lizenz': 'MPL 2.0', 'MOS (Englisch)': '~3,8' },
          { 'Tool': 'XTTS v2', 'Link': '[huggingface.co/coqui/XTTS-v2](https://huggingface.co/coqui/XTTS-v2)', 'Qualität': 'Ausgezeichnet', 'Geschwindigkeit': 'Langsam', 'Voice-Cloning': 'Ja (beste)', 'Mehrsprachig': 'Ja (17 Sprachen)', 'VRAM': '4–6 GB', 'Lizenz': 'CPML (nicht-kommerziell)', 'MOS (Englisch)': '~4,1' },
          { 'Tool': 'F5-TTS', 'Link': '[github.com/SWivid/F5-TTS](https://github.com/SWivid/F5-TTS)', 'Qualität': 'Ausgezeichnet', 'Geschwindigkeit': 'Mittel-schnell', 'Voice-Cloning': 'Ja (Zero-Shot)', 'Mehrsprachig': 'Ja (mehrsprachig)', 'VRAM': '3–5 GB', 'Lizenz': 'CC-BY-NC-4.0', 'MOS (Englisch)': '~4,1' },
          { 'Tool': 'Bark', 'Link': '[github.com/suno-ai/bark](https://github.com/suno-ai/bark)', 'Qualität': 'Einzigartig / variabel', 'Geschwindigkeit': 'Langsam', 'Voice-Cloning': 'Begrenzt', 'Mehrsprachig': 'Ja (mehrsprachig)', 'VRAM': '4–8 GB', 'Lizenz': 'MIT', 'MOS (Englisch)': '~3,2–4,0 (variabel)' },
          { 'Tool': 'StyleTTS 2', 'Link': '[github.com/yl4579/StyleTTS2](https://github.com/yl4579/StyleTTS2)', 'Qualität': 'Ausgezeichnet (Englisch)', 'Geschwindigkeit': 'Mittel', 'Voice-Cloning': 'Nein', 'Mehrsprachig': 'Hauptsächlich Englisch', 'VRAM': '2–4 GB', 'Lizenz': 'MIT', 'MOS (Englisch)': '~4,3' },
          { 'Tool': 'Tortoise', 'Link': '[github.com/neonbjb/tortoise-tts](https://github.com/neonbjb/tortoise-tts)', 'Qualität': 'Ausgezeichnet', 'Geschwindigkeit': 'Sehr langsam (Minuten/Satz)', 'Voice-Cloning': 'Ja', 'Mehrsprachig': 'Hauptsächlich Englisch', 'VRAM': '4–8 GB', 'Lizenz': 'Apache 2.0', 'MOS (Englisch)': '~4,2' },
        ],
      },
      latencyTable: {
        id: 'latency-table',
...
snippetBlocks: [
        ...
        columns: ['Tool', 'Link', 'Lizenz', 'Kommerziell erlaubt?', 'Hauptbedingung'],
        rows: [
          { 'Tool': 'Piper', 'Link': '[github.com/rhasspy/piper](https://github.com/rhasspy/piper)', 'Lizenz': 'MIT', 'Kommerziell erlaubt?': 'Ja — keine Einschränkungen', 'Hauptbedingung': 'MIT-Hinweis angeben; Lizenz je Voice-Modell prüfen' },
          { 'Tool': 'Kokoro', 'Link': '[github.com/hexgrad/kokoro](https://github.com/hexgrad/kokoro)', 'Lizenz': 'Apache 2.0', 'Kommerziell erlaubt?': 'Ja — keine Einschränkungen', 'Hauptbedingung': 'Apache 2.0-Hinweis angeben' },
          { 'Tool': 'Coqui TTS (Toolkit)', 'Link': '[github.com/coqui-ai/TTS](https://github.com/coqui-ai/TTS)', 'Lizenz': 'MPL 2.0', 'Kommerziell erlaubt?': 'Ja — mit Bedingungen', 'Hauptbedingung': 'Quelle aller Änderungen an den Toolkit-Dateien offenlegen' },
          { 'Tool': 'XTTS v2 (Modell)', 'Link': '[huggingface.co/coqui/XTTS-v2](https://huggingface.co/coqui/XTTS-v2)', 'Lizenz': 'CPML', 'Kommerziell erlaubt?': 'Nein — nicht-kommerziell', 'Hauptbedingung': 'Kommerziell braucht eine Vereinbarung; seit Coqui-Schließung (Jan. 2024) keine im Verkauf' },
          { 'Tool': 'F5-TTS', 'Link': '[github.com/SWivid/F5-TTS](https://github.com/SWivid/F5-TTS)', 'Lizenz': 'CC-BY-NC-4.0', 'Kommerziell erlaubt?': 'Nein — nicht-kommerziell', 'Hauptbedingung': 'NC überträgt sich auch auf Fine-Tunes (Emilia-Trainingsdaten)' },
          { 'Tool': 'Bark', 'Link': '[github.com/suno-ai/bark](https://github.com/suno-ai/bark)', 'Lizenz': 'MIT', 'Kommerziell erlaubt?': 'Ja — keine Einschränkungen', 'Hauptbedingung': 'MIT-Copyright-Hinweis angeben' },
          { 'Tool': 'StyleTTS 2', 'Link': '[github.com/yl4579/StyleTTS2](https://github.com/yl4579/StyleTTS2)', 'Lizenz': 'MIT', 'Kommerziell erlaubt?': 'Ja — keine Einschränkungen', 'Hauptbedingung': 'MIT-Copyright-Hinweis angeben' },
          { 'Tool': 'Tortoise', 'Link': '[github.com/neonbjb/tortoise-tts](https://github.com/neonbjb/tortoise-tts)', 'Lizenz': 'Apache 2.0', 'Kommerziell erlaubt?': 'Ja — keine Einschränkungen', 'Hauptbedingung': 'Namensnennung; Einwilligung für jede geklonte Stimme einholen' },
        ],
        callouts: [
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Nein — das sind getrennte Projekte. Coqui STT war eine Speech-to-Text-Engine (ein Fork von Mozilla DeepSpeech), lizenziert unter der Mozilla Public License 2.0. Coqui Inc stellte Coqui STT ein und archivierte es, bevor das Unternehmen im Januar 2024 schloss, und es wurde seither nicht mehr wesentlich aktualisiert. Coqui TTS (das in diesem Leitfaden behandelte Text-to-Speech-Toolkit, MPL 2.0) und XTTS v2 (das Voice-Cloning-Modell, CPML) stehen in keinem Zusammenhang zu Coqui STT und sind unter ihren jeweiligen Lizenzen weiterhin nutzbar. Wenn Sie jetzt lokale Spracherkennung benötigen, verwenden Sie Whisper.cpp oder faster-whisper anstelle des eingestellten Coqui STT — siehe unseren [Vergleich lokaler Sprache-zu-Text-Engines](/de/power-local-llm/local-whisper-stt-comparison-2026).',
          },
        ],
      },
      sources: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        content: 'Tous les moteurs TTS locaux comparés selon les métriques les plus importantes pour le déploiement en production.',
                  image: '/images/local-tts-voice-cloning-piper-coqui-xtts-vram-by-engine-hero-fr.webp',
...
snippetBlocks: [
        ...
        columns: ['Outil', 'Lien', 'Qualité', 'Vitesse', 'Clonage vocal', 'Multilingue', 'VRAM', 'Licence', 'MOS (anglais)'],
        rows: [
          { 'Outil': 'Piper', 'Lien': '[github.com/rhasspy/piper](https://github.com/rhasspy/piper)', 'Qualité': 'Bon', 'Vitesse': 'Très rapide (CPU)', 'Clonage vocal': 'Non', 'Multilingue': 'Oui (20+ langues)', 'VRAM': 'CPU uniquement', 'Licence': 'MIT', 'MOS (anglais)': '~3,5' },
          { 'Outil': 'Kokoro', 'Lien': '[github.com/hexgrad/kokoro](https://github.com/hexgrad/kokoro)', 'Qualité': 'Très bon', 'Vitesse': 'Rapide (CPU)', 'Clonage vocal': 'Non', 'Multilingue': 'Anglais + en expansion', 'VRAM': 'CPU / 1–2 Go', 'Licence': 'Apache 2.0', 'MOS (anglais)': '~4,0' },
          { 'Outil': 'Coqui TTS', 'Lien': '[github.com/coqui-ai/TTS](https://github.com/coqui-ai/TTS)', 'Qualité': 'Très bon', 'Vitesse': 'Moyen', 'Clonage vocal': 'Oui', 'Multilingue': 'Oui (20+ langues)', 'VRAM': '2–4 Go', 'Licence': 'MPL 2.0', 'MOS (anglais)': '~3,8' },
          { 'Outil': 'XTTS v2', 'Lien': '[huggingface.co/coqui/XTTS-v2](https://huggingface.co/coqui/XTTS-v2)', 'Qualité': 'Excellent', 'Vitesse': 'Lent', 'Clonage vocal': 'Oui (meilleur)', 'Multilingue': 'Oui (17 langues)', 'VRAM': '4–6 Go', 'Licence': 'CPML (non commercial)', 'MOS (anglais)': '~4,1' },
          { 'Outil': 'F5-TTS', 'Lien': '[github.com/SWivid/F5-TTS](https://github.com/SWivid/F5-TTS)', 'Qualité': 'Excellent', 'Vitesse': 'Moyen-rapide', 'Clonage vocal': 'Oui (zéro-shot)', 'Multilingue': 'Oui (multilingue)', 'VRAM': '3–5 Go', 'Licence': 'CC-BY-NC-4.0', 'MOS (anglais)': '~4,1' },
          { 'Outil': 'Bark', 'Lien': '[github.com/suno-ai/bark](https://github.com/suno-ai/bark)', 'Qualité': 'Unique / variable', 'Vitesse': 'Lent', 'Clonage vocal': 'Limité', 'Multilingue': 'Oui (multilingue)', 'VRAM': '4–8 Go', 'Licence': 'MIT', 'MOS (anglais)': '~3,2–4,0 (variable)' },
          { 'Outil': 'StyleTTS 2', 'Lien': '[github.com/yl4579/StyleTTS2](https://github.com/yl4579/StyleTTS2)', 'Qualité': 'Excellent (anglais)', 'Vitesse': 'Moyen', 'Clonage vocal': 'Non', 'Multilingue': 'Anglais principalement', 'VRAM': '2–4 Go', 'Licence': 'MIT', 'MOS (anglais)': '~4,3' },
          { 'Outil': 'Tortoise', 'Lien': '[github.com/neonbjb/tortoise-tts](https://github.com/neonbjb/tortoise-tts)', 'Qualité': 'Excellent', 'Vitesse': 'Très lent (minutes/phrase)', 'Clonage vocal': 'Oui', 'Multilingue': 'Anglais principalement', 'VRAM': '4–8 Go', 'Licence': 'Apache 2.0', 'MOS (anglais)': '~4,2' },
        ],
      },
      latencyTable: {
        id: 'latency-table',
...
snippetBlocks: [
        ...
        columns: ['Outil', 'Lien', 'Licence', 'Commercial autorisé?', 'Condition principale'],
        rows: [
          { 'Outil': 'Piper', 'Lien': '[github.com/rhasspy/piper](https://github.com/rhasspy/piper)', 'Licence': 'MIT', 'Commercial autorisé?': 'Oui — aucune restriction', 'Condition principale': 'Inclure la notice MIT ; vérifier la licence du modèle par voix' },
          { 'Outil': 'Kokoro', 'Lien': '[github.com/hexgrad/kokoro](https://github.com/hexgrad/kokoro)', 'Licence': 'Apache 2.0', 'Commercial autorisé?': 'Oui — aucune restriction', 'Condition principale': 'Inclure la notice Apache 2.0' },
          { 'Outil': 'Coqui TTS (toolkit)', 'Lien': '[github.com/coqui-ai/TTS](https://github.com/coqui-ai/TTS)', 'Licence': 'MPL 2.0', 'Commercial autorisé?': 'Oui — avec conditions', 'Condition principale': 'Divulguer la source de toute modification des fichiers du toolkit' },
          { 'Outil': 'XTTS v2 (modèle)', 'Lien': '[huggingface.co/coqui/XTTS-v2](https://huggingface.co/coqui/XTTS-v2)', 'Licence': 'CPML', 'Commercial autorisé?': 'Non — non commercial', 'Condition principale': 'Le commercial nécessite un accord ; aucun en vente depuis la fermeture de Coqui (janvier 2024)' },
          { 'Outil': 'F5-TTS', 'Lien': '[github.com/SWivid/F5-TTS](https://github.com/SWivid/F5-TTS)', 'Licence': 'CC-BY-NC-4.0', 'Commercial autorisé?': 'Non — non commercial', 'Condition principale': 'Le NC se reporte même aux fine-tunes (données d\'entraînement Emilia)' },
          { 'Outil': 'Bark', 'Lien': '[github.com/suno-ai/bark](https://github.com/suno-ai/bark)', 'Licence': 'MIT', 'Commercial autorisé?': 'Oui — aucune restriction', 'Condition principale': 'Inclure la notice de copyright MIT' },
          { 'Outil': 'StyleTTS 2', 'Lien': '[github.com/yl4579/StyleTTS2](https://github.com/yl4579/StyleTTS2)', 'Licence': 'MIT', 'Commercial autorisé?': 'Oui — aucune restriction', 'Condition principale': 'Inclure la notice de copyright MIT' },
          { 'Outil': 'Tortoise', 'Lien': '[github.com/neonbjb/tortoise-tts](https://github.com/neonbjb/tortoise-tts)', 'Licence': 'Apache 2.0', 'Commercial autorisé?': 'Oui — aucune restriction', 'Condition principale': 'Attribution ; obtenir le consentement pour toute voix clonée' },
        ],
        callouts: [
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Non — ce sont des projets distincts. Coqui STT était un moteur de reconnaissance vocale (un fork de Mozilla DeepSpeech), sous licence Mozilla Public License 2.0. Coqui Inc a abandonné et archivé Coqui STT avant la fermeture de l\'entreprise en janvier 2024, et il n\'a pas été mis à jour de manière significative depuis. Coqui TTS (le toolkit de synthèse vocale traité dans ce guide, MPL 2.0) et XTTS v2 (le modèle de clonage vocal, CPML) n\'ont aucun lien avec Coqui STT et restent utilisables aujourd\'hui sous leurs licences respectives. Si vous avez besoin de reconnaissance vocale locale maintenant, utilisez Whisper.cpp ou faster-whisper à la place du Coqui STT abandonné — voir notre [comparatif de reconnaissance vocale locale](/fr/power-local-llm/local-whisper-stt-comparison-2026).',
          },
        ],
      },
      sources: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        content: 'プロダクションデプロイに最も重要なメトリクスで比較したすべてのローカルTTSエンジン。',
                  image: '/images/local-tts-voice-cloning-piper-coqui-xtts-vram-by-engine-hero-ja.webp',
...
snippetBlocks: [
        ...
        columns: ['ツール', 'リンク', '品質', '速度', 'ボイスクローニング', '多言語', 'VRAM', 'ライセンス', 'MOS（英語）'],
        rows: [
          { 'ツール': 'Piper', 'リンク': '[github.com/rhasspy/piper](https://github.com/rhasspy/piper)', '品質': '良い', '速度': '非常に速い（CPU）', 'ボイスクローニング': 'なし', '多言語': 'あり（20+言語）', 'VRAM': 'CPUのみ', 'ライセンス': 'MIT', 'MOS（英語）': '~3.5' },
          { 'ツール': 'Kokoro', 'リンク': '[github.com/hexgrad/kokoro](https://github.com/hexgrad/kokoro)', '品質': '非常に良い', '速度': '速い（CPU）', 'ボイスクローニング': 'なし', '多言語': '英語 + 拡張中', 'VRAM': 'CPU / 1〜2 GB', 'ライセンス': 'Apache 2.0', 'MOS（英語）': '~4.0' },
          { 'ツール': 'Coqui TTS', 'リンク': '[github.com/coqui-ai/TTS](https://github.com/coqui-ai/TTS)', '品質': '非常に良い', '速度': '中程度', 'ボイスクローニング': 'あり', '多言語': 'あり（20+言語）', 'VRAM': '2〜4 GB', 'ライセンス': 'MPL 2.0', 'MOS（英語）': '~3.8' },
          { 'ツール': 'XTTS v2', 'リンク': '[huggingface.co/coqui/XTTS-v2](https://huggingface.co/coqui/XTTS-v2)', '品質': '優秀', '速度': '遅い', 'ボイスクローニング': 'あり（最高）', '多言語': 'あり（17言語）', 'VRAM': '4〜6 GB', 'ライセンス': 'CPML（非商用）', 'MOS（英語）': '~4.1' },
          { 'ツール': 'F5-TTS', 'リンク': '[github.com/SWivid/F5-TTS](https://github.com/SWivid/F5-TTS)', '品質': '優秀', '速度': '中程度〜速い', 'ボイスクローニング': 'あり（ゼロショット）', '多言語': 'あり（多言語）', 'VRAM': '3〜5 GB', 'ライセンス': 'CC-BY-NC-4.0', 'MOS（英語）': '~4.1' },
          { 'ツール': 'Bark', 'リンク': '[github.com/suno-ai/bark](https://github.com/suno-ai/bark)', '品質': 'ユニーク / 変動', '速度': '遅い', 'ボイスクローニング': '限定', '多言語': 'あり（多言語）', 'VRAM': '4〜8 GB', 'ライセンス': 'MIT', 'MOS（英語）': '~3.2〜4.0（変動）' },
          { 'ツール': 'StyleTTS 2', 'リンク': '[github.com/yl4579/StyleTTS2](https://github.com/yl4579/StyleTTS2)', '品質': '優秀（英語）', '速度': '中程度', 'ボイスクローニング': 'なし', '多言語': '主に英語', 'VRAM': '2〜4 GB', 'ライセンス': 'MIT', 'MOS（英語）': '~4.3' },
          { 'ツール': 'Tortoise', 'リンク': '[github.com/neonbjb/tortoise-tts](https://github.com/neonbjb/tortoise-tts)', '品質': '優秀', '速度': '非常に遅い（1文あたり数分）', 'ボイスクローニング': 'あり', '多言語': '主に英語', 'VRAM': '4〜8 GB', 'ライセンス': 'Apache 2.0', 'MOS（英語）': '~4.2' },
        ],
      },
      latencyTable: {
        id: 'latency-table',
...
snippetBlocks: [
        ...
        columns: ['ツール', 'リンク', 'ライセンス', '商用利用可?', '主な条件'],
        rows: [
          { 'ツール': 'Piper', 'リンク': '[github.com/rhasspy/piper](https://github.com/rhasspy/piper)', 'ライセンス': 'MIT', '商用利用可?': 'はい — 制限なし', '主な条件': 'MIT表示を含める；音声ごとのモデルライセンスを確認' },
          { 'ツール': 'Kokoro', 'リンク': '[github.com/hexgrad/kokoro](https://github.com/hexgrad/kokoro)', 'ライセンス': 'Apache 2.0', '商用利用可?': 'はい — 制限なし', '主な条件': 'Apache 2.0表示を含める' },
          { 'ツール': 'Coqui TTS（ツールキット）', 'リンク': '[github.com/coqui-ai/TTS](https://github.com/coqui-ai/TTS)', 'ライセンス': 'MPL 2.0', '商用利用可?': 'はい — 条件あり', '主な条件': 'ツールキットファイルへの変更のソースを開示' },
          { 'ツール': 'XTTS v2（モデル）', 'リンク': '[huggingface.co/coqui/XTTS-v2](https://huggingface.co/coqui/XTTS-v2)', 'ライセンス': 'CPML', '商用利用可?': 'いいえ — 非商用', '主な条件': '商用には契約が必要；Coqui閉鎖（2024年1月）以降は販売なし' },
          { 'ツール': 'F5-TTS', 'リンク': '[github.com/SWivid/F5-TTS](https://github.com/SWivid/F5-TTS)', 'ライセンス': 'CC-BY-NC-4.0', '商用利用可?': 'いいえ — 非商用', '主な条件': 'NCはファインチューン版にも引き継がれる（Emilia訓練データ）' },
          { 'ツール': 'Bark', 'リンク': '[github.com/suno-ai/bark](https://github.com/suno-ai/bark)', 'ライセンス': 'MIT', '商用利用可?': 'はい — 制限なし', '主な条件': 'MIT著作権表示を含める' },
          { 'ツール': 'StyleTTS 2', 'リンク': '[github.com/yl4579/StyleTTS2](https://github.com/yl4579/StyleTTS2)', 'ライセンス': 'MIT', '商用利用可?': 'はい — 制限なし', '主な条件': 'MIT著作権表示を含める' },
          { 'ツール': 'Tortoise', 'リンク': '[github.com/neonbjb/tortoise-tts](https://github.com/neonbjb/tortoise-tts)', 'ライセンス': 'Apache 2.0', '商用利用可?': 'はい — 制限なし', '主な条件': '帰属表示；クローンする音声について同意を得る' },
        ],
        callouts: [
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'いいえ — これらは別々のプロジェクトです。Coqui STTはMozilla DeepSpeechのフォークである音声認識エンジンで、Mozilla Public License 2.0の下でライセンスされていました。Coqui Inc.は2024年1月の会社閉鎖前にCoqui STTを終了・アーカイブしており、それ以降大きな更新はありません。Coqui TTS（本ガイドで扱う音声合成ツールキット、MPL 2.0）とXTTS v2（ボイスクローニングモデル、CPML）はCoqui STTとは無関係で、それぞれのライセンスの下で現在も利用可能です。今すぐローカル音声認識が必要な場合は、廃止されたCoqui STTの代わりにWhisper.cppまたはfaster-whisperを使用してください — 詳しくは[ローカル音声認識の比較](/ja/power-local-llm/local-whisper-stt-comparison-2026)をご覧ください。',
          },
        ],
      },
      sources: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        content: '所有本地TTS引擎按照生产部署最重要的指标进行比较。',
                  image: '/images/local-tts-voice-cloning-piper-coqui-xtts-vram-by-engine-hero-zh.webp',
...
snippetBlocks: [
        ...
        columns: ['工具', '链接', '质量', '速度', '声音克隆', '多语言', 'VRAM', '许可证', 'MOS（英语）'],
        rows: [
          { '工具': 'Piper', '链接': '[github.com/rhasspy/piper](https://github.com/rhasspy/piper)', '质量': '良好', '速度': '非常快（CPU）', '声音克隆': '否', '多语言': '是（20+语言）', 'VRAM': '仅CPU', '许可证': 'MIT', 'MOS（英语）': '~3.5' },
          { '工具': 'Kokoro', '链接': '[github.com/hexgrad/kokoro](https://github.com/hexgrad/kokoro)', '质量': '很好', '速度': '快（CPU）', '声音克隆': '否', '多语言': '英语 + 扩展中', 'VRAM': 'CPU / 1〜2 GB', '许可证': 'Apache 2.0', 'MOS（英语）': '~4.0' },
          { '工具': 'Coqui TTS', '链接': '[github.com/coqui-ai/TTS](https://github.com/coqui-ai/TTS)', '质量': '很好', '速度': '中等', '声音克隆': '是', '多语言': '是（20+语言）', 'VRAM': '2〜4 GB', '许可证': 'MPL 2.0', 'MOS（英语）': '~3.8' },
          { '工具': 'XTTS v2', '链接': '[huggingface.co/coqui/XTTS-v2](https://huggingface.co/coqui/XTTS-v2)', '质量': '优秀', '速度': '慢', '声音克隆': '是（最佳）', '多语言': '是（17种语言）', 'VRAM': '4〜6 GB', '许可证': 'CPML（非商用）', 'MOS（英语）': '~4.1' },
          { '工具': 'F5-TTS', '链接': '[github.com/SWivid/F5-TTS](https://github.com/SWivid/F5-TTS)', '质量': '优秀', '速度': '中快', '声音克隆': '是（零样本）', '多语言': '是（多语言）', 'VRAM': '3〜5 GB', '许可证': 'CC-BY-NC-4.0', 'MOS（英语）': '~4.1' },
          { '工具': 'Bark', '链接': '[github.com/suno-ai/bark](https://github.com/suno-ai/bark)', '质量': '独特 / 可变', '速度': '慢', '声音克隆': '有限', '多语言': '是（多语言）', 'VRAM': '4〜8 GB', '许可证': 'MIT', 'MOS（英语）': '~3.2〜4.0（可变）' },
          { '工具': 'StyleTTS 2', '链接': '[github.com/yl4579/StyleTTS2](https://github.com/yl4579/StyleTTS2)', '质量': '优秀（英语）', '速度': '中等', '声音克隆': '否', '多语言': '主要英语', 'VRAM': '2〜4 GB', '许可证': 'MIT', 'MOS（英语）': '~4.3' },
          { '工具': 'Tortoise', '链接': '[github.com/neonbjb/tortoise-tts](https://github.com/neonbjb/tortoise-tts)', '质量': '优秀', '速度': '非常慢（每句数分钟）', '声音克隆': '是', '多语言': '主要英语', 'VRAM': '4〜8 GB', '许可证': 'Apache 2.0', 'MOS（英语）': '~4.2' },
        ],
      },
      latencyTable: {
        id: 'latency-table',
...
snippetBlocks: [
        ...
        columns: ['工具', '链接', '许可证', '商业使用？', '主要条件'],
        rows: [
          { '工具': 'Piper', '链接': '[github.com/rhasspy/piper](https://github.com/rhasspy/piper)', '许可证': 'MIT', '商业使用？': '是 — 无限制', '主要条件': '包含MIT声明；检查每个语音模型的许可证' },
          { '工具': 'Kokoro', '链接': '[github.com/hexgrad/kokoro](https://github.com/hexgrad/kokoro)', '许可证': 'Apache 2.0', '商业使用？': '是 — 无限制', '主要条件': '包含Apache 2.0声明' },
          { '工具': 'Coqui TTS（工具包）', '链接': '[github.com/coqui-ai/TTS](https://github.com/coqui-ai/TTS)', '许可证': 'MPL 2.0', '商业使用？': '是 — 有条件', '主要条件': '披露对工具包文件的任何修改的源代码' },
          { '工具': 'XTTS v2（模型）', '链接': '[huggingface.co/coqui/XTTS-v2](https://huggingface.co/coqui/XTTS-v2)', '许可证': 'CPML', '商业使用？': '否 — 非商用', '主要条件': '商用需协议；自Coqui关闭（2024年1月）后无协议可售' },
          { '工具': 'F5-TTS', '链接': '[github.com/SWivid/F5-TTS](https://github.com/SWivid/F5-TTS)', '许可证': 'CC-BY-NC-4.0', '商业使用？': '否 — 非商用', '主要条件': '非商用限制延续至微调（Emilia训练数据）' },
          { '工具': 'Bark', '链接': '[github.com/suno-ai/bark](https://github.com/suno-ai/bark)', '许可证': 'MIT', '商业使用？': '是 — 无限制', '主要条件': '包含MIT版权声明' },
          { '工具': 'StyleTTS 2', '链接': '[github.com/yl4579/StyleTTS2](https://github.com/yl4579/StyleTTS2)', '许可证': 'MIT', '商业使用？': '是 — 无限制', '主要条件': '包含MIT版权声明' },
          { '工具': 'Tortoise', '链接': '[github.com/neonbjb/tortoise-tts](https://github.com/neonbjb/tortoise-tts)', '许可证': 'Apache 2.0', '商业使用？': '是 — 无限制', '主要条件': '署名；对任何克隆声音取得同意' },
        ],
        callouts: [
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: '不是——它们是各自独立的项目。Coqui STT是一款语音转文本引擎（Mozilla DeepSpeech的分支），采用Mozilla Public License 2.0许可。Coqui Inc在2024年1月公司关闭之前已停止维护并归档了Coqui STT，此后未再有实质性更新。Coqui TTS（本指南介绍的文本转语音工具包，MPL 2.0）与XTTS v2（声音克隆模型，CPML）均与Coqui STT无关，且仍可在各自的许可证下使用。如果你现在需要本地语音识别，请使用Whisper.cpp或faster-whisper替代已停止维护的Coqui STT——参见我们的[本地语音识别对比](/zh/power-local-llm/local-whisper-stt-comparison-2026)。',
          },
        ],
      },
      sources: {
      ...
      comparisonTable: {
        ...
        content:
          'Todos los motores TTS locales comparados en las métricas más importantes para despliegue en producción.',
                  image: '/images/local-tts-voice-cloning-piper-coqui-xtts-vram-by-engine-hero-es.webp',
...
snippetBlocks: [
        ...
        columns: ['Herramienta', 'Enlace', 'Calidad', 'Velocidad', 'Clonación de voz', 'Multilingüe', 'VRAM', 'Licencia', 'MOS (inglés)'],
        rows: [
          {
            'Herramienta': 'Piper',
            'Enlace': '[github.com/rhasspy/piper](https://github.com/rhasspy/piper)',
            'Calidad': 'Buena',
          ...
          {
            'Herramienta': 'Kokoro',
            'Enlace': '[github.com/hexgrad/kokoro](https://github.com/hexgrad/kokoro)',
            'Calidad': 'Muy buena',
          ...
          },
          {
            ...
            'Enlace': '[github.com/coqui-ai/TTS](https://github.com/coqui-ai/TTS)',
            'Calidad': 'Muy buena',
            'Velocidad': 'Media',
            'Clonación de voz': 'Sí',
            'Multilingüe': 'Sí (20+ idiomas)',
          ...
          {
            'Herramienta': 'XTTS v2',
            'Enlace': '[huggingface.co/coqui/XTTS-v2](https://huggingface.co/coqui/XTTS-v2)',
            'Calidad': 'Excelente',
            'Velocidad': 'Lenta',
          ...
          {
            'Herramienta': 'F5-TTS',
            'Enlace': '[github.com/SWivid/F5-TTS](https://github.com/SWivid/F5-TTS)',
            'Calidad': 'Excelente',
          ...
          {
            'Herramienta': 'Bark',
            'Enlace': '[github.com/suno-ai/bark](https://github.com/suno-ai/bark)',
          ...
          },
          {
            ...
            'Enlace': '[github.com/yl4579/StyleTTS2](https://github.com/yl4579/StyleTTS2)',
          ...
          },
          {
            ...
            'Enlace': '[github.com/neonbjb/tortoise-tts](https://github.com/neonbjb/tortoise-tts)',
            'Calidad': 'Excelente',
...
snippetBlocks: [
        ...
        columns: ['Herramienta', 'Enlace', 'Licencia', '¿Comercial?', 'Condición principal'],
        rows: [
          {
            'Herramienta': 'Piper',
            'Enlace': '[github.com/rhasspy/piper](https://github.com/rhasspy/piper)',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'No, son proyectos separados. Coqui STT era un motor de reconocimiento de voz (un fork de Mozilla DeepSpeech), licenciado bajo Mozilla Public License 2.0. Coqui Inc discontinuó y archivó Coqui STT antes de que la empresa cerrara en enero de 2024, y no ha recibido actualizaciones significativas desde entonces. Coqui TTS (el kit de herramientas de texto a voz cubierto en esta guía, MPL 2.0) y XTTS v2 (el modelo de clonación de voz, CPML) no están relacionados con Coqui STT y siguen siendo utilizables hoy bajo sus respectivas licencias. Si necesitas reconocimiento de voz local ahora, usa Whisper.cpp o faster-whisper en lugar del descontinuado Coqui STT — consulta nuestra [comparativa de reconocimiento de voz local](/es/power-local-llm/local-whisper-stt-comparison-2026).',
          },
        ],
      },
      sources: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        content: '프로덕션 배포를 위한 가장 중요한 지표에서 비교한 모든 로컬 TTS 엔진.',
                  image: '/images/local-tts-voice-cloning-piper-coqui-xtts-vram-by-engine-hero-ko.webp',
...
snippetBlocks: [
        ...
        columns: ['도구', '링크', '품질', '속도', '음성 복제', '다국어', 'VRAM', '라이선스', 'MOS(영어)'],
        rows: [
          { '도구': 'Piper', '링크': '[github.com/rhasspy/piper](https://github.com/rhasspy/piper)', '품질': '좋음', '속도': '매우 빠름(CPU)', '음성 복제': '없음', '다국어': '예(20개+ 언어)', 'VRAM': 'CPU 전용', '라이선스': 'MIT', 'MOS(영어)': '~3.5' },
          { '도구': 'Kokoro', '링크': '[github.com/hexgrad/kokoro](https://github.com/hexgrad/kokoro)', '품질': '매우 좋음', '속도': '빠름(CPU)', '음성 복제': '없음', '다국어': '영어 + 확장 중', 'VRAM': 'CPU / 1~2 GB', '라이선스': 'Apache 2.0', 'MOS(영어)': '~4.0' },
          { '도구': 'Coqui TTS', '링크': '[github.com/coqui-ai/TTS](https://github.com/coqui-ai/TTS)', '품질': '매우 좋음', '속도': '보통', '음성 복제': '있음', '다국어': '예(20개+ 언어)', 'VRAM': '2~4 GB', '라이선스': 'MPL 2.0', 'MOS(영어)': '~3.8' },
          { '도구': 'XTTS v2', '링크': '[huggingface.co/coqui/XTTS-v2](https://huggingface.co/coqui/XTTS-v2)', '품질': '우수', '속도': '느림', '음성 복제': '있음(최고)', '다국어': '예(17개 언어)', 'VRAM': '4~6 GB', '라이선스': 'CPML(비상업용)', 'MOS(영어)': '~4.1' },
          { '도구': 'F5-TTS', '링크': '[github.com/SWivid/F5-TTS](https://github.com/SWivid/F5-TTS)', '품질': '우수', '속도': '보통~빠름', '음성 복제': '있음(zero-shot)', '다국어': '예(다국어)', 'VRAM': '3~5 GB', '라이선스': 'CC-BY-NC-4.0', 'MOS(영어)': '~4.1' },
          { '도구': 'Bark', '링크': '[github.com/suno-ai/bark](https://github.com/suno-ai/bark)', '품질': '독특함/가변적', '속도': '느림', '음성 복제': '제한적', '다국어': '예(다국어)', 'VRAM': '4~8 GB', '라이선스': 'MIT', 'MOS(영어)': '~3.2~4.0(가변적)' },
          { '도구': 'StyleTTS 2', '링크': '[github.com/yl4579/StyleTTS2](https://github.com/yl4579/StyleTTS2)', '품질': '우수(영어)', '속도': '보통', '음성 복제': '없음', '다국어': '주로 영어', 'VRAM': '2~4 GB', '라이선스': 'MIT', 'MOS(영어)': '~4.3' },
          { '도구': 'Tortoise', '링크': '[github.com/neonbjb/tortoise-tts](https://github.com/neonbjb/tortoise-tts)', '품질': '우수', '속도': '매우 느림(문장당 수 분)', '음성 복제': '있음', '다국어': '주로 영어', 'VRAM': '4~8 GB', '라이선스': 'Apache 2.0', 'MOS(영어)': '~4.2' },
        ],
      },
      latencyTable: {
        id: 'latency-table',
...
snippetBlocks: [
        ...
        columns: ['도구', '링크', '라이선스', '상업적 가능?', '주요 조건'],
        rows: [
          { '도구': 'Piper', '링크': '[github.com/rhasspy/piper](https://github.com/rhasspy/piper)', '라이선스': 'MIT', '상업적 가능?': '예 — 제한 없음', '주요 조건': 'MIT 고지 포함; 음성별 모델 라이선스 확인' },
          { '도구': 'Kokoro', '링크': '[github.com/hexgrad/kokoro](https://github.com/hexgrad/kokoro)', '라이선스': 'Apache 2.0', '상업적 가능?': '예 — 제한 없음', '주요 조건': 'Apache 2.0 고지 포함' },
          { '도구': 'Coqui TTS (툴킷)', '링크': '[github.com/coqui-ai/TTS](https://github.com/coqui-ai/TTS)', '라이선스': 'MPL 2.0', '상업적 가능?': '예 — 조건 있음', '주요 조건': '툴킷 파일에 대한 수정 사항의 소스 공개' },
          { '도구': 'XTTS v2 (모델)', '링크': '[huggingface.co/coqui/XTTS-v2](https://huggingface.co/coqui/XTTS-v2)', '라이선스': 'CPML', '상업적 가능?': '아니오 — 비상업용', '주요 조건': '상업용에는 계약 필요; Coqui가 문을 닫은(2024년 1월) 이후 판매처 없음' },
          { '도구': 'F5-TTS', '링크': '[github.com/SWivid/F5-TTS](https://github.com/SWivid/F5-TTS)', '라이선스': 'CC-BY-NC-4.0', '상업적 가능?': '아니오 — 비상업용', '주요 조건': 'NC는 fine-tune에도 이어짐(Emilia 학습 데이터)' },
          { '도구': 'Bark', '링크': '[github.com/suno-ai/bark](https://github.com/suno-ai/bark)', '라이선스': 'MIT', '상업적 가능?': '예 — 제한 없음', '주요 조건': 'MIT 저작권 고지 포함' },
          { '도구': 'StyleTTS 2', '링크': '[github.com/yl4579/StyleTTS2](https://github.com/yl4579/StyleTTS2)', '라이선스': 'MIT', '상업적 가능?': '예 — 제한 없음', '주요 조건': 'MIT 저작권 고지 포함' },
          { '도구': 'Tortoise', '링크': '[github.com/neonbjb/tortoise-tts](https://github.com/neonbjb/tortoise-tts)', '라이선스': 'Apache 2.0', '상업적 가능?': '예 — 제한 없음', '주요 조건': '저작자 표시; 복제 음성에 대한 동의 확보' },
        ],
        callouts: [
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: '아니요 — 서로 별개의 프로젝트입니다. Coqui STT는 Mozilla DeepSpeech를 포크한 음성 인식 엔진으로, Mozilla Public License 2.0으로 라이선스되었습니다. Coqui Inc는 2024년 1월 회사가 문을 닫기 전에 Coqui STT를 중단하고 보관 처리했으며, 이후 의미 있는 업데이트가 없었습니다. Coqui TTS(이 가이드에서 다루는 텍스트 음성 변환 툴킷, MPL 2.0)와 XTTS v2(음성 복제 모델, CPML)는 Coqui STT와 무관하며 각자의 라이선스 하에 지금도 사용할 수 있습니다. 지금 로컬 음성 인식이 필요하다면 중단된 Coqui STT 대신 Whisper.cpp 또는 faster-whisper를 사용하십시오 — 자세한 내용은 [로컬 음성 인식 비교](/ko/power-local-llm/local-whisper-stt-comparison-2026)를 참고하십시오.',
          },
        ],
      },
      sources: {
      ...
      comparisonTable: {
        ...
        content:
          'Todos os motores TTS locais comparados nas métricas mais importantes para implantação em produção.',
                  image: '/images/local-tts-voice-cloning-piper-coqui-xtts-vram-by-engine-hero-pt.webp',
...
snippetBlocks: [
        ...
        columns: ['Ferramenta', 'Link', 'Qualidade', 'Velocidade', 'Clonagem de voz', 'Multilíngue', 'VRAM', 'Licença', 'MOS (inglês)'],
        rows: [
          {
            'Ferramenta': 'Piper',
            'Link': '[github.com/rhasspy/piper](https://github.com/rhasspy/piper)',
...
snippetBlocks: [
        ...
        columns: ['Ferramenta', 'Link', 'Licença', 'Comercial?', 'Condição principal'],
        rows: [
          {
            'Ferramenta': 'Piper',
            'Link': '[github.com/rhasspy/piper](https://github.com/rhasspy/piper)',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Não — são projetos separados. O Coqui STT era um motor de reconhecimento de voz (um fork do Mozilla DeepSpeech), licenciado sob a Mozilla Public License 2.0. A Coqui Inc descontinuou e arquivou o Coqui STT antes de a empresa fechar em janeiro de 2024, e ele não recebe atualizações significativas desde então. O Coqui TTS (o kit de texto para voz abordado neste guia, MPL 2.0) e o XTTS v2 (o modelo de clonagem de voz, CPML) não têm relação com o Coqui STT e continuam utilizáveis hoje sob suas respectivas licenças. Se você precisa de reconhecimento de voz local agora, use Whisper.cpp ou faster-whisper em vez do descontinuado Coqui STT — veja nossa [comparação de reconhecimento de voz local](/pt/power-local-llm/local-whisper-stt-comparison-2026).',
          },
        ],
      },
      sources: {
      ...
      comparisonTable: {
        ...
        content:
          'جميع محركات TTS المحلية مقارنة بأهم المقاييس للنشر في الإنتاج.',
                  image: '/images/local-tts-voice-cloning-piper-coqui-xtts-vram-by-engine-hero-ar.webp',
...
snippetBlocks: [
        ...
        columns: ['الأداة', 'الرابط', 'الجودة', 'السرعة', 'استنساخ الصوت', 'متعدد اللغات', 'VRAM', 'الترخيص', 'MOS (إنجليزي)'],
        rows: [
          {
            'الأداة': 'Piper',
            'الرابط': '[github.com/rhasspy/piper](https://github.com/rhasspy/piper)',
            'الجودة': 'جيدة',
          ...
          {
            'الأداة': 'Kokoro',
            'الرابط': '[github.com/hexgrad/kokoro](https://github.com/hexgrad/kokoro)',
            'الجودة': 'جيدة جدًا',
            'السرعة': 'سريعة (CPU)',
            'استنساخ الصوت': 'لا',
          ...
          {
            'الأداة': 'Coqui TTS',
            'الرابط': '[github.com/coqui-ai/TTS](https://github.com/coqui-ai/TTS)',
            'الجودة': 'جيدة جدًا',
            'السرعة': 'متوسطة',
            'استنساخ الصوت': 'نعم',
            'متعدد اللغات': 'نعم (20+ لغة)',
          ...
          {
            'الأداة': 'XTTS v2',
            'الرابط': '[huggingface.co/coqui/XTTS-v2](https://huggingface.co/coqui/XTTS-v2)',
            'الجودة': 'ممتازة',
            'السرعة': 'بطيئة',
          ...
          {
            'الأداة': 'F5-TTS',
            'الرابط': '[github.com/SWivid/F5-TTS](https://github.com/SWivid/F5-TTS)',
            'الجودة': 'ممتازة',
            'السرعة': 'متوسطة-سريعة',
          ...
          {
            'الأداة': 'Bark',
            'الرابط': '[github.com/suno-ai/bark](https://github.com/suno-ai/bark)',
            'الجودة': 'فريدة / متغيرة',
            'السرعة': 'بطيئة',
            'استنساخ الصوت': 'محدود',
            'متعدد اللغات': 'نعم (متعدد اللغات)',
          ...
          {
            'الأداة': 'StyleTTS 2',
            'الرابط': '[github.com/yl4579/StyleTTS2](https://github.com/yl4579/StyleTTS2)',
          ...
          {
            'الأداة': 'Tortoise',
            'الرابط': '[github.com/neonbjb/tortoise-tts](https://github.com/neonbjb/tortoise-tts)',
            'الجودة': 'ممتازة',
...
snippetBlocks: [
        ...
        columns: ['الأداة', 'الرابط', 'الترخيص', 'تجاري؟', 'الشرط الرئيسي'],
        rows: [
          {
            'الأداة': 'Piper',
            'الرابط': '[github.com/rhasspy/piper](https://github.com/rhasspy/piper)',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'لا — إنهما مشروعان منفصلان. كان Coqui STT محرك تحويل كلام إلى نص (نسخة مشتقة من Mozilla DeepSpeech)، مرخّصًا تحت Mozilla Public License 2.0. أوقفت Coqui Inc دعم Coqui STT وأرشفته قبل إغلاق الشركة في يناير 2024، ولم يشهد تحديثات جوهرية منذ ذلك الحين. Coqui TTS (مجموعة أدوات تحويل النص إلى كلام التي يتناولها هذا الدليل، MPL 2.0) وXTTS v2 (نموذج استنساخ الصوت، CPML) غير مرتبطين بـCoqui STT وما زالا قابلين للاستخدام اليوم بموجب ترخيص كل منهما. إذا كنت تحتاج إلى تحويل كلام إلى نص محليًا الآن، استخدم Whisper.cpp أو faster-whisper بدلًا من Coqui STT المتوقف — راجع [مقارنة تحويل الكلام إلى نص محليًا](/ar/power-local-llm/local-whisper-stt-comparison-2026) الخاصة بنا.',
          },
        ],
      },
      sources: {
