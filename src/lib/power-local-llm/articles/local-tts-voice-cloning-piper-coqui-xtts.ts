  ...
  de: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Vollständig offlinetem Sprach-Assistenten bauen 2026](/power-local-llm/build-local-voice-assistant-2026?lang=de) — Verwenden Sie Piper oder Coqui TTS als Ausgabeschicht einer vollständigen Whisper + LLM + TTS-Pipeline.',
          '[Lokale Sprache-zu-Text 2026: Whisper.cpp vs faster-whisper](/power-local-llm/local-whisper-stt-comparison-2026?lang=de) — Die Eingabeseite einer Sprach-Pipeline.',
          '[Lokale multimodale KI-Pipeline 2026](/power-local-llm/local-multimodal-pipeline-voice-vision-text?lang=de) — TTS als Sprach-Ausgabeschicht eines vollständigen multimodalen Stacks integrieren.',
          '[Beste Budget-GPUs für lokale LLMs](/local-llms/best-budget-gpus-local-llm?lang=de) — GPU-Auswahl für den Betrieb von XTTS v2, F5-TTS, Bark oder StyleTTS 2.',
          '[Beste KI-Sprachsynthese für Content-Creator](/prompt-bites/best-ai-text-to-speech-for-content-creators?lang=de) — Piper vs Coqui XTTS vs ElevenLabs Local: Sprachqualität und Latenzvergleich.',
        ],
      },
    },
  },
  ...
  fr: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Construire un assistant vocal entièrement hors ligne en 2026](/power-local-llm/build-local-voice-assistant-2026?lang=fr) — Utilisez Piper ou Coqui TTS comme couche de sortie d\'un pipeline complet Whisper + LLM + TTS.',
          '[Reconnaissance vocale locale 2026 : Whisper.cpp vs faster-whisper](/power-local-llm/local-whisper-stt-comparison-2026?lang=fr) — Le côté entrée d\'un pipeline vocal.',
          '[Pipeline IA multimodale locale 2026](/power-local-llm/local-multimodal-pipeline-voice-vision-text?lang=fr) — Intégrer le TTS comme couche de sortie vocale d\'une pile multimodale complète.',
          '[Meilleurs GPU budget pour LLM local](/local-llms/best-budget-gpus-local-llm?lang=fr) — Sélection de GPU pour exécuter XTTS v2, F5-TTS, Bark ou StyleTTS 2.',
          '[Meilleure IA text-to-speech pour créateurs de contenu](/prompt-bites/best-ai-text-to-speech-for-content-creators?lang=fr) — Piper vs Coqui XTTS vs ElevenLabs Local : comparaison qualité vocale et latence.',
        ],
      },
    },
  },
  ...
  ja: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '関連記事',
        items: [
          '[2026年の完全オフライン音声アシスタント構築](/power-local-llm/build-local-voice-assistant-2026?lang=ja) — PiperまたはCoqui TTSをWhisper + LLM + TTSパイプラインの出力レイヤーとして使用。',
          '[ローカル音声認識2026：Whisper.cpp vs faster-whisper](/power-local-llm/local-whisper-stt-comparison-2026?lang=ja) — 音声パイプラインの入力側。',
          '[ローカルマルチモーダルAIパイプライン2026](/power-local-llm/local-multimodal-pipeline-voice-vision-text?lang=ja) — 完全なマルチモーダルスタックの音声出力レイヤーとしてTTSを統合。',
          '[ローカルLLM向けベストバジェットGPU](/local-llms/best-budget-gpus-local-llm?lang=ja) — XTTS v2、F5-TTS、Bark、またはStyleTTS 2を実行するためのGPU選択。',
          '[コンテンツクリエイター向けベストAI音声合成](/prompt-bites/best-ai-text-to-speech-for-content-creators?lang=ja) — Piper vs Coqui XTTS vs ElevenLabs Local：音声品質とレイテンシ比較。',
        ],
      },
    },
  },
  ...
  zh: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '相关阅读',
        items: [
          '[2026年构建完全离线语音助手](/power-local-llm/build-local-voice-assistant-2026?lang=zh) — 将Piper或Coqui TTS用作完整Whisper + LLM + TTS管道的输出层。',
          '[本地语音识别2026：Whisper.cpp vs faster-whisper](/power-local-llm/local-whisper-stt-comparison-2026?lang=zh) — 语音管道的输入侧。',
          '[本地多模态AI管道2026](/power-local-llm/local-multimodal-pipeline-voice-vision-text?lang=zh) — 将TTS集成为完整多模态栈的语音输出层。',
          '[本地LLM最佳入门GPU](/local-llms/best-budget-gpus-local-llm?lang=zh) — 运行XTTS v2、F5-TTS、Bark或StyleTTS 2的GPU选择指南。',
          '[内容创作者最佳AI文本转语音](/prompt-bites/best-ai-text-to-speech-for-content-creators?lang=zh) — Piper vs Coqui XTTS vs ElevenLabs Local：语音质量与延迟对比。',
        ],
      },
    },
  },
