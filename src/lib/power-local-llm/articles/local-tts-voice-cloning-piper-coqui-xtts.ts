...
snippetBlocks: [
        ...
        rows: [
          ...
          {
            'Tool': '[Tortoise](https://github.com/neonbjb/tortoise-tts)',
            'Quality': 'Excellent',
...
snippetBlocks: [
        ...
        rows: [
          ...
          {
            'Tool': '[Coqui TTS (toolkit)](https://github.com/coqui-ai/TTS)',
            'License': 'MPL 2.0',
            'Commercial OK?': 'Yes — with conditions',
            'Key Condition': 'Disclose source of any modifications to the toolkit files',
          },
          {
            'Tool': '[XTTS v2 (model)](https://huggingface.co/coqui/XTTS-v2)',
            'License': 'CPML',
...
# Model now loads without the interactive license prompt`,
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[XTTS v2 Review](/power-local-llm/xtts-v2-review) — a dedicated review of the XTTS v2 model itself, including real usage commands and its non-commercial CPML license.',
          '[Bark Review](/power-local-llm/bark-tts-review) — a dedicated review of Suno\'s MIT-licensed generative audio model, which adds laughter and other non-speech sounds but does not support voice cloning.',
          '[StyleTTS 2 Review](/power-local-llm/styletts-2-review) — a dedicated review of Columbia University\'s MIT-licensed, style-diffusion speech model, including its README-level disclosure condition and maintenance status.',
...
snippetBlocks: [
        ...
        rows: [
          ...
          { 'Tool': '[F5-TTS](https://github.com/SWivid/F5-TTS)', 'Qualität': 'Ausgezeichnet', 'Geschwindigkeit': 'Mittel-schnell', 'Voice-Cloning': 'Ja (Zero-Shot)', 'Mehrsprachig': 'Ja (mehrsprachig)', 'VRAM': '3–5 GB', 'Lizenz': 'CC-BY-NC-4.0', 'MOS (Englisch)': '~4,1' },
          { 'Tool': '[Bark](https://github.com/suno-ai/bark)', 'Qualität': 'Einzigartig / variabel', 'Geschwindigkeit': 'Langsam', 'Voice-Cloning': 'Begrenzt', 'Mehrsprachig': 'Ja (mehrsprachig)', 'VRAM': '4–8 GB', 'Lizenz': 'MIT', 'MOS (Englisch)': '~3,2–4,0 (variabel)' },
          { 'Tool': '[StyleTTS 2](https://github.com/yl4579/StyleTTS2)', 'Qualität': 'Ausgezeichnet (Englisch)', 'Geschwindigkeit': 'Mittel', 'Voice-Cloning': 'Nein', 'Mehrsprachig': 'Hauptsächlich Englisch', 'VRAM': '2–4 GB', 'Lizenz': 'MIT', 'MOS (Englisch)': '~4,3' },
          { 'Tool': '[Tortoise](https://github.com/neonbjb/tortoise-tts)', 'Qualität': 'Ausgezeichnet', 'Geschwindigkeit': 'Sehr langsam (Minuten/Satz)', 'Voice-Cloning': 'Ja', 'Mehrsprachig': 'Hauptsächlich Englisch', 'VRAM': '4–8 GB', 'Lizenz': 'Apache 2.0', 'MOS (Englisch)': '~4,2' },
        ],
      },
      latencyTable: {
        id: 'latency-table',
...
snippetBlocks: [
        ...
        rows: [
          ...
          { 'Tool': '[F5-TTS](https://github.com/SWivid/F5-TTS)', 'Lizenz': 'CC-BY-NC-4.0', 'Kommerziell erlaubt?': 'Nein — nicht-kommerziell', 'Hauptbedingung': 'NC überträgt sich auch auf Fine-Tunes (Emilia-Trainingsdaten)' },
          { 'Tool': '[Bark](https://github.com/suno-ai/bark)', 'Lizenz': 'MIT', 'Kommerziell erlaubt?': 'Ja — keine Einschränkungen', 'Hauptbedingung': 'MIT-Copyright-Hinweis angeben' },
          { 'Tool': '[StyleTTS 2](https://github.com/yl4579/StyleTTS2)', 'Lizenz': 'MIT', 'Kommerziell erlaubt?': 'Ja — keine Einschränkungen', 'Hauptbedingung': 'MIT-Copyright-Hinweis angeben' },
          { 'Tool': '[Tortoise](https://github.com/neonbjb/tortoise-tts)', 'Lizenz': 'Apache 2.0', 'Kommerziell erlaubt?': 'Ja — keine Einschränkungen', 'Hauptbedingung': 'Namensnennung; Einwilligung für jede geklonte Stimme einholen' },
        ],
        callouts: [
...
# Das Modell lädt nun ohne die interaktive Lizenz-Eingabeaufforderung`,
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[XTTS v2 im Test](/de/power-local-llm/xtts-v2-review) — ein dedizierter Test des XTTS-v2-Modells selbst, mit echten Nutzungsbefehlen und seiner nicht-kommerziellen CPML-Lizenz.',
          '[Bark im Test](/de/power-local-llm/bark-tts-review) — ein dedizierter Test von Sunos MIT-lizenziertem generativem Audio-Modell, das Lachen und andere nicht-sprachliche Laute hinzufügt, aber kein Voice-Cloning unterstützt.',
          '[StyleTTS 2 im Test](/de/power-local-llm/styletts-2-review) — ein dedizierter Test von Columbia Universitys MIT-lizenziertem, Style-Diffusion-Sprachmodell, einschließlich seiner README-Offenlegungsbedingung und seines Wartungsstatus.',
...
snippetBlocks: [
        ...
        rows: [
          ...
          { 'Outil': '[F5-TTS](https://github.com/SWivid/F5-TTS)', 'Qualité': 'Excellent', 'Vitesse': 'Moyen-rapide', 'Clonage vocal': 'Oui (zéro-shot)', 'Multilingue': 'Oui (multilingue)', 'VRAM': '3–5 Go', 'Licence': 'CC-BY-NC-4.0', 'MOS (anglais)': '~4,1' },
          { 'Outil': '[Bark](https://github.com/suno-ai/bark)', 'Qualité': 'Unique / variable', 'Vitesse': 'Lent', 'Clonage vocal': 'Limité', 'Multilingue': 'Oui (multilingue)', 'VRAM': '4–8 Go', 'Licence': 'MIT', 'MOS (anglais)': '~3,2–4,0 (variable)' },
          { 'Outil': '[StyleTTS 2](https://github.com/yl4579/StyleTTS2)', 'Qualité': 'Excellent (anglais)', 'Vitesse': 'Moyen', 'Clonage vocal': 'Non', 'Multilingue': 'Anglais principalement', 'VRAM': '2–4 Go', 'Licence': 'MIT', 'MOS (anglais)': '~4,3' },
          { 'Outil': '[Tortoise](https://github.com/neonbjb/tortoise-tts)', 'Qualité': 'Excellent', 'Vitesse': 'Très lent (minutes/phrase)', 'Clonage vocal': 'Oui', 'Multilingue': 'Anglais principalement', 'VRAM': '4–8 Go', 'Licence': 'Apache 2.0', 'MOS (anglais)': '~4,2' },
        ],
      },
      latencyTable: {
        id: 'latency-table',
...
snippetBlocks: [
        ...
        rows: [
          ...
          { 'Outil': '[F5-TTS](https://github.com/SWivid/F5-TTS)', 'Licence': 'CC-BY-NC-4.0', 'Commercial autorisé?': 'Non — non commercial', 'Condition principale': 'Le NC se reporte même aux fine-tunes (données d\'entraînement Emilia)' },
          { 'Outil': '[Bark](https://github.com/suno-ai/bark)', 'Licence': 'MIT', 'Commercial autorisé?': 'Oui — aucune restriction', 'Condition principale': 'Inclure la notice de copyright MIT' },
          { 'Outil': '[StyleTTS 2](https://github.com/yl4579/StyleTTS2)', 'Licence': 'MIT', 'Commercial autorisé?': 'Oui — aucune restriction', 'Condition principale': 'Inclure la notice de copyright MIT' },
          { 'Outil': '[Tortoise](https://github.com/neonbjb/tortoise-tts)', 'Licence': 'Apache 2.0', 'Commercial autorisé?': 'Oui — aucune restriction', 'Condition principale': 'Attribution ; obtenir le consentement pour toute voix clonée' },
        ],
        callouts: [
...
# Le modèle se charge maintenant sans l'invite de licence interactive`,
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[XTTS v2 : avis](/fr/power-local-llm/xtts-v2-review) — un avis dédié au modèle XTTS v2 lui-même, avec des commandes d\'utilisation réelles et sa licence CPML non commerciale.',
          '[Avis Bark](/fr/power-local-llm/bark-tts-review) — un avis dédié au modèle audio génératif sous licence MIT de Suno, qui ajoute le rire et d\'autres sons non verbaux mais ne prend pas en charge le clonage vocal.',
          '[Avis StyleTTS 2](/fr/power-local-llm/styletts-2-review) — un avis dédié au modèle vocal à diffusion de style de l\'université Columbia, sous licence MIT, incluant sa condition de divulgation du README et son statut de maintenance.',
...
snippetBlocks: [
        ...
        rows: [
          ...
          { 'ツール': '[F5-TTS](https://github.com/SWivid/F5-TTS)', '品質': '優秀', '速度': '中程度〜速い', 'ボイスクローニング': 'あり（ゼロショット）', '多言語': 'あり（多言語）', 'VRAM': '3〜5 GB', 'ライセンス': 'CC-BY-NC-4.0', 'MOS（英語）': '~4.1' },
          { 'ツール': '[Bark](https://github.com/suno-ai/bark)', '品質': 'ユニーク / 変動', '速度': '遅い', 'ボイスクローニング': '限定', '多言語': 'あり（多言語）', 'VRAM': '4〜8 GB', 'ライセンス': 'MIT', 'MOS（英語）': '~3.2〜4.0（変動）' },
          { 'ツール': '[StyleTTS 2](https://github.com/yl4579/StyleTTS2)', '品質': '優秀（英語）', '速度': '中程度', 'ボイスクローニング': 'なし', '多言語': '主に英語', 'VRAM': '2〜4 GB', 'ライセンス': 'MIT', 'MOS（英語）': '~4.3' },
          { 'ツール': '[Tortoise](https://github.com/neonbjb/tortoise-tts)', '品質': '優秀', '速度': '非常に遅い（1文あたり数分）', 'ボイスクローニング': 'あり', '多言語': '主に英語', 'VRAM': '4〜8 GB', 'ライセンス': 'Apache 2.0', 'MOS（英語）': '~4.2' },
        ],
      },
      latencyTable: {
        id: 'latency-table',
...
snippetBlocks: [
        ...
        rows: [
          ...
          { 'ツール': '[F5-TTS](https://github.com/SWivid/F5-TTS)', 'ライセンス': 'CC-BY-NC-4.0', '商用利用可?': 'いいえ — 非商用', '主な条件': 'NCはファインチューン版にも引き継がれる（Emilia訓練データ）' },
          { 'ツール': '[Bark](https://github.com/suno-ai/bark)', 'ライセンス': 'MIT', '商用利用可?': 'はい — 制限なし', '主な条件': 'MIT著作権表示を含める' },
          { 'ツール': '[StyleTTS 2](https://github.com/yl4579/StyleTTS2)', 'ライセンス': 'MIT', '商用利用可?': 'はい — 制限なし', '主な条件': 'MIT著作権表示を含める' },
          { 'ツール': '[Tortoise](https://github.com/neonbjb/tortoise-tts)', 'ライセンス': 'Apache 2.0', '商用利用可?': 'はい — 制限なし', '主な条件': '帰属表示；クローンする音声について同意を得る' },
        ],
        callouts: [
...
# これでモデルは対話的なライセンスプロンプトなしに読み込まれる`,
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[XTTS v2レビュー](/ja/power-local-llm/xtts-v2-review) — XTTS v2モデル自体の専用レビュー。実際の使用コマンドと非商用CPMLライセンスを解説。',
          '[Barkレビュー](/ja/power-local-llm/bark-tts-review) — 笑い声などの非音声サウンドを追加できるがボイスクローニングには対応していない、SunoのMITライセンス生成音声モデルの専用レビュー。',
          '[StyleTTS 2レビュー](/ja/power-local-llm/styletts-2-review) — コロンビア大学のMITライセンス、スタイル拡散音声モデルの専用レビュー。READMEの開示条件とメンテナンス状況を解説。',
...
snippetBlocks: [
        ...
        rows: [
          ...
          { '工具': '[F5-TTS](https://github.com/SWivid/F5-TTS)', '质量': '优秀', '速度': '中快', '声音克隆': '是（零样本）', '多语言': '是（多语言）', 'VRAM': '3〜5 GB', '许可证': 'CC-BY-NC-4.0', 'MOS（英语）': '~4.1' },
          { '工具': '[Bark](https://github.com/suno-ai/bark)', '质量': '独特 / 可变', '速度': '慢', '声音克隆': '有限', '多语言': '是（多语言）', 'VRAM': '4〜8 GB', '许可证': 'MIT', 'MOS（英语）': '~3.2〜4.0（可变）' },
          { '工具': '[StyleTTS 2](https://github.com/yl4579/StyleTTS2)', '质量': '优秀（英语）', '速度': '中等', '声音克隆': '否', '多语言': '主要英语', 'VRAM': '2〜4 GB', '许可证': 'MIT', 'MOS（英语）': '~4.3' },
          { '工具': '[Tortoise](https://github.com/neonbjb/tortoise-tts)', '质量': '优秀', '速度': '非常慢（每句数分钟）', '声音克隆': '是', '多语言': '主要英语', 'VRAM': '4〜8 GB', '许可证': 'Apache 2.0', 'MOS（英语）': '~4.2' },
        ],
      },
      latencyTable: {
        id: 'latency-table',
...
snippetBlocks: [
        ...
        rows: [
          ...
          { '工具': '[F5-TTS](https://github.com/SWivid/F5-TTS)', '许可证': 'CC-BY-NC-4.0', '商业使用？': '否 — 非商用', '主要条件': '非商用限制延续至微调（Emilia训练数据）' },
          { '工具': '[Bark](https://github.com/suno-ai/bark)', '许可证': 'MIT', '商业使用？': '是 — 无限制', '主要条件': '包含MIT版权声明' },
          { '工具': '[StyleTTS 2](https://github.com/yl4579/StyleTTS2)', '许可证': 'MIT', '商业使用？': '是 — 无限制', '主要条件': '包含MIT版权声明' },
          { '工具': '[Tortoise](https://github.com/neonbjb/tortoise-tts)', '许可证': 'Apache 2.0', '商业使用？': '是 — 无限制', '主要条件': '署名；对任何克隆声音取得同意' },
        ],
        callouts: [
...
# Model now loads without the interactive license prompt`,
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[XTTS v2评测](/zh/power-local-llm/xtts-v2-review) — XTTS v2模型本身的专门评测,包括真实使用命令及其非商业性质的CPML许可证。',
          '[Bark评测](/zh/power-local-llm/bark-tts-review) — Suno的MIT许可生成式音频模型的专门评测,可添加笑声等非语音声音,但不支持声音克隆。',
          '[StyleTTS 2评测](/zh/power-local-llm/styletts-2-review) — 哥伦比亚大学MIT许可的风格扩散语音模型专门评测,包括其README级披露条件及维护状态。',
...
snippetBlocks: [
        ...
        rows: [
          ...
          {
            'Herramienta': '[F5-TTS](https://github.com/SWivid/F5-TTS)',
            'Calidad': 'Excelente',
          ...
          {
            'Herramienta': '[Tortoise](https://github.com/neonbjb/tortoise-tts)',
            'Calidad': 'Excelente',
...
snippetBlocks: [
        ...
        rows: [
          ...
          {
            'Herramienta': '[Coqui TTS (kit)](https://github.com/coqui-ai/TTS)',
            'Licencia': 'MPL 2.0',
            '¿Comercial?': 'Sí — con condiciones',
            'Condición principal': 'Divulgar el código fuente de cualquier modificación a los archivos del kit',
          },
          {
            'Herramienta': '[XTTS v2 (modelo)](https://huggingface.co/coqui/XTTS-v2)',
            'Licencia': 'CPML',
...
# Model now loads without the interactive license prompt`,
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Análisis de XTTS v2](/es/power-local-llm/xtts-v2-review) — un análisis dedicado del propio modelo XTTS v2, con comandos de uso reales y su licencia CPML no comercial.',
          '[Análisis de Bark](/es/power-local-llm/bark-tts-review) — un análisis dedicado del modelo de audio generativo con licencia MIT de Suno, que añade risas y otros sonidos no verbales pero no admite clonación de voz.',
          '[Análisis de StyleTTS 2](/es/power-local-llm/styletts-2-review) — un análisis dedicado del modelo de voz por difusión de estilo de la Universidad de Columbia, con licencia MIT, incluida su condición de divulgación del README y su estado de mantenimiento.',
...
snippetBlocks: [
        ...
        rows: [
          ...
          { '도구': '[F5-TTS](https://github.com/SWivid/F5-TTS)', '품질': '우수', '속도': '보통~빠름', '음성 복제': '있음(zero-shot)', '다국어': '예(다국어)', 'VRAM': '3~5 GB', '라이선스': 'CC-BY-NC-4.0', 'MOS(영어)': '~4.1' },
          { '도구': '[Bark](https://github.com/suno-ai/bark)', '품질': '독특함/가변적', '속도': '느림', '음성 복제': '제한적', '다국어': '예(다국어)', 'VRAM': '4~8 GB', '라이선스': 'MIT', 'MOS(영어)': '~3.2~4.0(가변적)' },
          { '도구': '[StyleTTS 2](https://github.com/yl4579/StyleTTS2)', '품질': '우수(영어)', '속도': '보통', '음성 복제': '없음', '다국어': '주로 영어', 'VRAM': '2~4 GB', '라이선스': 'MIT', 'MOS(영어)': '~4.3' },
          { '도구': '[Tortoise](https://github.com/neonbjb/tortoise-tts)', '품질': '우수', '속도': '매우 느림(문장당 수 분)', '음성 복제': '있음', '다국어': '주로 영어', 'VRAM': '4~8 GB', '라이선스': 'Apache 2.0', 'MOS(영어)': '~4.2' },
        ],
      },
      latencyTable: {
        id: 'latency-table',
...
snippetBlocks: [
        ...
        rows: [
          ...
          { '도구': '[F5-TTS](https://github.com/SWivid/F5-TTS)', '라이선스': 'CC-BY-NC-4.0', '상업적 가능?': '아니오 — 비상업용', '주요 조건': 'NC는 fine-tune에도 이어짐(Emilia 학습 데이터)' },
          { '도구': '[Bark](https://github.com/suno-ai/bark)', '라이선스': 'MIT', '상업적 가능?': '예 — 제한 없음', '주요 조건': 'MIT 저작권 고지 포함' },
          { '도구': '[StyleTTS 2](https://github.com/yl4579/StyleTTS2)', '라이선스': 'MIT', '상업적 가능?': '예 — 제한 없음', '주요 조건': 'MIT 저작권 고지 포함' },
          { '도구': '[Tortoise](https://github.com/neonbjb/tortoise-tts)', '라이선스': 'Apache 2.0', '상업적 가능?': '예 — 제한 없음', '주요 조건': '저작자 표시; 복제 음성에 대한 동의 확보' },
        ],
        callouts: [
...
# Model now loads without the interactive license prompt`,
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[XTTS v2 리뷰](/ko/power-local-llm/xtts-v2-review) — XTTS v2 모델 자체에 대한 전용 리뷰로, 실제 사용 명령어와 비상업용 CPML 라이선스를 다룹니다.',
          '[Bark 리뷰](/ko/power-local-llm/bark-tts-review) — 웃음 등 비언어적 소리를 추가할 수 있지만 음성 클로닝은 지원하지 않는, Suno의 MIT 라이선스 생성형 오디오 모델에 대한 전용 리뷰입니다.',
          '[StyleTTS 2 리뷰](/ko/power-local-llm/styletts-2-review) — 컬럼비아 대학교의 MIT 라이선스 스타일 확산 음성 모델에 대한 전용 리뷰로, README 수준의 공개 조건과 유지보수 상태를 다룹니다.',
...
snippetBlocks: [
        ...
        rows: [
          ...
          {
            'Ferramenta': '[F5-TTS](https://github.com/SWivid/F5-TTS)',
            'Qualidade': 'Excelente',
          ...
          {
            'Ferramenta': '[Tortoise](https://github.com/neonbjb/tortoise-tts)',
            'Qualidade': 'Excelente',
...
snippetBlocks: [
        ...
        rows: [
          ...
          {
            'Ferramenta': '[Coqui TTS (kit)](https://github.com/coqui-ai/TTS)',
            'Licença': 'MPL 2.0',
            'Comercial?': 'Sim — com condições',
            'Condição principal': 'Divulgar o código-fonte de quaisquer modificações nos arquivos do kit',
          },
          {
            'Ferramenta': '[XTTS v2 (modelo)](https://huggingface.co/coqui/XTTS-v2)',
            'Licença': 'CPML',
...
# O modelo agora carrega sem o prompt interativo de licença`,
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Análise do XTTS v2](/pt/power-local-llm/xtts-v2-review) — uma análise dedicada ao próprio modelo XTTS v2, com comandos de uso reais e sua licença CPML não comercial.',
          '[Análise do Bark](/pt/power-local-llm/bark-tts-review) — uma análise dedicada ao modelo de áudio generativo com licença MIT da Suno, que adiciona risadas e outros sons não verbais, mas não suporta clonagem de voz.',
          '[Análise do StyleTTS 2](/pt/power-local-llm/styletts-2-review) — uma análise dedicada ao modelo de voz por difusão de estilo da Universidade Columbia, com licença MIT, incluindo sua condição de divulgação do README e status de manutenção.',
...
snippetBlocks: [
        ...
        rows: [
          ...
          {
            'الأداة': '[F5-TTS](https://github.com/SWivid/F5-TTS)',
            'الجودة': 'ممتازة',
            'السرعة': 'متوسطة-سريعة',
          ...
          {
            'الأداة': '[Tortoise](https://github.com/neonbjb/tortoise-tts)',
            'الجودة': 'ممتازة',
...
snippetBlocks: [
        ...
        rows: [
          ...
          {
            'الأداة': '[Coqui TTS (مجموعة الأدوات)](https://github.com/coqui-ai/TTS)',
            'الترخيص': 'MPL 2.0',
            'تجاري؟': 'نعم — بشروط',
            'الشرط الرئيسي': 'الإفصاح عن مصدر أي تعديلات على ملفات مجموعة الأدوات',
          },
          {
            'الأداة': '[XTTS v2 (النموذج)](https://huggingface.co/coqui/XTTS-v2)',
            'الترخيص': 'CPML',
            'تجاري؟': 'لا — غير تجاري',
...
# Model now loads without the interactive license prompt`,
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[مراجعة XTTS v2](/ar/power-local-llm/xtts-v2-review) — مراجعة مخصصة لنموذج XTTS v2 نفسه، مع أوامر استخدام حقيقية ورخصته CPML غير التجارية.',
          '[مراجعة Bark](/ar/power-local-llm/bark-tts-review) — مراجعة مخصصة لنموذج Suno الصوتي التوليدي المرخّص بموجب MIT، الذي يضيف الضحك وأصواتًا غير كلامية أخرى لكنه لا يدعم استنساخ الصوت.',
          '[مراجعة StyleTTS 2](/ar/power-local-llm/styletts-2-review) — مراجعة مخصصة لنموذج الصوت القائم على انتشار الأسلوب من جامعة كولومبيا، المرخّص بموجب MIT، بما في ذلك شرط الإفصاح على مستوى README وحالة الصيانة.',
