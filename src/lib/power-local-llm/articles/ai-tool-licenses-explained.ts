...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[The Complete Local LLM Software Directory](/directory) — ' + TOTAL_TOOL_COUNT + ' local LLM tools with the license listed for each entry.',
  ...
  de: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Das vollständige Local-LLM-Software-Verzeichnis](/de/directory) — über 160 lokale LLM-Tools mit der jeweiligen Lizenz.',
  ...
  fr: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Le répertoire complet des logiciels LLM locaux](/fr/directory) — plus de 160 outils de LLM local avec la licence de chaque entrée.',
  ...
  es: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[El directorio completo de software de LLM local](/es/directory) — más de 160 herramientas de LLM local con la licencia de cada entrada.',
  ...
  pt: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[O diretório completo de software de LLM local](/pt/directory) — mais de 160 ferramentas de LLM local com a licença listada em cada entrada.',
  ...
  ja: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '関連記事',
        items: [
          '[ローカルLLMソフトウェア完全ディレクトリ](/ja/directory) — 160以上のローカルLLMツールと、各項目に記載されたライセンス。',
  ...
  zh: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '相关阅读',
        items: [
          '[完整本地LLM软件目录](/zh/directory) — 160多款本地LLM工具,每个条目均标注许可证。',
  ...
  ar: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[الدليل الكامل لبرمجيات LLM المحلية](/ar/directory) — أكثر من 160 أداة LLM محلية مع الترخيص المذكور لكل عنصر.',
  ...
  ko: {
    ...
    intro:
      '이 사이트에서 리뷰한 모든 로컬 LLM 도구, RAG 프레임워크, AI 코딩 어시스턴트는 MIT, Apache-2.0, AGPL-3.0, source-available 라이선스, 혹은 폐쇄형 "무료" 데스크톱 앱 중 하나의 라이선스로 배포됩니다. 이 라이선스는 기능 비교보다 훨씬 더 크게 "실제로 그 도구를 사용할 수 있는지"를 좌우합니다. 본 가이드는 오픈소스 소프트웨어와 AI 모델에서 마주치게 되는 라이선스 계열을 설명합니다 — 각각 무엇을 허용하고 무엇을 요구하는지, 어디서 유래했는지, 누구를 위한 것인지, 그리고 취미 프로젝트든 스타트업 제품이든 사내 시스템이든 재판매하는 클라이언트 배포든 도구를 도입하기 전에 구체적으로 확인해야 할 사항입니다. 이는 분류 체계이지 개별 도구별 라이선스 조회표가 아닙니다 — 특정 리뷰 대상 도구가 어떤 라이선스를 쓰는지는 해당 리뷰나 [소프트웨어 디렉터리](/ko/directory)를 참고하시고, 본 문서는 그 라이선스 이름을 알게 된 후 실제로 무엇을 의미하는지 설명합니다.',
    metaDescription:
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '관련 읽을거리',
        items: [
          '[로컬 LLM 소프트웨어 완전 디렉터리](/ko/directory) — 항목마다 라이선스가 명시된 160개 이상의 로컬 LLM 도구.',
