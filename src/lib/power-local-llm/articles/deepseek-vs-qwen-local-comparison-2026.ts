...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  es: {
    ...
    twitterDescription:
      'DeepSeek-R1 destilado vs Qwen2.5: mismo VRAM, distintas fortalezas. Matemáticas → DeepSeek. Código → Qwen. Tabla de benchmarks completa.',
    ...
    quickAnswerTop: {
      ...
      de: {
        question: 'Was ist besser lokal: DeepSeek oder Qwen?',
        answer:
          'Für Mathematik und Schlussfolgern sind DeepSeek-R1-destillierte Modelle stärker (94 % MATH-500 bei 32B). Für Programmierung und chinesischen Text ist Qwen2.5 stärker (91,5 % HumanEval bei 32B).',
        bullets: [
          'Mathematik/Schlussfolgern: DeepSeek-R1-Distill-Qwen-32B (94 % MATH-500)',
          'Programmierung: Qwen2.5-Coder 32B (91,5 % HumanEval)',
          'Chinesischer Text: Qwen2.5 7B–72B (natives Tokenisierung)',
      ...
      fr: {
        question: 'Lequel est le meilleur localement : DeepSeek ou Qwen ?',
        answer:
          'Pour les mathématiques et le raisonnement, les modèles distillés DeepSeek-R1 sont plus forts (94 % MATH-500 à 32B). Pour le code et le texte chinois, Qwen2.5 est plus fort (91,5 % HumanEval à 32B).',
        bullets: [
          'Maths / raisonnement : DeepSeek-R1-Distill-Qwen-32B (94 % MATH-500)',
          'Code : Qwen2.5-Coder 32B (91,5 % HumanEval)',
          'Texte chinois : Qwen2.5 7B–72B (tokenisation native)',
      ...
      ja: {
        question: 'ローカルで優れているのはDeepSeekとQwenのどちら？',
        answer:
          '数学・推論タスクではDeepSeek-R1蒸留モデルが優れています（32BでMATH-500 94%）。コーディングと中国語テキストではQwen2.5が優れています（32BでHumanEval 91.5%）。',
        bullets: [
          '数学・推論：DeepSeek-R1-Distill-Qwen-32B（MATH-500 94%）',
          'コーディング：Qwen2.5-Coder 32B（HumanEval 91.5%）',
          '中国語テキスト：Qwen2.5 7B〜72B（ネイティブトークナイゼーション）',
      ...
      es: {
        ...
        answer:
          'Para matemáticas y razonamiento, los modelos destilados de DeepSeek-R1 son más potentes (94% MATH-500 en 32B). Para programación y texto en chino, Qwen2.5 es más potente (91,5% HumanEval en 32B). Ambas familias funcionan en hardware idéntico con el mismo número de parámetros.',
        bullets: [
          'Matemáticas / razonamiento: DeepSeek-R1-Distill-Qwen-32B (94% MATH-500)',
          'Programación: Qwen2.5-Coder 32B (91,5% HumanEval)',
          'Texto en chino: Qwen2.5 7B–72B (tokenización nativa)',
    ...
    toc: [
      ...
      { label: 'Modelos Qwen2.5 explicados', anchor: 'qwen-models' },
      { label: 'Mac vs NVIDIA', anchor: 'mac-vs-nvidia' },
    ...
    snippetBlocks: [
      {
        type: 'one-sentence',
        content:
          'Los modelos destilados de DeepSeek-R1 lideran en matemáticas y razonamiento; Qwen2.5 lidera en programación y texto en chino — ambos requieren el mismo VRAM con igual número de parámetros.',
      },
      {
        type: 'plain-terms',
        content:
          'DeepSeek publicó una familia de modelos enfocada en razonamiento (R1) y puso a disposición versiones destiladas más pequeñas para uso local. Qwen2.5 es la familia de propósito general de Alibaba. Con 7B parámetros, ambos caben en 5,5 GB de VRAM. La diferencia está en sus fortalezas: DeepSeek es mejor en matemáticas; Qwen es mejor escribiendo código y entendiendo texto en chino.',
      },
    ],
    sections: {
      tldr: {
      ...
      qwenModels: {
        id: 'qwen-models',
        title: 'Modelos locales de Qwen2.5 explicados',
        content:
      ...
      relatedReading: {
        ...
        items: [
          '[Guía de despliegue local de Qwen 2026](/es/local-llms/qwen-local-deployment-guide-2026) — Tabla completa de niveles de hardware para todas las variantes de Qwen2.5',
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: '¿Cuál es mejor para texto en chino: DeepSeek o Qwen?', acceptedAnswer: { '@type': 'Answer', text: 'Qwen2.5 es significativamente mejor. Utiliza un tokenizador chino nativo que es un 30–40% más eficiente en texto CJK.' } },
        { '@type': 'Question', name: '¿Qué modelo para matemáticas con 8 GB VRAM?', acceptedAnswer: { '@type': 'Answer', text: 'DeepSeek-R1-Distill-Qwen-7B. Obtiene un 88% MATH-500 frente al 62,5% de Qwen2.5 7B con VRAM idéntico.' } },
      ],
    },
  },
  ...
  de: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Qwen Lokal-Deployment-Guide 2026](/de/local-llms/qwen-local-deployment-guide-2026) — Vollständige Hardware-Tabelle für alle Qwen2.5-Varianten',
  ...
  fr: {
    ...
    schema: { '@context': 'https://schema.org', '@type': 'TechArticle', headline: 'DeepSeek vs Qwen : Comparaison LLM local 2026', description: 'DeepSeek-R1 distillé vs Qwen2.5 local : VRAM, MMLU, MATH-500, HumanEval. Quel modèle à quel niveau matériel.', url: 'https://www.promptquorum.com/fr/power-local-llm/deepseek-vs-qwen-local-comparison-2026', inLanguage: 'fr', author: { '@type': 'Person', name: 'Hans Kuepper' }, publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' }, datePublished: '2026-05-26', dateModified: '2026-05-26', about: [{ '@type': 'Thing', name: 'DeepSeek R1' }, { '@type': 'Thing', name: 'Qwen2.5' }], speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] } },
  ...
  ja: {
    ...
    sections: {
      ...
      relatedReading: { id: 'related-reading', title: '関連記事', items: ['[Qwenローカル展開ガイド 2026](/ja/local-llms/qwen-local-deployment-guide-2026) — 全Qwen2.5バリアントのハードウェア表', '[ローカルLLM向けGPU購入ガイド 2026](/ja/power-local-llm/best-gpu-buying-guide-local-llm-2026)', '[Qwen vs Llama vs Mistral 2026](/ja/local-llms/qwen-vs-llama-vs-mistral)'] },
    },
    schema: { '@context': 'https://schema.org', '@type': 'TechArticle', headline: 'DeepSeek vs Qwen：ローカルLLM比較 2026', description: 'DeepSeek-R1蒸留 vs Qwen2.5ローカル：VRAM・MMLU・MATH-500・HumanEvalの直接比較。', url: 'https://www.promptquorum.com/ja/power-local-llm/deepseek-vs-qwen-local-comparison-2026', inLanguage: 'ja', author: { '@type': 'Organization', name: 'PromptQuorum' }, publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' }, datePublished: '2026-05-26', dateModified: '2026-05-26', about: [{ '@type': 'Thing', name: 'DeepSeek R1' }, { '@type': 'Thing', name: 'Qwen2.5' }], speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] } },
  ...
  zh: {
    ...
    sections: {
      ...
      relatedReading: { id: 'related-reading', title: '相关阅读', items: ['[Qwen本地部署指南 2026](/zh/local-llms/qwen-local-deployment-guide-2026) — 所有Qwen2.5变体的完整硬件表', '[本地LLM显卡选购指南 2026](/zh/power-local-llm/best-gpu-buying-guide-local-llm-2026) — RTX 4060 vs 4070 vs 4090对比', '[Qwen vs Llama vs Mistral 2026](/zh/local-llms/qwen-vs-llama-vs-mistral) — 三方对比', '[Qwen本地部署指南2026](/zh/local-llms/qwen-local-deployment-guide-2026) — 通过Ollama逐步设置Qwen2.5 7B到72B。', '[DeepSeek v3本地硬件要求](/zh/prompt-bites/deepseek-v3-local-hardware-requirements) — 运行DeepSeek v3完整版和量化版的最低VRAM要求。'] },
    },
    schema: { '@context': 'https://schema.org', '@type': 'TechArticle', headline: 'DeepSeek vs Qwen：本地LLM对比 2026', description: 'DeepSeek-R1蒸馏 vs Qwen2.5本地部署：显存、MMLU、MATH-500、HumanEval基准直接对比，附各硬件配置推荐模型。', url: 'https://www.promptquorum.com/zh/power-local-llm/deepseek-vs-qwen-local-comparison-2026', inLanguage: 'zh', author: { '@type': 'Organization', name: 'PromptQuorum' }, publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' }, datePublished: '2026-05-26', dateModified: '2026-05-26', about: [{ '@type': 'Thing', name: 'DeepSeek R1' }, { '@type': 'Thing', name: 'Qwen2.5' }, { '@type': 'Thing', name: '本地LLM' }], speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] } },
