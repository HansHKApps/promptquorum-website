...
export const article: Partial<Record<Language, LLMArticle>> = {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Best Agentic AI Coding Assistant 2026: Cursor vs Windsurf vs Copilot vs Cline](/power-local-llm/cursor-vs-windsurf-vs-copilot-cline) -- Cline\'s local-model setup compared against Cursor, Windsurf, and GitHub Copilot on price and agent mode',
  ...
  pt: {
    ...
    last_full_refresh: '2026-08-25',
    theme: 'Coding Assistants',
    title: 'Melhores plugins de IDE para LLMs locais em 2026 (VS Code, JetBrains e LM Studio)',
    seoTitle: 'Melhor IDE para LLMs locais 2026 (Ollama, LM Studio e JetBrains)',
    metaDescription: 'O Cline é a melhor IDE para LLMs locais em 2026: gratuito, funciona com Ollama e LM Studio no VS Code e em cada IDE JetBrains (PyCharm, Rider, CLion, GoLand).',
    heroImage: '/images/best-local-llm-ide-plugins-2026-model-recommendations-hero-pt.webp',
    educationalLevel: 'Intermediate',
    affiliateDisclosure: true,
    publishDate: '2026-05-26',
    dateModified: '2026-08-25',
    leadAnswerBlock: '**Cline (VS Code + JetBrains) é a melhor IDE gratuita para LLMs locais em 2026: conecta-se nativamente ao Ollama e ao LM Studio (além de qualquer API compatível com OpenAI), oferece edição agêntica de arquivos, comandos de terminal e ferramentas MCP, e roda inteiramente no seu hardware. Nota: o Continue.dev (anteriormente classificado em #1) foi adquirido pela Cursor em junho de 2026 — a v2.0.0-vscode é sua versão final e o repositório agora é somente leitura.**',
    quickAnswerTop: {
      question: 'Qual é o melhor plugin de IDE para executar modelos de IA locais enquanto você programa?',
      answer: 'Cline (gratuito, open-source, BYOK) é o melhor plugin de IDE para Ollama, LM Studio e LLMs locais em 2026 — depois que o Continue.dev foi adquirido pela Cursor em junho de 2026 e seu repositório congelado na v2.0.0-vscode. O Cline funciona no VS Code e em toda a família JetBrains (PyCharm, Rider, CLion, GoLand, WebStorm, RustRover), com edição agêntica de arquivos e ferramentas MCP. Para uso totalmente offline ou sob exigência de conformidade, o Bodega One Code é a opção mais forte. Para apenas autocompletar, Tabby é a opção mais leve. Aider funciona melhor no terminal.',
      bullets: [
        'Cline: melhor no geral, mantido ativamente — lê/escreve arquivos, executa comandos de terminal, usa ferramentas MCP, VS Code + toda a família JetBrains (PyCharm, Rider, CLion, GoLand, WebStorm, RustRover), gratuito (BYOK) ou ClinePass a partir de $9,99/mês',
        'Bodega One Code: IDE independente local-first gratuita para uso pessoal (não é um plugin) — agente de codificação integrado, bring-your-own-LLM, suporte completo offline/air-gap, $39 pagamento único para o nível comercial (ainda não disponível para compra)',
        'Continue: ainda instala e roda, mas sem manutenção (adquirido pela Cursor em junho de 2026, v2.0.0-vscode final, dados na nuvem excluídos após 15 de julho de 2026) — roda com Ollama, sem novos desenvolvimentos',
        'Tabby: melhor autocompletar self-hosted — roda seu próprio servidor de inferência, modelos de 1–3B, ~33 mil estrelas no GitHub',
        'Aider: melhor nativo de terminal — com reconhecimento de git, edições multiarquivo, mais de 44 mil estrelas no GitHub',
        'Cursor: melhor opção comercial — nível Hobby gratuito, Pro $20/mês, Pro+ $60/mês, Ultra $200/mês, modelos locais via Ollama/LM Studio Custom API',
      ],
      updatedDate: '2026-08-25',
    },
    sections: {
      ...
      buyingTable: {
        title: 'Compare os seis rapidamente',
        content: 'Cada plugin aqui se conecta a um modelo local — a diferença está no tipo de codificação que você faz e em quanto ecossistema comercial você quer ao redor.',
        columns: ['Plugin', 'Melhor para', 'Backend local', 'Preço', 'Obter'],
        rows: [
          { 'Plugin': 'Cline', 'Melhor para': 'A maioria / tarefas agênticas', 'Backend local': 'Ollama, LM Studio, 30+ APIs', 'Preço': 'Gratuito (BYOK) / a partir de $9,99/mês', 'Obter': '[Instalar grátis →](https://github.com/cline/cline)' },
          { 'Plugin': 'Bodega One Code', 'Melhor para': 'Offline / air-gap / conformidade', 'Backend local': 'Ollama, LM Studio, llama.cpp, 10+', 'Preço': 'Gratuito (pessoal) / $39 único', 'Obter': '[Testar grátis →](https://bodegaone.ai)' },
          { 'Plugin': 'Continue (legado)', 'Melhor para': 'Só para usuários já existentes', 'Backend local': 'Ollama, LM Studio, llama.cpp', 'Preço': 'Gratuito (sem manutenção)', 'Obter': '[Continue.dev →](https://continue.dev)' },
          { 'Plugin': 'Tabby', 'Melhor para': 'Autocompletar self-hosted + rápido', 'Backend local': 'Servidor de inferência próprio (1–3B)', 'Preço': 'Gratuito, open-source', 'Obter': '[Self-hostear grátis →](https://tabby.tabbyml.com)' },
          { 'Plugin': 'Aider', 'Melhor para': 'Terminal + fluxo de trabalho git', 'Backend local': 'Ollama, LM Studio, compat. OpenAI', 'Preço': 'Gratuito, open-source', 'Obter': '[Instalar grátis →](https://aider.chat)' },
          { 'Plugin': 'Cursor', 'Melhor para': 'IDE polida, mix nuvem + local', 'Backend local': 'Ollama, LM Studio (Custom API)', 'Preço': 'Hobby grátis / $20–$200/mês', 'Obter': '[Começar grátis →](https://cursor.com)' },
        ],
        note: 'Pule os seis se você ainda não tem um modelo local rodando — escolha primeiro o hardware e um backend (Ollama ou LM Studio), e depois volte para esta tabela. Cada link acima é um link de produto comum, sem relação de afiliação atual — veja o aviso de divulgação no topo desta página.',
      },
      clineCta: {
        title: 'Comece com o Cline: instalado nos próximos 2 minutos',
        content: 'O Cline é a recomendação padrão desta página. Veja por quê e como instalá-lo agora mesmo.',
        items: [
        ...
        affiliateLinks: [
          { label: 'Instalar o Cline para VS Code (grátis)', url: 'https://github.com/cline/cline', productName: 'Cline for VS Code', productCategory: 'dev-tool' },
          { label: 'Instalar o Cline para JetBrains (grátis)', url: 'https://cline.bot/jetbrains', productName: 'Cline for JetBrains', productCategory: 'dev-tool' },
        ],
      },
      decisionGuide: {
        title: 'Qual você deve usar?',
        content: 'Associe sua prioridade a um plugin — os seis são detalhados mais abaixo nesta página.',
        items: [
          '**Mais fácil, quer funcionando hoje** → [Cline](https://github.com/cline/cline) — gratuito, agêntico, VS Code + JetBrains.',
          '**Totalmente offline, air-gapped ou sob exigência de conformidade** → [Bodega One Code](https://bodegaone.ai) — IDE independente sem nenhum componente em nuvem.',
          '**Autocompletar mais rápido para um time, self-hosted** → [Tabby](https://tabby.tabbyml.com) — servidor de inferência próprio, completions abaixo de 200ms.',
          '**Fluxo terminal-first, com reconhecimento de git** → [Aider](https://aider.chat) — edições multiarquivo, auto-commits.',
          '**Quer uma IDE comercial polida com opção local ocasional** → [Cursor](https://cursor.com) — cloud-first por design, modelos locais via Ollama/LM Studio na configuração Custom API.',
      ...
      rankedList: {
        ...
        rankedItems: [
          ...
          },
          {
            ...
            affiliateLinks: [
              { label: 'Começar grátis com o Cursor Hobby', url: 'https://cursor.com' },
            ],
          },
        ],
      ...
      setupGuide: {
        ...
        content: 'Pronto para instalar o Cline? → [Instalar o Cline grátis](https://github.com/cline/cline). Siga estes passos para conectá-lo ao Ollama — a forma mais rápida de começar a programar com LLM local usando a atual escolha #1:',
        numberedItems: [
      ...
      aiderSetupGuide: {
        ...
        content: 'Pronto para instalar o Aider? → [Instalar o Aider grátis](https://aider.chat). Para codificação de IA nativa de terminal, com reconhecimento de git — documentação oficial do Aider: aider.chat/docs/llms/ollama.html',
        numberedItems: [
      ...
      finalRecommendations: {
        title: 'Minhas recomendações para 2026',
        content: 'Seis ferramentas, uma página — aqui está a versão curta se você só quer a resposta:',
        items: [
          '**Melhor no geral** → [Cline](https://github.com/cline/cline) — gratuito, agêntico, VS Code + toda a família JetBrains. Instale primeiro.',
          '**Melhor totalmente offline / conformidade** → [Bodega One Code](https://bodegaone.ai) — IDE independente, sem componente em nuvem.',
          '**Melhor autocompletar** → [Tabby](https://tabby.tabbyml.com) — self-hosted, abaixo de 200ms.',
          '**Melhor fluxo de terminal** → [Aider](https://aider.chat) — com reconhecimento de git, multiarquivo.',
          '**Melhor IDE comercial** → [Cursor](https://cursor.com) — comece grátis no nível Hobby, adicione modelos locais via Ollama/LM Studio.',
        ],
      },
      relatedReading: {
        id: 'related-reading',
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        {
          '@type': 'Question',
          name: 'O Cline funciona no PyCharm, Rider, GoLand, WebStorm, CLion e RustRover?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Sim. O plugin JetBrains do Cline suporta toda a família JetBrains: IntelliJ IDEA, PyCharm, WebStorm, PhpStorm, GoLand, Rider, CLion, RustRover, RubyMine e DataGrip. O plugin JetBrains do Continue cobre um conjunto mais restrito — IntelliJ IDEA, PyCharm, GoLand, WebStorm e Rider — e não recebe mais atualizações.',
          },
        },
        {
          '@type': 'Question',
          name: 'Quais dessas ferramentas funcionam totalmente offline para GDPR, HIPAA ou ambientes air-gapped?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'O Bodega One Code foi feito especificamente para isso, com um modo air-gap dedicado. Cline, Continue, Tabby e Aider também funcionam totalmente offline quando apontados para um backend local (Ollama, LM Studio ou um servidor auto-hospedado). O Cursor continua sendo um aplicativo conectado à nuvem mesmo com modelos locais, então não é adequado para ambientes isolados de rede.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'O Bodega One Code é uma IDE de IA independente e local-first com agente de codificação integrado, gratuita para uso pessoal durante sua beta aberta atual, com suporte a bring-your-own-LLM (BYOL) em mais de 10 backends e operação completa offline/air-gap. Diferente do Cline, que é um plugin adicionado ao VS Code ou JetBrains, o Bodega One Code é uma IDE completa construída ao redor do agente desde o início.',
          },
        },
      ],
    },
    itemListSchema: {
      ...
      numberOfItems: 6,
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Cline', description: 'Melhor no geral — mantido ativamente, agêntico, VS Code + toda a família JetBrains, gratuito (BYOK)' },
        { '@type': 'ListItem', position: 2, name: 'Bodega One Code', description: 'Melhor IDE local-first gratuita para uso pessoal com agente de codificação integrado — BYOL, suporte completo offline/air-gap' },
        ...
        { '@type': 'ListItem', position: 6, name: 'Cursor', description: 'Melhor comercial — nível Hobby gratuito + suporte a modelos locais, $20/mês Pro' },
      ],
    },
    schema: {
      '@type': 'TechArticle',
      headline: 'Melhores plugins de IDE para LLMs locais em 2026 (VS Code, JetBrains e LM Studio)',
      description: 'Comparação classificada de Cline, Bodega One Code, Continue, Tabby, Aider e Cursor para uso de LLM local no VS Code, toda a família JetBrains e LM Studio. Inclui tabela comparativa, guias de configuração, recomendações de modelos e orientação de hardware.',
      datePublished: '2026-05-26',
      dateModified: '2026-08-25',
  ...
  ar: {
    ...
    last_full_refresh: '2026-08-25',
    theme: 'Coding Assistants',
    title: 'أفضل إضافات ⁨IDE⁩ لنماذج ⁨LLM⁩ المحلية في ⁨2026⁩ (⁨VS Code⁩، وJetBrains⁩، وLM Studio⁩)',
    seoTitle: 'أفضل ⁨IDE⁩ لنماذج ⁨LLM⁩ المحلية ⁨2026⁩ (⁨Ollama⁩ وLM Studio⁩ وJetBrains⁩)',
    metaDescription: '⁨Cline⁩ أفضل ⁨IDE⁩ لنماذج ⁨LLM⁩ المحلية في ⁨2026⁩: مجانية، وتعمل مع ⁨Ollama⁩ وLM Studio⁩ في ⁨VS Code⁩ وكل بيئة ⁨JetBrains⁩ (⁨PyCharm⁩، وRider⁩، وCLion⁩، وGoLand⁩).',
    heroImage: '/images/best-local-llm-ide-plugins-2026-model-recommendations-hero-ar.webp',
    educationalLevel: 'Intermediate',
    affiliateDisclosure: true,
    publishDate: '2026-05-26',
    dateModified: '2026-08-25',
    leadAnswerBlock: '**تُعد Cline (VS Code + JetBrains) أفضل IDE مجانية لنماذج LLM المحلية في 2026: تتصل بشكل أصلي بـOllama وLM Studio (بالإضافة إلى أي واجهة برمجة تطبيقات متوافقة مع OpenAI)، وتدعم تحرير الملفات الوكيلي وأوامر الطرفية وأدوات MCP، وتعمل بالكامل على جهازك الخاص. ملاحظة: استحوذت Cursor على Continue.dev (التي كانت مصنّفة سابقاً في المرتبة الأولى) في يونيو 2026 — الإصدار v2.0.0-vscode هو إصدارها الأخير، والمستودع أصبح للقراءة فقط.**',
    quickAnswerTop: {
      question: 'ما أفضل إضافة IDE لتشغيل نماذج الذكاء الاصطناعي المحلية أثناء البرمجة؟',
      answer: 'تُعد Cline (مجانية، مفتوحة المصدر، BYOK) أفضل إضافة IDE لـOllama وLM Studio ونماذج LLM المحلية في 2026 — بعد استحواذ Cursor على Continue.dev في يونيو 2026 وتجميد مستودعه عند الإصدار v2.0.0-vscode. تعمل Cline في VS Code وعبر عائلة JetBrains بأكملها (PyCharm وRider وCLion وGoLand وWebStorm وRustRover)، وتدعم تحرير الملفات الوكيلي وأدوات MCP. للاستخدام غير المتصل بالكامل أو المتوافق مع متطلبات الامتثال، يُعد Bodega One Code الخيار الأقوى. للإكمال التلقائي فقط، تُعد Tabby الأخف. يعمل Aider بشكل أفضل في الطرفية.',
      bullets: [
        'Cline: الأفضل عموماً، يتم صيانتها بفعالية — تقرأ/تكتب الملفات، تنفذ أوامر الطرفية، تستخدم أدوات MCP، VS Code + عائلة JetBrains بأكملها (PyCharm وRider وCLion وGoLand وWebStorm وRustRover)، مجانية (BYOK) أو ClinePass من 9.99$/شهر',
        'Bodega One Code: IDE مستقل محلي أولاً مجاني للاستخدام الشخصي (وليس إضافة) — وكيل برمجة مدمج، bring-your-own-LLM، دعم كامل بلا اتصال/معزول تماماً، 39$ دفعة واحدة للمستوى التجاري (غير متاح للشراء بعد)',
        'Continue: لا تزال تُثبَّت وتعمل لكن دون صيانة (استحوذت عليها Cursor في يونيو 2026، v2.0.0-vscode هو الإصدار النهائي، حُذفت بيانات السحابة بعد 15 يوليو 2026) — تعمل مع Ollama، دون أي تطوير إضافي',
        'Tabby: أفضل إكمال تلقائي self-hosted — يشغّل خادم استدلال خاصاً به، نماذج 1–3B، ~33 ألف نجمة على GitHub',
        'Aider: الأفضل أصيلاً للطرفية — يدرك git، تعديلات متعددة الملفات، أكثر من 44 ألف نجمة على GitHub',
        'Cursor: أفضل خيار تجاري — مستوى Hobby مجاني، Pro بـ20$/شهر، Pro+ بـ60$/شهر، Ultra بـ200$/شهر، نماذج محلية عبر Ollama/LM Studio في إعداد Custom API',
      ],
      updatedDate: '2026-08-25',
    },
    sections: {
      tldr: {
        isTldr: true,
        items: [
          'استحوذت Cursor على Continue.dev (يونيو 2026) — v2.0.0-vscode هو الإصدار النهائي، والمستودع للقراءة فقط، وحُذفت بيانات السحابة بعد 15 يوليو 2026؛ لا يزال يعمل محلياً مع Ollama لكن دون صيانة',
          'أصبحت Cline الآن أفضل بديل مجاني (BYOK) يتم صيانته بفعالية: VS Code + عائلة JetBrains بأكملها (PyCharm وRider وCLion وGoLand وWebStorm وRustRover)، تحرير ملفات وكيلي، أدوات MCP، أكثر من 5 ملايين تثبيت',
          'Bodega One Code هو IDE مستقل محلي أولاً مجاني للاستخدام الشخصي بوكيل برمجة مدمج ودعم bring-your-own-LLM (BYOL) — عمل كامل بلا اتصال/معزول تماماً (air-gap) دون اشتراك إجباري',
          'تشغّل Tabby خادم استدلالها الخاص (نماذج 1–3B) — أقل زمن استجابة للإكمال التلقائي للفرق، self-hosted بموجب رخصة Apache 2.0',
          'Aider هو الخيار الموجّه للطرفية أولاً — يدرك commits الخاصة بـgit، إعادة كتابة متعددة الملفات، أكثر من 44 ألف نجمة على GitHub',
          'استحوذت Cursor (Hobby مجاني / Pro بـ20$ / Pro+ بـ60$ / Ultra بـ200$ شهرياً) على كل من Supermaven وContinue.dev؛ أتمّت SpaceX استحواذها على Cursor بقيمة 60 مليار دولار في أغسطس 2026',
          'تعمل كل الأدوات بلا اتصال بالكامل مقابل خلفية محلية (Ollama أو LM Studio أو خادم self-hosted)؛ Cursor وحدها تتطلب تطبيقاً متصلاً بالسحابة حتى عند استخدام نماذج محلية للاستدلال',
        ],
      },
      buyingTable: {
        title: 'قارن الستة جميعاً في لمحة',
        content: 'تتصل كل إضافة هنا بنموذج محلي — الفرق يكمن في نوع البرمجة التي تقوم بها ومقدار المنظومة التجارية التي تريدها حولها.',
        columns: ['الإضافة', 'الأفضل لـ', 'الخلفية المحلية', 'السعر', 'احصل عليها'],
        rows: [
          { 'الإضافة': 'Cline', 'الأفضل لـ': 'لمعظم المستخدمين / المهام الوكيلية', 'الخلفية المحلية': 'Ollama وLM Studio و30+ واجهة API', 'السعر': 'مجاني (BYOK) / من 9.99$/شهر', 'احصل عليها': '[تثبيت مجاني ←](https://github.com/cline/cline)' },
          { 'الإضافة': 'Bodega One Code', 'الأفضل لـ': 'بلا اتصال / معزول تماماً / امتثال', 'الخلفية المحلية': 'Ollama وLM Studio وllama.cpp و10+', 'السعر': 'مجاني (شخصي) / 39$ دفعة واحدة', 'احصل عليها': '[جرّب مجاناً ←](https://bodegaone.ai)' },
          { 'الإضافة': 'Continue (قديم)', 'الأفضل لـ': 'مستخدمو Continue الحاليون فقط', 'الخلفية المحلية': 'Ollama وLM Studio وllama.cpp', 'السعر': 'مجاني (دون صيانة)', 'احصل عليها': '[Continue.dev ←](https://continue.dev)' },
          { 'الإضافة': 'Tabby', 'الأفضل لـ': 'أسرع إكمال تلقائي self-hosted', 'الخلفية المحلية': 'خادم استدلال خاص (1–3B)', 'السعر': 'مجاني، مفتوح المصدر', 'احصل عليها': '[استضافة ذاتية مجانية ←](https://tabby.tabbyml.com)' },
          { 'الإضافة': 'Aider', 'الأفضل لـ': 'الطرفية + سير عمل git', 'الخلفية المحلية': 'Ollama وLM Studio ومتوافق مع OpenAI', 'السعر': 'مجاني، مفتوح المصدر', 'احصل عليها': '[تثبيت مجاني ←](https://aider.chat)' },
          { 'الإضافة': 'Cursor', 'الأفضل لـ': 'IDE مصقول، مزيج سحابة + محلي', 'الخلفية المحلية': 'Ollama وLM Studio (Custom API)', 'السعر': 'Hobby مجاني / 20$–200$/شهر', 'احصل عليها': '[ابدأ مجاناً ←](https://cursor.com)' },
        ],
        note: 'تخطَّ الستة جميعاً إذا لم يكن لديك نموذج محلي يعمل بعد — اختر العتاد وخلفية (Ollama أو LM Studio) أولاً، ثم عد إلى هذا الجدول. كل رابط أعلاه هو رابط منتج عادي دون علاقة إحالة تسويقية حالياً — انظر ملاحظة الإفصاح في أعلى هذه الصفحة.',
      },
      clineCta: {
        title: 'ابدأ بـCline: ثبّتها خلال الدقيقتين القادمتين',
        content: 'Cline هي التوصية الافتراضية في هذه الصفحة. إليك السبب، وكيفية تثبيتها الآن.',
        items: [
          '**مجانية ومفتوحة المصدر** — أحضر مفتاحك الخاص أو وجّهها إلى نقطة نهاية محلية، دون اشتراك إجباري (ClinePass بـ9.99$+/شهر اختيارية، للتوجيه المُدار دون مفتاح API خاص بك).',
          '**تعمل في VS Code وعائلة JetBrains بأكملها** — IntelliJ IDEA وPyCharm وWebStorm وPhpStorm وGoLand وRider وCLion وRustRover وRubyMine وDataGrip.',
          '**تتصل بشكل أصلي بـOllama وLM Studio** — بالإضافة إلى أكثر من 30 مزوّداً متوافقاً مع OpenAI، دون الحاجة لاعتماد سحابي.',
          '**وكيلية فعلاً** — تقرأ/تكتب الملفات، وتنفذ أوامر الطرفية، وتستخدم أدوات MCP، وليست مجرد إكمال تلقائي مضمّن.',
          '**القيود**: تتطلب المهام الوكيلية الموثوقة متعددة الخطوات نموذجاً محلياً بحجم 32B (24 GB+ من VRAM)؛ نماذج 14B تتعامل مع التعديلات البسيطة لكنها تواجه صعوبة مع إعادة الهيكلة المعقدة متعددة الملفات.',
        ],
        affiliateLinks: [
          { label: 'تثبيت Cline لـVS Code (مجاني)', url: 'https://github.com/cline/cline', productName: 'Cline for VS Code', productCategory: 'dev-tool' },
          { label: 'تثبيت Cline لـJetBrains (مجاني)', url: 'https://cline.bot/jetbrains', productName: 'Cline for JetBrains', productCategory: 'dev-tool' },
        ],
      },
      decisionGuide: {
        title: 'أي واحدة يجب أن تستخدمها؟',
        content: 'طابق أولويتك مع إضافة — الستة جميعاً مغطاة بالتفصيل الكامل أدناه في هذه الصفحة.',
        items: [
          '**الأسهل عموماً، تريدها تعمل اليوم** ← [Cline](https://github.com/cline/cline) — مجانية، وكيلية، VS Code + JetBrains.',
          '**بلا اتصال بالكامل، معزولة تماماً، أو تحت متطلبات امتثال** ← [Bodega One Code](https://bodegaone.ai) — IDE مستقلة دون أي مكوّن سحابي إطلاقاً.',
          '**أسرع إكمال تلقائي لفريق، self-hosted** ← [Tabby](https://tabby.tabbyml.com) — خادم استدلال خاص بها، إكمالات أقل من 200 ميلي ثانية.',
          '**سير عمل يبدأ من الطرفية ويدرك git** ← [Aider](https://aider.chat) — تعديلات متعددة الملفات، commits تلقائية.',
          '**تريد IDE تجارية مصقولة مع خيار محلي أحياناً** ← [Cursor](https://cursor.com) — مصممة أساساً للسحابة، نماذج محلية عبر Ollama/LM Studio في إعداد Custom API.',
          '**تستخدم Continue بالفعل** ← لا تزال تُثبَّت وتعمل (Ollama، BYO-LLM)، لكن المشروع دون صيانة منذ استحواذ Cursor في يونيو 2026 — خطّط للانتقال إلى Cline عندما يناسبك، دون استعجال.',
        ],
      },
      rankedList: {
        ...
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: 'تُعد Cline أفضل إضافة IDE لنماذج LLM المحلية في 2026 لأنها تدعم Ollama بشكل أصلي، وتعمل في كل من VS Code وJetBrains، وتضيف تحرير ملفات وكيلياً وأدوات MCP دون أي اعتماد على السحابة — بينما استحوذت Cursor على Continue، الفائز السابق بالمرتبة الأولى، في يونيو 2026 ولم تعد تطويرها نشطاً.',
          },
          {
            type: 'plain-terms',
        ...
        rankedItems: [
          ...
          {
            rank: 2,
            title: 'Bodega One Code — أفضل IDE مجاني للاستخدام الشخصي محلي أولاً بوكيل برمجة مدمج',
            content: 'يُعد Bodega One Code بيئة تطوير (IDE) محلية أولاً مبنية حول وكيل برمجة من الأساس، بدلاً من كونه مساعداً أُضيف لاحقاً إلى محرر موجود. يدعم مبدأ bring-your-own-LLM (BYOL) عبر أكثر من 10 خلفيات، منها Ollama وLM Studio وllama.cpp وLocalAI وKoboldCpp وGPT4All وMLX للنماذج المحلية، بالإضافة إلى مزودين سحابيين مباشرين إن أردتها: وجّهه إلى أي خلفية وسيقوم الوكيل بتنفيذ التخطيط والتحرير والتنفيذ بالكامل مقابل ذلك النموذج، دون ارتباط بمزوّد واحد. يعمل التطبيق بأكمله على جهازك، بما في ذلك وضع كامل بلا اتصال ومعزول تماماً (air-gap) يمنع اتصالات الشبكة الصادرة، بحيث لا تخرج أي بيانات تتبع أو استدعاءات نموذج من الجهاز — لذا يعمل في بيئات معزولة عن الشبكة لا يمكن لأدوات متصلة بالسحابة مثل Cursor أو GitHub Copilot العمل فيها إطلاقاً. الأسعار: مجاني للاستخدام الشخصي خلال النسخة التجريبية المفتوحة الحالية، ويشمل ذلك حقوق الاستخدام التجاري حالياً؛ مستوى Pro مدفوع بدفعة واحدة (السعر لم يُعلن بعد) مخطَّط له عند الإطلاق الكامل، ويضيف حقوق استخدام تجاري دائمة ومساحات عمل غير محدودة وجهازاً ثانياً، لكنه غير متاح للشراء بعد. لا يوجد اشتراك ولا قياس استخدام لاستخدام النماذج المحلية. هذا يجعله خياراً جيداً للقطاعات الخاضعة للرقابة، والمقاولين الحكوميين والدفاعيين، وأي فريق تمنع سياسته الأمنية إرسال الكود إلى خادم طرف ثالث — وهو نفس الجمهور الذي يبحث أصلاً عن الاستدلال المحلي. مقارنةً بـCline، وهو إضافة تُضاف إلى VS Code، فإن Bodega One Code بيئة تطوير مستقلة صُمِّمت حول الوكيل منذ البداية؛ الفرق التي تستخدم VS Code بالفعل ستجد في Cline الإضافة الأسهل، بينما الفرق التي تبدأ من الصفر أو تحتاج إلى ضمان العمل دون اتصال بالإنترنت تحصل مع Bodega One Code على بيئة مبنية خصيصاً لهذا الغرض.',
            affiliateLinks: [
          ...
          },
          {
            ...
            content: 'Tabby هو مساعد برمجة self-hosted مبني بلغة Rust بموجب رخصة Apache 2.0، يشغّل خادم استدلاله الخاص (منفصل عن Ollama). يستخدم نماذج صغيرة متخصصة لإكمال الكود (1–3B معامل) مُدرَّبة خصيصاً للإكمال التلقائي fill-in-the-middle (FIM) — أسرع بشكل ملحوظ من استخدام نموذج 7B للأغراض العامة. الإصدار المستقر الحالي هو v0.32.0، بحوالي 33 ألف نجمة على GitHub. توجد إضافات IDE لـTabby في VS Code وJetBrains وVim/Neovim وEmacs. مثالي لفرق من 5 إلى 50 مطوراً، خاصة الفرق الخاضعة للرقابة أو الحساسة للملكية الفكرية التي تريد إكمالاً تلقائياً سريعاً (أقل من 200 ميلي ثانية) دون إرسال الكود إلى السحابة. يتطلب خادماً مخصصاً أو جهاز سطح مكتب قوياً — مجاني للاستضافة الذاتية بعدد مستخدمين غير محدود، دون رسوم لكل مقعد.',
            affiliateLinks: [
          ...
          },
          {
            ...
            content: 'Cursor هو fork من VS Code مع ميزات ذكاء اصطناعي مدمجة. يدعم Cursor النماذج المحلية عبر Ollama وLM Studio في إعداد "Custom API". إلا أن أقوى ميزات Cursor (وضع Agent مع بحث الويب، والوعي الكامل بقاعدة الكود) تتطلب نماذج سحابية. تكامل النماذج المحلية يعمل للدردشة والإكمالات البسيطة، لكنه يتأخر عن Cline في سير العمل الذي يركز على الخصوصية، لأن Cursor نفسها تظل تطبيقاً متصلاً بالسحابة حتى عند تشغيل الاستدلال محلياً. الأسعار: Hobby (مجاني، يشمل استخدام النماذج المحلية)؛ Pro بـ20$/شهر (16$/شهر بفوترة سنوية، يشمل رصيد ذكاء اصطناعي بقيمة 20$/شهر للنماذج المتقدمة؛ وضع Auto غير محدود دون تكلفة أرصدة)؛ Pro+ بـ60$/شهر (3 أضعاف أرصدة الاستخدام)؛ Ultra بـ200$/شهر (20 ضعف الاستخدام)؛ Teams بـ40$/مستخدم/شهر مع فوترة مركزية وSSO. ملاحظة: استحوذت Cursor على Supermaven (2024) وContinue.dev (يونيو 2026). أتمّت SpaceX استحواذها على Cursor بقيمة 60 مليار دولار في أغسطس 2026، بعد أيام من طرح أسهم SpaceX نفسها للاكتتاب العام — وتشير التقارير إلى أن إيرادات Cursor السنوية نمت من نحو 100 مليون دولار في أوائل 2025 إلى أكثر من 4 مليارات دولار بحلول يونيو 2026. هذا التوحّد يجعل من Cursor القوة التجارية المهيمنة في أدوات البرمجة بالذكاء الاصطناعي — لكنه يثير تساؤلات طويلة المدى حول بدائل المصادر المفتوحة.',
            pros: [
              'fork مصقول ومألوف لـVS Code — منحنى تعلّم شبه معدوم لمستخدمي VS Code الحاليين',
              'نماذج محلية عبر Ollama أو LM Studio من خلال إعداد Custom API',
              'مستوى Hobby المجاني يشمل استخدام النماذج المحلية، وليس مجرد نسخة تجريبية',
            ],
            cons: [
              'أقوى الميزات (وضع Agent، الوعي الكامل بقاعدة الكود) تتطلب نماذج سحابية/متقدمة، وليست محلية',
              'مملوكة الآن لـSpaceX/xAI — ملف مزوّد مختلف جوهرياً عن أداة مستقلة مفتوحة المصدر',
            ],
            affiliateLinks: [
              { label: 'ابدأ مجاناً مع Cursor Hobby', url: 'https://cursor.com' },
            ],
          },
        ],
      ...
      setupGuide: {
        ...
        content: 'هل أنت مستعد لتثبيت Cline؟ ← [ثبّت Cline مجاناً](https://github.com/cline/cline). اتبع هذه الخطوات لتوصيلها بـOllama — أسرع طريقة لبدء البرمجة بنموذج LLM محلي مع الخيار الأول الحالي:',
        numberedItems: [
      ...
      aiderSetupGuide: {
        ...
        content: 'هل أنت مستعد لتثبيت Aider؟ ← [ثبّت Aider مجاناً](https://aider.chat). للبرمجة الذكية الأصيلة في الطرفية والمدركة لـgit — التوثيق الرسمي لـAider: aider.chat/docs/llms/ollama.html',
        numberedItems: [
      ...
      modelRecommendations: {
        ...
        note: 'هل تحتاج عتاداً لهذه النماذج؟ 8 GB من VRAM تكفي لنماذج الإكمال الصغيرة في Tabby؛ 16 GB تكفي لمعظم نماذج البرمجة بحجم 14B (Continue، وضع المحرر في Aider، الخيار المحلي لـCursor)؛ 24 GB+ هو الحد الأدنى الواقعي لعمل وكيلي موثوق بحجم 32B مع Cline أو وضع المهندس المعماري في Aider. راجع [أفضل وحدات معالجة الرسوميات لنماذج LLM المحلية](/ar/local-llms/best-gpus-for-local-llms) للاختيارات الكاملة، أو [أفضل وحدات معالجة رسوميات اقتصادية لنماذج LLM المحلية](/ar/local-llms/best-budget-gpus-local-llm) إذا كنت تبدأ بأقل من 16 GB.',
      },
      lmStudioPlugins: {
        title: 'أفضل إضافات LM Studio (ليست نفسها إضافات IDE)',
        content: 'هذا سؤال مختلف عن "أي إضافة IDE تتصل بـLM Studio" (تم تناوله أعلاه) — ويستحق إجابة مباشرة، لأن LM Studio هي إحدى الخلفيتين اللتين تتصل بهما كل إضافة في هذا الدليل. يمتلك LM Studio نظام إضافات خاصاً به منذ أواخر 2024: تعمل الإضافات داخل LM Studio نفسه — حالياً ككود TypeScript/JavaScript على Node.js في عامل معزول (sandboxed worker)، بينما لا يزال دعم Python قيد التطوير — ويمكنها اعتراض طلبات الاستدلال، وإضافة معالجات موجهات (prompt processors)، وربط خلفيات استدعاء الأدوات، أو إضافة لوحات واجهة مستخدم جديدة. ثبّتها من السوق المنسّق على lmstudio.ai/plugins؛ تعلن كل إضافة عن الأذونات المطلوبة مسبقاً (الوصول للشبكة، قراءة نظام الملفات)، ويمكنك إلغاءها لاحقاً من الإعدادات دون إلغاء التثبيت. الفئات الشائعة اعتباراً من 2026: إضافات البحث على الويب، معالجات RAG/استرداد المستندات المسبقة، معالجات OCR المسبقة، إضافات مجموعات الأدوات الوكيلية، أدوات الوصول للصدفة/الملفات، وإضافات الذاكرة.',
        items: [
        ...
        faqs: [
          {
            ...
            a: 'اعتباراً من يونيو 2026، استحوذت Cursor على Continue، وv2.0.0-vscode (الصادر في 19 يونيو 2026) هو الإصدار النهائي؛ المستودع للقراءة فقط، وحُذفت بيانات السحابة المستضافة لدى Continue بعد 15 يوليو 2026. لا تزال الإضافة تُثبَّت وتعمل بلا اتصال مع Ollama وBYO-LLM، لكنها لا تتلقى أي تطوير إضافي من الفريق الأصلي. كبديل مفتوح المصدر يتم صيانته بفعالية، تُعد Cline البديل الموصى به — فهي تقدّم نفس نموذج BYOK، وتعمل في VS Code وعائلة JetBrains بأكملها، وتضيف تحرير ملفات وكيلياً. يكلف GitHub Copilot Pro 10$/شهر مع 15$/شهر من أرصدة الذكاء الاصطناعي؛ Cline مجانية بمفتاح API الخاص بك.',
          },
          {
          ...
          },
          {
            ...
            a: 'نعم. يعرض LM Studio واجهة API متوافقة مع OpenAI على المنفذ 1234 افتراضياً. عيّن موفر الإضافة على "openai" مع عنوان URL الأساسي `http://localhost:1234/v1` واستخدم أي اسم نموذج من مكتبة LM Studio. تدعم Cline وContinue وAider وBodega One Code جميعها هذا الإعداد. لاحظ أن هذا يختلف عن نظام إضافات LM Studio الخاص به (انظر قسم "أفضل إضافات LM Studio" أعلاه) — فذلك مخصص لتوسيع LM Studio نفسه، وليس لتوصيل IDE خارجي به.',
          },
          {
            q: 'هل تعمل Cline في PyCharm وRider وGoLand وWebStorm وCLion وRustRover؟',
            a: 'نعم — إضافة JetBrains الخاصة بـCline، المثبَّتة من JetBrains Marketplace، تدعم عائلة JetBrains بأكملها: IntelliJ IDEA وPyCharm وWebStorm وPhpStorm وGoLand وRider وCLion وRustRover وRubyMine وDataGrip. اضبط نفس إعدادات موفر Ollama أو LM Studio كما في نسخة VS Code. إضافة JetBrains الخاصة بـContinue (دون صيانة منذ استحواذ Cursor في يونيو 2026) تغطي مجموعة أضيق — IntelliJ IDEA وPyCharm وGoLand وWebStorm وRider — لكن ليس CLion أو RustRover.',
          },
          {
            q: 'ما بيئات JetBrains التي تدعم إضافات LLM المحلية؟',
            a: 'توفر كل من Cline وContinue إضافات JetBrains. تغطي Cline العائلة بأكملها: IntelliJ IDEA وPyCharm وPhpStorm وWebStorm وGoLand وRider وCLion وRustRover وRubyMine وDataGrip. تغطي Continue فقط IntelliJ IDEA وPyCharm وPhpStorm وWebStorm وGoLand وRider. ثبّتها من JetBrains Marketplace (وليس VS Code Marketplace) واضبط نفس إعدادات موفر Ollama/LM Studio كما في نسخة VS Code. تدعم Tabby أيضاً JetBrains للإكمال التلقائي فقط.',
          },
          {
            q: 'أي من هذه الأدوات يعمل بلا اتصال بالكامل من أجل GDPR أو HIPAA أو البيئات المعزولة تماماً (air-gapped)؟',
            a: 'Bodega One Code مبنية لهذا الغرض تحديداً: عمل كامل بلا اتصال مع نماذج محلية، بالإضافة إلى وضع air-gap يمنع جميع اتصالات الشبكة الصادرة بحيث لا تخرج أي بيانات تتبع أو استدعاءات نموذج من الجهاز. تعمل Cline وContinue وTabby وAider أيضاً بلا اتصال بالكامل، طالما وجّهتها إلى خلفية محلية (Ollama أو LM Studio أو خادم Tabby self-hosted) بدلاً من واجهة API سحابية — لا شيء منها "يتصل بالمنزل" بهذا الإعداد. دعم Cursor للنماذج المحلية (عبر إعداد Custom API) لا يزال يعمل داخل تطبيق متصل بالسحابة، لذا فهو غير مناسب للبيئات المعزولة عن الشبكة.',
          },
          {
            q: 'ما هو Bodega One Code، وكيف يختلف عن Cline؟',
            a: 'Bodega One Code هو بيئة تطوير (IDE) مستقلة محلية أولاً بوكيل برمجة مدمج، مجانية للاستخدام الشخصي خلال النسخة التجريبية المفتوحة الحالية — على عكس Cline، وهو إضافة تُضاف إلى VS Code أو JetBrains، فإن Bodega One Code بيئة تطوير كاملة صُمِّمت حول الوكيل منذ البداية. يدعم bring-your-own-LLM (BYOL) عبر أكثر من 10 خلفيات، ويعمل بالكامل بلا اتصال مع دعم air-gap. مستوى Pro مدفوع بدفعة واحدة (39$) للاستخدام التجاري مخطَّط له لكنه غير متاح للشراء بعد. إنه خيار جيد للبيئات الخاضعة للرقابة أو المعزولة عن الشبكة حيث لا يمكن ببساطة استخدام محرر متصل بالسحابة.',
          },
        ],
      },
      finalRecommendations: {
        title: 'توصياتي لعام 2026',
        content: 'ست أدوات، صفحة واحدة — إليك النسخة المختصرة إذا كنت تريد الإجابة فقط:',
        items: [
          '**الأفضل عموماً** ← [Cline](https://github.com/cline/cline) — مجانية، وكيلية، VS Code + عائلة JetBrains بأكملها. ثبّتها أولاً.',
          '**الأفضل بلا اتصال بالكامل / للامتثال** ← [Bodega One Code](https://bodegaone.ai) — IDE مستقلة، دون مكوّن سحابي.',
          '**الأفضل للإكمال التلقائي** ← [Tabby](https://tabby.tabbyml.com) — self-hosted، أقل من 200 ميلي ثانية.',
          '**الأفضل لسير عمل الطرفية** ← [Aider](https://aider.chat) — يدرك git، متعدد الملفات.',
          '**الأفضل كـIDE تجارية** ← [Cursor](https://cursor.com) — ابدأ مجاناً في مستوى Hobby، وأضف نماذج محلية عبر Ollama/LM Studio.',
        ],
      },
      relatedReading: {
        id: 'related-reading',
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'اعتباراً من يونيو 2026، استحوذت Cursor على Continue وv2.0.0-vscode هو إصدارها النهائي (المستودع للقراءة فقط، وحُذفت بيانات السحابة بعد 15 يوليو 2026). لا تزال الإضافة تعمل بلا اتصال مع Ollama، لكن Cline أصبحت الآن البديل المفتوح المصدر الموصى به الذي يتم صيانته بفعالية — مجانية بنظام BYOK، تعمل في VS Code وعائلة JetBrains بأكملها، وتضيف تحرير ملفات وكيلياً.',
          },
        },
        {
          '@type': 'Question',
        ...
        {
          '@type': 'Question',
          name: 'هل تعمل Cline في PyCharm وRider وGoLand وWebStorm وCLion وRustRover؟',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'نعم. إضافة JetBrains الخاصة بـCline تدعم عائلة JetBrains بأكملها: IntelliJ IDEA وPyCharm وWebStorm وPhpStorm وGoLand وRider وCLion وRustRover وRubyMine وDataGrip. إضافة JetBrains الخاصة بـContinue تغطي مجموعة أضيق — IntelliJ IDEA وPyCharm وGoLand وWebStorm وRider — ولم تعد تتلقى تحديثات.',
          },
        },
        {
          '@type': 'Question',
          name: 'أي من هذه الأدوات يعمل بلا اتصال بالكامل من أجل GDPR أو HIPAA أو البيئات المعزولة تماماً (air-gapped)؟',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Bodega One Code مبنية لهذا الغرض تحديداً، بوضع air-gap مخصص. تعمل Cline وContinue وTabby وAider أيضاً بلا اتصال بالكامل عند توجيهها إلى خلفية محلية (Ollama أو LM Studio أو خادم self-hosted). تظل Cursor تطبيقاً متصلاً بالسحابة حتى مع النماذج المحلية، لذا فهي غير مناسبة للبيئات المعزولة عن الشبكة.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Bodega One Code هو بيئة تطوير مستقلة محلية أولاً بوكيل برمجة مدمج، مجانية للاستخدام الشخصي خلال النسخة التجريبية المفتوحة الحالية، تدعم bring-your-own-LLM (BYOL) عبر أكثر من 10 خلفيات، وتعمل بالكامل بلا اتصال مع دعم air-gap. على عكس Cline، وهو إضافة تُضاف إلى VS Code أو JetBrains، فإن Bodega One Code بيئة تطوير كاملة صُمِّمت حول الوكيل منذ البداية.',
          },
        },
      ],
    },
    itemListSchema: {
      ...
      numberOfItems: 6,
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Cline', description: 'الأفضل عموماً — يتم صيانتها بفعالية، وكيلية، VS Code + عائلة JetBrains بأكملها، مجانية (BYOK)' },
        { '@type': 'ListItem', position: 2, name: 'Bodega One Code', description: 'أفضل IDE مجاني للاستخدام الشخصي محلي أولاً بوكيل برمجة مدمج — BYOL، دعم كامل بلا اتصال/معزول تماماً' },
        { '@type': 'ListItem', position: 3, name: 'Continue', description: 'لا تزال تعمل لكن دون صيانة منذ استحواذ Cursor، يونيو 2026' },
        ...
        { '@type': 'ListItem', position: 6, name: 'Cursor', description: 'الأفضل تجارياً — مستوى Hobby مجاني + دعم النماذج المحلية، Pro بـ20$/شهر' },
      ],
    },
    schema: {
      '@type': 'TechArticle',
      headline: 'أفضل إضافات IDE لنماذج LLM المحلية في 2026 (VS Code وJetBrains وLM Studio)',
      description: 'مقارنة مُصنَّفة لـCline وBodega One Code وContinue وTabby وAider وCursor لاستخدام LLM محلي في VS Code وعائلة JetBrains بأكملها وLM Studio. يتضمن جدول مقارنة شراء، وأدلة إعداد، وتوصيات نماذج، وإرشادات عتاد.',
      datePublished: '2026-05-26',
      dateModified: '2026-08-25',
