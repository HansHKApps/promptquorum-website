...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'إضافات IDE لـLLM المحلي 2026: Continue وCline وAider',
    metaDescription: 'Continue أفضل إضافة IDE مجانية لـLLMs المحلية 2026 مع دعم Ollama وLM Studio. Cline وAider وCursor مقارَنة حسب الإكمال التلقائي ونافذة السياق.',
    educationalLevel: 'Intermediate',
    affiliateDisclosure: true,
    publishDate: '2026-05-26',
