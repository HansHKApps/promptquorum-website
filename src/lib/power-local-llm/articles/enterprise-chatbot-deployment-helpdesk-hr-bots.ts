  ...
  en: {
    ...
    sections: {
      ...
      ragArchitecture: {
        ...
        items: [
          ...
          'For the vector database layer, see [Pinecone vs Weaviate vs Qdrant vs Chroma](/power-local-llm/pinecone-vs-weaviate-vs-qdrant-vs-chroma) — the access-control filtering described above is applied as metadata filters at query time in whichever vector store you choose, not as a separate system.',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Best AI-Powered Marketing Software for Enterprises 2026](/power-local-llm/best-ai-marketing-software-enterprise) — a related build-vs-buy comparison for content generation and customer-journey automation, relevant where marketing chatbots overlap with this guide.',
          ...
          '[Pinecone vs Weaviate vs Qdrant vs Chroma](/power-local-llm/pinecone-vs-weaviate-vs-qdrant-vs-chroma) — vector database comparison for the metadata-filtered retrieval layer.',
        ],
      },
    },
    schema: {
    ...
    breadcrumbSchema: {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Enterprise Chatbot Deployment: Internal Helpdesk & HR Bots', item: '[www.promptquorum.com/power-local-llm/enterprise-chatbot-deployment-helpdesk-hr-bots](https://www.promptquorum.com/power-local-llm/enterprise-chatbot-deployment-helpdesk-hr-bots)' },
      ],
    },
  },
  de: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Beste KI-Marketing-Software für Unternehmen 2026](/de/power-local-llm/best-ai-marketing-software-enterprise) — ein verwandter Build-vs-Buy-Vergleich für Content-Generierung und Customer-Journey-Automatisierung, relevant wo Marketing-Chatbots sich mit diesem Leitfaden überschneiden.',
          ...
          '[Pinecone vs. Weaviate vs. Qdrant vs. Chroma](/de/power-local-llm/pinecone-vs-weaviate-vs-qdrant-vs-chroma) — Vektordatenbank-Vergleich für die metadatengefilterte Retrieval-Schicht.',
        ],
      },
    },
    schema: {
    ...
    breadcrumbSchema: {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Interne Chatbots: IT-Helpdesk & HR-Bots', item: '[www.promptquorum.com/de/power-local-llm/enterprise-chatbot-deployment-helpdesk-hr-bots](https://www.promptquorum.com/de/power-local-llm/enterprise-chatbot-deployment-helpdesk-hr-bots)' },
      ],
    },
  },
  fr: {
    ...
    sections: {
      ...
      ragArchitecture: {
        ...
        items: [
          ...
          'Pour la couche base vectorielle, voir [Pinecone vs Weaviate vs Qdrant vs Chroma](/fr/power-local-llm/pinecone-vs-weaviate-vs-qdrant-vs-chroma) — le filtrage de contrôle d\'accès décrit plus haut s\'applique comme filtre de métadonnées au moment de la requête, quelle que soit la base choisie.',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Meilleurs logiciels marketing IA pour entreprises 2026](/fr/power-local-llm/best-ai-marketing-software-enterprise) — un comparatif construire-vs-acheter apparenté pour la génération de contenu et l\'automatisation du parcours client, pertinent là où les chatbots marketing recoupent ce guide.',
          ...
          '[Pinecone vs Weaviate vs Qdrant vs Chroma](/fr/power-local-llm/pinecone-vs-weaviate-vs-qdrant-vs-chroma) — comparaison de bases vectorielles pour la couche de récupération filtrée par métadonnées.',
        ],
      },
    },
    schema: {
    ...
    breadcrumbSchema: {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Chatbots internes : helpdesk IT & bots RH', item: '[www.promptquorum.com/fr/power-local-llm/enterprise-chatbot-deployment-helpdesk-hr-bots](https://www.promptquorum.com/fr/power-local-llm/enterprise-chatbot-deployment-helpdesk-hr-bots)' },
      ],
    },
  },
  ja: {
    ...
    sections: {
      ...
      ragArchitecture: {
        ...
        items: [
          ...
          'ベクトルデータベース層については[Pinecone vs Weaviate vs Qdrant vs Chroma](/ja/power-local-llm/pinecone-vs-weaviate-vs-qdrant-vs-chroma)を参照——前述のアクセス制御フィルタリングは、選択したベクトルストアに関わらず、クエリ時のメタデータフィルターとして適用される、別システムではない。',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[企業向けAIマーケティングソフト2026年比較](/ja/power-local-llm/best-ai-marketing-software-enterprise) —— コンテンツ生成とカスタマージャーニー自動化に関する関連するビルド対バイの比較で、マーケティングチャットボットが本ガイドと重なる部分に関連します。',
          ...
          '[Pinecone vs Weaviate vs Qdrant vs Chroma](/ja/power-local-llm/pinecone-vs-weaviate-vs-qdrant-vs-chroma) — メタデータフィルタリングされた検索層のためのベクトルデータベース比較。',
        ],
      },
    },
    schema: {
    ...
    breadcrumbSchema: {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: '社内チャットボット構築:ITヘルプデスク・人事Bot', item: '[www.promptquorum.com/ja/power-local-llm/enterprise-chatbot-deployment-helpdesk-hr-bots](https://www.promptquorum.com/ja/power-local-llm/enterprise-chatbot-deployment-helpdesk-hr-bots)' },
      ],
    },
  },
  zh: {
    ...
    sections: {
      ...
      ragArchitecture: {
        ...
        items: [
          ...
          '关于向量数据库层,请见[Pinecone vs Weaviate vs Qdrant vs Chroma](/zh/power-local-llm/pinecone-vs-weaviate-vs-qdrant-vs-chroma)——上述访问控制过滤是在查询时以元数据过滤器的形式应用,无论选择哪种向量存储,而非作为独立系统存在。',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026年企业级AI营销软件最佳选择](/zh/power-local-llm/best-ai-marketing-software-enterprise) —— 关于内容生成与客户旅程自动化的相关自建对比购买对比，与营销聊天机器人和本指南的重叠部分相关。',
          ...
          '[Pinecone vs Weaviate vs Qdrant vs Chroma](/zh/power-local-llm/pinecone-vs-weaviate-vs-qdrant-vs-chroma) — 用于元数据过滤检索层的向量数据库比较。',
        ],
      },
    },
    schema: {
    ...
    breadcrumbSchema: {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: '内部聊天机器人部署:IT帮助台与HR机器人', item: '[www.promptquorum.com/zh/power-local-llm/enterprise-chatbot-deployment-helpdesk-hr-bots](https://www.promptquorum.com/zh/power-local-llm/enterprise-chatbot-deployment-helpdesk-hr-bots)' },
      ],
    },
  },
  es: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Mejor software de marketing con IA para empresas 2026](/es/power-local-llm/best-ai-marketing-software-enterprise) — una comparativa relacionada de construir frente a comprar para generación de contenido y automatización del recorrido de cliente, relevante donde los chatbots de marketing se solapan con esta guía.',
          ...
          '[Pinecone vs Weaviate vs Qdrant vs Chroma](/es/power-local-llm/pinecone-vs-weaviate-vs-qdrant-vs-chroma) — comparación de bases de datos vectoriales para la capa de recuperación filtrada por metadatos.',
        ],
      },
    },
    schema: {
    ...
    breadcrumbSchema: {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Chatbots internos: helpdesk de IT y bots de RR. HH.', item: '[www.promptquorum.com/es/power-local-llm/enterprise-chatbot-deployment-helpdesk-hr-bots](https://www.promptquorum.com/es/power-local-llm/enterprise-chatbot-deployment-helpdesk-hr-bots)' },
      ],
    },
  },
  pt: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Melhor software de marketing com IA para empresas 2026](/pt/power-local-llm/best-ai-marketing-software-enterprise) — uma comparação relacionada de construir versus comprar para geração de conteúdo e automação da jornada do cliente, relevante onde chatbots de marketing se sobrepõem a este guia.',
          ...
          '[Pinecone vs Weaviate vs Qdrant vs Chroma](/pt/power-local-llm/pinecone-vs-weaviate-vs-qdrant-vs-chroma) — comparação de bancos vetoriais pra camada de recuperação filtrada por metadados.',
        ],
      },
    },
    schema: {
    ...
    breadcrumbSchema: {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Chatbots internos: helpdesk de TI e bots de RH', item: '[www.promptquorum.com/pt/power-local-llm/enterprise-chatbot-deployment-helpdesk-hr-bots](https://www.promptquorum.com/pt/power-local-llm/enterprise-chatbot-deployment-helpdesk-hr-bots)' },
      ],
    },
  },
  ar: {
    ...
    sections: {
      ...
      ragArchitecture: {
        ...
        items: [
          ...
          'بخصوص طبقة قاعدة البيانات الاتجاهية، راجعوا [Pinecone مقابل Weaviate مقابل Qdrant مقابل Chroma](/ar/power-local-llm/pinecone-vs-weaviate-vs-qdrant-vs-chroma) — يُطبَّق فلتر التحكم بالوصول الموضح أعلاه كفلتر بيانات وصفية وقت الاستعلام، بغض النظر عن قاعدة البيانات الاتجاهية المختارة، وليس كنظام منفصل.',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[أفضل برامج التسويق بالذكاء الاصطناعي للمؤسسات 2026](/ar/power-local-llm/best-ai-marketing-software-enterprise) — مقارنة ذات صلة بين البناء والشراء لتوليد المحتوى وأتمتة رحلة العميل، وثيقة الصلة حيث تتقاطع روبوتات الدردشة التسويقية مع هذا الدليل.',
          ...
          '[Pinecone مقابل Weaviate مقابل Qdrant مقابل Chroma](/ar/power-local-llm/pinecone-vs-weaviate-vs-qdrant-vs-chroma) — مقارنة قواعد بيانات اتجاهية لطبقة الاسترجاع المصفّاة بالبيانات الوصفية.',
        ],
      },
    },
    schema: {
    ...
    breadcrumbSchema: {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'روبوتات دردشة داخلية: الدعم التقني والموارد البشرية', item: '[www.promptquorum.com/ar/power-local-llm/enterprise-chatbot-deployment-helpdesk-hr-bots](https://www.promptquorum.com/ar/power-local-llm/enterprise-chatbot-deployment-helpdesk-hr-bots)' },
      ],
    },
  },
  ko: {
    ...
    sections: {
      ...
      ragArchitecture: {
        ...
        items: [
          ...
          '벡터 데이터베이스 계층에 대해서는 [Pinecone vs Weaviate vs Qdrant vs Chroma](/ko/power-local-llm/pinecone-vs-weaviate-vs-qdrant-vs-chroma)를 참고하십시오 — 위에서 설명한 접근 제어 필터링은 어떤 벡터 스토어를 선택하든 별도 시스템이 아니라 쿼리 시점의 메타데이터 필터로 적용됩니다.',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026년 기업용 AI 마케팅 소프트웨어 최적 비교](/ko/power-local-llm/best-ai-marketing-software-enterprise) — 콘텐츠 생성과 고객 여정 자동화에 관한 관련 빌드 대 구매 비교로, 마케팅 챗봇이 본 가이드와 겹치는 지점과 관련이 있습니다.',
          ...
          '[Pinecone vs Weaviate vs Qdrant vs Chroma](/ko/power-local-llm/pinecone-vs-weaviate-vs-qdrant-vs-chroma) — 메타데이터로 필터링되는 검색 계층을 위한 벡터 데이터베이스 비교.',
        ],
      },
    },
    schema: {
    ...
    breadcrumbSchema: {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: '사내 챗봇 구축: IT 헬프데스크 & HR 봇', item: '[www.promptquorum.com/ko/power-local-llm/enterprise-chatbot-deployment-helpdesk-hr-bots](https://www.promptquorum.com/ko/power-local-llm/enterprise-chatbot-deployment-helpdesk-hr-bots)' },
      ],
    },
  },
}
