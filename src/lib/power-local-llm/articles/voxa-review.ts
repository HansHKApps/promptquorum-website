...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    primaryTerm: 'Voxa',
    title: 'Voxa Review: Private Voice Assistant Orb for Desktop',
    seoTitle: 'Voxa Review: Private Voice Assistant Orb for Desktop',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/directory) — the full catalog of local AI tools and apps this review belongs to.',
        ],
      },
    },
  },
  de: {
    ...
    primaryTerm: 'Voxa',
    title: 'Voxa Review: Privater Sprachassistent-Orb für den Desktop',
    seoTitle: 'Voxa Review: Privater Sprachassistent-Orb für Desktop',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/de/directory) — der vollständige Katalog lokaler KI-Tools und -Apps, zu dem dieses Review gehört.',
        ],
      },
    },
  },
  fr: {
    ...
    primaryTerm: 'Voxa',
    title: 'Voxa: avis sur l\'assistant vocal privé pour bureau',
    seoTitle: 'Voxa avis: assistant vocal privé pour bureau',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/fr/directory) — le catalogue complet d\'outils et d\'applications d\'IA locale auquel appartient cet avis.',
        ],
      },
    },
  },
  es: {
    ...
    primaryTerm: 'Voxa',
    title: 'Voxa: reseña del asistente de voz privado para escritorio',
    seoTitle: 'Voxa reseña: asistente de voz privado para escritorio',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/es/directory) — el catálogo completo de herramientas y apps de IA local al que pertenece esta reseña.',
        ],
      },
    },
  },
  pt: {
    ...
    primaryTerm: 'Voxa',
    title: 'Voxa: análise do assistente de voz privado para desktop',
    seoTitle: 'Voxa análise: assistente de voz privado para desktop',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/pt/directory) — o catálogo completo de ferramentas e apps de IA local ao qual esta análise pertence.',
        ],
      },
    },
  },
  ja: {
    ...
    primaryTerm: 'Voxa',
    title: 'Voxaレビュー：デスクトップ向けプライベート音声アシスタントオーブ',
    seoTitle: 'Voxaレビュー：プライベート音声アシスタントオーブ',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/ja/directory) — このレビューが属する、ローカルAIツールとアプリの完全なカタログ。',
        ],
      },
    },
  },
  zh: {
    ...
    primaryTerm: 'Voxa',
    title: 'Voxa评测：桌面端私密语音助手悬浮球',
    seoTitle: 'Voxa评测：桌面端私密语音助手悬浮球',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/zh/directory) — 本评测所属的本地AI工具和应用完整目录。',
        ],
      },
    },
  },
  ar: {
    ...
    primaryTerm: 'Voxa',
    title: 'مراجعة Voxa: مساعد صوتي خاص على شكل كرة عائمة لسطح المكتب',
    seoTitle: 'مراجعة Voxa: مساعد صوتي خاص لسطح المكتب',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/ar/directory) — الدليل الكامل لأدوات وتطبيقات الذكاء الاصطناعي المحلي الذي تنتمي إليه هذه المراجعة.',
        ],
      },
    },
  },
  ko: {
    ...
    primaryTerm: 'Voxa',
    title: 'Voxa 리뷰: 데스크톱용 프라이빗 음성 어시스턴트 오브',
    seoTitle: 'Voxa 리뷰: 데스크톱용 프라이빗 음성 어시스턴트 오브',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/ko/directory) — 이 리뷰가 속한 로컬 AI 도구 및 앱의 전체 카탈로그.',
        ],
      },
    },
  },
