    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/power-local-llm/local-llm-software-directory-2026) — the full catalog of local AI tools and apps this review belongs to.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/de/power-local-llm/local-llm-software-directory-2026) — der vollständige Katalog lokaler KI-Tools und -Apps, zu dem dieses Review gehört.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/fr/power-local-llm/local-llm-software-directory-2026) — le catalogue complet d\'outils et d\'applications d\'IA locale auquel appartient cet avis.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/es/power-local-llm/local-llm-software-directory-2026) — el catálogo completo de herramientas y apps de IA local al que pertenece esta reseña.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/pt/power-local-llm/local-llm-software-directory-2026) — o catálogo completo de ferramentas e apps de IA local ao qual esta análise pertence.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/ja/power-local-llm/local-llm-software-directory-2026) — このレビューが属する、ローカルAIツールとアプリの完全なカタログ。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/zh/power-local-llm/local-llm-software-directory-2026) — 本评测所属的本地AI工具和应用完整目录。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/ar/power-local-llm/local-llm-software-directory-2026) — الدليل الكامل لأدوات وتطبيقات الذكاء الاصطناعي المحلي الذي تنتمي إليه هذه المراجعة.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/ko/power-local-llm/local-llm-software-directory-2026) — 이 리뷰가 속한 로컬 AI 도구 및 앱의 전체 카탈로그.',
        ],
      },
    },
  },
