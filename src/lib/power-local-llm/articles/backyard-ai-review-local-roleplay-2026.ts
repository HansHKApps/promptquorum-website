  ...
  en: {
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Backyard AI (backyard.ai), formerly Faraday.dev, is a free, closed-source desktop app for Windows and Mac focused on AI character chat and roleplay.',
  ...
  de: {
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Backyard AI (backyard.ai), früher Faraday.dev, ist eine kostenlose, closed-source Desktop-App für Windows und Mac für KI-Charakter-Chat und Rollenspiel.',
  ...
  es: {
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Backyard AI (backyard.ai), antes Faraday.dev, es una app de escritorio gratuita y de código cerrado para Windows y Mac centrada en chat de personajes IA y roleplay.',
  ...
  fr: {
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Backyard AI (backyard.ai), anciennement Faraday.dev, est une application de bureau gratuite et à code fermé pour Windows et Mac dédiée au chat de personnages IA et au roleplay.',
  ...
  pt: {
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'O Backyard AI (backyard.ai), antes Faraday.dev, é um app de desktop gratuito e de código fechado para Windows e Mac focado em chat de personagens IA e roleplay.',
  ...
  ar: {
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Backyard AI (backyard.ai)، الذي كان يُعرف سابقاً باسم Faraday.dev، هو تطبيق سطح مكتب مجاني ومغلق المصدر لأنظمة Windows و Mac يركّز على محادثة الشخصيات بالذكاء الاصطناعي ولعب الأدوار.',
