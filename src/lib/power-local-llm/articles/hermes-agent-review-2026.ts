  ...
  en: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        columns: ['Tool', 'Link', 'Model backend', 'License', 'Memory/skills', 'Messaging access'],
        rows: [
          { 'Tool': 'Hermes Agent', 'Link': '[hermes-agent.org](https://hermes-agent.org)', 'Model backend': 'Local Hermes 4.3 or 200+ via OpenRouter', 'License': 'MIT', 'Memory/skills': 'Persistent memory + self-improving skills', 'Messaging access': 'Telegram/Discord/Slack/WhatsApp/Signal/email' },
          { 'Tool': 'AutoGPT (classic)', 'Link': '[github.com/Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT)', 'Model backend': 'Local via Ollama (generic OpenAI-compatible URL)', 'License': 'MIT', 'Memory/skills': 'Session-scoped planning loop', 'Messaging access': 'Terminal only' },
          { 'Tool': 'BabyAGI', 'Link': '[github.com/yoheinakajima/babyagi](https://github.com/yoheinakajima/babyagi)', 'Model backend': 'Varies by fork', 'License': 'MIT', 'Memory/skills': 'Task-list loop, limited persistence', 'Messaging access': 'Terminal only' },
          { 'Tool': 'Cline + Ollama', 'Link': '[cline.bot](https://cline.bot)', 'Model backend': 'Local', 'License': 'Apache 2.0', 'Memory/skills': 'Scoped to one coding session', 'Messaging access': 'IDE only' },
        ],
  ...
  de: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        columns: ['Tool', 'Link', 'Modell-Backend', 'Lizenz', 'Gedächtnis/Skills', 'Messaging-Zugriff'],
        rows: [
          { 'Tool': 'Hermes Agent', 'Link': '[hermes-agent.org](https://hermes-agent.org)', 'Modell-Backend': 'Lokal Hermes 4.3 oder 200+ über OpenRouter', 'Lizenz': 'MIT', 'Gedächtnis/Skills': 'Persistentes Gedächtnis + selbstverbessernde Skills', 'Messaging-Zugriff': 'Telegram/Discord/Slack/WhatsApp/Signal/E-Mail' },
          { 'Tool': 'AutoGPT (classic)', 'Link': '[github.com/Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT)', 'Modell-Backend': 'Lokal über Ollama (generische OpenAI-kompatible URL)', 'Lizenz': 'MIT', 'Gedächtnis/Skills': 'Sitzungsbezogene Planungs-Loop', 'Messaging-Zugriff': 'Nur Terminal' },
          { 'Tool': 'BabyAGI', 'Link': '[github.com/yoheinakajima/babyagi](https://github.com/yoheinakajima/babyagi)', 'Modell-Backend': 'Je nach Fork unterschiedlich', 'Lizenz': 'MIT', 'Gedächtnis/Skills': 'Aufgabenlisten-Loop, begrenzte Persistenz', 'Messaging-Zugriff': 'Nur Terminal' },
          { 'Tool': 'Cline + Ollama', 'Link': '[cline.bot](https://cline.bot)', 'Modell-Backend': 'Lokal', 'Lizenz': 'Apache 2.0', 'Gedächtnis/Skills': 'Auf eine Coding-Sitzung begrenzt', 'Messaging-Zugriff': 'Nur IDE' },
        ],
  ...
  fr: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        columns: ['Outil', 'Lien', 'Backend modèle', 'Licence', 'Mémoire/compétences', 'Accès messagerie'],
        rows: [
          { 'Outil': 'Hermes Agent', 'Lien': '[hermes-agent.org](https://hermes-agent.org)', 'Backend modèle': 'Hermes 4.3 local ou 200+ via OpenRouter', 'Licence': 'MIT', 'Mémoire/compétences': 'Mémoire persistante + compétences auto-améliorantes', 'Accès messagerie': 'Telegram/Discord/Slack/WhatsApp/Signal/e-mail' },
          { 'Outil': 'AutoGPT (classic)', 'Lien': '[github.com/Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT)', 'Backend modèle': 'Local via Ollama (URL générique compatible OpenAI)', 'Licence': 'MIT', 'Mémoire/compétences': 'Boucle de planification limitée à la session', 'Accès messagerie': 'Terminal uniquement' },
          { 'Outil': 'BabyAGI', 'Lien': '[github.com/yoheinakajima/babyagi](https://github.com/yoheinakajima/babyagi)', 'Backend modèle': 'Variable selon le fork', 'Licence': 'MIT', 'Mémoire/compétences': 'Boucle de liste de tâches, persistance limitée', 'Accès messagerie': 'Terminal uniquement' },
          { 'Outil': 'Cline + Ollama', 'Lien': '[cline.bot](https://cline.bot)', 'Backend modèle': 'Local', 'Licence': 'Apache 2.0', 'Mémoire/compétences': 'Limité à une session de codage', 'Accès messagerie': 'IDE uniquement' },
        ],
  ...
  es: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        columns: ['Herramienta', 'Enlace', 'Backend de modelo', 'Licencia', 'Memoria/habilidades', 'Acceso por mensajería'],
        rows: [
          { 'Herramienta': 'Hermes Agent', 'Enlace': '[hermes-agent.org](https://hermes-agent.org)', 'Backend de modelo': 'Hermes 4.3 local o 200+ vía OpenRouter', 'Licencia': 'MIT', 'Memoria/habilidades': 'Memoria persistente + habilidades autosuperadoras', 'Acceso por mensajería': 'Telegram/Discord/Slack/WhatsApp/Signal/correo' },
          { 'Herramienta': 'AutoGPT (classic)', 'Enlace': '[github.com/Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT)', 'Backend de modelo': 'Local vía Ollama (URL genérica compatible con OpenAI)', 'Licencia': 'MIT', 'Memoria/habilidades': 'Bucle de planificación limitado a la sesión', 'Acceso por mensajería': 'Solo terminal' },
          { 'Herramienta': 'BabyAGI', 'Enlace': '[github.com/yoheinakajima/babyagi](https://github.com/yoheinakajima/babyagi)', 'Backend de modelo': 'Varía según el fork', 'Licencia': 'MIT', 'Memoria/habilidades': 'Bucle de lista de tareas, persistencia limitada', 'Acceso por mensajería': 'Solo terminal' },
          { 'Herramienta': 'Cline + Ollama', 'Enlace': '[cline.bot](https://cline.bot)', 'Backend de modelo': 'Local', 'Licencia': 'Apache 2.0', 'Memoria/habilidades': 'Limitado a una sesión de codificación', 'Acceso por mensajería': 'Solo IDE' },
        ],
  ...
  pt: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        columns: ['Ferramenta', 'Link', 'Backend de modelo', 'Licença', 'Memória/habilidades', 'Acesso por mensagens'],
        rows: [
          { 'Ferramenta': 'Hermes Agent', 'Link': '[hermes-agent.org](https://hermes-agent.org)', 'Backend de modelo': 'Hermes 4.3 local ou 200+ via OpenRouter', 'Licença': 'MIT', 'Memória/habilidades': 'Memória persistente + habilidades autoaperfeiçoáveis', 'Acesso por mensagens': 'Telegram/Discord/Slack/WhatsApp/Signal/e-mail' },
          { 'Ferramenta': 'AutoGPT (classic)', 'Link': '[github.com/Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT)', 'Backend de modelo': 'Local via Ollama (URL genérica compatível com OpenAI)', 'Licença': 'MIT', 'Memória/habilidades': 'Loop de planejamento limitado à sessão', 'Acesso por mensagens': 'Só terminal' },
          { 'Ferramenta': 'BabyAGI', 'Link': '[github.com/yoheinakajima/babyagi](https://github.com/yoheinakajima/babyagi)', 'Backend de modelo': 'Varia conforme o fork', 'Licença': 'MIT', 'Memória/habilidades': 'Loop de lista de tarefas, persistência limitada', 'Acesso por mensagens': 'Só terminal' },
          { 'Ferramenta': 'Cline + Ollama', 'Link': '[cline.bot](https://cline.bot)', 'Backend de modelo': 'Local', 'Licença': 'Apache 2.0', 'Memória/habilidades': 'Limitado a uma sessão de codificação', 'Acesso por mensagens': 'Só IDE' },
        ],
  ...
  ja: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        columns: ['ツール', 'リンク', 'モデルバックエンド', 'ライセンス', '記憶/スキル', 'メッセージングアクセス'],
        rows: [
          { 'ツール': 'Hermes Agent', 'リンク': '[hermes-agent.org](https://hermes-agent.org)', 'モデルバックエンド': 'ローカルHermes 4.3、またはOpenRouter経由の200以上', 'ライセンス': 'MIT', '記憶/スキル': '永続的な記憶＋自己改善型スキル', 'メッセージングアクセス': 'Telegram/Discord/Slack/WhatsApp/Signal/メール' },
          { 'ツール': 'AutoGPT（classic）', 'リンク': '[github.com/Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT)', 'モデルバックエンド': 'Ollama経由のローカル（汎用OpenAI互換URL）', 'ライセンス': 'MIT', '記憶/スキル': 'セッション限定のプランニングループ', 'メッセージングアクセス': 'ターミナルのみ' },
          { 'ツール': 'BabyAGI', 'リンク': '[github.com/yoheinakajima/babyagi](https://github.com/yoheinakajima/babyagi)', 'モデルバックエンド': 'フォークにより異なる', 'ライセンス': 'MIT', '記憶/スキル': 'タスクリストループ、限定的な永続性', 'メッセージングアクセス': 'ターミナルのみ' },
          { 'ツール': 'Cline + Ollama', 'リンク': '[cline.bot](https://cline.bot)', 'モデルバックエンド': 'ローカル', 'ライセンス': 'Apache 2.0', '記憶/スキル': '1つのコーディングセッションに限定', 'メッセージングアクセス': 'IDEのみ' },
        ],
  ...
  zh: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        columns: ['工具', '链接', '模型后端', '许可证', '记忆/技能', '消息访问'],
        rows: [
          { '工具': 'Hermes Agent', '链接': '[hermes-agent.org](https://hermes-agent.org)', '模型后端': '本地Hermes 4.3或通过OpenRouter使用200+模型', '许可证': 'MIT', '记忆/技能': '持久记忆＋自我改进技能', '消息访问': 'Telegram/Discord/Slack/WhatsApp/Signal/邮件' },
          { '工具': 'AutoGPT（classic）', '链接': '[github.com/Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT)', '模型后端': '通过Ollama本地运行（通用OpenAI兼容URL）', '许可证': 'MIT', '记忆/技能': '仅限单次会话的规划循环', '消息访问': '仅限终端' },
          { '工具': 'BabyAGI', '链接': '[github.com/yoheinakajima/babyagi](https://github.com/yoheinakajima/babyagi)', '模型后端': '因分支而异', '许可证': 'MIT', '记忆/技能': '任务列表循环，持久性有限', '消息访问': '仅限终端' },
          { '工具': 'Cline + Ollama', '链接': '[cline.bot](https://cline.bot)', '模型后端': '本地', '许可证': 'Apache 2.0', '记忆/技能': '仅限于单次编码会话', '消息访问': '仅限IDE' },
        ],
  ...
  ar: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        columns: ['الأداة', 'الرابط', 'خلفية النموذج', 'الترخيص', 'الذاكرة/المهارات', 'الوصول عبر المراسلة'],
        rows: [
          { 'الأداة': 'Hermes Agent', 'الرابط': '[hermes-agent.org](https://hermes-agent.org)', 'خلفية النموذج': 'Hermes 4.3 محليًا أو 200+ عبر OpenRouter', 'الترخيص': 'MIT', 'الذاكرة/المهارات': 'ذاكرة دائمة + مهارات ذاتية التحسين', 'الوصول عبر المراسلة': 'Telegram/Discord/Slack/WhatsApp/Signal/البريد' },
          { 'الأداة': 'AutoGPT (classic)', 'الرابط': '[github.com/Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT)', 'خلفية النموذج': 'محليًا عبر Ollama (عنوان عام متوافق مع OpenAI)', 'الترخيص': 'MIT', 'الذاكرة/المهارات': 'حلقة تخطيط محدودة بالجلسة', 'الوصول عبر المراسلة': 'الطرفية فقط' },
          { 'الأداة': 'BabyAGI', 'الرابط': '[github.com/yoheinakajima/babyagi](https://github.com/yoheinakajima/babyagi)', 'خلفية النموذج': 'تختلف حسب الفرع', 'الترخيص': 'MIT', 'الذاكرة/المهارات': 'حلقة قائمة مهام، استمرارية محدودة', 'الوصول عبر المراسلة': 'الطرفية فقط' },
          { 'الأداة': 'Cline + Ollama', 'الرابط': '[cline.bot](https://cline.bot)', 'خلفية النموذج': 'محلي', 'الترخيص': 'Apache 2.0', 'الذاكرة/المهارات': 'محدود بجلسة برمجة واحدة', 'الوصول عبر المراسلة': 'بيئة التطوير فقط' },
        ],
  ...
  ko: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        columns: ['도구', '링크', '모델 백엔드', '라이선스', '메모리/스킬', '메시징 접근'],
        rows: [
          { '도구': 'Hermes Agent', '링크': '[hermes-agent.org](https://hermes-agent.org)', '모델 백엔드': '로컬 Hermes 4.3 또는 OpenRouter로 200개 이상', '라이선스': 'MIT', '메모리/스킬': '영구 메모리 + 자기개선형 스킬', '메시징 접근': 'Telegram/Discord/Slack/WhatsApp/Signal/이메일' },
          { '도구': 'AutoGPT(classic)', '링크': '[github.com/Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT)', '모델 백엔드': 'Ollama를 통한 로컬(범용 OpenAI 호환 URL)', '라이선스': 'MIT', '메모리/스킬': '세션에 한정된 계획 루프', '메시징 접근': '터미널만' },
          { '도구': 'BabyAGI', '링크': '[github.com/yoheinakajima/babyagi](https://github.com/yoheinakajima/babyagi)', '모델 백엔드': '포크에 따라 다름', '라이선스': 'MIT', '메모리/스킬': '작업 목록 루프, 제한적 지속성', '메시징 접근': '터미널만' },
          { '도구': 'Cline + Ollama', '링크': '[cline.bot](https://cline.bot)', '모델 백엔드': '로컬', '라이선스': 'Apache 2.0', '메모리/스킬': '하나의 코딩 세션에 한정', '메시징 접근': 'IDE만' },
        ],
