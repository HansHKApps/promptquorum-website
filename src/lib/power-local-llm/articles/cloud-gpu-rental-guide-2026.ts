...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'استئجار GPU سحابي 2026: RunPod مقابل Lambda مقابل Vast.ai',
    intro:
    ...
    metaDescription:
      'دليل استئجار GPU سحابي 2026: مقارنة RunPod وVast.ai وLambda Labs. أسعار الساعة لـ A100 وH100 وRTX 4090. متى يكون الاستئجار أفضل من الشراء.',
    twitterDescription:
