  ...
  de: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Den vollständigen Cloud-GPU-Anbietervergleich mit monatlich verifizierten Preisen ansehen](/local-llms/cloud-gpu-rental-comparison-2026?lang=de) — der breitere Anbieterkreis, die DSGVO-Checkliste und die Entscheidungsmatrix hinter diesem Ratgeber.',
          '[Die Kosten lokaler LLM-Hardware mit der Cloud-GPU-Miete vergleichen](/local-llms/local-llm-vs-cloud-gpu-cost?lang=de) — die Break-even-Rechnung dafür, wann eigene Hardware das Mieten schlägt.',
          '[DSGVO-konforme Cloud-GPU-Optionen für personenbezogene EU-Daten prüfen](/local-llms/eu-cloud-gpu-gdpr-2026?lang=de) — EU-eigene Anbieter und die geltenden Datenresidenzregeln.',
          '[Eine GPU auswählen, falls Sie sich für den Hardwarekauf entscheiden](/power-local-llm/best-gpu-buying-guide-local-llm-2026?lang=de) — der Consumer-GPU-Kaufratgeber über vier Budgetstufen.',
          '[Eine lokale KI-Workstation als Alternative zu eigener Hardware bauen](/power-local-llm/local-ai-workstation-build-guide-2026?lang=de) — Teilelisten und Kosten für eine selbst gehostete Inferenzmaschine.',
        ],
      },
    },
  },
  fr: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Voir le comparatif complet des fournisseurs de GPU cloud avec une tarification vérifiée chaque mois](/local-llms/cloud-gpu-rental-comparison-2026?lang=fr) — l\'ensemble plus large de fournisseurs, la check-list RGPD et la matrice de décision derrière ce guide.',
          '[Comparer le coût du matériel pour LLM locaux à la location de GPU cloud](/local-llms/local-llm-vs-cloud-gpu-cost?lang=fr) — le calcul du point d\'équilibre pour savoir quand posséder du matériel bat la location.',
          '[Vérifier les options de GPU cloud conformes au RGPD UE pour les données personnelles](/local-llms/eu-cloud-gpu-gdpr-2026?lang=fr) — les fournisseurs natifs de l\'UE et les règles de résidence des données applicables.',
          '[Choisir un GPU si vous décidez d\'acheter du matériel](/power-local-llm/best-gpu-buying-guide-local-llm-2026?lang=fr) — le guide d\'achat de GPU grand public sur quatre niveaux de budget.',
          '[Construire une station de travail IA locale comme alternative au matériel possédé](/power-local-llm/local-ai-workstation-build-guide-2026?lang=fr) — listes de pièces et coûts pour une machine d\'inférence auto-hébergée.',
        ],
      },
    },
  },
  ja: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '関連記事',
        items: [
          '[毎月検証された価格付きのクラウドGPUプロバイダー完全比較を見る](/local-llms/cloud-gpu-rental-comparison-2026?lang=ja) — このガイドの背景にある、より広範なプロバイダー群、GDPRチェックリスト、意思決定マトリクス。',
          '[ローカルLLMハードウェアのコストとクラウドGPUレンタルを比較する](/local-llms/local-llm-vs-cloud-gpu-cost?lang=ja) — ハードウェア所有がレンタルに勝るタイミングの損益分岐の計算。',
          '[個人データ向けのEU GDPR適合クラウドGPUの選択肢を確認する](/local-llms/eu-cloud-gpu-gdpr-2026?lang=ja) — EU発のプロバイダーと適用されるデータレジデンシーのルール。',
          '[代わりにハードウェアを購入する場合のGPUを選ぶ](/power-local-llm/best-gpu-buying-guide-local-llm-2026?lang=ja) — 4つの予算ティアにわたるコンシューマーGPU購入ガイド。',
          '[所有ハードウェアの代替としてローカルAIワークステーションを構築する](/power-local-llm/local-ai-workstation-build-guide-2026?lang=ja) — セルフホスト推論マシンの部品リストとコスト。',
        ],
      },
    },
  },
  zh: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '延伸阅读',
        items: [
          '[查看带每月验证价格的完整云GPU提供商对比](/local-llms/cloud-gpu-rental-comparison-2026?lang=zh) — 本指南背后更广的提供商范围、GDPR清单和决策矩阵。',
          '[对比本地LLM硬件成本与云GPU租用](/local-llms/local-llm-vs-cloud-gpu-cost?lang=zh) — 拥有硬件何时胜过租用的盈亏平衡测算。',
          '[查看面向个人数据的符合EU GDPR的云GPU选项](/local-llms/eu-cloud-gpu-gdpr-2026?lang=zh) — EU本土提供商及适用的数据驻留规则。',
          '[如果你决定改为购买硬件，选一块GPU](/power-local-llm/best-gpu-buying-guide-local-llm-2026?lang=zh) — 跨四个预算档位的消费级GPU购买指南。',
          '[构建一台本地AI工作站作为自有硬件的替代方案](/power-local-llm/local-ai-workstation-build-guide-2026?lang=zh) — 自托管推理机的零件清单与成本。',
        ],
      },
    },
  },
