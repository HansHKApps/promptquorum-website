    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[The Complete Local LLM Software Directory](/power-local-llm/local-llm-software-directory) — a broader directory of local-LLM tools across platforms, including smaller and lesser-documented apps.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Das vollständige Local-LLM-Software-Verzeichnis](/de/power-local-llm/local-llm-software-directory) — ein umfassenderes Verzeichnis lokaler KI-Werkzeuge über alle Plattformen hinweg, einschließlich kleinerer, weniger dokumentierter Apps.',
        ],
      },
    },
    schema: {
  ...
  fr: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Loci, notre test : IA hors ligne pour iPhone, Android, iPad, Mac et Windows](/fr/power-local-llm/loci-ai-review-offline-local-ai) — une alternative multiplateforme mieux documentée, avec une étiquette de confidentialité publiée.',
          '[Les meilleures applications de LLM local pour Android en 2026](/fr/power-local-llm/best-local-llm-apps-android-2026) — le panorama des applications Android, dont MLC Chat, Maid, Layla, Ollama via Termux et PocketPal AI.',
          '[Les meilleurs modèles LLM mobiles en 2026 : Phi-4 Mini vs Gemma 4 vs SmolLM](/fr/power-local-llm/mobile-llm-models-phi4-gemma-smollm) — l\'article compagnon consacré aux modèles, expliquant quels modèles compatibles GGUF tiennent réellement sur un smartphone.',
          '[Exécuter un LLM local sur votre tablette : iPad et Android](/fr/power-local-llm/run-ai-on-tablet-ipad-android) — guide orienté appareils pour l\'inférence locale et distante sur tablette.',
          '[L\'annuaire complet des logiciels de LLM local](/fr/power-local-llm/local-llm-software-directory) — un annuaire plus large d\'outils de LLM local sur toutes les plateformes, y compris des applications plus modestes et moins documentées.',
        ],
      },
    },
    schema: {
  ...
  ja: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '関連記事',
        items: [
          '[Loci AIレビュー:iPhone、Android、iPad、Mac、Windows向けオフラインAI](/ja/power-local-llm/loci-ai-review-offline-local-ai) — プライバシー表示を公開している、よりドキュメントの充実したクロスプラットフォームの代替アプリ。',
          '[2026年版 Android向けベストローカルLLMアプリ](/ja/power-local-llm/best-local-llm-apps-android-2026) — MLC Chat、Maid、Layla、Termux経由のOllama、PocketPal AIなどを含むAndroidアプリまとめ。',
          '[2026年版 モバイル向けベストLLMモデル:Phi-4 Mini vs Gemma 4 vs SmolLM](/ja/power-local-llm/mobile-llm-models-phi4-gemma-smollm) — スマートフォンに実際に収まるGGUF互換モデルを解説する、モデル層の関連記事。',
          '[タブレットでローカルLLMを実行する:iPadとAndroid](/ja/power-local-llm/run-ai-on-tablet-ipad-android) — タブレット上でのオンデバイス推論とリモート推論に焦点を当てたガイド。',
          '[ローカルLLMソフトウェア完全ディレクトリ](/ja/power-local-llm/local-llm-software-directory) — 小規模であまり文書化されていないアプリも含む、全プラットフォームのローカルLLMツールを網羅した、より広範なディレクトリ。',
        ],
      },
    },
    schema: {
  ...
  zh: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '延伸阅读',
        items: [
          '[Loci AI 评测:适用于 iPhone、Android、iPad、Mac 和 Windows 的离线 AI](/zh/power-local-llm/loci-ai-review-offline-local-ai) —— 一款文档更完善的跨平台替代方案,已公开隐私标签。',
          '[2026 年 Android 最佳本地 LLM 应用](/zh/power-local-llm/best-local-llm-apps-android-2026) —— Android 应用汇总,包括 MLC Chat、Maid、Layla、通过 Termux 运行的 Ollama,以及 PocketPal AI。',
          '[2026 年最佳移动端 LLM 模型:Phi-4 Mini 对比 Gemma 4 对比 SmolLM](/zh/power-local-llm/mobile-llm-models-phi4-gemma-smollm) —— 模型层面的配套文章,解释哪些 GGUF 兼容模型真正适合手机运行。',
          '[在平板电脑上运行本地 LLM:iPad 与 Android](/zh/power-local-llm/run-ai-on-tablet-ipad-android) —— 面向设备端的指南,涵盖平板上的本地及远程推理。',
          '[完整的本地 LLM 软件目录](/zh/power-local-llm/local-llm-software-directory) —— 一份涵盖各平台本地 LLM 工具的更全面目录,包括规模较小、文档较少的应用。',
        ],
      },
    },
    schema: {
  ...
  es: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Reseña de Loci AI: IA sin conexión para iPhone, Android, iPad, Mac y Windows](/es/power-local-llm/loci-ai-review-offline-local-ai) — una alternativa multiplataforma mejor documentada, con una etiqueta de privacidad publicada.',
          '[Las mejores apps de LLM local para Android en 2026](/es/power-local-llm/best-local-llm-apps-android-2026) — el resumen de apps de Android, incluyendo MLC Chat, Maid, Layla, Ollama vía Termux y PocketPal AI.',
          '[Los mejores modelos LLM móviles en 2026: Phi-4 Mini frente a Gemma 4 frente a SmolLM](/es/power-local-llm/mobile-llm-models-phi4-gemma-smollm) — el artículo complementario sobre modelos, que explica qué modelos compatibles con GGUF realmente caben en un teléfono.',
          '[Ejecuta un LLM local en tu tablet: iPad y Android](/es/power-local-llm/run-ai-on-tablet-ipad-android) — guía centrada en dispositivos para inferencia local y remota en tablets.',
          '[El directorio completo de software de LLM local](/es/power-local-llm/local-llm-software-directory) — un directorio más amplio de herramientas de LLM local en todas las plataformas, incluyendo apps más pequeñas y menos documentadas.',
        ],
      },
    },
    schema: {
  ...
  pt: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Análise do Loci AI: IA offline para iPhone, Android, iPad, Mac e Windows](/pt/power-local-llm/loci-ai-review-offline-local-ai) — uma alternativa multiplataforma mais bem documentada, com selo de privacidade publicado.',
          '[Os melhores apps de LLM local para Android em 2026](/pt/power-local-llm/best-local-llm-apps-android-2026) — o panorama de apps Android, incluindo MLC Chat, Maid, Layla, Ollama via Termux e PocketPal AI.',
          '[Os melhores modelos LLM móveis em 2026: Phi-4 Mini vs Gemma 4 vs SmolLM](/pt/power-local-llm/mobile-llm-models-phi4-gemma-smollm) — o artigo complementar sobre modelos, explicando quais modelos compatíveis com GGUF realmente cabem em um celular.',
          '[Execute um LLM local no seu tablet: iPad e Android](/pt/power-local-llm/run-ai-on-tablet-ipad-android) — guia focado em dispositivos para inferência local e remota em tablets.',
          '[O diretório completo de software de LLM local](/pt/power-local-llm/local-llm-software-directory) — um diretório mais amplo de ferramentas de LLM local em todas as plataformas, incluindo apps menores e menos documentados.',
        ],
      },
    },
    schema: {
  ...
  ar: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[مراجعة Loci AI: ذكاء اصطناعي دون اتصال لـ iPhone وAndroid وiPad وMac وWindows](/ar/power-local-llm/loci-ai-review-offline-local-ai) — بديل موثق بشكل أفضل عبر منصات متعددة، مع ملصق خصوصية منشور.',
          '[أفضل تطبيقات النماذج اللغوية المحلية لأندرويد في 2026](/ar/power-local-llm/best-local-llm-apps-android-2026) — قائمة بتطبيقات Android، تشمل MLC Chat وMaid وLayla وOllama عبر Termux وPocketPal AI.',
          '[أفضل نماذج LLM للأجهزة المحمولة في 2026: Phi-4 Mini مقابل Gemma 4 مقابل SmolLM](/ar/power-local-llm/mobile-llm-models-phi4-gemma-smollm) — المقال المكمّل على مستوى النماذج، الذي يوضح أي النماذج المتوافقة مع GGUF تناسب فعليًا الهاتف.',
          '[تشغيل نموذج لغوي محلي على جهازك اللوحي: iPad وAndroid](/ar/power-local-llm/run-ai-on-tablet-ipad-android) — دليل مركّز على الأجهزة للاستدلال المحلي والبعيد على الأجهزة اللوحية.',
          '[الدليل الكامل لبرمجيات النماذج اللغوية المحلية](/ar/power-local-llm/local-llm-software-directory) — دليل أوسع لأدوات النماذج اللغوية المحلية عبر جميع المنصات، بما في ذلك تطبيقات أصغر وأقل توثيقًا.',
        ],
      },
    },
    schema: {
  ...
  ko: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '관련 읽을거리',
        items: [
          '[Loci AI 리뷰: iPhone, Android, iPad, Mac, Windows용 오프라인 AI](/ko/power-local-llm/loci-ai-review-offline-local-ai) — 개인정보 보호 라벨이 공개된, 더 잘 문서화된 크로스 플랫폼 대안.',
          '[2026년 Android 최고의 로컬 LLM 앱](/ko/power-local-llm/best-local-llm-apps-android-2026) — MLC Chat, Maid, Layla, Termux를 통한 Ollama, PocketPal AI를 포함한 Android 앱 총정리.',
          '[2026년 최고의 모바일 LLM 모델: Phi-4 Mini 대 Gemma 4 대 SmolLM](/ko/power-local-llm/mobile-llm-models-phi4-gemma-smollm) — 어떤 GGUF 호환 모델이 실제로 휴대폰에 적합한지 설명하는 모델 계층 관련 글.',
          '[태블릿에서 로컬 LLM 실행하기: iPad와 Android](/ko/power-local-llm/run-ai-on-tablet-ipad-android) — 태블릿에서의 온디바이스 및 원격 추론에 초점을 맞춘 기기별 가이드.',
          '[로컬 LLM 소프트웨어 완전 디렉터리](/ko/power-local-llm/local-llm-software-directory) — 규모가 작고 문서화가 덜 된 앱을 포함해 여러 플랫폼의 로컬 LLM 도구를 폭넓게 다루는 디렉터리.',
        ],
      },
    },
    schema: {
