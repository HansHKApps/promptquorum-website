    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[The Complete Local LLM Software Directory](/directory) — a broader directory of local-LLM tools across platforms, including smaller and lesser-documented apps.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Das vollständige Local-LLM-Software-Verzeichnis](/de/directory) — ein umfassenderes Verzeichnis lokaler KI-Werkzeuge über alle Plattformen hinweg, einschließlich kleinerer, weniger dokumentierter Apps.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[L\'annuaire complet des logiciels de LLM local](/fr/directory) — un annuaire plus large d\'outils de LLM local sur toutes les plateformes, y compris des applications plus modestes et moins documentées.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[ローカルLLMソフトウェア完全ディレクトリ](/ja/directory) — 小規模であまり文書化されていないアプリも含む、全プラットフォームのローカルLLMツールを網羅した、より広範なディレクトリ。',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[完整的本地 LLM 软件目录](/zh/directory) —— 一份涵盖各平台本地 LLM 工具的更全面目录,包括规模较小、文档较少的应用。',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[El directorio completo de software de LLM local](/es/directory) — un directorio más amplio de herramientas de LLM local en todas las plataformas, incluyendo apps más pequeñas y menos documentadas.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[O diretório completo de software de LLM local](/pt/directory) — um diretório mais amplo de ferramentas de LLM local em todas as plataformas, incluindo apps menores e menos documentados.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[الدليل الكامل لبرمجيات النماذج اللغوية المحلية](/ar/directory) — دليل أوسع لأدوات النماذج اللغوية المحلية عبر جميع المنصات، بما في ذلك تطبيقات أصغر وأقل توثيقًا.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[로컬 LLM 소프트웨어 완전 디렉터리](/ko/directory) — 규모가 작고 문서화가 덜 된 앱을 포함해 여러 플랫폼의 로컬 LLM 도구를 폭넓게 다루는 디렉터리.',
        ],
      },
    },
    schema: {
