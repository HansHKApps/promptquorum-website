  ...
  en: {
    ...
    sections: {
      ...
      vsAlternatives: {
        ...
        columns: ['Tool', 'Link', 'Approach', 'Best for', 'Key limitation vs. AnimateDiff'],
        rows: [
          {
            'Tool': 'AnimateDiff',
            'Link': '[github.com/guoyww/AnimateDiff](https://github.com/guoyww/AnimateDiff)',
          ...
          },
          {
            ...
            'Link': '[github.com/Stability-AI/generative-models](https://github.com/Stability-AI/generative-models)',
          ...
          {
            'Tool': 'Deforum',
            'Link': '[github.com/deforum/sd-webui-deforum](https://github.com/deforum/sd-webui-deforum)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/power-local-llm/local-llm-software-directory) — the full local-AI tool directory, including the image-generation and visual-AI tier AnimateDiff belongs to.',
        ],
      },
    },
  },
  de: {
    ...
    sections: {
      ...
      vsAlternatives: {
        ...
        columns: ['Tool', 'Link', 'Ansatz', 'Am besten für', 'Wichtigste Einschränkung ggü. AnimateDiff'],
        rows: [
          {
            'Tool': 'AnimateDiff',
            'Link': '[github.com/guoyww/AnimateDiff](https://github.com/guoyww/AnimateDiff)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Lokales LLM-Software-Verzeichnis 2026](/de/power-local-llm/local-llm-software-directory) — das vollständige lokale-KI-Tool-Verzeichnis, einschließlich der Bildgenerierungs- und Visual-AI-Schicht, zu der AnimateDiff gehört.',
        ],
      },
    },
  },
  fr: {
    ...
    sections: {
      ...
      vsAlternatives: {
        ...
        itemHeadings: true,
        title: 'AnimateDiff vs. alternatives',
        columns: ['Outil', 'Lien', 'Approche', 'Idéal pour', 'Limite clé vs. AnimateDiff'],
        rows: [
          {
            'Outil': 'AnimateDiff',
            'Lien': '[github.com/guoyww/AnimateDiff](https://github.com/guoyww/AnimateDiff)',
          ...
          },
          {
            ...
            'Lien': '[github.com/Stability-AI/generative-models](https://github.com/Stability-AI/generative-models)',
          ...
          {
            'Outil': 'Deforum',
            'Lien': '[github.com/deforum/sd-webui-deforum](https://github.com/deforum/sd-webui-deforum)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Répertoire de logiciels LLM locaux 2026](/fr/power-local-llm/local-llm-software-directory) — le répertoire complet d\'outils IA locale, incluant la couche génération d\'images et IA visuelle à laquelle appartient AnimateDiff.',
        ],
      },
    },
  },
  ja: {
    ...
    sections: {
      ...
      vsAlternatives: {
        ...
        columns: ['ツール', 'リンク', 'アプローチ', '最適な用途', 'AnimateDiffと比べた主な限界'],
        rows: [
          {
            'ツール': 'AnimateDiff',
            'リンク': '[github.com/guoyww/AnimateDiff](https://github.com/guoyww/AnimateDiff)',
          ...
          },
          {
            ...
            'リンク': '[github.com/Stability-AI/generative-models](https://github.com/Stability-AI/generative-models)',
          ...
          {
            'ツール': 'Deforum',
            'リンク': '[github.com/deforum/sd-webui-deforum](https://github.com/deforum/sd-webui-deforum)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[ローカルLLMソフトウェアディレクトリ2026](/ja/power-local-llm/local-llm-software-directory) — AnimateDiffが属する画像生成・ビジュアルAI層を含む、ローカルAIツールの完全なディレクトリ。',
        ],
      },
    },
  },
  zh: {
    ...
    sections: {
      ...
      vsAlternatives: {
        ...
        columns: ['工具', '链接', '方法', '最适合', '相对AnimateDiff的主要局限'],
        rows: [
          {
            '工具': 'AnimateDiff',
            '链接': '[github.com/guoyww/AnimateDiff](https://github.com/guoyww/AnimateDiff)',
          ...
          },
          {
            ...
            '链接': '[github.com/Stability-AI/generative-models](https://github.com/Stability-AI/generative-models)',
          ...
          {
            '工具': 'Deforum',
            '链接': '[github.com/deforum/sd-webui-deforum](https://github.com/deforum/sd-webui-deforum)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026年本地LLM软件目录](/zh/power-local-llm/local-llm-software-directory) — 完整的本地AI工具目录，涵盖AnimateDiff所属的图像生成与视觉AI层级。',
        ],
      },
    },
  },
  es: {
    ...
    sections: {
      ...
      vsAlternatives: {
        ...
        columns: ['Herramienta', 'Enlace', 'Enfoque', 'Ideal para', 'Limitación clave frente a AnimateDiff'],
        rows: [
          {
            'Herramienta': 'AnimateDiff',
            'Enlace': '[github.com/guoyww/AnimateDiff](https://github.com/guoyww/AnimateDiff)',
          ...
          },
          {
            ...
            'Enlace': '[github.com/Stability-AI/generative-models](https://github.com/Stability-AI/generative-models)',
          ...
          {
            'Herramienta': 'Deforum',
            'Enlace': '[github.com/deforum/sd-webui-deforum](https://github.com/deforum/sd-webui-deforum)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Directorio de software LLM local 2026](/es/power-local-llm/local-llm-software-directory) — el directorio completo de herramientas de IA local, incluyendo la capa de generación de imágenes e IA visual a la que pertenece AnimateDiff.',
        ],
      },
    },
  },
  pt: {
    ...
    sections: {
      ...
      vsAlternatives: {
        ...
        itemHeadings: true,
        title: 'AnimateDiff vs. alternativas',
        columns: ['Ferramenta', 'Link', 'Abordagem', 'Ideal para', 'Principal limitação frente ao AnimateDiff'],
        rows: [
          {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Diretório de software LLM local 2026](/pt/power-local-llm/local-llm-software-directory) — o diretório completo de ferramentas de IA local, incluindo a camada de geração de imagens e IA visual à qual o AnimateDiff pertence.',
        ],
      },
    },
  },
  ar: {
    ...
    sections: {
      ...
      vsAlternatives: {
        ...
        columns: ['الأداة', 'الرابط', 'المنهج', 'الأفضل لـ', 'القيد الرئيسي مقارنة بـ AnimateDiff'],
        rows: [
          {
            'الأداة': 'AnimateDiff',
            'الرابط': '[github.com/guoyww/AnimateDiff](https://github.com/guoyww/AnimateDiff)',
          ...
          },
          {
            ...
            'الرابط': '[github.com/Stability-AI/generative-models](https://github.com/Stability-AI/generative-models)',
          ...
          {
            'الأداة': 'Deforum',
            'الرابط': '[github.com/deforum/sd-webui-deforum](https://github.com/deforum/sd-webui-deforum)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[دليل برمجيات النماذج اللغوية المحلية 2026](/ar/power-local-llm/local-llm-software-directory) — الدليل الكامل لأدوات الذكاء الاصطناعي المحلي، بما في ذلك طبقة توليد الصور والذكاء الاصطناعي البصري التي ينتمي إليها AnimateDiff.',
        ],
      },
    },
  },
  ko: {
    ...
    sections: {
      ...
      vsAlternatives: {
        ...
        columns: ['도구', '링크', '접근 방식', '적합한 대상', 'AnimateDiff 대비 주요 한계'],
        rows: [
          {
            '도구': 'AnimateDiff',
            '링크': '[github.com/guoyww/AnimateDiff](https://github.com/guoyww/AnimateDiff)',
          ...
          },
          {
            ...
            '링크': '[github.com/Stability-AI/generative-models](https://github.com/Stability-AI/generative-models)',
          ...
          {
            '도구': 'Deforum',
            '링크': '[github.com/deforum/sd-webui-deforum](https://github.com/deforum/sd-webui-deforum)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026 로컬 LLM 소프트웨어 디렉토리](/ko/power-local-llm/local-llm-software-directory) — AnimateDiff가 속한 이미지 생성 및 비주얼 AI 계층을 포함한 전체 로컬 AI 도구 디렉토리입니다.',
        ],
      },
    },
  },
