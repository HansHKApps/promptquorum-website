    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/directory) — directory listings for Ollama, n8n, Thunderbird, and other components in this stack.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Lokales LLM-Software-Verzeichnis 2026](/de/directory) — Verzeichnislistungen für Ollama, n8n, Thunderbird und andere Komponenten in diesem Stack.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Répertoire logiciels LLM locaux 2026](/fr/directory) — listes de répertoire pour Ollama, n8n, Thunderbird et autres composants de cette pile.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Directorio de software de LLM local 2026](/es/directory) — listados de directorio para Ollama, n8n, Thunderbird y otros componentes en esta pila.',
        ],
      },
    },
      schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Diretório de software de LLM local 2026](/pt/directory) — listagens de diretório para Ollama, n8n, Thunderbird e outros componentes desta pilha.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[ローカル LLM ソフトウェア ディレクトリ 2026](/ja/directory) — このstack のコンポーネント、Ollama、n8n、Thunderbird などのためのディレクトリ listings。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[本地LLM软件目录2026](/zh/directory) — 此堆栈的组件目录列表，Ollama、n8n、Thunderbird等。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[دليل برامج LLM المحلية 2026](/ar/directory) — قوائم الدليل لمكونات هذه الحزمة: Ollama وn8n وThunderbird وغيرها.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026년 로컬 LLM 소프트웨어 디렉토리](/ko/directory) — 이 스택의 Ollama, n8n, Thunderbird 및 기타 구성 요소에 대한 디렉토리 목록.',
        ],
      },
    },
    schema: {
