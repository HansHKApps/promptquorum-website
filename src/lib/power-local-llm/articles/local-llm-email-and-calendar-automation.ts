...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  pt: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Prompting Zero-Shot vs Few-Shot](/pt/prompt-engineering/zero-shot-vs-few-shot-prompting) — quando incluir e-mails de exemplo no prompt e quando omiti-los para melhor generalização.',
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/pt/pt/power-local-llm/local-llm-email-and-calendar-automation',
      inLanguage: 'pt-BR',
      datePublished: '2026-05-24',
      dateModified: '2026-05-24',
      author: { '@type': 'Person', name: 'Hans Kuepper' },
  ...
  ar: {
    ...
    seoTitle: 'أتمتة البريد الإلكتروني والتقويم بالذكاء الاصطناعي المحلي 2026',
    intro:
    ...
    metaDescription:
      'كيفية أتمتة صياغة البريد الإلكتروني وتلخيص صندوق الوارد وإدارة التقويم باستخدام نموذج لغوي كبير محلي. Ollama وتكامل IMAP وأتمتة الاتصالات مع الخصوصية أولاً.',
    twitterDescription:
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[الموجّه الصفري مقابل الموجّه القليل الأمثلة](/ar/prompt-engineering/zero-shot-vs-few-shot-prompting) — متى تُضمّن أمثلة البريد الإلكتروني في الموجّه ومتى تحذفها لتعميم أفضل.',
