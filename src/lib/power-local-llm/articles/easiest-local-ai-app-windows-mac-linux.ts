...
export const article: Partial<Record<Language, LLMArticle>> = {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Comment installer Ollama : Pour démarrer](/fr/power-local-llm/how-to-install-ollama) — l\'alternative en ligne de commande à LM Studio pour développeurs et power users.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Ollama インストール方法：初期ステップ](/ja/power-local-llm/how-to-install-ollama) — 開発者とパワーユーザー向けLM Studioのコマンドライン代替。',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[如何安装Ollama：入门](/zh/power-local-llm/how-to-install-ollama) — 开发者和高级用户的LM Studio命令行替代品。',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Cómo instalar Ollama: primeros pasos](/es/power-local-llm/how-to-install-ollama) — la alternativa de línea de comandos a LM Studio para desarrolladores y usuarios avanzados.',
        ],
      },
    },
    schema: {
  ...
  pt: {
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/pt/pt/power-local-llm/easiest-local-ai-app-windows-mac-linux',
      inLanguage: 'pt-BR',
      datePublished: '2026-05-07',
      dateModified: '2026-05-07',
      author: { '@type': 'Person', 'name': 'Hans Kuepper' },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[كيفية تثبيت Ollama: الخطوات الأولى](/ar/power-local-llm/how-to-install-ollama) — البديل الخاص بسطر الأوامر لـLM Studio للمطورين والمستخدمين المتقدمين.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Ollama 설치 방법: 시작 가이드](/ko/power-local-llm/how-to-install-ollama) — 개발자와 고급 사용자를 위한 LM Studio의 명령줄 대안.',
        ],
      },
    },
    schema: {
