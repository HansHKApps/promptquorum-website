  ...
  ko: {
    ...
    breadcrumbSchema: {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Windows, Mac, Linux에서 가장 쉬운 로컬 AI 앱', item: 'https://www.promptquorum.com/ko/power-local-llm/easiest-local-ai-app-windows-mac-linux' },
      ],
    },
  },
}
