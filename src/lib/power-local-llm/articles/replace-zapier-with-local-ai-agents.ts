    ...
    sections: {
      ...
      commonMistakes: {
        ...
        items: [
          ...
          '**Mistake 2: Using a 7B+ model on 4 GB RAM.** Llama 3.3 8B or Qwen2.5 7B on a Pi 5 8GB swaps to disk and takes 30+ seconds per email triage — usable but painful. Fix: stick to Llama 3.2 3B Q4_K_M for triage/summary on 8 GB devices. Bump to 7B only on 16 GB+ hardware.',
