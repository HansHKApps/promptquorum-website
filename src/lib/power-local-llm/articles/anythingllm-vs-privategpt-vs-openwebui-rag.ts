...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ja: {
    ...
    schema: {
      ...
      image: 'https://www.promptquorum.com/api/og/anythingllm-vs-privategpt-vs-openwebui-rag?lang=ja/anythingllm-vs-privategpt-vs-openwebui-rag',
  ...
  es: {
    ...
    schema: {
      ...
      image: 'https://www.promptquorum.com/api/og/anythingllm-vs-privategpt-vs-openwebui-rag?lang=es/anythingllm-vs-privategpt-vs-openwebui-rag',
  ...
  pt: {
    ...
    schema: {
      ...
      image: 'https://www.promptquorum.com/api/og/anythingllm-vs-privategpt-vs-openwebui-rag?lang=pt/anythingllm-vs-privategpt-vs-openwebui-rag',
      author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      datePublished: '2026-05-07',
      dateModified: '2026-06-19',
  ...
  ar: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        image: '/images/rag-vs-platforms-comparison-table-en.svg',
        imageCaption: 'AnythingLLM مقابل PrivateGPT مقابل Open WebUI على مجموعة نصوص من 5.047 صفحة: AnythingLLM بأدنى معدل هلوسة (6%)، وPrivateGPT بأسرع استرجاع (240 مللي ثانية p50)، وOpen WebUI بأفضل دعم لتعدد المستخدمين — تتوسع الثلاثة حتى ~8.000–12.000 صفحة على أجهزة المستهلكين.',
      },
      whichOne: {
        id: 'which-one',
    ...
    schema: {
      ...
      image: 'https://www.promptquorum.com/api/og/anythingllm-vs-privategpt-vs-openwebui-rag?lang=ar/anythingllm-vs-privategpt-vs-openwebui-rag',
      author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      datePublished: '2026-05-07',
      dateModified: '2026-06-19',
  ...
  ko: {
    ...
    schema: {
      ...
      image: 'https://www.promptquorum.com/api/og/anythingllm-vs-privategpt-vs-openwebui-rag?lang=ko/anythingllm-vs-privategpt-vs-openwebui-rag',
      author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      datePublished: '2026-05-07',
      dateModified: '2026-06-19',
