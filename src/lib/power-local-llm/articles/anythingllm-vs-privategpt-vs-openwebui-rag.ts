...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    metaDescription:
      '3 local RAG platforms tested on a 5,047-page corpus. AnythingLLM, PrivateGPT, Open WebUI benchmarked for accuracy, latency, citations. August 2026 verdict.',
    ...
    sections: {
      ...
      anythingllmDeep: {
        ...
        items: [
          ...
          '**Embedding flexibility:** 8 backends in August 2026 — Native (small bundled model), Ollama (any embedder you have pulled), LM Studio, OpenAI, Azure OpenAI, Cohere, Voyage, LocalAI. Switching forces a full re-index but is a one-click operation.',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[llama.cpp Explained: The Engine Powering Ollama (2026)](/power-local-llm/llama-cpp-explained) — the local inference engine several of these RAG tools connect to under the hood.',
          ...
          '[h2oGPT Review: Features, Setup, and Archived Status](/power-local-llm/h2ogpt-review) — a similarly feature-heavy RAG and document-chat tool from H2O.ai, now archived; a case study in checking maintenance status before you build on a tool.',
        ],
      },
    },
  },
  de: {
    ...
    metaDescription:
      '3 lokale RAG-Plattformen auf 5.047 Seiten getestet. AnythingLLM, PrivateGPT, Open WebUI: Genauigkeit, Latenz, Zitierqualität. Testergebnis August 2026.',
    ...
    sections: {
      ...
      anythingllmDeep: {
        ...
        items: [
          ...
          '**Embedder-Flexibilität:** 8 Backends im August 2026 — Native (kleines gebündeltes Modell), Ollama (jeder Embedder, den Sie haben), LM Studio, OpenAI, Azure OpenAI, Cohere, Voyage, LocalAI. Das Wechseln erzwingt eine vollständige Neuindexierung, ist aber eine Ein-Klick-Operation.',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[h2oGPT im Test: Funktionen, Setup und Archiv-Status](/de/power-local-llm/h2ogpt-review) — ein ähnlich funktionsreiches RAG- und Dokumenten-Chat-Tool von H2O.ai, inzwischen archiviert; ein Fallbeispiel dafür, den Pflegestatus zu prüfen, bevor man auf einem Tool aufbaut.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      anythingllmDeep: {
        ...
        items: [
          ...
          '**Flexibilité d\'embedding :** 8 backends en août 2026 — Native (petit modèle groupé), Ollama (n\'importe quel embedder que vous avez), LM Studio, OpenAI, Azure OpenAI, Cohere, Voyage, LocalAI. Changer force une réindexation complète mais est une opération d\'un clic.',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[h2oGPT en 2026 : fonctionnalités, installation et statut archivé](/fr/power-local-llm/h2ogpt-review) — un outil de RAG et de chat documentaire tout aussi riche en fonctionnalités, signé H2O.ai, désormais archivé ; un cas d\'école pour vérifier le statut de maintenance avant de construire sur un outil.',
        ],
      },
    },
  },
  ja: {
    ...
    metaDescription:
      'AnythingLLM、PrivateGPT、Open WebUIを5,047ページのコーパスでテスト。精度、レイテンシ、引用、スケーリング性能を比較。2026年8月の検証結果。',
    ...
    sections: {
      ...
      anythingllmDeep: {
        ...
        items: [
          ...
          '**エンベッディング柔軟性：** 2026年8月の8バックエンド — ネイティブ（小規模な束ねられたモデル）、Ollama（引き出した任意のエンベッダー）、LM Studio、OpenAI、Azure OpenAI、Cohere、Voyage、LocalAI。切り替えは完全な再インデックスを強制しますが、ワンクリック操作です。',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[h2oGPTレビュー：機能・セットアップ・アーカイブ状況](/ja/power-local-llm/h2ogpt-review) — H2O.ai製の同様に機能が豊富なRAG・文書チャットツールで、現在はアーカイブ済み。ツールを導入する前に保守状況を確認すべき好例。',
        ],
      },
    },
    schema: {
      ...
      description: 'AnythingLLM、PrivateGPT、Open WebUIを5,047ページのコーパスでテスト。精度、レイテンシ、引用、スケーリング性能を比較。2026年8月の検証結果。',
  ...
  zh: {
    ...
    leadAnswerBlock: '**在2026年8月测试的5,047页语料库上，AnythingLLM在生产可靠性上获胜（最佳引用、可交换的嵌入器、持久工作空间、6%的最低幻想率）。PrivateGPT在检索延迟上获胜（p50为240ms、完全离线设计、强化的EU合规姿态）。Open WebUI在操作人体工程学上获胜（最干净的多用户设置、精美的Ollama集成、最容易插入现有聊天工作流）。所有三个都在约10,000页时以不同的方式破裂。为您实际拥有的工作流选择，而不是您可能增长的工作流。**',
    quickAnswerTop: { zh: { question: 'Which self-hosted RAG platform is best for local documents in 2026: AnythingLLM, PrivateGPT, or Open WebUI?', answer: '**Open WebUI** wins for most users: easiest setup, best UI, and broadest model support (Ollama + OpenAI API). Use **AnythingLLM** if you need multi-user workspaces. Use **PrivateGPT** only for strict offline-only air-gapped environments.', bullets: ['Open WebUI — easiest one-command Docker install, best UI, supports Ollama and OpenAI-compatible APIs. The default pick for most users in 2026.', 'AnythingLLM — best citations, swappable embedders, multi-user workspaces with document access controls. Right choice for teams needing production-grade RAG with user management.', 'PrivateGPT — fastest retrieval (240 ms p50), offline-by-design, FastAPI service. Use only for strict air-gapped deployments where no internet connectivity is acceptable.', 'All three handle 5,000 pages on a 16 GB RAM machine; the scaling cliff appears between 8,000–12,000 pages depending on embedder choice.', 'Switching embedding models requires a full re-index in all three — budget 30–90 minutes per 5,000 pages on consumer hardware.'], updatedDate: '2026-08-27' } },
    ...
    sections: {
      ...
      faqSection: {
        ...
        title: '常见问题',
        faqs: [
          { q: '哪个RAG平台处理最大的文档集？', a: 'PrivateGPT在消费者硬件上扩展最远。带有调整设置在32GB RAM机器上舒适地达到25,000页。AnythingLLM在10,000页左右破裂，Open WebUI在8,000页左右。超过25,000页，三个都不是正确的工具。' },
          { q: '我可以在这些平台之间迁移文档和嵌入吗？', a: '源文档自由迁移。所有三个接受相同的文件。嵌入不迁移。每个平台以自己的格式存储向量，因此切换总是意味着重新索引。' },
          { q: '哪个平台具有最佳引用准确性？', a: 'AnythingLLM。在50个评分查询中，对逐字引用查询正确引用了10个中的9个。' },
          { q: '索引期间每个平台需要多少GPU内存？', a: '在5,047页语料库上使用默认嵌入器：AnythingLLM在6.2GB处达到峰值，Open WebUI 5.4GB，PrivateGPT 4.8GB。' },
          { q: '我可以使用自己的嵌入模型吗？', a: 'AnythingLLM在GUI中支持8个嵌入后端。PrivateGPT通过settings.yaml支持任何HuggingFace模型。Open WebUI支持Ollama和OpenAI兼容端点。' },
          { q: '哪个平台最好处理多语言文档？', a: 'PrivateGPT配对BAAI/bge-m3时最好。bge-m3支持100多种语言。' },
          { q: '他们如何处理PDF表格和图形？', a: '所有三个通过PDF解析器提取文本。表格被提取为文本。图形被提取为图像参考但未用于检索。' },
          { q: '有多少令牌用于典型的RAG查询？', a: '查询嵌入和搜索约500-700令牌等值计算。提示组装和回答生成取决于检索的块和模型的上下文窗口大小。' },
          { q: '这些平台之外还有其他RAG选择吗？', a: '是的。对于更高规模：自定义Ollama + Qdrant / Weaviate。对于更简单的设置：Docling + Qdrant CLI。使用Llamaindex或LangChain直接构建自定义RAG管道。' },
          { q: '这些平台支持审计日志吗？', a: 'AnythingLLM在工作空间元数据中记录。PrivateGPT可以启用FastAPI服务日志。Open WebUI记录用户登录和文档访问。' },
        ],
      },
    },
    schema: { '@context': 'https://schema.org', '@type': 'TechArticle', headline: 'AnythingLLM vs PrivateGPT vs Open WebUI：2026年最佳本地RAG平台', description: '在5,047页语料库上测试AnythingLLM、PrivateGPT和Open WebUI。比较准确性、延迟、引用和扩展性能。2026年8月的测试结果。', image: buildOgImageObject(OG_SLUG, 'zh'), author: { '@type': 'Organization', name: 'PromptQuorum' }, publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' }, datePublished: '2026-05-07', dateModified: '2026-08-27', inLanguage: 'zh', url: '/zh/power-local-llm/anythingllm-vs-privategpt-vs-openwebui-rag', speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] }, about: [{ '@type': 'Thing', name: 'AnythingLLM' }, { '@type': 'Thing', name: 'PrivateGPT' }, { '@type': 'Thing', name: 'Open WebUI' }, { '@type': 'Thing', name: 'RAG（检索增强生成）' }, { '@type': 'Thing', name: '本地LLM' }], mentions: [{ '@type': 'SoftwareApplication', name: 'Ollama' }, { '@type': 'SoftwareApplication', name: 'LanceDB' }, { '@type': 'SoftwareApplication', name: 'Qdrant' }, { '@type': 'SoftwareApplication', name: 'ChromaDB' }, { '@type': 'SoftwareApplication', name: 'Llama 3.3' }], educationalLevel: 'Advanced' },
    ...
    sections: {
      ...
      anythingllmDeep: {
        ...
        items: [
          ...
          '**Flexibilidad de embedding:** 8 backends en agosto de 2026 — Native (pequeño modelo integrado), Ollama (cualquier embedder que tengas descargado), LM Studio, OpenAI, Azure OpenAI, Cohere, Voyage, LocalAI. Cambiar fuerza una re-indexación completa pero es una operación de un solo clic.',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[h2oGPT en 2026: funciones, instalación y estado archivado](/es/power-local-llm/h2ogpt-review) — una herramienta de RAG y chat documental igual de completa, de H2O.ai, ahora archivada; un caso práctico para revisar el estado de mantenimiento antes de construir sobre una herramienta.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      anythingllmDeep: {
        ...
        items: [
          ...
          '**Flexibilidade de embedding:** 8 backends em agosto de 2026 — Native (pequeno modelo integrado), Ollama (qualquer embedder que você tenha baixado), LM Studio, OpenAI, Azure OpenAI, Cohere, Voyage, LocalAI. Trocar força uma reindexação completa mas é uma operação de um único clique.',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[h2oGPT em 2026: recursos, instalação e status arquivado](/pt/power-local-llm/h2ogpt-review) — uma ferramenta de RAG e chat documental igualmente completa, da H2O.ai, agora arquivada; um estudo de caso sobre checar o status de manutenção antes de construir sobre uma ferramenta.',
        ],
      },
    },
    schema: {
      ...
      description: '3 plataformas RAG locais testadas em um corpus de 5.047 páginas. AnythingLLM, PrivateGPT e Open WebUI: benchmarks de precisão, latência e citações. Veredito de agosto de 2026.',
  ...
  ar: {
    ...
    metaDescription:
      'اختُبرت 3 منصات RAG محلية على مجموعة 5,047 صفحة: AnythingLLM تتفوق في الدقة، وOpen WebUI في السرعة، وPrivateGPT في الاستشهادات. نتائج أغسطس 2026.',
    ...
    sections: {
      ...
      anythingllmDeep: {
        ...
        items: [
          ...
          '**مرونة التضمين:** 8 واجهات خلفية في أغسطس 2026 — Native (نموذج صغير مدمج)، وOllama (أي نموذج تضمين تنزّلته)، وLM Studio، وOpenAI، وAzure OpenAI، وCohere، وVoyage، وLocalAI. يُجبر التغيير على إعادة فهرسة كاملة لكنه عملية بنقرة واحدة.',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[مراجعة h2oGPT: الميزات والإعداد وحالة الأرشفة](/ar/power-local-llm/h2ogpt-review) — أداة RAG ودردشة على المستندات غنية بالميزات بنفس القدر من H2O.ai، أصبحت الآن مؤرشفة؛ مثال عملي على أهمية التحقق من حالة الصيانة قبل البناء على أداة ما.',
        ],
      },
    },
    schema: {
      ...
      description: 'ثلاث منصات RAG محلية اختُبرت على مجموعة نصوص من 5.047 صفحة. AnythingLLM وPrivateGPT وOpen WebUI: معايير أداء الدقة والاستجابة والاستشهادات. حكم أغسطس 2026.',
  ...
  ko: {
    ...
    leadAnswerBlock:
      '**2026년 8월 5,047페이지 코퍼스 테스트 결과: AnythingLLM은 프로덕션 신뢰성에서 우승했습니다(더 나은 인용, 교체 가능한 임베더, 영구 작업공간, 6%로 가장 낮은 환각 발생률). PrivateGPT는 검색 지연 시간에서 우승했습니다(p50 240ms, 완전 오프라인 설계, 엄격한 EU 규정 준수 자세). Open WebUI는 운영 편의성에서 우승했습니다(더 깔끔한 멀티 사용자 설정, Ollama와의 우아한 통합, 기존 채팅 워크플로우에 가장 쉽게 연결). 세 플랫폼 모두 약 10,000페이지를 초과하면 다른 방식으로 성능이 저하됩니다. 미래에 필요할지 모르는 것이 아닌, 실제로 사용하는 워크플로우에 맞춰 선택하십시오.**',
    quickAnswerTop: {
      ko: {
    ...
    sections: {
      ...
      anythingllmDeep: {
        ...
        items: [
          ...
          '**임베딩 유연성:** 2026년 8월 기준 8개 백엔드 — Native(소형 내장 모델), Ollama(다운로드한 모든 임베더), LM Studio, OpenAI, Azure OpenAI, Cohere, Voyage, LocalAI. 전환 시 전체 재인덱싱이 강제되지만 원클릭 작업입니다.',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[h2oGPT 리뷰: 기능, 설치, 아카이브 상태](/ko/power-local-llm/h2ogpt-review) — H2O.ai가 만든, 비슷하게 기능이 풍부한 RAG·문서 채팅 도구로 현재는 아카이브된 상태입니다. 도구를 기반으로 무언가를 구축하기 전에 유지 관리 상태를 확인해야 하는 사례입니다.',
        ],
      },
    },
    schema: {
      ...
      description: '5,047페이지 코퍼스에서 테스트한 로컬 RAG 플랫폼 3종. AnythingLLM, PrivateGPT, Open WebUI의 정확도, 지연 시간, 인용 벤치마크. 2026년 8월 최종 평가.',
