    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[h2oGPT Review: Features, Setup, and Archived Status](/power-local-llm/h2ogpt-review-2026) — a similarly feature-heavy RAG and document-chat tool from H2O.ai, now archived; a case study in checking maintenance status before you build on a tool.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[h2oGPT im Test: Funktionen, Setup und Archiv-Status](/de/power-local-llm/h2ogpt-review-2026) — ein ähnlich funktionsreiches RAG- und Dokumenten-Chat-Tool von H2O.ai, inzwischen archiviert; ein Fallbeispiel dafür, den Pflegestatus zu prüfen, bevor man auf einem Tool aufbaut.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[h2oGPT en 2026 : fonctionnalités, installation et statut archivé](/fr/power-local-llm/h2ogpt-review-2026) — un outil de RAG et de chat documentaire tout aussi riche en fonctionnalités, signé H2O.ai, désormais archivé ; un cas d\'école pour vérifier le statut de maintenance avant de construire sur un outil.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[h2oGPTレビュー：機能・セットアップ・アーカイブ状況](/ja/power-local-llm/h2ogpt-review-2026) — H2O.ai製の同様に機能が豊富なRAG・文書チャットツールで、現在はアーカイブ済み。ツールを導入する前に保守状況を確認すべき好例。',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[h2oGPT en 2026: funciones, instalación y estado archivado](/es/power-local-llm/h2ogpt-review-2026) — una herramienta de RAG y chat documental igual de completa, de H2O.ai, ahora archivada; un caso práctico para revisar el estado de mantenimiento antes de construir sobre una herramienta.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[h2oGPT em 2026: recursos, instalação e status arquivado](/pt/power-local-llm/h2ogpt-review-2026) — uma ferramenta de RAG e chat documental igualmente completa, da H2O.ai, agora arquivada; um estudo de caso sobre checar o status de manutenção antes de construir sobre uma ferramenta.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[مراجعة h2oGPT: الميزات والإعداد وحالة الأرشفة](/ar/power-local-llm/h2ogpt-review-2026) — أداة RAG ودردشة على المستندات غنية بالميزات بنفس القدر من H2O.ai، أصبحت الآن مؤرشفة؛ مثال عملي على أهمية التحقق من حالة الصيانة قبل البناء على أداة ما.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[h2oGPT 리뷰: 기능, 설치, 아카이브 상태](/ko/power-local-llm/h2ogpt-review-2026) — H2O.ai가 만든, 비슷하게 기능이 풍부한 RAG·문서 채팅 도구로 현재는 아카이브된 상태입니다. 도구를 기반으로 무언가를 구축하기 전에 유지 관리 상태를 확인해야 하는 사례입니다.',
        ],
      },
    },
    schema: {
