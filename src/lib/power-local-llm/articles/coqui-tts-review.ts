    ...
    sections: {
      ...
      xttsRelationship: {
        ...
        content: [
          ...
          '**Das `coqui-tts`-Paket dokumentiert die XTTS-v2-Nutzung direkt**, mit dem Modell geladen als `TTS("tts_models/multilingual/multi-dataset/xtts_v2")`, da das Toolkit der primäre unterstützte Weg ist, XTTS v2 auszuführen, außer die Modellgewichte direkt über einen anderen Inferenz-Stack zu verwenden. Siehe PromptQuorums eigenen [XTTS-v2-Test](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) für eine vollständige Aufschlüsselung der Lizenz und Fähigkeiten dieses Modells.',
        ],
      },
      installWalkthrough: {
        id: 'install-walkthrough',
...
print(tts.languages)`,
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[XTTS-v2-Test](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — eine vollständige Aufschlüsselung des Voice-Cloning-Modells, das dieses Toolkit ausführen kann.',
          ...
          '[Bark-TTS-Test](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — das ausdrucksstarke, nicht-sprachliche lokale TTS-Modell, in derselben Tiefe getestet.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      xttsRelationship: {
        ...
        content: [
          ...
          '**Le package `coqui-tts` documente directement l\'utilisation de XTTS v2**, le modèle étant chargé comme `TTS("tts_models/multilingual/multi-dataset/xtts_v2")`, car le kit est le principal moyen pris en charge pour exécuter XTTS v2 en dehors d\'une utilisation directe des poids du modèle via une autre pile d\'inférence. Voir l\'[avis dédié à XTTS v2](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) de PromptQuorum pour une analyse complète de la licence et des capacités de ce modèle.',
        ],
      },
      installWalkthrough: {
        id: 'install-walkthrough',
...
print(tts.languages)`,
      ...
      alternatives: {
        ...
        rows: [
          ...
          {
            'Outil': '[XTTS v2](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
          ...
          {
            'Outil': '[Bark](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Avis XTTS v2](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — une analyse complète du modèle de clonage vocal que ce kit peut exécuter.',
          ...
          '[Avis Bark TTS](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — le modèle TTS local audio expressif et non vocal, testé avec la même profondeur.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      xttsRelationship: {
        ...
        content: [
          ...
          '**El paquete `coqui-tts` documenta directamente el uso de XTTS v2**, con el modelo cargado como `TTS("tts_models/multilingual/multi-dataset/xtts_v2")`, ya que el kit es la vía principal soportada para ejecutar XTTS v2 fuera de usar directamente los pesos del modelo mediante otro stack de inferencia. Ver el [análisis dedicado de XTTS v2](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) de PromptQuorum para un desglose completo de la licencia y capacidades de ese modelo.',
        ],
      },
      installWalkthrough: {
        id: 'install-walkthrough',
...
print(tts.languages)`,
      ...
      alternatives: {
        ...
        rows: [
          ...
          {
            'Herramienta': '[XTTS v2](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
          ...
          {
            'Herramienta': '[Bark](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Análisis de XTTS v2](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — un desglose completo del modelo de clonación de voz que este kit puede ejecutar.',
          ...
          '[Análisis de Bark TTS](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — el modelo TTS local de audio expresivo y no vocal, analizado con la misma profundidad.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      xttsRelationship: {
        ...
        content: [
          ...
          '**`coqui-tts`パッケージはXTTS v2の使用方法を直接文書化しており**、モデルは`TTS("tts_models/multilingual/multi-dataset/xtts_v2")`としてロードされます。これは、別の推論スタックを通じてモデルの重みを直接使用する以外で、XTTS v2を実行する主要なサポート方法がこのツールキットだからです。そのモデルのライセンスと機能の完全な内訳については、PromptQuorumの専用[XTTS v2レビュー](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)を参照してください。',
        ],
      },
      installWalkthrough: {
        id: 'install-walkthrough',
...
print(tts.languages)`,
      ...
      licenseCost: {
        ...
        content: [
          ...
          '**XTTS v2モデルは別途、Coqui Public Model License(CPML)の下でライセンスされており、これは非商用です** — これはモデルの重みと生成された音声出力に適用され、それらを実行するCoqui TTSツールキットのコードには適用されません。そのライセンスの完全な内訳については、PromptQuorumの[XTTS v2レビュー](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)を参照してください。',
      ...
      alternatives: {
        ...
        rows: [
          ...
          {
            'ツール': '[XTTS v2](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
            '最適な用途': 'XTTS v2だけが必要で、より広いツールキットが不要な場合の音声クローニングモデル自体',
            'ライセンス': 'CPML(非商用)',
          },
          {
            'ツール': '[Bark](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[XTTS v2レビュー](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — このツールキットが実行できる音声クローニングモデルの完全な内訳。',
          ...
          '[Bark TTSレビュー](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — 同じ深さでレビューした、表現力豊かで非音声のローカルTTSモデル。',
        ],
      },
    },
    schema: {
...
print(tts.languages)`,
      ...
      licenseCost: {
        ...
        content: [
          ...
          '**O modelo XTTS v2 é licenciado separadamente, sob a Coqui Public Model License (CPML), que é não comercial** — isso se aplica aos pesos do modelo e suas saídas de áudio geradas, não ao código do kit Coqui TTS que os executa. Veja a [análise do XTTS v2](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) do PromptQuorum para a análise completa dessa licença.',
      ...
      alternatives: {
        ...
        rows: [
          ...
          {
            'Ferramenta': '[XTTS v2](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
          ...
          {
            'Ferramenta': '[Bark](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Análise do XTTS v2](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — uma análise completa do modelo de clonagem de voz que este kit pode executar.',
          ...
          '[Análise do Bark TTS](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — o modelo de TTS local de áudio expressivo e não vocal, analisado com a mesma profundidade.',
        ],
      },
    },
    schema: {
...
print(tts.languages)`,
      ...
      licenseCost: {
        ...
        content: [
          ...
          '**نموذج XTTS v2 مرخّص بشكل منفصل، بموجب Coqui Public Model License (CPML)، وهو غير تجاري** — وينطبق ذلك على أوزان النموذج ومخرجاته الصوتية المولَّدة، وليس على كود مجموعة أدوات Coqui TTS التي تُشغّله. راجع [مراجعة XTTS v2](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) من PromptQuorum لتفصيل كامل لذلك الترخيص.',
      ...
      alternatives: {
        ...
        rows: [
          ...
          {
            'الأداة': '[XTTS v2](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
            'الأنسب لـ': 'نموذج استنساخ الصوت نفسه، إذا كنت تحتاج XTTS v2 فقط دون مجموعة الأدوات الأوسع',
            'الترخيص': 'CPML (غير تجاري)',
          },
          {
            'الأداة': '[Bark](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[مراجعة XTTS v2](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — تفصيل كامل لنموذج استنساخ الصوت الذي يمكن لهذه المجموعة تشغيله.',
          ...
          '[مراجعة Bark TTS](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — نموذج TTS محلي معبّر وغير كلامي، تمت مراجعته بالعمق نفسه.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      xttsRelationship: {
        ...
        content: [
          ...
          '**`coqui-tts`包直接记录了XTTS v2的使用方法**,模型通过`TTS("tts_models/multilingual/multi-dataset/xtts_v2")`加载,因为除了通过其他推理栈直接使用模型权重之外,该工具包是运行XTTS v2的主要受支持方式。有关该模型许可证和能力的完整分解,请参阅PromptQuorum专门的[XTTS v2评测](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)。',
        ],
      },
      installWalkthrough: {
        id: 'install-walkthrough',
...
print(tts.languages)`,
      ...
      licenseCost: {
        ...
        content: [
          ...
          '**XTTS v2模型另外采用Coqui Public Model License(CPML)许可证,该许可证为非商业性质** —— 这适用于模型权重及其生成的音频输出,而不适用于运行它们的Coqui TTS工具包代码。有关该许可证的完整分解,请参阅PromptQuorum的[XTTS v2评测](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)。',
      ...
      alternatives: {
        ...
        rows: [
          ...
          {
            '工具': '[XTTS v2](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
            '最适合': '如果你只需要XTTS v2而不需要更广泛的工具包,则可直接使用该声音克隆模型本身',
            '许可证': 'CPML(非商业)',
          },
          {
            '工具': '[Bark](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
      ...
      verdict: {
        ...
        title: '结论',
        content:
          'Coqui TTS是一个非常有价值的案例研究,展示了当背后的公司关闭后开源基础设施会发生什么:原始仓库在2024年8月归于沉寂,但软件本身并未消失——一家研究机构接手了维护工作,重新命名了包,并持续发布版本直至2026年。对于今天评估它的任何人来说,实用的结论很简单:安装`coqui-tts`,而不是原始的`TTS`包,并要理解该工具包的MPL-2.0许可证与它可运行的XTTS v2模型的非商业CPML许可证是相互独立的。作为一个工具包,它的优势在于跨模型架构的灵活性,而不是在任何单一使用场景下都是最快或最简单的选择——为此,可将本评测与PromptQuorum关于[Piper](/power-local-llm/piper-tts-review)(速度方面)、专门针对克隆模型的[XTTS v2](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts),或涵盖所有引擎全貌的[本地TTS许可证指南](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)结合参考。',
      },
      sources: {
        id: 'sources',
        title: '来源',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[XTTS v2评测](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) —— 对该工具包可运行的声音克隆模型的完整拆解。',
          ...
          '[Bark TTS评测](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) —— 同样深度评测的富表现力、非语音本地TTS模型。',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      xttsRelationship: {
        ...
        content: [
          ...
          '**`coqui-tts` 패키지는 XTTS v2 사용법을 직접 문서화하고 있으며**, 모델은 `TTS("tts_models/multilingual/multi-dataset/xtts_v2")`로 로드됩니다. 이는 다른 추론 스택을 통해 모델 가중치를 직접 사용하는 것 외에, 이 툴킷이 XTTS v2를 실행하는 주요 지원 방법이기 때문입니다. 해당 모델의 라이선스와 기능에 대한 전체 분석은 PromptQuorum의 전용 [XTTS v2 리뷰](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)를 참고하십시오.',
        ],
      },
      installWalkthrough: {
        id: 'install-walkthrough',
...
print(tts.languages)`,
      ...
      licenseCost: {
        ...
        content: [
          ...
          '**XTTS v2 모델은 별도로 Coqui Public Model License(CPML) 하에 라이선스되어 있으며, 이는 비상업적입니다** — 이는 모델 가중치와 그 생성된 오디오 출력에 적용되며, 이를 실행하는 Coqui TTS 툴킷 코드에는 적용되지 않습니다. 해당 라이선스에 대한 전체 분석은 PromptQuorum의 [XTTS v2 리뷰](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)를 참고하십시오.',
      ...
      alternatives: {
        ...
        rows: [
          ...
          {
            '도구': '[XTTS v2](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
            '최적 용도': '더 넓은 툴킷이 아니라 XTTS v2만 필요한 경우의 음성 복제 모델 자체',
            '라이선스': 'CPML(비상업적)',
          },
          {
            '도구': '[Bark](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
      ...
      verdict: {
        ...
        title: '결론',
        content:
          'Coqui TTS는 배후 회사가 문을 닫은 후 오픈소스 인프라에 무슨 일이 일어나는지 보여주는 진정으로 유용한 사례 연구입니다: 원본 저장소는 2024년 8월에 조용해졌지만 소프트웨어는 사라지지 않았습니다 — 한 연구 기관이 관리를 이어받아 패키지명을 바꾸고 2026년까지 계속 릴리스를 출시했습니다. 오늘날 이를 평가하는 누구에게나 실용적인 결론은 간단합니다: 원본 `TTS` 패키지가 아니라 `coqui-tts`를 설치하고, 툴킷의 MPL-2.0 라이선스가 실행 가능한 XTTS v2 모델의 비상업적 CPML 라이선스와는 별개라는 점을 이해하십시오. 툴킷으로서의 강점은 어떤 단일 사용 사례에서 가장 빠르거나 가장 단순한 것이 아니라 모델 아키텍처 전반에 걸친 유연성에 있습니다 — 이를 위해서는 이 리뷰를 속도를 위한 PromptQuorum의 [Piper](/power-local-llm/piper-tts-review) 커버리지, 복제 모델 자체를 위한 [XTTS v2](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts), 또는 엔진 전반의 전체 그림을 위한 [로컬 TTS 라이선스 가이드](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)와 함께 참고하십시오.',
      },
      sources: {
        id: 'sources',
        title: '출처',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[XTTS v2 리뷰](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — 이 툴킷이 실행할 수 있는 음성 복제 모델의 전체 분석.',
          ...
          '[Bark TTS 리뷰](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — 동일한 깊이로 리뷰한, 표현력이 풍부하고 비언어적인 로컬 TTS 모델.',
        ],
      },
    },
    schema: {
