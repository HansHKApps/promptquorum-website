...
print(tts.languages)`,
      ...
      licenseCost: {
        ...
        content: [
          ...
          '**The XTTS v2 model is licensed separately, under the Coqui Public Model License (CPML), which is non-commercial** — this applies to the model weights and their generated audio outputs, not to the Coqui TTS toolkit code that runs them. See PromptQuorum\'s [XTTS v2 review](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) for the full breakdown of that license.',
      ...
      alternatives: {
        ...
        rows: [
          ...
          {
            'Tool': '[XTTS v2](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
            'Best fit': 'The voice-cloning model itself, if you only need XTTS v2 and not the broader toolkit',
            'License': 'CPML (non-commercial)',
          },
          {
            'Tool': '[Bark](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[XTTS v2 Review](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — a full breakdown of the voice-cloning model this toolkit can run.',
          ...
          '[Bark TTS Review](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — the expressive, non-speech-audio local TTS model, reviewed in the same depth.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      xttsRelationship: {
        ...
        content: [
          ...
          '**Das `coqui-tts`-Paket dokumentiert die XTTS-v2-Nutzung direkt**, mit dem Modell geladen als `TTS("tts_models/multilingual/multi-dataset/xtts_v2")`, da das Toolkit der primäre unterstützte Weg ist, XTTS v2 auszuführen, außer die Modellgewichte direkt über einen anderen Inferenz-Stack zu verwenden. Siehe PromptQuorums eigenen [XTTS-v2-Test](/de/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) für eine vollständige Aufschlüsselung der Lizenz und Fähigkeiten dieses Modells.',
        ],
      },
      installWalkthrough: {
        id: 'install-walkthrough',
...
print(tts.languages)`,
      ...
      limitations: {
        ...
        items: [
          ...
          '**Schnellstmögliche reine CPU-Synthese.** Wenn Ihre Priorität Echtzeit-Sprache auf bescheidener Hardware wie einem Raspberry Pi ohne GPU ist, ist [Piper](/de/power-local-llm/piper-tts-review) speziell dafür gebaut und einfacher zu deployen; die größeren Modelle von Coqui TTS, insbesondere XTTS v2, sind auf reiner CPU merklich langsamer.',
      ...
      alternatives: {
        ...
        rows: [
          ...
          {
            'Tool': '[XTTS v2](/de/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
          ...
          {
            'Tool': '[Bark](/de/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[XTTS-v2-Test](/de/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — eine vollständige Aufschlüsselung des Voice-Cloning-Modells, das dieses Toolkit ausführen kann.',
          '[Piper-TTS-Test](/de/power-local-llm/piper-tts-review) — die schnelle, reine CPU-lokale-TTS-Alternative, in derselben Tiefe getestet.',
          ...
          '[Bark-TTS-Test](/de/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — das ausdrucksstarke, nicht-sprachliche lokale TTS-Modell, in derselben Tiefe getestet.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      xttsRelationship: {
        ...
        content: [
          ...
          '**Le package `coqui-tts` documente directement l\'utilisation de XTTS v2**, le modèle étant chargé comme `TTS("tts_models/multilingual/multi-dataset/xtts_v2")`, car le kit est le principal moyen pris en charge pour exécuter XTTS v2 en dehors d\'une utilisation directe des poids du modèle via une autre pile d\'inférence. Voir l\'[avis dédié à XTTS v2](/fr/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) de PromptQuorum pour une analyse complète de la licence et des capacités de ce modèle.',
        ],
      },
      installWalkthrough: {
        id: 'install-walkthrough',
...
print(tts.languages)`,
      ...
      limitations: {
        ...
        items: [
          ...
          '**Synthèse CPU seule la plus rapide possible.** Si votre priorité est la parole en temps réel sur du matériel modeste comme un Raspberry Pi sans GPU, [Piper](/fr/power-local-llm/piper-tts-review) est conçu spécifiquement pour cela et plus simple à déployer ; les modèles plus lourds de Coqui TTS, en particulier XTTS v2, sont nettement plus lents sur CPU seul.',
      ...
      alternatives: {
        ...
        rows: [
          ...
          {
            'Outil': '[XTTS v2](/fr/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
          ...
          {
            'Outil': '[Bark](/fr/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Avis XTTS v2](/fr/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — une analyse complète du modèle de clonage vocal que ce kit peut exécuter.',
          '[Avis Piper TTS](/fr/power-local-llm/piper-tts-review) — l\'alternative TTS locale rapide, CPU seul, testée avec la même profondeur.',
          ...
          '[Avis Bark TTS](/fr/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — le modèle TTS local audio expressif et non vocal, testé avec la même profondeur.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      xttsRelationship: {
        ...
        content: [
          ...
          '**El paquete `coqui-tts` documenta directamente el uso de XTTS v2**, con el modelo cargado como `TTS("tts_models/multilingual/multi-dataset/xtts_v2")`, ya que el kit es la vía principal soportada para ejecutar XTTS v2 fuera de usar directamente los pesos del modelo mediante otro stack de inferencia. Ver el [análisis dedicado de XTTS v2](/es/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) de PromptQuorum para un desglose completo de la licencia y capacidades de ese modelo.',
        ],
      },
      installWalkthrough: {
        id: 'install-walkthrough',
...
print(tts.languages)`,
      ...
      limitations: {
        ...
        items: [
          ...
          '**La síntesis solo-CPU más rápida posible.** Si tu prioridad es la voz en tiempo real en hardware modesto como una Raspberry Pi sin GPU, [Piper](/es/power-local-llm/piper-tts-review) está construido específicamente para eso y es más simple de desplegar; los modelos más grandes de Coqui TTS, especialmente XTTS v2, son notablemente más lentos solo con CPU.',
      ...
      alternatives: {
        ...
        rows: [
          ...
          {
            'Herramienta': '[XTTS v2](/es/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
          ...
          {
            'Herramienta': '[Bark](/es/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
      ...
      relatedReading: {
        ...
        items: [
          '[Licencias de TTS local y clonación de voz: Piper, XTTS v2, F5-TTS y Coqui](/es/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — el análisis profundo de licencias en todos los motores TTS locales principales.',
          '[Análisis de XTTS v2](/es/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — un desglose completo del modelo de clonación de voz que este kit puede ejecutar.',
          '[Análisis de Piper TTS](/es/power-local-llm/piper-tts-review) — la alternativa TTS local rápida, solo-CPU, analizada con la misma profundidad.',
          '[ElevenLabs vs Piper vs XTTS v2](/es/power-local-llm/elevenlabs-vs-local-tts-piper-xtts) — la comparación nube contra local para lectores que deciden si autoalojarse.',
          '[Análisis de Bark TTS](/es/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — el modelo TTS local de audio expresivo y no vocal, analizado con la misma profundidad.',
        ],
      },
    },
    schema: {
  ...
  ja: {
    ...
    current_hardware_mentioned: ['CPU', 'NVIDIA GPU'],
    leadAnswerBlock:
      '**Coqui TTSは、もともとスタートアップ企業Coqui AIが開発したオープンソースのローカル音声合成・音声クローニング・ツールキットで、同社は2023年12月に有料サービスを終了しました。** 元のリポジトリ[coqui-ai/TTS](https://github.com/coqui-ai/TTS)は2024年8月以降更新されていません。代わりに、積極的に保守されているコミュニティフォークをインストールしてください:`pip install coqui-tts`。これは[idiap/coqui-ai-TTS](https://github.com/idiap/coqui-ai-TTS)由来で、[Idiap研究所](https://www.idiap.ch/)が保守しています。このツールキットはMPL-2.0ライセンスで、音声クローニングモデル[XTTS v2](https://huggingface.co/coqui/XTTS-v2)を動かすソフトウェアです — ツールキットとモデルは別物で、それぞれ別のライセンスを持ちます([ライセンスと費用](#license-cost)セクション参照)。ローカルTTSエンジン全体のライセンス比較は、PromptQuorumの[ローカルTTSライセンスガイド](/ja/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)を参照してください。',
    quickAnswerTop: {
      en: {
    ...
    sections: {
      ...
      xttsRelationship: {
        ...
        content: [
          ...
          '**`coqui-tts`パッケージはXTTS v2の使用方法を直接文書化しており**、モデルは`TTS("tts_models/multilingual/multi-dataset/xtts_v2")`としてロードされます。これは、別の推論スタックを通じてモデルの重みを直接使用する以外で、XTTS v2を実行する主要なサポート方法がこのツールキットだからです。そのモデルのライセンスと機能の完全な内訳については、PromptQuorumの専用[XTTS v2レビュー](/ja/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)を参照してください。',
        ],
      },
      installWalkthrough: {
        id: 'install-walkthrough',
...
print(tts.languages)`,
      ...
      licenseCost: {
        ...
        content: [
          ...
          '**XTTS v2モデルは別途、Coqui Public Model License(CPML)の下でライセンスされており、これは非商用です** — これはモデルの重みと生成された音声出力に適用され、それらを実行するCoqui TTSツールキットのコードには適用されません。そのライセンスの完全な内訳については、PromptQuorumの[XTTS v2レビュー](/ja/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)を参照してください。',
      ...
      limitations: {
        ...
        items: [
          ...
          '**可能な限り最速のCPU専用合成。** Raspberry PiのようなGPUなしの控えめなハードウェア上でのリアルタイム音声が優先事項であれば、[Piper](/ja/power-local-llm/piper-tts-review)がその目的専用に作られておりデプロイも簡単です。Coqui TTSのより大きなモデル、特にXTTS v2は、CPUのみでは明らかに遅くなります。',
      ...
      alternatives: {
        ...
        rows: [
          ...
          {
            'ツール': '[XTTS v2](/ja/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
            '最適な用途': 'XTTS v2だけが必要で、より広いツールキットが不要な場合の音声クローニングモデル自体',
            'ライセンス': 'CPML(非商用)',
          },
          {
            'ツール': '[Bark](/ja/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
      ...
      relatedReading: {
        ...
        title: '関連記事',
        items: [
          '[ローカルTTSと音声クローニングのライセンス:Piper、XTTS v2、F5-TTS、Coqui](/ja/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — 主要なローカルTTSエンジン全体を扱うライセンスの詳細比較。',
          '[XTTS v2レビュー](/ja/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — このツールキットが実行できる音声クローニングモデルの完全な内訳。',
          '[Piper TTSレビュー](/ja/power-local-llm/piper-tts-review) — 同じ深さでレビューした、高速でCPU専用のローカルTTSの代替案。',
          '[ElevenLabs対Piper対XTTS v2](/ja/power-local-llm/elevenlabs-vs-local-tts-piper-xtts) — セルフホストするかどうかを決める読者向けの、クラウド対ローカルの比較。',
          '[Bark TTSレビュー](/ja/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — 同じ深さでレビューした、表現力豊かで非音声のローカルTTSモデル。',
        ],
      },
    },
    schema: {
...
print(tts.languages)`,
      ...
      licenseCost: {
        ...
        content: [
          ...
          '**O modelo XTTS v2 é licenciado separadamente, sob a Coqui Public Model License (CPML), que é não comercial** — isso se aplica aos pesos do modelo e suas saídas de áudio geradas, não ao código do kit Coqui TTS que os executa. Veja a [análise do XTTS v2](/pt/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) do PromptQuorum para a análise completa dessa licença.',
      ...
      limitations: {
        ...
        items: [
          ...
          '**A síntese somente-CPU mais rápida possível.** Se sua prioridade é voz em tempo real em hardware modesto como um Raspberry Pi sem GPU, o [Piper](/pt/power-local-llm/piper-tts-review) é construído especificamente para isso e mais simples de implantar; os modelos maiores do Coqui TTS, especialmente o XTTS v2, são notavelmente mais lentos apenas com CPU.',
      ...
      alternatives: {
        ...
        rows: [
          ...
          {
            'Ferramenta': '[XTTS v2](/pt/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
          ...
          {
            'Ferramenta': '[Bark](/pt/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
      ...
      relatedReading: {
        ...
        items: [
          '[Licenças de TTS local e clonagem de voz: Piper, XTTS v2, F5-TTS e Coqui](/pt/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — a análise aprofundada de licenças em todos os principais motores de TTS local.',
          '[Análise do XTTS v2](/pt/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — uma análise completa do modelo de clonagem de voz que este kit pode executar.',
          '[Análise do Piper TTS](/pt/power-local-llm/piper-tts-review) — a alternativa de TTS local rápida e somente-CPU, analisada com a mesma profundidade.',
          '[ElevenLabs vs Piper vs XTTS v2](/pt/power-local-llm/elevenlabs-vs-local-tts-piper-xtts) — a comparação nuvem versus local para leitores decidindo se devem se auto-hospedar.',
          '[Análise do Bark TTS](/pt/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — o modelo de TTS local de áudio expressivo e não vocal, analisado com a mesma profundidade.',
        ],
      },
    },
    schema: {
...
print(tts.languages)`,
      ...
      licenseCost: {
        ...
        content: [
          ...
          '**نموذج XTTS v2 مرخّص بشكل منفصل، بموجب Coqui Public Model License (CPML)، وهو غير تجاري** — وينطبق ذلك على أوزان النموذج ومخرجاته الصوتية المولَّدة، وليس على كود مجموعة أدوات Coqui TTS التي تُشغّله. راجع [مراجعة XTTS v2](/ar/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) من PromptQuorum لتفصيل كامل لذلك الترخيص.',
      ...
      limitations: {
        ...
        items: [
          ...
          '**أسرع تحويل ممكن يعتمد على المعالج فقط.** إذا كانت أولويتك هي الكلام في الوقت الفعلي على أجهزة متواضعة مثل Raspberry Pi بلا GPU، فإن [Piper](/ar/power-local-llm/piper-tts-review) مبني خصيصًا لذلك وأبسط في النشر؛ ونماذج Coqui TTS الأكبر، وخصوصًا XTTS v2، أبطأ بشكل ملحوظ على المعالج وحده.',
      ...
      alternatives: {
        ...
        rows: [
          ...
          {
            'الأداة': '[XTTS v2](/ar/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
            'الأنسب لـ': 'نموذج استنساخ الصوت نفسه، إذا كنت تحتاج XTTS v2 فقط دون مجموعة الأدوات الأوسع',
            'الترخيص': 'CPML (غير تجاري)',
          },
          {
            'الأداة': '[Bark](/ar/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
      ...
      relatedReading: {
        ...
        items: [
          '[تراخيص TTS المحلي واستنساخ الصوت: Piper وXTTS v2 وF5-TTS وCoqui](/ar/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — التحليل المعمّق للتراخيص عبر أبرز محركات TTS المحلية.',
          '[مراجعة XTTS v2](/ar/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — تفصيل كامل لنموذج استنساخ الصوت الذي يمكن لهذه المجموعة تشغيله.',
          '[مراجعة Piper TTS](/ar/power-local-llm/piper-tts-review) — بديل TTS محلي سريع يعتمد على المعالج فقط، تمت مراجعته بالعمق نفسه.',
          ...
          '[مراجعة Bark TTS](/ar/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — نموذج TTS محلي معبّر وغير كلامي، تمت مراجعته بالعمق نفسه.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      xttsRelationship: {
        ...
        content: [
          ...
          '**`coqui-tts`包直接记录了XTTS v2的使用方法**,模型通过`TTS("tts_models/multilingual/multi-dataset/xtts_v2")`加载,因为除了通过其他推理栈直接使用模型权重之外,该工具包是运行XTTS v2的主要受支持方式。有关该模型许可证和能力的完整分解,请参阅PromptQuorum专门的[XTTS v2评测](/zh/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)。',
        ],
      },
      installWalkthrough: {
        id: 'install-walkthrough',
...
print(tts.languages)`,
      ...
      licenseCost: {
        ...
        content: [
          ...
          '**XTTS v2模型另外采用Coqui Public Model License(CPML)许可证,该许可证为非商业性质** —— 这适用于模型权重及其生成的音频输出,而不适用于运行它们的Coqui TTS工具包代码。有关该许可证的完整分解,请参阅PromptQuorum的[XTTS v2评测](/zh/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)。',
      ...
      limitations: {
        ...
        items: [
          ...
          '**尽可能最快的纯CPU合成。** 如果你的优先事项是在没有GPU的Raspberry Pi等入门级硬件上实现实时语音,[Piper](/zh/power-local-llm/piper-tts-review)正是为此专门打造且部署更简单;Coqui TTS的更大模型,尤其是XTTS v2,仅用CPU时明显更慢。',
      ...
      alternatives: {
        ...
        rows: [
          ...
          {
            '工具': '[XTTS v2](/zh/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
            '最适合': '如果你只需要XTTS v2而不需要更广泛的工具包,则可直接使用该声音克隆模型本身',
            '许可证': 'CPML(非商业)',
          },
          {
            '工具': '[Bark](/zh/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
      ...
      verdict: {
        ...
        title: '结论',
        content:
          'Coqui TTS是一个非常有价值的案例研究,展示了当背后的公司关闭后开源基础设施会发生什么:原始仓库在2024年8月归于沉寂,但软件本身并未消失——一家研究机构接手了维护工作,重新命名了包,并持续发布版本直至2026年。对于今天评估它的任何人来说,实用的结论很简单:安装`coqui-tts`,而不是原始的`TTS`包,并要理解该工具包的MPL-2.0许可证与它可运行的XTTS v2模型的非商业CPML许可证是相互独立的。作为一个工具包,它的优势在于跨模型架构的灵活性,而不是在任何单一使用场景下都是最快或最简单的选择——为此,可将本评测与PromptQuorum关于[Piper](/zh/power-local-llm/piper-tts-review)(速度方面)、专门针对克隆模型的[XTTS v2](/zh/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts),或涵盖所有引擎全貌的[本地TTS许可证指南](/zh/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)结合参考。',
      },
      sources: {
        id: 'sources',
        title: '来源',
      ...
      relatedReading: {
        ...
        title: '相关阅读',
        items: [
          '[本地TTS与声音克隆许可证:Piper、XTTS v2、F5-TTS与Coqui](/zh/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) —— 涵盖所有主要本地TTS引擎的许可证深度解析。',
          '[XTTS v2评测](/zh/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) —— 对该工具包可运行的声音克隆模型的完整拆解。',
          '[Piper TTS评测](/zh/power-local-llm/piper-tts-review) —— 同样深度评测的快速纯CPU本地TTS替代方案。',
          '[ElevenLabs对比Piper对比XTTS v2](/zh/power-local-llm/elevenlabs-vs-local-tts-piper-xtts) —— 面向正在决定是否自托管的读者的云端与本地对比。',
          '[Bark TTS评测](/zh/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) —— 同样深度评测的富表现力、非语音本地TTS模型。',
        ],
      },
    },
    schema: {
  ...
  ko: {
    ...
    current_hardware_mentioned: ['CPU', 'NVIDIA GPU'],
    leadAnswerBlock:
      '**Coqui TTS는 원래 스타트업 Coqui AI가 개발한 오픈소스 로컬 음성 합성 및 음성 복제 툴킷이며, 이 회사는 2023년 12월에 유료 서비스를 종료했습니다.** 원본 저장소인 [coqui-ai/TTS](https://github.com/coqui-ai/TTS)는 2024년 8월 이후 업데이트되지 않았습니다. 대신 적극적으로 관리되는 커뮤니티 포크를 설치하십시오: `pip install coqui-tts`이며, 이는 [idiap/coqui-ai-TTS](https://github.com/idiap/coqui-ai-TTS)에서 비롯되었고 [Idiap 연구소](https://www.idiap.ch/)가 관리합니다. 이 툴킷은 MPL-2.0 라이선스이며, 음성 복제 모델 [XTTS v2](https://huggingface.co/coqui/XTTS-v2)를 구동하는 소프트웨어입니다 — 툴킷과 모델은 별개이며 각각 별도의 라이선스를 가집니다([라이선스 및 비용](#license-cost) 섹션 참고). 로컬 TTS 엔진 전체에 걸친 라이선스 비교는 PromptQuorum의 [로컬 TTS 라이선스 가이드](/ko/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)를 참고하십시오.',
    quickAnswerTop: {
      en: {
    ...
    sections: {
      ...
      xttsRelationship: {
        ...
        content: [
          ...
          '**`coqui-tts` 패키지는 XTTS v2 사용법을 직접 문서화하고 있으며**, 모델은 `TTS("tts_models/multilingual/multi-dataset/xtts_v2")`로 로드됩니다. 이는 다른 추론 스택을 통해 모델 가중치를 직접 사용하는 것 외에, 이 툴킷이 XTTS v2를 실행하는 주요 지원 방법이기 때문입니다. 해당 모델의 라이선스와 기능에 대한 전체 분석은 PromptQuorum의 전용 [XTTS v2 리뷰](/ko/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)를 참고하십시오.',
        ],
      },
      installWalkthrough: {
        id: 'install-walkthrough',
...
print(tts.languages)`,
      ...
      licenseCost: {
        ...
        content: [
          ...
          '**XTTS v2 모델은 별도로 Coqui Public Model License(CPML) 하에 라이선스되어 있으며, 이는 비상업적입니다** — 이는 모델 가중치와 그 생성된 오디오 출력에 적용되며, 이를 실행하는 Coqui TTS 툴킷 코드에는 적용되지 않습니다. 해당 라이선스에 대한 전체 분석은 PromptQuorum의 [XTTS v2 리뷰](/ko/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)를 참고하십시오.',
      ...
      limitations: {
        ...
        items: [
          ...
          '**가능한 가장 빠른 CPU 전용 합성.** GPU가 없는 Raspberry Pi 같은 저사양 하드웨어에서 실시간 음성이 우선순위라면, [Piper](/ko/power-local-llm/piper-tts-review)가 이를 위해 특별히 제작되었고 배포도 더 간단합니다. Coqui TTS의 더 큰 모델, 특히 XTTS v2는 CPU만 사용할 때 눈에 띄게 느립니다.',
      ...
      alternatives: {
        ...
        rows: [
          ...
          {
            '도구': '[XTTS v2](/ko/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
            '최적 용도': '더 넓은 툴킷이 아니라 XTTS v2만 필요한 경우의 음성 복제 모델 자체',
            '라이선스': 'CPML(비상업적)',
          },
          {
            '도구': '[Bark](/ko/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)',
      ...
      verdict: {
        ...
        title: '결론',
        content:
          'Coqui TTS는 배후 회사가 문을 닫은 후 오픈소스 인프라에 무슨 일이 일어나는지 보여주는 진정으로 유용한 사례 연구입니다: 원본 저장소는 2024년 8월에 조용해졌지만 소프트웨어는 사라지지 않았습니다 — 한 연구 기관이 관리를 이어받아 패키지명을 바꾸고 2026년까지 계속 릴리스를 출시했습니다. 오늘날 이를 평가하는 누구에게나 실용적인 결론은 간단합니다: 원본 `TTS` 패키지가 아니라 `coqui-tts`를 설치하고, 툴킷의 MPL-2.0 라이선스가 실행 가능한 XTTS v2 모델의 비상업적 CPML 라이선스와는 별개라는 점을 이해하십시오. 툴킷으로서의 강점은 어떤 단일 사용 사례에서 가장 빠르거나 가장 단순한 것이 아니라 모델 아키텍처 전반에 걸친 유연성에 있습니다 — 이를 위해서는 이 리뷰를 속도를 위한 PromptQuorum의 [Piper](/ko/power-local-llm/piper-tts-review) 커버리지, 복제 모델 자체를 위한 [XTTS v2](/ko/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts), 또는 엔진 전반의 전체 그림을 위한 [로컬 TTS 라이선스 가이드](/ko/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts)와 함께 참고하십시오.',
      },
      sources: {
        id: 'sources',
        title: '출처',
      ...
      relatedReading: {
        ...
        title: '관련 글',
        items: [
          '[로컬 TTS 및 음성 복제 라이선스: Piper, XTTS v2, F5-TTS, Coqui](/ko/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — 주요 로컬 TTS 엔진 전체를 다루는 라이선스 심층 비교.',
          '[XTTS v2 리뷰](/ko/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — 이 툴킷이 실행할 수 있는 음성 복제 모델의 전체 분석.',
          '[Piper TTS 리뷰](/ko/power-local-llm/piper-tts-review) — 동일한 깊이로 리뷰한, 빠르고 CPU 전용인 로컬 TTS 대안.',
          '[ElevenLabs 대 Piper 대 XTTS v2](/ko/power-local-llm/elevenlabs-vs-local-tts-piper-xtts) — 자체 호스팅 여부를 결정하려는 독자를 위한 클라우드 대 로컬 비교.',
          '[Bark TTS 리뷰](/ko/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — 동일한 깊이로 리뷰한, 표현력이 풍부하고 비언어적인 로컬 TTS 모델.',
        ],
      },
    },
    schema: {
