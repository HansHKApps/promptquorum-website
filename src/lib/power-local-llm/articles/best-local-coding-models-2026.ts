...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  pt: {
    ...
    quickAnswerTop: {
      pt: {
        ...
        bullets: [
          ...
          'Llama 3.3 Code — escolher por compatibilidade com o ecossistema Llama (ferramentas existentes, fine-tunes); a direção de código fica atrás do Qwen3-Coder.',
    ...
    toc: [
      ...
      { label: 'Llama 3.3 Code: análise aprofundada', anchor: '#llama-code' },
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**Llama 3.3 Code** fica atrás do Qwen3-Coder em direção de código publicada, mas ganha onde o ecossistema ao redor (fine-tunes existentes, ferramentas específicas do Llama) importa mais do que o ranking absoluto.',
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**As licenças não são iguais.** Qwen3-Coder, DeepSeek Coder V3 e Granite Code são Apache 2.0. O Codestral tem a licença Mistral Non-Production com condições comerciais separadas. O Llama 3.3 usa a Llama Community Licence (apta para uso comercial com os filtros de política da Meta). O StarCoder 2 é distribuído sob BigCode OpenRAIL-M.',
        ],
      },
      comparisonTable: {
        id: 'comparison-table',
        ...
        rows: [
          ...
          },
          {
            ...
            'VRAM (Q4_K_M)': '~40 GB (70B) / ~5 GB (8B)',
            'Janela de contexto': '128K',
            'Licença': 'Llama Community Licence',
        ...
        image: '/images/best-local-coding-models-2026-model-comparison-pt.svg',
      ...
      whichOne: {
        ...
        rows: [
          ...
          { 'Sua situação': 'Já executo modelos Llama e quero consistência no stack', 'Opção': 'Llama 3.3 Code 70B (se a VRAM permitir) ou a variante 8B' },
      ...
      llamaCodeDeep: {
        id: 'llama-code',
        title: 'Llama 3.3 Code: a opção de compatibilidade com o ecossistema',
        content:
          '**O Llama 3.3 Code é a opção certa quando o seu stack já executa modelos Llama.** A sua direção de código bruta fica atrás do Qwen3-Coder e do DeepSeek, mas o ecossistema ao redor do Llama (fine-tunes, ferramentas, padrões de implantação) é o maior de qualquer família de modelos deste guia.',
        items: [
          ...
          '**Licença:** Llama Community Licence — uso comercial permitido sob as restrições de política da Meta, incluindo um limite de uso acima do qual se aplicam termos de licença separados. Leia a licença antes de integrar em produtos comerciais.',
      ...
      vramMath: {
        ...
        image: '/images/best-local-coding-models-2026-vram-by-quant-pt.svg',
      ...
      contextWindow: {
        ...
        rows: [
          ...
          { 'Modelo': 'Llama 3.3 Code', 'Contexto declarado': '128K', 'Contexto de trabalho prático (código)': '~32K-64K', 'Notas': 'A recuperação de contexto longo fica atrás do Qwen3-Coder.' },
      ...
      licensing: {
        ...
        rows: [
          ...
          { 'Modelo': 'Llama 3.3 Code', 'Licença': 'Llama Community Licence', 'Uso comercial sem licença separada?': 'Sim (com condições)', 'Restrição-chave': 'Política de uso aceitável; aplicam-se termos separados acima de um limite de uso.' },
      ...
      commonMistakes: {
        ...
        items: [
          ...
          '**Erro 3: pular a leitura da licença.** O Codestral em um produto comercial sem licença comercial da Mistral é uma falha de compras. A Llama Community Licence tem filtros para aplicações de alto uso. Leia a licença antes de integrar.',
      ...
      sources: {
        ...
        items: [
          ...
          '[Model cards do Llama 3.3](https://huggingface.co/meta-llama) — Tamanhos, janelas de contexto e texto da Llama Community Licence para a família Llama 3.3.',
    ...
    schema: {
      ...
      image: 'https://www.promptquorum.com/pt/api/og/power-local-llm/best-local-coding-models-2026',
      author: {
        '@type': 'Person',
        name: 'Hans Kuepper',
      },
  ...
  ar: {
    ...
    quickAnswerTop: {
      ar: {
        ...
        bullets: [
          ...
          'Llama 3.3 Code — اختره للتوافق مع منظومة Llama البيئية (الأدوات الموجودة والضبط الدقيق)؛ اتجاه البرمجة يتأخر عن Qwen3-Coder.',
    ...
    toc: [
      ...
      { label: 'Llama 3.3 Code: تحليل معمّق', anchor: '#llama-code' },
    ...
    sections: {
      ...
      whichOne: {
        ...
        rows: [
          ...
          { 'حالتك': 'أشغّل نماذج Llama بالفعل وأريد الاتساق في بنيتي', 'الخيار': 'Llama 3.3 Code 70B (إن سمح VRAM) أو المتغير 8B' },
      ...
      llamaCodeDeep: {
        id: 'llama-code',
        title: 'Llama 3.3 Code: خيار التوافق مع المنظومة البيئية',
        content:
      ...
      contextWindow: {
        ...
        rows: [
          ...
          { 'النموذج': 'Llama 3.3 Code', 'السياق المُعلن': '128K', 'السياق العملي للعمل البرمجي': '~32K-64K', 'ملاحظات': 'استدعاء السياق الطويل يتأخر عن Qwen3-Coder.' },
      ...
      licensing: {
        ...
        rows: [
          ...
          { 'النموذج': 'Llama 3.3 Code', 'الترخيص': 'رخصة مجتمع Llama', 'الاستخدام التجاري دون ترخيص منفصل؟': 'نعم (بشروط)', 'القيد الرئيسي': 'سياسة الاستخدام المقبول؛ شروط منفصلة تسري فوق عتبة استخدام معينة.' },
      ...
      sources: {
        ...
        items: [
          ...
          '[بطاقات نموذج Llama 3.3](https://huggingface.co/meta-llama) — الأحجام ونوافذ السياق ونص رخصة مجتمع Llama لعائلة Llama 3.3.',
    ...
    schema: {
      ...
      image: 'https://www.promptquorum.com/ar/api/og/power-local-llm/best-local-coding-models-2026',
      author: {
        '@type': 'Person',
        name: 'Hans Kuepper',
      },
  ...
  ko: {
    ...
    quickAnswerTop: {
      ko: {
        ...
        bullets: [
          ...
          'Llama 3.3 Code — Llama 에코시스템 호환성(기존 도구, 파인튜닝)을 위해 선택; 코드 방향성은 Qwen3-Coder에 뒤처집니다.',
    ...
    toc: [
      ...
      { label: 'Llama 3.3 Code: 심층 분석', anchor: '#llama-code' },
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**Llama 3.3 Code**는 공개된 코드 방향성에서 Qwen3-Coder에 뒤처지지만, 절대적 순위보다 주변 에코시스템(기존 파인튜닝, Llama 특화 도구)이 더 중요한 경우에 승리합니다.',
      ...
      comparisonTable: {
        ...
        image: '/images/best-local-coding-models-2026-model-comparison-ko.svg',
      ...
      whichOne: {
        ...
        rows: [
          ...
          { '상황': '이미 Llama 모델을 실행하고 있으며 스택 일관성을 원합니다', '선택지': 'Llama 3.3 Code 70B(VRAM이 허용하는 경우) 또는 8B 변형' },
      ...
      llamaCodeDeep: {
        id: 'llama-code',
        title: 'Llama 3.3 Code: 에코시스템 호환성 선택지',
        content:
      ...
      vramMath: {
        ...
        image: '/images/best-local-coding-models-2026-vram-by-quant-ko.svg',
      ...
      contextWindow: {
        ...
        rows: [
          ...
          { '모델': 'Llama 3.3 Code', '선언된 컨텍스트': '128K', '실용적 작업 컨텍스트 (코드)': '~32K-64K', '비고': '긴 컨텍스트 회수는 Qwen3-Coder에 뒤처집니다.' },
      ...
      licensing: {
        ...
        rows: [
          ...
          { '모델': 'Llama 3.3 Code', '라이선스': 'Llama Community Licence', '별도 라이선스 없이 상업적 이용 가능?': '예 (조건 포함)', '주요 제한': '허용 가능한 사용 정책; 사용량 임계값 이상에서 별도 조건 적용.' },
      ...
      decisionTree: {
        ...
        snippetBlocks: [
          ...
          {
            type: 'plain-terms',
            text: '구체적인 이유가 없다면 Qwen3-Coder를 선택하십시오. 이유는: 하드웨어(12 GB 미만 → 7B; 48 GB 이상 → DeepSeek), 언어(틈새 언어 지원 → StarCoder 2), 구매(규제 산업 → Granite Code), 에코시스템 의존성(기존 Llama 인프라 → Llama 3.3 Code). Codestral은 상업 라이선스를 지불할 수 있다면 속도 선택지입니다.',
          },
        ],
        callouts: [
          {
      ...
      sources: {
        ...
        items: [
          ...
          '[Llama 3.3 모델 카드](https://huggingface.co/meta-llama) — Llama 3.3 패밀리의 크기, 컨텍스트 창, Llama Community Licence 텍스트.',
    ...
    schema: {
      ...
      image: 'https://www.promptquorum.com/ko/api/og/power-local-llm/best-local-coding-models-2026',
      author: {
        '@type': 'Person',
        name: 'Hans Kuepper',
      },
