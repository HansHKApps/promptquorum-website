...
snippetBlocks: [
        ...
        columns: ['App', 'Link', 'Tokens/sec (S25 Ultra, Phi-4 Mini)', 'NPU support', 'Best for'],
        rows: [
          {
            'App': 'MLC Chat',
            'Link': '[llm.mlc.ai](https://llm.mlc.ai)',
          ...
          {
            'App': 'Maid',
            'Link': '[github.com/Mobile-Artificial-Intelligence/maid](https://github.com/Mobile-Artificial-Intelligence/maid)',
          ...
          {
            'App': 'Layla',
            'Link': '[layla-network.ai](https://www.layla-network.ai)',
          ...
          {
            'App': 'Private AI',
            'Link': '[play.google.com](https://play.google.com/store/apps/details?id=us.valkon.privateai)',
          ...
          {
            'App': 'PocketPal AI',
            'Link': '[github.com/a-ghorbani/pocketpal-ai](https://github.com/a-ghorbani/pocketpal-ai)',
...
snippetBlocks: [
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: 'Do any of these apps work on iPhone too?',
            a: 'No. MLC Chat, Maid, Layla, Ollama via Termux, Private AI, and PocketPal AI are Android-only builds — Termux-style local API servers in particular are not possible on iOS because of Apple\'s app sandboxing. If you are on iPhone, see the [Best Local LLM Apps for iPhone](/power-local-llm/best-local-llm-apps-iphone-2026) guide, which covers LLM Farm, Pocket Paladin, and the rest of the iOS-only lineup.',
          },
          {
            q: 'Is MLC Chat the official app, and how do I avoid fake clones on the Play Store?',
            a: 'The official MLC Chat app is published by the MLC AI team, with source at [github.com/mlc-ai/mlc-llm](https://github.com/mlc-ai/mlc-llm). Play Store search for local LLM apps regularly surfaces unrelated clones with similar names and no real inference engine behind them. Before installing any app in this guide, check that the Play Store listing\'s developer matches the project and that it links to the GitHub repo referenced in this article — PocketPal AI\'s source is at [github.com/a-ghorbani/pocketpal-ai](https://github.com/a-ghorbani/pocketpal-ai), and Maid\'s at [github.com/Mobile-Artificial-Intelligence/maid](https://github.com/Mobile-Artificial-Intelligence/maid).',
          },
        ],
      },
      relatedReading: {
...
snippetBlocks: [
        ...
        columns: ['App', 'Link', 'Token/Sek. (S25 Ultra, Phi-4 Mini)', 'NPU-Support', 'Am besten geeignet für'],
        rows: [
          {
            'App': 'MLC Chat',
            'Link': '[llm.mlc.ai](https://llm.mlc.ai)',
...
snippetBlocks: [
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: 'Funktioniert eine dieser Apps auch auf dem iPhone?',
            a: 'Nein. MLC Chat, Maid, Layla, Ollama via Termux, Private AI und PocketPal AI sind reine Android-Apps — insbesondere ein lokaler API-Server über Termux ist unter iOS wegen des App-Sandboxings von Apple nicht möglich. Falls Sie ein iPhone nutzen, siehe den Leitfaden [Beste lokale LLM-Apps für iPhone](/de/power-local-llm/best-local-llm-apps-iphone-2026) mit LLM Farm, Pocket Paladin und den übrigen iOS-exklusiven Optionen.',
          },
          {
            q: 'Ist MLC Chat die offizielle App, und wie erkenne ich gefälschte Klone im Play Store?',
            a: 'Die offizielle MLC-Chat-App wird vom MLC-AI-Team veröffentlicht, Quellcode unter [github.com/mlc-ai/mlc-llm](https://github.com/mlc-ai/mlc-llm). Bei der Play-Store-Suche nach lokalen LLM-Apps tauchen regelmäßig namensähnliche Klone ohne echte Inferenz-Engine dahinter auf. Prüfen Sie vor der Installation jeder App aus diesem Leitfaden, ob der angezeigte Entwickler zum Projekt passt und der Play-Store-Eintrag auf das hier verlinkte GitHub-Repo verweist — der Quellcode von PocketPal AI liegt unter [github.com/a-ghorbani/pocketpal-ai](https://github.com/a-ghorbani/pocketpal-ai), der von Maid unter [github.com/Mobile-Artificial-Intelligence/maid](https://github.com/Mobile-Artificial-Intelligence/maid).',
          },
        ],
      },
      countrySpecific: {
...
snippetBlocks: [
        ...
        columns: ['Application', 'Lien', 'Tokens/sec (S25 Ultra, Phi-4 Mini)', 'Support NPU', 'Meilleur pour'],
        rows: [
          {
            'Application': 'MLC Chat',
            'Lien': '[llm.mlc.ai](https://llm.mlc.ai)',
          ...
          {
            'Application': 'Maid',
            'Lien': '[github.com/Mobile-Artificial-Intelligence/maid](https://github.com/Mobile-Artificial-Intelligence/maid)',
          ...
          {
            'Application': 'Layla',
            'Lien': '[layla-network.ai](https://www.layla-network.ai)',
            'Tokens/sec (S25 Ultra, Phi-4 Mini)': '~14 tok/sec (CPU)',
            'Support NPU': 'Non',
          ...
          },
          {
            ...
            'Lien': '[play.google.com](https://play.google.com/store/apps/details?id=us.valkon.privateai)',
            'Tokens/sec (S25 Ultra, Phi-4 Mini)': '~13 tok/sec (CPU)',
            'Support NPU': 'Non',
          ...
          },
          {
            ...
            'Lien': '[github.com/a-ghorbani/pocketpal-ai](https://github.com/a-ghorbani/pocketpal-ai)',
            'Tokens/sec (S25 Ultra, Phi-4 Mini)': '~16 tok/sec (CPU/Vulkan)',
...
snippetBlocks: [
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: 'Ces applications fonctionnent-elles aussi sur iPhone ?',
            a: 'Non. MLC Chat, Maid, Layla, Ollama via Termux, Private AI et PocketPal AI sont des applications strictement Android — un serveur d\'API local via Termux en particulier n\'est pas possible sous iOS à cause du sandboxing des applications d\'Apple. Si vous êtes sur iPhone, consultez le guide [Meilleures applications LLM locales pour iPhone](/fr/power-local-llm/best-local-llm-apps-iphone-2026), qui couvre LLM Farm, Pocket Paladin et le reste des options exclusives à iOS.',
          },
          {
            q: 'MLC Chat est-elle l\'application officielle, et comment éviter les faux clones sur le Play Store ?',
            a: 'L\'application officielle MLC Chat est publiée par l\'équipe MLC AI, code source sur [github.com/mlc-ai/mlc-llm](https://github.com/mlc-ai/mlc-llm). La recherche d\'applications d\'IA locale sur le Play Store fait régulièrement remonter des clones au nom similaire sans véritable moteur d\'inférence derrière. Avant d\'installer une application de ce guide, vérifiez que le développeur affiché correspond au projet et que la fiche Play Store renvoie vers le dépôt GitHub cité dans cet article — le code source de PocketPal AI se trouve sur [github.com/a-ghorbani/pocketpal-ai](https://github.com/a-ghorbani/pocketpal-ai), celui de Maid sur [github.com/Mobile-Artificial-Intelligence/maid](https://github.com/Mobile-Artificial-Intelligence/maid).',
          },
        ],
      },
      relatedReading: {
...
snippetBlocks: [
        ...
        columns: ['アプリ', 'リンク', 'トークン/秒（S25 Ultra、Phi-4 Mini）', 'NPU対応', '最適用途'],
        rows: [
          {
            'アプリ': 'MLC Chat',
            'リンク': '[llm.mlc.ai](https://llm.mlc.ai)',
          ...
          {
            'アプリ': 'Maid',
            'リンク': '[github.com/Mobile-Artificial-Intelligence/maid](https://github.com/Mobile-Artificial-Intelligence/maid)',
          ...
          {
            'アプリ': 'Layla',
            'リンク': '[layla-network.ai](https://www.layla-network.ai)',
          ...
          },
          {
            ...
            'リンク': '[ollama.com](https://ollama.com)',
          ...
          {
            'アプリ': 'Private AI',
            'リンク': '[play.google.com](https://play.google.com/store/apps/details?id=us.valkon.privateai)',
          ...
          {
            'アプリ': 'PocketPal AI',
            'リンク': '[github.com/a-ghorbani/pocketpal-ai](https://github.com/a-ghorbani/pocketpal-ai)',
...
snippetBlocks: [
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: 'これらのアプリは iPhone でも使えますか?',
            a: 'いいえ。MLC Chat、Maid、Layla、Ollama via Termux、Private AI、PocketPal AI はいずれも Android 専用アプリです。特に Termux 経由のローカル API サーバーは、Apple のアプリサンドボックスにより iOS 上では実現できません。iPhone をお使いの場合は、LLM Farm や Pocket Paladin など iOS 専用の選択肢をまとめた[iPhone向けベストローカルLLMアプリ](/ja/power-local-llm/best-local-llm-apps-iphone-2026)を参照してください。',
          },
          {
...
snippetBlocks: [
        ...
        columns: ['App', 'Enlace', 'Tokens/seg (S25 Ultra, Phi-4 Mini)', 'Soporte NPU', 'Ideal para'],
        rows: [
          {
            'App': 'MLC Chat',
            'Enlace': '[llm.mlc.ai](https://llm.mlc.ai)',
          ...
          {
            'App': 'Maid',
            'Enlace': '[github.com/Mobile-Artificial-Intelligence/maid](https://github.com/Mobile-Artificial-Intelligence/maid)',
          ...
          {
            'App': 'Layla',
            'Enlace': '[layla-network.ai](https://www.layla-network.ai)',
          ...
          {
            'App': 'Private AI',
            'Enlace': '[play.google.com](https://play.google.com/store/apps/details?id=us.valkon.privateai)',
          ...
          {
            'App': 'PocketPal AI',
            'Enlace': '[github.com/a-ghorbani/pocketpal-ai](https://github.com/a-ghorbani/pocketpal-ai)',
...
snippetBlocks: [
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: '¿Alguna de estas apps funciona también en iPhone?',
            a: 'No. MLC Chat, Maid, Layla, Ollama via Termux, Private AI y PocketPal AI son apps exclusivamente para Android — en particular, un servidor de API local vía Termux no es posible en iOS debido al sandboxing de aplicaciones de Apple. Si tienes iPhone, consulta la guía [Mejores apps de LLM local para iPhone](/es/power-local-llm/best-local-llm-apps-iphone-2026), que cubre LLM Farm, Pocket Paladin y el resto de opciones exclusivas de iOS.',
          },
          {
            q: '¿Es MLC Chat la app oficial, y cómo evito clones falsos en la Play Store?',
            a: 'La app oficial de MLC Chat la publica el equipo de MLC AI, con el código fuente en [github.com/mlc-ai/mlc-llm](https://github.com/mlc-ai/mlc-llm). Al buscar apps de LLM local en la Play Store aparecen con frecuencia clones con nombres parecidos que no tienen un motor de inferencia real detrás. Antes de instalar cualquier app de esta guía, comprueba que el desarrollador que aparece coincide con el proyecto y que la ficha de la Play Store enlaza al repositorio de GitHub citado en este artículo — el código de PocketPal AI está en [github.com/a-ghorbani/pocketpal-ai](https://github.com/a-ghorbani/pocketpal-ai), y el de Maid en [github.com/Mobile-Artificial-Intelligence/maid](https://github.com/Mobile-Artificial-Intelligence/maid).',
          },
        ],
      },
      relatedReading: {
...
snippetBlocks: [
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: 'Algum desses apps funciona também no iPhone?',
            a: 'Não. MLC Chat, Maid, Layla, Ollama via Termux, Private AI e PocketPal AI são apps exclusivos para Android — em especial, um servidor de API local via Termux não é possível no iOS por causa do sandboxing de apps da Apple. Se você usa iPhone, veja o guia [Melhores Apps de LLM Local para iPhone](/pt/power-local-llm/best-local-llm-apps-iphone-2026), que cobre LLM Farm, Pocket Paladin e as demais opções exclusivas de iOS.',
          },
          {
            q: 'O MLC Chat é o app oficial? Como evitar clones falsos na Play Store?',
            a: 'O app oficial do MLC Chat é publicado pela equipe MLC AI, com código-fonte em [github.com/mlc-ai/mlc-llm](https://github.com/mlc-ai/mlc-llm). Buscas por apps de LLM local na Play Store frequentemente trazem clones com nomes parecidos, mas sem um mecanismo de inferência real por trás. Antes de instalar qualquer app deste guia, confirme se o desenvolvedor exibido corresponde ao projeto e se a página da Play Store aponta para o repositório do GitHub citado neste artigo — o código-fonte do PocketPal AI está em [github.com/a-ghorbani/pocketpal-ai](https://github.com/a-ghorbani/pocketpal-ai), e o do Maid em [github.com/Mobile-Artificial-Intelligence/maid](https://github.com/Mobile-Artificial-Intelligence/maid).',
          },
        ],
      },
      relatedReading: {
...
snippetBlocks: [
        ...
        columns: ['التطبيق', 'الرابط', 'الرموز/ث (S25 Ultra، Phi-4 Mini)', 'دعم NPU', 'الأنسب لـ'],
        rows: [
          {
            'التطبيق': 'MLC Chat',
            'الرابط': '[llm.mlc.ai](https://llm.mlc.ai)',
          ...
          {
            'التطبيق': 'Maid',
            'الرابط': '[github.com/Mobile-Artificial-Intelligence/maid](https://github.com/Mobile-Artificial-Intelligence/maid)',
          ...
          {
            'التطبيق': 'Layla',
            'الرابط': '[layla-network.ai](https://www.layla-network.ai)',
          ...
          {
            'التطبيق': 'Private AI',
            'الرابط': '[play.google.com](https://play.google.com/store/apps/details?id=us.valkon.privateai)',
          ...
          },
          {
            ...
            'الرابط': '[github.com/a-ghorbani/pocketpal-ai](https://github.com/a-ghorbani/pocketpal-ai)',
...
snippetBlocks: [
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: 'هل يعمل أي من هذه التطبيقات على iPhone أيضاً؟',
            a: 'لا. تطبيقات MLC Chat وMaid وLayla وOllama عبر Termux وPrivate AI وPocketPal AI مخصصة لنظام Android فقط — وعلى وجه الخصوص، تشغيل خادم API محلي عبر Termux غير ممكن على iOS بسبب آلية العزل (sandboxing) الخاصة بتطبيقات Apple. إذا كنت تستخدم iPhone، راجع دليل [أفضل تطبيقات LLM المحلية لأجهزة iPhone](/ar/power-local-llm/best-local-llm-apps-iphone-2026)، الذي يغطي LLM Farm وPocket Paladin وبقية الخيارات الحصرية لنظام iOS.',
          },
          {
            q: 'هل MLC Chat هو التطبيق الرسمي؟ وكيف أتجنب النسخ المقلّدة المزيفة على متجر Play؟',
            a: 'تطبيق MLC Chat الرسمي ينشره فريق MLC AI، والكود المصدري متاح على [github.com/mlc-ai/mlc-llm](https://github.com/mlc-ai/mlc-llm). يظهر بشكل متكرر عند البحث عن تطبيقات LLM محلية في متجر Play نسخ مقلّدة تحمل أسماء مشابهة دون وجود محرك استدلال حقيقي خلفها. قبل تثبيت أي تطبيق من هذا الدليل، تأكد من أن اسم المطوّر المعروض يطابق المشروع، وأن صفحة متجر Play ترتبط بمستودع GitHub المذكور في هذا المقال — الكود المصدري لتطبيق PocketPal AI موجود على [github.com/a-ghorbani/pocketpal-ai](https://github.com/a-ghorbani/pocketpal-ai)، وكود Maid على [github.com/Mobile-Artificial-Intelligence/maid](https://github.com/Mobile-Artificial-Intelligence/maid).',
          },
        ],
      },
      relatedReading: {
...
snippetBlocks: [
        ...
        columns: ['앱', '링크', 'tok/s(S25 Ultra, Phi-4 Mini)', 'NPU 지원', '최적 사용 사례'],
        rows: [
          {
            '앱': 'MLC Chat',
            '링크': '[llm.mlc.ai](https://llm.mlc.ai)',
          ...
          {
            '앱': 'Maid',
            '링크': '[github.com/Mobile-Artificial-Intelligence/maid](https://github.com/Mobile-Artificial-Intelligence/maid)',
          ...
          {
            '앱': 'Layla',
            '링크': '[layla-network.ai](https://www.layla-network.ai)',
          ...
          {
            '앱': 'Private AI',
            '링크': '[play.google.com](https://play.google.com/store/apps/details?id=us.valkon.privateai)',
          ...
          {
            '앱': 'PocketPal AI',
            '링크': '[github.com/a-ghorbani/pocketpal-ai](https://github.com/a-ghorbani/pocketpal-ai)',
...
snippetBlocks: [
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: '이 앱 중 iPhone에서도 작동하는 것이 있습니까?',
            a: '없습니다. MLC Chat, Maid, Layla, Ollama via Termux, Private AI, PocketPal AI는 모두 Android 전용 앱입니다 — 특히 Termux를 통한 로컬 API 서버는 Apple의 앱 샌드박싱 때문에 iOS에서 구현할 수 없습니다. iPhone을 사용 중이라면 LLM Farm, Pocket Paladin 등 iOS 전용 옵션을 다루는 [iPhone용 최고의 로컬 LLM 앱](/ko/power-local-llm/best-local-llm-apps-iphone-2026) 가이드를 참고하십시오.',
          },
          {
            q: 'MLC Chat은 공식 앱입니까? Play 스토어의 가짜 클론 앱은 어떻게 구별합니까?',
            a: '공식 MLC Chat 앱은 MLC AI 팀이 게시하며, 소스 코드는 [github.com/mlc-ai/mlc-llm](https://github.com/mlc-ai/mlc-llm)에 있습니다. Play 스토어에서 로컬 LLM 앱을 검색하면 이름은 비슷하지만 실제 추론 엔진이 없는 관련 없는 클론 앱이 자주 나타납니다. 이 가이드의 앱을 설치하기 전에 표시된 개발자가 프로젝트와 일치하는지, Play 스토어 목록이 이 글에서 언급한 GitHub 저장소로 연결되는지 확인하십시오 — PocketPal AI의 소스 코드는 [github.com/a-ghorbani/pocketpal-ai](https://github.com/a-ghorbani/pocketpal-ai)에, Maid의 소스 코드는 [github.com/Mobile-Artificial-Intelligence/maid](https://github.com/Mobile-Artificial-Intelligence/maid)에 있습니다.',
          },
        ],
      },
      relatedReading: {
