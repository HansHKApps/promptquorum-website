...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  pt: {
    ...
    seoTitle: 'Apps de LLM local para Android 2026: MLC Chat, Maid e mais',
    intro:
    ...
    metaDescription:
      '6 apps de LLM local para Android testados em celulares reais em 2026: MLC Chat, Maid, Layla, Ollama via Termux, Private AI, PocketPal AI. Velocidades de token, suporte a NPU.',
    twitterDescription:
    ...
    schema: {
      ...
      datePublished: '2026-05-08',
      dateModified: '2026-05-08',
      url: 'https://www.promptquorum.com/pt/pt/power-local-llm/best-local-llm-apps-android-2026',
      inLanguage: 'pt-BR',
  ...
  ko: {
    ...
    seoTitle: 'Android 로컬 LLM 앱 2026: MLC Chat, Maid 등 비교',
    intro:
    ...
    metaDescription:
      '2026년 실제 스마트폰에서 테스트한 Android용 로컬 LLM 앱 6종: MLC Chat, Maid, Layla, Ollama via Termux, Private AI, PocketPal AI. 토큰 속도와 NPU 지원 비교.',
    twitterDescription:
