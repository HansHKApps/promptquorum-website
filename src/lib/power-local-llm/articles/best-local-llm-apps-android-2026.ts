...
snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/directory) — the full app directory including desktop apps, server backends, and frontends for all platforms.',
...
snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Lokales LLM Software-Verzeichnis 2026](/de/directory) — das vollständige App-Verzeichnis einschließlich Desktop-Apps, Server-Backends und Frontends für alle Plattformen.',
...
snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Répertoire logiciel IA local 2026](/fr/directory) — le répertoire d\'applications complet incluant les applications de bureau, les backends serveur et les frontends pour toutes les plateformes.',
...
snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[ローカル AI ソフトウェアディレクトリ 2026](/ja/directory)—完全なアプリディレクトリ、デスクトップアプリ、サーバーバックエンド、すべてのプラットフォーム向けフロントエンド含む。',
...
snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Directorio de software LLM local 2026](/es/directory) — el directorio completo de apps incluyendo apps de escritorio, backends de servidor y frontends para todas las plataformas.',
...
snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Diretório de software de LLM local 2026](/pt/directory) — o diretório completo de apps incluindo apps de desktop, backends de servidor e frontends para todas as plataformas.',
...
snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[دليل برامج LLM المحلية 2026](/ar/directory) — الدليل الشامل للتطبيقات بما في ذلك تطبيقات سطح المكتب وخلفيات الخادم والواجهات الأمامية لجميع المنصات.',
...
snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026 로컬 LLM 소프트웨어 디렉토리](/ko/directory) — 데스크톱 앱, 서버 백엔드, 모든 플랫폼 프론트엔드를 포함한 전체 앱 디렉토리.',
