...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    seoTitle: 'Local LLM Apps for Android 2026: MLC Chat, Maid & More',
    intro:
    ...
    metaDescription:
      '6 local LLM apps for Android tested on real phones in 2026: MLC Chat, Maid, Layla, Ollama via Termux, Private AI, PocketPal AI. Token speeds, NPU support.',
    twitterDescription:
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Best Qwen Model for Coding](/prompt-bites/best-qwen-model-for-coding) — Qwen2.5-Coder on Android via Termux + Ollama: feasibility and setup.',
        ],
      },
    },
    schema: {
      ...
      dateModified: '2026-05-08',
      url: 'https://www.promptquorum.com/power-local-llm/best-local-llm-apps-android-2026?lang=en',
      inLanguage: 'en',
      image: 'https://www.promptquorum.com/api/og/best-local-llm-apps-android-2026?lang=en',
      author: {
        '@type': 'Person',
        name: 'Hans Kuepper',
  ...
  de: {
    ...
    seoTitle: 'Lokale LLM-Apps für Android 2026: MLC Chat, Maid & mehr',
    intro:
    ...
    metaDescription:
      '6 lokale LLM-Apps für Android 2026 getestet: MLC Chat, Maid, Layla, Ollama via Termux, Private AI, PocketPal AI. Token-Geschwindigkeit und NPU-Support.',
    twitterDescription:
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Open-Source-Alternativen zu ChatGPT Plus](/prompt-bites/best-open-source-alternatives-to-chatgpt-plus?lang=de) — Open WebUI, LibreChat und Jan: Funktionsvergleich mit ChatGPT Plus.',
          '[Bestes Qwen-Modell für das Coding](/prompt-bites/best-qwen-model-for-coding?lang=de) — Qwen2.5-Coder auf Android via Termux + Ollama: Machbarkeit und Einrichtung.',
        ],
      },
    },
    schema: {
      ...
      datePublished: '2026-05-08',
      dateModified: '2026-05-08',
      url: 'https://www.promptquorum.com/power-local-llm/best-local-llm-apps-android-2026?lang=de',
      inLanguage: 'de',
  ...
  fr: {
    ...
    seoTitle: 'Applications LLM Android 2026 : MLC Chat, Maid et plus',
    intro:
    ...
    metaDescription:
      '6 applications IA locales pour Android testées en 2026 : MLC Chat, Maid, Layla, Ollama via Termux, Private AI, PocketPal AI. Vitesses de tokens et NPU.',
    twitterDescription:
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Meilleures alternatives open-source à ChatGPT Plus](/prompt-bites/best-open-source-alternatives-to-chatgpt-plus?lang=fr) — Open WebUI, LibreChat et Jan : comparaison des fonctionnalités avec ChatGPT Plus.',
          '[Meilleur modèle Qwen pour le coding](/prompt-bites/best-qwen-model-for-coding?lang=fr) — Qwen2.5-Coder sur Android via Termux + Ollama : faisabilité et configuration.',
        ],
      },
    },
    schema: {
      ...
      datePublished: '2026-05-08',
      dateModified: '2026-05-08',
      url: 'https://www.promptquorum.com/power-local-llm/best-local-llm-apps-android-2026?lang=fr',
      inLanguage: 'fr',
  ...
  ja: {
    ...
    seoTitle: '2026年Android向けローカルLLMアプリ：MLC Chat、Maid など6種テスト',
    intro:
    ...
    metaDescription:
      '2026年の Android向けローカルLLMアプリ 6つを比較。MLC Chat、Maid、Layla、Ollama via Termux、Private AI、PocketPal AI は Galaxy S25 Ultra、Pixel 9 Pro でテスト済み。トークン速度、NPU対応。',
    twitterDescription:
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[ChatGPT Plusのオープンソース代替](/prompt-bites/best-open-source-alternatives-to-chatgpt-plus?lang=ja)—Open WebUI、LibreChat、Jan：ChatGPT Plusとの機能比較。',
          '[コーディング向けベストQwenモデル](/prompt-bites/best-qwen-model-for-coding?lang=ja)—Termux + OllamaでAndroid上のQwen2.5-Coder：実現可能性とセットアップ。',
        ],
      },
    },
    schema: {
      ...
      datePublished: '2026-05-08',
      dateModified: '2026-05-08',
      url: 'https://www.promptquorum.com/power-local-llm/best-local-llm-apps-android-2026?lang=ja',
      inLanguage: 'ja',
  ...
  zh: {
    ...
    seoTitle: '2026年最佳安卓本地LLM应用：MLC Chat vs Maid vs Layla 6款真机测试',
    intro:
    ...
    metaDescription:
      '2026年6款本地LLM安卓应用在真实手机上对比。MLC Chat、Maid、Layla、Ollama via Termux、Private AI和PocketPal AI，在Galaxy S25 Ultra、Pixel 9 Pro和OnePlus 13上测试。Token速率、NPU支持。',
    twitterDescription:
