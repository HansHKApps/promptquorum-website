...
snippetBlocks: [
        ...
        rows: [
          ...
          {
            'App': '[Ollama via Termux](https://ollama.com)',
          ...
          {
            'App': '[Private AI](https://play.google.com/store/apps/details?id=us.valkon.privateai)',
            'Tokens/sec (S25 Ultra, Phi-4 Mini)': '~13 tok/sec (CPU)',
            'NPU support': 'No',
            'Best for': 'Privacy-first users, minimal permissions',
          },
          {
            'App': '[PocketPal AI](https://github.com/a-ghorbani/pocketpal-ai)',
...
snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/power-local-llm/local-llm-software-directory) — the full app directory including desktop apps, server backends, and frontends for all platforms.',
...
snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Lokales LLM Software-Verzeichnis 2026](/de/power-local-llm/local-llm-software-directory) — das vollständige App-Verzeichnis einschließlich Desktop-Apps, Server-Backends und Frontends für alle Plattformen.',
...
snippetBlocks: [
        ...
        rows: [
          {
            'Application': '[MLC Chat](https://llm.mlc.ai)',
          ...
          {
            'Application': '[Ollama via Termux](https://ollama.com)',
            'Tokens/sec (S25 Ultra, Phi-4 Mini)': '~10 tok/sec (CPU)',
            'Support NPU': 'Non (CPU seul dans le build Termux standard)',
            'Meilleur pour': 'Utilisateurs avancés, accès API, utilisation d\'outils',
          },
          {
            'Application': '[Private AI](https://play.google.com/store/apps/details?id=us.valkon.privateai)',
            'Tokens/sec (S25 Ultra, Phi-4 Mini)': '~13 tok/sec (CPU)',
            'Support NPU': 'Non',
            'Meilleur pour': 'Utilisateurs orientés confidentialité, permissions minimales',
          },
          {
            'Application': '[PocketPal AI](https://github.com/a-ghorbani/pocketpal-ai)',
            'Tokens/sec (S25 Ultra, Phi-4 Mini)': '~16 tok/sec (CPU/Vulkan)',
...
snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Répertoire logiciel IA local 2026](/fr/power-local-llm/local-llm-software-directory) — le répertoire d\'applications complet incluant les applications de bureau, les backends serveur et les frontends pour toutes les plateformes.',
...
snippetBlocks: [
        ...
        rows: [
          ...
          {
            'アプリ': '[Ollama via Termux](https://ollama.com)',
            'トークン/秒（S25 Ultra、Phi-4 Mini）': '~10 tok/sec（CPU）',
            'NPU対応': 'いいえ（標準 Termux ビルド内 CPU のみ）',
            '最適用途': 'パワーユーザー、API アクセス、ツール利用',
          },
          {
            'アプリ': '[Private AI](https://play.google.com/store/apps/details?id=us.valkon.privateai)',
            'トークン/秒（S25 Ultra、Phi-4 Mini）': '~13 tok/sec（CPU）',
            'NPU対応': 'いいえ',
            '最適用途': 'プライバシー重視ユーザー、最小限の権限',
          },
          {
            'アプリ': '[PocketPal AI](https://github.com/a-ghorbani/pocketpal-ai)',
...
snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[ローカル AI ソフトウェアディレクトリ 2026](/ja/power-local-llm/local-llm-software-directory)—完全なアプリディレクトリ、デスクトップアプリ、サーバーバックエンド、すべてのプラットフォーム向けフロントエンド含む。',
...
snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Directorio de software LLM local 2026](/es/power-local-llm/local-llm-software-directory) — el directorio completo de apps incluyendo apps de escritorio, backends de servidor y frontends para todas las plataformas.',
...
snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Diretório de software de LLM local 2026](/pt/power-local-llm/local-llm-software-directory) — o diretório completo de apps incluindo apps de desktop, backends de servidor e frontends para todas as plataformas.',
...
snippetBlocks: [
        ...
        rows: [
          {
            'التطبيق': '[MLC Chat](https://llm.mlc.ai)',
          ...
          {
            'التطبيق': '[Ollama عبر Termux](https://ollama.com)',
          ...
          {
            'التطبيق': '[Private AI](https://play.google.com/store/apps/details?id=us.valkon.privateai)',
            'الرموز/ث (S25 Ultra، Phi-4 Mini)': '~13 رمز/ث (CPU)',
            'دعم NPU': 'لا',
            'الأنسب لـ': 'المستخدمون المهتمون بالخصوصية وأذونات محدودة',
          },
          {
            'التطبيق': '[PocketPal AI](https://github.com/a-ghorbani/pocketpal-ai)',
...
snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[دليل برامج LLM المحلية 2026](/ar/power-local-llm/local-llm-software-directory) — الدليل الشامل للتطبيقات بما في ذلك تطبيقات سطح المكتب وخلفيات الخادم والواجهات الأمامية لجميع المنصات.',
...
snippetBlocks: [
        ...
        rows: [
          ...
          {
            '앱': '[Ollama via Termux](https://ollama.com)',
            'tok/s(S25 Ultra, Phi-4 Mini)': '~10 tok/s(CPU)',
            'NPU 지원': '아니오(표준 Termux 빌드에서 CPU 전용)',
            '최적 사용 사례': '고급 사용자, API 접근, 도구 사용',
          },
          {
            '앱': '[Private AI](https://play.google.com/store/apps/details?id=us.valkon.privateai)',
            'tok/s(S25 Ultra, Phi-4 Mini)': '~13 tok/s(CPU)',
            'NPU 지원': '아니오',
            '최적 사용 사례': '프라이버시 우선 사용자, 최소 권한',
          },
          {
            '앱': '[PocketPal AI](https://github.com/a-ghorbani/pocketpal-ai)',
...
snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026 로컬 LLM 소프트웨어 디렉토리](/ko/power-local-llm/local-llm-software-directory) — 데스크톱 앱, 서버 백엔드, 모든 플랫폼 프론트엔드를 포함한 전체 앱 디렉토리.',
