...
export const article: Partial<Record<Language, LLMArticle>> = {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Bestes Qwen-Modell für das Coding](/de/prompt-bites/best-qwen-model-for-coding) — Qwen2.5-Coder auf Android via Termux + Ollama: Machbarkeit und Einrichtung.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Meilleur modèle Qwen pour le coding](/fr/prompt-bites/best-qwen-model-for-coding) — Qwen2.5-Coder sur Android via Termux + Ollama : faisabilité et configuration.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[コーディング向けベストQwenモデル](/ja/prompt-bites/best-qwen-model-for-coding)—Termux + OllamaでAndroid上のQwen2.5-Coder：実現可能性とセットアップ。',
        ],
      },
    },
    schema: {
  ...
  es: {
    ...
    seoTitle: 'Apps LLM local Android 2026: MLC Chat, Maid y más',
    intro:
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Mejor modelo Qwen para programación](/es/prompt-bites/best-qwen-model-for-coding) — Qwen2.5-Coder en Android via Termux + Ollama: viabilidad y configuración.',
        ],
      },
    },
    schema: {
