...
./build/bin/whisper-stream -m models/ggml-base.en.bin -t 8`,
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[faster-whisper评测](/power-local-llm/faster-whisper-review) ——基于CTranslate2的替代方案,采用同等深度评测。',
...
./build/bin/whisper-stream -m models/ggml-base.en.bin -t 8`,
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[faster-whisper 리뷰](/power-local-llm/faster-whisper-review) — CTranslate2 기반 대안을 동일한 깊이로 리뷰.',
