...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  es: {
    ...
    metaDescription:
      'Tres Mac comparados para LLMs locales: Mac Mini M5 Pro, MacBook Pro 16" M5 Max, Mac Studio. Memoria unificada, tokens/seg, consumo y precios de mayo 2026 por tamaño de modelo.',
    twitterDescription:
...
// DUPLICATE_ES_PLACEHOLDER_REMOVE_BELOW
    seoTitle: 'El mejor Mac para IA local 2026: Mini vs Studio vs MBP',
    intro:
      'La mayoría de los consejos sobre Mac para IA se centran en el nombre del chip, cuando el número que realmente determina la decisión es la memoria unificada. En Apple Silicon, el modelo vive en el mismo pool de memoria que todo lo demás: un Mac Mini de 64 GB puede correr un modelo de 34B que un MacBook Pro más rápido con 24 GB no puede cargar. Esta guía compara tres Mac para ejecutar LLM locales — el Mac Mini M5 Pro como servidor siempre encendido, el MacBook Pro 16" M5 Max como estación de trabajo portátil y el Mac Studio como opción de escritorio — en las cifras que deciden una compra: memoria unificada, ancho de banda de memoria, tokens por segundo medidos y precio. Un aviso sobre el precio: Apple subió los precios de la memoria configurada en 2026 por la misma escasez de memoria que afectó a las GPU, por lo que cada precio aquí es una instantánea de mayo de 2026. Y un aviso sobre disponibilidad: el Mac Studio M5 aún no se ha lanzado — sus especificaciones y precios a continuación son proyecciones claramente señaladas.',
    metaDescription:
      'Tres Mac comparados para LLM locales: Mac Mini M5 Pro, MacBook Pro 16" M5 Max, Mac Studio. Memoria unificada, tokens/seg, consumo y precios de mayo 2026 por tamaño de modelo.',
    twitterDescription:
      'Mac Mini M5 Pro vs MacBook Pro 16" M5 Max vs Mac Studio para IA local — tres Mac, una regla: compra por memoria unificada, luego optimiza el ancho de banda. Precios de mayo 2026.',
    affiliateDisclosure: true,
    current_models_mentioned: [
      'Llama 3.1 8B',
      'Llama 3.1 34B',
    ...
    audience:
      'Compradores que eligen un Mac específicamente para ejecutar LLM locales, decidiendo entre un servidor Mac Mini siempre encendido, un MacBook Pro portátil y un Mac Studio de escritorio. Se asume familiaridad con la cuantización y la memoria unificada como restricción, pero no con los SKU actuales de Mac.',
    readTime: '13 min de lectura',
    educationalLevel: 'Intermediate',
    primaryTerm: 'Mac para IA local',
    targetKeywords: [
      ...
      'macbook pro m5 max llm local',
      'cuanta memoria unificada para llm local',
      'mac para ejecutar llm locales',
    ],
    leadAnswerBlock:
      '**El mejor Mac para IA local es aquel cuya memoria unificada encaja con tu modelo. Un Mac Mini M5 Pro de 64 GB corre modelos de 34B, un MacBook Pro 16" M5 Max de 64 GB ejecuta modelos de 70B de forma portátil y un Mac Studio de 128 GB es la opción de escritorio para 70B con mayor calidad — aunque el Mac Studio M5 aún no está disponible.**',
    quickAnswerTop: {
      es: {
        question: '¿Qué Mac debo comprar para ejecutar LLM locales en 2026?',
        answer:
          'Compra según la memoria unificada, luego el ancho de banda. Un Mac Mini M5 Pro 64 GB (~$1,199) es la elección por relación calidad-precio y ejecuta modelos de 34B en silencio como servidor siempre encendido. Un MacBook Pro 16" M5 Max 64 GB (~$3,499) es la elección portátil y ejecuta modelos de 70B. Un Mac Studio de 128 GB es la elección de escritorio para 70B en Q5, pero el Mac Studio M5 no está disponible — el Mac Studio M4 Max se vende hoy como alternativa disponible.',
        bullets: [
          'Relación calidad-precio / servidor siempre encendido: Mac Mini M5 Pro 64 GB, ~$1,199, ejecuta modelos de 34B a 15-25 tok/s',
          'Portátil: MacBook Pro 16" M5 Max 64 GB, ~$3,499, ejecuta 70B Q4 a 7-11 tok/s',
          'Escritorio 70B: Mac Studio 128 GB — versión M5 no disponible (prevista para finales de 2026); M4 Max disponible hoy',
          'La memoria de Apple Silicon no se puede actualizar tras la compra — compra el tamaño que necesitas desde el principio',
        ],
        updatedDate: '2026-05',
      },
    },
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          '**La memoria unificada es la restricción determinante.** En Apple Silicon el modelo comparte un único pool de memoria con el sistema — un modelo que no cabe en la memoria unificada no puede ejecutarse. Elige el Mac cuya memoria encaje con tu modelo objetivo, y luego optimiza el ancho de banda y el factor de forma.',
          '**La memoria no se puede actualizar tras la compra.** La memoria unificada de Apple Silicon está soldada. Lo que compras es permanente — elige el tamaño pensando en el modelo que querrás en dos años, no solo en el de hoy.',
          '**Elección por relación calidad-precio / servidor: Mac Mini M5 Pro 64 GB (~$1,199)** — silencioso, 25-55 W bajo carga, ~$26-39/año en electricidad y 64 GB que ejecutan modelos de 34B. La entrada más económica seria a la IA local en Apple Silicon.',
          '**Elección portátil: MacBook Pro 16" M5 Max 64 GB (~$3,499)** — el único equipo M5 Max en venta, 460 GB/s de ancho de banda, ejecuta 70B Q4 a 7-11 tok/s. Acepta un throttling térmico de 10-15% bajo carga sostenida a cambio de portabilidad.',
          '**Elección de escritorio para 70B: Mac Studio 128 GB** — 614 GB/s de ancho de banda ejecuta 70B en Q5. El Mac Studio M5 no está disponible (previsto para finales de 2026); el Mac Studio M4 Max se vende hoy como alternativa disponible.',
          '**El ancho de banda, no el nombre del chip, determina la velocidad.** El M5 Max a 460-614 GB/s genera aproximadamente el doble de tokens por segundo que el M5 Pro a 307 GB/s en el mismo modelo.',
          '**Apple Silicon intercambia velocidad bruta por capacidad y silencio.** Una GPU RTX de escritorio es más rápida en modelos de 7B-13B, pero sus 24-32 GB de VRAM no pueden alojar un modelo de 70B que un Mac de 128 GB ejecuta cómodamente.',
          '**El consumo eléctrico es bajo en toda la línea.** Un Mac Mini consume 25-55 W bajo carga de LLM y un M5 Max 60-100 W — frente a 300-450 W de una tarjeta RTX de escritorio haciendo un trabajo comparable.',
        ],
      },
      quickFacts: {
        id: 'quick-facts',
        title: 'Datos rápidos',
        items: [
          '**Nivel servidor (~$999-1,399):** Mac Mini M5 Pro 64 GB — silencioso, siempre encendido, ejecuta modelos de hasta 34B.',
          '**Nivel portátil (~$3,499-4,499):** MacBook Pro 16" M5 Max 64-128 GB — ejecuta modelos de 70B en movimiento.',
          '**Nivel escritorio (~$2,000+):** Mac Studio 128 GB — ejecuta 70B en Q5; versión M5 no disponible, M4 Max se vende ahora.',
          '**Regla general de memoria unificada en Q4_K_M:** aproximadamente 0,6 GB por cada mil millones de parámetros, más 2-4 GB para contexto y herramientas.',
          '**Ancho de banda de memoria:** M5 Pro 307 GB/s, M5 Max 460 GB/s (64 GB) a 614 GB/s (128 GB) — la velocidad escala con el ancho de banda.',
          '**Rango de consumo:** Mac Mini M5 Pro 25-55 W, MacBook Pro M5 Max 60-100 W bajo carga de LLM.',
          '**Realidad de precios en 2026:** Apple subió los precios de la memoria configurada por una escasez de memoria — confirma el precio actual en Apple Store antes de comprar.',
        ],
      },
      editorsChoice: {
        id: 'editors-choice',
        ...
        sponsoredSlot: true,
        content:
          '**Para la mayoría de los compradores que eligen un Mac específicamente para IA local, el Mac Mini M5 Pro con 64 GB de memoria unificada es la elección que equilibra capacidad, precio y coste de funcionamiento.** Sus 64 GB caben todos los modelos hasta 34B con margen de contexto, funciona en silencio y consume solo 25-55 W bajo carga de inferencia, y a ~$1,199 es la entrada más económica seria a la IA local en Apple Silicon. También es un servidor de IA siempre encendido ideal para casa u oficina. Sube al MacBook Pro 16" M5 Max solo si necesitas portabilidad o modelos de 70B; sube a un Mac Studio de 128 GB solo si necesitas 70B con mayor calidad en escritorio. El Mac Studio M5 aún no está disponible, así que los compradores que quieran un escritorio 70B hoy deben elegir el Mac Studio M4 Max o esperar.',
        callouts: [
          {
            type: 'note',
            text: 'Esta elección del editor refleja solo la relación precio-capacidad. PromptQuorum no está inscrito en ningún programa de afiliados y los enlaces de abajo no llevan etiquetas de afiliado — son enlaces de referencia simples que no generan comisión.',
          },
        ],
        affiliateLinks: [
          {
      ...
      comparisonTable: {
        ...
        title: 'Cómo se comparan los tres Mac para IA local en 2026',
        content:
          'Las cifras de memoria y ancho de banda son especificaciones de Apple. Las velocidades de inferencia son valores medidos de 8B y 70B Q4 en las pruebas de Apple Silicon de PromptQuorum con el M5 Pro y el M5 Max; las cifras del Mac Studio M5 son proyecciones porque ese modelo aún no está disponible. Los precios son una instantánea de mayo de 2026 (Apple Store EE. UU.) — Apple subió los precios de la memoria configurada en 2026, así que confirma el precio actual antes de comprar.',
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: 'Para un Mac que ejecute LLM locales, la memoria unificada decide qué modelos puedes cargar y el ancho de banda de memoria decide con qué rapidez responden — compra pensando en lo primero y luego optimiza lo segundo.',
          },
          {
            type: 'plain-terms',
            text: 'Piensa en la memoria unificada como una mesa compartida que el modelo, la aplicación y el sistema usan juntos. Un chip con mayor ancho de banda despeja la mesa más rápido, pero si el modelo no cabe en la mesa, la velocidad nunca importa. Primero elige el Mac cuya mesa sea suficientemente grande.',
          },
        ],
        columns: ['Mac', 'Memoria unificada', 'Ancho de banda', 'Velocidad (8B Q4)', 'Velocidad (70B Q4)', 'Precio (mayo 2026)', 'Ideal para'],
        rows: [
          {
            ...
            'Velocidad (70B Q4)': '8-12 tok/s',
            'Precio (mayo 2026)': '~$1,199',
            'Ideal para': 'Servidor silencioso siempre encendido, modelos de 34B',
          },
          {
            'Mac': 'MacBook Pro 16" M5 Max 64 GB',
            'Memoria unificada': '64 GB',
            ...
            'Velocidad (70B Q4)': '7-11 tok/s',
            'Precio (mayo 2026)': '~$3,499',
            'Ideal para': 'Estación de trabajo portátil 70B',
          },
          {
            'Mac': 'MacBook Pro 16" M5 Max 128 GB',
            'Memoria unificada': '128 GB',
            ...
            'Velocidad (70B Q4)': '12-16 tok/s',
            'Precio (mayo 2026)': '~$4,499',
            'Ideal para': 'Portátil 70B Q5, multi-modelo',
          },
          {
            'Mac': 'Mac Studio M4 Max 128 GB',
            'Memoria unificada': '128 GB',
            'Ancho de banda': '~410-546 GB/s',
            'Velocidad (8B Q4)': 'est. a nivel de familia',
            'Velocidad (70B Q4)': 'est. a nivel de familia',
            'Precio (mayo 2026)': '~$2,000+ (configurado)',
            'Ideal para': 'Escritorio 70B, disponible hoy',
          },
          {
            ...
            'Velocidad (70B Q4)': 'aún no medible',
            'Precio (mayo 2026)': 'no anunciado',
            'Ideal para': 'Previsto para finales de 2026 — aún no a la venta',
          },
        ],
      },
      whichMac: {
        ...
        columns: ['Tu situación', 'Compra este'],
        rows: [
          { 'Tu situación': 'Quiero un servidor de IA silencioso siempre encendido para casa u oficina', 'Compra este': 'Mac Mini M5 Pro 64 GB' },
          { 'Tu situación': 'Ejecuto modelos de 8B-13B y quiero el Mac más económico con capacidad suficiente', 'Compra este': 'Mac Mini M5 Pro (32-64 GB)' },
          { 'Tu situación': 'Ejecuto modelos de 34B en un escritorio y valoro el bajo coste de funcionamiento', 'Compra este': 'Mac Mini M5 Pro 64 GB' },
          { 'Tu situación': 'Necesito ejecutar modelos de 70B y llevar el equipo conmigo', 'Compra este': 'MacBook Pro 16" M5 Max 64 GB' },
          { 'Tu situación': 'Quiero 70B en calidad Q5 y ejecutar varios modelos a la vez', 'Compra este': 'MacBook Pro 16" M5 Max 128 GB' },
          { 'Tu situación': 'Quiero un equipo de escritorio para 70B y comprarlo hoy', 'Compra este': 'Mac Studio M4 Max 128 GB' },
          { 'Tu situación': 'Quiero específicamente el Mac Studio M5', 'Compra este': 'Espera — previsto para finales de 2026, aún no disponible' },
          { 'Tu situación': 'No estoy seguro y quiero el primer Mac más seguro para IA local', 'Compra este': 'Mac Mini M5 Pro 64 GB — actualiza más tarde si se queda corto' },
        ],
      },
      macMini: {
        id: 'mac-mini',
        title: 'Mac Mini M5 Pro: el servidor silencioso siempre encendido',
        content:
          '**El Mac Mini M5 Pro es la elección por relación calidad-precio y el mejor Mac para un servidor de IA local siempre encendido — silencioso, de bajo consumo y capaz de ejecutar modelos de hasta 34B.** Para la mayoría de los usuarios que se inician en IA con Apple Silicon, la configuración de 64 GB ofrece toda la capacidad que necesitan, y su consumo de 25-55 W hace que el funcionamiento 24/7 sea económico.',
        items: [
          '**Mac Mini M5 (base, ~$599, 16 GB):** ejecuta modelos de 7B solo en Q4. Suficiente para chat ligero de un solo usuario, pero 16 GB es demasiado pequeño para un equipo de IA serio — descártalo para uso de IA.',
          '**Mac Mini M5 (~$799, 32 GB):** maneja modelos de hasta 13B en Q4. Una entrada razonable si solo ejecutas modelos pequeños, pero 32 GB se queda corto rápido.',
          '**Mac Mini M5 Pro 64 GB (~$1,199):** la elección recomendada. 307 GB/s de ancho de banda, ejecuta modelos de 8B a 50-60 tok/s y modelos de 34B a 15-25 tok/s. Memoria suficiente para ejecutar un LLM, reconocimiento de voz Whisper y un pipeline RAG al mismo tiempo.',
          '**Por qué comprar este Mac:** menor coste de entrada a la IA en Apple Silicon, funcionamiento silencioso, consumo de 25-55 W (~$26-39/año en electricidad) y una huella de ~12,7×12,7 cm que cabe en un armario como servidor.',
          '**Por qué saltarse este Mac:** no puede alojar un modelo de 70B y no es portátil. Si el 70B es tu objetivo, elige un MacBook Pro M5 Max o un Mac Studio de 128 GB.',
        ],
        callouts: [
          {
            type: 'tip',
            text: 'Compra el M5 Pro de 64 GB, no el M5 de 32 GB. La memoria adicional marca la diferencia entre quedarte en modelos de 13B y ejecutar cómodamente modelos de 34B — y la memoria de Apple Silicon no se puede añadir después.',
          },
          {
            type: 'note',
            text: 'El Mac Mini M5 Pro es un excelente servidor de IA headless: instala Ollama, expón la API en la red local y todos los dispositivos de casa podrán usarlo. Ejecutarlo 24/7 durante un año cuesta menos que un mes de suscripción a un chat en la nube.',
          },
        ],
        affiliateLinks: [
          {
      ...
      macbookPro: {
        id: 'macbook-pro',
        title: 'MacBook Pro 16" M5 Max: la estación de trabajo portátil para 70B',
        content:
          '**El MacBook Pro 16" M5 Max es el único Mac en venta que ejecuta modelos de 70B, y lo hace en un factor de forma portátil.** Es la elección para compradores que necesitan modelos de clase 70B y quieren llevar el equipo consigo. La contrapartida es un throttling térmico de 10-15% bajo inferencia sostenida y un precio más alto que un escritorio con el mismo chip.',
        items: [
          '**MacBook Pro 16" M5 Max 64 GB (~$3,499):** GPU de 32 núcleos, 460 GB/s de ancho de banda. Ejecuta modelos de 8B a ~100-110 tok/s y Llama 3.1 70B Q4 a 7-11 tok/s. El punto de entrada portátil a la IA local de 70B.',
          '**MacBook Pro 16" M5 Max 128 GB (~$4,499):** GPU de 40 núcleos, 614 GB/s de ancho de banda. Ejecuta 70B en Q5 (mayor calidad) y permite ejecutar dos modelos a la vez — por ejemplo un modelo de 70B más uno de 13B.',
          '**Por qué comprar este Mac:** necesitas modelos de 70B y portabilidad, quieres un único equipo para trabajo creativo e IA, o presentas y viajas y no puedes dejar un escritorio atrás.',
          '**Por qué saltarse este Mac:** si el equipo nunca sale del escritorio, un Mac Studio con la misma memoria cuesta menos y funciona más fresco; si los modelos de 34B son suficientes, el Mac Mini M5 Pro ahorra más de $2,000.',
        ],
        callouts: [
          {
            type: 'warning',
            text: 'El MacBook Pro 16" M5 Max reduce su rendimiento ~10-15% bajo inferencia sostenida una vez que el chasis se calienta — generalmente tras unas horas de carga continua. Para inferencia 24/7, un Mac Studio es la herramienta más adecuada; para ráfagas portátiles de trabajo con 70B, el MacBook Pro funciona bien.',
          },
          {
            type: 'note',
            text: 'El MacBook Pro M5 Max de 64 GB y el de 128 GB comparten la misma familia de chips. La versión de 128 GB compra capacidad — 70B en Q5 y modelos concurrentes — y mayor ancho de banda, no una clase diferente de equipo.',
          },
        ],
        affiliateLinks: [
          {
      ...
      macStudio: {
        ...
        title: 'Mac Studio: la opción de escritorio para 70B',
        content:
          '**El Mac Studio es la elección de escritorio para ejecutar modelos de 70B — pero el Mac Studio M5 aún no está disponible, por lo que los compradores de hoy eligen la versión M4 Max o esperan.** Un Mac Studio de 128 GB ejecuta 70B en calidad Q5 y permanece más silencioso bajo carga sostenida que un MacBook Pro, porque el chasis de escritorio no tiene el techo térmico de un portátil.',
        items: [
          '**Mac Studio M4 Max 128 GB (~$2,000+ configurado, disponible hoy):** la opción actualmente en venta. Ejecuta modelos de 70B y es la compra correcta si quieres un escritorio para 70B ahora y no quieres esperar a la actualización M5.',
          '**Mac Studio M5 Max (AÚN NO DISPONIBLE — previsto para finales de 2026):** Apple no ha anunciado el Mac Studio M5. Cualquier especificación o precio del Mac Studio M5 que veas es una proyección. Una expectativa razonable, basada en el chip M5 Max del MacBook Pro, es 128 GB de memoria unificada a ~614 GB/s de ancho de banda — pero esto no está confirmado y no hay precio.',
          '**Por qué comprar un Mac Studio:** quieres un escritorio para 70B, quieres un funcionamiento sostenido más silencioso que el MacBook Pro, o quieres un servidor de IA de escritorio compartido sin batería ni límites térmicos de portátil.',
          '**Por qué saltarse un Mac Studio:** si necesitas portabilidad, compra el MacBook Pro M5 Max; si los modelos de 34B son suficientes, el Mac Mini M5 Pro es mucho más económico; si quieres específicamente el Mac Studio M5, debes esperar hasta que se lance.',
        ],
        callouts: [
          {
            type: 'warning',
            text: 'El Mac Studio M5 no está a la venta a mayo de 2026. No pagues una prima esperando especificaciones del M5 — si necesitas un escritorio 70B hoy, el Mac Studio M4 Max se vende ahora y está verificado para ejecutar modelos de 70B.',
          },
        ],
        affiliateLinks: [
          {
      ...
      memoryNeeds: {
        ...
        title: '¿Cuánta memoria unificada necesitas?',
        content:
          '**Con cuantización Q4_K_M un modelo necesita aproximadamente 0,6 GB de memoria unificada por cada mil millones de parámetros, más 2-4 GB para contexto y herramientas — y en un Mac esa memoria también se comparte con macOS.** Deja margen para el sistema operativo: un Mac de 16 GB no tiene un presupuesto de modelo de 16 GB.',
        items: [
          '**Modelos de 8B — 8-9 GB:** caben en cualquier Mac con 16 GB o más. Un Mac de 32 GB deja un margen cómodo.',
          '**Modelos de 13-14B — 11-13 GB:** necesitan 32 GB una vez contabilizados macOS y el overhead de contexto. Mac Mini 32 GB en adelante.',
          '**Modelos de 34B — 21-25 GB:** necesitan 64 GB en la práctica. El Mac Mini M5 Pro 64 GB es la elección por relación calidad-precio aquí.',
          '**Modelos de 70B en Q4 — 39-42 GB:** necesitan 64 GB como mínimo, y 64 GB se quedan justos una vez añadido el contexto. El MacBook Pro M5 Max 64 GB es el suelo.',
          '**Modelos de 70B en Q5 o modelos concurrentes — 50-70 GB+:** necesitan 128 GB. MacBook Pro M5 Max 128 GB o un Mac Studio de 128 GB.',
        ],
        callouts: [
          {
            type: 'tip',
            text: 'La memoria de Apple Silicon está soldada y no se puede actualizar. Compra un nivel por encima de tu necesidad actual: si hoy ejecutas modelos de 34B, 64 GB es el mínimo, no la elección cómoda. Para el método completo, consulta la guía de memoria unificada en Lectura relacionada.',
          },
        ],
      },
      decisionFlowchart: {
        ...
        title: 'Diagrama de decisión: elige tu Mac en cuatro preguntas',
        content:
          '**Cuatro preguntas, en orden, llevan a la mayoría de compradores a un Mac concreto.**',
        items: [
          '**1. ¿Cuál es el modelo más grande que quieres ejecutar?** 8-13B: Mac Mini 32-64 GB. 34B: Mac Mini M5 Pro 64 GB. 70B Q4: MacBook Pro M5 Max 64 GB. 70B Q5 o concurrente: MacBook Pro 128 GB o Mac Studio.',
          '**2. ¿Necesita moverse el equipo?** Sí: MacBook Pro 16" M5 Max. No: Mac Mini (hasta 34B) o Mac Studio (70B).',
          '**3. ¿Es un servidor siempre encendido?** Sí: Mac Mini M5 Pro 64 GB — silencioso, 25-55 W, el más barato de operar 24/7. No: elige según el tamaño de modelo indicado arriba.',
          '**4. ¿Necesitas el equipo hoy?** Si quieres un escritorio para 70B ahora, compra el Mac Studio M4 Max — el Mac Studio M5 no está disponible y se espera solo para finales de 2026.',
        ],
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: 'Elige un Mac para IA local respondiendo primero al tamaño del modelo más grande, luego a la portabilidad, tercero al uso como servidor siempre encendido y por último a la disponibilidad.',
          },
          {
            type: 'plain-terms',
            text: 'Empieza por el modelo más grande que realmente quieres ejecutar y deja que eso determine la memoria que necesitas. Luego decide si tiene que viajar, si funciona las 24 horas y si puedes esperar al Mac Studio M5. Hacerlo en ese orden es la forma de evitar comprar un Mac que no puede alojar tu modelo.',
          },
        ],
      },
      whereToBuy: {
        ...
        title: 'Dónde comprar',
        content:
          '**Apple vende directamente cada configuración; Amazon y otros vendedores tienen configuraciones comunes, a veces por debajo del precio de lista de Apple.** Los enlaces de abajo son simples enlaces de búsqueda de producto; no llevan etiquetas de afiliado y no generan comisión.',
        items: [
          '**Apple Store (apple.com):** la única fuente para cada configuración de memoria y almacenamiento, incluida la personalización a pedido. Necesario si quieres una configuración no estándar.',
          '**Amazon:** tiene configuraciones fijas populares del Mac Mini y el MacBook Pro, a veces con descuento por debajo del precio de Apple. La selección de configuraciones personalizadas con mucha memoria es limitada.',
          '**Apple reacondicionado:** Mac de generación anterior (Mac Studio M4 Max, MacBook Pro más antiguos) con descuento y garantía completa — una opción sensata para un escritorio 70B hoy.',
          '**Revendedores autorizados y especializados:** tienen configuraciones comunes y ocasionalmente superan el precio de Apple; útil para el MacBook Pro 16" M5 Max.',
        ],
        callouts: [
          {
            type: 'warning',
            text: 'Apple subió los precios de la memoria configurada en 2026 por la misma escasez de memoria que afectó a las GPU. Las cifras en dólares aquí son una instantánea de mayo de 2026 — abre el listado actual de Apple Store antes de comprar y comprueba si la actualización de memoria que necesitas ha cambiado de precio.',
          },
        ],
        affiliateLinks: [
          {
      ...
      commonMistakes: {
        ...
        title: 'Errores comunes al comprar un Mac para IA local',
        items: [
          '**Comprar por el nombre del chip en lugar de por la memoria unificada.** Un M5 Max más rápido con poca memoria no puede alojar tu modelo. Confirma primero que el modelo cabe en la memoria unificada con 2-4 GB de margen, luego compara el ancho de banda.',
          '**Comprar un Mac de 16 GB para trabajo de IA.** 16 GB se agota en modelos de 7B y se comparte con macOS. Para un equipo de IA serio, 64 GB es el suelo práctico.',
          '**Olvidar que la memoria de Apple Silicon no se puede actualizar.** La memoria está soldada. Si compras de menos, la única solución es un Mac nuevo — elige un nivel por encima de tu necesidad actual.',
          '**Asumir que el Mac Studio M5 está disponible.** No está lanzado a mayo de 2026. Si un anuncio promete especificaciones del Mac Studio M5, trátalo como una proyección — compra el Mac Studio M4 Max o espera.',
          '**Comprar un MacBook Pro para un servidor fijo 24/7 en un escritorio.** Reduce el rendimiento bajo carga sostenida. Para un servidor siempre encendido, el Mac Mini M5 Pro o un Mac Studio funciona más fresco y en silencio.',
          '**Comprar de más para modelos de 8B.** Si los modelos de 8B cubren tu caso de uso, un Mac de 128 GB es dinero malgastado. Ajusta el nivel de memoria al modelo, no al presupuesto que tengas disponible.',
          '**Anclarse en los precios de Apple del año pasado.** Apple subió los precios de la memoria configurada en 2026 — haz el presupuesto con el precio en vivo de Apple Store, no con una cifra recordada.',
        ],
      },
      sources: {
        id: 'sources',
        title: 'Fuentes',
        items: [
          '[Especificaciones Apple Mac Mini](https://www.apple.com/mac-mini/specs/) — Cifras oficiales de memoria unificada, chip y consumo para la línea Mac Mini M5.',
          '[Especificaciones Apple MacBook Pro](https://www.apple.com/macbook-pro/specs/) — Cifras oficiales de memoria unificada, núcleos GPU y ancho de banda de memoria del M5 Max.',
          '[Apple Mac Studio](https://www.apple.com/mac-studio/) — Línea actual de Mac Studio y opciones de configuración (generación M4 Max a mayo de 2026).',
          '[Benchmarks LLM M5 Pro vs M5 Max 2026](/es/local-llms/m5-pro-max-llm-benchmarks-2026) — Pruebas de hardware PromptQuorum: tokens por segundo medidos para modelos de 8B y 70B en el M5 Pro y el M5 Max.',
          '[Mac Mini M5 como servidor de IA local](/es/local-llms/mac-mini-m5-local-ai-server) — Pruebas PromptQuorum: consumo, coste eléctrico y rendimiento como servidor siempre encendido del Mac Mini M5 Pro.',
        ],
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          {
            q: '¿Cuál es el Mac más económico que ejecuta bien LLM locales?',
            a: 'El Mac Mini M5 Pro 64 GB a ~$1,199 es el Mac más económico que ejecuta bien LLM locales. Sus 64 GB de memoria unificada caben todos los modelos hasta 34B en cuantización Q4, ejecuta modelos de 8B a 50-60 tokens por segundo y consume solo 25-55 W. Los modelos de Mac Mini de 16 GB y 32 GB son más baratos pero se quedan cortos rápidamente — 64 GB es el suelo práctico para uso de IA serio.',
          },
          {
            q: '¿El Mac Studio M5 ya está disponible?',
            a: 'No. A mayo de 2026 el Mac Studio M5 no está lanzado y Apple no ha anunciado especificaciones ni precio. Cualquier cifra del Mac Studio M5 que veas es una proyección. Si necesitas un Mac de escritorio para 70B hoy, el Mac Studio M4 Max se vende ahora y está verificado para ejecutar modelos de 70B; de lo contrario, el Mac Studio M5 se espera para más adelante en 2026.',
          },
          {
            q: '¿Cuánta memoria unificada necesito para LLM locales en un Mac?',
            a: 'Con cuantización Q4_K_M, calcula ~0,6 GB por cada mil millones de parámetros más 2-4 GB de overhead, y recuerda que macOS comparte el mismo pool. Eso significa unos 8-9 GB para modelos de 8B, 21-25 GB para 34B y 39-42 GB para 70B. Un Mac de 64 GB ejecuta 34B cómodamente y justo cabe 70B Q4; para 70B en Q5 o varios modelos simultáneos se necesitan 128 GB.',
          },
          {
            q: '¿Mac Mini o MacBook Pro para IA local?',
            a: 'Elige el Mac Mini M5 Pro si el equipo se queda en un escritorio y los modelos de 34B son tu techo — es mucho más económico, silencioso e ideal como servidor siempre encendido. Elige el MacBook Pro 16" M5 Max si necesitas ejecutar modelos de 70B o llevar el equipo contigo. El MacBook Pro es el único Mac en venta que ejecuta 70B, pero reduce el rendimiento bajo carga sostenida.',
          },
          {
            q: '¿Puede un Mac ejecutar modelos de 70B?',
            a: 'Sí. Un MacBook Pro 16" M5 Max con 64 GB ejecuta Llama 3.1 70B Q4 a 7-11 tokens por segundo, y la versión de 128 GB ejecuta 70B en Q5 a 8-12 tokens por segundo. Un Mac Studio de 128 GB también ejecuta 70B cómodamente. El Mac Mini M5 Pro no puede — 64 GB es demasiado justo para 70B una vez contabilizado el overhead de macOS.',
          },
          {
            q: '¿Es un Mac más rápido que una GPU NVIDIA para LLM locales?',
            a: 'No, no en velocidad bruta para modelos pequeños — una tarjeta RTX de escritorio genera más tokens por segundo en modelos de 7B-13B. La ventaja del Mac es la capacidad y la eficiencia: un Mac de 128 GB aloja un modelo de 70B que una tarjeta RTX de 24-32 GB no puede, y lo hace en silencio a 60-100 W frente a 300-450 W. Compra un Mac por capacidad, silencio y bajo coste de funcionamiento, no por velocidad bruta.',
          },
          {
            q: '¿Puedo actualizar la memoria de un Mac después?',
            a: 'No. La memoria unificada de Apple Silicon está soldada al paquete del chip y no se puede cambiar tras la compra. La memoria que compras es permanente durante la vida útil del equipo. Elige el tamaño pensando en el modelo más grande que esperas ejecutar en los próximos dos o tres años, no solo en el de hoy.',
          },
          {
            q: '¿Cuánto cuesta operar un Mac como servidor de IA?',
            a: 'Muy poco. Un Mac Mini M5 Pro consume 25-55 W bajo carga de LLM y ~8 W en reposo. Ejecutarlo 24/7 durante un año entero cuesta ~$26-39 en electricidad — menos que un mes de una suscripción típica de IA en la nube. Ese bajo coste de funcionamiento es una razón central por la que el Mac Mini es la elección por relación calidad-precio para un servidor siempre encendido.',
          },
        ],
      },
      relatedReading: {
        ...
        title: 'Lectura relacionada',
        items: [
          '[Ver el conjunto completo de benchmarks M5 Pro vs M5 Max](/es/local-llms/m5-pro-max-llm-benchmarks-2026) — tokens por segundo medidos, tiempo hasta el primer token y consumo detrás de las cifras de esta guía.',
          '[Configurar un Mac Mini M5 como servidor de IA siempre encendido](/es/local-llms/mac-mini-m5-local-ai-server) — la construcción completa del servidor, el análisis de costes eléctricos y las pruebas de fiabilidad 24/7.',
          '[Comparar Apple Silicon en toda la línea de la serie M](/es/local-llms/apple-silicon-local-llm-guide-2026) — cómo se comparan M1 hasta M5 Max en memoria unificada y ancho de banda.',
          '[Calcular cuánta memoria unificada necesita cada tamaño de modelo](/es/local-llms/how-much-unified-memory-for-local-llm) — el método completo por tamaño de modelo detrás de la fórmula rápida aquí.',
          '[Comparar Apple Silicon con GPUs NVIDIA para LLM locales](/es/power-local-llm/apple-mlx-vs-nvidia-cuda-local-llm-2026) — cuándo un Mac gana en capacidad y cuándo una tarjeta NVIDIA gana en velocidad bruta.',
        ],
      },
    },
  },
