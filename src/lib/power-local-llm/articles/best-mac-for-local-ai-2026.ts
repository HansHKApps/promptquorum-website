...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'أفضل Mac للذكاء الاصطناعي المحلي 2026: Mini مقابل Studio مقابل MBP',
    intro:
    ...
    metaDescription:
      'ثلاثة أجهزة Mac مقارنةً لنماذج LLM المحلية: Mac Mini M5 Pro، وMacBook Pro M5 Max، وMac Studio. الذاكرة الموحّدة، والرموز/ثانية، والاستهلاك، والأسعار لعام 2026.',
    twitterDescription:
