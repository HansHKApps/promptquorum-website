...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  de: {
    ...
    metaDescription:
      'Drei Macs für lokale LLMs im Vergleich: Mac Mini M5 Pro, MacBook Pro 16" M5 Max, Mac Studio. Unified Memory, Tokens/s, Stromverbrauch und Preise vom Mai 2026 nach Modellgröße.',
    twitterDescription:
    ...
    sections: {
      ...
      sources: {
        ...
        items: [
          ...
          '[M5 Pro vs. M5 Max LLM-Benchmarks 2026](/local-llms/m5-pro-max-llm-benchmarks-2026?lang=de) — PromptQuorum-Hardwaretests: gemessene Tokens pro Sekunde für 8B- und 70B-Modelle auf dem M5 Pro und dem M5 Max.',
          '[Mac Mini M5 als Server für lokale KI](/local-llms/mac-mini-m5-local-ai-server?lang=de) — PromptQuorum-Tests: Stromverbrauch, Stromkosten und Always-on-Server-Leistung des Mac Mini M5 Pro.',
        ],
      },
      faq: {
        id: 'faq',
      ...
      relatedReading: {
        ...
        items: [
          '[Den vollständigen M5 Pro vs. M5 Max Benchmark-Satz ansehen](/local-llms/m5-pro-max-llm-benchmarks-2026?lang=de) — gemessene Tokens pro Sekunde, Zeit bis zum ersten Token und Stromverbrauch hinter den Zahlen in diesem Leitfaden.',
          '[Einen Mac Mini M5 als Always-on-KI-Server einrichten](/local-llms/mac-mini-m5-local-ai-server?lang=de) — der vollständige Server-Aufbau, die Stromkostenanalyse und die 24/7-Zuverlässigkeitstests.',
          '[Apple Silicon über die gesamte M-Serie vergleichen](/local-llms/apple-silicon-local-llm-guide-2026?lang=de) — wie M1 bis M5 Max bei Unified Memory und Bandbreite abschneiden.',
          '[Ausrechnen, wie viel Unified Memory jede Modellgröße braucht](/local-llms/how-much-unified-memory-for-local-llm?lang=de) — die vollständige Methode pro Modellgröße hinter der schnellen Formel hier.',
          '[Apple Silicon gegen NVIDIA-GPUs für lokale LLMs vergleichen](/power-local-llm/apple-mlx-vs-nvidia-cuda-local-llm-2026?lang=de) — wann ein Mac bei Kapazität gewinnt und wann eine NVIDIA-Karte bei reiner Geschwindigkeit gewinnt.',
        ],
      },
    },
  },
  fr: {
    ...
    metaDescription:
      'Trois Mac comparés pour les LLM locaux : Mac mini M5 Pro, MacBook Pro 16" M5 Max, Mac Studio. Mémoire unifiée, tokens/s, consommation et prix de mai 2026 par taille de modèle.',
    twitterDescription:
    ...
    sections: {
      ...
      sources: {
        ...
        items: [
          ...
          '[Benchmarks LLM M5 Pro vs M5 Max 2026](/local-llms/m5-pro-max-llm-benchmarks-2026?lang=fr) — Tests matériels PromptQuorum : tokens par seconde mesurés pour les modèles 8B et 70B sur le M5 Pro et le M5 Max.',
          '[Le Mac mini M5 comme serveur d\'IA locale](/local-llms/mac-mini-m5-local-ai-server?lang=fr) — Tests PromptQuorum : consommation, coût d\'électricité et performance en serveur toujours actif du Mac mini M5 Pro.',
        ],
      },
      faq: {
        id: 'faq',
      ...
      relatedReading: {
        ...
        items: [
          '[Voir l\'ensemble complet des benchmarks M5 Pro vs M5 Max](/local-llms/m5-pro-max-llm-benchmarks-2026?lang=fr) — tokens par seconde mesurés, temps jusqu\'au premier token et consommation derrière les chiffres de ce guide.',
          '[Configurer un Mac mini M5 comme serveur d\'IA toujours actif](/local-llms/mac-mini-m5-local-ai-server?lang=fr) — la construction complète du serveur, l\'analyse du coût d\'électricité et les tests de fiabilité 24/7.',
          '[Comparer Apple Silicon sur toute la gamme M](/local-llms/apple-silicon-local-llm-guide-2026?lang=fr) — comment M1 à M5 Max se comparent en mémoire unifiée et bande passante.',
          '[Calculer la mémoire unifiée nécessaire à chaque taille de modèle](/local-llms/how-much-unified-memory-for-local-llm?lang=fr) — la méthode complète par taille de modèle derrière la formule rapide donnée ici.',
          '[Comparer Apple Silicon aux GPU NVIDIA pour les LLM locaux](/power-local-llm/apple-mlx-vs-nvidia-cuda-local-llm-2026?lang=fr) — quand un Mac gagne sur la capacité et quand une carte NVIDIA gagne sur la vitesse brute.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      sources: {
        ...
        items: [
          ...
          '[M5 Pro vs M5 Max LLMベンチマーク 2026](/local-llms/m5-pro-max-llm-benchmarks-2026?lang=ja) — PromptQuorumのハードウェアテスト：M5 ProとM5 Maxでの8Bおよび70Bモデルの実測tokens per second。',
          '[ローカルAIサーバーとしてのMac mini M5](/local-llms/mac-mini-m5-local-ai-server?lang=ja) — PromptQuorumのテスト：Mac mini M5 Proの消費電力、電気代、常時稼働サーバー性能。',
        ],
      },
      faq: {
        id: 'faq',
      ...
      relatedReading: {
        ...
        title: '関連記事',
        items: [
          '[M5 Pro vs M5 Maxのベンチマーク一式を見る](/local-llms/m5-pro-max-llm-benchmarks-2026?lang=ja) — 本ガイドの数値の裏にある、実測のtokens per second、最初のトークンまでの時間、消費電力。',
          '[Mac mini M5を常時稼働AIサーバーとしてセットアップする](/local-llms/mac-mini-m5-local-ai-server?lang=ja) — サーバー構築の全工程、電気代の分析、24時間365日の信頼性テスト。',
          '[Apple SiliconをMシリーズ全体で比較する](/local-llms/apple-silicon-local-llm-guide-2026?lang=ja) — M1からM5 Maxまでがunified memoryと帯域幅でどう比較されるか。',
          '[各モデルサイズに必要なunified memoryを計算する](/local-llms/how-much-unified-memory-for-local-llm?lang=ja) — ここでの簡易式の裏にある、モデルサイズ別の完全な方法。',
          '[Apple SiliconとNVIDIA GPUをローカルLLMで比較する](/power-local-llm/apple-mlx-vs-nvidia-cuda-local-llm-2026?lang=ja) — Macが容量で勝つのはいつか、NVIDIAカードが生の速度で勝つのはいつか。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      sources: {
        ...
        items: [
          ...
          '[M5 Pro vs M5 Max LLM 基准测试 2026](/local-llms/m5-pro-max-llm-benchmarks-2026?lang=zh) — PromptQuorum 硬件测试：M5 Pro 和 M5 Max 上 8B 与 70B 模型的实测每秒 token 数。',
          '[作为本地 AI 服务器的 Mac mini M5](/local-llms/mac-mini-m5-local-ai-server?lang=zh) — PromptQuorum 测试：Mac mini M5 Pro 的功耗、电费和常开服务器性能。',
        ],
      },
      faq: {
        id: 'faq',
      ...
      relatedReading: {
        ...
        title: '延伸阅读',
        items: [
          '[查看完整的 M5 Pro vs M5 Max 基准测试集](/local-llms/m5-pro-max-llm-benchmarks-2026?lang=zh) — 本指南数字背后的实测每秒 token 数、首 token 时间和功耗。',
          '[把 Mac mini M5 配置为常开 AI 服务器](/local-llms/mac-mini-m5-local-ai-server?lang=zh) — 完整的服务器搭建、电费分析和 7×24 小时可靠性测试。',
          '[在整条 M 系列产品线上对比 Apple Silicon](/local-llms/apple-silicon-local-llm-guide-2026?lang=zh) — M1 到 M5 Max 在统一内存和带宽上的对比。',
          '[算出每种模型规模需要多少统一内存](/local-llms/how-much-unified-memory-for-local-llm?lang=zh) — 本文快速公式背后按模型规模划分的完整方法。',
          '[在本地 LLM 上对比 Apple Silicon 与 NVIDIA GPU](/power-local-llm/apple-mlx-vs-nvidia-cuda-local-llm-2026?lang=zh) — Mac 何时在容量上取胜，NVIDIA 显卡何时在原始速度上取胜。',
        ],
      },
    },
  },
