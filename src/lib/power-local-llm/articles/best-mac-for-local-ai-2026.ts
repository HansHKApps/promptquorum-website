    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Apple Silicon gegen NVIDIA-GPUs für lokale LLMs vergleichen](/local-llms/apple-silicon-vs-nvidia-gpu-local-llm?lang=de) — wann ein Mac bei Kapazität gewinnt und wann eine NVIDIA-Karte bei reiner Geschwindigkeit gewinnt.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Comparer Apple Silicon aux GPU NVIDIA pour les LLM locaux](/local-llms/apple-silicon-vs-nvidia-gpu-local-llm?lang=fr) — quand un Mac gagne sur la capacité et quand une carte NVIDIA gagne sur la vitesse brute.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Apple SiliconとNVIDIA GPUをローカルLLMで比較する](/local-llms/apple-silicon-vs-nvidia-gpu-local-llm?lang=ja) — Macが容量で勝つのはいつか、NVIDIAカードが生の速度で勝つのはいつか。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[在本地 LLM 上对比 Apple Silicon 与 NVIDIA GPU](/local-llms/apple-silicon-vs-nvidia-gpu-local-llm?lang=zh) — Mac 何时在容量上取胜，NVIDIA 显卡何时在原始速度上取胜。',
        ],
      },
    },
  },
