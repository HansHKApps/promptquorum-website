...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  es: {
    ...
    sections: {
      ...
      url: 'https://www.promptquorum.com/es/es/power-local-llm/local-llm-personal-knowledge-base-2026',
      inLanguage: 'es',
  ...
  ar: {
    ...
    seoTitle: 'قاعدة معرفة بالذكاء الاصطناعي المحلي: دليل الحزمة 2026',
    intro:
    ...
    metaDescription:
      'قاعدة معرفة شخصية بالذكاء الاصطناعي المحلي 2026: مقارنة Obsidian وAnythingLLM وPython + ChromaDB. تتسع لأكثر من 100,000 عنصر. الالتقاط وRAG والمزامنة والنسخ الاحتياطي.',
    twitterDescription:
