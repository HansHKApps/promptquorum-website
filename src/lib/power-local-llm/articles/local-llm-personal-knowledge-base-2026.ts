    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/directory) — directory listings for Ollama, ChromaDB, AnythingLLM, Obsidian, and other components in the stack.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Lokales LLM Software-Verzeichnis 2026](/de/directory) — Verzeichnislisten für Ollama, ChromaDB, AnythingLLM, Obsidian und weitere Komponenten des Stacks.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Annuaire logiciels LLM local 2026](/fr/directory) — listes pour Ollama, ChromaDB, AnythingLLM, Obsidian et autres composants du stack.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[ローカルLLMソフトウェアディレクトリ 2026](/ja/directory) — Ollama、ChromaDB、AnythingLLM、Obsidian、その他のスタックコンポーネントのディレクトリリスト。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[本地 LLM 软件目录 2026](/zh/directory) — Ollama、ChromaDB、AnythingLLM、Obsidian 和技术栈其他组件的目录列表。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Directorio de software LLM local 2026](/es/directory) — listados de directorio para Ollama, ChromaDB, AnythingLLM, Obsidian y otros componentes del stack.',
        ],
      },
    },
      schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Diretório de software LLM local 2026](/pt/directory) — listagens de diretório para Ollama, ChromaDB, AnythingLLM, Obsidian e outros componentes do stack.',
        ],
      },
    },
      schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[دليل برامج LLM المحلية 2026](/ar/directory) — قوائم الدليل لـ Ollama وChromaDB وAnythingLLM وObsidian وغيرها من مكونات الحزمة.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[로컬 LLM 소프트웨어 디렉토리 2026](/ko/directory) — Ollama, ChromaDB, AnythingLLM, Obsidian 및 기타 스택 구성 요소의 디렉토리 목록.',
        ],
      },
    },
    schema: {
