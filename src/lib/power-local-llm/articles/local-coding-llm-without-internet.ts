...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  de: {
    ...
    metaDescription: 'Offline-Programmierung auf 14-Stunden-Flug getestet. Lokales LLM, gepufferte npm/pip, Devdocs, ripgrep – ~60 GB, null Netzwerkaufrufe. Pre-Flight-Checkliste enthalten.',
