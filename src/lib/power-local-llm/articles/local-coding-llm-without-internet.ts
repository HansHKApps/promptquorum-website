...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    sections: {
      ...
      modelChoice: {
        ...
        imageCaption: 'Local coding models for offline work: Qwen3-Coder 30B Q4_K_M (~18 GB, 24 GB RAM) is the recommended default; Qwen2.5-Coder 7B (~5 GB, 8 GB RAM) is the lightweight fallback at 80–85% quality; DeepSeek Coder V3 (~25 GB) for 128K-context workflows; Codestral 22B for fastest autocomplete.',
      },
      dependencyCache: {
        id: 'dependency-cache',
  ...
  es: {
    ...
    sections: {
      ...
      modelChoice: {
        ...
        imageCaption: 'Modelos locales de código para trabajo offline: Qwen3-Coder 30B Q4_K_M (~18 GB, 24 GB RAM) es el predeterminado recomendado; Qwen2.5-Coder 7B (~5 GB, 8 GB RAM) es el respaldo ligero con 80–85% de calidad; DeepSeek Coder V3 (~25 GB) para flujos de trabajo con contextos de 128K; Codestral 22B para el autocompletado más rápido.',
      },
      dependencyCache: {
        id: 'dependency-cache',
  ...
  de: {
    ...
    current_models_mentioned: ['Qwen3-Coder 30B', 'Qwen2.5-Coder 7B', 'DeepSeek Coder V3', 'Codestral 22B', 'nomic-embed-text v1.5'],
  ...
  ko: {
    ...
    sections: {
      ...
      modelChoice: {
        ...
        image: '/images/local-coding-llm-model-choice-es.svg',
        imageCaption: '오프라인 작업을 위한 로컬 코딩 모델: Qwen3-Coder 30B Q4_K_M (~18 GB, RAM 24 GB)이 기본 권장; Qwen2.5-Coder 7B (~5 GB, RAM 8 GB)는 80–85% 품질의 경량 백업; DeepSeek Coder V3 (~25 GB)는 128K 컨텍스트 워크플로우용; Codestral 22B는 가장 빠른 자동 완성용.',
      },
      dependencyCache: {
        id: 'dependency-cache',
