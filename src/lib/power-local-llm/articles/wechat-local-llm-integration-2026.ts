...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    metaDescription:
      'Connect WeChat to a local LLM in 2026. Three patterns: WeChatFerry, HTTP webhook, mini PC Ollama server. Qwen3 8B for Chinese. No cloud API.',
    twitterDescription:
      'Build a WeChat + local LLM bridge: WeChatFerry, HTTP webhook, or mini PC server. Qwen3 8B for Chinese. No cloud API required.',
    ...
    leadAnswerBlock:
      '**Connect WeChat to a local LLM by running Ollama on an always-on mini PC, then bridging WeChat messages to the Ollama HTTP API via WeChatFerry (Windows) or a webhook listener. Qwen3 8B Q4_K_M is the best model for Chinese-language WeChat chat — native CJK tokenisation, 6 GB VRAM, and 8–15 tok/s on modest hardware.**',
    quickAnswerTop: {
      en: {
        question: 'How do I connect WeChat to a local LLM?',
        answer:
          'Run Ollama on a mini PC (or localhost), install WeChatFerry to intercept WeChat PC client messages, write a Python bridge that sends messages to Ollama\'s HTTP API at localhost:11434, and return the LLM response to the chat. Qwen3 8B Q4_K_M is the recommended model for Chinese-language chat.',
        bullets: [
          ...
          'Qwen3 8B Q4_K_M: 6 GB VRAM, native CJK tokenisation, 8–15 tok/s',
      ...
      de: {
        ...
        answer:
          'Ollama auf einem Mini-PC betreiben, WeChatFerry für die Windows-WeChat-Client-Integration installieren, Python-Bridge schreiben, die Nachrichten an localhost:11434 weiterleitet, und LLM-Antworten zurück in den Chat senden. Empfohlen: Qwen3 8B Q4_K_M für chinesischen Text.',
        bullets: [
          'WeChatFerry: nur Windows, zuverlässigster Ansatz 2026',
          'Ollama HTTP API: POST an /api/generate — keine Cloud-Zugangsdaten nötig',
          'Qwen3 8B Q4_K_M: 6 GB VRAM, native CJK-Tokenisierung',
      ...
      fr: {
        ...
        answer:
          'Exécuter Ollama sur un mini PC, installer WeChatFerry pour intercepter les messages WeChat PC, écrire un bridge Python vers localhost:11434, et renvoyer les réponses du LLM dans la conversation. Modèle recommandé : Qwen3 8B Q4_K_M pour le chinois.',
        bullets: [
          ...
          'Qwen3 8B Q4_K_M : 6 Go VRAM, tokenisation CJK native',
      ...
      ja: {
        ...
        answer:
          'ミニPC上でOllamaを実行し、WeChatFerry（Windows版）でWeChatクライアントメッセージをインターセプト、Pythonブリッジでlocalhost:11434にルーティングし、LLMの応答をチャットに返します。中国語チャットにはQwen3 8B Q4_K_Mを推奨。',
        bullets: [
          'WeChatFerry：Windowsのみ、2026年で最も信頼性の高いアプローチ',
          'Ollama HTTP API：/api/generateへPOST、クラウド認証不要',
          'Qwen3 8B Q4_K_M：6 GB VRAM、ネイティブCJKトークン化',
      ...
      zh: {
        ...
        answer:
          '在迷你主机上运行Ollama，安装WeChatFerry钩入微信PC客户端，编写Python桥接脚本将消息路由至localhost:11434，并将LLM回复发回对话。中文聊天推荐Qwen3 8B Q4_K_M模型。',
        bullets: [
          'WeChatFerry：仅限Windows，2026年最可靠的微信集成方案',
          'Ollama HTTP API：POST至/api/generate，无需云端密钥',
          'Qwen3 8B Q4_K_M：6 GB显存，原生CJK分词，8–15 tok/s',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Qwen3 8B Q4_K_M: recommended for Chinese chat — 6 GB VRAM, native CJK tokenisation, 8–15 tok/s on mini PC',
      ...
      integrationPatterns: {
        ...
        imageCaption: 'WeChat + local LLM message flow: WeChatFerry hooks the WeChat PC client, a Python bridge forwards messages to Ollama at localhost:11434, and Qwen3 8B Q4_K_M returns a reply in 2–5 seconds — entirely on local hardware with zero cloud API calls.',
      },
      wechatferry: {
        id: 'wechatferry',
        title: 'WeChatFerry Setup: Step-by-Step',
        numberedItems: [
          'Install the WeChat PC 3.9.12.x build that matches your WeChatFerry release on Windows — WeChatFerry hooks specific 3.9.x builds and does not support the current WeChat 4.x client',
          ...
          'In the message loop, POST to Ollama: `requests.post("http://localhost:11434/api/generate", json={"model":"qwen3:8b","prompt":msg.content})`',
...
while True:
    ...
    if msg and msg.from_self() is False:
      ...
      modelChoice: {
        ...
        content: [
          '**Qwen3 8B Q4_K_M (Top Pick):** Built by Alibaba with native CJK tokenisation. 6 GB VRAM, 8–15 tok/s. Understands Chinese idioms, classical references, and colloquial phrasing far better than Western-first models. Install: `ollama pull qwen3:8b`.',
          ...
          '**DeepSeek-R1-0528-Qwen3-8B:** Good for question-answering and step-by-step explanations in Chinese. Slightly weaker at casual conversation than Qwen3 8B.',
        ...
        imageCaption: 'Chinese text tokenization by model: Qwen3 8B needs 42 tokens for a 50-character sentence versus 98 for Llama 3 and 115 for Mistral — native CJK tokenisation cuts token count by 2.3–2.7×.',
      },
      groupChat: {
        id: 'group-chat',
      ...
      privacy: {
        ...
        content: [
          ...
          '**Note for EU readers:** GDPR Article 28 requires data processor agreements. Running local LLMs avoids the need for a DPA with any LLM vendor — a compliance simplification.',
        ],
      },
      faqSection: {
        id: 'faq',
        ...
        faqs: [
            ...
            { q: 'Which Ollama model is best for Chinese text?', a: 'Qwen3 8B Q4_K_M. Built by Alibaba with native CJK tokenisation — 30–40% more efficient on Chinese text than Llama or Mistral models.' },
            { q: 'Can I run this on a laptop?', a: 'Yes. A 16 GB RAM laptop runs Qwen3 8B comfortably at 8–15 tok/s CPU-only. Response latency is 3–8 seconds per message — acceptable for chat.' },
            ...
            { q: 'Does WeChatFerry support WeChat 4.x?', a: 'No. WeChatFerry hooks specific WeChat PC 3.9.12.x builds only. The WeChat 4.x client uses a rewritten architecture with no stable hook, so keep the matching 3.9.12.x build installed on the bot machine and disable WeChat auto-updates.' },
          ],
      },
      relatedReading: {
        ...
        items: [
          ...
          '[Local AI Behind a Firewall / Offline 2026](/power-local-llm/local-ai-behind-firewall-offline-2026) — air-gapped Ollama: network isolation, audit logging, and no-internet setup',
          '[Best Qwen Model for Coding](/prompt-bites/best-qwen-model-for-coding) — picking the right Qwen3-Coder size for WeChat bot integrations',
        ],
      },
    },
    schema: {
      ...
      mentions: [
        ...
        { '@type': 'SoftwareApplication', name: 'Qwen3 8B' },
      ],
    ...
    faqSchema: {
      ...
      mainEntity: [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Qwen3 8B Q4_K_M. Built by Alibaba with native CJK tokenisation — 30–40% more efficient on Chinese text than Llama or Mistral models.',
            },
          },
          {
            '@type': 'Question',
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Yes. A 16 GB RAM laptop runs Qwen3 8B comfortably at 8–15 tok/s CPU-only. Response latency is 3–8 seconds per message — acceptable for chat.',
            },
          },
          {
            '@type': 'Question',
          ...
          {
            '@type': 'Question',
            'name': 'Does WeChatFerry support WeChat 4.x?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'No. WeChatFerry hooks specific WeChat PC 3.9.12.x builds only. The WeChat 4.x client uses a rewritten architecture with no stable hook, so keep the matching 3.9.12.x build installed on the bot machine and disable WeChat auto-updates.',
            },
          },
        ],
    },
  ...
  de: {
    ...
    seoTitle: 'WeChat mit lokalem LLM verbinden 2026: Ollama-API',
    intro:
    ...
    metaDescription:
      'WeChat mit lokalem LLM verbinden 2026: WeChatFerry (Windows), HTTP-Webhook-Brücke, Mini-PC-Ollama-Server. Qwen3 8B für Chinesisch. Keine Cloud-API.',
    twitterDescription:
      'WeChat + lokales LLM: WeChatFerry, HTTP-Webhook oder Mini-PC-Server. Qwen3 8B für Chinesisch. Keine Cloud-API erforderlich.',
    gammaEmbedUrl: '/presentations/wechat-local-llm-integration-2026-static.html',
    ...
    leadAnswerBlock:
      '**WeChat mit einem lokalen LLM verbinden: Ollama auf einem Mini-PC betreiben, WeChatFerry für die Windows-PC-Client-Integration installieren und eine Python-Brücke zur Ollama HTTP-API schreiben. Empfohlen: Qwen3 8B Q4_K_M für chinesische Konversationen – 6 GB VRAM, native CJK-Tokenisierung.**',
    quickAnswerTop: {
      en: {
        question: 'How do I connect WeChat to a local LLM?',
        answer: 'Run Ollama on a mini PC, install WeChatFerry to intercept WeChat PC client messages, write a Python bridge to localhost:11434, and return LLM responses to the chat. Qwen3 8B Q4_K_M is recommended for Chinese.',
        bullets: ['WeChatFerry: Windows-only, most reliable 2026', 'Ollama HTTP API: POST to /api/generate', 'Qwen3 8B Q4_K_M: 6 GB VRAM, CJK native'],
        updatedDate: '2026-09',
      },
      de: {
        question: 'Wie verbinde ich WeChat mit einem lokalen LLM?',
        answer: 'Ollama auf Mini-PC, WeChatFerry installieren, Python-Brücke zu localhost:11434, LLM-Antwort zurücksenden. Qwen3 8B Q4_K_M für Chinesisch.',
        bullets: ['WeChatFerry: nur Windows, zuverlässigster Ansatz', 'Ollama HTTP API: POST an /api/generate', 'Qwen3 8B Q4_K_M: 6 GB VRAM, CJK-nativ'],
        updatedDate: '2026-09',
      },
      fr: { question: 'Comment connecter WeChat à un LLM local ?', answer: 'Ollama sur mini PC, WeChatFerry, bridge Python vers localhost:11434, réponse renvoyée dans le chat.', bullets: ['WeChatFerry : Windows uniquement', 'Qwen3 8B Q4_K_M recommandé'], updatedDate: '2026-09' },
      ja: { question: 'WeChatをローカルLLMに接続するには？', answer: 'ミニPCでOllamaを実行、WeChatFerryでメッセージをインターセプト、Python経由でlocalhost:11434にルーティング。', bullets: ['WeChatFerry：Windows専用', 'Qwen3 8B Q4_K_M推奨'], updatedDate: '2026-09' },
      zh: { question: '如何将微信连接到本地LLM？', answer: '在迷你主机运行Ollama，安装WeChatFerry，Python脚本路由至localhost:11434。', bullets: ['WeChatFerry：仅限Windows', 'Qwen3 8B Q4_K_M推荐'], updatedDate: '2026-09' },
    },
    snippetBlocks: [
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Qwen3 8B Q4_K_M: empfohlen für chinesischen Chat – 6 GB VRAM, native CJK-Tokenisierung, 8–15 tok/s',
      ...
      integrationPatterns: {
        ...
        image: '/images/wechat-local-llm-integration-2026-architecture-flow-en.svg',
        imageCaption: 'WeChat + lokales LLM Nachrichtenfluss: WeChatFerry hakt in den WeChat-PC-Client ein, eine Python-Brücke leitet Nachrichten an Ollama unter localhost:11434 weiter, und Qwen3 8B Q4_K_M liefert die Antwort in 2–5 Sekunden – vollständig auf lokaler Hardware, ohne Cloud-API-Aufrufe.',
      },
      wechatferry: {
        id: 'wechatferry',
        title: 'WeChatFerry-Setup: Schritt für Schritt',
        numberedItems: [
          'Den zur WeChatFerry-Version passenden WeChat-PC-Build 3.9.12.x auf Windows installieren – WeChatFerry hakt in bestimmte 3.9.x-Builds ein und unterstützt den aktuellen WeChat-4.x-Client nicht',
          ...
          'In der Nachrichtenschleife an Ollama senden: `requests.post("http://localhost:11434/api/generate", json={"model":"qwen3:8b","prompt":msg.content})`',
          'Antwort senden: `wcf.send_text(response["response"], msg.roomid or msg.sender)`',
          'Mit einer persönlichen Nachricht testen; die Antwort sollte innerhalb von 2–5 Sekunden in WeChat erscheinen',
        ],
        codeBlock: `import requests
from wcferry import Wcf
...
while True:
    ...
    if msg and msg.from_self() is False:
      ...
      ollamaBridge: {
        ...
        content: [
          ...
          '**Modelle auflisten:** `GET /api/tags` — gibt alle installierten Modelle mit ihrer Größe zurück',
      ...
      modelChoice: {
        ...
        content: [
          '**Qwen3 8B Q4_K_M (Erste Wahl):** Von Alibaba mit nativer CJK-Tokenisierung entwickelt. 6 GB VRAM, 8–15 tok/s. Versteht chinesische Redewendungen und umgangssprachliche Formulierungen weit besser als westliche Modelle. Installation: `ollama pull qwen3:8b`.',
          '**Qwen3 14B Q4_K_M:** Für komplexere Unterhaltungen mit 12–16 GB RAM. 9,5 GB VRAM, 4–8 tok/s.',
          '**DeepSeek-R1-0528-Qwen3-8B:** Gut für Fragenbeantwortung und schrittweise Erklärungen auf Chinesisch. In lockerer Konversation etwas schwächer als Qwen3 8B.',
          '**Vermeiden:** Llama 3 und Mistral – westliche Tokenizer verwenden 2–3× mehr Token für chinesischen Text.',
        ],
        image: '/images/wechat-local-llm-integration-2026-cjk-tokenization-efficiency-en.svg',
        imageCaption: 'Chinesische Texttokenisierung nach Modell: Qwen3 8B benötigt 42 Token für einen 50-Zeichen-Satz gegenüber 98 bei Llama 3 und 115 bei Mistral – native CJK-Tokenisierung senkt die Tokenanzahl um 2,3–2,7×.',
      },
      groupChat: {
        id: 'group-chat',
        ...
        content: [
          ...
          'Ratenbegrenzung: WeChat kann Konten drosseln, die mehr als ~30 Nachrichten pro Minute senden. In Gruppenkontexten 2–3 Sekunden Verzögerung zwischen Bot-Antworten einplanen.',
      ...
      faqSection: {
        ...
        faqs: [
            ...
            { q: 'Welches Ollama-Modell ist am besten für chinesischen Text?', a: 'Qwen3 8B Q4_K_M von Alibaba – native CJK-Tokenisierung, 30–40 % effizienter bei chinesischem Text als Llama oder Mistral.' },
            { q: 'Kann ich dies auf einem Laptop betreiben?', a: 'Ja. Ein 16 GB RAM Laptop betreibt Qwen3 8B mit 8–15 tok/s (CPU-only). Antwortlatenz: 3–8 Sekunden.' },
            ...
            { q: 'Unterstützt WeChatFerry WeChat 4.x?', a: 'Nein. WeChatFerry hakt ausschließlich in bestimmte WeChat-PC-Builds 3.9.12.x ein. Der WeChat-4.x-Client hat eine neu geschriebene Architektur ohne stabilen Hook – auf dem Bot-Rechner den passenden 3.9.12.x-Build behalten und automatische Updates deaktivieren.' },
          ],
      },
      relatedReading: {
        ...
        items: [
          ...
          '[Zapier durch lokale KI-Agenten ersetzen](/de/power-local-llm/replace-zapier-with-local-ai-agents) — Automatisierungs-Workflows, ausgelöst durch WeChat-Ereignisse',
          '[Lokale KI hinter der Firewall / offline 2026](/de/power-local-llm/local-ai-behind-firewall-offline-2026) — Air-Gap-Ollama: Netzwerkisolation, Audit-Logs und Setup ohne Internet',
          '[Bestes Qwen-Modell fürs Coding](/de/prompt-bites/best-qwen-model-for-coding) — die richtige Qwen3-Coder-Größe für WeChat-Bot-Integrationen',
        ],
      },
    },
    schema: {
    ...
    faqSchema: {
      ...
      mainEntity: [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Qwen3 8B Q4_K_M von Alibaba – native CJK-Tokenisierung, 30–40 % effizienter bei chinesischem Text als Llama oder Mistral.',
            },
          },
          {
            '@type': 'Question',
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Ja. Ein 16 GB RAM Laptop betreibt Qwen3 8B mit 8–15 tok/s (CPU-only). Antwortlatenz: 3–8 Sekunden.',
            },
          },
          {
            '@type': 'Question',
          ...
          {
            '@type': 'Question',
            'name': 'Unterstützt WeChatFerry WeChat 4.x?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Nein. WeChatFerry hakt ausschließlich in bestimmte WeChat-PC-Builds 3.9.12.x ein. Der WeChat-4.x-Client hat eine neu geschriebene Architektur ohne stabilen Hook – auf dem Bot-Rechner den passenden 3.9.12.x-Build behalten und automatische Updates deaktivieren.',
            },
          },
        ],
    },
  ...
  fr: {
    ...
    metaDescription:
      'Connecter WeChat à un LLM local en 2026 : WeChatFerry (Windows), pont HTTP webhook, serveur mini PC Ollama. Qwen3 8B pour le chinois. Sans API cloud.',
    twitterDescription:
      'WeChat + LLM local : WeChatFerry, webhook HTTP ou serveur mini PC. Qwen3 8B pour le chinois. Aucune API cloud.',
    gammaEmbedUrl: '/presentations/wechat-local-llm-integration-2026-static.html',
    ...
    quickAnswerTop: {
      en: { question: 'How to connect WeChat to a local LLM?', answer: 'WeChatFerry + Ollama on Windows mini PC.', bullets: ['WeChatFerry: Windows only', 'Qwen3 8B recommended'], updatedDate: '2026-09' },
      de: { question: 'WeChat mit lokalem LLM verbinden?', answer: 'WeChatFerry + Ollama auf Windows Mini-PC.', bullets: ['WeChatFerry: nur Windows', 'Qwen3 8B empfohlen'], updatedDate: '2026-09' },
      fr: {
        question: 'Comment connecter WeChat à un LLM local ?',
        ...
        bullets: ['WeChatFerry : Windows uniquement, solution la plus fiable 2026', 'API HTTP Ollama : POST vers /api/generate sans clé cloud', 'Qwen3 8B Q4_K_M : 6 Go VRAM, tokenisation CJK native'],
        updatedDate: '2026-09',
      },
      ja: { question: 'WeChatをローカルLLMに接続するには？', answer: 'WeChatFerry + Ollama on Windows。', bullets: ['WeChatFerry：Windows専用', 'Qwen3 8B推奨'], updatedDate: '2026-09' },
      zh: { question: '如何将微信连接到本地LLM？', answer: 'WeChatFerry + Ollama在Windows迷你主机上。', bullets: ['WeChatFerry：仅限Windows', 'Qwen3 8B推荐'], updatedDate: '2026-09' },
    },
    snippetBlocks: [
    ...
    sections: {
      ...
      integrationPatterns: {
        ...
        image: '/images/wechat-local-llm-integration-2026-architecture-flow-en.svg',
        imageCaption: 'Flux de message WeChat + LLM local : WeChatFerry intercepte le client WeChat PC, un pont Python transmet les messages à Ollama sur localhost:11434, et Qwen3 8B Q4_K_M renvoie une réponse en 2–5 secondes — entièrement sur matériel local, sans appel API cloud.',
      },
      wechatferry: {
        id: 'wechatferry',
...
while True:
    ...
    if msg and msg.from_self() is False:
      ...
      modelChoice: {
        ...
        image: '/images/wechat-local-llm-integration-2026-cjk-tokenization-efficiency-en.svg',
        imageCaption: 'Tokenisation du texte chinois par modèle : Qwen3 8B a besoin de 42 tokens pour une phrase de 50 caractères contre 98 pour Llama 3 et 115 pour Mistral — la tokenisation CJK native réduit le nombre de tokens de 2,3–2,7×.',
      },
      groupChat: {
        id: 'group-chat',
      ...
      faqSection: {
        ...
        faqs: [
            ...
            { q: 'Quel modèle Ollama pour le chinois ?', a: 'Qwen3 8B Q4_K_M — tokenisation CJK native, 30–40% plus efficace que Llama ou Mistral.' },
            { q: 'Puis-je utiliser un laptop ?', a: 'Oui. 16 Go RAM suffit pour Qwen3 8B en mode CPU-only, 8–15 tok/s.' },
            ...
            { q: 'WeChatFerry prend-il en charge WeChat 4.x ?', a: 'Non. WeChatFerry cible uniquement des builds WeChat PC 3.9.12.x précis. Le client WeChat 4.x repose sur une architecture réécrite sans hook stable : conservez le build 3.9.12.x correspondant sur la machine du bot et désactivez les mises à jour automatiques.' },
          ],
      },
      relatedReading: {
        ...
        items: [
          ...
          '[Remplacer Zapier par des agents IA locaux](/fr/power-local-llm/replace-zapier-with-local-ai-agents) — automatisations déclenchées par des événements WeChat',
          '[IA locale derrière un pare-feu / hors ligne 2026](/fr/power-local-llm/local-ai-behind-firewall-offline-2026) — Ollama en air gap : isolation réseau, journaux d\'audit et installation sans internet',
          '[Meilleur modèle Qwen pour le code](/fr/prompt-bites/best-qwen-model-for-coding) — choisir la bonne taille de Qwen3-Coder pour les intégrations de bot WeChat',
        ],
      },
    },
    schema: {
    ...
    faqSchema: {
      ...
      mainEntity: [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Qwen3 8B Q4_K_M — tokenisation CJK native, 30–40% plus efficace que Llama ou Mistral.',
            },
          },
          {
            '@type': 'Question',
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Oui. 16 Go RAM suffit pour Qwen3 8B en mode CPU-only, 8–15 tok/s.',
            },
          },
          {
            '@type': 'Question',
          ...
          {
            '@type': 'Question',
            'name': 'WeChatFerry prend-il en charge WeChat 4.x ?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Non. WeChatFerry cible uniquement des builds WeChat PC 3.9.12.x précis. Le client WeChat 4.x repose sur une architecture réécrite sans hook stable : conservez le build 3.9.12.x correspondant sur la machine du bot et désactivez les mises à jour automatiques.',
            },
          },
        ],
    },
  ...
  ja: {
    ...
    metaDescription:
      '2026年版WeChat統合ガイド：WeChatFerry（Windows）、HTTPウェブフック、ミニPCサーバーの3パターンを詳解。中国語チャットはQwen3 8B推奨。クラウドAPI不要で会話データを完全ローカル保持。',
    twitterDescription:
      'WeChat + ローカルLLM：WeChatFerry、HTTPウェブフック、ミニPCサーバー。Qwen3 8B中国語対応。クラウドAPI不要。',
    gammaEmbedUrl: '/presentations/wechat-local-llm-integration-2026-static.html',
    readTime: '11分で読める',
    educationalLevel: 'Intermediate',
    ...
    quickAnswerTop: {
      en: { question: 'How to connect WeChat to local LLM?', answer: 'WeChatFerry + Ollama on Windows.', bullets: ['WeChatFerry: Windows only', 'Qwen3 8B recommended'], updatedDate: '2026-09' },
      de: { question: 'WeChat mit lokalem LLM verbinden?', answer: 'WeChatFerry + Ollama auf Windows.', bullets: ['WeChatFerry: nur Windows'], updatedDate: '2026-09' },
      fr: { question: 'Connecter WeChat au LLM local ?', answer: 'WeChatFerry + Ollama sur Windows.', bullets: ['WeChatFerry : Windows seulement'], updatedDate: '2026-09' },
      ja: {
      ...
      zh: { question: '如何连接微信和本地LLM？', answer: 'WeChatFerry + Ollama在Windows上。', bullets: ['WeChatFerry：仅Windows'], updatedDate: '2026-09' },
    },
    snippetBlocks: [
    ...
    sections: {
      ...
      integrationPatterns: {
        ...
        image: '/images/wechat-local-llm-integration-2026-architecture-flow-en.svg',
        imageCaption: 'WeChat + ローカルLLMのメッセージフロー：WeChatFerryがWeChat PCクライアントをフックし、PythonブリッジがlocalhostのOllama（11434）にメッセージを転送、Qwen3 8B Q4_K_Mが2〜5秒で応答を返します——すべてローカルハードウェア上で、クラウドAPI呼び出しは一切なし。',
      },
      wechatferry: {
        id: 'wechatferry',
...
while True:
    ...
    if msg and msg.from_self() is False:
      ...
      ollamaBridge: {
        ...
        content: [
          ...
          'WeChat統合では、コンテキスト維持のためローリング履歴（直近10件）付きで`/api/chat`の使用を推奨します。',
        ],
      },
      miniPcServer: {
        id: 'mini-pc-server',
      ...
      modelChoice: {
        ...
        image: '/images/wechat-local-llm-integration-2026-cjk-tokenization-efficiency-en.svg',
        imageCaption: 'モデル別の中国語テキストのトークン化：Qwen3 8Bは50文字の文に42トークンで済むのに対し、Llama 3は98トークン、Mistralは115トークンが必要——ネイティブCJKトークン化によりトークン数を2.3〜2.7倍削減。',
      },
      groupChat: {
        id: 'group-chat',
        title: 'グループチャット対応',
      ...
      faqSection: {
        ...
        faqs: [
            ...
            { q: '中国語向け最適Ollamaモデルは？', a: 'Qwen3 8B Q4_K_M。Alibabaがネイティブ中国語処理向けに開発、6 GB VRAM。' },
            { q: 'ノートパソコンで使えますか？', a: 'はい。16 GBのRAMでQwen3 8BをCPU-onlyで8〜15 tok/sで実行可能。応答遅延3〜8秒。' },
            ...
            { q: 'WeChatFerryはWeChat 4.xに対応していますか？', a: 'いいえ。WeChatFerryがフックするのは特定のWeChat PC 3.9.12.xビルドのみです。WeChat 4.x系はアーキテクチャが刷新され安定したフックがないため、ボット用PCでは対応する3.9.12.xビルドを維持し、自動アップデートを無効化してください。' },
          ],
      },
      relatedReading: {
        title: '関連記事',
        items: [
          ...
          '[ZapierをローカルAIエージェントで置き換える](/ja/power-local-llm/replace-zapier-with-local-ai-agents) — WeChatイベントでトリガーする自動化ワークフロー',
          '[ファイアウォール内・オフラインのローカルAI 2026](/ja/power-local-llm/local-ai-behind-firewall-offline-2026) — エアギャップOllama：ネットワーク分離、監査ログ、インターネット不要のセットアップ',
          '[コーディングに最適なQwenモデル](/ja/prompt-bites/best-qwen-model-for-coding) — WeChatボット統合に適したQwen3-Coderサイズの選び方',
        ],
      },
    },
    schema: {
    ...
    faqSchema: {
      ...
      mainEntity: [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Qwen3 8B Q4_K_M。Alibabaがネイティブ中国語処理向けに開発、6 GB VRAM。',
            },
          },
          {
            '@type': 'Question',
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'はい。16 GBのRAMでQwen3 8BをCPU-onlyで8〜15 tok/sで実行可能。応答遅延3〜8秒。',
            },
          },
          {
            '@type': 'Question',
          ...
          {
            '@type': 'Question',
            'name': 'WeChatFerryはWeChat 4.xに対応していますか？',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'いいえ。WeChatFerryがフックするのは特定のWeChat PC 3.9.12.xビルドのみです。WeChat 4.x系はアーキテクチャが刷新され安定したフックがないため、ボット用PCでは対応する3.9.12.xビルドを維持し、自動アップデートを無効化してください。',
            },
          },
        ],
    },
  ...
  zh: {
    ...
    metaDescription:
      '2026年微信接入本地大模型三种路线：WeChatFerry钩子自动回复、HTTP Webhook桥接、迷你主机Ollama服务器。中文对话推荐Qwen3 8B Q4_K_M，符合《数据安全法》，数据不离开本地设备。',
    twitterDescription:
      '微信 + 本地LLM：WeChatFerry、HTTP Webhook或迷你主机服务器。Qwen3 8B中文最优。无需云端API。',
    gammaEmbedUrl: '/presentations/wechat-local-llm-integration-2026-static.html',
    readTime: '11分钟阅读',
    educationalLevel: 'Intermediate',
    ...
    leadAnswerBlock:
      '**将微信接入本地LLM：在迷你主机上运行Ollama，安装WeChatFerry钩入微信PC客户端，编写Python桥接脚本将消息路由至Ollama HTTP API。中文聊天推荐Qwen3 8B Q4_K_M——6 GB显存，原生CJK分词，8–15 tok/s。**',
    quickAnswerTop: {
      en: { question: 'How to integrate WeChat with local LLM?', answer: 'WeChatFerry + Ollama on Windows mini PC.', bullets: ['WeChatFerry: Windows only', 'Qwen3 8B recommended'], updatedDate: '2026-09' },
      de: { question: 'WeChat mit lokalem LLM?', answer: 'WeChatFerry + Ollama auf Windows Mini-PC.', bullets: ['WeChatFerry: nur Windows'], updatedDate: '2026-09' },
      fr: { question: 'Intégrer WeChat avec LLM local ?', answer: 'WeChatFerry + Ollama sur Windows.', bullets: ['WeChatFerry : Windows seulement'], updatedDate: '2026-09' },
      ja: { question: 'WeChatとローカルLLM統合方法？', answer: 'WeChatFerry + Ollamaを使用。', bullets: ['WeChatFerry：Windows専用'], updatedDate: '2026-09' },
      zh: {
        ...
        bullets: [
          ...
          'Qwen3 8B Q4_K_M：6 GB显存，原生中文分词，速度8–15 tok/s',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Qwen3 8B Q4_K_M：中文聊天首选——6 GB显存，原生中文分词，8–15 tok/s',
      ...
      integrationPatterns: {
        ...
        imageCaption: '微信+本地LLM消息流转：WeChatFerry钩入微信PC客户端，Python桥接脚本将消息转发至localhost:11434的Ollama，Qwen3 8B Q4_K_M在2–5秒内返回回复——全程在本地硬件运行，零云端API调用。',
      },
      wechatferry: {
        id: 'wechatferry',
        title: 'WeChatFerry配置：分步指南',
        numberedItems: [
          '在Windows上安装与你的WeChatFerry版本匹配的微信PC 3.9.12.x客户端——WeChatFerry仅钩入特定3.9.x版本，不支持当前的微信4.x客户端',
          ...
          '在消息循环中调用Ollama：`requests.post("http://localhost:11434/api/generate", json={"model":"qwen3:8b","prompt":msg.content})`',
...
while True:
    ...
    if msg and msg.from_self() is False:
      ...
      modelChoice: {
        ...
        title: '微信中文聊天最佳模型',
        content: [
          '**Qwen3 8B Q4_K_M（首选）：** 阿里巴巴开发，原生中文分词。6 GB显存，8–15 tok/s。能理解中文成语、口语和表达，远优于西方优先模型。安装：`ollama pull qwen3:8b`。',
          '**Qwen3 14B Q4_K_M：** 适合拥有12–16 GB内存的设备，对话质量明显提升，多轮推理更强。',
          '**DeepSeek-R1-0528-Qwen3-8B：** 中文问答和推理表现良好，日常对话略弱于Qwen3 8B。',
        ...
        imageCaption: '各模型中文文本分词对比：Qwen3 8B处理50字句子仅需42个token，而Llama 3需要98个、Mistral需要115个——原生中文分词将token数量减少2.3–2.7倍。',
      },
      groupChat: {
        id: 'group-chat',
        title: '群聊处理',
      ...
      faqSection: {
        ...
        faqs: [
            ...
            { q: '微信中文聊天最推荐哪个Ollama模型？', a: 'Qwen3 8B Q4_K_M。阿里巴巴开发的原生中文分词模型，处理中文比Llama或Mistral效率高30–40%。' },
            { q: '可以在笔记本电脑上运行吗？', a: '可以。16 GB内存的笔记本以纯CPU运行Qwen3 8B，速度约8–15 tok/s，每条消息响应延迟3–8秒，可接受用于聊天场景。' },
            ...
            { q: 'WeChatFerry支持微信4.x吗？', a: '不支持。WeChatFerry只钩入特定的微信PC 3.9.12.x版本。微信4.x客户端架构重写后没有稳定的钩子——请在机器人电脑上保留匹配的3.9.12.x版本并关闭自动更新。' },
          ],
      },
      relatedReading: {
        title: '相关阅读',
    ...
    faqSchema: {
      ...
      mainEntity: [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Qwen3 8B Q4_K_M。阿里巴巴开发的原生中文分词模型，处理中文比Llama或Mistral效率高30–40%。',
            },
          },
          {
            '@type': 'Question',
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': '可以。16 GB内存的笔记本以纯CPU运行Qwen3 8B，速度约8–15 tok/s，每条消息响应延迟3–8秒，可接受用于聊天场景。',
            },
          },
          {
            '@type': 'Question',
          ...
          {
            '@type': 'Question',
            'name': 'WeChatFerry支持微信4.x吗？',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': '不支持。WeChatFerry只钩入特定的微信PC 3.9.12.x版本。微信4.x客户端架构重写后没有稳定的钩子——请在机器人电脑上保留匹配的3.9.12.x版本并关闭自动更新。',
            },
          },
        ],
    },
  ...
  es: {
    ...
    metaDescription:
      'Conecta WeChat a un LLM local en 2026. Tres patrones: WeChatFerry, HTTP webhook, servidor Ollama en mini PC. Qwen3 8B para chino. Sin API en la nube.',
    twitterDescription:
      'Crea un puente WeChat + LLM local: WeChatFerry, HTTP webhook o servidor mini PC. Qwen3 8B para chino. Sin API en la nube.',
    gammaEmbedUrl: '/presentations/wechat-local-llm-integration-2026-static.html',
    ...
    leadAnswerBlock:
      '**Conecta WeChat a un LLM local ejecutando Ollama en un mini PC siempre activo, luego enruta los mensajes de WeChat a la API HTTP de Ollama mediante WeChatFerry (Windows) o un listener de webhook. Qwen3 8B Q4_K_M es el mejor modelo para chats en chino en WeChat: tokenización CJK nativa, 6 GB de VRAM y 8–15 tok/s en hardware modesto.**',
    quickAnswerTop: {
      es: {
        question: '¿Cómo conecto WeChat a un LLM local?',
        answer:
          'Ejecuta Ollama en un mini PC (o en localhost), instala WeChatFerry para interceptar los mensajes del cliente WeChat PC, escribe un puente Python que envíe los mensajes a la API HTTP de Ollama en localhost:11434 y devuelve la respuesta del LLM al chat. Qwen3 8B Q4_K_M es el modelo recomendado para chats en chino.',
        bullets: [
          'WeChatFerry: hook de WeChat solo para Windows; el enfoque más fiable para 2026',
          'API HTTP de Ollama: POST a /api/generate — sin credenciales de nube',
          'Qwen3 8B Q4_K_M: 6 GB de VRAM, tokenización CJK nativa, 8–15 tok/s',
          'Servidor mini PC: el Minisforum UM890 Pro funciona 24/7 a ~35 W',
          'Privacidad: cero datos transmitidos a servidores de WeChat o a cualquier API de LLM',
        ],
        updatedDate: '2026-09',
      },
      de: {
        question: 'Wie verbinde ich WeChat mit einem lokalen LLM?',
        answer:
          'Ollama auf einem Mini-PC betreiben, WeChatFerry installieren, Python-Brücke zu localhost:11434, LLM-Antwort zurücksenden. Qwen3 8B Q4_K_M für Chinesisch.',
        bullets: [
          'WeChatFerry: nur Windows, zuverlässigster Ansatz',
          'Ollama HTTP API: POST an /api/generate',
          'Qwen3 8B Q4_K_M: 6 GB VRAM, CJK-nativ',
        ],
        updatedDate: '2026-09',
      },
      fr: { question: 'Comment connecter WeChat à un LLM local ?', answer: 'Ollama sur mini PC, WeChatFerry, bridge Python vers localhost:11434, réponse renvoyée dans le chat.', bullets: ['WeChatFerry : Windows uniquement', 'Qwen3 8B Q4_K_M recommandé'], updatedDate: '2026-09' },
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Qwen3 8B Q4_K_M: recomendado para chats en chino — 6 GB de VRAM, tokenización CJK nativa, 8–15 tok/s en mini PC',
      ...
      integrationPatterns: {
        ...
        image: '/images/wechat-local-llm-integration-2026-architecture-flow-en.svg',
        imageCaption: 'Flujo de mensajes WeChat + LLM local: WeChatFerry intercepta el cliente WeChat PC, un puente Python reenvía los mensajes a Ollama en localhost:11434, y Qwen3 8B Q4_K_M devuelve una respuesta en 2–5 segundos — todo en hardware local, sin llamadas a APIs en la nube.',
      },
      wechatferry: {
        id: 'wechatferry',
        title: 'Configuración de WeChatFerry: paso a paso',
        numberedItems: [
          'Instala en Windows la build 3.9.12.x de WeChat PC que corresponda a tu versión de WeChatFerry — WeChatFerry intercepta builds 3.9.x específicas y no es compatible con el cliente WeChat 4.x actual',
          ...
          'En el bucle de mensajes, haz POST a Ollama: `requests.post("http://localhost:11434/api/generate", json={"model":"qwen3:8b","prompt":msg.content})`',
...
while True:
    ...
    if msg and msg.from_self() is False:
      ...
      modelChoice: {
        ...
        content: [
          '**Qwen3 8B Q4_K_M (Primera opción):** Desarrollado por Alibaba con tokenización CJK nativa. 6 GB de VRAM, 8–15 tok/s. Entiende modismos chinos, referencias clásicas y frases coloquiales mucho mejor que los modelos centrados en Occidente. Instalación: `ollama pull qwen3:8b`.',
          ...
          '**DeepSeek-R1-0528-Qwen3-8B:** Bueno para responder preguntas y explicaciones paso a paso en chino. Ligeramente más débil en conversación casual que Qwen3 8B.',
        ...
        image: '/images/wechat-local-llm-integration-2026-cjk-tokenization-efficiency-en.svg',
        imageCaption: 'Tokenización de texto en chino por modelo: Qwen3 8B necesita 42 tokens para una frase de 50 caracteres frente a 98 de Llama 3 y 115 de Mistral — la tokenización CJK nativa reduce el recuento de tokens 2,3–2,7×.',
      },
      groupChat: {
        id: 'group-chat',
      ...
      privacy: {
        ...
        content: [
          ...
          '**Nota para lectores en España/LATAM:** El RGPD Artículo 28 exige acuerdos con encargados del tratamiento. En Latinoamérica, leyes como la LFPDPPP (México) o la Ley 25.326 (Argentina) siguen la misma lógica. Ejecutar LLMs locales evita la necesidad de un DPA con cualquier proveedor de LLM — una simplificación de cumplimiento significativa.',
        ],
      },
      faqSection: {
        id: 'faq',
        ...
        faqs: [
            ...
            { q: '¿Qué modelo de Ollama es mejor para texto en chino?', a: 'Qwen3 8B Q4_K_M. Desarrollado por Alibaba con tokenización CJK nativa — entre un 30–40% más eficiente con texto en chino que los modelos Llama o Mistral.' },
            { q: '¿Puedo ejecutar esto en un portátil?', a: 'Sí. Un portátil con 16 GB de RAM ejecuta Qwen3 8B cómodamente a 8–15 tok/s solo con CPU. La latencia de respuesta es de 3–8 segundos por mensaje, aceptable para chat.' },
            ...
            { q: '¿WeChatFerry es compatible con WeChat 4.x?', a: 'No. WeChatFerry solo intercepta builds específicas 3.9.12.x de WeChat PC. El cliente WeChat 4.x usa una arquitectura reescrita sin hook estable: mantén instalada la build 3.9.12.x correspondiente en el equipo del bot y desactiva las actualizaciones automáticas.' },
          ],
      },
      relatedReading: {
        ...
        items: [
          ...
          '[IA local tras un firewall / sin conexión 2026](/es/power-local-llm/local-ai-behind-firewall-offline-2026) — Ollama aislado: aislamiento de red, registros de auditoría y configuración sin internet',
          '[Mejor modelo Qwen para programar](/es/prompt-bites/best-qwen-model-for-coding) — elegir el tamaño correcto de Qwen3-Coder para integraciones de bots de WeChat',
        ],
      },
    },
    schema: {
    ...
    faqSchema: {
      ...
      mainEntity: [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Qwen3 8B Q4_K_M. Desarrollado por Alibaba con tokenización CJK nativa — entre un 30–40% más eficiente con texto en chino que los modelos Llama o Mistral.',
            },
          },
          {
            '@type': 'Question',
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Sí. Un portátil con 16 GB de RAM ejecuta Qwen3 8B cómodamente a 8–15 tok/s solo con CPU. La latencia de respuesta es de 3–8 segundos por mensaje, aceptable para chat.',
            },
          },
          {
            '@type': 'Question',
          ...
          {
            '@type': 'Question',
            'name': '¿WeChatFerry es compatible con WeChat 4.x?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'No. WeChatFerry solo intercepta builds específicas 3.9.12.x de WeChat PC. El cliente WeChat 4.x usa una arquitectura reescrita sin hook estable: mantén instalada la build 3.9.12.x correspondiente en el equipo del bot y desactiva las actualizaciones automáticas.',
            },
          },
        ],
    },
  ...
  ko: {
    ...
    metaDescription:
      '2026년 WeChat을 로컬 LLM에 연결하기. 세 가지 패턴: WeChatFerry, HTTP webhook, 미니 PC Ollama 서버. 중국어에는 Qwen3 8B. 클라우드 API 없음.',
    twitterDescription:
      'WeChat + 로컬 LLM 브리지 만들기: WeChatFerry, HTTP webhook 또는 미니 PC 서버. 중국어에는 Qwen3 8B. 클라우드 API 없음.',
    gammaEmbedUrl: '/presentations/wechat-local-llm-integration-2026-static.html',
    readTime: '11분 분량',
    educationalLevel: 'Intermediate',
    ...
    leadAnswerBlock:
      '**항상 켜져 있는 미니 PC에서 Ollama를 실행한 후 WeChatFerry(Windows) 또는 webhook 리스너를 통해 WeChat 메시지를 Ollama HTTP API로 라우팅하여 WeChat을 로컬 LLM에 연결하십시오. Qwen3 8B Q4_K_M은 WeChat에서 중국어 채팅에 최고의 모델입니다: 네이티브 CJK 토큰화, 6 GB VRAM, 적당한 하드웨어에서 8–15 tok/s.**',
    quickAnswerTop: {
      ko: {
        question: 'WeChat을 로컬 LLM에 어떻게 연결합니까?',
        answer:
          '미니 PC(또는 localhost)에서 Ollama를 실행하고, WeChatFerry를 설치하여 WeChat PC 클라이언트 메시지를 인터셉트하고, localhost:11434의 Ollama HTTP API로 메시지를 전송하는 Python 브리지를 작성하고, LLM 응답을 채팅으로 반환하십시오. 중국어 채팅에는 Qwen3 8B Q4_K_M을 권장합니다.',
        bullets: [
          'WeChatFerry: Windows 전용 WeChat 훅; 2026년 가장 신뢰할 수 있는 접근 방식',
          'Ollama HTTP API: /api/generate에 POST — 클라우드 자격증명 불필요',
          'Qwen3 8B Q4_K_M: 6 GB VRAM, 네이티브 CJK 토큰화, 8–15 tok/s',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Qwen3 8B Q4_K_M: 중국어 채팅에 권장 — 6 GB VRAM, 네이티브 CJK 토큰화, 미니 PC에서 8–15 tok/s',
      ...
      integrationPatterns: {
        ...
        image: '/images/wechat-local-llm-integration-2026-architecture-flow-en.svg',
        imageCaption: 'WeChat + 로컬 LLM 메시지 흐름: WeChatFerry가 WeChat PC 클라이언트를 인터셉트하고, Python 브리지가 localhost:11434의 Ollama로 메시지를 전달하며, Qwen3 8B Q4_K_M이 2–5초 만에 응답을 반환합니다 — 전부 로컬 하드웨어에서, 클라우드 API 호출 없이.',
      },
      wechatferry: {
        id: 'wechatferry',
        title: 'WeChatFerry 설정: 단계별',
        numberedItems: [
          '사용 중인 WeChatFerry 릴리스에 맞는 WeChat PC 3.9.12.x 빌드를 Windows에 설치합니다 — WeChatFerry는 특정 3.9.x 빌드만 후킹하며 현재의 WeChat 4.x 클라이언트는 지원하지 않습니다',
          ...
          '메시지 루프에서 Ollama에 POST: `requests.post("http://localhost:11434/api/generate", json={"model":"qwen3:8b","prompt":msg.content})`',
...
while True:
    ...
    if msg and msg.from_self() is False:
      ...
      modelChoice: {
        ...
        content: [
          '**Qwen3 8B Q4_K_M(첫 번째 선택):** Alibaba가 네이티브 CJK 토큰화로 개발했습니다. 6 GB VRAM, 8–15 tok/s. 서구 중심 모델보다 중국어 관용어, 고전적 참조, 구어체를 훨씬 잘 이해합니다. 설치: `ollama pull qwen3:8b`.',
          '**Qwen3 14B Q4_K_M:** 12–16 GB RAM의 미니 PC가 있을 때 더 풍부한 대화를 위해. 9.5 GB VRAM, 4–8 tok/s. 중국어 미묘한 추론과 다중 턴 컨텍스트에서 현저히 더 나음.',
          '**DeepSeek-R1-0528-Qwen3-8B:** 중국어 질문 답변 및 단계별 설명에 좋음. 캐주얼 대화에서 Qwen3 8B보다 약간 약함.',
          '**피해야 할 것:** Llama 3과 Mistral — 서구 중심 토크나이저가 중국어 텍스트에 2–3배 더 많은 토큰을 사용하여 더 느린 응답과 긴 메시지에서 잘림이 발생합니다.',
        ],
        image: '/images/wechat-local-llm-integration-2026-cjk-tokenization-efficiency-en.svg',
        imageCaption: '모델별 중국어 텍스트 토큰화: Qwen3 8B는 50자 문장에 42개 토큰이 필요한 반면 Llama 3는 98개, Mistral은 115개가 필요합니다 — 네이티브 CJK 토큰화로 토큰 수를 2.3–2.7배 줄입니다.',
      },
      groupChat: {
        id: 'group-chat',
        title: '그룹 채팅 처리',
      ...
      privacy: {
        ...
        content: [
          ...
          '**한국 독자를 위한 참고:** 개인정보 보호법(PIPA)은 개인정보 처리를 위탁할 때 위탁 계약과 관리·감독 의무를 요구합니다. 로컬 LLM을 실행하면 클라우드 LLM 공급업체에 대한 처리 위탁 자체가 발생하지 않으므로, 개인정보보호위원회(PIPC) 기준의 준수가 크게 단순해집니다.',
        ],
      },
      faqSection: {
        id: 'faq',
        ...
        faqs: [
            ...
            { q: 'WeChat에서 중국어 텍스트에 가장 좋은 Ollama 모델은 무엇입니까?', a: 'Qwen3 8B Q4_K_M. 네이티브 CJK 토큰화로 Alibaba가 개발했습니다 — 중국어 텍스트에서 Llama나 Mistral 모델보다 30–40% 더 효율적입니다.' },
            { q: '노트북에서 이것을 실행할 수 있습니까?', a: '네. 16 GB RAM의 노트북은 CPU 전용으로 Qwen3 8B를 8–15 tok/s로 편안하게 실행합니다. 메시지당 응답 지연은 3–8초로 채팅에서 허용 가능합니다.' },
            ...
            { q: 'WeChatFerry가 WeChat 4.x를 지원합니까?', a: '아니요. WeChatFerry는 특정 WeChat PC 3.9.12.x 빌드만 후킹합니다. WeChat 4.x 클라이언트는 아키텍처가 재작성되어 안정적인 후킹이 없으므로, 봇 PC에는 맞는 3.9.12.x 빌드를 유지하고 자동 업데이트를 비활성화하십시오.' },
          ],
      },
      relatedReading: {
        title: '관련 읽을거리',
        items: [
          ...
          '[방화벽 뒤 / 오프라인 로컬 AI 2026](/ko/power-local-llm/local-ai-behind-firewall-offline-2026) — 에어갭 Ollama: 네트워크 격리, 감사 로그, 인터넷 없는 설정',
          '[코딩에 가장 좋은 Qwen 모델](/ko/prompt-bites/best-qwen-model-for-coding) — WeChat 봇 통합에 맞는 Qwen3-Coder 크기 선택',
        ],
      },
    },
    schema: {
    ...
    faqSchema: {
      ...
      mainEntity: [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Qwen3 8B Q4_K_M. 네이티브 CJK 토큰화로 Alibaba가 개발했습니다 — 중국어 텍스트에서 Llama나 Mistral 모델보다 30–40% 더 효율적입니다.',
            },
          },
          {
            '@type': 'Question',
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': '네. 16 GB RAM의 노트북은 CPU 전용으로 Qwen3 8B를 8–15 tok/s로 편안하게 실행합니다. 메시지당 응답 지연은 3–8초로 채팅에서 허용 가능합니다.',
            },
          },
          {
            '@type': 'Question',
          ...
          {
            '@type': 'Question',
            'name': 'WeChatFerry가 WeChat 4.x를 지원합니까?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': '아니요. WeChatFerry는 특정 WeChat PC 3.9.12.x 빌드만 후킹합니다. WeChat 4.x 클라이언트는 아키텍처가 재작성되어 안정적인 후킹이 없으므로, 봇 PC에는 맞는 3.9.12.x 빌드를 유지하고 자동 업데이트를 비활성화하십시오.',
            },
          },
        ],
    },
  ...
  pt: {
    ...
    metaDescription:
      'Conecte o WeChat a um LLM local em 2026. Três padrões: WeChatFerry, HTTP webhook, servidor Ollama em mini PC. Qwen3 8B para chinês. Sem API de nuvem.',
    twitterDescription:
      'Crie uma ponte WeChat + LLM local: WeChatFerry, HTTP webhook ou servidor mini PC. Qwen3 8B para chinês. Sem API de nuvem.',
    gammaEmbedUrl: '/presentations/wechat-local-llm-integration-2026-static.html',
    ...
    quickAnswerTop: {
      pt: {
        ...
        bullets: [
          ...
          'Qwen3 8B Q4_K_M: 6 GB VRAM, tokenização CJK nativa, 8–15 tok/s',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Qwen3 8B Q4_K_M: recomendado para chats em chinês — 6 GB de VRAM, tokenização CJK nativa, 8–15 tok/s em mini PC',
      ...
      integrationPatterns: {
        ...
        image: '/images/wechat-local-llm-integration-2026-architecture-flow-en.svg',
        imageCaption: 'Fluxo de mensagens WeChat + LLM local: o WeChatFerry intercepta o cliente WeChat PC, uma ponte Python encaminha as mensagens ao Ollama em localhost:11434, e o Qwen3 8B Q4_K_M devolve uma resposta em 2–5 segundos — tudo em hardware local, sem chamadas a APIs de nuvem.',
      },
      wechatferry: {
        id: 'wechatferry',
        title: 'Configuração do WeChatFerry: passo a passo',
        numberedItems: [
          'Instale no Windows a build 3.9.12.x do WeChat PC correspondente à sua versão do WeChatFerry — o WeChatFerry intercepta builds 3.9.x específicas e não é compatível com o cliente WeChat 4.x atual',
          ...
          'No loop de mensagens, faça POST para o Ollama: `requests.post("http://localhost:11434/api/generate", json={"model":"qwen3:8b","prompt":msg.content})`',
...
while True:
    ...
    if msg and msg.from_self() is False:
      ...
      modelChoice: {
        ...
        content: [
          '**Qwen3 8B Q4_K_M (Primeira escolha):** Desenvolvido pela Alibaba com tokenização CJK nativa. 6 GB de VRAM, 8–15 tok/s. Entende expressões idiomáticas chinesas, referências clássicas e frases coloquiais muito melhor que os modelos centrados no Ocidente. Instalação: `ollama pull qwen3:8b`.',
          ...
          '**DeepSeek-R1-0528-Qwen3-8B:** Bom para responder perguntas e explicações passo a passo em chinês. Ligeiramente mais fraco em conversa casual que o Qwen3 8B.',
        ...
        image: '/images/wechat-local-llm-integration-2026-cjk-tokenization-efficiency-en.svg',
        imageCaption: 'Tokenização de texto chinês por modelo: o Qwen3 8B precisa de 42 tokens para uma frase de 50 caracteres, contra 98 do Llama 3 e 115 do Mistral — a tokenização CJK nativa reduz a contagem de tokens em 2,3–2,7×.',
      },
      groupChat: {
        id: 'group-chat',
      ...
      faqSection: {
        ...
        faqs: [
            ...
            { q: 'Qual modelo do Ollama é melhor para texto em chinês?', a: 'Qwen3 8B Q4_K_M. Desenvolvido pela Alibaba com tokenização CJK nativa — entre 30–40% mais eficiente com texto em chinês que os modelos Llama ou Mistral.' },
            { q: 'Posso rodar isso em um laptop?', a: 'Sim. Um laptop com 16 GB de RAM roda o Qwen3 8B confortavelmente a 8–15 tok/s apenas com CPU. A latência de resposta é de 3–8 segundos por mensagem, aceitável para chat.' },
            ...
            { q: 'O WeChatFerry é compatível com o WeChat 4.x?', a: 'Não. O WeChatFerry intercepta apenas builds específicas 3.9.12.x do WeChat PC. O cliente WeChat 4.x usa uma arquitetura reescrita sem hook estável: mantenha instalada a build 3.9.12.x correspondente na máquina do bot e desative as atualizações automáticas.' },
          ],
      },
      relatedReading: {
        ...
        items: [
          ...
          '[IA local atrás de firewall / offline 2026](/pt/power-local-llm/local-ai-behind-firewall-offline-2026) — Ollama isolado: isolamento de rede, logs de auditoria e configuração sem internet',
          '[Melhor modelo Qwen para programação](/pt/prompt-bites/best-qwen-model-for-coding) — escolhendo o tamanho certo do Qwen3-Coder para integrações de bot do WeChat',
        ],
      },
    },
    schema: {
      ...
      url: 'https://www.promptquorum.com/pt/power-local-llm/wechat-local-llm-integration-2026',
      inLanguage: 'pt-BR',
      author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      datePublished: '2026-05-26',
    ...
    faqSchema: {
      ...
      mainEntity: [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Qwen3 8B Q4_K_M. Desenvolvido pela Alibaba com tokenização CJK nativa — entre 30–40% mais eficiente com texto em chinês que os modelos Llama ou Mistral.',
            },
          },
          {
            '@type': 'Question',
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Sim. Um laptop com 16 GB de RAM roda o Qwen3 8B confortavelmente a 8–15 tok/s apenas com CPU. A latência de resposta é de 3–8 segundos por mensagem, aceitável para chat.',
            },
          },
          {
            '@type': 'Question',
          ...
          {
            '@type': 'Question',
            'name': 'O WeChatFerry é compatível com o WeChat 4.x?',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Não. O WeChatFerry intercepta apenas builds específicas 3.9.12.x do WeChat PC. O cliente WeChat 4.x usa uma arquitetura reescrita sem hook estável: mantenha instalada a build 3.9.12.x correspondente na máquina do bot e desative as atualizações automáticas.',
            },
          },
        ],
    },
  ...
  ar: {
    ...
    metaDescription:
      '3 أنماط لربط WeChat بنموذج LLM محلي: WeChatFerry على Windows، جسر HTTP webhook، وخادم Ollama على mini PC. Qwen3 8B موصى به للمحادثات بالصينية.',
    twitterDescription:
      'أنشئ جسرًا بين WeChat ونموذج لغة محلي: WeChatFerry أو HTTP webhook أو mini PC. Qwen3 8B للغة الصينية. بدون API سحابية.',
    gammaEmbedUrl: '/presentations/wechat-local-llm-integration-2026-static.html',
    ...
    leadAnswerBlock:
      '**اربط WeChat بنموذج لغة محلي عبر تشغيل Ollama على mini PC دائم التشغيل، ثم وجّه رسائل WeChat إلى HTTP API لـ Ollama عبر WeChatFerry (Windows) أو مستمع webhook. Qwen3 8B Q4_K_M هو أفضل نموذج للمحادثات باللغة الصينية في WeChat: ترميز CJK أصلي، 6 GB VRAM، و8–15 رمز/ثانية على أجهزة متواضعة.**',
    quickAnswerTop: {
      ar: {
        question: 'كيف أربط WeChat بنموذج لغة محلي؟',
        answer:
          'شغّل Ollama على mini PC (أو localhost)، وثبّت WeChatFerry لاعتراض رسائل عميل WeChat PC، واكتب جسر Python يرسل الرسائل إلى HTTP API لـ Ollama على localhost:11434، ثم يُعيد رد النموذج إلى المحادثة. Qwen3 8B Q4_K_M هو النموذج الموصى به للمحادثات باللغة الصينية.',
        bullets: [
          ...
          'Qwen3 8B Q4_K_M: 6 GB VRAM، ترميز CJK أصلي، 8–15 رمز/ثانية',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Qwen3 8B Q4_K_M: موصى به للمحادثات باللغة الصينية — 6 GB VRAM، ترميز CJK أصلي، 8–15 رمز/ثانية على mini PC',
      ...
      integrationPatterns: {
        ...
        image: '/images/wechat-local-llm-integration-2026-architecture-flow-en.svg',
        imageCaption: 'مسار الرسائل بين WeChat ونموذج لغة محلي: يعترض WeChatFerry عميل WeChat PC، ويُعيد جسر Python توجيه الرسائل إلى Ollama على localhost:11434، ويُعيد Qwen3 8B Q4_K_M الرد خلال 2–5 ثوانٍ — كل ذلك على أجهزة محلية دون أي استدعاءات API سحابية.',
      },
      wechatferry: {
        id: 'wechatferry',
        title: 'إعداد WeChatFerry: خطوة بخطوة',
        numberedItems: [
          'ثبّت على Windows إصدار WeChat PC 3.9.12.x المطابق لإصدار WeChatFerry لديك — يعترض WeChatFerry إصدارات 3.9.x محددة فقط ولا يدعم عميل WeChat 4.x الحالي',
          ...
          'في حلقة الرسائل، أرسل POST إلى Ollama: `requests.post("http://localhost:11434/api/generate", json={"model":"qwen3:8b","prompt":msg.content})`',
...
while True:
    ...
    if msg and msg.from_self() is False:
      ...
      modelChoice: {
        ...
        content: [
          '**Qwen3 8B Q4_K_M (الخيار الأول):** طوّرته Alibaba بترميز CJK أصلي. 6 GB VRAM، 8–15 رمز/ثانية. يفهم الأمثال الصينية والمراجع الكلاسيكية والعبارات العامية أفضل بكثير من النماذج ذات التوجه الغربي. التثبيت: `ollama pull qwen3:8b`.',
          ...
          '**DeepSeek-R1-0528-Qwen3-8B:** جيد للإجابة عن الأسئلة والشروحات خطوة بخطوة باللغة الصينية. أضعف قليلًا في المحادثة العادية مقارنةً بـ Qwen3 8B.',
        ...
        image: '/images/wechat-local-llm-integration-2026-cjk-tokenization-efficiency-en.svg',
        imageCaption: 'ترميز النص الصيني حسب النموذج: يحتاج Qwen3 8B إلى 42 رمزًا لجملة من 50 حرفًا مقابل 98 لـ Llama 3 و115 لـ Mistral — يقلّل الترميز الأصلي لـ CJK عدد الرموز بمقدار 2.3–2.7×.',
      },
      groupChat: {
        id: 'group-chat',
      ...
      privacy: {
        ...
        content: [
          ...
          '**ملاحظة للقراء في الخليج:** تفرض أنظمة حماية البيانات الإقليمية، مثل نظام حماية البيانات الشخصية السعودي (PDPL) وقانون حماية البيانات الإماراتي، قيودًا على نقل البيانات خارج الحدود. يُبقي تشغيل النماذج اللغوية محليًا بيانات الاستدلال داخل حدودك الوطنية دون الحاجة إلى اتفاقية معالجة بيانات مع أي مزود سحابي — تبسيط امتثال كبير.',
        ],
      },
      faqSection: {
        id: 'faq',
        ...
        faqs: [
            ...
            { q: 'ما أفضل نموذج Ollama للنص الصيني؟', a: 'Qwen3 8B Q4_K_M. طوّرته Alibaba بترميز CJK أصلي — أكثر كفاءة بـ 30–40% مع النص الصيني مقارنةً بنماذج Llama أو Mistral.' },
            { q: 'هل يمكنني تشغيل هذا على كمبيوتر محمول؟', a: 'نعم. يشغّل كمبيوتر محمول بـ 16 GB RAM نموذج Qwen3 8B بشكل مريح بـ 8–15 رمز/ثانية على المعالج فقط. كمون الرد 3–8 ثوانٍ لكل رسالة، وهو مقبول للمحادثة.' },
            ...
            { q: 'هل يدعم WeChatFerry إصدار WeChat 4.x؟', a: 'لا. يعترض WeChatFerry إصدارات محددة فقط من WeChat PC 3.9.12.x. يعتمد عميل WeChat 4.x على بنية مُعاد كتابتها دون ربط مستقر — أبقِ الإصدار 3.9.12.x المطابق مثبتًا على جهاز البوت وعطّل التحديثات التلقائية.' },
          ],
      },
      relatedReading: {
        title: 'قراءة ذات صلة',
        items: [
          ...
          '[ذكاء اصطناعي محلي خلف جدار الحماية / دون اتصال 2026](/ar/power-local-llm/local-ai-behind-firewall-offline-2026) — Ollama معزول: عزل الشبكة وسجلات التدقيق والإعداد دون إنترنت',
          '[أفضل نموذج Qwen للبرمجة](/ar/prompt-bites/best-qwen-model-for-coding) — اختيار حجم Qwen3-Coder المناسب لتكاملات بوت WeChat',
        ],
      },
    },
    schema: {
    ...
    faqSchema: {
      ...
      mainEntity: [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Qwen3 8B Q4_K_M. طوّرته Alibaba بترميز CJK أصلي — أكثر كفاءة بـ 30–40% مع النص الصيني مقارنةً بنماذج Llama أو Mistral.',
            },
          },
          {
            '@type': 'Question',
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'نعم. يشغّل كمبيوتر محمول بـ 16 GB RAM نموذج Qwen3 8B بشكل مريح بـ 8–15 رمز/ثانية على المعالج فقط. كمون الرد 3–8 ثوانٍ لكل رسالة، وهو مقبول للمحادثة.',
            },
          },
          {
            '@type': 'Question',
          ...
          {
            '@type': 'Question',
            'name': 'هل يدعم WeChatFerry إصدار WeChat 4.x؟',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'لا. يعترض WeChatFerry إصدارات محددة فقط من WeChat PC 3.9.12.x. يعتمد عميل WeChat 4.x على بنية مُعاد كتابتها دون ربط مستقر — أبقِ الإصدار 3.9.12.x المطابق مثبتًا على جهاز البوت وعطّل التحديثات التلقائية.',
            },
          },
        ],
    },
