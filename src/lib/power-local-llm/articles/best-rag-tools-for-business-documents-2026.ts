  ...
  en: {
    ...
    sections: {
      ...
      scorecard: {
        ...
        columns: ['Tool', 'Link', 'No-code', 'Multi-user', 'Document handling', 'Best for'],
        rows: [
          { Tool: 'AnythingLLM', 'Link': '[anythingllm.com](https://anythingllm.com)', 'No-code': 'Yes', 'Multi-user': 'Yes (workspaces)', 'Document handling': '9/10', 'Best for': 'Most business teams' },
          { Tool: 'RAGFlow', 'Link': '[ragflow.io](https://ragflow.io)', 'No-code': 'Yes', 'Multi-user': 'Yes', 'Document handling': '9.5/10', 'Best for': 'Tables, scans, complex layouts' },
          { Tool: 'PrivateGPT', 'Link': '[GitHub](https://github.com/zylon-ai/private-gpt)', 'No-code': 'Basic UI', 'Multi-user': 'No', 'Document handling': '7/10', 'Best for': 'Strict offline/air-gapped use' },
          { Tool: 'Open WebUI', 'Link': '[openwebui.com](https://openwebui.com)', 'No-code': 'Yes', 'Multi-user': 'Yes', 'Document handling': '8/10', 'Best for': 'Existing Ollama users' },
          { Tool: 'Dify', 'Link': '[dify.ai](https://dify.ai)', 'No-code': 'Yes (visual builder)', 'Multi-user': 'Yes', 'Document handling': '8/10', 'Best for': 'AI application workflows' },
          { Tool: 'LlamaIndex', 'Link': '[llamaindex.ai](https://www.llamaindex.ai)', 'No-code': 'No (Python SDK)', 'Multi-user': 'Custom', 'Document handling': '9.5/10', 'Best for': 'Custom developer pipelines' },
        ],
      ...
      comparison: {
        ...
        columns: ['Tool', 'Link', 'Category', 'No-code UI', 'Multi-user', 'Local LLM', 'License'],
        rows: [
          { Tool: 'AnythingLLM', 'Link': '[anythingllm.com](https://anythingllm.com)', Category: 'A — Application', 'No-code UI': 'Yes', 'Multi-user': 'Yes (workspaces)', 'Local LLM': 'Ollama, LM Studio', License: 'MIT' },
          { Tool: 'RAGFlow', 'Link': '[ragflow.io](https://ragflow.io)', Category: 'A — Application', 'No-code UI': 'Yes', 'Multi-user': 'Yes', 'Local LLM': 'Ollama and others', License: 'Apache 2.0' },
          { Tool: 'PrivateGPT', 'Link': '[GitHub](https://github.com/zylon-ai/private-gpt)', Category: 'A — Application', 'No-code UI': 'Basic UI', 'Multi-user': 'No', 'Local LLM': 'Ollama, llama.cpp', License: 'Apache 2.0' },
          { Tool: 'Open WebUI', 'Link': '[openwebui.com](https://openwebui.com)', Category: 'A — Application', 'No-code UI': 'Yes', 'Multi-user': 'Yes', 'Local LLM': 'Ollama-native', License: 'BSD-3' },
          { Tool: 'Dify', 'Link': '[dify.ai](https://dify.ai)', Category: 'B — App builder', 'No-code UI': 'Yes (visual)', 'Multi-user': 'Yes', 'Local LLM': 'Ollama and others', License: 'Apache 2.0 (partial)' },
          { Tool: 'LlamaIndex', 'Link': '[llamaindex.ai](https://www.llamaindex.ai)', Category: 'C — Framework', 'No-code UI': 'No (Python SDK)', 'Multi-user': 'Custom', 'Local LLM': 'Ollama, llama.cpp', License: 'MIT' },
          { Tool: 'Chroma', 'Link': '[trychroma.com](https://www.trychroma.com)', Category: 'C — Vector DB', 'No-code UI': 'No (API)', 'Multi-user': 'Yes (server mode)', 'Local LLM': 'N/A', License: 'Apache 2.0' },
          { Tool: 'Qdrant', 'Link': '[qdrant.tech](https://qdrant.tech)', Category: 'C — Vector DB', 'No-code UI': 'No (API)', 'Multi-user': 'Yes', 'Local LLM': 'N/A', License: 'Apache 2.0' },
          { Tool: 'Weaviate', 'Link': '[weaviate.io](https://weaviate.io)', Category: 'C — Vector DB', 'No-code UI': 'No (API)', 'Multi-user': 'Yes', 'Local LLM': 'N/A', License: 'BSD-3' },
        ],
      },
      decisionTree: {
        id: 'decision-tree',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[txtai Review 2026: The Embedded Vector Database That Skips the Server](/power-local-llm/txtai-embedded-vector-database-review) — for developers who want RAG built into one Python library instead of a separate document-chat platform.',
          ...
          '[Haystack Review: deepset\'s RAG Framework vs. LangChain and LlamaIndex](/power-local-llm/haystack-deepset-rag-framework-review) — a code-first Python framework built around explicit Pipeline and Component abstractions, for teams that want RAG as a measurable engineering problem.',
  ...
  de: {
    ...
    sections: {
      ...
      scorecard: {
        ...
        columns: ['Tool', 'Link', 'Ohne Code', 'Multi-User', 'Dokumentenverarbeitung', 'Am besten für'],
        rows: [
          { Tool: 'AnythingLLM', 'Link': '[anythingllm.com](https://anythingllm.com)', 'Ohne Code': 'Ja', 'Multi-User': 'Ja (Arbeitsbereiche)', Dokumentenverarbeitung: '9/10', 'Am besten für': 'Die meisten Geschäftsteams' },
          { Tool: 'RAGFlow', 'Link': '[ragflow.io](https://ragflow.io)', 'Ohne Code': 'Ja', 'Multi-User': 'Ja', Dokumentenverarbeitung: '9,5/10', 'Am besten für': 'Tabellen, Scans, komplexe Layouts' },
          { Tool: 'PrivateGPT', 'Link': '[GitHub](https://github.com/zylon-ai/private-gpt)', 'Ohne Code': 'Einfache UI', 'Multi-User': 'Nein', Dokumentenverarbeitung: '7/10', 'Am besten für': 'Strikte Offline-/Air-Gapped-Nutzung' },
          { Tool: 'Open WebUI', 'Link': '[openwebui.com](https://openwebui.com)', 'Ohne Code': 'Ja', 'Multi-User': 'Ja', Dokumentenverarbeitung: '8/10', 'Am besten für': 'Bestehende Ollama-Nutzer' },
          { Tool: 'Dify', 'Link': '[dify.ai](https://dify.ai)', 'Ohne Code': 'Ja (visueller Builder)', 'Multi-User': 'Ja', Dokumentenverarbeitung: '8/10', 'Am besten für': 'KI-Anwendungs-Workflows' },
          { Tool: 'LlamaIndex', 'Link': '[llamaindex.ai](https://www.llamaindex.ai)', 'Ohne Code': 'Nein (Python SDK)', 'Multi-User': 'Individuell', Dokumentenverarbeitung: '9,5/10', 'Am besten für': 'Individuelle Entwickler-Pipelines' },
        ],
      ...
      comparison: {
        ...
        columns: ['Tool', 'Link', 'Kategorie', 'Ohne-Code-UI', 'Multi-User', 'Lokales LLM', 'Lizenz'],
        rows: [
          { Tool: 'AnythingLLM', 'Link': '[anythingllm.com](https://anythingllm.com)', Kategorie: 'A — Anwendung', 'Ohne-Code-UI': 'Ja', 'Multi-User': 'Ja (Arbeitsbereiche)', 'Lokales LLM': 'Ollama, LM Studio', Lizenz: 'MIT' },
          { Tool: 'RAGFlow', 'Link': '[ragflow.io](https://ragflow.io)', Kategorie: 'A — Anwendung', 'Ohne-Code-UI': 'Ja', 'Multi-User': 'Ja', 'Lokales LLM': 'Ollama und andere', Lizenz: 'Apache 2.0' },
          { Tool: 'PrivateGPT', 'Link': '[GitHub](https://github.com/zylon-ai/private-gpt)', Kategorie: 'A — Anwendung', 'Ohne-Code-UI': 'Einfache UI', 'Multi-User': 'Nein', 'Lokales LLM': 'Ollama, llama.cpp', Lizenz: 'Apache 2.0' },
          { Tool: 'Open WebUI', 'Link': '[openwebui.com](https://openwebui.com)', Kategorie: 'A — Anwendung', 'Ohne-Code-UI': 'Ja', 'Multi-User': 'Ja', 'Lokales LLM': 'Ollama-nativ', Lizenz: 'BSD-3' },
          { Tool: 'Dify', 'Link': '[dify.ai](https://dify.ai)', Kategorie: 'B — App-Builder', 'Ohne-Code-UI': 'Ja (visuell)', 'Multi-User': 'Ja', 'Lokales LLM': 'Ollama und andere', Lizenz: 'Apache 2.0 (teilweise)' },
          { Tool: 'LlamaIndex', 'Link': '[llamaindex.ai](https://www.llamaindex.ai)', Kategorie: 'C — Framework', 'Ohne-Code-UI': 'Nein (Python SDK)', 'Multi-User': 'Individuell', 'Lokales LLM': 'Ollama, llama.cpp', Lizenz: 'MIT' },
          { Tool: 'Chroma', 'Link': '[trychroma.com](https://www.trychroma.com)', Kategorie: 'C — Vektor-DB', 'Ohne-Code-UI': 'Nein (API)', 'Multi-User': 'Ja (Server-Modus)', 'Lokales LLM': 'N/A', Lizenz: 'Apache 2.0' },
          { Tool: 'Qdrant', 'Link': '[qdrant.tech](https://qdrant.tech)', Kategorie: 'C — Vektor-DB', 'Ohne-Code-UI': 'Nein (API)', 'Multi-User': 'Ja', 'Lokales LLM': 'N/A', Lizenz: 'Apache 2.0' },
          { Tool: 'Weaviate', 'Link': '[weaviate.io](https://weaviate.io)', Kategorie: 'C — Vektor-DB', 'Ohne-Code-UI': 'Nein (API)', 'Multi-User': 'Ja', 'Lokales LLM': 'N/A', Lizenz: 'BSD-3' },
        ],
      },
      decisionTree: {
        id: 'decision-tree',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[txtai im Test 2026: Vektordatenbank ohne separaten Server](/de/power-local-llm/txtai-embedded-vector-database-review) — für Entwickler, die RAG in einer einzigen Python-Bibliothek statt in einer separaten Dokumenten-Chat-Plattform wollen.',
          ...
          '[Haystack von deepset im Test: RAG-Framework vs. LangChain und LlamaIndex](/de/power-local-llm/haystack-deepset-rag-framework-review) — ein code-first-Python-Framework mit expliziter Pipeline-/Component-Architektur für messbare RAG-Qualität.',
  ...
  fr: {
    ...
    sections: {
      ...
      scorecard: {
        ...
        columns: ['Outil', 'Lien', 'Sans code', 'Multi-utilisateurs', 'Gestion documentaire', 'Idéal pour'],
        rows: [
          { Outil: 'AnythingLLM', 'Lien': '[anythingllm.com](https://anythingllm.com)', 'Sans code': 'Oui', 'Multi-utilisateurs': 'Oui (espaces)', 'Gestion documentaire': '9/10', 'Idéal pour': 'La plupart des équipes' },
          { Outil: 'RAGFlow', 'Lien': '[ragflow.io](https://ragflow.io)', 'Sans code': 'Oui', 'Multi-utilisateurs': 'Oui', 'Gestion documentaire': '9.5/10', 'Idéal pour': 'Tableaux, scans, mises en page' },
          { Outil: 'PrivateGPT', 'Lien': '[GitHub](https://github.com/zylon-ai/private-gpt)', 'Sans code': 'UI basique', 'Multi-utilisateurs': 'Non', 'Gestion documentaire': '7/10', 'Idéal pour': 'Usage hors ligne strict' },
          { Outil: 'Open WebUI', 'Lien': '[openwebui.com](https://openwebui.com)', 'Sans code': 'Oui', 'Multi-utilisateurs': 'Oui', 'Gestion documentaire': '8/10', 'Idéal pour': 'Utilisateurs Ollama existants' },
          { Outil: 'Dify', 'Lien': '[dify.ai](https://dify.ai)', 'Sans code': 'Oui (visuel)', 'Multi-utilisateurs': 'Oui', 'Gestion documentaire': '8/10', 'Idéal pour': 'Workflows applicatifs IA' },
          { Outil: 'LlamaIndex', 'Lien': '[llamaindex.ai](https://www.llamaindex.ai)', 'Sans code': 'Non (SDK Python)', 'Multi-utilisateurs': 'Sur mesure', 'Gestion documentaire': '9.5/10', 'Idéal pour': 'Pipelines développeur sur mesure' },
        ],
      ...
      comparison: {
        ...
        columns: ['Outil', 'Lien', 'Catégorie', 'UI sans code', 'Multi-utilisateurs', 'LLM local', 'Licence'],
        rows: [
          { Outil: 'AnythingLLM', 'Lien': '[anythingllm.com](https://anythingllm.com)', Catégorie: 'A — Application', 'UI sans code': 'Oui', 'Multi-utilisateurs': 'Oui (espaces)', 'LLM local': 'Ollama, LM Studio', Licence: 'MIT' },
          { Outil: 'RAGFlow', 'Lien': '[ragflow.io](https://ragflow.io)', Catégorie: 'A — Application', 'UI sans code': 'Oui', 'Multi-utilisateurs': 'Oui', 'LLM local': 'Ollama et autres', Licence: 'Apache 2.0' },
          { Outil: 'PrivateGPT', 'Lien': '[GitHub](https://github.com/zylon-ai/private-gpt)', Catégorie: 'A — Application', 'UI sans code': 'UI basique', 'Multi-utilisateurs': 'Non', 'LLM local': 'Ollama, llama.cpp', Licence: 'Apache 2.0' },
          { Outil: 'Open WebUI', 'Lien': '[openwebui.com](https://openwebui.com)', Catégorie: 'A — Application', 'UI sans code': 'Oui', 'Multi-utilisateurs': 'Oui', 'LLM local': 'Natif Ollama', Licence: 'BSD-3' },
          { Outil: 'Dify', 'Lien': '[dify.ai](https://dify.ai)', Catégorie: 'B — Créateur d\'app', 'UI sans code': 'Oui (visuel)', 'Multi-utilisateurs': 'Oui', 'LLM local': 'Ollama et autres', Licence: 'Apache 2.0 (partielle)' },
          { Outil: 'LlamaIndex', 'Lien': '[llamaindex.ai](https://www.llamaindex.ai)', Catégorie: 'C — Framework', 'UI sans code': 'Non (SDK Python)', 'Multi-utilisateurs': 'Sur mesure', 'LLM local': 'Ollama, llama.cpp', Licence: 'MIT' },
          { Outil: 'Chroma', 'Lien': '[trychroma.com](https://www.trychroma.com)', Catégorie: 'C — Base vectorielle', 'UI sans code': 'Non (API)', 'Multi-utilisateurs': 'Oui (mode serveur)', 'LLM local': 'N/A', Licence: 'Apache 2.0' },
          { Outil: 'Qdrant', 'Lien': '[qdrant.tech](https://qdrant.tech)', Catégorie: 'C — Base vectorielle', 'UI sans code': 'Non (API)', 'Multi-utilisateurs': 'Oui', 'LLM local': 'N/A', Licence: 'Apache 2.0' },
          { Outil: 'Weaviate', 'Lien': '[weaviate.io](https://weaviate.io)', Catégorie: 'C — Base vectorielle', 'UI sans code': 'Non (API)', 'Multi-utilisateurs': 'Oui', 'LLM local': 'N/A', Licence: 'BSD-3' },
        ],
      },
      decisionTree: {
        id: 'decision-tree',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[txtai : la base vectorielle embarquée, sans serveur à déployer (2026)](/fr/power-local-llm/txtai-embedded-vector-database-review) — pour les développeurs qui veulent le RAG intégré dans une seule bibliothèque Python plutôt qu\'une plateforme de chat documentaire séparée.',
          ...
          '[Haystack de deepset : pipelines RAG en Python](/fr/power-local-llm/haystack-deepset-rag-framework-review) — un framework Python code-first à l\'architecture Pipeline/Component explicite, pour un RAG mesurable en production.',
  ...
  ja: {
    ...
    sections: {
      ...
      scorecard: {
        ...
        columns: ['ツール', 'リンク', 'ノーコード', 'マルチユーザー', '文書処理', '最適な用途'],
        rows: [
          { 'ツール': 'AnythingLLM', 'リンク': '[anythingllm.com](https://anythingllm.com)', 'ノーコード': 'あり', 'マルチユーザー': 'あり（ワークスペース）', '文書処理': '9/10', '最適な用途': 'ほとんどのビジネスチーム' },
          { 'ツール': 'RAGFlow', 'リンク': '[ragflow.io](https://ragflow.io)', 'ノーコード': 'あり', 'マルチユーザー': 'あり', '文書処理': '9.5/10', '最適な用途': '表、スキャン、複雑なレイアウト' },
          { 'ツール': 'PrivateGPT', 'リンク': '[GitHub](https://github.com/zylon-ai/private-gpt)', 'ノーコード': '基本的なUI', 'マルチユーザー': 'なし', '文書処理': '7/10', '最適な用途': '厳格なオフライン／エアギャップ利用' },
          { 'ツール': 'Open WebUI', 'リンク': '[openwebui.com](https://openwebui.com)', 'ノーコード': 'あり', 'マルチユーザー': 'あり', '文書処理': '8/10', '最適な用途': '既存のOllamaユーザー' },
          { 'ツール': 'Dify', 'リンク': '[dify.ai](https://dify.ai)', 'ノーコード': 'あり（ビジュアルビルダー）', 'マルチユーザー': 'あり', '文書処理': '8/10', '最適な用途': 'AIアプリケーションワークフロー' },
          { 'ツール': 'LlamaIndex', 'リンク': '[llamaindex.ai](https://www.llamaindex.ai)', 'ノーコード': 'なし（Python SDK）', 'マルチユーザー': 'カスタム', '文書処理': '9.5/10', '最適な用途': 'カスタム開発者パイプライン' },
        ],
      ...
      comparison: {
        ...
        columns: ['ツール', 'リンク', 'カテゴリー', 'ノーコードUI', 'マルチユーザー', 'ローカルLLM', 'ライセンス'],
        rows: [
          { 'ツール': 'AnythingLLM', 'リンク': '[anythingllm.com](https://anythingllm.com)', 'カテゴリー': 'A — アプリケーション', 'ノーコードUI': 'あり', 'マルチユーザー': 'あり（ワークスペース）', 'ローカルLLM': 'Ollama, LM Studio', 'ライセンス': 'MIT' },
          { 'ツール': 'RAGFlow', 'リンク': '[ragflow.io](https://ragflow.io)', 'カテゴリー': 'A — アプリケーション', 'ノーコードUI': 'あり', 'マルチユーザー': 'あり', 'ローカルLLM': 'Ollamaほか', 'ライセンス': 'Apache 2.0' },
          { 'ツール': 'PrivateGPT', 'リンク': '[GitHub](https://github.com/zylon-ai/private-gpt)', 'カテゴリー': 'A — アプリケーション', 'ノーコードUI': '基本的なUI', 'マルチユーザー': 'なし', 'ローカルLLM': 'Ollama, llama.cpp', 'ライセンス': 'Apache 2.0' },
          { 'ツール': 'Open WebUI', 'リンク': '[openwebui.com](https://openwebui.com)', 'カテゴリー': 'A — アプリケーション', 'ノーコードUI': 'あり', 'マルチユーザー': 'あり', 'ローカルLLM': 'Ollamaネイティブ', 'ライセンス': 'BSD-3' },
          { 'ツール': 'Dify', 'リンク': '[dify.ai](https://dify.ai)', 'カテゴリー': 'B — アプリビルダー', 'ノーコードUI': 'あり（ビジュアル）', 'マルチユーザー': 'あり', 'ローカルLLM': 'Ollamaほか', 'ライセンス': 'Apache 2.0（一部）' },
          { 'ツール': 'LlamaIndex', 'リンク': '[llamaindex.ai](https://www.llamaindex.ai)', 'カテゴリー': 'C — フレームワーク', 'ノーコードUI': 'なし（Python SDK）', 'マルチユーザー': 'カスタム', 'ローカルLLM': 'Ollama, llama.cpp', 'ライセンス': 'MIT' },
          { 'ツール': 'Chroma', 'リンク': '[trychroma.com](https://www.trychroma.com)', 'カテゴリー': 'C — ベクターDB', 'ノーコードUI': 'なし（API）', 'マルチユーザー': 'あり（サーバーモード）', 'ローカルLLM': 'N/A', 'ライセンス': 'Apache 2.0' },
          { 'ツール': 'Qdrant', 'リンク': '[qdrant.tech](https://qdrant.tech)', 'カテゴリー': 'C — ベクターDB', 'ノーコードUI': 'なし（API）', 'マルチユーザー': 'あり', 'ローカルLLM': 'N/A', 'ライセンス': 'Apache 2.0' },
          { 'ツール': 'Weaviate', 'リンク': '[weaviate.io](https://weaviate.io)', 'カテゴリー': 'C — ベクターDB', 'ノーコードUI': 'なし（API）', 'マルチユーザー': 'あり', 'ローカルLLM': 'N/A', 'ライセンス': 'BSD-3' },
        ],
      },
      decisionTree: {
        id: 'decision-tree',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[txtai比較2026:サーバー不要の組み込みベクトルDB](/ja/power-local-llm/txtai-embedded-vector-database-review) — 別のドキュメントチャットプラットフォームではなく、1つのPythonライブラリにRAGを組み込みたい開発者向け。',
          ...
          '[Haystack(deepset)レビュー：PythonでRAG検索パイプラインを構築](/ja/power-local-llm/haystack-deepset-rag-framework-review) — 明示的なPipeline/Component設計を持つコードファーストのPythonフレームワーク、本番でのRAG品質測定に向く。',
  ...
  zh: {
    ...
    sections: {
      ...
      scorecard: {
        ...
        columns: ['工具', '链接', '无代码', '多用户', '文档处理能力', '最适合'],
        rows: [
          { '工具': 'AnythingLLM', '链接': '[anythingllm.com](https://anythingllm.com)', '无代码': '是', '多用户': '是（工作区）', '文档处理能力': '9/10', '最适合': '大多数企业团队' },
          { '工具': 'RAGFlow', '链接': '[ragflow.io](https://ragflow.io)', '无代码': '是', '多用户': '是', '文档处理能力': '9.5/10', '最适合': '表格、扫描件、复杂排版' },
          { '工具': 'PrivateGPT', '链接': '[GitHub](https://github.com/zylon-ai/private-gpt)', '无代码': '基础界面', '多用户': '否', '文档处理能力': '7/10', '最适合': '严格离线/隔离网络场景' },
          { '工具': 'Open WebUI', '链接': '[openwebui.com](https://openwebui.com)', '无代码': '是', '多用户': '是', '文档处理能力': '8/10', '最适合': '现有Ollama用户' },
          { '工具': 'Dify', '链接': '[dify.ai](https://dify.ai)', '无代码': '是（可视化构建器）', '多用户': '是', '文档处理能力': '8/10', '最适合': 'AI应用工作流' },
          { '工具': 'LlamaIndex', '链接': '[llamaindex.ai](https://www.llamaindex.ai)', '无代码': '否（Python SDK）', '多用户': '自定义', '文档处理能力': '9.5/10', '最适合': '定制开发者管道' },
        ],
      ...
      comparison: {
        ...
        columns: ['工具', '链接', '类别', '无代码界面', '多用户', '本地LLM', '许可证'],
        rows: [
          { '工具': 'AnythingLLM', '链接': '[anythingllm.com](https://anythingllm.com)', '类别': 'A——应用', '无代码界面': '是', '多用户': '是（工作区）', '本地LLM': 'Ollama、LM Studio', '许可证': 'MIT' },
          { '工具': 'RAGFlow', '链接': '[ragflow.io](https://ragflow.io)', '类别': 'A——应用', '无代码界面': '是', '多用户': '是', '本地LLM': 'Ollama及其他', '许可证': 'Apache 2.0' },
          { '工具': 'PrivateGPT', '链接': '[GitHub](https://github.com/zylon-ai/private-gpt)', '类别': 'A——应用', '无代码界面': '基础界面', '多用户': '否', '本地LLM': 'Ollama、llama.cpp', '许可证': 'Apache 2.0' },
          { '工具': 'Open WebUI', '链接': '[openwebui.com](https://openwebui.com)', '类别': 'A——应用', '无代码界面': '是', '多用户': '是', '本地LLM': 'Ollama原生', '许可证': 'BSD-3' },
          { '工具': 'Dify', '链接': '[dify.ai](https://dify.ai)', '类别': 'B——应用构建平台', '无代码界面': '是（可视化）', '多用户': '是', '本地LLM': 'Ollama及其他', '许可证': 'Apache 2.0（部分）' },
          { '工具': 'LlamaIndex', '链接': '[llamaindex.ai](https://www.llamaindex.ai)', '类别': 'C——框架', '无代码界面': '否（Python SDK）', '多用户': '自定义', '本地LLM': 'Ollama、llama.cpp', '许可证': 'MIT' },
          { '工具': 'Chroma', '链接': '[trychroma.com](https://www.trychroma.com)', '类别': 'C——向量数据库', '无代码界面': '否（API）', '多用户': '是（服务器模式）', '本地LLM': '不适用', '许可证': 'Apache 2.0' },
          { '工具': 'Qdrant', '链接': '[qdrant.tech](https://qdrant.tech)', '类别': 'C——向量数据库', '无代码界面': '否（API）', '多用户': '是', '本地LLM': '不适用', '许可证': 'Apache 2.0' },
          { '工具': 'Weaviate', '链接': '[weaviate.io](https://weaviate.io)', '类别': 'C——向量数据库', '无代码界面': '否（API）', '多用户': '是', '本地LLM': '不适用', '许可证': 'BSD-3' },
        ],
      },
      decisionTree: {
        id: 'decision-tree',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[txtai 2026评测:无需服务器的嵌入式向量数据库](/zh/power-local-llm/txtai-embedded-vector-database-review) —— 为希望将RAG内置于单一Python库、而非独立文档聊天平台的开发者准备。',
          ...
          '[Haystack RAG框架评测：deepset出品的Python生产级检索管道](/zh/power-local-llm/haystack-deepset-rag-framework-review) — 一个基于显式Pipeline/Component架构的code-first Python框架，适合需要可衡量RAG质量的团队。',
  ...
  es: {
    ...
    sections: {
      ...
      scorecard: {
        ...
        columns: ['Herramienta', 'Enlace', 'Sin código', 'Multiusuario', 'Gestión de documentos', 'Ideal para'],
        rows: [
          { Herramienta: 'AnythingLLM', 'Enlace': '[anythingllm.com](https://anythingllm.com)', 'Sin código': 'Sí', Multiusuario: 'Sí (espacios de trabajo)', 'Gestión de documentos': '9/10', 'Ideal para': 'La mayoría de equipos empresariales' },
          { Herramienta: 'RAGFlow', 'Enlace': '[ragflow.io](https://ragflow.io)', 'Sin código': 'Sí', Multiusuario: 'Sí', 'Gestión de documentos': '9.5/10', 'Ideal para': 'Tablas, escaneos, diseños complejos' },
          { Herramienta: 'PrivateGPT', 'Enlace': '[GitHub](https://github.com/zylon-ai/private-gpt)', 'Sin código': 'Interfaz básica', Multiusuario: 'No', 'Gestión de documentos': '7/10', 'Ideal para': 'Uso offline/air-gapped estricto' },
          { Herramienta: 'Open WebUI', 'Enlace': '[openwebui.com](https://openwebui.com)', 'Sin código': 'Sí', Multiusuario: 'Sí', 'Gestión de documentos': '8/10', 'Ideal para': 'Usuarios existentes de Ollama' },
          { Herramienta: 'Dify', 'Enlace': '[dify.ai](https://dify.ai)', 'Sin código': 'Sí (constructor visual)', Multiusuario: 'Sí', 'Gestión de documentos': '8/10', 'Ideal para': 'Flujos de trabajo de aplicaciones IA' },
          { Herramienta: 'LlamaIndex', 'Enlace': '[llamaindex.ai](https://www.llamaindex.ai)', 'Sin código': 'No (SDK de Python)', Multiusuario: 'Personalizable', 'Gestión de documentos': '9.5/10', 'Ideal para': 'Pipelines personalizados para desarrolladores' },
        ],
      ...
      comparison: {
        ...
        columns: ['Herramienta', 'Enlace', 'Categoría', 'Interfaz sin código', 'Multiusuario', 'LLM local', 'Licencia'],
        rows: [
          { Herramienta: 'AnythingLLM', 'Enlace': '[anythingllm.com](https://anythingllm.com)', Categoría: 'A — Aplicación', 'Interfaz sin código': 'Sí', Multiusuario: 'Sí (espacios de trabajo)', 'LLM local': 'Ollama, LM Studio', Licencia: 'MIT' },
          { Herramienta: 'RAGFlow', 'Enlace': '[ragflow.io](https://ragflow.io)', Categoría: 'A — Aplicación', 'Interfaz sin código': 'Sí', Multiusuario: 'Sí', 'LLM local': 'Ollama y otros', Licencia: 'Apache 2.0' },
          { Herramienta: 'PrivateGPT', 'Enlace': '[GitHub](https://github.com/zylon-ai/private-gpt)', Categoría: 'A — Aplicación', 'Interfaz sin código': 'Interfaz básica', Multiusuario: 'No', 'LLM local': 'Ollama, llama.cpp', Licencia: 'Apache 2.0' },
          { Herramienta: 'Open WebUI', 'Enlace': '[openwebui.com](https://openwebui.com)', Categoría: 'A — Aplicación', 'Interfaz sin código': 'Sí', Multiusuario: 'Sí', 'LLM local': 'Nativo de Ollama', Licencia: 'BSD-3' },
          { Herramienta: 'Dify', 'Enlace': '[dify.ai](https://dify.ai)', Categoría: 'B — Constructor de apps', 'Interfaz sin código': 'Sí (visual)', Multiusuario: 'Sí', 'LLM local': 'Ollama y otros', Licencia: 'Apache 2.0 (parcial)' },
          { Herramienta: 'LlamaIndex', 'Enlace': '[llamaindex.ai](https://www.llamaindex.ai)', Categoría: 'C — Framework', 'Interfaz sin código': 'No (SDK de Python)', Multiusuario: 'Personalizable', 'LLM local': 'Ollama, llama.cpp', Licencia: 'MIT' },
          { Herramienta: 'Chroma', 'Enlace': '[trychroma.com](https://www.trychroma.com)', Categoría: 'C — Base de datos vectorial', 'Interfaz sin código': 'No (API)', Multiusuario: 'Sí (modo servidor)', 'LLM local': 'N/D', Licencia: 'Apache 2.0' },
          { Herramienta: 'Qdrant', 'Enlace': '[qdrant.tech](https://qdrant.tech)', Categoría: 'C — Base de datos vectorial', 'Interfaz sin código': 'No (API)', Multiusuario: 'Sí', 'LLM local': 'N/D', Licencia: 'Apache 2.0' },
          { Herramienta: 'Weaviate', 'Enlace': '[weaviate.io](https://weaviate.io)', Categoría: 'C — Base de datos vectorial', 'Interfaz sin código': 'No (API)', Multiusuario: 'Sí', 'LLM local': 'N/D', Licencia: 'BSD-3' },
        ],
      },
      decisionTree: {
        id: 'decision-tree',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[txtai 2026: la base de datos vectorial embebida que no necesita servidor](/es/power-local-llm/txtai-embedded-vector-database-review) — para desarrolladores que quieren RAG integrado en una sola biblioteca Python en lugar de una plataforma de chat documental separada.',
          ...
          '[Haystack de deepset: framework Python para RAG en producción](/es/power-local-llm/haystack-deepset-rag-framework-review) — un framework code-first con arquitectura Pipeline/Component explícita, para RAG medible en producción.',
  ...
  pt: {
    ...
    sections: {
      ...
      scorecard: {
        ...
        columns: ['Ferramenta', 'Link', 'Sem código', 'Multiusuário', 'Manuseio de documentos', 'Melhor para'],
        rows: [
          { 'Ferramenta': 'AnythingLLM', 'Link': '[anythingllm.com](https://anythingllm.com)', 'Sem código': 'Sim', 'Multiusuário': 'Sim (espaços de trabalho)', 'Manuseio de documentos': '9/10', 'Melhor para': 'A maioria das equipes corporativas' },
          { 'Ferramenta': 'RAGFlow', 'Link': '[ragflow.io](https://ragflow.io)', 'Sem código': 'Sim', 'Multiusuário': 'Sim', 'Manuseio de documentos': '9.5/10', 'Melhor para': 'Tabelas, digitalizações, layouts complexos' },
          { 'Ferramenta': 'PrivateGPT', 'Link': '[GitHub](https://github.com/zylon-ai/private-gpt)', 'Sem código': 'Interface básica', 'Multiusuário': 'Não', 'Manuseio de documentos': '7/10', 'Melhor para': 'Uso offline/isolado rigoroso' },
          { 'Ferramenta': 'Open WebUI', 'Link': '[openwebui.com](https://openwebui.com)', 'Sem código': 'Sim', 'Multiusuário': 'Sim', 'Manuseio de documentos': '8/10', 'Melhor para': 'Quem já usa Ollama' },
          { 'Ferramenta': 'Dify', 'Link': '[dify.ai](https://dify.ai)', 'Sem código': 'Sim (construtor visual)', 'Multiusuário': 'Sim', 'Manuseio de documentos': '8/10', 'Melhor para': 'Fluxos de aplicações de IA' },
          { 'Ferramenta': 'LlamaIndex', 'Link': '[llamaindex.ai](https://www.llamaindex.ai)', 'Sem código': 'Não (SDK Python)', 'Multiusuário': 'Personalizável', 'Manuseio de documentos': '9.5/10', 'Melhor para': 'Pipelines personalizados' },
        ],
      ...
      comparison: {
        ...
        columns: ['Ferramenta', 'Link', 'Categoria', 'Interface sem código', 'Multiusuário', 'LLM local', 'Licença'],
        rows: [
          { 'Ferramenta': 'AnythingLLM', 'Link': '[anythingllm.com](https://anythingllm.com)', 'Categoria': 'A — Aplicação', 'Interface sem código': 'Sim', 'Multiusuário': 'Sim (espaços de trabalho)', 'LLM local': 'Ollama, LM Studio', 'Licença': 'MIT' },
          { 'Ferramenta': 'RAGFlow', 'Link': '[ragflow.io](https://ragflow.io)', 'Categoria': 'A — Aplicação', 'Interface sem código': 'Sim', 'Multiusuário': 'Sim', 'LLM local': 'Ollama e outros', 'Licença': 'Apache 2.0' },
          { 'Ferramenta': 'PrivateGPT', 'Link': '[GitHub](https://github.com/zylon-ai/private-gpt)', 'Categoria': 'A — Aplicação', 'Interface sem código': 'Interface básica', 'Multiusuário': 'Não', 'LLM local': 'Ollama, llama.cpp', 'Licença': 'Apache 2.0' },
          { 'Ferramenta': 'Open WebUI', 'Link': '[openwebui.com](https://openwebui.com)', 'Categoria': 'A — Aplicação', 'Interface sem código': 'Sim', 'Multiusuário': 'Sim', 'LLM local': 'Nativo do Ollama', 'Licença': 'BSD-3' },
          { 'Ferramenta': 'Dify', 'Link': '[dify.ai](https://dify.ai)', 'Categoria': 'B — Construtor de apps', 'Interface sem código': 'Sim (visual)', 'Multiusuário': 'Sim', 'LLM local': 'Ollama e outros', 'Licença': 'Apache 2.0 (parcial)' },
          { 'Ferramenta': 'LlamaIndex', 'Link': '[llamaindex.ai](https://www.llamaindex.ai)', 'Categoria': 'C — Framework', 'Interface sem código': 'Não (SDK Python)', 'Multiusuário': 'Personalizável', 'LLM local': 'Ollama, llama.cpp', 'Licença': 'MIT' },
          { 'Ferramenta': 'Chroma', 'Link': '[trychroma.com](https://www.trychroma.com)', 'Categoria': 'C — Banco vetorial', 'Interface sem código': 'Não (API)', 'Multiusuário': 'Sim (modo servidor)', 'LLM local': 'N/A', 'Licença': 'Apache 2.0' },
          { 'Ferramenta': 'Qdrant', 'Link': '[qdrant.tech](https://qdrant.tech)', 'Categoria': 'C — Banco vetorial', 'Interface sem código': 'Não (API)', 'Multiusuário': 'Sim', 'LLM local': 'N/A', 'Licença': 'Apache 2.0' },
          { 'Ferramenta': 'Weaviate', 'Link': '[weaviate.io](https://weaviate.io)', 'Categoria': 'C — Banco vetorial', 'Interface sem código': 'Não (API)', 'Multiusuário': 'Sim', 'LLM local': 'N/A', 'Licença': 'BSD-3' },
        ],
      },
      decisionTree: {
        id: 'decision-tree',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[txtai 2026: o banco de dados vetorial embutido que dispensa servidor](/pt/power-local-llm/txtai-embedded-vector-database-review) — para desenvolvedores que querem RAG embutido em uma única biblioteca Python em vez de uma plataforma de chat documental separada.',
          ...
          '[Haystack da deepset: framework Python para RAG em produção](/pt/power-local-llm/haystack-deepset-rag-framework-review) — um framework code-first com arquitetura Pipeline/Component explícita, para RAG mensurável em produção.',
  ...
  ar: {
    ...
    sections: {
      ...
      scorecard: {
        ...
        columns: ['الأداة', 'الرابط', 'بدون برمجة', 'متعدد المستخدمين', 'التعامل مع الوثائق', 'الأفضل لـ'],
        rows: [
          { 'الأداة': 'AnythingLLM', 'الرابط': '[anythingllm.com](https://anythingllm.com)', 'بدون برمجة': 'نعم', 'متعدد المستخدمين': 'نعم (مساحات عمل)', 'التعامل مع الوثائق': '9/10', 'الأفضل لـ': 'معظم فرق الأعمال' },
          { 'الأداة': 'RAGFlow', 'الرابط': '[ragflow.io](https://ragflow.io)', 'بدون برمجة': 'نعم', 'متعدد المستخدمين': 'نعم', 'التعامل مع الوثائق': '9.5/10', 'الأفضل لـ': 'الجداول والمسح الضوئي والتخطيطات المعقدة' },
          { 'الأداة': 'PrivateGPT', 'الرابط': '[GitHub](https://github.com/zylon-ai/private-gpt)', 'بدون برمجة': 'واجهة أساسية', 'متعدد المستخدمين': 'لا', 'التعامل مع الوثائق': '7/10', 'الأفضل لـ': 'الاستخدام الصارم دون اتصال / المعزول' },
          { 'الأداة': 'Open WebUI', 'الرابط': '[openwebui.com](https://openwebui.com)', 'بدون برمجة': 'نعم', 'متعدد المستخدمين': 'نعم', 'التعامل مع الوثائق': '8/10', 'الأفضل لـ': 'مستخدمي Ollama الحاليين' },
          { 'الأداة': 'Dify', 'الرابط': '[dify.ai](https://dify.ai)', 'بدون برمجة': 'نعم (أداة بناء مرئية)', 'متعدد المستخدمين': 'نعم', 'التعامل مع الوثائق': '8/10', 'الأفضل لـ': 'سير عمل تطبيقات الذكاء الاصطناعي' },
          { 'الأداة': 'LlamaIndex', 'الرابط': '[llamaindex.ai](https://www.llamaindex.ai)', 'بدون برمجة': 'لا (Python SDK)', 'متعدد المستخدمين': 'مخصص', 'التعامل مع الوثائق': '9.5/10', 'الأفضل لـ': 'خطوط أنابيب المطورين المخصصة' },
        ],
      ...
      comparison: {
        ...
        columns: ['الأداة', 'الرابط', 'الفئة', 'واجهة بدون برمجة', 'متعدد المستخدمين', 'LLM محلي', 'الترخيص'],
        rows: [
          { 'الأداة': 'AnythingLLM', 'الرابط': '[anythingllm.com](https://anythingllm.com)', 'الفئة': 'أ — تطبيق', 'واجهة بدون برمجة': 'نعم', 'متعدد المستخدمين': 'نعم (مساحات عمل)', 'LLM محلي': 'Ollama، LM Studio', 'الترخيص': 'MIT' },
          { 'الأداة': 'RAGFlow', 'الرابط': '[ragflow.io](https://ragflow.io)', 'الفئة': 'أ — تطبيق', 'واجهة بدون برمجة': 'نعم', 'متعدد المستخدمين': 'نعم', 'LLM محلي': 'Ollama وغيره', 'الترخيص': 'Apache 2.0' },
          { 'الأداة': 'PrivateGPT', 'الرابط': '[GitHub](https://github.com/zylon-ai/private-gpt)', 'الفئة': 'أ — تطبيق', 'واجهة بدون برمجة': 'واجهة أساسية', 'متعدد المستخدمين': 'لا', 'LLM محلي': 'Ollama، llama.cpp', 'الترخيص': 'Apache 2.0' },
          { 'الأداة': 'Open WebUI', 'الرابط': '[openwebui.com](https://openwebui.com)', 'الفئة': 'أ — تطبيق', 'واجهة بدون برمجة': 'نعم', 'متعدد المستخدمين': 'نعم', 'LLM محلي': 'أصلي لـOllama', 'الترخيص': 'BSD-3' },
          { 'الأداة': 'Dify', 'الرابط': '[dify.ai](https://dify.ai)', 'الفئة': 'ب — أداة بناء تطبيقات', 'واجهة بدون برمجة': 'نعم (مرئية)', 'متعدد المستخدمين': 'نعم', 'LLM محلي': 'Ollama وغيره', 'الترخيص': 'Apache 2.0 (جزئي)' },
          { 'الأداة': 'LlamaIndex', 'الرابط': '[llamaindex.ai](https://www.llamaindex.ai)', 'الفئة': 'ج — إطار عمل', 'واجهة بدون برمجة': 'لا (Python SDK)', 'متعدد المستخدمين': 'مخصص', 'LLM محلي': 'Ollama، llama.cpp', 'الترخيص': 'MIT' },
          { 'الأداة': 'Chroma', 'الرابط': '[trychroma.com](https://www.trychroma.com)', 'الفئة': 'ج — قاعدة بيانات متجهة', 'واجهة بدون برمجة': 'لا (API)', 'متعدد المستخدمين': 'نعم (وضع الخادم)', 'LLM محلي': 'غير متاح', 'الترخيص': 'Apache 2.0' },
          { 'الأداة': 'Qdrant', 'الرابط': '[qdrant.tech](https://qdrant.tech)', 'الفئة': 'ج — قاعدة بيانات متجهة', 'واجهة بدون برمجة': 'لا (API)', 'متعدد المستخدمين': 'نعم', 'LLM محلي': 'غير متاح', 'الترخيص': 'Apache 2.0' },
          { 'الأداة': 'Weaviate', 'الرابط': '[weaviate.io](https://weaviate.io)', 'الفئة': 'ج — قاعدة بيانات متجهة', 'واجهة بدون برمجة': 'لا (API)', 'متعدد المستخدمين': 'نعم', 'LLM محلي': 'غير متاح', 'الترخيص': 'BSD-3' },
        ],
      },
      decisionTree: {
        id: 'decision-tree',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[مراجعة txtai 2026: قاعدة بيانات متجهية مضمّنة بلا خادم](/ar/power-local-llm/txtai-embedded-vector-database-review) — لمطوّري Python الذين يريدون RAG مدمجاً في مكتبة واحدة بدلاً من منصة محادثة مستندات منفصلة.',
          ...
          '[مراجعة Haystack من deepset: إطار عمل Python لـ RAG الإنتاجي](/ar/power-local-llm/haystack-deepset-rag-framework-review) — إطار عمل يعتمد الشيفرة أولًا ببنية Pipeline/Component صريحة، لجودة RAG قابلة للقياس.',
  ...
  ko: {
    ...
    sections: {
      ...
      scorecard: {
        ...
        columns: ['도구', '링크', '코드 불필요', '멀티 사용자', '문서 처리', '적합 대상'],
        rows: [
          { '도구': 'AnythingLLM', '링크': '[anythingllm.com](https://anythingllm.com)', '코드 불필요': '예', '멀티 사용자': '예 (워크스페이스)', '문서 처리': '9/10', '적합 대상': '대부분의 기업 팀' },
          { '도구': 'RAGFlow', '링크': '[ragflow.io](https://ragflow.io)', '코드 불필요': '예', '멀티 사용자': '예', '문서 처리': '9.5/10', '적합 대상': '표, 스캔, 복잡한 레이아웃' },
          { '도구': 'PrivateGPT', '링크': '[GitHub](https://github.com/zylon-ai/private-gpt)', '코드 불필요': '기본 UI', '멀티 사용자': '아니요', '문서 처리': '7/10', '적합 대상': '엄격한 오프라인/에어갭 환경' },
          { '도구': 'Open WebUI', '링크': '[openwebui.com](https://openwebui.com)', '코드 불필요': '예', '멀티 사용자': '예', '문서 처리': '8/10', '적합 대상': '기존 Ollama 사용자' },
          { '도구': 'Dify', '링크': '[dify.ai](https://dify.ai)', '코드 불필요': '예 (시각적 빌더)', '멀티 사용자': '예', '문서 처리': '8/10', '적합 대상': 'AI 애플리케이션 워크플로우' },
          { '도구': 'LlamaIndex', '링크': '[llamaindex.ai](https://www.llamaindex.ai)', '코드 불필요': '아니요 (Python SDK)', '멀티 사용자': '맞춤 설정', '문서 처리': '9.5/10', '적합 대상': '맞춤형 개발자 파이프라인' },
        ],
      ...
      comparison: {
        ...
        columns: ['도구', '링크', '범주', '코드 불필요 UI', '멀티 사용자', '로컬 LLM', '라이선스'],
        rows: [
          { '도구': 'AnythingLLM', '링크': '[anythingllm.com](https://anythingllm.com)', '범주': 'A — 애플리케이션', '코드 불필요 UI': '예', '멀티 사용자': '예 (워크스페이스)', '로컬 LLM': 'Ollama, LM Studio', '라이선스': 'MIT' },
          { '도구': 'RAGFlow', '링크': '[ragflow.io](https://ragflow.io)', '범주': 'A — 애플리케이션', '코드 불필요 UI': '예', '멀티 사용자': '예', '로컬 LLM': 'Ollama 외', '라이선스': 'Apache 2.0' },
          { '도구': 'PrivateGPT', '링크': '[GitHub](https://github.com/zylon-ai/private-gpt)', '범주': 'A — 애플리케이션', '코드 불필요 UI': '기본 UI', '멀티 사용자': '아니요', '로컬 LLM': 'Ollama, llama.cpp', '라이선스': 'Apache 2.0' },
          { '도구': 'Open WebUI', '링크': '[openwebui.com](https://openwebui.com)', '범주': 'A — 애플리케이션', '코드 불필요 UI': '예', '멀티 사용자': '예', '로컬 LLM': 'Ollama 네이티브', '라이선스': 'BSD-3' },
          { '도구': 'Dify', '링크': '[dify.ai](https://dify.ai)', '범주': 'B — 앱 빌더', '코드 불필요 UI': '예 (시각적)', '멀티 사용자': '예', '로컬 LLM': 'Ollama 외', '라이선스': 'Apache 2.0 (부분)' },
          { '도구': 'LlamaIndex', '링크': '[llamaindex.ai](https://www.llamaindex.ai)', '범주': 'C — 프레임워크', '코드 불필요 UI': '아니요 (Python SDK)', '멀티 사용자': '맞춤 설정', '로컬 LLM': 'Ollama, llama.cpp', '라이선스': 'MIT' },
          { '도구': 'Chroma', '링크': '[trychroma.com](https://www.trychroma.com)', '범주': 'C — 벡터 DB', '코드 불필요 UI': '아니요 (API)', '멀티 사용자': '예 (서버 모드)', '로컬 LLM': 'N/A', '라이선스': 'Apache 2.0' },
          { '도구': 'Qdrant', '링크': '[qdrant.tech](https://qdrant.tech)', '범주': 'C — 벡터 DB', '코드 불필요 UI': '아니요 (API)', '멀티 사용자': '예', '로컬 LLM': 'N/A', '라이선스': 'Apache 2.0' },
          { '도구': 'Weaviate', '링크': '[weaviate.io](https://weaviate.io)', '범주': 'C — 벡터 DB', '코드 불필요 UI': '아니요 (API)', '멀티 사용자': '예', '로컬 LLM': 'N/A', '라이선스': 'BSD-3' },
        ],
      },
      decisionTree: {
        id: 'decision-tree',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[txtai 2026 리뷰: 서버 없는 임베디드 벡터 DB](/ko/power-local-llm/txtai-embedded-vector-database-review) — 별도 문서 챗 플랫폼 대신 하나의 Python 라이브러리에 RAG를 내장하고 싶은 개발자를 위한 선택지.',
          ...
          '[Haystack(deepset) 리뷰: 프로덕션 RAG를 위한 Python 프레임워크](/ko/power-local-llm/haystack-deepset-rag-framework-review) — 명시적인 Pipeline/Component 아키텍처를 갖춘 code-first Python 프레임워크, 측정 가능한 RAG 품질을 위한 선택.',
