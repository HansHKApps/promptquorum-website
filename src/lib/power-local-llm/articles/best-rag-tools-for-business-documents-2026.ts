    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/directory) — the full directory of local LLM tools including RAG-ready options',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Lokales LLM-Software-Verzeichnis 2026](/de/directory) — das vollständige Verzeichnis lokaler LLM-Tools einschließlich RAG-fähiger Optionen',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Répertoire de logiciels LLM locaux 2026](/fr/directory) — le répertoire complet des outils LLM locaux, options RAG incluses',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[ローカルLLMソフトウェアディレクトリ2026](/ja/directory) — RAG対応オプションを含むローカルLLMツールの完全ディレクトリ',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026年本地LLM软件目录](/zh/directory) —— 包含RAG就绪选项的本地LLM工具完整目录',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Directorio de software de LLM local 2026](/es/directory) — el directorio completo de herramientas de LLM local, incluidas las opciones listas para RAG',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Diretório de Software LLM Local 2026](/pt/directory) — o diretório completo de ferramentas de LLM local, incluindo opções prontas para RAG',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[دليل برامج النماذج اللغوية المحلية 2026](/ar/directory) — الدليل الكامل لأدوات النماذج اللغوية المحلية بما في ذلك خيارات جاهزة لـ RAG',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[로컬 LLM 소프트웨어 디렉토리 2026](/ko/directory) — RAG 지원 옵션을 포함한 로컬 LLM 도구 전체 디렉토리',
