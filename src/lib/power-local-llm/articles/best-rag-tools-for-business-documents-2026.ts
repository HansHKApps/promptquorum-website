...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    metaDescription: 'AnythingLLM وLlamaIndex وPrivateGPT وCognita اختُبرت بوثائق PDF وWord وSharePoint حقيقية — مقارنة الدقة والخصوصية وسهولة النشر المحلي لعام 2026.',
    educationalLevel: 'Intermediate',
    affiliateDisclosure: true,
    publishDate: '2026-05-26',
