  ...
  en: {
    ...
    sections: {
      ...
      scorecard: {
        ...
        rows: [
          { Tool: '[AnythingLLM](https://anythingllm.com)', 'No-code': 'Yes', 'Multi-user': 'Yes (workspaces)', 'Document handling': '9/10', 'Best for': 'Most business teams' },
          { Tool: '[RAGFlow](https://ragflow.io)', 'No-code': 'Yes', 'Multi-user': 'Yes', 'Document handling': '9.5/10', 'Best for': 'Tables, scans, complex layouts' },
          { Tool: '[PrivateGPT](https://github.com/zylon-ai/private-gpt)', 'No-code': 'Basic UI', 'Multi-user': 'No', 'Document handling': '7/10', 'Best for': 'Strict offline/air-gapped use' },
          { Tool: '[Open WebUI](https://openwebui.com)', 'No-code': 'Yes', 'Multi-user': 'Yes', 'Document handling': '8/10', 'Best for': 'Existing Ollama users' },
          { Tool: '[Dify](https://dify.ai)', 'No-code': 'Yes (visual builder)', 'Multi-user': 'Yes', 'Document handling': '8/10', 'Best for': 'AI application workflows' },
          { Tool: '[LlamaIndex](https://www.llamaindex.ai)', 'No-code': 'No (Python SDK)', 'Multi-user': 'Custom', 'Document handling': '9.5/10', 'Best for': 'Custom developer pipelines' },
        ],
      ...
      comparison: {
        ...
        rows: [
          { Tool: '[AnythingLLM](https://anythingllm.com)', Category: 'A — Application', 'No-code UI': 'Yes', 'Multi-user': 'Yes (workspaces)', 'Local LLM': 'Ollama, LM Studio', License: 'MIT' },
          { Tool: '[RAGFlow](https://ragflow.io)', Category: 'A — Application', 'No-code UI': 'Yes', 'Multi-user': 'Yes', 'Local LLM': 'Ollama and others', License: 'Apache 2.0' },
          { Tool: '[PrivateGPT](https://github.com/zylon-ai/private-gpt)', Category: 'A — Application', 'No-code UI': 'Basic UI', 'Multi-user': 'No', 'Local LLM': 'Ollama, llama.cpp', License: 'Apache 2.0' },
          { Tool: '[Open WebUI](https://openwebui.com)', Category: 'A — Application', 'No-code UI': 'Yes', 'Multi-user': 'Yes', 'Local LLM': 'Ollama-native', License: 'BSD-3' },
          { Tool: '[Dify](https://dify.ai)', Category: 'B — App builder', 'No-code UI': 'Yes (visual)', 'Multi-user': 'Yes', 'Local LLM': 'Ollama and others', License: 'Apache 2.0 (partial)' },
          { Tool: '[LlamaIndex](https://www.llamaindex.ai)', Category: 'C — Framework', 'No-code UI': 'No (Python SDK)', 'Multi-user': 'Custom', 'Local LLM': 'Ollama, llama.cpp', License: 'MIT' },
          { Tool: '[Chroma](https://www.trychroma.com)', Category: 'C — Vector DB', 'No-code UI': 'No (API)', 'Multi-user': 'Yes (server mode)', 'Local LLM': 'N/A', License: 'Apache 2.0' },
          { Tool: '[Qdrant](https://qdrant.tech)', Category: 'C — Vector DB', 'No-code UI': 'No (API)', 'Multi-user': 'Yes', 'Local LLM': 'N/A', License: 'Apache 2.0' },
          { Tool: '[Weaviate](https://weaviate.io)', Category: 'C — Vector DB', 'No-code UI': 'No (API)', 'Multi-user': 'Yes', 'Local LLM': 'N/A', License: 'BSD-3' },
        ],
      },
      decisionTree: {
        id: 'decision-tree',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/power-local-llm/local-llm-software-directory) — the full directory of local LLM tools including RAG-ready options',
  ...
  de: {
    ...
    sections: {
      ...
      scorecard: {
        ...
        rows: [
          { Tool: '[AnythingLLM](https://anythingllm.com)', 'Ohne Code': 'Ja', 'Multi-User': 'Ja (Arbeitsbereiche)', Dokumentenverarbeitung: '9/10', 'Am besten für': 'Die meisten Geschäftsteams' },
          { Tool: '[RAGFlow](https://ragflow.io)', 'Ohne Code': 'Ja', 'Multi-User': 'Ja', Dokumentenverarbeitung: '9,5/10', 'Am besten für': 'Tabellen, Scans, komplexe Layouts' },
          { Tool: '[PrivateGPT](https://github.com/zylon-ai/private-gpt)', 'Ohne Code': 'Einfache UI', 'Multi-User': 'Nein', Dokumentenverarbeitung: '7/10', 'Am besten für': 'Strikte Offline-/Air-Gapped-Nutzung' },
          { Tool: '[Open WebUI](https://openwebui.com)', 'Ohne Code': 'Ja', 'Multi-User': 'Ja', Dokumentenverarbeitung: '8/10', 'Am besten für': 'Bestehende Ollama-Nutzer' },
          { Tool: '[Dify](https://dify.ai)', 'Ohne Code': 'Ja (visueller Builder)', 'Multi-User': 'Ja', Dokumentenverarbeitung: '8/10', 'Am besten für': 'KI-Anwendungs-Workflows' },
          { Tool: '[LlamaIndex](https://www.llamaindex.ai)', 'Ohne Code': 'Nein (Python SDK)', 'Multi-User': 'Individuell', Dokumentenverarbeitung: '9,5/10', 'Am besten für': 'Individuelle Entwickler-Pipelines' },
        ],
      ...
      comparison: {
        ...
        rows: [
          { Tool: '[AnythingLLM](https://anythingllm.com)', Kategorie: 'A — Anwendung', 'Ohne-Code-UI': 'Ja', 'Multi-User': 'Ja (Arbeitsbereiche)', 'Lokales LLM': 'Ollama, LM Studio', Lizenz: 'MIT' },
          { Tool: '[RAGFlow](https://ragflow.io)', Kategorie: 'A — Anwendung', 'Ohne-Code-UI': 'Ja', 'Multi-User': 'Ja', 'Lokales LLM': 'Ollama und andere', Lizenz: 'Apache 2.0' },
          { Tool: '[PrivateGPT](https://github.com/zylon-ai/private-gpt)', Kategorie: 'A — Anwendung', 'Ohne-Code-UI': 'Einfache UI', 'Multi-User': 'Nein', 'Lokales LLM': 'Ollama, llama.cpp', Lizenz: 'Apache 2.0' },
          { Tool: '[Open WebUI](https://openwebui.com)', Kategorie: 'A — Anwendung', 'Ohne-Code-UI': 'Ja', 'Multi-User': 'Ja', 'Lokales LLM': 'Ollama-nativ', Lizenz: 'BSD-3' },
          { Tool: '[Dify](https://dify.ai)', Kategorie: 'B — App-Builder', 'Ohne-Code-UI': 'Ja (visuell)', 'Multi-User': 'Ja', 'Lokales LLM': 'Ollama und andere', Lizenz: 'Apache 2.0 (teilweise)' },
          { Tool: '[LlamaIndex](https://www.llamaindex.ai)', Kategorie: 'C — Framework', 'Ohne-Code-UI': 'Nein (Python SDK)', 'Multi-User': 'Individuell', 'Lokales LLM': 'Ollama, llama.cpp', Lizenz: 'MIT' },
          { Tool: '[Chroma](https://www.trychroma.com)', Kategorie: 'C — Vektor-DB', 'Ohne-Code-UI': 'Nein (API)', 'Multi-User': 'Ja (Server-Modus)', 'Lokales LLM': 'N/A', Lizenz: 'Apache 2.0' },
          { Tool: '[Qdrant](https://qdrant.tech)', Kategorie: 'C — Vektor-DB', 'Ohne-Code-UI': 'Nein (API)', 'Multi-User': 'Ja', 'Lokales LLM': 'N/A', Lizenz: 'Apache 2.0' },
          { Tool: '[Weaviate](https://weaviate.io)', Kategorie: 'C — Vektor-DB', 'Ohne-Code-UI': 'Nein (API)', 'Multi-User': 'Ja', 'Lokales LLM': 'N/A', Lizenz: 'BSD-3' },
        ],
      },
      decisionTree: {
        id: 'decision-tree',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Lokales LLM-Software-Verzeichnis 2026](/de/power-local-llm/local-llm-software-directory) — das vollständige Verzeichnis lokaler LLM-Tools einschließlich RAG-fähiger Optionen',
  ...
  fr: {
    ...
    sections: {
      ...
      scorecard: {
        ...
        rows: [
          { Outil: '[AnythingLLM](https://anythingllm.com)', 'Sans code': 'Oui', 'Multi-utilisateurs': 'Oui (espaces)', 'Gestion documentaire': '9/10', 'Idéal pour': 'La plupart des équipes' },
          { Outil: '[RAGFlow](https://ragflow.io)', 'Sans code': 'Oui', 'Multi-utilisateurs': 'Oui', 'Gestion documentaire': '9.5/10', 'Idéal pour': 'Tableaux, scans, mises en page' },
          { Outil: '[PrivateGPT](https://github.com/zylon-ai/private-gpt)', 'Sans code': 'UI basique', 'Multi-utilisateurs': 'Non', 'Gestion documentaire': '7/10', 'Idéal pour': 'Usage hors ligne strict' },
          { Outil: '[Open WebUI](https://openwebui.com)', 'Sans code': 'Oui', 'Multi-utilisateurs': 'Oui', 'Gestion documentaire': '8/10', 'Idéal pour': 'Utilisateurs Ollama existants' },
          { Outil: '[Dify](https://dify.ai)', 'Sans code': 'Oui (visuel)', 'Multi-utilisateurs': 'Oui', 'Gestion documentaire': '8/10', 'Idéal pour': 'Workflows applicatifs IA' },
          { Outil: '[LlamaIndex](https://www.llamaindex.ai)', 'Sans code': 'Non (SDK Python)', 'Multi-utilisateurs': 'Sur mesure', 'Gestion documentaire': '9.5/10', 'Idéal pour': 'Pipelines développeur sur mesure' },
        ],
      ...
      comparison: {
        ...
        rows: [
          { Outil: '[AnythingLLM](https://anythingllm.com)', Catégorie: 'A — Application', 'UI sans code': 'Oui', 'Multi-utilisateurs': 'Oui (espaces)', 'LLM local': 'Ollama, LM Studio', Licence: 'MIT' },
          { Outil: '[RAGFlow](https://ragflow.io)', Catégorie: 'A — Application', 'UI sans code': 'Oui', 'Multi-utilisateurs': 'Oui', 'LLM local': 'Ollama et autres', Licence: 'Apache 2.0' },
          { Outil: '[PrivateGPT](https://github.com/zylon-ai/private-gpt)', Catégorie: 'A — Application', 'UI sans code': 'UI basique', 'Multi-utilisateurs': 'Non', 'LLM local': 'Ollama, llama.cpp', Licence: 'Apache 2.0' },
          { Outil: '[Open WebUI](https://openwebui.com)', Catégorie: 'A — Application', 'UI sans code': 'Oui', 'Multi-utilisateurs': 'Oui', 'LLM local': 'Natif Ollama', Licence: 'BSD-3' },
          { Outil: '[Dify](https://dify.ai)', Catégorie: 'B — Créateur d\'app', 'UI sans code': 'Oui (visuel)', 'Multi-utilisateurs': 'Oui', 'LLM local': 'Ollama et autres', Licence: 'Apache 2.0 (partielle)' },
          { Outil: '[LlamaIndex](https://www.llamaindex.ai)', Catégorie: 'C — Framework', 'UI sans code': 'Non (SDK Python)', 'Multi-utilisateurs': 'Sur mesure', 'LLM local': 'Ollama, llama.cpp', Licence: 'MIT' },
          { Outil: '[Chroma](https://www.trychroma.com)', Catégorie: 'C — Base vectorielle', 'UI sans code': 'Non (API)', 'Multi-utilisateurs': 'Oui (mode serveur)', 'LLM local': 'N/A', Licence: 'Apache 2.0' },
          { Outil: '[Qdrant](https://qdrant.tech)', Catégorie: 'C — Base vectorielle', 'UI sans code': 'Non (API)', 'Multi-utilisateurs': 'Oui', 'LLM local': 'N/A', Licence: 'Apache 2.0' },
          { Outil: '[Weaviate](https://weaviate.io)', Catégorie: 'C — Base vectorielle', 'UI sans code': 'Non (API)', 'Multi-utilisateurs': 'Oui', 'LLM local': 'N/A', Licence: 'BSD-3' },
        ],
      },
      decisionTree: {
        id: 'decision-tree',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Répertoire de logiciels LLM locaux 2026](/fr/power-local-llm/local-llm-software-directory) — le répertoire complet des outils LLM locaux, options RAG incluses',
  ...
  ja: {
    ...
    sections: {
      ...
      scorecard: {
        ...
        rows: [
          { 'ツール': '[AnythingLLM](https://anythingllm.com)', 'ノーコード': 'あり', 'マルチユーザー': 'あり（ワークスペース）', '文書処理': '9/10', '最適な用途': 'ほとんどのビジネスチーム' },
          { 'ツール': '[RAGFlow](https://ragflow.io)', 'ノーコード': 'あり', 'マルチユーザー': 'あり', '文書処理': '9.5/10', '最適な用途': '表、スキャン、複雑なレイアウト' },
          { 'ツール': '[PrivateGPT](https://github.com/zylon-ai/private-gpt)', 'ノーコード': '基本的なUI', 'マルチユーザー': 'なし', '文書処理': '7/10', '最適な用途': '厳格なオフライン／エアギャップ利用' },
          { 'ツール': '[Open WebUI](https://openwebui.com)', 'ノーコード': 'あり', 'マルチユーザー': 'あり', '文書処理': '8/10', '最適な用途': '既存のOllamaユーザー' },
          { 'ツール': '[Dify](https://dify.ai)', 'ノーコード': 'あり（ビジュアルビルダー）', 'マルチユーザー': 'あり', '文書処理': '8/10', '最適な用途': 'AIアプリケーションワークフロー' },
          { 'ツール': '[LlamaIndex](https://www.llamaindex.ai)', 'ノーコード': 'なし（Python SDK）', 'マルチユーザー': 'カスタム', '文書処理': '9.5/10', '最適な用途': 'カスタム開発者パイプライン' },
        ],
      ...
      comparison: {
        ...
        rows: [
          { 'ツール': '[AnythingLLM](https://anythingllm.com)', 'カテゴリー': 'A — アプリケーション', 'ノーコードUI': 'あり', 'マルチユーザー': 'あり（ワークスペース）', 'ローカルLLM': 'Ollama, LM Studio', 'ライセンス': 'MIT' },
          { 'ツール': '[RAGFlow](https://ragflow.io)', 'カテゴリー': 'A — アプリケーション', 'ノーコードUI': 'あり', 'マルチユーザー': 'あり', 'ローカルLLM': 'Ollamaほか', 'ライセンス': 'Apache 2.0' },
          { 'ツール': '[PrivateGPT](https://github.com/zylon-ai/private-gpt)', 'カテゴリー': 'A — アプリケーション', 'ノーコードUI': '基本的なUI', 'マルチユーザー': 'なし', 'ローカルLLM': 'Ollama, llama.cpp', 'ライセンス': 'Apache 2.0' },
          { 'ツール': '[Open WebUI](https://openwebui.com)', 'カテゴリー': 'A — アプリケーション', 'ノーコードUI': 'あり', 'マルチユーザー': 'あり', 'ローカルLLM': 'Ollamaネイティブ', 'ライセンス': 'BSD-3' },
          { 'ツール': '[Dify](https://dify.ai)', 'カテゴリー': 'B — アプリビルダー', 'ノーコードUI': 'あり（ビジュアル）', 'マルチユーザー': 'あり', 'ローカルLLM': 'Ollamaほか', 'ライセンス': 'Apache 2.0（一部）' },
          { 'ツール': '[LlamaIndex](https://www.llamaindex.ai)', 'カテゴリー': 'C — フレームワーク', 'ノーコードUI': 'なし（Python SDK）', 'マルチユーザー': 'カスタム', 'ローカルLLM': 'Ollama, llama.cpp', 'ライセンス': 'MIT' },
          { 'ツール': '[Chroma](https://www.trychroma.com)', 'カテゴリー': 'C — ベクターDB', 'ノーコードUI': 'なし（API）', 'マルチユーザー': 'あり（サーバーモード）', 'ローカルLLM': 'N/A', 'ライセンス': 'Apache 2.0' },
          { 'ツール': '[Qdrant](https://qdrant.tech)', 'カテゴリー': 'C — ベクターDB', 'ノーコードUI': 'なし（API）', 'マルチユーザー': 'あり', 'ローカルLLM': 'N/A', 'ライセンス': 'Apache 2.0' },
          { 'ツール': '[Weaviate](https://weaviate.io)', 'カテゴリー': 'C — ベクターDB', 'ノーコードUI': 'なし（API）', 'マルチユーザー': 'あり', 'ローカルLLM': 'N/A', 'ライセンス': 'BSD-3' },
        ],
      },
      decisionTree: {
        id: 'decision-tree',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[ローカルLLMソフトウェアディレクトリ2026](/ja/power-local-llm/local-llm-software-directory) — RAG対応オプションを含むローカルLLMツールの完全ディレクトリ',
  ...
  zh: {
    ...
    sections: {
      ...
      scorecard: {
        ...
        rows: [
          { '工具': '[AnythingLLM](https://anythingllm.com)', '无代码': '是', '多用户': '是（工作区）', '文档处理能力': '9/10', '最适合': '大多数企业团队' },
          { '工具': '[RAGFlow](https://ragflow.io)', '无代码': '是', '多用户': '是', '文档处理能力': '9.5/10', '最适合': '表格、扫描件、复杂排版' },
          { '工具': '[PrivateGPT](https://github.com/zylon-ai/private-gpt)', '无代码': '基础界面', '多用户': '否', '文档处理能力': '7/10', '最适合': '严格离线/隔离网络场景' },
          { '工具': '[Open WebUI](https://openwebui.com)', '无代码': '是', '多用户': '是', '文档处理能力': '8/10', '最适合': '现有Ollama用户' },
          { '工具': '[Dify](https://dify.ai)', '无代码': '是（可视化构建器）', '多用户': '是', '文档处理能力': '8/10', '最适合': 'AI应用工作流' },
          { '工具': '[LlamaIndex](https://www.llamaindex.ai)', '无代码': '否（Python SDK）', '多用户': '自定义', '文档处理能力': '9.5/10', '最适合': '定制开发者管道' },
        ],
      ...
      comparison: {
        ...
        rows: [
          { '工具': '[AnythingLLM](https://anythingllm.com)', '类别': 'A——应用', '无代码界面': '是', '多用户': '是（工作区）', '本地LLM': 'Ollama、LM Studio', '许可证': 'MIT' },
          { '工具': '[RAGFlow](https://ragflow.io)', '类别': 'A——应用', '无代码界面': '是', '多用户': '是', '本地LLM': 'Ollama及其他', '许可证': 'Apache 2.0' },
          { '工具': '[PrivateGPT](https://github.com/zylon-ai/private-gpt)', '类别': 'A——应用', '无代码界面': '基础界面', '多用户': '否', '本地LLM': 'Ollama、llama.cpp', '许可证': 'Apache 2.0' },
          { '工具': '[Open WebUI](https://openwebui.com)', '类别': 'A——应用', '无代码界面': '是', '多用户': '是', '本地LLM': 'Ollama原生', '许可证': 'BSD-3' },
          { '工具': '[Dify](https://dify.ai)', '类别': 'B——应用构建平台', '无代码界面': '是（可视化）', '多用户': '是', '本地LLM': 'Ollama及其他', '许可证': 'Apache 2.0（部分）' },
          { '工具': '[LlamaIndex](https://www.llamaindex.ai)', '类别': 'C——框架', '无代码界面': '否（Python SDK）', '多用户': '自定义', '本地LLM': 'Ollama、llama.cpp', '许可证': 'MIT' },
          { '工具': '[Chroma](https://www.trychroma.com)', '类别': 'C——向量数据库', '无代码界面': '否（API）', '多用户': '是（服务器模式）', '本地LLM': '不适用', '许可证': 'Apache 2.0' },
          { '工具': '[Qdrant](https://qdrant.tech)', '类别': 'C——向量数据库', '无代码界面': '否（API）', '多用户': '是', '本地LLM': '不适用', '许可证': 'Apache 2.0' },
          { '工具': '[Weaviate](https://weaviate.io)', '类别': 'C——向量数据库', '无代码界面': '否（API）', '多用户': '是', '本地LLM': '不适用', '许可证': 'BSD-3' },
        ],
      },
      decisionTree: {
        id: 'decision-tree',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026年本地LLM软件目录](/zh/power-local-llm/local-llm-software-directory) —— 包含RAG就绪选项的本地LLM工具完整目录',
  ...
  es: {
    ...
    sections: {
      ...
      scorecard: {
        ...
        rows: [
          { Herramienta: '[AnythingLLM](https://anythingllm.com)', 'Sin código': 'Sí', Multiusuario: 'Sí (espacios de trabajo)', 'Gestión de documentos': '9/10', 'Ideal para': 'La mayoría de equipos empresariales' },
          { Herramienta: '[RAGFlow](https://ragflow.io)', 'Sin código': 'Sí', Multiusuario: 'Sí', 'Gestión de documentos': '9.5/10', 'Ideal para': 'Tablas, escaneos, diseños complejos' },
          { Herramienta: '[PrivateGPT](https://github.com/zylon-ai/private-gpt)', 'Sin código': 'Interfaz básica', Multiusuario: 'No', 'Gestión de documentos': '7/10', 'Ideal para': 'Uso offline/air-gapped estricto' },
          { Herramienta: '[Open WebUI](https://openwebui.com)', 'Sin código': 'Sí', Multiusuario: 'Sí', 'Gestión de documentos': '8/10', 'Ideal para': 'Usuarios existentes de Ollama' },
          { Herramienta: '[Dify](https://dify.ai)', 'Sin código': 'Sí (constructor visual)', Multiusuario: 'Sí', 'Gestión de documentos': '8/10', 'Ideal para': 'Flujos de trabajo de aplicaciones IA' },
          { Herramienta: '[LlamaIndex](https://www.llamaindex.ai)', 'Sin código': 'No (SDK de Python)', Multiusuario: 'Personalizable', 'Gestión de documentos': '9.5/10', 'Ideal para': 'Pipelines personalizados para desarrolladores' },
        ],
      ...
      comparison: {
        ...
        rows: [
          { Herramienta: '[AnythingLLM](https://anythingllm.com)', Categoría: 'A — Aplicación', 'Interfaz sin código': 'Sí', Multiusuario: 'Sí (espacios de trabajo)', 'LLM local': 'Ollama, LM Studio', Licencia: 'MIT' },
          { Herramienta: '[RAGFlow](https://ragflow.io)', Categoría: 'A — Aplicación', 'Interfaz sin código': 'Sí', Multiusuario: 'Sí', 'LLM local': 'Ollama y otros', Licencia: 'Apache 2.0' },
          { Herramienta: '[PrivateGPT](https://github.com/zylon-ai/private-gpt)', Categoría: 'A — Aplicación', 'Interfaz sin código': 'Interfaz básica', Multiusuario: 'No', 'LLM local': 'Ollama, llama.cpp', Licencia: 'Apache 2.0' },
          { Herramienta: '[Open WebUI](https://openwebui.com)', Categoría: 'A — Aplicación', 'Interfaz sin código': 'Sí', Multiusuario: 'Sí', 'LLM local': 'Nativo de Ollama', Licencia: 'BSD-3' },
          { Herramienta: '[Dify](https://dify.ai)', Categoría: 'B — Constructor de apps', 'Interfaz sin código': 'Sí (visual)', Multiusuario: 'Sí', 'LLM local': 'Ollama y otros', Licencia: 'Apache 2.0 (parcial)' },
          { Herramienta: '[LlamaIndex](https://www.llamaindex.ai)', Categoría: 'C — Framework', 'Interfaz sin código': 'No (SDK de Python)', Multiusuario: 'Personalizable', 'LLM local': 'Ollama, llama.cpp', Licencia: 'MIT' },
          { Herramienta: '[Chroma](https://www.trychroma.com)', Categoría: 'C — Base de datos vectorial', 'Interfaz sin código': 'No (API)', Multiusuario: 'Sí (modo servidor)', 'LLM local': 'N/D', Licencia: 'Apache 2.0' },
          { Herramienta: '[Qdrant](https://qdrant.tech)', Categoría: 'C — Base de datos vectorial', 'Interfaz sin código': 'No (API)', Multiusuario: 'Sí', 'LLM local': 'N/D', Licencia: 'Apache 2.0' },
          { Herramienta: '[Weaviate](https://weaviate.io)', Categoría: 'C — Base de datos vectorial', 'Interfaz sin código': 'No (API)', Multiusuario: 'Sí', 'LLM local': 'N/D', Licencia: 'BSD-3' },
        ],
      },
      decisionTree: {
        id: 'decision-tree',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Directorio de software de LLM local 2026](/es/power-local-llm/local-llm-software-directory) — el directorio completo de herramientas de LLM local, incluidas las opciones listas para RAG',
  ...
  pt: {
    ...
    sections: {
      ...
      scorecard: {
        ...
        rows: [
          { 'Ferramenta': '[AnythingLLM](https://anythingllm.com)', 'Sem código': 'Sim', 'Multiusuário': 'Sim (espaços de trabalho)', 'Manuseio de documentos': '9/10', 'Melhor para': 'A maioria das equipes corporativas' },
          { 'Ferramenta': '[RAGFlow](https://ragflow.io)', 'Sem código': 'Sim', 'Multiusuário': 'Sim', 'Manuseio de documentos': '9.5/10', 'Melhor para': 'Tabelas, digitalizações, layouts complexos' },
          { 'Ferramenta': '[PrivateGPT](https://github.com/zylon-ai/private-gpt)', 'Sem código': 'Interface básica', 'Multiusuário': 'Não', 'Manuseio de documentos': '7/10', 'Melhor para': 'Uso offline/isolado rigoroso' },
          { 'Ferramenta': '[Open WebUI](https://openwebui.com)', 'Sem código': 'Sim', 'Multiusuário': 'Sim', 'Manuseio de documentos': '8/10', 'Melhor para': 'Quem já usa Ollama' },
          { 'Ferramenta': '[Dify](https://dify.ai)', 'Sem código': 'Sim (construtor visual)', 'Multiusuário': 'Sim', 'Manuseio de documentos': '8/10', 'Melhor para': 'Fluxos de aplicações de IA' },
          { 'Ferramenta': '[LlamaIndex](https://www.llamaindex.ai)', 'Sem código': 'Não (SDK Python)', 'Multiusuário': 'Personalizável', 'Manuseio de documentos': '9.5/10', 'Melhor para': 'Pipelines personalizados' },
        ],
      ...
      comparison: {
        ...
        rows: [
          { 'Ferramenta': '[AnythingLLM](https://anythingllm.com)', 'Categoria': 'A — Aplicação', 'Interface sem código': 'Sim', 'Multiusuário': 'Sim (espaços de trabalho)', 'LLM local': 'Ollama, LM Studio', 'Licença': 'MIT' },
          { 'Ferramenta': '[RAGFlow](https://ragflow.io)', 'Categoria': 'A — Aplicação', 'Interface sem código': 'Sim', 'Multiusuário': 'Sim', 'LLM local': 'Ollama e outros', 'Licença': 'Apache 2.0' },
          { 'Ferramenta': '[PrivateGPT](https://github.com/zylon-ai/private-gpt)', 'Categoria': 'A — Aplicação', 'Interface sem código': 'Interface básica', 'Multiusuário': 'Não', 'LLM local': 'Ollama, llama.cpp', 'Licença': 'Apache 2.0' },
          { 'Ferramenta': '[Open WebUI](https://openwebui.com)', 'Categoria': 'A — Aplicação', 'Interface sem código': 'Sim', 'Multiusuário': 'Sim', 'LLM local': 'Nativo do Ollama', 'Licença': 'BSD-3' },
          { 'Ferramenta': '[Dify](https://dify.ai)', 'Categoria': 'B — Construtor de apps', 'Interface sem código': 'Sim (visual)', 'Multiusuário': 'Sim', 'LLM local': 'Ollama e outros', 'Licença': 'Apache 2.0 (parcial)' },
          { 'Ferramenta': '[LlamaIndex](https://www.llamaindex.ai)', 'Categoria': 'C — Framework', 'Interface sem código': 'Não (SDK Python)', 'Multiusuário': 'Personalizável', 'LLM local': 'Ollama, llama.cpp', 'Licença': 'MIT' },
          { 'Ferramenta': '[Chroma](https://www.trychroma.com)', 'Categoria': 'C — Banco vetorial', 'Interface sem código': 'Não (API)', 'Multiusuário': 'Sim (modo servidor)', 'LLM local': 'N/A', 'Licença': 'Apache 2.0' },
          { 'Ferramenta': '[Qdrant](https://qdrant.tech)', 'Categoria': 'C — Banco vetorial', 'Interface sem código': 'Não (API)', 'Multiusuário': 'Sim', 'LLM local': 'N/A', 'Licença': 'Apache 2.0' },
          { 'Ferramenta': '[Weaviate](https://weaviate.io)', 'Categoria': 'C — Banco vetorial', 'Interface sem código': 'Não (API)', 'Multiusuário': 'Sim', 'LLM local': 'N/A', 'Licença': 'BSD-3' },
        ],
      },
      decisionTree: {
        id: 'decision-tree',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Diretório de Software LLM Local 2026](/pt/power-local-llm/local-llm-software-directory) — o diretório completo de ferramentas de LLM local, incluindo opções prontas para RAG',
  ...
  ar: {
    ...
    sections: {
      ...
      scorecard: {
        ...
        rows: [
          { 'الأداة': '[AnythingLLM](https://anythingllm.com)', 'بدون برمجة': 'نعم', 'متعدد المستخدمين': 'نعم (مساحات عمل)', 'التعامل مع الوثائق': '9/10', 'الأفضل لـ': 'معظم فرق الأعمال' },
          { 'الأداة': '[RAGFlow](https://ragflow.io)', 'بدون برمجة': 'نعم', 'متعدد المستخدمين': 'نعم', 'التعامل مع الوثائق': '9.5/10', 'الأفضل لـ': 'الجداول والمسح الضوئي والتخطيطات المعقدة' },
          { 'الأداة': '[PrivateGPT](https://github.com/zylon-ai/private-gpt)', 'بدون برمجة': 'واجهة أساسية', 'متعدد المستخدمين': 'لا', 'التعامل مع الوثائق': '7/10', 'الأفضل لـ': 'الاستخدام الصارم دون اتصال / المعزول' },
          { 'الأداة': '[Open WebUI](https://openwebui.com)', 'بدون برمجة': 'نعم', 'متعدد المستخدمين': 'نعم', 'التعامل مع الوثائق': '8/10', 'الأفضل لـ': 'مستخدمي Ollama الحاليين' },
          { 'الأداة': '[Dify](https://dify.ai)', 'بدون برمجة': 'نعم (أداة بناء مرئية)', 'متعدد المستخدمين': 'نعم', 'التعامل مع الوثائق': '8/10', 'الأفضل لـ': 'سير عمل تطبيقات الذكاء الاصطناعي' },
          { 'الأداة': '[LlamaIndex](https://www.llamaindex.ai)', 'بدون برمجة': 'لا (Python SDK)', 'متعدد المستخدمين': 'مخصص', 'التعامل مع الوثائق': '9.5/10', 'الأفضل لـ': 'خطوط أنابيب المطورين المخصصة' },
        ],
      ...
      comparison: {
        ...
        rows: [
          { 'الأداة': '[AnythingLLM](https://anythingllm.com)', 'الفئة': 'أ — تطبيق', 'واجهة بدون برمجة': 'نعم', 'متعدد المستخدمين': 'نعم (مساحات عمل)', 'LLM محلي': 'Ollama، LM Studio', 'الترخيص': 'MIT' },
          { 'الأداة': '[RAGFlow](https://ragflow.io)', 'الفئة': 'أ — تطبيق', 'واجهة بدون برمجة': 'نعم', 'متعدد المستخدمين': 'نعم', 'LLM محلي': 'Ollama وغيره', 'الترخيص': 'Apache 2.0' },
          { 'الأداة': '[PrivateGPT](https://github.com/zylon-ai/private-gpt)', 'الفئة': 'أ — تطبيق', 'واجهة بدون برمجة': 'واجهة أساسية', 'متعدد المستخدمين': 'لا', 'LLM محلي': 'Ollama، llama.cpp', 'الترخيص': 'Apache 2.0' },
          { 'الأداة': '[Open WebUI](https://openwebui.com)', 'الفئة': 'أ — تطبيق', 'واجهة بدون برمجة': 'نعم', 'متعدد المستخدمين': 'نعم', 'LLM محلي': 'أصلي لـOllama', 'الترخيص': 'BSD-3' },
          { 'الأداة': '[Dify](https://dify.ai)', 'الفئة': 'ب — أداة بناء تطبيقات', 'واجهة بدون برمجة': 'نعم (مرئية)', 'متعدد المستخدمين': 'نعم', 'LLM محلي': 'Ollama وغيره', 'الترخيص': 'Apache 2.0 (جزئي)' },
          { 'الأداة': '[LlamaIndex](https://www.llamaindex.ai)', 'الفئة': 'ج — إطار عمل', 'واجهة بدون برمجة': 'لا (Python SDK)', 'متعدد المستخدمين': 'مخصص', 'LLM محلي': 'Ollama، llama.cpp', 'الترخيص': 'MIT' },
          { 'الأداة': '[Chroma](https://www.trychroma.com)', 'الفئة': 'ج — قاعدة بيانات متجهة', 'واجهة بدون برمجة': 'لا (API)', 'متعدد المستخدمين': 'نعم (وضع الخادم)', 'LLM محلي': 'غير متاح', 'الترخيص': 'Apache 2.0' },
          { 'الأداة': '[Qdrant](https://qdrant.tech)', 'الفئة': 'ج — قاعدة بيانات متجهة', 'واجهة بدون برمجة': 'لا (API)', 'متعدد المستخدمين': 'نعم', 'LLM محلي': 'غير متاح', 'الترخيص': 'Apache 2.0' },
          { 'الأداة': '[Weaviate](https://weaviate.io)', 'الفئة': 'ج — قاعدة بيانات متجهة', 'واجهة بدون برمجة': 'لا (API)', 'متعدد المستخدمين': 'نعم', 'LLM محلي': 'غير متاح', 'الترخيص': 'BSD-3' },
        ],
      },
      decisionTree: {
        id: 'decision-tree',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[دليل برامج النماذج اللغوية المحلية 2026](/ar/power-local-llm/local-llm-software-directory) — الدليل الكامل لأدوات النماذج اللغوية المحلية بما في ذلك خيارات جاهزة لـ RAG',
  ...
  ko: {
    ...
    sections: {
      ...
      scorecard: {
        ...
        rows: [
          { '도구': '[AnythingLLM](https://anythingllm.com)', '코드 불필요': '예', '멀티 사용자': '예 (워크스페이스)', '문서 처리': '9/10', '적합 대상': '대부분의 기업 팀' },
          { '도구': '[RAGFlow](https://ragflow.io)', '코드 불필요': '예', '멀티 사용자': '예', '문서 처리': '9.5/10', '적합 대상': '표, 스캔, 복잡한 레이아웃' },
          { '도구': '[PrivateGPT](https://github.com/zylon-ai/private-gpt)', '코드 불필요': '기본 UI', '멀티 사용자': '아니요', '문서 처리': '7/10', '적합 대상': '엄격한 오프라인/에어갭 환경' },
          { '도구': '[Open WebUI](https://openwebui.com)', '코드 불필요': '예', '멀티 사용자': '예', '문서 처리': '8/10', '적합 대상': '기존 Ollama 사용자' },
          { '도구': '[Dify](https://dify.ai)', '코드 불필요': '예 (시각적 빌더)', '멀티 사용자': '예', '문서 처리': '8/10', '적합 대상': 'AI 애플리케이션 워크플로우' },
          { '도구': '[LlamaIndex](https://www.llamaindex.ai)', '코드 불필요': '아니요 (Python SDK)', '멀티 사용자': '맞춤 설정', '문서 처리': '9.5/10', '적합 대상': '맞춤형 개발자 파이프라인' },
        ],
      ...
      comparison: {
        ...
        rows: [
          { '도구': '[AnythingLLM](https://anythingllm.com)', '범주': 'A — 애플리케이션', '코드 불필요 UI': '예', '멀티 사용자': '예 (워크스페이스)', '로컬 LLM': 'Ollama, LM Studio', '라이선스': 'MIT' },
          { '도구': '[RAGFlow](https://ragflow.io)', '범주': 'A — 애플리케이션', '코드 불필요 UI': '예', '멀티 사용자': '예', '로컬 LLM': 'Ollama 외', '라이선스': 'Apache 2.0' },
          { '도구': '[PrivateGPT](https://github.com/zylon-ai/private-gpt)', '범주': 'A — 애플리케이션', '코드 불필요 UI': '기본 UI', '멀티 사용자': '아니요', '로컬 LLM': 'Ollama, llama.cpp', '라이선스': 'Apache 2.0' },
          { '도구': '[Open WebUI](https://openwebui.com)', '범주': 'A — 애플리케이션', '코드 불필요 UI': '예', '멀티 사용자': '예', '로컬 LLM': 'Ollama 네이티브', '라이선스': 'BSD-3' },
          { '도구': '[Dify](https://dify.ai)', '범주': 'B — 앱 빌더', '코드 불필요 UI': '예 (시각적)', '멀티 사용자': '예', '로컬 LLM': 'Ollama 외', '라이선스': 'Apache 2.0 (부분)' },
          { '도구': '[LlamaIndex](https://www.llamaindex.ai)', '범주': 'C — 프레임워크', '코드 불필요 UI': '아니요 (Python SDK)', '멀티 사용자': '맞춤 설정', '로컬 LLM': 'Ollama, llama.cpp', '라이선스': 'MIT' },
          { '도구': '[Chroma](https://www.trychroma.com)', '범주': 'C — 벡터 DB', '코드 불필요 UI': '아니요 (API)', '멀티 사용자': '예 (서버 모드)', '로컬 LLM': 'N/A', '라이선스': 'Apache 2.0' },
          { '도구': '[Qdrant](https://qdrant.tech)', '범주': 'C — 벡터 DB', '코드 불필요 UI': '아니요 (API)', '멀티 사용자': '예', '로컬 LLM': 'N/A', '라이선스': 'Apache 2.0' },
          { '도구': '[Weaviate](https://weaviate.io)', '범주': 'C — 벡터 DB', '코드 불필요 UI': '아니요 (API)', '멀티 사용자': '예', '로컬 LLM': 'N/A', '라이선스': 'BSD-3' },
        ],
      },
      decisionTree: {
        id: 'decision-tree',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[로컬 LLM 소프트웨어 디렉토리 2026](/ko/power-local-llm/local-llm-software-directory) — RAG 지원 옵션을 포함한 로컬 LLM 도구 전체 디렉토리',
