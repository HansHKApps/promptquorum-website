    ...
    sections: {
      ...
      generationDifferences: {
        ...
        items: [
          ...
          '**License and price.** AUTOMATIC1111, DiffusionBee, Stable Diffusion WebUI Forge and Locally Uncensored are AGPL-3.0; ComfyUI and Fooocus are GPL-3.0; AnimateDiff, ControlNet and Invoke AI are Apache-2.0; StableSwarmUI and ToolNeuron are MIT; [Stable Diffusion](/power-local-llm/stable-diffusion-review) uses an OpenRAIL license. Draw Things is a closed-source app, Locally Uncensored is free and open source with an optional paid cloud add-on, and Invoke AI is freemium. Copyleft licenses attach conditions to distributing modified versions — see [AI Tool Licenses Explained](/power-local-llm/ai-tool-licenses-explained).',
        ],
      },
      visionDifferences: {
    ...
    sections: {
      ...
      generationDifferences: {
        ...
        items: [
          ...
          '**Lizenz und Preis.** AUTOMATIC1111, DiffusionBee, Stable Diffusion WebUI Forge und Locally Uncensored stehen unter AGPL-3.0; ComfyUI und Fooocus unter GPL-3.0; AnimateDiff, ControlNet und Invoke AI unter Apache-2.0; StableSwarmUI und ToolNeuron unter MIT; [Stable Diffusion](/de/power-local-llm/stable-diffusion-review) verwendet eine OpenRAIL-Lizenz. Draw Things ist eine Closed-Source-App, Locally Uncensored ist kostenlos und quelloffen mit einer optionalen kostenpflichtigen Cloud-Erweiterung, und Invoke AI ist Freemium. Copyleft-Lizenzen knüpfen Bedingungen an die Weitergabe veränderter Versionen — siehe [KI-Tool-Lizenzen erklärt](/de/power-local-llm/ai-tool-licenses-explained).',
        ],
      },
      visionDifferences: {
        id: 'vision-differences',
    ...
    sections: {
      ...
      generationDifferences: {
        ...
        items: [
          ...
          '**الرخصة والسعر.** AUTOMATIC1111 وDiffusionBee وStable Diffusion WebUI Forge وLocally Uncensored بترخيص AGPL-3.0؛ وComfyUI وFooocus بترخيص GPL-3.0؛ وAnimateDiff وControlNet وInvoke AI بترخيص Apache-2.0؛ وStableSwarmUI وToolNeuron بترخيص MIT؛ ويستخدم [Stable Diffusion](/ar/power-local-llm/stable-diffusion-review) ترخيص OpenRAIL. Draw Things تطبيق مغلق المصدر، وLocally Uncensored مجاني ومفتوح المصدر مع إضافة سحابية مدفوعة اختيارية، وInvoke AI بنموذج فريميوم. تفرض تراخيص copyleft شروطًا على توزيع النسخ المعدّلة — راجع [شرح تراخيص أدوات الذكاء الاصطناعي](/ar/power-local-llm/ai-tool-licenses-explained).',
        ],
      },
      visionDifferences: {
        id: 'vision-differences',
