...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'الذكاء الاصطناعي المحلي بلا إنترنت خلف جدار الحماية 2026: دليل الإعداد',
    intro:
    ...
    metaDescription:
      'نشر نماذج LLM المحلية بدون إنترنت خلف جدار الحماية: قائمة تحقق شاملة، سير عمل air-gap مع Ollama وllama.cpp، تحديد حجم NAS، وملاحظات الامتثال.',
    twitterDescription:
