...
export const article: Partial<Record<Language, LLMArticle>> = {
    ...
    quickAnswerTop: {
      en: {
        ...
        bullets: [
          ...
          'Verify: `ollama run qwen3:14b` works fully offline',
      ...
      zh: {
        ...
        bullets: ['下载：Ollama + GGUF模型 + 分词器配置', '传输：USB/SSD或内部网络共享', '《数据安全法》/CAC：本地推理，数据不出设备', '验证：`ollama run qwen3:14b`完全离线运行'],
        updatedDate: '2026-08',
      },
    },
    toc: [
    ...
    sections: {
      ...
      preflight: {
        ...
        numberedItems: [
          ...
          '**Model GGUF file** — pull via `ollama pull qwen3:14b` on the connected machine. Models cache to `~/.ollama/models/`.',
      ...
      ollamaAirgap: {
        ...
        numberedItems: [
          ...
          'Test offline: `ollama run qwen3:14b` — should respond immediately without hitting any external URL.',
      ...
      llamacppAirgap: {
        ...
        items: [
          ...
          'Run: `./llama-server -m ./qwen3-14b-instruct-q4_K_M.gguf --port 8080`',
  ...
  fr: {
    freshness_tier: 'semi_annual', publishDate: '2026-05-26', dateModified: '2026-08-29', next_refresh_due: '2026-11-26',
    theme: 'Overview & Reference',
  ...
  ja: {
    ...
    sections: {
      ...
      preflight: { id: 'preflight', title: '事前チェックリスト', content: '孤立環境に移る前に接続マシンですべて確認。', numberedItems: ['**Ollamaバイナリ** — ollama.comからOS用をダウンロード。バージョン≥0.3.0推奨。', '**モデルGGUF** — `ollama pull qwen3:14b`を接続マシンで実行。', '**埋め込みモデル**（オフラインRAG用）— `ollama pull nomic-embed-text`。', '**検証ハッシュ** — 転送前に各GGUFファイルで`sha256sum`を実行。'] },
    ...
    quickAnswerTop: {
      es: {
        ...
        bullets: [
          ...
          'Verificación: `ollama run qwen3:14b` funciona completamente offline',
    ...
    sections: {
      ...
      preflight: {
        ...
        numberedItems: [
          ...
          '**Archivo GGUF del modelo** — ejecútalo con `ollama pull qwen3:14b` en la máquina conectada. Los modelos se almacenan en caché en `~/.ollama/models/`.',
      ...
      ollamaAirgap: {
        ...
        numberedItems: [
          ...
          'Prueba offline: `ollama run qwen3:14b` — debería responder de inmediato sin acceder a ninguna URL externa.',
      ...
      llamacppAirgap: {
        ...
        items: [
          ...
          'Ejecuta: `./llama-server -m ./qwen3-14b-instruct-q4_K_M.gguf --port 8080`',
    ...
    quickAnswerTop: {
      ko: {
        ...
        bullets: [
          ...
          '검증: `ollama run qwen3:14b` 완전 오프라인 동작 확인',
    ...
    sections: {
      ...
      preflight: {
        ...
        numberedItems: [
          ...
          '**모델 GGUF 파일** — 연결된 기기에서 `ollama pull qwen3:14b`을 실행하십시오. 모델은 `~/.ollama/models/`에 캐시됩니다.',
      ...
      ollamaAirgap: {
        ...
        numberedItems: [
          ...
          '오프라인 테스트: `ollama run qwen3:14b` — 외부 URL 접속 없이 즉시 응답해야 합니다.',
      ...
      llamacppAirgap: {
        ...
        items: [
          ...
          '실행: `./llama-server -m ./qwen3-14b-instruct-q4_K_M.gguf --port 8080`',
    ...
    quickAnswerTop: {
      pt: {
        ...
        bullets: [
          ...
          'Verificação: `ollama run qwen3:14b` funciona totalmente offline',
    ...
    sections: {
      ...
      preflight: {
        ...
        numberedItems: [
          ...
          '**Arquivo GGUF do modelo** — baixe via `ollama pull qwen3:14b` na máquina conectada. Os modelos são armazenados em cache em `~/.ollama/models/`.',
      ...
      ollamaAirgap: {
        ...
        numberedItems: [
          ...
          'Teste offline: `ollama run qwen3:14b` — deve responder imediatamente sem acessar nenhuma URL externa.',
      ...
      llamacppAirgap: {
        ...
        items: [
          ...
          'Execute: `./llama-server -m ./qwen3-14b-instruct-q4_K_M.gguf --port 8080`',
    ...
    quickAnswerTop: {
      ar: {
        ...
        bullets: [
          ...
          'التحقق: `ollama run qwen3:14b` يعمل بالكامل دون إنترنت',
    ...
    sections: {
      ...
      preflight: {
        ...
        numberedItems: [
          ...
          '**ملف GGUF للنموذج** — شغّل `ollama pull qwen3:14b` على الجهاز المتصل. تُخزَّن النماذج في `~/.ollama/models/`.',
      ...
      ollamaAirgap: {
        ...
        numberedItems: [
          ...
          'اختبر بدون إنترنت: `ollama run qwen3:14b` — يجب أن يستجيب فورًا دون الوصول إلى أي عنوان URL خارجي.',
      ...
      llamacppAirgap: {
        ...
        items: [
          ...
          'شغّل: `./llama-server -m ./qwen3-14b-instruct-q4_K_M.gguf --port 8080`',
