...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'Ollama + MCP محلياً 2026: ربط قواعد البيانات وAPIs',
    intro:
    ...
    metaDescription:
      'MCP يُتيح لـOllama استعلام Postgres وقراءة الملفات والتحكم في المتصفح محلياً. إعداد لـfilesystem وSQLite وGitHub مع نموذج sandboxing للأمان في 2026.',
    twitterDescription:
