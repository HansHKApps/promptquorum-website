...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  pt: {
    ...
    sections: {
      ...
      url: 'https://www.promptquorum.com/pt/pt/power-local-llm/best-gpu-buying-guide-local-llm-2026',
      inLanguage: 'pt-BR',
  ...
  ar: {
    ...
    seoTitle: 'أفضل GPU للنماذج اللغوية المحلية 2026: من الميزانية إلى RTX 5090',
    intro:
    ...
    metaDescription:
      'ثماني وحدات معالجة رسومات مقارَنة للنماذج اللغوية المحلية في 4 ميزانيات: من RTX 3060 إلى RTX 5090. VRAM والرموز في الثانية واستهلاك الطاقة وأسعار مايو 2026.',
    twitterDescription:
