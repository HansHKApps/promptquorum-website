    ...
    sections: {
      ...
      comparisonTable: {
        ...
        rows: [
          ...
          { 'Tool': '[CrewAI](/power-local-llm/crewai-review)', 'Interface': 'Python code', 'License': 'MIT (core)', 'Backing': 'CrewAI Inc. (VC-backed)', 'Best For': 'Role-based multi-agent crews' },
      ...
      faq: {
        ...
        faqs: [
          ...
          { q: 'Is AutoGen better than CrewAI?', a: "They target different patterns. AutoGen (and its successors) favor free-form, conversation-driven multi-agent orchestration with code execution; [CrewAI](/power-local-llm/crewai-review) provides a more structured, role-based 'crew' abstraction with defined tasks. Which fits better depends on how much structure your workflow needs." },
        ],
      },
      sources: {
        id: 'sources',
