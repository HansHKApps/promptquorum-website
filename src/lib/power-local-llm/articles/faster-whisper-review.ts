    ...
    for word in segment.words:
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Piper TTS Review](/power-local-llm/local-tts-voice-cloning-piper-coqui-xtts) — the local text-to-speech counterpart, for turning generated text back into speech offline.',
