...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'أفضل أدوات الذكاء الاصطناعي للبرمجة 2026: Cursor والمزيد',
    intro:
    ...
    metaDescription:
      'قارن أفضل أدوات البرمجة بالذكاء الاصطناعي في 2026: GitHub Copilot وCursor وCline وContinue.dev. الأسعار والنماذج المحلية مقابل السحابة والميزات الوكيلية.',
    twitterDescription:
