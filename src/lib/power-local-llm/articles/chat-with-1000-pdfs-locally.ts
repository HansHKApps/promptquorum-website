    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[RAGFlow: Deep Document Understanding & Citations](/power-local-llm/ragflow-document-understanding-rag-review) — for collections dominated by scanned contracts and tables, not plain text, RAGFlow\'s layout-aware parsing is worth the heavier setup.',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[RAGFlow: Tiefes Dokumentenverständnis & Zitate](/de/power-local-llm/ragflow-document-understanding-rag-review) – für Sammlungen aus gescannten Verträgen und Tabellen statt reinem Text lohnt sich RAGFlows layoutbewusstes Parsing trotz aufwändigerem Setup.',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[RAGFlow : compréhension approfondie des documents et citations](/fr/power-local-llm/ragflow-document-understanding-rag-review) – pour des collections dominées par des contrats scannés et des tableaux plutôt que du texte brut, l\'analyse sensible à la mise en page de RAGFlow vaut l\'installation plus lourde.',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[RAGFlow：深い文書理解と引用](/ja/power-local-llm/ragflow-document-understanding-rag-review) – スキャン契約書や表が中心のコレクションでは、プレーンテキストと違いRAGFlowのレイアウト認識解析がセットアップの重さに見合う価値を持つ。',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[RAGFlow：深度文档理解与引用](/zh/power-local-llm/ragflow-document-understanding-rag-review) — 对于以扫描合同和表格为主而非纯文本的文档集合,RAGFlow的版面感知解析值得更重的部署成本。',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[RAGFlow: comprensión profunda de documentos y citas](/es/power-local-llm/ragflow-document-understanding-rag-review) — para colecciones dominadas por contratos escaneados y tablas en lugar de texto plano, el análisis sensible al diseño de RAGFlow vale la instalación más pesada.',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[RAGFlow: 깊이 있는 문서 이해와 인용](/ko/power-local-llm/ragflow-document-understanding-rag-review) — 순수 텍스트가 아닌 스캔 계약서와 표가 주를 이루는 컬렉션이라면, RAGFlow의 레이아웃 인식 분석은 더 무거운 설치를 감수할 가치가 있습니다.',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[RAGFlow: compreensão profunda de documentos e citações](/pt/power-local-llm/ragflow-document-understanding-rag-review) — para coleções dominadas por contratos escaneados e tabelas em vez de texto simples, a análise sensível ao layout do RAGFlow compensa a instalação mais pesada.',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[RAGFlow: فهم عميق للمستندات واستشهادات موثوقة](/ar/power-local-llm/ragflow-document-understanding-rag-review) — لمجموعات تهيمن عليها العقود الممسوحة ضوئيًا والجداول بدلًا من النص العادي، يستحق تحليل RAGFlow الواعي بالتخطيط إعدادًا أثقل.',
