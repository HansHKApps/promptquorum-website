    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/directory) — directory listings for Ollama, Smart Connections, Copilot, and other components in this stack.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Lokales LLM Software-Verzeichnis 2026](/de/directory) — Verzeichniseinträge zu Ollama, Smart Connections, Copilot und weiteren Komponenten dieses Stacks.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Annuaire Logiciels LLM Local 2026](/fr/directory) — listings d\'annuaires pour Ollama, Smart Connections, Copilot et autres composants de cette pile.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[ローカルLLMソフトウェアディレクトリ2026](/ja/directory) — Ollama、Smart Connections、Copilot、このスタックの他のコンポーネントのディレクトリリスティング。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[本地大模型软件目录 2026](/zh/directory) — Ollama、Smart Connections、Copilot 和此堆栈中其他组件的目录列表。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Directorio de software LLM local 2026](/es/directory) — listados del directorio para Ollama, Smart Connections, Copilot y otros componentes de esta pila.',
        ],
      },
    },
      schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Diretório de software de LLM local 2026](/pt/directory) — listagens de diretório para Ollama, Smart Connections, Copilot e outros componentes desta pilha.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[دليل برامج LLM المحلية 2026](/ar/directory) — قوائم الدليل لـ Ollama وSmart Connections وCopilot وغيرها من مكونات هذا المكدس.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026년 로컬 LLM 소프트웨어 디렉토리](/ko/directory) — Ollama, Smart Connections, Copilot 및 이 스택의 다른 구성 요소에 대한 디렉토리 목록.',
        ],
      },
    },
    schema: {
