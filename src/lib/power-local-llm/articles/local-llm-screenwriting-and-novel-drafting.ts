...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  pt: {
    ...
    sections: {
      ...
      url: 'https://www.promptquorum.com/pt/pt/power-local-llm/local-llm-screenwriting-and-novel-drafting',
      inLanguage: 'pt-BR',
      datePublished: '2026-05-24',
      dateModified: '2026-05-24',
      author: { '@type': 'Person', name: 'Hans Kuepper' },
  ...
  ar: {
    ...
    seoTitle: 'نموذج لغوي محلي لكتابة السيناريوهات والروايات بدون اتصال 2026',
    intro:
    ...
    metaDescription:
      'سير عمل كامل لاستخدام النماذج اللغوية المحلية في كتابة الروايات والسيناريوهات: اختيار النماذج وإدارة السياق والسقالات الفصلية وتوليد المشاهد.',
    twitterDescription:
