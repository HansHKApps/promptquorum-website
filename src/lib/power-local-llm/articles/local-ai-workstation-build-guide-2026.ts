...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  es: {
    ...
    sections: {
      ...
      url: 'https://www.promptquorum.com/es/es/power-local-llm/local-ai-workstation-build-guide-2026',
      inLanguage: 'es',
  ...
  ar: {
    ...
    seoTitle: 'حاسوب الذكاء الاصطناعي المحلي 2026: من الاقتصادي إلى محطة عمل 70B',
    intro:
    ...
    metaDescription:
      'ثلاثة أحاسيب للذكاء الاصطناعي المحلي في 2026: اقتصادي 7B–13B ومتوسط 14B–33B ومتحمس 70B. قوائم مكوّنات دقيقة وتوكن/ثانية متوقع وتكاليف إجمالية.',
    twitterDescription:
