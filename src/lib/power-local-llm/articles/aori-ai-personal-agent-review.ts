    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/directory) — full directory of local-AI apps and tools across platforms.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[دليل برمجيات LLM المحلية 2026](/ar/directory) — دليل كامل لتطبيقات وأدوات الذكاء الاصطناعي المحلي عبر المنصات.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Directorio de software de LLM local 2026](/es/directory) — directorio completo de apps y herramientas de IA local para todas las plataformas.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Répertoire de logiciels LLM locaux 2026](/fr/directory) — répertoire complet des applications et outils d\'IA locale pour toutes les plateformes.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[ローカルLLMソフトウェアディレクトリ2026](/ja/directory) — 全プラットフォーム向けローカルAIアプリ・ツールの完全な一覧。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[로컬 LLM 소프트웨어 디렉토리 2026](/ko/directory) — 모든 플랫폼을 아우르는 로컬 AI 앱 및 도구 전체 디렉토리.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Diretório de software de LLM local 2026](/pt/directory) — diretório completo de apps e ferramentas de IA local para todas as plataformas.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026 本地 LLM 软件目录](/zh/directory) —— 涵盖所有平台的本地 AI 应用和工具完整目录。',
        ],
      },
    },
  },
