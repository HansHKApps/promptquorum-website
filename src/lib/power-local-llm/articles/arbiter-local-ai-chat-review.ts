    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026年版ローカルLLMソフトウェアディレクトリ](/ja/power-local-llm/local-llm-software-directory) — 全プラットフォームを網羅した総合アプリ・ツールディレクトリ。',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026 年本地大模型软件目录](/zh/power-local-llm/local-llm-software-directory) —— 覆盖所有平台的综合应用与工具目录。',
        ],
      },
    },
    schema: {
