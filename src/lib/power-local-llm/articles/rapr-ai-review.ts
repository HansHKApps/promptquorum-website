...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    title: 'RAPR AI Review: Local Desktop Command Center for Ollama, Claude and Gemini',
    seoTitle: 'RAPR AI Review: Desktop AI Agent Command Center',
    intro:
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[The Complete Local LLM Software Directory: ' + TOTAL_TOOL_COUNT + ' Tools to Run AI on Your Own Hardware (2026)](/directory) — see where RAPR AI fits among other local and hybrid AI tools.',
        ],
      },
    },
  },
  ar: {
    ...
    title: 'مراجعة ⁨RAPR AI⁩: مركز تحكم سطح مكتب محلي لـ ⁨Ollama⁩ و⁨Claude⁩ و⁨Gemini⁩',
    seoTitle: 'مراجعة ⁨RAPR AI⁩: مركز تحكم لوكلاء الذكاء الاصطناعي',
    intro:
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[الدليل الكامل لبرمجيات LLM المحلية: ' + TOTAL_TOOL_COUNT + ' أداة لتشغيل الذكاء الاصطناعي على عتادك الخاص (2026)](/ar/directory) — تعرّف على موقع ⁨RAPR AI⁩ بين أدوات الذكاء الاصطناعي المحلية والهجينة الأخرى.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Das vollständige lokale LLM-Software-Verzeichnis: ' + TOTAL_TOOL_COUNT + ' Tools für KI auf eigener Hardware (2026)](/de/directory) — sehen Sie, wo sich RAPR AI unter anderen lokalen und hybriden KI-Werkzeugen einordnet.',
        ],
      },
    },
  },
  es: {
    ...
    title: 'Reseña de RAPR AI: Centro de Control de Escritorio Local para Ollama, Claude y Gemini',
    seoTitle: 'Reseña RAPR AI: Centro de Control de Agentes IA',
    intro:
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[El directorio completo de software LLM local: ' + TOTAL_TOOL_COUNT + ' herramientas para IA en tu propio hardware (2026)](/es/directory) — descubre dónde encaja RAPR AI entre otras herramientas de IA locales e híbridas.',
        ],
      },
    },
  },
  fr: {
    ...
    title: 'RAPR AI: notre avis — centre de contrôle local pour Ollama, Claude et Gemini',
    seoTitle: 'RAPR AI: avis sur ce centre de contrôle IA',
    intro:
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Le répertoire complet des logiciels LLM locaux : ' + TOTAL_TOOL_COUNT + ' outils pour faire tourner l\'IA sur votre propre matériel (2026)](/fr/directory) — voyez où se situe RAPR AI parmi les autres outils d\'IA locaux et hybrides.',
        ],
      },
    },
  },
  ja: {
    ...
    title: 'RAPR AIレビュー：Ollama・Claude・Geminiをまとめるローカルデスクトップ司令塔',
    seoTitle: 'RAPR AIレビュー：AIエージェント司令塔アプリ',
    intro:
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[完全版ローカルLLMソフトウェアディレクトリ：自分のハードウェアでAIを動かす' + TOTAL_TOOL_COUNT + 'のツール（2026）](/ja/directory) — 他のローカル／ハイブリッドAIツールの中でRAPR AIがどう位置づけられるかを確認できます。',
        ],
      },
    },
  },
  pt: {
    ...
    title: 'RAPR AI: Análise — Central de Comando Local para Ollama, Claude e Gemini',
    seoTitle: 'RAPR AI: Análise da Central de Agentes de IA',
    intro:
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[O diretório completo de software LLM local: ' + TOTAL_TOOL_COUNT + ' ferramentas para rodar IA no seu próprio hardware (2026)](/pt/directory) — veja onde a RAPR AI se encaixa entre outras ferramentas de IA locais e híbridas.',
        ],
      },
    },
  },
  zh: {
    ...
    title: 'RAPR AI 评测：整合 Ollama、Claude 与 Gemini 的本地桌面指挥中心',
    seoTitle: 'RAPR AI 评测：AI 智能体指挥中心',
    intro:
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[完整本地 LLM 软件目录:在自己硬件上运行 AI 的 ' + TOTAL_TOOL_COUNT + ' 种工具(2026)](/zh/directory)——了解 RAPR AI 在其他本地与混合 AI 工具中的定位。',
        ],
      },
    },
  },
  ko: {
    ...
    title: 'RAPR AI 리뷰: Ollama·Claude·Gemini를 위한 로컬 데스크톱 커맨드 센터',
    seoTitle: 'RAPR AI 리뷰: AI 에이전트 커맨드 센터',
    intro:
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[완전한 로컬 LLM 소프트웨어 디렉터리: 자신의 하드웨어에서 AI를 실행하는 ' + TOTAL_TOOL_COUNT + '개의 도구(2026)](/ko/directory) — 다른 로컬 및 하이브리드 AI 도구들 사이에서 RAPR AI가 어디에 위치하는지 확인할 수 있습니다.',
        ],
      },
    },
  },
