    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[The Complete Local LLM Software Directory: ' + TOTAL_TOOL_COUNT + ' Tools to Run AI on Your Own Hardware (2026)](/power-local-llm/local-llm-software-directory) — see where RAPR AI fits among other local and hybrid AI tools.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[الدليل الكامل لبرمجيات LLM المحلية: ' + TOTAL_TOOL_COUNT + ' أداة لتشغيل الذكاء الاصطناعي على عتادك الخاص (2026)](/ar/power-local-llm/local-llm-software-directory) — تعرّف على موقع ⁨RAPR AI⁩ بين أدوات الذكاء الاصطناعي المحلية والهجينة الأخرى.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Das vollständige lokale LLM-Software-Verzeichnis: ' + TOTAL_TOOL_COUNT + ' Tools für KI auf eigener Hardware (2026)](/de/power-local-llm/local-llm-software-directory) — sehen Sie, wo sich RAPR AI unter anderen lokalen und hybriden KI-Werkzeugen einordnet.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[El directorio completo de software LLM local: ' + TOTAL_TOOL_COUNT + ' herramientas para IA en tu propio hardware (2026)](/es/power-local-llm/local-llm-software-directory) — descubre dónde encaja RAPR AI entre otras herramientas de IA locales e híbridas.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Le répertoire complet des logiciels LLM locaux : ' + TOTAL_TOOL_COUNT + ' outils pour faire tourner l\'IA sur votre propre matériel (2026)](/fr/power-local-llm/local-llm-software-directory) — voyez où se situe RAPR AI parmi les autres outils d\'IA locaux et hybrides.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[完全版ローカルLLMソフトウェアディレクトリ：自分のハードウェアでAIを動かす' + TOTAL_TOOL_COUNT + 'のツール（2026）](/ja/power-local-llm/local-llm-software-directory) — 他のローカル／ハイブリッドAIツールの中でRAPR AIがどう位置づけられるかを確認できます。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[O diretório completo de software LLM local: ' + TOTAL_TOOL_COUNT + ' ferramentas para rodar IA no seu próprio hardware (2026)](/pt/power-local-llm/local-llm-software-directory) — veja onde a RAPR AI se encaixa entre outras ferramentas de IA locais e híbridas.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[完整本地 LLM 软件目录:在自己硬件上运行 AI 的 ' + TOTAL_TOOL_COUNT + ' 种工具(2026)](/zh/power-local-llm/local-llm-software-directory)——了解 RAPR AI 在其他本地与混合 AI 工具中的定位。',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[완전한 로컬 LLM 소프트웨어 디렉터리: 자신의 하드웨어에서 AI를 실행하는 ' + TOTAL_TOOL_COUNT + '개의 도구(2026)](/ko/power-local-llm/local-llm-software-directory) — 다른 로컬 및 하이브리드 AI 도구들 사이에서 RAPR AI가 어디에 위치하는지 확인할 수 있습니다.',
        ],
      },
    },
  },
