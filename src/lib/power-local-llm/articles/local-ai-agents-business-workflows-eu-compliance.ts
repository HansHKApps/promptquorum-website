...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  pt: {
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/pt/pt/power-local-llm/local-ai-agents-business-workflows-eu-compliance',
      inLanguage: 'pt-BR',
      author: { '@type': 'Person', name: 'Hans Kuepper' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
    },
    sections: {
      ...
      modelPick: {
        ...
        items: [
          ...
          '**Mistral Large.** Alternativa hospedada na UE para configurações híbridas onde o local puro é excessivo mas a nuvem americana não é uma opção.',
  ...
  ar: {
    ...
    seoTitle: 'وكلاء الذكاء الاصطناعي المحلي للأعمال: GDPR وEU AI Act',
    intro:
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'إذا كان المتحكم في البيانات هو الكيان الأوروبي وبقيت البيانات في البنية التحتية الأوروبية، فإن البنية المحلية المحضة تغطي معظم المخاوف عبر الحدود افتراضياً. Mistral Large على Scaleway هو الخيار الهجين الشائع حين لا يكون المحلي المحض كافياً ولا يكون الخيار السحابي الأمريكي ممكناً.',
          },
        ],
      },
      relatedReading: {
