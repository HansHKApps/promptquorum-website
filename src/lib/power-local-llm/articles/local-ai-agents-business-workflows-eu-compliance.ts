...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'وكلاء الذكاء الاصطناعي المحلي للأعمال المؤسسية 2026: الامتثال لـGDPR وEU AI Act',
    intro:
    ...
    metaDescription:
      'انشر وكلاء ذكاء اصطناعي محلي لمعالجة المستندات وإدارة البريد الإلكتروني وإعداد التقارير وفق GDPR وEU AI Act. البنية وضوابط الامتثال و5 قوالب لسير العمل.',
    twitterDescription:
