...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'أفضل نماذج LLM المحلية للكتابة الإبداعية 2026: اختبارات وتوصيات',
    intro:
    ...
    metaDescription:
      'مقارنة 6 نماذج محلية للكتابة الإبداعية: Llama 3.3 وQwen3 وMistral Large وCommand R+ وYi-1.5 والمتغيرات غير المقيدة. اختُبرت على أكثر من 50 طلباً إبداعياً.',
    twitterDescription:
