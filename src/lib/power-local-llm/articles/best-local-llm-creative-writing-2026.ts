...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  pt: {
    ...
    sections: {
      ...
      url: 'https://www.promptquorum.com/pt/pt/power-local-llm/best-local-llm-creative-writing-2026',
      inLanguage: 'pt-BR',
      datePublished: '2026-05-24',
      dateModified: '2026-05-24',
      author: { '@type': 'Person', name: 'Hans Kuepper' },
  ...
  ar: {
    ...
    seoTitle: 'LLMs محلية للكتابة الإبداعية 2026: Llama وQwen3',
    intro:
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'AI 신호 — "등골이 오싹했다", "태피스트리", "깊이 파고들다", "헤쳐나가다", ChatGPT 스타일 전환 요약 같은 표현들 — 는 소형 인스트럭트 모델에서 더 자주 나타납니다. Llama 3.3 70B와 Qwen3 32B는 20B 미만 모델보다 신호가 적습니다. Hermes 3은 이 집합에서 가장 적습니다: RLHF 거부 패턴 훈련이 많은 공식적인 전환이 도입된 곳이기도 하며, 그것을 제거하면 둘 다 제거됩니다. 신호 감소를 위한 가장 큰 영향력 레버는 모델이 아니라 부정적 예시가 있는 시스템 프롬프트("'등골', '태피스트리', '깊이 파고들다'를 쓰지 마세요")입니다.',
          },
          {
