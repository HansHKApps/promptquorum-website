  ...
  ja: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '関連記事',
        items: [
          '[OS別最簡ローカルAIアプリ：Windows、Mac、Linuxの推奨](/power-local-llm/easiest-local-ai-app-windows-mac-linux?lang=ja) — ロースペックPCユーザーの多くは旧Windows使用、このガイドはOSごとに1つ選定。',
          '[2026年Android向けベストローカルLLMアプリ](/power-local-llm/best-local-llm-apps-android-2026?lang=ja) — 最新Android端末を持つロースペックユーザーの自然な代替肢。',
          '[ローカルAIエージェントでZapierを置き換える](/power-local-llm/replace-zapier-with-local-ai-agents?lang=ja) — 同じハードウェア上の予算ユーザー向け実用的ワークフロー自動化。',
          '[LM Studio vs Jan vs GPT4All：2026年に勝つローカルAIアプリは](/power-local-llm/lm-studio-vs-jan-vs-gpt4all-2026?lang=ja) — LM Studioも候補に入れる場合の直接比較。',
          '[ローカルLLM向けベスト予算GPU](/local-llms/best-budget-gpus-local-llm?lang=ja) — CPU専用領域から脱却する準備ができた時に。',
          '[2026年ローカルLLMハードウェアガイド](/local-llms/local-llm-hardware-guide-2026?lang=ja) — RAM、CPU、GPUのトレードオフを含むハードウェアの完全な権威。',
          '[Power Local LLMハブ](/power-local-llm?lang=ja) — クラスター完全ガイドライブラリ。',
        ],
      },
    },
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      'url': 'https://www.promptquorum.com/power-local-llm/best-local-ai-app-low-end-pc?lang=ja',
      'inLanguage': 'ja',
    ...
    breadcrumbSchema: {
      ...
      'itemListElement': [
        ...
        { '@type': 'ListItem', 'position': 2, 'name': 'Power Local LLM', 'item': 'https://www.promptquorum.com/power-local-llm?lang=ja' },
        { '@type': 'ListItem', 'position': 3, 'name': 'ロースペックPC向けベストローカルAIアプリ', 'item': 'https://www.promptquorum.com/power-local-llm/best-local-ai-app-low-end-pc?lang=ja' },
      ],
    },
  },
  zh: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '相关阅读',
        items: [
          '[各操作系统最简本地AI应用：Windows、Mac、Linux推荐](/power-local-llm/easiest-local-ai-app-windows-mac-linux?lang=zh) — 许多低配PC用户使用旧Windows，本指南为每个OS选择一个应用。',
          '[2026年Android最佳本地LLM应用](/power-local-llm/best-local-llm-apps-android-2026?lang=zh) — 拥有近期Android手机的低配用户的自然替代。',
          '[用本地AI代理替代Zapier](/power-local-llm/replace-zapier-with-local-ai-agents?lang=zh) — 同硬件上预算用户的实用工作流自动化。',
          '[LM Studio vs Jan vs GPT4All：2026年哪个本地AI应用胜出](/power-local-llm/lm-studio-vs-jan-vs-gpt4all-2026?lang=zh) — 如果还想考虑LM Studio的正面对决。',
          '[本地LLM最佳预算GPU](/local-llms/best-budget-gpus-local-llm?lang=zh) — 准备好走出CPU专用领域时。',
          '[2026年本地LLM硬件指南](/local-llms/local-llm-hardware-guide-2026?lang=zh) — 包括内存、CPU和GPU权衡的完整硬件权威。',
          '[Power Local LLM中心](/power-local-llm?lang=zh) — 集群完整指南库。',
        ],
      },
    },
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      'url': 'https://www.promptquorum.com/power-local-llm/best-local-ai-app-low-end-pc?lang=zh',
      'inLanguage': 'zh',
    ...
    breadcrumbSchema: {
      ...
      'itemListElement': [
        ...
        { '@type': 'ListItem', 'position': 2, 'name': 'Power Local LLM', 'item': 'https://www.promptquorum.com/power-local-llm?lang=zh' },
        { '@type': 'ListItem', 'position': 3, 'name': '低配PC最佳本地AI应用', 'item': 'https://www.promptquorum.com/power-local-llm/best-local-ai-app-low-end-pc?lang=zh' },
      ],
    },
  },
}
