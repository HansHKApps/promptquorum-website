...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  pt: {
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/pt/pt/power-local-llm/best-vpn-ai-privacy-local-llm-2026',
      inLanguage: 'pt-BR',
      datePublished: '2026-05-24',
      dateModified: '2026-05-24',
      author: { '@type': 'Person', name: 'Hans Kuepper' },
  ...
  ar: {
    ...
    seoTitle: 'أفضل VPN لنماذج اللغة المحلية 2026: مقارنة 4 مزودين',
    intro:
    ...
    metaDescription:
      'مقارنة ProtonVPN وNordVPN وMullvad وSurfshark لحماية بيئة نماذج اللغة المحلية: سياسة عدم السجلات، الاختصاص القضائي، WireGuard، وأسعار 2026.',
    twitterDescription:
