  ...
  de: {
    ...
    sections: {
      ...
      sources: {
        ...
        title: 'Quellen',
        items: [
          '[Bester NAS und Speicher für lokale KI-Modelle](/local-llms/best-nas-storage-local-llm?lang=de) — PromptQuorum-Leitfaden zu NAS-Dimensionierung, RAID-Stufen und der 3-2-1-Backup-Regel für Modellbibliotheken lokaler LLMs.',
      ...
      relatedReading: {
        ...
        items: [
          '[NAS-Dimensionierung und Backup für eine Bibliothek lokaler LLMs planen](/local-llms/best-nas-storage-local-llm?lang=de) — die Details zu RAID-Stufen und 3-2-1-Backup hinter dieser Kaufberatung.',
          '[Einen lokalen LLM-Stack für ein verteiltes Team einrichten](/local-llms/local-llm-setup-for-teams?lang=de) — wo geteilter Speicher in eine lokale LLM-Bereitstellung für mehrere Nutzer passt.',
          '[Einen sicheren Offline-Workflow für lokale LLMs aufbauen](/local-llms/secure-offline-local-llm-workflow?lang=de) — Muster für luftspaltgetrennten Speicher und Modellhandhabung.',
          '[Verstehen, wie Quantisierung die Modelldateigröße bestimmt](/local-llms/llm-quantization-explained?lang=de) — warum ein Q4-Modell die Größe hat, die es hat, und was Ihre Speicherrechnung antreibt.',
        ],
      },
    },
  },
  fr: {
    ...
    sections: {
      ...
      sources: {
        ...
        title: 'Sources',
        items: [
          '[Meilleur NAS et stockage pour modèles IA locaux](/local-llms/best-nas-storage-local-llm?lang=fr) — guide PromptQuorum sur le dimensionnement NAS, les niveaux RAID et la règle de sauvegarde 3-2-1 pour les bibliothèques de modèles de LLM locaux.',
      ...
      relatedReading: {
        ...
        items: [
          '[Planifier le dimensionnement NAS et la sauvegarde d\'une bibliothèque de LLM locaux](/local-llms/best-nas-storage-local-llm?lang=fr) — les détails sur les niveaux RAID et la sauvegarde 3-2-1 derrière ce guide.',
          '[Mettre en place une pile LLM locale pour une équipe distribuée](/local-llms/local-llm-setup-for-teams?lang=fr) — où le stockage partagé s\'inscrit dans un déploiement de LLM local multi-utilisateurs.',
          '[Construire un workflow LLM local sécurisé et hors ligne](/local-llms/secure-offline-local-llm-workflow?lang=fr) — modèles de stockage isolé et de manipulation des modèles.',
          '[Comprendre comment la quantification fixe la taille des fichiers de modèles](/local-llms/llm-quantization-explained?lang=fr) — pourquoi un modèle Q4 a la taille qu\'il a, ce qui conditionne votre calcul de stockage.',
        ],
      },
    },
  },
  ja: {
    ...
    sections: {
      ...
      sources: {
        ...
        title: '出典',
        items: [
          '[ローカルAIモデル向けの最適なNASとストレージ](/local-llms/best-nas-storage-local-llm?lang=ja) — ローカルLLMモデルライブラリ向けのNASのサイジング、RAIDレベル、3-2-1バックアップルールに関するPromptQuorumのガイド。',
      ...
      relatedReading: {
        ...
        title: '関連記事',
        items: [
          '[ローカルLLMライブラリのNASサイジングとバックアップを計画する](/local-llms/best-nas-storage-local-llm?lang=ja) — 本ガイドの背景にあるRAIDレベルと3-2-1バックアップの詳細。',
          '[分散したチームのためのローカルLLMスタックを構築する](/local-llms/local-llm-setup-for-teams?lang=ja) — 共有ストレージがマルチユーザーのローカルLLM展開のどこに位置づけられるか。',
          '[安全なオフラインのローカルLLMワークフローを構築する](/local-llms/secure-offline-local-llm-workflow?lang=ja) — エアギャップされたストレージとモデルの取り扱いのパターン。',
          '[量子化がモデルファイルサイズをどう決めるかを理解する](/local-llms/llm-quantization-explained?lang=ja) — Q4モデルがその大きさである理由と、それがストレージの計算をどう左右するか。',
        ],
      },
    },
  },
