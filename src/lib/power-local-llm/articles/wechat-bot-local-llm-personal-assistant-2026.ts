...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    metaDescription: 'Build a WeChat personal assistant bot with a local LLM in 2026. Use WeChatFerry or itchat + Ollama to run a private AI assistant that responds in WeChat without cloud APIs.',
  ...
  de: {
    ...
    seoTitle: 'WeChat-Bot mit lokalem LLM: Anleitung 2026',
  ...
  fr: {
    ...
    seoTitle: 'Bot WeChat avec LLM local : guide 2026',
    metaDescription: 'Créez un bot assistant personnel WeChat avec LLM local en 2026. WeChatFerry + Ollama sur Windows — entièrement local, sans API cloud, confidentialité totale.',
    educationalLevel: 'Intermediate',
    affiliateDisclosure: true,
    publishDate: '2026-05-26',
  ...
  ja: {
    ...
    seoTitle: 'ローカルLLMでWeChatボット構築ガイド 2026年版',
    metaDescription: 'WeChatFerry + Ollamaで2026年にローカルLLMを使ったWeChat個人アシスタントボットを構築。WindowsPC上で完全ローカル動作、クラウドAPI不要。',
    educationalLevel: 'Intermediate',
    affiliateDisclosure: true,
    publishDate: '2026-05-26',
  ...
  zh: {
    ...
    seoTitle: '本地大模型微信机器人搭建教程 2026',
    metaDescription: '2026年使用WeChatFerry + Ollama在Windows上搭建本地大模型微信私人助理——全程本地运行，无需云端API，数据不出本地。',
    educationalLevel: 'Intermediate',
    affiliateDisclosure: true,
    publishDate: '2026-05-26',
