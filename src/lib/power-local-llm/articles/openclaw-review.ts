...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    title: 'OpenClaw Review: Renamed Twice, Now Run by a Nonprofit',
    seoTitle: 'OpenClaw Review: History and Security Record',
  ...
  fr: {
    ...
    primaryTerm: 'OpenClaw',
    title: 'OpenClaw: renommé deux fois, désormais géré par une fondation',
    seoTitle: 'OpenClaw: historique et bilan de sécurité',
  ...
  ja: {
    ...
    primaryTerm: 'OpenClaw',
    title: 'OpenClawレビュー：2度改名され、今は非営利団体が運営',
    seoTitle: 'OpenClaw：歴史とセキュリティ実績',
  ...
  zh: {
    ...
    primaryTerm: 'OpenClaw',
    title: 'OpenClaw评测：两度改名，如今由非营利基金会运营',
    seoTitle: 'OpenClaw：历史与安全记录',
  ...
  es: {
    ...
    primaryTerm: 'OpenClaw',
    title: 'OpenClaw: renombrado dos veces, ahora gestionado por una fundación',
    seoTitle: 'OpenClaw: historia y historial de seguridad',
  ...
  pt: {
    ...
    primaryTerm: 'OpenClaw',
    title: 'OpenClaw: renomeado duas vezes, agora administrado por uma fundação',
    seoTitle: 'OpenClaw: história e histórico de segurança',
  ...
  ar: {
    ...
    primaryTerm: 'OpenClaw',
    title: 'مراجعة OpenClaw: أُعيدت تسميته مرتين، وتديره الآن مؤسسة غير ربحية',
    seoTitle: 'OpenClaw: التاريخ والسجل الأمني',
  ...
  ko: {
    ...
    primaryTerm: 'OpenClaw',
    title: 'OpenClaw 리뷰: 두 번 개명되었고, 이제는 비영리 재단이 운영',
    seoTitle: 'OpenClaw: 역사와 보안 실적',
