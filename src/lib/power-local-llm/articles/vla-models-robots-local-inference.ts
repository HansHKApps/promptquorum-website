  ...
  en: {
    ...
    sections: {
      ...
      'model-landscape': {
        ...
        note: 'For hardware tier specifics (Hailo-10H, Jetson Orin Nano/NX, AGX Orin, AGX Thor — power envelopes and pricing tiers), see [Edge AI Hardware for Local LLMs](/power-local-llm/edge-ai-hardware-for-local-llms) rather than re-deriving specs here — this article focuses on what runs where, not the silicon itself.',
        faqs: [
      ...
      'buying-guide': {
        ...
        content: [
          ...
          'Jetson Orin and Jetson Thor development kits are the standard starting point for evaluating an onboard VLA or VLM — see [Edge AI Hardware for Local LLMs](/power-local-llm/edge-ai-hardware-for-local-llms) for the tier-by-tier breakdown (Orin Nano through AGX Thor) covering power envelope and relative compute.',
      ...
      relatedReading: {
        ...
        items: [
          '[Edge AI Hardware for Local LLMs](/power-local-llm/edge-ai-hardware-for-local-llms) — hardware tiers (Hailo-10H, Jetson Orin Nano/NX, AGX Orin, AGX Thor) referenced throughout this article',
          '[VLM Video Analytics for Drones and Edge Cameras](/power-local-llm/vlm-video-analytics-drones-edge) — the observation-side sibling to this article\'s action-side focus, sharing the same silicon but a different latency constraint',
    ...
    schema: {
      ...
      inLanguage: 'en',
      url: 'https://www.promptquorum.com/power-local-llm/vla-models-robots-local-inference',
      educationalLevel: 'Advanced',
  ...
  de: {
    ...
    sections: {
      ...
      'model-landscape': {
        ...
        note: 'Für spezifische Hardware-Tiers (Hailo-10H, Jetson Orin Nano/NX, AGX Orin, AGX Thor — Leistungsklassen und Preisstufen) siehe [Edge-AI-Hardware für lokale LLMs](/de/power-local-llm/edge-ai-hardware-for-local-llms), statt die Spezifikationen hier neu herzuleiten — dieser Artikel konzentriert sich darauf, was wo läuft, nicht auf die Chips selbst.',
        faqs: [
      ...
      relatedReading: {
        ...
        items: [
          '[Edge-AI-Hardware für lokale LLMs](/de/power-local-llm/edge-ai-hardware-for-local-llms) — Hardware-Tiers (Hailo-10H, Jetson Orin Nano/NX, AGX Orin, AGX Thor), auf die dieser Artikel durchgängig verweist',
          '[VLM-Videoanalyse für Drohnen und Edge-Kameras](/de/power-local-llm/vlm-video-analytics-drones-edge) — das Beobachtungs-Pendant zum Handlungs-Fokus dieses Artikels, auf derselben Hardware, aber mit anderer Latenzanforderung',
    ...
    schema: {
      ...
      inLanguage: 'de',
      url: 'https://www.promptquorum.com/de/power-local-llm/vla-models-robots-local-inference',
      educationalLevel: 'Advanced',
      proficiencyLevel: 'Advanced',
    },
  },
  fr: {
    ...
    sections: {
      ...
      'model-landscape': {
        ...
        note: 'Pour les spécificités des paliers matériels (Hailo-10H, Jetson Orin Nano/NX, AGX Orin, AGX Thor — enveloppes de puissance et paliers tarifaires), voir [Matériel Edge AI pour LLM locaux](/fr/power-local-llm/edge-ai-hardware-for-local-llms) plutôt que de redériver les spécifications ici — cet article se concentre sur ce qui tourne où, pas sur le silicium lui-même.',
        faqs: [
      ...
      'buying-guide': {
        ...
        content: [
          ...
          'Les kits de développement Jetson Orin et Jetson Thor sont le point de départ standard pour évaluer un VLA ou un VLM embarqué — voir [Matériel Edge AI pour LLM locaux](/fr/power-local-llm/edge-ai-hardware-for-local-llms) pour la répartition palier par palier (Orin Nano à AGX Thor) couvrant l\'enveloppe de puissance et le calcul relatif.',
      ...
      relatedReading: {
        ...
        items: [
          '[Matériel Edge AI pour LLM locaux](/fr/power-local-llm/edge-ai-hardware-for-local-llms) — paliers matériels (Hailo-10H, Jetson Orin Nano/NX, AGX Orin, AGX Thor) référencés tout au long de cet article',
          '[Analyse vidéo VLM pour drones et caméras Edge](/fr/power-local-llm/vlm-video-analytics-drones-edge) — le pendant côté observation au focus côté action de cet article, sur le même silicium mais avec une contrainte de latence différente',
    ...
    schema: {
      ...
      inLanguage: 'fr',
      url: 'https://www.promptquorum.com/fr/power-local-llm/vla-models-robots-local-inference',
      educationalLevel: 'Advanced',
      proficiencyLevel: 'Advanced',
    },
  },
  ja: {
    ...
    sections: {
      ...
      'model-landscape': {
        ...
        note: 'ハードウェア階層の詳細（Hailo-10H、Jetson Orin Nano/NX、AGX Orin、AGX Thor——電力エンベロープと価格帯）については、ここで仕様を再導出するのではなく[ローカルLLM向けエッジAIハードウェア](/ja/power-local-llm/edge-ai-hardware-for-local-llms)を参照してください——本記事は何がどこで動くかに焦点を当てており、シリコン自体には焦点を当てていません。',
        faqs: [
      ...
      'buying-guide': {
        ...
        content: [
          ...
          'Jetson OrinおよびJetson Thor開発キットは、搭載VLAまたはVLMを評価するための標準的な出発点です——電力エンベロープと相対的な計算能力を含む階層別の内訳（Orin NanoからAGX Thorまで）については[ローカルLLM向けエッジAIハードウェア](/ja/power-local-llm/edge-ai-hardware-for-local-llms)を参照してください。',
      ...
      relatedReading: {
        title: '関連記事',
        items: [
          '[ローカルLLM向けエッジAIハードウェア](/ja/power-local-llm/edge-ai-hardware-for-local-llms) — 本記事全体で参照しているハードウェア階層（Hailo-10H、Jetson Orin Nano/NX、AGX Orin、AGX Thor）',
          '[ドローン・エッジカメラ向けVLA映像解析](/ja/power-local-llm/vlm-video-analytics-drones-edge) — 本記事のアクション側の焦点に対する観測側の対となる記事。同じシリコンを共有しつつ異なるレイテンシ制約を持つ',
    ...
    schema: {
      ...
      inLanguage: 'ja',
      url: 'https://www.promptquorum.com/ja/power-local-llm/vla-models-robots-local-inference',
      educationalLevel: 'Advanced',
      proficiencyLevel: 'Advanced',
    },
  },
  zh: {
    ...
    sections: {
      ...
      'model-landscape': {
        ...
        note: '关于具体硬件层级（Hailo-10H、Jetson Orin Nano/NX、AGX Orin、AGX Thor——功耗范围与价格档位），请参阅[本地LLM边缘AI硬件](/zh/power-local-llm/edge-ai-hardware-for-local-llms)，而非在此重新推导规格——本文关注的是什么运行在哪里，而不是芯片本身。',
        faqs: [
      ...
      'buying-guide': {
        ...
        content: [
          ...
          'Jetson Orin和Jetson Thor开发套件是评估机身端VLA或VLM的标准起点——关于按层级划分的详细对比（从Orin Nano到AGX Thor，涵盖功耗范围和相对算力），请参阅[本地LLM边缘AI硬件](/zh/power-local-llm/edge-ai-hardware-for-local-llms)。',
      ...
      relatedReading: {
        title: '延伸阅读',
        items: [
          '[本地LLM边缘AI硬件](/zh/power-local-llm/edge-ai-hardware-for-local-llms) — 本文通篇引用的硬件层级（Hailo-10H、Jetson Orin Nano/NX、AGX Orin、AGX Thor）',
          '[面向无人机与边缘摄像头的VLM视频分析](/zh/power-local-llm/vlm-video-analytics-drones-edge) — 本文聚焦"行动"侧的姊妹篇，聚焦"观测"侧，共享同样的芯片但延迟约束不同',
    ...
    schema: {
      ...
      inLanguage: 'zh',
      url: 'https://www.promptquorum.com/zh/power-local-llm/vla-models-robots-local-inference',
      educationalLevel: 'Advanced',
      proficiencyLevel: 'Advanced',
    },
  },
  es: {
    ...
    sections: {
      ...
      'model-landscape': {
        ...
        note: 'Para las especificidades de los niveles de hardware (Hailo-10H, Jetson Orin Nano/NX, AGX Orin, AGX Thor: envolventes de potencia y niveles de precio), consulta [Hardware Edge AI para LLM locales](/es/power-local-llm/edge-ai-hardware-for-local-llms) en lugar de rederivar las especificaciones aquí: este artículo se centra en qué corre dónde, no en el silicio en sí.',
        faqs: [
      ...
      'buying-guide': {
        ...
        content: [
          ...
          'Los kits de desarrollo Jetson Orin y Jetson Thor son el punto de partida estándar para evaluar un VLA o VLM a bordo: consulta [Hardware Edge AI para LLM locales](/es/power-local-llm/edge-ai-hardware-for-local-llms) para el desglose nivel por nivel (de Orin Nano a AGX Thor) que cubre la envolvente de potencia y el cómputo relativo.',
      ...
      relatedReading: {
        ...
        items: [
          '[Hardware Edge AI para LLM locales](/es/power-local-llm/edge-ai-hardware-for-local-llms) — niveles de hardware (Hailo-10H, Jetson Orin Nano/NX, AGX Orin, AGX Thor) referenciados a lo largo de este artículo',
          '[Análisis de vídeo VLM para drones y cámaras Edge](/es/power-local-llm/vlm-video-analytics-drones-edge) — el artículo hermano del lado de la observación frente al enfoque en el lado de la acción de este artículo, compartiendo el mismo silicio pero con una restricción de latencia distinta',
    ...
    schema: {
      ...
      inLanguage: 'es',
      url: 'https://www.promptquorum.com/es/power-local-llm/vla-models-robots-local-inference',
      educationalLevel: 'Advanced',
      proficiencyLevel: 'Advanced',
    },
  },
  pt: {
    ...
    sections: {
      ...
      'model-landscape': {
        ...
        note: 'Para especificidades dos níveis de hardware (Hailo-10H, Jetson Orin Nano/NX, AGX Orin, AGX Thor — envelopes de potência e faixas de preço), veja [Hardware Edge AI para LLMs Locais](/pt/power-local-llm/edge-ai-hardware-for-local-llms) em vez de rederivar especificações aqui — este artigo foca no que roda onde, não no silício em si.',
        faqs: [
      ...
      relatedReading: {
        ...
        items: [
          '[Hardware Edge AI para LLMs Locais](/pt/power-local-llm/edge-ai-hardware-for-local-llms) — níveis de hardware (Hailo-10H, Jetson Orin Nano/NX, AGX Orin, AGX Thor) referenciados ao longo deste artigo',
          '[Análise de Vídeo VLM para Drones e Câmeras Edge](/pt/power-local-llm/vlm-video-analytics-drones-edge) — o artigo irmão do lado da observação frente ao foco do lado da ação deste artigo, compartilhando o mesmo silício mas com uma restrição de latência diferente',
    ...
    schema: {
      ...
      inLanguage: 'pt-BR',
      url: 'https://www.promptquorum.com/pt/power-local-llm/vla-models-robots-local-inference',
      educationalLevel: 'Advanced',
      proficiencyLevel: 'Advanced',
    },
  },
  ar: {
    ...
    sections: {
      ...
      'model-landscape': {
        ...
        note: 'للاطلاع على تفاصيل مستويات العتاد (Hailo-10H، Jetson Orin Nano/NX، AGX Orin، AGX Thor — نطاقات الطاقة وفئات الأسعار)، راجع [عتاد الذكاء الاصطناعي الطرفي لنماذج LLM المحلية](/ar/power-local-llm/edge-ai-hardware-for-local-llms) بدلًا من إعادة اشتقاق المواصفات هنا — يركّز هذا المقال على ما يعمل وأين، لا على الشرائح نفسها.',
        faqs: [
      ...
      'buying-guide': {
        ...
        content: [
          ...
          'تُعد عُدد تطوير Jetson Orin وJetson Thor نقطة البداية المعتادة لتقييم VLA أو VLM على متن الجهاز — راجع [عتاد الذكاء الاصطناعي الطرفي لنماذج LLM المحلية](/ar/power-local-llm/edge-ai-hardware-for-local-llms) للاطلاع على التصنيف مستوى بمستوى (من Orin Nano إلى AGX Thor) الذي يغطي نطاق الطاقة والحوسبة النسبية.',
      ...
      relatedReading: {
        ...
        items: [
          '[عتاد الذكاء الاصطناعي الطرفي لنماذج LLM المحلية](/ar/power-local-llm/edge-ai-hardware-for-local-llms) — مستويات العتاد (Hailo-10H، Jetson Orin Nano/NX، AGX Orin، AGX Thor) المشار إليها في هذا المقال بأكمله',
          '[تحليل فيديو VLM للطائرات المسيّرة وكاميرات الحافة](/ar/power-local-llm/vlm-video-analytics-drones-edge) — المقال الشقيق من جانب المراقبة مقابل تركيز هذا المقال على جانب الفعل، بمشاركة الشرائح نفسها لكن بقيد زمن استجابة مختلف',
    ...
    schema: {
      ...
      inLanguage: 'ar',
      url: 'https://www.promptquorum.com/ar/power-local-llm/vla-models-robots-local-inference',
      educationalLevel: 'Advanced',
      proficiencyLevel: 'Advanced',
    },
  },
  ko: {
    ...
    sections: {
      ...
      'model-landscape': {
        ...
        note: '하드웨어 등급별 세부 사항(Hailo-10H, Jetson Orin Nano/NX, AGX Orin, AGX Thor — 전력 범위와 가격대)은 여기서 사양을 다시 도출하는 대신 [로컬 LLM용 엣지 AI 하드웨어](/ko/power-local-llm/edge-ai-hardware-for-local-llms)를 참고하세요 — 이 글은 무엇이 어디서 실행되는지에 초점을 맞추며, 실리콘 자체에는 초점을 두지 않습니다.',
        faqs: [
      ...
      'buying-guide': {
        ...
        content: [
          ...
          'Jetson Orin과 Jetson Thor 개발 키트는 온보드 VLA나 VLM을 평가하기 위한 표준 출발점입니다 — 전력 범위와 상대적 연산 능력을 다루는 등급별 세부 분류(Orin Nano부터 AGX Thor까지)는 [로컬 LLM용 엣지 AI 하드웨어](/ko/power-local-llm/edge-ai-hardware-for-local-llms)를 참고하세요.',
      ...
      relatedReading: {
        title: '관련 자료',
        items: [
          '[로컬 LLM용 엣지 AI 하드웨어](/ko/power-local-llm/edge-ai-hardware-for-local-llms) — 이 글 전체에서 참조한 하드웨어 등급(Hailo-10H, Jetson Orin Nano/NX, AGX Orin, AGX Thor)',
          '[드론과 엣지 카메라를 위한 VLM 영상 분석](/ko/power-local-llm/vlm-video-analytics-drones-edge) — 이 글이 액션 측에 초점을 맞춘 것과 대비되는 관측 측의 자매 글로, 동일한 실리콘을 공유하지만 지연시간 제약이 다름',
    ...
    schema: {
      ...
      inLanguage: 'ko',
      url: 'https://www.promptquorum.com/ko/power-local-llm/vla-models-robots-local-inference',
      educationalLevel: 'Advanced',
      proficiencyLevel: 'Advanced',
    },
  },
