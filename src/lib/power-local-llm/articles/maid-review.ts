  ...
  es: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Las mejores apps de LLM local para Android en 2026](/es/power-local-llm/best-local-llm-apps-android-2026) — el resumen de apps de Android, incluyendo Maid, MLC Chat y PocketPal AI.',
          '[Reseña de PocketPal AI](/es/power-local-llm/pocketpal-ai-review) — una alternativa gratuita y de código abierto que también cubre iPhone y iPad.',
          '[Reseña de Private LLM](/es/power-local-llm/private-llm-review) — una alternativa de pago, de código cerrado y exclusiva de Apple con un catálogo de modelos integrado más amplio.',
  ...
  fr: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Les meilleures applications de LLM local pour Android en 2026](/fr/power-local-llm/best-local-llm-apps-android-2026) — le panorama des applications Android, dont Maid, MLC Chat et PocketPal AI.',
          '[Test de PocketPal AI](/fr/power-local-llm/pocketpal-ai-review) — une alternative gratuite et open source qui couvre aussi iPhone et iPad.',
          '[Test de Private LLM](/fr/power-local-llm/private-llm-review) — une alternative payante, à code fermé, exclusive à Apple, avec un catalogue de modèles intégré plus large.',
          '[Test d\'Enclave AI](/fr/power-local-llm/enclave-ai-review) — une alternative réservée à Apple avec automatisation Siri et Raccourcis.',
          '[Les meilleurs modèles LLM mobiles en 2026 : Phi-4 Mini vs Gemma 4 vs SmolLM](/fr/power-local-llm/mobile-llm-models-phi4-gemma-smollm) — l\'article complémentaire sur les modèles pour choisir le fichier GGUF adapté à votre téléphone.',
        ],
      },
    },
    schema: {
  ...
  ja: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '関連記事',
        items: [
          '[2026年版 Android向けベストローカルLLMアプリ](/ja/power-local-llm/best-local-llm-apps-android-2026) — Maid、MLC Chat、PocketPal AIなどを含むAndroidアプリまとめ。',
          '[PocketPal AIレビュー](/ja/power-local-llm/pocketpal-ai-review) — iPhoneとiPadもカバーする、無料でオープンソースの代替アプリ。',
          '[Private LLMレビュー](/ja/power-local-llm/private-llm-review) — より大きな内蔵モデルカタログを持つ、有料でクローズドソースのApple専用代替アプリ。',
          '[Enclave AIレビュー](/ja/power-local-llm/enclave-ai-review) — SiriとShortcutsによる自動化を備えたApple専用の代替アプリ。',
          '[2026年ベストモバイルLLMモデル:Phi-4 Mini vs Gemma 4 vs SmolLM](/ja/power-local-llm/mobile-llm-models-phi4-gemma-smollm) — スマートフォンに合ったGGUFモデルを選ぶためのモデル層の関連記事。',
        ],
      },
    },
    schema: {
  ...
  pt: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Os melhores apps de LLM local para Android em 2026](/pt/power-local-llm/best-local-llm-apps-android-2026) — o panorama de apps Android, incluindo Maid, MLC Chat e PocketPal AI.',
          '[Análise do PocketPal AI](/pt/power-local-llm/pocketpal-ai-review) — uma alternativa gratuita e de código aberto que também cobre iPhone e iPad.',
          '[Análise do Private LLM](/pt/power-local-llm/private-llm-review) — uma alternativa paga, de código fechado, exclusiva para Apple, com um catálogo de modelos embutido maior.',
          ...
          '[Os melhores modelos LLM móveis em 2026: Phi-4 Mini vs Gemma 4 vs SmolLM](/pt/power-local-llm/mobile-llm-models-phi4-gemma-smollm) — o artigo complementar sobre modelos para escolher qual arquivo GGUF realmente cabe no seu telefone.',
        ],
      },
    },
    schema: {
  ...
  ar: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[أفضل تطبيقات النماذج اللغوية المحلية لأندرويد في 2026](/ar/power-local-llm/best-local-llm-apps-android-2026) — قائمة بتطبيقات Android، تشمل Maid وMLC Chat وPocketPal AI.',
          '[مراجعة PocketPal AI](/ar/power-local-llm/pocketpal-ai-review) — بديل مجاني ومفتوح المصدر يغطي أيضًا iPhone وiPad.',
          '[مراجعة Private LLM](/ar/power-local-llm/private-llm-review) — بديل مدفوع ومغلق المصدر وحصري لـApple بفهرس نماذج مدمج أكبر.',
          '[مراجعة Enclave AI](/ar/power-local-llm/enclave-ai-review) — بديل مخصص لأجهزة Apple فقط مع أتمتة عبر Siri وShortcuts.',
          '[أفضل نماذج LLM للهواتف في 2026: Phi-4 Mini مقابل Gemma 4 مقابل SmolLM](/ar/power-local-llm/mobile-llm-models-phi4-gemma-smollm) — المقال المكمّل على مستوى النماذج لاختيار ملف GGUF المناسب فعليًا لهاتفك.',
        ],
      },
    },
    schema: {
  ...
  zh: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '相关阅读',
        items: [
          '[2026 年 Android 最佳本地 LLM 应用](/zh/power-local-llm/best-local-llm-apps-android-2026) —— Android 应用汇总,包括 Maid、MLC Chat 和 PocketPal AI。',
          '[PocketPal AI 评测](/zh/power-local-llm/pocketpal-ai-review) —— 一款免费开源的替代应用,同时覆盖 iPhone 和 iPad。',
          '[Private LLM 评测](/zh/power-local-llm/private-llm-review) —— 一款付费、闭源、仅限 Apple 的替代应用,内置更大的模型目录。',
          '[Enclave AI 评测](/zh/power-local-llm/enclave-ai-review) —— 一款仅限 Apple 的替代应用,支持 Siri 与 Shortcuts 自动化。',
          '[2026 年最佳移动端 LLM 模型:Phi-4 Mini 对比 Gemma 4 对比 SmolLM](/zh/power-local-llm/mobile-llm-models-phi4-gemma-smollm) —— 模型层面的配套文章,帮助你选择真正适合自己手机的 GGUF 模型。',
        ],
      },
    },
    schema: {
  ...
  ko: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        title: '관련 자료',
        items: [
          '[2026년 Android 최고의 로컬 LLM 앱](/ko/power-local-llm/best-local-llm-apps-android-2026) — Maid, MLC Chat, PocketPal AI를 포함한 Android 앱 총정리.',
          '[PocketPal AI 리뷰](/ko/power-local-llm/pocketpal-ai-review) — iPhone과 iPad도 함께 다루는 무료 오픈소스 대안.',
          '[Private LLM 리뷰](/ko/power-local-llm/private-llm-review) — 더 큰 내장 모델 카탈로그를 갖춘 유료, 클로즈드소스, Apple 전용 대안.',
          '[Enclave AI 리뷰](/ko/power-local-llm/enclave-ai-review) — Siri 및 Shortcuts 자동화를 갖춘 Apple 전용 대안.',
          '[2026년 최고의 모바일 LLM 모델: Phi-4 Mini vs Gemma 4 vs SmolLM](/ko/power-local-llm/mobile-llm-models-phi4-gemma-smollm) — 스마트폰에 실제로 맞는 GGUF 모델을 고르기 위한 모델 계층의 관련 자료.',
        ],
      },
    },
    schema: {
