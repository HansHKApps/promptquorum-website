...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    heroImage: '/images/local-vision-models-llava-ollama-2026-overview-hero-en.png',
...
print("\\n".join(f"[{i+1}s] {d}" for i, d in enumerate(descriptions)))`,
  ...
  de: {
    ...
    next_refresh_due: '2026-12-19',
    theme: 'Voice, Speech & Multimodal',
    heroImage: '/images/local-vision-models-llava-ollama-2026-overview-hero-de.png',
...
print("\\n".join(f"[{i+1}s] {d}" for i, d in enumerate(descriptions)))`,
  ...
  fr: {
    ...
    next_refresh_due: '2026-12-19',
    theme: 'Voice, Speech & Multimodal',
    heroImage: '/images/local-vision-models-llava-ollama-2026-overview-hero-fr.png',
...
print("\\n".join(f"[{i+1}s] {d}" for i, d in enumerate(descriptions)))`,
  ...
  ja: {
    ...
    next_refresh_due: '2026-12-19',
    theme: 'Voice, Speech & Multimodal',
    heroImage: '/images/local-vision-models-llava-ollama-2026-overview-hero-ja.png',
...
print("\\n".join(f"[{i+1}s] {d}" for i, d in enumerate(descriptions)))`,
  ...
  zh: {
    ...
    next_refresh_due: '2026-12-19',
    theme: 'Voice, Speech & Multimodal',
    heroImage: '/images/local-vision-models-llava-ollama-2026-overview-hero-zh.png',
...
print("\\n".join(f"[{i+1}s] {d}" for i, d in enumerate(descriptions)))`,
  ...
  es: {
    ...
    next_refresh_due: '2026-12-19',
    theme: 'Voice, Speech & Multimodal',
    heroImage: '/images/local-vision-models-llava-ollama-2026-overview-hero-es.png',
...
print("\\n".join(f"[{i+1}s] {d}" for i, d in enumerate(descriptions)))`,
  ...
  pt: {
    ...
    next_refresh_due: '2026-12-19',
    theme: 'Voice, Speech & Multimodal',
    heroImage: '/images/local-vision-models-llava-ollama-2026-overview-hero-pt.png',
...
print("\\n".join(f"[{i+1}s] {d}" for i, d in enumerate(descriptions)))`,
  ...
  ar: {
    ...
    next_refresh_due: '2026-12-19',
    theme: 'Voice, Speech & Multimodal',
    heroImage: '/images/local-vision-models-llava-ollama-2026-overview-hero-ar.png',
...
print("\\n".join(f"[{i+1}s] {d}" for i, d in enumerate(descriptions)))`,
  ...
  ko: {
    ...
    next_refresh_due: '2026-12-19',
    theme: 'Voice, Speech & Multimodal',
    heroImage: '/images/local-vision-models-llava-ollama-2026-overview-hero-ko.png',
