...
export const article: Partial<Record<Language, LLMArticle>> = {
  en: {
    ...
    heroImage: '/images/local-vision-models-llava-ollama-2026-overview-hero-en.webp',
    title: 'Local Vision Models 2026: LLaVA, Llama 3.2 Vision, Qwen3-VL & Ollama Multimodal Setup',
    seoTitle: 'Best Local Vision Models 2026: LLaVA, Qwen3-VL & Ollama',
    intro:
      'Vision-language models (VLMs) accept image input alongside text and return text output — enabling document OCR, image Q&A, screenshot analysis, and chart reading locally. In 2026, the easiest path to running VLMs is through Ollama: pull a model, send an image, get a description or answer. This guide compares the leading local vision models (LLaVA 1.6, Llama 3.2 Vision, MiniCPM-V 4.5, Moondream 2, Qwen3-VL, InternVL 2.5), covers Ollama setup step-by-step, and maps each model to its best use case based on VRAM requirements and quality benchmarks.',
    metaDescription:
      'Image Q&A, OCR, and screenshot analysis offline in 2026. Benchmark: LLaVA 1.6, Llama 3.2 Vision, Qwen3-VL, MiniCPM-V. VRAM guide + Ollama setup steps.',
    twitterDescription:
    ...
    quickAnswerTop: {
      en: {
        ...
        bullets: [
          ...
          '6 GB VRAM → MiniCPM-V 4.5, LLaVA 1.6 7B, or Qwen3-VL 8B (best for multilingual OCR): best balance of quality and hardware fit.',
          '8–16 GB VRAM → Llama 3.2 Vision 11B: top local VLM for general photos and documents.',
          '64+ GB (or Apple M-series) → Llama 3.2 Vision 90B or Qwen3-VL 72B: best local quality, near-cloud performance.',
          'Setup: `ollama pull llama3.2-vision` then `ollama run llama3.2-vision "Describe this" --image photo.jpg`.',
          'Best for OCR: Qwen3-VL 8B ≈ MiniCPM-V 4.5 > Llama 3.2 Vision 11B > LLaVA 1.6 — strong on text extraction from documents.',
    ...
    toc: [
      ...
      { label: 'Qwen3-VL — Best Multilingual and OCR Performance', anchor: '#qwen2vl-deep-dive' },
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**MiniCPM-V 4.5 (8B) is the top choice for document OCR at 6 GB VRAM.** Its training data includes high-resolution document scans, making it more accurate than LLaVA on tables, invoices, and dense text.',
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**OCR strength:** Qwen3-VL 8B ≈ MiniCPM-V 4.5 > Llama 3.2 Vision 11B > LLaVA 1.6 13B > LLaVA 1.6 7B > Moondream 2.',
      ...
      modelComparison: {
        ...
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: 'For 6–8 GB VRAM: MiniCPM-V 4.5 for document OCR, Llama 3.2 Vision 11B for general image Q&A — both run locally via Ollama.',
          },
          {
            type: 'plain-terms',
            text: 'Llama3.2-Vision is the best overall; MiniCPM-V 4.5 leads for document OCR; Qwen3-VL is best for CJK and multilingual text; Moondream is the ultra-light option under 4 GB VRAM.',
          },
        ],
      ...
      invoiceAccuracyTest: {
        ...
        rows: [
          ...
          { 'Model': 'MiniCPM-V 4.5', 'Vendor': '✓', 'Date': '✓', 'Total': '✓', 'Tax': '✓', 'Line Items': '✓', 'Score': '5/5' },
          { 'Model': 'Qwen3-VL 8B', 'Vendor': '✓', 'Date': '✓', 'Total': '✓', 'Tax': '✓', 'Line Items': '✓', 'Score': '5/5' },
      ...
      multiImageSupport: {
        ...
        columns: ['Feature', 'Moondream', 'LLaVA 7B', 'MiniCPM-V', 'Qwen3-VL', 'LLaVA 13B', 'Llama 3.2 Vision', 'InternVL'],
        rows: [
          {
        ...
        items: [
          'MiniCPM-V 4.5 accepts up to 4 images per prompt; Qwen3-VL handles up to 8. LLaVA and Moondream accept only single images per request.',
...
print(result)`,
      ...
      useCaseOcr: {
        ...
        items: [
          ...
          '**Best models for OCR:** MiniCPM-V 4.5 (highest OCR accuracy in 6 GB class), Llama 3.2 Vision 11B (best for mixed document types).',
      ...
      useCaseScreenshot: {
        ...
        items: [
          ...
          '**Best models:** InternVL 2.5 8B (best UI understanding), MiniCPM-V 4.5 (second best, with Ollama support).',
        ],
      },
      useCaseChart: {
        id: 'use-case-chart',
...
print("\\n".join(f"[{i+1}s] {d}" for i, d in enumerate(descriptions)))`,
      ...
      localVsGpt4o: {
        ...
        callouts: [
          {
            type: 'note',
            text: 'For production invoice and form processing with clean input, local VLMs (Llama 3.2 Vision 11B, Qwen3-VL 8B) can replace GPT-5.5 Vision at zero cost. For anything involving handwriting, complex scene analysis, or ambiguous content, GPT-5.5 still leads.',
          },
        ],
      },
      llavaDeepDive: {
        ...
        items: [
          ...
          '**Weaknesses:** Weaker OCR than MiniCPM-V 4.5, weaker UI analysis than InternVL 2.5, outperformed overall by Llama 3.2 Vision 11B on quality benchmarks.',
          ...
          '**Full review:** [LLaVA Review (2026)](/power-local-llm/llava-review) — PromptQuorum\'s dedicated review, including its Apache-2.0-plus-base-model license nuance and real Ollama commands.',
        ],
      },
      qwen2VlDeepDive: {
        id: 'qwen2vl-deep-dive',
        title: 'Qwen3-VL — Best Multilingual and OCR Performance',
        content:
          '**Qwen3-VL is Alibaba\'s vision-language model and the strongest open-source option on document benchmarks in 2026.** The 8B variant is competitive with Llama 3.2 Vision 11B at lower VRAM, and the 72B variant tops most open-source VLM leaderboards.',
        items: [
          ...
          '**8B vs 72B:** The 8B fits in ~6 GB VRAM (Q4) and is competitive with Llama 3.2 Vision 11B on most document tasks. The 72B uses ~48 GB and leads most open-source benchmarks.',
          '**Ollama install:** `ollama pull qwen3-vl` — available directly from the Ollama model library.',
          '**Multi-image support:** Accepts up to 8 images per request — highest multi-image capacity of any model in this comparison.',
          '**Model page:** [Qwen3-VL on Hugging Face](https://huggingface.co/Qwen/Qwen3-VL-7B-Instruct)',
        ],
      },
      howToChoose: {
        id: 'how-to-choose',
        ...
        items: [
          ...
          '**6 GB VRAM:** MiniCPM-V 4.5 for document OCR and invoice processing. LLaVA 1.6 7B for general photo Q&A where community support matters. Qwen3-VL 8B for multilingual OCR or when the highest OCR accuracy matters.',
          ...
          '**64+ GB unified memory (Apple M-Max/Ultra, multi-GPU):** Llama 3.2 Vision 90B for the best local VLM quality available, approaching cloud-tier performance for document tasks. Qwen3-VL 72B is an alternative with top open-source benchmark scores.',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'LLaVA 1.6 supports up to 672×672 effective resolution (with dynamic patching). MiniCPM-V 4.5 supports up to 1792×1792 — one reason it outperforms LLaVA on high-DPI document scans. Llama 3.2 Vision supports variable resolution up to 1120×1120. For best OCR results, send document images at 150+ DPI.',
          },
          {
          ...
          },
          {
            ...
            a: 'Llama 3.2 Vision 11B (Q4 quantized fits in ~8 GB) for general use. Qwen3-VL 8B if multilingual OCR is the primary need. Both are available via Ollama with a single pull command.',
          },
          {
            q: 'LLaVA vs MiniCPM-V — which is better for OCR?',
            a: 'MiniCPM-V 4.5 is more accurate on document OCR, especially dense tables and high-DPI scans. LLaVA 1.6 is better documented and has more community support. For pure OCR accuracy, pick MiniCPM-V. For community resources and troubleshooting, pick LLaVA.',
          },
          {
            q: 'Can local vision models read handwriting?',
            a: 'Printed handwriting (block letters): yes, with moderate accuracy on Llama 3.2 Vision 11B and MiniCPM-V 4.5. Cursive handwriting: unreliable on all local models. GPT-5.5 Vision is significantly better at cursive. For production handwriting OCR on cursive documents, cloud APIs are still recommended.',
          },
        ],
      },
      sources: {
        ...
        items: [
          ...
          '[MiniCPM-V 4.5 on Hugging Face](https://huggingface.co/openbmb/MiniCPM-V-2_6) — OpenBMB model card, OCR benchmarks, and fine-tuning instructions.',
          ...
          '[Qwen3-VL on Hugging Face](https://huggingface.co/Qwen/Qwen3-VL-7B-Instruct) — Alibaba\'s Qwen3-VL model card, architecture details, and multilingual OCR benchmarks.',
      ...
      relatedReading: {
        ...
        items: [
          '[Ollama Vision Models (2026)](/power-local-llm/ollama-vision-models-review) — a focused, practical guide to running vision models specifically through Ollama: real CLI/API syntax and which models are actually in its library.',
          '[VLMs in Cameras and on Drones 2026](/power-local-llm/vlm-video-analytics-drones-edge) -- Desktop VLM basics are covered here; for embedded camera and drone deployment, see this edge-focused guide.',
  ...
  de: {
    ...
    quickAnswerTop: {
      de: {
        ...
        bullets: [
          ...
          '6 GB VRAM → MiniCPM-V 4.5, LLaVA 1.6 7B oder Qwen3-VL 8B (beste multilinguale OCR): beste Balance aus Qualität und VRAM-Bedarf.',
          '8–16 GB VRAM → Llama 3.2 Vision 11B: bestes lokales VLM für allgemeine Fotos und Dokumente.',
          '64+ GB (oder Apple M-Series) → Llama 3.2 Vision 90B oder Qwen3-VL 72B: beste lokale Qualität, nahe Cloud-Niveau.',
          'Setup: `ollama pull llama3.2-vision` dann `ollama run llama3.2-vision "Beschreibe das Bild" --image foto.jpg`.',
          'Beste OCR-Leistung: Qwen3-VL 8B ≈ MiniCPM-V 4.5 > Llama 3.2 Vision 11B > LLaVA 1.6.',
    ...
    toc: [
      ...
      { label: 'Qwen3-VL — Beste multilinguale OCR-Leistung', anchor: '#qwen2vl-deep-dive' },
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**MiniCPM-V 4.5 (8B) ist die erste Wahl für Dokument-OCR bei 6 GB VRAM.** Die Trainingsdaten umfassen hochauflösende Dokumentscans – damit genauer als LLaVA bei Tabellen, Rechnungen und dichtem Text.',
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**OCR-Stärke:** Qwen3-VL 8B ≈ MiniCPM-V 4.5 > Llama 3.2 Vision 11B > LLaVA 1.6 13B > LLaVA 1.6 7B > Moondream 2.',
      ...
      modelComparison: {
        ...
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: 'Für 6–8 GB VRAM: MiniCPM-V 4.5 für Dokument-OCR, Llama 3.2 Vision 11B für allgemeine Bild-Q&A – beide lokal via Ollama.',
          },
          {
            type: 'plain-terms',
        ...
        rows: [
          ...
          { 'Modell': 'MiniCPM-V 4.5', 'Parameter': '8B', 'VRAM (Q4)': '~6 GB', 'Bildtypen': 'Fotos, Dokumente, OCR', 'Qualität': 'Sehr gut', 'Via Ollama?': 'Ja' },
          ...
          { 'Modell': 'Qwen3-VL 8B', 'Parameter': '7B', 'VRAM (Q4)': '~6 GB', 'Bildtypen': 'Fotos, Dokumente, OCR, Mehrsprachig', 'Qualität': 'Ausgezeichnet', 'Via Ollama?': 'Ja' },
          { 'Modell': 'Qwen3-VL 72B', 'Parameter': '72B', 'VRAM (Q4)': '~48 GB', 'Bildtypen': 'Fotos, Dokumente, Komplex', 'Qualität': 'Bestes Open-Source', 'Via Ollama?': 'Ja' },
      ...
      invoiceAccuracyTest: {
        ...
        rows: [
          ...
          { 'Modell': 'MiniCPM-V 4.5', 'Anbieter': '✓', 'Datum': '✓', 'Gesamt': '✓', 'Steuer': '✓', 'Positionen': '✓', 'Bewertung': '5/5' },
          { 'Modell': 'Qwen3-VL 8B', 'Anbieter': '✓', 'Datum': '✓', 'Gesamt': '✓', 'Steuer': '✓', 'Positionen': '✓', 'Bewertung': '5/5' },
      ...
      multiImageSupport: {
        ...
        columns: ['Funktion', 'Moondream', 'LLaVA 7B', 'MiniCPM-V', 'Qwen3-VL', 'LLaVA 13B', 'Llama 3.2 Vision', 'InternVL'],
        rows: [
          {
        ...
        items: [
          'MiniCPM-V 4.5 akzeptiert bis zu 4 Bilder pro Prompt; Qwen3-VL verarbeitet bis zu 8. LLaVA und Moondream akzeptieren nur einzelne Bilder pro Anfrage.',
...
print(result)`,
      ...
      useCaseOcr: {
        ...
        items: [
          ...
          '**Beste Modelle für OCR:** MiniCPM-V 4.5 (höchste Genauigkeit in der 6-GB-Klasse), Llama 3.2 Vision 11B (beste Leistung bei gemischten Dokumenttypen).',
      ...
      useCaseScreenshot: {
        ...
        items: [
          ...
          '**Beste Modelle:** InternVL 2.5 8B (bestes UI-Verständnis), MiniCPM-V 4.5 (zweitbeste mit Ollama-Unterstützung).',
        ],
      },
      useCaseChart: {
        id: 'use-case-chart',
...
print("\\n".join(f"[{i+1}s] {d}" for i, d in enumerate(descriptions)))`,
      ...
      vramReality: {
        ...
        rows: [
          ...
          { 'Modell': 'MiniCPM-V 4.5 (8B)', 'VRAM (Q4)': '~6 GB', 'Token/Sek. (RTX 4070)': '~12–18', 'Token/Sek. (M5 Pro 36 GB)': '~15–20', 'Produktionstauglich?': 'Ja — OCR und Dokumente' },
      ...
      localVsGpt4o: {
        ...
        callouts: [
          { type: 'note', text: 'Für Rechnungs- und Formularverarbeitung mit sauberem Input können lokale VLMs (Llama 3.2 Vision 11B, Qwen3-VL 8B) GPT-5.5 Vision bei null Kosten ersetzen.' },
        ],
      },
      llavaDeepDive: {
        id: 'llava-deep-dive',
        ...
        items: [
          ...
          '**Schwächen:** Schwächere OCR als MiniCPM-V 4.5, schwächere UI-Analyse als InternVL 2.5.',
          '**Warum weiterhin empfohlen:** Größte Community, meiste Tutorials, meiste Beispiel-Prompts aller lokalen VLMs.',
          '**Vollständiger Test:** [LLaVA im Test (2026)](/de/power-local-llm/llava-review) — PromptQuorums dedizierter Test, einschließlich der Apache-2.0-plus-Basismodell-Lizenznuance und echter Ollama-Befehle.',
        ],
      },
      qwen2VlDeepDive: {
        id: 'qwen2vl-deep-dive',
        title: 'Qwen3-VL — Beste multilinguale OCR-Leistung',
        content:
          '**Qwen3-VL ist Alibabas Vision-Language-Modell und 2026 die stärkste Open-Source-Option bei Dokument-Benchmarks.**',
        items: [
          ...
          '**Ollama-Installation:** `ollama pull qwen3-vl:7b`',
          '**Multi-Bild:** Bis zu 8 Bilder pro Anfrage – höchste Kapazität im Vergleich.',
          '**Modellseite:** [Qwen3-VL 8B auf Hugging Face](https://huggingface.co/Qwen/Qwen3-VL-7B-Instruct)',
        ],
      },
      howToChoose: {
        id: 'how-to-choose',
        ...
        items: [
          ...
          '**6 GB VRAM:** MiniCPM-V 4.5 für Dokument-OCR. LLaVA 1.6 7B für allgemeine Foto-Q&A. Qwen3-VL 8B für mehrsprachige OCR.',
          ...
          '**64+ GB Unified Memory:** Llama 3.2 Vision 90B für beste lokale Qualität. Qwen3-VL 72B als Alternative mit führenden Benchmark-Werten.',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'LLaVA 1.6 bis 672×672 (dynamisches Patching). MiniCPM-V 4.5 bis 1792×1792. Llama 3.2 Vision bis 1120×1120. Für beste OCR-Ergebnisse Dokumente mit 150+ DPI senden.',
          },
          {
          ...
          },
          {
            ...
            a: 'Llama 3.2 Vision 11B (Q4 passt in ~8 GB) für den allgemeinen Einsatz. Qwen3-VL 8B für mehrsprachige OCR. Beide über Ollama verfügbar.',
          },
          {
            q: 'LLaVA vs. MiniCPM-V – welches ist besser für OCR?',
            a: 'MiniCPM-V 4.5 ist bei Dokument-OCR genauer, besonders bei dichten Tabellen und hochauflösenden Scans. LLaVA ist besser dokumentiert. Für OCR-Genauigkeit: MiniCPM-V. Für Community-Ressourcen: LLaVA.',
          },
          {
      ...
      sources: {
        ...
        items: [
          ...
          '[MiniCPM-V 4.5 auf Hugging Face](https://huggingface.co/openbmb/MiniCPM-V-2_6) — OpenBMB Modell-Card, OCR-Benchmarks und Fine-Tuning-Anleitung.',
          ...
          '[Qwen3-VL auf Hugging Face](https://huggingface.co/Qwen/Qwen3-VL-7B-Instruct) — Alibabas Qwen3-VL Modell-Card und multilinguale OCR-Benchmarks.',
      ...
      relatedReading: {
        ...
        items: [
          '[Ollama-Vision-Modelle (2026)](/de/power-local-llm/ollama-vision-models-review) — ein fokussierter, praktischer Leitfaden zum Ausführen von Vision-Modellen speziell über Ollama: echte CLI-/API-Syntax und welche Modelle tatsächlich in seiner Bibliothek sind.',
          '[VLMs in Kameras und auf Drohnen 2026](/de/power-local-llm/vlm-video-analytics-drones-edge) -- Desktop-VLM-Grundlagen stehen hier; fuer eingebettete Kameras und Drohnen siehe diesen Edge-fokussierten Guide.',
  ...
  fr: {
    ...
    next_refresh_due: '2026-12-19',
    theme: 'Voice, Speech & Multimodal',
    heroImage: '/images/local-vision-models-llava-ollama-2026-overview-hero-fr.webp',
    title: 'Modèles de vision locaux 2026 : LLaVA, Llama 3.2 Vision, Qwen3-VL & configuration Ollama',
    seoTitle: 'Modèles de vision locaux 2026 : LLaVA, Llama 3.2 Vision, Qwen3-VL & Ollama',
    intro:
      'Les modèles vision-langage (VLM) acceptent des entrées image et texte simultanément et produisent du texte — pour l\'OCR de documents, les questions-réponses sur images, l\'analyse de captures d\'écran et la lecture de graphiques, entièrement en local. En 2026, Ollama est la voie la plus simple : téléchargez un modèle, envoyez une image, obtenez une réponse. Ce guide compare les principaux VLM locaux (LLaVA 1.6, Llama 3.2 Vision, MiniCPM-V 4.5, Moondream 2, Qwen3-VL, InternVL 2.5) et explique la configuration d\'Ollama étape par étape.',
    metaDescription:
      'Exécuter des VLM locaux avec Ollama en 2026 : LLaVA 1.6, Llama 3.2 Vision, MiniCPM-V 4.5, Qwen3-VL. OCR de documents, questions-réponses sur images, captures d\'écran — hors ligne avec exigences VRAM et benchmarks.',
    twitterDescription:
      'Modèles de vision locaux 2026 : LLaVA, Llama 3.2 Vision, MiniCPM-V, Qwen3-VL via Ollama. OCR, Q&A images, captures d\'écran — 100 % hors ligne. Guide VRAM et configuration.',
    ...
    quickAnswerTop: {
      fr: {
        ...
        answer:
          'Le meilleur modèle de vision local dépend de votre VRAM et de votre cas d\'usage. Avec 6–8 Go de VRAM, MiniCPM-V 4.5 offre le meilleur équilibre entre précision OCR et compréhension générale des images. Avec 8–16 Go, Llama 3.2 Vision 11B est le choix principal. Avec 2 Go, Moondream 2 est la seule option.',
        bullets: [
          'Moins de 4 Go de VRAM → Moondream 2 (1,9B) : rapide, compréhension limitée. Aussi : PaliGemma 2 3B (~3 Go) et SmolVLM 2,2B (~2 Go).',
          '6 Go de VRAM → MiniCPM-V 4.5, LLaVA 1.6 7B ou Qwen3-VL 8B (meilleur OCR multilingue).',
          '8–16 Go de VRAM → Llama 3.2 Vision 11B : meilleur VLM local pour photos et documents.',
          '64+ Go (ou Apple M-Series) → Llama 3.2 Vision 90B ou Qwen3-VL 72B : qualité proche du cloud.',
          'Configuration : `ollama pull llama3.2-vision` puis `ollama run llama3.2-vision "Décris cette image" --image photo.jpg`.',
          'Meilleur OCR : Qwen3-VL 8B ≈ MiniCPM-V 4.5 > Llama 3.2 Vision 11B > LLaVA 1.6.',
    ...
    toc: [
      ...
      { label: 'Qwen3-VL — Meilleure OCR multilingue', anchor: '#qwen2vl-deep-dive' },
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**MiniCPM-V 4.5 (8B) est le premier choix pour l\'OCR de documents avec 6 Go de VRAM.** Ses données d\'entraînement incluent des scans haute résolution — plus précis que LLaVA sur les tableaux, factures et textes denses.',
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**Précision OCR :** Qwen3-VL 8B ≈ MiniCPM-V 4.5 > Llama 3.2 Vision 11B > LLaVA 1.6 13B > LLaVA 1.6 7B > Moondream 2.',
      ...
      modelComparison: {
        ...
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: 'Pour 6–8 Go de VRAM : MiniCPM-V 4.5 pour l\'OCR, Llama 3.2 Vision 11B pour les questions-réponses générales — tous deux en local via Ollama.',
          },
          {
            type: 'plain-terms',
        ...
        rows: [
          ...
          { 'Modèle': 'MiniCPM-V 4.5', 'Paramètres': '8B', 'VRAM (Q4)': '~6 Go', 'Types d\'images': 'Photos, documents, OCR', 'Qualité': 'Très bon', 'Via Ollama ?': 'Oui' },
          ...
          { 'Modèle': 'Qwen3-VL 8B', 'Paramètres': '7B', 'VRAM (Q4)': '~6 Go', 'Types d\'images': 'Photos, documents, OCR, multilingue', 'Qualité': 'Excellent', 'Via Ollama ?': 'Oui' },
          { 'Modèle': 'Qwen3-VL 72B', 'Paramètres': '72B', 'VRAM (Q4)': '~48 Go', 'Types d\'images': 'Photos, documents, complexe', 'Qualité': 'Meilleur open-source', 'Via Ollama ?': 'Oui' },
      ...
      invoiceAccuracyTest: {
        ...
        rows: [
          ...
          { 'Modèle': 'MiniCPM-V 4.5', 'Fournisseur': '✓', 'Date': '✓', 'Total': '✓', 'TVA': '✓', 'Lignes': '✓', 'Score': '5/5' },
          { 'Modèle': 'Qwen3-VL 8B', 'Fournisseur': '✓', 'Date': '✓', 'Total': '✓', 'TVA': '✓', 'Lignes': '✓', 'Score': '5/5' },
      ...
      multiImageSupport: {
        ...
        columns: ['Fonctionnalité', 'Moondream', 'LLaVA 7B', 'MiniCPM-V', 'Qwen3-VL', 'LLaVA 13B', 'Llama 3.2 Vision', 'InternVL'],
        rows: [
          {
        ...
        items: [
          'MiniCPM-V 4.5 accepte jusqu\'à 4 images par prompt ; Qwen3-VL jusqu\'à 8. LLaVA et Moondream n\'acceptent qu\'une image à la fois.',
...
print(result)`,
      ...
      useCaseOcr: {
        ...
        items: [
          ...
          '**Meilleurs modèles pour l\'OCR :** MiniCPM-V 4.5 (précision maximale dans la classe 6 Go), Llama 3.2 Vision 11B (meilleur sur les types de documents mixtes).',
      ...
      useCaseScreenshot: {
        ...
        items: [
          ...
          '**Meilleurs modèles :** InternVL 2.5 8B (meilleure compréhension UI), MiniCPM-V 4.5 (deuxième, avec support Ollama).',
        ],
      },
      useCaseChart: {
        id: 'use-case-chart',
...
print("\\n".join(f"[{i+1}s] {d}" for i, d in enumerate(descriptions)))`,
      ...
      vramReality: {
        ...
        rows: [
          ...
          { 'Modèle': 'MiniCPM-V 4.5 (8B)', 'VRAM (Q4)': '~6 Go', 'Tokens/sec (RTX 4070)': '~12–18', 'Tokens/sec (M5 Pro 36 Go)': '~15–20', 'Utilisable en production ?': 'Oui — OCR et documents' },
      ...
      localVsGpt4o: {
        ...
        callouts: [
          { type: 'note', text: 'Pour le traitement de factures avec une entrée propre, les VLM locaux (Llama 3.2 Vision 11B, Qwen3-VL 8B) peuvent remplacer GPT-5.5 Vision à coût zéro.' },
        ],
      },
      llavaDeepDive: {
        id: 'llava-deep-dive',
        ...
        items: [
          ...
          '**Points faibles :** OCR moins précis que MiniCPM-V 4.5, analyse UI moins bonne qu\'InternVL 2.5.',
          ...
          '**Avis complet :** [LLaVA : avis (2026)](/fr/power-local-llm/llava-review) — l\'avis dédié de PromptQuorum, avec la nuance de licence Apache-2.0 plus modèle de base et de vraies commandes Ollama.',
        ],
      },
      qwen2VlDeepDive: {
        id: 'qwen2vl-deep-dive',
        title: 'Qwen3-VL — Meilleure OCR multilingue',
        content:
          '**Qwen3-VL est le modèle vision-langage d\'Alibaba et la meilleure option open-source sur les benchmarks documentaires en 2026.**',
        items: [
          ...
          '**Installation Ollama :** `ollama pull qwen3-vl:7b`',
          '**Multi-images :** Jusqu\'à 8 images par requête — capacité maximale de cette comparaison.',
          '**Page du modèle :** [Qwen3-VL 8B sur Hugging Face](https://huggingface.co/Qwen/Qwen3-VL-7B-Instruct)',
        ],
      },
      howToChoose: {
        id: 'how-to-choose',
        ...
        items: [
          ...
          '**6 Go de VRAM :** MiniCPM-V 4.5 pour l\'OCR de documents. LLaVA 1.6 7B pour les questions-réponses générales sur photos. Qwen3-VL 8B pour l\'OCR multilingue.',
          ...
          '**64+ Go de mémoire unifiée :** Llama 3.2 Vision 90B pour la meilleure qualité locale. Qwen3-VL 72B comme alternative avec les meilleurs scores de benchmarks.',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'LLaVA 1.6 jusqu\'à 672×672 (découpage dynamique). MiniCPM-V 4.5 jusqu\'à 1792×1792. Llama 3.2 Vision jusqu\'à 1120×1120. Pour un meilleur OCR, envoyer des documents à 150+ DPI.',
          },
          {
          ...
          },
          {
            ...
            a: 'Llama 3.2 Vision 11B (Q4 tient dans ~8 Go) pour l\'usage général. Qwen3-VL 8B si l\'OCR multilingue est le besoin principal. Les deux disponibles via Ollama.',
          },
          {
            q: 'LLaVA vs MiniCPM-V — lequel est meilleur pour l\'OCR ?',
            a: 'MiniCPM-V 4.5 est plus précis sur l\'OCR de documents, notamment les tableaux denses et les scans haute résolution. LLaVA est mieux documenté. Pour la précision OCR : MiniCPM-V. Pour les ressources communautaires : LLaVA.',
          },
          {
      ...
      sources: {
        ...
        items: [
          ...
          '[MiniCPM-V 4.5 sur Hugging Face](https://huggingface.co/openbmb/MiniCPM-V-2_6) — Fiche modèle OpenBMB, benchmarks OCR et instructions de fine-tuning.',
          ...
          '[Qwen3-VL sur Hugging Face](https://huggingface.co/Qwen/Qwen3-VL-7B-Instruct) — Fiche modèle Qwen3-VL d\'Alibaba et benchmarks OCR multilingues.',
      ...
      relatedReading: {
        ...
        items: [
          '[Modèles de vision Ollama (2026)](/fr/power-local-llm/ollama-vision-models-review) — un guide pratique et concentré pour exécuter des modèles de vision spécifiquement via Ollama : syntaxe CLI/API réelle et modèles réellement présents dans sa bibliothèque.',
          '[VLM dans les cameras et sur les drones 2026](/fr/power-local-llm/vlm-video-analytics-drones-edge) -- Les bases du VLM de bureau sont ici ; pour un deploiement embarque camera/drone, voir ce guide dedie au edge computing.',
  ...
  ja: {
    ...
    next_refresh_due: '2026-12-19',
    theme: 'Voice, Speech & Multimodal',
    heroImage: '/images/local-vision-models-llava-ollama-2026-overview-hero-ja.webp',
    title: 'ローカルビジョンモデル2026：LLaVA・Llama 3.2 Vision・Qwen3-VL & Ollamaマルチモーダルセットアップ',
    seoTitle: 'ローカルビジョンモデル2026：LLaVA・Llama 3.2 Vision・Qwen3-VL & Ollamaセットアップ',
    intro:
      'ビジョン言語モデル（VLM）は画像とテキストを同時に処理し、テキスト出力を生成します。ドキュメントOCR、画像Q&A、スクリーンショット分析、グラフ解読をすべてローカルで実現できます。2026年、OllamaはVLMを最も簡単に実行する方法です：モデルをプル、画像を送信、説明または回答を取得。このガイドでは主要なローカルビジョンモデル（LLaVA 1.6、Llama 3.2 Vision、MiniCPM-V 4.5、Moondream 2、Qwen3-VL、InternVL 2.5）を比較し、Ollamaのセットアップ手順を解説します。',
    metaDescription:
      '2026年にOllamaでビジョン言語モデルをローカル実行：LLaVA 1.6、Llama 3.2 Vision、MiniCPM-V 4.5、Qwen3-VL。ドキュメントOCR、画像Q&A、スクリーンショット分析 — VRAM要件と品質ベンチマーク付きで完全オフライン対応。',
    twitterDescription:
      'ローカルビジョンモデル2026：LLaVA・Llama 3.2 Vision・MiniCPM-V・Qwen3-VL via Ollama。画像Q&A、OCR、スクリーンショット分析 — 100%オフライン。VRAMガイドとセットアップ手順。',
    readTime: '11分で読める',
    leadAnswerBlock:
      '**6〜8GB VRAMを持つ多くの開発者には、2026年の出発点としてMiniCPM-V 4.5（8B）またはLLaVA 1.6 7B（Ollama経由）が推奨されます。** 両モデルとも〜6GB VRAMで動作し、ドキュメントOCR、画像Q&A、スクリーンショット分析に対応し、単一のOllama pullコマンドで利用可能です。8〜16GB VRAMで最高品質を求めるなら、Llama 3.2 Vision 11Bが最良のローカルビジョンモデルであり、最強のローカルVLMです。すべてのモデルはダウンロード後に完全オフラインで動作します。',
    quickAnswerTop: {
      ja: {
        question: '2026年にOllamaで使えるベストなローカルビジョンモデルは？',
        answer:
          'VRAMとユースケースによって最適なモデルが異なります。6〜8GB VRAMではMiniCPM-V 4.5がOCR精度と一般的な画像理解のバランスが最良です。8〜16GB VRAMではLlama 3.2 Vision 11Bが最有力候補です。2GB VRAMではMoondream 2のみが選択肢です。',
        bullets: [
          '4GB未満 → Moondream 2（1.9B）：高速だが複雑な画像の理解は限定的。PaliGemma 2 3B（〜3GB）やSmolVLM 2.2B（〜2GB）も選択肢。',
          '6GB → MiniCPM-V 4.5、LLaVA 1.6 7B、またはQwen3-VL 8B（多言語OCRに最適）：品質とVRAMのバランスが良い。',
          '8〜16GB → Llama 3.2 Vision 11B：写真・ドキュメントに最強のローカルVLM。',
          '64GB以上（またはApple M-Series）→ Llama 3.2 Vision 90BまたはQwen3-VL 72B：クラウドに近い品質。',
          'セットアップ：`ollama pull llama3.2-vision` → `ollama run llama3.2-vision "この画像を説明して" --image photo.jpg`',
          'OCR精度：Qwen3-VL 8B ≈ MiniCPM-V 4.5 > Llama 3.2 Vision 11B > LLaVA 1.6',
    ...
    toc: [
      ...
      { label: 'Qwen3-VL — 最高の多言語OCR性能', anchor: '#qwen2vl-deep-dive' },
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**MiniCPM-V 4.5（8B）は6GB VRAMでのドキュメントOCRに最適です。** 高解像度ドキュメントスキャンを含むトレーニングデータにより、テーブル・請求書・密なテキストでLLaVAより高精度です。',
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**OCR精度：** Qwen3-VL 8B ≈ MiniCPM-V 4.5 > Llama 3.2 Vision 11B > LLaVA 1.6 13B > LLaVA 1.6 7B > Moondream 2。',
      ...
      modelComparison: {
        ...
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: '6〜8GB VRAMの場合：ドキュメントOCRにはMiniCPM-V 4.5、一般的な画像Q&AにはLlama 3.2 Vision 11B — 両方ともOllama経由でローカル実行可能。',
          },
          {
            type: 'plain-terms',
        ...
        rows: [
          ...
          { 'モデル': 'MiniCPM-V 4.5', 'パラメータ': '8B', 'VRAM (Q4)': '〜6GB', '画像タイプ': '写真・ドキュメント・OCR', '品質': '非常に良好', 'Ollama対応？': '対応' },
          ...
          { 'モデル': 'Qwen3-VL 8B', 'パラメータ': '7B', 'VRAM (Q4)': '〜6GB', '画像タイプ': '写真・ドキュメント・OCR・多言語', '品質': '優秀', 'Ollama対応？': '対応' },
          { 'モデル': 'Qwen3-VL 72B', 'パラメータ': '72B', 'VRAM (Q4)': '〜48GB', '画像タイプ': '写真・ドキュメント・複雑', '品質': 'オープンソース最高', 'Ollama対応？': '対応' },
      ...
      invoiceAccuracyTest: {
        ...
        rows: [
          ...
          { 'モデル': 'MiniCPM-V 4.5', 'ベンダー': '✓', '日付': '✓', '合計': '✓', '税額': '✓', '行項目': '✓', 'スコア': '5/5' },
          { 'モデル': 'Qwen3-VL 8B', 'ベンダー': '✓', '日付': '✓', '合計': '✓', '税額': '✓', '行項目': '✓', 'スコア': '5/5' },
      ...
      multiImageSupport: {
        ...
        columns: ['機能', 'Moondream', 'LLaVA 7B', 'MiniCPM-V', 'Qwen3-VL', 'LLaVA 13B', 'Llama 3.2 Vision', 'InternVL'],
        rows: [
          {
            '機能': 'マルチ画像入力',
            'Moondream': '非対応',
        ...
        items: [
          'MiniCPM-V 4.5は1プロンプトで最大4枚の画像を受け付け、Qwen3-VLは最大8枚に対応。LLaVAとMoondreamは1リクエストにつき1枚のみです。',
...
print(result)`,
      ...
      useCaseOcr: {
        ...
        items: [
          ...
          '**OCRに最適なモデル：** MiniCPM-V 4.5（6GBクラスで最高のOCR精度）、Llama 3.2 Vision 11B（混合ドキュメントタイプに最適）。',
      ...
      useCaseScreenshot: {
        ...
        items: [
          ...
          '**最適なモデル：** InternVL 2.5 8B（最高のUI理解）、MiniCPM-V 4.5（2番目に良く、Ollamaサポートあり）。',
        ],
      },
      useCaseChart: {
        id: 'use-case-chart',
...
print("\\n".join(f"[{i+1}s] {d}" for i, d in enumerate(descriptions)))`,
      ...
      vramReality: {
        ...
        rows: [
          ...
          { 'モデル': 'MiniCPM-V 4.5 (8B)', 'VRAM (Q4)': '〜6GB', 'トークン/秒 (RTX 4070)': '〜12〜18', 'トークン/秒 (M5 Pro 36GB)': '〜15〜20', '本番対応？': 'はい — OCRとドキュメント' },
      ...
      localVsGpt4o: {
        ...
        callouts: [
          { type: 'note', text: 'クリーンな入力での請求書・フォーム処理なら、ローカルVLM（Llama 3.2 Vision 11B、Qwen3-VL 8B）がGPT-5.5 Visionをゼロコストで代替できます。手書きや複雑なシーン分析にはGPT-5.5が依然として優位です。' },
        ],
      },
      llavaDeepDive: {
        id: 'llava-deep-dive',
        ...
        items: [
          ...
          '**弱み：** MiniCPM-V 4.5よりOCRが弱く、InternVL 2.5よりUI分析が劣り、Llama 3.2 Vision 11Bに品質ベンチマークで全体的に上回られている。',
          '**それでも推奨される理由：** すべてのローカルVLMの中で最大のコミュニティ・最多のチュートリアル・最多のプロンプト例を持つ。問題が発生した時にサポートが見つけやすい。',
          '**詳細レビュー：** [LLaVAレビュー(2026)](/ja/power-local-llm/llava-review) — Apache-2.0とベースモデルライセンスの微妙な違い、実際のOllamaコマンドを含むPromptQuorumの専用レビュー。',
        ],
      },
      qwen2VlDeepDive: {
        id: 'qwen2vl-deep-dive',
        title: 'Qwen3-VL — 最高の多言語OCR性能',
        content:
          '**Qwen3-VLはAlibabaのビジョン言語モデルで、2026年のドキュメントベンチマークで最強のオープンソース選択肢です。**',
        items: [
          ...
          '**Ollamaインストール：** `ollama pull qwen3-vl:7b` — Ollamaモデルライブラリから直接利用可能。',
          '**マルチ画像サポート：** 1リクエストで最大8枚 — この比較で最高のマルチ画像容量。',
          '**モデルページ：** [Hugging FaceのQwen3-VL 8B](https://huggingface.co/Qwen/Qwen3-VL-7B-Instruct)',
        ],
      },
      howToChoose: {
        id: 'how-to-choose',
        ...
        items: [
          ...
          '**6GB VRAM：** ドキュメントOCRと請求書処理にはMiniCPM-V 4.5。コミュニティサポートが重要な一般写真Q&AにはLLaVA 1.6 7B。多言語OCRまたは最高精度が必要な場合はQwen3-VL 8B。',
          ...
          '**64GB以上のユニファイドメモリ（Apple M-Max/Ultra、マルチGPU）：** ドキュメントタスクでクラウドレベルに近いLlama 3.2 Vision 90B。最高のオープンソースベンチマークスコアを持つQwen3-VL 72Bも選択肢。',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'LLaVA 1.6は動的パッチングで最大672×672。MiniCPM-V 4.5は最大1792×1792 — 高DPIドキュメントスキャンでLLaVAを上回る理由の一つ。Llama 3.2 Visionは最大1120×1120の可変解像度。最良のOCR結果のためにドキュメント画像は150+ DPIで送信してください。',
          },
          {
          ...
          },
          {
            ...
            a: 'Llama 3.2 Vision 11B（Q4量子化で〜8GBに収まる）が一般使用に最適。多言語OCRが主な用途なら Qwen3-VL 8B。両方ともOllamaで単一コマンドで利用可能。',
          },
          {
            q: 'LLaVA vs MiniCPM-V — OCRにはどちらが優れていますか？',
            a: 'MiniCPM-V 4.5はドキュメントOCR、特に密なテーブルと高DPIスキャンでより精確。LLaVA 1.6はより文書化されていてコミュニティサポートが充実。純粋なOCR精度にはMiniCPM-V。コミュニティリソースとトラブルシューティングにはLLaVAを選択。',
          },
          {
            q: 'ローカルビジョンモデルは手書きを読めますか？',
            a: '活字体の手書き（ブロック体）：Llama 3.2 Vision 11BとMiniCPM-V 4.5で中程度の精度で認識可能。草書体：すべてのローカルモデルで信頼性が低い。GPT-5.5 Visionは草書体で大幅に優れています。草書体ドキュメントの本番手書きOCRにはクラウドAPIが依然として推奨されます。',
          },
        ],
      },
      sources: {
        ...
        items: [
          ...
          '[Hugging FaceのMiniCPM-V 4.5](https://huggingface.co/openbmb/MiniCPM-V-2_6) — OpenBMBモデルカード、OCRベンチマーク、ファインチューニング手順。',
          ...
          '[Hugging FaceのQwen3-VL](https://huggingface.co/Qwen/Qwen3-VL-7B-Instruct) — AlibabaのQwen3-VLモデルカード、アーキテクチャの詳細、多言語OCRベンチマーク。',
      ...
      relatedReading: {
        ...
        title: '関連記事',
        items: [
          '[Ollamaビジョンモデル(2026)](/ja/power-local-llm/ollama-vision-models-review) — Ollama経由でビジョンモデルを実行するための実践ガイド。実際のCLI/API構文と、ライブラリに実際にあるモデルを解説。',
          '[カメラとドローンにおけるVLM 2026](/ja/power-local-llm/vlm-video-analytics-drones-edge) -- デスクトップVLMの基礎はこちら。組み込みカメラ・ドローン展開についてはこのエッジ向けガイドを参照。',
  ...
  zh: {
    ...
    next_refresh_due: '2026-12-19',
    theme: 'Voice, Speech & Multimodal',
    heroImage: '/images/local-vision-models-llava-ollama-2026-overview-hero-zh.webp',
    title: '本地视觉模型2026：LLaVA、Llama 3.2 Vision、Qwen3-VL与Ollama多模态配置',
    seoTitle: '本地视觉模型2026：LLaVA、Llama 3.2 Vision、Qwen3-VL与Ollama配置指南',
    intro:
      '视觉语言模型（VLM）同时接受图像和文本输入，输出文本内容——支持文档OCR、图像问答、截图分析和图表解读，全部在本地完成。2026年，通过Ollama运行VLM是最简便的方式：拉取模型、发送图像、获取描述或答案。本指南对比主要本地视觉模型（LLaVA 1.6、Llama 3.2 Vision、MiniCPM-V 4.5、Moondream 2、Qwen3-VL、InternVL 2.5），提供Ollama逐步配置说明及VRAM要求和质量基准。',
    metaDescription:
      '2026年使用Ollama在本地运行视觉语言模型：LLaVA 1.6、Llama 3.2 Vision、MiniCPM-V 4.5、Qwen3-VL。文档OCR、图像问答、截图分析——含VRAM要求和质量基准，完全离线使用。',
    twitterDescription:
      '本地视觉模型2026：通过Ollama运行LLaVA、Llama 3.2 Vision、MiniCPM-V、Qwen3-VL。图像问答、OCR、截图分析——100%离线。VRAM指南与配置步骤。',
    readTime: '阅读约11分钟',
    leadAnswerBlock:
      '**对于大多数拥有6–8 GB VRAM的开发者，2026年推荐从MiniCPM-V 4.5（8B）或LLaVA 1.6 7B（通过Ollama）开始。** 两者均可在约6 GB VRAM下运行，支持文档OCR、图像问答和截图分析，且通过单条Ollama命令即可获取。若拥有8–16 GB VRAM并追求最高质量，Llama 3.2 Vision 11B是最佳本地视觉模型和最强本地VLM。所有模型下载后均可完全离线运行，无需API密钥或云账户。',
    quickAnswerTop: {
      zh: {
        question: '2026年哪些本地视觉模型最适合与Ollama配合使用？',
        answer:
          '最佳本地视觉模型取决于您的VRAM和使用场景。6–8 GB VRAM时，MiniCPM-V 4.5在OCR精度和通用图像理解之间达到最佳平衡。8–16 GB VRAM时，Llama 3.2 Vision 11B是通用视觉问答和文档分析的首选。仅有2 GB VRAM时，Moondream 2是唯一选项——速度快但能力有限。',
        bullets: [
          '4 GB以下 → Moondream 2（1.9B）：速度快，复杂图像理解有限。另可选PaliGemma 2 3B（约3 GB）和SmolVLM 2.2B（约2 GB）。',
          '6 GB → MiniCPM-V 4.5、LLaVA 1.6 7B或Qwen3-VL 8B（多语言OCR最佳）：质量与硬件的最佳平衡。',
          '8–16 GB → Llama 3.2 Vision 11B：通用照片和文档的最强本地VLM。',
          '64 GB以上（或Apple M系列）→ Llama 3.2 Vision 90B或Qwen3-VL 72B：最佳本地质量，接近云端水平。',
          '配置：`ollama pull llama3.2-vision` 然后 `ollama run llama3.2-vision "描述这张图片" --image photo.jpg`',
          'OCR最强：Qwen3-VL 8B ≈ MiniCPM-V 4.5 > Llama 3.2 Vision 11B > LLaVA 1.6',
    ...
    toc: [
      ...
      { label: 'Qwen3-VL——最强多语言OCR', anchor: '#qwen2vl-deep-dive' },
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**MiniCPM-V 4.5（8B）是6 GB VRAM下文档OCR的首选。** 训练数据包含高分辨率文档扫描，在表格、发票和密集文本处理上比LLaVA更精准。',
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**OCR强度：** Qwen3-VL 8B ≈ MiniCPM-V 4.5 > Llama 3.2 Vision 11B > LLaVA 1.6 13B > LLaVA 1.6 7B > Moondream 2。',
      ...
      modelComparison: {
        ...
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: '6–8 GB VRAM：文档OCR选MiniCPM-V 4.5，通用图像问答选Llama 3.2 Vision 11B——均可通过Ollama本地运行。',
          },
          {
            type: 'plain-terms',
        ...
        rows: [
          ...
          { '模型': 'MiniCPM-V 4.5', '参数量': '8B', 'VRAM (Q4)': '约6 GB', '图像类型': '照片、文档、OCR', '质量': '非常好', '支持Ollama？': '是' },
          ...
          { '模型': 'Qwen3-VL 8B', '参数量': '7B', 'VRAM (Q4)': '约6 GB', '图像类型': '照片、文档、OCR、多语言', '质量': '优秀', '支持Ollama？': '是' },
          { '模型': 'Qwen3-VL 72B', '参数量': '72B', 'VRAM (Q4)': '约48 GB', '图像类型': '照片、文档、复杂', '质量': '开源最强', '支持Ollama？': '是' },
      ...
      invoiceAccuracyTest: {
        ...
        rows: [
          ...
          { '模型': 'MiniCPM-V 4.5', '供应商': '✓', '日期': '✓', '总金额': '✓', '税额': '✓', '行项目': '✓', '得分': '5/5' },
          { '模型': 'Qwen3-VL 8B', '供应商': '✓', '日期': '✓', '总金额': '✓', '税额': '✓', '行项目': '✓', '得分': '5/5' },
      ...
      multiImageSupport: {
        ...
        columns: ['功能', 'Moondream', 'LLaVA 7B', 'MiniCPM-V', 'Qwen3-VL', 'LLaVA 13B', 'Llama 3.2 Vision', 'InternVL'],
        rows: [
          {
            '功能': '多图像输入',
            'Moondream': '不支持',
        ...
        items: [
          'MiniCPM-V 4.5每次提示最多接受4张图像；Qwen3-VL最多支持8张。LLaVA和Moondream每次请求只接受单张图像。',
...
print(result)`,
      ...
      useCaseOcr: {
        ...
        items: [
          ...
          '**OCR最佳模型：** MiniCPM-V 4.5（6 GB级别中OCR精度最高），Llama 3.2 Vision 11B（混合文档类型最优）。',
      ...
      useCaseScreenshot: {
        ...
        items: [
          ...
          '**最佳模型：** InternVL 2.5 8B（UI理解最强），MiniCPM-V 4.5（次优，支持Ollama）。',
        ],
      },
      useCaseChart: {
        id: 'use-case-chart',
...
print("\\n".join(f"[{i+1}s] {d}" for i, d in enumerate(descriptions)))`,
      ...
      vramReality: {
        ...
        rows: [
          ...
          { '模型': 'MiniCPM-V 4.5 (8B)', 'VRAM (Q4)': '约6 GB', 'token/秒 (RTX 4070)': '约12–18', 'token/秒 (M5 Pro 36GB)': '约15–20', '适合生产？': '是——OCR和文档' },
      ...
      localVsGpt4o: {
        ...
        callouts: [
          { type: 'note', text: '对于输入规范的发票和表单处理，本地VLM（Llama 3.2 Vision 11B、Qwen3-VL 8B）可以零成本替代GPT-5.5 Vision。涉及手写、复杂场景分析或模糊内容时，GPT-5.5仍占优势。' },
        ],
      },
      llavaDeepDive: {
        id: 'llava-deep-dive',
        ...
        items: [
          ...
          '**劣势：** OCR弱于MiniCPM-V 4.5，UI分析弱于InternVL 2.5，质量基准测试中整体被Llama 3.2 Vision 11B超越。',
          '**仍被推荐的原因：** 在所有本地VLM中拥有最大社区、最多教程和最多提示示例。遇到问题时更容易找到帮助。',
          '**完整评测：** [LLaVA评测(2026)](/zh/power-local-llm/llava-review) — PromptQuorum的专门评测,包括Apache-2.0与基础模型许可证的细微差别及真实的Ollama命令。',
        ],
      },
      qwen2VlDeepDive: {
        id: 'qwen2vl-deep-dive',
        title: 'Qwen3-VL——最强多语言OCR',
        content:
          '**Qwen3-VL是阿里巴巴的视觉语言模型，是2026年文档基准测试中最强的开源选择。** 7B版本在更低VRAM下与Llama 3.2 Vision 11B竞争力相当，72B版本领跑大多数开源VLM排行榜。',
        items: [
          ...
          '**Ollama安装：** `ollama pull qwen3-vl:7b`——可直接从Ollama模型库获取。',
          '**多图像支持：** 每次请求最多接受8张图像——本比较中多图像容量最高。',
          '**模型页面：** [Hugging Face上的Qwen3-VL 8B](https://huggingface.co/Qwen/Qwen3-VL-7B-Instruct)',
        ],
      },
      howToChoose: {
        id: 'how-to-choose',
        ...
        items: [
          ...
          '**6 GB VRAM：** 文档OCR和发票处理选MiniCPM-V 4.5。注重社区支持的通用照片问答选LLaVA 1.6 7B。多语言OCR或追求最高OCR精度时选Qwen3-VL 8B。',
          ...
          '**64 GB以上统一内存（Apple M-Max/Ultra、多GPU）：** Llama 3.2 Vision 90B提供最佳本地VLM质量，文档任务接近云端水平。Qwen3-VL 72B是拥有顶级开源基准得分的备选方案。',
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: '本地VLM支持什么图像分辨率？',
            a: 'LLaVA 1.6支持最高672×672有效分辨率（动态分块）。MiniCPM-V 4.5支持最高1792×1792——这也是其在高DPI文档扫描上优于LLaVA的原因之一。Llama 3.2 Vision支持最高1120×1120的可变分辨率。最佳OCR效果请以150+ DPI发送文档图像。',
          },
          {
          ...
          },
          {
            ...
            a: 'Llama 3.2 Vision 11B（Q4量化可放入约8 GB）适合通用使用。若主要需求是多语言OCR，则选Qwen3-VL 8B。两者均可通过Ollama单条命令获取。',
          },
          {
            q: 'LLaVA与MiniCPM-V——哪个OCR效果更好？',
            a: 'MiniCPM-V 4.5在文档OCR上更精准，尤其是密集表格和高DPI扫描件。LLaVA 1.6文档更完善，社区支持更好。追求纯OCR精度选MiniCPM-V；需要社区资源和排错支持选LLaVA。',
          },
          {
            q: '本地视觉模型能识别手写吗？',
            a: '印刷体手写（块状字母）：Llama 3.2 Vision 11B和MiniCPM-V 4.5可以中等精度识别。草书手写：所有本地模型均不可靠。GPT-5.5 Vision在草书方面大幅领先。生产环境中的草书文档手写OCR仍建议使用云端API。',
          },
        ],
      },
      sources: {
        ...
        items: [
          ...
          '[Hugging Face上的MiniCPM-V 4.5](https://huggingface.co/openbmb/MiniCPM-V-2_6) — OpenBMB模型卡、OCR基准及微调说明。',
          ...
          '[Hugging Face上的Qwen3-VL](https://huggingface.co/Qwen/Qwen3-VL-7B-Instruct) — 阿里巴巴Qwen3-VL模型卡、架构详情和多语言OCR基准。',
      ...
      relatedReading: {
        ...
        title: '延伸阅读',
        items: [
          '[Ollama视觉模型(2026)](/zh/power-local-llm/ollama-vision-models-review) —— 通过Ollama运行视觉模型的实用指南:真实的CLI/API语法,以及模型库中实际列出的模型。',
          '[摄像头与无人机中的 VLM 2026](/zh/power-local-llm/vlm-video-analytics-drones-edge) -- 桌面端 VLM 基础见本文；嵌入式摄像头与无人机部署请参阅这份边缘专属指南。',
  ...
  es: {
    ...
    next_refresh_due: '2026-12-19',
    theme: 'Voice, Speech & Multimodal',
    heroImage: '/images/local-vision-models-llava-ollama-2026-overview-hero-es.webp',
    title: 'Modelos de visión locales 2026: LLaVA, Llama 3.2 Vision, Qwen3-VL y configuración multimodal con Ollama',
    seoTitle: 'Mejores modelos de visión locales 2026: LLaVA y Qwen3-VL',
    intro:
      'Los modelos visión-lenguaje (VLM) aceptan imágenes y texto como entrada y devuelven texto — para OCR de documentos, preguntas y respuestas sobre imágenes, análisis de capturas de pantalla y lectura de gráficos, todo en local. En 2026, la forma más sencilla de ejecutar VLMs es a través de Ollama: descarga un modelo, envía una imagen y obtén una descripción o respuesta. Esta guía compara los principales modelos de visión locales (LLaVA 1.6, Llama 3.2 Vision, MiniCPM-V 4.5, Moondream 2, Qwen3-VL, InternVL 2.5), explica la configuración de Ollama paso a paso y asocia cada modelo con su mejor caso de uso según los requisitos de VRAM y los benchmarks de calidad.',
    metaDescription:
      'Preguntas sobre imágenes, OCR y análisis de capturas offline en 2026. Benchmark: LLaVA 1.6, Llama 3.2 Vision, Qwen3-VL y MiniCPM-V. VRAM y setup con Ollama.',
    twitterDescription:
    ...
    quickAnswerTop: {
      es: {
        ...
        bullets: [
          ...
          '6 GB de VRAM → MiniCPM-V 4.5, LLaVA 1.6 7B o Qwen3-VL 8B (mejor para OCR multilingüe): mejor equilibrio entre calidad y hardware.',
          '8–16 GB de VRAM → Llama 3.2 Vision 11B: el mejor VLM local para fotografías y documentos en general.',
          '64+ GB (o Apple M-series) → Llama 3.2 Vision 90B o Qwen3-VL 72B: mejor calidad local, rendimiento cercano a la nube.',
          'Configuración: `ollama pull llama3.2-vision` luego `ollama run llama3.2-vision "Describe esta imagen" --image foto.jpg`.',
          'Mejor para OCR: Qwen3-VL 8B ≈ MiniCPM-V 4.5 > Llama 3.2 Vision 11B > LLaVA 1.6 — fuerte en extracción de texto de documentos.',
    ...
    toc: [
      ...
      { label: 'Qwen3-VL — Mejor OCR multilingüe', anchor: '#qwen2vl-deep-dive' },
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**MiniCPM-V 4.5 (8B) es la primera opción para OCR de documentos con 6 GB de VRAM.** Sus datos de entrenamiento incluyen escaneos de documentos en alta resolución, lo que lo hace más preciso que LLaVA en tablas, facturas y texto denso.',
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**Precisión OCR:** Qwen3-VL 8B ≈ MiniCPM-V 4.5 > Llama 3.2 Vision 11B > LLaVA 1.6 13B > LLaVA 1.6 7B > Moondream 2.',
      ...
      modelComparison: {
        ...
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: 'Para 6–8 GB de VRAM: MiniCPM-V 4.5 para OCR de documentos, Llama 3.2 Vision 11B para Q&A de imágenes en general — ambos se ejecutan en local vía Ollama.',
          },
          {
            type: 'plain-terms',
      ...
      invoiceAccuracyTest: {
        ...
        rows: [
          ...
          { 'Modelo': 'MiniCPM-V 4.5', 'Proveedor': '✓', 'Fecha': '✓', 'Total': '✓', 'Impuesto': '✓', 'Líneas': '✓', 'Puntuación': '5/5' },
          { 'Modelo': 'Qwen3-VL 8B', 'Proveedor': '✓', 'Fecha': '✓', 'Total': '✓', 'Impuesto': '✓', 'Líneas': '✓', 'Puntuación': '5/5' },
      ...
      multiImageSupport: {
        ...
        columns: ['Función', 'Moondream', 'LLaVA 7B', 'MiniCPM-V', 'Qwen3-VL', 'LLaVA 13B', 'Llama 3.2 Vision', 'InternVL'],
        rows: [
          {
        ...
        items: [
          'MiniCPM-V 4.5 acepta hasta 4 imágenes por prompt; Qwen3-VL admite hasta 8. LLaVA y Moondream solo aceptan una imagen por solicitud.',
...
print(result)`,
      ...
      useCaseOcr: {
        ...
        items: [
          ...
          '**Mejores modelos para OCR:** MiniCPM-V 4.5 (mayor precisión OCR en la categoría de 6 GB), Llama 3.2 Vision 11B (mejor para tipos de documentos mixtos).',
      ...
      useCaseScreenshot: {
        ...
        items: [
          ...
          '**Mejores modelos:** InternVL 2.5 8B (mejor comprensión de UI), MiniCPM-V 4.5 (segunda opción, con soporte de Ollama).',
        ],
      },
      useCaseChart: {
        id: 'use-case-chart',
...
print("\\n".join(f"[{i+1}s] {d}" for i, d in enumerate(descriptions)))`,
      ...
      localVsGpt4o: {
        ...
        callouts: [
          {
            type: 'note',
            text: 'Para el procesamiento en producción de facturas y formularios con entrada limpia, los VLMs locales (Llama 3.2 Vision 11B, Qwen3-VL 8B) pueden reemplazar a GPT-5.5 Vision a cero costo. Para todo lo que involucre escritura a mano, análisis de escenas complejas o contenido ambiguo, GPT-5.5 sigue siendo superior.',
          },
        ],
      },
      llavaDeepDive: {
        ...
        items: [
          ...
          '**Debilidades:** OCR más débil que MiniCPM-V 4.5, análisis de UI más débil que InternVL 2.5, superado en general por Llama 3.2 Vision 11B en benchmarks de calidad.',
          ...
          '**Análisis completo:** [LLaVA: análisis (2026)](/es/power-local-llm/llava-review) — el análisis dedicado de PromptQuorum, con el matiz de licencia Apache-2.0 más modelo base y comandos reales de Ollama.',
        ],
      },
      qwen2VlDeepDive: {
        id: 'qwen2vl-deep-dive',
        title: 'Qwen3-VL — Mejor OCR multilingüe y rendimiento en documentos',
        content:
          '**Qwen3-VL es el modelo visión-lenguaje de Alibaba y la opción de código abierto más potente en benchmarks de documentos en 2026.** La variante de 7B es competitiva con Llama 3.2 Vision 11B con menos VRAM, y la variante de 72B encabeza la mayoría de los rankings de VLMs de código abierto.',
        items: [
          ...
          '**Instalación en Ollama:** `ollama pull qwen3-vl:7b` — disponible directamente desde la biblioteca de modelos de Ollama.',
          ...
          '**Página del modelo:** [Qwen3-VL 8B en Hugging Face](https://huggingface.co/Qwen/Qwen3-VL-7B-Instruct)',
        ],
      },
      howToChoose: {
        id: 'how-to-choose',
        ...
        items: [
          ...
          '**6 GB de VRAM:** MiniCPM-V 4.5 para OCR de documentos y procesamiento de facturas. LLaVA 1.6 7B para Q&A general sobre fotos donde el soporte comunitario importa. Qwen3-VL 8B para OCR multilingüe o cuando se necesita la mayor precisión OCR posible.',
          ...
          '**64+ GB de memoria unificada (Apple M-Max/Ultra, multi-GPU):** Llama 3.2 Vision 90B para la mejor calidad de VLM local disponible, acercándose al rendimiento de nivel nube para tareas con documentos. Qwen3-VL 72B es una alternativa con las mejores puntuaciones en benchmarks de código abierto.',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'LLaVA 1.6 admite hasta 672×672 de resolución efectiva (con parches dinámicos). MiniCPM-V 4.5 admite hasta 1792×1792 — una razón por la que supera a LLaVA en escaneos de documentos a alto DPI. Llama 3.2 Vision admite resolución variable hasta 1120×1120. Para los mejores resultados de OCR, envía imágenes de documentos a 150+ DPI.',
          },
          {
          ...
          },
          {
            ...
            a: 'Llama 3.2 Vision 11B (Q4 cuantizado cabe en ~8 GB) para uso general. Qwen3-VL 8B si el OCR multilingüe es la necesidad principal. Ambos disponibles vía Ollama con un único comando pull.',
          },
          {
            q: 'LLaVA vs MiniCPM-V — ¿cuál es mejor para OCR?',
            a: 'MiniCPM-V 4.5 es más preciso en OCR de documentos, especialmente en tablas densas y escaneos a alto DPI. LLaVA 1.6 está mejor documentado y tiene más soporte comunitario. Para pura precisión de OCR, elige MiniCPM-V. Para recursos comunitarios y solución de problemas, elige LLaVA.',
          },
          {
            q: '¿Pueden los modelos de visión locales leer escritura a mano?',
            a: 'Escritura a mano en letra de molde (letras de bloque): sí, con precisión moderada en Llama 3.2 Vision 11B y MiniCPM-V 4.5. Escritura en cursiva: poco fiable en todos los modelos locales. GPT-5.5 Vision es significativamente mejor con cursiva. Para OCR de escritura a mano en cursiva en producción, se siguen recomendando las APIs en la nube.',
          },
        ],
      },
      sources: {
        ...
        items: [
          ...
          '[MiniCPM-V 4.5 en Hugging Face](https://huggingface.co/openbmb/MiniCPM-V-2_6) — Tarjeta de modelo de OpenBMB, benchmarks de OCR e instrucciones de fine-tuning.',
          ...
          '[Qwen3-VL en Hugging Face](https://huggingface.co/Qwen/Qwen3-VL-7B-Instruct) — Tarjeta de modelo Qwen3-VL de Alibaba, detalles de arquitectura y benchmarks de OCR multilingüe.',
      ...
      relatedReading: {
        ...
        items: [
          '[Modelos de visión de Ollama (2026)](/es/power-local-llm/ollama-vision-models-review) — una guía práctica y enfocada para ejecutar modelos de visión específicamente mediante Ollama: sintaxis real de CLI/API y qué modelos hay realmente en su biblioteca.',
          '[VLM en Camaras y Drones 2026](/es/power-local-llm/vlm-video-analytics-drones-edge) -- Los fundamentos de VLM de escritorio estan aqui; para despliegue embebido en camaras y drones, consulta esta guia centrada en el borde.',
       ...
       '@type': 'TechArticle',
       headline: 'Modelos de visión locales 2026: LLaVA, Llama 3.2 Vision, Qwen3-VL y configuración multimodal con Ollama',
       description: 'Preguntas sobre imágenes, OCR y análisis de capturas de pantalla sin conexión en 2026. Benchmark: LLaVA 1.6, Llama 3.2 Vision, Qwen3-VL, MiniCPM-V. Guía de VRAM y pasos de configuración con Ollama.',
  ...
  pt: {
    ...
    next_refresh_due: '2026-12-19',
    theme: 'Voice, Speech & Multimodal',
    heroImage: '/images/local-vision-models-llava-ollama-2026-overview-hero-pt.webp',
    title: 'Modelos de visão locais 2026: LLaVA, Llama 3.2 Vision, Qwen3-VL e configuração multimodal com Ollama',
    seoTitle: 'Melhores modelos de visão locais 2026: LLaVA e Qwen3-VL',
    intro:
    ...
    metaDescription:
      'Perguntas sobre imagens, OCR e análise de capturas offline em 2026. Benchmark: LLaVA 1.6, Llama 3.2 Vision, Qwen3-VL e MiniCPM-V. VRAM e setup com Ollama.',
    twitterDescription:
    ...
    quickAnswerTop: {
      pt: {
        ...
        bullets: [
          ...
          '6 GB de VRAM → MiniCPM-V 4.5, LLaVA 1.6 7B ou Qwen3-VL 8B (melhor para OCR multilíngue): melhor equilíbrio entre qualidade e hardware.',
          '8–16 GB de VRAM → Llama 3.2 Vision 11B: o melhor VLM local para fotografias e documentos em geral.',
          '64+ GB (ou Apple M-series) → Llama 3.2 Vision 90B ou Qwen3-VL 72B: melhor qualidade local, desempenho próximo à nuvem.',
          'Configuração: `ollama pull llama3.2-vision` depois `ollama run llama3.2-vision "Descreva esta imagem" --image foto.jpg`.',
          'Melhor para OCR: Qwen3-VL 8B ≈ MiniCPM-V 4.5 > Llama 3.2 Vision 11B > LLaVA 1.6 — forte na extração de texto de documentos.',
    ...
    toc: [
      ...
      { label: 'Qwen3-VL — Melhor OCR multilíngue', anchor: '#qwen2vl-deep-dive' },
    ...
    sections: {
      ...
      modelComparison: {
        ...
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: 'Para 6–8 GB de VRAM: MiniCPM-V 4.5 para OCR de documentos, Llama 3.2 Vision 11B para Q&A de imagens em geral — ambos executam localmente via Ollama.',
          },
          {
            type: 'plain-terms',
      ...
      invoiceAccuracyTest: {
        ...
        rows: [
          ...
          { 'Modelo': 'MiniCPM-V 4.5', 'Fornecedor': '✓', 'Data': '✓', 'Total': '✓', 'Imposto': '✓', 'Linhas': '✓', 'Pontuação': '5/5' },
          { 'Modelo': 'Qwen3-VL 8B', 'Fornecedor': '✓', 'Data': '✓', 'Total': '✓', 'Imposto': '✓', 'Linhas': '✓', 'Pontuação': '5/5' },
      ...
      multiImageSupport: {
        ...
        columns: ['Função', 'Moondream', 'LLaVA 7B', 'MiniCPM-V', 'Qwen3-VL', 'LLaVA 13B', 'Llama 3.2 Vision', 'InternVL'],
        rows: [
          {
...
print("\\n".join(f"[{i+1}s] {d}" for i, d in enumerate(descriptions)))`,
      ...
      localVsGpt4o: {
        ...
        callouts: [
          {
            type: 'note',
            text: 'Para o processamento em produção de faturas e formulários com entrada limpa, os VLMs locais (Llama 3.2 Vision 11B, Qwen3-VL 8B) podem substituir o GPT-5.5 Vision a custo zero. Para tudo que envolva escrita à mão, análise de cenas complexas ou conteúdo ambíguo, o GPT-5.5 ainda é superior.',
          },
        ],
      },
      llavaDeepDive: {
        ...
        items: [
          ...
          '**Análise completa:** [LLaVA: análise (2026)](/pt/power-local-llm/llava-review) — a análise dedicada da PromptQuorum, com a nuance de licença Apache-2.0 mais modelo base e comandos reais do Ollama.',
        ],
      },
      qwen2VlDeepDive: {
        id: 'qwen2vl-deep-dive',
        title: 'Qwen3-VL — Melhor OCR multilíngue e desempenho em documentos',
        content:
        ...
        items: [
          ...
          '**Página do modelo:** [Qwen3-VL 8B no Hugging Face](https://huggingface.co/Qwen/Qwen3-VL-7B-Instruct)',
        ],
      },
      howToChoose: {
        id: 'how-to-choose',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'LLaVA 1.6 suporta até 672×672 de resolução efetiva (com patches dinâmicos). MiniCPM-V 4.5 suporta até 1792×1792. Llama 3.2 Vision suporta resolução variável até 1120×1120. Para os melhores resultados de OCR, envie imagens de documentos a 150+ DPI.',
          },
          {
          ...
          },
          {
            ...
            a: 'Llama 3.2 Vision 11B (Q4 quantizado cabe em ~8 GB) para uso geral. Qwen3-VL 8B se o OCR multilíngue é a necessidade principal. Ambos disponíveis via Ollama com um único comando pull.',
          },
          {
            q: 'LLaVA vs MiniCPM-V — qual é melhor para OCR?',
            a: 'MiniCPM-V 4.5 é mais preciso em OCR de documentos, especialmente em tabelas densas e escaneamentos a alto DPI. LLaVA 1.6 está melhor documentado e tem mais suporte comunitário.',
          },
          {
            q: 'Os modelos de visão locais conseguem ler escrita à mão?',
            a: 'Escrita à mão em letra de forma (letras em bloco): sim, com precisão moderada em Llama 3.2 Vision 11B e MiniCPM-V 4.5. Escrita em cursiva: pouco confiável em todos os modelos locais. GPT-5.5 Vision é significativamente melhor com cursiva.',
          },
        ],
      },
      sources: {
        ...
        items: [
          ...
          '[MiniCPM-V 4.5 no Hugging Face](https://huggingface.co/openbmb/MiniCPM-V-2_6) — Ficha de modelo da OpenBMB, benchmarks de OCR e instruções de fine-tuning.',
          ...
          '[Qwen3-VL no Hugging Face](https://huggingface.co/Qwen/Qwen3-VL-7B-Instruct) — Ficha de modelo Qwen3-VL da Alibaba, detalhes de arquitetura e benchmarks de OCR multilíngue.',
      ...
      relatedReading: {
        ...
        items: [
          '[Modelos de Visão do Ollama (2026)](/pt/power-local-llm/ollama-vision-models-review) — um guia prático e focado para rodar modelos de visão especificamente pelo Ollama: sintaxe real de CLI/API e quais modelos estão de fato em sua biblioteca.',
          '[VLMs em Cameras e Drones 2026](/pt/power-local-llm/vlm-video-analytics-drones-edge) -- Os fundamentos de VLM de desktop estao aqui; para implantacao embarcada em cameras e drones, veja este guia focado em edge.',
       ...
       '@context': 'https://schema.org',
       '@type': 'TechArticle',
       headline: 'Modelos de visão locais 2026: LLaVA, Llama 3.2 Vision, Qwen3-VL e configuração multimodal com Ollama',
       description: 'Perguntas sobre imagens, OCR e análise de capturas de tela offline em 2026. Benchmark: LLaVA 1.6, Llama 3.2 Vision, Qwen3-VL, MiniCPM-V. Guia de VRAM e passos de configuração com Ollama.',
       url: 'https://www.promptquorum.com/pt/power-local-llm/local-vision-models-llava-ollama-2026',
       inLanguage: 'pt-BR',
       datePublished: '2026-05-24',
       dateModified: '2026-05-24',
       author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
  ...
  ar: {
    ...
    next_refresh_due: '2026-12-19',
    theme: 'Voice, Speech & Multimodal',
    heroImage: '/images/local-vision-models-llava-ollama-2026-overview-hero-ar.webp',
    ...
    metaDescription:
      'LLaVA 1.6 وQwen3-VL وMiniCPM-V مُختبرة محليًا 2026. تحليل صور وOCR واستخراج نصوص بدون اتصال — دليل VRAM وخطوات الإعداد مع Ollama.',
    twitterDescription:
    ...
    leadAnswerBlock:
      '**بالنسبة لأغلب المطورين الذين يمتلكون 6–8 غيغابايت من ذاكرة VRAM، يُعدّ MiniCPM-V 4.5 (8B) أو LLaVA 1.6 7B عبر Ollama نقطة الانطلاق الموصى بها في 2026.** كلاهما يعمل بنحو 6 غيغابايت من VRAM، ويدعم استخراج النصوص من المستندات وأسئلة الصور وتحليل لقطات الشاشة، وكلاهما متاح بأمر سحب واحد في Ollama. للحصول على أفضل جودة إجمالية مع 8–16 غيغابايت من VRAM، يُعدّ Llama 3.2 Vision 11B أفضل نموذج رؤية محلي وأقوى نموذج VLM محلي — لا سيما لتحليل المستندات والصور. مع توفر 2 غيغابايت فقط من VRAM، يبقى Moondream 2 (1.9B) الخيار العملي الوحيد، غير أن قدرته على فهم المشاهد المعقدة محدودة. جميع النماذج تعمل بصورة كاملة دون اتصال بعد تنزيلها؛ لا تحتاج إلى مفتاح API أو حساب سحابي.',
    quickAnswerTop: {
      ar: {
        question: 'ما أفضل نماذج الرؤية المحلية للتشغيل مع Ollama في 2026؟',
        answer:
          'يتوقف أفضل نموذج رؤية محلي على حجم ذاكرة VRAM لديك وحالة الاستخدام. مع 6–8 غيغابايت من VRAM، يُقدّم MiniCPM-V 4.5 أفضل توازن بين دقة استخراج النصوص (OCR) وفهم الصور العام. مع 8–16 غيغابايت من VRAM، يُعدّ Llama 3.2 Vision 11B الخيار الأول للأسئلة البصرية العامة وتحليل المستندات. مع 2 غيغابايت فقط من VRAM، لا يوجد سوى Moondream 2 — سريع لكن محدود القدرة. InternVL 2.5 هو الأفضل لتحليل لقطات واجهة المستخدم والرسوم البيانية، غير أن تكامله مع Ollama أقل من غيره.',
        bullets: [
          ...
          '6 غيغابايت VRAM → MiniCPM-V 4.5 أو LLaVA 1.6 7B أو Qwen3-VL 8B (الأفضل لاستخراج النصوص متعدد اللغات): أفضل توازن بين الجودة والمتطلبات.',
          '8–16 غيغابايت VRAM → Llama 3.2 Vision 11B: أفضل نموذج VLM محلي للصور والمستندات العامة.',
          '64 غيغابايت أو أكثر (أو Apple M-series) → Llama 3.2 Vision 90B أو Qwen3-VL 72B: أفضل جودة محلية تقترب من مستوى السحابة.',
          'الإعداد: `ollama pull llama3.2-vision` ثم `ollama run llama3.2-vision "صف هذه الصورة" --image photo.jpg`.',
          'الأفضل لاستخراج النصوص: Qwen3-VL 8B ≈ MiniCPM-V 4.5 > Llama 3.2 Vision 11B > LLaVA 1.6 — قوي في استخراج النصوص من المستندات.',
    ...
    toc: [
      ...
      { label: 'Qwen3-VL — أفضل أداء لاستخراج النصوص متعددة اللغات', anchor: '#qwen2vl-deep-dive' },
    ...
    sections: {
      ...
      modelComparison: {
        ...
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: 'لذاكرة VRAM بين 6–8 غيغابايت: MiniCPM-V 4.5 لاستخراج النصوص من المستندات، وLlama 3.2 Vision 11B للأسئلة العامة على الصور — كلاهما يعمل محلياً عبر Ollama.',
          },
          {
            type: 'plain-terms',
      ...
      invoiceAccuracyTest: {
        ...
        rows: [
          ...
          { 'النموذج': 'MiniCPM-V 4.5', 'المورد': '✓', 'التاريخ': '✓', 'المجموع': '✓', 'الضريبة': '✓', 'البنود': '✓', 'النتيجة': '5/5' },
          { 'النموذج': 'Qwen3-VL 8B', 'المورد': '✓', 'التاريخ': '✓', 'المجموع': '✓', 'الضريبة': '✓', 'البنود': '✓', 'النتيجة': '5/5' },
      ...
      multiImageSupport: {
        ...
        columns: ['الميزة', 'Moondream', 'LLaVA 7B', 'MiniCPM-V', 'Qwen3-VL', 'LLaVA 13B', 'Llama 3.2 Vision', 'InternVL'],
        rows: [
          {
...
print("\\n".join(f"[{i+1}s] {d}" for i, d in enumerate(descriptions)))`,
      ...
      localVsGpt4o: {
        ...
        callouts: [
          {
            type: 'note',
            text: 'لمعالجة الفواتير والنماذج في بيئة الإنتاج مع مدخلات نظيفة، يمكن لنماذج VLM المحلية (Llama 3.2 Vision 11B وQwen3-VL 8B) أن تحل محل GPT-5.5 Vision بتكلفة صفرية. لكل ما يتضمن خطاً يدوياً أو تحليل مشاهد معقدة أو محتوى غامض، لا يزال GPT-5.5 هو الأفضل.',
          },
        ],
      },
      llavaDeepDive: {
        ...
        items: [
          ...
          '**مراجعة كاملة:** [مراجعة LLaVA (2026)](/ar/power-local-llm/llava-review) — مراجعة PromptQuorum المخصصة، بما في ذلك الفارق الدقيق بين رخصة Apache-2.0 والنموذج الأساسي وأوامر Ollama الحقيقية.',
        ],
      },
      qwen2VlDeepDive: {
        id: 'qwen2vl-deep-dive',
        title: 'Qwen3-VL — أفضل أداء لاستخراج النصوص متعددة اللغات',
        content:
        ...
        items: [
          ...
          '**التثبيت على Ollama:** `ollama pull qwen3-vl:7b` — متاح مباشرةً من مكتبة نماذج Ollama.',
          '**دعم الصور المتعددة:** يقبل حتى 8 صور لكل طلب — أعلى قدرة متعددة الصور من بين جميع النماذج في هذه المقارنة.',
          '**صفحة النموذج:** [Qwen3-VL 8B على Hugging Face](https://huggingface.co/Qwen/Qwen3-VL-7B-Instruct)',
        ],
      },
      howToChoose: {
        id: 'how-to-choose',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'يدعم LLaVA 1.6 حتى 672×672 دقة فعّالة (مع التصحيح الديناميكي). يدعم MiniCPM-V 4.5 حتى 1792×1792 — وهذا أحد أسباب تفوقه على LLaVA في المسوحات الضوئية عالية الدقة. يدعم Llama 3.2 Vision دقة متغيرة حتى 1120×1120. لأفضل نتائج استخراج النصوص، أرسل صور المستندات بدقة 150 نقطة لكل بوصة أو أعلى.',
          },
          {
          ...
          },
          {
            ...
            a: 'Llama 3.2 Vision 11B (الضغط الكمي Q4 يتسع في ~8 غيغابايت) للاستخدام العام. Qwen3-VL 8B إذا كان استخراج النصوص متعدد اللغات هو الحاجة الرئيسية. كلاهما متاح عبر Ollama بأمر pull واحد.',
          },
          {
            q: 'LLaVA مقابل MiniCPM-V — أيهما أفضل لاستخراج النصوص؟',
            a: 'MiniCPM-V 4.5 أكثر دقة في استخراج نصوص المستندات، خاصةً الجداول الكثيفة والمسوحات الضوئية عالية الدقة. LLaVA 1.6 أفضل توثيقاً ولديه دعم مجتمعي أوسع. لدقة استخراج النصوص اختر MiniCPM-V. لموارد المجتمع واستكشاف الأخطاء اختر LLaVA.',
          },
          {
            q: 'هل تستطيع نماذج الرؤية المحلية قراءة الخط اليدوي؟',
            a: 'الخط اليدوي المطبوع (الحروف المنفصلة): نعم، بدقة معتدلة على Llama 3.2 Vision 11B وMiniCPM-V 4.5. الخط المتصل (الكرسيف): غير موثوق على جميع النماذج المحلية. GPT-5.5 Vision أفضل بكثير في الخط المتصل. لاستخراج النصوص اليدوية المتصلة في بيئة الإنتاج، لا تزال الواجهات البرمجية السحابية هي الأنسب.',
          },
        ],
      },
      sources: {
        ...
        items: [
          ...
          '[MiniCPM-V 4.5 على Hugging Face](https://huggingface.co/openbmb/MiniCPM-V-2_6) — بطاقة نموذج OpenBMB، ومعايير استخراج النصوص، وتعليمات الضبط الدقيق.',
          ...
          '[Qwen3-VL على Hugging Face](https://huggingface.co/Qwen/Qwen3-VL-7B-Instruct) — بطاقة نموذج Qwen3-VL من Alibaba، وتفاصيل البنية، ومعايير استخراج النصوص متعددة اللغات.',
      ...
      relatedReading: {
        ...
        items: [
          '[نماذج رؤية Ollama (2026)](/ar/power-local-llm/ollama-vision-models-review) — دليل عملي ومركّز لتشغيل نماذج الرؤية تحديدًا عبر Ollama: صيغة CLI/API فعلية والنماذج الموجودة فعليًا في مكتبته.',
          '[نماذج الرؤية اللغوية في الكاميرات والطائرات المسيرة 2026](/ar/power-local-llm/vlm-video-analytics-drones-edge) -- أساسيات VLM لسطح المكتب موجودة هنا؛ للنشر المدمج في الكاميرات والطائرات المسيرة، راجع هذا الدليل المخصص للحوسبة الطرفية.',
  ...
  ko: {
    ...
    next_refresh_due: '2026-12-19',
    theme: 'Voice, Speech & Multimodal',
    heroImage: '/images/local-vision-models-llava-ollama-2026-overview-hero-ko.webp',
    title: '로컬 비전 모델 2026: LLaVA, Llama 3.2 Vision, Qwen3-VL 및 Ollama 멀티모달 설정 가이드',
    seoTitle: '최고의 로컬 비전 모델 2026: LLaVA와 Qwen3-VL',
    intro:
      '비전-언어 모델(VLM)은 이미지와 텍스트를 입력으로 받아 텍스트를 출력합니다. 문서 OCR, 이미지 질의응답, 스크린샷 분석, 차트 읽기 등 모든 작업을 로컬에서 처리할 수 있습니다. 2026년 현재 VLM을 실행하는 가장 간편한 방법은 Ollama를 사용하는 것입니다. 모델을 다운로드하고 이미지를 전송하면 설명이나 답변을 받을 수 있습니다. 이 가이드는 주요 로컬 비전 모델(LLaVA 1.6, Llama 3.2 Vision, MiniCPM-V 4.5, Moondream 2, Qwen3-VL, InternVL 2.5)을 비교하고, Ollama 설정 단계를 설명하며, VRAM 요구 사항과 품질 벤치마크에 따라 각 모델의 최적 활용 사례를 안내합니다.',
    metaDescription:
      '2026년 오프라인 이미지 질의응답, OCR, 스크린샷 분석 가이드. 벤치마크: LLaVA 1.6, Llama 3.2 Vision, Qwen3-VL, MiniCPM-V. Ollama VRAM 및 설정 방법.',
    twitterDescription:
    ...
    leadAnswerBlock:
      '**VRAM 6~8 GB를 보유한 대부분의 개발자에게는 MiniCPM-V 4.5 (8B) 또는 LLaVA 1.6 7B via Ollama가 2026년 추천 시작점입니다.** 두 모델 모두 약 6 GB VRAM에서 동작하며, 문서 OCR, 이미지 질의응답, 스크린샷 분석을 지원하고 단일 Ollama 명령어로 실행할 수 있습니다. 8~16 GB VRAM에서 전반적인 최고 품질을 원한다면 Llama 3.2 Vision 11B가 최선의 선택이며, 특히 문서와 사진 처리에 강합니다. VRAM이 2 GB밖에 없다면 Moondream 2 (1.9B)가 유일한 실용적 옵션이지만, 복잡한 장면 처리에는 한계가 있습니다. 모든 모델은 다운로드 후 100% 오프라인으로 동작하며, API 키나 클라우드 계정이 필요하지 않습니다.',
    quickAnswerTop: {
      ko: {
        question: '2026년 Ollama에서 사용하기에 가장 좋은 로컬 비전 모델은 무엇입니까?',
        answer:
          '최적의 로컬 비전 모델은 VRAM 용량과 사용 목적에 따라 달라집니다. VRAM 6~8 GB의 경우 MiniCPM-V 4.5이 OCR 정확도와 일반적인 이미지 이해 사이에서 최고의 균형을 제공합니다. VRAM 8~16 GB의 경우 Llama 3.2 Vision 11B가 일반적인 시각적 질의응답과 문서 분석에서 최우선 선택입니다. VRAM 2 GB의 경우 Moondream 2가 유일한 대안으로, 빠르지만 처리 능력에 한계가 있습니다. InternVL 2.5는 UI 스크린샷과 차트 분석에 가장 강하지만, 다른 모델들보다 Ollama 통합이 적습니다.',
        bullets: [
          'VRAM 4 GB 미만 → Moondream 2 (1.9B): 빠르지만 복잡한 이미지 이해 제한적. 대안: PaliGemma 2 3B (~3 GB), SmolVLM 2.2B (~2 GB).',
          'VRAM 6 GB → MiniCPM-V 4.5, LLaVA 1.6 7B 또는 Qwen3-VL 8B (다국어 OCR에 최적): 품질과 하드웨어 균형이 최고.',
          'VRAM 8~16 GB → Llama 3.2 Vision 11B: 사진과 문서 처리에서 최고의 로컬 VLM.',
          'VRAM 64+ GB (또는 Apple M-series) → Llama 3.2 Vision 90B 또는 Qwen3-VL 72B: 클라우드 수준에 가까운 최고 로컬 품질.',
          '설정: `ollama pull llama3.2-vision` 후 `ollama run llama3.2-vision "이 이미지를 설명해 주세요" --image 사진.jpg`.',
          'OCR 최고: Qwen3-VL 8B ≈ MiniCPM-V 4.5 > Llama 3.2 Vision 11B > LLaVA 1.6 — 문서 텍스트 추출에 강함.',
    ...
    toc: [
      ...
      { label: 'Qwen3-VL — 최고의 다국어 OCR', anchor: '#qwen2vl-deep-dive' },
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**MiniCPM-V 4.5 (8B)는 VRAM 6 GB에서 문서 OCR에 가장 적합한 모델입니다.** 훈련 데이터에 고해상도 문서 스캔이 포함되어 있어 표, 청구서, 빽빽한 텍스트에서 LLaVA보다 더 정확합니다.',
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**OCR 정확도:** Qwen3-VL 8B ≈ MiniCPM-V 4.5 > Llama 3.2 Vision 11B > LLaVA 1.6 13B > LLaVA 1.6 7B > Moondream 2.',
      ...
      modelComparison: {
        ...
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: 'VRAM 6~8 GB의 경우: 문서 OCR에는 MiniCPM-V 4.5, 일반 이미지 질의응답에는 Llama 3.2 Vision 11B — 두 모델 모두 Ollama를 통해 로컬에서 실행 가능합니다.',
          },
          {
            type: 'plain-terms',
      ...
      invoiceAccuracyTest: {
        ...
        rows: [
          ...
          { '모델': 'MiniCPM-V 4.5', '공급업체': '✓', '날짜': '✓', '합계': '✓', '세금': '✓', '항목 수': '✓', '점수': '5/5' },
          { '모델': 'Qwen3-VL 8B', '공급업체': '✓', '날짜': '✓', '합계': '✓', '세금': '✓', '항목 수': '✓', '점수': '5/5' },
      ...
      multiImageSupport: {
        ...
        columns: ['기능', 'Moondream', 'LLaVA 7B', 'MiniCPM-V', 'Qwen3-VL', 'LLaVA 13B', 'Llama 3.2 Vision', 'InternVL'],
        rows: [
          {
            '기능': '다중 이미지 입력',
            'Moondream': '아니오',
        ...
        items: [
          'MiniCPM-V 4.5은 프롬프트당 최대 4개 이미지를, Qwen3-VL은 최대 8개 이미지를 허용합니다. LLaVA와 Moondream은 요청당 이미지 1개만 허용합니다.',
...
print(result)`,
      ...
      useCaseOcr: {
        ...
        items: [
          ...
          '**OCR 최적 모델:** MiniCPM-V 4.5 (6 GB 카테고리에서 최고 OCR 정확도), Llama 3.2 Vision 11B (혼합 문서 유형에 최적).',
      ...
      useCaseScreenshot: {
        ...
        items: [
          ...
          '**최적 모델:** InternVL 2.5 8B (최고 UI 이해), MiniCPM-V 4.5 (두 번째 선택, Ollama 지원).',
        ],
      },
      useCaseChart: {
        id: 'use-case-chart',
...
print("\n".join(f"[{i+1}초] {d}" for i, d in enumerate(descriptions)))`,
      ...
      localVsGpt4o: {
        ...
        callouts: [
          {
            type: 'note',
            text: '깨끗한 입력으로 청구서와 양식을 프로덕션에서 처리하는 경우, 로컬 VLM(Llama 3.2 Vision 11B, Qwen3-VL 8B)은 비용 없이 GPT-5.5 Vision을 대체할 수 있습니다. 손글씨, 복잡한 장면 분석, 모호한 내용이 포함된 모든 것에는 GPT-5.5가 여전히 우수합니다.',
          },
        ],
      },
      llavaDeepDive: {
        ...
        items: [
          ...
          '**약점:** MiniCPM-V 4.5보다 약한 OCR, InternVL 2.5보다 약한 UI 분석, 품질 벤치마크에서 Llama 3.2 Vision 11B에 전반적으로 뒤처짐.',
          '**여전히 권장되는 이유:** LLaVA 1.6은 모든 로컬 VLM 중에서 가장 큰 커뮤니티, 가장 많은 튜토리얼, 가장 많은 프롬프트 예제를 보유하고 있습니다. 문제가 있을 경우 도움을 찾기가 더 쉽습니다.',
          '**전체 리뷰:** [LLaVA 리뷰(2026)](/ko/power-local-llm/llava-review) — Apache-2.0과 기본 모델 라이선스의 미묘한 차이, 실제 Ollama 명령어를 다루는 PromptQuorum의 전용 리뷰.',
        ],
      },
      qwen2VlDeepDive: {
        id: 'qwen2vl-deep-dive',
        title: 'Qwen3-VL — 최고의 다국어 OCR 및 문서 성능',
        content:
          '**Qwen3-VL은 Alibaba의 비전-언어 모델로 2026년 문서 벤치마크에서 가장 강력한 오픈소스 옵션입니다.** 7B 변형은 더 적은 VRAM으로 Llama 3.2 Vision 11B와 경쟁하며, 72B 변형은 대부분의 오픈소스 VLM 순위에서 선두를 차지합니다.',
        items: [
          ...
          '**Ollama 설치:** `ollama pull qwen3-vl:7b` — Ollama 모델 라이브러리에서 직접 사용 가능.',
          '**다중 이미지 지원:** 요청당 최대 8개 이미지 허용 — 이 비교의 모든 모델 중 가장 높은 다중 이미지 용량.',
          '**모델 페이지:** [Qwen3-VL 8B on Hugging Face](https://huggingface.co/Qwen/Qwen3-VL-7B-Instruct)',
        ],
      },
      howToChoose: {
        id: 'how-to-choose',
        ...
        items: [
          ...
          '**VRAM 6 GB:** 문서 OCR 및 청구서 처리에는 MiniCPM-V 4.5. 커뮤니티 지원이 중요한 일반 사진 질의응답에는 LLaVA 1.6 7B. 다국어 OCR 또는 가능한 가장 높은 OCR 정확도가 필요할 때는 Qwen3-VL 8B.',
          ...
          '**통합 메모리 64+ GB (Apple M-Max/Ultra, 멀티 GPU):** 사용 가능한 최고 로컬 VLM 품질을 위해 Llama 3.2 Vision 90B — 문서 작업에서 클라우드 수준 성능에 근접. Qwen3-VL 72B는 최고의 오픈소스 벤치마크 점수를 보유한 대안.',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'LLaVA 1.6은 최대 672×672의 실효 해상도를 지원합니다(동적 패치 포함). MiniCPM-V 4.5은 최대 1792×1792를 지원합니다 — 고DPI 문서 스캔에서 LLaVA를 능가하는 이유 중 하나입니다. Llama 3.2 Vision은 최대 1120×1120의 가변 해상도를 지원합니다. 최상의 OCR 결과를 위해 문서 이미지를 150+ DPI로 전송하십시오.',
          },
          {
          ...
          },
          {
            ...
            a: '범용 사용에는 Llama 3.2 Vision 11B (Q4 양자화가 ~8 GB에 맞음). 다국어 OCR이 주요 요구 사항이라면 Qwen3-VL 8B. 두 모델 모두 단일 pull 명령어로 Ollama에서 사용 가능합니다.',
          },
          {
            q: 'LLaVA vs MiniCPM-V — OCR에는 어느 것이 더 낫습니까?',
            a: 'MiniCPM-V 4.5은 문서 OCR, 특히 빽빽한 표와 고DPI 스캔에서 더 정확합니다. LLaVA 1.6은 더 잘 문서화되어 있고 더 많은 커뮤니티 지원이 있습니다. 순수한 OCR 정확도를 위해서는 MiniCPM-V를 선택하십시오. 커뮤니티 자료와 문제 해결을 위해서는 LLaVA를 선택하십시오.',
          },
          {
            q: '로컬 비전 모델이 손글씨를 읽을 수 있습니까?',
            a: '인쇄체 손글씨(블록 문자): 예, Llama 3.2 Vision 11B와 MiniCPM-V 4.5에서 중간 수준의 정확도로 읽을 수 있습니다. 필기체: 모든 로컬 모델에서 신뢰할 수 없습니다. GPT-5.5 Vision은 필기체 처리가 크게 우수합니다. 프로덕션에서 필기체 OCR은 클라우드 API를 여전히 권장합니다.',
          },
        ],
      },
      sources: {
        ...
        items: [
          ...
          '[MiniCPM-V 4.5 on Hugging Face](https://huggingface.co/openbmb/MiniCPM-V-2_6) — OpenBMB 모델 카드, OCR 벤치마크, 파인튜닝 지침.',
          ...
          '[Qwen3-VL on Hugging Face](https://huggingface.co/Qwen/Qwen3-VL-7B-Instruct) — Alibaba Qwen3-VL 모델 카드, 아키텍처 세부 사항, 다국어 OCR 벤치마크.',
      ...
      relatedReading: {
        ...
        title: '관련 자료',
        items: [
          '[Ollama 비전 모델(2026)](/ko/power-local-llm/ollama-vision-models-review) — Ollama로 비전 모델을 실행하는 실용적이고 집중적인 가이드: 실제 CLI/API 문법과 라이브러리에 실제로 있는 모델.',
          '[카메라와 드론의 VLM 2026](/ko/power-local-llm/vlm-video-analytics-drones-edge) -- 데스크톱 VLM 기초는 여기에서 다룹니다. 임베디드 카메라·드론 배포는 이 엣지 전용 가이드를 참고하세요.',
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      headline: '로컬 비전 모델 2026: LLaVA, Llama 3.2 Vision, Qwen3-VL 및 Ollama 멀티모달 설정 가이드',
      description: '2026년 오프라인 이미지 질의응답, OCR, 스크린샷 분석. 벤치마크: LLaVA 1.6, Llama 3.2 Vision, Qwen3-VL, MiniCPM-V. Ollama VRAM 및 설정 가이드.',
    ...
    breadcrumbSchema: {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: '로컬 비전 모델 2026', item: '[www.promptquorum.com/ko/power-local-llm/local-vision-models-llava-ollama-2026](https://www.promptquorum.com/ko/power-local-llm/local-vision-models-llava-ollama-2026)' },
      ],
    },
  },
}
