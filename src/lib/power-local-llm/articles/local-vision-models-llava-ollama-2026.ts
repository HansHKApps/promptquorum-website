...
print("\\n".join(f"[{i+1}s] {d}" for i, d in enumerate(descriptions)))`,
      ...
      relatedReading: {
       ...
       url: 'https://www.promptquorum.com/es/es/power-local-llm/local-vision-models-llava-ollama-2026',
       inLanguage: 'es',
...
print("\\n".join(f"[{i+1}s] {d}" for i, d in enumerate(descriptions)))`,
  ...
  ar: {
    ...
    seoTitle: 'أفضل نماذج الرؤية المحلية 2026: LLaVA وQwen2-VL وOllama',
    intro:
    ...
    metaDescription:
      'أسئلة وأجوبة حول الصور واستخراج النصوص وتحليل لقطات الشاشة دون اتصال في 2026. معايير الأداء: LLaVA 1.6 وLlama 3.2 Vision وQwen2-VL وMiniCPM-V. دليل VRAM وخطوات الإعداد مع Ollama.',
    twitterDescription:
