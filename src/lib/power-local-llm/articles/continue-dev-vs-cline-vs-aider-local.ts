...
export const article: Partial<Record<Language, LLMArticle>> = {
    ...
    sections: {
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**La fiabilidad de las llamadas a herramientas es una propiedad del modelo, no de la herramienta.** Qwen3-Coder 30B y DeepSeek Coder V3 son fiables en las tres; los modelos de clase 7B fallan en las tres.',
      ...
      clineDeep: {
        ...
        items: [
          ...
          '**Configuración de modelo local:** cualquier endpoint compatible con OpenAI. Ollama es un clic. Para llama.cpp o vLLM, apunta Cline a la URL del servidor compatible con OpenAI. El bucle de agente consume muchos tokens — reserva un modelo con al menos una ventana de contexto de 32K (Qwen3-Coder 30B en 32K, DeepSeek Coder V3 en 128K).',
      ...
      editModel: {
        ...
        imageCaption: 'Fiabilidad del modelo de edición por herramienta: en modelos 7B, Continue.dev es el más tolerante, Aider rechaza bloques que no coinciden, Cline se detiene con XML mal formado; en modelos 30B+ de código (Qwen3-Coder, DeepSeek Coder V3), los tres son fiables.',
        items: [
          ...
          '**Ranking de fiabilidad en un modelo de llamadas a herramientas 30B+ (Qwen3-Coder 30B, DeepSeek Coder V3):** los tres convergen — el modelo tiene la capacidad de emitir bloques de diff precisos y llamadas a herramientas bien formadas de manera consistente.',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'A **confiabilidade das chamadas de ferramentas** depende do modelo, não da ferramenta. Qwen3-Coder 30B e DeepSeek Coder V3 são os chamadores de ferramentas mais confiáveis em maio de 2026; modelos menores (classe 7B) emitem regularmente chamadas de ferramentas malformadas independentemente de qual ferramenta os envolva.',
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**A confiabilidade das chamadas de ferramentas é uma propriedade do modelo, não da ferramenta.** Qwen3-Coder 30B e DeepSeek Coder V3 são confiáveis nos três; modelos de classe 7B falham nos três.',
      ...
      editModel: {
        ...
        image: '/images/coding-agent-edit-model-en.svg',
        imageCaption: 'Confiabilidade do modelo de edição por ferramenta: em modelos 7B, o Continue.dev é o mais tolerante, o Aider rejeita blocos que não coincidem, o Cline para com XML malformado; em modelos 30B+ de código (Qwen3-Coder, DeepSeek Coder V3), os três são confiáveis.',
        items: [
          ...
          '**Ranking de confiabilidade em um modelo de chamadas de ferramentas 30B+ (Qwen3-Coder 30B, DeepSeek Coder V3):** os três convergem — o modelo tem a capacidade de emitir blocos de diff precisos e chamadas de ferramentas bem formadas de maneira consistente.',
      ...
      url: 'https://www.promptquorum.com/pt/pt/power-local-llm/continue-dev-vs-cline-vs-aider-local',
      inLanguage: 'pt-BR',
      datePublished: '2026-05-24',
      dateModified: '2026-05-24',
      author: { '@type': 'Person', name: 'Hans Kuepper' },
  ...
  ar: {
    ...
    seoTitle: 'Continue.dev مقابل Cline مقابل Aider: حكم وكيل البرمجة المحلي 2026',
    intro:
    ...
    metaDescription:
      'مقارنة بين Continue.dev وCline وAider كوكلاء برمجة محلية في 2026: نموذج التحرير، والتكامل مع بيئة التطوير، والتراجع، واستراتيجية السياق.',
    twitterDescription:
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**موثوقية استدعاءات الأدوات** تعتمد على النموذج لا على الأداة. Qwen3-Coder 30B وDeepSeek Coder V3 هما الأكثر موثوقية في استدعاءات الأدوات في مايو 2026؛ أما النماذج الأصغر (فئة 7B) فتُصدر باستمرار استدعاءات أدوات مشوّهة بغض النظر عن الأداة المستخدمة.',
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**موثوقية استدعاءات الأدوات خاصية النموذج لا الأداة.** Qwen3-Coder 30B وDeepSeek Coder V3 موثوقان في الأدوات الثلاث؛ ونماذج فئة 7B تفشل في الثلاثة.',
      ...
      continueDevDeep: {
        ...
        items: [
          ...
          '**إعداد النموذج المحلي:** دعم Ollama الأصيل عبر كتلة إعداد. وتعمل llama.cpp وLM Studio وأي نقطة نهاية متوافقة مع OpenAI أيضاً. النمط المعتاد هو تشغيل نماذج منفصلة للإكمال التلقائي (صغير وسريع — فئة Qwen3-Coder 1.5B) والدردشة (أكبر — Qwen3-Coder 30B وDeepSeek Coder V3).',
      ...
      clineDeep: {
        ...
        items: [
          ...
          '**إعداد النموذج المحلي:** أي نقطة نهاية متوافقة مع OpenAI. Ollama بنقرة واحدة. لـllama.cpp أو vLLM، وجّه Cline إلى URL الخادم المتوافق مع OpenAI. تستهلك حلقة الوكيل توكن كثيرة — احتفظ بنموذج بنافذة سياق لا تقل عن 32K (Qwen3-Coder 30B بـ32K، وDeepSeek Coder V3 بـ128K).',
      ...
      editModel: {
        ...
        image: '/images/coding-agent-edit-model-es.svg',
        imageCaption: 'موثوقية نموذج التحرير حسب الأداة: في نماذج 7B، Continue.dev الأكثر تسامحاً، Aider يرفض الكتل غير المتطابقة، Cline يتوقف عند XML مشوّه؛ في نماذج البرمجة 30B+ (Qwen3-Coder وDeepSeek Coder V3)، الأدوات الثلاث موثوقة.',
        items: [
          ...
          '**ترتيب الموثوقية في نموذج استدعاء الأدوات 30B+ (Qwen3-Coder 30B وDeepSeek Coder V3):** تتقارب الأدوات الثلاث — النموذج قادر على إصدار كتل فوارق دقيقة واستدعاءات أدوات مُشكَّلة جيداً باستمرار.',
