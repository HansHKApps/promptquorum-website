...
export const article: Partial<Record<Language, LLMArticle>> = {
  ...
  es: {
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/es/es/power-local-llm/voice-assistant-local-mobile-offline',
      image: {
        '@type': 'ImageObject',
        url: 'https://www.promptquorum.com/og-image.png',
        width: 1200,
  ...
  pt: {
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/pt/pt/power-local-llm/voice-assistant-local-mobile-offline',
      image: {
        '@type': 'ImageObject',
        url: 'https://www.promptquorum.com/og-image.png',
        width: 1200,
  ...
  ar: {
    ...
    seoTitle: 'مساعد صوتي محلي Whisper LLM هاتف 2026',
    intro:
    ...
    metaDescription:
      'ذكاء اصطناعي صوتي محلي بالكامل على iPhone و Android في 2026: Whisper STT + LLM محلي + Piper TTS. إعداد iPhone وAndroid وهجين. الكمون والبطارية.',
    twitterDescription:
