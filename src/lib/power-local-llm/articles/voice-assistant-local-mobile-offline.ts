    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/directory) — directory entries for Whisper.cpp, WhisperKit, Piper TTS, and other voice-stack components.',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Local LLM Software Directory 2026](/de/directory) — Verzeichniseinträge für Whisper.cpp, WhisperKit, Piper TTS und andere Voice-Stack-Komponenten.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Répertoire logiciel LLM local 2026](/fr/directory) — entrées répertoire pour Whisper.cpp, WhisperKit, Piper TTS et autres composants de pile vocale.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[ローカルLLMソフトウェアディレクトリ2026](/ja/directory) —Whisper.cpp、WhisperKit、Piper TTS、およびその他の音声スタックコンポーネントのディレクトリエントリ。',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[本地LLM软件目录2026年](/zh/directory) —Whisper.cpp、WhisperKit、Piper TTS和其他语音堆栈组件的目录条目。',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Directorio de software LLM local 2026](/es/directory) — entradas del directorio para Whisper.cpp, WhisperKit, Piper TTS y otros componentes del stack de voz.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[2026년 로컬 LLM 소프트웨어 디렉토리](/ko/directory) — Whisper.cpp, WhisperKit, Piper TTS 및 기타 음성 스택 구성 요소의 디렉토리 항목.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Diretório de software LLM local 2026](/pt/directory) — entradas do diretório para Whisper.cpp, WhisperKit, Piper TTS e outros componentes do stack de voz.',
        ],
      },
    },
    schema: {
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[دليل برامج LLM المحلية 2026](/ar/directory) — إدخالات الدليل لـ Whisper.cpp وWhisperKit وPiper TTS ومكونات حزمة الصوت الأخرى.',
        ],
      },
    },
    schema: {
