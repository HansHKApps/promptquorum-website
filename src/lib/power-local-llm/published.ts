...
export const POWER_LLM_PUBLISHED_SLUGS: ReadonlySet<string> = new Set([
  ...
  'letta-review',
  // Agent frameworks series — Leon AI review (article 8 of 14) — 2026-09-11
  'leon-ai-review',
  ...
  // Category comparison guide for train-operate (all 9 locales) — generated table, see apps/compare-schema.ts
  ...
  // Off Grid AI review (Mobile & Edge LLMs) — 2026-09-12
  'off-grid-ai-review',
