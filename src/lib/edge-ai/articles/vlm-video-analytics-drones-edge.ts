  ...
  en: {
    ...
    sections: {
      ...
      'platform-comparison': {
        ...
        content: [
          'Cross-reference the [edge silicon guide](/edge-ai/edge-ai-hardware-for-local-llms) for full Jetson Orin and Jetson Thor specifications — this table stays scoped to the camera- and drone-specific platforms most relevant to video analytics.',
        ],
      ...
      'related-reading': {
        ...
        items: [
          '[Edge AI Hardware for Local LLMs](/edge-ai/edge-ai-hardware-for-local-llms) — full specifications for the Jetson Orin and Jetson Thor platforms referenced in the comparison table above',
          '[VLA Models for Robots: Local Inference](/edge-ai/vla-models-robots-local-inference) — the sibling article on the same silicon constraint applied to robot action models instead of video understanding',
          '[Edge AI hub](/edge-ai) — the full cluster covering edge silicon, on-robot inference, and in-camera video analytics',
    ...
    schema: {
      ...
      inLanguage: 'en',
      url: 'https://www.promptquorum.com/edge-ai/vlm-video-analytics-drones-edge',
      ...
      mainEntityOfPage: {
        '@type': 'WebPage',
        '@id': 'https://www.promptquorum.com/edge-ai/vlm-video-analytics-drones-edge',
      },
    },
  },
  de: {
    ...
    sections: {
      ...
      'platform-comparison': {
        ...
        content: [
          'Für vollständige Spezifikationen zu Jetson Orin und Jetson Thor siehe den [Edge-Silizium-Leitfaden](/de/edge-ai/edge-ai-hardware-for-local-llms) — diese Tabelle bleibt auf die kamera- und drohnenspezifischen Plattformen fokussiert, die für Videoanalyse am relevantesten sind.',
        ],
      ...
      'related-reading': {
        ...
        items: [
          '[Edge-AI-Hardware für lokale LLMs](/de/edge-ai/edge-ai-hardware-for-local-llms) — vollständige Spezifikationen zu den in der Vergleichstabelle oben referenzierten Jetson-Orin- und Jetson-Thor-Plattformen',
          '[VLA-Modelle für Roboter: Lokale Inferenz](/de/edge-ai/vla-models-robots-local-inference) — der Schwesterartikel zur selben Silizium-Einschränkung, angewendet auf Roboter-Aktionsmodelle statt auf Videoverständnis',
          '[Edge-AI-Hub](/de/edge-ai) — der vollständige Themenbereich zu Edge-Silizium, Roboter-Inferenz und In-Kamera-Videoanalyse',
    ...
    schema: {
      ...
      inLanguage: 'de',
      url: 'https://www.promptquorum.com/de/edge-ai/vlm-video-analytics-drones-edge',
      ...
      mainEntityOfPage: {
        '@type': 'WebPage',
        '@id': 'https://www.promptquorum.com/de/edge-ai/vlm-video-analytics-drones-edge',
      },
    },
  },
  fr: {
    ...
    sections: {
      ...
      'platform-comparison': {
        ...
        content: [
          "Pour les spécifications complètes de Jetson Orin et Jetson Thor, consultez le [guide du silicium embarqué](/fr/edge-ai/edge-ai-hardware-for-local-llms) — ce tableau reste centré sur les plateformes spécifiques aux caméras et aux drones les plus pertinentes pour l'analyse vidéo.",
        ],
      ...
      'related-reading': {
        ...
        items: [
          "[Matériel Edge AI pour LLM locaux](/fr/edge-ai/edge-ai-hardware-for-local-llms) — spécifications complètes des plateformes Jetson Orin et Jetson Thor référencées dans le tableau comparatif ci-dessus",
          "[Modèles VLA pour robots : inférence locale](/fr/edge-ai/vla-models-robots-local-inference) — l'article jumeau sur la même contrainte silicium appliquée aux modèles d'action robotique plutôt qu'à la compréhension vidéo",
          "[Hub Edge AI](/fr/edge-ai) — l'ensemble du pôle couvrant le silicium embarqué, l'inférence sur robot et l'analyse vidéo en caméra",
    ...
    schema: {
      ...
      inLanguage: 'fr',
      url: 'https://www.promptquorum.com/fr/edge-ai/vlm-video-analytics-drones-edge',
      ...
      mainEntityOfPage: {
        '@type': 'WebPage',
        '@id': 'https://www.promptquorum.com/fr/edge-ai/vlm-video-analytics-drones-edge',
      },
    },
  },
  es: {
    ...
    sections: {
      ...
      'platform-comparison': {
        ...
        content: [
          'Consulte la [guía de silicio de borde](/es/edge-ai/edge-ai-hardware-for-local-llms) para las especificaciones completas de Jetson Orin y Jetson Thor — esta tabla se centra en las plataformas específicas de cámaras y drones más relevantes para el análisis de vídeo.',
        ],
      ...
      'related-reading': {
        ...
        items: [
          '[Hardware Edge AI para LLM locales](/es/edge-ai/edge-ai-hardware-for-local-llms) — especificaciones completas de las plataformas Jetson Orin y Jetson Thor referenciadas en la tabla comparativa de arriba',
          '[Modelos VLA para robots: inferencia local](/es/edge-ai/vla-models-robots-local-inference) — el artículo hermano sobre la misma restricción de silicio aplicada a modelos de acción robótica en lugar de comprensión de vídeo',
          '[Hub de Edge AI](/es/edge-ai) — el clúster completo que cubre silicio de borde, inferencia en robots y análisis de vídeo en cámara',
    ...
    schema: {
      ...
      inLanguage: 'es',
      url: 'https://www.promptquorum.com/es/edge-ai/vlm-video-analytics-drones-edge',
      ...
      mainEntityOfPage: {
        '@type': 'WebPage',
        '@id': 'https://www.promptquorum.com/es/edge-ai/vlm-video-analytics-drones-edge',
      },
    },
  },
  pt: {
    ...
    sections: {
      ...
      'platform-comparison': {
        ...
        content: [
          'Consulte o [guia de silício de borda](/pt/edge-ai/edge-ai-hardware-for-local-llms) para as especificações completas de Jetson Orin e Jetson Thor — esta tabela permanece focada nas plataformas específicas de câmeras e drones mais relevantes para análise de vídeo.',
        ],
      ...
      'related-reading': {
        ...
        items: [
          '[Hardware Edge AI para LLMs locais](/pt/edge-ai/edge-ai-hardware-for-local-llms) — especificações completas das plataformas Jetson Orin e Jetson Thor referenciadas na tabela comparativa acima',
          '[Modelos VLA para robôs: inferência local](/pt/edge-ai/vla-models-robots-local-inference) — o artigo irmão sobre a mesma restrição de silício aplicada a modelos de ação robótica em vez de entendimento de vídeo',
          '[Hub de Edge AI](/pt/edge-ai) — o cluster completo cobrindo silício de borda, inferência em robôs e análise de vídeo em câmera',
    ...
    schema: {
      ...
      inLanguage: 'pt-BR',
      url: 'https://www.promptquorum.com/pt/edge-ai/vlm-video-analytics-drones-edge',
      ...
      mainEntityOfPage: {
        '@type': 'WebPage',
        '@id': 'https://www.promptquorum.com/pt/edge-ai/vlm-video-analytics-drones-edge',
      },
    },
  },
  ja: {
    ...
    sections: {
      ...
      'platform-comparison': {
        ...
        content: [
          'Jetson OrinとJetson Thorの完全な仕様については[エッジシリコンガイド](/ja/edge-ai/edge-ai-hardware-for-local-llms)を参照してください——この表は映像解析に最も関連するカメラ・ドローン特化型プラットフォームに絞っています。',
        ],
      ...
      'related-reading': {
        ...
        items: [
          '[ローカルLLM向けエッジAIハードウェア](/ja/edge-ai/edge-ai-hardware-for-local-llms) — 上記の比較表で参照したJetson OrinおよびJetson Thorプラットフォームの完全な仕様',
          '[ロボット向けVLAモデル：ローカル推論](/ja/edge-ai/vla-models-robots-local-inference) — 映像理解ではなくロボットの行動モデルに適用された、同じシリコン制約に関する姉妹記事',
          '[エッジAIハブ](/ja/edge-ai) — エッジシリコン、ロボット搭載推論、カメラ内蔵映像解析を網羅する完全なクラスター',
    ...
    schema: {
      ...
      inLanguage: 'ja',
      url: 'https://www.promptquorum.com/ja/edge-ai/vlm-video-analytics-drones-edge',
      ...
      mainEntityOfPage: {
        '@type': 'WebPage',
        '@id': 'https://www.promptquorum.com/ja/edge-ai/vlm-video-analytics-drones-edge',
      },
    },
  },
  zh: {
    ...
    sections: {
      ...
      'platform-comparison': {
        ...
        content: [
          '关于Jetson Orin和Jetson Thor的完整规格，请参阅[边缘芯片指南](/zh/edge-ai/edge-ai-hardware-for-local-llms)——本表只聚焦于与视频分析最相关的摄像头和无人机专用平台。',
        ],
      ...
      'related-reading': {
        ...
        items: [
          '[面向本地LLM的边缘AI硬件](/zh/edge-ai/edge-ai-hardware-for-local-llms) — 上方对比表中引用的Jetson Orin和Jetson Thor平台的完整规格',
          '[面向机器人的VLA模型：本地推理](/zh/edge-ai/vla-models-robots-local-inference) — 同样芯片约束应用于机器人动作模型而非视频理解的姊妹文章',
          '[边缘AI中心](/zh/edge-ai) — 涵盖边缘芯片、机器人机载推理和摄像头内置视频分析的完整专题',
    ...
    schema: {
      ...
      inLanguage: 'zh',
      url: 'https://www.promptquorum.com/zh/edge-ai/vlm-video-analytics-drones-edge',
      ...
      mainEntityOfPage: {
        '@type': 'WebPage',
        '@id': 'https://www.promptquorum.com/zh/edge-ai/vlm-video-analytics-drones-edge',
      },
    },
  },
  ar: {
    ...
    sections: {
      ...
      'platform-comparison': {
        ...
        content: [
          'راجع [دليل شرائح الحافة](/ar/edge-ai/edge-ai-hardware-for-local-llms) للمواصفات الكاملة لـ Jetson Orin وJetson Thor — يبقى هذا الجدول مركّزًا على المنصات المخصصة للكاميرات والطائرات المسيّرة الأكثر صلة بتحليل الفيديو.',
        ],
      ...
      'related-reading': {
        ...
        items: [
          '[عتاد الذكاء الاصطناعي الطرفي لنماذج LLM المحلية](/ar/edge-ai/edge-ai-hardware-for-local-llms) — المواصفات الكاملة لمنصتَي Jetson Orin وJetson Thor المشار إليهما في جدول المقارنة أعلاه',
          '[نماذج VLA للروبوتات: الاستدلال المحلي](/ar/edge-ai/vla-models-robots-local-inference) — المقال الشقيق حول قيد الشرائح نفسه مطبَّقًا على نماذج أفعال الروبوتات بدلًا من فهم الفيديو',
          '[مركز الذكاء الاصطناعي الطرفي](/ar/edge-ai) — المجموعة الكاملة التي تغطي شرائح الحافة، والاستدلال على متن الروبوتات، وتحليل الفيديو داخل الكاميرا',
    ...
    schema: {
      ...
      inLanguage: 'ar',
      url: 'https://www.promptquorum.com/ar/edge-ai/vlm-video-analytics-drones-edge',
      ...
      mainEntityOfPage: {
        '@type': 'WebPage',
        '@id': 'https://www.promptquorum.com/ar/edge-ai/vlm-video-analytics-drones-edge',
      },
    },
  },
  ko: {
    ...
    sections: {
      ...
      'platform-comparison': {
        ...
        content: [
          'Jetson Orin과 Jetson Thor의 전체 사양은 [엣지 실리콘 가이드](/ko/edge-ai/edge-ai-hardware-for-local-llms)를 참고하십시오. 이 표는 영상 분석과 가장 관련 있는 카메라·드론 전용 플랫폼에 초점을 맞춥니다.',
        ],
      ...
      'related-reading': {
        ...
        items: [
          '[로컬 LLM을 위한 엣지 AI 하드웨어](/ko/edge-ai/edge-ai-hardware-for-local-llms) — 위 비교표에서 참조한 Jetson Orin 및 Jetson Thor 플랫폼의 전체 사양',
          '[로봇을 위한 VLA 모델: 로컬 추론](/ko/edge-ai/vla-models-robots-local-inference) — 영상 이해가 아니라 로봇 행동 모델에 적용된 동일한 실리콘 제약을 다루는 자매 글',
          '[엣지 AI 허브](/ko/edge-ai) — 엣지 실리콘, 로봇 탑재 추론, 카메라 내장 영상 분석을 아우르는 전체 클러스터',
    ...
    schema: {
      ...
      inLanguage: 'ko',
      url: 'https://www.promptquorum.com/ko/edge-ai/vlm-video-analytics-drones-edge',
      ...
      mainEntityOfPage: {
        '@type': 'WebPage',
        '@id': 'https://www.promptquorum.com/ko/edge-ai/vlm-video-analytics-drones-edge',
      },
    },
  },
}
