    ...
    en: {
      ...
      sections: {
        ...
        callout7: {
          ...
          blockquoteSource: 'Internal evaluation across Ollama (Llama 3.3 8B) and LM Studio (Mistral 7B) quantized models vs full-precision cloud APIs.',
        },
    ...
    es: {
      ...
      sections: {
        ...
        callout7: {
          ...
          blockquoteSource: 'Evaluación interna en Ollama (Llama 3.3 8B) y LM Studio (Mistral 7B) modelos cuantizados vs APIs de nube de precisión completa.',
        },
