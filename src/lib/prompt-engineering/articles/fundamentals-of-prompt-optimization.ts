...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      seoTitle: 'كيفية تحسين الموجّهات في 2026: 6 رافعات و6 خطوات',
      ...
      metaDescription: 'حسّن جودة الذكاء الاصطناعي بنسبة 20–40٪ مع 6 رافعات وعملية من 6 خطوات. أمثلة قبل/بعد لـGPT-5.5 وClaude وGemini: تعمل على جميع النماذج.',
      publishDate: '2026-04-02',
      dateModified: '2026-04-04',
    ...
    pt: {
      ...
      schema: {
        ...
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
        image: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/api/og/fundamentals-of-prompt-optimization', width: 1200, height: 630 },
        url: 'https://www.promptquorum.com/pt/pt/prompt-engineering/fundamentals-of-prompt-optimization',
        inLanguage: 'pt-BR',
        speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
      },
    itemListSchema: {
