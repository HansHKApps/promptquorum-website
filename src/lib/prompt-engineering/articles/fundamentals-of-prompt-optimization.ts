    ...
    en: {
      ...
      howToSchema: {
        ...
        step: [
          ...
          { '@type': 'HowToStep', position: 4, name: 'Test across models', text: 'Run the revised prompt on GPT-4o, Claude Opus 4.7, and Gemini 3.1 Pro. A prompt that only works on one model is fragile.' },
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Does prompt optimization work across all AI models?', acceptedAnswer: { '@type': 'Answer', text: 'Yes, but with model-specific adjustments. The six core optimization levers (specificity, context, examples, constraints, output format, role) apply to GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro, and Mistral Large. However, each model responds differently to instruction density — Claude handles longer multi-part instructions better; GPT-4o responds well to structured system prompts; Gemini benefits from explicit section headers.' } },
      ...
      sections: {
        ...
        modelSpecificTips: {
          ...
          content: [
            '**The 6 optimization levers apply across all major models — GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro, and Mistral Large.** However, each model responds differently to instruction density, format specificity, and role definition. Below are model-specific tuning tips:',
          ],
          items: [
        ...
        multilingualReach: {
          ...
          rows: [
            { 'Language / Region': 'English — US', 'Local term for "prompt optimization"': 'prompt optimization', 'Primary model': 'GPT-4o, Claude Opus 4.7', 'Key regional note': 'Highest search volume globally; most published research is in English' },
            { 'Language / Region': 'English — UK / AU', 'Local term for "prompt optimization"': 'prompt optimisation', 'Primary model': 'GPT-4o, Claude Opus 4.7', 'Key regional note': 'British spelling (-ise); same technique, different keyword for UK/AU SEO' },
            { 'Language / Region': 'German — DE / AT / CH', 'Local term for "prompt optimization"': 'Prompt-Optimierung', 'Primary model': 'GPT-4o, Claude Opus 4.7', 'Key regional note': 'German compound noun; EU AI Act compliance context is especially relevant for DACH enterprises' },
            { 'Language / Region': 'French — FR / CA', 'Local term for "prompt optimization"': 'optimisation de prompt', 'Primary model': 'GPT-4o, Claude Opus 4.7', 'Key regional note': 'Feminine noun (l\'optimisation); French models respond well to explicit role definitions with formal register' },
            ...
            { 'Language / Region': 'Korean — KR', 'Local term for "prompt optimization"': '프롬프트 최적화', 'Primary model': 'GPT-4o, Claude Opus 4.7', 'Key regional note': 'High technical AI adoption; Korean text has dense tokenization — shorter prompts are proportionally more important' },
          ],
        },
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Yes, but with model-specific adjustments. The six core optimization levers (specificity, context, examples, constraints, output format, role) apply to GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro, and Mistral Large. However, each model responds differently to instruction density — Claude handles longer multi-part instructions better; GPT-4o responds well to structured system prompts; Gemini benefits from explicit section headers.',
            },
            {
    ...
    de: {
      ...
      howToSchema: {
        ...
        step: [
          ...
          { '@type': 'HowToStep', position: 4, name: 'Über mehrere Modelle testen', text: 'Den überarbeiteten Prompt mit GPT-4o, Claude Opus 4.7 und Gemini 3.1 Pro testen. Ein Prompt, der nur bei einem Modell funktioniert, ist fragil.' },
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Funktioniert Prompt-Optimierung bei allen KI-Modellen?', acceptedAnswer: { '@type': 'Answer', text: 'Ja, aber mit modellspezifischen Anpassungen. Die sechs zentralen Optimierungshebel (Spezifität, Kontext, Beispiele, Einschränkungen, Ausgabeformat, Rolle) gelten für GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro und Mistral Large. Jedes Modell reagiert jedoch unterschiedlich auf Anweisungsdichte – Claude verarbeitet längere mehrteilige Anweisungen besser; GPT-4o reagiert gut auf strukturierte System-Prompts; Gemini profitiert von expliziten Abschnittsüberschriften.' } },
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Ja, aber mit modellspezifischen Anpassungen. Die sechs Kern-Optimierungshebel (Spezifität, Kontext, Beispiele, Beschränkungen, Ausgabeformat, Rolle) gelten für GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro und Mistral Large. Allerdings reagiert jedes Modell unterschiedlich auf Anweisungsdichte — Claude handhabt längere mehrteilige Anweisungen besser; GPT-4o reagiert gut auf strukturierte System-Prompts; Gemini profitiert von expliziten Abschnittsüberschriften.',
            },
            {
    ...
    fr: {
      ...
      howToSchema: {
        ...
        step: [
          ...
          { '@type': 'HowToStep', position: 4, name: 'Tester sur plusieurs modèles', text: 'Exécuter le prompt révisé sur GPT-4o, Claude Opus 4.7 et Gemini 3.1 Pro. Un prompt qui fonctionne sur un seul modèle est fragile.' },
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'L\'optimisation de prompt fonctionne-t-elle sur tous les modèles IA ?', acceptedAnswer: { '@type': 'Answer', text: 'Oui, avec des ajustements spécifiques aux modèles. Les six leviers d\'optimisation (spécificité, contexte, exemples, contraintes, format de sortie, rôle) s\'appliquent à GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro et Mistral Large. Toutefois, chaque modèle réagit différemment à la densité des instructions.' } },
    ...
    ja: {
      ...
      howToSchema: {
        ...
        step: [
          ...
          { '@type': 'HowToStep', position: 4, name: '複数のモデルでテストする', text: 'GPT-4o、Claude Opus 4.7、Gemini 3.1 Proで修正されたプロンプトを実行します。1つのモデルでのみ機能するプロンプトは脆弱です。' },
      ...
      faqSchema: {
        ...
        inLanguage: 'ja',
        mainEntity: [
          { '@type': 'Question', name: 'プロンプト最適化とは何ですか？', acceptedAnswer: { '@type': 'Answer', text: 'プロンプト最適化は、特定のタスクに対するAI出力品質を向上させるために既存のプロンプトを反復的に改定するプロセスです。障害モード（フォーマット不良、ハルシネーション、曖昧な出力）を特定し、一つの変数（具体性、コンテキスト、例、制約、出力フォーマット、ロール）を変更して、GPT-4o、Claude Opus 4.7、Gemini 3.1 Proなどのモデルで結果をテストします。' } },
          ...
          { '@type': 'Question', name: 'プロンプト最適化はすべてのAIモデルで機能しますか？', acceptedAnswer: { '@type': 'Answer', text: 'はい、ただしモデル固有の調整が必要です。6つのコア最適化レバー（具体性、コンテキスト、例、制約、出力フォーマット、ロール）は、GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro、Mistral Largeに適用されます。ただし、各モデルは命令密度に対して異なる反応を示します。' } },
      ...
      sections: {
        ...
        definition: {
          title: 'プロンプト最適化とは？',
          content: [
            '**プロンプト最適化は、特定のタスクのためのAI出力の品質、精度、または一貫性を改善するために既存のプロンプトを改定する反復的なプロセスです。** これはすべての主要なモデルに適用されます—GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro、およびOllamaやLM Studioを介して実行されるローカルモデル。プロンプトエンジニアリングが初期プロンプト構造を設計する一方、プロンプト最適化は何が失敗しているかを診断し、出力が定義された標準を満たすまでターゲット変更を適用します。',
        ...
        modelSpecificTips: {
          title: 'モデル固有の最適化のヒント',
          content: [
            '**6つの最適化・レバーはすべての主要なモデル—GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro、およびMistral Largeに適用されます。** ただし、各モデルは異なる方法で命令密度、フォーマット特異性、およびロール定義に応答します。モデル固有のチューニング・ヒントを以下に示します：',
          ],
          items: [
        ...
        promptLibrary: {
          ...
          content: [
            ...
            '**PromptQuorumは実行する各プロンプトを保存します、バージョン管理、GPT-4o、Claude Opus 4.7、およびGemini 3.1 Proからの応答と一緒に。** スプレッドシートに出力をコピーする代わりに、テスト結果は自動的に保存されます。[PromptQuorumでプロンプト・ライブラリを開始](https://www.promptquorum.com)—最適化するすべてのプロンプトは保存され再生可能です。',
        ...
        faq: {
          title: 'FAQ : プロンプト最適化',
          faqs: [
            { q: 'プロンプト最適化とは何ですか？', a: 'プロンプト最適化は、特定のタスクのためのAI出力品質を改善するために既存のプロンプトを改定する反復的なプロセスです。障害モード（形式が違う、幻覚、曖昧な出力）を識別し、1つの変数（具体性、コンテキスト、例、制約、出力フォーマット、またはロール）を変更し、GPT-4o、Claude Opus 4.7、Gemini 3.1 Proなどのモデル全体で結果をテストします。' },
            ...
            { q: 'プロンプト最適化はすべてのAIモデルで機能しますか？', a: 'はい、ただしモデル固有の調整があります。6つのコア最適化・レバー（具体性、コンテキスト、例、制約、出力フォーマット、ロール）はGPT-4o、Claude Opus 4.7、Gemini 3.1 Pro、およびMistral Largeに適用されます。ただし、各モデルは命令密度に異なる方法で応答します—Claudeはより長いマルチパート指示をより良く処理；GPT-4oは構造化システム・プロンプトに良く応答；Geminiは明示的なセクション・ヘッダーから利益を得ます。' },
            ...
            { q: 'モデルごとに別々にプロンプトを最適化すべきですか？', a: 'モデルに依存しない最適化で始めてください—6つのレバー（具体性、コンテキスト、例、制約、出力フォーマット、ロール）を適用し、GPT-4o、Claude Opus 4.7、Gemini 3.1 Proでテストしてください。十分に構造化されたプロンプトは通常、3つすべてで十分に機能します。クロス・モデル・テストで相違する結果が示される場合にのみ、モデル固有の変種を追加します。一般的なモデル固有の調整：Claudeは長いマルチパート・システム・プロンプトをより良く処理；GPT-4oは明示的なJSON形式要求から利益を得る；Gemini 3.1 Proは長いドキュメント・タスクで明示的なセクション・ヘッダーから利益を得ます。プロンプト・ライブラリ内のモデル固有の変種をバージョン・ノート付きで文書化してください。' },
    ...
    zh: {
      ...
      howToSchema: {
        ...
        step: [
          ...
          { '@type': 'HowToStep', position: 4, name: '在多个模型上测试', text: '在GPT-4o、Claude Opus 4.7和Gemini 3.1 Pro上运行修订的提示词。仅在一个模型上工作的提示词很脆弱。' },
      ...
      faqSchema: {
        ...
        inLanguage: 'zh',
        mainEntity: [
          { '@type': 'Question', name: '什么是提示词优化？', acceptedAnswer: { '@type': 'Answer', text: '提示词优化是通过迭代修改现有提示词来改进特定任务AI输出质量的过程。包括识别失败模式（格式错误、幻觉、模糊输出），更改一个变量（具体性、上下文、示例、约束、输出格式或角色），并在GPT-4o、Claude Opus 4.7和Gemini 3.1 Pro等模型上测试结果。' } },
          ...
          { '@type': 'Question', name: '提示词优化适用于所有AI模型吗？', acceptedAnswer: { '@type': 'Answer', text: '是的，但需要针对模型进行调整。六个核心优化杠杆（具体性、上下文、示例、约束、输出格式、角色）适用于GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro和Mistral Large。但每个模型对指令密度的反应不同——Claude更好地处理长而复杂的指令；GPT-4o对结构化系统提示词响应好；Gemini受益于明确的章节标题。' } },
      ...
      sections: {
        ...
        modelSpecificTips: {
          title: '特定模型的优化提示',
          content: 'GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro和Mistral Large各有独特的指示跟随特性。每个模型对相同提示词的响应略有不同。',
          items: [
        ...
        faq: {
          ...
          faqs: [
            {
              q: '什么是提示词优化？',
              a: '提示词优化是为了改进特定任务的AI输出质量而迭代修改现有提示词的过程。它涉及识别失败模式（格式错误、幻觉、模糊输出），改变一个变量（具体性、上下文、示例、约束、输出格式或角色），并在GPT-4o、Claude Opus 4.7和Gemini 3.1 Pro等模型上测试结果。',
            },
            {
              q: '提示词优化与提示词工程的区别是什么？',
            ...
            {
              q: '提示词优化在所有AI模型上都有效吗？',
              a: '是的，但需要特定于模型的调整。六个核心优化杠杆（具体性、上下文、示例、约束、输出格式、角色）适用于GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro和Mistral Large。但是，每个模型对指示密度的响应不同——Claude更好地处理较长的多部分指示；GPT-4o响应结构化system prompts；Gemini受益于显式部分标题。',
            },
            {
              q: '最常见的提示词优化错误是什么？',
            ...
            {
              q: '我应该为每个模型分别优化提示词吗？',
              a: '从模型无关的优化开始——应用6个杠杆（具体性、上下文、示例、约束、输出格式、角色）并在GPT-4o、Claude Opus 4.7和Gemini 3.1 Pro上测试。结构良好的提示词通常在全部三个上工作得很好。仅当跨模型测试显示不同的结果时才添加特定于模型的变种。常见的特定于模型的调整：Claude更好地处理较长的多部分system prompts；GPT-4o受益于显式JSON格式请求；Gemini 3.1 Pro受益于长文档任务中的显式部分标题。在提示词库中用版本注释记录特定于模型的变种。',
            },
            {
              q: '提示词优化与RAG之间的区别是什么？',
