...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      howToSchema: {
        ...
        step: [
          ...
          { '@type': 'HowToStep', position: 4, name: 'Test across models', text: 'Run the revised prompt on GPT-4o, Claude Opus 4.8, and Gemini 3.1 Pro. A prompt that only works on one model is fragile.' },
      ...
      quickFacts: [
        ...
        '**Multi-model testing required:** A prompt that works on GPT-4o but fails on Claude is fragile — test on ≥2 models to confirm robustness',
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Does prompt optimization work across all AI models?', acceptedAnswer: { '@type': 'Answer', text: 'Yes, but with model-specific adjustments. The six core optimization levers (specificity, context, examples, constraints, output format, role) apply to GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro, and Mistral Large. However, each model responds differently to instruction density — Claude handles longer multi-part instructions better; GPT-4o responds well to structured system prompts; Gemini benefits from explicit section headers.' } },
      ...
      sections: {
        ...
        modelSpecificTips: {
          ...
          content: [
            '**The 6 optimization levers apply across all major models — GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro, and Mistral Large.** However, each model responds differently to instruction density, format specificity, and role definition. Below are model-specific tuning tips:',
          ],
          items: [
          ...
          snippets: [
            { type: 'in-plain-terms', text: 'Different models have different "personalities" — Claude is patient with long instructions, GPT-4o prefers tight constraints, Gemini handles massive documents. After you optimize a prompt, test it on all your target models because one size does not fit all.' },
          ],
        },
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Mistake 3: Optimizing for one model only.** You optimize for GPT-4o, see perfect results, then deploy on Claude. It fails. Each model has slightly different instruction-following behavior. Test on at least 2 models (GPT-4o and Claude Opus 4.8); ideally 3.',
        ...
        callout7: {
          blockquote: 'Quantized models (4-bit, 8-bit) show 15–25% higher sensitivity to ambiguous prompts compared to full-precision versions of the same model. A prompt that works reliably on GPT-4o (full precision, 100+ billion parameters) may fail 30–40% of the time on Llama 3.1 8B quantized. The optimization strategy differs: full-precision models tolerate implicit instructions; quantized models require explicit, unambiguous directions. Prompt optimization for local LLMs must account for this reduced instruction-following capacity.',
        ...
        multilingualReach: {
          ...
          rows: [
            { 'Language / Region': 'English — US', 'Local term for "prompt optimization"': 'prompt optimization', 'Primary model': 'GPT-4o, Claude Opus 4.8', 'Key regional note': 'Highest search volume globally; most published research is in English' },
            { 'Language / Region': 'English — UK / AU', 'Local term for "prompt optimization"': 'prompt optimisation', 'Primary model': 'GPT-4o, Claude Opus 4.8', 'Key regional note': 'British spelling (-ise); same technique, different keyword for UK/AU SEO' },
            { 'Language / Region': 'German — DE / AT / CH', 'Local term for "prompt optimization"': 'Prompt-Optimierung', 'Primary model': 'GPT-4o, Claude Opus 4.8', 'Key regional note': 'German compound noun; EU AI Act compliance context is especially relevant for DACH enterprises' },
            { 'Language / Region': 'French — FR / CA', 'Local term for "prompt optimization"': 'optimisation de prompt', 'Primary model': 'GPT-4o, Claude Opus 4.8', 'Key regional note': 'Feminine noun (l\'optimisation); French models respond well to explicit role definitions with formal register' },
            ...
            { 'Language / Region': 'Korean — KR', 'Local term for "prompt optimization"': '프롬프트 최적화', 'Primary model': 'GPT-4o, Claude Opus 4.8', 'Key regional note': 'High technical AI adoption; Korean text has dense tokenization — shorter prompts are proportionally more important' },
          ],
        },
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Yes, but with model-specific adjustments. The six core optimization levers (specificity, context, examples, constraints, output format, role) apply to GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro, and Mistral Large. However, each model responds differently to instruction density — Claude handles longer multi-part instructions better; GPT-4o responds well to structured system prompts; Gemini benefits from explicit section headers.',
            },
            {
    ...
    de: {
      ...
      howToSchema: {
        ...
        step: [
          ...
          { '@type': 'HowToStep', position: 4, name: 'Über mehrere Modelle testen', text: 'Den überarbeiteten Prompt mit GPT-4o, Claude Opus 4.8 und Gemini 3.1 Pro testen. Ein Prompt, der nur bei einem Modell funktioniert, ist fragil.' },
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Funktioniert Prompt-Optimierung bei allen KI-Modellen?', acceptedAnswer: { '@type': 'Answer', text: 'Ja, aber mit modellspezifischen Anpassungen. Die sechs zentralen Optimierungshebel (Spezifität, Kontext, Beispiele, Einschränkungen, Ausgabeformat, Rolle) gelten für GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro und Mistral Large. Jedes Modell reagiert jedoch unterschiedlich auf Anweisungsdichte – Claude verarbeitet längere mehrteilige Anweisungen besser; GPT-4o reagiert gut auf strukturierte System-Prompts; Gemini profitiert von expliziten Abschnittsüberschriften.' } },
          ...
          { '@type': 'Question', name: 'Sollte ich Prompts für jedes KI-Modell separat optimieren?', acceptedAnswer: { '@type': 'Answer', text: 'Beginne mit einer modellunabhängigen Optimierung – wende die 6 Hebel (Spezifität, Kontext, Beispiele, Einschränkungen, Ausgabeformat, Rolle) an und teste bei GPT-4o, Claude Opus 4.8 und Gemini 3.1 Pro. Ein gut strukturierter Prompt funktioniert typischerweise bei allen drei gut. Füge modellspezifische Varianten nur dann hinzu, wenn modellübergreifende Tests divergierende Ergebnisse zeigen. Häufige modellspezifische Anpassungen: Claude verarbeitet längere mehrteilige System-Prompts gut; GPT-4o profitiert von expliziten JSON-Formatanfragen; Gemini 3.1 Pro profitiert von expliziten Abschnittsüberschriften bei langen Dokumentenaufgaben. Halte modellspezifische Varianten in einer Prompt-Bibliothek mit Versionshinweisen.' } },
      ...
      sections: {
        ...
        definition: {
          ...
          content: [
            '**Prompt-Optimierung ist der iterative Prozess der Überarbeitung eines bestehenden Prompts zur Verbesserung der Qualität, Genauigkeit oder Konsistenz der KI-Ausgabe für eine spezifische Aufgabe.** Sie gilt für alle großen Modelle – GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro und lokal ausgeführte Modelle über Ollama oder LM Studio. Während Prompt-Entwicklung die ursprüngliche Prompt-Struktur entwirft, diagnostiziert Prompt-Optimierung, was fehlschlägt, und wendet gezielte Änderungen an, bis die Ausgabe einen definierten Standard erfüllt.',
        ...
        optimizationProcess: {
          ...
          items: [
            ...
            '**Schritt 4: Teste über Modelle hinweg.** Führe den überarbeiteten Prompt auf GPT-4o, Claude Opus 4.8 und Gemini 3.1 Pro aus. Ein Prompt, der auf nur einem Modell funktioniert, ist fragil und modellspezifisch. Nutze PromptQuorum, um einen Prompt gleichzeitig an alle drei zu versenden und Antworten Seite an Seite zu vergleichen. Übereinstimmung über Modelle hinweg bedeutet, der Prompt ist robust; Abweichung bedeutet, du brauchst weitere Verfeinerung.',
        ...
        modelSpecificTips: {
          ...
          content: [
            '**Die 6 Optimierungshebel gelten über alle großen Modelle — GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro und Mistral Large.** Allerdings reagiert jedes Modell unterschiedlich auf Anweisungsdichte, Format-Spezifität und Rollendefinition. Hier sind modellspezifische Tuning-Tipps:',
          ],
          items: [
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Fehler 3: Optimierung für nur ein Modell.** Du optimierst für GPT-4o, siehst perfekte Ergebnisse, dann stellst bereit auf Claude. Es schlägt fehl. Jedes Modell hat leicht verschiedenes Anweisungs-Folge-Verhalten. Teste auf mindestens 2 Modellen (GPT-4o und Claude Opus 4.8); ideal 3.',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Ja, aber mit modellspezifischen Anpassungen. Die sechs Kern-Optimierungshebel (Spezifität, Kontext, Beispiele, Beschränkungen, Ausgabeformat, Rolle) gelten für GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro und Mistral Large. Allerdings reagiert jedes Modell unterschiedlich auf Anweisungsdichte — Claude handhabt längere mehrteilige Anweisungen besser; GPT-4o reagiert gut auf strukturierte System-Prompts; Gemini profitiert von expliziten Abschnittsüberschriften.',
            },
            {
    ...
    es: {
      ...
      metaDescription: 'Mejora la calidad de la IA un 20–40 % con 6 palancas y un proceso de 6 pasos. Ejemplos antes/después para GPT-4o, Claude y Gemini: funciona en todos.',
      publishDate: '2026-04-02',
      dateModified: '2026-04-04',
      ...
      schema: {
        ...
        image: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/api/og/fundamentals-of-prompt-optimization', width: 1200, height: 630 },
        url: 'https://www.promptquorum.com/es/prompt-engineering/fundamentals-of-prompt-optimization?lang=es',
        inLanguage: 'es',
        speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
      },
      itemListSchema: {
      ...
      howToSchema: {
        ...
        step: [
          ...
          { '@type': 'HowToStep', position: 4, name: 'Probar en múltiples modelos', text: 'Ejecuta el prompt revisado en GPT-4o, Claude Opus 4.8 y Gemini 3.1 Pro. Un prompt que solo funciona en un modelo es frágil.' },
      ...
      faqSchema: {
        ...
        inLanguage: 'es',
        mainEntity: [
          { '@type': 'Question', name: '¿Qué es la optimización de prompts?', acceptedAnswer: { '@type': 'Answer', text: 'La optimización de prompts es el proceso iterativo de revisar un prompt existente para mejorar la calidad de la salida de IA para una tarea específica. Implica identificar un modo de fallo (formato incorrecto, alucinación, salida vaga), cambiar una variable (especificidad, contexto, ejemplos, restricciones, formato de salida o rol) y probar el resultado en modelos como GPT-4o, Claude Opus 4.8 y Gemini 3.1 Pro.' } },
          ...
          { '@type': 'Question', name: '¿Funciona la optimización de prompts en todos los modelos de IA?', acceptedAnswer: { '@type': 'Answer', text: 'Sí, pero con ajustes específicos del modelo. Las seis palancas de optimización principales (especificidad, contexto, ejemplos, restricciones, formato de salida, rol) se aplican a GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro y Mistral Large. Sin embargo, cada modelo responde de manera diferente a la densidad de instrucciones — Claude maneja mejor instrucciones más largas y de múltiples partes; GPT-4o responde bien a system prompts estructurados; Gemini se beneficia de encabezados de sección explícitos.' } },
          ...
          { '@type': 'Question', name: '¿Debo optimizar los prompts para cada modelo de IA por separado?', acceptedAnswer: { '@type': 'Answer', text: 'Empieza con una optimización agnóstica al modelo — aplica las 6 palancas y prueba en GPT-4o, Claude Opus 4.8 y Gemini 3.1 Pro. Un prompt bien estructurado típicamente funciona bien en los tres. Solo añade variantes específicas del modelo si las pruebas entre modelos revelan resultados divergentes.' } },
      ...
      sections: {
        ...
        optimizationProcess: {
          ...
          items: [
            ...
            '**Paso 4: Prueba en múltiples modelos.** Ejecuta el prompt revisado en GPT-4o, Claude Opus 4.8 y Gemini 3.1 Pro. Un prompt que solo funciona en un modelo es frágil y específico del modelo. Usa PromptQuorum para despachar un prompt a los tres simultáneamente y comparar respuestas lado a lado.',
        ...
        modelSpecificTips: {
          ...
          content: [
            '**Las 6 palancas de optimización se aplican a todos los modelos principales — GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro y Mistral Large.** Sin embargo, cada modelo responde de manera diferente a la densidad de instrucciones, la especificidad del formato y la definición de rol. A continuación, consejos de ajuste específicos por modelo:',
          ],
          items: [
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Error 3: Optimizar para solo un modelo.** Optimizas para GPT-4o, ves resultados perfectos, luego despliegas en Claude. Falla. Prueba en al menos 2 modelos (GPT-4o y Claude Opus 4.8); idealmente 3.',
        ...
        promptLibrary: {
          ...
          content: [
            ...
            '**PromptQuorum almacena cada prompt que ejecutas, con control de versiones, junto con sus respuestas de GPT-4o, Claude Opus 4.8 y Gemini 3.1 Pro.** En lugar de copiar salidas en una hoja de cálculo, tus resultados de prueba se preservan automáticamente. [Empieza tu biblioteca de prompts en PromptQuorum](https://www.promptquorum.com) — cada prompt que optimizas se guarda y se puede reproducir.',
        ...
        multilingualReach: {
          ...
          rows: [
            { 'Idioma / Región': 'Inglés — EE.UU.', 'Término local para "optimización de prompts"': 'prompt optimization', 'Modelo principal': 'GPT-4o, Claude Opus 4.8', 'Nota regional clave': 'Mayor volumen de búsqueda global; la mayoría de la investigación publicada está en inglés' },
            { 'Idioma / Región': 'Inglés — Reino Unido / AU', 'Término local para "optimización de prompts"': 'prompt optimisation', 'Modelo principal': 'GPT-4o, Claude Opus 4.8', 'Nota regional clave': 'Ortografía británica (-ise); misma técnica, diferente palabra clave para SEO del Reino Unido/AU' },
            { 'Idioma / Región': 'Alemán — DE / AT / CH', 'Término local para "optimización de prompts"': 'Prompt-Optimierung', 'Modelo principal': 'GPT-4o, Claude Opus 4.8', 'Nota regional clave': 'Sustantivo compuesto alemán; el contexto de cumplimiento de la Ley de IA de la UE es especialmente relevante para las empresas DACH' },
            { 'Idioma / Región': 'Francés — FR / CA', 'Término local para "optimización de prompts"': 'optimisation de prompt', 'Modelo principal': 'GPT-4o, Claude Opus 4.8', 'Nota regional clave': 'Sustantivo femenino (l\'optimisation); los modelos franceses responden bien a definiciones de rol explícitas con registro formal' },
            ...
            { 'Idioma / Región': 'Coreano — KR', 'Término local para "optimización de prompts"': '프롬프트 최적화', 'Modelo principal': 'GPT-4o, Claude Opus 4.8', 'Nota regional clave': 'Alta adopción técnica de IA; el texto coreano tiene una tokenización densa — los prompts más cortos son proporcionalmente más importantes' },
          ],
        },
        ...
        faq: {
          ...
          faqs: [
            { q: '¿Qué es la optimización de prompts?', a: 'La optimización de prompts es el proceso iterativo de revisar un prompt existente para mejorar la calidad de la salida de IA para una tarea específica. Implica identificar un modo de fallo (formato incorrecto, alucinación, salida vaga), cambiar una variable (especificidad, contexto, ejemplos, restricciones, formato de salida o rol) y probar el resultado en modelos como GPT-4o, Claude Opus 4.8 y Gemini 3.1 Pro.' },
            ...
            { q: '¿Funciona la optimización de prompts en todos los modelos de IA?', a: 'Sí, pero con ajustes específicos del modelo. Las seis palancas de optimización principales se aplican a GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro y Mistral Large. Sin embargo, cada modelo responde de manera diferente a la densidad de instrucciones.' },
    ...
    fr: {
      ...
      howToSchema: {
        ...
        step: [
          ...
          { '@type': 'HowToStep', position: 4, name: 'Tester sur plusieurs modèles', text: 'Exécuter le prompt révisé sur GPT-4o, Claude Opus 4.8 et Gemini 3.1 Pro. Un prompt qui fonctionne sur un seul modèle est fragile.' },
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'L\'optimisation de prompt fonctionne-t-elle sur tous les modèles IA ?', acceptedAnswer: { '@type': 'Answer', text: 'Oui, avec des ajustements spécifiques aux modèles. Les six leviers d\'optimisation (spécificité, contexte, exemples, contraintes, format de sortie, rôle) s\'appliquent à GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro et Mistral Large. Toutefois, chaque modèle réagit différemment à la densité des instructions.' } },
      ...
      sections: {
        ...
        modelSpecificTips: {
          ...
          content: [
            '**Les 6 leviers d\'optimisation s\'appliquent à tous les modèles majeurs — GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro et Mistral Large.** Cependant, chaque modèle répond différemment à la densité d\'instructions, la spécificité du format et la définition du rôle. Voici les conseils de tuning spécifiques au modèle :',
          ],
          items: [
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Erreur 3 : Optimiser pour un seul modèle.** Vous optimisez pour GPT-4o, voyez des résultats parfaits, puis déployez sur Claude. Il échoue. Chaque modèle a un comportement de suivi d\'instructions légèrement différent. Testez sur au moins 2 modèles (GPT-4o et Claude Opus 4.8) ; idéalement 3.',
        ...
        promptLibrary: {
          ...
          content: [
            ...
            '**PromptQuorum stocke chaque prompt que vous exécutez, contrôlé en version, aux côtés de ses réponses de GPT-4o, Claude Opus 4.8 et Gemini 3.1 Pro.** Au lieu de copier les sorties dans une feuille de calcul, vos résultats de test sont automatiquement préservés. [Commencez votre bibliothèque de prompts sur PromptQuorum](https://www.promptquorum.com) — chaque prompt que vous optimisez est sauvegardé et rejouable.',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Oui, mais avec des ajustements spécifiques au modèle. Les six leviers d\'optimisation fondamentaux (spécificité, contexte, exemples, contraintes, format de sortie, rôle) s\'appliquent à GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro et Mistral Large. Cependant, chaque modèle répond différemment à la densité d\'instructions — Claude gère mieux les instructions multi-parties plus longues ; GPT-4o répond bien aux system prompts structurés ; Gemini bénéficie des en-têtes de section explicites.',
            },
            {
    ...
    ja: {
      ...
      howToSchema: {
        ...
        step: [
          ...
          { '@type': 'HowToStep', position: 4, name: '複数のモデルでテストする', text: 'GPT-4o、Claude Opus 4.8、Gemini 3.1 Proで修正されたプロンプトを実行します。1つのモデルでのみ機能するプロンプトは脆弱です。' },
      ...
      faqSchema: {
        ...
        inLanguage: 'ja',
        mainEntity: [
          { '@type': 'Question', name: 'プロンプト最適化とは何ですか？', acceptedAnswer: { '@type': 'Answer', text: 'プロンプト最適化は、特定のタスクに対するAI出力品質を向上させるために既存のプロンプトを反復的に改定するプロセスです。障害モード（フォーマット不良、ハルシネーション、曖昧な出力）を特定し、一つの変数（具体性、コンテキスト、例、制約、出力フォーマット、ロール）を変更して、GPT-4o、Claude Opus 4.8、Gemini 3.1 Proなどのモデルで結果をテストします。' } },
          ...
          { '@type': 'Question', name: 'プロンプト最適化はすべてのAIモデルで機能しますか？', acceptedAnswer: { '@type': 'Answer', text: 'はい、ただしモデル固有の調整が必要です。6つのコア最適化レバー（具体性、コンテキスト、例、制約、出力フォーマット、ロール）は、GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro、Mistral Largeに適用されます。ただし、各モデルは命令密度に対して異なる反応を示します。' } },
      ...
      sections: {
        ...
        definition: {
          title: 'プロンプト最適化とは？',
          content: [
            '**プロンプト最適化は、特定のタスクのためのAI出力の品質、精度、または一貫性を改善するために既存のプロンプトを改定する反復的なプロセスです。** これはすべての主要なモデルに適用されます—GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro、およびOllamaやLM Studioを介して実行されるローカルモデル。プロンプトエンジニアリングが初期プロンプト構造を設計する一方、プロンプト最適化は何が失敗しているかを診断し、出力が定義された標準を満たすまでターゲット変更を適用します。',
        ...
        optimizationProcess: {
          ...
          items: [
            ...
            '**ステップ4：複数のモデルでテストする。** 修正されたプロンプトをGPT-4o、Claude Opus 4.8、Gemini 3.1 Proで実行します。1つのモデルでのみ機能するプロンプトは脆弱でモデル固有です。PromptQuorumを使用して1つのプロンプトを3つすべてに同時に送信し、応答を並べて比較します。モデル全体の合意はプロンプトが堅牢であることを意味します；分岐はさらなる改善が必要であることを意味します。',
        ...
        modelSpecificTips: {
          title: 'モデル固有の最適化のヒント',
          content: [
            '**6つの最適化・レバーはすべての主要なモデル—GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro、およびMistral Largeに適用されます。** ただし、各モデルは異なる方法で命令密度、フォーマット特異性、およびロール定義に応答します。モデル固有のチューニング・ヒントを以下に示します：',
          ],
          items: [
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**エラー3：1つのモデルのみのために最適化する。** GPT-4oのために最適化、完璧な結果を見て、その後Claude上で展開します。失敗します。各モデルは命令追従動作が若干異なります。少なくとも2モデル（GPT-4oおよびClaude Opus 4.8）でテスト；理想的には3。',
        ...
        promptLibrary: {
          ...
          content: [
            ...
            '**PromptQuorumは実行する各プロンプトを保存します、バージョン管理、GPT-4o、Claude Opus 4.8、およびGemini 3.1 Proからの応答と一緒に。** スプレッドシートに出力をコピーする代わりに、テスト結果は自動的に保存されます。[PromptQuorumでプロンプト・ライブラリを開始](https://www.promptquorum.com)—最適化するすべてのプロンプトは保存され再生可能です。',
        ...
        faq: {
          title: 'FAQ : プロンプト最適化',
          faqs: [
            { q: 'プロンプト最適化とは何ですか？', a: 'プロンプト最適化は、特定のタスクのためのAI出力品質を改善するために既存のプロンプトを改定する反復的なプロセスです。障害モード（形式が違う、幻覚、曖昧な出力）を識別し、1つの変数（具体性、コンテキスト、例、制約、出力フォーマット、またはロール）を変更し、GPT-4o、Claude Opus 4.8、Gemini 3.1 Proなどのモデル全体で結果をテストします。' },
            ...
            { q: 'プロンプト最適化はすべてのAIモデルで機能しますか？', a: 'はい、ただしモデル固有の調整があります。6つのコア最適化・レバー（具体性、コンテキスト、例、制約、出力フォーマット、ロール）はGPT-4o、Claude Opus 4.8、Gemini 3.1 Pro、およびMistral Largeに適用されます。ただし、各モデルは命令密度に異なる方法で応答します—Claudeはより長いマルチパート指示をより良く処理；GPT-4oは構造化システム・プロンプトに良く応答；Geminiは明示的なセクション・ヘッダーから利益を得ます。' },
            ...
            { q: 'モデルごとに別々にプロンプトを最適化すべきですか？', a: 'モデルに依存しない最適化で始めてください—6つのレバー（具体性、コンテキスト、例、制約、出力フォーマット、ロール）を適用し、GPT-4o、Claude Opus 4.8、Gemini 3.1 Proでテストしてください。十分に構造化されたプロンプトは通常、3つすべてで十分に機能します。クロス・モデル・テストで相違する結果が示される場合にのみ、モデル固有の変種を追加します。一般的なモデル固有の調整：Claudeは長いマルチパート・システム・プロンプトをより良く処理；GPT-4oは明示的なJSON形式要求から利益を得る；Gemini 3.1 Proは長いドキュメント・タスクで明示的なセクション・ヘッダーから利益を得ます。プロンプト・ライブラリ内のモデル固有の変種をバージョン・ノート付きで文書化してください。' },
    ...
    zh: {
      ...
      howToSchema: {
        ...
        step: [
          ...
          { '@type': 'HowToStep', position: 4, name: '在多个模型上测试', text: '在GPT-4o、Claude Opus 4.8和Gemini 3.1 Pro上运行修订的提示词。仅在一个模型上工作的提示词很脆弱。' },
      ...
      faqSchema: {
        ...
        inLanguage: 'zh',
        mainEntity: [
          { '@type': 'Question', name: '什么是提示词优化？', acceptedAnswer: { '@type': 'Answer', text: '提示词优化是通过迭代修改现有提示词来改进特定任务AI输出质量的过程。包括识别失败模式（格式错误、幻觉、模糊输出），更改一个变量（具体性、上下文、示例、约束、输出格式或角色），并在GPT-4o、Claude Opus 4.8和Gemini 3.1 Pro等模型上测试结果。' } },
          ...
          { '@type': 'Question', name: '提示词优化适用于所有AI模型吗？', acceptedAnswer: { '@type': 'Answer', text: '是的，但需要针对模型进行调整。六个核心优化杠杆（具体性、上下文、示例、约束、输出格式、角色）适用于GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro和Mistral Large。但每个模型对指令密度的反应不同——Claude更好地处理长而复杂的指令；GPT-4o对结构化系统提示词响应好；Gemini受益于明确的章节标题。' } },
      ...
      sections: {
        ...
        definition: {
          title: '什么是提示词优化？',
          content: [
            '**提示词优化是为了改进特定任务的AI输出质量、准确性或一致性而迭代修改现有提示词的过程。** 它适用于所有主要模型——GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro，以及通过Ollama或LM Studio运行的本地模型。虽然提示词工程设计初始提示词结构，但提示词优化诊断什么失败了，并应用有针对性的改变，直到输出达到定义的标准。',
        ...
        optimizationProcess: {
          ...
          items: [
            ...
            '**第4步：在多个模型上测试。** 在GPT-4o、Claude Opus 4.8和Gemini 3.1 Pro上运行修订的提示词。仅在一个模型上工作的提示词很脆弱。跨模型一致的改进意味着您改进了提示词本身，而不是为一个特定模型的怪癖优化。使用PromptQuorum同时向所有三个模型发送提示词。',
        ...
        modelSpecificTips: {
          title: '特定模型的优化提示',
          content: 'GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro和Mistral Large各有独特的指示跟随特性。每个模型对相同提示词的响应略有不同。',
          items: [
        ...
        faq: {
          ...
          faqs: [
            {
              q: '什么是提示词优化？',
              a: '提示词优化是为了改进特定任务的AI输出质量而迭代修改现有提示词的过程。它涉及识别失败模式（格式错误、幻觉、模糊输出），改变一个变量（具体性、上下文、示例、约束、输出格式或角色），并在GPT-4o、Claude Opus 4.8和Gemini 3.1 Pro等模型上测试结果。',
            },
            {
              q: '提示词优化与提示词工程的区别是什么？',
            ...
            {
              q: '提示词优化在所有AI模型上都有效吗？',
              a: '是的，但需要特定于模型的调整。六个核心优化杠杆（具体性、上下文、示例、约束、输出格式、角色）适用于GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro和Mistral Large。但是，每个模型对指示密度的响应不同——Claude更好地处理较长的多部分指示；GPT-4o响应结构化system prompts；Gemini受益于显式部分标题。',
            },
            {
              q: '最常见的提示词优化错误是什么？',
            ...
            {
              q: '我应该为每个模型分别优化提示词吗？',
              a: '从模型无关的优化开始——应用6个杠杆（具体性、上下文、示例、约束、输出格式、角色）并在GPT-4o、Claude Opus 4.8和Gemini 3.1 Pro上测试。结构良好的提示词通常在全部三个上工作得很好。仅当跨模型测试显示不同的结果时才添加特定于模型的变种。常见的特定于模型的调整：Claude更好地处理较长的多部分system prompts；GPT-4o受益于显式JSON格式请求；Gemini 3.1 Pro受益于长文档任务中的显式部分标题。在提示词库中用版本注释记录特定于模型的变种。',
            },
            {
              q: '提示词优化与RAG之间的区别是什么？',
