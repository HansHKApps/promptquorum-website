...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      metaDescription: 'حسّن مخرجات الذكاء الاصطناعي بنسبة 20–40% باستخدام 6 رافعات وعملية مُثبتة من 6 خطوات. أمثلة قبل/بعد لـGPT-5.5 وClaude وGemini تعمل على جميع النماذج.',
      publishDate: '2026-04-02',
      dateModified: '2026-04-04',
