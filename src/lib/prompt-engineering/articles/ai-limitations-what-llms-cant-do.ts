...
export const article: Record<Language, PEArticle> = {
    en: {
      ...
      intro: 'Large language models have eight hard limits that no amount of fine-tuning, scaling, or prompt engineering can eliminate: no real-time data, confident hallucinations, weak multi-step reasoning, context window caps, no memory, no real-world actions, training bias, and no self-verification. Every model — GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro, and open-source alternatives — shares these structural constraints. This guide covers each limit with the engineering workaround that works in production.',
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 4, name: 'Context window limits', description: 'Root cause: transformer attention has a hard token cap. Severity: medium for long documents. Context caps: GPT-4o 128K, Claude Opus 4.7 1M, Gemini 3.1 Pro 2M tokens. Workaround: RAG, chunking, summarization.' },
          ...
          { '@type': 'ListItem', position: 6, name: 'No real-world action capability', description: 'Root cause: LLMs output text only by default. Severity: high for autonomous tasks. Workaround: tool use / function calling available in GPT-4o, Claude Opus 4.7, and Gemini 3.1 Pro.' },
      ...
      sections: {
        ...
        modelLimitsComparison: {
          ...
          columns: ['Limitation', 'GPT-4o', 'Claude Opus 4.7', 'Gemini 3.1 Pro', 'Open-Source (LLaMA 3.1)'],
          rows: [
            { 'Limitation': 'Knowledge cutoff', 'GPT-4o': 'Oct 2024', 'Claude Opus 4.7': 'Early 2025', 'Gemini 3.1 Pro': 'Early 2025', 'Open-Source (LLaMA 3.1)': 'Varies by release' },
            { 'Limitation': 'Context window', 'GPT-4o': '128K tokens', 'Claude Opus 4.7': '1M tokens', 'Gemini 3.1 Pro': '2M tokens', 'Open-Source (LLaMA 3.1)': '8K–128K tokens' },
            { 'Limitation': 'Tool use quality', 'GPT-4o': 'Excellent', 'Claude Opus 4.7': 'Excellent', 'Gemini 3.1 Pro': 'Good', 'Open-Source (LLaMA 3.1)': 'Varies' },
            { 'Limitation': 'Hallucination handling', 'GPT-4o': 'Moderate', 'Claude Opus 4.7': 'Strong (flags uncertainty)', 'Gemini 3.1 Pro': 'Moderate', 'Open-Source (LLaMA 3.1)': 'Weak' },
            { 'Limitation': 'Reasoning (extended)', 'GPT-4o': 'o3/o4-mini available', 'Claude Opus 4.7': 'Extended thinking available', 'Gemini 3.1 Pro': 'Flash Thinking available', 'Open-Source (LLaMA 3.1)': 'Limited' },
          ],
        },
        knowledgeCutoff: {
        ...
        contextWindow: {
          ...
          content: [
            '**Every LLM session has a hard token limit — GPT-4o at 128,000 tokens, Claude Opus 4.7 at 200,000 tokens, Gemini 3.1 Pro at 2,000,000 tokens — and performance on earlier content degrades as the window fills.** See [Context Windows Explained](/prompt-engineering/context-windows-explained-why-ai-forgets) for a full breakdown.',
        ...
        keyTerms: {
          ...
          items: [
            '**[Knowledge Cutoff](/prompt-engineering/prompt-engineering-glossary)** — The date beyond which a model has no training data. Any event, pricing change, or release after this date is invisible to the model unless you paste it into the prompt. GPT-4o: October 2024; Claude Opus 4.7 and Gemini 3.1 Pro: early 2025.',
            ...
            '**[Context Window](/prompt-engineering/prompt-engineering-glossary#core-concepts)** — The maximum number of tokens (words + punctuation) the model can process at once, including system prompt, conversation history, and retrieved documents. GPT-4o: 128K tokens; Claude Opus 4.7: 1M; Gemini 3.1 Pro: 2M.',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'How do limitations differ between open-source and proprietary models in 2026?', a: 'Open-source models (LLaMA 3.1, Mistral Large, Qwen 2.5) and proprietary models (GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro) face identical structural limitations — knowledge cutoffs, hallucination, context windows, reasoning constraints. The differences are in severity and cost: proprietary models typically have larger contexts (Gemini 3.1 Pro: 2M tokens vs. Mistral: 128K), better instruction-following, and more frequent training updates. Open-source models trade capabilities for cost and deployment control. Neither category eliminates any of the eight limitations.' },
          ],
        },
        sources: {
    ...
    de: {
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 4, name: 'Kontextfenster-Grenzen', description: 'Ursache: Transformer-Attention hat ein hartes Token-Limit. Schweregrad: mittel für lange Dokumente. Kontextlimits: GPT-4o 128K, Claude Opus 4.7 1M, Gemini 3.1 Pro 2M Tokens. Workaround: RAG, Chunking, Zusammenfassung.' },
          ...
          { '@type': 'ListItem', position: 6, name: 'Keine Echtwelt-Aktionsfähigkeit', description: 'Ursache: LLMs geben standardmäßig nur Text aus. Schweregrad: hoch für autonome Aufgaben. Workaround: Tool-Use / Function Calling verfügbar in GPT-4o, Claude Opus 4.7 und Gemini 3.1 Pro.' },
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: { '@type': 'Answer', text: 'Stand 2026: OpenAI GPT-4o hat einen Trainings-Cutoff von Oktober 2024; Anthropic Claude Opus 4.7 und Google Gemini 3.1 Pro haben Cutoffs Anfang 2025. Alle drei Modelle können ungenaues Wissen über Ereignisse nahe ihrer Cutoffs haben, da die Trainingsabdeckung der jüngsten Monate spärlich ist.' },
          },
          {
            '@type': 'Question',
          ...
          },
          {
            ...
            acceptedAnswer: { '@type': 'Answer', text: 'Open-Source-Modelle (LLaMA 3.1, Mistral Large, Qwen 2.5) und proprietäre Modelle (GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro) stehen vor identischen strukturellen Einschränkungen — Wissens-Cutoffs, Halluzination, Kontextfenster, Schlussfolgerungsbeschränkungen. Die Unterschiede liegen im Schweregrad und den Kosten: Proprietäre Modelle haben typischerweise größere Kontexte (Gemini 3.1 Pro: 2M Tokens vs. Mistral: 128K), besseres Instruktions-Following und häufigere Trainingsupdates. Open-Source-Modelle tauschen Fähigkeiten gegen Kosten und Deployment-Kontrolle. Keine Kategorie eliminiert eine der acht Einschränkungen.' },
          },
        ],
      },
      gammaEmbedUrl: '/presentations/ai-limitations-what-llms-cant-do-static.html',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Kontextfenster begrenzen jede Sitzung: GPT-4o 128K, Claude Opus 4.7 1M, Gemini 3.1 Pro 2M Tokens',
        ...
        modelLimitsComparison: {
          ...
          columns: ['Einschränkung', 'GPT-4o', 'Claude Opus 4.7', 'Gemini 3.1 Pro', 'Open-Source (LLaMA 3.1)'],
          rows: [
            { 'Einschränkung': 'Wissens-Cutoff', 'GPT-4o': 'Okt. 2024', 'Claude Opus 4.7': 'Anfang 2025', 'Gemini 3.1 Pro': 'Anfang 2025', 'Open-Source (LLaMA 3.1)': 'Je nach Release' },
            { 'Einschränkung': 'Kontextfenster', 'GPT-4o': '128K Tokens', 'Claude Opus 4.7': '1M Tokens', 'Gemini 3.1 Pro': '2M Tokens', 'Open-Source (LLaMA 3.1)': '8K–128K Tokens' },
            { 'Einschränkung': 'Tool Use Qualität', 'GPT-4o': 'Ausgezeichnet', 'Claude Opus 4.7': 'Ausgezeichnet', 'Gemini 3.1 Pro': 'Gut', 'Open-Source (LLaMA 3.1)': 'Variiert' },
            { 'Einschränkung': 'Halluzinationskontrolle', 'GPT-4o': 'Mittel', 'Claude Opus 4.7': 'Stark (markiert Unsicherheit)', 'Gemini 3.1 Pro': 'Mittel', 'Open-Source (LLaMA 3.1)': 'Schwach' },
            { 'Einschränkung': 'Reasoning (erweitert)', 'GPT-4o': 'o3/o4-mini verfügbar', 'Claude Opus 4.7': 'Extended Thinking verfügbar', 'Gemini 3.1 Pro': 'Flash Thinking verfügbar', 'Open-Source (LLaMA 3.1)': 'Begrenzt' },
          ],
        },
        knowledgeCutoff: {
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'Wie unterscheiden sich Wissens-Cutoffs zwischen GPT-4o, Claude und Gemini?', a: 'Stand 2026: OpenAI GPT-4o hat einen Trainings-Cutoff von Oktober 2024; Anthropic Claude Opus 4.7 und Google Gemini 3.1 Pro haben Cutoffs Anfang 2025. Alle drei Modelle können ungenaues Wissen über Ereignisse nahe ihrer Cutoffs haben, da die Trainingsabdeckung der jüngsten Monate spärlich ist.' },
            ...
            { q: 'Wie unterscheiden sich die Einschränkungen zwischen Open-Source- und proprietären Modellen im Jahr 2026?', a: 'Open-Source-Modelle (LLaMA 3.1, Mistral Large, Qwen 2.5) und proprietäre Modelle (GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro) stehen vor identischen strukturellen Einschränkungen — Wissens-Cutoffs, Halluzination, Kontextfenster, Schlussfolgerungsbeschränkungen. Die Unterschiede liegen im Schweregrad und den Kosten: Proprietäre Modelle haben typischerweise größere Kontexte (Gemini 3.1 Pro: 2M Tokens vs. Mistral: 128K), besseres Instruktions-Following und häufigere Trainingsupdates. Open-Source-Modelle tauschen Fähigkeiten gegen Kosten und Deployment-Kontrolle. Keine Kategorie eliminiert eine der acht Einschränkungen.' },
          ],
        },
        sources: {
    ...
    fr: {
      ...
      intro: 'Les grands modèles de langage ont huit limites structurelles qu\'aucun fine-tuning, mise à l\'échelle ou ingénierie des prompts ne peut éliminer : pas d\'accès en temps réel, hallucinations, raisonnement multi-étapes peu fiable, limites de contexte, pas de mémoire, pas d\'actions, biais d\'entraînement et impossibilité de vérifier les sorties. Chaque modèle — GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro et les alternatives open-source — partage ces contraintes. Ce guide couvre chaque limite avec le contournement technique qui fonctionne en production.',
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 4, name: 'Limites de la fenêtre de contexte', description: 'Cause : l\'attention du transformer a une limite stricte de tokens. Sévérité : moyenne pour les longs documents. Limites : GPT-4o 128K, Claude Opus 4.7 1M, Gemini 3.1 Pro 2M tokens. Solution : RAG, découpage, résumé.' },
          ...
          { '@type': 'ListItem', position: 6, name: 'Absence de capacité d\'action réelle', description: 'Cause : les LLMs ne produisent que du texte par défaut. Sévérité : élevée pour les tâches autonomes. Solution : utilisation d\'outils disponible dans GPT-4o, Claude Opus 4.7 et Gemini 3.1 Pro.' },
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: { '@type': 'Answer', text: 'Les modèles open-source (LLaMA 3.1, Mistral Large, Qwen 2.5) et propriétaires (GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro) font face à des limitations structurelles identiques — coupures de connaissance, hallucination, fenêtres de contexte, contraintes de raisonnement. Les différences résident dans la sévérité et le coût : les modèles propriétaires ont généralement des contextes plus grands (Gemini 3.1 Pro : 2M tokens vs Mistral : 128K), un meilleur suivi des instructions et des mises à jour d\'entraînement plus fréquentes. Les modèles open-source échangent des capacités contre le coût et le contrôle du déploiement. Aucune catégorie n\'élimine l\'une des huit limitations.' },
          },
        ],
      },
      gammaEmbedUrl: '/presentations/ai-limitations-what-llms-cant-do-static.html',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Les fenêtres de contexte limitent chaque session : GPT-4o 128K, Claude Opus 4.7 1M, Gemini 3.1 Pro 2M tokens',
        ...
        modelLimitsComparison: {
          ...
          columns: ['Limitation', 'GPT-4o', 'Claude Opus 4.7', 'Gemini 3.1 Pro', 'Open-Source (LLaMA 3.1)'],
          rows: [
            { 'Limitation': 'Coupure de connaissance', 'GPT-4o': 'Oct. 2024', 'Claude Opus 4.7': 'Début 2025', 'Gemini 3.1 Pro': 'Début 2025', 'Open-Source (LLaMA 3.1)': 'Varie selon la version' },
            { 'Limitation': 'Fenêtre contextuelle', 'GPT-4o': '128K tokens', 'Claude Opus 4.7': '1M tokens', 'Gemini 3.1 Pro': '2M tokens', 'Open-Source (LLaMA 3.1)': '8K–128K tokens' },
            { 'Limitation': 'Qualité des outils', 'GPT-4o': 'Excellente', 'Claude Opus 4.7': 'Excellente', 'Gemini 3.1 Pro': 'Bonne', 'Open-Source (LLaMA 3.1)': 'Variable' },
            { 'Limitation': 'Gestion des hallucinations', 'GPT-4o': 'Modérée', 'Claude Opus 4.7': 'Forte (signale l\'incertitude)', 'Gemini 3.1 Pro': 'Modérée', 'Open-Source (LLaMA 3.1)': 'Faible' },
            { 'Limitation': 'Raisonnement étendu', 'GPT-4o': 'o3/o4-mini disponible', 'Claude Opus 4.7': 'Extended thinking disponible', 'Gemini 3.1 Pro': 'Flash Thinking disponible', 'Open-Source (LLaMA 3.1)': 'Limité' },
          ],
        },
        knowledgeCutoff: {
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'Comment les limitations diffèrent-elles entre les modèles open-source et propriétaires en 2026 ?', a: 'Les modèles open-source (LLaMA 3.1, Mistral Large, Qwen 2.5) et propriétaires (GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro) font face à des limitations structurelles identiques — coupures de connaissance, hallucination, fenêtres de contexte, contraintes de raisonnement. Les différences résident dans la sévérité et le coût : les modèles propriétaires ont généralement des contextes plus grands (Gemini 3.1 Pro : 2M tokens vs Mistral : 128K), un meilleur suivi des instructions et des mises à jour d\'entraînement plus fréquentes. Les modèles open-source échangent des capacités contre le coût et le contrôle du déploiement. Aucune catégorie n\'élimine l\'une des huit limitations.' },
          ],
        },
        sources: {
  ...
  intro: '大規模言語モデルには、ファインチューニング、スケーリング、プロンプトエンジニアリングのいずれによっても排除できない8つの硬い制限があります：リアルタイムデータへのアクセス不可、幻覚、不安定な複数ステップ推論、コンテキストウィンドウの上限、記憶なし、現実世界のアクション不可、学習バイアス、自己検証の不可能性。すべてのモデル — GPT-4o、Claude Opus 4.7、Gemini 3.1 Proとオープンソースの代替品 — がこれらの構造的制約を共有しています。このガイドでは、各制限について本番環境で機能するエンジニアリング上の回避策と合わせて説明します。',
  metaDescription: 'ローカルLLMはGPT-4oやClaudeと同じ8つの構造的限界を共有：知識カットオフ、幻覚、リアルタイムデータアクセス不可、コンテキスト窓、永続メモリなし、自動検証不可。各制約の実装ワークアラウンドを詳説。',
  publishDate: '2026-03-24',
  ...
  itemListSchema: {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 4, name: 'コンテキストウィンドウ制限', description: '根本原因：トランスフォーマーアテンションに硬いトークンキャップがある。重大度：長いドキュメント対して中程度。コンテキスト制限：GPT-4o 128K、Claude Opus 4.7 1M、Gemini 3.1 Pro 2Mトークン。回避方法：RAG、チャンキング、要約。' },
      ...
      { '@type': 'ListItem', position: 6, name: '実世界のアクション機能がない', description: '根本原因：LLMはデフォルトではテキストのみを出力する。重大度：自律的なタスク対して高い。回避方法：GPT-4o、Claude Opus 4.7、Gemini 3.1 Proで利用可能なツール使用/関数呼び出し。' },
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: 'LLMはリアルタイムデータにアクセスできず、独自の出力を検証できず、セッション間でメモリを保持できず、ツールスキャフォルディングなしで実世界のアクションを実行できず、chain-of-thoughtプロンプトなしで複数ステップのロジックを確実に推論できません。これらは、すべてのモデル（GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro、およびオープンソースの代替案など）に適用される構造的な制限です。' },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: '2026年現在：OpenAI GPT-4oは2024年10月のトレーニングカットオフを持っています。Anthropic Claude Opus 4.7とGoogle Gemini 3.1 Proは2025年初頭のカットオフを持っています。3つのモデルすべてが、最近数か月のトレーニング情報が希薄であるため、カットオフに近いイベントについて不正確な知識を持つ可能性があります。' },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: 'どのモデルも8つの構造的な制限のいずれかを排除することはできません — これらはトランスフォーマーアーキテクチャに普遍的です。Gemini 3.1 Proは最大のコンテキストウィンドウ（200万トークン）を持ち、制限4を最よく緩和します。Claude Opus 4.7は不確実性を回避し、知識カットオフを最も確実に認め、幻覚リスクを緩和します。GPT-4oはツール使用（制限6の回避）で優れています。「最も制限が少ない」モデルではなく、特定の制限のボトルネックに基づいて選択してください。' },
      },
      {
        '@type': 'Question',
        name: '2026年のオープンソースと専有モデル間で制限はどのように異なりますか?',
        acceptedAnswer: { '@type': 'Answer', text: 'オープンソースモデル（LLaMA 3.1、Mistral Large、Qwen 2.5）と専有モデル（GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro）は、同じ構造的な制限（知識カットオフ、幻覚、コンテキストウィンドウ、推論の制約）に直面しています。違いは重大度とコストにあります：専有モデルは通常、より大きなコンテキスト（Gemini 3.1 Pro：2Mトークン対Mistral：128K）、より良い指示追従、およびより頻繁なトレーニング更新を持っています。オープンソースモデルは、コストと展開制御のための能力をトレードします。どのカテゴリも8つの制限のいずれかを排除しません。' },
      },
    ],
  },
  gammaEmbedUrl: '/presentations/ai-limitations-what-llms-cant-do-static.html',
  ...
  sections: {
    tldr: {
      ...
      items: [
        ...
        'コンテキストウィンドウはすべてのセッションを上限に制限します：GPT-4o 128K、Claude Opus 4.7 1M、Gemini 3.1 Pro 2Mトークン',
    ...
    modelLimitsComparison: {
      ...
      columns: ['制限', 'GPT-4o', 'Claude Opus 4.7', 'Gemini 3.1 Pro', 'オープンソース (LLaMA 3.1)'],
      rows: [
        { '制限': '知識カットオフ', 'GPT-4o': '2024年10月', 'Claude Opus 4.7': '2025年初頭', 'Gemini 3.1 Pro': '2025年初頭', 'オープンソース (LLaMA 3.1)': 'リリースにより異なる' },
        { '制限': 'コンテキストウィンドウ', 'GPT-4o': '128Kトークン', 'Claude Opus 4.7': '1Mトークン', 'Gemini 3.1 Pro': '200万トークン', 'オープンソース (LLaMA 3.1)': '8K〜128Kトークン' },
        { '制限': 'ツール使用品質', 'GPT-4o': '優秀', 'Claude Opus 4.7': '優秀', 'Gemini 3.1 Pro': '良好', 'オープンソース (LLaMA 3.1)': '様々' },
        { '制限': '幻覚への対処', 'GPT-4o': '普通', 'Claude Opus 4.7': '強い（不確実性を明示）', 'Gemini 3.1 Pro': '普通', 'オープンソース (LLaMA 3.1)': '弱い' },
        { '制限': '拡張推論', 'GPT-4o': 'o3/o4-mini利用可能', 'Claude Opus 4.7': 'Extended thinking利用可能', 'Gemini 3.1 Pro': 'Flash Thinking利用可能', 'オープンソース (LLaMA 3.1)': '限定的' },
      ],
    },
    knowledgeCutoff: {
    ...
    faq: {
      title: 'よくある質問',
      faqs: [
        { q: 'LLMができない主なことは何ですか?', a: 'LLMはリアルタイムデータにアクセスできず、独自の出力を検証できず、セッション間でメモリを保持できず、ツールスキャフォルディングなしで実世界のアクションを実行できず、chain-of-thoughtプロンプトなしで複数ステップのロジックを確実に推論できません。これらは、すべてのモデル（GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro、およびオープンソースの代替案など）に適用される構造的な制限です。' },
        ...
        { q: 'GPT-4o、Claude、Geminiの知識カットオフはどのように異なりますか?', a: '2026年現在：OpenAI GPT-4oは2024年10月のトレーニングカットオフを持っています。Anthropic Claude Opus 4.7とGoogle Gemini 3.1 Proは2025年初頭のカットオフを持っています。3つのモデルすべてが、最近数か月のトレーニング情報が希薄であるため、カットオフに近いイベントについて不正確な知識を持つ可能性があります。' },
        ...
        { q: '最も制限が少ないLLMはどれですか?', a: 'どのモデルも8つの構造的な制限のいずれかを排除することはできません — これらはトランスフォーマーアーキテクチャに普遍的です。Gemini 3.1 Proは最大のコンテキストウィンドウ（200万トークン）を持ち、制限4を最よく緩和します。Claude Opus 4.7は不確実性を回避し、知識カットオフを最も確実に認め、幻覚リスクを緩和します。GPT-4oはツール使用（制限6の回避）で優れています。「最も制限が少ない」モデルではなく、特定の制限のボトルネックに基づいて選択してください。' },
        { q: '2026年のオープンソースと専有モデル間で制限はどのように異なりますか?', a: 'オープンソースモデル（LLaMA 3.1、Mistral Large、Qwen 2.5）と専有モデル（GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro）は、同じ構造的な制限（知識カットオフ、幻覚、コンテキストウィンドウ、推論の制約）に直面しています。違いは重大度とコストにあります：専有モデルは通常、より大きなコンテキスト（Gemini 3.1 Pro：2Mトークン対Mistral：128K）、より良い指示追従、およびより頻繁なトレーニング更新を持っています。オープンソースモデルは、コストと展開制御のための能力をトレードします。どのカテゴリも8つの制限のいずれかを排除しません。' },
      ],
    },
    sources: {
      title: 'ソースと参考資料',
...
zh: {
      ...
      intro: '大语言模型有八个硬性限制，无论是微调、扩展规模还是提示工程都无法消除：无法访问实时数据、产生幻觉、多步骤推理不可靠、上下文窗口上限、无持久记忆、无现实世界行动能力、训练偏差以及无法自我验证输出。每个模型——GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro以及开源替代方案——都共享这些结构性限制。本指南涵盖每个限制及其在生产环境中可行的工程解决方案。',
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 4, name: '上下文窗口限制', description: '根本原因：transformer 注意力有硬令牌上限。严重程度：对长文档为中等。上下文上限：GPT-4o 128K、Claude Opus 4.7 1M、Gemini 3.1 Pro 2M 令牌。解决方案：RAG、分块、摘要。' },
          { '@type': 'ListItem', position: 5, name: '无持久内存', description: '根本原因：无状态架构 — 每个会话从空白上下文开始。严重程度：对多会话工作流为中等。解决方案：使用向量数据库或对话摘要的应用层内存注入。' },
          { '@type': 'ListItem', position: 6, name: '无现实世界操作能力', description: '根本原因：大语言模型默认仅输出文本。严重程度：对自主任务为高。解决方案：在 GPT-4o、Claude Opus 4.7 和 Gemini 3.1 Pro 中可用的工具使用/函数调用。' },
        ...
        mainEntity: [
          {
            '@type': 'Question',
            name: '大语言模型主要无法做什么？',
            acceptedAnswer: { '@type': 'Answer', text: '大语言模型无法获取实时数据、验证自己的输出、在会话间保留内存、在没有工具支架的情况下采取现实世界的操作，或在没有思维链提示词的情况下可靠地进行多步逻辑推理。这些是适用于每个模型的结构性限制 — GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro 和开源替代品。' },
          },
          {
            '@type': 'Question',
            name: '为什么大语言模型会产生幻觉？',
          ...
          },
          {
            ...
            acceptedAnswer: { '@type': 'Answer', text: '截至 2026 年：OpenAI GPT-4o 的训练截断为 2024 年 10 月；Anthropic Claude Opus 4.7 和 Google Gemini 3.1 Pro 的截断为 2025 年初。所有三个模型可能对接近其截断日期的事件有不精确的知识，因为最近几个月的训练覆盖很少。' },
          },
          {
            '@type': 'Question',
          ...
          },
          {
            '@type': 'Question',
            name: '哪个大语言模型的局限性最少？',
            acceptedAnswer: { '@type': 'Answer', text: '没有模型消除这八个结构性限制中的任何一个 — 它们对 transformer 架构是通用的。Gemini 3.1 Pro 拥有最大的上下文窗口（200 万令牌），最好地缓解了限制 4。Claude Opus 4.7 最可靠地对冲不确定性并承认知识截断，缓解了幻觉风险。GPT-4o 在工具使用（限制 6 解决方案）上表现出色。根据您的特定限制瓶颈选择，而不是哪个模型"最不受限制"。' },
          },
          {
            '@type': 'Question',
            name: '2026 年开源和专有模型之间的局限性如何不同？',
            acceptedAnswer: { '@type': 'Answer', text: '开源模型（LLaMA 3.1、Mistral Large、Qwen 2.5）和专有模型（GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro）面临相同的结构性限制 — 知识截断、幻觉、上下文窗口、推理约束。区别在于严重程度和成本：专有模型通常有更大的上下文（Gemini 3.1 Pro：200 万令牌 vs Mistral：128K）、更好的指令遵循和更频繁的训练更新。开源模型以成本和部署控制为代价换取功能。两个类别都不消除这八个限制中的任何一个。' },
          },
        ],
      },
      gammaEmbedUrl: '/presentations/ai-limitations-what-llms-cant-do-static.html',
      ...
      sections: {
        ...
        modelLimitsComparison: {
          ...
          columns: ['限制', 'GPT-4o', 'Claude Opus 4.7', 'Gemini 3.1 Pro', '开源 (LLaMA 3.1)'],
          rows: [
            { '限制': '知识截止日期', 'GPT-4o': '2024年10月', 'Claude Opus 4.7': '2025年初', 'Gemini 3.1 Pro': '2025年初', '开源 (LLaMA 3.1)': '因版本而异' },
            { '限制': '上下文窗口', 'GPT-4o': '128K tokens', 'Claude Opus 4.7': '1M tokens', 'Gemini 3.1 Pro': '200万 tokens', '开源 (LLaMA 3.1)': '8K–128K tokens' },
            { '限制': '工具调用质量', 'GPT-4o': '优秀', 'Claude Opus 4.7': '优秀', 'Gemini 3.1 Pro': '良好', '开源 (LLaMA 3.1)': '参差不齐' },
            { '限制': '幻觉处理', 'GPT-4o': '一般', 'Claude Opus 4.7': '强（会标注不确定性）', 'Gemini 3.1 Pro': '一般', '开源 (LLaMA 3.1)': '较弱' },
            { '限制': '扩展推理', 'GPT-4o': 'o3/o4-mini可用', 'Claude Opus 4.7': 'Extended thinking可用', 'Gemini 3.1 Pro': 'Flash Thinking可用', '开源 (LLaMA 3.1)': '有限' },
          ],
        },
        knowledgeCutoff: {
        ...
        faq: {
          title: '常见问题',
          faqs: [
            { q: '大语言模型主要无法做什么？', a: '大语言模型无法获取实时数据、验证自己的输出、在会话间保留内存、在没有工具支架的情况下采取现实世界的操作，或在没有思维链提示词的情况下可靠地进行多步逻辑推理。这些是适用于每个模型的结构性限制 — GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro 和开源替代品。' },
            ...
            { q: 'GPT-4o、Claude 和 Gemini 的知识截断如何不同？', a: '截至 2026 年：OpenAI GPT-4o 的训练截断为 2024 年 10 月；Anthropic Claude Opus 4.7 和 Google Gemini 3.1 Pro 的截断为 2025 年初。所有三个模型可能对接近其截断日期的事件有不精确的知识，因为最近几个月的训练覆盖很少。' },
            ...
            { q: '哪个大语言模型的局限性最少？', a: '没有模型消除这八个结构性限制中的任何一个 — 它们对 transformer 架构是通用的。Gemini 3.1 Pro 拥有最大的上下文窗口（200 万令牌），最好地缓解了限制 4。Claude Opus 4.7 最可靠地对冲不确定性并承认知识截断，缓解了幻觉风险。GPT-4o 在工具使用（限制 6 解决方案）上表现出色。根据您的特定限制瓶颈选择，而不是哪个模型"最不受限制"。' },
            { q: '2026 年开源和专有模型之间的局限性如何不同？', a: '开源模型（LLaMA 3.1、Mistral Large、Qwen 2.5）和专有模型（GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro）面临相同的结构性限制 — 知识截断、幻觉、上下文窗口、推理约束。区别在于严重程度和成本：专有模型通常有更大的上下文（Gemini 3.1 Pro：200 万令牌 vs Mistral：128K）、更好的指令遵循和更频繁的训练更新。开源模型以成本和部署控制为代价换取功能。两个类别都不消除这八个限制中的任何一个。' },
          ],
        },
        sources: {
          title: '来源和进一步阅读',
