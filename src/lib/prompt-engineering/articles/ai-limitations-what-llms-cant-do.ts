...
export const article: Record<Language, PEArticle> = {
    en: {
      ...
      seoTitle: 'What LLMs Still Can\'t Do in 2026: 8 Structural Limits',
      metaDescription: 'LLMs can\'t access real-time data, verify outputs, or reason reliably. 8 structural limits for GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro — with workarounds.',
      ...
      sections: {
        ...
        modelLimitsComparison: {
          ...
          rows: [
            ...
            { 'Limitation': 'Context window', 'GPT-5.5': '128K tokens', 'Claude Opus 4.7': '200K tokens', 'Gemini 3.1 Pro': '2M tokens', 'Open-Source (LLaMA 3.1)': '8K–128K tokens' },
    ...
    de: {
      ...
      metaDescription: 'LLMs können nicht auf Echtzeitdaten zugreifen, Ausgaben prüfen oder zuverlässig schlussfolgern. 8 Grenzen für GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro.',
      publishDate: '2026-03-24',
      seoTitle: 'Was LLMs 2026 noch nicht können: 8 strukturelle Grenzen',
      dateModified: '2026-05-01',
      ...
      sections: {
        ...
        modelLimitsComparison: {
          ...
          rows: [
            ...
            { 'Einschränkung': 'Kontextfenster', 'GPT-5.5': '128K Tokens', 'Claude Opus 4.7': '200K Tokens', 'Gemini 3.1 Pro': '2M Tokens', 'Open-Source (LLaMA 3.1)': '8K–128K Tokens' },
    ...
    fr: {
      ...
      metaDescription: 'Les LLMs ne peuvent pas accéder aux données en temps réel, vérifier les sorties ou raisonner. 8 limites pour GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro.',
      publishDate: '2026-03-24',
      seoTitle: 'Limitations des LLMs 2026 : 8 choses qu\'ils ne font pas',
      dateModified: '2026-05-01',
      ...
      sections: {
        ...
        modelLimitsComparison: {
          ...
          rows: [
            ...
            { 'Limitation': 'Fenêtre contextuelle', 'GPT-5.5': '128K tokens', 'Claude Opus 4.7': '200K tokens', 'Gemini 3.1 Pro': '2M tokens', 'Open-Source (LLaMA 3.1)': '8K–128K tokens' },
  ...
  metaDescription: 'LLMはリアルタイムデータにアクセスできず、出力を検証できず、複数ステップの推論も不可。GPT-5.5、Claude Opus 4.7、Gemini 3.1 Proに共通する8つの構造的制限と回避策を解説。',
  publishDate: '2026-03-24',
  ...
  sections: {
    ...
    modelLimitsComparison: {
      ...
      rows: [
        ...
        { '制限': 'コンテキストウィンドウ', 'GPT-5.5': '128Kトークン', 'Claude Opus 4.7': '200Kトークン', 'Gemini 3.1 Pro': '200万トークン', 'オープンソース (LLaMA 3.1)': '8K〜128Kトークン' },
...
zh: {
      ...
      metaDescription: '大语言模型无法访问实时数据、验证输出或可靠推理。GPT-5.5、Claude Opus 4.7、Gemini 3.1 Pro共有的8个结构性限制及已验证的解决方案。',
      publishDate: '2026-03-24',
      ...
      sections: {
        ...
        modelLimitsComparison: {
          ...
          rows: [
            ...
            { '限制': '上下文窗口', 'GPT-5.5': '128K tokens', 'Claude Opus 4.7': '200K tokens', 'Gemini 3.1 Pro': '200万 tokens', '开源 (LLaMA 3.1)': '8K–128K tokens' },
