...
export const article: Record<Language, PEArticle> = {
    en: {
      ...
      intro: 'Large language models have eight hard limits that no amount of fine-tuning, scaling, or prompt engineering can eliminate: no real-time data, confident hallucinations, weak multi-step reasoning, context window caps, no memory, no real-world actions, training bias, and no self-verification. Every model — GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro, and open-source alternatives — shares these structural constraints. This guide covers each limit with the engineering workaround that works in production.',
      publishDate: '2026-03-24',
      seoTitle: 'Local LLM Limitations in 2026: 8 Structural Constraints',
      metaDescription: 'Local LLMs face the same 8 structural limits as GPT-4o and Claude: knowledge cutoffs, hallucination, no real-time data, context caps, no memory, no actions, bias, and no self-verification. How to work around each.',
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 4, name: 'Context window limits', description: 'Root cause: transformer attention has a hard token cap. Severity: medium for long documents. Context caps: GPT-5.5 128K, Claude Opus 4.7 1M, Gemini 3.1 Pro 2M tokens. Workaround: RAG, chunking, summarization.' },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Context windows cap every session: GPT-5.5 128K, Claude Opus 4.7 1M, Gemini 3.1 Pro 2M tokens',
        ...
        modelLimitsComparison: {
          ...
          columns: ['Limitation', 'GPT-5.5', 'Claude Opus 4.7', 'Gemini 3.1 Pro', 'Open-Source (LLaMA 3.1)'],
          rows: [
            { 'Limitation': 'Knowledge cutoff', 'GPT-5.5': 'Oct 2024', 'Claude Opus 4.7': 'Early 2025', 'Gemini 3.1 Pro': 'Early 2025', 'Open-Source (LLaMA 3.1)': 'Varies by release' },
            { 'Limitation': 'Context window', 'GPT-5.5': '128K tokens', 'Claude Opus 4.7': '1M tokens', 'Gemini 3.1 Pro': '2M tokens', 'Open-Source (LLaMA 3.1)': '8K–128K tokens' },
            { 'Limitation': 'Tool use quality', 'GPT-5.5': 'Excellent', 'Claude Opus 4.7': 'Excellent', 'Gemini 3.1 Pro': 'Good', 'Open-Source (LLaMA 3.1)': 'Varies' },
            { 'Limitation': 'Hallucination handling', 'GPT-5.5': 'Moderate', 'Claude Opus 4.7': 'Strong (flags uncertainty)', 'Gemini 3.1 Pro': 'Moderate', 'Open-Source (LLaMA 3.1)': 'Weak' },
            { 'Limitation': 'Reasoning (extended)', 'GPT-5.5': 'o3/o4-mini available', 'Claude Opus 4.7': 'Extended thinking available', 'Gemini 3.1 Pro': 'Flash Thinking available', 'Open-Source (LLaMA 3.1)': 'Limited' },
          ],
        },
        knowledgeCutoff: {
        ...
        keyTerms: {
          ...
          items: [
            ...
            '**[Context Window](/prompt-engineering/prompt-engineering-glossary#core-concepts)** — The maximum number of tokens (words + punctuation) the model can process at once, including system prompt, conversation history, and retrieved documents. GPT-5.5: 128K tokens; Claude Opus 4.7: 1M; Gemini 3.1 Pro: 2M.',
    ...
    de: {
      ...
      intro: 'Große Sprachmodelle haben acht harte Grenzen, die kein Fine-Tuning, kein Skalieren und kein Prompt Engineering beseitigen kann: kein Echtzeitzugriff, Halluzinationen, schwaches mehrstufiges Reasoning, Kontextfenster-Limits, kein Gedächtnis, keine Aktionen, Trainingsbias und keine Selbstverifikation. Jedes Modell — GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro und Open-Source-Alternativen — teilt diese strukturellen Einschränkungen. Dieser Leitfaden behandelt jede Grenze mit dem Engineering-Workaround, der in der Praxis funktioniert.',
      metaDescription: 'Lokale LLMs haben die gleichen 8 Grenzen wie GPT-5.5 und Claude: Wissenscutoff, Halluzinationen, kein Echtzeitwissen, Kontextfenster, kein Speicher, keine Aktionen, Bias und keine Selbstprüfung. Mit bewährten Workarounds.',
      publishDate: '2026-03-24',
      seoTitle: 'Lokale LLMs 2026: 8 Strukturelle Grenzen und Lösungen',
      dateModified: '2026-05-01',
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 4, name: 'Kontextfenster-Grenzen', description: 'Ursache: Transformer-Attention hat ein hartes Token-Limit. Schweregrad: mittel für lange Dokumente. Kontextlimits: GPT-5.5 128K, Claude Opus 4.7 1M, Gemini 3.1 Pro 2M Tokens. Workaround: RAG, Chunking, Zusammenfassung.' },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Kontextfenster begrenzen jede Sitzung: GPT-5.5 128K, Claude Opus 4.7 1M, Gemini 3.1 Pro 2M Tokens',
        ...
        modelLimitsComparison: {
          ...
          columns: ['Einschränkung', 'GPT-5.5', 'Claude Opus 4.7', 'Gemini 3.1 Pro', 'Open-Source (LLaMA 3.1)'],
          rows: [
            { 'Einschränkung': 'Wissens-Cutoff', 'GPT-5.5': 'Okt. 2024', 'Claude Opus 4.7': 'Anfang 2025', 'Gemini 3.1 Pro': 'Anfang 2025', 'Open-Source (LLaMA 3.1)': 'Je nach Release' },
            { 'Einschränkung': 'Kontextfenster', 'GPT-5.5': '128K Tokens', 'Claude Opus 4.7': '1M Tokens', 'Gemini 3.1 Pro': '2M Tokens', 'Open-Source (LLaMA 3.1)': '8K–128K Tokens' },
            { 'Einschränkung': 'Tool Use Qualität', 'GPT-5.5': 'Ausgezeichnet', 'Claude Opus 4.7': 'Ausgezeichnet', 'Gemini 3.1 Pro': 'Gut', 'Open-Source (LLaMA 3.1)': 'Variiert' },
            { 'Einschränkung': 'Halluzinationskontrolle', 'GPT-5.5': 'Mittel', 'Claude Opus 4.7': 'Stark (markiert Unsicherheit)', 'Gemini 3.1 Pro': 'Mittel', 'Open-Source (LLaMA 3.1)': 'Schwach' },
            { 'Einschränkung': 'Reasoning (erweitert)', 'GPT-5.5': 'o3/o4-mini verfügbar', 'Claude Opus 4.7': 'Extended Thinking verfügbar', 'Gemini 3.1 Pro': 'Flash Thinking verfügbar', 'Open-Source (LLaMA 3.1)': 'Begrenzt' },
          ],
        },
        knowledgeCutoff: {
    ...
    fr: {
      ...
      intro: 'Les grands modèles de langage ont huit limites structurelles qu\'aucun fine-tuning, mise à l\'échelle ou ingénierie des prompts ne peut éliminer : pas d\'accès en temps réel, hallucinations, raisonnement multi-étapes peu fiable, limites de contexte, pas de mémoire, pas d\'actions, biais d\'entraînement et impossibilité de vérifier les sorties. Chaque modèle — GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro et les alternatives open-source — partage ces contraintes. Ce guide couvre chaque limite avec le contournement technique qui fonctionne en production.',
      metaDescription: 'Les LLMs locaux font face aux mêmes 8 limites que GPT-5.5 et Claude : connaissances périmées, hallucinations, données non-temps réel, fenêtres de contexte, pas de mémoire, pas d\'actions. Contournements vérifiés inclus.',
      publishDate: '2026-03-24',
      seoTitle: 'Limitations des LLMs Locaux 2026 : 8 Défis Structurels',
      dateModified: '2026-05-01',
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 4, name: 'Limites de la fenêtre de contexte', description: 'Cause : l\'attention du transformer a une limite stricte de tokens. Sévérité : moyenne pour les longs documents. Limites : GPT-5.5 128K, Claude Opus 4.7 1M, Gemini 3.1 Pro 2M tokens. Solution : RAG, découpage, résumé.' },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Les fenêtres de contexte limitent chaque session : GPT-5.5 128K, Claude Opus 4.7 1M, Gemini 3.1 Pro 2M tokens',
        ...
        modelLimitsComparison: {
          ...
          columns: ['Limitation', 'GPT-5.5', 'Claude Opus 4.7', 'Gemini 3.1 Pro', 'Open-Source (LLaMA 3.1)'],
          rows: [
            { 'Limitation': 'Coupure de connaissance', 'GPT-5.5': 'Oct. 2024', 'Claude Opus 4.7': 'Début 2025', 'Gemini 3.1 Pro': 'Début 2025', 'Open-Source (LLaMA 3.1)': 'Varie selon la version' },
            { 'Limitation': 'Fenêtre contextuelle', 'GPT-5.5': '128K tokens', 'Claude Opus 4.7': '1M tokens', 'Gemini 3.1 Pro': '2M tokens', 'Open-Source (LLaMA 3.1)': '8K–128K tokens' },
            { 'Limitation': 'Qualité des outils', 'GPT-5.5': 'Excellente', 'Claude Opus 4.7': 'Excellente', 'Gemini 3.1 Pro': 'Bonne', 'Open-Source (LLaMA 3.1)': 'Variable' },
            { 'Limitation': 'Gestion des hallucinations', 'GPT-5.5': 'Modérée', 'Claude Opus 4.7': 'Forte (signale l\'incertitude)', 'Gemini 3.1 Pro': 'Modérée', 'Open-Source (LLaMA 3.1)': 'Faible' },
            { 'Limitation': 'Raisonnement étendu', 'GPT-5.5': 'o3/o4-mini disponible', 'Claude Opus 4.7': 'Extended thinking disponible', 'Gemini 3.1 Pro': 'Flash Thinking disponible', 'Open-Source (LLaMA 3.1)': 'Limité' },
          ],
        },
        knowledgeCutoff: {
  ...
  intro: '大規模言語モデルには、ファインチューニング、スケーリング、プロンプトエンジニアリングのいずれによっても排除できない8つの硬い制限があります：リアルタイムデータへのアクセス不可、幻覚、不安定な複数ステップ推論、コンテキストウィンドウの上限、記憶なし、現実世界のアクション不可、学習バイアス、自己検証の不可能性。すべてのモデル — GPT-5.5、Claude Opus 4.7、Gemini 3.1 Proとオープンソースの代替品 — がこれらの構造的制約を共有しています。このガイドでは、各制限について本番環境で機能するエンジニアリング上の回避策と合わせて説明します。',
  metaDescription: 'ローカルLLMはGPT-5.5やClaudeと同じ8つの構造的限界を共有：知識カットオフ、幻覚、リアルタイムデータアクセス不可、コンテキスト窓、永続メモリなし、自動検証不可。各制約の実装ワークアラウンドを詳説。',
  publishDate: '2026-03-24',
  seoTitle: 'ローカルLLM制限2026：8つの構造的制約と回避策',
  dateModified: '2026-05-01',
  readTime: '11分で読める',
  educationalLevel: 'Intermediate',
  primaryTerm: 'AI制限',
  ...
  itemListSchema: {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 4, name: 'コンテキストウィンドウ制限', description: '根本原因：トランスフォーマーアテンションに硬いトークンキャップがある。重大度：長いドキュメント対して中程度。コンテキスト制限：GPT-5.5 128K、Claude Opus 4.7 1M、Gemini 3.1 Pro 2Mトークン。回避方法：RAG、チャンキング、要約。' },
  ...
  sections: {
    tldr: {
      ...
      items: [
        ...
        'コンテキストウィンドウはすべてのセッションを上限に制限します：GPT-5.5 128K、Claude Opus 4.7 1M、Gemini 3.1 Pro 2Mトークン',
    ...
    modelLimitsComparison: {
      ...
      columns: ['制限', 'GPT-5.5', 'Claude Opus 4.7', 'Gemini 3.1 Pro', 'オープンソース (LLaMA 3.1)'],
      rows: [
        { '制限': '知識カットオフ', 'GPT-5.5': '2024年10月', 'Claude Opus 4.7': '2025年初頭', 'Gemini 3.1 Pro': '2025年初頭', 'オープンソース (LLaMA 3.1)': 'リリースにより異なる' },
        { '制限': 'コンテキストウィンドウ', 'GPT-5.5': '128Kトークン', 'Claude Opus 4.7': '1Mトークン', 'Gemini 3.1 Pro': '200万トークン', 'オープンソース (LLaMA 3.1)': '8K〜128Kトークン' },
        { '制限': 'ツール使用品質', 'GPT-5.5': '優秀', 'Claude Opus 4.7': '優秀', 'Gemini 3.1 Pro': '良好', 'オープンソース (LLaMA 3.1)': '様々' },
        { '制限': '幻覚への対処', 'GPT-5.5': '普通', 'Claude Opus 4.7': '強い（不確実性を明示）', 'Gemini 3.1 Pro': '普通', 'オープンソース (LLaMA 3.1)': '弱い' },
        { '制限': '拡張推論', 'GPT-5.5': 'o3/o4-mini利用可能', 'Claude Opus 4.7': 'Extended thinking利用可能', 'Gemini 3.1 Pro': 'Flash Thinking利用可能', 'オープンソース (LLaMA 3.1)': '限定的' },
      ],
    },
    knowledgeCutoff: {
    ...
    keyTerms: {
      ...
      items: [
        ...
        '**[コンテキストウィンドウ](/prompt-engineering/prompt-engineering-glossary?lang=ja#core-concepts)** — モデルが一度に処理できるトークンの最大数（単語 + 句読点）、システムプロンプト、会話履歴、取得ドキュメントを含む。GPT-5.5：128Kトークン；Claude Opus 4.7：1M；Gemini 3.1 Pro：2M。',
...
zh: {
      ...
      intro: '大语言模型有八个硬性限制，无论是微调、扩展规模还是提示工程都无法消除：无法访问实时数据、产生幻觉、多步骤推理不可靠、上下文窗口上限、无持久记忆、无现实世界行动能力、训练偏差以及无法自我验证输出。每个模型——GPT-5.5、Claude Opus 4.7、Gemini 3.1 Pro以及开源替代方案——都共享这些结构性限制。本指南涵盖每个限制及其在生产环境中可行的工程解决方案。',
      metaDescription: '本地LLM面临与GPT-4o、Claude相同的8项结构限制：知识截断、幻觉生成、实时数据无法访问、上下文窗口限制、无持久记忆、无自验证能力。附验证有效的解决方案。',
      publishDate: '2026-03-24',
      seoTitle: '本地LLM限制2026：8大结构约束',
      dateModified: '2026-05-01',
      readTime: '阅读约11分钟',
      educationalLevel: 'Intermediate',
      primaryTerm: 'AI 局限性',
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 4, name: '上下文窗口限制', description: '根本原因：transformer 注意力有硬令牌上限。严重程度：对长文档为中等。上下文上限：GPT-5.5 128K、Claude Opus 4.7 1M、Gemini 3.1 Pro 2M 令牌。解决方案：RAG、分块、摘要。' },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '上下文窗口限制每个会话：GPT-5.5 128K、Claude Opus 4.7 1M、Gemini 3.1 Pro 200 万令牌',
        ...
        modelLimitsComparison: {
          ...
          columns: ['限制', 'GPT-5.5', 'Claude Opus 4.7', 'Gemini 3.1 Pro', '开源 (LLaMA 3.1)'],
          rows: [
            { '限制': '知识截止日期', 'GPT-5.5': '2024年10月', 'Claude Opus 4.7': '2025年初', 'Gemini 3.1 Pro': '2025年初', '开源 (LLaMA 3.1)': '因版本而异' },
            { '限制': '上下文窗口', 'GPT-5.5': '128K tokens', 'Claude Opus 4.7': '1M tokens', 'Gemini 3.1 Pro': '200万 tokens', '开源 (LLaMA 3.1)': '8K–128K tokens' },
            { '限制': '工具调用质量', 'GPT-5.5': '优秀', 'Claude Opus 4.7': '优秀', 'Gemini 3.1 Pro': '良好', '开源 (LLaMA 3.1)': '参差不齐' },
            { '限制': '幻觉处理', 'GPT-5.5': '一般', 'Claude Opus 4.7': '强（会标注不确定性）', 'Gemini 3.1 Pro': '一般', '开源 (LLaMA 3.1)': '较弱' },
            { '限制': '扩展推理', 'GPT-5.5': 'o3/o4-mini可用', 'Claude Opus 4.7': 'Extended thinking可用', 'Gemini 3.1 Pro': 'Flash Thinking可用', '开源 (LLaMA 3.1)': '有限' },
          ],
        },
        knowledgeCutoff: {
        ...
        keyTerms: {
          ...
          items: [
            ...
            '**[上下文窗口](/prompt-engineering/prompt-engineering-glossary?lang=zh#core-concepts)** — 模型一次可处理的最大令牌数（单词+标点），包括系统提示、对话历史和检索文档。GPT-5.5：128K 令牌；Claude Opus 4.7：1M；Gemini 3.1 Pro：200 万。',
