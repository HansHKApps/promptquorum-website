...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      intro: 'Large language models have eight hard limits that no amount of fine-tuning, scaling, or prompt engineering can eliminate: no real-time data, confident hallucinations, weak multi-step reasoning, context window caps, no memory, no real-world actions, training bias, and no self-verification. Every model — GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro, and open-source alternatives — shares these structural constraints. This guide covers each limit with the engineering workaround that works in production.',
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 4, name: 'Context window limits', description: 'Root cause: transformer attention has a hard token cap. Severity: medium for long documents. Context caps: GPT-4o 128K, Claude Opus 4.8 1M, Gemini 3.1 Pro 2M tokens. Workaround: RAG, chunking, summarization.' },
          ...
          { '@type': 'ListItem', position: 6, name: 'No real-world action capability', description: 'Root cause: LLMs output text only by default. Severity: high for autonomous tasks. Workaround: tool use / function calling available in GPT-4o, Claude Opus 4.8, and Gemini 3.1 Pro.' },
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: { '@type': 'Answer', text: 'Yes. Fine-tuning adjusts style, domain focus, or instruction-following behavior — it does not add real-time data access, true reasoning, or persistent memory. A fine-tuned GPT-4o retains the same knowledge cutoff and hallucination risk as the base model.' },
          },
          {
            '@type': 'Question',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Context windows cap every session: GPT-4o 128K, Claude Opus 4.8 1M, Gemini 3.1 Pro 2M tokens',
        ...
        modelLimitsComparison: {
          ...
          columns: ['Limitation', 'GPT-4o', 'Claude Opus 4.8', 'Gemini 3.1 Pro', 'Open-Source (LLaMA 3.1)'],
          rows: [
            { 'Limitation': 'Knowledge cutoff', 'GPT-4o': 'Oct 2024', 'Claude Opus 4.8': 'Early 2025', 'Gemini 3.1 Pro': 'Early 2025', 'Open-Source (LLaMA 3.1)': 'Varies by release' },
            { 'Limitation': 'Context window', 'GPT-4o': '128K tokens', 'Claude Opus 4.8': '1M tokens', 'Gemini 3.1 Pro': '2M tokens', 'Open-Source (LLaMA 3.1)': '8K–128K tokens' },
            { 'Limitation': 'Tool use quality', 'GPT-4o': 'Excellent', 'Claude Opus 4.8': 'Excellent', 'Gemini 3.1 Pro': 'Good', 'Open-Source (LLaMA 3.1)': 'Varies' },
            { 'Limitation': 'Hallucination handling', 'GPT-4o': 'Moderate', 'Claude Opus 4.8': 'Strong (flags uncertainty)', 'Gemini 3.1 Pro': 'Moderate', 'Open-Source (LLaMA 3.1)': 'Weak' },
            { 'Limitation': 'Reasoning (extended)', 'GPT-4o': 'o3/o4-mini available', 'Claude Opus 4.8': 'Extended thinking available', 'Gemini 3.1 Pro': 'Flash Thinking available', 'Open-Source (LLaMA 3.1)': 'Limited' },
          ],
        },
        knowledgeCutoff: {
          title: 'Limitation 1 — Knowledge Cutoffs and No Real-Time Data',
          content: [
            '**Every LLM has a training cutoff date, and the model has no knowledge of events, prices, papers, or product versions released after that date unless external retrieval is added.** OpenAI GPT-4o has a cutoff of October 2024. Anthropic Claude Opus 4.8 and Google Gemini 3.1 Pro have cutoffs in early 2025.',
        ...
        hallucination: {
          ...
          content: [
            '**LLMs generate statistically plausible tokens, not verified facts — when the training signal for a specific fact is thin, the model produces a confident-sounding fabrication.** This applies to every model including GPT-4o, Claude Opus 4.8, and Gemini 3.1 Pro. For a deep dive, see [AI Hallucinations — Why AI Makes Things Up](/prompt-engineering/ai-hallucinations-why-ai-makes-things-up).',
        ...
        contextWindow: {
          ...
          content: [
            '**Every LLM session has a hard token limit — GPT-4o at 128,000 tokens, Claude Opus 4.8 at 200,000 tokens, Gemini 3.1 Pro at 2,000,000 tokens — and performance on earlier content degrades as the window fills.** See [Context Windows Explained](/prompt-engineering/context-windows-explained-why-ai-forgets) for a full breakdown.',
        ...
        noAction: {
          ...
          content: [
            ...
            'Tool use (also called function calling) — available in GPT-4o, Claude Opus 4.8, and Gemini 3.1 Pro — lets a model output structured function calls that an application intercepts and executes. The model still cannot take action on its own; it can only emit structured text that triggers external execution.',
        ...
        bias: {
          ...
          content: [
            ...
            'This is relevant for international teams: GPT-4o, Claude Opus 4.8, and Gemini 3.1 Pro all produce stronger outputs in English than in lower-resource languages. Technical terminology in niche domains (specific industries, local legal systems, regional dialects) may be poorly represented in training data.',
        ...
        keyTerms: {
          ...
          items: [
            '**[Knowledge Cutoff](/prompt-engineering/prompt-engineering-glossary)** — The date beyond which a model has no training data. Any event, pricing change, or release after this date is invisible to the model unless you paste it into the prompt. GPT-4o: October 2024; Claude Opus 4.8 and Gemini 3.1 Pro: early 2025.',
            ...
            '**[Context Window](/prompt-engineering/prompt-engineering-glossary#core-concepts)** — The maximum number of tokens (words + punctuation) the model can process at once, including system prompt, conversation history, and retrieved documents. GPT-4o: 128K tokens; Claude Opus 4.8: 1M; Gemini 3.1 Pro: 2M.',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'How do limitations differ between open-source and proprietary models in 2026?', a: 'Open-source models (LLaMA 3.1, Mistral Large, Qwen 2.5) and proprietary models (GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro) face identical structural limitations — knowledge cutoffs, hallucination, context windows, reasoning constraints. The differences are in severity and cost: proprietary models typically have larger contexts (Gemini 3.1 Pro: 2M tokens vs. Mistral: 128K), better instruction-following, and more frequent training updates. Open-source models trade capabilities for cost and deployment control. Neither category eliminates any of the eight limitations.' },
          ],
        },
        sources: {
    ...
    de: {
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 4, name: 'Kontextfenster-Grenzen', description: 'Ursache: Transformer-Attention hat ein hartes Token-Limit. Schweregrad: mittel für lange Dokumente. Kontextlimits: GPT-4o 128K, Claude Opus 4.8 1M, Gemini 3.1 Pro 2M Tokens. Workaround: RAG, Chunking, Zusammenfassung.' },
          ...
          { '@type': 'ListItem', position: 6, name: 'Keine Echtwelt-Aktionsfähigkeit', description: 'Ursache: LLMs geben standardmäßig nur Text aus. Schweregrad: hoch für autonome Aufgaben. Workaround: Tool-Use / Function Calling verfügbar in GPT-4o, Claude Opus 4.8 und Gemini 3.1 Pro.' },
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: { '@type': 'Answer', text: 'Open-Source-Modelle (LLaMA 3.1, Mistral Large, Qwen 2.5) und proprietäre Modelle (GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro) stehen vor identischen strukturellen Einschränkungen — Wissens-Cutoffs, Halluzination, Kontextfenster, Schlussfolgerungsbeschränkungen. Die Unterschiede liegen im Schweregrad und den Kosten: Proprietäre Modelle haben typischerweise größere Kontexte (Gemini 3.1 Pro: 2M Tokens vs. Mistral: 128K), besseres Instruktions-Following und häufigere Trainingsupdates. Open-Source-Modelle tauschen Fähigkeiten gegen Kosten und Deployment-Kontrolle. Keine Kategorie eliminiert eine der acht Einschränkungen.' },
          },
        ],
      },
      gammaEmbedUrl: '/presentations/ai-limitations-what-llms-cant-do-static.html',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Kontextfenster begrenzen jede Sitzung: GPT-4o 128K, Claude Opus 4.8 1M, Gemini 3.1 Pro 2M Tokens',
        ...
        modelLimitsComparison: {
          ...
          columns: ['Einschränkung', 'GPT-4o', 'Claude Opus 4.8', 'Gemini 3.1 Pro', 'Open-Source (LLaMA 3.1)'],
          rows: [
            { 'Einschränkung': 'Wissens-Cutoff', 'GPT-4o': 'Okt. 2024', 'Claude Opus 4.8': 'Anfang 2025', 'Gemini 3.1 Pro': 'Anfang 2025', 'Open-Source (LLaMA 3.1)': 'Je nach Release' },
            { 'Einschränkung': 'Kontextfenster', 'GPT-4o': '128K Tokens', 'Claude Opus 4.8': '1M Tokens', 'Gemini 3.1 Pro': '2M Tokens', 'Open-Source (LLaMA 3.1)': '8K–128K Tokens' },
            { 'Einschränkung': 'Tool Use Qualität', 'GPT-4o': 'Ausgezeichnet', 'Claude Opus 4.8': 'Ausgezeichnet', 'Gemini 3.1 Pro': 'Gut', 'Open-Source (LLaMA 3.1)': 'Variiert' },
            { 'Einschränkung': 'Halluzinationskontrolle', 'GPT-4o': 'Mittel', 'Claude Opus 4.8': 'Stark (markiert Unsicherheit)', 'Gemini 3.1 Pro': 'Mittel', 'Open-Source (LLaMA 3.1)': 'Schwach' },
            { 'Einschränkung': 'Reasoning (erweitert)', 'GPT-4o': 'o3/o4-mini verfügbar', 'Claude Opus 4.8': 'Extended Thinking verfügbar', 'Gemini 3.1 Pro': 'Flash Thinking verfügbar', 'Open-Source (LLaMA 3.1)': 'Begrenzt' },
          ],
        },
        knowledgeCutoff: {
          title: 'Einschränkung 1 — Wissens-Cutoffs und keine Echtzeitdaten',
          content: [
            '**Jedes LLM hat ein Trainings-Cutoff-Datum, und das Modell hat kein Wissen über Ereignisse, Preise, Forschungsarbeiten oder Produktversionen, die nach diesem Datum veröffentlicht wurden, sofern kein externes Retrieval hinzugefügt wird.** OpenAI GPT-4o hat einen Cutoff von Oktober 2024. Anthropic Claude Opus 4.8 und Google Gemini 3.1 Pro haben Cutoffs Anfang 2025.',
        ...
        noAction: {
          ...
          content: [
            ...
            'Tool-Use (auch Function Calling genannt) — verfügbar in GPT-4o, Claude Opus 4.8 und Gemini 3.1 Pro — lässt ein Modell strukturierte Funktionsaufrufe ausgeben, die eine Anwendung abfängt und ausführt. Das Modell kann immer noch keine Aktionen eigenständig durchführen; es kann nur strukturierten Text ausgeben, der externe Ausführung auslöst.',
        ...
        bias: {
          ...
          content: [
            ...
            'Das ist relevant für internationale Teams: GPT-4o, Claude Opus 4.8 und Gemini 3.1 Pro produzieren alle stärkere Ausgaben auf Englisch als in ressourcenärmeren Sprachen. Technische Terminologie in Nischendomänen (spezifische Branchen, lokale Rechtssysteme, regionale Dialekte) kann in den Trainingsdaten schlecht vertreten sein.',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'Kann GPT-4o auf das Internet zugreifen?', a: 'GPT-4o in der Standard-API kann nicht auf das Internet zugreifen. Die ChatGPT-Oberfläche bietet ein optionales Browsing-Tool, aber die Basis-Modell-API hat einen Trainings-Cutoff von Oktober 2024 und kein Live-Retrieval. Bestätigen Sie immer, ob eine Tool-Use-Schicht in Ihrer spezifischen Integration aktiv ist, bevor Sie davon ausgehen, dass das Modell aktuelle Daten hat.' },
            { q: 'Wie unterscheiden sich Wissens-Cutoffs zwischen GPT-4o, Claude und Gemini?', a: 'Stand 2026: OpenAI GPT-4o hat einen Trainings-Cutoff von Oktober 2024; Anthropic Claude Opus 4.8 und Google Gemini 3.1 Pro haben Cutoffs Anfang 2025. Alle drei Modelle können ungenaues Wissen über Ereignisse nahe ihrer Cutoffs haben, da die Trainingsabdeckung der jüngsten Monate spärlich ist.' },
            ...
            { q: 'Wie unterscheiden sich die Einschränkungen zwischen Open-Source- und proprietären Modellen im Jahr 2026?', a: 'Open-Source-Modelle (LLaMA 3.1, Mistral Large, Qwen 2.5) und proprietäre Modelle (GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro) stehen vor identischen strukturellen Einschränkungen — Wissens-Cutoffs, Halluzination, Kontextfenster, Schlussfolgerungsbeschränkungen. Die Unterschiede liegen im Schweregrad und den Kosten: Proprietäre Modelle haben typischerweise größere Kontexte (Gemini 3.1 Pro: 2M Tokens vs. Mistral: 128K), besseres Instruktions-Following und häufigere Trainingsupdates. Open-Source-Modelle tauschen Fähigkeiten gegen Kosten und Deployment-Kontrolle. Keine Kategorie eliminiert eine der acht Einschränkungen.' },
          ],
        },
        sources: {
    ...
    es: {
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 6, name: 'Sin capacidad de acción en el mundo real', description: 'Causa raíz: los LLMs por defecto solo producen texto. Severidad: alta para tareas autónomas. Workaround: uso de herramientas/function calling disponible en GPT-4o, Claude Opus 4.8 y Gemini 3.1 Pro.' },
      ...
      sections: {
        definition: {
          ...
          content: [
            ...
            'Estas restricciones aplican universalmente: GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro, LLaMA 3.1, Mistral Large y todos los modelos de código abierto son igualmente afectados. El prompt engineering puede mitigar el impacto de estas limitaciones pero no puede eliminarlas.',
          ],
        },
        tldr: {
          title: 'Puntos clave',
        ...
        limit1: {
          ...
          content: [
            ...
            'Los cortes de conocimiento en 2026: GPT-4o (OpenAI): octubre 2024. Claude Opus 4.8 (Anthropic): principios de 2025. Gemini 3.1 Pro (Google DeepMind): principios de 2025.',
          ],
          items: [
        ...
        limit6: {
          ...
          items: [
            '**Workaround: Tool calling / function calling.** Las APIs de LLM modernas (GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro) admiten tool use, donde el modelo puede solicitar la ejecución de funciones definidas por el desarrollador. El modelo genera una llamada a herramienta estructurada; tu código ejecuta la acción real y devuelve el resultado al modelo.',
          ],
        },
        limit7: {
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: '¿Cómo difieren los cortes de conocimiento entre GPT-4o, Claude y Gemini?', a: 'A partir de 2026: OpenAI GPT-4o tiene un corte de entrenamiento de octubre 2024; Anthropic Claude Opus 4.8 y Google Gemini 3.1 Pro tienen cortes de principios de 2025. Los tres modelos pueden tener conocimiento inexacto sobre eventos cercanos a sus cortes, ya que la cobertura de entrenamiento de los meses más recientes es escasa.' },
    ...
    fr: {
      ...
      intro: 'Les grands modèles de langage ont huit limites structurelles qu\'aucun fine-tuning, mise à l\'échelle ou ingénierie des prompts ne peut éliminer : pas d\'accès en temps réel, hallucinations, raisonnement multi-étapes peu fiable, limites de contexte, pas de mémoire, pas d\'actions, biais d\'entraînement et impossibilité de vérifier les sorties. Chaque modèle — GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro et les alternatives open-source — partage ces contraintes. Ce guide couvre chaque limite avec le contournement technique qui fonctionne en production.',
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 4, name: 'Limites de la fenêtre de contexte', description: 'Cause : l\'attention du transformer a une limite stricte de tokens. Sévérité : moyenne pour les longs documents. Limites : GPT-4o 128K, Claude Opus 4.8 1M, Gemini 3.1 Pro 2M tokens. Solution : RAG, découpage, résumé.' },
          ...
          { '@type': 'ListItem', position: 6, name: 'Absence de capacité d\'action réelle', description: 'Cause : les LLMs ne produisent que du texte par défaut. Sévérité : élevée pour les tâches autonomes. Solution : utilisation d\'outils disponible dans GPT-4o, Claude Opus 4.8 et Gemini 3.1 Pro.' },
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: { '@type': 'Answer', text: 'Les modèles open-source (LLaMA 3.1, Mistral Large, Qwen 2.5) et propriétaires (GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro) font face à des limitations structurelles identiques — coupures de connaissance, hallucination, fenêtres de contexte, contraintes de raisonnement. Les différences résident dans la sévérité et le coût : les modèles propriétaires ont généralement des contextes plus grands (Gemini 3.1 Pro : 2M tokens vs Mistral : 128K), un meilleur suivi des instructions et des mises à jour d\'entraînement plus fréquentes. Les modèles open-source échangent des capacités contre le coût et le contrôle du déploiement. Aucune catégorie n\'élimine l\'une des huit limitations.' },
          },
        ],
      },
      gammaEmbedUrl: '/presentations/ai-limitations-what-llms-cant-do-static.html',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Les fenêtres de contexte limitent chaque session : GPT-4o 128K, Claude Opus 4.8 1M, Gemini 3.1 Pro 2M tokens',
        ...
        modelLimitsComparison: {
          ...
          columns: ['Limitation', 'GPT-4o', 'Claude Opus 4.8', 'Gemini 3.1 Pro', 'Open-Source (LLaMA 3.1)'],
          rows: [
            { 'Limitation': 'Coupure de connaissance', 'GPT-4o': 'Oct. 2024', 'Claude Opus 4.8': 'Début 2025', 'Gemini 3.1 Pro': 'Début 2025', 'Open-Source (LLaMA 3.1)': 'Varie selon la version' },
            { 'Limitation': 'Fenêtre contextuelle', 'GPT-4o': '128K tokens', 'Claude Opus 4.8': '1M tokens', 'Gemini 3.1 Pro': '2M tokens', 'Open-Source (LLaMA 3.1)': '8K–128K tokens' },
            { 'Limitation': 'Qualité des outils', 'GPT-4o': 'Excellente', 'Claude Opus 4.8': 'Excellente', 'Gemini 3.1 Pro': 'Bonne', 'Open-Source (LLaMA 3.1)': 'Variable' },
            { 'Limitation': 'Gestion des hallucinations', 'GPT-4o': 'Modérée', 'Claude Opus 4.8': 'Forte (signale l\'incertitude)', 'Gemini 3.1 Pro': 'Modérée', 'Open-Source (LLaMA 3.1)': 'Faible' },
            { 'Limitation': 'Raisonnement étendu', 'GPT-4o': 'o3/o4-mini disponible', 'Claude Opus 4.8': 'Extended thinking disponible', 'Gemini 3.1 Pro': 'Flash Thinking disponible', 'Open-Source (LLaMA 3.1)': 'Limité' },
          ],
        },
        knowledgeCutoff: {
        ...
        hallucination: {
          ...
          content: [
            '**Les LLMs génèrent des tokens statistiquement plausibles, pas des faits vérifiés — quand le signal d\'entraînement pour un fait spécifique est faible, le modèle produit une fabrication qui sonne assurée.** Cela s\'applique à chaque modèle, y compris GPT-4o, Claude Opus 4.8 et Gemini 3.1 Pro. Pour un approfondissement, voir [Hallucinations de l\'IA — Pourquoi l\'IA invente des choses](/fr/prompt-engineering/ai-hallucinations-why-ai-makes-things-up).',
        ...
        bias: {
          ...
          content: [
            ...
            'C\'est pertinent pour les équipes internationales : GPT-4o, Claude Opus 4.8 et Gemini 3.1 Pro produisent tous des sorties plus fortes en anglais que dans les langues à moins de ressources. La terminologie technique dans les domaines de niche (industries spécifiques, systèmes juridiques locaux, dialectes régionaux) peut être mal représentée dans les données d\'entraînement.',
        ...
        promptExamples: {
          ...
          blockquote: '[Mauvais Prompt] « Quel est le tarif actuel de GPT-4o ? »',
        ...
        keyTerms: {
          ...
          items: [
            '**[Coupure de connaissance](/fr/prompt-engineering/prompt-engineering-glossary)** — La date au-delà de laquelle un modèle n\'a pas de données d\'entraînement. Tout événement, changement de prix ou publication après cette date est invisible pour le modèle sauf si vous le collez dans le prompt. GPT-4o : octobre 2024 ; Claude Opus 4.8 et Gemini 3.1 Pro : début 2025.',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'GPT-4o peut-il accéder à Internet ?', a: 'GPT-4o dans l\'API standard ne peut pas accéder à Internet. L\'interface ChatGPT propose un outil de navigation optionnel, mais l\'API du modèle de base a une coupure d\'entraînement d\'octobre 2024 sans récupération en direct. Confirmez toujours si une couche d\'utilisation d\'outils est active dans votre intégration spécifique avant de supposer que le modèle dispose de données actuelles.' },
            { q: 'Comment les coupures de connaissance diffèrent-elles entre GPT-4o, Claude et Gemini ?', a: 'En 2026 : OpenAI GPT-4o a une coupure d\'entraînement d\'octobre 2024 ; Anthropic Claude Opus 4.8 et Google Gemini 3.1 Pro ont des coupures début 2025. Les trois modèles peuvent avoir des connaissances imprécises sur les événements proches de leurs coupures en raison d\'une couverture d\'entraînement clairsemée des mois les plus récents.' },
            ...
            { q: 'Comment les limitations diffèrent-elles entre les modèles open-source et propriétaires en 2026 ?', a: 'Les modèles open-source (LLaMA 3.1, Mistral Large, Qwen 2.5) et propriétaires (GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro) font face à des limitations structurelles identiques — coupures de connaissance, hallucination, fenêtres de contexte, contraintes de raisonnement. Les différences résident dans la sévérité et le coût : les modèles propriétaires ont généralement des contextes plus grands (Gemini 3.1 Pro : 2M tokens vs Mistral : 128K), un meilleur suivi des instructions et des mises à jour d\'entraînement plus fréquentes. Les modèles open-source échangent des capacités contre le coût et le contrôle du déploiement. Aucune catégorie n\'élimine l\'une des huit limitations.' },
          ],
        },
        sources: {
  ...
  intro: '大規模言語モデルには、ファインチューニング、スケーリング、プロンプトエンジニアリングのいずれによっても排除できない8つの硬い制限があります：リアルタイムデータへのアクセス不可、幻覚、不安定な複数ステップ推論、コンテキストウィンドウの上限、記憶なし、現実世界のアクション不可、学習バイアス、自己検証の不可能性。すべてのモデル — GPT-4o、Claude Opus 4.8、Gemini 3.1 Proとオープンソースの代替品 — がこれらの構造的制約を共有しています。このガイドでは、各制限について本番環境で機能するエンジニアリング上の回避策と合わせて説明します。',
  ...
  itemListSchema: {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 4, name: 'コンテキストウィンドウ制限', description: '根本原因：トランスフォーマーアテンションに硬いトークンキャップがある。重大度：長いドキュメント対して中程度。コンテキスト制限：GPT-4o 128K、Claude Opus 4.8 1M、Gemini 3.1 Pro 2Mトークン。回避方法：RAG、チャンキング、要約。' },
      ...
      { '@type': 'ListItem', position: 6, name: '実世界のアクション機能がない', description: '根本原因：LLMはデフォルトではテキストのみを出力する。重大度：自律的なタスク対して高い。回避方法：GPT-4o、Claude Opus 4.8、Gemini 3.1 Proで利用可能なツール使用/関数呼び出し。' },
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: 'LLMはリアルタイムデータにアクセスできず、独自の出力を検証できず、セッション間でメモリを保持できず、ツールスキャフォルディングなしで実世界のアクションを実行できず、chain-of-thoughtプロンプトなしで複数ステップのロジックを確実に推論できません。これらは、すべてのモデル（GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro、およびオープンソースの代替案など）に適用される構造的な制限です。' },
      },
      {
        '@type': 'Question',
      ...
      {
        '@type': 'Question',
        name: 'GPT-4oはインターネットにアクセスできますか?',
        acceptedAnswer: { '@type': 'Answer', text: '標準APIのGPT-4oはインターネットにアクセスできません。ChatGPTのインターフェースはオプションのブラウジングツールを提供しますが、ベースモデルAPIは2024年10月のトレーニングカットオフを持っており、ライブ検索はありません。モデルが現在のデータを持っていると仮定する前に、ツール使用レイヤーが特定の統合でアクティブであることを常に確認してください。' },
      },
      {
        '@type': 'Question',
        name: 'GPT-4o、Claude、Geminiの知識カットオフはどのように異なりますか?',
        acceptedAnswer: { '@type': 'Answer', text: '2026年現在：OpenAI GPT-4oは2024年10月のトレーニングカットオフを持っています。Anthropic Claude Opus 4.8とGoogle Gemini 3.1 Proは2025年初頭のカットオフを持っています。3つのモデルすべてが、最近数か月のトレーニング情報が希薄であるため、カットオフに近いイベントについて不正確な知識を持つ可能性があります。' },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: 'はい。ファインチューニングはスタイル、ドメインフォーカス、または指示追従の動作を調整します — リアルタイムのデータアクセス、真の推論、または永続的なメモリを追加しません。ファインチューニングされたGPT-4oは、ベースモデルと同じ知識カットオフと幻覚リスクを保持しています。' },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: { '@type': 'Answer', text: 'どのモデルも8つの構造的な制限のいずれかを排除することはできません — これらはトランスフォーマーアーキテクチャに普遍的です。Gemini 3.1 Proは最大のコンテキストウィンドウ（200万トークン）を持ち、制限4を最よく緩和します。Claude Opus 4.8は不確実性を回避し、知識カットオフを最も確実に認め、幻覚リスクを緩和します。GPT-4oはツール使用（制限6の回避）で優れています。「最も制限が少ない」モデルではなく、特定の制限のボトルネックに基づいて選択してください。' },
      },
      {
        '@type': 'Question',
        name: '2026年のオープンソースと専有モデル間で制限はどのように異なりますか?',
        acceptedAnswer: { '@type': 'Answer', text: 'オープンソースモデル（LLaMA 3.1、Mistral Large、Qwen 2.5）と専有モデル（GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro）は、同じ構造的な制限（知識カットオフ、幻覚、コンテキストウィンドウ、推論の制約）に直面しています。違いは重大度とコストにあります：専有モデルは通常、より大きなコンテキスト（Gemini 3.1 Pro：2Mトークン対Mistral：128K）、より良い指示追従、およびより頻繁なトレーニング更新を持っています。オープンソースモデルは、コストと展開制御のための能力をトレードします。どのカテゴリも8つの制限のいずれかを排除しません。' },
      },
    ],
  },
  gammaEmbedUrl: '/presentations/ai-limitations-what-llms-cant-do-static.html',
  ...
  sections: {
    tldr: {
      ...
      items: [
        ...
        'コンテキストウィンドウはすべてのセッションを上限に制限します：GPT-4o 128K、Claude Opus 4.8 1M、Gemini 3.1 Pro 2Mトークン',
    ...
    modelLimitsComparison: {
      ...
      columns: ['制限', 'GPT-4o', 'Claude Opus 4.8', 'Gemini 3.1 Pro', 'オープンソース (LLaMA 3.1)'],
      rows: [
        { '制限': '知識カットオフ', 'GPT-4o': '2024年10月', 'Claude Opus 4.8': '2025年初頭', 'Gemini 3.1 Pro': '2025年初頭', 'オープンソース (LLaMA 3.1)': 'リリースにより異なる' },
        { '制限': 'コンテキストウィンドウ', 'GPT-4o': '128Kトークン', 'Claude Opus 4.8': '1Mトークン', 'Gemini 3.1 Pro': '200万トークン', 'オープンソース (LLaMA 3.1)': '8K〜128Kトークン' },
        { '制限': 'ツール使用品質', 'GPT-4o': '優秀', 'Claude Opus 4.8': '優秀', 'Gemini 3.1 Pro': '良好', 'オープンソース (LLaMA 3.1)': '様々' },
        { '制限': '幻覚への対処', 'GPT-4o': '普通', 'Claude Opus 4.8': '強い（不確実性を明示）', 'Gemini 3.1 Pro': '普通', 'オープンソース (LLaMA 3.1)': '弱い' },
        { '制限': '拡張推論', 'GPT-4o': 'o3/o4-mini利用可能', 'Claude Opus 4.8': 'Extended thinking利用可能', 'Gemini 3.1 Pro': 'Flash Thinking利用可能', 'オープンソース (LLaMA 3.1)': '限定的' },
      ],
    },
    knowledgeCutoff: {
      title: '制限1 — 知識カットオフとリアルタイムデータなし',
      content: [
        '**すべてのLLMはトレーニングカットオフ日を持ち、外部検索が追加されない限り、モデルはその日付の後にリリースされたイベント、価格、論文、または製品バージョンについての知識を持ちません。** OpenAI GPT-4oは2024年10月のカットオフを持っています。Anthropic Claude Opus 4.8とGoogle Gemini 3.1 Proは2025年初頭のカットオフを持っています。',
    ...
    hallucination: {
      ...
      content: [
        '**LLMは検証された事実ではなく、統計的にもっともらしいトークンを生成します — 特定の事実のトレーニング信号が薄いとき、モデルは確信を持った虚偽を生成します。** これはGPT-4o、Claude Opus 4.8、Gemini 3.1 Proを含むすべてのモデルに適用されます。詳細については、[AI幻覚 — AIが物事を作り出す理由](/ja/prompt-engineering/ai-hallucinations-why-ai-makes-things-up)を参照してください。',
    ...
    contextWindow: {
      ...
      content: [
        '**すべてのLLMセッションにハードなトークン制限があります — GPT-4oは128,000トークン、Claude Opus 4.8は200,000トークン、Gemini 3.1 Proは2,000,000トークン — ウィンドウが満杯になると、前のコンテンツのパフォーマンスが低下します。** [コンテキストウィンドウの説明](/ja/prompt-engineering/context-windows-explained-why-ai-forgets)を参照して、完全な詳細を確認してください。',
    ...
    noAction: {
      ...
      content: [
        ...
        'ツール使用（関数呼び出しとも呼ばれる）— GPT-4o、Claude Opus 4.8、Gemini 3.1 Proで利用可能です — モデルがアプリケーションが傍受して実行する構造化関数呼び出しを出力できるようにします。モデルは独立してアクションを実行することはできず、外部実行をトリガーする構造化テキストのみを出力できます。',
    ...
    bias: {
      ...
      content: [
        ...
        'これは国際チームに関連します：GPT-4o、Claude Opus 4.8、Gemini 3.1 Proは、低リソース言語よりも英語でより強力な出力を生成します。ニッチドメイン（特定の業界、ローカル法制度、地域方言）の技術用語は、トレーニングデータに不十分に表現されている可能性があります。',
    ...
    promptExamples: {
      ...
      blockquote: '[悪いプロンプト] 「GPT-4oの現在の価格は?」',
    ...
    keyTerms: {
      ...
      items: [
        '**[知識カットオフ](/ja/prompt-engineering/prompt-engineering-glossary)** — モデルがトレーニングデータを持たない日付。この日付後の任何のイベント、価格変更、またはリリースは、プロンプトに貼り付けない限り、モデルに見えません。GPT-4o：2024年10月；Claude Opus 4.8およびGemini 3.1 Pro：2025年初頭。',
        ...
        '**[コンテキストウィンドウ](/ja/prompt-engineering/prompt-engineering-glossary#core-concepts)** — モデルが一度に処理できるトークンの最大数（単語 + 句読点）、システムプロンプト、会話履歴、取得ドキュメントを含む。GPT-4o：128Kトークン；Claude Opus 4.8：1M；Gemini 3.1 Pro：2M。',
    ...
    faq: {
      title: 'よくある質問',
      faqs: [
        { q: 'LLMができない主なことは何ですか?', a: 'LLMはリアルタイムデータにアクセスできず、独自の出力を検証できず、セッション間でメモリを保持できず、ツールスキャフォルディングなしで実世界のアクションを実行できず、chain-of-thoughtプロンプトなしで複数ステップのロジックを確実に推論できません。これらは、すべてのモデル（GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro、およびオープンソースの代替案など）に適用される構造的な制限です。' },
        ...
        { q: 'GPT-4oはインターネットにアクセスできますか?', a: '標準APIのGPT-4oはインターネットにアクセスできません。ChatGPTのインターフェースはオプションのブラウジングツールを提供しますが、ベースモデルAPIは2024年10月のトレーニングカットオフを持っており、ライブ検索はありません。モデルが現在のデータを持っていると仮定する前に、ツール使用レイヤーが特定の統合でアクティブであることを常に確認してください。' },
        { q: 'GPT-4o、Claude、Geminiの知識カットオフはどのように異なりますか?', a: '2026年現在：OpenAI GPT-4oは2024年10月のトレーニングカットオフを持っています。Anthropic Claude Opus 4.8とGoogle Gemini 3.1 Proは2025年初頭のカットオフを持っています。3つのモデルすべてが、最近数か月のトレーニング情報が希薄であるため、カットオフに近いイベントについて不正確な知識を持つ可能性があります。' },
        ...
        { q: 'ファインチューニングされたモデルは同じ制限を持っていますか?', a: 'はい。ファインチューニングはスタイル、ドメインフォーカス、または指示追従の動作を調整します — リアルタイムのデータアクセス、真の推論、または永続的なメモリを追加しません。ファインチューニングされたGPT-4oは、ベースモデルと同じ知識カットオフと幻覚リスクを保持しています。' },
        ...
        { q: '最も制限が少ないLLMはどれですか?', a: 'どのモデルも8つの構造的な制限のいずれかを排除することはできません — これらはトランスフォーマーアーキテクチャに普遍的です。Gemini 3.1 Proは最大のコンテキストウィンドウ（200万トークン）を持ち、制限4を最よく緩和します。Claude Opus 4.8は不確実性を回避し、知識カットオフを最も確実に認め、幻覚リスクを緩和します。GPT-4oはツール使用（制限6の回避）で優れています。「最も制限が少ない」モデルではなく、特定の制限のボトルネックに基づいて選択してください。' },
        { q: '2026年のオープンソースと専有モデル間で制限はどのように異なりますか?', a: 'オープンソースモデル（LLaMA 3.1、Mistral Large、Qwen 2.5）と専有モデル（GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro）は、同じ構造的な制限（知識カットオフ、幻覚、コンテキストウィンドウ、推論の制約）に直面しています。違いは重大度とコストにあります：専有モデルは通常、より大きなコンテキスト（Gemini 3.1 Pro：2Mトークン対Mistral：128K）、より良い指示追従、およびより頻繁なトレーニング更新を持っています。オープンソースモデルは、コストと展開制御のための能力をトレードします。どのカテゴリも8つの制限のいずれかを排除しません。' },
      ],
    },
    sources: {
      title: 'ソースと参考資料',
...
zh: {
      ...
      intro: '大语言模型有八个硬性限制，无论是微调、扩展规模还是提示工程都无法消除：无法访问实时数据、产生幻觉、多步骤推理不可靠、上下文窗口上限、无持久记忆、无现实世界行动能力、训练偏差以及无法自我验证输出。每个模型——GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro以及开源替代方案——都共享这些结构性限制。本指南涵盖每个限制及其在生产环境中可行的工程解决方案。',
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 4, name: '上下文窗口限制', description: '根本原因：transformer 注意力有硬令牌上限。严重程度：对长文档为中等。上下文上限：GPT-4o 128K、Claude Opus 4.8 1M、Gemini 3.1 Pro 2M 令牌。解决方案：RAG、分块、摘要。' },
          { '@type': 'ListItem', position: 5, name: '无持久内存', description: '根本原因：无状态架构 — 每个会话从空白上下文开始。严重程度：对多会话工作流为中等。解决方案：使用向量数据库或对话摘要的应用层内存注入。' },
          { '@type': 'ListItem', position: 6, name: '无现实世界操作能力', description: '根本原因：大语言模型默认仅输出文本。严重程度：对自主任务为高。解决方案：在 GPT-4o、Claude Opus 4.8 和 Gemini 3.1 Pro 中可用的工具使用/函数调用。' },
        ...
        mainEntity: [
          {
            '@type': 'Question',
            name: '大语言模型主要无法做什么？',
            acceptedAnswer: { '@type': 'Answer', text: '大语言模型无法获取实时数据、验证自己的输出、在会话间保留内存、在没有工具支架的情况下采取现实世界的操作，或在没有思维链提示词的情况下可靠地进行多步逻辑推理。这些是适用于每个模型的结构性限制 — GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro 和开源替代品。' },
          },
          {
            '@type': 'Question',
            name: '为什么大语言模型会产生幻觉？',
          ...
          {
            '@type': 'Question',
            name: 'GPT-4o 可以访问互联网吗？',
            acceptedAnswer: { '@type': 'Answer', text: '标准 API 中的 GPT-4o 无法访问互联网。ChatGPT 界面提供可选的浏览工具，但基础模型 API 的训练截断日期为 2024 年 10 月，无实时检索。在假设模型具有当前数据前，始终确认工具使用层是否在您的特定集成中激活。' },
          },
          {
            '@type': 'Question',
            name: 'GPT-4o、Claude 和 Gemini 的知识截断如何不同？',
            acceptedAnswer: { '@type': 'Answer', text: '截至 2026 年：OpenAI GPT-4o 的训练截断为 2024 年 10 月；Anthropic Claude Opus 4.8 和 Google Gemini 3.1 Pro 的截断为 2025 年初。所有三个模型可能对接近其截断日期的事件有不精确的知识，因为最近几个月的训练覆盖很少。' },
          },
          {
            '@type': 'Question',
          ...
          },
          {
            '@type': 'Question',
            name: '微调的模型是否有相同的局限性？',
            acceptedAnswer: { '@type': 'Answer', text: '是的。微调调整风格、领域焦点或指令遵循行为 — 它不添加实时数据访问、真正推理或持久内存。微调的 GPT-4o 保留与基础模型相同的知识截断和幻觉风险。' },
          },
          {
            '@type': 'Question',
          ...
          },
          {
            '@type': 'Question',
            name: '哪个大语言模型的局限性最少？',
            acceptedAnswer: { '@type': 'Answer', text: '没有模型消除这八个结构性限制中的任何一个 — 它们对 transformer 架构是通用的。Gemini 3.1 Pro 拥有最大的上下文窗口（200 万令牌），最好地缓解了限制 4。Claude Opus 4.8 最可靠地对冲不确定性并承认知识截断，缓解了幻觉风险。GPT-4o 在工具使用（限制 6 解决方案）上表现出色。根据您的特定限制瓶颈选择，而不是哪个模型"最不受限制"。' },
          },
          {
            '@type': 'Question',
            name: '2026 年开源和专有模型之间的局限性如何不同？',
            acceptedAnswer: { '@type': 'Answer', text: '开源模型（LLaMA 3.1、Mistral Large、Qwen 2.5）和专有模型（GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro）面临相同的结构性限制 — 知识截断、幻觉、上下文窗口、推理约束。区别在于严重程度和成本：专有模型通常有更大的上下文（Gemini 3.1 Pro：200 万令牌 vs Mistral：128K）、更好的指令遵循和更频繁的训练更新。开源模型以成本和部署控制为代价换取功能。两个类别都不消除这八个限制中的任何一个。' },
          },
        ],
      },
      gammaEmbedUrl: '/presentations/ai-limitations-what-llms-cant-do-static.html',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '上下文窗口限制每个会话：GPT-4o 128K、Claude Opus 4.8 1M、Gemini 3.1 Pro 200 万令牌',
        ...
        modelLimitsComparison: {
          ...
          columns: ['限制', 'GPT-4o', 'Claude Opus 4.8', 'Gemini 3.1 Pro', '开源 (LLaMA 3.1)'],
          rows: [
            { '限制': '知识截止日期', 'GPT-4o': '2024年10月', 'Claude Opus 4.8': '2025年初', 'Gemini 3.1 Pro': '2025年初', '开源 (LLaMA 3.1)': '因版本而异' },
            { '限制': '上下文窗口', 'GPT-4o': '128K tokens', 'Claude Opus 4.8': '1M tokens', 'Gemini 3.1 Pro': '200万 tokens', '开源 (LLaMA 3.1)': '8K–128K tokens' },
            { '限制': '工具调用质量', 'GPT-4o': '优秀', 'Claude Opus 4.8': '优秀', 'Gemini 3.1 Pro': '良好', '开源 (LLaMA 3.1)': '参差不齐' },
            { '限制': '幻觉处理', 'GPT-4o': '一般', 'Claude Opus 4.8': '强（会标注不确定性）', 'Gemini 3.1 Pro': '一般', '开源 (LLaMA 3.1)': '较弱' },
            { '限制': '扩展推理', 'GPT-4o': 'o3/o4-mini可用', 'Claude Opus 4.8': 'Extended thinking可用', 'Gemini 3.1 Pro': 'Flash Thinking可用', '开源 (LLaMA 3.1)': '有限' },
          ],
        },
        knowledgeCutoff: {
          title: '限制 1 — 知识截断和无实时数据',
          content: [
            '**每个大语言模型都有训练截断日期，除非添加外部检索，否则模型对该日期后发布的事件、价格、论文或产品版本一无所知。** OpenAI GPT-4o 的截断为 2024 年 10 月。Anthropic Claude Opus 4.8 和 Google Gemini 3.1 Pro 的截断为 2025 年初。',
        ...
        hallucination: {
          ...
          content: [
            '**大语言模型生成统计上合理的令牌，而非已验证的事实 — 当特定事实的训练信号很少时，模型生成有信心但虚假的说法。** 这适用于每个模型，包括 GPT-4o、Claude Opus 4.8 和 Gemini 3.1 Pro。深入了解，请参见[AI 幻觉 — 为什么 AI 编造东西](/zh/prompt-engineering/ai-hallucinations-why-ai-makes-things-up)。',
        ...
        contextWindow: {
          title: '限制 4 — 上下文窗口限制',
          content: [
            '**每个大语言模型会话都有硬令牌限制 — GPT-4o 128,000 令牌、Claude Opus 4.8 200,000 令牌、Gemini 3.1 Pro 2,000,000 令牌 — 随着窗口填充，早期内容的性能会下降。** 请参见[上下文窗口详解](/zh/prompt-engineering/context-windows-explained-why-ai-forgets)获取完整分析。',
        ...
        noAction: {
          ...
          content: [
            ...
            '工具使用（也称函数调用） — 在 GPT-4o、Claude Opus 4.8 和 Gemini 3.1 Pro 中可用 — 让模型输出应用拦截和执行的结构化函数调用。模型仍然无法独立采取行动；它只能发出触发外部执行的结构化文本。',
        ...
        bias: {
          ...
          content: [
            ...
            '这与国际团队相关：GPT-4o、Claude Opus 4.8 和 Gemini 3.1 Pro 都在英语中比在低资源语言中生成更强的输出。技术术语处于利基域（特定行业、本地法律制度、地区方言）可能在训练数据中的代表性很差。',
        ...
        promptExamples: {
          ...
          blockquote: '[坏提示词] "GPT-4o 的当前价格是什么？"',
        ...
        keyTerms: {
          ...
          items: [
            '**[知识截断](/zh/prompt-engineering/prompt-engineering-glossary)** — 模型之后没有训练数据的日期。此日期后的任何事件、价格变化或发布对模型是无形的，除非您将其粘贴到提示词中。GPT-4o：2024 年 10 月；Claude Opus 4.8 和 Gemini 3.1 Pro：2025 年初。',
            '**[幻觉](/zh/prompt-engineering/prompt-engineering-glossary#core-concepts)** — 有信心但事实不正确或虚构的输出。由统计令牌预测而非真实查找导致。用源材料基础化提示词减少但不消除它。',
            '**[上下文窗口](/zh/prompt-engineering/prompt-engineering-glossary#core-concepts)** — 模型一次可处理的最大令牌数（单词+标点），包括系统提示、对话历史和检索文档。GPT-4o：128K 令牌；Claude Opus 4.8：1M；Gemini 3.1 Pro：200 万。',
        ...
        faq: {
          title: '常见问题',
          faqs: [
            { q: '大语言模型主要无法做什么？', a: '大语言模型无法获取实时数据、验证自己的输出、在会话间保留内存、在没有工具支架的情况下采取现实世界的操作，或在没有思维链提示词的情况下可靠地进行多步逻辑推理。这些是适用于每个模型的结构性限制 — GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro 和开源替代品。' },
            ...
            { q: 'GPT-4o 可以访问互联网吗？', a: '标准 API 中的 GPT-4o 无法访问互联网。ChatGPT 界面提供可选的浏览工具，但基础模型 API 的训练截断日期为 2024 年 10 月，无实时检索。在假设模型具有当前数据前，始终确认工具使用层是否在您的特定集成中激活。' },
            { q: 'GPT-4o、Claude 和 Gemini 的知识截断如何不同？', a: '截至 2026 年：OpenAI GPT-4o 的训练截断为 2024 年 10 月；Anthropic Claude Opus 4.8 和 Google Gemini 3.1 Pro 的截断为 2025 年初。所有三个模型可能对接近其截断日期的事件有不精确的知识，因为最近几个月的训练覆盖很少。' },
            ...
            { q: '微调的模型是否有相同的局限性？', a: '是的。微调调整风格、领域焦点或指令遵循行为 — 它不添加实时数据访问、真正推理或持久内存。微调的 GPT-4o 保留与基础模型相同的知识截断和幻觉风险。' },
            ...
            { q: '哪个大语言模型的局限性最少？', a: '没有模型消除这八个结构性限制中的任何一个 — 它们对 transformer 架构是通用的。Gemini 3.1 Pro 拥有最大的上下文窗口（200 万令牌），最好地缓解了限制 4。Claude Opus 4.8 最可靠地对冲不确定性并承认知识截断，缓解了幻觉风险。GPT-4o 在工具使用（限制 6 解决方案）上表现出色。根据您的特定限制瓶颈选择，而不是哪个模型"最不受限制"。' },
            { q: '2026 年开源和专有模型之间的局限性如何不同？', a: '开源模型（LLaMA 3.1、Mistral Large、Qwen 2.5）和专有模型（GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro）面临相同的结构性限制 — 知识截断、幻觉、上下文窗口、推理约束。区别在于严重程度和成本：专有模型通常有更大的上下文（Gemini 3.1 Pro：200 万令牌 vs Mistral：128K）、更好的指令遵循和更频繁的训练更新。开源模型以成本和部署控制为代价换取功能。两个类别都不消除这八个限制中的任何一个。' },
          ],
        },
        sources: {
          title: '来源和进一步阅读',
