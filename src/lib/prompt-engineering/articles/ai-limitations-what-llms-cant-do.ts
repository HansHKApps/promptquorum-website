...
export const article: Record<Language, PEArticle> = {
    en: {
      ...
      metaDescription: '8 hard limits all local LLMs share: no real-time data, hallucination, reasoning gaps, context caps, no memory, no actions, bias, no verification.',
    ...
    de: {
      ...
      metaDescription: '8 Grenzen lokaler LLMs: kein Echtzeitzugriff, Halluzinationen, schwaches Reasoning, Kontextfenster, kein Gedächtnis, keine Aktionen, Bias, keine Prüfung.',
      publishDate: '2026-03-24',
    ...
    fr: {
      ...
      metaDescription: '8 limites LLMs locaux: sans accès réel, hallucinations, raisonnement faible, fenêtres contexte, pas de mémoire, pas d\'actions, biais, sans vérification.',
      publishDate: '2026-03-24',
