...
export const article: Record<Language, PEArticle> = {
    en: {
      ...
      seoTitle: 'The APE Framework: Analyze, Plan, Execute — Structured Prompts That Show Their Reasoning',
      metaDescription: 'The APE Framework splits every AI prompt into Analyze, Plan, and Execute — making the model\'s reasoning visible and checkable. Template, examples, and comparison to other frameworks.',
    ...
    de: {
      ...
      readTime: '7 min read',
      educationalLevel: 'Intermediate',
      seoTitle: 'APE-Framework: Analyse, Plan, Ausführung — Strukturierte Prompts mit sichtbarem Denken',
      metaDescription: 'Das APE-Framework teilt jeden AI-Prompt in Analyse, Planung und Ausführung auf. Template, Beispiele und Vergleich zu anderen Frameworks.',
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
    ...
    fr: {
      ...
      readTime: '7 min read',
      educationalLevel: 'Intermediate',
      seoTitle: 'Framework APE : Analyse, Plan, Exécution — Prompts Structurés avec Raisonnement Visible',
      metaDescription: 'Le framework APE divise chaque prompt IA en analyse, planification et exécution. Template, exemples et comparaison avec d\'autres frameworks.',
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
    ...
    ja: {
      ...
      metaDescription: 'APEフレームワークはすべてのAIプロンプトを分析、計画、実行の3段階に分割。テンプレート、例、他のフレームワークとの比較。',
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
    ...
    zh: {
      ...
      metaDescription: 'APE框架将每个AI提示分为分析、规划和执行三个阶段。模板、示例和与其他框架的对比。',
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
