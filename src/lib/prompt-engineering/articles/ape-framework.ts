...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    de: {
      ...
      ogTitle: 'Das APE-Framework: Analyse, Plan, Ausführung — Strukturierte Prompts, die ihr Denken offenlegen',
      ogDescription: 'Schluss mit Blackbox-Antworten. Das APE-Framework zwingt Modelle dazu, erst ihre Analyse zu zeigen, dann ihren Plan zu nennen und erst danach auszuführen — so erkennen Sie Fehlausrichtungen vor dem Endergebnis.',
      twitterTitle: 'APE-Framework: Analyse → Plan → Ausführung',
      twitterDescription: 'APE-Framework: Analyse → Plan → Ausführung. Drei Schritte, die undurchsichtige KI-Antworten in nachvollziehbares, prüfbares Denken verwandeln.',
      quickFacts: [
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        headline: 'Das APE-Framework: Analyse, Plan, Ausführung — Strukturierte Prompts, die ihr Denken offenlegen',
        description: 'Das APE-Framework teilt jeden KI-Prompt in Analyse, Plan und Ausführung auf — und macht das Denken des Modells sichtbar und überprüfbar. Vorlage, Beispiele und Vergleich mit anderen Frameworks.',
        datePublished: '2026-03-24',
        ...
        'proficiencyLevel': 'Intermediate',
        speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
        keywords: ['APE-Framework', 'Analyse Plan Ausführung', 'Prompt-Frameworks', 'Prompt-Engineering', 'strukturiertes Denken', 'PromptQuorum'],
        author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
        about: [
          { '@type': 'Thing', name: 'Prompt Engineering' },
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          content: [
            '**APE steht für Analyse, Plan, Ausführung** — eine dreistufige Prompt-Struktur, die Modelle zwingt, ihr Denken offenzulegen, bevor sie ein Ergebnis produzieren.',
            '**Setzen Sie APE ein, wenn das Denken zählt:** komplexe Analysen, technische Reviews, strategische Texte und Entscheidungen mit hohem Einsatz, bei denen Sie den Gedankengang des Modells prüfen müssen.',
            '**APE reduziert Fehler, indem es implizite Annahmen aufbricht:** Statt einer einzigen Antwort sehen Sie, wie das Modell das Problem verstanden und welchen Plan es gewählt hat.',
            '**PromptQuorum bietet APE als integrierte Option:** einmal auswählen, parallel auf mehrere Modelle anwenden, als Vorlage speichern.',
            '**Im Vergleich zu Single-Step- oder Multi-Turn-Prompting ist APE der Mittelweg:** mehr Struktur als eine einzelne Anweisung, weniger Aufwand als viele Hin-und-Her-Runden.',
          ],
        },
        whatIsAPE: {
          title: 'Was das APE-Framework ist',
          content: [
        ...
        threeSteps: {
          title: 'Die drei Schritte: Analyse, Plan, Ausführung',
          content: [
            '**Der Kern des APE-Frameworks besteht darin, dass jeder Prompt das Modell anweist, zuerst das Problem zu analysieren, dann die Lösung zu planen und erst danach die endgültige Antwort auszuführen.** Diese drei Schritte bilden ab, [wie Menschen an Denkaufgaben herangehen](/de/prompt-engineering/chain-of-thought-prompting), und geben Ihnen klare Prüfpunkte.',
        ...
        whenToUse: {
          title: 'Wann Sie das APE-Framework einsetzen sollten',
          content: [
          ...
          callouts: [
            { type: 'warning', label: 'Achtung', text: 'APE verursacht zusätzlichen Token-Aufwand — die Stufen Analyse und Plan verbrauchen Ausgabe-Token, bevor die eigentliche Ausführung beginnt. Bei Produktionsaufgaben mit hohem Volumen, bei denen Sie nur das Endergebnis brauchen und das Denken nicht prüfen, nutzen Sie einen einfacheren einstufigen Prompt, um Kosten und Latenz zu senken.' },
          ],
        },
        howToWrite: {
          title: 'So schreiben Sie einen APE-Prompt',
          content: [
          ...
          callouts: [
            { type: 'pro-tip', label: 'Profi-Tipp', text: 'Lesen Sie Analyse und Plan, BEVOR Sie sich das Ergebnis der Ausführung ansehen. Wenn die Analyse eine Rahmenbedingung übersehen hat oder der Plan einen falschen Schritt enthält, weisen Sie das Modell an, nachzubessern — das ist günstiger und schneller, als die gesamte Antwort neu zu erzeugen.' },
          ],
        },
        badVsGoodExample: {
          title: 'Beispiel: Schlechter vs. guter APE-Prompt',
          content: [
        ...
        howPQImplements: {
          title: 'Wie PromptQuorum das APE-Framework umsetzt',
          content: [
        ...
        choosingAPE: {
          title: 'APE oder ein anderes Framework?',
          content: [
          ...
          items: [
            ...
            'Nehmen Sie ein [Framework im Single-Step-Stil](/de/prompt-engineering/the-single-step-prompt-method), wenn Sie das genaue Ausgabeformat bereits kennen und nur eine gut spezifizierte Anweisung brauchen.',
          ...
          columns: ['Framework', 'Stufen/Abschnitte', 'Am besten geeignet für', 'Denken sichtbar?'],
          rows: [
            { Framework: 'APE', 'Stufen/Abschnitte': '3 (Analyse, Plan, Ausführung)', 'Am besten geeignet für': 'Komplexe Aufgaben mit prüfbarem Denken', 'Denken sichtbar?': 'Ja — explizite Stufen' },
            { Framework: 'Single-Step', 'Stufen/Abschnitte': '1 (eine Anweisung)', 'Am besten geeignet für': 'Einfache, klar definierte Aufgaben', 'Denken sichtbar?': 'Nein' },
            { Framework: 'CRAFT', 'Stufen/Abschnitte': '5 (Context, Role, Action, Format, Target)', 'Am besten geeignet für': 'Umfassende Kontextdefinition', 'Denken sichtbar?': 'Optional' },
            { Framework: 'CO-STAR', 'Stufen/Abschnitte': '6 (Context, Objective, Style, Tone, Audience, Response)', 'Am besten geeignet für': 'Marketing und Kommunikation', 'Denken sichtbar?': 'Nein' },
            { Framework: 'SPECS', 'Stufen/Abschnitte': '5 (Situation, Problem, Examples, Constraints, Style)', 'Am besten geeignet für': 'Problemlösung mit Beispielen', 'Denken sichtbar?': 'Optional' },
            { Framework: 'Chain-of-Thought', 'Stufen/Abschnitte': '1 (mit „Schritt für Schritt denken")', 'Am besten geeignet für': 'Mathematik, Logik, Denken in einem Durchgang', 'Denken sichtbar?': 'Ja — aber unstrukturiert' },
          ],
          tableFormat: true,
          callouts: [
            { type: 'info', label: 'Wussten Sie schon?', text: 'Die dreistufige Struktur von APE bildet genau ab, wie menschliche Fachleute an komplexe Probleme herangehen: das Problem verstehen (Analyse), das Vorgehen entwerfen (Plan) und dann das Ergebnis erstellen (Ausführung). Kognitionswissenschaftliche Forschung zeigt, dass diese Trennung Fehler sowohl beim menschlichen als auch beim maschinellen Denken reduziert.' },
          ],
        },

        automaticPromptEngineering: {
          title: 'APE bedeutet auch: Automatic Prompt Engineering (ein anderes Konzept)',
          content: [
        ...
        faqSection: {
          ...
          faqs: [
            { q: 'Wofür steht APE?', a: 'APE steht für Analyse, Plan, Ausführung. Es ist ein dreistufiges Prompt-Framework, das komplexes Denken in drei ausdrückliche Phasen zerlegt: das Problem verstehen, ein Vorgehen planen und die Lösung ausführen.' },
            { q: 'Worin unterscheidet sich APE davon, ein Modell einfach nach einer Antwort zu fragen?', a: 'Mit APE erhalten Sie Einblick in den Denkprozess des Modells. Statt einer einzigen Antwort sehen Sie, wie das Modell Ihre Aufgabe verstanden hat, welchen Plan es gewählt hat und wie das Endergebnis aussieht. Dadurch lassen sich Fehler leichter erkennen und die Ergebnisse werden verlässlicher.' },
            { q: 'Wann sollte ich APE statt der Single-Step-Prompt-Methode einsetzen?', a: 'Setzen Sie APE ein, wenn das Denken für Ihre Aufgabe entscheidend ist: technische Analysen, Code-Reviews, Strategieentwicklung oder Situationen, in denen Fehler teuer sind. Nutzen Sie Single Step, wenn Ihr Ziel von vornherein klar ist und es Ihnen vor allem auf Ausführungsgeschwindigkeit ankommt.' },
            { q: 'Kann ich APE mit lokalen Modellen wie Ollama oder LM Studio nutzen?', a: 'Ja. APE funktioniert mit jedem Modell — mit Spitzenmodellen von OpenAI, Anthropic und Google ebenso wie mit lokalen Modellen über Ollama und LM Studio. Dieselbe dreistufige Struktur gilt auf allen Plattformen.' },
            { q: 'Wie lang muss ein APE-Prompt sein?', a: 'APE-Prompts können kompakt sein. Ein einzelner Absatz, der Analyse, Plan und Ausführung benennt und angibt, was Sie in jeder Stufe erwarten, genügt. Beim Framework geht es um Struktur, nicht um Länge.' },
            { q: 'Kann ich APE-Prompts in PromptQuorum als Vorlagen speichern?', a: 'Ja. Sobald Sie einen APE-strukturierten Prompt erstellt haben, der für einen bestimmten Ablauf gut funktioniert (etwa Code-Reviews oder Kundenzusammenfassungen), können Sie ihn in PromptQuorum als Vorlage speichern und mit Ihrem Team teilen.' },
            { q: 'Was, wenn meine Aufgabe für APE zu einfach ist?', a: 'Wenn Ihre Aufgabe unkompliziert ist und kein sichtbares Denken erfordert, genügt wahrscheinlich die Single-Step-Prompt-Methode. APE erzeugt zusätzlichen Aufwand — der Nutzen entsteht dadurch, dass Sie das Denken des Modells prüfen und nachschärfen können.' },
            { q: 'Woran erkenne ich, dass ein APE-Prompt gut funktioniert?', a: 'Lassen Sie Ihren APE-Prompt auf 3–5 repräsentativen Beispielen laufen und prüfen Sie: (1) Erfasst die Analyse die eigentliche Herausforderung? (2) Ist der Plan sinnvoll und umsetzbar? (3) Folgt die Ausführung dem Plan? Ist ein Schritt schwach, schärfen Sie den Prompt nach und testen Sie erneut.' },
            { q: 'Was ist der Unterschied zwischen APE (Analyse-Plan-Ausführung) und APE (Automatic Prompt Engineering)?', a: 'Sie teilen sich ein Akronym, sind aber völlig unterschiedliche Techniken. APE (Analyse-Plan-Ausführung) ist eine manuelle Prompt-Struktur, die Sie selbst schreiben. APE (Automatic Prompt Engineering, Zhou et al. 2022) ist eine Technik, bei der KI automatisch Prompt-Varianten erzeugt und bewertet, um die optimale Formulierung zu finden. Dieser Artikel behandelt beides — das Hauptframework ist Analyse-Plan-Ausführung; die automatisierte Prompt-Optimierung wird im letzten Abschnitt beschrieben.' },
          ],
        },
        relatedReading: {
          title: 'Weiterführende Artikel',
          items: [
            '[Chain-of-Thought-Prompting](/de/prompt-engineering/chain-of-thought-prompting) — die Denktechnik, die APE in drei Stufen formalisiert',
            '[Welches Prompt-Framework sollten Sie verwenden?](/de/prompt-engineering/which-prompt-framework-should-you-use) — APE im Vergleich zu CRAFT, CO-STAR und SPECS',
            '[Die Single-Step-Prompt-Methode](/de/prompt-engineering/the-single-step-prompt-method) — wenn Sie die drei Stufen von APE NICHT brauchen',
            '[5 Bausteine, die jeder Prompt braucht](/de/prompt-engineering/5-building-blocks-every-prompt-needs) — die universellen Bausteine, die APE in Stufen ordnet',
            '[Persona-Prompting](/de/prompt-engineering/persona-prompting) — kombinierbar mit der Rollendefinition von APE für fachspezifische Analysen',
            '[Prompt-Chaining](/de/prompt-engineering/prompt-chaining) — für Aufgaben, die für einen einzelnen APE-Prompt zu komplex sind, verketten Sie mehrere APE-Schritte',
          ],
        },
        ...
        sources: {
          title: 'Quellen',
          items: [
            '[White et al. (2023). „A Prompt Pattern Catalog to Enhance Prompt Engineering with ChatGPT." arXiv:2302.11382](https://arxiv.org/abs/2302.11382) — Taxonomie von Prompt-Mustern einschließlich Mustern für strukturiertes Denken',
            '[Zhou et al. (2022). „Large Language Models Are Human-Level Prompt Engineers." arXiv:2211.01910](https://arxiv.org/abs/2211.01910) — die ursprüngliche Arbeit zu Automatic Prompt Engineering (APE)',
            '[Anthropic. „Prompt Engineering Guide." docs.anthropic.com](https://docs.anthropic.com) — Best Practices für strukturiertes Prompting',
            '[OpenAI. „Prompt Engineering Guide." platform.openai.com](https://platform.openai.com/docs) — Anleitung zu schrittweisem Denken und strukturierter Ausgabe',
          ],
        },
      },
      faqSchema: {
        ...
        inLanguage: 'de',
        mainEntity: [
          { '@type': 'Question', name: 'Wofür steht APE?', acceptedAnswer: { '@type': 'Answer', text: 'APE steht für Analyse, Plan, Ausführung. Es ist ein dreistufiges Prompt-Framework, das komplexes Denken in drei ausdrückliche Phasen zerlegt: das Problem verstehen, ein Vorgehen planen und die Lösung ausführen.' } },
          { '@type': 'Question', name: 'Worin unterscheidet sich APE davon, ein Modell einfach nach einer Antwort zu fragen?', acceptedAnswer: { '@type': 'Answer', text: 'Mit APE erhalten Sie Einblick in den Denkprozess des Modells. Statt einer einzigen Antwort sehen Sie, wie das Modell Ihre Aufgabe verstanden hat, welchen Plan es gewählt hat und wie das Endergebnis aussieht. Dadurch lassen sich Fehler leichter erkennen und die Ergebnisse werden verlässlicher.' } },
          { '@type': 'Question', name: 'Wann sollte ich APE statt der Single-Step-Prompt-Methode einsetzen?', acceptedAnswer: { '@type': 'Answer', text: 'Setzen Sie APE ein, wenn das Denken für Ihre Aufgabe entscheidend ist: technische Analysen, Code-Reviews, Strategieentwicklung oder Situationen, in denen Fehler teuer sind. Nutzen Sie Single Step, wenn Ihr Ziel von vornherein klar ist und es Ihnen vor allem auf Ausführungsgeschwindigkeit ankommt.' } },
          { '@type': 'Question', name: 'Kann ich APE mit lokalen Modellen wie Ollama oder LM Studio nutzen?', acceptedAnswer: { '@type': 'Answer', text: 'Ja. APE funktioniert mit jedem Modell — mit Spitzenmodellen von OpenAI, Anthropic und Google ebenso wie mit lokalen Modellen über Ollama und LM Studio. Dieselbe dreistufige Struktur gilt auf allen Plattformen.' } },
          { '@type': 'Question', name: 'Wie lang muss ein APE-Prompt sein?', acceptedAnswer: { '@type': 'Answer', text: 'APE-Prompts können kompakt sein. Ein einzelner Absatz, der Analyse, Plan und Ausführung benennt und angibt, was Sie in jeder Stufe erwarten, genügt. Beim Framework geht es um Struktur, nicht um Länge.' } },
          { '@type': 'Question', name: 'Kann ich APE-Prompts in PromptQuorum als Vorlagen speichern?', acceptedAnswer: { '@type': 'Answer', text: 'Ja. Sobald Sie einen APE-strukturierten Prompt erstellt haben, der für einen bestimmten Ablauf gut funktioniert (etwa Code-Reviews oder Kundenzusammenfassungen), können Sie ihn in PromptQuorum als Vorlage speichern und mit Ihrem Team teilen.' } },
          { '@type': 'Question', name: 'Was, wenn meine Aufgabe für APE zu einfach ist?', acceptedAnswer: { '@type': 'Answer', text: 'Wenn Ihre Aufgabe unkompliziert ist und kein sichtbares Denken erfordert, genügt wahrscheinlich die Single-Step-Prompt-Methode. APE erzeugt zusätzlichen Aufwand — der Nutzen entsteht dadurch, dass Sie das Denken des Modells prüfen und nachschärfen können.' } },
          { '@type': 'Question', name: 'Woran erkenne ich, dass ein APE-Prompt gut funktioniert?', acceptedAnswer: { '@type': 'Answer', text: 'Lassen Sie Ihren APE-Prompt auf 3–5 repräsentativen Beispielen laufen und prüfen Sie: (1) Erfasst die Analyse die eigentliche Herausforderung? (2) Ist der Plan sinnvoll und umsetzbar? (3) Folgt die Ausführung dem Plan? Ist ein Schritt schwach, schärfen Sie den Prompt nach und testen Sie erneut.' } },
          { '@type': 'Question', name: 'Was ist der Unterschied zwischen APE (Analyse-Plan-Ausführung) und APE (Automatic Prompt Engineering)?', acceptedAnswer: { '@type': 'Answer', text: 'Sie teilen sich ein Akronym, sind aber völlig unterschiedliche Techniken. APE (Analyse-Plan-Ausführung) ist eine manuelle Prompt-Struktur, die Sie selbst schreiben. APE (Automatic Prompt Engineering, Zhou et al. 2022) ist eine Technik, bei der KI automatisch Prompt-Varianten erzeugt und bewertet, um die optimale Formulierung zu finden. Dieser Artikel behandelt beides — das Hauptframework ist Analyse-Plan-Ausführung; die automatisierte Prompt-Optimierung wird im letzten Abschnitt beschrieben.' } },
        ],
      },
    },
    es: {
    ...
    fr: {
      ...
      title: 'Le framework APE : Analyser, Planifier, Exécuter — des prompts structurés qui montrent leur raisonnement',
      ...
      educationalLevel: 'Intermediate',
      audience: 'Développeurs, analystes et travailleurs du savoir qui doivent vérifier le raisonnement de l\'IA sur des tâches complexes',
      ...
      ogTitle: 'Le framework APE : Analyser, Planifier, Exécuter — des prompts structurés qui montrent leur raisonnement',
      ogDescription: 'Fini les réponses IA en boîte noire. Le framework APE oblige le modèle à exposer son analyse, à annoncer son plan, puis à exécuter — vous repérez les écarts avant le résultat final.',
      twitterTitle: 'Framework APE : Analyser → Planifier → Exécuter',
      twitterDescription: 'Framework APE : Analyser → Planifier → Exécuter. Trois étapes qui transforment des réponses IA opaques en raisonnement traçable et inspectable.',
      quickFacts: [
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        headline: 'Le framework APE : Analyser, Planifier, Exécuter — des prompts structurés qui montrent leur raisonnement',
        description: 'Le framework APE divise chaque prompt IA en Analyser, Planifier et Exécuter — rendant le raisonnement du modèle visible et vérifiable. Modèle, exemples et comparaison aux autres frameworks.',
        datePublished: '2026-03-24',
        dateModified: '2026-08-31',
        ...
        'proficiencyLevel': 'Intermediate',
        speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
        keywords: ['Framework APE', 'Analyser Planifier Exécuter', 'frameworks de prompt', 'prompt engineering', 'raisonnement structuré', 'PromptQuorum'],
        author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
        about: [
          { '@type': 'Thing', name: 'Prompt Engineering' },
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          content: [
            '**APE signifie Analyser, Planifier, Exécuter** — une structure de prompt en trois étapes qui oblige le modèle à montrer son raisonnement avant de produire un résultat.',
            '**Utilisez APE quand le raisonnement compte :** analyses complexes, revues techniques, rédaction stratégique et décisions à fort enjeu où vous devez inspecter la réflexion du modèle.',
            '**APE réduit les erreurs en brisant les hypothèses implicites :** au lieu d\'une réponse unique, vous voyez comment le modèle a compris le problème et quel plan il a retenu.',
            '**PromptQuorum propose APE en option intégrée :** sélectionnez-le une fois, appliquez-le à plusieurs modèles en parallèle, enregistrez-le comme modèle réutilisable.',
            '**Face au prompt en une étape ou au multi-tours, APE est le juste milieu :** plus de structure qu\'une instruction unique, moins de lourdeur que de nombreux allers-retours.',
          ],
        },
        whatIsAPE: {
          title: 'Ce qu\'est le framework APE',
          content: [
        ...
        threeSteps: {
          title: 'Les trois étapes : Analyser, Planifier, Exécuter',
          content: [
            '**Le cœur du framework APE est que chaque prompt demande au modèle d\'analyser d\'abord le problème, de planifier ensuite la solution, et seulement après d\'exécuter la réponse finale.** Ces trois étapes reproduisent [la façon dont les humains raisonnent](/fr/prompt-engineering/chain-of-thought-prompting) et vous offrent des points de contrôle clairs.',
        ...
        whenToUse: {
          title: 'Quand utiliser le framework APE',
          content: [
          ...
          callouts: [
            { type: 'warning', label: 'Attention', text: 'APE consomme des tokens supplémentaires : les étapes Analyser et Planifier produisent des tokens de sortie avant l\'exécution finale. Pour des tâches de production à fort volume où seul le résultat final vous intéresse et où vous n\'inspectez pas le raisonnement, préférez un prompt simple en une étape afin de réduire coût et latence.' },
          ],
        },
        howToWrite: {
          title: 'Comment rédiger un prompt APE',
          content: [
          ...
          callouts: [
            { type: 'pro-tip', label: 'Astuce', text: 'Lisez l\'analyse et le plan AVANT de regarder le résultat de l\'exécution. Si l\'analyse a manqué une contrainte ou si le plan contient une étape erronée, demandez au modèle de corriger : c\'est plus rapide et moins coûteux que de régénérer la réponse entière.' },
          ],
        },
        badVsGoodExample: {
          title: 'Exemple : mauvais prompt vs bon prompt APE',
          content: [
        ...
        howPQImplements: {
          title: 'Comment PromptQuorum implémente le framework APE',
          content: [
        ...
        choosingAPE: {
          title: 'APE ou un autre framework ?',
          content: [
          ...
          items: [
            ...
            'Choisissez un [framework de type une étape](/fr/prompt-engineering/the-single-step-prompt-method) quand vous connaissez déjà le format de sortie exact et n\'avez besoin que d\'une instruction bien spécifiée.',
          ...
          columns: ['Framework', 'Étapes/Sections', 'Idéal pour', 'Raisonnement visible ?'],
          rows: [
            { Framework: 'APE', 'Étapes/Sections': '3 (Analyser, Planifier, Exécuter)', 'Idéal pour': 'Tâches complexes au raisonnement inspectable', 'Raisonnement visible ?': 'Oui — étapes explicites' },
            { Framework: 'Une étape', 'Étapes/Sections': '1 (une instruction)', 'Idéal pour': 'Tâches simples et bien définies', 'Raisonnement visible ?': 'Non' },
            { Framework: 'CRAFT', 'Étapes/Sections': '5 (Context, Role, Action, Format, Target)', 'Idéal pour': 'Définition de contexte exhaustive', 'Raisonnement visible ?': 'Optionnel' },
            { Framework: 'CO-STAR', 'Étapes/Sections': '6 (Context, Objective, Style, Tone, Audience, Response)', 'Idéal pour': 'Marketing et communication', 'Raisonnement visible ?': 'Non' },
            { Framework: 'SPECS', 'Étapes/Sections': '5 (Situation, Problem, Examples, Constraints, Style)', 'Idéal pour': 'Résolution de problèmes avec exemples', 'Raisonnement visible ?': 'Optionnel' },
            { Framework: 'Chain-of-Thought', 'Étapes/Sections': '1 (avec « réfléchis étape par étape »)', 'Idéal pour': 'Mathématiques, logique, raisonnement en une passe', 'Raisonnement visible ?': 'Oui — mais non structuré' },
          ],
          tableFormat: true,
          callouts: [
            { type: 'info', label: 'Le saviez-vous ?', text: 'La structure en trois étapes d\'APE reproduit la façon dont les experts humains abordent un problème complexe : comprendre le problème (Analyser), concevoir l\'approche (Planifier), puis produire le livrable (Exécuter). Les recherches en sciences cognitives montrent que cette séparation réduit les erreurs, chez l\'humain comme dans le raisonnement des IA.' },
          ],
        },

        automaticPromptEngineering: {
          title: 'APE désigne aussi : Automatic Prompt Engineering (concept différent)',
          content: [
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'En quoi APE diffère-t-il du fait de simplement demander une réponse à un modèle ?', a: 'Avec APE, vous avez une visibilité sur le processus de réflexion du modèle. Au lieu d\'une seule réponse, vous voyez comment le modèle a compris votre tâche, quel plan il a choisi et quel est le résultat final. Les erreurs sont ainsi plus faciles à repérer et les résultats plus fiables.' },
            { q: 'Quand devrais-je utiliser APE plutôt que la méthode du prompt en une étape ?', a: 'Utilisez APE quand le raisonnement est critique pour votre tâche : analyse technique, revues de code, développement de stratégie, ou situations où les erreurs coûtent cher. Utilisez le prompt en une étape quand votre objectif est clair dès le départ et que vous cherchez surtout de la rapidité d\'exécution.' },
            ...
            { q: 'Quelle longueur doit avoir un prompt APE ?', a: 'Les prompts APE peuvent être compacts. Un seul paragraphe qui mentionne Analyser, Planifier et Exécuter et précise ce que vous attendez à chaque étape suffit. Le framework porte sur la structure, pas sur la longueur.' },
            { q: 'Puis-je enregistrer les prompts APE comme modèles dans PromptQuorum ?', a: 'Oui. Une fois que vous avez créé un prompt structuré en APE qui fonctionne bien pour un flux de travail donné (revues de code, résumés clients, etc.), vous pouvez l\'enregistrer comme modèle dans PromptQuorum et le partager avec votre équipe.' },
            { q: 'Et si ma tâche est trop simple pour APE ?', a: 'Si votre tâche est directe et ne nécessite pas de raisonnement visible, la méthode du prompt en une étape suffit probablement. APE ajoute de la lourdeur — sa valeur vient de la possibilité d\'inspecter et d\'affiner le raisonnement du modèle.' },
            { q: 'Comment savoir si un prompt APE fonctionne bien ?', a: 'Exécutez votre prompt APE sur 3 à 5 exemples représentatifs et vérifiez : (1) L\'analyse capture-t-elle l\'enjeu principal ? (2) Le plan est-il raisonnable et réalisable ? (3) L\'exécution suit-elle le plan ? Si une étape est faible, affinez le prompt et testez à nouveau.' },
        ...
        relatedReading: {
          title: 'À lire aussi',
          items: [
            '[Chain-of-Thought Prompting](/fr/prompt-engineering/chain-of-thought-prompting) — la technique de raisonnement qu\'APE formalise en trois étapes',
            '[Quel framework de prompt utiliser ?](/fr/prompt-engineering/which-prompt-framework-should-you-use) — APE face à CRAFT, CO-STAR et SPECS',
            '[La méthode du prompt en une étape](/fr/prompt-engineering/the-single-step-prompt-method) — quand vous n\'avez PAS besoin des trois étapes d\'APE',
            '[5 briques indispensables à tout prompt](/fr/prompt-engineering/5-building-blocks-every-prompt-needs) — les briques universelles qu\'APE organise en étapes',
            '[Persona Prompting](/fr/prompt-engineering/persona-prompting) — à combiner avec la définition de rôle d\'APE pour des analyses métier',
            '[Chaînage de prompts](/fr/prompt-engineering/prompt-chaining) — pour les tâches trop complexes pour un seul prompt APE, enchaînez plusieurs étapes APE',
          ],
        },
        ...
        sources: {
          title: 'Sources',
          items: [
            '[White et al. (2023). « A Prompt Pattern Catalog to Enhance Prompt Engineering with ChatGPT. » arXiv:2302.11382](https://arxiv.org/abs/2302.11382) — taxonomie des patrons de prompt, dont les patrons de raisonnement structuré',
            '[Zhou et al. (2022). « Large Language Models Are Human-Level Prompt Engineers. » arXiv:2211.01910](https://arxiv.org/abs/2211.01910) — l\'article fondateur sur l\'Automatic Prompt Engineering (APE)',
            '[Anthropic. « Prompt Engineering Guide. » docs.anthropic.com](https://docs.anthropic.com) — bonnes pratiques de prompting structuré',
            '[OpenAI. « Prompt Engineering Guide. » platform.openai.com](https://platform.openai.com/docs) — raisonnement étape par étape et sortie structurée',
          ],
        },
      },
      faqSchema: {
        ...
        inLanguage: 'fr',
        mainEntity: [
          { '@type': 'Question', name: 'Que signifie APE ?', acceptedAnswer: { '@type': 'Answer', text: 'APE signifie Analyser, Planifier, Exécuter. C\'est un framework de prompt en trois étapes qui divise le raisonnement complexe en trois phases explicites : la compréhension du problème, la planification d\'une approche et l\'exécution de la solution.' } },
          { '@type': 'Question', name: 'En quoi APE diffère-t-il du fait de simplement demander une réponse à un modèle ?', acceptedAnswer: { '@type': 'Answer', text: 'Avec APE, vous avez une visibilité sur le processus de réflexion du modèle. Au lieu d\'une seule réponse, vous voyez comment le modèle a compris votre tâche, quel plan il a choisi et quel est le résultat final. Les erreurs sont ainsi plus faciles à repérer et les résultats plus fiables.' } },
          { '@type': 'Question', name: 'Quand devrais-je utiliser APE plutôt que la méthode du prompt en une étape ?', acceptedAnswer: { '@type': 'Answer', text: 'Utilisez APE quand le raisonnement est critique pour votre tâche : analyse technique, revues de code, développement de stratégie, ou situations où les erreurs coûtent cher. Utilisez le prompt en une étape quand votre objectif est clair dès le départ et que vous cherchez surtout de la rapidité d\'exécution.' } },
          { '@type': 'Question', name: 'Puis-je utiliser APE avec des modèles locaux comme Ollama ou LM Studio ?', acceptedAnswer: { '@type': 'Answer', text: 'Oui. APE fonctionne avec n\'importe quel modèle — modèles de pointe d\'OpenAI, Anthropic et Google, ou modèles locaux via Ollama et LM Studio. La même structure en trois étapes s\'applique sur toutes les plateformes.' } },
          { '@type': 'Question', name: 'Quelle longueur doit avoir un prompt APE ?', acceptedAnswer: { '@type': 'Answer', text: 'Les prompts APE peuvent être compacts. Un seul paragraphe qui mentionne Analyser, Planifier et Exécuter et précise ce que vous attendez à chaque étape suffit. Le framework porte sur la structure, pas sur la longueur.' } },
          { '@type': 'Question', name: 'Puis-je enregistrer les prompts APE comme modèles dans PromptQuorum ?', acceptedAnswer: { '@type': 'Answer', text: 'Oui. Une fois que vous avez créé un prompt structuré en APE qui fonctionne bien pour un flux de travail donné (revues de code, résumés clients, etc.), vous pouvez l\'enregistrer comme modèle dans PromptQuorum et le partager avec votre équipe.' } },
          { '@type': 'Question', name: 'Et si ma tâche est trop simple pour APE ?', acceptedAnswer: { '@type': 'Answer', text: 'Si votre tâche est directe et ne nécessite pas de raisonnement visible, la méthode du prompt en une étape suffit probablement. APE ajoute de la lourdeur — sa valeur vient de la possibilité d\'inspecter et d\'affiner le raisonnement du modèle.' } },
          { '@type': 'Question', name: 'Comment savoir si un prompt APE fonctionne bien ?', acceptedAnswer: { '@type': 'Answer', text: 'Exécutez votre prompt APE sur 3 à 5 exemples représentatifs et vérifiez : (1) L\'analyse capture-t-elle l\'enjeu principal ? (2) Le plan est-il raisonnable et réalisable ? (3) L\'exécution suit-elle le plan ? Si une étape est faible, affinez le prompt et testez à nouveau.' } },
          { '@type': 'Question', name: 'Quelle est la différence entre APE (Analyser-Planifier-Exécuter) et APE (Automatic Prompt Engineering) ?', acceptedAnswer: { '@type': 'Answer', text: 'Ils partagent un acronyme mais ce sont des techniques complètement différentes. APE (Analyser-Planifier-Exécuter) est une structure de prompt manuelle que vous rédigez vous-même. APE (Automatic Prompt Engineering, Zhou et al. 2022) est une technique où l\'IA génère et note automatiquement des variantes de prompt pour trouver la formulation optimale. Cet article couvre les deux — le framework principal est Analyser-Planifier-Exécuter ; l\'optimisation automatique est traitée dans la dernière section.' } },
        ],
      },
    },
    ja: {
      ...
      title: 'APEフレームワーク：分析・計画・実行 — 推論プロセスを見せる構造化プロンプト',
      intro: '**APEフレームワークは、Analyze（分析）・Plan（計画）・Execute（実行）の3ステップで構成されたシンプルなプロンプト構造です。1つの指示から、大規模言語モデルが明確で追跡可能な出力を生成できます。** PromptQuorumでは、APEフレームワークをすぐに使えるオプションとして提供しており、対応するすべてのモデルに適用できます。',
      publishDate: '2026-03-24',
      readTime: '7分で読める',
      educationalLevel: 'Intermediate',
      audience: '複雑なタスクでAIの推論を検証する必要がある開発者、アナリスト、ナレッジワーカー',
      seoTitle: 'APEフレームワーク：AIの推論を見せる構造化プロンプト',
      metaDescription: 'APEフレームワーク（分析・計画・実行）はAIの推論を透明化し、検証可能にします。テンプレート、他フレームワークとの比較、実装ガイドを収録。',
      ogTitle: 'APEフレームワーク：分析・計画・実行 — 推論プロセスを見せる構造化プロンプト',
      ogDescription: 'ブラックボックスなAI回答から脱却しましょう。APEフレームワークはモデルに分析を示させ、計画を明言させ、その後に実行させます。最終出力の前にズレを発見できます。',
      twitterTitle: 'APEフレームワーク：分析 → 計画 → 実行',
      twitterDescription: 'APEフレームワーク：分析 → 計画 → 実行。不透明なAI回答を、追跡・検証可能な推論に変える3つのステップです。',
      quickFacts: [
        '**APEの意味：** 分析（Analyze） → 計画（Plan） → 実行（Execute）',
        '**目的：** 最終出力の前にAIの推論を可視化し、検証可能にする',
        '**使う場面：** 推論が重要な複雑・高リスクのタスク（分析、戦略、コードレビュー、リサーチ）',
        '**使わない場面：** 単純な事実確認、短いタスク、簡易ドラフト',
        '**複雑さ：** 3段階 — CRAFT（5）、CO-STAR（6）、SPECS（5）よりシンプル',
        '**対応：** すべての言語モデル — クラウドAPIおよびOllama/LM Studio経由のローカルモデル',
      ],
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        headline: 'APEフレームワーク：分析・計画・実行 — 推論プロセスを見せる構造化プロンプト',
        description: 'APEフレームワークは、すべてのAIプロンプトを分析・計画・実行に分割し、モデルの推論を可視化して検証可能にします。テンプレート、実例、他フレームワークとの比較を掲載。',
        datePublished: '2026-03-24',
        dateModified: '2026-08-31',
        ...
        'proficiencyLevel': 'Intermediate',
        speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
        keywords: ['APEフレームワーク', 'Analyze Plan Execute', 'プロンプトフレームワーク', 'プロンプトエンジニアリング', '構造化推論', 'PromptQuorum'],
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          content: [
            '**APEはAnalyze（分析）、Plan（計画）、Execute（実行）の略です** — 出力を生成する前に、モデルに推論を提示させる3ステップのプロンプト構造です。',
            '**推論が重要な場面でAPEを使います：** 複雑な分析、技術レビュー、戦略的な文章作成、そしてモデルの思考を検証する必要がある高リスクの意思決定です。',
            '**APEは暗黙の前提を分解することでエラーを減らします：** 単一の回答ではなく、モデルが問題をどう理解し、どの計画を選んだのかが見えます。',
            '**PromptQuorumはAPEを標準オプションとして提供しています：** 一度選択すれば複数モデルに並列適用でき、テンプレートとして保存できます。',
            '**シングルステップやマルチターンのプロンプトと比べると、APEは中間的な選択肢です：** 単一指示より構造化されており、何度もやり取りするより負担が軽くなります。',
          ],
        },
        whatIsAPE: {
          title: 'APEフレームワークとは',
        ...
        threeSteps: {
          title: '3つのステップ：分析・計画・実行',
          content: [
            '**APEフレームワークの核心は、すべてのプロンプトがモデルに対して、まず問題を分析し、次に解決策を計画し、その後で初めて最終回答を実行するよう指示する点にあります。** この3ステップは[人間が推論を進める方法](/ja/prompt-engineering/chain-of-thought-prompting)に直接対応しており、明確なチェックポイントを提供します。',
        ...
        whenToUse: {
          ...
          callouts: [
            { type: 'warning', label: '注意', text: 'APEはトークンのオーバーヘッドを追加します。分析と計画の段階が、最終的な実行の前に出力トークンを消費するためです。最終回答だけが必要で推論を検証しない大量処理の本番タスクでは、よりシンプルなシングルステップのプロンプトを使い、コストとレイテンシを抑えてください。' },
          ],
        },
        howToWrite: {
          title: 'APEプロンプトの書き方',
          content: [
            ...
            '汎用パターンは次のとおりです。',
            '「あなたは[役割]です。まず、主要な目標・制約・不足情報を列挙してタスクを**分析**してください。次に、アプローチを3〜5個の箇条書きで**計画**してください。最後に、計画に厳密に従って[希望する出力形式]を生成し、**実行**してください。」',
            'この基本パターンには、対象読者、トーン、ファイル構成、引用要件といったドメイン固有の詳細を追加できます。一度定義すれば、目的とコンテキストを変えるだけで同じAPEプロンプトを複数のタスクに再利用できます。',
          ],
          callouts: [
            { type: 'pro-tip', label: 'プロのヒント', text: 'モデルが分析と計画を完了したら、実行結果を見る**前**にそれらを読んでください。分析が制約を見落としていたり、計画に誤ったステップがあれば、モデルに修正を指示します。応答全体を再生成するより安価かつ高速です。' },
          ],
        },
        badVsGoodExample: {
          title: '実例：悪いAPEプロンプトと良いAPEプロンプト',
          content: [
        ...
        howPQImplements: {
          title: 'PromptQuorumにおけるAPEフレームワークの実装',
          content: [
        ...
        choosingAPE: {
          ...
          items: [
            ...
            '出力形式が既に決まっており、よく指定された指示が1つあれば足りる場合は[シングルステップ型のフレームワーク](/ja/prompt-engineering/the-single-step-prompt-method)を選びます。',
            'プロンプトに反映すべき厳格な社内標準がある場合にのみ、より詳細なフレームワーク（多数のセクションとパラメータを持つもの）を選びます。',
          ],
          columns: ['フレームワーク', '段階/セクション数', '適した用途', '推論は可視化されるか'],
          rows: [
            { 'フレームワーク': 'APE', '段階/セクション数': '3（分析、計画、実行）', '適した用途': '推論の検証が必要な複雑なタスク', '推論は可視化されるか': 'はい — 明示的な段階' },
            { 'フレームワーク': 'シングルステップ', '段階/セクション数': '1（単一の指示）', '適した用途': 'シンプルで明確に定義されたタスク', '推論は可視化されるか': 'いいえ' },
            { 'フレームワーク': 'CRAFT', '段階/セクション数': '5（Context, Role, Action, Format, Target）', '適した用途': '包括的なコンテキスト定義', '推論は可視化されるか': '任意' },
            { 'フレームワーク': 'CO-STAR', '段階/セクション数': '6（Context, Objective, Style, Tone, Audience, Response）', '適した用途': 'マーケティングとコミュニケーション', '推論は可視化されるか': 'いいえ' },
            { 'フレームワーク': 'SPECS', '段階/セクション数': '5（Situation, Problem, Examples, Constraints, Style）', '適した用途': '実例を用いた問題解決', '推論は可視化されるか': '任意' },
            { 'フレームワーク': 'Chain-of-Thought', '段階/セクション数': '1（「ステップバイステップで考えて」を付加）', '適した用途': '数学、論理、単一パスの推論', '推論は可視化されるか': 'はい — ただし非構造的' },
          ],
          tableFormat: true,
          callouts: [
            { type: 'info', label: '豆知識', text: 'APEの3段階構造は、人間の専門家が複雑な問題に取り組む方法と直接対応しています。問題を理解し（分析）、アプローチを設計し（計画）、成果物を生成する（実行）という流れです。認知科学の研究では、この分離が人間とAIの双方で推論エラーを減らすことが示されています。' },
          ],
        },

        automaticPromptEngineering: {
          title: 'APEのもう1つの意味：Automatic Prompt Engineering（別概念）',
          content: [
          ...
          numberedItems: [
            '**タスク、成功指標、いくつかのシード例を定義します。** 例：タスク＝「顧客フィードバックの感情を分類する」。成功指標＝「ラベル付き20件での正解率」。シード例＝正しい感情ラベル付きの多様な顧客メッセージ3件。',
            '**APEツールまたはChatGPTでプロンプト候補を自動生成します。** タスクと例を渡し、「このタスクを解けそうなプロンプトのバリエーションを5つ生成してください。指示スタイル、例、制約を変えてください」と依頼します。各候補をテストセットで評価します。',
            '**各候補を成功指標で採点します。** すべての候補をホールドアウトした例で実行し、正解率、速度、コストを記録します。APEの狙いは、手作業の試行錯誤なしに最良のプロンプトを見つけることです。',
            '**反復します：上位2つの候補を選び、オプティマイザにその変異版を生成させます。** 候補3が正解率85%、候補5が82%だった場合、「候補3に近いが[特定の調整]を加えたバリエーションを生成して」と依頼します。段階的に洗練させていきます。',
            '**強いプロンプトが得られたら、新しいデータでテストして汎化を確認します。** 最適化したプロンプトはテストセットで良好でしたが、未知の新しい例でも機能するか検証してください。性能が落ちる場合、テストデータに過剰適合している可能性があります。',
          ],
        },
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'モデルに単に答えを求めるのと、APEはどう違いますか？', a: 'APEを使うと、モデルの思考プロセスが見えるようになります。単一の回答ではなく、モデルがタスクをどう理解し、どの計画を選び、最終出力がどうなったかが分かります。そのためエラーを発見しやすく、結果の信頼性が高まります。' },
            { q: 'シングルステップ・プロンプト法ではなくAPEを使うべきなのはいつですか？', a: '推論がタスクにとって重要な場合にAPEを使ってください。技術分析、コードレビュー、戦略立案、エラーのコストが高い状況などです。目的が最初から明確で、主に実行速度が必要な場合はシングルステップを使ってください。' },
            { q: 'OllamaやLM Studioのようなローカルモデルでも使えますか？', a: 'はい。APEはどのモデルでも機能します。OpenAI、Anthropic、Googleのフロンティアモデルでも、OllamaやLM Studio経由のローカルモデルでも同様です。同じ3ステップ構造がすべてのプラットフォームで適用できます。' },
            { q: 'APEプロンプトはどれくらいの長さが必要ですか？', a: 'APEプロンプトはコンパクトで構いません。分析・計画・実行に言及し、各段階で期待する内容を指定した1段落があれば十分です。このフレームワークが扱うのは構造であって、長さではありません。' },
            { q: 'APEプロンプトをPromptQuorumのテンプレートとして保存できますか？', a: 'はい。特定のワークフロー（コードレビュー、顧客要約など）でうまく機能するAPE構造のプロンプトを作成したら、PromptQuorumにテンプレートとして保存し、チームと共有できます。' },
            { q: 'タスクがAPEには単純すぎる場合はどうすればよいですか？', a: 'タスクが単純で可視化された推論を必要としないなら、シングルステップ・プロンプト法で十分でしょう。APEはオーバーヘッドを追加します。その価値は、モデルの推論を検証し洗練できる点にあります。' },
            { q: 'APEプロンプトがうまく機能しているかどうかは、どう判断しますか？', a: '代表的な例3〜5件でAPEプロンプトを実行し、次を確認してください。（1）分析は本質的な課題を捉えているか。（2）計画は妥当で実行可能か。（3）実行は計画に従っているか。いずれかの段階が弱ければ、プロンプトを改善して再テストします。' },
            { q: 'APE（Analyze-Plan-Execute）とAPE（Automatic Prompt Engineering）の違いは何ですか？', a: '頭字語は同じですが、まったく異なる技術です。APE（Analyze-Plan-Execute）は自分で書く手動のプロンプト構造です。APE（Automatic Prompt Engineering, Zhou et al. 2022）は、AIが自動的にプロンプト候補を生成・採点して最適な表現を見つける技術です。この記事は両方を扱っています。主なフレームワークはAnalyze-Plan-Executeで、自動プロンプト最適化は最終セクションで説明しています。' },
          ],
        },
        relatedReading: {
          title: '関連記事',
          items: [
            '[Chain-of-Thoughtプロンプティング](/ja/prompt-engineering/chain-of-thought-prompting) — APEが3段階に形式化した推論技術',
            '[どのプロンプトフレームワークを使うべきか？](/ja/prompt-engineering/which-prompt-framework-should-you-use) — APE、CRAFT、CO-STAR、SPECSの比較',
            '[シングルステップ・プロンプト法](/ja/prompt-engineering/the-single-step-prompt-method) — APEの3段階が必要ではない場合',
            '[すべてのプロンプトに必要な5つの構成要素](/ja/prompt-engineering/5-building-blocks-every-prompt-needs) — APEの各段階が整理する普遍的な構成要素',
            '[ペルソナ・プロンプティング](/ja/prompt-engineering/persona-prompting) — APEの役割定義と組み合わせて、専門領域の分析に活用',
            '[プロンプトチェーン](/ja/prompt-engineering/prompt-chaining) — 単一のAPEプロンプトには複雑すぎるタスクで、複数のAPEステップを連鎖させる',
          ],
        },
        ...
        sources: {
          title: '参考文献',
          items: [
            '[White et al. (2023). "A Prompt Pattern Catalog to Enhance Prompt Engineering with ChatGPT." arXiv:2302.11382](https://arxiv.org/abs/2302.11382) — 構造化推論パターンを含むプロンプトパターンの分類',
            '[Zhou et al. (2022). "Large Language Models Are Human-Level Prompt Engineers." arXiv:2211.01910](https://arxiv.org/abs/2211.01910) — Automatic Prompt Engineering（APE）の原論文',
            '[Anthropic. "Prompt Engineering Guide." docs.anthropic.com](https://docs.anthropic.com) — 構造化プロンプティングのベストプラクティス',
            '[OpenAI. "Prompt Engineering Guide." platform.openai.com](https://platform.openai.com/docs) — 段階的推論と構造化出力のガイダンス',
          ],
        },
      },
      faqSchema: {
        ...
        inLanguage: 'ja',
        mainEntity: [
          { '@type': 'Question', name: 'APEは何の略ですか？', acceptedAnswer: { '@type': 'Answer', text: 'APEはAnalyze（分析）、Plan（計画）、Execute（実行）の略です。複雑な推論を3つの明示的な段階に分割するプロンプトフレームワークです。問題の理解、アプローチの計画、解決策の実行という段階です。' } },
          { '@type': 'Question', name: 'モデルに単に答えを求めるのと、APEはどう違いますか？', acceptedAnswer: { '@type': 'Answer', text: 'APEを使うと、モデルの思考プロセスが見えるようになります。単一の回答ではなく、モデルがタスクをどう理解し、どの計画を選び、最終出力がどうなったかが分かります。そのためエラーを発見しやすく、結果の信頼性が高まります。' } },
          { '@type': 'Question', name: 'シングルステップ・プロンプト法ではなくAPEを使うべきなのはいつですか？', acceptedAnswer: { '@type': 'Answer', text: '推論がタスクにとって重要な場合にAPEを使ってください。技術分析、コードレビュー、戦略立案、エラーのコストが高い状況などです。目的が最初から明確で、主に実行速度が必要な場合はシングルステップを使ってください。' } },
          { '@type': 'Question', name: 'OllamaやLM Studioのようなローカルモデルでも使えますか？', acceptedAnswer: { '@type': 'Answer', text: 'はい。APEはどのモデルでも機能します。OpenAI、Anthropic、Googleのフロンティアモデルでも、OllamaやLM Studio経由のローカルモデルでも同様です。同じ3ステップ構造がすべてのプラットフォームで適用できます。' } },
          { '@type': 'Question', name: 'APEプロンプトはどれくらいの長さが必要ですか？', acceptedAnswer: { '@type': 'Answer', text: 'APEプロンプトはコンパクトで構いません。分析・計画・実行に言及し、各段階で期待する内容を指定した1段落があれば十分です。このフレームワークが扱うのは構造であって、長さではありません。' } },
          { '@type': 'Question', name: 'APEプロンプトをPromptQuorumのテンプレートとして保存できますか？', acceptedAnswer: { '@type': 'Answer', text: 'はい。特定のワークフロー（コードレビュー、顧客要約など）でうまく機能するAPE構造のプロンプトを作成したら、PromptQuorumにテンプレートとして保存し、チームと共有できます。' } },
          { '@type': 'Question', name: 'タスクがAPEには単純すぎる場合はどうすればよいですか？', acceptedAnswer: { '@type': 'Answer', text: 'タスクが単純で可視化された推論を必要としないなら、シングルステップ・プロンプト法で十分でしょう。APEはオーバーヘッドを追加します。その価値は、モデルの推論を検証し洗練できる点にあります。' } },
          { '@type': 'Question', name: 'APEプロンプトがうまく機能しているかどうかは、どう判断しますか？', acceptedAnswer: { '@type': 'Answer', text: '代表的な例3〜5件でAPEプロンプトを実行し、次を確認してください。（1）分析は本質的な課題を捉えているか。（2）計画は妥当で実行可能か。（3）実行は計画に従っているか。いずれかの段階が弱ければ、プロンプトを改善して再テストします。' } },
          { '@type': 'Question', name: 'APE（Analyze-Plan-Execute）とAPE（Automatic Prompt Engineering）の違いは何ですか？', acceptedAnswer: { '@type': 'Answer', text: '頭字語は同じですが、まったく異なる技術です。APE（Analyze-Plan-Execute）は自分で書く手動のプロンプト構造です。APE（Automatic Prompt Engineering, Zhou et al. 2022）は、AIが自動的にプロンプト候補を生成・採点して最適な表現を見つける技術です。この記事は両方を扱っています。主なフレームワークはAnalyze-Plan-Executeで、自動プロンプト最適化は最終セクションで説明しています。' } },
        ],
      },
    },
    zh: {
      ...
      title: 'APE框架：分析、规划、执行 —— 让推理过程可见的结构化提示词',
      intro: '**APE框架是一种简单的三步提示词结构，由分析（Analyze）、规划（Plan）、执行（Execute）组成，让大语言模型仅凭一条指令就能产出清晰、可追溯的结果。** 在PromptQuorum中，APE框架是一个开箱即用的选项，任何用户都可以选择并应用到所有受支持的模型上。',
      publishDate: '2026-03-24',
      readTime: '阅读约7分钟',
      educationalLevel: 'Intermediate',
      audience: '需要在复杂任务中验证AI推理过程的开发者、分析师和知识工作者',
      seoTitle: 'APE框架：让AI推理可见的结构化提示词',
      metaDescription: 'APE框架（分析-规划-执行）让AI推理透明且可审查。包含模板、与其他框架的对比以及落地实施指南。',
      ogTitle: 'APE框架：分析、规划、执行 —— 让推理过程可见的结构化提示词',
      ogDescription: '告别黑箱式AI回答。APE框架强制模型先展示分析、再说明计划、最后才执行——让你在最终输出之前就发现偏差。',
      twitterTitle: 'APE框架：分析 → 规划 → 执行',
      twitterDescription: 'APE框架：分析 → 规划 → 执行。三个步骤，把不透明的AI回答变成可追溯、可检查的推理过程。',
      quickFacts: [
        '**APE代表：** 分析（Analyze） → 规划（Plan） → 执行（Execute）',
        '**目的：** 在最终输出之前让AI的推理过程可见、可检查',
        '**适用场景：** 推理过程重要的复杂、高风险任务（分析、战略、代码审查、研究）',
        '**不适用场景：** 简单的事实性问题、短任务、快速草稿',
        '**复杂度：** 3个阶段——比CRAFT（5）、CO-STAR（6）、SPECS（5）更简单',
        '**适用于：** 所有语言模型——云端API以及通过Ollama/LM Studio运行的本地模型',
      ],
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        headline: 'APE框架：分析、规划、执行 —— 让推理过程可见的结构化提示词',
        description: 'APE框架把每个AI提示词拆分为分析、规划和执行，让模型的推理过程可见、可核查。包含模板、示例以及与其他框架的对比。',
        datePublished: '2026-03-24',
        dateModified: '2026-08-31',
        ...
        'proficiencyLevel': 'Intermediate',
        speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
        keywords: ['APE框架', '分析 规划 执行', '提示词框架', '提示词工程', '结构化推理', 'PromptQuorum'],
        author: { '@type': 'Organization', name: 'PromptQuorum' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
        about: [
      ...
      sections: {
        tldr: {
          ...
          isTldr: true,
          content: [
            '**APE代表分析、规划、执行** —— 一种三步提示词结构，强制模型在产出结果之前先展示推理过程。',
            '**推理过程重要时就用APE：** 复杂分析、技术评审、战略写作，以及需要检查模型思路的高风险决策。',
            '**APE通过打破隐含假设来减少错误：** 你看到的不再是单一答案，而是模型如何理解问题、选择了什么方案。',
            '**PromptQuorum内置APE选项：** 选择一次，即可并行应用到多个模型，并保存为模板。',
            '**相比单步提示词或多轮对话，APE是折中方案：** 比单条指令更有结构，比多轮往返更省事。',
          ],
        },
        whatIsAPE: {
          title: 'APE框架是什么',
        ...
        threeSteps: {
          title: '三个步骤：分析、规划、执行',
          content: [
            '**APE框架的核心在于：每个提示词都指示模型先分析问题，再规划解决方案，最后才执行给出最终答案。** 这三个步骤直接对应[人类处理推理的方式](/zh/prompt-engineering/chain-of-thought-prompting)，为你提供清晰的检查点。',
            '典型的拆分方式如下：',
          ],
          items: [
        ...
        whenToUse: {
          ...
          callouts: [
            { type: 'warning', label: '注意', text: 'APE会带来额外的token开销——分析和规划阶段会在最终执行之前消耗输出token。对于只需要最终答案、不检查推理过程的大批量生产任务，请改用更简单的单步提示词，以降低成本和延迟。' },
          ],
        },
        howToWrite: {
          title: '如何撰写APE提示词',
          content: [
            ...
            '通用模式如下：',
            '"你是[角色]。首先，**分析**这项任务，列出关键目标、约束条件和缺失信息。然后，用3–5条要点**规划**你的方案。最后，严格按照你的方案**执行**，产出[期望的输出格式]。"',
            '接着，你可以为这个基础模式补充领域细节，例如受众、语气、文件结构或引用要求。一旦定义完成，只需更改目标和上下文，就能把同一条APE提示词复用到多项任务上。',
          ],
          callouts: [
            { type: 'pro-tip', label: '专业提示', text: '模型完成分析和规划后，请在查看执行结果**之前**先读这两部分。如果分析遗漏了某个约束，或者方案中有一步是错的，就让模型修改——这比重新生成整个回答更省钱、更快。' },
          ],
        },
        badVsGoodExample: {
          title: '示例：糟糕的APE提示词与优秀的APE提示词',
          content: [
        ...
        choosingAPE: {
          ...
          items: [
            ...
            '如果你已经明确知道输出格式，只需要一条规格清晰的指令，就选[单步式框架](/zh/prompt-engineering/the-single-step-prompt-method)。',
            '只有当必须把严格的内部标准编码进提示词时，才选择更详细的框架（包含大量区块和参数）。',
          ],
          columns: ['框架', '阶段/区块数', '最适合', '推理是否可见'],
          rows: [
            { '框架': 'APE', '阶段/区块数': '3（分析、规划、执行）', '最适合': '需要可检查推理过程的复杂任务', '推理是否可见': '是——阶段明确' },
            { '框架': '单步式', '阶段/区块数': '1（一条指令）', '最适合': '简单、定义明确的任务', '推理是否可见': '否' },
            { '框架': 'CRAFT', '阶段/区块数': '5（Context, Role, Action, Format, Target）', '最适合': '全面的上下文定义', '推理是否可见': '可选' },
            { '框架': 'CO-STAR', '阶段/区块数': '6（Context, Objective, Style, Tone, Audience, Response）', '最适合': '营销与传播', '推理是否可见': '否' },
            { '框架': 'SPECS', '阶段/区块数': '5（Situation, Problem, Examples, Constraints, Style）', '最适合': '基于示例的问题解决', '推理是否可见': '可选' },
            { '框架': 'Chain-of-Thought', '阶段/区块数': '1（加上"一步步思考"）', '最适合': '数学、逻辑、单轮推理', '推理是否可见': '是——但不结构化' },
          ],
          tableFormat: true,
          callouts: [
            { type: 'info', label: '你知道吗', text: 'APE的三阶段结构直接对应人类专家处理复杂问题的方式：理解问题（分析）、设计方案（规划）、产出交付物（执行）。认知科学研究表明，这种分离能同时降低人类推理和AI推理中的错误率。' },
          ],
        },

        automaticPromptEngineering: {
          title: 'APE的另一个含义：Automatic Prompt Engineering（不同概念）',
          content: [
          ...
          numberedItems: [
            '**定义任务、成功指标和几个种子示例。** 例如：任务＝"对客户反馈进行情感分类"。成功指标＝"在20个带标签样本上的准确率"。种子示例＝3条带正确情感标签的多样化客户消息。',
            '**使用APE工具或ChatGPT自动生成提示词变体。** 提供你的任务和示例，然后要求："生成5个可能解决这项任务的不同提示词变体。在指令风格、示例和约束上做出变化。"再在测试集上评估每个变体。',
            '**按成功指标为每个变体打分。** 在留出样本上运行所有变体，记录准确率、速度和成本。APE的目标是在不做人工试错的情况下找到最优提示词。',
            '**迭代：选出得分最高的2个变体，让优化器基于它们生成变体。** 如果变体3的准确率为85%、变体5为82%，就要求优化器"生成与变体3类似但带有[具体调整]的变体"，逐步打磨。',
            '**得到强提示词后，在新数据上测试以确认其泛化能力。** 优化后的提示词在测试集上表现良好——现在要验证它在全新、未见过的样本上是否同样有效。如果性能下降，说明你可能对测试数据过拟合了。',
          ],
        },
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'APE与直接向模型要一个答案有什么区别？', a: '使用APE，你能看到模型的思考过程。得到的不是单一答案，而是模型如何理解你的任务、选择了什么方案，以及最终输出。这样更容易发现错误，结果也更可靠。' },
            { q: '什么时候该用APE而不是单步提示词方法？', a: '当推理过程对你的任务至关重要时使用APE：技术分析、代码审查、战略制定，或出错代价高昂的场景。如果目标一开始就很明确、主要追求执行速度，就用单步方法。' },
            { q: '可以在Ollama或LM Studio等本地模型上使用APE吗？', a: '可以。APE适用于任何模型——OpenAI、Anthropic和Google的前沿模型，或通过Ollama和LM Studio运行的本地模型。同样的三步结构适用于所有平台。' },
            { q: 'APE提示词需要多长？', a: 'APE提示词可以很紧凑。只要一个段落提到分析、规划和执行，并说明你对每个阶段的预期，就足够了。这个框架关乎结构，而非长度。' },
            { q: '可以把APE提示词保存为PromptQuorum中的模板吗？', a: '可以。当你创建出一条在特定工作流（例如代码审查、客户摘要）中表现良好的APE结构提示词后，就可以在PromptQuorum中把它保存为模板，并与团队共享。' },
            { q: '如果我的任务对APE来说太简单怎么办？', a: '如果任务很直接、不需要可见的推理过程，那么单步提示词方法很可能就够了。APE会增加额外开销——它的价值在于让你能够检查并改进模型的推理。' },
            { q: '如何判断一条APE提示词效果好不好？', a: '在3–5个有代表性的示例上运行你的APE提示词，然后检查：（1）分析是否抓住了核心挑战？（2）方案是否合理且可执行？（3）执行是否遵循了方案？如果某一步较弱，就改进提示词并重新测试。' },
            { q: 'APE（分析-规划-执行）和APE（Automatic Prompt Engineering）有什么区别？', a: '它们共用一个缩写，但是完全不同的技术。APE（分析-规划-执行）是你自己撰写的手动提示词结构。APE（Automatic Prompt Engineering，Zhou等人2022）是一项由AI自动生成并给提示词变体打分、以找到最优表述的技术。本文两者都涵盖——主框架是分析-规划-执行；自动提示词优化在最后一节介绍。' },
          ],
        },
        relatedReading: {
          title: '延伸阅读',
          items: [
            '[思维链提示词](/zh/prompt-engineering/chain-of-thought-prompting) —— APE将其形式化为三个阶段的推理技术',
            '[该用哪个提示词框架？](/zh/prompt-engineering/which-prompt-framework-should-you-use) —— APE与CRAFT、CO-STAR、SPECS的对比',
            '[单步提示词方法](/zh/prompt-engineering/the-single-step-prompt-method) —— 当你不需要APE三阶段的时候',
            '[每条提示词都需要的5个构件](/zh/prompt-engineering/5-building-blocks-every-prompt-needs) —— APE各阶段所组织的通用构件',
            '[角色提示词](/zh/prompt-engineering/persona-prompting) —— 与APE的角色定义结合，用于特定领域的分析',
            '[提示词链](/zh/prompt-engineering/prompt-chaining) —— 对于单条APE提示词过于复杂的任务，可串联多个APE步骤',
          ],
        },
        ...
        sources: {
          title: '来源',
          items: [
            '[White et al. (2023). "A Prompt Pattern Catalog to Enhance Prompt Engineering with ChatGPT." arXiv:2302.11382](https://arxiv.org/abs/2302.11382) —— 提示词模式分类法，包含结构化推理模式',
            '[Zhou et al. (2022). "Large Language Models Are Human-Level Prompt Engineers." arXiv:2211.01910](https://arxiv.org/abs/2211.01910) —— Automatic Prompt Engineering（APE）的原始论文',
            '[Anthropic. "Prompt Engineering Guide." docs.anthropic.com](https://docs.anthropic.com) —— 结构化提示词的最佳实践',
            '[OpenAI. "Prompt Engineering Guide." platform.openai.com](https://platform.openai.com/docs) —— 分步推理与结构化输出指南',
          ],
        },
      },
      faqSchema: {
        ...
        inLanguage: 'zh',
        mainEntity: [
          { '@type': 'Question', name: 'APE代表什么？', acceptedAnswer: { '@type': 'Answer', text: 'APE代表分析（Analyze）、规划（Plan）、执行（Execute）。这是一个三步骤的提示框架，将复杂推理分为三个明确的阶段：理解问题、规划方法和执行解决方案。' } },
          { '@type': 'Question', name: 'APE与直接向模型要一个答案有什么区别？', acceptedAnswer: { '@type': 'Answer', text: '使用APE，你能看到模型的思考过程。得到的不是单一答案，而是模型如何理解你的任务、选择了什么方案，以及最终输出。这样更容易发现错误，结果也更可靠。' } },
          { '@type': 'Question', name: '什么时候该用APE而不是单步提示词方法？', acceptedAnswer: { '@type': 'Answer', text: '当推理过程对你的任务至关重要时使用APE：技术分析、代码审查、战略制定，或出错代价高昂的场景。如果目标一开始就很明确、主要追求执行速度，就用单步方法。' } },
          { '@type': 'Question', name: '可以在Ollama或LM Studio等本地模型上使用APE吗？', acceptedAnswer: { '@type': 'Answer', text: '可以。APE适用于任何模型——OpenAI、Anthropic和Google的前沿模型，或通过Ollama和LM Studio运行的本地模型。同样的三步结构适用于所有平台。' } },
          { '@type': 'Question', name: 'APE提示词需要多长？', acceptedAnswer: { '@type': 'Answer', text: 'APE提示词可以很紧凑。只要一个段落提到分析、规划和执行，并说明你对每个阶段的预期，就足够了。这个框架关乎结构，而非长度。' } },
          { '@type': 'Question', name: '可以把APE提示词保存为PromptQuorum中的模板吗？', acceptedAnswer: { '@type': 'Answer', text: '可以。当你创建出一条在特定工作流（例如代码审查、客户摘要）中表现良好的APE结构提示词后，就可以在PromptQuorum中把它保存为模板，并与团队共享。' } },
          { '@type': 'Question', name: '如果我的任务对APE来说太简单怎么办？', acceptedAnswer: { '@type': 'Answer', text: '如果任务很直接、不需要可见的推理过程，那么单步提示词方法很可能就够了。APE会增加额外开销——它的价值在于让你能够检查并改进模型的推理。' } },
          { '@type': 'Question', name: '如何判断一条APE提示词效果好不好？', acceptedAnswer: { '@type': 'Answer', text: '在3–5个有代表性的示例上运行你的APE提示词，然后检查：（1）分析是否抓住了核心挑战？（2）方案是否合理且可执行？（3）执行是否遵循了方案？如果某一步较弱，就改进提示词并重新测试。' } },
          { '@type': 'Question', name: 'APE（分析-规划-执行）和APE（Automatic Prompt Engineering）有什么区别？', acceptedAnswer: { '@type': 'Answer', text: '它们共用一个缩写，但是完全不同的技术。APE（分析-规划-执行）是你自己撰写的手动提示词结构。APE（Automatic Prompt Engineering，Zhou等人2022）是一项由AI自动生成并给提示词变体打分、以找到最优表述的技术。本文两者都涵盖——主框架是分析-规划-执行；自动提示词优化在最后一节介绍。' } },
        ],
      },
    },
    ko: {
