...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    es: {
      ...
      schema: {
        ...
        datePublished: '2026-03-24',
        dateModified: '2026-05-04',
        url: 'https://www.promptquorum.com/es/es/prompt-engineering/ape-framework',
        inLanguage: 'es',
        speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
    ...
    ar: {
      ...
      metaDescription: 'إطار APE (التحليل-التخطيط-التنفيذ) يجعل استدلال الذكاء الاصطناعي شفافًا وقابلًا للتدقيق. يشمل قوالب ومقارنة مع الأطر الأخرى.',
