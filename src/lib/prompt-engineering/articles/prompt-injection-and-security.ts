...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      theme: 'Techniques',
      heroImage: '/images/prompt-injection-and-security-overview-hero-en.png',
...
def wrap_retrieved_context(doc_text: str, user_query: str) -> str:
    ...
    de: {
      theme: 'Techniques',
      heroImage: '/images/prompt-injection-and-security-overview-hero-de.png',
...
def wrap_retrieved_context(doc_text: str, user_query: str) -> str:
    ...
    es: {
      freshness_tier: 'semi_annual',
      theme: 'Techniques',
      heroImage: '/images/prompt-injection-and-security-overview-hero-es.png',
...
def is_injection_attempt(text: str) -> bool:`,
    ...
    ar: {
      freshness_tier: 'semi_annual',
      theme: 'Techniques',
      heroImage: '/images/prompt-injection-and-security-overview-hero-ar.png',
...
def is_injection_attempt(text: str) -> bool:`,
    ...
    pt: {
      theme: 'Techniques',
      heroImage: '/images/prompt-injection-and-security-overview-hero-pt.png',
...
def is_injection_attempt(text: str) -> bool:`,
    ...
    fr: {
      theme: 'Techniques',
      heroImage: '/images/prompt-injection-and-security-overview-hero-fr.png',
...
def wrap_retrieved_context(doc_text: str, user_query: str) -> str:
    ...
    ja: {
      theme: 'テクニック',
      heroImage: '/images/prompt-injection-and-security-overview-hero-ja.png',
...
def wrap_retrieved_context(doc_text: str, user_query: str) -> str:
    ...
    zh: {
      theme: '技术',
      heroImage: '/images/prompt-injection-and-security-overview-hero-zh.png',
...
def wrap_retrieved_context(doc_text: str, user_query: str) -> str:
  ...
  ko: {
    freshness_tier: 'semi_annual',
    theme: 'Techniques',
    heroImage: '/images/prompt-injection-and-security-overview-hero-ko.png',
