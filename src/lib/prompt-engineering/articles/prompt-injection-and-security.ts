...
def is_injection_attempt(text: str) -> bool:`,
    ...
    ar: {
      ...
      publishDate: '2026-03-30',
      seoTitle: 'حقن البرومبت 2026: كيف تحمي برومبتات الذكاء الاصطناعي',
      metaDescription: 'تعلّم أنماط الدفاع ضد حقن البرومبت والتحقق من المدخلات و sandboxing للنماذج اللغوية الكبيرة في السحابة ومحلياً. يتضمن قائمة مراجعة أمنية.',
...
def is_injection_attempt(text: str) -> bool:`,
    ...
    pt: {
      ...
      schema: {
        ...
        datePublished: '2026-03-30',
        url: 'https://www.promptquorum.com/pt/pt/prompt-engineering/prompt-injection-and-security',
        inLanguage: 'pt-BR',
        proficiencyLevel: 'Advanced',
