...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'اختبار Prompt Injection: أدوات Garak وPyRIT',
    metaDescription: 'Garak يغطي 40+ نمط هجوم وPyRIT يتيح red-teaming متعدد الجولات. دفاع بـ 4 طبقات: تصفية المدخلات، المخطط، فصل الصلاحيات، العزل.',
