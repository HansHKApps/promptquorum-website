...
export const article: Record<Language, PEArticle> = {
  ...
  fr: {
    ...
    metaDescription: 'Tests d\'injection de prompts : injection directe vs indirecte, outils (Garak, PyRIT, PromptQuorum), sanitisation des entrées, validation des sorties et couverture OWASP LLM Top 10.',
    ogDescription: 'Comment tester les prompts pour les vulnérabilités de sécurité — injection directe et indirecte, outils automatisés (Garak, PyRIT), red-teaming manuel et couverture OWASP LLM Top 10.',
    twitterDescription: 'Tests d\'injection de prompts : direct vs indirect, outils Garak et PyRIT, schémas de sanitisation des entrées. Couverture OWASP LLM Top 10.',
    publishDate: '2026-05-02',
