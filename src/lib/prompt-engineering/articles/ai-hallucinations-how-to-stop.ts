...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      metaDescription: 'افهم سبب هلوسة النماذج اللغوية الكبيرة وطبِّق تقنيات صياغة تعليمات مجرَّبة لتقليل الأخطاء. يشمل النماذج المحلية وآلية توافق PromptQuorum.',
