...
export const article: Partial<Record<Language, PEArticle>> = {
  en: {
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/es/es/prompt-engineering/pe-for-developers-workflow',
  ...
  ar: {
    ...
    seoTitle: 'هندسة البرومبت للمطوّرين: بيئة التطوير والتكامل المستمر',
    metaDescription: 'سير عمل البرومبت في 5 مراحل: Cursor/VS Code، اختبار Promptfoo في 30 ثانية، إصدار Git، بوابة CI/CD عند 85%، مراقبة الإنتاج.',
