      ...
      sections: {
        ...
        whatIsTRACE: {
          ...
          content: [
            ...
            'TRACE يعمل عبر جميع النماذج الرئيسية — GPT-5.6 (OpenAI) وClaude Opus 5 (Anthropic) وGemini 3 Pro (Google DeepMind) والنماذج المحلية عبر Ollama أو LM Studio — لكن النماذج تتبع المراحل الخمس بمستويات مختلفة من الانضباط. اختبار نفس طلب TRACE عبر نماذج متعددة يكشف أي مزود يستدل بشكل أكثر شفافية لمهمتك المحددة.',
          ],
          items: [
      ...
      sections: {
        ...
        howPQImplements: {
          ...
          items: [
            ...
            '同じプロンプトをGPT-5.6、Claude、Gemini等に並行送信して推論を比較',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'TRACEはモデル間で推論品質の差を見つけるのに役立つ？', a: 'はい。GPT-5.6、Claude、Geminiなど同じTRACEプロンプトを複数モデルに送れば、推論スタイルと精度の違いが明確に見えます。' },
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'はい。GPT-5.6、Claude、Geminiなど同じTRACEプロンプトを複数モデルに送れば、推論スタイルと精度の違いが明確に見えます。',
            },
          },
          {
            '@type': 'Question',
      ...
      sections: {
        ...
        howPQImplements: {
          ...
          items: [
            ...
            '同时发送给GPT-5.6、Claude、Gemini等模型，看谁推理最可靠',
            '保存TRACE模板，对同类问题快速复用',
          ],
        },
      ...
      sections: {
        ...
        whatIsTRACE: {
          ...
          content: [
            ...
            'TRACE는 GPT-5.6(OpenAI), Claude Opus 5(Anthropic), Gemini 3 Pro(Google DeepMind), 그리고 Ollama 또는 LM Studio를 통한 로컬 모델 등 모든 주요 모델에서 작동합니다. 단, 모델마다 다섯 단계를 따르는 수준이 다릅니다. 동일한 TRACE 프롬프트를 여러 모델에서 테스트하면 특정 작업에 대해 어떤 제공업체가 가장 투명하게 추론하는지 확인할 수 있습니다.',
          ],
          items: [
