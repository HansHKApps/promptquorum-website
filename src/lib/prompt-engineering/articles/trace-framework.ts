...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      theme: 'Frameworks',
      title: 'إطار TRACE',
      seoTitle: 'إطار TRACE: طلبات تكشف استدلال الذكاء الاصطناعي 2026',
      ...
      metaDescription: 'إطار TRACE (التفكير، الاستدلال، التحليل، الاستنتاج، الشرح) يُلزم الذكاء الاصطناعي بإظهار عمله. متى تستخدمه وكيف تكتب طلبات TRACE.',
      toc: [
