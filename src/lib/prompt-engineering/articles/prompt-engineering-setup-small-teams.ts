    ...
    sections: {
      ...
      sources: {
        ...
        items: [
          ...
          '[Google Gemini API Pricing](https://ai.google.dev/pricing) — Gemini 2.5 Pro context window and token rates',
    ...
    sections: {
      ...
      sources: {
        ...
        items: [
          ...
          '[Google Gemini API Pricing](https://ai.google.dev/pricing) — Ventana de contexto y tarifas de tokens de Gemini 2.5 Pro',
    ...
    sections: {
      ...
      sources: {
        ...
        items: [
          ...
          '[Google Gemini API Pricing](https://ai.google.dev/pricing) — Janela de contexto e tarifas de tokens do Gemini 2.5 Pro',
