...
export const article: Partial<Record<Language, PEArticle>> = {
  en: {
    ...
    theme: 'Workflows',
    heroImage: '/images/prompt-engineering-setup-small-teams-overview-hero-en.webp',
    ...
    sections: {
      ...
      modelSelection: {
        ...
        rows: [
          ...
          { 'Task type': 'Documents over 100k tokens', 'Recommended model': 'Gemini 3.1 Pro', 'Why': '1M-token context window; GPT-5.6 and Claude Sonnet 5 both cap at 200k tokens' },
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[How To Test Prompts Across Models](/prompt-engineering/how-to-test-prompts-across-models) — running the same prompt against GPT-5.6, Claude Sonnet 5, and Gemini 3.1 Pro to find the best performer per task',
      ...
      sources: {
        ...
        title: 'Sources',
        items: [
          '[OpenAI API Pricing](https://openai.com/api/pricing) — GPT-5.6 and GPT-5.6 mini input/output token rates used for cost estimates in this article',
          '[Anthropic API Pricing](https://www.anthropic.com/pricing) — Claude 4.6 Sonnet and Claude 4.5 Haiku token rates',
          '[Google Gemini API Pricing](https://ai.google.dev/pricing) — Gemini 3.1 Pro context window and token rates',
  ...
  de: {
    ...
    next_refresh_due: '2026-10-29',
    theme: 'Workflows',
    heroImage: '/images/prompt-engineering-setup-small-teams-overview-hero-de.webp',
    ...
    sections: {
      ...
      modelSelection: {
        ...
        rows: [
          ...
          { 'Aufgabentyp': 'Dokumente über 100k Token', 'Empfohlenes Modell': 'Gemini 3.1 Pro', 'Begründung': '1M-Token-Kontextfenster; GPT-5.6 und Claude Sonnet 5 sind beide auf 200k Token begrenzt' },
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Prompts modellübergreifend testen](/de/prompt-engineering/how-to-test-prompts-across-models) — denselben Prompt gegen GPT-5.6, Claude Sonnet 5 und Gemini 3.1 Pro ausführen, um den besten Performer pro Aufgabe zu finden',
      ...
      sources: {
        ...
        items: [
          ...
          '[Google Gemini API-Preise](https://ai.google.dev/pricing) — Gemini 3.1 Pro Kontextfenster und Token-Raten',
  ...
  es: {
    ...
    next_refresh_due: '2026-10-29',
    theme: 'Workflows',
    heroImage: '/images/prompt-engineering-setup-small-teams-overview-hero-es.webp',
    ...
    sections: {
      ...
      modelSelection: {
        ...
        content: [
          ...
          'GPT-5.6 de OpenAI y Claude 4.6 Sonnet de Anthropic son los dos modelos frontier más utilizados para el prompt engineering de producción a abril de 2026. Para documentos que superan los 100k tokens, añade Gemini 3.1 Pro. Para tareas de alto volumen sensibles al coste, usa Claude 4.5 Haiku o GPT-5.6 Luna.',
        ],
        ...
        rows: [
          ...
          { 'Tipo de tarea': 'Documentos de más de 100k tokens', 'Modelo recomendado': 'Gemini 3.1 Pro', 'Por qué': 'Ventana de contexto de 1M tokens; GPT-5.6 y Claude Sonnet 5 tienen un límite de 200k tokens' },
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Cómo probar prompts en múltiples modelos](/es/prompt-engineering/how-to-test-prompts-across-models) — ejecutar el mismo prompt en GPT-5.6, Claude Sonnet 5 y Gemini 3.1 Pro para encontrar el mejor rendimiento por tarea',
      ...
      sources: {
        ...
        title: 'Fuentes',
        items: [
          '[OpenAI API Pricing](https://openai.com/api/pricing) — Tarifas de tokens de entrada/salida de GPT-5.6 y GPT-5.6 mini usadas para estimaciones de coste en este artículo',
          '[Anthropic API Pricing](https://www.anthropic.com/pricing) — Tarifas de tokens de Claude 4.6 Sonnet y Claude 4.5 Haiku',
          '[Google Gemini API Pricing](https://ai.google.dev/pricing) — Ventana de contexto y tarifas de tokens de Gemini 3.1 Pro',
  ...
  pt: {
    theme: 'Workflows',
    heroImage: '/images/prompt-engineering-setup-small-teams-overview-hero-pt.webp',
    ...
    sections: {
      ...
      modelSelection: {
        ...
        content: [
          ...
          'GPT-5.6 da OpenAI e Claude 4.6 Sonnet da Anthropic são os dois modelos frontier mais usados para prompt engineering de produção em abril de 2026. Para documentos que excedem 100k tokens, adicione Gemini 3.1 Pro. Para tarefas de alto volume sensíveis ao custo, use Claude 4.5 Haiku ou GPT-5.6 Luna.',
        ],
        ...
        rows: [
          ...
          { 'Tipo de tarefa': 'Documentos com mais de 100k tokens', 'Modelo recomendado': 'Gemini 3.1 Pro', 'Por quê': 'Janela de contexto de 1M tokens; GPT-5.6 e Claude Sonnet 5 têm limite de 200k tokens' },
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Como testar prompts em múltiplos modelos](/pt/prompt-engineering/how-to-test-prompts-across-models) — executar o mesmo prompt no GPT-5.6, Claude Sonnet 5 e Gemini 3.1 Pro para encontrar o melhor desempenho por tarefa',
      ...
      sources: {
        ...
        title: 'Fontes',
        items: [
          '[OpenAI API Pricing](https://openai.com/api/pricing) — Tarifas de tokens de entrada/saída do GPT-5.6 e GPT-5.6 mini usadas para estimativas de custo neste artigo',
          '[Anthropic API Pricing](https://www.anthropic.com/pricing) — Tarifas de tokens do Claude 4.6 Sonnet e Claude 4.5 Haiku',
          '[Google Gemini API Pricing](https://ai.google.dev/pricing) — Janela de contexto e tarifas de tokens do Gemini 3.1 Pro',
  ...
  fr: {
    ...
    next_refresh_due: '2026-10-29',
    theme: 'Workflows',
    heroImage: '/images/prompt-engineering-setup-small-teams-overview-hero-fr.webp',
    ...
    sections: {
      ...
      modelSelection: {
        ...
        rows: [
          ...
          { 'Type de tâche': 'Documents de plus de 100k tokens', 'Modèle recommandé': 'Gemini 3.1 Pro', 'Pourquoi': 'Fenêtre de contexte de 1M tokens ; GPT-5.6 et Claude Sonnet 5 sont limités à 200k tokens' },
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Tester les prompts sur plusieurs modèles](/fr/prompt-engineering/how-to-test-prompts-across-models) — exécuter le même prompt sur GPT-5.6, Claude Sonnet 5 et Gemini 3.1 Pro pour trouver le meilleur performer par tâche',
      ...
      sources: {
        ...
        items: [
          ...
          '[Tarifs API Google Gemini (avril 2026)](https://ai.google.dev/pricing) — fenêtre de contexte et taux de tokens Gemini 3.1 Pro',
  ...
  ja: {
    ...
    next_refresh_due: '2026-10-29',
    theme: 'ワークフロー',
    heroImage: '/images/prompt-engineering-setup-small-teams-overview-hero-ja.webp',
    ...
    sections: {
      ...
      modelSelection: {
        ...
        content: [
          ...
          'GPT-5.6（OpenAI）とClaude 4.6 Sonnet（Anthropic）は、[2026年4月時点で](/ja/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model)本番プロンプトエンジニアリングで最も広く使われている2つのフロンティアモデルです。100kトークンを超えるドキュメントにはGemini 3.1 Proを追加します。コスト重視の大量処理タスクにはClaude 4.5 HaikuまたはGPT-5.6 Lunaを使用します。',
        ],
        ...
        rows: [
          ...
          { 'タスクの種類': '100kトークン超えのドキュメント', '推奨モデル': 'Gemini 3.1 Pro', '理由': '100万トークンのコンテキストウィンドウ；GPT-5.6とClaude Sonnet 5は両方とも200kトークンが上限' },
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[複数モデルでのPromptテスト方法](/ja/prompt-engineering/how-to-test-prompts-across-models) — タスクごとのベストパフォーマーを見つけるためにGPT-5.6、Claude Sonnet 5、Gemini 3.1 Proで同じPromptを実行',
      ...
      sources: {
        ...
        items: [
          ...
          '[Google Gemini APIの料金（2026年4月）](https://ai.google.dev/pricing) — Gemini 3.1 Proのコンテキストウィンドウとトークンレート',
  ...
  zh: {
    ...
    next_refresh_due: '2026-10-29',
    theme: '工作流',
    heroImage: '/images/prompt-engineering-setup-small-teams-overview-hero-zh.webp',
    ...
    sections: {
      ...
      modelSelection: {
        ...
        title: '小团队如何选择AI模型',
        content: [
          '**大多数任务从GPT-5.6与Claude Sonnet 5对比开始；长上下文或编码任务扩展至Gemini 3.1 Pro。**',
        ...
        rows: [
          ...
          { '任务类型': '长上下文（100k+ tokens）', '推荐模型': 'Gemini 3.1 Pro', '原因': '100万token上下文；GPT-5.6和Claude均上限200k' },
      ...
      sources: {
        ...
        items: [
          ...
          '[Google Gemini API定价（2026年4月）](https://ai.google.dev/pricing) — Gemini 3.1 Pro和Flash token费率',
  ...
  ar: {
    ...
    next_refresh_due: '2026-10-29',
    theme: 'Workflows',
    heroImage: '/images/prompt-engineering-setup-small-teams-overview-hero-ar.webp',
    title: 'إعداد هندسة البرومبت للفرق الصغيرة (⁨2026⁩)',
    seoTitle: 'هندسة البرومبت للفرق الصغيرة: الأدوات وسير العمل',
    metaDescription: 'الفرق الصغيرة تدير البرومبتات عبر ⁨Slack⁩ مع عمل مكرر وانحدارات صامتة. مكتبة ⁨YAML⁩ و⁨Git⁩ و⁨20⁩ حالة اختبار تحل المشكلة في أسبوع.',
    ...
    sections: {
      ...
      modelSelection: {
        ...
        content: [
          ...
          'GPT-5.6 من OpenAI وClaude 4.6 Sonnet من Anthropic هما النموذجان الأكثر استخداماً لهندسة البرومبت الإنتاجية اعتباراً من أبريل 2026. للوثائق التي تتجاوز 100k رمز، أضف Gemini 3.1 Pro. للمهام عالية الحجم الحساسة للتكلفة، استخدم Claude 4.5 Haiku أو GPT-5.6 Luna.',
        ],
        ...
        rows: [
          ...
          { 'نوع المهمة': 'وثائق أكثر من 100k رمز', 'النموذج الموصى به': 'Gemini 3.1 Pro', 'السبب': 'نافذة سياق 1M رمز؛ GPT-5.6 وClaude Sonnet 5 لهما حد 200k رمز' },
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[كيفية اختبار البرومبتات عبر نماذج متعددة](/ar/prompt-engineering/how-to-test-prompts-across-models) — تشغيل البرومبت ذاته على GPT-5.6 وClaude Sonnet 5 وGemini 3.1 Pro للعثور على أفضل أداء حسب المهمة',
      ...
      sources: {
        ...
        items: [
          ...
          '[أسعار Google Gemini API (أبريل 2026)](https://ai.google.dev/pricing) — نافذة السياق وأسعار رموز Gemini 3.1 Pro',
  ...
  ko: {
    ...
    next_refresh_due: '2026-10-29',
    theme: '워크플로우',
    heroImage: '/images/prompt-engineering-setup-small-teams-overview-hero-ko.webp',
    ...
    sections: {
      ...
      modelSelection: {
        ...
        content: [
          ...
          '[OpenAI의 GPT-5.6](https://platform.openai.com/playground)와 [Anthropic의 Claude 4.6 Sonnet](https://docs.anthropic.com/)은 [2026년 4월 기준](/ko/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model) 프로덕션 프롬프트 엔지니어링에서 가장 널리 사용되는 두 개의 프론티어 모델입니다. 100k 토큰을 초과하는 문서의 경우 Gemini 3.1 Pro를 추가하십시오. 비용에 민감한 대용량 작업에는 Claude 4.5 Haiku 또는 GPT-5.6 Luna를 사용하십시오.',
        ],
        ...
        rows: [
          ...
          { '작업 유형': '100k 토큰 초과 문서', '권장 모델': 'Gemini 3.1 Pro', '이유': '100만 토큰 컨텍스트 창 제공. GPT-5.6와 Claude Sonnet 5은 모두 200k 토큰에서 제한됩니다.' },
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[여러 모델에서 프롬프트 테스트하는 방법](/ko/prompt-engineering/how-to-test-prompts-across-models) — GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro에서 동일한 프롬프트를 실행하여 작업별 최적 모델 찾기',
      ...
      sources: {
        ...
        items: [
          ...
          '[Google Gemini API 요금 (2026년 4월)](https://ai.google.dev/pricing) — Gemini 3.1 Pro 컨텍스트 창 및 토큰 요금',
