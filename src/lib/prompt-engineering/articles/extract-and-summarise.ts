    ...
    en: {
      ...
      sections: {
        ...
        toolTable: {
          ...
          columns: ['Tool', 'Link', 'Context Limit', 'Citation Quality', 'Best Use Case'],
          rows: [
            {
              Tool: 'NotebookLM (Google DeepMind)',
              Link: '[notebook.google.com](https://notebook.google.com)',
    ...
    de: {
      ...
      sections: {
        ...
        toolTable: {
          ...
          columns: ['Tool', 'Link', 'Kontextlimit', 'Qualität der Quellenangaben', 'Bester Anwendungsfall'],
          rows: [
            {
              Tool: 'NotebookLM (Google DeepMind)',
              Link: '[notebook.google.com](https://notebook.google.com)',
    ...
    es: {
      ...
      sections: {
        ...
        toolTable: {
          ...
          columns: ['Herramienta', 'Enlace', 'Límite de contexto', 'Calidad de citas', 'Mejor caso de uso'],
          rows: [
            {
              'Herramienta': 'NotebookLM (Google DeepMind)',
              'Enlace': '[notebook.google.com](https://notebook.google.com)',
            ...
            },
            {
              ...
              'Enlace': '[chatgpt.com](https://chatgpt.com)',
              'Límite de contexto': '1M tokens (~800 páginas)',
    ...
    ar: {
      ...
      sections: {
        ...
        toolTable: {
          ...
          columns: ['الأداة', 'الرابط', 'حد السياق', 'جودة الاقتباسات', 'أفضل حالة استخدام'],
          rows: [
            {
              'الأداة': 'NotebookLM (Google DeepMind)',
              'الرابط': '[notebook.google.com](https://notebook.google.com)',
            ...
            },
            {
              ...
              'الرابط': '[claude.ai](https://claude.ai)',
            ...
            },
            {
              ...
              'الرابط': '[chatgpt.com](https://chatgpt.com)',
              'حد السياق': '1M رمز (~800 صفحة)',
            ...
            },
            {
              ...
              'الرابط': '[gemini.google.com](https://gemini.google.com)',
              'حد السياق': '1M رمز (~800 صفحة)',
    ...
    pt: {
      ...
      sections: {
        ...
        toolTable: {
          ...
          columns: ['Ferramenta', 'Link', 'Limite de contexto', 'Qualidade de citações', 'Melhor caso de uso'],
          rows: [
            {
    ...
    fr: {
      ...
      sections: {
        ...
        toolTable: {
          ...
          columns: ['Outil', 'Lien', 'Limite de contexte', 'Qualité des citations', 'Meilleur cas d\'usage'],
          rows: [
            {
              Outil: 'NotebookLM (Google DeepMind)',
              'Lien': '[notebook.google.com](https://notebook.google.com)',
    ...
    ja: {
      ...
      sections: {
        ...
        toolTable: {
          ...
          columns: ['ツール', 'リンク', 'コンテキスト制限', '引用品質', '最適なユースケース'],
          rows: [
            {
              ツール: 'NotebookLM（Google DeepMind）',
              'リンク': '[notebook.google.com](https://notebook.google.com)',
            ...
            {
              ツール: 'GPT-5.6（OpenAI）',
              'リンク': '[chatgpt.com](https://chatgpt.com)',
            ...
            },
            {
              ...
              'リンク': '[gemini.google.com](https://gemini.google.com)',
    ...
    zh: {
      ...
      sections: {
        ...
        toolTable: {
          ...
          columns: ['工具', '链接', '上下文限制', '引文质量', '最佳用途'],
          rows: [
            {
              '工具': 'NotebookLM（Google DeepMind）',
              '链接': '[notebook.google.com](https://notebook.google.com)',
              '上下文限制': '约500K字/50个源',
              '引文质量': '内联编号引文，可点击',
              '最佳用途': '结构化研究审查、源忠实问答',
            },
  ...
  ko: {
    ...
    sections: {
      ...
      toolTable: {
        ...
        columns: ['도구', '링크', '컨텍스트 한계', '인용 품질', '최적 사용 사례'],
        rows: [
          {
            '도구': 'NotebookLM(Google DeepMind)',
            '링크': '[notebook.google.com](https://notebook.google.com)',
