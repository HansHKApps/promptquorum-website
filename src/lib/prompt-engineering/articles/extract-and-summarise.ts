...
export const article: Record<Language, PEArticle> = {
    en: {
      ...
      seoTitle: 'AI Summarisation: Extractive vs Abstractive Methods Compared',
      metaDescription: 'Extractive summaries have 0% hallucination risk. Abstractive methods hallucinate at 0.7–14%. Learn which method to use for legal, financial, and research docs — with prompt templates for GPT, Claude, and Gemini.',
    ...
    de: {
      ...
      ogDescription: 'Rechtsdokumente brauchen extraktiv. Management-Summaries brauchen abstraktiv. Falsche Wahl = erfundene Fakten.',
      twitterTitle: 'KI-Zusammenfassung: Extraktiv vs. abstraktiv (2026)',
      twitterDescription: 'Halluzinationsraten sanken seit 2021 um 96 % — aber abstraktive Zusammenfassungen erfinden noch 0,7–14 % der Inhalte. Sichere Prompt-Vorlagen.',
