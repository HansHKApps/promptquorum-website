...
export const article: Record<Language, PEArticle> = {
    ...
    de: {
      ...
      seoTitle: 'KI-Zusammenfassung: Extraktive vs. Abstractive Methoden im Vergleich',
      ...
      publishDate: '2026-03-23',
      dateModified: '2026-05-04',
      metaDescription: 'Extractive: 0% Halluzination. Abstractive: 0,7–14%. Wählen Sie nach Dokumenttyp (Legal, Finanzen, Forschung) mit sicheren Prompt-Vorlagen für GPT, Claude, Gemini.',
