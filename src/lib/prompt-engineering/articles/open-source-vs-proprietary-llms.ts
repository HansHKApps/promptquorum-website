    ...
    en: {
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: 'Context window',
            description: 'Open-weights: LLaMA 3.1 131K, Mistral Large 123K, Qwen 128K — sufficient for long documents. Proprietary: GPT-5.6 128K, Claude 200K, Gemini 3.1 Pro 2M tokens.',
          },
          {
            '@type': 'ListItem',
            position: 4,
      ...
      sections: {
        ...
        whenProprietary: {
          ...
          items: [
            '**Complex multi-step reasoning:** Agent workflows, complex research synthesis, and abstract problem-solving. GPT-5.6, Claude 4.6, and Gemini 2.5 maintain a 7–8 point edge on MMLU. Open-weights close the gap on specific tasks but lag on general reasoning.',
      ...
      sections: {
        ...
        comparisonTable: {
          ...
          rows: [
            ...
            { 'Dimension': 'Kontextfenster', 'Open-Weights-Modelle': 'LLaMA 3.1: 131K. Mistral Large: 123K. Qwen: 128K. Ausreichend für lange Dokumente.', 'Proprietäre Modelle': 'GPT-5.6: 128K. Claude: 200K. Gemini 2.5: 2M. Größere Fenster ermöglichen längere Forschung.' },
        ...
        whenProprietary: {
          ...
          items: [
            '**Komplexes Multi-Step-Reasoning:** Agent-Workflows, komplexe Forschungs-Synthese und abstrakte Problemlösung. GPT-5.6, Claude 4.6 und Gemini 2.5 behalten eine 7–8 Punkt-Kante bei MMLU. Open-Weights schließen die Lücke bei spezifischen Aufgaben, liegen aber bei allgemeinem Reasoning zurück.',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Open-weights = poids de modèle téléchargeables (LLaMA, Mistral, Qwen) ; propriétaire = accès API uniquement (GPT-5.6, Claude 4.6, Gemini 2.5). "Open weights" n\'est pas synonyme de licence open source.',
        ...
        comparisonTable: {
          ...
          rows: [
            ...
            { 'Dimension': 'Fenêtre de contexte', 'Modèles open-weights': 'LLaMA 3.1 : 131 K. Mistral Large : 123 K. Qwen : 128 K. Suffisant pour les longs documents.', 'Modèles propriétaires': 'GPT-5.6 : 128 K. Claude : 200 K. Gemini 2.5 : 2 M. Les fenêtres plus grandes permettent des recherches plus longues.' },
        ...
        whenProprietary: {
          ...
          items: [
            '**Raisonnement multi-étapes complexe :** Workflows d\'agents, synthèse de recherche complexe et résolution de problèmes abstraits. GPT-5.6, Claude 4.6 et Gemini 2.5 maintiennent un avantage de 7–8 points sur MMLU. L\'open-weights réduit l\'écart sur des tâches spécifiques mais reste en retard sur le raisonnement général.',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'オープンウェイト = ダウンロード可能なモデルウェイト（LLaMA、Mistral、Qwen）、独自 = APIのみアクセス（GPT-5.6、Claude 4.6、Gemini 2.5）。「オープンウェイト」はオープンソースライセンスとは異なります。',
        ...
        comparisonTable: {
          ...
          rows: [
            ...
            { '次元': 'コンテキストウィンドウ', 'オープンウェイトモデル': 'LLaMA 3.1：131K。Mistral Large：123K。Qwen：128K。長文書に十分。', '独自モデル': 'GPT-5.6：128K。Claude：200K。Gemini 2.5：200万。大きなウィンドウで長い調査が可能。' },
        ...
        whenProprietary: {
          ...
          items: [
            '**複雑な多段階推論：** エージェントワークフロー・複雑な研究合成・抽象的な問題解決。GPT-5.6・Claude 4.6・Gemini 2.5はMMULで7〜8ポイントの優位性を維持しています。オープンウェイトは特定タスクで差を縮めていますが、一般推論では依然として劣っています。',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '开放权重 = 可下载的模型权重（LLaMA、Mistral、Qwen）；专有 = 仅限API访问（GPT-5.6、Claude 4.6、Gemini 2.5）。"开放权重"与开源许可证不同。',
        ...
        comparisonTable: {
          ...
          rows: [
            ...
            { '维度': '上下文窗口', '开放权重模型': 'LLaMA 3.1：131K。Mistral Large：123K。Qwen：128K。足以处理长文档。', '专有模型': 'GPT-5.6：128K。Claude：200K。Gemini 2.5：200万。更大窗口支持更长研究。' },
        ...
        whenProprietary: {
          ...
          items: [
            '**复杂多步骤推理：** 智能体工作流、复杂研究综合和抽象问题解决。GPT-5.6、Claude 4.6和Gemini 2.5在MMLU上保持7–8个百分点的优势。开放权重在特定任务上缩小差距，但在通用推理上仍有差距。',
