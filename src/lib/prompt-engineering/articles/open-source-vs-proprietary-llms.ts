...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      quickFacts: [
        ...
        '**Performance gap:** GPT-5.6 leads LLaMA on MMLU (88.7% vs 80.5%), but Claude Opus 4.8 leads GPT-5.6 on agentic coding (SWE-bench Pro: 64.3% vs 58.6%)',
        '**Context windows:** Open-weights (LLaMA 4 Scout: 10M, LLaMA 4 Maverick: 1M) vs Proprietary (Claude Opus 4.8: 1M, GPT-5.6: 1M, Gemini 3.1 Pro: 1M)',
      ...
      schema: {
        ...
        description: 'Open-weights models like LLaMA 3.1 and Mistral offer control and cost savings; proprietary models like GPT-5.6 and Claude Opus 4.8 deliver frontier performance.',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Which open-source LLM is closest to GPT-5.6 in 2026?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick, DeepSeek-R1, and Mistral Large 2 are closest. On MMLU, GPT-5.6 88.7% vs open-weights 80–83%. On agentic coding (SWE-bench Pro), Claude Opus 4.8 (64.3%) leads GPT-5.6 (58.6%), showing task-specific parity is achievable. Test on your specific task.' } },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Open-weights = downloadable model weights (LLaMA 4, Mistral, Qwen); proprietary = API-only access (GPT-5.6, Claude Opus 4.8, Gemini 3.1 Pro). "Open weights" is not the same as open-source licensing.',
            'Performance varies by task: LLaMA 4 Scout/Maverick and Mistral Large 2 now match proprietary on classification — but lag on abstract reasoning. On agentic coding (SWE-bench Pro), Claude Opus 4.8 (64.3%) leads GPT-5.6 (58.6%); on Terminal-Bench, GPT-5.6 (82.7%) leads Opus 4.8 (69.4%).',
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**Proprietary models are neither open weights nor open source.** OpenAI (GPT-5.6), Anthropic (Claude Opus 4.8), and Google (Gemini 3.1 Pro) do not release model weights. You access them exclusively via API. The weights remain closed; you cannot see, download, modify, or deploy the model yourself.',
        ...
        whatIsProprietary: {
          ...
          content: [
            '**Proprietary LLMs are closed models accessible only via API — the vendor controls the weights, training data, safety alignment, and all updates.** OpenAI (GPT-5.6), Anthropic (Claude Opus 4.8), Google (Gemini 3.1 Pro), and Mistral API are proprietary. You cannot download weights, view training data, run inference locally, or customize the model weights directly.',
            '**Pricing is per-token API billing on a vendor-controlled server.** GPT-5.6 costs $5 per 1M input tokens and $30 per 1M output tokens. Claude Opus 4.8 costs $5/$25. Gemini 3.1 Pro costs $2.00/$12.00 (≤200K context; higher above 200K). You have no infrastructure cost but cannot predict monthly spend precisely — costs scale with usage.',
        ...
        definitions: {
          ...
          content: [
            ...
            '**Proprietary LLM.** A large language model whose weights are kept private and never released. Access is exclusively through a vendor\'s API, requiring per-token billing and network connectivity. Examples: GPT-5.6 (OpenAI), Claude Opus 4.8 (Anthropic), Gemini 3.1 Pro (Google). Users cannot download, inspect, modify, or self-host the model.',
            ...
            '**Training Data Cutoff.** The date after which a model has no knowledge of events or information. GPT-5.6 has a cutoff of December 2025; Claude Opus 4.8 has early-to-mid 2025; Gemini 3.1 Pro has January 2025. Models cannot provide accurate information about events after their cutoff date.',
        ...
        featureComparison: {
          ...
          rows: [
            ...
            { 'Feature': 'Performance', 'Open Source LLM': '80–82% MMLU; LLaMA 4 competitive on coding (SWE-bench). Lag on abstract reasoning vs frontier.', 'Proprietary LLM': '88–90% MMLU; Claude Opus 4.8 leads agentic coding (SWE-bench Pro 64.3%); GPT-5.6 leads reasoning benchmarks.' },
        ...
        proprietaryLandscape: {
          ...
          content: [
            ...
            '**Anthropic\'s Claude Opus 4.8 leads on agentic coding and writing quality.** Claude supports 1M token context — enabling full codebase analysis and extended research. Training data cutoff: early-to-mid 2025. API pricing: $5 per 1M input tokens, $25 per 1M output tokens. On SWE-bench Pro (agentic coding), Claude Opus 4.8 scores 64.3% — ahead of GPT-5.6 at 58.6%. Claude does not offer public fine-tuning. Claude Mythos Preview (invitation-only): $25/$125 per 1M tokens, cybersecurity-focused.',
        ...
        performanceBenchmarks: {
          ...
          content: [
            '**Benchmark performance depends heavily on the task type — proprietary models no longer lead across all categories.** MMLU (broad academic reasoning) still shows a 7–8 point gap, but agentic coding (SWE-bench Pro) shows Claude Opus 4.8 ahead of GPT-5.6, and ARC-AGI-2 (abstract reasoning) is led by Gemini 3.1 Pro.',
            '',
            'MMLU (broad reasoning) — 2024/2025:',
            'GPT-5.6: 88.7% | Claude Opus 4.8: ~88% | LLaMA 3.1 70B: 80.5% | Mistral Large 2: 81.2% | Qwen 3 72B: 82.1%',
            '',
            'SWE-bench Pro (agentic coding, 2026):',
            'Claude Opus 4.8: 64.3% (SWE-bench Pro) / 87.6% (SWE-bench Verified) | GPT-5.6: 58.6% | LLaMA 4 Maverick: data pending',
            '',
            'Terminal-Bench 2.0 (CLI & system tasks, 2026):',
            'GPT-5.6: 82.7% | Claude Opus 4.8: 69.4%',
            '',
            'ARC-AGI-2 (abstract reasoning, 2026):',
            'Gemini 3.1 Pro: 77.1% | GPT-5.6: data pending | Claude Opus 4.8: data pending',
            '',
            '**The benchmark picture is more fragmented in 2026 than in prior years.** No single model leads all benchmarks. On agentic coding, Claude Opus 4.8 leads. On CLI reasoning, GPT-5.6 leads. On abstract reasoning, Gemini leads. On MMLU (academic knowledge), GPT-5.6 and Claude are near-tied. Open-weights (LLaMA 4 Maverick, DeepSeek-R1) are closing the gap on reasoning tasks.',
            '',
        ...
        costAnalysis: {
          ...
          content: [
            ...
            '',
            '**At 5M tokens/day:** A100 self-hosting costs ~$2.50/day. API costs for Claude Opus 4.8: 2.5M × $5/1M + 2.5M × $25/1M = $12.50 + $62.50 = $75/day (assumes 50% input, 50% output). APIs still cheaper. Using GPT-5.6 at $5/$30: $12.50 + $75 = $87.50/day.',
            '',
          ...
          callouts: [
            ...
            { type: '🔍', label: 'Did You Know?', text: 'Batching 1M tokens for classification costs $5–30 on Claude Opus 4.8 or GPT-5.6. Running 1M tokens on self-hosted LLaMA 4 Scout costs ~$0.20–0.30 in GPU time (MoE efficiency). At 50M tokens/day, the difference is $750–1,500/day API vs ~$15/day self-hosted.' },
          ],
        ...
        comparisonTable: {
          ...
          rows: [
            ...
            { 'Dimension': 'Performance ceiling', 'Open-Weights Models': 'Best open-weights (LLaMA 4 Maverick, DeepSeek-R1): MMLU 80–84%. Competitive on coding and extraction; lag on abstract multi-step reasoning.', 'Proprietary Models': 'Frontier (GPT-5.6, Claude Opus 4.8, Gemini 3.1 Pro): MMLU 88–90%. Claude Opus 4.8 leads SWE-bench Pro (64.3%); GPT-5.6 leads Terminal-Bench (82.7%).' },
            { 'Dimension': 'Context window', 'Open-Weights Models': 'LLaMA 4 Scout: 10M. LLaMA 4 Maverick: 1M. Mistral Large: 128K. Open-weights now match or exceed proprietary on context length.', 'Proprietary Models': 'GPT-5.6: 1M. Claude Opus 4.8: 1M. Gemini 3.1 Pro: 1M. All frontier proprietary models now offer ≥1M context.' },
        ...
        whenProprietary: {
          ...
          items: [
            ...
            '**Multimodal input (images, audio):** GPT-5.6 and Claude Opus 4.8 handle image input reliably. Multimodal open-weights models exist but are less mature. Use proprietary for reliable vision-language tasks.',
          ],
        },
        ...
        hybridArchitecture: {
          ...
          items: [
            '**Privacy-sensitive data → local open-weights; complex reasoning → proprietary API.** Route patient records, financial data, and legal documents to LLaMA 3.1 running locally via Ollama. Route multi-step research synthesis, code generation, and agent orchestration to GPT-5.6 or Claude Opus 4.8. This hybrid approach achieves compliance while maintaining frontier performance.',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'LLaMA 4 Maverick, DeepSeek-R1, and Mistral Large 2 are closest. On MMLU, GPT-5.6 scores 88.7% vs open-weights top competitors at 80–83%. On agentic coding (SWE-bench Pro), Claude Opus 4.8 (64.3%) leads GPT-5.6 (58.6%), showing task-specific parity is achievable. The benchmark picture is fragmented — test on your specific task.',
            },
            {
            ...
            },
            {
              ...
              a: 'LLaMA 4 Maverick and Mistral Large 2 are strongest open-weights coding models. On SWE-bench Verified (agentic coding), Claude Opus 4.8 scores 87.6% and GPT-5.6 scores ~77%. Open-weights best: LLaMA 4 Maverick and DeepSeek-R1 are competitive on HumanEval (~75–80%) and improving on SWE-bench. For Python and structured output, open-weights is viable. For multi-file refactoring and agent loops, proprietary models maintain an edge.',
            },
            {
    ...
    de: {
      ...
      quickFacts: [
        ...
        '**Leistungslücke:** GPT-5.6 führt LLaMA beim MMLU an (88,7% vs 80,5%), aber Claude Opus 4.8 führt GPT-5.6 beim Agentic-Coding an (SWE-bench Pro: 64,3% vs 58,6%)',
        '**Context-Fenster:** Open-Weights (LLaMA 4 Scout: 10 Mio., LLaMA 4 Maverick: 1 Mio.) vs Proprietär (Claude Opus 4.8: 1 Mio., GPT-5.6: 1 Mio., Gemini 3.1 Pro: 1 Mio.)',
      ...
      schema: {
        ...
        description: 'Open-Weights-Modelle wie LLaMA 3.1 und Mistral bieten Kontrolle und Kosteneinsparungen; proprietäre Modelle wie GPT-5.6 und Claude Opus 4.8 liefern Spitzenleistung.',
        datePublished: '2026-03-24',
        dateModified: '2026-07-13',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Welches Open-Source-LLM ist GPT-5.6 in 2026 am nächsten?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick, DeepSeek-R1 und Mistral Large 2 sind am nächsten. MMLU: GPT-5.6 88,7% vs. Open-Weights 80–83%. Beim Agentic-Coding (SWE-bench Pro) zeigt Claude Opus 4.8 (64,3%) Parität zu GPT-5.6 (58,6%), was aufgabenspezifische Wettbewerbsfähigkeit demonstriert. Benchmarken Sie auf Ihrer spezifischen Aufgabe.' } },
          ...
          { '@type': 'Question', 'name': 'Welches Open-Weights-Modell ist 2026 am besten für Programmierung?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick und DeepSeek-R1 sind am stärksten bei SWE-bench Verified (Agentic-Coding), mit ~75–80% auf HumanEval konkurierend. Claude Opus 4.8 führt SWE-bench Verified (87,6%) an; GPT-5.6 ~77%. Open-Weights sind lebensfähig für Python und SQL. Proprietäre Modelle behalten einen Vorteil bei Multi-File-Refactoring und agentic Schleifen.' } },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Open-Weights = herunterladbare Modellgewichte (LLaMA 4, Mistral, Qwen); proprietär = nur API-Zugriff (GPT-5.6, Claude Opus 4.8, Gemini 3.1 Pro). "Open Weights" ist nicht dasselbe wie Open-Source-Lizenzierung.',
            'Leistungslücke hat sich verengt: LLaMA 4 Scout/Maverick und Mistral Large 2 entsprechen jetzt proprietären Modellen bei Klassifizierung und Zusammenfassung — liegen aber hinter bei abstraktem Reasoning zurück. Beim Agentic-Coding (SWE-bench Pro) führt Claude Opus 4.8 (64,3%) GPT-5.6 an (58,6%); bei Terminal-Bench führt GPT-5.6 (82,7%) Claude Opus 4.8 an (69,4%).',
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**Proprietäre Modelle sind weder Open-Weights noch Open Source.** OpenAI (GPT-5.6), Anthropic (Claude Opus 4.8) und Google (Gemini 3.1 Pro) veröffentlichen keine Modellgewichte. Sie greifen ausschließlich über API zu. Die Gewichte bleiben geschlossen; Sie können das Modell nicht sehen, herunterladen, ändern oder selbst bereitstellen.',
        ...
        whatIsProprietary: {
          ...
          content: [
            '**Proprietäre LLMs sind geschlossene Modelle, auf die nur über API zugegriffen werden kann — der Vendor kontrolliert die Gewichte, Trainingsdaten, Safety-Alignment und alle Updates.** OpenAI (GPT-5.6), Anthropic (Claude Opus 4.8), Google (Gemini 3.1 Pro) und Mistral API sind proprietär. Sie können keine Gewichte herunterladen, Trainingsdaten anzeigen, lokal Inferenz ausführen oder die Modellgewichte direkt anpassen.',
        ...
        definitions: {
          ...
          content: [
            ...
            '**Proprietäres LLM.** Ein großes Sprachmodell, dessen Gewichte privat bleiben und nie freigegeben werden. Der Zugriff erfolgt ausschließlich über die API eines Vendors, erfordert Pro-Token-Billing und Netzwerkverbindung. Beispiele: GPT-5.6 (OpenAI), Claude Opus 4.8 (Anthropic), Gemini 3.1 Pro (Google). Benutzer können das Modell nicht herunterladen, inspizieren, ändern oder selbst hosten.',
        ...
        whenProprietary: {
          ...
          items: [
            ...
            '**Multimodal-Input (Bilder, Audio):** GPT-5.6 und Claude Opus 4.8 verarbeiten Bild-Eingabe zuverlässig. Multimodal-Open-Weights-Modelle existieren, sind aber weniger reif. Verwenden Sie proprietär für zuverlässige Vision-Language-Aufgaben.',
          ],
        },
    ...
    es: {
      ...
      quickFacts: [
        ...
        '**Brecha de rendimiento:** GPT-5.6 lidera LLaMA en MMLU (88,7 % vs 80,5 %), pero Claude Opus 4.8 lidera GPT-5.6 en código agéntico (SWE-bench Pro: 64,3 % vs 58,6 %)',
        '**Context windows:** Open-weights (LLaMA 4 Scout: 10M, LLaMA 4 Maverick: 1M) vs Propietarios (Claude Opus 4.8: 1M, GPT-5.6: 1M, Gemini 3.1 Pro: 1M)',
      ...
      schema: {
        ...
        description: 'Los modelos open-weights como LLaMA 4 y Mistral ofrecen control y ahorro de costos; los modelos propietarios como GPT-5.6 y Claude Opus 4.8 ofrecen rendimiento de frontera.',
        datePublished: '2026-03-24',
        dateModified: '2026-07-13',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '¿Qué LLM de código abierto se acerca más a GPT-5.6 en 2026?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick, DeepSeek-R1 y Mistral Large 2 son los más cercanos. En MMLU, GPT-5.6 88,7 % vs open-weights 80–83 %. En código agéntico (SWE-bench Pro), Claude Opus 4.8 (64,3 %) lidera GPT-5.6 (58,6 %), mostrando que la paridad específica de tareas es alcanzable. Prueba en tu tarea específica.' } },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Open-weights = pesos de modelo descargables (LLaMA 4, Mistral, Qwen); propietarios = acceso solo vía API (GPT-5.6, Claude Opus 4.8, Gemini 3.1 Pro). "Open-weights" no es lo mismo que licencias open-source.',
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**Los modelos propietarios no son ni open-weights ni open-source.** OpenAI (GPT-5.6), Anthropic (Claude Opus 4.8) y Google (Gemini 3.1 Pro) no publican los pesos del modelo. Los accedes exclusivamente vía API.',
        ...
        whatIsProprietary: {
          ...
          content: [
            '**Los LLMs propietarios son modelos cerrados accesibles solo vía API — el proveedor controla los pesos, los datos de entrenamiento, la alineación de seguridad y todas las actualizaciones.** OpenAI (GPT-5.6), Anthropic (Claude Opus 4.8), Google (Gemini 3.1 Pro) y Mistral API son propietarios.',
            '**Los precios son facturación por token en API en un servidor controlado por el proveedor.** GPT-5.6 cuesta $5 por 1M tokens de entrada y $30 por 1M tokens de salida. Claude Opus 4.8 cuesta $5/$25. Gemini 3.1 Pro cuesta $2,00/$12,00.',
        ...
        definitions: {
          ...
          content: [
            ...
            '**LLM Propietario.** Un LLM cuyos pesos se mantienen privados y nunca se publican. El acceso es exclusivamente a través de la API de un proveedor, requiriendo facturación por token y conectividad de red. Ejemplos: GPT-5.6 (OpenAI), Claude Opus 4.8 (Anthropic), Gemini 3.1 Pro (Google).',
    ...
    ar: {
      ...
      quickFacts: [
        ...
        '**فجوة الأداء:** GPT-5.6 يتقدم على LLaMA في MMLU (88.7% مقابل 80.5%)، لكن Claude Opus 4.8 يتقدم على GPT-5.6 في الكود الوكيل (SWE-bench Pro: 64.3% مقابل 58.6%)',
        '**نوافذ السياق:** مفتوحة الأوزان (LLaMA 4 Scout: 10M، LLaMA 4 Maverick: 1M) مقابل المملوكة (Claude Opus 4.8: 1M، GPT-5.6: 1M، Gemini 3.1 Pro: 1M)',
      ...
      schema: {
        ...
        description: 'تقدم النماذج مفتوحة الأوزان مثل LLaMA 4 وMistral تحكمًا وتوفيرًا في التكاليف؛ بينما تقدم النماذج المملوكة مثل GPT-5.6 وClaude Opus 4.8 أداءً متقدمًا.',
        datePublished: '2026-03-24',
        dateModified: '2026-07-13',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'ما النموذج مفتوح المصدر الأقرب إلى GPT-5.6 في 2026؟', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick وDeepSeek-R1 وMistral Large 2 هي الأقرب. في MMLU: GPT-5.6 88.7% مقابل النماذج مفتوحة الأوزان 80–83%. في الكود الوكيل (SWE-bench Pro)، Claude Opus 4.8 (64.3%) يتقدم على GPT-5.6 (58.6%)، مما يُظهر أن التعادل في مهام محددة قابل للتحقيق. اختبر في مهمتك المحددة.' } },
          ...
          { '@type': 'Question', 'name': 'ما أفضل نموذج مفتوح الأوزان للبرمجة في 2026؟', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick وDeepSeek-R1 تنافسيان في HumanEval (~75–80%) وتتحسنان في SWE-bench. Claude Opus 4.8 (SWE-bench Verified 87.6%) يتقدم على GPT-5.6 (~77%). النماذج مفتوحة الأوزان مناسبة للإنتاج في Python وSQL. النماذج المملوكة تحتفظ بميزة في إعادة هيكلة الملفات المتعددة وحلقات الوكلاء.' } },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'الأوزان المفتوحة = أوزان نماذج قابلة للتنزيل (LLaMA 4، Mistral، Qwen)؛ مملوكة = وصول عبر واجهة برمجة التطبيقات فقط (GPT-5.6، Claude Opus 4.8، Gemini 3.1 Pro). "الأوزان المفتوحة" ليست هي نفسها تراخيص المصدر المفتوح.',
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**النماذج المملوكة ليست أوزانًا مفتوحة ولا مفتوحة المصدر.** OpenAI (GPT-5.6) وAnthropic (Claude Opus 4.8) وGoogle (Gemini 3.1 Pro) لا تنشر أوزان النموذج. يمكن الوصول إليها حصرًا عبر واجهة برمجة التطبيقات.',
        ...
        whatIsProprietary: {
          ...
          content: [
            '**النماذج اللغوية الكبيرة المملوكة هي نماذج مغلقة يمكن الوصول إليها فقط عبر واجهة برمجة التطبيقات — المزود يتحكم في الأوزان وبيانات التدريب ومحاذاة السلامة وجميع التحديثات.** OpenAI (GPT-5.6) وAnthropic (Claude Opus 4.8) وGoogle (Gemini 3.1 Pro) وMistral API مملوكة.',
            '**الأسعار فوترة لكل رمز عبر واجهة برمجة التطبيقات على خادم يتحكم فيه المزود.** GPT-5.6 يكلّف 5 دولارات لكل مليون رمز مدخل و30 دولارًا لكل مليون رمز مخرج. Claude Opus 4.8 يكلّف 5/25 دولار. Gemini 3.1 Pro يكلّف 2.00/12.00 دولار.',
        ...
        definitions: {
          ...
          content: [
            ...
            '**نموذج لغوي كبير مملوك.** نموذج لغوي كبير أوزانه خاصة ولا تُنشر أبدًا. الوصول حصرًا عبر واجهة برمجة تطبيقات المزود، مما يتطلب فوترة لكل رمز واتصالًا بالشبكة. أمثلة: GPT-5.6 (OpenAI)، Claude Opus 4.8 (Anthropic)، Gemini 3.1 Pro (Google).',
    ...
    pt: {
      ...
      schema: {
        ...
        description: 'Os modelos open-weights como LLaMA 4 e Mistral oferecem controle e economia de custos; os modelos proprietários como GPT-5.6 e Claude Opus 4.8 oferecem desempenho de fronteira.',
        datePublished: '2026-03-24',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Qual LLM de código aberto está mais próximo do GPT-5.6 em 2026?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick, DeepSeek-R1 e Mistral Large 2 são os mais próximos. No MMLU, GPT-5.6 88,7% vs open-weights 80–83%. No código agêntico (SWE-bench Pro), Claude Opus 4.8 (64,3%) lidera GPT-5.6 (58,6%), mostrando que a paridade específica de tarefas é alcançável.' } },
          ...
          { '@type': 'Question', 'name': 'Qual é o melhor modelo open-weights para programação em 2026?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick e DeepSeek-R1 são competitivos no HumanEval (~75–80%) e melhorando no SWE-bench. Claude Opus 4.8 (SWE-bench Verified 87,6%) lidera GPT-5.6 (~77%). Os open-weights são viáveis para Python, SQL.' } },
    ...
    fr: {
      ...
      quickFacts: [
        ...
        '**Écart de performance :** GPT-5.6 mène LLaMA sur MMLU (88,7% vs 80,5%), mais Claude Opus 4.8 dépasse GPT-5.6 sur coding agentic (SWE-bench Pro : 64,3% vs 58,6%)',
        '**Fenêtres contextuelles :** Open-weights (LLaMA 4 Scout : 10M, LLaMA 4 Maverick : 1M) vs Propriétaires (Claude Opus 4.8 : 1M, GPT-5.6 : 1M, Gemini 3.1 Pro : 1M)',
      ...
      schema: {
        ...
        description: 'LLMs open-weights (LLaMA 4, DeepSeek-R1) vs propriétaires (GPT-5.6, Claude Opus 4.8, Gemini 3.1 Pro) : prix, fenêtres contextuelles, architecture MoE, benchmarks agentic-coding.',
        datePublished: '2026-03-24',
        dateModified: '2026-07-13',
        keywords: ['LLMs open-source', 'LLaMA 4', 'Mistral Large', 'modèles propriétaires', 'GPT-5.6', 'Claude Opus 4.8', 'fine-tuning', 'analyse coûts', 'open-weights', 'inférence locale', 'MoE'],
        teaches: [
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Quel modèle open-weights est le meilleur pour le code en 2026 ?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 3.1 70B et Mistral Large 2 sont les plus performants. Scores HumanEval : 73–78 % contre GPT-5.6 ~90 % et Claude Opus 4.8 ~87 %. Compétitif pour Python, SQL et la sortie structurée. Les modèles propriétaires conservent un avantage sur la conception d\'algorithmes complexes et le raisonnement multi-fichiers.' } },
      ...
      sections: {
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**Les modèles propriétaires ne sont ni open-weights ni open source.** OpenAI (GPT-5.6), Anthropic (Claude Opus 4.8) et Google (Gemini 3.1 Pro) ne publient pas les poids des modèles. Vous y accédez exclusivement via API. Les poids restent fermés ; vous ne pouvez pas voir, télécharger, modifier ou déployer le modèle vous-même.',
        ...
        whatIsProprietary: {
          ...
          content: [
            '**Les LLMs propriétaires sont des modèles fermés accessibles uniquement via API — le fournisseur contrôle les poids, les données d\'entraînement, l\'alignement de sécurité et toutes les mises à jour.** OpenAI (GPT-5.6), Anthropic (Claude Opus 4.8), Google (Gemini 3.1 Pro) et Mistral API sont propriétaires. Vous ne pouvez pas télécharger les poids, consulter les données d\'entraînement, exécuter l\'inférence localement ou personnaliser directement les poids du modèle.',
        ...
        definitions: {
          ...
          content: [
            ...
            '**LLM propriétaire.** Un grand modèle de langage dont les poids restent privés et ne sont jamais publiés. L\'accès se fait exclusivement via l\'API d\'un fournisseur, nécessitant une facturation par token et une connectivité réseau. Exemples : GPT-5.6 (OpenAI), Claude Opus 4.8 (Anthropic), Gemini 3.1 Pro (Google). Les utilisateurs ne peuvent pas télécharger, inspecter, modifier ou auto-héberger le modèle.',
        ...
        whenProprietary: {
          ...
          items: [
            ...
            '**Entrées multimodales (images, audio) :** GPT-5.6 et Claude Opus 4.8 traitent les images de façon fiable. Les modèles open-weights multimodaux existent mais sont moins matures. Utilisez le propriétaire pour des tâches vision-langage fiables.',
          ],
        },
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'LLaMA 3.1 70B et Mistral Large 2 sont les modèles open-weights de codage les plus performants. Sur HumanEval (benchmark de génération de code), ils obtiennent 73–78 %, contre GPT-5.6 à ~90 % et Claude Opus 4.8 à ~87 %. Pour Python, SQL et la sortie structurée, l\'open-weights est compétitif. Pour la conception d\'algorithmes complexes et le raisonnement multi-fichiers, les modèles propriétaires conservent un avantage significatif.',
            },
            {
    ...
    ja: {
      ...
      quickFacts: [
        ...
        '**性能ギャップ :** GPT-5.6がLLaMAをMMLU (88.7% vs 80.5%) で上回るも、Claude Opus 4.8がGPT-5.6をエージェント型コーディング (SWE-bench Pro: 64.3% vs 58.6%) で上回る',
        '**コンテキストウィンドウ :** オープンウェイト (LLaMA 4 Scout: 10M、LLaMA 4 Maverick: 1M) vs 独占的 (Claude Opus 4.8: 1M、GPT-5.6: 1M、Gemini 3.1 Pro: 1M)',
      ...
      schema: {
        ...
        description: 'オープンウェイト (LLaMA 4, DeepSeek-R1) vs 独占的 (GPT-5.6、Claude Opus 4.8、Gemini 3.1 Pro) : 価格、コンテキストウィンドウ、MoE、エージェントコーディングベンチマーク。',
        datePublished: '2026-03-24',
        dateModified: '2026-07-13',
        keywords: ['オープンウェイト', 'LLaMA 4', 'DeepSeek-R1', 'Mistral Large', '独占的モデル', 'GPT-5.6', 'Claude Opus 4.8', 'ファインチューニング', 'コスト分析', 'MoE'],
        teaches: [
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '2026年でコーディングに最適なオープンウェイトモデルはどれですか？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 3.1 70BとMistral Large 2が最強のオープンウェイトコーディングモデルです。HumanEvalスコア（コード生成ベンチマーク）は73〜78%で、GPT-5.6の約90%、Claude Opus 4.8の約87%と比較されます。Python・SQL・構造化出力ではオープンウェイトが競争力を持ちます。複雑なアルゴリズム設計やマルチファイル推論では、独自モデルが依然として優位性を維持しています。' } },
      ...
      sections: {
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**独自モデルはオープンウェイトでもオープンソースでもありません。** OpenAI（GPT-5.6）・Anthropic（Claude Opus 4.8）・Google（Gemini 3.1 Pro）はモデルウェイトをリリースしていません。APIを通じてのみアクセスできます。ウェイトはクローズドのままで、自分でモデルを確認・ダウンロード・修正・デプロイすることはできません。',
        ...
        whatIsProprietary: {
          title: '独自LLMとは何ですか？',
          content: [
            '**独自LLMはAPIを通じてのみアクセスできるクローズドモデルです — ベンダーがウェイト・学習データ・安全アライメント・すべての更新を管理します。** OpenAI（GPT-5.6）・Anthropic（Claude Opus 4.8）・Google（Gemini 3.1 Pro）・Mistral APIは独自モデルです。ウェイトをダウンロードしたり、学習データを確認したり、ローカルで推論を実行したり、モデルウェイトを直接カスタマイズしたりすることはできません。',
            '**価格はベンダー管理サーバーでのトークン単位のAPI課金です。** GPT-5.6は入力100万トークンあたり$5、出力100万トークンあたり$15です。Claude Opus 4.8は$5/$25。Gemini 3.1 Proは$1.25/$2.50（200K以下のコンテキスト）。インフラコストはかかりませんが、月額コストを正確に予測することはできず、コストは使用量に応じてスケールします。',
        ...
        definitions: {
          ...
          content: [
            ...
            '**独自LLM。** ウェイトが非公開で決してリリースされない大規模言語モデル。アクセスはベンダーのAPIを通じてのみ可能で、トークン課金とネットワーク接続が必要です。例：GPT-5.6（OpenAI）、Claude Opus 4.8（Anthropic）、Gemini 3.1 Pro（Google）。ユーザーはモデルをダウンロード・検査・修正・自己ホスティングすることができません。',
            ...
            '**学習データカットオフ。** モデルがその日付以降のイベントや情報の知識を持たない日付。GPT-5.6のカットオフは2024年10月、Claude Opus 4.8は2025年初頭、Gemini 3.1 Proは2024年10月です。モデルはカットオフ日以降のイベントについて正確な情報を提供できません。',
        ...
        proprietaryLandscape: {
          ...
          content: [
            ...
            '**AnthropicのClaude Opus 4.8はライティングとコード品質ベンチマークで支配的です。** Claudeは1Mトークンのコンテキストをサポートしており、GPT-5.6の約8倍で、より長い文書と長い会話が可能です。学習データのカットオフ：2025年初頭。APIの価格：入力100万トークンあたり$5、出力100万トークンあたり$25。Claudeは公開のファインチューニングを提供していません。Anthropicはベンチマーク最大化よりも解釈可能性と安全アライメントを優先しています。',
        ...
        whenProprietary: {
          ...
          items: [
            ...
            '**マルチモーダル入力（画像・音声）：** GPT-5.6とClaude Opus 4.8は画像入力を確実に処理します。マルチモーダルのオープンウェイトモデルは存在しますが、成熟度が低いです。信頼性の高いビジョン-言語タスクには独自モデルを使用してください。',
          ],
        },
        ...
        hybridArchitecture: {
          ...
          items: [
            '**プライバシー敏感データ → ローカルのオープンウェイト、複雑な推論 → 独自API。** 患者記録・金融データ・法的文書をOllamaを通じてローカルで動作するLLaMA 3.1にルーティングします。多段階の研究合成・コード生成・エージェントオーケストレーションをGPT-5.6またはClaude Opus 4.8にルーティングします。このハイブリッドアプローチでコンプライアンスを達成しながらフロンティアパフォーマンスを維持できます。',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'LLaMA 3.1 70BとMistral Large 2が最強のオープンウェイトコーディングモデルです。HumanEvalスコアは73〜78%で、GPT-5.6の約90%、Claude Opus 4.8の約87%と比較されます。Python・SQL・構造化出力ではオープンウェイトが競争力を持ちます。複雑なアルゴリズム設計やマルチファイル推論では、独自モデルが依然として大きな優位性を維持しています。',
            },
            {
    ...
    zh: {
      ...
      quickFacts: [
        ...
        '**性能差异：** GPT-5.6在MMLU上领先LLaMA（88.7% vs 80.5%），但Claude Opus 4.8在代理型编程（SWE-bench Pro：64.3% vs 58.6%）上领先GPT-5.6',
        '**上下文窗口：** 开放权重（LLaMA 4 Scout：1000万token，LLaMA 4 Maverick：100万token）vs 专有（Claude Opus 4.8：100万token，GPT-5.6：100万token，Gemini 3.1 Pro：100万token）',
      ...
      schema: {
        ...
        description: '开放权重模型（如LLaMA 4和Mistral）提供完全控制和规模化成本节省；专有模型（如GPT-5.6和Claude Opus 4.8）则提供前沿性能。',
        datePublished: '2026-03-24',
        dateModified: '2026-07-13',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '2026年哪个开放权重模型最适合编程？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 3.1 70B和Mistral Large 2最强。HumanEval分数：约73–78%，而GPT-5.6约90%，Claude Opus 4.8约87%。在Python、SQL和结构化输出方面具有竞争力。专有模型在复杂算法设计和多文件推理方面仍保持优势。' } },
      ...
      sections: {
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**专有模型既非开放权重也非开源。** OpenAI（GPT-5.6）、Anthropic（Claude Opus 4.8）和Google（Gemini 3.1 Pro）不发布模型权重。您只能通过API访问它们。权重保持封闭；您无法查看、下载、修改或自行部署模型。',
        ...
        whatIsProprietary: {
          ...
          content: [
            ...
            '**定价为供应商控制服务器上的按token API计费。** GPT-5.6的输入费用为每百万token 5美元，输出为每百万token 15美元。Claude Opus 4.8为5美元/25美元。Gemini 3.1 Pro为1.25美元/2.50美元（≤200K上下文）。您没有基础设施成本，但无法精确预测每月支出——成本随使用量扩展。',
        ...
        definitions: {
          ...
          content: [
            ...
            '**专有LLM。** 一种大型语言模型，其权重保密且从不发布。访问完全通过供应商的API进行，需要按token计费和网络连接。示例：GPT-5.6（OpenAI）、Claude Opus 4.8（Anthropic）、Gemini 3.1 Pro（Google）。用户无法下载、检查、修改或自托管模型。',
            '**微调。** 在针对特定领域或任务的新的较小数据集上重新训练预训练模型的过程。微调更新模型的权重以专业化于您的用例（例如客服语气、领域词汇）。开放权重模型通过LoRA、QLoRA或全量反向传播支持完整微调；大多数专有模型限制或禁止微调。',
            '**训练数据截止日期。** 模型对此日期之后的事件或信息不具备知识的日期。GPT-5.6的截止日期为2024年10月；Claude Opus 4.8为2025年初；Gemini 3.1 Pro为2024年10月。模型无法提供截止日期后事件的准确信息。',
        ...
        proprietaryLandscape: {
          ...
          content: [
            ...
            '**Anthropic的Claude Opus 4.8在写作和代码质量基准上占据主导地位。** Claude支持100万token上下文——是GPT-5.6的约8倍——能够处理更长的文档和更长的对话。训练数据截止日期：2025年初。API定价：每百万输入token 3美元，每百万输出token 15美元。Claude不提供公开微调。Anthropic将可解释性和安全对齐置于基准最大化之上。',
        ...
        whenProprietary: {
          ...
          items: [
            ...
            '**多模态输入（图像、音频）：** GPT-5.6和Claude Opus 4.8可靠地处理图像输入。多模态开放权重模型存在但不够成熟。对于可靠的视觉-语言任务，使用专有模型。',
          ],
        },
        ...
        hybridArchitecture: {
          ...
          items: [
            '**隐私敏感数据 → 本地开放权重；复杂推理 → 专有API。** 将患者记录、金融数据和法律文件路由到通过Ollama本地运行的LLaMA 3.1。将多步骤研究综合、代码生成和智能体编排路由到GPT-5.6或Claude Opus 4.8。这种混合方式在保持前沿性能的同时实现合规性。',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'LLaMA 3.1 70B和Mistral Large 2是最强的开放权重编程模型。在HumanEval（代码生成基准）上，它们得分73–78%，而GPT-5.6约90%，Claude Opus 4.8约87%。在Python、SQL和结构化输出方面，开放权重具有竞争力。在复杂算法设计和多文件推理方面，专有模型保持显著优势。',
            },
            {
              q: '我可以将开源LLM用于商业应用吗？',
    ...
    ko: {
      ...
      quickFacts: [
        ...
        '**성능 격차:** GPT-5.6가 MMLU에서 LLaMA를 앞섬 (88.7% vs 80.5%); Claude Opus 4.8는 에이전틱 코드에서 GPT-5.6를 앞섬 (SWE-bench Pro: 64.3% vs 58.6%)',
        '**컨텍스트 윈도우:** 오픈-웨이트 (LLaMA 4 Scout: 10M, LLaMA 4 Maverick: 1M) vs 독점 (Claude Opus 4.8: 1M, GPT-5.6: 1M, Gemini 3.1 Pro: 1M)',
      ...
      schema: {
        ...
        description: 'LLaMA 4, Mistral 같은 오픈-웨이트 모델은 제어권과 비용 절감을 제공하고, GPT-5.6, Claude Opus 4.8 같은 독점 모델은 최전선 성능을 제공합니다.',
        datePublished: '2026-03-24',
        dateModified: '2026-07-13',
        inLanguage: 'ko',
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: '2026년 GPT-5.6에 가장 근접한 오픈소스 LLM은 무엇입니까?', acceptedAnswer: { '@type': 'Answer', text: 'LLaMA 4 Maverick, DeepSeek-R1, Mistral Large 2가 가장 근접합니다. MMLU에서 GPT-5.6 88.7% vs 오픈-웨이트 80–83%. 에이전틱 코드 (SWE-bench Pro)에서 Claude Opus 4.8 (64.3%)이 GPT-5.6 (58.6%)를 앞서며 작업별 성능 동등이 달성 가능함을 보여줍니다. 귀사의 특정 작업에서 테스트하십시오.' } },
          ...
          { '@type': 'Question', name: '2026년 코딩에 가장 적합한 오픈-웨이트 모델은 무엇입니까?', acceptedAnswer: { '@type': 'Answer', text: 'LLaMA 4 Maverick와 DeepSeek-R1이 HumanEval (~75–80%)에서 경쟁력 있으며 SWE-bench에서 향상 중입니다. Claude Opus 4.8 (SWE-bench Verified 87.6%)이 GPT-5.6 (~77%)를 앞섭니다. 오픈-웨이트는 Python, SQL에서 실용적입니다. 독점 모델은 멀티파일 리팩토링과 에이전트 루프에서 우위를 유지합니다.' } },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '오픈-웨이트 = 다운로드 가능한 모델 가중치 (LLaMA 4, Mistral, Qwen); 독점 = API 전용 접근 (GPT-5.6, Claude Opus 4.8, Gemini 3.1 Pro). "오픈-웨이트"는 오픈소스 라이선스와 같지 않습니다.',
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**독점 모델은 오픈-웨이트도 오픈소스도 아닙니다.** OpenAI (GPT-5.6), Anthropic (Claude Opus 4.8), Google (Gemini 3.1 Pro)은 모델 가중치를 공개하지 않습니다. API를 통해서만 접근할 수 있습니다.',
        ...
        whatIsProprietary: {
          ...
          content: [
            '**독점 LLM은 API를 통해서만 접근 가능한 폐쇄형 모델입니다 — 공급업체가 가중치, 훈련 데이터, 안전 정렬 및 모든 업데이트를 제어합니다.** OpenAI (GPT-5.6), Anthropic (Claude Opus 4.8), Google (Gemini 3.1 Pro), Mistral API가 독점 모델입니다.',
            '**가격은 공급업체가 제어하는 서버의 API 토큰 과금입니다.** GPT-5.6는 입력 1M 토큰당 $5, 출력 1M 토큰당 $30입니다. Claude Opus 4.8는 $5/$25입니다. Gemini 3.1 Pro는 $2.00/$12.00입니다.',
        ...
        definitions: {
          ...
          content: [
            ...
            '**독점 LLM.** 가중치가 비공개로 유지되고 공개되지 않는 LLM. 접근은 공급업체 API를 통해서만 가능하며 토큰 과금과 네트워크 연결이 필요합니다. 예시: GPT-5.6 (OpenAI), Claude Opus 4.8 (Anthropic), Gemini 3.1 Pro (Google).',
