...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      intro: 'Open-weights models like LLaMA 3.1 and Mistral offer control and cost savings; proprietary models like GPT-4o and Claude Opus 4.7 deliver frontier performance. Both categories converge in capability but diverge in access, customization, and compliance requirements.',
      ...
      quickFacts: [
        ...
        '**Performance gap:** GPT-4o leads LLaMA on MMLU (88.7% vs 80.5%), but Claude Opus 4.7 leads GPT-4o on agentic coding (SWE-bench Pro: 64.3% vs 58.6%)',
        '**Context windows:** Open-weights (LLaMA 4 Scout: 10M, LLaMA 4 Maverick: 1M) vs Proprietary (Claude Opus 4.7: 1M, GPT-4o: 1M, Gemini 3.1 Pro: 1M)',
      ...
      schema: {
        ...
        description: 'Open-weights models like LLaMA 3.1 and Mistral offer control and cost savings; proprietary models like GPT-4o and Claude Opus 4.7 deliver frontier performance.',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Which open-source LLM is closest to GPT-4o in 2026?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick, DeepSeek-R1, and Mistral Large 2 are closest. On MMLU, GPT-4o 88.7% vs open-weights 80–83%. On agentic coding (SWE-bench Pro), Claude Opus 4.7 (64.3%) leads GPT-4o (58.6%), showing task-specific parity is achievable. Test on your specific task.' } },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Open-weights = downloadable model weights (LLaMA 4, Mistral, Qwen); proprietary = API-only access (GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro). "Open weights" is not the same as open-source licensing.',
            'Performance varies by task: LLaMA 4 Scout/Maverick and Mistral Large 2 now match proprietary on classification — but lag on abstract reasoning. On agentic coding (SWE-bench Pro), Claude Opus 4.7 (64.3%) leads GPT-4o (58.6%); on Terminal-Bench, GPT-4o (82.7%) leads Opus 4.7 (69.4%).',
        ...
        featureComparison: {
          ...
          rows: [
            ...
            { 'Feature': 'Performance', 'Open Source LLM': '80–82% MMLU; LLaMA 4 competitive on coding (SWE-bench). Lag on abstract reasoning vs frontier.', 'Proprietary LLM': '88–90% MMLU; Claude Opus 4.7 leads agentic coding (SWE-bench Pro 64.3%); GPT-4o leads reasoning benchmarks.' },
        ...
        costAnalysis: {
          ...
          callouts: [
            ...
            { type: '🔍', label: 'Did You Know?', text: 'Batching 1M tokens for classification costs $5–30 on Claude Opus 4.7 or GPT-4o. Running 1M tokens on self-hosted LLaMA 4 Scout costs ~$0.20–0.30 in GPU time (MoE efficiency). At 50M tokens/day, the difference is $750–1,500/day API vs ~$15/day self-hosted.' },
          ],
        ...
        comparisonTable: {
          ...
          rows: [
            ...
            { 'Dimension': 'Performance ceiling', 'Open-Weights Models': 'Best open-weights (LLaMA 4 Maverick, DeepSeek-R1): MMLU 80–84%. Competitive on coding and extraction; lag on abstract multi-step reasoning.', 'Proprietary Models': 'Frontier (GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro): MMLU 88–90%. Claude Opus 4.7 leads SWE-bench Pro (64.3%); GPT-4o leads Terminal-Bench (82.7%).' },
            { 'Dimension': 'Context window', 'Open-Weights Models': 'LLaMA 4 Scout: 10M. LLaMA 4 Maverick: 1M. Mistral Large: 128K. Open-weights now match or exceed proprietary on context length.', 'Proprietary Models': 'GPT-4o: 1M. Claude Opus 4.7: 1M. Gemini 3.1 Pro: 1M. All frontier proprietary models now offer ≥1M context.' },
        ...
        whenProprietary: {
          ...
          items: [
            ...
            '**Multimodal input (images, audio):** GPT-4o and Claude Opus 4.7 handle image input reliably. Multimodal open-weights models exist but are less mature. Use proprietary for reliable vision-language tasks.',
          ],
        },
        ...
        hybridArchitecture: {
          ...
          items: [
            '**Privacy-sensitive data → local open-weights; complex reasoning → proprietary API.** Route patient records, financial data, and legal documents to LLaMA 3.1 running locally via Ollama. Route multi-step research synthesis, code generation, and agent orchestration to GPT-4o or Claude Opus 4.7. This hybrid approach achieves compliance while maintaining frontier performance.',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'LLaMA 4 Maverick, DeepSeek-R1, and Mistral Large 2 are closest. On MMLU, GPT-4o scores 88.7% vs open-weights top competitors at 80–83%. On agentic coding (SWE-bench Pro), Claude Opus 4.7 (64.3%) leads GPT-4o (58.6%), showing task-specific parity is achievable. The benchmark picture is fragmented — test on your specific task.',
            },
            {
            ...
            },
            {
              ...
              a: 'LLaMA 4 Maverick and Mistral Large 2 are strongest open-weights coding models. On SWE-bench Verified (agentic coding), Claude Opus 4.7 scores 87.6% and GPT-4o scores ~77%. Open-weights best: LLaMA 4 Maverick and DeepSeek-R1 are competitive on HumanEval (~75–80%) and improving on SWE-bench. For Python and structured output, open-weights is viable. For multi-file refactoring and agent loops, proprietary models maintain an edge.',
            },
            {
    ...
    de: {
      ...
      intro: 'Open-Weights-Modelle wie LLaMA 4 Scout und Mistral bieten vollständige Kontrolle und Kosteneinsparungen; proprietäre Modelle wie GPT-4o und Claude Opus 4.7 liefern Spitzenleistung. Beide Kategorien konvergieren bei der Leistungsfähigkeit, divergieren aber bei Zugriff, Anpassung und Compliance-Anforderungen.',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Welches Open-Source-LLM ist GPT-4o in 2026 am nächsten?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick, DeepSeek-R1 und Mistral Large 2 sind am nächsten. MMLU: GPT-4o 88,7% vs. Open-Weights 80–83%. Beim Agentic-Coding (SWE-bench Pro) zeigt Claude Opus 4.7 (64,3%) Parität zu GPT-4o (58,6%), was aufgabenspezifische Wettbewerbsfähigkeit demonstriert. Benchmarken Sie auf Ihrer spezifischen Aufgabe.' } },
          ...
          { '@type': 'Question', 'name': 'Welches Open-Weights-Modell ist 2026 am besten für Programmierung?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick und DeepSeek-R1 sind am stärksten bei SWE-bench Verified (Agentic-Coding), mit ~75–80% auf HumanEval konkurierend. Claude Opus 4.7 führt SWE-bench Verified (87,6%) an; GPT-4o ~77%. Open-Weights sind lebensfähig für Python und SQL. Proprietäre Modelle behalten einen Vorteil bei Multi-File-Refactoring und agentic Schleifen.' } },
    ...
    es: {
      ...
      intro: 'Los modelos open-weights como LLaMA 4 y Mistral ofrecen control y ahorro de costos; los modelos propietarios como GPT-4o y Claude Opus 4.7 ofrecen rendimiento de frontera. Ambas categorías convergen en capacidad pero divergen en acceso, personalización y requisitos de cumplimiento.',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '¿Qué LLM de código abierto se acerca más a GPT-4o en 2026?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick, DeepSeek-R1 y Mistral Large 2 son los más cercanos. En MMLU, GPT-4o 88,7 % vs open-weights 80–83 %. En código agéntico (SWE-bench Pro), Claude Opus 4.7 (64,3 %) lidera GPT-4o (58,6 %), mostrando que la paridad específica de tareas es alcanzable. Prueba en tu tarea específica.' } },
      ...
      sections: {
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: '¿Cuál es el mejor modelo open-weights para programación en 2026?', a: 'LLaMA 4 Maverick y DeepSeek-R1 son competitivos en HumanEval (~75–80 %). Claude Opus 4.7 lidera en SWE-bench Verified.' },
    ...
    fr: {
      ...
      intro: 'Les modèles open-weights comme LLaMA 4 et Mistral offrent contrôle total et économies d\'échelle ; les modèles propriétaires comme GPT-4o et Claude Opus 4.7 livrent des performances de pointe. Les deux catégories convergent en performance mais divergent sur l\'accès, la personnalisation et la conformité.',
      ...
      quickFacts: [
        ...
        '**Écart de performance :** GPT-4o mène LLaMA sur MMLU (88,7% vs 80,5%), mais Claude Opus 4.7 dépasse GPT-4o sur coding agentic (SWE-bench Pro : 64,3% vs 58,6%)',
        '**Fenêtres contextuelles :** Open-weights (LLaMA 4 Scout : 10M, LLaMA 4 Maverick : 1M) vs Propriétaires (Claude Opus 4.7 : 1M, GPT-4o : 1M, Gemini 3.1 Pro : 1M)',
      ...
      schema: {
        ...
        datePublished: '2026-03-24',
        dateModified: '2026-05-03',
        keywords: ['LLMs open-source', 'LLaMA 4', 'Mistral Large', 'modèles propriétaires', 'GPT-4o', 'Claude Opus 4.7', 'fine-tuning', 'analyse coûts', 'open-weights', 'inférence locale', 'MoE'],
        teaches: [
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Quel modèle open-weights est le meilleur pour le code en 2026 ?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 3.1 70B et Mistral Large 2 sont les plus performants. Scores HumanEval : 73–78 % contre GPT-4o ~90 % et Claude Opus 4.7 ~87 %. Compétitif pour Python, SQL et la sortie structurée. Les modèles propriétaires conservent un avantage sur la conception d\'algorithmes complexes et le raisonnement multi-fichiers.' } },
      ...
      sections: {
        ...
        whenProprietary: {
          ...
          items: [
            ...
            '**Entrées multimodales (images, audio) :** GPT-4o et Claude Opus 4.7 traitent les images de façon fiable. Les modèles open-weights multimodaux existent mais sont moins matures. Utilisez le propriétaire pour des tâches vision-langage fiables.',
          ],
        },
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'LLaMA 3.1 70B et Mistral Large 2 sont les modèles open-weights de codage les plus performants. Sur HumanEval (benchmark de génération de code), ils obtiennent 73–78 %, contre GPT-4o à ~90 % et Claude Opus 4.7 à ~87 %. Pour Python, SQL et la sortie structurée, l\'open-weights est compétitif. Pour la conception d\'algorithmes complexes et le raisonnement multi-fichiers, les modèles propriétaires conservent un avantage significatif.',
            },
            {
    ...
    ja: {
      ...
      intro: 'LLaMA 4やMistralなどのオープンウェイトモデルは完全な制御とスケールでのコスト削減を提供し、GPT-4oやClaude Opus 4.7などの独占的モデルはフロンティアパフォーマンスを実現します。両カテゴリは性能面で収束しつつありますが、アクセス方法、カスタマイズ性、コンプライアンス要件では大きく異なります。',
      metaDescription: 'オープンウェイト (LLaMA 4、DeepSeek-R1) と独占的LLM (GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro) を比較：価格、コンテキストウィンドウ、MoE アーキテクチャ、エージェント型コーディングベンチマーク、データプライバシー。',
      publishDate: '2026-03-24',
      ...
      schema: {
        ...
        datePublished: '2026-03-24',
        dateModified: '2026-05-03',
        keywords: ['オープンウェイト', 'LLaMA 4', 'DeepSeek-R1', 'Mistral Large', '独占的モデル', 'GPT-4o', 'Claude Opus 4.7', 'ファインチューニング', 'コスト分析', 'MoE'],
        teaches: [
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '2026年でコーディングに最適なオープンウェイトモデルはどれですか？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 3.1 70BとMistral Large 2が最強のオープンウェイトコーディングモデルです。HumanEvalスコア（コード生成ベンチマーク）は73〜78%で、GPT-4oの約90%、Claude Opus 4.7の約87%と比較されます。Python・SQL・構造化出力ではオープンウェイトが競争力を持ちます。複雑なアルゴリズム設計やマルチファイル推論では、独自モデルが依然として優位性を維持しています。' } },
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'LLaMA 3.1 70BとMistral Large 2が最強のオープンウェイトコーディングモデルです。HumanEvalスコアは73〜78%で、GPT-4oの約90%、Claude Opus 4.7の約87%と比較されます。Python・SQL・構造化出力ではオープンウェイトが競争力を持ちます。複雑なアルゴリズム設計やマルチファイル推論では、独自モデルが依然として大きな優位性を維持しています。',
            },
            {
    ...
    zh: {
      ...
      theme: 'Techniques',
      title: '开源与专有LLM：竞争格局',
      intro: '开放权重模型（如LLaMA 4和Mistral）提供完全控制和规模化成本节省；专有模型（如GPT-4o和Claude Opus 4.7）则提供前沿性能。两类模型的能力正在趋同，但在访问方式、定制化程度和合规要求上存在明显分歧。',
      metaDescription: '对比开放权重模型 (LLaMA 4、DeepSeek-R1) 与专有LLM (GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro)：定价、上下文窗口、MoE架构、代理编程基准与合规性。为企业和开发者选择合适的推理方案。',
      publishDate: '2026-03-24',
      ...
      quickFacts: [
        ...
        '**性能差异：** GPT-4o在MMLU上领先LLaMA（88.7% vs 80.5%），但Claude Opus 4.7在代理型编程（SWE-bench Pro：64.3% vs 58.6%）上领先GPT-4o',
        '**上下文窗口：** 开放权重（LLaMA 4 Scout：1000万token，LLaMA 4 Maverick：100万token）vs 专有（Claude Opus 4.7：100万token，GPT-4o：100万token，Gemini 3.1 Pro：100万token）',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '2026年哪个开放权重模型最适合编程？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 3.1 70B和Mistral Large 2最强。HumanEval分数：约73–78%，而GPT-4o约90%，Claude Opus 4.7约87%。在Python、SQL和结构化输出方面具有竞争力。专有模型在复杂算法设计和多文件推理方面仍保持优势。' } },
      ...
      sections: {
        ...
        whatIsProprietary: {
          title: '什么是专有LLM？',
          content: [
            '**专有LLM是封闭模型，只能通过API访问——供应商控制权重、训练数据、安全对齐和所有更新。** OpenAI（GPT-4o）、Anthropic（Claude Opus 4.7）、Google（Gemini 3.1 Pro）和Mistral API都是专有的。您无法下载权重、查看训练数据、在本地运行推理或直接定制模型权重。',
            '**定价为供应商控制服务器上的按token API计费。** GPT-4o的输入费用为每百万token 5美元，输出为每百万token 15美元。Claude Opus 4.7为3美元/15美元。Gemini 3.1 Pro为1.25美元/2.50美元（≤200K上下文）。您没有基础设施成本，但无法精确预测每月支出——成本随使用量扩展。',
        ...
        definitions: {
          ...
          content: [
            ...
            '**专有LLM。** 一种大型语言模型，其权重保密且从不发布。访问完全通过供应商的API进行，需要按token计费和网络连接。示例：GPT-4o（OpenAI）、Claude Opus 4.7（Anthropic）、Gemini 3.1 Pro（Google）。用户无法下载、检查、修改或自托管模型。',
            '**微调。** 在针对特定领域或任务的新的较小数据集上重新训练预训练模型的过程。微调更新模型的权重以专业化于您的用例（例如客服语气、领域词汇）。开放权重模型通过LoRA、QLoRA或全量反向传播支持完整微调；大多数专有模型限制或禁止微调。',
            '**训练数据截止日期。** 模型对此日期之后的事件或信息不具备知识的日期。GPT-4o的截止日期为2024年10月；Claude Opus 4.7为2025年初；Gemini 3.1 Pro为2024年10月。模型无法提供截止日期后事件的准确信息。',
        ...
        whenProprietary: {
          ...
          items: [
            ...
            '**多模态输入（图像、音频）：** GPT-4o和Claude Opus 4.7可靠地处理图像输入。多模态开放权重模型存在但不够成熟。对于可靠的视觉-语言任务，使用专有模型。',
          ],
        },
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'LLaMA 3.1 70B和Mistral Large 2是最强的开放权重编程模型。在HumanEval（代码生成基准）上，它们得分73–78%，而GPT-4o约90%，Claude Opus 4.7约87%。在Python、SQL和结构化输出方面，开放权重具有竞争力。在复杂算法设计和多文件推理方面，专有模型保持显著优势。',
            },
            {
              q: '我可以将开源LLM用于商业应用吗？',
