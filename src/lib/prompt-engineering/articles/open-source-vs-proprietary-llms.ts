...
export const article: Record<Language, PEArticle> = {
    en: {
      ...
      quickFacts: [
        ...
        '**Performance gap:** 7–8 points on MMLU (GPT-5.5: 88.7% vs LLaMA 3.1: 80.5%)',
        '**Context windows:** Open-weights (LLaMA: 131K) vs Proprietary (Claude: 200K, Gemini: 2M)',
        ...
        '**Inference speed:** Open-weights (A100: 20–30 tokens/sec) vs Proprietary (30–50+ tokens/sec optimized)',
      ],
      schema: {
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Which open-source LLM is closest to GPT-5.5 in 2026?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 3.1 70B and Mistral Large 2 are closest. MMLU scores: GPT-5.5 88.7%, LLaMA 3.1 70B 80.5%, Mistral Large 81.2%. On classification, summarization, and extraction, open-weights now matches proprietary. The reasoning gap narrows ~2–3 points per year.' } },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Open-weights = downloadable model weights (LLaMA, Mistral, Qwen); proprietary = API-only access (GPT-5.5, Claude 4.6, Gemini 2.5). "Open weights" is not the same as open-source licensing.',
        ...
        whatIsProprietary: {
          ...
          content: [
            ...
            '**Pricing is per-token API billing on a vendor-controlled server.** GPT-5.5 costs $5 per 1M input tokens and $15 per 1M output tokens. Claude Opus 4.7 costs $3/$15. Gemini 3.1 Pro costs $1.25/$2.50 (≤200K context). You have no infrastructure cost but cannot predict monthly spend precisely — costs scale with usage.',
        ...
        definitions: {
          ...
          content: [
            ...
            '**Training Data Cutoff.** The date after which a model has no knowledge of events or information. GPT-5.5 has a cutoff of October 2024; Claude Opus 4.7 has early 2025; Gemini 3.1 Pro has October 2024. Models cannot provide accurate information about events after their cutoff date.',
        ...
        quickReference: {
          ...
          rows: [
            { 'Model': 'GPT-5.5', 'Type': 'Proprietary', 'Context Window': '128K tokens', 'Approx. Cost': '$5/$15 per 1M input/output tokens', 'Best For': 'Tool integration, agents, multimodal reasoning' },
            { 'Model': 'Claude Opus 4.7', 'Type': 'Proprietary', 'Context Window': '200K tokens', 'Approx. Cost': '$3/$15 per 1M input/output tokens', 'Best For': 'Writing, code review, structured reasoning' },
            { 'Model': 'Gemini 3.1 Pro', 'Type': 'Proprietary', 'Context Window': '2M tokens', 'Approx. Cost': '$1.25/$2.50 per 1M input/output tokens (≤200K)', 'Best For': 'Long-document research, Google integration' },
        ...
        openSourceLandscape: {
          ...
          callouts: [
            { type: '💡', label: 'Pro Tip', text: 'Start with LLaMA 3.1 8B for testing — it runs on any consumer laptop, trains fine-tuning examples fast, and covers 70% of use cases. Upgrade to 70B or Mistral Large only after proving you need the performance.' },
          ],
        },
        ...
        proprietaryLandscape: {
          ...
          content: [
            ...
            '**OpenAI\'s GPT-5.5 remains the reasoning leader.** GPT-5.5 supports 128K token context with a training cutoff of October 2024. It excels at tool use, agent workflows, multimodal input (images, text), and complex multi-step reasoning. API pricing: $5 per 1M input tokens, $15 per 1M output tokens (March 2026 rates). GPT-5.5 is API-only; weights are never released. See [how context windows affect your AI system](/prompt-engineering/context-windows-explained-why-ai-forgets) to understand trade-offs.',
            '**Anthropic\'s Claude Opus 4.7 dominates writing and code quality benchmarks.** Claude supports 200K token context — 2× larger than GPT-5.5 — enabling longer documents and extended conversations. Training data cutoff: early 2025. API pricing: $3 per 1M input tokens, $15 per 1M output tokens. Claude does not offer public fine-tuning. Anthropic prioritizes interpretability and safety alignment over benchmark maximization.',
            '**Google\'s Gemini 3.1 Pro offers the largest context window: 2M tokens.** This enables full book-length document processing, exhaustive research, and extended multi-turn conversations. Pricing: $1.25 per 1M input tokens (≤200K context), $10 per 1M output tokens; higher rates for >200K context. Gemini integrates deeply with Google Workspace, Calendar, Gmail, and web search. Training data cutoff: October 2024. Fine-tuning is available for Gemini models.',
          ],
        },
        ...
        performanceBenchmarks: {
          ...
          content: [
            ...
            '',
            '**Important caveat:** Benchmarks measure narrow skills. Task-specific performance varies: on classification, summarization, and extraction, LLaMA 3.1 70B often matches or exceeds GPT-5.5. For complex multi-step reasoning (algebra, long chains of thought), proprietary models maintain an edge. The only reliable benchmark is testing on your actual task — see [how to pick the right model for your use case](/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model).',
          ],
          callouts: [
            { type: '🔍', label: 'Did You Know?', text: 'MMLU is a good general reasoning benchmark but doesn\'t measure performance on your specific task. On classification, extraction, and summarization, LLaMA 3.1 70B often matches or beats GPT-5.5. Benchmark your actual use case, not generic scores.' },
          ],
        },
        ...
        costAnalysis: {
          ...
          callouts: [
            ...
            { type: '🔍', label: 'Did You Know?', text: 'Batching 1M tokens for classification costs $3–15 on proprietary APIs. Running 1M tokens on self-hosted LLaMA 70B costs ~$0.30 in GPU time. At 50M tokens/day, the difference is $150–750/day vs $15/day.' },
          ],
          columns: ['Model', 'Input (per 1M tokens)', 'Output (per 1M tokens)'],
          rows: [
            { 'Model': 'GPT-5.5', 'Input (per 1M tokens)': '$5.00', 'Output (per 1M tokens)': '$15.00' },
            { 'Model': 'Claude Opus 4.7', 'Input (per 1M tokens)': '$3.00', 'Output (per 1M tokens)': '$15.00' },
            { 'Model': 'Gemini 3.1 Pro', 'Input (per 1M tokens)': '$1.25 (≤200K ctx)', 'Output (per 1M tokens)': '$2.50' },
          ],
          tableFormat: true,
        },
        ...
        comparisonTable: {
          ...
          rows: [
            ...
            { 'Dimension': 'Performance ceiling', 'Open-Weights Models': 'Best open-weights (LLaMA 70B, Mistral Large): MMLU 80–82%. Competitive on specific tasks, lag on abstract reasoning.', 'Proprietary Models': 'Frontier (GPT-5.5, Claude, Gemini): MMLU 88–90%. Higher ceiling on reasoning, agents, multimodal.' },
            { 'Dimension': 'Context window', 'Open-Weights Models': 'LLaMA 3.1: 131K. Mistral Large: 123K. Qwen: 128K. Sufficient for long documents.', 'Proprietary Models': 'GPT-5.5: 128K. Claude: 200K. Gemini 2.5: 2M. Larger windows enable longer research.' },
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'LLaMA 3.1 70B and Mistral Large 2 are closest, but gaps remain. On MMLU (reasoning benchmark), GPT-5.5 scores 88.7% vs LLaMA 3.1 70B at 80.5% and Mistral Large at 81.2%. On specific tasks (classification, summarization, extraction), open-weights now matches proprietary. The gap narrows ~2–3 points per year; convergence on reasoning tasks is likely in 18–24 months.',
            },
            {
            ...
            },
            {
              ...
              a: 'LLaMA 3.1 70B and Mistral Large 2 are the strongest open-weights coding models. On HumanEval (code generation benchmark), they score 73–78%, compared to GPT-5.5 at ~90% and Claude Opus 4.7 at ~87%. For Python, SQL, and structured output, open-weights is competitive. For complex algorithm design and multi-file reasoning, proprietary models maintain a significant edge.',
            },
            {
