...
export const article: Record<Language, PEArticle> = {
    en: {
      ...
      metaDescription: 'Open-weights (LLaMA 4, DeepSeek-R1) vs proprietary (GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro): pricing, context windows, MoE architecture, and agentic coding benchmarks. Choose based on volume, privacy, and infrastructure readiness.',
    ...
    de: {
      ...
      metaDescription: 'Open-Weights (LLaMA 4, DeepSeek-R1) vs proprietäre (GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro): Preise, Context Windows, MoE, Datenschutz und Coding-Benchmarks für 2026.',
      publishDate: '2026-03-24',
    ...
    fr: {
      ...
      metaDescription: 'LLMs open-weights (LLaMA 4, DeepSeek-R1) vs propriétaires (GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro) : prix, fenêtres contextuelles, architecture MoE, benchmarks coding. Choisissez selon le volume, la confidentialité et la préparation infrastructure.',
      publishDate: '2026-03-24',
    ...
    ja: {
      ...
      metaDescription: 'オープンウェイト (LLaMA 4, DeepSeek-R1) vs 独占的 (GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro) : 価格、コンテキストウィンドウ、MoE、エージェントコーディングベンチマーク。2026年。',
      publishDate: '2026-03-24',
    ...
    zh: {
      theme: 'Techniques',
      title: '开源与专有LLM：竞争格局',
      intro: '开放权重模型（如LLaMA 3.1和Mistral）提供控制力与成本节省；专有模型（如GPT-5.5和Claude Opus 4.7）则提供前沿性能。两类模型的能力正在趋同，但在访问方式、定制化程度和合规要求上存在明显分歧。',
      ...
      schema: {
        ...
        description: '开放权重模型（如LLaMA 3.1和Mistral）提供控制力与成本节省；专有模型（如GPT-5.5和Claude Opus 4.7）则提供前沿性能。',
        datePublished: '2026-03-24',
        dateModified: '2026-04-01',
        keywords: ['开源LLM', 'LLaMA', 'Mistral', '专有模型', 'GPT-5.5', 'Claude', '微调', '成本分析', '开放权重', '本地推理'],
        teaches: [
          'LLM中开放权重与开源许可的区别',
