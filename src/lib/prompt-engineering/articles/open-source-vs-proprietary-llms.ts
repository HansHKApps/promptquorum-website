...
export const article: Record<Language, PEArticle> = {
    en: {
      ...
      intro: 'Open-weights models like LLaMA 3.1 and Mistral offer control and cost savings; proprietary models like GPT-5.5 and Claude Opus 4.7 deliver frontier performance. Both categories converge in capability but diverge in access, customization, and compliance requirements.',
      metaDescription: 'Compare open-weights (LLaMA 4, DeepSeek-R1) vs proprietary (GPT-5.5, Claude, Gemini): pricing, context windows, agentic coding & MoE architecture.',
      publishDate: '2026-03-24',
      seoTitle: 'Open-Weights vs Proprietary LLMs 2026: Cost & Performance',
      ...
      quickFacts: [
        ...
        '**Performance gap:** GPT-5.5 leads LLaMA on MMLU (88.7% vs 80.5%), but Claude Opus 4.7 leads GPT-5.5 on agentic coding (SWE-bench Pro: 64.3% vs 58.6%)',
        '**Context windows:** Open-weights (LLaMA 4 Scout: 10M, LLaMA 4 Maverick: 1M) vs Proprietary (Claude Opus 4.7: 1M, GPT-5.5: 1M, Gemini 3.1 Pro: 1M)',
      ...
      schema: {
        ...
        description: 'Open-weights models like LLaMA 3.1 and Mistral offer control and cost savings; proprietary models like GPT-5.5 and Claude Opus 4.7 deliver frontier performance.',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Which open-source LLM is closest to GPT-5.5 in 2026?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick, DeepSeek-R1, and Mistral Large 2 are closest. On MMLU, GPT-5.5 88.7% vs open-weights 80–83%. On agentic coding (SWE-bench Pro), Claude Opus 4.7 (64.3%) leads GPT-5.5 (58.6%), showing task-specific parity is achievable. Test on your specific task.' } },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Open-weights = downloadable model weights (LLaMA 4, Mistral, Qwen); proprietary = API-only access (GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro). "Open weights" is not the same as open-source licensing.',
            'Performance varies by task: LLaMA 4 Scout/Maverick and Mistral Large 2 now match proprietary on classification — but lag on abstract reasoning. On agentic coding (SWE-bench Pro), Claude Opus 4.7 (64.3%) leads GPT-5.5 (58.6%); on Terminal-Bench, GPT-5.5 (82.7%) leads Opus 4.7 (69.4%).',
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**Proprietary models are neither open weights nor open source.** OpenAI (GPT-5.5), Anthropic (Claude Opus 4.7), and Google (Gemini 3.1 Pro) do not release model weights. You access them exclusively via API. The weights remain closed; you cannot see, download, modify, or deploy the model yourself.',
        ...
        whatIsProprietary: {
          ...
          content: [
            '**Proprietary LLMs are closed models accessible only via API — the vendor controls the weights, training data, safety alignment, and all updates.** OpenAI (GPT-5.5), Anthropic (Claude Opus 4.7), Google (Gemini 3.1 Pro), and Mistral API are proprietary. You cannot download weights, view training data, run inference locally, or customize the model weights directly.',
            '**Pricing is per-token API billing on a vendor-controlled server.** GPT-5.5 costs $5 per 1M input tokens and $30 per 1M output tokens. Claude Opus 4.7 costs $5/$25. Gemini 3.1 Pro costs $2.00/$12.00 (≤200K context; higher above 200K). You have no infrastructure cost but cannot predict monthly spend precisely — costs scale with usage.',
        ...
        definitions: {
          ...
          content: [
            ...
            '**Proprietary LLM.** A large language model whose weights are kept private and never released. Access is exclusively through a vendor\'s API, requiring per-token billing and network connectivity. Examples: GPT-5.5 (OpenAI), Claude Opus 4.7 (Anthropic), Gemini 3.1 Pro (Google). Users cannot download, inspect, modify, or self-host the model.',
            ...
            '**Training Data Cutoff.** The date after which a model has no knowledge of events or information. GPT-5.5 has a cutoff of December 2025; Claude Opus 4.7 has early-to-mid 2025; Gemini 3.1 Pro has January 2025. Models cannot provide accurate information about events after their cutoff date.',
        ...
        featureComparison: {
          ...
          rows: [
            ...
            { 'Feature': 'Performance', 'Open Source LLM': '80–82% MMLU; LLaMA 4 competitive on coding (SWE-bench). Lag on abstract reasoning vs frontier.', 'Proprietary LLM': '88–90% MMLU; Claude Opus 4.7 leads agentic coding (SWE-bench Pro 64.3%); GPT-5.5 leads reasoning benchmarks.' },
        ...
        quickReference: {
          ...
          rows: [
            ...
            { 'Model': 'Claude Opus 4.7', 'Type': 'Proprietary', 'Context Window': '1M tokens', 'Approx. Cost': '$5/$25 per 1M input/output tokens', 'Best For': 'Agentic coding, writing, structured reasoning' },
        ...
        proprietaryLandscape: {
          ...
          content: [
            ...
            '**Anthropic\'s Claude Opus 4.7 leads on agentic coding and writing quality.** Claude supports 1M token context — enabling full codebase analysis and extended research. Training data cutoff: early-to-mid 2025. API pricing: $5 per 1M input tokens, $25 per 1M output tokens. On SWE-bench Pro (agentic coding), Claude Opus 4.7 scores 64.3% — ahead of GPT-5.5 at 58.6%. Claude does not offer public fine-tuning. Claude Mythos Preview (invitation-only): $25/$125 per 1M tokens, cybersecurity-focused.',
        ...
        performanceBenchmarks: {
          ...
          content: [
            '**Benchmark performance depends heavily on the task type — proprietary models no longer lead across all categories.** MMLU (broad academic reasoning) still shows a 7–8 point gap, but agentic coding (SWE-bench Pro) shows Claude Opus 4.7 ahead of GPT-5.5, and ARC-AGI-2 (abstract reasoning) is led by Gemini 3.1 Pro.',
            '',
            'MMLU (broad reasoning) — 2024/2025:',
            'GPT-5.5: 88.7% | Claude Opus 4.7: ~88% | LLaMA 3.1 70B: 80.5% | Mistral Large 2: 81.2% | Qwen 2.5 72B: 82.1%',
            '',
            'SWE-bench Pro (agentic coding, 2026):',
            'Claude Opus 4.7: 64.3% (SWE-bench Pro) / 87.6% (SWE-bench Verified) | GPT-5.5: 58.6% | LLaMA 4 Maverick: data pending',
            '',
            'Terminal-Bench 2.0 (CLI & system tasks, 2026):',
            'GPT-5.5: 82.7% | Claude Opus 4.7: 69.4%',
            '',
            'ARC-AGI-2 (abstract reasoning, 2026):',
            'Gemini 3.1 Pro: 77.1% | GPT-5.5: data pending | Claude Opus 4.7: data pending',
            '',
            '**The benchmark picture is more fragmented in 2026 than in prior years.** No single model leads all benchmarks. On agentic coding, Claude Opus 4.7 leads. On CLI reasoning, GPT-5.5 leads. On abstract reasoning, Gemini leads. On MMLU (academic knowledge), GPT-5.5 and Claude are near-tied. Open-weights (LLaMA 4 Maverick, DeepSeek-R1) are closing the gap on reasoning tasks.',
            '',
        ...
        costAnalysis: {
          ...
          content: [
            ...
            '',
            '**At 5M tokens/day:** A100 self-hosting costs ~$2.50/day. API costs for Claude Opus 4.7: 2.5M × $5/1M + 2.5M × $25/1M = $12.50 + $62.50 = $75/day (assumes 50% input, 50% output). APIs still cheaper. Using GPT-5.5 at $5/$30: $12.50 + $75 = $87.50/day.',
            '',
          ...
          callouts: [
            ...
            { type: '🔍', label: 'Did You Know?', text: 'Batching 1M tokens for classification costs $5–30 on Claude Opus 4.7 or GPT-5.5. Running 1M tokens on self-hosted LLaMA 4 Scout costs ~$0.20–0.30 in GPU time (MoE efficiency). At 50M tokens/day, the difference is $750–1,500/day API vs ~$15/day self-hosted.' },
          ],
          ...
          rows: [
            ...
            { 'Model': 'Claude Opus 4.7', 'Input (per 1M tokens)': '$5.00', 'Output (per 1M tokens)': '$25.00' },
        ...
        comparisonTable: {
          ...
          rows: [
            ...
            { 'Dimension': 'Performance ceiling', 'Open-Weights Models': 'Best open-weights (LLaMA 4 Maverick, DeepSeek-R1): MMLU 80–84%. Competitive on coding and extraction; lag on abstract multi-step reasoning.', 'Proprietary Models': 'Frontier (GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro): MMLU 88–90%. Claude Opus 4.7 leads SWE-bench Pro (64.3%); GPT-5.5 leads Terminal-Bench (82.7%).' },
            { 'Dimension': 'Context window', 'Open-Weights Models': 'LLaMA 4 Scout: 10M. LLaMA 4 Maverick: 1M. Mistral Large: 128K. Open-weights now match or exceed proprietary on context length.', 'Proprietary Models': 'GPT-5.5: 1M. Claude Opus 4.7: 1M. Gemini 3.1 Pro: 1M. All frontier proprietary models now offer ≥1M context.' },
        ...
        whenProprietary: {
          ...
          items: [
            ...
            '**Multimodal input (images, audio):** GPT-5.5 and Claude Opus 4.7 handle image input reliably. Multimodal open-weights models exist but are less mature. Use proprietary for reliable vision-language tasks.',
          ],
        },
        ...
        hybridArchitecture: {
          ...
          items: [
            '**Privacy-sensitive data → local open-weights; complex reasoning → proprietary API.** Route patient records, financial data, and legal documents to LLaMA 3.1 running locally via Ollama. Route multi-step research synthesis, code generation, and agent orchestration to GPT-5.5 or Claude Opus 4.7. This hybrid approach achieves compliance while maintaining frontier performance.',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'LLaMA 4 Maverick, DeepSeek-R1, and Mistral Large 2 are closest. On MMLU, GPT-5.5 scores 88.7% vs open-weights top competitors at 80–83%. On agentic coding (SWE-bench Pro), Claude Opus 4.7 (64.3%) leads GPT-5.5 (58.6%), showing task-specific parity is achievable. The benchmark picture is fragmented — test on your specific task.',
            },
            {
        ...
        sources: {
          ...
          items: [
            ...
            'Anthropic, "Claude Opus 4.7 Model Card" (April 2026) — pricing ($5/$25), context window (1M), SWE-bench Pro score (64.3%), training cutoff',
    ...
    de: {
      ...
      intro: 'Open-Weights-Modelle wie LLaMA 4 Scout und Mistral bieten vollständige Kontrolle und Kosteneinsparungen; proprietäre Modelle wie GPT-5.5 und Claude Opus 4.7 liefern Spitzenleistung. Beide Kategorien konvergieren bei der Leistungsfähigkeit, divergieren aber bei Zugriff, Anpassung und Compliance-Anforderungen.',
      ...
      quickFacts: [
        ...
        '**Leistungslücke:** GPT-5.5 führt LLaMA beim MMLU an (88,7% vs 80,5%), aber Claude Opus 4.7 führt GPT-5.5 beim Agentic-Coding an (SWE-bench Pro: 64,3% vs 58,6%)',
        '**Context-Fenster:** Open-Weights (LLaMA 4 Scout: 10 Mio., LLaMA 4 Maverick: 1 Mio.) vs Proprietär (Claude Opus 4.7: 1 Mio., GPT-5.5: 1 Mio., Gemini 3.1 Pro: 1 Mio.)',
      ...
      schema: {
        ...
        description: 'Open-Weights-Modelle wie LLaMA 3.1 und Mistral bieten Kontrolle und Kosteneinsparungen; proprietäre Modelle wie GPT-5.5 und Claude Opus 4.7 liefern Spitzenleistung.',
        datePublished: '2026-03-24',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Welches Open-Source-LLM ist GPT-5.5 in 2026 am nächsten?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick, DeepSeek-R1 und Mistral Large 2 sind am nächsten. MMLU: GPT-5.5 88,7% vs. Open-Weights 80–83%. Beim Agentic-Coding (SWE-bench Pro) zeigt Claude Opus 4.7 (64,3%) Parität zu GPT-5.5 (58,6%), was aufgabenspezifische Wettbewerbsfähigkeit demonstriert. Benchmarken Sie auf Ihrer spezifischen Aufgabe.' } },
          ...
          { '@type': 'Question', 'name': 'Welches Open-Weights-Modell ist 2026 am besten für Programmierung?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick und DeepSeek-R1 sind am stärksten bei SWE-bench Verified (Agentic-Coding), mit ~75–80% auf HumanEval konkurierend. Claude Opus 4.7 führt SWE-bench Verified (87,6%) an; GPT-5.5 ~77%. Open-Weights sind lebensfähig für Python und SQL. Proprietäre Modelle behalten einen Vorteil bei Multi-File-Refactoring und agentic Schleifen.' } },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Open-Weights = herunterladbare Modellgewichte (LLaMA 4, Mistral, Qwen); proprietär = nur API-Zugriff (GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro). "Open Weights" ist nicht dasselbe wie Open-Source-Lizenzierung.',
            'Leistungslücke hat sich verengt: LLaMA 4 Scout/Maverick und Mistral Large 2 entsprechen jetzt proprietären Modellen bei Klassifizierung und Zusammenfassung — liegen aber hinter bei abstraktem Reasoning zurück. Beim Agentic-Coding (SWE-bench Pro) führt Claude Opus 4.7 (64,3%) GPT-5.5 an (58,6%); bei Terminal-Bench führt GPT-5.5 (82,7%) Claude Opus 4.7 an (69,4%).',
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**Proprietäre Modelle sind weder Open-Weights noch Open Source.** OpenAI (GPT-5.5), Anthropic (Claude Opus 4.7) und Google (Gemini 3.1 Pro) veröffentlichen keine Modellgewichte. Sie greifen ausschließlich über API zu. Die Gewichte bleiben geschlossen; Sie können das Modell nicht sehen, herunterladen, ändern oder selbst bereitstellen.',
        ...
        whatIsProprietary: {
          ...
          content: [
            '**Proprietäre LLMs sind geschlossene Modelle, auf die nur über API zugegriffen werden kann — der Vendor kontrolliert die Gewichte, Trainingsdaten, Safety-Alignment und alle Updates.** OpenAI (GPT-5.5), Anthropic (Claude Opus 4.7), Google (Gemini 3.1 Pro) und Mistral API sind proprietär. Sie können keine Gewichte herunterladen, Trainingsdaten anzeigen, lokal Inferenz ausführen oder die Modellgewichte direkt anpassen.',
        ...
        definitions: {
          ...
          content: [
            ...
            '**Proprietäres LLM.** Ein großes Sprachmodell, dessen Gewichte privat bleiben und nie freigegeben werden. Der Zugriff erfolgt ausschließlich über die API eines Vendors, erfordert Pro-Token-Billing und Netzwerkverbindung. Beispiele: GPT-5.5 (OpenAI), Claude Opus 4.7 (Anthropic), Gemini 3.1 Pro (Google). Benutzer können das Modell nicht herunterladen, inspizieren, ändern oder selbst hosten.',
        ...
        quickReference: {
          ...
          rows: [
            ...
            { 'Modell': 'Claude Opus 4.7', 'Typ': 'Proprietär', 'Kontextfenster': '200K Token', 'Ungefähre Kosten': '$3/$15 pro 1 Million Input/Output-Token', 'Am besten für': 'Schreiben, Code Review, strukturiertes Reasoning' },
        ...
        costAnalysis: {
          ...
          rows: [
            ...
            { 'Modell': 'Claude Opus 4.7', 'Input (pro 1M Token)': '$3,00', 'Output (pro 1M Token)': '$15,00' },
        ...
        whenProprietary: {
          ...
          items: [
            ...
            '**Multimodal-Input (Bilder, Audio):** GPT-5.5 und Claude Opus 4.7 verarbeiten Bild-Eingabe zuverlässig. Multimodal-Open-Weights-Modelle existieren, sind aber weniger reif. Verwenden Sie proprietär für zuverlässige Vision-Language-Aufgaben.',
          ],
        },
        ...
        hybridArchitecture: {
          ...
          items: [
            ...
            '**Multi-Model-Vergleich und Consensus → PromptQuorum.** Verteilen Sie einen einzelnen [Prompt](/prompt-engineering/what-is-prompt-engineering?lang=de) gleichzeitig an lokal Ollama, GPT-5.5, Claude 4.6 und Gemini 3.1 Pro über PromptQuorum. Vergleichen Sie Outputs nebeneinander auf Qualität, Latenz und Kosten. Wählen Sie den Gewinner für Produktion oder kombinieren Sie Outputs für Ensemble-Reasoning.',
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Fundamentals: GPT-5.5, Claude, or Gemini? How to Pick the Right Model](/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model?lang=de) — Detaillierter Vergleich von Frontier-proprietären Modellen',
    ...
    fr: {
      ...
      intro: 'Les modèles open-weights comme LLaMA 4 et Mistral offrent contrôle total et économies d\'échelle ; les modèles propriétaires comme GPT-5.5 et Claude Opus 4.7 livrent des performances de pointe. Les deux catégories convergent en performance mais divergent sur l\'accès, la personnalisation et la conformité.',
      ...
      quickFacts: [
        ...
        '**Écart de performance :** GPT-5.5 mène LLaMA sur MMLU (88,7% vs 80,5%), mais Claude Opus 4.7 dépasse GPT-5.5 sur coding agentic (SWE-bench Pro : 64,3% vs 58,6%)',
        '**Fenêtres contextuelles :** Open-weights (LLaMA 4 Scout : 10M, LLaMA 4 Maverick : 1M) vs Propriétaires (Claude Opus 4.7 : 1M, GPT-5.5 : 1M, Gemini 3.1 Pro : 1M)',
      ...
      schema: {
        ...
        description: 'LLMs open-weights (LLaMA 4, DeepSeek-R1) vs propriétaires (GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro) : prix, fenêtres contextuelles, architecture MoE, benchmarks agentic-coding.',
        datePublished: '2026-03-24',
        dateModified: '2026-05-03',
        keywords: ['LLMs open-source', 'LLaMA 4', 'Mistral Large', 'modèles propriétaires', 'GPT-5.5', 'Claude Opus 4.7', 'fine-tuning', 'analyse coûts', 'open-weights', 'inférence locale', 'MoE'],
        teaches: [
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Quel modèle open-weights est le meilleur pour le code en 2026 ?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 3.1 70B et Mistral Large 2 sont les plus performants. Scores HumanEval : 73–78 % contre GPT-5.5 ~90 % et Claude Opus 4.7 ~87 %. Compétitif pour Python, SQL et la sortie structurée. Les modèles propriétaires conservent un avantage sur la conception d\'algorithmes complexes et le raisonnement multi-fichiers.' } },
      ...
      sections: {
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**Les modèles propriétaires ne sont ni open-weights ni open source.** OpenAI (GPT-5.5), Anthropic (Claude Opus 4.7) et Google (Gemini 3.1 Pro) ne publient pas les poids des modèles. Vous y accédez exclusivement via API. Les poids restent fermés ; vous ne pouvez pas voir, télécharger, modifier ou déployer le modèle vous-même.',
        ...
        whatIsProprietary: {
          ...
          content: [
            '**Les LLMs propriétaires sont des modèles fermés accessibles uniquement via API — le fournisseur contrôle les poids, les données d\'entraînement, l\'alignement de sécurité et toutes les mises à jour.** OpenAI (GPT-5.5), Anthropic (Claude Opus 4.7), Google (Gemini 3.1 Pro) et Mistral API sont propriétaires. Vous ne pouvez pas télécharger les poids, consulter les données d\'entraînement, exécuter l\'inférence localement ou personnaliser directement les poids du modèle.',
        ...
        definitions: {
          ...
          content: [
            ...
            '**LLM propriétaire.** Un grand modèle de langage dont les poids restent privés et ne sont jamais publiés. L\'accès se fait exclusivement via l\'API d\'un fournisseur, nécessitant une facturation par token et une connectivité réseau. Exemples : GPT-5.5 (OpenAI), Claude Opus 4.7 (Anthropic), Gemini 3.1 Pro (Google). Les utilisateurs ne peuvent pas télécharger, inspecter, modifier ou auto-héberger le modèle.',
        ...
        quickReference: {
          ...
          rows: [
            ...
            { 'Modèle': 'Claude Opus 4.7', 'Type': 'Propriétaire', 'Fenêtre de contexte': '200 K tokens', 'Coût approximatif': '3 $/15 $ par million de tokens entrée/sortie', 'Idéal pour': 'Rédaction, revue de code, raisonnement structuré' },
        ...
        costAnalysis: {
          ...
          rows: [
            ...
            { 'Modèle': 'Claude Opus 4.7', 'Entrée (par million de tokens)': '3,00 $', 'Sortie (par million de tokens)': '15,00 $' },
        ...
        whenProprietary: {
          ...
          items: [
            ...
            '**Entrées multimodales (images, audio) :** GPT-5.5 et Claude Opus 4.7 traitent les images de façon fiable. Les modèles open-weights multimodaux existent mais sont moins matures. Utilisez le propriétaire pour des tâches vision-langage fiables.',
          ],
        },
        ...
        hybridArchitecture: {
          ...
          items: [
            ...
            '**Comparaison et consensus multi-modèles → PromptQuorum.** Envoyez un seul [prompt](/prompt-engineering/what-is-prompt-engineering?lang=fr) à Ollama local, GPT-5.5, Claude 4.6 et Gemini 3.1 Pro simultanément via PromptQuorum. Comparez les sorties côte à côte sur la qualité, la latence et le coût. Choisissez le meilleur pour la production ou combinez les sorties pour un raisonnement en ensemble.',
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Fondamentaux : GPT-5.5, Claude ou Gemini ? Comment choisir le bon modèle](/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model?lang=fr) — Comparaison détaillée des modèles propriétaires de pointe',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'LLaMA 3.1 70B et Mistral Large 2 sont les modèles open-weights de codage les plus performants. Sur HumanEval (benchmark de génération de code), ils obtiennent 73–78 %, contre GPT-5.5 à ~90 % et Claude Opus 4.7 à ~87 %. Pour Python, SQL et la sortie structurée, l\'open-weights est compétitif. Pour la conception d\'algorithmes complexes et le raisonnement multi-fichiers, les modèles propriétaires conservent un avantage significatif.',
            },
            {
    ...
    ja: {
      ...
      intro: 'LLaMA 4やMistralなどのオープンウェイトモデルは完全な制御とスケールでのコスト削減を提供し、GPT-5.5やClaude Opus 4.7などの独占的モデルはフロンティアパフォーマンスを実現します。両カテゴリは性能面で収束しつつありますが、アクセス方法、カスタマイズ性、コンプライアンス要件では大きく異なります。',
      metaDescription: 'オープンウェイト (LLaMA 4、DeepSeek-R1) と独占的LLM (GPT-5.5、Claude Opus 4.7、Gemini 3.1 Pro) を比較：価格、コンテキストウィンドウ、MoE アーキテクチャ、エージェント型コーディングベンチマーク、データプライバシー。',
      publishDate: '2026-03-24',
      ...
      quickFacts: [
        ...
        '**性能ギャップ :** GPT-5.5がLLaMAをMMLU (88.7% vs 80.5%) で上回るも、Claude Opus 4.7がGPT-5.5をエージェント型コーディング (SWE-bench Pro: 64.3% vs 58.6%) で上回る',
        '**コンテキストウィンドウ :** オープンウェイト (LLaMA 4 Scout: 10M、LLaMA 4 Maverick: 1M) vs 独占的 (Claude Opus 4.7: 1M、GPT-5.5: 1M、Gemini 3.1 Pro: 1M)',
      ...
      schema: {
        ...
        description: 'オープンウェイト (LLaMA 4, DeepSeek-R1) vs 独占的 (GPT-5.5、Claude Opus 4.7、Gemini 3.1 Pro) : 価格、コンテキストウィンドウ、MoE、エージェントコーディングベンチマーク。',
        datePublished: '2026-03-24',
        dateModified: '2026-05-03',
        keywords: ['オープンウェイト', 'LLaMA 4', 'DeepSeek-R1', 'Mistral Large', '独占的モデル', 'GPT-5.5', 'Claude Opus 4.7', 'ファインチューニング', 'コスト分析', 'MoE'],
        teaches: [
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '2026年でコーディングに最適なオープンウェイトモデルはどれですか？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 3.1 70BとMistral Large 2が最強のオープンウェイトコーディングモデルです。HumanEvalスコア（コード生成ベンチマーク）は73〜78%で、GPT-5.5の約90%、Claude Opus 4.7の約87%と比較されます。Python・SQL・構造化出力ではオープンウェイトが競争力を持ちます。複雑なアルゴリズム設計やマルチファイル推論では、独自モデルが依然として優位性を維持しています。' } },
      ...
      sections: {
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**独自モデルはオープンウェイトでもオープンソースでもありません。** OpenAI（GPT-5.5）・Anthropic（Claude Opus 4.7）・Google（Gemini 3.1 Pro）はモデルウェイトをリリースしていません。APIを通じてのみアクセスできます。ウェイトはクローズドのままで、自分でモデルを確認・ダウンロード・修正・デプロイすることはできません。',
        ...
        whatIsProprietary: {
          title: '独自LLMとは何ですか？',
          content: [
            '**独自LLMはAPIを通じてのみアクセスできるクローズドモデルです — ベンダーがウェイト・学習データ・安全アライメント・すべての更新を管理します。** OpenAI（GPT-5.5）・Anthropic（Claude Opus 4.7）・Google（Gemini 3.1 Pro）・Mistral APIは独自モデルです。ウェイトをダウンロードしたり、学習データを確認したり、ローカルで推論を実行したり、モデルウェイトを直接カスタマイズしたりすることはできません。',
            '**価格はベンダー管理サーバーでのトークン単位のAPI課金です。** GPT-5.5は入力100万トークンあたり$5、出力100万トークンあたり$15です。Claude Opus 4.7は$3/$15。Gemini 3.1 Proは$1.25/$2.50（200K以下のコンテキスト）。インフラコストはかかりませんが、月額コストを正確に予測することはできず、コストは使用量に応じてスケールします。',
        ...
        definitions: {
          ...
          content: [
            ...
            '**独自LLM。** ウェイトが非公開で決してリリースされない大規模言語モデル。アクセスはベンダーのAPIを通じてのみ可能で、トークン課金とネットワーク接続が必要です。例：GPT-5.5（OpenAI）、Claude Opus 4.7（Anthropic）、Gemini 3.1 Pro（Google）。ユーザーはモデルをダウンロード・検査・修正・自己ホスティングすることができません。',
            ...
            '**学習データカットオフ。** モデルがその日付以降のイベントや情報の知識を持たない日付。GPT-5.5のカットオフは2024年10月、Claude Opus 4.7は2025年初頭、Gemini 3.1 Proは2024年10月です。モデルはカットオフ日以降のイベントについて正確な情報を提供できません。',
        ...
        quickReference: {
          ...
          rows: [
            ...
            { 'モデル': 'Claude Opus 4.7', 'タイプ': '独自', 'コンテキストウィンドウ': '200Kトークン', '概算コスト': '入力/出力100万トークンあたり$3/$15', '最適なユースケース': 'ライティング・コードレビュー・構造化推論' },
        ...
        proprietaryLandscape: {
          ...
          content: [
            ...
            '**OpenAIのGPT-5.5は推論のリーダーとして地位を維持しています。** GPT-5.5は2024年10月の学習カットオフで128Kトークンのコンテキストをサポートしています。ツール使用・エージェントワークフロー・マルチモーダル入力（画像・テキスト）・複雑な多段階推論で優れています。APIの価格：入力100万トークンあたり$5、出力100万トークンあたり$15（2026年3月現在）。GPT-5.5はAPIのみです。[コンテキストウィンドウがAIシステムにどう影響するか](/prompt-engineering/context-windows-explained-why-ai-forgets?lang=ja)を参照して、トレードオフを理解してください。',
            '**AnthropicのClaude Opus 4.7はライティングとコード品質ベンチマークで支配的です。** Claudeは200Kトークンのコンテキストをサポートしており、GPT-5.5の2倍で、より長い文書と長い会話が可能です。学習データのカットオフ：2025年初頭。APIの価格：入力100万トークンあたり$3、出力100万トークンあたり$15。Claudeは公開のファインチューニングを提供していません。Anthropicはベンチマーク最大化よりも解釈可能性と安全アライメントを優先しています。',
        ...
        performanceBenchmarks: {
          ...
          content: [
            ...
            '',
            '**重要な注意点：** ベンチマークは狭いスキルを測定します。タスク固有のパフォーマンスは変動します：分類・要約・抽出では、LLaMA 3.1 70BがGPT-5.5と同等またはそれ以上のパフォーマンスを示すことが多いです。複雑な多段階推論（代数、長い思考の連鎖）では、独自モデルが優位性を維持しています。唯一の信頼できるベンチマークは、実際のタスクでテストすることです — [ユースケースに最適なモデルの選び方](/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model?lang=ja)を参照してください。',
          ],
        },
        ...
        costAnalysis: {
          ...
          rows: [
            ...
            { 'モデル': 'Claude Opus 4.7', '入力（100万トークンあたり）': '$3.00', '出力（100万トークンあたり）': '$15.00' },
        ...
        whenProprietary: {
          ...
          items: [
            ...
            '**マルチモーダル入力（画像・音声）：** GPT-5.5とClaude Opus 4.7は画像入力を確実に処理します。マルチモーダルのオープンウェイトモデルは存在しますが、成熟度が低いです。信頼性の高いビジョン-言語タスクには独自モデルを使用してください。',
          ],
        },
        ...
        hybridArchitecture: {
          ...
          items: [
            '**プライバシー敏感データ → ローカルのオープンウェイト、複雑な推論 → 独自API。** 患者記録・金融データ・法的文書をOllamaを通じてローカルで動作するLLaMA 3.1にルーティングします。多段階の研究合成・コード生成・エージェントオーケストレーションをGPT-5.5またはClaude Opus 4.7にルーティングします。このハイブリッドアプローチでコンプライアンスを達成しながらフロンティアパフォーマンスを維持できます。',
            ...
            '**マルチモデル比較とコンセンサス → PromptQuorum。** PromptQuorumを使用して、単一の[プロンプト](/prompt-engineering/what-is-prompt-engineering?lang=ja)をローカルOllama・GPT-5.5・Claude 4.6・Gemini 3.1 Proに同時にディスパッチします。品質・レイテンシー・コストを並べて比較してください。本番用のウィナーを選択するか、アンサンブル推論のために出力を組み合わせてください。',
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[基礎：GPT-5.5、Claude、それともGemini？正しいモデルの選び方](/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model?lang=ja) — フロンティア独自モデルの詳細比較',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'LLaMA 3.1 70BとMistral Large 2が最強のオープンウェイトコーディングモデルです。HumanEvalスコアは73〜78%で、GPT-5.5の約90%、Claude Opus 4.7の約87%と比較されます。Python・SQL・構造化出力ではオープンウェイトが競争力を持ちます。複雑なアルゴリズム設計やマルチファイル推論では、独自モデルが依然として大きな優位性を維持しています。',
            },
            {
    ...
    zh: {
      ...
      theme: 'Techniques',
      title: '开源与专有LLM：竞争格局',
      intro: '开放权重模型（如LLaMA 4和Mistral）提供完全控制和规模化成本节省；专有模型（如GPT-5.5和Claude Opus 4.7）则提供前沿性能。两类模型的能力正在趋同，但在访问方式、定制化程度和合规要求上存在明显分歧。',
      metaDescription: '对比开放权重模型 (LLaMA 4、DeepSeek-R1) 与专有LLM (GPT-5.5、Claude Opus 4.7、Gemini 3.1 Pro)：定价、上下文窗口、MoE架构、代理编程基准与合规性。为企业和开发者选择合适的推理方案。',
      publishDate: '2026-03-24',
      ...
      quickFacts: [
        ...
        '**性能差异：** GPT-5.5在MMLU上领先LLaMA（88.7% vs 80.5%），但Claude Opus 4.7在代理型编程（SWE-bench Pro：64.3% vs 58.6%）上领先GPT-5.5',
        '**上下文窗口：** 开放权重（LLaMA 4 Scout：1000万token，LLaMA 4 Maverick：100万token）vs 专有（Claude Opus 4.7：100万token，GPT-5.5：100万token，Gemini 3.1 Pro：100万token）',
      ...
      schema: {
        ...
        description: '开放权重模型（如LLaMA 4和Mistral）提供完全控制和规模化成本节省；专有模型（如GPT-5.5和Claude Opus 4.7）则提供前沿性能。',
        datePublished: '2026-03-24',
        dateModified: '2026-05-03',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '2026年哪个开放权重模型最适合编程？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 3.1 70B和Mistral Large 2最强。HumanEval分数：约73–78%，而GPT-5.5约90%，Claude Opus 4.7约87%。在Python、SQL和结构化输出方面具有竞争力。专有模型在复杂算法设计和多文件推理方面仍保持优势。' } },
      ...
      sections: {
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**专有模型既非开放权重也非开源。** OpenAI（GPT-5.5）、Anthropic（Claude Opus 4.7）和Google（Gemini 3.1 Pro）不发布模型权重。您只能通过API访问它们。权重保持封闭；您无法查看、下载、修改或自行部署模型。',
        ...
        whatIsProprietary: {
          title: '什么是专有LLM？',
          content: [
            '**专有LLM是封闭模型，只能通过API访问——供应商控制权重、训练数据、安全对齐和所有更新。** OpenAI（GPT-5.5）、Anthropic（Claude Opus 4.7）、Google（Gemini 3.1 Pro）和Mistral API都是专有的。您无法下载权重、查看训练数据、在本地运行推理或直接定制模型权重。',
            '**定价为供应商控制服务器上的按token API计费。** GPT-5.5的输入费用为每百万token 5美元，输出为每百万token 15美元。Claude Opus 4.7为3美元/15美元。Gemini 3.1 Pro为1.25美元/2.50美元（≤200K上下文）。您没有基础设施成本，但无法精确预测每月支出——成本随使用量扩展。',
        ...
        definitions: {
          ...
          content: [
            ...
            '**专有LLM。** 一种大型语言模型，其权重保密且从不发布。访问完全通过供应商的API进行，需要按token计费和网络连接。示例：GPT-5.5（OpenAI）、Claude Opus 4.7（Anthropic）、Gemini 3.1 Pro（Google）。用户无法下载、检查、修改或自托管模型。',
            '**微调。** 在针对特定领域或任务的新的较小数据集上重新训练预训练模型的过程。微调更新模型的权重以专业化于您的用例（例如客服语气、领域词汇）。开放权重模型通过LoRA、QLoRA或全量反向传播支持完整微调；大多数专有模型限制或禁止微调。',
            '**训练数据截止日期。** 模型对此日期之后的事件或信息不具备知识的日期。GPT-5.5的截止日期为2024年10月；Claude Opus 4.7为2025年初；Gemini 3.1 Pro为2024年10月。模型无法提供截止日期后事件的准确信息。',
        ...
        quickReference: {
          ...
          rows: [
            ...
            { '模型': 'Claude Opus 4.7', '类型': '专有', '上下文窗口': '200K个token', '大致成本': '输入/输出每百万token 3/15美元', '最适用场景': '写作、代码审查、结构化推理' },
        ...
        proprietaryLandscape: {
          ...
          content: [
            ...
            '**OpenAI的GPT-5.5仍然是推理领域的领导者。** GPT-5.5支持128K token上下文，训练截止日期为2024年10月。它在工具使用、智能体工作流、多模态输入（图像、文本）和复杂多步骤推理方面表现出色。API定价：每百万输入token 5美元，每百万输出token 15美元（2026年3月价格）。GPT-5.5仅限API；权重从不发布。参见[上下文窗口如何影响您的AI系统](/prompt-engineering/context-windows-explained-why-ai-forgets?lang=zh)以了解权衡。',
            '**Anthropic的Claude Opus 4.7在写作和代码质量基准上占据主导地位。** Claude支持200K token上下文——是GPT-5.5的2倍——能够处理更长的文档和更长的对话。训练数据截止日期：2025年初。API定价：每百万输入token 3美元，每百万输出token 15美元。Claude不提供公开微调。Anthropic将可解释性和安全对齐置于基准最大化之上。',
        ...
        performanceBenchmarks: {
          ...
          content: [
            ...
            '',
            '**重要说明：** 基准测试衡量的是狭窄技能。特定任务性能各有不同：在分类、摘要和提取方面，LLaMA 3.1 70B经常与GPT-5.5持平甚至超越。在复杂多步骤推理（代数、长思维链）方面，专有模型保持优势。唯一可靠的基准是在您的实际任务上测试——参见[如何为您的用例选择合适的模型](/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model?lang=zh)。',
          ],
        },
        ...
        costAnalysis: {
          ...
          rows: [
            ...
            { '模型': 'Claude Opus 4.7', '输入（每百万token）': '$3.00', '输出（每百万token）': '$15.00' },
        ...
        whenProprietary: {
          ...
          items: [
            ...
            '**多模态输入（图像、音频）：** GPT-5.5和Claude Opus 4.7可靠地处理图像输入。多模态开放权重模型存在但不够成熟。对于可靠的视觉-语言任务，使用专有模型。',
          ],
        },
        ...
        hybridArchitecture: {
          ...
          items: [
            '**隐私敏感数据 → 本地开放权重；复杂推理 → 专有API。** 将患者记录、金融数据和法律文件路由到通过Ollama本地运行的LLaMA 3.1。将多步骤研究综合、代码生成和智能体编排路由到GPT-5.5或Claude Opus 4.7。这种混合方式在保持前沿性能的同时实现合规性。',
            ...
            '**多模型对比和共识 → PromptQuorum。** 通过PromptQuorum同时将单个[提示词](/prompt-engineering/what-is-prompt-engineering?lang=zh)分发到本地Ollama、GPT-5.5、Claude 4.6和Gemini 3.1 Pro。并排比较质量、延迟和成本方面的输出。选择生产中的获胜者，或将输出组合用于集成推理。',
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[基础知识：GPT-5.5、Claude还是Gemini？如何选择合适的模型](/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model?lang=zh) — 前沿专有模型的详细对比',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'LLaMA 3.1 70B和Mistral Large 2是最强的开放权重编程模型。在HumanEval（代码生成基准）上，它们得分73–78%，而GPT-5.5约90%，Claude Opus 4.7约87%。在Python、SQL和结构化输出方面，开放权重具有竞争力。在复杂算法设计和多文件推理方面，专有模型保持显著优势。',
            },
            {
              q: '我可以将开源LLM用于商业应用吗？',
