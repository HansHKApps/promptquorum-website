...
export const article: Partial<Record<Language, PEArticle>> = {
      ...
      sections: {
        ...
        quickReference: {
          ...
          rows: [
            ...
            { 'Model': 'Qwen 2.5 72B', 'Type': 'Open-weights', 'Context Window': '128K tokens', 'Approx. Cost': '~$2/hr on A100 (self-hosted)', 'Best For': 'Asia-Pacific workloads, Chinese language' },
          ],
          tableFormat: true,
        },
        ...
        performanceBenchmarks: {
          ...
          content: [
            ...
            'GPT-5.5: 88.7% | Claude Opus 4.8: ~88% | LLaMA 3.1 70B: 80.5% | Mistral Large 2: 81.2% | Qwen 2.5 72B: 82.1%',
            '',
    ...
    es: {
      ...
      faqSchema: {
        ...
        inLanguage: 'es',
        'mainEntity': [
          { '@type': 'Question', 'name': '¿LLaMA 3.1 es realmente de código abierto o solo open-weights?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Solo open-weights. LLaMA 3.1 publica los pesos del modelo bajo la Licencia Comunitaria Llama 2.1, que no es open-source compatible con OSI. La licencia permite uso comercial pero restringe nombrar derivados como "LLaMA" y requiere atribución. Las licencias verdaderamente open-source (Apache 2.0, MIT, GPL) no tienen ninguna de estas restricciones.' } },
      ...
      sections: {
        ...
        faq: {
          ...
          faqs: [
            { q: '¿LLaMA 3.1 es realmente de código abierto o solo open-weights?', a: 'Solo open-weights. LLaMA 3.1 publica los pesos del modelo bajo la Licencia Comunitaria Llama 2.1, que no es compatible con OSI. La licencia permite uso comercial pero incluye restricciones de denominación y requiere atribución.' },
