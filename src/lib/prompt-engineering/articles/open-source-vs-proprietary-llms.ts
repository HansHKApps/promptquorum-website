...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      intro: 'Open-weights models like LLaMA 3.1 and Mistral offer control and cost savings; proprietary models like GPT-4o and Claude Opus 4.8 deliver frontier performance. Both categories converge in capability but diverge in access, customization, and compliance requirements.',
      metaDescription: 'LLaMA 4 and DeepSeek-R1 vs GPT-4o, Claude, Gemini: cost, privacy, context windows, agentic coding benchmarks. Which to use in 2026 — decision guide.',
      ...
      leadAnswerBlock: '**Open-weights models (LLaMA, Mistral, Qwen) offer full customization and cost savings at scale; proprietary models (GPT-4o, Claude, Gemini) deliver frontier performance with managed infrastructure.** Below 5M tokens/day, APIs are cheaper. Above 10M tokens/day, self-hosted open-weights wins. Choose based on privacy requirements, volume, and infrastructure readiness.',
      quickFacts: [
        '**Cost crossover:** APIs cheaper below 5M tokens/day; open-weights wins above 10M tokens/day',
        '**Performance gap:** GPT-4o leads LLaMA on MMLU (88.7% vs 80.5%), but Claude Opus 4.8 leads GPT-4o on agentic coding (SWE-bench Pro: 64.3% vs 58.6%)',
        '**Context windows:** Open-weights (LLaMA 4 Scout: 10M, LLaMA 4 Maverick: 1M) vs Proprietary (Claude Opus 4.8: 1M, GPT-4o: 1M, Gemini 3.1 Pro: 1M)',
      ...
      schema: {
        ...
        description: 'Open-weights models like LLaMA 3.1 and Mistral offer control and cost savings; proprietary models like GPT-4o and Claude Opus 4.8 deliver frontier performance.',
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: 'Context window',
            description: 'Open-weights: LLaMA 3.1 131K, Mistral Large 123K, Qwen 128K — sufficient for long documents. Proprietary: GPT-4o 128K, Claude 200K, Gemini 3.1 Pro 2M tokens.',
          },
          {
            '@type': 'ListItem',
            position: 4,
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Which open-source LLM is closest to GPT-4o in 2026?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick, DeepSeek-R1, and Mistral Large 2 are closest. On MMLU, GPT-4o 88.7% vs open-weights 80–83%. On agentic coding (SWE-bench Pro), Claude Opus 4.8 (64.3%) leads GPT-4o (58.6%), showing task-specific parity is achievable. Test on your specific task.' } },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Open-weights = downloadable model weights (LLaMA 4, Mistral, Qwen); proprietary = API-only access (GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro). "Open weights" is not the same as open-source licensing.',
            'Performance varies by task: LLaMA 4 Scout/Maverick and Mistral Large 2 now match proprietary on classification — but lag on abstract reasoning. On agentic coding (SWE-bench Pro), Claude Opus 4.8 (64.3%) leads GPT-4o (58.6%); on Terminal-Bench, GPT-4o (82.7%) leads Opus 4.8 (69.4%).',
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**Proprietary models are neither open weights nor open source.** OpenAI (GPT-4o), Anthropic (Claude Opus 4.8), and Google (Gemini 3.1 Pro) do not release model weights. You access them exclusively via API. The weights remain closed; you cannot see, download, modify, or deploy the model yourself.',
        ...
        whatIsProprietary: {
          ...
          content: [
            '**Proprietary LLMs are closed models accessible only via API — the vendor controls the weights, training data, safety alignment, and all updates.** OpenAI (GPT-4o), Anthropic (Claude Opus 4.8), Google (Gemini 3.1 Pro), and Mistral API are proprietary. You cannot download weights, view training data, run inference locally, or customize the model weights directly.',
            '**Pricing is per-token API billing on a vendor-controlled server.** GPT-4o costs $5 per 1M input tokens and $30 per 1M output tokens. Claude Opus 4.8 costs $5/$25. Gemini 3.1 Pro costs $2.00/$12.00 (≤200K context; higher above 200K). You have no infrastructure cost but cannot predict monthly spend precisely — costs scale with usage.',
        ...
        definitions: {
          ...
          content: [
            ...
            '**Proprietary LLM.** A large language model whose weights are kept private and never released. Access is exclusively through a vendor\'s API, requiring per-token billing and network connectivity. Examples: GPT-4o (OpenAI), Claude Opus 4.8 (Anthropic), Gemini 3.1 Pro (Google). Users cannot download, inspect, modify, or self-host the model.',
            ...
            '**Training Data Cutoff.** The date after which a model has no knowledge of events or information. GPT-4o has a cutoff of December 2025; Claude Opus 4.8 has early-to-mid 2025; Gemini 3.1 Pro has January 2025. Models cannot provide accurate information about events after their cutoff date.',
        ...
        featureComparison: {
          ...
          rows: [
            ...
            { 'Feature': 'Performance', 'Open Source LLM': '80–82% MMLU; LLaMA 4 competitive on coding (SWE-bench). Lag on abstract reasoning vs frontier.', 'Proprietary LLM': '88–90% MMLU; Claude Opus 4.8 leads agentic coding (SWE-bench Pro 64.3%); GPT-4o leads reasoning benchmarks.' },
        ...
        quickReference: {
          ...
          rows: [
            { 'Model': 'GPT-4o', 'Type': 'Proprietary', 'Context Window': '1M tokens', 'Approx. Cost': '$5/$30 per 1M input/output tokens', 'Best For': 'Tool integration, agents, Terminal-Bench tasks' },
            { 'Model': 'GPT-4o Pro', 'Type': 'Proprietary', 'Context Window': '1M tokens', 'Approx. Cost': '$30/$180 per 1M input/output tokens', 'Best For': 'High-stakes reasoning, complex multi-step agents' },
        ...
        proprietaryLandscape: {
          ...
          content: [
            ...
            '**Anthropic\'s Claude Opus 4.8 leads on agentic coding and writing quality.** Claude supports 1M token context — enabling full codebase analysis and extended research. Training data cutoff: early-to-mid 2025. API pricing: $5 per 1M input tokens, $25 per 1M output tokens. On SWE-bench Pro (agentic coding), Claude Opus 4.8 scores 64.3% — ahead of GPT-4o at 58.6%. Claude does not offer public fine-tuning. Claude Mythos Preview (invitation-only): $25/$125 per 1M tokens, cybersecurity-focused.',
        ...
        performanceBenchmarks: {
          ...
          content: [
            '**Benchmark performance depends heavily on the task type — proprietary models no longer lead across all categories.** MMLU (broad academic reasoning) still shows a 7–8 point gap, but agentic coding (SWE-bench Pro) shows Claude Opus 4.8 ahead of GPT-4o, and ARC-AGI-2 (abstract reasoning) is led by Gemini 3.1 Pro.',
            '',
            'MMLU (broad reasoning) — 2024/2025:',
            'GPT-4o: 88.7% | Claude Opus 4.8: ~88% | LLaMA 3.1 70B: 80.5% | Mistral Large 2: 81.2% | Qwen 2.5 72B: 82.1%',
            '',
            'SWE-bench Pro (agentic coding, 2026):',
            'Claude Opus 4.8: 64.3% (SWE-bench Pro) / 87.6% (SWE-bench Verified) | GPT-4o: 58.6% | LLaMA 4 Maverick: data pending',
            '',
            'Terminal-Bench 2.0 (CLI & system tasks, 2026):',
            'GPT-4o: 82.7% | Claude Opus 4.8: 69.4%',
            '',
            'ARC-AGI-2 (abstract reasoning, 2026):',
            'Gemini 3.1 Pro: 77.1% | GPT-4o: data pending | Claude Opus 4.8: data pending',
            '',
            '**The benchmark picture is more fragmented in 2026 than in prior years.** No single model leads all benchmarks. On agentic coding, Claude Opus 4.8 leads. On CLI reasoning, GPT-4o leads. On abstract reasoning, Gemini leads. On MMLU (academic knowledge), GPT-4o and Claude are near-tied. Open-weights (LLaMA 4 Maverick, DeepSeek-R1) are closing the gap on reasoning tasks.',
            '',
        ...
        costAnalysis: {
          ...
          content: [
            ...
            '',
            '**At 5M tokens/day:** A100 self-hosting costs ~$2.50/day. API costs for Claude Opus 4.8: 2.5M × $5/1M + 2.5M × $25/1M = $12.50 + $62.50 = $75/day (assumes 50% input, 50% output). APIs still cheaper. Using GPT-4o at $5/$30: $12.50 + $75 = $87.50/day.',
            '',
          ...
          callouts: [
            ...
            { type: '🔍', label: 'Did You Know?', text: 'Batching 1M tokens for classification costs $5–30 on Claude Opus 4.8 or GPT-4o. Running 1M tokens on self-hosted LLaMA 4 Scout costs ~$0.20–0.30 in GPU time (MoE efficiency). At 50M tokens/day, the difference is $750–1,500/day API vs ~$15/day self-hosted.' },
          ],
          columns: ['Model', 'Input (per 1M tokens)', 'Output (per 1M tokens)'],
          rows: [
            { 'Model': 'GPT-4o', 'Input (per 1M tokens)': '$5.00', 'Output (per 1M tokens)': '$30.00' },
            { 'Model': 'GPT-4o Pro', 'Input (per 1M tokens)': '$30.00', 'Output (per 1M tokens)': '$180.00' },
        ...
        comparisonTable: {
          ...
          rows: [
            ...
            { 'Dimension': 'Performance ceiling', 'Open-Weights Models': 'Best open-weights (LLaMA 4 Maverick, DeepSeek-R1): MMLU 80–84%. Competitive on coding and extraction; lag on abstract multi-step reasoning.', 'Proprietary Models': 'Frontier (GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro): MMLU 88–90%. Claude Opus 4.8 leads SWE-bench Pro (64.3%); GPT-4o leads Terminal-Bench (82.7%).' },
            { 'Dimension': 'Context window', 'Open-Weights Models': 'LLaMA 4 Scout: 10M. LLaMA 4 Maverick: 1M. Mistral Large: 128K. Open-weights now match or exceed proprietary on context length.', 'Proprietary Models': 'GPT-4o: 1M. Claude Opus 4.8: 1M. Gemini 3.1 Pro: 1M. All frontier proprietary models now offer ≥1M context.' },
        ...
        whenProprietary: {
          ...
          items: [
            ...
            '**Multimodal input (images, audio):** GPT-4o and Claude Opus 4.8 handle image input reliably. Multimodal open-weights models exist but are less mature. Use proprietary for reliable vision-language tasks.',
          ],
        },
        ...
        hybridArchitecture: {
          ...
          items: [
            '**Privacy-sensitive data → local open-weights; complex reasoning → proprietary API.** Route patient records, financial data, and legal documents to LLaMA 3.1 running locally via Ollama. Route multi-step research synthesis, code generation, and agent orchestration to GPT-4o or Claude Opus 4.8. This hybrid approach achieves compliance while maintaining frontier performance.',
        ...
        promptExample: {
          ...
          promptExamples: [
            {
              bad: 'Which is better, open source or GPT-4o?',
              good: 'I need to process 20M tokens/day of customer support tickets. I cannot send data outside the EU. Compare open-weights (LLaMA 3.1 70B self-hosted) vs proprietary (GPT-4o via API) for this use case: include infrastructure cost at 20M tokens/day, GDPR data residency compliance, fine-tuning feasibility, and expected quality on ticket classification tasks.',
              badLabel: 'Vague',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'LLaMA 4 Maverick, DeepSeek-R1, and Mistral Large 2 are closest. On MMLU, GPT-4o scores 88.7% vs open-weights top competitors at 80–83%. On agentic coding (SWE-bench Pro), Claude Opus 4.8 (64.3%) leads GPT-4o (58.6%), showing task-specific parity is achievable. The benchmark picture is fragmented — test on your specific task.',
            },
            {
            ...
            },
            {
              ...
              a: 'LLaMA 4 Maverick and Mistral Large 2 are strongest open-weights coding models. On SWE-bench Verified (agentic coding), Claude Opus 4.8 scores 87.6% and GPT-4o scores ~77%. Open-weights best: LLaMA 4 Maverick and DeepSeek-R1 are competitive on HumanEval (~75–80%) and improving on SWE-bench. For Python and structured output, open-weights is viable. For multi-file refactoring and agent loops, proprietary models maintain an edge.',
            },
            {
        ...
        sources: {
          ...
          items: [
            ...
            'OpenAI, "Introducing GPT-4o" (April 2026) — GPT-4o and GPT-4o Pro pricing, context window (1M), training cutoff (December 2025), benchmark scores',
    ...
    de: {
      ...
      intro: 'Open-Weights-Modelle wie LLaMA 4 Scout und Mistral bieten vollständige Kontrolle und Kosteneinsparungen; proprietäre Modelle wie GPT-4o und Claude Opus 4.8 liefern Spitzenleistung. Beide Kategorien konvergieren bei der Leistungsfähigkeit, divergieren aber bei Zugriff, Anpassung und Compliance-Anforderungen.',
      metaDescription: 'Vergleichen Sie Open-Weights (LLaMA 4, DeepSeek-R1) mit proprietären LLMs (GPT-4o, Claude): Preise, Context Windows, MoE & Coding-Benchmarks.',
      publishDate: '2026-03-24',
      ...
      educationalLevel: 'Intermediate',
      primaryTerm: 'Open-Source-LLMs',
      leadAnswerBlock: '**Open-Weights-Modelle (LLaMA, Mistral, Qwen) bieten vollständige Anpassung und Kosteneinsparungen in großem Maßstab; proprietäre Modelle (GPT-4o, Claude, Gemini) liefern Spitzenleistung mit verwalteter Infrastruktur.** Unter 5 Mio. Token/Tag sind APIs günstiger. Ab 10 Mio. Token/Tag gewinnt selbstgehostetes Open-Weights. Wählen Sie basierend auf Datenschutzanforderungen, Volumen und Infrastrukturbereitschaft.',
      quickFacts: [
        '**Kostenausgleich:** APIs günstiger unter 5 Mio. Token/Tag; Open-Weights gewinnt ab 10 Mio. Token/Tag',
        '**Leistungslücke:** GPT-4o führt LLaMA beim MMLU an (88,7% vs 80,5%), aber Claude Opus 4.8 führt GPT-4o beim Agentic-Coding an (SWE-bench Pro: 64,3% vs 58,6%)',
        '**Context-Fenster:** Open-Weights (LLaMA 4 Scout: 10 Mio., LLaMA 4 Maverick: 1 Mio.) vs Proprietär (Claude Opus 4.8: 1 Mio., GPT-4o: 1 Mio., Gemini 3.1 Pro: 1 Mio.)',
      ...
      schema: {
        ...
        description: 'Open-Weights-Modelle wie LLaMA 3.1 und Mistral bieten Kontrolle und Kosteneinsparungen; proprietäre Modelle wie GPT-4o und Claude Opus 4.8 liefern Spitzenleistung.',
        datePublished: '2026-03-24',
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: 'Kontextfenster',
            description: 'Open-Weights: LLaMA 3.1 131K, Mistral Large 123K, Qwen 128K — ausreichend für lange Dokumente. Proprietär: GPT-4o 128K, Claude 200K, Gemini 3.1 Pro 2M Token.',
          },
          {
            '@type': 'ListItem',
            position: 4,
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Welches Open-Source-LLM ist GPT-4o in 2026 am nächsten?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick, DeepSeek-R1 und Mistral Large 2 sind am nächsten. MMLU: GPT-4o 88,7% vs. Open-Weights 80–83%. Beim Agentic-Coding (SWE-bench Pro) zeigt Claude Opus 4.8 (64,3%) Parität zu GPT-4o (58,6%), was aufgabenspezifische Wettbewerbsfähigkeit demonstriert. Benchmarken Sie auf Ihrer spezifischen Aufgabe.' } },
          ...
          { '@type': 'Question', 'name': 'Welches Open-Weights-Modell ist 2026 am besten für Programmierung?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick und DeepSeek-R1 sind am stärksten bei SWE-bench Verified (Agentic-Coding), mit ~75–80% auf HumanEval konkurierend. Claude Opus 4.8 führt SWE-bench Verified (87,6%) an; GPT-4o ~77%. Open-Weights sind lebensfähig für Python und SQL. Proprietäre Modelle behalten einen Vorteil bei Multi-File-Refactoring und agentic Schleifen.' } },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Open-Weights = herunterladbare Modellgewichte (LLaMA 4, Mistral, Qwen); proprietär = nur API-Zugriff (GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro). "Open Weights" ist nicht dasselbe wie Open-Source-Lizenzierung.',
            'Leistungslücke hat sich verengt: LLaMA 4 Scout/Maverick und Mistral Large 2 entsprechen jetzt proprietären Modellen bei Klassifizierung und Zusammenfassung — liegen aber hinter bei abstraktem Reasoning zurück. Beim Agentic-Coding (SWE-bench Pro) führt Claude Opus 4.8 (64,3%) GPT-4o an (58,6%); bei Terminal-Bench führt GPT-4o (82,7%) Claude Opus 4.8 an (69,4%).',
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**Proprietäre Modelle sind weder Open-Weights noch Open Source.** OpenAI (GPT-4o), Anthropic (Claude Opus 4.8) und Google (Gemini 3.1 Pro) veröffentlichen keine Modellgewichte. Sie greifen ausschließlich über API zu. Die Gewichte bleiben geschlossen; Sie können das Modell nicht sehen, herunterladen, ändern oder selbst bereitstellen.',
        ...
        whatIsProprietary: {
          ...
          content: [
            '**Proprietäre LLMs sind geschlossene Modelle, auf die nur über API zugegriffen werden kann — der Vendor kontrolliert die Gewichte, Trainingsdaten, Safety-Alignment und alle Updates.** OpenAI (GPT-4o), Anthropic (Claude Opus 4.8), Google (Gemini 3.1 Pro) und Mistral API sind proprietär. Sie können keine Gewichte herunterladen, Trainingsdaten anzeigen, lokal Inferenz ausführen oder die Modellgewichte direkt anpassen.',
        ...
        definitions: {
          ...
          content: [
            ...
            '**Proprietäres LLM.** Ein großes Sprachmodell, dessen Gewichte privat bleiben und nie freigegeben werden. Der Zugriff erfolgt ausschließlich über die API eines Vendors, erfordert Pro-Token-Billing und Netzwerkverbindung. Beispiele: GPT-4o (OpenAI), Claude Opus 4.8 (Anthropic), Gemini 3.1 Pro (Google). Benutzer können das Modell nicht herunterladen, inspizieren, ändern oder selbst hosten.',
        ...
        whenProprietary: {
          ...
          items: [
            ...
            '**Multimodal-Input (Bilder, Audio):** GPT-4o und Claude Opus 4.8 verarbeiten Bild-Eingabe zuverlässig. Multimodal-Open-Weights-Modelle existieren, sind aber weniger reif. Verwenden Sie proprietär für zuverlässige Vision-Language-Aufgaben.',
          ],
        },
    ...
    es: {
      ...
      intro: 'Los modelos open-weights como LLaMA 4 y Mistral ofrecen control y ahorro de costos; los modelos propietarios como GPT-4o y Claude Opus 4.8 ofrecen rendimiento de frontera. Ambas categorías convergen en capacidad pero divergen en acceso, personalización y requisitos de cumplimiento.',
      metaDescription: 'LLaMA 4 y DeepSeek-R1 vs GPT-4o, Claude, Gemini: costo, privacidad, context windows, benchmarks de código agéntico. Cuál usar en 2026 — guía de decisión.',
      publishDate: '2026-03-24',
      ...
      leadAnswerBlock: '**Los modelos open-weights (LLaMA, Mistral, Qwen) ofrecen personalización total y ahorro de costos a escala; los modelos propietarios (GPT-4o, Claude, Gemini) ofrecen rendimiento de frontera con infraestructura gestionada.** Por debajo de 5M tokens/día, las APIs son más baratas. Por encima de 10M tokens/día, los open-weights auto-alojados ganan. Elige según los requisitos de privacidad, el volumen y la preparación de la infraestructura.',
      quickFacts: [
        '**Cruce de costos:** APIs más baratas por debajo de 5M tokens/día; open-weights gana por encima de 10M tokens/día',
        '**Brecha de rendimiento:** GPT-4o lidera LLaMA en MMLU (88,7 % vs 80,5 %), pero Claude Opus 4.8 lidera GPT-4o en código agéntico (SWE-bench Pro: 64,3 % vs 58,6 %)',
        '**Context windows:** Open-weights (LLaMA 4 Scout: 10M, LLaMA 4 Maverick: 1M) vs Propietarios (Claude Opus 4.8: 1M, GPT-4o: 1M, Gemini 3.1 Pro: 1M)',
      ...
      schema: {
        ...
        description: 'Los modelos open-weights como LLaMA 4 y Mistral ofrecen control y ahorro de costos; los modelos propietarios como GPT-4o y Claude Opus 4.8 ofrecen rendimiento de frontera.',
        datePublished: '2026-03-24',
        dateModified: '2026-05-03',
        keywords: ['LLMs de código abierto', 'LLaMA', 'Mistral', 'modelos propietarios', 'GPT-4o', 'Claude', 'fine-tuning', 'análisis de costos', 'open-weights', 'inferencia local'],
        teaches: [
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'Context window', description: 'Open-weights: LLaMA 3.1 131K, Mistral Large 123K, Qwen 128K. Propietarios: GPT-4o 128K, Claude 200K, Gemini 3.1 Pro 2M tokens.' },
      ...
      howToSchema: {
        ...
        'step': [
          ...
          { '@type': 'HowToStep', 'position': 5, 'name': 'Benchmarks en tu tarea real', 'text': 'Usa PromptQuorum para despachar tu prompt a GPT-4o, Claude y una instancia local de Ollama simultáneamente. Compara calidad de salida, latencia y costo lado a lado. El modelo que gana en tu tarea específica y datos es la elección correcta.' },
        ],
      },
      faqSchema: {
        '@context': 'https://schema.org',
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '¿Qué es más barato en 2026 — auto-alojar LLaMA o usar la API de GPT-4o?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Por debajo de 5M tokens/día, la API de GPT-4o es más barata — sin costo de infraestructura. Entre 5–10M tokens/día, los costos se igualan. Por encima de 10M tokens/día, auto-alojar LLaMA 3.1 gana. A 100M tokens/día, el auto-alojamiento es 10–20× más barato.' } },
          ...
          { '@type': 'Question', 'name': '¿Qué LLM de código abierto se acerca más a GPT-4o en 2026?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 4 Maverick, DeepSeek-R1 y Mistral Large 2 son los más cercanos. En MMLU, GPT-4o 88,7 % vs open-weights 80–83 %. En código agéntico (SWE-bench Pro), Claude Opus 4.8 (64,3 %) lidera GPT-4o (58,6 %), mostrando que la paridad específica de tareas es alcanzable. Prueba en tu tarea específica.' } },
          { '@type': 'Question', 'name': '¿Puedo hacer fine-tuning de GPT-4o?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'No. El fine-tuning de OpenAI solo está disponible para GPT-4o mini, GPT-4 y gpt-3.5-turbo. Anthropic no ofrece fine-tuning para Claude. Google ofrece fine-tuning para Gemini. Los open-weights (LLaMA, Mistral, Qwen) soportan fine-tuning completo vía LoRA, QLoRA o entrenamiento completo.' } },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Open-weights = pesos de modelo descargables (LLaMA 4, Mistral, Qwen); propietarios = acceso solo vía API (GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro). "Open-weights" no es lo mismo que licencias open-source.',
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**Los modelos propietarios no son ni open-weights ni open-source.** OpenAI (GPT-4o), Anthropic (Claude Opus 4.8) y Google (Gemini 3.1 Pro) no publican los pesos del modelo. Los accedes exclusivamente vía API.',
        ...
        whatIsProprietary: {
          ...
          content: [
            '**Los LLMs propietarios son modelos cerrados accesibles solo vía API — el proveedor controla los pesos, los datos de entrenamiento, la alineación de seguridad y todas las actualizaciones.** OpenAI (GPT-4o), Anthropic (Claude Opus 4.8), Google (Gemini 3.1 Pro) y Mistral API son propietarios.',
            '**Los precios son facturación por token en API en un servidor controlado por el proveedor.** GPT-4o cuesta $5 por 1M tokens de entrada y $30 por 1M tokens de salida. Claude Opus 4.8 cuesta $5/$25. Gemini 3.1 Pro cuesta $2,00/$12,00.',
        ...
        definitions: {
          ...
          content: [
            ...
            '**LLM Propietario.** Un LLM cuyos pesos se mantienen privados y nunca se publican. El acceso es exclusivamente a través de la API de un proveedor, requiriendo facturación por token y conectividad de red. Ejemplos: GPT-4o (OpenAI), Claude Opus 4.8 (Anthropic), Gemini 3.1 Pro (Google).',
        ...
        comparisonTable: {
          ...
          rows: [
            ...
            { 'Dimensión': 'Context window', 'Open-Weights': 'LLaMA 4 Scout 10M, Mistral Large 123K', 'Propietario': 'GPT-4o 128K, Claude 200K, Gemini 3.1 Pro 1M' },
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: '¿Qué es más barato en 2026 — auto-alojar LLaMA o usar la API de GPT-4o?', a: 'Depende del volumen. Por debajo de 5M tokens/día, la API de GPT-4o es más barata. Entre 5–10M tokens/día, los costos se igualan. Por encima de 10M tokens/día, el auto-alojamiento de LLaMA 3.1 gana.' },
            ...
            { q: '¿Qué LLM de código abierto se acerca más a GPT-4o en 2026?', a: 'LLaMA 4 Maverick, DeepSeek-R1 y Mistral Large 2 son los más cercanos. En MMLU, GPT-4o 88,7 % vs open-weights 80–83 %.' },
            { q: '¿Puedo hacer fine-tuning de GPT-4o?', a: 'No. El fine-tuning de OpenAI solo está disponible para GPT-4o mini. Anthropic no ofrece fine-tuning para Claude. Los open-weights soportan fine-tuning completo vía LoRA, QLoRA o entrenamiento completo.' },
    ...
    fr: {
      ...
      intro: 'Les modèles open-weights comme LLaMA 4 et Mistral offrent contrôle total et économies d\'échelle ; les modèles propriétaires comme GPT-4o et Claude Opus 4.8 livrent des performances de pointe. Les deux catégories convergent en performance mais divergent sur l\'accès, la personnalisation et la conformité.',
      ...
      schema: {
        ...
        description: 'LLMs open-weights (LLaMA 4, DeepSeek-R1) vs propriétaires (GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro) : prix, fenêtres contextuelles, architecture MoE, benchmarks agentic-coding.',
        datePublished: '2026-03-24',
        dateModified: '2026-05-03',
        keywords: ['LLMs open-source', 'LLaMA 4', 'Mistral Large', 'modèles propriétaires', 'GPT-4o', 'Claude Opus 4.8', 'fine-tuning', 'analyse coûts', 'open-weights', 'inférence locale', 'MoE'],
        teaches: [
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            description: 'Open-weights : LLaMA 3.1 131 K, Mistral Large 123 K, Qwen 128 K — suffisant pour de longs documents. Propriétaire : GPT-4o 128 K, Claude 200 K, Gemini 3.1 Pro 2 M tokens.',
          },
          {
            '@type': 'ListItem',
            position: 4,
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Quel modèle open-weights est le meilleur pour le code en 2026 ?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 3.1 70B et Mistral Large 2 sont les plus performants. Scores HumanEval : 73–78 % contre GPT-4o ~90 % et Claude Opus 4.8 ~87 %. Compétitif pour Python, SQL et la sortie structurée. Les modèles propriétaires conservent un avantage sur la conception d\'algorithmes complexes et le raisonnement multi-fichiers.' } },
      ...
      sections: {
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**Les modèles propriétaires ne sont ni open-weights ni open source.** OpenAI (GPT-4o), Anthropic (Claude Opus 4.8) et Google (Gemini 3.1 Pro) ne publient pas les poids des modèles. Vous y accédez exclusivement via API. Les poids restent fermés ; vous ne pouvez pas voir, télécharger, modifier ou déployer le modèle vous-même.',
        ...
        definitions: {
          ...
          content: [
            ...
            '**LLM propriétaire.** Un grand modèle de langage dont les poids restent privés et ne sont jamais publiés. L\'accès se fait exclusivement via l\'API d\'un fournisseur, nécessitant une facturation par token et une connectivité réseau. Exemples : GPT-4o (OpenAI), Claude Opus 4.8 (Anthropic), Gemini 3.1 Pro (Google). Les utilisateurs ne peuvent pas télécharger, inspecter, modifier ou auto-héberger le modèle.',
        ...
        whenProprietary: {
          ...
          items: [
            ...
            '**Entrées multimodales (images, audio) :** GPT-4o et Claude Opus 4.8 traitent les images de façon fiable. Les modèles open-weights multimodaux existent mais sont moins matures. Utilisez le propriétaire pour des tâches vision-langage fiables.',
          ],
        },
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'LLaMA 3.1 70B et Mistral Large 2 sont les modèles open-weights de codage les plus performants. Sur HumanEval (benchmark de génération de code), ils obtiennent 73–78 %, contre GPT-4o à ~90 % et Claude Opus 4.8 à ~87 %. Pour Python, SQL et la sortie structurée, l\'open-weights est compétitif. Pour la conception d\'algorithmes complexes et le raisonnement multi-fichiers, les modèles propriétaires conservent un avantage significatif.',
            },
            {
    ...
    ja: {
      ...
      intro: 'LLaMA 4やMistralなどのオープンウェイトモデルは完全な制御とスケールでのコスト削減を提供し、GPT-4oやClaude Opus 4.8などの独占的モデルはフロンティアパフォーマンスを実現します。両カテゴリは性能面で収束しつつありますが、アクセス方法、カスタマイズ性、コンプライアンス要件では大きく異なります。',
      metaDescription: 'オープンウェイト (LLaMA 4、DeepSeek-R1) と独占的LLM (GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro) を比較：価格、コンテキストウィンドウ、MoE アーキテクチャ、エージェント型コーディングベンチマーク、データプライバシー。',
      publishDate: '2026-03-24',
      ...
      leadAnswerBlock: '**オープンウェイトモデル (LLaMA、Mistral、Qwen) は完全なカスタマイズとスケールでのコスト削減を提供し、独占的モデル (GPT-4o、Claude、Gemini) はフロンティア性能とマネージド基盤を実現します。** 1日5Mトークン未満ではAPIが安い。10M以上ではセルフホスティングが勝つ。プライバシー要件、ボリューム、基盤準備度に基づいて選択してください。',
      quickFacts: [
        '**コスト逆転点 :** 1日5M未満ではAPI安い; 10M以上ではオープンウェイトが勝つ',
        '**性能ギャップ :** GPT-4oがLLaMAをMMLU (88.7% vs 80.5%) で上回るも、Claude Opus 4.8がGPT-4oをエージェント型コーディング (SWE-bench Pro: 64.3% vs 58.6%) で上回る',
        '**コンテキストウィンドウ :** オープンウェイト (LLaMA 4 Scout: 10M、LLaMA 4 Maverick: 1M) vs 独占的 (Claude Opus 4.8: 1M、GPT-4o: 1M、Gemini 3.1 Pro: 1M)',
      ...
      schema: {
        ...
        description: 'オープンウェイト (LLaMA 4, DeepSeek-R1) vs 独占的 (GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro) : 価格、コンテキストウィンドウ、MoE、エージェントコーディングベンチマーク。',
        datePublished: '2026-03-24',
        dateModified: '2026-05-03',
        keywords: ['オープンウェイト', 'LLaMA 4', 'DeepSeek-R1', 'Mistral Large', '独占的モデル', 'GPT-4o', 'Claude Opus 4.8', 'ファインチューニング', 'コスト分析', 'MoE'],
        teaches: [
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: 'コンテキストウィンドウ',
            description: 'オープンウェイト：LLaMA 3.1 131K、Mistral Large 123K、Qwen 128K — 長文書に十分。独自：GPT-4o 128K、Claude 200K、Gemini 3.1 Pro 200万トークン。',
          },
          {
            '@type': 'ListItem',
            position: 4,
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '2026年でコーディングに最適なオープンウェイトモデルはどれですか？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 3.1 70BとMistral Large 2が最強のオープンウェイトコーディングモデルです。HumanEvalスコア（コード生成ベンチマーク）は73〜78%で、GPT-4oの約90%、Claude Opus 4.8の約87%と比較されます。Python・SQL・構造化出力ではオープンウェイトが競争力を持ちます。複雑なアルゴリズム設計やマルチファイル推論では、独自モデルが依然として優位性を維持しています。' } },
      ...
      sections: {
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**独自モデルはオープンウェイトでもオープンソースでもありません。** OpenAI（GPT-4o）・Anthropic（Claude Opus 4.8）・Google（Gemini 3.1 Pro）はモデルウェイトをリリースしていません。APIを通じてのみアクセスできます。ウェイトはクローズドのままで、自分でモデルを確認・ダウンロード・修正・デプロイすることはできません。',
        ...
        whatIsProprietary: {
          title: '独自LLMとは何ですか？',
          content: [
            '**独自LLMはAPIを通じてのみアクセスできるクローズドモデルです — ベンダーがウェイト・学習データ・安全アライメント・すべての更新を管理します。** OpenAI（GPT-4o）・Anthropic（Claude Opus 4.8）・Google（Gemini 3.1 Pro）・Mistral APIは独自モデルです。ウェイトをダウンロードしたり、学習データを確認したり、ローカルで推論を実行したり、モデルウェイトを直接カスタマイズしたりすることはできません。',
            '**価格はベンダー管理サーバーでのトークン単位のAPI課金です。** GPT-4oは入力100万トークンあたり$5、出力100万トークンあたり$15です。Claude Opus 4.8は$3/$15。Gemini 3.1 Proは$1.25/$2.50（200K以下のコンテキスト）。インフラコストはかかりませんが、月額コストを正確に予測することはできず、コストは使用量に応じてスケールします。',
        ...
        definitions: {
          ...
          content: [
            ...
            '**独自LLM。** ウェイトが非公開で決してリリースされない大規模言語モデル。アクセスはベンダーのAPIを通じてのみ可能で、トークン課金とネットワーク接続が必要です。例：GPT-4o（OpenAI）、Claude Opus 4.8（Anthropic）、Gemini 3.1 Pro（Google）。ユーザーはモデルをダウンロード・検査・修正・自己ホスティングすることができません。',
            ...
            '**学習データカットオフ。** モデルがその日付以降のイベントや情報の知識を持たない日付。GPT-4oのカットオフは2024年10月、Claude Opus 4.8は2025年初頭、Gemini 3.1 Proは2024年10月です。モデルはカットオフ日以降のイベントについて正確な情報を提供できません。',
        ...
        proprietaryLandscape: {
          ...
          content: [
            ...
            '**AnthropicのClaude Opus 4.8はライティングとコード品質ベンチマークで支配的です。** Claudeは200Kトークンのコンテキストをサポートしており、GPT-4oの2倍で、より長い文書と長い会話が可能です。学習データのカットオフ：2025年初頭。APIの価格：入力100万トークンあたり$3、出力100万トークンあたり$15。Claudeは公開のファインチューニングを提供していません。Anthropicはベンチマーク最大化よりも解釈可能性と安全アライメントを優先しています。',
        ...
        whenProprietary: {
          ...
          items: [
            ...
            '**マルチモーダル入力（画像・音声）：** GPT-4oとClaude Opus 4.8は画像入力を確実に処理します。マルチモーダルのオープンウェイトモデルは存在しますが、成熟度が低いです。信頼性の高いビジョン-言語タスクには独自モデルを使用してください。',
          ],
        },
        ...
        hybridArchitecture: {
          ...
          items: [
            '**プライバシー敏感データ → ローカルのオープンウェイト、複雑な推論 → 独自API。** 患者記録・金融データ・法的文書をOllamaを通じてローカルで動作するLLaMA 3.1にルーティングします。多段階の研究合成・コード生成・エージェントオーケストレーションをGPT-4oまたはClaude Opus 4.8にルーティングします。このハイブリッドアプローチでコンプライアンスを達成しながらフロンティアパフォーマンスを維持できます。',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'LLaMA 3.1 70BとMistral Large 2が最強のオープンウェイトコーディングモデルです。HumanEvalスコアは73〜78%で、GPT-4oの約90%、Claude Opus 4.8の約87%と比較されます。Python・SQL・構造化出力ではオープンウェイトが競争力を持ちます。複雑なアルゴリズム設計やマルチファイル推論では、独自モデルが依然として大きな優位性を維持しています。',
            },
            {
    ...
    zh: {
      ...
      theme: 'Techniques',
      title: '开源与专有LLM：竞争格局',
      intro: '开放权重模型（如LLaMA 4和Mistral）提供完全控制和规模化成本节省；专有模型（如GPT-4o和Claude Opus 4.8）则提供前沿性能。两类模型的能力正在趋同，但在访问方式、定制化程度和合规要求上存在明显分歧。',
      metaDescription: '对比开放权重模型 (LLaMA 4、DeepSeek-R1) 与专有LLM (GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro)：定价、上下文窗口、MoE架构、代理编程基准与合规性。为企业和开发者选择合适的推理方案。',
      publishDate: '2026-03-24',
      ...
      educationalLevel: 'Intermediate',
      primaryTerm: '开源LLM',
      leadAnswerBlock: '**开放权重模型（LLaMA、Mistral、Qwen）提供完整定制和规模化成本节省；专有模型（GPT-4o、Claude、Gemini）提供前沿性能和托管基础设施。** 日均低于500万token时，API更便宜。日均超过1000万token时，自托管开放权重更经济。根据隐私要求、使用量和基础设施准备情况选择。',
      quickFacts: [
        '**成本转折点：** 日均低于500万token时API更便宜；超过1000万token时开放权重自托管胜出',
        '**性能差异：** GPT-4o在MMLU上领先LLaMA（88.7% vs 80.5%），但Claude Opus 4.8在代理型编程（SWE-bench Pro：64.3% vs 58.6%）上领先GPT-4o',
        '**上下文窗口：** 开放权重（LLaMA 4 Scout：1000万token，LLaMA 4 Maverick：100万token）vs 专有（Claude Opus 4.8：100万token，GPT-4o：100万token，Gemini 3.1 Pro：100万token）',
      ...
      schema: {
        ...
        description: '开放权重模型（如LLaMA 4和Mistral）提供完全控制和规模化成本节省；专有模型（如GPT-4o和Claude Opus 4.8）则提供前沿性能。',
        datePublished: '2026-03-24',
        dateModified: '2026-05-03',
        keywords: ['开源LLM', 'LLaMA 4', 'Mistral', '专有模型', 'GPT-4o', 'Claude', '微调', '成本分析', '开放权重', '本地推理'],
        teaches: [
          'LLM中开放权重与开源许可的区别',
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: '上下文窗口',
            description: '开放权重：LLaMA 3.1为131K，Mistral Large为123K，Qwen为128K——足以处理长文档。专有：GPT-4o为128K，Claude为200K，Gemini 3.1 Pro为200万token。',
          },
          {
            '@type': 'ListItem',
            position: 4,
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '2026年哪个开放权重模型最适合编程？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 3.1 70B和Mistral Large 2最强。HumanEval分数：约73–78%，而GPT-4o约90%，Claude Opus 4.8约87%。在Python、SQL和结构化输出方面具有竞争力。专有模型在复杂算法设计和多文件推理方面仍保持优势。' } },
      ...
      sections: {
        ...
        whatIsOpenSource: {
          ...
          content: [
            ...
            '**专有模型既非开放权重也非开源。** OpenAI（GPT-4o）、Anthropic（Claude Opus 4.8）和Google（Gemini 3.1 Pro）不发布模型权重。您只能通过API访问它们。权重保持封闭；您无法查看、下载、修改或自行部署模型。',
        ...
        whatIsProprietary: {
          title: '什么是专有LLM？',
          content: [
            '**专有LLM是封闭模型，只能通过API访问——供应商控制权重、训练数据、安全对齐和所有更新。** OpenAI（GPT-4o）、Anthropic（Claude Opus 4.8）、Google（Gemini 3.1 Pro）和Mistral API都是专有的。您无法下载权重、查看训练数据、在本地运行推理或直接定制模型权重。',
            '**定价为供应商控制服务器上的按token API计费。** GPT-4o的输入费用为每百万token 5美元，输出为每百万token 15美元。Claude Opus 4.8为3美元/15美元。Gemini 3.1 Pro为1.25美元/2.50美元（≤200K上下文）。您没有基础设施成本，但无法精确预测每月支出——成本随使用量扩展。',
        ...
        definitions: {
          ...
          content: [
            ...
            '**专有LLM。** 一种大型语言模型，其权重保密且从不发布。访问完全通过供应商的API进行，需要按token计费和网络连接。示例：GPT-4o（OpenAI）、Claude Opus 4.8（Anthropic）、Gemini 3.1 Pro（Google）。用户无法下载、检查、修改或自托管模型。',
            '**微调。** 在针对特定领域或任务的新的较小数据集上重新训练预训练模型的过程。微调更新模型的权重以专业化于您的用例（例如客服语气、领域词汇）。开放权重模型通过LoRA、QLoRA或全量反向传播支持完整微调；大多数专有模型限制或禁止微调。',
            '**训练数据截止日期。** 模型对此日期之后的事件或信息不具备知识的日期。GPT-4o的截止日期为2024年10月；Claude Opus 4.8为2025年初；Gemini 3.1 Pro为2024年10月。模型无法提供截止日期后事件的准确信息。',
        ...
        proprietaryLandscape: {
          ...
          content: [
            ...
            '**Anthropic的Claude Opus 4.8在写作和代码质量基准上占据主导地位。** Claude支持200K token上下文——是GPT-4o的2倍——能够处理更长的文档和更长的对话。训练数据截止日期：2025年初。API定价：每百万输入token 3美元，每百万输出token 15美元。Claude不提供公开微调。Anthropic将可解释性和安全对齐置于基准最大化之上。',
        ...
        whenProprietary: {
          ...
          items: [
            ...
            '**多模态输入（图像、音频）：** GPT-4o和Claude Opus 4.8可靠地处理图像输入。多模态开放权重模型存在但不够成熟。对于可靠的视觉-语言任务，使用专有模型。',
          ],
        },
        ...
        hybridArchitecture: {
          ...
          items: [
            '**隐私敏感数据 → 本地开放权重；复杂推理 → 专有API。** 将患者记录、金融数据和法律文件路由到通过Ollama本地运行的LLaMA 3.1。将多步骤研究综合、代码生成和智能体编排路由到GPT-4o或Claude Opus 4.8。这种混合方式在保持前沿性能的同时实现合规性。',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'LLaMA 3.1 70B和Mistral Large 2是最强的开放权重编程模型。在HumanEval（代码生成基准）上，它们得分73–78%，而GPT-4o约90%，Claude Opus 4.8约87%。在Python、SQL和结构化输出方面，开放权重具有竞争力。在复杂算法设计和多文件推理方面，专有模型保持显著优势。',
            },
            {
              q: '我可以将开源LLM用于商业应用吗？',
