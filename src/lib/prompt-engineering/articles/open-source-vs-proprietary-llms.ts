...
export const article: Record<Language, PEArticle> = {
    ...
    ja: {
      ...
      intro: 'LLaMA 3.1やMistralなどのオープンウェイトモデルは制御とコスト削減を提供し、GPT-5.5やClaude Opus 4.7などの独自モデルはフロンティアパフォーマンスを実現します。両カテゴリは性能面で収束しつつありますが、アクセス方法、カスタマイズ性、コンプライアンス要件では大きく異なります。',
      ...
      schema: {
        ...
        description: 'LLaMA 3.1やMistralなどのオープンウェイトモデルは制御とコスト削減を提供し、GPT-5.5やClaude Opus 4.7などの独自モデルはフロンティアパフォーマンスを実現します。',
        datePublished: '2026-03-24',
        dateModified: '2026-04-01',
        keywords: ['オープンソースLLM', 'LLaMA', 'Mistral', '独自モデル', 'GPT-5.5', 'Claude', 'ファインチューニング', 'コスト分析', 'オープンウェイト', 'ローカル推論'],
        teaches: [
