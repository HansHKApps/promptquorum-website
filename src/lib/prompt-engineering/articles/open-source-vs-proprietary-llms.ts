...
export const article: Record<Language, PEArticle> = {
    ...
    de: {
      ...
      intro: 'Open-Weights-Modelle wie LLaMA 3.1 und Mistral bieten Kontrolle und Kosteneinsparungen; proprietäre Modelle wie GPT-5.5 und Claude Opus 4.7 liefern Spitzenleistung. Beide Kategorien konvergieren in der Leistungsfähigkeit, divergieren aber bei Zugriff, Anpassung und Compliance-Anforderungen.',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Welches Open-Source-LLM ist GPT-5.5 in 2026 am nächsten?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'LLaMA 3.1 70B und Mistral Large 2 sind am nächsten. MMLU-Scores: GPT-5.5 88,7%, LLaMA 3.1 70B 80,5%, Mistral Large 81,2%. Bei Klassifizierung, Zusammenfassung und Extraktion entspricht Open-Weights jetzt dem Proprietären. Der Reasoning-Gap verengt sich ~2–3 Punkte pro Jahr.' } },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Open-Weights = herunterladbare Modellgewichte (LLaMA, Mistral, Qwen); proprietär = nur API-Zugriff (GPT-5.5, Claude 4.6, Gemini 2.5). "Open Weights" ist nicht dasselbe wie Open-Source-Lizenzierung.',
