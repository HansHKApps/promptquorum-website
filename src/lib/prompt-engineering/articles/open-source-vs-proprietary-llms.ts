...
export const article: Record<Language, PEArticle> = {
    ...
    fr: {
      ...
      intro: 'Les modèles open-weights comme LLaMA 3.1 et Mistral offrent contrôle et économies ; les modèles propriétaires comme GPT-5.5 et Claude Opus 4.7 livrent des performances de pointe. Les deux catégories convergent en capacité, mais divergent en accès, personnalisation et exigences de conformité.',
      ...
      schema: {
        ...
        description: 'Les modèles open-weights comme LLaMA 3.1 et Mistral offrent contrôle et économies ; les modèles propriétaires comme GPT-5.5 et Claude Opus 4.7 livrent des performances de pointe.',
        datePublished: '2026-03-24',
        dateModified: '2026-04-01',
        keywords: ['LLMs open source', 'LLaMA', 'Mistral', 'modèles propriétaires', 'GPT-5.5', 'Claude', 'fine-tuning', 'analyse des coûts', 'open-weights', 'inférence locale'],
        teaches: [
