...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  es: {
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/es/es/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model',
      inLanguage: 'es',
      speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
  ...
  pt: {
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/pt/pt/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model',
      inLanguage: 'pt-BR',
      speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
  ...
  ar: {
    ...
    publishDate: '2026-03-23',
    seoTitle: 'GPT مقابل Claude مقابل Gemini 2026: أيها يفوز؟',
    metaDescription: 'يتفوق GPT-5.5 في تكامل الأدوات، وClaude في جودة الكتابة، وGemini في كفاءة التكلفة. جميعها تدعم سياق 1M رمز. مصفوفة قرار ومقارنة أسعار ودليل التوجيه.',
