...
export const article: Record<Language, PEArticle> = {
  ...
  metaDescription: 'GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro, DeepSeek, ERNIE vergleichen nach Aufgabe, Kosten und Region. Strategischer Rahmen mit praktischen Rezepten zur Modellauswahl.',
  ...
  fr: {
    ...
    metaDescription: 'GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro, DeepSeek et ERNIE comparés par tâche, coût, région. Cadre décisionnel stratégique avec recettes pratiques et sélection des modèles.',
  ...
  ja: {
    ...
    metaDescription: 'GPT-5.5、Claude Opus 4.7、Gemini 3.1 Pro、DeepSeek、Baidu ERNIEをタスク・コスト・地域で比較。戦略的な意思決定フレームワークと実践的なレシピで最適モデルを精選。',
    readTime: '12分の読了時間',
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
  ...
  zh: {
    ...
    metaDescription: 'GPT-5.5、Claude Opus 4.7、Gemini 3.1 Pro、DeepSeek、ERNIE五大模型按任务、成本、地域对比分析。战略决策框架与实践工作流指南，精准选择最优AI模型。',
    readTime: '12分钟阅读',
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
