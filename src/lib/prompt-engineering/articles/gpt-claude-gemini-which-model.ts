...
export const article: Record<Language, PEArticle> = {
  ...
  metaDescription: 'GPT-5.5 für Integrationen, Claude für Schreibqualität, Gemini für Kosteneffizienz. Alle mit 1M Kontext. Entscheidungsmatrix, Preisvergleich und Routing-Leitfaden.',
  ...
  ja: {
    ...
    metaDescription: 'GPT-5.5はツール連携、Claude Opus 4.7は文章品質、Gemini 3.1 Proはコスト効率に優れる。全て1Mコンテキスト対応。判断マトリクス・料金・ルーティングガイド。',
  ...
  zh: {
    ...
    metaDescription: 'GPT-5.5擅长工具集成，Claude Opus 4.7擅长写作，Gemini 3.1 Pro最具性价比。全部支持1M上下文。决策矩阵、定价对比、路由指南。',
