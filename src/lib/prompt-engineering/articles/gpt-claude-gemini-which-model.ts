...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  ar: {
    ...
    metaDescription: '⁨GPT-5.5⁩ يتفوق في تكامل الأدوات، و⁨Claude⁩ في جودة الكتابة، و⁨Gemini⁩ في خفض التكلفة. مصفوفة قرار ومقارنة أسعار ودليل التوجيه لكل مهمة.',
    ...
    twitterDescription: '⁨GPT-5.5⁩ للوكلاء، و⁨Claude⁩ للكتابة، و⁨Gemini⁩ للتكلفة. الثلاثة الآن بسياق ⁨1M⁩ رمز. مصفوفة قرار وأسعار و⁨4⁩ وصفات توجيه.',
