...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  es: {
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/es/es/prompt-engineering/pe-for-content-teams',
  ...
  ar: {
    ...
    metaDescription: 'برومبتات لفرق المحتوى: ترميز صوت العلامة التجارية، 5 قوالب قابلة للإعادة (مدونة، وسائل التواصل، SEO، بريد إلكتروني)، سير مراجعة ونظام تقييم الجودة.',
