...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  pt: {
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/pt/prompt-engineering/pe-for-content-teams',
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          ...
          { q: 'コンテンツプロンプトを複数のモデルで一貫して機能するようテストしますか？', a: '2–3個のモデル（GPT-5.5、Claude 4.6 Sonnet、Gemini 2.5 Flash）で同じテンプレートをテストして、各々10回以上のテスト実行を行います。5点品質スコアリングルーブリックを使用して一貫性を評価します。' },
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          ...
          { q: '你如何测试内容提示词在多个模型中的一致性？', a: '在2-3个模型（GPT-5.5、Claude 4.6 Sonnet、Gemini 2.5 Flash）上测试相同的模板，每个10+次测试运行。使用5点质量评分标准评估一致性。' },
  ...
  ar: {
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/ar/prompt-engineering/pe-for-content-teams',
      ...
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } },
      image: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/ar/api/og/pe-for-content-teams', width: 1200, height: 630 },
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          ...
          { q: 'كيف أُعدّ قالب محتوى يعمل باتساق عبر نماذج متعددة؟', a: 'اختبر القالب ذاته على 2–3 نماذج (GPT-5.5 وClaude 4.6 Sonnet وGemini 2.5 Flash) بـ10+ اختبارات تجريبية لكل منها. استخدم نظام تقييم الجودة من 5 معايير لتقييم الاتساق. إذا حقق كل النماذج 1.5+، القالب قابل للنقل. إذا انخفض نموذج دون 1.5، راجع البرومبت بدلاً من تبنّي نسخة مخصّصة لنموذج بعينه.' },
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          ...
          { q: '여러 모델에서 일관되게 작동하는 콘텐츠 템플릿을 어떻게 설정합니까?', a: '각각 10회 이상의 테스트 실행으로 2~3개의 모델(GPT-5.5, Claude 4.6 Sonnet, Gemini 2.5 Flash)에서 동일한 템플릿을 테스트하십시오. 5점 품질 점수화 루브릭을 사용하여 일관성을 평가하십시오. 모든 모델이 1.5점 이상을 달성하면 템플릿은 이식 가능합니다. 한 모델이 1.5점 미만으로 떨어지면 모델별 버전을 채택하는 대신 프롬프트를 수정하십시오.' },
