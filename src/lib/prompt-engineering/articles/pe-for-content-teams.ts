...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  pt: {
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/pt/pt/prompt-engineering/pe-for-content-teams',
  ...
  ar: {
    ...
    sections: {
      ...
      related_reading: {
        ...
        items: [
          { title: 'إطار CRAFT للفرق: البرومبتات المنظّمة مقابل الارتجالية', url: '/ar/prompt-engineering/prompt-framework-for-teams' },
          { title: 'اختبار البرومبتات والتحقق منها: مجموعات الاختبار الآلي للنماذج اللغوية', url: '/ar/prompt-engineering/prompt-testing-validation' },
          { title: 'العلامة التجارية في برومبتات النماذج اللغوية: ترميز الصوت والنبرة والمصطلحات', url: '/ar/prompt-engineering/brand-voice-llm-prompts' },
          { title: 'سير العمل التحريري مع الذكاء الاصطناعي: ضبط الجودة والامتثال', url: '/ar/prompt-engineering/editorial-workflow-ai' },
          { title: 'اختبار البرومبتات متعدد النماذج لإنشاء المحتوى', url: '/ar/prompt-engineering/multi-model-prompt-testing' },
        ],
      },
      sources: {
        id: 'sources',
