...
export const article: Record<Language, PEArticle> = {
    en: {
      ...
      seoTitle: 'Persona-Prompting: Zuverlässige KI-Experten ohne Fine-Tuning',
      publishDate: '2026-03-26',
      readTime: '13 Min. Lesezeit',
      educationalLevel: 'Intermediate',
      audience: 'Software-Entwickler, Produktmanager, Teams mit großflächigen KI-Assistenten',
      metaDescription: 'Beherrschen Sie Persona-Prompting für stabile, zuverlässige KI-Experten ohne Fine-Tuning. Lernen Sie die 7 Bausteine, praktische Templates und Multi-Model-Tests.',
      ...
      sections: {
        tldr: {
          ...
          numberedItems: [
            'Persona-Prompting fixiert KI-Verhalten durch die Definition von Rolle, Wissensbereich und Entscheidungsregeln – vor der eigentlichen Aufgabe – und macht Antworten über Sitzungen und Modelle hinweg vorhersehbar.',
            'Die sieben Bausteine sind: Rolle (wer), Domain-Umfang (was), Ziele (Prioritäten), Constraints (Grenzen), Interaktionsstil (wie), Beispiele (gut/schlecht) und Unsicherheitsbehandlung (wann unsicher).',
            'Personas reduzieren Halluzinationen, weil sie die Überlegungen des Modells auf eine konsistente „Identität" beschränken, anstatt jeden Query einen neuen Stil zu improvisieren.',
            'Testen Sie Personas über GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro und Mistral Large, um zu sehen, welches Modell am besten anhaftet – kein einzelnes Modell folgt allen Personas gleich.',
            'Persona-Prompting ist in Sekunden reversibel und funktioniert über Anbieter hinweg, was es portabel und günstiger als Fine-Tuning für Verhaltensänderungen macht.',
            'Verwenden Sie numerische Schwellenwerte (Konfidenz %, Token-Limits, Lese-Level), um Modellen bei der Befolgung von Regeln zu helfen; Modelle wie GPT-5.5 bilden diese direkt auf interne Decodierungsparameter ab.',
          ],
        },
        quickFacts: {
          title: 'Schnelle Fakten',
          items: [
            'Kerntechnik: Rolle, Domain und Constraints zur System-Nachricht hinzufügen, bevor die Aufgabe gestellt wird.',
            'Bausteine: 7 Komponenten (Rolle, Umfang, Ziele, Constraints, Stil, Beispiele, Unsicherheitsbehandlung) machen Personas maschinenlesbar.',
            'Verhaltensauswirkung: Personas reduzieren Formatfehler um >50% und erhöhen die Einhaltung von Constraints im Vergleich zu generischen Prompts.',
            'Multi-Model-Vorteil: Dieselbe Persona verhält sich auf GPT-5.5, Claude und Gemini unterschiedlich – erfordert absichtliches Testen.',
            'Wiederverwendbarkeit: Kompakte Personas (400–600 Token) sind innerhalb von Teams und über Projekte hinweg teilbar.',
            'Kein Training erforderlich: Im Gegensatz zu Fine-Tuning funktionieren Personas bei jedem Anbieter ohne Modell-Umschulung.',
          ],
        },
        whatIsPersonaPrompting: {
          ...
          rows: [
            {
              ...
              'System-Prompt': 'Minuten (API-Konfiguration)',
              'RAG (Retrieval-Augmented)': 'Stunden (Corpus aufbauen, Embeddings)',
            },
            {
              'Aspekt': 'Kosten',
              'Persona-Prompting': 'Kostenlos (nur Token)',
              'Fine-Tuning': '€90–€9.000+ pro Modell',
              'System-Prompt': 'Kostenlos (API-Feature)',
              'RAG (Retrieval-Augmented)': '€90–€900+ (Infrastruktur)',
            },
            {
              'Aspekt': 'Portabilität über Modelle',
              'Persona-Prompting': 'Funktioniert auf GPT, Claude, Gemini, lokal',
              'Fine-Tuning': 'Anbieterspezifisch, modellspezifisch',
              'System-Prompt': 'Anbieterspezifisch, eingeschränkter Umfang',
              'RAG (Retrieval-Augmented)': 'Modellunabhängig, Integration erforderlich',
            },
            {
              'Aspekt': 'Umkehrbarkeit',
              'Persona-Prompting': 'In Sekunden änderbar',
              'Fine-Tuning': 'Umschulung erforderlich (Tage)',
              'System-Prompt': 'In Minuten änderbar',
              'RAG (Retrieval-Augmented)': 'Corpus aktualisieren, neu bereitstellen',
            },
            {
              'Aspekt': 'Beste Anwendung',
              'Persona-Prompting': 'Multi-Domain-Rollen, Testing',
              'Fine-Tuning': 'Spezialisierte Aufgaben, Firmenstil',
              'System-Prompt': 'Globale Regeln, alle Request-Constraints',
              'RAG (Retrieval-Augmented)': 'Faktenverankerung, wissenslastige Aufgaben',
            },
          ],
        },
        zusatzFaqs: {
          ...
          faqs: [
            ...
            {
              q: 'Wie lang sollte ein Persona-Prompt sein?',
              a: 'Die meisten wirksamen Personas sind 200–600 Token. Beginnen Sie mit 200–300 Token, die Rolle, Domain, Ziele und 1–2 Constraints abdecken. Fügen Sie Beispiele und Unsicherheitsbehandlung hinzu, wenn die Komplexität es erfordert. Personas >1000 Token verwirren Modelle oft; halten Sie sie prägnant und testbar.',
            },
            {
              q: 'Funktioniert Persona-Prompting auf allen Modellen?',
              a: 'Es funktioniert auf GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro, Mistral Large und lokalen Modellen wie LLaMA 3.1 und Qwen 2.5. Unterschiedliche Modelle folgen Personas jedoch unterschiedlich: GPT-5.5 priorisiert Constraints, Claude stellt Klärungsfragen, Gemini produziert dichte Zusammenfassungen. Testen Sie Ihr Persona auf mehreren Modellen.',
            },
            {
              q: 'Kann ich Personas mit Fine-tuned-Modellen verwenden?',
              a: 'Ja. Personas funktionieren als Text-Layer über Fine-tuned-Modellen. Ein Fine-tuned-Modell kodiert bereits Domain-Wissen und Stil; ein Persona-Prompt kann dieses Verhalten für bestimmte Aufgaben verfeinern oder umleiten. Die beiden arbeiten komplementär.',
            },
            {
              q: 'Wie teste ich, ob ein Persona funktioniert?',
              a: 'Testen Sie mit PromptQuorum: Senden Sie dieselbe Aufgabe an GPT-5.5, Claude und Gemini mit Ihrem Persona. Zählen Sie, wie oft das Modell eine Regel bricht (z. B. Token-Limit überschreitet, Marketing-Sprache verwendet). Verfeinern Sie das Persona basierend auf Fehlern. Wiederholen Sie 10–20 Mal.',
            },
            {
              q: 'Was passiert, wenn ein Persona mit den Task-Anweisungen des Benutzers kollidiert?',
              a: 'Task-Anweisungen gewinnen normalerweise. Wenn ein Persona sagt „max 3 Sätze", aber der Nutzer fragt nach 1000 Worten, folgen Modelle normalerweise der expliziten Anfrage des Nutzers. Vermeiden Sie dies, indem Sie Personas flexibel machen: „Versuchen Sie, 3 Sätze pro Absatz zu schreiben, es sei denn, die Aufgabe fordert explizit anders."',
            },
            {
              q: 'Sind Personas für andere Sprachen als Englisch wirksam?',
              a: 'Ja, aber mit Einschränkungen. Modelle wie GPT-5.5 und Claude verarbeiten deutsche, französische, japanische und chinesische Personas gut, die Leistung variiert aber. Testen Sie Personas in Ihrer Zielsprache; einige Modelle (z. B. Qwen 2.5) sind für bestimmte Sprachen optimiert und folgen lokalisierten Personas zuverlässiger.',
            },
          ],
        },
        sources: {
          ...
          items: [
            ...
            '[Brown et al. (2020). "Language Models are Few-Shot Learners." OpenAI.](https://arxiv.org/abs/2005.14165)',
            '[Touvron et al. (2023). "LLaMA: Open and Efficient Foundation Language Models." arXiv.](https://arxiv.org/abs/2302.13971)',
            '[PromptQuorum Dokumentation: Multi-Model-Persona-Testing.](https://www.promptquorum.com/docs/multi-model-testing)',
          ],
        },
        relatedReading: {
          title: 'Verwandte Artikel',
          items: [
            '[Wie man klare Prompts für AI schreibt](/prompt-engineering/how-to-write-clear-prompts?lang=de) — Beherrschen Sie die Grundlagen, bevor Sie zu Personas übergehen.',
            '[Negative Prompting: Sagen Sie KI, was NICHT zu tun ist](/prompt-engineering/negative-prompting?lang=de) — Kombinieren Sie Personas mit expliziten Constraints für bessere Kontrolle.',
            '[Prompt-Frameworks: Chain-of-Thought und darüber hinaus](/prompt-engineering/chain-of-thought-prompting?lang=de) — Erlernen Sie strukturierte Reasoning-Techniken, die mit Personas funktionieren.',
            '[System-Prompts: Die Grundlage des KI-Verhaltens](/prompt-engineering/system-prompts?lang=de) — Verstehen Sie, wie Personas in die breitere Systemarchitektur passen.',
            '[Fine-Tuning vs Prompt Engineering: Wann sollte man was verwenden](/prompt-engineering/fine-tuning-vs-prompting?lang=de) — Entscheiden Sie, ob Personas oder Fine-Tuning für Ihren Use-Case richtig sind.',
            '[Testing von AI-Modellen über Anbieter hinweg](/prompt-engineering/testing-ai-models?lang=de) — Erlernen Sie systematisches Vergleichen der Persona-Leistung.',
          ],
        },
      },
    },
    faqSchema: {
      ...
      mainEntity: [
        {
          '@type': 'Question',
          name: 'Ist Persona-Prompting ein Ersatz für Data Governance und DSGVO-Compliance?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Nein. Ein Persona-Prompt ist eine Schicht zur Verhaltenskontrolle, aber Sie benötigen nach wie vor eine vollständige Datenschutz-Architektur: Data Governance-Richtlinien, Datenschutz-Folgenabschätzung (DSFA), Auftragsverarbeitungsverträge (AV) und Audit-Logs. Personas dokumentieren jedoch die KI-Entscheidungsregeln und machen Compliance einfacher nachzuweisen.',
          },
        },
        {
          '@type': 'Question',
          name: 'Kann ich eine Persona mit auf-Premise-Modellen lokal hosten und EU-Data-Residency-Anforderungen erfüllen?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Ja. Mit PromptQuorum können Sie eine Persona gegen lokale Ollama- oder LM-Studio-Deployments testen. Die Persona-Text bleibt in Ihrem System; Daten verlassen nie Ihre Infrastruktur. Dies ist besonders wertvoll für Banken und Organisationen mit strengen Datenspeicherungsanforderungen.',
          },
        },
        {
          '@type': 'Question',
          name: 'Wie lang sollte ein Persona-Prompt sein?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Die meisten wirksamen Personas sind 200–600 Token. Beginnen Sie mit 200–300 Token, die Rolle, Domain, Ziele und 1–2 Constraints abdecken. Fügen Sie Beispiele und Unsicherheitsbehandlung hinzu, wenn die Komplexität es erfordert.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Es funktioniert auf GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro, Mistral Large und lokalen Modellen. Unterschiedliche Modelle folgen Personas jedoch unterschiedlich. Testen Sie Ihr Persona auf mehreren Modellen.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Ja. Personas funktionieren als Text-Layer über Fine-tuned-Modellen. Die beiden arbeiten komplementär.',
          },
        },
        {
          '@type': 'Question',
          name: 'Wie teste ich, ob ein Persona funktioniert?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Testen Sie mit PromptQuorum: Senden Sie dieselbe Aufgabe an mehrere Modelle mit Ihrem Persona. Zählen Sie, wie oft das Modell eine Regel bricht. Verfeinern Sie basierend auf Fehlern.',
          },
        },
        {
          '@type': 'Question',
          name: 'Was passiert, wenn ein Persona mit Task-Anweisungen kollidiert?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Task-Anweisungen gewinnen normalerweise. Machen Sie Personas flexibel, um Konflikte zu vermeiden.',
          },
        },
        {
          '@type': 'Question',
          name: 'Sind Personas für andere Sprachen wirksam?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Ja, aber die Leistung variiert. Testen Sie Personas in Ihrer Zielsprache; einige Modelle sind für bestimmte Sprachen optimiert.',
          },
        },
      ],
    },
      ...
      itemListElement: [
        {
          ...
          position: 1,
          name: 'Persona-Prompting',
          description: 'Ändert nur Input-Text; funktioniert bei allen Anbietern; in Sekunden reversibel; beste Anwendung für Multi-Domain-Rollen und Testing.',
        },
        {
          '@type': 'ListItem',
          position: 2,
          name: 'Fine-Tuning',
          description: 'Ändert Modell-Gewichte; anbieterspezifisch; erfordert Umschulung für Änderungen; beste Anwendung für spezialisierte, proprietäre Stile.',
        },
        {
          '@type': 'ListItem',
          position: 3,
          name: 'System-Prompt',
          description: 'API-Level-Konfiguration; anbieterspezifisch; eingeschränkter Umfang; beste Anwendung für globale Regeln für alle Requests.',
        },
        {
          '@type': 'ListItem',
          position: 4,
          name: 'RAG (Retrieval-Augmented Generation)',
          description: 'Modellunabhängig; erfordert Infrastruktur; beste Anwendung für Faktenverankerung und wissenslastige Aufgaben.',
        },
        {
          '@type': 'ListItem',
          position: 5,
          name: 'System-Prompt + Persona',
          description: 'Kombiniert System-Regeln mit Task-spezifischen Personas; Hybrid-Ansatz; beste Anwendung für Enterprise-Governance und Flexibilität.',
        },
      ],
    },
  },
