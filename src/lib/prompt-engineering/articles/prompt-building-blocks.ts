      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: { '@type': 'Answer', text: 'はい。GPT-5.6、Claude、Gemini、Ollama や LM Studio などのローカル LLM など、どのモデルを使用していても、これら5つの構成要素は有効です。構文は若干異なりますが、役割、指示、例、制約、形式という概念的モデルはすべてのモデルに普遍的に適用されます。' },
          },
          {
            '@type': 'Question',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'はい。GPT-5.6、Claude Opus 5、Gemini 3.1 Pro、または Ollama や LM Studio を経由するオープンソース LLM を使用しているかどうかにかかわらず、これら5つの構成要素はすべてで機能します。最小構造は構文において若干異なりますが、概念的モデル（役割、指示、例、制約、形式）はすべてのモデルに普遍的に適用されます。',
            },
            {
