...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    es: {
      ...
      schema: {
        ...
        datePublished: '2026-03-01',
        dateModified: '2026-05-04',
        url: 'https://www.promptquorum.com/es/es/prompt-engineering/5-building-blocks-every-prompt-needs',
        inLanguage: 'es',
        proficiencyLevel: 'Beginner',
    ...
    ar: {
      ...
      seoTitle: '5 مكونات لكل برومبت ذكاء اصطناعي',
      ...
      metaDescription: 'كل برومبت ذكاء اصطناعي جيد يحتاج إلى 5 أجزاء: الدور والمهمة والمدخلات والقيود والتنسيق. إذا غاب أحدها، تنخفض الجودة. قالب جاهز للنسخ.',
      publishDate: '2026-03-01',
