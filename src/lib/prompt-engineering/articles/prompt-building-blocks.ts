...
export const article: Record<Language, PEArticle> = {
    en: {
      ...
      metaDescription: 'Every AI prompt needs 5 parts: Role, Task, Input, Constraints, Output Format. Miss one and outputs degrade. Copy-paste template works on all major language models.',
