...
**Test results:** 18/18 golden test cases passed (previously 15/18).`,
  ...
  ar: {
    ...
    seoTitle: 'التحكم في إصدارات الموجّهات: Git وSemver والتراجع',
    metaDescription: 'git revert على موجّه يستغرق ثوانٍ؛ إعادة الاختبار بدون سجل تستغرق ساعات. طبّق MAJOR.MINOR.PATCH وGit على كل تغيير في الموجّه لتراجع فوري.',
