    ...
    en: {
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'PromptQuorum test data: structured single-step prompts produced on-format output in 38/40 cases vs 21/40 for vague one-liners (GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro)',
            ...
            'The method works identically across GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro, and local models (Ollama, LM Studio)',
          ],
        },
        tldrBox: {
          isTldr: true,
          content: [
            '> **TL;DR:** Pack role, objective, context, constraints, and output format into one message. Test on 3-5 examples. Save as a reusable template. This single-step approach scored 95% on-format across GPT-4o, Claude Opus 4.8, and Gemini 3.1 Pro vs 52.5% for vague prompts. Start here for any task; switch to CO-STAR or CRAFT only when you need independent control over tone, audience, or style.',
          ],
        },
        quickFacts: {
          title: 'Quick Facts',
        ...
        whatIsSingleStep: {
          ...
          content: [
            '**The Single Step Prompt Method is a one-shot prompt structure that packs role, objective, context, constraints, and output format into a single message to the model.** Instead of asking the AI to "brainstorm together" over several turns, you give it everything it needs upfront. This approach works with GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro, and local models such as those you run via [Ollama](/local-llms/ollama-installation-guide) or LM Studio.',
        ...
        howPQImplements: {
          ...
          items: [
            ...
            'Applies the same structured prompt to multiple models in parallel, including GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro, and local models configured through Ollama or LM Studio.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Yes, absolutely. The Single Step Prompt Method works with any model — GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro, or local models via Ollama and LM Studio. The same single structure applies across all platforms.',
            },
            {
            ...
            },
            {
              ...
              a: 'You\'ll get different outputs — GPT-4o tends to be verbose, Claude Opus 4.8 concise, Gemini 3.1 Pro detail-oriented. This variation is a feature, not a bug. Test the same prompt across models to see which one matches your style. Save the model+prompt pair as a reusable recipe.',
            },
            {
        ...
        sources: {
          ...
          items: [
            ...
            '[PromptQuorum Testing Database. 2026.](https://www.promptquorum.com) — Internal benchmarks: 38/40 structured prompts vs. 21/40 vague prompts across GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro.',
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Can I use Single Step with local models like Ollama or LM Studio?', acceptedAnswer: { '@type': 'Answer', text: 'Yes, absolutely. The Single Step Prompt Method works with any model — GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro, or local models via Ollama and LM Studio. The same single structure applies across all platforms.' } },
    ...
    de: {
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'PromptQuorum-Testdaten: strukturierte Single-Step-Prompts erzeugten korrekt formatierte Ausgaben in 38/40 Fällen im Vergleich zu 21/40 bei vagen Einzeilern (GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro)',
            ...
            'Die Methode funktioniert identisch über GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro und lokale Modelle (Ollama, LM Studio)',
          ],
        },
        tldrBox: {
          isTldr: true,
          content: [
            '> **TL;DR:** Vereinen Sie Rolle, Ziel, Kontext, Einschränkungen und Ausgabeformat in einer Nachricht. Testen Sie an 3-5 Beispielen. Speichern Sie als wiederverwendbare Vorlage. Dieser Single-Step-Ansatz erzielte 95 % On-Format-Rate über GPT-4o, Claude Opus 4.8 und Gemini 3.1 Pro im Vergleich zu 52,5 % bei vagen Prompts. Beginnen Sie hier für jede Aufgabe; wechseln Sie zu CO-STAR oder CRAFT nur, wenn Sie unabhängige Kontrolle über Ton, Zielgruppe oder Stil benötigen.',
          ],
        },
        quickFacts: {
        ...
        whySingleStepWorks: {
          ...
          callouts: [
            { type: '🔍', label: 'Der 38/40-Test', text: 'Bei PromptQuorum-Tests wurden 40 Zusammenfassungs-Prompts an GPT-4o, Claude Opus 4.8 und Gemini 3.1 Pro versendet. Strukturierte Single-Step-Prompts erzeugten in 38 von 40 Fällen korrekt formatierte Ausgaben. Dieselben Aufgaben als vage Einzeiler erreichten 21 von 40. Struktur allein verdoppelte fast die Erfolgsquote.' },
          ],
        },
        fiveBlocks: {
        ...
        howPQImplements: {
          ...
          items: [
            ...
            'Wendet den gleichen strukturierten Prompt auf mehrere Modelle parallel an, darunter GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro und lokale Modelle, die über Ollama oder LM Studio konfiguriert sind.',
        ...
        summaryBox: {
          ...
          content: [
            ...
            '• **Für alle Modelle und Szenarien:** Die Methode funktioniert identisch über GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro und lokale Modelle (Ollama, LM Studio).',
          ],
        },
        howToStart: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Kann ich Single Step mit lokalen Modellen wie Ollama oder LM Studio verwenden?', acceptedAnswer: { '@type': 'Answer', text: 'Ja, absolut. Die Single Step Prompt Methode funktioniert mit jedem Modell — GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro oder lokalen Modellen über Ollama und LM Studio. Die gleiche einzige Struktur gilt über alle Plattformen hinweg.' } },
    ...
    es: {
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'Datos de prueba de PromptQuorum: los prompts de un solo paso estructurados produjeron output en formato correcto en 38/40 casos vs 21/40 para frases vagas (GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro)',
            ...
            'El método funciona de manera idéntica en GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro y modelos locales (Ollama, LM Studio)',
          ],
        },
        tldrBox: {
          isTldr: true,
          content: [
            '> **TL;DR:** Incluye rol, objetivo, contexto, restricciones y formato de output en un mensaje. Prueba en 3-5 ejemplos. Guarda como plantilla reutilizable. Este enfoque de un solo paso obtuvo 95% en formato correcto en GPT-4o, Claude Opus 4.8 y Gemini 3.1 Pro vs 52.5% para prompts vagos. Empieza aquí para cualquier tarea; pasa a CO-STAR o CRAFT solo cuando necesites control independiente sobre tono, audiencia o estilo.',
          ],
        },
        quickFacts: {
          title: 'Datos rápidos',
        ...
        whatIsSingleStep: {
          ...
          content: [
            '**El Método de Prompt de Un Solo Paso es una estructura de prompt de un disparo que incluye rol, objetivo, contexto, restricciones y formato de output en un único mensaje al modelo.** En lugar de pedirle a la IA que "piense en conjunto" durante varios turnos, le das todo lo que necesita desde el inicio. Este enfoque funciona con GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro y modelos locales como los que ejecutas via Ollama o LM Studio.',
        ...
        whySingleStepWorks: {
          ...
          callouts: [
            { type: '🔍', label: 'La Prueba de 38/40', text: 'En pruebas de PromptQuorum, se enviaron 40 prompts de resumen a GPT-4o, Claude Opus 4.8 y Gemini 3.1 Pro. Los prompts estructurados de un solo paso produjeron output en formato correcto en 38 de 40 casos. Las mismas tareas como frases vagas obtuvieron 21 de 40. Solo la estructura casi duplicó la tasa de éxito.' },
          ],
        },
        fiveBlocks: {
        ...
        howPQImplements: {
          ...
          items: [
            ...
            'Aplica el mismo prompt estructurado a múltiples modelos en paralelo, incluyendo GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro y modelos locales configurados a través de Ollama o LM Studio.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Sí, absolutamente. El Método de Prompt de Un Solo Paso funciona con cualquier modelo — GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro o modelos locales via Ollama y LM Studio. La misma estructura única aplica en todas las plataformas.',
            },
            {
        ...
        sources: {
          ...
          items: [
            ...
            '[PromptQuorum Testing Database. 2026.](https://www.promptquorum.com) — Benchmarks internos: 38/40 prompts estructurados vs 21/40 prompts vagos en GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro.',
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: '¿Puedo usar Un Solo Paso con modelos locales como Ollama o LM Studio?', acceptedAnswer: { '@type': 'Answer', text: 'Sí, absolutamente. El Método de Prompt de Un Solo Paso funciona con cualquier modelo — GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro o modelos locales via Ollama y LM Studio. La misma estructura única aplica en todas las plataformas.' } },
    ...
    fr: {
      ...
      sections: {
        ...
        howPQImplements: {
          ...
          items: [
            ...
            'Applique le même prompt structuré à plusieurs modèles en parallèle, y compris GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro et les modèles locaux configurés via Ollama ou LM Studio.',
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Puis-je utiliser Single Step avec des modèles locaux comme Ollama ou LM Studio ?', acceptedAnswer: { '@type': 'Answer', text: 'Oui, absolument. La Méthode Single Step Prompt fonctionne avec n\'importe quel modèle — GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro ou modèles locaux via Ollama et LM Studio. La même structure unique s\'applique sur toutes les plates-formes.' } },
  ...
  sections: {
    keyTakeaways: {
      ...
      items: [
        ...
        'PromptQuorumのテストデータ：構造化されたSingle Stepプロンプトは38/40（95%）の成功率を達成。曖昧な1行プロンプトは21/40（52.5%）。（GPT-4o・Claude Opus 4.8・Gemini 3.1 Proでの検証）',
        ...
        'このメソッドはGPT-4o・Claude Opus 4.8・Gemini 3.1 Pro・ローカルモデル（Ollama・LM Studio）で同じように機能します。',
      ],
    },
    tldrBox: {
      isTldr: true,
      content: [
        '> **TL;DR：** ロール・目的・コンテキスト・制約・出力形式を1つのメッセージに統合してください。3～5つの例でテストし、再利用可能なテンプレートとして保存します。このSingle Stepアプローチは、GPT-4o・Claude Opus 4.8・Gemini 3.1 Pro全体で95%の成功率を実現（曖昧なプロンプトは52.5%）。すべてのタスクではここから始めてください。トーン・対象者・スタイルの独立的な制御が必要な場合のみ、CO-STARやCRAFTに切り替えてください。',
      ],
    },
    quickFacts: {
      title: 'クイックファクト',
      ...
      numberedItems: [
        ...
        '**動作環境：** GPT-4o・Claude Opus 4.8・Gemini 3.1 Pro・ローカルモデル（Ollama・LM Studio）',
      ],
    },
    whatIsSingleStep: {
      title: 'What the Single Step Prompt Method Is',
      content: [
        '**Single Step Prompt Methodは、ロール・目的・コンテキスト・制約・出力形式を1つのメッセージに凝縮する1回限りのプロンプト構造です。** AIに「一緒にブレインストーミングしましょう」と複数ターンにわたって提案する代わりに、必要な情報をすべて最初に提供します。このアプローチはGPT-4o、Claude Opus 4.8、Gemini 3.1 Pro、および[Ollama](/ja/local-llms/ollama-installation-guide)やLM Studioなどのローカルモデルに対応しています。',
    ...
    howPQImplements: {
      ...
      items: [
        ...
        '構造化されたプロンプトをGPT-4o・Claude Opus 4.8・Gemini 3.1 Pro、およびOllamaやLM Studioで構成されたローカルモデルを含む複数のモデルに並列的に適用します。',
    ...
    practiceTips: {
      ...
      items: [
        ...
        '**同じプロンプトを複数モデルで並列テスト**：Single Stepプロンプトの大きな利点は、同じ指示をGPT-4o・Claude Opus 4.8・Gemini 3.1 Proで同時に実行でき、どのモデルがあなたのユースケースに最適かを見ることができることです。',
  ...
  faqSchema: {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'ほぼ同じですが、完全には同一ではありません。GPT-4o、Claude Opus 4.8、Gemini 3.1 Proはそれぞれ異なる訓練データと推論方法を持つため、微妙な違いが生じます。Single Stepプロンプトを使用する利点は、同じ指示で比較できるため、モデル固有の特性と品質の違いが明確になることです。',
        },
      },
      {
        '@type': 'Question',
    ...
    zh: {
      ...
      sections: {
        whatIsSingleStep: {
          title: '什么是单步提示法',
          content: [
            '**单步提示法是一种一次性的提示结构，将角色、目标、上下文、约束条件和输出格式整合到一条给模型的单一消息中。** 不同于让AI在多轮对话中"一起头脑风暴"，单步提示法在最初就向模型提供它所需的全部信息。这种方法适用于GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro以及通过[Ollama](/zh/local-llms/ollama-installation-guide)或LM Studio等工具运行的本地模型。',
        ...
        howPQImplements: {
          ...
          items: [
            ...
            '将同样的结构化提示并行应用于多个模型，包括GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro以及通过Ollama或LM Studio配置的本地模型。',
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: '完全可以。单步提示法与任何模型配合工作——GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro或通过Ollama和LM Studio的本地模型。相同的单一结构在所有平台应用。',
            },
          },
          {
            '@type': 'Question',
