...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      publishDate: '2026-03-24',
      seoTitle: 'طريقة البرومبت في خطوة واحدة: 5 لبنات وأمثلة',
      metaDescription: 'تعلّم طريقة البرومبت في خطوة واحدة: أدرج الدور والهدف والسياق والقيود وتنسيق المخرج في رسالة واحدة. البرومبتات المنظمة تتفوق على التعليمات المبهمة.',
