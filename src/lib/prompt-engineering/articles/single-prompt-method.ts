      ...
      sections: {
        ...
        sources: {
          ...
          items: [
            ...
            '[OpenAI. "Prompt Engineering Best Practices." 2024.](https://platform.openai.com/docs/guides/prompt-engineering) — OpenAI\'s approach to structured prompts for GPT-5.6 and earlier models.',
