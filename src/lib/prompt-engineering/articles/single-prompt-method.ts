...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      theme: 'Frameworks',
      heroImage: '/images/single-prompt-method-overview-hero-en.webp',
      ...
      leadAnswerBlock: 'The Single Step Prompt Method is a one-shot prompt structure that packs role, objective, context, constraints, and output format into a single message. In PromptQuorum testing it produced on-format output 95% of the time across GPT-5.6, Claude Opus 5, and Gemini 3.1 Pro, against 52.5% for vague prompts.',
      schema: {
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'PromptQuorum test data: structured single-step prompts produced on-format output in 38/40 cases vs 21/40 for vague one-liners (GPT-5.6, Claude Opus 5, Gemini 3.1 Pro)',
            ...
            'The method works identically across GPT-5.6, Claude Opus 5, Gemini 3.1 Pro, and local models (Ollama, LM Studio)',
          ],
        },
        tldrBox: {
          isTldr: true,
          content: [
            '> **TL;DR:** Pack role, objective, context, constraints, and output format into one message. Test on 3-5 examples. Save as a reusable template. This single-step approach scored 95% on-format across GPT-5.6, Claude Opus 5, and Gemini 3.1 Pro vs 52.5% for vague prompts. Start here for any task; switch to CO-STAR or CRAFT only when you need independent control over tone, audience, or style.',
          ],
        },
        quickFacts: {
          title: 'Quick Facts',
        ...
        whatIsSingleStep: {
          ...
          content: [
            '**The Single Step Prompt Method is a one-shot prompt structure that packs role, objective, context, constraints, and output format into a single message to the model.** Instead of asking the AI to "brainstorm together" over several turns, you give it everything it needs upfront. This approach works with GPT-5.6, Claude Opus 5, Gemini 3.1 Pro, and local models such as those you run via [Ollama](/local-llms/how-to-install-ollama) or LM Studio.',
        ...
        howPQImplements: {
          ...
          items: [
            ...
            'Applies the same structured prompt to multiple models in parallel, including GPT-5.6, Claude Opus 5, Gemini 3.1 Pro, and local models configured through Ollama or LM Studio.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Yes, absolutely. The Single Step Prompt Method works with any model — GPT-5.6, Claude Opus 5, Gemini 3.1 Pro, or local models via Ollama and LM Studio. The same single structure applies across all platforms.',
            },
            {
            ...
            },
            {
              ...
              a: 'You\'ll get different outputs — GPT-5.6 tends to be verbose, Claude Opus 5 concise, Gemini 3.1 Pro detail-oriented. This variation is a feature, not a bug. Test the same prompt across models to see which one matches your style. Save the model+prompt pair as a reusable recipe.',
            },
            {
        ...
        sources: {
          ...
          id: 'sources',
          items: [
            '[Schulhoff, S., & others. "The Prompt Report: A Systematic Survey of Prompting Techniques." 2024.](https://arxiv.org/abs/2406.06608) — Systematic survey of prompting techniques, including how structured instructions compare with unstructured ones.',
            ...
            '[PromptQuorum Testing Database. 2026.](https://www.promptquorum.com) — Internal benchmarks: 38/40 structured prompts vs. 21/40 vague prompts across GPT-5.6, Claude Opus 5, Gemini 3.1 Pro.',
            ...
            '[OpenAI. "Prompt Engineering Best Practices."](https://platform.openai.com/docs/guides/prompt-engineering) — OpenAI\'s guidance on structuring prompts: state the role, the task, and the desired output format explicitly rather than iterating conversationally.',
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Can I use Single Step with local models like Ollama or LM Studio?', acceptedAnswer: { '@type': 'Answer', text: 'Yes, absolutely. The Single Step Prompt Method works with any model — GPT-5.6, Claude Opus 5, Gemini 3.1 Pro, or local models via Ollama and LM Studio. The same single structure applies across all platforms.' } },
    ...
    de: {
      freshness_tier: 'semi_annual',
      theme: 'Frameworks',
      heroImage: '/images/single-prompt-method-overview-hero-de.webp',
      ...
      leadAnswerBlock: 'Die Single Step Prompt Methode ist eine One-Shot-Prompt-Struktur, die Rolle, Ziel, Kontext, Einschränkungen und Ausgabeformat in einer einzigen Nachricht bündelt. In PromptQuorum-Tests lieferte sie über GPT-5.6, Claude Opus 5 und Gemini 3.1 Pro hinweg in 95 % der Fälle formatkonforme Ausgaben, gegenüber 52,5 % bei vagen Prompts.',
      dateModified: '2026-08-31',
      educationalLevel: 'Intermediate',
      schema: {
        '@context': 'https://schema.org',
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'PromptQuorum-Testdaten: strukturierte Single-Step-Prompts erzeugten korrekt formatierte Ausgaben in 38/40 Fällen im Vergleich zu 21/40 bei vagen Einzeilern (GPT-5.6, Claude Opus 5, Gemini 3.1 Pro)',
            ...
            'Die Methode funktioniert identisch über GPT-5.6, Claude Opus 5, Gemini 3.1 Pro und lokale Modelle (Ollama, LM Studio)',
          ],
        },
        tldrBox: {
          isTldr: true,
          content: [
            '> **TL;DR:** Vereinen Sie Rolle, Ziel, Kontext, Einschränkungen und Ausgabeformat in einer Nachricht. Testen Sie an 3-5 Beispielen. Speichern Sie als wiederverwendbare Vorlage. Dieser Single-Step-Ansatz erzielte 95 % On-Format-Rate über GPT-5.6, Claude Opus 5 und Gemini 3.1 Pro im Vergleich zu 52,5 % bei vagen Prompts. Beginnen Sie hier für jede Aufgabe; wechseln Sie zu CO-STAR oder CRAFT nur, wenn Sie unabhängige Kontrolle über Ton, Zielgruppe oder Stil benötigen.',
          ],
        },
        quickFacts: {
        ...
        whySingleStepWorks: {
          ...
          callouts: [
            { type: '🔍', label: 'Der 38/40-Test', text: 'Bei PromptQuorum-Tests wurden 40 Zusammenfassungs-Prompts an GPT-5.6, Claude Opus 5 und Gemini 3.1 Pro versendet. Strukturierte Single-Step-Prompts erzeugten in 38 von 40 Fällen korrekt formatierte Ausgaben. Dieselben Aufgaben als vage Einzeiler erreichten 21 von 40. Struktur allein verdoppelte fast die Erfolgsquote.' },
          ],
        },
        fiveBlocks: {
        ...
        howPQImplements: {
          ...
          items: [
            ...
            'Wendet den gleichen strukturierten Prompt auf mehrere Modelle parallel an, darunter GPT-5.6, Claude Opus 5, Gemini 3.1 Pro und lokale Modelle, die über Ollama oder LM Studio konfiguriert sind.',
        ...
        summaryBox: {
          ...
          content: [
            ...
            '• **Für alle Modelle und Szenarien:** Die Methode funktioniert identisch über GPT-5.6, Claude Opus 5, Gemini 3.1 Pro und lokale Modelle (Ollama, LM Studio).',
          ],
        },
        howToStart: {
        ...
        comparisonTable: {
          title: 'Vergleich: Single Step und andere Frameworks',
          id: 'comparison-table',
          tableFormat: true,
          columns: ['Dimension', 'Single Step', 'CO-STAR', 'CRAFT', 'SPECS', 'RTF'],
          rows: [
            { 'Dimension': 'Komplexität', 'Single Step': 'Minimal — 5 Blöcke', 'CO-STAR': 'Mittel — 7 Komponenten', 'CRAFT': 'Hoch — 8+ Komponenten', 'SPECS': 'Mittel — Ausgabe + Regeln', 'RTF': 'Minimal — 3 Blöcke' },
            { 'Dimension': 'Am besten für', 'Single Step': 'Klare Aufgaben, erste Versuche', 'CO-STAR': 'Kontextlastige Arbeit', 'CRAFT': 'Kreativ, mehrdimensional', 'SPECS': 'Strukturierte Ausgabe', 'RTF': 'Rollenbasiert, einfach' },
            { 'Dimension': 'Einrichtungszeit', 'Single Step': '10–15 Min.', 'CO-STAR': '20–30 Min.', 'CRAFT': '30–45 Min.', 'SPECS': '15–20 Min.', 'RTF': '5–10 Min.' },
            { 'Dimension': 'Token-Kosten', 'Single Step': 'Niedrig (1×)', 'CO-STAR': 'Mittel (1,2–1,5×)', 'CRAFT': 'Mittel (1,2–1,5×)', 'SPECS': 'Niedrig–mittel (1–1,2×)', 'RTF': 'Niedrig (0,9–1×)' },
            { 'Dimension': 'Ton & Zielgruppe', 'Single Step': 'Begrenzt (in der Rolle)', 'CO-STAR': 'Integriert (eigene Felder)', 'CRAFT': 'Volle Kontrolle (eigene Felder)', 'SPECS': 'Keine', 'RTF': 'Keine' },
            { 'Dimension': 'Nachvollziehbarkeit', 'Single Step': 'Nein', 'CO-STAR': 'Nein', 'CRAFT': 'Nein', 'SPECS': 'Nein', 'RTF': 'Nein' },
            { 'Dimension': 'Ausgabevalidierung', 'Single Step': 'Nur manuell', 'CO-STAR': 'Nur manuell', 'CRAFT': 'Nur manuell', 'SPECS': 'Automatisch (Schema)', 'RTF': 'Nur manuell' },
            { 'Dimension': 'Wiederverwendbarkeit', 'Single Step': 'Hoch — vorlagenfertig', 'CO-STAR': 'Hoch — bei festem Kontext', 'CRAFT': 'Mittel — kontextabhängig', 'SPECS': 'Hoch — regelbasiert', 'RTF': 'Hoch — rollenbasiert' },
          ],
        },
        faqSection: {
          id: 'faq',
          ...
          faqs: [
            { q: 'Wie unterscheidet sich die Single Step Prompt Methode von einfach nur die Anweisung zu stellen?', a: 'Mit Single Step erhalten Sie strukturelle Konsistenz. Anstelle einer einmaligen Antwort erhalten Sie immer die gleiche Qualität von Ergebnissen, weil das Modell feste Einschränkungen und das Format eingehalten hat. Dies macht Ergebnisse über Modelle hinweg vergleichbar und über die Zeit reproduzierbar.' },
            { q: 'Wann sollte ich Single Step statt mehrstufiges Prompting (Chain-of-Thought) verwenden?', a: 'Verwenden Sie Single Step, wenn Ihr Ziel klar und genau definiert ist. Bevorzugen Sie mehrstufiges Prompting bei mehrdeutigen oder explorativen Aufgaben, bei denen Sie den Denkprozess des Modells sehen müssen.' },
            { q: 'Kann ich Single Step mit lokalen Modellen wie Ollama oder LM Studio verwenden?', a: 'Ja, absolut. Die Single Step Prompt Methode funktioniert mit jedem Modell — GPT-5.6, Claude Opus 5, Gemini 3.1 Pro oder lokalen Modellen über Ollama und LM Studio. Die gleiche einzige Struktur gilt über alle Plattformen hinweg.' },
            { q: 'Wie lange dauert es, einen guten Single Step Prompt zu schreiben und zu verfeinern?', a: 'Üblicherweise 15–30 Minuten für eine solide erste Version. Schreiben Sie einen Entwurf, testen Sie ihn an 3–5 Beispielen, verfeinern Sie die Dinge, die nicht funktionieren, und verwenden Sie dann. Die anfängliche Investition zahlt sich schnell aus, da Sie sie dutzende Male wiederverwenden.' },
            { q: 'Kann ich meine Single Step Prompts als Vorlagen in PromptQuorum speichern?', a: 'Ja. Sobald Sie einen Single Step Prompt erstellen, der gut für einen bestimmten Workflow funktioniert (z. B. Code-Reviews, Kundenzusammenfassungen), können Sie ihn als Vorlage in PromptQuorum speichern und mit Ihrem Team teilen.' },
            { q: 'Was ist, wenn meine Aufgabe zu komplex für Single Step ist?', a: 'Wenn Sie feststellen, dass Sie Ihre Aufgabe nicht in einer einzigen Anweisung klar spezifizieren können, oder wenn Sie wirklich mehrere Ansätze des Modells benötigen, wechseln Sie zu APE oder CRAFT.' },
            { q: 'Wie kann ich bewerten, ob mein Single Step Prompt gut funktioniert?', a: 'Führen Sie ihn an 5–10 repräsentativen Beispielen aus und überprüfen Sie: (1) Halten sich die Ergebnisse an das angegebene Format? (2) Spiegelt der Inhalt die angegebene Rolle und den Ton wider? (3) Werden Grenzen wie die Wortanzahl beachtet? Wenn Schritte fehlschlagen, verfeinern Sie und testen Sie erneut.' },
            { q: 'Gibt es einen Leistungsunterschied zwischen Single Step und APE bei der gleichen Aufgabe?', a: 'Bei einer einfachen Aufgabe mit klarem Ziel produziert Single Step üblicherweise die gleichen Ergebnisse mit einem Bruchteil der Token. APE fügt Overhead hinzu, um die Argumentation zu zeigen — der Wert besteht darin, die Gedanken des Modells inspizieren und verfeinern zu können.' },
            { q: 'Wie passe ich Single Step für ein mehrsprachiges oder verteiltes Team an?', a: 'Speichern Sie die Single Step Vorlage in PromptQuorum mit klaren Anweisungen zu Platzhaltern (Variablen) und festen Werten. Dokumentieren Sie Formaterwartungen und Grenzfälle. Teamkollegen können dann die Variablen ausfüllen und den identischen Prompt ausführen.' },
            { q: 'Welche DSGVO-Anforderungen sollte ich beachten, wenn ich Single Step Prompts für Kundendaten verwende?', a: 'Dokumentieren Sie, welcher Prompt welche Kundendaten verarbeitet hat (für Audit-Zwecke erforderlich). Verwenden Sie Platzhalter für sensible Daten; füllen Sie diese nur zur Laufzeit aus. Für regulierte Datenverarbeitung benötigen Sie eine Datenschutzbewertung unter DSGVO Artikel 35 und möglicherweise eine Vereinbarung zur Datenverarbeitung mit Ihrem KI-Anbieter.' },
            { q: 'Können Mittelstandsunternehmen Single Step Prompts für wiederkehrende Prozesse wie Angebotsgenerierung oder Kundenberichte standardisieren?', a: 'Ja. Dies ist eine Kernstärke von Single Step. Standardisieren Sie den Prompt in Ihrer Organisation, speichern Sie ihn in PromptQuorum, und neue Mitarbeiter können Angebote oder Berichte ohne Training mit konsistenter Qualität erstellen. Dies ist besonders wertvoll für kleinere Teams, bei denen Skalierbarkeit ohne Verdopplung der Mitarbeiterzahl erforderlich ist.' },
          ],
        },
        relatedReading: {
          ...
          id: 'related-reading',
          items: [
            '[CO-STAR-Framework](/de/prompt-engineering/co-star-framework) — für Aufgaben, die Zielgruppenanpassung und Tonsteuerung erfordern',
            '[CRAFT-Framework](/de/prompt-engineering/craft-framework) — wenn Sie mehrere Variablen unabhängig voneinander steuern müssen',
            '[Chain-of-Thought-Prompting](/de/prompt-engineering/chain-of-thought-prompting) — für komplexe Aufgaben, die schrittweises Denken erfordern',
            '[Prompts über Modelle hinweg testen](/de/prompt-engineering/how-to-test-prompts-across-models) — Methodik zur Validierung Ihrer Prompts über mehrere Modelle',
            '[SPECS-Framework](/de/prompt-engineering/specs-framework) — wenn Sie strikte Ausgabevalidierung und Einschränkungen durchsetzen müssen',
            '[Die Bausteine jedes Prompts](/de/prompt-engineering/5-building-blocks-every-prompt-needs) — die Kernkomponenten wirksamer Prompts',
            '[Temperature und Top-p](/de/prompt-engineering/temperature-and-top-p-control-ai-creativity) — wie Sie die Zufälligkeit des Modells ergänzend zur Prompt-Struktur steuern',
            '[Zero-Shot und Few-Shot im Vergleich](/de/prompt-engineering/zero-shot-vs-few-shot) — wann Sie Beispiele in Ihre Single-Step-Prompts aufnehmen sollten',
          ],
        },
        sources: {
          title: 'Quellen',
          id: 'sources',
          items: [
            '[Schulhoff, S., & andere. "The Prompt Report: A Systematic Survey of Prompting Techniques." 2024.](https://arxiv.org/abs/2406.06608) — systematische Übersicht über Prompting-Techniken, einschließlich des Vergleichs strukturierter und unstrukturierter Anweisungen.',
            '[Brown, T. B., Mann, B., Ryder, N., & andere. "Language Models are Few-Shot Learners." OpenAI, 2020.](https://arxiv.org/abs/2005.14165) — Grundlagenforschung dazu, wie Modelle einzelne gegenüber mehrstufigen Anweisungen verarbeiten.',
            '[PromptQuorum Testdatenbank. 2026.](https://www.promptquorum.com) — interne Benchmarks: 38/40 strukturierte Prompts gegenüber 21/40 vagen Prompts über GPT-5.6, Claude Opus 5 und Gemini 3.1 Pro.',
            '[Anthropic. "Build with Claude: Prompt Engineering Guide."](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering) — offizielle Claude-Dokumentation, die vollständige Anweisungen vorab gegenüber iterativer Konversation empfiehlt.',
            '[OpenAI. "Prompt Engineering Best Practices."](https://platform.openai.com/docs/guides/prompt-engineering) — OpenAIs Leitfaden zur Prompt-Struktur: Rolle, Aufgabe und gewünschtes Ausgabeformat explizit angeben statt konversationell zu iterieren.',
            '[Reynolds, L., & McDonell, K. "Prompt Programming for Large Language Models: Beyond the Few-Shot Paradigm." 2021.](https://arxiv.org/abs/2102.07350) — Forschung zu Prompt-Struktur und Entwurfsmustern für Anweisungen.',
          ],
        },
      },
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Kann ich Single Step mit lokalen Modellen wie Ollama oder LM Studio verwenden?', acceptedAnswer: { '@type': 'Answer', text: 'Ja, absolut. Die Single Step Prompt Methode funktioniert mit jedem Modell — GPT-5.6, Claude Opus 5, Gemini 3.1 Pro oder lokalen Modellen über Ollama und LM Studio. Die gleiche einzige Struktur gilt über alle Plattformen hinweg.' } },
    ...
    es: {
      freshness_tier: 'semi_annual',
      theme: 'Frameworks',
      heroImage: '/images/single-prompt-method-overview-hero-es.webp',
      ...
      leadAnswerBlock: 'El Método de Prompt de Paso Único es una estructura de prompt de un solo disparo que reúne rol, objetivo, contexto, restricciones y formato de salida en un único mensaje. En las pruebas de PromptQuorum produjo salidas con el formato correcto el 95 % de las veces en GPT-5.6, Claude Opus 5 y Gemini 3.1 Pro, frente al 52,5 % de los prompts vagos.',
      dateModified: '2026-08-31',
      educationalLevel: 'Intermediate',
      schema: {
        '@context': 'https://schema.org',
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'Datos de prueba de PromptQuorum: los prompts de un solo paso estructurados produjeron output en formato correcto en 38/40 casos vs 21/40 para frases vagas (GPT-5.6, Claude Opus 5, Gemini 3.1 Pro)',
            ...
            'El método funciona de manera idéntica en GPT-5.6, Claude Opus 5, Gemini 3.1 Pro y modelos locales (Ollama, LM Studio)',
          ],
        },
        tldrBox: {
          isTldr: true,
          content: [
            '> **TL;DR:** Incluye rol, objetivo, contexto, restricciones y formato de output en un mensaje. Prueba en 3-5 ejemplos. Guarda como plantilla reutilizable. Este enfoque de un solo paso obtuvo 95% en formato correcto en GPT-5.6, Claude Opus 5 y Gemini 3.1 Pro vs 52.5% para prompts vagos. Empieza aquí para cualquier tarea; pasa a CO-STAR o CRAFT solo cuando necesites control independiente sobre tono, audiencia o estilo.',
          ],
        },
        quickFacts: {
          title: 'Datos rápidos',
        ...
        whatIsSingleStep: {
          ...
          content: [
            '**El Método de Prompt de Un Solo Paso es una estructura de prompt de un disparo que incluye rol, objetivo, contexto, restricciones y formato de output en un único mensaje al modelo.** En lugar de pedirle a la IA que "piense en conjunto" durante varios turnos, le das todo lo que necesita desde el inicio. Este enfoque funciona con GPT-5.6, Claude Opus 5, Gemini 3.1 Pro y modelos locales como los que ejecutas via Ollama o LM Studio.',
        ...
        whySingleStepWorks: {
          ...
          callouts: [
            { type: '🔍', label: 'La Prueba de 38/40', text: 'En pruebas de PromptQuorum, se enviaron 40 prompts de resumen a GPT-5.6, Claude Opus 5 y Gemini 3.1 Pro. Los prompts estructurados de un solo paso produjeron output en formato correcto en 38 de 40 casos. Las mismas tareas como frases vagas obtuvieron 21 de 40. Solo la estructura casi duplicó la tasa de éxito.' },
          ],
        },
        fiveBlocks: {
        ...
        howPQImplements: {
          ...
          items: [
            ...
            'Aplica el mismo prompt estructurado a múltiples modelos en paralelo, incluyendo GPT-5.6, Claude Opus 5, Gemini 3.1 Pro y modelos locales configurados a través de Ollama o LM Studio.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Sí, absolutamente. El Método de Prompt de Un Solo Paso funciona con cualquier modelo — GPT-5.6, Claude Opus 5, Gemini 3.1 Pro o modelos locales via Ollama y LM Studio. La misma estructura única aplica en todas las plataformas.',
            },
            {
        ...
        sources: {
          ...
          items: [
            ...
            '[PromptQuorum Testing Database. 2026.](https://www.promptquorum.com) — Benchmarks internos: 38/40 prompts estructurados vs 21/40 prompts vagos en GPT-5.6, Claude Opus 5, Gemini 3.1 Pro.',
            ...
            '[OpenAI. "Prompt Engineering Best Practices." 2024.](https://platform.openai.com/docs/guides/prompt-engineering) — El enfoque de OpenAI para prompts estructurados para GPT-5.6 y modelos anteriores.',
          ],
        },
      },
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: '¿Puedo usar Un Solo Paso con modelos locales como Ollama o LM Studio?', acceptedAnswer: { '@type': 'Answer', text: 'Sí, absolutamente. El Método de Prompt de Un Solo Paso funciona con cualquier modelo — GPT-5.6, Claude Opus 5, Gemini 3.1 Pro o modelos locales via Ollama y LM Studio. La misma estructura única aplica en todas las plataformas.' } },
    ...
    ar: {
      freshness_tier: 'semi_annual',
      theme: 'Frameworks',
      heroImage: '/images/single-prompt-method-overview-hero-ar.webp',
      ...
      leadAnswerBlock: 'طريقة المطالبة أحادية الخطوة هي بنية مطالبة من لقطة واحدة تجمع الدور والهدف والسياق والقيود وصيغة المخرجات في رسالة واحدة. في اختبارات PromptQuorum أنتجت مخرجات مطابقة للصيغة بنسبة 95% عبر GPT-5.6 وClaude Opus 5 وGemini 3.1 Pro، مقابل 52.5% للمطالبات الغامضة.',
      dateModified: '2026-08-31',
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'بيانات اختبار PromptQuorum: أنتجت البرومبتات المنظمة في خطوة واحدة مخرجاً بالتنسيق الصحيح في 38/40 حالة مقابل 21/40 للجمل المبهمة (GPT-5.6 وClaude Opus 5 وGemini 3.1 Pro)',
            ...
            'الطريقة تعمل بشكل متطابق مع GPT-5.6 وClaude Opus 5 وGemini 3.1 Pro والنماذج المحلية (Ollama وLM Studio)',
          ],
        },
        tldrBox: {
          isTldr: true,
          content: [
            '> **TL;DR:** أدرج الدور والهدف والسياق والقيود وتنسيق المخرج في رسالة واحدة. اختبر على 3-5 أمثلة. احفظ كقالب قابل لإعادة الاستخدام. هذا النهج في خطوة واحدة حقّق 95٪ في التنسيق الصحيح مع GPT-5.6 وClaude Opus 5 وGemini 3.1 Pro مقابل 52.5٪ للبرومبتات المبهمة. ابدأ هنا لأي مهمة؛ انتقل إلى CO-STAR أو CRAFT فقط عند الحاجة إلى تحكم مستقل في النبرة أو الجمهور أو الأسلوب.',
          ],
        },
        quickFacts: {
          title: 'حقائق سريعة',
        ...
        whySingleStepWorks: {
          ...
          callouts: [
            { type: '🔍', label: 'اختبار 38/40', text: 'في اختبارات PromptQuorum، أُرسلت 40 برومبت تلخيص إلى GPT-5.6 وClaude Opus 5 وGemini 3.1 Pro. أنتجت برومبتات الخطوة الواحدة المنظمة مخرجاً بالتنسيق الصحيح في 38 من 40 حالة. المهام نفسها كجمل مبهمة حصلت على 21 من 40. البنية وحدها كادت تُضاعف معدل النجاح.' },
          ],
        },
        fiveBlocks: {
        ...
        howPQImplements: {
          ...
          items: [
            ...
            'يُطبّق البرومبت المنظم نفسه على نماذج متعددة في آنٍ واحد، بما في ذلك GPT-5.6 وClaude Opus 5 وGemini 3.1 Pro والنماذج المحلية المكوَّنة عبر Ollama أو LM Studio.',
        ...
        faqSection: {
          ...
          faqs: [
            { q: 'كيف تختلف طريقة البرومبت في خطوة واحدة عن مجرد إعطاء تعليمة؟', a: 'مع الخطوة الواحدة، تحصل على اتساق هيكلي. بدلاً من استجابة مرة واحدة، تحصل على نفس جودة النتائج في كل مرة لأن النموذج يتّبع قيوداً وتنسيقاً ثابتَين. هذا يجعل النتائج قابلة للمقارنة عبر النماذج وقابلة للتكرار مع مرور الوقت.' },
            { q: 'متى يجب استخدام الخطوة الواحدة بدلاً من البرومبت متعدد الخطوات (Chain-of-Thought)؟', a: 'استخدم الخطوة الواحدة عندما يكون هدفك واضحاً ومحدداً جيداً. فضّل البرومبت متعدد الخطوات للمهام الغامضة أو الاستكشافية حيث تحتاج رؤية عملية استدلال النموذج.' },
            { q: 'هل يمكن استخدام الخطوة الواحدة مع النماذج المحلية مثل Ollama أو LM Studio؟', a: 'نعم، بالتأكيد. طريقة البرومبت في خطوة واحدة تعمل مع أي نموذج — GPT-5.6 وClaude Opus 5 وGemini 3.1 Pro أو النماذج المحلية عبر Ollama وLM Studio. نفس البنية الواحدة تنطبق على جميع المنصات.' },
            { q: 'كم يستغرق كتابة وتحسين برومبت جيد في خطوة واحدة؟', a: 'عادةً 15-30 دقيقة للنسخة الأولى المتينة. اكتب مسودة، اختبرها على 3-5 أمثلة، حسّن الأجزاء التي لا تعمل، ثم استخدمها. الاستثمار الأولي يُستعاد بسرعة لأنك ستُعيد استخدامها عشرات المرات.' },
            { q: 'هل يمكن حفظ برومبتات الخطوة الواحدة كقوالب في PromptQuorum؟', a: 'نعم. بمجرد إنشاء برومبت الخطوة الواحدة الذي يعمل بشكل جيد لسير عمل محدد (مثل مراجعات الكود أو ملخصات العملاء)، يمكن حفظه كقالب في PromptQuorum ومشاركته مع فريقك.' },
            { q: 'ماذا لو كانت مهمتي معقدة جداً للخطوة الواحدة؟', a: 'إذا لم تستطع تحديد مهمتك بوضوح في تعليمة واحدة، أو كنت تحتاج فعلاً إلى تعديات متعددة من النموذج، انتقل إلى APE أو CRAFT.' },
            { q: 'كيف أعرف أن برومبت الخطوة الواحدة يعمل بشكل جيد؟', a: 'شغّله على 5-10 أمثلة تمثيلية وتحقق: (1) هل تتّبع النتائج التنسيق المحدد؟ (2) هل يعكس المحتوى الدور والنبرة المحددَين؟ (3) هل تُحترم القيود مثل عدد الكلمات؟ إذا فشل أي منها، حسّن وأعد الاختبار.' },
            { q: 'هل هناك فرق أداء بين الخطوة الواحدة وAPE في المهمة نفسها؟', a: 'في مهمة بسيطة بهدف واضح، عادةً ما تُنتج الخطوة الواحدة نتائج مطابقة بجزء من الرموز. APE يُضيف عبئاً لإظهار الاستدلال — القيمة تكمن في القدرة على فحص أفكار النموذج وتحسينها.' },
            { q: 'كيف أُكيّف الخطوة الواحدة لفريق متعدد اللغات أو موزّع؟', a: 'احفظ قالب الخطوة الواحدة في PromptQuorum مع تعليمات واضحة حول علامات الموضع (المتغيرات) مقابل القيم الثابتة. وثّق توقعات التنسيق والحالات الحافة. يمكن لأعضاء الفريق حينئذٍ ملء المتغيرات وتشغيل البرومبت المتطابق.' },
            { q: 'ما الذي يجب مراعاته عند استخدام برومبتات الخطوة الواحدة مع بيانات العملاء؟', a: 'وثّق أي برومبت عالج أي بيانات عميل (لمسارات التدقيق). استخدم علامات موضع للبيانات الحساسة؛ املأها فقط في وقت التشغيل. لمعالجة البيانات المنظَّمة، قد تحتاج إلى اتفاقية معالجة بيانات مع مزوّد الذكاء الاصطناعي وتقييم أثر الخصوصية.' },
            { q: 'هل يمكن للشركات الصغيرة توحيد برومبتات الخطوة الواحدة للعمليات المتكررة؟', a: 'نعم — هذه نقطة قوة مركزية للخطوة الواحدة. قنّن البرومبت في مؤسستك، احفظه في PromptQuorum، ويمكن للموظفين الجدد إنتاج مخرجات عالية الجودة (العروض والتقارير) دون تدريب. هذا ذو قيمة خاصة للتوسّع دون تكرار القالب.' },
            { q: 'ما يجب أن يكون أول برومبت الخطوة الواحدة لي؟', a: 'ابدأ بمهمة تُنجزها بانتظام (بريد إلكتروني أو ملخص أو مراجعة كود أو تقرير). اكتب برومبتاً يلتقط الدور والهدف والسياق والقيود والتنسيق. اختبره على 3 أمثلة حقيقية. احفظه. هذا هو خط أساسك — حسّنه فصلياً مع تعلّمك ما يعمل.' },
            { q: 'هل يمكن استخدام الخطوة الواحدة للمهام الإبداعية؟', a: 'نعم. كلما أضفت قيوداً أكثر (النبرة والجمهور والطول والبنية)، كان أفضل. للعمل الإبداعي المفتوح حقاً، استخدم إطاراً مختلفاً مثل CRAFT.' },
            { q: 'كيف تساعدني PromptQuorum على استخدام الخطوة الواحدة بشكل موسّع؟', a: 'PromptQuorum تُتيح لك هيكلة لبنات البناء الخمس في نموذج مُوجَّه، واختبار البرومبت نفسه عبر النماذج في آنٍ واحد، وحفظ البرومبتات الناجحة كقوالب ومشاركتها مع فريقك وإصدارها — مُحوّلةً برومبتات فردية إلى أصول للفريق.' },
          ],
        },
        relatedReading: {
        ...
        sources: {
          ...
          items: [
            ...
            '[PromptQuorum Testing Database. 2026.](https://www.promptquorum.com) — معايير داخلية: 38/40 برومبت منظم مقابل 21/40 برومبت مبهم على GPT-5.6 وClaude Opus 5 وGemini 3.1 Pro.',
            ...
            '[OpenAI. "Prompt Engineering Best Practices." 2024.](https://platform.openai.com/docs/guides/prompt-engineering) — نهج OpenAI للبرومبتات المنظمة لـ GPT-5.6 والنماذج السابقة.',
          ],
        },
      },
      faqSchema: {
        ...
        mainEntity: [
          {
            '@type': 'Question',
            'name': 'كيف تختلف طريقة البرومبت في خطوة واحدة عن مجرد إعطاء تعليمة؟',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'مع الخطوة الواحدة، تحصل على اتساق هيكلي. بدلاً من استجابة مرة واحدة، تحصل على نفس جودة النتائج في كل مرة لأن النموذج يتّبع قيوداً وتنسيقاً ثابتَين. هذا يجعل النتائج قابلة للمقارنة عبر النماذج وقابلة للتكرار مع مرور الوقت.',
            },
          },
          {
            '@type': 'Question',
            'name': 'متى يجب استخدام الخطوة الواحدة بدلاً من البرومبت متعدد الخطوات (Chain-of-Thought)؟',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'استخدم الخطوة الواحدة عندما يكون هدفك واضحاً ومحدداً جيداً. فضّل البرومبت متعدد الخطوات للمهام الغامضة أو الاستكشافية حيث تحتاج رؤية عملية استدلال النموذج.',
            },
          },
          {
            '@type': 'Question',
            'name': 'هل يمكن استخدام الخطوة الواحدة مع النماذج المحلية مثل Ollama أو LM Studio؟',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'نعم، بالتأكيد. طريقة البرومبت في خطوة واحدة تعمل مع أي نموذج — GPT-5.6 وClaude Opus 5 وGemini 3.1 Pro أو النماذج المحلية عبر Ollama وLM Studio. نفس البنية الواحدة تنطبق على جميع المنصات.',
            },
          },
          {
            '@type': 'Question',
            'name': 'كم يستغرق كتابة وتحسين برومبت جيد في خطوة واحدة؟',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'عادةً 15-30 دقيقة للنسخة الأولى المتينة. اكتب مسودة، اختبرها على 3-5 أمثلة، حسّن الأجزاء التي لا تعمل، ثم استخدمها. الاستثمار الأولي يُستعاد بسرعة لأنك ستُعيد استخدامها عشرات المرات.',
            },
          },
          {
            '@type': 'Question',
            'name': 'هل يمكن حفظ برومبتات الخطوة الواحدة كقوالب في PromptQuorum؟',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'نعم. بمجرد إنشاء برومبت الخطوة الواحدة الذي يعمل بشكل جيد لسير عمل محدد (مثل مراجعات الكود أو ملخصات العملاء)، يمكن حفظه كقالب في PromptQuorum ومشاركته مع فريقك.',
            },
          },
          {
            '@type': 'Question',
            'name': 'ماذا لو كانت مهمتي معقدة جداً للخطوة الواحدة؟',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'إذا لم تستطع تحديد مهمتك بوضوح في تعليمة واحدة، أو كنت تحتاج فعلاً إلى تعديات متعددة من النموذج، انتقل إلى APE أو CRAFT.',
            },
          },
          {
            '@type': 'Question',
            'name': 'كيف أعرف أن برومبت الخطوة الواحدة يعمل بشكل جيد؟',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'شغّله على 5-10 أمثلة تمثيلية وتحقق: (1) هل تتّبع النتائج التنسيق المحدد؟ (2) هل يعكس المحتوى الدور والنبرة المحددَين؟ (3) هل تُحترم القيود مثل عدد الكلمات؟ إذا فشل أي منها، حسّن وأعد الاختبار.',
            },
          },
          {
            '@type': 'Question',
            'name': 'هل هناك فرق أداء بين الخطوة الواحدة وAPE في المهمة نفسها؟',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'في مهمة بسيطة بهدف واضح، عادةً ما تُنتج الخطوة الواحدة نتائج مطابقة بجزء من الرموز. APE يُضيف عبئاً لإظهار الاستدلال — القيمة تكمن في القدرة على فحص أفكار النموذج وتحسينها.',
            },
          },
          {
            '@type': 'Question',
            'name': 'كيف أُكيّف الخطوة الواحدة لفريق متعدد اللغات أو موزّع؟',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'احفظ قالب الخطوة الواحدة في PromptQuorum مع تعليمات واضحة حول علامات الموضع (المتغيرات) مقابل القيم الثابتة. وثّق توقعات التنسيق والحالات الحافة. يمكن لأعضاء الفريق حينئذٍ ملء المتغيرات وتشغيل البرومبت المتطابق.',
            },
          },
          {
            '@type': 'Question',
            'name': 'ما الذي يجب مراعاته عند استخدام برومبتات الخطوة الواحدة مع بيانات العملاء؟',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'وثّق أي برومبت عالج أي بيانات عميل (لمسارات التدقيق). استخدم علامات موضع للبيانات الحساسة؛ املأها فقط في وقت التشغيل. لمعالجة البيانات المنظَّمة، قد تحتاج إلى اتفاقية معالجة بيانات مع مزوّد الذكاء الاصطناعي وتقييم أثر الخصوصية.',
            },
          },
          {
            '@type': 'Question',
            'name': 'هل يمكن للشركات الصغيرة توحيد برومبتات الخطوة الواحدة للعمليات المتكررة؟',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'نعم — هذه نقطة قوة مركزية للخطوة الواحدة. قنّن البرومبت في مؤسستك، احفظه في PromptQuorum، ويمكن للموظفين الجدد إنتاج مخرجات عالية الجودة (العروض والتقارير) دون تدريب. هذا ذو قيمة خاصة للتوسّع دون تكرار القالب.',
            },
          },
          {
            '@type': 'Question',
            'name': 'ما يجب أن يكون أول برومبت الخطوة الواحدة لي؟',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'ابدأ بمهمة تُنجزها بانتظام (بريد إلكتروني أو ملخص أو مراجعة كود أو تقرير). اكتب برومبتاً يلتقط الدور والهدف والسياق والقيود والتنسيق. اختبره على 3 أمثلة حقيقية. احفظه. هذا هو خط أساسك — حسّنه فصلياً مع تعلّمك ما يعمل.',
            },
          },
          {
            '@type': 'Question',
            'name': 'هل يمكن استخدام الخطوة الواحدة للمهام الإبداعية؟',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'نعم. كلما أضفت قيوداً أكثر (النبرة والجمهور والطول والبنية)، كان أفضل. للعمل الإبداعي المفتوح حقاً، استخدم إطاراً مختلفاً مثل CRAFT.',
            },
          },
          {
            '@type': 'Question',
            'name': 'كيف تساعدني PromptQuorum على استخدام الخطوة الواحدة بشكل موسّع؟',
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'PromptQuorum تُتيح لك هيكلة لبنات البناء الخمس في نموذج مُوجَّه، واختبار البرومبت نفسه عبر النماذج في آنٍ واحد، وحفظ البرومبتات الناجحة كقوالب ومشاركتها مع فريقك وإصدارها — مُحوّلةً برومبتات فردية إلى أصول للفريق.',
            },
          },
        ],
      },
    ...
    pt: {
      freshness_tier: 'semi_annual',
      theme: 'Frameworks',
      heroImage: '/images/single-prompt-method-overview-hero-pt.webp',
      ...
      ogDescription: 'Método de Prompt de Passo Único: 5 blocos de construção, exemplos comentados e comparação com CO-STAR/RTF/SPECS. Framework padrão da PromptQuorum em todos os modelos.',
      twitterDescription: 'Um prompt. Cinco blocos de construção. A abordagem estruturada supera instruções vagas. O Método de Passo Único é o ponto de partida de todo prompt — só evolua para o CO-STAR quando precisar.',
      readTime: '8 min de leitura',
      leadAnswerBlock: 'O Método de Prompt de Passo Único é uma estrutura de prompt de uma só vez que reúne papel, objetivo, contexto, restrições e formato de saída em uma única mensagem. Nos testes da PromptQuorum, produziu saídas no formato correto em 95% dos casos em GPT-5.6, Claude Opus 5 e Gemini 3.1 Pro, contra 52,5% dos prompts vagos.',
      dateModified: '2026-08-31',
      educationalLevel: 'Intermediate',
      schema: {
        '@context': 'https://schema.org',
      ...
      sections: {
        keyTakeaways: {
          ...
          id: 'key-takeaways',
          items: [
            'O Método de Prompt de Passo Único reúne papel, objetivo, contexto, restrições e formato de saída em uma única mensagem completa — sem necessidade de conversa de múltiplos turnos',
            'Dados de teste da PromptQuorum: prompts estruturados de passo único produziram saída no formato correto em 38 de 40 casos, contra 21 de 40 dos prompts vagos de uma linha (GPT-5.6, Claude Opus 5, Gemini 3.1 Pro)',
            'Cinco blocos de construção: papel, objetivo, contexto, restrições e formato de saída — todo prompt de passo único eficaz contém os cinco',
            'Comece pelo Passo Único em qualquer tarefa nova; mude para CO-STAR, CRAFT ou TRACE apenas quando encontrar uma limitação concreta',
            'Salve os prompts que funcionam como modelos reutilizáveis — eles são ativos da equipe, não mensagens de chat descartáveis',
            'O método funciona de forma idêntica em GPT-5.6, Claude Opus 5, Gemini 3.1 Pro e modelos locais (Ollama, LM Studio)',
          ],
        },
        quickFacts: {
          title: 'Dados rápidos',
          id: 'quick-facts',
          numberedItems: [
            '**Prompts estruturados de passo único:** 95% de saídas no formato correto (38/40) em 3 modelos nos testes da PromptQuorum',
            '**Prompts vagos de uma linha:** 52,5% de saídas no formato correto (21/40) nas mesmas tarefas',
            '**Cinco blocos de construção:** papel, objetivo, contexto, restrições, formato de saída',
            '**Faixa de tamanho útil:** de 50 palavras (tarefas simples) a mais de 500 palavras (tarefas complexas)',
            '**Framework padrão:** o Passo Único é o padrão na PromptQuorum e o ponto de partida recomendado para novos usuários',
            '**Funciona com:** GPT-5.6, Claude Opus 5, Gemini 3.1 Pro e modelos locais (Ollama, LM Studio)',
            '**Retorno do modelo reutilizável:** 20 minutos investidos em um prompt economizam mais de 10 minutos por uso. Um prompt usado 50 vezes se paga já nos 5 primeiros usos.',
            '**Eficiência de tokens:** prompts de passo único custam de 30% a 40% menos tokens do que conversas de ida e volta que chegam ao mesmo resultado',
            '**Testabilidade:** prompts estruturados permitem testes A/B entre modelos, versões e parâmetros de um jeito que prompts conversacionais não permitem',
          ],
        },
        tldr: {
          id: 'key-takeaways',
          ...
          items: [
            ...
            'Funciona com GPT-5.6, Claude Opus 5, Gemini 3.1 Pro e modelos locais via Ollama ou LM Studio.',
          ],
        },
        whatIsMethod: {
        ...
        whySingleStepWorks: {
          title: 'Por que o Passo Único supera o prompt incremental',
          content: [
        ...
        singleVsMulti: {
          ...
          callouts: [
            { type: '🔍', label: 'Comece no Passo Único, evolua depois', text: 'O Método de Passo Único não é limitante — é fundacional. 80% das tarefas nunca precisam de um framework mais complexo. Os 20% que precisam (múltiplas restrições, raciocínio auditável, esquema rígido) avisam quando é hora de evoluir. Não comece pelo complexo.' },
          ],
        },
        howPQImplements: {
          title: 'Implementação na PromptQuorum',
          content: [
        ...
        badVsGoodExample: {
          title: 'Exemplo: prompt de passo único ruim e bom',
          content: [
        ...
        teamAsset: {
          title: 'Transformando prompts de passo único em ativo da equipe',
          content: [
          ...
          callouts: [
            { type: '🔍', label: 'O teste do modelo', text: 'Um prompt de passo único está "bom o suficiente" quando 3 pessoas diferentes conseguem usá-lo em 3 entradas diferentes e obter saídas que atendem ao mesmo padrão de qualidade. Se ele só funciona para quem o escreveu, as restrições ainda não estão específicas o bastante.' },
          ],
        },
        comparisonTable: {
          title: 'Comparação: Passo Único e outros frameworks',
          id: 'comparison-table',
          tableFormat: true,
          columns: ['Dimensão', 'Single Step', 'CO-STAR', 'CRAFT', 'SPECS', 'RTF'],
          rows: [
            { 'Dimensão': 'Complexidade', 'Single Step': 'Mínima — 5 blocos', 'CO-STAR': 'Média — 7 componentes', 'CRAFT': 'Alta — 8+ componentes', 'SPECS': 'Média — saída + regras', 'RTF': 'Mínima — 3 blocos' },
            { 'Dimensão': 'Melhor para', 'Single Step': 'Tarefas claras, primeiras tentativas', 'CO-STAR': 'Trabalho denso em contexto', 'CRAFT': 'Criativo, multidimensional', 'SPECS': 'Saída estruturada', 'RTF': 'Guiado por papel, simples' },
            { 'Dimensão': 'Tempo de preparo', 'Single Step': '10–15 min', 'CO-STAR': '20–30 min', 'CRAFT': '30–45 min', 'SPECS': '15–20 min', 'RTF': '5–10 min' },
            { 'Dimensão': 'Custo em tokens', 'Single Step': 'Baixo (1×)', 'CO-STAR': 'Médio (1,2–1,5×)', 'CRAFT': 'Médio (1,2–1,5×)', 'SPECS': 'Baixo–médio (1–1,2×)', 'RTF': 'Baixo (0,9–1×)' },
            { 'Dimensão': 'Tom e público', 'Single Step': 'Limitado (dentro do papel)', 'CO-STAR': 'Nativo (campos próprios)', 'CRAFT': 'Controle total (campos próprios)', 'SPECS': 'Nenhum', 'RTF': 'Nenhum' },
            { 'Dimensão': 'Raciocínio visível', 'Single Step': 'Não', 'CO-STAR': 'Não', 'CRAFT': 'Não', 'SPECS': 'Não', 'RTF': 'Não' },
            { 'Dimensão': 'Validação de saída', 'Single Step': 'Apenas manual', 'CO-STAR': 'Apenas manual', 'CRAFT': 'Apenas manual', 'SPECS': 'Automática (esquema)', 'RTF': 'Apenas manual' },
            { 'Dimensão': 'Reutilização', 'Single Step': 'Alta — pronta para modelo', 'CO-STAR': 'Alta — se o contexto se repete', 'CRAFT': 'Média — depende do contexto', 'SPECS': 'Alta — baseada em regras', 'RTF': 'Alta — baseada em papel' },
          ],
        },
        commonMistakes: {
          title: 'Erros comuns com prompts de passo único',
          id: 'common-mistakes',
          mistakes: [
            {
              mistake: 'Esquecer o formato de saída',
              problem: 'O modelo recorre ao formato que ele prefere — normalmente parágrafos em prosa. Se você queria JSON, tópicos ou uma tabela, precisa dizer. Pular o formato de saída é a causa número 1 do "a IA não fez o que eu queria".',
            ...
            {
              mistake: 'Escrever restrições como desejos em vez de regras',
              problem: '"Tente manter abaixo de 200 palavras" é um desejo. "Máximo de 200 palavras. Corte qualquer frase que ultrapasse esse limite" é uma regra. Modelos seguem regras; desejos eles interpretam com folga.',
              fix: 'Use linguagem absoluta: "Máximo", "Não", "Deve incluir", "Exatamente 5 itens".',
            },
            {
              mistake: 'Incluir contexto irrelevante',
              problem: 'Mais contexto nem sempre é melhor. Detalhes irrelevantes diluem a atenção do modelo. Um prompt de 500 palavras em que 200 são ruído de fundo rende menos que um prompt de 300 palavras em que cada palavra importa.',
            ...
            {
              mistake: 'Testar em um exemplo e já colocar em produção',
              problem: 'Uma saída bem-sucedida não prova que o prompt funciona. Casos extremos, entradas diferentes e modelos diferentes expõem fraquezas que um teste único esconde.',
              fix: 'Teste em 3 a 5 exemplos representativos, incluindo pelo menos 1 caso extremo, antes de salvar como modelo.',
            },
            {
              mistake: 'Nunca atualizar o prompt',
              problem: 'Requisitos mudam, modelos são atualizados, casos extremos aparecem. Um prompt que funcionava no primeiro trimestre pode render menos no segundo. Tratar prompts como definitivos é o caminho para a qualidade cair em silêncio.',
            ...
            {
              mistake: 'Confundir papel com tarefa',
              problem: 'Papel é "quem você é" (especialista, assistente, analista). Tarefa é "o que fazer" (resumir, gerar, revisar). Quando os dois se misturam, o modelo se confunde sobre a própria autoridade e perspectiva.',
            ...
            {
              mistake: 'Escrever restrições que contradizem o formato',
              problem: '"Gere um objeto JSON de 500 palavras" não faz sentido, porque JSON é dado estruturado e não prosa. Restrições contraditórias forçam o modelo a escolher entre elas, e a escolha pode não ser a que você pretendia.',
              fix: 'Alinhe restrições e formato: "Gere um resumo estruturado em JSON com os campos: topic, key-points (array), conclusion."',
            },
            {
              mistake: 'Tratar o Passo Único como método que nunca se melhora',
              problem: 'O Passo Único é mínimo, mas não estático. Encará-lo como abordagem de "configurar e esquecer" faz você perder as melhorias que só aparecem depois do primeiro uso.',
        ...
        faqSection: {
          ...
          faqs: [
            { q: 'Em que o Método de Prompt de Passo Único é diferente de simplesmente dar uma instrução?', a: 'Com o Passo Único, você obtém consistência estrutural. Em vez de uma resposta pontual, você obtém a mesma qualidade de resultado toda vez, porque o modelo segue restrições e formato fixos. Isso torna os resultados comparáveis entre modelos e reprodutíveis ao longo do tempo.' },
            { q: 'Quando devo usar o Passo Único em vez de prompting em múltiplas etapas (Chain-of-Thought)?', a: 'Use o Passo Único quando seu objetivo for claro e bem definido. Prefira o prompting em múltiplas etapas para tarefas ambíguas ou exploratórias em que você precise ver o processo de raciocínio do modelo.' },
            { q: 'Posso usar o Passo Único com modelos locais como Ollama ou LM Studio?', a: 'Sim, sem restrições. O Método de Prompt de Passo Único funciona com qualquer modelo — GPT-5.6, Claude Opus 5, Gemini 3.1 Pro ou modelos locais via Ollama e LM Studio. A mesma estrutura única se aplica a todas as plataformas.' },
            { q: 'Quanto tempo leva para escrever e refinar um bom Prompt de Passo Único?', a: 'Normalmente 15–30 minutos para uma primeira versão sólida. Escreva um rascunho, teste-o em 3–5 exemplos, refine as partes que não funcionam e então use-o. O investimento inicial se paga rapidamente, já que você o reutilizará dezenas de vezes.' },
            { q: 'Posso salvar meus Prompts de Passo Único como templates no PromptQuorum?', a: 'Sim. Depois de criar um Prompt de Passo Único que funcione bem para um fluxo de trabalho específico (por exemplo, revisões de código, resumos de clientes), você pode salvá-lo como template no PromptQuorum e compartilhá-lo com sua equipe.' },
            { q: 'E se minha tarefa for complexa demais para o Passo Único?', a: 'Se você não conseguir especificar claramente sua tarefa em uma única instrução, ou se realmente precisar de múltiplas passagens do modelo, mude para APE ou CRAFT.' },
            { q: 'Como sei se meu Prompt de Passo Único está funcionando bem?', a: 'Execute-o em 5–10 exemplos representativos e verifique: (1) Os resultados seguem o formato especificado? (2) O conteúdo reflete o papel e o tom especificados? (3) Restrições como contagem de palavras são respeitadas? Se algo falhar, refine e teste novamente.' },
            { q: 'Há diferença de desempenho entre o Passo Único e o APE na mesma tarefa?', a: 'Em uma tarefa simples com objetivo claro, o Passo Único normalmente produz resultados idênticos com uma fração dos tokens. O APE adiciona overhead para mostrar o raciocínio — o valor está em poder inspecionar e refinar os pensamentos do modelo.' },
            { q: 'Como adapto o Passo Único para uma equipe multilíngue ou distribuída?', a: 'Salve o template de Passo Único no PromptQuorum com instruções claras sobre placeholders (variáveis) e valores fixos. Documente as expectativas de formato e os casos extremos. Os membros da equipe podem então preencher as variáveis e executar o prompt idêntico.' },
            { q: 'O que devo observar ao usar Prompts de Passo Único com dados de clientes?', a: 'Documente qual prompt processou quais dados de clientes (para trilhas de auditoria). Use placeholders para dados sensíveis; preencha-os apenas em tempo de execução. Para processamento de dados regulado, você pode precisar de um Acordo de Processamento de Dados com seu provedor de IA e uma Avaliação de Impacto à Proteção de Dados.' },
            { q: 'Pequenas e médias empresas podem padronizar Prompts de Passo Único para processos repetitivos?', a: 'Sim — essa é uma força central do Passo Único. Padronize o prompt na sua organização, salve-o no PromptQuorum, e novos colaboradores podem produzir resultados de alta qualidade (propostas, relatórios) sem treinamento. Isso é especialmente valioso para escalar sem dobrar o quadro de funcionários.' },
            { q: 'Qual deve ser meu primeiro Prompt de Passo Único?', a: 'Comece com uma tarefa que você faz regularmente (e-mail, resumo, revisão de código, relatório). Escreva um prompt que capture papel, objetivo, contexto, restrições e formato. Teste em 3 exemplos reais. Salve-o. Essa é sua linha de base — melhore-a trimestralmente conforme aprende o que funciona.' },
            { q: 'Posso usar o Passo Único para tarefas criativas?', a: 'Sim. Quanto mais restrições você adicionar (tom, audiência, extensão, estrutura), melhor. Para trabalho criativo verdadeiramente aberto, use um framework diferente, como o CRAFT.' },
            { q: 'Como o PromptQuorum me ajuda a usar o Passo Único em escala?', a: 'O PromptQuorum permite estruturar os cinco blocos de construção em um formulário guiado, testar o mesmo prompt em vários modelos em paralelo, salvar prompts que funcionam como templates, compartilhar templates com sua equipe e versionar seus prompts — transformando prompts individuais em ativos da equipe.' },
          ],
        },
        relatedReading: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Posso usar o Passo Único com modelos locais como Ollama ou LM Studio?', acceptedAnswer: { '@type': 'Answer', text: 'Sim, sem restrições. O Método de Prompt de Passo Único funciona com qualquer modelo — GPT-5.6, Claude Opus 5, Gemini 3.1 Pro ou modelos locais via Ollama e LM Studio. A mesma estrutura única se aplica a todas as plataformas.' } },
    ...
    fr: {
      freshness_tier: 'semi_annual',
      theme: 'Frameworks',
      heroImage: '/images/single-prompt-method-overview-hero-fr.webp',
      ...
      leadAnswerBlock: 'La méthode Single Step est une structure de prompt en un seul envoi qui regroupe rôle, objectif, contexte, contraintes et format de sortie dans un unique message. Lors des tests PromptQuorum, elle a produit une sortie au bon format dans 95 % des cas sur GPT-5.6, Claude Opus 5 et Gemini 3.1 Pro, contre 52,5 % pour les prompts vagues.',
      dateModified: '2026-08-31',
      educationalLevel: 'Intermediate',
      schema: {
        '@context': 'https://schema.org',
      ...
      sections: {
        keyTakeaways: {
          ...
          id: 'key-takeaways',
          items: [
            'La méthode Single Step regroupe rôle, objectif, contexte, contraintes et format de sortie dans un seul message complet — aucune conversation multi-tours nécessaire',
            'Données de test PromptQuorum : les prompts structurés en une étape ont produit une sortie au bon format dans 38 cas sur 40, contre 21 sur 40 pour des instructions vagues (GPT-5.6, Claude Opus 5, Gemini 3.1 Pro)',
            'Cinq blocs de construction : rôle, objectif, contexte, contraintes, format de sortie — tout prompt Single Step efficace contient les cinq',
            'Commencez par Single Step pour toute nouvelle tâche ; passez à CO-STAR, CRAFT ou TRACE uniquement lorsque vous rencontrez une limite précise',
            'Enregistrez les prompts qui fonctionnent comme modèles réutilisables : ce sont des actifs d\'équipe, pas des messages de chat jetables',
            'La méthode fonctionne de façon identique sur GPT-5.6, Claude Opus 5, Gemini 3.1 Pro et les modèles locaux (Ollama, LM Studio)',
          ],
        },
        tldrBox: {
          isTldr: true,
          content: [
            '> **En bref :** regroupez rôle, objectif, contexte, contraintes et format de sortie dans un seul message. Testez sur 3 à 5 exemples. Enregistrez le résultat comme modèle réutilisable. Cette approche en une étape a atteint 95 % de sorties au bon format sur GPT-5.6, Claude Opus 5 et Gemini 3.1 Pro, contre 52,5 % pour des prompts vagues. Commencez ici pour toute tâche ; passez à CO-STAR ou CRAFT seulement lorsque vous avez besoin d\'un contrôle indépendant du ton, de l\'audience ou du style.',
          ],
        },
        quickFacts: {
          ...
          id: 'quick-facts',
          numberedItems: [
            '**Prompts Single Step structurés :** 95 % de sorties au bon format (38/40) sur 3 modèles lors des tests PromptQuorum',
            '**Prompts vagues d\'une ligne :** 52,5 % de sorties au bon format (21/40) sur les mêmes tâches',
            '**Cinq blocs de construction :** rôle, objectif, contexte, contraintes, format de sortie',
            '**Longueur utile :** de 50 mots (tâches simples) à plus de 500 mots (tâches complexes)',
            '**Framework par défaut :** Single Step est le framework par défaut de PromptQuorum et le point de départ recommandé pour les nouveaux utilisateurs',
            '**Compatible avec :** GPT-5.6, Claude Opus 5, Gemini 3.1 Pro et les modèles locaux (Ollama, LM Studio)',
            '**Rentabilité du modèle :** 20 minutes investies dans un prompt font gagner plus de 10 minutes par utilisation. Un prompt utilisé 50 fois est rentabilisé dès les 5 premières utilisations.',
            '**Efficacité en tokens :** les prompts Single Step coûtent 30 à 40 % de tokens en moins que les échanges multi-tours aboutissant au même résultat',
            '**Testabilité :** les prompts structurés permettent des tests A/B entre modèles, versions et paramètres, ce que les prompts conversationnels ne permettent pas',
          ],
        },
        whatIsSingleStep: {
        ...
        comparisonTable: {
          title: 'Comparaison : Single Step et les autres frameworks',
          id: 'comparison-table',
          tableFormat: true,
          columns: ['Dimension', 'Single Step', 'CO-STAR', 'CRAFT', 'SPECS', 'RTF'],
          rows: [
            { 'Dimension': 'Complexité', 'Single Step': 'Minimale — 5 blocs', 'CO-STAR': 'Moyenne — 7 composants', 'CRAFT': 'Élevée — 8+ composants', 'SPECS': 'Moyenne — sortie + règles', 'RTF': 'Minimale — 3 blocs' },
            { 'Dimension': 'Idéal pour', 'Single Step': 'Tâches claires, premiers essais', 'CO-STAR': 'Travail riche en contexte', 'CRAFT': 'Créatif, multidimensionnel', 'SPECS': 'Sortie structurée', 'RTF': 'Basé sur le rôle, simple' },
            { 'Dimension': 'Mise en place', 'Single Step': '10–15 min', 'CO-STAR': '20–30 min', 'CRAFT': '30–45 min', 'SPECS': '15–20 min', 'RTF': '5–10 min' },
            { 'Dimension': 'Coût en tokens', 'Single Step': 'Faible (1×)', 'CO-STAR': 'Moyen (1,2–1,5×)', 'CRAFT': 'Moyen (1,2–1,5×)', 'SPECS': 'Faible–moyen (1–1,2×)', 'RTF': 'Faible (0,9–1×)' },
            { 'Dimension': 'Ton et audience', 'Single Step': 'Limité (dans le rôle)', 'CO-STAR': 'Intégré (champs dédiés)', 'CRAFT': 'Contrôle total (champs dédiés)', 'SPECS': 'Aucun', 'RTF': 'Aucun' },
            { 'Dimension': 'Raisonnement visible', 'Single Step': 'Non', 'CO-STAR': 'Non', 'CRAFT': 'Non', 'SPECS': 'Non', 'RTF': 'Non' },
            { 'Dimension': 'Validation de sortie', 'Single Step': 'Manuelle uniquement', 'CO-STAR': 'Manuelle uniquement', 'CRAFT': 'Manuelle uniquement', 'SPECS': 'Automatique (schéma)', 'RTF': 'Manuelle uniquement' },
            { 'Dimension': 'Réutilisabilité', 'Single Step': 'Élevée — prête à modéliser', 'CO-STAR': 'Élevée — si contexte répété', 'CRAFT': 'Moyenne — dépend du contexte', 'SPECS': 'Élevée — basée sur des règles', 'RTF': 'Élevée — basée sur le rôle' },
          ],
        },
        commonMistakes: {
          title: 'Erreurs courantes avec les prompts Single Step',
          id: 'common-mistakes',
          mistakes: [
            {
              mistake: 'Oublier le format de sortie',
              problem: 'Le modèle adopte alors le format qu\'il préfère — en général des paragraphes en prose. Si vous vouliez du JSON, des puces ou un tableau, il faut le dire. Omettre le format de sortie est la première cause du « l\'IA n\'a pas fait ce que je voulais ».',
            ...
            {
              mistake: 'Écrire les contraintes comme des souhaits plutôt que comme des règles',
              problem: '« Essayez de rester sous 200 mots » est un souhait. « Maximum 200 mots. Supprimez toute phrase qui dépasse cette limite » est une règle. Les modèles suivent les règles ; ils interprètent les souhaits librement.',
              fix: 'Utilisez un langage absolu : « Maximum », « Ne pas », « Doit inclure », « Exactement 5 éléments ».',
            },
            {
              mistake: 'Inclure du contexte non pertinent',
              problem: 'Plus de contexte n\'est pas toujours mieux. Les détails hors sujet diluent l\'attention du modèle. Un prompt de 500 mots dont 200 sont du bruit de fond donne de moins bons résultats qu\'un prompt de 300 mots où chaque mot compte.',
            ...
            {
              mistake: 'Tester sur un seul exemple puis déployer',
              problem: 'Une sortie réussie ne prouve pas que le prompt fonctionne. Les cas limites, les entrées différentes et les modèles différents révèlent des faiblesses qu\'un test unique masque.',
              fix: 'Testez sur 3 à 5 exemples représentatifs, dont au moins un cas limite, avant d\'enregistrer le prompt comme modèle.',
            },
            {
              mistake: 'Ne jamais mettre le prompt à jour',
              problem: 'Les exigences évoluent, les modèles sont mis à jour, de nouveaux cas limites apparaissent. Un prompt qui fonctionnait au premier trimestre peut sous-performer au second. Traiter les prompts comme définitifs, c\'est laisser la qualité se dégrader en silence.',
            ...
            {
              mistake: 'Confondre le rôle et la tâche',
              problem: 'Le rôle, c\'est « qui vous êtes » (expert, assistant, analyste). La tâche, c\'est « ce qu\'il faut faire » (résumer, générer, relire). Quand les deux se confondent, le modèle ne sait plus quelle est son autorité ni sa perspective.',
            ...
            {
              mistake: 'Écrire des contraintes qui contredisent le format',
              problem: '« Générez un objet JSON de 500 mots » n\'a pas de sens : JSON est une structure de données, pas de la prose. Des contraintes contradictoires forcent le modèle à choisir, et son choix peut ne pas être le vôtre.',
            ...
            {
              mistake: 'Traiter Single Step comme une méthode figée',
              problem: 'Single Step est minimal, pas statique. Le considérer comme une approche « à configurer puis oublier » fait manquer les améliorations qui apparaissent après les premières utilisations.',
        ...
        faqSection: {
          ...
          faqs: [
            { q: 'Comment la Méthode Single Step Prompt diffère-t-elle de simplement demander une réponse au modèle ?', a: 'Avec Single Step, vous obtennez une cohérence structurelle. Au lieu d\'une réponse unique, vous reçevez toujours la même qualité de résultat parce que le modèle respecte les contraintes fixes et le format. Cela rend les résultats comparables entre les modèles et reproductibles dans le temps.' },
            { q: 'Quand dois-je utiliser Single Step au lieu de multi-étapes (Chain-of-Thought) ?', a: 'Utilisez Single Step quand votre objectif est clair et bien défini. Préférez le prompting multi-étapes pour les tâches ambiguës ou exploratoires où vous avez besoin de voir le raisonnement intermédiaire du modèle.' },
            { q: 'Puis-je utiliser Single Step avec des modèles locaux comme Ollama ou LM Studio ?', a: 'Oui, absolument. La Méthode Single Step Prompt fonctionne avec n\'importe quel modèle — GPT-5.6, Claude Opus 5, Gemini 3.1 Pro ou modèles locaux via Ollama et LM Studio. La même structure unique s\'applique sur toutes les plates-formes.' },
            { q: 'Combien de temps faut-il pour écrire et perfectionner un bon Single Step Prompt ?', a: 'Généralement 15-30 minutes pour une première version solide. Écrivez un brouillon, testez-le sur 3-5 exemples, affinez les éléments qui fonctionnent mal, puis utilisez-le. L\'investissement initial paie rapidement car vous le réutilisez des dizaines de fois.' },
            { q: 'Puis-je sauvegarder mes Single Step Prompts comme modèles dans PromptQuorum ?', a: 'Oui. Une fois que vous créez un Single Step Prompt qui fonctionne bien pour un workflow particulier (par exemple révisions de code, résumés clients), vous pouvez le sauvegarder comme modèle dans PromptQuorum et le partager avec votre équipe.' },
            { q: 'Qu\'advient-il si ma tâche est trop complexe pour Single Step ?', a: 'Si vous trouvez que vous ne pouvez pas spécifier clairement votre tâche en une seule instruction, ou si vous avez vraiment besoin que le modèle explore plusieurs approches, basculez vers APE ou CRAFT.' },
            { q: 'Comment puis-je évaluer si mon Single Step Prompt fonctionne bien ?', a: 'Exécutez-le sur 5-10 exemples représentatifs et vérifiez : (1) Les résultats respectent-ils le format spécifié ? (2) Le contenu reflète-t-il le rôle et le ton indiqués ? (3) Les limites comme le nombre de mots sont-elles respectées ? Si des étapes échouent, affinez et testez à nouveau.' },
            { q: 'Existe-t-il une différence de performance entre Single Step et APE pour une même tâche ?', a: 'Pour une tâche simple avec objectif clair, Single Step produit généralement les mêmes résultats en une fraction du nombre de tokens. APE ajoute de la surcharge pour montrer le raisonnement — la valeur vient de pouvoir inspecter et raffiner la pensée du modèle.' },
            { q: 'Comment adapter Single Step pour une équipe multilingue ou distribuée ?', a: 'Stockez le modèle Single Step dans PromptQuorum avec des instructions claires sur les espaces réservés (variables) et les valeurs fixes. Documentez les attentes en matière de format et les cas limites. Les membres de l\'équipe peuvent alors remplir les variables et exécuter le prompt identique.' },
            { q: 'Comment la Méthode Single Step Prompt facilite-t-elle la conformité en France ?', a: 'La structure explicite et reproductible de Single Step facilite l\'audit et la documentation RGPD : vous pouvez documenter exactement quel prompt a généré chaque résultat, tracer les entrées utilisateur et démontrer la cohérence du traitement des données. C\'est un avantage majeur pour les organisations opérant sous la loi française.' },
          ],
        },
        relatedReading: {
          ...
          id: 'related-reading',
          items: [
            '[Framework CO-STAR](/fr/prompt-engineering/co-star-framework) — pour les tâches nécessitant une adaptation à l\'audience et un contrôle du ton',
            '[Framework CRAFT](/fr/prompt-engineering/craft-framework) — lorsque vous devez contrôler plusieurs variables indépendamment',
            '[Prompting Chain-of-Thought](/fr/prompt-engineering/chain-of-thought-prompting) — pour les raisonnements complexes exigeant une progression étape par étape',
            '[Tester des prompts sur plusieurs modèles](/fr/prompt-engineering/how-to-test-prompts-across-models) — méthodologie de validation de vos prompts',
            '[Framework SPECS](/fr/prompt-engineering/specs-framework) — lorsque vous devez imposer une validation stricte de la sortie',
            '[Les blocs de construction d\'un prompt](/fr/prompt-engineering/5-building-blocks-every-prompt-needs) — les composants essentiels d\'un prompt efficace',
            '[Temperature et Top-p](/fr/prompt-engineering/temperature-and-top-p-control-ai-creativity) — comment contrôler l\'aléatoire du modèle en complément de la structure du prompt',
            '[Zero-Shot et Few-Shot](/fr/prompt-engineering/zero-shot-vs-few-shot) — quand inclure des exemples dans vos prompts Single Step',
          ],
        },
        sources: {
          title: 'Sources',
          id: 'sources',
          items: [
            '[Schulhoff, S., & autres. "The Prompt Report: A Systematic Survey of Prompting Techniques." 2024.](https://arxiv.org/abs/2406.06608) — étude systématique des techniques de prompting, dont la comparaison entre instructions structurées et non structurées.',
            '[Brown, T. B., Mann, B., Ryder, N., & autres. "Language Models are Few-Shot Learners." OpenAI, 2020.](https://arxiv.org/abs/2005.14165) — recherche fondatrice sur la façon dont les modèles traitent les instructions uniques par rapport aux échanges multi-tours.',
            '[Base de tests PromptQuorum. 2026.](https://www.promptquorum.com) — benchmarks internes : 38/40 pour les prompts structurés contre 21/40 pour les prompts vagues, sur GPT-5.6, Claude Opus 5 et Gemini 3.1 Pro.',
            '[Anthropic. "Build with Claude: Prompt Engineering Guide."](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering) — documentation officielle de Claude, qui recommande des instructions complètes en amont plutôt qu\'une conversation itérative.',
            '[OpenAI. "Prompt Engineering Best Practices."](https://platform.openai.com/docs/guides/prompt-engineering) — recommandations d\'OpenAI sur la structuration des prompts : énoncer explicitement le rôle, la tâche et le format de sortie attendu.',
            '[Reynolds, L., & McDonell, K. "Prompt Programming for Large Language Models: Beyond the Few-Shot Paradigm." 2021.](https://arxiv.org/abs/2102.07350) — recherche sur la structure des prompts et les patterns de conception d\'instructions.',
          ],
        },
      },
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Puis-je utiliser Single Step avec des modèles locaux comme Ollama ou LM Studio ?', acceptedAnswer: { '@type': 'Answer', text: 'Oui, absolument. La Méthode Single Step Prompt fonctionne avec n\'importe quel modèle — GPT-5.6, Claude Opus 5, Gemini 3.1 Pro ou modèles locaux via Ollama et LM Studio. La même structure unique s\'applique sur toutes les plates-formes.' } },
...
ja: {
  freshness_tier: 'semi_annual',
  theme: 'Frameworks',
  heroImage: '/images/single-prompt-method-overview-hero-ja.webp',
  ...
  readTime: '8分で読める',
  leadAnswerBlock: 'Single Stepプロンプト法は、役割・目的・文脈・制約・出力形式を1つのメッセージにまとめるワンショットのプロンプト構造です。PromptQuorumの検証では、GPT-5.6、Claude Opus 5、Gemini 3.1 Proにおいて95%が指定形式どおりに出力され、曖昧なプロンプトの52.5%を大きく上回りました。',
  dateModified: '2026-08-31',
  educationalLevel: 'Intermediate',
  schema: {
    '@context': 'https://schema.org',
  ...
  sections: {
    keyTakeaways: {
      ...
      items: [
        ...
        'PromptQuorumのテストデータ：構造化されたSingle Stepプロンプトは38/40（95%）の成功率を達成。曖昧な1行プロンプトは21/40（52.5%）。（GPT-5.6・Claude Opus 5・Gemini 3.1 Proでの検証）',
        ...
        'このメソッドはGPT-5.6・Claude Opus 5・Gemini 3.1 Pro・ローカルモデル（Ollama・LM Studio）で同じように機能します。',
      ],
    },
    tldrBox: {
      isTldr: true,
      content: [
        '> **TL;DR：** ロール・目的・コンテキスト・制約・出力形式を1つのメッセージに統合してください。3～5つの例でテストし、再利用可能なテンプレートとして保存します。このSingle Stepアプローチは、GPT-5.6・Claude Opus 5・Gemini 3.1 Pro全体で95%の成功率を実現（曖昧なプロンプトは52.5%）。すべてのタスクではここから始めてください。トーン・対象者・スタイルの独立的な制御が必要な場合のみ、CO-STARやCRAFTに切り替えてください。',
      ],
    },
    quickFacts: {
      title: 'クイックファクト',
      ...
      numberedItems: [
        ...
        '**動作環境：** GPT-5.6・Claude Opus 5・Gemini 3.1 Pro・ローカルモデル（Ollama・LM Studio）',
      ],
    },
    whatIsSingleStep: {
      title: 'What the Single Step Prompt Method Is',
      content: [
        '**Single Step Prompt Methodは、ロール・目的・コンテキスト・制約・出力形式を1つのメッセージに凝縮する1回限りのプロンプト構造です。** AIに「一緒にブレインストーミングしましょう」と複数ターンにわたって提案する代わりに、必要な情報をすべて最初に提供します。このアプローチはGPT-5.6、Claude Opus 5、Gemini 3.1 Pro、および[Ollama](/ja/local-llms/how-to-install-ollama)やLM Studioなどのローカルモデルに対応しています。',
    ...
    comparisonTable: {
      title: '比較：Single Stepと他のフレームワーク',
      id: 'comparison-table',
      tableFormat: true,
      columns: ['項目', 'Single Step', 'CO-STAR', 'CRAFT', 'SPECS', 'RTF'],
      rows: [
        { '項目': '複雑さ', 'Single Step': '最小 — 5ブロック', 'CO-STAR': '中 — 7要素', 'CRAFT': '高 — 8要素以上', 'SPECS': '中 — 出力＋ルール', 'RTF': '最小 — 3ブロック' },
        { '項目': '適した用途', 'Single Step': '目的が明確なタスク、初回の試行', 'CO-STAR': '文脈量の多い作業', 'CRAFT': '創造的・多面的な作業', 'SPECS': '構造化された出力', 'RTF': '役割中心のシンプルな作業' },
        { '項目': '準備時間', 'Single Step': '10〜15分', 'CO-STAR': '20〜30分', 'CRAFT': '30〜45分', 'SPECS': '15〜20分', 'RTF': '5〜10分' },
        { '項目': 'トークンコスト', 'Single Step': '低（1×）', 'CO-STAR': '中（1.2〜1.5×）', 'CRAFT': '中（1.2〜1.5×）', 'SPECS': '低〜中（1〜1.2×）', 'RTF': '低（0.9〜1×）' },
        { '項目': 'トーンと読み手の制御', 'Single Step': '限定的（役割の中で指定）', 'CO-STAR': '標準搭載（専用フィールド）', 'CRAFT': '完全制御（専用フィールド）', 'SPECS': 'なし', 'RTF': 'なし' },
        { '項目': '推論過程の可視化', 'Single Step': 'なし', 'CO-STAR': 'なし', 'CRAFT': 'なし', 'SPECS': 'なし', 'RTF': 'なし' },
        { '項目': '出力の検証', 'Single Step': '手動のみ', 'CO-STAR': '手動のみ', 'CRAFT': '手動のみ', 'SPECS': '自動（スキーマ）', 'RTF': '手動のみ' },
        { '項目': '再利用性', 'Single Step': '高 — テンプレート化しやすい', 'CO-STAR': '高 — 文脈が繰り返される場合', 'CRAFT': '中 — 文脈に依存', 'SPECS': '高 — ルールベース', 'RTF': '高 — 役割ベース' },
      ],
    },
    commonMistakes: {
      title: 'Single Stepプロンプトでよくある失敗',
      id: 'common-mistakes',
      mistakes: [
        {
          mistake: '出力形式を書き忘れる',
          problem: 'モデルは自身が好む形式、通常は散文の段落を選びます。JSON、箇条書き、表が欲しいなら明示する必要があります。出力形式の指定漏れは「AIが思ったとおりに動かない」の最大の原因です。',
          fix: '出力形式の指示を必ず含めてください。例：「機能｜説明｜優先度の列を持つmarkdownの表で返してください」。',
        },
        {
          mistake: '制約を規則ではなく願望として書く',
          problem: '「200語以内に収めるようにしてください」は願望です。「最大200語。この上限を超える文は削除すること」は規則です。モデルは規則には従いますが、願望は緩く解釈します。',
          fix: '断定的な表現を使ってください：「最大」「〜しないこと」「必ず含めること」「ちょうど5項目」。',
        },
        {
          mistake: '無関係な文脈を詰め込む',
          problem: '文脈は多ければよいわけではありません。無関係な情報はモデルの注意を薄めます。500語のうち200語が背景ノイズのプロンプトは、すべての語が意味を持つ300語のプロンプトに劣ります。',
          fix: '正しい出力に必要な文脈だけを入れてください。ある文を削っても出力が変わらないなら、その文は削除します。',
        },
        {
          mistake: '1例だけ試して本番投入する',
          problem: '1回うまくいってもプロンプトが機能する証明にはなりません。エッジケース、異なる入力、異なるモデルは、単一のテストでは隠れる弱点を露呈させます。',
          fix: 'テンプレートとして保存する前に、エッジケースを1つ以上含む代表的な3〜5例で検証してください。',
        },
        {
          mistake: 'プロンプトを更新しない',
          problem: '要件は変わり、モデルは更新され、新しいエッジケースが現れます。第1四半期に機能したプロンプトが第2四半期には力を発揮しないこともあります。プロンプトを恒久的なものとして扱うと、品質は静かに劣化します。',
          fix: 'プロンプトをバージョン管理してください（v1、v2、v3）。四半期ごと、またはモデルのバージョンが変わるたびに再検証し、比較用に旧版を残します。',
        },
        {
          mistake: '役割とタスクを混同する',
          problem: '役割は「誰であるか」（専門家、アシスタント、アナリスト）、タスクは「何をするか」（要約、生成、レビュー）です。両者が曖昧になると、モデルは自らの権限と視点を見失います。',
          fix: '役割とタスクを分けて書いてください：「あなたはセキュリティ監査担当者です［役割］。このコードの脆弱性をレビューしてください［タスク］」。',
        },
        {
          mistake: '形式と矛盾する制約を書く',
          problem: '「500語のJSONオブジェクトを生成してください」は成立しません。JSONは構造化データであり散文ではないからです。矛盾する制約はモデルにどちらかを選ばせ、その選択が意図どおりとは限りません。',
          fix: '制約と形式を揃えてください：「topic、key-points（配列）、conclusionのフィールドを持つJSONで構造化された要約を生成してください」。',
        },
        {
          mistake: 'Single Stepを改善不要の手法とみなす',
          problem: 'Single Stepは最小限ですが固定的ではありません。「一度設定すれば終わり」と考えると、初回利用後に見えてくる改善の機会を逃します。',
    ...
    faqSection: {
      ...
      title: 'よくある質問',
      faqs: [
        { q: 'Single Step Prompt Methodはいつ使うべきですか？', a: 'Single Step Prompt Methodは、タスクが明確で定義されており、複数ターンの対話が必要ない場合に使用すべきです。研究要約、レポート作成、メール起案、コードレビューなど、目的と出力形式が事前に把握できている場合に理想的です。' },
        { q: 'マルチターン対話との主な違いは何ですか？', a: 'Single Stepプロンプトは、すべての情報を1回で提供し、モデルが完全な文脈で作業できるようにします。一方、マルチターン対話は段階的に情報を共有し、途中で修正や追加指示ができます。Single Stepは一貫性に優れ、マルチターンは柔軟性に優れています。' },
        { q: 'Single Stepプロンプトは複数モデルで同じ結果を出しますか？', a: 'ほぼ同じですが、完全には同一ではありません。GPT-5.6、Claude Opus 5、Gemini 3.1 Proはそれぞれ異なる訓練データと推論方法を持つため、微妙な違いが生じます。Single Stepプロンプトを使用する利点は、同じ指示で比較できるため、モデル固有の特性と品質の違いが明確になることです。' },
        { q: 'プロンプトに制約を多く追加するほど良いですか？', a: 'いいえ。制約は目的の達成に必要なものだけ含めてください。過度な制約はプロンプトを複雑にし、モデルが重要な指示を見落とす可能性があります。ベストプラクティスは、3～5個の重要な制約に焦点を当てることです。' },
        { q: 'Single Stepプロンプトをどのように改善しますか？', a: 'テストデータで3～5回実行し、失敗したケースを集めます。失敗のパターンから、プロンプトの曖昧な部分を特定し、具体的な例または追加の制約で改善します。その後、改善版を元のテストセットで再実行し、品質が向上したか確認します。' },
        { q: 'Single Stepプロンプトをチーム全体で共有するにはどうしますか？', a: 'PromptQuorumのテンプレート機能を使用して、成功したプロンプトを保存し、チームメンバーと共有します。テンプレートは実行時に変更できるプレースホルダー（たとえば {{customer_name}}）を含み、固定部分は変更できないようにします。' },
        { q: 'Single Stepプロンプトがうまく機能しない場合はどうしますか？', a: 'これは通常、ロール・コンテキスト・制約のいずれかが不十分または曖昧であることを示しています。失敗した出力例を見直し、モデルが何を誤解したかを特定します。次に、その特定の誤解を防ぐための例または制約を追加します。' },
        { q: 'Single Stepプロンプトはローカルモデル（Ollama、LM Studio）で動作しますか？', a: 'はい。Single Stepプロンプトはモデルに依存しない構造なため、GPT-5.6、Claude、Gemini、Ollama、LM Studioなど、すべてのLLMで動作します。ただし、より小さなモデルは複雑なプロンプトでパフォーマンスが低下する可能性があるため、制約はシンプルかつ明確に保つことが重要です。' },
        { q: 'Single Stepプロンプトのコストはマルチターン対話と比べてどうですか？', a: 'Single Stepプロンプトは通常、トークンの総使用量が少なく、コストが低いです。複数ターンの対話では、各ターンで完全な会話履歴がコンテキストに含まれるため、トークン数が増加します。Single Stepの1つのプロンプトは、複数ターンを通じた合計トークン数より少なくなるのが一般的です。' },
        { q: '日本企業でSingle Step Promptを導入するメリットは何ですか？', a: '日本企業では、品質管理（QA）とドキュメント標準化の強い需要があります。Single Stepプロンプトを導入することで、全チームが同じ品質基準のアウトプットを生成でき、新入社員の育成期間を短縮でき、多言語対応製品の開発スピードが向上します。特にグローバル企業と日本国内の大規模企業において高い効果が期待できます。' },
      ],
    },
    relatedReading: {
      title: '関連記事',
      id: 'related-reading',
      items: [
        '[CO-STARフレームワーク](/ja/prompt-engineering/co-star-framework) — 読み手への適応とトーン制御が必要なタスク向け',
        '[CRAFTフレームワーク](/ja/prompt-engineering/craft-framework) — 複数の変数を個別に制御する必要がある場合',
        '[Chain-of-Thoughtプロンプティング](/ja/prompt-engineering/chain-of-thought-prompting) — 段階的な推論を要する複雑なタスク向け',
        '[複数モデルでのプロンプト検証](/ja/prompt-engineering/how-to-test-prompts-across-models) — プロンプトを複数モデルで検証する方法論',
        '[SPECSフレームワーク](/ja/prompt-engineering/specs-framework) — 厳密な出力検証と制約を課す必要がある場合',
        '[プロンプトの構成要素](/ja/prompt-engineering/5-building-blocks-every-prompt-needs) — 効果的なプロンプトを構成する中核要素',
        '[Temperatureとtop-p](/ja/prompt-engineering/temperature-and-top-p-control-ai-creativity) — プロンプト構造と併せてモデルのランダム性を制御する方法',
        '[ゼロショットと少数ショットの比較](/ja/prompt-engineering/zero-shot-vs-few-shot) — Single Stepプロンプトに例を含めるべき場面',
      ],
    },
    sources: {
      title: '出典',
      id: 'sources',
      items: [
        '[Schulhoff, S., ほか「The Prompt Report: A Systematic Survey of Prompting Techniques」2024年。](https://arxiv.org/abs/2406.06608) — 構造化された指示と非構造の指示の比較を含む、プロンプティング技法の体系的調査。',
        '[Brown, T. B., Mann, B., Ryder, N., ほか「Language Models are Few-Shot Learners」OpenAI、2020年。](https://arxiv.org/abs/2005.14165) — 単一の指示と複数ターンの指示をモデルがどう処理するかに関する基礎研究。',
        '[PromptQuorumテストデータベース。2026年。](https://www.promptquorum.com) — 社内ベンチマーク：GPT-5.6、Claude Opus 5、Gemini 3.1 Proにおいて、構造化プロンプト38/40に対し曖昧なプロンプトは21/40。',
        '[Anthropic「Build with Claude: Prompt Engineering Guide」](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering) — 対話的な反復よりも事前の完全な指示を推奨するClaude公式ドキュメント。',
        '[OpenAI「Prompt Engineering Best Practices」](https://platform.openai.com/docs/guides/prompt-engineering) — プロンプト構造に関するOpenAIの指針：役割、タスク、望ましい出力形式を明示する。',
        '[Reynolds, L., & McDonell, K.「Prompt Programming for Large Language Models: Beyond the Few-Shot Paradigm」2021年。](https://arxiv.org/abs/2102.07350) — プロンプト構造と指示設計パターンに関する研究。',
      ],
    },
  },
  howToSchema: {
  ...
  faqSchema: {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'ほぼ同じですが、完全には同一ではありません。GPT-5.6、Claude Opus 5、Gemini 3.1 Proはそれぞれ異なる訓練データと推論方法を持つため、微妙な違いが生じます。Single Stepプロンプトを使用する利点は、同じ指示で比較できるため、モデル固有の特性と品質の違いが明確になることです。',
        },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'はい。Single Stepプロンプトはモデルに依存しない構造なため、GPT-5.6、Claude、Gemini、Ollama、LM Studioなど、すべてのLLMで動作します。ただし、より小さなモデルは複雑なプロンプトでパフォーマンスが低下する可能性があるため、制約はシンプルかつ明確に保つことが重要です。',
        },
      },
      {
        '@type': 'Question',
    ...
    zh: {
      freshness_tier: 'semi_annual',
      theme: 'Frameworks',
      heroImage: '/images/single-prompt-method-overview-hero-zh.webp',
      title: '单步提示法',
      ...
      readTime: '阅读约8分钟',
      leadAnswerBlock: 'Single Step 提示词方法是一种一次性提示结构，把角色、目标、上下文、约束和输出格式集中写入一条消息。在 PromptQuorum 的测试中，它在 GPT-5.6、Claude Opus 5 和 Gemini 3.1 Pro 上的格式符合率为 95%，而模糊提示词仅为 52.5%。',
      dateModified: '2026-08-31',
      educationalLevel: 'Intermediate',
      schema: {
        '@context': 'https://schema.org',
      ...
      sections: {
        keyTakeaways: {
          ...
          id: 'key-takeaways',
          items: [
            'Single Step 方法把角色、目标、上下文、约束和输出格式打包进一条完整的消息中，无需多轮对话',
            'PromptQuorum 测试数据：结构化的单步提示词在 40 例中有 38 例产出符合格式的结果，而模糊的一句话提示词为 40 例中的 21 例（GPT-5.6、Claude Opus 5、Gemini 3.1 Pro）',
            '五个构成模块：角色、目标、上下文、约束、输出格式——每一条有效的单步提示词都包含这五项',
            '任何新任务都先用 Single Step；只有在遇到具体限制时，才切换到 CO-STAR、CRAFT 或 TRACE',
            '把可用的单步提示词保存为可复用模板——它们是团队资产，而非一次性的聊天消息',
            '该方法在 GPT-5.6、Claude Opus 5、Gemini 3.1 Pro 以及本地模型（Ollama、LM Studio）上表现一致',
          ],
        },
        tldrBox: {
          isTldr: true,
          content: [
            '> **一句话总结：** 把角色、目标、上下文、约束和输出格式写进一条消息，在 3–5 个样例上测试，然后保存为可复用模板。这种单步方式在 GPT-5.6、Claude Opus 5 和 Gemini 3.1 Pro 上的格式符合率为 95%，模糊提示词则为 52.5%。任何任务都从这里开始；只有当你需要独立控制语气、受众或风格时，才切换到 CO-STAR 或 CRAFT。',
          ],
        },
        quickFacts: {
          title: '关键数据',
          id: 'quick-facts',
          numberedItems: [
            '**结构化的 Single Step 提示词：** 在 PromptQuorum 的测试中，3 个模型上的格式符合率为 95%（38/40）',
            '**模糊的一句话提示词：** 同样任务上的格式符合率为 52.5%（21/40）',
            '**五个构成模块：** 角色、目标、上下文、约束、输出格式',
            '**有效长度区间：** 从 50 词（简单任务）到 500 词以上（复杂任务）',
            '**默认框架：** Single Step 是 PromptQuorum 的默认框架，也是新用户的推荐起点',
            '**适用范围：** GPT-5.6、Claude Opus 5、Gemini 3.1 Pro 以及本地模型（Ollama、LM Studio）',
            '**模板复用回报：** 在一条提示词上投入 20 分钟，每次使用可节省 10 分钟以上。一条使用 50 次的提示词，在前 5 次使用中即可收回成本。',
            '**令牌效率：** 达到同样结果时，Single Step 提示词比多轮往复对话少消耗 30–40% 的令牌',
            '**可测试性：** 结构化提示词支持跨模型、跨版本、跨参数的 A/B 测试，这是对话式提示词无法做到的',
          ],
        },
        whatIsSingleStep: {
          title: '什么是单步提示法',
          content: [
            '**单步提示法是一种一次性的提示结构，将角色、目标、上下文、约束条件和输出格式整合到一条给模型的单一消息中。** 不同于让AI在多轮对话中"一起头脑风暴"，单步提示法在最初就向模型提供它所需的全部信息。这种方法适用于GPT-5.6、Claude Opus 5、Gemini 3.1 Pro以及通过[Ollama](/zh/local-llms/how-to-install-ollama)或LM Studio等工具运行的本地模型。',
        ...
        comparisonTable: {
          title: '对比：Single Step 与其他框架',
          id: 'comparison-table',
          tableFormat: true,
          columns: ['维度', 'Single Step', 'CO-STAR', 'CRAFT', 'SPECS', 'RTF'],
          rows: [
            { '维度': '复杂度', 'Single Step': '最简 — 5 个模块', 'CO-STAR': '中等 — 7 个组件', 'CRAFT': '较高 — 8 个以上组件', 'SPECS': '中等 — 输出＋规则', 'RTF': '最简 — 3 个模块' },
            { '维度': '适用场景', 'Single Step': '目标明确的任务、首次尝试', 'CO-STAR': '上下文密集的工作', 'CRAFT': '创意型、多维度任务', 'SPECS': '结构化输出', 'RTF': '以角色驱动的简单任务' },
            { '维度': '准备时间', 'Single Step': '10–15 分钟', 'CO-STAR': '20–30 分钟', 'CRAFT': '30–45 分钟', 'SPECS': '15–20 分钟', 'RTF': '5–10 分钟' },
            { '维度': '令牌成本', 'Single Step': '低（1×）', 'CO-STAR': '中（1.2–1.5×）', 'CRAFT': '中（1.2–1.5×）', 'SPECS': '低至中（1–1.2×）', 'RTF': '低（0.9–1×）' },
            { '维度': '语气与受众控制', 'Single Step': '有限（在角色中指定）', 'CO-STAR': '内置（独立字段）', 'CRAFT': '完全控制（独立字段）', 'SPECS': '无', 'RTF': '无' },
            { '维度': '推理过程可见性', 'Single Step': '否', 'CO-STAR': '否', 'CRAFT': '否', 'SPECS': '否', 'RTF': '否' },
            { '维度': '输出校验', 'Single Step': '仅手动', 'CO-STAR': '仅手动', 'CRAFT': '仅手动', 'SPECS': '自动（模式约束）', 'RTF': '仅手动' },
            { '维度': '可复用性', 'Single Step': '高 — 易于模板化', 'CO-STAR': '高 — 上下文重复时', 'CRAFT': '中 — 依赖上下文', 'SPECS': '高 — 基于规则', 'RTF': '高 — 基于角色' },
          ],
        },
        commonMistakes: {
          title: 'Single Step 提示词的常见错误',
          id: 'common-mistakes',
          mistakes: [
            {
              mistake: '忘记指定输出格式',
              problem: '模型会退回到它偏好的格式，通常是散文段落。如果你想要 JSON、要点列表或表格，就必须说明。漏掉输出格式是"AI 没有按我想要的方式作答"的首要原因。',
              fix: '始终包含明确的输出格式指令。例如："以 markdown 表格返回，列为：功能 | 说明 | 优先级。"',
            },
            {
              mistake: '把约束写成愿望而非规则',
              problem: '"尽量控制在 200 字以内"是愿望；"最多 200 字，删除超出此限制的句子"是规则。模型遵守规则，但对愿望的解释比较宽松。',
              fix: '使用绝对化表述："最多""不得""必须包含""恰好 5 项"。',
            },
            {
              mistake: '塞入无关的上下文',
              problem: '上下文并非越多越好。无关细节会稀释模型的注意力。一个 500 字的提示词若有 200 字是背景噪声，效果反而不如每个字都有用的 300 字提示词。',
              fix: '只包含模型产生正确输出所需的上下文。如果删掉某句话不会改变输出，就删掉它。',
            },
            {
              mistake: '只测一个样例就上线',
              problem: '一次成功的输出并不能证明提示词可靠。边缘情况、不同输入和不同模型会暴露单次测试掩盖的弱点。',
              fix: '保存为模板前，先在 3–5 个有代表性的样例上测试，其中至少包含 1 个边缘情况。',
            },
            {
              mistake: '从不更新提示词',
              problem: '需求会变化，模型会更新，新的边缘情况会出现。第一季度好用的提示词到第二季度可能表现下滑。把提示词当作一成不变的资产，质量就会悄然退化。',
              fix: '为提示词建立版本（v1、v2、v3）。每季度或每当模型版本变更时重新测试，并保留旧版本以便对比。',
            },
            {
              mistake: '混淆角色与任务',
              problem: '角色是"你是谁"（专家、助手、分析师），任务是"要做什么"（总结、生成、评审）。两者混淆时，模型会搞不清自己的权限与视角。',
              fix: '将角色与任务分开书写："你是一名安全审计员［角色］。请评审这段代码中的漏洞［任务］。"',
            },
            {
              mistake: '约束与格式自相矛盾',
              problem: '"生成一个 500 字的 JSON 对象"讲不通，因为 JSON 是结构化数据而非散文。相互矛盾的约束会迫使模型二选一，而它的选择未必符合你的本意。',
              fix: '让约束与格式相互配合："生成结构化的 JSON 摘要，字段为：topic、key-points（数组）、conclusion。"',
            },
            {
              mistake: '把 Single Step 当作无需改进的一次性方法',
              problem: 'Single Step 精简但并非静态。若视其为"配置一次即可永久使用"的方法，就会错过首次使用后才显现的持续改进机会。',
        ...
        faqSection: {
          ...
          title: '常见问题',
          faqs: [
            { q: '单步提示法与直接向模型提问有什么区别？', a: '使用单步提示，你获得结构一致性。不是获得单一响应，你总是因为模型遵守固定约束和格式而获得相同质量的结果。这使结果在模型间可比较，并随时间可重现。' },
            { q: '我何时应该使用单步法而不是多步（Chain-of-Thought）？', a: '当你的目标明确且定义清楚时，使用单步法。对于模糊或探索性的任务，更倾向于多步提示，因为你需要看到模型的中间推理。' },
            { q: '我可以在本地模型（如Ollama或LM Studio）上使用单步提示法吗？', a: '完全可以。单步提示法与任何模型配合工作——GPT-5.6、Claude Opus 5、Gemini 3.1 Pro或通过Ollama和LM Studio的本地模型。相同的单一结构在所有平台应用。' },
            { q: '编写和完善一个好的单步提示需要多长时间？', a: '一个坚实的第一版本通常需要15-30分钟。写一个草稿，在3-5个示例上测试，改进效果不好的要素，然后使用。初始投资快速回本，因为你会重复使用它数十次。' },
            { q: '我可以在PromptQuorum中将我的单步提示保存为模板吗？', a: '可以。一旦你创建了一个对特定工作流（例如代码审查、客户总结）有效的单步提示，你可以在PromptQuorum中将其保存为模板并与你的团队共享。' },
            { q: '如果我的任务对单步法来说太复杂会怎样？', a: '如果你发现你无法清楚地在单一指令中指定你的任务，或者你确实需要模型探索多种方法，切换到APE或CRAFT。' },
            { q: '我如何评估我的单步提示是否有效？', a: '在5-10个代表性示例上运行它并检查：(1)结果是否遵守指定的格式？(2)内容是否反映了指定的角色和语气？(3)诸如字数的限制是否得到遵守？如果任何步骤失败，改进并再次测试。' },
            { q: '对于相同的任务，单步法与APE之间的性能差异有多大？', a: '对于具有明确目标的简单任务，单步法通常以少得多的令牌数量生成相同的结果。APE增加了开销来展示推理——价值来自于能够检查和改进模型的思考。' },
            { q: '如何为多语言或分布式团队调整单步法？', a: '在PromptQuorum中存储单步模板，并提供关于占位符（变量）和固定值的明确说明。文档说明格式期望和边界情况。团队成员然后可以填充变量并运行相同的提示。' },
            { q: '单步提示法如何有助于中国企业的数据合规性？', a: '在数据安全法（2021）框架下，单步提示的显式、可重现结构简化了合规性：你可以准确地文档说明哪个提示生成了每个结果，追踪用户输入，并证明数据处理的一致性。这对于在中国运营受监管产业的组织来说是主要优势。' },
          ],
        },
        relatedReading: {
          title: '延伸阅读',
          id: 'related-reading',
          items: [
            '[CO-STAR 框架](/zh/prompt-engineering/co-star-framework) — 适用于需要适配受众和控制语气的任务',
            '[CRAFT 框架](/zh/prompt-engineering/craft-framework) — 当你需要独立控制多个变量时',
            '[思维链提示](/zh/prompt-engineering/chain-of-thought-prompting) — 适用于需要逐步推理的复杂任务',
            '[跨模型测试提示词](/zh/prompt-engineering/how-to-test-prompts-across-models) — 在多个模型上验证提示词的方法论',
            '[SPECS 框架](/zh/prompt-engineering/specs-framework) — 当你需要强制执行严格的输出校验与约束时',
            '[提示词的构成要素](/zh/prompt-engineering/5-building-blocks-every-prompt-needs) — 构成有效提示词的核心组件',
            '[Temperature 与 Top-p](/zh/prompt-engineering/temperature-and-top-p-control-ai-creativity) — 如何在提示词结构之外控制模型的随机性',
            '[零样本与少样本提示对比](/zh/prompt-engineering/zero-shot-vs-few-shot) — 何时应在 Single Step 提示词中加入示例',
          ],
        },
        sources: {
          title: '参考来源',
          id: 'sources',
          items: [
            '[Schulhoff, S. 等《The Prompt Report: A Systematic Survey of Prompting Techniques》2024 年。](https://arxiv.org/abs/2406.06608) — 对提示技术的系统性综述，包含结构化指令与非结构化指令的比较。',
            '[Brown, T. B.、Mann, B.、Ryder, N. 等《Language Models are Few-Shot Learners》OpenAI，2020 年。](https://arxiv.org/abs/2005.14165) — 关于模型如何处理单条指令与多轮指令的基础研究。',
            '[PromptQuorum 测试数据库，2026 年。](https://www.promptquorum.com) — 内部基准测试：在 GPT-5.6、Claude Opus 5 和 Gemini 3.1 Pro 上，结构化提示词为 38/40，模糊提示词为 21/40。',
            '[Anthropic《Build with Claude: Prompt Engineering Guide》](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering) — Claude 官方文档，建议一次性给出完整指令而非通过对话反复迭代。',
            '[OpenAI《Prompt Engineering Best Practices》](https://platform.openai.com/docs/guides/prompt-engineering) — OpenAI 关于提示词结构的指导：明确说明角色、任务和期望的输出格式。',
            '[Reynolds, L. 与 McDonell, K.《Prompt Programming for Large Language Models: Beyond the Few-Shot Paradigm》2021 年。](https://arxiv.org/abs/2102.07350) — 关于提示词结构与指令设计模式的研究。',
          ],
        },
      },
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: '完全可以。单步提示法与任何模型配合工作——GPT-5.6、Claude Opus 5、Gemini 3.1 Pro或通过Ollama和LM Studio的本地模型。相同的单一结构在所有平台应用。',
            },
          },
          {
            '@type': 'Question',
  ...
  ko: {
      freshness_tier: 'semi_annual',
      theme: 'Frameworks',
    heroImage: '/images/single-prompt-method-overview-hero-ko.webp',
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        url: 'https://www.promptquorum.com/ko/prompt-engineering/the-single-step-prompt-method',
        inLanguage: 'ko',
        'proficiencyLevel': 'Intermediate',
        speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'PromptQuorum 테스트 데이터: 구조화된 단일 단계 프롬프트는 40건 중 38건에서 형식에 맞는 출력을 생성했으며, 모호한 한 줄짜리 프롬프트는 40건 중 21건에 그쳤습니다 (GPT-5.6, Claude Opus 5, Gemini 3.1 Pro 기준)',
            ...
            '이 방법론은 GPT-5.6, Claude Opus 5, Gemini 3.1 Pro, 그리고 로컬 모델(Ollama, LM Studio)에서 동일하게 작동합니다',
          ],
        },
        tldrBox: {
          isTldr: true,
          content: [
            '> **TL;DR:** 역할, 목표, 맥락, 제약 조건, 출력 형식을 하나의 메시지에 담으십시오. 3~5개의 예제로 테스트하고 재사용 가능한 템플릿으로 저장하십시오. 이 단일 단계 접근법은 GPT-5.6, Claude Opus 5, Gemini 3.1 Pro에서 95%의 형식 준수율을 기록했으며, 모호한 프롬프트의 52.5%에 비해 현저히 높습니다. 모든 작업에서 여기서 시작하고, 톤, 대상 독자, 스타일을 독립적으로 제어해야 할 경우에만 CO-STAR 또는 CRAFT로 전환하십시오.',
          ],
        },
        quickFacts: {
          title: '주요 수치',
          ...
          numberedItems: [
            ...
            '**호환 모델:** GPT-5.6, Claude Opus 5, Gemini 3.1 Pro, 로컬 모델(Ollama, LM Studio)',
        ...
        whySingleStepWorks: {
          ...
          callouts: [
            { type: '🔍', label: '38/40 테스트', text: 'PromptQuorum 테스트에서 40개의 요약 프롬프트를 GPT-5.6, Claude Opus 5, Gemini 3.1 Pro에 전송했습니다. 구조화된 단일 단계 프롬프트는 40건 중 38건에서 형식에 맞는 출력을 생성했습니다. 동일한 작업을 모호한 한 줄짜리 프롬프트로 수행했을 때는 40건 중 21건에 그쳤습니다. 구조화만으로 성공률이 거의 두 배로 높아졌습니다.' },
          ],
        },
        fiveBlocks: {
          title: '5가지 구성 요소',
        ...
        howPQImplements: {
          ...
          items: [
            ...
            'GPT-5.6, Claude Opus 5, Gemini 3.1 Pro, Ollama 또는 LM Studio를 통해 구성된 로컬 모델을 포함하여 동일한 구조화 프롬프트를 여러 모델에 병렬로 적용합니다.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: '네, 물론입니다. 단일 단계 프롬프트 방법론은 GPT-5.6, Claude Opus 5, Gemini 3.1 Pro, 또는 Ollama 및 LM Studio를 통한 로컬 모델 등 어떤 모델에서도 작동합니다. 동일한 단일 구조가 모든 플랫폼에 적용됩니다.',
            },
            {
            ...
            },
            {
              ...
              a: '다른 출력을 얻게 됩니다 — GPT-5.6는 verbose한 경향이 있고, Claude Opus 5은 간결하며, Gemini 3.1 Pro는 세부 지향적입니다. 이 변동성은 버그가 아니라 기능입니다. 여러 모델에서 동일한 프롬프트를 테스트하여 어떤 것이 스타일에 맞는지 확인하십시오. 모델+프롬프트 쌍을 재사용 가능한 레시피로 저장하십시오.',
            },
            {
        ...
        sources: {
          ...
          items: [
            ...
            '[PromptQuorum Testing Database. 2026.](https://www.promptquorum.com) — 내부 벤치마크: GPT-5.6, Claude Opus 5, Gemini 3.1 Pro 기준 구조화 프롬프트 38/40 vs 모호한 프롬프트 21/40.',
            ...
            '[OpenAI. "Prompt Engineering Best Practices." 2024.](https://platform.openai.com/docs/guides/prompt-engineering) — GPT-5.6 및 이전 모델에 대한 OpenAI의 구조화된 프롬프트 접근법.',
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Ollama나 LM Studio와 같은 로컬 모델에서 단일 단계를 사용할 수 있습니까?', acceptedAnswer: { '@type': 'Answer', text: '네, 물론입니다. 단일 단계 프롬프트 방법론은 GPT-5.6, Claude Opus 5, Gemini 3.1 Pro, 또는 Ollama 및 LM Studio를 통한 로컬 모델 등 어떤 모델에서도 작동합니다. 동일한 단일 구조가 모든 플랫폼에 적용됩니다.' } },
      ...
      leadAnswerBlock: 'Single Step Prompt Method(단일 단계 프롬프트 방법론)는 역할, 목표, 맥락, 제약 조건, 출력 형식을 하나의 메시지에 담는 원샷 프롬프트 구조입니다. PromptQuorum 테스트에서 GPT-5.6, Claude Opus 5, Gemini 3.1 Pro 기준 95%의 형식 준수율을 기록했으며, 모호한 프롬프트의 52.5%에 비해 현저히 높습니다.',
    },
  };
