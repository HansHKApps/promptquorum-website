...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      metaDescription: '95% دقة تنسيق في اختبارات PromptQuorum. أدرج الدور والهدف والسياق والقيود وتنسيق المخرج في رسالة واحدة منظمة وأعد استخدامها عبر GPT وClaude وOllama.',
