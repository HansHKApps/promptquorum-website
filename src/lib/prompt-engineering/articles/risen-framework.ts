...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      quickFacts: [
        ...
        'Works with any model: GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro, and local models via Ollama or LM Studio. Larger models (13B+) handle multi-step structure better; 7B models may need steps separated.',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'RISEN works with any model: GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro, Ollama, LM Studio. Larger models (13B+) handle the multi-step structure better.',
        ...
        whatIsRISEN: {
          ...
          content: [
            '**The RISEN Framework is an iterative prompt pattern designed for refining existing drafts, analyses, and plans through multiple improvement cycles.** Instead of treating each prompt as a one-off task, you guide a model like GPT-5.6, Claude Sonnet 5, or Gemini 3.1 Pro through a structured, repeatable improvement loop. This makes your workflow more like continuous editing than random trial-and-error.',
        ...
        commonMistakes: {
          ...
          mistakes: [
            ...
            },
            {
              ...
              fix: 'Use PromptQuorum to run the same RISEN cycle across GPT-5.6, Claude Sonnet 5, and Gemini 3.1 Pro. Compare which model\'s refinements best match your goals.',
            },
          ],
        },
        ...
        risenInPromptQuorum: {
          ...
          items: [
            ...
            'Send the same RISEN-based instructions to multiple models — GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro — in parallel and compare how each one refines and critiques the draft.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Yes. Use PromptQuorum to send the same RISEN cycle to GPT-5.6, Claude Sonnet 5, and Gemini 3.1 Pro simultaneously. Compare which model\'s refinements, self-critique scores, and next-step suggestions best match your requirements.',
            },
            {
        ...
        sources: {
          ...
          items: [
            ...
            'OpenAI Prompt Engineering Guide. [platform.openai.com/docs/guides/prompt-engineering](https://platform.openai.com/docs/guides/prompt-engineering) — Official prompting best practices including iterative refinement strategies.',
            'Anthropic Prompt Engineering Documentation. [docs.anthropic.com/en/docs/build-with-claude/prompt-engineering](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering) — Claude-specific guidance on multi-step prompt workflows.',
          ],
        },
      },
      ...
      schema: {
        ...
        keywords: ['RISEN Framework', 'iterative prompting', 'prompt refinement', 'multi-step workflows', 'prompt engineering', 'PromptQuorum', 'GPT-5.6', 'Claude Sonnet 5', 'Gemini 3.1 Pro'],
        ...
        mentions: [
          ...
          { '@type': 'SoftwareApplication', name: 'Claude Sonnet 5', url: 'https://www.anthropic.com' },
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Can I combine RISEN with multi-model testing?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes. Use PromptQuorum to send the same RISEN cycle to GPT-5.6, Claude Sonnet 5, and Gemini 3.1 Pro simultaneously. Compare which model\'s refinements best match your requirements.' } },
    ...
    de: {
      ...
      quickFacts: [
        ...
        'Funktioniert mit jedem Modell: GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro und lokale Modelle über Ollama oder LM Studio. Größere Modelle (13B+) verarbeiten Multi-Schritt-Struktur besser.',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'RISEN funktioniert mit jedem Modell: GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro, Ollama, LM Studio. Größere Modelle (13B+) verarbeiten die Multi-Schritt-Struktur besser.',
        ...
        whatIsRISEN: {
          ...
          content: [
            '**Das RISEN-Framework ist ein iteratives Prompt-Muster, das für die Verfeinerung bestehender Entwürfe, Analysen und Pläne durch mehrere Verbesserungszyklen entwickelt wurde.** Anstatt jeden Prompt als Einmalaufgabe zu behandeln, führen Sie ein Modell wie GPT-5.6, Claude Sonnet 5 oder Gemini 3.1 Pro durch eine strukturierte, wiederholbare Verbesserungsschleife. Dies macht Ihren Arbeitsablauf weniger wie zufälliges Ausprobieren und mehr wie kontinuierliche Bearbeitung.',
        ...
        commonMistakes: {
          ...
          mistakes: [
            ...
            },
            {
              ...
              fix: 'Verwenden Sie PromptQuorum, um denselben RISEN-Zyklus über GPT-5.6, Claude Sonnet 5 und Gemini 3.1 Pro parallel auszuführen. Vergleichen Sie, welche Verbesserungen eines Modells am besten zu Ihren Zielen passen.',
            },
          ],
        },
        ...
        risenInPromptQuorum: {
          ...
          items: [
            ...
            'Senden Sie dieselben RISEN-basierten Anweisungen an mehrere Modelle — GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro — parallel und vergleichen Sie, wie jedes den Entwurf verfeinert und kritisiert.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Ja. Verwenden Sie PromptQuorum, um denselben RISEN-Zyklus an GPT-5.6, Claude Sonnet 5 und Gemini 3.1 Pro gleichzeitig zu senden. Vergleichen Sie, welche Modell-Verbesserungen, Selbstkritik-Bewertungen und Next-Step-Vorschläge am besten zu Ihren Anforderungen passen.',
            },
            {
        ...
        sources: {
          ...
          items: [
            ...
            'OpenAI Prompt Engineering Guide. [platform.openai.com/docs/guides/prompt-engineering](https://platform.openai.com/docs/guides/prompt-engineering) — Offizielle Prompting-Best-Practices einschließlich iterativer Verbesserungsstrategien.',
            'Anthropic Prompt Engineering Documentation. [docs.anthropic.com/en/docs/build-with-claude/prompt-engineering](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering) — Claude-spezifische Anleitung zu Multi-Schritt-Prompt-Arbeitsabläufen.',
          ],
        },
      },
      ...
      schema: {
        ...
        keywords: ['RISEN-Framework', 'iteratives Prompting', 'Prompt-Verfeinerung', 'Prompt Engineering', 'PromptQuorum', 'GPT-5.6', 'Claude Sonnet 5', 'Gemini 3.1 Pro'],
        author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
        about: [
          { '@type': 'Thing', name: 'RISEN-Framework' },
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'Kann ich RISEN mit Multi-Modell-Tests kombinieren?', 'acceptedAnswer': { '@type': 'Answer', 'text': 'Ja. Verwenden Sie PromptQuorum, um denselben RISEN-Zyklus an GPT-5.6, Claude Sonnet 5 und Gemini 3.1 Pro gleichzeitig zu senden. Vergleichen Sie, welche Modell-Verbesserungen am besten zu Ihren Anforderungen passen.' } },
    ...
    es: {
      ...
      quickFacts: [
        ...
        'Funciona con cualquier modelo: GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro y modelos locales via Ollama o LM Studio. Los modelos más grandes (13B+) manejan mejor la estructura multi-paso.',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'RISEN funciona con cualquier modelo: GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro, Ollama, LM Studio. Los modelos más grandes (13B+) manejan mejor la estructura multi-paso.',
        ...
        commonMistakes: {
          ...
          mistakes: [
            ...
            },
            {
              ...
              fix: 'Usa PromptQuorum para ejecutar el mismo ciclo RISEN en GPT-5.6, Claude Sonnet 5 y Gemini 3.1 Pro. Compara qué refinamientos del modelo mejor coinciden con tus objetivos.',
            },
          ],
        },
        ...
        risenInPromptQuorum: {
          ...
          items: [
            ...
            'Enviar las mismas instrucciones basadas en RISEN a múltiples modelos — GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro — en paralelo y comparar cómo cada uno refina y critica el borrador.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Sí. Usa PromptQuorum para enviar el mismo ciclo RISEN a GPT-5.6, Claude Sonnet 5 y Gemini 3.1 Pro simultáneamente. Compara qué refinamientos, puntuaciones de autocrítica y sugerencias de próximos pasos del modelo mejor coinciden con tus requisitos.',
            },
            {
        ...
        sources: {
          ...
          items: [
            ...
            'OpenAI Prompt Engineering Guide. [platform.openai.com/docs/guides/prompt-engineering](https://platform.openai.com/docs/guides/prompt-engineering) — Mejores prácticas oficiales de prompting incluyendo estrategias de refinamiento iterativo.',
            'Anthropic Prompt Engineering Documentation. [docs.anthropic.com/en/docs/build-with-claude/prompt-engineering](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering) — Guía específica de Claude sobre flujos de trabajo de prompts multi-paso.',
          ],
        },
      },
      ...
      schema: {
        ...
        inLanguage: 'es',
        keywords: ['Framework RISEN', 'prompting iterativo', 'refinamiento de prompts', 'flujos de trabajo multi-paso', 'prompt engineering', 'PromptQuorum', 'GPT-5.6', 'Claude Sonnet 5', 'Gemini 3.1 Pro'],
        author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
        about: [
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: '¿Puedo combinar RISEN con pruebas multi-modelo?', acceptedAnswer: { '@type': 'Answer', text: 'Sí. Usa PromptQuorum para enviar el mismo ciclo RISEN a GPT-5.6, Claude Sonnet 5 y Gemini 3.1 Pro simultáneamente. Compara qué refinamientos del modelo mejor coinciden con tus requisitos.' } },
    ...
    ar: {
      ...
      quickFacts: [
        ...
        'يعمل مع أي نموذج: GPT-5.6 وClaude Sonnet 5 وGemini 3.1 Pro والنماذج المحلية عبر Ollama أو LM Studio. النماذج الأكبر (13B+) تتعامل بشكل أفضل مع البنية متعددة الخطوات.',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'RISEN يعمل مع أي نموذج: GPT-5.6 وClaude Sonnet 5 وGemini 3.1 Pro وOllama وLM Studio. النماذج الأكبر (13B+) تتعامل بشكل أفضل مع البنية متعددة الخطوات.',
        ...
        whatIsRISEN: {
          ...
          content: [
            '**إطار RISEN هو نمط برومبت تكراري مصمم لتحسين المسودات والتحليلات والخطط القائمة من خلال دورات تحسين متعددة.** بدلاً من التعامل مع كل برومبت كمهمة لمرة واحدة، توجّه نموذجاً مثل GPT-5.6 أو Claude Sonnet 5 أو Gemini 3.1 Pro عبر حلقة تحسين منظمة وقابلة للتكرار. هذا يجعل سير عملك يشبه التحرير المستمر أكثر من المحاولة والخطأ العشوائية.',
        ...
        commonMistakes: {
          ...
          mistakes: [
            ...
            },
            {
              ...
              fix: 'استخدم PromptQuorum لتشغيل دورة RISEN نفسها على GPT-5.6 وClaude Sonnet 5 وGemini 3.1 Pro. قارن أي تحسينات النموذج تتوافق أفضل مع أهدافك.',
            },
          ],
        },
        ...
        risenInPromptQuorum: {
          ...
          items: [
            ...
            'إرسال التعليمات المستندة إلى RISEN نفسها إلى نماذج متعددة — GPT-5.6 وClaude Sonnet 5 وGemini 3.1 Pro — في آنٍ واحد ومقارنة كيف يُحسِّن كل منها وينتقد المسودة.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'نعم. استخدم PromptQuorum لإرسال دورة RISEN نفسها إلى GPT-5.6 وClaude Sonnet 5 وGemini 3.1 Pro في آنٍ واحد. قارن أي تحسينات وتقييمات ذاتية واقتراحات خطوات تالية للنموذج تتوافق أفضل مع متطلباتك.',
            },
            {
        ...
        sources: {
          ...
          items: [
            ...
            'OpenAI Prompt Engineering Guide. [platform.openai.com/docs/guides/prompt-engineering](https://platform.openai.com/docs/guides/prompt-engineering) — أفضل ممارسات البرومبت الرسمية بما في ذلك استراتيجيات التحسين التكراري.',
            'Anthropic Prompt Engineering Documentation. [docs.anthropic.com/en/docs/build-with-claude/prompt-engineering](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering) — دليل خاص بـ Claude حول سير عمل البرومبت متعدد الخطوات.',
          ],
        },
      },
      ...
      schema: {
        ...
        inLanguage: 'ar',
        keywords: ['Framework RISEN', 'برومبت تكراري', 'تحسين البرومبتات', 'سير عمل متعدد الخطوات', 'هندسة البرومبت', 'PromptQuorum', 'GPT-5.6', 'Claude Sonnet 5', 'Gemini 3.1 Pro'],
        author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
        about: [
          { '@type': 'Thing', name: 'Framework RISEN' },
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'هل يمكنني دمج RISEN مع اختبارات متعددة النماذج؟', acceptedAnswer: { '@type': 'Answer', text: 'نعم. استخدم PromptQuorum لإرسال دورة RISEN نفسها إلى GPT-5.6 وClaude Sonnet 5 وGemini 3.1 Pro في آنٍ واحد. قارن أي تحسينات النموذج تتوافق أفضل مع متطلباتك.' } },
    ...
    pt: {
      ...
      quickFacts: [
        ...
        'Funciona com qualquer modelo: GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro e modelos locais via Ollama ou LM Studio. Modelos maiores (13B+) gerenciam melhor a estrutura multi-etapa.',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'O RISEN funciona com qualquer modelo: GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro, Ollama, LM Studio. Modelos maiores (13B+) gerenciam melhor a estrutura multi-etapa.',
        ...
        commonMistakes: {
          ...
          mistakes: [
            ...
            },
            {
              ...
              fix: 'Use o PromptQuorum para executar o mesmo ciclo RISEN no GPT-5.6, Claude Sonnet 5 e Gemini 3.1 Pro. Compare quais refinamentos do modelo melhor atendem aos seus objetivos.',
            },
          ],
        },
        ...
        risenInPromptQuorum: {
          ...
          items: [
            ...
            'Envie as mesmas instruções baseadas em RISEN a múltiplos modelos — GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro — em paralelo e compare como cada um refina e critica o rascunho.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Sim. Use o PromptQuorum para enviar o mesmo ciclo RISEN ao GPT-5.6, Claude Sonnet 5 e Gemini 3.1 Pro simultaneamente. Compare quais refinamentos, pontuações de autocrítica e sugestões de próximos passos do modelo melhor atendem aos seus requisitos.',
            },
            {
        ...
        sources: {
          ...
          items: [
            ...
            'OpenAI Prompt Engineering Guide. [platform.openai.com/docs/guides/prompt-engineering](https://platform.openai.com/docs/guides/prompt-engineering) — Melhores práticas oficiais de prompting incluindo estratégias de refinamento iterativo.',
            'Anthropic Prompt Engineering Documentation. [docs.anthropic.com/en/docs/build-with-claude/prompt-engineering](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering) — Guia específico do Claude sobre fluxos de trabalho de prompts multi-etapa.',
          ],
        },
      },
      ...
      schema: {
        ...
        inLanguage: 'pt-BR',
        keywords: ['Framework RISEN', 'prompting iterativo', 'refinamento de prompts', 'fluxos de trabalho multi-etapa', 'prompt engineering', 'PromptQuorum', 'GPT-5.6', 'Claude Sonnet 5', 'Gemini 3.1 Pro'],
        author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
        about: [
          { '@type': 'Thing', name: 'Framework RISEN' },
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Posso combinar o RISEN com testes multi-modelo?', acceptedAnswer: { '@type': 'Answer', text: 'Sim. Use o PromptQuorum para enviar o mesmo ciclo RISEN ao GPT-5.6, Claude Sonnet 5 e Gemini 3.1 Pro simultaneamente. Compare quais refinamentos do modelo melhor atendem aos seus requisitos.' } },
    ...
    fr: {
      ...
      quickFacts: [
        ...
        'Fonctionne avec tous les modèles : GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro, modèles locaux via Ollama ou LM Studio.',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'RISEN fonctionne avec tous les modèles : GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro, Ollama, LM Studio.',
        ...
        whatIsRISEN: {
          ...
          content: [
            '**Le Framework RISEN est un pattern itératif conçu pour affiner les brouillons, analyses et plans via plusieurs cycles d\'amélioration.** Au lieu de traiter chaque prompt comme une tâche unique, vous guidez un modèle comme GPT-5.6, Claude Sonnet 5 ou Gemini 3.1 Pro via une boucle structurée et reproductible. Cela rend votre workflow moins essai-erreur et plus édition continue.',
        ...
        commonMistakes: {
          ...
          mistakes: [
            ...
            },
            {
              ...
              fix: 'Utilisez PromptQuorum envoyant même cycle RISEN à GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro parallèle. Comparez approches.',
            },
          ],
        },
        ...
        risenInPromptQuorum: {
          ...
          items: [
            ...
            'Envoyer même instructions RISEN-basées à modèles multiples — GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro — parallèle et comparer affinages.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'Puis-je combiner RISEN avec tests multi-modèles?', a: 'Oui. Utilisez PromptQuorum envoyant même cycle RISEN à GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro simultanément. Comparez améliorations, critiques, suggestions.' },
        ...
        sources: {
          ...
          items: [
            ...
            'OpenAI Prompt Engineering Guide. [platform.openai.com/docs/guides/prompt-engineering](https://platform.openai.com/docs/guides/prompt-engineering) — Bonnes pratiques prompting officielles incluant stratégies amélioration itérative.',
            'Anthropic Prompt Engineering Documentation. [docs.anthropic.com/en/docs/build-with-claude/prompt-engineering](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering) — Guide Claude-spécifique sur workflows prompts multi-étapes.',
          ],
        },
      },
      ...
      schema: {
        ...
        keywords: ['Framework RISEN', 'prompting itératif', 'raffinement prompts', 'ingénierie prompts', 'PromptQuorum', 'GPT-5.6', 'Claude Sonnet 5', 'Gemini 3.1 Pro'],
        author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
        about: [
          { '@type': 'Thing', name: 'Framework RISEN' },
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Oui. Utilisez PromptQuorum envoyant même cycle RISEN à GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro simultanément. Comparez améliorations, critiques, suggestions.',
            },
          },
          {
            '@type': 'Question',
    ...
    ja: {
      ...
      leadAnswerBlock: '**RISENは5段階の反復ループです：Refineはドラフトを改善し、Inspectは各変更を正当化を含めてリストアップし、Summarizeは新バージョンを説明し、Evaluateは基準に対して評価（1～5スケール）し、Next Stepsは次サイクルの3つの焦点を絞った改善を推奨します。既にドラフトがあり、制御された追跡可能な改善と監査証跡が必要な場合にRISENを使用します。Inspectステップは、モデルに変更を記録することを強制します。2026年、RISENはPromptQuorumにマルチモデルディスパッチオプションとして統合され、同じRISENサイクルをGPT-5.6、Claude Sonnet 5、Gemini 3.1 Proで並行してテストして改善アプローチを比較できます。**',
      publishDate: '2026-03-24',
      dateModified: '2026-08-31',
      readTime: '13分で読める',
      ...
      quickFacts: [
        ...
        'すべてのモデルで動作：GPT-5.6、Claude Sonnet 5、Gemini 3.1 Pro、OllamaやLM Studioの地元モデル',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'すべてのモデルで動作：GPT-5.6、Claude Sonnet 5、Gemini 3.1 Pro、Ollama、LM Studio',
        ...
        whatIsRISEN: {
          ...
          content: [
            '**RISENフレームワークは、複数改善サイクルを通じてドラフト、分析、計画を改善する反復パターンです。** 各プロンプトを1回限りの作業ではなく、GPT-5.6、Claude Sonnet 5、Gemini 3.1 Proなどのモデルを構造化された再現可能ループで導きます。これにより、ワークフローは試行錯誤よりも継続的編集に見えます。',
        ...
        commonMistakes: {
          ...
          mistakes: [
            ...
            },
            {
              ...
              fix: 'PromptQuorumで同じRISENをGPT-5.6、Claude Sonnet 5、Gemini 3.1 Proに並行実行。比較',
            },
          ],
        },
        ...
        risenInPromptQuorum: {
          ...
          items: [
            ...
            '同じRISEN命令を複数モデル — GPT-5.6、Claude Sonnet 5、Gemini 3.1 Pro — 並行送信、各改善方法を比較',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'はい。PromptQuorumで同じRISENをGPT-5.6、Claude Sonnet 5、Gemini 3.1 Proに同時送信。改善方法を比較。',
            },
            {
        ...
        sources: {
          ...
          items: [
            ...
            'OpenAI Prompt Engineering Guide. [platform.openai.com/docs/guides/prompt-engineering](https://platform.openai.com/docs/guides/prompt-engineering) — 公式プロンプティング現在慣行、反復改善戦略含め。',
            'Anthropic Prompt Engineering Documentation. [docs.anthropic.com/en/docs/build-with-claude/prompt-engineering](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering) — Claude特有、複数段階プロンプトワークフロー指針。',
          ],
        },
      },
      ...
      schema: {
        ...
        keywords: ['RISENフレームワーク', '反復的プロンプティング', 'プロンプト改善', 'プロンプト・エンジニアリング', 'PromptQuorum', 'GPT-5.6', 'Claude Sonnet 5', 'Gemini 3.1 Pro'],
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'RISENをマルチモデルテストと組み合わせられますか？', 'acceptedAnswer': { '@type': 'Answer', 'text': 'はい。PromptQuorumで同じRISENをGPT-5.6、Claude Sonnet 5、Gemini 3.1 Proに同時送信。改善方法を比較。' } },
    ...
    zh: {
      ...
      leadAnswerBlock: '**RISEN是一个5阶段的迭代优化框架：Refine改进草稿，Inspect列举每一个变更及其理由，Summarize解释新版本的作用，Evaluate按标准打分（1-5分），Next Steps推荐下一阶段的3个重点改进。在已经有初稿的时候使用RISEN，通过可跟踪的改进获得受控的、可审计的升级。Inspect步骤的独特之处在于强制模型记录所有变更——让修订变成可追踪的。在2026年，RISEN内置于PromptQuorum中，成为多模型分发选项，让您可以在GPT-5.6、Claude Sonnet 5、Gemini 3.1 Pro上同时测试RISEN循环，比较不同的改进方法。**',
      publishDate: '2026-03-24',
      dateModified: '2026-08-31',
      ...
      quickFacts: [
        ...
        '适用于任何模型：GPT-5.6、Claude Sonnet 5、Gemini 3.1 Pro，以及通过Ollama或LM Studio的本地模型。13B以上的大模型能更好地处理多步结构；7B模型可能需要分离步骤。',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'RISEN适用于任何模型：GPT-5.6、Claude Sonnet 5、Gemini 3.1 Pro、Ollama、LM Studio。13B以上的大模型更好地处理多步结构。',
        ...
        whatIsRISEN: {
          ...
          content: [
            '**RISEN框架是一个迭代Prompt模式，通过多个改进循环来改进现有的草稿、分析和计划。** 与其把每个Prompt当作一次性任务，不如引导GPT-5.6、Claude Sonnet 5或Gemini 3.1 Pro这样的模型通过一个结构化、可重复的改进循环。这使得您的工作流程更像持续编辑而不是随机试错。',
...
[粘贴原始文章]`,
        ...
        risenInPromptQuorum: {
          ...
          id: 'risen-in-promptquorum',
          content: [
            'PromptQuorum把RISEN变成了一个一级公民功能。您可以写一个RISEN循环，把它发送给GPT-5.6、Claude Sonnet 5和Gemini 3.1 Pro同时，比较它们各自的改进方法。这让您可以看到不同的模型如何以不同的方式处理相同的改进任务。',
        ...
        faqSection: {
          ...
          },
          {
            ...
            a: '是的。在PromptQuorum中，将同一个RISEN循环同时发送给GPT-5.6、Claude Sonnet 5和Gemini 3.1 Pro。比较它们各自如何改进。',
          },
          {
            q: 'RISEN会增加Token成本吗？',
        ...
        sources: {
          ...
          items: [
            ...
            'Anthropic. (2026). "Prompt Engineering Guide." [www.anthropic.com](https://www.anthropic.com)',
          ],
        },
      },
      ...
      schema: {
        ...
        keywords: ['RISEN框架', '迭代式提示词', '提示词优化', '提示词工程', 'PromptQuorum', 'GPT-5.6', 'Claude Sonnet 5', 'Gemini 3.1 Pro'],
        author: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
        about: [
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': '我可以把RISEN与多模型测试组合吗？', 'acceptedAnswer': { '@type': 'Answer', 'text': '是的。在PromptQuorum中，将同一个RISEN循环同时发送给GPT-5.6、Claude Sonnet 5和Gemini 3.1 Pro。比较它们各自如何改进。' } },
  ...
  ko: {
      ...
      quickFacts: [
        ...
        'GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro, Ollama 또는 LM Studio를 통한 로컬 모델 등 모든 모델에서 작동합니다. 더 큰 모델(13B+)이 다단계 구조를 더 잘 처리합니다. 7B 모델은 단계를 분리해야 할 수 있습니다.',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'RISEN은 모든 모델에서 작동합니다: GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro, Ollama, LM Studio. 더 큰 모델(13B+)이 다단계 구조를 더 잘 처리합니다.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: '예. PromptQuorum을 사용하여 동일한 RISEN 사이클을 GPT-5.6, Claude Sonnet 5 및 Gemini 3.1 Pro에 동시에 보내십시오. 어떤 모델의 개선, 자기 비판 점수 및 다음 단계 제안이 귀하의 요구 사항에 가장 잘 맞는지 비교하십시오.',
            },
            {
        ...
        sources: {
          ...
          items: [
            ...
            'OpenAI Prompt Engineering Guide. [platform.openai.com/docs/guides/prompt-engineering](https://platform.openai.com/docs/guides/prompt-engineering) — 반복 개선 전략을 포함한 공식 프롬프트 모범 사례.',
            'Anthropic Prompt Engineering Documentation. [docs.anthropic.com/en/docs/build-with-claude/prompt-engineering](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering) — 다단계 프롬프트 워크플로에 대한 Claude 전용 지침.',
          ],
        },
      },
      ...
      schema: {
        ...
        dateModified: '2026-08-31',
        'url': 'https://www.promptquorum.com/prompt-engineering/risen-framework',
        keywords: ['RISEN Framework', '반복 프롬프트', '프롬프트 개선', '다단계 워크플로', '프롬프트 엔지니어링', 'PromptQuorum', 'GPT-5.6', 'Claude Sonnet 5', 'Gemini 3.1 Pro'],
        author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
        about: [
          { '@type': 'Thing', name: 'RISEN Framework' },
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          { '@type': 'Question', 'name': 'RISEN을 멀티 모델 테스트와 결합할 수 있습니까?', 'acceptedAnswer': { '@type': 'Answer', 'text': '예. PromptQuorum을 사용하여 동일한 RISEN 사이클을 GPT-5.6, Claude Sonnet 5 및 Gemini 3.1 Pro에 동시에 보내십시오. 어떤 모델의 개선이 귀하의 요구 사항에 가장 잘 맞는지 비교하십시오.' } },
