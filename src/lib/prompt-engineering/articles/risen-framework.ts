...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    es: {
      ...
      schema: {
        ...
        datePublished: '2026-03-24',
        dateModified: '2026-05-04',
        url: 'https://www.promptquorum.com/es/es/prompt-engineering/risen-framework',
        inLanguage: 'es',
    ...
    ar: {
      ...
      seoTitle: 'إطار RISEN: تحسين البرومبتات في 5 خطوات تكرارية',
      metaDescription: 'RISEN يُحسِّن البرومبتات بشكل تكراري في 5 خطوات. يُوثِّق التغييرات ويُقيّم الجودة ويُخطط للتحسينات التالية. اختبارات متعددة النماذج مع PromptQuorum.',
