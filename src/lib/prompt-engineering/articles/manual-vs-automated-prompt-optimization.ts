  ...
  en: {
    ...
    sections: {
      ...
      tools: {
        ...
        rows: [
          { 'Tool': '[DSPy (Stanford)](https://dspy.ai)', 'Approach': 'Prompt optimization via learning', 'Maturity': 'Production-ready (open-source)', 'Scale': '50–500 prompts', 'Best For': 'Teams scaling prompt variants' },
          { 'Tool': '[TextGrad](https://github.com/zou-group/textgrad)', 'Approach': 'Gradient-based prompt rewriting', 'Maturity': 'Research (new, not in production yet)', 'Scale': '10–100 prompts', 'Best For': 'Research, cutting-edge optimization' },
          { 'Tool': '[Promptfoo](https://promptfoo.dev)', 'Approach': 'Testing + regression detection (manual-assisted)', 'Maturity': 'Production-ready (open-source)', 'Scale': 'Any size', 'Best For': 'CI/CD testing, not full automation' },
        ],
      },
  ...
  de: {
    ...
    sections: {
      ...
      tools: {
        ...
        rows: [
          { 'Tool': '[DSPy (Stanford)](https://dspy.ai)', 'Ansatz': 'Prompt-Optimierung via Lernen', 'Reife': 'Produktionsreif (Open-Source)', 'Skalierung': '50–500 Prompts', 'Beste für': 'Teams skalieren Prompt-Varianten' },
          { 'Tool': '[TextGrad](https://github.com/zou-group/textgrad)', 'Ansatz': 'Gradienten-basiertes Umschreiben', 'Reife': 'Forschung (neu, noch nicht produktionsreif)', 'Skalierung': '10–100 Prompts', 'Beste für': 'Forschung, fortgeschrittene Optimierung' },
          { 'Tool': '[Promptfoo](https://promptfoo.dev)', 'Ansatz': 'Testen + Regressionserkennung (manuell-assistiert)', 'Reife': 'Produktionsreif (Open-Source)', 'Skalierung': 'Beliebige Größe', 'Beste für': 'CI/CD-Testen, nicht vollständige Automatisierung' },
        ],
      },
  ...
  es: {
    ...
    sections: {
      ...
      tools: {
        ...
        rows: [
          { 'Herramienta': '[DSPy (Stanford)](https://dspy.ai)', 'Enfoque': 'Optimización de prompts mediante aprendizaje', 'Madurez': 'Listo para producción (open-source)', 'Escala': '50–500 prompts', 'Ideal para': 'Equipos que escalan variantes de prompts' },
          { 'Herramienta': '[TextGrad](https://github.com/zou-group/textgrad)', 'Enfoque': 'Reescritura de prompts basada en gradientes', 'Madurez': 'Investigación (nuevo, aún no en producción)', 'Escala': '10–100 prompts', 'Ideal para': 'Investigación, optimización de vanguardia' },
          { 'Herramienta': '[Promptfoo](https://promptfoo.dev)', 'Enfoque': 'Testing + detección de regresiones (asistido manualmente)', 'Madurez': 'Listo para producción (open-source)', 'Escala': 'Cualquier tamaño', 'Ideal para': 'Testing CI/CD, no automatización completa' },
        ],
      },
  ...
  pt: {
    ...
    sections: {
      ...
      tools: {
        ...
        rows: [
          { 'Ferramenta': '[DSPy (Stanford)](https://dspy.ai)', 'Abordagem': 'Otimização de prompts por aprendizado', 'Maturidade': 'Pronto para produção (código aberto)', 'Escala': '50–500 prompts', 'Ideal para': 'Equipes que escalam variantes de prompts' },
          { 'Ferramenta': '[TextGrad](https://github.com/zou-group/textgrad)', 'Abordagem': 'Reescrita de prompts baseada em gradientes', 'Maturidade': 'Pesquisa (novo, ainda não em produção)', 'Escala': '10–100 prompts', 'Ideal para': 'Pesquisa, otimização de ponta' },
          { 'Ferramenta': '[Promptfoo](https://promptfoo.dev)', 'Abordagem': 'Testes + detecção de regressões (assistido manualmente)', 'Maturidade': 'Pronto para produção (código aberto)', 'Escala': 'Qualquer tamanho', 'Ideal para': 'Testes CI/CD, não automação completa' },
        ],
      },
  ...
  fr: {
    ...
    sections: {
      ...
      tools: {
        ...
        rows: [
          { 'Outil': '[DSPy (Stanford)](https://dspy.ai)', 'Approche': 'Optimisation de prompts via apprentissage', 'Maturité': 'Prêt pour production (open-source)', 'Scalabilité': '50–500 prompts', 'Meilleur pour': 'Équipes scalant variantes de prompts' },
          { 'Outil': '[TextGrad](https://github.com/zou-group/textgrad)', 'Approche': 'Réécriture basée sur gradients', 'Maturité': 'Recherche (nouveau, pas productif encore)', 'Scalabilité': '10–100 prompts', 'Meilleur pour': 'Recherche, optimisation avancée' },
          { 'Outil': '[Promptfoo](https://promptfoo.dev)', 'Approche': 'Test + détection régression (semi-automatisé)', 'Maturité': 'Prêt pour production (open-source)', 'Scalabilité': 'Toute taille', 'Meilleur pour': 'Test CI/CD, pas automatisation complète' },
        ],
      },
  ...
  ja: {
    ...
    sections: {
      ...
      tools: {
        ...
        rows: [
          { 'ツール': '[DSPy(スタンフォード)](https://dspy.ai)', 'アプローチ': '学習によるプロンプト最適化', '成熟度': '本番対応(オープンソース)', 'スケール': '50–500プロンプト', '最適用途': 'プロンプト亜種をスケーリングするチーム' },
          { 'ツール': '[TextGrad](https://github.com/zou-group/textgrad)', 'アプローチ': '勾配ベースのプロンプト書き直し', '成熟度': '研究段階(新、本番まだ未対応)', 'スケール': '10–100プロンプト', '最適用途': '研究、最先端の最適化' },
          { 'ツール': '[Promptfoo](https://promptfoo.dev)', 'アプローチ': 'テスト + リグレッション検出(マニュアル補助)', '成熟度': '本番対応(オープンソース)', 'スケール': 'どのサイズでも', '最適用途': 'CI/CDテスト、完全自動化ではない' },
        ],
      },
  ...
  zh: {
    ...
    sections: {
      ...
      tools: {
        ...
        rows: [
          { '工具': '[DSPy（斯坦福）](https://dspy.ai)', '方法': '通过学习进行提示词优化', '成熟度': '生产就绪（开源）', '规模': '50–500提示词', '最适用于': '扩展提示词变体的团队' },
          { '工具': '[TextGrad](https://github.com/zou-group/textgrad)', '方法': '基于梯度的提示词重写', '成熟度': '研究阶段（新、生产未就绪）', '规模': '10–100提示词', '最适用于': '研究、尖端优化' },
          { '工具': '[Promptfoo](https://promptfoo.dev)', '方法': '测试 + 回归检测（手动辅助）', '成熟度': '生产就绪（开源）', '规模': '任何规模', '最适用于': 'CI/CD测试，不是完全自动化' },
        ],
      },
  ...
  ar: {
    ...
    sections: {
      ...
      tools: {
        ...
        rows: [
          { 'الأداة': '[DSPy (Stanford)](https://dspy.ai)', 'النهج': 'تحسين الـ prompts عبر التعلم', 'النضج': 'جاهزة للإنتاج (مفتوحة المصدر)', 'النطاق': '50–500 prompt', 'مثالية لـ': 'الفرق التي تتوسع في نسخ الـ prompts' },
          { 'الأداة': '[TextGrad](https://github.com/zou-group/textgrad)', 'النهج': 'إعادة كتابة الـ prompts القائمة على التدرجات', 'النضج': 'بحثي (جديد، غير جاهز للإنتاج بعد)', 'النطاق': '10–100 prompt', 'مثالية لـ': 'الأبحاث، التحسين المتطور' },
          { 'الأداة': '[Promptfoo](https://promptfoo.dev)', 'النهج': 'اختبار + كشف الانحدار (بمساعدة يدوية)', 'النضج': 'جاهزة للإنتاج (مفتوحة المصدر)', 'النطاق': 'أي حجم', 'مثالية لـ': 'اختبار CI/CD، ليست أتمتة كاملة' },
        ],
      },
  ...
  ko: {
    ...
    sections: {
      ...
      tools: {
        ...
        rows: [
          { '도구': '[DSPy (Stanford)](https://dspy.ai)', '방식': '학습을 통한 프롬프트 최적화', '성숙도': '프로덕션 지원 (오픈소스)', '규모': '50–500개 프롬프트', '최적 용도': '프롬프트 변형을 확장하는 팀' },
          { '도구': '[TextGrad](https://github.com/zou-group/textgrad)', '방식': '그래디언트 기반 프롬프트 재작성', '성숙도': '연구 단계 (신규, 아직 프로덕션 미지원)', '규모': '10–100개 프롬프트', '최적 용도': '연구, 최첨단 최적화' },
          { '도구': '[Promptfoo](https://promptfoo.dev)', '방식': '테스트 + 회귀 탐지 (수동 보조)', '성숙도': '프로덕션 지원 (오픈소스)', '규모': '어떤 규모에도 적합', '최적 용도': 'CI/CD 테스트, 완전 자동화 아님' },
        ],
      },
