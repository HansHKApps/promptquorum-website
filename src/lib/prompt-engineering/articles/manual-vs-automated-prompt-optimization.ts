...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  pt: {
    ...
    schema: {
      ...
      datePublished: '2026-04-26',
      url: 'https://www.promptquorum.com/pt/pt/prompt-engineering/manual-vs-automated-prompt-optimization',
      inLanguage: 'pt-BR',
      author: { '@type': 'Person', name: 'Hans Kuepper', url: 'https://www.promptquorum.com/about' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } },
  ...
  ar: {
    ...
    seoTitle: 'التحسين اليدوي مقابل الآلي: اختر نهجك في تحسين الـ prompts',
    metaDescription: 'تحسين الـ prompts يدويًا أم تلقائيًا: اختر حسب عدد الـ prompts والموارد المتاحة. متى تُكرر يدويًا ومتى تُؤتمت. إطار قرار ومقارنة شاملة.',
