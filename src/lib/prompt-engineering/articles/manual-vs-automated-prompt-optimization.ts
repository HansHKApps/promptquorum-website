...
export const article: Record<Language, PEArticle> = {
  ...
  zh: {
    ...
    howToSchema: {
      ...
      '@type': 'HowTo',
      name: '如何判断：手动还是自动优化',
      description: '选择手动或自动提示词优化的决策框架。',
      totalTime: 'PT15M',
      inLanguage: 'zh',
      step: [
        { '@type': 'HowToStep', position: 1, name: '统计你的生产提示词', text: '你有多少个不同的生产提示词？ <10 = 手动。10–50 = 手动或早期混合。50–100 = 混合。100个以上 = 自动化。' },
        { '@type': 'HowToStep', position: 2, name: '检查标记例子', text: '你有50个以上的(输入、标准输出)对吗？有的话自动化可行。没有的话从手动开始或构建评估数据。' },
        { '@type': 'HowToStep', position: 3, name: '定义成功指标', text: '手动使用人类判断。自动化需要可测量的指标：准确率、BLEU分数或LLM评分。在运行DSPy或TextGrad前需要这个。' },
        { '@type': 'HowToStep', position: 4, name: '计算两种方案的成本', text: '手动：工程时薪 × 提示词数量。自动化：计算成本 + 数据标记成本。为你的规模计算数字。' },
        { '@type': 'HowToStep', position: 5, name: '选择你的方法', text: '如果成本较低选手动。如果扩展能节省超过设置成本则选自动化。如果正在过渡则选混合。' },
      ],
    },
    itemListSchema: {
      '@context': 'https://schema.org',
    ...
    faqSchema: {
      ...
      inLanguage: 'zh',
      mainEntity: [
        { '@type': 'Question', name: '手动优化和自动优化有什么区别？', acceptedAnswer: { '@type': 'Answer', text: '手动：你根据测试失败重写提示词。自动化：框架（DSPy、TextGrad）使用梯度下降或LLM重写来重写提示词。手动提供更多控制；自动化扩展性更好。' } },
        { '@type': 'Question', name: '何时应该使用手动优化？', acceptedAnswer: { '@type': 'Answer', text: '手动最适合<50个生产提示词，当需要完全控制，或当没有标记的评估数据时。对于优化方向不清楚的新任务也最适合。' } },
        { '@type': 'Question', name: '何时应该使用自动优化？', acceptedAnswer: { '@type': 'Answer', text: '自动化最适合>100个生产提示词，当有标记的训练/评估数据，优化指标清晰，需要快速迭代时。' } },
        { '@type': 'Question', name: 'DSPy是什么？', acceptedAnswer: { '@type': 'Answer', text: 'DSPy是来自斯坦福的框架，通过将提示词视为可学习参数来自动化提示词优化。你定义任务、提供例子，DSPy生成并评分候选提示词。每次迭代从指标学习改进提示词。' } },
        { '@type': 'Question', name: 'DSPy需要标记数据吗？', acceptedAnswer: { '@type': 'Answer', text: '是的。DSPy需要训练集（50–500个输入/标准输出对）和评估指标（准确率、BLEU或LLM评分）。如果没有标签，从手动优化开始或构建标签。' } },
        { '@type': 'Question', name: 'DSPy设置需要多久？', acceptedAnswer: { '@type': 'Answer', text: 'DSPy设置需要2–5天：定义任务结构、准备训练数据、编写指标、初始化DSPy、运行优化。根据数据集大小，首次运行可能需要1–2小时计算。' } },
        { '@type': 'Question', name: '能在生产中实时自动优化提示词吗？', acceptedAnswer: { '@type': 'Answer', text: '不能。DSPy等自动框架是开发时工具——离线运行生成候选提示词、测试，然后部署最佳变体到生产。实时在线优化是研究阶段，不生产就绪。' } },
        { '@type': 'Question', name: '手动和自动的成本差异是多少？', acceptedAnswer: { '@type': 'Answer', text: '手动：每个提示词约$1,000–5,000（工程劳动，复杂任务4–8小时）。自动化：约$100–500/提示词（计算 + 标记，一次性）。大规模时（100个以上），自动化便宜5–10倍。' } },
      ],
    },
    sections: {
      tldr: {
