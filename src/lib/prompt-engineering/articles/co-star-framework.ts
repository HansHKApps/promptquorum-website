...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      seoTitle: 'إطار CO-STAR: بنِ موجّهاتك المعقدة في 6 خطوات',
      metaDescription: 'الحقول الـ 6 في CO-STAR تمنحك تحكمًا في كل متغير من متغيرات المخرجات: الصوت، النبرة، الجمهور، التنسيق. قوالب كاملة وجدول مقارنة مع CRAFT وRISEN.',
