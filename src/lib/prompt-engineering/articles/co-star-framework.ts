...
export const article: Record<Language, PEArticle> = {
    en: {
      ...
      metaDescription: 'CO-STAR Framework breaks prompts into Context, Objective, Style, Tone, Audience, Response. Works with GPT-5.5, Claude, Gemini, and local LLMs.',
      ...
      faqSchema: {
        ...
        'mainEntity': [
          ...
          },
          {
            ...
            'acceptedAnswer': { '@type': 'Answer', 'text': 'Yes. CO-STAR works with GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro, and local models like Ollama. Larger models handle nuance better, but all LLMs benefit from structured CO-STAR prompts.' }
          },
          {
            '@type': 'Question',
      ...
      sections: {
        ...
        howPQImplements: {
          ...
          items: [
            'Fill out CO-STAR fields for a task and dispatch the resulting prompt to multiple models such as GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro, and compatible local models.',
    ...
    de: {
      ...
      metaDescription: 'CO-STAR-Framework zerlegt komplexe Prompts: Kontext, Ziel, Stil, Ton, Zielgruppe, Response. Mit GPT-5.5, Claude und Gemini. PromptQuorum-unterstützt.',
      publishDate: '2026-03-24',
      readTime: '8 min read',
      educationalLevel: 'Intermediate',
      schema: {
        ...
        description: 'Das CO-STAR-Framework zerlegt komplexe Prompts in Kontext, Ziel, Stil, Ton, Zielgruppe und Response. Nutze es mit GPT-5.5, Claude und Gemini. PromptQuorum-unterstützt.',
        datePublished: '2026-03-24',
        dateModified: '2026-03-24',
      },
      sections: {}
    ...
    fr: {
      ...
      metaDescription: 'Framework CO-STAR divise les prompts: Contexte, Objectif, Style, Ton, Audience, Réponse. Utilisez avec GPT-5.5, Claude et Gemini. Support PromptQuorum.',
      publishDate: '2026-03-24',
      readTime: '8 min read',
      educationalLevel: 'Intermediate',
      schema: {
        ...
        description: 'Le framework CO-STAR divise les prompts complexes en Contexte, Objectif, Style, Ton, Audience et Réponse. Utilisez avec GPT-5.5, Claude et Gemini. Support PromptQuorum.',
        datePublished: '2026-03-24',
        dateModified: '2026-03-24',
      },
      sections: {}
    ...
    ja: {
      ...
      metaDescription: 'CO-STARフレームワークで複雑なプロンプトを構造化。コンテキスト、目的、スタイル、トーン、対象者に分割します。GPT-5.5、Claude対応。',
      publishDate: '2026-03-24',
      readTime: '8 min read',
      educationalLevel: 'Intermediate',
      schema: {
        ...
        description: 'CO-STARフレームワークは複雑なプロンプトを：コンテキスト、目的、スタイル、トーン、対象者、レスポンスに分割します。GPT-5.5、Claude、Geminiで使用可能。',
        datePublished: '2026-03-24',
        dateModified: '2026-03-24',
      },
      sections: {}
    ...
    zh: {
      ...
      metaDescription: 'CO-STAR框架将复杂提示分解为背景、目标、风格、语调、受众、回应。适用于GPT-5.5、Claude和Gemini。',
      publishDate: '2026-03-24',
      readTime: '8 min read',
      educationalLevel: 'Intermediate',
      schema: {
        ...
        description: 'CO-STAR框架将复杂提示分解为：背景、目标、风格、语调、受众、回应。适用于GPT-5.5、Claude和Gemini。PromptQuorum支持。',
        datePublished: '2026-03-24',
        dateModified: '2026-03-24',
      },
      sections: {}
