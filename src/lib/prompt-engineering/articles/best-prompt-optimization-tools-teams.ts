...
export const article: Record<Language, PEArticle> = {
  en: {
    ...
    metaDescription: 'Compare 7 prompt optimization tools: Braintrust, DSPy, Vellum, Promptfoo, Helicone, PromptQuorum. A/B testing, collaboration, pricing, and CI/CD integration.',
...
tests:
  ...
  de: {
    ...
    seoTitle: 'Prompt-Optimierungs-Tools für Teams im Vergleich 2026',
    ...
    metaDescription: 'Vergleich von 7 Prompt-Optimierungs-Tools: Braintrust, DSPy, Vellum, Promptfoo, Helicone, PromptQuorum. A/B-Tests, Zusammenarbeit, Preise, CI/CD-Integration.',
    publishDate: '2026-04-10',
    dateModified: '2026-04-29',
  ...
  ja: {
    ...
    seoTitle: 'チーム向けプロンプト最適化ツール比較ガイド 2026',
    ...
    metaDescription: 'Braintrust、DSPy、Vellum、Promptfoo、Helicone、PromptQuorumなど7つのプロンプト最適化ツール比較。A/Bテスト、チーム協働、価格、CI/CD統合で評価。',
    publishDate: '2026-04-10',
    dateModified: '2026-04-29',
    readTime: '10分で読める',
    educationalLevel: 'Intermediate',
  ...
  zh: {
    ...
    seoTitle: '团队提示优化工具对比指南 2026 | PromptQuorum',
    intro: '**团队提示优化需要四个核心能力：版本化存储、A/B变体测试、输出评分、协作审查。没有单一工具能覆盖全部四个能力。本指南根据团队类型、价格和工作流适配，对七个专业工具进行排名 — 加上PromptQuorum的跨模型对比。**',
    metaDescription: '对比7个团队提示优化工具: Braintrust、DSPy、Vellum、Promptfoo、Helicone、PromptQuorum。按A/B测试、协作、价格、CI/CD集成评估。',
    publishDate: '2026-04-10',
    dateModified: '2026-04-29',
    readTime: '阅读约10分钟',
    educationalLevel: 'Intermediate',
