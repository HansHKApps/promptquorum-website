...
tests:
  - vars:
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/es/es/prompt-engineering/best-prompt-optimization-tools-for-teams',
      inLanguage: 'es',
      datePublished: '2026-04-10',
      dateModified: '2026-04-29',
      author: {
...
tests:
  ...
  ar: {
    ...
    seoTitle: 'أفضل أدوات تحسين التعليمات للفرق 2026: مقارنة وتصنيف',
    ...
    metaDescription: 'لا توجد أداة واحدة تغطي الإصدارات واختبار A/B والتقييم والمراجعة. Braintrust الأفضل للتقييم، Vellum الأفضل لـ A/B في الإنتاج، Promptfoo مجاني. توصيات بحسب حجم الفريق.',
      ...
      commonMistakes: {
        ...
        mistakes: [
          ...
          },
          {
            ...
            problem:
              'تقييم مخرجات GPT-5.5 باستخدام GPT-5.5 كنموذج تقييم يُضخّم النقاط بنسبة 10–20% (تحيز model-as-judge).',
