...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    es: {
      ...
      schema: {
        ...
        datePublished: '2026-03-24',
        dateModified: '2026-05-04',
        url: 'https://www.promptquorum.com/prompt-engineering/rtf-framework?lang=es',
        inLanguage: 'es',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            { title: 'CO-STAR Framework: Componentes y cuándo usarlo', url: '/prompt-engineering/co-star-framework?lang=es' },
            { title: 'Framework SPECS: Prompts de especificación estricta', url: '/prompt-engineering/specs-framework?lang=es' },
            { title: 'Framework TRACE: Hacer visible el razonamiento de la IA', url: '/prompt-engineering/trace-framework?lang=es' },
            { title: '¿Qué framework de prompt deberías usar?', url: '/prompt-engineering/which-framework-to-use?lang=es' },
            { title: '¿Cómo elegir el modelo correcto: GPT-4o vs Claude vs Gemini?', url: '/prompt-engineering/gpt-claude-gemini-which-model?lang=es' },
