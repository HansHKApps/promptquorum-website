...
export const article: Partial<Record<Language, PEArticle>> = {
      ...
      sections: {
        ...
        relatedReading: {
          items: [
            ...
            { title: 'How to Pick the Right Model: GPT-5.5 vs Claude vs Gemini', url: '/prompt-engineering/gpt-claude-gemini-which-model' },
    ...
    ar: {
      ...
      seoTitle: 'إطار RTF: بنية البرومبت دور، مهمة، تنسيق',
      metaDescription: 'RTF = الدور + المهمة + التنسيق. بنية البرومبت من 3 حقول التي تتفوق على الأساليب المطوّلة في المهام الروتينية. قوالب وأمثلة.',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            { title: 'أي إطار برومبت يجب استخدامه؟', url: '/ar/prompt-engineering/which-framework-to-use' },
            { title: 'كيف تختار النموذج الصحيح: GPT-5.5 مقابل Claude مقابل Gemini؟', url: '/ar/prompt-engineering/gpt-claude-gemini-which-model' },
