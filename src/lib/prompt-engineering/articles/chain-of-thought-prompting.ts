...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  seoTitle: 'توجيه سلسلة الأفكار: رفع الدقة بنسبة 40%',
  metaDescription: 'سلسلة الأفكار تُحسِّن الاستدلال بنسبة 10-40% في الرياضيات والمنطق. تعلَّم متى تستخدم CoT مقابل أوضاع الاستدلال المُدمَجة.',
