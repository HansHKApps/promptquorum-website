...
export const article: Partial<Record<Language, PEArticle>> = {
      ...
      sections: {
        ...
        reasoningModels: {
          ...
          rows: [
            ...
            { 'Approach': 'Claude extended thinking (Opus 4.8, Sonnet 4.6)', 'Best For': 'Complex analysis, maximum accuracy', 'Cost': 'Separate thinking token budget (input rate)', 'Transparency': 'Inspector trace via API', 'Models': 'Claude Opus 4.8, Claude Sonnet 4.6' },
  ...
  sections: {
    ...
    reasoningModels: {
      ...
      rows: [
        ...
        { 'Ansatz': 'Claude Extended Thinking (Opus 4.8, Sonnet 4.6)', 'Am besten für': 'Komplexe Analysen, maximale Genauigkeit', 'Kosten': 'Separates Thinking-Token-Budget (Input-Satz)', 'Transparenz': 'Inspector-Trace via API', 'Modelle': 'Claude Opus 4.8, Claude Sonnet 4.6' },
  ...
  sections: {
    ...
    reasoningModels: {
      ...
      rows: [
        ...
        { 'Enfoque': 'Claude extended thinking (Opus 4.8, Sonnet 4.6)', 'Mejor para': 'Análisis complejo, máxima precisión', 'Costo': 'Presupuesto de tokens de pensamiento separado (tarifa de entrada)', 'Transparencia': 'Traza de inspector vía API', 'Modelos': 'Claude Opus 4.8, Claude Sonnet 4.6' },
  ...
  seoTitle: 'توجيه سلسلة الأفكار: دقة أعلى بـ40% في الرياضيات',
  metaDescription: 'توجيه سلسلة الأفكار (CoT) يرفع الدقة 10-40% في الرياضيات والمنطق. تعرّف على متى تستخدم CoT على الموجّه مقابل أوضاع الاستدلال في Claude وo3.',
  educationalLevel: 'متوسط',
  primaryTerm: 'توجيه سلسلة الأفكار',
  audience: 'المطورون وعلماء البيانات والفرق التي تعمل مع GPT-5.5 وClaude وGemini أو LLMs المحلية',
  next_refresh_due: '2026-11-03',
  ...
  sections: {
    ...
    reasoningModels: {
      ...
      rows: [
        ...
        { 'النهج': 'التفكير الممتد لـ Claude (Opus 4.8 وSonnet 4.6)', 'الأفضل لـ': 'التحليل المعقَّد وأقصى دقة', 'التكلفة': 'ميزانية رموز تفكير منفصلة (تعريفة المدخلات)', 'الشفافية': 'أثر المفتش عبر API', 'النماذج': 'Claude Opus 4.8 وClaude Sonnet 4.6' },
    ...
    modelComparison: {
      ...
      rows: [
        ...
        { 'النموذج': 'Claude Sonnet 4.6', 'CoT على مستوى التعليمات': 'غير ضروري', 'الاستدلال المُدمَج': 'التفكير الممتد', 'أفضل حالة استخدام': 'توازن الدقة/التكلفة', 'التكلفة (تقريبًا)': 'متوسط' },
        ...
        { 'النموذج': 'GPT-5.5 mini', 'CoT على مستوى التعليمات': 'مُوصى به', 'الاستدلال المُدمَج': 'لا يوجد', 'أفضل حالة استخدام': 'نشر اقتصادي', 'التكلفة (تقريبًا)': 'منخفض جدًا' },
    ...
    relatedReading: {
      ...
      items: [
        ...
        '[المخرجات المنظَّمة وتوجيه JSON Schema](/ar/prompt-engineering/structured-output)',
        '[كيفية تقليل هلوسة الذكاء الاصطناعي](/ar/prompt-engineering/reducing-hallucination)',
        '[التوجيه المقيَّد: تحديد مخرجات النموذج](/ar/prompt-engineering/constrained-prompting)',
        '[كيفية بناء نظام إرسال متعدد النماذج](/ar/prompt-engineering/multi-model-dispatch)',
        '[إطار اختبار وتقييم التعليمات](/ar/prompt-engineering/prompt-testing)',
      ],
    },
    faqSection: {
  ...
  sections: {
    ...
    reasoningModels: {
      ...
      rows: [
        ...
        { 'Approche': 'Claude Extended Thinking (Opus 4.8, Sonnet 4.6)', 'Meilleure pour': 'Analyses complexes, précision maximale', 'Coûts': 'Budget séparé de tokens de raisonnement (taux d\'entrée)', 'Transparence': 'Trace inspectable via API', 'Modèles': 'Claude Opus 4.8, Claude Sonnet 4.6' },
  ...
  sections: {
    ...
    reasoningModels: {
      ...
      rows: [
        ...
        { 'アプローチ': 'Claude Extended Thinking (Opus 4.8、Sonnet 4.6)', '最適な用途': '複雑な分析、最大精度', 'コスト': '独立した思考トークン予算(入力レート)', '透明性': 'APIを介して検査可能なトレース', 'モデル': 'Claude Opus 4.8、Claude Sonnet 4.6' },
  ...
  sections: {
    ...
    reasoningModels: {
      ...
      rows: [
        ...
        { '方法': 'Claude Extended Thinking (Opus 4.8、Sonnet 4.6)', '最适用于': '复杂分析、最高精度', '成本': '独立思维token预算(输入费率)', '透明度': '通过API可检查的trace', '模型': 'Claude Opus 4.8、Claude Sonnet 4.6' },
