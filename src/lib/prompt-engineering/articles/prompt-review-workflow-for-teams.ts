...
require_code_owner_reviews: true`,
  ...
  es: {
    ...
    schema: {
      ...
      proficiencyLevel: 'Intermediate',
      author: { '@type': 'Person', name: 'Hans Kuepper', url: 'https://www.promptquorum.com/about' },
      url: 'https://www.promptquorum.com/es/es/prompt-engineering/prompt-review-workflow-for-teams',
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } },
...
require_code_owner_reviews: true`,
  ...
  ar: {
    ...
    seoTitle: 'مراجعة التعليمات للفرق: قائمة 7 نقاط وCI/CD',
    metaDescription: 'التعليمات غير المراجعة تفشل بمعدل 3× أعلى. سير مراجعة: قائمة 7 نقاط و3 أدوار للمراجعين وبوابات CI/CD. أتمت 70% واحتفظ بـ30% يدوياً.',
...
require_code_owner_reviews: true`,
  ...
  pt: {
    ...
    schema: {
      ...
      proficiencyLevel: 'Intermediate',
      author: { '@type': 'Person', name: 'Hans Kuepper', url: 'https://www.promptquorum.com/about' },
      url: 'https://www.promptquorum.com/pt/pt/prompt-engineering/prompt-review-workflow-for-teams',
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } },
