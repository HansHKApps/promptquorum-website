...
require_code_owner_reviews: true`,
  ...
  ja: {
    ...
    seoTitle: 'チーム向けプロンプトレビュー：チェックリスト & CI/CDゲート',
    metaDescription: '7項目チェックリスト、3つのレビュアー役割、CI/CDゲートを備えたプロンプトレビューワークフローの構築方法。70%自動化、30%手動レビュー。',
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      headline: 'チーム向けプロンプトレビューワークフロー：チェックリストとCI/CDゲート（2026年）',
      description: '7項目チェックリスト、3つのレビュアー役割、CI/CDゲートを備えたプロンプトレビューワークフローの構築方法。70%自動化、30%手動レビュー。',
      datePublished: '2026-04-29',
      dateModified: '2026-04-29',
      inLanguage: 'ja',
      proficiencyLevel: 'Intermediate',
