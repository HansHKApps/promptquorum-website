...
export const article: Record<Language, PEArticle> = {
    en: {
      ...
      sections: {
        ...
        numericThresholds: {
          content: ['Persona-Aufforderungen, die numerische Schwellwerte kodieren (zum Beispiel „80 Prozent Konfidenz", „niemals über 300 Tokens in einer Antwort", oder „erklären Sie auf B1-Englischniveau"), sind leichter für Modelle zu befolgen als rein qualitative Anweisungen. Modelle wie GPT-5.5 und Claude Opus 4.7 reagieren besonders gut auf explizite Token-, Temperatur- und Längenlimits, da diese direkt zu internen Dekodierungsparametern wie Temperatur, Top-P und Token-Limits abbilden.', 'PromptQuorum ermöglicht es Ihnen, denselben Persona-Block an mehrere Prompts über mehrere Provider zu hängen, sodass Sie eine einzelne „risikoscheue Finanzanalyst"-Persona bei Abfragen von GPT-5.5, Gemini 3.1 Pro und LLaMA 3.1 wiederverwenden können, ohne zu kopieren und einzufügen.'],
        },
        techExample: {
        ...
        techExampleTest: {
          content: ['PromptQuorum kann diese Persona plus eine konkrete Aufgabe (zum Beispiel „Analysieren Sie die Auswirkungen des EU-AI-Act auf cloud-gehostete LLMs") an GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro und Mistral Large mit einem Klick senden und zeigen, welches Modell die Einschränkungen am besten respektiert.', '**PromptQuorum-Multi-Modell-Test:** In einem internen PromptQuorum-Experiment mit 40 Finanz- und IT-Persona-Aufforderungen über GPT-5.5, Claude Opus 4.7 und Gemini 3.1 Pro befolgte GPT-5.5 Längen- und Regionsbeschränkungen am strengsten in 26 von 40 Aufgaben, Claude Opus 4.7 stellte in 21 von 40 Aufgaben die meisten Klärungsfragen, und Gemini 3.1 Pro erstellte die dichtesten numerischen Zusammenfassungen in 18 von 40 Aufgaben.'],
        },
        howToBuild: {
        ...
        vsFineTuning: {
          ...
          items: ['Persona-Prompting ändert den Eingabetext; Fine-Tuning ändert Modellparameter.', 'Persona-Prompting funktioniert über GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro und Mistral Large ohne Neutraining; Fine-Tuning ist normalerweise anbieter-spezifisch.', 'Persona-Prompting ist in Sekunden reversibel; Sie können Personas pro Aufgabe oder pro Region (EU vs China vs USA) tauschen, ohne Infrastrukturänderungen.'],
        },
        regionalApproaches: {
    ...
    fr: {
      ...
      sections: {
        ...
        numericThresholds: { content: ['Les prompts persona qui codifient des seuils numériques (par exemple « 80 pour cent de confiance », « jamais plus de 300 tokens dans une réponse », ou « expliquez au niveau anglais B1 ») sont plus faciles à suivre par les modèles que les instructions purement qualitatives. Les modèles comme GPT-5.5 et Claude Opus 4.7 réagissent particulièrement bien aux limites explicites de token, de température et de longueur car ils correspondent directement à des paramètres de décodage internes comme la température, Top-P et les limites de token.', 'PromptQuorum vous permet d\'attacher le même bloc persona à plusieurs prompts dans tous les fournisseurs, afin que vous puissiez réutiliser un seul persona « analyste financier averse au risque » lors de l\'interrogation de GPT-5.5, Gemini 3.1 Pro et LLaMA 3.1 sans copier-coller.'] },
