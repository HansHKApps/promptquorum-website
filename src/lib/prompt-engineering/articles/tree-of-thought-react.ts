...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'Tree of Thought مقابل ReAct 2026: أي تقنية تستخدم',
    metaDescription: 'يستكشف Tree-of-Thought فروع الحل المتعددة للتخطيط؛ يجمع ReAct الاستدلال مع الأدوات. في 2026، أصبح ReAct أصلياً في GPT-5.5 و Claude.',
    educationalLevel: 'Advanced',
