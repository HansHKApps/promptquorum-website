...
export const article: Partial<Record<Language, PEArticle>> = {
  en: {
    ...
    theme: 'Techniques',
    heroImage: '/images/tree-of-thought-react-overview-hero-en.webp',
    ...
    lastFactChecked: '2026-05-03 — Yao et al. ToT/ReAct papers, Claude Opus 5/GPT-5.6/Gemini 3.1 Pro native tool use APIs',
    ...
    quickFacts: [
      ...
      '**Best models for ToT:** Claude Opus 5 (extended thinking), GPT-5.6 (reasoning mode), Gemini 3.1 Pro (Deep Think)',
    ...
    sections: {
      ...
      cotvsTotvsReact: {
        ...
        rows: [
          ...
          },
          {
            ...
            'Tree-of-Thought (ToT)': 'Best with reasoning models (Opus 5, o3)',
      ...
      howToWriteReAct: {
        ...
        content: [
          ...
          '```',
          '**For frontier models with native tool use** (GPT-5.6, Claude Opus 5/Sonnet 5, Gemini 3.1 Pro), you don\'t need to format this manually. Just state what you want to do: "Research the 2026 AI model landscape and compare GPT-5.6, Claude Opus 5, and Gemini 3.1 Pro." The model will call tools automatically, observe results, and continue reasoning.',
        ],
      },
      react2026: {
        id: 'react-2026',
        ...
        callouts: [
          { type: '⚠️', label: 'Warning', text: 'Tree-of-Thought prompts can generate 3-5× the output tokens of a standard prompt because the model writes out multiple branches before selecting one. At $25/1M output tokens (Claude Opus 5), a complex ToT prompt that generates 5,000 tokens costs ~$0.125 per run. Budget accordingly for high-volume use.' },
        ],
      },
      agenticApplications: {
      ...
      tokenCost: {
        ...
        content: [
          ...
          '**Cost at 2026 pricing** (Claude Opus 5: $25/1M output tokens):',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**For research, debugging, or fact-finding → use ReAct or native tool use.** Ask the model to look things up, observe the results, and synthesize. On frontier models (GPT-5.6, Claude Opus 5, Gemini 3.1 Pro), native tool use handles ReAct automatically. On open-weights, you can structure it manually if needed.',
          ...
          '**Test both on your use case in PromptQuorum.** Compare how GPT-5.6, Claude Opus 5, Gemini 3.1 Pro, and Mistral Large handle your specific ToT or ReAct prompt. You\'ll see which model\'s reasoning style fits your task best.',
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      inPromptQuorum: {
        ...
        content: [
          '**PromptQuorum lets you test Tree-of-Thought and ReAct patterns side by side across GPT-5.6, Claude Opus 5, Claude Sonnet 5, Gemini 3.1 Pro, and open-weights models like Mistral Large and LLaMA 4.**',
          'Write a ToT or ReAct prompt once, and PromptQuorum will send it to all models simultaneously. Watch how each one interprets the branching structure or the action-observation loop. Some models (like Claude Opus 5) naturally ask clarifying questions when reasoning through branches. Others (like GPT-5.6) tend to be more direct. Seeing the differences helps you refine your prompting for specific use cases.',
          '**Example workflow:**',
          '1. Write a ToT prompt: "Generate 3 ways to optimize a database query. Evaluate on speed, complexity, and maintainability."',
          '2. Send to GPT-5.6, Claude Opus 5, and Gemini 3.1 Pro via PromptQuorum.',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'For frontier models with native tool use (GPT-5.6, Claude Opus 5, Gemini 3.1 Pro), no. These models implement the Reason-Act-Observe loop automatically via function calling APIs. Manual Thought: / Action: / Observation: formatting is still useful for open-weights models without tool use, for educational purposes, or for simulated scenarios.',
          },
          {
      ...
      sources: {
        ...
        items: [
          ...
          'Anthropic. (2026). "Tool Use — Claude API Documentation." Retrieved from [docs.anthropic.com](https://docs.anthropic.com)',
          'OpenAI. (2026). "Function Calling — Responses API." Retrieved from [platform.openai.com/docs](https://platform.openai.com/docs)',
        ],
      },
    },
  },
  ...
  de: {
    freshness_tier: 'semi_annual',
    theme: 'Techniken',
    heroImage: '/images/tree-of-thought-react-overview-hero-de.webp',
  ...
  es: {
    freshness_tier: 'semi_annual',
    theme: 'Techniques',
    heroImage: '/images/tree-of-thought-react-overview-hero-es.webp',
    ...
    quickFacts: [
      ...
      '**Mejores modelos para ToT:** Claude Opus 5 (pensamiento extendido), GPT-5.6 (modo de razonamiento), Gemini 3.1 Pro (Deep Think)',
    ...
    sections: {
      ...
      cotvsTotvsReact: {
        ...
        rows: [
          ...
          { 'Dimensión': 'Soporte de modelos en 2026', 'Chain-of-Thought (CoT)': 'Todos los modelos', 'Tree-of-Thought (ToT)': 'Mejor con modelos de razonamiento (Opus 5, o3)', 'ReAct': 'Integrado en todos los modelos frontier a través del uso de herramientas' },
      ...
      howToWriteReAct: {
        ...
        content: [
          ...
          '```',
          '**Para modelos frontier con uso nativo de herramientas** (GPT-5.6, Claude Opus 5/Sonnet 5, Gemini 3.1 Pro), no necesitas formatear esto manualmente. Solo indica lo que quieres hacer: "Investiga el panorama de modelos de IA en 2026 y compara GPT-5.6, Claude Opus 5 y Gemini 3.1 Pro." El modelo llamará a las herramientas automáticamente, observará los resultados y continuará razonando.',
        ],
      },
      react2026: {
        id: 'react-2026',
        ...
        content: [
          ...
          '**En 2026, todos los modelos frontier implementan el bucle ReAct automáticamente a través del uso nativo de herramientas / llamada a funciones.** Cuando le pides a GPT-5.6, Claude Opus 5, Gemini 3.1 Pro o Claude Sonnet 5 que investigue un tema, ejecute código o busque algo, el modelo decide cuándo llamar a una herramienta, recibe el resultado y continúa razonando — no se necesita formateo manual de `Thought: / Action: / Observation:`.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Para investigación, debugging o búsqueda de hechos → usa ReAct o el uso nativo de herramientas.** Pide al modelo que busque cosas, observe los resultados y sintetice. En modelos frontier (GPT-5.6, Claude Opus 5, Gemini 3.1 Pro), el uso nativo de herramientas maneja ReAct automáticamente.',
          ...
          '**Prueba ambas en tu caso de uso en PromptQuorum.** Compara cómo GPT-5.6, Claude Opus 5, Gemini 3.1 Pro y Mistral Large manejan tu prompt ToT o ReAct específico. Verás qué estilo de razonamiento del modelo se adapta mejor a tu tarea.',
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      inPromptQuorum: {
        ...
        content: [
          '**PromptQuorum te permite probar los patrones Tree-of-Thought y ReAct en paralelo en GPT-5.6, Claude Opus 5, Claude Sonnet 5, Gemini 3.1 Pro y modelos open-weights como Mistral Large y LLaMA 4.**',
          ...
          '2. Envía a GPT-5.6, Claude Opus 5 y Gemini 3.1 Pro vía PromptQuorum.',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: '¿Todavía necesito formatear ReAct manualmente en 2026?', a: 'Para modelos frontier con uso nativo de herramientas (GPT-5.6, Claude Opus 5, Gemini 3.1 Pro), no. Estos modelos implementan el bucle Reason-Act-Observe automáticamente a través de las APIs de llamada a funciones. El formateo manual sigue siendo útil para modelos open-weights sin uso de herramientas, con fines educativos o en escenarios simulados.' },
          ...
          { q: '¿Qué modelos manejan mejor Tree-of-Thought?', a: 'Los modelos con modos de pensamiento extendido / razonamiento manejan ToT de forma más natural: Claude Opus 5 (pensamiento extendido), GPT-5.6 (modo de razonamiento) y Gemini 3.1 Pro (Deep Think).' },
  ...
  ar: {
    freshness_tier: 'semi_annual',
    theme: 'Techniques',
    heroImage: '/images/tree-of-thought-react-overview-hero-ar.webp',
    ...
    quickFacts: [
      ...
      '**أفضل النماذج لـ ToT:** Claude Opus 5 (التفكير الممتد)، GPT-5.6 (وضع الاستدلال)، Gemini 3.1 Pro (Deep Think)',
    ...
    sections: {
      ...
      cotvsTotvsReact: {
        ...
        rows: [
          ...
          { 'Dimensión': 'دعم النماذج في 2026', 'Chain-of-Thought (CoT)': 'جميع النماذج', 'Tree-of-Thought (ToT)': 'الأفضل مع نماذج الاستدلال (Opus 5، o3)', 'ReAct': 'مدمج في جميع النماذج الحدية عبر استخدام الأدوات' },
      ...
      howToWriteReAct: {
        ...
        content: [
          ...
          '```',
          '**للنماذج الحدية ذات استخدام الأدوات الأصلي** (GPT-5.6، Claude Opus 5/Sonnet 5، Gemini 3.1 Pro)، لا تحتاج إلى تنسيق هذا يدوياً. فقط اذكر ما تريد فعله: "ابحث في مشهد نماذج الذكاء الاصطناعي لعام 2026 وقارن GPT-5.6 و Claude Opus 5 و Gemini 3.1 Pro." سيستدعي النموذج الأدوات تلقائياً، ويلاحظ النتائج، ويواصل الاستدلال.',
        ],
      },
      react2026: {
        id: 'react-2026',
        ...
        content: [
          ...
          '**في 2026، تنفّذ جميع النماذج الحدية حلقة ReAct تلقائياً عبر استخدام الأدوات الأصلي / استدعاء الوظائف.** عندما تطلب من GPT-5.6 أو Claude Opus 5 أو Gemini 3.1 Pro أو Claude Sonnet 5 البحث في موضوع، أو تنفيذ كود، أو البحث عن شيء، يقرر النموذج متى يستدعي أداة، ويستقبل النتيجة، ويواصل الاستدلال — لا تنسيق يدوي لـ `Thought: / Action: / Observation:` مطلوب.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**للبحث أو التصحيح أو البحث عن حقائق → استخدم ReAct أو استخدام الأدوات الأصلي.** اطلب من النموذج البحث عن أشياء، ملاحظة النتائج، والتركيب. في النماذج الحدية (GPT-5.6، Claude Opus 5، Gemini 3.1 Pro)، يتعامل استخدام الأدوات الأصلي مع ReAct تلقائياً.',
          ...
          '**اختبر كليهما في حالة الاستخدام الخاصة بك في PromptQuorum.** قارن كيف يتعامل GPT-5.6 و Claude Opus 5 و Gemini 3.1 Pro و Mistral Large مع موجّه ToT أو ReAct المحدد لديك. سترى أي أسلوب استدلال للنموذج يناسب مهمتك أكثر.',
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      inPromptQuorum: {
        ...
        content: [
          '**يتيح لك PromptQuorum اختبار أنماط Tree-of-Thought و ReAct بالتوازي على GPT-5.6 و Claude Opus 5 و Claude Sonnet 5 و Gemini 3.1 Pro والنماذج ذات الأوزان المفتوحة مثل Mistral Large و LLaMA 4.**',
          ...
          '2. أرسل إلى GPT-5.6 و Claude Opus 5 و Gemini 3.1 Pro عبر PromptQuorum.',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'أي النماذج تتعامل مع Tree-of-Thought بشكل أفضل؟', a: 'النماذج ذات أوضاع التفكير الممتد / الاستدلال تتعامل مع ToT بشكل أكثر طبيعية: Claude Opus 5 (التفكير الممتد)، GPT-5.6 (وضع الاستدلال)، و Gemini 3.1 Pro (Deep Think).' },
      ...
      sources: {
        ...
        items: [
          ...
          'Anthropic. (2026). "توثيق استخدام الأدوات — Claude API." Retrieved from [docs.anthropic.com](https://docs.anthropic.com)',
          'OpenAI. (2026). "استدعاء الدوال — Responses API." Retrieved from [platform.openai.com/docs](https://platform.openai.com/docs)',
        ],
      },
    },
  },
  ...
  pt: {
    theme: 'Techniques',
    heroImage: '/images/tree-of-thought-react-overview-hero-pt.webp',
    ...
    quickFacts: [
      ...
      '**Melhores modelos para ToT:** Claude Opus 5 (extended thinking), GPT-5.6 (modo de raciocínio), Gemini 3.1 Pro (Deep Think)',
    ...
    sections: {
      ...
      cotvsTotvsReact: {
        ...
        rows: [
          ...
          { 'Dimensão': 'Suporte de modelos em 2026', 'Chain-of-Thought (CoT)': 'Todos os modelos', 'Tree-of-Thought (ToT)': 'Melhor com modelos de raciocínio (Opus 5, o3)', 'ReAct': 'Integrado em todos os modelos frontier via uso de ferramentas' },
      ...
      howToWriteReAct: {
        ...
        content: [
          ...
          '```',
          '**Para modelos frontier com uso nativo de ferramentas** (GPT-5.6, Claude Opus 5/Sonnet 5, Gemini 3.1 Pro), você não precisa formatar isso manualmente. Apenas declare o que quer fazer: "Pesquise o cenário de modelos de IA em 2026 e compare GPT-5.6, Claude Opus 5 e Gemini 3.1 Pro." O modelo chamará ferramentas automaticamente, observará os resultados e continuará raciocinan do.',
        ],
      },
      react2026: {
        id: 'react-2026',
        ...
        content: [
          ...
          '**Em 2026, todos os modelos frontier implementam o loop ReAct automaticamente via uso nativo de ferramentas / chamada de funções.** Quando você pede ao GPT-5.6, Claude Opus 5, Gemini 3.1 Pro ou Claude Sonnet 5 que pesquise um tópico, execute código ou busque algo, o modelo decide quando chamar uma ferramenta, recebe o resultado e continua raciocinan do — sem necessidade de formatação manual de `Thought: / Action: / Observation:`.',
        ...
        callouts: [
          { type: '⚠️', label: 'Atenção', text: 'Prompts Tree-of-Thought podem gerar 3–5× os tokens de output de um prompt padrão porque o modelo escreve múltiplas ramificações antes de selecionar uma. A $25/1M tokens de output (Claude Opus 5), um prompt ToT complexo que gera 5.000 tokens custa ~$0,125 por execução. Planeje seu orçamento para uso de alto volume.' },
        ],
      },
      agenticApplications: {
        id: 'agentic-applications',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Para pesquisa, depuração ou busca de fatos → use ReAct ou uso nativo de ferramentas.** Peça ao modelo que busque coisas, observe os resultados e sintetize. Em modelos frontier (GPT-5.6, Claude Opus 5, Gemini 3.1 Pro), o uso nativo de ferramentas trata o ReAct automaticamente.',
          ...
          '**Teste ambas no seu caso de uso no PromptQuorum.** Compare como GPT-5.6, Claude Opus 5, Gemini 3.1 Pro e Mistral Large lidam com seu prompt ToT ou ReAct específico. Você verá qual estilo de raciocínio do modelo se adapta melhor à sua tarefa.',
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      inPromptQuorum: {
        ...
        content: [
          '**O PromptQuorum permite testar os padrões Tree-of-Thought e ReAct lado a lado no GPT-5.6, Claude Opus 5, Claude Sonnet 5, Gemini 3.1 Pro e modelos open-weights como Mistral Large e LLaMA 4.**',
          ...
          '2. Envie para GPT-5.6, Claude Opus 5 e Gemini 3.1 Pro via PromptQuorum.',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'Quais modelos lidam melhor com Tree-of-Thought?', a: 'Modelos com modos de pensamento estendido / raciocínio lidam com ToT de forma mais natural: Claude Opus 5 (extended thinking), GPT-5.6 (modo de raciocínio) e Gemini 3.1 Pro (Deep Think).' },
  ...
  fr: {
    freshness_tier: 'semi_annual',
    theme: 'Techniques',
    heroImage: '/images/tree-of-thought-react-overview-hero-fr.webp',
    ...
    quickFacts: [
      ...
      '**Meilleurs modèles pour ToT :** Claude Opus 5 (extended thinking), GPT-5.6 (reasoning mode), Gemini 3.1 Pro (Deep Think)',
      ...
      cotvsTotvsReact: {
        ...
        rows: [
          ...
          },
          {
            ...
            'Tree-of-Thought (ToT)': 'Meilleur avec modèles de raisonnement (Opus 5, o3)',
...
Réponse finale : [conclusion synthétisée]`,
      ...
      react2026: {
        ...
        content: [
          'Le papier original ReAct (2023) proposait le format Thought/Action/Observation manuel comme pattern de prompting. En 2026, GPT-5.6, Claude Opus 5/Sonnet 5 et Gemini 3.1 Pro implémentent la boucle ReAct automatiquement via Function Calling / outils natifs.',
        ...
        callouts: [
          { type: 'warning', label: 'Warning', text: 'Les prompts Tree-of-Thought peuvent générer 3-5× les tokens de sortie d\'un prompt standard. À €0,025/1M tokens de sortie (Claude Opus 5), un prompt ToT complexe qui génère 5 000 tokens coûte ~€0,125 par exécution. Budgétisez en conséquence.' },
        ],
      },
      agenticApplications: {
        id: 'agentic-applications',
      ...
      tokenCost: {
        ...
        content: [
          ...
          'Exemple de coût à €0,025/1M tokens de sortie (Claude Opus 5) : Un prompt ToT complexe qui génère 5 000 tokens = ~€0,125 par exécution.',
  ...
  ja: {
    freshness_tier: 'semi_annual',
    theme: 'テクニック',
    heroImage: '/images/tree-of-thought-react-overview-hero-ja.webp',
    ...
    quickFacts: [
      ...
      '**ToT 向き最高モデル：** Claude Opus 5 (extended thinking)、GPT-5.6 (reasoning mode)、Gemini 3.1 Pro (Deep Think)',
      ...
      cotvsTotvsReact: {
        ...
        rows: [
          ...
          },
          {
            ...
            'Tree-of-Thought (ToT)': 'reasoning モデル最適（Opus 5、o3）',
...
Final Answer: [総合結論]`,
      ...
      react2026: {
        ...
        content: [
          '「元々の ReAct 論文 (2023)」は手動の Thought/Action/Observation フォーマットをプロンプティングパターンとして提案しました。2026年、GPT-5.6、Claude Opus 5/Sonnet 5、Gemini 3.1 Pro は Function Calling / native tools を通じて ReAct ループを自動実装します。',
        ...
        callouts: [
          { type: 'warning', label: 'Warning', text: 'Tree-of-Thought プロンプトは標準プロンプトの 3-5倍の出力トークンを生成できます。¥0.025/1M出力トークン (Claude Opus 5)、5,000トークン生成する複雑な ToT は実行あたり約¥0.125 かかります。高容量使用に予算を立ててください。' },
        ],
      },
      agenticApplications: {
        id: 'agentic-applications',
      ...
      tokenCost: {
        ...
        content: [
          ...
          'コスト例（Claude Opus 5 で ¥0.025/1M出力トークン）：5,000トークン生成の複雑な ToT = 実行あたり約 ¥0.125。',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: '2026年でもReActを手動でフォーマットする必要がありますか？', a: 'Native tool use 付き frontier モデル (GPT-5.6、Claude Opus 5、Gemini 3.1 Pro) では不要です。これらはループを自動実装します。手動 `Thought:/Action:/Observation:` フォーマットは open-weights モデルや教育・シミュレーション目的で有用です。' },
          ...
          { q: 'どのモデルがTree-of-Thoughtに最適ですか？', a: 'Extended Thinking / Reasoning モード付きモデルが ToT を最も自然に処理：Claude Opus 5 (extended thinking)、GPT-5.6 (reasoning mode)、Gemini 3.1 Pro (Deep Think)。これらは明示的なプロンプトレベル ToT なしで内部的に複数ブランチを探索できます。' },
          ...
          { q: 'Tree-of-Thoughtはトークンコストにどう影響しますか？', a: 'ToT は線形 CoT より大幅に多くのトークンを使用、モデルが複数ブランチ生成後選択するため。標準 CoT プロンプトの出力トークンの 2–5倍を計画。¥0.025/1M (Claude Opus 5)、5,000トークン生成の複雑 ToT = 実行あたり約 ¥0.125。高容量使用に予算を立ててください。' },
  ...
  zh: {
    freshness_tier: 'semi_annual',
    theme: '技巧',
    heroImage: '/images/tree-of-thought-react-overview-hero-zh.webp',
    ...
    quickFacts: [
      ...
      '**ToT 最佳模型：** Claude Opus 5（扩展思维）、GPT-5.6（推理模式）、Gemini 3.1 Pro（深度思维）',
    ...
    sections: {
      ...
      react2026: { id: 'react-2026', title: '2026 年的 ReAct：从提示模式到内置行为', content: ['原始 ReAct 论文（2023）提议手动 Thought/Action/Observation 格式作为提示模式。2026 年，GPT-5.6、Claude Opus 5/Sonnet 5 和 Gemini 3.1 Pro 通过 Function Calling/原生工具自动实现 ReAct 循环。', '模型决定何时调用工具、接收结果、继续推理——无需手动格式化。只需定义可用工具；模型管理循环。', '**手动格式化仍然相关的情况：**', '1. **开源权重模型**：没有原生工具使用（Mistral、旧 LLaMA 变体、Qwen）', '2. **教育/调试上下文**：希望看到完整追踪', '3. **模拟工具交互**：没有真实 API 连接', '**生产 ReAct：** 自主 AI 编码工具（Claude Code、OpenAI Codex、Cursor）是大规模 productionized ReAct，其中"行动"= 文件编辑和测试运行。'], callouts: [{ type: 'warning', label: '警告', text: '树思考提示可以生成标准提示 3-5 倍的输出 token。在 $0.025/1M 输出 token（Claude Opus 5），生成 5,000 token 的复杂 ToT 每次运行成本约为 $0.125。相应进行预算。' }] },
  ...
  ko: {
    freshness_tier: 'semi_annual',
    theme: 'Techniques',
    heroImage: '/images/tree-of-thought-react-overview-hero-ko.webp',
    ...
    quickFacts: [
      ...
      '**ToT에 최적인 모델:** Claude Opus 5(확장 사고), GPT-5.6(추론 모드), Gemini 3.1 Pro(Deep Think)',
    ...
    sections: {
      ...
      cotvsTotvsReact: {
        ...
        rows: [
          ...
          { '차원': '2026년 모델 지원', 'Chain-of-Thought (CoT)': '모든 모델', 'Tree-of-Thought (ToT)': '추론 모델 최적(Opus 5, o3)', 'ReAct': '도구 사용을 통해 모든 프론티어 모델에 내장' },
      ...
      howToWriteReAct: {
        ...
        content: [
          ...
          '```',
          '**네이티브 도구 사용이 가능한 프론티어 모델**(GPT-5.6, Claude Opus 5/Sonnet 5, Gemini 3.1 Pro)의 경우, 이를 수동으로 형식화할 필요가 없습니다. 원하는 것만 말하면 됩니다: "2026년 AI 모델 현황을 조사하고 GPT-5.6, Claude Opus 5, Gemini 3.1 Pro를 비교하십시오." 모델이 자동으로 도구를 호출하고, 결과를 관찰하고, 추론을 계속합니다.',
        ],
      },
      react2026: {
        id: 'react-2026',
        ...
        content: [
          ...
          '**2026년에는 모든 프론티어 모델이 네이티브 도구 사용 / 함수 호출을 통해 ReAct 루프를 자동으로 구현합니다.** GPT-5.6, Claude Opus 5, Gemini 3.1 Pro 또는 Claude Sonnet 5에 주제를 조사하거나, 코드를 실행하거나, 무언가를 조회하도록 요청하면 모델이 도구를 언제 호출할지 결정하고, 결과를 받고, 추론을 계속합니다 — `Thought: / Action: / Observation:` 수동 형식이 필요하지 않습니다.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**연구, 디버깅 또는 팩트 확인을 위해 → ReAct 또는 네이티브 도구 사용을 사용하십시오.** 모델에게 조회하고, 결과를 관찰하고, 종합하도록 요청하십시오. 프론티어 모델(GPT-5.6, Claude Opus 5, Gemini 3.1 Pro)에서는 네이티브 도구 사용이 자동으로 ReAct를 처리합니다.',
          ...
          '**PromptQuorum에서 두 기법을 사용 사례에 맞게 테스트하십시오.** GPT-5.6, Claude Opus 5, Gemini 3.1 Pro, Mistral Large가 특정 ToT 또는 ReAct 프롬프트를 어떻게 처리하는지 비교하십시오. 어느 모델의 추론 스타일이 작업에 가장 적합한지 확인할 수 있습니다.',
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      inPromptQuorum: {
        ...
        content: [
          '**PromptQuorum은 GPT-5.6, Claude Opus 5, Claude Sonnet 5, Gemini 3.1 Pro, Mistral Large, LLaMA 4와 같은 오픈 웨이트 모델에서 Tree-of-Thought와 ReAct 패턴을 나란히 테스트할 수 있게 해줍니다.**',
          ...
          '2. PromptQuorum을 통해 GPT-5.6, Claude Opus 5, Gemini 3.1 Pro로 전송하십시오.',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: '2026년에도 ReAct를 수동으로 형식화해야 합니까?', a: '네이티브 도구 사용이 가능한 프론티어 모델(GPT-5.6, Claude Opus 5, Gemini 3.1 Pro)의 경우 아닙니다. 이러한 모델은 함수 호출 API를 통해 Reason-Act-Observe 루프를 자동으로 구현합니다. 수동 형식은 도구 사용이 없는 오픈 웨이트 모델, 교육 목적 또는 시뮬레이션 시나리오에서 여전히 유용합니다.' },
          ...
          { q: '어떤 모델이 Tree-of-Thought를 가장 잘 처리합니까?', a: '확장 사고 / 추론 모드가 있는 모델이 ToT를 가장 자연스럽게 처리합니다: Claude Opus 5(확장 사고), GPT-5.6(추론 모드), Gemini 3.1 Pro(Deep Think). 이러한 모델은 명시적인 프롬프트 수준의 ToT 형식 없이도 내부적으로 여러 분기를 탐색할 수 있습니다.' },
          ...
          { q: 'Tree-of-Thought는 토큰 비용에 어떤 영향을 미칩니까?', a: 'ToT는 선형 CoT보다 훨씬 더 많은 토큰을 사용합니다 — 모델이 하나를 선택하기 전에 여러 분기를 생성하기 때문입니다. 표준 CoT 프롬프트의 출력 토큰의 2-5배를 예상하십시오. Claude Opus 5 기준 $25/1M 출력 토큰에서 5,000개의 토큰을 생성하는 복잡한 ToT 프롬프트는 실행당 약 $0.125의 비용이 듭니다. 고용량 사용에 맞게 예산을 계획하십시오.' },
        ],
      },
      sources: {
        id: 'sources',
