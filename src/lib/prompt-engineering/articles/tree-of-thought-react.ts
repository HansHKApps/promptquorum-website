...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  es: {
    ...
    seoTitle: 'Tree of Thought vs ReAct 2026: ¿Qué técnica de razonamiento avanzada usar?',
    metaDescription: 'Tree-of-Thought explora múltiples ramas de solución para planificación; ReAct entrelaza el razonamiento con llamadas a herramientas. En 2026, ReAct está integrado de forma nativa en GPT-4o, Claude y Gemini.',
    educationalLevel: 'Advanced',
    ...
    schema: {
      ...
      datePublished: '2026-03-26',
      dateModified: '2026-05-03',
      url: 'https://www.promptquorum.com/prompt-engineering/tree-of-thought-react?lang=es',
      inLanguage: 'es',
    ...
    sections: {
      ...
      cotvsTotvsReact: {
        ...
        rows: [
          ...
          { 'Dimensión': 'Soporte de modelos en 2026', 'Chain-of-Thought (CoT)': 'Todos los modelos', 'Tree-of-Thought (ToT)': 'Mejor con modelos de razonamiento (Opus 4.7, o3)', 'ReAct': 'Integrado en todos los modelos frontier a través del uso de herramientas' },
      ...
      relatedReading: {
        ...
        items: [
          ...
          { title: '¿Qué es el prompt engineering?', url: '/prompt-engineering/what-is-prompt-engineering?lang=es' },
          ...
          { title: '¿GPT, Claude o Gemini? Cómo elegir el modelo adecuado', url: '/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model?lang=es' },
          { title: 'Inyección de prompts y seguridad', url: '/prompt-engineering/prompt-injection-and-security?lang=es' },
        ],
      },
      faqSection: {
        id: 'faq',
        ...
        faqs: [
          ...
          { q: '¿Todavía necesito formatear ReAct manualmente en 2026?', a: 'Para modelos frontier con uso nativo de herramientas (GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro), no. Estos modelos implementan el bucle Reason-Act-Observe automáticamente a través de las APIs de llamada a funciones. El formateo manual sigue siendo útil para modelos open-weights sin uso de herramientas, con fines educativos o en escenarios simulados.' },
          ...
          { q: '¿Qué modelos manejan mejor Tree-of-Thought?', a: 'Los modelos con modos de pensamiento extendido / razonamiento manejan ToT de forma más natural: Claude Opus 4.7 (pensamiento extendido), GPT-4o (modo de razonamiento) y Gemini 3.1 Pro (Deep Think).' },
