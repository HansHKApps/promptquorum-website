...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  ar: {
    ...
    metaDescription: 'Tree-of-Thought يستكشف فروع الحل المتعددة؛ ReAct يدمج الاستدلال مع استدعاءات الأدوات. في 2026، ReAct مدمج أصلاً في GPT-5.5 وClaude وGemini.',
    educationalLevel: 'Advanced',
