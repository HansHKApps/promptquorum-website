...
export const article: Partial<Record<Language, PEArticle>> = {
  en: {
    ...
    lastFactChecked: '2026-05-03 — Yao et al. ToT/ReAct papers, Claude Opus 4.8/GPT-5.5/Gemini 3.1 Pro native tool use APIs',
    ...
    quickFacts: [
      ...
      '**Best models for ToT:** Claude Opus 4.8 (extended thinking), GPT-5.5 (reasoning mode), Gemini 3.1 Pro (Deep Think)',
    ...
    sections: {
      ...
      howToWriteReAct: {
        ...
        content: [
          ...
          '```',
          '**For frontier models with native tool use** (GPT-5.5, Claude Opus 4.8/Sonnet 4.6, Gemini 3.1 Pro), you don\'t need to format this manually. Just state what you want to do: "Research the 2026 AI model landscape and compare GPT-5.5, Claude Opus 4.8, and Gemini 3.1 Pro." The model will call tools automatically, observe results, and continue reasoning.',
        ],
      },
      react2026: {
        id: 'react-2026',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**For research, debugging, or fact-finding → use ReAct or native tool use.** Ask the model to look things up, observe the results, and synthesize. On frontier models (GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro), native tool use handles ReAct automatically. On open-weights, you can structure it manually if needed.',
          ...
          '**Test both on your use case in PromptQuorum.** Compare how GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro, and Mistral Large handle your specific ToT or ReAct prompt. You\'ll see which model\'s reasoning style fits your task best.',
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      inPromptQuorum: {
        ...
        content: [
          '**PromptQuorum lets you test Tree-of-Thought and ReAct patterns side by side across GPT-5.5, Claude Opus 4.8, Claude Sonnet 4.6, Gemini 3.1 Pro, and open-weights models like Mistral Large and LLaMA 4.**',
          ...
          '2. Send to GPT-5.5, Claude Opus 4.8, and Gemini 3.1 Pro via PromptQuorum.',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'For frontier models with native tool use (GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro), no. These models implement the Reason-Act-Observe loop automatically via function calling APIs. Manual Thought: / Action: / Observation: formatting is still useful for open-weights models without tool use, for educational purposes, or for simulated scenarios.',
          },
          {
  ...
  de: {
    ...
    metaDescription: 'Tree-of-Thought erkundet mehrere Lösungszweige; ReAct verschränkt Reasoning mit Tool-Calls. 2026 ist ReAct in GPT-5.5, Claude und Gemini nativ integriert.',
    educationalLevel: 'Advanced',
  ...
  es: {
    ...
    metaDescription: 'Tree-of-Thought explora varias ramas de solución para planificar; ReAct entrelaza razonamiento y herramientas. En 2026, ReAct ya es nativo en GPT-5.5 y Claude.',
    educationalLevel: 'Advanced',
    ...
    quickFacts: [
      ...
      '**Estado en 2026:** ReAct ahora está integrado en los modelos frontier (GPT-5.5, Claude Sonnet 4.6+, Gemini 3.1 Pro) a través del uso nativo de herramientas / llamada a funciones',
      '**Mejores modelos para ToT:** Claude Opus 4.8 (pensamiento extendido), GPT-5.5 (modo de razonamiento), Gemini 3.1 Pro (Deep Think)',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**En 2026, ReAct está en gran medida integrado en los modelos frontier** a través del uso nativo de herramientas / llamada a funciones — no necesitas formatear manualmente `Thought: / Action: / Observation:` en GPT-5.5, Claude o Gemini.',
      ...
      howToWriteReAct: {
        ...
        content: [
          ...
          '```',
          '**Para modelos frontier con uso nativo de herramientas** (GPT-5.5, Claude Opus 4.8/Sonnet 4.6, Gemini 3.1 Pro), no necesitas formatear esto manualmente. Solo indica lo que quieres hacer: "Investiga el panorama de modelos de IA en 2026 y compara GPT-5.5, Claude Opus 4.8 y Gemini 3.1 Pro." El modelo llamará a las herramientas automáticamente, observará los resultados y continuará razonando.',
        ],
      },
      react2026: {
        id: 'react-2026',
        ...
        content: [
          ...
          '**En 2026, todos los modelos frontier implementan el bucle ReAct automáticamente a través del uso nativo de herramientas / llamada a funciones.** Cuando le pides a GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro o Claude Sonnet 4.6 que investigue un tema, ejecute código o busque algo, el modelo decide cuándo llamar a una herramienta, recibe el resultado y continúa razonando — no se necesita formateo manual de `Thought: / Action: / Observation:`.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Para investigación, debugging o búsqueda de hechos → usa ReAct o el uso nativo de herramientas.** Pide al modelo que busque cosas, observe los resultados y sintetice. En modelos frontier (GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro), el uso nativo de herramientas maneja ReAct automáticamente.',
          ...
          '**Prueba ambas en tu caso de uso en PromptQuorum.** Compara cómo GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro y Mistral Large manejan tu prompt ToT o ReAct específico. Verás qué estilo de razonamiento del modelo se adapta mejor a tu tarea.',
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      inPromptQuorum: {
        ...
        content: [
          '**PromptQuorum te permite probar los patrones Tree-of-Thought y ReAct en paralelo en GPT-5.5, Claude Opus 4.8, Claude Sonnet 4.6, Gemini 3.1 Pro y modelos open-weights como Mistral Large y LLaMA 4.**',
          ...
          '2. Envía a GPT-5.5, Claude Opus 4.8 y Gemini 3.1 Pro vía PromptQuorum.',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: '¿Todavía necesito formatear ReAct manualmente en 2026?', a: 'Para modelos frontier con uso nativo de herramientas (GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro), no. Estos modelos implementan el bucle Reason-Act-Observe automáticamente a través de las APIs de llamada a funciones. El formateo manual sigue siendo útil para modelos open-weights sin uso de herramientas, con fines educativos o en escenarios simulados.' },
          ...
          { q: '¿Qué modelos manejan mejor Tree-of-Thought?', a: 'Los modelos con modos de pensamiento extendido / razonamiento manejan ToT de forma más natural: Claude Opus 4.8 (pensamiento extendido), GPT-5.5 (modo de razonamiento) y Gemini 3.1 Pro (Deep Think).' },
  ...
  ar: {
    ...
    metaDescription: '⁨Tree-of-Thought⁩ يستكشف فروع الحل المتعددة؛ ⁨ReAct⁩ يدمج الاستدلال مع استدعاءات الأدوات. في ⁨2026⁩، ⁨ReAct⁩ مدمج أصلاً في ⁨GPT-5.5⁩ و⁨Claude⁩ و⁨Gemini⁩.',
    educationalLevel: 'Advanced',
    ...
    sections: {
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'أي النماذج تتعامل مع Tree-of-Thought بشكل أفضل؟', a: 'النماذج ذات أوضاع التفكير الممتد / الاستدلال تتعامل مع ToT بشكل أكثر طبيعية: Claude Opus 4.8 (التفكير الممتد)، GPT-5.5 (وضع الاستدلال)، و Gemini 3.1 Pro (Deep Think).' },
  ...
  pt: {
    ...
    metaDescription: 'Tree-of-Thought explora múltiplas ramificações de solução para planejamento; ReAct intercala raciocínio com chamadas a ferramentas para pesquisa. Em 2026, o ReAct está integrado nativamente no GPT-5.5, Claude e Gemini.',
    educationalLevel: 'Advanced',
    ...
    quickFacts: [
      ...
      '**Status em 2026:** ReAct agora está integrado nos modelos frontier (GPT-5.5, Claude Sonnet 4.6+, Gemini 3.1 Pro) via uso nativo de ferramentas / chamada de funções',
      '**Melhores modelos para ToT:** Claude Opus 4.8 (extended thinking), GPT-5.5 (modo de raciocínio), Gemini 3.1 Pro (Deep Think)',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**Em 2026, o ReAct está em grande parte integrado nos modelos frontier** via uso nativo de ferramentas / chamada de funções — você não precisa formatar manualmente `Thought: / Action: / Observation:` no GPT-5.5, Claude ou Gemini.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Para pesquisa, depuração ou busca de fatos → use ReAct ou uso nativo de ferramentas.** Peça ao modelo que busque coisas, observe os resultados e sintetize. Em modelos frontier (GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro), o uso nativo de ferramentas trata o ReAct automaticamente.',
          ...
          '**Teste ambas no seu caso de uso no PromptQuorum.** Compare como GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro e Mistral Large lidam com seu prompt ToT ou ReAct específico. Você verá qual estilo de raciocínio do modelo se adapta melhor à sua tarefa.',
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'Quais modelos lidam melhor com Tree-of-Thought?', a: 'Modelos com modos de pensamento estendido / raciocínio lidam com ToT de forma mais natural: Claude Opus 4.8 (extended thinking), GPT-5.5 (modo de raciocínio) e Gemini 3.1 Pro (Deep Think).' },
  ...
  fr: {
    ...
    quickFacts: [
      ...
      '**Meilleurs modèles pour ToT :** Claude Opus 4.8 (extended thinking), GPT-5.5 (reasoning mode), Gemini 3.1 Pro (Deep Think)',
...
Réponse finale : [conclusion synthétisée]`,
      ...
      react2026: {
        ...
        content: [
          'Le papier original ReAct (2023) proposait le format Thought/Action/Observation manuel comme pattern de prompting. En 2026, GPT-5.5, Claude Opus 4.8/Sonnet 4.6 et Gemini 3.1 Pro implémentent la boucle ReAct automatiquement via Function Calling / outils natifs.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          'Testez les deux patterns côte à côte dans PromptQuorum sur GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro',
        ],
      },
      inPromptQuorum: {
        title: 'Dans PromptQuorum',
        content: 'Testez les patterns ToT et ReAct côte à côte sur GPT-5.5, Claude Opus 4.8/Sonnet 4.6, Gemini 3.1 Pro. Mesurez le coût en tokens, la qualité de sortie et la latence sans exposer les données à plusieurs APIs.',
      },
      relatedReading: {
  ...
  ja: {
    ...
    quickFacts: [
      ...
      '**2026年の状況：** ReAct は frontier モデル (GPT-5.5、Claude Sonnet 4.6+、Gemini 3.1 Pro) にネイティブツール使用で統合済み',
      '**ToT 向き最高モデル：** Claude Opus 4.8 (extended thinking)、GPT-5.5 (reasoning mode)、Gemini 3.1 Pro (Deep Think)',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '2026年、ReAct は frontier モデルにネイティブツール使用で統合 — GPT-5.5、Claude、Gemini では Thought:/Action:/Observation: 手動フォーマット不要',
...
Final Answer: [総合結論]`,
      ...
      react2026: {
        ...
        content: [
          '「元々の ReAct 論文 (2023)」は手動の Thought/Action/Observation フォーマットをプロンプティングパターンとして提案しました。2026年、GPT-5.5、Claude Opus 4.8/Sonnet 4.6、Gemini 3.1 Pro は Function Calling / native tools を通じて ReAct ループを自動実装します。',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          'PromptQuorum で両パターンを GPT-5.5、Claude Opus 4.8、Gemini 3.1 Pro で並べてテスト',
        ],
      },
      inPromptQuorum: {
        title: 'PromptQuorum で',
        content: 'ToT と ReAct パターンを GPT-5.5、Claude Opus 4.8/Sonnet 4.6、Gemini 3.1 Pro で並べてテスト。トークンコスト、出力品質、レイテンシを測定。複数 API にデータ露出なし。',
      },
      relatedReading: {
        title: '関連資料',
        items: [
          ...
          { title: 'Few-Shotプロンプティング', url: '/ja/prompt-engineering/few-shot-prompting' },
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: '2026年でもReActを手動でフォーマットする必要がありますか？', a: 'Native tool use 付き frontier モデル (GPT-5.5、Claude Opus 4.8、Gemini 3.1 Pro) では不要です。これらはループを自動実装します。手動 `Thought:/Action:/Observation:` フォーマットは open-weights モデルや教育・シミュレーション目的で有用です。' },
          ...
          { q: 'どのモデルがTree-of-Thoughtに最適ですか？', a: 'Extended Thinking / Reasoning モード付きモデルが ToT を最も自然に処理：Claude Opus 4.8 (extended thinking)、GPT-5.5 (reasoning mode)、Gemini 3.1 Pro (Deep Think)。これらは明示的なプロンプトレベル ToT なしで内部的に複数ブランチを探索できます。' },
  ...
  zh: {
    ...
    quickFacts: [
      ...
      '**2026 年状态：** ReAct 现已内置于前沿模型（GPT-5.5、Claude Sonnet 4.6+、Gemini 3.1 Pro），通过原生工具使用',
      '**ToT 最佳模型：** Claude Opus 4.8（扩展思维）、GPT-5.5（推理模式）、Gemini 3.1 Pro（深度思维）',
    ...
    sections: {
      tldr: { isTldr: true, title: '核心要点', id: 'key-takeaways', items: ['树思考探索多个推理分支、评估、选择最优——像模型响应内的决策树', 'ReAct 在工具行动（搜索、查找、代码执行）与推理之间交替，观察结果——所有现代 AI 代理的基础', '树思考用于探索备选方案（战略、计划、创意）。ReAct 用于信息交互（研究、调试、数据分析）', '2026 年，ReAct 通过原生工具使用内置于前沿模型——GPT-5.5、Claude、Gemini 上无需手动 Thought:/Action:/Observation: 格式化', '树思考使用比线性 CoT 多 2-5 倍的 token。在高风险决策上选择性使用', '两者可组合：战略探索用 ToT，选定分支内的数据驱动执行用 ReAct', '使用 PromptQuorum 在模型间并行测试两种模式'] },
      ...
      react2026: { id: 'react-2026', title: '2026 年的 ReAct：从提示模式到内置行为', content: ['原始 ReAct 论文（2023）提议手动 Thought/Action/Observation 格式作为提示模式。2026 年，GPT-5.5、Claude Opus 4.8/Sonnet 4.6 和 Gemini 3.1 Pro 通过 Function Calling/原生工具自动实现 ReAct 循环。', '模型决定何时调用工具、接收结果、继续推理——无需手动格式化。只需定义可用工具；模型管理循环。', '**手动格式化仍然相关的情况：**', '1. **开源权重模型**：没有原生工具使用（Mistral、旧 LLaMA 变体、Qwen）', '2. **教育/调试上下文**：希望看到完整追踪', '3. **模拟工具交互**：没有真实 API 连接', '**生产 ReAct：** 自主 AI 编码工具（Claude Code、OpenAI Codex、Cursor）是大规模 productionized ReAct，其中"行动"= 文件编辑和测试运行。'], callouts: [{ type: 'warning', label: '警告', text: '树思考提示可以生成标准提示 3-5 倍的输出 token。在 $0.025/1M 输出 token（Claude Opus 4.8），生成 5,000 token 的复杂 ToT 每次运行成本约为 $0.125。相应进行预算。' }] },
      ...
      howToStart: { id: 'how-to-start', title: '入门方法', numberedItems: ['战略/计划 → 使用带明确分支数和评估标准的 ToT', '带工具的研究/调试 → 使用 ReAct（或只在前沿模型上使用原生工具使用）', '组合：计划阶段用 ToT，选定分支内的执行用 ReAct', '在 PromptQuorum 上跨 GPT-5.5、Claude Opus 4.8、Gemini 3.1 Pro 并行测试两种模式'] },
      inPromptQuorum: { title: '在 PromptQuorum 中', content: '跨 GPT-5.5、Claude Opus 4.8/Sonnet 4.6、Gemini 3.1 Pro 并行测试 ToT 和 ReAct 模式。测量 token 成本、输出质量和延迟，无需向多个 API 暴露数据。' },
      relatedReading: { title: '相关阅读', items: [{ title: 'Chain-of-Thought 提示', url: '/zh/prompt-engineering/chain-of-thought-prompting' }, { title: '什么是提示工程？', url: '/zh/prompt-engineering/what-is-prompt-engineering' }, { title: 'Few-Shot 提示', url: '/zh/prompt-engineering/few-shot-prompting' }, { title: '约束提示', url: '/zh/prompt-engineering/constrained-prompting' }, { title: 'GPT、Claude 还是 Gemini？如何选择合适的模型', url: '/zh/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model' }, { title: '提示注入和安全', url: '/zh/prompt-engineering/prompt-injection-and-security' }] },
      faqSection: { id: 'faq', title: '常见问题', faqs: [{ q: '树思考提示是什么？', a: '树思考指示模型探索多条推理路径（如决策树分支），评估每条，然后在给出最终答案前选择最佳路径。与线性 CoT 不同，树思考明确创建并比较多个选项。' }, { q: 'ReAct 提示是什么？', a: 'ReAct（推理+行动）是一个提示框架，其中模型在推理步骤和行动（工具调用、搜索、查找）之间交替。每次行动后，模型观察结果并更新其推理。这个模式是现代 AI 代理的基础。' }, { q: '树思考与 Chain-of-Thought 有何不同？', a: 'Chain-of-Thought 遵循单一线性推理路径。树思考分支为多条路径、评估并选择最优。可以这样想：CoT 是走一条路，ToT 是探索分岔口后再选择要走的路。' }, { q: '2026 年还需要手动格式化 ReAct 吗？', a: '在具有原生工具使用的前沿模型（GPT-5.5、Claude Opus 4.8、Gemini 3.1 Pro）上不需要。这些模型自动实现循环。手动 Thought:/Action:/Observation: 格式化对于没有工具使用的开源权重模型或教学目的仍然有用。' }, { q: '我可以结合树思考和 ReAct 吗？', a: '可以。在战略层面使用 ToT 来探索和比较多个方法，然后在选定分支内使用 ReAct 处理需要工具交互或数据查找的步骤。这在复杂的规划任务中很常见。' }, { q: '哪些模型最适合树思考？', a: '具有扩展思维/推理模式的模型最自然地处理 ToT：Claude Opus 4.8（扩展思维）、GPT-5.5（推理模式）和 Gemini 3.1 Pro（深度思维）。这些模型可以在内部探索多个分支。' }, { q: 'ReAct 的实际应用是什么？', a: '所有现代 AI 代理都是 ReAct 循环：Claude Code（推理代码→编辑→运行测试→观察→迭代）、研究助手（思考问题→Web 搜索→阅读结果→综合）、支持机器人（思考请求→查询知识库→设计响应→验证）。模式从简单查找扩展到数小时的自主会话。' }, { q: '树思考如何影响 Token 成本？', a: '树思考使用明显更多的 token，因为模型生成多个分支后再选择。计划使用标准 CoT 提示输出 token 的 2-5 倍。在 $0.025/1M 输出 token（Claude Opus 4.8），生成 5,000 token 的复杂 ToT 每次运行成本约为 $0.125。为高容量使用进行预算。' }, { q: '中国企业如何确保树思考和 ReAct 的合规性？', a: '根据中国 2021 年《数据安全法》，本地推理满足数据驻留和处理合规要求。树思考和 ReAct 在本地部署模型上支持金融、医疗和法律部门的法规要求，无需将敏感数据发送到外部 API。' }, { q: '我可以在生产环境中使用树思考和 ReAct 吗？', a: '可以。ReAct 是生产 AI 代理（Claude Code、OpenAI Codex）的基本模式。树思考用于复杂的战略决策。为额外的 token 成本进行预算，并在生产案例中测试模型行为。' }] },
  ...
  ko: {
    ...
    metaDescription: 'Tree-of-Thought는 계획을 위해 여러 해결 분기를 탐색하고, ReAct는 추론과 도구 호출을 교차합니다. 2026년에는 ReAct가 GPT-5.5, Claude, Gemini에 기본 탑재됩니다.',
    educationalLevel: 'Advanced',
    ...
    quickFacts: [
      ...
      '**2026년 현황:** ReAct는 이제 프론티어 모델(GPT-5.5, Claude Sonnet 4.6+, Gemini 3.1 Pro)에 네이티브 도구 사용 / 함수 호출을 통해 내장되어 있습니다.',
      '**ToT에 최적인 모델:** Claude Opus 4.8(확장 사고), GPT-5.5(추론 모드), Gemini 3.1 Pro(Deep Think)',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**2026년에는 ReAct가 프론티어 모델에 내장**되어 있습니다 — GPT-5.5, Claude, Gemini에서는 `Thought: / Action: / Observation:`을 수동으로 형식화할 필요가 없습니다.',
      ...
      howToWriteReAct: {
        ...
        content: [
          ...
          '```',
          '**네이티브 도구 사용이 가능한 프론티어 모델**(GPT-5.5, Claude Opus 4.8/Sonnet 4.6, Gemini 3.1 Pro)의 경우, 이를 수동으로 형식화할 필요가 없습니다. 원하는 것만 말하면 됩니다: "2026년 AI 모델 현황을 조사하고 GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro를 비교하십시오." 모델이 자동으로 도구를 호출하고, 결과를 관찰하고, 추론을 계속합니다.',
        ],
      },
      react2026: {
        id: 'react-2026',
        ...
        content: [
          ...
          '**2026년에는 모든 프론티어 모델이 네이티브 도구 사용 / 함수 호출을 통해 ReAct 루프를 자동으로 구현합니다.** GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro 또는 Claude Sonnet 4.6에 주제를 조사하거나, 코드를 실행하거나, 무언가를 조회하도록 요청하면 모델이 도구를 언제 호출할지 결정하고, 결과를 받고, 추론을 계속합니다 — `Thought: / Action: / Observation:` 수동 형식이 필요하지 않습니다.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**연구, 디버깅 또는 팩트 확인을 위해 → ReAct 또는 네이티브 도구 사용을 사용하십시오.** 모델에게 조회하고, 결과를 관찰하고, 종합하도록 요청하십시오. 프론티어 모델(GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro)에서는 네이티브 도구 사용이 자동으로 ReAct를 처리합니다.',
          ...
          '**PromptQuorum에서 두 기법을 사용 사례에 맞게 테스트하십시오.** GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro, Mistral Large가 특정 ToT 또는 ReAct 프롬프트를 어떻게 처리하는지 비교하십시오. 어느 모델의 추론 스타일이 작업에 가장 적합한지 확인할 수 있습니다.',
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      inPromptQuorum: {
        ...
        content: [
          '**PromptQuorum은 GPT-5.5, Claude Opus 4.8, Claude Sonnet 4.6, Gemini 3.1 Pro, Mistral Large, LLaMA 4와 같은 오픈 웨이트 모델에서 Tree-of-Thought와 ReAct 패턴을 나란히 테스트할 수 있게 해줍니다.**',
          ...
          '2. PromptQuorum을 통해 GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro로 전송하십시오.',
      ...
      relatedReading: {
        ...
        items: [
          ...
          { title: 'Few-Shot 프롬프팅', url: '/ko/prompt-engineering/few-shot-prompting' },
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: '2026년에도 ReAct를 수동으로 형식화해야 합니까?', a: '네이티브 도구 사용이 가능한 프론티어 모델(GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro)의 경우 아닙니다. 이러한 모델은 함수 호출 API를 통해 Reason-Act-Observe 루프를 자동으로 구현합니다. 수동 형식은 도구 사용이 없는 오픈 웨이트 모델, 교육 목적 또는 시뮬레이션 시나리오에서 여전히 유용합니다.' },
          ...
          { q: '어떤 모델이 Tree-of-Thought를 가장 잘 처리합니까?', a: '확장 사고 / 추론 모드가 있는 모델이 ToT를 가장 자연스럽게 처리합니다: Claude Opus 4.8(확장 사고), GPT-5.5(추론 모드), Gemini 3.1 Pro(Deep Think). 이러한 모델은 명시적인 프롬프트 수준의 ToT 형식 없이도 내부적으로 여러 분기를 탐색할 수 있습니다.' },
