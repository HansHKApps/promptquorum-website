...
export const article: Partial<Record<Language, PEArticle>> = {
  en: {
    ...
    lastFactChecked: '2026-05-03 — Yao et al. ToT/ReAct papers, Claude Opus 4.8/GPT-4o/Gemini 3.1 Pro native tool use APIs',
    ...
    quickFacts: [
      ...
      '**Best models for ToT:** Claude Opus 4.8 (extended thinking), GPT-4o (reasoning mode), Gemini 3.1 Pro (Deep Think)',
    ...
    sections: {
      ...
      howToWriteReAct: {
        ...
        content: [
          ...
          '```',
          '**For frontier models with native tool use** (GPT-4o, Claude Opus 4.8/Sonnet 4.6, Gemini 3.1 Pro), you don\'t need to format this manually. Just state what you want to do: "Research the 2026 AI model landscape and compare GPT-4o, Claude Opus 4.8, and Gemini 3.1 Pro." The model will call tools automatically, observe results, and continue reasoning.',
        ],
      },
      react2026: {
        id: 'react-2026',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**For research, debugging, or fact-finding → use ReAct or native tool use.** Ask the model to look things up, observe the results, and synthesize. On frontier models (GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro), native tool use handles ReAct automatically. On open-weights, you can structure it manually if needed.',
          ...
          '**Test both on your use case in PromptQuorum.** Compare how GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro, and Mistral Large handle your specific ToT or ReAct prompt. You\'ll see which model\'s reasoning style fits your task best.',
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      inPromptQuorum: {
        ...
        content: [
          '**PromptQuorum lets you test Tree-of-Thought and ReAct patterns side by side across GPT-4o, Claude Opus 4.8, Claude Sonnet 4.6, Gemini 3.1 Pro, and open-weights models like Mistral Large and LLaMA 4.**',
          ...
          '2. Send to GPT-4o, Claude Opus 4.8, and Gemini 3.1 Pro via PromptQuorum.',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'For frontier models with native tool use (GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro), no. These models implement the Reason-Act-Observe loop automatically via function calling APIs. Manual Thought: / Action: / Observation: formatting is still useful for open-weights models without tool use, for educational purposes, or for simulated scenarios.',
          },
          {
