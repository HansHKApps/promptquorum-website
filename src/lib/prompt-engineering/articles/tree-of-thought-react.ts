...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  es: {
    ...
    metaDescription: 'Tree-of-Thought explora varias ramas de solución para planificar; ReAct entrelaza razonamiento y herramientas. En 2026, ReAct ya es nativo en GPT-4o y Claude.',
    educationalLevel: 'Advanced',
    ...
    quickFacts: [
      ...
      '**Mejores modelos para ToT:** Claude Opus 4.8 (pensamiento extendido), GPT-4o (modo de razonamiento), Gemini 3.1 Pro (Deep Think)',
    ...
    sections: {
      ...
      howToWriteReAct: {
        ...
        content: [
          ...
          '```',
          '**Para modelos frontier con uso nativo de herramientas** (GPT-4o, Claude Opus 4.8/Sonnet 4.6, Gemini 3.1 Pro), no necesitas formatear esto manualmente. Solo indica lo que quieres hacer: "Investiga el panorama de modelos de IA en 2026 y compara GPT-4o, Claude Opus 4.8 y Gemini 3.1 Pro." El modelo llamará a las herramientas automáticamente, observará los resultados y continuará razonando.',
        ],
      },
      react2026: {
        id: 'react-2026',
        ...
        content: [
          ...
          '**En 2026, todos los modelos frontier implementan el bucle ReAct automáticamente a través del uso nativo de herramientas / llamada a funciones.** Cuando le pides a GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro o Claude Sonnet 4.6 que investigue un tema, ejecute código o busque algo, el modelo decide cuándo llamar a una herramienta, recibe el resultado y continúa razonando — no se necesita formateo manual de `Thought: / Action: / Observation:`.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Para investigación, debugging o búsqueda de hechos → usa ReAct o el uso nativo de herramientas.** Pide al modelo que busque cosas, observe los resultados y sintetice. En modelos frontier (GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro), el uso nativo de herramientas maneja ReAct automáticamente.',
          ...
          '**Prueba ambas en tu caso de uso en PromptQuorum.** Compara cómo GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro y Mistral Large manejan tu prompt ToT o ReAct específico. Verás qué estilo de razonamiento del modelo se adapta mejor a tu tarea.',
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      inPromptQuorum: {
        ...
        content: [
          '**PromptQuorum te permite probar los patrones Tree-of-Thought y ReAct en paralelo en GPT-4o, Claude Opus 4.8, Claude Sonnet 4.6, Gemini 3.1 Pro y modelos open-weights como Mistral Large y LLaMA 4.**',
          ...
          '2. Envía a GPT-4o, Claude Opus 4.8 y Gemini 3.1 Pro vía PromptQuorum.',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: '¿Todavía necesito formatear ReAct manualmente en 2026?', a: 'Para modelos frontier con uso nativo de herramientas (GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro), no. Estos modelos implementan el bucle Reason-Act-Observe automáticamente a través de las APIs de llamada a funciones. El formateo manual sigue siendo útil para modelos open-weights sin uso de herramientas, con fines educativos o en escenarios simulados.' },
          ...
          { q: '¿Qué modelos manejan mejor Tree-of-Thought?', a: 'Los modelos con modos de pensamiento extendido / razonamiento manejan ToT de forma más natural: Claude Opus 4.8 (pensamiento extendido), GPT-4o (modo de razonamiento) y Gemini 3.1 Pro (Deep Think).' },
  ...
  fr: {
    ...
    quickFacts: [
      ...
      '**Meilleurs modèles pour ToT :** Claude Opus 4.8 (extended thinking), GPT-4o (reasoning mode), Gemini 3.1 Pro (Deep Think)',
...
Réponse finale : [conclusion synthétisée]`,
      ...
      react2026: {
        ...
        content: [
          'Le papier original ReAct (2023) proposait le format Thought/Action/Observation manuel comme pattern de prompting. En 2026, GPT-4o, Claude Opus 4.8/Sonnet 4.6 et Gemini 3.1 Pro implémentent la boucle ReAct automatiquement via Function Calling / outils natifs.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          'Testez les deux patterns côte à côte dans PromptQuorum sur GPT-4o, Claude Opus 4.8, Gemini 3.1 Pro',
        ],
      },
      inPromptQuorum: {
        title: 'Dans PromptQuorum',
        content: 'Testez les patterns ToT et ReAct côte à côte sur GPT-4o, Claude Opus 4.8/Sonnet 4.6, Gemini 3.1 Pro. Mesurez le coût en tokens, la qualité de sortie et la latence sans exposer les données à plusieurs APIs.',
      },
      relatedReading: {
  ...
  ja: {
    ...
    quickFacts: [
      ...
      '**ToT 向き最高モデル：** Claude Opus 4.8 (extended thinking)、GPT-4o (reasoning mode)、Gemini 3.1 Pro (Deep Think)',
...
Final Answer: [総合結論]`,
      ...
      react2026: {
        ...
        content: [
          '「元々の ReAct 論文 (2023)」は手動の Thought/Action/Observation フォーマットをプロンプティングパターンとして提案しました。2026年、GPT-4o、Claude Opus 4.8/Sonnet 4.6、Gemini 3.1 Pro は Function Calling / native tools を通じて ReAct ループを自動実装します。',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          'PromptQuorum で両パターンを GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro で並べてテスト',
        ],
      },
      inPromptQuorum: {
        title: 'PromptQuorum で',
        content: 'ToT と ReAct パターンを GPT-4o、Claude Opus 4.8/Sonnet 4.6、Gemini 3.1 Pro で並べてテスト。トークンコスト、出力品質、レイテンシを測定。複数 API にデータ露出なし。',
      },
      relatedReading: {
        title: '関連資料',
        items: [
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: '2026年でもReActを手動でフォーマットする必要がありますか？', a: 'Native tool use 付き frontier モデル (GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro) では不要です。これらはループを自動実装します。手動 `Thought:/Action:/Observation:` フォーマットは open-weights モデルや教育・シミュレーション目的で有用です。' },
          ...
          { q: 'どのモデルがTree-of-Thoughtに最適ですか？', a: 'Extended Thinking / Reasoning モード付きモデルが ToT を最も自然に処理：Claude Opus 4.8 (extended thinking)、GPT-4o (reasoning mode)、Gemini 3.1 Pro (Deep Think)。これらは明示的なプロンプトレベル ToT なしで内部的に複数ブランチを探索できます。' },
  ...
  zh: {
    ...
    quickFacts: [
      ...
      '**ToT 最佳模型：** Claude Opus 4.8（扩展思维）、GPT-4o（推理模式）、Gemini 3.1 Pro（深度思维）',
    ...
    sections: {
      ...
      react2026: { id: 'react-2026', title: '2026 年的 ReAct：从提示模式到内置行为', content: ['原始 ReAct 论文（2023）提议手动 Thought/Action/Observation 格式作为提示模式。2026 年，GPT-4o、Claude Opus 4.8/Sonnet 4.6 和 Gemini 3.1 Pro 通过 Function Calling/原生工具自动实现 ReAct 循环。', '模型决定何时调用工具、接收结果、继续推理——无需手动格式化。只需定义可用工具；模型管理循环。', '**手动格式化仍然相关的情况：**', '1. **开源权重模型**：没有原生工具使用（Mistral、旧 LLaMA 变体、Qwen）', '2. **教育/调试上下文**：希望看到完整追踪', '3. **模拟工具交互**：没有真实 API 连接', '**生产 ReAct：** 自主 AI 编码工具（Claude Code、OpenAI Codex、Cursor）是大规模 productionized ReAct，其中"行动"= 文件编辑和测试运行。'], callouts: [{ type: 'warning', label: '警告', text: '树思考提示可以生成标准提示 3-5 倍的输出 token。在 $0.025/1M 输出 token（Claude Opus 4.8），生成 5,000 token 的复杂 ToT 每次运行成本约为 $0.125。相应进行预算。' }] },
      ...
      howToStart: { id: 'how-to-start', title: '入门方法', numberedItems: ['战略/计划 → 使用带明确分支数和评估标准的 ToT', '带工具的研究/调试 → 使用 ReAct（或只在前沿模型上使用原生工具使用）', '组合：计划阶段用 ToT，选定分支内的执行用 ReAct', '在 PromptQuorum 上跨 GPT-4o、Claude Opus 4.8、Gemini 3.1 Pro 并行测试两种模式'] },
      inPromptQuorum: { title: '在 PromptQuorum 中', content: '跨 GPT-4o、Claude Opus 4.8/Sonnet 4.6、Gemini 3.1 Pro 并行测试 ToT 和 ReAct 模式。测量 token 成本、输出质量和延迟，无需向多个 API 暴露数据。' },
