...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    es: {
      ...
      schema: {
        ...
        datePublished: '2026-04-10',
        dateModified: '2026-04-29',
        url: 'https://www.promptquorum.com/es/es/prompt-engineering/how-to-evaluate-prompt-quality',
        inLanguage: 'es',
        proficiencyLevel: 'Intermediate',
        about: [
    ...
    ar: {
      ...
      seoTitle: 'تقييم جودة البرومبت: المقاييس والاختبارات',
      metaDescription: 'قيّم جودة البرومبت باستخدام مجموعات الاختبار، والتسجيل الثنائي pass/fail، وLLM-as-judge. قِس الدقة والاتساق ومعدل اتباع التعليمات.',
