      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[أفضل أدوات تحسين البرومبت للفرق](/ar/prompt-engineering/best-prompt-optimization-tools-teams) — أدوات تتضمن إدارة مجموعات الاختبار وتتبع معدلات النجاح',
    ...
    sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Melhores ferramentas de otimização de prompts para equipes](/pt/prompt-engineering/best-prompt-optimization-tools-teams) — Ferramentas que incluem gerenciamento de conjuntos de teste e acompanhamento de taxas de aprovação',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[팀을 위한 최고의 프롬프트 최적화 도구](/ko/prompt-engineering/best-prompt-optimization-tools-teams) — 테스트 세트 관리 및 통과율 추적을 포함하는 도구',
