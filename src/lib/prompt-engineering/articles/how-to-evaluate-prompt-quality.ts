...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      quickFacts: [
        ...
        'GPT-4o and Claude Opus 4.7 score 10–20 points differently on the same prompt on average',
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Does prompt quality differ between GPT-4o and Claude Opus 4.7?', acceptedAnswer: { '@type': 'Answer', text: 'Yes, significantly. The same prompt regularly scores 10-20 points differently between GPT-4o and Claude Opus 4.7 due to differences in instruction-format sensitivity and system prompt handling. Always measure pass rate separately on each model you plan to deploy. A prompt that scores 95% on GPT-4o may score 80% on Claude Opus 4.7 without model-specific tuning.' } },
          { '@type': 'Question', name: 'What is LLM-as-judge scoring and when should I use it?', acceptedAnswer: { '@type': 'Answer', text: 'LLM-as-judge uses a capable model like GPT-4o or Claude Opus 4.7 to score outputs against a rubric prompt. The judge receives the original input, your model\'s output, and evaluation criteria, then returns a score with justification. Use LLM-as-judge for free-text outputs where binary pass/fail is insufficient. It scales to thousands of test cases without human review, making it ideal for continuous evaluation pipelines.' } },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Use PromptQuorum to dispatch the same test set to GPT-4o and Claude Opus 4.7 and compare pass rates side-by-side',
          ],
        },
        definition: {
        ...
        multiModel: {
          ...
          content: '**Yes — the same prompt can score 20+ points differently between GPT-4o and Claude Opus 4.7, primarily due to instruction-format sensitivity and system prompt handling.**\n\nQuality gaps are largest for:\n\n- **JSON output formatting:** Claude Opus 4.7 follows complex schemas more strictly than GPT-4o\n- **Instruction priority:** GPT-4o weights the most recent instruction; Claude Opus 4.7 weights the system prompt\n- **Refusal patterns:** OpenAI and Anthropic models have different thresholds for borderline content\n\nOur evaluation of classification and formatting prompts across both models (updated through April 2026) found pass rate differences of 10–20 points, with JSON output formatting producing the largest gaps. See [how to test prompts across models](/prompt-engineering/how-to-test-prompts-across-models) for a full multi-model evaluation methodology.\n\nUse PromptQuorum to dispatch the same test set to GPT-4o, Claude Opus 4.7, and Gemini 2.5 Pro in one run and compare pass rates side-by-side.',
          callouts: [
            { type: 'warning', label: 'Warning', text: 'Do not assume a prompt that passes on GPT-4o will pass on Claude Opus 4.7. Run the same test set on every model you plan to deploy — a prompt may need model-specific tuning.' },
          ],
        },
        howToStart: {
          id: 'how-to-start',
          ...
          numberedItems: [
            ...
            'Dispatch the same test set to GPT-4o and Claude Opus 4.7 via PromptQuorum and compare model-level pass rates.',
        ...
        commonMistakes: {
          ...
          mistakes: [
            ...
            },
            {
              ...
              problem: 'The same prompt regularly scores 10-20 points differently between GPT-4o and Claude Opus 4.7. Assuming one model\'s pass rate applies to another leads to production surprises.',
              fix: 'Run the test set separately on each model you plan to deploy. GPT-4o, Claude Opus 4.7, and Gemini 2.5 Pro all need independent evaluation.',
            },
            {
              mistake: 'No baseline',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'Does prompt quality differ between GPT-4o and Claude Opus 4.7?', a: 'Yes, significantly. The same prompt regularly scores 10-20 points differently between GPT-4o and Claude Opus 4.7 due to differences in instruction-format sensitivity and system prompt handling. Always measure pass rate separately on each model you plan to deploy. A prompt that scores 95% on GPT-4o may score 80% on Claude Opus 4.7 without model-specific tuning.' },
            { q: 'What is LLM-as-judge scoring and when should I use it?', a: 'LLM-as-judge uses a capable model like GPT-4o or Claude Opus 4.7 to score outputs against a rubric prompt. The judge receives the original input, your model\'s output, and evaluation criteria, then returns a score with justification. Use LLM-as-judge for free-text outputs where binary pass/fail is insufficient. It scales to thousands of test cases without human review, making it ideal for continuous evaluation pipelines.' },
    ...
    de: {
      ...
      quickFacts: [
        ...
        'GPT-4o und Claude Opus 4.7 unterscheiden sich durchschnittlich um 10–20 Punkte beim Scoring desselben Prompts',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Nutze PromptQuorum, um denselben Test-Set zu GPT-4o und Claude Opus 4.7 zu leiten und Pass-Raten Seite-an-Seite zu vergleichen',
          ],
        },
        definition: {
          id: 'what-is-prompt-quality',
        ...
        commonMistakes: {
          ...
          mistakes: [
            ...
            },
            {
              ...
              problem: 'Derselbe Prompt scored regelmäßig 10-20 Punkte unterschiedlich zwischen GPT-4o und Claude Opus 4.7. Eine Pass-Rate von einem Modell auf ein anderes anzunehmen, führt zu Produktions-Überraschungen.',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'Unterscheidet sich die Prompt-Qualität zwischen GPT-4o und Claude Opus 4.7?', a: 'Ja, erheblich. Derselbe Prompt scored regelmäßig 10-20 Punkte unterschiedlich zwischen GPT-4o und Claude Opus 4.7 aufgrund von Unterschieden in der Instruction-Format-Sensitivität und dem System-Prompt-Handling. Messe die Pass-Rate immer separat auf jedem Modell, das du einsetzen möchtest. Ein Prompt, der auf GPT-4o 95 % scored, kann auf Claude Opus 4.7 ohne modellspezifisches Tuning 80 % scored.' },
            { q: 'Was ist LLM-as-Judge Scoring und wann sollte ich es verwenden?', a: 'LLM-as-Judge nutzt ein leistungsstarkes Modell wie GPT-4o oder Claude Opus 4.7, um Ausgaben gegen eine Rubrik zu bewerten. Der Judge erhält die ursprüngliche Eingabe, deine Modell-Ausgabe und Evaluierungskriterien und liefert dann einen Score mit Begründung. Verwende LLM-as-Judge für Free-Text-Ausgaben, wo Binary Pass/Fail nicht ausreicht. Es skaliert auf Tausende Test-Fälle ohne menschliche Überprüfung, was es ideal für kontinuierliche Evaluierungs-Pipelines macht.' },
    ...
    es: {
      ...
      seoTitle: 'Cómo evaluar la calidad de los prompts: métricas, pruebas y checklist (2026)',
      metaDescription: 'Aprende a evaluar la calidad de los prompts con conjuntos de prueba, puntuación pass/fail y LLM-as-judge. Framework para precisión, consistencia y tasa de seguimiento de instrucciones.',
      ...
      quickFacts: [
        ...
        'GPT-4o y Claude Opus 4.7 puntúan en promedio 10–20 puntos de forma diferente en el mismo prompt',
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: '¿Difiere la calidad de los prompts entre GPT-4o y Claude Opus 4.7?', acceptedAnswer: { '@type': 'Answer', text: 'Sí, significativamente. El mismo prompt puntúa regularmente 10–20 puntos de forma diferente entre GPT-4o y Claude Opus 4.7 debido a diferencias en la sensibilidad al formato de instrucciones y el manejo del prompt del sistema. Mide siempre la tasa de éxito por separado en cada modelo que planees desplegar.' } },
          { '@type': 'Question', name: '¿Qué es la puntuación LLM-as-judge y cuándo debo usarla?', acceptedAnswer: { '@type': 'Answer', text: 'LLM-as-judge usa un modelo capaz como GPT-4o o Claude Opus 4.7 para puntuar salidas contra una rúbrica. El juez recibe la entrada original, la salida de tu modelo y los criterios de evaluación, luego devuelve una puntuación con justificación. Úsalo para salidas de texto libre donde el pass/fail binario es insuficiente. Escala a miles de casos de prueba sin revisión humana.' } },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Usa PromptQuorum para despachar el mismo conjunto de prueba a GPT-4o y Claude Opus 4.7 y comparar las tasas de éxito lado a lado',
          ],
        },
        definition: {
          id: 'what-is-prompt-quality',
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            'Despacha el mismo conjunto de prueba a GPT-4o y Claude Opus 4.7 vía PromptQuorum y compara las tasas de éxito por modelo.',
        ...
        commonMistakes: {
          ...
          mistakes: [
            ...
            },
            {
              ...
              problem: 'El mismo prompt puntúa regularmente 10–20 puntos de forma diferente entre GPT-4o y Claude Opus 4.7. Asumir que la tasa de éxito de un modelo aplica a otro lleva a sorpresas en producción.',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: '¿Difiere la calidad de los prompts entre GPT-4o y Claude Opus 4.7?', a: 'Sí, significativamente. El mismo prompt puntúa regularmente 10–20 puntos de forma diferente. Mide siempre la tasa de éxito por separado en cada modelo que planees desplegar.' },
    ...
    fr: {
      ...
      quickFacts: [
        ...
        'GPT-4o et Claude Opus 4.7 diffèrent en moyenne de 10–20 points dans le scoring du même prompt',
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'La qualité des prompts diffère-t-elle entre GPT-4o et Claude Opus 4.7 ?', acceptedAnswer: { '@type': 'Answer', text: 'Oui, considérablement. Le même prompt score régulièrement 10-20 points différemment entre GPT-4o et Claude Opus 4.7 en raison de différences dans la sensibilité aux formats d\'instructions et la gestion du prompt système. Mesurez toujours le taux de passage séparément sur chaque modèle que vous prévoyez de déployer. Un prompt qui score 95 % sur GPT-4o peut score 80 % sur Claude Opus 4.7 sans tuning modèle-spécifique.' } },
          { '@type': 'Question', name: 'Qu\'est-ce que le scoring LLM-as-Judge et quand l\'utiliser ?', acceptedAnswer: { '@type': 'Answer', text: 'LLM-as-Judge utilise un modèle capable comme GPT-4o ou Claude Opus 4.7 pour évaluer les sorties contre une rubrique. Le juge reçoit l\'entrée originale, la sortie de votre modèle et les critères d\'évaluation, puis retourne un score avec justification. Utilisez LLM-as-Judge pour les sorties de texte libre où Pass/Fail binaire n\'est pas suffisant. Cela s\'adapte à des milliers de cas de test sans révision humaine, le rendant idéal pour les pipelines d\'évaluation continus.' } },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Utilisez PromptQuorum pour diriger le même ensemble de tests vers GPT-4o et Claude Opus 4.7 et comparer les taux de passage côte à côte',
          ],
        },
        definition: {
          id: 'what-is-prompt-quality',
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            'Dirigez le même ensemble de tests vers GPT-4o et Claude Opus 4.7 via PromptQuorum et comparez les taux de passage au niveau du modèle.',
        ...
        commonMistakes: {
          ...
          mistakes: [
            ...
            },
            {
              ...
              problem: 'Le même prompt score régulièrement 10-20 points différemment entre GPT-4o et Claude Opus 4.7. En supposant que le taux de passage d\'un modèle s\'applique à un autre conduit à des surprises en production.',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'La qualité diffère-t-elle entre GPT-4o et Claude Opus 4.7 ?', a: 'Oui, considérablement. Le même prompt score régulièrement 10-20 points différemment entre GPT-4o et Claude Opus 4.7 en raison de différences dans la sensibilité aux formats d\'instructions et la gestion du prompt système. Mesurez toujours le taux de passage séparément sur chaque modèle que vous prévoyez de déployer. Un prompt qui score 95 % sur GPT-4o peut score 80 % sur Claude Opus 4.7 sans tuning modèle-spécifique.' },
            { q: 'Qu\'est-ce que le scoring LLM-as-Judge et quand l\'utiliser ?', a: 'LLM-as-Judge utilise un modèle capable comme GPT-4o ou Claude Opus 4.7 pour évaluer les sorties contre une rubrique. Le juge reçoit l\'entrée originale, la sortie de votre modèle et les critères d\'évaluation, puis retourne un score avec justification. Utilisez LLM-as-Judge pour les sorties de texte libre où Pass/Fail binaire n\'est pas suffisant. Cela s\'adapte à des milliers de cas de test sans révision humaine, le rendant idéal pour les pipelines d\'évaluation continus.' },
    ...
    ja: {
      ...
      quickFacts: [
        ...
        'GPT-4o と Claude Opus 4.7 は同じプロンプトで平均10～20ポイント異なるスコアをつける',
