      ...
      sections: {
        ...
        security: {
          ...
          content: [
            ...
            'Transformer-based models — the architecture behind GPT-5.5, Claude Opus 4.7, and dedicated code security tools — achieve 94% accuracy in bug classification benchmarks, with very low false positive rates. This represents a measurable advance over convolutional neural network (CNN) and recurrent neural network (RNN) approaches at 89%, static analysis at 72%, and rule-based methods at 65%.',
      ...
      sections: {
        ...
        contextWindow: {
          ...
          rows: [
            ...
            { Modell: 'Claude Opus 4.7', 'Context Window': '200k tokens', 'Codezeilen (ungefähr)': '~150.000 Zeilen', 'Anwendungsfall': 'Multi-File Refactoring' },
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**Verwenden Sie Multi-Model Code Review für hochriskante Änderungen.** Führen Sie den Code durch GPT-5.5, Claude Opus 4.7 und Gemini 3.1 Pro aus.',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'Welches KI Modell ist am besten für Code Review?', a: 'Claude Opus 4.7 erzeugt die vollständigste Sicherheitsanalyse. GPT-5.5 erzeugt die actionable Fix-Vorschläge. Gemini 3.1 Pro verarbeitet die größten Codebases.' },
      ...
      sections: {
        ...
        contextWindow: {
          ...
          rows: [
            ...
            { Modèle: 'Claude Opus 4.7', 'Context Window': '200k tokens', 'Lignes de Code (Approx.)': '~150 000 lignes', 'Cas d\'Usage': 'Refactorisation Multi-Fichier' },
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**Utilisez la révision de code multi-modèle pour les changements à haut risque.** Exécutez le code via GPT-5.5, Claude Opus 4.7 et Gemini 3.1 Pro.',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'Quel modèle IA est le meilleur pour la révision de code ?', a: 'Claude Opus 4.7 produit l\'analyse de sécurité la plus complète. GPT-5.5 produit les suggestions de correctifs les plus exploitables. Gemini 3.1 Pro traite les plus grandes bases de code.' },
      ...
      sections: {
        ...
        contextWindow: {
          ...
          rows: [
            ...
            { モデル: 'Claude Opus 4.7', 'コンテキストウィンドウ': '200k tokens', 'コード行（概算）': '~150,000 行', 'ユースケース': 'マルチファイルリファクタリング' },
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**高リスク変更にはマルチモデルコードレビューを使用します。** GPT-5.5、Claude Opus 4.7、Gemini 3.1 Pro 経由でコードを実行します。',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'コードレビューに最適なAI モデルはどれですか？', a: 'Claude Opus 4.7 は最も完全なセキュリティ分析を生成。GPT-5.5 は最も実行可能なフィックス提案を生成。Gemini 3.1 Pro は最大のコードベースを処理。' },
      ...
      sections: {
        ...
        contextWindow: {
          ...
          rows: [
            ...
            { 模型: 'Claude Opus 4.7', '上下文窗口': '200k tokens', '代码行（约）': '~150,000 行', '用例': '多文件重构' },
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**使用思维链提示：指示模型追踪执行。**',
            '**对高风险更改使用多模型代码审查。** 通过 GPT-5.5、Claude Opus 4.7 和 Gemini 3.1 Pro 运行代码。',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: '哪个 AI 模型最适合代码审查？', a: 'Claude Opus 4.7 生成最完整的安全分析。GPT-5.5 生成最可执行的修复建议。Gemini 3.1 Pro 处理最大的代码库。' },
