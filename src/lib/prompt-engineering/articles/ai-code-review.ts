...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      seoTitle: 'مراجعة الكود بالذكاء الاصطناعي 2026: Snyk مقابل Greptile مقابل CodeRabbit',
      metaDescription: 'Snyk مقابل Greptile مقابل CodeRabbit مقارنةً: تكتشف 42 إلى 85٪ من الأخطاء مقابل 20٪ لـ SAST. معايير الأداء والأسعار ومتى تستخدم كل منها.',
