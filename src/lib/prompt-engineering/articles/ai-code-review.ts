    ...
    en: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          rows: [
            { Tool: '[Greptile](https://greptile.com)', 'Bug Detection': '85%', 'False Positive Rate': 'Sub-3%', 'Context Depth': 'Full codebase', 'Price/Dev/Month': '$30' },
            { Tool: '[Qodo](https://qodo.ai)', 'Bug Detection': '78%', 'False Positive Rate': 'Low', 'Context Depth': 'Multi-repo', 'Price/Dev/Month': 'From $19' },
            { Tool: '[CodeRabbit](https://coderabbit.ai)', 'Bug Detection': '46%', 'False Positive Rate': '10–15%', 'Context Depth': 'PR diff', 'Price/Dev/Month': '$12–24' },
            { Tool: '[Cursor Bugbot](https://cursor.com/bugbot)', 'Bug Detection': '42%', 'False Positive Rate': 'Sub-15%', 'Context Depth': 'PR diff', 'Price/Dev/Month': '$40 (above Cursor base)' },
            { Tool: '[GitHub Copilot](https://github.com/features/copilot)', 'Bug Detection': 'Basic', 'False Positive Rate': 'Under 15%', 'Context Depth': 'File-level', 'Price/Dev/Month': '$10–39 (bundled)' },
        ...
        security: {
          ...
          rows: [
            { Tool: '[Snyk Code + DeepCode AI](https://snyk.io)', 'Detection Score (AI code)': '92/100', 'False Positives': 'Lowest volume', 'Best For': 'Teams shipping daily with IDE integration' },
            { Tool: '[Semgrep Enterprise](https://semgrep.dev)', 'Detection Score (AI code)': '87/100', 'False Positives': 'Low', 'Best For': 'Policy-as-code; custom YAML rule packs' },
            { Tool: '[GitHub Advanced Security (CodeQL)](https://codeql.github.com)', 'Detection Score (AI code)': '84/100', 'False Positives': 'Medium', 'Best For': 'GitHub-first orgs; deep semantic coverage' },
          ],
          tableFormat: true,
    ...
    de: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          rows: [
            { Tool: '[Greptile](https://greptile.com)', 'Bug Erkennung': '85%', 'False-Positive-Rate': 'unter-3%', 'Kontext-Tiefe': 'Vollständige Codebase', 'Preis/Dev/Monat': '$30' },
            { Tool: '[Qodo](https://qodo.ai)', 'Bug Erkennung': '78%', 'False-Positive-Rate': 'Niedrig', 'Kontext-Tiefe': 'Multi-Repo', 'Preis/Dev/Monat': 'ab $19' },
            { Tool: '[CodeRabbit](https://coderabbit.ai)', 'Bug Erkennung': '46%', 'False-Positive-Rate': '10–15%', 'Kontext-Tiefe': 'PR diff', 'Preis/Dev/Monat': '$12–24' },
            { Tool: '[GitHub Copilot](https://github.com/features/copilot)', 'Bug Erkennung': 'Einfach', 'False-Positive-Rate': 'unter-15%', 'Kontext-Tiefe': 'Datei-Ebene', 'Preis/Dev/Monat': '$10–39 (gebündelt)' },
          ],
          tableFormat: true,
        },
        signalToNoise: {
        ...
        security: {
          ...
          rows: [
            { Tool: '[Snyk Code + DeepCode AI](https://snyk.io)', 'Erkennungswert': '92/100', 'False Positives': 'Niedrigste Lautstärke', 'Best für': 'Teams mit täglicher Auslieferung' },
            { Tool: '[Semgrep Enterprise](https://semgrep.dev)', 'Erkennungswert': '87/100', 'False Positives': 'Niedrig', 'Best für': 'Policy-as-Code' },
            { Tool: '[GitHub Advanced Security](https://codeql.github.com)', 'Erkennungswert': '84/100', 'False Positives': 'Mittel', 'Best für': 'GitHub-First Organisationen' },
          ],
          tableFormat: true,
        },
        bugTriaging: {
    ...
    pt: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          rows: [
            { 'Ferramenta': '[Greptile](https://greptile.com)', 'Detecção de Bugs': '85%', 'Taxa de Falsos Positivos': 'Menos de 3%', 'Profundidade de Contexto': 'Base de código completa', 'Preço/Dev/Mês': '$30' },
            { 'Ferramenta': '[Qodo](https://qodo.ai)', 'Detecção de Bugs': '78%', 'Taxa de Falsos Positivos': 'Baixa', 'Profundidade de Contexto': 'Multi-repositório', 'Preço/Dev/Mês': 'A partir de $19' },
            { 'Ferramenta': '[CodeRabbit](https://coderabbit.ai)', 'Detecção de Bugs': '46%', 'Taxa de Falsos Positivos': '10–15%', 'Profundidade de Contexto': 'Diff de PR', 'Preço/Dev/Mês': '$12–24' },
            { 'Ferramenta': '[Cursor Bugbot](https://cursor.com/bugbot)', 'Detecção de Bugs': '42%', 'Taxa de Falsos Positivos': 'Menos de 15%', 'Profundidade de Contexto': 'Diff de PR', 'Preço/Dev/Mês': '$40 (acima da base do Cursor)' },
            { 'Ferramenta': '[GitHub Copilot](https://github.com/features/copilot)', 'Detecção de Bugs': 'Básica', 'Taxa de Falsos Positivos': 'Menos de 15%', 'Profundidade de Contexto': 'Nível de arquivo', 'Preço/Dev/Mês': '$10–39 (incluído)' },
        ...
        security: {
          ...
          rows: [
            { 'Ferramenta': '[Snyk Code + DeepCode AI](https://snyk.io)', 'Pontuação de Detecção (código IA)': '92/100', 'Falsos Positivos': 'Volume mais baixo', 'Ideal Para': 'Equipes com entregas diárias com integração IDE' },
            { 'Ferramenta': '[Semgrep Enterprise](https://semgrep.dev)', 'Pontuação de Detecção (código IA)': '87/100', 'Falsos Positivos': 'Baixo', 'Ideal Para': 'Policy-as-code; pacotes de regras YAML personalizadas' },
            { 'Ferramenta': '[GitHub Advanced Security (CodeQL)](https://codeql.github.com)', 'Pontuação de Detecção (código IA)': '84/100', 'Falsos Positivos': 'Médio', 'Ideal Para': 'Organizações GitHub-first; cobertura semântica profunda' },
          ],
          tableFormat: true,
  ...
  ko: {
    ...
    sections: {
      ...
      toolComparison: {
        ...
        columns: ['도구', '버그 감지', '허위 양성률', '컨텍스트 깊이', '가격/개발자/월'],
        rows: [
      ...
      security: {
        ...
        columns: ['도구', '감지 점수 (AI 코드)', '허위 양성', '최적 사용 사례'],
        rows: [
