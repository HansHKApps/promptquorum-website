    ...
    de: {
      ...
      sections: {
        ...
        contextWindow: {
          ...
          rows: [
            { Modell: 'GPT-5.6 (OpenAI)', 'Context Window': '128k tokens', 'Codezeilen (ungefähr)': '~96.000 Zeilen', 'Anwendungsfall': 'Standard PR Review' },
            { Modell: 'Claude Opus 5', 'Context Window': '200k tokens', 'Codezeilen (ungefähr)': '~150.000 Zeilen', 'Anwendungsfall': 'Multi-File Refactoring' },
    ...
    fr: {
      ...
      sections: {
        ...
        contextWindow: {
          ...
          rows: [
            { Modèle: 'GPT-5.6 (OpenAI)', 'Context Window': '128k tokens', 'Lignes de Code (Approx.)': '~96 000 lignes', 'Cas d\'Usage': 'Révision PR Standard' },
            { Modèle: 'Claude Opus 5', 'Context Window': '200k tokens', 'Lignes de Code (Approx.)': '~150 000 lignes', 'Cas d\'Usage': 'Refactorisation Multi-Fichier' },
    ...
    ja: {
      ...
      sections: {
        ...
        contextWindow: {
          ...
          rows: [
            { モデル: 'GPT-5.6 (OpenAI)', 'コンテキストウィンドウ': '128k tokens', 'コード行（概算）': '~96,000 行', 'ユースケース': '標準PR レビュー' },
            { モデル: 'Claude Opus 5', 'コンテキストウィンドウ': '200k tokens', 'コード行（概算）': '~150,000 行', 'ユースケース': 'マルチファイルリファクタリング' },
    ...
    zh: {
      ...
      sections: {
        ...
        contextWindow: {
          ...
          rows: [
            { 模型: 'GPT-5.6 (OpenAI)', '上下文窗口': '128k tokens', '代码行（约）': '~96,000 行', '用例': '标准 PR 审查' },
            { 模型: 'Claude Opus 5', '上下文窗口': '200k tokens', '代码行（约）': '~150,000 行', '用例': '多文件重构' },
