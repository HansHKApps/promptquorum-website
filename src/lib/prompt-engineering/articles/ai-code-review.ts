  ...
  ko: {
    ...
    sections: {
      ...
      toolComparison: {
        ...
        rows: [
          { '도구': 'Greptile', '버그 감지': '85%', '허위 양성률': '3% 미만', '컨텍스트 깊이': '전체 코드베이스', '가격/개발자/월': '$30' },
          { '도구': 'Qodo', '버그 감지': '78%', '허위 양성률': '낮음', '컨텍스트 깊이': '멀티 저장소', '가격/개발자/월': '$19부터' },
          { '도구': 'CodeRabbit', '버그 감지': '46%', '허위 양성률': '10~15%', '컨텍스트 깊이': 'PR diff', '가격/개발자/월': '$12~24' },
          { '도구': 'Cursor Bugbot', '버그 감지': '42%', '허위 양성률': '15% 미만', '컨텍스트 깊이': 'PR diff', '가격/개발자/월': '$40 (Cursor 기본 위)' },
          { '도구': 'GitHub Copilot', '버그 감지': '기본', '허위 양성률': '15% 미만', '컨텍스트 깊이': '파일 수준', '가격/개발자/월': '$10~39 (포함)' },
      ...
      security: {
        ...
        rows: [
          { '도구': 'Snyk Code + DeepCode AI', '감지 점수 (AI 코드)': '92/100', '허위 양성': '가장 낮은 볼륨', '최적 사용 사례': 'IDE 통합과 함께 일일 배포를 하는 팀' },
          { '도구': 'Semgrep Enterprise', '감지 점수 (AI 코드)': '87/100', '허위 양성': '낮음', '최적 사용 사례': 'Policy-as-code; 커스텀 YAML 규칙 팩' },
          { '도구': 'GitHub Advanced Security (CodeQL)', '감지 점수 (AI 코드)': '84/100', '허위 양성': '중간', '최적 사용 사례': 'GitHub-first 조직; 깊은 의미적 커버리지' },
        ],
        tableFormat: true,
