      ...
      sections: {
        ...
        security: {
          ...
          content: [
            ...
            'Transformer-based models — the architecture behind GPT-5.6, Claude Opus 4.8, and dedicated code security tools — achieve 94% accuracy in bug classification benchmarks, with very low false positive rates. This represents a measurable advance over convolutional neural network (CNN) and recurrent neural network (RNN) approaches at 89%, static analysis at 72%, and rule-based methods at 65%.',
      ...
      sections: {
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**Verwenden Sie Multi-Model Code Review für hochriskante Änderungen.** Führen Sie den Code durch GPT-5.6, Claude Opus 4.8 und Gemini 3.1 Pro aus.',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'Welches KI Modell ist am besten für Code Review?', a: 'Claude Opus 4.8 erzeugt die vollständigste Sicherheitsanalyse. GPT-5.6 erzeugt die actionable Fix-Vorschläge. Gemini 3.1 Pro verarbeitet die größten Codebases.' },
      ...
      sections: {
        ...
        security: {
          ...
          content: [
            ...
            'Los modelos basados en transformadores — la arquitectura detrás de GPT-5.6, Claude Opus 4.8 y herramientas de seguridad de código dedicadas — logran el 94 % de precisión en benchmarks de clasificación de bugs, con tasas de falsos positivos muy bajas.',
      ...
      sections: {
        ...
        security: {
          ...
          content: [
            ...
            'النماذج القائمة على المحوِّل — المعمارية وراء GPT-5.6 وClaude Opus 4.8 وأدوات أمان الكود المتخصصة — تحقق 94٪ دقة في معايير تصنيف الأخطاء، مع معدلات نتائج إيجابية كاذبة منخفضة جدًا.',
      ...
      sections: {
        ...
        security: {
          ...
          content: [
            ...
            'Modelos baseados em transformadores — a arquitetura por trás do GPT-5.6, Claude Opus 4.8 e ferramentas de segurança de código dedicadas — alcançam 94% de precisão em benchmarks de classificação de bugs, com taxas de falsos positivos muito baixas.',
      ...
      sections: {
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**Utilisez la révision de code multi-modèle pour les changements à haut risque.** Exécutez le code via GPT-5.6, Claude Opus 4.8 et Gemini 3.1 Pro.',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'Quel modèle IA est le meilleur pour la révision de code ?', a: 'Claude Opus 4.8 produit l\'analyse de sécurité la plus complète. GPT-5.6 produit les suggestions de correctifs les plus exploitables. Gemini 3.1 Pro traite les plus grandes bases de code.' },
      ...
      sections: {
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**高リスク変更にはマルチモデルコードレビューを使用します。** GPT-5.6、Claude Opus 4.8、Gemini 3.1 Pro 経由でコードを実行します。',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'コードレビューに最適なAI モデルはどれですか？', a: 'Claude Opus 4.8 は最も完全なセキュリティ分析を生成。GPT-5.6 は最も実行可能なフィックス提案を生成。Gemini 3.1 Pro は最大のコードベースを処理。' },
      ...
      sections: {
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**使用思维链提示：指示模型追踪执行。**',
            '**对高风险更改使用多模型代码审查。** 通过 GPT-5.6、Claude Opus 4.8 和 Gemini 3.1 Pro 运行代码。',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: '哪个 AI 模型最适合代码审查？', a: 'Claude Opus 4.8 生成最完整的安全分析。GPT-5.6 生成最可执行的修复建议。Gemini 3.1 Pro 处理最大的代码库。' },
    ...
    sections: {
      ...
      security: {
        ...
        content: [
          ...
          'GPT-5.6, Claude Opus 4.8, 전용 코드 보안 도구 뒤의 아키텍처인 트랜스포머 기반 모델은 버그 분류 벤치마크에서 94% 정확도를 달성하며 허위 양성률이 매우 낮습니다.',
