...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      theme: 'Techniques', heroImage: '/images/structured-output-json-mode-overview-hero-en.png',
    ...
    de: {
      theme: 'Techniques', heroImage: '/images/structured-output-json-mode-overview-hero-de.png',
    ...
    es: {
      theme: 'Techniques', heroImage: '/images/structured-output-json-mode-overview-hero-es.png',
    ...
    ar: {
      theme: 'Techniques', heroImage: '/images/structured-output-json-mode-overview-hero-ar.png',
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'هل تدعم جميع النماذج اللغوية الكبيرة وضع JSON؟', acceptedAnswer: { '@type': 'Answer', text: 'لا. OpenAI GPT-5.6 وAnthropic Claude Sonnet 5 وGoogle Gemini تدعم وضع JSON الأصيل. النماذج الأقدم والنماذج مفتوحة المصدر قد تتطلب تطبيقاً قائماً على البرومبت.' } },
    ...
    pt: {
      theme: 'Techniques', heroImage: '/images/structured-output-json-mode-overview-hero-pt.png',
