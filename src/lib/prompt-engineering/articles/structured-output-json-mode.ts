...
export const article: Partial<Record<Language, PEArticle>> = {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[سلسلة الأفكار](/ar/prompt-engineering/chain-of-thought) — التفكير خطوة بخطوة قبل إعادة المخرجات المهيكلة.',
            '[قوالب البرومبت](/ar/prompt-engineering/prompt-templates) — أنماط قابلة لإعادة الاستخدام لمهام المخرجات المهيكلة الشائعة.',
        ...
        sources: {
          ...
          items: [
            ...
            '[واجهة برمجة تطبيقات Google Gemini – المخرجات المهيكلة](https://ai.google.dev/gemini-2/docs/structured-output) — دعم وضع JSON الأصيل من Google في Gemini 2.0.',
    ...
    pt: {
      ...
      schema: {
        ...
        datePublished: '2026-03-26',
        url: 'https://www.promptquorum.com/pt/prompt-engineering/structured-output-json-mode',
        inLanguage: 'pt-BR',
        author: { '@type': 'Person', name: 'Hans Kuepper', url: 'https://www.promptquorum.com/about' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      ...
      sections: {
        ...
        sources: {
          ...
          items: [
            ...
            '[API Google Gemini](https://ai.google.dev/gemini-2/docs/structured-output)',
