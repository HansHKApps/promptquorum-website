      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Chain of Thought](/es/prompt-engineering/chain-of-thought) — razona paso a paso antes de devolver salidas estructuradas.',
            '[Plantillas de prompts](/es/prompt-engineering/prompt-templates) — patrones reutilizables para tareas comunes de salida estructurada.',
