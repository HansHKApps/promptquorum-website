...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    de: {
      ...
      sections: {
        ...
        practicesAddendum: {
          content: [
            'Wenn weiterhin Formatierungsprobleme auftreten, kann die einfache Anweisung "Im Zweifel das Feld als leeren String belassen statt zu raten" hinzugefügt werden. Strukturierte Ausgabe funktioniert am besten in Kombination mit [RAG (Retrieval-Augmented Generation)]((/prompt-engineering/rag-explained?lang=de)) zur Faktenprüfung extrahierter Daten. Müssen diese extrahierten Daten Ihre Infrastruktur nicht verlassen, funktionieren dieselben JSON-Mode-Muster auch gegen einen On-Premise-Vektor-Store — siehe [Lokales RAG für Geschäftsdaten](/power-local-llm/local-rag-for-private-business-data?lang=de) für die DSGVO-konforme Architektur.',
          ],
        },
        modelComparison: {
    ...
    es: {
      ...
      schema: {
        ...
        author: { '@type': 'Person', name: 'Hans Kuepper', url: 'https://www.promptquorum.com/about' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
        url: 'https://www.promptquorum.com/prompt-engineering/structured-output-json-mode?lang=es',
        inLanguage: 'es',
      },
      howToSchema: {
        '@context': 'https://schema.org',
        ...
        step: [
          { '@type': 'HowToStep', position: 1, name: 'Elegir el modo JSON', text: 'Para extracción de datos y salidas legibles por máquinas, usa el modo JSON disponible en OpenAI GPT-4o, Anthropic Claude, Google Gemini y otros proveedores principales. Esto garantiza que el modelo devuelva JSON válido, no prosa.' },
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: '¿Todos los LLMs admiten el modo JSON?', acceptedAnswer: { '@type': 'Answer', text: 'No. OpenAI GPT-4o, Anthropic Claude 3.5+ y Google Gemini admiten el modo JSON nativo. Los modelos más antiguos y los LLMs de código abierto pueden requerir aplicación basada en prompts.' } },
      ...
      sections: {
        ...
        modelComparison: {
          ...
          rows: [
            { 'Modelo': 'OpenAI GPT-4o', 'Modo JSON nativo': 'Sí (impuesto)', 'Cumplimiento solo con prompt': 'No necesario', 'Notas': 'Estándar de la industria para el modo JSON; tasa de éxito > 99%.' },
            { 'Modelo': 'Anthropic Claude 3.5 Sonnet', 'Modo JSON nativo': 'Sí (impuesto)', 'Cumplimiento solo con prompt': 'No necesario', 'Notas': 'Excelente cumplimiento JSON; admite estructuras anidadas complejas.' },
            ...
            { 'Modelo': 'Meta Llama 3.1 (70B)', 'Modo JSON nativo': 'Parcial', 'Cumplimiento solo con prompt': 'Muy recomendado', 'Notas': 'Código abierto; funciona bien con prompts detallados y ejemplos.' },
        ...
        relatedReading: {
          ...
          items: [
            '[Prompting con restricciones](/prompt-engineering/constrained-prompting?lang=es) — impone formatos de salida específicos y presupuestos de tokens.',
            '[Framework SPECS](/prompt-engineering/specs-framework?lang=es) — prompts centrados en especificaciones para un comportamiento fiable del modelo.',
            '[RAG explicado](/prompt-engineering/rag-explained?lang=es) — combina extracción estructurada con recuperación de datos en tiempo real.',
            '[Chain of Thought](/prompt-engineering/chain-of-thought?lang=es) — razona paso a paso antes de devolver salidas estructuradas.',
            '[Plantillas de prompts](/prompt-engineering/prompt-templates?lang=es) — patrones reutilizables para tareas comunes de salida estructurada.',
            '[Zero-Shot vs Few-Shot](/prompt-engineering/zero-shot-vs-few-shot?lang=es) — cuándo los ejemplos (few-shot) mejoran el cumplimiento JSON.',
          ],
        },
        faq: {
          ...
          faqs: [
            ...
            { q: '¿Todos los LLMs admiten el modo JSON?', a: 'No. OpenAI GPT-4o, Anthropic Claude 3.5+ y Google Gemini admiten el modo JSON nativo. Los modelos más antiguos y los LLMs de código abierto pueden requerir aplicación basada en prompts.' },
        ...
        sources: {
          ...
          items: [
            ...
            '[API de Google Gemini – Salida estructurada](https://ai.google.dev/gemini-2/docs/structured-output) — Soporte nativo del modo JSON de Google en Gemini 2.0.',
