        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'No. OpenAI GPT-5.5, Anthropic Claude 3.5+, and Google Gemini support native JSON mode. Older models and open-source LLMs may require prompt-based enforcement (e.g., specifying the schema in instructions and providing examples).',
            },
            {
    ...
    de: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Unterstützen alle LLMs den JSON-Modus?', acceptedAnswer: { '@type': 'Answer', text: 'Nein. OpenAI GPT-5.5, Anthropic Claude 3.5+ und Google Gemini unterstützen nativen JSON-Modus. Ältere Modelle und Open-Source-LLMs benötigen möglicherweise Prompt-basierte Erzwingung.' } },
