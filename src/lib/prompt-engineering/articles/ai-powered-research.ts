...
export const article: Partial<Record<Language, PEArticle>> = {
      ...
      howToSchema: {
        ...
        step: [
          ...
          },
          {
            ...
            text: 'Run your research question through GPT-5.5, Claude Opus 4.8, and Gemini 3.1 Pro simultaneously to detect hallucinations.',
          },
          {
            '@type': 'HowToStep',
            position: 5,
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'This depends on the model\'s context window. GPT-5.5 (OpenAI) handles ~100 standard academic pages per session (128k token context). Claude Opus 4.8 (Anthropic) handles ~160 pages (200k tokens). Gemini 3.1 Pro (Google DeepMind) handles ~800 pages (1M tokens). For larger corpora, a RAG (Retrieval-Augmented Generation) pipeline with a vector database is required.',
            },
            {
      ...
      howToSchema: {
        ...
        step: [
          ...
          },
          {
            ...
            text: 'Führen Sie Ihre Forschungsfrage gleichzeitig durch GPT-5.5, Claude Opus 4.8 und Gemini 3.1 Pro aus, um Halluzinationen zu erkennen.',
          },
          {
            '@type': 'HowToStep',
            position: 5,
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Das hängt vom Context-Window des Modells ab. GPT-5.5 (OpenAI) verarbeitet ~100 Standard-Akademie-Seiten pro Sitzung (128k Token Context). Claude Opus 4.8 (Anthropic) verarbeitet ~160 Seiten (200k Tokens). Gemini 3.1 Pro (Google DeepMind) verarbeitet ~800 Seiten (1M Tokens). Für größere Korpora ist eine RAG (Retrieval-Augmented Generation) Pipeline mit Vektor-Datenbank erforderlich.',
            },
          },
          {
            '@type': 'Question',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Multi-Modell-Cross-Checking (GPT-5.5 + Claude Opus 4.8 + Gemini 3.1 Pro) erkennt Halluzinationen, die Single-Modell-Workflows verpassen',
        ...
        quickFacts: {
          ...
          items: [
            ...
            'Gemini 3.1 Pros 1M-Token Context Window verarbeitet ~800 akademische Seiten pro Sitzung; GPT-5.5 ~100, Claude ~160',
        ...
        multiModelCheck: {
          ...
          content: [
            '**Multi-Modell-Cross-Checking – das Ausführen der gleichen Forschungsfrage durch GPT-5.5, Claude Opus 4.8 und Gemini 3.1 Pro gleichzeitig – erkennt Halluzinationen, die Single-Modell-Workflows verpassen, weil unabhängige Modelle den gleichen spezifischen falschen Anspruch selten fabrizieren.**',
            ...
            'PromptQuorum ist ein Multi-Modell-KI-Dispatch-Tool, das einen Prompt gleichzeitig an mehrere KI-Anbieter sendet und alle Responses nebeneinander zurückgibt. Für Forschungs-Workflows bedeutet das, eine Zitations- oder Fakten-Aussage durch GPT-5.5 (OpenAI), Claude Opus 4.8 (Anthropic) und Gemini 3.1 Pro (Google DeepMind) in einer Dispatch auszuführen – und zu überprüfen, wo die drei Modelle konvergieren oder divergieren.',
            '**Getestet in PromptQuorum – 30 Forschungs-Zitations-Prompts über drei Modelle:** Alle drei Modelle (GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro) stimmten dem gleichen Zitationsformat und DOI in 22 von 30 Fällen zu. In 8 Fällen produzierte mindestens ein Modell einen anderen Autornamen oder Journal-Volume – alle 8 Fälle wurden auf manuelle Verifizierung gegen Google Scholar als Halluzinationen bestätigt.',
          ],
          items: [
            '**Generieren** – Fragen Sie ein Modell (z.B. Claude Opus 4.8), eine Literaturzusammenfassung mit Zitaten zu produzieren',
            '**Cross-Check** – Dispatchen Sie die gleiche Frage an GPT-5.5 und Gemini 3.1 Pro über PromptQuorum',
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**Nutzen Sie Multi-Modell-Cross-Checking, um halluzinierte Zitate zu erkennen.** Führen Sie die gleiche Forschungsfrage durch GPT-5.5, Claude Opus 4.8 und Gemini 3.1 Pro über PromptQuorum aus. Jedes Zitat, bei dem Modelle bei Autor, Jahr oder Journal uneinig sind, erfordert manuelle Verifizierung in Google Scholar oder PubMed.',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Das hängt vom Context-Window des Modells ab. GPT-5.5 (OpenAI) verarbeitet ~100 Standard-Akademie-Seiten pro Sitzung (128k Token Context). Claude Opus 4.8 (Anthropic) verarbeitet ~160 Seiten (200k Tokens). Gemini 3.1 Pro (Google DeepMind) verarbeitet ~800 Seiten (1M Tokens). Für größere Korpora ist eine RAG (Retrieval-Augmented Generation) Pipeline mit Vektor-Datenbank erforderlich.',
            },
            {
      ...
      howToSchema: {
        ...
        step: [
          ...
          },
          {
            ...
            text: 'Ejecuta tu pregunta de investigación simultáneamente en GPT-5.5, Claude Opus 4.8 y Gemini 3.1 Pro para detectar alucinaciones.',
          },
          {
            '@type': 'HowToStep',
            position: 5,
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Depende de la ventana de contexto del modelo. GPT-5.5 (OpenAI) maneja ~100 páginas académicas estándar por sesión (contexto de 128k tokens). Claude Opus 4.8 (Anthropic) maneja ~160 páginas (200k tokens). Gemini 3.1 Pro (Google DeepMind) maneja ~800 páginas (1M tokens). Para corpus más grandes, se requiere un pipeline RAG con base de datos vectorial.',
            },
          },
          {
            '@type': 'Question',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'La verificación cruzada multi-modelo (GPT-5.5 + Claude Opus 4.8 + Gemini 3.1 Pro) detecta alucinaciones que los flujos de trabajo de un solo modelo pierden',
        ...
        quickFacts: {
          ...
          items: [
            ...
            'La ventana de contexto de 1M tokens de Gemini 3.1 Pro procesa ~800 páginas académicas por sesión; GPT-5.5 maneja ~100, Claude ~160',
        ...
        multiModelCheck: {
          ...
          content: [
            '**La verificación cruzada multi-modelo — ejecutar la misma pregunta de investigación en GPT-5.5, Claude Opus 4.8 y Gemini 3.1 Pro simultáneamente — detecta alucinaciones que los flujos de trabajo de un solo modelo pierden, porque los modelos independientes raramente fabrican la misma afirmación falsa específica.**',
            ...
            'PromptQuorum es una herramienta de despacho de IA multi-modelo que envía un prompt a múltiples proveedores de IA simultáneamente y devuelve todas las respuestas lado a lado. Para flujos de trabajo de investigación, esto significa ejecutar una cita o afirmación factual en GPT-5.5 (OpenAI), Claude Opus 4.8 (Anthropic) y Gemini 3.1 Pro (Google DeepMind) en un solo despacho — y revisar dónde convergen o divergen los tres modelos.',
            '**Probado en PromptQuorum — 30 prompts de citas de investigación en tres modelos:** Los tres modelos (GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro) coincidieron en el mismo formato de cita y DOI en 22 de 30 casos. En 8 casos, al menos un modelo produjo un nombre de autor o volumen de revista diferente — los 8 casos fueron confirmados como alucinaciones en la verificación manual contra Google Scholar.',
          ],
          items: [
            '**Generar** — Pide a un modelo (p. ej., Claude Opus 4.8) que produzca un resumen bibliográfico con citas',
            '**Verificación cruzada** — Despacha la misma pregunta a GPT-5.5 y Gemini 3.1 Pro mediante PromptQuorum',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Depende de la ventana de contexto del modelo. GPT-5.5 (OpenAI) maneja ~100 páginas académicas estándar por sesión (contexto de 128k tokens). Claude Opus 4.8 (Anthropic) maneja ~160 páginas (200k tokens). Gemini 3.1 Pro (Google DeepMind) maneja ~800 páginas (1M tokens). Para corpus más grandes, se requiere un pipeline RAG con base de datos vectorial.',
            },
            {
    ...
    ar: {
      ...
      seoTitle: 'البحث بالذكاء الاصطناعي: تحقق من الاقتباسات وتجنب الهلوسة',
      metaDescription: 'قلِّل مراجعة الأدبيات من أسابيع إلى ساعات. اكتشف الهلوسة (9.2٪) وتحقق من الاقتباسات باستخدام Elicit وConsensus وscite.ai. سير العمل بالذكاء الاصطناعي.',
      ...
      howToSchema: {
        ...
        step: [
          ...
          },
          {
            ...
            text: 'شغِّل سؤالك البحثي في GPT-5.5 وClaude Opus 4.8 وGemini 3.1 Pro في آنٍ واحد لاكتشاف الهلوسة.',
          },
          {
            '@type': 'HowToStep',
            position: 5,
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'يعتمد على نافذة سياق النموذج. GPT-5.5 (OpenAI) يعالج ~100 صفحة أكاديمية قياسية في جلسة (سياق 128 ألف رمز). Claude Opus 4.8 (Anthropic) يعالج ~160 صفحة (200 ألف رمز). Gemini 3.1 Pro (Google DeepMind) يعالج ~800 صفحة (مليون رمز). للمجموعات الأكبر، يُلزَم بخط أنابيب RAG مع قاعدة بيانات متجهية.',
            },
          },
          {
            '@type': 'Question',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'التحقق المتبادل متعدد النماذج (GPT-5.5 + Claude Opus 4.8 + Gemini 3.1 Pro) يكتشف الهلوسة التي تفوتها سير عمل النموذج الواحد',
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**استخدم التحقق المتبادل متعدد النماذج لاكتشاف الاقتباسات المُهلوَسة.** شغِّل نفس السؤال البحثي في GPT-5.5 وClaude Opus 4.8 وGemini 3.1 Pro عبر PromptQuorum. أي اقتباس لا تتفق فيه النماذج على المؤلف أو السنة أو المجلة يتطلب تحققًا يدويًا في Google Scholar أو PubMed.',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'يعتمد على نافذة سياق النموذج. GPT-5.5 (OpenAI) يعالج ~100 صفحة أكاديمية قياسية في جلسة (سياق 128 ألف رمز). Claude Opus 4.8 (Anthropic) يعالج ~160 صفحة (200 ألف رمز). Gemini 3.1 Pro (Google DeepMind) يعالج ~800 صفحة (مليون رمز). للمجموعات الأكبر، يُلزَم بخط أنابيب RAG مع قاعدة بيانات متجهية.',
            },
            {
      ...
      howToSchema: {
        ...
        step: [
          ...
          },
          {
            ...
            text: 'Exécutez votre question de recherche simultanément sur GPT-5.5, Claude Opus 4.8 et Gemini 3.1 Pro pour détecter les hallucinations.',
          },
          {
            '@type': 'HowToStep',
            position: 5,
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Cela dépend de la fenêtre de contexte du modèle. GPT-5.5 (OpenAI) traite ~100 pages académiques standard par session (contexte 128k tokens). Claude Opus 4.8 (Anthropic) traite ~160 pages (200k tokens). Gemini 3.1 Pro (Google DeepMind) traite ~800 pages (1M tokens). Pour les corpus plus grands, un pipeline RAG (Retrieval-Augmented Generation) avec une base de données vectorielle est nécessaire.',
            },
          },
          {
            '@type': 'Question',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Le cross-checking multi-modèles (GPT-5.5 + Claude Opus 4.8 + Gemini 3.1 Pro) détecte les hallucinations que les workflows à modèle unique manquent',
        ...
        quickFacts: {
          ...
          items: [
            ...
            'La fenêtre de contexte 1M tokens de Gemini 3.1 Pro traite ~800 pages académiques par session ; GPT-5.5 ~100, Claude ~160',
        ...
        multiModelCheck: {
          ...
          content: [
            '**Le cross-checking multi-modèles — exécuter la même question de recherche sur GPT-5.5, Claude Opus 4.8 et Gemini 3.1 Pro simultanément — détecte les hallucinations que les workflows à modèle unique manquent, car les modèles indépendants fabriquent rarement la même fausse affirmation spécifique.**',
            ...
            'PromptQuorum est un outil de dispatch IA multi-modèles qui envoie un prompt à plusieurs fournisseurs IA simultanément et retourne toutes les réponses côte à côte. Pour les workflows de recherche, cela signifie exécuter une citation ou une affirmation factuelle sur GPT-5.5 (OpenAI), Claude Opus 4.8 (Anthropic) et Gemini 3.1 Pro (Google DeepMind) en un seul dispatch — et examiner où les trois modèles convergent ou divergent.',
            '**Testé dans PromptQuorum — 30 prompts de citations de recherche sur trois modèles :** Les trois modèles (GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro) se sont accordés sur le même format de citation et DOI dans 22 cas sur 30. Dans 8 cas, au moins un modèle a produit un nom d\'auteur ou volume de revue différent — les 8 cas ont été confirmés comme hallucinations après vérification manuelle dans Google Scholar.',
          ],
          items: [
            '**Générer** — Demandez à un modèle (ex. Claude Opus 4.8) de produire une synthèse de littérature avec citations',
            '**Cross-checker** — Dispatchez la même question à GPT-5.5 et Gemini 3.1 Pro via PromptQuorum',
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**Utilisez le cross-checking multi-modèles pour détecter les citations hallucinées.** Exécutez la même question de recherche sur GPT-5.5, Claude Opus 4.8 et Gemini 3.1 Pro via PromptQuorum. Toute citation sur laquelle les modèles divergent concernant l\'auteur, l\'année ou la revue nécessite une vérification manuelle dans Google Scholar ou PubMed.',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Cela dépend de la fenêtre de contexte du modèle. GPT-5.5 (OpenAI) traite ~100 pages académiques standard par session (128k tokens). Claude Opus 4.8 (Anthropic) traite ~160 pages (200k tokens). Gemini 3.1 Pro (Google DeepMind) traite ~800 pages (1M tokens). Pour les corpus plus grands, un pipeline RAG avec une base de données vectorielle est nécessaire.',
            },
            {
      ...
      howToSchema: {
        ...
        step: [
          ...
          },
          {
            ...
            text: 'GPT-5.5、Claude Opus 4.8、Gemini 3.1 Proで研究質問を同時に実行して幻想を検出します。',
          },
          {
            '@type': 'HowToStep',
            position: 5,
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'モデルのコンテキストウィンドウに依存。GPT-5.5（OpenAI）はセッションあたり〜100標準学術ページを処理（128kトークンコンテキスト）。Claude Opus 4.8（Anthropic）は〜160ページ（200kトークン）。Gemini 3.1 Pro（Google DeepMind）は〜800ページ（1Mトークン）。より大きなコーパスはベクトルデータベースを持つRAGパイプラインが必要。',
            },
          },
          {
            '@type': 'Question',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'マルチモデルクロスチェック（GPT-5.5+Claude Opus 4.8+Gemini 3.1 Pro）は単一モデルワークフローが見逃す幻想を検出',
        ...
        quickFacts: {
          ...
          items: [
            ...
            'Gemini 3.1 Proの1Mトークンコンテキストはセッションあたり〜800学術ページを処理；GPT-5.5 〜100、Claude 〜160',
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**マルチモデルクロスチェックで幻想引用を検出。** PromptQuantumを経由同じ研究質問をGPT-5.5、Claude Opus 4.8、Gemini 3.1 Proで実行。著者、年、ジャーナルでモデルが相違する引用は全てGoogle ScholarまたはPubMedで手動検証が必須。',
      ...
      howToSchema: {
        ...
        step: [
          ...
          },
          {
            ...
            position: 4,
            name: '在多个模型中交叉检查声明',
            text: '在GPT-5.5、Claude Opus 4.8和Gemini 3.1 Pro中同时运行研究问题以检测幻想。',
          },
          {
            '@type': 'HowToStep',
            position: 5,
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: '这取决于模型的上下文窗口。GPT-5.5（OpenAI）每个会话处理约100页标准学术页面（128k令牌上下文）。Claude Opus 4.8（Anthropic）处理约160页（200k令牌）。Gemini 3.1 Pro（Google DeepMind）处理约800页（1M令牌）。对于更大的语料库，需要具有向量数据库的RAG管道。',
            },
          },
          {
            '@type': 'Question',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '多模型交叉检查（GPT-5.5+Claude Opus 4.8+Gemini 3.1 Pro）检测单模型工作流遗漏的幻想',
        ...
        quickFacts: {
          ...
          items: [
            ...
            'Gemini 3.1 Pro的1M令牌上下文窗口处理约800学术页面/会话；GPT-5.5约100，Claude约160',
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**使用多模型交叉检查检测虚幻引用。** 通过PromptQuorum在GPT-5.5、Claude Opus 4.8和Gemini 3.1 Pro中运行相同的研究问题。任何模型在作者、年份或期刊方面不同意的引用都需要在Google Scholar或PubMed中进行手动验证。',
