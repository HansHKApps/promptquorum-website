      ...
      sections: {
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Processing too many papers in one context window:** Models lose recall accuracy as context fills up. Even Gemini 3.1 Pro\'s 1M-token window shows degraded retrieval of details from the middle of long contexts. For systematic reviews over 50 papers, use a RAG pipeline rather than direct context injection.',
      ...
      sections: {
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Zu viele Papiere in einem Context Window verarbeiten:** Modelle verlieren Rückruf-Genauigkeit, wenn der Context sich füllt. Selbst Gemini 3.1 Pros 1M-Token Window zeigt degradierte Abruf von Details aus der Mitte langer Kontexte. Für Systematic Reviews über 50 Papiere nutzen Sie eine RAG-Pipeline, anstatt direkten Context-Injection.',
      ...
      sections: {
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Traiter trop d\'articles dans une fenêtre de contexte :** Les modèles perdent en précision de rappel à mesure que le contexte se remplit. Même la fenêtre de 1M tokens de Gemini 3.1 Pro montre une récupération dégradée des détails du milieu des longs contextes. Pour les revues systématiques de plus de 50 articles, utilisez un pipeline RAG plutôt que l\'injection directe de contexte.',
