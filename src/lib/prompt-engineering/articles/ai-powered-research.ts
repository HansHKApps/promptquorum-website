    ...
    es: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          rows: [
            {
              'Herramienta': '[Elicit](https://elicit.com)',
    ...
    ar: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          rows: [
            {
              'الأداة': '[Elicit](https://elicit.com)',
    ...
    pt: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          rows: [
            {
              'Ferramenta': '[Elicit](https://elicit.com)',
    ...
    ja: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          rows: [
            {
              'ツール': '[Elicit](https://elicit.com)',
              'データベース': '138M+論文+54.5万件の臨床試験',
              '主な機能': 'PDFからの構造化データ抽出',
              '無料枠': 'あり（月5,000クレジット）',
            },
            {
              'ツール': '[Consensus](https://consensus.app)',
              'データベース': '約2億件の論文',
              '主な機能': 'コンセンサスメーターによる証拠合成',
              '無料枠': 'あり（制限付き）',
            },
            {
              'ツール': '[Semantic Scholar](https://www.semanticscholar.org)',
              'データベース': '2億+件の論文',
              '主な機能': '論文発見、引用グラフ、TLDR要約',
              '無料枠': '完全無料',
            },
            {
              'ツール': '[Perplexity AI](https://www.perplexity.ai)',
              'データベース': 'Web+学術',
              '主な機能': 'リアルタイム引用済み回答、幅広い探索',
              '無料枠': 'あり（制限付き）',
            },
            {
              'ツール': '[scite.ai](https://scite.ai)',
              'データベース': '12億+件の引用ステートメント',
              '主な機能': '支持／矛盾／言及分析',
              '無料枠': 'あり（制限付き）',
            },
            {
              'ツール': '[NotebookLM（Google）](https://notebook.google)',
              'データベース': 'アップロード文書',
    ...
    zh: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          rows: [
            {
              '工具': '[Elicit](https://elicit.com)',
              '数据库': '138M+论文+54.5万项临床试验',
              '主要功能': '从PDF提取结构化数据',
              '免费层级': '有（每月5,000点数）',
            },
            {
              '工具': '[Consensus](https://consensus.app)',
              '数据库': '约2亿篇论文',
              '主要功能': '使用共识计量器进行证据合成',
              '免费层级': '有（受限）',
            },
            {
              '工具': '[Semantic Scholar](https://www.semanticscholar.org)',
              '数据库': '2亿+论文',
              '主要功能': '论文发现、引用图谱、TLDR摘要',
              '免费层级': '完全免费',
            },
            {
              '工具': '[Perplexity AI](https://www.perplexity.ai)',
              '数据库': '网络+学术',
              '主要功能': '实时引用答案、广泛探索',
              '免费层级': '有（受限）',
            },
            {
              '工具': '[scite.ai](https://scite.ai)',
              '数据库': '12亿+引用声明',
              '主要功能': '支持/矛盾/提及分析',
              '免费层级': '有（受限）',
            },
            {
              '工具': '[NotebookLM（Google）](https://notebook.google)',
              '数据库': '上传的文档',
              '主要功能': '基于您自己文件的源引用问答',
              '免费层级': '免费/Plus层级',
            },
  ...
  ko: {
    ...
    sections: {
      ...
      toolComparison: {
        ...
        rows: [
          {
            '도구': '[Elicit](https://elicit.com)',
            '데이터베이스': '1억 3,800만 개 이상의 논문 + 545K 임상 시험',
            '주요 기능': 'PDF에서 구조화된 데이터 추출',
            '무료 티어': '예(월 5,000 크레딧)',
          },
          {
            '도구': '[Consensus](https://consensus.app)',
            '데이터베이스': '~2억 개의 논문',
            '주요 기능': 'Consensus Meter로 증거 합성',
            '무료 티어': '예(제한적)',
          },
          {
            '도구': '[Semantic Scholar](https://www.semanticscholar.org)',
            '데이터베이스': '2억 개 이상의 논문',
            '주요 기능': '논문 발견, 인용 그래프, TLDR 요약',
            '무료 티어': '완전 무료',
          },
          {
            '도구': '[Perplexity AI](https://www.perplexity.ai)',
            '데이터베이스': '웹 + 학술',
            '주요 기능': '실시간 인용 답변, 광범위한 탐색',
            '무료 티어': '예(제한적)',
          },
          {
            '도구': '[scite.ai](https://scite.ai)',
            '데이터베이스': '12억 개 이상의 인용 진술',
            '주요 기능': '지지/반박/언급 분석',
            '무료 티어': '예(제한적)',
          },
          {
            '도구': '[NotebookLM(Google)](https://notebook.google)',
            '데이터베이스': '업로드된 문서',
