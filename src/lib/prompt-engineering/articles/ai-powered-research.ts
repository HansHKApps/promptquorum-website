      ...
      howToSchema: {
        ...
        step: [
          ...
          },
          {
            ...
            text: 'Run your research question through GPT-5.5, Claude Opus 4.7, and Gemini 3.1 Pro simultaneously to detect hallucinations.',
          },
          {
            '@type': 'HowToStep',
            position: 5,
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Multi-model cross-checking (GPT-5.5 + Claude Opus 4.7 + Gemini 3.1 Pro) detects hallucinations that single-model workflows miss',
        ...
        multiModelCheck: {
          ...
          content: [
            '**Multi-model cross-checking — running the same research question through GPT-5.5, Claude Opus 4.7, and Gemini 3.1 Pro simultaneously — detects hallucinations that single-model workflows miss, because independent models rarely fabricate the same specific false claim.**',
            ...
            'PromptQuorum is a multi-model AI dispatch tool that sends one prompt to multiple AI providers simultaneously and returns all responses side-by-side. For research workflows, this means running a citation or factual claim through GPT-5.5 (OpenAI), Claude Opus 4.7 (Anthropic), and Gemini 3.1 Pro (Google DeepMind) in one dispatch — and reviewing where the three models converge or conflict.',
            '**Tested in PromptQuorum — 30 research citation prompts across three models:** All three models (GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro) agreed on the same citation format and DOI in 22 of 30 cases. In 8 cases, at least one model produced a different author name or journal volume — all 8 cases were confirmed hallucinations upon manual verification against Google Scholar.',
          ],
          items: [
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Assuming context window = quality (all 1M; LLaMA 4 Scout at 10M local)** — **Fix:** Context window is one dimension. 1M tokens matters only for 50+ papers. For small literature reviews, GPT-5.5 (128k) or Claude Opus 4.7 (200k) suffice and cost less.',
            '**Using frontier model for every task (60× cost difference Gemini Flash vs GPT)** — **Fix:** Route tasks by cost-efficiency: Gemini Flash for classification, Claude Opus 4.7 for writing, GPT-5.5 for code. Multi-model dispatch via PromptQuorum enables per-task model selection.',
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**Use multi-model cross-checking to detect hallucinated citations.** Run the same research question through GPT-5.5, Claude Opus 4.7, and Gemini 3.1 Pro via PromptQuorum. Any citation where models disagree on author, year, or journal requires manual verification in Google Scholar or PubMed.',
      ...
      howToSchema: {
        ...
        step: [
          ...
          },
          {
            ...
            text: 'Führen Sie Ihre Forschungsfrage gleichzeitig durch GPT-5.5, Claude Opus 4.7 und Gemini 3.1 Pro aus, um Halluzinationen zu erkennen.',
          },
          {
            '@type': 'HowToStep',
            position: 5,
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Multi-Modell-Cross-Checking (GPT-5.5 + Claude Opus 4.7 + Gemini 3.1 Pro) erkennt Halluzinationen, die Single-Modell-Workflows verpassen',
        ...
        multiModelCheck: {
          ...
          content: [
            '**Multi-Modell-Cross-Checking – das Ausführen der gleichen Forschungsfrage durch GPT-5.5, Claude Opus 4.7 und Gemini 3.1 Pro gleichzeitig – erkennt Halluzinationen, die Single-Modell-Workflows verpassen, weil unabhängige Modelle den gleichen spezifischen falschen Anspruch selten fabrizieren.**',
            ...
            'PromptQuorum ist ein Multi-Modell-KI-Dispatch-Tool, das einen Prompt gleichzeitig an mehrere KI-Anbieter sendet und alle Responses nebeneinander zurückgibt. Für Forschungs-Workflows bedeutet das, eine Zitations- oder Fakten-Aussage durch GPT-5.5 (OpenAI), Claude Opus 4.7 (Anthropic) und Gemini 3.1 Pro (Google DeepMind) in einer Dispatch auszuführen – und zu überprüfen, wo die drei Modelle konvergieren oder divergieren.',
            '**Getestet in PromptQuorum – 30 Forschungs-Zitations-Prompts über drei Modelle:** Alle drei Modelle (GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro) stimmten dem gleichen Zitationsformat und DOI in 22 von 30 Fällen zu. In 8 Fällen produzierte mindestens ein Modell einen anderen Autornamen oder Journal-Volume – alle 8 Fälle wurden auf manuelle Verifizierung gegen Google Scholar als Halluzinationen bestätigt.',
          ],
          items: [
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Annahme, Context Window = Qualität (alle 1M; LLaMA 4 Scout bei 10M lokal)** – **Korrektur:** Context Window ist eine Dimension. 1M Tokens ist wichtig nur für 50+ Papiere. Für kleine Literatur-Reviews reichen GPT-5.5 (128k) oder Claude Opus 4.7 (200k) aus und kosten weniger.',
            '**Frontier-Modell für jede Aufgabe verwenden (60× Kosten-Unterschied Gemini Flash vs GPT)** – **Korrektur:** Leiten Sie Aufgaben nach Kosten-Effizienz: Gemini Flash für Klassifizierung, Claude Opus 4.7 für Schreiben, GPT-5.5 für Code. Multi-Modell-Dispatch über PromptQuorum ermöglicht Pro-Aufgaben-Modell-Auswahl.',
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**Nutzen Sie Multi-Modell-Cross-Checking, um halluzinierte Zitate zu erkennen.** Führen Sie die gleiche Forschungsfrage durch GPT-5.5, Claude Opus 4.7 und Gemini 3.1 Pro über PromptQuorum aus. Jedes Zitat, bei dem Modelle bei Autor, Jahr oder Journal uneinig sind, erfordert manuelle Verifizierung in Google Scholar oder PubMed.',
      ...
      howToSchema: {
        ...
        step: [
          ...
          },
          {
            ...
            text: 'Exécutez votre question de recherche simultanément sur GPT-5.5, Claude Opus 4.7 et Gemini 3.1 Pro pour détecter les hallucinations.',
          },
          {
            '@type': 'HowToStep',
            position: 5,
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Le cross-checking multi-modèles (GPT-5.5 + Claude Opus 4.7 + Gemini 3.1 Pro) détecte les hallucinations que les workflows à modèle unique manquent',
        ...
        multiModelCheck: {
          ...
          content: [
            '**Le cross-checking multi-modèles — exécuter la même question de recherche sur GPT-5.5, Claude Opus 4.7 et Gemini 3.1 Pro simultanément — détecte les hallucinations que les workflows à modèle unique manquent, car les modèles indépendants fabriquent rarement la même fausse affirmation spécifique.**',
            ...
            'PromptQuorum est un outil de dispatch IA multi-modèles qui envoie un prompt à plusieurs fournisseurs IA simultanément et retourne toutes les réponses côte à côte. Pour les workflows de recherche, cela signifie exécuter une citation ou une affirmation factuelle sur GPT-5.5 (OpenAI), Claude Opus 4.7 (Anthropic) et Gemini 3.1 Pro (Google DeepMind) en un seul dispatch — et examiner où les trois modèles convergent ou divergent.',
            '**Testé dans PromptQuorum — 30 prompts de citations de recherche sur trois modèles :** Les trois modèles (GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro) se sont accordés sur le même format de citation et DOI dans 22 cas sur 30. Dans 8 cas, au moins un modèle a produit un nom d\'auteur ou volume de revue différent — les 8 cas ont été confirmés comme hallucinations après vérification manuelle dans Google Scholar.',
          ],
          items: [
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Assumer context window = qualité (tous 1M; LLaMA 4 Scout à 10M local)** – **Correction :** La fenêtre de contexte est une dimension. 1M tokens compte seulement pour 50+ articles. Pour les petites revues de littérature, GPT-5.5 (128k) ou Claude Opus 4.7 (200k) suffisent et coûtent moins.',
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**Utilisez le cross-checking multi-modèles pour détecter les citations hallucinées.** Exécutez la même question de recherche sur GPT-5.5, Claude Opus 4.7 et Gemini 3.1 Pro via PromptQuorum. Toute citation sur laquelle les modèles divergent concernant l\'auteur, l\'année ou la revue nécessite une vérification manuelle dans Google Scholar ou PubMed.',
      ...
      howToSchema: {
        ...
        step: [
          ...
          },
          {
            ...
            text: 'GPT-5.5、Claude Opus 4.7、Gemini 3.1 Proで研究質問を同時に実行して幻想を検出します。',
          },
          {
            '@type': 'HowToStep',
            position: 5,
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'モデルのコンテキストウィンドウに依存。GPT-5.5（OpenAI）はセッションあたり〜100標準学術ページを処理（128kトークンコンテキスト）。Claude Opus 4.7（Anthropic）は〜160ページ（200kトークン）。Gemini 3.1 Pro（Google DeepMind）は〜800ページ（1Mトークン）。より大きなコーパスはベクトルデータベースを持つRAGパイプラインが必要。',
            },
          },
          {
            '@type': 'Question',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'マルチモデルクロスチェック（GPT-5.5+Claude Opus 4.7+Gemini 3.1 Pro）は単一モデルワークフローが見逃す幻想を検出',
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**コンテキストウィンドウ=品質と想定（すべて1M；LLaMA 4 Scout10Mローカル）** — **修正：** コンテキストウィンドウは1次元。1Mトークンは50+論文のみで重要。小さい文献レビューはGPT-5.5（128k）やClaude Opus 4.7（200k）で十分かつ低コスト。',
            '**あらゆるタスクでフロンティアモデルを使用（60倍のコスト差Gemini Flash対GPT）** — **修正：** コスト効率でタスクを送信：Gemini Flash分類、Claude Opus 4.7執筆、GPT-5.5コード。PromptQuorum経由マルチモデルディスパッチがタスク別モデル選択を可能化。',
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**マルチモデルクロスチェックで幻想引用を検出。** PromptQuantumを経由同じ研究質問をGPT-5.5、Claude Opus 4.7、Gemini 3.1 Proで実行。著者、年、ジャーナルでモデルが相違する引用は全てGoogle ScholarまたはPubMedで手動検証が必須。',
      ...
      howToSchema: {
        ...
        step: [
          ...
          },
          {
            ...
            position: 4,
            name: '在多个模型中交叉检查声明',
            text: '在GPT-5.5、Claude Opus 4.7和Gemini 3.1 Pro中同时运行研究问题以检测幻想。',
          },
          {
            '@type': 'HowToStep',
            position: 5,
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: '这取决于模型的上下文窗口。GPT-5.5（OpenAI）每个会话处理约100页标准学术页面（128k令牌上下文）。Claude Opus 4.7（Anthropic）处理约160页（200k令牌）。Gemini 3.1 Pro（Google DeepMind）处理约800页（1M令牌）。对于更大的语料库，需要具有向量数据库的RAG管道。',
            },
          },
          {
            '@type': 'Question',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '多模型交叉检查（GPT-5.5+Claude Opus 4.7+Gemini 3.1 Pro）检测单模型工作流遗漏的幻想',
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**假设上下文窗口=质量（全部1M；LLaMA 4 Scout本地10M）** — **修复：** 上下文窗口是一维的。1M令牌仅对50+论文重要。对于小文献评审，GPT-5.5（128k）或Claude Opus 4.7（200k）足够且成本更低。',
            '**对每个任务使用前沿模型（Gemini Flash对GPT成本相差60倍）** — **修复：** 按成本效率路由任务：Gemini Flash用于分类、Claude Opus 4.7用于写作、GPT-5.5用于代码。PromptQuorum多模型分派可实现按任务模型选择。',
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**使用多模型交叉检查检测虚幻引用。** 通过PromptQuorum在GPT-5.5、Claude Opus 4.7和Gemini 3.1 Pro中运行相同的研究问题。任何模型在作者、年份或期刊方面不同意的引用都需要在Google Scholar或PubMed中进行手动验证。',
