...
export const article: Partial<Record<Language, PEArticle>> = {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            { title: 'Few-Shot Prompting: Give Examples', url: '/prompt-engineering/zero-shot-vs-few-shot' },
            ...
            { title: 'PromptQuorum: AI Dispatch & Multi-Model Consensus', url: '/pq-apps#how-it-works' },
            { title: 'Best Prompt Optimization Tools for Teams', url: '/prompt-engineering/best-prompt-optimization-tools-for-teams' },
  ...
  metaDescription: 'Prompt-Bibliothek mit 8-Feld-Metadaten und Governance aufbauen. Getestete Prompts projektübergreifend wiederverwenden. Mit Vorlage und Beispiel.',
  ...
  schema: {
    ...
    image: '[www.promptquorum.com/og-build-a-prompt-library-de.png](https://www.promptquorum.com/og-build-a-prompt-library-de.png)',
    datePublished: '2026-03-24',
    dateModified: '2026-09-01',
  ...
  howToSchema: {
    ...
    step: [
      ...
      },
      {
        ...
        text: 'Struktur: "Meeting Summaries" → v1.0 (Claude), v1.0 (GPT-5.6) statt "Claude Prompts" → "Meeting Summaries". Modell-Details gehören in Metadaten, nicht in die Ordnerstruktur.',
      },
      {
        '@type': 'HowToStep',
        position: 4,
  ...
  sections: {
    ...
    whyBuildOne: {
      ...
      items: [
        ...
        'Modell-Experiments vereinfachen: Test the same prompt auf GPT-5.6, Claude, Llama 3.3 — Track welche Model best ist.',
      ],
      callouts: [
        {
          type: 'warning',
    ...
    schemaBreakdown: {
      ...
      items: [
        ...
        '**Getestete Modelle**: "Claude 4.6, GPT-5.6" (dies hilft Teams, die richtige Variante zu wählen)',
    ...
    optionalFields: {
      ...
      items: [
        '**Kostennotizen**: "Dieser Prompt kostet ~0,02 € pro Aufruf bei GPT-5.6"',
    ...
    structureApproach: {
      ...
      items: [
        '✅ Richtig: Sales → Email Draft (v1.0 Claude, v1.0 GPT-5.6) → Customer Objection Handling (v1.1 Claude)',
    ...
    structureFlexibility: {
      ...
      items: [
        'Wenn Sie nach Aufgabe organisieren: "Email Draft" hat Varianten (Claude v1.0, GPT-5.6 v1.0) als klare Einträge. Leicht zu vergleichen, leicht zu aktualisieren.',
      ],
    },
    storageTableNote: {
    ...
    relatedReading: {
      ...
      items: [
        { title: 'Prompt Engineering Fundamentals', url: '/de/prompt-engineering/fundamentals-of-prompt-optimization' },
        { title: 'Few-Shot Prompting: Mit Beispielen besser prompten', url: '/de/prompt-engineering/zero-shot-vs-few-shot' },
        { title: 'Chain-of-Thought Prompting: Step-by-Step Reasoning', url: '/de/prompt-engineering/chain-of-thought-prompting' },
        { title: 'PromptQuorum: Prompt Management Made Easy', url: '/de/pq-apps#features' },
        { title: 'System-Prompt vs. User-Prompt: Was ist der Unterschied?', url: '/de/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference' },
        { title: 'Prompt Testing und Optimization', url: '/de/prompt-engineering/best-prompt-testing-evaluation-tools' },
      ],
    },
    sources: {
      id: 'sources',
    ...
    es: {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            { title: 'Fundamentos de prompt engineering', url: '/es/prompt-engineering/fundamentals-of-prompt-optimization' },
            { title: 'Few-Shot Prompting: mejora tus prompts con ejemplos', url: '/es/prompt-engineering/zero-shot-vs-few-shot' },
            { title: 'Chain-of-Thought Prompting: razonamiento paso a paso', url: '/es/prompt-engineering/chain-of-thought-prompting' },
            { title: 'PromptQuorum: gestión de prompts simplificada', url: '/es/pq-apps#features' },
            { title: 'System Prompt vs. User Prompt: ¿cuál es la diferencia?', url: '/es/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference' },
            { title: 'Pruebas y optimización de prompts', url: '/es/prompt-engineering/best-prompt-testing-evaluation-tools' },
          ],
        },
        sources: {
          id: 'sources',
    ...
    ar: {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            { title: 'أساسيات هندسة التعليمات', url: '/ar/prompt-engineering/fundamentals-of-prompt-optimization' },
            { title: 'Few-Shot Prompting: حسِّن تعليماتك بأمثلة', url: '/ar/prompt-engineering/zero-shot-vs-few-shot' },
            { title: 'صياغة سلسلة التفكير: استدلال خطوة بخطوة', url: '/ar/prompt-engineering/chain-of-thought-prompting' },
            { title: 'PromptQuorum: إدارة التعليمات مُبسَّطة', url: '/ar/pq-apps#features' },
            { title: 'System Prompt مقابل User Prompt: ما الفرق؟', url: '/ar/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference' },
            { title: 'اختبار التعليمات وتحسينها', url: '/ar/prompt-engineering/best-prompt-testing-evaluation-tools' },
          ],
        },
        sources: {
          id: 'sources',
    ...
    pt: {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            { title: 'Fundamentos de prompt engineering', url: '/pt/prompt-engineering/fundamentals-of-prompt-optimization' },
            { title: 'Few-Shot Prompting: melhore seus prompts com exemplos', url: '/pt/prompt-engineering/zero-shot-vs-few-shot' },
            { title: 'Chain-of-Thought Prompting: raciocínio passo a passo', url: '/pt/prompt-engineering/chain-of-thought-prompting' },
            { title: 'PromptQuorum: gestão de prompts simplificada', url: '/pt/pq-apps#features' },
            { title: 'System Prompt vs. User Prompt: qual é a diferença?', url: '/pt/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference' },
            { title: 'Testes e otimização de prompts', url: '/pt/prompt-engineering/best-prompt-testing-evaluation-tools' },
          ],
        },
        sources: {
          id: 'sources',
  ...
  metaDescription: 'Créez une bibliothèque de prompts avec métadonnées, versionnage et gouvernance d\'équipe. Réutilisez des prompts IA testés sur tous vos projets. Guide étape par étape.',
  ...
  schema: {
    ...
    image: '[www.promptquorum.com/og-build-a-prompt-library-fr.png](https://www.promptquorum.com/og-build-a-prompt-library-fr.png)',
    datePublished: '2026-03-24',
    dateModified: '2026-09-01',
    author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
    publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
  ...
  faqSchema: {
    ...
    mainEntity: [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'Étiquetez chaque prompt avec les modèles testés dans les métadonnées. Si un prompt échoue sur un nouveau modèle, créez une variante — par exemple « Résumé de réunion – Claude » et « Résumé de réunion – GPT-5.6 » — au lieu de forcer un prompt à fonctionner partout. Les outils de test multi-modèle vous permettent de comparer les résultats avant de promouvoir.',
            },
          },
          {
            '@type': 'Question',
  ...
  howToSchema: {
    ...
    step: [
      ...
      },
      {
        ...
        text: 'Structure : « Résumés de réunion » → v1.0 (Claude), v1.0 (GPT-5.6) au lieu de « Prompts Claude » → « Résumés de réunion ». Les détails du modèle vont dans les métadonnées, pas dans la structure des dossiers.',
      },
      {
        '@type': 'HowToStep',
        position: 4,
  ...
  sections: {
    ...
    whyBuildOne: {
      ...
      items: [
        ...
        'Simplifiez les expériences : testez le même prompt sur GPT-5.6, Claude, Llama 3.3 — suivez quel modèle fonctionne best.',
      ],
      callouts: [
        {
          type: 'warning',
    ...
    schemaBreakdown: {
      ...
      items: [
        ...
        '**Modèles testés** : « Claude 4.6, GPT-5.6 » (cela aide les équipes à choisir la bonne variante)',
    ...
    optionalFields: {
      ...
      items: [
        '**Notes de coût** : « Ce prompt coûte ~0,02 € par appel avec GPT-5.6 »',
    ...
    structureApproach: {
      ...
      items: [
        '✅ Correct : Ventes → Brouillon d\'email (v1.0 Claude, v1.0 GPT-5.6) → Gestion d\'objections (v1.1 Claude)',
    ...
    structureFlexibility: {
      ...
      items: [
        'Si vous organisez par tâche : « Brouillon d\'email » a des variantes (Claude v1.0, GPT-5.6 v1.0) comme des entrées claires. Facile à comparer, facile à mettre à jour.',
      ],
    },
    storageTableNote: {
      id: 'storage-table-note',
    ...
    relatedReading: {
      ...
      items: [
        { title: 'Fondamentaux du Prompt Engineering', url: '/fr/prompt-engineering/fundamentals-of-prompt-optimization' },
        { title: 'Few-Shot Prompting : Mieux prompter avec des exemples', url: '/fr/prompt-engineering/zero-shot-vs-few-shot' },
        { title: 'Chain-of-Thought Prompting : Raisonnement étape par étape', url: '/fr/prompt-engineering/chain-of-thought-prompting' },
        { title: 'PromptQuorum : Gestion de prompts simplifiée', url: '/fr/pq-apps#features' },
        { title: 'System Prompt vs User Prompt : Quelle est la différence ?', url: '/fr/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference' },
        { title: 'Test et optimisation de prompts', url: '/fr/prompt-engineering/best-prompt-testing-evaluation-tools' },
      ],
    },
    sources: {
      id: 'sources',
  ...
  metaDescription: 'メタデータ・バージョン管理・チームガバナンスを備えたプロンプトライブラリの構築方法。テスト済みAIプロンプトをモデル横断で再利用。テンプレート付きステップバイステップガイド。',
  ...
  faqSchema: {
    ...
    mainEntity: [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': 'メタデータでテスト済みモデルをタグ付け。新モデルで失敗なら、一つを無理に全モデルで機能させるのではなく「会議要約 – Claude」と「会議要約 – GPT-5.6」のバリエーション作成。多モデルテストツールで出力比較→昇格。',
            },
          },
          {
            '@type': 'Question',
  ...
  howToSchema: {
    ...
    step: [
      ...
      },
      {
        ...
        text: '「会議要約」→ v1.0 (Claude)、v1.0 (GPT-5.6) のようにタスク中心の構造にしてください。「Claude プロンプト」→「会議要約」というモデル中心の構成は避けてください。',
      },
      {
        '@type': 'HowToStep',
        position: 4,
  ...
  sections: {
    ...
    whyBuildOne: {
      ...
      items: [
        ...
        'マルチモデル実験：同じプロンプトを GPT-5.6、Claude、Llama 3.3 で試験 — 最適モデル追跡可能。',
      ],
      callouts: [
        {
          type: 'warning',
    ...
    schemaBreakdown: {
      ...
      items: [
        ...
        '**テスト済みモデル**：「Claude 4.6、GPT-5.6」（チームが正しいバリエーション選択を支援）',
    ...
    optionalFields: {
      ...
      items: [
        '**コスト注記**：「このプロンプトは GPT-5.6 で ~0.02 ドル/呼び出し」',
    ...
    structureApproach: {
      ...
      items: [
        '✅ 正解：営業 → メールドラフト (v1.0 Claude、v1.0 GPT-5.6) → 異議処理 (v1.1 Claude)',
    ...
    structureFlexibility: {
      ...
      items: [
        'タスク別なら：「メールドラフト」にバリエーション（Claude v1.0、GPT-5.6 v1.0）が明確なエントリ。比較・更新が簡単。',
      ],
    },
    storageTableNote: {
      id: 'storage-table-note',
    ...
    faqSection: {
      ...
      faqs: [
            ...
            { q: 'あるモデルで機能するが別では機能しないプロンプトは？', a: 'メタデータでテスト済みモデルをタグ付け。新モデルで失敗なら、一つを無理に全モデルで機能させるのではなく「会議要約 – Claude」と「会議要約 – GPT-5.6」のバリエーション作成。多モデルテストツールで出力比較→昇格。' },
    ...
    relatedReading: {
      ...
      title: '関連資料',
      items: [
        { title: 'プロンプトエンジニアリングの基礎', url: '/ja/prompt-engineering/fundamentals-of-prompt-optimization' },
        { title: 'Few-Shot プロンプティング：例を使った効果的なプロンプト', url: '/ja/prompt-engineering/zero-shot-vs-few-shot' },
        { title: 'Chain-of-Thought プロンプティング：ステップバイステップ推論', url: '/ja/prompt-engineering/chain-of-thought-prompting' },
        { title: 'PromptQuorum：プロンプト管理の簡素化', url: '/ja/pq-apps#features' },
        { title: 'システムプロンプト vs ユーザープロンプト：何が違う？', url: '/ja/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference' },
        { title: 'プロンプトのテストと最適化', url: '/ja/prompt-engineering/best-prompt-testing-evaluation-tools' },
      ],
    },
    sources: {
      id: 'sources',
  ...
  metaDescription: '构建包含元数据、版本管理和团队治理的提示词库。跨模型、跨项目复用经过测试的AI提示词。含模板的分步指南。',
  ...
  faqSchema: {
    ...
    mainEntity: [
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': '在元数据中为各提示词标记已测试模型。失败于新模型时，创建变体（如「总结-Claude」和「总结-GPT-5.6」）而不强制一个提示词处处工作。多模型工具升级前比较输出。',
            },
          },
          {
            '@type': 'Question',
          ...
          },
          {
            ...
            'acceptedAnswer': {
              '@type': 'Answer',
              'text': '在元数据中为每个提示词标记已测试的模型。如果提示词在新模型上失败，创建变体（如"会议总结-Claude"和"会议总结-GPT-5.6"），而不是强制一个提示词到处工作。多模型测试工具让您在升级前比较输出。',
            },
          },
          {
            '@type': 'Question',
  ...
  howToSchema: {
    ...
    step: [
      ...
      },
      {
        ...
        position: 3,
        name: '按任务/功能而非模型组织',
        text: '结构：「会议总结」→ v1.0 (Claude)、v1.0 (GPT-5.6)，而不是「Claude提示词」→「会议总结」。模型详情属于元数据，不是文件夹结构。',
      },
      {
        '@type': 'HowToStep',
        position: 4,
  ...
  sections: {
    ...
    whyBuildOne: {
      ...
      items: [
        ...
        '简化模型实验：在GPT-5.6、Claude、Llama 3.3上测试同一提示词——追踪哪个最佳。',
      ],
      callouts: [
        {
          type: 'warning',
    ...
    schemaBreakdown: {
      ...
      items: [
        ...
        '**已测试模型**：「Claude 4.6、GPT-5.6」（帮助团队选择正确变体）',
    ...
    optionalFields: {
      ...
      items: [
        '**成本说明**：「此提示词在GPT-5.6上成本约0.02美元/调用」',
        '**性能指标**：「延迟：<2秒」「令牌计数：~500」',
    ...
    structureApproach: {
      ...
      items: [
        '✅ 正确：销售→邮件草稿(v1.0 Claude、v1.0 GPT-5.6)→异议处理(v1.1 Claude)',
    ...
    structureFlexibility: {
      ...
      items: [
        '按任务：「邮件草稿」有变体（Claude v1.0、GPT-5.6 v1.0）作为清晰条目。易于比较、易于更新。',
      ],
    },
    storageTableNote: {
      id: 'storage-table-note',
    ...
    faqSection: {
      ...
      faqs: [
            ...
            { q: '一个模型有效但另一个无效的提示词如何处理？', a: '在元数据中为各提示词标记已测试模型。失败于新模型时，创建变体（如「总结-Claude」和「总结-GPT-5.6」）而不强制一个提示词处处工作。多模型工具升级前比较输出。' },
            ...
            { q: '如何处理在一个模型上有效但在另一个模型上无效的提示词？', a: '在元数据中为每个提示词标记已测试的模型。如果提示词在新模型上失败，创建变体（如"会议总结-Claude"和"会议总结-GPT-5.6"），而不是强制一个提示词到处工作。多模型测试工具让您在升级前比较输出。' },
    ...
    relatedReading: {
      ...
      title: '延伸阅读',
      items: [
        { title: '提示词工程基础', url: '/zh/prompt-engineering/fundamentals-of-prompt-optimization' },
        { title: '少样本提示词：用示例更好地提示', url: '/zh/prompt-engineering/zero-shot-vs-few-shot' },
        { title: '思路链提示词：逐步推理', url: '/zh/prompt-engineering/chain-of-thought-prompting' },
        { title: 'PromptQuorum：简化提示词管理', url: '/zh/pq-apps#features' },
        { title: '系统提示词 vs 用户提示词：有何区别？', url: '/zh/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference' },
        { title: '提示词测试和优化', url: '/zh/prompt-engineering/best-prompt-testing-evaluation-tools' },
      ],
    },
    sources: {
      id: 'sources',
    ...
    ko: {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          title: '관련 읽기',
          items: [
            '[프롬프트 엔지니어링 기초](/ko/prompt-engineering/fundamentals-of-prompt-optimization)',
            '[Few-Shot Prompting: 예시로 프롬프트 개선하기](/ko/prompt-engineering/zero-shot-vs-few-shot)',
            '[Chain-of-Thought Prompting: 단계별 추론](/ko/prompt-engineering/chain-of-thought-prompting)',
            '[PromptQuorum: 간소화된 프롬프트 관리](/ko/pq-apps#features)',
            '[System Prompt vs. User Prompt: 차이점은?](/ko/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference)',
            '[프롬프트 테스트 및 최적화](/ko/prompt-engineering/best-prompt-testing-evaluation-tools)',
          ],
        },
        sources: {
          id: 'sources',
