  ...
  next_refresh_due: '2026-09-24',
    ...
    es: {
      ...
      schema: {
        ...
        url: 'https://www.promptquorum.com/es/es/prompt-engineering/build-a-prompt-library',
        inLanguage: 'es',
    ...
    ar: {
      ...
      seoTitle: 'مكتبة التعليمات: قوالب ذكاء اصطناعي قابلة لإعادة الاستخدام للفرق',
      metaDescription: 'أنشئ مكتبة تعليمات مشتركة بمعادن بيانات وحوكمة مسودة→معتمدة ومراجعة شهرية. تشمل قالبًا ومثالًا ودليل تبني.',
