    ...
    sections: {
      ...
      tldr: {
        ...
        items: [
          ...
          'System prompts account for ~70% of behavioral consistency based on PromptQuorum testing across GPT-5.5, Claude Opus 4.7, and Gemini 1.5 Pro; user prompts shape specific outputs',
      ...
      whereTheyLive: {
        ...
        content: [
          '**System prompts live in the application layer; user prompts live in the interaction layer.** When you call GPT-5.5 via the OpenAI API, the endpoint accepts two separate inputs: `system` (the persistent instructions) and `messages` (per-request user input). The same is true for Claude Opus 4.7 via Anthropic\'s API, Gemini 1.5 Pro via Google\'s API, and any local LLM run through [Ollama](/prompt-engineering/context-windows-explained-why-ai-forgets) or LM Studio.',
          'All models support the system + user prompt pattern:',
        ],
        items: [
          '**Model layer:** The base LLM (GPT-5.5, Claude Opus 4.7, Gemini 1.5 Pro, LLaMA 3.1, Mistral Large) — all accept both system and user prompts',
      ...
      promptquorumToggle: {
        ...
        content: [
          'PromptQuorum includes a toggleable interface: "Show System Prompts." When enabled, you see the actual system prompt running on each model — GPT-5.5, Claude Opus 4.7, Gemini, Ollama, LM Studio, all of them. This is especially valuable when dispatching one prompt to multiple local backends simultaneously.',
        ],
      },
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Yes. All major LLMs — GPT-5.5, Claude Opus 4.7, Gemini 1.5 Pro, Ollama models, LM Studio — support the system prompt + user prompt pattern. Some come with default system prompts; others let you define your own.'
          },
          {
    ...
    sections: {
      ...
      tldr: {
        ...
        items: [
          ...
          "System Prompts machen ca. 70 % der Verhaltenskonsistenz aus (basierend auf PromptQuorum-Tests über GPT-5.5, Claude Opus 4.7 und Gemini 1.5 Pro); User Prompts prägen spezifische Ausgaben",
      ...
      whereTheyLive: {
        ...
        content: [
          "**System Prompts befinden sich in der Anwendungsschicht; User Prompts befinden sich in der Interaktionsschicht.** Wenn Sie GPT-5.5 über die OpenAI API aufrufen, akzeptiert der Endpoint zwei separate Eingaben: `system` (die persistenten Anweisungen) und `messages` (pro-Anfrage-Benutzereingabe). Dasselbe gilt für Claude Opus 4.7 über die Anthropic API, Gemini 1.5 Pro über die Google API und alle lokalen LLMs, die über Ollama oder LM Studio ausgeführt werden.",
          "Alle Modelle unterstützen das System + User Prompt-Muster:",
        ],
        items: [
          "**Modellebene:** Das Basis-LLM (GPT-5.5, Claude Opus 4.7, Gemini 1.5 Pro, LLaMA 3.1, Mistral Large) — alle akzeptieren beide System und User Prompts",
      ...
      designingSystemPrompt: {
        ...
        items: [
          ...
          "**Tests über Modelle hinweg:** Testen Sie den System Prompt auf mehreren Modellen — GPT-5.5, Claude Opus 4.7, Gemini 1.5 Pro. Einige Modelle sind strenger bei Constraints; andere interpretieren Stil unterschiedlich. Ein robuster System Prompt funktioniert konsistent über alle drei.",
        ],
      },
      promptquorumTransparency: {
      ...
      promptquorumToggle: {
        ...
        content: [
          "PromptQuorum beinhaltet eine umschaltbare Schnittstelle: \"System Prompts anzeigen.\" Wenn aktiviert, sehen Sie den tatsächlichen System Prompt, der auf jedem Modell läuft — GPT-5.5, Claude Opus 4.7, Gemini, Ollama, LM Studio, alle. Dies ist besonders wertvoll, wenn ein Prompt zu mehreren lokalen Backends gleichzeitig versendet wird.",
        ],
      },
      claudeCodeStory: {
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: "Ja. Alle großen LLMs — GPT-5.5, Claude Opus 4.7, Gemini 1.5 Pro, Ollama-Modelle, LM Studio — unterstützen das System Prompt + User Prompt-Muster. Einige werden mit Standard-System Prompts geliefert; andere lassen Sie Ihre eigenen definieren.",
          },
          {
          ...
          },
          {
            ...
            a: "Das Modell fällt auf sein Standard-Trainingsverhalten zurück. GPT-5.5, Claude Opus 4.7 und Gemini 1.5 Pro haben alle ein eingebautes Baseline-Verhalten (hilfreich, harmlos, ehrlich), wenn kein System Prompt vorhanden ist. Das Modell wird immer noch auf User Prompts antworten, aber ohne Rollendefinition, Ausgabeformat-Constraints oder Scope-Grenzen — Ergebnisse werden weniger konsistent und weniger spezialisiert sein.",
          },
          {
