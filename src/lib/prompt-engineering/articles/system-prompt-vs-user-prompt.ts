...
export const article: Partial<Record<Language, PEArticle>> = {
  en: {
    ...
    heroImage: '/images/system-prompt-vs-user-prompt-overview-hero-en.png',
  ...
  de: {
    ...
    heroImage: '/images/system-prompt-vs-user-prompt-overview-hero-de.png',
  ...
  es: {
    ...
    heroImage: '/images/system-prompt-vs-user-prompt-overview-hero-es.png',
  ...
  zh: {
    ...
    heroImage: '/images/system-prompt-vs-user-prompt-overview-hero-zh.png',
  ...
  pt: {
    ...
    heroImage: '/images/system-prompt-vs-user-prompt-overview-hero-pt.png',
  ...
  ko: {
    ...
    heroImage: '/images/system-prompt-vs-user-prompt-overview-hero-ko.png',
