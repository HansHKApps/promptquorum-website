...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  de: {
    ...
    metaDescription: 'System Prompts legen das KI-Verhalten fest; User Prompts steuern jede Anfrage. Unterschied, Interaktion und Beispiele für GPT-5.5 und Claude erklärt.',
    schema: {
      "@context": "https://schema.org",
      "@type": "TechArticle",
      ...
      datePublished: "2026-03-22",
      dateModified: "2026-04-12",
      keywords: ["System Prompt", "User Prompt", "Prompt Engineering", "LLM-Verhalten", "GPT-5.5", "Claude", "Prompt-Struktur", "PromptQuorum"],
      author: { "@type": "Person", name: "Hans Kuepper", url: "https://www.promptquorum.com/about" },
      publisher: { "@type": "Organization", name: "PromptQuorum", url: "https://www.promptquorum.com", logo: { "@type": "ImageObject", url: "https://www.promptquorum.com/logo.svg" } },
      mentions: [
        { "@type": "Thing", name: "PromptQuorum" },
    ...
    sections: {
      ...
      tldr: {
        ...
        items: [
          ...
          "System Prompts machen ca. 70 % der Verhaltenskonsistenz aus (basierend auf PromptQuorum-Tests über GPT-5.5, Claude 4.6 Sonnet und Gemini 3.5 Pro); User Prompts prägen spezifische Ausgaben",
      ...
      whereTheyLive: {
        ...
        content: [
          "**System Prompts befinden sich in der Anwendungsschicht; User Prompts befinden sich in der Interaktionsschicht.** Wenn Sie GPT-5.5 über die OpenAI API aufrufen, akzeptiert der Endpoint zwei separate Eingaben: `system` (die persistenten Anweisungen) und `messages` (pro-Anfrage-Benutzereingabe). Dasselbe gilt für Claude 4.6 Sonnet über die Anthropic API, Gemini 3.5 Pro über die Google API und alle lokalen LLMs, die über Ollama oder LM Studio ausgeführt werden.",
          "Alle Modelle unterstützen das System + User Prompt-Muster:",
        ],
        items: [
          "**Modellebene:** Das Basis-LLM (GPT-5.5, Claude 4.6 Sonnet, Gemini 3.5 Pro, LLaMA 3.1, Mistral Large) — alle akzeptieren beide System und User Prompts",
      ...
      designingSystemPrompt: {
        ...
        items: [
          ...
          "**Tests über Modelle hinweg:** Testen Sie den System Prompt auf mehreren Modellen — GPT-5.5, Claude 4.6 Sonnet, Gemini 3.5 Pro. Einige Modelle sind strenger bei Constraints; andere interpretieren Stil unterschiedlich. Ein robuster System Prompt funktioniert konsistent über alle drei.",
        ],
      },
      promptquorumTransparency: {
        ...
        items: [
          ...
          "**Inkonsistenz über Modelle hinweg:** Sie führen den gleichen Prompt auf GPT-5.5 und auf Ollama aus. Unterschiedliche Antworten. Ohne beide System Prompts zu sehen, können Sie nicht sagen, ob der Unterschied Modell-Fähigkeit oder verborgene Anweisungen ist.",
      ...
      promptquorumToggle: {
        ...
        content: [
          "PromptQuorum beinhaltet eine umschaltbare Schnittstelle: \"System Prompts anzeigen.\" Wenn aktiviert, sehen Sie den tatsächlichen System Prompt, der auf jedem Modell läuft — GPT-5.5, Claude 4.6 Sonnet, Gemini, Ollama, LM Studio, alle. Dies ist besonders wertvoll, wenn ein Prompt zu mehreren lokalen Backends gleichzeitig versendet wird.",
        ],
      },
      claudeCodeStory: {
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: "Ja. Alle großen LLMs — GPT-5.5, Claude 4.6 Sonnet, Gemini 3.5 Pro, Ollama-Modelle, LM Studio — unterstützen das System Prompt + User Prompt-Muster. Einige werden mit Standard-System Prompts geliefert; andere lassen Sie Ihre eigenen definieren.",
          },
          {
          ...
          },
          {
            ...
            a: "Das Modell fällt auf sein Standard-Trainingsverhalten zurück. GPT-5.5, Claude 4.6 Sonnet und Gemini 3.5 Pro haben alle ein eingebautes Baseline-Verhalten (hilfreich, harmlos, ehrlich), wenn kein System Prompt vorhanden ist. Das Modell wird immer noch auf User Prompts antworten, aber ohne Rollendefinition, Ausgabeformat-Constraints oder Scope-Grenzen — Ergebnisse werden weniger konsistent und weniger spezialisiert sein.",
          },
          {
  ...
  es: {
    ...
    metaDescription: 'Los system prompts definen el comportamiento de la IA. Los user prompts gestionan cada solicitud. Diferencias clave y ejemplos para GPT-5.5 y Claude.',
    schema: {
      "@context": "https://schema.org",
      "@type": "TechArticle",
      ...
      datePublished: "2026-03-22",
      dateModified: "2026-04-12",
      keywords: ["system prompt", "user prompt", "prompt engineering", "comportamiento LLM", "GPT-5.5", "Claude", "estructura del prompt", "PromptQuorum"],
      author: { "@type": "Person", name: "Hans Kuepper", url: "https://www.promptquorum.com/about" },
      publisher: { "@type": "Organization", name: "PromptQuorum", url: "https://www.promptquorum.com", logo: { "@type": "ImageObject", url: "https://www.promptquorum.com/logo.svg" } },
      mentions: [
        { "@type": "Thing", name: "PromptQuorum" },
    ...
    sections: {
      ...
      apiImplementation: {
        ...
        items: [
          '**OpenAI (GPT-5.5):** El system prompt se envía como primer mensaje con role: "system" en el array de messages. También admite un parámetro system separado en algunas configuraciones.',
  ...
  pt: {
    ...
    metaDescription: 'System prompts definem o comportamento da IA para toda a sessão; user prompts gerenciam cada solicitação. Diferenças, exemplos e padrões de depuração para GPT-5.5 e Claude.',
    schema: {
      "@context": "https://schema.org",
      "@type": "TechArticle",
      ...
      datePublished: "2026-03-22",
      dateModified: "2026-04-12",
      keywords: ["system prompt", "user prompt", "prompt engineering", "comportamento LLM", "GPT-5.5", "Claude", "estrutura do prompt", "PromptQuorum"],
      author: { "@type": "Person", name: "Hans Kuepper", url: "https://www.promptquorum.com/about" },
      publisher: { "@type": "Organization", name: "PromptQuorum", url: "https://www.promptquorum.com", logo: { "@type": "ImageObject", url: "https://www.promptquorum.com/logo.svg" } },
    },
    sections: {
  ...
  ar: {
    ...
    schema: {
      ...
      dateModified: '2026-04-12',
      inLanguage: 'ar',
      keywords: ['system prompt', 'user prompt', 'prompt engineering', 'سلوك LLM', 'GPT-5.5', 'Claude', 'بنية الـ prompt', 'PromptQuorum'],
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'يعود النموذج إلى سلوك التدريب الافتراضي. يمتلك كل من GPT-5.5 وClaude وGemini سلوكاً أساسياً مدمجاً (مفيد وغير ضار وصادق) عند غياب system prompt. سيستمر النموذج في الرد على user prompts، لكن دون تعريف للدور، أو قيود تنسيق المخرجات، أو حدود النطاق.'
          },
          {
    ...
    sections: {
      ...
      tldr: {
        ...
        items: [
          ...
          '시스템 프롬프트는 GPT-5.5, Claude 4.6 Sonnet, Gemini 3.5 Pro에 대한 PromptQuorum 테스트 기준으로 행동 일관성의 약 70%를 차지하며, 사용자 프롬프트는 특정 출력 결과를 형성합니다',
      ...
      whereTheyLive: {
        ...
        content: [
          '**시스템 프롬프트는 애플리케이션 레이어에, 사용자 프롬프트는 상호작용 레이어에 존재합니다.** OpenAI API를 통해 GPT-5.5를 호출할 때, 엔드포인트는 두 가지 별도 입력을 받습니다: `system`(영구 지침)과 `messages`(요청별 사용자 입력). 이는 Anthropic API를 통한 Claude 4.6 Sonnet, Google API를 통한 Gemini 3.5 Pro, 그리고 [Ollama](/prompt-engineering/context-windows-explained-why-ai-forgets) 또는 LM Studio를 통해 실행하는 로컬 LLM에서도 동일합니다.',
          '모든 모델은 시스템 + 사용자 프롬프트 패턴을 지원합니다:',
        ],
        items: [
          '**모델 레이어:** 기본 LLM (GPT-5.5, Claude 4.6 Sonnet, Gemini 3.5 Pro, LLaMA 3.1, Mistral Large) — 시스템 프롬프트와 사용자 프롬프트를 모두 수용합니다',
      ...
      designingSystemPrompt: {
        ...
        items: [
          ...
          '**여러 모델에 걸친 테스트:** 배포 전에 [GPT-5.5, Claude 4.6 Sonnet, Gemini 3.5 Pro 등 여러 모델](/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model)에서 시스템 프롬프트를 테스트하십시오. 일부 모델은 제약 조건에 더 엄격하고, 다른 모델은 스타일을 다르게 해석합니다. 강력한 시스템 프롬프트는 세 가지 모두에서 일관되게 작동합니다.',
        ],
      },
      ...
      promptquorumTransparency: {
        ...
        items: [
          ...
          '**모델 간 불일치:** GPT-5.5와 Ollama에서 동일한 프롬프트를 실행합니다. 다른 답변이 나옵니다. 두 시스템 프롬프트를 모두 보지 않으면 차이가 모델 능력 때문인지 숨겨진 지침 때문인지 알 수 없습니다.',
      ...
      promptquorumToggle: {
        ...
        content: [
          'PromptQuorum에는 토글 가능한 인터페이스가 포함되어 있습니다: "시스템 프롬프트 표시." 활성화하면 각 모델에서 실행 중인 실제 시스템 프롬프트를 볼 수 있습니다 — GPT-5.5, Claude 4.6 Sonnet, Gemini, Ollama, LM Studio, 모두 포함됩니다. 이는 하나의 프롬프트를 여러 로컬 백엔드에 동시에 디스패치할 때 특히 가치 있습니다.',
        ],
      },
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: '예. 모든 주요 LLM — GPT-5.5, Claude 4.6 Sonnet, Gemini 3.5 Pro, Ollama 모델, LM Studio — 은 시스템 프롬프트 + 사용자 프롬프트 패턴을 지원합니다. 일부는 기본 시스템 프롬프트를 제공하고, 다른 것들은 자신만의 것을 정의할 수 있게 합니다.'
          },
          {
          ...
          },
          {
            ...
            a: '모델이 기본 학습 동작으로 돌아갑니다. GPT-5.5, Claude 4.6 Sonnet, Gemini 3.5 Pro 모두 시스템 프롬프트가 없을 때 기본 동작(유용하고, 무해하며, 정직함)이 내장되어 있습니다. 모델은 여전히 사용자 프롬프트에 응답하지만, 역할 정의, 출력 형식 제약 조건, 또는 범위 경계 없이 — 결과는 덜 일관되고 덜 전문화될 것입니다.'
          },
          {
