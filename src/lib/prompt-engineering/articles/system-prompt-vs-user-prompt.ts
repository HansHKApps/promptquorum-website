...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  es: {
    ...
    metaDescription: 'Los system prompts definen el comportamiento de la IA. Los user prompts gestionan cada solicitud. Diferencias clave y ejemplos para GPT-4o y Claude.',
    schema: {
      "@context": "https://schema.org",
      "@type": "TechArticle",
      'url': 'https://www.promptquorum.com/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference?lang=es',
      'inLanguage': 'es',
      ...
      datePublished: "2026-03-22",
      dateModified: "2026-04-12",
      keywords: ["system prompt", "user prompt", "prompt engineering", "comportamiento LLM", "GPT-4o", "Claude", "estructura del prompt", "PromptQuorum"],
      author: { "@type": "Person", name: "Hans Kuepper", url: "https://www.promptquorum.com/about" },
      publisher: { "@type": "Organization", name: "PromptQuorum", url: "https://www.promptquorum.com", logo: { "@type": "ImageObject", url: "https://www.promptquorum.com/logo.svg" } },
      mentions: [
        { "@type": "Thing", name: "PromptQuorum" },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          '[Los 5 bloques de construcción que todo prompt necesita](/prompt-engineering/5-building-blocks-every-prompt-needs?lang=es) — los fundamentos del diseño estructurado de prompts',
          '[¿Qué es el Prompt Engineering?](/prompt-engineering/what-is-prompt-engineering?lang=es) — visión general de principios y técnicas',
          '[Tokens, costes y límites](/prompt-engineering/tokens-costs-limits-economics-of-ai-prompting?lang=es) — cómo la longitud del system prompt afecta al coste de la API en cada llamada',
          '[Alucinaciones de IA: Por qué la IA inventa cosas](/prompt-engineering/ai-hallucinations-why-ai-makes-things-up?lang=es) — cómo los system prompts ayudan a reducir los hechos fabricados',
        ],
      },
      faq: {
