    ...
    en: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'What is LLM-as-judge evaluation?', acceptedAnswer: { '@type': 'Answer', text: 'LLM-as-judge uses a capable model like GPT-4o or Claude 4.6 Sonnet to score outputs against a rubric. It scales to thousands of test cases without human review and handles nuanced quality dimensions that binary metrics miss. The main risk is model bias: the judge may favor outputs similar to its own style.' } },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'LLM-as-judge uses GPT-4o or Claude 4.6 Sonnet to score nuanced free-text outputs at scale',
        ...
        llmAsJudge: {
          ...
          content: '**LLM-as-judge uses a capable model — typically GPT-4o or Claude 4.6 Sonnet — to score outputs against a rubric.** This scales evaluation to thousands of test cases without human review and handles quality dimensions that binary metrics cannot capture: coherence, tone, completeness, and factual accuracy.\n\nThe judge approach requires:\n\n1. A detailed rubric (scoring criteria per dimension)\n2. A structured output format (e.g., JSON with score + justification)\n3. Calibration against human judgments for your specific task',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'What is LLM-as-judge evaluation?', a: 'LLM-as-judge uses GPT-4o or Claude 4.6 Sonnet to score outputs against a rubric at scale. It handles nuanced quality dimensions that binary metrics miss. The main risk is model bias toward its own output style.' },
