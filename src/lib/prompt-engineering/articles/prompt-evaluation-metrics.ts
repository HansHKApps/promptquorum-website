...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      seoTitle: 'مقاييس تقييم البرومبتات: Pass Rate وBLEU والمزيد',
      metaDescription: 'تعلّم أي مقاييس تقييم تستخدم حسب نوع المخرجات: pass rate لـJSON وBLEU للترجمة وLLM-as-judge للنص الحر.',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Braintrust مقابل Prompthub مقابل Vellum](/ar/prompt-engineering/braintrust-vs-prompthub-vs-vellum) — مقارنة منصات تقييم البرومبتات المخصصة للفرق',
            '[أفضل أدوات اختبار وتقييم البرومبتات 2026](/ar/prompt-engineering/best-prompt-testing-tools) — أدوات مُقيَّمة لضبط جودة البرومبتات المنهجي',
