...
export const article: Record<Language, PEArticle> = {
  ...
  ja: {
    ...
    seoTitle: 'プロンプト脆弱性を低減する7つのテクニック（2026年）',
    ...
    twitterTitle: 'プロンプト脆弱性を低減する7つのテクニック（2026年）',
  ...
  zh: {
    ...
    seoTitle: '减少Prompt脆弱性：7种技术（2026）',
    metaDescription: 'Prompt脆弱性导致静默失败。应用7种技术：结构化输出、防御性指令、回归测试、版本固定。',
    ogTitle: '减少Prompt脆弱性：7种可靠Prompt技术（2026）',
    ogDescription: '用结构化输出、Few-Shot锚点和回归测试集减少Prompt脆弱性。通过PromptQuorum对比GPT与Claude的鲁棒性。',
    twitterTitle: '减少Prompt脆弱性：7种技术（2026）',
