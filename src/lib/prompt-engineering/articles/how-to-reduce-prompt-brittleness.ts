...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'كيفية تقليل هشاشة الـ prompt: 7 تقنيات',
    metaDescription: 'هشاشة الـ prompt تُسبِّب إخفاقاتٍ صامتة عند تغيُّر المدخلات. طبِّق 7 تقنيات: الإخراج المهيكل، والتعليمات الدفاعية، واختبار الانحدار، وتثبيت إصدار النموذج.',
