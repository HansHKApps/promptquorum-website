  ...
  pt: {
    ...
    sections: {
      ...
      techniquesToReduce: {
        ...
        numberedItems: [
          '**Aplique saída estruturada** — Use o [modo JSON ou as APIs de saída estruturada nativa](/prompt-engineering/structured-output-json-mode) em vez de pedir ao modelo que "responda em JSON". A aplicação de formato transfere o ônus de confiabilidade do prompt para a camada de API.',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Saída estruturada e modo JSON](/pt/prompt-engineering/structured-output-json-mode) — Aplicação de formato no nível da API para GPT, Claude e Gemini',
  ...
  ar: {
    ...
    sections: {
      ...
      techniquesToReduce: {
        ...
        numberedItems: [
          '**طبِّق الإخراج المهيكل** — استخدم [وضع JSON أو APIs الإخراج المهيكل الأصلية](/prompt-engineering/structured-output-json-mode) بدلًا من مطالبة النموذج بـ "الرد بـ JSON". تطبيق التنسيق ينقل عبء الموثوقية من الـ prompt إلى طبقة API.',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[الإخراج المهيكل ووضع JSON](/ar/prompt-engineering/structured-output-json-mode) — تطبيق التنسيق على مستوى API لـ GPT وClaude وGemini',
  ...
  ko: {
    ...
    sections: {
      ...
      techniquesToReduce: {
        ...
        numberedItems: [
          '**구조화된 출력 강제** — 모델에게 "JSON으로 응답"하도록 요청하는 대신 [JSON 모드 또는 네이티브 구조화된 출력 API](/prompt-engineering/structured-output-json-mode)를 사용하십시오. 형식 강제는 신뢰성 부담을 프롬프트에서 API 레이어로 이동시킵니다.',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[구조화된 출력 및 JSON 모드](/prompt-engineering/structured-output-json-mode) — GPT, Claude, Gemini를 위한 API 레벨 형식 강제',
