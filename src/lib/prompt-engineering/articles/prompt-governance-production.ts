...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  es: {
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/es/es/prompt-engineering/prompt-governance-production',
      inLanguage: 'es',
  ...
  ar: {
    ...
    seoTitle: 'حوكمة التعليمات في الإنتاج: الأدوار وبوابات المراجعة',
    ...
    metaDescription: 'أنشئ حوكمة للتعليمات بثلاثة أدوار (المؤلف والمراجع والمعتمِد) وثلاث بوابات مراجعة وإجراءات التراجع وسجلات التدقيق. متوافق مع NIST AI RMF وقانون الذكاء الاصطناعي الأوروبي.',
