...
const OG_SLUG = keyToSlug('prompt-governance-production');
...
export const article: Partial<Record<Language, PEArticle>> = {
  en: {
    ...
    sections: {
      ...
      ownership_model_part2: {
        content: [
          'Add a Prompt Owner role for high-traffic production prompts. The Prompt Owner is accountable for the prompt\'s live performance across all model versions — GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro — and is the first contact during incidents.',
      ...
      tools: {
        ...
        items: [
          ...
          '[PromptQuorum](/features): multi-model testing to confirm a prompt works across GPT-5.6, Claude Sonnet 5, and Gemini 3.1 Pro before deployment. Use during Gate 2 peer review.',
        ],
      },
      faq: {
        id: 'faq',
    ...
    sections: {
      ...
      tools: {
        ...
        items: [
          ...
          'PromptQuorum: Multi-Modell-Tests zur Bestätigung, dass ein Prompt über GPT-5.6, Claude Sonnet 5 und Gemini 3.1 Pro funktioniert.',
        ],
      },
      faq: {
        id: 'faq',
  ...
  es: {
    ...
    sections: {
      ...
      ownership_model_part2: {
        content: [
          'Añade un rol de Propietario de Prompt para prompts de producción de alto tráfico. El Propietario del Prompt es responsable del rendimiento en vivo del prompt en todas las versiones del modelo — GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro — y es el primer contacto durante incidentes.',
      ...
      tools: {
        ...
        items: [
          ...
          '[PromptQuorum](/features): pruebas multi-modelo para confirmar que un prompt funciona en GPT-5.6, Claude Sonnet 5 y Gemini 3.1 Pro antes del despliegue. Úsalo durante la revisión por pares del Gate 2.',
        ],
      },
      faq: {
        id: 'faq',
  ...
  pt: {
    ...
    sections: {
      ...
      ownership_model_part2: {
        content: [
          'Adicione um papel de Proprietário de Prompt para prompts de produção de alto tráfego. O Proprietário do Prompt é responsável pelo desempenho em produção do prompt em todas as versões do modelo — GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro — e é o primeiro contato durante incidentes.',
      ...
      tools: {
        ...
        items: [
          ...
          '[PromptQuorum](/features): testes multi-modelo para confirmar que um prompt funciona no GPT-5.6, Claude Sonnet 5 e Gemini 3.1 Pro antes da implantação. Use durante a revisão por pares do Gate 2.',
        ],
      },
      faq: {
        id: 'faq',
    ...
    sections: {
      ...
      tools: {
        ...
        items: [
          ...
          'PromptQuorum : tests multi-modèles pour confirmer qu\'un prompt fonctionne sur GPT-5.6, Claude Sonnet 5 et Gemini 3.1 Pro.',
        ],
      },
      faq: {
        id: 'faq',
    ...
    sections: {
      ...
      tools: {
        ...
        items: [
          ...
          'PromptQuorum：デプロイ前にGPT-5.6、Claude Sonnet 5、Gemini 3.1 Proでの動作を確認するマルチモデルテスト。',
        ],
      },
      faq: {
        id: 'faq',
  ...
  ar: {
    ...
    metaDescription: '⁨3⁩ أدوار (مؤلف، مراجع، معتمِد) و⁨3⁩ بوابات مراجعة لحوكمة ⁨Prompt⁩ في الإنتاج. يتضمن إجراءات التراجع وسجلات التدقيق متوافقة مع ⁨NIST AI RMF⁩.',
    ...
    sections: {
      ...
      ownership_model_part2: {
        content: [
          'أضف دور مالك التعليمة للتعليمات الإنتاجية عالية الحركة. مالك التعليمة مسؤول عن أداء التعليمة المباشر عبر جميع إصدارات النماذج — GPT-5.6 وClaude Sonnet 5 وGemini 3.1 Pro — وهو جهة الاتصال الأولى أثناء الحوادث.',
      ...
      tools: {
        ...
        items: [
          ...
          '[PromptQuorum](/features): اختبار متعدد النماذج للتأكد من عمل التعليمة عبر GPT-5.6 وClaude Sonnet 5 وGemini 3.1 Pro قبل النشر. استخدمه أثناء مراجعة الأقران في البوابة 2.',
        ],
      },
      faq: {
        id: 'faq',
    ...
    sections: {
      ...
      tools: {
        ...
        items: [
          ...
          'PromptQuorum：多模型测试，确认Prompt在GPT-5.6、Claude Sonnet 5和Gemini 3.1 Pro上部署前能正常工作。',
        ],
      },
      faq: {
        id: 'faq',
  ...
  ko: {
    ...
    metaDescription: '3개 역할(작성자·검토자·승인자), 3개 검토 게이트, 롤백 절차, 감사 추적으로 프롬프트 거버넌스를 구축하십시오. NIST AI RMF 및 EU AI Act 준수.',
    ogDescription: '프로덕션 프롬프트 거버넌스: 3역할 소유 모델, 자동화 테스트 게이트, 5분 이내 롤백, 완전한 감사 추적. PromptQuorum으로 다중 모델 테스트.',
    twitterDescription: '프롬프트는 조용히 실패합니다. 거버넌스가 유일한 가시성 메커니즘입니다. 3개 역할, 3개 게이트, 5분 롤백, 완전한 감사 추적.',
    publishDate: '2026-05-02',
    readTime: '14분 분량',
    educationalLevel: 'Advanced',
    primaryTerm: '프롬프트 거버넌스',
    leadAnswerBlock: '**프롬프트 거버넌스는 어떤 프롬프트가 프로덕션에서 운영될지 제어하는 역할·검토 게이트·배포 규칙의 집합입니다.** 거버넌스 없이는 프롬프트가 조용히 변경됩니다 — 승인 기록도, 롤백 경로도, 출력 품질 저하 시 대응 방안도 없습니다.',
    quickFacts: [
      '3역할 소유 모델: 작성자(Author), 검토자(Reviewer), 승인자(Approver)',
      '버전 관리를 사전 구성하면 롤백에 5분 미만 소요',
      '3개 필수 게이트: 자동 회귀 테스트(≥90% 합격률), 동료 검토, 보안 스캔',
      '감사 추적은 누가·무엇을·언제·왜·게이트 결과를 반드시 기록해야 함',
      'EU AI Act(2026년 발효)는 고위험 AI 프롬프트에 추적 가능성 요구',
      '최소 실행 스택: Git + Braintrust 또는 Promptfoo',
    ],
    toc: [
      { label: '프롬프트 거버넌스란 무엇이며 왜 중요한가', anchor: 'what_is_governance' },
      { label: '3역할 소유 모델', anchor: 'ownership_model' },
      { label: '배포 전 검토 게이트', anchor: 'review_gates' },
      { label: '실패한 프롬프트 롤백 방법', anchor: 'rollback' },
      { label: '감사 추적: 기록할 내용', anchor: 'audit_trail' },
      { label: '프롬프트 거버넌스 도구', anchor: 'tools' },
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/ko/prompt-engineering/prompt-governance-production',
      inLanguage: 'ko',
    ...
    sections: {
      tldr: {
        isTldr: true,
        content: [
          '프롬프트 거버넌스는 3개 역할(작성자·검토자·승인자), 3개 필수 검토 게이트, 롤백 절차를 통해 어떤 프롬프트가 프로덕션에 도달하는지 제어합니다. 프롬프트는 조용히 실패합니다 — 거버넌스가 유일한 가시성 메커니즘입니다. 필요하기 전에 버전 관리와 롤백을 설정하십시오: 준비가 되어 있으면 롤백이 5분 미만, 그렇지 않으면 몇 시간이 소요됩니다.',
        ],
      },
      key_takeaways: {
        title: '핵심 요점',
      ...
      what_is_governance: {
        ...
        snippets: [
          ...
          { type: 'in-plain-terms', text: '거버넌스 없이는 프롬프트 변경이 보이지 않습니다 — 무엇을 변경했는지에 대한 기록도 없고, 문제가 발생했을 때 롤백 방법도 없으며, 품질이 조용히 저하될 때 경보도 없습니다.' },
        ],
        content: [
        ...
        callouts: [
          { type: 'warning', label: '조용한 실패', text: '품질을 저하시키는 프롬프트 변경은 오류도, 예외도, 경보도 생성하지 않습니다. 사용자 불만 또는 모니터링을 통해서만 문제를 발견할 수 있습니다 — 둘 다 피해가 발생한 이후입니다.' },
        ],
      },
      ownership_model: {
        id: 'ownership_model',
      ...
      ownership_model_part2: {
        content: [
          '고트래픽 프로덕션 프롬프트에는 프롬프트 소유자 역할을 추가하십시오. 프롬프트 소유자는 모든 모델 버전(GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro)에 걸친 프롬프트의 라이브 성능에 책임을 지며, 인시던트 발생 시 첫 번째 연락처입니다.',
        ...
        callouts: [
          { type: 'insight', label: '실전에서의 3역할 모델', text: '작성자-검토자-승인자 분리는 소프트웨어 코드 검토를 반영합니다: 코드를 작성한 사람이 자신의 풀 리퀘스트를 승인할 수 없습니다. 동일한 원칙이 프롬프트에도 적용됩니다.' },
        ],
      },
      review_gates: {
        id: 'review_gates',
      ...
      review_gates_part2: {
        ...
        callouts: [
          { type: 'tip', label: '게이트 1 자동화', text: '게이트 1(자동화 테스트)은 배포 전만이 아니라 모든 커밋에서 실행되어야 합니다. 커밋 시 회귀를 발견하면 수정에 몇 분이 걸립니다; 배포 시 발견하면 몇 시간이 걸립니다.' },
        ],
      },
      rollback: {
        id: 'rollback',
      ...
      tools: {
        ...
        items: [
          ...
          '[PromptQuorum](/features): 배포 전 프롬프트가 GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro에서 작동하는지 확인하기 위한 다중 모델 테스트. 게이트 2 동료 검토 중에 사용하십시오.',
        ],
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          ...
          { q: '프롬프트 거버넌스가 프로덕션에서 왜 중요합니까?', a: '프롬프트는 조용히 실패합니다 — 오류 로그도, 예외도, 경보도 없습니다. 출력 품질이 가시적인 신호 없이 저하됩니다. 거버넌스가 가시성을 추가합니다: 모든 변경이 추적되고, 모든 버전이 검토 가능하며, 모든 배포가 롤백될 수 있습니다.' },
          { q: '프롬프트 거버넌스에 어떤 역할이 필요합니까?', a: '3개 역할이 대부분의 팀을 담당합니다: 작성자(프롬프트 작성, 초기 테스트 실행), 검토자(품질과 준수 확인), 승인자(프로덕션 배포 승인). 대형 팀은 프롬프트 소유자 역할을 추가합니다.' },
          { q: '프로덕션에서 불량 프롬프트를 어떻게 롤백합니까?', a: 'Git 또는 PromptHub에서 버전 태그와 함께 배포된 모든 프롬프트를 저장하십시오. 회귀가 감지되면 배포 구성에서 이전 버전으로 되돌리고 재배포하십시오. 버전 관리가 사전에 설정되어 있으면 5분 이내에 완료됩니다.' },
          { q: 'NIST AI 위험 관리 프레임워크는 프롬프트 거버넌스를 요구합니까?', a: 'NIST AI RMF(2023)는 추적 가능성, 배포 전 위험 평가, 인시던트 대응을 포함한 거버넌스 통제를 권장합니다. 프롬프트 버전 관리와 검토 게이트가 세 가지 모두를 해결합니다.' },
          { q: 'EU AI Act는 프롬프트 거버넌스를 요구합니까?', a: 'EU AI Act(2026년 발효)는 고위험 AI 시스템에 대해 인간 감독, 문서화, 추적 가능성을 요구합니다. 고위험 범주(의료·법률·채용·신용)의 프롬프트는 문서화된 변경 제어가 있어야 합니다. 버전 관리, 검토 게이트, 감사 추적이 추적 가능성 요건을 직접 충족합니다.' },
          { q: '프롬프트 거버넌스는 모델 거버넌스와 어떻게 다릅니까?', a: '모델 거버넌스는 모델 선택, 훈련, 편향 테스트, 배포 정책을 다룹니다. 프롬프트 거버넌스는 배포된 모델에 어떤 지침이 주어지는지를 다룹니다. 둘 다 규제 환경에서 필요하며, 상호 보완적이지만 별개입니다.' },
          { q: '프롬프트의 감사 추적은 무엇을 포함해야 합니까?', a: '프롬프트 감사 추적은 반드시 기록해야 합니다: 각 버전의 프롬프트 텍스트, 변경한 사람, 언제, 왜, 통과한 테스트, 배포를 승인한 사람, 귀인된 인시던트. 추적 기록은 조회 가능해야 합니다 — 감사자가 특정 시점에 어떤 프롬프트가 라이브였는지 묻는다면 5분 이내에 답할 수 있어야 합니다.' },
        ],
      },
      related_reading: {
        id: 'related_reading',
