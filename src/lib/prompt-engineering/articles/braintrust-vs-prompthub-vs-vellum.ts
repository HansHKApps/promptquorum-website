...
`,
  ...
  fr: {
    ...
    title: 'Braintrust vs PromptHub vs Vellum vs Promptfoo',
    seoTitle: 'Braintrust vs PromptHub vs Vellum vs Promptfoo (2026)',
    metaDescription: 'Comparaison Braintrust, PromptHub, Vellum et Promptfoo : évaluation, version control, A/B testing et CI/CD. Tableau comparatif avec prix.',
...
`,
  ...
  ja: {
    ...
    metaDescription: 'Braintrust、PromptHub、Vellum、Promptfooを比較：評価スコアリング、バージョン管理、A/Bテスト、CI/CD。価格付き比較表。',
  ...
  zh: {
    ...
    title: 'Braintrust vs PromptHub vs Vellum vs Promptfoo',
    seoTitle: 'Braintrust vs PromptHub vs Vellum vs Promptfoo（2026）',
    metaDescription: 'Braintrust、PromptHub、Vellum和Promptfoo对比：评估评分、版本控制、A/B测试和CI/CD。含价格的对比表。',
