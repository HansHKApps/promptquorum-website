...
`,
  ...
  ja: {
    theme: 'ツール & プラットフォーム',
    title: 'Braintrust vs PromptHub vs Vellum vs Promptfoo',
    seoTitle: 'Braintrust vs PromptHub vs Vellum vs Promptfoo（2026年）',
    metaDescription: 'Braintrust、PromptHub、Vellum、Promptfooを比較：評価スコアリング、バージョン管理、A/Bテスト、CI/CD。価格付き比較表でチームに合う2ツールを選択。',
    ogTitle: '4ツール全部買うと月1,000ドル以上の無駄。最適な2ツール構成とは',
    ogDescription: '4つのプロンプト管理ツール比較：Braintrustはスコアリング、PromptHubはバージョン管理、VellumはA/Bテスト、PromptfooはCI/CD。最適な2ツール構成を選択。',
    twitterTitle: 'Braintrust vs PromptHub vs Vellum vs Promptfoo：どの2つを選ぶ？',
    twitterDescription: 'Braintrust vs PromptHub vs Vellum vs Promptfoo——本当に必要な2ツールはどれ？価格付き比較（2026年）。',
