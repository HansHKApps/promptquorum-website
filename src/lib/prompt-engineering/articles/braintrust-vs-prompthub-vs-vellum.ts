...
`,
      ...
      'promptquorum': {
        ...
        items: [
          '25+ Modelle einschließlich GPT-5.6, Claude Opus 5, Gemini 3.1 Pro, und lokale Modelle über Ollama und LM Studio',
...
`,
      ...
      'promptquorum': {
        ...
        items: [
          '25+ modèles incluant GPT-5.6, Claude Opus 5, Gemini 3.1 Pro, locaux via Ollama et LM Studio',
  ...
  - vars:
    ...
    assert:
      ...
      promptquorum: {
        ...
        items: [
          'أكثر من 25 نموذجًا بما يشمل GPT-5.6 وClaude Opus 5 وGemini 3.1 Pro والنماذج المحلية عبر Ollama وLM Studio',
  ...
  - vars:
    ...
    assert:
      ...
      promptquorum: {
        ...
        items: [
          'GPT-5.6, Claude Opus 5, Gemini 3.1 Pro 및 Ollama와 LM Studio를 통한 로컬 모델을 포함한 25개 이상의 모델',
