...
export const article: Record<Language, PEArticle> = {
  en: {
    ...
    seoTitle: 'Braintrust vs PromptHub vs Vellum vs Promptfoo (2026 Comparison) | PromptQuorum',
    ...
    metaDescription: 'Head-to-head: Braintrust for eval scoring ($500/mo), Vellum for production A/B ($200–500/mo), Promptfoo for free CI/CD, PromptHub for versioning ($50/mo). Most teams need exactly 2 — not all 4.',
...
tests:
  ...
  de: {
    ...
    title: 'Braintrust vs PromptHub vs Vellum vs Promptfoo',
    seoTitle: 'Braintrust vs PromptHub vs Vellum vs Promptfoo (Vergleich 2026) | PromptQuorum',
    metaDescription: 'Direktvergleich: Braintrust für Eval-Scoring (500 $/Monat), Vellum für Produktions-A/B (200–500 $/Monat), Promptfoo für kostenloses CI/CD, PromptHub für Versionierung (50 $/Monat). Die meisten Teams brauchen nur 2.',
    ogTitle: 'Alle 4 Prompt-Tools kaufen verschwendet 1.000+ $/Monat. Der 2-Tool-Stack',
    ogDescription: 'Braintrust bewertet. Vellum splittet Traffic. Promptfoo fängt Regressionen. PromptHub versioniert. Wählen Sie 2.',
    twitterTitle: 'Braintrust vs PromptHub vs Vellum vs Promptfoo: Welche 2 wählen?',
    twitterDescription: 'Promptfoo ist kostenlos. Vellum ab 200 $/Monat. Braintrust ab 500 $. PromptHub ab 50 $. Sie brauchen genau 2 — Eval + Deployment.',
...
`,
  ...
  fr: {
    ...
    title: 'Braintrust vs PromptHub vs Vellum vs Promptfoo',
    seoTitle: 'Braintrust vs PromptHub vs Vellum vs Promptfoo (comparatif 2026) | PromptQuorum',
    metaDescription: 'Face-à-face : Braintrust pour l\'évaluation (500 $/mois), Vellum pour l\'A/B en production (200–500 $/mois), Promptfoo en CI/CD gratuit, PromptHub pour le versioning (50 $/mois). La plupart des équipes n\'en ont besoin que de 2.',
    ogTitle: 'Acheter les 4 outils gaspille 1 000+ $/mois. Voici le stack à 2 outils',
    ogDescription: 'Braintrust évalue. Vellum répartit le trafic. Promptfoo détecte les régressions. PromptHub versionne. Choisissez 2.',
    twitterTitle: 'Braintrust vs PromptHub vs Vellum vs Promptfoo : lesquels choisir ?',
    twitterDescription: 'Promptfoo est gratuit. Vellum dès 200 $/mois. Braintrust dès 500 $. PromptHub dès 50 $. Vous avez besoin de 2 — éval + déploiement.',
...
`,
  ...
  ja: {
    theme: 'ツール & プラットフォーム',
    title: 'Braintrust vs PromptHub vs Vellum vs Promptfoo',
    seoTitle: 'Braintrust vs PromptHub vs Vellum vs Promptfoo（2026年比較）| PromptQuorum',
    metaDescription: '直接比較：Braintrustは評価（月額500ドル）、Vellumは本番A/B（200〜500ドル）、Promptfooは無料CI/CD、PromptHubはバージョン管理（50ドル）。ほとんどのチームに必要なのは4つではなく2つだけ。',
    ogTitle: '4ツール全部買うと月1,000ドル以上の無駄。最適な2ツール構成とは',
    ogDescription: 'Braintrustは評価。Vellumはトラフィック分割。Promptfooはリグレッション検出。PromptHubはバージョン管理。2つ選ぼう。',
    twitterTitle: 'Braintrust vs PromptHub vs Vellum vs Promptfoo：どの2つを選ぶ？',
    twitterDescription: 'Promptfooは無料。Vellumは月額200ドル〜。Braintrustは500ドル〜。PromptHubは50ドル〜。必要なのは評価+デプロイの2つだけ。',
  ...
  zh: {
    theme: '工具 & 平台',
    title: 'Braintrust vs PromptHub vs Vellum vs Promptfoo',
    seoTitle: 'Braintrust vs PromptHub vs Vellum vs Promptfoo（2026对比）| PromptQuorum',
    metaDescription: '直接对比：Braintrust负责评估（500美元/月），Vellum负责生产A/B（200–500美元/月），Promptfoo免费CI/CD，PromptHub负责版本管理（50美元/月）。大多数团队只需要2个，不是全部4个。',
    ogTitle: '买齐4个提示词工具每月浪费1000美元以上。最优的2工具方案',
    ogDescription: 'Braintrust评估。Vellum分流。Promptfoo防回归。PromptHub管版本。选2个就够了。',
    twitterTitle: 'Braintrust vs PromptHub vs Vellum vs Promptfoo：该选哪2个？',
    twitterDescription: 'Promptfoo免费。Vellum起价200美元/月。Braintrust 500美元。PromptHub 50美元。你只需要2个——评估+部署。决策矩阵在内。',
