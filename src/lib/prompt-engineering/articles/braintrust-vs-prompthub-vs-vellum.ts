...
`,
  ...
  zh: {
    ...
    seoTitle: 'Braintrust vs PromptHub vs Vellum vs Promptfoo（2026）',
    metaDescription: 'Braintrust、PromptHub、Vellum和Promptfoo对比：评估评分、版本控制、A/B测试和CI/CD。含价格对比表，大多数团队只需2款工具。',
    ogTitle: '买齐4个提示词工具每月浪费1000美元以上。最优的2工具方案',
    ogDescription: '4款Prompt管理工具对比：Braintrust评分、PromptHub版本控制、Vellum A/B测试、Promptfoo CI/CD。选择最适合的双工具组合。',
    twitterTitle: 'Braintrust vs PromptHub vs Vellum vs Promptfoo：该选哪2个？',
    twitterDescription: 'Braintrust vs PromptHub vs Vellum vs Promptfoo——你的团队真正需要哪两个？含价格对比（2026）。',
