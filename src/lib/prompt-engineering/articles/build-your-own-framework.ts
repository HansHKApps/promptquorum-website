    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          ...
          { q: '커스텀 프레임워크가 작동하는지 어떻게 테스트합니까?', a: '프레임워크를 대표적인 프롬프트 10개에 적용하고 3가지 기준으로 결과를 점수화하십시오: 작업 완료도, 형식 준수, 품질 일관성. 작동하는 프레임워크는 세 가지 모두에서 8/10 이상을 달성해야 합니다. PromptQuorum을 사용하여 GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro에서 동일한 프레임워크를 테스트하십시오.' },
