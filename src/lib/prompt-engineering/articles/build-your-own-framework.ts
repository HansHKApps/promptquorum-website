...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  pt: {
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/pt/pt/prompt-engineering/build-your-own-framework',
      inLanguage: 'pt-BR',
    ...
    sections: {
      ...
      related_reading: {
        ...
        items: [
          ...
          { title: 'أي إطار عمل للأوامر يجب أن تستخدم؟', url: '/ar/prompt-engineering/which-framework-to-use' },
          { title: 'اختيار إطار عمل الأوامر للفرق', url: '/ar/prompt-engineering/prompt-framework-selection-for-teams' },
          { title: 'إعداد هندسة الأوامر للفرق الصغيرة', url: '/ar/prompt-engineering/pe-setup-small-teams' },
        ],
      },
      sources: {
        title: 'المصادر',
    ...
    sections: {
      ...
      related_reading: {
        ...
        items: [
          ...
          '[소규모 팀을 위한 프롬프트 엔지니어링 설정](/ko/prompt-engineering/pe-setup-small-teams)',
        ],
      },
      sources: {
        title: '출처',
