...
export const article: Partial<Record<Language, PEArticle>> = {
  en: {
    ...
    quickFacts: [
      ...
      'Cross-model test on GPT-5.6 and Claude Sonnet 5 before standardizing',
    ],
    toc: [
    ...
    schema: {
      ...
      image: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/api/og/build-your-own-framework', width: 1200, height: 675 },
    ...
    sections: {
      ...
      key_takeaways: {
        ...
        items: [
          ...
          'Test on 10 real prompts before documenting — frameworks built from theory fail in practice',
          'Verify cross-model reliability on GPT-5.6 and Claude Sonnet 5 before standardizing',
      ...
      five_step_process: {
        ...
        numberedItems: [
          ...
          { title: 'Apply to 10 real prompts', whyItMatters: 'Use actual prompts from your workflow — not invented examples. Score each output: does it meet the goal? Which components were missing? Which were ignored? Run the same prompts on GPT-5.6 and Claude Sonnet 5 via PromptQuorum to confirm cross-model reliability.' },
      ...
      common_mistakes: {
        ...
        mistakes: [
          ...
          },
          {
            ...
            problem: 'A framework that works on GPT-5.6 may produce different output on Claude Sonnet 5 if it relies on implicit GPT-specific behaviors.',
      ...
      faq: {
        ...
        faqs: [
          ...
          { q: 'How do I test if my custom framework is working?', a: 'Apply the framework to 10 representative prompts and score outputs against 3 criteria: task completion, format compliance, and quality consistency. A working framework should score 8/10 or better on all three. Use PromptQuorum to test the same framework prompt across GPT-5.6, Claude Sonnet 5, and Gemini 2.5 Pro to confirm it works across models.' },
          { q: 'Can a custom framework work across different AI models?', a: 'Yes, if designed correctly. Model-agnostic frameworks avoid model-specific syntax and rely on universal components (task definition, constraints, output format). Test your framework on at least GPT-5.6 and Claude Sonnet 5 before finalizing — if it needs significant rewording per model, simplify the component definitions.' },
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'Can a custom framework work across different AI models?', a: 'Yes, if designed correctly. Avoid model-specific syntax and build around universal components (task, constraints, output format). Test on GPT-5.6 and Claude before finalizing. If the framework needs rewording per model, simplify it.' },
  ...
  de: {
    ...
    quickFacts: [
      ...
      'Modellübergreifend auf GPT-5.6 und Claude Sonnet 5 testen vor der Standardisierung',
    ],
    toc: [
    ...
    sections: {
      ...
      key_takeaways: {
        ...
        items: [
          ...
          'Überprüfen Sie die modellübergreifende Zuverlässigkeit auf GPT-5.6 und Claude Sonnet 5',
      ...
      five_step_process: {
        ...
        numberedItems: [
          ...
          { title: 'An 10 realen Prompts anwenden', whyItMatters: 'Verwenden Sie tatsächliche Prompts aus Ihrem Workflow — keine erfundenen Beispiele. Bewerten Sie jede Ausgabe: Erfüllt sie das Ziel? Welche Komponenten fehlten? Testen Sie mit PromptQuorum auf GPT-5.6 und Claude Sonnet 5.' },
  ...
  es: {
    ...
    quickFacts: [
      ...
      'Prueba entre modelos en GPT-5.6 y Claude Sonnet 5 antes de estandarizar',
    ],
    toc: [
    ...
    sections: {
      ...
      key_takeaways: {
        ...
        items: [
          ...
          'Verifica la fiabilidad entre modelos en GPT-5.6 y Claude Sonnet 5 antes de estandarizar',
      ...
      common_mistakes: {
        ...
        mistakes: [
          ...
          },
          {
            ...
            problem: 'Un framework que funciona en GPT-5.6 puede producir resultados diferentes en Claude Sonnet 5 si depende de comportamientos implícitos específicos de GPT.',
      ...
      related_reading: {
        ...
        items: [
          ...
          { title: 'Configuración de prompt engineering para equipos pequeños', url: '/es/prompt-engineering/prompt-engineering-setup-small-teams' },
        ],
      },
      sources: {
        title: 'Fuentes',
  ...
  pt: {
    ...
    quickFacts: [
      ...
      'Teste entre modelos no GPT-5.6 e Claude Sonnet 5 antes de padronizar',
    ],
    toc: [
      { label: 'Framework vs. Técnica', anchor: 'framework_vs_technique' },
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/pt/prompt-engineering/build-your-own-framework',
      inLanguage: 'pt-BR',
    ...
    sections: {
      ...
      key_takeaways: {
        ...
        items: [
          ...
          'Verifique a confiabilidade entre modelos no GPT-5.6 e Claude Sonnet 5 antes de padronizar',
      ...
      common_mistakes: {
        ...
        mistakes: [
          ...
          },
          {
            ...
            problem: 'Um framework que funciona no GPT-5.6 pode produzir resultados diferentes no Claude Sonnet 5 se depender de comportamentos implícitos específicos do GPT.',
      ...
      related_reading: {
        ...
        items: [
          ...
          { title: 'Configuração de prompt engineering para equipes pequenas', url: '/pt/prompt-engineering/prompt-engineering-setup-small-teams' },
        ],
      },
      sources: {
        title: 'Fontes',
  ...
  fr: {
    ...
    quickFacts: [
      ...
      'Tester sur GPT-5.6 et Claude Sonnet 5 avant de standardiser',
    ],
    toc: [
      { label: 'Framework vs. technique', anchor: 'framework_vs_technique' },
    ...
    sections: {
      ...
      key_takeaways: {
        ...
        items: [
          ...
          'Vérifiez la fiabilité multi-modèles sur GPT-5.6 et Claude Sonnet 5',
      ...
      five_step_process: {
        ...
        numberedItems: [
          ...
          { title: 'Appliquer à 10 prompts réels', whyItMatters: 'Utilisez des prompts réels de votre workflow — pas des exemples inventés. Évaluez chaque sortie. Testez sur GPT-5.6 et Claude Sonnet 5 via PromptQuorum.' },
  ...
  ja: {
    ...
    quickFacts: [
      ...
      '標準化前にGPT-5.6とClaude Sonnet 5でモデル横断テスト',
    ],
    toc: [
    ...
    sections: {
      ...
      key_takeaways: {
        ...
        items: [
          ...
          'GPT-5.6とClaude Sonnet 5でモデル横断的な信頼性を確認する',
      ...
      five_step_process: {
        ...
        numberedItems: [
          ...
          { title: '10の実際のプロンプトに適用する', whyItMatters: 'ワークフローからの実際のプロンプトを使用します（作り話は不可）。各出力を評価します。PromptQuorum経由でGPT-5.6とClaude Sonnet 5でテストし、モデル横断的な信頼性を確認します。' },
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'カスタムフレームワークは異なるAIモデル間で機能できるか?', a: 'はい、正しく設計されていれば可能です。モデル固有の構文を避けて、普遍的なコンポーネント（タスク、制約、出力形式）の周りに構築します。最終化する前にGPT-5.6とClaudeでテストします。フレームワークがモデルごとに大幅な言い換えを必要とする場合は、簡単にしてください。' },
  ...
  zh: {
    ...
    quickFacts: [
      ...
      '标准化前在GPT-5.6和Claude Sonnet 5上进行跨模型测试',
    ],
    toc: [
    ...
    sections: {
      ...
      key_takeaways: {
        ...
        items: [
          ...
          '在GPT-5.6和Claude Sonnet 5上验证跨模型可靠性',
      ...
      five_step_process: {
        ...
        numberedItems: [
          ...
          { title: '在10条真实Prompt上进行测试', whyItMatters: '使用工作流中的实际Prompt——不要用虚构的例子。通过PromptQuorum在GPT-5.6和Claude Sonnet 5上测试，确认跨模型可靠性。' },
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: '自定义框架能在不同的AI模型上工作吗?', a: '是的，如果设计正确。避免特定于模型的语法，围绕通用组件（任务、约束、输出格式）构建。在最终确定前在GPT-5.6和Claude上测试。如果框架需要按型号重新措辞，请简化它。' },
  ...
  ar: {
    ...
    metaDescription: 'تعلّم متى وكيف تبني إطار عمل مخصصاً للأوامر: عملية من ⁨5⁩ خطوات من تحديد الهدف إلى التوثيق. مع مثال ⁨REPAIR⁩ العملي لفرق الدعم.',
    ogDescription: 'ابنِ إطار عمل مخصصاً للأوامر في 5 خطوات: حدد الهدف، وحدد 3-6 مكونات، واختبر على 10 أوامر، وحسّن، وثّق. اختبار متعدد النماذج مع PromptQuorum.',
    twitterDescription: 'أطر العمل القياسية لا تناسبك؟ ابنِ إطارك الخاص في ⁨5⁩ خطوات. مثال ⁨REPAIR⁩ لفرق الدعم. ⁨3-6⁩ مكونات، تحقق باستخدام ⁨10⁩ أوامر.',
    publishDate: '2026-05-02',
    readTime: '12 دقائق للقراءة',
    educationalLevel: 'Advanced',
    primaryTerm: 'إطار عمل مخصص للأوامر',
    leadAnswerBlock: '**إطار عمل الأوامر المخصص هو قالب منظم تصممه لحالة استخدام محددة عندما تتطلب أطر العمل القياسية (CO-STAR وCRAFT وRISEN) تعديلات متكررة.** ابنه عندما تكرر نفس 3 تعديلات أو أكثر في كل أمر ضمن سير عمل معين.',
    quickFacts: [
      'ابنِ إطاراً مخصصاً عندما تضيف نفس 3 تعديلات أو أكثر إلى كل أمر في سير عمل معين',
      '3-6 مكونات: أقل من ذلك يُعدّ أسلوباً، وأكثر من ذلك يخلق احتكاكاً ويُهمَل',
      'اختبر على 10 أوامر حقيقية قبل التوثيق — أطر العمل المبنية نظرياً تفشل في التطبيق',
      'قلّص إطار REPAIR فترة الإعداد من أسبوعين إلى 3 أيام لفريق دعم',
      'تحسّنت درجات الاتساق من 64% إلى 89% في الشهر الأول من استخدام إطار مخصص',
      'اختبر على نموذجين على الأقل عبر PromptQuorum قبل التوحيد القياسي',
    ],
    toc: [
      { label: 'إطار العمل مقابل الأسلوب', anchor: 'framework_vs_technique' },
      { label: 'متى تبني إطار عمل مخصصاً', anchor: 'when_to_build' },
      { label: 'بناء إطار عمل مخصص: عملية من 5 خطوات', anchor: 'five_step_process' },
      { label: 'مثال: إطار REPAIR لفرق الدعم', anchor: 'support_example' },
      { label: 'الأخطاء الشائعة عند بناء أطر عمل مخصصة', anchor: 'common_mistakes' },
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/ar/prompt-engineering/build-your-own-framework',
      inLanguage: 'ar',
      headline: 'بناء إطار عمل خاص بك للأوامر: عملية من 5 خطوات',
      description: 'تعلّم متى وكيف تبني إطار عمل مخصصاً للأوامر: عملية من 5 خطوات من تحديد الهدف إلى التوثيق. مع مثال REPAIR العملي لفرق الدعم.',
      datePublished: '2026-05-02',
      dateModified: '2026-07-13',
      keywords: ['إطار عمل مخصص للأوامر', 'بناء إطار عمل أوامر', 'إطار عمل prompt engineering', 'تصميم الأوامر', 'أوامر الفريق'],
      mentions: [
        { '@type': 'Thing', name: 'CO-STAR' },
        { '@type': 'Thing', name: 'CRAFT' },
        { '@type': 'Thing', name: 'RISEN' },
    ...
    sections: {
      tldr: {
        isTldr: true,
        content: [
          'ابنِ إطار عمل مخصصاً للأوامر عندما تضيف بصورة متكررة نفس 3 مكونات أو أكثر إلى كل أمر في سير عمل معين. استخدم 3-6 مكونات، واختبر على 10 أوامر حقيقية قبل التوثيق، وتحقق من الموثوقية عبر النماذج. يوضح مثال REPAIR كيف قلّص فريق دعم فترة الإعداد من أسبوعين إلى 3 أيام.',
        ],
      },
      key_takeaways: {
        title: 'النقاط الرئيسية',
        items: [
          'ابنِ إطاراً مخصصاً عندما تضيف نفس 3 مكونات أو أكثر إلى كل أمر في سير عمل معين',
          'استخدم 3-6 مكونات: أقل من ذلك يُعدّ أسلوباً، وأكثر من ذلك يخلق احتكاكاً',
          'اختبر على 10 أوامر حقيقية قبل التوثيق',
          'تحقق من الموثوقية عبر النماذج قبل التوحيد القياسي',
          'احفظ مواصفات إطار العمل في نظام إدارة الإصدارات مع قالب و3 أمثلة موضّحة',
          'قِس وقت الإعداد ودرجات الاتساق للتأكد من فاعلية إطار العمل',
        ],
      },
      framework_vs_technique: {
        ...
        snippets: [
          ...
          { type: 'in-plain-terms', text: 'فكر في إطار العمل كسقالة لكل أمر — يحدد الأقسام. والأسلوب هو ما تفعله داخل أحد الأقسام، كطلب من النموذج أن يُفكر خطوة بخطوة.' },
        ],
        content: [
          '**إطار عمل الأوامر هو قالب هيكلي يحدد المكونات التي ينبغي أن يتضمنها كل أمر؛ أما الأسلوب فهو نمط يُطبَّق داخل أحد تلك المكونات.** أسلوب chain-of-thought هو تقنية — تطبّقها داخل مكوّن "المهمة" في إطار العمل. CO-STAR هو إطار عمل — يحدد 6 مكونات تُهيكل الأمر بأكمله.',
          'يهمّ هذا التمييز لأن أطر العمل والأساليب تحل مشكلات مختلفة. إطار العمل يحل مشكلة الاتساق: يتبع جميع أعضاء فريقك بنيةً موحدة في كتابة الأوامر. والأسلوب يحل مشكلة القدرة: يغير طريقة تعامل النموذج مع خطوة محددة في عملية الاستدلال.',
          'استخدم إطار عمل موجوداً (CO-STAR أو CRAFT أو RISEN أو RTF) عندما يتوافق نوع مهمتك مع الغرض الذي صُمّم له الإطار. وابنِ إطاراً مخصصاً عندما تضيف باستمرار نفس المكونات الخاصة بالمجال التي لا تتضمنها الأطر الموجودة.',
        ],
        callouts: [
          { type: 'insight', label: 'تمييز رئيسي', text: 'أطر العمل تحل مشكلة اتساق الفريق. الأساليب تحل مشكلة القدرة داخل خطوة فردية من الأمر. كلاهما ضروري؛ ولا يغني أحدهما عن الآخر.' },
        ],
      },
      when_to_build: {
        ...
        content: [
          ...
          'مؤشرات تدل على أنك بحاجة إلى إطار عمل مخصص:',
        ],
        items: [
          'تضيف نفس الحقول لكل أمر ولا يتضمنها أي إطار عمل قياسي',
          'ينتج فريقك أوامر غير متسقة رغم استخدام CO-STAR أو CRAFT',
          'يحتاج الأعضاء الجدد في الفريق أكثر من أسبوع لكتابة أوامر مقبولة',
          'يتجاوز معدل طول أوامرك 600 كلمة لأنك تشرح نفس السياق في كل مرة',
          'أنشأت "أمراً أساسياً" يقوم الجميع بنسخه وتعديله يدوياً',
        ],
      },
      when_to_build_part2: {
        content: [
          'مؤشرات تدل على أنك يجب أن تلتزم بأطر العمل الموجودة:',
        ],
        items: [
          'تغطي أوامرك حالات استخدام متنوعة وغير مترابطة (بلا نمط متسق)',
          'تكتب أقل من 10 أوامر أسبوعياً في هذا السير الوظيفي',
          'يتناسب إطار عمل موجود مع احتياجاتك مع تعديلات طفيفة',
          'يضم فريقك أقل من 3 أشخاص يكتبون الأوامر',
        ],
      },
      five_step_process: {
        ...
        numberedItems: [
          { title: 'حدد الهدف في جملة واحدة', whyItMatters: 'اكتب بدقة ما يجب أن ينتجه هذا الإطار بصورة موثوقة. مثال: "إنشاء بريد إلكتروني للرد الأول على تذكرة دعم يصنّف الخطورة، ويُشير إلى سياستنا، ويقترح مسار حل." هذه الجملة تحكم كل قرار يتعلق بالمكونات.' },
          { title: 'حدد 3-6 مكونات مطلوبة', whyItMatters: 'اسرد عناصر الإدخال التي يحتاجها كل أمر في هذا السير الوظيفي. ابدأ بكتابة 5 أوامر من الذاكرة، ثم استخرج القواسم المشتركة. إضافات شائعة تتجاوز الأطر القياسية: ارتكاز على السياسة، وقيد على الشخصية، ومفردات المجال، ومخطط الإخراج، وشرط التصعيد.' },
          { title: 'طبّق على 10 أوامر حقيقية', whyItMatters: 'استخدم أوامر حقيقية من سير عملك — لا أمثلة مخترعة. قيّم كل نتيجة: هل يحقق الهدف؟ ما المكونات التي غابت؟ ما التي أُهملت؟ شغّل الأوامر ذاتها على نموذجين على الأقل عبر PromptQuorum للتأكد من الموثوقية عبر النماذج.' },
          { title: 'حسّن قائمة المكونات', whyItMatters: 'أزل المكونات التي ظهرت في أقل من 7 أوامر من أصل 10 — فهي تنتمي إلى أوامر بعينها لا إلى الإطار. أضف المكونات التي ارتجلتها في 5 حالات أو أكثر. أعد اختبار 10 أوامر بالإطار المُحسَّن قبل الانتقال إلى الخطوة الخامسة.' },
          { title: 'وثّق وقيّس قياساً موحداً', whyItMatters: 'اكتب مواصفة من صفحة واحدة: اسم الإطار (اختصار اختياري)، وتعريف كل مكوّن، وقالب بعناصر نائبة، و3 أوامر مثالية موضّحة. احفظ في نظام إدارة الإصدارات (Git أو PromptHub). وزّع المواصفة قبل طلب استخدام الإطار من أي شخص.' },
        ],
        callouts: [
          { type: 'warning', label: 'لا تتخطى الخطوة الثالثة', text: 'أطر العمل المبنية دون اختبار 10 أوامر حقيقية تتضمن في الغالب مكونات تبدو مهمة لكن تُهمَل تحت ضغط الوقت. اختبر أولاً، ثم وثّق.' },
        ],
      },
      support_example: {
        ...
        content: [
          ...
          'لاحظ الفريق أنهم يضيفون يدوياً نفس العناصر إلى كل أمر CO-STAR: مستوى دور المندوب المحدد، والسياسة المعمول بها وفق اتفاقية مستوى الخدمة، ومسار تصعيد مشروط إذا تجاوزت المشكلة نطاق المستوى الأول. بعد 3 أسابيع، جرى تقنين هذه الإضافات كمكونات في الإطار.',
          'قالب REPAIR الناتج:',
        ],
        items: [
          'R (دور): "أنت وكيل دعم من المستوى الأول لـ [Product]. صلاحياتك تشمل [scope]."',
          'E (تصعيد): "إذا تضمّنت المشكلة [condition]، صعِّد إلى المستوى الثاني. لا تحاول الحل."',
          'P (ارتكاز السياسة): "طبِّق السياسة [ID] على [issue type]. اقتبس البند ذا الصلة في ردِّك."',
          'A (مسار الإجراء): "صنِّف المشكلة، أكِّد الفهم، اقترح الحل، اطلب التأكيد."',
          'I (تأكيد النية): "اختم كل رد بـ: \'هل عالجت مشكلتك، أم تريد مني التصعيد?\'"',
        ],
      },
      support_example_part2: {
        content: [
          'انخفض وقت إعداد المندوبين الجدد من أسبوعين إلى 3 أيام بعد توثيق إطار REPAIR وإضافته إلى مكتبة أوامر الفريق. تحسّنت درجات اتساق الأوامر (المقاسة عبر تقييم Braintrust) من 64% إلى 89% في الشهر الأول.',
          'استخدم إطار عمل مخصصاً عندما تستطيع تسمية النمط بوضوح وإثبات انطباقه على سير عملك. تجنّب تسمية إطار عمل لمجرد امتلاكه — فالبنية المتسقة المكونة من 4 مكونات بلا اسم التي تستخدمها يومياً هي إطار عمل حتى بدون اختصار.',
        ],
        callouts: [
          { type: 'tip', label: 'قِس الأثر', text: 'تتبّع وقت الإعداد ودرجات الاتساق قبل تطبيق إطار عمل مخصص وبعده. إذا لم يتحسّن أيٌّ منهما في غضون 4 أسابيع، فالإطار يحتاج إلى تحسين — لا مزيداً من التوثيق.' },
        ],
      },
      common_mistakes: {
        ...
        mistakes: [
          {
            mistake: 'عدد كبير جداً من المكونات (7+)',
            problem: 'يتخطى كتّاب الأوامر أقساماً تحت ضغط الوقت، مما يخلّ بالاتساق.',
            fix: 'اقتصر على 6 مكونات. انقل الحقول الخاصة بالمجال إلى امتدادات الأمر لا إلى الإطار الأساسي.',
          },
          {
            mistake: 'نسخ إطار عمل قياسي وإعادة تسميته',
            problem: 'CO-STAR المعاد تسميته ليس إطار عمل مخصصاً — إنه CO-STAR مع عبء علامة تجارية إضافية.',
            fix: 'قنّن إطار عمل فقط عندما يكون لديك مكوّنان على الأقل غير موجودَين في أي إطار عمل قياسي.',
          },
          {
            mistake: 'عدم وجود مجموعة اختبار قبل التوثيق',
            problem: 'توثّق إطار عمل لا يصمد أمام الأوامر الحقيقية.',
            fix: 'شغّل 10 أوامر حقيقية عبر إطار العمل المسودة قبل كتابة المواصفة. عدّل بناءً على ما يفشل.',
          },
          {
            mistake: 'عدم الاختبار عبر النماذج',
            problem: 'إطار العمل الذي يعمل على نموذج قد ينتج نتائج مختلفة على آخر إذا اعتمد على سلوكيات ضمنية خاصة بنموذج بعينه.',
            fix: 'اختبر على نموذجين على الأقل عبر PromptQuorum. وثّق أي تعديلات خاصة بنموذج في مواصفة الإطار.',
          },
          {
            mistake: 'بلا إدارة إصدارات',
            problem: 'يتشعّب الإطار مع قيام أعضاء الفريق بتعديله غير رسمياً، مما يخلق نسخاً غير متسقة.',
            fix: 'احفظ مواصفة الإطار في Git أو PromptHub مع رقم إصدار. اشترط مراجعة PR لأي تغيير في المكونات.',
          },
        ],
      },
      faq: {
        ...
        faqs: [
          ...
          { q: 'متى يجب أن أبني إطار عمل مخصصاً بدلاً من استخدام CO-STAR أو CRAFT؟', a: 'ابنِ إطاراً مخصصاً عندما تعدّل إطاراً موجوداً بنفس 3 طرق أو أكثر لكل أمر في سير عمل معين. إذا كنت تضيف دائماً قيد سياسة، وارتكاز شخصية، وقائمة مفردات المجال إلى CO-STAR — يجب أن تصبح هذه الإضافات مكونات من المستوى الأول في إطارك الخاص.' },
          { q: 'كم عدد المكونات التي يجب أن يحتوي عليها إطار عمل الأوامر المخصص؟', a: 'استخدم 3-6 مكونات. أقل من 3 يُعدّ أسلوباً لا إطار عمل. أكثر من 6 يخلق احتكاكاً — يتخطى كتّاب الأوامر أقساماً مما يُفشل الغرض. إذا احتجت أكثر من 6، قسّم إلى إطاري عمل متخصصَين لأنواع مختلفة من المهام.' },
          { q: 'كيف أختبر ما إذا كان إطار عملي المخصص يعمل؟', a: 'طبّق الإطار على 10 أوامر تمثيلية وقيّم النتائج وفق 3 معايير: اكتمال المهمة، والالتزام بالتنسيق، واتساق الجودة. يجب أن يحصل الإطار الفعّال على 8/10 أو أعلى في الثلاثة. استخدم PromptQuorum لاختبار الإطار ذاته عبر نماذج متعددة.' },
          { q: 'هل يمكن لإطار عمل مخصص أن يعمل عبر نماذج AI مختلفة؟', a: 'نعم، إذا صُمّم بشكل صحيح. تتجنب أطر العمل المستقلة عن النماذج الصياغة الخاصة بنموذج بعينه وتعتمد على مكونات عالمية (تعريف المهمة، والقيود، وتنسيق الإخراج). اختبر إطارك على نموذجين على الأقل قبل تقنينه.' },
          { q: 'كيف أسمّي إطار عمل الأوامر المخصص؟', a: 'التسمية باختصار (كـREPAIR) تجعله سهل التذكر وتسهّل الإعداد. اختر أحرفاً تقابل 3-6 مكونات بالترتيب. اختبار الاختصار: هل يستطيع عضو فريق جديد تذكّر جميع المكونات من الاسم وحده؟' },
          { q: 'كيف أُصدر نسخاً لإطار عمل مخصص؟', a: 'احفظ كل إصدار في ملف مؤرّخ (مثل repair-v1-2026-05.md) في دليل مكتبة الأوامر. صنّف التغييرات الكبرى (مكوّن مضاف/محذوف) كإصدارات رئيسية. صنّف التحسينات (تحديثات التعريف) كإصدارات ثانوية. وثّق سبب كل تغيير بجانب ملف الإصدار.' },
          { q: 'هل يمكنني دمج أطر عمل متعددة موجودة؟', a: 'يمكنك دمج مكونات من CO-STAR وCRAFT وRISEN — لكن عامل النتيجة كإطار عمل مخصص جديد لا هجين. سمّه ووثّقه واختبره كأنه أصيل. الدمج بلا تقنين يخلق نمطاً عشوائياً غير موثّق فحسب.' },
        ],
      },
      related_reading: {
        ...
        items: [
          ...
          { title: 'إطار عمل CRAFT: السياق والدور والإجراء والتنسيق والهدف', url: '/ar/prompt-engineering/craft-framework' },
          { title: 'إطار عمل RISEN: الدور والتعليمات والخطوات والهدف النهائي والقيد', url: '/ar/prompt-engineering/risen-framework' },
          { title: 'أي إطار عمل للأوامر يجب أن تستخدم؟', url: '/ar/prompt-engineering/which-prompt-framework-should-you-use' },
          { title: 'اختيار إطار عمل الأوامر للفرق', url: '/ar/prompt-engineering/prompt-framework-selection-for-teams' },
          { title: 'إعداد هندسة الأوامر للفرق الصغيرة', url: '/ar/prompt-engineering/prompt-engineering-setup-small-teams' },
        ],
      },
      sources: {
        title: 'المصادر',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'متى يجب أن أبني إطار عمل مخصصاً بدلاً من استخدام CO-STAR أو CRAFT أو RISEN؟', a: 'ابنِه عندما تطبّق بصورة متكررة نفس 3 تعديلات أو أكثر على إطار موجود لكل أمر في سير عمل معين. إذا كنت دائماً تضيف قيد سياسة، ومصطلحات المجال، ومخطط الإخراج إلى CO-STAR، فيجب أن تصبح هذه مكونات في إطارك الخاص.' },
          { q: 'هل يمكن لإطار عمل مخصص أن يعمل عبر نماذج AI مختلفة؟', a: 'نعم، إذا صُمّم بشكل صحيح. تجنّب الصياغة الخاصة بنموذج بعينه وابنِ حول مكونات عالمية (المهمة، والقيود، وتنسيق الإخراج). اختبر قبل التقنين. إذا احتاج الإطار إلى إعادة صياغة حسب النموذج، فبسّطه.' },
          { q: 'كم عدد المكونات التي يجب أن يحتوي عليها إطار عملي المخصص؟', a: 'استخدم 3-6 مكونات. أقل من 3 يُعدّ أسلوباً لا إطار عمل. أكثر من 6 يخلق احتكاكاً ويتخطى الكتّاب الأقسام. إذا احتجت أكثر، قسّم إلى إطاري عمل متخصصَين لأنواع مختلفة من المهام.' },
          { q: 'كيف أختبر ما إذا كان إطار عملي المخصص يعمل فعلاً؟', a: 'طبّقه على 10 أوامر تمثيلية من سير عملك. قيّم النتائج وفق ثلاثة معايير: (1) اكتمال المهمة، (2) الالتزام بالتنسيق، (3) اتساق الجودة. يجب أن يحصل الإطار الفعّال على 8/10 أو أعلى في الثلاثة. اختبر عبر نماذج متعددة باستخدام PromptQuorum.' },
          { q: 'كيف يجب أن أسمّي إطار عمل مخصصاً؟', a: 'استخدم اختصاراً يُعيّن مكوّناتك بالترتيب (مثل REPAIR). اختبار الاختصار: هل يستطيع عضو فريق جديد تذكّر جميع المكونات من الاسم وحده؟ إذا لا، بسّط قائمة مكوّناتك.' },
          { q: 'هل يمكنني دمج مكونات من CO-STAR وCRAFT وRISEN؟', a: 'نعم، لكن عامل النتيجة كإطار عمل جديد لا هجين. سمّه ووثّقه واختبره وأدرجه في إدارة الإصدارات. الدمج بلا تقنين يخلق نمطاً عشوائياً غير موثّق فحسب.' },
          { q: 'كيف أُصدر نسخاً لإطار عمل مخصص؟', a: 'احفظ كل إصدار في ملف مؤرّخ (مثل repair-v1-2026-05.md) في مكتبة الأوامر. صنّف التغييرات الكبرى (مكوّن مضاف/محذوف) كإصدارات رئيسية. صنّف التحسينات (تحديثات التعريف) كإصدارات ثانوية. وثّق سبب كل تغيير.' },
          { q: 'ماذا يجب أن أوثّق لإطار عملي المخصص؟', a: 'اكتب مواصفة من صفحة واحدة: (1) اسم الإطار وهدفه، (2) تعريفات 3-6 مكوّنات مع أمثلة، (3) قالب بعناصر نائبة، (4) 3 أوامر مثالية كاملة وموضّحة باستخدام الإطار. احفظها في إدارة الإصدارات بجانب مكتبة الأوامر.' },
          { q: 'كيف أجعل فريقي يستخدم إطار العمل المخصص الذي أنشأته؟', a: 'ابدأ بجلسة مدتها 30 دقيقة باستخدام أمثلة من مهام حقيقية. اختبر معاً على 2-3 أوامر. أنشئ مواصفة من صفحة واحدة قابلة للمشاركة. تتبّع مقاييس الالتزام والأثر (معدل نجاح المهمة، واتساق النتائج) خلال الشهر الأول. كرّر بناءً على التغذية الراجعة.' },
        ],
      },
    },
  },
  ko: {
    ...
    metaDescription: '커스텀 프롬프트 프레임워크를 만드는 방법: 목표 설정부터 문서화까지 5단계 프로세스. 지원팀을 위한 REPAIR 예시 포함.',
    ogDescription: '커스텀 프롬프트 프레임워크를 5단계로 구축하세요: 목표 정의, 3-6개 구성 요소 식별, 10개 프롬프트 테스트, 개선, 문서화. PromptQuorum으로 모델 간 테스트 가능.',
    twitterDescription: '표준 프레임워크가 맞지 않나요? 5단계로 직접 만드세요. 지원팀을 위한 REPAIR 예시. 3-6개 구성 요소, 10개 프롬프트 검증.',
    publishDate: '2026-05-02',
    readTime: '12분 분량',
    educationalLevel: 'Advanced',
    primaryTerm: '커스텀 프롬프트 프레임워크',
    leadAnswerBlock: '**커스텀 프롬프트 프레임워크는 기존 표준 프레임워크(CO-STAR, CRAFT, RISEN)에 지속적인 수정이 필요할 때 특정 사용 사례를 위해 설계하는 구조화된 템플릿입니다.** 특정 업무 흐름의 각 프롬프트에 동일한 3가지 이상의 조정을 반복할 때 구축하십시오.',
    quickFacts: [
      '업무 흐름의 모든 프롬프트에 동일한 3가지 이상의 수정을 추가할 때 커스텀 프레임워크를 구축하십시오',
      '3-6개 구성 요소: 그보다 적으면 기법이고, 많으면 마찰이 생기고 생략됩니다',
      '문서화 전에 실제 프롬프트 10개로 테스트하십시오 — 이론으로 구축된 프레임워크는 실전에서 실패합니다',
      'REPAIR 프레임워크는 지원팀의 온보딩을 2주에서 3일로 단축시켰습니다',
      '일관성 점수가 첫 달에 64%에서 89%로 향상되었습니다',
      '표준화 전에 GPT-5.6와 Claude Sonnet 5에서 모델 간 테스트를 수행하십시오',
    ],
    toc: [
      { label: '프레임워크 vs. 기법', anchor: 'framework_vs_technique' },
      { label: '커스텀 프레임워크를 구축해야 할 때', anchor: 'when_to_build' },
      { label: '커스텀 프레임워크 구축: 5단계 프로세스', anchor: 'five_step_process' },
      { label: '예시: 지원팀을 위한 REPAIR 프레임워크', anchor: 'support_example' },
      { label: '커스텀 프레임워크 구축 시 흔한 실수', anchor: 'common_mistakes' },
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/ko/prompt-engineering/build-your-own-framework',
      inLanguage: 'ko',
      headline: '나만의 프롬프트 프레임워크 만들기: 5단계 프로세스',
      description: '커스텀 프롬프트 프레임워크를 만드는 방법: 목표 설정부터 문서화까지 5단계 프로세스. 지원팀을 위한 REPAIR 예시 포함.',
      datePublished: '2026-05-02',
      dateModified: '2026-07-13',
      keywords: ['커스텀 프롬프트 프레임워크', '프롬프트 프레임워크 만들기', '프롬프트 엔지니어링 프레임워크', '프롬프트 설계', '팀 프롬프트'],
      mentions: [
        { '@type': 'Thing', name: 'CO-STAR' },
        { '@type': 'Thing', name: 'CRAFT' },
        { '@type': 'Thing', name: 'RISEN' },
    ...
    sections: {
      tldr: {
        isTldr: true,
        content: [
          '업무 흐름의 모든 프롬프트에 동일한 3가지 이상의 구성 요소를 반복적으로 추가할 때 커스텀 프롬프트 프레임워크를 구축하십시오. 3-6개의 구성 요소를 사용하고, 문서화 전에 실제 프롬프트 10개로 테스트하며, 모델 간 신뢰성을 확인하십시오. REPAIR 예시는 지원팀이 온보딩을 2주에서 3일로 단축한 방법을 보여줍니다.',
        ],
      },
      key_takeaways: {
        title: '핵심 요점',
      ...
      framework_vs_technique: {
        ...
        snippets: [
          ...
          { type: 'in-plain-terms', text: '프레임워크를 각 프롬프트의 뼈대로 생각하십시오 — 섹션을 정의합니다. 기법은 섹션 안에서 수행하는 작업입니다. 예를 들어 모델에게 단계별로 추론하도록 요청하는 것입니다.' },
        ],
        content: [
        ...
        callouts: [
          { type: 'insight', label: '핵심 구분', text: '프레임워크는 팀 내 일관성을 해결합니다. 기법은 프롬프트의 개별 단계 내에서 역량을 해결합니다. 둘 다 필요하며, 어느 것도 다른 것을 대체하지 않습니다.' },
        ],
      },
      when_to_build: {
      ...
      five_step_process: {
        ...
        numberedItems: [
          { title: '목표를 한 문장으로 정의하십시오', whyItMatters: '이 프레임워크가 안정적으로 생성해야 하는 결과물을 정확히 작성하십시오. 예시: "심각도를 분류하고, 정책을 참조하며, 해결 경로를 제안하는 지원 티켓 첫 응답 이메일을 생성합니다." 이 문장이 모든 구성 요소 결정을 지배합니다.' },
          { title: '필수 구성 요소 3-6개를 식별하십시오', whyItMatters: '이 업무 흐름의 모든 프롬프트에 필요한 입력 요소를 나열하십시오. 기억으로 프롬프트 5개를 작성한 후 공통점을 추출하십시오. 표준 프레임워크 외의 일반적인 추가 사항: 정책 앵커, 페르소나 제약, 도메인 어휘, 출력 스키마, 에스컬레이션 조건.' },
          { title: '실제 프롬프트 10개에 적용하십시오', whyItMatters: '만든 예시가 아닌 실제 업무 흐름의 프롬프트를 사용하십시오. 각 결과를 점수화하십시오: 목표를 달성합니까? 어떤 구성 요소가 누락되었습니까? 어떤 것이 무시되었습니까? PromptQuorum을 통해 GPT-5.6와 Claude Sonnet 5에서 동일한 프롬프트를 실행하여 모델 간 신뢰성을 확인하십시오.' },
          { title: '구성 요소 목록을 개선하십시오', whyItMatters: '10개 프롬프트 중 7개 미만에서 나타난 구성 요소를 제거하십시오 — 그것들은 특정 프롬프트에 속하며 프레임워크에 속하지 않습니다. 5개 이상의 경우에 즉흥적으로 추가한 구성 요소를 추가하십시오. 5단계로 넘어가기 전에 수정된 프레임워크로 10개 프롬프트 테스트를 다시 실행하십시오.' },
          { title: '문서화하고 표준화하십시오', whyItMatters: '한 페이지 사양을 작성하십시오: 프레임워크 이름(선택적 약어), 각 구성 요소의 정의, 자리 표시자가 있는 템플릿, 주석이 달린 예시 프롬프트 3개. Git 또는 PromptHub에 버전 관리로 저장하십시오. 누군가에게 프레임워크 사용을 요청하기 전에 사양을 배포하십시오.' },
        ],
        callouts: [
          { type: 'warning', label: '3단계를 건너뛰지 마십시오', text: '실제 프롬프트 10개를 테스트하지 않고 구축된 프레임워크는 시간 압박 하에 생략되는 구성 요소를 거의 항상 포함합니다. 먼저 테스트하고, 그 후에 문서화하십시오.' },
        ],
      },
      support_example: {
      ...
      support_example_part2: {
        ...
        callouts: [
          { type: 'tip', label: '영향을 측정하십시오', text: '커스텀 프레임워크를 구현하기 전후에 온보딩 시간과 일관성 점수를 추적하십시오. 4주 이내에 어느 것도 개선되지 않으면 프레임워크는 더 많은 문서화가 아닌 개선이 필요합니다.' },
        ],
      },
      common_mistakes: {
        ...
        mistakes: [
          {
            mistake: '구성 요소가 너무 많음 (7개 이상)',
            problem: '작성자가 시간 압박 하에 섹션을 생략하여 일관성을 해칩니다.',
            fix: '6개 구성 요소로 제한하십시오. 도메인별 필드를 핵심 프레임워크가 아닌 프롬프트 확장으로 이동하십시오.',
          },
          {
            mistake: '표준 프레임워크를 복사하여 이름만 바꾸기',
            problem: '이름이 바뀐 CO-STAR는 커스텀 프레임워크가 아닙니다 — 추가 브랜딩 오버헤드가 있는 CO-STAR입니다.',
            fix: '표준 프레임워크에 존재하지 않는 구성 요소가 최소 2개 있을 때만 프레임워크를 공식화하십시오.',
          },
          {
            mistake: '문서화 전 테스트 세트 없음',
            problem: '실제 프롬프트와의 접촉에서 살아남지 못하는 프레임워크를 문서화합니다.',
            fix: '사양을 작성하기 전에 초안 프레임워크를 통해 실제 프롬프트 10개를 실행하십시오. 실패하는 것을 기반으로 조정하십시오.',
          },
          {
            mistake: '모델 간 테스트를 하지 않음',
            problem: 'GPT-5.6에서 작동하는 프레임워크가 GPT 특유의 암묵적 동작에 의존하는 경우 Claude Sonnet 5에서 다른 결과를 생성할 수 있습니다.',
            fix: 'PromptQuorum을 통해 최소 2개의 모델에서 테스트하십시오. 프레임워크 사양에 모델별 조정 사항을 문서화하십시오.',
          },
          {
            mistake: '버전 관리 없음',
            problem: '팀원들이 비공식적으로 편집하면서 프레임워크가 다양해져 일관성 없는 버전을 만들어냅니다.',
      ...
      faq: {
        ...
        faqs: [
          ...
          { q: 'CO-STAR나 CRAFT 대신 커스텀 프레임워크를 언제 구축해야 합니까?', a: '특정 업무 흐름의 모든 프롬프트에 대해 기존 프레임워크를 동일한 방식으로 3가지 이상 수정할 때 커스텀 프레임워크를 구축하십시오. CO-STAR에 항상 정책 제약, 페르소나 앵커, 도메인 어휘 목록을 추가한다면 — 그러한 추가 사항이 자체 프레임워크의 최상위 구성 요소가 되어야 합니다.' },
          { q: '커스텀 프롬프트 프레임워크에는 몇 개의 구성 요소가 있어야 합니까?', a: '3-6개의 구성 요소를 사용하십시오. 3개 미만은 기법이지 프레임워크가 아닙니다. 6개 초과는 마찰을 만듭니다 — 프롬프트 작성자가 섹션을 생략하여 목적을 달성하지 못합니다. 6개 이상이 필요한 경우 다른 작업 유형을 위한 두 개의 전문 프레임워크로 나누십시오.' },
          { q: '커스텀 프레임워크가 작동하는지 어떻게 테스트합니까?', a: '프레임워크를 대표적인 프롬프트 10개에 적용하고 3가지 기준으로 결과를 점수화하십시오: 작업 완료도, 형식 준수, 품질 일관성. 작동하는 프레임워크는 세 가지 모두에서 8/10 이상을 달성해야 합니다. PromptQuorum을 사용하여 GPT-5.6, Claude Sonnet 5, Gemini 2.5 Pro에서 동일한 프레임워크를 테스트하십시오.' },
          { q: '커스텀 프레임워크가 다른 AI 모델에서 작동할 수 있습니까?', a: '올바르게 설계된 경우 가능합니다. 모델에 구애받지 않는 프레임워크는 모델별 구문을 피하고 보편적인 구성 요소(작업 정의, 제약, 출력 형식)를 기반으로 합니다. 최종화하기 전에 GPT-5.6와 Claude Sonnet 5 모두에서 테스트하십시오.' },
          { q: '커스텀 프롬프트 프레임워크를 어떻게 명명합니까?', a: '약어(REPAIR처럼)로 명명하면 기억하기 쉽고 온보딩에 도움이 됩니다. 순서대로 3-6개의 구성 요소에 해당하는 글자를 선택하십시오. 약어 테스트: 신규 팀원이 이름만으로 모든 구성 요소를 기억할 수 있습니까?' },
          { q: '커스텀 프레임워크를 어떻게 버전 관리합니까?', a: '프롬프트 라이브러리 디렉토리에 날짜가 있는 파일(예: repair-v1-2026-05.md)에 각 프레임워크 버전을 저장하십시오. 주요 변경 사항(구성 요소 추가/삭제)은 주요 버전으로 태그를 붙이십시오. 개선 사항(정의 업데이트)은 부 버전으로 태그를 붙이십시오. 버전 파일 옆에 각 변경 이유를 문서화하십시오.' },
          { q: '여러 기존 프레임워크를 결합할 수 있습니까?', a: 'CO-STAR, CRAFT, RISEN의 구성 요소를 결합할 수 있습니다 — 하지만 결과물을 혼합물이 아닌 새로운 커스텀 프레임워크로 취급하십시오. 원본인 것처럼 이름을 짓고, 문서화하고, 테스트하십시오. 공식화 없이 결합하는 것은 문서화되지 않은 임시 패턴만 만들 뿐입니다.' },
        ],
      },
      related_reading: {
        title: '관련 읽기',
        items: [
          ...
          '[CRAFT 프레임워크: 컨텍스트, 역할, 행동, 형식, 목표](/ko/prompt-engineering/craft-framework)',
          '[RISEN 프레임워크: 역할, 지침, 단계, 최종 목표, 제약](/ko/prompt-engineering/risen-framework)',
          '[어떤 프롬프트 프레임워크를 사용해야 합니까?](/ko/prompt-engineering/which-prompt-framework-should-you-use)',
          '[팀을 위한 프롬프트 프레임워크 선택](/ko/prompt-engineering/prompt-framework-selection-for-teams)',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'CO-STAR, CRAFT 또는 RISEN 대신 커스텀 프레임워크를 언제 구축해야 합니까?', a: '특정 업무 흐름의 모든 프롬프트에 대해 기존 프레임워크에 동일한 3가지 이상의 수정을 반복적으로 적용할 때 구축하십시오. CO-STAR에 항상 정책 제약, 도메인 용어, 출력 스키마를 추가한다면 — 그것들이 자체 프레임워크의 구성 요소가 되어야 합니다.' },
          { q: '커스텀 프레임워크가 다른 AI 모델에서 작동할 수 있습니까?', a: '올바르게 설계된 경우 가능합니다. 모델별 구문을 피하고 보편적인 구성 요소(작업, 제약, 출력 형식)를 중심으로 구축하십시오. 최종화하기 전에 테스트하십시오. 모델별로 재구성이 필요한 경우 단순화하십시오.' },
          { q: '커스텀 프레임워크에는 몇 개의 구성 요소가 있어야 합니까?', a: '3-6개의 구성 요소를 사용하십시오. 3개 미만은 기법이지 프레임워크가 아닙니다. 6개 초과는 마찰을 만들고 작성자가 섹션을 생략합니다. 더 많이 필요하면 다른 작업 유형을 위한 두 개의 전문 프레임워크로 나누십시오.' },
          { q: '커스텀 프레임워크가 실제로 작동하는지 어떻게 테스트합니까?', a: '업무 흐름의 대표적인 프롬프트 10개에 적용하십시오. 세 가지 기준으로 결과를 점수화하십시오: (1) 작업 완료도, (2) 형식 준수, (3) 품질 일관성. 작동하는 프레임워크는 세 가지 모두에서 8/10 이상을 달성합니다. PromptQuorum을 사용하여 여러 모델에서 테스트하십시오.' },
          { q: '커스텀 프레임워크를 어떻게 명명해야 합니까?', a: '순서대로 구성 요소를 매핑하는 약어를 사용하십시오(REPAIR처럼). 약어 테스트: 신규 팀원이 이름만으로 모든 구성 요소를 기억할 수 있습니까? 그렇지 않으면 구성 요소 목록을 단순화하십시오.' },
          { q: 'CO-STAR, CRAFT, RISEN의 구성 요소를 결합할 수 있습니까?', a: '가능하지만 혼합물이 아닌 새로운 프레임워크로 취급하십시오. 이름을 짓고, 문서화하고, 테스트하고, 버전 관리에 저장하십시오. 공식화 없이 결합하는 것은 문서화되지 않은 임시 패턴만 만들 뿐입니다.' },
          { q: '커스텀 프레임워크를 어떻게 버전 관리합니까?', a: '프롬프트 라이브러리에 날짜가 있는 파일(예: repair-v1-2026-05.md)에 각 버전을 저장하십시오. 주요 변경 사항(구성 요소 추가/삭제)은 주요 버전으로 태그를 붙이십시오. 개선 사항(정의 업데이트)은 부 버전으로 태그를 붙이십시오. 각 변경 이유를 문서화하십시오.' },
          { q: '커스텀 프레임워크에 무엇을 문서화해야 합니까?', a: '한 페이지 사양을 작성하십시오: (1) 프레임워크 이름과 목표, (2) 예시가 있는 3-6개 구성 요소 정의, (3) 채울 수 있는 템플릿, (4) 프레임워크를 사용하는 완전하고 주석이 달린 예시 프롬프트 3개. 프롬프트 라이브러리 옆에 버전 관리에 저장하십시오.' },
          { q: '만든 커스텀 프레임워크를 팀이 사용하도록 하려면 어떻게 해야 합니까?', a: '실제 작업 예시를 사용하여 30분 세션으로 시작하십시오. 2-3개의 프롬프트로 함께 테스트하십시오. 공유 가능한 한 페이지 사양을 만드십시오. 첫 달 동안 준수 및 영향 지표(작업 성공률, 결과 일관성)를 추적하십시오. 피드백을 기반으로 반복하십시오.' },
        ],
      },
    },
  },
