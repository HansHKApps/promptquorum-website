...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    sections: {
      ...
      five_step_process: {
        ...
        numberedItems: [
          ...
          { title: 'Apply to 10 real prompts', whyItMatters: 'Use actual prompts from your workflow — not invented examples. Score each output: does it meet the goal? Which components were missing? Which were ignored? Run the same prompts on GPT-5.5 and Claude 4.6 Sonnet via PromptQuorum to confirm cross-model reliability.' },
      ...
      common_mistakes: {
        ...
        mistakes: [
          ...
          },
          {
            ...
            problem: 'A framework that works on GPT-5.5 may produce different output on Claude 4.6 Sonnet if it relies on implicit GPT-specific behaviors.',
      ...
      faq: {
        ...
        faqs: [
          ...
          { q: 'How do I test if my custom framework is working?', a: 'Apply the framework to 10 representative prompts and score outputs against 3 criteria: task completion, format compliance, and quality consistency. A working framework should score 8/10 or better on all three. Use PromptQuorum to test the same framework prompt across GPT-5.5, Claude 4.6 Sonnet, and Gemini 2.5 Pro to confirm it works across models.' },
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'Can a custom framework work across different AI models?', a: 'Yes, if designed correctly. Avoid model-specific syntax and build around universal components (task, constraints, output format). Test on GPT-5.5 and Claude before finalizing. If the framework needs rewording per model, simplify it.' },
  ...
  de: {
    ...
    quickFacts: [
      ...
      'Modellübergreifend auf GPT-5.5 und Claude 4.6 Sonnet testen vor der Standardisierung',
    ],
    toc: [
    ...
    sections: {
      ...
      key_takeaways: {
        ...
        items: [
          ...
          'Überprüfen Sie die modellübergreifende Zuverlässigkeit auf GPT-5.5 und Claude 4.6 Sonnet',
      ...
      five_step_process: {
        ...
        numberedItems: [
          ...
          { title: 'An 10 realen Prompts anwenden', whyItMatters: 'Verwenden Sie tatsächliche Prompts aus Ihrem Workflow — keine erfundenen Beispiele. Bewerten Sie jede Ausgabe: Erfüllt sie das Ziel? Welche Komponenten fehlten? Testen Sie mit PromptQuorum auf GPT-5.5 und Claude 4.6 Sonnet.' },
  ...
  es: {
    ...
    quickFacts: [
      ...
      'Prueba entre modelos en GPT-5.5 y Claude 4.6 Sonnet antes de estandarizar',
    ],
    toc: [
    ...
    sections: {
      ...
      key_takeaways: {
        ...
        items: [
          ...
          'Verifica la fiabilidad entre modelos en GPT-5.5 y Claude 4.6 Sonnet antes de estandarizar',
      ...
      common_mistakes: {
        ...
        mistakes: [
          ...
          },
          {
            ...
            problem: 'Un framework que funciona en GPT-5.5 puede producir resultados diferentes en Claude 4.6 Sonnet si depende de comportamientos implícitos específicos de GPT.',
  ...
  fr: {
    ...
    quickFacts: [
      ...
      'Tester sur GPT-5.5 et Claude 4.6 Sonnet avant de standardiser',
    ],
    toc: [
      { label: 'Framework vs. technique', anchor: 'framework_vs_technique' },
    ...
    sections: {
      ...
      key_takeaways: {
        ...
        items: [
          ...
          'Vérifiez la fiabilité multi-modèles sur GPT-5.5 et Claude 4.6 Sonnet',
      ...
      five_step_process: {
        ...
        numberedItems: [
          ...
          { title: 'Appliquer à 10 prompts réels', whyItMatters: 'Utilisez des prompts réels de votre workflow — pas des exemples inventés. Évaluez chaque sortie. Testez sur GPT-5.5 et Claude 4.6 Sonnet via PromptQuorum.' },
  ...
  ja: {
    ...
    quickFacts: [
      ...
      '標準化前にGPT-5.5とClaude 4.6 Sonnetでモデル横断テスト',
    ],
    toc: [
    ...
    sections: {
      ...
      five_step_process: {
        ...
        numberedItems: [
          ...
          { title: '10の実際のプロンプトに適用する', whyItMatters: 'ワークフローからの実際のプロンプトを使用します（作り話は不可）。各出力を評価します。PromptQuorum経由でGPT-5.5とClaude 4.6 Sonnetでテストし、モデル横断的な信頼性を確認します。' },
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'カスタムフレームワークは異なるAIモデル間で機能できるか?', a: 'はい、正しく設計されていれば可能です。モデル固有の構文を避けて、普遍的なコンポーネント（タスク、制約、出力形式）の周りに構築します。最終化する前にGPT-5.5とClaudeでテストします。フレームワークがモデルごとに大幅な言い換えを必要とする場合は、簡単にしてください。' },
  ...
  zh: {
    ...
    quickFacts: [
      ...
      '标准化前在GPT-5.5和Claude 4.6 Sonnet上进行跨模型测试',
    ],
    toc: [
    ...
    sections: {
      ...
      key_takeaways: {
        ...
        items: [
          ...
          '在GPT-5.5和Claude 4.6 Sonnet上验证跨模型可靠性',
      ...
      five_step_process: {
        ...
        numberedItems: [
          ...
          { title: '在10条真实Prompt上进行测试', whyItMatters: '使用工作流中的实际Prompt——不要用虚构的例子。通过PromptQuorum在GPT-5.5和Claude 4.6 Sonnet上测试，确认跨模型可靠性。' },
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: '自定义框架能在不同的AI模型上工作吗?', a: '是的，如果设计正确。避免特定于模型的语法，围绕通用组件（任务、约束、输出格式）构建。在最终确定前在GPT-5.5和Claude上测试。如果框架需要按型号重新措辞，请简化它。' },
  ...
  ko: {
    ...
    quickFacts: [
      ...
      '표준화 전에 GPT-5.5와 Claude 4.6 Sonnet에서 모델 간 테스트를 수행하십시오',
    ],
    toc: [
    ...
    sections: {
      ...
      key_takeaways: {
        ...
        items: [
          ...
          '표준화 전에 GPT-5.5와 Claude 4.6 Sonnet에서 모델 간 신뢰성을 확인하십시오',
      ...
      five_step_process: {
        ...
        numberedItems: [
          ...
          { title: '실제 프롬프트 10개에 적용하십시오', whyItMatters: '만든 예시가 아닌 실제 업무 흐름의 프롬프트를 사용하십시오. 각 결과를 점수화하십시오: 목표를 달성합니까? 어떤 구성 요소가 누락되었습니까? 어떤 것이 무시되었습니까? PromptQuorum을 통해 GPT-5.5와 Claude 4.6 Sonnet에서 동일한 프롬프트를 실행하여 모델 간 신뢰성을 확인하십시오.' },
      ...
      common_mistakes: {
        ...
        mistakes: [
          ...
          },
          {
            ...
            problem: 'GPT-5.5에서 작동하는 프레임워크가 GPT 특유의 암묵적 동작에 의존하는 경우 Claude 4.6 Sonnet에서 다른 결과를 생성할 수 있습니다.',
      ...
      faq: {
        ...
        faqs: [
          ...
          { q: '커스텀 프레임워크가 작동하는지 어떻게 테스트합니까?', a: '프레임워크를 대표적인 프롬프트 10개에 적용하고 3가지 기준으로 결과를 점수화하십시오: 작업 완료도, 형식 준수, 품질 일관성. 작동하는 프레임워크는 세 가지 모두에서 8/10 이상을 달성해야 합니다. PromptQuorum을 사용하여 GPT-5.5, Claude 4.6 Sonnet, Gemini 2.5 Pro에서 동일한 프레임워크를 테스트하십시오.' },
          { q: '커스텀 프레임워크가 다른 AI 모델에서 작동할 수 있습니까?', a: '올바르게 설계된 경우 가능합니다. 모델에 구애받지 않는 프레임워크는 모델별 구문을 피하고 보편적인 구성 요소(작업 정의, 제약, 출력 형식)를 기반으로 합니다. 최종화하기 전에 GPT-5.5와 Claude 4.6 Sonnet 모두에서 테스트하십시오.' },
