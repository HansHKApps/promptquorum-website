...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      metaDescription: 'البرومبتات الغامضة تُولّد 850 رمزًا؛ البرومبتات المحسّنة 120 رمزًا فقط. 5 تغييرات تصميمية للحصول على إجابات دقيقة وسريعة مع GPT-5.5 وClaude.',
