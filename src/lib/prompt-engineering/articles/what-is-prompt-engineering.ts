...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    es: {
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        url: 'https://www.promptquorum.com/es/es/prompt-engineering/what-is-prompt-engineering',
        inLanguage: 'es',
    ...
    ar: {
      ...
      seoTitle: 'ما هي هندسة الطلبات في 2026؟ دليل المبتدئين',
      ...
      metaDescription: 'هندسة الطلبات في 2026: صمّم المدخلات النصية للحصول على نتائج موثوقة. تعلّم role prompting وchain-of-thought وfew-shot لـ ChatGPT وClaude وOllama.',
      publishDate: '2026-03-01',
    ...
    pt: {
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        url: 'https://www.promptquorum.com/pt/pt/prompt-engineering/what-is-prompt-engineering',
        inLanguage: 'pt-BR',
