...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      theme: 'Fundamentals',
      heroImage: '/images/prompt-with-images-overview-hero-en.webp',
      title: 'Beyond Text: How to Prompt With Images',
      intro: 'Multimodal prompting—combining images with text—unlocks capabilities in vision-language models like GPT-5.6 and Claude Opus 5. Learn precise patterns for describing, analyzing, generating, and editing images.',
      publishDate: '2026-03-25',
      dateModified: '2026-09-01',
      seoTitle: 'Image Prompting 2026: Analyze, Generate, and Edit With AI',
      metaDescription: 'Analyze, generate, and edit images with GPT-5.6, Claude, and Gemini. Proven multimodal prompt patterns for all 3 modes — templates and pitfalls included.',
      readTime: '12 min read',
      educationalLevel: 'Beginner',
      leadAnswerBlock: 'Multimodal prompting is combining images with text in a single prompt so a vision-language model can see and reason about visual content, not just read your description. It covers three modes: analyzing images, generating them, and editing them.',
      schema: {
        ...
        keywords: ['multimodal prompting', 'vision-language models', 'image prompting', 'GPT-5.6', 'Claude Opus 5', 'Gemini 3.1 Pro', 'prompt engineering', 'image analysis', 'text-to-image generation', 'image editing'],
      ...
      sections: {
        definition: { title: 'What Is Multimodal Prompting?', snippets: [
          { type: 'in-one-sentence', text: 'Multimodal prompting means attaching an image to your text prompt so a vision-language model can see and reason about visual content alongside your written instructions.' },
          { type: 'in-plain-terms', text: 'Instead of describing a picture in words and hoping the model imagines it correctly, you show it the picture. You still type your question — the image rides along with it, so the model works from what it can see rather than from your description.' },
        ], content: ['**Multimodal prompting is combining text and images in a single prompt to guide AI output.** Vision-language models (VLMs)—neural networks trained on both image and text data—process these multimodal inputs to answer questions, describe scenes, generate new images, or edit existing ones.\n\nUnlike text-only prompting, multimodal prompting lets you show rather than tell. A model can see exactly what you mean by examining visual details, spatial relationships, and colors rather than relying solely on written description.'] },
        tldr: { title: 'Key Takeaways', isTldr: true, items: ['Multimodal prompting combines text and images; models like GPT-5.6 and Claude Opus 5 excel at image analysis and description', 'Three modes exist: Image→Text (describe/analyze), Text→Image (generate), and Image↔Image (edit/transform)', 'Vision-language models struggle with precise counting, fine-grained object boundaries, and reading small text within images', 'Follow structured patterns: be specific about analysis goals, provide context, and use examples for consistency', 'PromptQuorum lets you test multimodal prompts across multiple models to compare outputs and find the best fit'] },
        ...
        howVisionWorks: { title: 'How Vision-Language Models See Images', content: ['**Vision-language models like GPT-5.6, Claude Opus 5, and Gemini 3.1 Pro convert images into high-dimensional vectors (embeddings) using a visual encoder, then process those embeddings alongside text tokens in a shared semantic space.** This approach gives VLMs clear strengths across several tasks: they identify objects, read text, understand spatial relationships, and reason about content across multiple images. GPT-5.6 and Claude Opus 5 both offer roughly 1-million-token context windows, and Gemini 3.1 Pro goes further with up to 2 million tokens, enabling analysis of long multimodal sequences without truncation. Understanding [context window limits](/prompt-engineering/context-windows-explained-why-ai-forgets) helps you structure prompts that avoid truncation when working with long image descriptions or multi-image sequences.', 'VLMs excel at scene understanding, document analysis, and comparing visual elements. However, they have predictable weaknesses:'], items: ['Precise counting (especially of small objects or items in dense scenes)', 'Fine-grained object boundaries and exact spatial measurements', 'Reading tiny text within images or complex diagrams', 'Understanding three-dimensional spatial relationships from single angles', 'Avoiding hallucinated details not present in the image'] },
        ...
        howToStart: {
          ...
          numberedItems: [
            ...
            '**Test across multiple models with PromptQuorum.** GPT-5.6 excels at scene understanding, Claude Opus 5 at text extraction, Gemini 3.1 Pro at long contexts. One model is rarely best for all tasks—compare outputs to find your best fit.',
        ...
        faq: { title: 'Frequently Asked Questions', faqs: [{ q: 'Which vision-language model is best for analyzing images?', a: 'No single model is best. GPT-5.6 excels at general scene understanding and complex reasoning. Claude Opus 5 is precise at document analysis and text extraction. GPT-5.6 and Claude Opus 5 both offer roughly 1-million-token context windows, and Gemini 3.1 Pro goes further with up to 2 million tokens. Use PromptQuorum to test all three against your specific task.' }, { q: 'Can vision-language models count objects accurately?', a: 'No. VLMs struggle with precise counting, especially of small or densely packed objects. For accurate counts, use specialized object-detection APIs, or ask the model to enumerate objects with explicit constraints: "Count only red items; be conservative—if uncertain, don\'t count it."' }, { q: 'How many images can I include in one prompt?', a: 'Hard API limits are higher than most people expect: Claude allows up to 100 images per request on 200K-context models, and Gemini 3.1 Pro accepts up to 3,600 image files per request (within a 20 MB inline-request cap; use the File API for more). Output reliability degrades well before those caps, though — batch requests into groups of 5–10 images and label each one for consistent analysis.' }, { q: 'What image formats do vision-language models support?', a: 'GPT-5.6, Claude Opus 5, and Gemini 3.1 Pro accept JPEG, PNG, GIF, and WebP. Per-image size caps differ: Claude\'s API limit is 10 MB per image (5 MB via Amazon Bedrock or Google Cloud), and Gemini\'s inline request cap is 20 MB total, with larger files routed through the File API. Check OpenAI, Anthropic, and Google documentation for current per-model limits.' }, { q: 'Can I use local models like Ollama for multimodal prompting?', a: 'Yes. Models like LLaVA and Ollama support local image analysis. Local models offer privacy but lower accuracy than GPT-5.6 or Claude Opus 5. Use them for non-critical tasks or when privacy is essential.' }, { q: 'How do I improve consistency in text-to-image generation?', a: 'Use structured templates (Subject/Action/Style/Context/Technical), provide reference images, and specify constraints (resolution, composition, element count). Iterate with the same model—switching models between iterations produces inconsistent results.' }, { q: 'What\'s the difference between prompting for image analysis versus generation?', a: 'Analysis prompts specify the information scope ("Extract only the date and invoice number"). Generation prompts must describe all visual elements clearly (subject, action, style, context, technical details). Generation demands more precision because the model imagines rather than perceives.' }] },
    ...
    de: {
      heroImage: '/images/prompt-with-images-overview-hero-de.webp',
      theme: 'Fundamentals', title: 'Jenseits von Text: Wie man mit Bildern promptet', seoTitle: 'Multimodales Prompting 2026: Bilder mit KI analysieren', metaDescription: 'GPT-5.6, Claude und Gemini für multimodales Bild-Prompting nutzen: Drei Modi mit strukturierten Prompt-Mustern, Vorlagen und häufigen Fehlern erklärt.', intro: 'Multimodales Prompting – die Kombination von Bildern mit Text – schaltet Funktionen in Vision-Language-Modellen wie GPT-5.6 und Claude Opus 5 frei. Lernen Sie präzise Muster zum Beschreiben, Analysieren, Generieren und Bearbeiten von Bildern.', publishDate: '2026-03-25', dateModified: '2026-09-01', readTime: '12 Min. Lesezeit', leadAnswerBlock: 'Multimodales Prompting bedeutet, Bilder und Text in einem einzigen Prompt zu kombinieren, damit ein Vision-Language-Modell visuelle Inhalte sehen und darüber schlussfolgern kann, statt nur Ihre Beschreibung zu lesen. Es umfasst drei Modi: Bilder analysieren, erzeugen und bearbeiten.', schema: { '@context': 'https://schema.org', '@type': 'TechArticle', headline: 'Jenseits von Text: Wie man mit Bildern promptet', description: 'GPT-5.6, Claude und Gemini für multimodales Bild-Prompting nutzen: Drei Modi mit strukturierten Prompt-Mustern, Vorlagen und häufigen Fehlern erklärt.', datePublished: '2026-03-25', dateModified: '2026-09-01', url: 'https://www.promptquorum.com/de/prompt-engineering/beyond-text-how-to-prompt-with-images', inLanguage: 'de', author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' }, publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } } }, sections: imagesWithTextDe },
    es: {
      heroImage: '/images/prompt-with-images-overview-hero-es.webp',
      theme: 'Fundamentals', title: 'Más allá del texto: Cómo hacer prompts con imágenes', seoTitle: 'Prompting multimodal 2026: analiza, genera y edita con IA', metaDescription: 'Analiza, genera y edita imágenes con GPT-5.6, Claude y Gemini. Tres modos de prompting multimodal con patrones, plantillas y errores comunes explicados.', intro: 'El prompting multimodal — combinar imágenes con texto — desbloquea capacidades en los modelos de visión-lenguaje como GPT-5.6 y Claude Opus 5. Aprende patrones precisos para describir, analizar, generar y editar imágenes.', publishDate: '2026-03-25', dateModified: '2026-09-01', readTime: '12 min de lectura', leadAnswerBlock: 'El prompting multimodal consiste en combinar imágenes y texto en un mismo prompt para que un modelo de visión-lenguaje pueda ver el contenido visual y razonar sobre él, no solo leer tu descripción. Abarca tres modos: analizar imágenes, generarlas y editarlas.', schema: { '@context': 'https://schema.org', '@type': 'TechArticle', headline: 'Más allá del texto: Cómo hacer prompts con imágenes', description: 'Analiza, genera y edita imágenes con GPT-5.6, Claude y Gemini. Tres modos de prompting multimodal con patrones estructurados, plantillas y errores comunes explicados.', datePublished: '2026-03-25', dateModified: '2026-09-01', url: 'https://www.promptquorum.com/es/prompt-engineering/beyond-text-how-to-prompt-with-images', inLanguage: 'es', author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' }, publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } } }, sections: imagesWithTextEs },
    ar: {
      heroImage: '/images/prompt-with-images-overview-hero-ar.webp',
      theme: 'Fundamentals', title: 'ما وراء النص: كيفية الاستفسار بالصور', seoTitle: 'الاستفسار بالصور 2026: GPT-5.6 وClaude وGemini', metaDescription: '3 أوضاع للاستفسار متعدد الوسائط مع GPT-5.6 وClaude وGemini: تحليل الصور، التوليد، والتحرير — أنماط منظمة وقوالب وأخطاء شائعة مشروحة.', intro: 'الاستفسار متعدد الوسائط — دمج الصور مع النصوص — يُطلق قدرات نماذج الرؤية واللغة مثل GPT-5.6 وClaude Opus 5. تعلّم أنماطاً دقيقة لوصف الصور وتحليلها وتوليدها وتحريرها.', publishDate: '2026-03-25', dateModified: '2026-09-01', readTime: '١٢ دقيقة للقراءة', leadAnswerBlock: 'الاستفسار متعدد الوسائط هو دمج الصور مع النص في استفسار واحد، بحيث يستطيع نموذج الرؤية واللغة رؤية المحتوى المرئي والاستدلال عليه بدلاً من قراءة وصفك فقط. ويشمل ثلاثة أوضاع: تحليل الصور وتوليدها وتحريرها.', schema: { '@context': 'https://schema.org', '@type': 'TechArticle', headline: 'ما وراء النص: كيفية الاستفسار بالصور', description: 'حلِّل الصور وولِّدها وعدِّلها باستخدام GPT-5.6 وClaude وGemini. ثلاثة أوضاع للاستفسار متعدد الوسائط مع أنماط منظمة وقوالب وأخطاء شائعة.', datePublished: '2026-03-25', dateModified: '2026-09-01', url: 'https://www.promptquorum.com/ar/prompt-engineering/beyond-text-how-to-prompt-with-images', inLanguage: 'ar', author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' }, publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } } }, sections: imagesWithTextAr },
    pt: {
      heroImage: '/images/prompt-with-images-overview-hero-pt.webp',
      theme: 'Fundamentals', title: 'Além do texto: Como criar prompts com imagens', seoTitle: 'Prompting multimodal 2026: analise, gere e edite com IA', metaDescription: 'Analise, gere e edite imagens com GPT-5.6, Claude e Gemini. Três modos de prompting multimodal com padrões estruturados, modelos e erros comuns explicados.', intro: 'O prompting multimodal — combinar imagens com texto — desbloqueia recursos em modelos de visão-linguagem como GPT-5.6 e Claude Opus 5. Aprenda padrões precisos para descrever, analisar, gerar e editar imagens.', publishDate: '2026-03-25', dateModified: '2026-09-01', readTime: '12 min de leitura', leadAnswerBlock: 'O prompting multimodal consiste em combinar imagens e texto em um único prompt para que um modelo de visão-linguagem consiga ver o conteúdo visual e raciocinar sobre ele, em vez de apenas ler a sua descrição. Ele abrange três modos: analisar, gerar e editar imagens.', schema: { '@context': 'https://schema.org', '@type': 'TechArticle', headline: 'Além do texto: Como criar prompts com imagens', description: 'Analise, gere e edite imagens com GPT-5.6, Claude e Gemini. Três modos de prompting multimodal com padrões estruturados, modelos e erros comuns explicados.', datePublished: '2026-03-25', dateModified: '2026-09-01', url: 'https://www.promptquorum.com/pt/prompt-engineering/beyond-text-how-to-prompt-with-images', inLanguage: 'pt-BR', author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' }, publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } } }, sections: imagesWithTextPt },
    fr: {
      heroImage: '/images/prompt-with-images-overview-hero-fr.webp',
      theme: 'Fundamentals', title: 'Au-delà du texte: Comment utiliser des images dans vos prompts', seoTitle: 'Prompting multimodal 2026 : images avec GPT-5.6 et Claude', metaDescription: 'Analysez, générez et modifiez des images avec GPT-5.6, Claude et Gemini. Trois modes de prompting multimodal — patrons et erreurs courants expliqués.', intro: 'Le prompting multimodal – combinaison d\'images et de texte – déverrouille les capacités des modèles de vision-langage comme GPT-5.6 et Claude Opus 5. Apprenez les modèles précis pour décrire, analyser, générer et modifier des images.', publishDate: '2026-03-25', dateModified: '2026-09-01', readTime: '12 min de lecture', leadAnswerBlock: 'Le prompting multimodal consiste à combiner images et texte dans un même prompt afin qu\'un modèle vision-langage puisse voir le contenu visuel et raisonner dessus, au lieu de simplement lire votre description. Il couvre trois modes : analyser, générer et modifier des images.', schema: { '@context': 'https://schema.org', '@type': 'TechArticle', headline: 'Au-delà du texte: Comment utiliser des images dans vos prompts', description: 'Analysez, générez et modifiez des images avec GPT-5.6, Claude et Gemini. Trois modes de prompting multimodal — patrons et erreurs courants expliqués.', datePublished: '2026-03-25', dateModified: '2026-09-01', url: 'https://www.promptquorum.com/fr/prompt-engineering/beyond-text-how-to-prompt-with-images', inLanguage: 'fr', author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' }, publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } } }, sections: imagesWithTextFr },
    ja: {
      heroImage: '/images/prompt-with-images-overview-hero-ja.webp',
      theme: 'Fundamentals', title: 'テキストを超えて：画像でプロンプトを作成する方法', seoTitle: 'マルチモーダルプロンプティング2026：GPT-5.6とClaudeで画像活用', metaDescription: 'GPT-5.6とClaudeで画像を分析・生成・編集するためのプロンプトパターン。3つのモードとコピー可能なテンプレートを収録。', intro: 'マルチモーダルプロンプティング—画像とテキストの組み合わせ—GPT-5.6やClaude Opus 5などのビジョン言語モデルの機能をアンロックします。画像の説明、分析、生成、編集のための正確なパターンを学びます。', publishDate: '2026-03-25', dateModified: '2026-09-01', readTime: '12分で読める', leadAnswerBlock: 'マルチモーダルプロンプティングとは、画像とテキストを1つのプロンプトにまとめ、ビジョン言語モデルが説明文を読むだけでなく、視覚的な内容を実際に見て推論できるようにする手法です。画像の分析・生成・編集という3つのモードがあります。', schema: { '@context': 'https://schema.org', '@type': 'TechArticle', headline: 'テキストを超えて：画像でプロンプトを作成する方法', description: 'GPT-5.6とClaudeで画像を分析・生成・編集するためのプロンプトパターン。3つのモードとコピー可能なテンプレートを収録。', datePublished: '2026-03-25', dateModified: '2026-09-01', url: 'https://www.promptquorum.com/ja/prompt-engineering/beyond-text-how-to-prompt-with-images', inLanguage: 'ja', author: { '@type': 'Organization', name: 'PromptQuorum' }, publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } } }, sections: imagesWithTextJa },
    zh: {
      heroImage: '/images/prompt-with-images-overview-hero-zh.webp',
      theme: 'Fundamentals', title: '超越文本：如何使用图像进行提示', seoTitle: '多模态提示词2026：如何用GPT-5.6和Claude分析与生成图像', metaDescription: '用GPT-5.6、Claude和Gemini分析、生成和编辑图像。三种模式的结构化提示模板，以及常见错误与本地模型使用建议。', intro: '多模态提示——结合图像和文本——解锁了GPT-5.6和Claude Opus 5等视觉语言模型的功能。学习用于描述、分析、生成和编辑图像的精确模式。', publishDate: '2026-03-25', dateModified: '2026-09-01', readTime: '12分钟阅读', leadAnswerBlock: '多模态提示是指在同一个提示中结合图像与文本，让视觉语言模型能够真正看到并推理视觉内容，而不只是阅读你的文字描述。它涵盖三种模式：分析图像、生成图像和编辑图像。', schema: { '@context': 'https://schema.org', '@type': 'TechArticle', headline: '超越文本：如何使用图像进行提示', description: '用GPT-5.6、Claude和Gemini分析、生成和编辑图像。三种模式的结构化提示模板，以及常见错误与本地模型使用建议。', datePublished: '2026-03-25', dateModified: '2026-09-01', url: 'https://www.promptquorum.com/zh/prompt-engineering/beyond-text-how-to-prompt-with-images', inLanguage: 'zh', author: { '@type': 'Organization', name: 'PromptQuorum' }, publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } } }, sections: imagesWithTextZh },
  ko: {
    theme: 'Fundamentals',
    heroImage: '/images/prompt-with-images-overview-hero-ko.webp',
    title: '텍스트를 넘어서: 이미지로 프롬프트를 작성하는 방법',
    seoTitle: '이미지 프롬프팅 2026: AI로 분석, 생성, 편집하기',
    metaDescription: 'GPT-5.6, Claude, Gemini로 이미지를 분석, 생성, 편집하십시오. 세 가지 모드에 대한 검증된 멀티모달 프롬프트 패턴 — 템플릿과 주의사항을 포함합니다.',
    intro: '멀티모달 프롬프팅 — 이미지와 텍스트를 결합하는 방식 — 은 GPT-5.6 및 Claude Opus 5과 같은 비전-언어 모델의 기능을 활성화합니다. 이미지를 설명하고 분석하며 생성하고 편집하기 위한 정확한 패턴을 학습하십시오.',
    publishDate: '2026-03-25',
    dateModified: '2026-09-01',
    readTime: '12분 읽기',
    leadAnswerBlock: '멀티모달 프롬프팅은 텍스트 프롬프트에 이미지를 첨부하여 비전-언어 모델이 문자 설명에만 의존하지 않고 시각적 콘텐츠를 함께 인식하고 추론하도록 합니다. 이미지 분석, 생성, 편집이라는 세 가지 모드를 포함합니다.',
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
    ...
    sections: {
      definition: {
        ...
        snippets: [
          { type: 'in-one-sentence', text: '멀티모달 프롬프팅은 텍스트 프롬프트에 이미지를 첨부하여, 비전-언어 모델이 작성된 지시사항과 함께 시각적 콘텐츠를 인식하고 추론하도록 하는 방식입니다.' },
          { type: 'in-plain-terms', text: '이미지를 말로 설명하고 모델이 제대로 상상하기를 기대하는 대신, 이미지를 직접 보여 줍니다. 질문은 그대로 입력하고 이미지가 함께 전달되므로, 모델은 설명이 아니라 실제로 보이는 내용을 근거로 판단합니다.' },
        ],
        content: [
      ...
      tldr: {
        ...
        isTldr: true,
        items: [
          '멀티모달 프롬프팅은 텍스트와 이미지를 결합합니다. GPT-5.6 및 Claude Opus 5과 같은 모델은 이미지 분석과 설명에 뛰어납니다.',
      ...
      howVisionWorks: {
        ...
        content: [
          '**GPT-5.6, Claude Opus 5, Gemini 3.1 Pro와 같은 비전-언어 모델은 시각적 인코더를 사용하여 이미지를 고차원 벡터(임베딩)로 변환한 다음, 공유된 의미 공간에서 텍스트 토큰과 함께 해당 임베딩을 처리합니다.** 이 접근 방식은 VLM에게 여러 작업에 걸쳐 명확한 강점을 부여합니다. 객체를 식별하고 텍스트를 읽으며 공간적 관계를 이해하고 여러 이미지에 걸쳐 콘텐츠를 추론합니다. GPT-5.6와 Claude Opus 5은 모두 약 100만 토큰의 컨텍스트 창을 제공하며, Gemini 3.1 Pro는 최대 200만 토큰까지 더 넓은 컨텍스트 창을 지원하여 잘림 없이 긴 멀티모달 시퀀스를 분석할 수 있습니다. [컨텍스트 창 한계](/ko/prompt-engineering/context-windows-explained-why-ai-forgets)를 이해하면 긴 이미지 설명이나 다중 이미지 시퀀스 작업 시 잘림을 방지하는 프롬프트를 구성하는 데 도움이 됩니다.',
      ...
      pitfalls: {
        ...
        items: [
          ...
          '**다중 이미지 과부하:** API 한도는 대부분의 사람이 예상하는 것보다 높습니다. Claude는 200K 컨텍스트 모델에서 요청당 최대 100개의 이미지(이미지당 10 MB 제한)를 허용하고, Gemini 3.1 Pro는 20 MB 인라인 요청 한도 내에서 요청당 최대 3,600개의 이미지 파일을 허용합니다(더 큰 배치는 File API를 사용하십시오). 다만 출력 신뢰성은 이러한 한도에 도달하기 훨씬 전부터 저하됩니다 — 일관된 분석을 위해 요청을 5–10개 단위로 배치 처리하십시오. 명확하게 레이블을 붙이십시오: "Image 1: [설명], Image 2: [설명]."',
      ...
      promptquorumHelps: {
        ...
        content: [
          '**PromptQuorum은 GPT-5.6, Claude Opus 5, Gemini 3.1 Pro 및 기타 모델에 걸쳐 멀티모달 프롬프트를 동시에 테스트할 수 있는 다중 모델 프롬프트 디스패치 플랫폼입니다.** **PromptQuorum에서 테스트됨 — 세 모델에 걸쳐 30개의 제품 이미지 프롬프트 디스패치:** GPT-5.6는 30건 중 22건에서 가장 구조화된 출력을 반환했으며, Claude Opus 5은 30건 중 25건에서 텍스트 추출에서 가장 높은 정확도를 달성했고, Gemini 3.1 Pro는 30건 중 18건에서 가장 많은 맥락적 세부 사항을 포착했습니다 — 서로 다른 모델이 서로 다른 이미지 분석 작업에 탁월함을 보여줍니다. Consensus Scoring은 모든 다중 모델 불일치에서 이상값 응답을 식별했습니다.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**PromptQuorum으로 여러 모델에 걸쳐 테스트하십시오.** GPT-5.6는 장면 이해에, Claude Opus 5은 텍스트 추출에, Gemini 3.1 Pro는 긴 컨텍스트에 뛰어납니다. 한 모델이 모든 작업에서 최고인 경우는 드뭅니다 — 출력을 비교하여 최적의 모델을 찾으십시오.',
        ...
        faqs: [
          {
            ...
            a: '단일 최고 모델은 없습니다. GPT-5.6는 일반적인 장면 이해와 복잡한 추론에 뛰어납니다. Claude Opus 5은 문서 분석과 텍스트 추출에 정확합니다. GPT-5.6와 Claude Opus 5은 약 100만 토큰의 컨텍스트 창을 제공하며, Gemini 3.1 Pro는 최대 200만 토큰을 지원합니다. PromptQuorum을 사용하여 특정 작업에 대해 세 모델 모두를 테스트하십시오.',
          },
          {
          ...
          },
          {
            ...
            a: 'API 한도는 대부분의 사람이 예상하는 것보다 높습니다. Claude는 200K 컨텍스트 모델에서 요청당 최대 100개의 이미지를 허용하고, Gemini 3.1 Pro는 요청당 최대 3,600개의 이미지 파일을 허용합니다(20 MB 인라인 요청 한도 내, 그 이상은 File API 사용). 다만 출력 신뢰성은 이러한 한도에 도달하기 훨씬 전부터 저하되므로, 일관된 분석을 위해 요청을 5–10개 단위로 배치 처리하고 각 이미지에 레이블을 붙이십시오.',
          },
          {
            q: '비전-언어 모델은 어떤 이미지 형식을 지원합니까?',
            a: 'GPT-5.6, Claude Opus 5, Gemini 3.1 Pro는 JPEG, PNG, GIF, WebP를 허용합니다. 이미지당 크기 한도는 모델마다 다릅니다. Claude의 API 한도는 이미지당 10 MB(Amazon Bedrock 또는 Google Cloud 경유 시 5 MB)이며, Gemini의 인라인 요청 한도는 총 20 MB로 더 큰 파일은 File API를 통해 처리됩니다. 현재 모델별 한도는 OpenAI, Anthropic, Google 문서를 확인하십시오.',
          },
          {
            q: '멀티모달 프롬프팅에 Ollama와 같은 로컬 모델을 사용할 수 있습니까?',
            a: '예. LLaVA 및 Ollama와 같은 모델은 로컬 이미지 분석을 지원합니다. 로컬 모델은 개인정보 보호를 제공하지만 GPT-5.6 또는 Claude Opus 5보다 정확도가 낮습니다. 중요하지 않은 작업이나 개인정보 보호가 필수적인 경우에 사용하십시오.',
          },
          {
