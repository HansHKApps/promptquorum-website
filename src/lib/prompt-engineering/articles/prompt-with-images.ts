...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      sections: {
        ...
        howVisionWorks: { title: 'How Vision-Language Models See Images', content: ['**Vision-language models like GPT-5.6, Claude Opus 5, and Gemini 3.1 Pro convert images into high-dimensional vectors (embeddings) using a visual encoder, then process those embeddings alongside text tokens in a shared semantic space.** This approach gives VLMs clear strengths across several tasks: they identify objects, read text, understand spatial relationships, and reason about content across multiple images. GPT-5.6, Claude Opus 5, and Gemini 3.1 Pro now all share a 1-million-token context window, enabling analysis of long multimodal sequences without truncation. Understanding [context window limits](/prompt-engineering/context-windows-explained-why-ai-forgets) helps you structure prompts that avoid truncation when working with long image descriptions or multi-image sequences.', 'VLMs excel at scene understanding, document analysis, and comparing visual elements. However, they have predictable weaknesses:'], items: ['Precise counting (especially of small objects or items in dense scenes)', 'Fine-grained object boundaries and exact spatial measurements', 'Reading tiny text within images or complex diagrams', 'Understanding three-dimensional spatial relationships from single angles', 'Avoiding hallucinated details not present in the image'] },
        ...
        faqs: [
          {
            ...
            a: '단일 최고 모델은 없습니다. GPT-5.6는 일반적인 장면 이해와 복잡한 추론에 뛰어납니다. Claude Opus 5은 문서 분석과 텍스트 추출에 정확합니다. GPT-5.6, Claude Opus 5, Gemini 3.1 Pro 모두 이제 100만 토큰 컨텍스트 창을 지원합니다. PromptQuorum을 사용하여 특정 작업에 대해 세 모델 모두를 테스트하십시오.',
          },
          {
