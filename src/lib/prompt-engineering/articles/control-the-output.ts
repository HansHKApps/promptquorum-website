...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    es: {
      ...
      schema: {
        ...
        url: 'https://www.promptquorum.com/es/es/prompt-engineering/control-the-output',
        inLanguage: 'es',
        datePublished: '2026-03-24',
        dateModified: '2026-04-29',
        author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.promptquorum.com/about' },
    ...
    ar: {
      ...
      seoTitle: 'التحكم في مخرجات الذكاء الاصطناعي وتوافق المخطط ٢٠٢٦',
      metaDescription: 'تحكّم في مخرجات نماذج اللغة الكبيرة بوضع JSON والفك المقيّد. حقّق توافق ١٠٠٪ مع المخطط بمسارات من مرحلتين دون فقدان الجودة.',
      ...
      twitterDescription: 'الفك المقيّد = توافق ١٠٠٪ مع المخطط لكن مع انخفاض ٢-١٠٪ في الدقة. درجة الحرارة ٠.٠-٠.١ لـJSON الإنتاجي. المقايضات التي لا يخبرك بها أحد.',
