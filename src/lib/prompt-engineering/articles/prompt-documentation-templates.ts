...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  ar: {
    ...
    metaDescription: '6 قوالب لتوثيق البرومبتات: بطاقة السطر الواحد، كتلة الإصدار، رأس مجموعة الاختبار، سجل القرارات، مبرر التغيير، تهيئة API. أقل من 10 دقائق لكل منها.',
