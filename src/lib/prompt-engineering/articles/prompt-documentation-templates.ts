...
export const article: Record<Language, PEArticle> = {
  en: {
    ...
    metaDescription: '6 prompt documentation templates: One-Liner Card, Version Block, Test Suite Header, Decision Log, Change Rationale, API Config Block. Under 10 minutes each.',
  ...
  de: {
    ...
    metaDescription: '6 Prompt-Dokumentationsvorlagen: Einzeiler-Karte, Versionsblock, Testsuite-Header, Entscheidungsprotokoll, Änderungsbegründung und API-Konfigurationsblock. Jeweils unter 10 Minuten.',
  ...
  fr: {
    ...
    metaDescription: '6 modèles de documentation des prompts : Fiche one-liner, Bloc de version, En-tête de suite de tests, Journal de décision, Justification de changement, Bloc de config API. Moins de 10 minutes chacun.',
  ...
  zh: {
    ...
    metaDescription: '6种Prompt文档化模板：单行卡片、版本块、测试套件头、决策日志、变更理由和API配置块。每种不超过10分钟。',
