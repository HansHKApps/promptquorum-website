...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    es: {
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        url: 'https://www.promptquorum.com/es/es/prompt-engineering/your-brand-voice-ai',
    ...
    ar: {
      ...
      seoTitle: 'الذكاء الاصطناعي لصوت العلامة التجارية: كيف تُدرّب النماذج على نبرتك',
      metaDescription: 'درّب الذكاء الاصطناعي على الكتابة بصوت علامتك التجارية باستخدام الركائز وقواعد الأسلوب وأمثلة النبرة. يتناول Jasper وCopy.ai وHubSpot والطلبات.',
