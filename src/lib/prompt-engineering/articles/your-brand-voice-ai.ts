...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ja: {
      ...
      metaDescription: 'AIをブランドボイスに合わせてトレーニングする方法。トーン設計、スタイルルール、オンブランド例の活用法を解説。Jasper・Copy.ai・HubSpot比較付き。実践テンプレート。',
    ...
    zh: {
      ...
      metaDescription: '训练AI匹配品牌语调：定义声音支柱、风格规则和品牌范例。比较Jasper、Copy.ai、HubSpot等工具。含模板的实践指南。',
