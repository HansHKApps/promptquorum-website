    ...
    en: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          rows: [
            { 'Tool': '[Jasper Brand Voice](https://www.jasper.ai/brand-voice)', 'Voice Training Method': 'Paste examples', 'Multi-language': 'Yes', 'SEO Integration': 'No', 'Pricing Model': 'Paid plans' },
            { 'Tool': '[Copy.ai Brand Voice](https://www.copy.ai/features/brand-voice)', 'Voice Training Method': 'Voice profiles', 'Multi-language': 'Yes', 'SEO Integration': 'No', 'Pricing Model': 'Free + paid' },
            ...
            { 'Tool': '[Blaze.ai](https://www.blaze.ai/ai-writer/ai-brand-voice)', 'Voice Training Method': 'Profile builder', 'Multi-language': 'Yes', 'SEO Integration': 'No', 'Pricing Model': 'Paid plans' },
          ],
        },
    ...
    de: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          rows: [
            { 'Tool': '[Jasper Brand Voice](https://www.jasper.ai/brand-voice)', 'Stimmen-Trainingsmethode': 'Beispiele einfügen', 'Mehrsprachig': 'Ja', 'SEO-Integration': 'Nein', 'Preismodell': 'Bezahlte Pläne' },
            { 'Tool': '[Copy.ai Brand Voice](https://www.copy.ai/features/brand-voice)', 'Stimmen-Trainingsmethode': 'Voice-Profile', 'Mehrsprachig': 'Ja', 'SEO-Integration': 'Nein', 'Preismodell': 'Kostenlos + bezahlt' },
            ...
            { 'Tool': '[Blaze.ai](https://www.blaze.ai/ai-writer/ai-brand-voice)', 'Stimmen-Trainingsmethode': 'Profilgenerator', 'Mehrsprachig': 'Ja', 'SEO-Integration': 'Nein', 'Preismodell': 'Bezahlte Pläne' },
          ],
        },
        applications: {
          id: 'applications',
    ...
    es: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          rows: [
            { 'Herramienta': '[Jasper Brand Voice](https://www.jasper.ai/brand-voice)', 'Método de entrenamiento de voz': 'Insertar ejemplos', 'Multilingüe': 'Sí', 'Integración SEO': 'No', 'Modelo de precios': 'Planes de pago' },
            { 'Herramienta': '[Copy.ai Brand Voice](https://www.copy.ai/features/brand-voice)', 'Método de entrenamiento de voz': 'Perfil de voz', 'Multilingüe': 'Sí', 'Integración SEO': 'No', 'Modelo de precios': 'Gratuito + pago' },
            ...
            { 'Herramienta': '[Blaze.ai](https://www.blaze.ai/ai-writer/ai-brand-voice)', 'Método de entrenamiento de voz': 'Generador de perfil', 'Multilingüe': 'Sí', 'Integración SEO': 'No', 'Modelo de precios': 'Planes de pago' },
          ],
        },
        applications: {
          id: 'applications',
    ...
    ar: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          rows: [
            { 'الأداة': '[Jasper Brand Voice](https://www.jasper.ai/brand-voice)', 'أسلوب تدريب الصوت': 'إدراج أمثلة', 'متعددة اللغات': 'نعم', 'تكامل SEO': 'لا', 'نموذج التسعير': 'خطط مدفوعة' },
            { 'الأداة': '[Copy.ai Brand Voice](https://www.copy.ai/features/brand-voice)', 'أسلوب تدريب الصوت': 'ملف صوت', 'متعددة اللغات': 'نعم', 'تكامل SEO': 'لا', 'نموذج التسعير': 'مجاني + مدفوع' },
            ...
            { 'الأداة': '[Blaze.ai](https://www.blaze.ai/ai-writer/ai-brand-voice)', 'أسلوب تدريب الصوت': 'مولّد ملفات', 'متعددة اللغات': 'نعم', 'تكامل SEO': 'لا', 'نموذج التسعير': 'خطط مدفوعة' },
          ],
        },
        applications: {
          id: 'applications',
    ...
    pt: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          rows: [
            { 'Ferramenta': '[Jasper Brand Voice](https://www.jasper.ai/brand-voice)', 'Método de treinamento de voz': 'Inserir exemplos', 'Multilíngue': 'Sim', 'Integração SEO': 'Não', 'Modelo de preço': 'Planos pagos' },
            { 'Ferramenta': '[Copy.ai Brand Voice](https://www.copy.ai/features/brand-voice)', 'Método de treinamento de voz': 'Perfil de voz', 'Multilíngue': 'Sim', 'Integração SEO': 'Não', 'Modelo de preço': 'Gratuito + pago' },
            ...
            { 'Ferramenta': '[Blaze.ai](https://www.blaze.ai/ai-writer/ai-brand-voice)', 'Método de treinamento de voz': 'Gerador de perfil', 'Multilíngue': 'Sim', 'Integração SEO': 'Não', 'Modelo de preço': 'Planos pagos' },
          ],
        },
        applications: {
          id: 'applications',
    ...
    fr: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          rows: [
            { 'Outil': '[Jasper Brand Voice](https://www.jasper.ai/brand-voice)', 'Méthode d\'entraînement': 'Exemples', 'Multilingue': 'Oui', 'Intégration SEO': 'Non', 'Modèle tarifaire': 'Forfaits payants' },
            { 'Outil': '[Copy.ai Brand Voice](https://www.copy.ai/features/brand-voice)', 'Méthode d\'entraînement': 'Profils', 'Multilingue': 'Oui', 'Intégration SEO': 'Non', 'Modèle tarifaire': 'Gratuit + payant' },
            ...
            { 'Outil': '[Blaze.ai](https://www.blaze.ai/ai-writer/ai-brand-voice)', 'Méthode d\'entraînement': 'Générateur de profil', 'Multilingue': 'Oui', 'Intégration SEO': 'Non', 'Modèle tarifaire': 'Forfaits payants' },
          ],
        },
        applications: {
          id: 'applications',
    ...
    ja: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          rows: [
            { 'ツール': '[Jasper Brand Voice](https://www.jasper.ai/brand-voice)', 'トレーニング方法': '例導入', 'マルチ言語': 'はい', 'SEO統合': 'いいえ', '価格モデル': '有料プラン' },
            { 'ツール': '[Copy.ai Brand Voice](https://www.copy.ai/features/brand-voice)', 'トレーニング方法': 'プロファイル', 'マルチ言語': 'はい', 'SEO統合': 'いいえ', '価格モデル': '無料+有料' },
            ...
            { 'ツール': '[Blaze.ai](https://www.blaze.ai/ai-writer/ai-brand-voice)', 'トレーニング方法': 'プロファイル生成', 'マルチ言語': 'はい', 'SEO統合': 'いいえ', '価格モデル': '有料プラン' },
          ],
        },
        applications: {
          id: 'applications',
    ...
    zh: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          rows: [
            { '工具': '[Jasper Brand Voice](https://www.jasper.ai/brand-voice)', '语音训练方法': '插入示例', '多语言': '是', 'SEO集成': '否', '定价模型': '付费计划' },
            { '工具': '[Copy.ai Brand Voice](https://www.copy.ai/features/brand-voice)', '语音训练方法': '语音配置文件', '多语言': '是', 'SEO集成': '否', '定价模型': '免费+付费' },
            ...
            { '工具': '[Blaze.ai](https://www.blaze.ai/ai-writer/ai-brand-voice)', '语音训练方法': '配置文件生成器', '多语言': '是', 'SEO集成': '否', '定价模型': '付费计划' },
          ],
        },
        applications: {
          id: 'applications',
  ...
  ko: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          rows: [
            { '도구': '[Jasper Brand Voice](https://www.jasper.ai/brand-voice)', '보이스 훈련 방법': '예시 붙여 넣기', '다국어': '예', 'SEO 통합': '아니요', '가격 모델': '유료 플랜' },
            { '도구': '[Copy.ai Brand Voice](https://www.copy.ai/features/brand-voice)', '보이스 훈련 방법': '보이스 프로필', '다국어': '예', 'SEO 통합': '아니요', '가격 모델': '무료 + 유료' },
            ...
            { '도구': '[Blaze.ai](https://www.blaze.ai/ai-writer/ai-brand-voice)', '보이스 훈련 방법': '프로필 빌더', '다국어': '예', 'SEO 통합': '아니요', '가격 모델': '유료 플랜' },
          ],
        },
