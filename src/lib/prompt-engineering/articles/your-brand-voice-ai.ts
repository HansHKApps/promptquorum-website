...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      metaDescription: 'درّب الذكاء الاصطناعي على الكتابة بصوت علامتك التجارية باستخدام ركائز النبرة وقواعد الأسلوب. مقارنة Jasper وCopy.ai وHubSpot مع قوالب عملية لـ 2026.',
      ...
      schema: {
        ...
        author: { '@type': 'Person', name: 'Hans Kuepper', url: 'https://www.promptquorum.com/about' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } },
        image: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/ar/api/og/your-brand-voice-ai', width: 1200, height: 630 },
    ...
    pt: {
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        url: 'https://www.promptquorum.com/pt/pt/prompt-engineering/your-brand-voice-ai',
