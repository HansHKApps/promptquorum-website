...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    de: {
      ...
      metaDescription: 'KI auf Ihre Markensprache trainieren: Stimmpfeiler, Stilregeln und Beispiele definieren. Vergleich von Jasper, Copy.ai und HubSpot. Praxisleitfaden mit Vorlagen. April 2026.',
    ...
    es: {
      ...
      metaDescription: 'Entrena a la IA para escribir con la voz de tu marca usando pilares de voz, reglas de estilo y ejemplos en tono. Cubre Jasper, Copy.ai, HubSpot y métodos basados en prompts. Guía práctica con plantillas. Abril 2026.',
