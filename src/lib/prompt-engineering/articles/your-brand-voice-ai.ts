...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      metaDescription: 'Train AI to write in your brand voice with voice pillars, style rules, and on-tone examples. Covers Jasper, Copy.ai, HubSpot, and prompt-based methods. Practical guide with templates.',
    ...
    fr: {
      ...
      metaDescription: 'Entraînez l\'IA sur la voix de votre marque : piliers de ton, règles de style et exemples on-brand. Comparatif Jasper, Copy.ai, HubSpot. Guide pratique avec modèles.',
  ...
  ko: {
    ...
    heroImage: '/images/your-brand-voice-ai-overview-hero-ko.webp',
      ...
      metaDescription: '보이스 필러, 스타일 규칙, 온톤 예시로 AI가 귀사의 브랜드 보이스로 작성하도록 훈련하십시오. Jasper, Copy.ai, HubSpot 및 프롬프트 기반 방법을 다룹니다. 템플릿이 포함된 실용 가이드.',
