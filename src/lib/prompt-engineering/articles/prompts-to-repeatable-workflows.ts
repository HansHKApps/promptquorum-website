...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'من الأوامر إلى سير العمل القابلة للتكرار: قوالب أتمتة',
    ...
    metaDescription: 'حوّل الأوامر إلى سير عمل آلي: المشغّلات وإدارة الحالة ومعالجة الأخطاء. 4 قوالب: معالجة المستندات، البحث، مراجعة الكود، الفرز.',
