...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      metaDescription: 'ربط البرومبتات يقسّم المهام المعقدة إلى خطوات مركّزة، ويحسّن الدقة بفصل الفهم والتخطيط والتوليد. تعلّم كيف تصمم سير عمل ذكاء اصطناعي متعدد الخطوات وموثوق.',
