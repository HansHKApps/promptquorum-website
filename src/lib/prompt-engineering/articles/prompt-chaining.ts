...
export const article: Record<Language, PEArticle> = {
    en: {
      ...
      sections: {
        ...
        proTipModelSelection: {
          ...
          content: [
            'Use a cheap, fast model (Claude Haiku 4.5, GPT-5.5 mini, Gemini Flash) for extraction and classification steps, and a frontier model (Claude Opus 4.7, GPT-5.5) only for the generation and review steps. This cuts chain cost by 60–70% with minimal quality loss on the mechanical steps.',
          ],
        },
        comparisonTable: {
        ...
        testingInsights: {
          ...
          content: [
            ...
            'In parallel testing across GPT-5.5, Claude Opus 4.7, and local LLaMA 4 Scout models, chains showed consistent gains. The trade-off: chains require 2–5× more API calls, but the quality gain and easier debugging typically justify the cost for production workflows.',
          ],
        },
        didYouKnow: {
          title: '🔍 Did You Know?',
    ...
    de: {
      ...
      publishDate: '2026-03-26',
      seoTitle: 'Prompt Chaining 2026: Komplexe Aufgaben in Schritte Zerlegen',
      metaDescription: 'Prompt Chaining zerlegt komplexe Aufgaben in fokussierte Schritte und verbessert die Genauigkeit. Lernen Sie Multi-Step-Workflows mit klaren Ausgaben und bewährten Praktiken für Claude, GPT und lokale LLMs.',
      ...
      sections: {
        ...
        proTipModelSelection: {
          ...
          content: [
            'Nutzen Sie ein günstiges, schnelles Modell (Claude Haiku 4.5, GPT-5.5 mini, Gemini Flash) für Extrahierungs- und Klassifizierungsschritte, und setzen Sie ein Frontier-Modell (Claude Opus 4.7, GPT-5.5) nur für die Generierungs- und Überprüfungsschritte ein. Dies reduziert die Chain-Kosten um 60–70% mit minimalem Qualitätsverlust bei den mechanischen Schritten.',
          ],
        },
        comparisonTable: {
        ...
        inPromptQuorum: {
          ...
          items: [
            ...
            'Wichtige Schritte parallel über Modelle hinweg ausführen (wie GPT-5.5, Claude Opus 4.7 und Gemini 3.1 Pro), um zu vergleichen, wie jeder Extrahierung, Planung oder Generierung bewältigt.',
        ...
        testingInsights: {
          ...
          content: [
            ...
            'In parallelen Tests über GPT-5.5, Claude Opus 4.7 und lokale LLaMA 4 Scout Modelle zeigten Chains konsistente Gewinne. Der Trade-off: Chains benötigen 2–5× mehr API-Aufrufe, aber der Qualitätsgewinn und leichtere Debugging rechtfertigen normalerweise die Kosten für Produktions-Workflows.',
          ],
        },
        didYouKnow: {
        ...
        relatedReading: {
          ...
          items: [
            '[Chain-of-Thought Prompting](/prompt-engineering/chain-of-thought-prompting?lang=de) — CoT ist Single-Prompt Reasoning; Chaining sequenziert mehrere Prompts.',
            '[Tree-of-Thought und ReAct](/prompt-engineering/tree-of-thought-and-react?lang=de) — ReAct ist ein spezifisches Chaining-Muster (Reason → Act → Observe Loop).',
            '[Constrained Prompting](/prompt-engineering/constrained-prompting?lang=de) — Constrain das Output-Format bei jedem Chain-Schritt für zuverlässige Handoffs.',
            '[Persona Prompting](/prompt-engineering/persona-prompting?lang=de) — Unterschiedliche Personas bei jedem Chain-Schritt (Analytiker → Schriftsteller → Redakteur).',
            '[RTF Framework](/prompt-engineering/rtf-framework?lang=de) — Role-Task-Format mappt natürlich zu einzelnen Chain-Schritten.',
            '[Tokens, Kosten & Limits](/prompt-engineering/tokens-costs-limits-economics-of-ai-prompting?lang=de) — Chains verwenden 2–5× mehr Tokens; Kosten-Auswirkungen.',
            '[GPT, Claude, oder Gemini?](/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model?lang=de) — Unterschiedliche Modelle bei unterschiedlichen Chain-Schritten.',
          ],
        },
      },
    },
