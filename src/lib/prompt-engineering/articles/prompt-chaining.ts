  ...
  sections: {
    ...
    testingInsights: {
      ...
      content: [
        ...
        'GPT-4o、Claude Opus 4.7、ローカルLLaMA 4 Scoutモデル全体での並列テストでは、チェーンは一貫した利益を示しました。トレードオフ：チェーンには2～5倍のAPI呼び出しが必要です。ただし品質向上と簡単なデバッグは、通常、本番ワークフローのコストを正当化します。',
      ],
    },
    didYouKnow: {
      title: 'ご存知でしたか？',
    ...
    faqSection: {
      ...
      faqs: [
        ...
        },
        {
          ...
          a: 'はい。プロンプトチェーニングはモデル非依存です。GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro、またはテキストプロンプトをサポートするローカルモデルでチェーンを実行できます。',
        },
      ],
    },
    sources: {
