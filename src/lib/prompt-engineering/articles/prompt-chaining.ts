...
export const article: Record<Language, PEArticle> = {
    ...
    de: {
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'url': 'https://www.promptquorum.com/prompt-engineering/prompt-chaining?lang=de',
        'inLanguage': 'de',
  ...
  schema: {
    '@context': 'https://schema.org',
    '@type': 'TechArticle',
    url: 'https://www.promptquorum.com/prompt-engineering/prompt-chaining?lang=ja',
  ...
  sections: {
    ...
    testingInsights: {
      ...
      content: [
        ...
        'GPT-5.5、Claude Opus 4.7、ローカルLLaMA 4 Scoutモデル全体での並列テストでは、チェーンは一貫した利益を示しました。トレードオフ：チェーンには2～5倍のAPI呼び出しが必要です。ただし品質向上と簡単なデバッグは、通常、本番ワークフローのコストを正当化します。',
      ],
    },
    didYouKnow: {
      title: 'ご存知でしたか？',
    ...
    faqSection: {
      ...
      faqs: [
        ...
        },
        {
          ...
          a: 'はい。プロンプトチェーニングはモデル非依存です。GPT-5.5、Claude Opus 4.7、Gemini 3.1 Pro、またはテキストプロンプトをサポートするローカルモデルでチェーンを実行できます。',
        },
      ],
    },
    sources: {
    ...
    relatedReading: {
      title: '関連記事',
      items: [
        '[Chain-of-Thought Prompting](/prompt-engineering/chain-of-thought-prompting?lang=ja) — CoTは単一プロンプトの推論。チェーニングは複数プロンプトを順序化。',
        '[Tree-of-Thought と ReAct](/prompt-engineering/tree-of-thought-and-react?lang=ja) — ReActは特定のチェーニングパターン（Reason → Act → Observe ループ）。',
        '[制約付きプロンプティング](/prompt-engineering/constrained-prompting?lang=ja) — 各チェーンステップで出力フォーマットを制約して、信頼できるハンドオフ。',
        '[ペルソナプロンプティング](/prompt-engineering/persona-prompting?lang=ja) — チェーンの各ステップで異なるペルソナ（アナリスト → ライター → エディタ）。',
        '[RTFフレームワーク](/prompt-engineering/rtf-framework?lang=ja) — Role-Task-Format は個別チェーンステップに自然にマップされます。',
        '[トークン、コスト、制限](/prompt-engineering/tokens-costs-limits-economics-of-ai-prompting?lang=ja) — チェーンは2～5倍のトークンを使用。コストへの影響。',
        '[GPT、Claude、Gemini どれを選ぶ？](/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model?lang=ja) — チェーインのステップごとに異なるモデル。',
      ],
    },
  },
},
zh: {
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        'url': 'https://www.promptquorum.com/prompt-engineering/prompt-chaining?lang=zh',
        'inLanguage': 'zh',
