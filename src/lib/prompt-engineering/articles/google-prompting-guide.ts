...
export const article: Partial<Record<Language, PEArticle>> = {
  en: {
    ...
    metaDescription: 'Master Google\'s 5 prompting principles: clarity, constraints, examples, roles, structure. Apply these techniques to Gemini, GPT-4o, Claude, and local models for predictable outputs.',
    ogTitle: 'Google Prompting Guide: 5 Core Principles + Examples',
    ogDescription: 'Master Google\'s 5 prompting principles: clarity, constraints, examples, roles, structure. Apply these techniques to Gemini, GPT-4o, Claude, and local models for predictable outputs.',
    twitterTitle: 'Google Prompting Guide: 5 Core Principles + Examples',
    twitterDescription: 'Master Google\'s 5 prompting principles: clarity, constraints, examples, roles, structure. Apply these techniques to Gemini, GPT-4o, Claude, and local models for predictable outputs.',
    educationalLevel: 'Intermediate',
    audience: 'Developers building with LLMs, prompt engineers, product teams',
    primaryTerm: 'Google Prompting Guide',
    leadAnswerBlock: '**Google\'s Prompting Guide teaches you to be explicit about task, audience, and constraints instead of relying on models to guess. The 5 core principles—clarity, structure, examples, roles, and constraints—work across all modern models (Gemini 3.1 Pro, GPT-4o, Claude Opus 4.7) and produce more predictable, reusable prompts.**',
    quickFacts: [
      ...
      '**Model Agnostic:** Works equally well on Gemini 3.1 Pro, GPT-4o, Claude Opus 4.7, local models via Ollama',
    ...
    schema: {
      ...
      description: "Master Google's 5 prompting principles: clarity, constraints, examples, roles, structure. Apply these techniques to Gemini, GPT-4o, Claude, and local models for predictable outputs.",
      datePublished: '2026-03-24',
      dateModified: '2026-05-03',
      url: 'https://www.promptquorum.com/prompt-engineering/google-prompting-guide?lang=en',
      inLanguage: 'en',
      keywords: ['Google Prompting Guide', 'prompt best practices', 'prompt engineering', 'Gemini 3.1 Pro', 'GPT-4o', 'Claude Opus 4.7', 'prompt frameworks', 'PromptQuorum'],
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**These principles work across all modern models—Gemini 3.1 Pro, GPT-4o, Claude Opus 4.7, and local models (Ollama, LM Studio).** They\'re model-agnostic.',
          ...
          '**PromptQuorum integrates Google\'s Guide as a reusable framework; fill in fields once and dispatch to Gemini, GPT-4o, Claude, and local models in parallel.**',
      ...
      howPQImplements: {
        ...
        items: [
          'Fill in guide-aligned fields once and send the resulting prompt to Gemini 3.1 Pro, GPT-4o, Claude Opus 4.7, and local models via [Ollama](https://ollama.com) or LM Studio in parallel.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Use step-by-step reasoning for complex tasks.** Ask the model to "think step by step" before answering. This forces deliberation and catches errors. Works across [Gemini 3.1 Pro](/prompt-engineering/gemini-prompting-guide?lang=en), GPT-4o, and Claude Opus 4.7.',
      ...
      faqSection: {
        ...
        faqs: [
          { q: 'Is Google\'s Prompting Guide limited to Gemini?', a: 'No. The principles are universal and work equally well with GPT-4o, Claude Opus 4.7, and all modern models. Gemini is the primary example, but the underlying ideas are model-agnostic.' },
  ...
  de: {
    ...
    metaDescription: 'Beherrsche Googles 5 Prompting-Prinzipien: Klarheit, Struktur, Beispiele, Rollen, Beschränkungen. Auf Gemini, GPT-4o, Claude und lokalen Modellen.',
    educationalLevel: 'Intermediate',
    ...
    schema: {
      ...
      description: 'Beherrsche Googles 5 Prompting-Prinzipien: Klarheit, Struktur, Beispiele, Rollen, Beschränkungen. Auf Gemini, GPT-4o, Claude und lokalen Modellen.',
      datePublished: '2026-03-24',
      dateModified: '2026-05-03',
      url: 'https://www.promptquorum.com/prompt-engineering/google-prompting-guide?lang=de',
      inLanguage: 'de',
      keywords: ['Google Prompting Guide', 'Prompt Best Practices', 'Prompt Engineering', 'Gemini 3.1 Pro', 'GPT-4o', 'Claude Opus 4.7', 'Frameworks', 'PromptQuorum'],
    ...
    sections: {
      ...
      whatIsGoogle: {
        ...
        content: [
          ...
          'In der Praxis funktioniert der Guide wie ein Katalog von Prompt-Rezepten. Jedes Rezept zeigt, wie man Anweisungen formuliert, was zu vermeiden ist und wie man Beispiele hinzufügt, damit das Modellverhalten vorhersagbar wird. Diese Patterns funktionieren nicht nur für Gemini 3,1 Pro, sondern auch für Modelle wie [GPT-4o](https://openai.com), Claude Opus 4,7 und lokale Modelle wie [Ollama](https://ollama.com), weil die zugrundeliegenden Prinzipien allgemein sind.',
        ],
      },
      corePrinciples: {
        id: 'core-principles',
      ...
      howPQImplements: {
        ...
        items: [
          'Guide-konforme Felder einmal ausfüllen und den resultierenden Prompt an Gemini 3,1 Pro, GPT-4o, Claude Opus 4,7 und lokale Modelle via [Ollama](https://ollama.com) oder LM Studio parallel senden.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Nutze schrittweise Begründung für komplexe Aufgaben.** Bitte das Modell, „Schritt für Schritt zu denken", bevor es antwortet. Das erzwingt Überlegung und fängt Fehler auf. Funktioniert über [Gemini 3,1 Pro](/prompt-engineering/gemini-prompting-guide?lang=de), GPT-4o und Claude Opus 4,7.',
      ...
      faqSection: {
        ...
        faqs: [
          { q: 'Ist der Google Prompting Guide nur auf Gemini beschränkt?', a: 'Nein. Die Prinzipien sind universell und funktionieren gleich gut mit GPT-4o, Claude Opus 4,7 und allen modernen Modellen. Gemini ist das primäre Beispiel, aber die Ideen sind modellunabhängig.' },
      ...
      sources: {
        ...
        items: [
          ...
          'OpenAI & Anthropic API Documentation (2026) — Prompt-Engineering Best Practices über GPT-4o, Claude Opus 4,7 und Open-Source-Modelle',
  ...
  fr: {
    ...
    metaDescription: 'Maîtrisez les 5 principes Google : clarté, structure, exemples, rôles, contraintes. Appliquez sur Gemini, GPT-4o, Claude et modèles locaux pour des outputs prévisibles.',
    educationalLevel: 'Intermediate',
    ...
    quickFacts: [
      ...
      '**Indépendant du modèle:** Fonctionne aussi bien sur Gemini 3.1 Pro, GPT-4o, Claude Opus 4.7, modèles locaux via Ollama',
    ...
    schema: {
      ...
      description: 'Maîtrisez les 5 principes Google : clarté, structure, exemples, rôles, contraintes. Appliquez sur Gemini, GPT-4o, Claude et modèles locaux pour des outputs prévisibles.',
      datePublished: '2026-03-24',
      dateModified: '2026-05-03',
      url: 'https://www.promptquorum.com/prompt-engineering/google-prompting-guide?lang=fr',
      inLanguage: 'fr',
      keywords: ['Guide Google', 'rédaction de prompts', 'prompt engineering', 'Gemini 3.1 Pro', 'GPT-4o', 'Claude Opus 4.7', 'frameworks de prompts', 'PromptQuorum'],
      author: { '@type': 'Person', name: 'Hans Kuepper', url: 'https://www.promptquorum.com/about', jobTitle: 'Founder' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      proficiencyLevel: 'Intermediate',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**Ces principes fonctionnent sur tous les modèles modernes—Gemini 3.1 Pro, GPT-4o, Claude Opus 4.7 et modèles locaux (Ollama, LM Studio).** Ils sont indépendants du modèle.',
          ...
          '**PromptQuorum intègre le Guide Google comme framework réutilisable; remplissez les champs une fois et envoyez à Gemini, GPT-4o, Claude et modèles locaux en parallèle.**',
      ...
      howPQImplements: {
        ...
        items: [
          'Remplir les champs alignés au guide une fois et envoyer le prompt résultant à Gemini 3.1 Pro, GPT-4o, Claude Opus 4.7 et modèles locaux via [Ollama](https://ollama.com) ou LM Studio en parallèle.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Utilisez le raisonnement étape par étape pour les tâches complexes.** Demandez au modèle de « penser étape par étape » avant de répondre. Cela force la délibération et attrape les erreurs. Fonctionne sur [Gemini 3.1 Pro](/prompt-engineering/gemini-prompting-guide?lang=fr), GPT-4o et Claude Opus 4.7.',
      ...
      faqSection: {
        ...
        faqs: [
          { q: 'Le Guide Google est-il limité à Gemini ?', a: 'Non. Les principes sont universels et fonctionnent aussi bien avec GPT-4o, Claude Opus 4.7 et tous les modèles modernes. Gemini est l\'exemple principal, mais les idées sous-jacentes sont universelles.' },
  ...
  ja: {
    ...
    metaDescription: 'Googleの5つの原則を習得：明確さ・構造・例・ロール・制約。Gemini、GPT-4o、Claude、ローカルモデルで実践します。',
    educationalLevel: 'Intermediate',
    audience: 'LLMsと協働する開発者、プロンプトエンジニア、プロダクトチーム',
    primaryTerm: 'Googleプロンプト作成ガイド',
    leadAnswerBlock: '**Googleガイドは巧さより明確さを優先します。タスク、オーディエンス、制約を明示的に定義してください。5つの中核原則—明確さ、構造、例、ロール、制約—は、すべての最新モデル（Gemini 3.1 Pro、GPT-4o、Claude Opus 4.7）で機能し、より予測可能で再利用可能なプロンプトを生成します。**',
    quickFacts: [
    ...
    schema: {
      ...
      description: 'Googleの5つの原則を習得：明確さ・構造・例・ロール・制約。Gemini、GPT-4o、Claude、ローカルモデルで実践します。',
      datePublished: '2026-03-24',
      dateModified: '2026-05-03',
      url: 'https://www.promptquorum.com/prompt-engineering/google-prompting-guide?lang=ja',
      inLanguage: 'ja',
      keywords: ['Googleプロンプトガイド', 'プロンプト作成', 'ベストプラクティス', 'Gemini 3.1 Pro', 'GPT-4o', 'Claude Opus 4.7', 'プロンプトフレームワーク', 'PromptQuorum'],
    ...
    sections: {
      ...
      sources: { id: 'sources', title: 'ソース', items: [
        ...
        'OpenAI & Anthropic API Documentation（2026） — Prompt engineering best practicesアクロスGPT-4o、Claude Opus 4.7、open-sourceモデル',
  ...
  zh: {
    ...
    theme: 'Frameworks',
    title: 'Google提示词撰写指南',
    intro: 'Google提示词撰写指南是Google DeepMind汇总的实用原则集，教你如何清晰、结构化地指示AI模型。这些原则对Gemini 3.1 Pro、GPT-4o、Claude都同样有效。PromptQuorum已将此指南集成为框架，所有用户可直接使用。',
    publishDate: '2026-03-24',
    dateModified: '2026-05-03',
    readTime: '阅读约9分钟',
    seoTitle: 'Google提示词指南：5大核心原则',
    metaDescription: '掌握Google 5大提示词原则：明确性、结构、例子、角色、约束。在Gemini、GPT-4o、Claude和本地模型上实践。',
    educationalLevel: 'Intermediate',
    audience: '与LLMs协作的开发者、提示词工程师、产品团队',
    primaryTerm: 'Google提示词撰写指南',
    leadAnswerBlock: '**Google指南优先考虑明确性而非技巧：明确定义任务、受众和约束。5大中核原则—明确性、结构、例子、角色、约束—在所有现代模型（Gemini 3.1 Pro、GPT-4o、Claude Opus 4.7）上有效，生成更可预测、可复用的提示词。**',
    quickFacts: [
      '**来源:** Google DeepMind将指南作为研究支持的最佳实践发布（2024–2026）',
      '**5大中核原则:** 明确性、结构、例子、角色、约束（CSERC）',
      '**模型无关:** 在Gemini 3.1 Pro、GPT-4o、Claude Opus 4.7、Ollama本地模型上同等有效',
    ...
    schema: {
      ...
      description: '掌握Google 5大提示词原则：明确性、结构、例子、角色、约束。在Gemini、GPT-4o、Claude和本地模型上实践。',
      datePublished: '2026-03-24',
      dateModified: '2026-05-03',
      url: 'https://www.promptquorum.com/prompt-engineering/google-prompting-guide?lang=zh',
      inLanguage: 'zh',
      keywords: ['Google提示词指南', '提示词撰写', '最佳实践', 'Gemini 3.1 Pro', 'GPT-4o', 'Claude Opus 4.7', '提示词框架', 'PromptQuorum'],
      author: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      proficiencyLevel: 'Intermediate',
    ...
    sections: {
      ...
      whatIsGoogle: { id: 'what-is-google', title: 'Google提示词撰写指南是什么', content: 'Google提示词撰写指南是Google DeepMind开发的一套实用原则，用于撰写更有效的提示词。这个框架经过数千次模型交互的研究得出，旨在提高清晰度、一致性和输出质量。指南不特定于Gemini——原则对GPT-4o、Claude和所有现代LLM同样适用。' },
      ...
      howPqImplements: { id: 'how-pq-implements', title: 'PromptQuorum如何实现它', content: 'PromptQuorum将Google指南集成为一个内置框架。创建提示词时，用户可选择"Google"模板，工具会：1) 提示输入清晰任务定义、受众和约束；2) 从库生成例子；3) 应用格式规则；4) 跨Gemini 3.1 Pro、GPT-4o和Claude Opus 4.7测试输出。这使Google原则可操作化，不需要用户手动构造提示词。' },
      ...
      howToStart: { id: 'how-to-start', title: '开始使用', numberedItems: ['**明确定义。** 避免模糊。明确说出任务、受众、想要什么。包括任何重要约束。', '**提供例子。** 对于任何涉及风格、格式或复杂判断的任务，包括1–3个输入-输出对。', '**请求结构化思考。** 对于复杂问题，要求模型在回答前"thinking step by step"。', '**定义输出格式。** 说"以JSON/表格/Markdown返回"并给出示范。', '**在PromptQuorum中测试。** 对提示词运行A/B对比；跨Gemini 3.1 Pro、GPT-4o、Claude Opus 4.7测试相同提示词，看哪个模型最一致。'] },
      faqSection: { id: 'faq', title: '常见问题解答', faqs: [
        { q: 'Google指南只适用于Gemini吗？', a: '不是。原则是通用的，对GPT-4o、Claude和所有现代模型都同样有效。Gemini是主要例子，但核心思想是普遍的。' },
      ...
      relatedReading: { id: 'related-reading', title: '关联阅读', items: [
        { title: 'Few-Shot Prompting', url: '/prompt-engineering/few-shot-prompting?lang=zh' },
        { title: 'Chain-of-Thought Prompting', url: '/prompt-engineering/chain-of-thought-prompting?lang=zh' },
        { title: 'Persona Prompting', url: '/prompt-engineering/persona-prompting?lang=zh' },
        { title: 'Constrained Prompting', url: '/prompt-engineering/constrained-prompting?lang=zh' },
        { title: 'CO-STAR Prompting Framework', url: '/prompt-engineering/co-star-prompting-framework?lang=zh' },
        { title: 'Prompt Chaining', url: '/prompt-engineering/prompt-chaining?lang=zh' },
        { title: '如何跨模型测试提示词', url: '/prompt-engineering/how-to-test-prompts-across-models?lang=zh' },
        { title: '选择模型：GPT、Claude还是Gemini？', url: '/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model?lang=zh' },
  ...
  es: {
    ...
    twitterDescription: 'Domina los 5 principios de prompts de Google: claridad, restricciones, ejemplos, roles, estructura. Aplícalos en Gemini, GPT-4o, Claude y modelos locales para resultados predecibles.',
    educationalLevel: 'Intermediate',
    ...
    schema: {
      ...
      datePublished: '2026-03-24',
      dateModified: '2026-05-03',
      url: 'https://www.promptquorum.com/prompt-engineering/google-prompting-guide?lang=es',
      inLanguage: 'es',
      keywords: ['Google Prompting Guide', 'mejores prácticas de prompts', 'ingeniería de prompts', 'Gemini 3.1 Pro', 'GPT-4o', 'Claude Opus 4.7', 'frameworks de prompts', 'PromptQuorum'],
      author: { '@type': 'Person', name: 'Hans Kuepper', url: 'https://www.promptquorum.com/about', jobTitle: 'Founder', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      proficiencyLevel: 'Intermediate',
    ...
    sections: {
      ...
      techniques: {
        ...
        items: [
          ...
          '[Prompting few-shot](/prompt-engineering/few-shot-prompting?lang=es): proporcionar varios ejemplos de entrada–salida para anclar el comportamiento.',
      ...
      howPQImplements: {
        ...
        items: [
          'Completar los campos alineados con la guía una sola vez y enviar el prompt resultante a Gemini 3.1 Pro, GPT-4o, Claude Opus 4.7 y modelos locales vía [Ollama](https://ollama.com) o LM Studio en paralelo.',
      ...
      usingWithOthers: {
        ...
        content: [
          '**Debes tratar la Guía de Prompts de Google como un conjunto de técnicas de bajo nivel que funcionan junto con frameworks de alto nivel como [CO-STAR](/prompt-engineering/co-star-prompting-framework?lang=es), SPECS, RISEN y TRACE.** La guía te dice cómo formular las instrucciones; los frameworks te dicen cómo estructurar flujos de trabajo completos.',
          'Un enfoque práctico es:',
        ],
        items: [
          'Usa un framework (por ejemplo, CO-STAR o SPECS) para definir la estructura general de la tarea.',
          'Aplica los principios de prompting de Google dentro de esa estructura: roles explícitos, restricciones claras, [ejemplos few-shot](/prompt-engineering/few-shot-prompting?lang=es) y razonamiento paso a paso cuando sea necesario.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Usa el razonamiento paso a paso para tareas complejas.** Pide al modelo que "piense paso a paso" antes de responder. Esto obliga a la deliberación y detecta errores. Funciona en [Gemini 3.1 Pro](/prompt-engineering/gemini-prompting-guide?lang=es), GPT-4o y Claude Opus 4.7.',
      ...
      faqSection: {
        ...
        faqs: [
          { q: '¿La Guía de Prompts de Google está limitada a Gemini?', a: 'No. Los principios son universales y funcionan igual de bien con GPT-4o, Claude Opus 4.7 y todos los modelos modernos. Gemini es el ejemplo principal, pero las ideas subyacentes son agnósticas al modelo.' },
      ...
      relatedReading: {
        ...
        items: [
          { title: 'Few-Shot Prompting', url: '/prompt-engineering/few-shot-prompting?lang=es' },
          { title: 'Chain-of-Thought Prompting', url: '/prompt-engineering/chain-of-thought-prompting?lang=es' },
          { title: 'Persona Prompting', url: '/prompt-engineering/persona-prompting?lang=es' },
          { title: 'Constrained Prompting', url: '/prompt-engineering/constrained-prompting?lang=es' },
          { title: 'CO-STAR Prompting Framework', url: '/prompt-engineering/co-star-prompting-framework?lang=es' },
          { title: 'Prompt Chaining', url: '/prompt-engineering/prompt-chaining?lang=es' },
          { title: 'Cómo probar prompts en múltiples modelos', url: '/prompt-engineering/how-to-test-prompts-across-models?lang=es' },
          { title: '¿GPT, Claude o Gemini? Cómo elegir el modelo correcto', url: '/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model?lang=es' },
          { title: '¿Qué es la ingeniería de prompts?', url: '/prompt-engineering/what-is-prompt-engineering?lang=es' },
        ],
      },
      google2026Updates: {
        id: 'google-2026-updates',
      ...
      sources: {
        ...
        items: [
          ...
          'Documentación de la API de OpenAI y Anthropic (2026) — Mejores prácticas de ingeniería de prompts para GPT-4o, Claude Opus 4.7 y modelos de código abierto',
