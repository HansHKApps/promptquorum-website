...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  de: {
    ...
    quickFacts: [
      ...
      '**Modellunabhängig:** Funktioniert gleich gut auf Gemini 3,1 Pro, GPT-5.6, Claude Opus 4,7, lokalen Modellen via Ollama',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**Diese Prinzipien funktionieren auf allen modernen Modellen—Gemini 3,1 Pro, GPT-5.6, Claude Opus 4,7 und lokalen Modellen (Ollama, LM Studio).** Sie sind modellunabhängig.',
      ...
      whatIsGoogle: {
        ...
        content: [
          ...
          'In der Praxis funktioniert der Guide wie ein Katalog von Prompt-Rezepten. Jedes Rezept zeigt, wie man Anweisungen formuliert, was zu vermeiden ist und wie man Beispiele hinzufügt, damit das Modellverhalten vorhersagbar wird. Diese Patterns funktionieren nicht nur für Gemini 3,1 Pro, sondern auch für Modelle wie [GPT-5.6](https://openai.com), Claude Opus 4,7 und lokale Modelle wie [Ollama](https://ollama.com), weil die zugrundeliegenden Prinzipien allgemein sind.',
        ],
      },
      corePrinciples: {
        id: 'core-principles',
      ...
      howPQImplements: {
        ...
        items: [
          'Guide-konforme Felder einmal ausfüllen und den resultierenden Prompt an Gemini 3,1 Pro, GPT-5.6, Claude Opus 4,7 und lokale Modelle via [Ollama](https://ollama.com) oder LM Studio parallel senden.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Nutze schrittweise Begründung für komplexe Aufgaben.** Bitte das Modell, „Schritt für Schritt zu denken", bevor es antwortet. Das erzwingt Überlegung und fängt Fehler auf. Funktioniert über [Gemini 3,1 Pro](/de/prompt-engineering/googles-prompting-guide), GPT-5.6 und Claude Opus 4,7.',
      ...
      faqSection: {
        ...
        faqs: [
          { q: 'Ist der Google Prompting Guide nur auf Gemini beschränkt?', a: 'Nein. Die Prinzipien sind universell und funktionieren gleich gut mit GPT-5.6, Claude Opus 4,7 und allen modernen Modellen. Gemini ist das primäre Beispiel, aber die Ideen sind modellunabhängig.' },
      ...
      sources: {
        ...
        items: [
          ...
          'OpenAI & Anthropic API Documentation (2026) — Prompt-Engineering Best Practices über GPT-5.6, Claude Opus 4,7 und Open-Source-Modelle',
  ...
  fr: {
    ...
    sections: {
      ...
      corePrinciples: {
        ...
        content: [
          '**Les principes fondamentaux du Guide Google tournent autour de la clarté, de la contrainte et du raffinement itératif plutôt que des formulations élégantes.** L\'accent est mis sur dire au modèle exactement ce que vous voulez d\'une manière facile à évaluer. En mai 2026, ces principes ont été validés sur Gemini 3.1 Pro, GPT-5.6, Claude Opus 5 et des modèles open-source.',
  ...
  ar: {
    ...
    sections: {
      ...
      corePrinciples: {
        ...
        content: [
          '**تتمحور المبادئ الأساسية لدليل Google للمطالبات حول الوضوح والقيود والصقل التكراري أكثر من الصياغة الذكية.** ينصبّ التركيز على إخبار النموذج بالضبط بما تريد بطريقة سهلة التقييم. اعتباراً من مايو 2026، تم التحقق من هذه المبادئ على Gemini 3.1 Pro وGPT-5.6 وClaude Opus 5 ونماذج المصدر المفتوح.',
  ...
  ko: {
    ...
    sections: {
      ...
      corePrinciples: {
        ...
        content: [
          '**Google 프롬프팅 가이드의 핵심 원칙은 영리한 문구보다 명확성, 제약, 반복적 개선을 중심으로 합니다.** 평가하기 쉬운 방식으로 원하는 것을 모델에 정확히 전달하는 데 중점을 둡니다. 2026년 5월 기준으로 이 원칙들은 Gemini 3.1 Pro, GPT-5.6, Claude Opus 5, 오픈소스 모델에서 검증되었습니다.',
          '공통 주제는 다음과 같습니다:',
        ],
        items: [
