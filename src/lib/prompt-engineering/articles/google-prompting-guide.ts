...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  pt: {
    ...
    schema: {
      ...
      datePublished: '2026-03-24',
      url: 'https://www.promptquorum.com/pt/pt/prompt-engineering/google-prompting-guide',
      inLanguage: 'pt-BR',
  ...
  ar: {
    ...
    twitterDescription: 'أتقن مبادئ Google الخمسة للمطالبات: الوضوح، والقيود، والأمثلة، والأدوار، والبنية. طبّقها على Gemini وGPT-5.5 وClaude والنماذج المحلية للحصول على نتائج متوقعة.',
    educationalLevel: 'Intermediate',
