...
export const article: Partial<Record<Language, PEArticle>> = {
  en: {
    ...
    quickFacts: [
      ...
      '**Model Agnostic:** Works equally well on Gemini 3.1 Pro, GPT-4o, Claude Opus 4.8, local models via Ollama',
    ...
    schema: {
      ...
      inLanguage: 'en',
      keywords: ['Google Prompting Guide', 'prompt best practices', 'prompt engineering', 'Gemini 3.1 Pro', 'GPT-4o', 'Claude Opus 4.8', 'prompt frameworks', 'PromptQuorum'],
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**These principles work across all modern models—Gemini 3.1 Pro, GPT-4o, Claude Opus 4.8, and local models (Ollama, LM Studio).** They\'re model-agnostic.',
      ...
      howPQImplements: {
        ...
        items: [
          'Fill in guide-aligned fields once and send the resulting prompt to Gemini 3.1 Pro, GPT-4o, Claude Opus 4.8, and local models via [Ollama](https://ollama.com) or LM Studio in parallel.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Use step-by-step reasoning for complex tasks.** Ask the model to "think step by step" before answering. This forces deliberation and catches errors. Works across [Gemini 3.1 Pro](/prompt-engineering/gemini-prompting-guide?lang=en), GPT-4o, and Claude Opus 4.8.',
      ...
      faqSection: {
        ...
        faqs: [
          { q: 'Is Google\'s Prompting Guide limited to Gemini?', a: 'No. The principles are universal and work equally well with GPT-4o, Claude Opus 4.8, and all modern models. Gemini is the primary example, but the underlying ideas are model-agnostic.' },
      ...
      sources: {
        ...
        items: [
          ...
          'OpenAI & Anthropic API Documentation (2026) — Prompt engineering best practices across GPT-4o, Claude Opus 4.8, and open-source models',
  ...
  de: {
    ...
    schema: {
      ...
      inLanguage: 'de',
      keywords: ['Google Prompting Guide', 'Prompt Best Practices', 'Prompt Engineering', 'Gemini 3.1 Pro', 'GPT-4o', 'Claude Opus 4.8', 'Frameworks', 'PromptQuorum'],
    ...
    sections: {
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Nutze schrittweise Begründung für komplexe Aufgaben.** Bitte das Modell, „Schritt für Schritt zu denken", bevor es antwortet. Das erzwingt Überlegung und fängt Fehler auf. Funktioniert über [Gemini 3,1 Pro](/de/prompt-engineering/gemini-prompting-guide), GPT-4o und Claude Opus 4,7.',
  ...
  fr: {
    ...
    quickFacts: [
      ...
      '**Indépendant du modèle:** Fonctionne aussi bien sur Gemini 3.1 Pro, GPT-4o, Claude Opus 4.8, modèles locaux via Ollama',
    ...
    schema: {
      ...
      inLanguage: 'fr',
      keywords: ['Guide Google', 'rédaction de prompts', 'prompt engineering', 'Gemini 3.1 Pro', 'GPT-4o', 'Claude Opus 4.8', 'frameworks de prompts', 'PromptQuorum'],
      author: { '@type': 'Person', name: 'Hans Kuepper', url: 'https://www.promptquorum.com/about', jobTitle: 'Founder' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      proficiencyLevel: 'Intermediate',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**Ces principes fonctionnent sur tous les modèles modernes—Gemini 3.1 Pro, GPT-4o, Claude Opus 4.8 et modèles locaux (Ollama, LM Studio).** Ils sont indépendants du modèle.',
      ...
      corePrinciples: {
        ...
        content: [
          '**Les principes fondamentaux du Guide Google tournent autour de la clarté, de la contrainte et du raffinement itératif plutôt que des formulations élégantes.** L\'accent est mis sur dire au modèle exactement ce que vous voulez d\'une manière facile à évaluer. En mai 2026, ces principes ont été validés sur Gemini 3.1 Pro, GPT-4o, Claude Opus 4.8 et des modèles open-source.',
      ...
      howPQImplements: {
        ...
        items: [
          'Remplir les champs alignés au guide une fois et envoyer le prompt résultant à Gemini 3.1 Pro, GPT-4o, Claude Opus 4.8 et modèles locaux via [Ollama](https://ollama.com) ou LM Studio en parallèle.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Utilisez le raisonnement étape par étape pour les tâches complexes.** Demandez au modèle de « penser étape par étape » avant de répondre. Cela force la délibération et attrape les erreurs. Fonctionne sur [Gemini 3.1 Pro](/fr/prompt-engineering/gemini-prompting-guide), GPT-4o et Claude Opus 4.8.',
      ...
      faqSection: {
        ...
        faqs: [
          { q: 'Le Guide Google est-il limité à Gemini ?', a: 'Non. Les principes sont universels et fonctionnent aussi bien avec GPT-4o, Claude Opus 4.8 et tous les modèles modernes. Gemini est l\'exemple principal, mais les idées sous-jacentes sont universelles.' },
      ...
      sources: {
        ...
        items: [
          ...
          'OpenAI & Anthropic API Documentation (2026) — Bonnes pratiques de prompt engineering sur GPT-4o, Claude Opus 4.8 et modèles open-source',
  ...
  ja: {
    ...
    leadAnswerBlock: '**Googleガイドは巧さより明確さを優先します。タスク、オーディエンス、制約を明示的に定義してください。5つの中核原則—明確さ、構造、例、ロール、制約—は、すべての最新モデル（Gemini 3.1 Pro、GPT-4o、Claude Opus 4.8）で機能し、より予測可能で再利用可能なプロンプトを生成します。**',
    quickFacts: [
      '**ソース:** Google DeepMindは、ガイドを研究に基づく最良の実践として公開しました（2024–2026）',
      '**5つの中核原則:** 明確さ、構造、例、ロール、制約（CSERC）',
      '**モデル非依存:** Gemini 3.1 Pro、GPT-4o、Claude Opus 4.8、Ollama経由のローカルモデルで同じ効果があります',
    ...
    schema: {
      ...
      inLanguage: 'ja',
      keywords: ['Googleプロンプトガイド', 'プロンプト作成', 'ベストプラクティス', 'Gemini 3.1 Pro', 'GPT-4o', 'Claude Opus 4.8', 'プロンプトフレームワーク', 'PromptQuorum'],
    ...
    sections: {
      ...
      sources: { id: 'sources', title: 'ソース', items: [
        ...
        'OpenAI & Anthropic API Documentation（2026） — Prompt engineering best practicesアクロスGPT-4o、Claude Opus 4.8、open-sourceモデル',
  ...
  zh: {
    ...
    leadAnswerBlock: '**Google指南优先考虑明确性而非技巧：明确定义任务、受众和约束。5大中核原则—明确性、结构、例子、角色、约束—在所有现代模型（Gemini 3.1 Pro、GPT-4o、Claude Opus 4.8）上有效，生成更可预测、可复用的提示词。**',
    quickFacts: [
      '**来源:** Google DeepMind将指南作为研究支持的最佳实践发布（2024–2026）',
      '**5大中核原则:** 明确性、结构、例子、角色、约束（CSERC）',
      '**模型无关:** 在Gemini 3.1 Pro、GPT-4o、Claude Opus 4.8、Ollama本地模型上同等有效',
    ...
    schema: {
      ...
      inLanguage: 'zh',
      keywords: ['Google提示词指南', '提示词撰写', '最佳实践', 'Gemini 3.1 Pro', 'GPT-4o', 'Claude Opus 4.8', '提示词框架', 'PromptQuorum'],
      author: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      proficiencyLevel: 'Intermediate',
    ...
    sections: {
      tldr: { id: 'key-takeaways', title: '核心要点', isTldr: true, items: ['Google指南将重点放在清晰性而非技巧上：明确定义任务、受众和约束。', '5大中核原则（清晰性、结构、例子、角色、约束）在所有现代模型（Gemini 3.1 Pro、GPT-4o、Claude Opus 4.8）上一致有效。', '明确的约束和示例比冗长说明更有力。写得好的例子值得10行说明。', '角色提示词（"你是…"）引导语气和细节程度，对创意任务特别有用。', '逐步推理（"step-by-step think"）强制结构化思维，减少错误，但增加token使用。', '对于高风险决策多样化输入和模型测试；一个提示词在一个例子上有效不等于在所有情况下有效。', '在PromptQuorum中并排测试所有框架，比较Gemini 3.1 Pro、GPT-4o和Claude Opus 4.8的输出。'] },
      ...
      howPqImplements: { id: 'how-pq-implements', title: 'PromptQuorum如何实现它', content: 'PromptQuorum将Google指南集成为一个内置框架。创建提示词时，用户可选择"Google"模板，工具会：1) 提示输入清晰任务定义、受众和约束；2) 从库生成例子；3) 应用格式规则；4) 跨Gemini 3.1 Pro、GPT-4o和Claude Opus 4.8测试输出。这使Google原则可操作化，不需要用户手动构造提示词。' },
      ...
      howToStart: { id: 'how-to-start', title: '开始使用', numberedItems: ['**明确定义。** 避免模糊。明确说出任务、受众、想要什么。包括任何重要约束。', '**提供例子。** 对于任何涉及风格、格式或复杂判断的任务，包括1–3个输入-输出对。', '**请求结构化思考。** 对于复杂问题，要求模型在回答前"thinking step by step"。', '**定义输出格式。** 说"以JSON/表格/Markdown返回"并给出示范。', '**在PromptQuorum中测试。** 对提示词运行A/B对比；跨Gemini 3.1 Pro、GPT-4o、Claude Opus 4.8测试相同提示词，看哪个模型最一致。'] },
      ...
      sources: { id: 'sources', title: '来源', items: [
        ...
        'OpenAI & Anthropic API文档（2026） — GPT-4o、Claude Opus 4.8、开源模型的提示词工程最佳实践',
  ...
  es: {
    ...
    primaryTerm: 'Google Prompting Guide',
    leadAnswerBlock: '**La Guía de Prompts de Google te enseña a ser explícito sobre la tarea, la audiencia y las restricciones en lugar de depender de que el modelo lo adivine. Los 5 principios clave —claridad, estructura, ejemplos, roles y restricciones— funcionan en todos los modelos modernos (Gemini 3.1 Pro, GPT-4o, Claude Opus 4.8) y producen prompts más predecibles y reutilizables.**',
    quickFacts: [
      ...
      '**Agnóstico al modelo:** Funciona igual de bien en Gemini 3.1 Pro, GPT-4o, Claude Opus 4.8 y modelos locales vía Ollama',
    ...
    schema: {
      ...
      inLanguage: 'es',
      keywords: ['Google Prompting Guide', 'mejores prácticas de prompts', 'ingeniería de prompts', 'Gemini 3.1 Pro', 'GPT-4o', 'Claude Opus 4.8', 'frameworks de prompts', 'PromptQuorum'],
      author: { '@type': 'Person', name: 'Hans Kuepper', url: 'https://www.promptquorum.com/about', jobTitle: 'Founder', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      proficiencyLevel: 'Intermediate',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**Estos principios funcionan en todos los modelos modernos —Gemini 3.1 Pro, GPT-4o, Claude Opus 4.8 y modelos locales (Ollama, LM Studio).** Son agnósticos al modelo.',
      ...
      howPQImplements: {
        ...
        items: [
          'Completar los campos alineados con la guía una sola vez y enviar el prompt resultante a Gemini 3.1 Pro, GPT-4o, Claude Opus 4.8 y modelos locales vía [Ollama](https://ollama.com) o LM Studio en paralelo.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Usa el razonamiento paso a paso para tareas complejas.** Pide al modelo que "piense paso a paso" antes de responder. Esto obliga a la deliberación y detecta errores. Funciona en [Gemini 3.1 Pro](/es/prompt-engineering/gemini-prompting-guide), GPT-4o y Claude Opus 4.8.',
      ...
      faqSection: {
        ...
        faqs: [
          { q: '¿La Guía de Prompts de Google está limitada a Gemini?', a: 'No. Los principios son universales y funcionan igual de bien con GPT-4o, Claude Opus 4.8 y todos los modelos modernos. Gemini es el ejemplo principal, pero las ideas subyacentes son agnósticas al modelo.' },
      ...
      sources: {
        ...
        items: [
          ...
          'Documentación de la API de OpenAI y Anthropic (2026) — Mejores prácticas de ingeniería de prompts para GPT-4o, Claude Opus 4.8 y modelos de código abierto',
