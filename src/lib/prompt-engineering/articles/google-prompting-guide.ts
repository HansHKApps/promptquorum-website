    ...
    sections: {
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Utilisez le raisonnement étape par étape pour les tâches complexes.** Demandez au modèle de « penser étape par étape » avant de répondre. Cela force la délibération et attrape les erreurs. Fonctionne sur [Gemini 3.1 Pro](/fr/prompt-engineering/gemini-prompting-guide), GPT-4o et Claude Opus 4.7.',
    ...
    sections: {
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Usa el razonamiento paso a paso para tareas complejas.** Pide al modelo que "piense paso a paso" antes de responder. Esto obliga a la deliberación y detecta errores. Funciona en [Gemini 3.1 Pro](/es/prompt-engineering/gemini-prompting-guide), GPT-4o y Claude Opus 4.7.',
