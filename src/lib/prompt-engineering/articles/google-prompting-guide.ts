...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    sections: {
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Use step-by-step reasoning for complex tasks.** Ask the model to "think step by step" before answering. This forces deliberation and catches errors. Works across [Gemini 3.1 Pro](/prompt-engineering/gemini-prompting-guide?lang=en), GPT-5.5, and Claude Opus 4.8.',
  ...
  es: {
    ...
    schema: {
      ...
      datePublished: '2026-03-24',
      dateModified: '2026-05-03',
      url: 'https://www.promptquorum.com/es/prompt-engineering/google-prompting-guide?lang=es',
      inLanguage: 'es',
  ...
  pt: {
    ...
    schema: {
      ...
      datePublished: '2026-03-24',
      url: 'https://www.promptquorum.com/pt/prompt-engineering/google-prompting-guide?lang=pt',
      inLanguage: 'pt-BR',
