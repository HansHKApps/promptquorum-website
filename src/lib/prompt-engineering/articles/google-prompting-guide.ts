...
export const article: Partial<Record<Language, PEArticle>> = {
  en: {
    ...
    metaDescription: 'Master Google\'s 5 prompting principles: clarity, constraints, examples, roles, structure. Apply these techniques to Gemini, GPT-5.6, Claude, and local models for predictable outputs.',
    ogTitle: 'Google Prompting Guide: 5 Core Principles + Examples',
    ogDescription: 'Master Google\'s 5 prompting principles: clarity, constraints, examples, roles, structure. Apply these techniques to Gemini, GPT-5.6, Claude, and local models for predictable outputs.',
    twitterTitle: 'Google Prompting Guide: 5 Core Principles + Examples',
    twitterDescription: 'Master Google\'s 5 prompting principles: clarity, constraints, examples, roles, structure. Apply these techniques to Gemini, GPT-5.6, Claude, and local models for predictable outputs.',
    educationalLevel: 'Intermediate',
    audience: 'Developers building with LLMs, prompt engineers, product teams',
    primaryTerm: 'Google Prompting Guide',
    leadAnswerBlock: '**Google\'s Prompting Guide teaches you to be explicit about task, audience, and constraints instead of relying on models to guess. The 5 core principles—clarity, structure, examples, roles, and constraints—work across all modern models (Gemini 3.1 Pro, GPT-5.6, Claude Opus 5) and produce more predictable, reusable prompts.**',
    quickFacts: [
      ...
      '**Model Agnostic:** Works equally well on Gemini 3.1 Pro, GPT-5.6, Claude Opus 5, local models via Ollama',
    ...
    schema: {
      ...
      description: "Master Google's 5 prompting principles: clarity, constraints, examples, roles, structure. Apply these techniques to Gemini, GPT-5.6, Claude, and local models for predictable outputs.",
      datePublished: '2026-03-24',
      dateModified: '2026-08-29',
      url: 'https://www.promptquorum.com/prompt-engineering/google-prompting-guide',
      inLanguage: 'en',
      keywords: ['Google Prompting Guide', 'prompt best practices', 'prompt engineering', 'Gemini 3.1 Pro', 'GPT-5.6', 'Claude Opus 5', 'prompt frameworks', 'PromptQuorum'],
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**These principles work across all modern models—Gemini 3.1 Pro, GPT-5.6, Claude Opus 5, and local models (Ollama, LM Studio).** They\'re model-agnostic.',
          ...
          '**PromptQuorum integrates Google\'s Guide as a reusable framework; fill in fields once and dispatch to Gemini, GPT-5.6, Claude, and local models in parallel.**',
      ...
      howPQImplements: {
        ...
        items: [
          'Fill in guide-aligned fields once and send the resulting prompt to Gemini 3.1 Pro, GPT-5.6, Claude Opus 5, and local models via [Ollama](https://ollama.com) or LM Studio in parallel.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Use step-by-step reasoning for complex tasks.** Ask the model to "think step by step" before answering. This forces deliberation and catches errors. Works across [Gemini 3.1 Pro](/prompt-engineering/googles-prompting-guide), GPT-5.6, and Claude Opus 5.',
      ...
      faqSection: {
        ...
        faqs: [
          { q: 'Is Google\'s Prompting Guide limited to Gemini?', a: 'No. The principles are universal and work equally well with GPT-5.6, Claude Opus 5, and all modern models. Gemini is the primary example, but the underlying ideas are model-agnostic.' },
      ...
      google2026Updates: {
        ...
        items: [
          ...
          '**Gemini Deep Think:** Built-in reasoning mode on Gemini 3.1 Pro (and Claude Opus 5\'s extended thinking, OpenAI\'s o3 reasoning) automates the "step-by-step reasoning" recommendation at the model level. You don\'t need to ask; the model reasons internally.',
      ...
      sources: {
        ...
        items: [
          ...
          'OpenAI & Anthropic API Documentation (2026) — Prompt engineering best practices across GPT-5.6, Claude Opus 5, and open-source models',
  ...
  de: {
    ...
    quickFacts: [
      ...
      '**Modellunabhängig:** Funktioniert gleich gut auf Gemini 3,1 Pro, GPT-5.6, Claude Opus 5, lokalen Modellen via Ollama',
    ...
    schema: {
      ...
      description: 'Beherrsche Googles 5 Prompting-Prinzipien: Klarheit, Struktur, Beispiele, Rollen, Beschränkungen. Auf Gemini, GPT-5.6, Claude und lokalen Modellen.',
      datePublished: '2026-03-24',
      dateModified: '2026-08-29',
      url: 'https://www.promptquorum.com/de/prompt-engineering/google-prompting-guide',
      inLanguage: 'de',
      keywords: ['Google Prompting Guide', 'Prompt Best Practices', 'Prompt Engineering', 'Gemini 3.1 Pro', 'GPT-5.6', 'Claude Opus 5', 'Frameworks', 'PromptQuorum'],
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**Diese Prinzipien funktionieren auf allen modernen Modellen—Gemini 3,1 Pro, GPT-5.6, Claude Opus 5 und lokalen Modellen (Ollama, LM Studio).** Sie sind modellunabhängig.',
          ...
          '**PromptQuorum integriert den Google Guide als wiederverwendbares Framework; füll Felder einmal aus und sende an Gemini, GPT-5.6, Claude und lokale Modelle parallel.**',
      ...
      howPQImplements: {
        ...
        items: [
          'Guide-konforme Felder einmal ausfüllen und den resultierenden Prompt an Gemini 3,1 Pro, GPT-5.6, Claude Opus 5 und lokale Modelle via [Ollama](https://ollama.com) oder LM Studio parallel senden.',
      ...
      google2026Updates: {
        ...
        items: [
          ...
          '**Gemini Deep Think:** Built-in Reasoning-Mode auf Gemini 3,1 Pro (und Claude Opus 5\'s Extended Thinking, OpenAI\'s o3 Reasoning) automatisiert die Empfehlung „schrittweise Begründung" auf Model-Level. Du musst nicht fragen; das Modell begründet intern.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Nutze schrittweise Begründung für komplexe Aufgaben.** Bitte das Modell, „Schritt für Schritt zu denken", bevor es antwortet. Das erzwingt Überlegung und fängt Fehler auf. Funktioniert über [Gemini 3,1 Pro](/de/prompt-engineering/googles-prompting-guide), GPT-5.6 und Claude Opus 5.',
      ...
      faqSection: {
        ...
        faqs: [
          { q: 'Ist der Google Prompting Guide nur auf Gemini beschränkt?', a: 'Nein. Die Prinzipien sind universell und funktionieren gleich gut mit GPT-5.6, Claude Opus 5 und allen modernen Modellen. Gemini ist das primäre Beispiel, aber die Ideen sind modellunabhängig.' },
      ...
      sources: {
        ...
        items: [
          ...
          'OpenAI & Anthropic API Documentation (2026) — Prompt-Engineering Best Practices über GPT-5.6, Claude Opus 5 und Open-Source-Modelle',
  ...
  fr: {
    ...
    metaDescription: 'Maîtrisez les 5 principes Google : clarté, structure, exemples, rôles, contraintes. Appliquez sur Gemini, GPT-5.6, Claude et modèles locaux pour des outputs prévisibles.',
    educationalLevel: 'Intermediate',
    ...
    quickFacts: [
      ...
      '**Indépendant du modèle:** Fonctionne aussi bien sur Gemini 3.1 Pro, GPT-5.6, Claude Opus 5, modèles locaux via Ollama',
    ...
    schema: {
      ...
      description: 'Maîtrisez les 5 principes Google : clarté, structure, exemples, rôles, contraintes. Appliquez sur Gemini, GPT-5.6, Claude et modèles locaux pour des outputs prévisibles.',
      datePublished: '2026-03-24',
      dateModified: '2026-08-29',
      url: 'https://www.promptquorum.com/fr/prompt-engineering/google-prompting-guide',
      inLanguage: 'fr',
      keywords: ['Guide Google', 'rédaction de prompts', 'prompt engineering', 'Gemini 3.1 Pro', 'GPT-5.6', 'Claude Opus 5', 'frameworks de prompts', 'PromptQuorum'],
      author: { '@type': 'Person', name: 'Hans Kuepper', url: 'https://www.promptquorum.com/about', jobTitle: 'Founder' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      proficiencyLevel: 'Intermediate',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**Ces principes fonctionnent sur tous les modèles modernes—Gemini 3.1 Pro, GPT-5.6, Claude Opus 5 et modèles locaux (Ollama, LM Studio).** Ils sont indépendants du modèle.',
          ...
          '**PromptQuorum intègre le Guide Google comme framework réutilisable; remplissez les champs une fois et envoyez à Gemini, GPT-5.6, Claude et modèles locaux en parallèle.**',
      ...
      corePrinciples: {
        ...
        content: [
          '**Les principes fondamentaux du Guide Google tournent autour de la clarté, de la contrainte et du raffinement itératif plutôt que des formulations élégantes.** L\'accent est mis sur dire au modèle exactement ce que vous voulez d\'une manière facile à évaluer. Ces principes sont validés sur Gemini 3.1 Pro, GPT-5.6, Claude Opus 5 et des modèles open-source.',
      ...
      howPQImplements: {
        ...
        items: [
          'Remplir les champs alignés au guide une fois et envoyer le prompt résultant à Gemini 3.1 Pro, GPT-5.6, Claude Opus 5 et modèles locaux via [Ollama](https://ollama.com) ou LM Studio en parallèle.',
      ...
      google2026Updates: {
        ...
        items: [
          ...
          '**Gemini Deep Think:** Le mode raisonnement intégré sur Gemini 3.1 Pro (et l\'extended thinking de Claude Opus 5, le reasoning d\'OpenAI o3) automatise la recommandation « raisonnement étape par étape » au niveau du modèle. Vous n\'avez pas besoin de demander; le modèle raisonne en interne.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Utilisez le raisonnement étape par étape pour les tâches complexes.** Demandez au modèle de « penser étape par étape » avant de répondre. Cela force la délibération et attrape les erreurs. Fonctionne sur [Gemini 3.1 Pro](/fr/prompt-engineering/googles-prompting-guide), GPT-5.6 et Claude Opus 5.',
        ...
        callouts: [
          { type: 'warning', label: 'Avertissement: Coûts en Tokens', text: 'Les exemples few-shot et les instructions détaillées de rôle ajoutent des tokens. Cinq exemples de 200 mots = ~1500 tokens avant que votre tâche n\'arrive. Sur Gemini à $2/1M input tokens, cela coûte des fractions de cent. Sur Claude Opus 5 à $5/1M, cela s\'additionne en volume. Utilisez le context caching de Gemini pour les prompts few-shot lourds pour réduire les coûts.' },
        ],
      },
      faqSection: {
        id: 'faq',
        ...
        faqs: [
          { q: 'Le Guide Google est-il limité à Gemini ?', a: 'Non. Les principes sont universels et fonctionnent aussi bien avec GPT-5.6, Claude Opus 5 et tous les modèles modernes. Gemini est l\'exemple principal, mais les idées sous-jacentes sont universelles.' },
      ...
      sources: {
        ...
        items: [
          ...
          'OpenAI & Anthropic API Documentation (2026) — Bonnes pratiques de prompt engineering sur GPT-5.6, Claude Opus 5 et modèles open-source',
  ...
  ja: {
    ...
    metaDescription: 'Googleの5つの原則を習得：明確さ・構造・例・ロール・制約。Gemini、GPT-5.6、Claude、ローカルモデルで実践します。',
    educationalLevel: 'Intermediate',
    audience: 'LLMsと協働する開発者、プロンプトエンジニア、プロダクトチーム',
    primaryTerm: 'Googleプロンプト作成ガイド',
    leadAnswerBlock: '**Googleガイドは巧さより明確さを優先します。タスク、オーディエンス、制約を明示的に定義してください。5つの中核原則—明確さ、構造、例、ロール、制約—は、すべての最新モデル（Gemini 3.1 Pro、GPT-5.6、Claude Opus 5）で機能し、より予測可能で再利用可能なプロンプトを生成します。**',
    quickFacts: [
      '**ソース:** Google DeepMindは、ガイドを研究に基づく最良の実践として公開しました（2024–2026）',
      '**5つの中核原則:** 明確さ、構造、例、ロール、制約（CSERC）',
      '**モデル非依存:** Gemini 3.1 Pro、GPT-5.6、Claude Opus 5、Ollama経由のローカルモデルで同じ効果があります',
    ...
    schema: {
      ...
      description: 'Googleの5つの原則を習得：明確さ・構造・例・ロール・制約。Gemini、GPT-5.6、Claude、ローカルモデルで実践します。',
      datePublished: '2026-03-24',
      dateModified: '2026-08-29',
      url: 'https://www.promptquorum.com/ja/prompt-engineering/google-prompting-guide',
      inLanguage: 'ja',
      keywords: ['Googleプロンプトガイド', 'プロンプト作成', 'ベストプラクティス', 'Gemini 3.1 Pro', 'GPT-5.6', 'Claude Opus 5', 'プロンプトフレームワーク', 'PromptQuorum'],
    ...
    sections: {
      tldr: { id: 'key-takeaways', isTldr: true, title: '重要ポイント', items: ['**Googleガイドは明確さ、構造、明示的な制約を優先します。**タスク、オーディエンス、出力フォーマット、安全ルールを定めます。', '**5つの中核原則は: 明確さ（正確に求めること）、例（説明より実例）、ロール（専門知識を割り当て）、制約（境界を設定）、構造（タスク分解）です。**', '**これらの原則は全モダンモデル—Gemini 3.1 Pro、GPT-5.6、Claude Opus 5、ローカルモデル（Ollama、LM Studio）で機能します。** モデル非依存です。', '**Googleガイドは低レベルの技術フレームワークで、CO-STAR、SPECS、RISEN、TRACEなどの高レベルフレームワークと組み合わせて使う設計です。** その代わりではなく、中に使用してください。', '**Googleガイドの構造化プロンプトは入力トークンの10–20%を追加しますが、エラー率を40–60%削減し、全体コストを低下させます。**', '**PromptQuorumはGoogleガイドを再利用可能フレームワークとして統合。フィールドを一度埋めて、Gemini、GPT-5.6、Claude、ローカルモデルへ並列送信。**', '**Googleガイドをfew-shot例、段階的推論、明示的な出力フォーマットと組み合わせ、モデル動作を最大コントロール。**'] },
      whatIsGoogle: { id: 'what-is-google', title: 'Googleプロンプト作成ガイドとは', content: ['**Googleプロンプト作成ガイドはGeminiと他の大規模言語モデルをpromptするパターンと最良実践の集合です。巧さではなく、明確さ、構造、安全性に焦点を合わせます。** ガイドはGoogle DeepMindの研究を、専門家以外でも従えるルールに翻訳します。ロール定義、コンテキスト提供、出力制約、推論・コーディング・データ抽出などのタスク処理をカバー。', '実務では、ガイドはpromptレシピの検索ツール。各レシピは指示の言い方、避けるべきことを示し、例を追加してモデル動作を予測可能にします。これらパターンはGemini 3.1 Proだけでなく、[GPT-5.6](https://openai.com)、Claude Opus 5、[Ollama](https://ollama.com)などのローカルモデルでも有効です。基礎となる考え方が一般的だから。'] },
      corePrinciples: { id: 'core-principles', title: '中核原則', content: ['**Googleガイドの中核原則は明確さ、制約、反復的改善を中心に回ります。巧い言い方ではなく。** 重点は、モデルに評価しやすい方法で求めることにあります。これら原則はGemini 3.1 Pro、GPT-5.6、Claude Opus 5、オープンソースモデルで検証済み。', 'よくあるテーマ:'], items: ['タスク、オーディエンス、出力フォーマットについて明示的。モデルに推測させるな。', '可能なら代表的な例を提供。モデルがパターンを真似できるように。', '複雑なタスクをステップに分割し、答える前に推論をもとめる。', '明確な安全・品質の制約を使用—禁止内容、引用要件、長さ制限など。'], callouts: [{ type: 'pro-tip', label: 'Pro Tip', text: 'Googleガイドからの最単一影響力のある技術はfew-shot例です。PromptQuorum測定では、promptへの2–3例追加で、全モデルでフォーマットエラーが50%以上削減。時間が一つの技術だけなら、例に投資してください。' }] },
      ...
      sources: { id: 'sources', title: 'ソース', items: [
        ...
        'OpenAI & Anthropic API Documentation（2026） — Prompt engineering best practicesアクロスGPT-5.6、Claude Opus 5、open-sourceモデル',
  ...
  zh: {
    ...
    intro: 'Google提示词撰写指南是Google DeepMind汇总的实用原则集，教你如何清晰、结构化地指示AI模型。这些原则对Gemini 3.1 Pro、GPT-5.6、Claude都同样有效。PromptQuorum已将此指南集成为框架，所有用户可直接使用。',
    publishDate: '2026-03-24',
    dateModified: '2026-08-29',
    readTime: '阅读约9分钟',
    seoTitle: 'Google提示词指南：5大核心原则',
    metaDescription: '掌握Google 5大提示词原则：明确性、结构、例子、角色、约束。在Gemini、GPT-5.6、Claude和本地模型上实践。',
    educationalLevel: 'Intermediate',
    audience: '与LLMs协作的开发者、提示词工程师、产品团队',
    primaryTerm: 'Google提示词撰写指南',
    leadAnswerBlock: '**Google指南优先考虑明确性而非技巧：明确定义任务、受众和约束。5大中核原则—明确性、结构、例子、角色、约束—在所有现代模型（Gemini 3.1 Pro、GPT-5.6、Claude Opus 5）上有效，生成更可预测、可复用的提示词。**',
    quickFacts: [
      '**来源:** Google DeepMind将指南作为研究支持的最佳实践发布（2024–2026）',
      '**5大中核原则:** 明确性、结构、例子、角色、约束（CSERC）',
      '**模型无关:** 在Gemini 3.1 Pro、GPT-5.6、Claude Opus 5、Ollama本地模型上同等有效',
    ...
    schema: {
      ...
      description: '掌握Google 5大提示词原则：明确性、结构、例子、角色、约束。在Gemini、GPT-5.6、Claude和本地模型上实践。',
      datePublished: '2026-03-24',
      dateModified: '2026-08-29',
      url: 'https://www.promptquorum.com/zh/prompt-engineering/google-prompting-guide',
      inLanguage: 'zh',
      keywords: ['Google提示词指南', '提示词撰写', '最佳实践', 'Gemini 3.1 Pro', 'GPT-5.6', 'Claude Opus 5', '提示词框架', 'PromptQuorum'],
      author: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      proficiencyLevel: 'Intermediate',
    ...
    sections: {
      tldr: { id: 'key-takeaways', title: '核心要点', isTldr: true, items: ['Google指南将重点放在清晰性而非技巧上：明确定义任务、受众和约束。', '5大中核原则（清晰性、结构、例子、角色、约束）在所有现代模型（Gemini 3.1 Pro、GPT-5.6、Claude Opus 5）上一致有效。', '明确的约束和示例比冗长说明更有力。写得好的例子值得10行说明。', '角色提示词（"你是…"）引导语气和细节程度，对创意任务特别有用。', '逐步推理（"step-by-step think"）强制结构化思维，减少错误，但增加token使用。', '对于高风险决策多样化输入和模型测试；一个提示词在一个例子上有效不等于在所有情况下有效。', '在PromptQuorum中并排测试所有框架，比较Gemini 3.1 Pro、GPT-5.6和Claude Opus 5的输出。'] },
      whatIsGoogle: { id: 'what-is-google', title: 'Google提示词撰写指南是什么', content: 'Google提示词撰写指南是Google DeepMind开发的一套实用原则，用于撰写更有效的提示词。这个框架经过数千次模型交互的研究得出，旨在提高清晰度、一致性和输出质量。指南不特定于Gemini——原则对GPT-5.6、Claude和所有现代LLM同样适用。' },
      ...
      howPqImplements: { id: 'how-pq-implements', title: 'PromptQuorum如何实现它', content: 'PromptQuorum将Google指南集成为一个内置框架。创建提示词时，用户可选择"Google"模板，工具会：1) 提示输入清晰任务定义、受众和约束；2) 从库生成例子；3) 应用格式规则；4) 跨Gemini 3.1 Pro、GPT-5.6和Claude Opus 5测试输出。这使Google原则可操作化，不需要用户手动构造提示词。' },
      ...
      howToStart: { id: 'how-to-start', title: '开始使用', numberedItems: ['**明确定义。** 避免模糊。明确说出任务、受众、想要什么。包括任何重要约束。', '**提供例子。** 对于任何涉及风格、格式或复杂判断的任务，包括1–3个输入-输出对。', '**请求结构化思考。** 对于复杂问题，要求模型在回答前"thinking step by step"。', '**定义输出格式。** 说"以JSON/表格/Markdown返回"并给出示范。', '**在PromptQuorum中测试。** 对提示词运行A/B对比；跨Gemini 3.1 Pro、GPT-5.6、Claude Opus 5测试相同提示词，看哪个模型最一致。'] },
      faqSection: { id: 'faq', title: '常见问题解答', faqs: [
        { q: 'Google指南只适用于Gemini吗？', a: '不是。原则是通用的，对GPT-5.6、Claude和所有现代模型都同样有效。Gemini是主要例子，但核心思想是普遍的。' },
      ...
      sources: { id: 'sources', title: '来源', items: [
        ...
        'OpenAI & Anthropic API文档（2026） — GPT-5.6、Claude Opus 5、开源模型的提示词工程最佳实践',
  ...
  es: {
    ...
    metaDescription: 'Domina los 5 principios de prompts de Google: claridad, restricciones, ejemplos, roles y estructura. Aplícalos en Gemini, GPT-5.6, Claude y modelos locales.',
    ogTitle: 'Guía de Prompts de Google: 5 Principios Clave + Ejemplos',
    ogDescription: 'Domina los 5 principios de prompts de Google: claridad, restricciones, ejemplos, roles, estructura. Aplícalos en Gemini, GPT-5.6, Claude y modelos locales para resultados predecibles.',
    twitterTitle: 'Guía de Prompts de Google: 5 Principios Clave + Ejemplos',
    twitterDescription: 'Domina los 5 principios de prompts de Google: claridad, restricciones, ejemplos, roles, estructura. Aplícalos en Gemini, GPT-5.6, Claude y modelos locales para resultados predecibles.',
    educationalLevel: 'Intermediate',
    audience: 'Desarrolladores que trabajan con LLMs, ingenieros de prompts, equipos de producto',
    primaryTerm: 'Google Prompting Guide',
    leadAnswerBlock: '**La Guía de Prompts de Google te enseña a ser explícito sobre la tarea, la audiencia y las restricciones en lugar de depender de que el modelo lo adivine. Los 5 principios clave —claridad, estructura, ejemplos, roles y restricciones— funcionan en todos los modelos modernos (Gemini 3.1 Pro, GPT-5.6, Claude Opus 5) y producen prompts más predecibles y reutilizables.**',
    quickFacts: [
      ...
      '**Agnóstico al modelo:** Funciona igual de bien en Gemini 3.1 Pro, GPT-5.6, Claude Opus 5 y modelos locales vía Ollama',
    ...
    schema: {
      ...
      description: "Domina los 5 principios de prompts de Google: claridad, restricciones, ejemplos, roles, estructura. Aplícalos en Gemini, GPT-5.6, Claude y modelos locales para resultados predecibles.",
      datePublished: '2026-03-24',
      dateModified: '2026-08-29',
      url: 'https://www.promptquorum.com/es/prompt-engineering/google-prompting-guide',
      inLanguage: 'es',
      keywords: ['Google Prompting Guide', 'mejores prácticas de prompts', 'ingeniería de prompts', 'Gemini 3.1 Pro', 'GPT-5.6', 'Claude Opus 5', 'frameworks de prompts', 'PromptQuorum'],
      author: { '@type': 'Person', name: 'Hans Kuepper', url: 'https://www.promptquorum.com/about', jobTitle: 'Founder', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      proficiencyLevel: 'Intermediate',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**Estos principios funcionan en todos los modelos modernos —Gemini 3.1 Pro, GPT-5.6, Claude Opus 5 y modelos locales (Ollama, LM Studio).** Son agnósticos al modelo.',
          ...
          '**PromptQuorum integra la Guía de Google como un framework reutilizable; completa los campos una vez y envía el resultado a Gemini, GPT-5.6, Claude y modelos locales en paralelo.**',
      ...
      corePrinciples: {
        ...
        content: [
          '**Los principios clave de la Guía de Prompts de Google giran en torno a la claridad, las restricciones y el refinamiento iterativo más que a la formulación ingeniosa.** El énfasis está en decirle al modelo exactamente lo que quieres de una manera que sea fácil de evaluar. Estos principios están validados en Gemini 3.1 Pro, GPT-5.6, Claude Opus 5 y modelos de código abierto.',
      ...
      howPQImplements: {
        ...
        items: [
          'Completar los campos alineados con la guía una sola vez y enviar el prompt resultante a Gemini 3.1 Pro, GPT-5.6, Claude Opus 5 y modelos locales vía [Ollama](https://ollama.com) o LM Studio en paralelo.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Usa el razonamiento paso a paso para tareas complejas.** Pide al modelo que "piense paso a paso" antes de responder. Esto obliga a la deliberación y detecta errores. Funciona en [Gemini 3.1 Pro](/es/prompt-engineering/googles-prompting-guide), GPT-5.6 y Claude Opus 5.',
      ...
      faqSection: {
        ...
        faqs: [
          { q: '¿La Guía de Prompts de Google está limitada a Gemini?', a: 'No. Los principios son universales y funcionan igual de bien con GPT-5.6, Claude Opus 5 y todos los modelos modernos. Gemini es el ejemplo principal, pero las ideas subyacentes son agnósticas al modelo.' },
      ...
      google2026Updates: {
        ...
        items: [
          ...
          '**Gemini Deep Think:** El modo de razonamiento integrado en Gemini 3.1 Pro (y el pensamiento extendido de Claude Opus 5, el razonamiento o3 de OpenAI) automatiza la recomendación de "razonamiento paso a paso" a nivel del modelo. No necesitas pedirlo; el modelo razona internamente.',
      ...
      sources: {
        ...
        items: [
          ...
          'Documentación de la API de OpenAI y Anthropic (2026) — Mejores prácticas de ingeniería de prompts para GPT-5.6, Claude Opus 5 y modelos de código abierto',
  ...
  pt: {
    ...
    metaDescription: 'Domine os 5 princípios de prompts do Google: clareza, restrições, exemplos, papéis, estrutura. Aplique-os no Gemini, GPT-5.6, Claude e modelos locais.',
    ogTitle: 'Guia de Prompts do Google: 5 Princípios Fundamentais + Exemplos',
    ogDescription: 'Domine os 5 princípios de prompts do Google: clareza, restrições, exemplos, papéis, estrutura. Aplique-os no Gemini, GPT-5.6, Claude e modelos locais para resultados previsíveis.',
    twitterTitle: 'Guia de Prompts do Google: 5 Princípios Fundamentais + Exemplos',
    twitterDescription: 'Domine os 5 princípios de prompts do Google: clareza, restrições, exemplos, papéis, estrutura. Aplique-os no Gemini, GPT-5.6, Claude e modelos locais para resultados previsíveis.',
    educationalLevel: 'Intermediate',
    audience: 'Desenvolvedores que trabalham com LLMs, engenheiros de prompts, equipes de produto',
    primaryTerm: 'Google Prompting Guide',
    leadAnswerBlock: '**O Guia de Prompts do Google ensina você a ser explícito sobre a tarefa, o público e as restrições em vez de depender de que o modelo adivinhe. Os 5 princípios fundamentais — clareza, estrutura, exemplos, papéis e restrições — funcionam em todos os modelos modernos (Gemini 3.1 Pro, GPT-5.6, Claude Opus 5) e produzem prompts mais previsíveis e reutilizáveis.**',
    quickFacts: [
      ...
      '**Agnóstico ao modelo:** Funciona igualmente bem no Gemini 3.1 Pro, GPT-5.6, Claude Opus 5 e modelos locais via Ollama',
    ...
    schema: {
      ...
      description: 'Domine os 5 princípios de prompts do Google: clareza, restrições, exemplos, papéis, estrutura. Aplique-os no Gemini, GPT-5.6, Claude e modelos locais para resultados previsíveis.',
      datePublished: '2026-03-24',
      dateModified: '2026-08-29',
      url: 'https://www.promptquorum.com/pt/prompt-engineering/google-prompting-guide',
      inLanguage: 'pt-BR',
      keywords: ['Google Prompting Guide', 'melhores práticas de prompts', 'engenharia de prompts', 'Gemini 3.1 Pro', 'GPT-5.6', 'Claude Opus 5', 'frameworks de prompts', 'PromptQuorum'],
      author: { '@type': 'Person', name: 'Hans Kuepper', url: 'https://www.promptquorum.com/about', jobTitle: 'Founder', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      proficiencyLevel: 'Intermediate',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**Esses princípios funcionam em todos os modelos modernos — Gemini 3.1 Pro, GPT-5.6, Claude Opus 5 e modelos locais (Ollama, LM Studio).** São agnósticos ao modelo.',
          ...
          '**O PromptQuorum integra o Guia do Google como um framework reutilizável; preencha os campos uma vez e envie para o Gemini, GPT-5.6, Claude e modelos locais em paralelo.**',
      ...
      howPQImplements: {
        ...
        items: [
          'Preencher os campos alinhados ao guia uma vez e enviar o prompt resultante para o Gemini 3.1 Pro, GPT-5.6, Claude Opus 5 e modelos locais via [Ollama](https://ollama.com) ou LM Studio em paralelo.',
      ...
      usingWithOthers: {
        ...
        callouts: [
          { type: 'did-you-know', label: 'Você sabia?', text: 'O Guia de Prompts do Google recomenda explicitamente testes multi-modelo. A própria documentação do guia observa que o comportamento do prompt varia entre famílias de modelos — que é exatamente o que o PromptQuorum permite com seu despacho multi-modelo. Teste seus prompts no estilo Google no Gemini 3.1 Pro, GPT-5.6 e Claude Opus 5 para garantir comportamento consistente.' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**Use raciocínio passo a passo para tarefas complexas.** Peça ao modelo para "pensar passo a passo" antes de responder. Isso força a deliberação e detecta erros. Funciona no [Gemini 3.1 Pro](/pt/prompt-engineering/googles-prompting-guide), GPT-5.6 e Claude Opus 5.',
        ...
        callouts: [
          { type: 'warning', label: 'Aviso: Custo em tokens', text: 'Exemplos few-shot e instruções de papel detalhadas adicionam tokens. Cinco exemplos de 200 palavras = ~1.500 tokens antes de sua tarefa chegar. No Gemini a $2/1M de tokens de entrada, isso custa frações de centavo. No Claude Opus 5 a $5/1M, acumula em volume. Use o cache de contexto do Gemini para prompts com muitos exemplos few-shot para reduzir custos.' },
        ],
      },
      faqSection: {
        id: 'faq',
        ...
        faqs: [
          { q: 'O Guia de Prompts do Google está limitado ao Gemini?', a: 'Não. Os princípios são universais e funcionam igualmente bem com GPT-5.6, Claude Opus 5 e todos os modelos modernos. O Gemini é o exemplo principal, mas as ideias subjacentes são agnósticas ao modelo.' },
      ...
      google2026Updates: {
        ...
        items: [
          ...
          '**Gemini Deep Think:** O modo de raciocínio integrado no Gemini 3.1 Pro (e o pensamento estendido do Claude Opus 5, o raciocínio o3 da OpenAI) automatiza a recomendação de "raciocínio passo a passo" a nível do modelo. Você não precisa pedir; o modelo raciocina internamente.',
      ...
      sources: {
        ...
        items: [
          ...
          'Documentação da API da OpenAI e da Anthropic (2026) — Melhores práticas de engenharia de prompts para GPT-5.6, Claude Opus 5 e modelos de código aberto',
  ...
  ar: {
    ...
    metaDescription: '⁨5⁩ مبادئ من ⁨Google⁩ (وضوح، بنية، أمثلة، أدوار، قيود) تُقلّل أخطاء النماذج ⁨40⁩–⁨60%⁩. طبّقها على ⁨Gemini⁩ و⁨GPT-5.6⁩ و⁨Claude⁩ والنماذج المحلية.',
    ogTitle: 'دليل Google للمطالبات: 5 مبادئ أساسية + أمثلة',
    ogDescription: 'أتقن مبادئ Google الخمسة للمطالبات: الوضوح، والقيود، والأمثلة، والأدوار، والبنية. طبّقها على Gemini وGPT-5.6 وClaude والنماذج المحلية للحصول على نتائج متوقعة.',
    twitterTitle: 'دليل Google للمطالبات: 5 مبادئ أساسية + أمثلة',
    twitterDescription: 'أتقن مبادئ ⁨Google⁩ الخمسة للمطالبات: الوضوح، والقيود، والأمثلة، والأدوار، والبنية. طبّقها على ⁨Gemini⁩ و⁨GPT-5.6⁩ و⁨Claude⁩ والنماذج المحلية للحصول على نتائج متوقعة.',
    educationalLevel: 'Intermediate',
    audience: 'المطورون الذين يعملون مع LLMs، ومهندسو المطالبات، وفرق المنتج',
    primaryTerm: 'Google Prompting Guide',
    leadAnswerBlock: '**يُعلّمك دليل Google للمطالبات أن تكون صريحاً بشأن المهمة والجمهور والقيود، بدلاً من الاعتماد على النموذج لاستنتاجها. المبادئ الخمسة الأساسية — الوضوح، والبنية، والأمثلة، والأدوار، والقيود — تعمل على جميع النماذج الحديثة (Gemini 3.1 Pro، وGPT-5.6، وClaude Opus 5) وتُنتج مطالبات أكثر توقعاً وقابليةً لإعادة الاستخدام.**',
    quickFacts: [
      ...
      '**مستقل عن النماذج:** يعمل بكفاءة متساوية على Gemini 3.1 Pro وGPT-5.6 وClaude Opus 5 والنماذج المحلية عبر Ollama',
    ...
    schema: {
      ...
      description: 'أتقن مبادئ Google الخمسة للمطالبات: الوضوح، والقيود، والأمثلة، والأدوار، والبنية. طبّقها على Gemini وGPT-5.6 وClaude والنماذج المحلية للحصول على نتائج متوقعة.',
      datePublished: '2026-03-24',
      dateModified: '2026-08-29',
      url: 'https://www.promptquorum.com/ar/prompt-engineering/google-prompting-guide',
      inLanguage: 'ar',
      keywords: ['Google Prompting Guide', 'أفضل ممارسات المطالبات', 'هندسة المطالبات', 'Gemini 3.1 Pro', 'GPT-5.6', 'Claude Opus 5', 'أطر عمل المطالبات', 'PromptQuorum'],
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**تعمل هذه المبادئ على جميع النماذج الحديثة — Gemini 3.1 Pro وGPT-5.6 وClaude Opus 5 والنماذج المحلية (Ollama وLM Studio).** وهي مستقلة عن النماذج.',
          ...
          '**يُدمج PromptQuorum دليل Google بوصفه إطار عمل قابلاً لإعادة الاستخدام؛ أدخِل الحقول مرة واحدة وأرسِل النتيجة إلى Gemini وGPT-5.6 وClaude والنماذج المحلية بالتوازي.**',
      ...
      corePrinciples: {
        ...
        content: [
          '**تتمحور المبادئ الأساسية لدليل Google للمطالبات حول الوضوح والقيود والصقل التكراري أكثر من الصياغة الذكية.** ينصبّ التركيز على إخبار النموذج بالضبط بما تريد بطريقة سهلة التقييم. تم التحقق من هذه المبادئ على Gemini 3.1 Pro وGPT-5.6 وClaude Opus 5 ونماذج المصدر المفتوح.',
      ...
      howPQImplements: {
        ...
        items: [
          'تعبئة الحقول المنسجمة مع الدليل مرة واحدة وإرسال المطالبة الناتجة إلى Gemini 3.1 Pro وGPT-5.6 وClaude Opus 5 والنماذج المحلية عبر [Ollama](https://ollama.com) أو LM Studio بالتوازي.',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          '**استخدم التفكير خطوة بخطوة للمهام المعقدة.** اطلب من النموذج "التفكير خطوة بخطوة" قبل الإجابة. هذا يُجبر على التأمل ويكشف الأخطاء. يعمل مع [Gemini 3.1 Pro](/ar/prompt-engineering/googles-prompting-guide) وGPT-5.6 وClaude Opus 5.',
        ...
        callouts: [
          { type: 'warning', label: 'تحذير: تكلفة الرموز', text: 'تُضيف أمثلة few-shot وتعليمات الدور المفصّلة رموزاً. خمسة أمثلة من 200 كلمة = ~1500 رمز قبل وصول مهمتك. على Gemini بسعر 2 دولار لكل مليون رمز إدخال، يكلف هذا أجزاءً من السنت. على Claude Opus 5 بسعر 5 دولارات لكل مليون، يتراكم بحجم كبير. استخدم تخزين السياق المؤقت في Gemini للمطالبات الغنية بأمثلة few-shot لخفض التكاليف.' },
        ],
      },
      faqSection: {
        id: 'faq',
        ...
        faqs: [
          { q: 'هل دليل Google للمطالبات مقتصر على Gemini؟', a: 'لا. المبادئ عالمية وتعمل بنفس الكفاءة مع GPT-5.6 وClaude Opus 5 وجميع النماذج الحديثة. Gemini هو المثال الرئيسي، لكن الأفكار الأساسية مستقلة عن النماذج.' },
      ...
      google2026Updates: {
        ...
        items: [
          ...
          '**Gemini Deep Think:** يُؤتمت وضع التفكير المدمج في Gemini 3.1 Pro (والتفكير الموسّع في Claude Opus 5، واستدلال o3 في OpenAI) توصيةَ "التفكير خطوة بخطوة" على مستوى النموذج. لا تحتاج إلى طلبه؛ يُفكّر النموذج داخلياً.',
      ...
      sources: {
        ...
        items: [
          ...
          'وثائق OpenAI وAnthropic API (2026) — أفضل ممارسات هندسة المطالبات لـ GPT-5.6 وClaude Opus 5 والنماذج مفتوحة المصدر',
  ...
  ko: {
    ...
    metaDescription: 'Google의 5가지 프롬프팅 원칙(명확성, 제약, 예시, 역할, 구조)을 마스터하십시오. Gemini, GPT-5.6, Claude 및 로컬 모델에 적용하여 예측 가능한 출력을 얻으십시오.',
    ogTitle: 'Google 프롬프팅 가이드: 5가지 핵심 원칙 + 예시',
    ogDescription: 'Google의 5가지 프롬프팅 원칙(명확성, 제약, 예시, 역할, 구조)을 마스터하십시오. Gemini, GPT-5.6, Claude 및 로컬 모델에 적용하여 예측 가능한 출력을 얻으십시오.',
    twitterTitle: 'Google 프롬프팅 가이드: 5가지 핵심 원칙 + 예시',
    twitterDescription: 'Google의 5가지 프롬프팅 원칙(명확성, 제약, 예시, 역할, 구조)을 마스터하십시오. Gemini, GPT-5.6, Claude 및 로컬 모델에 적용하여 예측 가능한 출력을 얻으십시오.',
    educationalLevel: 'Intermediate',
    audience: 'LLM을 활용하는 개발자, 프롬프트 엔지니어, 제품 팀',
    primaryTerm: 'Google 프롬프팅 가이드',
    leadAnswerBlock: '**Google 프롬프팅 가이드는 모델이 추측에 의존하는 대신 태스크, 대상 독자, 제약을 명시적으로 정의하도록 가르칩니다. 5가지 핵심 원칙—명확성, 구조, 예시, 역할, 제약—은 모든 최신 모델(Gemini 3.1 Pro, GPT-5.6, Claude Opus 5)에서 작동하며, 더욱 예측 가능하고 재사용 가능한 프롬프트를 생성합니다.**',
    quickFacts: [
      ...
      '**모델 비종속적:** Gemini 3.1 Pro, GPT-5.6, Claude Opus 5, Ollama를 통한 로컬 모델에서 동일하게 작동합니다',
    ...
    schema: {
      ...
      description: 'Google의 5가지 프롬프팅 원칙(명확성, 제약, 예시, 역할, 구조)을 마스터하십시오. Gemini, GPT-5.6, Claude 및 로컬 모델에 적용하여 예측 가능한 출력을 얻으십시오.',
      datePublished: '2026-03-24',
      dateModified: '2026-08-29',
      url: 'https://www.promptquorum.com/ko/prompt-engineering/google-prompting-guide',
      inLanguage: 'ko',
      keywords: ['Google 프롬프팅 가이드', '프롬프트 모범 사례', '프롬프트 엔지니어링', 'Gemini 3.1 Pro', 'GPT-5.6', 'Claude Opus 5', '프롬프트 프레임워크', 'PromptQuorum'],
      author: { '@type': 'Person', name: 'Hans Kuepper', url: 'https://www.promptquorum.com/about', jobTitle: 'Founder', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
      publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      proficiencyLevel: 'Intermediate',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '**이러한 원칙들은 Gemini 3.1 Pro, GPT-5.6, Claude Opus 5, 로컬 모델(Ollama, LM Studio) 등 모든 최신 모델에서 작동합니다.** 이들은 모델에 종속되지 않습니다.',
          ...
          '**PromptQuorum은 Google 가이드를 재사용 가능한 프레임워크로 통합합니다. 필드를 한 번 입력하면 Gemini, GPT-5.6, Claude, 로컬 모델로 동시에 전송할 수 있습니다.**',
      ...
      corePrinciples: {
        ...
        content: [
          '**Google 프롬프팅 가이드의 핵심 원칙은 영리한 문구보다 명확성, 제약, 반복적 개선을 중심으로 합니다.** 평가하기 쉬운 방식으로 원하는 것을 모델에 정확히 전달하는 데 중점을 둡니다. 이 원칙들은 Gemini 3.1 Pro, GPT-5.6, Claude Opus 5, 오픈소스 모델에서 검증되었습니다.',
          '공통 주제는 다음과 같습니다:',
        ],
        items: [
      ...
      howPQImplements: {
        ...
        items: [
          '가이드 준수 필드를 한 번 입력하고, 생성된 프롬프트를 Gemini 3.1 Pro, GPT-5.6, Claude Opus 5, [Ollama](https://ollama.com) 또는 LM Studio를 통한 로컬 모델로 동시에 전송합니다.',
      ...
      usingWithOthers: {
        ...
        callouts: [
          { type: 'did-you-know', label: '알고 계셨습니까', text: 'Google 프롬프팅 가이드는 크로스 모델 테스트를 명시적으로 권장합니다. 가이드 문서 자체에 프롬프트 동작이 모델 계열마다 다르다고 명시되어 있습니다. 이것이 바로 PromptQuorum이 멀티모델 디스패치로 가능하게 하는 것입니다. Google 스타일 프롬프트를 Gemini 3.1 Pro, GPT-5.6, Claude Opus 5에서 테스트하여 일관된 동작을 보장하십시오.' },
        ],
      },
      commonMistakes: {
        id: 'common-mistakes',
      ...
      howToStart: {
        ...
        callouts: [
          { type: 'warning', label: '경고: 토큰 비용', text: '퓨샷 예시와 상세한 역할 지침은 토큰을 증가시킵니다. 200단어 예시 5개 = 태스크가 도착하기 전에 이미 ~1,500토큰. Gemini에서 입력 토큰 1M당 $2라면 비용은 몇 센트의 일부에 불과합니다. Claude Opus 5의 경우 1M당 $5이므로 대용량에서는 누적됩니다. 퓨샷이 많은 프롬프트에는 Gemini의 컨텍스트 캐싱을 사용하여 비용을 절감하십시오.' },
        ],
      },
      faqSection: {
        id: 'faq',
        title: '자주 묻는 질문',
        faqs: [
          { q: 'Google 프롬프팅 가이드는 Gemini에만 제한됩니까?', a: '아닙니다. 원칙들은 보편적이며 GPT-5.6, Claude Opus 5, 모든 최신 모델에서 동일하게 잘 작동합니다. Gemini가 주요 예시이지만, 기저 아이디어는 모델에 종속되지 않습니다.' },
      ...
      google2026Updates: {
        ...
        items: [
          ...
          '**Gemini Deep Think:** Gemini 3.1 Pro의 내장 추론 모드(와 Claude Opus 5의 확장 사고, OpenAI의 o3 추론)는 "단계별 추론" 권장 사항을 모델 수준에서 자동화합니다. 요청할 필요가 없습니다; 모델이 내부적으로 추론합니다.',
      ...
      sources: {
        ...
        items: [
          ...
          'OpenAI 및 Anthropic API 문서(2026) — GPT-5.6, Claude Opus 5, 오픈소스 모델에 걸친 프롬프트 엔지니어링 모범 사례',
