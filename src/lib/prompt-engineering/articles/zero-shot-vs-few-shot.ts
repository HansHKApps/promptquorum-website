...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  sections: {
    ...
    howPQHelps: {
      ...
      content: [
        '**PromptQuorum ist ein Multi-Model-AI-Dispatch-Tool, mit dem Sie Zero-Shot- und Few-Shot-Prompts an mehreren Anbietern an einem Ort testen können.** Sie können denselben Anweisungs-Only-Prompt und denselben beispielerweiterten Prompt nebeneinander an Modelle wie GPT-5.6, Claude Opus 5 und Gemini 3.1 Pro senden.',
  ...
  sections: {
    ...
    howPQHelps: {
      ...
      content: [
        '**PromptQuorum هو أداة إرسال ذكاء اصطناعي متعددة النماذج تتيح لك اختبار الطلبات Zero-Shot وFew-Shot عبر مزودين متعددين في مكان واحد.** يمكنك إرسال الطلب ذاته بتعليمات فقط والطلب ذاته مع أمثلة إلى نماذج مثل GPT-5.6 وClaude Opus 5 وGemini 3.1 Pro في وقتٍ واحد.',
  ...
  sections: {
    ...
    注意点: {
      ...
      items: [
        ...
        'モデルによってゼロショット vs. フューショットの反応が異なる場合があります。GPT-5.6はゼロショットで堅牢ですが、Gemini 3.1 Proはいくつかのドメインでフューショットの恩恵をより受けることがあります。',
      ],
    },
    howPQHelps: {
      title: 'PromptQuorumがどのように選択を支援するか',
      content: [
        '**PromptQuorumは、複数のプロバイダー間でゼロショットとフューショットプロンプトをテストできるマルチモデルAIディスパッチツールです。** 指示のみのプロンプトと例を拡張したプロンプトの両方を、GPT-5.6、Claude Opus 5、Gemini 3.1 Proなどのモデルに並行して送信できます。',
  ...
  sections: {
    ...
    howPQHelps: {
      ...
      content: [
        '**PromptQuorum 是一款多模型 AI 分派工具，让您在一个地方跨多个提供商测试零样本和少样本提示。** 您可以将相同的仅指令提示和相同的示例增强提示并行发送到 GPT-5.6、Claude Opus 5 和 Gemini 3.1 Pro 等模型。',
    ...
    实用建议: {
      ...
      items: [
        ...
        '在生产环境中部署前测试性能差异。',
        '比较不同模型间的零样本 vs. 少样本性能——GPT-5.6 可能在零样本中表现出色，而 Gemini 3.1 Pro 可能从少样本获益更多。',
      ],
    },
    howToStart: {
      title: '如何在零样本和少样本间选择',
    ...
    heroImage: '/images/zero-shot-vs-few-shot-overview-hero-ko.webp',
      ...
      sections: {
        ...
        howPQHelps: {
          ...
          content: [
            '**PromptQuorum은 한 곳에서 여러 제공업체에 걸쳐 zero-shot 및 few-shot 프롬프트를 테스트할 수 있는 멀티 모델 AI 디스패치 도구입니다.** GPT-5.6, Claude Opus 5, Gemini 3.1 Pro 같은 모델에 동일한 지시문 전용 프롬프트와 예시 보강 프롬프트를 나란히 전송할 수 있습니다.',
