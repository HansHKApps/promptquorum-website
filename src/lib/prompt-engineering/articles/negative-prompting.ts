...
export const article: Partial<Record<Language, PEArticle>> = {
      ...
      sections: {
        ...
        faqSection: {
          ...
          faqs: [
            ...
            {
              q: 'What is a negative constraint (negative prompt) in AI?',
              a: 'A negative constraint — also called a negative prompt — is an explicit "do not" rule added to an AI prompt that limits content, style, structure, or behavior. It works alongside positive instructions to keep model output inside defined boundaries, for example telling a model not to use certain words, mention competitors, or fabricate statistics.',
            },
            {
  ...
  sections: {
    ...
    faqSection: {
      ...
      faqs: [
        ...
        {
          q: 'Qu\'est-ce qu\'une contrainte négative (négative prompt) en IA ?',
          a: 'Une contrainte négative — aussi appelée négative prompt — est une règle explicite « ne pas faire » ajoutée à une invite IA qui limite le contenu, le style, la structure ou le comportement. Elle fonctionne aux côtés des instructions positives pour maintenir le résultat du modèle à l\'intérieur de limites définies, par exemple en indiquant au modèle de ne pas utiliser certains mots, de ne pas mentionner de concurrents, ou de ne pas fabriquer de statistiques.',
        },
        {
    ...
    relatedReading: {
      items: [
        ...
        { title: 'Les 5 Éléments Clés d\'un Prompt', url: '/fr/prompt-engineering/5-building-blocks-every-prompt-needs' },
        { title: 'Hallucinations IA', url: '/fr/prompt-engineering/ai-hallucinations-why-ai-makes-things-up' },
  ...
  faqSchema: {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'Qu\'est-ce qu\'une contrainte négative (négative prompt) en IA ?', acceptedAnswer: { '@type': 'Answer', text: 'Une contrainte négative — aussi appelée négative prompt — est une règle explicite « ne pas faire » ajoutée à une invite IA qui limite le contenu, le style, la structure ou le comportement. Elle fonctionne aux côtés des instructions positives pour maintenir le résultat du modèle à l\'intérieur de limites définies, par exemple en indiquant au modèle de ne pas utiliser certains mots, de ne pas mentionner de concurrents, ou de ne pas fabriquer de statistiques.' } },
  ...
  sections: {
    ...
    faqSection: {
      ...
      faqs: [
        ...
        {
          q: 'AIにおけるネガティブ制約（ネガティブプロンプト）とは何ですか?',
          a: 'ネガティブ制約 — ネガティブプロンプトとも呼ばれます — は、AIプロンプトに追加される明示的な「してはいけないこと」ルールで、コンテンツ、スタイル、構造、または振る舞いを制限します。ポジティブな指示と組み合わせて使用することで、モデルの出力を定められた範囲内に保ちます。たとえば、特定の単語を使わない、競合他社に言及しない、統計を捏造しないようにモデルに指示する場合などです。',
        },
        {
    ...
    relatedReading: {
      items: [
        ...
        { title: 'プロンプトの5つの構成要素', url: '/ja/prompt-engineering/5-building-blocks-every-prompt-needs' },
        { title: 'AI幻覚', url: '/ja/prompt-engineering/ai-hallucinations-why-ai-makes-things-up' },
  ...
  faqSchema: {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'AIにおけるネガティブ制約（ネガティブプロンプト）とは何ですか?', acceptedAnswer: { '@type': 'Answer', text: 'ネガティブ制約 — ネガティブプロンプトとも呼ばれます — は、AIプロンプトに追加される明示的な「してはいけないこと」ルールで、コンテンツ、スタイル、構造、または振る舞いを制限します。ポジティブな指示と組み合わせて使用することで、モデルの出力を定められた範囲内に保ちます。たとえば、特定の単語を使わない、競合他社に言及しない、統計を捏造しないようにモデルに指示する場合などです。' } },
  ...
  sections: {
    ...
    faqSection: {
      ...
      faqs: [
        ...
        {
          q: 'AI에서 네거티브 제약(네거티브 프롬프트)이란 무엇입니까?',
          a: '네거티브 제약 — 네거티브 프롬프트라고도 함 — 은 AI 프롬프트에 추가되는 명시적인 "금지" 규칙으로, 내용, 스타일, 구조 또는 동작을 제한합니다. 긍정적인 지시문과 함께 작동하여 모델 출력을 정의된 경계 내에 유지합니다. 예를 들어 특정 단어를 사용하지 않거나, 경쟁사를 언급하지 않거나, 통계를 날조하지 않도록 모델에 지시하는 것입니다.',
        },
        {
