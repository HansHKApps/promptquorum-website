...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  schema: {
    ...
    datePublished: '2026-03-26',
    dateModified: '2026-05-04',
    url: 'https://www.promptquorum.com/prompt-engineering/negative-prompting?lang=de',
    inLanguage: 'de',
  ...
  schema: {
    ...
    datePublished: '2026-03-26',
    dateModified: '2026-05-04',
    url: 'https://www.promptquorum.com/prompt-engineering/negative-prompting?lang=ja',
    inLanguage: 'ja',
  ...
  sections: {
    ...
    relatedReading: {
      items: [
        ...
        { title: 'プロンプトの5つの構成要素', url: '/prompt-engineering/5-building-blocks-of-a-prompt?lang=ja' },
        { title: 'AI幻覚', url: '/prompt-engineering/ai-hallucinations?lang=ja' },
        { title: 'プロンプトインジェクションとセキュリティ', url: '/prompt-engineering/prompt-injection-and-security?lang=ja' },
        { title: '温度とTop-P', url: '/prompt-engineering/temperature-and-top-p?lang=ja' },
        { title: 'ゼロショットとフューショット', url: '/prompt-engineering/zero-shot-vs-few-shot-prompting?lang=ja' },
      ],
    },
    sources: {
      items: [
  ...
  itemListSchema: {
    ...
    zh: {
      ...
      schema: {
        ...
        datePublished: '2026-03-26',
        dateModified: '2026-05-04',
        url: 'https://www.promptquorum.com/prompt-engineering/negative-prompting?lang=zh',
        inLanguage: 'zh',
