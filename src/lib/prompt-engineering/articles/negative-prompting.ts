...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  seoTitle: 'البرومبت السلبي 2026: احمِ مخرجات الذكاء الاصطناعي',
  metaDescription: 'البرومبت السلبي يخبر الذكاء الاصطناعي بما يجب تجنبه: المحتوى والأسلوب والبنية والسلوكيات. يمنع المخرجات غير المرغوبة. دليل شامل مع أمثلة.',
  publishDate: '2026-03-26',
  dateModified: '2026-05-04',
  lastFactChecked: '2026-05-04',
  ...
  schema: {
    ...
    datePublished: '2026-03-26',
    url: 'https://www.promptquorum.com/pt/pt/prompt-engineering/negative-prompting',
    inLanguage: 'pt-BR',
    keywords: ['negative prompting', 'prompt engineering', 'guardrails', 'PromptQuorum'],
    author: { '@type': 'Person', name: 'Hans Kuepper', url: 'https://www.promptquorum.com/about' },
    publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
