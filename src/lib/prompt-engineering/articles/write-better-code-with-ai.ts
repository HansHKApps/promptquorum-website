      ...
      sections: {
        ...
        codingTools: {
          ...
          rows: [
            ...
            {
              'Tool': '[Claude Code (Anthropic)](https://claude.com/product/claude-code)',
    ...
    es: {
      ...
      sections: {
        ...
        codingTools: {
          ...
          rows: [
            { 'Herramienta': '[GitHub Copilot](https://github.com/features/copilot)', 'Tasa de alucinación': '~15–20 %', 'Conciencia de la arquitectura': 'Contexto a nivel de archivo', 'Adecuado para': 'Desarrolladores individuales, código repetitivo' },
            { 'Herramienta': '[Cursor](https://cursor.com)', 'Tasa de alucinación': '~10–15 %', 'Conciencia de la arquitectura': 'Indexación RAG a nivel de proyecto', 'Adecuado para': 'Equipos que quieren un IDE nativo de IA' },
            { 'Herramienta': '[Claude Code (Anthropic)](https://claude.com/product/claude-code)', 'Tasa de alucinación': 'Baja en tareas estructuradas', 'Conciencia de la arquitectura': 'Contexto completo del código base', 'Adecuado para': 'Backend, refactorización multi-archivo' },
            { 'Herramienta': '[Devin (Cognition AI)](https://devin.ai)', 'Tasa de alucinación': 'Variable', 'Conciencia de la arquitectura': 'Ejecución de tareas autónoma', 'Adecuado para': 'Pipelines autónomas de ticket a PR' },
            { 'Herramienta': '[Qwen Code (Alibaba)](https://github.com/QwenLM/qwen-code)', 'Tasa de alucinación': 'Variable', 'Conciencia de la arquitectura': 'Desplegable localmente', 'Adecuado para': 'Investigación, control total de la infraestructura' },
          ],
        },
        security: {
          id: 'the-security-problem-what-ai-gets-wrong',
    ...
    ar: {
      ...
      sections: {
        ...
        codingTools: {
          ...
          rows: [
            { 'الأداة': '[GitHub Copilot](https://github.com/features/copilot)', 'معدل الهلوسة': '~15–20%', 'الوعي بالبنية': 'سياق على مستوى الملف', 'مناسب لـ': 'المطورون الفرديون، الكود المتكرر' },
            { 'الأداة': '[Cursor](https://cursor.com)', 'معدل الهلوسة': '~10–15%', 'الوعي بالبنية': 'فهرسة RAG على مستوى المشروع', 'مناسب لـ': 'الفرق التي تريد بيئة تطوير أصلية للذكاء الاصطناعي' },
            { 'الأداة': '[Claude Code (Anthropic)](https://claude.com/product/claude-code)', 'معدل الهلوسة': 'منخفض في المهام المنظمة', 'الوعي بالبنية': 'سياق كامل لقاعدة الكود', 'مناسب لـ': 'الخلفية، إعادة الهيكلة متعددة الملفات' },
            { 'الأداة': '[Devin (Cognition AI)](https://devin.ai)', 'معدل الهلوسة': 'متفاوت', 'الوعي بالبنية': 'تنفيذ مهام مستقل', 'مناسب لـ': 'مسارات العمل المستقلة من التذكرة إلى طلب المراجعة' },
            { 'الأداة': '[Qwen Code (Alibaba)](https://github.com/QwenLM/qwen-code)', 'معدل الهلوسة': 'متفاوت', 'الوعي بالبنية': 'قابل للنشر محليًا', 'مناسب لـ': 'البحث، التحكم الكامل في البنية التحتية' },
          ],
        },
        security: {
          id: 'the-security-problem-what-ai-gets-wrong',
    ...
    pt: {
      ...
      sections: {
        ...
        codingTools: {
          ...
          rows: [
            { 'Ferramenta': '[GitHub Copilot](https://github.com/features/copilot)', 'Taxa de alucinação': '~15–20%', 'Consciência de arquitetura': 'Contexto de nível de arquivo', 'Adequado para': 'Desenvolvedores individuais, código repetitivo' },
            { 'Ferramenta': '[Cursor](https://cursor.com)', 'Taxa de alucinação': '~10–15%', 'Consciência de arquitetura': 'Indexação RAG de nível de projeto', 'Adequado para': 'Equipes que querem um IDE nativo de IA' },
            { 'Ferramenta': '[Claude Code (Anthropic)](https://claude.com/product/claude-code)', 'Taxa de alucinação': 'Baixa em tarefas estruturadas', 'Consciência de arquitetura': 'Contexto completo da base de código', 'Adequado para': 'Backend, refatoração de múltiplos arquivos' },
            { 'Ferramenta': '[Devin (Cognition AI)](https://devin.ai)', 'Taxa de alucinação': 'Variável', 'Consciência de arquitetura': 'Execução autônoma de tarefas', 'Adequado para': 'Pipelines autônomos de ticket para PR' },
            { 'Ferramenta': '[Qwen Code (Alibaba)](https://github.com/QwenLM/qwen-code)', 'Taxa de alucinação': 'Variável', 'Consciência de arquitetura': 'Implantável localmente', 'Adequado para': 'Pesquisa, controle total da infraestrutura' },
          ],
        },
        security: {
          id: 'the-security-problem-what-ai-gets-wrong',
      ...
      sections: {
        ...
        codingTools: {
          ...
          rows: [
            ...
            {
              'Outil': '[Claude Code (Anthropic)](https://claude.com/product/claude-code)',
            ...
            {
              'Outil': '[Devin (Cognition AI)](https://devin.ai)',
            ...
            {
              'Outil': '[Qwen Code (Alibaba)](https://github.com/QwenLM/qwen-code)',
              'Taux d\'Hallucination': 'Variable',
    ...
    ja: {
      ...
      sections: {
        ...
        codingTools: {
          ...
          rows: [
            { 'ツール': '[GitHub Copilot](https://github.com/features/copilot)', '幻覚率': '～15～20%', 'アーキテクチャ認識': 'ファイルレベル', '適した用途': '個人開発者、ボイラープレート' },
            { 'ツール': '[Cursor](https://cursor.com)', '幻覚率': '～10～15%', 'アーキテクチャ認識': 'プロジェクトレベル RAG', '適した用途': 'AI ネイティブ IDE を望むチーム' },
            { 'ツール': '[Claude Code（Anthropic）](https://claude.com/product/claude-code)', '幻覚率': '構造化タスクで低い', 'アーキテクチャ認識': '完全なコードベース', '適した用途': 'バックエンド、リファクタリング' },
            { 'ツール': '[Devin（Cognition AI）](https://devin.ai)', '幻覚率': '変動', 'アーキテクチャ認識': '自律的なタスク実行', '適した用途': '自律パイプライン' },
            { 'ツール': '[Qwen Code（Alibaba）](https://github.com/QwenLM/qwen-code)', '幻覚率': '変動', 'アーキテクチャ認識': 'ローカルデプロイ可能', '適した用途': '研究、インフラ制御' },
          ],
        },
        security: {
          id: 'the-security-problem-what-ai-gets-wrong',
      ...
      sections: {
        ...
        codingTools: {
          ...
          rows: [
            ...
            {
              '工具': '[Claude Code（Anthropic）](https://claude.com/product/claude-code)',
              '幻觉率': '结构化任务较低',
              '架构感知': '完整代码库上下文',
              '适用场景': '后端、多文件重构',
            },
            {
              '工具': '[Devin（Cognition AI）](https://devin.ai)',
              '幻觉率': '可变',
              '架构感知': '自主任务执行',
              '适用场景': '自主ticket-to-PR流水线',
            },
            {
              '工具': '[Qwen Code（阿里巴巴）](https://github.com/QwenLM/qwen-code)',
              '幻觉率': '可变',
              '架构感知': '本地部署能力',
              '适用场景': '研究、完全基础设施控制',
            },
      ...
      sections: {
        ...
        codingTools: {
          ...
          rows: [
            ...
            {
              '도구': '[Claude Code (Anthropic)](https://claude.com/product/claude-code)',
              '환각률': '구조화된 작업에서 더 낮음',
              '아키텍처 인식': '전체 코드베이스 컨텍스트',
              '최적 용도': '백엔드, 다중 파일 리팩토링',
            },
            {
              '도구': '[Devin (Cognition AI)](https://devin.ai)',
              '환각률': '가변',
              '아키텍처 인식': '자율 작업 실행',
              '최적 용도': '자율 티켓-to-PR 파이프라인',
            },
            {
              '도구': '[Qwen Code (Alibaba)](https://github.com/QwenLM/qwen-code)',
              '환각률': '가변',
              '아키텍처 인식': '로컬 배포 가능',
              '최적 용도': '연구, 전체 인프라 제어',
            },
