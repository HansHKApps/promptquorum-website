...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      seoTitle: 'كتابة كود أفضل بالذكاء الاصطناعي: الطلبات والنماذج والأمان',
      metaDescription: 'الذكاء الاصطناعي يقلّص وقت البرمجة بنسبة 30–75% مع طلبات منظمة. قارن بين Claude وGPT-5.5 وGemini. 45% من كود الذكاء الاصطناعي يحتوي ثغرات.',
