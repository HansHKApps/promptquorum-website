  ...
  es: {
    ...
    itemListSchema: {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 4, name: 'Claude Opus 4.7', description: 'Mejor opción para análisis de documentos multilingüe matizado y ajuste de tono' },
    ...
    sections: {
      ...
      modelMatrix: {
        ...
        rows: [
          ...
          { 'Modelo': 'Claude Opus 4.7', 'Nivel 2 (Europeo)': '✅ Fuerte', 'Nivel 3 (Asia Oriental)': '✓ Bueno', 'Árabe': '✓ Bueno', 'Mejor caso de uso': 'Análisis de documentos, tono matizado' },
