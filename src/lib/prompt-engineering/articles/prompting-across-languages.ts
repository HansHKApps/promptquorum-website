...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  es: {
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/es/es/prompt-engineering/prompting-across-languages',
      inLanguage: 'es',
  ...
  ar: {
    ...
    seoTitle: 'البرومبت متعدد اللغات: نتائج ذكاء اصطناعي متسقة',
    metaDescription: 'نماذج LLM دُرِّبت على ~46% إنجليزي — أداؤها أضعف في العربية والفرنسية والألمانية والعربية. أفضل النماذج لكل لغة وكيف تكتب برومبتات فعّالة.',
