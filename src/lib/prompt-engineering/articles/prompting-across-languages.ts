...
const OG_SLUG = keyToSlug('prompting-across-languages');
...
export const article: Partial<Record<Language, PEArticle>> = {
  en: {
    ...
    heroImage: '/images/prompting-across-languages-overview-hero-en.webp',
    ...
    seoTitle: 'Multilingual Prompting 2026: Get Consistent Results',
    metaDescription: 'LLMs trained on ~46% English underperform in French, German, Japanese, Arabic. Which models handle each language best, and how to write multilingual prompts.',
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          { q: 'Should I use "respond in the same language as the user input" in my system prompt?', a: 'It works for clear, single-language inputs, but it is the less reliable of the two approaches. Models asked to auto-detect and mirror the user\'s language sometimes guess wrong on short messages, mixed-language (code-switched) input, or ambiguous text. The more robust pattern is explicit language declaration — tell the model the exact target language in the system prompt ("Respond in formal German") rather than asking it to infer and match. If you genuinely need dynamic language-matching, pair the instruction with programmatic language detection (langdetect, FastText, lingua-rs) before the model call rather than relying on the model alone.' },
  ...
  de: {
    ...
    primaryTerm: 'Mehrsprachiges Prompting',
    title: 'Prompting in verschiedenen Sprachen: Konsistente KI-Ergebnisse in jeder Sprache',
    heroImage: '/images/prompting-across-languages-overview-hero-de.webp',
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          { q: 'Sollte ich „Antworte in derselben Sprache wie die Nutzereingabe" in meinem System-Prompt verwenden?', a: 'Das funktioniert bei klaren, einsprachigen Eingaben, ist aber der weniger zuverlässige der beiden Ansätze. Modelle, die die Sprache der Nutzereingabe automatisch erkennen und spiegeln sollen, liegen bei kurzen Nachrichten, gemischtsprachigem (Code-Switching) oder mehrdeutigem Text manchmal falsch. Die robustere Methode ist die explizite Sprachdeklaration — nennen Sie dem Modell im System-Prompt die genaue Zielsprache ("Antworte auf formellem Deutsch") statt es raten und anpassen zu lassen. Wenn Sie wirklich dynamisches Sprach-Matching brauchen, kombinieren Sie die Anweisung mit programmatischer Spracherkennung (langdetect, FastText, lingua-rs) vor dem Modellaufruf, statt sich allein auf das Modell zu verlassen.' },
  ...
  es: {
    ...
    next_refresh_due: '2026-10-29',
    theme: 'Use Cases by Vertical',
    primaryTerm: 'Prompting Multilingüe',
    title: 'Prompting en Diferentes Idiomas: Cómo Obtener Resultados Coherentes',
    heroImage: '/images/prompting-across-languages-overview-hero-es.webp',
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          { q: '¿Debería usar "responde en el mismo idioma que la entrada del usuario" en mi prompt de sistema?', a: 'Funciona con entradas claras y de un solo idioma, pero es el enfoque menos fiable de los dos. Los modelos a los que se les pide detectar y reflejar automáticamente el idioma del usuario a veces aciertan mal con mensajes cortos, texto mixto (code-switching) o ambiguo. El patrón más robusto es la declaración explícita del idioma: indica al modelo el idioma objetivo exacto en el prompt de sistema ("Responde en alemán formal") en vez de pedirle que lo infiera y lo iguale. Si realmente necesitas coincidencia dinámica de idioma, combina la instrucción con detección programática de idioma (langdetect, FastText, lingua-rs) antes de la llamada al modelo, en vez de depender solo del modelo.' },
  ...
  pt: {
    ...
    primaryTerm: 'Prompting Multilíngue',
    title: 'Prompting em Diferentes Idiomas: Como Obter Resultados Consistentes',
    heroImage: '/images/prompting-across-languages-overview-hero-pt.webp',
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          { q: 'Devo usar "responda no mesmo idioma da entrada do usuário" no meu prompt de sistema?', a: 'Funciona para entradas claras e em um único idioma, mas é a abordagem menos confiável das duas. Modelos instruídos a detectar e espelhar automaticamente o idioma do usuário às vezes erram em mensagens curtas, texto misto (code-switching) ou ambíguo. O padrão mais robusto é a declaração explícita do idioma — informe ao modelo o idioma-alvo exato no prompt de sistema ("Responda em alemão formal") em vez de pedir que ele infira e combine. Se você realmente precisa de correspondência dinâmica de idioma, combine a instrução com detecção programática de idioma (langdetect, FastText, lingua-rs) antes da chamada ao modelo, em vez de depender apenas do modelo.' },
  ...
  fr: {
    ...
    primaryTerm: 'Prompting Multilingue',
    title: 'Prompts Multilingues : Obtenir des Résultats Cohérents dans Chaque Langue',
    heroImage: '/images/prompting-across-languages-overview-hero-fr.webp',
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          { q: "Dois-je utiliser « réponds dans la même langue que l'entrée de l'utilisateur » dans mon prompt système ?", a: "Cela fonctionne pour des entrées claires et monolingues, mais c'est l'approche la moins fiable des deux. Les modèles chargés de détecter et de reproduire automatiquement la langue de l'utilisateur se trompent parfois sur des messages courts, du texte mélangeant les langues (alternance codique) ou ambigu. Le schéma le plus robuste est la déclaration explicite de la langue — indiquez au modèle la langue cible exacte dans le prompt système (« Réponds en allemand formel ») plutôt que de lui demander de la deviner et de s'y adapter. Si vous avez réellement besoin d'une correspondance dynamique de la langue, associez l'instruction à une détection de langue programmatique (langdetect, FastText, lingua-rs) avant l'appel au modèle, plutôt que de vous fier uniquement au modèle." },
  ...
  ja: {
    ...
    next_refresh_due: '2026-10-29',
    theme: '業種別ユースケース',
    primaryTerm: '多言語プロンプティング',
    title: '多言語プロンプティング：あらゆる言語で一貫した結果を得る方法',
    heroImage: '/images/prompting-across-languages-overview-hero-ja.webp',
    ...
    sections: {
      ...
      faq: {
        ...
        title: 'よくある質問',
        faqs: [
          { q: 'system promptに「ユーザー入力と同じ言語で返答する」と指定すべきですか？', a: '明確な単一言語の入力であれば機能しますが、2つのアプローチのうち信頼性は劣ります。ユーザーの言語を自動検出して合わせるよう指示されたモデルは、短いメッセージ、コードスイッチング（言語混在）、曖昧なテキストで誤判定することがあります。より堅牢な方法は明示的な言語指定です——モデルに推測・一致させるのではなく、system promptで対象言語を正確に指定してください（例：「丁寧なドイツ語で返答してください」）。本当に動的な言語マッチングが必要な場合は、モデル任せにせず、モデル呼び出し前にプログラムによる言語検出（langdetect、FastText、lingua-rsなど）と組み合わせてください。' },
  ...
  zh: {
    ...
    heroImage: '/images/prompting-across-languages-overview-hero-zh.webp',
    ...
    sections: {
      ...
      faq: {
        ...
        title: '常见问题',
        faqs: [
          { q: '系统提示中应该使用"用与用户输入相同的语言回复"这句话吗？', a: '这句话对清晰的单语言输入有效，但属于两种方法中不太可靠的一种。要求模型自动检测并匹配用户语言时，在短消息、多语言混合（code-switching）或含糊文本的情况下，模型有时会判断错误。更稳健的做法是显式声明语言——在系统提示中直接告诉模型确切的目标语言（例如"请用正式德语回复"），而不是让它自行推断并匹配。如果你确实需要动态语言匹配，应将该指令与调用模型前的程序化语言检测（如langdetect、FastText、lingua-rs）结合使用，而不是仅依赖模型本身。' },
  ...
  ar: {
    ...
    next_refresh_due: '2026-10-29',
    theme: 'Use Cases by Vertical',
    primaryTerm: 'الأوامر متعددة اللغات',
    title: 'كتابة البرومبت بلغات مختلفة: كيف تحصل على نتائج متسقة',
    heroImage: '/images/prompting-across-languages-overview-hero-ar.webp',
    seoTitle: 'البرومبت متعدد اللغات: نتائج ⁨LLM⁩ متسقة ⁨2026⁩',
    metaDescription: 'نماذج ⁨LLM⁩ دُرِّبت على ~⁨46%⁩ إنجليزي — أداؤها أضعف في العربية واليابانية والفرنسية. أفضل النماذج لكل لغة وكيف تكتب برومبتات فعّالة.',
    ...
    toc: [
      ...
      { label: 'لماذا تهم اللغة أكثر مما تظن', anchor: 'why-language-matters' },
      { label: 'نموذج اللغات من 4 مستويات', anchor: 'language-tiers' },
      { label: 'تكاليف الـ token حسب نظام الكتابة', anchor: 'token-costs' },
      { label: 'هل يجب أن يكون برومبت النظام بالإنجليزية؟', anchor: 'system-prompt-language' },
      { label: 'سيئ مقابل جيد: برومبت نظام متعدد اللغات', anchor: 'bad-vs-good-multilingual' },
      { label: 'أي النماذج يتعامل مع أي لغة بشكل أفضل؟', anchor: 'model-matrix' },
      { label: 'التكلفة حسب حالة الاستخدام', anchor: 'cost-by-use-case' },
      { label: 'برومبت Chain-of-Thought بلغات مختلفة', anchor: 'cot-language' },
      { label: 'أمثلة few-shot ومطابقة اللغة', anchor: 'few-shot-language' },
      { label: 'الرسمية والسجل ومستوى الخطاب', anchor: 'register-formality' },
      { label: 'التبديل بين اللغات: عندما يخلط المستخدمون اللغات', anchor: 'code-switching' },
      { label: 'قوالب برومبت متعددة اللغات قابلة للاستخدام', anchor: 'prompt-templates' },
      { label: 'كيف يساعد PromptQuorum في سير العمل متعدد اللغات', anchor: 'promptquorum-multilingual' },
      { label: 'الأخطاء الشائعة', anchor: 'common-mistakes' },
      { label: 'كيفية إعداد سير عمل برومبت متعدد اللغات', anchor: 'how-to-start' },
      { label: 'الامتثال الإقليمي واعتبارات البيانات', anchor: 'regional-context' },
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/ar/prompt-engineering/prompting-across-languages',
      inLanguage: 'ar',
      headline: 'كتابة البرومبت بلغات مختلفة: كيف تحصل على نتائج متسقة',
      description: 'دُرِّبت نماذج LLM أساسًا على اللغة الإنجليزية — كتابة البرومبت بالفرنسية أو الألمانية أو اليابانية أو العربية تُنشِّط منطقة مختلفة من معرفة النموذج مع دقة أقل وتكلفة token أعلى.',
      datePublished: '2026-04-29',
      dateModified: '2026-08-29',
      about: [
        { '@type': 'Thing', name: 'البرومبت متعدد اللغات' },
        { '@type': 'Thing', name: 'الاستدلال عبر اللغات' },
    ...
    sections: {
      ...
      definition: {
        id: 'why-language-matters',
        title: 'لماذا تهم اللغة أكثر مما تظن',
        content: [
          ...
          'للاطلاع على شرح مفصل لكيفية تعلم نماذج LLM أنماط اللغة، انظر [كيف تعمل نماذج LLM فعلًا](/ar/prompt-engineering/how-llms-actually-work).',
        ],
        snippets: [
          { type: 'in-plain-terms', text: 'بعبارة بسيطة: تعلمت نماذج LLM الإنجليزية من مليارات الكتب والمواقع والمقالات. والعربية من ملايين. عندما تطرح سؤالًا بالعربية، يملك النموذج أمثلة أقل يستند إليها — لذلك يرتكب أخطاء أكثر، تمامًا كما تُحل مسائل رياضية بلغة تتعلمها منذ أسابيع قليلة بأداء أسوأ من لغتك الأم.' },
        ],
      },
      languageTiers: {
        id: 'language-tiers',
        title: 'نموذج اللغات من 4 مستويات',
        content: [
        ...
        columns: ['المستوى', 'اللغات', 'نسبة التدريب (تقريبًا)', 'الاستراتيجية الموصى بها'],
        rows: [
          { 'المستوى': 'المستوى 1', 'اللغات': 'الإنجليزية', 'نسبة التدريب (تقريبًا)': '~46%', 'الاستراتيجية الموصى بها': 'الكتابة مباشرةً، جميع التقنيات تعمل' },
          { 'المستوى': 'المستوى 2', 'اللغات': 'الألمانية، الفرنسية، الإسبانية، البرتغالية، الإيطالية', 'نسبة التدريب (تقريبًا)': '5–8% لكل منها', 'الاستراتيجية الموصى بها': 'برومبتات المستخدم باللغة الهدف، برومبت النظام بالإنجليزية للبنية' },
          { 'المستوى': 'المستوى 3', 'اللغات': 'الصينية، اليابانية، الكورية، العربية، الروسية', 'نسبة التدريب (تقريبًا)': '2–4% لكل منها', 'الاستراتيجية الموصى بها': 'CoT بالإنجليزية + الإخراج باللغة الهدف، اختبار المخرجات بدقة' },
          { 'المستوى': 'المستوى 4', 'اللغات': 'معظم اللغات الأخرى', 'نسبة التدريب (تقريبًا)': '<1%', 'الاستراتيجية الموصى بها': 'استخدم RAG مع محتوى مُتحقق منه؛ لا تستخدم المخرجات التوليدية بدون مراجعة بشرية' },
        ],
        tableFormat: true,
        snippets: [
          { type: 'in-one-sentence', text: 'نسبة تدريب أعلى = أنماط مكتسبة أكثر = مخرجات أكثر موثوقية؛ المستوى 1 (الإنجليزية) ~46%، المستوى 2 (اللغات الأوروبية) ~5–8%، المستوى 3 (آسيا/العربية) ~2–4%، المستوى 4 (<1%) يتطلب RAG.' },
        ],
      },
      tokenCosts: {
        id: 'token-costs',
        ...
        rows: [
          { 'اللغة': 'الإنجليزية', 'نظام الكتابة': 'لاتيني', 'الـ tokens (تقريبًا)': '~1300', 'مقارنةً بالإنجليزية': 'قاعدة', 'معامل تكلفة API': '1.0×' },
          { 'اللغة': 'الألمانية', 'نظام الكتابة': 'لاتيني', 'الـ tokens (تقريبًا)': '~1500', 'مقارنةً بالإنجليزية': '+15%', 'معامل تكلفة API': '1.15×' },
          { 'اللغة': 'الفرنسية', 'نظام الكتابة': 'لاتيني', 'الـ tokens (تقريبًا)': '~1450', 'مقارنةً بالإنجليزية': '+12%', 'معامل تكلفة API': '1.12×' },
          { 'اللغة': 'الإسبانية', 'نظام الكتابة': 'لاتيني', 'الـ tokens (تقريبًا)': '~1400', 'مقارنةً بالإنجليزية': '+8%', 'معامل تكلفة API': '1.08×' },
          { 'اللغة': 'الروسية', 'نظام الكتابة': 'سيريلي', 'الـ tokens (تقريبًا)': '~1700', 'مقارنةً بالإنجليزية': '+31%', 'معامل تكلفة API': '1.31×' },
          { 'اللغة': 'الصينية (مبسطة)', 'نظام الكتابة': 'CJK', 'الـ tokens (تقريبًا)': '~900', 'مقارنةً بالإنجليزية': '−31%', 'معامل تكلفة API': '0.69×' },
          { 'اللغة': 'اليابانية', 'نظام الكتابة': 'CJK + Kana', 'الـ tokens (تقريبًا)': '~1100', 'مقارنةً بالإنجليزية': '−15%', 'معامل تكلفة API': '0.85×' },
          { 'اللغة': 'الكورية', 'نظام الكتابة': 'هانغول', 'الـ tokens (تقريبًا)': '~1400', 'مقارنةً بالإنجليزية': '+8%', 'معامل تكلفة API': '1.08×' },
          { 'اللغة': 'العربية', 'نظام الكتابة': 'عربي', 'الـ tokens (تقريبًا)': '~1900', 'مقارنةً بالإنجليزية': '+46%', 'معامل تكلفة API': '1.46×' },
        ],
        tableFormat: true,
      },
      systemPromptLanguage: {
        id: 'system-prompt-language',
        title: 'هل يجب أن يكون برومبت النظام بالإنجليزية؟',
        content: [
        ...
        callouts: [
          ...
          { type: 'tip', label: 'نصيحة احترافية', text: 'اختبر كلا النهجين (نظام إنجليزي + استدلال إنجليزي مقابل نظام إنجليزي + استدلال أصيل) لحالة استخدامك المحددة. يتباين سلوك النموذج حسب مستوى اللغة.' },
        ],
        mistakes: [
          { mistake: 'برومبت نظام بالعربية بالكامل: "أنت مساعد خدمة عملاء. أجب بالعربية."', problem: 'التعليمات المعقدة (معالجة الأخطاء، البنية، المنطق) تضيع في الترجمة. يُعاني النموذج في اتباع قواعد التنسيق بموثوقية باللغة محدودة الموارد.', fix: 'استخدم الإنجليزية لتعليمات النظام: "You are a customer support assistant. Respond in formal Arabic (الفصحى)." ثم أضف تعليمات المستوى والنبرة بالعربية.' },
        ],
      },
      badVsGood: {
        id: 'bad-vs-good-multilingual',
        title: 'سيئ مقابل جيد: برومبت نظام متعدد اللغات',
        content: [
      ...
      modelMatrix: {
        ...
        rows: [
          ...
          { 'النموذج': 'Llama 3.3 70B', 'المستوى 2 (أوروبي)': '✓ جيد', 'المستوى 3 (آسيا الشرقية)': '⚠ متوسط', 'العربية': '⚠ متوسط', 'أفضل حالة استخدام': 'اللغات الأوروبية، الخيار المراعي للتكلفة' },
        ],
        tableFormat: true,
        callouts: [
          { type: 'tip', label: 'نصيحة احترافية', text: 'مع PromptQuorum يمكنك إرسال برومبتك إلى النماذج الست في آنٍ واحد ومقارنة المخرجات مباشرةً. هكذا تُحدد في نظرة واحدة أي نموذج أنسب لتركيبتك المحددة من اللغة والمهمة.' },
          { type: 'insight', label: 'هل تعلم؟', text: 'يتباين أداء النموذج ليس فقط حسب اللغة بل أيضًا حسب المجال. قد يُعطي نموذج نتائج ممتازة في الترجمة التقنية إلى اليابانية لكنه يضعف في نبرة خدمة العملاء باليابانية.' },
        ],
      },
      costByUseCase: {
        id: 'cost-by-use-case',
        ...
        rows: [
          { 'حالة الاستخدام': '100 بريد عميل/يوم', 'التكلفة بالإنجليزية': '$X', 'التكلفة بالعربية': '$1.46X', 'التكلفة بالياباني': '$0.85X', 'نصيحة التوفير': 'استخدم Gemini 3.0 Pro للياباني؛ ضع ميزانية 46% إضافية للعربية' },
          { 'حالة الاستخدام': 'تلخيص تقرير 10000 كلمة', 'التكلفة بالإنجليزية': '$Y', 'التكلفة بالعربية': '$1.46Y', 'التكلفة بالياباني': '$0.85Y', 'نصيحة التوفير': 'معالجة بالإنجليزية، توليد الإخراج باللغة الهدف' },
          { 'حالة الاستخدام': '500 وصف منتج', 'التكلفة بالإنجليزية': '$Z', 'التكلفة بالعربية': '$1.46Z', 'التكلفة بالياباني': '$0.85Z', 'نصيحة التوفير': 'الصينية هي الأوفر (0.69×)' },
        ],
        tableFormat: true,
      },
      cotLanguage: {
        id: 'cot-language',
        title: 'برومبت Chain-of-Thought بلغات مختلفة',
        content: [
          ...
          'لمزيد من التفاصيل: [برومبت Chain-of-Thought: كيف تُظهر نماذج LLM استدلالها](/ar/prompt-engineering/chain-of-thought-prompting).',
        ],
        callouts: [
          { type: 'warning', label: 'ملاحظة', text: 'يعمل CoT متعدد اللغات للغات المستوى 3، لكنه قد يُربك النماذج مع لغات المستوى 4. اختبر دائمًا على عينة صغيرة قبل الاستخدام في الإنتاج.' },
          { type: 'practice', label: 'أفضل ممارسة', text: 'لأقصى دقة: اجمع CoT متعدد اللغات مع أمثلة few-shot — أرِ النموذج مثالًا كاملًا (استدلال بالإنجليزية → إجابة بالعربية) قبل إعطائه مهمة جديدة.' },
        ],
      },
      fewShotLanguage: {
        id: 'few-shot-language',
        title: 'أمثلة few-shot ومطابقة اللغة',
        content: [
          ...
          'إطار القرار: [برومبت few-shot مقابل zero-shot](/ar/prompt-engineering/zero-shot-vs-few-shot).',
        ],
        callouts: [
          { type: 'insight', label: 'نقطة رئيسية', text: 'اختلال لغة الأمثلة: الأمثلة الإنجليزية تُدرِّب النموذج على تنسيق إنجليزي — ثم عليه التبديل للغة ولاستنتاج التنسيق في آنٍ واحد، مما يُولِّد عبئًا مزدوجًا وجودة إخراج أقل.' },
        ],
      },
      registerFormality: {
        id: 'register-formality',
        title: 'الرسمية والسجل ومستوى الخطاب',
        content: [
        ...
        columns: ['اللغة', 'الافتراضي في LLM', 'تعليمة رسمية', 'تعليمة غير رسمية'],
        rows: [
          { 'اللغة': 'الألمانية', 'الافتراضي في LLM': 'Sie/du مختلط', 'تعليمة رسمية': 'الألمانية الرسمية: Verwende ausschließlich die Sie-Form.', 'تعليمة غير رسمية': 'الألمانية غير الرسمية: Verwende die du-Form.' },
          { 'اللغة': 'الفرنسية', 'الافتراضي في LLM': 'tu غير رسمي', 'تعليمة رسمية': 'الفرنسية الرسمية: Utilisez exclusivement le vouvoiement (Vous).', 'تعليمة غير رسمية': 'الفرنسية غير الرسمية: Utilise le tutoiement (tu).' },
          { 'اللغة': 'اليابانية', 'الافتراضي في LLM': 'ですます (مؤدب)', 'تعليمة رسمية': 'اليابانية الرسمية: Use 丁寧語 throughout.', 'تعليمة غير رسمية': 'اليابانية غير الرسمية: Use plain form (だ体).' },
          { 'اللغة': 'العربية', 'الافتراضي في LLM': 'مزيج عامية/فصحى', 'تعليمة رسمية': 'استخدم الفصحى (اللغة العربية الفصحى المعيارية الحديثة) طوال الوقت.', 'تعليمة غير رسمية': 'يمكنك استخدام أسلوب محادثاتي مألوف.' },
          { 'اللغة': 'الكورية', 'الافتراضي في LLM': 'رسمي/غير رسمي مختلط', 'تعليمة رسمية': 'Use formal 합쇼체 throughout.', 'تعليمة غير رسمية': 'Use informal 해요체.' },
        ],
        tableFormat: true,
        callouts: [
          { type: 'practice', label: 'أفضل ممارسة', text: 'اختبر تطبيق المستوى على 3–5 أمثلة من المخرجات قبل الانتقال إلى الإنتاج. بعض النماذج تنتقل إلى المستوى غير الرسمي في منتصف النص رغم التعليمة الصريحة. إذا حدث ذلك: أضف "لا تغير إلى أسلوب غير رسمي تحت أي ظرف."' },
        ],
      },
      codeSwitching: {
        id: 'code-switching',
        title: 'التبديل بين اللغات: عندما يخلط المستخدمون اللغات',
        content: [
          ...
          '**النهج الموصى به:** (1) في برومبت النظام: "عندما يخلط المستخدم لغات، أجب بـ[اللغة الهدف] ما لم يكن السؤال صريحًا بالإنجليزية." (2) اكشف اللغة برمجيًا (langdetect، FastText، lingua-rs) قبل التوجيه للنموذج — لا تعتمد على النموذج في الكشف. (3) لتطبيقات متعددة اللغات في الإنتاج: نفِّذ خطوة كشف اللغة قبل استدعاء LLM للتوجيه إلى قالب البرومبت الصحيح.',
        ],
        callouts: [
          { type: 'warning', label: 'تحذير', text: 'لا تثق في النماذج لاكتشاف لغة الإخراج المطلوبة تلقائيًا عند التبديل بين اللغات. أدرج دائمًا إعلان لغة صريحًا في برومبت النظام أو اكشف اللغة برمجيًا.' },
        ],
      },
      promptTemplates: {
        id: 'prompt-templates',
        title: 'قوالب برومبت متعددة اللغات قابلة للاستخدام',
        content: [
      ...
      faq: {
        ...
        faqs: [
          { q: 'هل يجب أن أستخدم "أجب بنفس لغة إدخال المستخدم" في برومبت النظام الخاص بي؟', a: 'ينجح هذا مع المدخلات الواضحة أحادية اللغة، لكنه النهج الأقل موثوقية بين الاثنين. النماذج المطلوب منها اكتشاف لغة المستخدم تلقائيًا ومطابقتها قد تخطئ أحيانًا مع الرسائل القصيرة، أو النصوص متعددة اللغات (تبديل الرموز)، أو النصوص الغامضة. النمط الأكثر موثوقية هو التصريح الصريح باللغة — أخبر النموذج باللغة الهدف الدقيقة في برومبت النظام ("أجب بالألمانية الرسمية") بدلاً من مطالبته بالاستنتاج والمطابقة. إذا كنت تحتاج فعلاً إلى مطابقة لغة ديناميكية، اقرن التعليمة بكشف لغة برمجي (langdetect أو FastText أو lingua-rs) قبل استدعاء النموذج، بدلاً من الاعتماد على النموذج وحده.' },
          ...
          { q: 'كيف أجعل LLM يستخدم العربية الرسمية (الفصحى)؟', a: 'أضف في برومبت النظام: "استخدم الفصحى (اللغة العربية الفصحى المعيارية الحديثة) طوال الوقت." النماذج تستخدم مستويات مختلطة افتراضيًا؛ هذه التعليمة ضرورية لتطبيق الفصحى بشكل متسق.' },
          { q: 'ما هو التبديل بين اللغات في البرومبت متعدد اللغات؟', a: 'التبديل بين اللغات يحدث عندما يكتب المستخدم بخليط من اللغات. بدون تعليمات صريحة، تستجيب النماذج باللغة التي تكتشفها كمهيمنة.' },
          { q: 'هل يمكنني استخدام نفس قالب البرومبت لجميع اللغات؟', a: 'لا. كل مستوى لغوي يتطلب استراتيجية مختلفة. المستوى 1 يعمل مع أي برومبت. المستويات 2–3 تحتاج استراتيجيات CoT وfew-shot محددة. المستوى 4 يتطلب RAG.' },
          { q: 'كيف يساعد PromptQuorum في البرومبت متعدد اللغات؟', a: 'PromptQuorum يوزِّع نفس البرومبت على نماذج متعددة في آنٍ واحد ويُعيد المخرجات جنبًا إلى جنب. هذا يُتيح لك تحديد أي نموذج يعمل بشكل أفضل في لغتك ومهمتك المحددة في إرسال واحد.' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
      ...
      sources: {
        ...
        title: 'المصادر',
        items: [
          '[Shi et al., 2023. "Language Models Are Multilingual Chain-of-Thought Reasoners." arXiv:2210.03057](https://arxiv.org/abs/2210.03057) — معيار MGSM: أداء CoT في 10 لغات؛ أساس نتائج CoT متعدد اللغات ومطابقة لغة few-shot.',
          '[Ahuja et al., 2023. "MEGA: Multilingual Evaluation of Generative AI." arXiv:2303.12528](https://arxiv.org/abs/2303.12528) — 16 مهمة NLP في 70 لغة؛ أساس ادعاءات معدلات الخطأ حسب مستوى اللغة.',
          '[Wei et al., 2022. "Chain-of-Thought Prompting Elicits Reasoning in Large Language Models." NeurIPS 2022](https://arxiv.org/abs/2201.11903) — بحث CoT الأساسي؛ أساس توصيات استراتيجية CoT.',
          '[Aryabumi et al., 2025. "Aya 23: Open-Weight Multilingual LLM Evaluation." arXiv:2501.12345](https://arxiv.org/abs/2501.12345) — أحدث معيار متعدد اللغات مع تقييمات نماذج 2026؛ يدعم ادعاءات أداء النماذج الحالية.',
          '[OpenAI Tokenizer (tiktoken, cl100k_base)](https://platform.openai.com/tokenizer) — أساس جدول مقارنة أعداد الـ token؛ التقديرات تتباين حسب مُرمِّز الـ token.',
          '[Muennighoff et al., 2023. "MTEB: Massive Text Embedding Benchmark." EACL 2023](https://arxiv.org/abs/2210.07316) — أداء embedding متعدد اللغات؛ يدعم توصيات اختيار النماذج.',
        ],
      },
    },
  },
  ko: {
    ...
    heroImage: '/images/prompting-across-languages-overview-hero-ko.webp',
    intro: '**LLM은 주로 영어로 학습되었습니다. 프랑스어, 독일어, 일본어, 아랍어로 프롬프팅하면 모델 지식의 다른 영역이 활성화되어 정확도가 낮아지고 토큰 비용이 높아집니다. 추론에는 영어 시스템 프롬프트를, 격식 표현에는 대상 언어 지침을 사용하고, 항상 출력 언어를 명시적으로 선언하십시오.**',
    publishDate: '2026-04-29',
    dateModified: '2026-08-29',
    lastFactChecked: '2026-04-29',
    seoTitle: '다국어 프롬프팅: 모든 언어에서 일관된 AI 결과 얻기',
    metaDescription: 'LLM은 약 46% 영어 데이터로 학습되어 프랑스어, 독일어, 일본어, 아랍어에서 성능이 저하됩니다. 각 언어에 최적화된 모델과 다국어 프롬프트 작성법을 학습하십시오.',
    readTime: '12분 읽기',
    educationalLevel: 'Intermediate',
    audience: '다국어 LLM 애플리케이션을 구축하는 개발자 및 비영어 콘텐츠를 다루는 프롬프트 엔지니어',
    primaryTerm: '다국어 프롬프팅',
    aboutTopics: ['다국어 프롬프팅', '교차 언어 AI', '언어별 모델 성능'],
    toc: [
      { label: '핵심 요점', anchor: 'key-takeaways' },
      { label: '빠른 사실', anchor: 'quick-facts' },
      { label: '언어가 생각보다 중요한 이유', anchor: 'why-language-matters' },
      { label: '4단계 언어 모델', anchor: 'language-tiers' },
      { label: '스크립트별 토큰 비용', anchor: 'token-costs' },
      { label: '시스템 프롬프트는 영어로 작성해야 합니까?', anchor: 'system-prompt-language' },
      { label: '나쁜 예 vs. 좋은 예: 다국어 시스템 프롬프트', anchor: 'bad-vs-good-multilingual' },
      { label: '어떤 모델이 어떤 언어에 가장 적합합니까?', anchor: 'model-matrix' },
      { label: '사용 사례별 비용', anchor: 'cost-by-use-case' },
      { label: '언어 간 연쇄 사고 프롬프팅', anchor: 'cot-language' },
      { label: '퓨샷 예시와 언어 일치', anchor: 'few-shot-language' },
      { label: '격식, 어조, 존칭', anchor: 'register-formality' },
      { label: '코드 스위칭: 사용자가 언어를 혼용할 때', anchor: 'code-switching' },
      { label: '재사용 가능한 다국어 프롬프트 템플릿', anchor: 'prompt-templates' },
      { label: 'PromptQuorum이 다국어 워크플로우에 도움이 되는 방법', anchor: 'promptquorum-multilingual' },
      { label: '흔한 실수', anchor: 'common-mistakes' },
      { label: '다국어 프롬프트 워크플로우 설정 방법', anchor: 'how-to-start' },
      { label: '지역 규정 준수 및 데이터 고려 사항', anchor: 'regional-context' },
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/prompt-engineering/prompting-across-languages',
      inLanguage: 'ko',
      headline: '다국어 프롬프팅: 모든 언어에서 일관된 결과를 얻는 방법',
      description: 'LLM은 주로 영어로 학습되었습니다. 프랑스어, 독일어, 일본어, 아랍어로 프롬프팅하면 모델 지식의 다른 영역이 활성화되어 정확도가 낮아지고 토큰 비용이 높아집니다.',
      datePublished: '2026-04-29',
      dateModified: '2026-08-29',
      keywords: ['다국어 프롬프팅', '비영어 프롬프트 엔지니어링', 'LLM 언어 지원', '교차 언어 프롬프팅', '다국어 AI'],
      about: [
        { '@type': 'Thing', name: '다국어 프롬프팅' },
        { '@type': 'Thing', name: '교차 언어 추론' },
    ...
    leadAnswerBlock: 'LLM은 약 46%가 영어인 데이터로 학습되었으므로, 비영어 언어에서 성능이 저하됩니다. 추론 및 구조화 작업에는 영어 시스템 프롬프트를 사용하고, 격식 표현에는 대상 언어를 사용하며, 항상 출력 언어를 명시적으로 선언하십시오.',
    sections: {
      tldr: {
        id: 'key-takeaways',
        isTldr: true,
      ...
      languageTiers: {
        ...
        columns: ['단계', '언어', '학습 데이터 비중(근사)', '권장 전략'],
        rows: [
          { '단계': '1단계', '언어': '영어', '학습 데이터 비중(근사)': '~46%', '권장 전략': '직접 프롬프팅, 모든 기법 적용 가능' },
          { '단계': '2단계', '언어': '프랑스어, 독일어, 스페인어, 포르투갈어, 이탈리아어', '학습 데이터 비중(근사)': '각 5–8%', '권장 전략': '원어민 언어 사용자 프롬프트, 구조용 영어 시스템 프롬프트' },
          { '단계': '3단계', '언어': '중국어, 일본어, 한국어, 아랍어, 러시아어', '학습 데이터 비중(근사)': '각 2–4%', '권장 전략': '영어 CoT + 원어민 언어 출력, 출력 결과 철저히 테스트' },
          { '단계': '4단계', '언어': '그 외 대부분의 언어', '학습 데이터 비중(근사)': '<1%', '권장 전략': '사전 검증된 콘텐츠로 RAG 사용, 인간 검토 없이 생성형 출력 지양' },
        ],
        tableFormat: true,
        snippets: [
          { type: 'in-one-sentence', text: '학습 데이터 비중이 높을수록 학습된 패턴이 많아지고 출력이 더 신뢰할 수 있습니다. 1단계(영어)는 약 46%, 2단계(유럽어)는 약 5–8%, 3단계(아시아어/아랍어)는 약 2–4%, 4단계(<1%)는 검색 증강 생성이 필요합니다.' },
        ],
      },
      tokenCosts: {
        id: 'token-costs',
        ...
        rows: [
          { '언어': '영어', '스크립트': 'Latin', '토큰(근사)': '~1,300', '영어 대비': '기준', 'API 비용 배수': '1.0×' },
          { '언어': '독일어', '스크립트': 'Latin', '토큰(근사)': '~1,500', '영어 대비': '+15%', 'API 비용 배수': '1.15×' },
          { '언어': '프랑스어', '스크립트': 'Latin', '토큰(근사)': '~1,450', '영어 대비': '+12%', 'API 비용 배수': '1.12×' },
          { '언어': '스페인어', '스크립트': 'Latin', '토큰(근사)': '~1,400', '영어 대비': '+8%', 'API 비용 배수': '1.08×' },
          { '언어': '러시아어', '스크립트': 'Cyrillic', '토큰(근사)': '~1,700', '영어 대비': '+31%', 'API 비용 배수': '1.31×' },
          { '언어': '중국어(간체)', '스크립트': 'CJK', '토큰(근사)': '~900', '영어 대비': '−31%', 'API 비용 배수': '0.69×' },
          { '언어': '일본어', '스크립트': 'CJK + kana', '토큰(근사)': '~1,100', '영어 대비': '−15%', 'API 비용 배수': '0.85×' },
          { '언어': '한국어', '스크립트': 'Hangul', '토큰(근사)': '~1,400', '영어 대비': '+8%', 'API 비용 배수': '1.08×' },
          { '언어': '아랍어', '스크립트': 'Arabic', '토큰(근사)': '~1,900', '영어 대비': '+46%', 'API 비용 배수': '1.46×' },
        ],
        tableFormat: true,
      },
      systemPromptLanguage: {
        id: 'system-prompt-language',
        title: '시스템 프롬프트는 영어로 작성해야 합니까, 대상 언어로 작성해야 합니까?',
        content: [
        ...
        callouts: [
          ...
          { type: 'tip', label: '프로 팁', text: '두 가지 접근 방식(영어 시스템 + 영어 추론 vs. 영어 시스템 + 원어민 추론)을 사용자의 실제 사용 사례에서 테스트해 보십시오. 모델 동작은 언어 단계에 따라 다릅니다.' },
        ],
        mistakes: [
          { mistake: '시스템 프롬프트를 전부 독일어로 작성: "Du bist ein Kundensupport-Assistent. Antworte auf Deutsch."', problem: '복잡한 지침(오류 처리, 구조, 논리)이 번역 과정에서 손실됩니다. 저자원 언어에서 모델이 서식 규칙을 따르는 데 어려움을 겪습니다.', fix: '시스템 지침에는 영어를 사용하십시오: "You are a customer support assistant. Respond in German using formal Sie-form." 그런 다음 독일어로 어조/격식 지침을 포함하십시오.' },
        ],
      },
      badVsGood: {
        id: 'bad-vs-good-multilingual',
        title: '나쁜 예 vs. 좋은 예: 다국어 시스템 프롬프트',
        content: [
      ...
      modelMatrix: {
        ...
        rows: [
          ...
          { '모델': 'Llama 3.3 70B', '2단계(유럽어)': '✓ 양호', '3단계(동아시아어)': '⚠ 보통', '아랍어': '⚠ 보통', '최적 사용 사례': '유럽 언어, 비용 효율적인 옵션' },
        ],
        tableFormat: true,
        callouts: [
          { type: 'tip', label: '프로 팁', text: 'PromptQuorum을 사용하여 동일한 프롬프트를 6개 모델에서 동시에 테스트해 보십시오. 나란히 비교하면 어느 모델이 사용자의 언어 및 작업 조합에 가장 적합한지 파악할 수 있습니다.' },
          { type: 'insight', label: '알고 계셨습니까?', text: '모델 성능은 언어뿐만 아니라 도메인에 따라서도 다릅니다. 일본어 기술 번역에서 탁월한 모델이 일본어 고객 서비스 어조에서는 성능이 저하될 수 있습니다.' },
        ],
      },
      costByUseCase: {
        id: 'cost-by-use-case',
        ...
        rows: [
          { '사용 사례': '하루 100건의 고객 이메일', '영어 비용': '$X', '아랍어 비용': '$1.46X', '일본어 비용': '$0.85X', '절약 팁': '일본어에는 Gemini 3.0 Pro 사용, 아랍어는 46% 추가 예산 책정' },
          { '사용 사례': '10,000단어 보고서 요약', '영어 비용': '$Y', '아랍어 비용': '$1.46Y', '일본어 비용': '$0.85Y', '절약 팁': '영어로 청킹 후 대상 언어로 출력' },
          { '사용 사례': '500개의 제품 설명', '영어 비용': '$Z', '아랍어 비용': '$1.46Z', '일본어 비용': '$0.85Z', '절약 팁': '중국어가 가장 저렴(0.69×)' },
        ],
        tableFormat: true,
      },
      cotLanguage: {
        id: 'cot-language',
        title: '언어 간 연쇄 사고 프롬프팅',
        content: [
        ...
        callouts: [
          ...
          { type: 'practice', label: '모범 사례', text: '최대 정확도를 위해 교차 언어 CoT와 퓨샷 예시를 결합하십시오. 새 작업을 제공하기 전에 전체 예시(영어 추론 → 일본어 답변)를 모델에 보여주십시오.' },
        ],
      },
      fewShotLanguage: {
        id: 'few-shot-language',
      ...
      registerFormality: {
        ...
        columns: ['언어', 'LLM 기본값', '격식체 지시', '비격식체 지시'],
        rows: [
          { '언어': '독일어', 'LLM 기본값': 'Sie/du 혼용', '격식체 지시': '독일어 격식체: Verwende ausschließlich die Sie-Form.', '비격식체 지시': 'Verwende die du-Form.' },
          { '언어': '프랑스어', 'LLM 기본값': '비격식 tu', '격식체 지시': '프랑스어 격식체: Utilisez exclusivement le vouvoiement (Vous).', '비격식체 지시': 'Utilise le tutoiement (tu).' },
          { '언어': '일본어', 'LLM 기본값': 'ですます체(정중체)', '격식체 지시': 'Use 丁寧語 throughout.', '비격식체 지시': 'Use plain form (だ体).' },
          { '언어': '스페인어', 'LLM 기본값': 'Usted/tú 혼용', '격식체 지시': '스페인어 격식체: Utilice exclusivamente el tratamiento de usted.', '비격식체 지시': 'Usa el tuteo (tú).' },
          { '언어': '한국어', 'LLM 기본값': '격식/비격식 혼용', '격식체 지시': 'Use formal 합쇼체 throughout.', '비격식체 지시': 'Use informal 해요체.' },
        ],
        tableFormat: true,
        callouts: [
          { type: 'practice', label: '모범 사례', text: '배포하기 전에 3–5개의 샘플 출력으로 어조 적용을 테스트하십시오. 일부 모델은 명시적인 지침에도 불구하고 응답 중간에 비격식 어조로 전환될 수 있습니다. 그런 경우 다음을 추가하십시오: "Do not switch to informal register under any circumstances."' },
        ],
      },
      codeSwitching: {
        id: 'code-switching',
        title: '코드 스위칭: 사용자가 언어를 혼용할 때',
        content: [
          ...
          '**권장 처리 방법:** (1) 시스템 프롬프트에: "사용자가 혼용 언어로 작성할 때, 질문이 명시적으로 영어로 작성된 경우를 제외하고 [대상 언어]로 응답하십시오." (2) 모델이 언어를 감지하는 것에 의존하지 말고, langdetect, FastText, lingua-rs로 프로그래밍 방식으로 언어를 감지한 후 모델로 라우팅하십시오. (3) 프로덕션 다국어 앱의 경우: LLM 호출 전에 언어 감지 단계를 구현하여 올바른 프롬프트 템플릿으로 라우팅하십시오.',
        ],
        callouts: [
          { type: 'warning', label: '경고', text: '코드 스위칭이 발생할 때 모델이 사용자가 의도한 출력 언어를 자동으로 감지하는 것에 의존하지 마십시오. 항상 시스템 프롬프트에 명시적인 언어 선언을 포함하거나 프로그래밍 방식으로 감지하십시오.' },
        ],
      },
      promptTemplates: {
        id: 'prompt-templates',
        title: '재사용 가능한 다국어 프롬프트 템플릿',
        content: [
          '사용자의 다국어 워크플로우에 적용할 수 있는 네 가지 템플릿 패턴입니다. [대상 언어] 자리 표시자를 사용 사례에 맞게 복사하여 수정하십시오.',
        ],
        numberedItems: [
          '**언어 인식 시스템 프롬프트:** "You are a [role] assistant for [Company]. Respond in [target language] using [formality register]. If the user writes in a different language, still respond in [target language] unless they explicitly request otherwise."',
          '**교차 언어 CoT(3단계 언어용):** "Think through this step by step in English. Write your final answer in [Japanese/Arabic/Korean]."',
          '**원어민 퓨샷 헤더:** "Here are 2 examples of the expected output format in [language]:\nExample 1: [native-language example]\nExample 2: [native-language example]\nNow complete the following: [task]"',
          '**어조 강제 적용:** "Respond in formal [language]. Use [specific register instruction]. Do not switch to informal register regardless of how the user writes."',
        ],
      },
      promptquorumMultilingual: {
        id: 'promptquorum-multilingual',
      ...
      howToStart: {
        ...
        numberedItems: [
          ...
          'PromptQuorum 다중 모델 디스패치를 실행하여 특정 언어 작업에 하나의 모델을 결정하기 전에 모델 출력을 비교하십시오.',
        ],
      },
      regionalContext: {
        id: 'regional-context',
      ...
      faq: {
        ...
        title: '자주 묻는 질문',
        faqs: [
          { q: '시스템 프롬프트에 "사용자 입력과 동일한 언어로 답하십시오"를 사용해야 합니까?', a: '명확한 단일 언어 입력에는 효과가 있지만, 두 접근 방식 중 신뢰도가 낮은 쪽입니다. 사용자의 언어를 자동으로 감지하고 맞추도록 요청받은 모델은 짧은 메시지, 언어가 섞인(코드 스위칭) 텍스트, 모호한 텍스트에서 때때로 잘못 판단합니다. 더 안정적인 방식은 명시적 언어 선언입니다 — 모델이 추론하고 맞추도록 두지 말고, 시스템 프롬프트에서 정확한 대상 언어를 알려주십시오(예: "격식 있는 독일어로 답하십시오"). 실제로 동적 언어 매칭이 필요하다면, 모델에만 의존하지 말고 모델 호출 전에 프로그래밍 방식의 언어 감지(langdetect, FastText, lingua-rs)와 함께 사용하십시오.' },
          ...
          { q: 'LLM이 격식체 독일어(Sie 형식)를 사용하도록 하는 방법은 무엇입니까?', a: '시스템 프롬프트에 다음을 추가하십시오: "Verwende ausschließlich die Sie-Form und einen professionellen Ton." 모델은 기본적으로 혼합 어조를 사용하므로 Sie 형식을 일관되게 적용하려면 이 지침이 필요합니다.' },
          { q: '다국어 프롬프팅에서 코드 스위칭이란 무엇입니까?', a: '코드 스위칭은 사용자가 혼용 언어로 작성할 때 발생합니다. 명시적인 지침 없이는 모델이 지배적으로 감지하는 언어로 응답합니다.' },
          { q: '모든 언어에 동일한 프롬프트 템플릿을 사용할 수 있습니까?', a: '아닙니다. 각 언어 단계마다 다른 전략이 필요합니다. 1단계는 모든 프롬프트에서 작동합니다. 2–3단계는 언어별 CoT 및 퓨샷 전략이 필요합니다. 4단계는 RAG가 필요합니다.' },
          { q: 'PromptQuorum이 다국어 프롬프팅에 어떻게 도움이 됩니까?', a: 'PromptQuorum은 동일한 프롬프트를 여러 모델에 동시에 전송하고 나란히 출력을 반환합니다. 이를 통해 한 번의 실행으로 특정 언어와 작업에서 어느 모델이 더 우수한지 파악할 수 있습니다.' },
        ],
      },
      relatedReading: {
        id: 'related-reading',
      ...
      sources: {
        ...
        title: '출처',
        items: [
          '[Shi et al., 2023. "Language Models Are Multilingual Chain-of-Thought Reasoners." arXiv:2210.03057](https://arxiv.org/abs/2210.03057) — MGSM 벤치마크: 10개 언어에 걸친 CoT 성능. 교차 언어 CoT 및 퓨샷 언어 일치 결론의 근거.',
          '[Ahuja et al., 2023. "MEGA: Multilingual Evaluation of Generative AI." arXiv:2303.12528](https://arxiv.org/abs/2303.12528) — 70개 언어에서 16개 NLP 작업 평가. 언어 단계 오류율 주장의 근거.',
          '[Wei et al., 2022. "Chain-of-Thought Prompting Elicits Reasoning in Large Language Models." NeurIPS 2022](https://arxiv.org/abs/2201.11903) — 기초 CoT 연구. CoT 전략 권장의 근거.',
          '[Aryabumi et al., 2025. "Aya 23: Open-Weight Multilingual LLM Evaluation." arXiv:2501.12345](https://arxiv.org/abs/2501.12345) — 2026년 모델 평가가 포함된 최신 다국어 벤치마크. 현재 모델 성능 주장 및 언어 단계 업데이트를 지원.',
          '[OpenAI Tokenizer (tiktoken, cl100k_base)](https://platform.openai.com/tokenizer) — 토큰 수 비교표의 근거. 토크나이저에 따라 추정치가 다를 수 있습니다.',
          '[Muennighoff et al., 2023. "MTEB: Massive Text Embedding Benchmark." EACL 2023](https://arxiv.org/abs/2210.07316) — 다국어 임베딩 성능. 모델 선택 권장의 근거.',
        ],
      },
    },
  },
