...
export const article: Record<Language, PEArticle> = {
  en: {
    ...
    metaDescription: 'Support team prompts: triage templates, escalation logic, tone controls, compliance guardrails, edge case testing, human handoff patterns.',
  ...
  de: {
    ...
    metaDescription: 'PE für Support-Teams: Triage-Templates, Eskalationslogik, Tonsteuerung, Compliance-Guardrails, Edge-Case-Tests, Human-Handoff-Muster.',
  ...
  fr: {
    ...
    seoTitle: 'Prompts pour équipes support : templates',
  ...
  zh: {
    ...
    metaDescription: '支持团队的提示词工程：分诊模板、升级逻辑、语气控制、策略合规护栏、边缘案例测试和人工交接模式，确保高质量的客户响应。',
