...
export const article: Partial<Record<Language, PEArticle>> = {
  en: {
    ...
    schema: {
      ...
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/prompt-engineering/prompt-engineering-for-support-operations',
  ...
  de: {
    ...
    schema: {
      ...
      headline: 'Prompt Engineering für Support-Operationen',
    ...
    sections: {
      ...
      related_reading: {
        ...
        items: [
          ...
          { title: 'Bauen Sie Ihren eigenen Prompt-Framework', url: '/de/prompt-engineering/build-your-own-prompt-framework' },
          { title: 'Prompt-Governance in Produktion', url: '/de/prompt-engineering/prompt-governance-in-production' },
  ...
  es: {
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/es/prompt-engineering/prompt-engineering-for-support-operations',
    ...
    sections: {
      ...
      related_reading: {
        ...
        items: [
          ...
          { title: 'Gobernanza de prompts en producción', url: '/es/prompt-engineering/prompt-governance-in-production' },
  ...
  pt: {
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/pt/prompt-engineering/prompt-engineering-for-support-operations',
  ...
  fr: {
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/fr/prompt-engineering/prompt-engineering-for-support-operations',
    ...
    sections: {
      ...
      related_reading: {
        ...
        items: [
          ...
          { title: 'Gouvernance des prompts en production', url: '/fr/prompt-engineering/prompt-governance-in-production' },
  ...
  ja: {
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/ja/prompt-engineering/prompt-engineering-for-support-operations',
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          ...
          { q: '日本でのサポートチーム向けの追加要件は？', a: '日本のサポートチームはMETI AI Governanceガイドラインに準拠する必要があります。モデル選択には日本語サポートとMETIコンプライアンスを確認してください。エスカレーション規則を日本の消費者保護法に合わせます。' },
        ],
      },
      related_reading: {
        id: 'related-reading',
        ...
        items: [
          ...
          { title: '独自のプロンプトフレームワークを構築する', url: '/ja/prompt-engineering/build-your-own-prompt-framework' },
          { title: '本番環境でのプロンプトガバナンス', url: '/ja/prompt-engineering/prompt-governance-in-production' },
      ...
      sources: {
        ...
        items: [
          ...
          { title: 'METI AI Governanceフレームワーク', url: 'https://www.meti.go.jp/english/' },
  ...
  zh: {
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/zh/prompt-engineering/prompt-engineering-for-support-operations',
    ...
    sections: {
      ...
      tldr: {
        ...
        title: 'TL;DR',
        isTldr: true,
        content: '支持提示词需要比其他大多数提示词类型更严格的约束，因为错误对客户、对策略敏感、通常在法律上很重要。分诊提示词将问题路由到3个级别：级别1（AI解决）、级别2（需要调查）、级别3（人工升级）。支持语气编码3–5个语调样本，并在模型间测试一致性。策略合规护栏（参考文件、决策树）必须明确包含在提示词中。5个普遍的升级触发器：法律语言、账户取消、数据安全、同一问题的重复P1、人工明确请求。人工移交使用中立的客户消息——"我正在将您转接给一位专家"，而不是"对不起，我无法帮助"。中国《数据安全法》要求在多模型测试中验证本地化部署和数据驻留政策。',
      },
      faq: {
        id: 'faq',
        title: '常见问题',
        faqs: [
          ...
          { q: '中国团队对支持提示词有什么额外要求？', a: '中国《数据安全法》要求在多模型选择中验证本地化部署和数据驻留政策。在升级规则中包括GDPR和本地数据保护法要求。' },
        ],
      },
      related_reading: {
        id: 'related-reading',
        ...
        items: [
          ...
          { title: '构建你的提示词框架', url: '/zh/prompt-engineering/build-your-own-prompt-framework' },
          { title: '生产环境中的提示词治理', url: '/zh/prompt-engineering/prompt-governance-in-production' },
      ...
      sources: {
        ...
        items: [
          ...
          { title: '中国数据安全法', url: 'https://www.cac.gov.cn/' },
  ...
  ar: {
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/ar/prompt-engineering/prompt-engineering-for-support-operations',
    ...
    sections: {
      ...
      related_reading: {
        ...
        items: [
          ...
          { title: 'بناء إطار عملك الخاص للبرومبت', url: '/ar/prompt-engineering/build-your-own-prompt-framework' },
          { title: 'حوكمة البرومبت في الإنتاج', url: '/ar/prompt-engineering/prompt-governance-in-production' },
