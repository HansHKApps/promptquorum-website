  ...
  de: {
    ...
    sections: {
      ...
      related_reading: {
        ...
        items: [
          { title: 'Prompt-Injektion und Sicherheit', url: '/prompt-engineering/prompt-injection-and-security?lang=de' },
          { title: 'Bauen Sie Ihren eigenen Prompt-Framework', url: '/prompt-engineering/build-your-own-framework?lang=de' },
          { title: 'Prompt-Governance in Produktion', url: '/prompt-engineering/prompt-governance-production?lang=de' },
          { title: 'Prompt-Review-Workflow für Teams', url: '/prompt-engineering/prompt-review-workflow-for-teams?lang=de' },
          { title: 'Prompts zu wiederholbaren Workflows', url: '/prompt-engineering/prompts-to-repeatable-workflows?lang=de' },
          { title: 'Negatives Prompting', url: '/prompt-engineering/negative-prompting?lang=de' },
        ],
      },
      sources: {
        id: 'sources',
  ...
  fr: {
    ...
    sections: {
      ...
      related_reading: {
        ...
        items: [
          { title: 'Injection de prompts et sécurité', url: '/prompt-engineering/prompt-injection-and-security?lang=fr' },
          { title: 'Créer votre propre framework de prompts', url: '/prompt-engineering/build-your-own-framework?lang=fr' },
          { title: 'Gouvernance des prompts en production', url: '/prompt-engineering/prompt-governance-production?lang=fr' },
          { title: 'Workflow d\'examen des prompts pour les équipes', url: '/prompt-engineering/prompt-review-workflow-for-teams?lang=fr' },
          { title: 'Des prompts aux processus reproductibles', url: '/prompt-engineering/prompts-to-repeatable-workflows?lang=fr' },
          { title: 'Prompting négatif', url: '/prompt-engineering/negative-prompting?lang=fr' },
        ],
      },
      sources: {
        id: 'sources',
    ...
    sections: {
      ...
      related_reading: {
        ...
        items: [
          ...
          { title: '独自のプロンプトフレームワークを構築する', url: '/prompt-engineering/build-your-own-framework?lang=ja' },
          { title: '本番環境でのプロンプトガバナンス', url: '/prompt-engineering/prompt-governance-production?lang=ja' },
          { title: 'チーム向けプロンプトレビューワークフロー', url: '/prompt-engineering/prompt-review-workflow-for-teams?lang=ja' },
          { title: 'プロンプトから反復可能なワークフローへ', url: '/prompt-engineering/prompts-to-repeatable-workflows?lang=ja' },
          { title: 'ネガティブプロンプティング', url: '/prompt-engineering/negative-prompting?lang=ja' },
        ],
      },
      sources: {
        id: 'sources',
  ...
  zh: {
    ...
    sections: {
      ...
      related_reading: {
        ...
        title: '相关资料',
        items: [
          { title: '提示词注入与安全', url: '/prompt-engineering/prompt-injection-and-security?lang=zh' },
          { title: '构建你的提示词框架', url: '/prompt-engineering/build-your-own-framework?lang=zh' },
          { title: '生产环境中的提示词治理', url: '/prompt-engineering/prompt-governance-production?lang=zh' },
          { title: '团队提示词审核工作流', url: '/prompt-engineering/prompt-review-workflow-for-teams?lang=zh' },
          { title: '从提示词到可重复工作流', url: '/prompt-engineering/prompts-to-repeatable-workflows?lang=zh' },
          { title: '负面提示', url: '/prompt-engineering/negative-prompting?lang=zh' },
        ],
      },
      sources: {
        id: 'sources',
