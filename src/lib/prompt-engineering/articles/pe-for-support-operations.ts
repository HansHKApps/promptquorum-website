...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'برومبتات الدعم: دليل القوالب',
    metaDescription: 'صمّم برومبتات الدعم للفرز والتصعيد والتحكم في النبرة. تمنع الضمانات أخطاء السياسات وتوضح متى يجب تصعيد الحالة.',
