      ...
      sections: {
        ...
        howPQImplements: {
          ...
          items: [
            ...
            'Apply the same CRAFT-based prompt to multiple models in parallel, comparing how GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro, and local models respond to the same creative brief.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'Can I use CRAFT with any language model?', a: 'Yes. CRAFT works with GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro, Mistral, and any other model. The framework is model-agnostic; it structures your prompt clearly for any LLM.' },
      ...
      sections: {
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'Kann ich CRAFT mit jedem Sprachmodell verwenden?', a: 'Ja. CRAFT funktioniert mit GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro, Mistral und jedem anderen Modell. Das Framework ist modellunabhängig; es strukturiert Ihren Prompt klar für alle LLMs.' },
      ...
      sections: {
        ...
        howPQImplements: {
          ...
          items: [
            ...
            'Aplicar el mismo prompt basado en CRAFT a múltiples modelos en paralelo, comparando cómo GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro y modelos locales responden al mismo brief creativo.',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: '¿Puedo usar CRAFT con cualquier modelo de lenguaje?', a: 'Sí. CRAFT funciona con GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro, Mistral y cualquier otro modelo. El framework es agnóstico al modelo; estructura tu prompt claramente para cualquier LLM.' },
      ...
      sections: {
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'Puis-je utiliser CRAFT avec n\'importe quel modèle de langage ?', a: 'Oui. CRAFT fonctionne avec GPT-4o, Claude Opus 4.7, Gemini 3.1 Pro, Mistral et n\'importe quel autre modèle. Le framework est agnostique aux modèles ; il structure votre prompt clairement pour tout LLM.' },
      ...
      sections: {
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'CRAFTをどのような言語モデルでも使用できますか？', a: 'はい。CRAFTはGPT-4o、Claude Opus 4.7、Gemini 3.1 Pro、Mistral、その他すべてのモデルで機能します。フレームワークはモデルに依存しません。すべてのLLMの入力内容を明確に構造化します。' },
      ...
      sections: {
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: '我可以将CRAFT与任何语言模型一起使用吗？', a: '可以。CRAFT适用于GPT-4o、Claude Opus 4.7、Gemini 3.1 Pro、Mistral和任何其他模型。该框架与模型无关；它为所有LLM清晰地结构化您的提示。' },
