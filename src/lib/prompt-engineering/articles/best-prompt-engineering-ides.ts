...
export const article: Partial<Record<Language, PEArticle>> = {
  en: {
    ...
    heroImage: '/images/best-prompt-engineering-ides-overview-hero-en.webp',
    ...
    leadAnswerBlock: '**A prompt engineering IDE is a specialized editor that minimizes friction between idea and execution — covering model switching, playground execution, prompt history, export to code, and cost visibility. No single IDE covers all six criteria.**',
    quickFacts: [
  ...
  de: {
    ...
    heroImage: '/images/best-prompt-engineering-ides-overview-hero-de.webp',
    ...
    sections: {
      ...
      openAIPlayground: {
        ...
        numberedItems: [
          ...
          'Modellauswahl: GPT-5.6, GPT-5.6 Luna, individuelle Fine-Tunes',
  ...
  es: {
    theme: 'Tools & Platforms',
    heroImage: '/images/best-prompt-engineering-ides-overview-hero-es.webp',
    ...
    sections: {
      ...
      openAIPlayground: {
        ...
        numberedItems: [
          ...
          'Selección de modelo: GPT-5.6, GPT-5.6 Luna, fine-tunes personalizados',
  ...
  pt: {
    theme: 'Tools & Platforms',
    heroImage: '/images/best-prompt-engineering-ides-overview-hero-pt.webp',
    ...
    sections: {
      ...
      openAIPlayground: {
        ...
        numberedItems: [
          ...
          'Seleção de modelo: GPT-5.6, GPT-5.6 Luna, fine-tunes personalizados',
  ...
  fr: {
    ...
    heroImage: '/images/best-prompt-engineering-ides-overview-hero-fr.webp',
    ...
    sections: {
      ...
      openAIPlayground: {
        ...
        numberedItems: [
          ...
          'Sélection de modèles : GPT-5.6, GPT-5.6 Luna, fine-tunes personnalisés',
  ...
  ja: {
    theme: 'ツール＆プラットフォーム',
    heroImage: '/images/best-prompt-engineering-ides-overview-hero-ja.webp',
    ...
    sections: {
      ...
      openAIPlayground: {
        ...
        numberedItems: [
          ...
          'モデル選択：GPT-5.6、GPT-5.6、GPT-5.6 Luna、カスタムファインチューン',
      ...
      anthropicConsole: {
        ...
        content: '**Anthropic Console（console.anthropic.com）はClaudeモデルとシステムプロンプトのテストに最適化されています。** 複雑なシステムプロンプトを作成し、複数のClaudeバージョン（Claude Sonnet 5、Claude Opus 5）に対してテストし、出力を並べて比較できます。画像入力のビジョンサポートあり。',
        numberedItems: [
          'Claude固有の開発とシステムプロンプトの最適化に最適',
          'Claude Sonnet 5、Claude Opus 5、Claude Haiku 4.5（最新バージョン）をサポート',
  ...
  zh: {
    theme: 'AI工具与平台',
    heroImage: '/images/best-prompt-engineering-ides-overview-hero-zh.webp',
    ...
    sections: {
      ...
      openAIPlayground: {
        ...
        numberedItems: [
          ...
          '模型选择：GPT-5.6、GPT-5.6、GPT-5.6 Luna、自定义微调模型',
          '一键导出curl/Python/JS',
        ],
        callouts: [
      ...
      anthropicConsole: {
        ...
        content: '**Anthropic Console（console.anthropic.com）专为测试Claude模型和系统提示词而优化。** 可设计复杂系统提示词，在多个Claude版本（Claude Sonnet 5、Claude Opus 5）上测试，并排对比输出结果。支持图像输入的视觉功能。',
        numberedItems: [
          '最适合Claude专项开发和系统提示词优化',
          '支持Claude Sonnet 5、Claude Opus 5、Claude Haiku 4.5（当前版本）',
  ...
  ar: {
    ...
    theme: 'Tools & Platforms',
    heroImage: '/images/best-prompt-engineering-ides-overview-hero-ar.webp',
    ...
    sections: {
      ...
      openAIPlayground: {
        ...
        content: '**OpenAI Playground هي بيئة ويب لاختبار نماذج GPT بضبط البارامترات مباشرة — الأسرع للتجربة التجريبية مع GPT-5.6 وGPT-5.6 Luna.** لا حاجة لأي إعداد، تعمل في ثوانٍ.',
        items: [
      ...
      anthropicConsole: {
        ...
        content: '**Claude Console من Anthropic هي بيئة اختبار Claude الرسمية — مثالية لاستكشاف قدرات Claude Opus 5 مع دعم سياق يصل إلى 1M token.** الأنسب لمن يريد اختبار برومبتات طويلة أو مستندات كبيرة.',
        items: [
      ...
      regionalContext: {
        id: 'regional-context',
        title: 'توفر بيئات تطوير هندسة الأوامر حسب المنطقة',
        content: '**يعتمد اختيار بيئة التطوير على المكان الذي تعمل فيه وعلى متطلبات خصوصية البيانات المطبقة.** ترسل بيئات التجريب السحابية (Cursor وOpenAI Playground وClaude Console وGoogle AI Studio) الأوامر افتراضياً إلى خوادم موجودة في الولايات المتحدة. أما LM Studio وVS Code مع Ollama محلياً فيبقيان كل البيانات على الجهاز نفسه.\n\n**الاتحاد الأوروبي / GDPR:** تتطلب بيئات التجريب السحابية مراجعة اتفاقية معالجة البيانات (DPA) الخاصة بكل مزود قبل استخدامها مع بيانات حساسة. أما LM Studio وVS Code مع Ollama فهما آمنان وفق GDPR لأي نوع من البيانات، إذ لا يحدث أي إرسال خارجي.\n\n**اليابان / APPI:** تنطبق الاعتبارات نفسها المتعلقة بنقل البيانات إلى السحابة. وتتجه الشركات اليابانية الخاضعة لمتطلبات الامتثال لقانون APPI إلى استخدام VS Code مع Ollama محلياً أو LM Studio لاختبار الأوامر داخلياً.\n\n**الصين:** يُحجب كل من OpenAI Playground وClaude Console في البر الرئيسي للصين. ويُعد LM Studio مع Qwen3 8B (بعد تنزيله محلياً) البديل الأكثر استخداماً للتطوير دون اتصال.\n\n**الخليج والشرق الأوسط:** تدفع متطلبات سيادة البيانات — مثل نظام حماية البيانات الشخصية السعودي (PDPL) وقانون حماية البيانات في الإمارات — الجهات في القطاعين الحكومي والمالي نحو الاستدلال المحلي. ويبقي تشغيل النماذج عبر LM Studio أو Ollama البيانات داخل الحدود الوطنية دون الحاجة إلى مراجعة عقود نقل البيانات عبر الحدود.',
      },
      relatedReading: {
        id: 'related-reading',
  ...
  ko: {
    theme: 'Tools & Platforms',
    heroImage: '/images/best-prompt-engineering-ides-overview-hero-ko.webp',
    ...
    schema: {
      ...
      openAIPlayground: {
        ...
        numberedItems: [
          ...
          '모델 선택: GPT-5.6, GPT-5.6 Luna, 커스텀 파인튜닝',
