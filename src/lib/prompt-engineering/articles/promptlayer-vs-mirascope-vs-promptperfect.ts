...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  es: {
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/es/es/prompt-engineering/promptlayer-vs-mirascope-vs-promptperfect',
      inLanguage: 'es',
      about: [
  ...
  ar: {
    ...
    seoTitle: 'PromptLayer vs Mirascope vs PromptPerfect 2026: اختر الأداة المناسبة',
    metaDescription: 'PromptLayer ($49/شهر) يسجّل استدعاءات نماذج اللغة، Mirascope (مجاني) يبني تطبيقات Python، وPromptPerfect ($20/شهر) يُعيد كتابة الموجّهات. مشاكل مختلفة: اختر واحدة.',
