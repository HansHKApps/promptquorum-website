...
export const article: Record<Language, PEArticle> = { en: {
  ...
  seoTitle: 'Prompt Testing Tools 2026: Promptfoo vs Braintrust vs DeepEval',
  metaDescription: 'Promptfoo catches regressions in seconds (free). Braintrust batch-evals with human judges. DeepEval scores RAG with RAGAS. Comparison table + stack guide inside.',
  ogTitle: 'Promptfoo Runs in Seconds. Braintrust Takes Hours. Which Do You Need?',
  ogDescription: 'Fast CI/CD tests vs slow batch evals vs RAG scoring. 5 tools compared by speed, cost, and use case. Comparison table inside.',
  twitterTitle: 'Prompt Testing Tools 2026: CI/CD vs Batch Eval vs RAG Scoring',
  twitterDescription: 'Self-evaluation inflates scores 10–20%. Test GPT-5.5? Grade with Claude. The full testing stack: Promptfoo → Braintrust → DeepEval → LangSmith → Phoenix.',
  ...
  title: 'Prompt-Testing-Tools 2026: Promptfoo, Braintrust, DeepEval',
  seoTitle: 'Prompt-Testing-Tools 2026: Promptfoo vs Braintrust vs DeepEval',
  metaDescription: 'Promptfoo erkennt Regressionen in Sekunden (kostenlos). Braintrust führt Batch-Evals mit menschlichen Prüfern durch. DeepEval bewertet RAG-Pipelines mit RAGAS. Vergleich + Stack-Guide.',
  ogTitle: 'Promptfoo läuft in Sekunden. Braintrust braucht Stunden. Was brauchen Sie?',
  ogDescription: 'Schnelle CI/CD-Tests vs. langsame Batch-Evals vs. RAG-Scoring. 5 Tools nach Geschwindigkeit, Kosten und Einsatzzweck verglichen.',
  twitterTitle: 'Prompt-Testing-Tools 2026: CI/CD vs. Batch-Eval vs. RAG-Scoring',
  twitterDescription: 'Selbstbewertung bläht Scores um 10–20 % auf. GPT-5.5 testen? Mit Claude bewerten. Der vollständige Testing-Stack im Überblick.',
  ...
  seoTitle: 'Outils de test de prompts 2026 : Promptfoo vs Braintrust vs DeepEval',
  metaDescription: 'Promptfoo détecte les régressions en secondes (gratuit). Braintrust évals batch avec juges humains. DeepEval évalue RAG via RAGAS. Comparatif + recommandations de stack.',
  ogTitle: 'Promptfoo en secondes. Braintrust en heures. Lequel vous faut-il ?',
  ogDescription: 'Tests CI/CD rapides vs évals batch lentes vs scoring RAG. 5 outils comparés par vitesse, coût et usage.',
  twitterTitle: 'Outils de test de prompts 2026 : CI/CD vs batch vs RAG',
  twitterDescription: 'L\'auto-évaluation gonfle les scores de 10–20 %. Testez GPT-5.5 ? Évaluez avec Claude. Le stack de test complet détaillé.',
  ...
  seoTitle: 'プロンプトテストツール2026：Promptfoo vs Braintrust vs DeepEval',
  metaDescription: 'Promptfooは数秒でリグレッションを検出。Braintrustは人間の評価者によるバッチ評価。DeepEvalはRAGAS指標でRAGを評価。比較表＋スタック構成ガイド。',
  ogTitle: 'Promptfooは数秒。Braintrustは数時間。あなたに必要なのは？',
  ogDescription: '高速CI/CDテスト vs 低速バッチ評価 vs RAGスコアリング。5ツールを速度・コスト・用途で比較。',
  twitterTitle: 'プロンプトテストツール2026：CI/CD vs バッチ評価 vs RAG',
  twitterDescription: '自己評価はスコアを10〜20%水増しする。GPT-5.5をテスト？Claudeで採点。完全なテストスタック構成を解説。',
  ...
  seoTitle: '提示词测试工具2026：Promptfoo vs Braintrust vs DeepEval',
  metaDescription: 'Promptfoo数秒内检测回归（免费）。Braintrust支持人工评审的批量评估。DeepEval用RAGAS指标评估RAG。对比表+技术栈推荐。',
  ogTitle: 'Promptfoo只需几秒。Braintrust需要几小时。你需要哪个？',
  ogDescription: '快速CI/CD测试 vs 慢速批量评估 vs RAG评分。5款工具按速度、成本和用途对比。',
  twitterTitle: '提示词测试工具2026：CI/CD vs 批量评估 vs RAG评分',
  twitterDescription: '自我评估使分数虚高10–20%。测试GPT-5.5？用Claude打分。完整测试技术栈详解。',
