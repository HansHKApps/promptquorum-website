...
export const article: Partial<Record<Language, PEArticle>> = { en: {
  ...
  metaDescription: 'Promptfoo catches regressions in seconds (free). Braintrust runs batch evals with human judges ($500/mo). DeepEval scores RAG with RAGAS metrics. LangSmith traces failures. Phoenix monitors production. Full pipeline comparison.',
  ...
  twitterDescription: 'Self-eval inflates scores 10–20%. Test GPT-4o? Grade with Claude. The full stack: Promptfoo → Braintrust → DeepEval → LangSmith → Phoenix.',
  ...
  twitterDescription: 'Selbstbewertung bläht Scores um 10–20 % auf. GPT-4o testen? Mit Claude bewerten. Promptfoo → Braintrust → DeepEval → LangSmith → Phoenix.',
  ...
  faqSchema: {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Ein LLM-as-Judge nutzt ein anderes LLM (GPT-4o, Claude) zur Bewertung Ihrer Ausgabe. Dies skaliert Evaluierungen ohne Menschen, kann aber verzerrt sein.'
        }
      },
      {
        '@type': 'Question',
  ...
  sections: {
    ...
    promptquorum: {
      ...
      content: '**Nutzen Sie PromptQuorum, um zu vergleichen, wie derselbe Prompt über GPT-4o, Claude, Gemini und lokale LLMs in einem einzigen Dispatch hinweg funktioniert – bevor Sie sich auf ein Modell für Ihre Test-Suite festlegen.** Promptfoo und Braintrust testen ein Modell nach dem anderen. PromptQuorum beantwortet „Welches Modell sollte ich testen?" in Sekunden.',
      numberedItems: [
    ...
    commonMistakes: {
      ...
      mistakes: [
        ...
        },
        {
          ...
          problem: 'Selbstbewertung bläht Scores um 10–20 % auf. GPT-4o benoten GPT-4o-Ausgabe ist nicht unabhängige Verifikation.',
    ...
    faq: {
      ...
      faqs: [
        ...
        },
        {
          ...
          a: 'Ein LLM-as-Judge nutzt ein anderes LLM (GPT-4o, Claude) zur Bewertung Ihrer Ausgabe gegen eine Richtlinie. Dies skaliert Evaluierungen ohne menschliche Prüfung, kann aber verzerrt sein. Die meisten Tools unterstützen dies.'
        },
        {
  ...
  metaDescription: 'Promptfoo detecta regresiones en segundos (gratis). Braintrust ejecuta evals batch con jueces humanos ($500/mes). DeepEval puntúa RAG con métricas RAGAS. LangSmith traza fallos. Phoenix monitoriza producción. Comparativa completa del pipeline.',
  ...
  twitterDescription: 'La auto-evaluación infla los scores un 10–20%. ¿Testeas GPT-4o? Puntúa con Claude. El stack completo: Promptfoo → Braintrust → DeepEval → LangSmith → Phoenix.',
  ...
  faqSchema: {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: '¿Qué es un LLM-as-judge?', acceptedAnswer: { '@type': 'Answer', text: 'Un LLM-as-judge usa otro LLM (GPT-4o, Claude) para puntuar tu output según una rúbrica. Escala la evaluación sin revisión humana, pero puede tener sesgo. La mayoría de herramientas lo soportan.' } }
    ]
  },
  itemListSchema: {
    '@context': 'https://schema.org',
  ...
  sections: {
    ...
    whyTestPrompts: {
      ...
      content: '**Esta guía se centra exclusivamente en herramientas de testing y evaluación.** Para el panorama completo de herramientas de prompt engineering, consulta [Mejores herramientas de prompt engineering 2026](/es/prompt-engineering/best-prompt-engineering-tools-2026). Para características de colaboración en equipo, consulta [Mejores herramientas de optimización de prompts para equipos](/es/prompt-engineering/best-prompt-optimization-tools-for-teams).\n\n**Los cambios de prompts rompen producción.** Una sola reformulación puede reducir la precisión un 5–10%, perder edge cases o cambiar el tono. A abril de 2026, la mayoría de empresas no testea prompts en absoluto, enviando cambios ad-hoc. El testing detecta regresiones antes de que lleguen a los usuarios. Existen dos flujos de trabajo: tests unitarios rápidos en [CI/CD](/es/prompt-engineering/ci-cd-for-prompts) (segundos, automatizados) y evals batch lentos offline (minutos a horas, revisión humana). Sin testing, no puedes iterar con seguridad.',
      snippets: [
    ...
    comparisonTable: {
      ...
      content: '**A abril de 2026, este es el desglose de características:**',
      ...
      rows: [
        ...
        { Herramienta: 'Braintrust', Velocidad: 'Minutos–horas', 'Caso de uso': 'Eval batch, aprobación', 'CI/CD': '✓ API', 'Revisión humana': '✅ Sí', Precios: '~$500/mes' },
    ...
    commonMistakes: {
      ...
      mistakes: [
        ...
        { mistake: 'Puntuar con el mismo LLM que estás testeando', problem: 'La auto-evaluación infla los scores un 10–20%. GPT-4o puntuando su propio output no es verificación independiente.', fix: 'Usa un modelo diferente para puntuar. Testea GPT-4o → puntúa con Claude. O usa jueces humanos para el ground truth.' },
    ...
    faq: {
      ...
      faqs: [
        ...
        { q: '¿Qué es un LLM-as-judge?', a: 'Un LLM-as-judge usa otro LLM (GPT-4o, Claude) para puntuar tu output según una rúbrica. Escala la evaluación sin revisión humana, pero puede tener sesgo. La mayoría de herramientas lo soportan.' }
      ]
    },
    sources: {
      title: 'Fuentes',
  ...
  metaDescription: 'Promptfoo détecte les régressions en secondes (gratuit). Braintrust exécute des évals batch avec juges humains (500 $/mois). DeepEval évalue le RAG avec RAGAS. LangSmith trace les erreurs. Phoenix surveille la production.',
  ...
  twitterDescription: 'L\'auto-évaluation gonfle les scores de 10–20 %. Testez GPT-4o ? Évaluez avec Claude. Promptfoo → Braintrust → DeepEval → LangSmith → Phoenix.',
  ...
  faqSchema: {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'Qu\'est-ce qu\'un LLM-as-judge ?', acceptedAnswer: { '@type': 'Answer', text: 'Un LLM-as-judge utilise un autre LLM (GPT-4o, Claude) pour évaluer votre sortie selon une rubrique. Cela évalue sans révision humaine mais peut être biaisé. La plupart des outils le supportent.' } },
  ...
  metaDescription: 'Promptfooは数秒でリグレッション検出（無料）。Braintrustは人間評価者によるバッチ評価（月額500ドル）。DeepEvalはRAGAS指標でRAGを評価。LangSmithは障害をトレース。Phoenixは本番を監視。',
  ...
  twitterDescription: '自己評価はスコアを10〜20%水増し。GPT-4oをテスト？Claudeで採点。Promptfoo→Braintrust→DeepEval→LangSmith→Phoenix。',
  ...
  twitterDescription: '自我评估使分数虚高10–20%。测试GPT-4o？用Claude打分。Promptfoo→Braintrust→DeepEval→LangSmith→Phoenix。',
  ...
  faqSchema: {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'LLM-as-Judge使用另一个LLM（GPT-4o、Claude）根据标准评估您的输出。它在没有人类审查的情况下扩展评估，但可能存在偏见。大多数工具支持此功能。'
        }
      },
      {
        '@type': 'Question',
  ...
  sections: {
    ...
    whyTestPrompts: {
      title: '为什么要测试提示词？',
      content: '**本指南仅关注测试和评估工具。** 有关完整的提示词工程工具景观，请参见[2026年最佳提示词工程工具](/zh/prompt-engineering/best-prompt-engineering-tools-2026)。有关团队协作功能，请参见[2026年团队最佳提示词优化工具](/zh/prompt-engineering/best-prompt-optimization-tools-for-teams)。\n\n**提示词变更会破坏生产。** 单一的措辞改变可能会使准确性下降5-10%，错过边界情况，或改变语调。截至2026年4月，大多数公司根本不测试提示词，而是临时发布变更。测试在错误到达用户前捕获回归。存在两种工作流：[CI/CD](/zh/prompt-engineering/ci-cd-for-prompts)中的快速单元测试（秒级、自动化）和离线缓慢批量评估（分钟到小时、人类审查）。没有测试，您无法安全地迭代。'
    },
    promptfoo: {
      title: 'Promptfoo：快速CI/CD测试',
      content: '**Promptfoo是开源的、CLI优先的，为CI/CD管道构建。** 它在秒内运行，在每次提交时捕获回归，如果分数下降则使构建失败。使用提示和测试用例编写YAML配置，运行promptfoo eval，获得分数。Promptfoo支持字符串相似度、正则表达式、[LLM-as-Judge](/zh/prompt-engineering/llm-as-judge-evaluation)和自定义评估器。',
      numberedItems: [
    ...
    promptquorum: {
      ...
      content: '**在为测试套件确定模型前，使用PromptQuorum在单个分派中对比GPT-4o、Claude、Gemini和本地LLM上同一提示的表现。** Promptfoo和Braintrust一次只测试一个模型。PromptQuorum在秒内回答"我应该测试哪个模型？"。',
      numberedItems: [
    ...
    commonMistakes: {
      ...
      mistakes: [
        ...
        },
        {
          ...
          problem: '自我评估使分数虚高10-20%。GPT-4o评估GPT-4o输出不是独立验证。',
    ...
    faq: {
      ...
      faqs: [
        ...
        {
          q: '什么是LLM-as-Judge？',
          a: 'LLM-as-Judge使用另一个LLM（GPT-4o、Claude）根据标准评估您的输出。它在没有人类审查的情况下扩展评估，但可能存在偏见。大多数工具支持此功能。'
        },
        {
