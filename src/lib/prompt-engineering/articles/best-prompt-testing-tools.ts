...
export const article: Partial<Record<Language, PEArticle>> = { en: {
  ...
  sections: {
    ...
    comparisonTable: {
      ...
      rows: [
        ...
        {
          'Tool': '[DeepEval](https://deepeval.com)',
        ...
        {
          'Tool': '[Phoenix](https://arize.com/phoenix)',
          'Geschwindigkeit': 'Echtzeit',
  ...
  sections: {
    ...
    comparisonTable: {
      ...
      columns: ['Herramienta', 'Velocidad', 'Caso de uso', 'CI/CD', 'Revisión humana', 'Precios'],
      rows: [
        { Herramienta: '[Promptfoo](https://promptfoo.dev)', Velocidad: 'Segundos', 'Caso de uso': 'Tests unitarios, regresión', 'CI/CD': '✅ Nativo', 'Revisión humana': '✗ No', Precios: 'Gratis (MIT)' },
        { Herramienta: '[Braintrust](https://braintrust.dev)', Velocidad: 'Minutos–horas', 'Caso de uso': 'Eval batch, aprobación', 'CI/CD': '✓ API', 'Revisión humana': '✅ Sí', Precios: 'Gratis / $249/mes' },
        { Herramienta: '[DeepEval](https://deepeval.com)', Velocidad: 'Minutos', 'Caso de uso': 'Scoring de pipelines RAG', 'CI/CD': '✓ Python', 'Revisión humana': '✗ No', Precios: 'Gratis + cloud de pago' },
        { Herramienta: '[LangSmith](https://smith.langchain.com)', Velocidad: 'Tiempo real', 'Caso de uso': 'Tracing, depuración', 'CI/CD': '✓ API', 'Revisión humana': '✗ No', Precios: 'Gratis / $50+/mes' },
        { Herramienta: '[Phoenix](https://arize.com/phoenix)', Velocidad: 'Tiempo real', 'Caso de uso': 'Monitorización en producción', 'CI/CD': '✓ API', 'Revisión humana': '✗ No', Precios: 'Gratis (Apache 2.0)' },
        { Herramienta: '[PromptQuorum](https://www.promptquorum.com)', Velocidad: 'Segundos', 'Caso de uso': 'Comparación multi-modelo', 'CI/CD': '✗ No', 'Revisión humana': '✓ Lado a lado', Precios: 'Gratis + créditos' }
      ]
    },
    howToChoose: {
      id: 'how-to-choose',
  ...
  sections: {
    ...
    comparisonTable: {
      ...
      rows: [
        { 'الأداة': '[Promptfoo](https://promptfoo.dev)', 'السرعة': 'ثوانٍ', 'حالة الاستخدام': 'اختبارات الوحدة، التراجع', 'CI/CD': '✅ أصلي', 'المراجعة البشرية': '✗ لا', 'التسعير': 'مجاني (MIT)' },
        { 'الأداة': '[Braintrust](https://braintrust.dev)', 'السرعة': 'دقائق–ساعات', 'حالة الاستخدام': 'تقييم دفعي، موافقة', 'CI/CD': '✓ API', 'المراجعة البشرية': '✅ نعم', 'التسعير': 'مجاني / 249$/شهر' },
        { 'الأداة': '[DeepEval](https://deepeval.com)', 'السرعة': 'دقائق', 'حالة الاستخدام': 'تسجيل خطوط RAG', 'CI/CD': '✓ Python', 'المراجعة البشرية': '✗ لا', 'التسعير': 'مجاني + سحابي مدفوع' },
        { 'الأداة': '[LangSmith](https://smith.langchain.com)', 'السرعة': 'وقت فعلي', 'حالة الاستخدام': 'تتبع، تصحيح', 'CI/CD': '✓ API', 'المراجعة البشرية': '✗ لا', 'التسعير': 'مجاني / 50+$/شهر' },
        { 'الأداة': '[Phoenix](https://arize.com/phoenix)', 'السرعة': 'وقت فعلي', 'حالة الاستخدام': 'مراقبة الإنتاج', 'CI/CD': '✓ API', 'المراجعة البشرية': '✗ لا', 'التسعير': 'مجاني (Apache 2.0)' },
        { 'الأداة': '[PromptQuorum](https://www.promptquorum.com)', 'السرعة': 'ثوانٍ', 'حالة الاستخدام': 'مقارنة متعددة النماذج', 'CI/CD': '✗ لا', 'المراجعة البشرية': '✓ جنبًا إلى جنب', 'التسعير': 'مجاني + رصيد' }
      ]
    },
    howToChoose: {
      id: 'how-to-choose',
  ...
  sections: {
    ...
    comparisonTable: {
      ...
      columns: ['Ferramenta', 'Velocidade', 'Caso de uso', 'CI/CD', 'Revisão humana', 'Preços'],
      rows: [
        { Ferramenta: '[Promptfoo](https://promptfoo.dev)', Velocidade: 'Segundos', 'Caso de uso': 'Testes unitários, regressão', 'CI/CD': '✅ Nativo', 'Revisão humana': '✗ Não', Preços: 'Grátis (MIT)' },
        { Ferramenta: '[Braintrust](https://braintrust.dev)', Velocidade: 'Minutos–horas', 'Caso de uso': 'Eval em lote, aprovação', 'CI/CD': '✓ API', 'Revisão humana': '✅ Sim', Preços: 'Grátis / $249/mês' },
        { Ferramenta: '[DeepEval](https://deepeval.com)', Velocidade: 'Minutos', 'Caso de uso': 'Scoring de pipelines RAG', 'CI/CD': '✓ Python', 'Revisão humana': '✗ Não', Preços: 'Grátis + nuvem paga' },
        { Ferramenta: '[LangSmith](https://smith.langchain.com)', Velocidade: 'Tempo real', 'Caso de uso': 'Tracing, depuração', 'CI/CD': '✓ API', 'Revisão humana': '✗ Não', Preços: 'Grátis / $50+/mês' },
        { Ferramenta: '[Phoenix](https://arize.com/phoenix)', Velocidade: 'Tempo real', 'Caso de uso': 'Monitoramento em produção', 'CI/CD': '✓ API', 'Revisão humana': '✗ Não', Preços: 'Grátis (Apache 2.0)' },
        { Ferramenta: '[PromptQuorum](https://www.promptquorum.com)', Velocidade: 'Segundos', 'Caso de uso': 'Comparação multimodelo', 'CI/CD': '✗ Não', 'Revisão humana': '✓ Lado a lado', Preços: 'Grátis + créditos' }
      ]
    },
    howToChoose: {
      id: 'how-to-choose',
  ...
  sections: {
    ...
    comparisonTable: { id: 'comparison-table', title: 'Tableau de comparaison : Matrice de fonctionnalités', content: '**Depuis août 2026, voici la ventilation des fonctionnalités :**', columns: ['Outil', 'Vitesse', 'Cas d\'utilisation', 'CI/CD', 'Révision humaine', 'Prix'], rows: [ { 'Outil': '[Promptfoo](https://promptfoo.dev)', 'Vitesse': 'Secondes', 'Cas d\'utilisation': 'Tests unitaires, régression', 'CI/CD': '✅ Natif', 'Révision humaine': '✗ Non', 'Prix': 'Gratuit (MIT)' }, { 'Outil': '[Braintrust](https://braintrust.dev)', 'Vitesse': 'Minutes–heures', 'Cas d\'utilisation': 'Évaluation batch, approbation', 'CI/CD': '✓ API', 'Révision humaine': '✅ Oui', 'Prix': 'Gratuit / 249 $/mois' }, { 'Outil': '[DeepEval](https://deepeval.com)', 'Vitesse': 'Minutes', 'Cas d\'utilisation': 'Scoring de pipeline RAG', 'CI/CD': '✓ Python', 'Révision humaine': '✗ Non', 'Prix': 'Gratuit + cloud payant' }, { 'Outil': '[LangSmith](https://smith.langchain.com)', 'Vitesse': 'Temps réel', 'Cas d\'utilisation': 'Traçage, débogage', 'CI/CD': '✓ API', 'Révision humaine': '✗ Non', 'Prix': 'Gratuit / 50 $/mois+' }, { 'Outil': '[Phoenix](https://arize.com/phoenix)', 'Vitesse': 'Temps réel', 'Cas d\'utilisation': 'Surveillance production', 'CI/CD': '✓ API', 'Révision humaine': '✗ Non', 'Prix': 'Gratuit (Apache 2.0)' }, { 'Outil': '[PromptQuorum](https://www.promptquorum.com)', 'Vitesse': 'Secondes', 'Cas d\'utilisation': 'Comparaison multi-modèles', 'CI/CD': '✗ Non', 'Révision humaine': '✓ Côte à côte', 'Prix': 'Gratuit + crédits' } ] },
  ...
  sections: {
    ...
    comparisonTable: {
      ...
      rows: [
        ...
        {
          '工具': '[DeepEval](https://deepeval.com)',
          '速度': '分钟',
          '用途': 'RAG管道评分',
          'CI/CD': '✓ Python',
          '人类审查': '✗ 否',
        ...
        {
          '工具': '[Phoenix](https://arize.com/phoenix)',
          '速度': '实时',
          '用途': '生产监控',
          'CI/CD': '✓ API',
          '人类审查': '✗ 否',
  ...
  ko: {
    ...
    sections: {
      ...
      comparisonTable: {
        ...
        rows: [
          { '도구': '[Promptfoo](https://promptfoo.dev)', '속도': '초 단위', '사용 사례': '단위 테스트, 회귀', 'CI/CD': '✅ 기본', '인간 검토': '✗ 없음', '가격': '무료 (MIT)' },
          { '도구': '[Braintrust](https://braintrust.dev)', '속도': '분~시간', '사용 사례': '배치 평가, 승인', 'CI/CD': '✓ API', '인간 검토': '✅ 있음', '가격': '무료 / $249/월' },
          { '도구': '[DeepEval](https://deepeval.com)', '속도': '분 단위', '사용 사례': 'RAG 파이프라인 채점', 'CI/CD': '✓ Python', '인간 검토': '✗ 없음', '가격': '무료 + 유료 클라우드' },
          { '도구': '[LangSmith](https://smith.langchain.com)', '속도': '실시간', '사용 사례': '트레이싱, 디버깅', 'CI/CD': '✓ API', '인간 검토': '✗ 없음', '가격': '무료 / $50+/월' },
          { '도구': '[Phoenix](https://arize.com/phoenix)', '속도': '실시간', '사용 사례': '프로덕션 모니터링', 'CI/CD': '✓ API', '인간 검토': '✗ 없음', '가격': '무료 (Apache 2.0)' },
          { '도구': '[PromptQuorum](https://www.promptquorum.com)', '속도': '초 단위', '사용 사례': '다중 모델 비교', 'CI/CD': '✗ 없음', '인간 검토': '✓ 나란히', '가격': '무료 + 크레딧' }
        ]
      },
      howToChoose: {
        id: 'how-to-choose',
