...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      metaDescription: 'نماذج LLMs تتنبأ بالرموز عبر توزيعات الاحتمال لا بالفهم. تعلّم التحليل إلى رموز، وانتباه المحوّل، وRLHF، ومعاملات الاستدلال مع معايير الأداء.',
      dateModified: '2026-04-12',
