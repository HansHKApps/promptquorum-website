...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      publishDate: '2026-03-30',
      seoTitle: 'كيف تعمل نماذج LLM: الرموز والانتباه والاستدلال',
      metaDescription: 'تتنبأ نماذج LLM بالرموز باحتمالية لا بمعنى. تعلّم التحليل إلى رموز، وانتباه المحوّل، وRLHF، ومعاملات الاستدلال مع معايير الأداء.',
      dateModified: '2026-04-12',
