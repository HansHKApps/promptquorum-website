...
tests:
  ...
  es: {
    ...
    schema: {
      ...
      url: 'https://www.promptquorum.com/es/es/prompt-engineering/prompt-audit-regression',
      datePublished: '2026-05-02',
...
tests:
  ...
  ar: {
    ...
    seoTitle: 'تدقيق الـ Prompt واختبار الانحدار: اكتشف الأعطال الصامتة',
    metaDescription: 'أنشئ مجموعة اختبارات بأمثلة ذهبية وحالات حافة ومدخلات عدائية. أوقف النشر تلقائيًا إذا انخفض معدل النجاح أكثر من 5%.',
