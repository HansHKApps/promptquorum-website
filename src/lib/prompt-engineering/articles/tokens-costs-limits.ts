...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      current_models_mentioned: ['GPT-5.6', 'Claude Opus 5', 'Claude Haiku 4.5', 'Gemini 3.1 Pro', 'Gemini 3.8 Flash', 'Gemini 3.5 Flash-Lite', 'Llama 3.1 8B'],
      ...
      supplementalSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 6, 'name': 'Google Gemini 3.8 Flash', 'description': 'Input: $0.75/1M tokens. Output: $3.75/1M tokens.' },
      ...
      sections: {
        ...
        pricing: {
          ...
          rows: [
            ...
            { 'Model': 'Google [Gemini 3.8 Flash](https://gemini.google.com)', 'Input (per 1M tokens)': '$0.75', 'Output (per 1M tokens)': '$3.75' },
      ...
      sections: {
        ...
        pricing: {
          ...
          rows: [
            ...
            { 'Modelo': 'Google [Gemini 3.8 Flash](https://gemini.google.com)', 'Input (por 1M tokens)': '$0.75', 'Output (por 1M tokens)': '$3.75' },
      ...
      sections: {
        ...
        pricing: {
          ...
          rows: [
            ...
            { 'النموذج': 'Google [Gemini 3.8 Flash](https://gemini.google.com)', 'المدخلات (لكل مليون رمز)': '$0.75', 'المخرجات (لكل مليون رمز)': '$3.75' },
      ...
      sections: {
        ...
        pricing: {
          ...
          rows: [
            ...
            { 'Modelo': 'Google [Gemini 3.8 Flash](https://gemini.google.com)', 'Entrada (por 1M tokens)': '$0,75', 'Saída (por 1M tokens)': '$3,75' },
  ...
  ko: {
      ...
      supplementalSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 6, 'name': 'Google Gemini 3.8 Flash', 'description': '입력: $0.75/100만 토큰. 출력: $3.75/100만 토큰.' },
      ...
      sections: {
        ...
        pricing: {
          ...
          rows: [
            ...
            { '모델': 'Google [Gemini 3.8 Flash](https://gemini.google.com)', '입력 (100만 토큰당)': '$0.75', '출력 (100만 토큰당)': '$3.75' },
