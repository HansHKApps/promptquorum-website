...
export const article: Partial<Record<Language, PEArticle>> = {
        ...
        itemListElement: [
          {
            ...
            description: 'Use GPT-5.6 Luna, Claude Haiku 4.5, or Gemini Flash — 25× cheaper than GPT-5.6 with equivalent accuracy on straightforward classification.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Short factual Q&A',
            description: 'Use GPT-5.6 Luna or Claude Haiku 4.5 — 10–25× cheaper than frontier models. Suitable for lookup tasks, single-answer questions, and entity extraction.',
          },
          {
            '@type': 'ListItem',
            position: 3,
      ...
      sections: {
        ...
        tldr: {
          ...
          items: [
            ...
            'Using the right model for the task reduces cost by 10–25×. GPT-5.6 Luna or Claude Haiku 4.5 can handle tasks that don\'t need GPT-5.6 or Claude Opus 5.',
        ...
        pricing: {
          ...
          rows: [
            ...
            { 'Model': 'Anthropic [Claude Opus 5](https://www.anthropic.com/claude)', 'Input (per 1M tokens)': '$5.00', 'Output (per 1M tokens)': '$15.00' },
        ...
        howToStart: {
          ...
          numberedItems: [
            'Match model to task complexity: use GPT-5.6 Luna or Claude Haiku 4.5 for simple classification and Q&A — 25× cheaper than frontier models',
        ...
        modelSelection: {
          ...
          rows: [
            { 'Task Type': 'Simple classification / yes-no', 'Recommended Model': '[GPT-5.6 Luna](https://openai.com/chatgpt), [Claude Haiku 4.5](https://www.anthropic.com/claude), or [Gemini Flash](https://gemini.google.com)', 'Cost vs GPT-5.6': '25× cheaper' },
            { 'Task Type': 'Short factual Q&A', 'Recommended Model': 'GPT-5.6 Luna or Claude Haiku 4.5', 'Cost vs GPT-5.6': '10–25× cheaper' },
        ...
        promptquorumHelps: {
          ...
          content: [
            ...
            '**Tested in PromptQuorum — 20 identical research-summary prompts dispatched to GPT-5.6 and GPT-5.6 Luna:** Output quality matched on 17 of 20 tasks. Cost difference: $0.003 per prompt (GPT-5.6) vs $0.00007 per prompt (mini) — a 43× cost reduction. On the 3 tasks where GPT-5.6 outperformed, complexity involved multi-step reasoning across documents.'
          ]
        },
        recipes: {
          ...
          items: [
            '**"Quick lookup / yes-no task":** Use GPT-5.6 Luna or Haiku. Minimal system prompt (≤50 tokens). No conversation history. Constrain output to 1–2 sentences. Total cost per task: ~$0.00001–0.0001.',
            ...
            '**"Comparing outputs across models":** Send one well-structured prompt to GPT-5.6, Claude Opus 5, and Claude Haiku 4.5 simultaneously. Compare quality + cost. Pick the cheapest that meets your quality bar. Discovery cost: ~$0.001. Ongoing cost: 33–43× savings.'
          ]
        },
        mistakes: {
          ...
          items: [
            ...
            '**Using a high-capability model for simple tasks:** Don\'t use GPT-5.6 for "extract the date from this email." Use GPT-5.6 Luna or Haiku. Cost difference: 25× on this task alone.',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Costs vary by model: GPT-5.6 Luna = ~$0.00005–0.0001 per prompt. GPT-5.6 = ~$0.001–0.01. Claude Haiku = ~$0.00003 per prompt. Claude Opus = ~$0.005–0.02. Gemini Flash = ~$0.00002. Costs depend on prompt length and output.'
            },
            {
        ...
        itemListElement: [
          {
            ...
            description: 'Verwenden Sie GPT-5.6 Mini, Claude Haiku 4.5 oder Gemini Flash — 25× günstiger als GPT-5.6 bei gleichwertiger Genauigkeit bei einfacher Klassifizierung.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Kurze faktische Fragen und Antworten',
            description: 'Verwenden Sie GPT-5.6 Mini oder Claude Haiku 4.5 — 10–25× günstiger als Frontier-Modelle. Geeignet für Nachschlageaufgaben, Einzelantwortfragen und Entitätsextraktion.',
          },
          {
            '@type': 'ListItem',
            position: 3,
    ...
    es: {
        ...
        itemListElement: [
          {
            ...
            description: 'Usa GPT-5.6 Luna, Claude Haiku 4.5 o Gemini Flash — 25× más barato que GPT-5.6 con precisión equivalente en clasificación sencilla.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Preguntas y respuestas factuales cortas',
            description: 'Usa GPT-5.6 Luna o Claude Haiku 4.5 — 10–25× más barato que los modelos frontera. Adecuado para tareas de búsqueda, preguntas de respuesta única y extracción de entidades.',
          },
          {
            '@type': 'ListItem',
            position: 3,
      ...
      sections: {
        ...
        promptDesign: {
          title: '¿Cómo puedo reducir mis costes de API LLM un 30–25×?',
          content: [
        ...
        modelSelection: {
          ...
          rows: [
            { 'Tipo de tarea': 'Clasificación simple / Sí-No', 'Modelo recomendado': '[GPT-5.6 Luna](https://openai.com/chatgpt), [Claude Haiku 4.5](https://www.anthropic.com/claude) o [Gemini Flash](https://gemini.google.com)', 'Coste vs GPT-5.6': '25× más barato' },
            { 'Tipo de tarea': 'Q&A factual corto', 'Modelo recomendado': 'GPT-5.6 Luna o Claude Haiku 4.5', 'Coste vs GPT-5.6': '10–25× más barato' },
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: '¿Cuánto cuesta GPT-5.6 por token?', a: 'A partir de agosto de 2026: GPT-5.6 (Sol) cuesta $5.00 por 1M de tokens de entrada y $30.00 por 1M de tokens de salida. GPT-5.6 Luna cuesta $0.20 por 1M de entrada y $1.20 por 1M de salida — ~25× más barato para tareas que no requieren la capacidad completa de GPT-5.6 Sol.' },
            ...
            { q: '¿Cuánto cuesta cada prompt de IA según el modelo?', a: 'Los costes varían según el modelo: GPT-5.6 Luna = ~$0.00005–0.0001 por prompt. GPT-5.6 = ~$0.001–0.01. Claude Haiku = ~$0.00003 por prompt. Claude Opus = ~$0.005–0.02. Gemini Flash = ~$0.00002. Los costes dependen de la longitud del prompt y del output.' },
    ...
    ar: {
        ...
        itemListElement: [
          {
            ...
            description: 'استخدم GPT-5.6 Luna أو Claude Haiku 4.5 أو Gemini Flash — أرخص بـ 33 مرة من GPT-5.6 بدقة مماثلة في التصنيف البسيط.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'أسئلة وأجوبة واقعية قصيرة',
            description: 'استخدم GPT-5.6 Luna أو Claude Haiku 4.5 — أرخص بـ 10-33 مرة من النماذج المتقدمة. مناسب لمهام البحث والأسئلة ذات الإجابة الواحدة واستخراج الكيانات.',
          },
          {
            '@type': 'ListItem',
            position: 3,
      ...
      sections: {
        ...
        howToStart: {
          ...
          numberedItems: [
            'طابق النموذج مع تعقيد المهمة: استخدم GPT-5.6 Luna أو Claude Haiku 4.5 للتصنيف البسيط والأسئلة والأجوبة — أرخص بـ 33 ضعفًا من النماذج الأمامية',
        ...
        modelSelection: {
          ...
          rows: [
            { 'نوع المهمة': 'تصنيف بسيط / نعم-لا', 'النموذج الموصى به': '[GPT-5.6 Luna](https://openai.com/chatgpt)، [Claude Haiku 4.5](https://www.anthropic.com/claude) أو [Gemini Flash](https://gemini.google.com)', 'التكلفة مقارنة بـ GPT-5.6': 'أرخص بـ 33 ضعفًا' },
            { 'نوع المهمة': 'أسئلة وأجوبة واقعية قصيرة', 'النموذج الموصى به': 'GPT-5.6 Luna أو Claude Haiku 4.5', 'التكلفة مقارنة بـ GPT-5.6': 'أرخص بـ 10–33 ضعفًا' },
        ...
        recipes: {
          ...
          items: [
            '**"بحث سريع / مهمة نعم-لا":** استخدم GPT-5.6 Luna أو Haiku. طلب نظام أدنى (≤50 رمزًا). بلا سجل. التكلفة لكل مهمة: ~$0.00001–0.0001.',
            ...
            '**"خط أنابيب آلي / معالجة دفعية":** استخدم GPT-5.6 Luna للتصفية (أرخص بـ 33 ضعفًا). تصعيد إلى GPT-5.6 فقط للتوليف النهائي.',
            '**"مسار عمل حساس للخصوصية":** وجّه إلى Ollama المحلي. تكلفة API صفر.',
            '**"مقارنة المخرجات عبر النماذج":** أرسل إلى GPT-5.6 وClaude Opus 5 وClaude Haiku 4.5 في آنٍ واحد. اختر الأرخص الذي يلبي عتبة الجودة لديك.'
          ]
        },
        mistakes: {
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'كم تكلف GPT-5.6 لكل رمز؟', a: 'اعتبارًا من أغسطس 2026: تكلف GPT-5.6 (فئة Sol) $5.00 لكل مليون رمز مدخل و$30.00 لكل مليون رمز مخرج. تكلف GPT-5.6 Luna $0.20 لكل مليون مدخل و$1.20 لكل مليون مخرج — أرخص بنحو 25 ضعفًا للمهام التي لا تتطلب القدرة الكاملة لـ GPT-5.6 Sol.' },
            ...
            { q: 'كم تكلف كل طلب ذكاء اصطناعي عبر النماذج المختلفة؟', a: 'تختلف التكاليف حسب النموذج: GPT-5.6 Luna = ~$0.00005–0.0001 لكل طلب. GPT-5.6 = ~$0.001–0.01. Claude Haiku = ~$0.00003 لكل طلب. Claude Opus = ~$0.005–0.02. Gemini Flash = ~$0.00002. تعتمد التكاليف على طول الطلب والمخرجات.' },
        ...
        itemListElement: [
          {
            ...
            description: 'Use GPT-5.6 Luna, Claude Haiku 4.5 ou Gemini Flash — 25× mais barato que o GPT-5.6 com precisão equivalente em classificação simples.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Perguntas e respostas factuais curtas',
            description: 'Use GPT-5.6 Luna ou Claude Haiku 4.5 — 10–25× mais barato que os modelos de fronteira. Adequado para tarefas de consulta, perguntas de resposta única e extração de entidades.',
          },
          {
            '@type': 'ListItem',
            position: 3,
      ...
      sections: {
        ...
        tldr: {
          ...
          items: [
            ...
            'Usar o modelo correto para a tarefa reduz o custo em 10–25×.',
        ...
        pricing: {
          ...
          rows: [
            ...
            { 'Modelo': 'OpenAI [GPT-5.6 Luna](https://openai.com/chatgpt)', 'Entrada (por 1M tokens)': '$0,15', 'Saída (por 1M tokens)': '$0,60' },
        ...
        howToStart: {
          ...
          numberedItems: [
            'Combine o modelo à complexidade da tarefa: use GPT-5.6 Luna ou Claude Haiku 4.5 para classificação simples e Q&A — 25× mais barato que modelos frontier',
        ...
        modelSelection: {
          ...
          rows: [
            { 'Tipo de tarefa': 'Classificação simples / Sim-Não', 'Modelo recomendado': '[GPT-5.6 Luna](https://openai.com/chatgpt), [Claude Haiku 4.5](https://www.anthropic.com/claude) ou [Gemini Flash](https://gemini.google.com)', 'Custo vs GPT-5.6': '25× mais barato' },
            { 'Tipo de tarefa': 'Q&A factual curto', 'Modelo recomendado': 'GPT-5.6 Luna ou Claude Haiku 4.5', 'Custo vs GPT-5.6': '10–25× mais barato' },
        ...
        recipes: {
          ...
          items: [
            '**"Consulta rápida / tarefa Sim-Não":** Use GPT-5.6 Luna ou Haiku. System prompt mínimo (≤50 tokens). Sem histórico de conversa. Limite a saída a 1–2 frases. Custo total por tarefa: ~$0,00001–0,0001.',
            ...
            '**"Pipeline automatizado / processamento em lote":** Use GPT-5.6 Luna para filtragem ou classificação (25× mais barato). Escale para GPT-5.6 apenas para síntese final em casos limítrofes.',
          ],
        },
        mistakes: {
          title: 'Erros Comuns',
          ...
          items: [
            ...
            '**Usar modelo de alta capacidade para tarefas simples:** Não use GPT-5.6 para "extraia a data deste e-mail". Use GPT-5.6 Luna ou Haiku. Diferença de custo: 25× nesta tarefa.',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'A partir de agosto de 2026: GPT-5.6 (Sol) custa $5,00 por 1M tokens de entrada e $30,00 por 1M tokens de saída. GPT-5.6 Luna custa $0,20 por 1M de entrada e $1,20 por 1M de saída — ~25× mais barato para tarefas que não requerem capacidade completa do GPT-5.6 Sol.',
            },
            {
            ...
            },
            {
              ...
              a: 'Os custos variam por modelo: GPT-5.6 Luna = ~$0,00005–0,0001 por prompt. GPT-5.6 = ~$0,001–0,01. Claude Haiku = ~$0,00003 por prompt. Claude Opus = ~$0,005–0,02. Gemini Flash = ~$0,00002. Os custos dependem do comprimento do prompt e da saída.',
            },
            {
        ...
        itemListElement: [
          {
            ...
            description: 'Utilisez GPT-5.6 Luna, Claude Haiku 4.5 ou Gemini Flash — 25× moins cher que GPT-5.6 avec une précision équivalente sur une classification simple.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Questions-réponses factuelles courtes',
            description: 'Utilisez GPT-5.6 Luna ou Claude Haiku 4.5 — 10 à 25× moins cher que les modèles de pointe. Adapté aux tâches de recherche, questions à réponse unique et extraction d\'entités.',
          },
          {
            '@type': 'ListItem',
            position: 3,
        ...
        itemListElement: [
          {
            ...
            description: 'GPT-5.6 Luna、Claude Haiku 4.5、またはGemini Flashを使用してください — 単純な分類において同等の精度でGPT-5.6より33倍安価です。',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: '短い事実に基づくQ&A',
            description: 'GPT-5.6 LunaまたはClaude Haiku 4.5を使用してください — フロンティアモデルより10〜33倍安価です。検索タスク、単一回答の質問、エンティティ抽出に適しています。',
          },
          {
            '@type': 'ListItem',
            position: 3,
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: '简单分类或是/否任务',
            description: '使用GPT-5.6 Luna、Claude Haiku 4.5或Gemini Flash——在简单分类上准确度相当，但比GPT-5.6便宜33倍。',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: '简短的事实性问答',
            description: '使用GPT-5.6 Luna或Claude Haiku 4.5——比前沿模型便宜10-33倍。适用于查找任务、单一答案问题和实体提取。',
          },
          {
            '@type': 'ListItem',
            position: 3,
  ...
  ko: {
      ...
      supplementalSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 4, 'name': 'OpenAI GPT-5.6 Luna', 'description': '입력: $0.20/100만 토큰. 출력: $1.20/100만 토큰. GPT-5.6보다 33배 저렴.' },
        ...
        itemListElement: [
          {
            ...
            description: 'GPT-5.6 Luna, Claude Haiku 4.5 또는 Gemini Flash를 사용하십시오. 단순 분류에서 동등한 정확도로 GPT-5.6보다 33배 저렴합니다.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: '짧은 사실 기반 질의응답',
            description: 'GPT-5.6 Luna 또는 Claude Haiku 4.5를 사용하십시오. 프론티어 모델보다 10~33배 저렴합니다. 조회 작업, 단일 답변 질문, 개체 추출에 적합합니다.',
          },
          {
            '@type': 'ListItem',
            position: 3,
      ...
      sections: {
        ...
        modelSelection: {
          ...
          rows: [
            { '작업 유형': '간단한 분류 / 예-아니오', '권장 모델': '[GPT-5.6 Luna](https://openai.com/chatgpt), [Claude Haiku 4.5](https://www.anthropic.com/claude), 또는 [Gemini Flash](https://gemini.google.com)', 'GPT-5.6 대비 비용': '33배 저렴' },
            { '작업 유형': '짧은 사실 기반 질의응답', '권장 모델': 'GPT-5.6 Luna 또는 Claude Haiku 4.5', 'GPT-5.6 대비 비용': '10~33배 저렴' },
        ...
        promptquorumHelps: {
          ...
          content: [
            ...
            '**PromptQuorum에서 테스트 완료 — GPT-5.6와 GPT-5.6 Luna로 동일한 리서치 요약 프롬프트 20개 발송:** 20개 작업 중 17개에서 출력 품질이 일치했습니다. 비용 차이: 프롬프트당 $0.003(GPT-5.6) 대 $0.00007(mini) — 43배 비용 절감. GPT-5.6가 더 나은 성능을 보인 3개 작업은 문서 전반의 다단계 추론을 포함했습니다.'
          ]
        },
        recipes: {
          title: '토큰 비용 레시피',
          ...
          items: [
            '**"빠른 조회 / 예-아니오 작업":** GPT-5.6 Luna 또는 Haiku를 사용하십시오. 최소 시스템 프롬프트(50토큰 이하). 대화 기록 없음. 출력을 1~2문장으로 제한하십시오. 작업당 총 비용: 약 $0.00001~0.0001.',
            '**"긴 리서치 작업 (5~10턴)":** Claude Opus 5을 사용하십시오(긴 컨텍스트에 탁월). 5턴마다 대화를 요약하고 기록을 요약으로 교체하십시오(토큰 70% 감소). 비용: 리서치 세션당 약 $0.01~0.05.',
            '**"자동화 파이프라인 / 배치 처리":** 필터링 또는 분류에 GPT-5.6 Luna를 사용하십시오(33배 저렴). 경계선 사례의 최종 종합에만 GPT-5.6로 에스컬레이션하십시오. API가 지원하는 경우 컨텍스트 캐싱을 재사용하기 위해 유사한 프롬프트를 묶으십시오.',
            ...
            '**"모델 간 출력 비교":** 잘 구조화된 프롬프트 하나를 GPT-5.6, Claude Opus 5, Claude Haiku 4.5에 동시에 전송하십시오. 품질 + 비용을 비교하십시오. 품질 기준을 충족하는 가장 저렴한 모델을 선택하십시오. 탐색 비용: 약 $0.001. 지속 비용: 33~43배 절감.'
          ]
        },
        mistakes: {
          title: '흔한 실수들',
          ...
          items: [
            ...
            '**간단한 작업에 고성능 모델 사용:** "이 이메일에서 날짜를 추출하십시오"에 GPT-5.6를 사용하지 마십시오. GPT-5.6 Luna 또는 Haiku를 사용하십시오. 이 작업만으로도 비용 차이: 33배.',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: '2026년 8월 기준: GPT-5.6(Sol)는 100만 입력 토큰당 $5.00, 100만 출력 토큰당 $30.00입니다. GPT-5.6 Luna는 100만 입력 토큰당 $0.20, 100만 출력 토큰당 $1.20으로 전체 GPT-5.6 Sol 성능이 필요하지 않은 작업에서 약 25배 더 저렴합니다.'
            },
            {
            ...
            },
            {
              ...
              a: '모델별 비용: GPT-5.6 Luna = 프롬프트당 약 $0.00005~0.0001. GPT-5.6 = 약 $0.001~0.01. Claude Haiku = 프롬프트당 약 $0.00003. Claude Opus = 약 $0.005~0.02. Gemini Flash = 약 $0.00002. 비용은 프롬프트 길이와 출력에 따라 다릅니다.'
            },
            {
            ...
            },
            {
              ...
              a: '네. 500토큰 시스템 프롬프트를 300토큰으로 줄이면 API 호출당 약 $0.001가 절약됩니다. 하루 1,000회 호출 시 연간 $365가 절약됩니다. 출력 길이 제한과 5턴마다 대화 기록 요약으로 비용이 30~50% 줄어듭니다. 모델 선택이 가장 큰 레버입니다. GPT-5.6 Luna는 GPT-5.6보다 33배 저렴합니다.'
            },
          ]
        },
        relatedReading: {
