...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      current_models_mentioned: ['GPT-5.6', 'Claude Opus 5', 'Claude Haiku 4.5', 'Gemini 3.1 Pro', 'Gemini 3.7 Flash', 'Gemini 3.5 Flash-Lite', 'Llama 3.1 8B'],
      theme: 'Fundamentals', heroImage: '/images/tokens-costs-limits-overview-hero-en.webp',
      ...
      toc: [
        ...
        { label: 'How to Cut LLM API Costs in 5 Steps', anchor: 'how-to-cut-llm-api-costs-in-5-steps' },
        ...
        { label: 'How PromptQuorum Helps',          anchor: 'how-promptquorum-helps-you-manage-token-costs' },
      ...
      schema: {
        ...
        mentions: [
          ...
          { '@type': 'Thing', name: 'Anthropic Claude Opus 5' },
          { '@type': 'Thing', name: 'Google Gemini 3.1 Pro' },
          { '@type': 'Thing', name: 'Google Gemini 3.5 Flash-Lite' },
      ...
      supplementalSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        'name': 'AI Model Pricing Comparison 2026',
        'description': 'Input and output token costs for major AI models, verified 2026-08-31',
        'numberOfItems': 7,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'OpenAI GPT-5.6', 'description': 'Input: $5.00/1M tokens. Output: $30.00/1M tokens.' },
          { '@type': 'ListItem', 'position': 2, 'name': 'Anthropic Claude Opus 5', 'description': 'Input: $5.00/1M tokens. Output: $25.00/1M tokens.' },
          { '@type': 'ListItem', 'position': 3, 'name': 'Google Gemini 3.1 Pro', 'description': 'Input: $2.00/1M tokens. Output: $12.00/1M tokens.' },
          { '@type': 'ListItem', 'position': 4, 'name': 'OpenAI GPT-5.6 Luna', 'description': 'Input: $0.20/1M tokens. Output: $1.20/1M tokens. 25x cheaper than GPT-5.6.' },
          { '@type': 'ListItem', 'position': 5, 'name': 'Anthropic Claude Haiku 4.5', 'description': 'Input: $1.00/1M tokens. Output: $5.00/1M tokens.' },
          { '@type': 'ListItem', 'position': 6, 'name': 'Google Gemini 3.7 Flash', 'description': 'Input: $0.75/1M tokens. Output: $3.75/1M tokens.' },
          { '@type': 'ListItem', 'position': 7, 'name': 'Google Gemini 3.5 Flash-Lite', 'description': 'Input: $0.30/1M tokens. Output: $2.50/1M tokens. Cheapest cloud option.' }
        ]
      },
      itemListSchema: {
        '@context': 'https://schema.org',
        ...
        itemListElement: [
          {
            ...
            description: 'Use GPT-5.6 Luna or Gemini 3.5 Flash-Lite — 12–25× cheaper than GPT-5.6 with equivalent accuracy on straightforward classification. Claude Haiku 4.5 is 5–6× cheaper.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Short factual Q&A',
            description: 'Use GPT-5.6 Luna or Claude Haiku 4.5 — 5–25× cheaper than frontier models. Suitable for lookup tasks, single-answer questions, and entity extraction.',
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: 'Complex analysis or code generation',
            description: 'Use GPT-5.6 or Claude Opus 5 — frontier capability required for multi-step reasoning, debugging, and technical synthesis.',
          },
          {
            '@type': 'ListItem',
            position: 4,
            name: 'Long-form creative writing',
            description: 'Use Claude Opus 5 or GPT-5.6 — both excel at sustained narrative quality and style consistency across long outputs.',
          },
          {
            '@type': 'ListItem',
            position: 5,
      ...
      sections: {
        ...
        tldr: {
          ...
          items: [
            ...
            'Using the right model for the task reduces cost by 5–25×. GPT-5.6 Luna or Claude Haiku 4.5 can handle tasks that don\'t need GPT-5.6 or Claude Opus 5.',
        ...
        pricing: {
          ...
          rows: [
            { 'Model': 'OpenAI [GPT-5.6](https://openai.com/chatgpt)', 'Input (per 1M tokens)': '$5.00', 'Output (per 1M tokens)': '$30.00' },
            { 'Model': 'Anthropic [Claude Opus 5](https://www.anthropic.com/claude)', 'Input (per 1M tokens)': '$5.00', 'Output (per 1M tokens)': '$25.00' },
            { 'Model': 'Google [Gemini 3.1 Pro](https://gemini.google.com)', 'Input (per 1M tokens)': '$2.00', 'Output (per 1M tokens)': '$12.00' },
            { 'Model': 'OpenAI [GPT-5.6 Luna](https://openai.com/chatgpt)', 'Input (per 1M tokens)': '$0.20', 'Output (per 1M tokens)': '$1.20' },
            { 'Model': 'Anthropic [Claude Haiku 4.5](https://www.anthropic.com/claude)', 'Input (per 1M tokens)': '$1.00', 'Output (per 1M tokens)': '$5.00' },
            { 'Model': 'Google [Gemini 3.7 Flash](https://gemini.google.com)', 'Input (per 1M tokens)': '$0.75', 'Output (per 1M tokens)': '$3.75' },
            { 'Model': 'Google [Gemini 3.5 Flash-Lite](https://gemini.google.com)', 'Input (per 1M tokens)': '$0.30', 'Output (per 1M tokens)': '$2.50' },
          ],
          tableFormat: true
        },
        rateLimits: {
        ...
        promptDesign: {
          ...
          items: [
            ...
            'Token difference: Bad = 55 tokens, Good = 13 tokens. On 100 calls per day: 42 × 100 × 30 days × ($5.00 per 1M input tokens) ≈ $0.63/month saved by just one trimmed prompt.'
          ]
        },
        howToStart: {
          title: 'How to Cut LLM API Costs in 5 Steps',
          numberedItems: [
            'Match model to task complexity: use GPT-5.6 Luna or Claude Haiku 4.5 for simple classification and Q&A — Luna is 25× cheaper than GPT-5.6, Haiku 4.5 is 5–6× cheaper',
        ...
        modelSelection: {
          ...
          rows: [
            { 'Task Type': 'Simple classification / yes-no', 'Recommended Model': '[GPT-5.6 Luna](https://openai.com/chatgpt), or [Gemini 3.5 Flash-Lite](https://gemini.google.com)', 'Cost vs GPT-5.6': '12–25× cheaper' },
            { 'Task Type': 'Short factual Q&A', 'Recommended Model': 'GPT-5.6 Luna or Claude Haiku 4.5', 'Cost vs GPT-5.6': '5–25× cheaper' },
            { 'Task Type': 'Complex analysis or code', 'Recommended Model': '[GPT-5.6](https://openai.com/chatgpt) or [Claude Opus 5](https://www.anthropic.com/claude)', 'Cost vs GPT-5.6': 'baseline' },
            { 'Task Type': 'Long-form creative writing', 'Recommended Model': 'Claude Opus 5 or GPT-5.6', 'Cost vs GPT-5.6': 'baseline' },
            { 'Task Type': 'High-volume private workflows', 'Recommended Model': 'Local model via [Ollama](https://ollama.com/library/llama3.1)', 'Cost vs GPT-5.6': 'zero API cost' },
          ],
          tableFormat: true
        },
        localLLMs: {
          ...
          items: [
            '**Hardware costs:** Ollama models like Llama 3.1 8B require ~8GB VRAM, 13B models need ~16GB, 70B models need 40GB+. GPU memory is the limiting factor.',
            '**Capability trade-off:** Local models are excellent at classification, summarisation, and repetitive tasks. They struggle with multi-step reasoning, code generation, and creative writing compared to GPT-5.6 or Claude Opus 5.',
        ...
        promptquorumHelps: {
          ...
          content: [
            ...
            '**Tested in PromptQuorum — 20 identical research-summary prompts dispatched to GPT-5.6 and GPT-5.6 Luna:** Output quality matched on 17 of 20 tasks. Cost difference: $0.003 per prompt (GPT-5.6) vs $0.00007 per prompt (Luna) — a 43× cost reduction. On the 3 tasks where GPT-5.6 outperformed, complexity involved multi-step reasoning across documents.'
          ]
        },
        recipes: {
          ...
          items: [
            '**"Quick lookup / yes-no task":** Use GPT-5.6 Luna or Gemini 3.5 Flash-Lite. Minimal system prompt (≤50 tokens). No conversation history. Constrain output to 1–2 sentences. Total cost per task: ~$0.00005–0.0005.',
            '**"Long research task (5–10 turns)":** Use Claude Opus 5 (excellent at long context). After every 5 turns, summarise the conversation and replace history with a summary (cuts tokens by 70%). Cost: ~$0.01–0.05 per research session.',
            '**"Automated pipeline / batch processing":** Use GPT-5.6 Luna for filtering or classification (25× cheaper). Only escalate to GPT-5.6 for final synthesis on borderline cases. Batch similar prompts to reuse context caching where the API supports it.',
            ...
            '**"Comparing outputs across models":** Send one well-structured prompt to GPT-5.6, Claude Opus 5, and GPT-5.6 Luna simultaneously. Compare quality + cost. Pick the cheapest that meets your quality bar. Discovery cost: ~$0.001. Ongoing cost: up to 25× savings when Luna clears your quality bar.'
          ]
        },
        mistakes: {
          ...
          items: [
            ...
            '**Using a high-capability model for simple tasks:** Don\'t use GPT-5.6 for "extract the date from this email." Use GPT-5.6 Luna. Cost difference: 25× on this task alone.',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'Three common causes: (1) You are sending full conversation history on every call — summarise after 5 turns. (2) Your system prompt is long — trim to essentials. (3) You are using a powerful model for simple tasks — switch to GPT-5.6 Luna or Haiku for classification or short Q&A.'
            },
            {
            ...
            },
            {
              ...
              a: 'Costs vary by model: GPT-5.6 Luna = ~$0.0001–0.0005 per prompt. GPT-5.6 = ~$0.002–0.02. Claude Haiku 4.5 = ~$0.0005–0.002 per prompt. Claude Opus 5 = ~$0.005–0.02. Gemini 3.5 Flash-Lite = ~$0.0001–0.0005. Costs depend on prompt length and output.'
            },
            {
            ...
            },
            {
              ...
              a: 'With 1 million tokens: 2,000–6,667 prompts if each prompt averages 150–500 tokens. GPT-5.6 Luna prompts (~300 tokens) = ~3,333 prompts. GPT-5.6 prompts (~500 tokens) = ~2,000 prompts. Actual count depends on prompt size and output length.'
            },
            {
              q: 'Does prompt optimization reduce API costs significantly?',
              a: 'Yes. Trimming a 500-token system prompt to 300 tokens saves ~$0.001 per API call. At 1,000 calls/day, that\'s $365/year saved. Constraining output length and summarizing conversation history every 5 turns reduces costs 30–50%. Model selection is the largest lever — GPT-5.6 Luna costs 25× less than GPT-5.6.'
            },          ]
        },
        relatedReading: {
        ...
        itemListElement: [
          {
            ...
            description: 'Verwenden Sie GPT-5.6 Luna oder Gemini 3.5 Flash-Lite — 12–25× günstiger als GPT-5.6 bei gleichwertiger Genauigkeit bei einfacher Klassifizierung. Claude Haiku 4.5 ist 5–6× günstiger.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Kurze faktische Fragen und Antworten',
            description: 'Verwenden Sie GPT-5.6 Luna oder Claude Haiku 4.5 — 5–25× günstiger als Frontier-Modelle. Geeignet für Nachschlageaufgaben, Einzelantwortfragen und Entitätsextraktion.',
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: 'Komplexe Analyse oder Codegenerierung',
            description: 'Verwenden Sie GPT-5.6 oder Claude Opus 5 — Frontier-Fähigkeiten sind für mehrstufiges Schlussfolgern, Debugging und technische Synthese erforderlich.',
          },
          {
            '@type': 'ListItem',
            position: 4,
            name: 'Langform-Kreativtexte',
            description: 'Verwenden Sie Claude Opus 5 oder GPT-5.6 — beide zeichnen sich durch anhaltende Erzählqualität und Stilkonsistenz bei langen Ausgaben aus.',
          },
          {
            '@type': 'ListItem',
            position: 5,
        ...
        itemListElement: [
          {
            ...
            description: 'Usa GPT-5.6 Luna o Gemini 3.5 Flash-Lite — 12–25× más barato que GPT-5.6 con precisión equivalente en clasificación sencilla. Claude Haiku 4.5 es 5–6× más barato.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Preguntas y respuestas factuales cortas',
            description: 'Usa GPT-5.6 Luna o Claude Haiku 4.5 — 5–25× más barato que los modelos frontera. Adecuado para tareas de búsqueda, preguntas de respuesta única y extracción de entidades.',
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: 'Análisis complejo o generación de código',
            description: 'Usa GPT-5.6 o Claude Opus 5 — se requiere capacidad de frontera para razonamiento de varios pasos, depuración y síntesis técnica.',
          },
          {
            '@type': 'ListItem',
            position: 4,
            name: 'Escritura creativa extensa',
            description: 'Usa Claude Opus 5 o GPT-5.6 — ambos destacan en calidad narrativa sostenida y consistencia de estilo en salidas largas.',
          },
          {
            '@type': 'ListItem',
            position: 5,
      ...
      sections: {
        ...
        tldr: {
          ...
          items: [
            ...
            'Usar el modelo correcto para la tarea reduce el coste en 5–25×.',
        ...
        pricing: {
          title: 'Precios de los proveedores cloud',
          content: [
          ...
          rows: [
            { 'Modelo': 'OpenAI [GPT-5.6](https://openai.com/chatgpt)', 'Input (por 1M tokens)': '$5.00', 'Output (por 1M tokens)': '$30.00' },
            { 'Modelo': 'Anthropic [Claude Opus 5](https://www.anthropic.com/claude)', 'Input (por 1M tokens)': '$5.00', 'Output (por 1M tokens)': '$25.00' },
            { 'Modelo': 'Google [Gemini 3.1 Pro](https://gemini.google.com)', 'Input (por 1M tokens)': '$2.00', 'Output (por 1M tokens)': '$12.00' },
            { 'Modelo': 'OpenAI [GPT-5.6 Luna](https://openai.com/chatgpt)', 'Input (por 1M tokens)': '$0.20', 'Output (por 1M tokens)': '$1.20' },
            { 'Modelo': 'Anthropic [Claude Haiku 4.5](https://www.anthropic.com/claude)', 'Input (por 1M tokens)': '$1.00', 'Output (por 1M tokens)': '$5.00' },
            { 'Modelo': 'Google [Gemini 3.7 Flash](https://gemini.google.com)', 'Input (por 1M tokens)': '$0.75', 'Output (por 1M tokens)': '$3.75' },
            { 'Modelo': 'Google [Gemini 3.5 Flash-Lite](https://gemini.google.com)', 'Input (por 1M tokens)': '$0.30', 'Output (por 1M tokens)': '$2.50' },
          ],
          tableFormat: true
        },
        rateLimits: {
        ...
        promptDesign: {
          title: 'Cómo el diseño del prompt controla los costes',
          content: [
            '**Probado en PromptQuorum — 20 prompts idénticos de resumen de investigación ejecutados en GPT-5.6, Claude Opus 5 y Gemini 3.1 Pro con distintos niveles de verbosidad en el system prompt:** Con un system prompt de 500 tokens, la salida media fue de 450 tokens a un coste medio de $0.032 por llamada. Con las mismas instrucciones en un prompt recortado de 200 tokens, la salida media fue de 460 tokens a $0.025 por llamada — una reducción de coste del 18% con calidad de salida idéntica. Esto coincide con [cómo hacer prompts para la velocidad](/es/prompt-engineering/faster-ai-answers-how-to-prompt-for-speed): la eficiencia reduce tanto la latencia como el coste.',
            '**Cada token innecesario en tu prompt desperdicia dinero — y los costes se acumulan más rápido porque todo tu prompt se reincluye en cada llamada de API de una conversación.** Reducir un system prompt de 500 tokens a 300 tokens ahorra $0.001 por llamada, pero a 1.000 llamadas al día, eso es $1/día o $365/año.',
          ],
          items: [
            '**Recorta el contexto agresivamente:** No repitas lo que el modelo ya sabe. En lugar de "El usuario preguntó X. Le respondí Y. Ahora pregunta Z", incluye solo Z.',
            '**Usa restricciones de longitud explícitas:** "Responde en 3 puntos" o "Máximo 100 palabras" fuerza la brevedad y evita salidas verbosas, que cuestan más.',
            '**Evita el relleno en los system prompts:** Cada palabra de relleno cuesta dinero. "Eres un asistente experto que ayuda a los usuarios" son 10 tokens. "Eres un asistente experto" son 6 tokens. Ambos comunican lo mismo.',
            '**Ejemplo: system prompt inflado frente a system prompt recortado:**',
            '[Mal Prompt] "Eres un asistente de IA útil con amplios conocimientos en muchos dominios. Ayudas a los usuarios ofreciendo respuestas detalladas y completas a sus preguntas. Sé siempre exhaustivo y explica tu razonamiento paso a paso. Evita ser conciso: los usuarios agradecen las explicaciones exhaustivas."',
            '[Buen Prompt] "Eres un asistente experto. Ofrece respuestas precisas y detalladas. Explica tu razonamiento."',
            'Diferencia de tokens: malo = 55 tokens, bueno = 13 tokens. A 100 llamadas al día: 42 × 100 × 30 días × ($5.00 por 1M de tokens de entrada) ≈ $0.63/mes ahorrados con un solo prompt recortado.',
          ]
        },
        howToStart: {
          title: 'Cómo reducir los costes de API de LLM en 5 pasos',
          numberedItems: [
            'Ajusta el modelo a la complejidad de la tarea: usa GPT-5.6 Luna o Claude Haiku 4.5 para clasificación simple y Q&A — Luna es 25× más barato que GPT-5.6, Haiku 4.5 es 5–6× más barato',
        ...
        modelSelection: {
          ...
          rows: [
            { 'Tipo de tarea': 'Clasificación simple / Sí-No', 'Modelo recomendado': '[GPT-5.6 Luna](https://openai.com/chatgpt) o [Gemini 3.5 Flash-Lite](https://gemini.google.com)', 'Coste vs GPT-5.6': '12–25× más barato' },
            { 'Tipo de tarea': 'Q&A factual corto', 'Modelo recomendado': 'GPT-5.6 Luna o Claude Haiku 4.5', 'Coste vs GPT-5.6': '5–25× más barato' },
            { 'Tipo de tarea': 'Análisis complejo o código', 'Modelo recomendado': '[GPT-5.6](https://openai.com/chatgpt) o [Claude Opus 5](https://www.anthropic.com/claude)', 'Coste vs GPT-5.6': 'Referencia' },
            { 'Tipo de tarea': 'Escritura creativa larga', 'Modelo recomendado': 'Claude Opus 5 o GPT-5.6', 'Coste vs GPT-5.6': 'Referencia' },
            { 'Tipo de tarea': 'Flujos de trabajo privados de alto volumen', 'Modelo recomendado': 'Modelo local mediante [Ollama](https://ollama.com/library/llama3.1)', 'Coste vs GPT-5.6': 'Coste de API cero' }
          ],
          tableFormat: true
        },
        localLLMs: {
          title: 'LLMs locales: la opción de coste cero',
          ...
          items: [
            '**Costes de hardware:** Llama 3.1 8B requiere ~8 GB VRAM, modelos 13B necesitan ~16 GB, modelos 70B necesitan 40 GB+.',
        ...
        promptquorumHelps: {
          ...
          content: [
            ...
            '**Probado en PromptQuorum — 20 prompts idénticos de resumen de investigación enviados a GPT-5.6 y GPT-5.6 Luna:** La calidad de salida coincidió en 17 de 20 tareas. Diferencia de coste: $0.003 por prompt (GPT-5.6) frente a $0.00007 por prompt (Luna) — una reducción de coste de 43×. En las 3 tareas donde GPT-5.6 fue superior, la complejidad implicaba razonamiento de varios pasos entre documentos.'
          ]
        },
        recipes: {
          ...
          items: [
            '**"Búsqueda rápida / Tarea Sí-No":** Usa GPT-5.6 Luna o Gemini 3.5 Flash-Lite. System prompt mínimo (≤50 tokens). Sin historial. Coste total por tarea: ~$0.00005–0.0005.',
            ...
            '**"Comparación de outputs en modelos":** Envía a GPT-5.6, Claude Opus 5 y GPT-5.6 Luna simultáneamente. Elige el más barato que cumpla tu umbral de calidad.'
          ]
        },
        mistakes: {
          ...
          items: [
            ...
            '**Olvidar los tokens de imagen:** Una imagen de alta resolución puede consumir 500–2.000 tokens. Reduce la resolución o recorta la región relevante antes de subirla.',
            '**Ejecutar llamadas de prueba manuales en lugar de agruparlas:** Probar 20 variantes de un prompt cuesta 20× el coste en tokens de una sola llamada. Usa APIs de lote o la comparación multimodelo de PromptQuorum para probarlas todas de una vez.',
            '**Cambiar de modelo a mitad de conversación:** Las APIs cloud (OpenAI, Anthropic) no trasladan el contexto de la conversación entre modelos. Reiniciar la conversación en otro modelo reenvía todos los mensajes previos. Mantén un solo modelo por conversación.'
          ]
        },
        faq: {
          id: 'faq',
          ...
          faqs: [
            ...
            { q: '¿Cuánto cuesta GPT-5.6 por token?', a: 'GPT-5.6 (Sol) cuesta $5.00 por 1M de tokens de entrada y $30.00 por 1M de tokens de salida. GPT-5.6 Luna cuesta $0.20 por 1M de entrada y $1.20 por 1M de salida — ~25× más barato para tareas que no requieren la capacidad completa de GPT-5.6 Sol.' },
            ...
            { q: '¿Cuánto cuesta cada prompt de IA según el modelo?', a: 'Los costes varían según el modelo: GPT-5.6 Luna = ~$0.0001–0.0005 por prompt. GPT-5.6 = ~$0.002–0.02. Claude Haiku 4.5 = ~$0.0005–0.002 por prompt. Claude Opus 5 = ~$0.005–0.02. Gemini 3.5 Flash-Lite = ~$0.0001–0.0005. Los costes dependen de la longitud del prompt y del output.' },
            ...
            { q: '¿Cuántos prompts se pueden obtener de 1 millón de tokens?', a: 'Con 1 millón de tokens: 2.000–6.667 prompts si cada prompt promedia 150–500 tokens. Prompts de GPT-5.6 Luna (~300 tokens) = ~3.333 prompts. Prompts de GPT-5.6 (~500 tokens) = ~2.000 prompts. El recuento real depende del tamaño del prompt y la longitud del output.' },
        ...
        relatedReading: {
          ...
          items: [
            '[Cómo funcionan realmente los LLMs](/es/prompt-engineering/how-llms-actually-work) — tokenización, context windows y parámetros de inferencia que generan estos costes',
            '[System prompt vs user prompt](/es/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference) — cómo la longitud del system prompt afecta directamente al coste en tokens de cada llamada',
            '[Context windows explicadas](/es/prompt-engineering/context-windows-explained-why-ai-forgets) — el problema de perderse en el medio y cómo el tamaño del context window afecta al coste y a la calidad',
            '[Instalar Ollama](/es/local-llms/how-to-install-ollama) — configura inferencia local sin coste por token para flujos de alto volumen o sensibles a la privacidad',
            '[Cuantización de LLM explicada](/es/local-llms/llm-quantization-explained) — requisitos de RAM de los modelos locales que sustituyen a las APIs cloud',
            '[Mejores LLMs locales en 2026](/es/local-llms/best-local-llms-2026) — qué modelos locales pueden sustituir a las APIs cloud según el tipo de tarea',
          ]
        },
        sources: {
    ...
    ar: {
      theme: 'Fundamentals', heroImage: '/images/tokens-costs-limits-overview-hero-ar.webp',
        ...
        itemListElement: [
          {
            ...
            description: 'استخدم GPT-5.6 Luna أو Gemini 3.5 Flash-Lite — أرخص بـ 12–25 مرة من GPT-5.6 بدقة مماثلة في التصنيف البسيط. وClaude Haiku 4.5 أرخص بـ 5–6 مرات.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'أسئلة وأجوبة واقعية قصيرة',
            description: 'استخدم GPT-5.6 Luna أو Claude Haiku 4.5 — أرخص بـ 5-25 مرة من النماذج المتقدمة. مناسب لمهام البحث والأسئلة ذات الإجابة الواحدة واستخراج الكيانات.',
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: 'التحليل المعقد أو توليد الأكواد',
            description: 'استخدم GPT-5.6 أو Claude Opus 5 — القدرة المتقدمة مطلوبة للاستدلال متعدد الخطوات وتصحيح الأخطاء والتوليف التقني.',
          },
          {
            '@type': 'ListItem',
            position: 4,
            name: 'الكتابة الإبداعية الطويلة',
            description: 'استخدم Claude Opus 5 أو GPT-5.6 — يتفوق كلاهما في جودة السرد المستمرة واتساق الأسلوب عبر المخرجات الطويلة.',
          },
          {
            '@type': 'ListItem',
            position: 5,
      ...
      sections: {
        ...
        pricing: {
          title: 'الأسعار عبر مزودي الخدمة السحابية',
          content: [
          ...
          rows: [
            { 'النموذج': 'OpenAI [GPT-5.6](https://openai.com/chatgpt)', 'المدخلات (لكل مليون رمز)': '$5.00', 'المخرجات (لكل مليون رمز)': '$30.00' },
            { 'النموذج': 'Anthropic [Claude Opus 5](https://www.anthropic.com/claude)', 'المدخلات (لكل مليون رمز)': '$5.00', 'المخرجات (لكل مليون رمز)': '$25.00' },
            { 'النموذج': 'Google [Gemini 3.1 Pro](https://gemini.google.com)', 'المدخلات (لكل مليون رمز)': '$2.00', 'المخرجات (لكل مليون رمز)': '$12.00' },
            { 'النموذج': 'OpenAI [GPT-5.6 Luna](https://openai.com/chatgpt)', 'المدخلات (لكل مليون رمز)': '$0.20', 'المخرجات (لكل مليون رمز)': '$1.20' },
            { 'النموذج': 'Anthropic [Claude Haiku 4.5](https://www.anthropic.com/claude)', 'المدخلات (لكل مليون رمز)': '$1.00', 'المخرجات (لكل مليون رمز)': '$5.00' },
            { 'النموذج': 'Google [Gemini 3.7 Flash](https://gemini.google.com)', 'المدخلات (لكل مليون رمز)': '$0.75', 'المخرجات (لكل مليون رمز)': '$3.75' },
            { 'النموذج': 'Google [Gemini 3.5 Flash-Lite](https://gemini.google.com)', 'المدخلات (لكل مليون رمز)': '$0.30', 'المخرجات (لكل مليون رمز)': '$2.50' },
          ],
          tableFormat: true
        },
        rateLimits: {
        ...
        modelSelection: {
          ...
          rows: [
            { 'نوع المهمة': 'تصنيف بسيط / نعم-لا', 'النموذج الموصى به': '[GPT-5.6 Luna](https://openai.com/chatgpt) أو [Gemini 3.5 Flash-Lite](https://gemini.google.com)', 'التكلفة مقارنة بـ GPT-5.6': 'أرخص بـ 12–25 ضعفًا' },
            { 'نوع المهمة': 'أسئلة وأجوبة واقعية قصيرة', 'النموذج الموصى به': 'GPT-5.6 Luna أو Claude Haiku 4.5', 'التكلفة مقارنة بـ GPT-5.6': 'أرخص بـ 5–25 ضعفًا' },
            { 'نوع المهمة': 'تحليل معقد أو كود', 'النموذج الموصى به': '[GPT-5.6](https://openai.com/chatgpt) أو [Claude Opus 5](https://www.anthropic.com/claude)', 'التكلفة مقارنة بـ GPT-5.6': 'مرجع' },
            { 'نوع المهمة': 'كتابة إبداعية طويلة', 'النموذج الموصى به': 'Claude Opus 5 أو GPT-5.6', 'التكلفة مقارنة بـ GPT-5.6': 'مرجع' },
            { 'نوع المهمة': 'مسارات عمل خاصة عالية الحجم', 'النموذج الموصى به': 'نموذج محلي عبر [Ollama](https://ollama.com/library/llama3.1)', 'التكلفة مقارنة بـ GPT-5.6': 'تكلفة API صفر' }
          ],
          tableFormat: true
        },
        localLLMs: {
          title: 'نماذج LLM المحلية — خيار بلا تكلفة',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'كم تكلف GPT-5.6 لكل رمز؟', a: 'تكلف GPT-5.6 (فئة Sol) $5.00 لكل مليون رمز مدخل و$30.00 لكل مليون رمز مخرج. تكلف GPT-5.6 Luna $0.20 لكل مليون مدخل و$1.20 لكل مليون مخرج — أرخص بنحو 25 ضعفًا للمهام التي لا تتطلب القدرة الكاملة لـ GPT-5.6 Sol.' },
            ...
            { q: 'كم تكلف كل طلب ذكاء اصطناعي عبر النماذج المختلفة؟', a: 'تختلف التكاليف حسب النموذج: GPT-5.6 Luna = ~$0.0001–0.0005 لكل طلب. GPT-5.6 = ~$0.002–0.02. Claude Haiku 4.5 = ~$0.0005–0.002 لكل طلب. Claude Opus 5 = ~$0.005–0.02. Gemini 3.5 Flash-Lite = ~$0.0001–0.0005. تعتمد التكاليف على طول الطلب والمخرجات.' },
            ...
            { q: 'كم عدد الطلبات التي يمكن الحصول عليها من مليون رمز؟', a: 'مع مليون رمز: 2.000–6.667 طلبًا إذا بلغ متوسط كل طلب 150–500 رمز. طلبات GPT-5.6 Luna (~300 رمز) = ~3.333 طلبًا. طلبات GPT-5.6 (~500 رمز) = ~2.000 طلب. يعتمد العدد الفعلي على حجم الطلب وطول المخرجات.' },
            { q: 'هل يقلل تحسين الطلبات تكاليف API بشكل كبير؟', a: 'نعم. تقليص طلب نظام من 500 رمز إلى 300 رمز يوفر ~$0.001 لكل استدعاء API. عند 1.000 استدعاء/يوم، هذا يعني توفير $365/سنة. تقييد طول المخرجات وتلخيص سجل المحادثة كل 5 جولات يقلل التكاليف بنسبة 30–50%. اختيار النموذج هو الرافعة الأكبر — تكلف GPT-5.6 Luna أقل بـ 25 ضعفًا من GPT-5.6.' }
          ]
        },
        relatedReading: {
          title: 'قراءات ذات صلة',
          items: [
            '[كيف تعمل نماذج اللغة الكبيرة فعلاً](/ar/prompt-engineering/how-llms-actually-work) — الترميز ونوافذ السياق ومعاملات الاستدلال التي تحدد هذه التكاليف',
            '[system prompt مقابل user prompt](/ar/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference) — كيف يؤثر طول طلب النظام مباشرةً في تكلفة الرموز عند كل استدعاء API',
            '[نوافذ السياق مشروحة](/ar/prompt-engineering/context-windows-explained-why-ai-forgets) — مشكلة الضياع في المنتصف وكيف يؤثر حجم نافذة السياق في التكلفة والجودة',
            '[تثبيت Ollama](/ar/local-llms/how-to-install-ollama) — إعداد استدلال محلي بلا تكلفة لكل رمز لسير العمل عالي الحجم أو الحساس للخصوصية',
            '[شرح تكميم LLM](/ar/local-llms/llm-quantization-explained) — متطلبات ذاكرة الوصول العشوائي للنماذج المحلية التي تحل محل تكاليف واجهات API السحابية',
            '[أفضل نماذج LLM المحلية في 2026](/ar/local-llms/best-local-llms-2026) — أي النماذج المحلية يمكنها استبدال واجهات API السحابية لكل نوع مهمة',
          ]
        },
        sources: {
    ...
    pt: {
      theme: 'Fundamentals', heroImage: '/images/tokens-costs-limits-overview-hero-pt.webp',
        ...
        itemListElement: [
          {
            ...
            description: 'Use GPT-5.6 Luna ou Gemini 3.5 Flash-Lite — 12–25× mais barato que o GPT-5.6 com precisão equivalente em classificação simples. O Claude Haiku 4.5 é 5–6× mais barato.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Perguntas e respostas factuais curtas',
            description: 'Use GPT-5.6 Luna ou Claude Haiku 4.5 — 5–25× mais barato que os modelos de fronteira. Adequado para tarefas de consulta, perguntas de resposta única e extração de entidades.',
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: 'Análise complexa ou geração de código',
            description: 'Use GPT-5.6 ou Claude Opus 5 — capacidade de fronteira é necessária para raciocínio em múltiplas etapas, depuração e síntese técnica.',
          },
          {
            '@type': 'ListItem',
            position: 4,
            name: 'Escrita criativa longa',
            description: 'Use Claude Opus 5 ou GPT-5.6 — ambos se destacam em qualidade narrativa sustentada e consistência de estilo em saídas longas.',
          },
          {
            '@type': 'ListItem',
            position: 5,
      ...
      sections: {
        ...
        pricing: {
          title: 'Preços entre provedores de nuvem',
          content: [
          ...
          rows: [
            { 'Modelo': 'OpenAI [GPT-5.6](https://openai.com/chatgpt)', 'Entrada (por 1M tokens)': '$5,00', 'Saída (por 1M tokens)': '$30,00' },
            { 'Modelo': 'Anthropic [Claude Opus 5](https://www.anthropic.com/claude)', 'Entrada (por 1M tokens)': '$5,00', 'Saída (por 1M tokens)': '$25,00' },
            { 'Modelo': 'Google [Gemini 3.1 Pro](https://gemini.google.com)', 'Entrada (por 1M tokens)': '$2,00', 'Saída (por 1M tokens)': '$12,00' },
            { 'Modelo': 'OpenAI [GPT-5.6 Luna](https://openai.com/chatgpt)', 'Entrada (por 1M tokens)': '$0,20', 'Saída (por 1M tokens)': '$1,20' },
            { 'Modelo': 'Anthropic [Claude Haiku 4.5](https://www.anthropic.com/claude)', 'Entrada (por 1M tokens)': '$1,00', 'Saída (por 1M tokens)': '$5,00' },
            { 'Modelo': 'Google [Gemini 3.7 Flash](https://gemini.google.com)', 'Entrada (por 1M tokens)': '$0,75', 'Saída (por 1M tokens)': '$3,75' },
            { 'Modelo': 'Google [Gemini 3.5 Flash-Lite](https://gemini.google.com)', 'Entrada (por 1M tokens)': '$0,30', 'Saída (por 1M tokens)': '$2,50' },
          ],
          tableFormat: true,
        },
        rateLimits: {
        ...
        modelSelection: {
          ...
          rows: [
            { 'Tipo de tarefa': 'Classificação simples / Sim-Não', 'Modelo recomendado': '[GPT-5.6 Luna](https://openai.com/chatgpt) ou [Gemini 3.5 Flash-Lite](https://gemini.google.com)', 'Custo vs GPT-5.6': '12–25× mais barato' },
            { 'Tipo de tarefa': 'Q&A factual curto', 'Modelo recomendado': 'GPT-5.6 Luna ou Claude Haiku 4.5', 'Custo vs GPT-5.6': '5–25× mais barato' },
            { 'Tipo de tarefa': 'Análise complexa ou código', 'Modelo recomendado': '[GPT-5.6](https://openai.com/chatgpt) ou [Claude Opus 5](https://www.anthropic.com/claude)', 'Custo vs GPT-5.6': 'referência' },
            { 'Tipo de tarefa': 'Escrita criativa longa', 'Modelo recomendado': 'Claude Opus 5 ou GPT-5.6', 'Custo vs GPT-5.6': 'referência' },
            { 'Tipo de tarefa': 'Fluxos de trabalho privados de alto volume', 'Modelo recomendado': 'Modelo local via [Ollama](https://ollama.com/library/llama3.1)', 'Custo vs GPT-5.6': 'custo de API zero' },
          ],
          tableFormat: true,
        },
        localLLMs: {
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'GPT-5.6 (Sol) custa $5,00 por 1M tokens de entrada e $30,00 por 1M tokens de saída. GPT-5.6 Luna custa $0,20 por 1M de entrada e $1,20 por 1M de saída — ~25× mais barato para tarefas que não requerem capacidade completa do GPT-5.6 Sol.',
            },
            {
            ...
            },
            {
              ...
              a: 'Três causas comuns: (1) Você está enviando o histórico completo da conversa em cada chamada — resuma após 5 turnos. (2) Seu system prompt é longo — corte ao essencial. (3) Você está usando um modelo poderoso para tarefas simples — mude para GPT-5.6 Luna ou Haiku para classificação ou Q&A curto.',
            },
            {
            ...
            },
            {
              ...
              a: 'Os custos variam por modelo: GPT-5.6 Luna = ~$0,0001–0,0005 por prompt. GPT-5.6 = ~$0,002–0,02. Claude Haiku 4.5 = ~$0,0005–0,002 por prompt. Claude Opus 5 = ~$0,005–0,02. Gemini 3.5 Flash-Lite = ~$0,0001–0,0005. Os custos dependem do comprimento do prompt e da saída.',
            },
            {
            ...
            },
            {
              ...
              a: 'Com 1 milhão de tokens: 2.000–6.667 prompts se cada prompt tiver em média 150–500 tokens. Prompts do GPT-5.6 Luna (~300 tokens) = ~3.333 prompts. Prompts do GPT-5.6 (~500 tokens) = ~2.000 prompts. A contagem real depende do tamanho do prompt e do comprimento da saída.',
            },
            {
        ...
        relatedReading: {
          ...
          items: [
            '[Como os LLMs realmente funcionam](/pt/prompt-engineering/how-llms-actually-work) — tokenização, janelas de contexto e parâmetros de inferência que geram esses custos',
            '[System prompt vs user prompt](/pt/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference) — como o comprimento do system prompt afeta diretamente o custo em tokens de cada chamada de API',
            '[Janelas de contexto explicadas](/pt/prompt-engineering/context-windows-explained-why-ai-forgets) — o problema de se perder no meio e como o tamanho da janela de contexto afeta custo e qualidade',
            '[Instalar o Ollama](/pt/local-llms/how-to-install-ollama) — configure inferência local sem custo por token para fluxos de alto volume ou sensíveis à privacidade',
            '[Quantização de LLM explicada](/pt/local-llms/llm-quantization-explained) — requisitos de RAM dos modelos locais que substituem os custos de API na nuvem',
            '[Melhores LLMs locais em 2026](/pt/local-llms/best-local-llms-2026) — quais modelos locais podem substituir APIs na nuvem para cada tipo de tarefa',
          ]
        },
        sources: {
        ...
        itemListElement: [
          {
            ...
            description: 'Utilisez GPT-5.6 Luna ou Gemini 3.5 Flash-Lite — 12–25× moins cher que GPT-5.6 avec une précision équivalente sur une classification simple. Claude Haiku 4.5 est 5–6× moins cher.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Questions-réponses factuelles courtes',
            description: 'Utilisez GPT-5.6 Luna ou Claude Haiku 4.5 — 5 à 25× moins cher que les modèles de pointe. Adapté aux tâches de recherche, questions à réponse unique et extraction d\'entités.',
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: 'Analyse complexe ou génération de code',
            description: 'Utilisez GPT-5.6 ou Claude Opus 5 — une capacité de pointe est nécessaire pour le raisonnement multi-étapes, le débogage et la synthèse technique.',
          },
          {
            '@type': 'ListItem',
            position: 4,
            name: 'Écriture créative longue',
            description: 'Utilisez Claude Opus 5 ou GPT-5.6 — les deux excellent en qualité narrative soutenue et cohérence de style sur des sorties longues.',
          },
          {
            '@type': 'ListItem',
            position: 5,
        ...
        itemListElement: [
          {
            ...
            description: 'GPT-5.6 LunaまたはGemini 3.5 Flash-Liteを使用してください — 単純な分類において同等の精度でGPT-5.6より12〜25倍安価です。Claude Haiku 4.5は5〜6倍安価です。',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: '短い事実に基づくQ&A',
            description: 'GPT-5.6 LunaまたはClaude Haiku 4.5を使用してください — フロンティアモデルより5〜25倍安価です。検索タスク、単一回答の質問、エンティティ抽出に適しています。',
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: '複雑な分析やコード生成',
            description: 'GPT-5.6またはClaude Opus 5を使用してください — 多段階の推論、デバッグ、技術的統合にはフロンティア能力が必要です。',
          },
          {
            '@type': 'ListItem',
            position: 4,
            name: '長文の創作',
            description: 'Claude Opus 5またはGPT-5.6を使用してください — どちらも長い出力にわたる持続的な物語品質とスタイルの一貫性に優れています。',
          },
          {
            '@type': 'ListItem',
            position: 5,
    ...
    zh: { theme: 'Fundamentals', heroImage: '/images/tokens-costs-limits-overview-hero-zh.webp', title: '令牌、成本和限制：AI提示的经济学', intro: '每个AI API调用都用令牌来测量和计费——该单位控制模型可以处理的内容以及您支付的金额。理解令牌是高效且经济有效提示的基础。', publishDate: '2026-03-22', readTime: '13分钟阅读', primaryTerm: 'LLM令牌',
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: '简单分类或是/否任务',
            description: '使用GPT-5.6 Luna或Gemini 3.5 Flash-Lite——在简单分类上准确度相当，但比GPT-5.6便宜12-25倍。Claude Haiku 4.5便宜5-6倍。',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: '简短的事实性问答',
            description: '使用GPT-5.6 Luna或Claude Haiku 4.5——比前沿模型便宜5-25倍。适用于查找任务、单一答案问题和实体提取。',
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: '复杂分析或代码生成',
            description: '使用GPT-5.6或Claude Opus 5——多步推理、调试和技术综合需要前沿能力。',
          },
          {
            '@type': 'ListItem',
            position: 4,
            name: '长篇创意写作',
            description: '使用Claude Opus 5或GPT-5.6——两者在长篇输出中都擅长保持叙事质量和风格一致性。',
          },
          {
            '@type': 'ListItem',
            position: 5,
      ...
      gammaEmbedUrl: '/presentations/tokens-costs-limits-economics-of-ai-prompting-static.html', gammaDescription: '幻灯片涵盖：令牌定价、速率限制、模型选择和降本策略。下载PDF作为AI令牌经济学参考卡。', sections: { definition: { title: '什么是令牌？', content: [ '**令牌是AI模型处理的最小文本单位，大约3-4个字符或3/4个英文单词。** 在英文文本中，"ChatGPT"计为2个令牌，"Hello, how are you?"大约是5-6个令牌。其他语言的令牌化效率较低——相同的短语用德语或日语可能会消耗20-40%的额外令牌。您需要为提示（输入）中的每个令牌和模型输出的每个令牌付费。理解令牌对于了解[什么是提示工程](/prompt-engineering/what-is-prompt-engineering)——构造输入以获得可靠输出的实践——是基础。', '模型不会用文字或字符"思考"。在内部，它们将您的文本转换为令牌ID并进行数值处理。这就是为什么令牌化很重要：单个字符更改有时会影响令牌边界，而包含冗余单词的组织不当的提示可能会浪费数百个令牌而不会改善输出质量。', '一句话：令牌是AI模型处理的最小文本单位，大约3-4个字符或3/4个英文单词，您需要为每个输入令牌和输出令牌付费。' ] }, tldr: { title: '重点', isTldr: true, items: [ '令牌是AI成本和处理的单位。大约3-4个字符=英文中的1个令牌；其他语言需要更多令牌。', '您为输入令牌和输出令牌分别付费——输出令牌通常费用多2-5倍。长冗长的输出是成本飙升的地方。', '令牌计数包括系统提示、完整的对话历史、附加文件和图像——不仅仅是您的最后一条消息。', '速率限制（每分钟请求数、每分钟令牌数）存在以防止滥用并确保公平的资源分配。免费层有严格的限制；付费层要高得多。', '为任务使用正确的模型可以将成本降低10-50倍。GPT-5.6 Luna或Claude Haiku 4.5可以处理不需要GPT-5.6或Claude Opus 5的任务。', '通过Ollama或LM Studio的本地LLM具有零令牌API成本，但需要VRAM投资且功能低于前沿模型。' ] }, tokenCounting: { title: '令牌计数在实践中的工作原理', content: '**API调用的每个元素——系统提示、对话历史、新消息、文件和模型自身的输出——都从您的配额中消耗令牌。** 这就是为什么以小消息开始的对话在五次往返后可能会突然变得昂贵。您为所有内容付费，累计。理解[系统提示和用户提示](/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference)之间的区别至关重要，因为两者在每次调用时都会计费。', items: [ '**系统提示：** 每条消息计算一次。200字系统提示=每次API调用约250个令牌。', '**完整对话历史：** 除非明确汇总或删除，否则包含在每个请求中。一个有10轮、每轮500个令牌的对话=第11轮再次计算5000个令牌。', '**您的输入消息：** 按原样计算。', '**附加文件或图像：** 图像根据大小和分辨率消耗100-2000个令牌。大型PDF可能消耗数千个。', '**模型输出：** 生成的响应以输出令牌速率（通常比输入速率高2-5倍）完全计算。', '**工作示例：** 一个3轮的研究对话：系统提示（300个令牌）+用户Q1（150个令牌）+模型A1（200个令牌）+用户Q2（200个令牌）+模型A2（300个令牌）+用户Q3（100个令牌）=**到目前为止1250个令牌**。当您发送Q3时，您再次为整个历史（1250个令牌）加上A3的输出付费。一个"短"后续可能花费与整个先前对话一样多。' ] }, pricing: { title: '各云服务商定价对比', content: [ '价格因模型功能而异。以下所有数据是截至2026年3月的公开价格。请注意，输出令牌通常比输入令牌多费用2-5倍——这是成本累积最快的地方。正确的模型选择是最大的成本杠杆——详细比较请参见[如何在GPT-5.6、Claude和Gemini之间选择](/prompt-engineering/gpt-claude-or-gemini-how-to-pick-the-right-model)。', '2026年3月起价格。验证当前费率：[OpenAI价格](https://openai.com/pricing)·[Anthropic价格](https://www.anthropic.com/api)·[Google价格](https://ai.google.dev/pricing)' ], columns: [ '模型', '输入（每百万令牌）', '输出（每百万令牌）' ], rows: [ { '模型': 'OpenAI [GPT-5.6](https://openai.com/chatgpt)', '输入（每百万令牌）': '$5.00', '输出（每百万令牌）': '$30.00' }, { '模型': 'Anthropic [Claude Opus 5](https://www.anthropic.com/claude)', '输入（每百万令牌）': '$5.00', '输出（每百万令牌）': '$25.00' }, { '模型': 'Google [Gemini 3.1 Pro](https://gemini.google.com)', '输入（每百万令牌）': '$2.00', '输出（每百万令牌）': '$12.00' }, { '模型': 'OpenAI [GPT-5.6 Luna](https://openai.com/chatgpt)', '输入（每百万令牌）': '$0.20', '输出（每百万令牌）': '$1.20' }, { '模型': 'Anthropic [Claude Haiku 4.5](https://www.anthropic.com/claude)', '输入（每百万令牌）': '$1.00', '输出（每百万令牌）': '$5.00' }, { '模型': 'Google [Gemini 3.7 Flash](https://gemini.google.com)', '输入（每百万令牌）': '$0.75', '输出（每百万令牌）': '$3.75' }, { '模型': 'Google [Gemini 3.5 Flash-Lite](https://gemini.google.com)', '输入（每百万令牌）': '$0.30', '输出（每百万令牌）': '$2.50' } ], tableFormat: true }, rateLimits: { title: '速率限制', content: '**速率限制是您可以每分钟进行的请求数（RPM）、可以每分钟处理的令牌数（TPM）或每天令牌数（TPD）的上限。** 提供商设置限制以防止滥用、确保用户间的公平资源分配并创建价格层。免费层用户面临最严格的限制；付费层解锁更高的吞吐量。', items: [ '**每分钟请求数（RPM）：** 您在60秒窗口内可以进行的API调用数。超过此限制，请求将排队或被拒绝。', '**每分钟令牌数（TPM）：** 总令牌吞吐量。单个大型提示可以在几秒内消耗整个TPM配额。', '**您遇到限制的常见场景：** 进行快速顺序调用（每秒50+）的自动化管道、大型批处理作业或免费层用户在突发情况下。', '**典型限制：** 免费：3-15 RPM、40k-100k TPM。付费层1：500 RPM、200k-500k TPM。企业：3000+ RPM、数百万TPM。', '**解决方法：** 将小任务批处理为较大的请求（较少API调用）、在请求之间添加延迟或升级到更高层的帐户。' ] }, promptDesign: { title: '提示词设计如何控制成本', content: [ '**在PromptQuorum中测试——在GPT-5.6、Claude Opus 5和Gemini 3.1 Pro上执行的20个相同的研究摘要提示，系统提示详细程度不同：** 使用500令牌系统提示，平均输出为450令牌，每次调用平均成本为$0.032。对于相同说明的修剪200令牌提示，平均输出为460令牌，每次调用为$0.025——相同输出质量下成本降低18%。这与[如何为速度提示](/prompt-engineering/faster-ai-answers-how-to-prompt-for-speed)一致——效率降低了延迟和成本。', '**提示中的每个不必要的令牌都浪费金钱——成本累积更快，因为整个提示在对话中的每次API调用时都会重新包含。** 将500令牌系统提示修剪到300令牌可以节省每次调用$0.001，但在每天1000次调用时，这是$1/天或$365/年。' ], items: [ '**积极修剪上下文：** 不要重复模型已经知道的内容。不要说"用户问了X。我告诉他们Y。现在他们问Z"，只需包括Z。', '**使用明确的长度限制：** "用3个要点回答"或"最多100个单词"强制简洁性并防止冗长输出（成本更高）。', '**避免系统提示中的填充：** 每个填充字都花钱。"您是一个可以帮助用户的有用的AI助手"是10个令牌。"您是一个有用的AI助手"是6个令牌。两者都传达相同的含义。', '**示例：膨胀vs。修剪系统提示：**', '[不好的提示]"您是一个具有跨许多领域广泛知识的有用AI助手。您通过提供详细、全面的答案来帮助用户。始终彻底并逐步解释您的推理。避免简洁——用户欣赏全面的解释。"', '[好的提示]"您是一个有用的AI助手。提供准确、详细的答案。解释您的推理。"', '令牌差异：不好=55个令牌，好=13个令牌。每天100次调用：42×100×30天×（$5.00/1M输入令牌）≈通过仅一个修剪提示节省$0.63/月。' ] }, howToStart: { title: '如何在5个步骤中降低LLM API成本', numberedItems: [ '将模型与任务复杂性匹配：对于简单分类和问答使用GPT-5.6 Luna（比GPT-5.6便宜25倍）或Claude Haiku 4.5（便宜5-6倍）', '每5轮汇总对话历史：防止每次调用都重新计费整个历史（与[思维链提示](/prompt-engineering/chain-of-thought-prompting)一致的技术——预先构造您的推理）', '明确限制输出长度："用3个要点回答"或"最多100个单词"可防止冗长的令牌密集响应', '将系统提示修剪到要点：删除填充短语；每个冗余字都在每个API调用时重新计费', '通过Ollama测试本地LLM用于大量私有工作流：每令牌零API成本，代价是前沿模型能力' ] }, modelSelection: { title: '为正确的任务选择正确的模型', content: '**并非每项任务都需要OpenAI GPT-5.6或Anthropic Claude Opus。** 简单分类、事实性问答和许多自动化任务在更便宜的模型上运行完美——成本差异很大。', columns: [ '任务类型', '推荐模型', '与GPT-5.6成本' ], rows: [ { '任务类型': '简单分类/是或否', '推荐模型': '[GPT-5.6 Luna](https://openai.com/chatgpt)或[Gemini 3.5 Flash-Lite](https://gemini.google.com)', '与GPT-5.6成本': '便宜12-25倍' }, { '任务类型': '简短的事实问答', '推荐模型': 'GPT-5.6 Luna或Claude Haiku 4.5', '与GPT-5.6成本': '便宜5-25倍' }, { '任务类型': '复杂分析或代码', '推荐模型': '[GPT-5.6](https://openai.com/chatgpt)或[Claude Opus 5](https://www.anthropic.com/claude)', '与GPT-5.6成本': '基准线' }, { '任务类型': '长篇创意写作', '推荐模型': 'Claude Opus 5或GPT-5.6', '与GPT-5.6成本': '基准线' }, { '任务类型': '大容量私有工作流', '推荐模型': '通过[Ollama](https://ollama.com/library/llama3.1)的本地模型', '与GPT-5.6成本': '零API成本' } ], tableFormat: true }, localLLMs: { title: '本地LLM——零成本选项', content: '**通过Ollama或LM Studio的本地模型具有零令牌API成本——您仅为硬件（VRAM和电力）付费。** 这使它们非常适合大容量工作流、隐私敏感应用程序和成本关键管道。权衡是能力（本地模型落后于前沿模型）和延迟（在消费者VRAM上运行较慢）。在规划本地部署时，理解[上下文窗口](/prompt-engineering/context-windows-explained-why-ai-forgets)至关重要——您的VRAM限制您可以支持的上下文窗口大小。', items: [ '**硬件成本：** Ollama模型Llama 3.1 8B需要约8GB VRAM、13B模型需要约16GB、70B模型需要40GB+。GPU内存是限制因素。', '**能力权衡：** 本地模型在分类、摘要和重复任务中表现出色。与GPT-5.6或Claude Opus 5相比，他们在多步骤推理、代码生成和创意写作方面苦苦挣扎。', '**延迟权衡：** 云模型在500ms-2s内响应。消费者硬件上的本地模型：2-10s，取决于模型大小和系统规格。', '**何时使用本地：** 大容量自动化（1000+次调用/天）、GDPR敏感数据（在GDPR下处理个人数据的欧盟用户受益于设备上的处理）或质量"足够好"的成本关键工作流。', '**何时使用云：** 延迟敏感应用程序、需要推理的任务或API成本可忽略的一次性分析。' ] }, regionalContext: { title: '区域背景', content: [ '**欧盟 / GDPR** 对于通过AI API处理个人数据的欧盟组织而言，令牌成本包含了价目表中看不见的合规成本：发送到云API的每个令牌都是由第三方处理的个人数据，根据GDPR第28条要求，非欧盟提供商还需要数据处理协议和第46条规定的传输机制。', '通过Ollama使用本地LLM可以完全消除这一问题。对于处理客户数据、支持工单或内部文档的欧盟团队而言，云API调用的真实成本包括外部数据传输的合规开销。在规模化之后，即使考虑到硬件投资，本地推理在经济上也可能更具竞争力。', '根据BSI IT-Grundschutz准则，德国组织必须记录AI处理成本和数据流——只要以适当的访问控制方式保留，来自云API的令牌日志即可满足此要求。', '**日本（经济产业省）** 由于分词器在CJK文字上的效率较低，日语文本所需的令牌比同等英语文本多20-40%。一份1000字的日语文档在GPT-5.6上的费用约为$0.007，而相同的英语内容为$0.005。对于日语AI工作流，通过Ollama使用Qwen3模型的令牌效率显著更高——原生CJK分词将日语令牌数量减少30-40%，直接降低了每次调用的成本。', '**中国** 根据中国的《数据安全法》，将业务数据发送到境外云AI API需要进行数据本地化合规审查。对于中国企业团队，通过Qwen3（阿里巴巴）进行本地推理可同时消除跨境数据传输成本和合规风险。每天1000次以上的API调用，本地推理服务器的硬件摊销成本通常在6-12个月内低于API费用。' ] }, promptquorumHelps: { title: 'PromptQuorum如何帮助您管理令牌成本', content: [ '**PromptQuorum使用两个LLM：后端LLM和前端LLM（回答提示问题的您选择的模型）。** 后端LLM优化您的提示并在多个前端模型中运行Quorum共识分析。与单模型聊天界面不同，PromptQuorum使令牌使用可见且可操作。', '**后端LLM令牌始终可见。** 前端令牌可见性取决于您如何访问模型：', '- **公共界面**（Copilot、公共Claude网络聊天）：前端令牌不可见——仅显示后端令牌。', '- **本地模型**（LM Studio、Ollama）：前端令牌可见——在您的硬件上运行，PromptQuorum直接看到令牌使用情况。', '- **API**（OpenAI、Anthropic）：这取决于。使用直接API集成，前端令牌可见。通过第三方端点或公共界面，前端令牌不可见。', '**在PromptQuorum中测试——20个相同的研究摘要提示发送到GPT-5.6和GPT-5.6 Luna：** 输出质量在20个任务中的17个匹配。成本差异：$0.003每个提示（GPT-5.6）对$0.00007每个提示（Luna）——43倍的成本降低。在GPT-5.6表现出色的3个任务中，复杂性涉及文档间的多步推理。' ] }, recipes: { title: '令牌成本配方——常见场景', content: '使用这些模板作为特定工作流成本优化的起点。', items: [ '**"快速查找/是否任务"：** 使用GPT-5.6 Luna或Gemini 3.5 Flash-Lite。最小系统提示（≤50令牌）。没有对话历史。将输出限制为1-2句。每个任务的总成本：~$0.00005-0.0005。', '**"长研究任务（5-10轮）"：** 使用Claude Opus 5（在长上下文中表现出色）。每5轮后，汇总对话并用汇总替换历史（降低令牌70%）。成本：~$0.01-0.05每个研究会话。', '**"自动化管道/批处理"：** 使用GPT-5.6 Luna进行过滤或分类（便宜25倍）。仅为边界情况的最终合成升级到GPT-5.6。批处理类似的提示以在API支持的地方重新使用上下文缓存。', '**"隐私敏感工作流"：** 路由到本地运行的Ollama或LM Studio。管理上下文窗口：8GB VRAM为4k-8k令牌，16GB为16k-32k。零API成本。接受稍低的质量以实现合规性。', '**"比较跨模型的输出"：** 将一个结构良好的提示同时发送到GPT-5.6、Claude Opus 5和GPT-5.6 Luna。比较质量+成本。选择满足您质量栏的最便宜的。发现成本：~$0.001。持续成本：若Luna达到您的质量标准，最多可节省25倍。' ] }, mistakes: { title: '导致令牌账单飙升的常见错误', content: '避免这些令牌浪费模式。', items: [ '**每次调用都发送完整对话历史：** 如果对话在10轮后为5000个令牌，您在第11轮再次为5000个令牌付费，尽管只有200个令牌是新的。解决方案：每5轮汇总或使用提示缓存（如果API支持）。', '**为简单任务使用高功能模型：** 不要为"从这封电子邮件中提取日期"使用GPT-5.6。使用GPT-5.6 Luna。仅此任务的成本差异：25倍。', '**不限制输出长度：** 一个模糊的"告诉我X"提示可能返回500个令牌，而"汇总为50个单词"返回60个令牌。您为冗长的响应多支付8倍。', '**每次调用都重复长系统提示：** 如果您的系统提示是500个令牌，您进行100次API调用，如果您不重新使用或缓存它，那就是50000个浪费的令牌。使用系统提示模板或请求级缓存。', '**忘记图像令牌：** 单个高分辨率图像可以消耗500-2000个令牌，具体取决于分辨率。在上传前向下缩放图像或裁剪到相关区域。', '**运行手动测试调用而不是批处理：** 测试20个提示变体的成本是一个调用令牌成本的20倍。使用批处理API或PromptQuorum的多模型比较在一次拍摄中测试所有变体。', '**在对话中间切换模型：** 云API（OpenAI、Anthropic）在模型间不转移对话上下文。在不同模型上重新启动对话会重新发送所有先前的消息。每个对话提交到一个模型。' ] }, faq: { title: '常见问题', faqs: [ { q: 'AI中的令牌是什么？', a: '令牌是AI模型处理的最小文本单位，大约3-4个字符或3/4个英文单词。"ChatGPT"计为2个令牌。您需要为每个输入令牌和每个输出令牌付费，输出令牌通常比输入令牌贵2-5倍。' }, { q: 'GPT-5.6每个令牌多少钱？', a: 'GPT-5.6（Sol档位）每百万输入令牌收费$5.00，每百万输出令牌收费$30.00。GPT-5.6 Luna每百万输入令牌收费$0.20，每百万输出令牌收费$1.20——对于不需要完整GPT-5.6 Sol性能的任务便宜约25倍。' }, { q: '速率限制是如何运作的？', a: '速率限制限制每分钟请求数（RPM）和每分钟令牌数（TPM）。免费层：3-15 RPM，40k-100k TPM。付费层：500 RPM，200k-500k TPM。企业级：3000+ RPM。解决方法：将小任务批量处理为更大的请求、在调用之间增加延迟，或升级到更高的层级。' }, { q: '典型文章或报告需要多少令牌？', a: '1000字文章≈1200-1500令牌。10页PDF≈4000-6000令牌。单个高分辨率图像≈500-2000令牌（取决于分辨率和内容密度）。' }, { q: '为什么即使使用短提示我的API账单也比预期高？', a: '三个常见原因：（1）您在每次调用时发送完整对话历史——5轮后汇总。（2）您的系统提示很长——修剪到要点。（3）您为简单任务使用高功能模型——切换到GPT-5.6 Luna或Haiku进行分类或简短问答。' }, { q: '更长的系统提示总是意味着更好的输出吗？', a: '不，制作精良的100令牌系统提示通常会超越一个啰嗦的500令牌提示。质量胜于数量。特异性胜过啰嗦。' }, { q: '什么时候应该使用本地LLM而不是云API？', a: '在以下情况下使用本地LLM：大批量自动化（每天1000+次调用）、要求个人数据不得离开基础设施的GDPR敏感数据、或质量"足够好"的成本关键型流程。在以下情况下使用云API：延迟敏感的应用程序、复杂推理任务、或API成本可忽略的一次性分析。' }, { q: '如何降低我的AI API令牌成本？', a: '七种策略：精简系统提示、限制输出长度、每5轮汇总对话历史、简单任务使用更便宜的模型、避免发送完整对话历史、上传前缩小图像、批量处理测试调用而非手动运行。' }, { q: '典型的AI提示使用多少令牌？', a: '典型提示根据复杂程度使用150-500个令牌。简单问题（5-20个令牌）、中等段落（50-150个令牌）、带示例的完整研究提示（200-600个令牌）。每个提示的令牌数因语言和复杂程度而异。' }, { q: '提示有3000个令牌意味着什么？', a: '3000令牌的提示大致相当于一篇2000字的文章或10页以上的文本。这表明系统提示较长、对话历史完整，或文档上下文较大。为提高效率，可考虑汇总对话历史或精简不必要的上下文。' }, { q: '不同模型的每个AI提示成本是多少？', a: '成本因模型而异：GPT-5.6 Luna = 每次提示约$0.0001-0.0005。GPT-5.6 = 约$0.002-0.02。Claude Haiku 4.5 = 每次提示约$0.0005-0.002。Claude Opus 5 = 约$0.005-0.02。Gemini 3.5 Flash-Lite = 约$0.0001-0.0005。成本取决于提示长度和输出。' }, { q: 'AI提示令牌是如何计算的？', a: '令牌是通过将文本分解为3-4个字符的单位（约3/4个英文单词）来计算的。系统提示、对话历史、图像、附加文件和输出均计入其中。大多数API提供商在响应中显示确切的令牌数。较短的提示和受限的输出可减少令牌使用量。' }, { q: '1000字的提示是多少令牌？', a: '1000字的提示在英语中大约是1200-1500个令牌。其他语言的分词效率较低，可能需要多20-40%的令牌。令牌数取决于所用语言的用词选择和平均词长。' }, { q: '令牌限制是基于单个提示还是整个对话？', a: '令牌限制适用于整个对话历史，包括所有系统提示、之前的消息、检索到的文档和当前提示。速率限制（每分钟令牌数）会在该时间段内的所有API调用中累积，而不仅仅是一个提示。' }, { q: '100万个令牌可以获得多少次提示？', a: '使用100万个令牌：如果每个提示平均150-500个令牌，则可获得2000-6667次提示。GPT-5.6 Luna提示（约300个令牌）=约3333次提示。GPT-5.6提示（约500个令牌）=约2000次提示。实际数量取决于提示大小和输出长度。' }, { q: '提示优化能否显著降低API成本？', a: '可以。将500令牌的系统提示精简至300令牌，每次API调用可节省约$0.001。按每天1000次调用计算，每年可节省$365。限制输出长度并每5轮汇总对话历史可将成本降低30-50%。模型选择是最大的杠杆——GPT-5.6 Luna的成本比GPT-5.6低25倍。' } ] }, relatedReading: { title: '相关阅读', items: [ '[大型语言模型实际如何工作](/zh/prompt-engineering/how-llms-actually-work) — 决定这些成本的令牌化、上下文窗口与推理参数', '[系统提示词 vs 用户提示词](/zh/prompt-engineering/system-prompt-vs-user-prompt-whats-the-difference) — 系统提示词长度如何直接影响每次API调用的令牌成本', '[上下文窗口解释](/zh/prompt-engineering/context-windows-explained-why-ai-forgets) — 信息在中间被忽略的问题，以及上下文窗口大小如何影响成本与质量', '[如何安装Ollama](/zh/local-llms/how-to-install-ollama) — 为高频或隐私敏感的工作流搭建零令牌成本的本地推理', '[LLM量化详解](/zh/local-llms/llm-quantization-explained) — 可替代云API成本的本地模型的内存需求', '[2026年最佳本地大语言模型](/zh/local-llms/best-local-llms-2026) — 按任务类型看哪些本地模型可以替代云API' ] }, sources: { title: '来源和进一步阅读', items: [ '[OpenAI定价](https://openai.com/pricing)', '[Anthropic Claude定价](https://www.anthropic.com/pricing)', '[Google Gemini定价](https://ai.google.dev/pricing)' ] } } as any },
  ko: {
      freshness_tier: 'monthly',
      theme: 'Fundamentals', heroImage: '/images/tokens-costs-limits-overview-hero-ko.webp',
      ...
      readTime: '13분 읽기',
      toc: [
        { label: '토큰이란 무엇인가?',              anchor: '토큰이란-무엇인가' },
        { label: '토큰 계산 방식',                   anchor: '토큰-계산-방식' },
        { label: '클라우드 제공업체별 가격 비교',     anchor: '클라우드-제공업체별-가격-비교' },
        { label: '요청 속도 제한',                   anchor: '요청-속도-제한' },
        { label: '프롬프트 설계로 비용 제어하기',     anchor: '프롬프트-설계로-비용-제어하기' },
        { label: '적합한 모델 선택하기',              anchor: '적합한-모델-선택하기' },
        { label: '로컬 LLM — 무비용 옵션',           anchor: '로컬-llm-무비용-옵션' },
        { label: '지역별 맥락',                      anchor: '지역별-맥락' },
        { label: '토큰 비용 레시피',                 anchor: '토큰-비용-레시피' },
        { label: '흔한 실수들',                      anchor: '흔한-실수들' },
        { label: '관련 읽을거리',                    anchor: '관련-읽을거리' },
        { label: 'FAQ',                             anchor: 'faq' },
      ],
      educationalLevel: 'Beginner',
      primaryTerm: 'LLM 토큰',
      ...
      supplementalSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        'name': 'AI 모델 가격 비교 2026',
        'description': '주요 AI 모델의 입력 및 출력 토큰 비용 (2026-08-31 확인)',
        'numberOfItems': 7,
        'itemListElement': [
          { '@type': 'ListItem', 'position': 1, 'name': 'OpenAI GPT-5.6', 'description': '입력: $5.00/100만 토큰. 출력: $30.00/100만 토큰.' },
          { '@type': 'ListItem', 'position': 2, 'name': 'Anthropic Claude Opus 5', 'description': '입력: $5.00/100만 토큰. 출력: $25.00/100만 토큰.' },
          { '@type': 'ListItem', 'position': 3, 'name': 'Google Gemini 3.1 Pro', 'description': '입력: $2.00/100만 토큰. 출력: $12.00/100만 토큰.' },
          { '@type': 'ListItem', 'position': 4, 'name': 'OpenAI GPT-5.6 Luna', 'description': '입력: $0.20/100만 토큰. 출력: $1.20/100만 토큰. GPT-5.6보다 25배 저렴.' },
          { '@type': 'ListItem', 'position': 5, 'name': 'Anthropic Claude Haiku 4.5', 'description': '입력: $1.00/100만 토큰. 출력: $5.00/100만 토큰.' },
          { '@type': 'ListItem', 'position': 6, 'name': 'Google Gemini 3.7 Flash', 'description': '입력: $0.75/100만 토큰. 출력: $3.75/100만 토큰.' },
          { '@type': 'ListItem', 'position': 7, 'name': 'Google Gemini 3.5 Flash-Lite', 'description': '입력: $0.30/100만 토큰. 출력: $2.50/100만 토큰. 가장 저렴한 클라우드 옵션.' }
        ]
      },
      itemListSchema: {
        '@context': 'https://schema.org',
        ...
        itemListElement: [
          {
            ...
            description: 'GPT-5.6 Luna 또는 Gemini 3.5 Flash-Lite를 사용하십시오. 단순 분류에서 동등한 정확도로 GPT-5.6보다 12~25배 저렴합니다. Claude Haiku 4.5는 5~6배 저렴합니다.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: '짧은 사실 기반 질의응답',
            description: 'GPT-5.6 Luna 또는 Claude Haiku 4.5를 사용하십시오. 프론티어 모델보다 5~25배 저렴합니다. 조회 작업, 단일 답변 질문, 개체 추출에 적합합니다.',
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: '복잡한 분석 또는 코드 생성',
            description: 'GPT-5.6 또는 Claude Opus 5을 사용하십시오. 다단계 추론, 디버깅, 기술적 종합에는 프론티어 수준의 성능이 필요합니다.',
          },
          {
            '@type': 'ListItem',
            position: 4,
            name: '장문 창의적 글쓰기',
            description: 'Claude Opus 5 또는 GPT-5.6를 사용하십시오. 두 모델 모두 긴 출력에서 일관된 서사 품질과 문체를 유지하는 데 탁월합니다.',
          },
          {
            '@type': 'ListItem',
            position: 5,
      ...
      sections: {
        ...
        tldr: {
          ...
          items: [
            ...
            '작업에 적합한 모델을 사용하면 비용이 10~50배 절감됩니다. GPT-5.6 Luna 또는 Claude Haiku 4.5는 GPT-5.6나 Claude Opus 5이 필요하지 않은 작업을 처리할 수 있습니다.',
        ...
        pricing: {
          ...
          rows: [
            { '모델': 'OpenAI [GPT-5.6](https://openai.com/chatgpt)', '입력 (100만 토큰당)': '$5.00', '출력 (100만 토큰당)': '$30.00' },
            { '모델': 'Anthropic [Claude Opus 5](https://www.anthropic.com/claude)', '입력 (100만 토큰당)': '$5.00', '출력 (100만 토큰당)': '$25.00' },
            { '모델': 'Google [Gemini 3.1 Pro](https://gemini.google.com)', '입력 (100만 토큰당)': '$2.00', '출력 (100만 토큰당)': '$12.00' },
            { '모델': 'OpenAI [GPT-5.6 Luna](https://openai.com/chatgpt)', '입력 (100만 토큰당)': '$0.20', '출력 (100만 토큰당)': '$1.20' },
            { '모델': 'Anthropic [Claude Haiku 4.5](https://www.anthropic.com/claude)', '입력 (100만 토큰당)': '$1.00', '출력 (100만 토큰당)': '$5.00' },
            { '모델': 'Google [Gemini 3.7 Flash](https://gemini.google.com)', '입력 (100만 토큰당)': '$0.75', '출력 (100만 토큰당)': '$3.75' },
            { '모델': 'Google [Gemini 3.5 Flash-Lite](https://gemini.google.com)', '입력 (100만 토큰당)': '$0.30', '출력 (100만 토큰당)': '$2.50' },
          ],
          tableFormat: true
        },
        rateLimits: {
        ...
        promptDesign: {
          ...
          items: [
            ...
            '토큰 차이: 나쁜 프롬프트 = 55토큰, 좋은 프롬프트 = 13토큰. 하루 100번 호출 시: 42 × 100 × 30일 × ($5.00 / 100만 입력 토큰) ≈ 단 하나의 간결한 프롬프트로 월 $0.63 절약.'
          ]
        },
        howToStart: {
          title: 'LLM API 비용 5단계 절감법',
          numberedItems: [
            '모델을 작업 복잡도에 맞추십시오: 간단한 분류 및 질의응답에는 GPT-5.6 Luna(GPT-5.6보다 25배 저렴) 또는 Claude Haiku 4.5(5~6배 저렴)를 사용하십시오.',
        ...
        modelSelection: {
          ...
          rows: [
            { '작업 유형': '간단한 분류 / 예-아니오', '권장 모델': '[GPT-5.6 Luna](https://openai.com/chatgpt), 또는 [Gemini 3.5 Flash-Lite](https://gemini.google.com)', 'GPT-5.6 대비 비용': '12~25배 저렴' },
            { '작업 유형': '짧은 사실 기반 질의응답', '권장 모델': 'GPT-5.6 Luna 또는 Claude Haiku 4.5', 'GPT-5.6 대비 비용': '5~25배 저렴' },
            { '작업 유형': '복잡한 분석 또는 코드', '권장 모델': '[GPT-5.6](https://openai.com/chatgpt) 또는 [Claude Opus 5](https://www.anthropic.com/claude)', 'GPT-5.6 대비 비용': '기준' },
            { '작업 유형': '장문 창의적 글쓰기', '권장 모델': 'Claude Opus 5 또는 GPT-5.6', 'GPT-5.6 대비 비용': '기준' },
            { '작업 유형': '대용량 비공개 워크플로', '권장 모델': '[Ollama](https://ollama.com/library/llama3.1)를 통한 로컬 모델', 'GPT-5.6 대비 비용': 'API 비용 없음' },
          ],
          tableFormat: true
        },
        localLLMs: {
          ...
          items: [
            '**하드웨어 비용:** Llama 3.1 8B와 같은 Ollama 모델은 약 8GB VRAM이 필요하고, 13B 모델은 약 16GB, 70B 모델은 40GB 이상이 필요합니다. GPU 메모리가 제한 요인입니다.',
        ...
        promptquorumHelps: {
          ...
          content: [
            ...
            '**PromptQuorum에서 테스트 완료 — GPT-5.6와 GPT-5.6 Luna로 동일한 리서치 요약 프롬프트 20개 발송:** 20개 작업 중 17개에서 출력 품질이 일치했습니다. 비용 차이: 프롬프트당 $0.003(GPT-5.6) 대 $0.00007(Luna) — 43배 비용 절감. GPT-5.6가 더 나은 성능을 보인 3개 작업은 문서 전반의 다단계 추론을 포함했습니다.'
          ]
        },
        recipes: {
          title: '토큰 비용 레시피',
          ...
          items: [
            '**"빠른 조회 / 예-아니오 작업":** GPT-5.6 Luna 또는 Gemini 3.5 Flash-Lite를 사용하십시오. 최소 시스템 프롬프트(50토큰 이하). 대화 기록 없음. 출력을 1~2문장으로 제한하십시오. 작업당 총 비용: 약 $0.00005~0.0005.',
            '**"긴 리서치 작업 (5~10턴)":** Claude Opus 5을 사용하십시오(긴 컨텍스트에 탁월). 5턴마다 대화를 요약하고 기록을 요약으로 교체하십시오(토큰 70% 감소). 비용: 리서치 세션당 약 $0.01~0.05.',
            '**"자동화 파이프라인 / 배치 처리":** 필터링 또는 분류에 GPT-5.6 Luna를 사용하십시오(25배 저렴). 경계선 사례의 최종 종합에만 GPT-5.6로 에스컬레이션하십시오. API가 지원하는 경우 컨텍스트 캐싱을 재사용하기 위해 유사한 프롬프트를 묶으십시오.',
            ...
            '**"모델 간 출력 비교":** 잘 구조화된 프롬프트 하나를 GPT-5.6, Claude Opus 5, GPT-5.6 Luna에 동시에 전송하십시오. 품질 + 비용을 비교하십시오. 품질 기준을 충족하는 가장 저렴한 모델을 선택하십시오. 탐색 비용: 약 $0.001. 지속 비용: Luna가 품질 기준을 충족하면 최대 25배 절감.'
          ]
        },
        mistakes: {
          title: '흔한 실수들',
          ...
          items: [
            ...
            '**간단한 작업에 고성능 모델 사용:** "이 이메일에서 날짜를 추출하십시오"에 GPT-5.6를 사용하지 마십시오. GPT-5.6 Luna를 사용하십시오. 이 작업만으로도 비용 차이: 25배.',
        ...
        faq: {
          ...
          faqs: [
            ...
            },
            {
              ...
              a: 'GPT-5.6(Sol)는 100만 입력 토큰당 $5.00, 100만 출력 토큰당 $30.00입니다. GPT-5.6 Luna는 100만 입력 토큰당 $0.20, 100만 출력 토큰당 $1.20으로 전체 GPT-5.6 Sol 성능이 필요하지 않은 작업에서 약 25배 더 저렴합니다.'
            },
            {
            ...
            },
            {
              ...
              a: '세 가지 일반적인 원인: (1) 모든 호출에 전체 대화 기록을 전송하고 있습니다. 5턴마다 요약하십시오. (2) 시스템 프롬프트가 깁니다. 필수 내용으로 줄이십시오. (3) 간단한 작업에 강력한 모델을 사용하고 있습니다. 분류 또는 짧은 질의응답에는 GPT-5.6 Luna 또는 Haiku로 전환하십시오.'
            },
            {
            ...
            },
            {
              ...
              a: '모델별 비용: GPT-5.6 Luna = 프롬프트당 약 $0.0001~0.0005. GPT-5.6 = 약 $0.002~0.02. Claude Haiku 4.5 = 프롬프트당 약 $0.0005~0.002. Claude Opus 5 = 약 $0.005~0.02. Gemini 3.5 Flash-Lite = 약 $0.0001~0.0005. 비용은 프롬프트 길이와 출력에 따라 다릅니다.'
            },
            {
            ...
            },
            {
              ...
              a: '100만 토큰으로: 각 프롬프트가 평균 150~500토큰인 경우 2,000~6,667개의 프롬프트. GPT-5.6 Luna 프롬프트(약 300토큰) = 약 3,333개. GPT-5.6 프롬프트(약 500토큰) = 약 2,000개. 실제 수는 프롬프트 크기와 출력 길이에 따라 다릅니다.'
            },
            {
              q: '프롬프트 최적화가 API 비용을 크게 줄입니까?',
              a: '네. 500토큰 시스템 프롬프트를 300토큰으로 줄이면 API 호출당 약 $0.001가 절약됩니다. 하루 1,000회 호출 시 연간 $365가 절약됩니다. 출력 길이 제한과 5턴마다 대화 기록 요약으로 비용이 30~50% 줄어듭니다. 모델 선택이 가장 큰 레버입니다. GPT-5.6 Luna는 GPT-5.6보다 25배 저렴합니다.'
            },
          ]
        },
        relatedReading: {
