...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      theme: 'Fundamentals', heroImage: '/images/tokens-costs-limits-overview-hero-en.png',
    ...
    es: {
      theme: 'Fundamentals', heroImage: '/images/tokens-costs-limits-overview-hero-es.png',
    ...
    ar: {
      theme: 'Fundamentals', heroImage: '/images/tokens-costs-limits-overview-hero-ar.png',
    ...
    pt: {
      theme: 'Fundamentals', heroImage: '/images/tokens-costs-limits-overview-hero-pt.png',
    ...
    ja: { theme: 'Fundamentals', heroImage: '/images/tokens-costs-limits-overview-hero-ja.png', title: 'トークン、コスト＆制限：AIプロンプティングの経済学', intro: 'すべてのAI APIコールはトークン（モデルが処理できる内容と支払う金額を制御する単位）で測定および課金されます。トークンを理解することは、効率的で費用対効果の高いプロンプトエンジニアリングの基礎です。', publishDate: '2026-03-22', readTime: '13分で読める', primaryTerm: 'LLMトークン',
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
    ...
    zh: { theme: 'Fundamentals', heroImage: '/images/tokens-costs-limits-overview-hero-zh.png', title: '令牌、成本和限制：AI提示的经济学', intro: '每个AI API调用都用令牌来测量和计费——该单位控制模型可以处理的内容以及您支付的金额。理解令牌是高效且经济有效提示的基础。', publishDate: '2026-03-22', readTime: '13分钟阅读', primaryTerm: 'LLM令牌',
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
  ...
  ko: {
      freshness_tier: 'monthly',
      theme: 'Fundamentals', heroImage: '/images/tokens-costs-limits-overview-hero-ko.png',
