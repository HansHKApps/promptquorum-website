        ...
        itemListElement: [
          {
            ...
            description: 'Verwenden Sie GPT-5.5 Mini, Claude Haiku 4.5 oder Gemini Flash — 33× günstiger als GPT-5.5 bei gleichwertiger Genauigkeit bei einfacher Klassifizierung.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Kurze faktische Fragen und Antworten',
            description: 'Verwenden Sie GPT-5.5 Mini oder Claude Haiku 4.5 — 10–33× günstiger als Frontier-Modelle. Geeignet für Nachschlageaufgaben, Einzelantwortfragen und Entitätsextraktion.',
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: 'Komplexe Analyse oder Codegenerierung',
            description: 'Verwenden Sie GPT-5.5 oder Claude Opus 4.8 — Frontier-Fähigkeiten sind für mehrstufiges Schlussfolgern, Debugging und technische Synthese erforderlich.',
          },
          {
            '@type': 'ListItem',
            position: 4,
            name: 'Langform-Kreativtexte',
            description: 'Verwenden Sie Claude Opus 4.8 oder GPT-5.5 — beide zeichnen sich durch anhaltende Erzählqualität und Stilkonsistenz bei langen Ausgaben aus.',
          },
          {
            '@type': 'ListItem',
            position: 5,
        ...
        itemListElement: [
          {
            ...
            description: 'Usa GPT-5.5 mini, Claude Haiku 4.5 o Gemini Flash — 33× más barato que GPT-5.5 con precisión equivalente en clasificación sencilla.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Preguntas y respuestas factuales cortas',
            description: 'Usa GPT-5.5 mini o Claude Haiku 4.5 — 10–33× más barato que los modelos frontera. Adecuado para tareas de búsqueda, preguntas de respuesta única y extracción de entidades.',
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: 'Análisis complejo o generación de código',
            description: 'Usa GPT-5.5 o Claude Opus 4.8 — se requiere capacidad de frontera para razonamiento de varios pasos, depuración y síntesis técnica.',
          },
          {
            '@type': 'ListItem',
            position: 4,
            name: 'Escritura creativa extensa',
            description: 'Usa Claude Opus 4.8 o GPT-5.5 — ambos destacan en calidad narrativa sostenida y consistencia de estilo en salidas largas.',
          },
          {
            '@type': 'ListItem',
            position: 5,
        ...
        itemListElement: [
          {
            ...
            description: 'استخدم GPT-5.5 mini أو Claude Haiku 4.5 أو Gemini Flash — أرخص بـ 33 مرة من GPT-5.5 بدقة مماثلة في التصنيف البسيط.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'أسئلة وأجوبة واقعية قصيرة',
            description: 'استخدم GPT-5.5 mini أو Claude Haiku 4.5 — أرخص بـ 10-33 مرة من النماذج المتقدمة. مناسب لمهام البحث والأسئلة ذات الإجابة الواحدة واستخراج الكيانات.',
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: 'التحليل المعقد أو توليد الأكواد',
            description: 'استخدم GPT-5.5 أو Claude Opus 4.8 — القدرة المتقدمة مطلوبة للاستدلال متعدد الخطوات وتصحيح الأخطاء والتوليف التقني.',
          },
          {
            '@type': 'ListItem',
            position: 4,
            name: 'الكتابة الإبداعية الطويلة',
            description: 'استخدم Claude Opus 4.8 أو GPT-5.5 — يتفوق كلاهما في جودة السرد المستمرة واتساق الأسلوب عبر المخرجات الطويلة.',
          },
          {
            '@type': 'ListItem',
            position: 5,
        ...
        itemListElement: [
          {
            ...
            description: 'Use GPT-5.5 mini, Claude Haiku 4.5 ou Gemini Flash — 33× mais barato que o GPT-5.5 com precisão equivalente em classificação simples.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Perguntas e respostas factuais curtas',
            description: 'Use GPT-5.5 mini ou Claude Haiku 4.5 — 10–33× mais barato que os modelos de fronteira. Adequado para tarefas de consulta, perguntas de resposta única e extração de entidades.',
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: 'Análise complexa ou geração de código',
            description: 'Use GPT-5.5 ou Claude Opus 4.8 — capacidade de fronteira é necessária para raciocínio em múltiplas etapas, depuração e síntese técnica.',
          },
          {
            '@type': 'ListItem',
            position: 4,
            name: 'Escrita criativa longa',
            description: 'Use Claude Opus 4.8 ou GPT-5.5 — ambos se destacam em qualidade narrativa sustentada e consistência de estilo em saídas longas.',
          },
          {
            '@type': 'ListItem',
            position: 5,
        ...
        itemListElement: [
          {
            ...
            description: 'Utilisez GPT-5.5 mini, Claude Haiku 4.5 ou Gemini Flash — 33× moins cher que GPT-5.5 avec une précision équivalente sur une classification simple.',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Questions-réponses factuelles courtes',
            description: 'Utilisez GPT-5.5 mini ou Claude Haiku 4.5 — 10 à 33× moins cher que les modèles de pointe. Adapté aux tâches de recherche, questions à réponse unique et extraction d\'entités.',
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: 'Analyse complexe ou génération de code',
            description: 'Utilisez GPT-5.5 ou Claude Opus 4.8 — une capacité de pointe est nécessaire pour le raisonnement multi-étapes, le débogage et la synthèse technique.',
          },
          {
            '@type': 'ListItem',
            position: 4,
            name: 'Écriture créative longue',
            description: 'Utilisez Claude Opus 4.8 ou GPT-5.5 — les deux excellent en qualité narrative soutenue et cohérence de style sur des sorties longues.',
          },
          {
            '@type': 'ListItem',
            position: 5,
        ...
        itemListElement: [
          {
            ...
            description: 'GPT-5.5 mini、Claude Haiku 4.5、またはGemini Flashを使用してください — 単純な分類において同等の精度でGPT-5.5より33倍安価です。',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: '短い事実に基づくQ&A',
            description: 'GPT-5.5 miniまたはClaude Haiku 4.5を使用してください — フロンティアモデルより10〜33倍安価です。検索タスク、単一回答の質問、エンティティ抽出に適しています。',
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: '複雑な分析やコード生成',
            description: 'GPT-5.5またはClaude Opus 4.8を使用してください — 多段階の推論、デバッグ、技術的統合にはフロンティア能力が必要です。',
          },
          {
            '@type': 'ListItem',
            position: 4,
            name: '長文の創作',
            description: 'Claude Opus 4.8またはGPT-5.5を使用してください — どちらも長い出力にわたる持続的な物語品質とスタイルの一貫性に優れています。',
          },
          {
            '@type': 'ListItem',
            position: 5,
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: '简单分类或是/否任务',
            description: '使用GPT-5.5 mini、Claude Haiku 4.5或Gemini Flash——在简单分类上准确度相当，但比GPT-5.5便宜33倍。',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: '简短的事实性问答',
            description: '使用GPT-5.5 mini或Claude Haiku 4.5——比前沿模型便宜10-33倍。适用于查找任务、单一答案问题和实体提取。',
          },
          {
            '@type': 'ListItem',
            position: 3,
            name: '复杂分析或代码生成',
            description: '使用GPT-5.5或Claude Opus 4.8——多步推理、调试和技术综合需要前沿能力。',
          },
          {
            '@type': 'ListItem',
            position: 4,
            name: '长篇创意写作',
            description: '使用Claude Opus 4.8或GPT-5.5——两者在长篇输出中都擅长保持叙事质量和风格一致性。',
          },
          {
            '@type': 'ListItem',
            position: 5,
