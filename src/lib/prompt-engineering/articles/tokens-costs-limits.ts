...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      publishDate: '2026-03-22',
      dateModified: '2026-04-12',
      seoTitle: 'تكاليف وحدود رموز الذكاء الاصطناعي 2026',
      metaDescription: 'كل طلب يستهلك رموزًا، وهي الوحدة التي تتحكم في تكاليف وحدود الذكاء الاصطناعي. افهم العدّ وأسعار GPT-5.5/Claude/Gemini ونماذج LLM المحلية.',
