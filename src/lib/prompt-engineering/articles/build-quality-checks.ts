...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      theme: 'Fundamentals',
      heroImage: '/images/build-quality-checks-overview-hero-en.webp',
      title: 'AI Code Quality Checks: Catching Hallucinations in CI/CD',
      seoTitle: 'AI Code Quality Checks: Catch Hallucinations in CI/CD',
      metaDescription: 'Add AI-aware quality gates to your CI/CD pipeline: dependency existence checks, API reality validation, slopsquatting detection, and multi-model cross-review. Step-by-step framework. April 2026.',
      ogTitle: '3 Ways AI-Generated Code Breaks Your CI/CD — And How to Fix Them',
      ogDescription: 'AI-generated code compiles cleanly but invents packages that don\'t exist and calls APIs that were never built. Traditional lint and tests miss this entirely. Here is how to build gates that catch it.',
      twitterTitle: 'Your CI/CD Can\'t Catch AI Hallucinations. Here\'s What to Add',
      twitterDescription: 'AI code hallucinates packages, APIs, and logic. Your CI/CD doesn\'t catch it. Add these 5 gates. Framework + checklist inside.',
      ...
      primaryTerm: 'AI Code Quality Checks',
      ...
      schema: {
        ...
        '@type': 'TechArticle',
        headline: 'AI Code Quality Checks: Catching Hallucinations in CI/CD',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[AI Hallucinations: How to Stop Them](/prompt-engineering/ai-hallucinations-why-ai-makes-things-up) — techniques to reduce hallucinations in AI-generated outputs',
    ...
    de: {
      ...
      next_refresh_due: '2026-09-24',
      theme: 'Fundamentals',
      heroImage: '/images/build-quality-checks-overview-hero-de.webp',
      ...
      twitterDescription: 'KI-Code halluziniert Pakete, APIs und Logik. Ihre CI/CD fängt das nicht ab. 5 Gates, die das ändern. Framework + Checkliste.',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[KI-Halluzinationen: So stoppen Sie sie](/de/prompt-engineering/ai-hallucinations-why-ai-makes-things-up) — Techniken zur Reduzierung von Halluzinationen in KI-generierten Ausgaben',
    ...
    es: {
      ...
      next_refresh_due: '2026-09-24',
      theme: 'Fundamentals',
      heroImage: '/images/build-quality-checks-overview-hero-es.webp',
      ...
      twitterDescription: 'El código IA alucina paquetes, APIs y lógica. Tu CI/CD no lo atrapa. Añade estos 5 gates. Framework + checklist.',
      intro: '**El código generado por IA falla en los gates de calidad tradicionales a escala: estudios e informes de la industria encuentran consistentemente que los programas escritos por IA contienen vulnerabilidades explotables a tasas significativamente más altas que el código revisado por humanos, y una fracción medible de paquetes o APIs sugeridos por IA simplemente no existen.** Para mantener estas alucinaciones fuera de producción, los controles de calidad de build deben evolucionar de gates genéricos de "tests + cobertura" a pipelines conscientes de IA que detecten APIs irreales, dependencias falsas y lógica que es confiada pero incorrecta antes del merge.',
      publishDate: '2026-03-24',
      dateModified: '2026-04-29',
      readTime: '10 min de lectura',
      educationalLevel: 'Intermediate',
      audience: 'Líderes de equipos de desarrollo e ingenieros DevOps que integran asistentes de codificación IA en pipelines CI/CD de producción',
      primaryTerm: 'Controles de calidad de código IA',
      aboutTopics: ['Seguridad CI/CD', 'Alucinaciones de código IA', 'Validación de dependencias'],
      toc: [
        { label: 'Puntos clave', anchor: '#key-takeaways' },
        { label: '¿Qué cambia cuando la IA escribe tu código?', anchor: '#what-changes' },
        { label: '¿Qué tipos de alucinaciones deben atrapar tus gates?', anchor: '#hallucination-types' },
        { label: '¿Cómo es una arquitectura CI/CD de gate consciente de IA?', anchor: '#architecture' },
        { label: '¿Qué controles concretos debes añadir?', anchor: '#concrete-checks' },
        { label: '¿Cómo manejas las alucinaciones en el pipeline?', anchor: '#hallucination-handling' },
        { label: '¿Cómo hacer que los controles de calidad IA sean amigables para el desarrollador?', anchor: '#developer-friendly' },
        { label: 'Ejemplo: Extender un gate clásico para código IA', anchor: '#example' },
        { label: 'Paso a paso: ¿cómo configurar controles de calidad conscientes de IA?', anchor: '#how-to-start' },
      ...
      schema: {
        ...
        proficiencyLevel: 'Intermediate',
        audience: { '@type': 'Audience', audienceType: 'Líderes de equipos de desarrollo e ingenieros DevOps que integran asistentes de codificación IA' },
        about: [
          { '@type': 'Thing', name: 'Calidad de código IA' },
          { '@type': 'Thing', name: 'Pipelines CI/CD' },
          { '@type': 'Thing', name: 'Detección de alucinaciones' },
        ],
        speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
        mentions: [
          { '@type': 'SoftwareApplication', name: 'SAST' },
      ...
      howToSchema: {
        '@context': 'https://schema.org',
        '@type': 'HowTo',
        name: 'Cómo construir controles de calidad conscientes de IA',
        inLanguage: 'es',
        step: [
          { '@type': 'HowToStep', name: 'Añadir un paso de validación de dependencias', text: 'Verifica que todos los paquetes importados realmente existen en tu gestor de paquetes. Comprueba que cada instrucción import o require se resuelve a un paquete real en npm, pip, PyPI o tu registro interno.' },
          { '@type': 'HowToStep', name: 'Escanear patrones de alucinación', text: 'Ejecuta un linter o script personalizado que compruebe cada llamada a la API contra la documentación real del SDK o servicio. Marca las llamadas a métodos o endpoints que no existen en tu base de código o versiones de SDK.' },
          { '@type': 'HowToStep', name: 'Añadir un gate centrado en seguridad', text: 'Ejecuta herramientas SAST como Bandit (Python), ESLint-Security (JavaScript) o Snyk en los archivos modificados. Escanea patrones de inyección SQL, reglas CORS demasiado amplias, credenciales hardcodeadas y deserialización insegura.' },
          { '@type': 'HowToStep', name: 'Usar validación multi-modelo para rutas críticas', text: 'Para código que toca autenticación, pagos o infraestructura, ejecuta el código a través de múltiples modelos de IA preguntando si coincide con la lógica prevista y si hay riesgos de seguridad.' },
          { '@type': 'HowToStep', name: 'Requerir revisión humana centrada en la lógica', text: 'Los gates automatizados detectan alucinaciones obvias. Los revisores de código deben verificar: ¿hace esto lo que se pretendía? ¿Se manejan los casos límite? ¿Es el enfoque apropiado para el caso de uso?' },
        ],
      },
      sections: {
        tldr: {
        ...
        definition: {
          id: 'what-changes',
          title: '¿Qué cambia cuando la IA escribe tu código?',
          content: [
        ...
        hallucinations: {
          id: 'hallucination-types',
          title: '¿Qué tipos de alucinaciones deben atrapar tus gates?',
          content: [
          ...
          snippets: [
            { type: 'in-one-sentence', text: 'Una alucinación de código es cualquier salida generada por IA — un nombre de paquete, método de API, flag de configuración o algoritmo — que no corresponde a nada que realmente exista o funcione en tu entorno.' },
            { type: 'in-plain-terms', text: 'Piénsalo como una IA que confiadamente te da indicaciones para una calle que no existe. Las indicaciones parecen plausibles, pero seguirlas no lleva a ningún lado — o a algún lugar peligroso.' },
          ],
        },
        hallucinationsConclusion: {
          content: [
        ...
        architecture: {
          id: 'architecture',
          title: '¿Cómo es una arquitectura CI/CD de gate consciente de IA?',
          content: [
        ...
        concreteChecks: {
          id: 'concrete-checks',
          title: '¿Qué controles concretos debes añadir para el código generado por IA?',
          content: [
        ...
        hallucinationHandling: {
          id: 'hallucination-handling',
          title: '¿Cómo manejas las alucinaciones explícitamente en el pipeline?',
          content: [
        ...
        developerFriendly: {
          id: 'developer-friendly',
          title: '¿Cómo hacer que los controles de calidad IA sean amigables para el desarrollador?',
          content: [
        ...
        example: {
          id: 'example',
          title: 'Ejemplo: Extender un gate clásico para código generado por IA',
          content: [
        ...
        exampleExtension: {
          content: ['Extensión consciente de IA:'],
          items: [
        ...
        exampleConclusion: {
          content: ['Este enfoque evita una reconstrucción completa de tu proceso mientras se dirige directamente a los riesgos específicos de la IA.'],
        },
        howToStart: {
          id: 'how-to-start',
          title: 'Paso a paso: ¿cómo configurar controles de calidad conscientes de IA?',
          numberedItems: [
        ...
        commonMistakes: {
          ...
          mistakes: [
            { mistake: 'Tratar el código generado por IA como equivalente al código escrito por humanos en riesgo de calidad', problem: 'Los umbrales estándar de lint y tests unitarios están calibrados para código escrito y revisado por humanos. El código generado por IA puede pasar todos los gates tradicionales mientras contiene APIs alucinadas, paquetes fabricados y lógica silenciosamente incorrecta.', fix: 'Aplica un nivel de riesgo separado para el código generado o modificado por IA. Usa umbrales de cobertura más estrictos (≥80% para nuevas líneas), requiere escaneos de seguridad en todos los archivos tocados por IA y añade controles de existencia de dependencias.' },
            { mistake: 'Confiar en la compilación como prueba de corrección', problem: 'El código generado por IA compila correctamente incluso cuando invoca métodos que no existen, importa paquetes que no están registrados, o implementa lógica que viola los requisitos.', fix: 'Añade validación en tiempo de ejecución: tests basados en propiedades, tests de casos límite y tests de integración que fallarían si la lógica fuera sutilmente incorrecta.' },
            { mistake: 'No comprobar si los paquetes sugeridos realmente existen en el registro', problem: 'Los modelos de lenguaje frecuentemente inventan nombres de paquetes plausibles cuando no conocen el correcto. Los desarrolladores que ejecutan npm install o pip install en un nombre alucinado pueden instalar un paquete malicioso registrado más tarde por un atacante (slopsquatting).', fix: 'Ejecuta un paso de validación de dependencias que llame a la API del registro npm/PyPI/Maven para cada nueva importación de paquete. Falla el build si el paquete no se puede resolver o no tiene historial de publicación.' },
            { mistake: 'Iniciar nuevos gates en modo de bloqueo sin datos', problem: 'Un nuevo gate introducido como bloqueo duro encontrará falsos positivos, creando fricción y erosionando la confianza de los desarrolladores.', fix: 'Ejecuta cada nuevo gate en modo de advertencia durante al menos un sprint. Mide la relación señal-ruido y solo promueve a bloqueo una vez que el gate sea demostrablemente fiable.' },
            { mistake: 'Omitir dashboards y métricas específicas para IA', problem: 'Sin visibilidad sobre cuántos problemas relacionados con alucinaciones se detectaron, los equipos no pueden justificar la sobrecarga de los gates conscientes de IA ni ajustarlos efectivamente.', fix: 'Instrumenta tu CI para etiquetar los problemas por categoría. Expone un resumen semanal de problemas detectados por categoría.' },
          ],
        },
        regionalContext: {
          id: 'regional-context',
          title: 'Consideraciones regionales para la calidad del código IA',
          content: [
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: '¿Cómo detecto nombres de paquetes alucinados en mi pipeline CI/CD?', a: 'Añade un paso de validación de dependencias que compruebe si cada paquete importado realmente existe en tu registro objetivo antes de ejecutar los tests. Los paquetes que no se pueden resolver o no tienen historial de publicación deben fallar el build inmediatamente.' },
            { q: '¿Qué controles de seguridad debo añadir para el código generado por IA?', a: 'Ejecuta herramientas SAST como Bandit (Python), ESLint-Security (JavaScript) o Snyk en cada archivo modificado. Requiere cero nuevos hallazgos altos o críticos en rutas de código modificadas por IA.' },
            { q: '¿Una API alucinada es lo mismo que un error en tiempo de ejecución?', a: 'Una API alucinada es más sutil que un simple error en tiempo de ejecución. Se refiere a un modelo que inventa un método, parámetro u opción de configuración que no existe en el SDK o servicio real.' },
            { q: '¿Puedo usar herramientas de IA para revisar código generado por IA?', a: 'Sí. La verificación cruzada multi-modelo es un patrón efectivo: un modelo genera código, un modelo diferente lo revisa. Esto funciona mejor en rutas de riesgo crítico como autenticación, procesamiento de pagos o configuración de infraestructura.' },
            { q: '¿Cómo introduzco controles de calidad conscientes de IA sin ralentizar a mi equipo?', a: 'Empieza todas las nuevas reglas en modo de advertencia para recopilar datos antes de bloquear los merges. Permite excepciones documentadas para que los equipos puedan continuar en casos inusuales pero válidos mientras dejan un rastro de auditoría.' },
            { q: '¿Qué es el slopsquatting y por qué es peligroso?', a: 'El slopsquatting ocurre cuando un modelo de IA inventa un nombre de paquete que suena plausible pero no existe en ningún registro. Si un atacante registra más tarde ese nombre con código malicioso, cualquier desarrollador que lo instale ejecuta el payload del atacante.' },
          ],
        },
        relatedReading: {
          id: 'related-reading',
          ...
          items: [
            ...
            '[Alucinaciones de IA: cómo detenerlas](/es/prompt-engineering/ai-hallucinations-why-ai-makes-things-up) — técnicas para reducir alucinaciones en salidas de IA generadas',
        ...
        sources: {
          ...
          title: 'Fuentes',
          items: [
            '[OWASP Top 10 para aplicaciones LLM](https://owasp.org/www-project-top-10-for-large-language-model-applications/) — OWASP, 2025. Riesgos de seguridad específicos para código generado por LLM y desarrollo asistido por IA.',
            '[Documentación de GitHub CodeQL](https://codeql.github.com/docs/) — GitHub. Motor de análisis estático usado para escaneo de seguridad de rutas de código modificadas por IA.',
            '[Snyk State of Open Source Security Report](https://snyk.io/reports/state-of-open-source-security/) — Snyk, 2024–2025. Informe anual sobre vulnerabilidades de dependencias y riesgos de la cadena de suministro.',
            '[NIST AI Risk Management Framework (AI RMF 1.0)](https://airc.nist.gov/Home) — NIST, 2023. Marco para gestionar riesgos de sistemas de IA incluyendo calidad de código y gobernanza.',
          ],
        },
      },
    },
    ar: {
      ...
      next_refresh_due: '2026-09-24',
      theme: 'Fundamentals',
      heroImage: '/images/build-quality-checks-overview-hero-ar.webp',
      title: 'جودة كود الذكاء الاصطناعي في ⁨CI/CD⁩: كشف الهلوسة والتبعيات المختلَقة',
      seoTitle: 'جودة كود الذكاء الاصطناعي: كشف الهلوسة في ⁨CI/CD⁩',
      metaDescription: 'أضف بوابات جودة بالذكاء الاصطناعي إلى خط أنابيب ⁨CI/CD⁩: التحقق من التبعيات وتحقق من ⁨APIs⁩ وكشف ⁨slopsquatting⁩ ومراجعة متعددة النماذج.',
      ogTitle: '3 طرق يكسر فيها الكود المولَّد بالذكاء الاصطناعي CI/CD — وكيفية إصلاحه',
      ogDescription: 'الكود المولَّد بالذكاء الاصطناعي يُصرَّف بشكل صحيح لكنه يخترع حزمًا غير موجودة ويستدعي APIs لم تُبنَ قط. الاختبارات والتحليل الثابت التقليديان لا يكتشفان هذا. تعلَّم كيفية بناء بوابات تكتشفه.',
      twitterTitle: 'CI/CD لا يكتشف هلوسة الذكاء الاصطناعي. إليك ما تضيفه',
      twitterDescription: 'الكود المولَّد بالذكاء الاصطناعي يُهلوِس حزمًا و⁨APIs⁩ ومنطقًا. ⁨CI/CD⁩ لا يلتقطه. أضف هذه البوابات الخمس. إطار عمل + قائمة تحقق.',
      intro: '**الكود المولَّد بالذكاء الاصطناعي يفشل في بوابات الجودة التقليدية على نطاق واسع: تجد الدراسات وتقارير الصناعة باستمرار أن البرامج المكتوبة بالذكاء الاصطناعي تحتوي على ثغرات قابلة للاستغلال بمعدلات أعلى بكثير من الكود المراجَع بشريًا، وجزء قابل للقياس من الحزم أو APIs المقترحة بالذكاء الاصطناعي ببساطة غير موجود.** لإبقاء هذه الهلوسة خارج الإنتاج، يجب أن تتطور بوابات جودة البناء من بوابات "اختبارات + تغطية" العامة إلى خطوط أنابيب واعية بالذكاء الاصطناعي تكتشف APIs غير واقعية وتبعيات مزيفة ومنطقًا واثقًا لكنه خاطئ قبل الدمج.',
      publishDate: '2026-03-24',
      dateModified: '2026-04-29',
      readTime: '١٠ دقائق للقراءة',
      educationalLevel: 'متوسط',
      audience: 'قادة فرق التطوير ومهندسو DevOps الذين يدمجون مساعدي البرمجة بالذكاء الاصطناعي في خطوط أنابيب CI/CD للإنتاج',
      primaryTerm: 'بوابات جودة كود الذكاء الاصطناعي',
      aboutTopics: ['أمان CI/CD', 'هلوسة كود الذكاء الاصطناعي', 'التحقق من التبعيات'],
      toc: [
        { label: 'النقاط الرئيسية', anchor: '#key-takeaways' },
        { label: 'ما الذي يتغير حين يكتب الذكاء الاصطناعي كودك؟', anchor: '#what-changes' },
        { label: 'ما أنواع الهلوسة التي يجب أن تلتقطها بواباتك؟', anchor: '#hallucination-types' },
        { label: 'كيف تبدو بنية CI/CD البوابة الواعية بالذكاء الاصطناعي؟', anchor: '#architecture' },
        { label: 'ما البوابات المحددة التي يجب إضافتها؟', anchor: '#concrete-checks' },
        { label: 'كيف تتعامل مع الهلوسة في خط الأنابيب؟', anchor: '#hallucination-handling' },
        { label: 'كيف تجعل بوابات جودة الذكاء الاصطناعي صديقة للمطور؟', anchor: '#developer-friendly' },
        { label: 'مثال: توسيع بوابة كلاسيكية لكود الذكاء الاصطناعي', anchor: '#example' },
        { label: 'خطوة بخطوة: كيفية إعداد بوابات جودة واعية بالذكاء الاصطناعي؟', anchor: '#how-to-start' },
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        headline: 'جودة كود الذكاء الاصطناعي في CI/CD: كشف الهلوسة والتبعيات المختلَقة',
        description: 'صمِّم بوابات جودة CI/CD للكود المولَّد بالذكاء الاصطناعي. يشمل كشف الهلوسة والتحقق من التبعيات وبوابات الأمان والممارسات الصديقة للمطور.',
        datePublished: '2026-03-24',
        dateModified: '2026-04-29',
        author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
        url: 'https://www.promptquorum.com/ar/prompt-engineering/build-quality-checks',
        inLanguage: 'ar',
        keywords: ['بوابات الجودة', 'CI/CD', 'هلوسة الذكاء الاصطناعي', 'مراجعة الكود', 'فحص الأمان', 'التحقق من التبعيات', 'بوابات البناء'],
        proficiencyLevel: 'Intermediate',
        audience: { '@type': 'Audience', audienceType: 'قادة فرق التطوير ومهندسو DevOps الذين يدمجون مساعدي البرمجة بالذكاء الاصطناعي' },
        about: [
          { '@type': 'Thing', name: 'جودة كود الذكاء الاصطناعي' },
          { '@type': 'Thing', name: 'خطوط أنابيب CI/CD' },
          { '@type': 'Thing', name: 'كشف الهلوسة' },
        ],
        speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
        mentions: [
          { '@type': 'SoftwareApplication', name: 'SAST' },
      ...
      howToSchema: {
        '@context': 'https://schema.org',
        '@type': 'HowTo',
        name: 'كيفية بناء بوابات جودة واعية بالذكاء الاصطناعي',
        inLanguage: 'ar',
        step: [
          { '@type': 'HowToStep', name: 'إضافة خطوة التحقق من التبعيات', text: 'تحقق من وجود جميع الحزم المستوردة فعليًا في مدير الحزم. تأكد من حل كل عبارة import أو require إلى حزمة حقيقية في npm أو pip أو PyPI أو سجلك الداخلي.' },
          { '@type': 'HowToStep', name: 'فحص أنماط الهلوسة', text: 'شغِّل linter أو script مخصصًا يتحقق من كل استدعاء API مقابل وثائق SDK أو الخدمة الفعلية. ضَعْ علامة على استدعاءات المناهج أو نقاط النهاية الغائبة عن قاعدة كودك أو إصدارات SDK.' },
          { '@type': 'HowToStep', name: 'إضافة بوابة متمركزة على الأمان', text: 'شغِّل أدوات SAST مثل Bandit (Python) وESLint-Security (JavaScript) أو Snyk على الملفات المعدَّلة. افحص أنماط حقن SQL وقواعد CORS الواسعة جدًا وبيانات الاعتماد المُشفَّرة والتحلل غير الآمن.' },
          { '@type': 'HowToStep', name: 'استخدام التحقق متعدد النماذج للمسارات الحرجة', text: 'للكود الذي يلمس المصادقة والمدفوعات أو البنية التحتية، شغِّل الكود عبر نماذج ذكاء اصطناعي متعددة سائلًا ما إذا كان يتطابق مع المنطق المقصود وما إذا كانت هناك مخاطر أمان.' },
          { '@type': 'HowToStep', name: 'اشتراط مراجعة بشرية متمركزة على المنطق', text: 'البوابات الآلية تكتشف الهلوسة الواضحة. المراجعون البشريون يجب أن يتحققوا: هل يفعل هذا ما أُريد به؟ هل تُعالَج الحالات الحافة؟ هل النهج مناسب لحالة الاستخدام؟' },
        ],
      },
      sections: {
        tldr: {
          ...
          isTldr: true,
          items: [
            'يُدخِل الكود المولَّد بالذكاء الاصطناعي أنماط فشل جديدة — APIs مُهلوَسة وتبعيات مختلَقة ومنطق يكسر المتطلبات — لم تُصمَّم بوابات الجودة التقليدية لكشفها.',
            'عامِل الهلوسة كمخاطرة هيكلية: افترض أنها ستحدث في أي مكان يُسمَح فيه للذكاء الاصطناعي بكتابة الكود أو إعادة هيكلته، وصمِّم الاختبارات والسياسات لكشفها.',
            'بنية البوابة الواعية بالذكاء الاصطناعي تُطبِّق طبقات من بوابات pre-commit وسياسات على مستوى PR وتحليل أعمق في CI وبوابات الأمان والتبعيات وتغذية راجعة في وقت التشغيل.',
            'البوابات المحددة للذكاء الاصطناعي تشمل فحوصات وجود التبعيات وفحوصات واقعية للAPIs وعتبات تغطية أعلى في الكود الجديد وبوابات أمان أكثر صرامة في الملفات المعدَّلة بالذكاء الاصطناعي.',
            'البوابات الصديقة للمطور تشرح الإخفاقات بوضوح وتُفرِّق بين التحذيرات والحجب الصارم وتسمح بالاستثناءات الموثَّقة ومضبوطة لتقليل النتائج الإيجابية الكاذبة الصاخبة.',
          ],
        },
        definition: {
          id: 'what-changes',
          title: 'ما الذي يتغير حين يكتب الذكاء الاصطناعي كودك؟',
          content: [
        ...
        hallucinations: {
          id: 'hallucination-types',
          title: 'ما أنواع الهلوسة التي يجب أن تلتقطها بواباتك؟',
          content: [
          ...
          snippets: [
            { type: 'in-one-sentence', text: 'هلوسة الكود هي أي مخرجات مولَّدة بالذكاء الاصطناعي — اسم حزمة أو منهج API أو علم تكوين أو خوارزمية — لا يقابله شيء موجود فعليًا أو يعمل في بيئتك.' },
            { type: 'in-plain-terms', text: 'فكِّر فيه كذكاء اصطناعي يعطيك بثقة اتجاهات لشارع غير موجود. الاتجاهات تبدو معقولة، لكن اتباعها لا يصل إلى أي مكان — أو إلى مكان خطير.' },
          ],
        },
        hallucinationsConclusion: {
          content: [
        ...
        architecture: {
          id: 'architecture',
          title: 'كيف تبدو بنية CI/CD البوابة الواعية بالذكاء الاصطناعي؟',
          content: [
        ...
        concreteChecks: {
          id: 'concrete-checks',
          title: 'ما البوابات المحددة التي يجب إضافتها للكود المولَّد بالذكاء الاصطناعي؟',
          content: [
        ...
        hallucinationHandling: {
          id: 'hallucination-handling',
          title: 'كيف تتعامل مع الهلوسة صراحةً في خط الأنابيب؟',
          content: [
        ...
        developerFriendly: {
          id: 'developer-friendly',
          title: 'كيف تجعل بوابات جودة الذكاء الاصطناعي صديقة للمطور؟',
          content: [
        ...
        example: {
          id: 'example',
          title: 'مثال: توسيع بوابة كلاسيكية للكود المولَّد بالذكاء الاصطناعي',
          content: [
        ...
        exampleExtension: {
          content: ['توسيع واعٍ بالذكاء الاصطناعي:'],
          items: [
        ...
        exampleConclusion: {
          content: ['هذا النهج يتجنب إعادة بناء كاملة لعمليتك مع التعامل المباشر مع المخاطر المحددة للذكاء الاصطناعي.'],
        },
        howToStart: {
          id: 'how-to-start',
          title: 'خطوة بخطوة: كيفية إعداد بوابات جودة واعية بالذكاء الاصطناعي',
          numberedItems: [
            '**أضف خطوة التحقق من التبعيات: تحقق من وجود جميع الحزم المستوردة في مدير الحزم.** قبل تشغيل الاختبارات، تأكد من وجود كل حزمة مذكورة في عبارات `import` أو `require` في npm أو pip أو PyPI أو سجلك الداخلي. هلوسات الذكاء الاصطناعي كثيرًا ما تخترع أسماء حزم تبدو معقولة.',
            '**افحص أنماط الهلوسة الشائعة: APIs غير موجودة ودوال بتوقيعات خاطئة وأعلام تكوين مختلَقة.** شغِّل linter أو script مخصصًا يتحقق مما إذا كان كل استدعاء API يتطابق مع وثائق SDK أو الخدمة الفعلية.',
            '**أضف بوابة متمركزة على الأمان: SAST بالإضافة إلى بوابات صريحة للثغرات الشائعة في الكود المولَّد بالذكاء الاصطناعي.** استخدم أدوات مثل Bandit (Python) وESLint-Security (JavaScript) أو Snyk. افحص أيضًا: أنماط حقن SQL وقواعد CORS الواسعة جدًا وبيانات الاعتماد المُشفَّرة والتحلل غير الآمن.',
            '**استخدم التحقق متعدد النماذج للمسارات الحرجة (مصادقة ومدفوعات وبنية تحتية).** قبل الدمج، شغِّل كودك عبر نماذج ذكاء اصطناعي متعددة سائلًا "هل هذا الكود يتطابق مع المنطق المقصود؟ هل هناك مخاطر أمان؟" ضَعْ علامة على التباينات.',
            '**اشترط مراجعة بشرية للكود المتمركزة على المنطق مقابل النحو.** البوابات الآلية تكتشف الهلوسة الواضحة. المراجعون البشريون يجب أن يتحققوا: هل يفعل هذا ما أُريد به؟ هل تُعالَج الحالات الحافة؟ هل النهج مناسب لحالة الاستخدام؟',
          ],
        },
        commonMistakes: {
          id: 'common-mistakes',
          ...
          mistakes: [
            { mistake: 'معاملة الكود المولَّد بالذكاء الاصطناعي كمكافئ للكود المكتوب بشريًا في مخاطر الجودة', problem: 'عتبات lint واختبارات الوحدة القياسية مُعايَرة للكود المكتوب والمراجَع بشريًا. الكود المولَّد بالذكاء الاصطناعي يمكن أن يجتاز جميع البوابات التقليدية مع احتوائه على APIs مُهلوَسة وحزم مختلَقة ومنطق خاطئ بصمت.', fix: 'طبِّق مستوى مخاطر منفصلًا للكود المولَّد أو المعدَّل بالذكاء الاصطناعي. استخدم عتبات تغطية أكثر صرامة (≥80٪ للسطور الجديدة) واشترط فحوصات الأمان في جميع الملفات الملمسة بالذكاء الاصطناعي وأضف فحوصات وجود التبعيات.' },
            { mistake: 'الاعتماد على التصريف كدليل على الصحة', problem: 'الكود المولَّد بالذكاء الاصطناعي يُصرَّف بشكل صحيح حتى حين يستدعي مناهج غير موجودة أو يستورد حزمًا غير مسجَّلة أو ينفِّذ منطقًا ينتهك المتطلبات.', fix: 'أضف التحقق في وقت التشغيل: اختبارات قائمة على الخصائص واختبارات الحالات الحافة واختبارات التكامل التي تفشل إذا كان المنطق خاطئًا بدقة.' },
            { mistake: 'عدم التحقق من وجود الحزم المقترحة فعليًا في السجل', problem: 'تخترع النماذج اللغوية أحيانًا أسماء حزم معقولة حين لا تعرف الاسم الصحيح. المطورون الذين ينفِّذون npm install أو pip install على اسم مُهلوَس قد يثبِّتون حزمة خبيثة سجَّلها مهاجم لاحقًا (slopsquatting).', fix: 'شغِّل خطوة التحقق من التبعيات التي تستدعي API سجل npm/PyPI/Maven لكل استيراد حزمة جديد. أفشِل عملية البناء إذا تعذَّر حل الحزمة أو لم يكن لها تاريخ نشر.' },
            { mistake: 'إطلاق بوابات جديدة في وضع الحجب بدون بيانات', problem: 'بوابة جديدة مُقدَّمة كحجب صارم ستجد نتائج إيجابية كاذبة وتخلق احتكاكًا وتُآكِل ثقة المطور.', fix: 'شغِّل كل بوابة جديدة في وضع التحذير لمدة sprint واحدة على الأقل. قِس نسبة الإشارة إلى الضوضاء وروِّج إلى الحجب فقط حين تكون البوابة موثوقة بشكل موثَّق.' },
            { mistake: 'إغفال لوحات التحكم والمقاييس المحددة للذكاء الاصطناعي', problem: 'بدون رؤية حول كم مشكلة مرتبطة بالهلوسة جرى كشفها، لا يمكن للفرق تبرير العبء الإضافي للبوابات الواعية بالذكاء الاصطناعي ولا ضبطها بفعالية.', fix: 'قِس CI لوضع علامة على المشكلات حسب الفئة. اعرض ملخصًا أسبوعيًا للمشكلات المكتشفة حسب الفئة.' },
          ],
        },
        regionalContext: {
          id: 'regional-context',
          title: 'الاعتبارات الإقليمية لجودة كود الذكاء الاصطناعي',
          content: [
        ...
        faqSection: {
          ...
          faqs: [
            { q: 'ما هي بوابة جودة البناء الواعية بالذكاء الاصطناعي؟', a: 'بوابة جودة البناء الواعية بالذكاء الاصطناعي هي بوابة CI/CD مُصمَّمة لكشف أنماط فشل محددة في الكود المولَّد بالذكاء الاصطناعي: APIs مُهلوَسة وأسماء حزم مختلَقة وأخطاء منطقية تُصرَّف لكن تنتهك المتطلبات.' },
            { q: 'كيف يختلف الكود المولَّد بالذكاء الاصطناعي من حيث مخاطر الجودة؟', a: 'يُدخِل الكود المولَّد بالذكاء الاصطناعي أنماط فشل هيكلية نادرًا ما يُظهرها الكود المكتوب بشريًا: أسماء حزم مخترعة وإصدارات SDK واستدعاءات مناهج غير موجودة وكود يجتاز اختبارات سطحية مع تطبيق غير صحيح للمتطلبات.' },
            { q: 'كيف أكتشف أسماء الحزم المُهلوَسة في خط أنابيب CI/CD؟', a: 'أضف خطوة التحقق من التبعيات التي تتحقق من وجود كل حزمة مستوردة فعليًا في سجلك المستهدف قبل تشغيل الاختبارات. الحزم التي يتعذَّر حلها أو لا يكون لها تاريخ نشر يجب أن تُفشِل عملية البناء فورًا.' },
            { q: 'ما فحوصات الأمان التي يجب إضافتها للكود المولَّد بالذكاء الاصطناعي؟', a: 'شغِّل أدوات SAST مثل Bandit (Python) وESLint-Security (JavaScript) أو Snyk على كل ملف معدَّل. اشترط صفر نتائج جديدة عالية أو حرجة في مسارات الكود المعدَّلة بالذكاء الاصطناعي.' },
            { q: 'هل API مُهلوَسة هي نفسها خطأ في وقت التشغيل؟', a: 'API مُهلوَسة أكثر دقةً من خطأ وقت تشغيل بسيط. تشير إلى نموذج يخترع منهجًا أو معاملًا أو خيار تكوين غير موجود في SDK أو خدمتك الفعلية.' },
        ...
        relatedReading: {
          ...
          title: 'قراءة ذات صلة',
          items: [
            '[كتابة كود أفضل بالذكاء الاصطناعي](/ar/prompt-engineering/write-better-code-with-ai) — كيفية هيكلة التعليمات لتوليد الكود الذي ينتج مخرجات قابلة للمراجعة',
            '[مراجعة الكود بالذكاء الاصطناعي: الأدوات والتحقق](/ar/prompt-engineering/ai-code-review) — استخدام الذكاء الاصطناعي لمراجعة جودة الكود والأمان',
            '[ما هي هندسة التعليمات؟](/ar/prompt-engineering/what-is-prompt-engineering) — المبادئ الأساسية لمخرجات الذكاء الاصطناعي الموثوقة',
            '[حقن التعليمات والأمان](/ar/prompt-engineering/prompt-injection-and-security) — أنماط هجوم تؤثر على خطوط أنابيب التطوير المدعوم بالذكاء الاصطناعي',
            '[هلوسة الذكاء الاصطناعي: كيفية إيقافها](/ar/prompt-engineering/ai-hallucinations-why-ai-makes-things-up) — تقنيات لتقليل الهلوسة في مخرجات الذكاء الاصطناعي المولَّدة',
            '[كيفية تقييم جودة التعليمات](/ar/prompt-engineering/how-to-evaluate-prompt-quality) — أُطر تقييم قابلة للتطبيق على جودة توليد الكود',
          ],
        },
        sources: {
          id: 'sources',
          title: 'المصادر',
          items: [
            '[OWASP Top 10 لتطبيقات LLM](https://owasp.org/www-project-top-10-for-large-language-model-applications/) — OWASP، 2025. مخاطر الأمان المحددة للكود المولَّد بـ LLM والتطوير المدعوم بالذكاء الاصطناعي.',
            '[وثائق GitHub CodeQL](https://codeql.github.com/docs/) — GitHub. محرك التحليل الثابت المستخدم لفحص الأمان لمسارات الكود المعدَّلة بالذكاء الاصطناعي.',
            '[تقرير Snyk لحالة أمان المصادر المفتوحة](https://snyk.io/reports/state-of-open-source-security/) — Snyk، 2024 إلى 2025. تقرير سنوي عن ثغرات التبعيات ومخاطر سلسلة التوريد.',
            '[إطار NIST لإدارة مخاطر الذكاء الاصطناعي (AI RMF 1.0)](https://airc.nist.gov/Home) — NIST، 2023. إطار لإدارة مخاطر أنظمة الذكاء الاصطناعي بما يشمل جودة الكود والحوكمة.',
          ],
        },
      },
    },
    pt: {
      ...
      next_refresh_due: '2026-09-24',
      theme: 'Fundamentals',
      heroImage: '/images/build-quality-checks-overview-hero-pt.webp',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Alucinações de IA: como pará-las](/pt/prompt-engineering/ai-hallucinations-why-ai-makes-things-up) — técnicas para reduzir alucinações em saídas geradas por IA',
    ...
    fr: {
      ...
      next_refresh_due: '2026-09-24',
      theme: 'Fundamentals',
      heroImage: '/images/build-quality-checks-overview-hero-fr.webp',
      title: 'Qualité CI/CD pour code généré par IA : détecter hallucinations et dépendances fabriquées',
      seoTitle: 'Qualité du Code IA : Détecter les Hallucinations en CI/CD',
      metaDescription: 'Ajoutez des contrôles qualité IA à votre pipeline CI/CD : validation des dépendances, vérification des API, détection du slopsquatting et revue multi-modèle. Guide pas-à-pas. Avril 2026.',
      ogTitle: '3 façons dont le code IA casse votre CI/CD — et comment y remédier',
      ogDescription: 'Le code généré par IA compile parfaitement mais invente des paquets inexistants et appelle des API fictives. Les tests classiques ne détectent rien. Voici comment construire des gates qui les interceptent.',
      twitterTitle: 'Votre CI/CD ne détecte pas les hallucinations IA. Voici quoi ajouter',
      twitterDescription: 'Le code IA hallucine des paquets, des API et de la logique. Votre CI/CD ne le voit pas. 5 gates pour tout intercepter. Guide + checklist.',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Hallucinations IA : comment les stopper](/fr/prompt-engineering/ai-hallucinations-why-ai-makes-things-up) — techniques pour réduire les hallucinations dans les sorties générées par IA',
    ...
    ja: {
      ...
      next_refresh_due: '2026-09-24',
      theme: 'ファンダメンタルズ',
      heroImage: '/images/build-quality-checks-overview-hero-ja.webp',
      title: 'AIを想定したビルド品質チェック：ハルシネーションと架空の依存関係を検出する',
      seoTitle: 'AIコード品質チェック：CI/CDでハルシネーションを検出',
      metaDescription: 'CI/CDパイプラインにAI対応品質ゲートを追加：依存関係の存在確認、APIリアリティチェック、スロップスクワッティング検出、マルチモデルクロスレビュー。ステップバイステップガイド。2026年4月版。',
      ogTitle: 'AI生成コードがCI/CDを壊す3つの原因と対処法',
      ogDescription: 'AI生成コードは正常にコンパイルされるが、存在しないパッケージやAPIを捏造する。従来のlintやテストでは検出できない。マージ前にこれらを捕捉するゲートの構築方法を解説。',
      twitterTitle: 'あなたのCI/CDはAIハルシネーションを検出できません。追加すべきもの',
      twitterDescription: 'AIコードがパッケージ・API・ロジックを幻覚。CI/CDでは検出不可。5層ゲートで対策。フレームワーク付き。',
      ...
      sections: {
        ...
        hallucinations: {
          ...
          content: [
            '**コードハルシネーションは構文エラーだけではありません。表面的なチェックを通過することが多い論理的、構造的、依存関係レベルの偽造も含まれます。** 効果的なゲートを設計するには、各カテゴリを理解する必要があります。プロンプトレベルでの削減技術については、[AIハルシネーション：止める方法](/ja/prompt-engineering/ai-hallucinations-why-ai-makes-things-up)を参照してください。',
            '設計時に考慮すべき主なカテゴリ：',
          ],
          items: [
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[AIハルシネーション：止める方法](/ja/prompt-engineering/ai-hallucinations-why-ai-makes-things-up) — AI生成出力のハルシネーションを減らす技術',
    ...
    zh: {
      ...
      next_refresh_due: '2026-09-24',
      theme: '基础知识',
      heroImage: '/images/build-quality-checks-overview-hero-zh.webp',
      title: '面向AI的构建质量检查：检测幻觉与伪造依赖项',
      seoTitle: 'AI代码质量检查：在CI/CD中检测幻觉与虚假依赖',
      metaDescription: '为CI/CD管道添加AI感知质量门：依赖存在性验证、API真实性检查、Slopsquatting检测和多模型交叉审查。分步框架指南。2026年4月版。',
      ogTitle: 'AI生成代码以3种方式破坏CI/CD——以及修复方法',
      ogDescription: 'AI生成的代码编译通过，却发明了不存在的包和从未构建的API。传统lint和测试完全无法发现。以下是如何构建在合并前拦截这些问题的质量门。',
      twitterTitle: '您的CI/CD无法捕获AI幻觉。应该添加这些检查',
      twitterDescription: 'AI代码幻觉：虚假包、虚假API、隐蔽逻辑错误。你的CI/CD抓不到。5层质量门框架+检查清单。',
      ...
      sections: {
        ...
        hallucinations: {
          ...
          title: '门控必须捕获哪些幻觉类型？',
          content: [
            '**代码幻觉不仅仅是语法错误，还包括经常能通过表面检查的逻辑、结构和依赖项级别的伪造。** 设计有效的门控需要理解每个类别。有关在提示层面减少幻觉的技术，请参阅[AI幻觉：如何阻止它们](/zh/prompt-engineering/ai-hallucinations-why-ai-makes-things-up)。',
            '设计时需考虑的常见类别：',
          ],
          items: [
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[AI幻觉：如何阻止它们](/zh/prompt-engineering/ai-hallucinations-why-ai-makes-things-up) — 减少AI生成输出中幻觉的技术',
    ...
    ko: {
      ...
      next_refresh_due: '2026-09-24',
      theme: 'Fundamentals',
      heroImage: '/images/build-quality-checks-overview-hero-ko.webp',
      title: 'AI 코드 품질 검사: CI/CD에서 환각 감지하기',
      seoTitle: 'AI 코드 품질 검사: CI/CD에서 환각 잡기',
      metaDescription: 'CI/CD 파이프라인에 AI 인식 품질 게이트 추가하기: 의존성 존재 확인, API 현실 검증, slopsquatting 감지, 다중 모델 교차 검토. 단계별 프레임워크.',
      ogTitle: 'AI 생성 코드가 CI/CD를 망가뜨리는 3가지 방법 — 해결책',
      ogDescription: 'AI 생성 코드는 컴파일은 잘 되지만 존재하지 않는 패키지를 만들어내고 구축된 적 없는 API를 호출합니다. 전통적인 린트와 테스트는 이를 전혀 감지하지 못합니다. 이를 잡아내는 게이트 구축 방법을 알아보십시오.',
      twitterTitle: 'CI/CD는 AI 환각을 잡지 못합니다. 추가해야 할 것들',
      twitterDescription: 'AI 코드는 패키지, API, 로직에서 환각을 일으킵니다. CI/CD는 이를 잡지 못합니다. 이 5개 게이트를 추가하십시오. 프레임워크 + 체크리스트 포함.',
      intro: '**AI 생성 코드는 대규모에서 전통적인 품질 게이트를 통과하지 못합니다: 연구와 업계 보고서는 AI가 작성한 프로그램이 인간이 검토한 코드보다 훨씬 높은 비율로 악용 가능한 취약점을 포함한다는 것을 지속적으로 발견하며, AI가 제안한 패키지나 API의 상당 부분은 단순히 존재하지 않습니다.** 이러한 환각이 프로덕션에 들어가지 않도록 하려면, 빌드 품질 검사가 일반적인 "테스트 + 커버리지" 게이트에서 비현실적인 API, 가짜 의존성, 자신 있지만 틀린 로직을 병합 전에 감지하는 AI 인식 파이프라인으로 발전해야 합니다.',
      publishDate: '2026-03-24',
      dateModified: '2026-04-29',
      readTime: '10분 분량',
      educationalLevel: 'Intermediate',
      audience: 'AI 코딩 어시스턴트를 프로덕션 CI/CD 파이프라인에 통합하는 개발팀 리더와 DevOps 엔지니어',
      primaryTerm: 'AI 코드 품질 검사',
      aboutTopics: ['CI/CD 보안', 'AI 코드 환각', '의존성 검증'],
      toc: [
        { label: '핵심 요점', anchor: '#key-takeaways' },
        { label: 'AI가 코드를 작성할 때 무엇이 바뀌는가?', anchor: '#what-changes' },
        { label: '게이트가 잡아야 하는 환각 유형은 무엇인가?', anchor: '#hallucination-types' },
        { label: 'AI 인식 CI/CD 아키텍처는 어떻게 생겼는가?', anchor: '#architecture' },
        { label: '어떤 구체적인 검사를 추가해야 하는가?', anchor: '#concrete-checks' },
        { label: '파이프라인에서 환각을 어떻게 처리하는가?', anchor: '#hallucination-handling' },
        { label: 'AI 품질 검사를 개발자 친화적으로 만드는 방법은?', anchor: '#developer-friendly' },
        { label: '예시: AI 코드용 클래식 게이트 확장하기', anchor: '#example' },
        { label: '단계별: AI 인식 품질 검사 설정 방법', anchor: '#how-to-start' },
        { label: '피해야 할 흔한 실수들', anchor: '#common-mistakes' },
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        headline: 'AI 코드 품질 검사: CI/CD에서 환각 감지하기',
        description: 'AI 생성 코드를 위한 CI/CD 품질 게이트를 설계하십시오. 환각 감지, 의존성 검증, 보안 게이트, 개발자 친화적 실천을 포함합니다.',
        datePublished: '2026-03-24',
        dateModified: '2026-04-29',
        author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
        url: 'https://www.promptquorum.com/ko/prompt-engineering/build-quality-checks',
        inLanguage: 'ko',
        keywords: ['품질 게이트', 'CI/CD', 'AI 환각', '코드 리뷰', '보안 스캔', '의존성 검증', '빌드 검사'],
        proficiencyLevel: 'Intermediate',
        audience: { '@type': 'Audience', audienceType: 'AI 코딩 어시스턴트를 통합하는 개발팀 리더와 DevOps 엔지니어' },
        about: [
          { '@type': 'Thing', name: 'AI 코드 품질' },
          { '@type': 'Thing', name: 'CI/CD 파이프라인' },
          { '@type': 'Thing', name: '환각 감지' },
        ],
        speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
        mentions: [
          { '@type': 'SoftwareApplication', name: 'SAST' },
      ...
      howToSchema: {
        '@context': 'https://schema.org',
        '@type': 'HowTo',
        name: 'AI 인식 품질 게이트 구축 방법',
        inLanguage: 'ko',
        step: [
          { '@type': 'HowToStep', name: '의존성 검증 단계 추가', text: '가져온 모든 패키지가 패키지 관리자에 실제로 존재하는지 확인하십시오. 모든 import 또는 require 구문이 npm, pip, PyPI 또는 내부 레지스트리의 실제 패키지로 해석되는지 확인하십시오.' },
          { '@type': 'HowToStep', name: '환각 패턴 스캔', text: '각 API 호출을 실제 SDK 또는 서비스 문서와 대조하는 커스텀 린터 또는 스크립트를 실행하십시오. 코드베이스 또는 SDK 버전에 없는 메서드 호출이나 엔드포인트를 표시하십시오.' },
          { '@type': 'HowToStep', name: '보안 중심 게이트 추가', text: '수정된 파일에 Bandit(Python), ESLint-Security(JavaScript) 또는 Snyk와 같은 SAST 도구를 실행하십시오. SQL 인젝션 패턴, 과도하게 넓은 CORS 규칙, 하드코딩된 자격 증명, 안전하지 않은 역직렬화를 스캔하십시오.' },
          { '@type': 'HowToStep', name: '중요 경로에 다중 모델 검증 사용', text: '인증, 결제 또는 인프라를 다루는 코드의 경우 여러 AI 모델을 통해 코드를 실행하면서 의도된 로직과 일치하는지, 보안 위험이 있는지 질문하십시오.' },
          { '@type': 'HowToStep', name: '로직 중심 사람 검토 요구', text: '자동화된 게이트는 명백한 환각을 감지합니다. 코드 검토자는 다음을 확인해야 합니다: 이것이 의도된 대로 동작합니까? 엣지 케이스가 처리됩니까? 사용 사례에 적합한 접근 방식입니까?' },
        ],
      },
      sections: {
        tldr: {
          ...
          isTldr: true,
          items: [
            'AI 생성 코드는 전통적인 품질 게이트가 감지하도록 설계되지 않은 새로운 실패 패턴을 도입합니다 — 환각된 API, 조작된 의존성, 요구사항을 깨는 로직.',
            '환각을 구조적 위험으로 취급하십시오: AI가 코드를 작성하거나 리팩터링하도록 허용되는 곳 어디서나 발생한다고 가정하고, 이를 감지하기 위한 테스트와 정책을 설계하십시오.',
            'AI 인식 게이트 아키텍처는 pre-commit 게이트, PR 레벨 정책, CI에서의 심층 분석, 보안 및 의존성 게이트, 런타임 피드백의 레이어를 적용합니다.',
            'AI 전용 구체적인 검사에는 의존성 존재 확인, API 현실 검사, 새 코드에 대한 높은 커버리지 임계값, AI가 수정한 파일에 대한 더 엄격한 보안 게이트가 포함됩니다.',
            '개발자 친화적인 게이트는 실패를 명확하게 설명하고, 경고와 강력한 차단을 구분하며, 문서화된 예외를 허용하고, 시끄러운 거짓 양성을 최소화하도록 조정됩니다.',
          ],
        },
        definition: {
          id: 'what-changes',
          title: 'AI가 코드를 작성할 때 무엇이 바뀌는가?',
          content: [
        ...
        hallucinations: {
          ...
          snippets: [
            { type: 'in-one-sentence', text: '코드 환각은 AI 생성 출력 — 패키지 이름, API 메서드, 구성 플래그 또는 알고리즘 — 으로 실제 환경에서 존재하거나 작동하는 것이 아무것도 없는 것입니다.' },
            { type: 'in-plain-terms', text: 'AI가 자신 있게 존재하지 않는 거리에 대한 길안내를 제공하는 것으로 생각하십시오. 안내는 그럴듯해 보이지만 따라가도 아무 곳도 가지 않습니다 — 또는 위험한 곳으로 갑니다.' },
          ],
        },
        hallucinationsConclusion: {
          content: [
        ...
        architecture: {
          id: 'architecture',
          title: 'AI 인식 CI/CD 아키텍처는 어떻게 생겼는가?',
          content: [
        ...
        concreteChecks: {
          id: 'concrete-checks',
          title: 'AI 생성 코드에 어떤 구체적인 검사를 추가해야 하는가?',
          content: [
        ...
        developerFriendly: {
          id: 'developer-friendly',
          title: 'AI 품질 검사를 개발자 친화적으로 만드는 방법은?',
          content: [
        ...
        example: {
          id: 'example',
          title: '예시: AI 생성 코드용 클래식 게이트 확장하기',
          content: [
        ...
        exampleConclusion: {
          content: ['이 접근 방식은 AI 특정 위험을 직접 다루면서 프로세스의 완전한 재구축을 피합니다.'],
        },
        howToStart: {
          id: 'how-to-start',
          title: '단계별: AI 인식 품질 검사 설정 방법',
          numberedItems: [
            '**의존성 검증 단계 추가: 가져온 모든 패키지가 패키지 관리자에 존재하는지 확인하십시오.** 테스트 실행 전에 `import` 또는 `require` 구문에 언급된 모든 패키지가 npm, pip, PyPI 또는 내부 레지스트리에 존재하는지 확인하십시오. AI 환각은 종종 그럴듯하게 들리는 패키지 이름을 만들어냅니다.',
            '**일반적인 환각 패턴 스캔: 존재하지 않는 API, 잘못된 서명이 있는 함수, 조작된 구성 플래그.** 각 API 호출이 실제 SDK 또는 서비스 문서와 일치하는지 확인하는 커스텀 린터 또는 스크립트를 실행하십시오.',
            '**보안 중심 게이트 추가: SAST와 AI 생성 코드의 일반적인 취약점에 대한 명시적인 검사.** Bandit(Python), ESLint-Security(JavaScript) 또는 Snyk와 같은 도구를 사용하십시오. 또한 스캔하십시오: SQL 인젝션 패턴, 과도하게 넓은 CORS 규칙, 하드코딩된 자격 증명, 안전하지 않은 역직렬화.',
            '**중요 경로(인증, 결제, 인프라)에 다중 모델 코드 검증 사용.** 병합 전에 여러 AI 모델을 통해 코드를 실행하면서 "이 코드가 의도된 로직과 일치합니까? 보안 위험이 있습니까?"라고 질문하십시오. 불일치를 표시하십시오.',
            '**구문이 아닌 로직 중심 사람 코드 검토 요구.** 자동화된 게이트는 명백한 환각을 감지합니다. 코드 검토자는 다음을 확인해야 합니다: 이것이 의도된 대로 동작합니까? 엣지 케이스가 처리됩니까? 사용 사례에 적합한 접근 방식입니까?',
          ],
        },
        commonMistakes: {
          id: 'common-mistakes',
          title: '피해야 할 흔한 실수들',
          mistakes: [
            { mistake: 'AI 생성 코드를 품질 위험 면에서 인간이 작성한 코드와 동등하게 취급하기', problem: '표준 lint 및 단위 테스트 임계값은 인간이 작성하고 검토한 코드에 맞게 보정되어 있습니다. AI 생성 코드는 환각된 API, 조작된 패키지, 조용히 잘못된 로직을 포함하면서 모든 전통적인 게이트를 통과할 수 있습니다.', fix: 'AI가 생성하거나 수정한 코드에 별도의 위험 등급을 적용하십시오. 더 엄격한 커버리지 임계값(새 줄에 ≥80%), AI가 수정한 모든 파일에 보안 스캔 요구, 의존성 존재 검사 추가.' },
            { mistake: '컴파일을 정확성의 증거로 신뢰하기', problem: 'AI 생성 코드는 존재하지 않는 메서드를 호출하고, 등록되지 않은 패키지를 가져오거나, 요구사항을 위반하는 로직을 구현할 때도 올바르게 컴파일됩니다.', fix: '런타임 검증을 추가하십시오: 속성 기반 테스트, 엣지 케이스 테스트, 로직이 미묘하게 잘못된 경우 실패하는 통합 테스트.' },
            { mistake: '제안된 패키지가 레지스트리에 실제로 존재하는지 확인하지 않기', problem: '언어 모델은 올바른 이름을 모를 때 종종 그럴듯한 패키지 이름을 만들어냅니다. 환각된 이름으로 npm install 또는 pip install을 실행하는 개발자는 공격자가 나중에 등록한 악성 패키지를 설치할 수 있습니다(slopsquatting).', fix: '각 새 패키지 가져오기에 대해 npm/PyPI/Maven 레지스트리 API를 호출하는 의존성 검증 단계를 실행하십시오. 패키지를 해결할 수 없거나 게시 이력이 없으면 빌드를 실패시키십시오.' },
            { mistake: '데이터 없이 차단 모드로 새 게이트 시작하기', problem: '강력한 차단으로 도입된 새 게이트는 거짓 양성을 만나 마찰을 일으키고 개발자 신뢰를 침식합니다.', fix: '적어도 한 스프린트 동안 경고 모드로 각 새 게이트를 실행하십시오. 신호 대 잡음 비율을 측정하고 게이트가 입증 가능하게 신뢰할 수 있을 때만 차단으로 승격하십시오.' },
            { mistake: 'AI 전용 대시보드와 메트릭 생략하기', problem: '환각 관련 문제가 얼마나 감지되었는지에 대한 가시성 없이는 팀이 AI 인식 게이트의 오버헤드를 정당화하거나 효과적으로 조정할 수 없습니다.', fix: 'CI를 계측하여 카테고리별 문제에 태그를 붙이십시오. 카테고리별 감지된 문제에 대한 주간 요약을 노출하십시오.' },
          ],
        },
        regionalContext: {
          id: 'regional-context',
          title: 'AI 코드 품질에 대한 지역별 고려사항',
          content: [
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'CI/CD 파이프라인에서 환각된 패키지 이름을 어떻게 감지합니까?', a: '테스트 실행 전에 가져온 각 패키지가 대상 레지스트리에 실제로 존재하는지 확인하는 의존성 검증 단계를 추가하십시오. 해결할 수 없거나 게시 이력이 없는 패키지는 즉시 빌드를 실패시켜야 합니다.' },
            { q: 'AI 생성 코드에 어떤 보안 검사를 추가해야 합니까?', a: '수정된 모든 파일에 Bandit(Python), ESLint-Security(JavaScript) 또는 Snyk와 같은 SAST 도구를 실행하십시오. AI가 수정한 코드 경로에서 새로운 높음 또는 심각한 발견이 없을 것을 요구하십시오.' },
            { q: '환각된 API는 런타임 오류와 같습니까?', a: '환각된 API는 단순한 런타임 오류보다 더 미묘합니다. 실제 SDK 또는 서비스에 존재하지 않는 메서드, 매개변수 또는 구성 옵션을 모델이 만들어내는 것을 말합니다.' },
            { q: 'AI 도구를 사용하여 AI 생성 코드를 검토할 수 있습니까?', a: '예. 다중 모델 교차 검증은 효과적인 패턴입니다: 한 모델이 코드를 생성하고 다른 모델이 검토합니다. 인증, 결제 처리 또는 인프라 구성과 같은 중요 위험 경로에서 가장 잘 작동합니다.' },
            { q: '팀을 느리게 하지 않고 AI 인식 품질 검사를 어떻게 도입합니까?', a: '병합을 차단하기 전에 데이터를 수집하기 위해 모든 새 규칙을 경고 모드로 시작하십시오. 팀이 감사 추적을 남기면서 비정상적이지만 유효한 경우에 계속 진행할 수 있도록 문서화된 예외를 허용하십시오.' },
            { q: 'slopsquatting이란 무엇이며 왜 위험합니까?', a: 'slopsquatting은 AI 모델이 그럴듯하게 들리지만 실제로는 어떤 레지스트리에도 존재하지 않는 패키지 이름을 만들어낼 때 발생합니다. 공격자가 나중에 악성 코드로 해당 이름을 등록하면, 이를 설치하는 모든 개발자는 공격자의 페이로드를 실행하게 됩니다.' },
          ],
        },
        relatedReading: {
          id: 'related-reading',
          ...
          items: [
            ...
            '[AI 코드 리뷰: 도구와 검증](/ko/prompt-engineering/ai-code-review) — AI를 사용하여 코드 품질과 보안 검토하기',
            '[프롬프트 엔지니어링이란 무엇입니까?](/ko/prompt-engineering/what-is-prompt-engineering) — 신뢰할 수 있는 AI 출력을 위한 기본 원칙',
            '[프롬프트 인젝션과 보안](/ko/prompt-engineering/prompt-injection-and-security) — AI 지원 개발 파이프라인에 영향을 미치는 공격 패턴',
            '[AI 환각: 멈추는 방법](/ko/prompt-engineering/ai-hallucinations-why-ai-makes-things-up) — AI 생성 출력의 환각을 줄이는 기술',
            '[프롬프트 품질 평가 방법](/ko/prompt-engineering/how-to-evaluate-prompt-quality) — 코드 생성 품질에 적용 가능한 평가 프레임워크',
          ],
        },
        sources: {
          id: 'sources',
          title: '출처',
          items: [
            '[LLM 애플리케이션을 위한 OWASP Top 10](https://owasp.org/www-project-top-10-for-large-language-model-applications/) — OWASP, 2025. LLM 생성 코드 및 AI 지원 개발에 특정한 보안 위험.',
            '[GitHub CodeQL 문서](https://codeql.github.com/docs/) — GitHub. AI 수정 코드 경로의 보안 스캔에 사용되는 정적 분석 엔진.',
            '[Snyk 오픈 소스 보안 현황 보고서](https://snyk.io/reports/state-of-open-source-security/) — Snyk, 2024–2025. 의존성 취약점과 공급망 위험에 대한 연간 보고서.',
            '[NIST AI 위험 관리 프레임워크(AI RMF 1.0)](https://airc.nist.gov/Home) — NIST, 2023. 코드 품질과 거버넌스를 포함한 AI 시스템 위험 관리 프레임워크.',
          ],
        },
      },
    },
