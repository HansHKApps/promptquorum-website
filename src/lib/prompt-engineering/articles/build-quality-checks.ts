      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[هلوسة الذكاء الاصطناعي: كيفية إيقافها](/ar/prompt-engineering/ai-hallucinations-how-to-stop) — تقنيات لتقليل الهلوسة في مخرجات الذكاء الاصطناعي المولَّدة',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[AI 환각: 멈추는 방법](/ko/prompt-engineering/ai-hallucinations-how-to-stop) — AI 생성 출력의 환각을 줄이는 기술',
