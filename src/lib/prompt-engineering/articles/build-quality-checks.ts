...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ja: {
      ...
      metaDescription: 'CI/CDパイプラインにAI対応品質ゲートを追加：依存関係の存在確認、APIリアリティチェック、スロップスクワッティング検出、マルチモデルクロスレビュー。ステップバイステップガイド。',
    ...
    zh: {
      ...
      metaDescription: '为CI/CD管道添加AI感知质量门：依赖存在性验证、API真实性检查、Slopsquatting检测和多模型交叉审查。分步框架指南。',
