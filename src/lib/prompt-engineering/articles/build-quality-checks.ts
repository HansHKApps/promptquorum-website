...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      metaDescription: 'Add AI-aware quality gates to your CI/CD pipeline: dependency existence checks, API reality validation, slopsquatting detection, and multi-model cross-review. Step-by-step framework.',
    ...
    fr: {
      ...
      metaDescription: 'Ajoutez des contrôles qualité IA à votre pipeline CI/CD : validation des dépendances, vérification des API, détection du slopsquatting et revue multi-modèle. Guide pas-à-pas.',
