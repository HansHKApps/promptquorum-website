    ...
    ko: {
      ...
      sections: {
        ...
        hallucinations: {
          ...
          snippetBlocks: [
            { type: 'one-sentence', text: '코드 환각은 AI 생성 출력 — 패키지 이름, API 메서드, 구성 플래그 또는 알고리즘 — 으로 실제 환경에서 존재하거나 작동하는 것이 아무것도 없는 것입니다.' },
            { type: 'plain-terms', text: 'AI가 자신 있게 존재하지 않는 거리에 대한 길안내를 제공하는 것으로 생각하십시오. 안내는 그럴듯해 보이지만 따라가도 아무 곳도 가지 않습니다 — 또는 위험한 곳으로 갑니다.' },
          ],
        },
        hallucinationsConclusion: {
          content: [
