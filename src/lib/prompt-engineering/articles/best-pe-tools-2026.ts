...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      lastFactChecked: '2026-08-27 — all pricing and features re-verified against official documentation; no material changes since the July refresh',
      readTime: '9 min read',
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'What is the typical cost of these tools?', acceptedAnswer: { '@type': 'Answer', text: 'As of August 2026: Braintrust has a permanent free tier (1M traces, 10k scores, unlimited users) and Pro at $249/month; Vellum has a free tier and Pro from $50/mo; Promptfoo is entirely free (open-source self-hosted); PromptHub is free and $20/user/month (Team); LangSmith Developer is $0/seat (5k traces/month) and Plus is $39/seat/month; Confident AI is free (5 test runs/week) and $200/month (Starter, unlimited seats). Costs scale with eval volume, API calls, and seat counts.' } },
      ...
      sections: {
        ...
        vellum: {
          ...
          content: '**Vellum has expanded beyond production deployment into a full LLM development platform.** Core: A/B testing, canary rollouts, fallback chains (GPT-5.6 → Claude 4.8 Opus → Gemini), and a monitoring dashboard for latency and cost. Additions: drag-and-drop visual workflow builder, Python SDK for code-defined pipelines, document retrieval and RAG integration, LLM Leaderboard for model benchmarking, and AWS Marketplace listing for enterprise procurement. As of August 2026, Vellum\'s public homepage has repositioned around a separate consumer product, a personal AI assistant called "Vellum: Your Personal Intelligence" — verify the LLMOps/prompt-engineering plan is still active on your account before signing up.',
          items: [
        ...
        comparison: {
          ...
          content: '**As of August 2026, here is the full feature breakdown across all seven tools:**',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'What is the typical cost of these tools?', a: 'As of August 2026: Braintrust has a free tier (1M traces, 10k scores, unlimited users) and Pro at $249/month; Vellum has a free tier and Pro from $50/mo; Promptfoo is entirely free (open-source); PromptHub is free and $20/user/month (Team); LangSmith Developer is $0/seat (5k traces/month) and Plus is $39/seat/month; Confident AI is free (limited) and $200/month (Starter, unlimited seats). Costs scale with eval volume, API calls, and seat counts.' },
  ...
  publishDate: '2026-04-10',
  dateModified: '2026-08-27',
  lastFactChecked: '2026-08-27 — alle Preise und Features erneut gegen offizielle Dokumentation geprüft; keine materiellen Änderungen seit dem Juli-Refresh',
  ...
  faqSchema: {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'Was kosten diese Tools zusammen?', acceptedAnswer: { '@type': 'Answer', text: 'Stand August 2026: Braintrust hat ein kostenloses Tier (1 Mio. Traces, 10.000 Scores, unbegrenzte Nutzer) und Pro bei 249 $/Monat; Vellum hat ein kostenloses Tier und Pro ab 50 $/Monat; Promptfoo ist vollständig kostenlos (Open-Source); PromptHub ist kostenlos und 20 $/Nutzer/Monat (Team); LangSmith Developer ist 0 $/Seat (5.000 Traces/Monat) und Plus ist 39 $/Seat/Monat; Confident AI ist kostenlos (5 Test-Runs/Woche) und 200 $/Monat (Starter, unbegrenzte Nutzer).' } },
  ...
  publishDate: '2026-04-10',
  dateModified: '2026-08-27',
  lastFactChecked: '2026-08-27 — todos los precios y características reverificados contra documentación oficial; sin cambios materiales desde la revisión de julio',
  ...
  faqSchema: {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: '¿Cuál es el coste típico de estas herramientas?', acceptedAnswer: { '@type': 'Answer', text: 'A agosto de 2026: Braintrust tiene un tier gratuito permanente (1M trazas, 10k puntuaciones, usuarios ilimitados) y Pro a $249/mes; Vellum tiene tier gratuito y Pro desde $50/mes; Promptfoo es totalmente gratuito (open-source self-hosted); PromptHub es gratuito y $20/usuario/mes (Team); LangSmith Developer es $0/seat (5k trazas/mes) y Plus a $39/seat/mes; Confident AI es gratuito (5 test runs/semana) y $200/mes (Starter, sin límite de asientos). Los costes escalan con el volumen de eval, las llamadas a API y el número de seats.' } },
  ...
  publishDate: '2026-04-10',
  dateModified: '2026-08-27',
  lastFactChecked: '2026-08-27 — تمت إعادة التحقق من جميع الأسعار والميزات مقابل الوثائق الرسمية؛ لا تغييرات جوهرية منذ مراجعة يوليو',
  ...
  sections: {
    ...
    faq: {
      ...
      faqs: [
        ...
        { q: 'ما التكلفة النموذجية لهذه الأدوات؟', a: 'اعتبارًا من أغسطس 2026: Braintrust لديه طبقة مجانية (مليون تتبع، 10 آلاف درجة، مستخدمون غير محدودون) وPro بـ 249 دولارًا/شهر؛ Vellum لديه طبقة مجانية وPro من 50 دولارًا/شهر؛ Promptfoo مجاني تمامًا (مفتوح المصدر)؛ PromptHub مجاني و20 دولارًا/مستخدم/شهر (Team)؛ LangSmith Developer بـ 0 دولار/مقعد (5 آلاف تتبع/شهر) وPlus بـ 39 دولارًا/مقعد/شهر؛ Confident AI مجاني (محدود) و200 دولار/شهر (Starter، بلا حد للمقاعد). التكاليف تتوسع مع حجم التقييم واستدعاءات API وعدد المقاعد.' },
  ...
  publishDate: '2026-04-10',
  dateModified: '2026-08-27',
  lastFactChecked: '2026-08-27 — todos os preços e recursos reverificados contra documentação oficial; nenhuma mudança material desde a revisão de julho',
  ...
  sections: {
    ...
    faq: {
      ...
      faqs: [
            ...
            { q: 'Qual é o custo típico dessas ferramentas?', a: 'Em agosto de 2026: Braintrust tem um tier gratuito (1M traces, 10k pontuações, usuários ilimitados) e Pro a $249/mês; Vellum tem tier gratuito e Pro a partir de $50/mês; Promptfoo é totalmente gratuito (open-source); PromptHub é gratuito e $20/usuário/mês (Team); LangSmith Developer é $0/seat (5k traces/mês) e Plus a $39/seat/mês; Confident AI é gratuito (limitado) e $200/mês (Starter, assentos ilimitados). Os custos escalam com o volume de avaliação, as chamadas de API e o número de seats.' },
  ...
  publishDate: '2026-04-10',
  dateModified: '2026-08-27',
  lastFactChecked: '2026-08-27 — tous les tarifs et fonctionnalités re-vérifiés contre la documentation officielle ; aucun changement matériel depuis la révision de juillet',
...
'**Confident AI :** Évaluation automatisée avec 50+ métriques intégrées et red teaming — 200 $/mois Starter (sièges illimités)', '**Vellum :** Déploiement en production avec monitoring et tests A/B — gratuit / à partir de 50 $/mois', '**Promptfoo :** Tests open-source gratuits pour les pipelines CI/CD', '**PromptHub :** Versioning style Git avec collaboration en équipe — Gratuit / 20 $/utilisateur/mois', '**LangSmith :** Observabilité et tracing pour LangChain — gratuit avec options premium', '**Stratégie :** Commencez avec PromptQuorum + Promptfoo (gratuits), ajoutez le versioning tôt, l\'évaluation seulement si nécessaire'] },
  ...
  publishDate: '2026-04-10',
  dateModified: '2026-08-27',
  lastFactChecked: '2026-08-27 — すべての価格と機能を公式ドキュメントに対して再検証済み。7月のリフレッシュ以降、重要な変更なし',
  readTime: '9分で読める',
  educationalLevel: 'Intermediate',
  ...
  sections: {
    ...
    vellum: {
      ...
      content: '**Vellumは本番環境へのデプロイを超え、フルLLM開発プラットフォームへと拡張しました。** コア機能：A/Bテスト、カナリアロールアウト、フォールバックチェーン、レイテンシ・コストのモニタリングダッシュボード。新機能：ドラッグ＆ドロップのビジュアルワークフロービルダー、コード定義パイプライン用のPython SDK、RAGドキュメント検索統合、モデルベンチマーク用LLMリーダーボード、エンタープライズ調達用AWSマーケットプレイス掲載。2026年8月時点、Vellumの公開ホームページは別のコンシューマー向け製品「Vellum: Your Personal Intelligence」（パーソナルAIアシスタント）を前面に打ち出しています。登録前に、LLMOps/プロンプトエンジニアリングプランがアカウントで引き続き有効か確認してください。',
      items: [
    ...
    faq: {
      ...
      faqs: [
        ...
        { q: 'これらのツールの典型的なコストは何ですか？', a: '2026年8月時点：Braintrust無料（100万トレース、1万スコア）/ Pro $249/月、Vellum無料プランあり / Pro $50/月〜、Promptfoo無料（オープンソース自ホスト）、PromptHub無料（公開プロンプト）/ Team $20/ユーザー/月、LangSmith Developer 0ドル / Plus $39/シート/月、Confident AI無料（週5回テスト）/ Starter $200/月（シート数無制限）。' },
        ...
        { q: '日本の企業がこれらのツールを使うときにMETI AI Governanceに準拠する必要がありますか？', a: 'はい。2024年のMETI AIガバナンス関連ガイドラインは、企業がPrompt Engineeringツールを本番環境で使用する場合、透明性とアカウンタビリティ要件を含みます。BraintrustとPromptfooの両方は監査ログとトレーシング機能を提供し、コンプライアンス要件をサポートします。Vellumのモニタリングダッシュボードは本番環境の可視性も提供し、政府関連のガバナンス基準に合わせて使用できます。' },
        { q: '日本の開発チームは、これらのツールのどれをデータレジデンシーセキュリティに推奨しますか？', a: '日本の開発チームの場合、データレジデンシーは主な懸念事項です。Promptfooはオープンソースでセルフホストできるため、機密データを国内のインフラで保持できます。VellumとBraintrustはクラウドホストですが、データ処理契約（DPA）オプションを提供し、GCP/AWS Japan Regionなどの日本リージョンでのデータ保存をサポートしています。LangChainアプリケーションの場合、LangSmithは日本のデータセンターオプションも提供しており、企業レベルの監査要件を満たします。' }
      ]
    },
    sources: {
      id: 'sources',
  ...
  metaDescription: '7款提示词工程工具2026年对比。Promptfoo专注自动化测试（免费），Braintrust专注评估（每月249美元），Confident AI专注自动化评估（每月200美元），Vellum专注生产环境部署（每月50美元起），PromptHub专注版本管理，LangSmith专注追踪。',
  ogTitle: '7款提示词工程工具对比——哪个能解决你的瓶颈？',
  ogDescription: '评估、测试、版本管理、生产部署、多模型分发。每项任务一个工具。内含对比表。',
  twitterTitle: '2026年最佳提示词工程工具：全面对比',
  twitterDescription: 'Promptfoo免费开源。Braintrust起价249美元/月。PromptQuorum可同时向25+模型分发。哪个技术栈适合你？',
  ...
  publishDate: '2026-04-10',
  dateModified: '2026-08-27',
  lastFactChecked: '2026-08-27 — 所有价格和功能已对照官方文档重新验证；自7月刷新以来无重大变化',
  readTime: '阅读约9分钟',
  educationalLevel: 'Intermediate',
  primaryTerm: '提示词工程工具',
  ...
  faqSchema: {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: '这些工具的典型成本是多少？', acceptedAnswer: { '@type': 'Answer', text: '截至2026年8月：Braintrust免费层（100万次追踪、1万次评分），Pro $249/月；Vellum提供免费层，Pro从$50/月起；Promptfoo免费（开源自托管）；PromptHub免费（公开），Team $20/用户/月；LangSmith Developer免费，Plus $39/席位/月；Confident AI免费（每周5次测试），Starter $200/月（席位不限）。成本按评估量、API调用和座位数缩放。' } },
  ...
  sections: {
    ...
    vellum: {
      ...
      content: '**Vellum已从单纯的生产部署工具扩展为完整的LLM开发平台。** 核心功能：A/B测试、金丝雀发布、回退链、延迟与成本监控仪表板。新增功能：可视化拖拽工作流构建器、代码定义管道的Python SDK、文档检索与RAG集成、模型基准测试的LLM排行榜，以及面向企业采购的AWS Marketplace上架。截至2026年8月，Vellum的公开主页已转向一款独立的消费级产品——个人AI助理"Vellum: Your Personal Intelligence"；注册前请确认您账户中的LLMOps/提示工程方案仍然有效。',
      items: [
        '最适合带监控的生产级部署',
        '按模型、按提示词版本的成本估算',
    ...
    faq: {
      ...
      faqs: [
        ...
        { q: '这些工具的典型成本是多少？', a: '截至2026年8月：Braintrust免费层（100万次追踪、1万次评分），Pro $249/月；Vellum提供免费层，Pro从$50/月起；Promptfoo免费（开源自托管）；PromptHub免费（公开），Team $20/用户/月；LangSmith Developer免费，Plus $39/席位/月；Confident AI免费（每周5次测试），Starter $200/月（席位不限）。成本按评估量、API调用和座位数缩放。' },
  ...
  publishDate: '2026-04-10',
  dateModified: '2026-08-27',
  lastFactChecked: '2026-08-27 — 모든 가격 및 기능을 공식 문서에 대해 재검증했습니다. 7월 갱신 이후 중요한 변경 사항 없음',
  readTime: '9분 분량',
  educationalLevel: 'Intermediate',
  ...
  sections: {
    ...
    vellum: {
      ...
      content: '**Vellum은 프로덕션 배포를 넘어 완전한 LLM 개발 플랫폼으로 확장되었습니다.** 핵심: A/B 테스팅, 카나리 롤아웃, 폴백 체인(GPT-5.6 → Claude 4.8 Opus → Gemini), 지연 시간 및 비용 모니터링 대시보드. 추가 기능: 드래그 앤 드롭 시각적 워크플로 빌더, 코드 정의 파이프라인을 위한 Python SDK, 문서 검색 및 RAG 통합, 모델 벤치마킹을 위한 LLM Leaderboard, 엔터프라이즈 조달을 위한 AWS Marketplace 등록. 2026년 8월 기준, Vellum의 공개 홈페이지는 별도의 소비자 제품인 개인 AI 어시스턴트 "Vellum: Your Personal Intelligence"를 전면에 내세우고 있습니다. 가입 전에 계정에서 LLMOps/프롬프트 엔지니어링 플랜이 여전히 활성 상태인지 확인하십시오.',
      items: [
