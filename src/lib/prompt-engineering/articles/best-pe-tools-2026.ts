...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  seoTitle: 'أفضل أدوات هندسة التعليمات 2026: 6 خيارات',
  metaDescription: 'Promptfoo مجاني. Braintrust من 249 دولارًا/شهر. Vellum من 500 دولارًا. مقارنة 6 أدوات هندسة تعليمات مُصنَّفة حسب المشكلة التي تحلها في 2026.',
