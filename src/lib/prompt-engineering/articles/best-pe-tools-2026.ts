    ...
    en: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'What is the typical cost of these tools?', acceptedAnswer: { '@type': 'Answer', text: 'Braintrust has a permanent free tier (1M traces, 10k scores, unlimited users) and Pro at $249/month; Vellum has a free tier and Pro from $50/mo; Promptfoo is entirely free (open-source self-hosted); PromptHub is free and $20/user/month (Team); LangSmith Developer is $0/seat (5k traces/month) and Plus is $39/seat/month; Confident AI is free (5 test runs/week) and $200/month (Starter, unlimited seats). Costs scale with eval volume, API calls, and seat counts.' } },
      ...
      sections: {
        ...
        vellum: {
          ...
          content: '**Vellum has expanded beyond production deployment into a full LLM development platform.** Core: A/B testing, canary rollouts, fallback chains (GPT-5.6 → Claude 4.8 Opus → Gemini), and a monitoring dashboard for latency and cost. Additions: drag-and-drop visual workflow builder, Python SDK for code-defined pipelines, document retrieval and RAG integration, LLM Leaderboard for model benchmarking, and AWS Marketplace listing for enterprise procurement. Vellum\'s public homepage has repositioned around a separate consumer product, a personal AI assistant called "Vellum: Your Personal Intelligence" — verify the LLMOps/prompt-engineering plan is still active on your account before signing up.',
          items: [
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'What is the typical cost of these tools?', a: 'Braintrust has a free tier (1M traces, 10k scores, unlimited users) and Pro at $249/month; Vellum has a free tier and Pro from $50/mo; Promptfoo is entirely free (open-source); PromptHub is free and $20/user/month (Team); LangSmith Developer is $0/seat (5k traces/month) and Plus is $39/seat/month; Confident AI is free (limited) and $200/month (Starter, unlimited seats). Costs scale with eval volume, API calls, and seat counts.' },
