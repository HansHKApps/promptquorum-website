...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  itemListSchema: {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Confident AI', description: 'Automatisierte Evaluierung mit 50+ integrierten Metriken und Red-Teaming — kostenlos / 200 $/Monat' },
      { '@type': 'ListItem', position: 4, name: 'Vellum', description: 'Production-Deployment mit Monitoring und A/B-Tests — kostenlos / 50 $/Monat' },
...
'**Confident AI :** Évaluation automatisée avec 50+ métriques intégrées et red teaming — 200 $/mois Starter (sièges illimités)', '**Vellum :** Déploiement en production avec monitoring et tests A/B — gratuit / à partir de 50 $/mois', '**Promptfoo :** Tests open-source gratuits pour les pipelines CI/CD', '**PromptHub :** Versioning style Git avec collaboration en équipe — Gratuit / 20 $/utilisateur/mois', '**LangSmith :** Observabilité et tracing pour LangChain — gratuit avec options premium', '**Stratégie :** Commencez avec PromptQuorum + Promptfoo (gratuits), ajoutez le versioning tôt, l\'évaluation seulement si nécessaire'] },
  ...
  sections: {
    ...
    comparison: {
      ...
      content: '**2026年7月時点で、すべての6つのツール完全Feature内訳：**',
      ...
      imageCaption: '6つのPrompt Engineeringツール Feature比較（2026年7月）：PromptQuorumマルチモデルディスパッチ（無料）、Braintrust評価（$249/月）、Vellum本番環境（無料/$50/月〜）、Promptfooテスト（無料）、PromptHubバージョン管理（$50～300/月）、LangSmithトレーシング（無料層）。'
    },
    decision: {
      id: 'how-to-choose',
  ...
  sections: {
    ...
    comparison: {
      ...
      content: '**截至2026年7月，所有6款工具的完整功能对比：**',
      ...
      image: '/images/best-pe-tools-2026-comparison-table-en.svg',
      imageCaption: '6款提示词工程工具功能对比（2026年7月）：PromptQuorum多模型分发（免费）、Braintrust评估（$249/月起）、Confident AI评估（$200/月起）、Vellum生产部署（免费/从$50起）、Promptfoo测试（免费，已被OpenAI收购）、PromptHub版本管理（免费/$20/用户/月）、LangSmith追踪（免费层）。'
    },
    decision: {
      id: 'how-to-choose',
