...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    sections: {
      ...
      commonMistakes: {
        ...
        mistakes: [
          ...
          { mistake: 'Modellversionierung ignorieren', problem: 'Ein Fine-Tuned-Modell funktioniert großartig, dann wird GPT-4o aktualisiert. Das Fine-Tuned-Modell ist jetzt veraltet und muss neu trainiert werden.', fix: 'Budget für jährliches Retraining oder Migration zu neuen Modellen. Dokumentieren Sie, welche Basismodellversion jedes Fine-Tune ist.' },
      ...
      relatedReading: {
        ...
        id: 'related',
        items: [
          { title: 'Effektive Prompts schreiben', url: '/prompt-engineering/how-to-write-effective-prompts?lang=de' },
          { title: 'Prompt-Engineering-Frameworks', url: '/prompt-engineering/frameworks?lang=de' },
          { title: 'Kostenoptimierung für LLMs', url: '/prompt-engineering/cost-optimization?lang=de' },
          { title: 'RAG-Systeme aufbauen', url: '/prompt-engineering/retrieval-augmented-generation?lang=de' },
          { title: 'Modellauswahlhandbuch', url: '/prompt-engineering/model-selection?lang=de' },
          { title: 'LLM API Benchmarks', url: '/prompt-engineering/llm-api-benchmarks?lang=de' },
        ],
      },
      regionalContext: {
  ...
  es: {
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/prompt-engineering/prompt-engineering-vs-fine-tuning?lang=es',
      inLanguage: 'es',
      speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
    ...
    sections: {
      ...
      commonMistakes: {
        ...
        mistakes: [
          ...
          { mistake: 'Ignorar el versionado del modelo', problem: 'Un modelo con fine-tuning funciona genial, luego GPT-4o se actualiza. El modelo con fine-tuning está ahora desactualizado y debe reentrenarse.', fix: 'Presupuesta para reentrenamiento anual o migración a nuevos modelos. Documenta en qué versión del modelo base está cada fine-tune.' },
      ...
      relatedReading: {
        ...
        id: 'related',
        items: [
          { title: 'Cómo escribir prompts efectivos', url: '/prompt-engineering/how-to-write-effective-prompts?lang=es' },
          { title: 'Frameworks de prompt engineering', url: '/prompt-engineering/frameworks?lang=es' },
          { title: 'Optimización de costes para LLMs', url: '/prompt-engineering/cost-optimization?lang=es' },
          { title: 'Construir sistemas RAG', url: '/prompt-engineering/retrieval-augmented-generation?lang=es' },
          { title: 'Guía de selección de modelo', url: '/prompt-engineering/model-selection?lang=es' },
          { title: 'Benchmarks de API LLM', url: '/prompt-engineering/llm-api-benchmarks?lang=es' },
        ],
      },
      regionalContext: {
    ...
    sections: {
      ...
      commonMistakes: {
        ...
        mistakes: [
          ...
          { mistake: 'Ignorer le versioning de modèle', problem: 'Un modèle fine-tuné fonctionne bien, puis GPT-4o est mis à jour. Le modèle est maintenant obsolète et doit être réentraîné.', fix: 'Budgétez le réentraînement annuel ou la migration vers de nouveaux modèles. Documentez quelle version de base chaque fine-tune utilise.' },
      ...
      relatedReading: {
        ...
        id: 'related',
        items: [
          { title: 'Écrire des prompts efficaces', url: '/prompt-engineering/how-to-write-effective-prompts?lang=fr' },
          { title: 'Frameworks de prompt engineering', url: '/prompt-engineering/frameworks?lang=fr' },
          { title: 'Optimisation des coûts pour les LLMs', url: '/prompt-engineering/cost-optimization?lang=fr' },
          { title: 'Construire des systèmes RAG', url: '/prompt-engineering/retrieval-augmented-generation?lang=fr' },
          { title: 'Guide de sélection de modèle', url: '/prompt-engineering/model-selection?lang=fr' },
          { title: 'Benchmarks API LLM', url: '/prompt-engineering/llm-api-benchmarks?lang=fr' },
        ],
      },
      regionalContext: {
    ...
    sections: {
      ...
      quickFacts: {
        ...
        numberedItems: [
          ...
          '1Mトークンあたりのコスト (GPT-4o)：プロンプトエンジニアリング $25、ファインチューニング推論 $50-100。',
          'ファインチューニングに必要なデータ：最小100例、安定した結果には理想的には500+。',
          '結果までの時間：プロンプトエンジニアリング2時間（10回繰り返し）、ファインチューニング7日（データ収集含む）。',
          'モデル可用性：プロンプトエンジニアリングはGPT-4o、Claude、Gemini、Llamaで動作。ファインチューニングはプロバイダーごとに異なる。',
      ...
      promptEngineeringExplained: {
        ...
        items: [
          ...
          'モデル不問：GPT-4o、Claude、Gemini、ローカルモデルで動作',
        ],
      },
      fineTuningExplained: {
        title: 'ファインチューニングとは',
      ...
      commonMistakes: {
        ...
        mistakes: [
          ...
          { mistake: 'モデルバージョン管理を無視', problem: 'ファインチューニング済みモデルが機能していますが、GPT-4o が更新されます。モデルは古くなり、再訓練する必要があります。', fix: '年間再訓練または新しいモデルへの移行をバジェットします。各ファインチューニングがどのベースモデルバージョンにとって存在するかを文書化します。' },
      ...
      relatedReading: {
        ...
        id: 'related',
        items: [
          { title: '効果的なプロンプトを書く', url: '/prompt-engineering/how-to-write-effective-prompts?lang=ja' },
          { title: 'プロンプトエンジニアリングのフレームワーク', url: '/prompt-engineering/frameworks?lang=ja' },
          { title: 'LLMのコスト最適化', url: '/prompt-engineering/cost-optimization?lang=ja' },
          { title: 'RAG システムの構築', url: '/prompt-engineering/retrieval-augmented-generation?lang=ja' },
          { title: 'モデル選択ガイド', url: '/prompt-engineering/model-selection?lang=ja' },
          { title: 'LLM API ベンチマーク', url: '/prompt-engineering/llm-api-benchmarks?lang=ja' },
        ],
      },
      regionalContext: {
        title: '日本での実装ガイダンス',
  ...
  zh: {
    ...
    schema: {
      ...
      mentions: [
        { '@type': 'SoftwareApplication', name: 'OpenAI GPT-4o' },
    ...
    sections: {
      ...
      commonMistakes: {
        ...
        mistakes: [
          ...
          },
          {
            ...
            problem: '团队对GPT-4微调，OpenAI发布GPT-4 Turbo，他们的微调模型变得过时并且性能下降。',
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[单一Prompt方法框架](/prompt-engineering/single-prompt-method?lang=zh)',
          '[Prompt工程vs零样本学习](/prompt-engineering/prompt-engineering-vs-zero-shot?lang=zh)',
          '[RAG与微调：何时使用](/prompt-engineering/rag-vs-fine-tuning-explained?lang=zh)',
          '[本地LLM成本指南](/local-llms/local-llm-cost-breakdown-2026?lang=zh)',
          '[通过Prompt链接改进推理](/prompt-engineering/prompt-chaining-reasoning?lang=zh)',
        ],
      },
      regionalContext: {
        title: '中国与亚太部署指南',
