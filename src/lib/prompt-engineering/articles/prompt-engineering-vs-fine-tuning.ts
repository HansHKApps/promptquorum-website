...
export const article: Record<Language, PEArticle> = {
  ...
  fr: {
    ...
    intro: 'Le prompt engineering et le fine-tuning sont deux approches fondamentalement différentes pour améliorer les résultats. Le prompt engineering est gratuit, instantané et réversible. Le fine-tuning coûte 500-5000+ euros, prend plusieurs jours ou semaines, et est difficile à annuler.',
    publishDate: '2026-04-10',
    dateModified: '2026-05-04',
    readTime: '8 min de lecture',
    educationalLevel: 'Intermediate',
    seoTitle: 'Prompt Engineering vs Fine-Tuning : Quand prompter, quand entraîner',
    metaDescription: 'Guide de décision : prompt engineering vs fine-tuning. Comparez les coûts, le temps et la réversibilité pour choisir le bon approach.',
    next_refresh_due: '2026-11-03',
    sections: {
      keyTakeaways: {
        isTldr: true,
  ...
  ja: {
    ...
    intro: 'プロンプトエンジニアリングとファインチューニングは、AIモデル出力を改善するための根本的に異なる2つのアプローチです。プロンプトエンジニアリングは無料、即座、可逆的。ファインチューニングは$500-$5000+かかり、数日～数週間で、取り消しが困難です。',
    publishDate: '2026-04-10',
    dateModified: '2026-05-04',
    readTime: '10分で読める',
    educationalLevel: 'Intermediate',
  ...
  zh: {
    ...
    intro: 'Prompt工程和微调是改进AI模型输出的两种根本不同方法。Prompt工程免费、即时、可逆。微调成本$500-$5000+，需要数天或数周，难以撤销。此指南帮您选择正确方法。',
    publishDate: '2026-04-10',
    dateModified: '2026-05-04',
    readTime: '阅读约9分钟',
    educationalLevel: 'Intermediate',
    seoTitle: 'Prompt工程 vs 微调：何时用提示，何时训练',
    metaDescription: '决策指南：Prompt工程 vs 微调。比较成本（$0 vs $500+）、时间（分钟 vs 天）、可逆性，以及何时选择各自方案。',
    next_refresh_due: '2026-11-03',
    sections: {
      keyTakeaways: {
        isTldr: true,
