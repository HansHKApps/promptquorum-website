...
export const article: Record<Language, PEArticle> = {
  ...
  ja: {
    ...
    metaDescription: '判断ガイド：プロンプトエンジニアリング vs ファインチューニング。コスト比較（$0 vs $500+）、反復時間（分 vs 日）、可逆性を解説。判断フローチャート付き。',
  ...
  zh: {
    ...
    readTime: '阅读约10分钟',
    educationalLevel: 'Intermediate',
    seoTitle: 'Prompt工程 vs 微调 2026：何时用提示，何时训练',
    metaDescription: '决策指南：Prompt工程 vs 微调。成本对比（$0 vs $500+）、时间对比（分钟 vs 天）、可逆性、中国数据安全法合规。附决策流程图。',
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
