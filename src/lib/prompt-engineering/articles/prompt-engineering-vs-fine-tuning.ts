...
export const article: Record<Language, PEArticle> = {
  en: {
    ...
    metaDescription: 'Decision guide: prompt engineering vs fine-tuning. Compare approach cost, time, reversibility, and when each method wins.',
  ...
  de: {
    ...
    metaDescription: 'Entscheidungsleitfaden: Prompt Engineering vs Fine-Tuning. Vergleich von Kosten, Zeit und Reversibilität.',
  ...
  fr: {
    ...
    metaDescription: 'Guide de décision : prompt engineering vs fine-tuning. Comparez les coûts, le temps et la réversibilité.',
    sections: {
      keyTakeaways: {
        isTldr: true,
        title: 'Points clés',
  ...
  ja: {
    ...
    metaDescription: 'プロンプトエンジニアリング vs ファインチューニング。コスト、時間、可逆性を比較し、どのアプローチを選ぶかを判断します。',
    sections: {
      keyTakeaways: {
        isTldr: true,
        title: '重要ポイント',
  ...
  zh: {
    ...
    metaDescription: '决策指南：Prompt工程 vs 微调。比较成本、时间、可逆性，以及何时选择各自方案。',
    sections: {
      keyTakeaways: {
        isTldr: true,
        title: '核心要点',
