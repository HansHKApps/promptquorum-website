...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      readTime: '8 min read',
      seoTitle: 'Teaching With AI in 2026: 2× Learning Gains Guide',
      metaDescription: 'Harvard study: AI tutoring doubles learning gains, 18% less time. Tools: Khanmigo, MagicSchool, Claude. Structured prompts save 5–13 hours/week. EU AI Act guidance included.',
      ...
      ogDescription: '85% of US teachers used AI in 2024-25 — but vague prompts waste it. Harvard proved AI tutoring doubles learning gains. Here\'s the 5-part teacher prompt framework plus EU AI Act compliance for schools.',
      twitterDescription: 'AI tutoring: 2× learning gains, 18% less study time (Harvard RCT, n=194). Best tools + prompt framework for teachers.',
      toc: [
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'The answer depends on the task. Khanmigo (Khan Academy, powered by GPT-4) is the strongest for student tutoring via Socratic questioning at $44/year. MagicSchool leads for comprehensive teacher workflow tools (lesson plans, IEPs, parent communications). ChatGPT (GPT-5.6, OpenAI) provides the most flexible general-purpose content generation. For complex curriculum analysis, Claude Sonnet 5 (Anthropic) handles 1M tokens — approximately 800 standard pages — in a single session.',
            },
          },
          {
            '@type': 'Question',
      ...
      itemListSchema: {
        ...
        'itemListElement': [
          ...
          { '@type': 'ListItem', 'position': 3, 'name': 'ChatGPT / GPT-5.6', 'description': 'Flexible content creation and drafting. Any level, any subject. Free limited tier.' },
          { '@type': 'ListItem', 'position': 4, 'name': 'Claude Sonnet 5', 'description': 'Deep analysis, careful reasoning, writing quality, 1M context. Post-secondary and complex tasks. Free limited.' },
      ...
      sections: {
        ...
        toolComparison: {
          ...
          columns: ['Tool', 'Link', 'Best For', 'Context', 'Free Tier'],
          rows: [
            {
              Tool: 'Khanmigo (Khan Academy)',
              Link: '[khanmigo.ai](https://www.khanmigo.ai)',
            ...
            {
              Tool: 'MagicSchool',
              Link: '[magicschool.ai](https://www.magicschool.ai)',
              'Best For': 'Lesson planning; classroom management',
              Context: 'K-12 teachers',
              'Free Tier': 'Yes (limited)',
            },
            {
              Tool: 'ChatGPT / GPT-5.6 (OpenAI)',
            ...
            },
            {
              ...
              'Best For': 'Deep analysis, careful reasoning, writing quality',
          ...
          rows: [
            {
              ...
              'Recommended Tool': 'MagicSchool / GPT-5.6',
              Temperature: '0.1–0.2',
              'Time Saved': '30–60 min/lesson',
            },
            {
              'Use Case': 'Differentiated reading levels',
              'Recommended Tool': 'Claude Sonnet 5',
              Temperature: '0.1–0.2',
            ...
            },
            {
              ...
              'Recommended Tool': 'Claude Sonnet 5 (1M context)',
              Temperature: '0.2',
              'Time Saved': 'Hours per class set',
            },
            {
              'Use Case': 'Parent communication drafts',
              'Recommended Tool': 'ChatGPT / GPT-5.6',
              Temperature: '0.3–0.5',
        ...
        assessmentPrompt: {
          ...
          content: [
            ...
            'Claude Sonnet 5\'s 1M-token [context window](/prompt-engineering/context-windows-explained-why-ai-forgets) handles full class sets of essays in a single session — approximately 800 standard pages — making batch feedback generation practical for teachers with large classes. GPT-5.6 handles ~800 pages per session (1M tokens), sufficient for any classroom workload.',
          ],
        ...
        relatedReading: {
          ...
          items: [
            ...
            '[Constrained Prompting](/prompt-engineering/constrained-prompting) — essential for controlling AI output format in educational materials',
            '[Extract and Summarise](/prompt-engineering/extract-and-summarise) — techniques for AI-assisted reading comprehension and document analysis in classrooms',
            '[5 Building Blocks Every Prompt Needs](/prompt-engineering/5-building-blocks-every-prompt-needs) — the universal prompt structure that the teacher prompt framework builds on',
          ],
        },
        howToStart: {
        ...
        sources: {
          ...
          content: [
            '**All statistics and findings in this article are sourced from peer-reviewed research, official government guidance, and publicly-documented institutional policies.** Last fact-checked: 2026-05-04 (against current Claude Sonnet 5, GPT-5.6, Gemini 3.1 Pro models; current Khanmigo pricing at Khan Academy; current EU AI Act Article 4 guidance effective 2025).',
          ],
          items: [
    ...
    de: {
      freshness_tier: 'annual',
      theme: 'Use Cases',
      heroImage: '/images/teaching-with-ai-overview-hero-de.webp',
      ...
      seoTitle: 'Mit KI unterrichten 2026: Lernzuwachs verdoppeln',
      metaDescription: 'Harvard-Studie: KI-Tutoring verdoppelt Lernerfolg, 18% weniger Zeit. Tools: Khanmigo, MagicSchool, Claude. Prompts sparen 5–13 Std/Woche. EU AI Act für Schulen.',
      ...
      ogDescription: '85 % der US-Lehrkräfte nutzten KI 2024–25 — aber vage Prompts verschwenden Zeit. Harvard bewies, dass KI-Tutoring den Lernerfolg verdoppelt. Hier ist das fünfteilige Lehrkräfte-Prompt-Framework plus EU AI Act Compliance für Schulen.',
      twitterDescription: 'KI-Tutoring: 2× Lernzuwachs, 18 % weniger Lernzeit (Harvard RCT, n=194). Beste Tools und Prompt-Framework für Lehrkräfte.',
      toc: [
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Die Antwort hängt von der Aufgabe ab. Khanmigo (Khan Academy, betrieben durch GPT-4) ist am stärksten für Schülernachhilfe durch sokratisches Fragen zu 44 US-Dollar pro Jahr. MagicSchool führt bei umfassenden Lehrkräfte-Workflow-Tools (Unterrichtspläne, IEPs, Elternkommunikation). ChatGPT (GPT-5.6, OpenAI) bietet die flexibelste universelle Inhalterstellung. Für komplexe Lehrplananalysen behandelt Claude Sonnet 5 (Anthropic) 1.000.000 Token — ungefähr 800 Standardseiten — in einer einzigen Sitzung.',
            },
          },
          {
            '@type': 'Question',
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'Ja — dies ist einer der stärksten Einsatzbereiche von KI im Bildungswesen. LLMs können denselben Inhalt in Sekunden auf mehreren Lesefähigkeitsstufen umschreiben (Flesch-Kincaid Klasse 4, 8 und 12). Prompt-Struktur: „Schreiben Sie diesen Abschnitt auf Klassenstufe [N] um. Bewahren Sie alle sachlichen Inhalte. Ersetzen Sie komplexes Vokabular durch einfachere Entsprechungen. Behalten Sie die gleiche Absatzstruktur bei.\" Claude Sonnet 5 produziert die konsistenteste Differenzierung über Lesefähigkeitsstufen hinweg.',
            },
          },
          {
            '@type': 'Question',
      ...
      itemListSchema: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'ChatGPT / GPT-5.6', description: 'Flexible Inhalterstellung und Entwurf. Jede Ebene, jedes Fach. Kostenlose begrenzte Version.' },
          { '@type': 'ListItem', position: 4, name: 'Claude Sonnet 5', description: 'Langform-Lehrplandesign, 1.000.000 Token Kontext. Hochschule und komplexe Aufgaben. Kostenlose begrenzte Version.' },
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            'Im Mai 2026 unterstützen GPT-5.6, Claude Sonnet 5 (Anthropic) und Gemini 3.1 Pro alle 1 Million Token Kontextfenster (~800 Seiten pro Sitzung) — Kontextfenstergröße ist kein Schlüssel-Differenziator zwischen Frontier-Modellen',
          ],
        },
        quickFacts: {
          title: '⚡ Schnelle Fakten',
          items: [
            '**Harvard RCT Ergebnis:** KI-Nachhilfe produzierte 0,73–1,3 SD Lernzuwächse im Vergleich zu aktiven Lernklassenzimmern in 18 % weniger Zeit (n=194, p < 10⁻⁸)',
            '**Lehrkräfte-Adoption:** 85 % der US-Lehrkräfte nutzten KI im Schuljahr 2024–25',
            '**Zeit eingespart:** Strukturierte Prompts sparen Lehrkräften 5–13 Stunden/Woche bei Unterrichtsplanung und Admin',
            '**KI-Erkennungsproblem:** 15–30 % falsch-positive Rate — unzuverlässig für eigenständige akademische Integritätsentscheidungen',
            '**EU AI Act:** Bildungs-KI als hochriskant klassifiziert (Annex III). KI-Kompetenzkurs für Lehrkräfte ist Pflicht (Artikel 4, gültig ab 2025). Emotionserkennung in Schulen verboten.',
            '**Best Tools:** Khanmigo (Nachhilfe), MagicSchool (Unterrichtspläne), ChatGPT/Claude (flexible Inhalte), NotebookLM (quellengestützte Forschung)',
          ],
        },
        definition: {
        ...
        toolComparison: {
          ...
          content: [
            ...
            'MagicSchool bietet das umfassendste Lehrkräfte-Toolset — Unterrichtsplanung, Klassenverwaltungsvorlagen, Unterstützung bei der Erstellung von IEPs und Elternkommunikations-Tools. ChatGPT (GPT-5.6) bietet die flexibelste universelle Unterstützung mit der höchsten Autonomie, erfordert aber strukturierte Prompts von der Lehrkraft, um classroom-ready Outputs zu produzieren.',
          ],
          callouts: [
          ...
          columns: ['Tool', 'Link', 'Am besten für', 'Kontext', 'Kostenlose Version'],
          rows: [
            {
              Tool: 'Khanmigo (Khan Academy)',
              Link: '[khanmigo.ai](https://www.khanmigo.ai)',
        ...
        toolUseCaseMapping: {
          ...
          rows: [
            ...
            },
            {
              ...
              'Empfohlenes Tool': 'Claude Sonnet 5 (1.000.000 Token Kontext)',
              Temperatur: '0,2',
              Zeitersparnis: 'Stunden pro Klassensatz',
            },
            {
              Einsatzfall: 'Elternkommunikations-Entwürfe',
              'Empfohlenes Tool': 'ChatGPT / GPT-5.6',
              Temperatur: '0,3–0,5',
        ...
        assessmentPrompt: {
          ...
          content: [
            ...
            'Claude Sonnet 5s 1.000.000-Token [Kontextfenster](/de/prompt-engineering/context-windows-explained-why-ai-forgets) behandelt vollständige Klassensätze von Essays in einer einzelnen Sitzung — ungefähr 800 Standardseiten — was Batch-Feedback-Generierung für Lehrkräfte mit großen Klassen praktisch macht. GPT-5.6 behandelt ~800 Seiten pro Sitzung (1M Token), ausreichend für jede Klassengröße.',
          ],
        ...
        commonMistakes: {
          ...
          items: [
            ...
            '**Schüler nicht beibringen, wie sie KI-Tools effektiv einsetzen können:** Schüler, die „schreib meinen Aufsatz über Photosynthese\" tippen, lernen nichts. Schüler, die „erkläre Photosynthese auf Klassenstufe 8 Niveau, dann teste mich auf die drei Schlüsselkonzepte\" tippen, lernen aktiv. Erstellen Sie eine Klassenzimmer-Prompt-Vorlage, die Schüler für alle KI-Interaktionen verwenden müssen. Fordern Sie sie auf, ihre Lernziele anzugeben, was sie bereits wissen und in welchem Format sie die Antwort möchten. Dies macht KI von einer Abkürzung zu einem Lerntool.',
          ],
          callouts: [
    ...
    es: {
      ...
      next_refresh_due: '2027-05-04',
      theme: 'Use Cases',
      heroImage: '/images/teaching-with-ai-overview-hero-es.webp',
      ...
      howToName: 'Cómo enseñar con IA',
      ogDescription: 'El 85 % de los docentes estadounidenses usaron IA en 2024–25 — pero los prompts vagos la desperdician. Harvard demostró que la tutoría con IA duplica las ganancias de aprendizaje. Aquí está el framework de prompts de 5 partes para docentes más el cumplimiento de la Ley de IA de la UE para escuelas.',
      twitterDescription: 'Tutoría con IA: 2× más ganancias de aprendizaje, 18 % menos de tiempo de estudio (ECA de Harvard, n=194). Mejores herramientas + framework de prompts para docentes.',
      toc: [
        { label: 'Qué hacen realmente las herramientas de enseñanza con IA', anchor: '#what-ai-teaching-tools-actually-do' },
        { label: '¿Qué herramientas de IA deberían usar los docentes en 2026?', anchor: '#which-ai-tools-should-teachers-use-in-2026' },
        { label: 'Cómo escribir prompts para tareas de enseñanza', anchor: '#how-to-write-prompts-for-teaching-tasks' },
        { label: 'El prompt de docente de cinco componentes', anchor: '#the-five-component-teacher-prompt' },
        { label: '¿Cómo escribes prompts de IA para retroalimentación de evaluación?', anchor: '#how-do-you-prompt-ai-for-assessment-feedback' },
        { label: '¿La tutoría con IA mejora los resultados de aprendizaje?', anchor: '#does-ai-tutoring-improve-learning-outcomes' },
        { label: '¿Qué tan detectable es el engaño con IA en las escuelas?', anchor: '#how-detectable-is-ai-cheating-in-schools' },
        { label: '¿Cómo afecta la Ley de IA de la UE a las escuelas?', anchor: '#how-does-the-eu-ai-act-affect-schools' },
      ...
      schema: {
        ...
        about: [
          ...
          { '@type': 'SoftwareApplication', name: 'Khanmigo' },
          { '@type': 'Legislation', name: 'Ley de IA de la UE' },
        ],
        speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
        audience: { '@type': 'EducationalAudience', educationalRole: 'Teacher', audienceType: 'Docentes, directores escolares, profesionales de la educación' },
        educationalLevel: 'K-12, Educación Superior',
      },
      faqSchema: {
        '@context': 'https://schema.org',
        '@type': 'FAQPage',
      ...
      howToSchema: {
        ...
        step: [
          ...
          { '@type': 'HowToStep', position: 3, name: 'Enseña a los estudiantes cómo verificar los resultados de la IA y detectar alucinaciones', text: 'Muestra a los estudiantes la validación multi-modelo y la verificación de hechos contra fuentes primarias para desarrollar el pensamiento crítico y la alfabetización en IA.' },
          { '@type': 'HowToStep', position: 4, name: 'Crea una plantilla de prompt estructurada que los estudiantes usen para todas las interacciones con IA', text: 'Usa Rol → Objetivo → Alcance → Formato de salida → Método de validación. Practica esta plantilla juntos hasta que los estudiantes reconozcan cuándo los prompts vagos producen respuestas vagas.' },
          { '@type': 'HowToStep', position: 5, name: 'Establece directrices claras sobre el uso de la IA para tareas específicas', text: 'Sé explícito sobre qué tareas permiten la IA (lluvia de ideas, problemas de práctica) y cuáles no (respuestas de exámenes, código sin atribución).' },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'MagicSchool', description: 'Planificación de lecciones y gestión del aula. Docentes de K-12. Versión gratuita limitada.' },
          { '@type': 'ListItem', position: 3, name: 'ChatGPT / GPT-5.6', description: 'Creación de contenido flexible y borradores. Cualquier nivel, cualquier materia. Versión gratuita limitada.' },
          { '@type': 'ListItem', position: 4, name: 'Claude Sonnet 5', description: 'Diseño curricular de formato largo, contexto de 1.000.000 tokens. Universidad y tareas complejas. Versión gratuita limitada.' },
          { '@type': 'ListItem', position: 5, name: 'NotebookLM', description: 'Preguntas y respuestas basadas en fuentes sobre materiales cargados. Universidad e investigación. Gratuito.' },
          { '@type': 'ListItem', position: 6, name: 'Gemini 3.1 Pro', description: 'Análisis de documentos grandes, contexto de 1 millón de tokens. Administración escolar. Versión gratuita limitada.' },
        ],
      },
      sections: {
        tldr: {
          ...
          isTldr: true,
          items: [
            'Los tutores de IA produjeron ganancias de aprendizaje más del doble de las de las aulas de aprendizaje activo en el ensayo controlado aleatorizado de Harvard de 2024 (194 estudiantes; tamaño del efecto 0,73–1,3 DE) en un 18 % menos de tiempo de aprendizaje',
            'El 85 % de los docentes estadounidenses y el 86 % de los estudiantes usaron IA en el año escolar 2024–25 — la tasa de adopción de IA más alta de cualquier industria en el mundo',
            'Los prompts estructurados para docentes (con nivel de grado, objetivo, contexto del estudiante y formato de salida) ahorran 5–13 horas por semana en comparación con los prompts abiertos',
            'Las herramientas de detección de IA tienen tasas de falsos positivos del 15–30 % — son insuficientes como herramienta independiente para hacer cumplir la integridad académica',
            'La Ley de IA de la UE clasifica la IA educativa como de alto riesgo; las escuelas de la UE deben llevar a cabo formación en competencias de IA para todo el personal docente (Artículo 4, vigente desde 2025)',
            'Los estudiantes que usan herramientas de IA logran entre un 15 y un 35 % de puntuaciones más altas en evaluaciones en 21 estudios empíricos; r = 0,781 correlación entre el uso de herramientas de IA y los resultados',
            'En mayo de 2026, GPT-5.6, Claude Sonnet 5 (Anthropic) y Gemini 3.1 Pro admiten todos ventanas de contexto de 1 millón de tokens (~800 páginas por sesión)',
          ],
        },
        quickFacts: {
          title: '⚡ Datos rápidos',
          items: [
            '**Resultado del ECA de Harvard:** La tutoría con IA produjo ganancias de aprendizaje de 0,73–1,3 DE sobre las aulas de aprendizaje activo en un 18 % menos de tiempo (n=194, p < 10⁻⁸)',
            '**Adopción por parte de los docentes:** El 85 % de los docentes estadounidenses usó IA en el año escolar 2024–25',
            '**Tiempo ahorrado:** Los prompts estructurados ahorran a los docentes 5–13 horas/semana en planificación de lecciones y administración',
            '**Problema de detección de IA:** Tasa de falsos positivos del 15–30 % — poco fiable para decisiones independientes de integridad académica',
            '**Ley de IA de la UE:** La IA educativa clasificada como de alto riesgo (Anexo III). La formación en competencias de IA para el personal docente es obligatoria (Artículo 4, vigente desde 2025). La IA de reconocimiento de emociones en las escuelas está prohibida.',
            '**Mejores herramientas:** Khanmigo (tutoría), MagicSchool (planes de lección), ChatGPT/Claude (contenido flexible), NotebookLM (investigación basada en fuentes)',
          ],
        },
        definition: {
          id: 'what-ai-teaching-tools-actually-do',
          ...
          content: [
            ...
            'Los Sistemas de Tutoría Inteligente (STI) — la categoría técnica para herramientas como Khanmigo — adaptan la dificultad, proporcionan retroalimentación inmediata y guían a los estudiantes mediante el cuestionamiento socrático en lugar de dar respuestas directas. Los LLMs universales como GPT-5.6 (OpenAI) y Claude Sonnet 5 (Anthropic) manejan la generación de planes de lección, la creación de rúbricas y los materiales de instrucción diferenciada. Las herramientas de IA administrativas manejan resúmenes de asistencia, borradores de comunicación con padres e informes de progreso.',
            'En una oración: la IA en el aula no es una herramienta — es un conjunto, donde cada capa cumple un rol específico en el flujo de trabajo de instrucción.',
          ],
          snippets: [
            { type: 'in-one-sentence', text: 'Las herramientas de enseñanza con IA abarcan sistemas de tutoría (Khanmigo), planificadores de lecciones (ChatGPT, Claude) y asistentes administrativos — cada uno optimizado para diferentes tareas del aula.' },
          ],
        },
        toolComparison: {
          id: 'which-ai-tools-should-teachers-use-in-2026',
          ...
          content: [
            ...
            'Khanmigo es el asistente de tutoría con IA de Khan Academy, impulsado por GPT-4. Usa el cuestionamiento socrático para guiar a los estudiantes hacia las respuestas en lugar de dárselas directamente — una diferencia de diseño crucial para la retención del aprendizaje.',
            'MagicSchool ofrece el conjunto de herramientas más completo para docentes — planificación de lecciones, plantillas de gestión del aula, asistencia para la creación de PEI y herramientas de comunicación con padres.',
          ],
          callouts: [
            { type: '💡', label: 'Consejo Pro', text: 'Ninguna herramienta lo hace todo. La mayoría de los docentes usan 2–3 herramientas juntas: Khanmigo para la tutoría de los estudiantes, MagicSchool para la planificación y ChatGPT para la creación rápida de contenido.' },
          ],
          columns: ['Herramienta', 'Enlace', 'Mejor para', 'Contexto', 'Versión gratuita'],
          rows: [
            { 'Herramienta': 'Khanmigo (Khan Academy)', 'Enlace': '[khanmigo.ai](https://www.khanmigo.ai)', 'Mejor para': 'Tutoría estudiantil; aprendizaje socrático', 'Contexto': 'K-12, ecosistema Khan Academy', 'Versión gratuita': '44 USD al año' },
            { 'Herramienta': 'MagicSchool', 'Enlace': '[magicschool.ai](https://www.magicschool.ai)', 'Mejor para': 'Planificación de lecciones; gestión del aula', 'Contexto': 'Docentes de K-12', 'Versión gratuita': 'Sí (limitado)' },
            { 'Herramienta': 'ChatGPT / GPT-5.6 (OpenAI)', 'Enlace': '[chatgpt.com](https://chatgpt.com)', 'Mejor para': 'Creación de contenido flexible; borradores', 'Contexto': 'Cualquier nivel, cualquier materia', 'Versión gratuita': 'Sí (limitado)' },
            { 'Herramienta': 'Claude Sonnet 5 (Anthropic)', 'Enlace': '[claude.ai](https://claude.ai)', 'Mejor para': 'Diseño curricular de formato largo; análisis de documentos', 'Contexto': 'Universidad; tareas complejas', 'Versión gratuita': 'Sí (limitado)' },
            { 'Herramienta': 'NotebookLM (Google DeepMind)', 'Enlace': '[notebooklm.google.com](https://notebooklm.google.com)', 'Mejor para': 'Preguntas y respuestas basadas en fuentes sobre materiales del aula cargados', 'Contexto': 'Universidad; contextos de investigación', 'Versión gratuita': 'Gratuito / nivel Plus' },
            { 'Herramienta': 'Gemini 3.1 Pro (Google DeepMind)', 'Enlace': '[gemini.google.com](https://gemini.google.com)', 'Mejor para': 'Análisis de documentos grandes; revisión de políticas', 'Contexto': 'Administradores de distritos escolares', 'Versión gratuita': 'Sí (limitado)' },
          ],
        },
        toolUseCaseMapping: {
          title: 'IA en la educación: Mapeo de caso de uso a herramienta',
          content: [
            '**No todas las herramientas se adaptan a todas las tareas. Elige la herramienta correcta para cada caso de uso específico — los diferentes modelos destacan bajo diferentes restricciones (ventana de contexto, temperatura, costo, velocidad).**',
          ],
          columns: ['Caso de uso', 'Herramienta recomendada', 'Temperatura', 'Ahorro de tiempo'],
          rows: [
            { 'Caso de uso': 'Creación de planes de lección', 'Herramienta recomendada': 'MagicSchool / GPT-5.6', 'Temperatura': '0,1–0,2', 'Ahorro de tiempo': '30–60 min./lección' },
            { 'Caso de uso': 'Niveles de lectura diferenciados', 'Herramienta recomendada': 'Claude Sonnet 5', 'Temperatura': '0,1–0,2', 'Ahorro de tiempo': '15 min./pasaje' },
            { 'Caso de uso': 'Tutoría estudiantil (socrática)', 'Herramienta recomendada': 'Khanmigo', 'Temperatura': 'n/a (preestablecido)', 'Ahorro de tiempo': 'Asíncrono' },
            { 'Caso de uso': 'Retroalimentación alineada con rúbrica', 'Herramienta recomendada': 'Claude Sonnet 5 (contexto de 1.000.000 tokens)', 'Temperatura': '0,2', 'Ahorro de tiempo': 'Horas por conjunto de clase' },
            { 'Caso de uso': 'Borradores de comunicación con padres', 'Herramienta recomendada': 'ChatGPT / GPT-5.6', 'Temperatura': '0,3–0,5', 'Ahorro de tiempo': '5–10 min./mensaje' },
            { 'Caso de uso': 'Revisión de libros de texto/políticas', 'Herramienta recomendada': 'Gemini 3.1 Pro (contexto de 1 millón de tokens)', 'Temperatura': '0,1', 'Ahorro de tiempo': 'Horas por documento' },
          ],
        },
        localLLMs: {
          title: 'IA escolar privada: LLMs locales para la privacidad de datos',
          content: [
            'Para escuelas con requisitos estrictos de privacidad de datos — especialmente las escuelas de la UE bajo el RGPD — los LLMs locales mediante Ollama ofrecen una alternativa de cero salida de datos. Un portátil escolar con 16 GB de RAM ejecuta Qwen3 8B o Llama 4 Scout localmente, manejando la planificación de lecciones y la retroalimentación formativa sin que los datos de los estudiantes abandonen el dispositivo. La calidad es inferior a los modelos en la nube frontier, pero suficiente para las tareas de planificación rutinarias.',
          ],
        },
        promptStructure: {
          id: 'how-to-write-prompts-for-teaching-tasks',
          ...
          content: [
            ...
            'El prompt engineering es la práctica de crear instrucciones precisas y estructuradas que guíen la salida de la IA. Para los docentes, la diferencia entre una salida de IA útil e inútil está casi siempre en la especificidad del prompt, no en la capacidad del modelo.',
          ],
          snippets: [
            { type: 'in-plain-terms', text: 'Piensa en los prompts de IA como recetas: los prompts vagos ("haz algo delicioso") producen resultados inconsistentes; los prompts detallados ("hornea un pastel de chocolate a 175°C durante 35 minutos con chocolate negro") producen resultados fiables.' },
          ],
        },
        promptFramework: {
          title: 'Malo vs. bueno: Prompts para la planificación de lecciones',
          content: [
            '**Los prompts específicos y ricos en contexto ahorran a los docentes entre 5 y 13 horas por semana en planificación de lecciones cuando se usan de forma coherente. La versión mala requiere más de 30 minutos de revisión; la buena genera una salida lista para el aula en un solo intento.**',
            'Prompt malo — salida genérica:',
          ],
          blockquote: 'Crea una lección sobre la adición de fracciones para quinto grado.',
          items: [
            'Esto genera un esquema vago sin asignación de tiempo, sin alineación con estándares, sin diferenciación y sin boleto de salida. La mayor parte de la salida se desecha.',
          ],
        },
        goodExample: {
          id: 'the-five-component-teacher-prompt',
          ...
          blockquote: 'Eres un docente de matemáticas de quinto grado con experiencia. Crea una lección de 45 minutos sobre la adición de fracciones con denominadores diferentes. Los estudiantes comprenden las fracciones equivalentes pero aún no las han combinado. Incluye: un calentamiento de 10 minutos con modelos visuales, 15 minutos de instrucción directa con tres ejemplos resueltos, 15 minutos de práctica con un compañero y un boleto de salida de 5 minutos. Alineación con Common Core 5.NF.A.1. Genera solo el plan de lección con encabezados de sección, asignaciones de tiempo y una lista de materiales.',
          items: [
            'La versión estructurada genera un documento con secciones alineadas con rúbricas, actividades cronometradas y una lista de materiales. Listo para usar o para refinar — no para reescribir completamente.',
          ],
          callouts: [
            { type: '📌', label: 'Punto clave', text: 'Los cinco componentes son: (1) Rol, (2) Objetivo, (3) Contexto del estudiante, (4) Restricciones, (5) Formato de salida. Usar los cinco de forma coherente ahorra 5–13 horas por semana.' },
          ],
        },
        assessmentPrompt: {
          id: 'how-do-you-prompt-ai-for-assessment-feedback',
          ...
          content: [
            ...
            'La ventana de contexto de 1.000.000 de tokens de Claude Sonnet 5 maneja conjuntos completos de clase de ensayos en una sola sesión — aproximadamente 800 páginas estándar — lo que hace práctico la generación de retroalimentación por lotes para los docentes con clases grandes.',
          ],
          blockquote: 'Eres una profesora de inglés de séptimo grado con experiencia. Analiza este ensayo persuasivo de un estudiante usando esta rúbrica: tesis clara (4 puntos), tres argumentos de apoyo con evidencia (12 puntos), reconocimiento del contraargumento (4 puntos), transiciones formales (3 puntos), conclusión que refuerza la tesis (3 puntos). Para cada criterio: da la puntuación, cita la oración relevante y escribe una sugerencia específica de mejora. Puntuación total de 26 puntos.',
          callouts: [
            { type: '⚠️', label: 'Advertencia', text: 'La IA no puede evaluar de manera fiable la voz, la originalidad ni la calidad de escritura — usa siempre la retroalimentación de la IA para la mecánica y la estructura, no para las puntuaciones holísticas en criterios subjetivos. Mantén la evaluación sumativa final en manos de humanos.' },
          ],
        },
        learningOutcomes: {
          id: 'does-ai-tutoring-improve-learning-outcomes',
          ...
          content: [
            ...
            'La evidencia más sólida proviene de un ensayo controlado aleatorizado de 2024 liderado por Gregory Kestin y Kelly Miller en la Universidad de Harvard con 194 estudiantes de física. El estudio utilizó un diseño cruzado donde cada estudiante experimentó tanto la tutoría con IA como los métodos de aprendizaje activo tradicionales en dos temas. Hallazgos clave:',
          ],
          callouts: [
            { type: '🔍', label: '¿Sabías que?', text: 'Los estudiantes mostraron mayor motivación y compromiso en las sesiones de tutoría con IA. El tamaño del efecto (0,73–1,3 DE) es equivalente a la ganancia de aprendizaje de pasar de un aula típica a una instrucción de primera clase.' },
          ],
          items: [
            'Los estudiantes enseñados por IA lograron puntuaciones significativamente más altas en las pruebas posteriores — tamaño del efecto entre 0,73 y 1,3 desviaciones estándar',
            'Tiempo promedio de aprendizaje: **49 minutos** (grupo IA) vs. **60 minutos** (grupo de aula)',
            'Los estudiantes informaron de mayor motivación y compromiso en las sesiones de IA',
            'Significación estadística: p < 10⁻⁸',
            'Una revisión sistemática de 2025 de 21 estudios empíricos muestra que los estudiantes asistidos por IA superan a los grupos de control en evaluaciones en un 15–35 %, r = 0,781',
          ],
        },
        integrityProblem: {
          id: 'how-detectable-is-ai-cheating-in-schools',
          ...
          content: [
            ...
            'La integridad académica es el desafío central en la educación asistida por IA. El alcance de la adopción ha superado tanto las políticas como la tecnología de detección. La adopción por parte de los estudiantes es generalizada: las encuestas informan que el 60–92 % de los estudiantes usan la IA para aprender, aunque las políticas institucionales sobre los usos permitidos varían considerablemente.',
            'El problema de detección tiene tres capas críticas:',
          ],
          items: [
            '**Falsos positivos** — los hablantes no nativos se marcan de forma desproporcionada; los estilos de escritura académica estructurada activan consistentemente las herramientas de detección',
            '**Texto híbrido** — los borradores de IA editados significativamente por los estudiantes vencen a la mayoría de los sistemas de detección',
            '**Brecha de políticas** — las universidades están pasando en 2026 de las prohibiciones absolutas a los marcos de transparencia y divulgación',
          ],
          callouts: [
            { type: '⚠️', label: 'Advertencia', text: 'Los hablantes no nativos y los estudiantes con estilos de escritura estructurados se marcan de forma desproporcionada. Acusar a un estudiante únicamente basándose en la salida de detección de IA tiene un riesgo de error del 15–30 %.' },
          ],
        },
        integrityCloser: {
          content: [
            'El consenso institucional emergente: las herramientas de detección de IA no son autoridades definitivas. Las universidades exigen cada vez más la revisión humana-automatizada y hacen cumplir las normas de divulgación en lugar de las normas de prohibición.',
          ],
        },
        regulatoryContext: {
          id: 'how-does-the-eu-ai-act-affect-schools',
          ...
          content: [
            ...
            'Según el Anexo III de la Ley de IA de la UE, las herramientas de IA educativas que determinan el acceso a la educación o evalúan los resultados del aprendizaje se clasifican como sistemas de alto riesgo. Las escuelas y universidades que operan en la UE se consideran "proveedoras" de IA bajo la ley y tienen obligaciones legales, incluyendo:',
          ],
          items: [
            'Garantizar la competencia en IA del personal (mandato del Artículo 4 — vigente desde 2025)',
            'Implementar la supervisión humana para todas las decisiones de IA de alto riesgo que afecten a los estudiantes',
            'Mantener registros de auditoría de las evaluaciones influenciadas por IA',
            'Divulgar las fuentes de datos del sistema de IA y la lógica del modelo a los estudiantes a petición',
          ],
          callouts: [
            { type: '📌', label: 'Punto clave', text: 'Las escuelas de la UE deben llevar a cabo formación en competencias de IA para todos los docentes y administradores que trabajen con sistemas de IA (Artículo 4, vigente desde 2025). El incumplimiento conlleva penalizaciones de hasta 30 millones de euros.' },
          ],
        },
        regulatoryRegionalContext: {
          title: 'Regulaciones globales de IA educativa',
          content: [
            'La Ley de IA de la UE prohíbe completamente los sistemas de reconocimiento de emociones en instituciones educativas — que afecta directamente a las herramientas que rastrean el compromiso de los estudiantes mediante el análisis facial. Las instituciones educativas chinas despliegan herramientas de IA bajo las Medidas Provisionales de China para la IA Generativa (2023), que requieren que el contenido educativo generado por IA se etiquete como tal. El Ministerio de Educación de Japón (MEXT) emitió directrices en 2023 que advierten sobre el uso de IA en ciertos contextos de evaluación, al tiempo que reconoce la IA como una competencia estudiantil central.',
          ],
        },
        regionalContext: {
          title: 'En el contexto hispanohablante: IA en escuelas e instituciones educativas',
          content: [
            '**El uso de IA en las escuelas e instituciones educativas de España y Latinoamérica requiere atención cuidadosa al cumplimiento de la protección de datos, las directrices regulatorias locales y la documentación para las autoridades educativas.**',
            'La IA en el contexto educativo hispanohablante ofrece oportunidades y desafíos únicos:',
          ],
          items: [
            '**España (LOPD-GDD y RGPD):** Si una escuela usa plataformas de IA (ChatGPT, Claude, Khanmigo) que procesan datos de los estudiantes, la escuela necesita un Acuerdo de Procesamiento de Datos (DPA) con el proveedor. Verifica si tu proveedor de herramientas ofrece DPAs para escuelas. La AEPD ha emitido guías específicas sobre el uso de IA en entornos educativos. Las soluciones locales o alojadas en la UE (Ollama con inferencia local, LM Studio) reducen significativamente los riesgos de privacidad.',
            '**Latinoamérica:** Las regulaciones varían por país. Brasil tiene la LGPD, Colombia la Ley 1581, México la LFPDPPP y Argentina la Ley 25.326. En general, todas exigen informar al usuario sobre el uso de IA en contextos educativos y obtener el consentimiento adecuado. Consulta siempre la normativa local antes de desplegar herramientas de IA que procesen datos de estudiantes menores de edad.',
            '**Documentación para las autoridades educativas:** Las autoridades educativas de España y muchos países latinoamericanos requieren cada vez más documentación de todos los usos de IA. Mantén registros de auditoría de todas las evaluaciones influenciadas por IA, almacena los prompts y la configuración, y documenta la formación sobre el uso de IA.',
            '**Modelos locales para escuelas con presupuesto limitado:** Para escuelas con presupuesto limitado o altos requisitos de privacidad de datos, los modelos de código abierto locales (Ollama, LM Studio, llama.cpp) son una alternativa práctica. Requieren conocimientos básicos de TI pero ahorran costos y evitan la salida de datos fuera de la jurisdicción local.',
          ],
        },
        commonMistakes: {
          id: 'common-mistakes-when-using-ai-in-education',
          ...
          items: [
            '**Usar la IA como sustituto de la calificación en lugar de como herramienta de retroalimentación:** La IA genera puntuaciones de rúbrica plausibles pero no puede evaluar de manera fiable la originalidad, la voz ni la calidad de la argumentación en escritos más largos. Usa la IA para la retroalimentación formativa en trabajos de bajo riesgo; mantén la evaluación sumativa en manos de humanos.',
            '**Prompts no estructurados para la planificación de lecciones:** "Crea una lección sobre la fotosíntesis" genera una salida genérica que requiere más tiempo de edición que escribir desde cero. Especifica siempre el nivel de grado, el conocimiento previo, las restricciones de tiempo y el formato de salida.',
            '**Exceso de confianza en las herramientas de detección de IA para la integridad académica:** Las tasas de falsos positivos del 15–30 % significan que acusar a un estudiante únicamente basándose en la salida de detección de IA tiene un riesgo de error del 15–30 %. Los hablantes no nativos se marcan de forma desproporcionada.',
            '**Ignorar las obligaciones de la Ley de IA de la UE para las escuelas de la UE:** Las herramientas de IA educativas que influyen en las rutas de aprendizaje o la evaluación son de alto riesgo bajo el Anexo III. Las escuelas de la UE que implementan estas herramientas sin la formación en competencias del personal del Artículo 4 no están en cumplimiento.',
            '**Usar ajustes de temperatura alta para el contenido de las lecciones:** La temperatura predeterminada en la mayoría de las plataformas de IA (0,7–1,0) aumenta el riesgo de alucinación. Para el contenido factual de las lecciones, las rúbricas de evaluación y la generación de referencias, establece la temperatura en 0,1–0,2.',
            '**No enseñar a los estudiantes cómo usar las herramientas de IA de manera eficaz:** Los estudiantes que escriben "escribe mi ensayo sobre la fotosíntesis" no aprenden nada. Los estudiantes que escriben "explica la fotosíntesis al nivel de octavo grado, luego hazme un examen sobre los tres conceptos clave" están aprendiendo activamente. Crea una plantilla de prompt para el aula que los estudiantes deban usar para todas las interacciones con IA.',
          ],
          callouts: [
            { type: '🛠️', label: 'Mejor práctica', text: 'Documenta todo el uso de IA: qué herramienta, qué configuración (temperatura, contexto) y qué tarea. Esto crea un rastro de auditoría para el cumplimiento y te ayuda a mejorar con el tiempo.' },
          ],
        },
        relatedReading: {
          id: 'related-reading',
        ...
        howToStart: {
          ...
          numberedItems: [
            'Define los objetivos de aprendizaje y las evaluaciones antes de introducir la IA.',
            'Usa la IA para práctica personalizada y retroalimentación inmediata, no para juicios de calificación.',
            'Enseña a los estudiantes cómo verificar los resultados de la IA y detectar alucinaciones.',
            'Crea una plantilla de prompt estructurada que los estudiantes usen para todas las interacciones con IA.',
            'Establece directrices claras sobre el uso de la IA para tareas específicas.',
          ],
        },
        faq: {
          id: 'faq',
        ...
        sources: {
          ...
          items: [
            '[Kestin & Miller, 2024. "AI Tutoring Outperforms Active Learning Classrooms — Harvard RCT"](https://www.nature.com/articles/s41598-025-97652-6) — ensayo controlado aleatorizado con 194 estudiantes; tamaño del efecto 0,73–1,3 DE',
            '[Kwak, 2025. "The Effectiveness of AI-Driven Tools in Improving Student Learning Outcomes"](https://iacis.org/iis/2025/4_iis_2025_233-247.pdf) — revisión sistemática de 21 estudios; ganancias de rendimiento del 15–35 %; r = 0,781',
            '[Ley de IA de la UE, 2024. Anexo III — Sistemas de IA de alto riesgo en la educación](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689) — clasifica la IA de evaluación educativa como de alto riesgo con requisitos de supervisión obligatorios',
          ],
        },
      },
    },
    ...
    ar: {
      ...
      next_refresh_due: '2027-05-04',
      theme: 'Use Cases',
      heroImage: '/images/teaching-with-ai-overview-hero-ar.webp',
      ...
      seoTitle: 'التدريس بالذكاء الاصطناعي ⁨2026⁩: ضعف نتائج التعلم',
      metaDescription: 'دراسة هارفارد (⁨194⁩ طالباً): الذكاء الاصطناعي يضاعف التعلم في وقت أقل بـ⁨18%⁩. أدوات ⁨Khanmigo⁩ و⁨MagicSchool⁩ مع إرشادات قانون ⁨EU⁩.',
      educationalLevel: 'مبتدئ',
      audience: 'المعلمون ومديرو المدارس والمهنيون في قطاع التعليم الذين يستخدمون أدوات الذكاء الاصطناعي',
      aboutTopics: ['الذكاء الاصطناعي في التعليم', 'Khanmigo', 'قانون الذكاء الاصطناعي الأوروبي'],
      howToName: 'كيفية التدريس بالذكاء الاصطناعي',
      ogDescription: '85٪ من المعلمين الأمريكيين استخدموا الذكاء الاصطناعي في 2024–25 — لكن البرومبتات الغامضة تُهدر إمكاناته. هارفارد أثبتت أن التدريس الفردي بالذكاء الاصطناعي يُضاعف مكاسب التعلم. هنا إطار البرومبت المؤلف من 5 أجزاء للمعلمين مع الامتثال لقانون الذكاء الاصطناعي الأوروبي للمدارس.',
      twitterDescription: 'التدريس الفردي بالذكاء الاصطناعي: ضعف مكاسب التعلم، وقت دراسة أقل بـ⁨18⁩٪ (تجربة عشوائية محكومة هارفارد، ⁨n⁩=⁨194⁩). أفضل الأدوات وإطار البرومبت للمعلمين.',
      toc: [
        { label: 'ما تفعله أدوات التدريس بالذكاء الاصطناعي فعلاً', anchor: '#what-ai-teaching-tools-actually-do' },
        { label: 'أي أدوات ذكاء اصطناعي يجب على المعلمين استخدامها في 2026؟', anchor: '#which-ai-tools-should-teachers-use-in-2026' },
        { label: 'كيفية كتابة برومبتات لمهام التدريس', anchor: '#how-to-write-prompts-for-teaching-tasks' },
        { label: 'برومبت المعلم المؤلف من خمسة مكونات', anchor: '#the-five-component-teacher-prompt' },
        { label: 'كيف تكتب برومبتات ذكاء اصطناعي لتغذية راجعة التقييم؟', anchor: '#how-do-you-prompt-ai-for-assessment-feedback' },
        { label: 'هل يُحسّن التدريس الفردي بالذكاء الاصطناعي نتائج التعلم؟', anchor: '#does-ai-tutoring-improve-learning-outcomes' },
        { label: 'ما مدى قابلية كشف الغش بالذكاء الاصطناعي في المدارس؟', anchor: '#how-detectable-is-ai-cheating-in-schools' },
        { label: 'كيف يؤثر قانون الذكاء الاصطناعي الأوروبي على المدارس؟', anchor: '#how-does-the-eu-ai-act-affect-schools' },
      ...
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        url: 'https://www.promptquorum.com/ar/prompt-engineering/teaching-with-ai',
        inLanguage: 'ar',
        headline: 'التدريس بالذكاء الاصطناعي في 2026: دراسة هارفارد تُثبت ضعف التعلم — الأدوات والبرومبتات ودليل قانون الذكاء الاصطناعي الأوروبي',
        description: 'تجربة عشوائية محكومة من هارفارد: التدريس الفردي بالذكاء الاصطناعي أنتج ضعف مكاسب التعلم في وقت أقل بـ18٪. أفضل الأدوات للمعلمين (Khanmigo وMagicSchool) وإطار البرومبت المؤلف من 5 أجزاء والتزامات مدارس الاتحاد الأوروبي بقانون الذكاء الاصطناعي.',
        datePublished: '2026-03-23',
        dateModified: '2026-08-30',
        proficiencyLevel: 'Beginner',
        author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
        ...
        about: [
          ...
          { '@type': 'SoftwareApplication', name: 'Khanmigo' },
          { '@type': 'Legislation', name: 'قانون الذكاء الاصطناعي الأوروبي' },
        ],
        speakable: { '@type': 'SpeakableSpecification', cssSelector: ['.article-intro', '.key-takeaways'] },
        audience: { '@type': 'EducationalAudience', educationalRole: 'Teacher', audienceType: 'المعلمون ومديرو المدارس والمهنيون في قطاع التعليم' },
        educationalLevel: 'K-12، التعليم العالي',
      },
      faqSchema: {
        '@context': 'https://schema.org',
        '@type': 'FAQPage',
      ...
      howToSchema: {
        ...
        '@type': 'HowTo',
        inLanguage: 'ar',
        name: 'كيفية دمج الذكاء الاصطناعي في تدريسك',
        url: 'https://www.promptquorum.com/ar/prompt-engineering/teaching-with-ai',
        step: [
          { '@type': 'HowToStep', position: 1, name: 'حدّد أهداف التعلم والتقييمات قبل إدخال الذكاء الاصطناعي', text: 'حدّد ما يجب أن يعرفه الطلاب وكيف ستُقيّمه. ثم صمّم أين يُعزّز الذكاء الاصطناعي التعليم.' },
          { '@type': 'HowToStep', position: 2, name: 'استخدم الذكاء الاصطناعي للتدريب الشخصي والتغذية الراجعة الفورية، وليس للتقييم', text: 'يتميز الذكاء الاصطناعي في توليد مسائل التدريب وتقديم التغذية الراجعة الفورية. تجنّب استخدام الذكاء الاصطناعي للتقييم الذاتي دون مراجعة بشرية.' },
          { '@type': 'HowToStep', position: 3, name: 'علّم الطلاب كيفية التحقق من نتائج الذكاء الاصطناعي والكشف عن الهلوسات', text: 'أظهر للطلاب التحقق متعدد النماذج والتحقق من الحقائق مقابل المصادر الأولية لتطوير التفكير النقدي وثقافة الذكاء الاصطناعي.' },
          { '@type': 'HowToStep', position: 4, name: 'أنشئ قالب برومبت منظماً يستخدمه الطلاب لجميع تفاعلات الذكاء الاصطناعي', text: 'استخدم الدور ← الهدف ← النطاق ← صيغة المخرج ← طريقة التحقق. تدرّب على هذا القالب معاً حتى يتعرف الطلاب متى تُنتج البرومبتات الغامضة ردوداً غامضة.' },
          { '@type': 'HowToStep', position: 5, name: 'ضع إرشادات واضحة حول استخدام الذكاء الاصطناعي لمهام محددة', text: 'كن صريحاً حول المهام التي تسمح بالذكاء الاصطناعي (العصف الذهني ومسائل التدريب) والتي لا تسمح (إجابات الامتحانات والكود بدون إسناد).' },
        ],
      },
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        inLanguage: 'ar',
        name: 'أدوات الذكاء الاصطناعي للمعلمين 2026',
        description: 'مقارنة أدوات الذكاء الاصطناعي للمعلمين للاستخدام في الفصل الدراسي',
        url: 'https://www.promptquorum.com/ar/prompt-engineering/teaching-with-ai',
        numberOfItems: 6,
        itemListElement: [
          { '@type': 'ListItem', position: 1, name: 'Khanmigo', description: 'تدريس الطلاب فردياً عبر الاستجواب السقراطي. K-12، نظيرة بيئة Khan Academy. 44 دولار سنوياً.' },
          { '@type': 'ListItem', position: 2, name: 'MagicSchool', description: 'التخطيط للدروس وإدارة الفصل. معلمو K-12. نسخة مجانية محدودة.' },
          { '@type': 'ListItem', position: 3, name: 'ChatGPT / GPT-5.6', description: 'إنشاء محتوى مرن ومسودات. أي مستوى، أي مادة. نسخة مجانية محدودة.' },
          { '@type': 'ListItem', position: 4, name: 'Claude Sonnet 5', description: 'تصميم مناهج طويلة، سياق مليون رمز. الجامعة والمهام المعقدة. نسخة مجانية محدودة.' },
          { '@type': 'ListItem', position: 5, name: 'NotebookLM', description: 'أسئلة وأجوبة مستندة إلى المصادر على المواد المُحمَّلة. الجامعة والبحث. مجاني.' },
          { '@type': 'ListItem', position: 6, name: 'Gemini 3.1 Pro', description: 'تحليل المستندات الكبيرة، سياق مليون رمز. إدارة المدارس. نسخة مجانية محدودة.' },
        ],
      },
      sections: {
        tldr: {
          ...
          isTldr: true,
          items: [
            'أنتج المعلمون الذكاء الاصطناعي مكاسب تعليمية تفوق ضعف تلك التي تحققت في فصول التعلم النشط في التجربة العشوائية المحكومة من هارفارد 2024 (194 طالباً؛ حجم التأثير 0.73–1.3 انحراف معياري) في وقت تعلم أقل بـ18٪',
            '85٪ من المعلمين الأمريكيين و86٪ من الطلاب استخدموا الذكاء الاصطناعي في العام الدراسي 2024–25 — أعلى معدل تبني للذكاء الاصطناعي في أي صناعة في العالم',
            'البرومبتات المنظمة للمعلمين (مع المستوى الدراسي والهدف وسياق الطالب وصيغة المخرج) توفّر 5–13 ساعة أسبوعياً مقارنة بالبرومبتات المفتوحة',
            'أدوات كشف الذكاء الاصطناعي لها معدلات إيجابية كاذبة 15–30٪ — غير كافية كأداة مستقلة لتطبيق النزاهة الأكاديمية',
            'قانون الذكاء الاصطناعي الأوروبي يُصنّف الذكاء الاصطناعي التعليمي عالي المخاطر؛ يجب على مدارس الاتحاد الأوروبي إجراء تدريب كفاءة الذكاء الاصطناعي لجميع الموظفين التدريسيين (المادة 4، سارية من 2025)',
            'الطلاب الذين يستخدمون أدوات الذكاء الاصطناعي يحققون درجات أعلى بـ15–35٪ في التقييمات في 21 دراسة تجريبية؛ r = 0.781 الارتباط بين استخدام أدوات الذكاء الاصطناعي والنتائج',
            'في مايو 2026، GPT-5.6 وClaude Sonnet 5 (Anthropic) وGemini 3.1 Pro يدعمون جميعاً نوافذ سياق مليون رمز (~800 صفحة قياسية لكل جلسة)',
          ],
        },
        quickFacts: {
          title: '⚡ حقائق سريعة',
        ...
        definition: {
          ...
          content: [
            ...
            'أنظمة التدريس الذكي (ITS) — الفئة التقنية لأدوات مثل Khanmigo — تُكيّف الصعوبة وتُقدّم تغذية راجعة فورية وتُرشد الطلاب عبر الاستجواب السقراطي بدلاً من إعطاء إجابات مباشرة. النماذج اللغوية العامة مثل GPT-5.6 (OpenAI) وClaude Sonnet 5 (Anthropic) تتعامل مع توليد خطط الدروس وإنشاء المعايير ومواد التعليم المُتمايز. الأدوات الإدارية للذكاء الاصطناعي تتعامل مع ملخصات الحضور ومسودات التواصل مع الأولياء وتقارير التقدم.',
            'في جملة واحدة: الذكاء الاصطناعي في الفصل الدراسي ليس أداةً — بل مجموعة أدوات، كل طبقة تؤدي دوراً محدداً في سير عمل التعليم.',
          ],
          snippets: [
            { type: 'in-one-sentence', text: 'أدوات التدريس بالذكاء الاصطناعي تشمل أنظمة تدريس فردي (Khanmigo) ومخططي دروس (ChatGPT وClaude) ومساعدين إداريين — كل منها مُحسَّن لمهام فصل دراسي مختلفة.' },
          ],
        },
        toolComparison: {
          id: 'which-ai-tools-should-teachers-use-in-2026',
          ...
          callouts: [
            { type: '💡', label: 'نصيحة احترافية', text: 'لا توجد أداة تفعل كل شيء. معظم المعلمين يستخدمون 2–3 أدوات معاً: Khanmigo لتدريس الطلاب فردياً، MagicSchool للتخطيط، وChatGPT لإنشاء المحتوى السريع.' },
          ],
          columns: ['الأداة', 'الرابط', 'الأفضل لـ', 'السياق', 'نسخة مجانية'],
          rows: [
            { 'الأداة': 'Khanmigo (Khan Academy)', 'الرابط': '[khanmigo.ai](https://www.khanmigo.ai)', 'الأفضل لـ': 'تدريس الطلاب فردياً؛ التعلم السقراطي', 'السياق': 'K-12، نظيرة بيئة Khan Academy', 'نسخة مجانية': '44 دولار سنوياً' },
            { 'الأداة': 'MagicSchool', 'الرابط': '[magicschool.ai](https://www.magicschool.ai)', 'الأفضل لـ': 'التخطيط للدروس؛ إدارة الفصل', 'السياق': 'معلمو K-12', 'نسخة مجانية': 'نعم (محدود)' },
            { 'الأداة': 'ChatGPT / GPT-5.6 (OpenAI)', 'الرابط': '[chatgpt.com](https://chatgpt.com)', 'الأفضل لـ': 'إنشاء محتوى مرن؛ مسودات', 'السياق': 'أي مستوى، أي مادة', 'نسخة مجانية': 'نعم (محدود)' },
            { 'الأداة': 'Claude Sonnet 5 (Anthropic)', 'الرابط': '[claude.ai](https://claude.ai)', 'الأفضل لـ': 'تصميم مناهج طويلة؛ تحليل مستندات', 'السياق': 'الجامعة؛ المهام المعقدة', 'نسخة مجانية': 'نعم (محدود)' },
            { 'الأداة': 'NotebookLM (Google DeepMind)', 'الرابط': '[notebooklm.google.com](https://notebooklm.google.com)', 'الأفضل لـ': 'أسئلة وأجوبة مستندة إلى المصادر على مواد الفصل المُحمَّلة', 'السياق': 'الجامعة؛ سياقات البحث', 'نسخة مجانية': 'مجاني / مستوى Plus' },
            { 'الأداة': 'Gemini 3.1 Pro (Google DeepMind)', 'الرابط': '[gemini.google.com](https://gemini.google.com)', 'الأفضل لـ': 'تحليل المستندات الكبيرة؛ مراجعة السياسات', 'السياق': 'مديرو المقاطعات المدرسية', 'نسخة مجانية': 'نعم (محدود)' },
          ],
        },
        toolUseCaseMapping: {
          title: 'الذكاء الاصطناعي في التعليم: ربط حالة الاستخدام بالأداة',
          content: [
          ...
          columns: ['حالة الاستخدام', 'الأداة الموصى بها', 'درجة الحرارة', 'توفير الوقت'],
          rows: [
            { 'حالة الاستخدام': 'إنشاء خطط الدروس', 'الأداة الموصى بها': 'MagicSchool / GPT-5.6', 'درجة الحرارة': '0.1–0.2', 'توفير الوقت': '30–60 دقيقة/درس' },
            { 'حالة الاستخدام': 'مستويات القراءة المُتمايزة', 'الأداة الموصى بها': 'Claude Sonnet 5', 'درجة الحرارة': '0.1–0.2', 'توفير الوقت': '15 دقيقة/مقطع' },
            { 'حالة الاستخدام': 'التدريس الفردي للطلاب (سقراطي)', 'الأداة الموصى بها': 'Khanmigo', 'درجة الحرارة': 'غير متاح (مُضبط مسبقاً)', 'توفير الوقت': 'غير متزامن' },
            { 'حالة الاستخدام': 'تغذية راجعة مُحاذِية لمعايير التقييم', 'الأداة الموصى بها': 'Claude Sonnet 5 (سياق مليون رمز)', 'درجة الحرارة': '0.2', 'توفير الوقت': 'ساعات لكل مجموعة فصل' },
            { 'حالة الاستخدام': 'مسودات التواصل مع الأولياء', 'الأداة الموصى بها': 'ChatGPT / GPT-5.6', 'درجة الحرارة': '0.3–0.5', 'توفير الوقت': '5–10 دقائق/رسالة' },
            { 'حالة الاستخدام': 'مراجعة الكتب المدرسية/السياسات', 'الأداة الموصى بها': 'Gemini 3.1 Pro (سياق مليون رمز)', 'درجة الحرارة': '0.1', 'توفير الوقت': 'ساعات لكل مستند' },
          ],
        },
        localLLMs: {
          title: 'الخصوصية المدرسية: النماذج اللغوية المحلية لخصوصية البيانات',
          content: [
        ...
        promptStructure: {
          ...
          snippets: [
            { type: 'in-plain-terms', text: 'فكّر في برومبتات الذكاء الاصطناعي كوصفات: البرومبتات الغامضة ("اصنع شيئاً لذيذاً") تُنتج نتائج غير متسقة؛ البرومبتات المفصّلة ("اخبز كعكة شوكولاتة على 175 درجة لمدة 35 دقيقة بشوكولاتة داكنة") تُنتج نتائج موثوقة.' },
          ],
        },
        promptFramework: {
          title: 'سيئ مقابل جيد: البرومبتات للتخطيط للدروس',
          content: [
          ...
          blockquote: 'أنشئ درساً عن جمع الكسور للصف الخامس.',
          items: [
        ...
        goodExample: {
          ...
          callouts: [
            { type: '📌', label: 'نقطة رئيسية', text: 'المكونات الخمسة هي: (1) الدور، (2) الهدف، (3) سياق الطالب، (4) القيود، (5) صيغة المخرج. استخدام الخمسة باتساق يوفّر 5–13 ساعة أسبوعياً.' },
          ],
        },
        assessmentPrompt: {
          id: 'how-do-you-prompt-ai-for-assessment-feedback',
          ...
          content: [
            ...
            'نافذة سياق مليون رمز لـClaude Sonnet 5 تتعامل مع مجموعات كاملة من المقالات في جلسة واحدة — حوالي 800 صفحة قياسية — مما يجعل توليد التغذية الراجعة الدُفعية عملياً للمعلمين ذوي الفصول الكبيرة.',
          ],
          blockquote: 'أنت معلمة لغة عربية من الصف السابع ذات خبرة. حلّل هذه المقالة الإقناعية لطالب باستخدام هذا المعيار: أطروحة واضحة (4 نقاط) وثلاث حجج داعمة بأدلة (12 نقطة) واعتراف بالحجة المضادة (4 نقاط) وانتقالات رسمية (3 نقاط) وخاتمة تُعزّز الأطروحة (3 نقاط). لكل معيار: أعطِ الدرجة واستشهد بالجملة ذات الصلة واكتب اقتراح تحسين محدداً. مجموع الدرجات 26 نقطة.',
          callouts: [
            { type: '⚠️', label: 'تحذير', text: 'الذكاء الاصطناعي لا يستطيع تقييم الصوت والأصالة وجودة الكتابة بشكل موثوق — استخدم دائماً تغذية الذكاء الاصطناعي الراجعة للميكانيكا والبنية، وليس للدرجات الشاملة على معايير ذاتية. احتفظ بالتقييم الختامي النهائي في أيدي البشر.' },
          ],
        },
        learningOutcomes: {
          id: 'does-ai-tutoring-improve-learning-outcomes',
          ...
          callouts: [
            { type: '🔍', label: 'هل تعلم؟', text: 'أظهر الطلاب دافعية أعلى وتفاعلاً أكبر في جلسات التدريس الفردي بالذكاء الاصطناعي. حجم التأثير (0.73–1.3 انحراف معياري) يعادل مكسب التعلم من الانتقال من فصل نموذجي إلى تعليم عالي الجودة.' },
          ],
          items: [
        ...
        integrityProblem: {
          ...
          callouts: [
            { type: '⚠️', label: 'تحذير', text: 'غير الناطقين باللغة الأصلية والطلاب ذوو أساليب الكتابة المنظمة يُعلَّمون بشكل غير متناسب. اتهام طالب بناءً فقط على مخرج كشف الذكاء الاصطناعي له خطر خطأ 15–30٪.' },
          ],
        },
        integrityCloser: {
          content: [
        ...
        regulatoryContext: {
          ...
          callouts: [
            { type: '📌', label: 'نقطة رئيسية', text: 'يجب على مدارس الاتحاد الأوروبي إجراء تدريب كفاءة الذكاء الاصطناعي لجميع المعلمين والإداريين الذين يعملون مع أنظمة الذكاء الاصطناعي (المادة 4، سارية من 2025). عدم الامتثال قد يترتب عليه عقوبات تصل إلى 30 مليون يورو.' },
          ],
        },
        regulatoryRegionalContext: {
          title: 'لوائح الذكاء الاصطناعي التعليمي العالمية',
          content: [
        ...
        regionalContext: {
          title: 'في السياق العربي: الذكاء الاصطناعي في المدارس والمؤسسات التعليمية',
          content: [
        ...
        commonMistakes: {
          ...
          callouts: [
            { type: '🛠️', label: 'أفضل ممارسة', text: 'وثّق جميع استخدامات الذكاء الاصطناعي: أي أداة وأي إعداد (درجة الحرارة والسياق) وأي مهمة. هذا ينشئ مسار تدقيق للامتثال ويساعدك على التحسين مع الوقت.' },
          ],
        },
        relatedReading: {
          id: 'related-reading',
          ...
          items: [
            ...
            '[اكتب كوداً أفضل بالذكاء الاصطناعي](/ar/prompt-engineering/write-better-code-with-ai) — كيف تُولّد البرومبتات المنظمة مخرجات ذكاء اصطناعي موثوقة — قابل للتطبيق على التخطيط للدروس وتوليد التقييمات',
            '[قيود الذكاء الاصطناعي — ما لا تستطيع النماذج اللغوية فعله](/ar/prompt-engineering/ai-limitations-what-llms-cant-do) — لماذا هلوسة الذكاء الاصطناعي تؤثر على أدوات المعلمين وكيفية التصميم حولها',
            '[البحث بالذكاء الاصطناعي](/ar/prompt-engineering/ai-powered-research) — سير عمل التحقق للمحتوى المُنتج بالذكاء الاصطناعي، قابل للتطبيق على مهام بحث الطلاب والمعلمين',
            '[برومبت الشخصية](/ar/prompt-engineering/persona-prompting) — كيف تُغيّر تعريفات الدور مثل "معلم رياضيات من الصف الخامس ذو خبرة" جودة واتساق مخرجات الذكاء الاصطناعي',
            '[برومبت سلسلة الأفكار](/ar/prompt-engineering/chain-of-thought-prompting) — تقنية الاستدلال وراء المعلمين الذكاء الاصطناعي السقراطيين كـKhanmigo',
            '[البرومبت المُقيَّد](/ar/prompt-engineering/constrained-prompting) — ضروري للتحكم في صيغة مخرجات الذكاء الاصطناعي في مواد الدروس',
            '[5 لبنات بناء يحتاجها كل برومبت](/ar/prompt-engineering/5-building-blocks-every-prompt-needs) — بنية البرومبت العالمية التي يُبنى عليها إطار البرومبت للمعلمين',
          ],
        },
        howToStart: {
          id: 'step-by-step-integrating-ai-into-your-teaching',
          ...
          numberedItems: [
            'حدّد أهداف التعلم والتقييمات قبل إدخال الذكاء الاصطناعي.',
            'استخدم الذكاء الاصطناعي للتدريب الشخصي والتغذية الراجعة الفورية، وليس لأحكام التقييم.',
            'علّم الطلاب كيفية التحقق من نتائج الذكاء الاصطناعي والكشف عن الهلوسات.',
            'أنشئ قالب برومبت منظماً يستخدمه الطلاب لجميع تفاعلات الذكاء الاصطناعي.',
            'ضع إرشادات واضحة حول استخدام الذكاء الاصطناعي لمهام محددة.',
          ],
        },
        faq: {
          id: 'faq',
        ...
        sources: {
          ...
          items: [
            '[Kestin & Miller، 2024. "AI Tutoring Outperforms Active Learning Classrooms — Harvard RCT"](https://www.nature.com/articles/s41598-025-97652-6) — تجربة عشوائية محكومة مع 194 طالباً؛ حجم التأثير 0.73–1.3 انحراف معياري',
            '[Kwak، 2025. "The Effectiveness of AI-Driven Tools in Improving Student Learning Outcomes"](https://iacis.org/iis/2025/4_iis_2025_233-247.pdf) — مراجعة منهجية لـ21 دراسة؛ مكاسب أداء 15–35٪؛ r = 0.781',
            '[قانون الذكاء الاصطناعي الأوروبي، 2024. الملحق الثالث — أنظمة الذكاء الاصطناعي عالية المخاطر في التعليم](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689) — يُصنّف ذكاء اصطناعي التقييم التعليمي عالي المخاطر مع متطلبات إشراف إلزامية',
          ],
        },
      },
    },
    pt: {
      specific_year: 2026,
      theme: 'Use Cases',
      heroImage: '/images/teaching-with-ai-overview-hero-pt.webp',
  ...
  freshness_tier: 'annual',
  theme: 'Use Cases',
  heroImage: '/images/teaching-with-ai-overview-hero-fr.webp',
  ...
  seoTitle: 'Enseigner avec l\'IA en 2026: Doubler les résultats',
  metaDescription: 'Étude Harvard : tutorat IA double résultats, 18 % moins de temps. Outils : Khanmigo, MagicSchool, Claude. Prompts sauvent 5–13 h/semaine. Guide loi IA.',
  ...
  ogDescription: '85 % des enseignants américains ont utilisé l\'IA en 2024–25 — mais des prompts vagues gaspillent du temps. Harvard a prouvé que le tutorat IA double les résultats. Voici le framework du prompt pédagogue à cinq composants plus la conformité loi IA de l\'UE pour les écoles.',
  twitterDescription: 'Tutorat IA : gains 2×, 18 % moins de temps d\'études (Harvard RCT, n=194). Meilleurs outils et framework de prompt pour enseignants.',
  toc: [
  ...
  faqSchema: {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'La réponse dépend de la tâche. Khanmigo (Khan Academy, alimenté par GPT-4) excelle pour le tutorat des élèves par questionnement socratique à 44 $/année. MagicSchool domine pour les outils de flux de travail pédagogique complets (plans d\'études, PEI, communication parentale). ChatGPT (GPT-5.6, OpenAI) offre la création de contenu universelle la plus flexible. Pour l\'analyse pédagogique complexe, Claude Sonnet 5 (Anthropic) traite 200 000 tokens — environ 160 pages standard — en une seule session.',
        },
      },
      {
        '@type': 'Question',
  ...
  itemListSchema: {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'ChatGPT / GPT-5.6', description: 'Création de contenu flexible et rédaction. Tous les niveaux, toutes les matières. Version gratuite limitée.' },
      { '@type': 'ListItem', position: 4, name: 'Claude Sonnet 5', description: 'Conception de plans d\'études à long terme, 200 000 tokens de contexte. Enseignement supérieur et tâches complexes. Version gratuite limitée.' },
  ...
  sections: {
    tldr: {
      ...
      items: [
        ...
        'En mai 2026, GPT-5.6, Claude Sonnet 5 (Anthropic) et Gemini 3.1 Pro supportent tous des fenêtres de contexte de 1 million tokens (~800 pages par session) — la taille de la fenêtre de contexte n\'est plus un différenciateur clé entre modèles frontière',
      ],
    },
    quickFacts: {
      title: '⚡ Faits rapides',
    ...
    definition: {
      ...
      content: [
        ...
        'Les systèmes tutoriels intelligents (STI) — la catégorie technique pour des outils comme Khanmigo — adaptent le niveau de difficulté, fournissent une rétroaction immédiate et guident les élèves par questionnement socratique plutôt que de donner des réponses directes. Les LLM universels (Large Language Models) comme GPT-5.6 (OpenAI) et Claude Sonnet 5 (Anthropic) gèrent la génération de plans d\'études, la création de rubriques et les matériels d\'enseignement différenciés. Les outils IA administratifs gèrent les résumés de présence, les brouillons de communication parentale et les rapports de progrès — les tâches que les enseignants signalent comme les plus exigeantes en temps.',
    ...
    toolComparison: {
      ...
      columns: ['Outil', 'Lien', 'Meilleur pour', 'Contexte', 'Version gratuite'],
      rows: [
        {
          'Outil': 'Khanmigo (Khan Academy)',
          'Lien': '[khanmigo.ai](https://www.khanmigo.ai)',
        ...
        },
        {
          ...
          'Lien': '[notebooklm.google.com](https://notebooklm.google.com)',
        ...
        },
        {
          ...
          'Lien': '[gemini.google.com](https://gemini.google.com)',
    ...
    assessmentPrompt: {
      ...
      content: [
        ...
        'La [fenêtre de contexte](/fr/prompt-engineering/context-windows-explained-why-ai-forgets) de 200 000 tokens de Claude Sonnet 5 traite des séries complètes de courts essais en une seule session — environ 160 pages standard — rendant la génération de rétroaction en lot pratique pour les enseignants avec de grandes classes. GPT-5.6 traite ~100 pages par session, suffisant pour les tailles de classe typiques.',
      ],
  ...
  freshness_tier: 'annual',
  theme: 'Use Cases',
  heroImage: '/images/teaching-with-ai-overview-hero-ja.webp',
  ...
  faqSchema: {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: '2026年の教師にとって最高のAIツール', acceptedAnswer: { '@type': 'Answer', text: '答えはタスクに依存します。Khanmigo（Khan Academy、GPT-4を搭載）は年44ドルでソクラテス的質問による生徒チューターに最適です。MagicSchool は完全な教育ワークフロー（カリキュラム、IEP、親通信）が充実しています。ChatGPT（GPT-5.6、OpenAI）は最も柔軟な汎用コンテンツ作成を提供します。複雑な教育分析にはClaude Sonnet 5（Anthropic）が200,000トークン処理します（約160ページ）。' } },
      ...
      { '@type': 'Question', name: 'AIは差別化教育を支援できるか', acceptedAnswer: { '@type': 'Answer', text: 'はい。これは教育AIの最強のユースケースです。LLMは同じコンテンツを複数の読解レベル（Flesch-Kincaid クラス4、8、12）に数秒で言い換えることができます。プロンプト構造：「このパッセージをクラス[N]レベルで言い直してください。すべてのファクト内容を保持してください。複雑な語彙をシンプルな同義語に置き換えてください。段落構造を保持してください。」Claude Sonnet 5が読解レベル間で最も一貫した差別化を生成します。' } },
  ...
  itemListSchema: {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'ChatGPT / GPT-5.6', description: '柔軟なコンテンツ作成と草案。すべてのレベル、すべての対象。限定無料版。' },
      { '@type': 'ListItem', position: 4, name: 'Claude Sonnet 5', description: '長形式カリキュラム設計、200,000トークンコンテキスト。高等教育と複雑タスク。限定無料版。' },
  ...
  sections: {
    tldr: {
      ...
      items: [
        ...
        'Claude Sonnet 5（Anthropic）、GPT-5.6（OpenAI）、Gemini 3.1 Pro（Google DeepMind）はすべて1セッションで100万トークン（約800ページ）処理できます—2026年5月時点でコンテキストウィンドウはもはやフロンティアモデル間の主要な差別化要因ではありません',
      ],
    },
    quickFacts: {
      title: '⚡ クイックファクト',
    ...
    definition: {
      ...
      content: [
        ...
        'インテリジェント先生システム（ITS）—Khanmigoのようなツール技術カテゴリー—は難易度を調整し、即座フィードバックを提供し、直接答えを与えるのではなくソクラテス的質問で生徒を導きます。汎用LLM（大言語モデル）、GPT-5.6（OpenAI）とClaude Sonnet 5（Anthropic）はカリキュラム生成、ルーブリック作成、差別化教材を処理します。管理AIツールは出席サマリ、親通信草案、進捗レポート—教師が最も時間消費と報告するタスク—を処理します。',
    ...
    toolComparison: {
      ...
      content: [
        ...
        'Khanmigo はKhan AcademyのAI先生アシスタント、GPT-4搭載。ソクラテス的質問を使って生徒を答えに導きます、直接答えを与えるのではなく—学習保持向けの重要な設計差。Khan Academy課に直接統合されるため、すでにこのプラットフォームを使う学校に最強のオプション。MagicSchool は最も完全な教師ツールセット—カリキュラム計画、クラス管理テンプレート、IEP作成支援、親通信ツール。ChatGPT（GPT-5.6）は最も柔軟な汎用サポートと最高の自律性を提供しますが、教室対応の結果を生むために教師の構造化プロンプトが必要。',
      ],
      callouts: [
        { type: '💡', label: 'プロティップ', text: '1つのツールがすべてを行いません。ほとんどの教師は2～3ツールを一緒に使用します：生徒チューター向けKhanmigo、計画向けMagicSchool、迅速なコンテンツ作成向けChatGPT。' },
      ],
      columns: ['ツール', 'リンク', '最適な用途', 'コンテキスト', '無料版'],
      rows: [
        { 'ツール': 'Khanmigo（Khan Academy）', 'リンク': '[khanmigo.ai](https://www.khanmigo.ai)', '最適な用途': '生徒チューター；ソクラテス的学習', 'コンテキスト': 'K-12、Khan Academy エコシステム', '無料版': '年$44' },
        { 'ツール': 'MagicSchool', 'リンク': '[magicschool.ai](https://www.magicschool.ai)', '最適な用途': '教育計画；教室管理', 'コンテキスト': 'K-12教師向け', '無料版': 'はい（限定）' },
        { 'ツール': 'ChatGPT / GPT-5.6（OpenAI）', 'リンク': '[chatgpt.com](https://chatgpt.com)', '最適な用途': '柔軟なコンテンツ作成；草案', 'コンテキスト': 'すべてのレベル、すべての対象', '無料版': 'はい（限定）' },
        { 'ツール': 'Claude Sonnet 5（Anthropic）', 'リンク': '[claude.ai](https://claude.ai)', '最適な用途': '長形式カリキュラム設計；文書分析', 'コンテキスト': '高等教育；複雑タスク', '無料版': 'はい（限定）' },
        { 'ツール': 'NotebookLM（Google DeepMind）', 'リンク': '[notebooklm.google.com](https://notebooklm.google.com)', '最適な用途': 'アップロード教室資料へのソースベースQ&A', 'コンテキスト': '大学；研究コンテキスト', '無料版': '無料 / Plus' },
        { 'ツール': 'Gemini 3.1 Pro（Google DeepMind）', 'リンク': '[gemini.google.com](https://gemini.google.com)', '最適な用途': '大型文書分析；ポリシー査閲', 'コンテキスト': '学区管理者向け', '無料版': 'はい（限定）' },
      ],
    },
    toolUseCaseMapping: {
      ...
      rows: [
        { 'ユースケース': 'カリキュラム計画作成', '推奨ツール': 'MagicSchool / GPT-5.6', '温度': '0.1–0.2', '時間節約': '教科30~60分' },
        { 'ユースケース': '差別化読解レベル', '推奨ツール': 'Claude Sonnet 5', '温度': '0.1–0.2', '時間節約': 'パッセージ当たり15分' },
        { 'ユースケース': '生徒チューター（ソクラテス的）', '推奨ツール': 'Khanmigo', '温度': 'n/a（プリセット）', '時間節約': '非同期' },
        { 'ユースケース': 'ルーブリック整列フィードバック', '推奨ツール': 'Claude Sonnet 5（200,000トークンコンテキスト）', '温度': '0.2', '時間節約': 'シリーズ当たり時間' },
        { 'ユースケース': '親通信草案', '推奨ツール': 'ChatGPT / GPT-5.6', '温度': '0.3–0.5', '時間節約': 'メッセージ当たり5~10分' },
    ...
    assessmentPrompt: {
      ...
      content: [
        ...
        'Claude Sonnet 5の[コンテキストウィンドウ](/ja/prompt-engineering/context-windows-explained-why-ai-forgets)（200,000トークン）は短いエッセイの完全シリーズを1セッションで処理します—約160標準ページ—大クラスを持つ教師向けにバッチフィードバック生成を実践的にしています。GPT-5.6は1セッション約100ページ処理し、典型的なクラスサイズに十分。',
      ],
    ...
    faq: {
      ...
      faqs: [
        ...
        { q: '2026年の教師にとって最高のAIツール', a: '答えはタスクに依存します。Khanmigo（Khan Academy、GPT-4を搭載）は年44ドルでソクラテス的質問による生徒チューターに最適です。MagicSchool は完全な教育ワークフロー（カリキュラム、IEP、親通信）が充実しています。ChatGPT（GPT-5.6、OpenAI）は最も柔軟な汎用コンテンツ作成を提供します。複雑な教育分析にはClaude Sonnet 5（Anthropic）が200,000トークン処理します（約160ページ）。' },
        ...
        { q: 'AIは差別化教育を支援できるか', a: 'はい。これは教育AIの最強のユースケースです。LLMは同じコンテンツを複数の読解レベル（Flesch-Kincaid クラス4、8、12）に数秒で言い換えることができます。プロンプト構造：「このパッセージをクラス[N]レベルで言い直してください。すべてのファクト内容を保持してください。複雑な語彙をシンプルな同義語に置き換えてください。段落構造を保持してください。」Claude Sonnet 5が読解レベル間で最も一貫した差別化を生成します。' },
    ...
    zh: {
      freshness_tier: 'annual',
      theme: '应用案例',
      heroImage: '/images/teaching-with-ai-overview-hero-zh.webp',
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: '答案取决于任务。Khanmigo（Khan Academy，GPT-4驱动）最适合通过苏格拉底式提问进行学生辅导，每年$44。MagicSchool在全面教师工作流工具中领先（课程计划、IEP、家长沟通）。ChatGPT（GPT-5.6，OpenAI）提供最灵活的通用内容生成。对于复杂课程分析，Claude Sonnet 5（Anthropic）在单个会话中处理200,000个令牌——约160个标准页面。',
            },
          },
          {
            '@type': 'Question',
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: '是的——这是AI最强的教育用例之一。LLM可以在数秒内将相同内容改写为多个阅读水平（Flesch-Kincaid等级4、8和12）。提示词结构：「将此段落改写为[N]年级阅读水平。保留所有事实内容。用更简单的同义词替换复杂词汇。保持相同的段落结构。」Claude Sonnet 5在各阅读水平间产生最一致的差异化。',
            },
          },
          {
            '@type': 'Question',
      ...
      sections: {
        tldr: {
          ...
          items: [
            ...
            '截至2026年5月，GPT-5.6、Claude Sonnet 5（Anthropic）和Gemini 3.1 Pro都支持100万令牌上下文窗口（约800页/会话）——上下文窗口大小不再是前沿模型间的主要差异',
          ],
        },
        quickFacts: {
          title: '⚡ 快速事实',
        ...
        toolComparison: {
          ...
          tableFormat: true,
          columns: ['工具', '链接', '定价', '最佳用途', '学习曲线', '高风险功能'],
          rows: [
            {
              '工具': 'Khanmigo',
              '链接': '[khanmigo.ai](https://www.khanmigo.ai)',
              '定价': '$44/年',
            ...
            {
              '工具': 'MagicSchool',
              '链接': '[magicschool.ai](https://www.magicschool.ai)',
              '定价': '$199/年',
              '最佳用途': '课程计划、差异化、IEP协助',
              '学习曲线': '低——针对教师的GUI',
              '高风险功能': '是；生成评估内容',
            ...
            {
              '工具': 'ChatGPT（GPT-5.6）',
              '链接': '[chatgpt.com](https://chatgpt.com)',
              '定价': '$20/月或按需',
              '最佳用途': '内容生成、论文反馈、研究摘要',
              '学习曲线': '中——提示词质量决定输出',
              '高风险功能': '是；用于评估反馈',
            ...
            {
              '工具': 'Gemini 3.1 Pro',
              '链接': '[gemini.google.com](https://gemini.google.com)',
              '定价': '免费+Pro',
            ...
            {
              '工具': 'NotebookLM',
              '链接': '[notebooklm.google.com](https://notebooklm.google.com)',
              '定价': '免费（谷歌）',
...
[选择一个：单个段落] / [3点项目符号] / [分步说明] / [对话脚本] / [Markdown大纲]`,
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: '2026年教师最好的AI工具是什么？', a: '答案取决于任务。Khanmigo（Khan Academy，GPT-4驱动）最适合通过苏格拉底式提问进行学生辅导，每年$44。MagicSchool在全面教师工作流工具中领先（课程计划、IEP、家长沟通）。ChatGPT（GPT-5.6，OpenAI）提供最灵活的通用内容生成。对于复杂课程分析，Claude Sonnet 5（Anthropic）在单个会话中处理200,000个令牌——约160个标准页面。' },
            ...
            { q: 'AI工具能帮助进行差异化教学吗？', a: '是的——这是AI最强的教育用例之一。LLM可以在数秒内将相同内容改写为多个阅读水平（Flesch-Kincaid等级4、8和12）。提示词结构：「将此段落改写为[N]年级阅读水平。保留所有事实内容。用更简单的同义词替换复杂词汇。保持相同的段落结构。」Claude Sonnet 5在各阅读水平间产生最一致的差异化。' },
  ...
  ko: {
      freshness_tier: 'annual',
      theme: 'Use Cases',
      heroImage: '/images/teaching-with-ai-overview-hero-ko.webp',
      ...
      dateModified: '2026-08-30',
      readTime: '8분 읽기',
      seoTitle: '2026년 AI를 활용한 교육: 학습 효과 2배 가이드',
      metaDescription: '하버드 연구: AI 튜터링은 학습 효과를 두 배로, 18% 시간 단축. 도구: Khanmigo, MagicSchool, Claude. 구조화된 프롬프트로 주당 5–13시간 절약. EU AI Act 지침 포함.',
      educationalLevel: '초급',
      ...
      twitterDescription: 'AI 튜터링: 학습 효과 2배, 학습 시간 18% 단축(하버드 RCT, n=194). 교사를 위한 최고의 도구 및 프롬프트 프레임워크.',
      toc: [
        { label: 'AI 교육 도구가 실제로 하는 일', anchor: '#what-ai-teaching-tools-actually-do' },
        { label: '2026년 교사가 사용해야 할 AI 도구는?', anchor: '#which-ai-tools-should-teachers-use-in-2026' },
        { label: '교육 과제에 맞는 프롬프트 작성 방법', anchor: '#how-to-write-prompts-for-teaching-tasks' },
        { label: '5가지 구성 요소 교사 프롬프트', anchor: '#the-five-component-teacher-prompt' },
        { label: '평가 피드백을 위한 AI 프롬프트 작성 방법', anchor: '#how-do-you-prompt-ai-for-assessment-feedback' },
        { label: 'AI 튜터링이 학습 성과를 향상시키는가?', anchor: '#does-ai-tutoring-improve-learning-outcomes' },
        { label: '학교에서 AI 부정행위는 얼마나 탐지 가능한가?', anchor: '#how-detectable-is-ai-cheating-in-schools' },
        { label: 'EU AI Act가 학교에 미치는 영향', anchor: '#how-does-the-eu-ai-act-affect-schools' },
      ...
      sections: {
        ...
        definition: {
          ...
          snippets: [
            { type: 'in-one-sentence', text: 'AI 교육 도구에는 튜터링 시스템(Khanmigo), 수업 계획 도구(ChatGPT, Claude), 행정 보조 도구가 포함되며, 각각 서로 다른 교실 과제에 최적화되어 있습니다.' },
          ],
        },
        toolComparison: {
          id: 'which-ai-tools-should-teachers-use-in-2026',
          ...
          callouts: [
            { type: '💡', label: '프로 팁', text: '어떤 단일 도구도 모든 것을 할 수 없습니다. 대부분의 교사는 2–3가지 도구를 조합하여 사용합니다: 학생 튜터링에는 Khanmigo, 계획에는 MagicSchool, 빠른 콘텐츠 생성에는 ChatGPT.' },
          ],
          columns: ['도구', '링크', '최적 용도', '맥락', '무료 티어'],
          rows: [
            {
              '도구': 'Khanmigo (Khan Academy)',
              '링크': '[khanmigo.ai](https://www.khanmigo.ai)',
              '최적 용도': '학생 튜터링; 소크라테스식 학습',
              '맥락': 'K-12, Khan Academy 생태계',
              '무료 티어': '$44/년',
            },
            {
              '도구': 'MagicSchool',
              '링크': '[magicschool.ai](https://www.magicschool.ai)',
              '최적 용도': '수업 계획; 교실 관리',
              '맥락': 'K-12 교사',
              '무료 티어': '예 (제한됨)',
            },
            {
              '도구': 'ChatGPT / GPT-5.6 (OpenAI)',
              '링크': '[chatgpt.com](https://chatgpt.com)',
              '최적 용도': '유연한 콘텐츠 생성; 초안 작성',
              '맥락': '모든 수준, 모든 과목',
              '무료 티어': '예 (제한됨)',
            },
            {
              '도구': 'Claude Sonnet 5 (Anthropic)',
              '링크': '[claude.ai](https://claude.ai)',
              '최적 용도': '심층 분석, 신중한 추론, 작문 품질',
              '맥락': '고등 교육 이상; 복잡한 과제',
              '무료 티어': '예 (제한됨)',
            },
            {
              '도구': 'NotebookLM (Google DeepMind)',
              '링크': '[notebooklm.google.com](https://notebooklm.google.com)',
              '최적 용도': '업로드된 강의 자료에 대한 출처 기반 Q&A',
              '맥락': '대학; 연구 맥락',
              '무료 티어': '무료 / Plus 티어',
            },
            {
              '도구': 'Gemini 3.1 Pro (Google DeepMind)',
              '링크': '[gemini.google.com](https://gemini.google.com)',
              '최적 용도': '대용량 문서 분석; 정책 검토',
              '맥락': '교육구 관리자',
              '무료 티어': '예 (제한됨)',
            },
          ],
        ...
        toolUseCaseMapping: {
          title: '교육에서의 AI: 사용 사례와 도구 매핑',
          content: [
            '**모든 도구가 모든 과제에 적합하지는 않습니다. 각 특정 사용 사례에 맞는 도구를 선택하세요 — 컨텍스트 창, temperature, 비용, 속도 등 다양한 제약 조건에서 서로 다른 모델이 탁월합니다.**',
          ],
          columns: ['사용 사례', '권장 도구', 'Temperature', '절약된 시간'],
          rows: [
            {
              '사용 사례': '수업 계획 작성',
              '권장 도구': 'MagicSchool / GPT-5.6',
              'Temperature': '0.1–0.2',
              '절약된 시간': '수업당 30–60분',
            },
            {
              '사용 사례': '차별화된 읽기 수준',
              '권장 도구': 'Claude Sonnet 5',
              'Temperature': '0.1–0.2',
              '절약된 시간': '지문당 15분',
            },
            {
              '사용 사례': '학생 튜터링 (소크라테스식)',
              '권장 도구': 'Khanmigo',
              'Temperature': 'n/a (사전 설정)',
              '절약된 시간': '비동기',
            },
            {
              '사용 사례': '루브릭 기반 피드백',
              '권장 도구': 'Claude Sonnet 5 (1M 컨텍스트)',
              'Temperature': '0.2',
              '절약된 시간': '학급 세트당 수 시간',
            },
            {
              '사용 사례': '학부모 소통 초안',
              '권장 도구': 'ChatGPT / GPT-5.6',
              'Temperature': '0.3–0.5',
              '절약된 시간': '메시지당 5–10분',
            },
            {
              '사용 사례': '교육과정 / 정책 검토',
              '권장 도구': 'Gemini 3.1 Pro (1M 컨텍스트)',
              'Temperature': '0.1',
              '절약된 시간': '문서당 수 시간',
            },
          ],
        ...
        promptFramework: {
          ...
          blockquote: '5학년생을 위한 분수 덧셈 수업을 만들어줘.',
          items: [
        ...
        goodExample: {
          ...
          blockquote: '당신은 경험 많은 5학년 수학 교사입니다. 분모가 다른 분수 덧셈에 관한 45분 수업을 만들어 주세요. 학생들은 동치 분수를 이해하지만 아직 결합하지 않았습니다. 포함 사항: 시각적 모델을 활용한 10분 워밍업, 3가지 풀이 예제가 포함된 15분 직접 교수, 15분 짝 연습, 5분 출구 카드. Common Core 5.NF.A.1에 맞추어 주세요. 섹션 헤더, 시간 배분, 자료 목록이 포함된 수업 계획만 출력하세요.',
          items: [
            '구조화된 버전은 루브릭에 맞는 섹션, 시간 배분된 활동, 자료 목록이 포함된 문서를 생성합니다. 수정이 아닌 사용 또는 정제 준비 완료.',
          ],
          callouts: [
            { type: '📌', label: '핵심 포인트', text: '5가지 구성 요소는: (1) 역할, (2) 목표, (3) 학생 맥락, (4) 제약 조건, (5) 출력 형식입니다. 이 5가지를 일관되게 사용하면 주당 5–13시간을 절약할 수 있습니다.' },
          ],
        },
        assessmentPrompt: {
          id: 'how-do-you-prompt-ai-for-assessment-feedback',
          ...
          callouts: [
            { type: '⚠️', label: '경고', text: 'AI는 목소리, 독창성, 주관적인 작문 품질을 신뢰할 수 있게 평가할 수 없습니다 — AI 피드백은 항상 전체적인 루브릭 점수가 아닌 기계적인 요소와 구조에 사용하십시오. 최종 종합 점수는 인간이 내리도록 하십시오.' },
          ],
        },
        learningOutcomes: {
          id: 'does-ai-tutoring-improve-learning-outcomes',
          ...
          callouts: [
            { type: '🔍', label: '알고 계셨나요?', text: '학생들은 AI 튜터링 세션에서 더 높은 참여도와 동기 부여를 보였습니다. 효과 크기(0.73–1.3 SD)는 일반적인 교실에서 상위 4분의 1 교수법으로 이동했을 때의 학습 효과와 동일합니다.' },
          ],
          items: [
        ...
        integrityProblem: {
          ...
          callouts: [
            { type: '⚠️', label: '경고', text: '비영어 원어민과 구조화된 작문 스타일을 가진 학생들은 불균형적으로 높은 비율로 표시됩니다. AI 탐지 결과만을 근거로 학생을 고발하면 15–30%의 허위 고발 위험이 있습니다.' },
          ],
        },
        integrityCloser: {
          content: [
        ...
        regulatoryContext: {
          ...
          callouts: [
            { type: '📌', label: '핵심 포인트', text: 'EU 학교는 AI 시스템과 함께 작업하는 모든 교사와 관리자에게 직원 AI 리터러시 교육을 실시해야 합니다(Article 4, 2025년부터 시행). 불준수 시 최대 €3천만의 벌금이 부과될 수 있습니다.' },
          ],
        },
        regulatoryRegionalContext: {
          title: '글로벌 교육 AI 규정',
        ...
        commonMistakes: {
          ...
          callouts: [
            { type: '🛠️', label: '모범 사례', text: '모든 AI 사용을 문서화하십시오: 어떤 도구, 어떤 설정(temperature, 컨텍스트), 어떤 과제. 이렇게 하면 준수(EU AI Act Article 6)를 위한 감사 추적이 만들어지고 시간이 지남에 따라 개선하는 데 도움이 됩니다.' },
          ],
        },
        relatedReading: {
          id: 'related-reading',
        ...
        faq: {
          ...
          faqs: [
            {
              q: 'AI 튜터가 실제로 학습 성과를 향상시키는가?',
              a: '네 — 증거는 강력합니다. 194명의 학부 물리학 학생을 대상으로 한 2024년 하버드 RCT에서 AI 튜터링은 능동적 학습 교실보다 0.73–1.3 표준편차의 효과 크기를 산출했으며, 학생들은 60분의 교실 시간 대비 49분 만에 더 높은 점수에 도달했습니다(p < 10−8). 21개의 연구에 대한 2025년 체계적 검토에서 AI 지원 학생들이 평가에서 전통적인 교육보다 15–35% 더 높은 성과를 냈습니다.',
            },
            {
              q: '2026년 교사를 위한 최고의 AI 도구는 무엇인가?',
              a: '답은 과제에 따라 다릅니다. Khanmigo(Khan Academy, GPT-4로 구동)는 연 $44에 소크라테스식 질문을 통한 학생 튜터링에 가장 강력합니다. MagicSchool은 포괄적인 교사 워크플로우 도구(수업 계획, IEP, 학부모 소통)에서 앞섭니다. ChatGPT(GPT-5.6, OpenAI)는 가장 유연한 범용 콘텐츠 생성을 제공합니다. 복잡한 교육과정 분석을 위해 Claude Sonnet 5(Anthropic)은 단일 세션에서 1M 토큰 — 약 800 표준 페이지 — 을 처리합니다.',
            },
            {
              q: 'AI는 교사의 주당 얼마나 많은 시간을 절약할 수 있는가?',
              a: '구체적이고 맥락이 풍부한 프롬프트는 일관되게 사용할 때 수업 계획 및 행정 업무에서 교사의 주당 5–13시간을 절약합니다. 가장 일반적인 시간 절약 응용은: 연구 및 콘텐츠 수집(교사의 44%), 수업 계획 작성(38%), 정보 요약(38%), 교실 자료 생성(37%)입니다.',
            },
            {
              q: 'EU 규정에 따라 교육에서 AI 사용은 합법인가?',
              a: '교육 평가나 학습 경로에 영향을 미치는 AI 시스템은 EU AI Act(Annex III)에 따라 고위험으로 분류됩니다. EU 학교는 직원 AI 리터러시 교육을 실시하고(Article 4, 2025년부터 시행), AI가 영향을 미친 평가에 대한 인간 감독을 유지하며, 학생 결과에 영향을 미치는 모든 AI 시스템에 대한 감사 추적을 확보해야 합니다. 교육 환경에서 감정 인식 AI는 법에 의해 전면 금지됩니다.',
            },
            {
              q: 'AI 탐지 소프트웨어가 학업 부정행위를 신뢰할 수 있게 탐지하는가?',
              a: '아니요 — 현재 AI 탐지 도구는 동료 검토 연구에서 15–30%의 위양성률을 보이므로, 100개의 합법적인 학생 제출물 중 최대 30개가 잘못 표시될 수 있습니다. 비영어 원어민과 구조화된 학술적 작문 스타일로 작성하는 학생들은 불균형적으로 높은 비율로 표시됩니다. 2026년 대학들은 금지 정책에서 공개 및 인용 프레임워크로 전환하고 있으며, AI 탐지를 결정적인 비위 증거가 아닌 여러 입력 중 하나로 취급하고 있습니다.',
            },
            {
              q: '수업 계획을 위한 AI temperature 설정은 어떻게 해야 하는가?',
              a: '사실적인 교육 콘텐츠 — 수업 계획, 평가 루브릭, 교육과정 정렬 — 에는 temperature를 0.1–0.2로 설정하십시오. 이렇게 하면 일관적이고 변동성이 낮은 결과물이 생성됩니다. 다양한 옵션이 목표인 창의적인 활동 아이디어를 생성할 때만 0.7–0.9를 사용하십시오. 대부분의 플랫폼에서 기본 temperature(0.7–1.0)는 창의적 작업을 위해 설계되었으며 교육 콘텐츠에서 사실적 오류를 증가시킵니다.',
            },
            {
              q: 'AI 도구가 차별화 교수법에 도움이 될 수 있는가?',
              a: '네 — 이것은 AI의 가장 강력한 교육적 사용 사례 중 하나입니다. LLM은 동일한 콘텐츠를 여러 읽기 수준(Flesch-Kincaid Grade 4, 8, 12)으로 순식간에 다시 작성할 수 있습니다. 프롬프트 구조: "이 지문을 [N]학년 읽기 수준으로 다시 작성하세요. 모든 사실적 내용을 유지하세요. 복잡한 어휘를 더 간단한 것으로 교체하세요. 동일한 단락 구조를 유지하세요." Claude Sonnet 5은 읽기 수준 전반에 걸쳐 가장 일관된 차별화를 제공합니다.',
            },
            {
              q: 'EU AI Act에 따라 학교는 직원 AI 리터러시를 어떻게 처리해야 하는가?',
              a: 'EU AI Act의 Article 4는 AI 배포자(학교 포함)가 AI 시스템과 함께 작업하는 모든 직원에게 충분한 AI 리터러시를 보장하도록 요구합니다 — 2025년부터 시행. 이것은 다음에 대한 교육을 의미합니다: AI가 어떻게 결정을 내리는지, 특정 도구의 오류율이 무엇인지, 인간 감독이 필요한 경우, AI가 영향을 미친 결정을 어떻게 문서화하는지. 학교는 감사 목적으로 이 교육을 문서화해야 합니다.',
            },
            {
              q: 'Khanmigo란 무엇이며 학생들을 위한 ChatGPT와 어떻게 다른가?',
              a: 'Khanmigo는 GPT-4로 구동되는 Khan Academy의 AI 교육 보조 도구입니다. 그 특징은 소크라테스식 질문입니다 — 직접 답변을 제공하는 대신 학생들을 답으로 안내합니다. 학생이 "답이 무엇인가요?"라고 물으면 Khanmigo는 안내 질문으로 응답합니다. 이 설계는 학습 유지를 촉진합니다. ChatGPT는 기본적으로 직접 답변을 제공하는데, 이는 효율적이지만 장기적인 학습을 생성하는 인지적 노력을 줄입니다. 학생 대면 튜터링에서는 Khanmigo의 교육학적 설계가 우월하며; 교사 콘텐츠 생성에서는 ChatGPT의 유연성이 이깁니다.',
            },
            {
              q: '학교의 AI 사용 정책을 어떻게 만드는가?',
              a: '효과적인 학교 AI 정책은 네 가지를 정의합니다: (1) AI가 허용되는 과제(브레인스토밍, 연습 문제, 초안 피드백), (2) 공개가 필요한 과제(AI 지원 에세이, 발표), (3) AI가 금지된 과제(최종 시험 답변, 표절), (4) AI 생성 콘텐츠의 귀속 방법. 도구 개발 속도를 감안하여 정책은 6개월마다 검토해야 합니다. EU 학교는 정책 문서에서 EU AI Act Article 4 직원 교육 요구 사항과 Annex III 고위험 시스템 의무를 추가로 다루어야 합니다.',
            },
          ],
        },
        sources: {
          ...
          items: [
            '[Kestin & Miller, 2024. "AI tutoring outperforms in-class active learning: an RCT"](https://www.nature.com/articles/s41598-025-97652-6) — 194명 학생을 대상으로 한 무작위 대조 시험; 효과 크기 0.73–1.3 SD',
            '[Kwak, 2025. "The Effectiveness of AI-Driven Tools in Improving Student Learning Outcomes"](https://iacis.org/iis/2025/4_iis_2025_233-247.pdf) — 21개 연구의 체계적 검토; 15–35% 성과 향상; r = 0.781',
            '[EU AI Act, 2024. Annex III — High-Risk AI Systems in Education](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689) — 교육 평가 AI를 의무적인 감독 요구 사항이 있는 고위험으로 분류',
          ],
        },
      },
    },
