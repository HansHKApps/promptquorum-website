...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      seoTitle: 'التدريس بالذكاء الاصطناعي في 2026: دليل ضعف التعلم',
      metaDescription: 'دراسة هارفارد: التدريس الفردي بالذكاء الاصطناعي يُضاعف التعلم في وقت أقل بـ18٪. الأدوات: Khanmigo وMagicSchool وClaude. مع دليل الاتحاد الأوروبي.',
