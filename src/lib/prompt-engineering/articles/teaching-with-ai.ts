...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    es: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          columns: ['Herramienta', 'Mejor para', 'Contexto', 'Versión gratuita'],
          rows: [
            { 'Herramienta': '[Khanmigo (Khan Academy)](https://www.khanmigo.ai)', 'Mejor para': 'Tutoría estudiantil; aprendizaje socrático', 'Contexto': 'K-12, ecosistema Khan Academy', 'Versión gratuita': '44 USD al año' },
            { 'Herramienta': '[MagicSchool](https://www.magicschool.ai)', 'Mejor para': 'Planificación de lecciones; gestión del aula', 'Contexto': 'Docentes de K-12', 'Versión gratuita': 'Sí (limitado)' },
            { 'Herramienta': '[ChatGPT / GPT-5.6 (OpenAI)](https://chatgpt.com)', 'Mejor para': 'Creación de contenido flexible; borradores', 'Contexto': 'Cualquier nivel, cualquier materia', 'Versión gratuita': 'Sí (limitado)' },
            { 'Herramienta': '[Claude Sonnet 5 (Anthropic)](https://claude.ai)', 'Mejor para': 'Diseño curricular de formato largo; análisis de documentos', 'Contexto': 'Universidad; tareas complejas', 'Versión gratuita': 'Sí (limitado)' },
            { 'Herramienta': '[NotebookLM (Google DeepMind)](https://notebooklm.google.com)', 'Mejor para': 'Preguntas y respuestas basadas en fuentes sobre materiales del aula cargados', 'Contexto': 'Universidad; contextos de investigación', 'Versión gratuita': 'Gratuito / nivel Plus' },
            { 'Herramienta': '[Gemini 3.1 Pro (Google DeepMind)](https://gemini.google.com)', 'Mejor para': 'Análisis de documentos grandes; revisión de políticas', 'Contexto': 'Administradores de distritos escolares', 'Versión gratuita': 'Sí (limitado)' },
          ],
        },
        toolUseCaseMapping: {
    ...
    ar: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          columns: ['الأداة', 'الأفضل لـ', 'السياق', 'نسخة مجانية'],
          rows: [
            { 'الأداة': '[Khanmigo (Khan Academy)](https://www.khanmigo.ai)', 'الأفضل لـ': 'تدريس الطلاب فردياً؛ التعلم السقراطي', 'السياق': 'K-12، نظيرة بيئة Khan Academy', 'نسخة مجانية': '44 دولار سنوياً' },
            { 'الأداة': '[MagicSchool](https://www.magicschool.ai)', 'الأفضل لـ': 'التخطيط للدروس؛ إدارة الفصل', 'السياق': 'معلمو K-12', 'نسخة مجانية': 'نعم (محدود)' },
            { 'الأداة': '[ChatGPT / GPT-5.6 (OpenAI)](https://chatgpt.com)', 'الأفضل لـ': 'إنشاء محتوى مرن؛ مسودات', 'السياق': 'أي مستوى، أي مادة', 'نسخة مجانية': 'نعم (محدود)' },
            { 'الأداة': '[Claude Sonnet 5 (Anthropic)](https://claude.ai)', 'الأفضل لـ': 'تصميم مناهج طويلة؛ تحليل مستندات', 'السياق': 'الجامعة؛ المهام المعقدة', 'نسخة مجانية': 'نعم (محدود)' },
            { 'الأداة': '[NotebookLM (Google DeepMind)](https://notebooklm.google.com)', 'الأفضل لـ': 'أسئلة وأجوبة مستندة إلى المصادر على مواد الفصل المُحمَّلة', 'السياق': 'الجامعة؛ سياقات البحث', 'نسخة مجانية': 'مجاني / مستوى Plus' },
            { 'الأداة': '[Gemini 3.1 Pro (Google DeepMind)](https://gemini.google.com)', 'الأفضل لـ': 'تحليل المستندات الكبيرة؛ مراجعة السياسات', 'السياق': 'مديرو المقاطعات المدرسية', 'نسخة مجانية': 'نعم (محدود)' },
          ],
        },
        toolUseCaseMapping: {
  ...
  sections: {
    ...
    toolComparison: {
      ...
      rows: [
        ...
        {
          'Outil': '[NotebookLM (Google DeepMind)](https://notebooklm.google.com)',
        ...
        {
          'Outil': '[Gemini 3.1 Pro (Google DeepMind)](https://gemini.google.com)',
  ...
  sections: {
    ...
    toolComparison: {
      ...
      rows: [
        { 'ツール': '[Khanmigo（Khan Academy）](https://www.khanmigo.ai)', '最適な用途': '生徒チューター；ソクラテス的学習', 'コンテキスト': 'K-12、Khan Academy エコシステム', '無料版': '年$44' },
        { 'ツール': '[MagicSchool](https://www.magicschool.ai)', '最適な用途': '教育計画；教室管理', 'コンテキスト': 'K-12教師向け', '無料版': 'はい（限定）' },
        { 'ツール': '[ChatGPT / GPT-5.6（OpenAI）](https://chatgpt.com)', '最適な用途': '柔軟なコンテンツ作成；草案', 'コンテキスト': 'すべてのレベル、すべての対象', '無料版': 'はい（限定）' },
        { 'ツール': '[Claude Sonnet 5（Anthropic）](https://claude.ai)', '最適な用途': '長形式カリキュラム設計；文書分析', 'コンテキスト': '高等教育；複雑タスク', '無料版': 'はい（限定）' },
        { 'ツール': '[NotebookLM（Google DeepMind）](https://notebooklm.google.com)', '最適な用途': 'アップロード教室資料へのソースベースQ&A', 'コンテキスト': '大学；研究コンテキスト', '無料版': '無料 / Plus' },
        { 'ツール': '[Gemini 3.1 Pro（Google DeepMind）](https://gemini.google.com)', '最適な用途': '大型文書分析；ポリシー査閲', 'コンテキスト': '学区管理者向け', '無料版': 'はい（限定）' },
      ],
    },
    toolUseCaseMapping: {
    ...
    zh: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          rows: [
            {
              '工具': '[Khanmigo](https://www.khanmigo.ai)',
              '定价': '$44/年',
            ...
            {
              '工具': '[MagicSchool](https://www.magicschool.ai)',
              '定价': '$199/年',
              '最佳用途': '课程计划、差异化、IEP协助',
              '学习曲线': '低——针对教师的GUI',
              '高风险功能': '是；生成评估内容',
            ...
            {
              '工具': '[ChatGPT（GPT-5.6）](https://chatgpt.com)',
              '定价': '$20/月或按需',
              '最佳用途': '内容生成、论文反馈、研究摘要',
              '学习曲线': '中——提示词质量决定输出',
              '高风险功能': '是；用于评估反馈',
            ...
            {
              '工具': '[Claude Sonnet 5](https://claude.ai)',
              '定价': '$20/月 Pro或按需',
            ...
            {
              '工具': '[Gemini 3.1 Pro](https://gemini.google.com)',
              '定价': '免费+Pro',
  ...
  ko: {
      ...
      sections: {
        ...
        toolComparison: {
          ...
          columns: ['도구', '최적 용도', '맥락', '무료 티어'],
          rows: [
            {
              '도구': '[Khanmigo (Khan Academy)](https://www.khanmigo.ai)',
              '최적 용도': '학생 튜터링; 소크라테스식 학습',
              '맥락': 'K-12, Khan Academy 생태계',
              '무료 티어': '$44/년',
            },
            {
              '도구': '[MagicSchool](https://www.magicschool.ai)',
              '최적 용도': '수업 계획; 교실 관리',
              '맥락': 'K-12 교사',
              '무료 티어': '예 (제한됨)',
            },
            {
              '도구': '[ChatGPT / GPT-5.6 (OpenAI)](https://chatgpt.com)',
              '최적 용도': '유연한 콘텐츠 생성; 초안 작성',
              '맥락': '모든 수준, 모든 과목',
              '무료 티어': '예 (제한됨)',
            },
            {
              '도구': '[Claude Sonnet 5 (Anthropic)](https://claude.ai)',
              '최적 용도': '심층 분석, 신중한 추론, 작문 품질',
              '맥락': '고등 교육 이상; 복잡한 과제',
              '무료 티어': '예 (제한됨)',
            },
            {
              '도구': '[NotebookLM (Google DeepMind)](https://notebooklm.google.com)',
              '최적 용도': '업로드된 강의 자료에 대한 출처 기반 Q&A',
              '맥락': '대학; 연구 맥락',
              '무료 티어': '무료 / Plus 티어',
            },
            {
              '도구': '[Gemini 3.1 Pro (Google DeepMind)](https://gemini.google.com)',
