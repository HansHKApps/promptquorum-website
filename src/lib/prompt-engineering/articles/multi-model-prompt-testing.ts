  ...
  pt: {
    ...
    sections: {
      ...
      related_reading: {
        ...
        items: [
          { title: 'Como avaliar e comparar modelos LLM', url: '/pt/prompt-engineering/evaluate-compare-llm-models' },
          { title: 'Testes e validação de prompts: suítes automatizadas para LLMs', url: '/pt/prompt-engineering/prompt-testing-validation' },
  ...
  ar: {
    ...
    sections: {
      ...
      related_reading: {
        ...
        items: [
          { title: 'كيفية تقييم نماذج LLM ومقارنتها', url: '/ar/prompt-engineering/evaluate-compare-llm-models' },
          { title: 'اختبار الـ prompt والتحقق منه: مجموعات اختبار تلقائية لنماذج LLM', url: '/ar/prompt-engineering/prompt-testing-validation' },
  ...
  ko: {
    ...
    sections: {
      ...
      related_reading: {
        ...
        title: '관련 자료',
        items: [
          { title: 'LLM 모델 평가 및 비교 방법', url: '/ko/prompt-engineering/evaluate-compare-llm-models' },
          { title: '프롬프트 테스트 및 검증: LLM을 위한 자동화된 테스트 스위트', url: '/ko/prompt-engineering/prompt-testing-validation' },
