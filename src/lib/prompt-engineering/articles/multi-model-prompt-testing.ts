...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'اختبار النماذج المتعددة: GPT-5.5، Claude، Gemini',
    metaDescription: 'اختبار الـ prompt متعدد النماذج: لماذا تختلف المخرجات في GPT-5.5 وClaude 4.6 وGemini 2.5. أنشئ مصفوفة اختبار وقيّم النتائج مع PromptQuorum.',
