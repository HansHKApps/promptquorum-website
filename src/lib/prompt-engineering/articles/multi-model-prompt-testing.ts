...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  es: {
    ...
    schema: {
      '@context': 'https://schema.org',
      '@type': 'TechArticle',
      url: 'https://www.promptquorum.com/prompt-engineering/multi-model-prompt-testing?lang=es',
      ...
      image: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/api/og/multi-model-prompt-testing?lang=es', width: 1200, height: 630 },
    ...
    sections: {
      ...
      related_reading: {
        ...
        items: [
          { title: 'Cómo evaluar y comparar modelos LLM', url: '/prompt-engineering/evaluate-compare-llm-models?lang=es' },
          { title: 'Pruebas y validación de prompts: suites automatizadas para LLMs', url: '/prompt-engineering/prompt-testing-validation?lang=es' },
          { title: 'Introducción a Promptfoo: probar prompts localmente y en CI/CD', url: '/prompt-engineering/promptfoo-testing?lang=es' },
          { title: 'Cuándo usar puntuación de consenso entre múltiples modelos', url: '/prompt-engineering/consensus-scoring-llm?lang=es' },
          { title: 'Optimización de costes: elegir entre GPT-4o, Claude y Gemini', url: '/prompt-engineering/cost-optimization-model-selection?lang=es' },
        ],
      },
      sources: {
        id: 'sources',
