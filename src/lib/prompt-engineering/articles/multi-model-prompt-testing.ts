  ...
  de: {
    ...
    sections: {
      ...
      related_reading: {
        ...
        items: [
          { title: 'Wie man LLM-Modelle evaluiert und vergleicht', url: '/prompt-engineering/evaluate-compare-llm-models?lang=de' },
          ...
          { title: 'Einführung in Promptfoo: Prompts lokal und in CI/CD testen', url: '/prompt-engineering/promptfoo-testing?lang=de' },
          { title: 'Wann Konsens-Scoring über mehrere Modelle einsetzen', url: '/prompt-engineering/consensus-scoring-llm?lang=de' },
          { title: 'Kostenoptimierung: Auswahl zwischen GPT-4o, Claude und Gemini', url: '/prompt-engineering/cost-optimization-model-selection?lang=de' },
        ],
      },
      sources: {
        id: 'sources',
  ...
  fr: {
    ...
    sections: {
      ...
      related_reading: {
        ...
        items: [
          { title: 'Comment évaluer et comparer les modèles LLM', url: '/prompt-engineering/evaluate-compare-llm-models?lang=fr' },
          { title: 'Tests et validation de prompts : test suites pour LLMs', url: '/prompt-engineering/prompt-testing-validation?lang=fr' },
          { title: 'Introduction à Promptfoo : tester les prompts localement et en CI/CD', url: '/prompt-engineering/promptfoo-testing?lang=fr' },
          { title: 'Quand utiliser le scoring par consensus entre modèles', url: '/prompt-engineering/consensus-scoring-llm?lang=fr' },
          { title: 'Optimisation des coûts : choisir entre GPT-4o, Claude et Gemini', url: '/prompt-engineering/cost-optimization-model-selection?lang=fr' },
        ],
      },
      sources: {
        id: 'sources',
  ...
  ja: {
    ...
    sections: {
      ...
      related_reading: {
        ...
        title: '関連資料',
        items: [
          { title: 'LLMモデルの評価と比較方法', url: '/prompt-engineering/evaluate-compare-llm-models?lang=ja' },
          { title: 'プロンプトテストと検証：LLM向けテストスイート自動化', url: '/prompt-engineering/prompt-testing-validation?lang=ja' },
          { title: 'Promptfoo入門：ローカルとCI/CDでのPromptテスト', url: '/prompt-engineering/promptfoo-testing?lang=ja' },
          { title: '複数モデル間でコンセンサススコアリングを使用する時期', url: '/prompt-engineering/consensus-scoring-llm?lang=ja' },
          { title: 'コスト最適化：GPT-4o、Claude、Gemini選択ガイド', url: '/prompt-engineering/cost-optimization-model-selection?lang=ja' },
        ],
      },
      sources: {
        id: 'sources',
