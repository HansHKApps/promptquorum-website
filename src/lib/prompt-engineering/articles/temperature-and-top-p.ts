...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      current_models_mentioned: ['GPT-5.6', 'Claude Opus 5', 'Claude Sonnet 5', 'Claude Fable 5.1', 'Gemini 3.1 Pro'],
      theme: 'Fundamentals',
        ...
        faqs: {
          faqs: [
            ...
            },
            {
              ...
              a: 'More than slightly — one of them no longer takes the setting at all. Claude Opus 5 (like Claude Sonnet 5 and Claude Fable 5.1) rejects any non-default temperature or top-p outright. Gemini 3.1 Pro still exposes both through generationConfig and behaves reasonably at 0.5–0.7. GPT-5.6 accepts the full range on its non-reasoning endpoints but refuses non-default values in reasoning mode. Test the exact model and mode you are calling.',
            },
            {
      ...
      sections: {
        ...
        providerLimits: {
          ...
          content: [
            ...
            '**Anthropic:** en Claude Opus 5, Claude Sonnet 5 y Claude Fable 5.1 (y en Claude Opus 4.7 y 4.8), un valor de temperature, top_p o top_k distinto del predeterminado devuelve un error 400 en cada petición, no solo con el razonamiento activado. En los modelos Claude anteriores la restricción se aplica solo mientras el razonamiento está activo, donde top_p se acepta entre 0.95 y 1.0.',
      ...
      sections: {
        ...
        providerLimits: {
          ...
          content: [
            ...
            '**Anthropic:** في Claude Opus 5 وClaude Sonnet 5 وClaude Fable 5.1 (وكذلك Claude Opus 4.7 و4.8)، تؤدي أي قيمة غير افتراضية لـ temperature أو top_p أو top_k إلى خطأ 400 في كل طلب — وليس فقط عند تفعيل التفكير. أما في نماذج Claude الأقدم فيسري القيد أثناء التفكير فقط، ويُقبل فيه top_p بين 0.95 و1.0.',
      ...
      sections: {
        ...
        providerLimits: {
          ...
          content: [
            ...
            '**Anthropic：** 在 Claude Opus 5、Claude Sonnet 5 和 Claude Fable 5.1（以及 Claude Opus 4.7 和 4.8）上，非默认的 temperature、top_p 或 top_k 会让每一次请求都返回 400 错误——不仅仅是在开启思考时。在更早的 Claude 模型上，该限制只在思考开启期间生效，此时 top_p 可接受 0.95 到 1.0 之间的值。',
        ...
        faqs: {
          faqs: [
            ...
            { q: 'GPT-5.6、Claude Opus 5和Gemini 3.1 Pro之间的推荐设置是否不同？', a: '不止是“略有不同”——其中一个已经完全不接受这个设置。Claude Opus 5（以及 Claude Sonnet 5 和 Claude Fable 5.1）会直接拒绝任何非默认的温度或 Top-P。Gemini 3.1 Pro 仍然通过 generationConfig 开放两者，在 0.5–0.7 之间表现稳妥。GPT-5.6 在非推理端点上接受完整范围，但在推理模式下拒绝非默认值。请按你实际调用的模型和模式来测试。' },
      ...
      sections: {
        ...
        providerLimits: {
          ...
          content: [
            ...
            '**Anthropic:** Claude Opus 5, Claude Sonnet 5, Claude Fable 5.1(그리고 Claude Opus 4.7과 4.8)에서는 기본값이 아닌 temperature, top_p, top_k가 모든 요청에서 400 오류를 반환합니다. 사고 기능이 켜져 있을 때만이 아닙니다. 이전 Claude 모델에서는 이 제한이 사고가 활성화된 동안에만 적용되며, 이때 top_p는 0.95에서 1.0 사이에서 허용됩니다.',
        ...
        faqs: {
          faqs: [
            ...
            },
            {
              ...
              a: '약간이 아니라 셋 중 하나는 아예 이 설정을 받지 않습니다. Claude Opus 5(그리고 Claude Sonnet 5, Claude Fable 5.1)는 기본값이 아닌 temperature나 top-p를 그대로 거부합니다. Gemini 3.1 Pro는 여전히 generationConfig로 두 값을 제공하며 0.5–0.7에서 무난하게 동작합니다. GPT-5.6는 추론을 쓰지 않는 엔드포인트에서는 전체 범위를 받아들이지만, 추론 모드에서는 기본값이 아닌 값을 거부합니다. 실제로 호출할 모델과 모드를 그대로 테스트하십시오.',
            },
            {
