...
export const article: Partial<Record<Language, PEArticle>> = {
      ...
      sections: {
        ...
        faqs: {
          faqs: [
            ...
            {
              q: 'Do recommended settings differ between GPT-4o, Claude Opus 4.7, and Gemini 1.5 Pro?',
              a: 'Slightly. All three behave reasonably at temperature 0.5–0.7, but their tolerance for higher temperatures varies. GPT-4o can go higher without becoming incoherent; Claude Opus 4.7 is very stable; Gemini 1.5 Pro is more experimental. Test your actual model.',
            },
            {
      ...
      sections: {
        ...
        promptquorum: {
          ...
          content: [
            ...
            '**Multi-Modell-Vergleiche:** Sende einen Prompt mit verschiedenen Temperatur-/Top-P-Einstellungen über 25+ Modelle (GPT-4o, Claude Opus 4.7, Gemini 1.5 Pro, Mistral, lokale Ollama-Modelle) in einem einzigen Versand. Sieh sofort, welches Modell bei höherer Temperatur stabil bleibt und welches die beste kreative Ausgabe bei deiner Zieleinstellung erzeugt.',
        ...
        faqs: {
          faqs: [
            ...
            { q: 'Unterscheiden sich die empfohlenen Einstellungen zwischen GPT-4o, Claude Opus 4.7 und Gemini 1.5 Pro?', a: 'Leicht. Alle drei verhalten sich angemessen bei Temperatur 0.5–0.7, aber ihre Toleranz für höhere Temperaturen variiert. GPT-4o kann höher gehen ohne unzusammenhängend zu werden; Claude Opus 4.7 ist sehr stabil; Gemini 1.5 Pro ist experimenteller. Teste dein tatsächliches Modell.' },
    ...
    es: {
      ...
      schema: {
        ...
        datePublished: '2026-03-22',
        dateModified: '2026-03-22',
        url: 'https://www.promptquorum.com/prompt-engineering/temperature-and-top-p-control-ai-creativity?lang=es',
        inLanguage: 'es',
        author: { '@type': 'Person', name: 'Hans Kuepper', url: 'https://www.promptquorum.com/about' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } },
        keywords: ['temperatura', 'top-p', 'nucleus sampling', 'aleatoriedad de IA', 'configuración LLM', 'creatividad', 'GPT-4o', 'Claude', 'Gemini'],
      },
      gammaEmbedUrl: '/presentations/temperature-and-top-p-static.html',
      ...
      sections: {
        ...
        promptquorum: {
          ...
          content: [
            ...
            '**Comparaciones multi-modelo:** Envía un prompt con diferentes configuraciones de temperatura/top-p a más de 25 modelos (GPT-4o, Claude Opus 4.7, Gemini 1.5 Pro, Mistral, modelos Ollama locales) en un solo envío. Ve inmediatamente qué modelo permanece estable a mayor temperatura y cuál produce el mejor output creativo en tu configuración objetivo.',
        ...
        mistakes: {
          ...
          items: [
            ...
            '**Olvidar que los modelos interpretan los mismos valores de forma diferente.** Temperatura 0.7 en Claude se siente diferente a 0.7 en GPT-4o. Siempre prueba tu modelo real.',
        ...
        faqs: {
          faqs: [
            ...
            { q: '¿Difieren las configuraciones recomendadas entre GPT-4o, Claude Opus 4.7 y Gemini 1.5 Pro?', a: 'Ligeramente. Los tres se comportan razonablemente con temperatura 0.5–0.7, pero su tolerancia a temperaturas más altas varía. GPT-4o puede ir más alto sin volverse incoherente; Claude Opus 4.7 es muy estable; Gemini 1.5 Pro es más experimental. Prueba tu modelo real.' },
        ...
        relatedReading: {
          content: [
            '[¿Qué es el Prompt Engineering?](/prompt-engineering/what-is-prompt-engineering?lang=es) — por qué la estructura del prompt importa más que los parámetros',
            '[Los 5 bloques de construcción que todo prompt necesita](/prompt-engineering/5-building-blocks-every-prompt-needs?lang=es) — cómo estructurar los prompts antes de ajustar los parámetros',
            '[Alucinaciones de IA: Por qué la IA inventa cosas](/prompt-engineering/ai-hallucinations-why-ai-makes-things-up?lang=es) — por qué la temperatura más baja no elimina las alucinaciones',
          ],
        },
      ...
      sections: {
        ...
        promptquorum: {
          ...
          content: [
            ...
            '**Comparaisons multi-modèles :** Envoie un prompt à différents paramètres de température/top-p sur 25+ modèles (GPT-4o, Claude Opus 4.7, Gemini 1.5 Pro, Mistral, modèles locaux Ollama) en une seule expédition. Vois instantanément quel modèle reste stable à une température plus élevée et quel modèle offre le meilleur résultat créatif à ton paramètre cible.',
        ...
        faqs: {
          faqs: [
            ...
            { q: 'Les paramètres recommandés diffèrent-ils entre GPT-4o, Claude Opus 4.7 et Gemini 1.5 Pro ?', a: 'Légèrement. Tous les trois se comportent raisonnablement à température 0.5–0.7, mais leur tolérance aux températures plus élevées varie. GPT-4o peut aller plus haut sans devenir incohérent ; Claude Opus 4.7 est très stable ; Gemini 1.5 Pro est plus expérimental. Teste ton modèle réel.' },
    ...
    ja: {
      ...
      metaDescription: '温度は0.0〜2.0でAI出力のランダム性を制御し、Top-Pは0.1〜1.0で語彙選択の幅を調整します。コードには低温度（0.1〜0.3）、ブレーンストーミングには高温度（0.8以上）を推奨します。GPT-4o、Claude Opus 4.7、Gemini 1.5 Proで確認済みの設定値を提供します。',
      publishDate: '2026-03-22',
      readTime: '10分で読める',
      educationalLevel: 'Intermediate',
      schema: {
      ...
      sections: {
        ...
        faqs: {
          faqs: [
            ...
            { q: 'GPT-4o、Claude Opus 4.7、Gemini 1.5 Proで推奨設定が異なりますか？', a: 'わずかに。すべて3つは温度0.5–0.7で妥当に振舞いますが、高い温度の公差は異なります。GPT-4oはより高くなっても無意味にならずに行くことができます；Claude Opus 4.7は非常に安定しています；Gemini 1.5 Proはより実験的です。実際のモデルをテストしてください。' },
    ...
    zh: {
      ...
      metaDescription: '温度参数范围0至2控制AI输出的随机程度，Top-P参数范围0.1至1.0决定模型考虑的词汇选项范围。代码生成推荐低温度（0.1至0.3），头脑风暴推荐高温度（0.8以上）。GPT-4o、Claude Opus 4.7和Gemini 1.5 Pro均已完整验证以上参数设置效果。',
      publishDate: '2026-03-22',
      readTime: '阅读约10分钟',
      educationalLevel: 'Intermediate',
      schema: {
      ...
      sections: {
        ...
        faqs: {
          faqs: [
            ...
            { q: 'GPT-4o、Claude Opus 4.7和Gemini 1.5 Pro之间的推荐设置是否不同？', a: '略有不同。全部三个在温度0.5–0.7下表现合理，但对较高温度的容限不同。GPT-4o可以走得更高而不变成不连贯；Claude Opus 4.7非常稳定；Gemini 1.5 Pro更多实验性。测试您的实际模型。' },
