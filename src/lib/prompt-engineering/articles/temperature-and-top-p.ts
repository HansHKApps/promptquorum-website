...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    es: {
      ...
      schema: {
        ...
        datePublished: '2026-03-22',
        dateModified: '2026-03-22',
        url: 'https://www.promptquorum.com/es/es/prompt-engineering/temperature-and-top-p-control-ai-creativity',
        inLanguage: 'es',
        author: { '@type': 'Person', name: 'Hans Kuepper', url: 'https://www.promptquorum.com/about' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } },
    ...
    ar: {
      ...
      publishDate: '2026-03-22',
      seoTitle: 'درجة الحرارة وTop-P 2026: اضبط الإبداع والدقة',
      metaDescription: 'درجة الحرارة من 0 إلى 2 وTop-P من 0.1 إلى 1.0: حدّد عشوائية الذكاء الاصطناعي للكود والملخصات والعصف الذهني. نطاقات عملية لـ ChatGPT وClaude وGemini.',
