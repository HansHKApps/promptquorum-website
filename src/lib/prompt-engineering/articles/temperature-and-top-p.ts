...
export const article: Record<Language, PEArticle> = {
      ...
      sections: {
        ...
        faqs: {
          faqs: [
            ...
            {
              q: 'Do recommended settings differ between GPT-5.5, Claude Opus 4.7, and Gemini 1.5 Pro?',
              a: 'Slightly. All three behave reasonably at temperature 0.5–0.7, but their tolerance for higher temperatures varies. GPT-5.5 can go higher without becoming incoherent; Claude Opus 4.7 is very stable; Gemini 1.5 Pro is more experimental. Test your actual model.',
            },
            {
      ...
      sections: {
        ...
        promptquorum: {
          ...
          content: [
            ...
            '**Multi-Modell-Vergleiche:** Sende einen Prompt mit verschiedenen Temperatur-/Top-P-Einstellungen über 25+ Modelle (GPT-5.5, Claude Opus 4.7, Gemini 1.5 Pro, Mistral, lokale Ollama-Modelle) in einem einzigen Versand. Sieh sofort, welches Modell bei höherer Temperatur stabil bleibt und welches die beste kreative Ausgabe bei deiner Zieleinstellung erzeugt.',
        ...
        faqs: {
          faqs: [
            ...
            { q: 'Unterscheiden sich die empfohlenen Einstellungen zwischen GPT-5.5, Claude Opus 4.7 und Gemini 1.5 Pro?', a: 'Leicht. Alle drei verhalten sich angemessen bei Temperatur 0.5–0.7, aber ihre Toleranz für höhere Temperaturen variiert. GPT-5.5 kann höher gehen ohne unzusammenhängend zu werden; Claude Opus 4.7 ist sehr stabil; Gemini 1.5 Pro ist experimenteller. Teste dein tatsächliches Modell.' },
      ...
      sections: {
        ...
        promptquorum: {
          ...
          content: [
            ...
            '**Comparaisons multi-modèles :** Envoie un prompt à différents paramètres de température/top-p sur 25+ modèles (GPT-5.5, Claude Opus 4.7, Gemini 1.5 Pro, Mistral, modèles locaux Ollama) en une seule expédition. Vois instantanément quel modèle reste stable à une température plus élevée et quel modèle offre le meilleur résultat créatif à ton paramètre cible.',
        ...
        faqs: {
          faqs: [
            ...
            { q: 'Les paramètres recommandés diffèrent-ils entre GPT-5.5, Claude Opus 4.7 et Gemini 1.5 Pro ?', a: 'Légèrement. Tous les trois se comportent raisonnablement à température 0.5–0.7, mais leur tolérance aux températures plus élevées varie. GPT-5.5 peut aller plus haut sans devenir incohérent ; Claude Opus 4.7 est très stable ; Gemini 1.5 Pro est plus expérimental. Teste ton modèle réel.' },
    ...
    ja: {
      ...
      metaDescription: '温度は0.0〜2.0でAI出力のランダム性を制御し、Top-Pは0.1〜1.0で語彙選択の幅を調整します。コードには低温度（0.1〜0.3）、ブレーンストーミングには高温度（0.8以上）を推奨します。GPT-5.5、Claude Opus 4.7、Gemini 1.5 Proで確認済みの設定値を提供します。',
      publishDate: '2026-03-22',
      readTime: '10分で読める',
      educationalLevel: 'Intermediate',
      schema: {
      ...
      sections: {
        ...
        promptquorum: {
          ...
          content: [
            ...
            '**マルチモデル比較：** 1つのプロンプトを異なる温度/Top-P設定で25以上のモデル（GPT-5.5、Claude Opus 4.7、Gemini 1.5 Pro、Mistral、ローカルOllamaモデル）に送信します。どのモデルが高温度でも安定しているか、ターゲット設定で最適な創造的出力を提供するかをすぐに確認できます。',
        ...
        faqs: {
          faqs: [
            ...
            { q: 'GPT-5.5、Claude Opus 4.7、Gemini 1.5 Proで推奨設定が異なりますか？', a: 'わずかに。すべて3つは温度0.5–0.7で妥当に振舞いますが、高い温度の公差は異なります。GPT-5.5はより高くなっても無意味にならずに行くことができます；Claude Opus 4.7は非常に安定しています；Gemini 1.5 Proはより実験的です。実際のモデルをテストしてください。' },
    ...
    zh: {
      ...
      metaDescription: '温度参数范围0至2控制AI输出的随机程度，Top-P参数范围0.1至1.0决定模型考虑的词汇选项范围。代码生成推荐低温度（0.1至0.3），头脑风暴推荐高温度（0.8以上）。GPT-5.5、Claude Opus 4.7和Gemini 1.5 Pro均已完整验证以上参数设置效果。',
      publishDate: '2026-03-22',
      readTime: '阅读约10分钟',
      educationalLevel: 'Intermediate',
      schema: {
      ...
      sections: {
        ...
        promptquorum: {
          ...
          content: [
            ...
            '**多模型比较：** 在一次分发中跨25+个模型（GPT-5.5、Claude Opus 4.7、Gemini 1.5 Pro、Mistral、本地Ollama模型）发送一个不同温度/Top-P设置的提示。立即看到哪个模型在较高温度下保持稳定，哪个在您的目标设置下提供最佳创意输出。',
        ...
        faqs: {
          faqs: [
            ...
            { q: 'GPT-5.5、Claude Opus 4.7和Gemini 1.5 Pro之间的推荐设置是否不同？', a: '略有不同。全部三个在温度0.5–0.7下表现合理，但对较高温度的容限不同。GPT-5.5可以走得更高而不变成不连贯；Claude Opus 4.7非常稳定；Gemini 1.5 Pro更多实验性。测试您的实际模型。' },
