...
export const article: Partial<Record<Language, PEArticle>> = {
      ...
      sections: {
        ...
        faqs: {
          faqs: [
            ...
            {
              q: 'Do recommended settings differ between GPT-5.6, Claude Opus 4.8, and Gemini 3.1 Pro?',
              a: 'Slightly. All three behave reasonably at temperature 0.5–0.7, but their tolerance for higher temperatures varies. GPT-5.6 can go higher without becoming incoherent; Claude Opus 4.8 is very stable; Gemini 3.1 Pro is more experimental. Test your actual model.',
            },
            {
      ...
      sections: {
        ...
        promptquorum: {
          ...
          content: [
            ...
            '**Multi-Modell-Vergleiche:** Sende einen Prompt mit verschiedenen Temperatur-/Top-P-Einstellungen über 25+ Modelle (GPT-5.6, Claude Opus 4.8, Gemini 3.1 Pro, Mistral, lokale Ollama-Modelle) in einem einzigen Versand. Sieh sofort, welches Modell bei höherer Temperatur stabil bleibt und welches die beste kreative Ausgabe bei deiner Zieleinstellung erzeugt.',
        ...
        faqs: {
          faqs: [
            ...
            { q: 'Unterscheiden sich die empfohlenen Einstellungen zwischen GPT-5.6, Claude Opus 4.8 und Gemini 3.1 Pro?', a: 'Leicht. Alle drei verhalten sich angemessen bei Temperatur 0.5–0.7, aber ihre Toleranz für höhere Temperaturen variiert. GPT-5.6 kann höher gehen ohne unzusammenhängend zu werden; Claude Opus 4.8 ist sehr stabil; Gemini 3.1 Pro ist experimenteller. Teste dein tatsächliches Modell.' },
      ...
      sections: {
        ...
        promptquorum: {
          ...
          content: [
            ...
            '**Comparaciones multi-modelo:** Envía un prompt con diferentes configuraciones de temperatura/top-p a más de 25 modelos (GPT-5.6, Claude Opus 4.8, Gemini 3.1 Pro, Mistral, modelos Ollama locales) en un solo envío. Ve inmediatamente qué modelo permanece estable a mayor temperatura y cuál produce el mejor output creativo en tu configuración objetivo.',
        ...
        faqs: {
          faqs: [
            ...
            { q: '¿Difieren las configuraciones recomendadas entre GPT-5.6, Claude Opus 4.8 y Gemini 3.1 Pro?', a: 'Ligeramente. Los tres se comportan razonablemente con temperatura 0.5–0.7, pero su tolerancia a temperaturas más altas varía. GPT-5.6 puede ir más alto sin volverse incoherente; Claude Opus 4.8 es muy estable; Gemini 3.1 Pro es más experimental. Prueba tu modelo real.' },
      ...
      sections: {
        ...
        promptquorum: {
          ...
          content: [
            ...
            '**مقارنات متعددة النماذج:** أرسل طلبًا بإعدادات درجة حرارة/top-p مختلفة إلى أكثر من 25 نموذجًا (GPT-5.6، Claude Opus 4.8، Gemini 3.1 Pro، Mistral، نماذج Ollama المحلية) في إرسال واحد. شاهد فورًا أيٌّ من النماذج يبقى مستقرًا عند درجة حرارة أعلى وأيٌّها يُنتج أفضل مخرجات إبداعية عند إعدادك المستهدف.',
        ...
        faqs: {
          faqs: [
            ...
            { q: 'هل تختلف الإعدادات الموصى بها بين GPT-5.6 وClaude Opus 4.8 وGemini 3.1 Pro؟', a: 'قليلًا. الثلاثة تتصرف بشكل معقول عند درجة الحرارة 0.5–0.7، لكن تحمّلها لدرجات الحرارة المرتفعة يتفاوت. GPT-5.6 يمكنه الذهاب أعلى دون أن يصبح غير متماسك؛ Claude Opus 4.8 مستقر جدًا؛ Gemini 3.1 Pro أكثر تجريبيًا. اختبر نموذجك الفعلي.' },
      ...
      sections: {
        ...
        promptsAndParams: {
          ...
          content: [
            ...
            'O fluxo de trabalho correto é: (1) Elabore o prompt primeiro com tarefa clara, contexto, restrições e formato de saída. (2) Teste na sua temperatura/top-p alvo. (3) Só ajuste os controles se precisar de mais ou menos variação depois que o prompt estiver sólido.',
            'O mesmo prompt em temperaturas diferentes produz estilos muito diferentes. Na temperatura 0,2, as saídas são seguras e diretas. Na temperatura 0,8, as saídas são criativas e poéticas. Nenhuma é "melhor" — depende da voz da sua marca e do seu caso de uso.',
          ],
        },
        example: {
        ...
        risk: {
          ...
          content: [
            ...
            'Para tarefas fundamentadas em fatos, considere combinar temperatura mais baixa com RAG ou restrições explícitas de fonte para reduzir ainda mais os erros.',
          ],
        },
        promptquorum: {
          ...
          content: [
            ...
            '**Comparações multi-modelo:** Envie um prompt com diferentes configurações de temperatura/top-p para mais de 25 modelos (GPT-5.6, Claude Opus 4.8, Gemini 3.1 Pro, Mistral, modelos Ollama locais) em um único envio. Veja instantaneamente qual modelo permanece estável em temperaturas mais altas e qual produz a melhor saída criativa na sua configuração-alvo.',
        ...
        recipeSafe: {
          items: [
            ...
            '**Modo de Resposta Curta:** Temperatura 0,3, top-p 0,95 | Ideal para respostas diretas, decisões rápidas, saídas concisas | Saída: Rápida, direta, elaboração mínima',
      ...
      sections: {
        ...
        promptquorum: {
          ...
          content: [
            ...
            '**Comparaisons multi-modèles :** Envoie un prompt à différents paramètres de température/top-p sur 25+ modèles (GPT-5.6, Claude Opus 4.8, Gemini 3.1 Pro, Mistral, modèles locaux Ollama) en une seule expédition. Vois instantanément quel modèle reste stable à une température plus élevée et quel modèle offre le meilleur résultat créatif à ton paramètre cible.',
        ...
        faqs: {
          faqs: [
            ...
            { q: 'Les paramètres recommandés diffèrent-ils entre GPT-5.6, Claude Opus 4.8 et Gemini 3.1 Pro ?', a: 'Légèrement. Tous les trois se comportent raisonnablement à température 0.5–0.7, mais leur tolérance aux températures plus élevées varie. GPT-5.6 peut aller plus haut sans devenir incohérent ; Claude Opus 4.8 est très stable ; Gemini 3.1 Pro est plus expérimental. Teste ton modèle réel.' },
    ...
    ja: {
      ...
      metaDescription: '温度は0.0〜2.0でAI出力のランダム性を制御し、Top-Pは0.1〜1.0で語彙選択の幅を調整します。コードには低温度（0.1〜0.3）、ブレーンストーミングには高温度（0.8以上）を推奨します。GPT-5.6、Claude Opus 4.8、Gemini 3.1 Proで確認済みの設定値を提供します。',
      publishDate: '2026-03-22',
      readTime: '10分で読める',
      educationalLevel: 'Intermediate',
      ...
      sections: {
        ...
        promptquorum: {
          ...
          content: [
            ...
            '**マルチモデル比較：** 1つのプロンプトを異なる温度/Top-P設定で25以上のモデル（GPT-5.6、Claude Opus 4.8、Gemini 3.1 Pro、Mistral、ローカルOllamaモデル）に送信します。どのモデルが高温度でも安定しているか、ターゲット設定で最適な創造的出力を提供するかをすぐに確認できます。',
        ...
        faqs: {
          faqs: [
            ...
            { q: 'GPT-5.6、Claude Opus 4.8、Gemini 3.1 Proで推奨設定が異なりますか？', a: 'わずかに。すべて3つは温度0.5–0.7で妥当に振舞いますが、高い温度の公差は異なります。GPT-5.6はより高くなっても無意味にならずに行くことができます；Claude Opus 4.8は非常に安定しています；Gemini 3.1 Proはより実験的です。実際のモデルをテストしてください。' },
    ...
    zh: {
      ...
      metaDescription: '温度参数范围0至2控制AI输出的随机程度，Top-P参数范围0.1至1.0决定模型考虑的词汇选项范围。代码生成推荐低温度（0.1至0.3），头脑风暴推荐高温度（0.8以上）。GPT-5.6、Claude Opus 4.8和Gemini 3.1 Pro均已完整验证以上参数设置效果。',
      publishDate: '2026-03-22',
      readTime: '阅读约10分钟',
      educationalLevel: 'Intermediate',
      ...
      sections: {
        ...
        promptquorum: {
          ...
          content: [
            ...
            '**多模型比较：** 在一次分发中跨25+个模型（GPT-5.6、Claude Opus 4.8、Gemini 3.1 Pro、Mistral、本地Ollama模型）发送一个不同温度/Top-P设置的提示。立即看到哪个模型在较高温度下保持稳定，哪个在您的目标设置下提供最佳创意输出。',
        ...
        faqs: {
          faqs: [
            ...
            { q: 'GPT-5.6、Claude Opus 4.8和Gemini 3.1 Pro之间的推荐设置是否不同？', a: '略有不同。全部三个在温度0.5–0.7下表现合理，但对较高温度的容限不同。GPT-5.6可以走得更高而不变成不连贯；Claude Opus 4.8非常稳定；Gemini 3.1 Pro更多实验性。测试您的实际模型。' },
      ...
      sections: {
        ...
        faqs: {
          faqs: [
            ...
            {
              q: 'GPT-5.6, Claude Opus 4.8, Gemini 3.1 Pro 간에 권장 설정이 다릅니까?',
              a: '약간 다릅니다. 세 모델 모두 temperature 0.5–0.7에서 합리적으로 동작하지만, 높은 temperature에 대한 허용 범위는 다릅니다. GPT-5.6는 비일관적이 되지 않고 더 높게 올라갈 수 있습니다. Claude Opus 4.8은 매우 안정적입니다. Gemini 3.1 Pro는 더 실험적입니다. 실제 모델을 테스트하십시오.',
            },
            {
