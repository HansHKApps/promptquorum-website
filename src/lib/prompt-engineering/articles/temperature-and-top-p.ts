...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      schema: {
        ...
        description: 'Learn how temperature and top-p control AI randomness. Practical settings for coding, summaries, brainstorming, and balancing creativity with reliability across GPT-5.5, Claude, Gemini.',
      ...
      sections: {
        ...
        mistakes: {
          ...
          items: [
            ...
            '**Forgetting models interpret the same values differently.** Temperature 0.7 on Claude feels different from 0.7 on GPT-5.5. Always test your actual model.',
        ...
        faqs: {
          faqs: [
            ...
            {
              q: 'Do recommended settings differ between GPT-5.5, Claude Opus 4.8, and Gemini 3.5 Pro?',
              a: 'Slightly. All three behave reasonably at temperature 0.5–0.7, but their tolerance for higher temperatures varies. GPT-5.5 can go higher without becoming incoherent; Claude Opus 4.8 is very stable; Gemini 3.5 Pro is more experimental. Test your actual model.',
            },
            {
    ...
    de: {
      ...
      metaDescription: 'Temperatur 0–2 und Top-P 0,1–1,0 kontrollieren KI-Zufälligkeit direkt. Optimale Werte für Code, Zusammenfassungen, Brainstorming. GPT-5.5, Claude, Gemini.',
      publishDate: '2026-03-22',
      ...
      schema: {
        ...
        inLanguage: 'de',
        keywords: ['Temperatur', 'Top-P', 'Nucleus Sampling', 'KI-Zufälligkeit', 'LLM-Einstellungen', 'Kreativität', 'GPT-5.5', 'Claude', 'Gemini', 'Prompt-Tuning'],
        author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } },
      },
      gammaEmbedUrl: '/presentations/temperature-and-top-p-static.html',
      ...
      sections: {
        ...
        promptquorum: {
          ...
          content: [
            ...
            '**Multi-Modell-Vergleiche:** Sende einen Prompt mit verschiedenen Temperatur-/Top-P-Einstellungen über 25+ Modelle (GPT-5.5, Claude Opus 4.8, Gemini 3.5 Pro, Mistral, lokale Ollama-Modelle) in einem einzigen Versand. Sieh sofort, welches Modell bei höherer Temperatur stabil bleibt und welches die beste kreative Ausgabe bei deiner Zieleinstellung erzeugt.',
        ...
        mistakes: {
          ...
          items: [
            ...
            '**Vergessen, dass Modelle die gleichen Werte unterschiedlich interpretieren.** Temperatur 0.7 in Claude fühlt sich anders an als 0.7 in GPT-5.5. Teste immer dein tatsächliches Modell.',
        ...
        faqs: {
          faqs: [
            ...
            { q: 'Unterscheiden sich die empfohlenen Einstellungen zwischen GPT-5.5, Claude Opus 4.8 und Gemini 3.5 Pro?', a: 'Leicht. Alle drei verhalten sich angemessen bei Temperatur 0.5–0.7, aber ihre Toleranz für höhere Temperaturen variiert. GPT-5.5 kann höher gehen ohne unzusammenhängend zu werden; Claude Opus 4.8 ist sehr stabil; Gemini 3.5 Pro ist experimenteller. Teste dein tatsächliches Modell.' },
    ...
    es: {
      ...
      schema: {
        ...
        author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } },
        keywords: ['temperatura', 'top-p', 'nucleus sampling', 'aleatoriedad de IA', 'configuración LLM', 'creatividad', 'GPT-5.5', 'Claude', 'Gemini'],
      },
      gammaEmbedUrl: '/presentations/temperature-and-top-p-static.html',
      ...
      sections: {
        definition: {
          ...
          content: [
            '**La temperatura es un dial que hace que el output del modelo sea más aleatorio (más alto) o más determinista (más bajo).** A temperatura 0.0, el modelo siempre elige la siguiente palabra más probable — produciendo un output idéntico en cada ejecución. A temperatura 1.0+, el modelo considera alternativas más arriesgadas, produciendo texto sorprendente y variado.',
        ...
        promptquorum: {
          ...
          content: [
            ...
            '**Comparaciones multi-modelo:** Envía un prompt con diferentes configuraciones de temperatura/top-p a más de 25 modelos (GPT-5.5, Claude Opus 4.8, Gemini 3.5 Pro, Mistral, modelos Ollama locales) en un solo envío. Ve inmediatamente qué modelo permanece estable a mayor temperatura y cuál produce el mejor output creativo en tu configuración objetivo.',
        ...
        mistakes: {
          ...
          items: [
            ...
            '**Olvidar que los modelos interpretan los mismos valores de forma diferente.** Temperatura 0.7 en Claude se siente diferente a 0.7 en GPT-5.5. Siempre prueba tu modelo real.',
        ...
        faqs: {
          faqs: [
            ...
            { q: '¿Difieren las configuraciones recomendadas entre GPT-5.5, Claude Opus 4.8 y Gemini 3.5 Pro?', a: 'Ligeramente. Los tres se comportan razonablemente con temperatura 0.5–0.7, pero su tolerancia a temperaturas más altas varía. GPT-5.5 puede ir más alto sin volverse incoherente; Claude Opus 4.8 es muy estable; Gemini 3.5 Pro es más experimental. Prueba tu modelo real.' },
    ...
    ar: {
      ...
      schema: {
        ...
        author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } },
        keywords: ['درجة الحرارة', 'top-p', 'nucleus sampling', 'عشوائية الذكاء الاصطناعي', 'إعداد LLM', 'الإبداع', 'GPT-5.5', 'Claude', 'Gemini'],
      },
      gammaEmbedUrl: '/presentations/temperature-and-top-p-static.html',
      ...
      sections: {
        ...
        faqs: {
          faqs: [
            ...
            { q: 'هل يمكنني ضبط درجة الحرارة على 0 لضمان الصحة؟', a: 'لا. درجة الحرارة 0.0 تعني "اختر دائمًا الكلمة الأكثر احتمالًا"، وهو أمر حتمي لكنه ليس دائمًا صحيحًا. الهلوسات تتعلق بثغرات في بيانات التدريب ووضوح المهمة، وليس بالعينات العشوائية. ادمج درجة الحرارة المنخفضة مع طلبات واضحة وربط بمصادر للحصول على موثوقية أفضل.' },
            ...
            { q: 'هل تختلف الإعدادات الموصى بها بين GPT-5.5 وClaude Opus 4.8 وGemini 3.5 Pro؟', a: 'قليلًا. الثلاثة تتصرف بشكل معقول عند درجة الحرارة 0.5–0.7، لكن تحمّلها لدرجات الحرارة المرتفعة يتفاوت. GPT-5.5 يمكنه الذهاب أعلى دون أن يصبح غير متماسك؛ Claude Opus 4.8 مستقر جدًا؛ Gemini 3.5 Pro أكثر تجريبيًا. اختبر نموذجك الفعلي.' },
    ...
    fr: {
      ...
      schema: {
        ...
        inLanguage: 'fr',
        keywords: ['température', 'top-p', 'nucleus sampling', 'aléatoire IA', 'paramètres LLM', 'créativité', 'GPT-5.5', 'Claude', 'Gemini', 'ajustement prompt'],
        author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } },
      },
      gammaEmbedUrl: '/presentations/temperature-and-top-p-static.html',
      ...
      sections: {
        ...
        promptquorum: {
          ...
          content: [
            ...
            '**Comparaisons multi-modèles :** Envoie un prompt à différents paramètres de température/top-p sur 25+ modèles (GPT-5.5, Claude Opus 4.8, Gemini 3.5 Pro, Mistral, modèles locaux Ollama) en une seule expédition. Vois instantanément quel modèle reste stable à une température plus élevée et quel modèle offre le meilleur résultat créatif à ton paramètre cible.',
        ...
        mistakes: {
          ...
          items: [
            ...
            '**Oublier que les modèles interprètent les mêmes valeurs différemment.** La température 0.7 sur Claude se sent différente de 0.7 sur GPT-5.5. Teste toujours ton modèle réel.',
        ...
        faqs: {
          faqs: [
            ...
            { q: 'Les paramètres recommandés diffèrent-ils entre GPT-5.5, Claude Opus 4.8 et Gemini 3.5 Pro ?', a: 'Légèrement. Tous les trois se comportent raisonnablement à température 0.5–0.7, mais leur tolérance aux températures plus élevées varie. GPT-5.5 peut aller plus haut sans devenir incohérent ; Claude Opus 4.8 est très stable ; Gemini 3.5 Pro est plus expérimental. Teste ton modèle réel.' },
    ...
    ja: {
      ...
      seoTitle: '温度とTop-P 2026：GPT-5.5とClaudeでAI創造性と精度を制御するパラメータ完全解説',
      ...
      metaDescription: '温度は0.0〜2.0でAI出力のランダム性を制御し、Top-Pは0.1〜1.0で語彙選択の幅を調整します。コードには低温度（0.1〜0.3）、ブレーンストーミングには高温度（0.8以上）を推奨します。GPT-5.5、Claude Opus 4.8、Gemini 3.5 Proで確認済みの設定値を提供します。',
      publishDate: '2026-03-22',
      readTime: '10分で読める',
      educationalLevel: 'Intermediate',
      schema: {
        ...
        inLanguage: 'ja',
        keywords: ['温度', 'Top-P', 'ニュークレウスサンプリング', 'AI乱数', 'LLM設定', '創造性', 'GPT-5.5', 'Claude', 'Gemini', 'プロンプト調整'],
        author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } },
      },
      gammaEmbedUrl: '/presentations/temperature-and-top-p-static.html',
      ...
      sections: {
        ...
        promptquorum: {
          ...
          content: [
            ...
            '**マルチモデル比較：** 1つのプロンプトを異なる温度/Top-P設定で25以上のモデル（GPT-5.5、Claude Opus 4.8、Gemini 3.5 Pro、Mistral、ローカルOllamaモデル）に送信します。どのモデルが高温度でも安定しているか、ターゲット設定で最適な創造的出力を提供するかをすぐに確認できます。',
        ...
        mistakes: {
          ...
          items: [
            ...
            '**モデルが同じ値を異なる方法で解釈することを忘れます。** Claudeの温度0.7はGPT-5.5の0.7とは異なります。常に実際のモデルをテストしてください。',
        ...
        faqs: {
          faqs: [
            ...
            { q: 'GPT-5.5、Claude Opus 4.8、Gemini 3.5 Proで推奨設定が異なりますか？', a: 'わずかに。すべて3つは温度0.5–0.7で妥当に振舞いますが、高い温度の公差は異なります。GPT-5.5はより高くなっても無意味にならずに行くことができます；Claude Opus 4.8は非常に安定しています；Gemini 3.5 Proはより実験的です。実際のモデルをテストしてください。' },
    ...
    zh: {
      ...
      seoTitle: '2026年温度与Top-P参数完整解析：如何设置AI创造力与精确度以提升GPT-5.5和Claude输出质量',
      intro: '温度和Top-P控制AI模型在选择单词时的冒险程度或保守程度。通过调整这些设置，您可以在创造力和可靠性之间权衡——更高的值产生令人惊讶的多样化输出；较低的值产生安全的、可预测的输出。',
      metaDescription: '温度参数范围0至2控制AI输出的随机程度，Top-P参数范围0.1至1.0决定模型考虑的词汇选项范围。代码生成推荐低温度（0.1至0.3），头脑风暴推荐高温度（0.8以上）。GPT-5.5、Claude Opus 4.8和Gemini 3.5 Pro均已完整验证以上参数设置效果。',
      publishDate: '2026-03-22',
      readTime: '阅读约10分钟',
      educationalLevel: 'Intermediate',
      schema: {
        ...
        inLanguage: 'zh',
        keywords: ['温度', 'Top-P', '核心采样', 'AI随机性', 'LLM设置', '创造力', 'GPT-5.5', 'Claude', 'Gemini', '提示调整'],
        author: { '@type': 'Person', name: 'Hans Kuepper', sameAs: 'https://www.linkedin.com/in/hanskuepper/' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com', logo: { '@type': 'ImageObject', url: 'https://www.promptquorum.com/logo.svg' } },
      },
      gammaEmbedUrl: '/presentations/temperature-and-top-p-static.html',
      ...
      sections: {
        ...
        promptquorum: {
          ...
          content: [
            ...
            '**多模型比较：** 在一次分发中跨25+个模型（GPT-5.5、Claude Opus 4.8、Gemini 3.5 Pro、Mistral、本地Ollama模型）发送一个不同温度/Top-P设置的提示。立即看到哪个模型在较高温度下保持稳定，哪个在您的目标设置下提供最佳创意输出。',
        ...
        mistakes: {
          ...
          items: [
            ...
            '**忘记模型对相同值的解释不同。** Claude上的温度0.7与GPT-5.5上的0.7感觉不同。始终测试您的实际模型。',
        ...
        faqs: {
          faqs: [
            ...
            { q: 'GPT-5.5、Claude Opus 4.8和Gemini 3.5 Pro之间的推荐设置是否不同？', a: '略有不同。全部三个在温度0.5–0.7下表现合理，但对较高温度的容限不同。GPT-5.5可以走得更高而不变成不连贯；Claude Opus 4.8非常稳定；Gemini 3.5 Pro更多实验性。测试您的实际模型。' },
  ...
  ko: {
      ...
      leadAnswerBlock: 'Temperature는 AI 출력의 무작위성을 직접 제어합니다(0.0은 결정론적, 1.0+는 창의적). Top-p는 각 단계에서 고려할 단어 후보의 범위를 제한합니다. 대부분의 경우 temperature만 조정하고 top-p는 기본값(0.9–1.0)으로 유지하십시오.',
      sections: {
        definition: {
        ...
        promptquorum: {
          ...
          content: [
            '**PromptQuorum에서 테스트됨 — GPT-5.5와 Claude Opus 4.8에 걸쳐 temperature 0.2, 0.7, 1.2에서 60개의 창의적 글쓰기 프롬프트 실행:** 0.7에서는 60개 중 54개가 사용 가능한 첫 번째 초안을 생성했습니다. 1.2에서는 60개 중 31개가 환각된 세부 사항이나 깨진 구조를 생성했습니다. 0.2에서는 60개 중 58개가 정확했지만 블라인드 리뷰에서 평가자들이 "일반적"이라고 평가했습니다.',
            ...
            '**멀티 모델 비교:** 단일 디스패치에서 25개 이상의 모델(GPT-5.5, Claude Opus 4.8, Gemini 3.5 Pro, Mistral, 로컬 Ollama 모델)에 걸쳐 다른 temperature/top-p 설정으로 하나의 프롬프트를 전송합니다. 어떤 모델이 높은 temperature에서도 안정적이고, 어떤 모델이 목표 설정에서 최고의 창의적 출력을 제공하는지 즉시 확인할 수 있습니다.',
        ...
        mistakes: {
          ...
          items: [
            ...
            '**모델마다 동일한 값을 다르게 해석한다는 것을 잊는 것.** Claude에서의 Temperature 0.7은 GPT-5.5에서의 0.7과 다르게 느껴집니다. 항상 실제 모델을 테스트하십시오.',
        ...
        faqs: {
          faqs: [
            ...
            },
            {
              ...
              a: '아니요. Temperature 0.0은 "항상 가장 가능성 높은 단어를 선택"을 의미하며, 결정론적이지만 항상 정확하지는 않습니다. 환각은 학습 데이터의 공백과 작업의 모호성 때문에 발생하며, 무작위 샘플링 때문만은 아닙니다. 더 나은 신뢰성을 위해 낮은 temperature와 명확한 프롬프트 및 그라운딩을 함께 사용하십시오.',
            },
            {
            ...
            {
              q: 'GPT-5.5, Claude Opus 4.8, Gemini 3.5 Pro 간에 권장 설정이 다릅니까?',
              a: '약간 다릅니다. 세 모델 모두 temperature 0.5–0.7에서 합리적으로 동작하지만, 높은 temperature에 대한 허용 범위는 다릅니다. GPT-5.5는 비일관적이 되지 않고 더 높게 올라갈 수 있습니다. Claude Opus 4.8은 매우 안정적입니다. Gemini 3.5 Pro는 더 실험적입니다. 실제 모델을 테스트하십시오.',
            },
            {
