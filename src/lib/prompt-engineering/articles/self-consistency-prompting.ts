...
export const article: Record<Language, PEArticle> = {
    ...
    fr: {
      freshness_tier: 'evergreen',
      theme: 'Techniques',
      title: 'Self-Consistency Prompting : Générer Plusieurs Réponses, Choisir le Consensus',
      ...
      metaDescription: 'Self-Consistency Prompting génère 5–20 chemins de raisonnement et choisit la réponse la plus fréquente. Précision améliorée de 56% à 74%. Modèles et exemples pratiques.',
      primaryTerm: 'Self-Consistency Prompting',
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
        ...
        'inLanguage': 'fr',
        headline: 'Self-Consistency Prompting : Générer Plusieurs Réponses, Choisir le Consensus',
        description: 'Le Self-Consistency Prompting améliore la précision de l\'IA en mathématiques, logique et analyse en générant plusieurs chemins de raisonnement et en sélectionnant la réponse de la majorité.',
        datePublished: '2026-03-26',
        dateModified: '2026-05-04',
        keywords: ['Self-Consistency Prompting', 'Prompt Engineering', 'Fiabilité IA', 'Vote majoritaire', 'Raisonnement'],
        author: { '@type': 'Person', name: 'Hans Kuepper', url: 'https://www.promptquorum.com/about' },
        publisher: { '@type': 'Organization', name: 'PromptQuorum', url: 'https://www.promptquorum.com' },
      },
      sections: {},
