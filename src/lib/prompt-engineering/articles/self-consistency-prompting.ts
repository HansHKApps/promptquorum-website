...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      seoTitle: 'برومبت الاتساق الذاتي: استجابات متعددة، أفضل نتيجة',
      metaDescription: 'يُولّد برومبت الاتساق الذاتي 5–20 مساراً استدلالياً ويختار الإجابة الأكثرية. يُحسّن الدقة في الرياضيات من 56٪ إلى 74٪.',
