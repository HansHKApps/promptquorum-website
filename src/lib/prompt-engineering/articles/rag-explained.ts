    ...
    es: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: '¿RAG funciona con GPT-4o, Claude y Gemini?', acceptedAnswer: { '@type': 'Answer', text: 'Sí. Los tres aceptan contexto recuperado en el prompt. Claude Opus 4.7 es particularmente efectivo para indicar cuando el contexto recuperado no contiene la respuesta, en lugar de alucinar. GPT-4o produce respuestas más concisas a partir de contexto denso.' } },
