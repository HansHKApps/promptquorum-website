      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'RAG works with GPT-4o, Claude Opus 4.8, Gemini 2.0 Pro, and local models via Ollama and LM Studio',
          ],
        },
        whatIsRAG: {
          title: 'What RAG Is',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'Does RAG work with GPT-4o, Claude, and Gemini?', a: 'Yes. All three accept retrieved context in the prompt. Claude Opus 4.8 is particularly effective at flagging when retrieved context does not contain the answer, rather than hallucinating. GPT-4o produces more concise answers from dense context.' },
    ...
    de: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Funktioniert RAG mit GPT-4o, Claude und Gemini?', acceptedAnswer: { '@type': 'Answer', text: 'Ja. Alle drei akzeptieren abgerufenen Kontext im Prompt. Claude Opus 4.8 ist besonders wirksam beim Kennzeichnen, wenn abgerufener Kontext die Antwort nicht enthält, anstatt zu halluzinieren. GPT-4o erzeugt prägnantere Antworten aus dichtem Kontext.' } },
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'RAG funktioniert mit GPT-4o, Claude Opus 4.8, Gemini 2.0 Pro und lokalen Modellen über Ollama und LM Studio',
          ],
        },
        whatIsRAG: {
          title: 'Was ist RAG',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'Funktioniert RAG mit GPT-4o, Claude und Gemini?', a: 'Ja. Alle drei akzeptieren abgerufenen Kontext im Prompt. Claude Opus 4.8 ist besonders wirksam beim Kennzeichnen, wenn abgerufener Kontext die Antwort nicht enthält, anstatt zu halluzinieren. GPT-4o erzeugt prägnantere Antworten aus dichtem Kontext.' },
    ...
    es: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: '¿RAG funciona con GPT-4o, Claude y Gemini?', acceptedAnswer: { '@type': 'Answer', text: 'Sí. Los tres aceptan contexto recuperado en el prompt. Claude Opus 4.8 es particularmente efectivo para indicar cuando el contexto recuperado no contiene la respuesta, en lugar de alucinar. GPT-4o produce respuestas más concisas a partir de contexto denso.' } },
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'RAG funciona con GPT-4o, Claude Opus 4.8, Gemini 2.0 Pro y modelos locales via Ollama y LM Studio',
          ],
        },
        whatIsRAG: {
          title: 'Qué es RAG',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: '¿Funciona RAG con cualquier modelo de lenguaje?', a: 'Sí. RAG es agnóstico al modelo. Cualquier LLM que acepte un prompt con contexto puede usar documentos recuperados. Esto aplica a GPT-4o, Claude Opus, Gemini, modelos open-source como Llama y modelos locales via Ollama.' },
    ...
    fr: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'RAG fonctionne avec GPT-4o, Claude, Gemini ?', acceptedAnswer: { '@type': 'Answer', text: 'Oui. Tous acceptent le contexte récupéré. Claude Opus 4.8 signale bien quand le contexte ne contient pas la réponse. GPT-4o produit des réponses concises à partir de contexte dense.' } },
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'Fonctionne avec GPT-4o, Claude Opus 4.8, Gemini 2.0 Pro, modèles locaux via Ollama',
          ],
        },
        whatIsRAG: {
        ...
        multiModel: {
          ...
          callouts: [
            { type: 'info', label: 'Mêmes documents, réponses différentes', text: 'Tester le même prompt RAG sur GPT-4o, Claude Opus 4.8, et Gemini 2.0 Pro avec le même vecteur-store. Vous verrez: différentes longueurs, styles, utilisation du contexte. PromptQuorum permet router une même requête vers plusieurs modèles et comparer.' },
          ],
          items: [
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'RAG + GPT-4o, Claude, Gemini ?', a: 'Oui. Tous acceptent contexte. Claude Opus 4.8 bon signaler contexte insuffisant. GPT-4o concis.' },
    ...
    ja: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'RAG は GPT-4o、Claude、Gemini で動きますか？', acceptedAnswer: { '@type': 'Answer', text: 'はい。3 つすべてが取得コンテキストをプロンプトで受け入れます。Claude Opus 4.8 は取得コンテキストに回答が含まれない場合のフラグ付けが特に有効で、ハルシネーション傾向が低い。GPT-4o は密集したコンテキストから簡潔な回答を生成。' } },
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'GPT-4o、Claude Opus 4.8、Gemini 2.0 Pro、Ollama/LM Studio 経由のローカルモデルで動作',
          ],
        },
        whatIsRAG: {
          title: 'RAGとは何か',
        ...
        multiModel: {
          ...
          callouts: [
            { type: 'info', label: '同じドキュメント、異なる回答', text: '同じ RAG プロンプトを GPT-4o、Claude Opus 4.8、Gemini 2.0 Pro で同じベクトルストアに対して実行してみてください。長さ・スタイル・コンテキスト活用が異なります。PromptQuorum は同じクエリを複数モデルにルーティングして比較を可能にします。' },
          ],
          items: [
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'GPT-4o、Claude、Gemini で RAG？', a: 'はい。3つ全て取得コンテキスト受入。Claude Opus 4.8：文脈不足をよく報告。GPT-4o：密集文脈から簡潔回答。' },
    ...
    zh: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'RAG能用于GPT-4o、Claude、Gemini？', acceptedAnswer: { '@type': 'Answer', text: '可以。三者都在提示中接受检索上下文。Claude Opus 4.8特别有效地标记检索上下文何时不包含答案，而不是编造。GPT-4o从密集上下文生成更简洁的答案。' } },
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            '与GPT-4o、Claude Opus 4.8、Gemini 2.0 Pro以及通过Ollama的本地模型配合',
          ],
        },
        whatIsRAG: {
          title: 'RAG是什么',
        ...
        multiModel: {
          ...
          callouts: [
            { type: 'info', label: '相同文档，不同答案', text: '在GPT-4o、Claude Opus 4.8、Gemini 2.0 Pro上用同样的RAG提示对相同向量存储做测试。你会看到长度、风格、文档利用率不同。PromptQuorum允许路由相同查询到多个模型并做对比。' },
          ],
          items: [
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'RAG能用GPT-4o、Claude、Gemini？', a: '可以。三者都接受检索上下文。Claude Opus 4.8擅长标记上下文不足。GPT-4o简洁。' },
