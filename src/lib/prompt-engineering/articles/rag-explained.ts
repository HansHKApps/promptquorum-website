...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      seoTitle: 'RAG موضَّح 2026: دليل التوليد المُعزَّز بالاسترجاع',
      metaDescription: 'RAG موضَّح: أنبوب من 4 مراحل، أحجام الشظايا المثلى، عتبة الصلة، ومقارنة قواعد البيانات المتجهية. RAG مقابل الضبط الدقيق.',
