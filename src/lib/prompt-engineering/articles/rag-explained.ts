      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'RAG works with GPT-5.6, Claude Opus 5, Gemini 2.0 Pro, and local models via Ollama and LM Studio',
          ],
        },
        whatIsRAG: {
          title: 'What RAG Is',
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'RAG funktioniert mit GPT-5.6, Claude Opus 5, Gemini 2.0 Pro und lokalen Modellen über Ollama und LM Studio',
          ],
        },
        whatIsRAG: {
          id: 'what-rag-is',
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'RAG funciona con GPT-5.6, Claude Opus 5, Gemini 2.0 Pro y modelos locales via Ollama y LM Studio',
          ],
        },
        whatIsRAG: {
          id: 'what-rag-is',
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'يعمل RAG مع GPT-5.6 وClaude Opus 5 وGemini 2.0 Pro والنماذج المحلية عبر Ollama وLM Studio',
          ],
        },
        whatIsRAG: {
          id: 'what-rag-is',
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'RAG funciona com GPT-5.6, Claude Opus 5, Gemini 2.0 Pro e modelos locais via Ollama e LM Studio',
          ],
        },
        whatIsRAG: {
          id: 'what-rag-is',
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'Fonctionne avec GPT-5.6, Claude Opus 5, Gemini 2.0 Pro, modèles locaux via Ollama',
          ],
        },
        whatIsRAG: {
          id: 'what-rag-is',
        ...
        multiModel: {
          ...
          callouts: [
            { type: 'info', label: 'Mêmes documents, réponses différentes', text: 'Tester le même prompt RAG sur GPT-5.6, Claude Opus 5, et Gemini 2.0 Pro avec le même vecteur-store. Vous verrez: différentes longueurs, styles, utilisation du contexte. PromptQuorum permet router une même requête vers plusieurs modèles et comparer.' },
          ],
          items: [
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'GPT-5.6、Claude Opus 5、Gemini 2.0 Pro、Ollama/LM Studio 経由のローカルモデルで動作',
          ],
        },
        whatIsRAG: {
          id: 'what-rag-is',
        ...
        multiModel: {
          ...
          callouts: [
            { type: 'info', label: '同じドキュメント、異なる回答', text: '同じ RAG プロンプトを GPT-5.6、Claude Opus 5、Gemini 2.0 Pro で同じベクトルストアに対して実行してみてください。長さ・スタイル・コンテキスト活用が異なります。PromptQuorum は同じクエリを複数モデルにルーティングして比較を可能にします。' },
          ],
          items: [
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            '与GPT-5.6、Claude Opus 5、Gemini 2.0 Pro以及通过Ollama的本地模型配合',
          ],
        },
        whatIsRAG: {
          id: 'what-rag-is',
        ...
        multiModel: {
          ...
          callouts: [
            { type: 'info', label: '相同文档，不同答案', text: '在GPT-5.6、Claude Opus 5、Gemini 2.0 Pro上用同样的RAG提示对相同向量存储做测试。你会看到长度、风格、文档利用率不同。PromptQuorum允许路由相同查询到多个模型并做对比。' },
          ],
          items: [
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'RAG는 GPT-5.6, Claude Opus 5, Gemini 2.0 Pro, 그리고 Ollama 및 LM Studio를 통한 로컬 모델과 함께 작동합니다',
          ],
        },
        whatIsRAG: {
          id: 'what-rag-is',
