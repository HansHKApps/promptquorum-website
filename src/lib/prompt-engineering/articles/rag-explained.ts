      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'RAG works with GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro, and local models via Ollama and LM Studio',
          ],
        },
        whatIsRAG: {
          title: 'What RAG Is',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'Does RAG work with GPT-5.5, Claude, and Gemini?', a: 'Yes. All three accept retrieved context in the prompt. Claude Opus 4.7 is particularly effective at flagging when retrieved context does not contain the answer, rather than hallucinating. GPT-5.5 produces more concise answers from dense context.' },
    ...
    de: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Funktioniert RAG mit GPT-5.5, Claude und Gemini?', acceptedAnswer: { '@type': 'Answer', text: 'Ja. Alle drei akzeptieren abgerufenen Kontext im Prompt. Claude Opus 4.7 ist besonders wirksam beim Kennzeichnen, wenn abgerufener Kontext die Antwort nicht enthält, anstatt zu halluzinieren. GPT-5.5 erzeugt prägnantere Antworten aus dichtem Kontext.' } },
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'RAG funktioniert mit GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro und lokalen Modellen über Ollama und LM Studio',
          ],
        },
        whatIsRAG: {
          title: 'Was ist RAG',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'Funktioniert RAG mit GPT-5.5, Claude und Gemini?', a: 'Ja. Alle drei akzeptieren abgerufenen Kontext im Prompt. Claude Opus 4.7 ist besonders wirksam beim Kennzeichnen, wenn abgerufener Kontext die Antwort nicht enthält, anstatt zu halluzinieren. GPT-5.5 erzeugt prägnantere Antworten aus dichtem Kontext.' },
    ...
    fr: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'RAG fonctionne avec GPT-5.5, Claude, Gemini ?', acceptedAnswer: { '@type': 'Answer', text: 'Oui. Tous acceptent le contexte récupéré. Claude Opus 4.7 signale bien quand le contexte ne contient pas la réponse. GPT-5.5 produit des réponses concises à partir de contexte dense.' } },
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'Fonctionne avec GPT-5.5, Claude Opus 4.7, Gemini 3.1 Pro, modèles locaux via Ollama',
          ],
        },
        whatIsRAG: {
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'RAG + GPT-5.5, Claude, Gemini ?', a: 'Oui. Tous acceptent contexte. Claude Opus 4.7 bon signaler contexte insuffisant. GPT-5.5 concis.' },
    ...
    ja: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'RAG は GPT-5.5、Claude、Gemini で動きますか？', acceptedAnswer: { '@type': 'Answer', text: 'はい。3 つすべてが取得コンテキストをプロンプトで受け入れます。Claude Opus 4.7 は取得コンテキストに回答が含まれない場合のフラグ付けが特に有効で、ハルシネーション傾向が低い。GPT-5.5 は密集したコンテキストから簡潔な回答を生成。' } },
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            'GPT-5.5、Claude Opus 4.7、Gemini 3.1 Pro、Ollama/LM Studio 経由のローカルモデルで動作',
          ],
        },
        whatIsRAG: {
          title: 'RAGとは何か',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'GPT-5.5、Claude、Gemini で RAG？', a: 'はい。3つ全て取得コンテキスト受入。Claude Opus 4.7：文脈不足をよく報告。GPT-5.5：密集文脈から簡潔回答。' },
    ...
    zh: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'RAG能用于GPT-5.5、Claude、Gemini？', acceptedAnswer: { '@type': 'Answer', text: '可以。三者都在提示中接受检索上下文。Claude Opus 4.7特别有效地标记检索上下文何时不包含答案，而不是编造。GPT-5.5从密集上下文生成更简洁的答案。' } },
      ...
      sections: {
        keyTakeaways: {
          ...
          items: [
            ...
            '与GPT-5.5、Claude Opus 4.7、Gemini 3.1 Pro以及通过Ollama的本地模型配合',
          ],
        },
        whatIsRAG: {
          title: 'RAG是什么',
        ...
        faq: {
          ...
          faqs: [
            ...
            { q: 'RAG能用GPT-5.5、Claude、Gemini？', a: '可以。三者都接受检索上下文。Claude Opus 4.7擅长标记上下文不足。GPT-5.5简洁。' },
