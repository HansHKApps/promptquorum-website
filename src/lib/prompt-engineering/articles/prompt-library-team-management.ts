...
export const article: Partial<Record<Language, PEArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'إدارة مكتبة التلقينات: تنظيم وإصدار تلقينات الفريق',
    ...
    metaDescription: 'إدارة مكتبة تلقينات الفريق: المجلدات، التسمية، إصدار Git، التحكم بالوصول والإهمال. للفرق التي لديها 3 أو أكثر من مؤلفي التلقينات.',
