...
export const article: Partial<Record<Language, PEArticle>> = {
      ...
      sections: {
        ...
        timeline: {
          ...
          rows: [
            ...
            { 'Year': '2024', 'Milestone': 'Llama 3-class models; context windows exceed 1M tokens (Gemini 3.1 Pro)', 'Why It Matters': 'Open-source LLMs for private deployment; massive context shifted focus to context engineering' },
        ...
        relatedReading: {
          ...
          items: [
            ...
            { title: 'Context Windows Explained: Why Your AI Forgets', url: '/prompt-engineering/context-windows-explained-why-ai-forgets' },
            { title: 'Tokens, Costs & Limits: The Economics of AI Prompting', url: '/prompt-engineering/tokens-costs-limits-economics-of-ai-prompting' },
          ],
        },
    ...
    de: {
      ...
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        name: 'Zeitleiste der Prompt-Engineering-Entwicklung: 2018–2026',
        description: 'Eine chronologische Zeitleiste der wichtigsten Meilensteine, Forschungsarbeiten und Modellveröffentlichungen, die die Entwicklung von Prompt Engineering von 2018 bis 2026 geprägt haben.',
        url: 'https://www.promptquorum.com/de/prompt-engineering/how-prompt-engineering-evolved#timeline',
        inLanguage: 'de',
        numberOfItems: 13,
        itemListElement: [
          { '@type': 'ListItem', position: 1, name: 'BERT und GPT-2 veröffentlicht (2018–2019)', description: 'Zeigte, dass Transformer-Modelle durch Eingabeformulierung gesteuert werden können — aber noch keine formale Disziplin' },
          { '@type': 'ListItem', position: 2, name: 'GPT-3 Few-Shot-Lernen (2020)', description: 'Etablierte Few-Shot-Prompting als Paradigma: Die Umformulierung des Prompts ändert das Modellverhalten ohne erneutes Training' },
          { '@type': 'ListItem', position: 3, name: 'InstructGPT und RLHF (Januar 2022)', description: 'Modelle wurden trainiert, Anweisungen zu befolgen — machte Prompt-Qualität deutlich folgenreicher' },
          { '@type': 'ListItem', position: 4, name: 'Chain-of-Thought-Prompting (Mai 2022)', description: 'Bewies, dass die Prompt-Struktur schrittweises Denken hervorrufen kann — machte Prompting zu einem kognitiven Gerüst' },
          { '@type': 'ListItem', position: 5, name: 'ChatGPT-Start (November 2022)', description: 'Brachte Prompt Engineering in das öffentliche Bewusstsein; Millionen begannen über Nacht zu experimentieren' },
          { '@type': 'ListItem', position: 6, name: '„Prompt Engineer" als Berufsbezeichnung (Q1 2023)', description: 'Definierte Prompt Engineering als anerkannten Beruf und benannte Fähigkeit' },
          { '@type': 'ListItem', position: 7, name: 'GPT-4 und multimodales Prompting (März 2023)', description: 'Erweiterte Prompt Engineering über Text hinaus auf visuelle Eingaben und große Kontextfenster' },
          { '@type': 'ListItem', position: 8, name: 'Prompt-Engineering-Frameworks (2023)', description: 'Machte aus Prompt Engineering vom persönlichen Handwerk eine lehrbare, teilbare Praxis' },
          { '@type': 'ListItem', position: 9, name: 'Automatisierte Prompt-Optimierung (2023–2024)', description: 'LLMs erwiesen sich als ebenso gut im Schreiben von Prompts wie Menschen; automatisierte Prompt-Optimierung wurde praktikabel' },
          { '@type': 'ListItem', position: 10, name: 'Open-Weight-Modelle und 1-Mio.-Kontext (2024)', description: 'Open-Source-LLMs für private Bereitstellung; massiver Kontext verlagerte den Fokus auf Context Engineering' },
          { '@type': 'ListItem', position: 11, name: 'Erweiterte Denk- und Reasoning-Modi (Q1–Q2 2025)', description: 'Modelle verinnerlichen schrittweises Denken; CoT auf Prompt-Ebene wird bei Frontier-Modellen optional' },
          { '@type': 'ListItem', position: 12, name: 'LLaMA 4 MoE und 10-Mio.-Kontext (Q3–Q4 2025)', description: 'Open-Weight-Modelle erreichen nahezu Frontier-Qualität; MoE-Architektur senkt Rechenkosten für Self-Hosting' },
          { '@type': 'ListItem', position: 13, name: 'Context Design als Standardpraxis (2026)', description: 'Prompting wird zu einer Schicht in einem zusammengesetzten Kontext — systemisches Denken erforderlich; Prompt-Engineering-Kompetenz in allen KI-nutzenden Rollen verankert' },
        ],
      },
      sections: {
        definition: {
        ...
        timeline: {
          ...
          rows: [
            ...
            { 'Jahr': '2024', 'Meilenstein': 'Llama-3-Klasse-Modelle; Kontextfenster überschreiten 1M Token (Gemini 3.1 Pro)', 'Warum es wichtig ist': 'Open-Source-LLMs für private Deployments; massiver Kontext verlagerte Fokus auf Kontext-Engineering' },
    ...
    es: {
      ...
      educationalLevel: 'Beginner',
      next_refresh_due: '2027-02-28',
      primaryTerm: 'Historia del Prompt Engineering',
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
      ...
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        name: 'Línea de tiempo de la evolución del Prompt Engineering: 2018–2026',
        description: 'Una línea de tiempo cronológica de los hitos clave, artículos de investigación y lanzamientos de modelos que dieron forma a la evolución del prompt engineering entre 2018 y 2026.',
        url: 'https://www.promptquorum.com/es/prompt-engineering/how-prompt-engineering-evolved#timeline',
        inLanguage: 'es',
        numberOfItems: 13,
        itemListElement: [
          { '@type': 'ListItem', position: 1, name: 'Lanzamiento de BERT y GPT-2 (2018–2019)', description: 'Demostró que los modelos transformer podían guiarse mediante la formulación de la entrada — pero aún sin disciplina formal' },
          { '@type': 'ListItem', position: 2, name: 'Aprendizaje few-shot de GPT-3 (2020)', description: 'Estableció el few-shot prompting como paradigma: reescribir el prompt cambia el comportamiento del modelo sin reentrenamiento' },
          { '@type': 'ListItem', position: 3, name: 'InstructGPT y RLHF (enero de 2022)', description: 'Modelos entrenados para seguir instrucciones — hizo que la calidad del prompt fuera mucho más determinante' },
          { '@type': 'ListItem', position: 4, name: 'Chain-of-Thought prompting (mayo de 2022)', description: 'Demostró que la estructura del prompt puede provocar razonamiento paso a paso — convirtió el prompting en un andamiaje cognitivo' },
          { '@type': 'ListItem', position: 5, name: 'Lanzamiento de ChatGPT (noviembre de 2022)', description: 'Llevó el prompt engineering a la conciencia pública; millones comenzaron a experimentar de la noche a la mañana' },
          { '@type': 'ListItem', position: 6, name: '"Prompt Engineer" como puesto de trabajo (T1 2023)', description: 'Definió el prompt engineering como una profesión reconocida y una habilidad con nombre propio' },
          { '@type': 'ListItem', position: 7, name: 'GPT-4 y prompting multimodal (marzo de 2023)', description: 'Extendió el prompt engineering más allá del texto a entradas visuales y ventanas de contexto grandes' },
          { '@type': 'ListItem', position: 8, name: 'Frameworks de prompt engineering (2023)', description: 'Convirtió el prompt engineering de un oficio personal en una práctica enseñable y compartible' },
          { '@type': 'ListItem', position: 9, name: 'Optimización automatizada de prompts (2023–2024)', description: 'Se demostró que los LLM escriben prompts tan bien como los humanos; la optimización automatizada de prompts se volvió práctica' },
          { '@type': 'ListItem', position: 10, name: 'Modelos de peso abierto y contexto de 1M (2024)', description: 'LLM de código abierto para despliegue privado; el contexto masivo trasladó el foco al context engineering' },
          { '@type': 'ListItem', position: 11, name: 'Modos de razonamiento extendido (T1–T2 2025)', description: 'Los modelos internalizan el razonamiento paso a paso; el CoT a nivel de prompt se vuelve opcional en modelos de frontera' },
          { '@type': 'ListItem', position: 12, name: 'LLaMA 4 MoE y contexto de 10M (T3–T4 2025)', description: 'Los modelos de peso abierto alcanzan calidad casi de frontera; la arquitectura MoE reduce los costos de cómputo para el autoalojamiento' },
          { '@type': 'ListItem', position: 13, name: 'Context design como práctica estándar (2026)', description: 'El prompting se convierte en una capa dentro de un contexto compuesto — se requiere pensamiento a nivel de sistema; la habilidad de prompt engineering se integra en todos los roles que usan IA' },
        ],
      },
      sections: {
        definition: {
        ...
        timeline: {
          ...
          rows: [
            ...
            { 'Año': '2024', 'Hito': 'Modelos clase Llama 3; context windows superan 1M tokens (Gemini 3.1 Pro)', 'Por qué importa': 'LLMs de código abierto para despliegues privados; el contexto masivo desplazó el foco hacia el context engineering' },
    ...
    ar: {
      ...
      next_refresh_due: '2027-02-28',
      primaryTerm: 'تاريخ هندسة البرومبت',
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
      ...
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        name: 'الخط الزمني لتطور هندسة البرومبت: 2018–2026',
        description: 'خط زمني يرصد أهم المحطات وأوراق البحث وإصدارات النماذج التي شكّلت تطور هندسة البرومبت من 2018 إلى 2026.',
        url: 'https://www.promptquorum.com/ar/prompt-engineering/how-prompt-engineering-evolved#timeline',
        inLanguage: 'ar',
        numberOfItems: 13,
        itemListElement: [
          { '@type': 'ListItem', position: 1, name: 'إطلاق BERT وGPT-2 (2018–2019)', description: 'أثبت أن نماذج المحولات يمكن توجيهها عبر صياغة المدخلات — لكن دون تخصص رسمي بعد' },
          { '@type': 'ListItem', position: 2, name: 'تعلّم GPT-3 بأسلوب Few-Shot (2020)', description: 'أرسى مبدأ الـfew-shot prompting: إعادة صياغة البرومبت تغيّر سلوك النموذج دون إعادة تدريب' },
          { '@type': 'ListItem', position: 3, name: 'InstructGPT وRLHF (يناير 2022)', description: 'نماذج مدرَّبة على اتباع التعليمات — جعلت جودة البرومبت أكثر أهمية بكثير' },
          { '@type': 'ListItem', position: 4, name: 'Chain-of-Thought Prompting (مايو 2022)', description: 'أثبت أن بنية البرومبت يمكن أن تستحضر تفكيرًا تدريجيًا — حوّل البرومبت إلى سقالة معرفية' },
          { '@type': 'ListItem', position: 5, name: 'إطلاق ChatGPT (نوفمبر 2022)', description: 'جلب هندسة البرومبت إلى الوعي العام؛ بدأ الملايين بالتجربة بين ليلة وضحاها' },
          { '@type': 'ListItem', position: 6, name: '"مهندس برومبت" كمسمى وظيفي (الربع الأول 2023)', description: 'عرّف هندسة البرومبت كمهنة معترف بها ومهارة مسمّاة' },
          { '@type': 'ListItem', position: 7, name: 'GPT-4 والبرومبتات متعددة الوسائط (مارس 2023)', description: 'وسّع هندسة البرومبت إلى ما بعد النص ليشمل المدخلات المرئية ونوافذ السياق الكبيرة' },
          { '@type': 'ListItem', position: 8, name: 'أطر هندسة البرومبت (2023)', description: 'حوّل هندسة البرومبت من حرفة شخصية إلى ممارسة قابلة للتعليم والمشاركة' },
          { '@type': 'ListItem', position: 9, name: 'تحسين البرومبتات الآلي (2023–2024)', description: 'أظهرت نماذج اللغة الكبيرة قدرتها على كتابة البرومبتات بجودة تضاهي البشر؛ أصبح التحسين الآلي للبرومبتات عمليًا' },
          { '@type': 'ListItem', position: 10, name: 'نماذج الأوزان المفتوحة وسياق مليون رمز (2024)', description: 'نماذج مفتوحة المصدر للنشر الخاص؛ حوّل السياق الضخم التركيز إلى هندسة السياق' },
          { '@type': 'ListItem', position: 11, name: 'أوضاع التفكير الممتد والاستدلال (الربع الأول–الثاني 2025)', description: 'استوعبت النماذج التفكير التدريجي داخليًا؛ أصبح Chain-of-Thought على مستوى البرومبت اختياريًا في النماذج المتقدمة' },
          { '@type': 'ListItem', position: 12, name: 'LLaMA 4 MoE وسياق 10 ملايين رمز (الربع الثالث–الرابع 2025)', description: 'بلغت نماذج الأوزان المفتوحة جودة قريبة من النماذج المتقدمة؛ خفّضت بنية MoE تكاليف الحوسبة للاستضافة الذاتية' },
          { '@type': 'ListItem', position: 13, name: 'تصميم السياق كممارسة معيارية (2026)', description: 'أصبح البرومبت طبقة واحدة ضمن سياق مركّب — يتطلب تفكيرًا على مستوى النظام؛ أصبحت مهارة هندسة البرومبت جزءًا من كل الأدوار المستخدمة للذكاء الاصطناعي' },
        ],
      },
      sections: {
        definition: {
        ...
        context: {
          ...
          content: [
            ...
            'عدة تطورات سرّعت هذا التحوّل. جعلت نماذج فئة Llama 3 من Meta (2024) LLMs مفتوحة المصدر قادرة للنشر الخاص. نمت نوافذ السياق إلى مليون رمز أو أكثر (Gemini 3.1 Pro).',
          ],
        },
        beyond2026: {
    ...
    pt: {
      ...
      educationalLevel: 'Beginner',
      primaryTerm: 'História do Prompt Engineering',
      schema: {
        '@context': 'https://schema.org',
        '@type': 'TechArticle',
      ...
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        name: 'Linha do tempo da evolução do Prompt Engineering: 2018–2026',
        description: 'Uma linha do tempo cronológica dos principais marcos, artigos de pesquisa e lançamentos de modelos que moldaram a evolução do prompt engineering entre 2018 e 2026.',
        url: 'https://www.promptquorum.com/pt/prompt-engineering/how-prompt-engineering-evolved#timeline',
        inLanguage: 'pt-BR',
        numberOfItems: 13,
        itemListElement: [
          { '@type': 'ListItem', position: 1, name: 'Lançamento do BERT e GPT-2 (2018–2019)', description: 'Demonstrou que modelos transformer podiam ser guiados pela formulação da entrada — mas ainda sem disciplina formal' },
          { '@type': 'ListItem', position: 2, name: 'Aprendizado few-shot do GPT-3 (2020)', description: 'Estabeleceu o few-shot prompting como paradigma: reescrever o prompt muda o comportamento do modelo sem retreinamento' },
          { '@type': 'ListItem', position: 3, name: 'InstructGPT e RLHF (janeiro de 2022)', description: 'Modelos treinados para seguir instruções — tornou a qualidade do prompt muito mais consequente' },
          { '@type': 'ListItem', position: 4, name: 'Chain-of-Thought prompting (maio de 2022)', description: 'Provou que a estrutura do prompt pode induzir raciocínio passo a passo — transformou o prompting em um andaime cognitivo' },
          { '@type': 'ListItem', position: 5, name: 'Lançamento do ChatGPT (novembro de 2022)', description: 'Trouxe o prompt engineering para a consciência popular; milhões começaram a experimentar da noite para o dia' },
          { '@type': 'ListItem', position: 6, name: '"Prompt Engineer" como cargo (1º trim. 2023)', description: 'Definiu o prompt engineering como profissão reconhecida e habilidade nomeada' },
          { '@type': 'ListItem', position: 7, name: 'GPT-4 e prompting multimodal (março de 2023)', description: 'Estendeu o prompt engineering além do texto para entradas visuais e janelas de contexto grandes' },
          { '@type': 'ListItem', position: 8, name: 'Frameworks de prompt engineering (2023)', description: 'Transformou o prompt engineering de um ofício pessoal em uma prática ensinável e compartilhável' },
          { '@type': 'ListItem', position: 9, name: 'Otimização automatizada de prompts (2023–2024)', description: 'LLMs mostraram-se capazes de escrever prompts tão bem quanto humanos; a otimização automatizada de prompts tornou-se prática' },
          { '@type': 'ListItem', position: 10, name: 'Modelos de pesos abertos e contexto de 1M (2024)', description: 'LLMs de código aberto para implantação privada; o contexto massivo deslocou o foco para o context engineering' },
          { '@type': 'ListItem', position: 11, name: 'Modos de raciocínio estendido (1º–2º trim. 2025)', description: 'Modelos internalizam o raciocínio passo a passo; o CoT no nível do prompt torna-se opcional em modelos de fronteira' },
          { '@type': 'ListItem', position: 12, name: 'LLaMA 4 MoE e contexto de 10M (3º–4º trim. 2025)', description: 'Modelos de pesos abertos atingem qualidade quase de fronteira; a arquitetura MoE reduz custos de computação para self-hosting' },
          { '@type': 'ListItem', position: 13, name: 'Context design como prática padrão (2026)', description: 'O prompting torna-se uma camada em um contexto composto — exige pensamento em nível de sistema; a habilidade de prompt engineering está incorporada em todas as funções que usam IA' },
        ],
      },
      sections: {
        definition: {
        ...
        context: {
          ...
          content: [
            ...
            'Vários desenvolvimentos aceleraram essa mudança. Os modelos da família Llama 3 da Meta (2024) tornaram disponíveis LLMs de código aberto capazes para implantações privadas. Os context windows cresceram para 1 milhão de tokens ou mais (Gemini 3.1 Pro). Frameworks multi-agente como LangChain e AutoGen transformaram o prompting em orquestração.',
          ],
        },
        ...
        timeline: {
          ...
          rows: [
            ...
            { 'Ano': '2024', 'Marco': 'Modelos família Llama 3; context windows superam 1M tokens (Gemini 3.1 Pro)', 'Por que importa': 'LLMs de código aberto para implantações privadas; o contexto massivo deslocou o foco para o context engineering' },
    ...
    fr: {
      ...
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        name: 'Chronologie de l\'évolution du Prompt Engineering : 2018–2026',
        description: 'Une chronologie des étapes clés, articles de recherche et sorties de modèles qui ont façonné l\'évolution du prompt engineering de 2018 à 2026.',
        url: 'https://www.promptquorum.com/fr/prompt-engineering/how-prompt-engineering-evolved#timeline',
        inLanguage: 'fr',
        numberOfItems: 13,
        itemListElement: [
          { '@type': 'ListItem', position: 1, name: 'Sortie de BERT et GPT-2 (2018–2019)', description: 'A démontré que les modèles transformers pouvaient être guidés par la formulation de l\'entrée — mais sans discipline formelle encore' },
          { '@type': 'ListItem', position: 2, name: 'Apprentissage few-shot de GPT-3 (2020)', description: 'A établi le few-shot prompting comme paradigme : réécrire le prompt change le comportement du modèle sans réentraînement' },
          { '@type': 'ListItem', position: 3, name: 'InstructGPT et RLHF (janvier 2022)', description: 'Modèles entraînés à suivre des instructions — a rendu la qualité du prompt bien plus déterminante' },
          { '@type': 'ListItem', position: 4, name: 'Chain-of-Thought prompting (mai 2022)', description: 'A prouvé que la structure du prompt pouvait susciter un raisonnement étape par étape — a transformé le prompting en échafaudage cognitif' },
          { '@type': 'ListItem', position: 5, name: 'Lancement de ChatGPT (novembre 2022)', description: 'A fait entrer le prompt engineering dans la conscience du grand public ; des millions de personnes ont commencé à expérimenter du jour au lendemain' },
          { '@type': 'ListItem', position: 6, name: '« Prompt Engineer » comme intitulé de poste (T1 2023)', description: 'A défini le prompt engineering comme une profession reconnue et une compétence nommée' },
          { '@type': 'ListItem', position: 7, name: 'GPT-4 et prompting multimodal (mars 2023)', description: 'A étendu le prompt engineering au-delà du texte, aux entrées visuelles et aux grandes fenêtres de contexte' },
          { '@type': 'ListItem', position: 8, name: 'Frameworks de prompt engineering (2023)', description: 'A transformé le prompt engineering d\'un savoir-faire personnel en une pratique enseignable et partageable' },
          { '@type': 'ListItem', position: 9, name: 'Optimisation automatisée des prompts (2023–2024)', description: 'Les LLM se sont montrés capables d\'écrire des prompts aussi bien que des humains ; l\'optimisation automatisée des prompts est devenue viable' },
          { '@type': 'ListItem', position: 10, name: 'Modèles à poids ouverts et contexte de 1M (2024)', description: 'LLM open source pour un déploiement privé ; un contexte massif a déplacé l\'attention vers le context engineering' },
          { '@type': 'ListItem', position: 11, name: 'Modes de raisonnement étendu (T1–T2 2025)', description: 'Les modèles internalisent le raisonnement étape par étape ; le CoT au niveau du prompt devient optionnel sur les modèles de pointe' },
          { '@type': 'ListItem', position: 12, name: 'LLaMA 4 MoE et contexte de 10M (T3–T4 2025)', description: 'Les modèles à poids ouverts atteignent une qualité proche des modèles de pointe ; l\'architecture MoE réduit les coûts de calcul pour l\'auto-hébergement' },
          { '@type': 'ListItem', position: 13, name: 'Le context design comme pratique standard (2026)', description: 'Le prompting devient une couche dans un contexte composé — une réflexion au niveau du système est requise ; la compétence de prompt engineering est intégrée dans tous les rôles utilisant l\'IA' },
        ],
      },
      sections: {
        definition: {
        ...
        skill: {
          ...
          content: [
            'Entre 2021 et début 2022, la conception de prompts est passée des articles de recherche aux communautés de praticiens. Des dépôts GitHub avec des collections de prompts curatées sont apparus — des listes de style « awesome-prompts » partageant ce qui fonctionnait pour l\'assistance au codage, la résumation et l\'écriture créative. Des collections de prompts, partagées sur Twitter et Reddit, sont devenues des actifs communautaires. Le Prompt Engineering Guide ([promptingguide.ai](https://promptingguide.ai)) [External: Prompt Engineering Guide – promptingguide.ai] est devenu l\'une des premières références dédiées à cataloguer les techniques de manière systématique.',
        ...
        timeline: {
          ...
          rows: [
            ...
            { 'Année': '2024', 'Jalon': 'Modèles de la classe Llama 3 ; fenêtres de contexte dépassant 1M de tokens (Gemini 3.1 Pro)', 'Pourquoi c\'est important': 'LLM open source pour déploiement privé ; le contexte massif a déplacé l\'attention vers l\'ingénierie de contexte' },
    ...
    ja: {
      ...
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        name: 'プロンプトエンジニアリング進化タイムライン：2018〜2026年',
        description: '2018年から2026年までのプロンプトエンジニアリングの進化を形作った主要なマイルストーン、研究論文、モデルのリリースを年代順にまとめたタイムライン。',
        url: 'https://www.promptquorum.com/ja/prompt-engineering/how-prompt-engineering-evolved#timeline',
        inLanguage: 'ja',
        numberOfItems: 13,
        itemListElement: [
          { '@type': 'ListItem', position: 1, name: 'BERTとGPT-2のリリース（2018〜2019年）', description: 'トランスフォーマーモデルが入力表現によって誘導できることを示したが、まだ正式な学問分野ではなかった' },
          { '@type': 'ListItem', position: 2, name: 'GPT-3のFew-Shot学習（2020年）', description: 'Few-Shotプロンプティングをパラダイムとして確立：プロンプトを書き換えることで再学習なしにモデルの挙動が変化する' },
          { '@type': 'ListItem', position: 3, name: 'InstructGPTとRLHF（2022年1月）', description: '指示に従うよう訓練されたモデル — プロンプトの品質がはるかに重要になった' },
          { '@type': 'ListItem', position: 4, name: 'Chain-of-Thoughtプロンプティング（2022年5月）', description: 'プロンプトの構造が段階的な推論を引き出せることを証明 — プロンプティングを認知的な足場に変えた' },
          { '@type': 'ListItem', position: 5, name: 'ChatGPTのローンチ（2022年11月）', description: 'プロンプトエンジニアリングを一般的な認知にもたらした；数百万人が一夜にして実験を開始' },
          { '@type': 'ListItem', position: 6, name: '職種としての「プロンプトエンジニア」（2023年第1四半期）', description: 'プロンプトエンジニアリングを認知された職業かつ名前の付いたスキルとして定義' },
          { '@type': 'ListItem', position: 7, name: 'GPT-4とマルチモーダルプロンプティング（2023年3月）', description: 'プロンプトエンジニアリングをテキストを超えて視覚入力と大規模コンテキストウィンドウへ拡張' },
          { '@type': 'ListItem', position: 8, name: 'プロンプトエンジニアリングのフレームワーク（2023年）', description: 'プロンプトエンジニアリングを個人的な技巧から教育可能で共有可能な実践へと変えた' },
          { '@type': 'ListItem', position: 9, name: '自動プロンプト最適化（2023〜2024年）', description: 'LLMが人間と同等にプロンプトを書けることが示され、自動プロンプト最適化が実用化された' },
          { '@type': 'ListItem', position: 10, name: 'オープンウェイトモデルと100万トークンコンテキスト（2024年）', description: 'プライベート展開向けのオープンソースLLM；大規模なコンテキストがコンテキストエンジニアリングへと焦点を移した' },
          { '@type': 'ListItem', position: 11, name: '拡張思考・推論モード（2025年第1〜2四半期）', description: 'モデルが段階的推論を内部化；プロンプトレベルのCoTはフロンティアモデルでオプション化' },
          { '@type': 'ListItem', position: 12, name: 'LLaMA 4 MoEと1,000万トークンコンテキスト（2025年第3〜4四半期）', description: 'オープンウェイトモデルがフロンティアに近い品質に到達；MoEアーキテクチャがセルフホスティングの計算コストを削減' },
          { '@type': 'ListItem', position: 13, name: '標準的な実践としてのコンテキスト設計（2026年）', description: 'プロンプティングは構成されたコンテキストの一層となる — システムレベルの思考が求められる；プロンプトエンジニアリングのスキルはAIを使うすべての役割に組み込まれる' },
        ],
      },
      sections: {
        definition: {
        ...
        pqTest: {
          ...
          content: [
            'PromptQuorumは同じタスク — CO-STARフレームワークで構造化された — をGPT-5.6、Claude Opus 5、Gemini 3.1 Proに送信しました。3つのモデル全てが最初の試行でフォーマット準拠、長さ準拠の回答を生成しました。フレームワークなしの同じタスクは、モデル間で平均2～3回の修正ラウンドが必要でした、有用な出力に到達するために。',
        ...
        timeline: {
          ...
          rows: [
            ...
            { '年': '2024年', 'マイルストーン': 'Llama 3クラスのモデル；コンテキストウィンドウが100万トークンを超える（Gemini 3.1 Pro）', '重要な理由': 'プライベート展開のためのオープンソースLLM；大規模なコンテキストがコンテキストエンジニアリングへの焦点のシフトを加速した' },
    ...
    zh: {
      ...
      itemListSchema: {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        name: '提示词工程演变时间线：2018–2026年',
        description: '一份按时间顺序排列的时间线，记录了塑造2018年至2026年间提示词工程演变的关键里程碑、研究论文和模型发布。',
        url: 'https://www.promptquorum.com/zh/prompt-engineering/how-prompt-engineering-evolved#timeline',
        inLanguage: 'zh',
        numberOfItems: 13,
        itemListElement: [
          { '@type': 'ListItem', position: 1, name: 'BERT与GPT-2发布（2018–2019年）', description: '证明了Transformer模型可以通过输入措辞来引导——但尚未形成正式学科' },
          { '@type': 'ListItem', position: 2, name: 'GPT-3少样本学习（2020年）', description: '确立了少样本提示作为一种范式：重写提示词无需重新训练即可改变模型行为' },
          { '@type': 'ListItem', position: 3, name: 'InstructGPT与RLHF（2022年1月）', description: '训练模型遵循指令——使提示词质量的影响大大增加' },
          { '@type': 'ListItem', position: 4, name: '思维链提示（2022年5月）', description: '证明提示词结构可以引出逐步推理——将提示从技巧转变为认知支架' },
          { '@type': 'ListItem', position: 5, name: 'ChatGPT发布（2022年11月）', description: '将提示工程带入大众视野；数百万人一夜之间开始尝试' },
          { '@type': 'ListItem', position: 6, name: '"提示工程师"成为职位名称（2023年第一季度）', description: '将提示工程确立为一个被认可的职业和专门技能' },
          { '@type': 'ListItem', position: 7, name: 'GPT-4与多模态提示（2023年3月）', description: '将提示工程从文本扩展到视觉输入和大型上下文窗口' },
          { '@type': 'ListItem', position: 8, name: '提示工程框架（2023年）', description: '将提示工程从个人手艺转变为可教授、可分享的实践' },
          { '@type': 'ListItem', position: 9, name: '自动化提示优化（2023–2024年）', description: '大语言模型被证明能够像人类一样撰写提示词；自动化提示优化变得实用' },
          { '@type': 'ListItem', position: 10, name: '开放权重模型与100万token上下文（2024年）', description: '面向私有部署的开源大语言模型；海量上下文将重心转向上下文工程' },
          { '@type': 'ListItem', position: 11, name: '扩展思考与推理模式（2025年第一至第二季度）', description: '模型将逐步推理内部化；提示层面的思维链在前沿模型上变为可选' },
          { '@type': 'ListItem', position: 12, name: 'LLaMA 4 MoE与1000万token上下文（2025年第三至第四季度）', description: '开放权重模型达到接近前沿的质量；MoE架构降低了自托管的算力成本' },
          { '@type': 'ListItem', position: 13, name: '上下文设计成为标准实践（2026年）', description: '提示成为组合上下文中的一层——需要系统级思维；提示工程技能已融入所有使用AI的角色' },
        ],
      },
      sections: {
        definition: {
        ...
        context: {
          ...
          content: [
            ...
            '多项发展加速了这一转变。Meta 的 Llama 3 系列模型（2024年）使强大的开源大型语言模型可用于私有部署，将部分提示词工程从云端 API 转移到本地基础设施。上下文窗口增长到100万词元或更多（Gemini 3.1 Pro），使得将整个代码库、书籍或文档集合注入单个提示词成为可行。LangChain 和 AutoGen 等多智能体框架将提示变成了编排——一个提示词触发另一个模型，该模型触发一个工具，工具将上下文返回给下一个提示词。',
          ],
        },
        ...
        timeline: {
          ...
          rows: [
            ...
            { '年份': '2024年', '里程碑': 'Llama 3 系列模型；上下文窗口超过100万词元（Gemini 3.1 Pro）', '重要意义': '开源大型语言模型支持私有部署；超大上下文窗口将重心转移至上下文工程' },
      ...
      sections: {
        ...
        timeline: {
          ...
          rows: [
            ...
            { '연도': '2024', '이정표': 'Llama 3 계열 모델; 컨텍스트 창이 100만 토큰 초과 (Gemini 3.1 Pro)', '중요성': '프라이빗 배포를 위한 오픈소스 LLM; 방대한 컨텍스트가 컨텍스트 엔지니어링으로 초점 이동' },
        ...
        relatedReading: {
          ...
          items: [
            ...
            { title: '컨텍스트 창 설명: AI가 잊어버리는 이유', url: '/prompt-engineering/context-windows-explained-why-ai-forgets' },
            { title: '토큰, 비용 및 한계: AI 프롬프팅의 경제학', url: '/prompt-engineering/tokens-costs-limits-economics-of-ai-prompting' },
          ],
        },
