...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      metaDescription: 'هندسة البرومبت مرّت بـ7 مراحل من GPT-3 (2020) إلى تصميم السياق (2026). خط زمني شامل مع أكثر من 12 استشهاداً بحثياً وأساطير مدحوضة وتحليل عميق.',
      publishDate: '2026-03-01',
      dateModified: '2026-05-03',
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            { title: '퓨샷 프롬프팅: 예제의 힘', url: '/prompt-engineering/few-shot-prompting' },
