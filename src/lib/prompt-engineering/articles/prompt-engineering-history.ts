...
export const article: Partial<Record<Language, PEArticle>> = {
      ...
      sections: {
        ...
        relatedReading: {
          ...
          items: [
            ...
            { title: 'Few-Shot Prompting: The Power of Examples', url: '/prompt-engineering/few-shot-prompting' },
    ...
    es: {
      ...
      schema: {
        ...
        datePublished: '2026-03-01',
        dateModified: '2026-05-03',
        url: 'https://www.promptquorum.com/es/es/prompt-engineering/how-prompt-engineering-evolved',
        inLanguage: 'es',
    ...
    ar: {
      ...
      seoTitle: 'هل ماتت هندسة البرومبت؟ تطورها في 2026',
      ...
      metaDescription: 'هندسة البرومبت مرّت بـ7 مراحل من GPT-3 (2020) إلى تصميم السياق (2026). خط زمني مع استشهادات بحثية وأساطير مدحوضة.',
      publishDate: '2026-03-01',
      dateModified: '2026-05-03',
