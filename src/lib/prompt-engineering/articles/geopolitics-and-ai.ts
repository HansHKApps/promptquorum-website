...
export const article: Record<Language, PEArticle> = {
    en: {
      ...
      seoTitle: 'EU vs US vs China 2026: AI Regulatory Comparison',
      metaDescription: 'Compare EU AI Act enforcement, US sectoral approach, and China CAC control: frameworks, compliance deadlines, and geopolitical risks for AI.',
        ...
        commonMistakes: {
          ...
          mistakes: [
            ...
            },
            {
              ...
              problem: 'DeepSeek R1 (January 2025) matched GPT-4o on major benchmarks while training on restricted H800 GPUs at ~$6M compute cost — 94% cheaper than GPT-4 training estimates. Export controls slow Chinese progress but do not stop it.',
            ...
            {
              mistake: 'Assuming proprietary US models (GPT-4o, Claude) will remain available globally without regulatory friction.',
              problem: 'The EU AI Act already applies compliance obligations to GPT-4o and Claude. Future EU regulation could restrict export of data or require on-premises deployment for sensitive use cases. China\'s domestic substitution strategy (Made in China 2025) may limit foreign model access.',
    ...
    de: {
      ...
      metaDescription: 'EU AI Act 2026, US CHIPS Act und Chinas KI-Strategie: Regulierungsfragen, Compliance-Anforderungen, Geopolitik und Auswirkungen auf Ihr Geschäft.',
      seoTitle: 'KI-Geopolitik 2026: EU AI Act vs. USA vs. China',
      publishDate: '2026-04-01',
      dateModified: '2026-04-02',
    ...
    fr: {
      ...
      metaDescription: 'Cadre réglementaire IA : EU AI Act (2026) vs approche sectorielle US vs CAC chinois. Délais de conformité, risques géopolitiques et implications.',
      seoTitle: 'Géopolitique IA 2026 : EU vs États-Unis vs Chine',
      publishDate: '2026-04-01',
      dateModified: '2026-04-02',
    ...
    ja: {
      ...
      metaDescription: 'EU AI法、米国CHIPS法、中国CAC規制の比較。規制リスク、コンプライアンス期限、日本企業への地政学的影響。2026年の選択肢を解説。',
      seoTitle: 'AI地政学2026年解説：EU・米国・中国の規制戦略比較',
      publishDate: '2026-04-01',
      dateModified: '2026-04-02',
      readTime: '16分で読める',
      educationalLevel: 'Intermediate',
    ...
    zh: {
      ...
      seoTitle: 'AI地缘政治2026年对比：欧盟・美国・中国战略',
      metaDescription: 'AI地缘政治2026完全对比分析：欧盟AI法案、美国分部门监管、中国CAC控制体系。法律框架、合规期限、地缘政治风险及全球AI部署影响解读。',
      publishDate: '2026-04-01',
