...
export const article: Record<Language, PEArticle> = {
    ...
    fr: {
      ...
      metaDescription: 'Loi IA de l\'UE vs approche sectorielle US vs stratégie CAC chinoise : cadres réglementaires, délais et implications pour les organisations. 2026.',
    ...
    zh: {
      ...
      metaDescription: '欧盟AI法案、美国CHIPS法案、中国CAC规制的政策对比。规制框架、合规期限、地缘政治风险及组织部署影响分析。',
      publishDate: '2026-04-01',
