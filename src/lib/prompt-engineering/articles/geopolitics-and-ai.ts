...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      metaDescription: 'قانون الاتحاد الأوروبي للذكاء الاصطناعي وضوابط التصدير الأمريكية وCAC الصيني: 3 أطر متعارضة تؤثر على مشتريات الذكاء الاصطناعي وإقامة البيانات في 2026.',
