...
export const article: Record<Language, PEArticle> = {
    en: {
      ...
      metaDescription: 'How AI reshapes geopolitics: analyze US sectoral, EU AI Act, and China CAC strategies. Compare regulatory frameworks, compliance risks, and global implications.',
    ...
    de: {
      ...
      metaDescription: 'AI in der Geopolitik 2026: Analysieren Sie US-Sektorpolitik, EU AI Act und Chinas CAC-Strategie. Vergleichen Sie Regulierungsrahmen, Compliance-Risiken, globale Auswirkungen.',
    ...
    fr: {
      ...
      metaDescription: 'IA et géopolitique 2026 : analysez l\'approche sectorielle US, l\'EU AI Act et la stratégie CAC chinoise. Comparez les cadres réglementaires, risques et implications globales.',
      seoTitle: 'Analyse Géopolitique IA 2026: USA, UE et Chine',
      publishDate: '2026-04-01',
      dateModified: '2026-04-02',
    ...
    ja: {
      ...
      metaDescription: 'AIが地政学を変える2026年。米国セクター別規制、EU AI法、中国CAC戦略を分析。規制フレームワーク、コンプライアンスリスク、グローバル影響を比較解説。',
    ...
    zh: {
      ...
      metaDescription: 'AI如何改变地缘政治2026年：分析美国分部门监管、欧盟AI法案、中国CAC战略。对比法律框架、合规风险、全球AI部署影响。',
      publishDate: '2026-04-01',
