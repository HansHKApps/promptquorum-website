...
export const article: Partial<Record<Language, PEArticle>> = {
    en: {
      ...
      current_models_mentioned: ['Qwen 2.5', 'ERNIE 4.0', 'Doubao', 'Z.ai GLM-4', 'DeepSeek R1', 'GPT-4o', 'Claude Opus 4.8', 'Gemini 3.1 Pro', 'Mistral Large 2'],
    ...
    zh: {
      ...
      howToSchema: {
        ...
        step: [
          { '@type': 'HowToStep', position: 1, name: '了解中国可用的AI模型', text: '外国模型（GPT-4o、Claude、Gemini）在中国大陆无法在不使用VPN的情况下访问。可用选项：Alibaba Qwen 2.5（开源权重，7B–72B，128K上下文）、Baidu ERNIE 4.0（Qianfan API）、ByteDance Doubao（Volcano Engine）、Z.ai GLM-4、DeepSeek R1/V3。Qwen 2.5 72B是自托管的最强开源权重选项。' },
