...
export const article: Partial<Record<Language, PEArticle>> = {
    ...
    ar: {
      ...
      seoTitle: 'الموجّهات المقيّدة: مخرجات ذكاء اصطناعي منظّمة',
      metaDescription: 'أتقن الموجّهات المقيّدة لإجبار الذكاء الاصطناعي على إنتاج JSON وXML وتنسيقات منظّمة. 5 تقنيات مع أمثلة حقيقية لـGPT-5.5 وClaude وGemini.',
