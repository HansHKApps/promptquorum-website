      ...
      sections: {
        ...
        quickFacts: {
          ...
          items: [
            ...
            '**Model adherence:** GPT-5.6 and Claude Opus 5 follow hard constraints at ~95% on well-formed prompts',
      ...
      sections: {
        ...
        quickFacts: {
          ...
          items: [
            ...
            '**Adherencia de los modelos:** GPT-5.6 y Claude Opus 5 siguen constraints estrictas con ~95 % en prompts bien formados',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: '¿Funciona el constrained prompting en GPT-5.6, Claude y Gemini?', a: 'Sí — los tres soportan constrained prompting. GPT-5.6 y Claude Opus 5 siguen constraints de formato estrictas (JSON, tablas, límites de palabras) con aproximadamente un 95 % de adherencia en prompts bien formados. Gemini 3.1 Pro puntúa de forma similar pero puede interpretar constraints ambiguas de manera diferente. Siempre prueba entre modelos.' },
      ...
      sections: {
        ...
        quickFacts: {
          ...
          items: [
            ...
            '**التزام النماذج:** يتبع GPT-5.6 وClaude Opus 5 القيود الصارمة بنسبة ~95% في الموجّهات المنسّقة جيدًا',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'هل تعمل الموجّهات المقيّدة مع GPT-5.6 وClaude وGemini؟', a: 'نعم — الثلاثة يدعمونها. يتبع GPT-5.6 وClaude Opus 5 القيود الصارمة بنسبة ~95% في الموجّهات المنسّقة جيدًا. Gemini 3.1 Pro يُحقق نتائج مماثلة. دائمًا اختبر عبر النماذج.' },
    ...
    pt: {
      ...
      faqSchema: {
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'O constrained prompting funciona no GPT-5.6, Claude e Gemini?', acceptedAnswer: { '@type': 'Answer', text: 'Sim — os três suportam constrained prompting. GPT-5.6 e Claude Opus 5 seguem restrições de formato estrito (JSON, tabelas, limites de palavras) com ~95% de adesão em prompts bem formados. Os três também suportam aplicação de restrições no nível da API via structured outputs.' } },
      ...
      sections: {
        ...
        quickFacts: {
          ...
          items: [
            ...
            '**Adesão dos modelos:** GPT-5.6 e Claude Opus 5 seguem restrições estritas com ~95% em prompts bem formados',
        ...
        faqSection: {
          ...
          faqs: [
            ...
            { q: 'O constrained prompting funciona no GPT-5.6, Claude e Gemini?', a: 'Sim — os três suportam constrained prompting. GPT-5.6 e Claude Opus 5 seguem restrições de formato estrito com ~95% de adesão em prompts bem formados. Gemini 3.1 Pro pontua de forma similar. Sempre teste entre modelos.' },
    ...
    sections: {
      ...
      quickFacts: {
        ...
        items: [
          ...
          '**모델 준수율:** GPT-5.6와 Claude Opus 5은 잘 형성된 프롬프트에서 강한 제약을 약 95%의 준수율로 따릅니다',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: '제약 프롬프팅은 GPT-5.6, Claude, Gemini에서 작동합니까?', a: '예 — 세 모델 모두 제약 프롬프팅을 지원합니다. GPT-5.6와 Claude Opus 5은 잘 형성된 프롬프트에서 강한 형식 제약(JSON, 표, 단어 제한)을 약 95%의 준수율로 따릅니다. Gemini 3.1 Pro도 비슷한 점수를 보이지만 모호한 제약을 다르게 해석할 수 있습니다. 항상 여러 모델에서 테스트하십시오.' },
