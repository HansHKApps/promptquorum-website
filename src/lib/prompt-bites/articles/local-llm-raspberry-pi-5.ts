...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  de: {
    ...
    metaDescription: 'Ja, aber nur winzige Modelle: Raspberry Pi 5 (8GB) läuft 1B-3B-Modelle bei Q4 via llama.cpp, mit etwa 2-5 Tokens/Sek. auf der CPU. Keine GPU-Beschleunigung verfügbar.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  es: {
    ...
    metaDescription: 'Sí, pero solo modelos diminutos: la Raspberry Pi 5 (8GB) ejecuta modelos de 1B-3B en Q4 vía llama.cpp, a unos 2-5 tokens/seg en CPU. No hay aceleración por GPU disponible.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  pt: {
    ...
    metaDescription: 'Sim, mas apenas modelos pequenos: o Raspberry Pi 5 (8GB) roda modelos de 1B-3B em Q4 via llama.cpp, a aproximadamente 2-5 tokens/s na CPU. Nenhuma aceleração de GPU está disponível.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
