...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  de: {
    ...
    seoTitle: 'RAG mit 2 GB RAM? | Prompt Bites | PromptQuorum',
    metaDescription: 'Vollständiges RAG benötigt 8+ GB RAM. Mit 2 GB RAM funktionieren nur kleine Modelle (Phi-2, TinyLlama). Das Embedding-Modell benötigt weitere 0,5–1 GB. Kurze Antwort von PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  fr: {
    ...
    metaDescription: 'RAG complet nécessite 8+ Go de RAM. Avec 2 Go, seuls les petits modèles (Phi-2, TinyLlama) fonctionnent pour le LLM. Le modèle d\'embedding ajoute 0,5–1 Go. Réponse rapide par PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  zh: {
    ...
    seoTitle: '2 GB 内存能运行 RAG 吗？ | Prompt Bites | PromptQuorum',
