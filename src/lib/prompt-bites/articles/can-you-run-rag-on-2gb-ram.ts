...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  de: {
    ...
    metaDescription: 'Mit 2 GB RAM ist ein RAG-Pipeline möglich: Llama 3.2 1B (~750 MB) mit MiniLM-L6-v2-Embeddings (~80 MB). Gesamtspeicher ~1,3–1,5 GB. Für größere Korpora sind 8 GB erforderlich.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  fr: {
    ...
    metaDescription: 'Avec 2 Go de RAM, un pipeline RAG est possible : Llama 3.2 1B (~750 Mo) avec MiniLM-L6-v2 (~80 Mo) et un vector store en mémoire. Total ~1,3–1,5 Go. Les corpus plus grands nécessitent 8 Go minimum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  ja: {
    ...
    metaDescription: '2 GB RAMでRAGパイプラインが可能：Llama 3.2 1B（~750 MB）とMiniLM-L6-v2 Embeddings（~80 MB）でインメモリベクターストアを使用。合計~1.3–1.5 GBで2 GBデバイスに収まります。',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  zh: {
    ...
    metaDescription: '2 GB 内存可运行 RAG 管道：Llama 3.2 1B（~750 MB）配合 MiniLM-L6-v2 Embeddings（~80 MB）和内存向量数据库。总计 ~1.3–1.5 GB，适合 2 GB 设备。大型语料库需要 8 GB 以上。',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
