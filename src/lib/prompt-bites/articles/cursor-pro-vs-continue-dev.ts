  ...
  en: {
    ...
    sections: {
      ...
      bestPick: {
        ...
        content: [
          '<strong>Cursor Pro is the best pick if you mostly use cloud frontier models (Claude 4.6 Sonnet, GPT-class) and want a polished IDE. Continue.dev is no longer an option — it was acquired by Cursor on June 18, 2026 and is shutting down. The best free open-source replacement is Cline.</strong>',
          'Cursor Pro at $20/month bundles model usage with a tightly integrated editor — agent mode, repo-wide context, predictive edits. The plan now includes unlimited Auto mode (Cursor routes to the best model at flat rates) plus a $20 monthly credit pool for manually selected premium models like Claude 4.6 Sonnet or GPT. For developers who do not already pay for Claude or OpenAI APIs, that $20 is competitive with what model usage alone would cost.',
  ...
  de: {
    ...
    sections: {
      ...
      bestPick: {
        ...
        content: [
          '<strong>Cursor Pro ist die beste Wahl für Cloud-Frontier-Modelle (Claude 4.6 Sonnet, GPT-Klasse) mit polierter IDE. Continue.dev ist keine Option mehr — es wurde am 18. Juni 2026 von Cursor übernommen und stellt den Betrieb ein. Die beste kostenlose Open-Source-Alternative ist Cline.</strong>',
          'Cursor Pro für 20 €/Monat bündelt Modellnutzung mit einem eng integrierten Editor — Agent-Modus, repository-weiter Kontext, prädiktive Edits. Der Plan beinhaltet nun unbegrenzten Auto-Modus (Cursor wählt das Modell zu Flatrates) sowie einen monatlichen 20-$-Credit-Pool für manuell gewählte Premium-Modelle wie Claude 4.6 Sonnet.',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Der Auto-Modus ist unbegrenzt: Cursor wählt das Modell und berechnet Flatrates (1,25 $/Mio. Input, 6 $/Mio. Output), ohne den Credit-Pool zu belasten. Wählt man manuell ein Premium-Modell (Claude 4.6 Sonnet, GPT-5 usw.), wird der 20-$-Pool verbraucht. Vielnutzer, die Premium-Modelle manuell wählen, können den Pool erschöpfen; Pro+ für 60 €/Monat bietet 3-faches Nutzungskontingent.',
          },
        ],
      },
      related: {
  ...
  fr: {
    ...
    sections: {
      ...
      bestPick: {
        ...
        content: [
          '<strong>Cursor Pro est le meilleur choix pour les modèles cloud (Claude 4.6 Sonnet, classe GPT) avec un IDE soigné. Continue.dev n\'est plus une option — racheté par Cursor le 18 juin 2026 et arrêté. La meilleure alternative open source gratuite est Cline.</strong>',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Le mode Auto est illimité : Cursor choisit le modèle et facture à tarifs fixes (1,25 $/M input, 6 $/M output) sans puiser dans le pool. Sélectionner manuellement un modèle premium (Claude 4.6 Sonnet, GPT-5, etc.) consomme le pool de 20 $. Les gros utilisateurs qui sélectionnent manuellement des modèles premium peuvent l\'épuiser ; Pro+ à 60 €/mois offre 3x le quota d\'usage.',
          },
        ],
      },
      related: {
  ...
  ja: {
    ...
    sections: {
      ...
      bestPick: {
        ...
        content: [
          '<strong>クラウドフロンティアモデル（Claude 4.6 Sonnet、GPT級）と洗練IDEにはCursor Proがベスト。Continue.devはもう選択肢にありません — 2026年6月18日にCursorに買収・終了。最良の無料OSS代替はClineです。</strong>',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Autoモードは無制限：Cursorがモデルを選択しフラットレート（Input $1.25/M、Output $6/M）で課金、クレジットプールを消費しません。プレミアムモデル（Claude 4.6 Sonnet、GPT-5など）を手動選択すると$20プールが消費されます。手動でプレミアムモデルを多用するユーザーはプールを使い切る場合があり、Pro+（$60/月）なら3倍のクレジットが利用できます。',
          },
        ],
      },
      related: {
  ...
  zh: {
    ...
    sections: {
      ...
      bestPick: {
        ...
        content: [
          '<strong>云端前沿模型（Claude 4.6 Sonnet、GPT级）加精致IDE首选Cursor Pro。Continue.dev已不再是选项——2026年6月18日被Cursor收购关闭。最佳免费开源替代方案是Cline。</strong>',
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: 'Cursor Pro积分池如何运作？',
            a: 'Auto模式无限制：Cursor选择模型并按固定费率计费（输入$1.25/M，输出$6/M），不消耗积分池。手动选择高级模型（Claude 4.6 Sonnet、GPT-5等）则消耗$20积分池。重度使用高级模型的用户可能耗尽积分；Pro+套餐（$60/月）提供3倍配额。',
          },
        ],
      },
      related: {
  ...
  pt: {
    ...
    sections: {
      ...
      bestPick: {
        ...
        content: [
          '<strong>Cursor Pro é a melhor opção para modelos de fronteira em nuvem (Claude 4.6 Sonnet, GPT) com um IDE refinado. Continue.dev não é mais uma opção — adquirido pela Cursor em 18 de junho de 2026 e encerrado. A melhor alternativa gratuita open source é o Cline.</strong>',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'O modo Auto é ilimitado: o Cursor escolhe o modelo e cobra a tarifas fixas ($1,25/M input, $6/M output) sem consumir do pool. Selecionar manualmente um modelo premium (Claude 4.6 Sonnet, GPT-5, etc.) consome o pool de $20. Usuários intensivos que selecionam manualmente modelos premium podem esgotar o pool; o Pro+ a $60/mês oferece 3x o uso.',
          },
        ],
      },
      related: {
  ...
  es: {
    ...
    sections: {
      ...
      bestPick: {
        ...
        content: [
          '<strong>Cursor Pro es la mejor opción para modelos frontera en la nube (Claude 4.6 Sonnet, GPT) con un IDE pulido. Continue.dev ya no es una opción — adquirido por Cursor el 18 de junio de 2026 y cerrado. La mejor alternativa gratuita open source es Cline.</strong>',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'El modo Auto es ilimitado: Cursor elige el modelo y cobra a tarifas fijas ($1,25/M input, $6/M output) sin consumir del pool. Seleccionar manualmente un modelo premium (Claude 4.6 Sonnet, GPT-5, etc.) consume el pool de $20. Los usuarios intensivos que seleccionan modelos premium manualmente pueden agotarlo; Pro+ a $60/mes ofrece 3x el uso.',
          },
        ],
      },
      related: {
  ...
  ar: {
    ...
    sections: {
      ...
      bestPick: {
        ...
        content: [
          '<strong>Cursor Pro هو الأفضل لنماذج السحابة الحدّية (Claude 4.6 Sonnet وGPT) مع بيئة تطوير مصقولة. Continue.dev لم يعد خيارًا — استُحوذ عليه من Cursor في 18 يونيو 2026 وأُغلق. أفضل بديل مجاني مفتوح المصدر هو Cline.</strong>',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'وضع Auto غير محدود: يختار Cursor النموذج ويحسب بأسعار ثابتة ($1.25/مليون رمز إدخال، $6/مليون رمز إخراج) دون الاقتطاع من المجمع. اختيار نموذج مميز يدويًا (Claude 4.6 Sonnet وGPT-5 وغيرهما) يقتطع من مجمع $20. كثيفو الاستخدام الذين يختارون نماذج مميزة يدويًا قد يستنفدون المجمع؛ Pro+ بـ $60/شهر يمنح 3 أضعاف الاستخدام.',
          },
        ],
      },
      related: {
  ...
  ko: {
    ...
    sections: {
      ...
      bestPick: {
        ...
        content: [
          '<strong>클라우드 프론티어 모델(Claude 4.6 Sonnet, GPT 계열)과 세련된 IDE에는 Cursor Pro가 최선입니다. Continue.dev는 더 이상 선택지가 아닙니다 — 2026년 6월 18일 Cursor에 인수되어 종료되었습니다. 최고의 무료 오픈소스 대안은 Cline입니다.</strong>',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Auto 모드는 무제한입니다: Cursor가 모델을 선택하고 고정 요금(입력 $1.25/백만, 출력 $6/백만)으로 청구되며 크레딧 풀을 소모하지 않습니다. 프리미엄 모델(Claude 4.6 Sonnet, GPT-5 등)을 수동으로 선택하면 $20 풀을 소모합니다. 프리미엄 모델을 수동으로 많이 선택하는 사용자는 풀을 소진할 수 있으며, Pro+(월 $60)는 3배의 사용량을 제공합니다.',
          },
        ],
      },
      related: {
