...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    heroImage: '/images/best-mini-pc-for-ollama-server-always-on-overview-hero-en.png',
    type: 'comparison',
  ...
  de: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Hardware & Performance',
    heroImage: '/images/best-mini-pc-for-ollama-server-always-on-overview-hero-de.png',
    type: 'comparison',
  ...
  fr: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Hardware & Performance',
    heroImage: '/images/best-mini-pc-for-ollama-server-always-on-overview-hero-fr.png',
    type: 'comparison',
  ...
  ja: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Hardware & Performance',
    heroImage: '/images/best-mini-pc-for-ollama-server-always-on-overview-hero-ja.png',
    type: 'comparison',
  ...
  es: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Hardware & Performance',
    heroImage: '/images/best-mini-pc-for-ollama-server-always-on-overview-hero-es.png',
    type: 'comparison',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Sí. Configura OLLAMA_HOST=0.0.0.0 y Ollama sirve solicitudes desde cualquier dispositivo en tu LAN. Combina con Open WebUI (contenedor Docker) para interfaz basada en navegador accesible desde teléfonos, tablets y PCs. Maneja una solicitud simultánea sin problema.',
          },
          {
            q: '¿Valen la pena las configuraciones eGPU?',
            a: 'Para Ollama específicamente, una eGPU OCuLink (AOOSTAR GEM12 Pro + RTX 3090) es lo mejor de ambos mundos: velocidad GPU de escritorio con consumo eléctrico mini PC en reposo. OCuLink (PCIe 4.0 x4) entrega ~80% del ancho de banda de ranura PCIe x16 directa — suficiente para inferencia LLM con cuello de botella mínimo.',
          },
        ],
      },
    },
    faqSchema: {
      ...
      mainEntity: [
        ...
        {
          '@type': 'Question',
          name: '¿Funciona bien Ollama como servidor de red en un mini PC?',
          acceptedAnswer: { '@type': 'Answer', text: 'Sí. Configura OLLAMA_HOST=0.0.0.0 y Ollama sirve tu LAN. Combina con Open WebUI para interfaz navegador. Maneja una solicitud simultánea sin problema.' },
        },
      ],
    },
    itemListSchema: {
  ...
  pt: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Hardware & Performance',
    heroImage: '/images/best-mini-pc-for-ollama-server-always-on-overview-hero-pt.png',
    type: 'comparison',
  ...
  zh: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Hardware & Performance',
    heroImage: '/images/best-mini-pc-for-ollama-server-always-on-overview-hero-zh.png',
    type: 'comparison',
  ...
  ar: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Hardware & Performance',
    heroImage: '/images/best-mini-pc-for-ollama-server-always-on-overview-hero-ar.png',
    type: 'comparison',
    title: 'أفضل جهاز كمبيوتر مصغر لخادم ⁨Ollama⁩ الدائم التشغيل ⁨2026⁩',
    seoTitle: 'أفضل جهاز مصغر لخادم ⁨Ollama⁩ دائم ⁨2026⁩ | ⁨PromptQuorum⁩',
    metaDescription: 'شغّل ⁨Ollama 24/7⁩ بجهاز مصغر يستهلك ⁨15⁩–⁨35 W. Minisforum UM890 Pro⁩ يشغّل نماذج ⁨7B⁩ بـ⁨12⁩–⁨18⁩ رمز/ثانية. مقارنة شاملة مع ⁨AOOSTAR GEM12⁩ و⁨Beelink SER8⁩.',
    educationalLevel: 'Intermediate',
    affiliateDisclosure: true,
    publishDate: '2026-05-26',
    dateModified: '2026-07-02',
  ...
  ko: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Hardware & Performance',
    heroImage: '/images/best-mini-pc-for-ollama-server-always-on-overview-hero-ko.png',
    type: 'comparison',
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Ollama 설치 및 시작 가이드](/ko/local-llms/how-to-install-ollama)',
