...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: 'M4 Max beats M4 Pro for local LLMs on memory bandwidth (up to 546 GB/s vs 273 GB/s) and unified memory ceiling (up to 128GB vs 48GB) — faster tokens/sec at every model size.',
  ...
  ar: {
    ...
    metaDescription: 'يتفوق M4 Max على M4 Pro لتشغيل LLM محليًا في عرض نطاق الذاكرة (حتى 546 GB/s مقابل 273 GB/s) وسقف الذاكرة الموحدة (حتى 128GB مقابل 48GB) — رموز أسرع في الثانية في كل حجم نموذج.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  de: {
    ...
    metaDescription: 'M4 Max schlägt M4 Pro bei lokalen LLMs durch Speicherbandbreite (bis 546 GB/s vs. 273 GB/s) und Unified-Memory-Obergrenze (bis 128GB vs. 48GB) — schnellere Tokens/Sek. bei jeder Modellgröße.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  es: {
    ...
    metaDescription: 'El M4 Max supera al M4 Pro en LLMs locales en ancho de banda de memoria (hasta 546 GB/s vs 273 GB/s) y techo de memoria unificada (hasta 128GB vs 48GB) — más tokens/seg en todos los tamaños.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  ko: {
    ...
    metaDescription: 'M4 Max는 메모리 대역폭(최대 546GB/s 대 273GB/s)과 통합 메모리 한계(최대 128GB 대 48GB)에서 M4 Pro를 능가합니다 — 모든 모델 크기에서 초당 토큰 수가 더 빠릅니다.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  pt: {
    ...
    metaDescription: 'O M4 Max supera o M4 Pro para LLMs locais em largura de banda de memória (até 546 GB/s vs 273 GB/s) e teto de memória unificada (até 128GB vs 48GB) — tokens/s mais rápidos em todo tamanho de modelo.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
