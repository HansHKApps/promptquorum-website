...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  de: {
    ...
    seoTitle: 'Neueste Ollama-Version? | Prompt Bites | PromptQuorum',
    metaDescription: 'Aktuelle Ollama-Version auf ollama.com oder GitHub prüfen. Auf Mac/Windows das Installationsprogramm erneut herunterladen oder unter Linux das Installationsskript ausführen. Schnelle Antwort von PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-06-18',
    is_living_page: true,
  ...
  fr: {
    ...
    seoTitle: 'Dernière version d\'Ollama ? | Prompt Bites | PromptQuorum',
    metaDescription: 'Consultez ollama.com ou GitHub pour la dernière version d\'Ollama. Retéléchargez l\'installeur sur Mac/Windows ou exécutez le script d\'installation sur Linux pour mettre à jour. Réponse rapide de PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-06-18',
    is_living_page: true,
  ...
  ja: {
    ...
    seoTitle: 'Ollamaの最新バージョンは？ | Prompt Bites | PromptQuorum',
    metaDescription: 'ollama.comまたはGitHubで最新のOllamaバージョンを確認できます。Mac/Windowsはインストーラーを再ダウンロード、Linuxはインストールスクリプトを実行して更新。PromptQuorumによるクイックアンサー。',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-06-18',
    is_living_page: true,
  ...
  zh: {
    theme: 'Ollama',
    title: 'Ollama最新版本是什么？',
    seoTitle: 'Ollama最新版本？| Prompt Bites | PromptQuorum',
    metaDescription: '在ollama.com或GitHub查看最新Ollama版本。Mac/Windows重新下载安装程序，Linux运行安装脚本即可更新。PromptQuorum快速解答。',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-06-18',
    is_living_page: true,
