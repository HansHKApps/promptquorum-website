...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: 'Qwen3 14B and Llama 3.3 8B are the best local LLMs for document summarization — both support 128K+ context on Ollama, enough to summarize long documents in one pass.',
  ...
  de: {
    ...
    metaDescription: 'Qwen3 14B und Llama 3.3 8B sind die besten lokalen LLMs für Dokumentenzusammenfassung — beide unterstützen 128K+ Kontext auf Ollama, genug, um lange Dokumente in einem Durchgang zusammenzufassen.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  es: {
    ...
    metaDescription: 'Qwen3 14B y Llama 3.3 8B son los mejores LLM locales para resumir documentos — ambos soportan 128K+ de contexto en Ollama, suficiente para resumir documentos largos en una sola pasada.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  fr: {
    ...
    metaDescription: 'Qwen3 14B et Llama 3.3 8B sont les meilleurs LLM locaux pour la synthèse de documents — tous deux prennent en charge un contexte de 128K+ sur Ollama, suffisant pour résumer de longs documents en une seule passe.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  pt: {
    ...
    metaDescription: 'O Qwen3 14B e o Llama 3.3 8B são os melhores LLMs locais para resumo de documentos — ambos suportam contexto de 128K+ no Ollama, suficiente para resumir documentos longos em uma única passagem.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
