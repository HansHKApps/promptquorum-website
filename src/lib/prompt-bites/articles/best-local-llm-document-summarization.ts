...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    theme: 'Quick Answers',
    heroImage: '/images/best-local-llm-document-summarization-overview-hero-en.webp',
    title: 'Best Local LLM for Document Summarization?',
    seoTitle: 'Best Local LLM for Document Summarization 2026',
    metaDescription: 'Qwen3 14B and Llama 3.1 8B are the best local LLMs for document summarization — both support 128K+ context on Ollama for long documents in one pass.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
    current_models_mentioned: ['Qwen3 14B', 'Llama 3.1 8B'],
    ...
    quickAnswerTop: {
      en: {
        ...
        answer: 'Qwen3 14B and Llama 3.1 8B are the best local LLMs for document summarization — both support 128K+ context on Ollama, enough to summarize long documents without chunking.',
        bullets: [
          'Llama 3.1 8B supports 128K+ context on Ollama — a smaller, faster option for long-document summarization.',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Best pick: Llama 3.1 8B — 128K+ context on Ollama, smaller and faster for most documents',
      ...
      bestPick: {
        id: 'best-pick',
        title: 'Best Pick: Llama 3.1 8B (or Qwen3 14B for Very Long Documents)',
        content: [
          '<strong>Llama 3.1 8B is the best local LLM for most document summarization tasks, since its 128K+ context window on Ollama covers the vast majority of real-world documents in a single pass, without splitting the document into chunks that risk losing cross-section context.</strong> Its smaller 8B size also keeps VRAM requirements and inference speed reasonable compared to larger models.',
          'For exceptionally long documents that exceed even 128K tokens, Qwen3 14B is the better choice — it shares the same 128K baseline but can extend to 1M tokens in its extended configuration, covering book-length documents that Llama 3.1 8B\'s standard context cannot.',
  ...
  ar: {
    theme: 'Quick Answers',
    heroImage: '/images/best-local-llm-document-summarization-overview-hero-ar.webp',
    title: 'أفضل LLM محلي لتلخيص المستندات؟',
    seoTitle: 'أفضل LLM محلي لتلخيص المستندات 2026',
    metaDescription: 'نموذجا Qwen3 14B وLlama 3.1 8B هما الأفضل لتلخيص المستندات محليًا — كلاهما يدعم سياقًا 128K+ على Ollama، كافٍ لتلخيص مستندات طويلة في مرور واحد.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
    ...
    siblingBites: ['ollama-128k-context-models', 'best-embedding-model-local-rag'],
    is_living_page: false,
    leadAnswerBlock: '<strong>نموذجا Qwen3 14B وLlama 3.1 8B هما الأفضل لتلخيص المستندات محليًا</strong> — كلاهما يدعم سياق 128K+ على Ollama، طويل بما يكفي لتلخيص معظم المستندات في مرور واحد دون تقطيع. يصل Qwen3 14B إلى ما يصل إلى مليون رمز من السياق في تكوينه الممتد، مفيد للمستندات الطويلة استثنائيًا.',
    toc: [
      { label: 'أفضل اختيار: Llama 3.1 8B (أو Qwen3 14B للمستندات الطويلة جدًا)', anchor: '#best-pick' },
    ...
    quickAnswerTop: {
      ar: {
        ...
        answer: 'نموذجا Qwen3 14B وLlama 3.1 8B هما الأفضل لتلخيص المستندات محليًا — كلاهما يدعم سياق 128K+ على Ollama، كافٍ لتلخيص مستندات طويلة دون تقطيع.',
        bullets: [
          'يدعم Llama 3.1 8B سياق 128K+ على Ollama — خيار أصغر وأسرع لتلخيص المستندات الطويلة.',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'أفضل اختيار: Llama 3.1 8B — سياق 128K+ على Ollama، أصغر وأسرع لمعظم المستندات',
      ...
      bestPick: {
        id: 'best-pick',
        title: 'أفضل اختيار: Llama 3.1 8B (أو Qwen3 14B للمستندات الطويلة جدًا)',
        content: [
          '<strong>نموذج Llama 3.1 8B هو الأفضل لمعظم مهام تلخيص المستندات، حيث تغطي نافذة سياقه البالغة 128K+ على Ollama الغالبية العظمى من المستندات الواقعية في مرور واحد، دون تقسيم المستند إلى قِطع تخاطر بفقدان السياق عبر الأقسام.</strong> يحافظ حجمه الأصغر البالغ 8B أيضًا على متطلبات VRAM وسرعة الاستدلال معقولة مقارنة بالنماذج الأكبر.',
          'بالنسبة للمستندات الطويلة استثنائيًا التي تتجاوز حتى 128K رمز، يُعد Qwen3 14B الاختيار الأفضل — يشارك نفس الأساس البالغ 128K لكنه يمكن أن يمتد إلى مليون رمز في تكوينه الممتد، مغطيًا مستندات بطول كتاب لا يستوعبها سياق Llama 3.1 8B القياسي.',
  ...
  de: {
    theme: 'Quick Answers',
    heroImage: '/images/best-local-llm-document-summarization-overview-hero-de.webp',
    title: 'Das beste lokale LLM für Dokumentenzusammenfassung?',
    seoTitle: 'Bestes lokales LLM für Dokumentenzusammenfassung 2026',
    metaDescription: 'Qwen3 14B und Llama 3.1 8B sind die besten lokalen LLMs für Dokumentenzusammenfassung, mit 128K+ Kontext auf Ollama für lange Dokumente in einem Durchgang.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
    ...
    siblingBites: ['ollama-128k-context-models', 'best-embedding-model-local-rag'],
    is_living_page: false,
    leadAnswerBlock: '<strong>Qwen3 14B und Llama 3.1 8B sind die besten lokalen LLMs für Dokumentenzusammenfassung</strong> — beide unterstützen 128K+ Kontext auf Ollama, lang genug, um die meisten Dokumente in einem einzigen Durchgang ohne Chunking zusammenzufassen. Qwen3 14B erreicht in seiner erweiterten Konfiguration bis zu 1 Mio. Token Kontext, nützlich für außergewöhnlich lange Dokumente.',
    toc: [
      { label: 'Beste Wahl: Llama 3.1 8B (oder Qwen3 14B für sehr lange Dokumente)', anchor: '#best-pick' },
    ...
    quickAnswerTop: {
      de: {
        ...
        answer: 'Qwen3 14B und Llama 3.1 8B sind die besten lokalen LLMs für Dokumentenzusammenfassung — beide unterstützen 128K+ Kontext auf Ollama, genug, um lange Dokumente ohne Chunking zusammenzufassen.',
        bullets: [
          'Llama 3.1 8B unterstützt 128K+ Kontext auf Ollama — eine kleinere, schnellere Option für Long-Document-Zusammenfassung.',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Beste Wahl: Llama 3.1 8B — 128K+ Kontext auf Ollama, kleiner und schneller für die meisten Dokumente',
  ...
  es: {
    theme: 'Quick Answers',
    heroImage: '/images/best-local-llm-document-summarization-overview-hero-es.webp',
    title: '¿Cuál es el Mejor LLM Local para Resumir Documentos?',
    seoTitle: 'Mejor LLM Local para Resumen de Documentos 2026',
    metaDescription: 'Qwen3 14B y Llama 3.1 8B son los mejores LLM locales para resumir documentos, con 128K+ de contexto en Ollama para documentos largos en una pasada.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
    ...
    quickAnswerTop: {
      es: {
        ...
        answer: 'Qwen3 14B y Llama 3.1 8B son los mejores LLM locales para resumen de documentos — ambos soportan 128K+ de contexto en Ollama, suficiente para resumir documentos largos sin fragmentar.',
        bullets: [
          'Llama 3.1 8B soporta 128K+ de contexto en Ollama — una opción más pequeña y rápida para resumen de documentos largos.',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Mejor opción: Llama 3.1 8B — 128K+ de contexto en Ollama, más pequeño y rápido para la mayoría de los documentos',
      ...
      bestPick: {
        id: 'best-pick',
        title: 'Mejor Opción: Llama 3.1 8B (o Qwen3 14B para Documentos Muy Largos)',
        content: [
          '<strong>Llama 3.1 8B es el mejor LLM local para la mayoría de las tareas de resumen de documentos, ya que su ventana de contexto de 128K+ en Ollama cubre la gran mayoría de los documentos del mundo real en una sola pasada, sin dividir el documento en fragmentos que arriesgan perder contexto entre secciones.</strong> Su menor tamaño de 8B también mantiene razonables los requisitos de VRAM y la velocidad de inferencia comparado con modelos más grandes.',
          'Para documentos excepcionalmente largos que superan incluso los 128K tokens, Qwen3 14B es la mejor elección — comparte la misma base de 128K pero puede extenderse hasta 1M de tokens en su configuración extendida, cubriendo documentos de longitud de libro que el contexto estándar de Llama 3.1 8B no puede.',
  ...
  fr: {
    theme: 'Quick Answers',
    heroImage: '/images/best-local-llm-document-summarization-overview-hero-fr.webp',
    ...
    metaDescription: 'Qwen3 14B et Llama 3.1 8B sont les meilleurs LLM locaux pour résumer des documents longs, avec 128K+ de contexte sur Ollama en une seule passe.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
    ...
    quickAnswerTop: {
      fr: {
        ...
        answer: 'Qwen3 14B et Llama 3.1 8B sont les meilleurs LLM locaux pour la synthèse de documents — tous deux prennent en charge un contexte de 128K+ sur Ollama, suffisant pour résumer de longs documents sans découpage.',
        bullets: [
          'Llama 3.1 8B prend en charge un contexte de 128K+ sur Ollama — une option plus légère et plus rapide pour la synthèse de longs documents.',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Meilleur choix : Llama 3.1 8B — contexte de 128K+ sur Ollama, plus léger et plus rapide pour la plupart des documents',
  ...
  ja: {
    theme: 'Quick Answers',
    heroImage: '/images/best-local-llm-document-summarization-overview-hero-ja.webp',
    title: '文書要約に最適なローカルLLMは?',
    seoTitle: '2026年版 文書要約に最適なローカルLLM',
    metaDescription: 'Qwen3 14BとLlama 3.1 8Bは文書要約に最適なローカルLLMです — どちらもOllamaで128K以上のコンテキストをサポートし、長い文書を1回のパスで要約できます。',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
    ...
    siblingBites: ['ollama-128k-context-models', 'best-embedding-model-local-rag'],
    is_living_page: false,
    leadAnswerBlock: '<strong>Qwen3 14BとLlama 3.1 8Bは文書要約に最適なローカルLLMです</strong> — どちらもOllamaで128K以上のコンテキストをサポートし、ほとんどの文書をチャンク分割なしで1回のパスで要約するのに十分な長さです。Qwen3 14Bは拡張構成で最大100万トークンのコンテキストに達し、特に長い文書に役立ちます。',
    toc: [
      { label: 'ベストピック: Llama 3.1 8B(非常に長い文書にはQwen3 14B)', anchor: '#best-pick' },
    ...
    quickAnswerTop: {
      ja: {
        ...
        answer: 'Qwen3 14BとLlama 3.1 8Bは文書要約に最適なローカルLLMです — どちらもOllamaで128K以上のコンテキストをサポートし、チャンク分割なしで長い文書を要約できます。',
        bullets: [
          'Llama 3.1 8BはOllamaで128K以上のコンテキストをサポート — 長文書要約向けのより小さく高速な選択肢。',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'ベストピック: Llama 3.1 8B — Ollamaで128K以上のコンテキスト、ほとんどの文書で小さく高速',
      ...
      bestPick: {
        id: 'best-pick',
        title: 'ベストピック: Llama 3.1 8B(非常に長い文書にはQwen3 14B)',
        content: [
          '<strong>Llama 3.1 8Bは、ほとんどの文書要約タスクに最適なローカルLLMです。Ollamaでの128K以上のコンテキストウィンドウが、セクション間の文脈を失うリスクのあるチャンク分割をせずに、実世界の文書の大半を1回のパスでカバーするためです。</strong>その小さい8Bサイズは、より大きなモデルに比べVRAM要件と推論速度も妥当な範囲に保ちます。',
          '128Kトークンを超える例外的に長い文書には、Qwen3 14Bがより良い選択です — 同じ128Kのベースラインを共有しつつ、拡張構成で最大100万トークンまで拡張でき、Llama 3.1 8Bの標準コンテキストではカバーできない書籍サイズの文書もカバーします。',
  ...
  ko: {
    theme: 'Quick Answers',
    heroImage: '/images/best-local-llm-document-summarization-overview-hero-ko.webp',
    title: '문서 요약을 위한 최적의 로컬 LLM은?',
    seoTitle: '2026년 문서 요약 최적 로컬 LLM',
    metaDescription: 'Qwen3 14B와 Llama 3.1 8B는 문서 요약을 위한 최적의 로컬 LLM입니다 — 둘 다 Ollama에서 128K 이상 컨텍스트를 지원해 긴 문서를 한 번에 요약할 수 있습니다.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
    ...
    siblingBites: ['ollama-128k-context-models', 'best-embedding-model-local-rag'],
    is_living_page: false,
    leadAnswerBlock: '<strong>Qwen3 14B와 Llama 3.1 8B는 문서 요약을 위한 최적의 로컬 LLM입니다</strong> — 둘 다 Ollama에서 128K 이상의 컨텍스트를 지원하여 청크로 나누지 않고도 대부분의 문서를 한 번에 요약할 수 있습니다. Qwen3 14B는 확장 구성에서 최대 100만 토큰의 컨텍스트에 도달하며, 예외적으로 긴 문서에 유용합니다.',
    toc: [
      { label: '최적의 선택: Llama 3.1 8B(매우 긴 문서에는 Qwen3 14B)', anchor: '#best-pick' },
    ...
    quickAnswerTop: {
      ko: {
        ...
        answer: 'Qwen3 14B와 Llama 3.1 8B는 문서 요약을 위한 최적의 로컬 LLM입니다 — 둘 다 Ollama에서 128K 이상 컨텍스트를 지원해 긴 문서를 청크 분할 없이 요약할 수 있습니다.',
        bullets: [
          'Llama 3.1 8B는 Ollama에서 128K 이상 컨텍스트를 지원합니다 — 긴 문서 요약을 위한 더 작고 빠른 옵션입니다.',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          '최적의 선택: Llama 3.1 8B — Ollama에서 128K 이상 컨텍스트, 대부분의 문서에 더 작고 빠릅니다',
      ...
      bestPick: {
        id: 'best-pick',
        title: '최적의 선택: Llama 3.1 8B(매우 긴 문서에는 Qwen3 14B)',
        content: [
          '<strong>Llama 3.1 8B는 대부분의 문서 요약 작업에 최적의 로컬 LLM입니다. Ollama에서의 128K 이상 컨텍스트 윈도우가 대다수의 실제 문서를 한 번에 다루며, 섹션 간 맥락을 잃을 위험이 있는 청크로 문서를 나눌 필요가 없기 때문입니다.</strong> 더 작은 8B 크기 또한 더 큰 모델 대비 VRAM 요구량과 추론 속도를 합리적으로 유지합니다.',
          '128K 토큰마저 초과하는 예외적으로 긴 문서에는 Qwen3 14B가 더 나은 선택입니다 — 동일한 128K 기준선을 공유하지만 확장 구성에서 최대 100만 토큰까지 확장될 수 있어, Llama 3.1 8B의 표준 컨텍스트로는 다룰 수 없는 책 분량의 문서까지 다룹니다.',
  ...
  pt: {
    theme: 'Quick Answers',
    heroImage: '/images/best-local-llm-document-summarization-overview-hero-pt.webp',
    title: 'Qual o Melhor LLM Local para Resumo de Documentos?',
    seoTitle: 'Melhor LLM Local para Resumo de Documentos 2026',
    metaDescription: 'O Qwen3 14B e Llama 3.1 8B são os melhores LLMs locais para resumo de documentos, com 128K+ de contexto no Ollama para documentos longos em uma passagem.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
    ...
    quickAnswerTop: {
      pt: {
        ...
        answer: 'O Qwen3 14B e o Llama 3.1 8B são os melhores LLMs locais para resumo de documentos — ambos suportam contexto de 128K+ no Ollama, suficiente para resumir documentos longos sem fragmentação.',
        bullets: [
          'O Llama 3.1 8B suporta contexto de 128K+ no Ollama — uma opção menor e mais rápida para resumo de documentos longos.',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Melhor escolha: Llama 3.1 8B — contexto de 128K+ no Ollama, menor e mais rápido para a maioria dos documentos',
      ...
      bestPick: {
        id: 'best-pick',
        title: 'Melhor Escolha: Llama 3.1 8B (ou Qwen3 14B para Documentos Muito Longos)',
        content: [
          '<strong>O Llama 3.1 8B é o melhor LLM local para a maioria das tarefas de resumo de documentos, já que sua janela de contexto de 128K+ no Ollama cobre a grande maioria dos documentos do mundo real em uma única passagem, sem dividir o documento em fragmentos que arriscam perder contexto entre seções.</strong> Seu tamanho menor de 8B também mantém os requisitos de VRAM e a velocidade de inferência razoáveis em comparação com modelos maiores.',
          'Para documentos excepcionalmente longos que excedem até os 128K tokens, o Qwen3 14B é a melhor escolha — ele compartilha a mesma base de 128K, mas pode se estender até 1M de tokens em sua configuração estendida, cobrindo documentos do tamanho de livros que o contexto padrão do Llama 3.1 8B não comporta.',
  ...
  zh: {
    theme: 'Quick Answers',
    heroImage: '/images/best-local-llm-document-summarization-overview-hero-zh.webp',
    title: '文档摘要的最佳本地 LLM 是什么？',
    seoTitle: '2026 年文档摘要最佳本地 LLM',
    metaDescription: 'Qwen3 14B 和 Llama 3.1 8B 是文档摘要的最佳本地 LLM——两者在 Ollama 上都支持 128K+ 上下文，足以一次性摘要长文档。',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
    ...
    siblingBites: ['ollama-128k-context-models', 'best-embedding-model-local-rag'],
    is_living_page: false,
    leadAnswerBlock: '<strong>Qwen3 14B 和 Llama 3.1 8B 是文档摘要的最佳本地 LLM</strong>——两者在 Ollama 上都支持 128K+ 上下文，足以一次性摘要大多数文档而无需分块。Qwen3 14B 在扩展配置下上下文可达 100 万 token，对超长文档很有用。',
    toc: [
      { label: '最佳选择：Llama 3.1 8B（超长文档选 Qwen3 14B）', anchor: '#best-pick' },
    ...
    quickAnswerTop: {
      zh: {
        ...
        answer: 'Qwen3 14B 和 Llama 3.1 8B 是文档摘要的最佳本地 LLM——两者在 Ollama 上都支持 128K+ 上下文，足以在不分块的情况下摘要长文档。',
        bullets: [
          'Llama 3.1 8B 在 Ollama 上支持 128K+ 上下文——是长文档摘要中更小、更快的选择。',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          '最佳选择：Llama 3.1 8B——Ollama 上支持 128K+ 上下文，对大多数文档来说更小更快',
      ...
      bestPick: {
        id: 'best-pick',
        title: '最佳选择：Llama 3.1 8B（超长文档选 Qwen3 14B）',
        content: [
          '<strong>Llama 3.1 8B 是大多数文档摘要任务的最佳本地 LLM，因为它在 Ollama 上支持 128K+ 上下文窗口，能一次性覆盖绝大多数现实文档，无需将文档拆分成有可能丢失跨段落上下文的分块。</strong>它较小的 8B 规模也让显存需求和推理速度相比更大的模型保持合理。',
          '对于超出甚至 128K token 的特别长的文档，Qwen3 14B 是更好的选择——它共享相同的 128K 基线，但在扩展配置下可延伸到 100 万 token，能覆盖 Llama 3.1 8B 标准上下文无法处理的书籍级文档。',
