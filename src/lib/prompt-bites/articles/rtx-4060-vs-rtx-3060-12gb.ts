...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  ar: {
    ...
    metaDescription: 'بطاقة RTX 3060 12GB تتفوق على RTX 4060 8GB القياسية لتشغيل LLM محليًا — سعة VRAM أكبر (12 GB مقابل 8 GB) أهم من الجيل الأحدث. مقارنة كاملة.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  es: {
    ...
    metaDescription: 'La RTX 3060 12GB supera a la RTX 4060 8GB estándar para LLMs locales — más VRAM (12 GB vs 8 GB) importa más que la arquitectura más nueva. Comparación completa.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  fr: {
    ...
    metaDescription: 'La RTX 3060 12 Go surpasse la RTX 4060 8 Go standard pour les LLM locaux — plus de VRAM (12 Go contre 8 Go) compte plus que l\'architecture récente. Comparatif complet.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
