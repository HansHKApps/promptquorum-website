...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: 'Intel Arc B580 12GB (~$249) is the best Intel Arc GPU for local LLMs, but expect rougher software support than NVIDIA — no CUDA, IPEX-LLM or Vulkan required.',
  ...
  de: {
    ...
    metaDescription: 'Intel Arc B580 12GB (~249 $) ist die beste Intel-Arc-GPU für lokale LLMs, aber mit rauerem Software-Support als bei NVIDIA — kein CUDA, IPEX-LLM oder Vulkan nötig.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  es: {
    ...
    metaDescription: 'La Intel Arc B580 12GB (~$249) es la mejor GPU Intel Arc para LLMs locales, pero espera un soporte de software más complicado que NVIDIA — sin CUDA, requiere IPEX-LLM o Vulkan.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  fr: {
    ...
    metaDescription: 'L\'Intel Arc B580 12 Go (~249 $) est le meilleur GPU Intel Arc pour les LLM locaux, mais attendez-vous à un support logiciel plus rugueux que NVIDIA — CUDA absent, IPEX-LLM ou Vulkan requis.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  ko: {
    ...
    metaDescription: 'Intel Arc B580 12GB(약 249달러)가 로컬 LLM에 최적의 Intel Arc GPU입니다. 다만 NVIDIA보다 소프트웨어 지원이 거칠어 CUDA 없이 IPEX-LLM이나 Vulkan이 필요합니다.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  pt: {
    ...
    metaDescription: 'Intel Arc B580 12GB (~US$ 249) é a melhor GPU Intel Arc para LLMs locais, mas espere um suporte de software mais bruto que a NVIDIA — sem CUDA, requer IPEX-LLM ou Vulkan.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
