  ...
  en: {
    ...
    quickAnswerTop: {
      en: {
        ...
        bullets: [
          'NordVPN: Best GFW bypass reliability — obfuscated servers, AES-256 encryption, $4.59/month (2-year Basic plan)',
          'ExpressVPN: Best download speed for model files — Lightway protocol, $4.99/month (1-year Basic plan)',
          'Surfshark: Best value — $2.49/month (2-year Starter plan), obfuscation available, ~20% slower than NordVPN',
      ...
      de: {
        ...
        bullets: [
          'NordVPN: Beste GFW-Bypass-Zuverlässigkeit — obfuskierte Server, ~4,59 $/Monat (2-Jahres-Plan)',
          'ExpressVPN: Schnellste Downloads für Modelldateien — Lightway-Protokoll, ~4,99 $/Monat',
          'Surfshark: Bestes Preis-Leistungs-Verhältnis — ~2,49 $/Monat, Obfuskierung verfügbar',
      ...
      ja: {
        ...
        bullets: [
          'NordVPN：GFWバイパス信頼性最高——難読化サーバー、月約$4.59（2年プラン）',
          'ExpressVPN：モデルファイルダウンロード最速——Lightwayプロトコル、月約$4.99',
          'Surfshark：コスパ最高——月約$2.49、難読化あり',
      ...
      zh: {
        ...
        bullets: [
          'NordVPN：GFW穿透最可靠——混淆服务器，约$4.59/月（两年套餐）',
          'ExpressVPN：模型文件下载最快——Lightway协议，约$4.99/月',
          'Surfshark：性价比最高——约$2.49/月，支持混淆',
    ...
    sections: {
      bestPick: {
        ...
        items: [
          '**NordVPN — #1 for reliability.** Obfuscated servers disguise VPN traffic as regular HTTPS. Works consistently for HuggingFace model downloads, GitHub clone/push, Docker Hub pulls. Price: $4.59/month (2-year Basic plan). Available via NordVPN.com — Chinese bank cards not accepted, use international card or cryptocurrency. Kill switch prevents DNS leaks if connection drops during large model downloads.',
          '**ExpressVPN — #1 for download speed.** Lightway protocol is the fastest for large file transfers (important for 10–70 GB model files). Now offers tiered plans (Basic, Advanced, Pro). Price: $4.99/month (1-year Basic plan). Competitive pricing after the 2026 tier restructure.',
          '**Surfshark — Best value.** NoBorders mode activates automatically in restricted regions. Unlimited simultaneous connections — run on development server, laptop, and phone simultaneously. Price: $2.49/month (2-year Starter plan). Speed is ~20% lower than NordVPN but adequate for most tasks.',
        ...
        affiliateLinks: [
          {
            ...
            label: 'Get NordVPN — Most reliable China bypass ($4.59/mo) →',
          },
          {
            ...
            label: 'Get ExpressVPN — Fastest for model downloads ($4.99/mo) →',
          },
          {
            ...
            label: 'Get Surfshark — Best budget VPN for China ($2.49/mo) →',
          },
        ],
      },
      speedTests: {
        id: 'speed-tests',
        title: 'Speed Tests — AI Dev Tools from China (July 2026)',
        content:
        ...
        note: 'Speeds from July 2026 tests. GFW blocking intensity varies — speeds can be 50–80% lower during politically sensitive periods. VPN enforcement tightened in 2026; unauthorized VPN use can result in fines up to RMB 5,000 (~$750). Test your VPN before relying on it for a critical download.',
      },
      comparison: {
        id: 'comparison',
        ...
        rows: [
          { '0': 'NordVPN', '1': '⭐⭐⭐⭐⭐', '2': '⭐⭐⭐⭐', '3': '$4.59 (2yr Basic)', '4': '10', '5': 'Daily AI dev' },
          { '0': 'ExpressVPN', '1': '⭐⭐⭐⭐⭐', '2': '⭐⭐⭐⭐⭐', '3': '$4.99 (1yr Basic)', '4': '8', '5': 'Large model downloads' },
          { '0': 'Surfshark', '1': '⭐⭐⭐⭐', '2': '⭐⭐⭐', '3': '$2.49 (2yr Starter)', '4': 'Unlimited', '5': 'Budget, multiple devices' },
        ...
        faqs: [
          {
            ...
            a: 'Legally complex. Commercial VPN use by enterprises is regulated and requires approval. Individual VPN use exists in a gray area, but enforcement tightened in 2026 — individual fines for unauthorized VPN access to the international internet can now reach RMB 5,000 (approximately $750). Many Chinese AI developers use VPNs routinely but accept this risk. This is not legal advice — assess your own risk tolerance.',
          },
          {
