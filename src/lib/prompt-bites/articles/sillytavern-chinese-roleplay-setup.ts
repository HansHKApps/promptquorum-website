...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    seoTitle: 'SillyTavern Chinese Roleplay Setup 2026 | Best Models & Config',
    metaDescription: 'Best models for Chinese roleplay in SillyTavern: Qwen2.5-72B leads, Yi-34B for character depth, ChatGLM for speed. Character card encoding, API bridge to Ollama.',
...
- 如有动作描写，用括号标注，如：（她轻轻叹气）`,
  ...
  de: {
    ...
    seoTitle: 'SillyTavern Chinesisches Rollenspiel 2026 | Beste Modelle & Konfiguration',
    metaDescription: 'Beste Modelle für chinesisches Rollenspiel in SillyTavern: Qwen2.5-72B führt, Yi-34B für Charaktertiefe, ChatGLM für Geschwindigkeit. Charakterkarten-Kodierung und Ollama-API-Bridge.',
    publishDate: '2026-05-26',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-26',
    educationalLevel: 'Intermediate',
...
- 如有动作描写，用括号标注，如：（她轻轻叹气）`,
  ...
  fr: {
    ...
    seoTitle: 'SillyTavern Jeu de Rôle Chinois 2026 | Meilleurs Modèles & Config',
    metaDescription: 'Meilleurs modèles pour le jeu de rôle chinois dans SillyTavern : Qwen2.5-72B en tête, Yi-34B pour la profondeur des personnages, ChatGLM pour la vitesse. Encodage des cartes de personnage et bridge API Ollama.',
    publishDate: '2026-05-26',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-26',
    educationalLevel: 'Intermediate',
...
- 如有动作描写，用括号标注，如：（她轻轻叹气）`,
  ...
  ja: {
    ...
    seoTitle: 'SillyTavern 中国語ロールプレイ設定 2026 | 最適モデルと設定',
    metaDescription: 'SillyTavernで中国語ロールプレイに最適なモデル：Qwen2.5-72Bがトップ、Yi-34Bはキャラクター深度、ChatGLMは速度。キャラクターカードのエンコードとOllama APIブリッジ。',
    publishDate: '2026-05-26',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-26',
    educationalLevel: 'Intermediate',
...
- 如有动作描写，用括号标注，如：（她轻轻叹气）`,
  ...
  zh: {
    ...
    seoTitle: 'SillyTavern 中文角色扮演配置 2026 | 最佳模型与设置',
    metaDescription: 'SillyTavern 中文角色扮演最佳本地模型：Qwen2.5-72B 首选，Yi-34B 角色深度突出，ChatGLM3-6B 速度最快。角色卡中文设置、UTF-8 编码与 Ollama API 桥接。',
    publishDate: '2026-05-26',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-26',
    educationalLevel: 'Intermediate',
