...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    heroImage: '/images/sillytavern-chinese-roleplay-setup-model-comparison-hero-en.png',
    ...
    sections: {
      ...
      modelComparison: {
        ...
        image: '/images/sillytavern-chinese-roleplay-setup-model-comparison-hero-en.png',
        imageCaption: 'Best Models for Chinese Roleplay -- Hardware tier and use case',
      },
      connectionSetup: {
        id: 'connection-setup',
...
苏云: 先说清楚，值不值得我出手。`,
      ...
      encodingSettings: {
        ...
        image: '/images/sillytavern-chinese-roleplay-setup-encoding-fixes-hero-en.png',
        imageCaption: 'Fixing Garbled Chinese Output -- Common causes and fixes',
      },
      promptTemplate: {
        id: 'prompt-template',
...
- 如有动作描写，用括号标注，如：（她轻轻叹气）`,
  ...
  de: {
    ...
    heroImage: '/images/sillytavern-chinese-roleplay-setup-model-comparison-hero-de.png',
    publishDate: '2026-05-26',
    dateModified: '2026-06-20',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-26',
    ...
    sections: {
      ...
      modelComparison: {
        ...
        image: '/images/sillytavern-chinese-roleplay-setup-model-comparison-hero-de.png',
        imageCaption: 'Beste Modelle für Chinesisches Rollenspiel -- Hardware-Stufe und Anwendungsfall',
      },
      connectionSetup: {
        id: 'connection-setup',
...
苏云: 先说清楚，值不值得我出手。`,
      ...
      encodingSettings: {
        ...
        image: '/images/sillytavern-chinese-roleplay-setup-encoding-fixes-hero-de.png',
        imageCaption: 'Verstümmelte Chinesische Ausgabe Beheben -- Häufige Ursachen und Lösungen',
      },
      promptTemplate: {
        id: 'prompt-template',
...
- 如有动作描写，用括号标注，如：（她轻轻叹气）`,
  ...
  fr: {
    ...
    heroImage: '/images/sillytavern-chinese-roleplay-setup-model-comparison-hero-fr.png',
    publishDate: '2026-05-26',
    dateModified: '2026-06-20',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-26',
    ...
    sections: {
      ...
      modelComparison: {
        ...
        image: '/images/sillytavern-chinese-roleplay-setup-model-comparison-hero-fr.png',
        imageCaption: 'Meilleurs Modèles pour le Roleplay Chinois -- Niveau matériel et cas d\'usage',
      },
      connectionSetup: {
        id: 'connection-setup',
...
苏云: 先说清楚，值不值得我出手。`,
      ...
      encodingSettings: {
        ...
        image: '/images/sillytavern-chinese-roleplay-setup-encoding-fixes-hero-fr.png',
        imageCaption: 'Corriger le Chinois Corrompu -- Causes courantes et corrections',
      },
      promptTemplate: {
        id: 'prompt-template',
...
- 如有动作描写，用括号标注，如：（她轻轻叹气）`,
  ...
  ja: {
    ...
    heroImage: '/images/sillytavern-chinese-roleplay-setup-model-comparison-hero-ja.png',
    publishDate: '2026-05-26',
    dateModified: '2026-06-20',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-26',
    ...
    sections: {
      ...
      modelComparison: {
        ...
        image: '/images/sillytavern-chinese-roleplay-setup-model-comparison-hero-ja.png',
        imageCaption: '中国語ロールプレイ向けベストモデル -- ハードウェア階層と用途',
      },
      connectionSetup: {
        id: 'connection-setup',
...
苏云: 先说清楚，值不值得我出手。`,
      ...
      encodingSettings: {
        ...
        image: '/images/sillytavern-chinese-roleplay-setup-encoding-fixes-hero-ja.png',
        imageCaption: '文字化けした中国語出力の修正 -- よくある原因と対処法',
      },
      promptTemplate: {
        id: 'prompt-template',
...
- 如有动作描写，用括号标注，如：（她轻轻叹气）`,
  ...
  zh: {
    ...
    heroImage: '/images/sillytavern-chinese-roleplay-setup-model-comparison-hero-zh.png',
    publishDate: '2026-05-26',
    dateModified: '2026-06-20',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-26',
    ...
    sections: {
      ...
      modelComparison: {
        ...
        image: '/images/sillytavern-chinese-roleplay-setup-model-comparison-hero-zh.png',
        imageCaption: '中文角色扮演最佳模型 -- 硬件档位与使用场景',
      },
      connectionSetup: {
        id: 'connection-setup',
...
苏云: 先说清楚，值不值得我出手。`,
      ...
      encodingSettings: {
        ...
        image: '/images/sillytavern-chinese-roleplay-setup-encoding-fixes-hero-zh.png',
        imageCaption: '修复中文乱码输出 -- 常见原因与修复方法',
      },
      promptTemplate: {
        id: 'prompt-template',
        title: '中文角色扮演系统提示词模板',
...
- 如有动作描写，用括号标注，如：（她轻轻叹气）`,
  ...
  pt: {
    ...
    heroImage: '/images/sillytavern-chinese-roleplay-setup-model-comparison-hero-pt.png',
    publishDate: '2026-05-26',
    dateModified: '2026-06-20',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-26',
    ...
    sections: {
      ...
      modelComparison: {
        ...
        image: '/images/sillytavern-chinese-roleplay-setup-model-comparison-hero-pt.png',
        imageCaption: 'Melhores Modelos para Roleplay em Chinês -- Nível de hardware e caso de uso',
      },
      connectionSetup: {
        id: 'connection-setup',
...
苏云: 先说清楚，值不值得我出手。`,
      ...
      encodingSettings: {
        ...
        image: '/images/sillytavern-chinese-roleplay-setup-encoding-fixes-hero-pt.png',
        imageCaption: 'Corrigindo a Saída de Chinês Corrompida -- Causas comuns e correções',
      },
      promptTemplate: {
        id: 'prompt-template',
...
- 如有动作描写，用括号标注，如：（她轻轻叹气）`,
  ...
  es: {
    ...
    heroImage: '/images/sillytavern-chinese-roleplay-setup-model-comparison-hero-es.png',
    publishDate: '2026-05-26',
    dateModified: '2026-06-20',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-26',
    ...
    sections: {
      ...
      modelComparison: {
        ...
        image: '/images/sillytavern-chinese-roleplay-setup-model-comparison-hero-es.png',
        imageCaption: 'Mejores Modelos para Roleplay en Chino -- Nivel de hardware y caso de uso',
      },
      connectionSetup: {
        id: 'connection-setup',
...
苏云: 先说清楚，值不值得我出手。`,
      ...
      encodingSettings: {
        ...
        image: '/images/sillytavern-chinese-roleplay-setup-encoding-fixes-hero-es.png',
        imageCaption: 'Corrigiendo la Salida de Chino Corrupta -- Causas comunes y soluciones',
      },
      promptTemplate: {
        id: 'prompt-template',
...
- 如有动作描写，用括号标注，如：（她轻轻叹气）`,
  ...
  ar: {
    ...
    heroImage: '/images/sillytavern-chinese-roleplay-setup-model-comparison-hero-ar.png',
    publishDate: '2026-05-26',
    dateModified: '2026-06-20',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-26',
    ...
    sections: {
      ...
      modelComparison: {
        ...
        image: '/images/sillytavern-chinese-roleplay-setup-model-comparison-hero-ar.png',
        imageCaption: 'أفضل النماذج لتمثيل الأدوار بالصينية -- مستوى الجهاز وحالة الاستخدام',
      },
      connectionSetup: {
        id: 'connection-setup',
...
苏云: 先说清楚，值不值得我出手。`,
      ...
      encodingSettings: {
        ...
        image: '/images/sillytavern-chinese-roleplay-setup-encoding-fixes-hero-ar.png',
        imageCaption: 'إصلاح مخرجات الصينية المشوّهة -- الأسباب الشائعة والإصلاحات',
      },
      promptTemplate: {
        id: 'prompt-template',
...
- 如有动作描写，用括号标注，如：（她轻轻叹气）`,
  ...
  ko: {
    ...
    heroImage: '/images/sillytavern-chinese-roleplay-setup-model-comparison-hero-ko.png',
    publishDate: '2026-05-26',
    dateModified: '2026-06-20',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-26',
    ...
    sections: {
      ...
      modelComparison: {
        ...
        image: '/images/sillytavern-chinese-roleplay-setup-model-comparison-hero-ko.png',
        imageCaption: '중국어 롤플레이를 위한 최고의 모델 -- 하드웨어 등급 및 사용 사례',
      },
      connectionSetup: {
        id: 'connection-setup',
...
苏云: 先说清楚，值不值得我出手。`,
      ...
      encodingSettings: {
        ...
        image: '/images/sillytavern-chinese-roleplay-setup-encoding-fixes-hero-ko.png',
        imageCaption: '깨진 중국어 출력 수정하기 -- 일반적인 원인과 해결책',
      },
      promptTemplate: {
        id: 'prompt-template',
