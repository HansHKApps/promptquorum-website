...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: 'Claude Opus 4.7 for coding (87.6% SWE-Bench), GPT-5.5 Instant for general chat (52.5% fewer hallucinations), Gemini 2.5 Pro for multimodal. Local: Llama 4 Scout (24GB) or Qwen 2.5 14B (12GB). Updated monthly.',
  ...
  de: {
    ...
    metaDescription: 'Claude Opus 4.7 für Coding (87,6% SWE-Bench), GPT-5.5 Instant für allgemeinen Chat (52,5% weniger Halluzinationen), Gemini 2.5 Pro multimodal. Lokal: Llama 4 Scout (24GB) oder Qwen 2.5 14B (12GB). Monatlich aktualisiert.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-06-18',
    quickAnswerTop: {
  ...
  fr: {
    ...
    metaDescription: 'Claude Opus 4.7 pour le code (87,6% SWE-Bench), GPT-5.5 Instant pour le chat général (52,5% moins d\'hallucinations), Gemini 2.5 Pro multimodal. Local : Llama 4 Scout (24 Go) ou Qwen 2.5 14B (12 Go). Mis à jour chaque mois.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-06-18',
    quickAnswerTop: {
  ...
  ja: {
    ...
    metaDescription: '現在最良のLLM：コーディングはClaude Opus 4.7（87.6% SWE-Bench）、汎用チャットはGPT-5.5 Instant（幻覚を52.5%削減）、マルチモーダルはGemini 2.5 Pro。ローカル：24GB VRAMはLlama 4 Scout、12GB VRAMはQwen 2.5 14B。毎月更新。',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-06-18',
    quickAnswerTop: {
  ...
  zh: {
    ...
    metaDescription: '当前最好的 LLM：编程选 Claude Opus 4.7（87.6% SWE-Bench），通用对话选 GPT-5.5 Instant（幻觉减少 52.5%），多模态选 Gemini 2.5 Pro。本地：24GB VRAM 选 Llama 4 Scout，12GB VRAM 选 Qwen 2.5 14B。每月更新。',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-06-18',
    quickAnswerTop: {
