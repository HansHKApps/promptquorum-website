...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: 'Cloud coding: Claude Opus 5 (leads Frontier-Bench v0.1). General: GPT-5.6 Sol. Multimodal: Gemini 3.1 Pro (77.1% ARC-AGI-2). Local: qwen3.5:9b.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-28',
    current_models_mentioned: ['Claude Opus 5', 'GPT-5.6', 'Gemini 3.1 Pro'],
  ...
  de: {
    ...
    metaDescription: 'Cloud-Coding: Claude Opus 5 (führt Frontier-Bench v0.1). Allgemein: GPT-5.6 Sol. Multimodal: Gemini 3.1 Pro (77,1% ARC-AGI-2). Lokal: qwen3.5:9b.',
    publishDate: '2026-05-18',
    dateModified: '2026-08-28',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-28',
  ...
  fr: {
    ...
    metaDescription: 'Code cloud : Claude Opus 5 (en tête de Frontier-Bench v0.1). Général : GPT-5.6 Sol. Multimodal : Gemini 3.1 Pro (77,1% ARC-AGI-2). Local : qwen3.5:9b.',
    publishDate: '2026-05-18',
    dateModified: '2026-08-28',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-28',
  ...
  ja: {
    ...
    metaDescription: 'クラウドのコーディングはClaude Opus 5（Frontier-Bench v0.1首位）。汎用はGPT-5.6 Sol。マルチモーダルはGemini 3.1 Pro（ARC-AGI-2で77.1%）。ローカルはqwen3.5:9b。',
    publishDate: '2026-05-18',
    dateModified: '2026-08-28',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-28',
  ...
  es: {
    ...
    metaDescription: 'Código en la nube: Claude Opus 5 (lidera Frontier-Bench v0.1). General: GPT-5.6 Sol. Multimodal: Gemini 3.1 Pro (77,1% ARC-AGI-2). Local: qwen3.5:9b.',
    publishDate: '2026-05-18',
    dateModified: '2026-08-28',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-28',
  ...
  pt: {
    ...
    metaDescription: 'Código na nuvem: Claude Opus 5 (lidera o Frontier-Bench v0.1). Geral: GPT-5.6 Sol. Multimodal: Gemini 3.1 Pro (77,1% no ARC-AGI-2). Local: qwen3.5:9b.',
    publishDate: '2026-05-18',
    dateModified: '2026-08-28',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-28',
  ...
  zh: {
    ...
    metaDescription: '云端编程：Claude Opus 5（领先 Frontier-Bench v0.1）。通用：GPT-5.6 Sol。多模态：Gemini 3.1 Pro（ARC-AGI-2 达 77.1%）。本地：qwen3.5:9b。',
    publishDate: '2026-05-18',
    dateModified: '2026-08-28',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-28',
  ...
  ar: {
    ...
    metaDescription: 'البرمجة السحابية: Claude Opus 5 (يتصدر Frontier-Bench v0.1). العام: GPT-5.6 Sol. متعدد الوسائط: Gemini 3.1 Pro (77.1% في ARC-AGI-2). محليًا: qwen3.5:9b. جرى.',
    publishDate: '2026-05-18',
    dateModified: '2026-08-28',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-28',
  ...
  ko: {
    ...
    metaDescription: '코딩: Claude Opus 5 (Frontier-Bench v0.1 선두). 일반: GPT-5.6 Sol. 멀티모달: Gemini 3.1 Pro (ARC-AGI-2 77.1%). 로컬: qwen3.5:9b.',
    publishDate: '2026-05-18',
    dateModified: '2026-08-28',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-28',
