...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: 'Cloud coding: Claude Opus 4.8 (87.6% SWE-Bench). General chat: GPT-5.5 Instant (52.5% fewer hallucinations). Local: Llama 4 Scout or Qwen 2.5 14B. Updated monthly.',
    ...
    quickAnswerTop: {
      ...
      ja: {
        ...
        answer: 'クラウドコーディングタスクではClaude Opus 4.8がSWE-Benchで87.6%を達成し、GPT-5.5 Instantは前バージョンより52.5%幻覚を削減しています。クラウド利用では：Claude Opus 4.8がコーディングと長文書をリード、GPT-5.5 Instantが汎用チャット、Gemini 2.5 Proがマルチモーダルタスクを担当。ローカルでは：24GB VRAMあればLlama 4 Scout、12GB VRAMならQwen 2.5 14B。',
        bullets: [
      ...
      zh: {
        ...
        answer: '云编程任务中，Claude Opus 4.8 在 SWE-Bench 上达成 87.6% 成绩，GPT-5.5 Instant 则在通用对话中降低幻觉 52.5%。云端：Claude Opus 4.8 在编程和长文档领先，GPT-5.5 Instant 适合通用对话，Gemini 2.5 Pro 适合多模态任务。本地：24GB VRAM 选 Llama 4 Scout；12 GB VRAM 选 Qwen 2.5 14B。',
        bullets: [
