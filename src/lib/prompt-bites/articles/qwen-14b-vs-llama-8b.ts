...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    seoTitle: 'Qwen 14B vs Llama 3 8B Local? | Prompt Bites | PromptQuorum',
    metaDescription: 'Llama 3 8B fits 6 GB VRAM and runs faster. Qwen 2.5 14B needs 10+ GB but scores higher on benchmarks. With 12 GB VRAM, Qwen 14B wins on quality.',
  ...
  de: {
    ...
    metaDescription: 'Llama 3 8B braucht 6 GB VRAM — schneller. Qwen 2.5 14B braucht 10+ GB, aber höhere Benchmark-Werte. Bei 12 GB VRAM gewinnt Qwen 14B qualitativ.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  fr: {
    ...
    seoTitle: 'Qwen 14B vs Llama 3 8B local ? | Prompt Bites | PromptQuorum',
    metaDescription: 'Llama 3 8B tient en 6 Go VRAM et tourne plus vite. Qwen 2.5 14B nécessite 10+ Go mais obtient de meilleurs scores. Avec 12 Go VRAM, Qwen 14B gagne en qualité.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
