...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: 'Chinese prompts use 30–50% fewer tokens on Qwen2.5. English produces stronger reasoning chains. Mixed-language techniques and per-model guidance.',
    ...
    quickAnswerTop: {
      ...
      de: {
        ...
        answer: 'Abhängig von Modell und Aufgabe. Bei Qwen2.5 und DeepSeek-R1-Distill-Modellen verwenden chinesische Prompts 30–50 % weniger Tokens. Englische Prompts liefern stärkere Schritt-für-Schritt-Reasoning-Ketten. Beste Praxis: Anweisungen auf Englisch, Modell auf Chinesisch antworten lassen.',
        bullets: ['CJK-Tokenisierung: 1 chinesisches Zeichen ≈ 1–2 Token', 'Qwen2.5: Chinesisch für Inhalt, Englisch für System-Prompts', 'Llama 3 / Mistral: Englisches Prompting deutlich besser'],
        updatedDate: '2026-05',
      },
      fr: {
        question: 'Vaut-il mieux prompter un LLM local en chinois ou en anglais ?',
        answer: 'Selon le modèle et la tâche. Pour Qwen2.5 et DeepSeek-R1-Distill, les prompts chinois utilisent 30–50% moins de tokens. Les prompts anglais produisent de meilleures chaînes de raisonnement. Meilleure pratique : instructions en anglais, réponse en chinois.',
        bullets: ['Tokenisation CJK plus dense', 'Qwen2.5 : chinois pour contenu, anglais pour instructions système', 'Llama 3 : prompting anglais nettement supérieur'],
        updatedDate: '2026-05',
      },
      ja: {
        question: 'ローカルLLMへのプロンプトは中国語と英語どちらが良い？',
        answer: 'モデルとタスクによります。Qwen2.5とDeepSeek-R1-Distillモデルでは、中国語プロンプトはトークンを30–50%節約。英語プロンプトはより強い推論チェーンを生成。最善策：指示を英語で書き、中国語での返答を指示する。',
        bullets: ['CJKトークン化は密——1漢字≈1–2トークン', 'Qwen2.5：コンテンツに中国語、システムプロンプトに英語', 'Llama 3：英語プロンプトが大幅に優れている'],
        updatedDate: '2026-05',
      },
      zh: {
        question: '用中文还是英文提示本地LLM更好？',
        answer: '取决于模型和任务。对于Qwen2.5和DeepSeek-R1-Distill模型，中文提示词消耗的token减少30–50%（CJK分词更密集），输出的中文更自然。英文提示词在大多数模型上产生更强的逐步推理链。最佳实践：用英文写指令，让模型用中文回答。',
        bullets: [
    ...
    sections: {
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'Can I mix English and Chinese in the same prompt?', a: 'Yes. Mixed-language prompts are well-handled by Qwen2.5 and DeepSeek-R1-Distill. The model understands both languages in context.' },
          ...
          { q: 'What about Traditional Chinese (Traditional vs Simplified)?', a: 'Qwen2.5 handles both. Specify in the system prompt: "请使用繁体中文回答" for Traditional or "请使用简体中文回答" for Simplified.' },
        ],
      },
    },
    schema: {
      ...
      description: 'CJK tokenisation saves 30–50% tokens on Qwen2.5. English system prompts produce stronger reasoning. Best practice: English instructions with Chinese output directive.',
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Which language for system prompts?', acceptedAnswer: { '@type': 'Answer', text: 'English, even on Chinese-native models like Qwen2.5. English system prompts consistently produce better instruction-following.' } },
      ],
    },
  },
  ...
  de: {
    ...
    metaDescription: 'Chinesische Prompts nutzen 30–50 % weniger Tokens auf Qwen2.5. Englisch ist besser für Reasoning-Ketten. Gemischte Techniken und modellspezifische Tipps.',
    publishDate: '2026-05-26',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-26',
    educationalLevel: 'Intermediate',
    ...
    quickAnswerTop: {
      ...
      de: {
        ...
        answer: 'Englische Anweisungen + "Antworte auf Chinesisch" ist das beste Setup auf allen Modellen. Chinesische Prompts sparen 30–50 % Tokens bei Qwen2.5. Englische Prompts liefern bessere Reasoning-Ketten.',
        bullets: ['CJK-Tokenisierung: 30–50 % weniger Tokens bei Qwen2.5', 'Englische System-Prompts → besseres Reasoning', 'Llama 3 / Mistral: Englisch deutlich besser'],
        updatedDate: '2026-05',
      },
      fr: { question: 'Prompting chinois ou anglais ?', answer: 'Instructions en anglais + directive "répondre en chinois" est optimal.', bullets: ['Chinois économise 30–50% tokens sur Qwen2.5'], updatedDate: '2026-05' },
    ...
    sections: {
      tldr: {
        isTldr: true,
        items: [
          'Chinesische Prompts sparen 30–50 % Tokens bei Qwen2.5 und DeepSeek-R1-Distill — CJK-Tokenisierung ist dichter',
      ...
      tokenEfficiency: {
        ...
        content: [
          ...
          '**Token-Effizienz nach Modellfamilie:** Qwen2.5: 1 chinesisches Zeichen ≈ 1–1,5 Tokens; Llama 3: 1 Zeichen ≈ 3–5 Tokens (ineffizient)',
        ],
      },
      reasoning: {
        id: 'reasoning-quality',
        ...
        content: [
          'Trotz der nativen chinesischen Fähigkeit von Qwen2.5 liefern englische System-Prompts konsistent stärkere Chain-of-Thought-Reasoning-Ketten.',
      ...
      mixedTechnique: {
        ...
        content: [
          ...
          '**Für kreatives Schreiben:** Rein chinesische Prompts auf Qwen2.5-72B liefern die besten stilistischen Ergebnisse.',
          '**Für technische Aufgaben:** Englische Prompts auch auf Qwen2.5-Coder verwenden.',
        ],
      },
      modelGuide: {
        id: 'model-guide',
        ...
        content: [
          '**Qwen2.5:** Beste native chinesische Unterstützung. Englische System-Prompts für Reasoning-intensive Aufgaben.',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'Kann ich Chinesisch und Englisch mischen?', a: 'Ja. Qwen2.5 und DeepSeek-R1-Distill verarbeiten zweisprachige Prompts gut.' },
          { q: 'Welche Sprache für System-Prompts?', a: 'Englisch, auch bei chinesisch-nativen Modellen wie Qwen2.5. Liefert besseres Reasoning.' },
          { q: 'Was ist mit Traditionell vs. Vereinfacht Chinesisch?', a: 'Qwen2.5 verarbeitet beides. "请使用繁体中文回答" für Traditionell; "请使用简体中文回答" für Vereinfacht angeben.' },
        ],
      },
    },
    schema: {
      ...
      description: 'CJK-Tokenisierung spart 30–50 % Tokens bei Qwen2.5. Englische System-Prompts liefern besseres Reasoning. Gemischte Technik empfohlen.',
  ...
  fr: {
    ...
    metaDescription: 'Les prompts chinois économisent 30–50 % de tokens sur Qwen2.5. L\'anglais produit de meilleures chaînes logiques. Techniques mixtes et guide par modèle LLM.',
    publishDate: '2026-05-26',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-26',
    educationalLevel: 'Intermediate',
    ...
    is_living_page: false,
    quickAnswerTop: {
      en: { question: 'Chinese or English prompting?', answer: 'English instructions + Chinese reply directive is best.', bullets: ['Chinese saves 30–50% tokens on Qwen2.5', 'English produces stronger reasoning'], updatedDate: '2026-05' },
      ...
      fr: {
        ...
        answer: 'Instructions en anglais + directive "répondre en chinois" est la meilleure approche sur tous les modèles. Les prompts chinois économisent 30–50 % de tokens sur Qwen2.5. Les prompts anglais produisent de meilleures chaînes de raisonnement.',
        bullets: [
          'Tokenisation CJK : 30–50 % moins de tokens sur Qwen2.5',
    ...
    sections: {
      tldr: {
        isTldr: true,
        items: [
          'Les prompts chinois économisent 30–50 % de tokens sur Qwen2.5 — la tokenisation CJK est plus dense',
      ...
      tokenEfficiency: {
        ...
        content: [
          ...
          '**Efficacité par famille de modèle :** Qwen2.5 : 1 caractère chinois ≈ 1–1,5 tokens ; Llama 3 : 1 caractère ≈ 3–5 tokens',
        ],
      },
      reasoning: {
        id: 'reasoning-quality',
        ...
        content: [
          'Malgré les capacités chinoises natives de Qwen2.5, les prompts système anglais produisent un meilleur raisonnement étape par étape.',
      ...
      mixedTechnique: {
        ...
        content: [
          ...
          '**Pour l\'écriture créative :** Prompts uniquement en chinois sur Qwen2.5-72B pour les meilleurs résultats stylistiques.',
          '**Pour les tâches techniques :** Utiliser des prompts anglais même sur Qwen2.5-Coder.',
        ],
      },
      modelGuide: {
        id: 'model-guide',
        ...
        content: [
          '**Qwen2.5 :** Meilleur support chinois natif. Prompts système anglais pour les tâches de raisonnement.',
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: 'Peut-on mélanger chinois et anglais dans un prompt ?', a: 'Oui. Qwen2.5 et DeepSeek-R1-Distill gèrent bien les prompts bilingues.' },
          { q: 'Quelle langue pour les prompts système ?', a: 'Anglais, même sur des modèles à dominante chinoise comme Qwen2.5. Meilleure instruction-following.' },
          { q: 'Chinois traditionnel vs simplifié ?', a: 'Qwen2.5 gère les deux. Préciser "请使用繁体中文" pour le traditionnel ou "请使用简体中文" pour le simplifié.' },
        ],
      },
    },
    schema: {
      ...
      description: 'Tokenisation CJK : 30–50 % moins de tokens sur Qwen2.5. Prompts système anglais pour meilleur raisonnement. Technique mixte recommandée.',
  ...
  ja: {
    ...
    metaDescription: 'Qwen2.5とDeepSeek-R1-Distillモデルでは中国語プロンプトがトークンを三十〜五十パーセント節約します。英語プロンプトはほぼ全モデルで強力な論理推論チェーンを生成します。混合言語テクニックと各モデル別の詳細ガイダンスを解説します。',
    publishDate: '2026-05-26',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-26',
    educationalLevel: 'Intermediate',
    ...
    is_living_page: false,
    quickAnswerTop: {
      en: { question: 'Chinese or English prompting for LLMs?', answer: 'English instructions + Chinese reply directive is best.', bullets: ['Chinese saves 30–50% tokens on Qwen2.5'], updatedDate: '2026-05' },
      ...
      ja: {
        question: 'ローカルLLMへのプロンプトは中国語と英語どちらが良い？',
        answer: 'Qwen2.5とDeepSeek-R1-Distillモデルでは、中国語プロンプトはトークンを30–50%節約（CJKトークン化はより密集）。英語プロンプトはほぼ全てのモデルで強い推論チェーンを生成。ベストプラクティス：英語で指示を書き、中国語での返答を指示。',
        bullets: [
    ...
    sections: {
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: '同じプロンプトで中国語と英語を混ぜられますか？', a: 'はい。Qwen2.5とDeepSeek-R1-Distillはバイリンガルプロンプトをよく処理します。' },
          { q: 'システムプロンプトにはどの言語を使うべきですか？', a: 'Qwen2.5のような中国語ネイティブモデルでも英語が推奨。より良い指示フォローを一貫して生成します。' },
          { q: '繁体字と簡体字の違いは？', a: 'Qwen2.5は両方に対応。繁体字には「请使用繁体中文回答」、簡体字には「请使用简体中文回答」と指定。' },
        ],
      },
    },
    schema: {
      ...
      description: 'CJKトークン化でQwen2.5のトークンを30–50%節約。英語システムプロンプトがより良い推論を生成。混合言語テクニック推奨。',
  ...
  zh: {
    ...
    metaDescription: '在Qwen2.5和DeepSeek-R1-Distill模型上，中文提示词比英文少用百分之三十到五十的token，中文输出更自然流畅。英文提示词在几乎所有模型上产生更强的逻辑推理链。本文提供混合语言提示技巧与各模型专项最佳实践指南。',
    publishDate: '2026-05-26',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-26',
    educationalLevel: 'Intermediate',
    ...
    is_living_page: false,
    quickAnswerTop: {
      en: { question: 'Chinese or English prompting?', answer: 'English instructions + Chinese reply directive is best.', bullets: ['Chinese saves 30–50% tokens on Qwen2.5'], updatedDate: '2026-05' },
      ...
      zh: {
        question: '用中文还是英文提示本地LLM更好？',
        answer: '取决于模型和任务。Qwen2.5和DeepSeek-R1-Distill模型的中文提示词消耗的token减少30–50%，输出的中文更自然。英文提示词在大多数模型上产生更强的逐步推理链。最佳实践：用英文写指令，让模型用中文回答。',
        bullets: [
    ...
    sections: {
      ...
      faqSection: {
        ...
        faqs: [
          ...
          { q: '同一提示中可以混用中英文吗？', a: '可以。Qwen2.5和DeepSeek-R1-Distill能很好地处理双语混合提示。' },
          { q: '系统提示应该使用哪种语言？', a: '英文，即使在Qwen2.5这样的中文原生模型上。英文系统提示始终产生更好的指令遵从。' },
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Qwen本地部署指南2026](/zh/local-llms/qwen-local-deployment-guide-2026) — 为中文创作场景优化本地Qwen2.5部署的完整指南。',
        ],
      },
    },
    schema: {
      ...
      description: 'CJK分词在Qwen2.5上节省30–50% token。英文系统提示产生更强推理。推荐混合语言技巧。',
    ...
    faqSchema: {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: '系统提示词应该用哪种语言？', acceptedAnswer: { '@type': 'Answer', text: '英文，即使在Qwen2.5这样的中文原生模型上，英文系统提示始终产生更好的指令遵从。' } },
      ],
    },
  },
