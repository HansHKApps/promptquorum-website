...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: 'Llama 3 8B Q4_K_M (~5 tok/s) best for 16 GB laptops. Qwen 2.5 Coder 7B optimal for coding. Apple Silicon ~3× faster. Quick answer from PromptQuorum.',
