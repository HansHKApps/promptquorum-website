...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  de: {
    ...
    metaDescription: 'Mit 16 GB RAM und ohne GPU ist Llama 3 8B Q4_K_M das beste lokale LLM für einen Laptop. Läuft bei ~3–5 tok/s auf CPU. Mistral 7B ist eine schnelle Alternative.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  fr: {
    ...
    metaDescription: 'Avec 16 Go de RAM et sans GPU, Llama 3 8B Q4_K_M est le meilleur LLM local pour laptop. Tourne à ~3–5 tok/s sur CPU. Mistral 7B est plus rapide.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
