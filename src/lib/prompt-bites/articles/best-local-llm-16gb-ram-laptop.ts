    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Mistral Small 24B vs Qwen3 14B vs Llama 3.1 8B](/prompt-bites/mistral-small-24b-vs-qwen-14b-vs-llama-8b) -- model comparison',
        ],
      },
    },
  },
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Ja, wenn Sie regelmäßig 14B+-Modelle ausführen oder das Modell geladen halten möchten, während Sie andere ressourcenintensive Anwendungen verwenden. Mit 32 GB läuft Qwen3 14B problemlos ohne Speicherdruck. Sie können auch 70B-Modelle mit sehr aggressiver Quantisierung (Q2_K bei ~24 GB) nutzen, obwohl die Qualität unterhalb von Q4 erheblich abnimmt. Für die meisten Nutzer mit 7–8B-Modellen reichen 16 GB.',
          },
        ],
      },
      relatedReading: {
        ...
        items: [
          ...
          '[Mistral Small 24B vs Qwen3 14B vs Llama 3.1 8B](/de/prompt-bites/mistral-small-24b-vs-qwen-14b-vs-llama-8b) -- model comparison',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Mistral Small 24B vs Qwen3 14B vs Llama 3.1 8B](/fr/prompt-bites/mistral-small-24b-vs-qwen-14b-vs-llama-8b) -- model comparison',
        ],
      },
    },
  },
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'はい、14B+ モデルを定期的に実行する場合や、他の重いアプリケーションを実行しながらモデルをロードしたままにしたい場合は。32 GB なら Qwen3 14B はメモリプレッシャーなしに快適に動作します。非常にアグレッシブな量子化で 70B モデルも解放されます（Q2_K で ~24 GB）が、Q4 以下では品質が著しく低下します。7～8B モデルを実行するほとんどのユーザーには 16 GB で十分です。',
          },
        ],
      },
      relatedReading: {
        ...
        items: [
          ...
          '[Mistral Small 24B vs Qwen3 14B vs Llama 3.1 8B](/ja/prompt-bites/mistral-small-24b-vs-qwen-14b-vs-llama-8b) -- model comparison',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Mistral Small 24B vs Qwen3 14B vs Llama 3.1 8B](/es/prompt-bites/mistral-small-24b-vs-qwen-14b-vs-llama-8b) -- model comparison',
        ],
      },
    },
  },
    ...
    sections: {
      ...
      relatedReading: {
        ...
        items: [
          ...
          '[Mistral Small 24B vs Qwen3 14B vs Llama 3.1 8B](/pt/prompt-bites/mistral-small-24b-vs-qwen-14b-vs-llama-8b) -- model comparison',
        ],
      },
    },
  },
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'نعم، إذا شغّلت نماذج 14B+ بشكل منتظم أو أردت إبقاء النموذج محملاً أثناء استخدام تطبيقات أخرى ثقيلة. مع 32 جيجابايت، يعمل Qwen3 14B بدون ضغط على الذاكرة. تفتح أيضاً نماذج 70B بتكميم شديد للغاية (Q2_K بـ~24 جيجابايت)، وإن كانت الجودة تتراجع بشكل ملحوظ دون Q4. لمعظم المستخدمين الذين يشغّلون نماذج 7–8B، 16 جيجابايت كافية.',
          },
        ],
      },
      relatedReading: {
        ...
        items: [
          ...
          '[Mistral Small 24B vs Qwen3 14B vs Llama 3.1 8B](/ar/prompt-bites/mistral-small-24b-vs-qwen-14b-vs-llama-8b) -- model comparison',
        ],
      },
    },
  },
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: '值得，如果你经常运行 14B+ 模型或希望在运行其他繁重应用时保持模型加载。32 GB 下 Qwen3 14B 运行流畅无内存压力。还可以解锁超激进量化的 70B 模型（Q2_K 约 24 GB），但 Q4 以下质量明显下降。对大多数运行 7~8B 模型的用户，16 GB 已经足够。',
          },
        ],
      },
      relatedReading: {
        ...
        items: [
          ...
          '[Mistral Small 24B vs Qwen3 14B vs Llama 3.1 8B](/zh/prompt-bites/mistral-small-24b-vs-qwen-14b-vs-llama-8b) -- model comparison',
        ],
      },
    },
  },
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: '14B 이상 모델을 자주 실행하거나 다른 무거운 애플리케이션을 사용하는 동안 모델을 로드 상태로 유지하려면 가치가 있습니다. 32 GB에서는 Qwen3 14B가 메모리 압박 없이 실행됩니다. 매우 공격적인 양자화(Q2_K, 약 24 GB)의 70B 모델도 사용할 수 있지만, Q4 이하에서는 품질이 눈에 띄게 저하됩니다. 7~8B 모델을 실행하는 대부분의 사용자에게는 16 GB면 충분합니다.',
          },
        ],
      },
      relatedReading: {
        ...
        items: [
          ...
          '[Mistral Small 24B vs Qwen3 14B vs Llama 3.1 8B](/ko/prompt-bites/mistral-small-24b-vs-qwen-14b-vs-llama-8b) -- model comparison',
        ],
      },
    },
  },
