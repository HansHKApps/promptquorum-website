...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    heroImage: '/images/is-qwen-gdpr-compliant-overview-hero-en.webp',
    title: 'Is Qwen GDPR Compliant?',
    dateModified: '2026-09-02',
    seoTitle: 'Is Qwen GDPR Compliant? 2026 | Prompt Bites | PromptQuorum',
    metaDescription: 'Qwen run locally is GDPR-compliant — no data transfer, no Article 44 issue. Qwen API (Alibaba Cloud) requires SCCs like any non-EU cloud provider.',
    publishDate: '2026-05-22',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-03-02',
    current_models_mentioned: ['Qwen3 14B', 'Qwen3 8B'],
    current_hardware_mentioned: ['RTX 3080', 'RTX 4070'],
    ...
    sections: {
      ...
      body1: {
        ...
        content: [
          ...
          'The Qwen model weights (Qwen3 14B, Qwen3 8B) are released under Apache 2.0. This means you can download them, inspect them, and run them on your own server permanently — the licence cannot be revoked. Article 25 (data protection by design) is satisfied because you can demonstrate that sensitive data is never transmitted externally.',
          'Run Qwen locally via Ollama: <code>ollama run qwen3:14b</code> for general tasks, or <code>ollama run qwen3:8b</code> for lighter hardware. The 14B model needs 10–12 GB VRAM at Q4_K_M (a standard RTX 3080 or RTX 4070 is sufficient); the 8B model runs on 6–8 GB VRAM.',
        ],
        snippetBlocks: [
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'For 12 GB VRAM: Qwen3 14B at Q4_K_M (general tasks) or Qwen2.5-Coder 14B (code-heavy workflows). For 6–8 GB VRAM: Qwen3 8B at Q4_K_M. Both run fully offline via Ollama. See the <a href="/local-llms/qwen-local-gdpr-setup-guide-2026" class="text-primary hover:underline">complete GDPR Qwen setup guide</a> for Ollama installation steps.',
          },
          {
      ...
      relatedReading: {
        ...
        items: [
          '[How to Set Up Qwen Locally for GDPR-Compliant Workflows](/local-llms/qwen-local-gdpr-setup-guide-2026)',
          '[Is DeepSeek GDPR Safe to Use?](/prompt-bites/is-deepseek-gdpr-safe)',
          '[Can a Local LLM Help with GDPR Compliance?](/prompt-bites/can-local-llm-help-gdpr)',
        ],
      },
    },
  },
  de: {
    theme: 'Privacy & Security',
    heroImage: '/images/is-qwen-gdpr-compliant-overview-hero-de.webp',
    ...
    quickAnswerTop: {
      de: {
        ...
        bullets: [
          ...
          'Empfehlung: Qwen3 14B oder Qwen3 8B lokal via Ollama für datensensible Aufgaben',
        ],
        updatedDate: '2026-09',
      },
    },
    sections: {
      ...
      body1: {
        ...
        content: [
          ...
          'Die Qwen-Modellgewichte (Qwen3 14B, Qwen3 8B) werden unter Apache 2.0 veröffentlicht. Das bedeutet, Sie können sie herunterladen, prüfen und dauerhaft auf Ihrem eigenen Server betreiben — die Lizenz kann nicht widerrufen werden. Artikel 25 (Datenschutz durch Technikgestaltung) ist erfüllt, weil Sie nachweisen können, dass sensible Daten niemals extern übertragen werden.',
          'Betreiben Sie Qwen lokal via Ollama: <code>ollama run qwen3:14b</code> für allgemeine Aufgaben oder <code>ollama run qwen3:8b</code> für schwächere Hardware. Das 14B-Modell benötigt 10–12 GB VRAM bei Q4_K_M (eine Standard-RTX-3080 oder RTX-4070 ist ausreichend); das 8B-Modell läuft mit 6–8 GB VRAM.',
        ],
        snippetBlocks: [
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Für 12 GB VRAM: Qwen3 14B bei Q4_K_M (allgemeine Aufgaben) oder Qwen2.5-Coder 14B (code-intensive Workflows). Für 6–8 GB VRAM: Qwen3 8B bei Q4_K_M. Beide laufen vollständig offline via Ollama. Vollständige Einrichtungsschritte finden Sie im <a href="/de/local-llms/qwen-local-gdpr-setup-guide-2026" class="text-primary hover:underline">vollständigen DSGVO-Qwen-Einrichtungsleitfaden</a>.',
          },
          {
      ...
      relatedReading: {
        ...
        items: [
          '[Qwen lokal einrichten für DSGVO-konforme Workflows](/de/local-llms/qwen-local-gdpr-setup-guide-2026)',
          '[Ist DeepSeek DSGVO-sicher?](/de/prompt-bites/is-deepseek-gdpr-safe)',
          '[Kann ein lokales LLM bei der DSGVO-Compliance helfen?](/de/prompt-bites/can-local-llm-help-gdpr)',
        ],
      },
    },
  },
  fr: {
    theme: 'Privacy & Security',
    heroImage: '/images/is-qwen-gdpr-compliant-overview-hero-fr.webp',
    title: 'Qwen est-il conforme au RGPD ?',
    seoTitle: 'Qwen conforme RGPD 2026 ? | Prompt Bites | PromptQuorum',
    metaDescription: 'Qwen en local est conforme au RGPD — pas de transfert, pas de problème Article 44. L\'API (Alibaba Cloud) exige des CCT comme tout prestataire hors UE.',
    publishDate: '2026-05-22',
    dateModified: '2026-09-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-03-02',
    quickAnswerTop: {
      fr: {
        ...
        bullets: [
          ...
          'Recommandé : Qwen3 14B ou Qwen3 8B en local via Ollama pour les tâches sensibles',
        ],
        updatedDate: '2026-09',
      },
    },
    sections: {
      ...
      body1: {
        ...
        content: [
          ...
          'Les poids des modèles Qwen (Qwen3 14B, Qwen3 8B) sont publiés sous Apache 2.0. Cela signifie que vous pouvez les télécharger, les inspecter et les exécuter sur votre propre serveur de façon permanente — la licence ne peut pas être révoquée. L\'Article 25 (protection des données dès la conception) est satisfait car vous pouvez démontrer que les données sensibles ne sont jamais transmises en externe.',
          'Exécutez Qwen localement via Ollama : <code>ollama run qwen3:14b</code> pour les tâches générales, ou <code>ollama run qwen3:8b</code> pour du matériel plus léger. Le modèle 14B nécessite 10–12 Go de VRAM en Q4_K_M (une RTX 3080 ou RTX 4070 standard suffit) ; le modèle 8B fonctionne avec 6–8 Go de VRAM.',
        ],
        snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          '[Configurer Qwen localement pour des workflows conformes au RGPD](/fr/local-llms/qwen-local-gdpr-setup-guide-2026)',
          '[DeepSeek est-il sûr au regard du RGPD ?](/fr/prompt-bites/is-deepseek-gdpr-safe)',
          '[Un LLM local peut-il aider à la conformité RGPD ?](/fr/prompt-bites/can-local-llm-help-gdpr)',
        ],
      },
    },
  },
  ja: {
    theme: 'Privacy & Security',
    heroImage: '/images/is-qwen-gdpr-compliant-overview-hero-ja.webp',
    title: 'QwenはGDPR準拠ですか？',
    seoTitle: 'QwenはGDPR準拠？2026 | Prompt Bites | PromptQuorum',
    metaDescription: 'ローカルQwenはGDPR準拠——データ転送なし、第44条問題なし。Qwen API（Alibaba Cloud）は他の非EU提供者と同様SCCが必要。',
    publishDate: '2026-05-22',
    dateModified: '2026-09-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-03-02',
    quickAnswerTop: {
      ja: {
        ...
        bullets: [
          ...
          '推奨：Ollama経由Qwen3 14BまたはQwen3 8Bをローカル実行（データ機密タスク）',
        ],
        updatedDate: '2026-09',
      },
    },
    sections: {
      ...
      body1: {
        ...
        content: [
          ...
          'Qwenモデル重み（Qwen3 14B、Qwen3 8B）はApache 2.0で公開されています。ダウンロード、検査、自社サーバーでの永続的な運用が可能で、ライセンスは取り消せません。機密データが外部転送されないことを証明できるため、第25条（プライバシーバイデザイン）を満たします。',
          'OllamaでQwenをローカル実行：一般的なタスクには<code>ollama run qwen3:14b</code>、軽量なハードウェアには<code>ollama run qwen3:8b</code>を使用します。14BモデルはQ4_K_Mで10〜12 GB VRAMが必要（標準的なRTX 3080またはRTX 4070で十分）、8Bモデルは6〜8 GB VRAMで動作します。',
        ],
        snippetBlocks: [
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: '12 GB VRAM：Qwen3 14B（Q4_K_M、汎用タスク）またはQwen2.5-Coder 14B（コード重視）。6〜8 GB VRAM：Qwen3 8B（Q4_K_M）。どちらもOllama経由で完全オフライン動作。詳細なセットアップ手順は<a href="/ja/local-llms/qwen-local-gdpr-setup-guide-2026" class="text-primary hover:underline">Qwen GDPRセットアップガイド</a>を参照してください。',
          },
          {
      ...
      relatedReading: {
        title: '関連読書',
        items: [
          '[GDPRに準拠したワークフローのためのQwenローカルセットアップ方法](/ja/local-llms/qwen-local-gdpr-setup-guide-2026)',
          '[DeepSeekはGDPR的に安全ですか？](/ja/prompt-bites/is-deepseek-gdpr-safe)',
          '[ローカルLLMはGDPRコンプライアンスに役立ちますか？](/ja/prompt-bites/can-local-llm-help-gdpr)',
        ],
      },
    },
  },
  zh: {
    theme: 'Privacy & Security',
    heroImage: '/images/is-qwen-gdpr-compliant-overview-hero-zh.webp',
    title: 'Qwen符合GDPR吗？',
    seoTitle: 'Qwen符合GDPR吗？2026 | Prompt Bites | PromptQuorum',
    metaDescription: '本地Qwen符合GDPR——无数据传输，无第44条问题。Qwen API（阿里云）与其他非欧盟提供商一样需要SCCs。',
    publishDate: '2026-05-22',
    dateModified: '2026-09-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-03-02',
    quickAnswerTop: {
      zh: {
        ...
        bullets: [
          ...
          '推荐：Ollama本地运行Qwen3 14B或Qwen3 8B处理敏感数据任务',
        ],
        updatedDate: '2026-09',
      },
    },
    sections: {
      ...
      body1: {
        ...
        content: [
          ...
          'Qwen模型权重（Qwen3 14B、Qwen3 8B）以Apache 2.0发布。这意味着您可以下载、检查并在自己的服务器上永久运行它们——许可证不可撤销。由于您可以证明敏感数据从未外部传输，第25条（隐私设计）得以满足。',
          '通过Ollama本地运行Qwen：通用任务使用<code>ollama run qwen3:14b</code>，硬件较弱时使用<code>ollama run qwen3:8b</code>。14B模型在Q4_K_M下需要10-12 GB VRAM（标准RTX 3080或RTX 4070即可）；8B模型仅需6-8 GB VRAM。',
        ],
        snippetBlocks: [
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: '12 GB VRAM：Qwen3 14B（Q4_K_M，通用任务）或Qwen2.5-Coder 14B（代码密集型工作流）。6-8 GB VRAM：Qwen3 8B（Q4_K_M）。两者均通过Ollama完全离线运行。完整设置步骤请参阅<a href="/zh/local-llms/qwen-local-gdpr-setup-guide-2026" class="text-primary hover:underline">Qwen GDPR完整设置指南</a>。',
          },
          {
      ...
      relatedReading: {
        title: '相关阅读',
        items: [
          '[为GDPR合规工作流本地配置Qwen](/zh/local-llms/qwen-local-gdpr-setup-guide-2026)',
          '[DeepSeek在GDPR方面安全吗？](/zh/prompt-bites/is-deepseek-gdpr-safe)',
          '[本地LLM能帮助GDPR合规吗？](/zh/prompt-bites/can-local-llm-help-gdpr)',
        ],
      },
    },
  },
  pt: {
    theme: 'Privacy & Security',
    heroImage: '/images/is-qwen-gdpr-compliant-overview-hero-pt.webp',
    title: 'O Qwen é compatível com o RGPD?',
    seoTitle: 'O Qwen é compatível com o RGPD? 2026 | PromptQuorum',
    metaDescription: 'O Qwen local cumpre o RGPD: sem transferência de dados, sem problema do Artigo 44. A API (Alibaba Cloud) requer CCT, como qualquer fornecedor não europeu.',
    publishDate: '2026-05-22',
    dateModified: '2026-09-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-03-02',
    quickAnswerTop: {
      pt: {
        ...
        bullets: [
          ...
          'Recomendado: Qwen3 14B ou Qwen3 8B localmente via Ollama para tarefas com dados sensíveis',
        ],
        updatedDate: '2026-09',
      },
    },
    sections: {
      ...
      body1: {
        ...
        content: [
          ...
          'Os pesos do modelo Qwen (Qwen3 14B, Qwen3 8B) são lançados sob Apache 2.0. Isso significa que você pode baixá-los, inspecioná-los e executá-los no seu próprio servidor de forma permanente — a licença não pode ser revogada. O Artigo 25 (proteção de dados por concepção) é satisfeito porque você pode demonstrar que os dados sensíveis nunca são transmitidos externamente.',
          'Execute o Qwen localmente via Ollama: <code>ollama run qwen3:14b</code> para tarefas gerais, ou <code>ollama run qwen3:8b</code> para hardware mais limitado. O modelo 14B precisa de 10–12 GB de VRAM em Q4_K_M (uma RTX 3080 ou RTX 4070 padrão é suficiente); o modelo 8B roda com 6–8 GB de VRAM.',
        ],
        snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          '[Como configurar o Qwen localmente para fluxos de trabalho em conformidade com o GDPR](/pt/local-llms/qwen-local-gdpr-setup-guide-2026)',
          '[O DeepSeek é seguro para uso sob o RGPD?](/pt/prompt-bites/is-deepseek-gdpr-safe)',
          '[Um LLM local pode ajudar com a conformidade do RGPD?](/pt/prompt-bites/can-local-llm-help-gdpr)',
        ],
      },
    },
  },
  es: {
    theme: 'Privacy & Security',
    heroImage: '/images/is-qwen-gdpr-compliant-overview-hero-es.webp',
    title: '¿Es Qwen compatible con el RGPD?',
    seoTitle: '¿Es Qwen compatible con el RGPD? 2026 | PromptQuorum',
    metaDescription: 'Qwen en local cumple el RGPD: sin transferencia de datos ni problema del Artículo 44. La API (Alibaba Cloud) requiere CCT, como todo proveedor no europeo.',
    publishDate: '2026-05-22',
    dateModified: '2026-09-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-03-02',
    quickAnswerTop: {
      es: {
        ...
        bullets: [
          ...
          'Recomendado: Qwen3 14B o Qwen3 8B localmente via Ollama para tareas con datos sensibles',
        ],
        updatedDate: '2026-09',
      },
    },
    sections: {
      ...
      body1: {
        ...
        content: [
          ...
          'Los pesos del modelo Qwen (Qwen3 14B, Qwen3 8B) se publican bajo Apache 2.0. Esto significa que puedes descargarlos, inspeccionarlos y ejecutarlos en tu propio servidor de forma permanente; la licencia no puede revocarse. El Artículo 25 (privacidad desde el diseño) queda satisfecho porque puedes demostrar que los datos sensibles nunca se transmiten externamente.',
          'Ejecuta Qwen localmente via Ollama: <code>ollama run qwen3:14b</code> para tareas generales, o <code>ollama run qwen3:8b</code> para hardware más modesto. El modelo 14B necesita 10–12 GB de VRAM en Q4_K_M (una RTX 3080 o RTX 4070 estándar es suficiente); el modelo 8B funciona con 6–8 GB de VRAM.',
        ],
        snippetBlocks: [
      ...
      relatedReading: {
        ...
        items: [
          '[Cómo configurar Qwen localmente para flujos de trabajo conformes con el RGPD](/es/local-llms/qwen-local-gdpr-setup-guide-2026)',
          '[¿Es seguro usar DeepSeek bajo el RGPD?](/es/prompt-bites/is-deepseek-gdpr-safe)',
          '[¿Puede un LLM local ayudar con el cumplimiento del RGPD?](/es/prompt-bites/can-local-llm-help-gdpr)',
        ],
      },
    },
  },
  ar: {
    theme: 'Privacy & Security',
    heroImage: '/images/is-qwen-gdpr-compliant-overview-hero-ar.webp',
    ...
    quickAnswerTop: {
      ar: {
        ...
        bullets: [
          ...
          'موصى به: Qwen3 14B أو Qwen3 8B محلياً عبر Ollama للمهام ذات البيانات الحساسة',
        ],
        updatedDate: '2026-09',
      },
    },
    sections: {
      ...
      body1: {
        ...
        content: [
          ...
          'أوزان نموذج Qwen (Qwen3 14B، Qwen3 8B) تُطرح بموجب Apache 2.0. هذا يعني أنك تستطيع تنزيلها وفحصها وتشغيلها على خادمك الخاص بصفة دائمة؛ الترخيص لا يمكن سحبه. المادة 25 (الخصوصية بالتصميم) مُستوفاة لأنك تستطيع إثبات أن البيانات الحساسة لا تُرسل خارجياً أبداً.',
          'شغّل Qwen محلياً عبر Ollama: <code>ollama run qwen3:14b</code> للمهام العامة، أو <code>ollama run qwen3:8b</code> للأجهزة الأخف. يحتاج نموذج 14B إلى 10–12 GB VRAM عند Q4_K_M (تكفي RTX 3080 أو RTX 4070 قياسية)؛ ويعمل نموذج 8B بـ 6–8 GB VRAM.',
        ],
        snippetBlocks: [
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'لـ 12 GB VRAM: Qwen3 14B بتكميم Q4_K_M (المهام العامة) أو Qwen2.5-Coder 14B (سير عمل البرمجة المكثفة). لـ 6–8 GB VRAM: Qwen3 8B بتكميم Q4_K_M. كلاهما يعمل بالكامل دون اتصال عبر Ollama. راجع <a href="/ar/local-llms/qwen-local-gdpr-setup-guide-2026" class="text-primary hover:underline">الدليل الكامل لإعداد Qwen لـ GDPR</a> لخطوات التثبيت مع Ollama.',
          },
          {
      ...
      relatedReading: {
        ...
        items: [
          '[كيفية إعداد Qwen محليًا لسير عمل متوافق مع GDPR](/ar/local-llms/qwen-local-gdpr-setup-guide-2026)',
          '[هل استخدام DeepSeek آمن وفق اللائحة الأوروبية لحماية البيانات GDPR؟](/ar/prompt-bites/is-deepseek-gdpr-safe)',
          '[هل يمكن لنموذج LLM المحلي المساعدة في الامتثال للائحة GDPR؟](/ar/prompt-bites/can-local-llm-help-gdpr)',
        ],
      },
    },
  },
  ko: {
    theme: 'Privacy & Security',
    heroImage: '/images/is-qwen-gdpr-compliant-overview-hero-ko.webp',
    ...
    quickAnswerTop: {
      ko: {
        ...
        bullets: [
          ...
          '권장 사항: 데이터 민감 작업에는 Ollama를 통해 Qwen3 14B 또는 Qwen3 8B를 로컬에서 실행',
        ],
        updatedDate: '2026-09',
      },
    },
    sections: {
      ...
      body1: {
        ...
        content: [
          ...
          'Qwen 모델 가중치(Qwen3 14B, Qwen3 8B)는 Apache 2.0 라이선스로 배포됩니다. 이는 자체 서버에 영구적으로 다운로드, 검사, 실행할 수 있음을 의미합니다. 라이선스는 철회될 수 없습니다. 민감한 데이터가 외부로 전송되지 않는다는 것을 증명할 수 있으므로 제25조(설계 기반 개인정보보호)가 충족됩니다.',
          'Ollama를 통해 Qwen을 로컬에서 실행하십시오. 일반 작업에는 <code>ollama run qwen3:14b</code>를, 더 가벼운 하드웨어에는 <code>ollama run qwen3:8b</code>를 사용하십시오. 14B 모델은 Q4_K_M에서 10~12 GB VRAM이 필요합니다(표준 RTX 3080 또는 RTX 4070으로 충분). 8B 모델은 6~8 GB VRAM으로 작동합니다.',
        ],
        snippetBlocks: [
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: '12 GB VRAM의 경우: 범용 작업에는 Q4_K_M의 Qwen3 14B, 코드 집약적 워크플로우에는 Qwen2.5-Coder 14B를 권장합니다. 6~8 GB VRAM의 경우: Q4_K_M의 Qwen3 8B를 권장합니다. 두 모델 모두 Ollama를 통해 완전히 오프라인으로 실행됩니다. Ollama 설치 단계는 <a href="/ko/local-llms/qwen-local-gdpr-setup-guide-2026" class="text-primary hover:underline">완전한 GDPR Qwen 설정 가이드</a>를 참조하십시오.',
          },
          {
