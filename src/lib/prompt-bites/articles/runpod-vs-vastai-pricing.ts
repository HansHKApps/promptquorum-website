...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  es: {
    ...
    quickAnswerTop: {
      es: {
        ...
        answer: 'Vast.ai es más barato para instancias spot (RTX 4090 a ~$0.15/hr vs RunPod ~$0.44/hr). RunPod es más fiable con disponibilidad garantizada.',
        bullets: [
          'Vast.ai spot RTX 4090: $0.10-0.25/hr; bajo demanda: $0.50-0.80/hr.',
          'RunPod Secure Cloud RTX 4090: $0.44/hr — sin cold starts, disponibilidad garantizada.',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Las tarifas de Vast.ai varían por anfitrión; comprueba los listados actuales antes de reservar — los rangos indicados son aproximaciones de mayo 2026',
      ...
      comparison: {
        ...
        content: [
          '<strong>Las tarifas siguientes son rangos aproximados a mayo de 2026 — verifica los paneles en vivo antes de reservar.</strong> Las tarifas de Vast.ai varían por anfitrión y región; el extremo inferior suele ser interrumpible.',
        ],
        columns: ['GPU', 'Vast.ai (aprox.)', 'RunPod (aprox.)', 'Notas'],
        rows: [
          {
          ...
          },
          {
            ...
            'Vast.ai (aprox.)': '$0.90-1.40/hr',
            'RunPod (aprox.)': '$1.20-1.90/hr',
            'Notas': 'Tarjeta de datacenter; la diferencia es menor',
          },
          {
            'GPU': 'H100 80 GB',
            'Vast.ai (aprox.)': '$2.20-3.50/hr',
            'RunPod (aprox.)': '$2.70-4.00/hr',
            'Notas': 'Gama alta; disponibilidad variable',
          },
        ],
      },
      faq: {
  ...
  ar: {
    ...
    metaDescription: 'Vast.ai أرخص في وحدات GPU المؤقتة/القابلة للمقاطعة؛ RunPod أكثر موثوقية للأحمال المستدامة. أسعار بالساعة من مايو 2026؛ تحقق من الأسعار الحالية.',
    publishDate: '2026-05-22',
    dateModified: '2026-05-22',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-22',
    ...
    quickAnswerTop: {
      ar: {
        ...
        answer: 'Vast.ai أرخص للحالات المؤقتة (RTX 4090 بـ ~$0.15/hr مقابل RunPod ~$0.44/hr). RunPod أكثر موثوقية مع توفر مضمون.',
        bullets: [
          'Vast.ai مؤقت RTX 4090: $0.10-0.25/hr؛ عند الطلب: $0.50-0.80/hr.',
          'RunPod Secure Cloud RTX 4090: $0.44/hr — بدون تأخيرات بارد، توفر مضمون.',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'تتفاوت أسعار Vast.ai حسب المضيف؛ تحقق من القوائم الحية قبل الحجز — النطاقات المذكورة تقريبية من مايو 2026',
      ...
      comparison: {
        ...
        content: [
          '<strong>الأسعار التالية نطاقات تقريبية اعتبارًا من مايو 2026 — تحقق من لوحات التحكم الحية قبل الحجز.</strong> تتفاوت أسعار Vast.ai حسب المضيف والمنطقة؛ الطرف الأدنى من النطاق يكون عادةً قابلًا للمقاطعة.',
        ],
        ...
        rows: [
          {
            ...
            'RunPod (تقريبي)': '$0.60-0.80/hr',
            'ملاحظات': 'Vast عادةً أرخص في بطاقات المستهلك',
          },
          {
            'وحدة معالجة الرسومات': 'A100 80 GB',
            'Vast.ai (تقريبي)': '$0.90-1.40/hr',
            'RunPod (تقريبي)': '$1.20-1.90/hr',
            'ملاحظات': 'بطاقة مركز بيانات؛ الفارق أصغر',
          },
          {
            'وحدة معالجة الرسومات': 'H100 80 GB',
            'Vast.ai (تقريبي)': '$2.20-3.50/hr',
            'RunPod (تقريبي)': '$2.70-4.00/hr',
            'ملاحظات': 'الفئة العليا؛ التوفر متغير',
          },
        ],
      },
      faq: {
