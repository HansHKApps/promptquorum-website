    ...
    sections: {
      ...
      related: {
        ...
        items: [
          ...
          '[1,500달러 이하 로컬 LLM용 최적의 Windows 노트북](/prompt-bites/best-windows-laptop-local-llm-under-1500) — 전체 노트북 구매 비교',
          '[AI PC·NPU 표준화 트렌드](/prompt-bites/local-ai-trend-2027-ai-pc-npu-normalization) — NPU 가속 로컬 AI가 실제로 향하는 방향',
        ],
      },
    },
  },
