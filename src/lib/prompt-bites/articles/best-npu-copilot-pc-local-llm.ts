...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  ar: {
    ...
    metaDescription: 'وحدات NPU في أجهزة Copilot+ PC (Snapdragon X Elite، Intel Lunar Lake، Ryzen AI 300) لا يستخدمها Ollama أو llama.cpp بعد — الدردشة عبر LLM محلي لا تزال تعمل على CPU أو GPU.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  de: {
    ...
    metaDescription: 'Copilot+-PC-NPUs (Snapdragon X Elite, Intel Lunar Lake, Ryzen AI 300) werden von Ollama oder llama.cpp noch nicht genutzt — lokaler LLM-Chat läuft weiter auf CPU oder GPU.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  es: {
    ...
    metaDescription: 'Las NPU de Copilot+ PC (Snapdragon X Elite, Intel Lunar Lake, Ryzen AI 300) aún no son usadas por Ollama ni llama.cpp — el chat de LLM local sigue corriendo en CPU o GPU.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  fr: {
    ...
    metaDescription: 'Les NPU des PC Copilot+ (Snapdragon X Elite, Intel Lunar Lake, Ryzen AI 300) ne sont pas encore utilisés par Ollama ou llama.cpp — le chat LLM local tourne toujours sur CPU ou GPU.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  ja: {
    ...
    metaDescription: 'Copilot+ PCのNPU(Snapdragon X Elite、Intel Lunar Lake、Ryzen AI 300)はOllamaやllama.cppではまだ使われていません — ローカルLLMチャットは依然CPUかGPUで動作します。',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  ko: {
    ...
    metaDescription: 'Copilot+ PC의 NPU(Snapdragon X Elite, Intel Lunar Lake, Ryzen AI 300)는 아직 Ollama나 llama.cpp에서 사용되지 않습니다 — 로컬 LLM 채팅은 여전히 CPU나 GPU에서 실행됩니다.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  pt: {
    ...
    metaDescription: 'As NPUs dos PCs Copilot+ (Snapdragon X Elite, Intel Lunar Lake, Ryzen AI 300) ainda não são usadas pelo Ollama ou llama.cpp — o chat de LLM local ainda roda na CPU ou GPU.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
