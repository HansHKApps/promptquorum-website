...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  de: {
    ...
    seoTitle: 'Ollama 128K Kontext-Modelle? | Prompt Bites | PromptQuorum',
    metaDescription: 'Llama 3.1 8B und Qwen 2.5 14B unterstützen 128K+ Kontext auf Ollama. Qwen erreicht 1M Tokens. Voller Kontext erhöht den VRAM-Bedarf erheblich. Schnelle Antwort von PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  fr: {
    ...
    seoTitle: 'Modèles Ollama à contexte 128K ? | Prompt Bites | PromptQuorum',
    metaDescription: 'Llama 3.1 8B et Qwen 2.5 14B supportent le contexte 128K+ sur Ollama. Qwen atteint 1M de tokens. Le contexte complet augmente fortement l\'utilisation VRAM. Réponse rapide par PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  ja: {
    ...
    seoTitle: 'Ollama 128Kコンテキストモデル？ | Prompt Bites | PromptQuorum',
    metaDescription: 'Llama 3.1 8BとQwen 2.5 14BはOllamaで128K以上のコンテキストに対応。Qwenは1Mトークンに到達。フルコンテキストはVRAMを大幅に増加。PromptQuorumによる簡潔な回答。',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  zh: {
    ...
    seoTitle: 'Ollama 128K上下文模型？| Prompt Bites | PromptQuorum',
    metaDescription: 'Llama 3.1 8B和Qwen 2.5 14B在Ollama上支持128K以上上下文。Qwen可达1M个token。完整上下文会大幅增加VRAM需求。PromptQuorum快速解答。',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
