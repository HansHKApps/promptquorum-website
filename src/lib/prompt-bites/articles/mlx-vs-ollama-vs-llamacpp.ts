...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    heroImage: '/images/mlx-vs-ollama-vs-llamacpp-overview-hero-en.webp',
  ...
  de: {
    theme: 'Tool Comparisons',
    heroImage: '/images/mlx-vs-ollama-vs-llamacpp-overview-hero-de.webp',
  ...
  fr: {
    theme: 'Tool Comparisons',
    heroImage: '/images/mlx-vs-ollama-vs-llamacpp-overview-hero-fr.webp',
  ...
  ja: {
    theme: 'Tool Comparisons',
    heroImage: '/images/mlx-vs-ollama-vs-llamacpp-overview-hero-ja.webp',
    ...
    sections: {
      ...
      body2: {
        ...
        content: [
          ...
          '<strong>NVIDIA GPUまたはその他のハードウェアをお持ちの場合：<a href="[ollama.com](https://ollama.com)" rel="nofollow noopener noreferrer" target="_blank" onclick="try{window.umami&&window.umami.track(\'outbound_click\',{product_name:\'Ollama\',source_page:window.location.pathname,language:\'ja\'})}catch(e){}" class="text-primary hover:underline">Ollama</a>を使用してください。</strong> ワンコマンドでインストールでき、モデルが自動的にダウンロードされ、ポート11434でOpenAI互換のAPIを公開します。Ollamaのオーバーヘッドなしで高度な制御が必要な場合は、<a href="[github.com/ggerganov/llama.cpp](https://github.com/ggerganov/llama.cpp)" rel="nofollow noopener noreferrer" target="_blank" onclick="try{window.umami&&window.umami.track(\'outbound_click\',{product_name:\'llama.cpp\',source_page:window.location.pathname,language:\'ja\'})}catch(e){}" class="text-primary hover:underline">llaMa.cppを直接コンパイル</a>して、内蔵のサーバーモードを使用してください。',
        ],
      },
      faq: {
        id: 'faq',
  ...
  pt: {
    theme: 'Tool Comparisons',
    heroImage: '/images/mlx-vs-ollama-vs-llamacpp-overview-hero-pt.webp',
  ...
  es: {
    theme: 'Tool Comparisons',
    heroImage: '/images/mlx-vs-ollama-vs-llamacpp-overview-hero-es.webp',
  ...
  zh: {
    theme: 'Tool Comparisons',
    heroImage: '/images/mlx-vs-ollama-vs-llamacpp-overview-hero-zh.webp',
  ...
  ar: {
    theme: 'Tool Comparisons',
    heroImage: '/images/mlx-vs-ollama-vs-llamacpp-overview-hero-ar.webp',
  ...
  ko: {
    theme: 'Tool Comparisons',
    heroImage: '/images/mlx-vs-ollama-vs-llamacpp-overview-hero-ko.webp',
    ...
    sections: {
      ...
      body2: {
        ...
        content: [
          ...
          '<strong>NVIDIA GPU 또는 다른 하드웨어가 있다면 <a href="[ollama.com](https://ollama.com)" rel="nofollow noopener noreferrer" target="_blank" class="text-primary hover:underline">Ollama</a>를 사용하십시오.</strong> 한 명령으로 설치되고 모델이 자동으로 다운로드되며 11434 포트에서 OpenAI 호환 API를 제공합니다. Ollama 오버헤드 없이 고급 제어가 필요하다면 <a href="[github.com/ggerganov/llama.cpp](https://github.com/ggerganov/llama.cpp)" rel="nofollow noopener noreferrer" target="_blank" class="text-primary hover:underline">llama.cpp를 직접 컴파일</a>하여 내장 서버 모드를 사용하십시오.',
        ],
      },
      faq: {
        id: 'faq',
