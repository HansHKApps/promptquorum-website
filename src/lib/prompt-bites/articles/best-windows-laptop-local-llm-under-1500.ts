...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  es: {
    ...
    metaDescription: 'Mejor portátil Windows por menos de $1,500 para LLMs locales: GPU móvil RTX 4070 8GB + 32GB de RAM. Ejecuta modelos de 8B rápido y 14B en Q4 con VRAM ajustada.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  ko: {
    ...
    metaDescription: '1,500달러 이하 로컬 LLM용 최적의 Windows 노트북: RTX 4070 8GB 모바일 GPU + 32GB RAM. 8B 모델을 빠르게 구동하고 14B는 Q4에서 타이트한 VRAM 여유로 처리합니다.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  pt: {
    ...
    metaDescription: 'Melhor notebook Windows abaixo de US$ 1.500 para LLMs locais: GPU móvel RTX 4070 8GB + 32GB de RAM. Roda modelos de 8B rápido e 14B em Q4 com espaço apertado de VRAM.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
