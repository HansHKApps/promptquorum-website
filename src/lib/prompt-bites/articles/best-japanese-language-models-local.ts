...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: 'Rinna 3.6B, ELYZA-7B, Qwen3 8B (best for JA/EN/ZH translation), and Phi-4: 4 local LLMs for Japanese chat, writing, and translation via Ollama.',
    heroImage: '/images/best-japanese-language-models-local-model-comparison-hero-en.webp',
    publishDate: '2026-05-27',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-27',
    current_models_mentioned: ['Rinna 3.6B', 'ELYZA-7B', 'CyberAgent CALM3-22B', 'Qwen3 8B', 'Phi-4'],
    ...
    quickAnswerTop: {
      en: {
        ...
        bullets: [
          ...
          'Qwen3 8B — multilingual JA/ZH/EN and coding, 6 GB RAM',
        ],
        updatedDate: '2026-05',
      },
      de: {
        ...
        bullets: [
          ...
          'Qwen3 8B — mehrsprachig JA/ZH/EN und Coding, 6 GB RAM',
        ],
        updatedDate: '2026-05',
      },
      fr: {
        ...
        bullets: [
          ...
          'Qwen3 8B — multilingue JA/ZH/EN et codage, 6 Go de RAM',
        ],
        updatedDate: '2026-05',
      },
      ja: {
        ...
        bullets: [
          ...
          'Qwen3 8B — 多言語JA/ZH/EN対応・コーディング、6 GB RAM',
        ],
        updatedDate: '2026-05',
      },
      zh: {
        ...
        bullets: [
          ...
          'Qwen3 8B — 多语言JA/ZH/EN和编码，6 GB内存',
        ],
        updatedDate: '2026-05',
      },
    },
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Qwen3 8B is the best multilingual choice: strong Japanese alongside Chinese and English, plus coding support',
      ...
      body1: {
        ...
        content: [
          '<strong>Five local LLMs stand out for Japanese-language tasks: Rinna 3.6B, ELYZA-7B, CyberAgent CALM3-22B, Qwen3 8B, and Phi-4.</strong> Each fills a different hardware and use-case niche. The table below gives you the decision anchor points.',
          'Decision shortcut: Use Rinna 3.6B if you have only 4 GB RAM and need Japanese-native conversation. Use ELYZA-7B for structured instruction following on 6 GB hardware. Use Qwen3 8B when you need multilingual output across Japanese, Chinese, and English in a single model.',
        ],
        ...
        rows: [
          ...
          { 'Model': 'Qwen3 8B', 'Size / Min RAM': '7B / 6 GB RAM', 'Best for': 'Multilingual JA/ZH/EN, coding' },
          { 'Model': 'Phi-4', 'Size / Min RAM': '14B / 10–12 GB RAM', 'Best for': 'Reasoning + Japanese (via fine-tune)' },
        ],
        image: '/images/best-japanese-language-models-local-model-comparison-hero-en.webp',
        imageCaption: 'Best Local LLMs for Japanese -- Model size vs minimum RAM',
      },
      body2: {
        ...
        image: '/images/best-japanese-language-models-local-task-mapping-hero-en.webp',
        imageCaption: 'Which Japanese Model for Which Task -- Task-to-model mapping',
      },
      faq: {
        id: 'faq',
  ...
  de: {
    ...
    metaDescription: 'Rinna 3.6B (4 GB), ELYZA-7B (6 GB), Qwen3 8B (JA/ZH/EN), Phi-4 (10–12 GB): vier lokale LLMs für japanische Texte — alle über Ollama ausführbar.',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Qwen3 8B ist die beste mehrsprachige Wahl: starkes Japanisch neben Chinesisch und Englisch, plus Coding-Unterstützung',
      ...
      body1: {
        ...
        content: [
          '<strong>Stand Mai 2026 stechen fünf lokale LLMs für japanischsprachige Aufgaben hervor: Rinna 3.6B, ELYZA-7B, CyberAgent CALM3-22B, Qwen3 8B und Phi-4.</strong> Jedes füllt eine andere Hardware- und Anwendungsnische. Die Tabelle unten liefert die entscheidenden Vergleichspunkte.',
          'Entscheidungshilfe: Rinna 3.6B bei nur 4 GB RAM für japanische Konversation. ELYZA-7B für strukturierte Instruktionsbefolgung auf 6-GB-Hardware. Qwen3 8B wenn mehrsprachige Ausgabe über Japanisch, Chinesisch und Englisch in einem Modell benötigt wird.',
        ],
        ...
        rows: [
          ...
          { 'Modell': 'Qwen3 8B', 'Größe / Min RAM': '7B / 6 GB RAM', 'Geeignet für': 'Mehrsprachig JA/ZH/EN, Coding' },
          { 'Modell': 'Phi-4', 'Größe / Min RAM': '14B / 10–12 GB RAM', 'Geeignet für': 'Reasoning + Japanisch (via Fine-Tune)' },
        ],
        image: '/images/best-japanese-language-models-local-model-comparison-hero-de.webp',
        imageCaption: 'Beste lokale LLMs für Japanisch -- Modellgröße vs. Mindest-RAM',
      },
      body2: {
        ...
        image: '/images/best-japanese-language-models-local-task-mapping-hero-de.webp',
        imageCaption: 'Welches Japanisch-Modell für Welche Aufgabe -- Aufgabe-zu-Modell-Zuordnung',
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          {
            ...
            a: 'Qwen3 8B — es beherrscht Japanisch, Englisch und Chinesisch in einem einzigen Modell, sodass Sie für JA-EN-, EN-JA- oder JA-ZH-Übersetzungen nicht das Modell wechseln müssen. ELYZA-7B und Rinna 3.6B sind Japanisch-nativ, wurden aber primär für Generierung und Chat trainiert, nicht speziell für Übersetzung. Qwen3 8Bs explizites mehrsprachiges Training macht es zur stärkeren Wahl, wenn Übersetzung die Hauptaufgabe ist.',
          },
          {
  ...
  fr: {
    ...
    metaDescription: 'Rinna 3.6B (4 Go), ELYZA-7B (6 Go), Qwen3 8B (JA/ZH/EN), Phi-4 (10–12 Go) : quatre LLM locaux pour le japonais, tous compatibles Ollama en 2026.',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Qwen3 8B est le meilleur choix multilingue : japonais robuste aux côtés du chinois et de l\'anglais, plus le codage',
      ...
      body1: {
        ...
        content: [
          '<strong>En mai 2026, cinq LLM locaux se distinguent pour les tâches en japonais : Rinna 3.6B, ELYZA-7B, CyberAgent CALM3-22B, Qwen3 8B et Phi-4.</strong> Chacun répond à un profil matériel et un cas d\'usage différent. Le tableau ci-dessous donne les points de décision essentiels.',
          'Raccourci décisionnel : Rinna 3.6B si vous disposez seulement de 4 Go de RAM et avez besoin de conversation native en japonais. ELYZA-7B pour le suivi d\'instructions structuré sur hardware 6 Go. Qwen3 8B quand vous avez besoin d\'une sortie multilingue japonais, chinois et anglais dans un seul modèle.',
        ],
        ...
        rows: [
          ...
          { 'Modèle': 'Qwen3 8B', 'Taille / RAM min.': '7B / 6 Go de RAM', 'Idéal pour': 'Multilingue JA/ZH/EN, codage' },
          { 'Modèle': 'Phi-4', 'Taille / RAM min.': '14B / 10–12 Go de RAM', 'Idéal pour': 'Raisonnement + japonais (via fine-tune)' },
        ],
        image: '/images/best-japanese-language-models-local-model-comparison-hero-fr.webp',
        imageCaption: 'Meilleurs LLM Locaux pour le Japonais -- Taille du modèle vs RAM minimale',
      },
      body2: {
        ...
        image: '/images/best-japanese-language-models-local-task-mapping-hero-fr.webp',
        imageCaption: 'Quel Modèle Japonais pour Quelle Tâche -- Correspondance tâche-modèle',
      },
      faq: {
        id: 'faq',
  ...
  ja: {
    ...
    metaDescription: 'Rinna 3.6Bは4 GB RAMで動作する最軽量の日本語ネイティブモデル。ELYZA-7Bは指示追従に最適。Qwen3 8BはJA/ZH/ENの多言語とコーディングをカバー。すべてOllama経由。',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Qwen3 8Bが最良の多言語モデル：日本語・中国語・英語を一つのモデルで処理、コーディングにも対応',
      ...
      body1: {
        title: '日本語モデル比較表',
        content: [
          '<strong>2026年5月時点で、日本語タスクに優れた5つのローカルLLMがあります：Rinna 3.6B、ELYZA-7B、CyberAgent CALM3-22B、Qwen3 8B、Phi-4。</strong>それぞれ異なるハードウェア環境と用途に対応しています。日本国内では特に、Rinna株式会社とELYZA株式会社のモデルがオープンソースコミュニティで広く使われています。',
          '決断のショートカット：RAMが4 GBしかない場合はRinna 3.6Bを選択。6 GBハードウェアで構造的な指示追従が必要な場合はELYZA-7Bを選択。日本語・中国語・英語の多言語出力が一つのモデルで必要な場合はQwen3 8Bを選択。',
        ],
        ...
        rows: [
          ...
          { 'モデル': 'Qwen3 8B', 'サイズ / 最低RAM': '7B / 6 GB RAM', '用途': '多言語JA/ZH/EN・コーディング' },
          { 'モデル': 'Phi-4', 'サイズ / 最低RAM': '14B / 10–12 GB RAM', '用途': '推論+日本語（ファインチューン経由）' },
        ],
        image: '/images/best-japanese-language-models-local-model-comparison-hero-ja.webp',
        imageCaption: '日本語対応ローカルLLMベスト -- モデルサイズ対最小RAM',
      },
      body2: {
        title: 'タスク別推奨モデル',
        content: [
          ...
          '<strong>日常チャット</strong> → Rinna 3.6B（最軽量、日本語ネイティブ、ファインチューン不要）。<strong>ビジネス文書・フォーマル文章</strong> → ELYZA-7BまたはCyberAgent CALM3-22B（16 GB RAMが使えるならCALM3がより高品質）。<strong>日本語でのコーディング支援</strong> → Qwen3-Coder（日本語コメント・ドキュメントに強い多言語コードモデル）。<strong>日英中の翻訳</strong> → Qwen3 8B（モデル切り替えなしで3言語対応）。',
        ...
        image: '/images/best-japanese-language-models-local-task-mapping-hero-ja.webp',
        imageCaption: 'タスク別おすすめ日本語モデル -- タスクとモデルの対応表',
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          {
            ...
            a: 'Qwen3 8Bです。日本語・英語・中国語を単一モデルで扱えるため、JA→EN、EN→JA、JA→ZHの翻訳でモデルを切り替える必要がありません。ELYZA-7BとRinna 3.6Bは日本語ネイティブですが、主に生成やチャット用に訓練されており、翻訳に特化しているわけではありません。Qwen3 8Bは明示的な多言語訓練を受けているため、翻訳が主なタスクの場合はより強い選択肢です。',
          },
          {
  ...
  zh: {
    ...
    metaDescription: 'Rinna 3.6B最低4 GB内存即可运行，是最轻量的日语原生本地LLM。ELYZA-7B在指令跟随方面领先。Qwen3 8B覆盖JA/ZH/EN多语言和编码。均可通过Ollama运行。',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Qwen3 8B是最佳多语言选择：日语能力强，同时支持中文和英文，以及代码生成',
      ...
      body1: {
        title: '日语模型对比表',
        content: [
          '<strong>截至2026年5月，五款本地LLM在日语任务中表现突出：Rinna 3.6B、ELYZA-7B、CyberAgent CALM3-22B、Qwen3 8B和Phi-4。</strong>每款模型填补不同的硬件和使用场景需求。下表提供关键决策参考点。',
          '决策捷径：如果只有4 GB内存且需要日语原生对话，选Rinna 3.6B。在6 GB硬件上需要结构化指令跟随，选ELYZA-7B。需要在单一模型中实现日语、中文、英文多语言输出，选Qwen3 8B。',
        ],
        ...
        rows: [
          ...
          { '模型': 'Qwen3 8B', '规模 / 最低内存': '7B / 6 GB内存', '最适合场景': '多语言JA/ZH/EN、代码生成' },
          { '模型': 'Phi-4', '规模 / 最低内存': '14B / 10–12 GB内存', '最适合场景': '推理+日语（通过微调）' },
        ],
        image: '/images/best-japanese-language-models-local-model-comparison-hero-zh.webp',
        imageCaption: '日语支持最佳本地LLM -- 模型规模对比最低内存',
      },
      body2: {
        title: '按任务类型的模型推荐',
        content: [
          ...
          '<strong>日常对话</strong> → Rinna 3.6B（最轻量、日语原生、无需微调）。<strong>商业文档和正式写作</strong> → ELYZA-7B或CyberAgent CALM3-22B（如有16 GB内存，CALM3效果更好）。<strong>日语编程辅助</strong> → Qwen3-Coder（支持日语注释和文档的多语言代码模型）。<strong>日英中翻译</strong> → Qwen3 8B（单一模型处理三种语言，无需切换）。',
        ...
        image: '/images/best-japanese-language-models-local-task-mapping-hero-zh.webp',
        imageCaption: '不同任务适用的日语模型 -- 任务与模型对照表',
      },
      faq: {
        id: 'faq',
        title: '日语本地LLM常见问题',
        faqs: [
          {
            q: '日语翻译最好的本地LLM是什么？',
            a: 'Qwen3 8B——它在单一模型中同时处理日语、英语和中文，因此无需为JA→EN、EN→JA或JA→ZH翻译切换模型。ELYZA-7B和Rinna 3.6B是日语原生模型，但主要针对生成和对话训练，而非专门针对翻译。Qwen3 8B明确的多语言训练使其在以翻译为主要任务时是更强的选择。',
          },
          {
  ...
  es: {
    ...
    metaDescription: 'Rinna 3.6B (4 GB), ELYZA-7B (6 GB), Qwen3 8B (multilingüe JA/ZH/EN), Phi-4 (10–12 GB): cuatro LLMs locales para tareas en japonés, todos vía Ollama en 2026.',
    ...
    is_living_page: false,
    quickAnswerTop: {
      en: { question: 'Which local LLM models support Japanese best?', answer: 'Depends on task: Rinna 3.6B for conversation, ELYZA-7B for instruction following, Qwen3-Coder for coding.', bullets: ['Rinna 3.6B: 4 GB RAM', 'ELYZA-7B: 6 GB RAM', 'Qwen3 8B: multilingual'], updatedDate: '2026-05' },
      ...
      es: {
        ...
        bullets: [
          ...
          'Qwen3 8B — multilingüe JA/ZH/EN y programación, 6 GB RAM',
        ],
        updatedDate: '2026-05',
      },
    },
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Qwen3 8B es la mejor opción multilingüe: japonés robusto junto con chino e inglés, más soporte de programación',
      ...
      body1: {
        ...
        content: [
          '<strong>A mayo de 2026, cinco LLMs locales destacan para tareas en japonés: Rinna 3.6B, ELYZA-7B, CyberAgent CALM3-22B, Qwen3 8B y Phi-4.</strong> Cada uno cubre un nicho de hardware y caso de uso diferente. La tabla ofrece los puntos de decisión clave.',
          'Atajo de decisión: usa Rinna 3.6B si solo tienes 4 GB RAM y necesitas conversación nativa en japonés. Usa ELYZA-7B para seguimiento estructurado de instrucciones en hardware de 6 GB. Usa Qwen3 8B cuando necesites salida multilingüe en japonés, chino e inglés en un solo modelo.',
        ],
        ...
        rows: [
          ...
          { 'Modelo': 'Qwen3 8B', 'Tamaño / RAM mínima': '7B / 6 GB RAM', 'Mejor para': 'Multilingüe JA/ZH/EN, programación' },
          { 'Modelo': 'Phi-4', 'Tamaño / RAM mínima': '14B / 10–12 GB RAM', 'Mejor para': 'Razonamiento + japonés (vía fine-tune)' },
        ],
        image: '/images/best-japanese-language-models-local-model-comparison-hero-es.webp',
        imageCaption: 'Mejores LLM Locales para Japonés -- Tamaño del modelo vs RAM mínima',
      },
      body2: {
        ...
        image: '/images/best-japanese-language-models-local-task-mapping-hero-es.webp',
        imageCaption: 'Qué Modelo Japonés para Qué Tarea -- Mapa de tarea a modelo',
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          {
            ...
            a: 'Qwen3 8B: maneja japonés, inglés y chino en un solo modelo, así que no necesitas cambiar de modelo para traducción JA-EN, EN-JA o JA-ZH. ELYZA-7B y Rinna 3.6B son nativos de japonés, pero se entrenaron principalmente para generación y chat, no específicamente para traducción. El entrenamiento multilingüe explícito de Qwen3 8B lo convierte en la opción más sólida cuando la traducción es la tarea principal.',
          },
          {
  ...
  ar: {
    ...
    metaDescription: '⁨Rinna 3.6B⁩ يعمل بـ⁨4 GB RAM⁩، و⁨ELYZA-7B⁩ بـ⁨6 GB⁩ للتعليمات، و⁨Qwen3 8B⁩ يغطي ⁨JA/ZH/EN⁩ — جميعها تعمل محلياً عبر ⁨Ollama⁩ بتكميم ⁨Q4⁩_⁨K⁩_⁨M⁩.',
    ...
    quickAnswerTop: {
      ar: {
        ...
        bullets: [
          ...
          'Qwen3 8B — متعدد اللغات JA/ZH/EN والبرمجة، 6 جيجابايت RAM',
        ],
        updatedDate: '2026-05',
      },
    },
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Qwen3 8B هو أفضل خيار متعدد اللغات: يابانية قوية إلى جانب الصينية والإنجليزية، مع دعم للبرمجة',
      ...
      body1: {
        ...
        content: [
          '<strong>اعتباراً من مايو 2026، تبرز خمسة نماذج لغوية كبيرة محلية للمهام اليابانية: Rinna 3.6B وELYZA-7B وCyberAgent CALM3-22B وQwen3 8B وPhi-4.</strong> كل منها يغطي نيشاً مختلفاً من الأجهزة وحالات الاستخدام. يوفر الجدول نقاط القرار الرئيسية.',
          'اختصار القرار: استخدم Rinna 3.6B إذا كان لديك 4 جيجابايت RAM فقط وتحتاج محادثة يابانية أصيلة. استخدم ELYZA-7B لاتباع التعليمات المنظّم في أجهزة بـ6 جيجابايت. استخدم Qwen3 8B عندما تحتاج إخراجاً متعدد اللغات باليابانية والصينية والإنجليزية في نموذج واحد.',
        ],
        ...
        rows: [
          ...
          { 'النموذج': 'Qwen3 8B', 'الحجم / الحد الأدنى من RAM': '7B / 6 جيجابايت RAM', 'الأفضل لـ': 'متعدد اللغات JA/ZH/EN، البرمجة' },
          { 'النموذج': 'Phi-4', 'الحجم / الحد الأدنى من RAM': '14B / 10–12 جيجابايت RAM', 'الأفضل لـ': 'الاستدلال + اليابانية (عبر الضبط الدقيق)' },
        ],
        image: '/images/best-japanese-language-models-local-model-comparison-hero-ar.webp',
        imageCaption: 'أفضل نماذج LLM محلية لليابانية -- حجم النموذج مقابل الحد الأدنى من الذاكرة',
      },
      body2: {
        ...
        content: [
          ...
          'خريطة المهام والنماذج: <strong>محادثة يومية</strong> → Rinna 3.6B (الأخف، أصيل في اليابانية، لا يتطلب ضبطاً دقيقاً). <strong>وثائق أعمال والكتابة الرسمية</strong> → ELYZA-7B أو CyberAgent CALM3-22B (CALM3 هو الأقوى عند توفر 16 جيجابايت RAM). <strong>مساعدة البرمجة باليابانية</strong> → Qwen3-Coder (نموذج برمجة متعدد اللغات مع دعم جيد للتعليقات والوثائق اليابانية). <strong>الترجمة بين اليابانية والإنجليزية والصينية</strong> → Qwen3 8B (نموذج واحد للغات الثلاث بدون تبديل النموذج).',
        ...
        image: '/images/best-japanese-language-models-local-task-mapping-hero-ar.webp',
        imageCaption: 'أي نموذج ياباني لأي مهمة -- ربط المهمة بالنموذج',
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          {
            ...
            a: 'Qwen3 8B — يتعامل مع اليابانية والإنجليزية والصينية في نموذج واحد، لذا لا تحتاج إلى تبديل النماذج لترجمة JA-EN أو EN-JA أو JA-ZH. نموذجا ELYZA-7B وRinna 3.6B يابانيان أصليان، لكنهما دُرِّبا بشكل أساسي للتوليد والدردشة، وليس للترجمة تحديدًا. تدريب Qwen3 8B متعدد اللغات الصريح يجعله الخيار الأقوى عندما تكون الترجمة هي المهمة الرئيسية.',
          },
          {
  ...
  pt: {
    ...
    metaDescription: 'Rinna 3.6B (4 GB), ELYZA-7B (6 GB), Qwen3 8B (multilíngue JA/ZH/EN), Phi-4 (10–12 GB): quatro LLMs locais para tarefas em japonês, todos via Ollama em 2026.',
    ...
    quickAnswerTop: {
      ...
      pt: {
        ...
        bullets: [
          ...
          'Qwen3 8B — multilíngue JA/ZH/EN e programação, 6 GB RAM',
        ],
        updatedDate: '2026-05',
      },
    },
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Qwen3 8B é a melhor opção multilíngue: japonês robusto junto com chinês e inglês, mais suporte a programação',
      ...
      body1: {
        ...
        content: [
          '<strong>Em maio de 2026, cinco LLMs locais se destacam para tarefas em japonês: Rinna 3.6B, ELYZA-7B, CyberAgent CALM3-22B, Qwen3 8B e Phi-4.</strong> Cada um cobre um nicho de hardware e caso de uso diferente. A tabela oferece os pontos de decisão principais.',
          'Atalho de decisão: use Rinna 3.6B se tiver apenas 4 GB de RAM e precisar de conversação nativa em japonês. Use ELYZA-7B para seguimento estruturado de instruções em hardware de 6 GB. Use Qwen3 8B quando precisar de saída multilíngue em japonês, chinês e inglês em um único modelo.',
        ],
        ...
        rows: [
          ...
          { 'Modelo': 'Qwen3 8B', 'Tamanho / RAM mínima': '7B / 6 GB RAM', 'Melhor para': 'Multilíngue JA/ZH/EN, programação' },
          { 'Modelo': 'Phi-4', 'Tamanho / RAM mínima': '14B / 10–12 GB RAM', 'Melhor para': 'Raciocínio + japonês (via fine-tune)' },
        ],
        image: '/images/best-japanese-language-models-local-model-comparison-hero-pt.webp',
        imageCaption: 'Melhores LLMs Locais para Japonês -- Tamanho do modelo vs RAM mínima',
      },
      body2: {
        ...
        image: '/images/best-japanese-language-models-local-task-mapping-hero-pt.webp',
        imageCaption: 'Qual Modelo Japonês para Qual Tarefa -- Mapeamento de tarefa para modelo',
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          {
            ...
            a: 'Qwen3 8B — ele lida com japonês, inglês e chinês em um único modelo, então você não precisa trocar de modelo para tradução JA-EN, EN-JA ou JA-ZH. ELYZA-7B e Rinna 3.6B são nativos em japonês, mas foram treinados principalmente para geração e chat, não especificamente para tradução. O treinamento multilíngue explícito do Qwen3 8B o torna a escolha mais forte quando a tradução é a tarefa principal.',
          },
          {
  ...
  ko: {
    ...
    metaDescription: 'Rinna 3.6B (4 GB), ELYZA-7B (6 GB), Qwen3 8B (다국어 JA/ZH/EN), Phi-4 (10–12 GB): 2026년 Ollama를 통해 실행하는 일본어 작업용 로컬 LLM 4종 비교.',
    ...
    quickAnswerTop: {
      ko: {
        ...
        bullets: [
          ...
          'Qwen3 8B — JA/ZH/EN 다국어 지원 및 코딩, 6 GB RAM',
        ],
        updatedDate: '2026-05',
      },
    },
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Qwen3 8B는 최고의 다국어 선택입니다: 일본어와 함께 중국어, 영어를 지원하며 코딩 기능도 포함합니다',
      ...
      body1: {
        title: '일본어 모델 비교표',
        content: [
          '<strong>2026년 5월 기준, 일본어 작업에 특화된 로컬 LLM 5종이 주목받고 있습니다: Rinna 3.6B, ELYZA-7B, CyberAgent CALM3-22B, Qwen3 8B, Phi-4입니다.</strong> 각 모델은 하드웨어 요구사항과 사용 사례가 다릅니다. 아래 표에서 핵심 결정 기준을 확인하십시오.',
          '선택 기준 요약: RAM이 4 GB뿐이고 일본어 네이티브 대화가 필요하다면 Rinna 3.6B를 사용하십시오. 6 GB 하드웨어에서 구조화된 명령어 수행이 필요하다면 ELYZA-7B를 선택하십시오. 단일 모델로 일본어, 중국어, 영어 다국어 출력이 필요하다면 Qwen3 8B를 사용하십시오.',
        ],
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: '2026년 일본어 로컬 LLM 최적 선택은 대화에 Rinna 3.6B, 명령어 수행에 ELYZA-7B, 다국어 작업에 Qwen3 8B입니다.',
          },
          {
            type: 'plain-terms',
        ...
        rows: [
          ...
          { '모델': 'Qwen3 8B', '크기 / 최소 RAM': '7B / 6 GB RAM', '최적 용도': '다국어 JA/ZH/EN, 코딩' },
          { '모델': 'Phi-4', '크기 / 최소 RAM': '14B / 10–12 GB RAM', '최적 용도': '추론 + 일본어 (파인튜닝 활용)' },
        ],
        image: '/images/best-japanese-language-models-local-model-comparison-hero-ko.webp',
        imageCaption: '일본어 지원 최고의 로컬 LLM -- 모델 크기 대 최소 RAM',
      },
      body2: {
        title: '작업별 모델 추천',
        content: [
          ...
          '작업-모델 매핑: <strong>일상 대화</strong> → Rinna 3.6B(가장 가볍고 일본어 네이티브, 파인튜닝 불필요). <strong>비즈니스 문서 및 공식 작성</strong> → ELYZA-7B 또는 CyberAgent CALM3-22B(16 GB RAM이 있을 경우 CALM3이 가장 강력한 선택). <strong>일본어 코딩 지원</strong> → Qwen3-Coder(일본어 주석과 문서를 잘 지원하는 다국어 코드 모델). <strong>일본어, 영어, 중국어 간 번역</strong> → Qwen3 8B(모델 전환 없이 세 언어를 단일 모델로 처리).',
        ...
        image: '/images/best-japanese-language-models-local-task-mapping-hero-ko.webp',
        imageCaption: '작업별 추천 일본어 모델 -- 작업-모델 매핑',
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          {
            ...
            a: 'Qwen3 8B입니다 — 일본어, 영어, 중국어를 하나의 모델로 처리하므로 JA-EN, EN-JA, JA-ZH 번역을 위해 모델을 바꿀 필요가 없습니다. ELYZA-7B와 Rinna 3.6B는 일본어 네이티브 모델이지만 주로 생성과 채팅용으로 학습되었으며 번역에 특화되지는 않았습니다. Qwen3 8B는 명시적인 다국어 학습을 거쳤기 때문에 번역이 주요 작업일 때 더 강력한 선택입니다.',
          },
          {
