...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: 'Nomic-embed-text is the best embedding model for local RAG via Ollama — 8,192-token context and strong open benchmark results. BGE-M3 is the best multilingual pick.',
  ...
  de: {
    ...
    metaDescription: 'Nomic-embed-text ist das beste Embedding-Modell für lokales RAG via Ollama — 8.192-Token-Kontext und starke Ergebnisse in offenen Benchmarks. BGE-M3 ist die beste mehrsprachige Wahl.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  es: {
    ...
    metaDescription: 'nomic-embed-text es el mejor modelo de embedding para RAG local vía Ollama — contexto de 8,192 tokens y fuertes resultados en benchmarks abiertos. BGE-M3 es la mejor opción multilingüe.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  fr: {
    ...
    metaDescription: 'nomic-embed-text est le meilleur modèle d\'embedding pour un RAG local via Ollama — contexte de 8,192 tokens et bons résultats aux benchmarks ouverts. BGE-M3 est le meilleur choix multilingue.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  ko: {
    ...
    metaDescription: 'nomic-embed-text는 Ollama를 통한 로컬 RAG를 위한 최적의 임베딩 모델입니다 — 8,192토큰 컨텍스트와 강력한 오픈 벤치마크 결과를 갖추고 있습니다. BGE-M3는 최고의 다국어 선택입니다.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  pt: {
    ...
    metaDescription: 'O nomic-embed-text é o melhor modelo de embedding para RAG local via Ollama — contexto de 8.192 tokens e fortes resultados em benchmarks abertos. O BGE-M3 é a melhor escolha multilíngue.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
