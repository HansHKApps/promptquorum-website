...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    sections: {
      ...
      body1: {
        ...
        content: [
          '<strong>Ollama supports four production-ready vision models: LLaVA, Llama 3.2 Vision, Qwen-VL, and Gemma 3.</strong> Each has a distinct strength and VRAM profile.',
  ...
  de: {
    ...
    metaDescription: 'LLaVA, Gemma 3 multimodal und Qwen-VL unterstützen Vision in Ollama. Start: ollama run llava. Alle akzeptieren Bilder via Ollama API.',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
  ...
  fr: {
    ...
    metaDescription: 'LLaVA, Gemma 3 multimodal et Qwen-VL supportent la vision sur Ollama. Démarrez : ollama run llava. Images acceptées via l\'API Ollama.',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
  ...
  zh: {
    ...
    metaDescription: 'LLaVA、Gemma 3多模态和Qwen-VL支持Ollama上的视觉功能。使用 ollama run llava 快速开始。所有模型均通过Ollama API接受图片。',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
