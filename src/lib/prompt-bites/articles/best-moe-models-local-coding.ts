...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    heroImage: '/images/best-moe-models-local-coding-moe-comparison-hero-en.webp',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'For VRAM below 16 GB, dense 13B–14B coding models like DeepSeek-Coder-V2-Lite are more practical than MoE options',
        ],
      },
      body1: {
        ...
        image: '/images/best-moe-models-local-coding-moe-comparison-hero-en.webp',
      ...
      body2: {
        ...
        image: '/images/best-moe-models-local-coding-ollama-setup-hero-en.webp',
  ...
  de: {
    ...
    heroImage: '/images/best-moe-models-local-coding-moe-comparison-hero-de.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Unter 16 GB VRAM sind Dense-Coding-Modelle wie DeepSeek-Coder-V2-Lite praktischer als MoE-Optionen',
        ],
      },
      body1: {
        ...
        image: '/images/best-moe-models-local-coding-moe-comparison-hero-de.webp',
      ...
      body2: {
        ...
        image: '/images/best-moe-models-local-coding-ollama-setup-hero-de.webp',
  ...
  fr: {
    ...
    heroImage: '/images/best-moe-models-local-coding-moe-comparison-hero-fr.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Sous 16 Go de VRAM, les modèles denses de codage comme DeepSeek-Coder-V2-Lite sont plus pratiques que les options MoE',
        ],
      },
      body1: {
        ...
        image: '/images/best-moe-models-local-coding-moe-comparison-hero-fr.webp',
      ...
      body2: {
        ...
        content: [
          ...
          'Une idée fausse courante : les modèles MoE doivent charger TOUS les poids des experts en VRAM au démarrage, pas seulement le sous-ensemble actif. Le coût VRAM reflète les paramètres totaux, pas les paramètres actifs. Pour les tâches single-langue (par exemple, travail Python uniquement), un modèle dense comme Qwen2.5-Coder 14B surpasse souvent Mixtral 8x22B car ses poids sont entièrement spécialisés dans le code plutôt que répartis entre des experts génériques.',
        ...
        image: '/images/best-moe-models-local-coding-ollama-setup-hero-fr.webp',
  ...
  ja: {
    ...
    heroImage: '/images/best-moe-models-local-coding-moe-comparison-hero-ja.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '16 GB VRAM 未満では、MoE より DeepSeek-Coder-V2-Lite などの Dense コーディングモデルの方が実用的',
        ],
      },
      body1: {
        ...
        image: '/images/best-moe-models-local-coding-moe-comparison-hero-ja.webp',
      ...
      body2: {
        ...
        content: [
          ...
          'よくある誤解：MoE モデルはスタートアップ時にアクティブなサブセットではなく、全エキスパート重みを VRAM に読み込む必要があります。VRAM コストはアクティブパラメータではなく総パラメータを反映します。単一言語コーディングタスク（例：Python のみ）の場合、Qwen2.5-Coder 14B のような Dense モデルは、重みが汎用エキスパート全体に分散されているのではなく完全にコードに特化しているため、Mixtral 8x22B を上回ることが多いです。',
        ...
        image: '/images/best-moe-models-local-coding-ollama-setup-hero-ja.webp',
  ...
  zh: {
    ...
    heroImage: '/images/best-moe-models-local-coding-moe-comparison-hero-zh.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '低于 16 GB VRAM 时，DeepSeek-Coder-V2-Lite 等稠密编程模型比 MoE 更实用',
        ],
      },
      body1: {
        ...
        image: '/images/best-moe-models-local-coding-moe-comparison-hero-zh.webp',
      ...
      body2: {
        ...
        content: [
          ...
          '常见误解：MoE 模型必须在启动时将全部专家权重加载到 VRAM 中，而不仅仅是活跃子集。VRAM 成本反映的是总参数，而非活跃参数。对于单一语言编程任务（如纯 Python 工作），Qwen2.5-Coder 14B 等稠密模型通常优于 Mixtral 8x22B，因为其权重完全专门化于代码，而不是分散在多个通用专家中。',
        ...
        image: '/images/best-moe-models-local-coding-ollama-setup-hero-zh.webp',
  ...
  es: {
    ...
    heroImage: '/images/best-moe-models-local-coding-moe-comparison-hero-es.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Para VRAM por debajo de 16 GB, los modelos densos de coding de 13B–14B como DeepSeek-Coder-V2-Lite son más prácticos que las opciones MoE',
        ],
      },
      body1: {
        ...
        image: '/images/best-moe-models-local-coding-moe-comparison-hero-es.webp',
      ...
      body2: {
        ...
        image: '/images/best-moe-models-local-coding-ollama-setup-hero-es.webp',
  ...
  pt: {
    ...
    heroImage: '/images/best-moe-models-local-coding-moe-comparison-hero-pt.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Para VRAM abaixo de 16 GB, modelos densos de programação 13B–14B como DeepSeek-Coder-V2-Lite são mais práticos do que opções MoE',
        ],
      },
      body1: {
        ...
        image: '/images/best-moe-models-local-coding-moe-comparison-hero-pt.webp',
      ...
      body2: {
        ...
        content: [
          ...
          'Um equívoco comum: os modelos MoE devem carregar TODOS os pesos dos especialistas na VRAM na inicialização, não apenas o subconjunto ativo. O custo de VRAM reflete os parâmetros totais, não os ativos. Para tarefas de programação em uma única linguagem (p.ex., trabalho somente em Python), um modelo denso como o Qwen2.5-Coder 14B frequentemente supera o Mixtral 8x22B porque seus pesos são totalmente especializados em código, em vez de distribuídos entre especialistas de propósito geral.',
        ...
        image: '/images/best-moe-models-local-coding-ollama-setup-hero-pt.webp',
  ...
  ar: {
    ...
    heroImage: '/images/best-moe-models-local-coding-moe-comparison-hero-ar.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'للـVRAM دون 16 GB، النماذج الكثيفة للبرمجة 13B–14B كـDeepSeek-Coder-V2-Lite أكثر عملية من خيارات MoE',
        ],
      },
      body1: {
        ...
        image: '/images/best-moe-models-local-coding-moe-comparison-hero-ar.webp',
      ...
      body2: {
        ...
        image: '/images/best-moe-models-local-coding-ollama-setup-hero-ar.webp',
  ...
  ko: {
    ...
    heroImage: '/images/best-moe-models-local-coding-moe-comparison-hero-ko.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'VRAM이 16 GB 미만인 경우, DeepSeek-Coder-V2-Lite와 같은 밀집 13B–14B 코딩 모델이 MoE 옵션보다 실용적입니다.',
        ],
      },
      body1: {
        ...
        image: '/images/best-moe-models-local-coding-moe-comparison-hero-ko.webp',
      ...
      body2: {
        ...
        content: [
          ...
          '흔한 오해 한 가지: MoE 모델은 시작 시 활성 서브셋만이 아닌 모든 전문가 가중치를 VRAM에 로드해야 합니다. VRAM 비용은 활성 파라미터가 아닌 전체 파라미터를 반영합니다. 단일 언어 코딩 작업(예: Python 전용 작업)에서는 Qwen2.5-Coder 14B 같은 밀집 모델이 Mixtral 8x22B를 능가하는 경우가 많습니다. 이는 가중치가 범용 전문가들에 분산되지 않고 코드에 완전히 특화되어 있기 때문입니다.',
        ...
        image: '/images/best-moe-models-local-coding-ollama-setup-hero-ko.webp',
