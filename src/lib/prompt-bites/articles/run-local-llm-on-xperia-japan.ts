...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: 'Yes — the Xperia 1 VI (12 GB RAM, Snapdragon 8 Gen 3) runs Phi-4 Q4 and Rinna 3.6B via MLC Chat. Xperia 5 V handles lightweight models. Xperia 10 VI is limited to TinyLlama and Gemma 2B.',
  ...
  de: {
    ...
    seoTitle: 'Lokales LLM auf Xperia Japan 2026 | Prompt Bites | PromptQuorum',
    metaDescription: 'Ja — das Xperia 1 VI (12 GB RAM, Snapdragon 8 Gen 3) führt Phi-4 Q4 und Rinna 3.6B über MLC Chat aus. Das Xperia 5 V unterstützt leichte Modelle. Das Xperia 10 VI ist auf TinyLlama und Gemma 2B beschränkt.',
    publishDate: '2026-05-27',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-27',
    quickAnswerTop: {
  ...
  fr: {
    ...
    seoTitle: 'LLM local sur Xperia Japon 2026 | Prompt Bites | PromptQuorum',
    metaDescription: 'Oui — le Xperia 1 VI (12 Go RAM, Snapdragon 8 Gen 3) exécute Phi-4 Q4 et Rinna 3.6B via MLC Chat. Le Xperia 5 V gère les modèles légers. Le Xperia 10 VI est limité à TinyLlama et Gemma 2B.',
    publishDate: '2026-05-27',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-27',
    quickAnswerTop: {
