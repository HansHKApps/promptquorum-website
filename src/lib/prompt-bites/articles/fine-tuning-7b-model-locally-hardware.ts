...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  de: {
    ...
    metaDescription: 'Fine-Tuning eines 7B-Modells lokal mit QLoRA auf einer RTX 4090 24GB (komfortabel) oder RTX 4060 Ti 16GB (machbar mit kleinerer Batch-Größe). Kein Multi-GPU nötig.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  es: {
    ...
    metaDescription: 'Haz fine-tuning de un modelo de 7B localmente con QLoRA en una RTX 4090 24GB (cómodo) o RTX 4060 Ti 16GB (viable con un batch más pequeño). No necesitas multi-GPU.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  pt: {
    ...
    metaDescription: 'Faça fine-tuning de um modelo de 7B localmente com QLoRA em uma RTX 4090 24GB (confortável) ou RTX 4060 Ti 16GB (viável com batch size menor). Sem necessidade de multi-GPU.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
