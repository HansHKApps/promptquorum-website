...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  de: {
    ...
    metaDescription: 'Ja — Radeon RX 6800M (12 GB VRAM) führt lokale LLMs via ROCm unter Linux oder llama.cpp aus. Llama 3 8B Q4 läuft bei ~12 tok/s. Windows ROCm ist eingeschränkt.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  fr: {
    ...
    metaDescription: 'Oui — Radeon RX 6800M (12 Go VRAM) fait tourner des LLMs via ROCm sur Linux ou llama.cpp. Llama 3 8B Q4 tourne à ~12 tok/s. ROCm Windows est limité.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
