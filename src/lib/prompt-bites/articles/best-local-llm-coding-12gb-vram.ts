...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: 'Qwen2.5-Coder 14B Q4_K_M: top coding model for 12 GB VRAM at ~10 GB, highest HumanEval. DeepSeek 14B Q4 alternative. Both fit RTX 3060/3080 Ti 12 GB.',
    heroImage: '/images/best-local-llm-coding-12gb-vram-model-vram-comparison-hero-en.webp',
    ...
    quickAnswerTop: {
      en: {
        ...
        answer: 'Qwen2.5-Coder 14B Q4_K_M is the best coding model for 12 GB VRAM GPUs, achieving the highest HumanEval scores among 14B models while using ~10 GB VRAM on RTX 3060 and RTX 3080 Ti. It uses ~10 GB VRAM and scores highest on HumanEval among models that fit this constraint. DeepSeek-Coder-V2-Lite is a strong alternative.',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M: ~10 GB VRAM, top coding benchmark for this size',
          'DeepSeek-Coder-V2-Lite Q4_K_M: similar VRAM, competitive on code completion',
      ...
      de: {
        ...
        answer: 'Qwen2.5-Coder 14B Q4_K_M ist das beste Coding-Modell für 12-GB-VRAM-GPUs, erreicht die höchsten HumanEval-Scores unter 14B-Modellen und benötigt ~10 GB VRAM auf RTX 3060 und RTX 3080 Ti. Es benötigt ~10 GB VRAM und erzielt den höchsten HumanEval-Score unter Modellen, die in dieses Limit passen. DeepSeek-Coder-V2-Lite ist eine starke Alternative.',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M: ~10 GB VRAM, bester Coding-Benchmark für diese Größe',
          'DeepSeek-Coder-V2-Lite Q4_K_M: ähnlicher VRAM, wettbewerbsfähig bei Code-Vervollständigung',
      ...
      fr: {
        ...
        answer: 'Qwen2.5-Coder 14B Q4_K_M est le meilleur modèle de coding pour les GPU 12 Go, obtient les meilleurs scores HumanEval parmi les modèles 14B tout en utilisant ~10 Go de VRAM sur RTX 3060 et RTX 3080 Ti. Il utilise ~10 Go de VRAM et obtient le meilleur score HumanEval parmi les modèles qui tiennent dans cette contrainte. DeepSeek-Coder-V2-Lite est une alternative solide.',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M : ~10 Go de VRAM, meilleur benchmark de coding pour cette taille',
          'DeepSeek-Coder-V2-Lite Q4_K_M : VRAM similaire, compétitif sur la complétion de code',
      ...
      ja: {
        ...
        answer: 'Qwen2.5-Coder 14B Q4_K_MはRTX 3060とRTX 3080 Ti上で12 GB VRAMの最良コーディングモデルで、14Bモデル中で最高のHumanEvalスコアを達成しながら~10 GB VRAMを使用します。~10 GB VRAMを使用し、この制約に収まるモデルの中でHumanEvalスコアが最高です。DeepSeek-Coder-V2-Liteは強力な代替です。',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M：~10 GB VRAM、このサイズでコーディングベンチマーク最高',
          'DeepSeek-Coder-V2-Lite Q4_K_M：同様のVRAM、コード補完で競争力あり',
      ...
      zh: {
        ...
        answer: 'Qwen2.5-Coder 14B Q4_K_M 是12 GB VRAM显卡的最佳编程模型，在14B模型中 HumanEval 得分最高，RTX 3060和RTX 3080 Ti上仅占约10 GB VRAM。使用约10 GB VRAM，在符合此约束的模型中 HumanEval 得分最高。DeepSeek-Coder-V2-Lite 是有力替代。',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M：~10 GB VRAM，该尺寸编程基准最高分',
          'DeepSeek-Coder-V2-Lite Q4_K_M：VRAM 相近，代码补全竞争力强',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B Q4_K_M: ~9–10 GB VRAM, high-70s on HumanEval — the top coding pick for any 12 GB GPU',
      ...
      body1: {
        ...
        content: [
          ...
          'Qwen2.5-Coder 14B Q4_K_M is the top pick — it leads consistently on Python and TypeScript tasks. DeepSeek-Coder-V2-Lite is a close alternative for polyglot work across 80+ languages. Both use ~9–10 GB VRAM and run at ~14 tok/s on an RTX 3060 12 GB. The RTX 3080 Ti 12 GB pushes these to ~18 tok/s thanks to its higher memory bandwidth (912 GB/s vs 360 GB/s).',
        ...
        rows: [
          { 'Model': 'Qwen2.5-Coder 14B Q4_K_M', 'VRAM at Q4': '~9–10 GB', 'Best For': 'Python, TypeScript, Go (top pick)' },
          { 'Model': 'DeepSeek-Coder-V2-Lite Q4_K_M', 'VRAM at Q4': '~9–10 GB', 'Best For': '80+ languages, polyglot work' },
        ...
        image: '/images/best-local-llm-coding-12gb-vram-model-vram-comparison-hero-en.webp',
        imageCaption: 'Best Coding Models for 12 GB VRAM -- Q4_K_M quantization',
      },
      body2: {
        ...
        image: '/images/best-local-llm-coding-12gb-vram-coding-settings-hero-en.webp',
        imageCaption: 'Settings That Matter for Coding -- Context and Flash Attention on 12 GB',
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          {
            ...
            a: 'No — Qwen2.5-Coder 14B at Q4_K_M uses ~9–10 GB, which exceeds 8 GB VRAM. Dropping to Q3_K_M (~7 GB) allows it to fit, but output quality degrades noticeably on code completion tasks.',
          },
          {
  ...
  de: {
    ...
    metaDescription: 'Qwen2.5-Coder 14B Q4_K_M: bestes Coding-Modell für 12 GB bei ~10 GB, höchster HumanEval-Score. DeepSeek 14B Q4 Alternative. Beide auf RTX 3060/3080 Ti.',
    heroImage: '/images/best-local-llm-coding-12gb-vram-model-vram-comparison-hero-de.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
      de: {
        question: 'Bestes lokales LLM für Coding mit 12 GB VRAM?',
        answer: 'Qwen2.5-Coder 14B Q4_K_M ist das beste Coding-Modell für 12-GB-VRAM-GPUs wie die RTX 3060. Es benötigt ~10 GB VRAM und erzielt den höchsten HumanEval-Score unter Modellen, die in dieses Limit passen. DeepSeek-Coder-V2-Lite ist eine starke Alternative.',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M: ~10 GB VRAM, bester Coding-Benchmark für diese Größe',
          'DeepSeek-Coder-V2-Lite Q4_K_M: ähnlicher VRAM, wettbewerbsfähig bei Code-Vervollständigung',
          'Beide passen auf RTX 3060 12 GB und RTX 3080 Ti 12 GB',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B Q4_K_M benötigt ~10 GB VRAM und passt mit 2 GB Puffer auf RTX 3060 12 GB oder RTX 3080 Ti 12 GB',
          'Bei kurzen Kontexten (≤4k Tokens) laufen Qwen und DeepSeek-Coder-V2-Lite auf diesen 12-GB-Karten mit 14–18 tok/s',
          'Kontextsitzungen über 8k erhöhen den VRAM auf ~11,5 GB — unter 8k Kontext bleiben für komfortablen 12-GB-Betrieb',
          'Qwen2.5-Coder 14B erzielt 78,4 % auf HumanEval; DeepSeek-Coder-V2-Lite 75,1 % — beide weit über jedem 7B-Coding-Modell',
        ],
      },
      body1: {
        title: 'Qwen2.5-Coder 14B ist das richtige 12-GB-VRAM-Modell',
        content: [
          '<strong>Qwen2.5-Coder 14B in der Q4_K_M-Quantisierung verwendet etwa 10 GB VRAM — mit 2 GB Puffer auf einer 12-GB-Karte, genug für Betriebssystem und Ollama-Laufzeit.</strong> Es erreicht 78,4 % auf HumanEval, den höchsten Score eines 14B- oder kleineren Coding-Modells für lokale Bereitstellung (Stand Mai 2026).',
          'DeepSeek-Coder-V2-Lite bei Q4_K_M hat einen fast identischen VRAM-Bedarf (~10 GB) und erzielt 75,1 % auf HumanEval. Der Unterschied ist gering, aber Qwen 3 Coder liegt bei Python- und TypeScript-Aufgaben konsequent vorne, die den Großteil typischer Entwickler-Workloads ausmachen.',
        ...
        rows: [
          { 'Modell': 'Qwen2.5-Coder 14B Q4_K_M', 'VRAM': '~10 GB', 'HumanEval': '78,4 %', 'Geschw. (RTX 3060)': '~14 tok/s', 'Geschw. (RTX 3080 Ti)': '~18 tok/s' },
          { 'Modell': 'DeepSeek-Coder-V2-Lite Q4_K_M', 'VRAM': '~10 GB', 'HumanEval': '75,1 %', 'Geschw. (RTX 3060)': '~14 tok/s', 'Geschw. (RTX 3080 Ti)': '~18 tok/s' },
          { 'Modell': 'Qwen2.5-Coder 7B Q4_K_M', 'VRAM': '~5 GB', 'HumanEval': '72,1 %', 'Geschw. (RTX 3060)': '~28 tok/s', 'Geschw. (RTX 3080 Ti)': '~38 tok/s' },
        ],
        image: '/images/best-local-llm-coding-12gb-vram-model-vram-comparison-hero-de.webp',
        imageCaption: 'Beste Coding-Modelle für 12 GB VRAM -- Q4_K_M-Quantisierung',
      },
      body2: {
        ...
        content: [
          ...
          'Wenn Sie häufig mit großen Dateien arbeiten und auf einer 12-GB-Karte bleiben möchten, erwägen Sie Qwen2.5-Coder 7B Q4_K_M — es läuft mit ~28 tok/s auf RTX 3060, erzielt 72,1 % auf HumanEval und lässt 7 GB VRAM für Kontext frei. Weitere Details zum 14B-vs-7B-Kompromiss finden Sie im <a href="/de/prompt-bites/best-14b-models-coding" class="text-primary hover:underline">Vergleich der besten 14B-Coding-Modelle</a>.',
        ],
        image: '/images/best-local-llm-coding-12gb-vram-coding-settings-hero-de.webp',
        imageCaption: 'Wichtige Einstellungen für Coding -- Kontext und Flash Attention bei 12 GB',
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Bei Q3_K_M passen einige 20B-Modelle in ~12 GB, aber Q3-Quantisierung verursacht bei Code-Aufgaben merkliche Qualitätsverluste. Qwen2.5-Coder 14B bei Q4_K_M übertrifft Qwen 3 Coder 20B bei Q3_K_M auf den meisten Coding-Benchmarks, weil Quantisierungsqualität in diesem Bereich wichtiger ist als Parameteranzahl.',
          },
          {
            q: 'Wie installiere ich Qwen2.5-Coder 14B auf Ollama für meine RTX 3060?',
  ...
  fr: {
    ...
    metaDescription: 'Qwen2.5-Coder 14B Q4_K_M: meilleur LLM coding pour 12 Go (~10 Go), meilleur HumanEval. DeepSeek 14B Q4 alternative. RTX 3060/3080 Ti 12 Go.',
    heroImage: '/images/best-local-llm-coding-12gb-vram-model-vram-comparison-hero-fr.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
      fr: {
        question: 'Meilleur LLM local pour le coding avec 12 Go de VRAM ?',
        answer: 'Qwen2.5-Coder 14B Q4_K_M est le meilleur modèle de coding pour les GPU 12 Go de VRAM comme la RTX 3060. Il utilise ~10 Go de VRAM et obtient le meilleur score HumanEval parmi les modèles qui tiennent dans cette contrainte. DeepSeek-Coder-V2-Lite est une alternative solide.',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M : ~10 Go de VRAM, meilleur benchmark de coding pour cette taille',
          'DeepSeek-Coder-V2-Lite Q4_K_M : VRAM similaire, compétitif sur la complétion de code',
          'Les deux tiennent sur RTX 3060 12 Go et RTX 3080 Ti 12 Go',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B Q4_K_M utilise ~10 Go de VRAM et tient sur RTX 3060 12 Go ou RTX 3080 Ti 12 Go avec 2 Go de marge',
          'En contexte court (≤4k tokens), Qwen et DeepSeek-Coder-V2-Lite tournent à 14–18 tok/s sur ces cartes 12 Go',
          ...
          'Qwen2.5-Coder 14B obtient 78,4 % sur HumanEval ; DeepSeek-Coder-V2-Lite 75,1 % — les deux bien au-dessus de tout modèle de coding 7B',
        ],
      },
      body1: {
        title: 'Qwen2.5-Coder 14B est le bon modèle pour 12 Go de VRAM',
        content: [
          '<strong>Qwen2.5-Coder 14B en quantification Q4_K_M utilise environ 10 Go de VRAM — laissant 2 Go de marge sur une carte 12 Go, suffisant pour le système d\'exploitation et le runtime Ollama.</strong> Il atteint 78,4 % sur HumanEval, le meilleur score de tout modèle de coding 14B ou inférieur disponible en local en mai 2026.',
          'DeepSeek-Coder-V2-Lite en Q4_K_M a une empreinte VRAM quasi-identique (~10 Go) et obtient 75,1 % sur HumanEval. L\'écart est faible, mais Qwen 3 Coder est régulièrement en tête sur les tâches Python et TypeScript, qui représentent la majorité des charges de travail développeur classiques.',
        ...
        rows: [
          { 'Modèle': 'Qwen2.5-Coder 14B Q4_K_M', 'VRAM': '~10 Go', 'HumanEval': '78,4 %', 'Vitesse (RTX 3060)': '~14 tok/s', 'Vitesse (RTX 3080 Ti)': '~18 tok/s' },
          { 'Modèle': 'DeepSeek-Coder-V2-Lite Q4_K_M', 'VRAM': '~10 Go', 'HumanEval': '75,1 %', 'Vitesse (RTX 3060)': '~14 tok/s', 'Vitesse (RTX 3080 Ti)': '~18 tok/s' },
          { 'Modèle': 'Qwen2.5-Coder 7B Q4_K_M', 'VRAM': '~5 Go', 'HumanEval': '72,1 %', 'Vitesse (RTX 3060)': '~28 tok/s', 'Vitesse (RTX 3080 Ti)': '~38 tok/s' },
        ],
        image: '/images/best-local-llm-coding-12gb-vram-model-vram-comparison-hero-fr.webp',
        imageCaption: 'Meilleurs Modèles de Codage pour 12 Go VRAM -- Quantification Q4_K_M',
      },
      body2: {
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'En Q3_K_M, certains modèles 20B tiennent dans ~12 Go, mais la quantification Q3 cause une dégradation perceptible de la qualité sur les tâches de code. Un Qwen2.5-Coder 14B en Q4_K_M surpasse un Qwen 3 Coder 20B en Q3_K_M sur la plupart des benchmarks de coding, car la qualité de quantification compte plus que le nombre de paramètres dans cette plage.',
          },
          {
            q: 'Comment installer Qwen2.5-Coder 14B sur Ollama pour ma RTX 3060 ?',
  ...
  ja: {
    ...
    metaDescription: 'Qwen2.5-Coder 14B Q4_K_M：12 GB VRAM最高のコーディングLLM、約10 GB使用、HumanEval最高スコア。DeepSeek 14B Q4代替。RTX 3060/3080 Ti対応。',
    heroImage: '/images/best-local-llm-coding-12gb-vram-model-vram-comparison-hero-ja.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
      ja: {
        question: '12 GB VRAMでコーディングに最適なローカルLLMは？',
        answer: 'Qwen2.5-Coder 14B Q4_K_MはRTX 3060などの12 GB VRAM GPUに最適なコーディングモデルです。~10 GB VRAMを使用し、この制約に収まるモデルの中でHumanEvalスコアが最高です。DeepSeek-Coder-V2-Liteは強力な代替です。',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M：~10 GB VRAM、このサイズでコーディングベンチマーク最高',
          'DeepSeek-Coder-V2-Lite Q4_K_M：同様のVRAM、コード補完で競争力あり',
          '両者ともRTX 3060 12 GBおよびRTX 3080 Ti 12 GBに収まる',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B Q4_K_Mは~10 GB VRAMを使用し、RTX 3060 12 GBまたはRTX 3080 Ti 12 GBに2 GBの余裕で収まる',
          '短いコンテキスト（≤4kトークン）では、これらの12 GBカードでQwenとDeepSeek-Coder-V2-Liteは14〜18 tok/sで動作',
          '8k超のコンテキストセッションではVRAMが~11.5 GBに上昇 — 快適な12 GB動作のため8k以下を維持',
          'Qwen2.5-Coder 14BはHumanEvalで78.4%、DeepSeek-Coder-V2-Liteは75.1% — 両者とも7Bコーディングモデルを大幅に上回る',
        ],
      },
      body1: {
        title: 'Qwen2.5-Coder 14Bが12 GB VRAMに最適なモデル',
        content: [
          '<strong>Q4_K_M量子化のQwen2.5-Coder 14Bは約10 GB VRAMを使用 — 12 GBカードに2 GBの余裕を残し、OSとOllamaランタイムに十分です。</strong> HumanEvalで78.4%を達成し、2026年5月時点でローカル展開向けの14B以下のコーディングモデルの中で最高スコアです。',
          'Q4_K_MのDeepSeek-Coder-V2-Liteはほぼ同一のVRAMフットプリント（~10 GB）でHumanEvalで75.1%を記録します。差は小さいですが、Qwen 3 CoderはPythonとTypeScriptタスクで一貫してリードしており、これらは典型的な開発者ワークロードの大半を占めます。',
        ...
        rows: [
          { 'モデル': 'Qwen2.5-Coder 14B Q4_K_M', 'VRAM': '~10 GB', 'HumanEval': '78.4%', '速度 (RTX 3060)': '~14 tok/s', '速度 (RTX 3080 Ti)': '~18 tok/s' },
          { 'モデル': 'DeepSeek-Coder-V2-Lite Q4_K_M', 'VRAM': '~10 GB', 'HumanEval': '75.1%', '速度 (RTX 3060)': '~14 tok/s', '速度 (RTX 3080 Ti)': '~18 tok/s' },
          { 'モデル': 'Qwen2.5-Coder 7B Q4_K_M', 'VRAM': '~5 GB', 'HumanEval': '72.1%', '速度 (RTX 3060)': '~28 tok/s', '速度 (RTX 3080 Ti)': '~38 tok/s' },
        ],
        image: '/images/best-local-llm-coding-12gb-vram-model-vram-comparison-hero-ja.webp',
        imageCaption: '12GB VRAM向け最良コーディングモデル -- Q4_K_M量子化',
      },
      body2: {
        ...
        content: [
          ...
          '大きなファイルを頻繁に扱い12 GBカードを使い続けたい場合は、Qwen2.5-Coder 7B Q4_K_Mを検討してください — RTX 3060で~28 tok/sで動作し、HumanEvalで72.1%を記録し、コンテキスト用に7 GB VRAMを空けます。14B対7Bのトレードオフの詳細については<a href="/ja/prompt-bites/best-14b-models-coding" class="text-primary hover:underline">最適14Bコーディングモデル比較</a>をご覧ください。',
        ],
        image: '/images/best-local-llm-coding-12gb-vram-coding-settings-hero-ja.webp',
        imageCaption: 'コーディングで重要な設定 -- 12GBでのコンテキストとFlash Attention',
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Q3_K_Mでは一部の20BモデルがVRAM~12 GBに収まりますが、Q3量子化はコードタスクで顕著な品質低下を引き起こします。Q4_K_MのQwen2.5-Coder 14BはQ3_K_MのQwen 3 Coder 20Bをほとんどのコーディングベンチマークで上回ります。この範囲では量子化品質がパラメータ数より重要です。',
          },
          {
            q: 'RTX 3060にOllamaでQwen2.5-Coder 14Bをインストールするにはどうすればいいですか？',
          ...
          },
          {
            ...
            a: 'はい、大幅に優れています。Qwen2.5-Coder 14BはHumanEvalで78.4%を記録します。同程度のサイズの汎用Mistral 12Bは約60%です。18ポイントの差はコード特化の事前学習データを反映しています。本格的なコーディング作業には同じサイズの汎用モデルではなく常にコード最適化モデルを選んでください。選択肢の比較は<a href="/ja/prompt-bites/qwen-coder-vs-deepseek-coder" class="text-primary hover:underline">Qwen Coder対DeepSeek Coderガイド</a>をご覧ください。',
          },
        ],
      },
      relatedReading: {
  ...
  zh: {
    ...
    metaDescription: 'Qwen2.5-Coder 14B Q4_K_M：12 GB VRAM最优编程LLM，约10 GB占用，HumanEval最高分。DeepSeek 14B Q4备选。RTX 3060/3080 Ti 12 GB适配。',
    heroImage: '/images/best-local-llm-coding-12gb-vram-model-vram-comparison-hero-zh.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
      zh: {
        question: '12 GB VRAM 编程最佳本地 LLM 是哪款？',
        answer: 'Qwen2.5-Coder 14B Q4_K_M 是 RTX 3060 等12 GB VRAM 显卡的最佳编程模型。使用约10 GB VRAM，在符合此约束的模型中 HumanEval 得分最高。DeepSeek-Coder-V2-Lite 是有力替代。',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M：~10 GB VRAM，该尺寸编程基准最高分',
          'DeepSeek-Coder-V2-Lite Q4_K_M：VRAM 相近，代码补全竞争力强',
          '两者均适配 RTX 3060 12 GB 和 RTX 3080 Ti 12 GB',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B Q4_K_M 使用约10 GB VRAM，以2 GB 余量适配 RTX 3060 12 GB 或 RTX 3080 Ti 12 GB',
          '短上下文（≤4k token）下，Qwen 和 DeepSeek-Coder-V2-Lite 在这些12 GB 显卡上运行14–18 tok/s',
          '超过8k 的上下文会让 VRAM 升至约11.5 GB——保持8k 以下以确保12 GB 显卡舒适运行',
          'Qwen2.5-Coder 14B HumanEval 得78.4%；DeepSeek-Coder-V2-Lite 得75.1%——均远超任何7B 编程模型',
        ],
      },
      body1: {
        title: 'Qwen2.5-Coder 14B 是12 GB VRAM 的正确选择',
        content: [
          '<strong>Q4_K_M 量化的 Qwen2.5-Coder 14B 使用约10 GB VRAM——在12 GB 显卡上留有2 GB 余量，足够操作系统和 Ollama 运行时使用。</strong>HumanEval 得78.4%，是截至2026年5月所有可本地部署的14B 及以下编程模型中的最高分。',
          'Q4_K_M 下的 DeepSeek-Coder-V2-Lite VRAM 占用几乎相同（约10 GB），HumanEval 得75.1%。差距不大，但 Qwen 3 Coder 在 Python 和 TypeScript 任务上持续领先，而这些占据了典型开发者工作负载的大部分。',
        ...
        rows: [
          { '模型': 'Qwen2.5-Coder 14B Q4_K_M', 'VRAM': '~10 GB', 'HumanEval': '78.4%', '速度 (RTX 3060)': '~14 tok/s', '速度 (RTX 3080 Ti)': '~18 tok/s' },
          { '模型': 'DeepSeek-Coder-V2-Lite Q4_K_M', 'VRAM': '~10 GB', 'HumanEval': '75.1%', '速度 (RTX 3060)': '~14 tok/s', '速度 (RTX 3080 Ti)': '~18 tok/s' },
          { '模型': 'Qwen2.5-Coder 7B Q4_K_M', 'VRAM': '~5 GB', 'HumanEval': '72.1%', '速度 (RTX 3060)': '~28 tok/s', '速度 (RTX 3080 Ti)': '~38 tok/s' },
        ],
        image: '/images/best-local-llm-coding-12gb-vram-model-vram-comparison-hero-zh.webp',
        imageCaption: '12GB显存最佳编程模型 -- Q4_K_M量化',
      },
      body2: {
        ...
        content: [
          ...
          '如果经常处理大型文件且希望保留12 GB 显卡，可考虑 Qwen2.5-Coder 7B Q4_K_M——RTX 3060 上约28 tok/s，HumanEval 得72.1%，且释放7 GB VRAM 用于上下文。14B 对比7B 权衡的更多细节请参阅<a href="/zh/prompt-bites/best-14b-models-coding" class="text-primary hover:underline">最佳14B 编程模型对比</a>。',
        ],
        image: '/images/best-local-llm-coding-12gb-vram-coding-settings-hero-zh.webp',
        imageCaption: '编程时需要注意的设置 -- 12GB下的上下文与Flash Attention',
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Q3_K_M 下部分20B 模型能塞进约12 GB，但 Q3 量化在代码任务上造成明显质量下降。Q4_K_M 的 Qwen2.5-Coder 14B 在大多数编程基准测试上优于 Q3_K_M 的 Qwen 3 Coder 20B，因为在这个范围内量化质量比参数量更重要。',
          },
          {
            q: '如何在 RTX 3060 的 Ollama 上安装 Qwen2.5-Coder 14B？',
          ...
          },
          {
            ...
            a: '是的，明显更好。Qwen2.5-Coder 14B HumanEval 得78.4%。同等大小的通用 Mistral 12B 约60%。18分的差距反映了代码专项预训练数据的价值。对于严肃的编程工作，始终选择相同尺寸的代码微调模型而非通用模型。选项对比请参阅<a href="/zh/prompt-bites/qwen-coder-vs-deepseek-coder" class="text-primary hover:underline">Qwen Coder 对比 DeepSeek Coder 指南</a>。',
          },
        ],
      },
      relatedReading: {
  ...
  es: {
    ...
    metaDescription: 'Qwen2.5-Coder 14B Q4_K_M: mejor LLM de programación para 12 GB con ~10 GB y mayor HumanEval. DeepSeek 14B Q4 como alternativa. Para RTX 3060/3080 Ti.',
    heroImage: '/images/best-local-llm-coding-12gb-vram-model-vram-comparison-hero-es.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
      es: {
        ...
        answer: 'Qwen2.5-Coder 14B Q4_K_M es el mejor modelo de programación para GPUs con 12 GB de VRAM como la RTX 3060. Usa ~10 GB de VRAM y obtiene la puntuación HumanEval más alta entre los modelos que caben en esta restricción. DeepSeek-Coder-V2-Lite es una alternativa sólida.',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M: ~10 GB de VRAM, mejor benchmark de programación para este tamaño',
          'DeepSeek-Coder-V2-Lite Q4_K_M: VRAM similar, competitivo en completado de código',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B Q4_K_M usa ~10 GB de VRAM y cabe en RTX 3060 12 GB o RTX 3080 Ti 12 GB con 2 GB de margen',
          'En contexto corto (≤4k tokens), Qwen y DeepSeek-Coder-V2-Lite corren a 14–18 tok/s en estas tarjetas de 12 GB',
          ...
          'Qwen2.5-Coder 14B obtiene 78,4 % en HumanEval; DeepSeek-Coder-V2-Lite 75,1 % — ambos muy por encima de cualquier modelo de programación 7B',
        ],
      },
      body1: {
        title: 'Qwen2.5-Coder 14B es la elección correcta para 12 GB de VRAM',
        content: [
          '<strong>Qwen2.5-Coder 14B en cuantización Q4_K_M usa aproximadamente 10 GB de VRAM — dejando 2 GB de margen en una tarjeta de 12 GB, suficiente para el sistema operativo y el runtime de Ollama.</strong> Alcanza 78,4 % en HumanEval, la puntuación más alta de cualquier modelo de programación de 14B o inferior disponible para despliegue local a mayo de 2026.',
          'DeepSeek-Coder-V2-Lite en Q4_K_M tiene un consumo de VRAM casi idéntico (~10 GB) y obtiene 75,1 % en HumanEval. La diferencia es pequeña, pero Qwen 3 Coder lidera de forma consistente en tareas de Python y TypeScript, que representan la mayoría de las cargas de trabajo habituales de los desarrolladores.',
        ...
        rows: [
          { 'Modelo': 'Qwen2.5-Coder 14B Q4_K_M', 'VRAM': '~10 GB', 'HumanEval': '78,4 %', 'Velocidad (RTX 3060)': '~14 tok/s', 'Velocidad (RTX 3080 Ti)': '~18 tok/s' },
          { 'Modelo': 'DeepSeek-Coder-V2-Lite Q4_K_M', 'VRAM': '~10 GB', 'HumanEval': '75,1 %', 'Velocidad (RTX 3060)': '~14 tok/s', 'Velocidad (RTX 3080 Ti)': '~18 tok/s' },
          { 'Modelo': 'Qwen2.5-Coder 7B Q4_K_M', 'VRAM': '~5 GB', 'HumanEval': '72,1 %', 'Velocidad (RTX 3060)': '~28 tok/s', 'Velocidad (RTX 3080 Ti)': '~38 tok/s' },
        ],
        image: '/images/best-local-llm-coding-12gb-vram-model-vram-comparison-hero-es.webp',
        imageCaption: 'Mejores Modelos de Código para 12 GB VRAM -- Cuantización Q4_K_M',
      },
      body2: {
  ...
  pt: {
    ...
    metaDescription: 'Qwen2.5-Coder 14B Q4_K_M: melhor LLM de programação para 12 GB com ~10 GB e maior HumanEval. DeepSeek 14B Q4 como alternativa. Para RTX 3060/3080 Ti.',
    heroImage: '/images/best-local-llm-coding-12gb-vram-model-vram-comparison-hero-pt.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
      pt: {
        ...
        answer: 'O Qwen2.5-Coder 14B Q4_K_M é o melhor modelo de programação para GPUs com 12 GB de VRAM como a RTX 3060. Usa ~10 GB de VRAM e obtém a pontuação HumanEval mais alta entre os modelos que cabem nessa restrição. DeepSeek-Coder-V2-Lite é uma alternativa sólida.',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M: ~10 GB de VRAM, melhor benchmark de programação para esse tamanho',
          'DeepSeek-Coder-V2-Lite Q4_K_M: VRAM similar, competitivo em completação de código',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B Q4_K_M usa ~10 GB de VRAM e cabe na RTX 3060 12 GB ou RTX 3080 Ti 12 GB com 2 GB de margem',
          'Em contexto curto (≤4k tokens), Qwen e DeepSeek-Coder-V2-Lite rodam a 14–18 tok/s nessas placas de 12 GB',
          'Sessões com mais de 8k tokens sobem o VRAM para ~11,5 GB — mantenha abaixo de 8k para operação confortável em 12 GB',
          'Qwen2.5-Coder 14B obtém 78,4% no HumanEval; DeepSeek-Coder-V2-Lite obtém 75,1% — ambos bem acima de qualquer modelo de programação 7B',
        ],
      },
      body1: {
        title: 'Qwen2.5-Coder 14B é a escolha certa para 12 GB de VRAM',
        content: [
          '<strong>O Qwen2.5-Coder 14B em quantização Q4_K_M usa aproximadamente 10 GB de VRAM — deixando 2 GB de margem em uma placa de 12 GB, suficiente para o sistema operacional e o runtime do Ollama.</strong> Alcança 78,4% no HumanEval, a pontuação mais alta de qualquer modelo de programação de 14B ou inferior disponível para implantação local em maio de 2026.',
          'O DeepSeek-Coder-V2-Lite em Q4_K_M tem um consumo de VRAM quase idêntico (~10 GB) e obtém 75,1% no HumanEval. A diferença é pequena, mas o Qwen 3 Coder lidera de forma consistente em tarefas de Python e TypeScript, que representam a maioria das cargas de trabalho típicas dos desenvolvedores.',
        ...
        rows: [
          { 'Modelo': 'Qwen2.5-Coder 14B Q4_K_M', 'VRAM': '~10 GB', 'HumanEval': '78,4%', 'Velocidade (RTX 3060)': '~14 tok/s', 'Velocidade (RTX 3080 Ti)': '~18 tok/s' },
          { 'Modelo': 'DeepSeek-Coder-V2-Lite Q4_K_M', 'VRAM': '~10 GB', 'HumanEval': '75,1%', 'Velocidade (RTX 3060)': '~14 tok/s', 'Velocidade (RTX 3080 Ti)': '~18 tok/s' },
          { 'Modelo': 'Qwen2.5-Coder 7B Q4_K_M', 'VRAM': '~5 GB', 'HumanEval': '72,1%', 'Velocidade (RTX 3060)': '~28 tok/s', 'Velocidade (RTX 3080 Ti)': '~38 tok/s' },
        ],
        image: '/images/best-local-llm-coding-12gb-vram-model-vram-comparison-hero-pt.webp',
        imageCaption: 'Melhores Modelos de Código para 12 GB VRAM -- Quantização Q4_K_M',
      },
      body2: {
        ...
        content: [
          ...
          'Se você trabalha frequentemente com arquivos grandes e quer manter uma placa de 12 GB, considere o Qwen2.5-Coder 7B Q4_K_M — roda a ~28 tok/s na RTX 3060, obtém 72,1% no HumanEval e libera 7 GB de VRAM para o contexto. Consulte o <a href="/pt/prompt-bites/best-14b-models-coding" class="text-primary hover:underline">comparativo dos melhores modelos de programação 14B</a> para mais detalhes sobre o trade-off 14B vs 7B.',
        ],
        image: '/images/best-local-llm-coding-12gb-vram-coding-settings-hero-pt.webp',
        imageCaption: 'Configurações que Importam para Programação -- Contexto e Flash Attention em 12 GB',
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Com Q3_K_M alguns modelos de 20B cabem em ~12 GB, mas a quantização Q3 causa uma degradação perceptível de qualidade em tarefas de código. O Qwen2.5-Coder 14B em Q4_K_M supera o Qwen 3 Coder 20B em Q3_K_M na maioria dos benchmarks de programação, porque a qualidade da quantização importa mais do que o número de parâmetros nesse intervalo.',
          },
          {
            q: 'Como instalo o Qwen2.5-Coder 14B no Ollama para minha RTX 3060?',
  ...
  ar: {
    ...
    metaDescription: '⁨Qwen2.5-Coder 14B Q4⁩_⁨K⁩_⁨M⁩ أفضل نموذج برمجة لـ⁨12 GB VRAM⁩ بـ~⁨10 GB⁩، أعلى ⁨HumanEval. DeepSeek 14B Q4⁩ بديل قوي. كلاهما على ⁨RTX 3060⁩ و⁨RTX 3080 Ti⁩.',
    heroImage: '/images/best-local-llm-coding-12gb-vram-model-vram-comparison-hero-ar.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
      ar: {
        ...
        answer: 'Qwen2.5-Coder 14B Q4_K_M هو أفضل نموذج برمجة لمعالجات رسومات بـ12 جيجابايت VRAM كـRTX 3060. يستخدم ~10 جيجابايت VRAM ويحقق أعلى درجة HumanEval بين النماذج التي تتسع ضمن هذا القيد. DeepSeek-Coder-V2-Lite بديل قوي.',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M: ~10 جيجابايت VRAM، أعلى اختبار أداء برمجة لهذا الحجم',
          'DeepSeek-Coder-V2-Lite Q4_K_M: VRAM مماثل، تنافسي في إكمال الكود',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B Q4_K_M يستخدم ~10 جيجابايت VRAM ويتسع في RTX 3060 12 جيجابايت أو RTX 3080 Ti 12 جيجابايت بهامش 2 جيجابايت',
          'في السياق القصير (≤4000 رمز)، يعمل Qwen وDeepSeek-Coder-V2-Lite بـ14–18 رمز/ثانية على هذه البطاقات بـ12 جيجابايت',
          'جلسات السياق التي تتجاوز 8000 رمز ترفع VRAM إلى ~11.5 جيجابايت — ابقَ دون 8000 رمز لتشغيل مريح بـ12 جيجابايت',
          'Qwen2.5-Coder 14B يحقق 78.4% على HumanEval؛ DeepSeek-Coder-V2-Lite يحقق 75.1% — كلاهما يتفوق بفارق كبير على أي نموذج برمجة 7B',
        ],
      },
      body1: {
        title: 'Qwen2.5-Coder 14B هو الاختيار الصحيح لـ12 جيجابايت VRAM',
        content: [
          '<strong>Qwen2.5-Coder 14B بتكميم Q4_K_M يستخدم نحو 10 جيجابايت VRAM — يترك 2 جيجابايت هامشاً على بطاقة 12 جيجابايت، كافٍ لنظام التشغيل وبيئة تشغيل Ollama.</strong> يحقق 78.4% على HumanEval، وهو أعلى درجة لأي نموذج برمجة بـ14B أو أقل متاح للنشر المحلي حتى مايو 2026.',
          'DeepSeek-Coder-V2-Lite بتكميم Q4_K_M له بصمة VRAM متطابقة تقريباً (~10 جيجابايت) ويحقق 75.1% على HumanEval. الفارق صغير، لكن Qwen 3 Coder يتصدر باستمرار في مهام Python وTypeScript التي تشكّل معظم أعباء عمل المطورين النموذجية.',
        ...
        rows: [
          { 'النموذج': 'Qwen2.5-Coder 14B Q4_K_M', 'VRAM': '~10 جيجابايت', 'HumanEval': '78.4%', 'السرعة (RTX 3060)': '~14 رمز/ثانية', 'السرعة (RTX 3080 Ti)': '~18 رمز/ثانية' },
          { 'النموذج': 'DeepSeek-Coder-V2-Lite Q4_K_M', 'VRAM': '~10 جيجابايت', 'HumanEval': '75.1%', 'السرعة (RTX 3060)': '~14 رمز/ثانية', 'السرعة (RTX 3080 Ti)': '~18 رمز/ثانية' },
          { 'النموذج': 'Qwen2.5-Coder 7B Q4_K_M', 'VRAM': '~5 جيجابايت', 'HumanEval': '72.1%', 'السرعة (RTX 3060)': '~28 رمز/ثانية', 'السرعة (RTX 3080 Ti)': '~38 رمز/ثانية' },
        ],
        image: '/images/best-local-llm-coding-12gb-vram-model-vram-comparison-hero-ar.webp',
        imageCaption: 'أفضل نماذج البرمجة لذاكرة 12 GB -- تكميم Q4_K_M',
      },
      body2: {
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'بتكميم Q3_K_M تتسع بعض نماذج 20B في ~12 جيجابايت، لكن التكميم Q3 يُحدث تدهوراً ملحوظاً في الجودة على مهام الكود. Qwen2.5-Coder 14B بتكميم Q4_K_M يتفوق على Qwen 3 Coder 20B بتكميم Q3_K_M في معظم اختبارات أداء البرمجة، لأن جودة التكميم أهم من عدد المعاملات في هذا النطاق.',
          },
          {
            q: 'كيف أثبّت Qwen2.5-Coder 14B على Ollama لـRTX 3060 لديّ؟',
  ...
  ko: {
    ...
    metaDescription: 'Qwen2.5-Coder 14B Q4_K_M: 12 GB VRAM 코딩 최고 모델, ~10 GB 사용, HumanEval 최고점. DeepSeek 14B Q4 대안. RTX 3060/3080 Ti 모두 지원.',
    heroImage: '/images/best-local-llm-coding-12gb-vram-model-vram-comparison-hero-ko.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-21',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    ...
    quickAnswerTop: {
      ko: {
        ...
        answer: 'Qwen2.5-Coder 14B Q4_K_M은 RTX 3060과 같은 12 GB VRAM GPU에서 코딩에 가장 적합한 모델입니다. VRAM을 약 10 GB 사용하며 이 제약 조건에 맞는 모델 중 HumanEval 점수가 가장 높습니다. DeepSeek-Coder-V2-Lite는 강력한 대안입니다.',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M: ~10 GB VRAM 사용, 이 크기에서 코딩 벤치마크 최고점',
          'DeepSeek-Coder-V2-Lite Q4_K_M: 유사한 VRAM, 코드 완성에서 경쟁력 있음',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B Q4_K_M은 VRAM 약 10 GB를 사용하며 RTX 3060 12 GB 또는 RTX 3080 Ti 12 GB에 2 GB 여유를 두고 탑재됩니다.',
          '짧은 컨텍스트(≤4k 토큰) 환경에서 Qwen과 DeepSeek-Coder-V2-Lite는 12 GB 카드에서 14~18 tok/s로 구동됩니다.',
          '8k 토큰 이상의 컨텍스트 세션에서는 VRAM이 약 11.5 GB까지 증가합니다. 12 GB에서 안정적인 사용을 위해 8k 미만을 권장합니다.',
          'Qwen2.5-Coder 14B는 HumanEval에서 78.4%를 달성하며, DeepSeek-Coder-V2-Lite는 75.1%로 모든 7B 코딩 모델을 크게 능가합니다.',
        ],
        snippetBlocks: [
          { type: 'one-sentence', text: '12 GB VRAM 환경에서 코딩에 가장 적합한 로컬 LLM은 Qwen2.5-Coder 14B Q4_K_M이며 HumanEval 78.4%를 기록합니다.' },
          { type: 'plain-terms', text: 'VRAM 12 GB인 RTX 3060이나 RTX 3080 Ti를 사용하는 개발자는 Qwen2.5-Coder 14B Q4_K_M을 선택하면 약 10 GB VRAM으로 최고 수준의 코드 생성 성능을 얻을 수 있습니다.' },
        ],
      },
      body1: {
        title: 'Qwen2.5-Coder 14B: 12 GB VRAM을 위한 최선의 선택',
        content: [
          '<strong>Q4_K_M 양자화를 적용한 Qwen2.5-Coder 14B는 VRAM 약 10 GB를 사용하여 12 GB 카드에 2 GB 여유를 남깁니다. 이는 운영 체제와 Ollama 런타임을 위한 충분한 공간입니다.</strong> 2026년 5월 기준 로컬 배포 가능한 14B 이하 코딩 모델 중 HumanEval 78.4%로 가장 높은 점수를 기록합니다.',
          'Q4_K_M 양자화의 DeepSeek-Coder-V2-Lite는 VRAM 사용량이 거의 동일하며(~10 GB) HumanEval에서 75.1%를 달성합니다. 차이는 작지만, Qwen 3 Coder는 개발자가 가장 많이 다루는 Python과 TypeScript 작업에서 일관적으로 우세합니다.',
        ...
        rows: [
          { '모델': 'Qwen2.5-Coder 14B Q4_K_M', 'VRAM': '~10 GB', 'HumanEval': '78.4%', '속도 (RTX 3060)': '~14 tok/s', '속도 (RTX 3080 Ti)': '~18 tok/s' },
          { '모델': 'DeepSeek-Coder-V2-Lite Q4_K_M', 'VRAM': '~10 GB', 'HumanEval': '75.1%', '속도 (RTX 3060)': '~14 tok/s', '속도 (RTX 3080 Ti)': '~18 tok/s' },
          { '모델': 'Qwen2.5-Coder 7B Q4_K_M', 'VRAM': '~5 GB', 'HumanEval': '72.1%', '속도 (RTX 3060)': '~28 tok/s', '속도 (RTX 3080 Ti)': '~38 tok/s' },
        ],
        image: '/images/best-local-llm-coding-12gb-vram-model-vram-comparison-hero-ko.webp',
        imageCaption: '12GB VRAM를 위한 최고의 코딩 모델 -- Q4_K_M 양자화',
      },
      body2: {
        ...
        content: [
          ...
          '대용량 파일을 자주 다루면서 12 GB 카드를 유지하려는 경우 Qwen2.5-Coder 7B Q4_K_M을 고려하십시오. RTX 3060에서 약 28 tok/s로 구동되고 HumanEval 72.1%를 달성하며 컨텍스트를 위해 7 GB VRAM을 확보합니다. 14B 대 7B 트레이드오프에 대한 자세한 내용은 <a href="/ko/prompt-bites/best-14b-models-coding" class="text-primary hover:underline">최고의 14B 코딩 모델 비교</a>를 참조하십시오.',
        ],
        image: '/images/best-local-llm-coding-12gb-vram-coding-settings-hero-ko.webp',
        imageCaption: '코딩에 중요한 설정 -- 12GB에서의 컨텍스트와 Flash Attention',
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Q3_K_M 양자화를 사용하면 일부 20B 모델이 약 12 GB에 맞지만, Q3 양자화는 코드 작업에서 눈에 띄는 품질 저하를 유발합니다. Qwen2.5-Coder 14B Q4_K_M은 이 범위에서 매개변수 수보다 양자화 품질이 더 중요하기 때문에 대부분의 코딩 벤치마크에서 Q3_K_M의 Qwen 3 Coder 20B를 능가합니다.',
          },
          {
            q: 'RTX 3060에서 Qwen2.5-Coder 14B를 Ollama에 설치하려면 어떻게 합니까?',
