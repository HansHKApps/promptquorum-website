...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    heroImage: '/images/best-mini-pc-local-llm-japan-overview-hero-en.webp',
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: 'Mini PC vs Mac mini — which is better for local LLMs in Japan?',
            a: 'Apple refreshed the Mac mini lineup on August 25, 2026: the base Mac mini M6 (32 GB max unified memory) starts at ¥149,800 in Japan and ships September 22, 2026. A Mac mini M5 Pro (64 GB max) starts at ¥299,800 for users who need more memory headroom. No independent local-LLM inference benchmarks exist yet for the M6 or M5 Pro — treat any tok/s figures for these chips as unverified for now. The Beelink SER7 (~¥70,000) remains roughly ¥80,000 cheaper and runs Ollama out of the box today. Buy the Mac mini M6 if your budget allows, you run macOS, and you want the newest Apple Silicon; buy the Beelink SER7 if you need Windows, prefer AMD/Vulkan, or want to save money now.',
          },
        ],
      },
    },
  ...
  de: {
    theme: 'Hardware Guides',
    heroImage: '/images/best-mini-pc-local-llm-japan-overview-hero-de.webp',
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: 'Mini-PC vs. Mac mini — welcher ist besser für lokale LLMs in Japan?',
            a: 'Apple hat die Mac-mini-Reihe am 25. August 2026 aktualisiert: Der Basis-Mac mini M6 (max. 32 GB Unified Memory) startet in Japan bei ¥149.800 (ca. €1.220) und kommt am 22. September 2026 in den Handel. Ein Mac mini M5 Pro (max. 64 GB) startet bei ¥299.800 (ca. €2.450) für mehr Speicher-Headroom. Für M6 und M5 Pro liegen noch keine unabhängigen Local-LLM-Benchmarks vor — behandeln Sie alle Tok/s-Angaben zu diesen Chips vorerst als unbestätigt. Der Beelink SER7 (~¥70.000) bleibt rund ¥80.000 günstiger und lässt Ollama sofort ohne Konfiguration laufen. Kaufen Sie den Mac mini M6, wenn das Budget es erlaubt, Sie macOS nutzen und die neueste Apple-Silicon-Generation wollen; kaufen Sie den Beelink SER7, wenn Sie Windows benötigen, AMD/Vulkan bevorzugen oder jetzt Geld sparen möchten.',
          },
        ],
      },
    },
  ...
  fr: {
    theme: 'Hardware Guides',
    heroImage: '/images/best-mini-pc-local-llm-japan-overview-hero-fr.webp',
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: 'Mini PC vs Mac mini — lequel est mieux pour les LLMs locaux au Japon ?',
            a: 'Apple a renouvelé la gamme Mac mini le 25 août 2026 : le Mac mini M6 de base (32 Go de mémoire unifiée max.) démarre à ¥149 800 au Japon (environ €1 220) et sera disponible le 22 septembre 2026. Un Mac mini M5 Pro (64 Go max.) démarre à ¥299 800 (environ €2 450) pour plus de marge mémoire. Aucun benchmark d\'inférence LLM locale indépendant n\'existe encore pour le M6 ou le M5 Pro — considérez tout chiffre en tok/s pour ces puces comme non vérifié pour l\'instant. Le Beelink SER7 (~¥70 000) reste environ ¥80 000 moins cher et fait tourner Ollama dès le démarrage. Achetez le Mac mini M6 si votre budget le permet, que vous utilisez macOS et voulez la dernière génération Apple Silicon ; achetez le Beelink SER7 si vous avez besoin de Windows, préférez AMD/Vulkan, ou voulez économiser dès maintenant.',
          },
        ],
      },
    },
  ...
  ja: {
    theme: 'Hardware Guides',
    heroImage: '/images/best-mini-pc-local-llm-japan-overview-hero-ja.webp',
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: 'ミニPCとMac mini、日本でローカルLLMに向いているのはどちらですか？',
            a: 'Appleは2026年8月25日にMac miniシリーズを刷新しました。ベースのMac mini M6（ユニファイドメモリ最大32GB）は日本で¥149,800から、発売は2026年9月22日です。より多くのメモリが必要な場合はMac mini M5 Pro（最大64GB）が¥299,800からとなります。M6・M5 ProについてはローカルLLM推論の独立したベンチマークがまだ公開されておらず、これらのチップのtok/s値は現時点では未検証として扱ってください。Beelink SER7（約¥70,000）は依然として約¥80,000安く、Ollamaは設定なしですぐに動作します。予算に余裕がありmacOSを使い、最新のApple Siliconが欲しい場合はMac mini M6を、Windowsが必要、AMD/Vulkanを好む、またはすぐに費用を抑えたい場合はBeelink SER7を選んでください。',
          },
        ],
      },
    },
  ...
  es: {
    theme: 'Hardware Guides',
    heroImage: '/images/best-mini-pc-local-llm-japan-overview-hero-es.webp',
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: 'Mini PC vs Mac mini — ¿cuál es mejor para LLMs locales en Japón?',
            a: 'Apple renovó la gama Mac mini el 25 de agosto de 2026: el Mac mini M6 base (32 GB de memoria unificada máx.) parte de ¥149.800 en Japón (~€1.220) y sale a la venta el 22 de septiembre de 2026. Un Mac mini M5 Pro (64 GB máx.) parte de ¥299.800 (~€2.450) para más margen de memoria. Todavía no existen benchmarks independientes de inferencia LLM local para el M6 ni el M5 Pro — trata cualquier cifra en tok/s de estos chips como no verificada por ahora. El Beelink SER7 (~¥70.000) sigue siendo unos ¥80.000 más barato y ejecuta Ollama sin configuración. Compra el Mac mini M6 si tu presupuesto lo permite, usas macOS y quieres la generación más reciente de Apple Silicon; compra el Beelink SER7 si necesitas Windows, prefieres AMD/Vulkan, o quieres ahorrar ahora.',
          },
        ],
      },
    },
  ...
  pt: {
    theme: 'Hardware Guides',
    heroImage: '/images/best-mini-pc-local-llm-japan-overview-hero-pt.webp',
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: 'Mini PC vs Mac mini — qual é melhor para LLMs locais no Japão?',
            a: 'A Apple renovou a linha Mac mini em 25 de agosto de 2026: o Mac mini M6 básico (até 32 GB de memória unificada) parte de ¥149.800 no Japão (~R$ 7.490) e chega às lojas em 22 de setembro de 2026. Um Mac mini M5 Pro (até 64 GB) parte de ¥299.800 (~R$ 14.990) para mais memória. Ainda não existem benchmarks independentes de inferência de LLM local para o M6 ou o M5 Pro — trate qualquer número em tok/s desses chips como não verificado por enquanto. O Beelink SER7 (~¥70.000) continua cerca de ¥80.000 mais barato e roda o Ollama sem configuração. Compre o Mac mini M6 se o orçamento permitir, você usar macOS e quiser a geração mais recente da Apple Silicon; compre o Beelink SER7 se precisar do Windows, preferir AMD/Vulkan, ou quiser economizar agora.',
          },
        ],
      },
    },
  ...
  zh: {
    theme: 'Hardware Guides',
    heroImage: '/images/best-mini-pc-local-llm-japan-overview-hero-zh.webp',
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: '在日本，迷你电脑和Mac mini哪个更适合本地LLM？',
            a: '苹果于2026年8月25日更新了Mac mini产品线：入门款Mac mini M6（统一内存最高32GB）在日本起售价为¥149,800（约$899 USD），将于2026年9月22日上市。若需要更大内存，Mac mini M5 Pro（最高64GB）起售价为¥299,800（约$1,699 USD）。目前M6和M5 Pro尚无独立的本地LLM推理基准测试数据——这两款芯片的tok/s数字暂时应视为未经验证。Beelink SER7（约¥70,000）仍然便宜约¥80,000，且无需配置即可运行Ollama。如果预算充足、使用macOS并想要最新的Apple Silicon，请购买Mac mini M6；如果需要Windows、偏好AMD/Vulkan或想现在省钱，请购买Beelink SER7。',
          },
        ],
      },
    },
  ...
  ar: {
    theme: 'Hardware Guides',
    heroImage: '/images/best-mini-pc-local-llm-japan-overview-hero-ar.webp',
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: 'جهاز مصغر أم Mac mini — أيهما أفضل لنماذج اللغة الكبيرة المحلية في اليابان؟',
            a: 'حدّثت Apple تشكيلة Mac mini في 25 أغسطس 2026: يبدأ طراز Mac mini M6 الأساسي (بحد أقصى 32 جيجابايت ذاكرة موحدة) من ¥149,800 في اليابان (~$899 USD)، ويُطرح في 22 سبتمبر 2026. يبدأ طراز Mac mini M5 Pro (بحد أقصى 64 جيجابايت) من ¥299,800 (~$1,699 USD) لمن يحتاج ذاكرة أكبر. لا توجد بعد اختبارات أداء مستقلة لاستدلال نماذج اللغة المحلية على M6 أو M5 Pro — تعامل مع أي أرقام رمز/ثانية لهذه الشرائح على أنها غير موثقة حاليًا. يبقى Beelink SER7 (~¥70,000) أرخص بنحو ¥80,000 ويشغّل Ollama دون إعداد. اشترِ Mac mini M6 إذا سمحت ميزانيتك، وتستخدم macOS، وتريد أحدث جيل من Apple Silicon؛ اشترِ Beelink SER7 إذا كنت تحتاج Windows أو تفضّل AMD/Vulkan أو تريد توفير المال الآن.',
          },
        ],
      },
    },
  ...
  ko: {
    theme: 'Hardware Guides',
    heroImage: '/images/best-mini-pc-local-llm-japan-overview-hero-ko.webp',
    ...
    sections: {
      ...
      faq: {
        ...
        faqs: [
          ...
          {
            q: '미니 PC vs Mac mini — 일본에서 로컬 LLM에 어느 것이 더 좋습니까?',
            a: 'Apple은 2026년 8월 25일 Mac mini 라인업을 새로 선보였습니다. 기본 Mac mini M6(통합 메모리 최대 32GB)는 일본에서 ¥149,800부터 시작하며 2026년 9월 22일 출시됩니다. 더 많은 메모리가 필요하면 Mac mini M5 Pro(최대 64GB)가 ¥299,800부터 시작합니다. M6와 M5 Pro에 대한 독립적인 로컬 LLM 추론 벤치마크는 아직 없으므로, 이 칩들의 tok/s 수치는 현재로서는 검증되지 않은 것으로 간주해야 합니다. Beelink SER7(약 ¥70,000)은 여전히 약 ¥80,000 더 저렴하며 설정 없이 바로 Ollama를 실행합니다. 예산이 충분하고 macOS를 사용하며 최신 Apple Silicon을 원한다면 Mac mini M6를 구매하고, Windows가 필요하거나 AMD/Vulkan을 선호하거나 지금 비용을 절약하고 싶다면 Beelink SER7을 구매하세요.',
          },
        ],
      },
      relatedReading: {
