  ...
  fr: {
    ...
    sections: {
      ...
      body1: {
        ...
        content: [
          "**Le HB 1532 du Maryland, le Utility RELIEF Act, est la plus rapide des 8 lois d'État adoptées — elle comportait une clause d'urgence, donc elle est entrée en vigueur immédiatement à la signature plutôt qu'après un délai d'attente standard.** Le plafond standard est de 1 200 W, conforme au modèle majoritaire utilisé dans la plupart des États. Un seuil distinct de 391 W apparaît aussi dans le cadre réglementaire multi-États plus large, qui pourrait appliquer un traitement allégé aux appareils plus petits — vérifiez le mécanisme exact dans le texte législatif du Maryland avant de vous fier à cette distinction pour un appareil donné.",
      ...
      body2: {
        ...
        content: [
          "**La loi du Maryland, comme celle de chaque autre État, cite UL 3700 comme référence de sécurité, mais aucun système solaire enfichable complet n'a confirmé une certification complète à ce jour.** La norme a été publiée en décembre 2025, avec des tests débutant en janvier 2026 — un délai qui s'applique à l'échelle nationale. Le STREAM Ultra d'EcoFlow est le produit le plus proche du marché, mais il est actuellement vendu spécifiquement dans l'Utah, pas dans le Maryland.",
  ...
  ja: {
    ...
    sections: {
      ...
      body1: {
        ...
        content: [
          '**メリーランド州のHB 1532（Utility RELIEF Act）は、制定済みの8州の中で最も発効が早い法律です——緊急条項が付与されており、通常の待機期間を経ずに署名と同時に発効しました。** 標準的な上限は1,200Wで、大多数の制定州で使われているテンプレートと一致します。より広い複数州規制フレームワークには391Wの下位しきい値も別途登場し、小型機器に対してより軽い扱いを適用する可能性があります——特定の機器についてこの区別に依拠する前に、メリーランド州の法令原文で正確な仕組みを確認してください。',
      ...
      body2: {
        ...
        content: [
          '**メリーランド州の法律も、他の制定州と同様にUL 3700を安全基準として参照していますが、本稿執筆時点で完全なプラグイン型ソーラーシステムのフル認証取得が確認されたものはありません。** この規格は2025年12月に公開され、試験は2026年1月に開始されました——このギャップは全米共通です。EcoFlowのSTREAM Ultraが市場に最も近い製品ですが、現在の販売対象は特にユタ州であり、メリーランド州ではありません。',
  ...
  zh: {
    ...
    sections: {
      ...
      body1: {
        ...
        content: [
          '**马里兰州的HB 1532（公用事业救济法案）是已立法的8个州中生效速度最快的一部——该法案附带紧急条款，因此在签署后立即生效，而不是像通常那样经过标准等待期。** 标准上限为1,200W，与大多数已立法州采用的模板一致。更广泛的多州监管框架中还出现了单独的391W较低门槛，可能对较小设备适用更宽松的处理方式——在依赖这一区分处理具体设备之前，请以马里兰州法律原文核实具体机制。',
      ...
      body2: {
        title: '认证套件现在真的能买到吗？',
        content: [
          '**马里兰州的法律与其他所有已立法州一样，将UL 3700列为安全基准，但截至撰写本文时，尚无完整的插电式太阳能系统确认获得完整认证。** 该标准于2025年12月发布，测试于2026年1月启动——这一空档在全美范围内普遍存在。EcoFlow的STREAM Ultra是目前最接近上市的产品，但目前仅在犹他州而非马里兰州销售。',
  ...
  es: {
    ...
    sections: {
      ...
      body1: {
        ...
        content: [
          '**La HB 1532 de Maryland, la Utility RELIEF Act, es la más rápida en entrar en vigor de las 8 leyes estatales aprobadas: incluía una cláusula de emergencia, por lo que entró en vigor de inmediato al firmarse, en lugar de tras el período de espera estándar.** El límite estándar es de 1,200 W, coincidiendo con la plantilla que usan la mayoría de los estados con ley aprobada. También aparece un umbral separado de 391 W en el marco regulatorio multiestatal más amplio, que podría aplicar un trato más flexible a los dispositivos más pequeños — confirma el mecanismo exacto en el texto legal de Maryland antes de basarte en esta distinción para un dispositivo específico.',
      ...
      body2: {
        ...
        content: [
          '**La ley de Maryland, igual que la de cada estado con ley aprobada, hace referencia a UL 3700 como el estándar de seguridad, pero al momento de escribir esto ningún sistema solar enchufable completo confirma tener la certificación total.** El estándar se publicó en diciembre de 2025 y las pruebas comenzaron en enero de 2026 — un desfase que se aplica a nivel nacional. El STREAM Ultra de EcoFlow es el producto más cercano a llegar al mercado, pero actualmente se vende específicamente en Utah, no en Maryland.',
  ...
  pt: {
    ...
    sections: {
      ...
      body2: {
        ...
        content: [
          '**A lei de Maryland, assim como a de todos os outros estados com lei em vigor, faz referência à UL 3700 como o padrão de segurança, mas nenhum sistema solar plug-in completo confirmou certificação total até o momento desta publicação.** O padrão foi publicado em dezembro de 2025, com os testes começando em janeiro de 2026 — uma lacuna que se aplica em todo o país. O STREAM Ultra da EcoFlow é o produto mais próximo de chegar ao mercado, mas atualmente está à venda especificamente em Utah, não em Maryland.',
  ...
  ar: {
    ...
    sections: {
      ...
      body1: {
        ...
        content: [
          '**يُعد قانون HB 1532 في ماريلاند (Utility RELIEF Act) الأسرع سريانًا من بين قوانين الولايات الثماني المسنّة — إذ تضمّن بند طوارئ جعله يسري فورًا عند التوقيع بدلاً من انتظار الفترة المعتادة.** الحد الأقصى القياسي هو 1,200 واط، بما يتوافق مع النموذج المعتمد في غالبية الولايات المسنّة. كما تظهر عتبة فرعية منفصلة قدرها 391 واط في الإطار التنظيمي الأوسع بين الولايات، والتي قد تطبّق معاملة أخف على الأجهزة الأصغر — يُرجى التحقق من الآلية الدقيقة في نص التشريع الرسمي لماريلاند قبل الاعتماد على هذا التمييز لجهاز معين.',
  ...
  ko: {
    ...
    sections: {
      ...
      body2: {
        ...
        content: [
          '**메릴랜드주 법률도 다른 모든 시행 주와 마찬가지로 UL 3700을 안전 기준으로 참조하고 있지만, 이 글을 작성하는 시점까지 완전한 플러그인형 태양광 시스템 중 완전한 인증을 받은 제품은 확인되지 않았습니다.** 이 표준은 2025년 12월에 발표되었으며 시험은 2026년 1월에 시작되었습니다 — 이러한 공백은 전국적으로 동일하게 적용됩니다. EcoFlow의 STREAM Ultra가 시장 출시에 가장 근접한 제품이지만, 현재는 메릴랜드주가 아닌 유타주에서 구체적으로 판매되고 있습니다.',
