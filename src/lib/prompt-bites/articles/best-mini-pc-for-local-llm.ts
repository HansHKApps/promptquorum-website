...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: 'Best mini PCs for local LLMs: Minisforum UM790 Pro (AMD iGPU, 32 GB RAM) and Mac Mini M4 (fast, power-efficient). Both run 7–13B models without a discrete GPU.',
  ...
  de: {
    ...
    seoTitle: 'Mini-PC für lokale LLMs 2026 | Prompt Bites | PromptQuorum',
    metaDescription: 'Beste Mini-PCs für lokale LLMs: Minisforum UM790 Pro (AMD iGPU, 32 GB) und Mac Mini M4 (schnell, energieeffizient). Beide laufen 7–13B-Modelle ohne GPU.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  fr: {
    ...
    seoTitle: 'Mini PC pour LLM local 2026 | Prompt Bites | PromptQuorum',
    metaDescription: 'Mini PC pour LLM local : Minisforum UM790 Pro (iGPU AMD, 32 Go) et Mac Mini M4 (rapide, économe). Les deux tournent des modèles 7–13B sans GPU dédié.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  ja: {
    ...
    seoTitle: 'ローカルLLM最適ミニPC 2026 | Prompt Bites | PromptQuorum',
  ...
  zh: {
    ...
    seoTitle: '本地LLM最佳迷你PC推荐 2026 | Prompt Bites | PromptQuorum',
