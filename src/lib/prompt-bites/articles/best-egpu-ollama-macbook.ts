...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    current_hardware_mentioned: ['Apple Silicon MacBook', 'TinyGPU driver', 'NVIDIA RTX GPU'],
