...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: 'Yes — Ollama supports all Qwen 3 sizes from 0.6B to 72B. Run with: ollama run qwen3:8b. The 8B model needs ~6 GB VRAM. MoE variant available.',
  ...
  de: {
    ...
    metaDescription: 'Ja — Ollama unterstützt alle Qwen 3-Größen von 0,6B bis 72B. Befehl: ollama run qwen3:8b. Das 8B-Modell benötigt ~6 GB VRAM.',
    publishDate: '2026-05-18',
  ...
  fr: {
    ...
    metaDescription: 'Oui — Ollama supporte toutes les tailles de Qwen 3, de 0.6B à 72B. Lancez : ollama run qwen3:8b. Le modèle 8B nécessite ~6 Go de VRAM.',
    publishDate: '2026-05-18',
    dateModified: '2026-05-19',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
  ...
  ja: {
    ...
    metaDescription: 'はい — Ollama は Qwen 3 の 0.6B から 72B まで全サイズに対応しています。実行コマンド：ollama run qwen3:8b。8B モデルには ~6 GB VRAM が必要です。',
    publishDate: '2026-05-18',
    dateModified: '2026-05-19',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
  ...
  zh: {
    ...
    metaDescription: '可以——Ollama支持Qwen 3的全部规格，从0.6B到72B。运行命令：ollama run qwen3:8b。8B模型约需6 GB VRAM。',
    publishDate: '2026-05-18',
    dateModified: '2026-05-19',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
  ...
  pt: {
    ...
    metaDescription: 'Sim: Ollama suporta todos os tamanhos do Qwen 3, de 0,6B a 72B. Execute com: ollama run qwen3:8b. O modelo 8B precisa de ~6 GB de VRAM. Variante MoE disponível.',
    publishDate: '2026-05-18',
  ...
  es: {
    ...
    metaDescription: 'Sí: Ollama admite todos los tamaños de Qwen 3, de 0.6B a 72B. Ejecuta: ollama run qwen3:8b. El 8B necesita ~6 GB de VRAM. Variante MoE disponible.',
    publishDate: '2026-05-18',
  ...
  ko: {
    ...
    metaDescription: '예 — Ollama는 0.6B부터 72B까지 모든 Qwen 3 크기를 지원합니다. 실행 명령: ollama run qwen3:8b. 8B 모델은 Q4 양자화에서 VRAM 약 6 GB가 필요합니다.',
    publishDate: '2026-05-18',
