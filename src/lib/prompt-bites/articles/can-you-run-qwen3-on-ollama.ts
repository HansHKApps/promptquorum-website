...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  de: {
    ...
    seoTitle: 'Kann man Qwen 3 mit Ollama ausführen? | Prompt Bites | PromptQuorum',
    metaDescription: 'Ja — Ollama unterstützt alle Qwen 3-Größen von 0.6B bis 72B. Starten Sie mit: ollama run qwen3:8b. Das 8B-Modell benötigt ~6 GB VRAM. Kurze Antwort von PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  fr: {
    ...
    seoTitle: 'Peut-on exécuter Qwen 3 avec Ollama ? | Prompt Bites | PromptQuorum',
    metaDescription: 'Oui — Ollama supporte toutes les tailles de Qwen 3, de 0.6B à 72B. Lancez avec : ollama run qwen3:8b. Le modèle 8B nécessite ~6 Go de VRAM. Réponse rapide par PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  ja: {
    ...
    seoTitle: 'Qwen 3 は Ollama で動かせますか？ | Prompt Bites | PromptQuorum',
    metaDescription: 'はい — Ollama は Qwen 3 の 0.6B から 72B まで全サイズに対応しています。実行コマンド：ollama run qwen3:8b。8B モデルには ~6 GB VRAM が必要です。PromptQuorum による簡潔な回答。',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  zh: {
    ...
    seoTitle: '可以在Ollama上运行Qwen 3吗？| Prompt Bites | PromptQuorum',
    metaDescription: '可以——Ollama支持从0.6B到72B的所有Qwen 3规格。运行命令：ollama run qwen3:8b。8B模型需要约6 GB VRAM。PromptQuorum快速解答。',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
