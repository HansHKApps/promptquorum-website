    ...
    sections: {
      ...
      body1: {
        ...
        content: [
          ...
          '<strong>K-Quant funktioniert durch Clustering von Gewichten und Bit-Zuweisung basierend auf Wichtigkeit.</strong> Top-Wichtigkeits-Cluster erhalten 6 Bits pro Gewicht. Mittlere Cluster erhalten 4 Bits. Unwichtige Cluster erhalten 3 Bits. Die "M"-Stufe durchschnittlich 4,5 Bits pro Gewicht — was erklärt, warum Q4_K_M in Größe und Qualität zwischen Q4_K_S und Q5_K_M liegt. Für den Fall, dass die M-Stufe nicht ausreicht, siehe <a href="/prompt-bites/q4-k-m-vs-q8-0?lang=de" class="text-primary hover:underline">Q4_K_M vs. Q8_0</a>.',
        ],
      },
      body2: {
        ...
        content: [
          ...
          'Für einen direkten Vergleich von Q4_K_M vs. Q8_0, siehe den <a href="/prompt-bites/q4-k-m-vs-q8-0?lang=de" class="text-primary hover:underline">Q4_K_M vs. Q8_0 Entscheidungsleitfaden</a>. Für die vollständige Quantisierungsreferenz, siehe den <a href="/local-llms/quantization-levels-comparison?lang=de" class="text-primary hover:underline">Quantisierungsstufen-Vergleich</a>.',
        ],
        ...
        faqs: [
          {
            ...
            a: 'Nein. Q4_K_M verwendet K-Quant-Kompression, die 5–8 % Qualität gegenüber Q4_0 bei gleicher Bittiefe zurückgewinnt. Bevorzugen Sie immer Q4_K_M gegenüber Q4_0. Siehe den <a href="/prompt-bites/q4-k-m-vs-q8-0?lang=de" class="text-primary hover:underline">Q4_K_M vs. Q8_0 Leitfaden</a> für den Fall, dass Sie höher gehen möchten.',
          },
          {
    ...
    sections: {
      ...
      body2: {
        ...
        content: [
          ...
          'Pour une comparaison directe Q4_K_M vs Q8_0, voir le <a href="/prompt-bites/q4-k-m-vs-q8-0?lang=fr" class="text-primary hover:underline">guide de décision Q4_K_M vs Q8_0</a>. Pour la référence complète des quantisations, voir la <a href="/local-llms/quantization-levels-comparison?lang=fr" class="text-primary hover:underline">comparaison des niveaux de quantisation</a>.',
        ],
        ...
        faqs: [
          {
            ...
            a: 'Non. Q4_K_M utilise la compression k-quant qui récupère 5 à 8 % de qualité par rapport à Q4_0 à même profondeur de bits. Préférez toujours Q4_K_M à Q4_0. Voir le <a href="/prompt-bites/q4-k-m-vs-q8-0?lang=fr" class="text-primary hover:underline">guide Q4_K_M vs Q8_0</a> pour savoir quand monter en niveau.',
          },
          {
    ...
    sections: {
      ...
      body1: {
        ...
        content: [
          ...
          '<strong>K-Quantは重みをクラスタリングし、重要度に基づいてビットを割り当てます。</strong>最重要クラスターは重みあたり6ビットを取得します。中間クラスターは4ビットを取得します。低重要クラスターは3ビットを取得します。「M」ティアはモデル全体で重みあたり平均4.5ビット — これがQ4_K_MがQ4_K_SとQ5_K_Mの間のサイズと品質に位置する理由です。Mティアで不十分な場合は、<a href="/prompt-bites/q4-k-m-vs-q8-0?lang=ja" class="text-primary hover:underline">Q4_K_M vs Q8_0</a>を参照してください。',
        ],
      },
      body2: {
        ...
        content: [
          ...
          'Q4_K_MとQ8_0の直接比較については、<a href="/prompt-bites/q4-k-m-vs-q8-0?lang=ja" class="text-primary hover:underline">Q4_K_M vs Q8_0決定ガイド</a>を参照してください。完全な量化リファレンスについては、<a href="/local-llms/quantization-levels-comparison?lang=ja" class="text-primary hover:underline">量化レベル比較</a>を参照してください。',
        ],
      ...
      faq: {
        ...
        faqs: [
          {
            q: 'Q4_K_MはQ4_0と同じですか？',
            a: 'いいえ。Q4_K_MはK-Quant圧縮を使用しており、同じビット深度でQ4_0より5–8%品質を回復します。常にQ4_0よりQ4_K_Mを優先してください。高いレベルに上げる場合は<a href="/prompt-bites/q4-k-m-vs-q8-0?lang=ja" class="text-primary hover:underline">Q4_K_M vs Q8_0ガイド</a>を参照してください。',
          },
          {
    ...
    sections: {
      ...
      body1: {
        ...
        content: [
          ...
          '<strong>K-Quant通过对权重进行聚类并按重要性分配位数来工作。</strong>最重要的簇每个权重获得6位。中间级别的簇获得4位。低重要性的簇获得3位。「M」层的平均值为每权重4.5位——这解释了为什么Q4_K_M在大小和质量上都介于Q4_K_S和Q5_K_M之间。当M层不够用时，请参阅<a href="/prompt-bites/q4-k-m-vs-q8-0?lang=zh" class="text-primary hover:underline">Q4_K_M与Q8_0的对比</a>。',
        ],
      },
      body2: {
        ...
        content: [
          ...
          '关于Q4_K_M与Q8_0的直接比较，请参阅<a href="/prompt-bites/q4-k-m-vs-q8-0?lang=zh" class="text-primary hover:underline">Q4_K_M vs Q8_0决策指南</a>。完整的量化参考请查看<a href="/local-llms/quantization-levels-comparison?lang=zh" class="text-primary hover:underline">量化级别比较</a>。',
        ],
      ...
      faq: {
        ...
        faqs: [
          {
            q: 'Q4_K_M和Q4_0是一样的吗？',
            a: '不一样。Q4_K_M使用K-Quant压缩，在相同位深下比Q4_0恢复5–8%的质量。始终优先选择Q4_K_M而非Q4_0。何时需要更高格式请参阅<a href="/prompt-bites/q4-k-m-vs-q8-0?lang=zh" class="text-primary hover:underline">Q4_K_M vs Q8_0指南</a>。',
          },
          {
            q: '8 GB显存应该使用哪种量化？',
