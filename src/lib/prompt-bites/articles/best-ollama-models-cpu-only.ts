...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  de: {
    ...
    seoTitle: 'Die besten Ollama-Modelle nur für die CPU? | Prompt Bites | PromptQuorum',
    metaDescription: 'Ohne GPU ist Phi-4 Mini Q4 das beste CPU-only-Ollama-Modell. Llama 3 8B Q4 läuft mit 8+ GB RAM. Gemma 2B ist das schnellste. Kurze Antwort von PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-06-18',
    quickAnswerTop: {
  ...
  fr: {
    ...
    seoTitle: 'Meilleurs modèles Ollama en mode CPU uniquement ? | Prompt Bites | PromptQuorum',
    metaDescription: 'Sans GPU, Phi-4 Mini Q4 est le meilleur modèle Ollama CPU-only. Llama 3 8B Q4 fonctionne avec 8+ Go de RAM. Gemma 2B est le plus rapide. Réponse rapide par PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-06-18',
    quickAnswerTop: {
  ...
  ja: {
    ...
    seoTitle: 'CPU専用で使えるOllamaの最適モデルは？ | Prompt Bites | PromptQuorum',
    metaDescription: 'GPUなしの場合、Phi-4 Mini Q4がCPU専用の最適Ollamaモデルです。Llama 3 8B Q4は8GB以上のRAMで動作します。Gemma 2Bが最速。PromptQuorumによる簡潔な回答。',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-06-18',
    quickAnswerTop: {
  ...
  zh: {
    ...
    seoTitle: '仅用 CPU 运行 Ollama 的最佳模型？ | Prompt Bites | PromptQuorum',
    metaDescription: '没有 GPU？Phi-4 Mini Q4 是最佳纯 CPU Ollama 模型。Llama 3 8B Q4 需要 8GB 以上内存。Gemma 2B 速度最快。PromptQuorum 快速解答。',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-06-18',
    quickAnswerTop: {
