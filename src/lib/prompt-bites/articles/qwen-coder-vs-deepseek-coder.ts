...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    heroImage: '/images/qwen-coder-vs-deepseek-coder-overview-hero-en.webp',
    ...
    current_models_mentioned: ['Qwen2.5-Coder 14B', 'DeepSeek Coder V2'],
    ...
    quickAnswerTop: {
      en: {
        ...
        bullets: [
          'Qwen2.5-Coder 14B: top Python and TypeScript benchmark scores',
      ...
      de: {
        ...
        bullets: [
          'Qwen2.5-Coder 14B: beste Python- und TypeScript-Benchmark-Scores',
      ...
      fr: {
        ...
        bullets: [
          'Qwen2.5-Coder 14B : meilleurs scores Python et TypeScript',
      ...
      ja: {
        ...
        bullets: [
          'Qwen2.5-Coder 14B：PythonとTypeScriptのベンチマークスコアが最高',
      ...
      zh: {
        ...
        bullets: [
          'Qwen2.5-Coder 14B：Python 和 TypeScript 基准测试最高分',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B leads HumanEval by ~5 points among 14B coding models — best for Python and TypeScript',
      ...
      body1: {
        ...
        content: [
          '<strong>Qwen2.5-Coder 14B leads HumanEval by ~5 points among 14B coding models.</strong> The gap is consistent across Python-specific and TypeScript generation tasks, making Qwen the stronger choice for most web and backend developers.',
        ...
        rows: [
          { 'Model': 'Qwen2.5-Coder 14B', 'Python (HumanEval)': 'High-80s', 'Language Coverage': 'Python, TypeScript, Go' },
      ...
      body2: {
        ...
        content: [
          '<strong>Pick Qwen2.5-Coder 14B for Python and TypeScript-heavy projects, tool use, and function calling.</strong> Its benchmark lead translates directly to fewer wrong completions on the tasks most backend and frontend developers do daily.',
          ...
          'One workflow detail: Qwen2.5-Coder 14B has stronger native function calling support, which matters if you are building agents or structured-output pipelines that invoke external tools during code generation.',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Both support tool calling, but Qwen2.5-Coder 14B has stronger native function-calling support and more consistent structured output. If your pipeline uses tool calls heavily, Qwen is the safer choice.',
          },
        ],
      },
    },
  ...
  de: {
    theme: 'Tool Comparisons',
    heroImage: '/images/qwen-coder-vs-deepseek-coder-overview-hero-de.webp',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B führt HumanEval unter den 14B-Coding-Modellen mit ~5 Punkten an — beste Wahl für Python und TypeScript',
      ...
      body1: {
        ...
        content: [
          '<strong>Stand Mai 2026 führt Qwen2.5-Coder 14B den HumanEval unter den 14B-Coding-Modellen mit ~5 Punkten an.</strong> Der Vorsprung ist konsistent über Python-spezifische und TypeScript-Generierungsaufgaben hinweg und macht Qwen zur stärkeren Wahl für die meisten Web- und Backend-Entwickler.',
        ...
        rows: [
          { 'Modell': 'Qwen2.5-Coder 14B', 'Python (HumanEval)': 'High-80s', 'Sprachabdeckung': 'Python, TypeScript, Go' },
      ...
      body2: {
        ...
        content: [
          '<strong>Wählen Sie Qwen2.5-Coder 14B für Python- und TypeScript-lastige Projekte, Tool-Nutzung und Function Calling.</strong> Sein Benchmark-Vorsprung schlägt sich direkt in weniger falschen Vervollständigungen bei den Aufgaben nieder, die die meisten Backend- und Frontend-Entwickler täglich erledigen.',
          ...
          'Ein Workflow-Detail: Qwen2.5-Coder 14B hat stärkere native Function-Calling-Unterstützung, was wichtig ist, wenn Sie Agenten oder Structured-Output-Pipelines bauen, die externe Tools während der Code-Generierung aufrufen.',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Beide unterstützen Tool Calling, aber Qwen2.5-Coder 14B hat stärkere native Function-Calling-Unterstützung und konsistentere strukturierte Ausgaben. Wenn Ihre Pipeline Tool Calls intensiv nutzt, ist Qwen die sicherere Wahl.',
          },
        ],
      },
    },
  ...
  es: {
    theme: 'Tool Comparisons',
    heroImage: '/images/qwen-coder-vs-deepseek-coder-overview-hero-es.webp',
    ...
    quickAnswerTop: {
      es: {
        ...
        bullets: [
          'Qwen2.5-Coder 14B: mejores puntuaciones en benchmarks de Python y TypeScript',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B lidera HumanEval con ~5 puntos entre modelos de 14B — la mejor opción para Python y TypeScript',
      ...
      body1: {
        ...
        content: [
          '<strong>A partir de mayo de 2026, Qwen2.5-Coder 14B lidera HumanEval con ~5 puntos entre modelos de coding de 14B.</strong> La ventaja es consistente en tareas específicas de Python y generación de TypeScript, convirtiendo a Qwen en la opción más fuerte para la mayoría de desarrolladores web y backend.',
        ...
        rows: [
          { 'Modelo': 'Qwen2.5-Coder 14B', 'Python (HumanEval)': 'High-80s', 'Cobertura de lenguajes': 'Python, TypeScript, Go' },
      ...
      body2: {
        ...
        content: [
          '<strong>Elige Qwen2.5-Coder 14B para proyectos intensivos en Python y TypeScript, uso de tools y function calling.</strong> Su ventaja en benchmarks se traduce directamente en menos completaciones incorrectas en las tareas que la mayoría de desarrolladores backend y frontend hacen a diario.',
          ...
          'Un detalle del flujo de trabajo: Qwen2.5-Coder 14B tiene soporte nativo de function calling más fuerte, lo cual importa si estás construyendo agentes o pipelines de salida estructurada que invoquen herramientas externas durante la generación de código.',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Ambos soportan tool calling, pero Qwen2.5-Coder 14B tiene soporte nativo más fuerte para function calling y salida estructurada más consistente. Si tu pipeline usa tool calls intensivamente, Qwen es la opción más segura.',
          },
          {
            q: '¿Cuál modelo es mejor para desarrolladores de Python?',
            a: 'Qwen2.5-Coder 14B. Su ventaja de 5 puntos en HumanEval en tareas específicas de Python lo hace el mejor para desarrolladores que trabajan principalmente con Python. DeepSeek se destaca cuando necesitas soporte multilenguaje.',
          },
          {
  ...
  pt: {
    theme: 'Tool Comparisons',
    heroImage: '/images/qwen-coder-vs-deepseek-coder-overview-hero-pt.webp',
    ...
    quickAnswerTop: {
      pt: {
        ...
        bullets: [
          'Qwen2.5-Coder 14B: melhores pontuações em benchmarks de Python e TypeScript',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B lidera o HumanEval com ~5 pontos entre os modelos de codificação 14B — melhor opção para Python e TypeScript',
      ...
      body1: {
        ...
        content: [
          '<strong>Em maio de 2026, Qwen2.5-Coder 14B lidera o HumanEval com ~5 pontos entre os modelos de codificação 14B.</strong> A vantagem é consistente nas tarefas específicas de Python e geração de TypeScript, tornando Qwen a escolha mais forte para a maioria dos desenvolvedores web e backend.',
        ...
        rows: [
          { 'Modelo': 'Qwen2.5-Coder 14B', 'Python (HumanEval)': 'High-80s', 'Cobertura de linguagens': 'Python, TypeScript, Go' },
      ...
      body2: {
        ...
        content: [
          '<strong>Escolha Qwen2.5-Coder 14B para projetos intensivos em Python e TypeScript, uso de ferramentas e chamadas de função.</strong> Sua vantagem no benchmark se traduz diretamente em menos complementações incorretas nas tarefas que a maioria dos desenvolvedores backend e frontend faz diariamente.',
          ...
          'Um detalhe de fluxo de trabalho: Qwen2.5-Coder 14B tem suporte nativo mais forte para chamadas de função, o que importa se você está construindo agentes ou pipelines de saída estruturada que invocam ferramentas externas durante a geração de código.',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Ambos suportam chamadas de ferramentas, mas Qwen2.5-Coder 14B tem suporte nativo mais forte para chamadas de função e saída estruturada mais consistente. Se seu pipeline usa chamadas de ferramentas intensivamente, Qwen é a escolha mais segura.',
          },
        ],
      },
    },
  ...
  fr: {
    theme: 'Tool Comparisons',
    heroImage: '/images/qwen-coder-vs-deepseek-coder-overview-hero-fr.webp',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B mène HumanEval d\'environ 5 points parmi les modèles de coding 14B — le meilleur choix pour Python et TypeScript',
      ...
      body1: {
        ...
        content: [
          '<strong>En mai 2026, Qwen2.5-Coder 14B mène HumanEval d\'environ 5 points parmi les modèles de coding 14B.</strong> L\'écart est cohérent sur les tâches Python-spécifiques et de génération TypeScript, faisant de Qwen le choix plus fort pour la plupart des développeurs web et backend.',
        ...
        rows: [
          { 'Modèle': 'Qwen2.5-Coder 14B', 'Python (HumanEval)': 'High-80s', 'Couverture des langages': 'Python, TypeScript, Go' },
      ...
      body2: {
        ...
        content: [
          ...
          'Un détail de flux de travail : Qwen2.5-Coder 14B dispose d\'une prise en charge native plus forte du Function Calling, ce qui compte si vous construisez des agents ou des pipelines à sortie structurée qui invoquent des outils externes pendant la génération de code.',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'Les deux prennent en charge le Tool Calling, mais Qwen2.5-Coder 14B dispose d\'une prise en charge native du Function Calling plus forte et d\'une sortie structurée plus cohérente. Si votre pipeline utilise intensivement les Tool Calls, Qwen est le choix plus sûr.',
          },
        ],
      },
    },
  ...
  ja: {
    theme: 'Tool Comparisons',
    heroImage: '/images/qwen-coder-vs-deepseek-coder-overview-hero-ja.webp',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14BはHumanEvalで14BコーディングモデルのなかでリードしHigh-80sを達成 — PythonとTypeScriptに最適',
      ...
      body1: {
        title: 'ベンチマークの数値',
        content: [
          '<strong>2026年5月時点で、Qwen2.5-Coder 14BはHumanEvalで14BコーディングモデルのなかでHigh-80sをマークしてリードしています。</strong> その差はPython固有とTypeScript生成タスク全般にわたって一貫しており、Qwenはほとんどのウェブおよびバックエンド開発者にとってより強い選択肢となっています。',
        ...
        rows: [
          { 'モデル': 'Qwen2.5-Coder 14B', 'Python (HumanEval)': 'High-80s', '言語カバレッジ': 'Python, TypeScript, Go' },
      ...
      body2: {
        title: 'ワークフロー別の選び方',
        content: [
          '<strong>PythonとTypeScriptが多いプロジェクト、ツール使用、Function CallingにはQwen2.5-Coder 14Bを選んでください。</strong> そのベンチマーク上のリードは、ほとんどのバックエンドおよびフロントエンド開発者が日常的に行うタスクでの誤った補完の減少に直結します。',
          ...
          'ワークフローの詳細として：Qwen2.5-Coder 14BはネイティブのFunction Callingサポートが強力で、コード生成中に外部ツールを呼び出すエージェントや構造化出力パイプラインを構築する場合に重要です。',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: '両者ともTool Callingをサポートしていますが、Qwen2.5-Coder 14Bはネイティブのfunction-callingサポートが強力で、構造化出力がより一貫しています。パイプラインでTool Callsを多用する場合、Qwenがより安全な選択です。',
          },
        ],
      },
    },
  ...
  zh: {
    theme: 'Tool Comparisons',
    heroImage: '/images/qwen-coder-vs-deepseek-coder-overview-hero-zh.webp',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B 在14B编程模型中领跑 HumanEval，领先约5分——Python 和 TypeScript 最佳选择',
      ...
      body1: {
        title: '基准测试数据',
        content: [
          '<strong>截至2026年5月，Qwen2.5-Coder 14B 在14B编程模型中以约5分的优势领跑 HumanEval。</strong>这一差距在 Python 专项和 TypeScript 生成任务中保持一致，使 Qwen 成为大多数 Web 和后端开发者的更强选择。',
        ...
        rows: [
          { '模型': 'Qwen2.5-Coder 14B', 'Python (HumanEval)': 'High-80s', '语言覆盖': 'Python, TypeScript, Go' },
      ...
      body2: {
        title: '按工作流程选择',
        content: [
          '<strong>Python 和 TypeScript 密集型项目、工具使用和 Function Calling 选择 Qwen2.5-Coder 14B。</strong>其基准优势直接转化为大多数后端和前端开发者日常任务中更少的错误补全。',
          ...
          '一个工作流细节：Qwen2.5-Coder 14B 具有更强的原生 Function Calling 支持，如果您正在构建在代码生成过程中调用外部工具的智能体或结构化输出管道，这一点至关重要。',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: '两者均支持 Tool Calling，但 Qwen2.5-Coder 14B 具有更强的原生 Function Calling 支持和更一致的结构化输出。如果您的管道大量使用 Tool Calls，Qwen 是更安全的选择。',
          },
        ],
      },
    },
  ...
  ar: {
    theme: 'Tool Comparisons',
    heroImage: '/images/qwen-coder-vs-deepseek-coder-overview-hero-ar.webp',
    title: '⁨Qwen Coder⁩ مقابل ⁨DeepSeek Coder⁩: أيهما أفضل؟',
    seoTitle: '⁨Qwen Coder⁩ مقابل ⁨DeepSeek Coder⁩: أيهما أفضل؟',
    metaDescription: '⁨Qwen2.5-Coder 14B⁩ يتفوق في ⁨HumanEval⁩ بـ ⁨5⁩ نقاط على ⁨DeepSeek Coder V2⁩. كلاهما يعمل على ⁨RTX 3060⁩ بـ ~⁨10 GB VRAM. Python⁩ و ⁨TypeScript⁩: ⁨Qwen⁩ يفوز.',
    publishDate: '2026-05-18',
    dateModified: '2026-06-20',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    ...
    quickAnswerTop: {
      ar: {
        ...
        bullets: [
          'Qwen2.5-Coder 14B: أعلى درجات في معايير Python و TypeScript',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'يتقدم Qwen2.5-Coder 14B في HumanEval بحوالي 5 نقاط بين نماذج البرمجة 14B — الأفضل لـ Python و TypeScript',
      ...
      body1: {
        ...
        content: [
          '<strong>اعتبارًا من مايو 2026، يتقدم Qwen2.5-Coder 14B في HumanEval بحوالي 5 نقاط بين نماذج البرمجة 14B.</strong> الفارق متسق عبر مهام Python المحددة وتوليد TypeScript، مما يجعل Qwen الاختيار الأقوى لمعظم مطوري الويب والخلفية.',
        ...
        rows: [
          { 'النموذج': 'Qwen2.5-Coder 14B', 'Python (HumanEval)': 'High-80s', 'تغطية اللغات': 'Python, TypeScript, Go' },
      ...
      body2: {
        ...
        content: [
          '<strong>اختر Qwen2.5-Coder 14B للمشاريع الثقيلة في Python و TypeScript، واستخدام الأدوات، و Function Calling.</strong> تترجم ميزته في المعايير مباشرةً إلى إتمام ات خاطئة أقل في المهام التي يؤديها معظم مطوري الخلفية والواجهة الأمامية يوميًا.',
          ...
          'تفصيل في سير العمل: يمتلك Qwen2.5-Coder 14B دعمًا أصليًا أقوى لـ Function Calling، وهو ما يهم إذا كنت تبني وكلاء أو خطوط عمل للمخرجات المنظمة التي تستدعي أدوات خارجية أثناء توليد الكود.',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: 'كلاهما يدعم استدعاء الأدوات، لكن Qwen2.5-Coder 14B يمتلك دعمًا أصليًا أقوى لـ Function Calling ومخرجات منظمة أكثر اتساقًا. إذا كان خط عملك يستخدم استدعاءات الأدوات بكثافة، فـ Qwen هو الخيار الأكثر أمانًا.',
          },
          {
            q: 'أي نموذج أفضل لمطوري Python؟',
            a: 'Qwen2.5-Coder 14B. تجعله ميزته البالغة 5 نقاط في HumanEval في مهام Python المحددة الأفضل للمطورين الذين يعملون بشكل أساسي بـ Python. يتفوق DeepSeek حين تحتاج إلى دعم متعدد اللغات.',
          },
          {
            q: 'ما حجم كل نموذج؟',
  ...
  ko: {
    theme: 'Tool Comparisons',
    heroImage: '/images/qwen-coder-vs-deepseek-coder-overview-hero-ko.webp',
    title: 'Qwen Coder 대 DeepSeek Coder: 어느 것이 더 낫습니까?',
    seoTitle: 'Qwen Coder 대 DeepSeek Coder 비교 | Prompt Bites | PromptQuorum',
    metaDescription: 'Qwen2.5-Coder 14B는 Python 및 TypeScript에서 HumanEval을 약 5점 차로 앞섭니다. 두 모델 모두 RTX 3060에서 ~10 GB VRAM으로 실행됩니다. PromptQuorum의 빠른 답변.',
    publishDate: '2026-05-18',
    dateModified: '2026-06-12',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    ...
    quickAnswerTop: {
      ko: {
        ...
        bullets: [
          'Qwen2.5-Coder 14B: Python 및 TypeScript 벤치마크 최고 점수',
    ...
    schema: {
      inLanguage: 'ko',
      articleUrl: '[www.promptquorum.com/ko/prompt-bites/qwen-coder-vs-deepseek-coder](https://www.promptquorum.com/ko/prompt-bites/qwen-coder-vs-deepseek-coder)',
      imageUrl: '[www.promptquorum.com/api/og/qwen-coder-vs-deepseek-coder?lang=ko](https://www.promptquorum.com/api/og/qwen-coder-vs-deepseek-coder?lang=ko)',
    },
    breadcrumbSchema: {
      items: [
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B는 14B 코딩 모델 중 HumanEval에서 약 5점 차로 선두 — Python 및 TypeScript에 최적',
        ...
        snippetBlocks: [
          { type: 'one-sentence', text: 'Qwen2.5-Coder 14B는 Python 및 TypeScript 벤치마크에서 DeepSeek Coder V2를 앞서며, DeepSeek은 더 광범위한 언어 지원을 제공합니다.' },
          { type: 'plain-terms', text: 'Python이나 TypeScript를 주로 사용하는 개발자라면 Qwen2.5-Coder 14B를 선택하십시오. 여러 언어를 혼합하여 사용한다면 DeepSeek Coder V2가 더 적합합니다.' },
        ],
      },
      body1: {
        title: '벤치마크 수치',
        content: [
          '<strong>2026년 5월 기준, Qwen2.5-Coder 14B는 14B 코딩 모델 중 HumanEval에서 약 5점 차로 선두를 유지하고 있습니다.</strong> 이 차이는 Python 특화 작업과 TypeScript 생성 작업 전반에 걸쳐 일관되게 나타나며, 대부분의 웹 및 백엔드 개발자에게 Qwen이 더 강력한 선택이 됩니다.',
        ...
        rows: [
          { '모델': 'Qwen2.5-Coder 14B', 'Python (HumanEval)': 'High-80s', '언어 지원 범위': 'Python, TypeScript, Go' },
      ...
      body2: {
        ...
        content: [
          '<strong>Python 및 TypeScript 집약적 프로젝트, 도구 사용, Function Calling에는 Qwen2.5-Coder 14B를 선택하십시오.</strong> 벤치마크 우위가 대부분의 백엔드 및 프론트엔드 개발자가 일상적으로 수행하는 작업에서 잘못된 완성을 줄이는 것으로 직결됩니다.',
          ...
          '워크플로 세부 사항: Qwen2.5-Coder 14B는 네이티브 Function Calling 지원이 더 강력하여 코드 생성 중 외부 도구를 호출하는 에이전트나 구조화된 출력 파이프라인을 구축하는 경우 중요합니다.',
      ...
      faq: {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: '두 모델 모두 Tool Calling을 지원하지만, Qwen2.5-Coder 14B는 더 강력한 네이티브 Function Calling 지원과 더 일관된 구조화 출력을 제공합니다. 파이프라인에서 Tool Call을 집중적으로 사용하는 경우 Qwen이 더 안전한 선택입니다.',
          },
          {
            q: 'Python 개발자에게는 어느 모델이 더 낫습니까?',
            a: 'Qwen2.5-Coder 14B입니다. Python 특화 작업에서의 5점 HumanEval 우위 덕분에 주로 Python을 사용하는 개발자에게 최선입니다. 다중 언어 지원이 필요할 때는 DeepSeek이 두각을 나타냅니다.',
          },
          {
            q: '각 모델의 크기는 얼마입니까?',
