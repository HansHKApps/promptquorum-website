...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    seoTitle: 'CO-STAR Prompt Framework Guide | Prompt Bites | PromptQuorum',
    metaDescription: 'CO-STAR is a prompt framework: Context, Objective, Style, Tone, Audience, Response. It structures prompts for consistent, targeted LLM output.',
  ...
  de: {
    ...
    seoTitle: 'CO-STAR: Prompt-Framework | Prompt Bites | PromptQuorum',
    metaDescription: 'CO-STAR ist ein Prompt-Framework: Context, Objective, Style, Tone, Audience, Response. Es strukturiert Prompts für konsistente, zielgerichtete LLM-Ausgaben.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  fr: {
    ...
    metaDescription: 'CO-STAR est un framework de prompt : Context, Objective, Style, Tone, Audience, Response. Il structure les prompts pour des sorties LLM cohérentes et ciblées.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  zh: {
    ...
    seoTitle: 'CO-STAR 提示框架：结构与应用 | Prompt Bites | PromptQuorum',
