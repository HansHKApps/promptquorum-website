...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    seoTitle: 'CO-STAR Prompt Framework Explained | Prompt Bites | PromptQuorum',
    metaDescription: 'CO-STAR is a prompt framework: Context, Objective, Style, Tone, Audience, Response. It structures prompts for consistent, targeted LLM output. Quick answer from PromptQuorum.',
    ...
    sections: {
      ...
      body1: {
        title: 'What Each CO-STAR Component Does',
        content: [
          '<strong>CO-STAR is a six-component prompt structure that covers every variable a language model needs to produce targeted, consistent output: the background situation, the task, the desired writing style, the emotional tone, the intended reader, and the required output format.</strong> Using all six components eliminates the most common source of misaligned responses — missing context.',
        ...
        columns: ['Component', 'Question It Answers', 'Example'],
        rows: [
          { 'Component': 'Context', 'Question It Answers': 'What is the situation?', 'Example': 'You are summarizing a legal contract for a non-lawyer' },
          { 'Component': 'Objective', 'Question It Answers': 'What must be produced?', 'Example': 'Write a 3-bullet summary of key obligations' },
          { 'Component': 'Style', 'Question It Answers': 'How should it be written?', 'Example': 'Plain language, no jargon' },
          { 'Component': 'Tone', 'Question It Answers': 'What is the emotional register?', 'Example': 'Neutral and informative' },
          { 'Component': 'Audience', 'Question It Answers': 'Who will read this?', 'Example': 'Small business owner with no legal background' },
          { 'Component': 'Response', 'Question It Answers': 'What is the output format?', 'Example': 'Bulleted list, max 3 items' },
        ],
      },
      body2: {
        title: 'When to Use CO-STAR vs. Simpler Prompts',
        content: [
          ...
          'For a deeper look at prompt patterns that pair well with CO-STAR, see the <a href="/prompt-engineering/co-star-framework" class="text-primary hover:underline">full CO-STAR prompt engineering guide</a> covering advanced examples and common failure modes.',
        ],
      },
      faq: {
        id: 'faq',
  ...
  de: {
    ...
    seoTitle: 'CO-STAR-Prompt-Framework erklärt | Prompt Bites | PromptQuorum',
    metaDescription: 'CO-STAR ist ein Prompt-Framework: Context, Objective, Style, Tone, Audience, Response. Es strukturiert Prompts für konsistente, zielgerichtete LLM-Ausgaben. Kurze Antwort von PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  fr: {
    ...
    seoTitle: 'Framework CO-STAR expliqué | Prompt Bites | PromptQuorum',
    metaDescription: 'CO-STAR est un framework de prompt : Context, Objective, Style, Tone, Audience, Response. Il structure les prompts pour des sorties LLM cohérentes et ciblées. Réponse rapide par PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  ja: {
    ...
    seoTitle: 'CO-STARプロンプトフレームワーク解説 | Prompt Bites | PromptQuorum',
    metaDescription: 'CO-STARはプロンプトフレームワーク：Context、Objective、Style、Tone、Audience、Response。一貫した目的に合ったLLM出力のためにプロンプトを構造化します。PromptQuorumによる簡潔な回答。',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  zh: {
    ...
    seoTitle: 'CO-STAR 提示框架详解 | Prompt Bites | PromptQuorum',
    metaDescription: 'CO-STAR 是一个提示框架：Context、Objective、Style、Tone、Audience、Response。它为一致的、有针对性的 LLM 输出构建提示结构。PromptQuorum 快速解答。',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
