...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    heroImage: '/images/cheapest-way-to-run-70b-model-locally-overview-hero-en.png',
    type: 'comparison',
  ...
  de: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Hardware & Performance',
    heroImage: '/images/cheapest-way-to-run-70b-model-locally-overview-hero-de.png',
    type: 'comparison',
  ...
  fr: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Hardware & Performance',
    heroImage: '/images/cheapest-way-to-run-70b-model-locally-overview-hero-fr.png',
    type: 'comparison',
  ...
  ja: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Hardware & Performance',
    heroImage: '/images/cheapest-way-to-run-70b-model-locally-overview-hero-ja.png',
    type: 'comparison',
  ...
  es: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Hardware & Performance',
    heroImage: '/images/cheapest-way-to-run-70b-model-locally-overview-hero-es.png',
    type: 'comparison',
  ...
  zh: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Hardware & Performance',
    heroImage: '/images/cheapest-way-to-run-70b-model-locally-overview-hero-zh.png',
    type: 'comparison',
  ...
  pt: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Hardware & Performance',
    heroImage: '/images/cheapest-way-to-run-70b-model-locally-overview-hero-pt.png',
    type: 'comparison',
  ...
  ar: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Hardware & Performance',
    heroImage: '/images/cheapest-way-to-run-70b-model-locally-overview-hero-ar.png',
    type: 'comparison',
  ...
  ko: {
    ...
    next_refresh_due: '2026-11-26',
    theme: 'Hardware & Performance',
    heroImage: '/images/cheapest-way-to-run-70b-model-locally-overview-hero-ko.png',
    type: 'comparison',
