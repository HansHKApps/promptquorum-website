...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  ar: {
    ...
    metaDescription: 'ElevenLabs الأفضل سحابياً بـ 5 دولار/شهر؛ Kokoro-82M مجاني محلي يعمل على CPU بجودة شبه احترافية. Piper وCoqui XTTS بديلان محليان مجانيان.',
    educationalLevel: 'Beginner',
    affiliateDisclosure: true,
    publishDate: '2026-05-26',
