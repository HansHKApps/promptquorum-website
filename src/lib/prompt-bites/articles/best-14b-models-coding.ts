...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: 'Qwen2.5-Coder 14B: 78% HumanEval, 10 GB VRAM. DeepSeek-Coder-V2-Lite: 75%. StarCoder2 15B: 73% at 10 GB. Quick answer from PromptQuorum.',
    heroImage: '/images/best-14b-models-coding-humaneval-comparison-hero-en.webp',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    current_models_mentioned: ['Qwen2.5-Coder 14B', 'DeepSeek-Coder-V2-Lite'],
    ...
    quickAnswerTop: {
      en: {
        ...
        answer: 'Qwen2.5-Coder 14B is the top 14B coding model for local use, scoring 78.4% on HumanEval and running in 10 GB VRAM at Q4_K_M quantization. It fits in 10 GB VRAM at Q4_K_M and scores highest on HumanEval among 14B models. DeepSeek-Coder-V2-Lite is a strong alternative with similar VRAM requirements.',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M: ~10 GB VRAM, top HumanEval score',
          'DeepSeek-Coder-V2-Lite: strong alternative, similar VRAM footprint',
      ...
      de: {
        ...
        answer: 'Qwen2.5-Coder 14B ist das beste 14B-Coding-Modell für den lokalen Einsatz, mit 78,4% HumanEval-Score und 10 GB VRAM bei Q4_K_M-Quantisierung. Es passt mit Q4_K_M in 10 GB VRAM und erzielt den höchsten HumanEval-Score unter den 14B-Modellen. DeepSeek-Coder-V2-Lite ist eine starke Alternative mit ähnlichem VRAM-Bedarf.',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M: ~10 GB VRAM, bester HumanEval-Score',
          'DeepSeek-Coder-V2-Lite: starke Alternative, ähnlicher VRAM-Bedarf',
      ...
      fr: {
        ...
        answer: 'Qwen2.5-Coder 14B est le meilleur modèle de coding 14B pour une utilisation locale, avec un score HumanEval de 78,4% et 10 Go de VRAM en Q4_K_M. Il tient en 10 Go de VRAM en Q4_K_M et obtient le meilleur score HumanEval parmi les modèles 14B. DeepSeek-Coder-V2-Lite est une alternative solide avec des besoins en VRAM similaires.',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M : ~10 Go de VRAM, meilleur score HumanEval',
          'DeepSeek-Coder-V2-Lite : alternative solide, empreinte VRAM similaire',
      ...
      ja: {
        ...
        answer: 'Qwen2.5-Coder 14Bはローカル利用の14Bコーディングモデルの中でトップで、HumanEvalで78.4%を達成し、Q4_K_M量子化で10 GB VRAMで動作します。Q4_K_Mで10 GB VRAMに収まり、14Bモデル中でHumanEvalスコアが最高です。DeepSeek-Coder-V2-Liteは同様のVRAM要件を持つ強力な代替モデルです。',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M：~10 GB VRAM、最高のHumanEvalスコア',
          'DeepSeek-Coder-V2-Lite：強力な代替、同様のVRAM使用量',
      ...
      zh: {
        ...
        answer: 'Qwen2.5-Coder 14B 是本地使用的最佳14B编程模型，HumanEval 得分78.4%，Q4_K_M 量化仅需10 GB VRAM。Q4_K_M量化后仅需10 GB VRAM，在14B模型中 HumanEval 得分最高。DeepSeek-Coder-V2-Lite 是 VRAM 需求相近的有力替代。',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M：~10 GB VRAM，HumanEval 最高分',
          'DeepSeek-Coder-V2-Lite：有力替代，VRAM 需求相近',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B Q4_K_M uses ~10 GB VRAM and achieves the highest HumanEval score among local 14B coding models',
          'DeepSeek-Coder-V2-Lite is a competitive alternative that scores within 3 points of Qwen on most code benchmarks',
      ...
      body1: {
        title: 'Qwen2.5-Coder 14B Leads on HumanEval',
        content: [
          '<strong>Qwen2.5-Coder 14B at Q4_K_M quantization scores 78.4% on HumanEval — the highest of any 14B model available through Ollama or llama.cpp.</strong> The model was fine-tuned on over 5 trillion tokens of code-focused data, which distinguishes its performance on multi-step completion and test-case generation.',
          'DeepSeek-Coder-V2-Lite scores 75.1% on HumanEval under identical Q4_K_M conditions. The gap is small enough that DeepSeek Coder is a valid choice, particularly if you already have it cached or are familiar with its output style.',
        ...
        rows: [
          { 'Model': 'Qwen2.5-Coder 14B', 'HumanEval': '78.4%', 'VRAM (Q4_K_M)': '~10 GB' },
          { 'Model': 'DeepSeek-Coder-V2-Lite', 'HumanEval': '75.1%', 'VRAM (Q4_K_M)': '~10 GB' },
          { 'Model': 'StarCoder2 15B', 'HumanEval': '~73%', 'VRAM (Q4_K_M)': '~10 GB' },
        ],
        image: '/images/best-14b-models-coding-humaneval-comparison-hero-en.webp',
        imageCaption: 'Best 14B Models for Coding -- HumanEval and VRAM (Q4_K_M)',
      },
      body2: {
        title: 'VRAM Headroom Determines Which to Pick',
        content: [
          'Both Qwen2.5-Coder 14B and DeepSeek-Coder-V2-Lite require approximately 10 GB VRAM at Q4_K_M, leaving only 2 GB headroom on a 12 GB card. <strong>This margin is tight for long-context sessions: at 8k context, VRAM usage climbs to ~11.5 GB.</strong> If your workflow involves large files, prefer a card with 16+ GB.',
        ...
        image: '/images/best-14b-models-coding-vram-headroom-hero-en.webp',
      ...
      faq: {
        ...
        faqs: [
          {
            q: 'Can Qwen2.5-Coder 14B run on 8 GB VRAM?',
            a: 'Not reliably. At Q4_K_M the model requires ~10 GB VRAM. You could use Q3_K_M to squeeze it into 8 GB, but the quality drop is noticeable. A better option for 8 GB VRAM is Qwen2.5-Coder 7B or DeepSeek Coder 7B.',
          },
          {
            q: 'How does Qwen2.5-Coder 14B compare to DeepSeek-Coder-V2-Lite on real tasks?',
  ...
  de: {
    ...
    metaDescription: 'Qwen2.5-Coder 14B: 78% HumanEval, 10 GB VRAM. DeepSeek-Coder-V2-Lite: 75%. StarCoder2 15B: 73%. Schnelle Antwort von PromptQuorum.',
    heroImage: '/images/best-14b-models-coding-humaneval-comparison-hero-de.webp',
    publishDate: '2026-05-18',
    ...
    quickAnswerTop: {
      de: {
        question: 'Bestes 14B-Modell für Coding?',
        answer: 'Qwen2.5-Coder 14B ist das beste 14B-Coding-Modell für den lokalen Einsatz. Es passt mit Q4_K_M in 10 GB VRAM und erzielt den höchsten HumanEval-Score unter den 14B-Modellen. DeepSeek-Coder-V2-Lite ist eine starke Alternative mit ähnlichem VRAM-Bedarf.',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M: ~10 GB VRAM, bester HumanEval-Score',
          'DeepSeek-Coder-V2-Lite: starke Alternative, ähnlicher VRAM-Bedarf',
          'Beide übertreffen generische 14B-Modelle bei Code-Vervollständigung und Debugging',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B Q4_K_M benötigt ~10 GB VRAM und erreicht den höchsten HumanEval-Score unter lokalen 14B-Coding-Modellen',
          'DeepSeek-Coder-V2-Lite ist eine wettbewerbsfähige Alternative, die auf den meisten Code-Benchmarks nur 3 Punkte zurückliegt',
      ...
      body1: {
        title: 'Qwen2.5-Coder 14B führt beim HumanEval',
        content: [
          '<strong>Stand Mai 2026 erzielt Qwen2.5-Coder 14B in der Q4_K_M-Quantisierung 78,4 % auf HumanEval — der höchste Wert aller 14B-Modelle, die über Ollama oder llama.cpp verfügbar sind.</strong> Das Modell wurde auf über 5 Billionen Code-fokussierten Tokens feinabgestimmt, was seine Leistung bei mehrstufiger Vervollständigung und Testfall-Generierung erklärt.',
          'DeepSeek-Coder-V2-Lite erzielt unter identischen Q4_K_M-Bedingungen 75,1 % auf HumanEval. Der Unterschied ist gering genug, dass DeepSeek Coder eine valide Wahl ist — insbesondere wenn das Modell bereits gecacht ist oder Sie mit seinem Ausgabestil vertraut sind.',
      ...
      body2: {
        ...
        image: '/images/best-14b-models-coding-vram-headroom-hero-de.webp',
      ...
      faq: {
        ...
        faqs: [
          {
            q: 'Kann Qwen2.5-Coder 14B mit 8 GB VRAM betrieben werden?',
            a: 'Nicht zuverlässig. Bei Q4_K_M benötigt das Modell ~10 GB VRAM. Mit Q3_K_M könnte es in 8 GB passen, aber der Qualitätsabfall ist spürbar. Eine bessere Option für 8 GB VRAM ist Qwen2.5-Coder 7B oder DeepSeek Coder 7B.',
          },
          {
            q: 'Wie verhalten sich Qwen2.5-Coder 14B und DeepSeek-Coder-V2-Lite bei realen Aufgaben?',
  ...
  fr: {
    ...
    metaDescription: 'Qwen2.5-Coder 14B : 78% HumanEval, 10 Go VRAM. DeepSeek-Coder-V2-Lite : 75%. StarCoder2 15B : 73%. Réponse rapide de PromptQuorum.',
    heroImage: '/images/best-14b-models-coding-humaneval-comparison-hero-fr.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
      fr: {
        question: 'Meilleur modèle 14B pour le coding ?',
        answer: 'Qwen2.5-Coder 14B est le meilleur modèle de coding 14B pour une utilisation locale. Il tient en 10 Go de VRAM en Q4_K_M et obtient le meilleur score HumanEval parmi les modèles 14B. DeepSeek-Coder-V2-Lite est une alternative solide avec des besoins en VRAM similaires.',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M : ~10 Go de VRAM, meilleur score HumanEval',
          'DeepSeek-Coder-V2-Lite : alternative solide, empreinte VRAM similaire',
          'Les deux surpassent les modèles 14B génériques sur la complétion de code et le débogage',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B Q4_K_M utilise ~10 Go de VRAM et atteint le meilleur score HumanEval parmi les modèles de coding 14B locaux',
          'DeepSeek-Coder-V2-Lite est une alternative compétitive, à moins de 3 points de Qwen sur la plupart des benchmarks de code',
      ...
      body1: {
        title: 'Qwen2.5-Coder 14B en tête sur HumanEval',
        content: [
          '<strong>En mai 2026, Qwen2.5-Coder 14B en quantification Q4_K_M obtient 78,4 % sur HumanEval — le meilleur score de tout modèle 14B disponible via Ollama ou llama.cpp.</strong> Le modèle a été affiné sur plus de 5 000 milliards de tokens de données axées sur le code, ce qui explique ses performances sur la complétion multi-étapes et la génération de cas de test.',
          'DeepSeek-Coder-V2-Lite obtient 75,1 % sur HumanEval dans des conditions Q4_K_M identiques. L\'écart est suffisamment faible pour que DeepSeek Coder reste un choix valide, notamment si vous l\'avez déjà en cache ou que vous êtes habitué à son style de sortie.',
      ...
      body2: {
        ...
        image: '/images/best-14b-models-coding-vram-headroom-hero-fr.webp',
      ...
      faq: {
        ...
        faqs: [
          {
            q: 'Qwen2.5-Coder 14B peut-il fonctionner avec 8 Go de VRAM ?',
            a: 'Pas de manière fiable. En Q4_K_M, le modèle nécessite ~10 Go de VRAM. En Q3_K_M il pourrait tenir en 8 Go, mais la baisse de qualité est perceptible. Une meilleure option pour 8 Go de VRAM est Qwen2.5-Coder 7B ou DeepSeek Coder 7B.',
          },
          {
            q: 'Comment se comparent Qwen2.5-Coder 14B et DeepSeek-Coder-V2-Lite sur des tâches réelles ?',
          ...
          },
          {
            ...
            a: 'Pour les tâches spécifiques au code, Qwen2.5-Coder 14B surpasse généralement un modèle générique 34B malgré sa taille inférieure, grâce à son préentraînement axé sur le code. Consultez la <a href="/fr/prompt-bites/qwen-coder-vs-deepseek-coder" class="text-primary hover:underline">comparaison Qwen Coder vs DeepSeek Coder</a> pour les données de benchmark détaillées.',
          },
          {
  ...
  ja: {
    ...
    metaDescription: 'Qwen2.5-Coder 14B：78% HumanEval、10 GB VRAM。DeepSeek-Coder-V2-Lite：75%。StarCoder2 15B：73%。PromptQuorum による簡潔な回答。',
    heroImage: '/images/best-14b-models-coding-humaneval-comparison-hero-ja.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
      ja: {
        question: 'コーディングに最適な14Bモデルは？',
        answer: 'Qwen2.5-Coder 14Bはローカル利用の14Bコーディングモデルの中でトップです。Q4_K_Mで10 GB VRAMに収まり、14Bモデル中でHumanEvalスコアが最高です。DeepSeek-Coder-V2-Liteは同様のVRAM要件を持つ強力な代替モデルです。',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M：~10 GB VRAM、最高のHumanEvalスコア',
          'DeepSeek-Coder-V2-Lite：強力な代替、同様のVRAM使用量',
          '両者ともコード補完とデバッグで汎用14Bモデルを上回る',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B Q4_K_Mは~10 GB VRAMを使用し、ローカル14Bコーディングモデル中で最高のHumanEvalスコアを達成',
          'DeepSeek-Coder-V2-Liteは競争力のある代替で、ほとんどのコードベンチマークでQwenから3ポイント以内',
          '両モデルともコード補完、デバッグ、ドキュメント生成で汎用14Bモデルを大幅に上回る',
          'VRAMが10 GB超ならQwen 3 Coderを優先。8 GB未満なら特化型7Bコーダーに切り替えること',
        ],
      },
      body1: {
        title: 'Qwen2.5-Coder 14BがHumanEvalでトップ',
        content: [
          '<strong>2026年5月時点で、Qwen2.5-Coder 14BはQ4_K_M量子化でHumanEval 78.4%を記録 — OllamaまたはLlama.cpp経由で利用可能な14Bモデル中で最高のスコアです。</strong> このモデルは5兆トークン以上のコード重視データでファインチューニングされており、多段階補完とテストケース生成における性能の高さはそこに由来します。',
          'DeepSeek-Coder-V2-Liteは同一のQ4_K_M条件でHumanEval 75.1%を記録します。差は小さく、特にすでにキャッシュ済みだったり出力スタイルに慣れている場合はDeepSeek Coderも有効な選択肢です。',
        ...
        rows: [
          { 'モデル': 'Qwen2.5-Coder 14B', 'HumanEval': '78.4%', 'VRAM (Q4_K_M)': '~10 GB' },
          { 'モデル': 'DeepSeek-Coder-V2-Lite', 'HumanEval': '75.1%', 'VRAM (Q4_K_M)': '~10 GB' },
          { 'モデル': 'StarCoder2 15B', 'HumanEval': '~73%', 'VRAM (Q4_K_M)': '~10 GB' },
        ],
        image: '/images/best-14b-models-coding-humaneval-comparison-hero-ja.webp',
        imageCaption: 'コーディング向けベスト14Bモデル -- HumanEvalとVRAM（Q4_K_M）',
      },
      body2: {
        title: 'VRAMの余裕が選択を決める',
        content: [
          'Qwen2.5-Coder 14BとDeepSeek-Coder-V2-Liteはいずれも Q4_K_Mで約10 GB VRAMが必要で、12 GBカードでは2 GBしか余裕がありません。<strong>この余裕は長いコンテキストセッションでは不十分です：8kコンテキストではVRAM使用量は~11.5 GBに達します。</strong>大きなファイルを扱うワークフローでは16 GB以上のカードを推奨します。',
        ...
        image: '/images/best-14b-models-coding-vram-headroom-hero-ja.webp',
      ...
      faq: {
        ...
        faqs: [
          {
            q: 'Qwen2.5-Coder 14Bは8 GB VRAMで動作しますか？',
            a: '確実には動作しません。Q4_K_Mではモデルに~10 GB VRAMが必要です。Q3_K_Mなら8 GBに収まりますが品質低下が目立ちます。8 GB VRAMにはQwen2.5-Coder 7BまたはDeepSeek Coder 7Bがより良い選択肢です。',
          },
          {
            q: 'Qwen2.5-Coder 14BとDeepSeek-Coder-V2-Liteは実際のタスクでどう違いますか？',
          ...
          },
          {
            ...
            a: 'コード固有のタスクでは、コード重視の事前学習によりQwen2.5-Coder 14Bは小さいにもかかわらず汎用34Bモデルを上回ることが多いです。詳細なベンチマークデータは<a href="/ja/prompt-bites/qwen-coder-vs-deepseek-coder" class="text-primary hover:underline">Qwen Coder対DeepSeek Coderの比較</a>をご覧ください。',
          },
          {
  ...
  zh: {
    ...
    metaDescription: 'Qwen2.5-Coder 14B以78% HumanEval得分领先，12 GB显存运行Q4_K_M量化版。DeepSeek-Coder-V2-Lite以75%紧随，Python与SQL补全特别出色。StarCoder2 15B评分73%，响应速度最快。三款均支持Ollama本地部署，无需订阅费用。',
    heroImage: '/images/best-14b-models-coding-humaneval-comparison-hero-zh.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
      zh: {
        question: '编程最佳14B模型是哪款？',
        answer: 'Qwen2.5-Coder 14B 是本地使用的最佳14B编程模型。Q4_K_M量化后仅需10 GB VRAM，在14B模型中 HumanEval 得分最高。DeepSeek-Coder-V2-Lite 是 VRAM 需求相近的有力替代。',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M：~10 GB VRAM，HumanEval 最高分',
          'DeepSeek-Coder-V2-Lite：有力替代，VRAM 需求相近',
          '两者在代码补全和调试上均优于通用14B模型',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B Q4_K_M 使用约10 GB VRAM，在本地14B编程模型中 HumanEval 得分最高',
          'DeepSeek-Coder-V2-Lite 竞争力强，在大多数代码基准测试中与 Qwen 相差不超过3分',
          '两款模型在代码补全、调试和文档生成方面均大幅优于通用14B模型',
          'VRAM 超过10 GB 时首选 Qwen 3 Coder；低于8 GB 时改用专用7B编程模型',
        ],
      },
      body1: {
        title: 'Qwen2.5-Coder 14B 在 HumanEval 上领跑',
        content: [
          '<strong>截至2026年5月，Qwen2.5-Coder 14B 在 Q4_K_M 量化下 HumanEval 得分78.4%——是 Ollama 或 llama.cpp 上所有可用14B模型中的最高分。</strong>该模型在超过5万亿条以代码为核心的 token 上进行了微调，这正是其在多步骤补全和测试用例生成上表现突出的原因。',
          'DeepSeek-Coder-V2-Lite 在相同的 Q4_K_M 条件下 HumanEval 得分75.1%。差距足够小，DeepSeek Coder 仍是合理选择——尤其是当你已有缓存或熟悉其输出风格时。',
        ...
        rows: [
          { '模型': 'Qwen2.5-Coder 14B', 'HumanEval': '78.4%', 'VRAM (Q4_K_M)': '~10 GB' },
          { '模型': 'DeepSeek-Coder-V2-Lite', 'HumanEval': '75.1%', 'VRAM (Q4_K_M)': '~10 GB' },
          { '模型': 'StarCoder2 15B', 'HumanEval': '~73%', 'VRAM (Q4_K_M)': '~10 GB' },
        ],
        image: '/images/best-14b-models-coding-humaneval-comparison-hero-zh.webp',
        imageCaption: '编程最佳14B模型 -- HumanEval与显存（Q4_K_M）',
      },
      body2: {
        title: 'VRAM 余量决定选择',
        content: [
          'Qwen2.5-Coder 14B 和 DeepSeek-Coder-V2-Lite 在 Q4_K_M 下均需约10 GB VRAM，在12 GB 显卡上只剩2 GB 余量。<strong>长上下文会话中余量非常紧张：8k 上下文时 VRAM 使用量升至约11.5 GB。</strong>如果工作流涉及大型文件，建议使用16 GB 以上的显卡。',
        ...
        image: '/images/best-14b-models-coding-vram-headroom-hero-zh.webp',
      ...
      faq: {
        ...
        faqs: [
          {
            q: 'Qwen2.5-Coder 14B 能在8 GB VRAM 上运行吗？',
            a: '不能可靠运行。Q4_K_M 下模型需要约10 GB VRAM。使用 Q3_K_M 可以勉强塞入8 GB，但质量下降明显。8 GB VRAM 的更好选择是 Qwen2.5-Coder 7B 或 DeepSeek Coder 7B。',
          },
          {
            q: 'Qwen2.5-Coder 14B 和 DeepSeek-Coder-V2-Lite 在实际任务上有何差异？',
          ...
          },
          {
            ...
            a: '对于代码专项任务，尽管体积更小，Qwen2.5-Coder 14B 凭借代码专项预训练通常优于通用34B模型。详细基准数据请参阅<a href="/zh/prompt-bites/qwen-coder-vs-deepseek-coder" class="text-primary hover:underline">Qwen Coder 对比 DeepSeek Coder</a>。',
          },
          {
            q: '14B编程模型应使用哪种量化？',
  ...
  es: {
    ...
    metaDescription: 'Qwen2.5-Coder 14B: 78% HumanEval, 10 GB VRAM. DeepSeek-Coder-V2-Lite: 75%. StarCoder2 15B: 73% en 10 GB. Respuesta rápida de PromptQuorum.',
    heroImage: '/images/best-14b-models-coding-humaneval-comparison-hero-es.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
      es: {
        ...
        answer: 'Qwen2.5-Coder 14B es el mejor modelo de coding 14B para uso local, con 78.4% en HumanEval y 10 GB de VRAM en cuantización Q4_K_M. DeepSeek-Coder-V2-Lite es una alternativa sólida con requisitos de VRAM similares.',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M: ~10 GB VRAM, mejor puntuación HumanEval',
          'DeepSeek-Coder-V2-Lite: alternativa sólida, huella de VRAM similar',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B Q4_K_M usa ~10 GB de VRAM y logra la mayor puntuación HumanEval entre los modelos de coding 14B locales',
          'DeepSeek-Coder-V2-Lite es una alternativa competitiva que se queda a menos de 3 puntos de Qwen en la mayoría de benchmarks de código',
      ...
      body1: {
        title: 'Qwen2.5-Coder 14B lidera en HumanEval',
        content: [
          '<strong>A mayo de 2026, Qwen2.5-Coder 14B con cuantización Q4_K_M obtiene 78.4% en HumanEval — el mayor puntaje de cualquier modelo 14B disponible a través de Ollama o llama.cpp.</strong> El modelo fue ajustado con más de 5 billones de tokens de datos centrados en código, lo que distingue su rendimiento en finalización de múltiples pasos y generación de casos de prueba.',
          'DeepSeek-Coder-V2-Lite obtiene 75.1% en HumanEval bajo condiciones idénticas de Q4_K_M. La diferencia es lo suficientemente pequeña como para que DeepSeek Coder sea una opción válida, especialmente si ya lo tienes en caché o estás familiarizado con su estilo de salida.',
      ...
      body2: {
        ...
        image: '/images/best-14b-models-coding-vram-headroom-hero-es.webp',
      ...
      faq: {
        ...
        faqs: [
          {
            q: '¿Puede Qwen2.5-Coder 14B correr con 8 GB de VRAM?',
            a: 'No de forma fiable. En Q4_K_M el modelo necesita ~10 GB de VRAM. Podrías usar Q3_K_M para ajustarlo a 8 GB, pero la caída de calidad es notable. Una mejor opción para 8 GB de VRAM es Qwen2.5-Coder 7B o DeepSeek Coder 7B.',
          },
          {
            q: '¿Cómo se compara Qwen2.5-Coder 14B con DeepSeek-Coder-V2-Lite en tareas reales?',
          ...
          },
          {
            ...
            a: 'Para tareas específicas de código, Qwen2.5-Coder 14B generalmente supera a un modelo genérico de 34B a pesar de ser más pequeño, gracias a su preentrenamiento enfocado en coding. Consulta la <a href="/es/prompt-bites/qwen-coder-vs-deepseek-coder" class="text-primary hover:underline">comparativa Qwen Coder vs DeepSeek Coder</a> para datos detallados de benchmarks.',
          },
          {
  ...
  pt: {
    ...
    metaDescription: 'Qwen2.5-Coder 14B: 78% HumanEval, 10 GB VRAM. DeepSeek-Coder-V2-Lite: 75%. StarCoder2 15B: 73% com 10 GB. Resposta rápida do PromptQuorum.',
    heroImage: '/images/best-14b-models-coding-humaneval-comparison-hero-pt.webp',
    publishDate: '2026-05-18',
    dateModified: '2026-06-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
      pt: {
        ...
        answer: 'Qwen2.5-Coder 14B é o melhor modelo de programação 14B para uso local, com 78,4% no HumanEval e 10 GB de VRAM em quantização Q4_K_M. DeepSeek-Coder-V2-Lite é uma alternativa sólida com requisitos de VRAM semelhantes.',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M: ~10 GB VRAM, maior pontuação HumanEval',
          'DeepSeek-Coder-V2-Lite: alternativa sólida, pegada de VRAM semelhante',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B Q4_K_M usa ~10 GB de VRAM e alcança a maior pontuação HumanEval entre modelos de programação 14B locais',
          'DeepSeek-Coder-V2-Lite é uma alternativa competitiva que fica a menos de 3 pontos do Qwen na maioria dos benchmarks de código',
      ...
      body1: {
        title: 'Qwen2.5-Coder 14B lidera no HumanEval',
        content: [
          '<strong>Em maio de 2026, Qwen2.5-Coder 14B com quantização Q4_K_M pontua 78,4% no HumanEval — a maior pontuação de qualquer modelo 14B disponível via Ollama ou llama.cpp.</strong> O modelo foi ajustado em mais de 5 trilhões de tokens de dados focados em código, o que distingue seu desempenho em conclusão de múltiplas etapas e geração de casos de teste.',
          'DeepSeek-Coder-V2-Lite pontua 75,1% no HumanEval em condições idênticas de Q4_K_M. A diferença é pequena o suficiente para que o DeepSeek Coder seja uma escolha válida, especialmente se você já o tem em cache ou está familiarizado com seu estilo de saída.',
      ...
      body2: {
        ...
        image: '/images/best-14b-models-coding-vram-headroom-hero-pt.webp',
      ...
      faq: {
        ...
        faqs: [
          {
            q: 'O Qwen2.5-Coder 14B pode rodar com 8 GB de VRAM?',
            a: 'Não de forma confiável. Em Q4_K_M o modelo requer ~10 GB de VRAM. Você poderia usar Q3_K_M para encaixá-lo em 8 GB, mas a queda de qualidade é perceptível. Uma opção melhor para 8 GB de VRAM é Qwen2.5-Coder 7B ou DeepSeek Coder 7B.',
          },
          {
            q: 'Como Qwen2.5-Coder 14B se compara ao DeepSeek-Coder-V2-Lite em tarefas reais?',
  ...
  ar: {
    ...
    metaDescription: '⁨Qwen2.5-Coder 14B⁩ يسجل ⁨78%⁩ على ⁨HumanEval⁩ بـ ⁨10 GB VRAM⁩ عند ⁨Q4⁩_⁨K⁩_⁨M. DeepSeek-Coder-V2-Lite⁩ يصل إلى ⁨75%. StarCoder2 15B⁩ يحقق ⁨73%⁩ بنفس ⁨VRAM⁩.',
    heroImage: '/images/best-14b-models-coding-humaneval-comparison-hero-ar.webp',
    publishDate: '2026-05-18',
    ...
    quickAnswerTop: {
      ar: {
        ...
        answer: 'Qwen2.5-Coder 14B هو أفضل نموذج برمجة 14B للاستخدام المحلي، إذ يحقق 78.4% على HumanEval ويعمل بـ 10 GB من VRAM عند تكميم Q4_K_M. أما DeepSeek-Coder-V2-Lite فهو بديل قوي بمتطلبات VRAM مماثلة.',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M: ~10 GB VRAM، أعلى نتيجة HumanEval',
          'DeepSeek-Coder-V2-Lite: بديل قوي، بصمة VRAM مماثلة',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'يستخدم Qwen2.5-Coder 14B Q4_K_M نحو 10 GB من VRAM ويحقق أعلى نتيجة HumanEval بين نماذج البرمجة المحلية 14B',
          'DeepSeek-Coder-V2-Lite بديل تنافسي يقل عن Qwen بأقل من 3 نقاط في معظم اختبارات الكود المعيارية',
      ...
      body1: {
        title: 'Qwen2.5-Coder 14B يتصدر في HumanEval',
        content: [
          '<strong>اعتباراً من مايو 2026، يحقق Qwen2.5-Coder 14B بتكميم Q4_K_M نسبة 78.4% على HumanEval — وهي أعلى نتيجة لأي نموذج 14B متاح عبر Ollama أو llama.cpp.</strong> جرى ضبط دقيق للنموذج على أكثر من 5 تريليون رمز من البيانات المتمحورة حول الكود، مما يميّز أداءه في الإكمال متعدد الخطوات وتوليد حالات الاختبار.',
          'يحقق DeepSeek-Coder-V2-Lite نسبة 75.1% على HumanEval في ظروف Q4_K_M المتطابقة. الفارق صغير بما يكفي لجعل DeepSeek Coder خياراً صالحاً، لا سيما إن كان لديك نسخة مخزّنة مسبقاً أو كنت مألوفاً بأسلوب مخرجاته.',
        ...
        rows: [
          { 'النموذج': 'Qwen2.5-Coder 14B', 'HumanEval': '78.4%', 'VRAM (Q4_K_M)': '~10 GB' },
          { 'النموذج': 'DeepSeek-Coder-V2-Lite', 'HumanEval': '75.1%', 'VRAM (Q4_K_M)': '~10 GB' },
          { 'النموذج': 'StarCoder2 15B', 'HumanEval': '~73%', 'VRAM (Q4_K_M)': '~10 GB' },
        ],
        image: '/images/best-14b-models-coding-humaneval-comparison-hero-ar.webp',
        imageCaption: 'أفضل نماذج 14B للبرمجة -- HumanEval والذاكرة (Q4_K_M)',
      },
      body2: {
        title: 'هامش VRAM يحدد أيهما تختار',
        content: [
          'يحتاج كلٌّ من Qwen2.5-Coder 14B وDeepSeek-Coder-V2-Lite إلى نحو 10 GB من VRAM عند Q4_K_M، مما يترك هامشاً لا يتجاوز 2 GB على بطاقة بسعة 12 GB. <strong>هذا الهامش ضيّق لجلسات السياق الطويل: عند 8k من السياق، يرتفع استخدام VRAM إلى ~11.5 GB.</strong> إن كان سير عملك يتضمن ملفات كبيرة، فاختر بطاقة بسعة 16 GB أو أكثر.',
        ...
        image: '/images/best-14b-models-coding-vram-headroom-hero-ar.webp',
      ...
      faq: {
        ...
        faqs: [
          {
            q: 'هل يمكن تشغيل Qwen2.5-Coder 14B بـ 8 GB من VRAM؟',
            a: 'ليس باستمرار. يحتاج النموذج عند Q4_K_M إلى ~10 GB من VRAM. يمكنك استخدام Q3_K_M لضغطه في 8 GB، لكن تراجع الجودة ملحوظ. الخيار الأفضل لـ 8 GB من VRAM هو Qwen2.5-Coder 7B أو DeepSeek Coder 7B.',
          },
          {
            q: 'كيف يقارن Qwen2.5-Coder 14B بـ DeepSeek-Coder-V2-Lite في المهام الفعلية؟',
          ...
          },
          {
            ...
            a: 'في المهام الخاصة بالكود، يتفوق Qwen2.5-Coder 14B عادةً على نموذج عام بحجم 34B رغم صغر حجمه، بفضل تدريبه المسبق المتمحور حول البرمجة. راجع <a href="/ar/prompt-bites/qwen-coder-vs-deepseek-coder" class="text-primary hover:underline">مقارنة Qwen Coder مع DeepSeek Coder</a> للاطلاع على بيانات الاختبارات المعيارية التفصيلية.',
          },
          {
  ...
  ko: {
    ...
    metaDescription: 'Qwen2.5-Coder 14B: HumanEval 78%, VRAM 10 GB. DeepSeek-Coder-V2-Lite: 75%. StarCoder2 15B: 73%. PromptQuorum의 빠른 답변.',
    heroImage: '/images/best-14b-models-coding-humaneval-comparison-hero-ko.webp',
    publishDate: '2026-05-18',
    ...
    quickAnswerTop: {
      ko: {
        ...
        answer: 'Qwen2.5-Coder 14B는 로컬 사용을 위한 최고의 14B 코딩 모델입니다. Q4_K_M 양자화에서 10 GB VRAM으로 동작하며, 14B 모델 중 HumanEval 점수가 가장 높습니다. DeepSeek-Coder-V2-Lite는 VRAM 요구 사항이 유사한 강력한 대안입니다.',
        bullets: [
          'Qwen2.5-Coder 14B Q4_K_M: ~10 GB VRAM, 최고의 HumanEval 점수',
          'DeepSeek-Coder-V2-Lite: 강력한 대안, 유사한 VRAM 사용량',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'Qwen2.5-Coder 14B Q4_K_M은 ~10 GB VRAM을 사용하며 로컬 14B 코딩 모델 중 가장 높은 HumanEval 점수를 달성합니다',
          'DeepSeek-Coder-V2-Lite는 대부분의 코드 벤치마크에서 Qwen과 3점 이내 차이를 보이는 경쟁력 있는 대안입니다',
        ...
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: 'Qwen2.5-Coder 14B는 Q4_K_M 양자화 시 VRAM 10 GB로 HumanEval 78.4%를 달성하여 로컬 14B 코딩 모델 중 1위입니다.',
          },
          {
            type: 'plain-terms',
            text: '14B 코딩 모델을 로컬에서 실행하려면 Qwen2.5-Coder 14B 또는 DeepSeek-Coder-V2-Lite를 선택하십시오. 두 모델 모두 Q4_K_M 양자화 시 약 10 GB VRAM이 필요하며, 범용 모델보다 코드 작업에서 훨씬 높은 성능을 발휘합니다.',
          },
        ],
      },
      body1: {
        title: 'Qwen2.5-Coder 14B가 HumanEval에서 선두',
        content: [
          '<strong>2026년 5월 기준, Qwen2.5-Coder 14B는 Q4_K_M 양자화에서 HumanEval 78.4%를 기록합니다 — Ollama 또는 llama.cpp를 통해 사용 가능한 모든 14B 모델 중 가장 높은 점수입니다.</strong> 이 모델은 5조 개 이상의 코드 중심 토큰으로 파인튜닝되었으며, 이는 다단계 완성 및 테스트 케이스 생성에서의 뛰어난 성능으로 이어집니다.',
          'DeepSeek-Coder-V2-Lite는 동일한 Q4_K_M 조건에서 HumanEval 75.1%를 기록합니다. 차이가 크지 않아 DeepSeek Coder도 유효한 선택지입니다. 특히 이미 캐시에 저장되어 있거나 출력 스타일에 익숙한 경우라면 더욱 그렇습니다.',
        ...
        rows: [
          { '모델': 'Qwen2.5-Coder 14B', 'HumanEval': '78.4%', 'VRAM (Q4_K_M)': '~10 GB' },
          { '모델': 'DeepSeek-Coder-V2-Lite', 'HumanEval': '75.1%', 'VRAM (Q4_K_M)': '~10 GB' },
          { '모델': 'StarCoder2 15B', 'HumanEval': '~73%', 'VRAM (Q4_K_M)': '~10 GB' },
        ],
        image: '/images/best-14b-models-coding-humaneval-comparison-hero-ko.webp',
        imageCaption: '코딩을 위한 최고의 14B 모델 -- HumanEval 및 VRAM (Q4_K_M)',
      },
      body2: {
        title: 'VRAM 여유 공간이 선택을 결정합니다',
        content: [
          'Qwen2.5-Coder 14B와 DeepSeek-Coder-V2-Lite 모두 Q4_K_M에서 약 10 GB VRAM이 필요하며, 12 GB 카드에서는 여유 공간이 2 GB에 불과합니다. <strong>이 여유 공간은 긴 컨텍스트 세션에서 부족합니다: 8k 컨텍스트에서 VRAM 사용량이 ~11.5 GB까지 증가합니다.</strong> 대용량 파일을 다루는 작업이라면 16 GB 이상의 카드를 권장합니다.',
        ...
        image: '/images/best-14b-models-coding-vram-headroom-hero-ko.webp',
      ...
      faq: {
        ...
        faqs: [
          {
            q: 'Qwen2.5-Coder 14B를 8 GB VRAM에서 실행할 수 있습니까?',
            a: '안정적으로는 불가능합니다. Q4_K_M에서 모델은 ~10 GB VRAM이 필요합니다. Q3_K_M을 사용하면 8 GB에 넣을 수 있지만 품질 저하가 눈에 띕니다. 8 GB VRAM에는 Qwen2.5-Coder 7B 또는 DeepSeek Coder 7B가 더 나은 선택입니다.',
          },
          {
            q: 'Qwen2.5-Coder 14B와 DeepSeek-Coder-V2-Lite는 실제 작업에서 어떻게 다릅니까?',
          ...
          },
          {
            ...
            a: '코드 특화 작업에서 Qwen2.5-Coder 14B는 코딩 중심 사전 학습 덕분에 크기가 작음에도 불구하고 범용 34B 모델보다 일반적으로 우수합니다. 자세한 벤치마크 데이터는 <a href="/ko/prompt-bites/qwen-coder-vs-deepseek-coder" class="text-primary hover:underline">Qwen Coder 대 DeepSeek Coder 비교</a>를 참조하십시오.',
          },
          {
