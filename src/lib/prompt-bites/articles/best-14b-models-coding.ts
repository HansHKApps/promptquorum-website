...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: 'Qwen 2.5 Coder 14B leads 14B coding models locally. Fits 10 GB VRAM at Q4_K_M and scores highest on HumanEval. DeepSeek Coder 14B is a strong alternative.',
    ...
    sections: {
      ...
      body1: {
        ...
        content: [
          ...
          'Generic 14B models such as Llama 3 14B or Mistral 12B score in the 56–62% range on HumanEval. The coding-specific pretraining of Qwen 2.5 Coder and DeepSeek Coder represents a substantial quality gap for tasks involving real code.',
        ],
        ...
        rows: [
          ...
          { 'Model': 'Mistral 12B (generic)', 'HumanEval': '60.3%', 'VRAM (Q4_K_M)': '~8 GB' },
        ],
      },
      body2: {
        ...
        content: [
          ...
          'For context windows below 4k tokens — the common case for single-file code completion — both models run comfortably on an RTX 3060 12 GB or RTX 3080 Ti 12 GB. Speed on those cards is approximately 14–18 tok/s for both models.',
  ...
  de: {
    ...
    seoTitle: 'Bestes 14B-Modell für Coding? | Prompt Bites | PromptQuorum',
    metaDescription: 'Qwen 2.5 Coder 14B führt 14B-Coding-Modelle lokal an. 10 GB VRAM bei Q4_K_M, bester HumanEval-Score. DeepSeek Coder 14B ist eine starke Alternative.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  fr: {
    ...
    seoTitle: 'Meilleur 14B pour coding 2026 | Prompt Bites | PromptQuorum',
    metaDescription: 'Qwen 2.5 Coder 14B domine les modèles de coding 14B en local. 10 Go de VRAM en Q4_K_M, meilleur score HumanEval. DeepSeek Coder 14B est une solide alternative.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  ja: {
    ...
    seoTitle: 'コーディングに最適な14Bモデルは？ | Prompt Bites | PromptQuorum',
    metaDescription: 'Qwen 2.5 Coder 14Bがローカルの14Bコーディングモデルをリード。Q4_K_Mで10 GB VRAMに収まりHumanEvalスコア最高。DeepSeek Coder 14Bも強力な代替。PromptQuorumによる簡潔な回答。',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  zh: {
    theme: 'Model Comparisons',
    title: '编程最佳14B模型是哪款？',
    seoTitle: '本地编程最佳14B模型推荐 2026 | Prompt Bites | PromptQuorum',
    metaDescription: 'Qwen 2.5 Coder 14B 领跑本地14B编程模型。Q4_K_M仅需10 GB VRAM，HumanEval得分最高。DeepSeek Coder 14B 是有力替代。PromptQuorum 快速解答。',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
