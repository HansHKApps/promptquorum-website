...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  de: {
    ...
    metaDescription: 'Qwen 2.5 Coder 14B führt die 14B-Coding-Modelle lokal an. Benötigt 10 GB VRAM bei Q4_K_M und erzielt den besten HumanEval-Score. DeepSeek Coder 14B ist eine starke Alternative. Kurze Antwort von PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  fr: {
    ...
    seoTitle: 'Meilleur modèle 14B pour le coding ? | Prompt Bites | PromptQuorum',
    metaDescription: 'Qwen 2.5 Coder 14B domine les modèles de coding 14B en local. 10 Go de VRAM en Q4_K_M, meilleur score HumanEval. DeepSeek Coder 14B est une solide alternative. Réponse rapide par PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  zh: {
    theme: 'Model Comparisons',
    title: '编程最佳14B模型是哪款？',
    seoTitle: '编程最佳14B模型？ | Prompt Bites | PromptQuorum',
