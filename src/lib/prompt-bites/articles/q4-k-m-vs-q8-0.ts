...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  ar: {
    ...
    seoTitle: 'Q4_K_M مقابل Q8_0: أيهما؟ 2026 | Prompt Bites | PromptQuorum',
    metaDescription: 'استخدم Q4_K_M مع 8 GB من VRAM أو أقل. استخدم Q8_0 مع 12+ GB. يوفر Q4_K_M 95% من جودة Q8_0 بنصف الحجم تقريبًا. إجابة سريعة من PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
