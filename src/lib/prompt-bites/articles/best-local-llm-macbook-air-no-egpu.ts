...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    current_models_mentioned: ['Qwen3 8B'],
  ...
  ar: {
    ...
    title: 'أفضل LLM محلي لجهاز MacBook Air بدون eGPU في عام 2026',
    seoTitle: 'أفضل LLM محلي لـ MacBook Air (بدون eGPU) 2026',
    metaDescription: 'MacBook Air بمعالج M5 من أفضل أجهزة اللابتوب لتشغيل LLM محليًا دون eGPU. للذكاء الاصطناعي المحلي، اختر ذاكرة موحدة 24GB أو 32GB — وليس الطراز الأساسي بسعة 16GB.',
    publishDate: '2026-07-14',
    dateModified: '2026-08-26',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-02-26',
    ...
    current_hardware_mentioned: ['MacBook Air M5'],
    educationalLevel: 'Beginner',
    audience: 'مشترو MacBook Air الذين يقررون سعة الذاكرة الموحدة المناسبة لتشغيل LLM محليًا، ويفترض بعضهم أنهم بحاجة إلى eGPU لتشغيلها',
    affiliateDisclosure: true,
    parentArticle: '/power-local-llm/best-gpu-buying-guide-local-llm-2026',
    siblingBites: ['best-egpu-ollama-macbook', 'mac-mini-m4-local-llm'],
    is_living_page: false,
    leadAnswerBlock: '<strong>يُعد MacBook Air بمعالج M5 أحد أفضل أجهزة الحاسوب المحمولة لتشغيل LLM محليًا دون الحاجة إلى eGPU — لتشغيل الذكاء الاصطناعي محليًا، اختر ذاكرة موحدة سعة 24GB أو 32GB، وليس الطراز الأساسي بسعة 16GB.</strong> لا يمتلك Apple Silicon أي مسار PCIe إلى بطاقة رسومات خارجية، لذا فإن غياب خيار eGPU ليس نقصًا تحتاج إلى الالتفاف حوله — سعة الذاكرة الموحدة هي الرافعة الحقيقية، ولا يمكن زيادتها بعد الشراء.',
    toc: [
      { label: 'أفضل تكوين لتشغيل LLM محليًا', anchor: '#best-pick' },
      { label: '24GB مقابل 32GB في MacBook Air', anchor: '#comparison' },
      { label: 'الأسئلة الشائعة', anchor: '#faq' },
      { label: 'قراءات ذات صلة', anchor: '#related' },
    ],
    quickAnswerTop: {
      ar: {
        question: 'ما هو أفضل تكوين لجهاز MacBook Air لتشغيل LLM محليًا؟',
        answer: 'يُعد MacBook Air بمعالج M5 وذاكرة موحدة سعة 32GB أفضل تكوين لاستخدام الذكاء الاصطناعي محليًا؛ أما 24GB فهو الخيار الأفضل من حيث القيمة إذا كانت الميزانية أهم. تجنب الطراز الأساسي بسعة 16GB إذا كان تشغيل LLM محليًا سببًا رئيسيًا لشرائك الجهاز. لا يمكن لأي eGPU المساعدة على Apple Silicon — اشترِ بناءً على سعة الذاكرة، لا على مسار ترقية غير موجود.',
        bullets: [
    ...
    sections: {
      ...
      bestPick: {
        id: 'best-pick',
        title: 'أفضل تكوين لجهاز MacBook Air لتشغيل LLM محليًا',
        content: [
          '<strong>إذا كان الذكاء الاصطناعي المحلي أحد الأسباب الرئيسية لشرائك MacBook Air بمعالج M5، فاختر تكوينًا بذاكرة موحدة سعة 32GB.</strong> يشارك Apple Silicon الذاكرة بين CPU وGPU، لذا فإن رقم الذاكرة الموحدة في ورقة المواصفات — وليس رقم VRAM منفصلًا — هو ما يحدد النماذج التي تناسب الجهاز. توفر 32GB هامشًا مريحًا لنماذج فئة 14B ومساحة للتجربة مع نماذج مكممة أكبر.',
        ...
        affiliateLinks: [
          {
            ...
            productName: 'MacBook Air M5 (24GB unified memory)',
            productCategory: 'laptop',
            label: 'تحقق من السعر الحالي لـ MacBook Air M5 24GB',
          },
          {
            url: 'https://www.amazon.com/s?k=MacBook+Air+M5+32GB',
            productName: 'MacBook Air M5 (32GB unified memory)',
            productCategory: 'laptop',
            label: 'تحقق من السعر الحالي لـ MacBook Air M5 32GB',
          },
        ],
      },
      comparison: {
        id: 'comparison',
        title: '24GB مقابل 32GB في MacBook Air لتشغيل LLM محليًا',
        content: [
        ...
        columns: ['حجم النموذج', 'على 24GB', 'على 32GB'],
        rows: [
          { '0': '7B-8B', '1': '🟢 ممتاز', '2': '🟢 ممتاز' },
          { '0': '13B-14B', '1': '🟢 مريح', '2': '🟢 مساحة وفيرة' },
          { '0': '20B-30B', '1': '🟡 ضيق، يعتمد على التكميم', '2': '🟢 مريح عند Q4' },
          { '0': '70B', '1': '🔴 غير واقعي', '2': '🔴 ليس الغرض من الشراء' },
        ],
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          {
            q: 'هل يمكنني إضافة eGPU إلى MacBook Air أو MacBook Pro أو iMac لتشغيل LLM محليًا؟',
            a: 'لا، ليس لأغراض التسريع على أي جهاز Mac حالي بمعالج Apple Silicon — سواء MacBook Air أو MacBook Pro أو iMac بمعالج Apple Silicon. لا يمتلك Apple Silicon أي مسار PCIe إلى بطاقة رسومات خارجية، وحتى في الحالات التي يمكن فيها توصيل eGPU فعليًا (ممكن فقط على أجهزة Mac القديمة بمعالج Intel، وليس Apple Silicon)، فإن macOS وأدوات مثل Ollama توجّه الاستدلال فقط إلى واجهة Metal الخاصة بـ Apple. إذا كان سير عملك يعتمد على NVIDIA CUDA وبطاقة رسومات قابلة للترقية، فإن جهاز Windows أو Linux هو الخيار العملي الأنسب، وليس جهاز Mac مزودًا بـ eGPU.',
          },
          {
            q: 'هل يكفي MacBook Air الأساسي بذاكرة 16GB لتشغيل LLM محليًا؟',
            a: 'يمكنه تشغيل نماذج فئة 7B بدقة Q4 بشكل مريح، لذا فهو ليس عديم الفائدة. لكن الذكاء الاصطناعي المحلي ليس الاستخدام الذي صُمم من أجله هذا التكوين — لا يمكن إضافة ذاكرة بعد الشراء، لذا إذا كان تشغيل نماذج محلية أكبر يهمك، اختر 24GB على الأقل عند الشراء بدلًا من التخطيط للترقية لاحقًا.',
          },
          {
          ...
          },
          {
            ...
            a: 'فقط إذا احتجت تبريدًا فعالًا لأحمال العمل المستمرة أو أردت تكوينات ذاكرة موحدة أعلى من 32GB — إذ تصل سلسلة MacBook Pro إلى 64GB مع M5 Pro أو 128GB مع M5 Max، وهي أسقف لا تقدمها سلسلة MacBook Air.',
          },
          {
            q: 'هل يعمل Ollama أو MLX بشكل أفضل على MacBook Air؟',
            a: 'يستخدم كلاهما نفس تسريع Metal تحته؛ MLX هو إطار عمل Apple الخاص ويمكن أن يكون أسرع قليلًا لبعض بنى النماذج، بينما يوفر Ollama تجربة إعداد أبسط. كلاهما خيار افتراضي معقول.',
          },
        ],
      },
      related: {
        ...
        items: [
          '[هل يمكن تشغيل LLM محليًا باستخدام eGPU على MacBook؟](/ar/prompt-bites/best-egpu-ollama-macbook) — لماذا لا تعمل أجهزة eGPU على Apple Silicon',
          '[هل يُعد Mac Mini M4 خيارًا جيدًا لتشغيل LLM محليًا؟](/ar/prompt-bites/mac-mini-m4-local-llm) — بديل سطح مكتب بهامش ذاكرة أكبر',
          '[أفضل LLM محلي لجهاز Mac بذاكرة موحدة 32GB](/ar/prompt-bites/best-local-llm-32gb-unified-memory-mac) — نفس فئة الذاكرة، بتصميم سطح مكتب',
        ],
      },
    },
  },
  ...
  pt: {
    ...
    title: 'Qual o Melhor LLM Local para um MacBook Air Sem eGPU em 2026?',
    seoTitle: 'Melhor LLM Local para MacBook Air (Sem eGPU) 2026',
    metaDescription: 'O MacBook Air M5 é um dos melhores notebooks para LLM local sem eGPU. Para IA local, escolha 24GB ou 32GB de memória unificada, não o 16GB básico.',
    publishDate: '2026-07-14',
    dateModified: '2026-08-26',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-02-26',
    ...
    current_hardware_mentioned: ['MacBook Air M5'],
    educationalLevel: 'Beginner',
    audience: 'Compradores de MacBook Air decidindo quanta memória unificada configurar para LLMs locais, alguns dos quais presumem que precisam de uma eGPU para rodá-los',
    affiliateDisclosure: true,
    parentArticle: '/power-local-llm/best-gpu-buying-guide-local-llm-2026',
    siblingBites: ['best-egpu-ollama-macbook', 'mac-mini-m4-local-llm'],
    is_living_page: false,
    leadAnswerBlock: '<strong>O MacBook Air M5 é um dos melhores notebooks portáteis para LLM local que você pode comprar sem precisar de uma eGPU — para IA local, configure 24GB ou 32GB de memória unificada, não o modelo básico de 16GB.</strong> O Apple Silicon não tem caminho PCIe para uma GPU externa, então a ausência de opção de eGPU não é uma limitação que você precisa contornar — a capacidade de memória unificada é a alavanca real, e ela não pode ser adicionada depois da compra.',
    toc: [
      { label: 'Melhor Configuração para LLMs Locais', anchor: '#best-pick' },
      { label: '24 GB vs 32 GB MacBook Air', anchor: '#comparison' },
    ...
    sections: {
        ...
        affiliateLinks: [
          {
            ...
            productName: 'MacBook Air M5 (24GB unified memory)',
            productCategory: 'laptop',
            label: 'Confira o preço atual do MacBook Air M5 24GB',
          },
          {
            url: 'https://www.amazon.com/s?k=MacBook+Air+M5+32GB',
            productName: 'MacBook Air M5 (32GB unified memory)',
            productCategory: 'laptop',
            label: 'Confira o preço atual do MacBook Air M5 32GB',
          },
        ],
      },
      comparison: {
        id: 'comparison',
        title: '24 GB vs 32 GB MacBook Air para LLMs Locais',
        content: [
        ...
        columns: ['Tamanho do modelo', 'Em 24GB', 'Em 32GB'],
        rows: [
          { '0': '7B-8B', '1': '🟢 Excelente', '2': '🟢 Excelente' },
          { '0': '13B-14B', '1': '🟢 Confortável', '2': '🟢 Bastante espaço' },
          { '0': '20B-30B', '1': '🟡 Apertado, depende da quant.', '2': '🟢 Confortável em Q4' },
          { '0': '70B', '1': '🔴 Não é realista', '2': '🔴 Não é para isso' },
        ],
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          {
            q: 'É possível adicionar uma eGPU a um MacBook Air, MacBook Pro ou iMac para LLMs locais?',
            a: 'Não, não para aceleração em nenhum Mac Apple Silicon atual — MacBook Air, MacBook Pro ou um iMac com Apple Silicon. O Apple Silicon não tem caminho PCIe para uma GPU externa, e mesmo onde uma eGPU está fisicamente conectada (possível apenas em Macs Intel mais antigos, não em Apple Silicon), o macOS e ferramentas como o Ollama só despacham inferência para o backend Metal da própria Apple. Se seu fluxo de trabalho depende de NVIDIA CUDA e de uma GPU atualizável, uma máquina Windows ou Linux é a escolha mais prática, não um Mac com eGPU.',
          },
          {
            q: 'O MacBook Air básico de 16 GB é suficiente para LLMs locais?',
            a: 'Ele consegue rodar modelos de classe 7B em Q4 confortavelmente, então não é inútil. Mas IA local não é o caso de uso para o qual essa configuração foi feita — a memória não pode ser adicionada depois da compra, então, se rodar modelos locais maiores importar para você, configure pelo menos 24 GB no checkout em vez de planejar atualizar depois.',
          },
          {
          ...
          },
          {
            ...
            a: 'Apenas se você precisar de resfriamento ativo para cargas de trabalho sustentadas ou quiser configurações de memória unificada acima de 32 GB — a linha MacBook Pro vai até 64 GB com M5 Pro ou 128 GB com M5 Max, limites que o MacBook Air não oferece.',
          },
          {
      ...
      related: {
        ...
        items: [
          '[É Possível Rodar LLMs Locais com uma eGPU em um MacBook?](/pt/prompt-bites/best-egpu-ollama-macbook) — por que eGPUs não funcionam no Apple Silicon',
          '[O Mac Mini M4 É Bom para LLMs Locais?](/pt/prompt-bites/mac-mini-m4-local-llm) — uma alternativa desktop com mais espaço de memória',
          '[Melhor LLM Local para um Mac com 32 GB de Memória Unificada](/pt/prompt-bites/best-local-llm-32gb-unified-memory-mac) — a mesma faixa de memória, formato desktop',
        ],
      },
    },
  },
