...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: 'Best local LLM for a MacBook Air: 7B-8B models at Q4 on 16GB unified memory, 13-14B on 24GB. No eGPU works on Apple Silicon — unified memory is the only lever.',
  ...
  de: {
    ...
    metaDescription: 'Bestes lokales LLM für ein MacBook Air: 7B-8B-Modelle bei Q4 auf 16 GB Unified Memory, 13-14B auf 24 GB. Keine eGPU funktioniert auf Apple Silicon — Unified Memory ist der einzige Hebel.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  es: {
    ...
    metaDescription: 'Mejor LLM local para un MacBook Air: modelos de 7B-8B en Q4 con 16GB de memoria unificada, 13-14B con 24GB. Ninguna eGPU funciona en Apple Silicon — la memoria unificada es la única palanca.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  ko: {
    ...
    metaDescription: 'MacBook Air를 위한 최적의 로컬 LLM: 16GB 통합 메모리에서는 Q4의 7B-8B 모델, 24GB에서는 13-14B 모델. Apple Silicon에서는 eGPU가 작동하지 않으며 통합 메모리가 유일한 수단입니다.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  pt: {
    ...
    metaDescription: 'Melhor LLM local para um MacBook Air: modelos de 7B-8B em Q4 com 16GB de memória unificada, 13-14B com 24GB. eGPU não funciona no Apple Silicon — memória unificada é a única alavanca.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
