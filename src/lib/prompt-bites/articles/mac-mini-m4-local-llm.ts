  ...
  en: {
    ...
    sections: {
      ...
      comparison: {
        ...
        columns: ['Configuration', 'Unified Memory', 'Best Models (Q4)', 'Speed', 'Best for'],
        rows: [
          {
            'Configuration': 'Mac Mini M4 (base)',
            'Unified Memory': '16 GB',
            'Best Models (Q4)': 'Qwen 3 8B, Llama 3.3 8B, DeepSeek-R1 7B',
            'Speed': '~35-45 tok/s',
            'Best for': 'Lowest price, 8B-class only',
          },
          {
            'Configuration': 'Mac Mini M4 Pro',
            'Unified Memory': '24 GB',
            'Best Models (Q4)': 'Qwen 14B, Phi-4 14B, Mistral Small; full 8B headroom',
            'Speed': '~20 tok/s (14B) / ~36 tok/s (8B)',
            'Best for': 'Best value — runs 14B comfortably',
          },
          {
            'Configuration': 'Mac Mini M4 Pro',
            'Unified Memory': '48 GB',
            'Best Models (Q4)': 'Qwen 32B, Mixtral 8×7B; all 14B models with headroom',
            'Speed': '~12 tok/s (32B) / ~20 tok/s (14B)',
            'Best for': 'Power users — 32B class at good speed',
          },
        ],
      },
      faq: {
