...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    title: 'Mistral Small 24B vs Qwen 3 14B vs Llama 3.1 8B: Which to Run Locally?',
    dateModified: '2026-06-20',
    seoTitle: 'Mistral Small 24B vs Qwen 14B vs Llama 8B 2026 | Prompt Bites | PromptQuorum',
    metaDescription: 'Llama 3.1 8B: 4.9 GB VRAM. Qwen 3 14B: 9.3 GB, MMLU 74.8%. Mistral Small 24B: 14.4 GB, MMLU 81%. Pick by VRAM tier. Quick answer from PromptQuorum.',
    publishDate: '2026-05-23',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-23',
    current_models_mentioned: ['Mistral Small 3.1 24B', 'Qwen 3 14B', 'Llama 3.1 8B'],
    ...
    quickAnswerTop: {
      en: {
        question: 'Mistral Small 24B vs Qwen 3 14B vs Llama 3.1 8B: which should I run locally?',
        answer: 'Pick by VRAM: Llama 3.1 8B (4.9 GB), Qwen 3 14B (9.3 GB), Mistral Small 3.1 24B (14.4 GB). Qwen 14B wins at 12 GB VRAM. Mistral Small 24B wins above 16 GB on reasoning tasks.',
        bullets: [
      ...
      de: {
        question: 'Mistral Small 24B vs. Qwen 3 14B vs. Llama 3.1 8B: Welches sollte ich lokal ausführen?',
        answer: 'Wählen Sie nach VRAM: Llama 3.1 8B (4,9 GB), Qwen 3 14B (9,3 GB), Mistral Small 3.1 24B (14,4 GB). Qwen 14B gewinnt bei 12 GB VRAM. Mistral Small 24B gewinnt ab 16 GB bei Reasoning-Aufgaben.',
        bullets: [
      ...
      fr: {
        question: 'Mistral Small 24B vs Qwen 3 14B vs Llama 3.1 8B : lequel lancer en local ?',
        answer: 'Choisissez selon le VRAM : Llama 3.1 8B (4,9 Go), Qwen 3 14B (9,3 Go), Mistral Small 3.1 24B (14,4 Go). Qwen 14B gagne à 12 Go de VRAM. Mistral Small 24B gagne au-dessus de 16 Go sur les tâches de raisonnement.',
        bullets: [
      ...
      ja: {
        question: 'Mistral Small 24B・Qwen 3 14B・Llama 3.1 8B：ローカルでどれを動かすべきか？',
        answer: 'VRAMで選択してください：Llama 3.1 8B（4.9 GB）、Qwen 3 14B（9.3 GB）、Mistral Small 3.1 24B（14.4 GB）。12 GB VRAMではQwen 14Bが最適。16 GB以上では推論タスクでMistral Small 24Bが優位。',
        bullets: [
      ...
      zh: {
        question: 'Mistral Small 24B 对比 Qwen 3 14B 对比 Llama 3.1 8B：本地运行选哪个？',
        answer: '按显存选择：Llama 3.1 8B（4.9 GB）、Qwen 3 14B（9.3 GB）、Mistral Small 3.1 24B（14.4 GB）。12 GB 显存选 Qwen 14B。16 GB 以上推理任务选 Mistral Small 24B。',
        bullets: [
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'For coding on 12 GB: Qwen 3 Coder 14B. For multilingual reasoning on 16 GB+: Mistral Small 3.1 24B. Below 10 GB: Llama 3.1 8B.',
        ],
      },
      body1: {
        title: 'VRAM Requirements: Which Card Runs Which Model',
        content: [
          'The choice between these three models is primarily a VRAM decision. At Q4_K_M quantization: Llama 3.1 8B uses 4.9 GB, Qwen 3 14B uses 9.3 GB, and Mistral Small 3.1 24B uses 14.4 GB. This maps directly onto three GPU tiers: 6–8 GB cards (Llama 3.1 8B only), 10–12 GB cards (Qwen 3 14B), and 16+ GB cards (Mistral Small 24B).',
          'Speed on RTX 4090 at Q4_K_M: Llama 3.1 8B runs at approximately 45 tok/s, Qwen 3 14B at ~28 tok/s, and Mistral Small 3.1 24B at ~20 tok/s. On an RTX 3060 12 GB, only Llama 3.1 8B and Qwen 3 14B fit — Mistral Small 24B requires at minimum a 16 GB card to avoid spilling to CPU RAM.',
          'The benchmark spread is meaningful: Mistral Small 24B\'s 81% MMLU is 14 points above Llama 3.1 8B and 6 points above Qwen 3 14B. On complex multi-step reasoning and instruction-following tasks, this gap is noticeable in practice.',
        ],
      ...
      body2: {
        ...
        content: [
          ...
          '<strong>Qwen 3 14B wins at 12 GB VRAM.</strong> Its 74.8% MMLU places it well above Llama 3.1 8B on reasoning and coding — and it fits within the most common prosumer GPU tier. The Qwen Coder 14B variant (same size, code-tuned) scores approximately 78% on HumanEval. If your primary use is coding and you have a 12 GB card, Qwen 3 14B is the answer.',
  ...
  de: {
    ...
    title: 'Mistral Small 24B vs. Qwen 3 14B vs. Llama 3.1 8B: Welches lokal ausführen?',
    seoTitle: 'Mistral Small 24B vs. Qwen 14B vs. Llama 8B 2026',
    metaDescription: 'Llama 3.1 8B: 4,9 GB VRAM. Qwen 3 14B: 9,3 GB, MMLU 74,8 %. Mistral Small 24B: 14,4 GB, MMLU 81 %. Auswahl nach VRAM-Tier. Schnelle Antwort von PromptQuorum.',
    publishDate: '2026-05-23',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Für Coding auf 12 GB: Qwen 3 Coder 14B. Für mehrsprachiges Reasoning auf 16 GB+: Mistral Small 3.1 24B. Unter 10 GB: Llama 3.1 8B.',
        ],
      },
      body1: {
        title: 'VRAM-Anforderungen: Welche Karte führt welches Modell aus',
        content: [
          'Die Wahl zwischen diesen drei Modellen ist primär eine VRAM-Entscheidung. Bei Q4_K_M-Quantisierung: Llama 3.1 8B verwendet 4,9 GB, Qwen 3 14B 9,3 GB und Mistral Small 3.1 24B 14,4 GB. Dies ordnet sich direkt drei GPU-Tiers zu: 6–8 GB Karten (nur Llama 3.1 8B), 10–12 GB Karten (Qwen 3 14B) und 16+ GB Karten (Mistral Small 24B).',
          'Geschwindigkeit auf RTX 4090 bei Q4_K_M: Llama 3.1 8B läuft bei etwa 45 tok/s, Qwen 3 14B bei ~28 tok/s und Mistral Small 3.1 24B bei ~20 tok/s. Auf einer RTX 3060 12 GB passen nur Llama 3.1 8B und Qwen 3 14B — Mistral Small 24B benötigt mindestens eine 16 GB Karte, um kein CPU-RAM zu belegen.',
          'Der Benchmark-Abstand ist bedeutsam: Mistral Small 24Bs 81 % MMLU liegt 14 Punkte über Llama 3.1 8B und 6 Punkte über Qwen 3 14B. Bei komplexen mehrstufigen Reasoning- und Instruktionsbefolgungsaufgaben ist diese Lücke in der Praxis spürbar.',
        ],
  ...
  fr: {
    ...
    title: 'Mistral Small 24B vs Qwen 3 14B vs Llama 3.1 8B : lequel lancer en local ?',
    seoTitle: 'Mistral Small 24B vs Qwen 14B vs Llama 8B 2026 | Prompt Bites | PromptQuorum',
    metaDescription: 'Llama 3.1 8B : 4,9 Go VRAM. Qwen 3 14B : 9,3 Go, MMLU 74,8 %. Mistral Small 24B : 14,4 Go, MMLU 81 %. Choisissez selon le tier VRAM. Réponse rapide de PromptQuorum.',
    publishDate: '2026-05-23',
    dateModified: '2026-06-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-23',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Pour le coding sur 12 Go : Qwen 3 Coder 14B. Pour le raisonnement multilingue sur 16 Go+ : Mistral Small 3.1 24B. En dessous de 10 Go : Llama 3.1 8B.',
        ],
      },
      body1: {
        title: 'Besoins en VRAM : quelle carte fait tourner quel modèle',
        content: [
          'Le choix entre ces trois modèles est avant tout une décision de VRAM. En quantification Q4_K_M : Llama 3.1 8B utilise 4,9 Go, Qwen 3 14B utilise 9,3 Go, et Mistral Small 3.1 24B utilise 14,4 Go. Cela correspond directement à trois tiers de GPU : cartes 6–8 Go (Llama 3.1 8B uniquement), cartes 10–12 Go (Qwen 3 14B), et cartes 16+ Go (Mistral Small 24B).',
          'Vitesse sur RTX 4090 en Q4_K_M : Llama 3.1 8B tourne à environ 45 tok/s, Qwen 3 14B à ~28 tok/s, et Mistral Small 3.1 24B à ~20 tok/s. Sur une RTX 3060 12 Go, seuls Llama 3.1 8B et Qwen 3 14B rentrent — Mistral Small 24B nécessite au minimum une carte 16 Go pour éviter de déborder sur la RAM CPU.',
          'L\'écart de benchmark est significatif : le 81 % MMLU de Mistral Small 24B est 14 points au-dessus de Llama 3.1 8B et 6 points au-dessus de Qwen 3 14B. Sur des tâches complexes de raisonnement multi-étapes et de suivi d\'instructions, cet écart est perceptible en pratique.',
        ],
  ...
  ja: {
    ...
    title: 'Mistral Small 24B・Qwen 3 14B・Llama 3.1 8B：ローカルでどれを動かすべきか？',
    seoTitle: 'Mistral Small 24B vs Qwen 14B vs Llama 8B 2026 | Prompt Bites | PromptQuorum',
    metaDescription: 'Llama 3.1 8B：4.9 GB VRAM。Qwen 3 14B：9.3 GB、MMLU 74.8%。Mistral Small 24B：14.4 GB、MMLU 81%。VRAMティアで選択。PromptQuorumによる簡潔な回答。',
    publishDate: '2026-05-23',
    dateModified: '2026-06-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-23',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '12 GBでのコーディング：Qwen 3 Coder 14B。16 GB+での多言語推論：Mistral Small 3.1 24B。10 GB未満：Llama 3.1 8B。',
        ],
      },
      body1: {
        title: 'VRAM要件：どのカードがどのモデルを動かせるか',
        content: [
          'この3モデルの選択は主にVRAMの問題です。Q4_K_M量子化で：Llama 3.1 8Bは4.9 GB、Qwen 3 14Bは9.3 GB、Mistral Small 3.1 24Bは14.4 GBを使用します。これは3つのGPUティアに直接対応します：6〜8 GBカード（Llama 3.1 8Bのみ）、10〜12 GBカード（Qwen 3 14B）、16 GB以上のカード（Mistral Small 24B）。',
          'RTX 4090でのQ4_K_M速度：Llama 3.1 8Bは約45 tok/s、Qwen 3 14Bは~28 tok/s、Mistral Small 3.1 24Bは~20 tok/sで動作します。RTX 3060 12 GBではLlama 3.1 8BとQwen 3 14Bのみ収まります — Mistral Small 24BはCPU RAMへのスピルを避けるため最低でも16 GBカードが必要です。',
          'ベンチマークの差は意味があります：Mistral Small 24BのMMLU 81%はLlama 3.1 8Bより14ポイント、Qwen 3 14Bより6ポイント高いです。複雑な多段階推論や指示遵守タスクでは、この差は実際に体感できます。',
        ],
      ...
      body2: {
        ...
        content: [
          ...
          '<strong>Qwen 3 14Bは12 GB VRAMで勝ります。</strong> MMLU 74.8%で推論とコーディングにおいてLlama 3.1 8Bを大きく上回り、最も一般的なプロシューマーGPUティア内に収まります。Qwen Coder 14Bバリアント（同サイズ、コード最適化）はHumanEvalで約78%を記録します。主にコーディングに使用し12 GBカードをお持ちの場合、Qwen 3 14Bが答えです。',
  ...
  zh: {
    ...
    title: 'Mistral Small 24B 对比 Qwen 3 14B 对比 Llama 3.1 8B：本地运行选哪个？',
    seoTitle: 'Mistral Small 24B vs Qwen 14B vs Llama 8B 2026 | Prompt Bites | PromptQuorum',
    metaDescription: 'Llama 3.1 8B：4.9 GB 显存。Qwen 3 14B：9.3 GB、MMLU 74.8%。Mistral Small 24B：14.4 GB、MMLU 81%。按显存层级选择。PromptQuorum 快速解答。',
    publishDate: '2026-05-23',
    dateModified: '2026-06-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-23',
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '12 GB 显卡编程：选 Qwen 3 Coder 14B。16 GB+ 多语言推理：选 Mistral Small 3.1 24B。10 GB 以下：选 Llama 3.1 8B。',
        ],
      },
      body1: {
        title: '显存要求：哪款显卡运行哪个模型',
        content: [
          '这三个模型之间的选择主要是显存决策。在 Q4_K_M 量化下：Llama 3.1 8B 使用 4.9 GB，Qwen 3 14B 使用 9.3 GB，Mistral Small 3.1 24B 使用 14.4 GB。这直接对应三个 GPU 层级：6–8 GB 显卡（仅 Llama 3.1 8B）、10–12 GB 显卡（Qwen 3 14B）和 16 GB+ 显卡（Mistral Small 24B）。',
          'RTX 4090 上 Q4_K_M 速度：Llama 3.1 8B 约 45 tok/s，Qwen 3 14B 约 28 tok/s，Mistral Small 3.1 24B 约 20 tok/s。RTX 3060 12 GB 上只有 Llama 3.1 8B 和 Qwen 3 14B 能放下——Mistral Small 24B 至少需要 16 GB 显卡以避免溢出到 CPU 内存。',
          '基准测试差距显著：Mistral Small 24B 的 MMLU 81% 比 Llama 3.1 8B 高 14 分，比 Qwen 3 14B 高 6 分。在复杂的多步推理和指令遵循任务上，这一差距在实践中是可以察觉到的。',
        ],
      ...
      body2: {
        ...
        content: [
          ...
          '<strong>Qwen 3 14B 在 12 GB 显存下胜出。</strong>其 74.8% MMLU 在推理和编程上远高于 Llama 3.1 8B——且适合最常见的专业消费级 GPU 层级。Qwen Coder 14B 变体（相同大小，代码优化）在 HumanEval 上得分约 78%。如果主要用途是编程且拥有 12 GB 显卡，Qwen 3 14B 就是答案。',
  ...
  pt: {
    ...
    title: 'Mistral Small 24B vs Qwen 3 14B vs Llama 3.1 8B: qual rodar localmente?',
    seoTitle: 'Mistral Small 24B vs Qwen 14B vs Llama 8B 2026',
    metaDescription: 'Llama 3.1 8B: 4,9 GB de VRAM. Qwen 3 14B: 9,3 GB, MMLU 74,8%. Mistral Small 24B: 14,4 GB, MMLU 81%. Escolha pelo nível de VRAM. Resposta rápida.',
    publishDate: '2026-05-23',
    dateModified: '2026-06-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-23',
    quickAnswerTop: {
      pt: {
        question: 'Mistral Small 24B vs Qwen 3 14B vs Llama 3.1 8B: qual devo rodar localmente?',
        answer: 'Escolha pelo VRAM: Llama 3.1 8B (4,9 GB), Qwen 3 14B (9,3 GB), Mistral Small 3.1 24B (14,4 GB). Qwen 14B ganha com 12 GB de VRAM. Mistral Small 24B ganha acima de 16 GB em tarefas de raciocínio.',
        bullets: [
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Para codificação em 12 GB: Qwen 3 Coder 14B. Para raciocínio multilíngue em 16 GB+: Mistral Small 3.1 24B. Abaixo de 10 GB: Llama 3.1 8B.',
        ],
      },
      body1: {
        title: 'Requisitos de VRAM: qual placa roda qual modelo',
        content: [
          'A escolha entre esses três modelos é principalmente uma decisão de VRAM. Em quantização Q4_K_M: Llama 3.1 8B usa 4,9 GB, Qwen 3 14B usa 9,3 GB e Mistral Small 3.1 24B usa 14,4 GB. Isso se corresponde diretamente a três níveis de GPU: placas de 6–8 GB (apenas Llama 3.1 8B), placas de 10–12 GB (Qwen 3 14B) e placas de 16+ GB (Mistral Small 24B).',
          'Velocidade na RTX 4090 em Q4_K_M: Llama 3.1 8B roda a aproximadamente 45 tok/s, Qwen 3 14B a ~28 tok/s e Mistral Small 3.1 24B a ~20 tok/s. Em uma RTX 3060 12 GB, apenas Llama 3.1 8B e Qwen 3 14B cabem — Mistral Small 24B requer no mínimo uma placa de 16 GB para evitar derramamento para a RAM da CPU.',
          'A diferença nos benchmarks é significativa: o MMLU 81% do Mistral Small 24B supera o Llama 3.1 8B em 14 pontos e o Qwen 3 14B em 6 pontos. Em tarefas complexas de raciocínio em várias etapas e seguimento de instruções, essa lacuna é perceptível na prática.',
        ],
  ...
  es: {
    ...
    title: 'Mistral Small 24B vs Qwen 3 14B vs Llama 3.1 8B: ¿cuál ejecutar en local?',
    seoTitle: 'Mistral Small 24B vs Qwen 14B vs Llama 8B 2026',
    metaDescription: 'Llama 3.1 8B: 4,9 GB VRAM. Qwen 3 14B: 9,3 GB, MMLU 74,8%. Mistral Small 24B: 14,4 GB, MMLU 81%. Elige según tu nivel de VRAM. Respuesta rápida.',
    publishDate: '2026-05-23',
    dateModified: '2026-06-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-23',
    quickAnswerTop: {
      es: {
        question: 'Mistral Small 24B vs Qwen 3 14B vs Llama 3.1 8B: ¿cuál debo ejecutar en local?',
        answer: 'Elige según el VRAM: Llama 3.1 8B (4.9 GB), Qwen 3 14B (9.3 GB), Mistral Small 3.1 24B (14.4 GB). Qwen 14B gana con 12 GB de VRAM. Mistral Small 24B gana por encima de 16 GB en tareas de razonamiento.',
        bullets: [
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'Para coding en 12 GB: Qwen 3 Coder 14B. Para razonamiento multilingüe en 16 GB+: Mistral Small 3.1 24B. Por debajo de 10 GB: Llama 3.1 8B.',
        ],
      },
      body1: {
        title: 'Requisitos de VRAM: qué tarjeta ejecuta qué modelo',
        content: [
          'La elección entre estos tres modelos es principalmente una decisión de VRAM. En cuantización Q4_K_M: Llama 3.1 8B usa 4.9 GB, Qwen 3 14B usa 9.3 GB y Mistral Small 3.1 24B usa 14.4 GB. Esto se corresponde directamente con tres niveles de GPU: tarjetas de 6–8 GB (solo Llama 3.1 8B), tarjetas de 10–12 GB (Qwen 3 14B) y tarjetas de 16+ GB (Mistral Small 24B).',
          'Velocidad en RTX 4090 en Q4_K_M: Llama 3.1 8B corre a aproximadamente 45 tok/s, Qwen 3 14B a ~28 tok/s y Mistral Small 3.1 24B a ~20 tok/s. En una RTX 3060 12 GB, solo caben Llama 3.1 8B y Qwen 3 14B — Mistral Small 24B necesita como mínimo una tarjeta de 16 GB para evitar volcar a la RAM de la CPU.',
          'La diferencia en benchmarks es significativa: el 81% MMLU de Mistral Small 24B supera en 14 puntos a Llama 3.1 8B y en 6 puntos a Qwen 3 14B. En tareas complejas de razonamiento multi-paso y seguimiento de instrucciones, esta diferencia es notable en la práctica.',
        ],
  ...
  ar: {
    ...
    title: '⁨Mistral Small 24B⁩ مقابل ⁨Qwen 3 14B⁩ مقابل ⁨Llama 3.1 8B⁩: أيهما تشغّل محلياً؟',
    seoTitle: '⁨Mistral Small 24B⁩ مقابل ⁨Qwen 14B⁩ مقابل ⁨Llama 8B 2026⁩',
    metaDescription: '⁨Llama 3.1 8B⁩: ⁨4.9 GB VRAM⁩ و⁨66.6% MMLU. Qwen 3 14B⁩: ⁨9.3 GB⁩ و⁨74.8% MMLU. Mistral Small 24B⁩: ⁨14.4 GB⁩ و⁨81% MMLU⁩. اختر النموذج بحسب حجم ⁨VRAM⁩ المتاح.',
    publishDate: '2026-05-23',
    dateModified: '2026-06-20',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-23',
    quickAnswerTop: {
      ar: {
        question: 'Mistral Small 24B مقابل Qwen 3 14B مقابل Llama 3.1 8B: أيهما يجب تشغيله محلياً؟',
        answer: 'اختر حسب VRAM: Llama 3.1 8B (4.9 GB)، Qwen 3 14B (9.3 GB)، Mistral Small 3.1 24B (14.4 GB). Qwen 14B يتفوق بـ 12 GB من VRAM. Mistral Small 24B يتفوق فوق 16 GB في مهام الاستدلال.',
        bullets: [
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          'للبرمجة على 12 GB: Qwen 3 Coder 14B. للاستدلال متعدد اللغات على 16 GB+: Mistral Small 3.1 24B. أقل من 10 GB: Llama 3.1 8B.',
        ],
      },
      body1: {
        title: 'متطلبات VRAM: أي بطاقة تشغّل أي نموذج',
        content: [
          'الاختيار بين هذه النماذج الثلاثة هو في الأساس قرار VRAM. عند تكميم Q4_K_M: Llama 3.1 8B يستخدم 4.9 GB، Qwen 3 14B يستخدم 9.3 GB، وMistral Small 3.1 24B يستخدم 14.4 GB. هذا يتوافق مباشرةً مع ثلاثة مستويات من GPU: بطاقات 6–8 GB (Llama 3.1 8B فقط)، بطاقات 10–12 GB (Qwen 3 14B)، وبطاقات 16+ GB (Mistral Small 24B).',
          'السرعة على RTX 4090 بتكميم Q4_K_M: Llama 3.1 8B يعمل بـ ~45 توكن/ث، Qwen 3 14B بـ ~28 توكن/ث، وMistral Small 3.1 24B بـ ~20 توكن/ث. على RTX 3060 12 GB، يتسع فقط Llama 3.1 8B وQwen 3 14B — Mistral Small 24B يحتاج على الأقل بطاقة 16 GB لتجنب نقل الأحمال إلى RAM وحدة المعالجة.',
          'الفرق في المعايير القياسية كبير: 81% MMLU لـ Mistral Small 24B يتفوق بـ 14 نقطة على Llama 3.1 8B وبـ 6 نقاط على Qwen 3 14B. في مهام الاستدلال متعدد الخطوات المعقدة واتباع التعليمات، هذا الفارق ملحوظ عملياً.',
        ],
      ...
      body2: {
        ...
        content: [
          ...
          '<strong>Qwen 3 14B يتفوق بـ 12 GB VRAM.</strong> 74.8% MMLU يضعه فوق Llama 3.1 8B في الاستدلال والبرمجة — ويتسع في أكثر مستويات GPU شيوعاً للمحترفين. نسخة Qwen Coder 14B (نفس الحجم، محسّنة للكود) تحقق ~78% في HumanEval.',
  ...
  ko: {
    ...
    title: 'Mistral Small 24B vs Qwen 3 14B vs Llama 3.1 8B: 로컬에서 무엇을 실행할까?',
    seoTitle: 'Mistral Small 24B vs Qwen 14B vs Llama 8B 2026 | PromptQuorum',
    metaDescription: 'Llama 3.1 8B: 4.9 GB VRAM, MMLU 66.6%. Qwen 3 14B: 9.3 GB, MMLU 74.8%. Mistral Small 24B: 14.4 GB, MMLU 81%. VRAM 용량에 따라 최적 모델을 선택하십시오.',
    publishDate: '2026-05-23',
    ...
    quickAnswerTop: {
      ko: {
        question: 'Mistral Small 24B vs Qwen 3 14B vs Llama 3.1 8B: 로컬에서 무엇을 실행해야 합니까?',
        answer: 'VRAM에 따라 선택하십시오: Llama 3.1 8B(4.9 GB), Qwen 3 14B(9.3 GB), Mistral Small 3.1 24B(14.4 GB). 12 GB VRAM에서는 Qwen 14B가 최적입니다. 16 GB 이상의 추론 작업에서는 Mistral Small 24B가 우위를 보입니다.',
        bullets: [
    ...
    sections: {
      tldr: {
        ...
        items: [
          ...
          '12 GB에서 코딩 작업: Qwen 3 Coder 14B. 16 GB 이상에서 다국어 추론: Mistral Small 3.1 24B. 10 GB 미만: Llama 3.1 8B.',
        ],
      },
      body1: {
        title: 'VRAM 요구 사항: 어느 카드가 어느 모델을 실행하는가',
        content: [
          '이 세 가지 모델 중에서의 선택은 기본적으로 VRAM에 관한 결정입니다. Q4_K_M 양자화 기준: Llama 3.1 8B는 4.9 GB, Qwen 3 14B는 9.3 GB, Mistral Small 3.1 24B는 14.4 GB를 사용합니다. 이는 세 가지 GPU 계층에 직접 대응됩니다: 6~8 GB 카드(Llama 3.1 8B만 가능), 10~12 GB 카드(Qwen 3 14B), 16 GB 이상 카드(Mistral Small 24B).',
          'RTX 4090에서 Q4_K_M 기준 속도: Llama 3.1 8B는 약 45 tok/s, Qwen 3 14B는 ~28 tok/s, Mistral Small 3.1 24B는 ~20 tok/s입니다. RTX 3060 12 GB에서는 Llama 3.1 8B와 Qwen 3 14B만 탑재 가능합니다 — Mistral Small 24B는 CPU RAM으로의 스필을 방지하려면 최소 16 GB 카드가 필요합니다.',
          '벤치마크 차이는 중요합니다: Mistral Small 24B의 MMLU 81%는 Llama 3.1 8B보다 14점, Qwen 3 14B보다 6점 높습니다. 복잡한 다단계 추론 및 지시 이행 작업에서 이 격차는 실제로 체감됩니다.',
        ],
        snippetBlocks: [
          { type: 'one-sentence', text: 'Q4_K_M 양자화 기준으로 Llama 3.1 8B는 4.9 GB VRAM, Qwen 3 14B는 9.3 GB, Mistral Small 3.1 24B는 14.4 GB를 사용합니다.' },
          { type: 'plain-terms', text: 'VRAM 6~8 GB: Llama 3.1 8B만 가능합니다. VRAM 12 GB: Qwen 3 14B가 최적입니다. VRAM 16 GB 이상: Mistral Small 24B가 최고 품질을 제공합니다.' },
        ],
      ...
      body2: {
        ...
        content: [
          ...
          '<strong>Qwen 3 14B는 12 GB VRAM에서 최적입니다.</strong> MMLU 74.8%로 추론 및 코딩에서 Llama 3.1 8B를 크게 상회하며 가장 일반적인 프로슈머 GPU 계층에 탑재됩니다. Qwen Coder 14B 변형(동일 크기, 코드 최적화)은 HumanEval에서 약 78%를 달성합니다. 주요 용도가 코딩이고 12 GB 카드를 보유하고 있다면 Qwen 3 14B가 정답입니다.',
