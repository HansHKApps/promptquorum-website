...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: 'Qwen and DeepSeek, developed by PRC companies under domestic content-review requirements, are the most-used local LLMs for mainland-China-facing deployments.',
  ...
  de: {
    ...
    metaDescription: 'Qwen und DeepSeek, entwickelt von chinesischen Unternehmen unter inländischen Content-Review-Anforderungen, sind die meistgenutzten lokalen LLMs für China-gerichtete Deployments.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  es: {
    ...
    metaDescription: 'Qwen y DeepSeek, desarrollados por empresas de la RPC bajo requisitos nacionales de revisión de contenido, son los LLM locales más usados para despliegues orientados a China continental.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  pt: {
    ...
    metaDescription: 'O Qwen e o DeepSeek, desenvolvidos por empresas da RPC sob requisitos domésticos de revisão de conteúdo, são os LLMs locais mais usados para implantações voltadas à China continental.',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
  ...
  zh: {
    ...
    metaDescription: '由中国大陆企业在国内内容审核要求下开发的 Qwen 和 DeepSeek，是面向中国大陆的部署中使用最广泛的本地 LLM。',
    publishDate: '2026-07-14',
    dateModified: '2026-07-14',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-01-14',
