...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  ar: {
    ...
    seoTitle: '6 GB VRAM: أفضل نموذج لغوي محلي 2026 | PromptQuorum',
    metaDescription: 'Llama 3 8B Q4_K_M (5.5 GB) هو الخيار الأمثل لـ 6 GB من VRAM. Phi-4 Q4_K_M وMistral Small Q4_K_S بدائل قوية. إجابة سريعة من PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
