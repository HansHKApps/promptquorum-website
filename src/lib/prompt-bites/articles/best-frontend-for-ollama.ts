...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  ...
  de: {
    ...
    metaDescription: 'Open WebUI ist das beste Ollama-Frontend. SillyTavern für Rollenspiele. Jan ergänzt die Modellverwaltung. Alle kostenlos. Schnelle Antwort von PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-06-18',
    quickAnswerTop: {
  ...
  fr: {
    ...
    metaDescription: 'Open WebUI est le meilleur frontend Ollama. SillyTavern pour le jeu de rôle. Jan ajoute la gestion de modèles. Tous gratuits. Réponse rapide par PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-06-18',
    quickAnswerTop: {
  ...
  ja: {
    ...
    metaDescription: 'Open WebUIはOllamaに最適なフロントエンドです。ロールプレイにはSillyTavern。Janはモデル管理を追加します。すべて無料。PromptQuorumによる簡潔な回答。',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-06-18',
    quickAnswerTop: {
  ...
  zh: {
    ...
    seoTitle: 'Ollama 最佳前端是什么？| Prompt Bites | PromptQuorum',
    metaDescription: 'Open WebUI 是最佳 Ollama 前端。SillyTavern 适合角色扮演。Jan 提供模型管理。全部免费。PromptQuorum 快速解答。',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-06-18',
    quickAnswerTop: {
