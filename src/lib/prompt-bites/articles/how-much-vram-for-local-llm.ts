...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    metaDescription: '4 GB runs Llama 3.2 3B Q4. 6 GB handles Llama 3.1 8B Q4_K_M. 12 GB unlocks Qwen3 14B. Formula: params × 0.6 = GB at Q4. VRAM tier guide from PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-03-02',
    current_models_mentioned: ['Llama 3.2 3B', 'Phi-3.5-mini', 'Llama 3.1 8B', 'Qwen3 14B'],
    ...
    quickAnswerTop: {
      en: {
        ...
        answer: '4 GB VRAM handles Llama 3.2 3B and Phi-3.5-mini comfortably with safe headroom for context expansion. 6 GB runs Llama 3.1 8B at Q4. 12 GB fits Qwen3 14B Q4 efficiently. 16+ GB is needed for 70B models at Q4.',
        bullets: [
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          '4 GB VRAM runs Llama 3.2 3B and Phi-3.5-mini Q4 comfortably',
          '6 GB is the entry point for Llama 3.1 8B at Q4_K_M — the most popular local model size',
          '12 GB unlocks Qwen3 14B Q4, the best quality-per-dollar tier',
      ...
      body1: {
        ...
        content: [
          'A model\'s VRAM need follows a simple formula, verified against real GGUF file sizes: parameter count in billions × 0.6 = approximate GB at Q4 quantization. <strong>An 8B model needs ~4.8 GB for weights, plus 0.5–1 GB of context overhead.</strong> This is why 6 GB is the minimum for the 7–8B tier, and why 12 GB unlocks the 14B tier with breathing room.',
          ...
          '<strong>Always keep 1–2 GB of VRAM free above your model\'s stated needs.</strong> Operating systems, browser tabs, and Ollama\'s runtime consume 500 MB–1 GB even with no model loaded. A 6 GB card running Llama 3.1 8B Q4_K_M (~4.8 GB) leaves only about 1.2 GB headroom — you\'ll hit out-of-memory errors if you increase <code>--num-ctx</code> much beyond 2048 tokens. For the 6 GB tier with safe headroom, see <a href="/prompt-bites/best-local-llm-6gb-vram" class="text-primary hover:underline">best local LLMs for 6 GB VRAM</a>.',
        ],
        columns: ['VRAM', 'Best Model at Q4_K_M', 'Speed'],
        rows: [
          { 'VRAM': '4 GB', 'Best Model at Q4_K_M': 'Llama 3.2 3B or Phi-3.5-mini Q4', 'Speed': '~25 tok/s' },
          { 'VRAM': '6 GB', 'Best Model at Q4_K_M': 'Llama 3.1 8B Q4_K_M', 'Speed': '~20 tok/s' },
          { 'VRAM': '8 GB', 'Best Model at Q4_K_M': 'Llama 3.1 8B Q5_K_M', 'Speed': '~18 tok/s' },
          { 'VRAM': '12 GB', 'Best Model at Q4_K_M': 'Qwen3 14B Q4_K_M', 'Speed': '~15 tok/s' },
          { 'VRAM': '16+ GB', 'Best Model at Q4_K_M': 'Qwen3 32B Q4 or Llama 3.3 70B partial', 'Speed': '~8 tok/s' },
        ],
      },
      body2: {
        ...
        content: [
          ...
          'CPU offload works but is slow — each layer moved to RAM adds latency. For interactive use, stay within your GPU\'s VRAM limit. Reducing context from 4096 to 2048 tokens saves approximately 2 GB on a 7-8B model.',
        ...
        faqs: [
          {
            ...
            a: 'Yes. 8 GB runs Llama 3.1 8B at Q5_K_M at around 18 tokens per second, with headroom to spare. Most day-to-day chat and coding tasks are well-covered at this tier.',
          },
          {
            q: 'Can I run a 7B model on 4 GB VRAM?',
            a: 'No. A 7B model at Q4 needs approximately 4.5–5.5 GB of VRAM (parameter count × 0.6, plus context overhead). The smallest usable quantization still exceeds 4 GB. See <a href="/prompt-bites/how-much-ram-for-7b-model" class="text-primary hover:underline">how much RAM a 7B model needs</a> for the full breakdown.',
          },
          {
  ...
  de: {
    ...
    metaDescription: '4 GB für Llama 3.2 3B bei Q4. 6 GB für Llama 3.1 8B Q4_K_M. 12 GB für Qwen3 14B. Formel: Parameter × 0,6 = GB bei Q4. VRAM-Stufenführer von PromptQuorum.',
    publishDate: '2026-05-18',
    dateModified: '2026-09-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-03-02',
    quickAnswerTop: {
      de: {
        ...
        answer: '4 GB VRAM reichen für Llama 3.2 3B und Phi-3.5-mini mit sicherer Pufferzone für Kontexterweiterung. 6 GB betreiben Llama 3.1 8B bei Q4. 12 GB fassen Qwen3 14B Q4 effizient. Für 70B-Modelle bei Q4 werden 16+ GB benötigt.',
        bullets: [
          '4 GB: Llama 3.2 3B Q4, Phi-3.5-mini Q4',
          '6 GB: Llama 3.1 8B Q4_K_M',
          '8–12 GB: Llama 3.1 8B Q5_K_M, Qwen3 14B Q4',
    ...
    sections: {
      ...
      body1: {
        ...
        content: [
          'Der VRAM-Bedarf eines Modells folgt einer einfachen, anhand realer GGUF-Dateigrößen verifizierten Formel: Parameteranzahl in Milliarden × 0,6 = ungefähre GB bei Q4-Quantisierung. <strong>Ein 8B-Modell benötigt ~4,8 GB für die Gewichte, plus 0,5–1 GB Kontext-Overhead.</strong> Deshalb sind 6 GB das Minimum für die 7–8B-Tier und warum 12 GB die 14B-Tier mit Spielraum freischaltet.',
          ...
          '<strong>Halten Sie stets 1–2 GB VRAM über dem angegebenen Bedarf Ihres Modells frei.</strong> Betriebssysteme, Browser-Tabs und die Ollama-Laufzeit verbrauchen 500 MB–1 GB, selbst wenn kein Modell geladen ist. Eine 6-GB-Karte, die Llama 3.1 8B Q4_K_M (~4,8 GB) betreibt, lässt nur etwa 1,2 GB Spielraum — Out-of-Memory-Fehler treten auf, sobald Sie <code>--num-ctx</code> deutlich über 2048 Tokens erhöhen. Für die 6-GB-Tier mit sicherem Spielraum, siehe <a href="/de/prompt-bites/best-local-llm-6gb-vram" class="text-primary hover:underline">beste lokale LLMs für 6 GB VRAM</a>.',
        ],
        columns: ['VRAM', 'Bestes Modell bei Q4_K_M', 'Geschwindigkeit'],
        rows: [
          { 'VRAM': '4 GB', 'Bestes Modell bei Q4_K_M': 'Llama 3.2 3B oder Phi-3.5-mini Q4', 'Geschwindigkeit': '~25 tok/s' },
          { 'VRAM': '6 GB', 'Bestes Modell bei Q4_K_M': 'Llama 3.1 8B Q4_K_M', 'Geschwindigkeit': '~20 tok/s' },
          { 'VRAM': '8 GB', 'Bestes Modell bei Q4_K_M': 'Llama 3.1 8B Q5_K_M', 'Geschwindigkeit': '~18 tok/s' },
          { 'VRAM': '12 GB', 'Bestes Modell bei Q4_K_M': 'Qwen3 14B Q4_K_M', 'Geschwindigkeit': '~15 tok/s' },
          { 'VRAM': '16+ GB', 'Bestes Modell bei Q4_K_M': 'Qwen3 32B Q4 oder Llama 3.3 70B partiell', 'Geschwindigkeit': '~8 tok/s' },
        ],
      },
      body2: {
        ...
        faqs: [
          {
            ...
            a: 'Ja. 8 GB betreibt Llama 3.1 8B bei Q5_K_M mit etwa 18 Tokens pro Sekunde, mit Spielraum übrig. Die meisten alltäglichen Chat- und Coding-Aufgaben sind bei dieser Tier gut abgedeckt.',
          },
          {
            q: 'Kann ich ein 7B-Modell auf 4 GB VRAM betreiben?',
            a: 'Nein. Ein 7B-Modell bei Q4 benötigt etwa 4,5–5,5 GB VRAM (Parameteranzahl × 0,6, plus Kontext-Overhead). Die kleinste nutzbare Quantisierung überschreitet immer noch 4 GB. Siehe <a href="/de/prompt-bites/how-much-ram-for-7b-model" class="text-primary hover:underline">wie viel RAM ein 7B-Modell benötigt</a> für die vollständige Aufschlüsselung.',
          },
          {
  ...
  fr: {
    ...
    metaDescription: '4 Go pour Llama 3.2 3B en Q4. 6 Go pour Llama 3.1 8B Q4_K_M. 12 Go pour Qwen3 14B. Formule : params × 0,6 = Go en Q4. Paliers VRAM par PromptQuorum.',
    publishDate: '2026-05-18',
    dateModified: '2026-09-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-03-02',
    quickAnswerTop: {
      fr: {
        ...
        answer: '4 Go VRAM suffisent pour Llama 3.2 3B et Phi-3.5-mini avec marge sûre pour expansion contexte. 6 Go font tourner Llama 3.1 8B en Q4. 12 Go accueillent Qwen3 14B Q4 efficacement. Les modèles 70B Q4 nécessitent 16+ Go.',
        bullets: [
    ...
    sections: {
      ...
      body1: {
        ...
        content: [
          'Le besoin en VRAM d\'un modèle suit une formule simple, vérifiée sur les tailles réelles des fichiers GGUF : nombre de paramètres en milliards × 0,6 = Go approximatifs en quantisation Q4. <strong>Un modèle 8B nécessite ~4,8 Go pour les poids, plus 0,5–1 Go de surcharge de contexte.</strong> C\'est pourquoi 6 Go est le minimum pour le tier 7–8B, et pourquoi 12 Go débloque le tier 14B avec de la marge.',
          ...
          '<strong>Gardez toujours 1–2 Go de VRAM libres au-dessus des besoins déclarés de votre modèle.</strong> Les systèmes d\'exploitation, les onglets de navigateur et le runtime d\'Ollama consomment 500 Mo–1 Go même sans modèle chargé. Une carte 6 Go faisant tourner Llama 3.1 8B Q4_K_M (~4,8 Go) ne laisse qu\'environ 1,2 Go de marge — vous rencontrerez des erreurs de mémoire insuffisante si vous augmentez <code>--num-ctx</code> nettement au-delà de 2048 tokens. Pour le tier 6 Go avec une marge sécurisée, voir <a href="/fr/prompt-bites/best-local-llm-6gb-vram" class="text-primary hover:underline">les meilleurs LLMs locaux pour 6 Go de VRAM</a>.',
        ],
        columns: ['VRAM', 'Meilleur modèle en Q4_K_M', 'Vitesse'],
        rows: [
          { 'VRAM': '4 Go', 'Meilleur modèle en Q4_K_M': 'Llama 3.2 3B ou Phi-3.5-mini Q4', 'Vitesse': '~25 tok/s' },
          { 'VRAM': '6 Go', 'Meilleur modèle en Q4_K_M': 'Llama 3.1 8B Q4_K_M', 'Vitesse': '~20 tok/s' },
          { 'VRAM': '8 Go', 'Meilleur modèle en Q4_K_M': 'Llama 3.1 8B Q5_K_M', 'Vitesse': '~18 tok/s' },
          { 'VRAM': '12 Go', 'Meilleur modèle en Q4_K_M': 'Qwen3 14B Q4_K_M', 'Vitesse': '~15 tok/s' },
          { 'VRAM': '16+ Go', 'Meilleur modèle en Q4_K_M': 'Qwen3 32B Q4 ou Llama 3.3 70B partiel', 'Vitesse': '~8 tok/s' },
        ],
      },
      body2: {
        ...
        faqs: [
          {
            ...
            a: 'Oui. 8 Go fait tourner Llama 3.1 8B en Q5_K_M à environ 18 tokens par seconde, avec de la marge. La plupart des tâches quotidiennes de chat et de coding sont bien couvertes à ce tier.',
          },
          {
            q: 'Puis-je faire tourner un modèle 7B sur 4 Go de VRAM ?',
            a: 'Non. Un modèle 7B en Q4 nécessite environ 4,5–5,5 Go de VRAM (nombre de paramètres × 0,6, plus surcharge de contexte). La plus petite quantisation utilisable dépasse encore les 4 Go. Voir <a href="/fr/prompt-bites/how-much-ram-for-7b-model" class="text-primary hover:underline">combien de RAM nécessite un modèle 7B</a> pour la répartition complète.',
          },
          {
  ...
  ja: {
    ...
    metaDescription: '4 GBでLlama 3.2 3Bが動作。6 GBでLlama 3.1 8B Q4が動作。12 GBでQwen3 14B Q4が収まります。PromptQuorumによるVRAM選択ガイド。',
    publishDate: '2026-05-18',
    dateModified: '2026-09-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-03-02',
    quickAnswerTop: {
      ja: {
        ...
        answer: '4 GB VRAMでLlama 3.2 3BとPhi-3.5-miniがコンテキスト拡張用安全余裕で動作します。6 GBではQ4でLlama 3.1 8Bが動作します。12 GBでQwen3 14B Q4を効率的に収納できます。70BモデルのQ4には16+ GBが必要です。',
        bullets: [
          '4 GB: Llama 3.2 3B Q4, Phi-3.5-mini Q4',
          '6 GB: Llama 3.1 8B Q4_K_M',
          '8–12 GB: Llama 3.1 8B Q5_K_M, Qwen3 14B Q4',
    ...
    sections: {
      ...
      body1: {
        ...
        content: [
          'モデルのVRAM要件は、実際のGGUFファイルサイズで検証済みの単純な計算式に従います：パラメータ数（十億単位）× 0.6 = Q4量化での概算GB。<strong>8Bモデルは重みに~4.8 GB、加えてコンテキストオーバーヘッドに0.5–1 GBが必要です。</strong>これが7–8Bティアの最小が6 GBである理由であり、12 GBが余裕を持って14Bティアを解放する理由です。',
          '以下の表を素早い決定リファレンスとして使用してください。「速度」列はデフォルトコンテキスト（2048トークン）で動作するデスクトップGPU上のOllamaを前提としています。',
          '<strong>モデルの必要VRAMより常に1–2 GB多くの空き容量を確保してください。</strong>OSや、ブラウザタブ、Ollamaのランタイムは、モデルを読み込んでいない状態でも500 MB–1 GBを消費します。Llama 3.1 8B Q4_K_M（~4.8 GB）を動かす6 GBカードには約1.2 GBしか余裕がなく、<code>--num-ctx</code>を2048トークンより大幅に増やすとメモリ不足エラーが発生します。安全な余裕のある6 GBティアについては、<a href="/ja/prompt-bites/best-local-llm-6gb-vram" class="text-primary hover:underline">6 GB VRAM向け最良ローカルLLM</a>を参照してください。',
        ],
        columns: ['VRAM', 'Q4_K_Mでの最良モデル', '速度'],
        rows: [
          { 'VRAM': '4 GB', 'Q4_K_Mでの最良モデル': 'Llama 3.2 3BまたはPhi-3.5-mini Q4', '速度': '~25 tok/s' },
          { 'VRAM': '6 GB', 'Q4_K_Mでの最良モデル': 'Llama 3.1 8B Q4_K_M', '速度': '~20 tok/s' },
          { 'VRAM': '8 GB', 'Q4_K_Mでの最良モデル': 'Llama 3.1 8B Q5_K_M', '速度': '~18 tok/s' },
          { 'VRAM': '12 GB', 'Q4_K_Mでの最良モデル': 'Qwen3 14B Q4_K_M', '速度': '~15 tok/s' },
          { 'VRAM': '16+ GB', 'Q4_K_Mでの最良モデル': 'Qwen3 32B Q4またはLlama 3.3 70B部分実行', '速度': '~8 tok/s' },
        ],
      },
      body2: {
        ...
        faqs: [
          {
            ...
            a: 'はい。8 GBはLlama 3.1 8BをQ5_K_Mで毎秒約18トークン、余裕を持って動作させられます。このティアでは日常的なチャットやコーディングタスクのほとんどに対応できます。',
          },
          {
            q: '4 GB VRAMで7Bモデルを動かせますか？',
            a: 'いいえ。Q4の7BモデルにはVRAM約4.5–5.5 GB（パラメータ数 × 0.6、加えてコンテキストオーバーヘッド）が必要です。最小の使用可能な量化でも4 GBを超えます。完全な内訳については<a href="/ja/prompt-bites/how-much-ram-for-7b-model" class="text-primary hover:underline">7Bモデルに必要なRAM量</a>を参照してください。',
          },
          {
  ...
  zh: {
    ...
    metaDescription: '本地大模型各参数规模所需显存参考（2026）：4 GB运行Llama 3.2 3B Q4；6 GB运行Llama 3.1 8B Q4_K_M；12 GB解锁Qwen3 14B；24 GB承载Qwen3 32B。通用公式：参数量（B）×0.6≈Q4量化所需显存（GB）。',
    publishDate: '2026-05-18',
    dateModified: '2026-09-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-03-02',
    quickAnswerTop: {
      zh: {
        ...
        answer: '4 GB显存可安全运行Llama 3.2 3B和Phi-3.5-mini并具有上下文扩展足够余量。6 GB可Q4运行Llama 3.1 8B。12 GB有效容纳Qwen3 14B Q4。70B模型Q4需16+ GB。',
        bullets: [
          '4 GB：Llama 3.2 3B Q4，Phi-3.5-mini Q4',
          '6 GB：Llama 3.1 8B Q4_K_M',
          '8–12 GB：Llama 3.1 8B Q5_K_M，Qwen3 14B Q4',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          '4 GB显存可流畅运行Llama 3.2 3B和Phi-3.5-mini',
          '6 GB是运行最流行本地模型规格Llama 3.1 8B Q4_K_M的最低门槛',
          '12 GB解锁Qwen3 14B Q4，性价比最优档位',
      ...
      body1: {
        title: '按模型大小划分的显存需求',
        content: [
          '模型的显存需求遵循一个经过真实GGUF文件大小验证的简单公式：参数量（十亿为单位）× 0.6 = Q4量化下的近似GB数。<strong>8B模型的权重需要约4.8 GB，另加0.5–1 GB的上下文开销。</strong>这就是为什么6 GB是7–8B档位的最低要求，以及12 GB能够为14B档位留有余量的原因。',
          '请将下表作为快速决策参考。「速度」列假设Ollama在台式机GPU上以默认上下文（2048令牌）运行。',
          '<strong>始终在模型声明需求基础上保留1–2 GB的空闲显存。</strong>操作系统、浏览器标签页和Ollama运行时即使在未加载模型时也会消耗500 MB–1 GB。运行Llama 3.1 8B Q4_K_M（约4.8 GB）的6 GB显卡只剩约1.2 GB余量——一旦将<code>--num-ctx</code>大幅增加到2048令牌以上就会出现内存不足错误。有关安全余量的6 GB档位建议，请参阅<a href="/zh/prompt-bites/best-local-llm-6gb-vram" class="text-primary hover:underline">6 GB显存最佳本地LLM</a>。',
        ],
        columns: ['显存', 'Q4_K_M最佳模型', '速度'],
        rows: [
          { '显存': '4 GB', 'Q4_K_M最佳模型': 'Llama 3.2 3B或Phi-3.5-mini Q4', '速度': '~25 tok/s' },
          { '显存': '6 GB', 'Q4_K_M最佳模型': 'Llama 3.1 8B Q4_K_M', '速度': '~20 tok/s' },
          { '显存': '8 GB', 'Q4_K_M最佳模型': 'Llama 3.1 8B Q5_K_M', '速度': '~18 tok/s' },
          { '显存': '12 GB', 'Q4_K_M最佳模型': 'Qwen3 14B Q4_K_M', '速度': '~15 tok/s' },
          { '显存': '16+ GB', 'Q4_K_M最佳模型': 'Qwen3 32B Q4或Llama 3.3 70B部分运行', '速度': '~8 tok/s' },
        ],
      },
      body2: {
        title: '显存不足时的解决方案',
        content: [
          ...
          'CPU卸载可以运行但速度较慢——每个移至RAM的层都会增加延迟。对于交互式使用，请保持在GPU显存限制内。将上下文从4096缩减到2048令牌，7-8B模型约可节省2 GB显存。',
      ...
      faq: {
        ...
        faqs: [
          {
            q: '8 GB显存足够运行本地LLM吗？',
            a: '足够。8 GB可以Q5_K_M运行Llama 3.1 8B，速度约每秒18个令牌，还有充足余量。在此档位下，日常聊天和编程任务都能得到良好支持。',
          },
          {
            q: '4 GB显存能运行7B模型吗？',
            a: '不能。Q4的7B模型需要约4.5–5.5 GB显存（参数量 × 0.6，另加上下文开销），最小可用量化仍超过4 GB。完整分析请参阅<a href="/zh/prompt-bites/how-much-ram-for-7b-model" class="text-primary hover:underline">7B模型所需RAM量</a>。',
          },
          {
            q: '上下文窗口大小会影响显存使用量吗？',
  ...
  pt: {
    ...
    metaDescription: '4 GB para Llama 3.2 3B Q4. 6 GB para Llama 3.1 8B Q4_K_M. 12 GB para Qwen3 14B. Fórmula: params × 0,6 = GB em Q4. Guia de VRAM do PromptQuorum.',
    publishDate: '2026-05-18',
    dateModified: '2026-09-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-03-02',
    quickAnswerTop: {
      pt: {
        ...
        answer: '4 GB de VRAM suporta Llama 3.2 3B e Phi-3.5-mini confortavelmente com margem para expansão de contexto. 6 GB roda Llama 3.1 8B em Q4. 12 GB acomoda Qwen3 14B Q4 eficientemente. Modelos 70B em Q4 requerem 16+ GB.',
        bullets: [
          '4 GB: Llama 3.2 3B Q4, Phi-3.5-mini Q4',
          '6 GB: Llama 3.1 8B Q4_K_M',
          '8–12 GB: Llama 3.1 8B Q5_K_M, Qwen3 14B Q4',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          '4 GB de VRAM roda Llama 3.2 3B e Phi-3.5-mini sem problemas',
          '6 GB é o ponto de entrada para Llama 3.1 8B em Q4_K_M — o tamanho de modelo local mais popular',
          '12 GB desbloqueia Qwen3 14B Q4, o melhor nível de qualidade por preço',
      ...
      body1: {
        ...
        content: [
          'A necessidade de VRAM de um modelo segue uma fórmula simples, verificada com base em tamanhos reais de arquivos GGUF: contagem de parâmetros em bilhões × 0,6 = GB aproximados em quantização Q4. <strong>Um modelo 8B precisa de ~4,8 GB para os pesos, mais 0,5–1 GB de sobrecarga de contexto.</strong> É por isso que 6 GB é o mínimo para o nível 7–8B, e 12 GB desbloqueia o nível 14B com folga.',
          ...
          '<strong>Sempre mantenha 1–2 GB de VRAM livres acima das necessidades declaradas do seu modelo.</strong> Sistemas operacionais, abas do navegador e o runtime do Ollama consomem 500 MB–1 GB mesmo sem nenhum modelo carregado. Uma placa de 6 GB rodando Llama 3.1 8B Q4_K_M (~4,8 GB) deixa apenas cerca de 1,2 GB de margem — você terá erros de falta de memória se aumentar <code>--num-ctx</code> bem além de 2048 tokens. Para o nível de 6 GB com margem segura, veja <a href="/pt/prompt-bites/best-local-llm-6gb-vram" class="text-primary hover:underline">os melhores LLMs locais para 6 GB de VRAM</a>.',
        ],
        columns: ['VRAM', 'Melhor modelo em Q4_K_M', 'Velocidade'],
        rows: [
          { 'VRAM': '4 GB', 'Melhor modelo em Q4_K_M': 'Llama 3.2 3B ou Phi-3.5-mini Q4', 'Velocidade': '~25 tok/s' },
          { 'VRAM': '6 GB', 'Melhor modelo em Q4_K_M': 'Llama 3.1 8B Q4_K_M', 'Velocidade': '~20 tok/s' },
          { 'VRAM': '8 GB', 'Melhor modelo em Q4_K_M': 'Llama 3.1 8B Q5_K_M', 'Velocidade': '~18 tok/s' },
          { 'VRAM': '12 GB', 'Melhor modelo em Q4_K_M': 'Qwen3 14B Q4_K_M', 'Velocidade': '~15 tok/s' },
          { 'VRAM': '16+ GB', 'Melhor modelo em Q4_K_M': 'Qwen3 32B Q4 ou Llama 3.3 70B parcial', 'Velocidade': '~8 tok/s' },
        ],
      },
      body2: {
        ...
        content: [
          ...
          'O offload para CPU funciona, mas é lento — cada camada movida para a RAM adiciona latência. Para uso interativo, fique dentro do limite de VRAM da sua GPU. Reduzir o contexto de 4096 para 2048 tokens economiza aproximadamente 2 GB em um modelo 7-8B.',
        ...
        faqs: [
          {
            ...
            a: 'Sim. 8 GB roda Llama 3.1 8B em Q5_K_M a cerca de 18 tokens por segundo, com margem de sobra. A maioria das tarefas cotidianas de chat e codificação são bem cobertas neste nível.',
          },
          {
            q: 'Posso rodar um modelo 7B com 4 GB de VRAM?',
            a: 'Não. Um modelo 7B em Q4 precisa de aproximadamente 4,5–5,5 GB de VRAM (contagem de parâmetros × 0,6, mais sobrecarga de contexto). A menor quantização utilizável ainda excede 4 GB. Veja <a href="/pt/prompt-bites/how-much-ram-for-7b-model" class="text-primary hover:underline">quanta RAM um modelo 7B precisa</a> para o detalhamento completo.',
          },
          {
  ...
  es: {
    ...
    metaDescription: '4 GB para Llama 3.2 3B Q4. 6 GB para Llama 3.1 8B Q4_K_M. 12 GB para Qwen3 14B. Fórmula: params × 0,6 = GB en Q4. Guía de VRAM de PromptQuorum.',
    publishDate: '2026-05-18',
    dateModified: '2026-09-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-03-02',
    quickAnswerTop: {
      es: {
        ...
        answer: '4 GB de VRAM soporta Llama 3.2 3B y Phi-3.5-mini cómodamente con margen para expansión de contexto. 6 GB ejecuta Llama 3.1 8B en Q4. 12 GB aloja Qwen3 14B Q4 eficientemente. Los modelos 70B en Q4 requieren 16+ GB.',
        bullets: [
          '4 GB: Llama 3.2 3B Q4, Phi-3.5-mini Q4',
          '6 GB: Llama 3.1 8B Q4_K_M',
          '8–12 GB: Llama 3.1 8B Q5_K_M, Qwen3 14B Q4',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          '4 GB de VRAM ejecuta Llama 3.2 3B y Phi-3.5-mini sin problemas',
          '6 GB es el punto de entrada para Llama 3.1 8B en Q4_K_M — el tamaño de modelo local más popular',
          '12 GB desbloquea Qwen3 14B Q4, el mejor escalón de calidad por precio',
      ...
      body1: {
        ...
        content: [
          'El consumo de VRAM de un modelo sigue una fórmula sencilla, verificada con tamaños reales de archivos GGUF: parámetros en miles de millones × 0,6 = GB aproximados en cuantización Q4. <strong>Un modelo 8B necesita ~4,8 GB para los pesos, más 0,5–1 GB de sobrecarga de contexto.</strong> Por eso 6 GB es el mínimo para el rango 7–8B, y 12 GB desbloquea el rango 14B con margen.',
          ...
          '<strong>Deja siempre 1–2 GB de VRAM libres por encima de las necesidades declaradas del modelo.</strong> El sistema operativo, las pestañas del navegador y el runtime de Ollama consumen 500 MB–1 GB incluso sin modelo cargado. Una tarjeta de 6 GB ejecutando Llama 3.1 8B Q4_K_M (~4,8 GB) solo deja unos 1,2 GB de margen — tendrás errores de memoria si aumentas <code>--num-ctx</code> bastante más allá de 2048 tokens. Para el rango de 6 GB con margen seguro, consulta <a href="/es/prompt-bites/best-local-llm-6gb-vram" class="text-primary hover:underline">los mejores LLMs locales para 6 GB de VRAM</a>.',
        ],
        columns: ['VRAM', 'Mejor modelo en Q4_K_M', 'Velocidad'],
        rows: [
          { 'VRAM': '4 GB', 'Mejor modelo en Q4_K_M': 'Llama 3.2 3B o Phi-3.5-mini Q4', 'Velocidad': '~25 tok/s' },
          { 'VRAM': '6 GB', 'Mejor modelo en Q4_K_M': 'Llama 3.1 8B Q4_K_M', 'Velocidad': '~20 tok/s' },
          { 'VRAM': '8 GB', 'Mejor modelo en Q4_K_M': 'Llama 3.1 8B Q5_K_M', 'Velocidad': '~18 tok/s' },
          { 'VRAM': '12 GB', 'Mejor modelo en Q4_K_M': 'Qwen3 14B Q4_K_M', 'Velocidad': '~15 tok/s' },
          { 'VRAM': '16+ GB', 'Mejor modelo en Q4_K_M': 'Qwen3 32B Q4 o Llama 3.3 70B parcial', 'Velocidad': '~8 tok/s' },
        ],
      },
      body2: {
        ...
        content: [
          ...
          'El offloading a CPU funciona pero es lento — cada capa movida a RAM añade latencia. Para uso interactivo, mantente dentro del límite de VRAM de tu GPU. Reducir el contexto de 4096 a 2048 tokens ahorra aproximadamente 2 GB en un modelo 7-8B.',
        ...
        faqs: [
          {
            ...
            a: 'Sí. Con 8 GB puedes ejecutar Llama 3.1 8B en Q5_K_M a unos 18 tokens por segundo, con margen de sobra. La mayoría de las tareas cotidianas de chat y programación están bien cubiertas en este rango.',
          },
          {
            q: '¿Puedo ejecutar un modelo 7B con 4 GB de VRAM?',
            a: 'No. Un modelo 7B en Q4 necesita aproximadamente 4,5–5,5 GB de VRAM (parámetros × 0,6, más sobrecarga de contexto). La cuantización más pequeña utilizable sigue superando los 4 GB. Consulta <a href="/es/prompt-bites/how-much-ram-for-7b-model" class="text-primary hover:underline">cuánta RAM necesita un modelo 7B</a> para el desglose completo.',
          },
          {
  ...
  ar: {
    ...
    metaDescription: '⁨4 GB⁩ تكفي لـ ⁨Llama 3.2 3B Q4⁩؛ ⁨6 GB⁩ تُشغّل ⁨Llama 3.1 8B Q4⁩_⁨K⁩_⁨M⁩؛ ⁨12 GB⁩ تفتح ⁨Qwen3 14B Q4⁩. القاعدة: معاملات × ⁨0.6⁩ = ⁨GB⁩ عند ⁨Q4⁩. من ⁨PromptQuorum⁩.',
    publishDate: '2026-05-18',
    dateModified: '2026-09-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-03-02',
    quickAnswerTop: {
      ar: {
        ...
        answer: '4 GB من VRAM يستوعب Llama 3.2 3B وPhi-3.5-mini بسهولة مع هامش لتوسيع السياق. 6 GB يشغّل Llama 3.1 8B بتكميم Q4. 12 GB يستوعب Qwen3 14B Q4 بكفاءة. النماذج بـ 70B عند Q4 تحتاج 16+ GB.',
        bullets: [
          '4 GB: Llama 3.2 3B Q4، Phi-3.5-mini Q4',
          '6 GB: Llama 3.1 8B Q4_K_M',
          '8–12 GB: Llama 3.1 8B Q5_K_M، Qwen3 14B Q4',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          '4 GB من VRAM يشغّل Llama 3.2 3B وPhi-3.5-mini بسلاسة',
          '6 GB هو حد الدخول لـ Llama 3.1 8B بتكميم Q4_K_M — حجم النموذج المحلي الأكثر شيوعاً',
          '12 GB يفتح الباب أمام Qwen3 14B Q4، أفضل مستوى جودة بالسعر',
      ...
      body1: {
        ...
        content: [
          'يتبع استهلاك VRAM للنموذج معادلة بسيطة، تم التحقق منها مقابل أحجام ملفات GGUF الفعلية: المعاملات بالمليار × 0.6 = GB تقريبياً عند تكميم Q4. <strong>نموذج 8B يحتاج ~4.8 GB للأوزان، بالإضافة إلى 0.5–1 GB كنفقات عامة للسياق.</strong> لهذا السبب 6 GB هو الحد الأدنى للنطاق 7–8B، و12 GB يفتح نطاق 14B مع هامش.',
        ...
        rows: [
          { 'VRAM': '4 GB', 'أفضل نموذج بـ Q4_K_M': 'Llama 3.2 3B أو Phi-3.5-mini Q4', 'السرعة': '~25 توكن/ث' },
          { 'VRAM': '6 GB', 'أفضل نموذج بـ Q4_K_M': 'Llama 3.1 8B Q4_K_M', 'السرعة': '~20 توكن/ث' },
          { 'VRAM': '8 GB', 'أفضل نموذج بـ Q4_K_M': 'Llama 3.1 8B Q5_K_M', 'السرعة': '~18 توكن/ث' },
          { 'VRAM': '12 GB', 'أفضل نموذج بـ Q4_K_M': 'Qwen3 14B Q4_K_M', 'السرعة': '~15 توكن/ث' },
          { 'VRAM': '16+ GB', 'أفضل نموذج بـ Q4_K_M': 'Qwen3 32B Q4 أو Llama 3.3 70B جزئي', 'السرعة': '~8 توكن/ث' },
        ],
      },
      body2: {
        ...
        content: [
          ...
          'النقل إلى CPU يعمل لكنه بطيء — كل طبقة تُنقل إلى RAM تضيف كمون. للاستخدام التفاعلي، ابقَ ضمن حد VRAM لـ GPU. تقليل السياق من 4096 إلى 2048 توكن يوفر ~2 GB في نموذج 7-8B.',
        ...
        faqs: [
          {
            ...
            a: 'نعم. بـ 8 GB يمكنك تشغيل Llama 3.1 8B بتكميم Q5_K_M بسرعة ~18 توكن/ث، مع هامش وافر. معظم مهام المحادثة والبرمجة اليومية مغطاة جيداً في هذا النطاق.',
          },
          {
            q: 'هل يمكن تشغيل نموذج 7B بـ 4 GB VRAM؟',
            a: 'لا. نموذج 7B بتكميم Q4 يحتاج تقريباً 4.5–5.5 GB من VRAM (المعاملات × 0.6، بالإضافة إلى نفقات السياق). أصغر تكميم قابل للاستخدام لا يزال يتجاوز 4 GB. راجع <a href="/ar/prompt-bites/how-much-ram-for-7b-model" class="text-primary hover:underline">كم ذاكرة يحتاج نموذج 7B</a> للتفاصيل الكاملة.',
          },
          {
  ...
  ko: {
    ...
    metaDescription: '4 GB로 Llama 3.2 3B Q4 실행. 6 GB로 Llama 3.1 8B Q4_K_M 처리. 12 GB로 Qwen3 14B 실행. 공식: 파라미터 × 0.6 = Q4 기준 GB. PromptQuorum VRAM 티어 가이드.',
    publishDate: '2026-05-18',
    dateModified: '2026-09-02',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2027-03-02',
    ...
    quickAnswerTop: {
      ko: {
        ...
        answer: '4 GB VRAM으로 Llama 3.2 3B와 Phi-3.5-mini를 컨텍스트 확장 여유를 두고 편안하게 실행할 수 있습니다. 6 GB로 Q4에서 Llama 3.1 8B를 실행할 수 있습니다. 12 GB로 Qwen3 14B Q4를 효율적으로 로드할 수 있습니다. Q4에서 70B 모델은 16+ GB가 필요합니다.',
        bullets: [
          '4 GB: Llama 3.2 3B Q4, Phi-3.5-mini Q4',
          '6 GB: Llama 3.1 8B Q4_K_M',
          '8~12 GB: Llama 3.1 8B Q5_K_M, Qwen3 14B Q4',
    ...
    breadcrumbSchema: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: '[www.promptquorum.com/ko/prompt-bites/how-much-vram-for-local-llm](https://www.promptquorum.com/ko/prompt-bites/how-much-vram-for-local-llm)',
        },
      ],
    },
    sections: {
      ...
      body1: {
        ...
        snippetBlocks: [
          {
            type: 'one-sentence',
            text: '모델의 VRAM 필요량은 실제 GGUF 파일 크기로 검증된 계산식을 따릅니다: 파라미터 수(십억 단위) × 0.6 = Q4 양자화 기준 대략적인 GB.',
          },
          {
            type: 'plain-terms',
            text: '8B 모델은 가중치에 약 4.8 GB가 필요하고, 컨텍스트 오버헤드로 0.5~1 GB가 추가됩니다. 따라서 7~8B 티어의 최소 요건은 6 GB이며, 12 GB로 14B 티어를 여유 있게 실행할 수 있습니다.',
          },
        ],
        content: [
          '모델의 VRAM 필요량은 실제 GGUF 파일 크기로 검증된 단순한 계산식을 따릅니다: 파라미터 수(십억 단위) × 0.6 = Q4 양자화 기준 대략적인 GB. <strong>8B 모델은 가중치에 약 4.8 GB가 필요하며, 컨텍스트 오버헤드로 0.5~1 GB가 추가됩니다.</strong> 따라서 6 GB가 7~8B 티어의 최소 요건이며, 12 GB로 14B 티어를 여유 있게 실행할 수 있습니다.',
          '아래 표를 빠른 의사결정 참조용으로 사용하십시오. "속도" 열은 기본 컨텍스트(2048 토큰)에서 데스크톱 GPU로 Ollama를 실행하는 경우를 가정합니다.',
          '<strong>항상 모델의 명시된 요구사항보다 1~2 GB의 VRAM을 여유로 남겨 두십시오.</strong> 운영체제, 브라우저 탭, Ollama 런타임은 모델이 로드되지 않아도 500 MB~1 GB를 소비합니다. Llama 3.1 8B Q4_K_M(~4.8 GB)을 실행하는 6 GB 카드는 여유 공간이 약 1.2 GB뿐이므로 <code>--num-ctx</code>를 2048 토큰보다 크게 늘리면 메모리 부족 오류가 발생합니다. 안전한 여유가 있는 6 GB 티어에 대해서는 <a href="/ko/prompt-bites/best-local-llm-6gb-vram" class="text-primary hover:underline">6 GB VRAM 최적 로컬 LLM</a>을 참조하십시오.',
        ],
        columns: ['VRAM', 'Q4_K_M 최적 모델', '속도'],
        rows: [
          { 'VRAM': '4 GB', 'Q4_K_M 최적 모델': 'Llama 3.2 3B 또는 Phi-3.5-mini Q4', '속도': '~25 tok/s' },
          { 'VRAM': '6 GB', 'Q4_K_M 최적 모델': 'Llama 3.1 8B Q4_K_M', '속도': '~20 tok/s' },
          { 'VRAM': '8 GB', 'Q4_K_M 최적 모델': 'Llama 3.1 8B Q5_K_M', '속도': '~18 tok/s' },
          { 'VRAM': '12 GB', 'Q4_K_M 최적 모델': 'Qwen3 14B Q4_K_M', '속도': '~15 tok/s' },
          { 'VRAM': '16+ GB', 'Q4_K_M 최적 모델': 'Qwen3 32B Q4 또는 Llama 3.3 70B 부분 로드', '속도': '~8 tok/s' },
        ],
      },
      body2: {
        ...
        faqs: [
          {
            ...
            a: '네. 8 GB로 Llama 3.1 8B를 Q5_K_M에서 초당 약 18 토큰 속도로, 여유 있게 실행할 수 있습니다. 대부분의 일상적인 채팅 및 코딩 작업은 이 티어에서 충분히 처리됩니다.',
          },
          {
            q: '4 GB VRAM으로 7B 모델을 실행할 수 있습니까?',
            a: '아니요. Q4에서 7B 모델은 약 4.5~5.5 GB의 VRAM(파라미터 수 × 0.6, 컨텍스트 오버헤드 포함)이 필요합니다. 사용 가능한 가장 작은 양자화도 4 GB를 초과합니다. 전체 분석은 <a href="/ko/prompt-bites/how-much-ram-for-7b-model" class="text-primary hover:underline">7B 모델에 필요한 RAM 용량</a>을 참조하십시오.',
          },
          {
