...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    seoTitle: 'Best LLM for AMD 5700X + RTX 3070 Ti? | Prompt Bites',
    ...
    sections: {
      tldr: {
        ...
        isTldr: true,
        items: [
          'RTX 3070 Ti has 8 GB GDDR6 VRAM and 608 GB/s memory bandwidth — expect ~25 tok/s on 7B Q4 models',
          'Llama 3 8B Q4_K_M uses ~6 GB VRAM, leaving 2 GB headroom on the RTX 3070 Ti',
          'Mistral 7B Q4_K_M also uses ~6 GB VRAM and offers comparable speed with strong instruction-following',
          '13B models at Q4 exceed 8 GB VRAM and require quantization to Q3 or lower to run on this GPU',
        ],
      },
      body1: {
        title: 'RTX 3070 Ti VRAM Limits Define the Model Ceiling',
        content: [
          '<strong>The RTX 3070 Ti has 8 GB of GDDR6 VRAM and 608 GB/s of memory bandwidth, which delivers approximately 25 tokens per second on 7B models at Q4_K_M quantization.</strong> This puts the 3070 Ti firmly in the 7B–8B sweet spot for local inference.',
          'At Q4_K_M, Llama 3 8B uses approximately 6 GB of VRAM, leaving 2 GB free for context and overhead. Mistral 7B at the same quantization uses a similar 6 GB. Both run without layer offloading to the CPU.',
          'The 13B model class is the hard ceiling. Llama 3 13B at Q4_K_M requires roughly 8.5–9 GB of VRAM, exceeding what the 3070 Ti can hold. You can drop to Q3_K_M (~7 GB) to make it fit, but output quality degrades noticeably versus a native Q4 7B model.',
        ],
        columns: ['Model', 'VRAM at Q4_K_M', 'Speed on RTX 3070 Ti'],
        rows: [
          { 'Model': 'Llama 3 8B Q4_K_M', 'VRAM at Q4_K_M': '~6 GB', 'Speed on RTX 3070 Ti': '~25 tok/s' },
          { 'Model': 'Mistral 7B Q4_K_M', 'VRAM at Q4_K_M': '~6 GB', 'Speed on RTX 3070 Ti': '~24 tok/s' },
          { 'Model': 'Llama 3 13B Q4_K_M', 'VRAM at Q4_K_M': '~9 GB', 'Speed on RTX 3070 Ti': 'Does not fit' },
        ],
      },
      body2: {
        title: 'The AMD 5700X Role in This Setup',
        content: [
          'The AMD Ryzen 7 5700X is a Zen 3 8-core CPU that handles tokenization and prompt preprocessing before the GPU takes over for generation. <strong>Tokenization speed is not a bottleneck at 7B model sizes — the 5700X completes this step faster than the GPU generates tokens.</strong>',
          'If you need to run a 13B model and own only this hardware, load it using llama.cpp with layer offloading: keep as many layers in VRAM as fit and spill the remainder to system RAM. Expect generation speed to drop to 5–8 tok/s due to PCIe bottleneck on the RAM-resident layers.',
          'For the full GPU selection guide and how bandwidth maps to inference speed, see the <a href="/local-llms/best-gpus-for-local-llms" class="text-primary hover:underline">best GPUs for local LLMs guide</a>.',
        ],
      },
      faq: {
        id: 'faq',
        ...
        faqs: [
          {
            q: 'Can I run a 13B model on an RTX 3070 Ti?',
            a: 'Not at Q4_K_M — 13B models need 8.5–9 GB VRAM, which exceeds the 8 GB limit. You can use Q3_K_M (~7 GB) to fit it, but quality drops. Alternatively, use llama.cpp layer offloading to split the model across VRAM and RAM at reduced speed.',
          },
          {
            q: 'What is the best quantization for the RTX 3070 Ti?',
            a: 'Q4_K_M is the best balance of quality and VRAM for 7B–8B models. It preserves most model quality while fitting comfortably in 6 GB, leaving 2 GB for KV cache and context. Q5_K_M offers slightly better quality but uses ~7 GB, reducing context headroom.',
          },
          {
            q: 'Does the AMD 5700X CPU affect LLM inference speed?',
            a: 'Minimally. Tokenization is negligible at 7B model sizes. The bottleneck is GPU memory bandwidth. The 5700X is a capable Zen 3 CPU but its role in GPU-accelerated inference is limited to preprocessing and orchestration.',
          },
          {
            q: 'Which Ollama command runs Llama 3 8B on an RTX 3070 Ti?',
            a: '<code>ollama pull llama3:8b</code> downloads the model; <code>ollama run llama3:8b</code> starts it. Ollama auto-detects the NVIDIA GPU via CUDA and loads the full model into VRAM. See <a href="/prompt-bites/radeon-6800m-local-llm" class="text-primary hover:underline">Radeon 6800M setup</a> for the AMD GPU equivalent.',
          },
        ],
      },
    },
  ...
  de: {
    ...
    seoTitle: 'Bestes LLM für AMD 5700X + RTX 3070 Ti? | Prompt Bites',
    metaDescription: 'Mit einer RTX 3070 Ti (8 GB VRAM) sind Llama 3 8B und Mistral 7B bei Q4_K_M die besten lokalen LLMs. Beide passen in 6 GB VRAM. Schnelle Antwort von PromptQuorum.',
    publishDate: '2026-05-18',
    freshness_tier: 'semi_annual',
    next_refresh_due: '2026-11-18',
    quickAnswerTop: {
  ...
  fr: {
    ...
    seoTitle: 'Meilleur LLM pour AMD 5700X + RTX 3070 Ti ? | Prompt Bites',
  ...
  ja: {
    ...
    seoTitle: 'AMD 5700X + RTX 3070 Ti 向け最適 LLM | Prompt Bites',
  ...
  zh: {
    ...
    seoTitle: 'AMD 5700X + RTX 3070 Ti 最佳 LLM | Prompt Bites',
