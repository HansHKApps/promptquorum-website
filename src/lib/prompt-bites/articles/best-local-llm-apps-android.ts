  ...
  en: {
    ...
    sections: {
      ...
      body1: {
        ...
        image: '/images/best-local-llm-apps-android-app-comparison-hero-en.webp',
      ...
      body2: {
        ...
        image: '/images/best-local-llm-apps-android-battery-ram-hero-en.webp',
  ...
  de: {
    ...
    sections: {
      ...
      body1: {
        ...
        image: '/images/best-local-llm-apps-android-app-comparison-hero-de.webp',
      ...
      body2: {
        ...
        image: '/images/best-local-llm-apps-android-battery-ram-hero-de.webp',
  ...
  fr: {
    ...
    sections: {
      ...
      body1: {
        ...
        image: '/images/best-local-llm-apps-android-app-comparison-hero-fr.webp',
      ...
      body2: {
        ...
        image: '/images/best-local-llm-apps-android-battery-ram-hero-fr.webp',
  ...
  ja: {
    ...
    sections: {
      ...
      body1: {
        ...
        image: '/images/best-local-llm-apps-android-app-comparison-hero-ja.webp',
      ...
      body2: {
        ...
        image: '/images/best-local-llm-apps-android-battery-ram-hero-ja.webp',
  ...
  zh: {
    ...
    sections: {
      ...
      body1: {
        ...
        image: '/images/best-local-llm-apps-android-app-comparison-hero-zh.webp',
      ...
      body2: {
        ...
        image: '/images/best-local-llm-apps-android-battery-ram-hero-zh.webp',
  ...
  es: {
    ...
    sections: {
      ...
      body2: {
        ...
        image: '/images/best-local-llm-apps-android-battery-ram-hero-es.webp',
  ...
  pt: {
    ...
    sections: {
      ...
      body2: {
        ...
        image: '/images/best-local-llm-apps-android-battery-ram-hero-pt.webp',
  ...
  ar: {
    ...
    sections: {
      ...
      body2: {
        ...
        image: '/images/best-local-llm-apps-android-battery-ram-hero-ar.webp',
    ...
    breadcrumbSchema: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: '[www.promptquorum.com/ko/prompt-bites/best-local-llm-apps-android](https://www.promptquorum.com/ko/prompt-bites/best-local-llm-apps-android)',
        },
      ],
    },
    sections: {
      ...
      body2: {
        ...
        image: '/images/best-local-llm-apps-android-battery-ram-hero-ko.webp',
