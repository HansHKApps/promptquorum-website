...
export const article: Partial<Record<Language, PromptBiteArticle>> = {
  en: {
    ...
    current_hardware_mentioned: ['RTX 4090 24 GB', 'Mac Studio M5 Max', 'Mac Studio M5 Ultra'],
    ...
    sections: {
      ...
      bestPick: {
        ...
        content: [
          ...
          'Apple refreshed the Mac Studio lineup in August 2026: the Mac Studio M5 Max starts at $2,499 with up to 128 GB of unified memory, and the Mac Studio M5 Ultra starts at $5,499 with up to 256 GB (a 512 GB configuration ships in late October 2026, priced well above $10,000 and unnecessary for the 32 GB+ tier this use case needs). Either current model comfortably covers the 32 GB+ recommendation above; PromptQuorum has not benchmarked either chip directly.',
        ...
        affiliateLinks: [
          ...
          },
          {
            ...
            productName: 'Mac Studio M5 Max/M5 Ultra (32GB+ unified memory)',
      ...
      comparison: {
        ...
        content: [
          'An RTX 4090 workstation is generally the faster option for a given model size and has the more mature software ecosystem for tasks like local fine-tuning on your own document set. A Mac Studio is quieter, more power-efficient for always-on use, and its unified memory scales higher (up to 256 GB in the Mac Studio M5 Ultra, with a 512 GB configuration shipping in late October 2026) if you need to run very large models.',
    ...
    sections: {
      ...
      bestPick: {
        ...
        content: [
          ...
          'حدّثت Apple تشكيلة Mac Studio في أغسطس 2026: يبدأ Mac Studio M5 Max بسعر $2,499 (أسعار السوق الأمريكي) بذاكرة موحدة تصل إلى 128 GB، ويبدأ Mac Studio M5 Ultra بسعر $5,499 بذاكرة تصل إلى 256 GB (يتوفر تكوين بذاكرة 512 GB اعتبارًا من أواخر أكتوبر 2026 بسعر يتجاوز 10,000 $ بكثير، وهو غير ضروري لمستوى 32 GB+ الذي تحتاجه هذه الحالة). يغطي كلا الطرازين الحاليين توصية 32 GB+ أعلاه براحة؛ لم تختبر PromptQuorum أيًا من الشريحتين مباشرة.',
    ...
    sections: {
      ...
      bestPick: {
        ...
        content: [
          ...
          'Apple hat die Mac-Studio-Reihe im August 2026 aktualisiert: Der Mac Studio M5 Max startet bei 2.499 $ (US-Preis) mit bis zu 128 GB Unified Memory, der Mac Studio M5 Ultra startet bei 5.499 $ mit bis zu 256 GB (eine 512-GB-Konfiguration ist ab Ende Oktober 2026 lieferbar, kostet deutlich über 10.000 $ und ist für die oben empfohlene 32-GB+-Stufe nicht nötig). Beide aktuellen Modelle erfüllen die 32-GB+-Empfehlung komfortabel; PromptQuorum hat keinen der beiden Chips selbst getestet.',
    ...
    sections: {
      ...
      bestPick: {
        ...
        content: [
          ...
          'Apple actualizó la línea Mac Studio en agosto de 2026: el Mac Studio M5 Max parte de $2,499 (precio en EE. UU.) con hasta 128 GB de memoria unificada, y el Mac Studio M5 Ultra parte de $5,499 con hasta 256 GB (una configuración de 512 GB estará disponible a finales de octubre de 2026, con un precio muy superior a $10,000 e innecesaria para el nivel de 32 GB+ que requiere este caso de uso). Cualquiera de los dos modelos actuales cubre cómodamente la recomendación de 32 GB+ anterior; PromptQuorum no ha probado directamente ninguno de los dos chips.',
    ...
    sections: {
      ...
      bestPick: {
        ...
        content: [
          ...
          'Apple a renouvelé la gamme Mac Studio en août 2026 : le Mac Studio M5 Max démarre à 2 499 $ (prix US) avec jusqu\'à 128 Go de mémoire unifiée, et le Mac Studio M5 Ultra démarre à 5 499 $ avec jusqu\'à 256 Go (une configuration à 512 Go est disponible fin octobre 2026, à un prix largement supérieur à 10 000 $ et inutile pour le palier de 32 Go+ requis ici). L\'un ou l\'autre modèle actuel couvre confortablement la recommandation de 32 Go+ ci-dessus ; PromptQuorum n\'a testé aucune de ces deux puces directement.',
      ...
      comparison: {
        ...
        content: [
          'Une station RTX 4090 est généralement l\'option la plus rapide pour une taille de modèle donnée et dispose de l\'écosystème logiciel le plus mature pour des tâches comme le fine-tuning local sur votre propre ensemble de documents. Un Mac Studio est plus silencieux, plus économe en énergie pour un usage permanent, et sa mémoire unifiée évolue plus haut (jusqu\'à 256 Go dans le Mac Studio M5 Ultra, avec une configuration à 512 Go disponible fin octobre 2026) si vous devez exécuter de très grands modèles.',
    ...
    sections: {
      ...
      bestPick: {
        ...
        content: [
          ...
          'Appleは2026年8月にMac Studioのラインナップを刷新しました。Mac Studio M5 Maxは$2,499(米国価格)から、統合メモリは最大128GB。Mac Studio M5 Ultraは$5,499から、統合メモリは最大256GB(512GB構成は2026年10月下旬以降に登場予定で、価格は$10,000を大きく超え、この用途が必要とする32GB以上の水準には過剰です)。どちらの現行モデルも上記の32GB以上という推奨を余裕を持って満たします。PromptQuorumはどちらのチップも直接ベンチマークしていません。',
      ...
      comparison: {
        ...
        content: [
          'RTX 4090ワークステーションは、同じモデルサイズに対して一般により高速で、自分の文書セットでのローカルファインチューニングのようなタスクに対してより成熟したソフトウェアエコシステムを持っています。Mac Studioはより静かで、常時稼働の用途に対して電力効率が高く、非常に大きなモデルを動かす必要がある場合、統合メモリはより高くスケールします(Mac Studio M5 Ultraで最大256GB、2026年10月下旬には512GB構成も登場予定)。',
    ...
    sections: {
      ...
      bestPick: {
        ...
        content: [
          ...
          'Apple는 2026년 8월 Mac Studio 라인업을 새로 출시했습니다. Mac Studio M5 Max는 최대 128GB 통합 메모리를 갖추고 $2,499(미국 가격)부터 시작하며, Mac Studio M5 Ultra는 최대 256GB 메모리를 갖추고 $5,499부터 시작합니다(512GB 구성은 2026년 10월 말부터 제공되며 가격이 $10,000를 훨씬 초과해 이 사용 사례에 필요한 32GB 이상 등급에는 불필요합니다). 두 현행 모델 모두 위에서 권장한 32GB 이상 사양을 충분히 충족합니다. PromptQuorum은 두 칩을 직접 벤치마크하지 않았습니다.',
      ...
      comparison: {
        ...
        content: [
          'RTX 4090 워크스테이션은 일반적으로 주어진 모델 크기에서 더 빠른 옵션이며 자체 문서 데이터셋에 대한 로컬 파인튜닝 같은 작업에 더 성숙한 소프트웨어 생태계를 갖추고 있습니다. Mac Studio는 더 조용하고 상시 가동에 더 전력 효율적이며, 매우 큰 모델을 실행해야 한다면 통합 메모리가 더 높게(Mac Studio M5 Ultra 기준 최대 256GB, 2026년 10월 말부터는 512GB 구성도 제공) 확장됩니다.',
    ...
    sections: {
      ...
      bestPick: {
        ...
        content: [
          ...
          'A Apple renovou a linha Mac Studio em agosto de 2026: o Mac Studio M5 Max parte de $2.499 (preço nos EUA) com até 128 GB de memória unificada, e o Mac Studio M5 Ultra parte de $5.499 com até 256 GB (uma configuração de 512 GB chega no final de outubro de 2026, com preço bem acima de $10.000 e desnecessária para o patamar de 32 GB+ exigido neste caso de uso). Qualquer um dos modelos atuais atende com folga à recomendação de 32 GB+ acima; a PromptQuorum não testou nenhum dos dois chips diretamente.',
    ...
    sections: {
      ...
      bestPick: {
        ...
        content: [
          ...
          'Apple 已于 2026 年 8 月更新 Mac Studio 系列：Mac Studio M5 Max 起售价 $2,499（美国定价），最高配备 128GB 统一内存；Mac Studio M5 Ultra 起售价 $5,499，最高配备 256GB（512GB 配置将于 2026 年 10 月下旬上市，售价远超 $10,000，对本场景所需的 32GB+ 档位而言并无必要）。这两款现行机型均能轻松满足上文所述的 32GB+ 建议；PromptQuorum 并未直接对这两款芯片进行基准测试。',
        ...
        affiliateLinks: [
          ...
          {
            url: 'https://www.amazon.com/s?k=Mac%20Studio%2032GB',
            productName: 'Mac Studio M5 Max/M5 Ultra（32GB+ 统一内存）',
            productCategory: 'desktop',
            priceRange: '2500-5500',
      ...
      comparison: {
        ...
        content: [
          '对于给定的模型规模，RTX 4090 工作站通常速度更快，并且在本地针对自有文档集进行微调等任务上拥有更成熟的软件生态。Mac Studio 更安静，长期开机使用时能效更高，其统一内存扩展性更高（Mac Studio M5 Ultra 最高可达 256GB，512GB 配置将于 2026 年 10 月下旬上市），适合需要运行超大模型的情况。',
