...
const T = {
  en: {
    ...
    subtitle: 'A 4-stage workflow: write a structured prompt, optimize it with your own LLM, dispatch to 25+ AI services, then analyze every response for consensus.',
    ...
    frameworksDesc: 'Each framework structures your input differently. A Framework Wizard helps you choose — or you can build two fully custom frameworks of your own.',
    frameworkCol: 'Framework', fieldsCol: 'Fields', bestCol: 'Best For',
    frameworks: [
    ...
    analysisDesc: 'Mix and match. Run 2 or all 13 at once. Each analysis is powered by your connected LLM, not a PromptQuorum server.',
    analysisGroups: [
    ...
    byomH2: 'Bring Your Own Model (BYOM)',
    byomDesc: 'PromptQuorum never calls any LLM with its own keys. Every call goes directly from your browser to your chosen provider. Your API keys stay in your browser\'s localStorage — never transmitted to any PromptQuorum server.',
    cloudLabel: 'Cloud APIs (bring your key)',
    localLabel: 'Local (no API key needed)',
    privacy: [
