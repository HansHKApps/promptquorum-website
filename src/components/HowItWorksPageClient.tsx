...
const T = {
  ...
  es: {
    ...
    ctaDesc: 'Únete a la lista de espera para acceso anticipado. Los primeros usuarios obtienen funciones premium de por vida.',
  ...
  pt: {
    ...
    ctaDesc: 'Entre na lista de espera para acesso antecipado. Os primeiros usuários ganham recursos premium vitalícios.',
  ...
  ar: {
    ...
    ctaDesc: 'سجّل في قائمة الانتظار للحصول على وصول مبكر. يحصل المستخدمون الأوائل على ميزات متميزة مدى الحياة.',
    ctaBtn: 'الانضمام إلى قائمة الانتظار',
  ...
  ko: {
    ...
    ctaH2: '사용해볼 준비가 되셨나요?',
    ctaDesc: '얼리 액세스를 위해 대기자 명단에 등록하세요. 초기 사용자는 평생 프리미엄 기능을 받습니다.',
    ctaBtn: '대기자 명단 참가',
