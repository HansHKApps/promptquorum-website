  ...
  return (
    <div className="space-y-6 bg-gradient-to-br from-slate-50 to-slate-100 p-6 rounded-lg border border-slate-200">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        {/* Model Size */}
        <div>
          <label className="block text-sm font-semibold text-slate-700 mb-2">Model Size</label>
          <select
            value={modelSize}
        ...
        {/* Quantization */}
        <div>
          <label className="block text-sm font-semibold text-slate-700 mb-2">Quantization</label>
          <select
            value={quantization}
        ...
        {/* Batch Size */}
        <div>
          <label className="block text-sm font-semibold text-slate-700 mb-2">Batch Size</label>
          <select
            value={batchSize}
