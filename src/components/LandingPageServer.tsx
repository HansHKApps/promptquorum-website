...
const T = {
  en: {
    ...
    faqs: [
      ...
      { q: 'What platforms does PromptQuorum run on?', a: 'PromptQuorum is available for macOS, Windows, and Linux (desktop via Electron). A web application is in development, followed by mobile solutions.' },
  ...
  de: {
    ...
    faqs: [
      ...
      { q: 'Auf welchen Plattformen läuft PromptQuorum?', a: 'PromptQuorum ist für macOS, Windows und Linux (Desktop via Electron) verfügbar. Eine Webanwendung ist in Entwicklung, gefolgt von mobilen Lösungen.' },
  ...
  fr: {
    ...
    faqs: [
      ...
      { q: 'Sur quelles plateformes fonctionne PromptQuorum ?', a: 'PromptQuorum est disponible pour macOS, Windows et Linux (desktop via Electron). Une application web est en cours de développement, suivie d\'applications mobiles.' },
  ...
  ja: {
    ...
    faqs: [
      ...
      { q: 'どのプラットフォームで動きますか？', a: 'PromptQuorumはmacOS、Windows、Linux（デスクトップ via Electron）で利用可能です。ウェブアプリケーションは開発中で、その後モバイルソリューションが続きます。' },
  ...
  zh: {
    ...
    faqs: [
      ...
      { q: 'PromptQuorum 支持哪些平台？', a: 'PromptQuorum 现已支持 macOS、Windows 和 Linux（桌面应用 via Electron）。网页应用正在开发中，随后将推出移动端解决方案。' },
  ...
  es: {
    ...
    faqs: [
      ...
      { q: '¿En qué plataformas funciona PromptQuorum?', a: 'PromptQuorum está disponible para macOS, Windows y Linux (escritorio via Electron). Una aplicación web está en desarrollo, seguida de soluciones móviles.' },
  ...
  pt: {
    ...
    faqs: [
      ...
      { q: 'Em quais plataformas o PromptQuorum funciona?', a: 'O PromptQuorum está disponível para macOS, Windows e Linux (desktop via Electron). Um aplicativo web está em desenvolvimento, seguido de soluções móveis.' },
  ...
  ar: {
    ...
    heroSub: 'مجاني الاستخدام. استخدم مفتاح API الخاص بك أو شغّل نموذج LLM محليًا.',
    compareH2: 'أي نموذج ذكاء اصطناعي يقدّم أفضل إجابة لمهمتك؟',
    compareDesc: 'أرسل الموجّه نفسه إلى ChatGPT وClaude وGemini وMistral وLlama وDeepSeek وأكثر من 25 نموذجًا آخر في آنٍ واحد. قارن الإجابات جنبًا إلى جنب لإيجاد الإجماع المبني على الحقائق ورصد التناقضات.',
    compareBtn: 'عرض دليل مقارنة نماذج الذكاء الاصطناعي',
    featuresH2: 'ماذا يمكنك أن تفعل باستخدام PromptQuorum؟',
    featuresDesc: 'ست أدوات لتحسين الموجّهات، والإرسال متعدد النماذج، وتحليل الإجماع',
    features: [
      { title: 'تحسين الموجّهات', description: 'حسّن موجّهاتك تلقائيًا عبر 8 تقنيات للصقل والتحسين.' },
      { title: 'تحليل متعدد النماذج', description: 'قارن إجابات أكثر من 25 نموذجًا للذكاء الاصطناعي جنبًا إلى جنب لاكتشاف الهلوسات.' },
      { title: 'مقارنة قدرات النماذج', description: 'حدّد أي نموذج يتفوّق في البرمجة أو الاستدلال أو الكتابة الإبداعية أو استرجاع الحقائق — جنبًا إلى جنب لموجّهك بالتحديد.' },
      { title: 'السرعة والكفاءة', description: 'أرسل إلى أكثر من 25 نموذجًا بنقرة واحدة بدلًا من التنقل بين علامات تبويب المتصفح يدويًا.' },
      { title: 'الخصوصية أولًا', description: 'تبقى مفاتيح API في متصفحك (localStorage) فقط — ولا تُرسَل أبدًا إلى خوادم PromptQuorum. بلا تسجيل، بلا تتبّع، تحكّم كامل.' },
      { title: 'تكامل مفتوح المصدر', description: 'انشر محليًا باستخدام Ollama وLM Studio وJan AI وMeta Llama — دون الحاجة إلى مفتاح API.' },
    ],
    ...
    whyItems: [
      ...
      'احصل على حكم Quorum: تقييم إجماع آلي عبر جميع النماذج',
      'اكتشف الهلوسات ورصد التناقضات تلقائيًا',
      'شغّل محليًا باستخدام Ollama/LM Studio لخصوصية كاملة',
      'مجاني الاستخدام — استخدم مفاتيح API الخاصة بك وابقَ متحكمًا بالكامل',
    ],
    faqs: [
      { q: 'هل PromptQuorum مجاني؟', a: 'نعم. PromptQuorum مجاني الاستخدام. يمكنك استخدام مفتاح API الخاص بك، أو استخدام نموذج LLM محلي، أو تجربة خدمتنا الخلفية المجانية المحدودة لتحسين الموجّهات على أساس تجريبي.' },
      { q: 'كيف تعمل الخصوصية؟', a: 'أنت من يقرّر إلى أين تذهب بياناتك. احتفظ بكل شيء محليًا مع LM Studio أو Ollama، أو استخدم مفاتيح API الخاصة بك. تبلغ خصوصية PromptQuorum القدر الذي تُعدّه أنت.' },
      { q: 'ما مزوّدو الذكاء الاصطناعي المدعومون؟', a: 'يرسل PromptQuorum إلى أكثر من 25 مزوّدًا سحابيًا: GPT-4o وGPT-4o mini وClaude Sonnet 4.6 وClaude 4 وGemini 2.0 Flash وGemini 1.5 Pro وMistral Large وDeepSeek وGrok وغيرها. بالإضافة إلى نماذج LLM المحلية: Ollama وLM Studio وJan AI وGPT4All.' },
      { q: 'على أي منصّات يعمل PromptQuorum؟', a: 'يتوفر PromptQuorum لـ macOS و Windows و Linux (سطح المكتب عبر Electron). تطبيق ويب قيد التطوير، يليه حلول للأجهزة المحمولة.' },
      { q: 'ما الذي يميّز PromptQuorum؟', a: 'يغطّي PromptQuorum دورة حياة الموجّه بالكامل: 9 أطر مدمجة للكتابة، وتحسين تكراري بـ8 أنواع من الصقل، وإرسال متزامن إلى أكثر من 25 نموذجًا، و13 نوعًا من تحليل Quorum لتقييم الإجماع.' },
      { q: 'هل توجد أي حدود؟', a: 'لا حدود من جانب PromptQuorum. يعتمد استخدامك فقط على حدود معدّل API الخاص بك أو موارد نموذج LLM المحلي — نحن لا نحدّ من الاستخدام أو نقيسه أبدًا.' },
    ],
    copyright: '© 2026 PromptQuorum. جميع الحقوق محفوظة.',
    heroStrong: 'PromptQuorum أداة إرسال متعددة للذكاء الاصطناعي ترسل موجّهًا واحدًا إلى أكثر من 25 نموذجًا في آنٍ واحد — GPT-4o وClaude 4.6 Sonnet وGemini 2.5 Pro وMistral Large وDeepSeek وغيرها — وتقيّم النتائج بحثًا عن الإجماع ومخاطر الهلوسة.',
  ...
  ko: {
    ...
    faqs: [
      ...
      { q: 'PromptQuorum은 어떤 플랫폼에서 실행됩니까?', a: 'PromptQuorum은 macOS, Windows, Linux(데스크톱 via Electron)에서 사용 가능합니다. 웹 애플리케이션은 개발 중이며, 그 다음 모바일 솔루션이 출시됩니다.' },
