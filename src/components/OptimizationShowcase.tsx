...
const translations = {
  ...
  ko: {
    ...
    reviewRefine: 'AI 지원으로 프롬프트를 검토하고 수정하고 개선하십시오',
    ...
    undoChanges: '🔄 변경 취소',
    copy: '✓ 복사',
    teachingExplanation: '📚 교육적 설명',
    quickRefinements: '빠른 개선',
    makeConcise: '간결하게',
    addExamples: '예시 추가',
    improveClarity: '명확성 개선',
    expandDetail: '세부 사항 확장',
    simplify: '단순화',
    makeProfessional: '전문적으로',
    qualityAssessment: '품질 평가',
    currentQuality: '현재 품질:',
    assessQuality: '품질 평가',
    showDetails: '▼ 세부 정보 표시',
    showSuggestions: '▼ 제안 표시',
    qualityDetails: '품질 세부 정보',
    strengths: '강점:',
    areasForImprovement: '개선 영역:',
    improvementSuggestions: '개선 제안(3)',
    saveToHistory: '기록에 저장',
    dispatchToMultipleLLMs: '여러 LLM으로 전송',
