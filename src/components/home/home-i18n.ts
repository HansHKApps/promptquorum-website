...
const HOME_UI = {
  ...
  // --- PromptQuorum app banner (English placeholder in all locales until translated) ---
  pqBannerEyebrow: { en: 'PromptQuorum App · Beta', de: 'PromptQuorum App · Beta', fr: 'PromptQuorum App · Beta', ja: 'PromptQuorum App · Beta', zh: 'PromptQuorum App · Beta', es: 'PromptQuorum App · Beta', pt: 'PromptQuorum App · Beta', ar: 'PromptQuorum App · Beta', ko: 'PromptQuorum App · Beta' },
  pqBannerHeading: { en: 'Optimize one prompt. Ask 25+ AIs. Compare the answers.', de: 'Optimize one prompt. Ask 25+ AIs. Compare the answers.', fr: 'Optimize one prompt. Ask 25+ AIs. Compare the answers.', ja: 'Optimize one prompt. Ask 25+ AIs. Compare the answers.', zh: 'Optimize one prompt. Ask 25+ AIs. Compare the answers.', es: 'Optimize one prompt. Ask 25+ AIs. Compare the answers.', pt: 'Optimize one prompt. Ask 25+ AIs. Compare the answers.', ar: 'Optimize one prompt. Ask 25+ AIs. Compare the answers.', ko: 'Optimize one prompt. Ask 25+ AIs. Compare the answers.' },
  pqBannerSub: { en: 'PromptQuorum structures your prompt, sends it to many models at once, and shows where they agree.', de: 'PromptQuorum structures your prompt, sends it to many models at once, and shows where they agree.', fr: 'PromptQuorum structures your prompt, sends it to many models at once, and shows where they agree.', ja: 'PromptQuorum structures your prompt, sends it to many models at once, and shows where they agree.', zh: 'PromptQuorum structures your prompt, sends it to many models at once, and shows where they agree.', es: 'PromptQuorum structures your prompt, sends it to many models at once, and shows where they agree.', pt: 'PromptQuorum structures your prompt, sends it to many models at once, and shows where they agree.', ar: 'PromptQuorum structures your prompt, sends it to many models at once, and shows where they agree.', ko: 'PromptQuorum structures your prompt, sends it to many models at once, and shows where they agree.' },
  pqBannerCta: { en: 'Explore PQ Apps →', de: 'Explore PQ Apps →', fr: 'Explore PQ Apps →', ja: 'Explore PQ Apps →', zh: 'Explore PQ Apps →', es: 'Explore PQ Apps →', pt: 'Explore PQ Apps →', ar: 'Explore PQ Apps →', ko: 'Explore PQ Apps →' },
  pqBannerChip1: { en: 'Automatic prompt optimization', de: 'Automatic prompt optimization', fr: 'Automatic prompt optimization', ja: 'Automatic prompt optimization', zh: 'Automatic prompt optimization', es: 'Automatic prompt optimization', pt: 'Automatic prompt optimization', ar: 'Automatic prompt optimization', ko: 'Automatic prompt optimization' },
  pqBannerChip2: { en: 'One prompt to 25+ AI models', de: 'One prompt to 25+ AI models', fr: 'One prompt to 25+ AI models', ja: 'One prompt to 25+ AI models', zh: 'One prompt to 25+ AI models', es: 'One prompt to 25+ AI models', pt: 'One prompt to 25+ AI models', ar: 'One prompt to 25+ AI models', ko: 'One prompt to 25+ AI models' },
  pqBannerChip3: { en: 'Side-by-side comparison', de: 'Side-by-side comparison', fr: 'Side-by-side comparison', ja: 'Side-by-side comparison', zh: 'Side-by-side comparison', es: 'Side-by-side comparison', pt: 'Side-by-side comparison', ar: 'Side-by-side comparison', ko: 'Side-by-side comparison' },
  pqBannerChip4: { en: 'Consensus scoring', de: 'Consensus scoring', fr: 'Consensus scoring', ja: 'Consensus scoring', zh: 'Consensus scoring', es: 'Consensus scoring', pt: 'Consensus scoring', ar: 'Consensus scoring', ko: 'Consensus scoring' },
  pqBannerChip5: { en: 'Local LLM support', de: 'Local LLM support', fr: 'Local LLM support', ja: 'Local LLM support', zh: 'Local LLM support', es: 'Local LLM support', pt: 'Local LLM support', ar: 'Local LLM support', ko: 'Local LLM support' },
