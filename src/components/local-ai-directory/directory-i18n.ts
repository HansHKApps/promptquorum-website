...
const DIR_UI = {
  ...
  staleListingTooltipWarn: {
    en: 'PromptQuorum has not re-verified this listing in over 6 months. Local-AI tools change fast — check the official source before installing.',
    de: 'PromptQuorum hat diesen Eintrag seit über 6 Monaten nicht erneut geprüft. Lokale KI-Tools ändern sich schnell — vor der Installation die offizielle Quelle prüfen.',
    fr: 'PromptQuorum n’a pas revérifié cette fiche depuis plus de 6 mois. Les outils d’IA locale évoluent vite — vérifiez la source officielle avant d’installer.',
    ja: 'PromptQuorumはこの情報を6ヶ月以上再確認していません。ローカルAIツールは変化が速いため、インストール前に公式情報源を確認してください。',
    zh: 'PromptQuorum 已超过6个月未重新核实该条目。本地 AI 工具变化很快——安装前请查看官方来源。',
    es: 'PromptQuorum no ha vuelto a verificar esta ficha en más de 6 meses. Las herramientas de IA local cambian rápido: revisa la fuente oficial antes de instalar.',
    pt: 'A PromptQuorum não reverificou este registro há mais de 6 meses. As ferramentas de IA local mudam rápido — confira a fonte oficial antes de instalar.',
    ar: 'لم تُعِد PromptQuorum التحقق من هذا العنصر منذ أكثر من 6 أشهر. تتغير أدوات الذكاء الاصطناعي المحلي بسرعة — تحقق من المصدر الرسمي قبل التثبيت.',
    ko: 'PromptQuorum이 6개월 넘게 이 항목을 다시 확인하지 않았습니다. 로컬 AI 도구는 빠르게 변하니 설치 전에 공식 출처를 확인하세요.',
  },
  staleListingBadgeOld: { en: 'Not verified in over a year', de: 'Seit über einem Jahr nicht geprüft', fr: 'Non vérifié depuis plus d’un an', ja: '1年以上未確認', zh: '一年多未核实', es: 'Sin verificar desde hace más de un año', pt: 'Não verificado há mais de um ano', ar: 'لم يُتحقَّق منه منذ أكثر من عام', ko: '1년 넘게 확인되지 않음' },
  staleListingTooltipOld: {
    en: 'PromptQuorum has not re-verified this listing in over a year. Details may be outdated — check the official source before installing.',
    de: 'PromptQuorum hat diesen Eintrag seit über einem Jahr nicht erneut geprüft. Angaben können veraltet sein — vor der Installation die offizielle Quelle prüfen.',
    fr: 'PromptQuorum n’a pas revérifié cette fiche depuis plus d’un an. Les informations peuvent être obsolètes — vérifiez la source officielle avant d’installer.',
    ja: 'PromptQuorumはこの情報を1年以上再確認していません。内容が古い可能性があるため、インストール前に公式情報源を確認してください。',
    zh: 'PromptQuorum 已超过一年未重新核实该条目，信息可能已过时——安装前请查看官方来源。',
    es: 'PromptQuorum no ha vuelto a verificar esta ficha en más de un año. Los datos pueden estar desactualizados: revisa la fuente oficial antes de instalar.',
    pt: 'A PromptQuorum não reverificou este registro há mais de um ano. Os dados podem estar desatualizados — confira a fonte oficial antes de instalar.',
    ar: 'لم تُعِد PromptQuorum التحقق من هذا العنصر منذ أكثر من عام. قد تكون التفاصيل قديمة — تحقق من المصدر الرسمي قبل التثبيت.',
    ko: 'PromptQuorum이 1년 넘게 이 항목을 다시 확인하지 않았습니다. 정보가 오래되었을 수 있으니 설치 전에 공식 출처를 확인하세요.',
  },
  ...
  licenseModalMultiple: {
    en: 'Multiple licenses', de: 'Mehrere Lizenzen', fr: 'Licences multiples', ja: '複数のライセンス',
    zh: '多种许可证', es: 'Varias licencias', pt: 'Várias licenças', ar: 'رخص متعددة', ko: '복수 라이선스',
  },
  licenseModalMultipleNote: {
    en: 'This tool combines more than one license, one per component:',
    de: 'Dieses Tool kombiniert mehrere Lizenzen, eine pro Komponente:',
    fr: 'Cet outil combine plusieurs licences, une par composant :',
    ja: 'このツールは複数のライセンスをコンポーネントごとに組み合わせている：',
    zh: '该工具按组件组合了多种许可证：',
    es: 'Esta herramienta combina más de una licencia, una por componente:',
    pt: 'Esta ferramenta combina mais de uma licença, uma por componente:',
    ar: 'تجمع هذه الأداة أكثر من رخصة، واحدة لكل مكوّن:',
    ko: '이 도구는 구성 요소별로 서로 다른 라이선스를 함께 사용한다:',
  },
  licenseModalReadGuide: {
    en: 'Read the full license guide ↗', de: 'Vollständigen Lizenz-Leitfaden lesen ↗', fr: 'Lire le guide complet des licences ↗',
    ja: 'ライセンス完全ガイドを読む ↗', zh: '阅读完整许可证指南 ↗', es: 'Leer la guía completa de licencias ↗',
    pt: 'Ler o guia completo de licenças ↗', ar: 'قراءة الدليل الكامل للتراخيص ↗', ko: '전체 라이선스 가이드 읽기 ↗',
  },
  licenseModalRawLabel: {
    en: 'As listed for this tool:', de: 'Für dieses Tool angegeben:', fr: 'Tel qu’indiqué pour cet outil :',
    ja: 'このツールの表記:', zh: '本工具标注为：', es: 'Tal como figura para esta herramienta:',
    pt: 'Conforme listado para esta ferramenta:', ar: 'كما هو مُدرج لهذه الأداة:', ko: '이 도구에 표기된 값:',
  },
