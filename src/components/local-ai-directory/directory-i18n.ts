...
const DIR_UI = {
  ...
  staleListingBadge: { en: 'Not verified in over a year', de: 'Seit über einem Jahr nicht geprüft', fr: 'Non vérifié depuis plus d’un an', ja: '1年以上未確認', zh: '一年多未核实', es: 'Sin verificar desde hace más de un año', pt: 'Não verificado há mais de um ano', ar: 'لم يُتحقَّق منه منذ أكثر من عام', ko: '1년 넘게 확인되지 않음' },
  staleListingTooltip: {
