          ...
          __html: JSON.stringify([
            ...
            },
            {
              ...
              'itemListElement': [
                ...
                { '@type': 'ListItem', 'position': 2, 'name': 'Frameworks', 'item': 'https://www.promptquorum.com/es/frameworks' },
      ...
      <div className="min-h-screen bg-surface pt-24 pb-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <nav className="flex items-center gap-2 text-xs text-text-muted mb-8">
            ...
            <span>/</span>
            <Link href="/es/frameworks" className="hover:text-primary transition-colors">Frameworks</Link>
            <span>/</span>
          ...
          <div className="flex flex-wrap gap-4 pt-8 border-t border-primary/20">
            ...
            <Link href="/es/frameworks" className="text-primary hover:text-primary/80 font-medium text-sm">All Frameworks</Link>
          </div>
