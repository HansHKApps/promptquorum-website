      ...
      <div className="min-h-screen bg-surface pt-24 pb-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap gap-4 pt-8 border-t border-primary/20">
            ...
            <Link href="/es/how-it-works" className="text-primary hover:text-primary/80 font-medium text-sm">How It Works</Link>
            <Link href="/es/compare" className="text-primary hover:text-primary/80 font-medium text-sm">Compare Tools</Link>
