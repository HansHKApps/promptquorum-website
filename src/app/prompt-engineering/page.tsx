  ...
  const HOWTO_TRANSLATIONS: Record<string, { name: string; steps: Array<{ name: string; text: string }> }> = {
    en: {
      ...
      steps: [
        ...
        { name: 'Test across models', text: 'Run your prompt on GPT-4o, Claude 4.8 Sonnet, and Gemini 2.5 Pro to compare quality and speed.' },
    ...
    de: {
      ...
      steps: [
        ...
        { name: 'Über Modelle testen', text: 'Führen Sie Ihren Prompt auf GPT-4o, Claude 4.8 Sonnet und Gemini 2.5 Pro aus, um Qualität und Geschwindigkeit zu vergleichen.' },
    ...
    fr: {
      ...
      steps: [
        ...
        { name: 'Tester sur plusieurs modèles', text: 'Exécutez votre prompt sur GPT-4o, Claude 4.8 Sonnet et Gemini 2.5 Pro pour comparer qualité et vitesse.' },
    ...
    ja: {
      ...
      steps: [
        ...
        { name: '複数のモデルでテストする', text: 'GPT-4o、Claude 4.8 Sonnet、Gemini 2.5 Proでプロンプトを実行して、品質と速度を比較してください。' },
    ...
    zh: {
      ...
      steps: [
        ...
        { name: '跨模型测试', text: '在GPT-4o、Claude 4.8 Sonnet和Gemini 2.5 Pro上运行提示词，比较质量和速度。' },
