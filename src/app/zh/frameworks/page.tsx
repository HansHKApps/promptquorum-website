...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: generateAlternates('/frameworks', lang, true, undefined, ['zh']),
    openGraph: {
      title: t.frameworksMetaTitle,
      description: t.frameworksMetaDescription,
...
export default async function ZhFrameworksPage() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            'url': 'https://www.promptquorum.com/zh/frameworks',
