...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: generateAlternates('/features', lang, true, undefined, ['zh']),
    openGraph: {
      title: t.featuresMetaTitle,
      description: t.featuresMetaDescription,
...
export default async function ZhFeaturesPage() {
  return (
    <>
      <FeaturesPageClient initialLang="zh" />
      <script
          ...
          __html: JSON.stringify([
            {
              ...
              'url': 'https://www.promptquorum.com/zh/features',
            ...
            },
            {
              ...
              'itemListElement': [
                ...
                { '@type': 'ListItem', 'position': 2, 'name': 'Features', 'item': 'https://www.promptquorum.com/zh/features' },
              ],
            },
          ]),
        }}
