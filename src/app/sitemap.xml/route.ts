...
import { PAGES as ENTERPRISE_AI_PAGES } from '@/lib/sitemap/pages/enterprise-ai'
...
import { PAGES as EDGE_AI_PAGES } from '@/lib/sitemap/pages/edge-ai'
...
const CHILDREN: Array<{ slug: string; pages: Page[] }> = [
  ...
  { slug: 'enterprise-ai', pages: ENTERPRISE_AI_PAGES },
  ...
  { slug: 'edge-ai', pages: EDGE_AI_PAGES },
