...
type BlogMetadata = { lastmod: string; langs: string[]; images: Array<{ url: string; title?: string }> }
const metadata = contentMetadata as unknown as {
...
function hasRealContent(cluster: Record<string, ClusterMetadata>, key: string): boolean {
...
function articleLastmod(cluster: Record<string, ClusterMetadata>, key: string, fallback: string): string {
...
function extractImagesFromArticle(cluster: Record<string, ClusterMetadata>, key: string): Array<{ url: string; title?: string }> {
