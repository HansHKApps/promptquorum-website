...
export default async function PtComparePage() {
  return (
    <>
      <ComparePageClient initialLang="pt" />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@graph': [
              {
                '@type': 'WebPage',
                '@id': 'https://www.promptquorum.com/pt/compare',
                'url': 'https://www.promptquorum.com/pt/compare',
              ...
              },
              {
                ...
                'itemListElement': [
                  ...
                  { '@type': 'ListItem', 'position': 2, 'name': 'Comparar', 'item': 'https://www.promptquorum.com/pt/compare' },
                ],
              },
              {
                '@type': 'FAQPage',
