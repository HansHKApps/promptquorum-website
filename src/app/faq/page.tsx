...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: generateAlternates('/faq', selectedLang, true, undefined, [...PATH_PREFIX_LANGS]),
    openGraph: {
      title: t.faqMetaTitle,
      description: t.faqMetaDescription,
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              { '@type': 'Question', name: 'How do I get PromptQuorum and is there a cost?', acceptedAnswer: { '@type': 'Answer', text: 'PromptQuorum is in free public beta. Download the desktop app directly — no signup, no waitlist, no email required.' } },
