...
export default async function JaPromptEngineeringPage() {
  const { titlesMap, articleLevels, datesMap } = buildPEHubData('ja')

  return <PromptEngineeringHub initialLang="ja" titlesMap={titlesMap} articleLevels={articleLevels} datesMap={datesMap} />
}
