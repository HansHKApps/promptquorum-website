          ...
          __html: JSON.stringify([
            ...
            },
            {
              ...
              'itemListElement': [
                ...
                { '@type': 'ListItem', 'position': 2, 'name': 'フレームワーク', 'item': 'https://www.promptquorum.com/ja/frameworks' },
      ...
      <div className="min-h-screen bg-surface pt-24 pb-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <nav className="flex items-center gap-2 text-xs text-text-muted mb-8">
            <Link href="/ja" className="hover:text-primary transition-colors">ホーム</Link>
            <span>/</span>
            <Link href="/ja/frameworks" className="hover:text-primary transition-colors">フレームワーク</Link>
            <span>/</span>
