...
export const translations = {
  en: {
    ...
    localLlmsHubTitle: "Local LLMs May 2026: Models, Hardware, RAG, Updates & VRAM Tier Guide",
    localLlmsHubDescription: "Local LLMs May 2026: best models by VRAM tier (4GB–48GB), Ollama updates, LM Studio comparison, local RAG setup, hardware requirements (RTX 3060–RTX 5090), and beginner guides.",
    ...
    privacyS4Row4Role: "Session replay and heatmaps — runs in cookieless mode with ad storage and analytics storage denied",
    privacyS4Row4Data: "Interaction events and viewport data (no cookies under current configuration)",
  ...
  de: {
    ...
    localLlmsHubTitle: "Lokale LLMs Mai 2026: Modelle, Hardware, RAG, Updates & VRAM-Leitfaden",
    localLlmsHubDescription: "Lokale LLMs Mai 2026: beste Modelle nach VRAM-Tier (4 GB–48 GB), Ollama-Updates, LM Studio-Vergleich, lokale RAG-Einrichtung, Hardware-Anforderungen (RTX 3060–RTX 5090) und Anfänger-Guides.",
    ...
    privacyS4Row4Proc: "Microsoft Clarity (Microsoft Corporation)",
    privacyS4Row4Role: "Session-Aufzeichnung und Heatmaps – läuft im cookielosen Modus mit verweigertem Anzeigen- und Analyse-Speicher",
    privacyS4Row4Data: "Interaktionsereignisse und Viewport-Daten (in der aktuellen Konfiguration keine Cookies)",
  ...
  fr: {
    ...
    localLlmsHubTitle: "LLMs Locaux Mai 2026 : Modèles, Matériel, RAG, Actualités & Guide VRAM",
    localLlmsHubDescription: "LLMs locaux mai 2026 : meilleurs modèles par tier VRAM (4 Go–48 Go), mises à jour Ollama, comparaison LM Studio, configuration RAG local, exigences matériel (RTX 3060–RTX 5090) et guides débutants.",
    ...
    privacyS4Row4Proc: "Microsoft Clarity (Microsoft Corporation)",
    privacyS4Row4Role: "Relecture de session et cartes de chaleur — fonctionne en mode sans cookies avec stockage publicitaire et stockage d'analyse refusés",
    privacyS4Row4Data: "Événements d'interaction et données de fenêtre d'affichage (aucun cookie dans la configuration actuelle)",
  ...
  ja: {
    ...
    localLlmsHubTitle: "2026年5月ローカルLLM：モデル、ハードウェア、RAG、更新情報 & VRAM完全ガイド",
    localLlmsHubDescription: "2026年5月ローカルLLM：VRAMティア別（4GB～48GB）最高モデル、Ollama最新情報、LM Studio比較、ローカルRAG設定、ハードウェア要件（RTX 3060～RTX 5090）、初心者ガイド。",
    ...
    privacyS4Row4Proc: "Microsoft Clarity (Microsoft Corporation)",
    privacyS4Row4Role: "セッションリプレイおよびヒートマップ — 広告ストレージおよび解析ストレージを拒否したクッキーレスモードで動作",
    privacyS4Row4Data: "操作イベントおよびビューポートデータ（現在の構成ではクッキーなし）",
  ...
  zh: {
    ...
    localLlmsHubTitle: "2026年5月本地LLM：模型、硬件、RAG、更新 & VRAM完整指南",
    localLlmsHubDescription: "2026年5月本地LLM：按VRAM等级（4GB～48GB）的最佳模型、Ollama更新、LM Studio对比、本地RAG设置、硬件要求（RTX 3060～RTX 5090）及初学者指南。",
    ...
    privacyS4Row4Proc: "Microsoft Clarity (Microsoft Corporation)",
    privacyS4Row4Role: "会话回放和热图——以无 Cookie 模式运行，广告存储和分析存储均被拒绝",
    privacyS4Row4Data: "交互事件和视口数据（在当前配置下无 Cookie）",
