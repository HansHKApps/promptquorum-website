...
export const translations = {
  en: {
    ...
    localLlmsHubTitle: "Local LLMs 2026: Ollama, LM Studio, Models & Hardware Guide",
    localLlmsHubDescription: "Run a 7B model locally in 5 minutes with Ollama — $0/token, full privacy, offline. Guides for hardware (8–48 GB VRAM), model selection, LM Studio, and April 2026 benchmarks.",
  ...
  de: {
    ...
    localLlmsHubTitle: "Lokale LLMs 2026: Ollama, LM Studio, Modelle & Hardware",
    localLlmsHubDescription: "7B-Modell in 5 Minuten lokal mit Ollama starten — $0/Token, volle Privatsphäre, offline. Anleitungen für Hardware (8–48 GB VRAM), Modellauswahl, LM Studio, Benchmarks April 2026.",
  ...
  fr: {
    ...
    localLlmsHubTitle: "LLMs locaux 2026 : Ollama, LM Studio, modèles et matériel",
    localLlmsHubDescription: "Lancez un modèle 7B localement en 5 min avec Ollama — $0/token, vie privée totale, hors ligne. Guides matériel (8–48 Go VRAM), modèles, LM Studio, benchmarks avril 2026.",
  ...
  ja: {
    ...
    localLlmsHubTitle: "ローカルLLM 2026：Ollama・LM Studio・モデル・ハードウェア完全ガイド",
    localLlmsHubDescription: "Ollamaで7Bモデルを5分でローカル実行 — トークン料金$0、完全プライベート、オフライン対応。ハードウェア（8〜48GB VRAM）・モデル選択・LM Studio・2026年4月ベンチマーク完全ガイド。",
  ...
  zh: {
    ...
    localLlmsHubTitle: "本地LLM 2026：Ollama、LM Studio、模型与硬件完整指南",
    localLlmsHubDescription: "用Ollama在5分钟内本地运行7B模型 — 每token $0，完全隐私，离线可用。硬件指南（8–48 GB VRAM）、模型选择、LM Studio对比、2026年4月基准测试。",
