...
export const translations = {
  en: {
    ...
    localLlmsHubDescription: "Complete guide to running local LLMs privately in 2026. Compare Ollama, LM Studio, hardware requirements, quantization, and how PromptQuorum helps you test and compare your local models instantly.",
  ...
  de: {
    ...
    localLlmsHubTitle: "Local LLMs 2026: Privat & Kostenlos mit Ollama & LM Studio",
    localLlmsHubDescription: "Der komplette Guide 2026 zu Local LLMs. Vergleich von Ollama und LM Studio, Hardware-Empfehlungen, Quantisierung und wie Sie Ihre lokalen Modelle mit PromptQuorum testen und vergleichen.",
  ...
  fr: {
    ...
    localLlmsHubTitle: "Local LLMs 2026 : Exécutez l'IA en local avec Ollama & LM Studio",
    localLlmsHubDescription: "Guide complet 2026 pour exécuter des Local LLMs en privé. Comparaison Ollama vs LM Studio, exigences matérielles, quantification et comment tester vos modèles locaux avec PromptQuorum.",
  ...
  ja: {
    ...
    localLlmsHubTitle: "Local LLMs 2026：Ollama & LM StudioでプライベートAI",
    localLlmsHubDescription: "2026年版 Local LLMs完全ガイド。OllamaとLM Studioの比較、ハードウェア要件、量子化手法、そしてPromptQuorumで自分のローカルモデルを簡単にテスト・比較する方法を解説。",
  ...
  zh: {
    ...
    localLlmsHubTitle: "Local LLMs 2026：用Ollama和LM Studio私有运行AI",
    localLlmsHubDescription: "2026年完整 Local LLMs 指南。对比Ollama与LM Studio、硬件需求、量化技巧，以及如何用PromptQuorum快速测试和比较你的本地模型。",
