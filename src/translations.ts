...
export const translations = {
  ...
  de: {
    ...
    localLlmsHubDescription: "Beste lokale LLM-Modelle nach VRAM-Tier (4–48 GB): RTX 3060 12GB, RTX 4090, Apple Silicon-Leitfäden. Ollama-Einrichtung, Hardware-Tier-Vergleich, Anfänger-Anleitungen.",
  ...
  ko: {
    ...
    localLlmsHubDescription: "VRAM 등급별(4GB–48GB) 최고 로컬 LLM 모델: RTX 3060 12GB, RTX 4090, Apple Silicon 가이드. Ollama 설정, 하드웨어 등급 비교, 초보자 튜토리얼.",
