...
export const translations = {
  ...
  de: {
    ...
    aboutMetaTitle: "Über PromptQuorum: Nutzungsebene für Open-Weight- & Open-Source-KI",
  ...
  fr: {
    ...
    aboutMetaTitle: "À propos de PromptQuorum : la couche d’usage de l’IA ouverte",
  ...
  ja: {
    ...
    aboutMetaTitle: "PromptQuorumとは:オープンウェイト・オープンソースAI活用レイヤー",
  ...
  zh: {
    ...
    aboutMetaTitle: "关于 PromptQuorum：开放权重与开源 AI 的应用层",
  ...
  es: {
    ...
    aboutMetaTitle: "Sobre PromptQuorum: la capa de uso para IA de pesos abiertos y código abierto",
  ...
  pt: {
    ...
    aboutMetaTitle: "Sobre a PromptQuorum: a camada de uso para IA aberta",
  ...
  ar: {
    ...
    aboutMetaTitle: "حول PromptQuorum: طبقة الاستخدام للذكاء الاصطناعي مفتوح الأوزان ومفتوح المصدر",
  ...
  ko: {
    ...
    aboutMetaTitle: "PromptQuorum 소개: 오픈 웨이트 및 오픈소스 AI 사용 계층",
