...
export const translations = {
  ...
  ja: {
    ...
    localLlmsHubDescription: "8 GB VRAMで7Bモデルをローカル実行。40 GB以上で70B大規模モデルも高品質に動作。APIコスト不要、完全プライベート。OllamaとLM Studioの比較・設定、Q4量子化、RAGパイプライン、ファインチューニング手順を解説する2026年完全ガイド88本。",
  ...
  zh: {
    ...
    localLlmsHubDescription: "8 GB显存即可本地运行7B模型，数据完全保留在设备内，API费用为零。40 GB以上可运行70B大模型。本系列共88篇指南，涵盖Ollama与LM Studio对比、Q4量化配置、RAG管道搭建及微调全流程（2026年版）。",
