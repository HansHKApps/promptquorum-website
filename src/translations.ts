...
export const translations = {
  ...
  pt: {
    ...
    localLlmsHubDescription: "Melhores modelos LLM locais por nível de VRAM (4–48 GB): RTX 3060 12GB, RTX 4090, guias para Apple Silicon. Configuração do Ollama, comparação de hardware, tutoriais para iniciantes — maio de 2026.",
