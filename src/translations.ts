...
export const translations = {
  en: {
    ...
    localLlmsHubDescription: "Best local LLM models ranked by VRAM tier (4GB–48GB): RTX 3060 12GB, RTX 4090, Apple Silicon guides. Ollama setup, hardware tier comparison, beginner tutorials.",
    enterpriseAiHubTitle: "Enterprise AI: Build, Buy, Govern",
    enterpriseAiHubDescription: "Practical guidance for enterprises deploying AI at scale — building in-house capability, buying vendor tools, and governing AI use across the organization, including shadow AI risk and controls.",
    ...
    aboutMetaTitle: "About PromptQuorum: The Discovery Engine for Open-Weight & Open-Source AI",
    ...
    privacyS7Row5Cookie: "pq_google_ps_*",
    privacyS7Row5SetBy: "PromptQuorum (localStorage)",
    privacyS7Row5Purpose: "Remembers that you have seen or dismissed the \"set as preferred source\" prompt, so it is not shown again for a while",
    privacyS7Row5Duration: "Up to 14 days",
    privacyS7Row6Cookie: "pq-hw-profile",
    privacyS7Row6SetBy: "PromptQuorum (localStorage)",
    privacyS7Row6Purpose: "Stores the RAM/VRAM figures you manually enter and save in the AI software directory's compatibility checker, so it can compare tools against your setup — the numbers are typed by you, never auto-detected, and never sent to us",
    privacyS7Row6Duration: "Until you click \"Forget my hardware\" or clear browser data",
    privacyS7Row7Cookie: "pq-directory-machine",
  ...
  de: {
    ...
    localLlmsHubDescription: "Lokale LLMs und KI-Modelle auf eigener Hardware betreiben – ohne API-Kosten. Beste Local-LLM-Modelle von 4 bis 48 GB VRAM und Ollama-Setup im Vergleich.",
    enterpriseAiHubTitle: "Enterprise AI: Build, Buy, Govern",
    enterpriseAiHubDescription: "Praktische Leitfäden für Unternehmen, die KI im großen Maßstab einsetzen — eigene Fähigkeiten aufbauen, Anbieter-Tools einkaufen und den KI-Einsatz im Unternehmen steuern, einschließlich Shadow-AI-Risiken und -Kontrollen.",
    ...
    aboutMetaTitle: "Über PromptQuorum: Entdeckungsmaschine für Open-Weight- & Open-Source-KI",
    aboutMetaDescription: "Ein unabhängiges Ökosystem für lokale KI: Verzeichnis, Anleitungen in 9 Sprachen und eine kostenlose Multi-Modell-App. Von Modellen über Runtimes zu Apps.",
    ...
    privacyS7Row5Cookie: "pq_google_ps_*",
    privacyS7Row5SetBy: "PromptQuorum (localStorage)",
    privacyS7Row5Purpose: "Merkt sich, dass Sie den Hinweis \"Als bevorzugte Quelle festlegen\" gesehen oder abgelehnt haben, damit er nicht erneut angezeigt wird",
    privacyS7Row5Duration: "Bis zu 14 Tage",
    privacyS7Row6Cookie: "pq-hw-profile",
    privacyS7Row6SetBy: "PromptQuorum (localStorage)",
    privacyS7Row6Purpose: "Speichert die RAM-/VRAM-Angaben, die Sie manuell im Kompatibilitäts-Check des KI-Software-Verzeichnisses eingeben und speichern, damit Tools mit Ihrer Ausstattung verglichen werden können — die Werte werden von Ihnen eingegeben, nie automatisch erkannt und niemals an uns übertragen",
    privacyS7Row6Duration: "Bis Sie auf \"Meine Hardware vergessen\" klicken oder Ihre Browserdaten löschen",
    privacyS7Row7Cookie: "pq-directory-machine",
    privacyS7Row7SetBy: "PromptQuorum (localStorage)",
  ...
  fr: {
    ...
    localLlmsHubDescription: "Meilleurs modèles LLM locaux par tier VRAM (4–48 Go): RTX 3060 12GB, RTX 4090, guides Apple Silicon. Configuration Ollama, comparaison hardware, tutoriels débutants.",
    enterpriseAiHubTitle: "Enterprise AI : Build, Buy, Govern",
    enterpriseAiHubDescription: "Conseils pratiques pour les entreprises qui déploient l'IA à grande échelle — développer des capacités internes, acheter des outils fournisseurs et gouverner l'usage de l'IA, y compris les risques et contrôles liés au Shadow AI.",
    ...
    aboutMetaTitle: "À propos de PromptQuorum : le moteur de découverte de l’IA ouverte",
    aboutMetaDescription: "Écosystème indépendant pour l’IA locale : annuaire d’applications, guides en 9 langues et application multi-modèles gratuite. Des modèles aux runtimes, aux applications.",
    ...
    privacyS7Row5Cookie: "pq_google_ps_*",
    privacyS7Row5SetBy: "PromptQuorum (localStorage)",
    privacyS7Row5Purpose: "Se souvient que vous avez vu ou rejeté l'invite « Définir comme source préférée », afin qu'elle ne soit plus affichée pendant un certain temps",
    privacyS7Row5Duration: "Jusqu'à 14 jours",
    privacyS7Row6Cookie: "pq-hw-profile",
    privacyS7Row6SetBy: "PromptQuorum (localStorage)",
    privacyS7Row6Purpose: "Stocke les valeurs de RAM/VRAM que vous saisissez et enregistrez manuellement dans le vérificateur de compatibilité du répertoire de logiciels IA, afin de comparer les outils à votre configuration — les chiffres sont saisis par vous, jamais détectés automatiquement, et jamais transmis à nous",
    privacyS7Row6Duration: "Jusqu'à ce que vous cliquiez sur « Oublier mon matériel » ou effaciez les données de votre navigateur",
    privacyS7Row7Cookie: "pq-directory-machine",
    privacyS7Row7SetBy: "PromptQuorum (localStorage)",
  ...
  ja: {
    ...
    enterpriseAiHubTitle: "エンタープライズAI：構築・購入・統制",
    enterpriseAiHubDescription: "大規模にAIを導入する企業向けの実践ガイド。社内能力の構築、ベンダーツールの購入、組織全体でのAI利用統制（シャドーAIのリスクと対策を含む）を扱います。",
    ...
    aboutMetaTitle: "PromptQuorumとは:オープンウェイト・オープンソースAI発見エンジン",
    aboutMetaDescription: "ローカルAIのための独立系エコシステム。ローカルAIアプリのディレクトリ、9言語のガイド、無料のマルチモデルアプリを提供。モデルからランタイム、アプリへ。",
    ...
    privacyS7Row5Cookie: "pq_google_ps_*",
    privacyS7Row5SetBy: "PromptQuorum (localStorage)",
    privacyS7Row5Purpose: "「優先ソースに設定」の案内を表示または閉じたことを記憶し、一定期間再表示しないようにします",
    privacyS7Row5Duration: "最大14日間",
    privacyS7Row6Cookie: "pq-hw-profile",
    privacyS7Row6SetBy: "PromptQuorum (localStorage)",
    privacyS7Row6Purpose: "AIソフトウェアディレクトリの互換性チェッカーで手動入力・保存したRAM/VRAMの数値を保存し、ツールとお使いの環境を比較できるようにします — 数値はご自身で入力したものであり、自動検出されることも、当社に送信されることもありません",
    privacyS7Row6Duration: "「ハードウェア情報を削除」をクリックするか、ブラウザデータを消去するまで",
    privacyS7Row7Cookie: "pq-directory-machine",
    privacyS7Row7SetBy: "PromptQuorum (localStorage)",
  ...
  zh: {
    ...
    enterpriseAiHubTitle: "企业AI：构建、采购、治理",
    enterpriseAiHubDescription: "面向大规模部署AI的企业的实用指南：构建内部能力、采购供应商工具、以及在组织范围内治理AI使用，包括Shadow AI风险与管控。",
    ...
    aboutMetaTitle: "关于 PromptQuorum：开放权重与开源 AI 的发现引擎",
    aboutMetaDescription: "PromptQuorum 是本地 AI 的独立生态系统：本地 AI 应用目录、9 种语言指南，以及免费多模型应用。从模型到运行环境，再到应用。",
    ...
    privacyS7Row5Cookie: "pq_google_ps_*",
    privacyS7Row5SetBy: "PromptQuorum (localStorage)",
    privacyS7Row5Purpose: "记住您已看到或关闭了\"设为优先来源\"提示，以便在一段时间内不再显示",
    privacyS7Row5Duration: "最多14天",
    privacyS7Row6Cookie: "pq-hw-profile",
    privacyS7Row6SetBy: "PromptQuorum (localStorage)",
    privacyS7Row6Purpose: "存储您在AI软件目录兼容性检查器中手动输入并保存的RAM/VRAM数值，以便将工具与您的配置进行比较 — 这些数值由您输入，从不自动检测，也绝不会发送给我们",
    privacyS7Row6Duration: "直到您点击\"忘记我的硬件\"或清除浏览器数据",
    privacyS7Row7Cookie: "pq-directory-machine",
    privacyS7Row7SetBy: "PromptQuorum (localStorage)",
  ...
  es: {
    ...
    localLlmsHubDescription: "Mejores modelos LLM locales por tier VRAM (4-48 GB): RTX 3060 12GB, RTX 4090, guías Apple Silicon. Configuración Ollama, comparativa hardware, tutoriales principiantes.",
    enterpriseAiHubTitle: "IA Empresarial: Build, Buy, Govern",
    enterpriseAiHubDescription: "Guías prácticas para empresas que despliegan IA a gran escala: crear capacidad interna, comprar herramientas de proveedores y gobernar el uso de la IA, incluidos los riesgos y controles de la IA en la sombra.",
    ...
    aboutMetaTitle: "Sobre PromptQuorum: el motor de descubrimiento para IA de pesos abiertos y código abierto",
    aboutMetaDescription: "Un ecosistema independiente para la IA local: directorio de apps de IA local, guías en 9 idiomas y una app multimodelo gratuita. De los modelos a los runtimes y las apps.",
    ...
    privacyS7Row5Cookie: "pq_google_ps_*",
    privacyS7Row5SetBy: "PromptQuorum (localStorage)",
    privacyS7Row5Purpose: "Recuerda que has visto o descartado el aviso «Establecer como fuente preferida», para no volver a mostrarlo durante un tiempo",
    privacyS7Row5Duration: "Hasta 14 días",
    privacyS7Row6Cookie: "pq-hw-profile",
    privacyS7Row6SetBy: "PromptQuorum (localStorage)",
    privacyS7Row6Purpose: "Almacena las cifras de RAM/VRAM que introduces y guardas manualmente en el verificador de compatibilidad del directorio de software de IA, para comparar las herramientas con tu configuración — las cifras las introduces tú, nunca se detectan automáticamente ni se nos envían",
    privacyS7Row6Duration: "Hasta que hagas clic en \"Olvidar mi hardware\" o borres los datos del navegador",
    privacyS7Row7Cookie: "pq-directory-machine",
    privacyS7Row7SetBy: "PromptQuorum (localStorage)",
  ...
  pt: {
    ...
    localLlmsHubDescription: "Melhores modelos LLM locais por nível de VRAM (4–48 GB): RTX 3060 12GB, RTX 4090, guias para Apple Silicon. Configuração do Ollama, comparação de hardware, tutoriais para iniciantes.",
    enterpriseAiHubTitle: "IA Empresarial: Build, Buy, Govern",
    enterpriseAiHubDescription: "Orientação prática para empresas que implantam IA em escala: construir capacidade interna, comprar ferramentas de fornecedores e governar o uso de IA, incluindo riscos e controles de shadow AI.",
    ...
    aboutMetaTitle: "Sobre a PromptQuorum: o motor de descoberta para IA aberta",
    aboutMetaDescription: "Ecossistema independente para IA local: diretório de apps de IA local, guias em 9 idiomas e um app multimodelo grátis. Dos modelos aos runtimes e apps.",
    ...
    privacyS7Row5Cookie: "pq_google_ps_*",
    privacyS7Row5SetBy: "PromptQuorum (localStorage)",
    privacyS7Row5Purpose: "Lembra que você viu ou dispensou o aviso 'Definir como fonte preferida', para não exibi-lo novamente por um tempo",
    privacyS7Row5Duration: "Até 14 dias",
    privacyS7Row6Cookie: "pq-hw-profile",
    privacyS7Row6SetBy: "PromptQuorum (localStorage)",
    privacyS7Row6Purpose: "Armazena os valores de RAM/VRAM que você insere e salva manualmente no verificador de compatibilidade do diretório de software de IA, para comparar as ferramentas com sua configuração — os valores são digitados por você, nunca detectados automaticamente, e nunca enviados a nós",
    privacyS7Row6Duration: "Até você clicar em \"Esquecer meu hardware\" ou limpar os dados do navegador",
    privacyS7Row7Cookie: "pq-directory-machine",
    privacyS7Row7SetBy: "PromptQuorum (localStorage)",
  ...
  ar: {
    ...
    localLlmsHubDescription: "أفضل نماذج LLM المحلية حسب مستوى VRAM (4-48 GB): RTX 3060 12GB وRTX 4090 وأدلة Apple Silicon. إعداد Ollama ومقارنة الأجهزة والدروس التعليمية للمبتدئين.",
    enterpriseAiHubTitle: "الذكاء الاصطناعي للمؤسسات: البناء والشراء والحوكمة",
    enterpriseAiHubDescription: "إرشادات عملية للمؤسسات التي تنشر الذكاء الاصطناعي على نطاق واسع: بناء القدرات الداخلية، وشراء أدوات الموردين، وحوكمة استخدام الذكاء الاصطناعي، بما في ذلك مخاطر وضوابط الذكاء الاصطناعي الخفي (Shadow AI).",
    ...
    aboutMetaTitle: "حول PromptQuorum: محرك الاكتشاف للذكاء الاصطناعي مفتوح الأوزان ومفتوح المصدر",
    aboutMetaDescription: "نظام بيئي مستقل للذكاء الاصطناعي المحلي: دليل تطبيقات الذكاء الاصطناعي المحلي، وأدلة إرشادية بـ 9 لغات، وتطبيق مجاني متعدد النماذج. من النماذج إلى بيئات التشغيل إلى التطبيقات.",
    ...
    privacyS7Row5Cookie: "pq_google_ps_*",
    privacyS7Row5SetBy: "PromptQuorum (localStorage)",
    privacyS7Row5Purpose: "يتذكر أنك شاهدت أو أغلقت التنبيه الخاص بـ \"تعيين كمصدر مفضل\"، حتى لا يظهر مرة أخرى لفترة",
    privacyS7Row5Duration: "حتى 14 يومًا",
    privacyS7Row6Cookie: "pq-hw-profile",
    privacyS7Row6SetBy: "PromptQuorum (localStorage)",
    privacyS7Row6Purpose: "يخزِّن قيم الذاكرة العشوائية (RAM) وذاكرة الرسومات (VRAM) التي تُدخلها وتحفظها يدويًا في أداة فحص التوافق بدليل برامج الذكاء الاصطناعي، لمقارنة الأدوات بإعداداتك — يتم إدخال القيم من قِبلك، ولا يتم اكتشافها تلقائيًا أبدًا، ولا تُرسَل إلينا أبدًا",
    privacyS7Row6Duration: "حتى تنقر على \"نسيان جهازي\" أو تمسح بيانات المتصفح",
    privacyS7Row7Cookie: "pq-directory-machine",
    privacyS7Row7SetBy: "PromptQuorum (localStorage)",
  ...
  ko: {
    ...
    localLlmsHubTitle: "로컬 LLM 순위·추천 2026: VRAM 등급별 비교",
    localLlmsHubDescription: "로컬 LLM 순위와 추천 2026: VRAM 등급별(4GB–48GB) 성능 비교, RTX 3060·4090, Apple Silicon, Ollama 설정과 초보자 가이드.",
    enterpriseAiHubTitle: "엔터프라이즈 AI: 구축, 도입, 거버넌스",
    enterpriseAiHubDescription: "대규모로 AI를 도입하는 기업을 위한 실용 가이드: 사내 역량 구축, 벤더 도구 구매, 그리고 Shadow AI 위험 및 통제를 포함한 조직 전반의 AI 사용 거버넌스.",
    ...
    aboutMetaTitle: "PromptQuorum 소개: 오픈 웨이트 및 오픈소스 AI 발견 엔진",
    aboutMetaDescription: "로컬 AI를 위한 독립적인 생태계: 로컬 AI 앱 디렉터리, 9개 언어 가이드, 무료 멀티 모델 앱. 모델에서 런타임, 앱까지.",
    ...
    privacyS7Row5Cookie: "pq_google_ps_*",
    privacyS7Row5SetBy: "PromptQuorum (localStorage)",
    privacyS7Row5Purpose: "'선호 소스로 설정' 알림을 보았거나 닫았음을 기억하여 일정 기간 다시 표시되지 않도록 합니다",
    privacyS7Row5Duration: "최대 14일",
    privacyS7Row6Cookie: "pq-hw-profile",
    privacyS7Row6SetBy: "PromptQuorum (localStorage)",
    privacyS7Row6Purpose: "AI 소프트웨어 디렉터리의 호환성 검사기에서 직접 입력하고 저장한 RAM/VRAM 수치를 저장하여 도구를 사용자의 환경과 비교할 수 있도록 합니다 — 수치는 사용자가 직접 입력하며, 자동으로 감지되거나 당사로 전송되지 않습니다",
    privacyS7Row6Duration: "\"내 하드웨어 잊기\"를 클릭하거나 브라우저 데이터를 삭제할 때까지",
    privacyS7Row7Cookie: "pq-directory-machine",
    privacyS7Row7SetBy: "PromptQuorum (localStorage)",
