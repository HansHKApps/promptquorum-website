# SPECS Framework Translations — Integration Guide

## Quick Start

Four translation files have been created with complete multilingual content for the SPECS framework:
- `/src/lib/prompt-engineering/specs-de.ts` (German)
- `/src/lib/prompt-engineering/specs-fr.ts` (French)
- `/src/lib/prompt-engineering/specs-ja.ts` (Japanese)
- `/src/lib/prompt-engineering/specs-zh.ts` (Simplified Chinese)

Each file exports a complete object ready to be integrated into `content.ts`.

## What Needs to Be Done

### Step 1: Add Imports to content.ts

At the top of `/src/lib/prompt-engineering/content.ts`, add:
...
### Step 2: Replace Empty Language Objects

Find the SPECS framework entry in content.ts (currently around line 23050-23204):
...
Replace the empty `de`, `fr`, `ja`, and `zh` objects with:
...
2. **Language Route Test**
   Open the following URLs in a browser and verify correct language appears:
   - `/frameworks/specs-framework?lang=de` — German
   - `/frameworks/specs-framework?lang=fr` — French
   - `/frameworks/specs-framework?lang=ja` — Japanese
   - `/frameworks/specs-framework?lang=zh` — Simplified Chinese

3. **Metadata Verification**
   Check page source for correct `<meta>` tags in each language.

4. **No English Fallback**
   Verify that all sections display translated content, not English.

## File Locations

**Translation Files:**
- `/Users/hanskuepper/promptquorum-website/src/lib/prompt-engineering/specs-de.ts`
- `/Users/hanskuepper/promptquorum-website/src/lib/prompt-engineering/specs-fr.ts`
- `/Users/hanskuepper/promptquorum-website/src/lib/prompt-engineering/specs-ja.ts`
- `/Users/hanskuepper/promptquorum-website/src/lib/prompt-engineering/specs-zh.ts`

**Target File for Integration:**
- `/Users/hanskuepper/promptquorum-website/src/lib/prompt-engineering/content.ts` (lines ~23050–23204)

**Summary Documents:**
- `/Users/hanskuepper/promptquorum-website/SPECS_TRANSLATIONS_SUMMARY.md`
- `/Users/hanskuepper/promptquorum-website/SPECS_INTEGRATION_GUIDE.md` (this file)

## Notes

- All product names (PromptQuorum, GPT-4o, Claude 4.6 Sonnet, Gemini 2.5 Pro) remain unchanged in all languages
- Framework names (SPECS, CRAFT, CO-STAR, APE, TRACE, RISEN) remain unchanged
- Acronyms (API, SDK, JSON, RAG, RLHF, LLM, HIPAA) remain unchanged
- All translations are GEO-compliant with no marketing fluff
- Zero English words appear in any translated sections
