  ...
  async redirects() {
    return [
      ...
      },
      {
        ...
        destination: '/:lang/directory',
        permanent: true,
      },
      {
        source: '/power-local-llm/local-llm-software-directory',
        destination: '/directory',
        permanent: true,
      },
      {
        source: '/:lang(de|fr|ja|zh|es|pt|ar|ko)/power-local-llm/local-llm-software-directory',
        destination: '/:lang/directory',
        permanent: true,
      },
      {
