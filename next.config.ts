...
const nextConfig: NextConfig = {
  ...
  async headers() {
    const cspHeader = [
      ...
      "connect-src 'self' https://region1.google-analytics.com https://www.google-analytics.com https://*.google-analytics.com https://www.googletagmanager.com https://scripts.clarity.ms https://www.clarity.ms https://c.clarity.ms https://c.bing.com https://d.clarity.ms https://*.vercel-insights.com https://*.vercel-analytics.com https://cloud.umami.is https://vitals.vercel-insights.com https://api.vercel.com https://onesignal.com https://*.onesignal.com",
